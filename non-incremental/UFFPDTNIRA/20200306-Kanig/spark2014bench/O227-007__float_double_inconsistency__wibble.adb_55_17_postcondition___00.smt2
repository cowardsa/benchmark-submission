...
(assert
;; defqtvc
 ;; File "wibble.adb", line 51, characters 0-0
  (not
  ...
  (=>
  (or
  (fp.eq state (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))
  (and
  (fp.leq (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) state)
  ...
  (=> (= state1 o)
  (fp.leq (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) state1))))))))))))
(check-sat)
(exit)
