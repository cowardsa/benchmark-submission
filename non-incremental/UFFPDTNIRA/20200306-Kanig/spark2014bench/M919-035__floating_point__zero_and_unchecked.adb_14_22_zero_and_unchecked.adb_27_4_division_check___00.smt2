...
;; defqtvc
 ;; File "zero_and_unchecked.adb", line 5, characters 0-0
  (not
  (forall ((x Int))
  (let ((zero_and_unchecked__zero_plus__assume (convert #x00000000)))
  (=>
  (and (convert__function_guard zero_and_unchecked__zero_plus__assume
  #x00000000) (dynamic_invariant3 zero_and_unchecked__zero_plus__assume true
  false true true))
  (=> (= zero_and_unchecked__zero_plus__assume zero_plus)
  (=> (dynamic_invariant1 zero_plus true false true true)
  (let ((zero_and_unchecked__zero_neg__assume (convert #x80000000)))
  (=>
  (and (convert__function_guard zero_and_unchecked__zero_neg__assume
  #x80000000) (dynamic_invariant3 zero_and_unchecked__zero_neg__assume true
  false true true))
  (=> (= zero_and_unchecked__zero_neg__assume zero_neg)
  ...
  (=> (= spark__branch (ite (fp.eq c1b c2b) true false))
  (=> (= spark__branch true)
  (let ((o c2b))
  (let ((o1 (magic o)))
  (=>
  (and (magic__function_guard o1 o) (dynamic_invariant5 o1 true false true
  true))
  (forall ((spark__branch1 Bool))
  (=> (= spark__branch1 (ite (= o1 0) false true))
  (=> (= spark__branch1 true)
  (let ((o2 c1b))
  (let ((o3 (magic o2)))
  (=>
