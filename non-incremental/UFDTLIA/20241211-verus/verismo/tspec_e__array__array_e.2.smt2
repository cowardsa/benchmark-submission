...
(assert (< index! (vstd!seq.Seq.len.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!))))
(assert (%B (B true)))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (req%verismo!tspec_e.array.array_t.impl&%4.trusted_index. T&. T& N&. N& self! index!)) (=> (ens%verismo!tspec_e.array.array_t.impl&%4.trusted_index. T&. T& N&. N& self! index! tmp%1) (=> (= ret! tmp%1) (=> %%location_label%%1 (= ret! (vstd!seq.Seq.index.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!) (I index!)))))))))
(check-sat)
(exit)
