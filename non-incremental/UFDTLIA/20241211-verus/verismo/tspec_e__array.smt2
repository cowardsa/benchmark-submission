...
(set-info :comment ";; MODULE 'module tspec_e::array'")
(set-info :comment ";; Fuel")
(declare-const fuel%verismo!tspec_e.array.U32_MAX. FuelId)
(assert (distinct fuel%verismo!tspec_e.array.U32_MAX.))
(set-info :comment ";; Datatypes")
(declare-fun TYPE%verismo!tspec_e.array.Array. (Dcr Type Dcr Type) Type)
(set-info :comment ";; Function-Decl verismo::tspec_e::array::U32_MAX")
(declare-fun verismo!tspec_e.array.U32_MAX.? () Int)
(set-info :comment ";; Function-Def verismo::tspec_e::array::U32_MAX")
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#23016)")
