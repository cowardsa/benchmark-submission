...
(assert (and (<= 0 i!) (< i! (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx!)))))
...
(assert (not (=> (= tmp%%@ (tuple%2./tuple%2 subs! (Poly%vstd!seq.Seq<int.>. subs_idx!))) (=> (= subs0@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= subs_idx0@ (%Poly%vstd!seq.Seq<int.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= subs1@ (vstd!seq_lib.impl&%0.remove.? T&. T& subs0@ (I i!))) (=> (= subs_idx1@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq_lib.impl&%0.remove.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx0@) (I i!)))) (and (=> (has_type k@ INT) (=> (and (<= 0 (%I k@)) (< (%I k@) (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@)))) (=> (= tmp%1 (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@)) (Sub (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx0@)) 1))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (and (<= 0 (%I k@)) (< (%I k@) (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx0@))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (and (<= 0 (%I k@)) (< (%I k@) (vstd!seq.Seq.len.? T&. T& subs0@)))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (and (<= 0 (%I k@)) (< (%I k@) (vstd!seq.Seq.len.? T&. T& subs1@)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (or (and (=> (< (%I k@) i!) (=> (= tmp%5 (and (let ((tmp%%$$0 (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx0@) k@)))) (and (<= 0 tmp%%$$0) (< tmp%%$$0 (vstd!seq.Seq.len.? T&. T& s!)))) (= (vstd!seq.Seq.index.? T&. T& subs0@ k@) (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx0@) k@))))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= tmp%6 (= (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx0@) k@) (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k@))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> (= tmp%7 (= (vstd!seq.Seq.index.? T&. T& subs0@ k@) (vstd!seq.Seq.index.? T&. T& subs1@ k@))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> (= tmp%8 (and (let ((tmp%%$$0 (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k@)))) (and (<= 0 tmp%%$$0) (< tmp%%$$0 (vstd!seq.Seq.len.? T&. T& s!)))) (= (vstd!seq.Seq.index.? T&. T& subs1@ k@) (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k@))))) (and (=> %%location_label%%7 tmp%8) (=> tmp%8 %%switch_label%%0))))))))))))) (=> (not (< (%I k@) i!)) (=> (= tmp%9 (= (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx0@) (I (Add (%I k@) 1))) (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k@))) (and (=> %%location_label%%8 tmp%9) (=> tmp%9 (=> (= tmp%10 (= (vstd!seq.Seq.index.? T&. T& subs0@ (I (Add (%I k@) 1))) (vstd!seq.Seq.index.? T&. T& subs1@ k@))) (and (=> %%location_label%%9 tmp%10) (=> tmp%10 (=> (= tmp%11 (and (let ((tmp%%$$0 (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx0@) (I (Add (%I k@) 1)))))) (and (<= 0 tmp%%$$0) (< tmp%%$$0 (vstd!seq.Seq.len.? T&. T& s!)))) (= (vstd!seq.Seq.index.? T&. T& subs0@ (I (Add (%I k@) 1))) (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx0@) (I (Add (%I k@) 1))))))) (and (=> %%location_label%%10 tmp%11) (=> tmp%11 (=> (= tmp%12 (and (let ((tmp%%$$0 (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k@)))) (and (<= 0 tmp%%$$0) (< tmp%%$$0 (vstd!seq.Seq.len.? T&. T& s!)))) (= (vstd!seq.Seq.index.? T&. T& subs1@ k@) (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k@))))) (and (=> %%location_label%%11 tmp%12) (=> tmp%12 %%switch_label%%0)))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%12 (and (let ((tmp%%$$0 (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k@)))) (and (<= 0 tmp%%$$0) (< tmp%%$$0 (vstd!seq.Seq.len.? T&. T& s!)))) (= (vstd!seq.Seq.index.? T&. T& subs1@ k@) (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k@))))))))))))))))))))) (=> (forall ((k$ Poly)) (! (=> (has_type k$ INT) (=> (and (<= 0 (%I k$)) (< (%I k$) (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@)))) (and (let ((tmp%%$$0 (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k$)))) (and (<= 0 tmp%%$$0) (< tmp%%$$0 (vstd!seq.Seq.len.? T&. T& s!)))) (= (vstd!seq.Seq.index.? T&. T& subs1@ k$) (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k$)))))) :pattern ((vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@) k$)) )) (=> (= tmp%13 (= (vstd!seq.Seq.len.? T&. T& subs1@) (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx1@)))) (and (=> %%location_label%%13 tmp%13) (=> tmp%13 (=> (= tmp%14 (<= (vstd!seq.Seq.len.? T&. T& subs1@) (vstd!seq.Seq.len.? T&. T& s!))) (and (=> %%location_label%%14 tmp%14) (=> tmp%14 (and (=> %%location_label%%15 (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& (vstd!seq_lib.impl&%0.remove.? T&. T& subs! (I i!)) s! (vstd!seq_lib.impl&%0.remove.? $ INT (Poly%vstd!seq.Seq<int.>. subs_idx!) (I i!)))) (=> %%location_label%%16 (= (vstd!seq.Seq.len.? T&. T& (vstd!seq_lib.impl&%0.remove.? T&. T& subs! (I i!))) (Sub (vstd!seq.Seq.len.? T&. T& subs!) 1)))))))))))))))))))
(check-sat)
(exit)
