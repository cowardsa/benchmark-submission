...
(assert (has_type op_fn! (TYPE%fun%2. T1&. T1& T2&. T2& T3&. T3&)))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(declare-const %%switch_label%%2 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? T1&. T1& s1!)) (or (and (=> (vstd!set.impl&%0.finite.? T1&. T1& s1!) (or (and (=> (not (vstd!set_lib.impl&%0.is_empty.? T1&. T1& s1!)) (=> (= ss1@ (vstd!set.impl&%0.remove.? T1&. T1& s1! (vstd!set.impl&%0.choose.? T1&. T1& s1!))) (or (and (=> (< (vstd!set.impl&%0.len.? T1&. T1& ss1@) (vstd!set.impl&%0.len.? T1&. T1& s1!)) (and (=> %%location_label%%0 (check_decrease_int (let ((s1!$0 ss1@) (s2!$1 s2!) (op_fn!$2 op_fn!)) (vstd!set.impl&%0.len.? T1&. T1& s1!$0)) decrease%init0 false)) (=> (has_type tmp%1 (TYPE%vstd!set.Set. T3&. T3&)) (=> (= tmp%1 (verismo!tspec.setlib.set_bop_recursive.? T1&. T1& T2&. T2& T3&. T3& ss1@ s2! op_fn!)) (=> (= tmp%2 (vstd!set.impl&%0.union.? T3&. T3& tmp%1 (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. op_fn!) (vstd!set.impl&%0.choose.? T1&. T1& s1!))))))))))) %%switch_label%%2))))) (=> (not (< (vstd!set.impl&%0.len.? T1&. T1& ss1@) (vstd!set.impl&%0.len.? T1&. T1& s1!))) (=> (= tmp%2 (vstd!set.impl&%0.empty.? T3&. T3&)) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%3 tmp%2) %%switch_label%%1))))) (=> (not (not (vstd!set_lib.impl&%0.is_empty.? T1&. T1& s1!))) (=> (= tmp%3 (vstd!set.impl&%0.empty.? T3&. T3&)) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 tmp%3) %%switch_label%%0)))) (=> (not (vstd!set.impl&%0.finite.? T1&. T1& s1!)) (=> (= tmp%4 (vstd!set.impl&%0.empty.? T3&. T3&)) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
