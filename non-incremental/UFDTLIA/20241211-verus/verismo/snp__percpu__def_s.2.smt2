...
(assert (fuel_bool_default fuel%verismo!snp.percpu.def_s.BSP.))
(assert (=> (fuel_bool fuel%verismo!snp.percpu.def_s.BSP.) (= verismo!snp.percpu.def_s.BSP.? 0)))
(assert (uInv 64 verismo!snp.percpu.def_s.BSP.?))
