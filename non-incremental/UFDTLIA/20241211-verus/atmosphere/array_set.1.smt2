...
(declare-const ret! lib!array_set.ArraySet.)
(declare-const tmp%1 lib!array.Array.)
...
(declare-const ret@0 lib!array_set.ArraySet.)
(assert fuel_defaults)
(assert (uInv SZ (const_int N&)))
(assert (has_type (Poly%lib!array.Array. tmp%1) (TYPE%lib!array.Array. $ BOOL N&. N&)))
(assert (has_type (Poly%lib!array_set.ArraySet. ret@0) (TYPE%lib!array_set.ArraySet. N&. N&)))
...
(declare-const ret@1 lib!array_set.ArraySet.)
