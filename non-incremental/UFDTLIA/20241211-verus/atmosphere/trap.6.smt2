...
(declare-const self!@0 lib!trap.TrapFrameOption.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!trap.TrapFrameOption. self!@0) TYPE%lib!trap.TrapFrameOption.))
(declare-const self!@1 lib!trap.TrapFrameOption.)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= (lib!trap.TrapFrameOption./TrapFrameOption/exists (%Poly%lib!trap.TrapFrameOption. (Poly%lib!trap.TrapFrameOption. self!@1))) false) (=> (= (lib!trap.TrapFrameOption./TrapFrameOption/reg self!@0) (lib!trap.TrapFrameOption./TrapFrameOption/reg self!@1)) (=> %%location_label%%0 (lib!trap.impl&%0.is_None.? (Poly%lib!trap.TrapFrameOption. self!@1)))))))
(check-sat)
(exit)
