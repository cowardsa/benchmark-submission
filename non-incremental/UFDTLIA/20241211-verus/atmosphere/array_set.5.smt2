...
(set-info :comment ";; Function-Specs lib::array_set::ArraySet::len")
...
(set-info :comment ";; Function-Def lib::array_set::ArraySet::len")
(set-info :comment ";; array_set.rs:68:5: 68:36 (#0)")
(declare-const N&. Dcr)
(declare-const N& Type)
(declare-const ret! Int)
(declare-const self! lib!array_set.ArraySet.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!array_set.ArraySet. self!) (TYPE%lib!array_set.ArraySet. N&. N&)))
(assert (uInv SZ (const_int N&)))
(assert (lib!array_set.impl&%0.wf.? N&. N& (Poly%lib!array_set.ArraySet. self!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= ret! (lib!array_set.ArraySet./ArraySet/len (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!)))) (=> %%location_label%%0 (= ret! (vstd!set.impl&%0.len.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. (lib!array_set.ArraySet./ArraySet/set (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!))))))))))
(check-sat)
(exit)
