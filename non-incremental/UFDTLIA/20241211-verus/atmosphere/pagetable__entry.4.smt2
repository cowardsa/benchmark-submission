...
(set-info :comment ";; Function-Specs lib::pagetable::entry::usize2pa")
...
(set-info :comment ";; Function-Def lib::pagetable::entry::usize2pa")
(set-info :comment ";; pagetable/entry.rs:205:1: 205:39 (#0)")
(set-info :comment ";; Function-Specs lib::pagetable::entry::usize2page_entry_perm")
(declare-fun ens%lib!pagetable.entry.usize2page_entry_perm. (Int lib!pagetable.entry.PageEntryPerm.) Bool)
(assert (forall ((v! Int) (ret! lib!pagetable.entry.PageEntryPerm.)) (! (= (ens%lib!pagetable.entry.usize2page_entry_perm. v! ret!) (and (ext_eq false TYPE%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!) (Poly%lib!pagetable.entry.PageEntryPerm. (lib!pagetable.entry.spec_usize2page_entry_perm.? (I v!)))) (=> (= v! 0) (and (and (and (and (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/present (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false) (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/ps (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false)) (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/write (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false)) (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/execute_disable (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false)) (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/user (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false))))) :pattern ((ens%lib!pagetable.entry.usize2page_entry_perm. v! ret!)) )))
(set-info :comment ";; Function-Def lib::pagetable::entry::usize2page_entry_perm")
(set-info :comment ";; pagetable/entry.rs:159:1: 159:60 (#0)")
(declare-const ret! lib!pagetable.entry.PageEntryPerm.)
(declare-const v! Int)
...
(assert (not (and (=> %%location_label%%0 true) (=> (= (not (= (uClip SZ (bitand (I 0) (I (uClip SZ 1)))) 0)) false) (and (=> %%location_label%%1 true) (=> (= (not (= (uClip SZ (bitand (I 0) (I (uClip SZ (uClip 64 (bitshl (I 1) (I 7))))))) 0)) false) (and (=> %%location_label%%2 true) (=> (= (not (= (uClip SZ (bitand (I 0) (I (uClip SZ (uClip 64 (bitshl (I 1) (I 1))))))) 0)) false) (and (=> %%location_label%%3 true) (=> (= (not (= (uClip SZ (bitand (I 0) (I (uClip SZ (uClip 64 (bitshl (I 1) (I 63))))))) 0)) false) (and (=> %%location_label%%4 true) (=> (= (not (= (uClip SZ (bitand (I 0) (I (uClip SZ (uClip 64 (bitshl (I 1) (I 2))))))) 0)) false) (=> (= ret! (lib!pagetable.entry.PageEntryPerm./PageEntryPerm (%B (B (not (= (uClip SZ (bitand (I v!) (I (uClip SZ lib!define.PAGE_ENTRY_PRESENT_MASK.?)))) 0)))) (%B (B (not (= (uClip SZ (bitand (I v!) (I (uClip SZ lib!define.PAGE_ENTRY_PS_MASK.?)))) 0)))) (%B (B (not (= (uClip SZ (bitand (I v!) (I (uClip SZ lib!define.PAGE_ENTRY_WRITE_MASK.?)))) 0)))) (%B (B (not (= (uClip SZ (bitand (I v!) (I (uClip SZ lib!define.PAGE_ENTRY_EXECUTE_MASK.?)))) 0)))) (%B (B (not (= (uClip SZ (bitand (I v!) (I (uClip SZ lib!define.PAGE_ENTRY_USER_MASK.?)))) 0)))))) (and (=> %%location_label%%5 (ext_eq false TYPE%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!) (Poly%lib!pagetable.entry.PageEntryPerm. (lib!pagetable.entry.spec_usize2page_entry_perm.? (I v!))))) (=> %%location_label%%6 (=> (= v! 0) (and (and (and (and (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/present (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false) (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/ps (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false)) (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/write (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false)) (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/execute_disable (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false)) (= (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/user (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. ret!))) false))))))))))))))))))
(check-sat)
(exit)
