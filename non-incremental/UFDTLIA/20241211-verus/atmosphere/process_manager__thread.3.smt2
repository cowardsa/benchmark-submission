...
(assert (not (=> (= ret! (ite (is-lib!process_manager.thread.IPCPayLoad./Endpoint_ self!) (let ((endpoint_index$ (lib!process_manager.thread.IPCPayLoad./Endpoint/endpoint_index (%Poly%lib!process_manager.thread.IPCPayLoad. (Poly%lib!process_manager.thread.IPCPayLoad. self!))))) (core!option.Option./Some (I endpoint_index$))) core!option.Option./None)) (=> %%location_label%%0 (= ret! (lib!process_manager.thread.impl&%3.spec_get_payload_as_endpoint.? (Poly%lib!process_manager.thread.IPCPayLoad. self!)))))))
(check-sat)
(exit)
