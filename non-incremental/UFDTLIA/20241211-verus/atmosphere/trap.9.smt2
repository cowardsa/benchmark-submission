...
(declare-fun ens%lib!trap.impl&%0.is_some. (lib!trap.TrapFrameOption. Bool) Bool)
(assert (forall ((self! lib!trap.TrapFrameOption.) (ret! Bool)) (! (= (ens%lib!trap.impl&%0.is_some. self! ret!) (= ret! (lib!trap.impl&%0.is_Some.? (Poly%lib!trap.TrapFrameOption. self!)))) :pattern ((ens%lib!trap.impl&%0.is_some. self! ret!)) )))
(declare-fun ens%lib!trap.impl&%0.is_none. (lib!trap.TrapFrameOption. Bool) Bool)
(assert (forall ((self! lib!trap.TrapFrameOption.) (ret! Bool)) (! (= (ens%lib!trap.impl&%0.is_none. self! ret!) (= ret! (lib!trap.impl&%0.is_None.? (Poly%lib!trap.TrapFrameOption. self!)))) :pattern ((ens%lib!trap.impl&%0.is_none. self! ret!)) )))
(declare-fun ens%lib!trap.impl&%0.set_self. (lib!trap.TrapFrameOption. lib!trap.TrapFrameOption. lib!trap.Registers.) Bool)
(assert (forall ((pre%self! lib!trap.TrapFrameOption.) (self! lib!trap.TrapFrameOption.) (src! lib!trap.Registers.)) (! (= (ens%lib!trap.impl&%0.set_self. pre%self! self! src!) (and (has_type (Poly%lib!trap.TrapFrameOption. self!) TYPE%lib!trap.TrapFrameOption.) (lib!trap.impl&%0.is_Some.? (Poly%lib!trap.TrapFrameOption. self!)) (ext_eq false TYPE%lib!trap.Registers. (Poly%lib!trap.Registers. (lib!trap.impl&%0.get_Some_0.? (Poly%lib!trap.TrapFrameOption. self!))) (Poly%lib!trap.Registers. src!)))) :pattern ((ens%lib!trap.impl&%0.set_self. pre%self! self! src!)) )))
(declare-fun req%lib!trap.impl&%0.set_dst. (lib!trap.TrapFrameOption. lib!trap.Registers.) Bool)
(declare-const %%global_location_label%%3 Bool)
(assert (forall ((self! lib!trap.TrapFrameOption.) (pre%dst! lib!trap.Registers.)) (! (= (req%lib!trap.impl&%0.set_dst. self! pre%dst!) (=> %%global_location_label%%3 (lib!trap.impl&%0.is_Some.? (Poly%lib!trap.TrapFrameOption. self!)))) :pattern ((req%lib!trap.impl&%0.set_dst. self! pre%dst!)) )))
(declare-fun ens%lib!trap.impl&%0.set_dst. (lib!trap.TrapFrameOption. lib!trap.Registers. lib!trap.Registers.) Bool)
(assert (forall ((self! lib!trap.TrapFrameOption.) (pre%dst! lib!trap.Registers.) (dst! lib!trap.Registers.)) (! (= (ens%lib!trap.impl&%0.set_dst. self! pre%dst! dst!) (and (has_type (Poly%lib!trap.Registers. dst!) TYPE%lib!trap.Registers.) (ext_eq false TYPE%lib!trap.Registers. (Poly%lib!trap.Registers. dst!) (Poly%lib!trap.Registers. (lib!trap.impl&%0.get_Some_0.? (Poly%lib!trap.TrapFrameOption. self!)))))) :pattern ((ens%lib!trap.impl&%0.set_dst. self! pre%dst! dst!)) )))
(declare-fun ens%lib!trap.impl&%0.set_to_none. (lib!trap.TrapFrameOption. lib!trap.TrapFrameOption.) Bool)
(assert (forall ((pre%self! lib!trap.TrapFrameOption.) (self! lib!trap.TrapFrameOption.)) (! (= (ens%lib!trap.impl&%0.set_to_none. pre%self! self!) (and (has_type (Poly%lib!trap.TrapFrameOption. self!) TYPE%lib!trap.TrapFrameOption.) (lib!trap.impl&%0.is_None.? (Poly%lib!trap.TrapFrameOption. self!)))) :pattern ((ens%lib!trap.impl&%0.set_to_none. pre%self! self!)) )))
(declare-fun ens%lib!trap.impl&%0.zeroed_none. (Int lib!trap.TrapFrameOption.) Bool)
(assert (forall ((no%param Int) (ret! lib!trap.TrapFrameOption.)) (! (= (ens%lib!trap.impl&%0.zeroed_none. no%param ret!) (and (has_type (Poly%lib!trap.TrapFrameOption. ret!) TYPE%lib!trap.TrapFrameOption.) (lib!trap.impl&%0.is_None.? (Poly%lib!trap.TrapFrameOption. ret!)))) :pattern ((ens%lib!trap.impl&%0.zeroed_none. no%param ret!)) )))
(declare-fun ens%lib!trap.impl&%4.new_empty. (Int lib!trap.Registers.) Bool)
(assert (forall ((no%param Int) (%return! lib!trap.Registers.)) (! (= (ens%lib!trap.impl&%4.new_empty. no%param %return!) (has_type (Poly%lib!trap.Registers. %return!) TYPE%lib!trap.Registers.)) :pattern ((ens%lib!trap.impl&%4.new_empty. no%param %return!)) )))
(declare-fun ens%lib!trap.impl&%4.new. (lib!trap.Registers. lib!trap.Registers.) Bool)
(assert (forall ((input! lib!trap.Registers.) (ret! lib!trap.Registers.)) (! (= (ens%lib!trap.impl&%4.new. input! ret!) (and (has_type (Poly%lib!trap.Registers. ret!) TYPE%lib!trap.Registers.) (ext_eq false TYPE%lib!trap.Registers. (Poly%lib!trap.Registers. ret!) (Poly%lib!trap.Registers. input!)))) :pattern ((ens%lib!trap.impl&%4.new. input! ret!)) )))
(declare-const ret! lib!trap.Registers.)
(declare-const input! lib!trap.Registers.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!trap.Registers. input!) TYPE%lib!trap.Registers.))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= ret! (let ((ret$ (lib!trap.Registers./Registers (%I (I (lib!trap.Registers./Registers/r15 (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/r14 (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/r13 (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/r12 (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/rbp (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/rbx (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/r11 (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/r10 (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/r9 (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/r8 (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/rcx (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/rdx (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/rsi (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/rdi (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/rax (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/error_code (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/rip (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/cs (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/flags (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/rsp (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!))))) (%I (I (lib!trap.Registers./Registers/ss (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. input!)))))))) ret$)) (=> %%location_label%%0 (ext_eq false TYPE%lib!trap.Registers. (Poly%lib!trap.Registers. ret!) (Poly%lib!trap.Registers. input!))))))
(check-sat)
(exit)
