...
(assert (not (=> (= ret! (ite (is-lib!process_manager.thread.IPCPayLoad./Pages_ self!) (let ((va_range$ (lib!process_manager.thread.IPCPayLoad./Pages/va_range (%Poly%lib!process_manager.thread.IPCPayLoad. (Poly%lib!process_manager.thread.IPCPayLoad. self!))))) (core!option.Option./Some (Poly%lib!va_range.VaRange4K. va_range$))) core!option.Option./None)) (=> %%location_label%%0 (= ret! (lib!process_manager.thread.impl&%3.spec_get_payload_as_va_range.? (Poly%lib!process_manager.thread.IPCPayLoad. self!)))))))
(check-sat)
(exit)
