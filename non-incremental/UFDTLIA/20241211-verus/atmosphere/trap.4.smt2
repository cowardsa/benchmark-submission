...
(declare-const src! lib!trap.Registers.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!trap.TrapFrameOption. self!@0) TYPE%lib!trap.TrapFrameOption.))
(assert (has_type (Poly%lib!trap.Registers. src!) TYPE%lib!trap.Registers.))
(declare-const self!@1 lib!trap.TrapFrameOption.)
(declare-const self!@2 lib!trap.TrapFrameOption.)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= (lib!trap.TrapFrameOption./TrapFrameOption/exists (%Poly%lib!trap.TrapFrameOption. (Poly%lib!trap.TrapFrameOption. self!@1))) true) (=> (= (lib!trap.TrapFrameOption./TrapFrameOption/reg self!@0) (lib!trap.TrapFrameOption./TrapFrameOption/reg self!@1)) (=> (= (lib!trap.TrapFrameOption./TrapFrameOption/reg (%Poly%lib!trap.TrapFrameOption. (Poly%lib!trap.TrapFrameOption. self!@2))) src!) (=> (= (lib!trap.TrapFrameOption./TrapFrameOption/exists self!@1) (lib!trap.TrapFrameOption./TrapFrameOption/exists self!@2)) (and (=> %%location_label%%0 (lib!trap.impl&%0.is_Some.? (Poly%lib!trap.TrapFrameOption. self!@2))) (=> %%location_label%%1 (ext_eq false TYPE%lib!trap.Registers. (Poly%lib!trap.Registers. (lib!trap.impl&%0.get_Some_0.? (Poly%lib!trap.TrapFrameOption. self!@2))) (Poly%lib!trap.Registers. src!))))))))))
(check-sat)
(exit)
