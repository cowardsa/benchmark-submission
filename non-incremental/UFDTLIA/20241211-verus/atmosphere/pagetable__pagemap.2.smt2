...
(set-info :comment ";; Function-Def lib::pagetable::pagemap::PageMap::init")
(set-info :comment ";; pagetable/pagemap.rs:19:5: 19:27 (#0)")
...
(assert (lib!array.impl&%0.wf.? $ (UINT SZ) $ (CONST_INT 512) (Poly%lib!array.Array. (lib!pagetable.pagemap.PageMap./PageMap/ar (%Poly%lib!pagetable.pagemap.PageMap. (Poly%lib!pagetable.pagemap.PageMap. self!@0))))))
(assert (= (vstd!seq.Seq.len.? $ TYPE%lib!pagetable.entry.PageEntry. (Poly%vstd!seq.Seq<lib!pagetable.entry.PageEntry.>. (lib!pagetable.pagemap.PageMap./PageMap/spec_seq (%Poly%lib!pagetable.pagemap.PageMap. (Poly%lib!pagetable.pagemap.PageMap. self!@0))))) 512))
