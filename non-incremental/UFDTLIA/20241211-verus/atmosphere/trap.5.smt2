...
(declare-const dst!@0 lib!trap.Registers.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!trap.TrapFrameOption. self!) TYPE%lib!trap.TrapFrameOption.))
(assert (has_type (Poly%lib!trap.Registers. dst!@0) TYPE%lib!trap.Registers.))
(assert (lib!trap.impl&%0.is_Some.? (Poly%lib!trap.TrapFrameOption. self!)))
(declare-const dst!@1 lib!trap.Registers.)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= dst!@1 (lib!trap.TrapFrameOption./TrapFrameOption/reg (%Poly%lib!trap.TrapFrameOption. (Poly%lib!trap.TrapFrameOption. self!)))) (=> %%location_label%%0 (ext_eq false TYPE%lib!trap.Registers. (Poly%lib!trap.Registers. dst!@1) (Poly%lib!trap.Registers. (lib!trap.impl&%0.get_Some_0.? (Poly%lib!trap.TrapFrameOption. self!))))))))
(check-sat)
(exit)
