...
(declare-const tmp@ vstd!seq.Seq<usize.>.)
...
(assert (has_type (Poly%lib!array.Array. self!@0) (TYPE%lib!array.Array. $ (UINT SZ) N&. N&)))
(assert (iInv 32 i@0))
