...
(assert (not (=> (= l! (lib!slinkedlist.spec_impl_u.StaticLinkedList./StaticLinkedList/value_list_len (%Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)))) (and (=> %%location_label%%0 (= l! (lib!slinkedlist.spec_impl_u.StaticLinkedList./StaticLinkedList/value_list_len (%Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!))))) (=> %%location_label%%1 (=> (lib!slinkedlist.spec_impl_u.impl&%0.wf.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)) (= l! (lib!slinkedlist.spec_impl_u.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)))))))))
(check-sat)
(exit)
