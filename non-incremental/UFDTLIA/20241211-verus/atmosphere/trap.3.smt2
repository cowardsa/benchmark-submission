...
(assert (not (=> (= ret! (= (lib!trap.TrapFrameOption./TrapFrameOption/exists (%Poly%lib!trap.TrapFrameOption. (Poly%lib!trap.TrapFrameOption. self!))) false)) (=> %%location_label%%0 (= ret! (lib!trap.impl&%0.is_None.? (Poly%lib!trap.TrapFrameOption. self!)))))))
(check-sat)
(exit)
