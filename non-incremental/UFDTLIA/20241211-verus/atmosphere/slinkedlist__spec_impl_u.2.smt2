...
(assert (lib!slinkedlist.spec_impl_u.impl&%0.unique.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)))
...
(assert (not (=> (= tmp%1 (forall ((i$ Poly) (j$ Poly)) (! (=> (and (has_type i$ INT) (has_type j$ INT)) (=> (and (and (and (<= 0 (%I i$)) (< (%I i$) (lib!slinkedlist.spec_impl_u.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)))) (and (<= 0 (%I j$)) (< (%I j$) (lib!slinkedlist.spec_impl_u.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!))))) (not (= i$ j$))) (not (= (vstd!seq.Seq.index.? T&. T& (lib!slinkedlist.spec_impl_u.impl&%0.view.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)) i$) (vstd!seq.Seq.index.? T&. T& (lib!slinkedlist.spec_impl_u.impl&%0.view.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)) j$))))) :pattern ((vstd!seq.Seq.index.? T&. T& (lib!slinkedlist.spec_impl_u.impl&%0.view.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)) i$) (vstd!seq.Seq.index.? T&. T& (lib!slinkedlist.spec_impl_u.impl&%0.view.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)) j$)) ))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (vstd!seq_lib.impl&%0.no_duplicates.? T&. T& (lib!slinkedlist.spec_impl_u.impl&%0.view.? T&. T& N&. N& (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)))))))))
(check-sat)
(exit)
