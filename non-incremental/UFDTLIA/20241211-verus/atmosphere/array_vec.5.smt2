...
(assert (< index! (lib!array_vec.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!))))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%2 (lib!array_vec.ArrayVec./ArrayVec/data (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!)))) (and (=> %%location_label%%0 (req%lib!array.impl&%0.get. T&. T& N&. N& tmp%2 index!)) (=> (ens%lib!array.impl&%0.get. T&. T& N&. N& tmp%2 index! tmp%1) (=> (= ret! tmp%1) (=> %%location_label%%1 (= ret! (vstd!seq.Seq.index.? T&. T& (lib!array_vec.impl&%0.view.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!)) (I index!))))))))))
(check-sat)
(exit)
