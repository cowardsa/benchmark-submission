...
(assert (< (lib!array_vec.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@0)) (lib!array_vec.impl&%0.spec_capacity.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@0))))
(declare-const self!@1 lib!array_vec.ArrayVec.)
(declare-const self!@2 lib!array_vec.ArrayVec.)
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(declare-const %%location_label%%3 Bool)
(declare-const %%location_label%%4 Bool)
(assert (not (=> (= index@ (lib!array_vec.ArrayVec./ArrayVec/len (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@0)))) (and (=> %%location_label%%0 (req%lib!array.impl&%1.set. T&. T& N&. N& (lib!array_vec.ArrayVec./ArrayVec/data (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@0))) index@ value!)) (=> (= (lib!array_vec.ArrayVec./ArrayVec/len self!@0) (lib!array_vec.ArrayVec./ArrayVec/len self!@1)) (=> (has_type (Poly%lib!array_vec.ArrayVec. self!@1) (TYPE%lib!array_vec.ArrayVec. T&. T& N&. N&)) (=> (ens%lib!array.impl&%1.set. T&. T& N&. N& (lib!array_vec.ArrayVec./ArrayVec/data (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@0))) (lib!array_vec.ArrayVec./ArrayVec/data (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@1))) index@ value!) (and (=> %%location_label%%1 (uInv SZ (Add (lib!array_vec.ArrayVec./ArrayVec/len (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@1))) 1))) (=> (= tmp%1 (uClip SZ (Add (lib!array_vec.ArrayVec./ArrayVec/len (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@1))) 1))) (=> (= (lib!array_vec.ArrayVec./ArrayVec/len (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@2))) tmp%1) (=> (= (lib!array_vec.ArrayVec./ArrayVec/data self!@1) (lib!array_vec.ArrayVec./ArrayVec/data self!@2)) (and (=> %%location_label%%2 (lib!array_vec.impl&%0.wf.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@2))) (and (=> %%location_label%%3 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (lib!array_vec.impl&%0.view.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@2)) (vstd!seq.Seq.push.? T&. T& (lib!array_vec.impl&%0.view.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@0)) value!))) (=> %%location_label%%4 (= (lib!array_vec.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@2)) (Add (lib!array_vec.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@0)) 1))))))))))))))))
(check-sat)
(exit)
