...
(assert (> (lib!array_vec.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@0)) 0))
...
(assert (not (and (=> %%location_label%%0 (req%lib!array_vec.impl&%0.len. T&. T& N&. N& self!@0)) (=> (ens%lib!array_vec.impl&%0.len. T&. T& N&. N& self!@0 tmp%1) (and (=> %%location_label%%1 (uInv SZ (Sub tmp%1 1))) (=> (= index@ (uClip SZ (Sub tmp%1 1))) (=> (= tmp%2 (lib!array_vec.ArrayVec./ArrayVec/data (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@0)))) (and (=> %%location_label%%2 (req%lib!array.impl&%0.get. T&. T& N&. N& tmp%2 index@)) (=> (ens%lib!array.impl&%0.get. T&. T& N&. N& tmp%2 index@ ret@) (and (=> %%location_label%%3 (uInv SZ (Sub (lib!array_vec.ArrayVec./ArrayVec/len (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@0))) 1))) (=> (= tmp%3 (uClip SZ (Sub (lib!array_vec.ArrayVec./ArrayVec/len (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@0))) 1))) (=> (= (lib!array_vec.ArrayVec./ArrayVec/len (%Poly%lib!array_vec.ArrayVec. (Poly%lib!array_vec.ArrayVec. self!@1))) tmp%3) (=> (= (lib!array_vec.ArrayVec./ArrayVec/data self!@0) (lib!array_vec.ArrayVec./ArrayVec/data self!@1)) (=> (= ret! ret@) (and (=> %%location_label%%4 (lib!array_vec.impl&%0.wf.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@1))) (and (=> %%location_label%%5 (= (lib!array_vec.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@1)) (Sub (lib!array_vec.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@0)) 1))) (and (=> %%location_label%%6 (= ret! (vstd!seq.Seq.index.? T&. T& (lib!array_vec.impl&%0.view.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@0)) (I (Sub (lib!array_vec.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@0)) 1))))) (=> %%location_label%%7 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (lib!array_vec.impl&%0.view.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@1)) (vstd!seq_lib.impl&%0.drop_last.? T&. T& (lib!array_vec.impl&%0.view.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. self!@0))))))))))))))))))))))
(check-sat)
(exit)
