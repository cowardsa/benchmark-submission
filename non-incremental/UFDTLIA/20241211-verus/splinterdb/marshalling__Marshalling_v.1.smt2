...
(set-info :comment ";; MODULE 'module marshalling::Marshalling_v'")
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.is_some. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!std_specs.vec.impl&%0.spec_index. fuel%vstd!std_specs.vec.axiom_spec_len. fuel%vstd!std_specs.vec.axiom_vec_index_decreases. fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_subrange_decreases. fuel%vstd!seq.axiom_seq_new_len. fuel%vstd!seq.axiom_seq_new_index. fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq.axiom_seq_subrange_len. fuel%vstd!seq.axiom_seq_subrange_index. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view. fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view. fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%24.view. fuel%lib!marshalling.IntegerMarshalling_v.impl&%0.deepv. fuel%lib!marshalling.Marshalling_v.impl&%0.deepv. fuel%lib!marshalling.Slice_v.impl&%0.valid. fuel%lib!marshalling.Slice_v.impl&%0.i. fuel%lib!marshalling.Slice_v.impl&%2.view. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (data! Poly)) (! (= (req%lib!marshalling.Slice_v.impl&%0.i. T&. T& self! data!) (=> %%global_location_label%%2 (lib!marshalling.Slice_v.impl&%0.valid.? T&. T& self! data!))) :pattern ((req%lib!marshalling.Slice_v.impl&%0.i. T&. T& self! data!)) )))
...
(assert (forall ((T&. Dcr) (T& Type) (option! core!option.Option.)) (! (= (req%core!option.impl&%0.unwrap. T&. T& option!) (=> %%global_location_label%%4 (is-core!option.Option./Some_ option!))) :pattern ((req%core!option.impl&%0.unwrap. T&. T& option!)) )))
...
(set-info :comment ";; Function-Def lib::marshalling::Marshalling_v::Marshal::exec_parsable")
(set-info :comment ";; marshalling/Marshalling_v.rs:71:10: 71:76 (#0)")
...
(declare-const ovalue@ core!option.Option.)
...
(assert (tr_bound%lib!marshalling.Marshalling_v.Marshal. Self%&. Self%&))
(assert (%B (lib!marshalling.Marshalling_v.Marshal.valid.? Self%&. Self%& self!)))
...
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.Marshalling_v.Marshal.try_parse. Self%&. Self%& self! slice! data!)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.try_parse. Self%&. Self%& self! slice! data! tmp%1) (=> (= ovalue@ (%Poly%core!option.Option. tmp%1)) (=> (ens%core!option.impl&%0.is_some. (proj%%lib!marshalling.Marshalling_v.Marshal./U Self%&. Self%&) (proj%lib!marshalling.Marshalling_v.Marshal./U Self%&. Self%&) ovalue@ tmp%2) (=> (= p! (B tmp%2)) (=> %%location_label%%1 (= p! (lib!marshalling.Marshalling_v.Marshal.parsable.? Self%&. Self%& self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))))))))))
(check-sat)
(exit)
