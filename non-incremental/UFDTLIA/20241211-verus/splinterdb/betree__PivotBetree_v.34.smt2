...
(declare-const tmp%1 lib!betree.PivotBetree_v.BetreeNode.)
...
(assert (not (=> (= decrease%init0 (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. self!))) (or (and (=> (= (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. self!)) 0) (=> (= tmp%3 (lib!betree.PivotBetree_v.Path./Path/node (%Poly%lib!betree.PivotBetree_v.Path. self!))) %%switch_label%%0)) (=> (not (= (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. self!)) 0)) (=> (= tmp%2 (Poly%lib!betree.PivotBetree_v.Path. (lib!betree.PivotBetree_v.impl&%4.subpath.? self!))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.PivotBetree_v.Path. tmp%2))) (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. (Poly%lib!betree.PivotBetree_v.Path. self!$0)))) decrease%init0 false)) (=> (= tmp%1 (lib!betree.PivotBetree_v.impl&%4.target.? (Poly%lib!betree.PivotBetree_v.Path. (lib!betree.PivotBetree_v.impl&%4.subpath.? self!)))) (=> (= tmp%3 tmp%1) %%switch_label%%0)))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
