...
(assert (not (=> (ens%vstd!bytes.lemma_auto_spec_u16_to_from_le_bytes. 0) (and (=> (has_type x@ (UINT 16)) (=> %%location_label%%0 (and (= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) x@)) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 16)))) (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 16) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) x@)) x@)))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ (UINT 16)) (and (= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) x$)) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 16)))) (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 16) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) x$)) x$))) :pattern ((lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) x$)) )) (and (=> %%location_label%%1 (forall ((x$$0 Poly)) (! (=> (has_type x$$0 (UINT 16)) (and (= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) x$$0)) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 16)))) (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 16) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) x$$0)) x$$0))) :pattern ((lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) x$$0)) ))) (=> %%location_label%%2 (forall ((s$$0 Poly)) (! (=> (has_type s$$0 (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (= (vstd!seq.Seq.len.? $ (UINT 8) s$$0) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 16)))) (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 16) s$$0)) s$$0))) :pattern ((lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 16) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 16) s$$0))) )))))))))
(check-sat)
(exit)
