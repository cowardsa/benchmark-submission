...
(assert (not (=> (lib!betree.PivotBetree_v.impl&%1.wf.? self!) (=> (= tmp%2 (Poly%lib!betree.Domain_v.Domain. (lib!betree.Domain_v.total_domain.? (I 0)))) (and (=> %%location_label%%0 (req%lib!betree.PivotBetree_v.impl&%1.promote. self! tmp%2)) (=> (= tmp%1 (lib!betree.PivotBetree_v.impl&%1.promote.? self! (Poly%lib!betree.Domain_v.Domain. (lib!betree.Domain_v.total_domain.? (I 0))))) (=> (= tmp%4 (lib!betree.Memtable_v.Memtable./Memtable/buffer (%Poly%lib!betree.Memtable_v.Memtable. memtable!))) (=> %%location_label%%1 (req%lib!betree.PivotBetree_v.impl&%1.merge_buffer. (Poly%lib!betree.PivotBetree_v.BetreeNode. tmp%1) tmp%4)))))))))
(check-sat)
(exit)
