...
(assert (not (=> (= decrease%init0 (%I depth!)) (or (and (=> (< 0 (%I depth!)) (or (and (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. root!)) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!))) (=> (= tmp%3 (I (nClip (Sub (%I depth!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)) (root!$1 (%Poly%core!option.Option. tmp%2)) (depth!$2 (%I tmp%3))) depth!$2) decrease%init0 false)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.can_crop.? self! (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!)) (I (nClip (Sub (%I depth!) 1))))) (=> (= tmp%4 tmp%1) %%switch_label%%1)))))) (=> (not (is-core!option.Option./Some_ (%Poly%core!option.Option. root!))) (=> (= tmp%4 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%5 tmp%4) %%switch_label%%0)))) (=> (not (< 0 (%I depth!))) (=> (= tmp%5 true) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
