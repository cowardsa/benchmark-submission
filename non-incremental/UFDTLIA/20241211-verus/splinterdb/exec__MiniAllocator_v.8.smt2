...
(assert (has_type (Poly%lib!exec.MiniAllocator_v.PageAllocator. self!) TYPE%lib!exec.MiniAllocator_v.PageAllocator.))
(assert (lib!exec.MiniAllocator_v.impl&%1.wf.? (Poly%lib!exec.MiniAllocator_v.PageAllocator. self!)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (or (and (=> (lib!exec.MiniAllocator_v.impl&%1.has_free_addr.? (Poly%lib!exec.MiniAllocator_v.PageAllocator. self!)) (=> (= addr@ (lib!spec.ImplDisk_t.IAddress./IAddress (%I (I (lib!exec.MiniAllocator_v.PageAllocator./PageAllocator/au (%Poly%lib!exec.MiniAllocator_v.PageAllocator. (Poly%lib!exec.MiniAllocator_v.PageAllocator. self!))))) (%I (I (lib!exec.MiniAllocator_v.PageAllocator./PageAllocator/reserved (%Poly%lib!exec.MiniAllocator_v.PageAllocator. (Poly%lib!exec.MiniAllocator_v.PageAllocator. self!))))))) (=> (= tmp%1 (lib!allocation_layer.MiniAllocator_v.impl&%0.is_free_addr.? (vstd!view.View.view.? $ TYPE%lib!exec.MiniAllocator_v.PageAllocator. (Poly%lib!exec.MiniAllocator_v.PageAllocator. self!)) (Poly%lib!spec.AsyncDisk_t.Address. (lib!spec.ImplDisk_t.impl&%0.view.? (Poly%lib!spec.ImplDisk_t.IAddress. addr@))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0))))) (=> (not (lib!exec.MiniAllocator_v.impl&%1.has_free_addr.? (Poly%lib!exec.MiniAllocator_v.PageAllocator. self!))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%1 (= (lib!exec.MiniAllocator_v.impl&%1.has_free_addr.? (Poly%lib!exec.MiniAllocator_v.PageAllocator. self!)) (not (lib!allocation_layer.MiniAllocator_v.impl&%0.all_pages_allocated.? (vstd!view.View.view.? $ TYPE%lib!exec.MiniAllocator_v.PageAllocator. (Poly%lib!exec.MiniAllocator_v.PageAllocator. self!))))))))))
(check-sat)
(exit)
