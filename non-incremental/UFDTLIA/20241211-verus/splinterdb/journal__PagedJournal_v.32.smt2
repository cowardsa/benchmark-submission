...
(assert (not (and (=> (has_type ojr@ (TYPE%core!option.Option. $ TYPE%lib!journal.PagedJournal_v.JournalRecord.)) (=> (has_type boundary_lsn@ NAT) (=> (has_type depth@ NAT) (=> (lib!journal.PagedJournal_v.impl&%0.opt_rec_can_crop_head_records.? ojr@ boundary_lsn@ depth@) (and (=> %%location_label%%0 (req%lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records_lemma. (%Poly%core!option.Option. ojr@) (%I boundary_lsn@) (%I depth@))) (=> (ens%lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records_lemma. (%Poly%core!option.Option. ojr@) (%I boundary_lsn@) (%I depth@)) (=> %%location_label%%1 (=> (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? ojr@ boundary_lsn@ depth@)) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? ojr@ boundary_lsn@ depth@)))) boundary_lsn@))))))))) (=> (forall ((ojr$ Poly) (boundary_lsn$ Poly) (depth$ Poly)) (! (=> (and (has_type ojr$ (TYPE%core!option.Option. $ TYPE%lib!journal.PagedJournal_v.JournalRecord.)) (has_type boundary_lsn$ NAT) (has_type depth$ NAT)) (=> (lib!journal.PagedJournal_v.impl&%0.opt_rec_can_crop_head_records.? ojr$ boundary_lsn$ depth$) (=> (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? ojr$ boundary_lsn$ depth$)) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? ojr$ boundary_lsn$ depth$)))) boundary_lsn$)))) :pattern ((lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? ojr$ boundary_lsn$ depth$)) )) (=> %%location_label%%2 (forall ((ojr$ Poly) (boundary_lsn$ Poly) (depth$ Poly)) (! (=> (and (has_type ojr$ (TYPE%core!option.Option. $ TYPE%lib!journal.PagedJournal_v.JournalRecord.)) (has_type boundary_lsn$ NAT) (has_type depth$ NAT)) (=> (lib!journal.PagedJournal_v.impl&%0.opt_rec_can_crop_head_records.? ojr$ boundary_lsn$ depth$) (=> (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? ojr$ boundary_lsn$ depth$)) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? ojr$ boundary_lsn$ depth$)))) boundary_lsn$)))) :pattern ((lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? ojr$ boundary_lsn$ depth$)) )))))))
(check-sat)
(exit)
