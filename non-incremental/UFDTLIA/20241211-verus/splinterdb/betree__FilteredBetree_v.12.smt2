...
(assert (not (or (and (=> (and (lib!betree.FilteredBetree_v.impl&%1.wf.? self!) (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) (=> (= tmp%2 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.FilteredBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%lib!betree.PivotTable_v.impl&%0.bounded_key. tmp%2 key!)) (=> (= tmp%1 (lib!betree.PivotTable_v.impl&%0.bounded_key.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.FilteredBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) key!)) (=> (= tmp%3 tmp%1) %%switch_label%%0))))) (=> (not (and (lib!betree.FilteredBetree_v.impl&%1.wf.? self!) (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
