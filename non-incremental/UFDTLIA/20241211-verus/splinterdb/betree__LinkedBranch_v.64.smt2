...
(declare-const tmp%3 lib!betree.LinkedBranch_v.Node.)
(declare-const subtree_addrs@ vstd!seq.Seq<vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.>.)
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.valid_ranking. self! ranking!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!)) (=> (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%5.get_rank. self! ranking!)) (=> (= tmp%2 (lib!betree.LinkedBranch_v.impl&%5.get_rank.? self! ranking!)) (or (and (=> (not (lib!betree.LinkedBranch_v.impl&%5.has_root.? self!)) (=> (= tmp%5 (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.)) %%switch_label%%0)) (=> (not (not (lib!betree.LinkedBranch_v.impl&%5.has_root.? self!))) (and (=> %%location_label%%2 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%3 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (or (and (=> (is-lib!betree.LinkedBranch_v.Node./Leaf_ tmp%3) (=> (= tmp%4 (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/root (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!))))) %%switch_label%%1)) (=> (not (is-lib!betree.LinkedBranch_v.Node./Leaf_ tmp%3)) (and (=> %%location_label%%3 (req%lib!betree.LinkedBranch_v.impl&%5.children_reachable_addrs_using_ranking. self! ranking!)) (=> (= tmp%4 (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (lib!betree.Utils_v.union_seq_of_sets.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.>. subtree_addrs@)) (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/root (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!))))) %%switch_label%%1)))) (and (not %%switch_label%%1) (=> (= tmp%5 tmp%4) %%switch_label%%0))))))) (not %%switch_label%%0))))))))))
(check-sat)
(exit)
