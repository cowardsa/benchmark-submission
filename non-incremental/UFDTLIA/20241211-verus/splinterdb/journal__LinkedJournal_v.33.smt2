...
(declare-const tmp%7 lib!journal.LinkedJournal_v.DiskView.)
(declare-const tmp%8 lib!journal.LinkedJournal_v.DiskView.)
...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. self! root!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? self! root!)) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%2 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (or (and (=> (not tmp%2) (=> (= tmp%8 (lib!journal.LinkedJournal_v.DiskView./DiskView (%I (I 0)) (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (vstd!map.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord.)))) %%switch_label%%0)) (=> (not (not tmp%2)) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. root!)) (=> (= tmp%7 (lib!journal.LinkedJournal_v.DiskView./DiskView (%I (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (vstd!map.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord.)))) %%switch_label%%1)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. root!))) (and (=> %%location_label%%2 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. root!)) (=> (= tmp%3 (core!option.Option./Some/0 (%Poly%core!option.Option. root!))) (=> (= addr@ (%Poly%lib!spec.AsyncDisk_t.Address. tmp%3)) (and (=> %%location_label%%3 (req%lib!journal.LinkedJournal_v.impl&%1.next. self! root!)) (=> (= tmp%4 (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!)) (and (=> %%location_label%%4 (req%lib!journal.LinkedJournal_v.impl&%1.build_tight. self! (Poly%core!option.Option. tmp%4))) (=> (= tmp%6 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (and (=> %%location_label%%5 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. tmp%6 (Poly%lib!spec.AsyncDisk_t.Address. addr@))) (=> (= tmp%5 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (Poly%lib!spec.AsyncDisk_t.Address. addr@))) (=> (= tmp%7 (lib!journal.LinkedJournal_v.DiskView./DiskView (%I (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (vstd!map.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. tail@)))) (Poly%lib!spec.AsyncDisk_t.Address. addr@) tmp%5)))) %%switch_label%%1)))))))))))) (and (not %%switch_label%%1) (=> (= tmp%8 tmp%7) %%switch_label%%0))))) (not %%switch_label%%0))))))))))
(check-sat)
(exit)
