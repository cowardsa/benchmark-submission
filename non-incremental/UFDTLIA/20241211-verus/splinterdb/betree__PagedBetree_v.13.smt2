...
(assert (not (or (and (=> (and (lib!betree.PagedBetree_v.impl&%4.structure.? self!) (lib!betree.PagedBetree_v.impl&%4.all_lines_wf.? self!)) (=> (has_type i@ INT) (or (and (=> (and (<= 0 (%I i@)) (< (%I i@) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PagedBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PagedBetree_v.QueryReceiptLine.>. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!)))) 1))) (and (=> %%location_label%%0 (req%lib!betree.PagedBetree_v.impl&%4.child_linked_at. self! i@)) (=> (= tmp%1 (lib!betree.PagedBetree_v.impl&%4.child_linked_at.? self! i@)) (=> (= tmp%2 tmp%1) %%switch_label%%3)))) (=> (not (and (<= 0 (%I i@)) (< (%I i@) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PagedBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PagedBetree_v.QueryReceiptLine.>. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!)))) 1)))) (=> (= tmp%2 true) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= tmp%3 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PagedBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PagedBetree_v.QueryReceiptLine.>. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!)))) 1))) (lib!betree.PagedBetree_v.impl&%4.child_linked_at.? self! i$))) :pattern ((lib!betree.PagedBetree_v.impl&%4.child_linked_at.? self! i$)) ))) %%switch_label%%2))))) (=> (not (and (lib!betree.PagedBetree_v.impl&%4.structure.? self!) (lib!betree.PagedBetree_v.impl&%4.all_lines_wf.? self!))) (=> (= tmp%3 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%3 (=> (has_type i$1@ INT) (or (and (=> (and (<= 0 (%I i$1@)) (< (%I i$1@) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PagedBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PagedBetree_v.QueryReceiptLine.>. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!)))) 1))) (and (=> %%location_label%%1 (req%lib!betree.PagedBetree_v.impl&%4.result_linked_at. self! i$1@)) (=> (= tmp%4 (lib!betree.PagedBetree_v.impl&%4.result_linked_at.? self! i$1@)) (=> (= tmp%5 tmp%4) %%switch_label%%1)))) (=> (not (and (<= 0 (%I i$1@)) (< (%I i$1@) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PagedBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PagedBetree_v.QueryReceiptLine.>. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!)))) 1)))) (=> (= tmp%5 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%6 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PagedBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PagedBetree_v.QueryReceiptLine.>. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!)))) 1))) (lib!betree.PagedBetree_v.impl&%4.result_linked_at.? self! i$))) :pattern ((lib!betree.PagedBetree_v.impl&%4.result_linked_at.? self! i$)) ))) %%switch_label%%0))))) (=> (not tmp%3) (=> (= tmp%6 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
