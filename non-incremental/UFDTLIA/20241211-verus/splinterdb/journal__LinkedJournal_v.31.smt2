...
(declare-const tmp%3 vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>.)
...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! ptr!) (or (and (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. ptr!)) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (= tmp%2 tmp%1) %%switch_label%%1)))) (=> (not (is-core!option.Option./Some_ (%Poly%core!option.Option. ptr!))) (=> (= tmp%2 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%2 (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.the_ranking. self!)) (=> (= tmp%3 (lib!journal.LinkedJournal_v.impl&%1.the_ranking.? self!)) (and (=> %%location_label%%2 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. ptr!)) (=> (= tmp%4 (core!option.Option./Some/0 (%Poly%core!option.Option. ptr!))) (and (=> %%location_label%%3 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. tmp%3) tmp%4)) (=> (= tmp%5 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. tmp%3) tmp%4)) (=> (= tmp%6 (nClip (Add (%I tmp%5) 1))) %%switch_label%%0)))))))) (=> (not tmp%2) (=> (= tmp%6 0) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
