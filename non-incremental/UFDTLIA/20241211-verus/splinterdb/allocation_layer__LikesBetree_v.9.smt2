...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r1!))) (=> (= decrease%init1 (Sub (vstd!seq.Seq.len.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!))))))) start!)) (or (and (=> (< start! (vstd!seq.Seq.len.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))))))) (=> (fuel_bool fuel%lib!betree.LinkedBetree_v.impl&%11.reachable_betree_addrs_ignore_ranking.) (=> (= child@ (lib!betree.LinkedBetree_v.impl&%5.child_at_idx.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (I start!))) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!))) (I start!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> %%location_label%%1 (check_decrease_int (let ((self!$0 child@) (r1!$1 r1!) (r2!$2 r2!)) (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!$0) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r1!$1))) decrease%init0 false)) (and (=> %%location_label%%2 (req%lib!allocation_layer.LikesBetree_v.impl&%1.tree_likes_ignore_ranking. T&. T& child@ r1! r2!)) (=> (ens%lib!allocation_layer.LikesBetree_v.impl&%1.tree_likes_ignore_ranking. T&. T& child@ r1! r2!) (=> (= tmp%2 (nClip (Add start! 1))) (and (=> %%location_label%%3 (check_decrease_int (let ((self!$0 self!) (r1!$1 r1!) (r2!$2 r2!) (start!$3 tmp%2)) (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!$0) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r1!$1))) decrease%init0 (check_decrease_int (let ((self!$0 self!) (r1!$1 r1!) (r2!$2 r2!) (start!$3 tmp%2)) (Sub (vstd!seq.Seq.len.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!$0))))))) start!$3)) decrease%init1 false))) (and (=> %%location_label%%4 (req%lib!allocation_layer.LikesBetree_v.impl&%1.children_likes_ignore_ranking. T&. T& self! r1! r2! tmp%2)) (=> (ens%lib!allocation_layer.LikesBetree_v.impl&%1.children_likes_ignore_ranking. T&. T& self! r1! r2! tmp%2) %%switch_label%%0))))))))))))) (=> (not (< start! (vstd!seq.Seq.len.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!))))))))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%5 (ext_eq false (TYPE%vstd!multiset.Multiset. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesBetree_v.impl&%1.children_likes.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r1!) (I start!))) (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesBetree_v.impl&%1.children_likes.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r2!) (I start!)))))))))))
(check-sat)
(exit)
