...
(assert (forall ((A&. Dcr) (A& Type) (sets! Poly) (a! Poly)) (! (= (req%lib!betree.Utils_v.lemma_union_seq_of_sets_contains. A&. A& sets! a!) (=> %%global_location_label%%6 (vstd!set.impl&%0.contains.? A&. A& (lib!betree.Utils_v.union_seq_of_sets.? A&. A& sets!) a!))) :pattern ((req%lib!betree.Utils_v.lemma_union_seq_of_sets_contains. A&. A& sets! a!)) )))
...
(set-info :comment ";; Function-Def lib::betree::Utils_v::lemma_union_seq_of_sets_contains")
(set-info :comment ";; betree/Utils_v.rs:38:1: 38:74 (#0)")
...
(assert (forall ((A&. Dcr) (A& Type) (sets! Poly)) (! (= (req%lib!betree.Utils_v.lemma_union_seq_of_sets_finite. A&. A& sets!) (=> %%global_location_label%%7 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!))) (vstd!set.impl&%0.finite.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$)))) :pattern ((vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$)) )))) :pattern ((req%lib!betree.Utils_v.lemma_union_seq_of_sets_finite. A&. A& sets!)) )))
...
(set-info :comment ";; Function-Def lib::betree::Utils_v::lemma_union_seq_of_sets_finite")
(set-info :comment ";; betree/Utils_v.rs:14:1: 14:66 (#0)")
(set-info :comment ";; Function-Specs lib::betree::Utils_v::lemma_to_set_distributes_over_plus")
(declare-fun ens%lib!betree.Utils_v.lemma_to_set_distributes_over_plus. (Dcr Type Poly Poly) Bool)
(assert (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (! (= (ens%lib!betree.Utils_v.lemma_to_set_distributes_over_plus. A&. A& a! b!) (= (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& a! b!)) (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& a!) (vstd!seq_lib.impl&%0.to_set.? A&. A& b!)))) :pattern ((ens%lib!betree.Utils_v.lemma_to_set_distributes_over_plus. A&. A& a! b!)) )))
(set-info :comment ";; Function-Def lib::betree::Utils_v::lemma_to_set_distributes_over_plus")
(set-info :comment ";; betree/Utils_v.rs:51:1: 51:73 (#0)")
(set-info :comment ";; Function-Specs lib::betree::Utils_v::lemma_subset_finite")
(declare-fun req%lib!betree.Utils_v.lemma_subset_finite. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%8 Bool)
(declare-const %%global_location_label%%9 Bool)
(assert (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (! (= (req%lib!betree.Utils_v.lemma_subset_finite. A&. A& a! b!) (and (=> %%global_location_label%%8 (vstd!set.impl&%0.finite.? A&. A& a!)) (=> %%global_location_label%%9 (vstd!set.impl&%0.subset_of.? A&. A& b! a!)))) :pattern ((req%lib!betree.Utils_v.lemma_subset_finite. A&. A& a! b!)) )))
(declare-fun ens%lib!betree.Utils_v.lemma_subset_finite. (Dcr Type Poly Poly) Bool)
(assert (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (! (= (ens%lib!betree.Utils_v.lemma_subset_finite. A&. A& a! b!) (vstd!set.impl&%0.finite.? A&. A& b!)) :pattern ((ens%lib!betree.Utils_v.lemma_subset_finite. A&. A& a! b!)) )))
(set-info :comment ";; Function-Def lib::betree::Utils_v::lemma_subset_finite")
(set-info :comment ";; betree/Utils_v.rs:73:1: 73:58 (#0)")
(declare-const A&. Dcr)
...
(assert (has_type a! (TYPE%vstd!set.Set. A&. A&)))
(assert (has_type b! (TYPE%vstd!set.Set. A&. A&)))
(assert (vstd!set.impl&%0.finite.? A&. A& a!))
(assert (vstd!set.impl&%0.subset_of.? A&. A& b! a!))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. A&. A&) b! (vstd!set.impl&%0.intersect.? A&. A& a! b!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (vstd!set.impl&%0.finite.? A&. A& b!)))))))
(check-sat)
(exit)
