...
(set-info :comment ";; Function-Axioms lib::betree::LinkedBranch_v::LinkedBranch::tight_disk_view")
(assert (fuel_bool_default fuel%lib!betree.LinkedBranch_v.impl&%5.tight_disk_view.))
(assert (=> (fuel_bool fuel%lib!betree.LinkedBranch_v.impl&%5.tight_disk_view.) (forall ((self! Poly)) (! (= (lib!betree.LinkedBranch_v.impl&%5.tight_disk_view.? self!) (=> (lib!betree.LinkedBranch_v.impl&%5.acyclic.? self!) (= (lib!betree.LinkedBranch_v.impl&%5.representation.? self!) (lib!betree.LinkedBranch_v.impl&%4.representation.? (Poly%lib!betree.LinkedBranch_v.DiskView. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/disk_view (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!))))))) :pattern ((lib!betree.LinkedBranch_v.impl&%5.tight_disk_view.? self!)) ))))
(set-info :comment ";; Function-Recommends lib::betree::LinkedBranch_v::empty_linked_branch")
(set-info :comment ";; betree/LinkedBranch_v.rs:690:1: 690:77 (#0)")
(declare-const %return! lib!betree.LinkedBranch_v.LinkedBranch.)
(declare-const root! Poly)
(assert fuel_defaults)
(assert (has_type root! TYPE%lib!spec.AsyncDisk_t.Address.))
(assert (not true))
(check-sat)
(exit)
