...
(set-info :comment ";; MODULE 'module abstract_system::MsgHistory_v'")
...
(declare-const fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_key. FuelId)
...
(assert (distinct fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_empty. fuel%vstd!map.axiom_map_insert_domain. fuel%vstd!map.axiom_map_insert_same. fuel%vstd!map.axiom_map_insert_different. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!map.check_argument_is_map. fuel%vstd!map_lib.impl&%0.union_prefer_right. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_mk_map_domain. fuel%vstd!set.axiom_mk_map_index. fuel%vstd!set.axiom_set_empty_finite. fuel%vstd!set.axiom_set_insert_finite. fuel%lib!abstract_system.MsgHistory_v.impl&%0.wf. fuel%lib!abstract_system.MsgHistory_v.impl&%0.ext_equal. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_key. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_exactly. fuel%lib!abstract_system.MsgHistory_v.impl&%0.is_empty. fuel%lib!abstract_system.MsgHistory_v.impl&%0.len. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_follow. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_concat. fuel%lib!abstract_system.MsgHistory_v.impl&%0.concat. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to. fuel%lib!abstract_system.MsgHistory_v.impl&%0.discard_recent. fuel%lib!abstract_system.MsgHistory_v.impl&%0._dr. fuel%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map. fuel%lib!abstract_system.MsgHistory_v.impl&%0.discard_old. fuel%lib!abstract_system.MsgHistory_v.impl&%0._do. fuel%lib!abstract_system.MsgHistory_v.impl&%0.maybe_discard_old. fuel%lib!abstract_system.MsgHistory_v.impl&%0.includes_subseq. fuel%lib!abstract_system.MsgHistory_v.impl&%0.empty_history_at. fuel%lib!abstract_system.MsgHistory_v.impl&%0.singleton_at. fuel%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history. fuel%lib!spec.Messages_t.nop_delta. fuel%lib!spec.Messages_t.impl&%1.combine_deltas. fuel%lib!spec.Messages_t.impl&%1.apply_delta. fuel%lib!spec.Messages_t.impl&%1.merge. fuel%lib!spec.TotalKMMap_t.total_domain. fuel%lib!spec.TotalKMMap_t.impl&%0.spec_index. fuel%lib!spec.TotalKMMap_t.impl&%0.insert. fuel%lib!spec.TotalKMMap_t.impl&%0.dom. fuel%lib!spec.TotalKMMap_t.impl&%0.wf. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(declare-datatypes ((lib!abstract_system.MsgHistory_v.KeyedMessage. 0) (lib!abstract_system.MsgHistory_v.MsgHistory. 0) (lib!abstract_system.StampedMap_v.Stamped. 0) (lib!spec.KeyType_t.Key. 0) (lib!spec.Messages_t.Value. 0) (lib!spec.Messages_t.Delta. 0) (lib!spec.Messages_t.Message. 0) (lib!spec.TotalKMMap_t.TotalKMMap. 0) (tuple%0. 0) (tuple%2. 0)) (((lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage (lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage/?key lib!spec.KeyType_t.Key.) (lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage/?message lib!spec.Messages_t.Message.))) ((lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/?msgs vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>.) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/?seq_start Int) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/?seq_end Int))) ((lib!abstract_system.StampedMap_v.Stamped./Stamped (lib!abstract_system.StampedMap_v.Stamped./Stamped/?value Poly) (lib!abstract_system.StampedMap_v.Stamped./Stamped/?seq_end Int))) ((lib!spec.KeyType_t.Key./Key (lib!spec.KeyType_t.Key./Key/?0 Int))) ((lib!spec.Messages_t.Value./Value (lib!spec.Messages_t.Value./Value/?0 Int))) ((lib!spec.Messages_t.Delta./Delta (lib!spec.Messages_t.Delta./Delta/?0 Int))) ((lib!spec.Messages_t.Message./Define (lib!spec.Messages_t.Message./Define/?value lib!spec.Messages_t.Value.)) (lib!spec.Messages_t.Message./Update (lib!spec.Messages_t.Message./Update/?delta lib!spec.Messages_t.Delta.))) ((lib!spec.TotalKMMap_t.TotalKMMap./TotalKMMap (lib!spec.TotalKMMap_t.TotalKMMap./TotalKMMap/?0 vstd!map.Map<lib!spec.KeyType_t.Key./lib!spec.Messages_t.Message.>.))) ((tuple%0./tuple%0 )) ((tuple%2./tuple%2 (tuple%2./tuple%2/?0 Poly) (tuple%2./tuple%2/?1 Poly)))))
...
(set-info :comment ";; Function-Decl lib::abstract_system::MsgHistory_v::MsgHistory::singleton_at")
...
(set-info :comment ";; Function-Decl lib::abstract_system::MsgHistory_v::MsgHistory::contains_key")
(declare-fun lib!abstract_system.MsgHistory_v.impl&%0.contains_key.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::abstract_system::MsgHistory_v::MsgHistory::_dr")
(declare-fun lib!abstract_system.MsgHistory_v.impl&%0._dr.? (Poly Poly) lib!abstract_system.MsgHistory_v.MsgHistory.)
(set-info :comment ";; Function-Decl lib::abstract_system::MsgHistory_v::MsgHistory::_do")
...
(assert (forall ((self! Poly) (idx! Poly)) (! (= (req%lib!spec.TotalKMMap_t.impl&%0.spec_index. self! idx!) (=> %%global_location_label%%2 (lib!spec.TotalKMMap_t.impl&%0.wf.? self!))) :pattern ((req%lib!spec.TotalKMMap_t.impl&%0.spec_index. self! idx!)) )))
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::contains")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:57:3: 57:61 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::contains_exactly")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:68:3: 68:75 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::wf")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:39:3: 39:45 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::can_follow")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:83:3: 83:63 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::can_concat")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:87:3: 87:72 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::can_discard_to")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:152:3: 152:67 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::discard_old")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:244:3: 244:70 (#0)")
...
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Poly) (k$ Poly)) (! (= (%%apply%%0 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4) k$) (vstd!map.impl&%0.index.? %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 k$)) :pattern ((%%apply%%0 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4) k$)))))
(assert (=> (fuel_bool fuel%lib!abstract_system.MsgHistory_v.impl&%0.discard_old.) (forall ((self! Poly) (lsn! Poly)) (! (= (lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? self! lsn!) (let ((keepMap$ (%Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (vstd!map.impl&%0.new.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. $ (TYPE%fun%1. $ NAT $ BOOL) $ (TYPE%fun%1. $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage.) (Poly%fun%1. (mk_fun (%%lambda%%5 (%I lsn!) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))))) (Poly%fun%1. (mk_fun (%%lambda%%6 $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))))))))) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory (%Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. keepMap$)) (%I lsn!) (%I (I (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))))))) :pattern ((lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? self! lsn!)) ))))
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::maybe_discard_old")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:260:3: 260:76 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::concat")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:91:3: 91:74 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::discard_recent")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:157:3: 157:73 (#0)")
...
(assert (=> (fuel_bool fuel%lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.) (forall ((self! Poly) (lsn! Poly)) (! (= (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? self! lsn!) (let ((keepMap$ (%Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (vstd!map.impl&%0.new.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. $ (TYPE%fun%1. $ NAT $ BOOL) $ (TYPE%fun%1. $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage.) (Poly%fun%1. (mk_fun (%%lambda%%5 (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) (%I lsn!)))) (Poly%fun%1. (mk_fun (%%lambda%%6 $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))))))))) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory (%Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. keepMap$)) (%I (I (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))) (%I lsn!)))) :pattern ((lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? self! lsn!)) ))))
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::empty_history_at")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:312:3: 312:69 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::is_empty")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:72:3: 72:51 (#0)")
...
(assert (forall ((self! Poly)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.len. self!) (=> %%global_location_label%%8 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.len. self!)) )))
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::len")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:76:3: 76:45 (#0)")
...
(assert (forall ((self! Poly) (orig! Poly)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map. self! orig!) (and (=> %%global_location_label%%9 (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? self! (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))))) (=> %%global_location_label%%10 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!)))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map. self! orig!)) )))
(set-info :comment ";; Spec-Termination lib::abstract_system::MsgHistory_v::MsgHistory::apply_to_stamped_map")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:176:3: 176:78 (#0)")
...
(assert (forall ((stamped_map! Poly) (history! Poly)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history. stamped_map! history!) (and (=> %%global_location_label%%11 (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!)))) (=> %%global_location_label%%12 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? history!)) (=> %%global_location_label%%13 (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? history! (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!))))))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history. stamped_map! history!)) )))
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::map_plus_history")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:320:3: 320:105 (#0)")
...
(assert (forall ((self! Poly) (subseq! Poly)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.includes_subseq. self! subseq!) (and (=> %%global_location_label%%14 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!)) (=> %%global_location_label%%15 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? subseq!)))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.includes_subseq. self! subseq!)) )))
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::includes_subseq")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:302:3: 302:78 (#0)")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::singleton_at")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:316:3: 316:84 (#0)")
(set-info :comment ";; Function-Axioms lib::abstract_system::MsgHistory_v::MsgHistory::singleton_at")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::ext_equal")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:45:3: 45:71 (#0)")
...
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::contains_key")
(declare-fun req%lib!abstract_system.MsgHistory_v.impl&%0.contains_key. (Poly Poly) Bool)
(declare-const %%global_location_label%%16 Bool)
(assert (forall ((self! Poly) (key! Poly)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.contains_key. self! key!) (=> %%global_location_label%%16 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.contains_key. self! key!)) )))
(set-info :comment ";; Function-Axioms lib::abstract_system::MsgHistory_v::MsgHistory::contains_key")
(assert (fuel_bool_default fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_key.))
(assert (=> (fuel_bool fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_key.) (forall ((self! Poly) (key! Poly)) (! (= (lib!abstract_system.MsgHistory_v.impl&%0.contains_key.? self! key!) (exists ((lsn$ Poly)) (! (and (has_type lsn$ NAT) (= (lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage/key (%Poly%lib!abstract_system.MsgHistory_v.KeyedMessage. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) lsn$))) (%Poly%lib!spec.KeyType_t.Key. key!))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) lsn$)) ))) :pattern ((lib!abstract_system.MsgHistory_v.impl&%0.contains_key.? self! key!)) ))))
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::_dr")
(declare-fun req%lib!abstract_system.MsgHistory_v.impl&%0._dr. (Poly Poly) Bool)
(declare-const %%global_location_label%%17 Bool)
(assert (forall ((self! Poly) (lsn! Poly)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0._dr. self! lsn!) (=> %%global_location_label%%17 (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? self! lsn!))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0._dr. self! lsn!)) )))
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::_dr")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:168:3: 168:62 (#0)")
(set-info :comment ";; Function-Axioms lib::abstract_system::MsgHistory_v::MsgHistory::_dr")
...
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::_do")
(declare-fun req%lib!abstract_system.MsgHistory_v.impl&%0._do. (Poly Poly) Bool)
(declare-const %%global_location_label%%18 Bool)
(assert (forall ((self! Poly) (lsn! Poly)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0._do. self! lsn!) (=> %%global_location_label%%18 (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? self! lsn!))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0._do. self! lsn!)) )))
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::_do")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:254:3: 254:62 (#0)")
(set-info :comment ";; Function-Axioms lib::abstract_system::MsgHistory_v::MsgHistory::_do")
...
(assert (forall ((self! lib!abstract_system.MsgHistory_v.MsgHistory.) (other! lib!abstract_system.MsgHistory_v.MsgHistory.)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.concat_lemma. self! other!) (and (=> %%global_location_label%%19 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (=> %%global_location_label%%20 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. other!))) (=> %%global_location_label%%21 (lib!abstract_system.MsgHistory_v.impl&%0.can_concat.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. other!))))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.concat_lemma. self! other!)) )))
...
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::concat_lemma")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:103:3: 103:53 (#0)")
(set-info :comment ";; Function-Specs lib::spec::TotalKMMap_t::TotalKMMap::insert_lemma")
(declare-fun req%lib!spec.TotalKMMap_t.impl&%0.insert_lemma. (lib!spec.TotalKMMap_t.TotalKMMap.) Bool)
(declare-const %%global_location_label%%22 Bool)
(assert (forall ((self! lib!spec.TotalKMMap_t.TotalKMMap.)) (! (= (req%lib!spec.TotalKMMap_t.impl&%0.insert_lemma. self!) (=> %%global_location_label%%22 (lib!spec.TotalKMMap_t.impl&%0.wf.? (Poly%lib!spec.TotalKMMap_t.TotalKMMap. self!)))) :pattern ((req%lib!spec.TotalKMMap_t.impl&%0.insert_lemma. self!)) )))
(declare-fun ens%lib!spec.TotalKMMap_t.impl&%0.insert_lemma. (lib!spec.TotalKMMap_t.TotalKMMap.) Bool)
(assert (forall ((self! lib!spec.TotalKMMap_t.TotalKMMap.)) (! (= (ens%lib!spec.TotalKMMap_t.impl&%0.insert_lemma. self!) (forall ((k$ Poly) (v$ Poly)) (! (=> (and (has_type k$ TYPE%lib!spec.KeyType_t.Key.) (has_type v$ TYPE%lib!spec.Messages_t.Message.)) (lib!spec.TotalKMMap_t.impl&%0.wf.? (Poly%lib!spec.TotalKMMap_t.TotalKMMap. (lib!spec.TotalKMMap_t.impl&%0.insert.? (Poly%lib!spec.TotalKMMap_t.TotalKMMap. self!) k$ v$)))) :pattern ((lib!spec.TotalKMMap_t.impl&%0.insert.? (Poly%lib!spec.TotalKMMap_t.TotalKMMap. self!) k$ v$)) ))) :pattern ((ens%lib!spec.TotalKMMap_t.impl&%0.insert_lemma. self!)) )))
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::apply_to_stamped_map_wf_lemma")
(declare-fun req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_wf_lemma. (lib!abstract_system.MsgHistory_v.MsgHistory. lib!abstract_system.StampedMap_v.Stamped.) Bool)
(declare-const %%global_location_label%%23 Bool)
(declare-const %%global_location_label%%24 Bool)
(declare-const %%global_location_label%%25 Bool)
(assert (forall ((self! lib!abstract_system.MsgHistory_v.MsgHistory.) (orig! lib!abstract_system.StampedMap_v.Stamped.)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_wf_lemma. self! orig!) (and (=> %%global_location_label%%23 (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))))) (=> %%global_location_label%%24 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (=> %%global_location_label%%25 (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!)))))))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_wf_lemma. self! orig!)) )))
(declare-fun ens%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_wf_lemma. (lib!abstract_system.MsgHistory_v.MsgHistory. lib!abstract_system.StampedMap_v.Stamped.) Bool)
(assert (forall ((self! lib!abstract_system.MsgHistory_v.MsgHistory.) (orig! lib!abstract_system.StampedMap_v.Stamped.)) (! (= (ens%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_wf_lemma. self! orig!) (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. (lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))))))) :pattern ((ens%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_wf_lemma. self! orig!)) )))
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::apply_to_stamped_map_wf_lemma")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:204:3: 204:69 (#0)")
...
(assert (forall ((self! lib!abstract_system.MsgHistory_v.MsgHistory.) (orig! lib!abstract_system.StampedMap_v.Stamped.)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_length_lemma. self! orig!) (and (=> %%global_location_label%%26 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (=> %%global_location_label%%27 (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!)))))))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_length_lemma. self! orig!)) )))
...
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::apply_to_stamped_map_length_lemma")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:229:3: 229:73 (#0)")
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::map_plus_history_seq_end_lemma")
(declare-fun req%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_seq_end_lemma. (lib!abstract_system.StampedMap_v.Stamped. lib!abstract_system.MsgHistory_v.MsgHistory.) Bool)
(declare-const %%global_location_label%%28 Bool)
(declare-const %%global_location_label%%29 Bool)
(declare-const %%global_location_label%%30 Bool)
(assert (forall ((stamped_map! lib!abstract_system.StampedMap_v.Stamped.) (history! lib!abstract_system.MsgHistory_v.MsgHistory.)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_seq_end_lemma. stamped_map! history!) (and (=> %%global_location_label%%28 (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!))))) (=> %%global_location_label%%29 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. history!))) (=> %%global_location_label%%30 (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. history!) (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!)))))))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_seq_end_lemma. stamped_map! history!)) )))
(declare-fun ens%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_seq_end_lemma. (lib!abstract_system.StampedMap_v.Stamped. lib!abstract_system.MsgHistory_v.MsgHistory.) Bool)
(assert (forall ((stamped_map! lib!abstract_system.StampedMap_v.Stamped.) (history! lib!abstract_system.MsgHistory_v.MsgHistory.)) (! (= (ens%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_seq_end_lemma. stamped_map! history!) (= (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. (lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. history!) (Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!))))) (nClip (Add (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!))) (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. history!)))))) :pattern ((ens%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_seq_end_lemma. stamped_map! history!)) )))
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::map_plus_history_seq_end_lemma")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:376:3: 376:92 (#0)")
...
(assert (forall ((stamped_map! lib!abstract_system.StampedMap_v.Stamped.) (history! lib!abstract_system.MsgHistory_v.MsgHistory.)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_lemma. stamped_map! history!) (and (=> %%global_location_label%%31 (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!))))) (=> %%global_location_label%%32 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. history!))) (=> %%global_location_label%%33 (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. history!) (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!)))))))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_lemma. stamped_map! history!)) )))
...
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::map_plus_history_lemma")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:329:3: 329:84 (#0)")
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::map_plus_history_forall_lemma")
(declare-fun ens%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_forall_lemma. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_forall_lemma. no%param) (forall ((stamped_map$ Poly) (history$ Poly)) (! (=> (and (has_type stamped_map$ (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.)) (has_type history$ TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.)) (=> (and (and (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map$))) (lib!abstract_system.MsgHistory_v.impl&%0.wf.? history$)) (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? history$ (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map$))))) (and (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. (lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history.? stamped_map$ history$))))) (= (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. (lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history.? stamped_map$ history$)))) (nClip (Add (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map$)) (lib!abstract_system.MsgHistory_v.impl&%0.len.? history$))))))) :pattern ((lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history.? stamped_map$ history$)) ))) :pattern ((ens%lib!abstract_system.MsgHistory_v.impl&%0.map_plus_history_forall_lemma. no%param)) )))
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::map_plus_history_forall_lemma")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:343:3: 343:47 (#0)")
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::ext_equal_is_equality")
(declare-fun ens%lib!abstract_system.MsgHistory_v.impl&%0.ext_equal_is_equality. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!abstract_system.MsgHistory_v.impl&%0.ext_equal_is_equality. no%param) (forall ((a$ Poly) (b$ Poly)) (! (=> (and (has_type a$ TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.) (has_type b$ TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.)) (= (lib!abstract_system.MsgHistory_v.impl&%0.ext_equal.? a$ b$) (= a$ b$))) :pattern ((lib!abstract_system.MsgHistory_v.impl&%0.ext_equal.? a$ b$)) ))) :pattern ((ens%lib!abstract_system.MsgHistory_v.impl&%0.ext_equal_is_equality. no%param)) )))
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::ext_equal_is_equality")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:51:3: 51:39 (#0)")
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::concat_forall_lemma")
...
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::concat_forall_lemma")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:121:3: 121:37 (#0)")
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::discard_order_is_commutative")
(declare-fun req%lib!abstract_system.MsgHistory_v.impl&%0.discard_order_is_commutative. (lib!abstract_system.MsgHistory_v.MsgHistory. Int Int) Bool)
(declare-const %%global_location_label%%34 Bool)
(declare-const %%global_location_label%%35 Bool)
(declare-const %%global_location_label%%36 Bool)
(assert (forall ((self! lib!abstract_system.MsgHistory_v.MsgHistory.) (start! Int) (end! Int)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.discard_order_is_commutative. self! start! end!) (and (=> %%global_location_label%%34 (<= start! end!)) (=> %%global_location_label%%35 (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I start!))) (=> %%global_location_label%%36 (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I end!))))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.discard_order_is_commutative. self! start! end!)) )))
(declare-fun ens%lib!abstract_system.MsgHistory_v.impl&%0.discard_order_is_commutative. (lib!abstract_system.MsgHistory_v.MsgHistory. Int Int) Bool)
(assert (forall ((self! lib!abstract_system.MsgHistory_v.MsgHistory.) (start! Int) (end! Int)) (! (= (ens%lib!abstract_system.MsgHistory_v.impl&%0.discard_order_is_commutative. self! start! end!) (= (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I start!))) (I end!)) (lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I end!))) (I start!)))) :pattern ((ens%lib!abstract_system.MsgHistory_v.impl&%0.discard_order_is_commutative. self! start! end!)) )))
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::discard_order_is_commutative")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:273:3: 273:72 (#0)")
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::added_slices_union")
(declare-fun req%lib!abstract_system.MsgHistory_v.impl&%0.added_slices_union. (lib!abstract_system.MsgHistory_v.MsgHistory. Int) Bool)
(declare-const %%global_location_label%%37 Bool)
(declare-const %%global_location_label%%38 Bool)
(assert (forall ((self! lib!abstract_system.MsgHistory_v.MsgHistory.) (middle! Int)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.added_slices_union. self! middle!) (and (=> %%global_location_label%%37 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (=> %%global_location_label%%38 (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I middle!))))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.added_slices_union. self! middle!)) )))
(declare-fun ens%lib!abstract_system.MsgHistory_v.impl&%0.added_slices_union. (lib!abstract_system.MsgHistory_v.MsgHistory. Int) Bool)
(assert (forall ((self! lib!abstract_system.MsgHistory_v.MsgHistory.) (middle! Int)) (! (= (ens%lib!abstract_system.MsgHistory_v.impl&%0.added_slices_union. self! middle!) (= (lib!abstract_system.MsgHistory_v.impl&%0.concat.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I middle!))) (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I middle!)))) self!)) :pattern ((ens%lib!abstract_system.MsgHistory_v.impl&%0.added_slices_union. self! middle!)) )))
(set-info :comment ";; Function-Def lib::abstract_system::MsgHistory_v::MsgHistory::added_slices_union")
(set-info :comment ";; abstract_system/MsgHistory_v.rs:287:3: 287:53 (#0)")
(declare-const self! lib!abstract_system.MsgHistory_v.MsgHistory.)
(declare-const middle! Int)
(declare-const tmp%1 Bool)
(declare-const other@ lib!abstract_system.MsgHistory_v.MsgHistory.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.))
(assert (<= 0 middle!))
(assert (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))
(assert (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I middle!)))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= other@ (lib!abstract_system.MsgHistory_v.impl&%0.concat.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I middle!))) (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I middle!))))) (=> (= tmp%1 (lib!abstract_system.MsgHistory_v.impl&%0.ext_equal.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. other@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (= (lib!abstract_system.MsgHistory_v.impl&%0.concat.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I middle!))) (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I middle!)))) self!))))))))
(check-sat)
(exit)
