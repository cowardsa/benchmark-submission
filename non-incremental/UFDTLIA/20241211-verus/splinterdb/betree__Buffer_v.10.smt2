...
(assert (not (=> %%location_label%%0 (= (%Poly%lib!spec.Messages_t.Message. (lib!betree.Buffer_v.Buffer.query.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. self! key!)) (lib!betree.Buffer_v.impl&%1.query_internal.? (lib!betree.Buffer_v.Buffer.i.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. self!) key!)))))
(check-sat)
(exit)
