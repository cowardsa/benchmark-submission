...
(assert (not (=> (is-lib!betree.PivotBranch_v.Node./Index_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (and (<= 0 (%I i!)) (< (%I i!) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!)))))) (=> (let ((tmp%%$ (Sub (%I i!) 1))) (and (<= 0 tmp%%$) (< tmp%%$ (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!))))))) (=> (has_type key@ TYPE%lib!spec.KeyType_t.Key.) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.PivotBranch_v.Node. tmp%2 i!)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!))) i!)) (or (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? tmp%1)) key@) (=> (= tmp%4 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (=> (= tmp%5 (I (Sub (%I i!) 1))) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Key. tmp%4 tmp%5)) (=> (= tmp%3 (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!))) (I (Sub (%I i!) 1)))) (=> (= tmp%6 (lib!spec.KeyType_t.impl&%1.lte.? tmp%3 key@)) %%switch_label%%0)))))) (=> (not (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? tmp%1)) key@)) (=> (= tmp%6 true) %%switch_label%%0))) (not %%switch_label%%0)))))))))))
(check-sat)
(exit)
