...
(declare-const %return! lib!betree.BufferSeq_v.BufferSeq.)
(declare-const self! Poly)
(declare-const addrs! Poly)
(declare-const i@ Poly)
(declare-const buffers@ vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>.)
(assert fuel_defaults)
(assert (has_type self! (TYPE%lib!betree.BufferDisk_v.BufferDisk. T&. T&)))
(assert (has_type addrs! TYPE%lib!betree.LinkedSeq_v.LinkedSeq.))
(assert (tr_bound%lib!betree.Buffer_v.Buffer. T&. T&))
(declare-fun %%lambda%%3 (Dcr Type Poly Dcr Type Dcr Type Poly Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Poly) (%%hole%%8 Dcr) (%%hole%%9 Type) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) i$) (lib!betree.Buffer_v.Buffer.i.? %%hole%%8 %%hole%%9 (vstd!map.impl&%0.index.? %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 (vstd!seq.Seq.index.? %%hole%%0 %%hole%%1 %%hole%%2 i$)))) :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) i$)))))
(assert (not true))
(check-sat)
(exit)
