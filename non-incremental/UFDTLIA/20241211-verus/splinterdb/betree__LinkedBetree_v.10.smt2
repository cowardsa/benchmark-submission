...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%1.entries_wf.? self!) (=> (has_type addr@ TYPE%lib!spec.AsyncDisk_t.Address.) (or (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!)))) addr@) (=> (= tmp%2 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!)))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. tmp%2 addr@)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!))) addr@)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%1.node_has_nondangling_child_ptrs. self! tmp%1)) (=> (= tmp%3 (lib!betree.LinkedBetree_v.impl&%1.node_has_nondangling_child_ptrs.? self! tmp%1)) (or (and (=> tmp%3 (=> (= tmp%5 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!)))) (and (=> %%location_label%%2 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. tmp%5 addr@)) (=> (= tmp%4 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!))) addr@)) (and (=> %%location_label%%3 (req%lib!betree.LinkedBetree_v.impl&%1.node_has_linked_children. self! tmp%4)) (=> (= tmp%6 (lib!betree.LinkedBetree_v.impl&%1.node_has_linked_children.? self! tmp%4)) (=> (= tmp%7 tmp%6) %%switch_label%%1))))))) (=> (not tmp%3) (=> (= tmp%7 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%8 tmp%7) %%switch_label%%0))))))))) (=> (not (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!)))) addr@)) (=> (= tmp%8 true) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
