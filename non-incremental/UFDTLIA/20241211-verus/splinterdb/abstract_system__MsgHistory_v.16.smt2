...
(assert (has_type subseq! TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.))
...
(assert (not (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!) (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? subseq!) (or (and (=> (and (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. subseq!))) (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. subseq!)) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))) (=> (has_type lsn@ NAT) (or (and (=> (lib!abstract_system.MsgHistory_v.impl&%0.contains.? subseq! lsn@) (or (and (=> (lib!abstract_system.MsgHistory_v.impl&%0.contains.? self! lsn@) (=> (= tmp%2 (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. tmp%2 lsn@)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) lsn@)) (=> (= tmp%4 (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. subseq!)))) (and (=> %%location_label%%1 (req%vstd!map.impl&%0.spec_index. $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. tmp%4 lsn@)) (=> (= tmp%3 (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. subseq!))) lsn@)) (=> (= tmp%5 (= tmp%1 tmp%3)) %%switch_label%%2)))))))) (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.contains.? self! lsn@)) (=> (= tmp%5 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%6 tmp%5) %%switch_label%%1)))) (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.contains.? subseq! lsn@)) (=> (= tmp%6 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%7 (forall ((lsn$ Poly)) (! (=> (has_type lsn$ NAT) (=> (lib!abstract_system.MsgHistory_v.impl&%0.contains.? subseq! lsn$) (and (lib!abstract_system.MsgHistory_v.impl&%0.contains.? self! lsn$) (= (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) lsn$) (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. subseq!))) lsn$))))) :pattern ((lib!abstract_system.MsgHistory_v.impl&%0.contains.? subseq! lsn$)) :pattern ((lib!abstract_system.MsgHistory_v.impl&%0.contains.? self! lsn$)) ))) %%switch_label%%0))))) (=> (not (and (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. subseq!))) (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. subseq!)) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))))) (=> (= tmp%7 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
