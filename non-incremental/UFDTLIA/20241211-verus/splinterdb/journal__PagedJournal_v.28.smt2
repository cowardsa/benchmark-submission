...
(assert (<= 0 depth!))
(assert (lib!journal.PagedJournal_v.impl&%0.can_crop_head_records.? (Poly%lib!journal.PagedJournal_v.JournalRecord. self!) (I boundary_lsn!) (I depth!)))
...
(assert (not (=> (= decrease%init0 depth!) (=> (= decrease%init1 0) (or (and (=> (not (= depth! 0)) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%0.cropped_prior.? (Poly%lib!journal.PagedJournal_v.JournalRecord. self!) (I boundary_lsn!))) (=> (= tmp%2 (nClip (Sub depth! 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((ojr!$0 tmp%1) (boundary_lsn!$1 boundary_lsn!) (depth!$2 tmp%2)) depth!$2) decrease%init0 (check_decrease_int (let ((ojr!$0 tmp%1) (boundary_lsn!$1 boundary_lsn!) (depth!$2 tmp%2)) 1) decrease%init1 false))) (and (=> %%location_label%%1 (req%lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records_lemma. tmp%1 boundary_lsn! tmp%2)) (=> (ens%lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records_lemma. tmp%1 boundary_lsn! tmp%2) %%switch_label%%0)))))) (=> (not (not (= depth! 0))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (let ((out$ (lib!journal.PagedJournal_v.impl&%0.crop_head_records.? (Poly%lib!journal.PagedJournal_v.JournalRecord. self!) (I boundary_lsn!) (I depth!)))) (=> (is-core!option.Option./Some_ out$) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. out$))) (I boundary_lsn!)))))))))))
(check-sat)
(exit)
