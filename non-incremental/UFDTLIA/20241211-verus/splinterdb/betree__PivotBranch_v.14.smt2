...
(assert (not (or (and (=> (and (lib!betree.PivotBranch_v.impl&%3.wf.? (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!)))) (=> (< 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!))) (is-lib!betree.PivotBranch_v.Node./Index_ (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!))))) (or (and (=> (< 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!))) (and (=> %%location_label%%0 (req%lib!betree.PivotBranch_v.impl&%4.subpath. self!)) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%4.subpath.? self!)) (=> (= tmp%2 (lib!betree.PivotBranch_v.impl&%4.valid.? (Poly%lib!betree.PivotBranch_v.Path. tmp%1))) %%switch_label%%1)))) (=> (not (< 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!)))) (=> (= tmp%2 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%3 tmp%2) %%switch_label%%0)))) (=> (not (and (lib!betree.PivotBranch_v.impl&%3.wf.? (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!)))) (=> (< 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!))) (is-lib!betree.PivotBranch_v.Node./Index_ (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!)))))) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
