...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%8.structure.? T&. T& self!) (=> (and (<= 0 (%I i!)) (< (%I i!) (Sub (vstd!seq.Seq.len.? $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))) 1))) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%8.node. T&. T& self! i!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%8.node.? T&. T& self! i!)) (=> (lib!betree.LinkedBetree_v.impl&%0.key_in_domain.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. (lib!betree.LinkedBetree_v.impl&%8.node.? T&. T& self! i!)) (Poly%lib!spec.KeyType_t.Key. (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/key (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!)))) (=> (= tmp%3 (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))) (=> (= tmp%4 (I (Add (%I i!) 1))) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) tmp%3 tmp%4)) (=> (= tmp%2 (vstd!seq.Seq.index.? $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!)) (I (Add (%I i!) 1)))) (and (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%8.node. T&. T& self! i!)) (=> (= tmp%5 (lib!betree.LinkedBetree_v.impl&%8.node.? T&. T& self! i!)) (=> (= tmp%7 (Poly%lib!spec.KeyType_t.Key. (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/key (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!)))) (=> %%location_label%%3 (req%lib!betree.LinkedBetree_v.impl&%0.child_ptr. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%5) tmp%7))))))))))))))))
(check-sat)
(exit)
