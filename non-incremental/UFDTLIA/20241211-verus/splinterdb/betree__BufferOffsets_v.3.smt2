...
(assert (not (=> (and (<= 0 (%I idx!)) (< (%I idx!) (lib!betree.BufferOffsets_v.impl&%0.len.? self!))) (=> (= tmp%2 (Poly%vstd!seq.Seq<nat.>. (lib!betree.BufferOffsets_v.BufferOffsets./BufferOffsets/offsets (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ NAT tmp%2 idx!)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!betree.BufferOffsets_v.BufferOffsets./BufferOffsets/offsets (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. self!))) idx!)) (=> (= tmp%4 (Poly%vstd!seq.Seq<nat.>. (lib!betree.BufferOffsets_v.BufferOffsets./BufferOffsets/offsets (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. self!)))) (=> %%location_label%%1 (req%vstd!seq_lib.impl&%0.insert. $ NAT tmp%4 idx! tmp%1)))))))))
(check-sat)
(exit)
