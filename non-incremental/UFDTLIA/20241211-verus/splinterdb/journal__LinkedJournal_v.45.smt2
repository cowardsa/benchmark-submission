...
(assert (lib!journal.LinkedJournal_v.impl&%1.block_in_bounds.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))
(assert (lib!journal.LinkedJournal_v.impl&%1.can_crop.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!) (I depth!)))
...
(assert (not (=> (= decrease%init0 depth!) (or (and (=> (> depth! 0) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (=> (= tmp%2 (nClip (Sub depth! 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 self!) (root!$1 tmp%1) (depth!$2 tmp%2)) depth!$2) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.pointer_after_crop_ensures. self! tmp%1 tmp%2)) (=> (ens%lib!journal.LinkedJournal_v.impl&%1.pointer_after_crop_ensures. self! tmp%1 tmp%2) %%switch_label%%0)))))) (=> (not (> depth! 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%2 (lib!journal.LinkedJournal_v.impl&%1.is_nondangling_pointer.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.pointer_after_crop.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!) (I depth!))))) (=> %%location_label%%3 (lib!journal.LinkedJournal_v.impl&%1.block_in_bounds.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.pointer_after_crop.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!) (I depth!)))))))))))
(check-sat)
(exit)
