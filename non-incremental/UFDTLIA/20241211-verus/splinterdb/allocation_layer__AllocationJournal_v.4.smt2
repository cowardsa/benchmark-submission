...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.wf.? self!) (and (=> %%location_label%%0 (req%lib!allocation_layer.AllocationJournal_v.impl&%1.nonzero_pages_point_backward. self!)) (=> (= tmp%1 (lib!allocation_layer.AllocationJournal_v.impl&%1.nonzero_pages_point_backward.? self!)) (or (and (=> tmp%1 (and (=> %%location_label%%1 (req%lib!allocation_layer.AllocationJournal_v.impl&%1.pages_allocated_in_lsn_order. self!)) (=> (= tmp%2 (lib!allocation_layer.AllocationJournal_v.impl&%1.pages_allocated_in_lsn_order.? self!)) (=> (= tmp%3 tmp%2) %%switch_label%%0)))) (=> (not tmp%1) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
