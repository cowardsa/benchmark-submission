...
(set-info :comment ";; MODULE 'module betree::PivotTable_v'")
...
(set-info :comment ";; Function-Decl lib::betree::PivotTable_v::PivotTable::pivot_range_keyset")
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::num_ranges")
(set-info :comment ";; betree/PivotTable_v.rs:35:5: 35:54 (#0)")
...
(assert (forall ((elem! Poly)) (! (= (req%lib!spec.KeyType_t.to_key. elem!) (=> %%global_location_label%%6 (is-lib!spec.KeyType_t.Element./Elem_ (%Poly%lib!spec.KeyType_t.Element. elem!)))) :pattern ((req%lib!spec.KeyType_t.to_key. elem!)) )))
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::wf")
(set-info :comment ";; betree/PivotTable_v.rs:40:5: 40:47 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::bounded_key")
(set-info :comment ";; betree/PivotTable_v.rs:105:5: 105:66 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::route")
(set-info :comment ";; betree/PivotTable_v.rs:113:5: 113:59 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::domain_to_pivots")
(set-info :comment ";; betree/PivotTable_v.rs:28:1: 28:73 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::len")
(set-info :comment ";; betree/PivotTable_v.rs:47:5: 47:47 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::update")
(set-info :comment ";; betree/PivotTable_v.rs:59:5: 59:83 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::can_insert")
(set-info :comment ";; betree/PivotTable_v.rs:71:5: 71:81 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::insert")
(set-info :comment ";; betree/PivotTable_v.rs:81:5: 81:83 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::subrange")
(set-info :comment ";; betree/PivotTable_v.rs:65:5: 65:81 (#0)")
...
(set-info :comment ";; Function-Specs lib::spec::KeyType_t::Element::lte_transitive_forall")
(declare-fun ens%lib!spec.KeyType_t.impl&%2.lte_transitive_forall. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!spec.KeyType_t.impl&%2.lte_transitive_forall. no%param) (forall ((a$ Poly) (b$ Poly) (c$ Poly)) (! (=> (and (has_type a$ TYPE%lib!spec.KeyType_t.Element.) (has_type b$ TYPE%lib!spec.KeyType_t.Element.) (has_type c$ TYPE%lib!spec.KeyType_t.Element.)) (=> (and (lib!spec.KeyType_t.impl&%2.lte.? a$ b$) (lib!spec.KeyType_t.impl&%2.lte.? b$ c$)) (lib!spec.KeyType_t.impl&%2.lte.? a$ c$))) :pattern ((lib!spec.KeyType_t.impl&%2.lte.? a$ b$) (lib!spec.KeyType_t.impl&%2.lte.? b$ c$)) :pattern ((lib!spec.KeyType_t.impl&%2.lte.? a$ b$) (lib!spec.KeyType_t.impl&%2.lte.? a$ c$)) :pattern ((lib!spec.KeyType_t.impl&%2.lte.? b$ c$) (lib!spec.KeyType_t.impl&%2.lte.? a$ c$)) :pattern ((lib!spec.KeyType_t.impl&%2.lte.? b$ c$) (lib!spec.KeyType_t.impl&%2.lte.? a$ c$)) ))) :pattern ((ens%lib!spec.KeyType_t.impl&%2.lte_transitive_forall. no%param)) )))
(set-info :comment ";; Function-Specs lib::spec::KeyType_t::Element::largest_lte_lemma")
(declare-fun req%lib!spec.KeyType_t.impl&%2.largest_lte_lemma. (vstd!seq.Seq<lib!spec.KeyType_t.Element.>. lib!spec.KeyType_t.Element. Int) Bool)
(declare-const %%global_location_label%%15 Bool)
(declare-const %%global_location_label%%16 Bool)
(assert (forall ((run! vstd!seq.Seq<lib!spec.KeyType_t.Element.>.) (needle! lib!spec.KeyType_t.Element.) (out! Int)) (! (= (req%lib!spec.KeyType_t.impl&%2.largest_lte_lemma. run! needle! out!) (and (=> %%global_location_label%%15 (lib!spec.KeyType_t.impl&%2.is_sorted.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!))) (=> %%global_location_label%%16 (= out! (lib!spec.KeyType_t.impl&%2.largest_lte.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!) (Poly%lib!spec.KeyType_t.Element. needle!)))))) :pattern ((req%lib!spec.KeyType_t.impl&%2.largest_lte_lemma. run! needle! out!)) )))
(declare-fun ens%lib!spec.KeyType_t.impl&%2.largest_lte_lemma. (vstd!seq.Seq<lib!spec.KeyType_t.Element.>. lib!spec.KeyType_t.Element. Int) Bool)
(assert (forall ((run! vstd!seq.Seq<lib!spec.KeyType_t.Element.>.) (needle! lib!spec.KeyType_t.Element.) (out! Int)) (! (= (ens%lib!spec.KeyType_t.impl&%2.largest_lte_lemma. run! needle! out!) (and (and (<= (Sub 0 1) out!) (< out! (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!)))) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (<= (%I i$) out!)) (lib!spec.KeyType_t.impl&%2.lte.? (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!) i$) (Poly%lib!spec.KeyType_t.Element. needle!)))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!) i$)) )) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (< out! (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!)))) (lib!spec.KeyType_t.impl&%2.lt.? (Poly%lib!spec.KeyType_t.Element. needle!) (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!) i$)))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!) i$)) )) (=> (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!) (Poly%lib!spec.KeyType_t.Element. needle!)) (and (<= 0 out!) (= (%Poly%lib!spec.KeyType_t.Element. (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. run!) (I out!))) needle!))))) :pattern ((ens%lib!spec.KeyType_t.impl&%2.largest_lte_lemma. run! needle! out!)) )))
(set-info :comment ";; Function-Def lib::betree::PivotTable_v::PivotTable::route_lemma")
(set-info :comment ";; betree/PivotTable_v.rs:121:5: 121:55 (#0)")
(declare-const self! lib!betree.PivotTable_v.PivotTable.)
(declare-const key! lib!spec.KeyType_t.Key.)
(declare-const tmp%1 vstd!seq.Seq<lib!spec.KeyType_t.Element.>.)
(declare-const tmp%2 vstd!seq.Seq<lib!spec.KeyType_t.Element.>.)
...
(assert (lib!betree.PivotTable_v.impl&%0.wf.? (Poly%lib!betree.PivotTable_v.PivotTable. self!)))
(assert (lib!betree.PivotTable_v.impl&%0.bounded_key.? (Poly%lib!betree.PivotTable_v.PivotTable. self!) (Poly%lib!spec.KeyType_t.Key. key!)))
...
(assert (not (=> (= tmp%1 (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (and (=> %%location_label%%0 (req%lib!spec.KeyType_t.impl&%2.strictly_sorted_implies_sorted. tmp%1)) (=> (ens%lib!spec.KeyType_t.impl&%2.strictly_sorted_implies_sorted. tmp%1) (=> (= tmp%2 (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (=> (= tmp%3 (lib!spec.KeyType_t.to_element.? (Poly%lib!spec.KeyType_t.Key. key!))) (=> (= tmp%4 (lib!betree.PivotTable_v.impl&%0.route.? (Poly%lib!betree.PivotTable_v.PivotTable. self!) (Poly%lib!spec.KeyType_t.Key. key!))) (and (=> %%location_label%%1 (req%lib!spec.KeyType_t.impl&%2.largest_lte_lemma. tmp%2 tmp%3 tmp%4)) (=> (ens%lib!spec.KeyType_t.impl&%2.largest_lte_lemma. tmp%2 tmp%3 tmp%4) (and (=> %%location_label%%2 (let ((tmp%%$ (lib!betree.PivotTable_v.impl&%0.route.? (Poly%lib!betree.PivotTable_v.PivotTable. self!) (Poly%lib!spec.KeyType_t.Key. key!)))) (and (<= 0 tmp%%$) (< tmp%%$ (lib!betree.PivotTable_v.impl&%0.num_ranges.? (Poly%lib!betree.PivotTable_v.PivotTable. self!)))))) (and (=> %%location_label%%3 (lib!spec.KeyType_t.impl&%2.lte.? (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (I (lib!betree.PivotTable_v.impl&%0.route.? (Poly%lib!betree.PivotTable_v.PivotTable. self!) (Poly%lib!spec.KeyType_t.Key. key!)))) (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? (Poly%lib!spec.KeyType_t.Key. key!))))) (=> %%location_label%%4 (lib!spec.KeyType_t.impl&%2.lt.? (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? (Poly%lib!spec.KeyType_t.Key. key!))) (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (I (Add (lib!betree.PivotTable_v.impl&%0.route.? (Poly%lib!betree.PivotTable_v.PivotTable. self!) (Poly%lib!spec.KeyType_t.Key. key!)) 1)))))))))))))))))
(check-sat)
(exit)
