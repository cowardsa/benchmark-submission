...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBranch_v.impl&%5.get_rank.? self! ranking!)) (=> (=> (is-lib!betree.LinkedBranch_v.Node./Index_ (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (let ((r$ (lib!betree.LinkedBranch_v.impl&%3.route.? (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) key!))) (and (and (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!)) (lib!betree.LinkedBranch_v.impl&%3.valid_child_index.? (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (I (Add r$ 1)))))) (=> (= node@ (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (= r@ (lib!betree.LinkedBranch_v.impl&%3.route.? (Poly%lib!betree.LinkedBranch_v.Node. node@) key!)) (or (and (=> (is-lib!betree.LinkedBranch_v.Node./Leaf_ node@) (=> (= tmp%3 (ite (and (>= r@ 0) (= (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.LinkedBranch_v.Node./Leaf/keys (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. node@)))) (I r@)) key!)) (%Poly%lib!spec.Messages_t.Message. (vstd!seq.Seq.index.? $ TYPE%lib!spec.Messages_t.Message. (Poly%vstd!seq.Seq<lib!spec.Messages_t.Message.>. (lib!betree.LinkedBranch_v.Node./Leaf/msgs (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. node@)))) (I r@))) (lib!spec.Messages_t.Message./Update (%Poly%lib!spec.Messages_t.Delta. (Poly%lib!spec.Messages_t.Delta. (lib!spec.Messages_t.nop_delta.? (I 0))))))) %%switch_label%%0)) (=> (not (is-lib!betree.LinkedBranch_v.Node./Leaf_ node@)) (=> (= tmp%2 (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.impl&%5.child_at_idx.? self! (I (Add r@ 1))))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. tmp%2)) (key!$1 (%Poly%lib!spec.KeyType_t.Key. key!)) (ranking!$2 (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!))) (lib!betree.LinkedBranch_v.impl&%5.get_rank.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!$0) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!$2))) decrease%init0 false)) (=> (has_type (Poly%lib!spec.Messages_t.Message. tmp%1) TYPE%lib!spec.Messages_t.Message.) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.query_internal.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.impl&%5.child_at_idx.? self! (I (Add r@ 1)))) key! ranking!)) (=> (= tmp%3 tmp%1) %%switch_label%%0))))))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
