...
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Poly) (%%hole%%2 Poly)) (! (=> (exists ((ranking$3 Poly)) (! (and (has_type ranking$3 %%hole%%0) (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? %%hole%%1 ranking$3)) :pattern ((lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? %%hole%%2 ranking$3)) )) (exists ((ranking$3 Poly)) (! (and (and (has_type ranking$3 %%hole%%0) (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? %%hole%%1 ranking$3)) (= (%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2) ranking$3)) :pattern ((lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? %%hole%%2 ranking$3))))) :pattern ((%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2)))))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.acyclic.? self!) (=> (has_type ranking$1@ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.valid_ranking. self! ranking$1@)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking$1@)) (=> (has_type ranking$2@ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (=> %%location_label%%1 (exists ((ranking$3 Poly)) (! (and (has_type ranking$3 (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking$3)) :pattern ((lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking$3)) ))))))))))
(check-sat)
(exit)
