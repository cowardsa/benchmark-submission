...
(assert (not (=> (= decrease%init0 (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)) (or (and (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))) (or (and (=> (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))) (=> (= tmp%2 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))))) (and (=> %%location_label%%0 (check_decrease_height (Poly%lib!journal.PagedJournal_v.JournalRecord. (let ((self!$0 (%Poly%lib!journal.PagedJournal_v.JournalRecord. tmp%2))) self!$0)) (Poly%lib!journal.PagedJournal_v.JournalRecord. decrease%init0) false)) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%0.wf.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))))))) (=> (= tmp%3 (and tmp%1 (lib!abstract_system.MsgHistory_v.impl&%0.can_concat.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))))))) (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))))) %%switch_label%%1))))) (=> (not (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))) (=> (= tmp%3 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 tmp%3) %%switch_label%%0)))) (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))))) (=> (= tmp%4 false) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
