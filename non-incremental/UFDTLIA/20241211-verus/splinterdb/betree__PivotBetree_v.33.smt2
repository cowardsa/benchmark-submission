...
(assert (not (or (and (=> (and (lib!betree.PivotBetree_v.impl&%1.wf.? self!) (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (or (and (=> (is-lib!betree.SplitRequest_v.SplitRequest./SplitLeaf_ (%Poly%lib!betree.SplitRequest_v.SplitRequest. request!)) (=> (= child_idx@ (lib!betree.SplitRequest_v.SplitRequest./SplitLeaf/child_idx (%Poly%lib!betree.SplitRequest_v.SplitRequest. request!))) (=> (= split_key@ (lib!betree.SplitRequest_v.SplitRequest./SplitLeaf/split_key (%Poly%lib!betree.SplitRequest_v.SplitRequest. request!))) (or (and (=> (lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! (I child_idx@)) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.PivotBetree_v.BetreeNode. tmp%2 (I child_idx@))) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (I child_idx@))) (=> (= tmp%3 (lib!betree.PivotBetree_v.impl&%1.can_split_leaf.? tmp%1 (Poly%lib!spec.KeyType_t.Key. split_key@))) %%switch_label%%2))))) (=> (not (lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! (I child_idx@))) (=> (= tmp%3 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%7 tmp%3) %%switch_label%%1)))))) (=> (not (is-lib!betree.SplitRequest_v.SplitRequest./SplitLeaf_ (%Poly%lib!betree.SplitRequest_v.SplitRequest. request!))) (=> (= child_idx$1@ (lib!betree.SplitRequest_v.SplitRequest./SplitIndex/child_idx (%Poly%lib!betree.SplitRequest_v.SplitRequest. request!))) (=> (= child_pivot_idx@ (lib!betree.SplitRequest_v.SplitRequest./SplitIndex/child_pivot_idx (%Poly%lib!betree.SplitRequest_v.SplitRequest. request!))) (or (and (=> (lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! (I child_idx$1@)) (=> (= tmp%5 (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.PivotBetree_v.BetreeNode. tmp%5 (I child_idx$1@))) (=> (= tmp%4 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (I child_idx$1@))) (=> (= tmp%6 (lib!betree.PivotBetree_v.impl&%1.can_split_index.? tmp%4 (I child_pivot_idx@))) %%switch_label%%3))))) (=> (not (lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! (I child_idx$1@))) (=> (= tmp%6 false) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= tmp%7 tmp%6) %%switch_label%%1))))))) (and (not %%switch_label%%1) (=> (= tmp%8 tmp%7) %%switch_label%%0)))) (=> (not (and (lib!betree.PivotBetree_v.impl&%1.wf.? self!) (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (=> (= tmp%8 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
