...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%1.is_nondangling_ptr.? self! ptr!) (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. ptr!)) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. ptr!)) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. ptr!))) (=> (= tmp%3 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!)))) (=> %%location_label%%1 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. tmp%3 tmp%1)))))))))
(check-sat)
(exit)
