...
(declare-const tmp%1 lib!spec.KeyType_t.Element.)
(declare-const tmp%2 Poly)
(declare-const tmp%3 lib!spec.KeyType_t.Element.)
...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%0.wf.? self!) (=> (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? self! child_idx!) (=> (= tmp%2 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/pivots (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%lib!betree.PivotTable_v.impl&%0.spec_index. tmp%2 child_idx!)) (=> (= tmp%1 (%Poly%lib!spec.KeyType_t.Element. (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/pivots (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))))) child_idx!))) (=> (= tmp%4 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/pivots (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))) (=> (= tmp%5 (I (Add (%I child_idx!) 1))) (=> %%location_label%%1 (req%lib!betree.PivotTable_v.impl&%0.spec_index. tmp%4 tmp%5)))))))))))
(check-sat)
(exit)
