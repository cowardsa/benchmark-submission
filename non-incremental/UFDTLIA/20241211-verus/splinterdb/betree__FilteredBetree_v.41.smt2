...
(declare-const tmp%1 lib!betree.BufferOffsets_v.BufferOffsets.)
...
(assert (not (or (and (=> (and (and (lib!betree.FilteredBetree_v.impl&%1.wf.? self!) (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) (lib!betree.FilteredBetree_v.impl&%1.valid_child_index.? self! child_idx!)) (=> (= tmp%2 (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.FilteredBetree_v.BetreeNode./Node/flushed (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (=> (= tmp%3 (I (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. (lib!betree.FilteredBetree_v.BetreeNode./Node/buffers (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))))) (and (=> %%location_label%%0 (req%lib!betree.BufferOffsets_v.impl&%0.update. tmp%2 child_idx! tmp%3)) (=> (= tmp%1 (lib!betree.BufferOffsets_v.impl&%0.update.? (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.FilteredBetree_v.BetreeNode./Node/flushed (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) child_idx! (I (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. (lib!betree.FilteredBetree_v.BetreeNode./Node/buffers (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))))))) (=> (= tmp%4 (lib!betree.BufferOffsets_v.impl&%0.all_gte.? (Poly%lib!betree.BufferOffsets_v.BufferOffsets. tmp%1) buffer_gc!)) %%switch_label%%0)))))) (=> (not (and (and (lib!betree.FilteredBetree_v.impl&%1.wf.? self!) (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) (lib!betree.FilteredBetree_v.impl&%1.valid_child_index.? self! child_idx!))) (=> (= tmp%4 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
