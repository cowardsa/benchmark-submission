...
(declare-fun %%lambda%%2 (Dcr Type Dcr Type Poly Int) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Poly) (%%hole%%5 Int) (k$ Poly)) (! (= (%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) k$) (B (<= (%I (vstd!map.impl&%0.index.? %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 k$)) %%hole%%5))) :pattern ((%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) k$)))))
(assert (=> (fuel_bool fuel%lib!betree.OffsetMap_v.impl&%0.active_keys.) (forall ((self! Poly) (offset! Poly)) (! (= (lib!betree.OffsetMap_v.impl&%0.active_keys.? self! offset!) (%Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (vstd!set.impl&%0.new.? $ TYPE%lib!spec.KeyType_t.Key. $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%2 $ TYPE%lib!spec.KeyType_t.Key. $ NAT (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./nat.>. (lib!betree.OffsetMap_v.OffsetMap./OffsetMap/offsets (%Poly%lib!betree.OffsetMap_v.OffsetMap. self!))) (%I offset!))))))) :pattern ((lib!betree.OffsetMap_v.impl&%0.active_keys.? self! offset!)) ))))
(declare-fun req%lib!betree.OffsetMap_v.impl&%0.get. (Poly Poly) Bool)
(declare-const %%global_location_label%%3 Bool)
(assert (forall ((self! Poly) (k! Poly)) (! (= (req%lib!betree.OffsetMap_v.impl&%0.get. self! k!) (=> %%global_location_label%%3 (lib!betree.OffsetMap_v.impl&%0.is_total.? self!))) :pattern ((req%lib!betree.OffsetMap_v.impl&%0.get. self! k!)) )))
...
(assert (not (=> (lib!betree.OffsetMap_v.impl&%0.is_total.? self!) (=> (= tmp%2 (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./nat.>. (lib!betree.OffsetMap_v.OffsetMap./OffsetMap/offsets (%Poly%lib!betree.OffsetMap_v.OffsetMap. self!)))) (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Key. $ NAT tmp%2 k!))))))
(check-sat)
(exit)
