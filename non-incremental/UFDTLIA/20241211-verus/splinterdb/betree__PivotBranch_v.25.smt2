...
(assert (not (=> (= decrease%init0 (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (=> (is-lib!betree.PivotBranch_v.Node./Index_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (let ((tmp%%$ (Add (lib!betree.PivotBranch_v.impl&%3.route.? self! key!) 1))) (and (<= 0 tmp%%$) (< tmp%%$ (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!)))))))) (=> (= r@ (lib!betree.PivotBranch_v.impl&%3.route.? self! key!)) (or (and (=> (is-lib!betree.PivotBranch_v.Node./Leaf_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (= tmp%3 (let ((keys$ (lib!betree.PivotBranch_v.Node./Leaf/keys (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (let ((msgs$ (lib!betree.PivotBranch_v.Node./Leaf/msgs (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (ite (and (>= r@ 0) (= (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys$) (I r@)) key!)) (%Poly%lib!spec.Messages_t.Message. (vstd!seq.Seq.index.? $ TYPE%lib!spec.Messages_t.Message. (Poly%vstd!seq.Seq<lib!spec.Messages_t.Message.>. msgs$) (I r@))) (lib!spec.Messages_t.Message./Update (%Poly%lib!spec.Messages_t.Delta. (Poly%lib!spec.Messages_t.Delta. (lib!spec.Messages_t.nop_delta.? (I 0))))))))) %%switch_label%%0)) (=> (not (is-lib!betree.PivotBranch_v.Node./Leaf_ (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= pivots@ (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= children@ (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= tmp%2 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) (I (Add r@ 1)))) (and (=> %%location_label%%0 (check_decrease_height (Poly%lib!betree.PivotBranch_v.Node. (let ((self!$0 (%Poly%lib!betree.PivotBranch_v.Node. tmp%2)) (key!$1 (%Poly%lib!spec.KeyType_t.Key. key!))) self!$0)) (Poly%lib!betree.PivotBranch_v.Node. decrease%init0) false)) (=> (has_type (Poly%lib!spec.Messages_t.Message. tmp%1) TYPE%lib!spec.Messages_t.Message.) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%3.query.? (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) (I (Add r@ 1))) key!)) (=> (= tmp%3 tmp%1) %%switch_label%%0))))))))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
