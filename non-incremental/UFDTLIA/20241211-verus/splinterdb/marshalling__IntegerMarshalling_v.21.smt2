...
(declare-const self! lib!marshalling.IntegerMarshalling_v.IntFormat.)
...
(assert (not (=> (= parsed@ (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? T&. T& (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. data!) (I 0) (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? T&. T&)))) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.nonnegative. T&. T& parsed@) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.max_ensures. T&. T& parsed@) (=> %%location_label%%0 (let ((tmp%%$ (%I (lib!marshalling.Marshalling_v.Marshal.parse.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) (Poly%lib!marshalling.IntegerMarshalling_v.IntFormat. self!) (Poly%vstd!seq.Seq<u8.>. data!))))) (and (<= 0 tmp%%$) (<= tmp%%$ (%I (lib!marshalling.IntegerMarshalling_v.IntFormattable.max.? T&. T&)))))))))))
(check-sat)
(exit)
