...
(assert (forall ((self! Poly)) (! (= (req%lib!betree.PagedBetree_v.impl&%5.target. self!) (=> %%global_location_label%%30 (lib!betree.PagedBetree_v.impl&%5.valid.? self!))) :pattern ((req%lib!betree.PagedBetree_v.impl&%5.target. self!)) )))
(set-info :comment ";; Spec-Termination lib::betree::PagedBetree_v::Path::target")
(set-info :comment ";; betree/PagedBetree_v.rs:283:5: 283:57 (#0)")
(declare-const self! Poly)
(declare-const tmp%1 lib!betree.PagedBetree_v.BetreeNode.)
(declare-const tmp%2 Poly)
(declare-const tmp%3 lib!betree.PagedBetree_v.BetreeNode.)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.PagedBetree_v.Path.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!))))) (or (and (=> (= (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))) 0) (=> (= tmp%3 (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!))) %%switch_label%%0)) (=> (not (= (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))) 0)) (=> (= tmp%2 (Poly%lib!betree.PagedBetree_v.Path. (lib!betree.PagedBetree_v.impl&%5.subpath.? self!))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.PagedBetree_v.Path. tmp%2))) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. (Poly%lib!betree.PagedBetree_v.Path. self!$0)))))) decrease%init0 false)) (=> (= tmp%1 (lib!betree.PagedBetree_v.impl&%5.target.? (Poly%lib!betree.PagedBetree_v.Path. (lib!betree.PagedBetree_v.impl&%5.subpath.? self!)))) (=> (= tmp%3 tmp%1) %%switch_label%%0)))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
