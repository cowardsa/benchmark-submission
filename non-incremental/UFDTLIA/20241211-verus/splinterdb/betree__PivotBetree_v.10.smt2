...
(assert (not (or (and (=> (lib!betree.PivotBetree_v.impl&%1.local_structure.? self!) (or (and (=> (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)) (and (=> %%location_label%%0 (req%lib!betree.PivotBetree_v.impl&%1.wf_children. self!)) (=> (= tmp%1 (lib!betree.PivotBetree_v.impl&%1.wf_children.? self!)) (or (and (=> tmp%1 (and (=> %%location_label%%1 (req%lib!betree.PivotBetree_v.impl&%1.linked_children. self!)) (=> (= tmp%2 (lib!betree.PivotBetree_v.impl&%1.linked_children.? self!)) (=> (= tmp%3 tmp%2) %%switch_label%%2)))) (=> (not tmp%1) (=> (= tmp%3 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%4 tmp%3) %%switch_label%%1)))))) (=> (not (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (=> (= tmp%4 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%5 tmp%4) %%switch_label%%0)))) (=> (not (lib!betree.PivotBetree_v.impl&%1.local_structure.? self!)) (=> (= tmp%5 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
