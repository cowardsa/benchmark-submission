...
(assert (has_type node! TYPE%lib!betree.LinkedBranch_v.Node.))
...
(assert (not (or (and (=> (is-lib!betree.LinkedBranch_v.Node./Index_ (%Poly%lib!betree.LinkedBranch_v.Node. node!)) (=> (has_type idx@ INT) (or (and (=> (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. node!)))))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. node!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%2 idx@)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. node!))) idx@)) (=> (= tmp%3 (lib!betree.LinkedBranch_v.impl&%4.valid_address.? self! tmp%1)) %%switch_label%%1))))) (=> (not (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. node!))))))) (=> (= tmp%3 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. node!)))))) (lib!betree.LinkedBranch_v.impl&%4.valid_address.? self! (vstd!seq.Seq.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. node!))) idx$)))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. node!))) idx$)) ))) %%switch_label%%0))))) (=> (not (is-lib!betree.LinkedBranch_v.Node./Index_ (%Poly%lib!betree.LinkedBranch_v.Node. node!))) (=> (= tmp%4 true) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
