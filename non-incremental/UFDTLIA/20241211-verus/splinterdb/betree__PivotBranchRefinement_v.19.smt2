...
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children!)))) (vstd!set.impl&%0.finite.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children!) i$)))))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children!) i$)) )))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 (lib!betree.PivotBranchRefinement_v.map_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children!))) (and (=> %%location_label%%0 (req%lib!betree.Utils_v.lemma_union_seq_of_sets_finite. $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. tmp%1))) (=> (ens%lib!betree.Utils_v.lemma_union_seq_of_sets_finite. $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. tmp%1)) (=> %%location_label%%1 (vstd!set.impl&%0.finite.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranchRefinement_v.union_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children!))))))))))
(check-sat)
(exit)
