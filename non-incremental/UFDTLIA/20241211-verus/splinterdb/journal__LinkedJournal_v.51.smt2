...
(declare-const ptr! core!option.Option.)
(declare-const big! lib!journal.LinkedJournal_v.DiskView.)
...
(assert (has_type (Poly%core!option.Option. ptr!) (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.)))
(assert (has_type (Poly%lib!journal.LinkedJournal_v.DiskView. big!) TYPE%lib!journal.LinkedJournal_v.DiskView.))
(assert (lib!journal.LinkedJournal_v.impl&%1.wf.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!)))
(assert (lib!journal.LinkedJournal_v.impl&%1.is_nondangling_pointer.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. ptr!)))
(assert (lib!journal.LinkedJournal_v.impl&%1.wf.? (Poly%lib!journal.LinkedJournal_v.DiskView. big!)))
(assert (lib!journal.LinkedJournal_v.impl&%1.acyclic.? (Poly%lib!journal.LinkedJournal_v.DiskView. big!)))
(assert (lib!journal.LinkedJournal_v.impl&%1.is_sub_disk.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%lib!journal.LinkedJournal_v.DiskView. big!)))
...
(assert (not (=> (= decrease%init0 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. big!) (Poly%core!option.Option. ptr!))) (=> (= tmp%1 (vstd!set.impl&%0.subset_of.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. self!))))) (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. big!))))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (lib!journal.LinkedJournal_v.impl&%1.valid_ranking.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. (lib!journal.LinkedJournal_v.impl&%1.the_ranking.? (Poly%lib!journal.LinkedJournal_v.DiskView. big!))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (or (and (=> (is-core!option.Option./Some_ ptr!) (=> (= tmp%3 (< (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. big!) (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. ptr!)))) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. big!) (Poly%core!option.Option. ptr!)))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. ptr!))) (and (=> %%location_label%%3 (check_decrease_int (let ((self!$0 self!) (ptr!$1 tmp%4) (big!$2 big!)) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. big!$2) (Poly%core!option.Option. ptr!$1))) decrease%init0 false)) (and (=> %%location_label%%4 (req%lib!journal.LinkedJournal_v.impl&%1.iptr_ignores_extra_blocks. self! tmp%4 big!)) (=> (ens%lib!journal.LinkedJournal_v.impl&%1.iptr_ignores_extra_blocks. self! tmp%4 big!) %%switch_label%%0)))))))) (=> (not (is-core!option.Option./Some_ ptr!)) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%5 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (=> %%location_label%%6 (= (lib!journal.LinkedJournal_v.impl&%1.iptr.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. ptr!)) (lib!journal.LinkedJournal_v.impl&%1.iptr.? (Poly%lib!journal.LinkedJournal_v.DiskView. big!) (Poly%core!option.Option. ptr!))))))))))))))))
(check-sat)
(exit)
