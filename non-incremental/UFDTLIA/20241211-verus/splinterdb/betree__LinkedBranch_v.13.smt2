...
(assert (not (or (and (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (=> (has_type ranking@ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.valid_ranking. self! ranking@)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking@)) (=> (= tmp%2 (exists ((ranking$ Poly)) (! (and (has_type ranking$ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking$)) :pattern ((lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking$)) ))) %%switch_label%%0))))) (=> (not (lib!betree.LinkedBranch_v.impl&%5.wf.? self!)) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
