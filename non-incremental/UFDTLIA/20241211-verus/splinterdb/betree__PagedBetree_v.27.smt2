...
(set-info :comment ";; betree/PagedBetree_v.rs:294:5: 294:91 (#0)")
(declare-const %return! lib!betree.PagedBetree_v.ChildMap.)
(declare-const self! Poly)
(declare-const replacement! Poly)
(declare-const tmp%1 lib!betree.PagedBetree_v.Path.)
(declare-const tmp%2 lib!betree.PagedBetree_v.Path.)
(declare-const k@ Poly)
(declare-const k$1@ Poly)
(declare-const replaced_child@ lib!betree.PagedBetree_v.BetreeNode.)
...
(assert (not (=> (lib!betree.PagedBetree_v.impl&%5.valid.? self!) (=> (lib!betree.PagedBetree_v.impl&%2.wf.? replacement!) (=> (< 0 (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!))))) (and (=> %%location_label%%0 (req%lib!betree.PagedBetree_v.impl&%5.subpath. self!)) (=> (= tmp%1 (lib!betree.PagedBetree_v.impl&%5.subpath.? self!)) (and (=> %%location_label%%1 (req%lib!betree.PagedBetree_v.impl&%5.subpath. self!)) (=> (= tmp%2 (lib!betree.PagedBetree_v.impl&%5.subpath.? self!)) (=> %%location_label%%2 (req%lib!betree.PagedBetree_v.impl&%5.substitute. (Poly%lib!betree.PagedBetree_v.Path. tmp%2) replacement!)))))))))))
(check-sat)
(exit)
