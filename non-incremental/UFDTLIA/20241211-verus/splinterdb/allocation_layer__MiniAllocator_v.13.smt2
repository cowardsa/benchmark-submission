...
(declare-const result@ lib!allocation_layer.MiniAllocator_v.PageAllocator.)
(declare-const new_curr@ core!option.Option.)
...
(assert (not (=> (lib!allocation_layer.MiniAllocator_v.impl&%1.wf.? self!) (=> (lib!allocation_layer.MiniAllocator_v.impl&%1.can_allocate.? self! addr!) (=> (= tmp%2 (Poly%vstd!map.Map<nat./lib!allocation_layer.MiniAllocator_v.PageAllocator.>. (lib!allocation_layer.MiniAllocator_v.MiniAllocator./MiniAllocator/allocs (%Poly%lib!allocation_layer.MiniAllocator_v.MiniAllocator. self!)))) (=> (= tmp%3 (I (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. addr!)))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ NAT $ TYPE%lib!allocation_layer.MiniAllocator_v.PageAllocator. tmp%2 tmp%3)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!allocation_layer.MiniAllocator_v.PageAllocator. (Poly%vstd!map.Map<nat./lib!allocation_layer.MiniAllocator_v.PageAllocator.>. (lib!allocation_layer.MiniAllocator_v.MiniAllocator./MiniAllocator/allocs (%Poly%lib!allocation_layer.MiniAllocator_v.MiniAllocator. self!))) (I (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. addr!))))) (=> (= tmp%4 (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) addr!)) (=> %%location_label%%1 (req%lib!allocation_layer.MiniAllocator_v.impl&%0.reserve. tmp%1 tmp%4)))))))))))
(check-sat)
(exit)
