...
(assert (not (or (and (=> (lib!journal.LinkedJournal_v.impl&%2.wf.? self!) (=> (= tmp%2 (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. tmp%2)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))))) (=> (= tmp%3 tmp%1) %%switch_label%%0))))) (=> (not (lib!journal.LinkedJournal_v.impl&%2.wf.? self!)) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
