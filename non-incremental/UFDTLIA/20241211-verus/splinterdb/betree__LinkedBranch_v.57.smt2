...
(declare-const tmp%4 lib!betree.LinkedBranch_v.LinkedBranch.)
...
(assert (has_type path! TYPE%lib!betree.LinkedBranch_v.Path.))
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%6.valid.? path!) (=> (= (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. path!)) (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!)) (=> (= (lib!betree.LinkedBranch_v.Path./Path/key (%Poly%lib!betree.LinkedBranch_v.Path. path!)) (lib!betree.LinkedBranch_v.impl&%1.get_pivot.? split_arg!)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%6.target. path!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%6.target.? path!)) (=> (lib!betree.LinkedBranch_v.impl&%5.can_split_child_of_index.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.impl&%6.target.? path!)) split_arg! addr!) (=> (lib!betree.LinkedBranch_v.impl&%4.is_fresh.? (Poly%lib!betree.LinkedBranch_v.DiskView. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/disk_view (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!))) (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) addr!)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%6.target. path!)) (=> (= tmp%2 (lib!betree.LinkedBranch_v.impl&%6.target.? path!)) (and (=> %%location_label%%2 (req%lib!betree.LinkedBranch_v.impl&%5.split_child_of_index. (Poly%lib!betree.LinkedBranch_v.LinkedBranch. tmp%2) split_arg! addr!)) (=> (= tmp%3 (lib!betree.LinkedBranch_v.impl&%5.split_child_of_index.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. tmp%2) split_arg! addr!)) (=> %%location_label%%3 (req%lib!betree.LinkedBranch_v.impl&%6.substitute. path! (Poly%lib!betree.LinkedBranch_v.LinkedBranch. tmp%3))))))))))))))))
(check-sat)
(exit)
