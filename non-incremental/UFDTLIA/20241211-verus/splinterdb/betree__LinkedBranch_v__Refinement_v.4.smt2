...
(declare-const %return! lib!betree.PivotBranch_v.Path.)
(declare-const self! Poly)
(declare-const ranking! Poly)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Poly)
(declare-const tmp%3 lib!betree.PivotBranch_v.Node.)
(declare-const tmp%4 Poly)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.LinkedBranch_v.Path.))
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (=> (= tmp%2 (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.valid_ranking. tmp%2 ranking!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))) ranking!)) (=> (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))) ranking!) (=> (= tmp%4 (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.Refinement_v.impl&%0.i_internal. tmp%4 ranking!))))))))))
(check-sat)
(exit)
