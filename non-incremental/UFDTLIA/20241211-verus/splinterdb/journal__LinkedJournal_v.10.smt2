...
(assert (not (or (and (=> (and (lib!journal.LinkedJournal_v.impl&%1.entries_wf.? self!) (lib!journal.LinkedJournal_v.impl&%1.nondangling_pointers.? self!)) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.blocks_can_concat. self!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.blocks_can_concat.? self!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (and (lib!journal.LinkedJournal_v.impl&%1.entries_wf.? self!) (lib!journal.LinkedJournal_v.impl&%1.nondangling_pointers.? self!))) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
