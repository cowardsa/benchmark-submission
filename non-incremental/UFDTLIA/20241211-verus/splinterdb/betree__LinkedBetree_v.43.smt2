...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (=> (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) idx!) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%2 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (=> (= tmp%4 (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%2))))) (=> %%location_label%%2 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) tmp%4 idx!))))))))))))
(check-sat)
(exit)
