...
(declare-const new_message@ lib!spec.Messages_t.Message.)
(declare-const old_message@ lib!spec.Messages_t.Message.)
(declare-const new_value@ lib!spec.TotalKMMap_t.TotalKMMap.)
...
(assert (has_type orig! (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (lib!abstract_system.MsgHistory_v.impl&%0.len.? self!)) (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!) (or (and (=> (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? self!) (=> (= tmp%2 orig!) %%switch_label%%0)) (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? self!)) (=> (= last_lsn@ (nClip (Sub (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) 1))) (=> (= tmp%1 (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? self! (I last_lsn@)))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. tmp%1)) (orig!$1 (%Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))) (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!$0))) decrease%init0 false)) (=> (has_type (Poly%lib!abstract_system.StampedMap_v.Stamped. sub_map@) (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.)) (=> (= key@ (lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage/key (%Poly%lib!abstract_system.MsgHistory_v.KeyedMessage. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (I last_lsn@))))) (=> (= new_message@ (lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage/message (%Poly%lib!abstract_system.MsgHistory_v.KeyedMessage. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (I last_lsn@))))) (=> (= old_message@ (lib!spec.TotalKMMap_t.impl&%0.spec_index.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. sub_map@))) (Poly%lib!spec.KeyType_t.Key. key@))) (=> (= new_value@ (lib!spec.TotalKMMap_t.impl&%0.insert.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. sub_map@))) (Poly%lib!spec.KeyType_t.Key. key@) (Poly%lib!spec.Messages_t.Message. (lib!spec.Messages_t.impl&%1.merge.? (Poly%lib!spec.Messages_t.Message. old_message@) (Poly%lib!spec.Messages_t.Message. new_message@))))) (=> (= tmp%2 (Poly%lib!abstract_system.StampedMap_v.Stamped. (lib!abstract_system.StampedMap_v.Stamped./Stamped (Poly%lib!spec.TotalKMMap_t.TotalKMMap. new_value@) (%I (I (nClip (Add (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. sub_map@))) 1))))))) %%switch_label%%0))))))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
