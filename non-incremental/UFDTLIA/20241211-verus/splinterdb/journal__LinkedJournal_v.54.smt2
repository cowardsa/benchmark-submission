...
(assert (not (=> (= decrease%init0 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (or (and (=> (is-core!option.Option./Some_ root!) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 self!) (root!$1 tmp%1)) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!$0) (Poly%core!option.Option. root!$1))) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. self! tmp%1)) (=> (ens%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. self! tmp%1) (and (=> (has_type lsn@ NAT) (=> (and (<= (lib!journal.LinkedJournal_v.impl&%1.seq_start.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!)) (%I lsn@)) (< (%I lsn@) (lib!journal.LinkedJournal_v.impl&%1.seq_end.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))) (or (and (=> (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. root!))))))))) (%I lsn@)) (=> (= tmp%2 (lib!journal.LinkedJournal_v.impl&%1.lsn_has_entry_at.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) lsn@ (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. root!))))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 %%switch_label%%1)))) (=> (not (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. root!))))))))) (%I lsn@))) %%switch_label%%1)) (and (not %%switch_label%%1) (=> %%location_label%%3 (lib!journal.LinkedJournal_v.impl&%1.lsn_has_entry.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) lsn@)))))) (=> (forall ((lsn$ Poly)) (! (=> (has_type lsn$ NAT) (=> (and (<= (lib!journal.LinkedJournal_v.impl&%1.seq_start.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!)) (%I lsn$)) (< (%I lsn$) (lib!journal.LinkedJournal_v.impl&%1.seq_end.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))) (lib!journal.LinkedJournal_v.impl&%1.lsn_has_entry.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) lsn$))) :pattern ((lib!journal.LinkedJournal_v.impl&%1.lsn_has_entry.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) lsn$)) )) %%switch_label%%0))))))) (=> (not (is-core!option.Option./Some_ root!)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%4 (lib!journal.LinkedJournal_v.impl&%1.lsns_have_entries.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))))))))
(check-sat)
(exit)
