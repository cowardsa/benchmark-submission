...
(assert (not (=> %%location_label%%0 (forall ((a$ Poly) (b$ Poly)) (! (=> (and (has_type a$ TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.) (has_type b$ TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.)) (= (lib!abstract_system.MsgHistory_v.impl&%0.ext_equal.? a$ b$) (= a$ b$))) :pattern ((lib!abstract_system.MsgHistory_v.impl&%0.ext_equal.? a$ b$)) )))))
(check-sat)
(exit)
