...
(declare-const from_idx! Poly)
(declare-const k! Poly)
(declare-const idx! Poly)
(declare-const tmp%1 lib!spec.AsyncDisk_t.Address.)
...
(assert (not (=> (<= 0 (%I from_idx!)) (or (and (=> (and (<= (%I from_idx!) (%I idx!)) (< (%I idx!) (lib!betree.LinkedSeq_v.impl&%0.len.? buffers!))) (and (=> %%location_label%%0 (req%lib!betree.LinkedSeq_v.impl&%0.spec_index. buffers! idx!)) (=> (= tmp%1 (%Poly%lib!spec.AsyncDisk_t.Address. (vstd!seq.Seq.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedSeq_v.LinkedSeq./LinkedSeq/addrs (%Poly%lib!betree.LinkedSeq_v.LinkedSeq. buffers!))) idx!))) (=> (= tmp%2 (lib!betree.BufferDisk_v.impl&%1.queryable_contains.? T&. T& self! (Poly%lib!spec.AsyncDisk_t.Address. tmp%1) k!)) %%switch_label%%0)))) (=> (not (and (<= (%I from_idx!) (%I idx!)) (< (%I idx!) (lib!betree.LinkedSeq_v.impl&%0.len.? buffers!)))) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
