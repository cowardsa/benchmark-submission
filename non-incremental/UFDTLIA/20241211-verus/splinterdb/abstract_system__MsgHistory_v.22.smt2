...
(declare-const orig! lib!abstract_system.StampedMap_v.Stamped.)
(declare-const tmp%1 lib!abstract_system.MsgHistory_v.MsgHistory.)
(declare-const tmp%2 lib!spec.TotalKMMap_t.TotalKMMap.)
(declare-const last_lsn@ Int)
(declare-const sub_map@ lib!abstract_system.StampedMap_v.Stamped.)
...
(assert (has_type (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!) (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.)))
(assert (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!)))))
(assert (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))
(assert (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))))))
...
(assert (not (=> (= decrease%init0 (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (or (and (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (=> (= last_lsn@ (nClip (Sub (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) 1))) (=> (= sub_map@ (lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I last_lsn@))) (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))) (=> (= tmp%1 (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I last_lsn@))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 tmp%1) (orig!$1 orig!)) (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!$0))) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_wf_lemma. tmp%1 orig!)) (=> (ens%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_wf_lemma. tmp%1 orig!) (=> (= tmp%2 (%Poly%lib!spec.TotalKMMap_t.TotalKMMap. (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. sub_map@))))) (and (=> %%location_label%%2 (req%lib!spec.TotalKMMap_t.impl&%0.insert_lemma. tmp%2)) (=> (ens%lib!spec.TotalKMMap_t.impl&%0.insert_lemma. tmp%2) %%switch_label%%0)))))))))) (=> (not (not (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%3 (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. (lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))))))))))))
(check-sat)
(exit)
