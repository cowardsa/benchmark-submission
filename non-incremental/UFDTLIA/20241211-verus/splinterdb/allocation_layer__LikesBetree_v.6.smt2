...
(declare-const betree_likes! Poly)
(declare-const tmp%1 Poly)
(declare-const addr@ lib!spec.AsyncDisk_t.Address.)
(declare-const sub_buffer_likes@ vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>.)
...
(assert (has_type betree_likes! (TYPE%vstd!multiset.Multiset. $ TYPE%lib!spec.AsyncDisk_t.Address.)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (vstd!multiset.impl&%0.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. betree_likes!)) (or (and (=> (> (vstd!multiset.impl&%0.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. betree_likes!) 0) (=> (= addr@ (%Poly%lib!spec.AsyncDisk_t.Address. (vstd!multiset.impl&%0.choose.? $ TYPE%lib!spec.AsyncDisk_t.Address. betree_likes!))) (=> (= tmp%1 (vstd!multiset.impl&%0.remove.? $ TYPE%lib!spec.AsyncDisk_t.Address. betree_likes! (Poly%lib!spec.AsyncDisk_t.Address. addr@))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)) (betree_likes!$1 (%Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. tmp%1))) (vstd!multiset.impl&%0.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. betree_likes!$1))) decrease%init0 false)) (=> (= tmp%2 (vstd!multiset.impl&%0.add.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesBetree_v.impl&%0.likes.? (Poly%lib!betree.LinkedSeq_v.LinkedSeq. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/buffers (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. (Poly%lib!betree.LinkedBetree_v.DiskView. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/dv (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))))) (Poly%lib!spec.AsyncDisk_t.Address. addr@))))))) (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. sub_buffer_likes@))) %%switch_label%%0))))) (=> (not (> (vstd!multiset.impl&%0.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. betree_likes!) 0)) (=> (= tmp%2 (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.Likes_v.no_likes.? (I 0)))) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
