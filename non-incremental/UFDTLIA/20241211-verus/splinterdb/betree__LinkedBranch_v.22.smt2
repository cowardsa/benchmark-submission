...
(declare-const tmp%1 lib!betree.LinkedBranch_v.LinkedBranch.)
(declare-const tmp%2 Poly)
(declare-const tmp%3 lib!betree.LinkedBranch_v.LinkedBranch.)
...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!))) (or (and (=> (= 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!))) (=> (= tmp%3 (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))) %%switch_label%%0)) (=> (not (= 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (=> (= tmp%2 (Poly%lib!betree.LinkedBranch_v.Path. (lib!betree.LinkedBranch_v.impl&%6.subpath.? self!))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBranch_v.Path. tmp%2))) (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. (Poly%lib!betree.LinkedBranch_v.Path. self!$0)))) decrease%init0 false)) (=> (has_type (Poly%lib!betree.LinkedBranch_v.LinkedBranch. tmp%1) TYPE%lib!betree.LinkedBranch_v.LinkedBranch.) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%6.target.? (Poly%lib!betree.LinkedBranch_v.Path. (lib!betree.LinkedBranch_v.impl&%6.subpath.? self!)))) (=> (= tmp%3 tmp%1) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
