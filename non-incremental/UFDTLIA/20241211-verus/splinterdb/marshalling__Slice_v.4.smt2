...
(assert (has_type data! (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%alloc!vec.impl&%1.len. T&. T& $ ALLOCATOR_GLOBAL data! tmp%1) (=> (= out! (lib!marshalling.Slice_v.Slice./Slice (%I (I 0)) (%I (I tmp%1)))) (=> %%location_label%%0 (= (%Poly%lib!marshalling.Slice_v.SpecSlice. (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. out!))) (lib!marshalling.Slice_v.impl&%0.all.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) data!))))))))
(check-sat)
(exit)
