...
(declare-const tmp%1 lib!betree.LinkedBranch_v.Path.)
(declare-const tmp%2 lib!betree.LinkedBranch_v.LinkedBranch.)
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%6.valid.? self!) (or (and (=> (= 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!))) (=> (= tmp%3 (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))) %%switch_label%%0)) (=> (not (= 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%6.subpath. self!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%6.subpath.? self!)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%6.target. (Poly%lib!betree.LinkedBranch_v.Path. tmp%1))) (=> (= tmp%2 (lib!betree.LinkedBranch_v.impl&%6.target.? (Poly%lib!betree.LinkedBranch_v.Path. tmp%1))) (=> (= tmp%3 tmp%2) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
