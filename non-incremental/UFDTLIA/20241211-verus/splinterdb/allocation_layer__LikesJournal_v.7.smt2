...
(declare-const tmp%1 vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.)
...
(assert (not (=> (= decrease%init0 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? self! root!)) (=> (and (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. root!)) (=> (= tmp%3 (vstd!map.impl&%0.empty.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address.)) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. root!))) (=> (= curr_msgs@ (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (core!option.Option./Some/0 (%Poly%core!option.Option. root!)))))) (=> (= start_lsn@ (nClip (vstd!math.max.? (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (I (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. curr_msgs@))))))) (=> (= update@ (lib!allocation_layer.LikesJournal_v.singleton_index.? (I start_lsn@) (I (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. curr_msgs@)))) (core!option.Option./Some/0 (%Poly%core!option.Option. root!)))) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)) (root!$1 (%Poly%core!option.Option. tmp%2))) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!$0) (Poly%core!option.Option. root!$1))) decrease%init0 false)) (=> (= tmp%1 (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? self! (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!)))) (=> (= tmp%3 (vstd!map_lib.impl&%0.union_prefer_right.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. tmp%1) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. update@))) %%switch_label%%0))))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
