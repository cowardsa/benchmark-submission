...
(assert (not (=> %%location_label%%0 (=> (%B (lib!betree.Buffer_v.Buffer.is_empty.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. self!)) (= (%Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.Buffer_v.Buffer.i.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. self!)) (lib!betree.Buffer_v.impl&%1.empty.? (I 0)))))))
(check-sat)
(exit)
