...
(declare-const %return! lib!betree.LinkedBranch_v.Node.)
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%4.valid_address.? self! addr!) (=> (= tmp%2 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBranch_v.Node.>. (lib!betree.LinkedBranch_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBranch_v.DiskView. self!)))) (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBranch_v.Node. tmp%2 addr!))))))
(check-sat)
(exit)
