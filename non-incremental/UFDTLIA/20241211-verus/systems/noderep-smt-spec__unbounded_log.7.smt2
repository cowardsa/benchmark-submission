...
(declare-const nodeId! Int)
(declare-const updates1! Poly)
(declare-const updates2! Poly)
...
(assert (<= 0 nodeId!))
(assert (has_type updates1! (TYPE%vstd!map.Map. $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&))))
(assert (has_type updates2! (TYPE%vstd!map.Map. $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&))))
...
(assert (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (Poly%vstd!seq.Seq<nat.>. queue!) log! (I queueIndex!) (I logIndexLower!) (I logIndexUpper!) (I nodeId!) updates1!))
(assert (forall ((rid$ Poly)) (! (=> (has_type rid$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates1!) rid$) (=> (vstd!seq_lib.impl&%0.contains.? $ NAT (Poly%vstd!seq.Seq<nat.>. queue!) rid$) (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates2!) rid$) (= (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates2! rid$) (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates1! rid$)))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates1!) rid$)) )))
...
(assert (not (=> (= decrease%init0 (Sub logIndexUpper! logIndexLower!)) (or (and (=> (= logIndexLower! logIndexUpper!) %%switch_label%%0) (=> (not (= logIndexLower! logIndexUpper!)) (or (and (=> (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! (I logIndexLower!)))) nodeId!) (=> (= tmp%1 (nClip (Add queueIndex! 1))) (=> (= tmp%2 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (queueIndex!$2 tmp%1) (logIndexLower!$3 tmp%2) (logIndexUpper!$4 logIndexUpper!) (nodeId!$5 nodeId!) (updates1!$6 updates1!) (updates2!$7 updates2!)) (Sub logIndexUpper!$4 logIndexLower!$3)) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!spec.unbounded_log.LogRangeMatchesQueue_update_change_2. DT&. DT& queue! log! tmp%1 tmp%2 logIndexUpper! nodeId! updates1! updates2!)) (=> (ens%lib!spec.unbounded_log.LogRangeMatchesQueue_update_change_2. DT&. DT& queue! log! tmp%1 tmp%2 logIndexUpper! nodeId! updates1! updates2!) %%switch_label%%1)))))) (=> (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! (I logIndexLower!)))) nodeId!)) (=> (= tmp%3 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%2 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (queueIndex!$2 queueIndex!) (logIndexLower!$3 tmp%3) (logIndexUpper!$4 logIndexUpper!) (nodeId!$5 nodeId!) (updates1!$6 updates1!) (updates2!$7 updates2!)) (Sub logIndexUpper!$4 logIndexLower!$3)) decrease%init0 false)) (and (=> %%location_label%%3 (req%lib!spec.unbounded_log.LogRangeMatchesQueue_update_change_2. DT&. DT& queue! log! queueIndex! tmp%3 logIndexUpper! nodeId! updates1! updates2!)) (=> (ens%lib!spec.unbounded_log.LogRangeMatchesQueue_update_change_2. DT&. DT& queue! log! queueIndex! tmp%3 logIndexUpper! nodeId! updates1! updates2!) %%switch_label%%1)))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%4 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (Poly%vstd!seq.Seq<nat.>. queue!) log! (I queueIndex!) (I logIndexLower!) (I logIndexUpper!) (I nodeId!) updates2!)))))))
(check-sat)
(exit)
