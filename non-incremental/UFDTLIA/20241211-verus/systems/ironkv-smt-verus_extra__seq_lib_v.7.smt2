...
(assert (has_type prefix! (TYPE%vstd!seq.Seq. B&. B&)))
(assert (has_type (Poly%fun%1. f!) (TYPE%fun%1. A&. A& $ (TYPE%vstd!seq.Seq. B&. B&))))
(assert (> (vstd!seq.Seq.len.? A&. A& s!) 0))
(declare-fun %%lambda%%6 (Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (x$ Poly) (y$ Poly)) (! (= (%%apply%%1 (%%lambda%%6 %%hole%%0 %%hole%%1) x$ y$) (vstd!seq.Seq.add.? %%hole%%0 %%hole%%1 x$ y$)) :pattern ((%%apply%%1 (%%lambda%%6 %%hole%%0 %%hole%%1) x$ y$)))))
...
(assert (not (=> (= g@ (mk_fun (%%lambda%%6 B&. B&))) (and (=> (has_type x@ (TYPE%vstd!seq.Seq. B&. B&)) (=> (has_type y@ (TYPE%vstd!seq.Seq. B&. B&)) (=> (has_type z@ (TYPE%vstd!seq.Seq. B&. B&)) (=> (= s1@ (%%apply%%1 g@ (%%apply%%1 g@ x@ y@) z@)) (=> (= s2@ (%%apply%%1 g@ x@ (%%apply%%1 g@ y@ z@))) (and (=> (= tmp%1 (= (vstd!seq.Seq.len.? B&. B& s1@) (vstd!seq.Seq.len.? B&. B& s2@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> (has_type idx@ INT) (=> (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? B&. B& s1@))) (=> %%location_label%%1 (= (vstd!seq.Seq.index.? B&. B& s1@ idx@) (vstd!seq.Seq.index.? B&. B& s2@ idx@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? B&. B& s1@))) (= (vstd!seq.Seq.index.? B&. B& s1@ idx$) (vstd!seq.Seq.index.? B&. B& s2@ idx$)))) :pattern ((vstd!seq.Seq.index.? B&. B& s1@ idx$)) :pattern ((vstd!seq.Seq.index.? B&. B& s2@ idx$)) )) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. B&. B&) s1@ s2@)) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> %%location_label%%3 (= s1@ s2@)))))))))) (=> (= s1@ s2@) (=> %%location_label%%4 (= (%%apply%%1 g@ (%%apply%%1 g@ x@ y@) z@) (%%apply%%1 g@ x@ (%%apply%%1 g@ y@ z@))))))))))) (=> (forall ((x$ Poly) (y$ Poly) (z$ Poly)) (! (=> (and (has_type x$ (TYPE%vstd!seq.Seq. B&. B&)) (has_type y$ (TYPE%vstd!seq.Seq. B&. B&)) (has_type z$ (TYPE%vstd!seq.Seq. B&. B&))) (= (%%apply%%1 g@ (%%apply%%1 g@ x$ y$) z$) (%%apply%%1 g@ x$ (%%apply%%1 g@ y$ z$)))) :pattern ((%%apply%%1 g@ (%%apply%%1 g@ x$ y$) z$)) )) (=> (= tmp%3 (mk_fun (%%lambda%%5 f! B&. B&))) (=> (= tmp%4 (mk_fun (%%lambda%%0 f! g@))) (and (=> %%location_label%%5 (req%vstd!function.fun_ext_2. $ (TYPE%vstd!seq.Seq. B&. B&) A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) tmp%3 tmp%4)) (=> (ens%vstd!function.fun_ext_2. $ (TYPE%vstd!seq.Seq. B&. B&) A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) tmp%3 tmp%4) (and (=> %%location_label%%6 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_merge_right_assoc. A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s! prefix! f! g@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_merge_right_assoc. A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s! prefix! f! g@) (=> %%location_label%%7 (= (vstd!seq.Seq.add.? B&. B& (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) (vstd!seq.Seq.subrange.? A&. A& s! (I 0) (I (Sub (vstd!seq.Seq.len.? A&. A& s!) 1))) prefix! (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&)))) (%%apply%%0 f! (vstd!seq.Seq.index.? A&. A& s! (I (Sub (vstd!seq.Seq.len.? A&. A& s!) 1))))) (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s! prefix! (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&)))))))))))))))))
(check-sat)
(exit)
