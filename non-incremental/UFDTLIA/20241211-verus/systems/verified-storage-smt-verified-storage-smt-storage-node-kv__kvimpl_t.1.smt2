...
(declare-const pmem! Poly)
(declare-const kvstore_id! Int)
(declare-const max_keys! Int)
(declare-const list_node_size! Int)
...
(assert (has_type pmem! PM&))
(assert (uInv 128 kvstore_id!))
(assert (uInv SZ max_keys!))
(assert (uInv SZ list_node_size!))
...
(assert (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? PM&. PM& pmem!)))
(declare-const %%switch_label%%0 Bool)
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (=> (ens%lib!kv.kvimpl_v.impl&%0.untrusted_new. PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E& pmem! kvstore_id! max_keys! list_node_size! tmp%1) (=> (ens%core!result.impl&%26.branch. $ (TYPE%lib!kv.kvimpl_v.UntrustedKvStoreImpl. PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E&) $ (TYPE%lib!kv.kvimpl_t.KvError. K&. K& E&. E&) tmp%1 tmp%%@) (or (and (=> (is-core!ops.control_flow.ControlFlow./Break_ tmp%%@) (=> (= residual@ (%Poly%core!result.Result. (core!ops.control_flow.ControlFlow./Break/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@))))) (=> (ens%core!result.impl&%27.from_residual. $ (TYPE%lib!kv.kvimpl_t.KvStore. PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E&) $ (TYPE%lib!kv.kvimpl_t.KvError. K&. K& E&. E&) $ (TYPE%lib!kv.kvimpl_t.KvError. K&. K& E&. E&) residual@ tmp%2) (=> (= result! tmp%2) (=> %%location_label%%0 (=> (is-core!result.Result./Ok_ result!) (let ((new_kv$ (%Poly%lib!kv.kvimpl_t.KvStore. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (lib!kv.kvimpl_t.impl&%5.valid.? PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E& (Poly%lib!kv.kvimpl_t.KvStore. new_kv$))))))))) (=> (not (is-core!ops.control_flow.ControlFlow./Break_ tmp%%@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= result! (core!result.Result./Ok (Poly%lib!kv.kvimpl_t.KvStore. (lib!kv.kvimpl_t.KvStore./KvStore (%I (I kvstore_id!)) (let ((val$ (core!ops.control_flow.ControlFlow./Continue/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@))))) val$))))) (=> %%location_label%%1 (=> (is-core!result.Result./Ok_ result!) (let ((new_kv$ (%Poly%lib!kv.kvimpl_t.KvStore. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (lib!kv.kvimpl_t.impl&%5.valid.? PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E& (Poly%lib!kv.kvimpl_t.KvStore. new_kv$))))))))))))
(check-sat)
(exit)
