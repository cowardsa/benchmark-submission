...
(declare-const self! lib!delegation_map_v.StrictlyOrderedVec.)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Poly)
(assert fuel_defaults)
(assert (has_type (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!) (TYPE%lib!delegation_map_v.StrictlyOrderedVec. K&. K&)))
(assert (tr_bound%lib!keys_t.KeyTrait. K&. K&))
(assert (tr_bound%lib!verus_extra.clone_v.VerusClone. K&. K&))
(assert (lib!delegation_map_v.impl&%1.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!)))
...
(assert (not (=> (= tmp%1 (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!))) (=> (ens%vstd!seq_lib.seq_to_set_is_finite. K&. K& tmp%1) (=> (= tmp%2 (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!))) (and (=> %%location_label%%0 (req%vstd!seq_lib.impl&%0.unique_seq_to_set. K&. K& tmp%2)) (=> (ens%vstd!seq_lib.impl&%0.unique_seq_to_set. K&. K& tmp%2) (=> (= s! (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!)))) (and (=> %%location_label%%1 (= s! (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!))))) (and (=> %%location_label%%2 (vstd!set.impl&%0.finite.? K&. K& s!)) (=> %%location_label%%3 (= (vstd!set.impl&%0.len.? K&. K& s!) (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!)))))))))))))))
(check-sat)
(exit)
