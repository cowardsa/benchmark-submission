...
(declare-const deleted@0 Int)
(assert fuel_defaults)
(assert (has_type v!@0 (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL)))
(assert (uInv SZ start!))
(assert (uInv SZ end!))
(assert (and (<= start! end!) (<= end! (vstd!std_specs.vec.spec_vec_len.? A&. A& $ ALLOCATOR_GLOBAL v!@0))))
(declare-const v!@1 Poly)
(declare-const deleted@1 Int)
...
(assert (not (=> (= deleted@0 0) (=> (= s1@ (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)) (=> (= s2@ (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I 0) (I start!)) (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I (Add start! deleted@0)) (I (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)))))) (and (=> (= tmp%1 (= (vstd!seq.Seq.len.? A&. A& s1@) (vstd!seq.Seq.len.? A&. A& s2@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> (has_type idx@ INT) (=> (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? A&. A& s1@))) (=> %%location_label%%1 (= (vstd!seq.Seq.index.? A&. A& s1@ idx@) (vstd!seq.Seq.index.? A&. A& s2@ idx@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? A&. A& s1@))) (= (vstd!seq.Seq.index.? A&. A& s1@ idx$) (vstd!seq.Seq.index.? A&. A& s2@ idx$)))) :pattern ((vstd!seq.Seq.index.? A&. A& s1@ idx$)) :pattern ((vstd!seq.Seq.index.? A&. A& s2@ idx$)) )) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1@ s2@)) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> %%location_label%%3 (= s1@ s2@)))))))))) (=> (= s1@ s2@) (and (=> %%location_label%%4 (and (<= start! end!) (<= end! (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0))))) (and (=> %%location_label%%5 (= (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)) (Sub (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)) deleted@0))) (and (=> %%location_label%%6 (and (<= 0 deleted@0) (<= deleted@0 (Sub end! start!)))) (and (=> %%location_label%%7 (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I 0) (I start!)) (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I (Add start! deleted@0)) (I (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0))))))) (=> (has_type v!@1 (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL)) (=> (uInv SZ deleted@1) (=> (and (<= start! end!) (<= end! (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)))) (=> (= (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@1)) (Sub (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)) deleted@1)) (=> (and (<= 0 deleted@1) (<= deleted@1 (Sub end! start!))) (=> (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@1) (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I 0) (I start!)) (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I (Add start! deleted@1)) (I (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)))))) (and (=> %%location_label%%8 (uInv SZ (Sub end! start!))) (=> (not (< deleted@1 (uClip SZ (Sub end! start!)))) (and (=> %%location_label%%9 true) (=> %%location_label%%10 (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@1) (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I 0) (I start!)) (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I end!) (I (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)))))))))))))))))))))))))))
(check-sat)
(exit)
