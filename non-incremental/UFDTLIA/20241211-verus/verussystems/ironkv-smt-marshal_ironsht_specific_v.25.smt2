...
(assert (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!hashmap_t.CKeyHashMap. self! other!)))
...
(assert (not (=> (ens%lib!hashmap_t.impl&%0.lemma_to_vec_view. (%Poly%lib!hashmap_t.CKeyHashMap. self!) (%Poly%lib!hashmap_t.CKeyHashMap. other!)) (=> (= tmp%1 (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) (=> (= tmp%2 (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) tmp%1 tmp%2)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) tmp%1 tmp%2) (and (=> %%location_label%%1 (= (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!hashmap_t.CKeyHashMap. self!) (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!hashmap_t.CKeyHashMap. other!))) (=> %%location_label%%2 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyHashMap. self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyHashMap. other!)))))))))))
(check-sat)
(exit)
