...
(assert (has_type s1! (TYPE%vstd!seq.Seq. A&. A&)))
(assert (has_type s2! (TYPE%vstd!seq.Seq. A&. A&)))
(assert (not (= s1! s2!)))
(assert (= (vstd!seq.Seq.len.? A&. A& s1!) (vstd!seq.Seq.len.? A&. A& s2!)))
(declare-fun %%choose%%0 (Type Int Int Dcr Type Poly Dcr Type Poly Dcr Type Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly) (%%hole%%9 Dcr) (%%hole%%10 Type) (%%hole%%11 Poly) (%%hole%%12 Dcr) (%%hole%%13 Type) (%%hole%%14 Poly)) (! (=> (exists ((i$ Poly)) (! (and (has_type i$ %%hole%%0) (and (and (<= %%hole%%1 (%I i$)) (< (%I i$) %%hole%%2)) (not (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$) (vstd!seq.Seq.index.? %%hole%%6 %%hole%%7 %%hole%%8 i$))))) :pattern ((vstd!seq.Seq.index.? %%hole%%9 %%hole%%10 %%hole%%11 i$)) :pattern ((vstd!seq.Seq.index.? %%hole%%12 %%hole%%13 %%hole%%14 i$)) )) (exists ((i$ Poly)) (! (and (and (has_type i$ %%hole%%0) (and (and (<= %%hole%%1 (%I i$)) (< (%I i$) %%hole%%2)) (not (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$) (vstd!seq.Seq.index.? %%hole%%6 %%hole%%7 %%hole%%8 i$))))) (= (%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14) i$)) :pattern ((vstd!seq.Seq.index.? %%hole%%9 %%hole%%10 %%hole%%11 i$)) :pattern ((vstd!seq.Seq.index.? %%hole%%12 %%hole%%13 %%hole%%14 i$))))) :pattern ((%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14)))))
...
(assert (not (or (and (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? A&. A& s1!))) (= (vstd!seq.Seq.index.? A&. A& s1! i$) (vstd!seq.Seq.index.? A&. A& s2! i$)))) :pattern ((vstd!seq.Seq.index.? A&. A& s1! i$)) :pattern ((vstd!seq.Seq.index.? A&. A& s2! i$)) )) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1! s2!)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? A&. A& s1!))) (= (vstd!seq.Seq.index.? A&. A& s1! i$) (vstd!seq.Seq.index.? A&. A& s2! i$)))) :pattern ((vstd!seq.Seq.index.? A&. A& s1! i$)) :pattern ((vstd!seq.Seq.index.? A&. A& s2! i$)) ))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= i! (%I (as_type (%%choose%%0 INT 0 (vstd!seq.Seq.len.? A&. A& s1!) A&. A& s1! A&. A& s2! A&. A& s1! A&. A& s2!) INT))) (and (=> %%location_label%%1 (and (<= 0 i!) (< i! (vstd!seq.Seq.len.? A&. A& s1!)))) (=> %%location_label%%2 (not (= (vstd!seq.Seq.index.? A&. A& s1! (I i!)) (vstd!seq.Seq.index.? A&. A& s2! (I i!)))))))))))
(check-sat)
(exit)
