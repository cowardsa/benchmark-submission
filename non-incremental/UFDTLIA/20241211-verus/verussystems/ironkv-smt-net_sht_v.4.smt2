...
(set-info :comment ";; Function-Def lib::net_sht_v::take_buf")
(set-info :comment ";; ironsht/src/net_sht_v.rs:247:1: 247:31 (#0)")
(declare-const buf!@0 alloc!vec.Vec<u8./allocator_global%.>.)
