...
(declare-const node_id$1@ Int)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (has_type combiners! (TYPE%vstd!map.Map. $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState.)))
...
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!))) (=> (and (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)) (>= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)) 0)) (or (and (=> (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)) (or (and (=> (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)) 0) %%switch_label%%3) (=> (not (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)) 0)) (=> (= node_id$1@ (%I (vstd!set.impl&%0.choose.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)))) (=> (= tmp%4 (< (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (vstd!map.impl&%0.remove.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners! (I node_id$1@)))) (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)))) (and (=> %%location_label%%0 tmp%4) (=> tmp%4 %%switch_label%%3)))))) (and (not %%switch_label%%3) %%switch_label%%2))) (=> (not (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!))) %%switch_label%%2)) (and (not %%switch_label%%2) (or (and (=> (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)) (or (and (=> (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)) 0) (=> (= tmp%2 (vstd!set.impl&%0.empty.? $ NAT)) %%switch_label%%1)) (=> (not (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)) 0)) (=> (= node_id@ (%I (vstd!set.impl&%0.choose.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!)))) (=> (= tmp%1 (vstd!map.impl&%0.remove.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners! (I node_id@))) (and (=> %%location_label%%1 (check_decrease_int (let ((combiners!$0 tmp%1)) (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!$0))) decrease%init0 false)) (=> (= tmp%2 (vstd!set.impl&%0.union.? $ NAT (Poly%vstd!set.Set<nat.>. req_ids@) (lib!spec.utils.seq_to_set.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec.unbounded_log.impl&%7.queued_ops.? (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners! (I node_id@))))))) %%switch_label%%1)))))) (and (not %%switch_label%%1) (=> (= tmp%3 tmp%2) %%switch_label%%0)))) (=> (not (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. combiners!))) (=> (= tmp%3 (vstd!pervasive.arbitrary.? $ (TYPE%vstd!set.Set. $ NAT))) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
