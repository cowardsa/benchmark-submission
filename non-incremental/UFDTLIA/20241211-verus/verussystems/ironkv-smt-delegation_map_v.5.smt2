...
(declare-const self! lib!keys_t.Ordering.)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= b! (not (is-lib!keys_t.Ordering./Equal_ self!))) (=> %%location_label%%0 (= b! (lib!delegation_map_v.impl&%0.ne.? (Poly%lib!keys_t.Ordering. self!)))))))
(check-sat)
(exit)
