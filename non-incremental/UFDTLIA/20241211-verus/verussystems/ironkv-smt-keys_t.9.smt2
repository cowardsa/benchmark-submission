...
(set-info :comment ";; Function-Specs lib::keys_t::KeyRange::contains_exec")
(declare-fun ens%lib!keys_t.impl&%5.contains_exec. (Dcr Type lib!keys_t.KeyRange. Poly Bool) Bool)
(assert (forall ((K&. Dcr) (K& Type) (self! lib!keys_t.KeyRange.) (k! Poly) (b! Bool)) (! (= (ens%lib!keys_t.impl&%5.contains_exec. K&. K& self! k! b!) (= b! (lib!keys_t.impl&%4.contains.? K&. K& (Poly%lib!keys_t.KeyRange. self!) k!))) :pattern ((ens%lib!keys_t.impl&%5.contains_exec. K&. K& self! k! b!)) )))
(set-info :comment ";; Function-Def lib::keys_t::KeyRange::contains_exec")
(set-info :comment ";; ironsht/src/keys_t.rs:120:5: 120:51 (#0)")
(declare-const K&. Dcr)
(declare-const K& Type)
(declare-const b! Bool)
(declare-const self! lib!keys_t.KeyRange.)
(declare-const k! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Bool)
(declare-const tmp%3 lib!keys_t.KeyIterator.)
(declare-const tmp%4 Bool)
(declare-const tmp%5 lib!keys_t.KeyIterator.)
(declare-const tmp%6 Bool)
(declare-const ki@ lib!keys_t.KeyIterator.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!keys_t.KeyRange. self!) (TYPE%lib!keys_t.KeyRange. K&. K&)))
(assert (has_type k! K&))
...
(assert (not (=> (ens%lib!verus_extra.clone_v.VerusClone.clone. K&. K& k! tmp%1) (=> (= ki@ (lib!keys_t.KeyIterator./KeyIterator (%Poly%core!option.Option. (Poly%core!option.Option. (core!option.Option./Some tmp%1))))) (=> (= tmp%3 (lib!keys_t.KeyRange./KeyRange/lo (%Poly%lib!keys_t.KeyRange. (Poly%lib!keys_t.KeyRange. self!)))) (=> (ens%lib!delegation_map_v.impl&%2.lt. K&. K& ki@ tmp%3 tmp%2) (or (and (=> (not tmp%2) (=> (= tmp%5 (lib!keys_t.KeyRange./KeyRange/hi (%Poly%lib!keys_t.KeyRange. (Poly%lib!keys_t.KeyRange. self!)))) (=> (ens%lib!delegation_map_v.impl&%2.lt. K&. K& ki@ tmp%5 tmp%4) (=> (= tmp%6 tmp%4) %%switch_label%%0)))) (=> (not (not tmp%2)) (=> (= tmp%6 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= b! tmp%6) (=> %%location_label%%0 (= b! (lib!keys_t.impl&%4.contains.? K&. K& (Poly%lib!keys_t.KeyRange. self!) k!))))))))))))
(check-sat)
(exit)
