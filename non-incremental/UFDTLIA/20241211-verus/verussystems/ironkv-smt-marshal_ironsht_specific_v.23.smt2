...
(declare-const res@ lib!hashmap_t.CKeyHashMap.)
(declare-const tmp%5 core!option.Option.)
(declare-const x@ alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>.)
...
(assert (not (=> (ens%lib!marshal_v.Marshalable.deserialize. $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) data! start! tmp%1) (=> (= tmp%%@ (%Poly%core!option.Option. tmp%1)) (or (and (=> (is-core!option.Option./None_ tmp%%@) (=> (= tmp%6 core!option.Option./None) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ tmp%%@)) (=> (= x@ (%Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@))))))) (=> (= end@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@))))))) (=> (ens%lib!marshal_ironsht_specific_v.sorted_keys. x@ tmp%2) (or (and (=> (not tmp%2) (=> (= tmp%5 core!option.Option./None) %%switch_label%%1)) (=> (not (not tmp%2)) (=> (ens%lib!hashmap_t.impl&%0.from_vec. x@ res@) (and (=> %%location_label%%0 (uInv SZ (Sub end@ (%I start!)))) (=> (ens%lib!marshal_ironsht_specific_v.ckeyhashmap_max_serialized_size_exec. 0 tmp%3) (or (and (=> (> (uClip SZ (Sub end@ (%I start!))) tmp%3) (=> (= tmp%4 core!option.Option./None) %%switch_label%%2)) (=> (not (> (uClip SZ (Sub end@ (%I start!))) tmp%3)) (=> (ens%lib!hashmap_t.impl&%0.lemma_from_vec. x@) (=> (= tmp%4 (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (Poly%lib!hashmap_t.CKeyHashMap. res@) (I end@))))) %%switch_label%%2)))) (and (not %%switch_label%%2) (=> (= tmp%5 tmp%4) %%switch_label%%1)))))))) (and (not %%switch_label%%1) (=> (= tmp%6 tmp%5) %%switch_label%%0)))))))) (and (not %%switch_label%%0) (=> (= %return! (Poly%core!option.Option. tmp%6)) (=> %%location_label%%1 (=> (and (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (is-tuple%2./tuple%2_ (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%Poly%lib!hashmap_t.CKeyHashMap. (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!hashmap_t.CKeyHashMap. (Poly%lib!hashmap_t.CKeyHashMap. x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyHashMap. (Poly%lib!hashmap_t.CKeyHashMap. x$$0)))))))))))))))
(check-sat)
(exit)
