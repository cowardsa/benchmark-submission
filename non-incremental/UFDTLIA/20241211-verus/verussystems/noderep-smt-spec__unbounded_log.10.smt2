...
(assert (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (Poly%lib!spec.types.LogEntry. log_entry!))) node_id!)))
...
(assert (not (=> (= decrease%init0 (Sub logIndexUpper! logIndexLower!)) (or (and (=> (= logIndexLower! (nClip (Add logIndexUpper! 1))) %%switch_label%%0) (=> (not (= logIndexLower! (nClip (Add logIndexUpper! 1)))) (or (and (=> (= logIndexLower! logIndexUpper!) (=> (= tmp%1 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log!) (I logIndexLower!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (Poly%vstd!seq.Seq<nat.>. queue!) new_log! (I queueIndex!) (I (nClip (Add logIndexLower! 1))) (I (nClip (Add logIndexUpper! 1))) (I node_id!) new_updates!)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%1)))))))))) (=> (not (= logIndexLower! logIndexUpper!)) (=> (= tmp%4 (= (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)) (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! (I logIndexLower!)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (or (and (=> (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!) (=> (= tmp%5 (nClip (Add queueIndex! 1))) (=> (= tmp%6 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%4 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (new_log!$2 new_log!) (queueIndex!$3 tmp%5) (logIndexLower!$4 tmp%6) (logIndexUpper!$5 logIndexUpper!) (node_id!$6 node_id!) (updates!$7 updates!) (new_updates!$8 new_updates!) (new_rid!$9 new_rid!) (log_entry!$10 log_entry!)) (Sub logIndexUpper!$5 logIndexLower!$4)) decrease%init0 false)) (and (=> %%location_label%%5 (req%lib!spec.unbounded_log.LogRangeMatchesQueue_append_other_augment. DT&. DT& queue! log! new_log! tmp%5 tmp%6 logIndexUpper! node_id! updates! new_updates! new_rid! log_entry!)) (=> (ens%lib!spec.unbounded_log.LogRangeMatchesQueue_append_other_augment. DT&. DT& queue! log! new_log! tmp%5 tmp%6 logIndexUpper! node_id! updates! new_updates! new_rid! log_entry!) (=> (= tmp%7 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (Poly%vstd!seq.Seq<nat.>. queue!) new_log! (I queueIndex!) (I logIndexLower!) (I (nClip (Add logIndexUpper! 1))) (I node_id!) new_updates!)) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 %%switch_label%%2))))))))) (=> (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!)) (=> (= tmp%8 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%7 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (new_log!$2 new_log!) (queueIndex!$3 queueIndex!) (logIndexLower!$4 tmp%8) (logIndexUpper!$5 logIndexUpper!) (node_id!$6 node_id!) (updates!$7 updates!) (new_updates!$8 new_updates!) (new_rid!$9 new_rid!) (log_entry!$10 log_entry!)) (Sub logIndexUpper!$5 logIndexLower!$4)) decrease%init0 false)) (and (=> %%location_label%%8 (req%lib!spec.unbounded_log.LogRangeMatchesQueue_append_other_augment. DT&. DT& queue! log! new_log! queueIndex! tmp%8 logIndexUpper! node_id! updates! new_updates! new_rid! log_entry!)) (=> (ens%lib!spec.unbounded_log.LogRangeMatchesQueue_append_other_augment. DT&. DT& queue! log! new_log! queueIndex! tmp%8 logIndexUpper! node_id! updates! new_updates! new_rid! log_entry!) %%switch_label%%2)))))) (and (not %%switch_label%%2) %%switch_label%%1))))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%9 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (Poly%vstd!seq.Seq<nat.>. queue!) new_log! (I queueIndex!) (I logIndexLower!) (I (nClip (Add logIndexUpper! 1))) (I node_id!) new_updates!)))))))
(check-sat)
(exit)
