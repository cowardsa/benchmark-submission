...
(assert (not (=> (= tmp%2 (I (lib!keys_t.SHTKey./SHTKey/ukey (%Poly%lib!keys_t.SHTKey. self!)))) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ (UINT 64) tmp%2 tmp%1) (=> (= %return! tmp%1) (=> %%location_label%%0 (= %return! (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!keys_t.SHTKey. self!))))))))
(check-sat)
(exit)
