...
(assert (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!io_t.EndPoint. self! other!)))
...
(assert (not (=> (= tmp%1 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!marshal_ironsht_specific_v.impl&%7.forward_bijection_for_view_equality_do_not_use_for_anything_else.? self!))) (=> (= tmp%2 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!marshal_ironsht_specific_v.impl&%7.forward_bijection_for_view_equality_do_not_use_for_anything_else.? other!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%1 tmp%2)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%1 tmp%2) (and (=> %%location_label%%1 (= (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!io_t.EndPoint. self!) (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!io_t.EndPoint. other!))) (=> %%location_label%%2 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!io_t.EndPoint. self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!io_t.EndPoint. other!))))))))))
(check-sat)
(exit)
