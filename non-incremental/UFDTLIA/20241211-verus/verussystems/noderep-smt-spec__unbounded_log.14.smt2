...
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!)))) (or (and (=> (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))) 0) (=> (= tmp%1 (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. (lib!spec.unbounded_log.combiner_request_ids.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))) 0)) (=> (= node_id@ (%I (vstd!set.impl&%0.choose.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))))) (and (=> (= tmp%2 (%Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. (vstd!map.impl&%0.remove.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!) (I node_id@)))) (and (=> %%location_label%%1 (check_decrease_int (let ((combiners!$0 tmp%2)) (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!$0)))) decrease%init0 false)) (and (=> %%location_label%%2 (req%lib!spec.unbounded_log.combiner_request_ids_finite. tmp%2)) (=> (ens%lib!spec.unbounded_log.combiner_request_ids_finite. tmp%2) (=> %%location_label%%3 (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. (lib!spec.unbounded_log.combiner_request_ids.? (vstd!map.impl&%0.remove.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!) (I node_id@)))))))))) (=> (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. (lib!spec.unbounded_log.combiner_request_ids.? (vstd!map.impl&%0.remove.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!) (I node_id@))))) (and (=> (= tmp%3 (Poly%vstd!seq.Seq<nat.>. (lib!spec.unbounded_log.impl&%7.queued_ops.? (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!) (I node_id@))))) (=> (ens%lib!spec.utils.seq_to_set_is_finite. $ NAT tmp%3) (=> %%location_label%%4 (vstd!set.impl&%0.finite.? $ NAT (lib!spec.utils.seq_to_set.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec.unbounded_log.impl&%7.queued_ops.? (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!) (I node_id@))))))))) (=> (vstd!set.impl&%0.finite.? $ NAT (lib!spec.utils.seq_to_set.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec.unbounded_log.impl&%7.queued_ops.? (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!) (I node_id@)))))) %%switch_label%%0))))))) (and (not %%switch_label%%0) (=> %%location_label%%5 (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. (lib!spec.unbounded_log.combiner_request_ids.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))))))))))
(check-sat)
(exit)
