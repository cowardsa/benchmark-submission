...
(set-info :comment ";; Function-Specs lib::cmessage_v::CMessage::is_message_marshallable")
(declare-fun ens%lib!cmessage_v.impl&%1.is_message_marshallable. (lib!cmessage_v.CMessage. Bool) Bool)
(assert (forall ((self! lib!cmessage_v.CMessage.) (b! Bool)) (! (= (ens%lib!cmessage_v.impl&%1.is_message_marshallable. self! b!) (= b! (lib!cmessage_v.impl&%1.message_marshallable.? (Poly%lib!cmessage_v.CMessage. self!)))) :pattern ((ens%lib!cmessage_v.impl&%1.is_message_marshallable. self! b!)) )))
(set-info :comment ";; Function-Def lib::cmessage_v::CMessage::is_message_marshallable")
(set-info :comment ";; ironsht/src/cmessage_v.rs:154:3: 154:52 (#0)")
...
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::view_equal_spec")
(set-info :comment ";; ironsht/src/cmessage_v.rs:227:3: 227:33 (#0)")
...
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::clone_up_to_view")
(set-info :comment ";; ironsht/src/cmessage_v.rs:248:3: 248:45 (#0)")
(set-info :comment ";; Function-Specs lib::cmessage_v::CSingleMessage::is_marshallable")
(declare-fun ens%lib!cmessage_v.impl&%2.is_marshallable. (lib!cmessage_v.CSingleMessage. Bool) Bool)
(assert (forall ((self! lib!cmessage_v.CSingleMessage.) (b! Bool)) (! (= (ens%lib!cmessage_v.impl&%2.is_marshallable. self! b!) (= b! (lib!cmessage_v.impl&%2.marshallable.? (Poly%lib!cmessage_v.CSingleMessage. self!)))) :pattern ((ens%lib!cmessage_v.impl&%2.is_marshallable. self! b!)) )))
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::is_marshallable")
(set-info :comment ";; ironsht/src/cmessage_v.rs:272:3: 272:44 (#0)")
(declare-const b! Bool)
(declare-const self! lib!cmessage_v.CSingleMessage.)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Bool)
(declare-const tmp%3 Bool)
(declare-const seqno@ Int)
(declare-const dst@ lib!io_t.EndPoint.)
(declare-const m@ lib!cmessage_v.CMessage.)
(declare-const tmp%4 Bool)
(declare-const tmp%5 Bool)
(assert fuel_defaults)
(assert (has_type (Poly%lib!cmessage_v.CSingleMessage. self!) TYPE%lib!cmessage_v.CSingleMessage.))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(declare-const %%switch_label%%2 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (or (and (=> (is-lib!cmessage_v.CSingleMessage./Ack_ self!) (=> (= tmp%5 (let ((ack_seqno$ (lib!cmessage_v.CSingleMessage./Ack/ack_seqno (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. self!))))) true)) %%switch_label%%0)) (=> (not (is-lib!cmessage_v.CSingleMessage./Ack_ self!)) (or (and (=> (is-lib!cmessage_v.CSingleMessage./Message_ self!) (=> (= seqno@ (lib!cmessage_v.CSingleMessage./Message/seqno (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. self!)))) (=> (= dst@ (lib!cmessage_v.CSingleMessage./Message/dst (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. self!)))) (=> (= m@ (lib!cmessage_v.CSingleMessage./Message/m (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. self!)))) (=> (ens%lib!io_t.impl&%4.valid_physical_address. dst@ tmp%1) (or (and (=> tmp%1 (=> (ens%lib!cmessage_v.impl&%1.is_message_marshallable. m@ tmp%2) (=> (= tmp%3 tmp%2) %%switch_label%%2))) (=> (not tmp%1) (=> (= tmp%3 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%4 tmp%3) %%switch_label%%1)))))))) (=> (not (is-lib!cmessage_v.CSingleMessage./Message_ self!)) (=> (= tmp%4 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%5 tmp%4) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= b! tmp%5) (=> %%location_label%%0 (= b! (lib!cmessage_v.impl&%2.marshallable.? (Poly%lib!cmessage_v.CSingleMessage. self!)))))))))
(check-sat)
(exit)
