...
(assert (not (=> %%location_label%%0 (vstd!set_lib.impl&%0.is_full.? K&. K& (vstd!map.impl&%0.dom.? K&. K& $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (lib!delegation_map_v.impl&%4.view.? K&. K& (Poly%lib!delegation_map_v.DelegationMap. self!)))))))
(check-sat)
(exit)
