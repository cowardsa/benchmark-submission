...
(declare-const self! lib!single_delivery_t.SingleDelivery.)
(declare-const src! lib!abstract_end_point_t.AbstractEndPoint.)
(declare-const dests! vstd!set.Set<lib!abstract_end_point_t.AbstractEndPoint.>.)
(declare-const elem@ Poly)
(declare-const tmp%1 Bool)
(declare-const elem$1@ Poly)
(declare-const tmp%2 Bool)
(declare-const s1@ vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>.)
(declare-const s2@ vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>.)
(declare-const s1$1@ vstd!set.Set<lib!network_t.Packet.>.)
(declare-const s2$1@ vstd!set.Set<lib!network_t.Packet.>.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!single_delivery_t.SingleDelivery. self!) (TYPE%lib!single_delivery_t.SingleDelivery. $ TYPE%lib!message_t.Message.)))
(assert (= dests! (%Poly%vstd!set.Set<lib!abstract_end_point_t.AbstractEndPoint.>. (vstd!set.impl&%0.empty.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint.))))
...
(assert (not (=> (= s1@ (%Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. (vstd!set_lib.impl&%0.map.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<lib!abstract_end_point_t.AbstractEndPoint.>. dests!) (Poly%fun%1. (mk_fun (%%lambda%%11 (Poly%lib!single_delivery_t.SingleDelivery. self!) (Poly%lib!abstract_end_point_t.AbstractEndPoint. src!))))))) (=> (= s2@ (%Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. (vstd!set.impl&%0.empty.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.)))) (and (and (=> (has_type elem@ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.)) (=> %%location_label%%0 (and (=> (vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s1@) elem@) (vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s2@) elem@)) (=> (vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s2@) elem@) (vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s1@) elem@))))) (=> (forall ((elem$ Poly)) (! (=> (has_type elem$ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.)) (and (=> (vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s1@) elem$) (vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s2@) elem$)) (=> (vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s2@) elem$) (vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s1@) elem$)))) :pattern ((vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s1@) elem$)) :pattern ((vstd!set.impl&%0.contains.? $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s2@) elem$)) )) (=> (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. $ (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.)) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s1@) (Poly%vstd!set.Set<vstd!set.Set<lib!network_t.Packet.>.>. s2@))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> (= s1$1@ (lib!single_delivery_t.impl&%2.un_acked_messages_for_dests.? (Poly%lib!single_delivery_t.SingleDelivery. self!) (Poly%lib!abstract_end_point_t.AbstractEndPoint. src!) (Poly%vstd!set.Set<lib!abstract_end_point_t.AbstractEndPoint.>. dests!))) (=> (= s2$1@ (%Poly%vstd!set.Set<lib!network_t.Packet.>. (vstd!set.impl&%0.empty.? $ TYPE%lib!network_t.Packet.))) (and (and (=> (has_type elem$1@ TYPE%lib!network_t.Packet.) (=> %%location_label%%3 (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s1$1@) elem$1@) (vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s2$1@) elem$1@)) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s2$1@) elem$1@) (vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s1$1@) elem$1@))))) (=> (forall ((elem$ Poly)) (! (=> (has_type elem$ TYPE%lib!network_t.Packet.) (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s1$1@) elem$) (vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s2$1@) elem$)) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s2$1@) elem$) (vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s1$1@) elem$)))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s1$1@) elem$)) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!network_t.Packet. (Poly%vstd!set.Set<lib!network_t.Packet.>. s2$1@) elem$)) )) (=> (= tmp%2 (ext_eq false (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.) (Poly%vstd!set.Set<lib!network_t.Packet.>. s1$1@) (Poly%vstd!set.Set<lib!network_t.Packet.>. s2$1@))) (and (=> %%location_label%%4 tmp%2) (=> tmp%2 (=> %%location_label%%5 (= s1$1@ s2$1@))))))) (=> (= s1$1@ s2$1@) (=> %%location_label%%6 (= (lib!single_delivery_t.impl&%2.un_acked_messages_for_dests.? (Poly%lib!single_delivery_t.SingleDelivery. self!) (Poly%lib!abstract_end_point_t.AbstractEndPoint. src!) (Poly%vstd!set.Set<lib!abstract_end_point_t.AbstractEndPoint.>. dests!)) (%Poly%vstd!set.Set<lib!network_t.Packet.>. (vstd!set.impl&%0.empty.? $ TYPE%lib!network_t.Packet.))))))))))))))
(check-sat)
(exit)
