...
(declare-const s! lib!delegation_map_v.StrictlyOrderedMap.)
(declare-const elem@ Poly)
(declare-const tmp%1 Bool)
(declare-const s1@ Poly)
(declare-const s2@ Poly)
(declare-const tmp%2 Poly)
(declare-const keys@ lib!delegation_map_v.StrictlyOrderedVec.)
...
(assert (not (=> (ens%lib!delegation_map_v.impl&%1.new. K&. K& keys@) (=> (= m@ (vstd!map.impl&%0.empty.? K&. K& $ TYPE%lib!io_t.EndPoint.)) (=> (= s1@ (vstd!map.impl&%0.dom.? K&. K& $ TYPE%lib!io_t.EndPoint. m@)) (=> (= s2@ (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. keys@)))) (and (and (=> (has_type elem@ K&) (=> %%location_label%%0 (and (=> (vstd!set.impl&%0.contains.? K&. K& s1@ elem@) (vstd!set.impl&%0.contains.? K&. K& s2@ elem@)) (=> (vstd!set.impl&%0.contains.? K&. K& s2@ elem@) (vstd!set.impl&%0.contains.? K&. K& s1@ elem@))))) (=> (forall ((elem$ Poly)) (! (=> (has_type elem$ K&) (and (=> (vstd!set.impl&%0.contains.? K&. K& s1@ elem$) (vstd!set.impl&%0.contains.? K&. K& s2@ elem$)) (=> (vstd!set.impl&%0.contains.? K&. K& s2@ elem$) (vstd!set.impl&%0.contains.? K&. K& s1@ elem$)))) :pattern ((vstd!set.impl&%0.contains.? K&. K& s1@ elem$)) :pattern ((vstd!set.impl&%0.contains.? K&. K& s2@ elem$)) )) (=> (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. K&. K&) s1@ s2@)) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> (ens%alloc!vec.impl&%0.new. $ TYPE%lib!io_t.EndPoint. tmp%2) (=> (= s! (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. keys@)) (%Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. tmp%2) m@)) (and (=> %%location_label%%3 (lib!delegation_map_v.impl&%3.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. s!))) (=> %%location_label%%4 (= (lib!delegation_map_v.impl&%3.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. s!)) (vstd!map.impl&%0.empty.? K&. K& $ TYPE%lib!io_t.EndPoint.))))))))))))))
(check-sat)
(exit)
