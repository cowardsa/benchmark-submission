...
(assert (not (=> (= s1@ (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& (vstd!seq.Seq.add.? A&. A& s1! s2!) (Poly%fun%1. f!))) (=> (= s2@ (vstd!seq.Seq.add.? B&. B& (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s1! (Poly%fun%1. f!)) (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s2! (Poly%fun%1. f!)))) (and (=> (= tmp%1 (= (vstd!seq.Seq.len.? B&. B& s1@) (vstd!seq.Seq.len.? B&. B& s2@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> (has_type i@ INT) (=> (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? B&. B& s1@))) (or (and (=> (< (%I i@) (vstd!seq.Seq.len.? A&. A& s1!)) (=> (= tmp%2 (= (vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s1! s2!) i@) (vstd!seq.Seq.index.? A&. A& s1! i@))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%0)))) (=> (not (< (%I i@) (vstd!seq.Seq.len.? A&. A& s1!))) (=> (= tmp%3 (= (vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s1! s2!) i@) (vstd!seq.Seq.index.? A&. A& s2! (I (Sub (%I i@) (vstd!seq.Seq.len.? A&. A& s1!)))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%3 (= (vstd!seq.Seq.index.? B&. B& s1@ i@) (vstd!seq.Seq.index.? B&. B& s2@ i@))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? B&. B& s1@))) (= (vstd!seq.Seq.index.? B&. B& s1@ i$) (vstd!seq.Seq.index.? B&. B& s2@ i$)))) :pattern ((vstd!seq.Seq.index.? B&. B& s1@ i$)) :pattern ((vstd!seq.Seq.index.? B&. B& s2@ i$)) )) (=> (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. B&. B&) s1@ s2@)) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (=> %%location_label%%5 (= s1@ s2@)))))))))) (=> (= s1@ s2@) (=> %%location_label%%6 (= (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& (vstd!seq.Seq.add.? A&. A& s1! s2!) (Poly%fun%1. f!)) (vstd!seq.Seq.add.? B&. B& (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s1! (Poly%fun%1. f!)) (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s2! (Poly%fun%1. f!)))))))))))
(check-sat)
(exit)
