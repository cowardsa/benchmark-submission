...
(declare-const v$2@ core!option.Option.)
...
(declare-const tmp%15 lib!keys_t.KeyIterator.)
(declare-const tmp%16 lib!keys_t.KeyIterator.)
...
(declare-const tmp%19 lib!keys_t.KeyIterator.)
(declare-const tmp%20 lib!keys_t.KeyIterator.)
...
(assert (not (or (and (=> (is-lib!cmessage_v.CMessage./GetRequest_ self!) (=> (= k@ (lib!cmessage_v.CMessage./GetRequest/k (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!cmessage_v.is_key_valid. k@ tmp%1) (=> (= tmp%27 tmp%1) %%switch_label%%0)))) (=> (not (is-lib!cmessage_v.CMessage./GetRequest_ self!)) (or (and (=> (is-lib!cmessage_v.CMessage./SetRequest_ self!) (=> (= k$1@ (lib!cmessage_v.CMessage./SetRequest/k (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= v@ (lib!cmessage_v.CMessage./SetRequest/v (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!cmessage_v.is_key_valid. k$1@ tmp%2) (or (and (=> tmp%2 (or (and (=> (is-core!option.Option./Some_ v@) (=> (= v$1@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. v@))))) (=> (ens%lib!cmessage_v.is_value_valid. v$1@ tmp%3) (=> (= tmp%4 tmp%3) %%switch_label%%3)))) (=> (not (is-core!option.Option./Some_ v@)) (=> (= tmp%4 true) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= tmp%5 tmp%4) %%switch_label%%2)))) (=> (not tmp%2) (=> (= tmp%5 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%26 tmp%5) %%switch_label%%1))))))) (=> (not (is-lib!cmessage_v.CMessage./SetRequest_ self!)) (or (and (=> (is-lib!cmessage_v.CMessage./Reply_ self!) (=> (= k$2@ (lib!cmessage_v.CMessage./Reply/k (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= v$2@ (lib!cmessage_v.CMessage./Reply/v (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!cmessage_v.is_key_valid. k$2@ tmp%6) (or (and (=> tmp%6 (or (and (=> (is-core!option.Option./Some_ v$2@) (=> (= v$3@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. v$2@))))) (=> (ens%lib!cmessage_v.is_value_valid. v$3@ tmp%7) (=> (= tmp%8 tmp%7) %%switch_label%%6)))) (=> (not (is-core!option.Option./Some_ v$2@)) (=> (= tmp%8 true) %%switch_label%%6))) (and (not %%switch_label%%6) (=> (= tmp%9 tmp%8) %%switch_label%%5)))) (=> (not tmp%6) (=> (= tmp%9 false) %%switch_label%%5))) (and (not %%switch_label%%5) (=> (= tmp%25 tmp%9) %%switch_label%%4))))))) (=> (not (is-lib!cmessage_v.CMessage./Reply_ self!)) (or (and (=> (is-lib!cmessage_v.CMessage./Redirect_ self!) (=> (= k$3@ (lib!cmessage_v.CMessage./Redirect/k (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= id@ (lib!cmessage_v.CMessage./Redirect/id (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!cmessage_v.is_key_valid. k$3@ tmp%10) (or (and (=> tmp%10 (=> (ens%lib!io_t.impl&%4.valid_physical_address. id@ tmp%11) (=> (= tmp%12 tmp%11) %%switch_label%%8))) (=> (not tmp%10) (=> (= tmp%12 false) %%switch_label%%8))) (and (not %%switch_label%%8) (=> (= tmp%24 tmp%12) %%switch_label%%7))))))) (=> (not (is-lib!cmessage_v.CMessage./Redirect_ self!)) (or (and (=> (is-lib!cmessage_v.CMessage./Shard_ self!) (=> (= kr@ (lib!cmessage_v.CMessage./Shard/kr (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= recipient@ (lib!cmessage_v.CMessage./Shard/recipient (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!io_t.impl&%4.valid_physical_address. recipient@ tmp%13) (or (and (=> tmp%13 (=> (= tmp%15 (lib!keys_t.KeyRange./KeyRange/lo (%Poly%lib!keys_t.KeyRange. (Poly%lib!keys_t.KeyRange. kr@)))) (=> (= tmp%16 (lib!keys_t.KeyRange./KeyRange/hi (%Poly%lib!keys_t.KeyRange. (Poly%lib!keys_t.KeyRange. kr@)))) (=> (ens%lib!delegation_map_v.impl&%2.lt. $ TYPE%lib!keys_t.SHTKey. tmp%15 tmp%16 tmp%14) (=> (= tmp%17 tmp%14) %%switch_label%%10))))) (=> (not tmp%13) (=> (= tmp%17 false) %%switch_label%%10))) (and (not %%switch_label%%10) (=> (= tmp%23 tmp%17) %%switch_label%%9))))))) (=> (not (is-lib!cmessage_v.CMessage./Shard_ self!)) (=> (= range@ (lib!cmessage_v.CMessage./Delegate/range (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= h@ (lib!cmessage_v.CMessage./Delegate/h (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= tmp%19 (lib!keys_t.KeyRange./KeyRange/lo (%Poly%lib!keys_t.KeyRange. (Poly%lib!keys_t.KeyRange. range@)))) (=> (= tmp%20 (lib!keys_t.KeyRange./KeyRange/hi (%Poly%lib!keys_t.KeyRange. (Poly%lib!keys_t.KeyRange. range@)))) (=> (ens%lib!delegation_map_v.impl&%2.lt. $ TYPE%lib!keys_t.SHTKey. tmp%19 tmp%20 tmp%18) (or (and (=> tmp%18 (=> (ens%lib!hashmap_t.impl&%0.valid. h@ tmp%21) (=> (= tmp%22 tmp%21) %%switch_label%%11))) (=> (not tmp%18) (=> (= tmp%22 false) %%switch_label%%11))) (and (not %%switch_label%%11) (=> (= tmp%23 tmp%22) %%switch_label%%9)))))))))) (and (not %%switch_label%%9) (=> (= tmp%24 tmp%23) %%switch_label%%7))))) (and (not %%switch_label%%7) (=> (= tmp%25 tmp%24) %%switch_label%%4))))) (and (not %%switch_label%%4) (=> (= tmp%26 tmp%25) %%switch_label%%1))))) (and (not %%switch_label%%1) (=> (= tmp%27 tmp%26) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= b! tmp%27) (=> %%location_label%%0 (= b! (lib!cmessage_v.impl&%1.message_marshallable.? (Poly%lib!cmessage_v.CMessage. self!)))))))))
(check-sat)
(exit)
