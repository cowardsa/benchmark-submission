...
(set-info :comment ";; MODULE 'module pmem::traits_t'")
...
(assert (distinct fuel%lib!pmem.pmcopy_t.impl&%27.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%27.spec_align_of. fuel%lib!pmem.pmcopy_t.impl&%55.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%55.spec_align_of. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(set-info :comment ";; Function-Specs lib::pmem::traits_t::PmSized::align_of")
(declare-fun ens%lib!pmem.traits_t.PmSized.align_of. (Dcr Type Poly) Bool)
(assert (forall ((Self%&. Dcr) (Self%& Type) (out! Poly)) (! (= (ens%lib!pmem.traits_t.PmSized.align_of. Self%&. Self%& out!) (and (has_type out! (UINT SZ)) (= out! (lib!pmem.pmcopy_t.SpecPmSized.spec_align_of.? Self%&. Self%&)))) :pattern ((ens%lib!pmem.traits_t.PmSized.align_of. Self%&. Self%& out!)) )))
...
(set-info :comment ";; Function-Def lib::pmem::traits_t::size_of")
(set-info :comment ";; src/pmem/traits_t.rs:90:5: 90:48 (#0)")
(set-info :comment ";; Function-Specs lib::pmem::traits_t::align_of")
(declare-fun ens%lib!pmem.traits_t.align_of. (Dcr Type Int) Bool)
(assert (forall ((S&. Dcr) (S& Type) (out! Int)) (! (= (ens%lib!pmem.traits_t.align_of. S&. S& out!) (and (uInv SZ out!) (= out! (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_align_of.? S&. S&))))) :pattern ((ens%lib!pmem.traits_t.align_of. S&. S& out!)) )))
(set-info :comment ";; Function-Def lib::pmem::traits_t::align_of")
(set-info :comment ";; src/pmem/traits_t.rs:97:5: 97:49 (#0)")
(declare-const S&. Dcr)
(declare-const S& Type)
(declare-const out! Int)
(declare-const tmp%1 Poly)
(assert fuel_defaults)
(assert (tr_bound%lib!pmem.traits_t.PmSized. S&. S&))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!pmem.traits_t.PmSized.align_of. S&. S& tmp%1) (=> (= out! (%I tmp%1)) (=> %%location_label%%0 (= out! (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_align_of.? S&. S&))))))))
(check-sat)
(exit)
