...
(assert (not (and (=> (has_type s@ (TYPE%vstd!set.Set. A&. A&)) (=> (has_type f@ (TYPE%fun%1. A&. A& B&. B&)) (=> (vstd!set.impl&%0.finite.? A&. A& s@) (and (=> %%location_label%%0 (req%lib!verus_extra.set_lib_ext_v.map_finite. A&. A& B&. B& s@ (%Poly%fun%1. f@))) (=> (ens%lib!verus_extra.set_lib_ext_v.map_finite. A&. A& B&. B& s@ (%Poly%fun%1. f@)) (=> %%location_label%%1 (vstd!set.impl&%0.finite.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s@ f@)))))))) (=> (forall ((s$ Poly) (f$ Poly)) (! (=> (and (has_type s$ (TYPE%vstd!set.Set. A&. A&)) (has_type f$ (TYPE%fun%1. A&. A& B&. B&))) (=> (vstd!set.impl&%0.finite.? A&. A& s$) (vstd!set.impl&%0.finite.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s$ f$)))) :pattern ((vstd!set.impl&%0.finite.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s$ f$))) )) (=> %%location_label%%2 (forall ((s$ Poly) (f$ Poly)) (! (=> (and (has_type s$ (TYPE%vstd!set.Set. A&. A&)) (has_type f$ (TYPE%fun%1. A&. A& B&. B&))) (=> (vstd!set.impl&%0.finite.? A&. A& s$) (vstd!set.impl&%0.finite.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s$ f$)))) :pattern ((vstd!set.impl&%0.finite.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s$ f$))) )))))))
(check-sat)
(exit)
