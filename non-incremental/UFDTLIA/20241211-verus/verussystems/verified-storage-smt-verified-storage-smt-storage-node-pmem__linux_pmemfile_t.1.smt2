...
(declare-const verus_tmp_true_val@ Poly)
...
(assert (not (=> (ens%lib!pmem.traits_t.PmSized.size_of. S&. S& tmp%1) (and (=> %%location_label%%0 (req%lib!pmem.linux_pmemfile_t.impl&%7.get_slice_at_offset. (%Poly%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!) (%I addr!) (uClip 64 (%I tmp%1)))) (=> (ens%lib!pmem.linux_pmemfile_t.impl&%7.get_slice_at_offset. (%Poly%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!) (%I addr!) (uClip 64 (%I tmp%1)) tmp%2) (=> (ens%core!result.impl&%26.branch. (REF $) (SLICE $ (UINT 8)) $ TYPE%lib!pmem.pmemspec_t.PmemError. tmp%2 tmp%%@) (or (and (=> (is-core!ops.control_flow.ControlFlow./Break_ tmp%%@) (=> (= residual@ (%Poly%core!result.Result. (core!ops.control_flow.ControlFlow./Break/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@))))) (=> (ens%core!result.impl&%27.from_residual. $ (TYPE%lib!pmem.pmcopy_t.MaybeCorruptedBytes. S&. S&) $ TYPE%lib!pmem.pmemspec_t.PmemError. $ TYPE%lib!pmem.pmemspec_t.PmemError. residual@ tmp%3) (=> (= %return! (Poly%core!result.Result. tmp%3)) (=> %%location_label%%1 (and (is-core!result.Result./Ok_ (%Poly%core!result.Result. %return!)) (let ((bytes$$0 (core!result.Result./Ok/0 (%Poly%core!result.Result. %return!)))) (let ((true_bytes$$0 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))) addr! (I (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&)))))))) (let ((addrs$$0 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&) (Poly%fun%1. (mk_fun (%%lambda%%2 (%I addr!)))))))) (ite (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))) (= (lib!pmem.pmcopy_t.impl&%2.view.? S&. S& bytes$$0) true_bytes$$0) (lib!pmem.pmemspec_t.maybe_corrupted.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmcopy_t.impl&%2.view.? S&. S& bytes$$0)) (Poly%vstd!seq.Seq<u8.>. true_bytes$$0) (Poly%vstd!seq.Seq<int.>. addrs$$0)))))))))))) (=> (not (is-core!ops.control_flow.ControlFlow./Break_ tmp%%@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= pm_slice@ (let ((val$ (%Poly%slice%<u8.>. (core!ops.control_flow.ControlFlow./Continue/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@)))))) val$)) (=> (= verus_tmp@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&) (Poly%fun%1. (mk_fun (%%lambda%%7 (%I addr!))))))) (=> (= verus_tmp_addrs@ verus_tmp@1) (=> (= addrs@1 verus_tmp_addrs@) (=> (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))) addr! (I (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&))))))) (=> (= verus_tmp_true_bytes@ verus_tmp$1@1) (=> (= true_bytes@1 verus_tmp_true_bytes@) (=> (= verus_tmp$2@1 (lib!pmem.pmcopy_t.PmCopyHelper.spec_from_bytes.? S&. S& (Poly%vstd!seq.Seq<u8.>. true_bytes@1))) (=> (= verus_tmp_true_val@ verus_tmp$2@1) (=> (= true_val@1 verus_tmp_true_val@) (=> (ens%lib!pmem.pmcopy_t.impl&%2.new. S&. S& maybe_corrupted_val@0) (=> (= tmp%4 (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!)))) (and (=> %%location_label%%2 (req%lib!pmem.pmcopy_t.impl&%2.copy_from_slice. S&. S& maybe_corrupted_val@0 pm_slice@ true_val@1 addrs@1 tmp%4)) (=> (has_type maybe_corrupted_val@1 (TYPE%lib!pmem.pmcopy_t.MaybeCorruptedBytes. S&. S&)) (=> (ens%lib!pmem.pmcopy_t.impl&%2.copy_from_slice. S&. S& maybe_corrupted_val@0 maybe_corrupted_val@1 pm_slice@ true_val@1 addrs@1 tmp%4) (=> (= %return! (Poly%core!result.Result. (core!result.Result./Ok maybe_corrupted_val@1))) (=> %%location_label%%3 (and (is-core!result.Result./Ok_ (%Poly%core!result.Result. %return!)) (let ((bytes$$0 (core!result.Result./Ok/0 (%Poly%core!result.Result. %return!)))) (let ((true_bytes$$0 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))) addr! (I (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&)))))))) (let ((addrs$$0 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&) (Poly%fun%1. (mk_fun (%%lambda%%2 (%I addr!)))))))) (ite (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))) (= (lib!pmem.pmcopy_t.impl&%2.view.? S&. S& bytes$$0) true_bytes$$0) (lib!pmem.pmemspec_t.maybe_corrupted.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmcopy_t.impl&%2.view.? S&. S& bytes$$0)) (Poly%vstd!seq.Seq<u8.>. true_bytes$$0) (Poly%vstd!seq.Seq<int.>. addrs$$0))))))))))))))))))))))))))))))))
(check-sat)
(exit)
