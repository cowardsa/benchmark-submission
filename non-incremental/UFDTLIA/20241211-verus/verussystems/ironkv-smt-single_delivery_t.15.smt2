...
(assert (forall ((self! Poly) (src! Poly) (dst! Poly)) (! (= (req%lib!single_delivery_t.impl&%2.un_acked_messages_for_dest. self! src! dst!) (=> %%global_location_label%%10 (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!))) dst!))) :pattern ((req%lib!single_delivery_t.impl&%2.un_acked_messages_for_dest. self! src! dst!)) )))
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::un_acked_messages_for_dest")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:218:5: 218:124 (#0)")
...
(declare-const tmp%3 vstd!set.Set<lib!network_t.Packet.>.)
...
(assert (not (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!))) dst!) (=> (= tmp%2 (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) tmp%2 dst!)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!)) dst!)) (=> (= tmp%4 (I (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.AckState./AckState/un_acked (%Poly%lib!single_delivery_t.AckState. tmp%1))))) (=> %%location_label%%1 (req%lib!single_delivery_t.impl&%2.un_acked_messages_for_dest_up_to. self! src! dst! tmp%4)))))))))
(check-sat)
(exit)
