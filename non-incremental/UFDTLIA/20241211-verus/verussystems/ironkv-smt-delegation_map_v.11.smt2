...
(assert (not (=> (= tmp%2 (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!)))) (=> (ens%alloc!vec.impl&%1.len. K&. K& $ ALLOCATOR_GLOBAL tmp%2 tmp%1) (=> (= len! tmp%1) (=> %%location_label%%0 (= len! (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!))))))))))
(check-sat)
(exit)
