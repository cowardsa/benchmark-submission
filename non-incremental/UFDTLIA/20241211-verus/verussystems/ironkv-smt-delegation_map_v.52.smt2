...
(assert (not (and (=> %%location_label%%0 (req%lib!delegation_map_v.impl&%4.almost_all_keys_agree. K&. K& self! lo! hi! id!)) (=> (ens%lib!delegation_map_v.impl&%4.almost_all_keys_agree. K&. K& self! lo! hi! id!) (=> %%location_label%%1 (lib!delegation_map_v.impl&%4.range_consistent.? K&. K& (Poly%lib!delegation_map_v.DelegationMap. self!) (Poly%lib!keys_t.KeyIterator. (lib!keys_t.impl&%3.new_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. (lib!delegation_map_v.DelegationMap./DelegationMap/lows (%Poly%lib!delegation_map_v.DelegationMap. (Poly%lib!delegation_map_v.DelegationMap. self!)))))))) (I lo!)))) (Poly%lib!keys_t.KeyIterator. (lib!keys_t.impl&%3.new_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. (lib!delegation_map_v.DelegationMap./DelegationMap/lows (%Poly%lib!delegation_map_v.DelegationMap. (Poly%lib!delegation_map_v.DelegationMap. self!)))))))) (I hi!)))) (Poly%lib!io_t.EndPoint. id!)))))))
(check-sat)
(exit)
