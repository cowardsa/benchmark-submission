...
(set-info :comment ";; Function-Specs lib::cmessage_v::CPacket::clone_up_to_view")
(declare-fun ens%lib!cmessage_v.impl&%4.clone_up_to_view. (lib!cmessage_v.CPacket. lib!cmessage_v.CPacket.) Bool)
(assert (forall ((self! lib!cmessage_v.CPacket.) (%return! lib!cmessage_v.CPacket.)) (! (= (ens%lib!cmessage_v.impl&%4.clone_up_to_view. self! %return!) (has_type (Poly%lib!cmessage_v.CPacket. %return!) TYPE%lib!cmessage_v.CPacket.)) :pattern ((ens%lib!cmessage_v.impl&%4.clone_up_to_view. self! %return!)) )))
(set-info :comment ";; Function-Def lib::cmessage_v::CPacket::clone_up_to_view")
(set-info :comment ";; ironsht/src/cmessage_v.rs:327:5: 327:43 (#0)")
(declare-const %return! lib!cmessage_v.CPacket.)
(declare-const self! lib!cmessage_v.CPacket.)
(declare-const tmp%1 lib!io_t.EndPoint.)
(declare-const tmp%2 lib!io_t.EndPoint.)
(declare-const tmp%3 lib!io_t.EndPoint.)
(declare-const tmp%4 lib!io_t.EndPoint.)
(declare-const tmp%5 lib!cmessage_v.CSingleMessage.)
(declare-const tmp%6 lib!cmessage_v.CSingleMessage.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!cmessage_v.CPacket. self!) TYPE%lib!cmessage_v.CPacket.))
(assert (not true))
(check-sat)
(exit)
