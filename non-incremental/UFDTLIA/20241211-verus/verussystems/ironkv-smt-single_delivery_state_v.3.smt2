...
(declare-const e! lib!single_delivery_state_v.CAckState.)
...
(assert (not (=> (ens%alloc!vec.impl&%0.new. $ TYPE%lib!cmessage_v.CSingleMessage. tmp%1) (=> (= e! (lib!single_delivery_state_v.CAckState./CAckState (%I (I 0)) (%Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. tmp%1))) (and (=> %%location_label%%0 (= (lib!single_delivery_state_v.CAckState./CAckState/num_packets_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. e!))) 0)) (and (=> %%location_label%%1 (= (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. e!))))) 0)) (=> %%location_label%%2 (ext_eq false (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%lib!single_delivery_t.AckState. (lib!single_delivery_state_v.impl&%0.view.? (Poly%lib!single_delivery_state_v.CAckState. e!))) (Poly%lib!single_delivery_t.AckState. (lib!single_delivery_t.impl&%0.new.? (I 0)))))))))))
(check-sat)
(exit)
