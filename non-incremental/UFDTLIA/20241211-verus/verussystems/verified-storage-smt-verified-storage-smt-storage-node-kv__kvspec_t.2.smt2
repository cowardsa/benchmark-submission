...
(set-info :comment ";; Function-Specs lib::kv::kvspec_t::TrustedKvPermission::new_one_possibility")
(declare-fun ens%lib!kv.kvspec_t.impl&%1.new_one_possibility. (Dcr Type Dcr Type Dcr Type Dcr Type Dcr Type Dcr Type Int lib!kv.kvspec_t.AbstractKvStoreState. lib!kv.kvspec_t.TrustedKvPermission.) Bool)
(assert (forall ((PM&. Dcr) (PM& Type) (K&. Dcr) (K& Type) (I&. Dcr) (I& Type) (L&. Dcr) (L& Type) (D&. Dcr) (D& Type) (E&. Dcr) (E& Type) (kv_id! Int) (state! lib!kv.kvspec_t.AbstractKvStoreState.) (perm! lib!kv.kvspec_t.TrustedKvPermission.)) (! (= (ens%lib!kv.kvspec_t.impl&%1.new_one_possibility. PM&. PM& K&. K& I&. I& L&. L& D&. D& E&. E& kv_id! state! perm!) (and (has_type (Poly%lib!kv.kvspec_t.TrustedKvPermission. perm!) (TYPE%lib!kv.kvspec_t.TrustedKvPermission. PM&. PM& K&. K& I&. I& L&. L& D&. D& E&. E&)) (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (= (%B (lib!pmem.wrpm_t.CheckPermission.check_permission.? $ (TYPE%lib!kv.kvspec_t.TrustedKvPermission. PM&. PM& K&. K& I&. I& L&. L& D&. D& E&. E&) $ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%lib!kv.kvspec_t.TrustedKvPermission. perm!) s$)) (= (%Poly%core!option.Option. (lib!kv.durable.durableimpl_v.DurableKvStore.recover_to_kv_state.? D&. D& PM&. PM& K&. K& I&. I& L&. L& E&. E& s$ (I kv_id!))) (core!option.Option./Some (Poly%lib!kv.kvspec_t.AbstractKvStoreState. state!))))) :pattern ((lib!pmem.wrpm_t.CheckPermission.check_permission.? $ (TYPE%lib!kv.kvspec_t.TrustedKvPermission. PM&. PM& K&. K& I&. I& L&. L& D&. D& E&. E&) $ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%lib!kv.kvspec_t.TrustedKvPermission. perm!) s$)) )))) :pattern ((ens%lib!kv.kvspec_t.impl&%1.new_one_possibility. PM&. PM& K&. K& I&. I& L&. L& D&. D& E&. E& kv_id! state! perm!)) )))
(set-info :comment ";; Function-Def lib::kv::kvspec_t::TrustedKvPermission::new_one_possibility")
(set-info :comment ";; src/kv/kvspec_t.rs:71:9: 71:118 (#0)")
...
(assert (has_type (Poly%lib!kv.kvspec_t.AbstractKvStoreState. state!) (TYPE%lib!kv.kvspec_t.AbstractKvStoreState. K&. K& I&. I& L&. L& E&. E&)))
