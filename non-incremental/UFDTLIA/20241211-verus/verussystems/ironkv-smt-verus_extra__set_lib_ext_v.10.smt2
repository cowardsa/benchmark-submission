...
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!)) (or (and (=> (= (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!) 0) %%switch_label%%0) (=> (not (= (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!) 0)) (=> (= tmp%1 (vstd!seq_lib.impl&%0.drop_last.? $ (TYPE%vstd!set.Set. A&. A&) sets!)) (and (=> %%location_label%%0 (check_decrease_int (let ((sets!$0 tmp%1)) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!$0)) decrease%init0 false)) (=> (ens%lib!verus_extra.set_lib_ext_v.lemma_flatten_set_seq_spec. A&. A& tmp%1) (and (=> (has_type x@ A&) (=> (vstd!set.impl&%0.contains.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& sets!) x@) (or (and (=> (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.last.? $ (TYPE%vstd!set.Set. A&. A&) sets!) x@) %%switch_label%%2) (=> (not (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.last.? $ (TYPE%vstd!set.Set. A&. A&) sets!) x@)) (=> (= tmp%2 (vstd!set.impl&%0.contains.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? $ (TYPE%vstd!set.Set. A&. A&) sets!)) x@)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%2))))) (and (not %%switch_label%%2) (=> %%location_label%%2 (exists ((i$ Poly)) (! (and (has_type i$ INT) (and (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!))) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x@))) :pattern ((vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x@)) ))))))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ A&) (=> (vstd!set.impl&%0.contains.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& sets!) x$) (exists ((i$ Poly)) (! (and (has_type i$ INT) (and (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!))) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x$))) :pattern ((vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x$)) )))) :pattern ((vstd!set.impl&%0.contains.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& sets!) x$)) )) (and (=> (has_type x$1@ A&) (=> (has_type i@ INT) (=> (and (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!))) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i@) x$1@)) (or (and (=> (= (%I i@) (Sub (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!) 1)) (=> (= tmp%3 (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.last.? $ (TYPE%vstd!set.Set. A&. A&) sets!) x$1@)) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> (= tmp%4 (ext_eq false (TYPE%vstd!set.Set. A&. A&) (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& sets!) (vstd!set.impl&%0.union.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? $ (TYPE%vstd!set.Set. A&. A&) sets!)) (vstd!seq.Seq.last.? $ (TYPE%vstd!set.Set. A&. A&) sets!)))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 %%switch_label%%1))))))) (=> (not (= (%I i@) (Sub (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!) 1))) (=> (= tmp%5 (and (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) (vstd!seq_lib.impl&%0.drop_last.? $ (TYPE%vstd!set.Set. A&. A&) sets!)))) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) (vstd!seq_lib.impl&%0.drop_last.? $ (TYPE%vstd!set.Set. A&. A&) sets!) i@) x$1@))) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 %%switch_label%%1))))) (and (not %%switch_label%%1) (=> %%location_label%%6 (vstd!set.impl&%0.contains.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& sets!) x$1@))))))) (=> (forall ((x$ Poly) (i$ Poly)) (! (=> (and (has_type x$ A&) (has_type i$ INT)) (=> (and (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!))) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x$)) (vstd!set.impl&%0.contains.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& sets!) x$))) :pattern ((vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x$)) )) %%switch_label%%0))))))))) (and (not %%switch_label%%0) (and (=> %%location_label%%7 (forall ((x$ Poly)) (! (=> (has_type x$ A&) (=> (vstd!set.impl&%0.contains.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& sets!) x$) (exists ((i$ Poly)) (! (and (has_type i$ INT) (and (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!))) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x$))) :pattern ((vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x$)) )))) :pattern ((vstd!set.impl&%0.contains.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& sets!) x$)) ))) (=> %%location_label%%8 (forall ((x$ Poly) (i$ Poly)) (! (=> (and (has_type x$ A&) (has_type i$ INT)) (=> (and (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!))) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x$)) (vstd!set.impl&%0.contains.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_set_seq.? A&. A& sets!) x$))) :pattern ((vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) x$)) )))))))))
(check-sat)
(exit)
