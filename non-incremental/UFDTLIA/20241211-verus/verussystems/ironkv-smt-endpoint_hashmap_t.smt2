...
(set-info :comment ";; MODULE 'module endpoint_hashmap_t'")
...
(set-info :comment ";; Function-Def lib::endpoint_hashmap_t::HashMap::put")
(set-info :comment ";; ironsht/src/endpoint_hashmap_t.rs:86:5: 86:52 (#0)")
(declare-const V&. Dcr)
