...
(set-info :comment ";; MODULE 'module pmemspec_t'")
...
(set-info :comment ";; Function-Recommends main::pmemspec_t::update_contents_to_reflect_write")
(set-info :comment ";; src/pmemspec_t.rs:174:5: 175:96 (#0)")
...
(set-info :comment ";; Function-Def main::pmemspec_t::crc_size")
(set-info :comment ";; src/pmemspec_t.rs:34:5: 34:33 (#0)")
...
(assert (forall ((x_c! vstd!seq.Seq<u8.>.) (x! vstd!seq.Seq<u8.>.) (x_addrs! vstd!seq.Seq<int.>.) (y_c! vstd!seq.Seq<u8.>.) (y! vstd!seq.Seq<u8.>.) (y_addrs! vstd!seq.Seq<int.>.)) (! (= (req%main!pmemspec_t.axiom_bytes_uncorrupted. x_c! x! x_addrs! y_c! y! y_addrs!) (and (=> %%global_location_label%%10 (main!pmemspec_t.maybe_corrupted.? (Poly%vstd!seq.Seq<u8.>. x_c!) (Poly%vstd!seq.Seq<u8.>. x!) (Poly%vstd!seq.Seq<int.>. x_addrs!))) (=> %%global_location_label%%11 (main!pmemspec_t.maybe_corrupted.? (Poly%vstd!seq.Seq<u8.>. y_c!) (Poly%vstd!seq.Seq<u8.>. y!) (Poly%vstd!seq.Seq<int.>. y_addrs!))) (=> %%global_location_label%%12 (= y! (main!pmemspec_t.spec_crc_bytes.? (Poly%vstd!seq.Seq<u8.>. x!)))) (=> %%global_location_label%%13 (= y_c! (main!pmemspec_t.spec_crc_bytes.? (Poly%vstd!seq.Seq<u8.>. x_c!)))) (=> %%global_location_label%%14 (main!pmemspec_t.all_elements_unique.? (Poly%vstd!seq.Seq<int.>. x_addrs!))) (=> %%global_location_label%%15 (main!pmemspec_t.all_elements_unique.? (Poly%vstd!seq.Seq<int.>. y_addrs!))))) :pattern ((req%main!pmemspec_t.axiom_bytes_uncorrupted. x_c! x! x_addrs! y_c! y! y_addrs!)) )))
...
(set-info :comment ";; Function-Def main::pmemspec_t::cdb0_val")
(set-info :comment ";; src/pmemspec_t.rs:91:5: 91:50 (#0)")
...
(set-info :comment ";; Function-Def main::pmemspec_t::cdb1_val")
(set-info :comment ";; src/pmemspec_t.rs:92:5: 92:50 (#0)")
...
(assert (forall ((cdb_c! Int) (cdb! Int) (addrs! vstd!seq.Seq<int.>.)) (! (= (req%main!pmemspec_t.axiom_corruption_detecting_boolean. cdb_c! cdb! addrs!) (and (=> %%global_location_label%%16 (main!pmemspec_t.maybe_corrupted.? (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I cdb_c!))) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I cdb!))) (Poly%vstd!seq.Seq<int.>. addrs!))) (=> %%global_location_label%%17 (main!pmemspec_t.all_elements_unique.? (Poly%vstd!seq.Seq<int.>. addrs!))) (=> %%global_location_label%%18 (or (= cdb! main!pmemspec_t.cdb0_val.?) (= cdb! main!pmemspec_t.cdb1_val.?))) (=> %%global_location_label%%19 (or (= cdb_c! main!pmemspec_t.cdb0_val.?) (= cdb_c! main!pmemspec_t.cdb1_val.?))))) :pattern ((req%main!pmemspec_t.axiom_corruption_detecting_boolean. cdb_c! cdb! addrs!)) )))
...
(set-info :comment ";; Function-Axioms main::pmemspec_t::WriteRestrictedPersistentMemory::inv")
(assert (fuel_bool_default fuel%main!pmemspec_t.impl&%0.inv.))
(assert (=> (fuel_bool fuel%main!pmemspec_t.impl&%0.inv.) (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly)) (! (= (main!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& self!) (%B (main!pmemspec_t.PersistentMemory.inv.? PM&. PM& (main!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm (%Poly%main!pmemspec_t.WriteRestrictedPersistentMemory. self!))))) :pattern ((main!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& self!)) ))))
(set-info :comment ";; Function-Axioms main::pmemspec_t::WriteRestrictedPersistentMemory::view")
(assert (fuel_bool_default fuel%main!pmemspec_t.impl&%0.view.))
(assert (=> (fuel_bool fuel%main!pmemspec_t.impl&%0.view.) (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly)) (! (= (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& self!) (%Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.PersistentMemory.view.? PM&. PM& (main!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm (%Poly%main!pmemspec_t.WriteRestrictedPersistentMemory. self!))))) :pattern ((main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& self!)) ))))
(set-info :comment ";; Function-Axioms main::pmemspec_t::WriteRestrictedPersistentMemory::constants")
(assert (fuel_bool_default fuel%main!pmemspec_t.impl&%0.constants.))
(assert (=> (fuel_bool fuel%main!pmemspec_t.impl&%0.constants.) (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly)) (! (= (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& self!) (%Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& (main!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm (%Poly%main!pmemspec_t.WriteRestrictedPersistentMemory. self!))))) :pattern ((main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& self!)) ))))
(set-info :comment ";; Function-Def main::pmemspec_t::persistence_chunk_size")
(set-info :comment ";; src/pmemspec_t.rs:155:5: 155:52 (#0)")
