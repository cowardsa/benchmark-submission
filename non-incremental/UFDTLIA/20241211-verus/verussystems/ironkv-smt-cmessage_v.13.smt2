...
(declare-const vec@ alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const tmp%2 core!option.Option.)
(assert fuel_defaults)
(assert (has_type (Poly%core!option.Option. value!) (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL))))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (or (and (=> (is-core!option.Option./Some_ value!) (=> (= vec@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. value!))))) (=> (ens%lib!args_t.clone_vec_u8. vec@ tmp%1) (=> (= tmp%2 (core!option.Option./Some (Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%1))) %%switch_label%%0)))) (=> (not (is-core!option.Option./Some_ value!)) (=> (= tmp%2 core!option.Option./None) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= out! tmp%2) (=> %%location_label%%0 (ite (is-core!option.Option./Some_ value!) (let ((vec$ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. value!)))))) (and (is-core!option.Option./Some_ out!) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. out!)))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. vec$))))) (is-core!option.Option./None_ out!))))))))
(check-sat)
(exit)
