...
(assert (not (or (and (=> (is-lib!cmessage_v.CMessage./GetRequest_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= k@ (lib!cmessage_v.CMessage./GetRequest/k (%Poly%lib!cmessage_v.CMessage. self!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k@) tmp%1) (and (=> %%location_label%%1 (uInv SZ (Add 1 (%I tmp%1)))) (=> (= tmp%16 (uClip SZ (Add 1 (%I tmp%1)))) %%switch_label%%0)))))) (=> (not (is-lib!cmessage_v.CMessage./GetRequest_ (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (is-lib!cmessage_v.CMessage./SetRequest_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= k$1@ (lib!cmessage_v.CMessage./SetRequest/k (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= v@ (lib!cmessage_v.CMessage./SetRequest/v (%Poly%lib!cmessage_v.CMessage. self!))) (and (=> %%location_label%%2 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$1@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$1@) tmp%2) (and (=> %%location_label%%3 (uInv SZ (Add 1 (%I tmp%2)))) (and (=> %%location_label%%4 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v@) tmp%3) (and (=> %%location_label%%5 (uInv SZ (Add (uClip SZ (Add 1 (%I tmp%2))) (%I tmp%3)))) (=> (= tmp%15 (uClip SZ (Add (uClip SZ (Add 1 (%I tmp%2))) (%I tmp%3)))) %%switch_label%%1)))))))))) (=> (not (is-lib!cmessage_v.CMessage./SetRequest_ (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (is-lib!cmessage_v.CMessage./Reply_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= k$2@ (lib!cmessage_v.CMessage./Reply/k (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= v$1@ (lib!cmessage_v.CMessage./Reply/v (%Poly%lib!cmessage_v.CMessage. self!))) (and (=> %%location_label%%6 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$2@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$2@) tmp%4) (and (=> %%location_label%%7 (uInv SZ (Add 1 (%I tmp%4)))) (and (=> %%location_label%%8 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v$1@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v$1@) tmp%5) (and (=> %%location_label%%9 (uInv SZ (Add (uClip SZ (Add 1 (%I tmp%4))) (%I tmp%5)))) (=> (= tmp%14 (uClip SZ (Add (uClip SZ (Add 1 (%I tmp%4))) (%I tmp%5)))) %%switch_label%%2)))))))))) (=> (not (is-lib!cmessage_v.CMessage./Reply_ (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (is-lib!cmessage_v.CMessage./Redirect_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= k$3@ (lib!cmessage_v.CMessage./Redirect/k (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= id@ (lib!cmessage_v.CMessage./Redirect/id (%Poly%lib!cmessage_v.CMessage. self!))) (and (=> %%location_label%%10 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$3@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$3@) tmp%6) (and (=> %%location_label%%11 (uInv SZ (Add 1 (%I tmp%6)))) (and (=> %%location_label%%12 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. id@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. id@) tmp%7) (and (=> %%location_label%%13 (uInv SZ (Add (uClip SZ (Add 1 (%I tmp%6))) (%I tmp%7)))) (=> (= tmp%13 (uClip SZ (Add (uClip SZ (Add 1 (%I tmp%6))) (%I tmp%7)))) %%switch_label%%3)))))))))) (=> (not (is-lib!cmessage_v.CMessage./Redirect_ (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (is-lib!cmessage_v.CMessage./Shard_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= kr@ (lib!cmessage_v.CMessage./Shard/kr (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= recipient@ (lib!cmessage_v.CMessage./Shard/recipient (%Poly%lib!cmessage_v.CMessage. self!))) (and (=> %%location_label%%14 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. kr@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. kr@) tmp%8) (and (=> %%location_label%%15 (uInv SZ (Add 1 (%I tmp%8)))) (and (=> %%location_label%%16 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. recipient@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. recipient@) tmp%9) (and (=> %%location_label%%17 (uInv SZ (Add (uClip SZ (Add 1 (%I tmp%8))) (%I tmp%9)))) (=> (= tmp%12 (uClip SZ (Add (uClip SZ (Add 1 (%I tmp%8))) (%I tmp%9)))) %%switch_label%%4)))))))))) (=> (not (is-lib!cmessage_v.CMessage./Shard_ (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= range@ (lib!cmessage_v.CMessage./Delegate/range (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= h@ (lib!cmessage_v.CMessage./Delegate/h (%Poly%lib!cmessage_v.CMessage. self!))) (and (=> %%location_label%%18 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. range@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. range@) tmp%10) (and (=> %%location_label%%19 (uInv SZ (Add 1 (%I tmp%10)))) (and (=> %%location_label%%20 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!hashmap_t.CKeyHashMap. (Poly%lib!hashmap_t.CKeyHashMap. h@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!hashmap_t.CKeyHashMap. (Poly%lib!hashmap_t.CKeyHashMap. h@) tmp%11) (and (=> %%location_label%%21 (uInv SZ (Add (uClip SZ (Add 1 (%I tmp%10))) (%I tmp%11)))) (=> (= tmp%12 (uClip SZ (Add (uClip SZ (Add 1 (%I tmp%10))) (%I tmp%11)))) %%switch_label%%4))))))))))) (and (not %%switch_label%%4) (=> (= tmp%13 tmp%12) %%switch_label%%3))))) (and (not %%switch_label%%3) (=> (= tmp%14 tmp%13) %%switch_label%%2))))) (and (not %%switch_label%%2) (=> (= tmp%15 tmp%14) %%switch_label%%1))))) (and (not %%switch_label%%1) (=> (= tmp%16 tmp%15) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= %return! (I tmp%16)) (=> %%location_label%%22 (= (%I %return!) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CMessage. self!)))))))))
(check-sat)
(exit)
