...
(set-info :comment ";; MODULE 'module exec::rwlock, function lib::exec::rwlock::RwLock::new'")
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.impl&%0.is_None. fuel%vstd!atomic_ghost.impl&%1.well_formed. fuel%vstd!atomic_ghost.impl&%1.constant. fuel%vstd!atomic_ghost.impl&%21.well_formed. fuel%vstd!atomic_ghost.impl&%21.constant. fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!multiset.impl&%0.subset_of. fuel%vstd!multiset.impl&%0.choose. fuel%vstd!multiset.impl&%0.dom. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!set.impl&%0.choose. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view. fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%8.view. fuel%vstd!view.impl&%10.view. fuel%vstd!view.impl&%18.view. fuel%vstd!view.impl&%22.view. fuel%vstd!view.impl&%38.view. fuel%lib!spec.rwlock.RwLockSpec.impl&%5.map_agree. fuel%lib!spec.rwlock.RwLockSpec.impl&%5.map_agree_strict. fuel%lib!spec.rwlock.RwLockSpec.impl&%6.option_agree_strict. fuel%lib!spec.rwlock.RwLockSpec.impl&%6.option_agree. fuel%lib!spec.rwlock.RwLockSpec.impl&%7.option_agree_strict. fuel%lib!spec.rwlock.RwLockSpec.impl&%7.option_agree. fuel%lib!spec.rwlock.RwLockSpec.impl&%8.multiset_agree_strict. fuel%lib!spec.rwlock.RwLockSpec.impl&%9.multiset_agree_strict. fuel%lib!exec.rwlock.MAX_RC. fuel%lib!exec.rwlock.impl&%1.atomic_inv. fuel%lib!exec.rwlock.impl&%2.atomic_inv. fuel%lib!exec.rwlock.impl&%3.wf. fuel%lib!exec.rwlock.impl&%4.inv. fuel%lib!exec.rwlock.impl&%4.max_threads.))
...
(assert (forall ((V&. Dcr) (V& Type) (m! Poly) (v! Poly)) (! (= (req%vstd!multiset.axiom_multiset_contained. V&. V& m! v!) (and (=> %%global_location_label%%14 (vstd!set.impl&%0.finite.? V&. V& (vstd!map.impl&%0.dom.? V&. V& $ NAT m!))) (=> %%global_location_label%%15 (vstd!set.impl&%0.contains.? V&. V& (vstd!map.impl&%0.dom.? V&. V& $ NAT m!) v!)))) :pattern ((req%vstd!multiset.axiom_multiset_contained. V&. V& m! v!)) )))
...
(assert (forall ((V&. Dcr) (V& Type) (m! Poly) (v! Poly)) (! (= (req%vstd!multiset.axiom_multiset_new_not_contained. V&. V& m! v!) (and (=> %%global_location_label%%16 (vstd!set.impl&%0.finite.? V&. V& (vstd!map.impl&%0.dom.? V&. V& $ NAT m!))) (=> %%global_location_label%%17 (not (vstd!set.impl&%0.contains.? V&. V& (vstd!map.impl&%0.dom.? V&. V& $ NAT m!) v!))))) :pattern ((req%vstd!multiset.axiom_multiset_new_not_contained. V&. V& m! v!)) )))
...
(assert (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (! (= (req%vstd!multiset.axiom_len_sub. V&. V& m1! m2!) (=> %%global_location_label%%18 (vstd!multiset.impl&%0.subset_of.? V&. V& m2! m1!))) :pattern ((req%vstd!multiset.axiom_len_sub. V&. V& m1! m2!)) )))
...
(assert (forall ((V&. Dcr) (V& Type) (m! Poly)) (! (= (req%vstd!multiset.axiom_choose_count. V&. V& m!) (=> %%global_location_label%%19 (not (= (vstd!multiset.impl&%0.len.? V&. V& m!) 0)))) :pattern ((req%vstd!multiset.axiom_choose_count. V&. V& m!)) )))
...
(assert (forall ((T&. Dcr) (T& Type) (rc_width! Int) (init_t! Poly) (user_inv! Poly) (param_token_storage! core!option.Option.)) (! (= (req%lib!spec.rwlock.RwLockSpec.impl&%10.initialize. T&. T& rc_width! init_t! user_inv! param_token_storage!) (and (=> %%global_location_label%%53 (< 0 rc_width!)) (=> %%global_location_label%%54 (vstd!set.impl&%0.contains.? T&. T& user_inv! init_t!)) (=> %%global_location_label%%55 (= param_token_storage! (core!option.Option./Some init_t!))))) :pattern ((req%lib!spec.rwlock.RwLockSpec.impl&%10.initialize. T&. T& rc_width! init_t! user_inv! param_token_storage!)) )))
...
(assert (forall ((T&. Dcr) (T& Type) (rc_width! Int) (t! Poly) (inv! %%Function%%)) (! (= (req%lib!exec.rwlock.impl&%4.new. T&. T& rc_width! t! inv!) (=> %%global_location_label%%56 (and (< 0 rc_width!) (%B (%%apply%%0 inv! t!))))) :pattern ((req%lib!exec.rwlock.impl&%4.new. T&. T& rc_width! t! inv!)) )))
...
(set-info :comment ";; Function-Def lib::exec::rwlock::RwLock::new")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/exec/rwlock.rs:222:9: 264:10 (#0)")
(set-info :comment ";; Function-Def lib::exec::rwlock::RwLock::new")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/exec/rwlock.rs:138:5: 138:82 (#0)")
(declare-const T&. Dcr)
(declare-const T& Type)
(declare-const s! lib!exec.rwlock.RwLock.)
(declare-const rc_width! Int)
(declare-const t! Poly)
(declare-const inv! %%Function%%)
(declare-const verus_tmp_set_inv@ Poly)
(declare-const verus_tmp_user_inv@ Poly)
(declare-const tmp%1 core!option.Option.)
(declare-const tmp%%$1@ tuple%7.)
(declare-const verus_tmp_inst0@ Poly)
(declare-const verus_tmp_exc_locked_token0@ Poly)
(declare-const verus_tmp_ref_counts_tokens0@ Poly)
(declare-const inst0@ Poly)
(declare-const exc_locked_token0@ Poly)
(declare-const ref_counts_tokens0@ Poly)
...
(declare-const verus_tmp_ref_count_token@ Poly)
...
(declare-const verus_tmp$2@ Poly)
(declare-const ref_count_token@0 Poly)
(declare-const rc_atomic@ vstd!atomic_ghost.AtomicU64.)
(declare-const tmp%14 Bool)
(declare-const inst@ Poly)
(declare-const exc_locked_token@ Poly)
(declare-const ref_counts_tokens@0 Poly)
(declare-const tmp%%@ tuple%2.)
(declare-const pcell_data@ Poly)
(declare-const verus_tmp_pcell_token@ Poly)
(declare-const pcell_token@0 Poly)
(declare-const verus_tmp@0 Poly)
(declare-const set_inv@0 Poly)
(declare-const verus_tmp$1@0 Poly)
(declare-const user_inv@0 Poly)
(declare-const tracked_inst@ Poly)
(declare-const exc_locked_atomic@ vstd!atomic_ghost.AtomicBool.)
(declare-const v@0 Poly)
(declare-const i@0 Int)
(declare-const s@ lib!exec.rwlock.RwLock.)
(assert fuel_defaults)
(assert (uInv SZ rc_width!))
(assert (has_type t! T&))
(assert (has_type (Poly%fun%1. inv!) (TYPE%fun%1. T&. T& $ BOOL)))
(assert (and (< 0 rc_width!) (%B (%%apply%%0 inv! t!))))
(declare-fun %%lambda%%3 (Dcr Type vstd!cell.CellId. Dcr Type Dcr Type Dcr Type Poly) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 vstd!cell.CellId.) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly) (s$ Poly)) (! (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) s$) (B (and (and (= (vstd!cell.PointsToData./PointsToData/pcell (%Poly%vstd!cell.PointsToData. (Poly%vstd!cell.PointsToData. (vstd!cell.impl&%2.view.? %%hole%%0 %%hole%%1 s$)))) %%hole%%2) (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (vstd!cell.PointsToData./PointsToData/value (%Poly%vstd!cell.PointsToData. (Poly%vstd!cell.PointsToData. (vstd!cell.impl&%2.view.? %%hole%%3 %%hole%%4 s$)))))))))) (vstd!set.impl&%0.contains.? %%hole%%7 %%hole%%8 %%hole%%9 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (vstd!cell.PointsToData./PointsToData/value (%Poly%vstd!cell.PointsToData. (Poly%vstd!cell.PointsToData. (vstd!cell.impl&%2.view.? %%hole%%5 %%hole%%6 s$))))))))))) :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) s$)))))
(declare-const pcell_token@1 Poly)
(declare-const verus_tmp@1 Poly)
(declare-const set_inv@1 Poly)
(declare-const verus_tmp$1@1 Poly)
(declare-const user_inv@1 Poly)
(declare-const ref_counts_tokens@1 Poly)
(declare-const ref_counts_tokens@2 Poly)
(declare-const ref_count_token@1 Poly)
...
(assert (not (=> (ens%vstd!cell.impl&%3.new. T&. T& t! tmp%%@) (=> (= pcell_data@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= verus_tmp_pcell_token@ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= pcell_token@1 verus_tmp_pcell_token@) (=> (= verus_tmp@1 (vstd!set.impl&%0.new.? T&. T& $ (TYPE%fun%1. T&. T& $ BOOL) (Poly%fun%1. inv!))) (=> (= verus_tmp_set_inv@ verus_tmp@1) (=> (= set_inv@1 verus_tmp_set_inv@) (=> (= verus_tmp$1@1 (vstd!set.impl&%0.new.? $ (TYPE%vstd!cell.PointsTo. T&. T&) $ (TYPE%fun%1. $ (TYPE%vstd!cell.PointsTo. T&. T&) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T&. T& (vstd!cell.impl&%3.id.? T&. T& pcell_data@) T&. T& T&. T& T&. T& set_inv@1))))) (=> (= verus_tmp_user_inv@ verus_tmp$1@1) (=> (= user_inv@1 verus_tmp_user_inv@) (=> (= tmp%1 (core!option.Option./Some pcell_token@1)) (and (=> %%location_label%%0 (req%lib!spec.rwlock.RwLockSpec.impl&%10.initialize. $ (TYPE%vstd!cell.PointsTo. T&. T&) rc_width! pcell_token@1 user_inv@1 tmp%1)) (=> (ens%lib!spec.rwlock.RwLockSpec.impl&%10.initialize. $ (TYPE%vstd!cell.PointsTo. T&. T&) rc_width! pcell_token@1 user_inv@1 tmp%1 tmp%%$1@) (=> (= verus_tmp_inst0@ (tuple%7./tuple%7/0 (%Poly%tuple%7. (Poly%tuple%7. tmp%%$1@)))) (=> (= verus_tmp_exc_locked_token0@ (tuple%7./tuple%7/1 (%Poly%tuple%7. (Poly%tuple%7. tmp%%$1@)))) (=> (= verus_tmp_ref_counts_tokens0@ (tuple%7./tuple%7/2 (%Poly%tuple%7. (Poly%tuple%7. tmp%%$1@)))) (=> (= inst0@ verus_tmp_inst0@) (=> (= exc_locked_token0@ verus_tmp_exc_locked_token0@) (=> (= ref_counts_tokens0@ verus_tmp_ref_counts_tokens0@) (=> (= inst@ inst0@) (=> (= exc_locked_token@ exc_locked_token0@) (=> (= ref_counts_tokens@1 ref_counts_tokens0@) (=> (ens%lib!spec.rwlock.RwLockSpec.impl&%10.clone. $ (TYPE%vstd!cell.PointsTo. T&. T&) inst@ tracked_inst@) (and (=> %%location_label%%1 (req%vstd!atomic_ghost.impl&%21.new. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_exc_locked. tracked_inst@ false exc_locked_token@)) (=> (ens%vstd!atomic_ghost.impl&%21.new. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_exc_locked. tracked_inst@ false exc_locked_token@ exc_locked_atomic@) (=> (ens%alloc!vec.impl&%0.new. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) v@0) (=> (= i@0 0) (and (=> (has_type j@ INT) (=> (and (<= i@0 (%I j@)) (< (%I j@) rc_width!)) (=> (= tmp%2 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1) j@)) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (= tmp%3 (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j@))))) inst@)) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> (= tmp%4 (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j@))))) (%I j@))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (=> (= tmp%5 (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j@))))) 0)) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 (=> %%location_label%%6 (and (and (and (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1) j@) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j@))))) inst@)) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j@))))) (%I j@))) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j@))))) 0))))))))))))))))) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= i@0 (%I j$)) (< (%I j$) rc_width!)) (and (and (and (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1) j$) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$))))) inst@)) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$))))) (%I j$))) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$))))) 0)))) :pattern ((vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1) j$)) )) (=> (= tmp%6 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= i@0 (%I j$)) (< (%I j$) rc_width!)) (and (and (and (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1) j$) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$))))) inst@)) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$))))) (%I j$))) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$))))) 0)))) :pattern ((vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1) j$)) :pattern ((vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$)) ))) (and (=> %%location_label%%7 tmp%6) (=> tmp%6 (and (=> %%location_label%%8 (<= i@0 rc_width!)) (and (=> %%location_label%%9 (= (vstd!seq.Seq.len.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.) v@0)) i@0)) (and (=> %%location_label%%10 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (and (vstd!atomic_ghost.impl&%1.well_formed.? $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts. (lib!exec.CachePadded./CachePadded/0 (%Poly%lib!exec.CachePadded. (vstd!seq.Seq.index.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.) v@0) j$)))) (= (%Poly%tuple%2. (vstd!atomic_ghost.impl&%1.constant.? $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts. (lib!exec.CachePadded./CachePadded/0 (%Poly%lib!exec.CachePadded. (vstd!seq.Seq.index.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.) v@0) j$))))) (tuple%2./tuple%2 tracked_inst@ j$))))) :pattern ((vstd!seq.Seq.index.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.) v@0) j$)) ))) (and (=> %%location_label%%11 (= tracked_inst@ inst@)) (and (=> %%location_label%%12 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= i@0 (%I j$)) (< (%I j$) rc_width!)) (and (and (and (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1) j$) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$))))) inst@)) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$))))) (%I j$))) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$))))) 0)))) :pattern ((vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1) j$)) :pattern ((vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@1 j$)) ))) (=> (has_type ref_counts_tokens@2 (TYPE%vstd!map.Map. $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)))) (=> (has_type v@1 (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.)) (=> (uInv SZ i@1) (=> (<= i@1 rc_width!) (=> (= (vstd!seq.Seq.len.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.) v@1)) i@1) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (and (vstd!atomic_ghost.impl&%1.well_formed.? $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts. (lib!exec.CachePadded./CachePadded/0 (%Poly%lib!exec.CachePadded. (vstd!seq.Seq.index.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.) v@1) j$)))) (= (%Poly%tuple%2. (vstd!atomic_ghost.impl&%1.constant.? $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts. (lib!exec.CachePadded./CachePadded/0 (%Poly%lib!exec.CachePadded. (vstd!seq.Seq.index.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.) v@1) j$))))) (tuple%2./tuple%2 tracked_inst@ j$))))) :pattern ((vstd!seq.Seq.index.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.) v@1) j$)) )) (=> (= tracked_inst@ inst@) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= i@1 (%I j$)) (< (%I j$) rc_width!)) (and (and (and (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@2) j$) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@2 j$))))) inst@)) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@2 j$))))) (%I j$))) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@2 j$))))) 0)))) :pattern ((vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@2) j$)) :pattern ((vstd!map.impl&%0.index.? $ INT $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) ref_counts_tokens@2 j$)) )) (=> (not (< i@1 rc_width!)) (=> (= s@ (lib!exec.rwlock.RwLock./RwLock pcell_data@ (%Poly%lib!exec.CachePadded. (Poly%lib!exec.CachePadded. (lib!exec.CachePadded./CachePadded (Poly%vstd!atomic_ghost.AtomicBool. exc_locked_atomic@)))) v@1 inst@ set_inv@1)) (=> (= tmp%14 (= (lib!spec.rwlock.RwLockSpec.impl&%10.rc_width.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (lib!exec.rwlock.RwLock./RwLock/inst (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. s@)))) (vstd!seq.Seq.len.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.) (lib!exec.rwlock.RwLock./RwLock/ref_counts (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. s@))))))) (and (=> %%location_label%%13 tmp%14) (=> tmp%14 (=> (= s! s@) (and (=> %%location_label%%14 (and (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. s!)) (= (lib!exec.rwlock.impl&%4.max_threads.? T&. T& (Poly%lib!exec.rwlock.RwLock. s!)) rc_width!))) (=> %%location_label%%15 (forall ((v$ Poly)) (! (=> (has_type v$ T&) (= (lib!exec.rwlock.impl&%4.inv.? T&. T& (Poly%lib!exec.rwlock.RwLock. s!) v$) (%B (%%apply%%0 inv! v$)))) :pattern ((lib!exec.rwlock.impl&%4.inv.? T&. T& (Poly%lib!exec.rwlock.RwLock. s!) v$)) )))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
