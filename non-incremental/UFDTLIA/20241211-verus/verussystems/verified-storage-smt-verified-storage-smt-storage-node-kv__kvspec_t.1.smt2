...
(set-info :comment ";; MODULE 'module kv::kvspec_t'")
...
(set-info :comment ";; Function-Decl lib::kv::kvspec_t::AbstractKvStoreState::contains_key")
...
(set-info :comment ";; Function-Axioms lib::kv::kvspec_t::TrustedKvPermission::check_permission")
...
(set-info :comment ";; Function-Axioms lib::kv::kvspec_t::AbstractKvStoreState::contains_key")
...
(set-info :comment ";; Function-Def lib::kv::kvspec_t::TrustedKvPermission::new_two_possibilities")
(set-info :comment ";; src/kv/kvspec_t.rs:87:9: 91:33 (#0)")
