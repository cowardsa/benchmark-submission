...
(assert (not (=> (= tmp%2 (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!)))) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!keys_t.SHTKey. tmp%2 tmp%1) (or (and (=> (%B tmp%1) (=> (= tmp%4 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. self!)))) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%4 tmp%3) (=> (= tmp%5 tmp%3) %%switch_label%%2)))) (=> (not (%B tmp%1)) (=> (= tmp%5 (B false)) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> (%B tmp%5) (and (=> %%location_label%%0 (uInv SZ (Sub (- (uHi SZ) 1) 0))) (=> (= tmp%7 (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!)))) (and (=> %%location_label%%1 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. tmp%7)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. tmp%7 tmp%6) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) (%I tmp%6)) (=> (= tmp%9 (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!)))) (and (=> %%location_label%%2 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. tmp%9)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. tmp%9 tmp%8) (and (=> %%location_label%%3 (uInv SZ (Add 0 (%I tmp%8)))) (and (=> %%location_label%%4 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 (%I tmp%8)))))) (=> (= tmp%11 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. self!)))) (and (=> %%location_label%%5 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%11)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%11 tmp%10) (=> (= tmp%12 (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 (%I tmp%8))))) (%I tmp%10))) %%switch_label%%1)))))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) (%I tmp%6))) (=> (= tmp%12 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%13 tmp%12) %%switch_label%%0)))))))) (=> (not (%B tmp%5)) (=> (= tmp%13 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= %return! (B tmp%13)) (=> %%location_label%%6 (= %return! (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!hashmap_t.CKeyKV. self!))))))))))))
(check-sat)
(exit)
