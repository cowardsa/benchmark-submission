...
(set-info :comment ";; Function-Specs lib::seq_is_unique_v::clone_option_end_point")
(declare-fun ens%lib!seq_is_unique_v.clone_option_end_point. (core!option.Option. core!option.Option.) Bool)
(assert (forall ((oep! core!option.Option.) (cloned_oep! core!option.Option.)) (! (= (ens%lib!seq_is_unique_v.clone_option_end_point. oep! cloned_oep!) (and (has_type (Poly%core!option.Option. cloned_oep!) (TYPE%core!option.Option. $ TYPE%lib!io_t.EndPoint.)) (ite (is-core!option.Option./Some_ oep!) (let ((ep$ (%Poly%lib!io_t.EndPoint. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. oep!)))))) (and (is-core!option.Option./Some_ cloned_oep!) (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. ep$)) (lib!io_t.impl&%4.view.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. cloned_oep!))))))) (is-core!option.Option./None_ cloned_oep!)))) :pattern ((ens%lib!seq_is_unique_v.clone_option_end_point. oep! cloned_oep!)) )))
(set-info :comment ";; Function-Def lib::seq_is_unique_v::clone_option_end_point")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:140:5: 140:91 (#0)")
...
(assert (not (=> (ens%core!option.impl&%0.as_ref. $ TYPE%lib!io_t.EndPoint. oep! tmp%%@) (or (and (=> (is-core!option.Option./Some_ tmp%%@) (=> (= ep@ (%Poly%lib!io_t.EndPoint. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@))))) (=> (ens%lib!seq_is_unique_v.clone_end_point. ep@ tmp%1) (=> (= tmp%2 (core!option.Option./Some (Poly%lib!io_t.EndPoint. tmp%1))) %%switch_label%%0)))) (=> (not (is-core!option.Option./Some_ tmp%%@)) (=> (= tmp%2 core!option.Option./None) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= cloned_oep! tmp%2) (=> %%location_label%%0 (ite (is-core!option.Option./Some_ oep!) (let ((ep$ (%Poly%lib!io_t.EndPoint. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. oep!)))))) (and (is-core!option.Option./Some_ cloned_oep!) (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. ep$)) (lib!io_t.impl&%4.view.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. cloned_oep!))))))) (is-core!option.Option./None_ cloned_oep!)))))))))
(check-sat)
(exit)
