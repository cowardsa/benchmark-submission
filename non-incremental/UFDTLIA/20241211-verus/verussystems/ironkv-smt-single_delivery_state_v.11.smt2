...
(assert (lib!single_delivery_state_v.impl&%0.valid.? (Poly%lib!single_delivery_state_v.CAckState. self!) (Poly%lib!abstract_end_point_t.AbstractEndPoint. dst!)))
(assert (and (<= 0 k!) (< k! (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!)))))))))
...
(assert (not (=> (= decrease%init0 k!) (or (and (=> (> k! 0) (=> (= tmp%1 (Sub k! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 self!) (dst!$1 dst!) (k!$2 tmp%1)) k!$2) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!single_delivery_state_v.impl&%0.lemma_seqno_in_un_acked_list. self! dst! tmp%1)) (=> (ens%lib!single_delivery_state_v.impl&%0.lemma_seqno_in_un_acked_list. self! dst! tmp%1) %%switch_label%%0))))) (=> (not (> k! 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (= (lib!cmessage_v.CSingleMessage./Message/seqno (%Poly%lib!cmessage_v.CSingleMessage. (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))) (I k!)))) (Add (Add (lib!single_delivery_state_v.CAckState./CAckState/num_packets_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))) k!) 1))))))))
(check-sat)
(exit)
