...
(assert (not (=> (= tmp%1 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!marshal_ironsht_specific_v.impl&%7.forward_bijection_for_view_equality_do_not_use_for_anything_else.? self!))) (=> (= tmp%2 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!marshal_ironsht_specific_v.impl&%7.forward_bijection_for_view_equality_do_not_use_for_anything_else.? other!))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%1 tmp%2) (=> %%location_label%%0 (= (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!io_t.EndPoint. self! other!) (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!io_t.EndPoint. other! self!))))))))
(check-sat)
(exit)
