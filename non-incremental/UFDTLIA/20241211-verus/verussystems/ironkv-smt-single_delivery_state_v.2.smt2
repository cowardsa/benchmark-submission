...
(declare-const self! lib!single_delivery_state_v.CSendState.)
...
(assert (not (=> (= tmp%2 (lib!single_delivery_state_v.CSendState./CSendState/epmap (%Poly%lib!single_delivery_state_v.CSendState. (Poly%lib!single_delivery_state_v.CSendState. self!)))) (=> (ens%lib!endpoint_hashmap_t.impl&%0.get. $ TYPE%lib!single_delivery_state_v.CAckState. (Poly%lib!endpoint_hashmap_t.HashMap<lib!single_delivery_state_v.CAckState.>. tmp%2) src! tmp%1) (=> (= value! tmp%1) (and (=> %%location_label%%0 (= value! (let ((tmp%%$ (lib!endpoint_hashmap_t.impl&%0.get_spec.? $ TYPE%lib!single_delivery_state_v.CAckState. (lib!endpoint_hashmap_t.impl&%0.view.? $ TYPE%lib!single_delivery_state_v.CAckState. (Poly%lib!endpoint_hashmap_t.HashMap<lib!single_delivery_state_v.CAckState.>. (lib!single_delivery_state_v.CSendState./CSendState/epmap (%Poly%lib!single_delivery_state_v.CSendState. (Poly%lib!single_delivery_state_v.CSendState. self!))))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src!)))))) (ite (is-core!option.Option./Some_ tmp%%$) (let ((v$ (%Poly%lib!single_delivery_state_v.CAckState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%$)))))) (core!option.Option./Some (Poly%lib!single_delivery_state_v.CAckState. v$))) core!option.Option./None)))) (=> %%location_label%%1 (=> (is-core!option.Option./Some_ value!) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. (lib!single_delivery_state_v.impl&%2.view.? (Poly%lib!single_delivery_state_v.CSendState. self!)))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src!))))))))))))
(check-sat)
(exit)
