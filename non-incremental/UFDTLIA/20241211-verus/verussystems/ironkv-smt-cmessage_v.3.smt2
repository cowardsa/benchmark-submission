...
(assert (not (or (and (=> (is-lib!cmessage_v.CSingleMessage./Message_ (%Poly%lib!cmessage_v.CSingleMessage. self!)) (=> (= seqno@ (lib!cmessage_v.CSingleMessage./Message/seqno (%Poly%lib!cmessage_v.CSingleMessage. self!))) (=> (= dst@ (lib!cmessage_v.CSingleMessage./Message/dst (%Poly%lib!cmessage_v.CSingleMessage. self!))) (=> (= m@ (lib!cmessage_v.CSingleMessage./Message/m (%Poly%lib!cmessage_v.CSingleMessage. self!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I seqno@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I seqno@) tmp%1) (and (=> %%location_label%%1 (uInv SZ (Add 1 (%I tmp%1)))) (and (=> %%location_label%%2 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. dst@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. dst@) tmp%2) (and (=> %%location_label%%3 (uInv SZ (Add (uClip SZ (Add 1 (%I tmp%1))) (%I tmp%2)))) (and (=> %%location_label%%4 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. m@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. m@) tmp%3) (and (=> %%location_label%%5 (uInv SZ (Add (uClip SZ (Add (uClip SZ (Add 1 (%I tmp%1))) (%I tmp%2))) (%I tmp%3)))) (=> (= tmp%6 (uClip SZ (Add (uClip SZ (Add (uClip SZ (Add 1 (%I tmp%1))) (%I tmp%2))) (%I tmp%3)))) %%switch_label%%0)))))))))))))) (=> (not (is-lib!cmessage_v.CSingleMessage./Message_ (%Poly%lib!cmessage_v.CSingleMessage. self!))) (or (and (=> (is-lib!cmessage_v.CSingleMessage./Ack_ (%Poly%lib!cmessage_v.CSingleMessage. self!)) (=> (= ack_seqno@ (lib!cmessage_v.CSingleMessage./Ack/ack_seqno (%Poly%lib!cmessage_v.CSingleMessage. self!))) (and (=> %%location_label%%6 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I ack_seqno@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I ack_seqno@) tmp%4) (and (=> %%location_label%%7 (uInv SZ (Add 1 (%I tmp%4)))) (=> (= tmp%5 (uClip SZ (Add 1 (%I tmp%4)))) %%switch_label%%1)))))) (=> (not (is-lib!cmessage_v.CSingleMessage./Ack_ (%Poly%lib!cmessage_v.CSingleMessage. self!))) (=> (= tmp%5 1) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%6 tmp%5) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= %return! (I tmp%6)) (=> %%location_label%%8 (= (%I %return!) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CSingleMessage. self!)))))))))
(check-sat)
(exit)
