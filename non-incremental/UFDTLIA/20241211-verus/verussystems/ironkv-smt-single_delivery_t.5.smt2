...
(declare-const un_acked! Poly)
(declare-const seqno_acked! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Poly)
(declare-const tmp%3 Poly)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (has_type un_acked! (TYPE%vstd!seq.Seq. $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&))))
(assert (has_type seqno_acked! NAT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!)) (or (and (=> (and (and (> (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!) 0) (is-lib!single_message_t.SingleMessage./Message_ (%Poly%lib!single_message_t.SingleMessage. (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0))))) (<= (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0)))) (%I seqno_acked!))) (=> (= tmp%2 (vstd!seq.Seq.subrange.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 1) (I (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!)))) (and (=> %%location_label%%0 (check_decrease_int (let ((un_acked!$0 tmp%2) (seqno_acked!$1 (%I seqno_acked!))) (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!$0)) decrease%init0 false)) (=> (has_type tmp%1 (TYPE%vstd!seq.Seq. $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&))) (=> (= tmp%1 (lib!single_delivery_t.truncate_un_ack_list.? MT&. MT& (vstd!seq.Seq.subrange.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 1) (I (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!))) seqno_acked!)) (=> (= tmp%3 tmp%1) %%switch_label%%0)))))) (=> (not (and (and (> (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!) 0) (is-lib!single_message_t.SingleMessage./Message_ (%Poly%lib!single_message_t.SingleMessage. (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0))))) (<= (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0)))) (%I seqno_acked!)))) (=> (= tmp%3 un_acked!) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
