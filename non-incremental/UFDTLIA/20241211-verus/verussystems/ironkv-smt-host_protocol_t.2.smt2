...
(declare-const h! Poly)
(declare-const k! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 core!option.Option.)
(assert fuel_defaults)
(assert (has_type h! (TYPE%vstd!map.Map. $ TYPE%lib!keys_t.SHTKey. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))))
(assert (has_type k! TYPE%lib!keys_t.SHTKey.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (or (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!keys_t.SHTKey. (vstd!map.impl&%0.dom.? $ TYPE%lib!keys_t.SHTKey. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) h!) k!) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!keys_t.SHTKey. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) h! k!)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ TYPE%lib!keys_t.SHTKey. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) h! k!)) (=> (= tmp%2 (core!option.Option./Some tmp%1)) %%switch_label%%0)))) (=> (not (vstd!set.impl&%0.contains.? $ TYPE%lib!keys_t.SHTKey. (vstd!map.impl&%0.dom.? $ TYPE%lib!keys_t.SHTKey. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) h!) k!)) (=> (= tmp%2 core!option.Option./None) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
