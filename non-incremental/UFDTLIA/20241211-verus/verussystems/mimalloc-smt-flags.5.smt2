...
(assert (not (=> (= b! (not (= (uClip 8 (bitand (I (lib!types.PageInner./PageInner/flags1 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!)))) (I 2))) 0))) (=> %%location_label%%0 (= b! (lib!flags.impl&%0.has_aligned.? (Poly%lib!types.PageInner. self!)))))))
(check-sat)
(exit)
