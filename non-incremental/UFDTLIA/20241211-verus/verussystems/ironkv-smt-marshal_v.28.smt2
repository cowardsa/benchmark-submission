...
(assert (%B (lib!marshal_v.Marshalable.view_equal.? $ (UINT 64) self! other!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (and (=> %%location_label%%0 (= (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT 64) self!) (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT 64) other!))) (=> %%location_label%%1 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT 64) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT 64) other!)))))))
(check-sat)
(exit)
