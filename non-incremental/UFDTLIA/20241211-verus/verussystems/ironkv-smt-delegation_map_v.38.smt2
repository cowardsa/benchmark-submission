...
(assert (not (and (=> %%location_label%%0 (req%lib!delegation_map_v.impl&%3.greatest_lower_bound_index. K&. K& self! iter!)) (=> (ens%lib!delegation_map_v.impl&%3.greatest_lower_bound_index. K&. K& self! iter! index@) (=> (= tmp%2 (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)))) (and (=> %%location_label%%1 (req%lib!delegation_map_v.impl&%1.index. K&. K& tmp%2 index@)) (=> (ens%lib!delegation_map_v.impl&%1.index. K&. K& tmp%2 index@ tmp%1) (=> (ens%lib!delegation_map_v.impl&%2.new. K&. K& tmp%1 glb@) (=> (= glb! glb@) (=> %%location_label%%2 (lib!delegation_map_v.impl&%3.greatest_lower_bound_spec.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!) (Poly%lib!keys_t.KeyIterator. iter!) (Poly%lib!keys_t.KeyIterator. glb!))))))))))))
(check-sat)
(exit)
