...
(assert (not (=> (= tmp%2 (tuple%2./tuple%2/0 (%Poly%tuple%2. self!))) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. T&. T& tmp%2 tmp%1) (or (and (=> (%B tmp%1) (=> (= tmp%4 (tuple%2./tuple%2/1 (%Poly%tuple%2. self!))) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. U&. U& tmp%4 tmp%3) (=> (= tmp%5 tmp%3) %%switch_label%%1)))) (=> (not (%B tmp%1)) (=> (= tmp%5 (B false)) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> (%B tmp%5) (=> (= tmp%7 (tuple%2./tuple%2/0 (%Poly%tuple%2. self!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%7)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%7 tmp%6) (=> (= tmp%9 (tuple%2./tuple%2/1 (%Poly%tuple%2. self!))) (and (=> %%location_label%%1 (req%lib!marshal_v.Marshalable.serialized_size. U&. U& tmp%9)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. U&. U& tmp%9 tmp%8) (and (=> %%location_label%%2 (uInv SZ (Sub (- (uHi SZ) 1) (%I tmp%8)))) (=> (= tmp%10 (<= (%I tmp%6) (uClip SZ (Sub (- (uHi SZ) 1) (%I tmp%8))))) %%switch_label%%0))))))))) (=> (not (%B tmp%5)) (=> (= tmp%10 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= %return! (B tmp%10)) (=> %%location_label%%3 (= %return! (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%tuple%2. T&. T& U&. U&) self!))))))))))))
(check-sat)
(exit)
