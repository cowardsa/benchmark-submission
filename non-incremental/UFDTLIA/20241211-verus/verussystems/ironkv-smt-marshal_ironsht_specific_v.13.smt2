...
(declare-const x0$2@ alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const x1$2@ alloc!vec.Vec<u8./allocator_global%.>.)
...
(declare-const x0$3@ alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const x1$3@ alloc!vec.Vec<u8./allocator_global%.>.)
...
(assert (not (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!hashmap_t.CKeyKV. self! other!))))
(assert (<= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. self!)) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. other!))))
...
(assert (not (=> (= si@ (%Poly%vstd!seq.Seq<u8.>. (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. self!))) (=> (= so@ (%Poly%vstd!seq.Seq<u8.>. (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. other!))) (=> (= mid@ 0) (or (and (=> (not (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!))) (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. other!)))))) (=> (= tmp%%@ (tuple%2./tuple%2 (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!))) (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. other!))))) (=> (= x0@ (%Poly%lib!keys_t.SHTKey. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= x1@ (%Poly%lib!keys_t.SHTKey. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= tmp%%$1@ (tuple%2./tuple%2 (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. x0@)) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. x1@)))) (=> (= s0@ (%Poly%vstd!seq.Seq<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@))))) (=> (= s1@ (%Poly%vstd!seq.Seq<u8.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@))))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. x0@) (Poly%lib!keys_t.SHTKey. x1@)) (=> (= tmp%%$2@ (ite (<= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0@)) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1@))) (tuple%4./tuple%4 (Poly%lib!keys_t.SHTKey. x0@) (Poly%lib!keys_t.SHTKey. x1@) (Poly%vstd!seq.Seq<u8.>. s0@) (Poly%vstd!seq.Seq<u8.>. s1@)) (tuple%4./tuple%4 (Poly%lib!keys_t.SHTKey. x1@) (Poly%lib!keys_t.SHTKey. x0@) (Poly%vstd!seq.Seq<u8.>. s1@) (Poly%vstd!seq.Seq<u8.>. s0@)))) (=> (= x0$1@ (%Poly%lib!keys_t.SHTKey. (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$2@))))) (=> (= x1$1@ (%Poly%lib!keys_t.SHTKey. (tuple%4./tuple%4/1 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$2@))))) (=> (= s0$1@ (%Poly%vstd!seq.Seq<u8.>. (tuple%4./tuple%4/2 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$2@))))) (=> (= s1$1@ (%Poly%vstd!seq.Seq<u8.>. (tuple%4./tuple%4/3 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$2@))))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. x0$1@) (Poly%lib!keys_t.SHTKey. x1$1@))) (=> (ens%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. x0$1@) (Poly%lib!keys_t.SHTKey. x1$1@)) (=> (= tmp%1 (not (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s0$1@) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$1@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$1@))))))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= idx@ (%I (as_type (%%choose%%0 INT 0 (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$1@)) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$1@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$1@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$1@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$1@)) INT))) (or (and (=> (= si@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@)))))) (=> (= tmp%2 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@) (I (Add mid@ idx@))) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I (Add mid@ idx@))))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 %%switch_label%%3)))) (=> (not (= si@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@))))))) %%switch_label%%3)) (and (not %%switch_label%%3) (=> %%location_label%%3 (not (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. self!) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. self!)))))))))))))))))))))))))))) (=> (not (not (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!))) (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. other!))))))) (=> (= tmp%3 (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!)))) (=> (= tmp%4 (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. other!)))) (and (=> %%location_label%%4 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ TYPE%lib!keys_t.SHTKey. tmp%3 tmp%4)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ TYPE%lib!keys_t.SHTKey. tmp%3 tmp%4) %%switch_label%%2)))))) (and (not %%switch_label%%2) (=> (= mid$1@ (Add mid@ (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!))))))) (or (and (=> (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. self!))) (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. other!)))))) (=> (= tmp%%$3@ (tuple%2./tuple%2 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. self!))) (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. other!))))) (=> (= x0$2@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$3@))))) (=> (= x1$2@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$3@))))) (=> (= tmp%%$4@ (tuple%2./tuple%2 (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x0$2@)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x1$2@)))) (=> (= s0$2@ (%Poly%vstd!seq.Seq<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$4@))))) (=> (= s1$2@ (%Poly%vstd!seq.Seq<u8.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$4@))))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x0$2@) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x1$2@)) (=> (= tmp%%$5@ (ite (<= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$2@)) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$2@))) (tuple%4./tuple%4 (Poly%alloc!vec.Vec<u8./allocator_global%.>. x0$2@) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x1$2@) (Poly%vstd!seq.Seq<u8.>. s0$2@) (Poly%vstd!seq.Seq<u8.>. s1$2@)) (tuple%4./tuple%4 (Poly%alloc!vec.Vec<u8./allocator_global%.>. x1$2@) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x0$2@) (Poly%vstd!seq.Seq<u8.>. s1$2@) (Poly%vstd!seq.Seq<u8.>. s0$2@)))) (=> (= x0$3@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$5@))))) (=> (= x1$3@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (tuple%4./tuple%4/1 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$5@))))) (=> (= s0$3@ (%Poly%vstd!seq.Seq<u8.>. (tuple%4./tuple%4/2 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$5@))))) (=> (= s1$3@ (%Poly%vstd!seq.Seq<u8.>. (tuple%4./tuple%4/3 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$5@))))) (and (=> %%location_label%%5 (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x0$3@) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x1$3@))) (=> (ens%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x0$3@) (Poly%alloc!vec.Vec<u8./allocator_global%.>. x1$3@)) (=> (= tmp%5 (not (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s0$3@) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$3@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$3@))))))) (and (=> %%location_label%%6 tmp%5) (=> tmp%5 (=> (= idx$1@ (%I (as_type (%%choose%%0 INT 0 (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$3@)) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$3@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$3@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$3@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$3@)) INT))) (or (and (=> (= si@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@)))))) (=> (= tmp%6 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@) (I (Add mid$1@ idx$1@))) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I (Add mid$1@ idx$1@))))) (and (=> %%location_label%%7 tmp%6) (=> tmp%6 %%switch_label%%1)))) (=> (not (= si@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@))))))) %%switch_label%%1)) (and (not %%switch_label%%1) (=> %%location_label%%8 (not (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. self!) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. self!)))))))))))))))))))))))))))) (=> (not (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. self!))) (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. other!))))))) (=> (= tmp%7 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. self!)))) (=> (= tmp%8 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. other!)))) (and (=> %%location_label%%9 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%7 tmp%8)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%7 tmp%8) %%switch_label%%0)))))) (and (not %%switch_label%%0) (=> (= mid$2@ (Add mid$1@ (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. self!))))))) (=> %%location_label%%10 (not (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. self!) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. self!))))))))))))))))))
(check-sat)
(exit)
