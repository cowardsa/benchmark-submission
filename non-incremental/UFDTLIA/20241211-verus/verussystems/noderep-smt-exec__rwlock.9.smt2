...
(set-info :comment ";; Function-Def lib::exec::rwlock::RwLock::acquire_write")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/exec/rwlock.rs:276:5: 276:75 (#0)")
(set-info :comment ";; Function-Specs lib::spec::rwlock::RwLockSpec::Instance::exc_release")
(declare-fun req%lib!spec.rwlock.RwLockSpec.impl&%10.exc_release. (Dcr Type Poly Poly Poly Poly Poly) Bool)
...
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (t! Poly) (param_token_1_storage! Poly) (pre%param_token_exc_locked! Poly) (param_token_0_exc_guard! Poly)) (! (= (req%lib!spec.rwlock.RwLockSpec.impl&%10.exc_release. T&. T& self! t! param_token_1_storage! pre%param_token_exc_locked! param_token_0_exc_guard!) (and (=> %%global_location_label%%79 (= (lib!spec.rwlock.RwLockSpec.exc_locked_token_data./exc_locked_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (lib!spec.rwlock.RwLockSpec.impl&%4.view.? T&. T& pre%param_token_exc_locked!)))) self!)) (=> %%global_location_label%%80 (= (lib!spec.rwlock.RwLockSpec.exc_guard_token_data./exc_guard_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.exc_guard_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_guard_token_data. (lib!spec.rwlock.RwLockSpec.impl&%7.view.? T&. T& param_token_0_exc_guard!)))) self!)) (=> %%global_location_label%%81 (vstd!set.impl&%0.contains.? T&. T& (lib!spec.rwlock.RwLockSpec.impl&%10.user_inv.? T&. T& self!) t!)) (=> %%global_location_label%%82 (= (lib!spec.rwlock.RwLockSpec.exc_guard_token_data./exc_guard_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.exc_guard_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_guard_token_data. (lib!spec.rwlock.RwLockSpec.impl&%7.view.? T&. T& param_token_0_exc_guard!)))) tuple%0./tuple%0)) (=> %%global_location_label%%83 (= param_token_1_storage! t!)))) :pattern ((req%lib!spec.rwlock.RwLockSpec.impl&%10.exc_release. T&. T& self! t! param_token_1_storage! pre%param_token_exc_locked! param_token_0_exc_guard!)) )))
(declare-fun ens%lib!spec.rwlock.RwLockSpec.impl&%10.exc_release. (Dcr Type Poly Poly Poly Poly Poly Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (t! Poly) (param_token_1_storage! Poly) (pre%param_token_exc_locked! Poly) (param_token_exc_locked! Poly) (param_token_0_exc_guard! Poly)) (! (= (ens%lib!spec.rwlock.RwLockSpec.impl&%10.exc_release. T&. T& self! t! param_token_1_storage! pre%param_token_exc_locked! param_token_exc_locked! param_token_0_exc_guard!) (and (has_type param_token_exc_locked! (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. T&. T&)) (= (lib!spec.rwlock.RwLockSpec.exc_locked_token_data./exc_locked_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (lib!spec.rwlock.RwLockSpec.impl&%4.view.? T&. T& param_token_exc_locked!)))) self!) (= (lib!spec.rwlock.RwLockSpec.exc_locked_token_data./exc_locked_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (lib!spec.rwlock.RwLockSpec.impl&%4.view.? T&. T& param_token_exc_locked!)))) false))) :pattern ((ens%lib!spec.rwlock.RwLockSpec.impl&%10.exc_release. T&. T& self! t! param_token_1_storage! pre%param_token_exc_locked! param_token_exc_locked! param_token_0_exc_guard!)) )))
(set-info :comment ";; Function-Specs lib::exec::rwlock::RwLock::release_write")
(declare-fun req%lib!exec.rwlock.impl&%4.release_write. (Dcr Type lib!exec.rwlock.RwLock. Poly lib!exec.rwlock.RwLockWriteGuard.) Bool)
(declare-const %%global_location_label%%84 Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! lib!exec.rwlock.RwLock.) (val! Poly) (write_handle! lib!exec.rwlock.RwLockWriteGuard.)) (! (= (req%lib!exec.rwlock.impl&%4.release_write. T&. T& self! val! write_handle!) (=> %%global_location_label%%84 (and (and (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!)) (lib!exec.rwlock.impl&%4.inv.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!) val!)) (lib!exec.rwlock.impl&%4.wf_write_handle.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!) (Poly%lib!exec.rwlock.RwLockWriteGuard. write_handle!))))) :pattern ((req%lib!exec.rwlock.impl&%4.release_write. T&. T& self! val! write_handle!)) )))
(declare-fun ens%lib!exec.rwlock.impl&%4.release_write. (Dcr Type lib!exec.rwlock.RwLock. Poly lib!exec.rwlock.RwLockWriteGuard.) Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! lib!exec.rwlock.RwLock.) (val! Poly) (write_handle! lib!exec.rwlock.RwLockWriteGuard.)) (! (= (ens%lib!exec.rwlock.impl&%4.release_write. T&. T& self! val! write_handle!) (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!))) :pattern ((ens%lib!exec.rwlock.impl&%4.release_write. T&. T& self! val! write_handle!)) )))
(set-info :comment ";; Function-Def lib::exec::rwlock::RwLock::release_write")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/exec/rwlock.rs:464:5: 464:84 (#0)")
(set-info :comment ";; Function-Specs lib::spec::rwlock::RwLockSpec::Instance::shared_start")
(declare-fun req%lib!spec.rwlock.RwLockSpec.impl&%10.shared_start. (Dcr Type Poly Int Poly) Bool)
(declare-const %%global_location_label%%85 Bool)
(declare-const %%global_location_label%%86 Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (r! Int) (param_token_0_ref_counts! Poly)) (! (= (req%lib!spec.rwlock.RwLockSpec.impl&%10.shared_start. T&. T& self! r! param_token_0_ref_counts!) (and (=> %%global_location_label%%85 (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_0_ref_counts!)))) self!)) (=> %%global_location_label%%86 (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_0_ref_counts!)))) r!)))) :pattern ((req%lib!spec.rwlock.RwLockSpec.impl&%10.shared_start. T&. T& self! r! param_token_0_ref_counts!)) )))
(declare-fun ens%lib!spec.rwlock.RwLockSpec.impl&%10.shared_start. (Dcr Type Poly Int Poly tuple%2.) Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (r! Int) (param_token_0_ref_counts! Poly) (tmp_tuple! tuple%2.)) (! (= (ens%lib!spec.rwlock.RwLockSpec.impl&%10.shared_start. T&. T& self! r! param_token_0_ref_counts! tmp_tuple!) (and (has_type (Poly%tuple%2. tmp_tuple!) (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. T&. T&) (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.shared_pending. T&. T&))) (let ((param_token_1_ref_counts$ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp_tuple!))))) (let ((param_token_2_shared_pending$ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp_tuple!))))) (let ((param_token_1_ref_counts$1 param_token_1_ref_counts$)) (let ((param_token_2_shared_pending$1 param_token_2_shared_pending$)) (and (and (and (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_1_ref_counts$1)))) self!) (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_2_shared_pending$1)))) self!)) (let ((rc$ (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_0_ref_counts!)))))) (and (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_1_ref_counts$1)))) r!) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_1_ref_counts$1)))) (Add rc$ 1))))) (let ((rc$ (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_0_ref_counts!)))))) (and (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_2_shared_pending$1)))) r!) (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/count (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_2_shared_pending$1)))) 1)))))))))) :pattern ((ens%lib!spec.rwlock.RwLockSpec.impl&%10.shared_start. T&. T& self! r! param_token_0_ref_counts! tmp_tuple!)) )))
(set-info :comment ";; Function-Specs lib::spec::rwlock::RwLockSpec::Instance::shared_finish")
(declare-fun req%lib!spec.rwlock.RwLockSpec.impl&%10.shared_finish. (Dcr Type Poly Int Poly Poly) Bool)
...
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (r! Int) (param_token_exc_locked! Poly) (param_token_0_shared_pending! Poly)) (! (= (req%lib!spec.rwlock.RwLockSpec.impl&%10.shared_finish. T&. T& self! r! param_token_exc_locked! param_token_0_shared_pending!) (and (=> %%global_location_label%%87 (= (lib!spec.rwlock.RwLockSpec.exc_locked_token_data./exc_locked_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (lib!spec.rwlock.RwLockSpec.impl&%4.view.? T&. T& param_token_exc_locked!)))) self!)) (=> %%global_location_label%%88 (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_0_shared_pending!)))) self!)) (=> %%global_location_label%%89 (not (lib!spec.rwlock.RwLockSpec.exc_locked_token_data./exc_locked_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_locked_token_data. (lib!spec.rwlock.RwLockSpec.impl&%4.view.? T&. T& param_token_exc_locked!)))))) (=> %%global_location_label%%90 (and (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_0_shared_pending!)))) r!) (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/count (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_0_shared_pending!)))) 1))))) :pattern ((req%lib!spec.rwlock.RwLockSpec.impl&%10.shared_finish. T&. T& self! r! param_token_exc_locked! param_token_0_shared_pending!)) )))
(declare-fun ens%lib!spec.rwlock.RwLockSpec.impl&%10.shared_finish. (Dcr Type Poly Int Poly Poly tuple%2.) Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (r! Int) (param_token_exc_locked! Poly) (param_token_0_shared_pending! Poly) (tmp_tuple! tuple%2.)) (! (= (ens%lib!spec.rwlock.RwLockSpec.impl&%10.shared_finish. T&. T& self! r! param_token_exc_locked! param_token_0_shared_pending! tmp_tuple!) (and (has_type (Poly%tuple%2. tmp_tuple!) (TYPE%tuple%2. (GHOST $) (TYPE%core!option.Option. T&. T&) (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.shared_guard. T&. T&))) (let ((original_field_storage$ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp_tuple!)))))) (let ((param_token_1_shared_guard$ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp_tuple!))))) (let ((original_field_storage$1 original_field_storage$)) (let ((param_token_1_shared_guard$1 param_token_1_shared_guard$)) (and (and (= (lib!spec.rwlock.RwLockSpec.shared_guard_token_data./shared_guard_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.shared_guard_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_guard_token_data. (lib!spec.rwlock.RwLockSpec.impl&%9.view.? T&. T& param_token_1_shared_guard$1)))) self!) (let ((t$ (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. original_field_storage$1))))) (and (= (lib!spec.rwlock.RwLockSpec.shared_guard_token_data./shared_guard_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.shared_guard_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_guard_token_data. (lib!spec.rwlock.RwLockSpec.impl&%9.view.? T&. T& param_token_1_shared_guard$1)))) (tuple%2./tuple%2 (I r!) t$)) (= (lib!spec.rwlock.RwLockSpec.shared_guard_token_data./shared_guard_token_data/count (%Poly%lib!spec.rwlock.RwLockSpec.shared_guard_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_guard_token_data. (lib!spec.rwlock.RwLockSpec.impl&%9.view.? T&. T& param_token_1_shared_guard$1)))) 1)))) (let ((t$ (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. original_field_storage$1))))) (vstd!set.impl&%0.contains.? T&. T& (lib!spec.rwlock.RwLockSpec.impl&%10.user_inv.? T&. T& self!) t$))))))))) :pattern ((ens%lib!spec.rwlock.RwLockSpec.impl&%10.shared_finish. T&. T& self! r! param_token_exc_locked! param_token_0_shared_pending! tmp_tuple!)) )))
(set-info :comment ";; Function-Specs lib::spec::rwlock::RwLockSpec::Instance::rc_not_zero_guard")
(declare-fun req%lib!spec.rwlock.RwLockSpec.impl&%10.rc_not_zero_guard. (Dcr Type Poly Int Poly Poly) Bool)
...
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (r! Int) (param_token_1_ref_counts! Poly) (param_token_0_shared_pending! Poly)) (! (= (req%lib!spec.rwlock.RwLockSpec.impl&%10.rc_not_zero_guard. T&. T& self! r! param_token_1_ref_counts! param_token_0_shared_pending!) (and (=> %%global_location_label%%91 (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_1_ref_counts!)))) self!)) (=> %%global_location_label%%92 (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_0_shared_pending!)))) self!)) (=> %%global_location_label%%93 (and (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_0_shared_pending!)))) r!) (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/count (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_0_shared_pending!)))) 1))) (=> %%global_location_label%%94 (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_1_ref_counts!)))) r!)))) :pattern ((req%lib!spec.rwlock.RwLockSpec.impl&%10.rc_not_zero_guard. T&. T& self! r! param_token_1_ref_counts! param_token_0_shared_pending!)) )))
(declare-fun ens%lib!spec.rwlock.RwLockSpec.impl&%10.rc_not_zero_guard. (Dcr Type Poly Int Poly Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (r! Int) (param_token_1_ref_counts! Poly) (param_token_0_shared_pending! Poly)) (! (= (ens%lib!spec.rwlock.RwLockSpec.impl&%10.rc_not_zero_guard. T&. T& self! r! param_token_1_ref_counts! param_token_0_shared_pending!) (let ((rc$ (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_1_ref_counts!)))))) (> rc$ 0))) :pattern ((ens%lib!spec.rwlock.RwLockSpec.impl&%10.rc_not_zero_guard. T&. T& self! r! param_token_1_ref_counts! param_token_0_shared_pending!)) )))
(set-info :comment ";; Function-Specs lib::spec::rwlock::RwLockSpec::Instance::shared_abandon")
(declare-fun req%lib!spec.rwlock.RwLockSpec.impl&%10.shared_abandon. (Dcr Type Poly Int Poly Poly) Bool)
...
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (r! Int) (param_token_0_ref_counts! Poly) (param_token_2_shared_pending! Poly)) (! (= (req%lib!spec.rwlock.RwLockSpec.impl&%10.shared_abandon. T&. T& self! r! param_token_0_ref_counts! param_token_2_shared_pending!) (and (=> %%global_location_label%%95 (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_0_ref_counts!)))) self!)) (=> %%global_location_label%%96 (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_2_shared_pending!)))) self!)) (=> %%global_location_label%%97 (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_0_ref_counts!)))) r!)) (=> %%global_location_label%%98 (let ((rc$ (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_0_ref_counts!)))))) (> rc$ 0))) (=> %%global_location_label%%99 (let ((rc$ (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_0_ref_counts!)))))) (and (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_2_shared_pending!)))) r!) (= (lib!spec.rwlock.RwLockSpec.shared_pending_token_data./shared_pending_token_data/count (%Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.shared_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%8.view.? T&. T& param_token_2_shared_pending!)))) 1)))))) :pattern ((req%lib!spec.rwlock.RwLockSpec.impl&%10.shared_abandon. T&. T& self! r! param_token_0_ref_counts! param_token_2_shared_pending!)) )))
(declare-fun ens%lib!spec.rwlock.RwLockSpec.impl&%10.shared_abandon. (Dcr Type Poly Int Poly Poly Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! Poly) (r! Int) (param_token_0_ref_counts! Poly) (param_token_2_shared_pending! Poly) (param_token_1_ref_counts! Poly)) (! (= (ens%lib!spec.rwlock.RwLockSpec.impl&%10.shared_abandon. T&. T& self! r! param_token_0_ref_counts! param_token_2_shared_pending! param_token_1_ref_counts!) (and (has_type param_token_1_ref_counts! (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. T&. T&)) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_1_ref_counts!)))) self!) (let ((rc$ (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_0_ref_counts!)))))) (and (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/key (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_1_ref_counts!)))) r!) (= (lib!spec.rwlock.RwLockSpec.ref_counts_token_data./ref_counts_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (Poly%lib!spec.rwlock.RwLockSpec.ref_counts_token_data. (lib!spec.rwlock.RwLockSpec.impl&%5.view.? T&. T& param_token_1_ref_counts!)))) (Sub rc$ 1)))))) :pattern ((ens%lib!spec.rwlock.RwLockSpec.impl&%10.shared_abandon. T&. T& self! r! param_token_0_ref_counts! param_token_2_shared_pending! param_token_1_ref_counts!)) )))
(set-info :comment ";; Function-Specs vstd::atomic::impl&%9::fetch_sub")
(declare-fun req%vstd!atomic.impl&%9.fetch_sub. (vstd!atomic.PAtomicU64. vstd!atomic.PermissionU64. Int) Bool)
...
(assert (forall ((self! vstd!atomic.PAtomicU64.) (pre%perm! vstd!atomic.PermissionU64.) (n! Int)) (! (= (req%vstd!atomic.impl&%9.fetch_sub. self! pre%perm! n!) (and (=> %%global_location_label%%100 (= (vstd!atomic.impl&%9.id.? (Poly%vstd!atomic.PAtomicU64. self!)) (vstd!atomic.PermissionDataU64./PermissionDataU64/patomic (%Poly%vstd!atomic.PermissionDataU64. (Poly%vstd!atomic.PermissionDataU64. (vstd!atomic.impl&%8.view.? (Poly%vstd!atomic.PermissionU64. pre%perm!))))))) (=> %%global_location_label%%101 (<= 0 (Sub (vstd!atomic.PermissionDataU64./PermissionDataU64/value (%Poly%vstd!atomic.PermissionDataU64. (Poly%vstd!atomic.PermissionDataU64. (vstd!atomic.impl&%8.view.? (Poly%vstd!atomic.PermissionU64. pre%perm!))))) n!))) (=> %%global_location_label%%102 (<= (Sub (vstd!atomic.PermissionDataU64./PermissionDataU64/value (%Poly%vstd!atomic.PermissionDataU64. (Poly%vstd!atomic.PermissionDataU64. (vstd!atomic.impl&%8.view.? (Poly%vstd!atomic.PermissionU64. pre%perm!))))) n!) 18446744073709551615)))) :pattern ((req%vstd!atomic.impl&%9.fetch_sub. self! pre%perm! n!)) )))
(declare-fun ens%vstd!atomic.impl&%9.fetch_sub. (vstd!atomic.PAtomicU64. vstd!atomic.PermissionU64. vstd!atomic.PermissionU64. Int Int) Bool)
(assert (forall ((self! vstd!atomic.PAtomicU64.) (pre%perm! vstd!atomic.PermissionU64.) (perm! vstd!atomic.PermissionU64.) (n! Int) (ret! Int)) (! (= (ens%vstd!atomic.impl&%9.fetch_sub. self! pre%perm! perm! n! ret!) (and (uInv 64 ret!) (= (vstd!atomic.PermissionDataU64./PermissionDataU64/value (%Poly%vstd!atomic.PermissionDataU64. (Poly%vstd!atomic.PermissionDataU64. (vstd!atomic.impl&%8.view.? (Poly%vstd!atomic.PermissionU64. pre%perm!))))) ret!) (= (vstd!atomic.PermissionDataU64./PermissionDataU64/patomic (%Poly%vstd!atomic.PermissionDataU64. (Poly%vstd!atomic.PermissionDataU64. (vstd!atomic.impl&%8.view.? (Poly%vstd!atomic.PermissionU64. perm!))))) (vstd!atomic.PermissionDataU64./PermissionDataU64/patomic (%Poly%vstd!atomic.PermissionDataU64. (Poly%vstd!atomic.PermissionDataU64. (vstd!atomic.impl&%8.view.? (Poly%vstd!atomic.PermissionU64. pre%perm!)))))) (= (vstd!atomic.PermissionDataU64./PermissionDataU64/value (%Poly%vstd!atomic.PermissionDataU64. (Poly%vstd!atomic.PermissionDataU64. (vstd!atomic.impl&%8.view.? (Poly%vstd!atomic.PermissionU64. perm!))))) (Sub (vstd!atomic.PermissionDataU64./PermissionDataU64/value (%Poly%vstd!atomic.PermissionDataU64. (Poly%vstd!atomic.PermissionDataU64. (vstd!atomic.impl&%8.view.? (Poly%vstd!atomic.PermissionU64. pre%perm!))))) n!)))) :pattern ((ens%vstd!atomic.impl&%9.fetch_sub. self! pre%perm! perm! n! ret!)) )))
(set-info :comment ";; Function-Specs lib::exec::rwlock::RwLock::acquire_read")
(declare-fun req%lib!exec.rwlock.impl&%4.acquire_read. (Dcr Type lib!exec.rwlock.RwLock. Int) Bool)
(declare-const %%global_location_label%%103 Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! lib!exec.rwlock.RwLock.) (tid! Int)) (! (= (req%lib!exec.rwlock.impl&%4.acquire_read. T&. T& self! tid!) (=> %%global_location_label%%103 (and (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!)) (lib!exec.rwlock.impl&%4.thread_id_valid.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!) (I tid!))))) :pattern ((req%lib!exec.rwlock.impl&%4.acquire_read. T&. T& self! tid!)) )))
(declare-fun ens%lib!exec.rwlock.impl&%4.acquire_read. (Dcr Type lib!exec.rwlock.RwLock. Int lib!exec.rwlock.RwLockReadGuard.) Bool)
(assert (forall ((T&. Dcr) (T& Type) (self! lib!exec.rwlock.RwLock.) (tid! Int) (res! lib!exec.rwlock.RwLockReadGuard.)) (! (= (ens%lib!exec.rwlock.impl&%4.acquire_read. T&. T& self! tid! res!) (and (has_type (Poly%lib!exec.rwlock.RwLockReadGuard. res!) (TYPE%lib!exec.rwlock.RwLockReadGuard. T&. T&)) (and (and (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!)) (lib!exec.rwlock.impl&%4.wf_read_handle.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!) (Poly%lib!exec.rwlock.RwLockReadGuard. res!))) (lib!exec.rwlock.impl&%4.inv.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!) (lib!exec.rwlock.impl&%0.view.? T&. T& (Poly%lib!exec.rwlock.RwLockReadGuard. res!)))))) :pattern ((ens%lib!exec.rwlock.impl&%4.acquire_read. T&. T& self! tid! res!)) )))
(set-info :comment ";; Function-Def lib::exec::rwlock::RwLock::acquire_read")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/exec/rwlock.rs:372:17: 373:18 (#0)")
(set-info :comment ";; Function-Def lib::exec::rwlock::RwLock::acquire_read")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/exec/rwlock.rs:355:9: 449:10 (#0)")
(set-info :comment ";; Function-Def lib::exec::rwlock::RwLock::acquire_read")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/exec/rwlock.rs:349:5: 349:78 (#0)")
(declare-const T&. Dcr)
(declare-const T& Type)
(declare-const res! lib!exec.rwlock.RwLockReadGuard.)
...
(declare-const tmp%4 vstd!atomic.PAtomicU64.)
(declare-const verus_tmp_rc@ Int)
...
(declare-const verus_tmp_prev@ Int)
(declare-const tmp%8 vstd!atomic.PAtomicU64.)
(declare-const verus_tmp_next@ Int)
(declare-const tmp%9 Bool)
(declare-const tmp%10 Poly)
(declare-const tmp%%@ tuple%2.)
(declare-const _ref_counts@ Poly)
(declare-const _shared_pending@ Poly)
(declare-const verus_tmp$4@ tuple%2.)
(declare-const perm$1@0 vstd!atomic.PermissionU64.)
(declare-const g$1@0 Poly)
(declare-const verus_tmp$5@0 Int)
(declare-const prev@0 Int)
(declare-const verus_tmp$6@0 core!result.Result.)
(declare-const verus_tmp$7@0 Int)
(declare-const next@0 Int)
...
(declare-const pair$2@0 tuple%2.)
...
(declare-const verus_tmp_res@ Bool)
(declare-const tmp%14 Poly)
(declare-const tmp%15 Poly)
(declare-const tmp%%$1@ tuple%2.)
(declare-const _perms@ core!option.Option.)
(declare-const _shared_guard@ Poly)
(declare-const verus_tmp$8@ tuple%2.)
(declare-const perm$2@0 vstd!atomic.PermissionBool.)
(declare-const g$2@0 Poly)
(declare-const verus_tmp$9@0 Bool)
(declare-const res$1@0 Bool)
(declare-const verus_tmp$10@0 Bool)
(declare-const verus_tmp$11@0 Bool)
(declare-const result$2@ Bool)
...
(declare-const pair$3@0 tuple%2.)
...
(declare-const shared_pending$1@ Poly)
(declare-const tmp%%$2@ Int)
(declare-const tmp%%$3@ Int)
(declare-const tmp%%$4@ Int)
(declare-const tmp%21 vstd!atomic.PAtomicU64.)
(declare-const verus_tmp$12@ tuple%2.)
...
(declare-const shared_pending@0 core!option.Option.)
(declare-const res@ core!result.Result.)
(declare-const perms@0 Poly)
(declare-const shared_guard@ core!option.Option.)
(declare-const is_exc_locked@ Bool)
(declare-const perms$1@ Poly)
(assert fuel_defaults)
(assert (has_type (Poly%lib!exec.rwlock.RwLock. self!) (TYPE%lib!exec.rwlock.RwLock. T&. T&)))
(assert (uInv SZ tid!))
(assert (and (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!)) (lib!exec.rwlock.impl&%4.thread_id_valid.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!) (I tid!))))
...
(declare-const verus_tmp$5@1 Int)
(declare-const prev@1 Int)
(declare-const verus_tmp$6@1 core!result.Result.)
(declare-const verus_tmp$7@1 Int)
(declare-const next@1 Int)
(declare-const shared_pending@1 core!option.Option.)
(declare-const pair$2@1 tuple%2.)
(declare-const perm$2@1 vstd!atomic.PermissionBool.)
(declare-const g$2@1 Poly)
(declare-const verus_tmp$9@1 Bool)
(declare-const res$1@1 Bool)
(declare-const verus_tmp$10@1 Bool)
(declare-const verus_tmp$11@1 Bool)
(declare-const perms@1 Poly)
(declare-const pair$3@1 tuple%2.)
...
(assert (not (=> %%location_label%%0 (and (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!)) (< tid! (vstd!std_specs.vec.spec_vec_len.? $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global. (lib!exec.rwlock.RwLock./RwLock/ref_counts (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. self!)))))))))
(check-sat)
(exit)
