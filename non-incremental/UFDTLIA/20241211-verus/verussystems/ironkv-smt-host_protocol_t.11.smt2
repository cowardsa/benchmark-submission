...
(declare-const end_points@ vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>.)
(assert fuel_defaults)
(assert (has_type args! (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= end_points@ (lib!host_protocol_t.unchecked_parse_args.? args!)) (=> (has_type i@ INT) (or (and (=> (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. end_points@)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. end_points@) i@)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. end_points@) i@)) (=> (= tmp%2 (lib!abstract_end_point_t.impl&%0.valid_physical_address.? tmp%1)) %%switch_label%%0)))) (=> (not (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. end_points@))))) (=> (= tmp%2 true) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
