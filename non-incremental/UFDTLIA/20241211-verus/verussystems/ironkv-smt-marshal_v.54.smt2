...
(set-info :comment ";; Function-Def lib::marshal_v::impl&%5::lemma_same_views_serialize_the_same")
(set-info :comment ";; ironsht/src/marshal_v.rs:1144:9: 1144:74 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%5::lemma_serialize_injective")
(set-info :comment ";; ironsht/src/marshal_v.rs:1151:9: 1151:64 (#0)")
(declare-const T&. Dcr)
...
(assert (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%tuple%2. T&. T& U&. U&) other!)))
(assert (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) other!)))
...
(assert (not (or (and (=> (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%tuple%2. T&. T& U&. U&) self! other!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%tuple%2. T&. T& U&. U&) self! other!)) (=> (ens%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%tuple%2. T&. T& U&. U&) self! other!) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!)))) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) other!))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 %%switch_label%%0)))))) (=> (not (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%tuple%2. T&. T& U&. U&) self! other!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%tuple%2. T&. T& U&. U&) self! other!)))))))
(check-sat)
(exit)
