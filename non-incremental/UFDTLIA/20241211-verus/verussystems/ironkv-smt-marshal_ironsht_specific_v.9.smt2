...
(assert (not (=> (ens%lib!marshal_v.Marshalable.deserialize. $ (UINT 64) data! start! tmp%1) (=> (= tmp%%@ (%Poly%core!option.Option. tmp%1)) (=> (= %return! (Poly%core!option.Option. (ite (is-core!option.Option./None_ tmp%%@) core!option.Option./None (let ((x$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@)))))))) (let ((end$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@)))))))) (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (Poly%lib!keys_t.SHTKey. (lib!keys_t.SHTKey./SHTKey (%I (I x$)))) (I end$))))))))) (=> %%location_label%%0 (=> (and (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (is-tuple%2./tuple%2_ (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%Poly%lib!keys_t.SHTKey. (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. x$$0)))))))))))))
(check-sat)
(exit)
