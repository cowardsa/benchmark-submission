...
(declare-const %return! vstd!set.Set<lib!keys_t.SHTKey.>.)
(declare-const h! Poly)
(declare-const kr! Poly)
...
(assert (has_type kr! (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.)))
(assert (has_type u! (TYPE%vstd!map.Map. $ TYPE%lib!keys_t.SHTKey. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))))
(assert (not true))
(check-sat)
(exit)
