...
(declare-const k! lib!keys_t.KeyIterator.)
...
(assert (has_type (Poly%lib!keys_t.KeyIterator. k!) (TYPE%lib!keys_t.KeyIterator. K&. K&)))
(assert (tr_bound%lib!keys_t.KeyTrait. K&. K&))
(assert (tr_bound%lib!verus_extra.clone_v.VerusClone. K&. K&))
(assert (lib!delegation_map_v.impl&%3.gap.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!) (Poly%lib!keys_t.KeyIterator. lo!) (Poly%lib!keys_t.KeyIterator. hi!)))
(assert (and (lib!keys_t.impl&%3.lt_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. lo!) (Poly%lib!keys_t.KeyIterator. k!)) (lib!keys_t.impl&%3.lt_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. k!) (Poly%lib!keys_t.KeyIterator. hi!))))
(assert (vstd!set.impl&%0.contains.? K&. K& (vstd!map.impl&%0.dom.? K&. K& $ TYPE%lib!io_t.EndPoint. (lib!delegation_map_v.impl&%3.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))) (lib!delegation_map_v.impl&%2.get_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. k!))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!delegation_map_v.impl&%3.mind_the_gap. K&. K& self!) (=> %%location_label%%0 false))))
(check-sat)
(exit)
