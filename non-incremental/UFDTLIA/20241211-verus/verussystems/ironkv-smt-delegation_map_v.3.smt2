...
(declare-const self! lib!keys_t.KeyIterator.)
(declare-const other! lib!keys_t.KeyIterator.)
...
(declare-const tmp%11 core!option.Option.)
...
(assert (has_type (Poly%lib!keys_t.KeyIterator. self!) (TYPE%lib!keys_t.KeyIterator. K&. K&)))
(assert (has_type (Poly%lib!keys_t.KeyIterator. other!) (TYPE%lib!keys_t.KeyIterator. K&. K&)))
...
(assert (not (=> (ens%lib!delegation_map_v.impl&%2.is_end. K&. K& self! tmp%1) (or (and (=> (not tmp%1) (=> (ens%lib!delegation_map_v.impl&%2.is_end. K&. K& other! tmp%2) (=> (= tmp%3 tmp%2) %%switch_label%%3))) (=> (not (not tmp%1)) (=> (= tmp%3 false) %%switch_label%%3))) (and (not %%switch_label%%3) (or (and (=> tmp%3 (=> (= tmp%16 true) %%switch_label%%0)) (=> (not tmp%3) (=> (ens%lib!delegation_map_v.impl&%2.is_end. K&. K& self! tmp%4) (or (and (=> (not tmp%4) (=> (ens%lib!delegation_map_v.impl&%2.is_end. K&. K& other! tmp%5) (=> (= tmp%6 (not tmp%5)) %%switch_label%%2))) (=> (not (not tmp%4)) (=> (= tmp%6 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%6 (=> (= tmp%8 (lib!keys_t.KeyIterator./KeyIterator/k (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. self!)))) (=> (ens%core!option.impl&%0.as_ref. K&. K& tmp%8 tmp%7) (and (=> %%location_label%%0 (req%core!option.impl&%0.unwrap. (REF K&.) K& tmp%7)) (=> (ens%core!option.impl&%0.unwrap. (REF K&.) K& tmp%7 tmp%9) (=> (= tmp%11 (lib!keys_t.KeyIterator./KeyIterator/k (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. other!)))) (=> (ens%core!option.impl&%0.as_ref. K&. K& tmp%11 tmp%10) (and (=> %%location_label%%1 (req%core!option.impl&%0.unwrap. (REF K&.) K& tmp%10)) (=> (ens%core!option.impl&%0.unwrap. (REF K&.) K& tmp%10 tmp%12) (and (=> %%location_label%%2 (req%lib!keys_t.KeyTrait.cmp. K&. K& tmp%9 tmp%12)) (=> (ens%lib!keys_t.KeyTrait.cmp. K&. K& tmp%9 tmp%12 tmp%13) (=> (ens%lib!delegation_map_v.impl&%0.is_lt. (%Poly%lib!keys_t.Ordering. tmp%13) tmp%14) (=> (= tmp%15 tmp%14) %%switch_label%%1))))))))))))) (=> (not tmp%6) (=> (= tmp%15 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%16 tmp%15) %%switch_label%%0)))))))) (and (not %%switch_label%%0) (=> (= b! tmp%16) (=> %%location_label%%3 (= b! (lib!keys_t.impl&%3.lt_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. self!) (Poly%lib!keys_t.KeyIterator. other!))))))))))))
(check-sat)
(exit)
