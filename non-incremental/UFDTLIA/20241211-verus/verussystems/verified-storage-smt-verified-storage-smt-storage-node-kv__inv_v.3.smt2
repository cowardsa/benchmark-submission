...
(set-info :comment ";; MODULE 'module kv::inv_v'")
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!std_specs.result.impl&%0.is_Ok. fuel%vstd!std_specs.result.impl&%0.get_Ok_0. fuel%vstd!std_specs.result.spec_unwrap. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.impl&%0.len. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_empty. fuel%vstd!map.axiom_map_insert_domain. fuel%vstd!map.axiom_map_insert_same. fuel%vstd!map.axiom_map_insert_different. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!map_lib.impl&%0.is_empty. fuel%vstd!map_lib.impl&%0.contains_key. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_empty. fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_set_empty_finite. fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_empty_len. fuel%vstd!set.axiom_set_insert_len. fuel%vstd!set.axiom_set_contains_len. fuel%vstd!set_lib.impl&%0.is_empty. fuel%vstd!set_lib.axiom_is_empty. fuel%lib!kv.durable.durablespec_t.impl&%0.empty. fuel%lib!kv.durable.durablespec_t.impl&%1.key. fuel%lib!kv.durable.durablespec_t.impl&%2.spec_index. fuel%lib!kv.durable.durablespec_t.impl&%2.contains_key. fuel%lib!kv.durable.durablespec_t.impl&%2.empty. fuel%lib!kv.durable.durablespec_t.impl&%2.len. fuel%lib!kv.durable.durablespec_t.impl&%2.create. fuel%lib!kv.durable.durablespec_t.impl&%2.valid. fuel%lib!kv.durable.durablespec_t.impl&%2.matches_volatile_index. fuel%lib!kv.volatile.volatilespec_t.impl&%1.spec_index. fuel%lib!kv.volatile.volatilespec_t.impl&%1.contains_key. fuel%lib!kv.volatile.volatilespec_t.impl&%1.len. fuel%lib!kv.volatile.volatilespec_t.impl&%1.insert_item_offset. fuel%lib!kv.volatile.volatilespec_t.impl&%1.empty. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(assert (=> (fuel_bool_default fuel%vstd!seq.group_seq_axioms.) (and (fuel_bool_default fuel%vstd!seq.axiom_seq_index_decreases.) (fuel_bool_default fuel%vstd!seq.axiom_seq_empty.) (fuel_bool_default fuel%vstd!seq.axiom_seq_ext_equal.) (fuel_bool_default fuel%vstd!seq.axiom_seq_ext_equal_deep.))))
...
(assert (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (map! Poly)) (! (= (req%lib!kv.inv_v.lemma_empty_map_contains_no_keys. K&. K& V&. V& map!) (and (=> %%global_location_label%%6 (vstd!set_lib.impl&%0.is_empty.? K&. K& (vstd!map.impl&%0.dom.? K&. K& V&. V& map!))) (=> %%global_location_label%%7 (vstd!set.impl&%0.finite.? K&. K& (vstd!map.impl&%0.dom.? K&. K& V&. V& map!))))) :pattern ((req%lib!kv.inv_v.lemma_empty_map_contains_no_keys. K&. K& V&. V& map!)) )))
...
(set-info :comment ";; Function-Def lib::kv::inv_v::lemma_empty_map_contains_no_keys")
(set-info :comment ";; src/kv/inv_v.rs:40:5: 40:72 (#0)")
...
(assert (forall ((K&. Dcr) (K& Type) (I&. Dcr) (I& Type) (L&. Dcr) (L& Type) (E&. Dcr) (E& Type) (durable_store! lib!kv.durable.durablespec_t.DurableKvStoreView.) (volatile_index! lib!kv.volatile.volatilespec_t.VolatileKvIndexView.)) (! (= (req%lib!kv.inv_v.lemma_empty_index_matches_empty_store. K&. K& I&. I& L&. L& E&. E& durable_store! volatile_index!) (and (=> %%global_location_label%%8 (lib!kv.durable.durablespec_t.impl&%2.empty.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!))) (=> %%global_location_label%%9 (lib!kv.durable.durablespec_t.impl&%2.valid.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!))) (=> %%global_location_label%%10 (vstd!set.impl&%0.finite.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!kv.durable.durablespec_t.DurableKvStoreViewEntry. K&. K& I&. I& L&. L&) (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/contents (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!)))))) (=> %%global_location_label%%11 (lib!kv.volatile.volatilespec_t.impl&%1.empty.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. volatile_index!))))) :pattern ((req%lib!kv.inv_v.lemma_empty_index_matches_empty_store. K&. K& I&. I& L&. L& E&. E& durable_store! volatile_index!)) )))
...
(set-info :comment ";; Function-Def lib::kv::inv_v::lemma_empty_index_matches_empty_store")
(set-info :comment ";; src/kv/inv_v.rs:22:5: 26:31 (#0)")
...
(assert (forall ((K&. Dcr) (K& Type) (I&. Dcr) (I& Type) (L&. Dcr) (L& Type) (E&. Dcr) (E& Type) (old_durable_state! lib!kv.durable.durablespec_t.DurableKvStoreView.) (old_volatile_state! lib!kv.volatile.volatilespec_t.VolatileKvIndexView.) (offset! Int) (key! Poly) (item! Poly)) (! (= (req%lib!kv.inv_v.lemma_volatile_matches_durable_after_create. K&. K& I&. I& L&. L& E&. E& old_durable_state! old_volatile_state! offset! key! item!) (and (=> %%global_location_label%%12 (lib!kv.durable.durablespec_t.impl&%2.matches_volatile_index.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. old_durable_state!) (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. old_volatile_state!))) (=> %%global_location_label%%13 (is-core!option.Option./None_ (lib!kv.durable.durablespec_t.impl&%2.spec_index.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. old_durable_state!) (I offset!)))) (=> %%global_location_label%%14 (is-core!option.Option./None_ (lib!kv.volatile.volatilespec_t.impl&%1.spec_index.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. old_volatile_state!) key!))) (=> %%global_location_label%%15 (= (lib!kv.kvimpl_t.Item.spec_key.? I&. I& K&. K& item!) key!)))) :pattern ((req%lib!kv.inv_v.lemma_volatile_matches_durable_after_create. K&. K& I&. I& L&. L& E&. E& old_durable_state! old_volatile_state! offset! key! item!)) )))
...
(set-info :comment ";; Function-Def lib::kv::inv_v::lemma_volatile_matches_durable_after_create")
(set-info :comment ";; src/kv/inv_v.rs:53:5: 63:31 (#0)")
(declare-const K&. Dcr)
...
(declare-const old_durable_state! lib!kv.durable.durablespec_t.DurableKvStoreView.)
(declare-const old_volatile_state! lib!kv.volatile.volatilespec_t.VolatileKvIndexView.)
...
(declare-const indexed_offset@ Int)
(declare-const new_durable_state@ lib!kv.durable.durablespec_t.DurableKvStoreView.)
(declare-const new_volatile_state@ lib!kv.volatile.volatilespec_t.VolatileKvIndexView.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. old_durable_state!) (TYPE%lib!kv.durable.durablespec_t.DurableKvStoreView. K&. K& I&. I& L&. L& E&. E&)))
(assert (has_type (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. old_volatile_state!) (TYPE%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. K&. K&)))
(assert (has_type key! K&))
(assert (has_type item! I&))
...
(assert (lib!kv.durable.durablespec_t.impl&%2.matches_volatile_index.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. old_durable_state!) (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. old_volatile_state!)))
(assert (is-core!option.Option./None_ (lib!kv.durable.durablespec_t.impl&%2.spec_index.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. old_durable_state!) (I offset!))))
(assert (is-core!option.Option./None_ (lib!kv.volatile.volatilespec_t.impl&%1.spec_index.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. old_volatile_state!) key!)))
(assert (= (lib!kv.kvimpl_t.Item.spec_key.? I&. I& K&. K& item!) key!))
...
(assert (not (=> (= new_durable_state@ (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!kv.durable.durablespec_t.impl&%2.create.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. old_durable_state!) (I offset!) item!)))))) (=> (= new_volatile_state@ (lib!kv.volatile.volatilespec_t.impl&%1.insert_item_offset.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. old_volatile_state!) key! (I offset!))) (and (=> (has_type k@ K&) (=> (lib!kv.volatile.volatilespec_t.impl&%1.contains_key.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. new_volatile_state@) k@) (or (and (=> (not (= k@ key!)) (=> (= tmp%1 (lib!kv.volatile.volatilespec_t.impl&%1.contains_key.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. old_volatile_state!) k@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= indexed_offset@ (lib!kv.volatile.volatilespec_t.VolatileKvIndexEntry./VolatileKvIndexEntry/item_offset (%Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexEntry. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!kv.volatile.volatilespec_t.impl&%1.spec_index.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. new_volatile_state@) k@))))))) (=> (= tmp%2 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT K&. K& (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/index_to_key_map (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. old_durable_state!)))) (I indexed_offset@))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (= (vstd!map.impl&%0.index.? $ INT K&. K& (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/index_to_key_map (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. old_durable_state!))) (I indexed_offset@)) (vstd!map.impl&%0.index.? $ INT K&. K& (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/index_to_key_map (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. new_durable_state@))) (I indexed_offset@)))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%0))))))))))) (=> (not (not (= k@ key!))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%3 (let ((indexed_offset$ (lib!kv.volatile.volatilespec_t.VolatileKvIndexEntry./VolatileKvIndexEntry/item_offset (%Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexEntry. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!kv.volatile.volatilespec_t.impl&%1.spec_index.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. new_volatile_state@) k@)))))))) (and (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT K&. K& (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/index_to_key_map (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. new_durable_state@)))) (I indexed_offset$)) (= (vstd!map.impl&%0.index.? $ INT K&. K& (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/index_to_key_map (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. new_durable_state@))) (I indexed_offset$)) k@)))))))) (=> (forall ((k$ Poly)) (! (=> (has_type k$ K&) (=> (lib!kv.volatile.volatilespec_t.impl&%1.contains_key.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. new_volatile_state@) k$) (let ((indexed_offset$ (lib!kv.volatile.volatilespec_t.VolatileKvIndexEntry./VolatileKvIndexEntry/item_offset (%Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexEntry. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!kv.volatile.volatilespec_t.impl&%1.spec_index.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. new_volatile_state@) k$)))))))) (and (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT K&. K& (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/index_to_key_map (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. new_durable_state@)))) (I indexed_offset$)) (= (vstd!map.impl&%0.index.? $ INT K&. K& (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/index_to_key_map (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. new_durable_state@))) (I indexed_offset$)) k$))))) :pattern ((lib!kv.volatile.volatilespec_t.impl&%1.contains_key.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. new_volatile_state@) k$)) )) (=> %%location_label%%4 (let ((new_durable_state$ (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!kv.durable.durablespec_t.impl&%2.create.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. old_durable_state!) (I offset!) item!))))))) (let ((new_volatile_state$ (lib!kv.volatile.volatilespec_t.impl&%1.insert_item_offset.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. old_volatile_state!) key! (I offset!)))) (lib!kv.durable.durablespec_t.impl&%2.matches_volatile_index.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. new_durable_state$) (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. new_volatile_state$)))))))))))
(check-sat)
(exit)
