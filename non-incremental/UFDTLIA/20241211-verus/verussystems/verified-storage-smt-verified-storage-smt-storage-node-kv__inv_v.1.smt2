...
(assert (has_type map! (TYPE%vstd!map.Map. K&. K& V&. V&)))
(assert (vstd!set_lib.impl&%0.is_empty.? K&. K& (vstd!map.impl&%0.dom.? K&. K& V&. V& map!)))
(assert (vstd!set.impl&%0.finite.? K&. K& (vstd!map.impl&%0.dom.? K&. K& V&. V& map!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (forall ((k$ Poly)) (! (=> (has_type k$ K&) (not (vstd!set.impl&%0.contains.? K&. K& (vstd!map.impl&%0.dom.? K&. K& V&. V& map!) k$))) :pattern ((vstd!set.impl&%0.contains.? K&. K& (vstd!map.impl&%0.dom.? K&. K& V&. V& map!) k$)) )))))
(check-sat)
(exit)
