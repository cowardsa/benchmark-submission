...
(assert (uInv SZ tid!))
(assert (has_type tmp%1 (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.))))
(assert (has_type tmp%2 (TYPE%alloc!vec.Vec. $ (TYPE%lib!exec.CachePadded. $ (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)) $ TYPE%alloc!alloc.Global.)))
(assert (has_type tmp%3 (TYPE%vstd!invariant.AtomicInvariant. $ (TYPE%tuple%2. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ INT) $ (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionU64. $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&))) $ (TYPE%vstd!atomic_ghost.AtomicPredU64. $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.))))
(assert (has_type (Poly%tuple%2. pair@0) (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionU64. $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)))))
(assert (has_type verus_tmp_g@0 (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&))))
(assert (uInv 64 verus_tmp_rc@))
(assert (has_type (Poly%tuple%2. verus_tmp@) (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionU64. $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)))))
(assert (has_type g@0 (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&))))
(assert (uInv 64 verus_tmp$1@0))
(assert (uInv 64 rc$1@0))
(assert (uInv 64 verus_tmp$2@0))
(assert (uInv 64 verus_tmp$3@0))
(assert (uInv 64 result@))
(assert (has_type (Poly%vstd!atomic_ghost.AtomicU64. atomic@) (TYPE%vstd!atomic_ghost.AtomicU64. $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%lib!spec.rwlock.RwLockSpec.ref_counts. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_ref_counts.)))
(assert (uInv 64 rc@))
(assert (not true))
(check-sat)
(exit)
