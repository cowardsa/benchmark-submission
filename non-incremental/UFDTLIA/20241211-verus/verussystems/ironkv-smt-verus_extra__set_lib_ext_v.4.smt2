...
(assert (has_type sets1! (TYPE%vstd!set.Set. $ (TYPE%vstd!set.Set. A&. A&))))
(assert (has_type sets2! (TYPE%vstd!set.Set. $ (TYPE%vstd!set.Set. A&. A&))))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(declare-const %%location_label%%3 Bool)
(assert (not (=> (= s1@ (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& (vstd!set.impl&%0.union.? $ (TYPE%vstd!set.Set. A&. A&) sets1! sets2!))) (=> (= s2@ (vstd!set.impl&%0.union.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets1!) (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets2!))) (and (and (=> (has_type elem@ A&) (=> %%location_label%%0 (and (=> (vstd!set.impl&%0.contains.? A&. A& s1@ elem@) (vstd!set.impl&%0.contains.? A&. A& s2@ elem@)) (=> (vstd!set.impl&%0.contains.? A&. A& s2@ elem@) (vstd!set.impl&%0.contains.? A&. A& s1@ elem@))))) (=> (forall ((elem$ Poly)) (! (=> (has_type elem$ A&) (and (=> (vstd!set.impl&%0.contains.? A&. A& s1@ elem$) (vstd!set.impl&%0.contains.? A&. A& s2@ elem$)) (=> (vstd!set.impl&%0.contains.? A&. A& s2@ elem$) (vstd!set.impl&%0.contains.? A&. A& s1@ elem$)))) :pattern ((vstd!set.impl&%0.contains.? A&. A& s1@ elem$)) :pattern ((vstd!set.impl&%0.contains.? A&. A& s2@ elem$)) )) (=> (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. A&. A&) s1@ s2@)) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> %%location_label%%3 (= (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& (vstd!set.impl&%0.union.? $ (TYPE%vstd!set.Set. A&. A&) sets1! sets2!)) (vstd!set.impl&%0.union.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets1!) (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets2!))))))))))
(check-sat)
(exit)
