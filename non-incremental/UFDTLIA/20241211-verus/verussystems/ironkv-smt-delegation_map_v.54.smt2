...
(assert (has_type (Poly%lib!delegation_map_v.DelegationMap. self!) (TYPE%lib!delegation_map_v.DelegationMap. $ TYPE%lib!keys_t.SHTKey.)))
...
(assert (lib!delegation_map_v.impl&%4.valid.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!delegation_map_v.DelegationMap. self!)))
(declare-fun %%choose%%14 (Type Dcr Type Dcr Type Poly Poly Dcr Type Dcr Type Poly lib!abstract_end_point_t.AbstractEndPoint. Dcr Type Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Dcr) (%%hole%%10 Type) (%%hole%%11 Poly) (%%hole%%12 lib!abstract_end_point_t.AbstractEndPoint.) (%%hole%%13 Dcr) (%%hole%%14 Type) (%%hole%%15 Dcr) (%%hole%%16 Type) (%%hole%%17 Poly)) (! (=> (exists ((k$2 Poly)) (! (and (has_type k$2 %%hole%%0) (and (lib!delegation_map_v.impl&%2.between.? %%hole%%3 %%hole%%4 %%hole%%5 (Poly%lib!keys_t.KeyIterator. (lib!keys_t.impl&%3.new_spec.? %%hole%%1 %%hole%%2 k$2)) %%hole%%6) (not (= (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.index.? %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 k$2)) %%hole%%12)))) :pattern ((vstd!map.impl&%0.index.? %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 k$2)) )) (exists ((k$2 Poly)) (! (and (and (has_type k$2 %%hole%%0) (and (lib!delegation_map_v.impl&%2.between.? %%hole%%3 %%hole%%4 %%hole%%5 (Poly%lib!keys_t.KeyIterator. (lib!keys_t.impl&%3.new_spec.? %%hole%%1 %%hole%%2 k$2)) %%hole%%6) (not (= (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.index.? %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 k$2)) %%hole%%12)))) (= (%%choose%%14 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17) k$2)) :pattern ((vstd!map.impl&%0.index.? %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 k$2))))) :pattern ((%%choose%%14 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17)))))
...
(assert (not (and (=> %%location_label%%0 (req%lib!delegation_map_v.impl&%4.range_consistent_impl. $ TYPE%lib!keys_t.SHTKey. self! lo! hi! dst!)) (=> (ens%lib!delegation_map_v.impl&%4.range_consistent_impl. $ TYPE%lib!keys_t.SHTKey. self! lo! hi! dst! ret@) (=> (= kr@ (lib!keys_t.KeyRange./KeyRange (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. lo!)) (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. hi!)))) (or (and (=> ret@ (and (=> (has_type k@ TYPE%lib!keys_t.SHTKey.) (=> (lib!keys_t.impl&%4.contains.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.KeyRange. kr@) k@) (=> (= tmp%1 (lib!delegation_map_v.impl&%2.between.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.KeyIterator. lo!) (Poly%lib!keys_t.KeyIterator. (lib!keys_t.impl&%3.new_spec.? $ TYPE%lib!keys_t.SHTKey. k@)) (Poly%lib!keys_t.KeyIterator. hi!))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (= (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.index.? $ TYPE%lib!keys_t.SHTKey. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (lib!delegation_map_v.impl&%4.view.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!delegation_map_v.DelegationMap. self!)) k@)) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. dst!))))))))) (=> (forall ((k$ Poly)) (! (=> (has_type k$ TYPE%lib!keys_t.SHTKey.) (=> (lib!keys_t.impl&%4.contains.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.KeyRange. kr@) k$) (= (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.index.? $ TYPE%lib!keys_t.SHTKey. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (lib!delegation_map_v.impl&%4.view.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!delegation_map_v.DelegationMap. self!)) k$)) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. dst!))))) :pattern ((lib!keys_t.impl&%4.contains.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.KeyRange. kr@) k$)) )) %%switch_label%%0))) (=> (not ret@) (=> (= k$1@ (%Poly%lib!keys_t.SHTKey. (as_type (%%choose%%14 TYPE%lib!keys_t.SHTKey. $ TYPE%lib!keys_t.SHTKey. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.KeyIterator. lo!) (Poly%lib!keys_t.KeyIterator. hi!) $ TYPE%lib!keys_t.SHTKey. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (lib!delegation_map_v.impl&%4.view.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!delegation_map_v.DelegationMap. self!)) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. dst!)) $ TYPE%lib!keys_t.SHTKey. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (lib!delegation_map_v.impl&%4.view.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!delegation_map_v.DelegationMap. self!))) TYPE%lib!keys_t.SHTKey.))) (=> (= tmp%2 (lib!keys_t.impl&%4.contains.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.KeyRange. kr@) (Poly%lib!keys_t.SHTKey. k$1@))) (and (=> %%location_label%%3 tmp%2) (=> tmp%2 %%switch_label%%0)))))) (and (not %%switch_label%%0) (=> (= b! ret@) (=> %%location_label%%4 (= b! (lib!delegation_map_t.impl&%0.delegate_for_key_range_is_host.? (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!delegation_map_t.AbstractDelegationMap./AbstractDelegationMap (%Poly%vstd!map.Map<lib!keys_t.SHTKey./lib!abstract_end_point_t.AbstractEndPoint.>. (lib!delegation_map_v.impl&%4.view.? $ TYPE%lib!keys_t.SHTKey. (Poly%lib!delegation_map_v.DelegationMap. self!))))) (Poly%lib!keys_t.KeyRange. (lib!keys_t.KeyRange./KeyRange (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. lo!)) (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. hi!)))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. dst!))))))))))))))
(check-sat)
(exit)
