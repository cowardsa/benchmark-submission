...
(declare-const queue! Poly)
(declare-const log! Poly)
(declare-const queueIndex! Poly)
(declare-const logIndexLower! Poly)
(declare-const logIndexUpper! Poly)
(declare-const nodeId! Poly)
...
(assert (has_type queue! (TYPE%vstd!seq.Seq. $ NAT)))
(assert (has_type log! (TYPE%vstd!map.Map. $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&))))
(assert (has_type queueIndex! NAT))
(assert (has_type logIndexLower! NAT))
(assert (has_type logIndexUpper! NAT))
(assert (has_type nodeId! NAT))
...
(assert (not (=> (= decrease%init0 (Sub (%I logIndexUpper!) (%I logIndexLower!))) (=> (tr_bound%lib!Dispatch. DT&. DT&) (=> (<= (%I logIndexLower!) (%I logIndexUpper!)) (or (and (=> (=> (= logIndexLower! logIndexUpper!) (= (%I queueIndex!) (vstd!seq.Seq.len.? $ NAT queue!))) (or (and (=> (< (%I logIndexLower!) (%I logIndexUpper!)) (or (and (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log!) logIndexLower!) (or (and (=> (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! logIndexLower!))) (%I nodeId!)) (or (and (=> (and (and (and (< (%I queueIndex!) (vstd!seq.Seq.len.? $ NAT queue!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates!) (vstd!seq.Seq.index.? $ NAT queue! queueIndex!))) (is-lib!spec.unbounded_log.UpdateState./Placed_ (%Poly%lib!spec.unbounded_log.UpdateState. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates! (vstd!seq.Seq.index.? $ NAT queue! queueIndex!))))) (= (lib!spec.unbounded_log.UpdateState./Placed/idx (%Poly%lib!spec.unbounded_log.UpdateState. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates! (vstd!seq.Seq.index.? $ NAT queue! queueIndex!)))) (%I logIndexLower!))) (=> (= tmp%2 (I (nClip (Add (%I queueIndex!) 1)))) (=> (= tmp%3 (I (nClip (Add (%I logIndexLower!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (queueIndex!$2 tmp%2) (logIndexLower!$3 tmp%3) (logIndexUpper!$4 logIndexUpper!) (nodeId!$5 nodeId!) (updates!$6 updates!)) (Sub (%I logIndexUpper!$4) (%I logIndexLower!$3))) decrease%init0 false)) (=> (= tmp%1 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& queue! log! (I (nClip (Add (%I queueIndex!) 1))) (I (nClip (Add (%I logIndexLower!) 1))) logIndexUpper! nodeId! updates!)) (=> (= tmp%4 tmp%1) %%switch_label%%6)))))) (=> (not (and (and (and (< (%I queueIndex!) (vstd!seq.Seq.len.? $ NAT queue!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates!) (vstd!seq.Seq.index.? $ NAT queue! queueIndex!))) (is-lib!spec.unbounded_log.UpdateState./Placed_ (%Poly%lib!spec.unbounded_log.UpdateState. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates! (vstd!seq.Seq.index.? $ NAT queue! queueIndex!))))) (= (lib!spec.unbounded_log.UpdateState./Placed/idx (%Poly%lib!spec.unbounded_log.UpdateState. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates! (vstd!seq.Seq.index.? $ NAT queue! queueIndex!)))) (%I logIndexLower!)))) (=> (= tmp%4 false) %%switch_label%%6))) (and (not %%switch_label%%6) (=> (= tmp%5 tmp%4) %%switch_label%%5)))) (=> (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! logIndexLower!))) (%I nodeId!))) (=> (= tmp%5 true) %%switch_label%%5))) (and (not %%switch_label%%5) (=> (= tmp%6 tmp%5) %%switch_label%%4)))) (=> (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log!) logIndexLower!)) (=> (= tmp%6 false) %%switch_label%%4))) (and (not %%switch_label%%4) (or (and (=> tmp%6 (or (and (=> (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! logIndexLower!))) (%I nodeId!))) (=> (= tmp%8 (I (nClip (Add (%I logIndexLower!) 1)))) (and (=> %%location_label%%1 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (queueIndex!$2 queueIndex!) (logIndexLower!$3 tmp%8) (logIndexUpper!$4 logIndexUpper!) (nodeId!$5 nodeId!) (updates!$6 updates!)) (Sub (%I logIndexUpper!$4) (%I logIndexLower!$3))) decrease%init0 false)) (=> (= tmp%7 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& queue! log! queueIndex! (I (nClip (Add (%I logIndexLower!) 1))) logIndexUpper! nodeId! updates!)) (=> (= tmp%9 tmp%7) %%switch_label%%3))))) (=> (not (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! logIndexLower!))) (%I nodeId!)))) (=> (= tmp%9 true) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= tmp%10 tmp%9) %%switch_label%%2)))) (=> (not tmp%6) (=> (= tmp%10 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%11 tmp%10) %%switch_label%%1)))))) (=> (not (< (%I logIndexLower!) (%I logIndexUpper!))) (=> (= tmp%11 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%12 tmp%11) %%switch_label%%0)))) (=> (not (=> (= logIndexLower! logIndexUpper!) (= (%I queueIndex!) (vstd!seq.Seq.len.? $ NAT queue!)))) (=> (= tmp%12 false) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
