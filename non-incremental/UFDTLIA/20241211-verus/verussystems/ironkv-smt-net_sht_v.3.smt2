...
(set-info :comment ";; MODULE 'module net_sht_v'")
...
(declare-const fuel%lib!net_sht_v.impl&%0.arrow_cpacket. FuelId)
(declare-const fuel%lib!net_sht_v.impl&%0.arrow_Packet_cpacket. FuelId)
(declare-const fuel%lib!net_sht_v.net_packet_is_abstractable. FuelId)
(declare-const fuel%lib!net_sht_v.net_event_is_abstractable. FuelId)
(declare-const fuel%lib!net_sht_v.sht_demarshal_data. FuelId)
(declare-const fuel%lib!net_sht_v.abstractify_net_packet_to_lsht_packet. FuelId)
(declare-const fuel%lib!net_sht_v.abstractify_net_event_to_lsht_io. FuelId)
(declare-const fuel%lib!net_sht_v.abstractify_net_packet_to_sht_packet. FuelId)
(declare-const fuel%lib!net_sht_v.net_event_log_is_abstractable. FuelId)
(declare-const fuel%lib!net_sht_v.outbound_packet_is_valid. FuelId)
(declare-const fuel%lib!net_sht_v.send_log_entry_reflects_packet. FuelId)
...
(declare-const fuel%lib!net_sht_v.net_packet_bound. FuelId)
(declare-const fuel%lib!net_sht_v.is_marshalable_data. FuelId)
(declare-const fuel%lib!net_sht_v.only_sent_marshalable_data. FuelId)
(declare-const fuel%lib!net_sht_v.send_log_entries_reflect_packets. FuelId)
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!std_specs.vec.axiom_spec_len. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.impl&%0.spec_add. fuel%vstd!seq.Seq.last. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_subrange_decreases. fuel%vstd!seq.axiom_seq_empty. fuel%vstd!seq.axiom_seq_push_len. fuel%vstd!seq.axiom_seq_push_index_same. fuel%vstd!seq.axiom_seq_push_index_different. fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq.axiom_seq_subrange_len. fuel%vstd!seq.axiom_seq_subrange_index. fuel%vstd!seq.axiom_seq_add_len. fuel%vstd!seq.axiom_seq_add_index1. fuel%vstd!seq.axiom_seq_add_index2. fuel%vstd!seq_lib.impl&%0.add_empty_left. fuel%vstd!seq_lib.impl&%0.add_empty_right. fuel%vstd!seq_lib.impl&%0.push_distributes_over_add. fuel%vstd!seq_lib.impl&%0.contains. fuel%vstd!seq_lib.impl&%0.drop_last. fuel%vstd!seq_lib.impl&%0.fold_left. fuel%vstd!seq_lib.check_argument_is_seq. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view. fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view. fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%20.view. fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%30.view. fuel%vstd!view.impl&%38.view. fuel%vstd!view.impl&%42.view. fuel%lib!cmessage_v.optional_value_view. fuel%lib!cmessage_v.impl&%1.abstractable. fuel%lib!cmessage_v.impl&%1.view. fuel%lib!cmessage_v.impl&%2.abstractable. fuel%lib!cmessage_v.impl&%2.view. fuel%lib!cmessage_v.impl&%3.view. fuel%lib!cmessage_v.impl&%3.abstractable. fuel%lib!cmessage_v.impl&%6.view_equal. fuel%lib!cmessage_v.impl&%6.is_marshalable. fuel%lib!cmessage_v.impl&%6.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%2.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%2.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%2.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%3.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%3.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%3.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%4.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%4.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%4.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%5.forward_bijection_for_view_equality_do_not_use_for_anything_else. fuel%lib!marshal_ironsht_specific_v.impl&%6.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%6.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%6.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%7.forward_bijection_for_view_equality_do_not_use_for_anything_else. fuel%lib!marshal_ironsht_specific_v.impl&%8.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%8.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%8.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%9.forward_bijection_for_view_equality_do_not_use_for_anything_else. fuel%lib!marshal_ironsht_specific_v.impl&%10.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%10.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%10.ghost_serialize. fuel%lib!marshal_v.impl&%0.view_equal. fuel%lib!marshal_v.impl&%0.is_marshalable. fuel%lib!marshal_v.impl&%0.ghost_serialize. fuel%lib!marshal_v.impl&%1.view_equal. fuel%lib!marshal_v.impl&%1.is_marshalable. fuel%lib!marshal_v.impl&%1.ghost_serialize. fuel%lib!marshal_v.impl&%2.view_equal. fuel%lib!marshal_v.impl&%2.is_marshalable. fuel%lib!marshal_v.impl&%2.ghost_serialize. fuel%lib!marshal_v.impl&%3.view_equal. fuel%lib!marshal_v.impl&%3.is_marshalable. fuel%lib!marshal_v.impl&%3.ghost_serialize. fuel%lib!marshal_v.impl&%4.view_equal. fuel%lib!marshal_v.impl&%4.is_marshalable. fuel%lib!marshal_v.impl&%4.ghost_serialize. fuel%lib!marshal_v.impl&%5.view_equal. fuel%lib!marshal_v.impl&%5.is_marshalable. fuel%lib!marshal_v.impl&%5.ghost_serialize. fuel%lib!net_sht_v.impl&%0.arrow_cpacket. fuel%lib!net_sht_v.impl&%0.arrow_Packet_cpacket. fuel%lib!net_sht_v.net_packet_is_abstractable. fuel%lib!net_sht_v.net_event_is_abstractable. fuel%lib!net_sht_v.sht_demarshal_data. fuel%lib!net_sht_v.abstractify_net_packet_to_lsht_packet. fuel%lib!net_sht_v.abstractify_net_event_to_lsht_io. fuel%lib!net_sht_v.abstractify_net_packet_to_sht_packet. fuel%lib!net_sht_v.net_event_log_is_abstractable. fuel%lib!net_sht_v.outbound_packet_is_valid. fuel%lib!net_sht_v.send_log_entry_reflects_packet. fuel%lib!net_sht_v.outbound_packet_seq_is_valid. fuel%lib!net_sht_v.outbound_packet_seq_has_correct_srcs. fuel%lib!net_sht_v.net_packet_bound. fuel%lib!net_sht_v.is_marshalable_data. fuel%lib!net_sht_v.only_sent_marshalable_data. fuel%lib!net_sht_v.send_log_entries_reflect_packets. fuel%lib!abstract_end_point_t.impl&%0.valid_physical_address. fuel%lib!abstract_end_point_t.impl&%0.abstractable. fuel%lib!environment_t.impl&%0.arrow_Send_s. fuel%lib!environment_t.impl&%0.arrow_Receive_r. fuel%lib!hashmap_t.ckeykvlt. fuel%lib!hashmap_t.spec_sorted_keys. fuel%lib!io_t.impl&%4.view. fuel%lib!io_t.impl&%4.abstractable. fuel%lib!io_t.impl&%7.ok. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(declare-sort lib!io_t.NetClient. 0)
...
(declare-fun lib!net_sht_v.ReceiveResult./Packet/cpacket (lib!net_sht_v.ReceiveResult.) lib!cmessage_v.CPacket.)
...
(assert (forall ((x lib!net_sht_v.ReceiveResult.)) (! (= x (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. x))) :pattern ((Poly%lib!net_sht_v.ReceiveResult. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!net_sht_v.ReceiveResult.) (= x (Poly%lib!net_sht_v.ReceiveResult. (%Poly%lib!net_sht_v.ReceiveResult. x)))) :pattern ((has_type x TYPE%lib!net_sht_v.ReceiveResult.)) )))
(assert (has_type (Poly%lib!net_sht_v.ReceiveResult. lib!net_sht_v.ReceiveResult./Fail) TYPE%lib!net_sht_v.ReceiveResult.))
(assert (has_type (Poly%lib!net_sht_v.ReceiveResult. lib!net_sht_v.ReceiveResult./Timeout) TYPE%lib!net_sht_v.ReceiveResult.))
(assert (forall ((_cpacket! lib!cmessage_v.CPacket.)) (! (=> (has_type (Poly%lib!cmessage_v.CPacket. _cpacket!) TYPE%lib!cmessage_v.CPacket.) (has_type (Poly%lib!net_sht_v.ReceiveResult. (lib!net_sht_v.ReceiveResult./Packet _cpacket!)) TYPE%lib!net_sht_v.ReceiveResult.)) :pattern ((has_type (Poly%lib!net_sht_v.ReceiveResult. (lib!net_sht_v.ReceiveResult./Packet _cpacket!)) TYPE%lib!net_sht_v.ReceiveResult.)) )))
(assert (forall ((x lib!net_sht_v.ReceiveResult.)) (! (= (lib!net_sht_v.ReceiveResult./Packet/cpacket x) (lib!net_sht_v.ReceiveResult./Packet/?cpacket x)) :pattern ((lib!net_sht_v.ReceiveResult./Packet/cpacket x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!net_sht_v.ReceiveResult.) (has_type (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. x))) TYPE%lib!cmessage_v.CPacket.)) :pattern ((lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. x)) (has_type x TYPE%lib!net_sht_v.ReceiveResult.)) )))
...
(set-info :comment ";; Function-Decl lib::net_sht_v::net_packet_is_abstractable")
(declare-fun lib!net_sht_v.net_packet_is_abstractable.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::net_sht_v::net_event_is_abstractable")
(declare-fun lib!net_sht_v.net_event_is_abstractable.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::net_sht_v::sht_demarshal_data")
(declare-fun lib!net_sht_v.sht_demarshal_data.? (Poly) lib!cmessage_v.CSingleMessage.)
(set-info :comment ";; Function-Decl lib::net_sht_v::abstractify_net_packet_to_lsht_packet")
(declare-fun lib!net_sht_v.abstractify_net_packet_to_lsht_packet.? (Poly) lib!environment_t.LPacket.)
(set-info :comment ";; Function-Decl lib::net_sht_v::abstractify_net_event_to_lsht_io")
(declare-fun lib!net_sht_v.abstractify_net_event_to_lsht_io.? (Poly) lib!environment_t.LIoOp.)
(set-info :comment ";; Function-Decl lib::net_sht_v::net_event_log_is_abstractable")
(declare-fun lib!net_sht_v.net_event_log_is_abstractable.? (Poly) Bool)
...
(set-info :comment ";; Function-Decl lib::net_sht_v::ReceiveResult::arrow_cpacket")
(declare-fun lib!net_sht_v.impl&%0.arrow_cpacket.? (Poly) lib!cmessage_v.CPacket.)
(set-info :comment ";; Function-Decl lib::net_sht_v::ReceiveResult::arrow_Packet_cpacket")
(declare-fun lib!net_sht_v.impl&%0.arrow_Packet_cpacket.? (Poly) lib!cmessage_v.CPacket.)
(set-info :comment ";; Function-Decl lib::net_sht_v::abstractify_net_packet_to_sht_packet")
(declare-fun lib!net_sht_v.abstractify_net_packet_to_sht_packet.? (Poly) lib!network_t.Packet.)
...
(set-info :comment ";; Function-Decl lib::net_sht_v::send_log_entry_reflects_packet")
(declare-fun lib!net_sht_v.send_log_entry_reflects_packet.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::net_sht_v::net_packet_bound")
(declare-fun lib!net_sht_v.net_packet_bound.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::net_sht_v::is_marshalable_data")
(declare-fun lib!net_sht_v.is_marshalable_data.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::net_sht_v::only_sent_marshalable_data")
(declare-fun lib!net_sht_v.only_sent_marshalable_data.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::net_sht_v::send_log_entries_reflect_packets")
(declare-fun lib!net_sht_v.send_log_entries_reflect_packets.? (Poly Poly) Bool)
...
(assert (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (self! Poly) (b! Poly) (f! Poly) (fuel% Fuel)) (! (=> (and (has_type self! (TYPE%vstd!seq.Seq. A&. A&)) (has_type b! B&) (has_type f! (TYPE%fun%2. B&. B& A&. A& B&. B&))) (= (vstd!seq_lib.impl&%0.rec%fold_left.? A&. A& B&. B& self! b! f! (succ fuel%)) (ite (= (vstd!seq.Seq.len.? A&. A& self!) 0) b! (%%apply%%0 (%Poly%fun%2. f!) (vstd!seq_lib.impl&%0.rec%fold_left.? A&. A& B&. B& (vstd!seq_lib.impl&%0.drop_last.? A&. A& self!) b! f! fuel%) (vstd!seq.Seq.last.? A&. A& self!))))) :pattern ((vstd!seq_lib.impl&%0.rec%fold_left.? A&. A& B&. B& self! b! f! (succ fuel%))) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly)) (! (= (req%lib!marshal_v.Marshalable.ghost_serialize. Self%&. Self%& self!) (=> %%global_location_label%%9 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& self!)))) :pattern ((req%lib!marshal_v.Marshalable.ghost_serialize. Self%&. Self%& self!)) )))
...
(set-info :comment ";; Function-Specs lib::marshal_v::Marshalable::serialize")
(declare-fun req%lib!marshal_v.Marshalable.serialize. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%10 Bool)
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (pre%data! Poly)) (! (= (req%lib!marshal_v.Marshalable.serialize. Self%&. Self%& self! pre%data!) (=> %%global_location_label%%10 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& self!)))) :pattern ((req%lib!marshal_v.Marshalable.serialize. Self%&. Self%& self! pre%data!)) )))
...
(set-info :comment ";; Function-Specs lib::marshal_v::Marshalable::deserialize")
...
(set-info :comment ";; Function-Specs lib::marshal_v::Marshalable::lemma_serialize_injective")
(declare-fun req%lib!marshal_v.Marshalable.lemma_serialize_injective. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%11 Bool)
(declare-const %%global_location_label%%12 Bool)
(declare-const %%global_location_label%%13 Bool)
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (other! Poly)) (! (= (req%lib!marshal_v.Marshalable.lemma_serialize_injective. Self%&. Self%& self! other!) (and (=> %%global_location_label%%11 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& self!))) (=> %%global_location_label%%12 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& other!))) (=> %%global_location_label%%13 (= (lib!marshal_v.Marshalable.ghost_serialize.? Self%&. Self%& self!) (lib!marshal_v.Marshalable.ghost_serialize.? Self%&. Self%& other!))))) :pattern ((req%lib!marshal_v.Marshalable.lemma_serialize_injective. Self%&. Self%& self! other!)) )))
...
(assert (forall ((pre%self! lib!io_t.NetClient.) (time_limit_s! Int)) (! (= (req%lib!io_t.impl&%7.receive. pre%self! time_limit_s!) (=> %%global_location_label%%14 (is-lib!io_t.State./Receiving_ (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. pre%self!))))) :pattern ((req%lib!io_t.impl&%7.receive. pre%self! time_limit_s!)) )))
...
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (acc$ Poly) (x$ Poly)) (! (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) acc$ x$) (I (Add (%I acc$) (vstd!seq.Seq.len.? %%hole%%2 %%hole%%3 (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$))))) :pattern ((%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) acc$ x$)))))
...
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (acc$ Poly) (x$ Poly)) (! (= (%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) acc$ x$) (vstd!seq.Seq.add.? %%hole%%2 %%hole%%3 acc$ (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$))) :pattern ((%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) acc$ x$)))))
...
(set-info :comment ";; Function-Axioms lib::net_sht_v::net_packet_is_abstractable")
(assert (fuel_bool_default fuel%lib!net_sht_v.net_packet_is_abstractable.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.net_packet_is_abstractable.) (forall ((net! Poly)) (! (= (lib!net_sht_v.net_packet_is_abstractable.? net!) true) :pattern ((lib!net_sht_v.net_packet_is_abstractable.? net!)) ))))
(set-info :comment ";; Function-Axioms lib::net_sht_v::net_event_is_abstractable")
(assert (fuel_bool_default fuel%lib!net_sht_v.net_event_is_abstractable.))
...
(assert (=> (fuel_bool fuel%lib!net_sht_v.net_event_is_abstractable.) (forall ((evt! Poly)) (! (= (lib!net_sht_v.net_event_is_abstractable.? evt!) (ite (is-lib!environment_t.LIoOp./Send_ (%Poly%lib!environment_t.LIoOp. evt!)) (let ((s$ (lib!environment_t.LIoOp./Send/s (%Poly%lib!environment_t.LIoOp. evt!)))) (lib!net_sht_v.net_packet_is_abstractable.? (Poly%lib!environment_t.LPacket. s$))) (ite (is-lib!environment_t.LIoOp./Receive_ (%Poly%lib!environment_t.LIoOp. evt!)) (let ((r$ (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. evt!)))) (lib!net_sht_v.net_packet_is_abstractable.? (Poly%lib!environment_t.LPacket. r$))) (=> (not (is-lib!environment_t.LIoOp./TimeoutReceive_ (%Poly%lib!environment_t.LIoOp. evt!))) (let ((t$ (lib!environment_t.LIoOp./ReadClock/t (%Poly%lib!environment_t.LIoOp. evt!)))) true))))) :pattern ((lib!net_sht_v.net_event_is_abstractable.? evt!)) ))))
(set-info :comment ";; Function-Specs lib::net_sht_v::sht_demarshal_data")
(declare-fun req%lib!net_sht_v.sht_demarshal_data. (Poly) Bool)
(declare-const %%global_location_label%%15 Bool)
(assert (forall ((data! Poly)) (! (= (req%lib!net_sht_v.sht_demarshal_data. data!) (=> %%global_location_label%%15 (exists ((v$ Poly)) (! (and (has_type v$ TYPE%lib!cmessage_v.CSingleMessage.) (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. v$)) (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CSingleMessage. v$) data!))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. v$)) :pattern ((lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CSingleMessage. v$)) )))) :pattern ((req%lib!net_sht_v.sht_demarshal_data. data!)) )))
(set-info :comment ";; Function-Axioms lib::net_sht_v::sht_demarshal_data")
(assert (fuel_bool_default fuel%lib!net_sht_v.sht_demarshal_data.))
(declare-fun %%choose%%0 (Type Dcr Type Dcr Type Poly Dcr Type Dcr Type) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Dcr) (%%hole%%9 Type)) (! (=> (exists ((v$1 Poly)) (! (and (has_type v$1 %%hole%%0) (and (%B (lib!marshal_v.Marshalable.is_marshalable.? %%hole%%1 %%hole%%2 v$1)) (= (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%3 %%hole%%4 v$1) %%hole%%5))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? %%hole%%6 %%hole%%7 v$1)) :pattern ((lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%8 %%hole%%9 v$1)) )) (exists ((v$1 Poly)) (! (and (and (has_type v$1 %%hole%%0) (and (%B (lib!marshal_v.Marshalable.is_marshalable.? %%hole%%1 %%hole%%2 v$1)) (= (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%3 %%hole%%4 v$1) %%hole%%5))) (= (%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) v$1)) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? %%hole%%6 %%hole%%7 v$1)) :pattern ((lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%8 %%hole%%9 v$1))))) :pattern ((%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
(assert (=> (fuel_bool fuel%lib!net_sht_v.sht_demarshal_data.) (forall ((data! Poly)) (! (= (lib!net_sht_v.sht_demarshal_data.? data!) (let ((v$ (%Poly%lib!cmessage_v.CSingleMessage. (as_type (%%choose%%0 TYPE%lib!cmessage_v.CSingleMessage. $ TYPE%lib!cmessage_v.CSingleMessage. $ TYPE%lib!cmessage_v.CSingleMessage. data! $ TYPE%lib!cmessage_v.CSingleMessage. $ TYPE%lib!cmessage_v.CSingleMessage.) TYPE%lib!cmessage_v.CSingleMessage.)))) v$)) :pattern ((lib!net_sht_v.sht_demarshal_data.? data!)) ))))
(assert (forall ((data! Poly)) (! (=> (has_type data! (TYPE%vstd!seq.Seq. $ (UINT 8))) (has_type (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? data!)) TYPE%lib!cmessage_v.CSingleMessage.)) :pattern ((lib!net_sht_v.sht_demarshal_data.? data!)) )))
(set-info :comment ";; Function-Specs lib::net_sht_v::abstractify_net_packet_to_lsht_packet")
(declare-fun req%lib!net_sht_v.abstractify_net_packet_to_lsht_packet. (Poly) Bool)
(declare-const %%global_location_label%%16 Bool)
(assert (forall ((net! Poly)) (! (= (req%lib!net_sht_v.abstractify_net_packet_to_lsht_packet. net!) (=> %%global_location_label%%16 (lib!net_sht_v.net_packet_is_abstractable.? net!))) :pattern ((req%lib!net_sht_v.abstractify_net_packet_to_lsht_packet. net!)) )))
(set-info :comment ";; Function-Axioms lib::net_sht_v::abstractify_net_packet_to_lsht_packet")
(assert (fuel_bool_default fuel%lib!net_sht_v.abstractify_net_packet_to_lsht_packet.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.abstractify_net_packet_to_lsht_packet.) (forall ((net! Poly)) (! (= (lib!net_sht_v.abstractify_net_packet_to_lsht_packet.? net!) (lib!environment_t.LPacket./LPacket (lib!environment_t.LPacket./LPacket/dst (%Poly%lib!environment_t.LPacket. net!)) (lib!environment_t.LPacket./LPacket/src (%Poly%lib!environment_t.LPacket. net!)) (Poly%lib!single_message_t.SingleMessage. (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (lib!environment_t.LPacket./LPacket/msg (%Poly%lib!environment_t.LPacket. net!)))))))) :pattern ((lib!net_sht_v.abstractify_net_packet_to_lsht_packet.? net!)) ))))
(assert (forall ((net! Poly)) (! (=> (has_type net! (TYPE%lib!environment_t.LPacket. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (has_type (Poly%lib!environment_t.LPacket. (lib!net_sht_v.abstractify_net_packet_to_lsht_packet.? net!)) (TYPE%lib!environment_t.LPacket. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)))) :pattern ((lib!net_sht_v.abstractify_net_packet_to_lsht_packet.? net!)) )))
(set-info :comment ";; Function-Specs lib::net_sht_v::abstractify_net_event_to_lsht_io")
(declare-fun req%lib!net_sht_v.abstractify_net_event_to_lsht_io. (Poly) Bool)
(declare-const %%global_location_label%%17 Bool)
(assert (forall ((evt! Poly)) (! (= (req%lib!net_sht_v.abstractify_net_event_to_lsht_io. evt!) (=> %%global_location_label%%17 (lib!net_sht_v.net_event_is_abstractable.? evt!))) :pattern ((req%lib!net_sht_v.abstractify_net_event_to_lsht_io. evt!)) )))
(set-info :comment ";; Function-Axioms lib::net_sht_v::abstractify_net_event_to_lsht_io")
(assert (fuel_bool_default fuel%lib!net_sht_v.abstractify_net_event_to_lsht_io.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.abstractify_net_event_to_lsht_io.) (forall ((evt! Poly)) (! (= (lib!net_sht_v.abstractify_net_event_to_lsht_io.? evt!) (ite (is-lib!environment_t.LIoOp./Send_ (%Poly%lib!environment_t.LIoOp. evt!)) (let ((s$ (lib!environment_t.LIoOp./Send/s (%Poly%lib!environment_t.LIoOp. evt!)))) (lib!environment_t.LIoOp./Send (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. (lib!net_sht_v.abstractify_net_packet_to_lsht_packet.? (Poly%lib!environment_t.LPacket. s$)))))) (ite (is-lib!environment_t.LIoOp./Receive_ (%Poly%lib!environment_t.LIoOp. evt!)) (let ((r$ (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. evt!)))) (lib!environment_t.LIoOp./Receive (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. (lib!net_sht_v.abstractify_net_packet_to_lsht_packet.? (Poly%lib!environment_t.LPacket. r$)))))) (ite (is-lib!environment_t.LIoOp./TimeoutReceive_ (%Poly%lib!environment_t.LIoOp. evt!)) lib!environment_t.LIoOp./TimeoutReceive (let ((t$ (lib!environment_t.LIoOp./ReadClock/t (%Poly%lib!environment_t.LIoOp. evt!)))) (lib!environment_t.LIoOp./ReadClock (%I (I t$)))))))) :pattern ((lib!net_sht_v.abstractify_net_event_to_lsht_io.? evt!)) ))))
(assert (forall ((evt! Poly)) (! (=> (has_type evt! (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (has_type (Poly%lib!environment_t.LIoOp. (lib!net_sht_v.abstractify_net_event_to_lsht_io.? evt!)) (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)))) :pattern ((lib!net_sht_v.abstractify_net_event_to_lsht_io.? evt!)) )))
(set-info :comment ";; Function-Axioms lib::net_sht_v::net_event_log_is_abstractable")
(assert (fuel_bool_default fuel%lib!net_sht_v.net_event_log_is_abstractable.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.net_event_log_is_abstractable.) (forall ((rawlog! Poly)) (! (= (lib!net_sht_v.net_event_log_is_abstractable.? rawlog!) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) rawlog!))) (lib!net_sht_v.net_event_is_abstractable.? (vstd!seq.Seq.index.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) rawlog! i$)))) :pattern ((lib!net_sht_v.net_event_is_abstractable.? (vstd!seq.Seq.index.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) rawlog! i$))) ))) :pattern ((lib!net_sht_v.net_event_log_is_abstractable.? rawlog!)) ))))
...
(set-info :comment ";; Function-Axioms lib::net_sht_v::ReceiveResult::arrow_cpacket")
(assert (fuel_bool_default fuel%lib!net_sht_v.impl&%0.arrow_cpacket.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.impl&%0.arrow_cpacket.) (forall ((self! Poly)) (! (= (lib!net_sht_v.impl&%0.arrow_cpacket.? self!) (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. self!))) :pattern ((lib!net_sht_v.impl&%0.arrow_cpacket.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!net_sht_v.ReceiveResult.) (has_type (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.impl&%0.arrow_cpacket.? self!)) TYPE%lib!cmessage_v.CPacket.)) :pattern ((lib!net_sht_v.impl&%0.arrow_cpacket.? self!)) )))
(set-info :comment ";; Function-Axioms lib::net_sht_v::ReceiveResult::arrow_Packet_cpacket")
(assert (fuel_bool_default fuel%lib!net_sht_v.impl&%0.arrow_Packet_cpacket.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.impl&%0.arrow_Packet_cpacket.) (forall ((self! Poly)) (! (= (lib!net_sht_v.impl&%0.arrow_Packet_cpacket.? self!) (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. self!))) :pattern ((lib!net_sht_v.impl&%0.arrow_Packet_cpacket.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!net_sht_v.ReceiveResult.) (has_type (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.impl&%0.arrow_Packet_cpacket.? self!)) TYPE%lib!cmessage_v.CPacket.)) :pattern ((lib!net_sht_v.impl&%0.arrow_Packet_cpacket.? self!)) )))
(set-info :comment ";; Function-Specs lib::net_sht_v::abstractify_net_packet_to_sht_packet")
(declare-fun req%lib!net_sht_v.abstractify_net_packet_to_sht_packet. (Poly) Bool)
(declare-const %%global_location_label%%18 Bool)
(assert (forall ((net! Poly)) (! (= (req%lib!net_sht_v.abstractify_net_packet_to_sht_packet. net!) (=> %%global_location_label%%18 (lib!net_sht_v.net_packet_is_abstractable.? net!))) :pattern ((req%lib!net_sht_v.abstractify_net_packet_to_sht_packet. net!)) )))
(set-info :comment ";; Function-Axioms lib::net_sht_v::abstractify_net_packet_to_sht_packet")
(assert (fuel_bool_default fuel%lib!net_sht_v.abstractify_net_packet_to_sht_packet.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.abstractify_net_packet_to_sht_packet.) (forall ((net! Poly)) (! (= (lib!net_sht_v.abstractify_net_packet_to_sht_packet.? net!) (let ((lp$ (lib!net_sht_v.abstractify_net_packet_to_lsht_packet.? net!))) (lib!network_t.Packet./Packet (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!environment_t.LPacket./LPacket/dst (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. lp$)))) (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!environment_t.LPacket./LPacket/src (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. lp$)))) (%Poly%lib!single_message_t.SingleMessage. (lib!environment_t.LPacket./LPacket/msg (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. lp$))))))) :pattern ((lib!net_sht_v.abstractify_net_packet_to_sht_packet.? net!)) ))))
(assert (forall ((net! Poly)) (! (=> (has_type net! (TYPE%lib!environment_t.LPacket. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (has_type (Poly%lib!network_t.Packet. (lib!net_sht_v.abstractify_net_packet_to_sht_packet.? net!)) TYPE%lib!network_t.Packet.)) :pattern ((lib!net_sht_v.abstractify_net_packet_to_sht_packet.? net!)) )))
...
(set-info :comment ";; Function-Axioms lib::net_sht_v::send_log_entry_reflects_packet")
(assert (fuel_bool_default fuel%lib!net_sht_v.send_log_entry_reflects_packet.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.send_log_entry_reflects_packet.) (forall ((event! Poly) (cpacket! Poly)) (! (= (lib!net_sht_v.send_log_entry_reflects_packet.? event! cpacket!) (and (and (is-lib!environment_t.LIoOp./Send_ (%Poly%lib!environment_t.LIoOp. event!)) (lib!cmessage_v.impl&%3.abstractable.? cpacket!)) (= (lib!cmessage_v.impl&%3.view.? cpacket!) (lib!net_sht_v.abstractify_net_packet_to_sht_packet.? (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Send/s (%Poly%lib!environment_t.LIoOp. event!))))))) :pattern ((lib!net_sht_v.send_log_entry_reflects_packet.? event! cpacket!)) ))))
(set-info :comment ";; Function-Axioms lib::net_sht_v::net_packet_bound")
(assert (fuel_bool_default fuel%lib!net_sht_v.net_packet_bound.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.net_packet_bound.) (forall ((data! Poly)) (! (= (lib!net_sht_v.net_packet_bound.? data!) (<= (vstd!seq.Seq.len.? $ (UINT 8) data!) 18446744073709551615)) :pattern ((lib!net_sht_v.net_packet_bound.? data!)) ))))
(set-info :comment ";; Function-Specs lib::net_sht_v::is_marshalable_data")
(declare-fun req%lib!net_sht_v.is_marshalable_data. (Poly) Bool)
(declare-const %%global_location_label%%19 Bool)
(assert (forall ((event! Poly)) (! (= (req%lib!net_sht_v.is_marshalable_data. event!) (=> %%global_location_label%%19 (is-lib!environment_t.LIoOp./Send_ (%Poly%lib!environment_t.LIoOp. event!)))) :pattern ((req%lib!net_sht_v.is_marshalable_data. event!)) )))
(set-info :comment ";; Function-Axioms lib::net_sht_v::is_marshalable_data")
(assert (fuel_bool_default fuel%lib!net_sht_v.is_marshalable_data.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.is_marshalable_data.) (forall ((event! Poly)) (! (= (lib!net_sht_v.is_marshalable_data.? event!) (and (lib!net_sht_v.net_packet_bound.? (lib!environment_t.LPacket./LPacket/msg (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Send/s (%Poly%lib!environment_t.LIoOp. event!)))))) (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (lib!environment_t.LPacket./LPacket/msg (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Send/s (%Poly%lib!environment_t.LIoOp. event!))))))))))) :pattern ((lib!net_sht_v.is_marshalable_data.? event!)) ))))
(set-info :comment ";; Function-Axioms lib::net_sht_v::only_sent_marshalable_data")
(assert (fuel_bool_default fuel%lib!net_sht_v.only_sent_marshalable_data.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.only_sent_marshalable_data.) (forall ((rawlog! Poly)) (! (= (lib!net_sht_v.only_sent_marshalable_data.? rawlog!) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) rawlog!))) (is-lib!environment_t.LIoOp./Send_ (%Poly%lib!environment_t.LIoOp. (vstd!seq.Seq.index.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) rawlog! i$)))) (lib!net_sht_v.is_marshalable_data.? (vstd!seq.Seq.index.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) rawlog! i$)))) :pattern ((lib!net_sht_v.is_marshalable_data.? (vstd!seq.Seq.index.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) rawlog! i$))) ))) :pattern ((lib!net_sht_v.only_sent_marshalable_data.? rawlog!)) ))))
(set-info :comment ";; Function-Axioms lib::net_sht_v::send_log_entries_reflect_packets")
(assert (fuel_bool_default fuel%lib!net_sht_v.send_log_entries_reflect_packets.))
(assert (=> (fuel_bool fuel%lib!net_sht_v.send_log_entries_reflect_packets.) (forall ((net_event_log! Poly) (cpackets! Poly)) (! (= (lib!net_sht_v.send_log_entries_reflect_packets.? net_event_log! cpackets!) (and (= (vstd!seq.Seq.len.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) net_event_log!) (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CPacket. cpackets!)) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CPacket. cpackets!))) (lib!net_sht_v.send_log_entry_reflects_packet.? (vstd!seq.Seq.index.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) net_event_log! i$) (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CPacket. cpackets! i$)))) :pattern ((lib!net_sht_v.send_log_entry_reflects_packet.? (vstd!seq.Seq.index.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) net_event_log! i$) (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CPacket. cpackets! i$))) )))) :pattern ((lib!net_sht_v.send_log_entries_reflect_packets.? net_event_log! cpackets!)) ))))
...
(set-info :comment ";; Function-Specs lib::io_t::NetClient::send")
(declare-fun req%lib!io_t.impl&%7.send. (lib!io_t.NetClient. lib!io_t.EndPoint. alloc!vec.Vec<u8./allocator_global%.>.) Bool)
(declare-const %%global_location_label%%20 Bool)
(assert (forall ((pre%self! lib!io_t.NetClient.) (recipient! lib!io_t.EndPoint.) (message! alloc!vec.Vec<u8./allocator_global%.>.)) (! (= (req%lib!io_t.impl&%7.send. pre%self! recipient! message!) (=> %%global_location_label%%20 (not (is-lib!io_t.State./Error_ (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. pre%self!)))))) :pattern ((req%lib!io_t.impl&%7.send. pre%self! recipient! message!)) )))
...
(assert (forall ((pre%self! lib!io_t.NetClient.) (self! lib!io_t.NetClient.) (recipient! lib!io_t.EndPoint.) (message! alloc!vec.Vec<u8./allocator_global%.>.) (result! core!result.Result.)) (! (= (ens%lib!io_t.impl&%7.send. pre%self! self! recipient! message! result!) (and (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ TYPE%tuple%0. $ TYPE%lib!io_t.IronfleetIOError.)) (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. self!)) (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. pre%self!))) (= (is-lib!io_t.State./Error_ (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. self!))) (is-core!result.Result./Err_ result!)) (=> (is-core!result.Result./Ok_ result!) (is-lib!io_t.State./Sending_ (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. self!)))) (=> (is-core!result.Result./Ok_ result!) (= (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. self!)) (%Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (vstd!seq.Seq.add.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. pre%self!))) (vstd!seq.Seq.push.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (vstd!seq.Seq.empty.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (Poly%lib!environment_t.LIoOp. (lib!environment_t.LIoOp./Send (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. (lib!environment_t.LPacket./LPacket (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. recipient!))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. self!))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. message!)))))))))))))) :pattern ((ens%lib!io_t.impl&%7.send. pre%self! self! recipient! message! result!)) )))
(set-info :comment ";; Function-Specs lib::net_sht_v::sht_marshal_data_injective")
(declare-fun req%lib!net_sht_v.sht_marshal_data_injective. (lib!cmessage_v.CSingleMessage. lib!cmessage_v.CSingleMessage.) Bool)
(declare-const %%global_location_label%%21 Bool)
(declare-const %%global_location_label%%22 Bool)
(declare-const %%global_location_label%%23 Bool)
(assert (forall ((a! lib!cmessage_v.CSingleMessage.) (b! lib!cmessage_v.CSingleMessage.)) (! (= (req%lib!net_sht_v.sht_marshal_data_injective. a! b!) (and (=> %%global_location_label%%21 (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. a!)))) (=> %%global_location_label%%22 (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. b!)))) (=> %%global_location_label%%23 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. a!)) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. b!)))))) :pattern ((req%lib!net_sht_v.sht_marshal_data_injective. a! b!)) )))
(declare-fun ens%lib!net_sht_v.sht_marshal_data_injective. (lib!cmessage_v.CSingleMessage. lib!cmessage_v.CSingleMessage.) Bool)
(assert (forall ((a! lib!cmessage_v.CSingleMessage.) (b! lib!cmessage_v.CSingleMessage.)) (! (= (ens%lib!net_sht_v.sht_marshal_data_injective. a! b!) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. a!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. b!)))) :pattern ((ens%lib!net_sht_v.sht_marshal_data_injective. a! b!)) )))
(set-info :comment ";; Function-Specs lib::net_sht_v::send_packet")
(declare-fun req%lib!net_sht_v.send_packet. (lib!cmessage_v.CPacket. lib!io_t.NetClient.) Bool)
(declare-const %%global_location_label%%24 Bool)
(declare-const %%global_location_label%%25 Bool)
(declare-const %%global_location_label%%26 Bool)
(assert (forall ((cpacket! lib!cmessage_v.CPacket.) (pre%netc! lib!io_t.NetClient.)) (! (= (req%lib!net_sht_v.send_packet. cpacket! pre%netc!) (and (=> %%global_location_label%%24 (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. pre%netc!))) (=> %%global_location_label%%25 (lib!net_sht_v.outbound_packet_is_valid.? (Poly%lib!cmessage_v.CPacket. cpacket!))) (=> %%global_location_label%%26 (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. (lib!cmessage_v.CPacket./CPacket/src (%Poly%lib!cmessage_v.CPacket. (Poly%lib!cmessage_v.CPacket. cpacket!))))) (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. pre%netc!)))))) :pattern ((req%lib!net_sht_v.send_packet. cpacket! pre%netc!)) )))
(declare-fun ens%lib!net_sht_v.send_packet. (lib!cmessage_v.CPacket. lib!io_t.NetClient. lib!io_t.NetClient. tuple%2.) Bool)
(assert (forall ((cpacket! lib!cmessage_v.CPacket.) (pre%netc! lib!io_t.NetClient.) (netc! lib!io_t.NetClient.) (rc! tuple%2.)) (! (= (ens%lib!net_sht_v.send_packet. cpacket! pre%netc! netc! rc!) (and (has_type (Poly%tuple%2. rc!) (TYPE%tuple%2. $ BOOL (GHOST $) (TYPE%core!option.Option. $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))))) (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. netc!)) (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. pre%netc!))) (let ((ok$ (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. rc!)))))) (let ((verus_tmp_net_event$ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. rc!)))))) (let ((net_event$ verus_tmp_net_event$)) (and (and (and (= (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. netc!)) ok$) (=> ok$ (is-core!option.Option./Some_ net_event$))) (=> ok$ (= (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. netc!)) (%Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (vstd!seq.Seq.add.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. pre%netc!))) (vstd!seq.Seq.push.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (vstd!seq.Seq.empty.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. net_event$))))))))) (=> ok$ (and (and (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. rc!))))) (lib!net_sht_v.send_log_entry_reflects_packet.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. net_event$))) (Poly%lib!cmessage_v.CPacket. cpacket!))) (lib!net_sht_v.is_marshalable_data.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. net_event$)))))))))))) :pattern ((ens%lib!net_sht_v.send_packet. cpacket! pre%netc! netc! rc!)) )))
(set-info :comment ";; Function-Def lib::net_sht_v::send_packet")
(set-info :comment ";; ironsht/src/net_sht_v.rs:278:1: 278:100 (#0)")
(set-info :comment ";; Function-Specs lib::net_sht_v::send_packet_seq")
(declare-fun req%lib!net_sht_v.send_packet_seq. (alloc!vec.Vec<lib!cmessage_v.CPacket./allocator_global%.>. lib!io_t.NetClient.) Bool)
(declare-const %%global_location_label%%27 Bool)
(declare-const %%global_location_label%%28 Bool)
(declare-const %%global_location_label%%29 Bool)
(assert (forall ((cpackets! alloc!vec.Vec<lib!cmessage_v.CPacket./allocator_global%.>.) (pre%netc! lib!io_t.NetClient.)) (! (= (req%lib!net_sht_v.send_packet_seq. cpackets! pre%netc!) (and (=> %%global_location_label%%27 (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. pre%netc!))) (=> %%global_location_label%%28 (lib!net_sht_v.outbound_packet_seq_is_valid.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CPacket. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CPacket./allocator_global%.>. cpackets!)))) (=> %%global_location_label%%29 (lib!net_sht_v.outbound_packet_seq_has_correct_srcs.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CPacket. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CPacket./allocator_global%.>. cpackets!)) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. pre%netc!))))))) :pattern ((req%lib!net_sht_v.send_packet_seq. cpackets! pre%netc!)) )))
(declare-fun ens%lib!net_sht_v.send_packet_seq. (alloc!vec.Vec<lib!cmessage_v.CPacket./allocator_global%.>. lib!io_t.NetClient. lib!io_t.NetClient. tuple%2.) Bool)
(assert (forall ((cpackets! alloc!vec.Vec<lib!cmessage_v.CPacket./allocator_global%.>.) (pre%netc! lib!io_t.NetClient.) (netc! lib!io_t.NetClient.) (rc! tuple%2.)) (! (= (ens%lib!net_sht_v.send_packet_seq. cpackets! pre%netc! netc! rc!) (and (has_type (Poly%tuple%2. rc!) (TYPE%tuple%2. $ BOOL (GHOST $) (TYPE%vstd!seq.Seq. $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))))) (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. netc!)) (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. pre%netc!))) (let ((ok$ (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. rc!)))))) (let ((verus_tmp_net_events$ (%Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. rc!)))))) (let ((net_events$ verus_tmp_net_events$)) (and (and (and (and (= (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. netc!)) ok$) (=> ok$ (= (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. netc!)) (%Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (vstd!seq.Seq.add.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. pre%netc!))) (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. net_events$)))))) (=> ok$ (lib!net_sht_v.send_log_entries_reflect_packets.? (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. net_events$) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CPacket. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CPacket./allocator_global%.>. cpackets!))))) (=> ok$ (lib!net_sht_v.only_sent_marshalable_data.? (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. net_events$)))) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. net_events$)))) (is-lib!environment_t.LIoOp./Send_ (%Poly%lib!environment_t.LIoOp. (vstd!seq.Seq.index.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. net_events$) i$))))) :pattern ((vstd!seq.Seq.index.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. net_events$) i$)) )))))))) :pattern ((ens%lib!net_sht_v.send_packet_seq. cpackets! pre%netc! netc! rc!)) )))
(set-info :comment ";; Function-Specs lib::net_sht_v::sht_demarshall_data_method")
(declare-fun ens%lib!net_sht_v.sht_demarshall_data_method. (alloc!vec.Vec<u8./allocator_global%.>. lib!cmessage_v.CSingleMessage.) Bool)
(assert (forall ((buffer! alloc!vec.Vec<u8./allocator_global%.>.) (out! lib!cmessage_v.CSingleMessage.)) (! (= (ens%lib!net_sht_v.sht_demarshall_data_method. buffer! out!) (and (has_type (Poly%lib!cmessage_v.CSingleMessage. out!) TYPE%lib!cmessage_v.CSingleMessage.) (=> (not (is-lib!cmessage_v.CSingleMessage./InvalidMessage_ out!)) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. out!))) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. out!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!))))))) (lib!cmessage_v.impl&%2.abstractable.? (Poly%lib!cmessage_v.CSingleMessage. out!)))))) :pattern ((ens%lib!net_sht_v.sht_demarshall_data_method. buffer! out!)) )))
(set-info :comment ";; Function-Def lib::net_sht_v::sht_demarshall_data_method")
(set-info :comment ";; ironsht/src/net_sht_v.rs:132:1: 132:76 (#0)")
(set-info :comment ";; Function-Specs lib::net_sht_v::receive_with_demarshal")
(declare-fun req%lib!net_sht_v.receive_with_demarshal. (lib!io_t.NetClient. lib!io_t.EndPoint.) Bool)
(declare-const %%global_location_label%%30 Bool)
(declare-const %%global_location_label%%31 Bool)
(declare-const %%global_location_label%%32 Bool)
(declare-const %%global_location_label%%33 Bool)
(assert (forall ((pre%netc! lib!io_t.NetClient.) (local_addr! lib!io_t.EndPoint.)) (! (= (req%lib!net_sht_v.receive_with_demarshal. pre%netc! local_addr!) (and (=> %%global_location_label%%30 (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. pre%netc!))) (=> %%global_location_label%%31 (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. pre%netc!)) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. local_addr!)))) (=> %%global_location_label%%32 (is-lib!io_t.State./Receiving_ (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. pre%netc!)))) (=> %%global_location_label%%33 (lib!abstract_end_point_t.impl&%0.valid_physical_address.? (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. local_addr!))))))) :pattern ((req%lib!net_sht_v.receive_with_demarshal. pre%netc! local_addr!)) )))
(declare-fun ens%lib!net_sht_v.receive_with_demarshal. (lib!io_t.NetClient. lib!io_t.NetClient. lib!io_t.EndPoint. tuple%2.) Bool)
(define-fun is-lib!net_sht_v.ReceiveResult./Fail_ ((c lib!net_sht_v.ReceiveResult.)) Bool ((_ is lib!net_sht_v.ReceiveResult./Fail) c))
(define-fun is-lib!net_sht_v.ReceiveResult./Timeout_ ((c lib!net_sht_v.ReceiveResult.)) Bool ((_ is lib!net_sht_v.ReceiveResult./Timeout) c))
(define-fun is-lib!net_sht_v.ReceiveResult./Packet_ ((c lib!net_sht_v.ReceiveResult.)) Bool ((_ is lib!net_sht_v.ReceiveResult./Packet) c))
(define-fun is-lib!single_message_t.SingleMessage./InvalidMessage_ ((c lib!single_message_t.SingleMessage.)) Bool ((_ is lib!single_message_t.SingleMessage./InvalidMessage) c))
(assert (forall ((pre%netc! lib!io_t.NetClient.) (netc! lib!io_t.NetClient.) (local_addr! lib!io_t.EndPoint.) (rc! tuple%2.)) (! (= (ens%lib!net_sht_v.receive_with_demarshal. pre%netc! netc! local_addr! rc!) (and (has_type (Poly%tuple%2. rc!) (TYPE%tuple%2. $ TYPE%lib!net_sht_v.ReceiveResult. (GHOST $) (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))))) (let ((rr$ (%Poly%lib!net_sht_v.ReceiveResult. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. rc!)))))) (let ((net_event$ (%Poly%lib!environment_t.LIoOp. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. rc!)))))) (and (and (and (and (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. netc!)) (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. pre%netc!))) (= (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. netc!)) (not (is-lib!net_sht_v.ReceiveResult./Fail_ rr$)))) (=> (not (is-lib!net_sht_v.ReceiveResult./Fail_ rr$)) (and (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. netc!)) (= (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. netc!)) (%Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (vstd!seq.Seq.add.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. pre%netc!))) (vstd!seq.Seq.push.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (vstd!seq.Seq.empty.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (Poly%lib!environment_t.LIoOp. net_event$)))))))) (=> (is-lib!net_sht_v.ReceiveResult./Timeout_ rr$) (is-lib!environment_t.LIoOp./TimeoutReceive_ net_event$))) (=> (is-lib!net_sht_v.ReceiveResult./Packet_ rr$) (and (and (and (is-lib!environment_t.LIoOp./Receive_ net_event$) (lib!cmessage_v.impl&%3.abstractable.? (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$)))))) (=> (not (is-lib!single_message_t.SingleMessage./InvalidMessage_ (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. (Poly%lib!network_t.Packet. (lib!cmessage_v.impl&%3.view.? (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$)))))))))) (and (= (lib!cmessage_v.impl&%3.view.? (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$))))) (lib!net_sht_v.abstractify_net_packet_to_sht_packet.? (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. (Poly%lib!environment_t.LIoOp. net_event$)))))) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!cmessage_v.CPacket./CPacket/msg (%Poly%lib!cmessage_v.CPacket. (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$)))))))) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (lib!environment_t.LPacket./LPacket/msg (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. (Poly%lib!environment_t.LIoOp. net_event$))))))))))))) (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. (lib!cmessage_v.CPacket./CPacket/dst (%Poly%lib!cmessage_v.CPacket. (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$)))))))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. local_addr!)))))))))) :pattern ((ens%lib!net_sht_v.receive_with_demarshal. pre%netc! netc! local_addr! rc!)) )))
(set-info :comment ";; Function-Def lib::net_sht_v::receive_with_demarshal")
(set-info :comment ";; ironsht/src/net_sht_v.rs:172:1: 172:116 (#0)")
(declare-const rc! tuple%2.)
(declare-const netc!@0 lib!io_t.NetClient.)
(declare-const local_addr! lib!io_t.EndPoint.)
(declare-const tmp%1 Bool)
(declare-const tmp%2 lib!io_t.EndPoint.)
(declare-const verus_tmp_net_event@ lib!environment_t.LIoOp.)
...
(declare-const lp@ lib!environment_t.LPacket.)
(declare-const p@ lib!network_t.Packet.)
(declare-const gsinglemessage@ lib!cmessage_v.CSingleMessage.)
(declare-const csinglemessage@ lib!cmessage_v.CSingleMessage.)
(declare-const src_ep@ lib!io_t.EndPoint.)
(declare-const cpacket@ lib!cmessage_v.CPacket.)
(declare-const verus_tmp@0 lib!environment_t.LIoOp.)
(declare-const net_event@0 lib!environment_t.LIoOp.)
(declare-const sender@ lib!io_t.EndPoint.)
...
(declare-const netr@ lib!io_t.NetcReceiveResult.)
(assert fuel_defaults)
(assert (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. netc!@0)))
(assert (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. netc!@0)) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. local_addr!))))
(assert (is-lib!io_t.State./Receiving_ (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. netc!@0))))
(assert (lib!abstract_end_point_t.impl&%0.valid_physical_address.? (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. local_addr!)))))
(declare-const netc!@1 lib!io_t.NetClient.)
(declare-const verus_tmp@1 lib!environment_t.LIoOp.)
(declare-const net_event@1 lib!environment_t.LIoOp.)
...
(define-fun is-lib!io_t.NetcReceiveResult./Error_ ((c lib!io_t.NetcReceiveResult.)) Bool ((_ is lib!io_t.NetcReceiveResult./Error) c))
(assert (not (=> (= timeout@ 0) (and (=> %%location_label%%0 (req%lib!io_t.impl&%7.receive. netc!@0 timeout@)) (=> (ens%lib!io_t.impl&%7.receive. netc!@0 netc!@1 timeout@ netr@) (or (and (=> (is-lib!io_t.NetcReceiveResult./Error_ netr@) (=> (= tmp%17 (let ((dummy$ lib!environment_t.LIoOp./TimeoutReceive)) (tuple%2./tuple%2 (Poly%lib!net_sht_v.ReceiveResult. lib!net_sht_v.ReceiveResult./Fail) (Poly%lib!environment_t.LIoOp. dummy$)))) (=> (= verus_tmp@1 verus_tmp@0) (=> (= net_event@1 net_event@0) %%switch_label%%0)))) (=> (not (is-lib!io_t.NetcReceiveResult./Error_ netr@)) (or (and (=> (is-lib!io_t.NetcReceiveResult./TimedOut_ netr@) (=> (= tmp%16 (tuple%2./tuple%2 (Poly%lib!net_sht_v.ReceiveResult. lib!net_sht_v.ReceiveResult./Timeout) (Poly%lib!environment_t.LIoOp. lib!environment_t.LIoOp./TimeoutReceive))) (=> (= verus_tmp@1 verus_tmp@0) (=> (= net_event@1 net_event@0) %%switch_label%%1)))) (=> (not (is-lib!io_t.NetcReceiveResult./TimedOut_ netr@)) (=> (= sender@ (lib!io_t.NetcReceiveResult./Received/sender (%Poly%lib!io_t.NetcReceiveResult. (Poly%lib!io_t.NetcReceiveResult. netr@)))) (=> (= message@ (lib!io_t.NetcReceiveResult./Received/message (%Poly%lib!io_t.NetcReceiveResult. (Poly%lib!io_t.NetcReceiveResult. netr@)))) (=> (ens%lib!net_sht_v.sht_demarshall_data_method. message@ csinglemessage@) (=> (= tmp%1 (=> (is-lib!cmessage_v.CSingleMessage./Message_ csinglemessage@) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. csinglemessage@)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. message@)))))))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= src_ep@ sender@) (=> (ens%lib!io_t.impl&%4.clone_up_to_view. local_addr! tmp%2) (=> (= cpacket@ (lib!cmessage_v.CPacket./CPacket (%Poly%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. tmp%2)) (%Poly%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. src_ep@)) (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. csinglemessage@)))) (=> (= verus_tmp@1 (lib!environment_t.LIoOp./Receive (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. (lib!environment_t.LPacket./LPacket (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. local_addr!))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src_ep@))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. message@))))))) (=> (= verus_tmp_net_event@ verus_tmp@1) (=> (= net_event@1 verus_tmp_net_event@) (=> (= tmp%3 (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. (lib!cmessage_v.CPacket./CPacket/dst (%Poly%lib!cmessage_v.CPacket. (Poly%lib!cmessage_v.CPacket. cpacket@))))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. local_addr!)))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (lib!abstract_end_point_t.impl&%0.valid_physical_address.? (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. (lib!cmessage_v.CPacket./CPacket/src (%Poly%lib!cmessage_v.CPacket. (Poly%lib!cmessage_v.CPacket. cpacket@)))))))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (lib!cmessage_v.impl&%3.abstractable.? (Poly%lib!cmessage_v.CPacket. cpacket@))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= gsinglemessage@ csinglemessage@) (or (and (=> (not (is-lib!cmessage_v.CSingleMessage./InvalidMessage_ gsinglemessage@)) (=> (= lp@ (lib!environment_t.LPacket./LPacket (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. local_addr!))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src_ep@))) (Poly%lib!single_message_t.SingleMessage. (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. message@)))))))) (=> (= tmp%6 (= lp@ (lib!net_sht_v.abstractify_net_packet_to_lsht_packet.? (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. (Poly%lib!environment_t.LIoOp. net_event@1))))))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> (= p@ (lib!network_t.Packet./Packet (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!environment_t.LPacket./LPacket/dst (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. lp@)))) (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!environment_t.LPacket./LPacket/src (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. lp@)))) (%Poly%lib!single_message_t.SingleMessage. (lib!environment_t.LPacket./LPacket/msg (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. lp@)))))) (=> (= tmp%7 (= p@ (lib!net_sht_v.abstractify_net_packet_to_sht_packet.? (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. (Poly%lib!environment_t.LIoOp. net_event@1))))))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> (= tmp%8 (not (is-lib!cmessage_v.CSingleMessage./InvalidMessage_ gsinglemessage@))) (and (=> %%location_label%%7 tmp%8) (=> tmp%8 (=> (= tmp%9 (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. gsinglemessage@)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. message@))))))) (and (=> %%location_label%%8 tmp%9) (=> tmp%9 (=> (= tmp%10 (ext_eq false TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/dst (%Poly%lib!network_t.Packet. (Poly%lib!network_t.Packet. (lib!cmessage_v.impl&%3.view.? (Poly%lib!cmessage_v.CPacket. cpacket@)))))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/dst (%Poly%lib!network_t.Packet. (Poly%lib!network_t.Packet. p@)))))) (and (=> %%location_label%%9 tmp%10) (=> tmp%10 (=> (= tmp%11 (ext_eq false TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. (Poly%lib!network_t.Packet. (lib!cmessage_v.impl&%3.view.? (Poly%lib!cmessage_v.CPacket. cpacket@)))))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. (Poly%lib!network_t.Packet. p@)))))) (and (=> %%location_label%%10 tmp%11) (=> tmp%11 (=> (= tmp%12 (ext_eq false (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. (Poly%lib!network_t.Packet. (lib!cmessage_v.impl&%3.view.? (Poly%lib!cmessage_v.CPacket. cpacket@)))))) (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. (Poly%lib!network_t.Packet. p@)))))) (and (=> %%location_label%%11 tmp%12) (=> tmp%12 (=> (= tmp%13 (ext_eq false TYPE%lib!network_t.Packet. (Poly%lib!network_t.Packet. (lib!cmessage_v.impl&%3.view.? (Poly%lib!cmessage_v.CPacket. cpacket@))) (Poly%lib!network_t.Packet. p@))) (and (=> %%location_label%%12 tmp%13) (=> tmp%13 (=> (= tmp%14 (= (lib!cmessage_v.impl&%3.view.? (Poly%lib!cmessage_v.CPacket. cpacket@)) (lib!net_sht_v.abstractify_net_packet_to_sht_packet.? (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. (Poly%lib!environment_t.LIoOp. net_event@1))))))) (and (=> %%location_label%%13 tmp%14) (=> tmp%14 (=> (= tmp%15 (=> (is-lib!cmessage_v.CSingleMessage./Message_ gsinglemessage@) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!cmessage_v.CPacket./CPacket/msg (%Poly%lib!cmessage_v.CPacket. (Poly%lib!cmessage_v.CPacket. cpacket@))))) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (lib!environment_t.LPacket./LPacket/msg (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. (Poly%lib!environment_t.LIoOp. net_event@1)))))))))))) (and (=> %%location_label%%14 tmp%15) (=> tmp%15 %%switch_label%%2))))))))))))))))))))))))))))))))) (=> (not (not (is-lib!cmessage_v.CSingleMessage./InvalidMessage_ gsinglemessage@))) %%switch_label%%2)) (and (not %%switch_label%%2) (=> (= tmp%16 (tuple%2./tuple%2 (Poly%lib!net_sht_v.ReceiveResult. (lib!net_sht_v.ReceiveResult./Packet (%Poly%lib!cmessage_v.CPacket. (Poly%lib!cmessage_v.CPacket. cpacket@)))) (Poly%lib!environment_t.LIoOp. net_event@1))) %%switch_label%%1))))))))))))))))))))))))))) (and (not %%switch_label%%1) (=> (= tmp%17 tmp%16) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= rc! tmp%17) (=> %%location_label%%15 (let ((rr$ (%Poly%lib!net_sht_v.ReceiveResult. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. rc!)))))) (let ((net_event$ (%Poly%lib!environment_t.LIoOp. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. rc!)))))) (and (and (and (and (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. netc!@1)) (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. netc!@0))) (= (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. netc!@1)) (not (is-lib!net_sht_v.ReceiveResult./Fail_ rr$)))) (=> (not (is-lib!net_sht_v.ReceiveResult./Fail_ rr$)) (and (lib!io_t.impl&%7.ok.? (Poly%lib!io_t.NetClient. netc!@1)) (= (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. netc!@1)) (%Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (vstd!seq.Seq.add.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<lib!environment_t.LIoOp<lib!abstract_end_point_t.AbstractEndPoint./vstd!seq.Seq<u8.>.>.>. (lib!io_t.impl&%7.history.? (Poly%lib!io_t.NetClient. netc!@0))) (vstd!seq.Seq.push.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (vstd!seq.Seq.empty.? $ (TYPE%lib!environment_t.LIoOp. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (Poly%lib!environment_t.LIoOp. net_event$)))))))) (=> (is-lib!net_sht_v.ReceiveResult./Timeout_ rr$) (is-lib!environment_t.LIoOp./TimeoutReceive_ net_event$))) (=> (is-lib!net_sht_v.ReceiveResult./Packet_ rr$) (and (and (and (is-lib!environment_t.LIoOp./Receive_ net_event$) (lib!cmessage_v.impl&%3.abstractable.? (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$)))))) (=> (not (is-lib!single_message_t.SingleMessage./InvalidMessage_ (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. (Poly%lib!network_t.Packet. (lib!cmessage_v.impl&%3.view.? (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$)))))))))) (and (= (lib!cmessage_v.impl&%3.view.? (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$))))) (lib!net_sht_v.abstractify_net_packet_to_sht_packet.? (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. (Poly%lib!environment_t.LIoOp. net_event$)))))) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!cmessage_v.CPacket./CPacket/msg (%Poly%lib!cmessage_v.CPacket. (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$)))))))) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (lib!environment_t.LPacket./LPacket/msg (%Poly%lib!environment_t.LPacket. (Poly%lib!environment_t.LPacket. (lib!environment_t.LIoOp./Receive/r (%Poly%lib!environment_t.LIoOp. (Poly%lib!environment_t.LIoOp. net_event$))))))))))))) (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. (lib!cmessage_v.CPacket./CPacket/dst (%Poly%lib!cmessage_v.CPacket. (Poly%lib!cmessage_v.CPacket. (lib!net_sht_v.ReceiveResult./Packet/cpacket (%Poly%lib!net_sht_v.ReceiveResult. (Poly%lib!net_sht_v.ReceiveResult. rr$)))))))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. local_addr!)))))))))))))))))
(check-sat)
(exit)
