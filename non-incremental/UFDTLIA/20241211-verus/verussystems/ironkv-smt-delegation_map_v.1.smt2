...
(assert (not (=> (= b! (let ((tmp%%$ (lib!keys_t.KeyIterator./KeyIterator/k (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. self!))))) (is-core!option.Option./None_ tmp%%$))) (=> %%location_label%%0 (= b! (lib!delegation_map_v.impl&%2.is_end_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. self!)))))))
(check-sat)
(exit)
