...
(declare-fun %%choose%%4 (Type Int Int Dcr Type Poly Dcr Type Poly Dcr Type Dcr Type Poly Dcr Type Poly Dcr Type) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly) (%%hole%%9 Dcr) (%%hole%%10 Type) (%%hole%%11 Dcr) (%%hole%%12 Type) (%%hole%%13 Poly) (%%hole%%14 Dcr) (%%hole%%15 Type) (%%hole%%16 Poly) (%%hole%%17 Dcr) (%%hole%%18 Type)) (! (=> (exists ((i$2 Poly)) (! (and (has_type i$2 %%hole%%0) (and (and (<= %%hole%%1 (%I i$2)) (< (%I i$2) %%hole%%2)) (not (%B (lib!marshal_v.Marshalable.view_equal.? %%hole%%9 %%hole%%10 (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$2) (vstd!seq.Seq.index.? %%hole%%6 %%hole%%7 %%hole%%8 i$2)))))) :pattern ((lib!marshal_v.Marshalable.view_equal.? %%hole%%17 %%hole%%18 (vstd!seq.Seq.index.? %%hole%%11 %%hole%%12 %%hole%%13 i$2) (vstd!seq.Seq.index.? %%hole%%14 %%hole%%15 %%hole%%16 i$2))) )) (exists ((i$2 Poly)) (! (and (and (has_type i$2 %%hole%%0) (and (and (<= %%hole%%1 (%I i$2)) (< (%I i$2) %%hole%%2)) (not (%B (lib!marshal_v.Marshalable.view_equal.? %%hole%%9 %%hole%%10 (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$2) (vstd!seq.Seq.index.? %%hole%%6 %%hole%%7 %%hole%%8 i$2)))))) (= (%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 %%hole%%18) i$2)) :pattern ((lib!marshal_v.Marshalable.view_equal.? %%hole%%17 %%hole%%18 (vstd!seq.Seq.index.? %%hole%%11 %%hole%%12 %%hole%%13 i$2) (vstd!seq.Seq.index.? %%hole%%14 %%hole%%15 %%hole%%16 i$2)))))) :pattern ((%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 %%hole%%18)))))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= s@ (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) (=> (= o@ (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)) (or (and (=> (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self! other!)) (and (=> (has_type i@ INT) (=> (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? T&. T& o@))) (=> (= tmp%1 (vstd!seq.Seq.index.? T&. T& s@ i@)) (=> (= tmp%2 (vstd!seq.Seq.index.? T&. T& o@ i@)) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. T&. T& tmp%1 tmp%2) (=> %%location_label%%0 (%B (lib!marshal_v.Marshalable.view_equal.? T&. T& (vstd!seq.Seq.index.? T&. T& o@ i@) (vstd!seq.Seq.index.? T&. T& s@ i@))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? T&. T& o@))) (%B (lib!marshal_v.Marshalable.view_equal.? T&. T& (vstd!seq.Seq.index.? T&. T& o@ i$) (vstd!seq.Seq.index.? T&. T& s@ i$))))) :pattern ((lib!marshal_v.Marshalable.view_equal.? T&. T& (vstd!seq.Seq.index.? T&. T& o@ i$) (vstd!seq.Seq.index.? T&. T& s@ i$))) )) %%switch_label%%0))) (=> (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self! other!))) (or (and (=> (not (= (vstd!seq.Seq.len.? T&. T& s@) (vstd!seq.Seq.len.? T&. T& o@))) %%switch_label%%1) (=> (not (not (= (vstd!seq.Seq.len.? T&. T& s@) (vstd!seq.Seq.len.? T&. T& o@)))) (=> (= i$1@ (%I (as_type (%%choose%%4 INT 0 (vstd!seq.Seq.len.? T&. T& s@) T&. T& s@ T&. T& o@ T&. T& T&. T& s@ T&. T& o@ T&. T&) INT))) (=> (= tmp%3 (vstd!seq.Seq.index.? T&. T& s@ (I i$1@))) (=> (= tmp%4 (vstd!seq.Seq.index.? T&. T& o@ (I i$1@))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. T&. T& tmp%3 tmp%4) %%switch_label%%1)))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%1 (= (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self! other!) (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other! self!)))))))))
(check-sat)
(exit)
