...
(declare-const recipient@ lib!abstract_end_point_t.AbstractEndPoint.)
...
(assert (not (=> (is-lib!single_message_t.SingleMessage./Message_ (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))) (=> (lib!delegation_map_t.impl&%0.is_complete.? (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (=> (= m@ (%Poly%lib!message_t.Message. (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))))) (=> (= recipient@ (lib!message_t.Message./Shard/recipient (%Poly%lib!message_t.Message. (Poly%lib!message_t.Message. m@)))) (=> (= kr@ (lib!message_t.Message./Shard/range (%Poly%lib!message_t.Message. (Poly%lib!message_t.Message. m@)))) (or (and (=> (is-lib!message_t.Message./Shard_ m@) (or (and (=> (lib!host_protocol_t.next_shard_wrapper_must_reject.? pre! (Poly%lib!message_t.Message. m@)) (=> (= tmp%2 (and (= (%Poly%lib!host_protocol_t.AbstractHostState. post!) (lib!host_protocol_t.AbstractHostState./AbstractHostState (%Poly%lib!host_protocol_t.AbstractConstants. (Poly%lib!host_protocol_t.AbstractConstants. (lib!host_protocol_t.AbstractHostState./AbstractHostState/constants (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (%Poly%lib!delegation_map_t.AbstractDelegationMap. (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (%Poly%vstd!map.Map<lib!keys_t.SHTKey./vstd!seq.Seq<u8.>.>. (Poly%vstd!map.Map<lib!keys_t.SHTKey./vstd!seq.Seq<u8.>.>. (lib!host_protocol_t.AbstractHostState./AbstractHostState/h (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (%Poly%lib!single_delivery_t.SingleDelivery. (Poly%lib!single_delivery_t.SingleDelivery. (lib!host_protocol_t.AbstractHostState./AbstractHostState/sd (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (%Poly%core!option.Option. (Poly%core!option.Option. (lib!host_protocol_t.AbstractHostState./AbstractHostState/received_packet (%Poly%lib!host_protocol_t.AbstractHostState. post!)))) (%I (I (lib!host_protocol_t.AbstractHostState./AbstractHostState/num_delegations (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (%Poly%vstd!seq.Seq<lib!abstract_service_t.AppRequest.>. (Poly%vstd!seq.Seq<lib!abstract_service_t.AppRequest.>. (lib!host_protocol_t.AbstractHostState./AbstractHostState/received_requests (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))))) (= out! (vstd!set.impl&%0.empty.? $ TYPE%lib!network_t.Packet.)))) %%switch_label%%1)) (=> (not (lib!host_protocol_t.next_shard_wrapper_must_reject.? pre! (Poly%lib!message_t.Message. m@))) (=> (has_type sm@ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)) (=> (has_type b@ BOOL) (and (=> %%location_label%%0 (req%lib!host_protocol_t.next_shard. pre! post! out! (Poly%lib!keys_t.KeyRange. kr@) (Poly%lib!abstract_end_point_t.AbstractEndPoint. recipient@) sm@ b@)) (=> (= tmp%1 (lib!host_protocol_t.next_shard.? pre! post! out! (Poly%lib!keys_t.KeyRange. kr@) (Poly%lib!abstract_end_point_t.AbstractEndPoint. recipient@) sm@ b@)) (=> (= tmp%2 (exists ((sm$ Poly) (b$ Poly)) (! (and (and (has_type sm$ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)) (has_type b$ BOOL)) (lib!host_protocol_t.next_shard.? pre! post! out! (Poly%lib!keys_t.KeyRange. kr@) (Poly%lib!abstract_end_point_t.AbstractEndPoint. recipient@) sm$ b$)) :pattern ((lib!host_protocol_t.next_shard.? pre! post! out! (Poly%lib!keys_t.KeyRange. kr@) (Poly%lib!abstract_end_point_t.AbstractEndPoint. recipient@) sm$ b$)) ))) %%switch_label%%1))))))) (and (not %%switch_label%%1) (=> (= tmp%3 tmp%2) %%switch_label%%0)))) (=> (not (is-lib!message_t.Message./Shard_ m@)) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0)))))))))
(check-sat)
(exit)
