...
(assert (not (and (=> (has_type s@ (TYPE%vstd!seq.Seq. A&. A&)) (=> (has_type t@ (TYPE%vstd!seq.Seq. A&. A&)) (=> (ens%lib!verus_extra.set_lib_ext_v.lemma_to_set_distributes_over_addition. A&. A& s@ t@) (=> %%location_label%%0 (= (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& s@ t@)) (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s@) (vstd!seq_lib.impl&%0.to_set.? A&. A& t@))))))) (=> (forall ((s$ Poly) (t$ Poly)) (! (=> (and (has_type s$ (TYPE%vstd!seq.Seq. A&. A&)) (has_type t$ (TYPE%vstd!seq.Seq. A&. A&))) (= (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& s$ t$)) (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s$) (vstd!seq_lib.impl&%0.to_set.? A&. A& t$)))) :pattern ((vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& s$ t$))) )) (=> %%location_label%%1 (forall ((s$ Poly) (t$ Poly)) (! (=> (and (has_type s$ (TYPE%vstd!seq.Seq. A&. A&)) (has_type t$ (TYPE%vstd!seq.Seq. A&. A&))) (= (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& s$ t$)) (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s$) (vstd!seq_lib.impl&%0.to_set.? A&. A& t$)))) :pattern ((vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& s$ t$))) )))))))
(check-sat)
(exit)
