...
(set-info :comment ";; MODULE 'module betree::BufferOffsets_v'")
...
(set-info :comment ";; Function-Decl lib::betree::BufferOffsets_v::empty_bufer_offsets")
...
(set-info :comment ";; Function-Recommends lib::betree::BufferOffsets_v::BufferOffsets::len")
(set-info :comment ";; betree/BufferOffsets_v.rs:19:5: 19:47 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::BufferOffsets_v::BufferOffsets::all_lte")
(set-info :comment ";; betree/BufferOffsets_v.rs:41:5: 41:65 (#0)")
...
(assert (forall ((self! Poly) (idx! Poly)) (! (= (req%lib!betree.BufferOffsets_v.impl&%0.dup. self! idx!) (=> %%global_location_label%%5 (and (<= 0 (%I idx!)) (< (%I idx!) (lib!betree.BufferOffsets_v.impl&%0.len.? self!))))) :pattern ((req%lib!betree.BufferOffsets_v.impl&%0.dup. self! idx!)) )))
(set-info :comment ";; Function-Recommends lib::betree::BufferOffsets_v::BufferOffsets::dup")
(set-info :comment ";; betree/BufferOffsets_v.rs:29:5: 29:67 (#0)")
...
(assert (forall ((self! Poly) (start! Poly) (end! Poly)) (! (= (req%lib!betree.BufferOffsets_v.impl&%0.slice. self! start! end!) (=> %%global_location_label%%6 (and (and (<= 0 (%I start!)) (<= (%I start!) (%I end!))) (<= (%I end!) (lib!betree.BufferOffsets_v.impl&%0.len.? self!))))) :pattern ((req%lib!betree.BufferOffsets_v.impl&%0.slice. self! start! end!)) )))
(set-info :comment ";; Function-Recommends lib::betree::BufferOffsets_v::BufferOffsets::slice")
(set-info :comment ";; betree/BufferOffsets_v.rs:23:5: 23:81 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::BufferOffsets_v::BufferOffsets::all_gte")
(set-info :comment ";; betree/BufferOffsets_v.rs:46:5: 46:65 (#0)")
...
(assert (forall ((self! Poly) (idx! Poly) (value! Poly)) (! (= (req%lib!betree.BufferOffsets_v.impl&%0.update. self! idx! value!) (=> %%global_location_label%%7 (and (<= 0 (%I idx!)) (< (%I idx!) (lib!betree.BufferOffsets_v.impl&%0.len.? self!))))) :pattern ((req%lib!betree.BufferOffsets_v.impl&%0.update. self! idx! value!)) )))
(set-info :comment ";; Function-Recommends lib::betree::BufferOffsets_v::BufferOffsets::update")
(set-info :comment ";; betree/BufferOffsets_v.rs:35:5: 35:82 (#0)")
...
(assert (forall ((self! Poly) (target! Poly)) (! (= (req%lib!betree.BufferOffsets_v.impl&%0.shift_left. self! target!) (=> %%global_location_label%%8 (lib!betree.BufferOffsets_v.impl&%0.all_gte.? self! target!))) :pattern ((req%lib!betree.BufferOffsets_v.impl&%0.shift_left. self! target!)) )))
(set-info :comment ";; Function-Recommends lib::betree::BufferOffsets_v::BufferOffsets::shift_left")
(set-info :comment ";; betree/BufferOffsets_v.rs:51:5: 51:77 (#0)")
...
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 Int) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) i$) (I (nClip (Sub (%I (vstd!seq.Seq.index.? %%hole%%0 %%hole%%1 %%hole%%2 i$)) %%hole%%3)))) :pattern ((%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) i$)))))
(assert (=> (fuel_bool fuel%lib!betree.BufferOffsets_v.impl&%0.shift_left.) (forall ((self! Poly) (target! Poly)) (! (= (lib!betree.BufferOffsets_v.impl&%0.shift_left.? self! target!) (lib!betree.BufferOffsets_v.BufferOffsets./BufferOffsets (%Poly%vstd!seq.Seq<nat.>. (vstd!seq.Seq.new.? $ NAT $ (TYPE%fun%1. $ INT $ NAT) (I (lib!betree.BufferOffsets_v.impl&%0.len.? self!)) (Poly%fun%1. (mk_fun (%%lambda%%0 $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!betree.BufferOffsets_v.BufferOffsets./BufferOffsets/offsets (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. self!))) (%I target!)))))))) :pattern ((lib!betree.BufferOffsets_v.impl&%0.shift_left.? self! target!)) ))))
...
(assert (forall ((self! Poly) (start! Poly) (end! Poly)) (! (= (req%lib!betree.BufferOffsets_v.impl&%0.adjust_compact. self! start! end!) (=> %%global_location_label%%9 (and (<= 0 (%I start!)) (< (%I start!) (%I end!))))) :pattern ((req%lib!betree.BufferOffsets_v.impl&%0.adjust_compact. self! start! end!)) )))
(set-info :comment ";; Function-Recommends lib::betree::BufferOffsets_v::BufferOffsets::adjust_compact")
(set-info :comment ";; betree/BufferOffsets_v.rs:64:5: 64:90 (#0)")
(declare-const %return! lib!betree.BufferOffsets_v.BufferOffsets.)
