...
(declare-const tmp%1 vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>.)
(declare-const tmp%2 Poly)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.PivotBranch_v.Path.))
(assert (has_type replacement! TYPE%lib!betree.PivotBranch_v.Node.))
(declare-const %%switch_label%%0 Bool)
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!betree.PivotBranch_v.impl&%4.valid.? self!) (or (and (=> (= 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!))) (=> (= tmp%2 replacement!) %%switch_label%%0)) (=> (not (= 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!)))) (and (=> %%location_label%%0 (req%lib!betree.PivotBranch_v.impl&%4.replaced_children. self! replacement!)) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%4.replaced_children.? self! replacement!)) (=> (= tmp%2 (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Node./Index (%Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!))))))) (%Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. tmp%1))))) %%switch_label%%0))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
