...
(declare-const tmp%1 vstd!map.Map<u64./lib!spec.AsyncDisk_t.DiskRequest.>.)
...
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? $ (UINT 64) ids!)) (or (and (=> (> (vstd!seq.Seq.len.? $ (UINT 64) ids!) 0) (=> (= sub_ids@ (%Poly%vstd!seq.Seq<u64.>. (vstd!seq.Seq.subrange.? $ (UINT 64) ids! (I 1) (I (vstd!seq.Seq.len.? $ (UINT 64) ids!))))) (=> (= sub_reqs@ (%Poly%vstd!seq.Seq<lib!spec.ImplDisk_t.IDiskRequest.>. (vstd!seq.Seq.subrange.? $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs! (I 1) (I (vstd!seq.Seq.len.? $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs!))))) (and (=> %%location_label%%0 (check_decrease_int (let ((ids!$0 sub_ids@) (reqs!$1 sub_reqs@)) (vstd!seq.Seq.len.? $ (UINT 64) (Poly%vstd!seq.Seq<u64.>. ids!$0))) decrease%init0 false)) (=> (= tmp%1 (lib!spec.AppIO_t.to_disk_reqs.? (Poly%vstd!seq.Seq<u64.>. sub_ids@) (Poly%vstd!seq.Seq<lib!spec.ImplDisk_t.IDiskRequest.>. sub_reqs@))) (=> (= tmp%2 (vstd!map.impl&%0.insert.? $ (UINT 64) $ TYPE%lib!spec.AsyncDisk_t.DiskRequest. (Poly%vstd!map.Map<u64./lib!spec.AsyncDisk_t.DiskRequest.>. tmp%1) (vstd!seq.Seq.index.? $ (UINT 64) ids! (I 0)) (Poly%lib!spec.AsyncDisk_t.DiskRequest. (lib!spec.ImplDisk_t.impl&%3.view.? (vstd!seq.Seq.index.? $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs! (I 0)))))) %%switch_label%%0)))))) (=> (not (> (vstd!seq.Seq.len.? $ (UINT 64) ids!) 0)) (=> (= tmp%2 (vstd!map.impl&%0.empty.? $ (UINT 64) $ TYPE%lib!spec.AsyncDisk_t.DiskRequest.)) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
