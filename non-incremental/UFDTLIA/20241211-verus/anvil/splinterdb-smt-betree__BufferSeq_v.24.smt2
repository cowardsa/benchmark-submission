...
(set-info :comment ";; Function-Def lib::betree::BufferSeq_v::BufferSeq::not_present_query_lemma")
(set-info :comment ";; betree/BufferSeq_v.rs:253:5: 253:67 (#0)")
...
(assert (and (<= 0 start!) (<= start! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. self!)))))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= start! (%I i$)) (< (%I i$) (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. self!)))) (not (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!spec.Messages_t.Message. (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!spec.Messages_t.Message.>. (lib!betree.Buffer_v.SimpleBuffer./SimpleBuffer/map (%Poly%lib!betree.Buffer_v.SimpleBuffer. (vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. (Poly%lib!betree.BufferSeq_v.BufferSeq. self!)))) i$))))) (Poly%lib!spec.KeyType_t.Key. k!))))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. (Poly%lib!betree.BufferSeq_v.BufferSeq. self!)))) i$)) )))
...
(assert (not (=> (= decrease%init0 (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. self!)) start!)) (or (and (=> (< start! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. self!))) (=> (= tmp%1 (Add start! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 self!) (k!$1 k!) (start!$2 tmp%1)) (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. self!$0)) start!$2)) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!betree.BufferSeq_v.impl&%0.not_present_query_lemma. self! k! tmp%1)) (=> (ens%lib!betree.BufferSeq_v.impl&%0.not_present_query_lemma. self! k! tmp%1) %%switch_label%%0))))) (=> (not (< start! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. self!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (= (lib!betree.BufferSeq_v.impl&%0.query_from.? (Poly%lib!betree.BufferSeq_v.BufferSeq. self!) (Poly%lib!spec.KeyType_t.Key. k!) (I start!)) (lib!spec.Messages_t.Message./Update (%Poly%lib!spec.Messages_t.Delta. (Poly%lib!spec.Messages_t.Delta. (lib!spec.Messages_t.nop_delta.? (I 0))))))))))))
(check-sat)
(exit)
