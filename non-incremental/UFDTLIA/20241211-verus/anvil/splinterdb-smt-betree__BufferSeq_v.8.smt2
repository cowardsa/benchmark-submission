...
(assert (has_type buffer_idx! INT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!betree.OffsetMap_v.impl&%0.is_total.? offset_map!) (=> (<= 0 (%I from_idx!)) (or (and (=> (lib!betree.BufferSeq_v.impl&%0.key_in_buffer.? self! from_idx! k! buffer_idx!) (=> (= tmp%2 (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./nat.>. (lib!betree.OffsetMap_v.OffsetMap./OffsetMap/offsets (%Poly%lib!betree.OffsetMap_v.OffsetMap. offset_map!)))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Key. $ NAT tmp%2 k!)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.KeyType_t.Key. $ NAT (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./nat.>. (lib!betree.OffsetMap_v.OffsetMap./OffsetMap/offsets (%Poly%lib!betree.OffsetMap_v.OffsetMap. offset_map!))) k!)) (=> (= tmp%3 (<= (%I tmp%1) (%I buffer_idx!))) %%switch_label%%0))))) (=> (not (lib!betree.BufferSeq_v.impl&%0.key_in_buffer.? self! from_idx! k! buffer_idx!)) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
