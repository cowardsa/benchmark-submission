...
(assert (not (or (and (=> (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (=> (has_type ranking@ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (=> (= tmp%1 (exists ((ranking$ Poly)) (! (and (has_type ranking$ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (lib!betree.LinkedBetree_v.impl&%5.valid_ranking.? T&. T& self! ranking$)) :pattern ((lib!betree.LinkedBetree_v.impl&%5.valid_ranking.? T&. T& self! ranking$)) ))) %%switch_label%%0))) (=> (not (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!)) (=> (= tmp%1 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
