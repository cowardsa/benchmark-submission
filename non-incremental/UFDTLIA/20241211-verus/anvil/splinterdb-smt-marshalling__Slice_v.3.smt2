...
(assert (not (=> %%location_label%%0 (forall ((data$ Poly)) (! (=> (has_type data$ (TYPE%vstd!seq.Seq. T&. T&)) (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (lib!marshalling.Slice_v.impl&%0.i.? T&. T& (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.Slice_v.impl&%0.all.? T&. T& data$)) data$) data$)) :pattern ((lib!marshalling.Slice_v.impl&%0.all.? T&. T& data$)) )))))
(check-sat)
(exit)
