...
(assert (not (=> (= decrease%init0 (%Poly%lib!betree.PagedBetree_v.BetreeNode. self!)) (or (and (=> (is-lib!betree.PagedBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PagedBetree_v.BetreeNode. self!)) (=> (= tmp%2 (Poly%lib!betree.PagedBetree_v.ChildMap. (lib!betree.PagedBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PagedBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (check_decrease_height (Poly%lib!betree.PagedBetree_v.ChildMap. (let ((self!$0 (%Poly%lib!betree.PagedBetree_v.ChildMap. tmp%2))) self!$0)) (Poly%lib!betree.PagedBetree_v.BetreeNode. decrease%init0) false)) (=> (= tmp%1 (lib!betree.PagedBetree_v.impl&%0.wf.? (Poly%lib!betree.PagedBetree_v.ChildMap. (lib!betree.PagedBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PagedBetree_v.BetreeNode. self!))))) (=> (= tmp%3 tmp%1) %%switch_label%%0))))) (=> (not (is-lib!betree.PagedBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PagedBetree_v.BetreeNode. self!))) (=> (= tmp%3 true) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
