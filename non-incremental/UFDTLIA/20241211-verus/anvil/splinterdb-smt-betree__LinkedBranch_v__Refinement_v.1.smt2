...
(declare-const pivots@ vstd!seq.Seq<lib!spec.KeyType_t.Key.>.)
(declare-const children@ vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>.)
(declare-const tmp%4 lib!betree.PivotBranch_v.Node.)
(declare-const tmp%%@ lib!betree.LinkedBranch_v.Node.)
