...
(declare-const tmp%1 lib!betree.PivotBranch_v.Path.)
(declare-const key@ Poly)
(declare-const tmp%2 lib!spec.KeyType_t.Key.)
(declare-const tmp%3 lib!spec.KeyType_t.Key.)
...
(assert (> (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!)) 0))
(assert (lib!spec.KeyType_t.impl&%1.is_strictly_sorted.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!)))
(assert (= (lib!betree.PivotBranch_v.Path./Path/key (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!))) (%Poly%lib!spec.KeyType_t.Key. (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!) (I 0)))))
(assert (lib!betree.PivotBranch_v.impl&%4.path_equiv.? (Poly%lib!betree.PivotBranch_v.Path. path!) (vstd!seq.Seq.last.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!))))
...
(assert (not (=> (= decrease%init0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!)))) (or (and (=> (< 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!)))) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%4.subpath.? (Poly%lib!betree.PivotBranch_v.Path. path!))) (and (=> %%location_label%%0 (check_decrease_int (let ((keys!$0 keys!) (path!$1 tmp%1)) (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!$1)))) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!betree.PivotBranchRefinement_v.lemma_append_keys_are_path_equiv. keys! tmp%1)) (=> (ens%lib!betree.PivotBranchRefinement_v.lemma_append_keys_are_path_equiv. keys! tmp%1) %%switch_label%%0))))) (=> (not (< 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!))))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%2 (req%lib!spec.KeyType_t.impl&%1.strictly_sorted_implies_sorted. keys!)) (=> (ens%lib!spec.KeyType_t.impl&%1.strictly_sorted_implies_sorted. keys!) (and (=> (has_type key@ TYPE%lib!spec.KeyType_t.Key.) (=> (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!) key@) (=> (= node@ (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!)))) (=> (= tmp%2 (%Poly%lib!spec.KeyType_t.Key. (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!) (I 0)))) (and (=> %%location_label%%3 (req%lib!betree.PivotBranchRefinement_v.lemma_key_lte_implies_route_lte. node@ tmp%2 (%Poly%lib!spec.KeyType_t.Key. key@))) (=> (ens%lib!betree.PivotBranchRefinement_v.lemma_key_lte_implies_route_lte. node@ tmp%2 (%Poly%lib!spec.KeyType_t.Key. key@)) (=> (= tmp%3 (%Poly%lib!spec.KeyType_t.Key. (vstd!seq.Seq.last.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!)))) (and (=> %%location_label%%4 (req%lib!betree.PivotBranchRefinement_v.lemma_key_lte_implies_route_lte. node@ (%Poly%lib!spec.KeyType_t.Key. key@) tmp%3)) (=> (ens%lib!betree.PivotBranchRefinement_v.lemma_key_lte_implies_route_lte. node@ (%Poly%lib!spec.KeyType_t.Key. key@) tmp%3) (=> (= tmp%4 (= (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!)))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.PivotBranch_v.Path./Path/key (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!))))) (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!)))) key@))) (and (=> %%location_label%%5 tmp%4) (=> tmp%4 (=> %%location_label%%6 (lib!betree.PivotBranch_v.impl&%4.path_equiv.? (Poly%lib!betree.PivotBranch_v.Path. path!) key@)))))))))))))) (=> (forall ((key$ Poly)) (! (=> (has_type key$ TYPE%lib!spec.KeyType_t.Key.) (=> (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!) key$) (lib!betree.PivotBranch_v.impl&%4.path_equiv.? (Poly%lib!betree.PivotBranch_v.Path. path!) key$))) :pattern ((vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!) key$)) :pattern ((lib!betree.PivotBranch_v.impl&%4.path_equiv.? (Poly%lib!betree.PivotBranch_v.Path. path!) key$)) )) (=> %%location_label%%7 (forall ((key$ Poly)) (! (=> (has_type key$ TYPE%lib!spec.KeyType_t.Key.) (=> (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!) key$) (lib!betree.PivotBranch_v.impl&%4.path_equiv.? (Poly%lib!betree.PivotBranch_v.Path. path!) key$))) :pattern ((vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys!) key$)) :pattern ((lib!betree.PivotBranch_v.impl&%4.path_equiv.? (Poly%lib!betree.PivotBranch_v.Path. path!) key$)) ))))))))))))
(check-sat)
(exit)
