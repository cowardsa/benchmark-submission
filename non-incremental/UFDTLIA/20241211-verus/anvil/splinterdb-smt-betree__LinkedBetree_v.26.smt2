...
(declare-const %return! lib!spec.Messages_t.Message.)
...
(assert (not (=> (and (<= 0 (%I i!)) (< (%I i!) (vstd!seq.Seq.len.? $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))))) (=> (= tmp%2 (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))) (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) tmp%2 i!))))))
(check-sat)
(exit)
