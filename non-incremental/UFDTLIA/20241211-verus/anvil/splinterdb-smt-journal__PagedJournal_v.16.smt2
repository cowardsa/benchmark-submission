...
(declare-const tmp%6 lib!abstract_system.MsgHistory_v.MsgHistory.)
(declare-const tmp%7 Poly)
(declare-const tmp%8 Bool)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!journal.PagedJournal_v.TruncatedJournal.))
...
(assert (not (=> (lib!journal.PagedJournal_v.impl&%1.wf.? self!) (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? msgs!) (or (and (=> (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!))) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!journal.PagedJournal_v.JournalRecord. tmp%2)) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))))) (=> (= tmp%3 (lib!journal.PagedJournal_v.impl&%0.can_crop_head_records.? tmp%1 (I (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/boundary_lsn (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!))) (I (nClip (Add (%I depth!) 1))))) %%switch_label%%1))))) (=> (not (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%3 (=> (= tmp%5 (Poly%core!option.Option. (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%1 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!journal.PagedJournal_v.JournalRecord. tmp%5)) (=> (= tmp%4 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))))) (=> (= tmp%7 (I (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/boundary_lsn (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%2 (req%lib!journal.PagedJournal_v.impl&%0.message_seq_after_crop. tmp%4 tmp%7 depth!)) (=> (= tmp%6 (lib!journal.PagedJournal_v.impl&%0.message_seq_after_crop.? tmp%4 (I (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/boundary_lsn (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!))) depth!)) (=> (= tmp%8 (= tmp%6 (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. msgs!))) %%switch_label%%0)))))))) (=> (not tmp%3) (=> (= tmp%8 false) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
