...
(assert (not (=> (lib!betree.FilteredBetree_v.impl&%3.all_lines_wf.? self!) (=> (lib!betree.FilteredBetree_v.impl&%3.structure.? self!) (=> (and (<= 0 (%I i!)) (< (%I i!) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.FilteredBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.QueryReceiptLine.>. (lib!betree.FilteredBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.FilteredBetree_v.QueryReceipt. self!)))) 1))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.QueryReceiptLine.>. (lib!betree.FilteredBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.FilteredBetree_v.QueryReceipt. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.FilteredBetree_v.QueryReceiptLine. tmp%2 i!)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.FilteredBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.QueryReceiptLine.>. (lib!betree.FilteredBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.FilteredBetree_v.QueryReceipt. self!))) i!)) (=> (= tmp%4 (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.QueryReceiptLine./QueryReceiptLine/node (%Poly%lib!betree.FilteredBetree_v.QueryReceiptLine. tmp%1)))) (=> (= tmp%5 (Poly%lib!spec.KeyType_t.Key. (lib!betree.FilteredBetree_v.QueryReceipt./QueryReceipt/key (%Poly%lib!betree.FilteredBetree_v.QueryReceipt. self!)))) (=> %%location_label%%1 (req%lib!betree.FilteredBetree_v.impl&%1.child. tmp%4 tmp%5))))))))))))
(check-sat)
(exit)
