...
(assert (not (=> (lib!betree.PagedBetree_v.impl&%4.all_lines_wf.? self!) (=> (lib!betree.PagedBetree_v.impl&%4.structure.? self!) (=> (and (<= 0 (%I i!)) (< (%I i!) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PagedBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PagedBetree_v.QueryReceiptLine.>. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!)))) 1))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.PagedBetree_v.QueryReceiptLine.>. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.PagedBetree_v.QueryReceiptLine. tmp%2 i!)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PagedBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PagedBetree_v.QueryReceiptLine.>. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!))) i!)) (=> (= msg@ (%Poly%lib!spec.Messages_t.Message. (lib!betree.Buffer_v.Buffer.query.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.PagedBetree_v.BetreeNode./Node/buffer (%Poly%lib!betree.PagedBetree_v.BetreeNode. (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.QueryReceiptLine./QueryReceiptLine/node (%Poly%lib!betree.PagedBetree_v.QueryReceiptLine. tmp%1)))))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.PagedBetree_v.QueryReceipt./QueryReceipt/key (%Poly%lib!betree.PagedBetree_v.QueryReceipt. self!)))))) (and (=> %%location_label%%1 (req%lib!betree.PagedBetree_v.impl&%4.result_at. self! i!)) (=> (= tmp%3 (lib!betree.PagedBetree_v.impl&%4.result_at.? self! i!)) (=> (= tmp%5 (I (Add (%I i!) 1))) (=> %%location_label%%2 (req%lib!betree.PagedBetree_v.impl&%4.result_at. self! tmp%5))))))))))))))
(check-sat)
(exit)
