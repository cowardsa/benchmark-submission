...
(declare-const tmp%6 lib!betree.PivotBranch_v.Path.)
...
(assert (not (=> (lib!betree.PivotBranch_v.impl&%4.valid.? self!) (=> (= tmp%2 (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!)))) (=> (= tmp%3 (Poly%lib!spec.KeyType_t.Key. (lib!betree.PivotBranch_v.Path./Path/key (%Poly%lib!betree.PivotBranch_v.Path. self!)))) (and (=> %%location_label%%0 (req%lib!betree.PivotBranch_v.impl&%3.route. tmp%2 tmp%3)) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.PivotBranch_v.Path./Path/key (%Poly%lib!betree.PivotBranch_v.Path. self!))))) (=> (= tmp%5 (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!)))) (and (=> %%location_label%%1 (req%lib!betree.PivotBranch_v.impl&%3.route. tmp%5 other_key!)) (=> (= tmp%4 (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!))) other_key!)) (or (and (=> (= tmp%1 tmp%4) (or (and (=> (< 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!))) (and (=> %%location_label%%2 (req%lib!betree.PivotBranch_v.impl&%4.subpath. self!)) (=> (= tmp%6 (lib!betree.PivotBranch_v.impl&%4.subpath.? self!)) (and (=> %%location_label%%3 (req%lib!betree.PivotBranch_v.impl&%4.path_equiv. (Poly%lib!betree.PivotBranch_v.Path. tmp%6) other_key!)) (=> (= tmp%7 (lib!betree.PivotBranch_v.impl&%4.path_equiv.? (Poly%lib!betree.PivotBranch_v.Path. tmp%6) other_key!)) (=> (= tmp%8 tmp%7) %%switch_label%%1)))))) (=> (not (< 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!)))) (=> (= tmp%8 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%9 tmp%8) %%switch_label%%0)))) (=> (not (= tmp%1 tmp%4)) (=> (= tmp%9 false) %%switch_label%%0))) (not %%switch_label%%0))))))))))))
(check-sat)
(exit)
