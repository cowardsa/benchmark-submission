...
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:464:1: 464:76 (#0)")
(declare-const %return! vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>.)
(declare-const lsn_addr_map! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Poly)
(declare-const tmp%3 Poly)
(declare-const tmp%4 Poly)
(declare-const k@ Int)
(declare-const sub_likes@ vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>.)
(declare-const tmp%5 vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>.)
(assert fuel_defaults)
(assert (has_type lsn_addr_map! (TYPE%vstd!map.Map. $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address.)))
...
(assert (not (=> (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_map!)) (or (and (=> (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_map!)) 0) (=> (= tmp%5 (lib!allocation_layer.Likes_v.no_likes.? (I 0))) %%switch_label%%0)) (=> (not (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_map!)) 0)) (=> (= k@ (%I (vstd!set.impl&%0.choose.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_map!)))) (=> (= tmp%1 (vstd!map.impl&%0.remove.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_map! (I k@))) (and (=> %%location_label%%0 (req%lib!allocation_layer.LikesJournal_v.map_to_likes. tmp%1)) (and (=> %%location_label%%1 (req%vstd!map.impl&%0.spec_index. $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_map! (I k@))) (=> (= tmp%2 (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_map! (I k@))) (=> (= tmp%4 (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) tmp%2)) (and (=> %%location_label%%2 (req%vstd!set_lib.impl&%0.to_multiset. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%4)) (=> (= tmp%3 (vstd!set_lib.impl&%0.to_multiset.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) tmp%2))) (=> (= tmp%5 (%Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (vstd!multiset.impl&%0.add.? $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%3 (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. sub_likes@)))) %%switch_label%%0))))))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
