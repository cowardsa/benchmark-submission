...
(declare-const pivot_keys@ vstd!set.Set<lib!spec.KeyType_t.Key.>.)
(declare-const index_keys@ vstd!set.Set<lib!spec.KeyType_t.Key.>.)
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.valid_ranking. self! ranking!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!)) (=> (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%5.get_rank. self! ranking!)) (=> (= tmp%2 (lib!betree.LinkedBranch_v.impl&%5.get_rank.? self! ranking!)) (and (=> %%location_label%%2 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%3 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (or (and (=> (is-lib!betree.LinkedBranch_v.Node./Leaf_ tmp%3) (and (=> %%location_label%%3 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%4 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (= tmp%6 (vstd!seq_lib.impl&%0.to_set.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.LinkedBranch_v.Node./Leaf/keys (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. tmp%4)))))) %%switch_label%%0)))) (=> (not (is-lib!betree.LinkedBranch_v.Node./Leaf_ tmp%3)) (and (=> %%location_label%%4 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%5 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (= pivot_keys@ (%Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (vstd!seq_lib.impl&%0.to_set.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.LinkedBranch_v.Node./Index/pivots (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. tmp%5))))))) (and (=> %%location_label%%5 (req%lib!betree.LinkedBranch_v.impl&%5.children_keys. self! ranking!)) (=> (= tmp%6 (vstd!set.impl&%0.union.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. pivot_keys@) (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. index_keys@))) %%switch_label%%0))))))) (not %%switch_label%%0))))))))))))
(check-sat)
(exit)
