...
(assert (not (=> (= decrease%init0 (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)) (=> (= decrease%init1 0) (=> (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)) (=> (has_type i@ NAT) (or (and (=> (lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! i@) (=> (= tmp%2 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) i@)) (and (=> %%location_label%%0 (check_decrease_height (Poly%lib!betree.PivotBetree_v.BetreeNode. (let ((self!$0 (%Poly%lib!betree.PivotBetree_v.BetreeNode. tmp%2))) self!$0)) (Poly%lib!betree.PivotBetree_v.BetreeNode. decrease%init0) (check_decrease_int (let ((self!$0 (%Poly%lib!betree.PivotBetree_v.BetreeNode. tmp%2))) 1) decrease%init1 false))) (=> (= tmp%1 (lib!betree.PivotBetree_v.impl&%1.wf.? (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) i@))) (=> (= tmp%3 tmp%1) %%switch_label%%0))))) (=> (not (lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! i@)) (=> (= tmp%3 true) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
