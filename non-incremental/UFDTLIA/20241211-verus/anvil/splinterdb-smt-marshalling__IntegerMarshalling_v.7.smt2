...
(declare-const s@ alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const end@ Int)
(assert fuel_defaults)
(assert (has_type self! (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)))
...
(assert (%B (lib!marshalling.Marshalling_v.Marshal.valid.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self!)))
(assert (%B (lib!marshalling.Marshalling_v.Marshal.marshallable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) value!))))
(assert (<= (Add (%I start!) (%I (lib!marshalling.Marshalling_v.Marshal.spec_size.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) value!)))) (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!@0)))
...
(assert (not (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.to_le_bytes. T&. T& value! tmp%1) (=> (= s@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%1)) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. s@)) (I 0) (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? T&. T&)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. s@)))) (and (=> %%location_label%%0 tmp%2) (=> tmp%2 (and (=> %%location_label%%1 (req%lib!marshalling.IntegerMarshalling_v.impl&%12.install_bytes. T&. T& s@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. data!@0) (%I start!))) (=> (has_type data!@1 (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (=> (ens%lib!marshalling.IntegerMarshalling_v.impl&%12.install_bytes. T&. T& s@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. data!@0) (%Poly%alloc!vec.Vec<u8./allocator_global%.>. data!@1) (%I start!) end@) (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@1) start! (I end@)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. s@)))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (and (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.lemma_auto_spec_to_from_le_bytes. T&. T&) (=> %%location_label%%3 (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? T&. T& (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? T&. T& value!)) value!))) (=> (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? T&. T& (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? T&. T& value!)) value!) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.deepv_is_as_int. T&. T& value!) (=> (= %return! (I end@)) (and (=> %%location_label%%4 (= (%I %return!) (Add (%I start!) (%I (lib!marshalling.Marshalling_v.Marshal.spec_size.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) value!)))))) (and (=> %%location_label%%5 (= (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!@1) (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!@0))) (and (=> %%location_label%%6 (forall ((i$$0 Poly)) (! (=> (has_type i$$0 INT) (=> (and (<= 0 (%I i$$0)) (< (%I i$$0) (%I start!))) (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@1) i$$0) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@0) i$$0)))) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@1) i$$0)) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@0) i$$0)) ))) (and (=> %%location_label%%7 (forall ((i$$0 Poly)) (! (=> (has_type i$$0 INT) (=> (and (<= (%I %return!) (%I i$$0)) (< (%I i$$0) (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!@1))) (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@1) i$$0) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@0) i$$0)))) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@1) i$$0)) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@0) i$$0)) ))) (and (=> %%location_label%%8 (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@1) start! %return!)))) (=> %%location_label%%9 (= (lib!marshalling.Marshalling_v.Marshal.parse.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@1) start! %return!)) (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) value!)))))))))))))))))))))))))
(check-sat)
(exit)
