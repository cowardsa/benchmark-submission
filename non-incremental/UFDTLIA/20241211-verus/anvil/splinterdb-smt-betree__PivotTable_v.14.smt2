...
(assert (forall ((self! Poly) (i! Poly)) (! (= (req%lib!betree.PivotTable_v.impl&%0.spec_index. self! i!) (=> %%global_location_label%%17 (and (<= 0 (%I i!)) (< (%I i!) (lib!betree.PivotTable_v.impl&%0.len.? self!))))) :pattern ((req%lib!betree.PivotTable_v.impl&%0.spec_index. self! i!)) )))
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::spec_index")
(set-info :comment ";; betree/PivotTable_v.rs:53:5: 53:66 (#0)")
...
(set-info :comment ";; Function-Def lib::betree::PivotTable_v::PivotTable::route_is_lemma")
(set-info :comment ";; betree/PivotTable_v.rs:131:5: 131:66 (#0)")
...
(set-info :comment ";; Function-Specs lib::betree::PivotTable_v::PivotTable::pivot_range_keyset")
(declare-fun req%lib!betree.PivotTable_v.impl&%0.pivot_range_keyset. (Poly Poly) Bool)
(declare-const %%global_location_label%%18 Bool)
(declare-const %%global_location_label%%19 Bool)
(assert (forall ((self! Poly) (i! Poly)) (! (= (req%lib!betree.PivotTable_v.impl&%0.pivot_range_keyset. self! i!) (and (=> %%global_location_label%%18 (lib!betree.PivotTable_v.impl&%0.wf.? self!)) (=> %%global_location_label%%19 (and (<= 0 (%I i!)) (< (%I i!) (lib!betree.PivotTable_v.impl&%0.num_ranges.? self!)))))) :pattern ((req%lib!betree.PivotTable_v.impl&%0.pivot_range_keyset. self! i!)) )))
(set-info :comment ";; Function-Recommends lib::betree::PivotTable_v::PivotTable::pivot_range_keyset")
(set-info :comment ";; betree/PivotTable_v.rs:141:5: 141:75 (#0)")
