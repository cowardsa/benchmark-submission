...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (or (and (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!) (=> (= tmp%2 (Poly%core!option.Option. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/root (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%2)) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/root (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))))) (=> (= tmp%3 (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking!) tmp%1)) %%switch_label%%1))))) (=> (not (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%3 (=> (= tmp%5 (Poly%core!option.Option. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/root (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))) (and (=> %%location_label%%1 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%5)) (=> (= tmp%4 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/root (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))))) (and (=> %%location_label%%2 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking! tmp%4)) (=> (= tmp%6 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking! tmp%4)) (=> (= tmp%7 (nClip (Add (%I tmp%6) 1))) %%switch_label%%0))))))) (=> (not tmp%3) (=> (= tmp%7 0) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
