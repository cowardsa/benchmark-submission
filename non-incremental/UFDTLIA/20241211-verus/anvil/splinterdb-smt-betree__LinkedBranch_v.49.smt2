...
(declare-const except! Poly)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.LinkedBranch_v.DiskView.))
(assert (has_type other! TYPE%lib!betree.LinkedBranch_v.DiskView.))
(assert (has_type except! (TYPE%vstd!set.Set. $ TYPE%lib!spec.AsyncDisk_t.Address.)))
(assert (not true))
(check-sat)
(exit)
