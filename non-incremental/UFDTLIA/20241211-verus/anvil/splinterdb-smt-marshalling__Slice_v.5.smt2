...
(set-info :comment ";; MODULE 'module marshalling::Slice_v'")
...
(set-info :comment ";; Function-Def lib::marshalling::Slice_v::Slice::len")
(set-info :comment ";; marshalling/Slice_v.rs:80:5: 80:42 (#0)")
...
(assert (forall ((self! lib!marshalling.Slice_v.Slice.) (a! Int) (b! Int)) (! (= (req%lib!marshalling.Slice_v.impl&%1.subslice. self! a! b!) (=> %%global_location_label%%5 (and (<= a! b!) (<= b! (lib!marshalling.Slice_v.impl&%0.len.? (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!))))))) :pattern ((req%lib!marshalling.Slice_v.impl&%1.subslice. self! a! b!)) )))
...
(set-info :comment ";; Function-Def lib::marshalling::Slice_v::Slice::subslice")
(set-info :comment ";; marshalling/Slice_v.rs:94:5: 94:67 (#0)")
(set-info :comment ";; Function-Specs lib::marshalling::Slice_v::SpecSlice::all_ensures")
(declare-fun ens%lib!marshalling.Slice_v.impl&%0.all_ensures. (Dcr Type) Bool)
(assert (forall ((T&. Dcr) (T& Type)) (! (= (ens%lib!marshalling.Slice_v.impl&%0.all_ensures. T&. T&) (forall ((data$ Poly)) (! (=> (has_type data$ (TYPE%vstd!seq.Seq. T&. T&)) (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (lib!marshalling.Slice_v.impl&%0.i.? T&. T& (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.Slice_v.impl&%0.all.? T&. T& data$)) data$) data$)) :pattern ((lib!marshalling.Slice_v.impl&%0.all.? T&. T& data$)) ))) :pattern ((ens%lib!marshalling.Slice_v.impl&%0.all_ensures. T&. T&)) )))
(set-info :comment ";; Function-Def lib::marshalling::Slice_v::SpecSlice::all_ensures")
(set-info :comment ";; marshalling/Slice_v.rs:45:5: 45:34 (#0)")
...
(set-info :comment ";; Function-Specs lib::marshalling::Slice_v::Slice::all")
(declare-fun ens%lib!marshalling.Slice_v.impl&%1.all. (Dcr Type Poly lib!marshalling.Slice_v.Slice.) Bool)
(assert (forall ((T&. Dcr) (T& Type) (data! Poly) (out! lib!marshalling.Slice_v.Slice.)) (! (= (ens%lib!marshalling.Slice_v.impl&%1.all. T&. T& data! out!) (and (has_type (Poly%lib!marshalling.Slice_v.Slice. out!) TYPE%lib!marshalling.Slice_v.Slice.) (= (%Poly%lib!marshalling.Slice_v.SpecSlice. (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. out!))) (lib!marshalling.Slice_v.impl&%0.all.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) data!))))) :pattern ((ens%lib!marshalling.Slice_v.impl&%1.all. T&. T& data! out!)) )))
(set-info :comment ";; Function-Def lib::marshalling::Slice_v::Slice::all")
(set-info :comment ";; marshalling/Slice_v.rs:87:5: 87:53 (#0)")
(set-info :comment ";; Function-Specs lib::marshalling::Slice_v::Slice::drop")
(declare-fun req%lib!marshalling.Slice_v.impl&%1.drop. (lib!marshalling.Slice_v.Slice. Int) Bool)
(declare-const %%global_location_label%%6 Bool)
(assert (forall ((self! lib!marshalling.Slice_v.Slice.) (count! Int)) (! (= (req%lib!marshalling.Slice_v.impl&%1.drop. self! count!) (=> %%global_location_label%%6 (<= (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!))) count!) (- (uHi SZ) 1)))) :pattern ((req%lib!marshalling.Slice_v.impl&%1.drop. self! count!)) )))
(declare-fun ens%lib!marshalling.Slice_v.impl&%1.drop. (lib!marshalling.Slice_v.Slice. Int lib!marshalling.Slice_v.Slice.) Bool)
(assert (forall ((self! lib!marshalling.Slice_v.Slice.) (count! Int) (%return! lib!marshalling.Slice_v.Slice.)) (! (= (ens%lib!marshalling.Slice_v.impl&%1.drop. self! count! %return!) (has_type (Poly%lib!marshalling.Slice_v.Slice. %return!) TYPE%lib!marshalling.Slice_v.Slice.)) :pattern ((ens%lib!marshalling.Slice_v.impl&%1.drop. self! count! %return!)) )))
(set-info :comment ";; Function-Def lib::marshalling::Slice_v::Slice::drop")
(set-info :comment ";; marshalling/Slice_v.rs:101:5: 101:60 (#0)")
(declare-const %return! lib!marshalling.Slice_v.Slice.)
...
(assert (<= (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!))) count!) (- (uHi SZ) 1)))
(set-info :comment ";; possible arithmetic underflow/overflow")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (uInv SZ (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!))) count!)))))
(check-sat)
(exit)
