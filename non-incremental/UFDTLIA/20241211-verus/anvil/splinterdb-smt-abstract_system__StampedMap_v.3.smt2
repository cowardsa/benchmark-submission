...
(assert (has_type self! (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.)))
(assert (has_type history! TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. self!))) (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? history!) (=> (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? history! (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. self!)))) (=> %%location_label%%0 (req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map. history! self!)))))))
(check-sat)
(exit)
