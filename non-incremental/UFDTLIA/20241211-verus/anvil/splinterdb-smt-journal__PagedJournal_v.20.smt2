...
(assert (not (=> (lib!journal.PagedJournal_v.impl&%1.can_crop.? self! depth!) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))) (=> (= tmp%3 (I (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/boundary_lsn (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))) (=> %%location_label%%0 (req%lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records. tmp%2 tmp%3 depth!)))))))
(check-sat)
(exit)
