...
(assert (<= 0 old_lsn!))
(assert (<= 0 new_lsn!))
(assert (=> (is-core!option.Option./Some_ ojr!) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ojr!))) (I old_lsn!))))
...
(assert (not (or (and (=> (is-core!option.Option./Some_ ojr!) (=> (= tmp%1 (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ojr!))))) (and (=> %%location_label%%0 (req%lib!journal.PagedJournal_v.impl&%0.new_boundary_valid. tmp%1 old_lsn! new_lsn!)) (=> (ens%lib!journal.PagedJournal_v.impl&%0.new_boundary_valid. tmp%1 old_lsn! new_lsn!) %%switch_label%%0)))) (=> (not (is-core!option.Option./Some_ ojr!)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%1 (=> (is-core!option.Option./Some_ ojr!) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ojr!))) (I new_lsn!))))))))
(check-sat)
(exit)
