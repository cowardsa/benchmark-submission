...
(declare-const self! lib!journal.PagedJournal_v.TruncatedJournal.)
(declare-const depth! Int)
(declare-const tmp%1 lib!journal.PagedJournal_v.JournalRecord.)
(declare-const tmp%2 Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!) TYPE%lib!journal.PagedJournal_v.TruncatedJournal.))
(assert (<= 0 depth!))
(assert (lib!journal.PagedJournal_v.impl&%1.wf.? (Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))
(assert (lib!journal.PagedJournal_v.impl&%1.can_crop.? (Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!) (I depth!)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (or (and (=> (< 0 depth!) (=> (= tmp%1 (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. (Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))))))) (=> (= tmp%2 (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/boundary_lsn (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. (Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%0 (req%lib!journal.PagedJournal_v.impl&%0.crop_head_records_lemma. tmp%1 tmp%2 depth!)) (=> (ens%lib!journal.PagedJournal_v.impl&%0.crop_head_records_lemma. tmp%1 tmp%2 depth!) %%switch_label%%0))))) (=> (not (< 0 depth!)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%1 (lib!journal.PagedJournal_v.impl&%1.wf.? (Poly%lib!journal.PagedJournal_v.TruncatedJournal. (lib!journal.PagedJournal_v.impl&%1.crop_head_records.? (Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!) (I depth!)))))))))
(check-sat)
(exit)
