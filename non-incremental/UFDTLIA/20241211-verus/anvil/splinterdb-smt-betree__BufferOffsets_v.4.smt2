...
(assert (not (=> (and (and (<= 0 (%I start!)) (<= (%I start!) (%I end!))) (<= (%I end!) (lib!betree.BufferOffsets_v.impl&%0.len.? self!))) (=> (= tmp%2 (Poly%vstd!seq.Seq<nat.>. (lib!betree.BufferOffsets_v.BufferOffsets./BufferOffsets/offsets (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. self!)))) (=> %%location_label%%0 (req%vstd!seq.Seq.subrange. $ NAT tmp%2 start! end!))))))
(check-sat)
(exit)
