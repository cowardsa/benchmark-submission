...
(assert (not (or (and (=> (and (and (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) (lib!betree.LinkedBetree_v.impl&%5.valid_ranking.? T&. T& self! ranking!)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.child_count. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.child_count.? T&. T& self!)) (=> (= tmp%2 (<= (%I child_idx!) tmp%1)) %%switch_label%%0)))) (=> (not (and (and (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) (lib!betree.LinkedBetree_v.impl&%5.valid_ranking.? T&. T& self! ranking!))) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
