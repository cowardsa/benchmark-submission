...
(assert (not (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!) (=> (<= (%I lsn!) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (or (and (=> (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) (%I lsn!)) (and (=> %%location_label%%0 (req%lib!abstract_system.MsgHistory_v.impl&%0.discard_old. self! lsn!)) (=> (= tmp%1 (lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? self! lsn!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) (%I lsn!))) (=> (= tmp%2 (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
