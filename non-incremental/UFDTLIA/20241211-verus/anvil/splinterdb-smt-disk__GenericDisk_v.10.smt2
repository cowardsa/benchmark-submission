...
(set-info :comment ";; Function-Recommends lib::disk::GenericDisk_v::first_page")
(set-info :comment ";; disk/GenericDisk_v.rs:59:1: 59:62 (#0)")
...
(set-info :comment ";; Function-Recommends lib::disk::GenericDisk_v::Address::next")
(set-info :comment ";; disk/GenericDisk_v.rs:47:5: 47:52 (#0)")
(set-info :comment ";; Function-Axioms lib::disk::GenericDisk_v::Address::next")
(assert (fuel_bool_default fuel%lib!disk.GenericDisk_v.impl&%0.next.))
(assert (=> (fuel_bool fuel%lib!disk.GenericDisk_v.impl&%0.next.) (forall ((self! Poly)) (! (= (lib!disk.GenericDisk_v.impl&%0.next.? self!) (lib!spec.AsyncDisk_t.Address./Address (%I (I (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. self!)))) (%I (I (nClip (Add (lib!spec.AsyncDisk_t.Address./Address/page (%Poly%lib!spec.AsyncDisk_t.Address. self!)) 1)))))) :pattern ((lib!disk.GenericDisk_v.impl&%0.next.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec.AsyncDisk_t.Address.) (has_type (Poly%lib!spec.AsyncDisk_t.Address. (lib!disk.GenericDisk_v.impl&%0.next.? self!)) TYPE%lib!spec.AsyncDisk_t.Address.)) :pattern ((lib!disk.GenericDisk_v.impl&%0.next.? self!)) )))
...
(set-info :comment ";; Function-Recommends lib::disk::GenericDisk_v::to_aus")
(set-info :comment ";; disk/GenericDisk_v.rs:76:1: 76:65 (#0)")
(set-info :comment ";; Function-Axioms lib::disk::GenericDisk_v::to_aus")
(assert (fuel_bool_default fuel%lib!disk.GenericDisk_v.to_aus.))
(declare-fun %%lambda%%1 () %%Function%%)
(assert (forall ((addr$ Poly)) (! (= (%%apply%%0 %%lambda%%1 addr$) (I (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. addr$)))) :pattern ((%%apply%%0 %%lambda%%1 addr$)))))
(assert (=> (fuel_bool fuel%lib!disk.GenericDisk_v.to_aus.) (forall ((addrs! Poly)) (! (= (lib!disk.GenericDisk_v.to_aus.? addrs!) (%Poly%vstd!set.Set<nat.>. (vstd!set_lib.impl&%0.map.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT addrs! (Poly%fun%1. (mk_fun %%lambda%%1))))) :pattern ((lib!disk.GenericDisk_v.to_aus.? addrs!)) ))))
...
(set-info :comment ";; Function-Recommends lib::disk::GenericDisk_v::page_count")
(set-info :comment ";; disk/GenericDisk_v.rs:25:1: 25:47 (#0)")
...
(set-info :comment ";; Function-Recommends lib::disk::GenericDisk_v::au_count")
(set-info :comment ";; disk/GenericDisk_v.rs:30:1: 30:43 (#0)")
...
(set-info :comment ";; Function-Recommends lib::disk::GenericDisk_v::min_addr")
(set-info :comment ";; disk/GenericDisk_v.rs:68:1: 68:70 (#0)")
(set-info :comment ";; Function-Axioms lib::disk::GenericDisk_v::min_addr")
(assert (fuel_bool_default fuel%lib!disk.GenericDisk_v.min_addr.))
(assert (=> (fuel_bool fuel%lib!disk.GenericDisk_v.min_addr.) (forall ((a! Poly) (b! Poly)) (! (= (lib!disk.GenericDisk_v.min_addr.? a! b!) (%Poly%lib!spec.AsyncDisk_t.Address. (ite (< (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. a!)) (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. b!))) a! (ite (> (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. a!)) (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. b!))) b! (ite (<= (lib!spec.AsyncDisk_t.Address./Address/page (%Poly%lib!spec.AsyncDisk_t.Address. a!)) (lib!spec.AsyncDisk_t.Address./Address/page (%Poly%lib!spec.AsyncDisk_t.Address. b!))) a! b!))))) :pattern ((lib!disk.GenericDisk_v.min_addr.? a! b!)) ))))
(assert (forall ((a! Poly) (b! Poly)) (! (=> (and (has_type a! TYPE%lib!spec.AsyncDisk_t.Address.) (has_type b! TYPE%lib!spec.AsyncDisk_t.Address.)) (has_type (Poly%lib!spec.AsyncDisk_t.Address. (lib!disk.GenericDisk_v.min_addr.? a! b!)) TYPE%lib!spec.AsyncDisk_t.Address.)) :pattern ((lib!disk.GenericDisk_v.min_addr.? a! b!)) )))
(set-info :comment ";; Function-Recommends lib::disk::GenericDisk_v::addr_range")
(set-info :comment ";; disk/GenericDisk_v.rs:80:1: 80:101 (#0)")
(declare-const %return! vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.)
(declare-const au! Poly)
(declare-const start! Poly)
(declare-const end_excl! Poly)
(declare-const addr@ Poly)
(assert fuel_defaults)
(assert (has_type au! (UINT 32)))
(assert (has_type start! (UINT 32)))
(assert (has_type end_excl! (UINT 32)))
(assert (not true))
(check-sat)
(exit)
