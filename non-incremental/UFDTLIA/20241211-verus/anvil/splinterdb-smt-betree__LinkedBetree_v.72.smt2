...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& self! ranking!)) (=> (and (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (lib!betree.LinkedBetree_v.impl&%5.valid_ranking.? T&. T& self! ranking!)) (or (and (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)) (ranking!$1 (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!)) (child_idx!$2 0)) (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!$0) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!$1))) decrease%init0 true)) (=> (= root_addr@ (%Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/root (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))))))) (=> (= tmp%1 (vstd!set.impl&%0.union.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. root_addr@) (Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. sub_tree_addrs@))) %%switch_label%%0)))) (=> (not (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) (=> (= tmp%1 (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.)) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
