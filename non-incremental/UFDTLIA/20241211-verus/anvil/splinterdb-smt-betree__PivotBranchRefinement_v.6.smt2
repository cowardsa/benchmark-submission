...
(declare-const tmp%2 vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>.)
(declare-const i@ Int)
(declare-const key$1@ Poly)
(declare-const tmp%3 vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>.)
...
(declare-fun %%choose%%2 (Type Int Int Dcr Type Poly Dcr Type Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly) (%%hole%%9 Dcr) (%%hole%%10 Type) (%%hole%%11 Poly)) (! (=> (exists ((i$1 Poly)) (! (and (has_type i$1 %%hole%%0) (and (and (<= %%hole%%1 (%I i$1)) (< (%I i$1) %%hole%%2)) (vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$1))) %%hole%%8))) :pattern ((vstd!seq.Seq.index.? %%hole%%9 %%hole%%10 %%hole%%11 i$1)) )) (exists ((i$1 Poly)) (! (and (and (has_type i$1 %%hole%%0) (and (and (<= %%hole%%1 (%I i$1)) (< (%I i$1) %%hole%%2)) (vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$1))) %%hole%%8))) (= (%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11) i$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%9 %%hole%%10 %%hole%%11 i$1))))) :pattern ((%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11)))))
...
(assert (not (=> (= children@ (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. node!)))) (and (=> (has_type key@ TYPE%lib!spec.KeyType_t.Key.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.children_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!))) key@) (=> (= i@ (%I (as_type (%%choose%%2 INT 0 (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)) $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) $ TYPE%lib!spec.KeyType_t.Key. key@ $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)) INT))) (=> (= tmp%1 (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PivotBranchRefinement_v.map_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))) (I i@)) key@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (lib!betree.PivotBranchRefinement_v.map_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))) (and (=> %%location_label%%1 (req%lib!betree.Utils_v.lemma_set_subset_of_union_seq_of_sets. $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. tmp%2) key@)) (=> (ens%lib!betree.Utils_v.lemma_set_subset_of_union_seq_of_sets. $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. tmp%2) key@) (=> %%location_label%%2 (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranchRefinement_v.union_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))) key@))))))))))) (=> (forall ((key$ Poly)) (! (=> (has_type key$ TYPE%lib!spec.KeyType_t.Key.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.children_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!))) key$) (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranchRefinement_v.union_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))) key$))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.children_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!))) key$)) )) (and (=> (has_type key$1@ TYPE%lib!spec.KeyType_t.Key.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranchRefinement_v.union_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))) key$1@) (=> (= tmp%3 (lib!betree.PivotBranchRefinement_v.map_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))) (and (=> %%location_label%%3 (req%lib!betree.Utils_v.lemma_union_seq_of_sets_contains. $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. tmp%3) key$1@)) (=> (ens%lib!betree.Utils_v.lemma_union_seq_of_sets_contains. $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. tmp%3) key$1@) (=> %%location_label%%4 (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.children_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!))) key$1@))))))) (=> (forall ((key$ Poly)) (! (=> (has_type key$ TYPE%lib!spec.KeyType_t.Key.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranchRefinement_v.union_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))) key$) (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.children_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!))) key$))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.children_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!))) key$)) )) (=> (= tmp%4 (ext_eq false (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.children_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!))) (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranchRefinement_v.union_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))))) (and (=> %%location_label%%5 tmp%4) (=> tmp%4 (=> %%location_label%%6 (= (lib!betree.PivotBranch_v.impl&%3.children_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!)) (lib!betree.PivotBranchRefinement_v.union_all_keys.? (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. node!)))))))))))))))))
(check-sat)
(exit)
