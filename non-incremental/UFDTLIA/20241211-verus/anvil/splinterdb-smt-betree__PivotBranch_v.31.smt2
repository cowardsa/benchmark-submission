...
(assert (not (=> (lib!betree.PivotBranch_v.impl&%1.wf.? split_arg! self!) (or (and (=> (is-lib!betree.PivotBranch_v.Node./Leaf_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (and (=> %%location_label%%0 (req%lib!betree.PivotBranch_v.impl&%3.split_leaf. self! split_arg!)) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%3.split_leaf.? self! split_arg!)) (=> (= tmp%3 tmp%1) %%switch_label%%0)))) (=> (not (is-lib!betree.PivotBranch_v.Node./Leaf_ (%Poly%lib!betree.PivotBranch_v.Node. self!))) (and (=> %%location_label%%1 (req%lib!betree.PivotBranch_v.impl&%3.split_index. self! split_arg!)) (=> (= tmp%2 (lib!betree.PivotBranch_v.impl&%3.split_index.? self! split_arg!)) (=> (= tmp%3 tmp%2) %%switch_label%%0))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
