...
(assert (tr_bound%lib!marshalling.Marshalling_v.Deepview. Self%&. Self%& $ INT))
(assert (tr_bound%builtin!Integer. Self%&. Self%&))
(assert (tr_bound%builtin!SpecOrd. Self%&. Self%& Self%&. Self%&))
(assert (tr_bound%lib!marshalling.StaticallySized_v.StaticallySized. Self%&. Self%&))
(assert (tr_bound%lib!marshalling.IntegerMarshalling_v.IntFormattable. Self%&. Self%&))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> (has_type v@ Self%&) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.deepv_is_as_int. Self%&. Self%& v@) (=> %%location_label%%0 (= (%I (lib!marshalling.Marshalling_v.Deepview.deepv.? Self%&. Self%& $ INT v@)) (%I v@))))) (=> (forall ((v$ Poly)) (! (=> (has_type v$ Self%&) (= (%I (lib!marshalling.Marshalling_v.Deepview.deepv.? Self%&. Self%& $ INT v$)) (%I v$))) :pattern ((lib!marshalling.Marshalling_v.Deepview.deepv.? Self%&. Self%& $ INT v$)) )) (=> %%location_label%%1 (forall ((v$ Poly)) (! (=> (has_type v$ Self%&) (= (%I (lib!marshalling.Marshalling_v.Deepview.deepv.? Self%&. Self%& $ INT v$)) (%I v$))) :pattern ((lib!marshalling.Marshalling_v.Deepview.deepv.? Self%&. Self%& $ INT v$)) )))))))
(check-sat)
(exit)
