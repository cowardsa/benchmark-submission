...
(declare-const new_child@ lib!betree.PivotBetree_v.BetreeNode.)
(declare-const r@ Int)
...
(assert (not (=> (= decrease%init0 (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. (Poly%lib!betree.PivotBetree_v.Path. (lib!betree.PivotBetree_v.impl&%4.subpath.? self!))))) (=> (= tmp%1 (Poly%lib!betree.PivotBetree_v.Path. (lib!betree.PivotBetree_v.impl&%4.subpath.? self!))) (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.PivotBetree_v.Path. tmp%1)) (replacement!$1 (%Poly%lib!betree.PivotBetree_v.BetreeNode. replacement!))) (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. (Poly%lib!betree.PivotBetree_v.Path. self!$0)))) decrease%init0 true))))))
(check-sat)
(exit)
