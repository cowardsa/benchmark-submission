...
(assert (not (=> (lib!journal.PagedJournal_v.impl&%0.can_crop_head_records.? self! boundary_lsn! depth!) (or (and (=> (= (%I depth!) 0) (=> (= tmp%4 (core!option.Option./Some self!)) %%switch_label%%0)) (=> (not (= (%I depth!) 0)) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.cropped_prior.? self! boundary_lsn!))) (=> (= tmp%3 (I (nClip (Sub (%I depth!) 1)))) (and (=> %%location_label%%0 (req%lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records. tmp%2 boundary_lsn! tmp%3)) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.cropped_prior.? self! boundary_lsn!)) boundary_lsn! (I (nClip (Sub (%I depth!) 1))))) (=> (= tmp%4 tmp%1) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
