...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.has_root.? self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (lib!betree.LinkedBranch_v.impl&%3.valid_child_index.? (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) i!) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%2 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (= tmp%4 (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. tmp%2))))) (=> %%location_label%%2 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%4 i!)))))))))))
(check-sat)
(exit)
