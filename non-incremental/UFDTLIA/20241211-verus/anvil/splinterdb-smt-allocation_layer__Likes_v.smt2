...
(set-info :comment ";; MODULE 'module allocation_layer::Likes_v'")
...
(assert (distinct fuel%lib!allocation_layer.Likes_v.no_likes. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(declare-datatypes ((lib!spec.AsyncDisk_t.Address. 0)) (((lib!spec.AsyncDisk_t.Address./Address (lib!spec.AsyncDisk_t.Address./Address/?au Int) (lib!spec.AsyncDisk_t.Address./Address/?page Int)))))
...
(set-info :comment ";; Function-Recommends lib::allocation_layer::Likes_v::no_likes")
(set-info :comment ";; allocation_layer/Likes_v.rs:15:5: 15:50 (#0)")
