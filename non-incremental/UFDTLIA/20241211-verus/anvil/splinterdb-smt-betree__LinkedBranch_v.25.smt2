...
(declare-const tmp%8 lib!betree.LinkedBranch_v.Path.)
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%6.valid.? self!) (=> (= tmp%2 (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.root. tmp%2)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.root.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))))) (=> (= tmp%4 (Poly%lib!spec.KeyType_t.Key. (lib!betree.LinkedBranch_v.Path./Path/key (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%3.route. (Poly%lib!betree.LinkedBranch_v.Node. tmp%1) tmp%4)) (=> (= tmp%3 (lib!betree.LinkedBranch_v.impl&%3.route.? (Poly%lib!betree.LinkedBranch_v.Node. tmp%1) (Poly%lib!spec.KeyType_t.Key. (lib!betree.LinkedBranch_v.Path./Path/key (%Poly%lib!betree.LinkedBranch_v.Path. self!))))) (=> (= tmp%6 (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (and (=> %%location_label%%2 (req%lib!betree.LinkedBranch_v.impl&%5.root. tmp%6)) (=> (= tmp%5 (lib!betree.LinkedBranch_v.impl&%5.root.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))))) (and (=> %%location_label%%3 (req%lib!betree.LinkedBranch_v.impl&%3.route. (Poly%lib!betree.LinkedBranch_v.Node. tmp%5) other_key!)) (=> (= tmp%7 (lib!betree.LinkedBranch_v.impl&%3.route.? (Poly%lib!betree.LinkedBranch_v.Node. tmp%5) other_key!)) (or (and (=> (= tmp%3 tmp%7) (or (and (=> (< 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!))) (and (=> %%location_label%%4 (req%lib!betree.LinkedBranch_v.impl&%6.subpath. self!)) (=> (= tmp%8 (lib!betree.LinkedBranch_v.impl&%6.subpath.? self!)) (and (=> %%location_label%%5 (req%lib!betree.LinkedBranch_v.impl&%6.path_equiv. (Poly%lib!betree.LinkedBranch_v.Path. tmp%8) other_key!)) (=> (= tmp%9 (lib!betree.LinkedBranch_v.impl&%6.path_equiv.? (Poly%lib!betree.LinkedBranch_v.Path. tmp%8) other_key!)) (=> (= tmp%10 tmp%9) %%switch_label%%1)))))) (=> (not (< 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (=> (= tmp%10 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%11 tmp%10) %%switch_label%%0)))) (=> (not (= tmp%3 tmp%7)) (=> (= tmp%11 false) %%switch_label%%0))) (not %%switch_label%%0))))))))))))))))
(check-sat)
(exit)
