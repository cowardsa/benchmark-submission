...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.has_root.? self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (is-lib!betree.LinkedBranch_v.Node./Index_ (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%2 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (and (=> %%location_label%%2 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%3 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (= (vstd!seq.Seq.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? self!)))))) (nClip (Add (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.LinkedBranch_v.Node./Index/pivots (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? self!)))))) 1))) (or (and (=> (and (<= 0 (%I from!)) (< (%I from!) (%I to!))) (and (=> %%location_label%%3 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%4 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (= tmp%5 (<= (%I to!) (vstd!seq.Seq.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. tmp%4))))))) %%switch_label%%0)))) (=> (not (and (<= 0 (%I from!)) (< (%I from!) (%I to!)))) (=> (= tmp%5 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (and (and (<= 0 (%I from!)) (< (%I from!) (%I to!))) (<= (%I to!) (vstd!seq.Seq.len.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? self!)))))))) (and (=> %%location_label%%4 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%6 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (= tmp%8 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.LinkedBranch_v.Node./Index/pivots (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. tmp%6))))) (=> (= tmp%9 (I (Sub (%I to!) 1))) (and (=> %%location_label%%5 (req%vstd!seq.Seq.subrange. $ TYPE%lib!spec.KeyType_t.Key. tmp%8 from! tmp%9)) (=> (= tmp%7 (vstd!seq.Seq.subrange.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.LinkedBranch_v.Node./Index/pivots (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. tmp%6)))) from! (I (Sub (%I to!) 1)))) (and (=> %%location_label%%6 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%10 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (= tmp%12 (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBranch_v.Node./Index/children (%Poly%lib!betree.LinkedBranch_v.Node. (Poly%lib!betree.LinkedBranch_v.Node. tmp%10))))) (=> %%location_label%%7 (req%vstd!seq.Seq.subrange. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%12 from! to!)))))))))))))))))))))))))
(check-sat)
(exit)
