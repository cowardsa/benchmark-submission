...
(declare-const tmp%1 vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>.)
(declare-const tmp%2 Poly)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.PivotBetree_v.Path.))
(assert (has_type replacement! TYPE%lib!betree.PivotBetree_v.BetreeNode.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!betree.PivotBetree_v.impl&%4.can_substitute.? self! replacement!) (or (and (=> (= (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. self!)) 0) (=> (= tmp%2 replacement!) %%switch_label%%0)) (=> (not (= (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. self!)) 0)) (and (=> %%location_label%%0 (req%lib!betree.PivotBetree_v.impl&%4.replaced_children. self! replacement!)) (=> (= tmp%1 (lib!betree.PivotBetree_v.impl&%4.replaced_children.? self! replacement!)) (=> (= tmp%2 (Poly%lib!betree.PivotBetree_v.BetreeNode. (lib!betree.PivotBetree_v.BetreeNode./Node (%Poly%lib!betree.Buffer_v.SimpleBuffer. (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.PivotBetree_v.BetreeNode./Node/buffer (%Poly%lib!betree.PivotBetree_v.BetreeNode. (Poly%lib!betree.PivotBetree_v.BetreeNode. (lib!betree.PivotBetree_v.Path./Path/node (%Poly%lib!betree.PivotBetree_v.Path. self!))))))) (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. (Poly%lib!betree.PivotBetree_v.BetreeNode. (lib!betree.PivotBetree_v.Path./Path/node (%Poly%lib!betree.PivotBetree_v.Path. self!))))))) (%Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. tmp%1))))) %%switch_label%%0))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
