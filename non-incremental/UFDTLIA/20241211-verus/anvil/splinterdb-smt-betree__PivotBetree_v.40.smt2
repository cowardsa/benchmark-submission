...
(declare-const tmp%4 lib!betree.Domain_v.Domain.)
(declare-const tmp%5 lib!betree.PivotTable_v.PivotTable.)
(declare-const tmp%6 Poly)
(declare-const tmp%7 Poly)
(declare-const tmp%8 Poly)
(declare-const tmp%9 Poly)
(declare-const tmp%10 lib!betree.PivotTable_v.PivotTable.)
...
(declare-const left_filter@ lib!betree.Domain_v.Domain.)
(declare-const right_filter@ lib!betree.Domain_v.Domain.)
(declare-const new_left@ lib!betree.PivotBetree_v.BetreeNode.)
(declare-const new_right@ lib!betree.PivotBetree_v.BetreeNode.)
...
(assert (not (=> (lib!betree.PivotBetree_v.impl&%1.can_split_index.? self! pivot_idx!) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))))))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Element. tmp%2 pivot_idx!)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))))) pivot_idx!)) (=> (= split_element@ (%Poly%lib!spec.KeyType_t.Element. tmp%1)) (and (=> %%location_label%%1 (req%lib!betree.PivotBetree_v.impl&%1.my_domain. self!)) (=> (= tmp%3 (lib!betree.PivotBetree_v.impl&%1.my_domain.? self!)) (=> (= left_filter@ (lib!betree.Domain_v.Domain./Domain (%Poly%lib!spec.KeyType_t.Element. (Poly%lib!spec.KeyType_t.Element. (lib!betree.Domain_v.Domain./Domain/start (%Poly%lib!betree.Domain_v.Domain. (Poly%lib!betree.Domain_v.Domain. tmp%3))))) (%Poly%lib!spec.KeyType_t.Element. (Poly%lib!spec.KeyType_t.Element. split_element@)))) (and (=> %%location_label%%2 (req%lib!betree.PivotBetree_v.impl&%1.my_domain. self!)) (=> (= tmp%4 (lib!betree.PivotBetree_v.impl&%1.my_domain.? self!)) (=> (= right_filter@ (lib!betree.Domain_v.Domain./Domain (%Poly%lib!spec.KeyType_t.Element. (Poly%lib!spec.KeyType_t.Element. split_element@)) (%Poly%lib!spec.KeyType_t.Element. (Poly%lib!spec.KeyType_t.Element. (lib!betree.Domain_v.Domain./Domain/end (%Poly%lib!betree.Domain_v.Domain. (Poly%lib!betree.Domain_v.Domain. tmp%4))))))) (=> (= tmp%6 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (=> (= tmp%7 (I (Add (%I pivot_idx!) 1))) (and (=> %%location_label%%3 (req%lib!betree.PivotTable_v.impl&%0.subrange. tmp%6 (I 0) tmp%7)) (=> (= tmp%5 (lib!betree.PivotTable_v.impl&%0.subrange.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (I 0) (I (Add (%I pivot_idx!) 1)))) (=> (= tmp%9 (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%4 (req%vstd!seq.Seq.subrange. $ TYPE%lib!betree.PivotBetree_v.BetreeNode. tmp%9 (I 0) pivot_idx!)) (=> (= tmp%8 (vstd!seq.Seq.subrange.? $ TYPE%lib!betree.PivotBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (I 0) pivot_idx!)) (=> (= new_left@ (lib!betree.PivotBetree_v.BetreeNode./Node (%Poly%lib!betree.Buffer_v.SimpleBuffer. (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.Buffer_v.impl&%1.apply_filter.? (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.PivotBetree_v.BetreeNode./Node/buffer (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.Domain_v.impl&%1.key_set.? (Poly%lib!betree.Domain_v.Domain. left_filter@)))))) (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. tmp%5)) (%Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. tmp%8))) (=> (= tmp%11 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (=> (= tmp%12 (I (lib!betree.PivotTable_v.impl&%0.len.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))))) (and (=> %%location_label%%5 (req%lib!betree.PivotTable_v.impl&%0.subrange. tmp%11 pivot_idx! tmp%12)) (=> (= tmp%10 (lib!betree.PivotTable_v.impl&%0.subrange.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) pivot_idx! (I (lib!betree.PivotTable_v.impl&%0.len.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))))))) (=> (= tmp%14 (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (=> (= tmp%15 (I (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))))) (=> %%location_label%%6 (req%vstd!seq.Seq.subrange. $ TYPE%lib!betree.PivotBetree_v.BetreeNode. tmp%14 pivot_idx! tmp%15)))))))))))))))))))))))))))))
(check-sat)
(exit)
