...
(set-info :comment ";; betree/LinkedBranch_v.rs:385:5: 385:84 (#0)")
(declare-const %return! vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>.)
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.valid_ranking. self! ranking!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!)) (=> (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%2 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (is-lib!betree.LinkedBranch_v.Node./Index_ (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (or (and (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (and (=> %%location_label%%2 (req%lib!betree.LinkedBranch_v.impl&%5.valid_ranking. self! ranking!)) (=> (= tmp%3 (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!)) (=> (= tmp%4 tmp%3) %%switch_label%%0)))) (=> (not (lib!betree.LinkedBranch_v.impl&%5.wf.? self!)) (=> (= tmp%4 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (and (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!)) (and (=> %%location_label%%3 (req%lib!betree.LinkedBranch_v.impl&%5.get_rank. self! ranking!)) (=> (= tmp%5 (lib!betree.LinkedBranch_v.impl&%5.get_rank.? self! ranking!)) (=> %%location_label%%4 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!))))))))))))))))
(check-sat)
(exit)
