...
(declare-const decrease%init0 lib!betree.PivotBetree_v.BetreeNode.)
...
(assert (not (=> (= decrease%init0 (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)) (=> (= decrease%init1 1) (or (and (=> (lib!betree.PivotBetree_v.impl&%1.local_structure.? self!) (or (and (=> (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)) (and (=> %%location_label%%0 (check_decrease_height (Poly%lib!betree.PivotBetree_v.BetreeNode. (let ((self!$0 (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) self!$0)) (Poly%lib!betree.PivotBetree_v.BetreeNode. decrease%init0) (check_decrease_int (let ((self!$0 (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) 0) decrease%init1 false))) (=> (= tmp%1 (lib!betree.PivotBetree_v.impl&%1.wf_children.? self!)) (=> (= tmp%2 (and tmp%1 (lib!betree.PivotBetree_v.impl&%1.linked_children.? self!))) %%switch_label%%1)))) (=> (not (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (=> (= tmp%2 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%3 tmp%2) %%switch_label%%0)))) (=> (not (lib!betree.PivotBetree_v.impl&%1.local_structure.? self!)) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
