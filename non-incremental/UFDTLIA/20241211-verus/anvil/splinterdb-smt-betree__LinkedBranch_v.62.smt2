...
(set-info :comment ";; betree/LinkedBranch_v.rs:500:5: 500:114 (#0)")
(declare-const %return! vstd!seq.Seq<vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.>.)
(declare-const self! Poly)
(declare-const ranking! Poly)
(declare-const tmp%1 Bool)
(declare-const tmp%2 lib!betree.LinkedBranch_v.Node.)
(declare-const tmp%3 Int)
(declare-const tmp%4 lib!betree.LinkedBranch_v.Node.)
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.valid_ranking. self! ranking!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!)) (=> (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%2 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (is-lib!betree.LinkedBranch_v.Node./Index_ (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (and (=> %%location_label%%2 (req%lib!betree.LinkedBranch_v.impl&%5.get_rank. self! ranking!)) (=> (= tmp%3 (lib!betree.LinkedBranch_v.impl&%5.get_rank.? self! ranking!)) (=> %%location_label%%3 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)))))))))))))
(check-sat)
(exit)
