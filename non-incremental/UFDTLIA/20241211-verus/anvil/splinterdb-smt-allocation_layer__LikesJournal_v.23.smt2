...
(set-info :comment ";; MODULE 'module allocation_layer::LikesJournal_v'")
...
(declare-const fuel%lib!allocation_layer.LikesJournal_v.lsn_disjoint. FuelId)
...
(declare-const fuel%lib!allocation_layer.LikesJournal_v.impl&%2.index_reflects_disk_view. FuelId)
(declare-const fuel%lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries. FuelId)
...
(declare-const fuel%lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old. FuelId)
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_empty. fuel%vstd!map.axiom_map_insert_domain. fuel%vstd!map.axiom_map_insert_same. fuel%vstd!map.axiom_map_insert_different. fuel%vstd!map.axiom_map_remove_domain. fuel%vstd!map.axiom_map_remove_different. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!map_lib.impl&%0.contains_key. fuel%vstd!map_lib.impl&%0.contains_value. fuel%vstd!map_lib.impl&%0.values. fuel%vstd!map_lib.impl&%0.submap_of. fuel%vstd!map_lib.impl&%0.spec_le. fuel%vstd!map_lib.impl&%0.union_prefer_right. fuel%vstd!math.max. fuel%vstd!multiset.impl&%0.insert. fuel%vstd!multiset.axiom_multiset_empty. fuel%vstd!multiset.axiom_multiset_singleton. fuel%vstd!multiset.axiom_multiset_singleton_different. fuel%vstd!multiset.axiom_multiset_add. fuel%vstd!multiset.axiom_multiset_ext_equal. fuel%vstd!multiset.axiom_multiset_ext_equal_deep. fuel%vstd!set.impl&%0.subset_of. fuel%vstd!set.impl&%0.spec_add. fuel%vstd!set.impl&%0.choose. fuel%vstd!set.impl&%0.disjoint. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_remove_same. fuel%vstd!set.axiom_set_remove_insert. fuel%vstd!set.axiom_set_remove_different. fuel%vstd!set.axiom_set_union. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_mk_map_domain. fuel%vstd!set.axiom_mk_map_index. fuel%vstd!set.axiom_set_empty_finite. fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_remove_finite. fuel%vstd!set.axiom_set_union_finite. fuel%vstd!set.axiom_set_choose_finite. fuel%vstd!set.axiom_set_empty_len. fuel%vstd!set.axiom_set_insert_len. fuel%vstd!set.axiom_set_remove_len. fuel%vstd!set.axiom_set_contains_len. fuel%vstd!set.axiom_set_choose_len. fuel%vstd!set_lib.impl&%0.to_multiset. fuel%lib!abstract_system.MsgHistory_v.impl&%0.wf. fuel%lib!abstract_system.MsgHistory_v.impl&%0.ext_equal. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_exactly. fuel%lib!abstract_system.MsgHistory_v.impl&%0.is_empty. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_follow. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_concat. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to. fuel%lib!abstract_system.MsgHistory_v.impl&%0.discard_old. fuel%lib!allocation_layer.Likes_v.no_likes. fuel%lib!allocation_layer.LikesJournal_v.lsn_disjoint. fuel%lib!allocation_layer.LikesJournal_v.lsn_addr_index_discard_up_to. fuel%lib!allocation_layer.LikesJournal_v.singleton_index. fuel%lib!allocation_layer.LikesJournal_v.lsn_addr_index_append_record. fuel%lib!allocation_layer.LikesJournal_v.impl&%1.buildable. fuel%lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index. fuel%lib!allocation_layer.LikesJournal_v.impl&%2.addr_supports_lsn. fuel%lib!allocation_layer.LikesJournal_v.impl&%2.cropped_msg_seq_contains_lsn. fuel%lib!allocation_layer.LikesJournal_v.impl&%2.tj_at. fuel%lib!allocation_layer.LikesJournal_v.impl&%2.index_reflects_disk_view. fuel%lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries. fuel%lib!allocation_layer.LikesJournal_v.map_to_likes. fuel%lib!allocation_layer.LikesJournal_v.impl&%3.build_lsn_addr_index. fuel%lib!allocation_layer.LikesJournal_v.impl&%3.discard_old_cond. fuel%lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old. fuel%lib!allocation_layer.LikesJournal_v.max. fuel%lib!allocation_layer.LikesJournal_v.impl&%5.index_domain_valid. fuel%lib!allocation_layer.LikesJournal_v.impl&%5.every_lsn_at_addr_indexed_to_addr. fuel%lib!allocation_layer.LikesJournal_v.impl&%5.index_range_valid. fuel%lib!journal.LinkedJournal_v.impl&%0.wf. fuel%lib!journal.LinkedJournal_v.impl&%0.has_link. fuel%lib!journal.LinkedJournal_v.impl&%0.cropped_prior. fuel%lib!journal.LinkedJournal_v.impl&%0.contains_lsn. fuel%lib!journal.LinkedJournal_v.impl&%1.entries_wf. fuel%lib!journal.LinkedJournal_v.impl&%1.is_nondangling_pointer. fuel%lib!journal.LinkedJournal_v.impl&%1.nondangling_pointers. fuel%lib!journal.LinkedJournal_v.impl&%1.this_block_can_concat. fuel%lib!journal.LinkedJournal_v.impl&%1.blocks_can_concat. fuel%lib!journal.LinkedJournal_v.impl&%1.blocks_each_have_link. fuel%lib!journal.LinkedJournal_v.impl&%1.block_in_bounds. fuel%lib!journal.LinkedJournal_v.impl&%1.wf. fuel%lib!journal.LinkedJournal_v.impl&%1.valid_ranking. fuel%lib!journal.LinkedJournal_v.impl&%1.acyclic. fuel%lib!journal.LinkedJournal_v.impl&%1.the_ranking. fuel%lib!journal.LinkedJournal_v.impl&%1.decodable. fuel%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. fuel%lib!journal.LinkedJournal_v.impl&%1.seq_start. fuel%lib!journal.LinkedJournal_v.impl&%1.seq_end. fuel%lib!journal.LinkedJournal_v.impl&%1.is_sub_disk. fuel%lib!journal.LinkedJournal_v.impl&%1.is_sub_disk_with_newer_lsn. fuel%lib!journal.LinkedJournal_v.impl&%1.build_tight. fuel%lib!journal.LinkedJournal_v.impl&%1.can_crop. fuel%lib!journal.LinkedJournal_v.impl&%1.pointer_after_crop. fuel%lib!journal.LinkedJournal_v.impl&%1.next. fuel%lib!journal.LinkedJournal_v.impl&%2.wf. fuel%lib!journal.LinkedJournal_v.impl&%2.seq_start. fuel%lib!journal.LinkedJournal_v.impl&%2.seq_end. fuel%lib!journal.LinkedJournal_v.impl&%2.can_discard_to. fuel%lib!journal.LinkedJournal_v.impl&%2.decodable. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(set-info :comment ";; Function-Decl lib::abstract_system::MsgHistory_v::MsgHistory::ext_equal")
(declare-fun lib!abstract_system.MsgHistory_v.impl&%0.ext_equal.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::allocation_layer::LikesJournal_v::lsn_disjoint")
(declare-fun lib!allocation_layer.LikesJournal_v.lsn_disjoint.? (Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl lib::journal::LinkedJournal_v::DiskView::index_reflects_disk_view")
(declare-fun lib!allocation_layer.LikesJournal_v.impl&%2.index_reflects_disk_view.? (Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl lib::abstract_system::MsgHistory_v::MsgHistory::tight_discard_old")
(declare-fun lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old.? (Poly Poly Poly) Bool)
...
(assert (forall ((self! Poly) (lsn! Poly)) (! (= (req%lib!journal.LinkedJournal_v.impl&%2.can_discard_to. self! lsn!) (=> %%global_location_label%%20 (lib!journal.LinkedJournal_v.impl&%2.wf.? self!))) :pattern ((req%lib!journal.LinkedJournal_v.impl&%2.can_discard_to. self! lsn!)) )))
...
(assert (forall ((self! Poly)) (! (= (req%lib!journal.LinkedJournal_v.impl&%1.the_ranking. self!) (and (=> %%global_location_label%%21 (lib!journal.LinkedJournal_v.impl&%1.wf.? self!)) (=> %%global_location_label%%22 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)))) :pattern ((req%lib!journal.LinkedJournal_v.impl&%1.the_ranking. self!)) )))
...
(assert (forall ((self! Poly) (ptr! Poly)) (! (= (req%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. self! ptr!) (=> %%global_location_label%%23 (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! ptr!))) :pattern ((req%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. self! ptr!)) )))
...
(assert (forall ((self! Poly) (root! Poly)) (! (= (req%lib!journal.LinkedJournal_v.impl&%1.build_tight. self! root!) (and (=> %%global_location_label%%24 (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!)) (=> %%global_location_label%%25 (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!)))) :pattern ((req%lib!journal.LinkedJournal_v.impl&%1.build_tight. self! root!)) )))
...
(set-info :comment ";; Function-Recommends lib::journal::LinkedJournal_v::DiskView::addr_supports_lsn")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:128:5: 128:87 (#0)")
...
(set-info :comment ";; Function-Recommends lib::journal::LinkedJournal_v::DiskView::buildable")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:98:5: 98:69 (#0)")
...
(set-info :comment ";; Function-Recommends lib::journal::LinkedJournal_v::DiskView::tj_at")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:176:5: 176:77 (#0)")
...
(assert (forall ((self! Poly) (start_lsn! Poly) (keep_addrs! Poly) (new! Poly)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%3.discard_old_cond. self! start_lsn! keep_addrs! new!) (=> %%global_location_label%%26 (lib!journal.LinkedJournal_v.impl&%2.wf.? self!))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%3.discard_old_cond. self! start_lsn! keep_addrs! new!)) )))
(set-info :comment ";; Function-Recommends lib::journal::LinkedJournal_v::TruncatedJournal::discard_old_cond")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:499:5: 499:114 (#0)")
...
(assert (forall ((%%hole%%0 Poly) (x$ Poly)) (! (= (%%apply%%0 (%%lambda%%6 %%hole%%0) x$) %%hole%%0) :pattern ((%%apply%%0 (%%lambda%%6 %%hole%%0) x$)))))
(assert (=> (fuel_bool fuel%lib!allocation_layer.LikesJournal_v.singleton_index.) (forall ((start! Poly) (end! Poly) (value! Poly)) (! (= (lib!allocation_layer.LikesJournal_v.singleton_index.? start! end! value!) (%Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (vstd!map.impl&%0.new.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. $ (TYPE%fun%1. $ NAT $ BOOL) $ (TYPE%fun%1. $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%fun%1. (mk_fun (%%lambda%%3 (%I start!) (%I end!)))) (Poly%fun%1. (mk_fun (%%lambda%%6 value!)))))) :pattern ((lib!allocation_layer.LikesJournal_v.singleton_index.? start! end! value!)) ))))
...
(assert (forall ((lsn_addr_index! Poly) (msgs! Poly) (addr! Poly)) (! (= (req%lib!allocation_layer.LikesJournal_v.lsn_addr_index_append_record. lsn_addr_index! msgs! addr!) (and (=> %%global_location_label%%27 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? msgs!)) (=> %%global_location_label%%28 (< (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. msgs!)) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. msgs!)))))) :pattern ((req%lib!allocation_layer.LikesJournal_v.lsn_addr_index_append_record. lsn_addr_index! msgs! addr!)) )))
(set-info :comment ";; Function-Recommends lib::allocation_layer::LikesJournal_v::lsn_addr_index_append_record")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:58:1: 58:134 (#0)")
...
(assert (forall ((self! Poly) (root! Poly)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index. self! root!) (and (=> %%global_location_label%%29 (lib!allocation_layer.LikesJournal_v.impl&%1.buildable.? self! root!)) (=> %%global_location_label%%30 (and (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!))))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index. self! root!)) )))
(set-info :comment ";; Spec-Termination lib::journal::LinkedJournal_v::DiskView::build_lsn_addr_index")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:105:5: 105:88 (#0)")
(set-info :comment ";; Function-Recommends lib::journal::LinkedJournal_v::DiskView::build_lsn_addr_index")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:105:5: 105:88 (#0)")
...
(assert (forall ((self! Poly)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%3.build_lsn_addr_index. self!) (=> %%global_location_label%%31 (lib!journal.LinkedJournal_v.impl&%2.decodable.? self!))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%3.build_lsn_addr_index. self!)) )))
(set-info :comment ";; Function-Recommends lib::journal::LinkedJournal_v::TruncatedJournal::build_lsn_addr_index")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:478:5: 478:74 (#0)")
...
(assert (forall ((A&. Dcr) (A& Type) (self! Poly)) (! (= (req%vstd!set_lib.impl&%0.to_multiset. A&. A& self!) (=> %%global_location_label%%32 (vstd!set.impl&%0.finite.? A&. A& self!))) :pattern ((req%vstd!set_lib.impl&%0.to_multiset. A&. A& self!)) )))
...
(assert (forall ((lsn_addr_map! Poly)) (! (= (req%lib!allocation_layer.LikesJournal_v.map_to_likes. lsn_addr_map!) (=> %%global_location_label%%33 (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_map!)))) :pattern ((req%lib!allocation_layer.LikesJournal_v.map_to_likes. lsn_addr_map!)) )))
(set-info :comment ";; Spec-Termination lib::allocation_layer::LikesJournal_v::map_to_likes")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:464:1: 464:76 (#0)")
(set-info :comment ";; Function-Recommends lib::allocation_layer::LikesJournal_v::map_to_likes")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:464:1: 464:76 (#0)")
...
(set-info :comment ";; Function-Axioms lib::abstract_system::MsgHistory_v::MsgHistory::ext_equal")
...
(set-info :comment ";; Function-Recommends lib::allocation_layer::LikesJournal_v::lsn_disjoint")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:30:1: 30:86 (#0)")
(set-info :comment ";; Function-Axioms lib::allocation_layer::LikesJournal_v::lsn_disjoint")
(assert (fuel_bool_default fuel%lib!allocation_layer.LikesJournal_v.lsn_disjoint.))
(assert (=> (fuel_bool fuel%lib!allocation_layer.LikesJournal_v.lsn_disjoint.) (forall ((lsn_index! Poly) (msgs! Poly)) (! (= (lib!allocation_layer.LikesJournal_v.lsn_disjoint.? lsn_index! msgs!) (forall ((lsn$ Poly)) (! (=> (has_type lsn$ NAT) (=> (and (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. msgs!)) (%I lsn$)) (< (%I lsn$) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. msgs!)))) (not (vstd!set.impl&%0.contains.? $ NAT lsn_index! lsn$)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT lsn_index! lsn$)) ))) :pattern ((lib!allocation_layer.LikesJournal_v.lsn_disjoint.? lsn_index! msgs!)) ))))
(set-info :comment ";; Function-Recommends lib::allocation_layer::LikesJournal_v::max")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:545:15: 545:44 (#0)")
...
(set-info :comment ";; Function-Recommends lib::journal::LinkedJournal_v::DiskView::cropped_msg_seq_contains_lsn")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:168:19: 172:14 (#0)")
...
(set-info :comment ";; Function-Axioms lib::journal::LinkedJournal_v::DiskView::index_reflects_disk_view")
(assert (fuel_bool_default fuel%lib!allocation_layer.LikesJournal_v.impl&%2.index_reflects_disk_view.))
(assert (=> (fuel_bool fuel%lib!allocation_layer.LikesJournal_v.impl&%2.index_reflects_disk_view.) (forall ((self! Poly) (lsn_addr_index! Poly)) (! (= (lib!allocation_layer.LikesJournal_v.impl&%2.index_reflects_disk_view.? self! lsn_addr_index!) (forall ((lsn$ Poly)) (! (=> (has_type lsn$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index!) lsn$) (and (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index! lsn$)) (lib!abstract_system.MsgHistory_v.impl&%0.contains.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index! lsn$))))) lsn$)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index!) lsn$)) ))) :pattern ((lib!allocation_layer.LikesJournal_v.impl&%2.index_reflects_disk_view.? self! lsn_addr_index!)) ))))
...
(assert (forall ((self! Poly) (lsn_addr_index! Poly)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries. self! lsn_addr_index!) (=> %%global_location_label%%34 (lib!journal.LinkedJournal_v.impl&%1.wf.? self!))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries. self! lsn_addr_index!)) )))
(set-info :comment ";; Function-Recommends lib::journal::LinkedJournal_v::DiskView::index_keys_map_to_valid_entries")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:441:5: 441:108 (#0)")
(set-info :comment ";; Function-Axioms lib::journal::LinkedJournal_v::DiskView::index_keys_map_to_valid_entries")
(assert (=> (fuel_bool fuel%lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries.) (forall ((self! Poly) (lsn_addr_index! Poly)) (! (= (lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries.? self! lsn_addr_index!) (forall ((lsn$ Poly)) (! (=> (has_type lsn$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index!) lsn$) (lib!allocation_layer.LikesJournal_v.impl&%2.addr_supports_lsn.? self! (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index! lsn$) lsn$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index!) lsn$)) ))) :pattern ((lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries.? self! lsn_addr_index!)) ))))
(set-info :comment ";; Function-Specs lib::abstract_system::MsgHistory_v::MsgHistory::tight_discard_old")
(declare-fun req%lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old. (Poly Poly Poly) Bool)
(declare-const %%global_location_label%%35 Bool)
(declare-const %%global_location_label%%36 Bool)
(declare-const %%global_location_label%%37 Bool)
(assert (forall ((self! Poly) (new! Poly) (new_bdy! Poly)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old. self! new! new_bdy!) (and (=> %%global_location_label%%35 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!)) (=> %%global_location_label%%36 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? new!)) (=> %%global_location_label%%37 (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? self! new_bdy!)))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old. self! new! new_bdy!)) )))
(set-info :comment ";; Function-Recommends lib::abstract_system::MsgHistory_v::MsgHistory::tight_discard_old")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:533:5: 533:87 (#0)")
(set-info :comment ";; Function-Axioms lib::abstract_system::MsgHistory_v::MsgHistory::tight_discard_old")
(assert (fuel_bool_default fuel%lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old.))
(assert (=> (fuel_bool fuel%lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old.) (forall ((self! Poly) (new! Poly) (new_bdy! Poly)) (! (= (lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old.? self! new! new_bdy!) (let ((msgs$ (ite (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) (%I new_bdy!)) (lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? self! new_bdy!) (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))) (lib!abstract_system.MsgHistory_v.impl&%0.ext_equal.? new! (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. msgs$)))) :pattern ((lib!allocation_layer.LikesJournal_v.impl&%4.tight_discard_old.? self! new! new_bdy!)) ))))
...
(assert (forall ((self! Poly) (lsn_addr_index! Poly)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%5.index_domain_valid. self! lsn_addr_index!) (=> %%global_location_label%%38 (lib!journal.LinkedJournal_v.impl&%2.wf.? self!))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%5.index_domain_valid. self! lsn_addr_index!)) )))
(set-info :comment ";; Function-Recommends lib::journal::LinkedJournal_v::TruncatedJournal::index_domain_valid")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:566:5: 566:93 (#0)")
...
(assert (forall ((self! Poly) (lsn_addr_index! Poly)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%5.index_range_valid. self! lsn_addr_index!) (and (=> %%global_location_label%%39 (lib!journal.LinkedJournal_v.impl&%2.wf.? self!)) (=> %%global_location_label%%40 (lib!allocation_layer.LikesJournal_v.impl&%5.index_domain_valid.? self! lsn_addr_index!)) (=> %%global_location_label%%41 (lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries.? (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))) lsn_addr_index!)))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%5.index_range_valid. self! lsn_addr_index!)) )))
...
(set-info :comment ";; Function-Specs lib::journal::LinkedJournal_v::DiskView::build_lsn_addr_all_decodable")
(declare-fun req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_all_decodable. (lib!journal.LinkedJournal_v.DiskView. core!option.Option.) Bool)
(declare-const %%global_location_label%%42 Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.DiskView.) (root! core!option.Option.)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_all_decodable. self! root!) (=> %%global_location_label%%42 (lib!allocation_layer.LikesJournal_v.impl&%1.buildable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_all_decodable. self! root!)) )))
(declare-fun ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_all_decodable. (lib!journal.LinkedJournal_v.DiskView. core!option.Option.) Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.DiskView.) (root! core!option.Option.)) (! (= (ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_all_decodable. self! root!) (forall ((lsn$ Poly)) (! (=> (has_type lsn$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))) lsn$) (lib!journal.LinkedJournal_v.impl&%1.decodable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) lsn$)))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))) lsn$)) ))) :pattern ((ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_all_decodable. self! root!)) )))
(set-info :comment ";; Function-Def lib::journal::LinkedJournal_v::DiskView::build_lsn_addr_all_decodable")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:348:5: 348:67 (#0)")
...
(assert (forall ((self! lib!journal.LinkedJournal_v.DiskView.) (root! core!option.Option.)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_domain_valid. self! root!) (and (=> %%global_location_label%%43 (lib!journal.LinkedJournal_v.impl&%1.decodable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (=> %%global_location_label%%44 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (=> %%global_location_label%%45 (is-core!option.Option./Some_ root!)) (=> %%global_location_label%%46 (< (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. root!))))))))))))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_domain_valid. self! root!)) )))
...
(set-info :comment ";; Function-Def lib::journal::LinkedJournal_v::DiskView::build_lsn_addr_index_domain_valid")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:181:5: 181:72 (#0)")
(set-info :comment ";; Function-Specs lib::journal::LinkedJournal_v::DiskView::build_lsn_addr_honors_rank")
(declare-fun req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_honors_rank. (lib!journal.LinkedJournal_v.DiskView. core!option.Option. vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.) Bool)
(declare-const %%global_location_label%%47 Bool)
(declare-const %%global_location_label%%48 Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.DiskView.) (root! core!option.Option.) (lsn_addr_index! vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_honors_rank. self! root! lsn_addr_index!) (and (=> %%global_location_label%%47 (lib!allocation_layer.LikesJournal_v.impl&%1.buildable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (=> %%global_location_label%%48 (= lsn_addr_index! (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_honors_rank. self! root! lsn_addr_index!)) )))
(declare-fun ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_honors_rank. (lib!journal.LinkedJournal_v.DiskView. core!option.Option. vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.) Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.DiskView.) (root! core!option.Option.) (lsn_addr_index! vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.)) (! (= (ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_honors_rank. self! root! lsn_addr_index!) (forall ((lsn1$ Poly) (lsn2$ Poly)) (! (=> (and (has_type lsn1$ NAT) (has_type lsn2$ NAT)) (=> (and (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!)) lsn1$) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!)) lsn2$)) (<= (%I lsn1$) (%I lsn2$))) (<= (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!) lsn1$)))) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!) lsn2$))))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!)) lsn1$) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!)) lsn2$)) ))) :pattern ((ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_honors_rank. self! root! lsn_addr_index!)) )))
(set-info :comment ";; Function-Def lib::journal::LinkedJournal_v::DiskView::build_lsn_addr_honors_rank")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:371:5: 371:100 (#0)")
(set-info :comment ";; Function-Specs lib::journal::LinkedJournal_v::TruncatedJournal::build_lsn_addr_honors_rank")
(declare-fun req%lib!allocation_layer.LikesJournal_v.impl&%5.build_lsn_addr_honors_rank. (lib!journal.LinkedJournal_v.TruncatedJournal. vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.) Bool)
(declare-const %%global_location_label%%49 Bool)
(declare-const %%global_location_label%%50 Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.TruncatedJournal.) (lsn_addr_index! vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%5.build_lsn_addr_honors_rank. self! lsn_addr_index!) (and (=> %%global_location_label%%49 (lib!journal.LinkedJournal_v.impl&%2.decodable.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))) (=> %%global_location_label%%50 (= lsn_addr_index! (lib!allocation_layer.LikesJournal_v.impl&%3.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%5.build_lsn_addr_honors_rank. self! lsn_addr_index!)) )))
(declare-fun ens%lib!allocation_layer.LikesJournal_v.impl&%5.build_lsn_addr_honors_rank. (lib!journal.LinkedJournal_v.TruncatedJournal. vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.) Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.TruncatedJournal.) (lsn_addr_index! vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.)) (! (= (ens%lib!allocation_layer.LikesJournal_v.impl&%5.build_lsn_addr_honors_rank. self! lsn_addr_index!) (forall ((lsn1$ Poly) (lsn2$ Poly)) (! (=> (and (has_type lsn1$ NAT) (has_type lsn2$ NAT)) (=> (and (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!)) lsn1$) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!)) lsn2$)) (<= (%I lsn1$) (%I lsn2$))) (<= (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (Poly%core!option.Option. (core!option.Option./Some (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!) lsn1$)))) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (Poly%core!option.Option. (core!option.Option./Some (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!) lsn2$))))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!)) lsn1$) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. lsn_addr_index!)) lsn2$)) ))) :pattern ((ens%lib!allocation_layer.LikesJournal_v.impl&%5.build_lsn_addr_honors_rank. self! lsn_addr_index!)) )))
(set-info :comment ";; Function-Def lib::journal::LinkedJournal_v::TruncatedJournal::build_lsn_addr_honors_rank")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:595:5: 595:85 (#0)")
...
(assert (forall ((self! lib!journal.LinkedJournal_v.TruncatedJournal.) (start_lsn! Int) (keep_addrs! vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.) (new! lib!journal.LinkedJournal_v.TruncatedJournal.)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%3.discard_old_preserves_acyclicity. self! start_lsn! keep_addrs! new!) (and (=> %%global_location_label%%51 (lib!journal.LinkedJournal_v.impl&%2.wf.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))) (=> %%global_location_label%%52 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))))) (=> %%global_location_label%%53 (lib!journal.LinkedJournal_v.impl&%2.can_discard_to.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!) (I start_lsn!))) (=> %%global_location_label%%54 (lib!allocation_layer.LikesJournal_v.impl&%3.discard_old_cond.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!) (I start_lsn!) (Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. keep_addrs!) (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. new!))))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%3.discard_old_preserves_acyclicity. self! start_lsn! keep_addrs! new!)) )))
...
(set-info :comment ";; Function-Def lib::journal::LinkedJournal_v::TruncatedJournal::discard_old_preserves_acyclicity")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:510:5: 510:109 (#0)")
(set-info :comment ";; Function-Specs lib::journal::LinkedJournal_v::DiskView::build_lsn_addr_index_range_valid")
(declare-fun req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. (lib!journal.LinkedJournal_v.DiskView. core!option.Option.) Bool)
(declare-const %%global_location_label%%55 Bool)
(declare-const %%global_location_label%%56 Bool)
(declare-const %%global_location_label%%57 Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.DiskView.) (root! core!option.Option.)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. self! root!) (and (=> %%global_location_label%%55 (lib!allocation_layer.LikesJournal_v.impl&%1.buildable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (=> %%global_location_label%%56 (lib!allocation_layer.LikesJournal_v.impl&%5.index_domain_valid.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!allocation_layer.LikesJournal_v.impl&%2.tj_at.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))))) (=> %%global_location_label%%57 (lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))))))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. self! root!)) )))
(declare-fun ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. (lib!journal.LinkedJournal_v.DiskView. core!option.Option.) Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.DiskView.) (root! core!option.Option.)) (! (= (ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. self! root!) (lib!allocation_layer.LikesJournal_v.impl&%5.index_range_valid.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!allocation_layer.LikesJournal_v.impl&%2.tj_at.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))))) :pattern ((ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. self! root!)) )))
(set-info :comment ";; Function-Def lib::journal::LinkedJournal_v::DiskView::build_lsn_addr_index_range_valid")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:206:5: 206:71 (#0)")
...
(declare-const sub_index@ vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.)
(declare-const index@ vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.)
...
(assert (lib!allocation_layer.LikesJournal_v.impl&%1.buildable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))
(assert (lib!allocation_layer.LikesJournal_v.impl&%5.index_domain_valid.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!allocation_layer.LikesJournal_v.impl&%2.tj_at.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))))
(assert (lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))))
...
(assert (not (=> (= decrease%init0 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (=> (fuel_bool fuel%lib!allocation_layer.LikesJournal_v.impl&%5.index_domain_valid.) (=> (fuel_bool fuel%lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries.) (or (and (=> (is-core!option.Option./None_ root!) (=> (= tmp%1 (lib!allocation_layer.LikesJournal_v.impl&%5.index_range_valid.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!allocation_layer.LikesJournal_v.impl&%2.tj_at.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (is-core!option.Option./None_ root!)) (or (and (=> (is-core!option.Option./None_ (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (=> (= tmp%2 (lib!allocation_layer.LikesJournal_v.impl&%5.index_range_valid.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!allocation_layer.LikesJournal_v.impl&%2.tj_at.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%1)))) (=> (not (is-core!option.Option./None_ (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!)))) (=> (= tmp%3 (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (and (=> %%location_label%%2 (req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_domain_valid. self! tmp%3)) (=> (ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_domain_valid. self! tmp%3) (=> (= tmp%4 (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (and (=> %%location_label%%3 (check_decrease_int (let ((self!$0 self!) (root!$1 tmp%4)) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!$0) (Poly%core!option.Option. root!$1))) decrease%init0 false)) (and (=> %%location_label%%4 (req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. self! tmp%4)) (=> (ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. self! tmp%4) (=> (= tj@ (lib!allocation_layer.LikesJournal_v.impl&%2.tj_at.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (=> (= sub_index@ (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))))) (=> (= index@ (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (and (=> (has_type addr@ TYPE%lib!spec.AsyncDisk_t.Address.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map_lib.impl&%0.values.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. index@)) addr@) (or (and (=> (not (= addr@ (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. root!))))) (=> (= tmp%5 (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map_lib.impl&%0.values.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. sub_index@)) addr@)) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 %%switch_label%%2)))) (=> (not (not (= addr@ (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. root!)))))) %%switch_label%%2)) (and (not %%switch_label%%2) (=> %%location_label%%6 (lib!allocation_layer.LikesJournal_v.impl&%5.every_lsn_at_addr_indexed_to_addr.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. tj@) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. index@) addr@)))))) (=> (forall ((addr$ Poly)) (! (=> (has_type addr$ TYPE%lib!spec.AsyncDisk_t.Address.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map_lib.impl&%0.values.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. index@)) addr$) (lib!allocation_layer.LikesJournal_v.impl&%5.every_lsn_at_addr_indexed_to_addr.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. tj@) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. index@) addr$))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map_lib.impl&%0.values.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. index@)) addr$)) :pattern ((lib!allocation_layer.LikesJournal_v.impl&%5.every_lsn_at_addr_indexed_to_addr.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. tj@) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. index@) addr$)) )) (=> (= tmp%6 (lib!allocation_layer.LikesJournal_v.impl&%5.index_range_valid.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!allocation_layer.LikesJournal_v.impl&%2.tj_at.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))))) (and (=> %%location_label%%7 tmp%6) (=> tmp%6 %%switch_label%%1))))))))))))))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%8 (lib!allocation_layer.LikesJournal_v.impl&%5.index_range_valid.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!allocation_layer.LikesJournal_v.impl&%2.tj_at.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))))))))))))
(check-sat)
(exit)
