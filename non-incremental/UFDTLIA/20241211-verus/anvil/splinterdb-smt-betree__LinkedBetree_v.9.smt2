...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%1.entries_wf.? self!) (=> (lib!betree.LinkedBetree_v.impl&%0.wf.? node!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%1.node_has_nondangling_child_ptrs. self! node!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%1.node_has_nondangling_child_ptrs.? self! node!)) (=> (lib!betree.LinkedBetree_v.impl&%1.node_has_nondangling_child_ptrs.? self! node!) (=> (has_type i@ NAT) (or (and (=> (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? node! i@) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%1.child_linked. self! node! i@)) (=> (= tmp%2 (lib!betree.LinkedBetree_v.impl&%1.child_linked.? self! node! i@)) (=> (= tmp%3 tmp%2) %%switch_label%%0)))) (=> (not (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? node! i@)) (=> (= tmp%3 true) %%switch_label%%0))) (not %%switch_label%%0))))))))))
(check-sat)
(exit)
