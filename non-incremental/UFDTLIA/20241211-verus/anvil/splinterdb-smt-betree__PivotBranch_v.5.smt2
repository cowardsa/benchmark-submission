...
(assert (not (or (and (=> (is-lib!betree.PivotBranch_v.Node./Leaf_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (= tmp%2 (let ((keys$ (lib!betree.PivotBranch_v.Node./Leaf/keys (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (let ((msgs$ (lib!betree.PivotBranch_v.Node./Leaf/msgs (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (vstd!seq_lib.impl&%0.to_set.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys$))))) %%switch_label%%0)) (=> (not (is-lib!betree.PivotBranch_v.Node./Leaf_ (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= pivots@ (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= children@ (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!))) (and (=> %%location_label%%0 (req%lib!betree.PivotBranch_v.impl&%3.children_keys. self!)) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%3.children_keys.? self!)) (=> (= tmp%2 (vstd!set.impl&%0.union.? $ TYPE%lib!spec.KeyType_t.Key. (vstd!seq_lib.impl&%0.to_set.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. pivots@)) (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. tmp%1))) %%switch_label%%0))))))) (not %%switch_label%%0))))
(check-sat)
(exit)
