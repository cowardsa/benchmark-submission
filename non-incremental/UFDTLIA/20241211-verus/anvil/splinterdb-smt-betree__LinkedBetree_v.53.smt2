...
(declare-const tmp%1 lib!betree.LinkedBetree_v.LinkedBetree.)
...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. self!))) (or (and (=> (= (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. self!)) 0) (=> (= tmp%3 (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!))) %%switch_label%%0)) (=> (not (= (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. self!)) 0)) (=> (= tmp%2 (Poly%lib!betree.LinkedBetree_v.Path. (lib!betree.LinkedBetree_v.impl&%10.subpath.? T&. T& self!))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBetree_v.Path. tmp%2))) (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. (Poly%lib!betree.LinkedBetree_v.Path. self!$0)))) decrease%init0 false)) (=> (has_type (Poly%lib!betree.LinkedBetree_v.LinkedBetree. tmp%1) (TYPE%lib!betree.LinkedBetree_v.LinkedBetree. T&. T&)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%10.target.? T&. T& (Poly%lib!betree.LinkedBetree_v.Path. (lib!betree.LinkedBetree_v.impl&%10.subpath.? T&. T& self!)))) (=> (= tmp%3 tmp%1) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
