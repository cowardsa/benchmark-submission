...
(assert (<= 0 depth!))
(assert (lib!journal.LinkedJournal_v.impl&%2.can_crop.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!) (I depth!)))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (=> (= tmp%2 (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.pointer_after_crop_ensures. tmp%1 tmp%2 depth!)) (=> (ens%lib!journal.LinkedJournal_v.impl&%1.pointer_after_crop_ensures. tmp%1 tmp%2 depth!) (=> %%location_label%%1 (lib!journal.LinkedJournal_v.impl&%2.wf.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!journal.LinkedJournal_v.impl&%2.crop.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!) (I depth!)))))))))))
(check-sat)
(exit)
