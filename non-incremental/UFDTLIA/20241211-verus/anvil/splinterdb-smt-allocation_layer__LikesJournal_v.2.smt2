...
(assert (not (or (and (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (= tmp%2 tmp%1) %%switch_label%%2)))) (=> (not (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!)) (=> (= tmp%2 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%2 (or (and (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. root!)) (and (=> %%location_label%%1 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. root!)) (=> (= tmp%3 (core!option.Option./Some/0 (%Poly%core!option.Option. root!))) (=> (= tmp%5 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (and (=> %%location_label%%2 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. tmp%5 tmp%3)) (=> (= tmp%4 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) tmp%3)) (=> (= tmp%6 (< (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. tmp%4))))))) %%switch_label%%1))))))) (=> (not (is-core!option.Option./Some_ (%Poly%core!option.Option. root!))) (=> (= tmp%6 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%7 tmp%6) %%switch_label%%0)))) (=> (not tmp%2) (=> (= tmp%7 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
