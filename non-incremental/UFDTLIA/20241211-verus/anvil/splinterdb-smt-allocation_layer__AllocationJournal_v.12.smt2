...
(declare-const tmp%10 vstd!map.Map<nat./nat.>.)
...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!) (or (and (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%2 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (= tmp%3 tmp%2) %%switch_label%%1)))) (=> (not (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!)) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (and (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (and (=> %%location_label%%2 (req%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. self! root!)) (=> (= tmp%4 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? self! root!)) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. root!)) (=> (= tmp%11 (vstd!map.impl&%0.empty.? $ NAT $ NAT)) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. root!))) (and (=> %%location_label%%3 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. root!)) (=> (= tmp%5 (core!option.Option./Some/0 (%Poly%core!option.Option. root!))) (=> (= tmp%7 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (and (=> %%location_label%%4 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. tmp%7 tmp%5)) (=> (= tmp%6 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) tmp%5)) (=> (= curr_msgs@ (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. tmp%6))) (and (=> %%location_label%%5 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. root!)) (=> (= tmp%8 (core!option.Option./Some/0 (%Poly%core!option.Option. root!))) (=> (= update@ (lib!allocation_layer.AllocationJournal_v.singleton_index.? (I (nClip (vstd!math.max.? (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (I (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. curr_msgs@))))))) (I (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. curr_msgs@)))) (I (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. tmp%8))))) (and (=> %%location_label%%6 (req%lib!journal.LinkedJournal_v.impl&%1.next. self! root!)) (=> (= tmp%9 (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!)) (and (=> %%location_label%%7 (req%lib!allocation_layer.AllocationJournal_v.impl&%1.build_lsn_au_index_page_walk. self! (Poly%core!option.Option. tmp%9))) (=> (= tmp%10 (lib!allocation_layer.AllocationJournal_v.impl&%1.build_lsn_au_index_page_walk.? self! (Poly%core!option.Option. tmp%9))) (=> (= tmp%11 (vstd!map_lib.impl&%0.union_prefer_right.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. tmp%10) (Poly%vstd!map.Map<nat./nat.>. update@))) %%switch_label%%0)))))))))))))))) (not %%switch_label%%0)))))))))))))
(check-sat)
(exit)
