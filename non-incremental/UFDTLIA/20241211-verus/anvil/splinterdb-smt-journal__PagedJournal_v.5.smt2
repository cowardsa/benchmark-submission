...
(assert (not (or (and (=> (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!))) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!journal.PagedJournal_v.JournalRecord. tmp%2)) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))))) (=> (= tmp%3 (lib!journal.PagedJournal_v.impl&%0.valid.? tmp%1 (I (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/boundary_lsn (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!))))) %%switch_label%%0))))) (=> (not (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.PagedJournal_v.TruncatedJournal. self!)))) (=> (= tmp%3 true) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
