...
(assert (not (=> (= decrease%init0 (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (= decrease%init1 0) (=> (is-lib!betree.PivotBranch_v.Node./Index_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (has_type key@ TYPE%lib!spec.KeyType_t.Key.) (=> (has_type i@ INT) (or (and (=> (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!)))))) (=> (= tmp%2 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!))) i@)) (and (=> %%location_label%%0 (check_decrease_height (Poly%lib!betree.PivotBranch_v.Node. (let ((self!$0 (%Poly%lib!betree.PivotBranch_v.Node. tmp%2))) self!$0)) (Poly%lib!betree.PivotBranch_v.Node. decrease%init0) (check_decrease_int (let ((self!$0 (%Poly%lib!betree.PivotBranch_v.Node. tmp%2))) 1) decrease%init1 false))) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%3.all_keys.? (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!))) i@))) (=> (= tmp%3 (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. tmp%1) key@)) %%switch_label%%0))))) (=> (not (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!))))))) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0)))))))))
(check-sat)
(exit)
