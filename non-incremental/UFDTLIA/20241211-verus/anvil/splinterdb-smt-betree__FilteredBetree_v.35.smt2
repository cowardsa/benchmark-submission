...
(declare-const new_child@ lib!betree.FilteredBetree_v.BetreeNode.)
(declare-const r@ Int)
...
(assert (not (=> (= decrease%init0 (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. (Poly%lib!betree.FilteredBetree_v.Path. (lib!betree.FilteredBetree_v.impl&%4.subpath.? self!))))) (=> (= tmp%1 (Poly%lib!betree.FilteredBetree_v.Path. (lib!betree.FilteredBetree_v.impl&%4.subpath.? self!))) (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.FilteredBetree_v.Path. tmp%1)) (replacement!$1 (%Poly%lib!betree.FilteredBetree_v.BetreeNode. replacement!))) (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. (Poly%lib!betree.FilteredBetree_v.Path. self!$0)))) decrease%init0 true))))))
(check-sat)
(exit)
