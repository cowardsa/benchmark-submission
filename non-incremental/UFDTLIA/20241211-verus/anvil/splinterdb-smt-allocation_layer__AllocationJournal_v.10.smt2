...
(declare-const start_lsn! Poly)
(declare-const end_lsn! Poly)
(declare-const value! Poly)
(declare-const lsn@ Poly)
(declare-const lsn$1@ Poly)
(assert fuel_defaults)
(assert (has_type start_lsn! NAT))
(assert (has_type end_lsn! NAT))
(assert (has_type value! NAT))
(assert (not true))
(check-sat)
(exit)
