...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.wf.? self!) (=> (has_type lsn@ NAT) (or (and (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index!) lsn@) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index! lsn@)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index! lsn@)) (=> (= tmp%2 (lib!allocation_layer.LikesJournal_v.impl&%2.addr_supports_lsn.? self! tmp%1 lsn@)) %%switch_label%%0)))) (=> (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. lsn_addr_index!) lsn@)) (=> (= tmp%2 true) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
