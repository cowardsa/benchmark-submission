...
(declare-const child_addr@ lib!spec.AsyncDisk_t.Address.)
(declare-const tmp%12 Bool)
(declare-const node@ lib!betree.LinkedBetree_v.BetreeNode.)
...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%1.wf.? self!) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!)))) addr!) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking!) addr!) (=> (= tmp%2 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!)))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. tmp%2 addr!)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!))) addr!)) (=> (= node@ (%Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%1)) (=> (has_type idx@ NAT) (or (and (=> (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. node@) idx@) (=> (= tmp%4 (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. node@))))) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) tmp%4 idx@)) (=> (= tmp%3 (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. node@)))) idx@)) (=> (= tmp%5 (is-core!option.Option./Some_ (%Poly%core!option.Option. tmp%3))) %%switch_label%%2))))) (=> (not (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. node@) idx@)) (=> (= tmp%5 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%5 (=> (= tmp%7 (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. node@))))) (and (=> %%location_label%%2 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) tmp%7 idx@)) (=> (= tmp%6 (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. node@)))) idx@)) (and (=> %%location_label%%3 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%6)) (=> (= tmp%8 (core!option.Option./Some/0 (%Poly%core!option.Option. tmp%6))) (=> (= child_addr@ (%Poly%lib!spec.AsyncDisk_t.Address. tmp%8)) (or (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking!) (Poly%lib!spec.AsyncDisk_t.Address. child_addr@)) (and (=> %%location_label%%4 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking! (Poly%lib!spec.AsyncDisk_t.Address. child_addr@))) (=> (= tmp%9 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking! (Poly%lib!spec.AsyncDisk_t.Address. child_addr@))) (and (=> %%location_label%%5 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking! addr!)) (=> (= tmp%10 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking! addr!)) (=> (= tmp%11 (< (%I tmp%9) (%I tmp%10))) %%switch_label%%1)))))) (=> (not (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking!) (Poly%lib!spec.AsyncDisk_t.Address. child_addr@))) (=> (= tmp%11 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%12 tmp%11) %%switch_label%%0)))))))))) (=> (not tmp%5) (=> (= tmp%12 true) %%switch_label%%0))) (not %%switch_label%%0))))))))))))))
(check-sat)
(exit)
