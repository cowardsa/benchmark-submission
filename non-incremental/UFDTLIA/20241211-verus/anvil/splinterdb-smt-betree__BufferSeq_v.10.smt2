...
(assert (not (=> (< 0 (lib!betree.BufferSeq_v.impl&%0.len.? self!)) (=> (= tmp%2 (I (lib!betree.BufferSeq_v.impl&%0.len.? self!))) (=> %%location_label%%0 (req%lib!betree.BufferSeq_v.impl&%0.slice. self! (I 1) tmp%2))))))
(check-sat)
(exit)
