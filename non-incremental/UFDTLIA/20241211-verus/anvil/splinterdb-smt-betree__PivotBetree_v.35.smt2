...
(declare-const tmp%1 lib!betree.PivotBetree_v.Path.)
(declare-const tmp%2 lib!betree.PivotBetree_v.BetreeNode.)
(declare-const tmp%3 lib!betree.PivotBetree_v.BetreeNode.)
...
(assert (not (=> (lib!betree.PivotBetree_v.impl&%4.valid.? self!) (or (and (=> (= (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. self!)) 0) (=> (= tmp%3 (lib!betree.PivotBetree_v.Path./Path/node (%Poly%lib!betree.PivotBetree_v.Path. self!))) %%switch_label%%0)) (=> (not (= (lib!betree.PivotBetree_v.Path./Path/depth (%Poly%lib!betree.PivotBetree_v.Path. self!)) 0)) (and (=> %%location_label%%0 (req%lib!betree.PivotBetree_v.impl&%4.subpath. self!)) (=> (= tmp%1 (lib!betree.PivotBetree_v.impl&%4.subpath.? self!)) (and (=> %%location_label%%1 (req%lib!betree.PivotBetree_v.impl&%4.target. (Poly%lib!betree.PivotBetree_v.Path. tmp%1))) (=> (= tmp%2 (lib!betree.PivotBetree_v.impl&%4.target.? (Poly%lib!betree.PivotBetree_v.Path. tmp%1))) (=> (= tmp%3 tmp%2) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
