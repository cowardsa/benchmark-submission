...
(declare-const a! lib!betree.BufferSeq_v.BufferSeq.)
(declare-const b! lib!betree.BufferSeq_v.BufferSeq.)
(declare-const a_start! Int)
(declare-const b_delta! Int)
...
(assert (and (<= 0 a_start!) (<= a_start! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. a!)))))
(assert (let ((tmp%%$ (Add a_start! b_delta!))) (and (<= 0 tmp%%$) (<= tmp%%$ (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. b!))))))
(assert (= (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. a!)) a_start!) (Sub (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. b!)) a_start!) b_delta!)))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= a_start! (%I i$)) (< (%I i$) (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. a!)))) (= (vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. (Poly%lib!betree.BufferSeq_v.BufferSeq. a!)))) i$) (vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. (Poly%lib!betree.BufferSeq_v.BufferSeq. b!)))) (I (Add (%I i$) b_delta!)))))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. (Poly%lib!betree.BufferSeq_v.BufferSeq. a!)))) i$)) )))
...
(assert (not (=> (= decrease%init0 (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. a!)) a_start!)) (or (and (=> (< a_start! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. a!))) (=> (= tmp%1 (Add a_start! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((a!$0 a!) (b!$1 b!) (a_start!$2 tmp%1) (b_delta!$3 b_delta!) (key!$4 key!)) (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. a!$0)) a_start!$2)) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!betree.BufferSeq_v.impl&%0.common_buffer_seqs. a! b! tmp%1 b_delta! key!)) (=> (ens%lib!betree.BufferSeq_v.impl&%0.common_buffer_seqs. a! b! tmp%1 b_delta! key!) %%switch_label%%0))))) (=> (not (< a_start! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. a!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (= (lib!betree.BufferSeq_v.impl&%0.query_from.? (Poly%lib!betree.BufferSeq_v.BufferSeq. a!) (Poly%lib!spec.KeyType_t.Key. key!) (I a_start!)) (lib!betree.BufferSeq_v.impl&%0.query_from.? (Poly%lib!betree.BufferSeq_v.BufferSeq. b!) (Poly%lib!spec.KeyType_t.Key. key!) (I (Add a_start! b_delta!))))))))))
(check-sat)
(exit)
