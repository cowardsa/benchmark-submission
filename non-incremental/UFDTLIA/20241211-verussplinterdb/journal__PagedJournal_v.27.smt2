...
(assert (<= 0 depth!))
(assert (lib!journal.PagedJournal_v.impl&%0.opt_rec_can_crop_head_records.? (Poly%core!option.Option. ojr!) (I boundary_lsn!) (I depth!)))
...
(assert (not (=> (= decrease%init0 depth!) (=> (= decrease%init1 1) (or (and (=> (is-core!option.Option./None_ ojr!) %%switch_label%%0) (=> (not (is-core!option.Option./None_ ojr!)) (=> (= rec@ (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ojr!))))) (or (and (=> (is-core!option.Option./Some_ ojr!) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 rec@) (boundary_lsn!$1 boundary_lsn!) (depth!$2 depth!)) depth!$2) decrease%init0 (check_decrease_int (let ((self!$0 rec@) (boundary_lsn!$1 boundary_lsn!) (depth!$2 depth!)) 0) decrease%init1 false))) (and (=> %%location_label%%1 (req%lib!journal.PagedJournal_v.impl&%0.crop_head_records_lemma. rec@ boundary_lsn! depth!)) (=> (ens%lib!journal.PagedJournal_v.impl&%0.crop_head_records_lemma. rec@ boundary_lsn! depth!) %%switch_label%%1)))) (=> (not (is-core!option.Option./Some_ ojr!)) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%2 (let ((out$ (lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? (Poly%core!option.Option. ojr!) (I boundary_lsn!) (I depth!)))) (=> (is-core!option.Option./Some_ out$) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. out$))) (I boundary_lsn!)))))))))))
(check-sat)
(exit)
