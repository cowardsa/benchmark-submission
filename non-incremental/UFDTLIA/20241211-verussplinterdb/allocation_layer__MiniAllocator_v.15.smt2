...
(declare-const %return! lib!allocation_layer.MiniAllocator_v.MiniAllocator.)
(declare-const self! Poly)
(declare-const aus! Poly)
(declare-const au@ Poly)
(declare-const au$1@ Poly)
(declare-const new_allocs@ vstd!map.Map<nat./lib!allocation_layer.MiniAllocator_v.PageAllocator.>.)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!allocation_layer.MiniAllocator_v.MiniAllocator.))
(assert (has_type aus! (TYPE%vstd!set.Set. $ NAT)))
(declare-fun %%lambda%%2 (Dcr Type Poly) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (au$ Poly)) (! (= (%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1 %%hole%%2) au$) (B (vstd!set.impl&%0.contains.? %%hole%%0 %%hole%%1 %%hole%%2 au$))) :pattern ((%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1 %%hole%%2) au$)))))
(declare-fun %%lambda%%3 (Dcr Type Poly Dcr Type Dcr Type Poly) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Poly) (au$ Poly)) (! (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7) au$) (Poly%lib!allocation_layer.MiniAllocator_v.PageAllocator. (ite (vstd!set.impl&%0.contains.? %%hole%%0 %%hole%%1 %%hole%%2 au$) (%Poly%lib!allocation_layer.MiniAllocator_v.PageAllocator. (vstd!map.impl&%0.index.? %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 au$)) (lib!allocation_layer.MiniAllocator_v.impl&%0.new.? au$)))) :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7) au$)))))
(assert (not true))
(check-sat)
(exit)
