...
(set-info :comment ";; Function-Recommends lib::betree::LinkedBetree_v::LinkedBetree::reachable_betree_addrs_using_ranking_recur")
(set-info :comment ";; betree/LinkedBetree_v.rs:537:5: 537:129 (#0)")
(set-info :comment ";; Spec-Termination lib::betree::LinkedBetree_v::LinkedBetree::reachable_betree_addrs_using_ranking")
(set-info :comment ";; betree/LinkedBetree_v.rs:551:5: 551:107 (#0)")
(set-info :comment ";; Function-Recommends lib::betree::LinkedBetree_v::LinkedBetree::reachable_betree_addrs_using_ranking")
(set-info :comment ";; betree/LinkedBetree_v.rs:551:5: 551:107 (#0)")
(declare-const T&. Dcr)
...
(declare-const sub_tree_addrs@ vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.)
(declare-const root_addr@ vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.)
...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (=> (lib!betree.LinkedBetree_v.impl&%5.valid_ranking.? T&. T& self! ranking!) (=> (and (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (lib!betree.LinkedBetree_v.impl&%5.valid_ranking.? T&. T& self! ranking!)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.get_rank. T&. T& self! ranking!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& self! ranking!)) (or (and (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%5.reachable_betree_addrs_using_ranking_recur. T&. T& self! ranking! (I 0))) (=> (= tmp%3 (Poly%core!option.Option. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/root (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))) (and (=> %%location_label%%2 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%3)) (=> (= tmp%2 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/root (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))))) (=> (= root_addr@ (%Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) tmp%2))) (=> (= tmp%4 (vstd!set.impl&%0.union.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. root_addr@) (Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. sub_tree_addrs@))) %%switch_label%%0))))))) (=> (not (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) (=> (= tmp%4 (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.)) %%switch_label%%0))) (not %%switch_label%%0)))))))))
(check-sat)
(exit)
