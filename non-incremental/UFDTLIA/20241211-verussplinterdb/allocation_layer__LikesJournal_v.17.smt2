...
(declare-const lsn_addr_index! Poly)
(declare-const lsn@ Poly)
(declare-const tmp%1 Int)
(declare-const tmp%2 Bool)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!journal.LinkedJournal_v.TruncatedJournal.))
(assert (has_type lsn_addr_index! (TYPE%vstd!map.Map. $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address.)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%2.wf.? self!) (=> (has_type lsn@ NAT) (or (and (=> (<= (lib!journal.LinkedJournal_v.impl&%2.seq_start.? self!) (%I lsn@)) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%2.seq_end. self!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%2.seq_end.? self!)) (=> (= tmp%2 (< (%I lsn@) tmp%1)) %%switch_label%%0)))) (=> (not (<= (lib!journal.LinkedJournal_v.impl&%2.seq_start.? self!) (%I lsn@))) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
