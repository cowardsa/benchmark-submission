...
(declare-const split_key! Poly)
(declare-const tmp%1 lib!betree.PivotTable_v.PivotTable.)
(declare-const tmp%2 Poly)
(declare-const tmp%3 Poly)
(declare-const tmp%4 lib!betree.PivotTable_v.PivotTable.)
(declare-const tmp%5 Poly)
(declare-const tmp%6 Poly)
(declare-const new_left@ lib!betree.LinkedBetree_v.BetreeNode.)
(declare-const new_right@ lib!betree.LinkedBetree_v.BetreeNode.)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.LinkedBetree_v.BetreeNode.))
(assert (has_type split_key! TYPE%lib!spec.KeyType_t.Key.))
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%0.can_split_leaf.? self! split_key!) (=> (= tmp%2 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/pivots (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))) (=> (= tmp%3 (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!))) (and (=> %%location_label%%0 (req%lib!betree.PivotTable_v.impl&%0.update. tmp%2 (I 1) tmp%3)) (=> (= tmp%1 (lib!betree.PivotTable_v.impl&%0.update.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/pivots (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!))) (I 1) (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!)))) (=> (= new_left@ (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode (%Poly%lib!betree.LinkedSeq_v.LinkedSeq. (Poly%lib!betree.LinkedSeq_v.LinkedSeq. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/buffers (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))) (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. tmp%1)) (%Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))) (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/flushed (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))))) (=> (= tmp%5 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/pivots (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))) (=> (= tmp%6 (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!))) (=> %%location_label%%1 (req%lib!betree.PivotTable_v.impl&%0.update. tmp%5 (I 0) tmp%6))))))))))))
(check-sat)
(exit)
