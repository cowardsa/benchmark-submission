...
(set-info :comment ";; Function-Def lib::betree::LinkedBetree_v::LinkedBetree::tree_likes_domain")
(set-info :comment ";; allocation_layer/LikesBetree_v.rs:142:11: 142:55 (#0)")
(declare-const T&. Dcr)
...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!))) (or (and (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 self!) (ranking!$1 ranking!) (start!$2 0)) (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!$0) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!$1))) decrease%init0 true)) (and (=> %%location_label%%1 (req%lib!allocation_layer.LikesBetree_v.impl&%1.children_likes_domain. T&. T& self! ranking! 0)) (=> (ens%lib!allocation_layer.LikesBetree_v.impl&%1.children_likes_domain. T&. T& self! ranking! 0) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.the_ranking.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!))) (and (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%11.reachable_betree_addrs_ignore_ranking. T&. T& self! tmp%1 ranking!)) (=> (ens%lib!betree.LinkedBetree_v.impl&%11.reachable_betree_addrs_ignore_ranking. T&. T& self! tmp%1 ranking!) (and (=> %%location_label%%3 (req%lib!betree.LinkedBetree_v.impl&%11.reachable_betree_addrs_using_ranking_recur_lemma. T&. T& self! ranking! 0)) (=> (ens%lib!betree.LinkedBetree_v.impl&%11.reachable_betree_addrs_using_ranking_recur_lemma. T&. T& self! ranking! 0) %%switch_label%%0))))))))) (=> (not (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%4 (ext_eq false (TYPE%vstd!set.Set. $ TYPE%lib!spec.AsyncDisk_t.Address.) (vstd!multiset.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesBetree_v.impl&%1.tree_likes.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!)))) (Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedBetree_v.impl&%5.reachable_betree_addrs_using_ranking.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!))))) (=> %%location_label%%5 (vstd!set.impl&%0.subset_of.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!multiset.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesBetree_v.impl&%1.tree_likes.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!)))) (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. (Poly%lib!betree.LinkedBetree_v.DiskView. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/dv (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!))))))))))))))))
(check-sat)
(exit)
