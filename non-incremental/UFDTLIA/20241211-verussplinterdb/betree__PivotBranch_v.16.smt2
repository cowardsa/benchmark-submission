...
(assert (not (=> (lib!betree.PivotBranch_v.impl&%4.valid.? self!) (or (and (=> (= 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!))) (=> (= tmp%3 (lib!betree.PivotBranch_v.Path./Path/node (%Poly%lib!betree.PivotBranch_v.Path. self!))) %%switch_label%%0)) (=> (not (= 0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. self!)))) (and (=> %%location_label%%0 (req%lib!betree.PivotBranch_v.impl&%4.subpath. self!)) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%4.subpath.? self!)) (and (=> %%location_label%%1 (req%lib!betree.PivotBranch_v.impl&%4.target. (Poly%lib!betree.PivotBranch_v.Path. tmp%1))) (=> (= tmp%2 (lib!betree.PivotBranch_v.impl&%4.target.? (Poly%lib!betree.PivotBranch_v.Path. tmp%1))) (=> (= tmp%3 tmp%2) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
