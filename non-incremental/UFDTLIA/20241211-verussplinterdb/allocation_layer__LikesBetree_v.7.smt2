...
(declare-const tree_likes@ vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>.)
...
(assert (not (or (and (=> (not (lib!betree.LinkedBetree_v.impl&%5.acyclic.? T&. T& self!)) (=> (= tmp%2 (tuple%2./tuple%2 (vstd!pervasive.arbitrary.? $ (TYPE%vstd!multiset.Multiset. $ TYPE%lib!spec.AsyncDisk_t.Address.)) (vstd!pervasive.arbitrary.? $ (TYPE%vstd!multiset.Multiset. $ TYPE%lib!spec.AsyncDisk_t.Address.)))) %%switch_label%%0)) (=> (not (not (lib!betree.LinkedBetree_v.impl&%5.acyclic.? T&. T& self!))) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.the_ranking. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.the_ranking.? T&. T& self!)) (and (=> %%location_label%%1 (req%lib!allocation_layer.LikesBetree_v.impl&%1.tree_likes. T&. T& self! (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. tmp%1))) (=> (= tmp%2 (tuple%2./tuple%2 (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. tree_likes@) (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesBetree_v.impl&%1.buffer_likes.? T&. T& self! (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. tree_likes@))))) %%switch_label%%0)))))) (not %%switch_label%%0))))
(check-sat)
(exit)
