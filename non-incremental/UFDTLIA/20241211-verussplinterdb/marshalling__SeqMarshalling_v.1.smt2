...
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.SeqMarshalling_v.SeqMarshal.try_length. Self%&. Self%& self! dslice! data!)) (=> (ens%lib!marshalling.SeqMarshalling_v.SeqMarshal.try_length. Self%&. Self%& self! dslice! data! tmp%1) (=> (ens%core!option.impl&%0.is_some. $ (UINT SZ) (%Poly%core!option.Option. tmp%1) tmp%2) (=> (= l! (B tmp%2)) (=> %%location_label%%1 (= l! (lib!marshalling.SeqMarshalling_v.SeqMarshal.lengthable.? Self%&. Self%& self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))))))))
(check-sat)
(exit)
