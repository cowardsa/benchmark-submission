...
(assert (has_type v! (UINT 64)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!marshalling.IntegerMarshalling_v.usize64_workaround. 0) (=> %%location_label%%0 (<= (%I v!) (%I (lib!marshalling.IntegerMarshalling_v.IntFormattable.max.? $ (UINT 64))))))))
(check-sat)
(exit)
