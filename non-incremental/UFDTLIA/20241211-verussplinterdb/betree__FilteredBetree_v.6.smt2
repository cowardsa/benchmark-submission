...
(assert (not (=> (lib!betree.FilteredBetree_v.impl&%1.local_structure.? self!) (=> (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)) (=> (has_type i@ NAT) (or (and (=> (lib!betree.FilteredBetree_v.impl&%1.valid_child_index.? self! i@) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. tmp%2 i@)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) i@)) (=> (= tmp%3 (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. tmp%1))) %%switch_label%%2))))) (=> (not (lib!betree.FilteredBetree_v.impl&%1.valid_child_index.? self! i@)) (=> (= tmp%3 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%3 (=> (= tmp%5 (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. tmp%5 i@)) (=> (= tmp%4 (vstd!seq.Seq.index.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) i@)) (=> (= tmp%6 (lib!betree.FilteredBetree_v.impl&%1.local_structure.? tmp%4)) %%switch_label%%1))))) (=> (not tmp%3) (=> (= tmp%6 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%6 (=> (= tmp%8 (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%2 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. tmp%8 i@)) (=> (= tmp%7 (vstd!seq.Seq.index.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) i@)) (and (=> %%location_label%%3 (req%lib!betree.FilteredBetree_v.impl&%1.my_domain. tmp%7)) (=> (= tmp%9 (lib!betree.FilteredBetree_v.impl&%1.my_domain.? tmp%7)) (and (=> %%location_label%%4 (req%lib!betree.FilteredBetree_v.impl&%1.child_domain. self! i@)) (=> (= tmp%10 (lib!betree.FilteredBetree_v.impl&%1.child_domain.? self! i@)) (=> (= tmp%11 (= tmp%9 tmp%10)) %%switch_label%%0))))))))) (=> (not tmp%6) (=> (= tmp%11 true) %%switch_label%%0))) (not %%switch_label%%0)))))))))))
(check-sat)
(exit)
