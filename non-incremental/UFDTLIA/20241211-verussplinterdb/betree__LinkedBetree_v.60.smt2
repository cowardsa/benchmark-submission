...
(assert (has_type self! TYPE%lib!betree.LinkedBetree_v.BetreeNode.))
(assert (has_type child_idx! NAT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%0.wf.? self!) (or (and (=> (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? self! child_idx!) (=> (= tmp%2 (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) tmp%2 child_idx!)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!))) child_idx!)) (=> (= tmp%3 (is-core!option.Option./Some_ (%Poly%core!option.Option. tmp%1))) %%switch_label%%0))))) (=> (not (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? self! child_idx!)) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
