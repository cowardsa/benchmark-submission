...
(set-info :comment ";; MODULE 'module betree::Domain_v'")
...
(set-info :comment ";; Function-Decl lib::betree::Domain_v::Domain::arrow_Domain_start")
(declare-fun lib!betree.Domain_v.impl&%0.arrow_Domain_start.? (Poly) lib!spec.KeyType_t.Element.)
(set-info :comment ";; Function-Decl lib::betree::Domain_v::Domain::arrow_Domain_end")
...
(assert (forall ((elem! Poly)) (! (= (req%lib!spec.KeyType_t.to_key. elem!) (=> %%global_location_label%%0 (is-lib!spec.KeyType_t.Element./Elem_ (%Poly%lib!spec.KeyType_t.Element. elem!)))) :pattern ((req%lib!spec.KeyType_t.to_key. elem!)) )))
...
(set-info :comment ";; Function-Recommends lib::betree::Domain_v::Domain::wf")
(set-info :comment ";; betree/Domain_v.rs:22:5: 22:47 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::Domain_v::total_domain")
(set-info :comment ";; betree/Domain_v.rs:16:1: 16:51 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::Domain_v::Domain::contains")
(set-info :comment ";; betree/Domain_v.rs:30:5: 30:63 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::Domain_v::Domain::key_set")
(set-info :comment ";; betree/Domain_v.rs:45:5: 45:56 (#0)")
...
(assert (forall ((%%hole%%0 Poly) (k$ Poly)) (! (= (%%apply%%0 (%%lambda%%0 %%hole%%0) k$) (B (lib!betree.Domain_v.impl&%1.contains.? %%hole%%0 k$))) :pattern ((%%apply%%0 (%%lambda%%0 %%hole%%0) k$)))))
(assert (=> (fuel_bool fuel%lib!betree.Domain_v.impl&%1.key_set.) (forall ((self! Poly)) (! (= (lib!betree.Domain_v.impl&%1.key_set.? self!) (%Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (vstd!set.impl&%0.new.? $ TYPE%lib!spec.KeyType_t.Key. $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 self!)))))) :pattern ((lib!betree.Domain_v.impl&%1.key_set.? self!)) ))))
(set-info :comment ";; Function-Axioms lib::betree::Domain_v::Domain::arrow_Domain_start")
(assert (fuel_bool_default fuel%lib!betree.Domain_v.impl&%0.arrow_Domain_start.))
(assert (=> (fuel_bool fuel%lib!betree.Domain_v.impl&%0.arrow_Domain_start.) (forall ((self! Poly)) (! (= (lib!betree.Domain_v.impl&%0.arrow_Domain_start.? self!) (lib!betree.Domain_v.Domain./Domain/start (%Poly%lib!betree.Domain_v.Domain. self!))) :pattern ((lib!betree.Domain_v.impl&%0.arrow_Domain_start.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!betree.Domain_v.Domain.) (has_type (Poly%lib!spec.KeyType_t.Element. (lib!betree.Domain_v.impl&%0.arrow_Domain_start.? self!)) TYPE%lib!spec.KeyType_t.Element.)) :pattern ((lib!betree.Domain_v.impl&%0.arrow_Domain_start.? self!)) )))
(set-info :comment ";; Function-Axioms lib::betree::Domain_v::Domain::arrow_Domain_end")
(assert (fuel_bool_default fuel%lib!betree.Domain_v.impl&%0.arrow_Domain_end.))
(assert (=> (fuel_bool fuel%lib!betree.Domain_v.impl&%0.arrow_Domain_end.) (forall ((self! Poly)) (! (= (lib!betree.Domain_v.impl&%0.arrow_Domain_end.? self!) (lib!betree.Domain_v.Domain./Domain/end (%Poly%lib!betree.Domain_v.Domain. self!))) :pattern ((lib!betree.Domain_v.impl&%0.arrow_Domain_end.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!betree.Domain_v.Domain.) (has_type (Poly%lib!spec.KeyType_t.Element. (lib!betree.Domain_v.impl&%0.arrow_Domain_end.? self!)) TYPE%lib!spec.KeyType_t.Element.)) :pattern ((lib!betree.Domain_v.impl&%0.arrow_Domain_end.? self!)) )))
(set-info :comment ";; Function-Recommends lib::betree::Domain_v::Domain::includes")
(set-info :comment ";; betree/Domain_v.rs:37:5: 37:66 (#0)")
(declare-const %return! Bool)
(declare-const self! Poly)
(declare-const other! Poly)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.Domain_v.Domain.))
(assert (has_type other! TYPE%lib!betree.Domain_v.Domain.))
(assert (not true))
(check-sat)
(exit)
