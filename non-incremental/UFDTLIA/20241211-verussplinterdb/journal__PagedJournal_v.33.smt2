...
(declare-const old_lsn! Int)
(declare-const new_lsn! Int)
(declare-const tmp%1 lib!journal.PagedJournal_v.JournalRecord.)
(declare-const decrease%init0 lib!journal.PagedJournal_v.JournalRecord.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!journal.PagedJournal_v.JournalRecord. self!) TYPE%lib!journal.PagedJournal_v.JournalRecord.))
(assert (<= 0 old_lsn!))
(assert (<= 0 new_lsn!))
(assert (lib!journal.PagedJournal_v.impl&%0.valid.? (Poly%lib!journal.PagedJournal_v.JournalRecord. self!) (I old_lsn!)))
(assert (<= old_lsn! new_lsn!))
(assert (< new_lsn! (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. self!))))))))
...
(assert (not (=> (= decrease%init0 self!) (or (and (=> (< new_lsn! (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. self!))))))) (=> (= tmp%1 (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))))))) (and (=> %%location_label%%0 (check_decrease_height (Poly%lib!journal.PagedJournal_v.JournalRecord. (let ((self!$0 tmp%1) (old_lsn!$1 old_lsn!) (new_lsn!$2 new_lsn!)) self!$0)) (Poly%lib!journal.PagedJournal_v.JournalRecord. decrease%init0) false)) (and (=> %%location_label%%1 (req%lib!journal.PagedJournal_v.impl&%0.new_boundary_valid. tmp%1 old_lsn! new_lsn!)) (=> (ens%lib!journal.PagedJournal_v.impl&%0.new_boundary_valid. tmp%1 old_lsn! new_lsn!) %%switch_label%%0))))) (=> (not (< new_lsn! (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))))))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (lib!journal.PagedJournal_v.impl&%0.valid.? (Poly%lib!journal.PagedJournal_v.JournalRecord. self!) (I new_lsn!))))))))
(check-sat)
(exit)
