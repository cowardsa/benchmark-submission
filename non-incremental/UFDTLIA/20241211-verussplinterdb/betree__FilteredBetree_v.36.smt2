...
(declare-const tmp%1 vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>.)
(declare-const tmp%2 Poly)
(declare-const decrease%init0 Int)
(declare-const decrease%init1 Int)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.FilteredBetree_v.Path.))
(assert (has_type replacement! TYPE%lib!betree.FilteredBetree_v.BetreeNode.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. self!))) (=> (= decrease%init1 1) (or (and (=> (= (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. self!)) 0) (=> (= tmp%2 replacement!) %%switch_label%%0)) (=> (not (= (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. self!)) 0)) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.FilteredBetree_v.Path. self!)) (replacement!$1 (%Poly%lib!betree.FilteredBetree_v.BetreeNode. replacement!))) (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. (Poly%lib!betree.FilteredBetree_v.Path. (lib!betree.FilteredBetree_v.impl&%4.subpath.? (Poly%lib!betree.FilteredBetree_v.Path. self!$0)))))) decrease%init0 false)) (=> (= tmp%1 (lib!betree.FilteredBetree_v.impl&%4.replaced_children.? self! replacement!)) (=> (= tmp%2 (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.BetreeNode./Node (%Poly%lib!betree.BufferSeq_v.BufferSeq. (Poly%lib!betree.BufferSeq_v.BufferSeq. (lib!betree.FilteredBetree_v.BetreeNode./Node/buffers (%Poly%lib!betree.FilteredBetree_v.BetreeNode. (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!))))))) (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.FilteredBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.FilteredBetree_v.BetreeNode. (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!))))))) (%Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. tmp%1)) (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.FilteredBetree_v.BetreeNode./Node/flushed (%Poly%lib!betree.FilteredBetree_v.BetreeNode. (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!)))))))))) %%switch_label%%0))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
