...
(declare-const %return! lib!betree.LinkedBetree_v.LinkedBetree.)
(declare-const self! Poly)
(declare-const tmp%1 lib!betree.LinkedBetree_v.Path.)
(declare-const tmp%2 lib!betree.LinkedBetree_v.LinkedBetree.)
(declare-const tmp%3 lib!betree.LinkedBetree_v.LinkedBetree.)
(assert fuel_defaults)
(assert (has_type self! (TYPE%lib!betree.LinkedBetree_v.Path. T&. T&)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%10.valid.? T&. T& self!) (or (and (=> (= (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. self!)) 0) (=> (= tmp%3 (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!))) %%switch_label%%0)) (=> (not (= (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. self!)) 0)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%10.subpath. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%10.subpath.? T&. T& self!)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%10.target. T&. T& (Poly%lib!betree.LinkedBetree_v.Path. tmp%1))) (=> (= tmp%2 (lib!betree.LinkedBetree_v.impl&%10.target.? T&. T& (Poly%lib!betree.LinkedBetree_v.Path. tmp%1))) (=> (= tmp%3 tmp%2) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
