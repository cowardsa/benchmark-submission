...
(assert (not (=> (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? self! lsn!) (=> %%location_label%%0 (req%lib!abstract_system.MsgHistory_v.impl&%0.discard_recent. self! lsn!)))))
(check-sat)
(exit)
