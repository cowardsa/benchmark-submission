...
(assert (not (or (and (=> (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)) (=> (has_type i@ INT) (or (and (=> (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. tmp%2 i@)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) i@)) (=> (= tmp%3 (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. tmp%1))) %%switch_label%%1))))) (=> (not (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))))))) (=> (= tmp%3 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))))) (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. (vstd!seq.Seq.index.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) i$))))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) i$)) ))) %%switch_label%%0))))) (=> (not (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) (=> (= tmp%4 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
