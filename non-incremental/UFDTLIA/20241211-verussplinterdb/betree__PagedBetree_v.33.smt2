...
(set-info :comment ";; Function-Recommends lib::betree::PagedBetree_v::Path::target")
(set-info :comment ";; betree/PagedBetree_v.rs:283:5: 283:57 (#0)")
(declare-const %return! lib!betree.PagedBetree_v.BetreeNode.)
(declare-const self! Poly)
(declare-const tmp%1 lib!betree.PagedBetree_v.Path.)
(declare-const tmp%2 lib!betree.PagedBetree_v.BetreeNode.)
...
(assert (not (=> (lib!betree.PagedBetree_v.impl&%5.valid.? self!) (or (and (=> (= (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))) 0) (=> (= tmp%3 (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!))) %%switch_label%%0)) (=> (not (= (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))) 0)) (and (=> %%location_label%%0 (req%lib!betree.PagedBetree_v.impl&%5.subpath. self!)) (=> (= tmp%1 (lib!betree.PagedBetree_v.impl&%5.subpath.? self!)) (and (=> %%location_label%%1 (req%lib!betree.PagedBetree_v.impl&%5.target. (Poly%lib!betree.PagedBetree_v.Path. tmp%1))) (=> (= tmp%2 (lib!betree.PagedBetree_v.impl&%5.target.? (Poly%lib!betree.PagedBetree_v.Path. tmp%1))) (=> (= tmp%3 tmp%2) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
