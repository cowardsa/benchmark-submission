...
(set-info :comment ";; MODULE 'module journal::PagedJournal_v::PagedJournal'")
...
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_read_for_recovery_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_freeze_for_commit_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_internal_journal_marshal_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_dummy_to_use_type_params_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_read_for_recovery. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_read_for_recovery_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_freeze_for_commit. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_freeze_for_commit_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_query_end_lsn. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_put. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_discard_old. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_internal_journal_marshal. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_internal_journal_marshal_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_internal_no_op. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_dummy_to_use_type_params. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_dummy_to_use_type_params_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%2.arrow_initialize_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%2.arrow_dummy_to_use_type_params_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%3.is_initialize. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%3.get_initialize_0. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%3.is_dummy_to_use_type_params. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%3.get_dummy_to_use_type_params_0. FuelId)
...
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_FreezeForCommit_frozen_journal. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_QueryEndLsn_end_lsn. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_Put_messages. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_DiscardOld_start_lsn. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_DiscardOld_require_end. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.read_for_recovery. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.read_for_recovery_strong. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.read_for_recovery_enabled. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.freeze_for_commit. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.freeze_for_commit_strong. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.freeze_for_commit_enabled. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.query_end_lsn. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.query_end_lsn_strong. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.query_end_lsn_enabled. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.put. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.put_strong. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.put_enabled. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.discard_old. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.discard_old_strong. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.discard_old_enabled. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_journal_marshal. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_journal_marshal_strong. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_journal_marshal_enabled. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_no_op. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_no_op_strong. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_no_op_enabled. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.initialize. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.initialize_enabled. FuelId)
...
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.next_strong_by. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.next_strong. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.init_by. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.init. FuelId)
(declare-const fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.invariant. FuelId)
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_empty. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!map_lib.impl&%0.union_prefer_right. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_mk_map_domain. fuel%vstd!set.axiom_mk_map_index. fuel%vstd!set.axiom_set_empty_finite. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_read_for_recovery_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_freeze_for_commit_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_internal_journal_marshal_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_dummy_to_use_type_params_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_read_for_recovery. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_read_for_recovery_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_freeze_for_commit. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_freeze_for_commit_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_query_end_lsn. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_put. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_discard_old. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_internal_journal_marshal. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_internal_journal_marshal_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_internal_no_op. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_dummy_to_use_type_params. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_dummy_to_use_type_params_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%2.arrow_initialize_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%2.arrow_dummy_to_use_type_params_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%3.is_initialize. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%3.get_initialize_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%3.is_dummy_to_use_type_params. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%3.get_dummy_to_use_type_params_0. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_require_end. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_end_lsn. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_start_lsn. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_frozen_journal. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_ReadForRecovery_messages. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_FreezeForCommit_frozen_journal. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_QueryEndLsn_end_lsn. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_Put_messages. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_DiscardOld_start_lsn. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_DiscardOld_require_end. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.read_for_recovery. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.read_for_recovery_strong. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.read_for_recovery_enabled. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.freeze_for_commit. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.freeze_for_commit_strong. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.freeze_for_commit_enabled. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.query_end_lsn. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.query_end_lsn_strong. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.query_end_lsn_enabled. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.put. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.put_strong. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.put_enabled. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.discard_old. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.discard_old_strong. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.discard_old_enabled. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_journal_marshal. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_journal_marshal_strong. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_journal_marshal_enabled. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_no_op. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_no_op_strong. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_no_op_enabled. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.initialize. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.initialize_enabled. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.next_by. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.next. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.next_strong_by. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.next_strong. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.init_by. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.init. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.invariant. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.wf. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.seq_start. fuel%lib!journal.PagedJournal_v.PagedJournal.impl&%5.seq_end. fuel%lib!abstract_system.MsgHistory_v.impl&%0.wf. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_exactly. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_follow. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_concat. fuel%lib!abstract_system.MsgHistory_v.impl&%0.concat. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to. fuel%lib!abstract_system.MsgHistory_v.impl&%0.discard_recent. fuel%lib!abstract_system.MsgHistory_v.impl&%0.discard_old. fuel%lib!abstract_system.MsgHistory_v.impl&%0.maybe_discard_old. fuel%lib!abstract_system.MsgHistory_v.impl&%0.empty_history_at. fuel%lib!journal.PagedJournal_v.impl&%0.wf. fuel%lib!journal.PagedJournal_v.impl&%0.valid. fuel%lib!journal.PagedJournal_v.impl&%0.cropped_prior. fuel%lib!journal.PagedJournal_v.impl&%0.can_crop_head_records. fuel%lib!journal.PagedJournal_v.impl&%0.opt_rec_can_crop_head_records. fuel%lib!journal.PagedJournal_v.impl&%0.crop_head_records. fuel%lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records. fuel%lib!journal.PagedJournal_v.impl&%0.message_seq_after_crop. fuel%lib!journal.PagedJournal_v.impl&%0.discard_old_journal_rec. fuel%lib!journal.PagedJournal_v.impl&%1.wf. fuel%lib!journal.PagedJournal_v.impl&%1.seq_end. fuel%lib!journal.PagedJournal_v.impl&%1.seq_start. fuel%lib!journal.PagedJournal_v.impl&%1.can_discard_to. fuel%lib!journal.PagedJournal_v.impl&%1.discard_old_defn. fuel%lib!journal.PagedJournal_v.impl&%1.has_messages_at_depth. fuel%lib!journal.PagedJournal_v.impl&%1.append_record. fuel%lib!journal.PagedJournal_v.impl&%1.can_crop. fuel%lib!journal.PagedJournal_v.impl&%1.crop_head_records. fuel%lib!journal.PagedJournal_v.impl&%1.freeze_for_commit. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(declare-datatypes ((core!option.Option. 0) (lib!journal.PagedJournal_v.PagedJournal.State. 0) (lib!journal.PagedJournal_v.PagedJournal.Step. 0) (lib!journal.PagedJournal_v.PagedJournal.Config. 0) (lib!journal.PagedJournal_v.PagedJournal.Label. 0) (lib!abstract_system.MsgHistory_v.KeyedMessage. 0) (lib!abstract_system.MsgHistory_v.MsgHistory. 0) (lib!journal.PagedJournal_v.JournalRecord. 0) (lib!journal.PagedJournal_v.TruncatedJournal. 0) (lib!spec.KeyType_t.Key. 0) (lib!spec.Messages_t.Value. 0) (lib!spec.Messages_t.Delta. 0) (lib!spec.Messages_t.Message. 0) (tuple%0. 0)) (((core!option.Option./None ) (core!option.Option./Some (core!option.Option./Some/?0 Poly))) ((lib!journal.PagedJournal_v.PagedJournal.State./State (lib!journal.PagedJournal_v.PagedJournal.State./State/?truncated_journal lib!journal.PagedJournal_v.TruncatedJournal.) (lib!journal.PagedJournal_v.PagedJournal.State./State/?unmarshalled_tail lib!abstract_system.MsgHistory_v.MsgHistory.))) ((lib!journal.PagedJournal_v.PagedJournal.Step./read_for_recovery (lib!journal.PagedJournal_v.PagedJournal.Step./read_for_recovery/?0 Int)) (lib!journal.PagedJournal_v.PagedJournal.Step./freeze_for_commit (lib!journal.PagedJournal_v.PagedJournal.Step./freeze_for_commit/?0 Int)) (lib!journal.PagedJournal_v.PagedJournal.Step./query_end_lsn ) (lib!journal.PagedJournal_v.PagedJournal.Step./put ) (lib!journal.PagedJournal_v.PagedJournal.Step./discard_old ) (lib!journal.PagedJournal_v.PagedJournal.Step./internal_journal_marshal (lib!journal.PagedJournal_v.PagedJournal.Step./internal_journal_marshal/?0 Int)) (lib!journal.PagedJournal_v.PagedJournal.Step./internal_no_op ) (lib!journal.PagedJournal_v.PagedJournal.Step./dummy_to_use_type_params (lib!journal.PagedJournal_v.PagedJournal.Step./dummy_to_use_type_params/?0 lib!journal.PagedJournal_v.PagedJournal.State.))) ((lib!journal.PagedJournal_v.PagedJournal.Config./initialize (lib!journal.PagedJournal_v.PagedJournal.Config./initialize/?0 lib!journal.PagedJournal_v.TruncatedJournal.)) (lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params (lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params/?0 lib!journal.PagedJournal_v.PagedJournal.State.))) ((lib!journal.PagedJournal_v.PagedJournal.Label./ReadForRecovery (lib!journal.PagedJournal_v.PagedJournal.Label./ReadForRecovery/?messages lib!abstract_system.MsgHistory_v.MsgHistory.)) (lib!journal.PagedJournal_v.PagedJournal.Label./FreezeForCommit (lib!journal.PagedJournal_v.PagedJournal.Label./FreezeForCommit/?frozen_journal lib!journal.PagedJournal_v.TruncatedJournal.)) (lib!journal.PagedJournal_v.PagedJournal.Label./QueryEndLsn (lib!journal.PagedJournal_v.PagedJournal.Label./QueryEndLsn/?end_lsn Int)) (lib!journal.PagedJournal_v.PagedJournal.Label./Put (lib!journal.PagedJournal_v.PagedJournal.Label./Put/?messages lib!abstract_system.MsgHistory_v.MsgHistory.)) (lib!journal.PagedJournal_v.PagedJournal.Label./DiscardOld (lib!journal.PagedJournal_v.PagedJournal.Label./DiscardOld/?start_lsn Int) (lib!journal.PagedJournal_v.PagedJournal.Label./DiscardOld/?require_end Int)) (lib!journal.PagedJournal_v.PagedJournal.Label./Internal )) ((lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage (lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage/?key lib!spec.KeyType_t.Key.) (lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage/?message lib!spec.Messages_t.Message.))) ((lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/?msgs vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>.) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/?seq_start Int) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/?seq_end Int))) ((lib!journal.PagedJournal_v.JournalRecord./JournalRecord (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/?message_seq lib!abstract_system.MsgHistory_v.MsgHistory.) (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/?prior_rec core!option.Option.))) ((lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/?boundary_lsn Int) (lib!journal.PagedJournal_v.TruncatedJournal./TruncatedJournal/?freshest_rec core!option.Option.))) ((lib!spec.KeyType_t.Key./Key (lib!spec.KeyType_t.Key./Key/?0 Int))) ((lib!spec.Messages_t.Value./Value (lib!spec.Messages_t.Value./Value/?0 Int))) ((lib!spec.Messages_t.Delta./Delta (lib!spec.Messages_t.Delta./Delta/?0 Int))) ((lib!spec.Messages_t.Message./Define (lib!spec.Messages_t.Message./Define/?value lib!spec.Messages_t.Value.)) (lib!spec.Messages_t.Message./Update (lib!spec.Messages_t.Message./Update/?delta lib!spec.Messages_t.Delta.))) ((tuple%0./tuple%0 ))))
...
(declare-fun lib!journal.PagedJournal_v.PagedJournal.Config./initialize/0 (lib!journal.PagedJournal_v.PagedJournal.Config.) lib!journal.PagedJournal_v.TruncatedJournal.)
(declare-fun lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params/0 (lib!journal.PagedJournal_v.PagedJournal.Config.) lib!journal.PagedJournal_v.PagedJournal.State.)
...
(declare-const TYPE%lib!journal.PagedJournal_v.PagedJournal.Config. Type)
...
(declare-fun Poly%lib!journal.PagedJournal_v.PagedJournal.Config. (lib!journal.PagedJournal_v.PagedJournal.Config.) Poly)
(declare-fun %Poly%lib!journal.PagedJournal_v.PagedJournal.Config. (Poly) lib!journal.PagedJournal_v.PagedJournal.Config.)
...
(assert (forall ((x lib!journal.PagedJournal_v.PagedJournal.Config.)) (! (= x (%Poly%lib!journal.PagedJournal_v.PagedJournal.Config. (Poly%lib!journal.PagedJournal_v.PagedJournal.Config. x))) :pattern ((Poly%lib!journal.PagedJournal_v.PagedJournal.Config. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.) (= x (Poly%lib!journal.PagedJournal_v.PagedJournal.Config. (%Poly%lib!journal.PagedJournal_v.PagedJournal.Config. x)))) :pattern ((has_type x TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.)) )))
(assert (forall ((_0! lib!journal.PagedJournal_v.TruncatedJournal.)) (! (=> (has_type (Poly%lib!journal.PagedJournal_v.TruncatedJournal. _0!) TYPE%lib!journal.PagedJournal_v.TruncatedJournal.) (has_type (Poly%lib!journal.PagedJournal_v.PagedJournal.Config. (lib!journal.PagedJournal_v.PagedJournal.Config./initialize _0!)) TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.)) :pattern ((has_type (Poly%lib!journal.PagedJournal_v.PagedJournal.Config. (lib!journal.PagedJournal_v.PagedJournal.Config./initialize _0!)) TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.)) )))
(assert (forall ((x lib!journal.PagedJournal_v.PagedJournal.Config.)) (! (= (lib!journal.PagedJournal_v.PagedJournal.Config./initialize/0 x) (lib!journal.PagedJournal_v.PagedJournal.Config./initialize/?0 x)) :pattern ((lib!journal.PagedJournal_v.PagedJournal.Config./initialize/0 x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.) (has_type (Poly%lib!journal.PagedJournal_v.TruncatedJournal. (lib!journal.PagedJournal_v.PagedJournal.Config./initialize/0 (%Poly%lib!journal.PagedJournal_v.PagedJournal.Config. x))) TYPE%lib!journal.PagedJournal_v.TruncatedJournal.)) :pattern ((lib!journal.PagedJournal_v.PagedJournal.Config./initialize/0 (%Poly%lib!journal.PagedJournal_v.PagedJournal.Config. x)) (has_type x TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.)) )))
(assert (forall ((_0! lib!journal.PagedJournal_v.PagedJournal.State.)) (! (=> (has_type (Poly%lib!journal.PagedJournal_v.PagedJournal.State. _0!) TYPE%lib!journal.PagedJournal_v.PagedJournal.State.) (has_type (Poly%lib!journal.PagedJournal_v.PagedJournal.Config. (lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params _0!)) TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.)) :pattern ((has_type (Poly%lib!journal.PagedJournal_v.PagedJournal.Config. (lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params _0!)) TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.)) )))
(assert (forall ((x lib!journal.PagedJournal_v.PagedJournal.Config.)) (! (= (lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params/0 x) (lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params/?0 x)) :pattern ((lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params/0 x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.) (has_type (Poly%lib!journal.PagedJournal_v.PagedJournal.State. (lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params/0 (%Poly%lib!journal.PagedJournal_v.PagedJournal.Config. x))) TYPE%lib!journal.PagedJournal_v.PagedJournal.State.)) :pattern ((lib!journal.PagedJournal_v.PagedJournal.Config./dummy_to_use_type_params/0 (%Poly%lib!journal.PagedJournal_v.PagedJournal.Config. x)) (has_type x TYPE%lib!journal.PagedJournal_v.PagedJournal.Config.)) )))
...
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::init_by")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.init_by.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::init")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.init.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::arrow_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_0.? (Poly) lib!journal.PagedJournal_v.PagedJournal.State.)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::arrow_read_for_recovery_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_read_for_recovery_0.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::arrow_freeze_for_commit_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_freeze_for_commit_0.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::arrow_internal_journal_marshal_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_internal_journal_marshal_0.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::arrow_dummy_to_use_type_params_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%0.arrow_dummy_to_use_type_params_0.? (Poly) lib!journal.PagedJournal_v.PagedJournal.State.)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::is_read_for_recovery")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_read_for_recovery.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::get_read_for_recovery_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_read_for_recovery_0.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::is_freeze_for_commit")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_freeze_for_commit.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::get_freeze_for_commit_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_freeze_for_commit_0.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::is_query_end_lsn")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_query_end_lsn.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::is_put")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_put.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::is_discard_old")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_discard_old.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::is_internal_journal_marshal")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_internal_journal_marshal.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::get_internal_journal_marshal_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_internal_journal_marshal_0.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::is_internal_no_op")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_internal_no_op.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::is_dummy_to_use_type_params")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.is_dummy_to_use_type_params.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Step::get_dummy_to_use_type_params_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%1.get_dummy_to_use_type_params_0.? (Poly) lib!journal.PagedJournal_v.PagedJournal.State.)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Config::arrow_initialize_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%2.arrow_initialize_0.? (Poly) lib!journal.PagedJournal_v.TruncatedJournal.)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Config::arrow_dummy_to_use_type_params_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%2.arrow_dummy_to_use_type_params_0.? (Poly) lib!journal.PagedJournal_v.PagedJournal.State.)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Config::is_initialize")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%3.is_initialize.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Config::get_initialize_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%3.get_initialize_0.? (Poly) lib!journal.PagedJournal_v.TruncatedJournal.)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Config::is_dummy_to_use_type_params")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%3.is_dummy_to_use_type_params.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Config::get_dummy_to_use_type_params_0")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%3.get_dummy_to_use_type_params_0.? (Poly) lib!journal.PagedJournal_v.PagedJournal.State.)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Label::arrow_FreezeForCommit_frozen_journal")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_FreezeForCommit_frozen_journal.? (Poly) lib!journal.PagedJournal_v.TruncatedJournal.)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Label::arrow_QueryEndLsn_end_lsn")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_QueryEndLsn_end_lsn.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Label::arrow_DiscardOld_start_lsn")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_DiscardOld_start_lsn.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::Label::arrow_DiscardOld_require_end")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%4.arrow_DiscardOld_require_end.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::read_for_recovery_strong")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.read_for_recovery_strong.? (Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::read_for_recovery_enabled")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.read_for_recovery_enabled.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::freeze_for_commit_strong")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.freeze_for_commit_strong.? (Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::freeze_for_commit_enabled")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.freeze_for_commit_enabled.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::query_end_lsn_strong")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.query_end_lsn_strong.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::query_end_lsn_enabled")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.query_end_lsn_enabled.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::put_strong")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.put_strong.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::put_enabled")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.put_enabled.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::discard_old_strong")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.discard_old_strong.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::discard_old_enabled")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.discard_old_enabled.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::internal_journal_marshal_strong")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_journal_marshal_strong.? (Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::internal_journal_marshal_enabled")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_journal_marshal_enabled.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::internal_no_op_strong")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_no_op_strong.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::internal_no_op_enabled")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.internal_no_op_enabled.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::initialize_enabled")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.initialize_enabled.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::next_strong_by")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.next_strong_by.? (Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::next_strong")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.next_strong.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::journal::PagedJournal_v::PagedJournal::State::invariant")
(declare-fun lib!journal.PagedJournal_v.PagedJournal.impl&%5.invariant.? (Poly) Bool)
...
(set-info :comment ";; Function-Recommends lib::journal::PagedJournal_v::PagedJournal::State::wf")
(set-info :comment ";; journal/PagedJournal_v.rs:412:5: 412:47 (#0)")
...
(assert (has_type self! TYPE%lib!journal.PagedJournal_v.PagedJournal.State.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (or (and (=> (and (lib!journal.PagedJournal_v.impl&%1.wf.? (Poly%lib!journal.PagedJournal_v.TruncatedJournal. (lib!journal.PagedJournal_v.PagedJournal.State./State/truncated_journal (%Poly%lib!journal.PagedJournal_v.PagedJournal.State. self!)))) (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.PagedJournal.State./State/unmarshalled_tail (%Poly%lib!journal.PagedJournal_v.PagedJournal.State. self!))))) (=> (= tmp%2 (Poly%lib!journal.PagedJournal_v.TruncatedJournal. (lib!journal.PagedJournal_v.PagedJournal.State./State/truncated_journal (%Poly%lib!journal.PagedJournal_v.PagedJournal.State. self!)))) (and (=> %%location_label%%0 (req%lib!journal.PagedJournal_v.impl&%1.seq_end. tmp%2)) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%1.seq_end.? (Poly%lib!journal.PagedJournal_v.TruncatedJournal. (lib!journal.PagedJournal_v.PagedJournal.State./State/truncated_journal (%Poly%lib!journal.PagedJournal_v.PagedJournal.State. self!))))) (=> (= tmp%3 (= tmp%1 (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.PagedJournal.State./State/unmarshalled_tail (%Poly%lib!journal.PagedJournal_v.PagedJournal.State. self!))))))) %%switch_label%%0))))) (=> (not (and (lib!journal.PagedJournal_v.impl&%1.wf.? (Poly%lib!journal.PagedJournal_v.TruncatedJournal. (lib!journal.PagedJournal_v.PagedJournal.State./State/truncated_journal (%Poly%lib!journal.PagedJournal_v.PagedJournal.State. self!)))) (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.PagedJournal.State./State/unmarshalled_tail (%Poly%lib!journal.PagedJournal_v.PagedJournal.State. self!)))))) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
