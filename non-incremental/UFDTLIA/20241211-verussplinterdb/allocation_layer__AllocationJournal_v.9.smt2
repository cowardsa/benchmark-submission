...
(declare-const root! lib!spec.AsyncDisk_t.Address.)
(declare-const later! lib!spec.AsyncDisk_t.Address.)
(declare-const first! Int)
(declare-const tmp%1 Bool)
(declare-const tmp%2 core!option.Option.)
(declare-const tmp%3 lib!spec.AsyncDisk_t.Address.)
...
(assert (has_type (Poly%lib!spec.AsyncDisk_t.Address. root!) TYPE%lib!spec.AsyncDisk_t.Address.))
(assert (has_type (Poly%lib!spec.AsyncDisk_t.Address. later!) TYPE%lib!spec.AsyncDisk_t.Address.))
(assert (<= 0 first!))
(assert (lib!allocation_layer.AllocationJournal_v.impl&%1.pointer_is_upstream.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!spec.AsyncDisk_t.Address. later!))) (I first!)))
(assert (lib!journal.LinkedJournal_v.impl&%1.decodable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!spec.AsyncDisk_t.Address. root!)))))
(assert (lib!journal.LinkedJournal_v.impl&%1.acyclic.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!)))
(assert (not (= (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. root!))) first!)))
(assert (= (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. root!))) (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. later!)))))
(assert (<= (lib!spec.AsyncDisk_t.Address./Address/page (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. root!))) (lib!spec.AsyncDisk_t.Address./Address/page (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. later!)))))
(assert (lib!allocation_layer.AllocationJournal_v.impl&%1.internal_au_pages_fully_linked.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!)))
...
(assert (not (=> (= decrease%init0 (lib!spec.AsyncDisk_t.Address./Address/page (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. later!)))) (or (and (=> (= root! later!) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.decodable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!spec.AsyncDisk_t.Address. later!))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (<= (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!spec.AsyncDisk_t.Address. root!)))) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!spec.AsyncDisk_t.Address. later!)))))))))) (=> (not (= root! later!)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= prior@ (lib!journal.LinkedJournal_v.impl&%1.next.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!spec.AsyncDisk_t.Address. later!))))) (=> (= tmp%2 (core!option.Option./Some (Poly%lib!spec.AsyncDisk_t.Address. later!))) (and (=> %%location_label%%2 (req%lib!allocation_layer.AllocationJournal_v.impl&%1.nonfirst_properties. self! tmp%2 first!)) (=> (ens%lib!allocation_layer.AllocationJournal_v.impl&%1.nonfirst_properties. self! tmp%2 first!) (=> (= tmp%3 (%Poly%lib!spec.AsyncDisk_t.Address. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. prior@))))) (and (=> %%location_label%%3 (check_decrease_int (let ((self!$0 self!) (root!$1 root!) (later!$2 tmp%3) (first!$3 first!)) (lib!spec.AsyncDisk_t.Address./Address/page (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. later!$2)))) decrease%init0 false)) (and (=> %%location_label%%4 (req%lib!allocation_layer.AllocationJournal_v.impl&%1.transitive_ranking. self! root! tmp%3 first!)) (=> (ens%lib!allocation_layer.AllocationJournal_v.impl&%1.transitive_ranking. self! root! tmp%3 first!) (=> %%location_label%%5 (<= (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!spec.AsyncDisk_t.Address. root!)))) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!spec.AsyncDisk_t.Address. later!)))))))))))))))))))
(check-sat)
(exit)
