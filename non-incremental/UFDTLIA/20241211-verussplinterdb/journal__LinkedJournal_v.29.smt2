...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%2.wf.? self!) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%2.can_discard_to. self! lsn!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%2.can_discard_to.? self! lsn!)) (=> (lib!journal.LinkedJournal_v.impl&%2.can_discard_to.? self! lsn!) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%2.seq_end. self!)) (=> (= tmp%2 (lib!journal.LinkedJournal_v.impl&%2.seq_end.? self!)) (=> (= tmp%4 (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (=> %%location_label%%2 (req%lib!journal.LinkedJournal_v.impl&%1.discard_old. tmp%4 lsn!)))))))))))
(check-sat)
(exit)
