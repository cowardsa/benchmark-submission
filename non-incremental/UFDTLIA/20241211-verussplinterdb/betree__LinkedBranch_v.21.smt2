...
(declare-const tmp%5 lib!betree.LinkedBranch_v.Path.)
...
(assert (not (or (and (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (or (and (=> (< 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!))) (=> (= tmp%2 (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.root. tmp%2)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.root.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))))) (=> (= tmp%3 (is-lib!betree.LinkedBranch_v.Node./Index_ tmp%1)) %%switch_label%%3))))) (=> (not (< 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (=> (= tmp%3 true) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= tmp%4 tmp%3) %%switch_label%%2)))) (=> (not (lib!betree.LinkedBranch_v.impl&%5.wf.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))))) (=> (= tmp%4 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%4 (or (and (=> (< 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!))) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%6.subpath. self!)) (=> (= tmp%5 (lib!betree.LinkedBranch_v.impl&%6.subpath.? self!)) (=> (= tmp%6 (lib!betree.LinkedBranch_v.impl&%6.valid.? (Poly%lib!betree.LinkedBranch_v.Path. tmp%5))) %%switch_label%%1)))) (=> (not (< 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (=> (= tmp%6 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%7 tmp%6) %%switch_label%%0)))) (=> (not tmp%4) (=> (= tmp%7 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
