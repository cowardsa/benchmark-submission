...
(declare-const memtable! Poly)
(declare-const new_addrs! Poly)
...
(declare-const tmp%6 lib!betree.LinkedBetree_v.BetreeNode.)
(declare-const memtable_buffer@ lib!betree.LinkedSeq_v.LinkedSeq.)
(declare-const new_root@ lib!betree.LinkedBetree_v.BetreeNode.)
(declare-const new_dv@ lib!betree.LinkedBetree_v.DiskView.)
(declare-const new_buffer_dv@ lib!betree.BufferDisk_v.BufferDisk.)
(assert fuel_defaults)
(assert (has_type self! (TYPE%lib!betree.LinkedBetree_v.LinkedBetree. T&. T&)))
(assert (has_type memtable! (TYPE%lib!betree.Memtable_v.Memtable. T&. T&)))
(assert (has_type new_addrs! TYPE%lib!betree.LinkedBetree_v.TwoAddrs.))
...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (=> (%B (lib!betree.LinkedBetree_v.Addrs.no_duplicates.? $ TYPE%lib!betree.LinkedBetree_v.TwoAddrs. new_addrs!)) (=> (lib!betree.LinkedBetree_v.impl&%5.is_fresh.? T&. T& self! (lib!betree.LinkedBetree_v.Addrs.repr.? $ TYPE%lib!betree.LinkedBetree_v.TwoAddrs. new_addrs!)) (=> (= memtable_buffer@ (lib!betree.LinkedSeq_v.LinkedSeq./LinkedSeq (%Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (vstd!seq.Seq.push.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!seq.Seq.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBetree_v.TwoAddrs./TwoAddrs/addr2 (%Poly%lib!betree.LinkedBetree_v.TwoAddrs. new_addrs!))))))) (or (and (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%0.extend_buffer_seq. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%1) (Poly%lib!betree.LinkedSeq_v.LinkedSeq. memtable_buffer@))) (=> (= tmp%2 (lib!betree.LinkedBetree_v.impl&%0.extend_buffer_seq.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%1) (Poly%lib!betree.LinkedSeq_v.LinkedSeq. memtable_buffer@))) (=> (= tmp%6 tmp%2) %%switch_label%%0)))))) (=> (not (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) (=> (= tmp%4 (Poly%lib!betree.Domain_v.Domain. (lib!betree.Domain_v.total_domain.? (I 0)))) (and (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%0.empty_root. tmp%4)) (=> (= tmp%3 (lib!betree.LinkedBetree_v.impl&%0.empty_root.? (Poly%lib!betree.Domain_v.Domain. (lib!betree.Domain_v.total_domain.? (I 0))))) (and (=> %%location_label%%3 (req%lib!betree.LinkedBetree_v.impl&%0.extend_buffer_seq. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%3) (Poly%lib!betree.LinkedSeq_v.LinkedSeq. memtable_buffer@))) (=> (= tmp%5 (lib!betree.LinkedBetree_v.impl&%0.extend_buffer_seq.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%3) (Poly%lib!betree.LinkedSeq_v.LinkedSeq. memtable_buffer@))) (=> (= tmp%6 tmp%5) %%switch_label%%0)))))))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
