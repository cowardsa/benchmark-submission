...
(assert (not (=> (lib!betree.PivotBetree_v.impl&%1.local_structure.? self!) (=> (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)) (=> (= tmp%1 (B (< 0 (lib!betree.PivotTable_v.impl&%0.num_ranges.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))))))) (and (=> %%location_label%%0 (req%vstd!pervasive.spec_affirm. tmp%1)) (=> (= tmp%3 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))))))) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Element. tmp%3 (I 0))) (=> (= tmp%2 (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))))) (I 0))) (=> (= tmp%5 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))))))) (=> %%location_label%%2 (req%vstd!seq.Seq.last. $ TYPE%lib!spec.KeyType_t.Element. tmp%5))))))))))))
(check-sat)
(exit)
