...
(set-info :comment ";; Function-Def lib::betree::BufferSeq_v::BufferSeq::query_from_same_as_i_filtered")
(set-info :comment ";; betree/BufferSeq_v.rs:209:5: 209:101 (#0)")
...
(set-info :comment ";; Function-Def lib::betree::BufferSeq_v::BufferSeq::common_buffer_seqs")
(set-info :comment ";; betree/BufferSeq_v.rs:228:5: 228:102 (#0)")
...
(set-info :comment ";; Function-Def lib::betree::BufferSeq_v::BufferSeq::extend_buffer_seq_query_ensures")
(set-info :comment ";; betree/BufferSeq_v.rs:240:5: 240:106 (#0)")
(declare-const top! lib!betree.BufferSeq_v.BufferSeq.)
(declare-const bottom! lib!betree.BufferSeq_v.BufferSeq.)
(declare-const key! lib!spec.KeyType_t.Key.)
(declare-const start! Int)
(declare-const tmp%1 lib!betree.BufferSeq_v.BufferSeq.)
...
(assert (and (<= 0 start!) (<= start! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!)))))
...
(assert (not (=> (= decrease%init0 (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!)) start!)) (or (and (=> (= start! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!))) (=> (= tmp%1 (lib!betree.BufferSeq_v.impl&%0.extend.? (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!) (Poly%lib!betree.BufferSeq_v.BufferSeq. top!))) (=> (= tmp%2 (Sub 0 start!)) (and (=> %%location_label%%0 (req%lib!betree.BufferSeq_v.impl&%0.common_buffer_seqs. tmp%1 top! start! tmp%2 key!)) (=> (ens%lib!betree.BufferSeq_v.impl&%0.common_buffer_seqs. tmp%1 top! start! tmp%2 key!) %%switch_label%%0))))) (=> (not (= start! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!)))) (=> (= tmp%3 (ext_eq false TYPE%lib!betree.Buffer_v.SimpleBuffer. (vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. (Poly%lib!betree.BufferSeq_v.BufferSeq. (lib!betree.BufferSeq_v.impl&%0.extend.? (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!) (Poly%lib!betree.BufferSeq_v.BufferSeq. top!)))))) (I start!)) (vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!)))) (I start!)))) (and (=> %%location_label%%1 tmp%3) (=> tmp%3 (=> (= tmp%4 (Add start! 1)) (and (=> %%location_label%%2 (check_decrease_int (let ((top!$0 top!) (bottom!$1 bottom!) (key!$2 key!) (start!$3 tmp%4)) (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!$1)) start!$3)) decrease%init0 false)) (and (=> %%location_label%%3 (req%lib!betree.BufferSeq_v.impl&%0.extend_buffer_seq_query_ensures. top! bottom! key! tmp%4)) (=> (ens%lib!betree.BufferSeq_v.impl&%0.extend_buffer_seq_query_ensures. top! bottom! key! tmp%4) %%switch_label%%0))))))))) (and (not %%switch_label%%0) (=> %%location_label%%4 (= (lib!betree.BufferSeq_v.impl&%0.query_from.? (Poly%lib!betree.BufferSeq_v.BufferSeq. (lib!betree.BufferSeq_v.impl&%0.extend.? (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!) (Poly%lib!betree.BufferSeq_v.BufferSeq. top!))) (Poly%lib!spec.KeyType_t.Key. key!) (I start!)) (lib!spec.Messages_t.impl&%1.merge.? (Poly%lib!spec.Messages_t.Message. (lib!betree.BufferSeq_v.impl&%0.query_from.? (Poly%lib!betree.BufferSeq_v.BufferSeq. bottom!) (Poly%lib!spec.KeyType_t.Key. key!) (I start!))) (Poly%lib!spec.Messages_t.Message. (lib!betree.BufferSeq_v.impl&%0.query.? (Poly%lib!betree.BufferSeq_v.BufferSeq. top!) (Poly%lib!spec.KeyType_t.Key. key!)))))))))))
(check-sat)
(exit)
