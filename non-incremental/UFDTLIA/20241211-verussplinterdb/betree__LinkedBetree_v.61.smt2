...
(assert (not (or (and (=> (and (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%0.occupied_child_index. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%1) child_idx!)) (=> (= tmp%2 (lib!betree.LinkedBetree_v.impl&%0.occupied_child_index.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%1) child_idx!)) (=> (= tmp%3 tmp%2) %%switch_label%%1)))))) (=> (not (and (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!))) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%3 (and (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%4 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (and (=> %%location_label%%3 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%5 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (=> (= tmp%7 (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/flushed (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%4))))) (=> (= tmp%8 (I (lib!betree.LinkedSeq_v.impl&%0.len.? (Poly%lib!betree.LinkedSeq_v.LinkedSeq. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/buffers (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%5))))))) (and (=> %%location_label%%4 (req%lib!betree.BufferOffsets_v.impl&%0.update. tmp%7 child_idx! tmp%8)) (=> (= tmp%6 (lib!betree.BufferOffsets_v.impl&%0.update.? (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/flushed (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%4)))) child_idx! (I (lib!betree.LinkedSeq_v.impl&%0.len.? (Poly%lib!betree.LinkedSeq_v.LinkedSeq. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/buffers (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%5)))))))) (=> (= tmp%9 (lib!betree.BufferOffsets_v.impl&%0.all_gte.? (Poly%lib!betree.BufferOffsets_v.BufferOffsets. tmp%6) buffer_gc!)) %%switch_label%%0)))))))))) (=> (not tmp%3) (=> (= tmp%9 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
