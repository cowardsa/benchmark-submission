...
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.Slice_v.impl&%1.len. (%Poly%lib!marshalling.Slice_v.Slice. slice!))) (=> (ens%lib!marshalling.Slice_v.impl&%1.len. (%Poly%lib!marshalling.Slice_v.Slice. slice!) l@) (=> (ens%lib!marshalling.StaticallySized_v.StaticallySized.exec_uniform_size. T&. T& tmp%1) (=> (= p@ (<= (%I tmp%1) l@)) (=> (= tmp%2 (lib!marshalling.Slice_v.impl&%0.valid.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (= l@ (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (or (and (=> p@ (=> (= tmp%4 (<= (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? T&. T&)) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 %%switch_label%%0))))))) (=> (not p@) (=> (= tmp%6 (not (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= tmp%7 (= p@ (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> (= %return! (B p@)) (=> %%location_label%%7 (= %return! (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))))))))))))))))))))
(check-sat)
(exit)
