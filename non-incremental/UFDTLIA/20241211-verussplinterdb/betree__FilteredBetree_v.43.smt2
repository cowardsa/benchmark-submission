...
(set-info :comment ";; Function-Recommends lib::betree::FilteredBetree_v::BetreeNode::can_flush")
(set-info :comment ";; betree/FilteredBetree_v.rs:313:5: 313:86 (#0)")
...
(assert (forall ((self! Poly) (start! Poly) (end! Poly)) (! (= (req%lib!betree.BufferSeq_v.impl&%0.slice. self! start! end!) (=> %%global_location_label%%66 (and (and (<= 0 (%I start!)) (<= (%I start!) (%I end!))) (<= (%I end!) (lib!betree.BufferSeq_v.impl&%0.len.? self!))))) :pattern ((req%lib!betree.BufferSeq_v.impl&%0.slice. self! start! end!)) )))
...
(assert (forall ((self! Poly) (child_idx! Poly) (buffer_gc! Poly)) (! (= (req%lib!betree.FilteredBetree_v.impl&%1.flush. self! child_idx! buffer_gc!) (=> %%global_location_label%%67 (lib!betree.FilteredBetree_v.impl&%1.can_flush.? self! child_idx! buffer_gc!))) :pattern ((req%lib!betree.FilteredBetree_v.impl&%1.flush. self! child_idx! buffer_gc!)) )))
...
(assert (forall ((self! Poly) (i! Poly)) (! (= (req%lib!betree.BufferSeq_v.impl&%0.spec_index. self! i!) (=> %%global_location_label%%68 (and (<= 0 (%I i!)) (< (%I i!) (lib!betree.BufferSeq_v.impl&%0.len.? self!))))) :pattern ((req%lib!betree.BufferSeq_v.impl&%0.spec_index. self! i!)) )))
...
(assert (forall ((self! Poly) (offset_map! Poly) (from_idx! Poly) (k! Poly) (buffer_idx! Poly)) (! (= (req%lib!betree.BufferSeq_v.impl&%0.key_in_buffer_filtered. self! offset_map! from_idx! k! buffer_idx!) (and (=> %%global_location_label%%69 (lib!betree.OffsetMap_v.impl&%0.is_total.? offset_map!)) (=> %%global_location_label%%70 (<= 0 (%I from_idx!))))) :pattern ((req%lib!betree.BufferSeq_v.impl&%0.key_in_buffer_filtered. self! offset_map! from_idx! k! buffer_idx!)) )))
...
(set-info :comment ";; Function-Recommends lib::betree::FilteredBetree_v::BetreeNode::make_offset_map")
(set-info :comment ";; betree/FilteredBetree_v.rs:426:5: 426:65 (#0)")
...
(declare-fun %%lambda%%6 (Poly Poly Int) %%Function%%)
(assert (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Int) (k$ Poly)) (! (= (%%apply%%0 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2) k$) (I (ite (lib!betree.FilteredBetree_v.impl&%1.key_in_domain.? %%hole%%0 k$) (lib!betree.FilteredBetree_v.impl&%1.flushed_ofs.? %%hole%%1 k$) %%hole%%2))) :pattern ((%%apply%%0 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2) k$)))))
(assert (=> (fuel_bool fuel%lib!betree.FilteredBetree_v.impl&%1.make_offset_map.) (forall ((self! Poly)) (! (= (lib!betree.FilteredBetree_v.impl&%1.make_offset_map.? self!) (lib!betree.OffsetMap_v.OffsetMap./OffsetMap (%Poly%vstd!map.Map<lib!spec.KeyType_t.Key./nat.>. (vstd!map.impl&%0.new.? $ TYPE%lib!spec.KeyType_t.Key. $ NAT $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ BOOL) $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ NAT) (Poly%fun%1. (mk_fun (%%lambda%%5 (B true)))) (Poly%fun%1. (mk_fun (%%lambda%%6 self! self! (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. (lib!betree.FilteredBetree_v.BetreeNode./Node/buffers (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))))))))))) :pattern ((lib!betree.FilteredBetree_v.impl&%1.make_offset_map.? self!)) ))))
...
(assert (forall ((self! Poly) (start! Poly) (end! Poly) (k! Poly)) (! (= (req%lib!betree.FilteredBetree_v.impl&%1.valid_compact_key_domain. self! start! end! k!) (and (=> %%global_location_label%%71 (lib!betree.FilteredBetree_v.impl&%1.wf.? self!)) (=> %%global_location_label%%72 (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) (=> %%global_location_label%%73 (and (< (%I start!) (%I end!)) (<= (%I end!) (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. (lib!betree.FilteredBetree_v.BetreeNode./Node/buffers (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))))))))) :pattern ((req%lib!betree.FilteredBetree_v.impl&%1.valid_compact_key_domain. self! start! end! k!)) )))
...
(assert (forall ((self! Poly) (start! Poly) (end! Poly) (new_buffer! Poly)) (! (= (req%lib!betree.BufferSeq_v.impl&%0.update_subrange. self! start! end! new_buffer!) (=> %%global_location_label%%74 (and (and (<= 0 (%I start!)) (< (%I start!) (%I end!))) (<= (%I end!) (lib!betree.BufferSeq_v.impl&%0.len.? self!))))) :pattern ((req%lib!betree.BufferSeq_v.impl&%0.update_subrange. self! start! end! new_buffer!)) )))
...
(set-info :comment ";; Function-Recommends lib::betree::FilteredBetree_v::empty_image")
(set-info :comment ";; betree/FilteredBetree_v.rs:32:1: 32:57 (#0)")
(declare-const %return! lib!abstract_system.StampedMap_v.Stamped.)
