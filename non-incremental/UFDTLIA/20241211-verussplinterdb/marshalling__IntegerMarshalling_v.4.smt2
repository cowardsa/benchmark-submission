...
(declare-const sr@ slice%<u8.>.)
(declare-const parsed@ Poly)
...
(assert (not (=> (ens%lib!marshalling.StaticallySized_v.StaticallySized.exec_uniform_size. T&. T& tmp%1) (and (=> %%location_label%%0 (req%lib!marshalling.Slice_v.impl&%1.len. (%Poly%lib!marshalling.Slice_v.Slice. slice!))) (=> (ens%lib!marshalling.Slice_v.impl&%1.len. (%Poly%lib!marshalling.Slice_v.Slice. slice!) tmp%2) (or (and (=> (<= (%I tmp%1) tmp%2) (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL data! tmp%3) (=> (ens%lib!marshalling.StaticallySized_v.StaticallySized.exec_uniform_size. T&. T& tmp%4) (and (=> %%location_label%%1 (uInv SZ (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. slice!)) (%I tmp%4)))) (=> (= tmp%6 (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. slice!))) (=> (= tmp%7 (uClip SZ (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. slice!)) (%I tmp%4)))) (and (=> %%location_label%%2 (req%vstd!slice.slice_subrange. $ (UINT 8) tmp%3 tmp%6 tmp%7)) (=> (ens%vstd!slice.slice_subrange. $ (UINT 8) tmp%3 tmp%6 tmp%7 tmp%5) (=> (= sr@ (%Poly%slice%<u8.>. tmp%5)) (and (=> %%location_label%%3 (req%lib!marshalling.IntegerMarshalling_v.IntFormattable.from_le_bytes. T&. T& (Poly%slice%<u8.>. sr@))) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.from_le_bytes. T&. T& (Poly%slice%<u8.>. sr@) parsed@) (=> (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. sr@)) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)) (I 0) (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? T&. T&)))) (and (=> %%location_label%%4 tmp%8) (=> tmp%8 (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.deepv_is_as_int. T&. T& parsed@) (=> (= tmp%10 (core!option.Option./Some parsed@)) %%switch_label%%0)))))))))))))))) (=> (not (<= (%I tmp%1) tmp%2)) (=> (= tmp%9 (not (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))) (and (=> %%location_label%%5 tmp%9) (=> tmp%9 (=> (= tmp%10 core!option.Option./None) %%switch_label%%0)))))) (and (not %%switch_label%%0) (=> (= %return! (Poly%core!option.Option. tmp%10)) (and (=> %%location_label%%6 (= (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))) (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)))) (=> %%location_label%%7 (=> (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))) (= (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))) (lib!marshalling.Marshalling_v.Marshal.parse.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))))))))))))
(check-sat)
(exit)
