...
(assert (not (=> %%location_label%%0 (= (%B (lib!betree.Buffer_v.Buffer.contains.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. self! key!)) (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!spec.Messages_t.Message. (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!spec.Messages_t.Message.>. (lib!betree.Buffer_v.SimpleBuffer./SimpleBuffer/map (%Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.Buffer_v.Buffer.i.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. self!))))) key!)))))
(check-sat)
(exit)
