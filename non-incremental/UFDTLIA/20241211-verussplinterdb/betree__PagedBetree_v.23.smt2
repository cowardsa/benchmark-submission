...
(declare-const tmp%5 lib!betree.PagedBetree_v.BetreeNode.)
...
(assert (not (=> (lib!betree.PagedBetree_v.impl&%2.wf.? (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (=> (is-lib!betree.PagedBetree_v.BetreeNode./Node_ (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!))) (=> (< 0 (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!))))) (=> (has_type k@ TYPE%lib!spec.KeyType_t.Key.) (=> (= tmp%2 (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.Seq.index. $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) tmp%2 (I 0))) (=> (= tmp%1 (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!))) (I 0))) (or (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. tmp%1 k@) (=> (= tmp%4 (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (and (=> %%location_label%%1 (req%lib!betree.PagedBetree_v.impl&%2.child. tmp%4 k@)) (=> (= tmp%3 (lib!betree.PagedBetree_v.impl&%2.child.? (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!))) k@)) (=> (= tmp%6 (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (=> (= tmp%7 (Poly%lib!spec.KeyType_t.Key. (lib!betree.PagedBetree_v.Path./Path/key (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (and (=> %%location_label%%2 (req%lib!betree.PagedBetree_v.impl&%2.child. tmp%6 tmp%7)) (=> (= tmp%5 (lib!betree.PagedBetree_v.impl&%2.child.? (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.PagedBetree_v.Path./Path/key (%Poly%lib!betree.PagedBetree_v.Path. self!))))) (=> (= tmp%8 (= tmp%3 tmp%5)) %%switch_label%%0))))))))) (=> (not (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. tmp%1 k@)) (=> (= tmp%8 true) %%switch_label%%0))) (not %%switch_label%%0)))))))))))
(check-sat)
(exit)
