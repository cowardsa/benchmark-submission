...
(declare-const tmp%1 lib!allocation_layer.MiniAllocator_v.PageAllocator.)
...
(assert (not (=> (lib!allocation_layer.MiniAllocator_v.impl&%0.wf.? self!) (=> (= tmp%2 (Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.MiniAllocator_v.PageAllocator./PageAllocator/observed (%Poly%lib!allocation_layer.MiniAllocator_v.PageAllocator. self!)))) (=> %%location_label%%0 (req%lib!allocation_layer.MiniAllocator_v.impl&%0.unobserve. self! tmp%2))))))
(check-sat)
(exit)
