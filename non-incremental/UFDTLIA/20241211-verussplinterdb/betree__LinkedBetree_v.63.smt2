...
(declare-const node! Poly)
(declare-const start! Poly)
(declare-const end! Poly)
(declare-const k! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 lib!betree.OffsetMap_v.OffsetMap.)
(declare-const tmp%3 Int)
(declare-const tmp%4 Bool)
(declare-const idx@ Poly)
(declare-const tmp%5 Bool)
(declare-const tmp%6 Bool)
(declare-const slice@ lib!betree.LinkedSeq_v.LinkedSeq.)
(declare-const slice_ofs_map@ lib!betree.OffsetMap_v.OffsetMap.)
(assert fuel_defaults)
(assert (has_type self! (TYPE%lib!betree.BufferDisk_v.BufferDisk. T&. T&)))
(assert (has_type node! TYPE%lib!betree.LinkedBetree_v.BetreeNode.))
...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%0.wf.? node!) (=> (and (< (%I start!) (%I end!)) (<= (%I end!) (lib!betree.LinkedSeq_v.impl&%0.len.? (Poly%lib!betree.LinkedSeq_v.LinkedSeq. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/buffers (%Poly%lib!betree.LinkedBetree_v.BetreeNode. node!)))))) (=> (= tmp%1 (Poly%lib!betree.LinkedSeq_v.LinkedSeq. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/buffers (%Poly%lib!betree.LinkedBetree_v.BetreeNode. node!)))) (and (=> %%location_label%%0 (req%lib!betree.LinkedSeq_v.impl&%0.slice. tmp%1 start! end!)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%0.make_offset_map. node!)) (=> (= tmp%2 (lib!betree.LinkedBetree_v.impl&%0.make_offset_map.? node!)) (=> (= slice_ofs_map@ (lib!betree.OffsetMap_v.impl&%0.decrement.? (Poly%lib!betree.OffsetMap_v.OffsetMap. tmp%2) start!)) (or (and (=> (lib!betree.LinkedBetree_v.impl&%0.key_in_domain.? node! k!) (and (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%0.flushed_ofs. node! k!)) (=> (= tmp%3 (lib!betree.LinkedBetree_v.impl&%0.flushed_ofs.? node! k!)) (=> (= tmp%4 (<= tmp%3 (%I end!))) %%switch_label%%1)))) (=> (not (lib!betree.LinkedBetree_v.impl&%0.key_in_domain.? node! k!)) (=> (= tmp%4 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%4 (=> (has_type idx@ INT) (and (=> %%location_label%%3 (req%lib!betree.BufferDisk_v.impl&%1.key_in_buffer_filtered. T&. T& self! (Poly%lib!betree.LinkedSeq_v.LinkedSeq. slice@) (Poly%lib!betree.OffsetMap_v.OffsetMap. slice_ofs_map@) (I 0) k! idx@)) (=> (= tmp%5 (lib!betree.BufferDisk_v.impl&%1.key_in_buffer_filtered.? T&. T& self! (Poly%lib!betree.LinkedSeq_v.LinkedSeq. slice@) (Poly%lib!betree.OffsetMap_v.OffsetMap. slice_ofs_map@) (I 0) k! idx@)) (=> (= tmp%6 (exists ((idx$ Poly)) (! (and (has_type idx$ INT) (lib!betree.BufferDisk_v.impl&%1.key_in_buffer_filtered.? T&. T& self! (Poly%lib!betree.LinkedSeq_v.LinkedSeq. slice@) (Poly%lib!betree.OffsetMap_v.OffsetMap. slice_ofs_map@) (I 0) k! idx$)) :pattern ((lib!betree.BufferDisk_v.impl&%1.key_in_buffer_filtered.? T&. T& self! (Poly%lib!betree.LinkedSeq_v.LinkedSeq. slice@) (Poly%lib!betree.OffsetMap_v.OffsetMap. slice_ofs_map@) (I 0) k! idx$)) ))) %%switch_label%%0))))) (=> (not tmp%4) (=> (= tmp%6 false) %%switch_label%%0))) (not %%switch_label%%0)))))))))))))
(check-sat)
(exit)
