...
(assert (has_type self! (TYPE%lib!betree.LinkedBetree_v.QueryReceipt. T&. T&)))
...
(assert (not (or (and (=> (lib!betree.LinkedBetree_v.impl&%8.structure.? T&. T& self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%9.all_lines_wf. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%9.all_lines_wf.? T&. T& self!)) (=> (= tmp%2 tmp%1) %%switch_label%%4)))) (=> (not (lib!betree.LinkedBetree_v.impl&%8.structure.? T&. T& self!)) (=> (= tmp%2 false) %%switch_label%%4))) (and (not %%switch_label%%4) (or (and (=> tmp%2 (=> (has_type i@ INT) (or (and (=> (and (<= 0 (%I i@)) (< (%I i@) (Sub (vstd!seq.Seq.len.? $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))) 1))) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%8.child_linked_at. T&. T& self! i@)) (=> (= tmp%3 (lib!betree.LinkedBetree_v.impl&%8.child_linked_at.? T&. T& self! i@)) (=> (= tmp%4 tmp%3) %%switch_label%%3)))) (=> (not (and (<= 0 (%I i@)) (< (%I i@) (Sub (vstd!seq.Seq.len.? $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))) 1)))) (=> (= tmp%4 true) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= tmp%5 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (Sub (vstd!seq.Seq.len.? $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))) 1))) (lib!betree.LinkedBetree_v.impl&%8.child_linked_at.? T&. T& self! i$))) :pattern ((lib!betree.LinkedBetree_v.impl&%8.child_linked_at.? T&. T& self! i$)) ))) %%switch_label%%2))))) (=> (not tmp%2) (=> (= tmp%5 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%5 (=> (has_type i$1@ INT) (or (and (=> (and (<= 0 (%I i$1@)) (< (%I i$1@) (Sub (vstd!seq.Seq.len.? $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))) 1))) (and (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%9.result_linked_at. T&. T& self! i$1@)) (=> (= tmp%6 (lib!betree.LinkedBetree_v.impl&%9.result_linked_at.? T&. T& self! i$1@)) (=> (= tmp%7 tmp%6) %%switch_label%%1)))) (=> (not (and (<= 0 (%I i$1@)) (< (%I i$1@) (Sub (vstd!seq.Seq.len.? $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))) 1)))) (=> (= tmp%7 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%8 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (Sub (vstd!seq.Seq.len.? $ (TYPE%lib!betree.LinkedBetree_v.QueryReceiptLine. T&. T&) (lib!betree.LinkedBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.LinkedBetree_v.QueryReceipt. self!))) 1))) (lib!betree.LinkedBetree_v.impl&%9.result_linked_at.? T&. T& self! i$))) :pattern ((lib!betree.LinkedBetree_v.impl&%9.result_linked_at.? T&. T& self! i$)) ))) %%switch_label%%0))))) (=> (not tmp%5) (=> (= tmp%8 false) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
