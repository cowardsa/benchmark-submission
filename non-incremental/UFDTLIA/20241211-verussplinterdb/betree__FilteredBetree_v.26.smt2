...
(declare-const %return! lib!betree.FilteredBetree_v.Path.)
(declare-const self! Poly)
(declare-const tmp%1 lib!betree.FilteredBetree_v.BetreeNode.)
...
(assert (not (=> (< 0 (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. self!))) (=> (lib!betree.FilteredBetree_v.impl&%1.key_in_domain.? (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.FilteredBetree_v.Path./Path/key (%Poly%lib!betree.FilteredBetree_v.Path. self!)))) (=> (= depth@ (nClip (Sub (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. self!)) 1))) (=> (= tmp%2 (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!)))) (=> (= tmp%3 (Poly%lib!spec.KeyType_t.Key. (lib!betree.FilteredBetree_v.Path./Path/key (%Poly%lib!betree.FilteredBetree_v.Path. self!)))) (=> %%location_label%%0 (req%lib!betree.FilteredBetree_v.impl&%1.child. tmp%2 tmp%3)))))))))
(check-sat)
(exit)
