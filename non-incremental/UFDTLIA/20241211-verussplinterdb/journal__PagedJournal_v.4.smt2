...
(assert (not (or (and (=> (and (lib!journal.PagedJournal_v.impl&%0.wf.? self!) (< (%I boundary_lsn!) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))))))) (or (and (=> (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))) boundary_lsn!) (=> (= tmp%4 true) %%switch_label%%1)) (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))) boundary_lsn!)) (or (and (=> (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!journal.PagedJournal_v.JournalRecord. tmp%2)) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))))) (=> (= tmp%3 (lib!journal.PagedJournal_v.impl&%0.valid.? tmp%1 boundary_lsn!)) %%switch_label%%2))))) (=> (not (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))) (=> (= tmp%3 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%4 tmp%3) %%switch_label%%1))))) (and (not %%switch_label%%1) (=> (= tmp%5 tmp%4) %%switch_label%%0)))) (=> (not (and (lib!journal.PagedJournal_v.impl&%0.wf.? self!) (< (%I boundary_lsn!) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))))))) (=> (= tmp%5 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
