...
(declare-const tmp%5 lib!betree.PivotBranch_v.Node.)
...
(declare-fun %%lambda%%9 (Poly Poly Poly lib!betree.PivotBranch_v.Node.) %%Function%%)
(assert (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 lib!betree.PivotBranch_v.Node.) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%9 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) i$) (Poly%lib!betree.PivotBranch_v.Node. (ite (lib!betree.LinkedBranch_v.impl&%3.valid_child_index.? %%hole%%0 i$) (lib!betree.LinkedBranch_v.Refinement_v.impl&%0.i_internal.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.impl&%5.child_at_idx.? %%hole%%1 i$)) %%hole%%2) %%hole%%3))) :pattern ((%%apply%%0 (%%lambda%%9 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) i$)))))
