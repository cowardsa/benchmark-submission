...
(declare-const %return! vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.)
(declare-const self! Poly)
(declare-const tmp%1 vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>.)
(declare-const tmp%2 vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.)
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.acyclic.? self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.the_ranking. self!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.the_ranking.? self!)) (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%5.reachable_addrs_using_ranking. self! (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. tmp%1))))))))
(check-sat)
(exit)
