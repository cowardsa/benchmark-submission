...
(assert (not (=> (lib!betree.PivotBetree_v.impl&%1.can_split_leaf.? self! split_key!) (and (=> %%location_label%%0 (req%lib!betree.PivotBetree_v.impl&%1.my_domain. self!)) (=> (= tmp%1 (lib!betree.PivotBetree_v.impl&%1.my_domain.? self!)) (=> (= left_filter@ (lib!betree.Domain_v.Domain./Domain (%Poly%lib!spec.KeyType_t.Element. (Poly%lib!spec.KeyType_t.Element. (lib!betree.Domain_v.Domain./Domain/start (%Poly%lib!betree.Domain_v.Domain. (Poly%lib!betree.Domain_v.Domain. tmp%1))))) (%Poly%lib!spec.KeyType_t.Element. (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!))))) (and (=> %%location_label%%1 (req%lib!betree.PivotBetree_v.impl&%1.my_domain. self!)) (=> (= tmp%2 (lib!betree.PivotBetree_v.impl&%1.my_domain.? self!)) (=> (= right_filter@ (lib!betree.Domain_v.Domain./Domain (%Poly%lib!spec.KeyType_t.Element. (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!))) (%Poly%lib!spec.KeyType_t.Element. (Poly%lib!spec.KeyType_t.Element. (lib!betree.Domain_v.Domain./Domain/end (%Poly%lib!betree.Domain_v.Domain. (Poly%lib!betree.Domain_v.Domain. tmp%2))))))) (=> (= tmp%4 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (=> (= tmp%5 (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!))) (and (=> %%location_label%%2 (req%lib!betree.PivotTable_v.impl&%0.update. tmp%4 (I 1) tmp%5)) (=> (= tmp%3 (lib!betree.PivotTable_v.impl&%0.update.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (I 1) (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!)))) (=> (= new_left@ (lib!betree.PivotBetree_v.BetreeNode./Node (%Poly%lib!betree.Buffer_v.SimpleBuffer. (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.Buffer_v.impl&%1.apply_filter.? (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.PivotBetree_v.BetreeNode./Node/buffer (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.Domain_v.impl&%1.key_set.? (Poly%lib!betree.Domain_v.Domain. left_filter@)))))) (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. tmp%3)) (%Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))))) (=> (= tmp%7 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (=> (= tmp%8 (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!))) (=> %%location_label%%3 (req%lib!betree.PivotTable_v.impl&%0.update. tmp%7 (I 0) tmp%8))))))))))))))))))
(check-sat)
(exit)
