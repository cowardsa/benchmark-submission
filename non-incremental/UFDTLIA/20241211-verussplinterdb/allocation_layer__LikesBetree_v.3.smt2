...
(declare-const children_betree_likes@ vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>.)
(declare-const tmp%1 vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>.)
