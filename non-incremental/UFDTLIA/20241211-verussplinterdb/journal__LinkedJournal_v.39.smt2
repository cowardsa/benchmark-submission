...
(assert (not (=> (= decrease%init0 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? self! ptr!)) (=> (and (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! ptr!) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. ptr!)) (=> (= tmp%3 core!option.Option./None) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. ptr!))) (=> (= jr@ (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (core!option.Option./Some/0 (%Poly%core!option.Option. ptr!))))) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%0.cropped_prior.? (Poly%lib!journal.LinkedJournal_v.JournalRecord. jr@) (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)) (ptr!$1 (%Poly%core!option.Option. tmp%2))) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!$0) (Poly%core!option.Option. ptr!$1))) decrease%init0 false)) (=> (has_type (Poly%core!option.Option. tmp%1) (TYPE%core!option.Option. $ TYPE%lib!journal.PagedJournal_v.JournalRecord.)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.iptr.? self! (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%0.cropped_prior.? (Poly%lib!journal.LinkedJournal_v.JournalRecord. jr@) (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))))))) (=> (= tmp%3 (core!option.Option./Some (Poly%lib!journal.PagedJournal_v.JournalRecord. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (Poly%lib!journal.LinkedJournal_v.JournalRecord. jr@))))) (%Poly%core!option.Option. (Poly%core!option.Option. tmp%1)))))) %%switch_label%%0)))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
