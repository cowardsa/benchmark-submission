...
(set-info :comment ";; MODULE 'module betree::OffsetMap_v'")
...
(set-info :comment ";; Function-Decl lib::betree::OffsetMap_v::OffsetMap::get")
...
(set-info :comment ";; Function-Recommends lib::betree::OffsetMap_v::OffsetMap::decrement")
(set-info :comment ";; betree/OffsetMap_v.rs:37:5: 37:67 (#0)")
(declare-const %return! lib!betree.OffsetMap_v.OffsetMap.)
