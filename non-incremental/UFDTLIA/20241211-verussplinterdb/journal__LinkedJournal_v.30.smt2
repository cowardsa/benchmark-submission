...
(declare-const %return! vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>.)
(declare-const self! Poly)
(declare-const tmp%1 Bool)
(declare-const ranking@ Poly)
(declare-const tmp%2 Bool)
(declare-const ranking$1@ Poly)
...
(set-info :comment ";; recommendation not met: cannot prove that there exists values that satisfy the condition of the choose expression")
(declare-const %%location_label%%2 Bool)
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.wf.? self!) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!) (=> (has_type ranking@ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.valid_ranking. self! ranking@)) (=> (= tmp%2 (lib!journal.LinkedJournal_v.impl&%1.valid_ranking.? self! ranking@)) (=> (has_type ranking$1@ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (=> %%location_label%%2 (exists ((ranking$ Poly)) (! (and (has_type ranking$ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (lib!journal.LinkedJournal_v.impl&%1.valid_ranking.? self! ranking$)) :pattern ((lib!journal.LinkedJournal_v.impl&%1.valid_ranking.? self! ranking$)) )))))))))))))
(check-sat)
(exit)
