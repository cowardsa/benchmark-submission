...
(assert (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))
...
(assert (not (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL data! tmp%1) (=> (ens%lib!marshalling.StaticallySized_v.StaticallySized.exec_uniform_size. T&. T& tmp%2) (and (=> %%location_label%%0 (uInv SZ (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. slice!)) (%I tmp%2)))) (=> (= tmp%4 (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. slice!))) (=> (= tmp%5 (uClip SZ (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. slice!)) (%I tmp%2)))) (and (=> %%location_label%%1 (req%vstd!slice.slice_subrange. $ (UINT 8) tmp%1 tmp%4 tmp%5)) (=> (ens%vstd!slice.slice_subrange. $ (UINT 8) tmp%1 tmp%4 tmp%5 tmp%3) (=> (= sr@ (%Poly%slice%<u8.>. tmp%3)) (=> (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. sr@)) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)) (I 0) (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? T&. T&)))) (and (=> %%location_label%%2 tmp%6) (=> tmp%6 (and (=> %%location_label%%3 (req%lib!marshalling.IntegerMarshalling_v.IntFormattable.from_le_bytes. T&. T& (Poly%slice%<u8.>. sr@))) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.from_le_bytes. T&. T& (Poly%slice%<u8.>. sr@) value@) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.deepv_is_as_int. T&. T& value@) (=> (= %return! value@) (=> %%location_label%%4 (= (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&)) %return!) (lib!marshalling.Marshalling_v.Marshal.parse.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))))))))))))))))))))
(check-sat)
(exit)
