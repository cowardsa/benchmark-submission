...
(set-info :comment ";; Function-Specs lib::journal::LinkedJournal_v::DiskView::decodable_implies_lsns_have_entries")
(declare-fun req%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. (lib!journal.LinkedJournal_v.DiskView. core!option.Option.) Bool)
(declare-const %%global_location_label%%61 Bool)
(declare-const %%global_location_label%%62 Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.DiskView.) (root! core!option.Option.)) (! (= (req%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. self! root!) (and (=> %%global_location_label%%61 (lib!journal.LinkedJournal_v.impl&%1.decodable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) (=> %%global_location_label%%62 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!))))) :pattern ((req%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. self! root!)) )))
(declare-fun ens%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. (lib!journal.LinkedJournal_v.DiskView. core!option.Option.) Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.DiskView.) (root! core!option.Option.)) (! (= (ens%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. self! root!) (lib!journal.LinkedJournal_v.impl&%1.lsns_have_entries.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. root!))) :pattern ((ens%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. self! root!)) )))
(set-info :comment ";; Function-Def lib::journal::LinkedJournal_v::DiskView::decodable_implies_lsns_have_entries")
(set-info :comment ";; journal/LinkedJournal_v.rs:575:5: 575:74 (#0)")
(set-info :comment ";; Function-Specs lib::journal::LinkedJournal_v::TruncatedJournal::decodable_implies_lsns_have_entries")
(declare-fun req%lib!journal.LinkedJournal_v.impl&%2.decodable_implies_lsns_have_entries. (lib!journal.LinkedJournal_v.TruncatedJournal.) Bool)
(declare-const %%global_location_label%%63 Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.TruncatedJournal.)) (! (= (req%lib!journal.LinkedJournal_v.impl&%2.decodable_implies_lsns_have_entries. self!) (=> %%global_location_label%%63 (lib!journal.LinkedJournal_v.impl&%2.decodable.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) :pattern ((req%lib!journal.LinkedJournal_v.impl&%2.decodable_implies_lsns_have_entries. self!)) )))
(declare-fun ens%lib!journal.LinkedJournal_v.impl&%2.decodable_implies_lsns_have_entries. (lib!journal.LinkedJournal_v.TruncatedJournal.) Bool)
(assert (forall ((self! lib!journal.LinkedJournal_v.TruncatedJournal.)) (! (= (ens%lib!journal.LinkedJournal_v.impl&%2.decodable_implies_lsns_have_entries. self!) (lib!journal.LinkedJournal_v.impl&%2.lsns_have_entries.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))) :pattern ((ens%lib!journal.LinkedJournal_v.impl&%2.decodable_implies_lsns_have_entries. self!)) )))
(set-info :comment ";; Function-Def lib::journal::LinkedJournal_v::TruncatedJournal::decodable_implies_lsns_have_entries")
(set-info :comment ";; journal/LinkedJournal_v.rs:721:5: 721:59 (#0)")
(declare-const self! lib!journal.LinkedJournal_v.TruncatedJournal.)
(declare-const tmp%1 lib!journal.LinkedJournal_v.DiskView.)
(declare-const tmp%2 core!option.Option.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!) TYPE%lib!journal.LinkedJournal_v.TruncatedJournal.))
(assert (lib!journal.LinkedJournal_v.impl&%2.decodable.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (=> (= tmp%2 (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. tmp%1 tmp%2)) (=> (ens%lib!journal.LinkedJournal_v.impl&%1.decodable_implies_lsns_have_entries. tmp%1 tmp%2) (=> %%location_label%%1 (lib!journal.LinkedJournal_v.impl&%2.lsns_have_entries.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))))))))
(check-sat)
(exit)
