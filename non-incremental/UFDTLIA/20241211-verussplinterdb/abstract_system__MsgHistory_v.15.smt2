...
(assert (has_type stamped_map! (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.)))
(assert (has_type history! TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.))
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!))) (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? history!) (=> (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? history! (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. stamped_map!)))) (=> %%location_label%%0 (req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map. history! stamped_map!)))))))
(check-sat)
(exit)
