...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (or (and (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (=> (= tmp%2 (vstd!seq.Seq.len.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%1)))))) %%switch_label%%0)))) (=> (not (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) (=> (= tmp%2 0) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
