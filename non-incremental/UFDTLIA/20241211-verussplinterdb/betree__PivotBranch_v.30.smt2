...
(declare-const from! Poly)
(declare-const to! Poly)
...
(assert (has_type from! INT))
(assert (has_type to! INT))
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (is-lib!betree.PivotBranch_v.Node./Index_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (= (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (nClip (Add (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!)))) 1))) (=> (and (and (<= 0 (%I from!)) (< (%I from!) (%I to!))) (<= (%I to!) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!)))))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (=> (= tmp%3 (I (Sub (%I to!) 1))) (and (=> %%location_label%%0 (req%vstd!seq.Seq.subrange. $ TYPE%lib!spec.KeyType_t.Key. tmp%2 from! tmp%3)) (=> (= tmp%1 (vstd!seq.Seq.subrange.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!))) from! (I (Sub (%I to!) 1)))) (=> (= tmp%5 (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (=> %%location_label%%1 (req%vstd!seq.Seq.subrange. $ TYPE%lib!betree.PivotBranch_v.Node. tmp%5 from! to!))))))))))))
(check-sat)
(exit)
