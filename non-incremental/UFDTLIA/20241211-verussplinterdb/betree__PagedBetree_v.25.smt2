...
(assert (not (or (and (=> (and (lib!betree.PagedBetree_v.impl&%2.wf.? (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (is-lib!betree.PagedBetree_v.BetreeNode./Node_ (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (or (and (=> (< 0 (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!))))) (and (=> %%location_label%%0 (req%lib!betree.PagedBetree_v.impl&%5.subpath. self!)) (=> (= tmp%1 (lib!betree.PagedBetree_v.impl&%5.subpath.? self!)) (or (and (=> (lib!betree.PagedBetree_v.impl&%5.valid.? (Poly%lib!betree.PagedBetree_v.Path. tmp%1)) (and (=> %%location_label%%1 (req%lib!betree.PagedBetree_v.impl&%5.common_children. self!)) (=> (= tmp%2 (lib!betree.PagedBetree_v.impl&%5.common_children.? self!)) (=> (= tmp%3 tmp%2) %%switch_label%%2)))) (=> (not (lib!betree.PagedBetree_v.impl&%5.valid.? (Poly%lib!betree.PagedBetree_v.Path. tmp%1))) (=> (= tmp%3 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%4 tmp%3) %%switch_label%%1)))))) (=> (not (< 0 (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))))) (=> (= tmp%4 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%5 tmp%4) %%switch_label%%0)))) (=> (not (and (lib!betree.PagedBetree_v.impl&%2.wf.? (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (is-lib!betree.PagedBetree_v.BetreeNode./Node_ (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!))))) (=> (= tmp%5 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
