...
(declare-const key1! lib!spec.KeyType_t.Key.)
(declare-const key2! lib!spec.KeyType_t.Key.)
...
(assert (has_type (Poly%lib!spec.KeyType_t.Key. key1!) TYPE%lib!spec.KeyType_t.Key.))
(assert (has_type (Poly%lib!spec.KeyType_t.Key. key2!) TYPE%lib!spec.KeyType_t.Key.))
(assert (lib!betree.PivotBranch_v.impl&%3.wf.? (Poly%lib!betree.PivotBranch_v.Node. node!)))
(assert (lib!spec.KeyType_t.impl&%1.lte.? (Poly%lib!spec.KeyType_t.Key. key1!) (Poly%lib!spec.KeyType_t.Key. key2!)))
...
(assert (not (=> (= s@ (ite (is-lib!betree.PivotBranch_v.Node./Leaf_ node!) (lib!betree.PivotBranch_v.Node./Leaf/keys (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. node!))) (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. node!))))) (and (=> %%location_label%%0 (req%lib!spec.KeyType_t.impl&%1.strictly_sorted_implies_sorted. s@)) (=> (ens%lib!spec.KeyType_t.impl&%1.strictly_sorted_implies_sorted. s@) (=> (= tmp%1 (lib!spec.KeyType_t.impl&%1.largest_lte.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s@) (Poly%lib!spec.KeyType_t.Key. key1!))) (and (=> %%location_label%%1 (req%lib!spec.KeyType_t.impl&%1.largest_lte_ensures. s@ key1! tmp%1)) (=> (ens%lib!spec.KeyType_t.impl&%1.largest_lte_ensures. s@ key1! tmp%1) (=> (= tmp%2 (lib!spec.KeyType_t.impl&%1.largest_lte.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s@) (Poly%lib!spec.KeyType_t.Key. key2!))) (and (=> %%location_label%%2 (req%lib!spec.KeyType_t.impl&%1.largest_lte_ensures. s@ key2! tmp%2)) (=> (ens%lib!spec.KeyType_t.impl&%1.largest_lte_ensures. s@ key2! tmp%2) (or (and (=> (> (lib!spec.KeyType_t.impl&%1.largest_lte.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s@) (Poly%lib!spec.KeyType_t.Key. key1!)) (lib!spec.KeyType_t.impl&%1.largest_lte.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s@) (Poly%lib!spec.KeyType_t.Key. key2!))) (=> (= tmp%3 (lib!spec.KeyType_t.impl&%1.lt.? (Poly%lib!spec.KeyType_t.Key. key2!) (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s@) (I (lib!spec.KeyType_t.impl&%1.largest_lte.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s@) (Poly%lib!spec.KeyType_t.Key. key1!)))))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> (= tmp%4 (lib!spec.KeyType_t.impl&%1.lt.? (Poly%lib!spec.KeyType_t.Key. key2!) (Poly%lib!spec.KeyType_t.Key. key1!))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 %%switch_label%%0))))))) (=> (not (> (lib!spec.KeyType_t.impl&%1.largest_lte.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s@) (Poly%lib!spec.KeyType_t.Key. key1!)) (lib!spec.KeyType_t.impl&%1.largest_lte.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s@) (Poly%lib!spec.KeyType_t.Key. key2!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%5 (<= (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. node!) (Poly%lib!spec.KeyType_t.Key. key1!)) (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. node!) (Poly%lib!spec.KeyType_t.Key. key2!)))))))))))))))))
(check-sat)
(exit)
