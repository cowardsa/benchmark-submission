...
(assert (forall ((self! lib!journal.LinkedJournal_v.TruncatedJournal.)) (! (= (req%lib!allocation_layer.LikesJournal_v.impl&%3.build_lsn_addr_index_ensures. self!) (=> %%global_location_label%%58 (lib!journal.LinkedJournal_v.impl&%2.decodable.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) :pattern ((req%lib!allocation_layer.LikesJournal_v.impl&%3.build_lsn_addr_index_ensures. self!)) )))
...
(set-info :comment ";; Function-Def lib::journal::LinkedJournal_v::TruncatedJournal::build_lsn_addr_index_ensures")
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:484:5: 484:52 (#0)")
...
(declare-const tmp%3 lib!journal.LinkedJournal_v.DiskView.)
...
(assert (not (=> (fuel_bool fuel%lib!allocation_layer.LikesJournal_v.impl&%5.index_domain_valid.) (=> (fuel_bool fuel%lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries.) (or (and (=> (is-core!option.Option./Some_ (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (=> (= tmp%1 (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (=> (= tmp%2 (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%0 (req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_domain_valid. tmp%1 tmp%2)) (=> (ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_domain_valid. tmp%1 tmp%2) (=> (= tmp%3 (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (=> (= tmp%4 (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (and (=> %%location_label%%1 (req%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. tmp%3 tmp%4)) (=> (ens%lib!allocation_layer.LikesJournal_v.impl&%2.build_lsn_addr_index_range_valid. tmp%3 tmp%4) %%switch_label%%0))))))))) (=> (not (is-core!option.Option./Some_ (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%2 (lib!allocation_layer.LikesJournal_v.impl&%5.index_domain_valid.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%3.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))))) (and (=> %%location_label%%3 (lib!allocation_layer.LikesJournal_v.impl&%2.index_keys_map_to_valid_entries.? (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%3.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))))) (=> %%location_label%%4 (lib!allocation_layer.LikesJournal_v.impl&%5.index_range_valid.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesJournal_v.impl&%3.build_lsn_addr_index.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))))))))))))
(check-sat)
(exit)
