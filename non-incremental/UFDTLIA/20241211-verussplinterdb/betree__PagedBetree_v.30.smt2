...
(declare-const filtered_children@ lib!betree.PagedBetree_v.ChildMap.)
(declare-const tmp%1 Poly)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.PagedBetree_v.BetreeNode.))
(assert (has_type filter! (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.)))
(declare-fun %%lambda%%6 (Dcr Type Poly Dcr Type Dcr Type Poly lib!betree.PagedBetree_v.BetreeNode.) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Poly) (%%hole%%8 lib!betree.PagedBetree_v.BetreeNode.) (k$ Poly)) (! (= (%%apply%%0 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) k$) (Poly%lib!betree.PagedBetree_v.BetreeNode. (ite (vstd!set.impl&%0.contains.? %%hole%%0 %%hole%%1 %%hole%%2 k$) (%Poly%lib!betree.PagedBetree_v.BetreeNode. (vstd!map.impl&%0.index.? %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 k$)) %%hole%%8))) :pattern ((%%apply%%0 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) k$)))))
(declare-const %%switch_label%%0 Bool)
(assert (not (or (and (=> (is-lib!betree.PagedBetree_v.BetreeNode./Nil_ (%Poly%lib!betree.PagedBetree_v.BetreeNode. self!)) (=> (= tmp%1 self!) %%switch_label%%0)) (=> (not (is-lib!betree.PagedBetree_v.BetreeNode./Nil_ (%Poly%lib!betree.PagedBetree_v.BetreeNode. self!))) (=> (has_type k@ TYPE%lib!spec.KeyType_t.Key.) (=> (has_type k$1@ TYPE%lib!spec.KeyType_t.Key.) (=> (= filtered_children@ (lib!betree.PagedBetree_v.ChildMap./ChildMap (%Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!betree.PagedBetree_v.BetreeNode.>. (vstd!map.impl&%0.new.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!betree.PagedBetree_v.BetreeNode. $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ BOOL) $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!betree.PagedBetree_v.BetreeNode.) (Poly%fun%1. (mk_fun (%%lambda%%4 (B true)))) (Poly%fun%1. (mk_fun (%%lambda%%6 $ TYPE%lib!spec.KeyType_t.Key. filter! $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!betree.PagedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!betree.PagedBetree_v.BetreeNode.>. (lib!betree.PagedBetree_v.ChildMap./ChildMap/map (%Poly%lib!betree.PagedBetree_v.ChildMap. (Poly%lib!betree.PagedBetree_v.ChildMap. (lib!betree.PagedBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PagedBetree_v.BetreeNode. self!)))))) lib!betree.PagedBetree_v.BetreeNode./Nil))))))) (=> (= tmp%1 (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.BetreeNode./Node (%Poly%lib!betree.Buffer_v.SimpleBuffer. (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.Buffer_v.impl&%1.apply_filter.? (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.PagedBetree_v.BetreeNode./Node/buffer (%Poly%lib!betree.PagedBetree_v.BetreeNode. self!))) filter!))) (%Poly%lib!betree.PagedBetree_v.ChildMap. (Poly%lib!betree.PagedBetree_v.ChildMap. filtered_children@))))) %%switch_label%%0)))))) (not %%switch_label%%0))))
(check-sat)
(exit)
