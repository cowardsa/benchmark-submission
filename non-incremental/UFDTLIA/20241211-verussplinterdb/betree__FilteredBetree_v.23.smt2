...
(declare-const tmp%3 lib!betree.FilteredBetree_v.BetreeNode.)
(declare-const buffers@ lib!betree.BufferSeq_v.BufferSeq.)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.FilteredBetree_v.BetreeNode.))
(assert (has_type memtable! (TYPE%lib!betree.Memtable_v.Memtable. $ TYPE%lib!betree.Buffer_v.SimpleBuffer.)))
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (lib!betree.FilteredBetree_v.impl&%1.wf.? self!) (=> (= buffers@ (lib!betree.BufferSeq_v.BufferSeq./BufferSeq (%Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (vstd!seq.Seq.push.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (vstd!seq.Seq.empty.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer.) (lib!betree.Memtable_v.Memtable./Memtable/buffer (%Poly%lib!betree.Memtable_v.Memtable. memtable!)))))) (=> (= tmp%2 (Poly%lib!betree.Domain_v.Domain. (lib!betree.Domain_v.total_domain.? (I 0)))) (and (=> %%location_label%%0 (req%lib!betree.FilteredBetree_v.impl&%1.promote. self! tmp%2)) (=> (= tmp%1 (lib!betree.FilteredBetree_v.impl&%1.promote.? self! (Poly%lib!betree.Domain_v.Domain. (lib!betree.Domain_v.total_domain.? (I 0))))) (=> %%location_label%%1 (req%lib!betree.FilteredBetree_v.impl&%1.extend_buffer_seq. (Poly%lib!betree.FilteredBetree_v.BetreeNode. tmp%1) (Poly%lib!betree.BufferSeq_v.BufferSeq. buffers@))))))))))
(check-sat)
(exit)
