...
(assert (not (=> (= decrease%init0 (Sub (lib!betree.BufferSeq_v.impl&%0.len.? self!) (%I start!))) (=> (<= (%I start!) (lib!betree.BufferSeq_v.impl&%0.len.? self!)) (or (and (=> (= (%I start!) (lib!betree.BufferSeq_v.impl&%0.len.? self!)) (=> (= tmp%3 (lib!spec.Messages_t.Message./Update (%Poly%lib!spec.Messages_t.Delta. (Poly%lib!spec.Messages_t.Delta. (lib!spec.Messages_t.nop_delta.? (I 0)))))) %%switch_label%%0)) (=> (not (= (%I start!) (lib!betree.BufferSeq_v.impl&%0.len.? self!))) (=> (= tmp%2 (I (Add (%I start!) 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.BufferSeq_v.BufferSeq. self!)) (key!$1 (%Poly%lib!spec.KeyType_t.Key. key!)) (start!$2 (%I tmp%2))) (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. self!$0)) start!$2)) decrease%init0 false)) (=> (has_type (Poly%lib!spec.Messages_t.Message. tmp%1) TYPE%lib!spec.Messages_t.Message.) (=> (= tmp%1 (lib!betree.BufferSeq_v.impl&%0.query_from.? self! key! (I (Add (%I start!) 1)))) (=> (= tmp%3 (lib!spec.Messages_t.impl&%1.merge.? (lib!betree.Buffer_v.Buffer.query.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. self!))) start!) key!) (Poly%lib!spec.Messages_t.Message. tmp%1))) %%switch_label%%0))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
