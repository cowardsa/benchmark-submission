...
(declare-const boundary! Poly)
(declare-const message_seq! Poly)
(declare-const lsn! Poly)
(assert fuel_defaults)
(assert (has_type boundary! NAT))
(assert (has_type message_seq! TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.))
