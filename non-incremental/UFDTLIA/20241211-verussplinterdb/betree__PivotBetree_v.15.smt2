...
(declare-const tmp%4 lib!betree.PivotBetree_v.BetreeNode.)
...
(assert (not (=> (lib!betree.PivotBetree_v.impl&%3.all_lines_wf.? self!) (=> (lib!betree.PivotBetree_v.impl&%3.structure.? self!) (=> (and (<= 0 (%I i!)) (< (%I i!) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.QueryReceiptLine.>. (lib!betree.PivotBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PivotBetree_v.QueryReceipt. self!)))) 1))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.QueryReceiptLine.>. (lib!betree.PivotBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PivotBetree_v.QueryReceipt. self!)))) (=> (= tmp%3 (I (Add (%I i!) 1))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.PivotBetree_v.QueryReceiptLine. tmp%2 tmp%3)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBetree_v.QueryReceiptLine. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.QueryReceiptLine.>. (lib!betree.PivotBetree_v.QueryReceipt./QueryReceipt/lines (%Poly%lib!betree.PivotBetree_v.QueryReceipt. self!))) (I (Add (%I i!) 1)))) (=> %%location_label%%1 (req%lib!betree.PivotBetree_v.impl&%3.child_at. self! i!)))))))))))
(check-sat)
(exit)
