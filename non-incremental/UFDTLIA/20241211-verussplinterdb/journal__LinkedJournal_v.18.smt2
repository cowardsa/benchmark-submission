...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.wf.? self!) (=> (has_type ranking@ (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT)) (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.valid_ranking. self! ranking@))))))
(check-sat)
(exit)
