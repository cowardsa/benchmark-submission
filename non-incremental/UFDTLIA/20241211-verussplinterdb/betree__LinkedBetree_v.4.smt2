...
(assert (not (or (and (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. ptr!)) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. ptr!)) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. ptr!))) (=> (= tmp%2 (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!)))) tmp%1)) %%switch_label%%0)))) (=> (not (is-core!option.Option./Some_ (%Poly%core!option.Option. ptr!))) (=> (= tmp%2 true) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
