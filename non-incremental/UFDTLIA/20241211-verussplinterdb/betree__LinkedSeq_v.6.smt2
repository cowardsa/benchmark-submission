...
(set-info :comment ";; MODULE 'module betree::LinkedSeq_v'")
...
(set-info :comment ";; Function-Recommends lib::betree::LinkedSeq_v::LinkedSeq::len")
(set-info :comment ";; betree/LinkedSeq_v.rs:21:5: 21:47 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::LinkedSeq_v::LinkedSeq::spec_index")
(set-info :comment ";; betree/LinkedSeq_v.rs:26:5: 26:66 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::LinkedSeq_v::LinkedSeq::extend")
(set-info :comment ";; betree/LinkedSeq_v.rs:43:5: 43:73 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::LinkedSeq_v::LinkedSeq::empty")
(set-info :comment ";; betree/LinkedSeq_v.rs:16:5: 16:51 (#0)")
...
(assert (forall ((self! Poly) (start! Poly) (end! Poly)) (! (= (req%lib!betree.LinkedSeq_v.impl&%0.slice. self! start! end!) (=> %%global_location_label%%4 (and (and (<= 0 (%I start!)) (<= (%I start!) (%I end!))) (<= (%I end!) (lib!betree.LinkedSeq_v.impl&%0.len.? self!))))) :pattern ((req%lib!betree.LinkedSeq_v.impl&%0.slice. self! start! end!)) )))
(set-info :comment ";; Function-Recommends lib::betree::LinkedSeq_v::LinkedSeq::slice")
(set-info :comment ";; betree/LinkedSeq_v.rs:37:5: 37:77 (#0)")
...
(assert (forall ((self! Poly) (start! Poly) (end! Poly) (new_addr! Poly)) (! (= (req%lib!betree.LinkedSeq_v.impl&%0.update_subrange. self! start! end! new_addr!) (=> %%global_location_label%%5 (and (and (<= 0 (%I start!)) (< (%I start!) (%I end!))) (<= (%I end!) (lib!betree.LinkedSeq_v.impl&%0.len.? self!))))) :pattern ((req%lib!betree.LinkedSeq_v.impl&%0.update_subrange. self! start! end! new_addr!)) )))
(set-info :comment ";; Function-Recommends lib::betree::LinkedSeq_v::LinkedSeq::update_subrange")
(set-info :comment ";; betree/LinkedSeq_v.rs:48:5: 48:106 (#0)")
(declare-const %return! lib!betree.LinkedSeq_v.LinkedSeq.)
(declare-const self! Poly)
(declare-const start! Poly)
(declare-const end! Poly)
(declare-const new_addr! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Poly)
(declare-const tmp%3 Poly)
(declare-const tmp%4 Poly)
(declare-const tmp%5 Poly)
(declare-const addrs@ vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>.)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.LinkedSeq_v.LinkedSeq.))
(assert (has_type start! INT))
(assert (has_type end! INT))
(assert (has_type new_addr! TYPE%lib!spec.AsyncDisk_t.Address.))
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (and (and (<= 0 (%I start!)) (< (%I start!) (%I end!))) (<= (%I end!) (lib!betree.LinkedSeq_v.impl&%0.len.? self!))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedSeq_v.LinkedSeq./LinkedSeq/addrs (%Poly%lib!betree.LinkedSeq_v.LinkedSeq. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.Seq.subrange. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%2 (I 0) start!)) (=> (= tmp%1 (vstd!seq.Seq.subrange.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedSeq_v.LinkedSeq./LinkedSeq/addrs (%Poly%lib!betree.LinkedSeq_v.LinkedSeq. self!))) (I 0) start!)) (=> (= tmp%4 (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedSeq_v.LinkedSeq./LinkedSeq/addrs (%Poly%lib!betree.LinkedSeq_v.LinkedSeq. self!)))) (=> (= tmp%5 (I (lib!betree.LinkedSeq_v.impl&%0.len.? self!))) (=> %%location_label%%1 (req%vstd!seq.Seq.subrange. $ TYPE%lib!spec.AsyncDisk_t.Address. tmp%4 end! tmp%5))))))))))
(check-sat)
(exit)
