...
(assert (not (=> (lib!journal.PagedJournal_v.impl&%0.opt_rec_can_crop_head_records.? ojr! boundary_lsn! depth!) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. ojr!)) (=> (= tmp%2 core!option.Option./None) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. ojr!))) (=> (= rec@ (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. ojr!)))) (and (=> %%location_label%%0 (req%lib!journal.PagedJournal_v.impl&%0.crop_head_records. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@) boundary_lsn! depth!)) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%0.crop_head_records.? (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@) boundary_lsn! depth!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
