...
(assert (uInv SZ a!))
(assert (uInv SZ b!))
(assert (and (<= a! b!) (<= b! (lib!marshalling.Slice_v.impl&%0.len.? (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!))))))
...
(assert (not (and (=> %%location_label%%0 (uInv SZ (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!))) a!))) (and (=> %%location_label%%1 (uInv SZ (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!))) b!))) (=> (= out! (lib!marshalling.Slice_v.Slice./Slice (%I (I (uClip SZ (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!))) a!)))) (%I (I (uClip SZ (Add (lib!marshalling.Slice_v.Slice./Slice/start (%Poly%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!))) b!)))))) (=> %%location_label%%2 (= (%Poly%lib!marshalling.Slice_v.SpecSlice. (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. out!))) (lib!marshalling.Slice_v.impl&%0.subslice.? (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. (Poly%lib!marshalling.Slice_v.Slice. self!)) (I a!) (I b!)))))))))
(check-sat)
(exit)
