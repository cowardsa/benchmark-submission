...
(declare-const pivot@ lib!spec.KeyType_t.Key.)
(declare-const split_index@ Int)
(declare-const left_root@ lib!betree.LinkedBranch_v.Node.)
(declare-const right_root@ lib!betree.LinkedBranch_v.Node.)
(declare-const new_disk_view@ lib!betree.LinkedBranch_v.DiskView.)
(declare-const left_leaf@ lib!betree.LinkedBranch_v.LinkedBranch.)
(declare-const right_leaf@ lib!betree.LinkedBranch_v.LinkedBranch.)
