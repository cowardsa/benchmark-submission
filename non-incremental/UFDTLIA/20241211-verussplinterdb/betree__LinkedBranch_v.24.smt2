...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!))) (=> (= decrease%init1 1) (or (and (=> (= (lib!betree.LinkedBranch_v.impl&%3.route.? (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.LinkedBranch_v.Path./Path/key (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (lib!betree.LinkedBranch_v.impl&%3.route.? (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))))) other_key!)) (or (and (=> (< 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!))) (=> (= tmp%2 (Poly%lib!betree.LinkedBranch_v.Path. (lib!betree.LinkedBranch_v.impl&%6.subpath.? self!))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBranch_v.Path. tmp%2)) (other_key!$1 (%Poly%lib!spec.KeyType_t.Key. other_key!))) (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. (Poly%lib!betree.LinkedBranch_v.Path. self!$0)))) decrease%init0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBranch_v.Path. tmp%2)) (other_key!$1 (%Poly%lib!spec.KeyType_t.Key. other_key!))) 1) decrease%init1 false))) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%6.path_equiv.? (Poly%lib!betree.LinkedBranch_v.Path. (lib!betree.LinkedBranch_v.impl&%6.subpath.? self!)) other_key!)) (=> (= tmp%3 tmp%1) %%switch_label%%1))))) (=> (not (< 0 (lib!betree.LinkedBranch_v.Path./Path/depth (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (=> (= tmp%3 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 tmp%3) %%switch_label%%0)))) (=> (not (= (lib!betree.LinkedBranch_v.impl&%3.route.? (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.LinkedBranch_v.Path./Path/key (%Poly%lib!betree.LinkedBranch_v.Path. self!)))) (lib!betree.LinkedBranch_v.impl&%3.route.? (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.Path./Path/branch (%Poly%lib!betree.LinkedBranch_v.Path. self!))))) other_key!))) (=> (= tmp%4 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
