...
(set-info :comment ";; MODULE 'module abstract_system::AbstractCrashAwareJournal_v'")
...
(declare-const fuel%lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_Known_v. FuelId)
...
(assert (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%lib!abstract_system.AbstractJournal_v.AbstractJournal.impl&%5.wf. fuel%lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_v. fuel%lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_Known_v. fuel%lib!abstract_system.AbstractCrashAwareJournal_v.impl&%1.wf. fuel%lib!abstract_system.MsgHistory_v.impl&%0.wf. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_exactly. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(set-info :comment ";; Function-Decl lib::abstract_system::AbstractCrashAwareJournal_v::Ephemeral::arrow_v")
...
(set-info :comment ";; Function-Decl lib::abstract_system::AbstractCrashAwareJournal_v::Ephemeral::arrow_Known_v")
(declare-fun lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_Known_v.? (Poly) lib!abstract_system.AbstractJournal_v.AbstractJournal.State.)
(set-info :comment ";; Function-Decl lib::abstract_system::AbstractCrashAwareJournal_v::Ephemeral::wf")
...
(set-info :comment ";; Function-Axioms lib::abstract_system::AbstractCrashAwareJournal_v::Ephemeral::arrow_v")
...
(set-info :comment ";; Function-Axioms lib::abstract_system::AbstractCrashAwareJournal_v::Ephemeral::arrow_Known_v")
(assert (fuel_bool_default fuel%lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_Known_v.))
(assert (=> (fuel_bool fuel%lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_Known_v.) (forall ((self! Poly)) (! (= (lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_Known_v.? self!) (lib!abstract_system.AbstractCrashAwareJournal_v.Ephemeral./Known/v (%Poly%lib!abstract_system.AbstractCrashAwareJournal_v.Ephemeral. self!))) :pattern ((lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_Known_v.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!abstract_system.AbstractCrashAwareJournal_v.Ephemeral.) (has_type (Poly%lib!abstract_system.AbstractJournal_v.AbstractJournal.State. (lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_Known_v.? self!)) TYPE%lib!abstract_system.AbstractJournal_v.AbstractJournal.State.)) :pattern ((lib!abstract_system.AbstractCrashAwareJournal_v.impl&%0.arrow_Known_v.? self!)) )))
(set-info :comment ";; Function-Recommends lib::abstract_system::AbstractCrashAwareJournal_v::Ephemeral::wf")
(set-info :comment ";; abstract_system/AbstractCrashAwareJournal_v.rs:28:5: 28:47 (#0)")
(declare-const %return! Bool)
(declare-const self! Poly)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!abstract_system.AbstractCrashAwareJournal_v.Ephemeral.))
(assert (not true))
(check-sat)
(exit)
