...
(assert (not (=> (lib!betree.FilteredBetree_v.impl&%1.can_split_leaf.? self! split_key!) (=> (= tmp%2 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.FilteredBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (=> (= tmp%3 (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!))) (and (=> %%location_label%%0 (req%lib!betree.PivotTable_v.impl&%0.update. tmp%2 (I 1) tmp%3)) (=> (= tmp%1 (lib!betree.PivotTable_v.impl&%0.update.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.FilteredBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) (I 1) (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!)))) (=> (= new_left@ (lib!betree.FilteredBetree_v.BetreeNode./Node (%Poly%lib!betree.BufferSeq_v.BufferSeq. (Poly%lib!betree.BufferSeq_v.BufferSeq. (lib!betree.FilteredBetree_v.BetreeNode./Node/buffers (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. tmp%1)) (%Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.FilteredBetree_v.BetreeNode./Node/flushed (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))))) (=> (= tmp%5 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.FilteredBetree_v.BetreeNode./Node/pivots (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (=> (= tmp%6 (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? split_key!))) (=> %%location_label%%1 (req%lib!betree.PivotTable_v.impl&%0.update. tmp%5 (I 0) tmp%6))))))))))))
(check-sat)
(exit)
