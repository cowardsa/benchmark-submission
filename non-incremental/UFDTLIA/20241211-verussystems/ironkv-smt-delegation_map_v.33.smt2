...
(declare-const v! lib!io_t.EndPoint.)
...
(assert (and (and (<= 0 lo!) (<= lo! hi!)) (< hi! (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)))))))))
(declare-fun %%choose%%4 (Type Int Int Dcr Type Poly lib!abstract_end_point_t.AbstractEndPoint. Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 lib!abstract_end_point_t.AbstractEndPoint.) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((i$1 Poly)) (! (and (has_type i$1 %%hole%%0) (not (=> (and (<= %%hole%%1 (%I i$1)) (<= (%I i$1) %%hole%%2)) (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$1)) %%hole%%6)))) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 i$1)) )) (exists ((i$1 Poly)) (! (and (and (has_type i$1 %%hole%%0) (not (=> (and (<= %%hole%%1 (%I i$1)) (<= (%I i$1) %%hole%%2)) (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$1)) %%hole%%6)))) (= (%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) i$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 i$1))))) :pattern ((%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
(declare-fun %%choose%%5 (Type Int Int Dcr Type Poly lib!abstract_end_point_t.AbstractEndPoint. Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 lib!abstract_end_point_t.AbstractEndPoint.) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((j$1 Poly)) (! (and (has_type j$1 %%hole%%0) (and (and (<= %%hole%%1 (%I j$1)) (< (%I j$1) %%hole%%2)) (not (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 j$1)) %%hole%%6)))) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 j$1)) )) (exists ((j$1 Poly)) (! (and (and (has_type j$1 %%hole%%0) (and (and (<= %%hole%%1 (%I j$1)) (< (%I j$1) %%hole%%2)) (not (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 j$1)) %%hole%%6)))) (= (%%choose%%5 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) j$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 j$1))))) :pattern ((%%choose%%5 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
...
(assert (not (and (=> %%location_label%%0 (req%lib!delegation_map_v.impl&%3.values_agree. K&. K& self! lo! hi! v!)) (=> (ens%lib!delegation_map_v.impl&%3.values_agree. K&. K& self! lo! hi! v! tmp%%@) (=> (= agree@ (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= almost@ (%B (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (or (and (=> agree@ %%switch_label%%0) (=> (not agree@) (=> (= tmp%1 (not (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= lo! (%I i$)) (<= (%I i$) hi!)) (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) i$)) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!))))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) i$)) )))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= i@ (%I (as_type (%%choose%%4 INT lo! hi! $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!)) $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)))))) INT))) (=> (= tmp%2 (not (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (I i@))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!))))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (= tmp%3 (= (lib!io_t.impl&%4.view.? (vstd!map.impl&%0.index.? K&. K& $ TYPE%lib!io_t.EndPoint. (lib!delegation_map_v.impl&%3.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (I i@)))) (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (I i@))))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (or (and (=> almost@ %%switch_label%%1) (=> (not almost@) (=> (= tmp%4 (not (and (not (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (I hi!))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!)))) (forall ((i$2 Poly)) (! (=> (has_type i$2 INT) (=> (and (<= lo! (%I i$2)) (< (%I i$2) hi!)) (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) i$2)) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!))))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) i$2)) ))))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (or (and (=> (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (I hi!))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!))) %%switch_label%%2) (=> (not (= (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (I hi!))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!)))) (=> (= j@ (%I (as_type (%%choose%%5 INT lo! hi! $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!)) $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)))))) INT))) (=> (= tmp%5 (not (= (lib!io_t.impl&%4.view.? (vstd!map.impl&%0.index.? K&. K& $ TYPE%lib!io_t.EndPoint. (lib!delegation_map_v.impl&%3.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (I j@)))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!))))) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 %%switch_label%%2)))))) (and (not %%switch_label%%2) %%switch_label%%1))))))) (and (not %%switch_label%%1) %%switch_label%%0)))))))))))))) (and (not %%switch_label%%0) (=> (= ret! (tuple%2./tuple%2 (B agree@) (B almost@))) (and (=> %%location_label%%6 (= (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. ret!)))) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= lo! (%I i$)) (<= (%I i$) hi!)) (= (lib!io_t.impl&%4.view.? (vstd!map.impl&%0.index.? K&. K& $ TYPE%lib!io_t.EndPoint. (lib!delegation_map_v.impl&%3.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) i$))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!))))) :pattern ((vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) i$)) )))) (=> %%location_label%%7 (=> (not (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. ret!))))) (= (%B (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. ret!)))) (and (not (= (lib!io_t.impl&%4.view.? (vstd!map.impl&%0.index.? K&. K& $ TYPE%lib!io_t.EndPoint. (lib!delegation_map_v.impl&%3.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) (I hi!)))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!)))) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= lo! (%I i$)) (< (%I i$) hi!)) (= (lib!io_t.impl&%4.view.? (vstd!map.impl&%0.index.? K&. K& $ TYPE%lib!io_t.EndPoint. (lib!delegation_map_v.impl&%3.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) i$))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. v!))))) :pattern ((vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))))) i$)) ))))))))))))))))
(check-sat)
(exit)
