...
(declare-const z! lib!keys_t.KeyIterator.)
...
(assert (has_type (Poly%lib!keys_t.KeyIterator. z!) (TYPE%lib!keys_t.KeyIterator. K&. K&)))
...
(assert (lib!delegation_map_v.impl&%4.range_consistent.? K&. K& (Poly%lib!delegation_map_v.DelegationMap. self!) (Poly%lib!keys_t.KeyIterator. y!) (Poly%lib!keys_t.KeyIterator. z!) (Poly%lib!io_t.EndPoint. dst!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (lib!delegation_map_v.impl&%4.range_consistent.? K&. K& (Poly%lib!delegation_map_v.DelegationMap. self!) (Poly%lib!keys_t.KeyIterator. x!) (Poly%lib!keys_t.KeyIterator. z!) (Poly%lib!io_t.EndPoint. dst!)))))
(check-sat)
(exit)
