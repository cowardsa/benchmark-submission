...
(assert (not (lib!delegation_map_v.impl&%2.is_end_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. self!))))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%2 (lib!keys_t.KeyIterator./KeyIterator/k (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. self!)))) (=> (ens%core!option.impl&%0.as_ref. K&. K& tmp%2 tmp%1) (and (=> %%location_label%%0 (req%core!option.impl&%0.unwrap. (REF K&.) K& tmp%1)) (=> (ens%core!option.impl&%0.unwrap. (REF K&.) K& tmp%1 tmp%3) (=> (= k! tmp%3) (=> %%location_label%%1 (= k! (lib!delegation_map_v.impl&%2.get_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. self!)))))))))))
(check-sat)
(exit)
