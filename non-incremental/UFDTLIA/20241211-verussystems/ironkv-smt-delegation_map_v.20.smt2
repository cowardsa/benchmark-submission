...
(assert (not (=> (= s! (lib!keys_t.KeyIterator./KeyIterator (%Poly%core!option.Option. (Poly%core!option.Option. core!option.Option./None)))) (=> %%location_label%%0 (is-core!option.Option./None_ (lib!keys_t.KeyIterator./KeyIterator/k (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. s!))))))))
(check-sat)
(exit)
