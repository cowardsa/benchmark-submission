...
(set-info :comment ";; Function-Specs lib::io_t::NetClient::reset")
...
(assert (forall ((pre%self! lib!io_t.NetClient.) (self! lib!io_t.NetClient.)) (! (= (ens%lib!io_t.impl&%7.reset. pre%self! self!) (and (is-lib!io_t.State./Receiving_ (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. self!))) (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. self!)) (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. pre%self!))))) :pattern ((ens%lib!io_t.impl&%7.reset. pre%self! self!)) )))
(set-info :comment ";; Function-Def lib::io_t::NetClient::reset")
(set-info :comment ";; ironsht/src/io_t.rs:227:5: 227:28 (#0)")
