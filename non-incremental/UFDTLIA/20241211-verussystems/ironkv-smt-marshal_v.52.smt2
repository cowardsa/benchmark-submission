...
(set-info :comment ";; Function-Def alloc::vec::Vec::lemma_same_views_serialize_the_same")
(set-info :comment ";; ironsht/src/marshal_v.rs:976:9: 976:74 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%1::lemma_view_equal_symmetric")
(set-info :comment ";; ironsht/src/marshal_v.rs:226:9: 226:59 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%1::_is_marshalable")
(set-info :comment ";; ironsht/src/marshal_v.rs:232:8: 232:47 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%1::lemma_serialization_is_not_a_prefix_of")
(set-info :comment ";; ironsht/src/marshal_v.rs:270:9: 270:71 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%1::lemma_same_views_serialize_the_same")
(set-info :comment ";; ironsht/src/marshal_v.rs:275:9: 275:74 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%1::lemma_serialize_injective")
(set-info :comment ";; ironsht/src/marshal_v.rs:280:9: 280:64 (#0)")
(set-info :comment ";; Trait-Impl-Axiom")
(assert (tr_bound%lib!marshal_v.Marshalable. $ (UINT SZ)))
(set-info :comment ";; Function-Def alloc::vec::Vec::lemma_view_equal_symmetric")
(set-info :comment ";; ironsht/src/marshal_v.rs:595:9: 595:59 (#0)")
(set-info :comment ";; Function-Def alloc::vec::Vec::lemma_serialize_injective")
(set-info :comment ";; ironsht/src/marshal_v.rs:1015:9: 1015:64 (#0)")
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Function-Def lib::marshal_v::impl&%5::lemma_view_equal_symmetric")
(set-info :comment ";; ironsht/src/marshal_v.rs:1032:9: 1032:59 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%5::_is_marshalable")
(set-info :comment ";; ironsht/src/marshal_v.rs:1044:8: 1044:41 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%5::serialized_size")
(set-info :comment ";; ironsht/src/marshal_v.rs:1055:8: 1055:48 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%5::serialize")
(set-info :comment ";; ironsht/src/marshal_v.rs:1061:8: 1061:47 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%5::deserialize")
(set-info :comment ";; ironsht/src/marshal_v.rs:1081:8: 1081:83 (#0)")
(set-info :comment ";; Function-Def lib::marshal_v::impl&%5::lemma_serialization_is_not_a_prefix_of")
(set-info :comment ";; ironsht/src/marshal_v.rs:1097:9: 1097:71 (#0)")
(declare-const T&. Dcr)
...
(declare-const x0@ Poly)
(declare-const x1@ Poly)
(declare-const tmp%%$1@ tuple%2.)
(declare-const s0@ vstd!seq.Seq<u8.>.)
(declare-const s1@ vstd!seq.Seq<u8.>.)
(declare-const tmp%%$2@ tuple%4.)
(declare-const x0$1@ Poly)
(declare-const x1$1@ Poly)
...
(declare-const x0$2@ Poly)
(declare-const x1$2@ Poly)
(declare-const tmp%%$4@ tuple%2.)
(declare-const s0$2@ vstd!seq.Seq<u8.>.)
(declare-const s1$2@ vstd!seq.Seq<u8.>.)
(declare-const tmp%%$5@ tuple%4.)
(declare-const x0$3@ Poly)
(declare-const x1$3@ Poly)
...
(assert (has_type self! (TYPE%tuple%2. T&. T& U&. U&)))
(assert (has_type other! (TYPE%tuple%2. T&. T& U&. U&)))
(assert (tr_bound%lib!marshal_v.Marshalable. T&. T&))
(assert (tr_bound%lib!marshal_v.Marshalable. U&. U&))
(assert (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%tuple%2. T&. T& U&. U&) self! other!))))
(assert (<= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!)) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) other!))))
(declare-fun %%choose%%5 (Type Int Int Dcr Type Poly Dcr Type Poly Dcr Type Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly) (%%hole%%9 Dcr) (%%hole%%10 Type) (%%hole%%11 Poly) (%%hole%%12 Dcr) (%%hole%%13 Type) (%%hole%%14 Poly)) (! (=> (exists ((i$ Poly)) (! (and (has_type i$ %%hole%%0) (and (and (<= %%hole%%1 (%I i$)) (< (%I i$) %%hole%%2)) (not (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$) (vstd!seq.Seq.index.? %%hole%%6 %%hole%%7 %%hole%%8 i$))))) :pattern ((vstd!seq.Seq.index.? %%hole%%9 %%hole%%10 %%hole%%11 i$)) :pattern ((vstd!seq.Seq.index.? %%hole%%12 %%hole%%13 %%hole%%14 i$)) )) (exists ((i$ Poly)) (! (and (and (has_type i$ %%hole%%0) (and (and (<= %%hole%%1 (%I i$)) (< (%I i$) %%hole%%2)) (not (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$) (vstd!seq.Seq.index.? %%hole%%6 %%hole%%7 %%hole%%8 i$))))) (= (%%choose%%5 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14) i$)) :pattern ((vstd!seq.Seq.index.? %%hole%%9 %%hole%%10 %%hole%%11 i$)) :pattern ((vstd!seq.Seq.index.? %%hole%%12 %%hole%%13 %%hole%%14 i$))))) :pattern ((%%choose%%5 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14)))))
...
(assert (not (=> (= si@ (%Poly%vstd!seq.Seq<u8.>. (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!))) (=> (= so@ (%Poly%vstd!seq.Seq<u8.>. (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) other!))) (=> (= mid@ 0) (or (and (=> (not (%B (lib!marshal_v.Marshalable.view_equal.? T&. T& (tuple%2./tuple%2/0 (%Poly%tuple%2. self!)) (tuple%2./tuple%2/0 (%Poly%tuple%2. other!))))) (=> (= tmp%%@ (tuple%2./tuple%2 (tuple%2./tuple%2/0 (%Poly%tuple%2. self!)) (tuple%2./tuple%2/0 (%Poly%tuple%2. other!)))) (=> (= x0@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= x1@ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= tmp%%$1@ (tuple%2./tuple%2 (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& x0@) (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& x1@))) (=> (= s0@ (%Poly%vstd!seq.Seq<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@))))) (=> (= s1@ (%Poly%vstd!seq.Seq<u8.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@))))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. T&. T& x0@ x1@) (=> (= tmp%%$2@ (ite (<= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0@)) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1@))) (tuple%4./tuple%4 x0@ x1@ (Poly%vstd!seq.Seq<u8.>. s0@) (Poly%vstd!seq.Seq<u8.>. s1@)) (tuple%4./tuple%4 x1@ x0@ (Poly%vstd!seq.Seq<u8.>. s1@) (Poly%vstd!seq.Seq<u8.>. s0@)))) (=> (= x0$1@ (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$2@)))) (=> (= x1$1@ (tuple%4./tuple%4/1 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$2@)))) (=> (= s0$1@ (%Poly%vstd!seq.Seq<u8.>. (tuple%4./tuple%4/2 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$2@))))) (=> (= s1$1@ (%Poly%vstd!seq.Seq<u8.>. (tuple%4./tuple%4/3 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$2@))))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. T&. T& x0$1@ x1$1@)) (=> (ens%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. T&. T& x0$1@ x1$1@) (=> (= tmp%1 (not (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s0$1@) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$1@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$1@))))))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= idx@ (%I (as_type (%%choose%%5 INT 0 (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$1@)) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$1@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$1@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$1@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$1@)) INT))) (or (and (=> (= si@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@)))))) (=> (= tmp%2 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@) (I (Add mid@ idx@))) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I (Add mid@ idx@))))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 %%switch_label%%3)))) (=> (not (= si@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@))))))) %%switch_label%%3)) (and (not %%switch_label%%3) (=> %%location_label%%3 (not (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!)))))))))))))))))))))))))))) (=> (not (not (%B (lib!marshal_v.Marshalable.view_equal.? T&. T& (tuple%2./tuple%2/0 (%Poly%tuple%2. self!)) (tuple%2./tuple%2/0 (%Poly%tuple%2. other!)))))) (=> (= tmp%3 (tuple%2./tuple%2/0 (%Poly%tuple%2. self!))) (=> (= tmp%4 (tuple%2./tuple%2/0 (%Poly%tuple%2. other!))) (and (=> %%location_label%%4 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%3 tmp%4)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%3 tmp%4) %%switch_label%%2)))))) (and (not %%switch_label%%2) (=> (= mid$1@ (Add mid@ (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (tuple%2./tuple%2/0 (%Poly%tuple%2. self!)))))) (or (and (=> (not (%B (lib!marshal_v.Marshalable.view_equal.? U&. U& (tuple%2./tuple%2/1 (%Poly%tuple%2. self!)) (tuple%2./tuple%2/1 (%Poly%tuple%2. other!))))) (=> (= tmp%%$3@ (tuple%2./tuple%2 (tuple%2./tuple%2/1 (%Poly%tuple%2. self!)) (tuple%2./tuple%2/1 (%Poly%tuple%2. other!)))) (=> (= x0$2@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$3@)))) (=> (= x1$2@ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$3@)))) (=> (= tmp%%$4@ (tuple%2./tuple%2 (lib!marshal_v.Marshalable.ghost_serialize.? U&. U& x0$2@) (lib!marshal_v.Marshalable.ghost_serialize.? U&. U& x1$2@))) (=> (= s0$2@ (%Poly%vstd!seq.Seq<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$4@))))) (=> (= s1$2@ (%Poly%vstd!seq.Seq<u8.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$4@))))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. U&. U& x0$2@ x1$2@) (=> (= tmp%%$5@ (ite (<= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$2@)) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$2@))) (tuple%4./tuple%4 x0$2@ x1$2@ (Poly%vstd!seq.Seq<u8.>. s0$2@) (Poly%vstd!seq.Seq<u8.>. s1$2@)) (tuple%4./tuple%4 x1$2@ x0$2@ (Poly%vstd!seq.Seq<u8.>. s1$2@) (Poly%vstd!seq.Seq<u8.>. s0$2@)))) (=> (= x0$3@ (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$5@)))) (=> (= x1$3@ (tuple%4./tuple%4/1 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$5@)))) (=> (= s0$3@ (%Poly%vstd!seq.Seq<u8.>. (tuple%4./tuple%4/2 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$5@))))) (=> (= s1$3@ (%Poly%vstd!seq.Seq<u8.>. (tuple%4./tuple%4/3 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$5@))))) (and (=> %%location_label%%5 (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. U&. U& x0$3@ x1$3@)) (=> (ens%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. U&. U& x0$3@ x1$3@) (=> (= tmp%5 (not (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s0$3@) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$3@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$3@))))))) (and (=> %%location_label%%6 tmp%5) (=> tmp%5 (=> (= idx$1@ (%I (as_type (%%choose%%5 INT 0 (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$3@)) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$3@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$3@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s0$3@) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$3@)) INT))) (or (and (=> (= si@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@)))))) (=> (= tmp%6 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@) (I (Add mid$1@ idx$1@))) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I (Add mid$1@ idx$1@))))) (and (=> %%location_label%%7 tmp%6) (=> tmp%6 %%switch_label%%1)))) (=> (not (= si@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. so@) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. si@))))))) %%switch_label%%1)) (and (not %%switch_label%%1) (=> %%location_label%%8 (not (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!)))))))))))))))))))))))))))) (=> (not (not (%B (lib!marshal_v.Marshalable.view_equal.? U&. U& (tuple%2./tuple%2/1 (%Poly%tuple%2. self!)) (tuple%2./tuple%2/1 (%Poly%tuple%2. other!)))))) (=> (= tmp%7 (tuple%2./tuple%2/1 (%Poly%tuple%2. self!))) (=> (= tmp%8 (tuple%2./tuple%2/1 (%Poly%tuple%2. other!))) (and (=> %%location_label%%9 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. U&. U& tmp%7 tmp%8)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. U&. U& tmp%7 tmp%8) %%switch_label%%0)))))) (and (not %%switch_label%%0) (=> %%location_label%%10 (not (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!)))))))))))))))))
(check-sat)
(exit)
