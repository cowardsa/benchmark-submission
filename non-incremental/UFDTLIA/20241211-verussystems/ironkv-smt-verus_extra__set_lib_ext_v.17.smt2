...
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? A&. A& s!)) (or (and (=> (= (vstd!set.impl&%0.len.? A&. A& s!) 0) (=> %%location_label%%0 (vstd!set.impl&%0.finite.? B&. B& (lib!verus_extra.set_lib_ext_v.map_fold.? A&. A& B&. B& s! (Poly%fun%1. f!))))) (=> (not (= (vstd!set.impl&%0.len.? A&. A& s!) 0)) (=> (= a@ (vstd!set.impl&%0.choose.? A&. A& s!)) (=> (= tmp%1 (vstd!set.impl&%0.remove.? A&. A& s! a@)) (and (=> %%location_label%%1 (check_decrease_int (let ((s!$0 tmp%1) (f!$1 f!)) (vstd!set.impl&%0.len.? A&. A& s!$0)) decrease%init0 false)) (and (=> %%location_label%%2 (req%lib!verus_extra.set_lib_ext_v.map_fold_finite. A&. A& B&. B& tmp%1 f!)) (=> (ens%lib!verus_extra.set_lib_ext_v.map_fold_finite. A&. A& B&. B& tmp%1 f!) (=> %%location_label%%3 (vstd!set.impl&%0.finite.? B&. B& (lib!verus_extra.set_lib_ext_v.map_fold.? A&. A& B&. B& s! (Poly%fun%1. f!))))))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
