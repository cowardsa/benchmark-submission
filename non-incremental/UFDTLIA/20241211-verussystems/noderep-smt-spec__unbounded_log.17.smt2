...
(set-info :comment ";; Function-Specs lib::spec::utils::seq_to_set_is_finite")
(declare-fun ens%lib!spec.utils.seq_to_set_is_finite. (Dcr Type Poly) Bool)
(assert (forall ((A&. Dcr) (A& Type) (seq! Poly)) (! (= (ens%lib!spec.utils.seq_to_set_is_finite. A&. A& seq!) (vstd!set.impl&%0.finite.? A&. A& (lib!spec.utils.seq_to_set.? A&. A& seq!))) :pattern ((ens%lib!spec.utils.seq_to_set_is_finite. A&. A& seq!)) )))
(set-info :comment ";; Function-Specs lib::spec::unbounded_log::combiner_request_ids_finite")
(declare-fun req%lib!spec.unbounded_log.combiner_request_ids_finite. (vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>.) Bool)
(declare-const %%global_location_label%%101 Bool)
(assert (forall ((combiners! vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>.)) (! (= (req%lib!spec.unbounded_log.combiner_request_ids_finite. combiners!) (=> %%global_location_label%%101 (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))))) :pattern ((req%lib!spec.unbounded_log.combiner_request_ids_finite. combiners!)) )))
(declare-fun ens%lib!spec.unbounded_log.combiner_request_ids_finite. (vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>.) Bool)
(assert (forall ((combiners! vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>.)) (! (= (ens%lib!spec.unbounded_log.combiner_request_ids_finite. combiners!) (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. (lib!spec.unbounded_log.combiner_request_ids.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))))) :pattern ((ens%lib!spec.unbounded_log.combiner_request_ids_finite. combiners!)) )))
(set-info :comment ";; Function-Def lib::spec::unbounded_log::combiner_request_ids_finite")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/unbounded_log.rs:1275:1: 1275:80 (#0)")
(set-info :comment ";; Function-Specs lib::spec::unbounded_log::max_of_set")
(declare-fun req%lib!spec.unbounded_log.max_of_set. (vstd!set.Set<nat.>.) Bool)
(declare-const %%global_location_label%%102 Bool)
(assert (forall ((s! vstd!set.Set<nat.>.)) (! (= (req%lib!spec.unbounded_log.max_of_set. s!) (=> %%global_location_label%%102 (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. s!)))) :pattern ((req%lib!spec.unbounded_log.max_of_set. s!)) )))
(declare-fun ens%lib!spec.unbounded_log.max_of_set. (vstd!set.Set<nat.>. Int) Bool)
(assert (forall ((s! vstd!set.Set<nat.>.) (r! Int)) (! (= (ens%lib!spec.unbounded_log.max_of_set. s! r!) (and (<= 0 r!) (forall ((x$ Poly)) (! (=> (has_type x$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s!) x$) (<= (%I x$) r!))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s!) x$)) )))) :pattern ((ens%lib!spec.unbounded_log.max_of_set. s! r!)) )))
(set-info :comment ";; Function-Def lib::spec::unbounded_log::max_of_set")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/unbounded_log.rs:1305:7: 1305:44 (#0)")
(set-info :comment ";; Function-Specs lib::spec::unbounded_log::element_outside_set")
(declare-fun req%lib!spec.unbounded_log.element_outside_set. (vstd!set.Set<nat.>.) Bool)
(declare-const %%global_location_label%%103 Bool)
(assert (forall ((s! vstd!set.Set<nat.>.)) (! (= (req%lib!spec.unbounded_log.element_outside_set. s!) (=> %%global_location_label%%103 (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. s!)))) :pattern ((req%lib!spec.unbounded_log.element_outside_set. s!)) )))
(declare-fun ens%lib!spec.unbounded_log.element_outside_set. (vstd!set.Set<nat.>. Int) Bool)
(assert (forall ((s! vstd!set.Set<nat.>.) (r! Int)) (! (= (ens%lib!spec.unbounded_log.element_outside_set. s! r!) (and (<= 0 r!) (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s!) (I r!))))) :pattern ((ens%lib!spec.unbounded_log.element_outside_set. s! r!)) )))
(set-info :comment ";; Function-Def lib::spec::unbounded_log::element_outside_set")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/unbounded_log.rs:1326:7: 1326:53 (#0)")
(set-info :comment ";; Function-Specs lib::spec::unbounded_log::get_fresh_nat_not_in")
...
(assert (forall ((reqs! vstd!set.Set<nat.>.) (combiner! vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>.)) (! (= (req%lib!spec.unbounded_log.get_fresh_nat_not_in. reqs! combiner!) (and (=> %%global_location_label%%104 (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. reqs!))) (=> %%global_location_label%%105 (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!)))))) :pattern ((req%lib!spec.unbounded_log.get_fresh_nat_not_in. reqs! combiner!)) )))
...
(assert (forall ((reqs! vstd!set.Set<nat.>.) (combiner! vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>.)) (! (= (ens%lib!spec.unbounded_log.get_fresh_nat_not_in. reqs! combiner!) (and (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. reqs!) (I (lib!spec.unbounded_log.get_fresh_nat.? (Poly%vstd!set.Set<nat.>. reqs!) (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!))))) (lib!spec.unbounded_log.combiner_request_id_fresh.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!) (I (lib!spec.unbounded_log.get_fresh_nat.? (Poly%vstd!set.Set<nat.>. reqs!) (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!)))))) :pattern ((ens%lib!spec.unbounded_log.get_fresh_nat_not_in. reqs! combiner!)) )))
(set-info :comment ";; Function-Def lib::spec::unbounded_log::get_fresh_nat_not_in")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/unbounded_log.rs:1335:1: 1335:90 (#0)")
(declare-const reqs! vstd!set.Set<nat.>.)
(declare-const combiner! vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>.)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Bool)
(declare-const tmp%3 Bool)
(declare-const tmp%4 Bool)
(declare-const rid@ Int)
(declare-const combiner_req_ids@ vstd!set.Set<nat.>.)
(declare-const req_ids@ vstd!set.Set<nat.>.)
(declare-const r@ Int)
(assert fuel_defaults)
(assert (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. reqs!)))
(assert (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!))))
...
(assert (not (=> (= rid@ (lib!spec.unbounded_log.get_fresh_nat.? (Poly%vstd!set.Set<nat.>. reqs!) (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!))) (=> (= combiner_req_ids@ (lib!spec.unbounded_log.combiner_request_ids.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!))) (and (and (=> %%location_label%%0 (req%lib!spec.unbounded_log.combiner_request_ids_not_contains. combiner! rid@)) (=> (ens%lib!spec.unbounded_log.combiner_request_ids_not_contains. combiner! rid@) (=> %%location_label%%1 (= (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. combiner_req_ids@) (I rid@))) (lib!spec.unbounded_log.combiner_request_id_fresh.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!) (I rid@)))))) (=> (= (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. combiner_req_ids@) (I rid@))) (lib!spec.unbounded_log.combiner_request_id_fresh.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!) (I rid@))) (and (and (=> %%location_label%%2 (req%lib!spec.unbounded_log.combiner_request_ids_finite. combiner!)) (=> (ens%lib!spec.unbounded_log.combiner_request_ids_finite. combiner!) (=> %%location_label%%3 (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. combiner_req_ids@))))) (=> (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. combiner_req_ids@)) (=> (= req_ids@ (%Poly%vstd!set.Set<nat.>. (vstd!set.impl&%0.union.? $ NAT (Poly%vstd!set.Set<nat.>. reqs!) (Poly%vstd!set.Set<nat.>. combiner_req_ids@)))) (=> (= tmp%1 (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. req_ids@))) (and (=> %%location_label%%4 tmp%1) (=> tmp%1 (and (=> %%location_label%%5 (req%lib!spec.unbounded_log.element_outside_set. req_ids@)) (=> (ens%lib!spec.unbounded_log.element_outside_set. req_ids@ r@) (=> (= tmp%2 (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. reqs!) (I r@)))) (and (=> %%location_label%%6 tmp%2) (=> tmp%2 (=> (= tmp%3 (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. combiner_req_ids@) (I r@)))) (and (=> %%location_label%%7 tmp%3) (=> tmp%3 (and (and (=> %%location_label%%8 (req%lib!spec.unbounded_log.combiner_request_ids_not_contains. combiner! r@)) (=> (ens%lib!spec.unbounded_log.combiner_request_ids_not_contains. combiner! r@) (=> %%location_label%%9 (lib!spec.unbounded_log.combiner_request_id_fresh.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!) (I r@))))) (=> (lib!spec.unbounded_log.combiner_request_id_fresh.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!) (I r@)) (=> (= tmp%4 (exists ((n$ Poly)) (! (and (has_type n$ NAT) (and (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. reqs!) n$)) (lib!spec.unbounded_log.combiner_request_id_fresh.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!) n$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. reqs!) n$)) :pattern ((lib!spec.unbounded_log.combiner_request_id_fresh.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!) n$)) ))) (and (=> %%location_label%%10 tmp%4) (=> tmp%4 (and (=> %%location_label%%11 (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. reqs!) (I (lib!spec.unbounded_log.get_fresh_nat.? (Poly%vstd!set.Set<nat.>. reqs!) (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!)))))) (=> %%location_label%%12 (lib!spec.unbounded_log.combiner_request_id_fresh.? (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!) (I (lib!spec.unbounded_log.get_fresh_nat.? (Poly%vstd!set.Set<nat.>. reqs!) (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiner!)))))))))))))))))))))))))))))))
(check-sat)
(exit)
