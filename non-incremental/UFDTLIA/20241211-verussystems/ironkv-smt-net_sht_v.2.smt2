...
(declare-const out! lib!cmessage_v.CSingleMessage.)
(declare-const buffer! alloc!vec.Vec<u8./allocator_global%.>.)
...
(declare-const cmessage@ lib!cmessage_v.CSingleMessage.)
(declare-const count@ Int)
(declare-const tmp%8 lib!cmessage_v.CSingleMessage.)
...
(assert (not (=> (ens%lib!marshal_v.Marshalable.deserialize. $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!) (I 0) tmp%1) (=> (= tmp%%@ (%Poly%core!option.Option. tmp%1)) (or (and (=> (is-core!option.Option./None_ tmp%%@) (=> (= tmp%8 lib!cmessage_v.CSingleMessage./InvalidMessage) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ tmp%%@)) (=> (= cmessage@ (%Poly%lib!cmessage_v.CSingleMessage. (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@))))))) (=> (= count@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@))))))) (=> (ens%alloc!vec.impl&%1.len. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!) tmp%2) (or (and (=> (not (= count@ tmp%2)) (=> (= out! lib!cmessage_v.CSingleMessage./InvalidMessage) (=> %%location_label%%0 (=> (not (is-lib!cmessage_v.CSingleMessage./InvalidMessage_ out!)) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. out!))) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. out!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!))))))) (lib!cmessage_v.impl&%2.abstractable.? (Poly%lib!cmessage_v.CSingleMessage. out!))))))) (=> (not (not (= count@ tmp%2))) %%switch_label%%7)) (and (not %%switch_label%%7) (or (and (=> (is-lib!cmessage_v.CSingleMessage./Message_ cmessage@) (=> (= dst@ (lib!cmessage_v.CSingleMessage./Message/dst (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. cmessage@)))) (=> (= m@ (lib!cmessage_v.CSingleMessage./Message/m (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. cmessage@)))) (=> (ens%lib!io_t.impl&%4.valid_physical_address. dst@ tmp%3) (or (and (=> (not tmp%3) (=> (= out! lib!cmessage_v.CSingleMessage./InvalidMessage) (=> %%location_label%%1 (=> (not (is-lib!cmessage_v.CSingleMessage./InvalidMessage_ out!)) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. out!))) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. out!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!))))))) (lib!cmessage_v.impl&%2.abstractable.? (Poly%lib!cmessage_v.CSingleMessage. out!))))))) (=> (not (not tmp%3)) %%switch_label%%6)) (and (not %%switch_label%%6) (or (and (=> (is-lib!cmessage_v.CMessage./Redirect_ m@) (=> (= id@ (lib!cmessage_v.CMessage./Redirect/id (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. m@)))) (=> (ens%lib!io_t.impl&%4.valid_physical_address. id@ tmp%4) (or (and (=> (not tmp%4) (=> (= out! lib!cmessage_v.CSingleMessage./InvalidMessage) (=> %%location_label%%2 (=> (not (is-lib!cmessage_v.CSingleMessage./InvalidMessage_ out!)) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. out!))) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. out!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!))))))) (lib!cmessage_v.impl&%2.abstractable.? (Poly%lib!cmessage_v.CSingleMessage. out!))))))) (=> (not (not tmp%4)) %%switch_label%%3)) (and (not %%switch_label%%3) %%switch_label%%2))))) (=> (not (is-lib!cmessage_v.CMessage./Redirect_ m@)) (or (and (=> (is-lib!cmessage_v.CMessage./Shard_ m@) (=> (= recipient@ (lib!cmessage_v.CMessage./Shard/recipient (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. m@)))) (=> (ens%lib!io_t.impl&%4.valid_physical_address. recipient@ tmp%5) (or (and (=> (not tmp%5) (=> (= out! lib!cmessage_v.CSingleMessage./InvalidMessage) (=> %%location_label%%3 (=> (not (is-lib!cmessage_v.CSingleMessage./InvalidMessage_ out!)) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. out!))) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. out!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!))))))) (lib!cmessage_v.impl&%2.abstractable.? (Poly%lib!cmessage_v.CSingleMessage. out!))))))) (=> (not (not tmp%5)) %%switch_label%%5)) (and (not %%switch_label%%5) %%switch_label%%4))))) (=> (not (is-lib!cmessage_v.CMessage./Shard_ m@)) %%switch_label%%4)) (and (not %%switch_label%%4) %%switch_label%%2)))) (and (not %%switch_label%%2) %%switch_label%%1)))))))) (=> (not (is-lib!cmessage_v.CSingleMessage./Message_ cmessage@)) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!)) (I 0) (I count@)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!)))) (and (=> %%location_label%%4 tmp%6) (=> tmp%6 (=> (= tmp%7 (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!)))) (and (=> %%location_label%%5 (req%lib!net_sht_v.sht_marshal_data_injective. tmp%7 cmessage@)) (=> (ens%lib!net_sht_v.sht_marshal_data_injective. tmp%7 cmessage@) (=> (= tmp%8 cmessage@) %%switch_label%%0)))))))))))))))) (and (not %%switch_label%%0) (=> (= out! tmp%8) (=> %%location_label%%6 (=> (not (is-lib!cmessage_v.CSingleMessage./InvalidMessage_ out!)) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. out!))) (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. out!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!net_sht_v.sht_demarshal_data.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buffer!))))))) (lib!cmessage_v.impl&%2.abstractable.? (Poly%lib!cmessage_v.CSingleMessage. out!))))))))))))
(check-sat)
(exit)
