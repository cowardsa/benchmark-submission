...
(declare-const ack_state!@0 lib!single_delivery_state_v.CAckState.)
(declare-const default! lib!single_delivery_state_v.CAckState.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!single_delivery_state_v.CAckState. ack_state!@0) TYPE%lib!single_delivery_state_v.CAckState.))
(assert (has_type (Poly%lib!single_delivery_state_v.CAckState. default!) TYPE%lib!single_delivery_state_v.CAckState.))
(assert (lib!single_delivery_state_v.impl&%2.valid.? (Poly%lib!single_delivery_state_v.CSendState. self!@0)))
...
(declare-const ack_state!@1 lib!single_delivery_state_v.CAckState.)
(declare-const self!@1 lib!single_delivery_state_v.CSendState.)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (has_type (Poly%lib!single_delivery_state_v.CAckState. ack_state!@1) TYPE%lib!single_delivery_state_v.CAckState.) (=> (ens%lib!endpoint_hashmap_t.impl&%0.swap. $ TYPE%lib!single_delivery_state_v.CAckState. (Poly%lib!endpoint_hashmap_t.HashMap<lib!single_delivery_state_v.CAckState.>. (lib!single_delivery_state_v.CSendState./CSendState/epmap (%Poly%lib!single_delivery_state_v.CSendState. (Poly%lib!single_delivery_state_v.CSendState. self!@0)))) (Poly%lib!endpoint_hashmap_t.HashMap<lib!single_delivery_state_v.CAckState.>. (lib!single_delivery_state_v.CSendState./CSendState/epmap (%Poly%lib!single_delivery_state_v.CSendState. (Poly%lib!single_delivery_state_v.CSendState. self!@1)))) src! (Poly%lib!single_delivery_state_v.CAckState. ack_state!@0) (Poly%lib!single_delivery_state_v.CAckState. ack_state!@1) (Poly%lib!single_delivery_state_v.CAckState. default!)) (=> %%location_label%%0 (lib!endpoint_hashmap_t.impl&%0.swap_spec.? $ TYPE%lib!single_delivery_state_v.CAckState. (lib!endpoint_hashmap_t.impl&%0.view.? $ TYPE%lib!single_delivery_state_v.CAckState. (Poly%lib!endpoint_hashmap_t.HashMap<lib!single_delivery_state_v.CAckState.>. (lib!single_delivery_state_v.CSendState./CSendState/epmap (%Poly%lib!single_delivery_state_v.CSendState. (Poly%lib!single_delivery_state_v.CSendState. self!@0))))) (lib!endpoint_hashmap_t.impl&%0.view.? $ TYPE%lib!single_delivery_state_v.CAckState. (Poly%lib!endpoint_hashmap_t.HashMap<lib!single_delivery_state_v.CAckState.>. (lib!single_delivery_state_v.CSendState./CSendState/epmap (%Poly%lib!single_delivery_state_v.CSendState. (Poly%lib!single_delivery_state_v.CSendState. self!@1))))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src!))) (Poly%lib!single_delivery_state_v.CAckState. ack_state!@0) (Poly%lib!single_delivery_state_v.CAckState. ack_state!@1) (Poly%lib!single_delivery_state_v.CAckState. default!)))))))
(check-sat)
(exit)
