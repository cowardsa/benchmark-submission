...
(assert (not (=> (= tmp%%@ (lib!keys_t.KeyIterator./KeyIterator/k (%Poly%lib!keys_t.KeyIterator. self!))) (or (and (=> (is-core!option.Option./Some_ tmp%%@) (=> (= v@ (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@)))) (=> (ens%lib!verus_extra.clone_v.VerusClone.clone. K&. K& v@ tmp%1) (=> (= tmp%2 (core!option.Option./Some tmp%1)) %%switch_label%%0)))) (=> (not (is-core!option.Option./Some_ tmp%%@)) (=> (= tmp%2 core!option.Option./None) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= %return! (Poly%lib!keys_t.KeyIterator. (lib!keys_t.KeyIterator./KeyIterator (%Poly%core!option.Option. (Poly%core!option.Option. tmp%2))))) (=> %%location_label%%0 (= %return! self!))))))))
(check-sat)
(exit)
