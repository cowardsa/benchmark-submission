...
(declare-const c! lib!cmessage_v.CSingleMessage.)
(declare-const self! lib!cmessage_v.CSingleMessage.)
(declare-const tmp%1 lib!io_t.EndPoint.)
(declare-const tmp%2 lib!cmessage_v.CMessage.)
(declare-const seqno@ Int)
(declare-const dst@ lib!io_t.EndPoint.)
(declare-const m@ lib!cmessage_v.CMessage.)
(declare-const tmp%3 lib!cmessage_v.CSingleMessage.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!cmessage_v.CSingleMessage. self!) TYPE%lib!cmessage_v.CSingleMessage.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (or (and (=> (is-lib!cmessage_v.CSingleMessage./Message_ self!) (=> (= seqno@ (lib!cmessage_v.CSingleMessage./Message/seqno (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. self!)))) (=> (= dst@ (lib!cmessage_v.CSingleMessage./Message/dst (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. self!)))) (=> (= m@ (lib!cmessage_v.CSingleMessage./Message/m (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. self!)))) (=> (ens%lib!io_t.impl&%4.clone_up_to_view. dst@ tmp%1) (=> (ens%lib!cmessage_v.impl&%1.clone_up_to_view. m@ tmp%2) (=> (= tmp%3 (lib!cmessage_v.CSingleMessage./Message (%I (I seqno@)) (%Poly%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. tmp%1)) (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. tmp%2)))) %%switch_label%%0))))))) (=> (not (is-lib!cmessage_v.CSingleMessage./Message_ self!)) (=> (= tmp%3 (ite (is-lib!cmessage_v.CSingleMessage./Ack_ self!) (let ((ack_seqno$ (lib!cmessage_v.CSingleMessage./Ack/ack_seqno (%Poly%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. self!))))) (lib!cmessage_v.CSingleMessage./Ack (%I (I ack_seqno$)))) lib!cmessage_v.CSingleMessage./InvalidMessage)) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= c! tmp%3) (=> %%location_label%%0 (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. c!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. self!)))))))))
(check-sat)
(exit)
