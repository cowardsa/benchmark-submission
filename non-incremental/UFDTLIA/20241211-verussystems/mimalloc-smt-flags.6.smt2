...
(assert (not (=> (= b! (not (= (uClip 8 (bitand (I (lib!types.PageInner./PageInner/flags2 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!)))) (I 1))) 0))) (=> %%location_label%%0 (= b! (lib!flags.impl&%0.is_zero.? (Poly%lib!types.PageInner. self!)))))))
(check-sat)
(exit)
