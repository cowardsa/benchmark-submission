...
(assert (not (=> (= tmp%2 (tuple%2./tuple%2/0 (%Poly%tuple%2. self!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%2)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%2 tmp%1) (=> (= tmp%4 (tuple%2./tuple%2/1 (%Poly%tuple%2. self!))) (and (=> %%location_label%%1 (req%lib!marshal_v.Marshalable.serialized_size. U&. U& tmp%4)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. U&. U& tmp%4 tmp%3) (and (=> %%location_label%%2 (uInv SZ (Add (%I tmp%1) (%I tmp%3)))) (=> (= %return! (I (uClip SZ (Add (%I tmp%1) (%I tmp%3))))) (=> %%location_label%%3 (= (%I %return!) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!))))))))))))))
(check-sat)
(exit)
