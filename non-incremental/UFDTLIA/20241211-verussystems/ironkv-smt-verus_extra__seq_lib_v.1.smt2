...
(assert (and (and (and (<= 0 i!) (<= i! j!)) (<= j! k!)) (<= k! (vstd!seq.Seq.len.? A&. A& s!))))
...
(assert (not (=> (= s1@ (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.subrange.? A&. A& s! (I i!) (I j!)) (vstd!seq.Seq.subrange.? A&. A& s! (I j!) (I k!)))) (=> (= s2@ (vstd!seq.Seq.subrange.? A&. A& s! (I i!) (I k!))) (and (=> (= tmp%1 (= (vstd!seq.Seq.len.? A&. A& s1@) (vstd!seq.Seq.len.? A&. A& s2@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> (has_type idx@ INT) (=> (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? A&. A& s1@))) (=> %%location_label%%1 (= (vstd!seq.Seq.index.? A&. A& s1@ idx@) (vstd!seq.Seq.index.? A&. A& s2@ idx@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? A&. A& s1@))) (= (vstd!seq.Seq.index.? A&. A& s1@ idx$) (vstd!seq.Seq.index.? A&. A& s2@ idx$)))) :pattern ((vstd!seq.Seq.index.? A&. A& s1@ idx$)) :pattern ((vstd!seq.Seq.index.? A&. A& s2@ idx$)) )) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1@ s2@)) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> %%location_label%%3 (= s1@ s2@)))))))))) (=> (= s1@ s2@) (=> %%location_label%%4 (= (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.subrange.? A&. A& s! (I i!) (I j!)) (vstd!seq.Seq.subrange.? A&. A& s! (I j!) (I k!))) (vstd!seq.Seq.subrange.? A&. A& s! (I i!) (I k!))))))))))
(check-sat)
(exit)
