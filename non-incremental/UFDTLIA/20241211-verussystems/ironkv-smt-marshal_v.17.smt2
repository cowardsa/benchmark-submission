...
(assert (not (=> (= tmp%%@ (tuple%2./tuple%2 self! other!)) (or (and (=> (and (and (is-tuple%2./tuple%2_ tmp%%@) (is-core!option.Option./None_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (is-core!option.Option./None_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) %%switch_label%%0) (=> (not (and (and (is-tuple%2./tuple%2_ tmp%%@) (is-core!option.Option./None_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (is-core!option.Option./None_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))))) (or (and (=> (and (and (is-tuple%2./tuple%2_ tmp%%@) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (=> (= s@ (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (=> (= o@ (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. T&. T& s@ o@) %%switch_label%%1)))) (=> (not (and (and (is-tuple%2./tuple%2_ tmp%%@) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))))) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%0 (= (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%core!option.Option. T&. T&) self! other!) (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%core!option.Option. T&. T&) other! self!))))))))
(check-sat)
(exit)
