...
(assert (not (=> (fuel_bool fuel%lib!marshal_ironsht_specific_v.ckeyhashmap_max_serialized_size.) (=> (= r! 1048576) (=> %%location_label%%0 (= r! (lib!marshal_ironsht_specific_v.ckeyhashmap_max_serialized_size.? (I 0))))))))
(check-sat)
(exit)
