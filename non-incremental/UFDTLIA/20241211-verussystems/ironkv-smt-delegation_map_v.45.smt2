...
(assert (not (and (=> %%location_label%%0 (req%lib!delegation_map_v.impl&%4.get_internal. K&. K& self! k!)) (=> (ens%lib!delegation_map_v.impl&%4.get_internal. K&. K& self! k! tmp%%@) (=> (= id@ (%Poly%lib!io_t.EndPoint. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= glb_ret@ (%Poly%lib!keys_t.KeyIterator. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= id! id@) (and (=> %%location_label%%1 (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. id!)) (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.index.? K&. K& $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (lib!delegation_map_v.impl&%4.view.? K&. K& (Poly%lib!delegation_map_v.DelegationMap. self!)) k!)))) (=> %%location_label%%2 (lib!abstract_end_point_t.impl&%0.valid_physical_address.? (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. id!)))))))))))))
(check-sat)
(exit)
