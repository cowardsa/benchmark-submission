...
(assert (not (=> (= tmp%1 (I (lib!marshal_ironsht_specific_v.impl&%9.forward_bijection_for_view_equality_do_not_use_for_anything_else.? self!))) (=> (= tmp%2 (I (lib!marshal_ironsht_specific_v.impl&%9.forward_bijection_for_view_equality_do_not_use_for_anything_else.? other!))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. $ (UINT 64) tmp%1 tmp%2) (=> %%location_label%%0 (= (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!keys_t.SHTKey. self! other!) (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!keys_t.SHTKey. other! self!))))))))
(check-sat)
(exit)
