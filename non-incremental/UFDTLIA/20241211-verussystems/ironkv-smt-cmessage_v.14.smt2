...
(set-info :comment ";; MODULE 'module cmessage_v'")
...
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_recipient. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_h. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_kr. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_range. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_id. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_GetRequest_k. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_SetRequest_k. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_SetRequest_v. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_Reply_k. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_Reply_v. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_Redirect_k. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_Redirect_id. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_Shard_kr. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_Shard_recipient. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_Delegate_range. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%0.arrow_Delegate_h. FuelId)
...
(declare-const fuel%lib!cmessage_v.impl&%2.temp_valid. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%2.view. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%2.marshallable. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%3.valid. FuelId)
...
(declare-const fuel%lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets. FuelId)
(declare-const fuel%lib!cmessage_v.abstractify_seq_of_cpackets_to_set_of_sht_packets. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%5.arrow_seqno. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%5.arrow_ack_seqno. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%5.arrow_dst. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%5.arrow_m. FuelId)
...
(declare-const fuel%lib!cmessage_v.impl&%5.arrow_Message_m. FuelId)
(declare-const fuel%lib!cmessage_v.impl&%5.arrow_Ack_ack_seqno. FuelId)
...
(declare-const fuel%lib!host_impl_v.abstractify_cpacket_to_lsht_packet. FuelId)
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.impl&%0.is_None. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!std_specs.vec.axiom_spec_len. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.impl&%0.spec_add. fuel%vstd!seq.Seq.last. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_subrange_decreases. fuel%vstd!seq.axiom_seq_empty. fuel%vstd!seq.axiom_seq_new_len. fuel%vstd!seq.axiom_seq_new_index. fuel%vstd!seq.axiom_seq_push_len. fuel%vstd!seq.axiom_seq_push_index_same. fuel%vstd!seq.axiom_seq_push_index_different. fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq.axiom_seq_subrange_len. fuel%vstd!seq.axiom_seq_subrange_index. fuel%vstd!seq.axiom_seq_add_len. fuel%vstd!seq.axiom_seq_add_index1. fuel%vstd!seq.axiom_seq_add_index2. fuel%vstd!seq_lib.impl&%0.map_values. fuel%vstd!seq_lib.impl&%0.add_empty_left. fuel%vstd!seq_lib.impl&%0.add_empty_right. fuel%vstd!seq_lib.impl&%0.push_distributes_over_add. fuel%vstd!seq_lib.impl&%0.contains. fuel%vstd!seq_lib.impl&%0.drop_last. fuel%vstd!seq_lib.impl&%0.to_set. fuel%vstd!seq_lib.impl&%0.fold_left. fuel%vstd!seq_lib.seq_to_set_is_finite. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_set_contains_len. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view. fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view. fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%20.view. fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%42.view. fuel%vstd!view.impl&%46.view. fuel%lib!cmessage_v.impl&%0.arrow_recipient. fuel%lib!cmessage_v.impl&%0.arrow_h. fuel%lib!cmessage_v.impl&%0.arrow_kr. fuel%lib!cmessage_v.impl&%0.arrow_range. fuel%lib!cmessage_v.impl&%0.arrow_id. fuel%lib!cmessage_v.impl&%0.arrow_GetRequest_k. fuel%lib!cmessage_v.impl&%0.arrow_SetRequest_k. fuel%lib!cmessage_v.impl&%0.arrow_SetRequest_v. fuel%lib!cmessage_v.impl&%0.arrow_Reply_k. fuel%lib!cmessage_v.impl&%0.arrow_Reply_v. fuel%lib!cmessage_v.impl&%0.arrow_Redirect_k. fuel%lib!cmessage_v.impl&%0.arrow_Redirect_id. fuel%lib!cmessage_v.impl&%0.arrow_Shard_kr. fuel%lib!cmessage_v.impl&%0.arrow_Shard_recipient. fuel%lib!cmessage_v.impl&%0.arrow_Delegate_range. fuel%lib!cmessage_v.impl&%0.arrow_Delegate_h. fuel%lib!cmessage_v.optional_value_view. fuel%lib!cmessage_v.impl&%1.abstractable. fuel%lib!cmessage_v.impl&%1.view. fuel%lib!cmessage_v.impl&%1.message_marshallable. fuel%lib!cmessage_v.abstractify_cmessage_seq. fuel%lib!cmessage_v.impl&%2.abstractable. fuel%lib!cmessage_v.impl&%2.temp_valid. fuel%lib!cmessage_v.impl&%2.view. fuel%lib!cmessage_v.impl&%2.marshallable. fuel%lib!cmessage_v.impl&%3.valid. fuel%lib!cmessage_v.impl&%3.view. fuel%lib!cmessage_v.impl&%3.abstractable. fuel%lib!cmessage_v.cpacket_seq_is_abstractable. fuel%lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets. fuel%lib!cmessage_v.abstractify_seq_of_cpackets_to_set_of_sht_packets. fuel%lib!cmessage_v.impl&%5.arrow_seqno. fuel%lib!cmessage_v.impl&%5.arrow_ack_seqno. fuel%lib!cmessage_v.impl&%5.arrow_dst. fuel%lib!cmessage_v.impl&%5.arrow_m. fuel%lib!cmessage_v.impl&%5.arrow_Message_seqno. fuel%lib!cmessage_v.impl&%5.arrow_Message_dst. fuel%lib!cmessage_v.impl&%5.arrow_Message_m. fuel%lib!cmessage_v.impl&%5.arrow_Ack_ack_seqno. fuel%lib!cmessage_v.impl&%6.view_equal. fuel%lib!cmessage_v.impl&%6.is_marshalable. fuel%lib!cmessage_v.impl&%6.ghost_serialize. fuel%lib!delegation_map_v.impl&%0.lt. fuel%lib!host_impl_v.abstractify_cpacket_to_lsht_packet. fuel%lib!marshal_ironsht_specific_v.impl&%2.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%2.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%2.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%3.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%3.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%3.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%4.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%4.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%4.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%5.forward_bijection_for_view_equality_do_not_use_for_anything_else. fuel%lib!marshal_ironsht_specific_v.impl&%6.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%6.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%6.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%7.forward_bijection_for_view_equality_do_not_use_for_anything_else. fuel%lib!marshal_ironsht_specific_v.impl&%8.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%8.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%8.ghost_serialize. fuel%lib!marshal_ironsht_specific_v.impl&%9.forward_bijection_for_view_equality_do_not_use_for_anything_else. fuel%lib!marshal_ironsht_specific_v.impl&%10.view_equal. fuel%lib!marshal_ironsht_specific_v.impl&%10.is_marshalable. fuel%lib!marshal_ironsht_specific_v.impl&%10.ghost_serialize. fuel%lib!marshal_v.impl&%0.view_equal. fuel%lib!marshal_v.impl&%0.is_marshalable. fuel%lib!marshal_v.impl&%0.ghost_serialize. fuel%lib!marshal_v.impl&%1.view_equal. fuel%lib!marshal_v.impl&%1.is_marshalable. fuel%lib!marshal_v.impl&%1.ghost_serialize. fuel%lib!marshal_v.impl&%2.view_equal. fuel%lib!marshal_v.impl&%2.is_marshalable. fuel%lib!marshal_v.impl&%2.ghost_serialize. fuel%lib!marshal_v.impl&%3.view_equal. fuel%lib!marshal_v.impl&%3.is_marshalable. fuel%lib!marshal_v.impl&%3.ghost_serialize. fuel%lib!marshal_v.impl&%4.view_equal. fuel%lib!marshal_v.impl&%4.is_marshalable. fuel%lib!marshal_v.impl&%4.ghost_serialize. fuel%lib!marshal_v.impl&%5.view_equal. fuel%lib!marshal_v.impl&%5.is_marshalable. fuel%lib!marshal_v.impl&%5.ghost_serialize. fuel%lib!abstract_end_point_t.impl&%0.valid_physical_address. fuel%lib!abstract_end_point_t.impl&%0.abstractable. fuel%lib!abstract_parameters_t.impl&%0.static_params. fuel%lib!app_interface_t.max_val_len. fuel%lib!app_interface_t.valid_key. fuel%lib!app_interface_t.valid_value. fuel%lib!hashmap_t.ckeykvlt. fuel%lib!hashmap_t.spec_sorted_keys. fuel%lib!host_protocol_t.max_hashtable_size. fuel%lib!host_protocol_t.valid_hashtable. fuel%lib!host_protocol_t.valid_optional_value. fuel%lib!io_t.impl&%4.view. fuel%lib!io_t.impl&%4.abstractable. fuel%lib!io_t.impl&%4.valid_public_key. fuel%lib!keys_t.impl&%3.lt_spec. fuel%lib!keys_t.impl&%3.geq_spec. fuel%lib!keys_t.impl&%4.is_empty. fuel%lib!keys_t.impl&%13.cmp_spec. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(assert (=> (fuel_bool_default fuel%vstd!set.group_set_axioms.) (and (fuel_bool_default fuel%vstd!set.axiom_set_new.) (fuel_bool_default fuel%vstd!set.axiom_set_ext_equal.) (fuel_bool_default fuel%vstd!set.axiom_set_ext_equal_deep.) (fuel_bool_default fuel%vstd!set.axiom_set_contains_len.))))
...
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_recipient")
(declare-fun lib!cmessage_v.impl&%0.arrow_recipient.? (Poly) lib!io_t.EndPoint.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_h")
(declare-fun lib!cmessage_v.impl&%0.arrow_h.? (Poly) lib!hashmap_t.CKeyHashMap.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_kr")
(declare-fun lib!cmessage_v.impl&%0.arrow_kr.? (Poly) lib!keys_t.KeyRange.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_range")
(declare-fun lib!cmessage_v.impl&%0.arrow_range.? (Poly) lib!keys_t.KeyRange.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_id")
(declare-fun lib!cmessage_v.impl&%0.arrow_id.? (Poly) lib!io_t.EndPoint.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_GetRequest_k")
(declare-fun lib!cmessage_v.impl&%0.arrow_GetRequest_k.? (Poly) lib!keys_t.SHTKey.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_SetRequest_k")
(declare-fun lib!cmessage_v.impl&%0.arrow_SetRequest_k.? (Poly) lib!keys_t.SHTKey.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_SetRequest_v")
(declare-fun lib!cmessage_v.impl&%0.arrow_SetRequest_v.? (Poly) core!option.Option.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_Reply_k")
(declare-fun lib!cmessage_v.impl&%0.arrow_Reply_k.? (Poly) lib!keys_t.SHTKey.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_Reply_v")
(declare-fun lib!cmessage_v.impl&%0.arrow_Reply_v.? (Poly) core!option.Option.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_Redirect_k")
(declare-fun lib!cmessage_v.impl&%0.arrow_Redirect_k.? (Poly) lib!keys_t.SHTKey.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_Redirect_id")
(declare-fun lib!cmessage_v.impl&%0.arrow_Redirect_id.? (Poly) lib!io_t.EndPoint.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_Shard_kr")
(declare-fun lib!cmessage_v.impl&%0.arrow_Shard_kr.? (Poly) lib!keys_t.KeyRange.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_Shard_recipient")
(declare-fun lib!cmessage_v.impl&%0.arrow_Shard_recipient.? (Poly) lib!io_t.EndPoint.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_Delegate_range")
(declare-fun lib!cmessage_v.impl&%0.arrow_Delegate_range.? (Poly) lib!keys_t.KeyRange.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CMessage::arrow_Delegate_h")
(declare-fun lib!cmessage_v.impl&%0.arrow_Delegate_h.? (Poly) lib!hashmap_t.CKeyHashMap.)
...
(set-info :comment ";; Function-Decl lib::cmessage_v::CSingleMessage::temp_valid")
(declare-fun lib!cmessage_v.impl&%2.temp_valid.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::io_t::EndPoint::valid_public_key")
(declare-fun lib!io_t.impl&%4.valid_public_key.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::cmessage_v::CSingleMessage::marshallable")
(declare-fun lib!cmessage_v.impl&%2.marshallable.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::cmessage_v::CPacket::valid")
(declare-fun lib!cmessage_v.impl&%3.valid.? (Poly) Bool)
...
(set-info :comment ";; Function-Decl lib::host_impl_v::abstractify_cpacket_to_lsht_packet")
(declare-fun lib!host_impl_v.abstractify_cpacket_to_lsht_packet.? (Poly) lib!environment_t.LPacket.)
(set-info :comment ";; Function-Decl lib::cmessage_v::abstractify_outbound_packets_to_seq_of_lsht_packets")
(declare-fun lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets.? (Poly) vstd!seq.Seq<lib!environment_t.LPacket<lib!abstract_end_point_t.AbstractEndPoint./lib!single_message_t.SingleMessage<lib!message_t.Message.>.>.>.)
...
(set-info :comment ";; Function-Decl lib::cmessage_v::CSingleMessage::arrow_seqno")
(declare-fun lib!cmessage_v.impl&%5.arrow_seqno.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::cmessage_v::CSingleMessage::arrow_ack_seqno")
(declare-fun lib!cmessage_v.impl&%5.arrow_ack_seqno.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::cmessage_v::CSingleMessage::arrow_dst")
(declare-fun lib!cmessage_v.impl&%5.arrow_dst.? (Poly) lib!io_t.EndPoint.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CSingleMessage::arrow_m")
(declare-fun lib!cmessage_v.impl&%5.arrow_m.? (Poly) lib!cmessage_v.CMessage.)
...
(set-info :comment ";; Function-Decl lib::cmessage_v::CSingleMessage::arrow_Message_m")
(declare-fun lib!cmessage_v.impl&%5.arrow_Message_m.? (Poly) lib!cmessage_v.CMessage.)
(set-info :comment ";; Function-Decl lib::cmessage_v::CSingleMessage::arrow_Ack_ack_seqno")
(declare-fun lib!cmessage_v.impl&%5.arrow_Ack_ack_seqno.? (Poly) Int)
...
(set-info :comment ";; Function-Specs lib::marshal_v::Marshalable::_is_marshalable")
...
(set-info :comment ";; Function-Specs lib::marshal_v::Marshalable::serialized_size")
(declare-fun req%lib!marshal_v.Marshalable.serialized_size. (Dcr Type Poly) Bool)
(declare-const %%global_location_label%%10 Bool)
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly)) (! (= (req%lib!marshal_v.Marshalable.serialized_size. Self%&. Self%& self!) (=> %%global_location_label%%10 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& self!)))) :pattern ((req%lib!marshal_v.Marshalable.serialized_size. Self%&. Self%& self!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (pre%data! Poly)) (! (= (req%lib!marshal_v.Marshalable.serialize. Self%&. Self%& self! pre%data!) (=> %%global_location_label%%11 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& self!)))) :pattern ((req%lib!marshal_v.Marshalable.serialize. Self%&. Self%& self! pre%data!)) )))
...
(set-info :comment ";; Function-Specs lib::marshal_v::Marshalable::lemma_view_equal_symmetric")
...
(set-info :comment ";; Function-Specs lib::marshal_v::Marshalable::lemma_serialization_is_not_a_prefix_of")
(declare-fun req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%12 Bool)
(declare-const %%global_location_label%%13 Bool)
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (other! Poly)) (! (= (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. Self%&. Self%& self! other!) (and (=> %%global_location_label%%12 (not (%B (lib!marshal_v.Marshalable.view_equal.? Self%&. Self%& self! other!)))) (=> %%global_location_label%%13 (<= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? Self%&. Self%& self!)) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? Self%&. Self%& other!)))))) :pattern ((req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. Self%&. Self%& self! other!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (other! Poly)) (! (= (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. Self%&. Self%& self! other!) (=> %%global_location_label%%14 (%B (lib!marshal_v.Marshalable.view_equal.? Self%&. Self%& self! other!)))) :pattern ((req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. Self%&. Self%& self! other!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (other! Poly)) (! (= (req%lib!marshal_v.Marshalable.lemma_serialize_injective. Self%&. Self%& self! other!) (and (=> %%global_location_label%%15 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& self!))) (=> %%global_location_label%%16 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& other!))) (=> %%global_location_label%%17 (= (lib!marshal_v.Marshalable.ghost_serialize.? Self%&. Self%& self!) (lib!marshal_v.Marshalable.ghost_serialize.? Self%&. Self%& other!))))) :pattern ((req%lib!marshal_v.Marshalable.lemma_serialize_injective. Self%&. Self%& self! other!)) )))
...
(set-info :comment ";; Function-Specs lib::hashmap_t::CKeyHashMap::clone_up_to_view")
(declare-fun ens%lib!hashmap_t.impl&%0.clone_up_to_view. (lib!hashmap_t.CKeyHashMap. lib!hashmap_t.CKeyHashMap.) Bool)
(assert (forall ((self! lib!hashmap_t.CKeyHashMap.) (out! lib!hashmap_t.CKeyHashMap.)) (! (= (ens%lib!hashmap_t.impl&%0.clone_up_to_view. self! out!) (= (lib!hashmap_t.impl&%0.view.? (Poly%lib!hashmap_t.CKeyHashMap. out!)) (lib!hashmap_t.impl&%0.view.? (Poly%lib!hashmap_t.CKeyHashMap. self!)))) :pattern ((ens%lib!hashmap_t.impl&%0.clone_up_to_view. self! out!)) )))
...
(set-info :comment ";; Function-Specs lib::hashmap_t::CKeyHashMap::valid")
(declare-fun ens%lib!hashmap_t.impl&%0.valid. (lib!hashmap_t.CKeyHashMap. Bool) Bool)
(assert (forall ((self! lib!hashmap_t.CKeyHashMap.) (b! Bool)) (! (= (ens%lib!hashmap_t.impl&%0.valid. self! b!) (= b! (lib!host_protocol_t.valid_hashtable.? (Poly%vstd!map.Map<lib!keys_t.SHTKey./vstd!seq.Seq<u8.>.>. (lib!hashmap_t.impl&%0.view.? (Poly%lib!hashmap_t.CKeyHashMap. self!)))))) :pattern ((ens%lib!hashmap_t.impl&%0.valid. self! b!)) )))
...
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_recipient")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_recipient.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_recipient.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_recipient.? self!) (lib!cmessage_v.CMessage./Shard/recipient (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_recipient.? self!)) ))))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_h")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_h.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_h.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_h.? self!) (lib!cmessage_v.CMessage./Delegate/h (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_h.? self!)) ))))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_kr")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_kr.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_kr.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_kr.? self!) (lib!cmessage_v.CMessage./Shard/kr (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_kr.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%lib!keys_t.KeyRange. (lib!cmessage_v.impl&%0.arrow_kr.? self!)) (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.))) :pattern ((lib!cmessage_v.impl&%0.arrow_kr.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_range")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_range.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_range.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_range.? self!) (lib!cmessage_v.CMessage./Delegate/range (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_range.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%lib!keys_t.KeyRange. (lib!cmessage_v.impl&%0.arrow_range.? self!)) (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.))) :pattern ((lib!cmessage_v.impl&%0.arrow_range.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_id")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_id.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_id.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_id.? self!) (lib!cmessage_v.CMessage./Redirect/id (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_id.? self!)) ))))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_GetRequest_k")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_GetRequest_k.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_GetRequest_k.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_GetRequest_k.? self!) (lib!cmessage_v.CMessage./GetRequest/k (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_GetRequest_k.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%lib!keys_t.SHTKey. (lib!cmessage_v.impl&%0.arrow_GetRequest_k.? self!)) TYPE%lib!keys_t.SHTKey.)) :pattern ((lib!cmessage_v.impl&%0.arrow_GetRequest_k.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_SetRequest_k")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_SetRequest_k.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_SetRequest_k.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_SetRequest_k.? self!) (lib!cmessage_v.CMessage./SetRequest/k (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_SetRequest_k.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%lib!keys_t.SHTKey. (lib!cmessage_v.impl&%0.arrow_SetRequest_k.? self!)) TYPE%lib!keys_t.SHTKey.)) :pattern ((lib!cmessage_v.impl&%0.arrow_SetRequest_k.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_SetRequest_v")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_SetRequest_v.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_SetRequest_v.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_SetRequest_v.? self!) (lib!cmessage_v.CMessage./SetRequest/v (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_SetRequest_v.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%core!option.Option. (lib!cmessage_v.impl&%0.arrow_SetRequest_v.? self!)) (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)))) :pattern ((lib!cmessage_v.impl&%0.arrow_SetRequest_v.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_Reply_k")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_Reply_k.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_Reply_k.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_Reply_k.? self!) (lib!cmessage_v.CMessage./Reply/k (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_Reply_k.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%lib!keys_t.SHTKey. (lib!cmessage_v.impl&%0.arrow_Reply_k.? self!)) TYPE%lib!keys_t.SHTKey.)) :pattern ((lib!cmessage_v.impl&%0.arrow_Reply_k.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_Reply_v")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_Reply_v.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_Reply_v.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_Reply_v.? self!) (lib!cmessage_v.CMessage./Reply/v (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_Reply_v.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%core!option.Option. (lib!cmessage_v.impl&%0.arrow_Reply_v.? self!)) (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)))) :pattern ((lib!cmessage_v.impl&%0.arrow_Reply_v.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_Redirect_k")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_Redirect_k.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_Redirect_k.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_Redirect_k.? self!) (lib!cmessage_v.CMessage./Redirect/k (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_Redirect_k.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%lib!keys_t.SHTKey. (lib!cmessage_v.impl&%0.arrow_Redirect_k.? self!)) TYPE%lib!keys_t.SHTKey.)) :pattern ((lib!cmessage_v.impl&%0.arrow_Redirect_k.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_Redirect_id")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_Redirect_id.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_Redirect_id.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_Redirect_id.? self!) (lib!cmessage_v.CMessage./Redirect/id (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_Redirect_id.? self!)) ))))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_Shard_kr")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_Shard_kr.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_Shard_kr.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_Shard_kr.? self!) (lib!cmessage_v.CMessage./Shard/kr (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_Shard_kr.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%lib!keys_t.KeyRange. (lib!cmessage_v.impl&%0.arrow_Shard_kr.? self!)) (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.))) :pattern ((lib!cmessage_v.impl&%0.arrow_Shard_kr.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_Shard_recipient")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_Shard_recipient.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_Shard_recipient.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_Shard_recipient.? self!) (lib!cmessage_v.CMessage./Shard/recipient (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_Shard_recipient.? self!)) ))))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_Delegate_range")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_Delegate_range.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_Delegate_range.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_Delegate_range.? self!) (lib!cmessage_v.CMessage./Delegate/range (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_Delegate_range.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CMessage.) (has_type (Poly%lib!keys_t.KeyRange. (lib!cmessage_v.impl&%0.arrow_Delegate_range.? self!)) (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.))) :pattern ((lib!cmessage_v.impl&%0.arrow_Delegate_range.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CMessage::arrow_Delegate_h")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%0.arrow_Delegate_h.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%0.arrow_Delegate_h.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%0.arrow_Delegate_h.? self!) (lib!cmessage_v.CMessage./Delegate/h (%Poly%lib!cmessage_v.CMessage. self!))) :pattern ((lib!cmessage_v.impl&%0.arrow_Delegate_h.? self!)) ))))
...
(set-info :comment ";; Function-Axioms lib::cmessage_v::CSingleMessage::temp_valid")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%2.temp_valid.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%2.temp_valid.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%2.temp_valid.? self!) (ite (is-lib!cmessage_v.CSingleMessage./Message_ (%Poly%lib!cmessage_v.CSingleMessage. self!)) (let ((seqno$ (lib!cmessage_v.CSingleMessage./Message/seqno (%Poly%lib!cmessage_v.CSingleMessage. self!)))) (< seqno$ (lib!abstract_parameters_t.AbstractParameters./AbstractParameters/max_seqno (%Poly%lib!abstract_parameters_t.AbstractParameters. (Poly%lib!abstract_parameters_t.AbstractParameters. (lib!abstract_parameters_t.impl&%0.static_params.? (I 0))))))) (and (is-lib!cmessage_v.CSingleMessage./Ack_ (%Poly%lib!cmessage_v.CSingleMessage. self!)) (let ((ack_seqno$ (lib!cmessage_v.CSingleMessage./Ack/ack_seqno (%Poly%lib!cmessage_v.CSingleMessage. self!)))) (< ack_seqno$ (lib!abstract_parameters_t.AbstractParameters./AbstractParameters/max_seqno (%Poly%lib!abstract_parameters_t.AbstractParameters. (Poly%lib!abstract_parameters_t.AbstractParameters. (lib!abstract_parameters_t.impl&%0.static_params.? (I 0)))))))))) :pattern ((lib!cmessage_v.impl&%2.temp_valid.? self!)) ))))
...
(set-info :comment ";; Function-Axioms lib::cmessage_v::CSingleMessage::marshallable")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%2.marshallable.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%2.marshallable.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%2.marshallable.? self!) (=> (not (is-lib!cmessage_v.CSingleMessage./Ack_ (%Poly%lib!cmessage_v.CSingleMessage. self!))) (and (is-lib!cmessage_v.CSingleMessage./Message_ (%Poly%lib!cmessage_v.CSingleMessage. self!)) (let ((seqno$ (lib!cmessage_v.CSingleMessage./Message/seqno (%Poly%lib!cmessage_v.CSingleMessage. self!)))) (let ((dst$ (lib!cmessage_v.CSingleMessage./Message/dst (%Poly%lib!cmessage_v.CSingleMessage. self!)))) (let ((m$ (lib!cmessage_v.CSingleMessage./Message/m (%Poly%lib!cmessage_v.CSingleMessage. self!)))) (and (lib!io_t.impl&%4.valid_public_key.? (Poly%lib!io_t.EndPoint. dst$)) (lib!cmessage_v.impl&%1.message_marshallable.? (Poly%lib!cmessage_v.CMessage. m$))))))))) :pattern ((lib!cmessage_v.impl&%2.marshallable.? self!)) ))))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CPacket::valid")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%3.valid.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%3.valid.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%3.valid.? self!) (lib!cmessage_v.impl&%2.temp_valid.? (Poly%lib!cmessage_v.CSingleMessage. (lib!cmessage_v.CPacket./CPacket/msg (%Poly%lib!cmessage_v.CPacket. self!))))) :pattern ((lib!cmessage_v.impl&%3.valid.? self!)) ))))
...
(set-info :comment ";; Function-Specs lib::host_impl_v::abstractify_cpacket_to_lsht_packet")
(declare-fun req%lib!host_impl_v.abstractify_cpacket_to_lsht_packet. (Poly) Bool)
(declare-const %%global_location_label%%18 Bool)
(assert (forall ((cp! Poly)) (! (= (req%lib!host_impl_v.abstractify_cpacket_to_lsht_packet. cp!) (=> %%global_location_label%%18 (lib!cmessage_v.impl&%3.abstractable.? cp!))) :pattern ((req%lib!host_impl_v.abstractify_cpacket_to_lsht_packet. cp!)) )))
(set-info :comment ";; Function-Axioms lib::host_impl_v::abstractify_cpacket_to_lsht_packet")
(assert (fuel_bool_default fuel%lib!host_impl_v.abstractify_cpacket_to_lsht_packet.))
(assert (=> (fuel_bool fuel%lib!host_impl_v.abstractify_cpacket_to_lsht_packet.) (forall ((cp! Poly)) (! (= (lib!host_impl_v.abstractify_cpacket_to_lsht_packet.? cp!) (lib!environment_t.LPacket./LPacket (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. (lib!cmessage_v.CPacket./CPacket/dst (%Poly%lib!cmessage_v.CPacket. cp!))))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. (lib!cmessage_v.CPacket./CPacket/src (%Poly%lib!cmessage_v.CPacket. cp!))))) (Poly%lib!single_message_t.SingleMessage. (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. (lib!cmessage_v.CPacket./CPacket/msg (%Poly%lib!cmessage_v.CPacket. cp!))))))) :pattern ((lib!host_impl_v.abstractify_cpacket_to_lsht_packet.? cp!)) ))))
(assert (forall ((cp! Poly)) (! (=> (has_type cp! TYPE%lib!cmessage_v.CPacket.) (has_type (Poly%lib!environment_t.LPacket. (lib!host_impl_v.abstractify_cpacket_to_lsht_packet.? cp!)) (TYPE%lib!environment_t.LPacket. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)))) :pattern ((lib!host_impl_v.abstractify_cpacket_to_lsht_packet.? cp!)) )))
(set-info :comment ";; Function-Specs lib::cmessage_v::abstractify_outbound_packets_to_seq_of_lsht_packets")
(declare-fun req%lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets. (Poly) Bool)
(declare-const %%global_location_label%%19 Bool)
(assert (forall ((packets! Poly)) (! (= (req%lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets. packets!) (=> %%global_location_label%%19 (lib!cmessage_v.cpacket_seq_is_abstractable.? packets!))) :pattern ((req%lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets. packets!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::abstractify_outbound_packets_to_seq_of_lsht_packets")
(assert (fuel_bool_default fuel%lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets.))
(declare-fun %%lambda%%3 () %%Function%%)
(assert (forall ((packet$ Poly)) (! (= (%%apply%%0 %%lambda%%3 packet$) (Poly%lib!environment_t.LPacket. (lib!host_impl_v.abstractify_cpacket_to_lsht_packet.? packet$))) :pattern ((%%apply%%0 %%lambda%%3 packet$)))))
(assert (=> (fuel_bool fuel%lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets.) (forall ((packets! Poly)) (! (= (lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets.? packets!) (%Poly%vstd!seq.Seq<lib!environment_t.LPacket<lib!abstract_end_point_t.AbstractEndPoint./lib!single_message_t.SingleMessage<lib!message_t.Message.>.>.>. (vstd!seq_lib.impl&%0.map_values.? $ TYPE%lib!cmessage_v.CPacket. $ (TYPE%lib!environment_t.LPacket. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)) packets! (Poly%fun%1. (mk_fun %%lambda%%3))))) :pattern ((lib!cmessage_v.abstractify_outbound_packets_to_seq_of_lsht_packets.? packets!)) ))))
...
(assert (forall ((cps! Poly)) (! (= (req%lib!cmessage_v.abstractify_seq_of_cpackets_to_set_of_sht_packets. cps!) (=> %%global_location_label%%20 (lib!cmessage_v.cpacket_seq_is_abstractable.? cps!))) :pattern ((req%lib!cmessage_v.abstractify_seq_of_cpackets_to_set_of_sht_packets. cps!)) )))
...
(assert (forall ((cp$ Poly)) (! (= (%%apply%%0 %%lambda%%4 cp$) (Poly%lib!network_t.Packet. (lib!cmessage_v.impl&%3.view.? cp$))) :pattern ((%%apply%%0 %%lambda%%4 cp$)))))
(assert (=> (fuel_bool fuel%lib!cmessage_v.abstractify_seq_of_cpackets_to_set_of_sht_packets.) (forall ((cps! Poly)) (! (= (lib!cmessage_v.abstractify_seq_of_cpackets_to_set_of_sht_packets.? cps!) (%Poly%vstd!set.Set<lib!network_t.Packet.>. (vstd!seq_lib.impl&%0.to_set.? $ TYPE%lib!network_t.Packet. (vstd!seq_lib.impl&%0.map_values.? $ TYPE%lib!cmessage_v.CPacket. $ TYPE%lib!network_t.Packet. cps! (Poly%fun%1. (mk_fun %%lambda%%4)))))) :pattern ((lib!cmessage_v.abstractify_seq_of_cpackets_to_set_of_sht_packets.? cps!)) ))))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CSingleMessage::arrow_seqno")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%5.arrow_seqno.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%5.arrow_seqno.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%5.arrow_seqno.? self!) (lib!cmessage_v.CSingleMessage./Message/seqno (%Poly%lib!cmessage_v.CSingleMessage. self!))) :pattern ((lib!cmessage_v.impl&%5.arrow_seqno.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CSingleMessage.) (uInv 64 (lib!cmessage_v.impl&%5.arrow_seqno.? self!))) :pattern ((lib!cmessage_v.impl&%5.arrow_seqno.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CSingleMessage::arrow_ack_seqno")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%5.arrow_ack_seqno.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%5.arrow_ack_seqno.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%5.arrow_ack_seqno.? self!) (lib!cmessage_v.CSingleMessage./Ack/ack_seqno (%Poly%lib!cmessage_v.CSingleMessage. self!))) :pattern ((lib!cmessage_v.impl&%5.arrow_ack_seqno.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CSingleMessage.) (uInv 64 (lib!cmessage_v.impl&%5.arrow_ack_seqno.? self!))) :pattern ((lib!cmessage_v.impl&%5.arrow_ack_seqno.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CSingleMessage::arrow_dst")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%5.arrow_dst.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%5.arrow_dst.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%5.arrow_dst.? self!) (lib!cmessage_v.CSingleMessage./Message/dst (%Poly%lib!cmessage_v.CSingleMessage. self!))) :pattern ((lib!cmessage_v.impl&%5.arrow_dst.? self!)) ))))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CSingleMessage::arrow_m")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%5.arrow_m.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%5.arrow_m.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%5.arrow_m.? self!) (lib!cmessage_v.CSingleMessage./Message/m (%Poly%lib!cmessage_v.CSingleMessage. self!))) :pattern ((lib!cmessage_v.impl&%5.arrow_m.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CSingleMessage.) (has_type (Poly%lib!cmessage_v.CMessage. (lib!cmessage_v.impl&%5.arrow_m.? self!)) TYPE%lib!cmessage_v.CMessage.)) :pattern ((lib!cmessage_v.impl&%5.arrow_m.? self!)) )))
...
(set-info :comment ";; Function-Axioms lib::cmessage_v::CSingleMessage::arrow_Message_m")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%5.arrow_Message_m.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%5.arrow_Message_m.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%5.arrow_Message_m.? self!) (lib!cmessage_v.CSingleMessage./Message/m (%Poly%lib!cmessage_v.CSingleMessage. self!))) :pattern ((lib!cmessage_v.impl&%5.arrow_Message_m.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CSingleMessage.) (has_type (Poly%lib!cmessage_v.CMessage. (lib!cmessage_v.impl&%5.arrow_Message_m.? self!)) TYPE%lib!cmessage_v.CMessage.)) :pattern ((lib!cmessage_v.impl&%5.arrow_Message_m.? self!)) )))
(set-info :comment ";; Function-Axioms lib::cmessage_v::CSingleMessage::arrow_Ack_ack_seqno")
(assert (fuel_bool_default fuel%lib!cmessage_v.impl&%5.arrow_Ack_ack_seqno.))
(assert (=> (fuel_bool fuel%lib!cmessage_v.impl&%5.arrow_Ack_ack_seqno.) (forall ((self! Poly)) (! (= (lib!cmessage_v.impl&%5.arrow_Ack_ack_seqno.? self!) (lib!cmessage_v.CSingleMessage./Ack/ack_seqno (%Poly%lib!cmessage_v.CSingleMessage. self!))) :pattern ((lib!cmessage_v.impl&%5.arrow_Ack_ack_seqno.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!cmessage_v.CSingleMessage.) (uInv 64 (lib!cmessage_v.impl&%5.arrow_Ack_ack_seqno.? self!))) :pattern ((lib!cmessage_v.impl&%5.arrow_Ack_ack_seqno.? self!)) )))
...
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (acc$ Poly) (x$ Poly)) (! (= (%%apply%%1 (%%lambda%%5 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) acc$ x$) (I (Add (%I acc$) (vstd!seq.Seq.len.? %%hole%%2 %%hole%%3 (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$))))) :pattern ((%%apply%%1 (%%lambda%%5 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) acc$ x$)))))
(assert (=> (fuel_bool fuel%lib!marshal_v.impl&%4.is_marshalable.) (forall ((T&. Dcr) (T& Type) (self! Poly)) (! (=> (tr_bound%lib!marshal_v.Marshalable. T&. T&) (= (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (B (and (and (<= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) (- (uHi SZ) 1)) (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) ))) (<= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%5 T&. T& $ (UINT 8))))))) (- (uHi SZ) 1)))))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) ))))
(set-info :comment ";; Function-Axioms alloc::vec::Vec::ghost_serialize")
(assert (fuel_bool_default fuel%lib!marshal_v.impl&%4.ghost_serialize.))
(declare-fun %%lambda%%6 (Dcr Type Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (acc$ Poly) (x$ Poly)) (! (= (%%apply%%1 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) acc$ x$) (vstd!seq.Seq.add.? %%hole%%2 %%hole%%3 acc$ (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$))) :pattern ((%%apply%%1 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) acc$ x$)))))
(assert (=> (fuel_bool fuel%lib!marshal_v.impl&%4.ghost_serialize.) (forall ((T&. Dcr) (T& Type) (self! Poly)) (! (=> (tr_bound%lib!marshal_v.Marshalable. T&. T&) (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (vstd!seq.Seq.add.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!))))) (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (vstd!seq.Seq.empty.? $ (UINT 8)) (Poly%fun%2. (mk_fun (%%lambda%%6 T&. T& $ (UINT 8)))))))) :pattern ((lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) ))))
...
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::lemma_view_equal_symmetric")
(set-info :comment ";; ironsht/src/marshal_v.rs:1399:15: 1399:65 (#1522)")
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::_is_marshalable")
(set-info :comment ";; ironsht/src/marshal_v.rs:1424:14: 1424:47 (#1522)")
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::serialized_size")
(set-info :comment ";; ironsht/src/marshal_v.rs:1444:14: 1444:54 (#1522)")
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::serialize")
(set-info :comment ";; ironsht/src/marshal_v.rs:1456:14: 1456:53 (#1522)")
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::deserialize")
(set-info :comment ";; ironsht/src/marshal_v.rs:1480:14: 1480:89 (#1522)")
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::lemma_serialization_is_not_a_prefix_of")
(set-info :comment ";; ironsht/src/marshal_v.rs:1508:15: 1508:83 (#1522)")
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::lemma_same_views_serialize_the_same")
(set-info :comment ";; ironsht/src/marshal_v.rs:1551:15: 1551:80 (#1522)")
(set-info :comment ";; Function-Def lib::cmessage_v::CSingleMessage::lemma_serialize_injective")
(set-info :comment ";; ironsht/src/marshal_v.rs:1566:15: 1566:70 (#1522)")
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Function-Specs lib::cmessage_v::clone_optional_value")
(declare-fun ens%lib!cmessage_v.clone_optional_value. (core!option.Option. core!option.Option.) Bool)
(assert (forall ((ov! core!option.Option.) (res! core!option.Option.)) (! (= (ens%lib!cmessage_v.clone_optional_value. ov! res!) (and (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL))) (= (lib!cmessage_v.optional_value_view.? (Poly%core!option.Option. ov!)) (lib!cmessage_v.optional_value_view.? (Poly%core!option.Option. res!))))) :pattern ((ens%lib!cmessage_v.clone_optional_value. ov! res!)) )))
(set-info :comment ";; Function-Def lib::cmessage_v::clone_optional_value")
(set-info :comment ";; ironsht/src/cmessage_v.rs:43:1: 43:83 (#0)")
(set-info :comment ";; Function-Specs lib::cmessage_v::is_key_valid")
(declare-fun ens%lib!cmessage_v.is_key_valid. (lib!keys_t.SHTKey. Bool) Bool)
(assert (forall ((key! lib!keys_t.SHTKey.) (b! Bool)) (! (= (ens%lib!cmessage_v.is_key_valid. key! b!) (= b! (lib!app_interface_t.valid_key.? (Poly%lib!keys_t.SHTKey. key!)))) :pattern ((ens%lib!cmessage_v.is_key_valid. key! b!)) )))
(set-info :comment ";; Function-Def lib::cmessage_v::is_key_valid")
(set-info :comment ";; ironsht/src/cmessage_v.rs:53:1: 53:44 (#0)")
(set-info :comment ";; Function-Specs lib::cmessage_v::is_value_valid")
(declare-fun ens%lib!cmessage_v.is_value_valid. (alloc!vec.Vec<u8./allocator_global%.>. Bool) Bool)
(assert (forall ((val! alloc!vec.Vec<u8./allocator_global%.>.) (b! Bool)) (! (= (ens%lib!cmessage_v.is_value_valid. val! b!) (= b! (lib!app_interface_t.valid_value.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. val!))))) :pattern ((ens%lib!cmessage_v.is_value_valid. val! b!)) )))
(set-info :comment ";; Function-Def lib::cmessage_v::is_value_valid")
(set-info :comment ";; ironsht/src/cmessage_v.rs:60:1: 60:49 (#0)")
(set-info :comment ";; Function-Specs lib::cmessage_v::CMessage::view_equal_spec")
(declare-fun ens%lib!cmessage_v.impl&%1.view_equal_spec. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!cmessage_v.impl&%1.view_equal_spec. no%param) (forall ((x$ Poly) (y$ Poly)) (! (=> (and (has_type x$ TYPE%lib!cmessage_v.CMessage.) (has_type y$ TYPE%lib!cmessage_v.CMessage.)) (= (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!cmessage_v.CMessage. x$ y$)) (= (lib!cmessage_v.impl&%1.view.? x$) (lib!cmessage_v.impl&%1.view.? y$)))) :pattern ((lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!cmessage_v.CMessage. x$ y$)) ))) :pattern ((ens%lib!cmessage_v.impl&%1.view_equal_spec. no%param)) )))
(set-info :comment ";; Function-Def lib::cmessage_v::CMessage::view_equal_spec")
(set-info :comment ";; ironsht/src/cmessage_v.rs:87:3: 87:33 (#0)")
(set-info :comment ";; Function-Specs lib::cmessage_v::CMessage::clone_value")
(declare-fun ens%lib!cmessage_v.impl&%1.clone_value. (core!option.Option. core!option.Option.) Bool)
(assert (forall ((value! core!option.Option.) (out! core!option.Option.)) (! (= (ens%lib!cmessage_v.impl&%1.clone_value. value! out!) (and (has_type (Poly%core!option.Option. out!) (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL))) (ite (is-core!option.Option./Some_ value!) (let ((vec$ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. value!)))))) (and (is-core!option.Option./Some_ out!) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. out!)))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. vec$))))) (is-core!option.Option./None_ out!)))) :pattern ((ens%lib!cmessage_v.impl&%1.clone_value. value! out!)) )))
(set-info :comment ";; Function-Def lib::cmessage_v::CMessage::clone_value")
(set-info :comment ";; ironsht/src/cmessage_v.rs:108:3: 108:71 (#0)")
...
(set-info :comment ";; Function-Def lib::cmessage_v::CMessage::clone_up_to_view")
(set-info :comment ";; ironsht/src/cmessage_v.rs:126:3: 126:45 (#0)")
(declare-const c! lib!cmessage_v.CMessage.)
(declare-const self! lib!cmessage_v.CMessage.)
(declare-const tmp%1 lib!keys_t.SHTKey.)
(declare-const k@ lib!keys_t.SHTKey.)
(declare-const tmp%2 lib!keys_t.SHTKey.)
(declare-const tmp%3 core!option.Option.)
(declare-const k$1@ lib!keys_t.SHTKey.)
(declare-const v@ core!option.Option.)
(declare-const tmp%4 lib!keys_t.SHTKey.)
(declare-const tmp%5 core!option.Option.)
(declare-const k$2@ lib!keys_t.SHTKey.)
(declare-const v$1@ core!option.Option.)
(declare-const tmp%6 lib!keys_t.SHTKey.)
(declare-const tmp%7 lib!io_t.EndPoint.)
(declare-const k$3@ lib!keys_t.SHTKey.)
(declare-const id@ lib!io_t.EndPoint.)
(declare-const tmp%8 Poly)
(declare-const tmp%9 lib!io_t.EndPoint.)
(declare-const kr@ lib!keys_t.KeyRange.)
(declare-const recipient@ lib!io_t.EndPoint.)
(declare-const tmp%10 Poly)
(declare-const tmp%11 lib!hashmap_t.CKeyHashMap.)
(declare-const range@ lib!keys_t.KeyRange.)
(declare-const h@ lib!hashmap_t.CKeyHashMap.)
(declare-const tmp%12 lib!cmessage_v.CMessage.)
(declare-const tmp%13 lib!cmessage_v.CMessage.)
(declare-const tmp%14 lib!cmessage_v.CMessage.)
(declare-const tmp%15 lib!cmessage_v.CMessage.)
(declare-const tmp%16 lib!cmessage_v.CMessage.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!cmessage_v.CMessage. self!) TYPE%lib!cmessage_v.CMessage.))
...
(assert (not (or (and (=> (is-lib!cmessage_v.CMessage./GetRequest_ self!) (=> (= k@ (lib!cmessage_v.CMessage./GetRequest/k (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!keys_t.impl&%12.clone. k@ tmp%1) (=> (= tmp%16 (lib!cmessage_v.CMessage./GetRequest (%Poly%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. tmp%1)))) %%switch_label%%0)))) (=> (not (is-lib!cmessage_v.CMessage./GetRequest_ self!)) (or (and (=> (is-lib!cmessage_v.CMessage./SetRequest_ self!) (=> (= k$1@ (lib!cmessage_v.CMessage./SetRequest/k (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= v@ (lib!cmessage_v.CMessage./SetRequest/v (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!keys_t.impl&%12.clone. k$1@ tmp%2) (=> (ens%lib!cmessage_v.impl&%1.clone_value. v@ tmp%3) (=> (= tmp%15 (lib!cmessage_v.CMessage./SetRequest (%Poly%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. tmp%2)) (%Poly%core!option.Option. (Poly%core!option.Option. tmp%3)))) %%switch_label%%1)))))) (=> (not (is-lib!cmessage_v.CMessage./SetRequest_ self!)) (or (and (=> (is-lib!cmessage_v.CMessage./Reply_ self!) (=> (= k$2@ (lib!cmessage_v.CMessage./Reply/k (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= v$1@ (lib!cmessage_v.CMessage./Reply/v (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!keys_t.impl&%12.clone. k$2@ tmp%4) (=> (ens%lib!cmessage_v.impl&%1.clone_value. v$1@ tmp%5) (=> (= tmp%14 (lib!cmessage_v.CMessage./Reply (%Poly%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. tmp%4)) (%Poly%core!option.Option. (Poly%core!option.Option. tmp%5)))) %%switch_label%%2)))))) (=> (not (is-lib!cmessage_v.CMessage./Reply_ self!)) (or (and (=> (is-lib!cmessage_v.CMessage./Redirect_ self!) (=> (= k$3@ (lib!cmessage_v.CMessage./Redirect/k (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= id@ (lib!cmessage_v.CMessage./Redirect/id (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!keys_t.impl&%12.clone. k$3@ tmp%6) (=> (ens%lib!io_t.impl&%4.clone_up_to_view. id@ tmp%7) (=> (= tmp%13 (lib!cmessage_v.CMessage./Redirect (%Poly%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. tmp%6)) (%Poly%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. tmp%7)))) %%switch_label%%3)))))) (=> (not (is-lib!cmessage_v.CMessage./Redirect_ self!)) (or (and (=> (is-lib!cmessage_v.CMessage./Shard_ self!) (=> (= kr@ (lib!cmessage_v.CMessage./Shard/kr (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= recipient@ (lib!cmessage_v.CMessage./Shard/recipient (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!verus_extra.clone_v.VerusClone.clone. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. kr@) tmp%8) (=> (ens%lib!io_t.impl&%4.clone_up_to_view. recipient@ tmp%9) (=> (= tmp%12 (lib!cmessage_v.CMessage./Shard (%Poly%lib!keys_t.KeyRange. tmp%8) (%Poly%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. tmp%9)))) %%switch_label%%4)))))) (=> (not (is-lib!cmessage_v.CMessage./Shard_ self!)) (=> (= range@ (lib!cmessage_v.CMessage./Delegate/range (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (= h@ (lib!cmessage_v.CMessage./Delegate/h (%Poly%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. self!)))) (=> (ens%lib!verus_extra.clone_v.VerusClone.clone. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. range@) tmp%10) (=> (ens%lib!hashmap_t.impl&%0.clone_up_to_view. h@ tmp%11) (=> (= tmp%12 (lib!cmessage_v.CMessage./Delegate (%Poly%lib!keys_t.KeyRange. tmp%10) (%Poly%lib!hashmap_t.CKeyHashMap. (Poly%lib!hashmap_t.CKeyHashMap. tmp%11)))) %%switch_label%%4))))))) (and (not %%switch_label%%4) (=> (= tmp%13 tmp%12) %%switch_label%%3))))) (and (not %%switch_label%%3) (=> (= tmp%14 tmp%13) %%switch_label%%2))))) (and (not %%switch_label%%2) (=> (= tmp%15 tmp%14) %%switch_label%%1))))) (and (not %%switch_label%%1) (=> (= tmp%16 tmp%15) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= c! tmp%16) (=> %%location_label%%0 (= (lib!cmessage_v.impl&%1.view.? (Poly%lib!cmessage_v.CMessage. c!)) (lib!cmessage_v.impl&%1.view.? (Poly%lib!cmessage_v.CMessage. self!)))))))))
(check-sat)
(exit)
