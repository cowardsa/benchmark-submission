...
(assert (has_type (Poly%fun%2. g!) (TYPE%fun%2. $ INT A&. A& B&. B&)))
(assert (forall ((i$ Poly) (a$ Poly)) (! (=> (and (has_type i$ INT) (has_type a$ A&)) (= (%%apply%%1 g! i$ a$) (%%apply%%0 f! a$))) :pattern ((%%apply%%1 g! i$ a$)) )))
...
(assert (not (and (=> (has_type s@ (TYPE%vstd!seq.Seq. A&. A&)) (=> (= s1@ (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s@ (Poly%fun%1. f!))) (=> (= s2@ (vstd!seq_lib.impl&%0.map.? A&. A& B&. B& s@ (Poly%fun%2. g!))) (and (=> (= tmp%1 (= (vstd!seq.Seq.len.? B&. B& s1@) (vstd!seq.Seq.len.? B&. B& s2@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> (has_type idx@ INT) (=> (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? B&. B& s1@))) (=> %%location_label%%1 (= (vstd!seq.Seq.index.? B&. B& s1@ idx@) (vstd!seq.Seq.index.? B&. B& s2@ idx@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? B&. B& s1@))) (= (vstd!seq.Seq.index.? B&. B& s1@ idx$) (vstd!seq.Seq.index.? B&. B& s2@ idx$)))) :pattern ((vstd!seq.Seq.index.? B&. B& s1@ idx$)) :pattern ((vstd!seq.Seq.index.? B&. B& s2@ idx$)) )) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. B&. B&) s1@ s2@)) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> %%location_label%%3 (= s1@ s2@)))))))))) (=> (= s1@ s2@) (=> %%location_label%%4 (= (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s@ (Poly%fun%1. f!)) (vstd!seq_lib.impl&%0.map.? A&. A& B&. B& s@ (Poly%fun%2. g!))))))))) (=> (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. A&. A&)) (= (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s$ (Poly%fun%1. f!)) (vstd!seq_lib.impl&%0.map.? A&. A& B&. B& s$ (Poly%fun%2. g!)))) :pattern ((vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s$ (Poly%fun%1. f!))) :pattern ((vstd!seq_lib.impl&%0.map.? A&. A& B&. B& s$ (Poly%fun%2. g!))) )) (=> %%location_label%%5 (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. A&. A&)) (= (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s$ (Poly%fun%1. f!)) (vstd!seq_lib.impl&%0.map.? A&. A& B&. B& s$ (Poly%fun%2. g!)))) :pattern ((vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s$ (Poly%fun%1. f!))) :pattern ((vstd!seq_lib.impl&%0.map.? A&. A& B&. B& s$ (Poly%fun%2. g!))) )))))))
(check-sat)
(exit)
