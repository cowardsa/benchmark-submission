...
(declare-const j@ Int)
(declare-const tmp%15 %%Function%%)
(declare-const tmp%16 %%Function%%)
(declare-const tmp%17 Bool)
(declare-const sl@ %%Function%%)
(declare-const s@ Poly)
(declare-const old_total_len@ Int)
(declare-const tmp%18 %%Function%%)
(declare-const tmp%19 %%Function%%)
(declare-const tmp%20 Bool)
(declare-const tmp%21 Poly)
(declare-const tmp%22 Int)
(declare-const tmp%23 %%Function%%)
(declare-const tmp%24 %%Function%%)
(declare-const f@ %%Function%%)
(declare-const sl$1@ %%Function%%)
(declare-const s$1@ Poly)
(declare-const tmp%25 Bool)
(declare-const res@0 Bool)
(declare-const i@0 Int)
(declare-const total_len@0 Int)
...
(assert (has_type tmp%2 (UINT SZ)))
(assert (uInv SZ total_len@0))
(declare-fun %%choose%%0 (Type Int Int Dcr Type Poly Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((j$1 Poly)) (! (and (has_type j$1 %%hole%%0) (and (and (<= %%hole%%1 (%I j$1)) (< (%I j$1) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 j$1) %%hole%%6))) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 j$1)) )) (exists ((j$1 Poly)) (! (and (and (has_type j$1 %%hole%%0) (and (and (<= %%hole%%1 (%I j$1)) (< (%I j$1) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 j$1) %%hole%%6))) (= (%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) j$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 j$1))))) :pattern ((%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
(declare-fun %%lambda%%4 (Dcr Type Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (x$ Poly)) (! (= (%%apply%%0 (%%lambda%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) x$) (I (vstd!seq.Seq.len.? %%hole%%2 %%hole%%3 (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$)))) :pattern ((%%apply%%0 (%%lambda%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) x$)))))
(declare-fun %%lambda%%5 (Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (x$ Poly)) (! (= (%%apply%%0 (%%lambda%%5 %%hole%%0 %%hole%%1) x$) (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$)) :pattern ((%%apply%%0 (%%lambda%%5 %%hole%%0 %%hole%%1) x$)))))
(declare-const res@1 Bool)
(declare-const total_len@1 Int)
...
(assert (not (=> (and (<= 0 i@0) (<= i@0 (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL self!))) (=> (=> res@0 (= total_len@0 (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@0)) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))))) (=> (=> res@0 (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@0)) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) ))) (=> (=> res@0 (<= total_len@0 (- (uHi SZ) 1))) (=> (=> (not res@0) (not (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))) (or (and (=> res@0 (=> (ens%alloc!vec.impl&%1.len. T&. T& $ ALLOCATOR_GLOBAL self! tmp%4) (=> (= tmp%5 (< i@0 tmp%4)) %%switch_label%%5))) (=> (not res@0) (=> (= tmp%5 false) %%switch_label%%5))) (and (not %%switch_label%%5) (=> tmp%5 (and (=> %%location_label%%0 res@0) (=> res@0 (or (and (=> res@0 (and (=> %%location_label%%1 (req%vstd!std_specs.vec.vec_index. T&. T& $ ALLOCATOR_GLOBAL self! i@0)) (=> (ens%vstd!std_specs.vec.vec_index. T&. T& $ ALLOCATOR_GLOBAL self! i@0 tmp%6) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. T&. T& tmp%6 tmp%7) (=> (= tmp%8 tmp%7) %%switch_label%%4))))) (=> (not res@0) (=> (= tmp%8 (B false)) %%switch_label%%4))) (and (not %%switch_label%%4) (or (and (=> (%B tmp%8) (and (=> %%location_label%%2 (uInv SZ (Sub (- (uHi SZ) 1) total_len@0))) (and (=> %%location_label%%3 (req%vstd!std_specs.vec.vec_index. T&. T& $ ALLOCATOR_GLOBAL self! i@0)) (=> (ens%vstd!std_specs.vec.vec_index. T&. T& $ ALLOCATOR_GLOBAL self! i@0 tmp%9) (and (=> %%location_label%%4 (req%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%9)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%9 tmp%10) (=> (= tmp%11 (>= (uClip SZ (Sub (- (uHi SZ) 1) total_len@0)) (%I tmp%10))) %%switch_label%%3))))))) (=> (not (%B tmp%8)) (=> (= tmp%11 false) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= res@1 tmp%11) (or (and (=> res@1 (=> (= old_total_len@ total_len@0) (and (=> %%location_label%%5 (req%vstd!std_specs.vec.vec_index. T&. T& $ ALLOCATOR_GLOBAL self! i@0)) (=> (ens%vstd!std_specs.vec.vec_index. T&. T& $ ALLOCATOR_GLOBAL self! i@0 tmp%12) (and (=> %%location_label%%6 (req%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%12)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%12 tmp%13) (and (=> %%location_label%%7 (uInv SZ (Add total_len@0 (%I tmp%13)))) (=> (= total_len@1 (uClip SZ (Add total_len@0 (%I tmp%13)))) (and (=> %%location_label%%8 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (and (=> (has_type x@ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) x@) (or (and (=> (exists ((j$ Poly)) (! (and (has_type j$ INT) (and (and (<= 0 (%I j$)) (< (%I j$) (Sub (vstd!seq.Seq.len.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1))) 1))) (= (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) j$) x@))) :pattern ((vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) j$)) )) (=> (= j@ (%I (as_type (%%choose%%0 INT 0 (Sub (vstd!seq.Seq.len.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1))) 1) T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) x@ T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1))) INT))) (=> (= tmp%14 (= (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (Sub i@1 1))) (I j@)) x@)) (and (=> %%location_label%%9 tmp%14) (=> tmp%14 %%switch_label%%1))))) (=> (not (exists ((j$ Poly)) (! (and (has_type j$ INT) (and (and (<= 0 (%I j$)) (< (%I j$) (Sub (vstd!seq.Seq.len.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1))) 1))) (= (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) j$) x@))) :pattern ((vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) j$)) ))) %%switch_label%%1)) (and (not %%switch_label%%1) (=> %%location_label%%10 (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x@))))))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) x$)) )) (=> (= sl@ (mk_fun (%%lambda%%4 T&. T& $ (UINT 8)))) (=> (= tmp%15 (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))) (=> (= tmp%16 (mk_fun (%%lambda%%2 sl@))) (and (=> %%location_label%%11 (req%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%15 tmp%16)) (=> (ens%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%15 tmp%16) (=> (= s@ (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1))) (and (=> %%location_label%%12 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& s@ 0 sl@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& s@ 0 sl@) (=> (= tmp%17 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& s@ (I 0) (I (Sub (vstd!seq.Seq.len.? T&. T& s@) 1))) (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (Sub i@1 1))))) (and (=> %%location_label%%13 tmp%17) (=> tmp%17 %%switch_label%%0))))))))))))))))))))))) (=> (not res@1) (or (and (=> (< (- (uHi SZ) 1) (Add total_len@0 (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I i@0)))))) (and (=> (= f@ (mk_fun (%%lambda%%5 T&. T&))) (=> (= sl$1@ (mk_fun (%%lambda%%4 T&. T& $ (UINT 8)))) (=> (= s$1@ (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (Add i@0 1)))) (=> (= tmp%18 (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))) (=> (= tmp%19 (mk_fun (%%lambda%%2 sl$1@))) (and (=> %%location_label%%14 (req%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%18 tmp%19)) (=> (ens%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%18 tmp%19) (and (=> %%location_label%%15 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& s$1@ 0 sl$1@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& s$1@ 0 sl$1@) (=> (= tmp%20 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& s$1@ (I 0) (I (Sub (vstd!seq.Seq.len.? T&. T& s$1@) 1))) (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@0)))) (and (=> %%location_label%%16 tmp%20) (=> tmp%20 (=> (= tmp%21 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) (=> (= tmp%22 (Add i@0 1)) (and (=> %%location_label%%17 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. T&. T& $ (UINT 8) tmp%21 tmp%22 0 f@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. T&. T& $ (UINT 8) tmp%21 tmp%22 0 f@) (=> (= tmp%23 (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))) (=> (= tmp%24 (mk_fun (%%lambda%%3 f@ $ (UINT 8)))) (and (=> %%location_label%%18 (req%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%23 tmp%24)) (=> (ens%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%23 tmp%24) (=> %%location_label%%19 (>= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (Add total_len@0 (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I i@0))))))))))))))))))))))))))) (=> (>= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (Add total_len@0 (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I i@0)))))) %%switch_label%%2))) (=> (not (< (- (uHi SZ) 1) (Add total_len@0 (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I i@0))))))) (=> (= tmp%25 (not (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I i@0)))))) (and (=> %%location_label%%20 tmp%25) (=> tmp%25 %%switch_label%%2))))) (and (not %%switch_label%%2) (=> (= i@1 i@0) (=> (= total_len@1 total_len@0) %%switch_label%%0)))))) (and (not %%switch_label%%0) (and (=> %%location_label%%21 (and (<= 0 i@1) (<= i@1 (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL self!)))) (and (=> %%location_label%%22 (=> res@1 (= total_len@1 (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))))))))) (and (=> %%location_label%%23 (=> res@1 (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) )))) (and (=> %%location_label%%24 (=> res@1 (<= total_len@1 (- (uHi SZ) 1)))) (=> %%location_label%%25 (=> (not res@1) (not (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!))))))))))))))))))))))))))))
(check-sat)
(exit)
