...
(assert (has_type tmp%1 (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL)))
(assert (uInv SZ i@0))
...
(assert (not (=> (<= i@0 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!)))))) (=> (= (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@0))) i@0) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@0)) j$)) (lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))) j$))))) :pattern ((lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@0)) j$))) )) (=> (= tmp%3 (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!)))) (=> (ens%alloc!vec.impl&%1.len. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. tmp%3) tmp%2) (=> (< i@0 tmp%2) (=> (= tmp%5 (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!)))) (and (=> %%location_label%%0 (req%vstd!std_specs.vec.vec_index. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. tmp%5) i@0)) (=> (ens%vstd!std_specs.vec.vec_index. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. tmp%5) i@0 tmp%4) (=> (ens%lib!cmessage_v.impl&%2.clone_up_to_view. (%Poly%lib!cmessage_v.CSingleMessage. tmp%4) tmp%6) (=> (ens%alloc!vec.impl&%1.push. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@0) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@1) (Poly%lib!cmessage_v.CSingleMessage. tmp%6)) (and (=> %%location_label%%1 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (and (=> %%location_label%%2 (<= i@1 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))))) (and (=> %%location_label%%3 (= (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@1))) i@1)) (=> %%location_label%%4 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@1)) j$)) (lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))) j$))))) :pattern ((lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@1)) j$))) ))))))))))))))))))))
(check-sat)
(exit)
