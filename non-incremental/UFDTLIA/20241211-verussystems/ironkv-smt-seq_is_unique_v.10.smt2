...
(set-info :comment ";; MODULE 'module seq_is_unique_v'")
...
(set-info :comment ";; Function-Decl lib::seq_is_unique_v::seq_is_unique")
...
(set-info :comment ";; Function-Axioms lib::seq_is_unique_v::seq_is_unique")
...
(set-info :comment ";; Function-Specs lib::seq_is_unique_v::do_vec_u8s_match")
...
(set-info :comment ";; Function-Def lib::seq_is_unique_v::do_vec_u8s_match")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:33:9: 44:10 (#0)")
(set-info :comment ";; Function-Def lib::seq_is_unique_v::do_vec_u8s_match")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:22:5: 22:69 (#0)")
...
(set-info :comment ";; Function-Def lib::seq_is_unique_v::do_end_points_match")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:51:5: 51:74 (#0)")
...
(set-info :comment ";; Function-Def lib::seq_is_unique_v::clone_end_point")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:133:5: 133:66 (#0)")
(set-info :comment ";; Function-Specs lib::seq_is_unique_v::test_unique")
...
(set-info :comment ";; Function-Def lib::seq_is_unique_v::test_unique")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:72:13: 93:14 (#0)")
(set-info :comment ";; Function-Def lib::seq_is_unique_v::test_unique")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:64:9: 95:10 (#0)")
(set-info :comment ";; Function-Def lib::seq_is_unique_v::test_unique")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:59:5: 59:67 (#0)")
(set-info :comment ";; Function-Specs lib::seq_is_unique_v::clone_option_vec_u8")
(declare-fun ens%lib!seq_is_unique_v.clone_option_vec_u8. (core!option.Option. core!option.Option.) Bool)
(assert (forall ((ov! core!option.Option.) (res! core!option.Option.)) (! (= (ens%lib!seq_is_unique_v.clone_option_vec_u8. ov! res!) (and (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL))) (ite (is-core!option.Option./Some_ ov!) (let ((e1$ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ov!)))))) (and (is-core!option.Option./Some_ res!) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. e1$)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. res!))))))) (is-core!option.Option./None_ res!)))) :pattern ((ens%lib!seq_is_unique_v.clone_option_vec_u8. ov! res!)) )))
(set-info :comment ";; Function-Def lib::seq_is_unique_v::clone_option_vec_u8")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:120:5: 120:78 (#0)")
(set-info :comment ";; Function-Specs lib::seq_is_unique_v::singleton_seq_to_set_is_singleton_set")
(declare-fun ens%lib!seq_is_unique_v.singleton_seq_to_set_is_singleton_set. (Dcr Type Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (x! Poly)) (! (= (ens%lib!seq_is_unique_v.singleton_seq_to_set_is_singleton_set. T&. T& x!) (= (vstd!seq_lib.impl&%0.to_set.? T&. T& (vstd!seq.Seq.push.? T&. T& (vstd!seq.Seq.empty.? T&. T&) x!)) (vstd!set.impl&%0.insert.? T&. T& (vstd!set.impl&%0.empty.? T&. T&) x!))) :pattern ((ens%lib!seq_is_unique_v.singleton_seq_to_set_is_singleton_set. T&. T& x!)) )))
(set-info :comment ";; Function-Def lib::seq_is_unique_v::singleton_seq_to_set_is_singleton_set")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:153:5: 153:64 (#0)")
(set-info :comment ";; Function-Specs lib::seq_is_unique_v::endpoints_contain")
(declare-fun ens%lib!seq_is_unique_v.endpoints_contain. (alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. lib!io_t.EndPoint. Bool) Bool)
(assert (forall ((endpoints! alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>.) (endpoint! lib!io_t.EndPoint.) (present! Bool)) (! (= (ens%lib!seq_is_unique_v.endpoints_contain. endpoints! endpoint! present!) (= present! (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. (lib!io_t.abstractify_end_points.? (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. endpoint!)))))) :pattern ((ens%lib!seq_is_unique_v.endpoints_contain. endpoints! endpoint! present!)) )))
(set-info :comment ";; Function-Def lib::seq_is_unique_v::endpoints_contain")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:106:9: 116:10 (#0)")
(declare-const present! Bool)
(declare-const endpoints! alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>.)
(declare-const endpoint! lib!io_t.EndPoint.)
...
(assert (not (=> (and (<= 0 j@0) (<= j@0 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)))) (=> (forall ((k$ Poly)) (! (=> (has_type k$ INT) (=> (and (<= 0 (%I k$)) (< (%I k$) j@0)) (not (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. endpoint!)) (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)) k$)))))) :pattern ((lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)) k$))) )) (=> (ens%alloc!vec.impl&%1.len. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!) tmp%1) (=> (< j@0 tmp%1) (and (=> %%location_label%%0 (req%vstd!std_specs.vec.vec_index. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!) j@0)) (=> (ens%vstd!std_specs.vec.vec_index. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!) j@0 tmp%2) (=> (ens%lib!seq_is_unique_v.do_end_points_match. endpoint! (%Poly%lib!io_t.EndPoint. tmp%2) tmp%3) (or (and (=> tmp%3 (=> (= tmp%4 (= (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (vstd!seq.Seq.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. (lib!io_t.abstractify_end_points.? (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!))) (I j@0))) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. endpoint!)))) (and (=> %%location_label%%1 tmp%4) (=> tmp%4 (=> (= present! true) (=> %%location_label%%2 (= present! (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. (lib!io_t.abstractify_end_points.? (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. endpoint!))))))))))) (=> (not tmp%3) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%3 (uInv SZ (Add j@0 1))) (=> (= j@1 (uClip SZ (Add j@0 1))) (and (=> %%location_label%%4 (and (<= 0 j@1) (<= j@1 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!))))) (=> %%location_label%%5 (forall ((k$ Poly)) (! (=> (has_type k$ INT) (=> (and (<= 0 (%I k$)) (< (%I k$) j@1)) (not (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. endpoint!)) (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)) k$)))))) :pattern ((lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)) k$))) )))))))))))))))))
(check-sat)
(exit)
