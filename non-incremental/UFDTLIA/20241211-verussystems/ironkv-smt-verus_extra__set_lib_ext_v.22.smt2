...
(set-info :comment ";; Function-Specs lib::verus_extra::set_lib_ext_v::map_fold_finite")
(declare-fun req%lib!verus_extra.set_lib_ext_v.map_fold_finite. (Dcr Type Dcr Type Poly %%Function%%) Bool)
(declare-const %%global_location_label%%9 Bool)
(assert (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (s! Poly) (f! %%Function%%)) (! (= (req%lib!verus_extra.set_lib_ext_v.map_fold_finite. A&. A& B&. B& s! f!) (=> %%global_location_label%%9 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%lib!verus_extra.set_lib_ext_v.map_fold_finite. A&. A& B&. B& s! f!)) )))
(declare-fun ens%lib!verus_extra.set_lib_ext_v.map_fold_finite. (Dcr Type Dcr Type Poly %%Function%%) Bool)
(assert (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (s! Poly) (f! %%Function%%)) (! (= (ens%lib!verus_extra.set_lib_ext_v.map_fold_finite. A&. A& B&. B& s! f!) (vstd!set.impl&%0.finite.? B&. B& (lib!verus_extra.set_lib_ext_v.map_fold.? A&. A& B&. B& s! (Poly%fun%1. f!)))) :pattern ((ens%lib!verus_extra.set_lib_ext_v.map_fold_finite. A&. A& B&. B& s! f!)) )))
(set-info :comment ";; Function-Def lib::verus_extra::set_lib_ext_v::map_fold_finite")
(set-info :comment ";; ironsht/src/verus_extra/set_lib_ext_v.rs:244:7: 244:62 (#0)")
(set-info :comment ";; Function-Specs lib::verus_extra::set_lib_ext_v::map_finite")
(declare-fun req%lib!verus_extra.set_lib_ext_v.map_finite. (Dcr Type Dcr Type Poly %%Function%%) Bool)
(declare-const %%global_location_label%%10 Bool)
(assert (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (s! Poly) (f! %%Function%%)) (! (= (req%lib!verus_extra.set_lib_ext_v.map_finite. A&. A& B&. B& s! f!) (=> %%global_location_label%%10 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%lib!verus_extra.set_lib_ext_v.map_finite. A&. A& B&. B& s! f!)) )))
(declare-fun ens%lib!verus_extra.set_lib_ext_v.map_finite. (Dcr Type Dcr Type Poly %%Function%%) Bool)
(assert (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (s! Poly) (f! %%Function%%)) (! (= (ens%lib!verus_extra.set_lib_ext_v.map_finite. A&. A& B&. B& s! f!) (vstd!set.impl&%0.finite.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s! (Poly%fun%1. f!)))) :pattern ((ens%lib!verus_extra.set_lib_ext_v.map_finite. A&. A& B&. B& s! f!)) )))
(set-info :comment ";; Function-Def lib::verus_extra::set_lib_ext_v::map_finite")
(set-info :comment ";; ironsht/src/verus_extra/set_lib_ext_v.rs:258:1: 258:61 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::set_lib_ext_v::map_set_finite_auto")
(set-info :comment ";; ironsht/src/verus_extra/set_lib_ext_v.rs:268:1: 268:41 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::set_lib_ext_v::lemma_to_set_singleton_auto")
(set-info :comment ";; ironsht/src/verus_extra/set_lib_ext_v.rs:277:1: 277:46 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::set_lib_ext_v::lemma_map_values_singleton_auto")
(set-info :comment ";; ironsht/src/verus_extra/set_lib_ext_v.rs:286:1: 286:53 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::set_lib_ext_v::lemma_map_set_singleton_auto")
(set-info :comment ";; ironsht/src/verus_extra/set_lib_ext_v.rs:292:1: 292:50 (#0)")
(declare-const A&. Dcr)
...
(assert (not (and (=> (has_type x@ A&) (=> (has_type f@ (TYPE%fun%1. A&. A& B&. B&)) (=> (= tmp%1 (vstd!set.impl&%0.contains.? A&. A& (vstd!set.impl&%0.insert.? A&. A& (vstd!set.impl&%0.empty.? A&. A&) x@) x@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (ext_eq false (TYPE%vstd!set.Set. B&. B&) (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.insert.? A&. A& (vstd!set.impl&%0.empty.? A&. A&) x@) f@) (vstd!set.impl&%0.insert.? B&. B& (vstd!set.impl&%0.empty.? B&. B&) (%%apply%%0 (%Poly%fun%1. f@) x@))))))))) (=> (forall ((x$ Poly) (f$ Poly)) (! (=> (and (has_type x$ A&) (has_type f$ (TYPE%fun%1. A&. A& B&. B&))) (ext_eq false (TYPE%vstd!set.Set. B&. B&) (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.insert.? A&. A& (vstd!set.impl&%0.empty.? A&. A&) x$) f$) (vstd!set.impl&%0.insert.? B&. B& (vstd!set.impl&%0.empty.? B&. B&) (%%apply%%0 (%Poly%fun%1. f$) x$)))) :pattern ((vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.insert.? A&. A& (vstd!set.impl&%0.empty.? A&. A&) x$) f$)) )) (=> %%location_label%%2 (forall ((x$ Poly) (f$ Poly)) (! (=> (and (has_type x$ A&) (has_type f$ (TYPE%fun%1. A&. A& B&. B&))) (= (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.insert.? A&. A& (vstd!set.impl&%0.empty.? A&. A&) x$) f$) (vstd!set.impl&%0.insert.? B&. B& (vstd!set.impl&%0.empty.? B&. B&) (%%apply%%0 (%Poly%fun%1. f$) x$)))) :pattern ((vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.insert.? A&. A& (vstd!set.impl&%0.empty.? A&. A&) x$) f$)) )))))))
(check-sat)
(exit)
