...
(set-info :comment ";; Function-Def lib::seq_is_unique_v::endpoints_contain")
(set-info :comment ";; ironsht/src/seq_is_unique_v.rs:102:5: 102:95 (#0)")
...
(assert (not (=> (= j@0 0) (and (=> %%location_label%%0 (and (<= 0 j@0) (<= j@0 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!))))) (and (=> %%location_label%%1 (forall ((k$ Poly)) (! (=> (has_type k$ INT) (=> (and (<= 0 (%I k$)) (< (%I k$) j@0)) (not (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. endpoint!)) (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)) k$)))))) :pattern ((lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)) k$))) ))) (=> (uInv SZ j@1) (=> (and (<= 0 j@1) (<= j@1 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)))) (=> (forall ((k$ Poly)) (! (=> (has_type k$ INT) (=> (and (<= 0 (%I k$)) (< (%I k$) j@1)) (not (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. endpoint!)) (lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)) k$)))))) :pattern ((lib!io_t.impl&%4.view.? (vstd!seq.Seq.index.? $ TYPE%lib!io_t.EndPoint. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!)) k$))) )) (=> (ens%alloc!vec.impl&%1.len. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!) tmp%1) (=> (not (< j@1 tmp%1)) (=> (= present! false) (=> %%location_label%%2 (= present! (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. (lib!io_t.abstractify_end_points.? (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. endpoints!))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. endpoint!)))))))))))))))))
(check-sat)
(exit)
