...
(declare-const tmp%1 lib!delegation_map_t.AbstractDelegationMap.)
(declare-const tmp%2 Poly)
(declare-const tmp%3 Poly)
(declare-const tmp%4 Poly)
(declare-const m@ lib!message_t.Message.)
...
(assert (not (=> (is-lib!single_message_t.SingleMessage./Message_ (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))) (=> (lib!delegation_map_t.impl&%0.is_complete.? (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (or (and (=> (is-lib!message_t.Message./Delegate_ (%Poly%lib!message_t.Message. (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))))) (or (and (=> (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. (lib!host_protocol_t.AbstractConstants./AbstractConstants/host_ids (%Poly%lib!host_protocol_t.AbstractConstants. (Poly%lib!host_protocol_t.AbstractConstants. (lib!host_protocol_t.AbstractHostState./AbstractHostState/constants (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. pkt!)))) (=> (= m@ (%Poly%lib!message_t.Message. (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))))) (=> (= tmp%2 (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (=> (= tmp%3 (Poly%lib!keys_t.KeyRange. (lib!message_t.Message./Delegate/range (%Poly%lib!message_t.Message. (Poly%lib!message_t.Message. m@))))) (=> (= tmp%4 (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!host_protocol_t.AbstractConstants./AbstractConstants/me (%Poly%lib!host_protocol_t.AbstractConstants. (Poly%lib!host_protocol_t.AbstractConstants. (lib!host_protocol_t.AbstractHostState./AbstractHostState/constants (%Poly%lib!host_protocol_t.AbstractHostState. pre!))))))) (and (=> %%location_label%%0 (req%lib!delegation_map_t.impl&%0.update. tmp%2 tmp%3 tmp%4)) (=> (= tmp%1 (lib!delegation_map_t.impl&%0.update.? (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!))) (Poly%lib!keys_t.KeyRange. (lib!message_t.Message./Delegate/range (%Poly%lib!message_t.Message. (Poly%lib!message_t.Message. m@)))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!host_protocol_t.AbstractConstants./AbstractConstants/me (%Poly%lib!host_protocol_t.AbstractConstants. (Poly%lib!host_protocol_t.AbstractConstants. (lib!host_protocol_t.AbstractHostState./AbstractHostState/constants (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))))))) (=> (= tmp%5 (and (and (= (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. post!)) tmp%1) (= (lib!host_protocol_t.AbstractHostState./AbstractHostState/h (%Poly%lib!host_protocol_t.AbstractHostState. post!)) (lib!host_protocol_t.bulk_update_hashtable.? (Poly%vstd!map.Map<lib!keys_t.SHTKey./vstd!seq.Seq<u8.>.>. (lib!host_protocol_t.AbstractHostState./AbstractHostState/h (%Poly%lib!host_protocol_t.AbstractHostState. pre!))) (Poly%lib!keys_t.KeyRange. (lib!message_t.Message./Delegate/range (%Poly%lib!message_t.Message. (Poly%lib!message_t.Message. m@)))) (Poly%vstd!map.Map<lib!keys_t.SHTKey./vstd!seq.Seq<u8.>.>. (lib!message_t.Message./Delegate/h (%Poly%lib!message_t.Message. (Poly%lib!message_t.Message. m@))))))) (= (lib!host_protocol_t.AbstractHostState./AbstractHostState/num_delegations (%Poly%lib!host_protocol_t.AbstractHostState. post!)) (Add (lib!host_protocol_t.AbstractHostState./AbstractHostState/num_delegations (%Poly%lib!host_protocol_t.AbstractHostState. pre!)) 1)))) %%switch_label%%1)))))))) (=> (not (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. (lib!host_protocol_t.AbstractConstants./AbstractConstants/host_ids (%Poly%lib!host_protocol_t.AbstractConstants. (Poly%lib!host_protocol_t.AbstractConstants. (lib!host_protocol_t.AbstractHostState./AbstractHostState/constants (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. pkt!))))) (=> (= tmp%5 (and (and (= (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. post!)) (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!))) (= (lib!host_protocol_t.AbstractHostState./AbstractHostState/h (%Poly%lib!host_protocol_t.AbstractHostState. post!)) (lib!host_protocol_t.AbstractHostState./AbstractHostState/h (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (= (lib!host_protocol_t.AbstractHostState./AbstractHostState/num_delegations (%Poly%lib!host_protocol_t.AbstractHostState. post!)) (lib!host_protocol_t.AbstractHostState./AbstractHostState/num_delegations (%Poly%lib!host_protocol_t.AbstractHostState. pre!))))) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%6 tmp%5) %%switch_label%%0)))) (=> (not (is-lib!message_t.Message./Delegate_ (%Poly%lib!message_t.Message. (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!)))))))) (=> (= tmp%6 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
