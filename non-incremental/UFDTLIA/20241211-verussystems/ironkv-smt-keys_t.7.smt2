...
(assert (has_type self! (TYPE%lib!keys_t.KeyRange. K&. K&)))
(assert (tr_bound%lib!verus_extra.clone_v.VerusClone. K&. K&))
(assert (tr_bound%lib!keys_t.KeyTrait. K&. K&))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= tmp%2 (Poly%lib!keys_t.KeyIterator. (lib!keys_t.KeyRange./KeyRange/lo (%Poly%lib!keys_t.KeyRange. self!)))) (=> (ens%lib!verus_extra.clone_v.VerusClone.clone. $ (TYPE%lib!keys_t.KeyIterator. K&. K&) tmp%2 tmp%1) (=> (= tmp%4 (Poly%lib!keys_t.KeyIterator. (lib!keys_t.KeyRange./KeyRange/hi (%Poly%lib!keys_t.KeyRange. self!)))) (=> (ens%lib!verus_extra.clone_v.VerusClone.clone. $ (TYPE%lib!keys_t.KeyIterator. K&. K&) tmp%4 tmp%3) (=> (= %return! (Poly%lib!keys_t.KeyRange. (lib!keys_t.KeyRange./KeyRange (%Poly%lib!keys_t.KeyIterator. tmp%1) (%Poly%lib!keys_t.KeyIterator. tmp%3)))) (=> %%location_label%%0 (= %return! self!)))))))))
(check-sat)
(exit)
