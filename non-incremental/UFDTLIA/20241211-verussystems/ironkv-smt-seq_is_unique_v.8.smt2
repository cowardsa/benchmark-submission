...
(declare-const ov! core!option.Option.)
...
(assert (has_type (Poly%core!option.Option. ov!) (TYPE%core!option.Option. (REF $) (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL))))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (or (and (=> (is-core!option.Option./Some_ ov!) (=> (= e1@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ov!))))) (=> (ens%lib!args_t.clone_vec_u8. e1@ tmp%1) (=> (= tmp%2 (core!option.Option./Some (Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%1))) %%switch_label%%0)))) (=> (not (is-core!option.Option./Some_ ov!)) (=> (= tmp%2 core!option.Option./None) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= res! tmp%2) (=> %%location_label%%0 (ite (is-core!option.Option./Some_ ov!) (let ((e1$ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ov!)))))) (and (is-core!option.Option./Some_ res!) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. e1$)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. res!))))))) (is-core!option.Option./None_ res!))))))))
(check-sat)
(exit)
