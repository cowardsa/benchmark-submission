...
(set-info :comment ";; Function-Def lib::verus_extra::set_lib_ext_v::lemma_map_seq_singleton_auto")
(set-info :comment ";; ironsht/src/verus_extra/set_lib_ext_v.rs:301:1: 301:50 (#0)")
(declare-const A&. Dcr)
...
(assert (not (=> %%location_label%%0 (forall ((x$ Poly) (f$ Poly)) (! (=> (and (has_type x$ A&) (has_type f$ (TYPE%fun%1. A&. A& B&. B&))) (ext_eq false (TYPE%vstd!seq.Seq. B&. B&) (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& (vstd!seq.Seq.push.? A&. A& (vstd!seq.Seq.empty.? A&. A&) x$) f$) (vstd!seq.Seq.push.? B&. B& (vstd!seq.Seq.empty.? B&. B&) (%%apply%%0 (%Poly%fun%1. f$) x$)))) :pattern ((vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& (vstd!seq.Seq.push.? A&. A& (vstd!seq.Seq.empty.? A&. A&) x$) f$)) )))))
(check-sat)
(exit)
