...
(assert (not (=> (has_type (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1) (TYPE%lib!delegation_map_v.StrictlyOrderedMap. K&. K&)) (=> (lib!delegation_map_v.impl&%3.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1)) (=> (and (<= 0 start@0) (<= start@0 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1)))))))) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) start@0)) (lib!delegation_map_v.impl&%2.above_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. lo!) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))) j$)))) :pattern ((vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))) j$)) )) (=> (= tmp%2 (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1)))) (=> (ens%lib!delegation_map_v.impl&%1.len. K&. K& tmp%2 tmp%1) (or (and (=> (< start@0 tmp%1) (=> (= tmp%4 (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1)))) (and (=> %%location_label%%0 (req%lib!delegation_map_v.impl&%1.index. K&. K& tmp%4 start@0)) (=> (ens%lib!delegation_map_v.impl&%1.index. K&. K& tmp%4 start@0 tmp%3) (=> (ens%lib!delegation_map_v.impl&%2.above. K&. K& lo! tmp%3 tmp%5) (=> (= tmp%6 tmp%5) %%switch_label%%0)))))) (=> (not (< start@0 tmp%1)) (=> (= tmp%6 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> tmp%6 (and (=> %%location_label%%1 (uInv SZ (Add start@0 1))) (=> (= start@1 (uClip SZ (Add start@0 1))) (and (=> %%location_label%%2 (lib!delegation_map_v.impl&%3.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))) (and (=> %%location_label%%3 (and (<= 0 start@1) (<= start@1 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))))))) (=> %%location_label%%4 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) start@1)) (lib!delegation_map_v.impl&%2.above_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. lo!) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))) j$)))) :pattern ((vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))) j$)) ))))))))))))))))))
(check-sat)
(exit)
