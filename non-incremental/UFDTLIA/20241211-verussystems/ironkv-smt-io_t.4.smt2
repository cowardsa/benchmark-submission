...
(assert (forall ((pre%self! lib!io_t.NetClient.) (recipient! lib!io_t.EndPoint.) (message! alloc!vec.Vec<u8./allocator_global%.>.)) (! (= (req%lib!io_t.impl&%7.send. pre%self! recipient! message!) (=> %%global_location_label%%4 (not (is-lib!io_t.State./Error_ (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. pre%self!)))))) :pattern ((req%lib!io_t.impl&%7.send. pre%self! recipient! message!)) )))
...
(set-info :comment ";; Function-Def lib::io_t::NetClient::send")
(set-info :comment ";; ironsht/src/io_t.rs:403:5: 403:109 (#0)")
...
(assert (not (is-lib!io_t.State./Error_ (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. self!@0)))))
