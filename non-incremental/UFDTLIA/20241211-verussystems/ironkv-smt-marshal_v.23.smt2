...
(assert (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%core!option.Option. T&. T&) self! other!)))
...
(assert (not (=> (= tmp%%@ (tuple%2./tuple%2 self! other!)) (or (and (=> (and (and (is-tuple%2./tuple%2_ tmp%%@) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (=> (= s@ (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (=> (= o@ (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& s@ o@)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& s@ o@) %%switch_label%%0))))) (=> (not (and (and (is-tuple%2./tuple%2_ tmp%%@) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%1 (= (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%core!option.Option. T&. T&) self!) (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%core!option.Option. T&. T&) other!))) (=> %%location_label%%2 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%core!option.Option. T&. T&) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%core!option.Option. T&. T&) other!)))))))))
(check-sat)
(exit)
