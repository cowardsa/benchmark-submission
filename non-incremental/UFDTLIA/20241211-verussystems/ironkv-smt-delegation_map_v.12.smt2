...
(assert (< i! (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!)))))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%2 (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!)))) (and (=> %%location_label%%0 (req%vstd!std_specs.vec.vec_index. K&. K& $ ALLOCATOR_GLOBAL tmp%2 i!)) (=> (ens%vstd!std_specs.vec.vec_index. K&. K& $ ALLOCATOR_GLOBAL tmp%2 i! tmp%1) (=> (ens%lib!verus_extra.clone_v.VerusClone.clone. K&. K& tmp%1 tmp%3) (=> (= k! tmp%3) (=> %%location_label%%1 (= k! (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!)) (I i!)))))))))))
(check-sat)
(exit)
