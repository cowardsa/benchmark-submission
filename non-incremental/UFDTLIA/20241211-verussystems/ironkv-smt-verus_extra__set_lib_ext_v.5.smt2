...
(declare-const sets1@ Poly)
(declare-const sets2@ Poly)
(assert fuel_defaults)
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> (has_type sets1@ (TYPE%vstd!set.Set. $ (TYPE%vstd!set.Set. A&. A&))) (=> (has_type sets2@ (TYPE%vstd!set.Set. $ (TYPE%vstd!set.Set. A&. A&))) (=> (ens%lib!verus_extra.set_lib_ext_v.lemma_flatten_sets_union. A&. A& sets1@ sets2@) (=> %%location_label%%0 (= (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& (vstd!set.impl&%0.union.? $ (TYPE%vstd!set.Set. A&. A&) sets1@ sets2@)) (vstd!set.impl&%0.union.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets1@) (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets2@))))))) (=> (forall ((sets1$ Poly) (sets2$ Poly)) (! (=> (and (has_type sets1$ (TYPE%vstd!set.Set. $ (TYPE%vstd!set.Set. A&. A&))) (has_type sets2$ (TYPE%vstd!set.Set. $ (TYPE%vstd!set.Set. A&. A&)))) (= (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& (vstd!set.impl&%0.union.? $ (TYPE%vstd!set.Set. A&. A&) sets1$ sets2$)) (vstd!set.impl&%0.union.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets1$) (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets2$)))) :pattern ((lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& (vstd!set.impl&%0.union.? $ (TYPE%vstd!set.Set. A&. A&) sets1$ sets2$))) )) (=> %%location_label%%1 (forall ((sets1$ Poly) (sets2$ Poly)) (! (=> (and (has_type sets1$ (TYPE%vstd!set.Set. $ (TYPE%vstd!set.Set. A&. A&))) (has_type sets2$ (TYPE%vstd!set.Set. $ (TYPE%vstd!set.Set. A&. A&)))) (= (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& (vstd!set.impl&%0.union.? $ (TYPE%vstd!set.Set. A&. A&) sets1$ sets2$)) (vstd!set.impl&%0.union.? A&. A& (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets1$) (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& sets2$)))) :pattern ((lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& (vstd!set.impl&%0.union.? $ (TYPE%vstd!set.Set. A&. A&) sets1$ sets2$))) )))))))
(check-sat)
(exit)
