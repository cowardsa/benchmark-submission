...
(declare-const i! Int)
(declare-const self!@0 lib!delegation_map_v.StrictlyOrderedVec.)
...
(declare-const new_s@ Poly)
(declare-const old_s@ Poly)
(declare-const s1@ Poly)
(declare-const s2@ Poly)
(declare-const index@0 Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0) (TYPE%lib!delegation_map_v.StrictlyOrderedVec. K&. K&)))
(assert (has_type k! K&))
(assert (tr_bound%lib!keys_t.KeyTrait. K&. K&))
(assert (tr_bound%lib!verus_extra.clone_v.VerusClone. K&. K&))
(assert (lib!delegation_map_v.impl&%1.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)))
(assert (not (vstd!seq_lib.impl&%0.contains.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) k!)))
(declare-fun %%choose%%2 (Type Int Int Dcr Type Poly Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((i$1 Poly)) (! (and (has_type i$1 %%hole%%0) (and (and (<= %%hole%%1 (%I i$1)) (< (%I i$1) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$1) %%hole%%6))) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 i$1)) )) (exists ((i$1 Poly)) (! (and (and (has_type i$1 %%hole%%0) (and (and (<= %%hole%%1 (%I i$1)) (< (%I i$1) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$1) %%hole%%6))) (= (%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) i$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 i$1))))) :pattern ((%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
(declare-const index@1 Int)
(declare-const self!@1 lib!delegation_map_v.StrictlyOrderedVec.)
...
(assert (not (=> (= index@0 0) (and (=> %%location_label%%0 (and (<= 0 index@0) (<= index@0 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)))))) (and (=> %%location_label%%1 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) index@0)) (lib!delegation_map_v.impl&%0.lt.? (lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) i$) k!)))) :pattern ((lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) i$) k!)) ))) (=> (uInv SZ index@1) (=> (and (<= 0 index@1) (<= index@1 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) index@1)) (lib!delegation_map_v.impl&%0.lt.? (lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) i$) k!)))) :pattern ((lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) i$) k!)) )) (=> (= tmp%2 (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)))) (=> (ens%alloc!vec.impl&%1.len. K&. K& $ ALLOCATOR_GLOBAL tmp%2 tmp%1) (or (and (=> (< index@1 tmp%1) (=> (= tmp%4 (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)))) (and (=> %%location_label%%2 (req%vstd!std_specs.vec.vec_index. K&. K& $ ALLOCATOR_GLOBAL tmp%4 index@1)) (=> (ens%vstd!std_specs.vec.vec_index. K&. K& $ ALLOCATOR_GLOBAL tmp%4 index@1 tmp%3) (and (=> %%location_label%%3 (req%lib!keys_t.KeyTrait.cmp. K&. K& tmp%3 k!)) (=> (ens%lib!keys_t.KeyTrait.cmp. K&. K& tmp%3 k! tmp%5) (=> (ens%lib!delegation_map_v.impl&%0.is_lt. (%Poly%lib!keys_t.Ordering. tmp%5) tmp%6) (=> (= tmp%7 tmp%6) %%switch_label%%2)))))))) (=> (not (< index@1 tmp%1)) (=> (= tmp%7 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (not tmp%7) (and (=> %%location_label%%4 (req%alloc!vec.impl&%1.insert. K&. K& $ ALLOCATOR_GLOBAL (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) index@1 k!)) (=> (has_type (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1) (TYPE%lib!delegation_map_v.StrictlyOrderedVec. K&. K&)) (=> (ens%alloc!vec.impl&%1.insert. K&. K& $ ALLOCATOR_GLOBAL (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))) index@1 k!) (and (=> (has_type m@ INT) (=> (has_type n@ INT) (=> (and (and (<= 0 (%I m@)) (< (%I m@) (%I n@))) (< (%I n@) (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))))) (=> (ens%lib!keys_t.KeyTrait.cmp_properties. K&. K&) (=> %%location_label%%5 (lib!delegation_map_v.impl&%0.lt.? (lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) m@) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) n@)))))))) (=> (forall ((m$ Poly) (n$ Poly)) (! (=> (and (has_type m$ INT) (has_type n$ INT)) (=> (and (and (<= 0 (%I m$)) (< (%I m$) (%I n$))) (< (%I n$) (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))))) (lib!delegation_map_v.impl&%0.lt.? (lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) m$) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) n$))))) :pattern ((lib!delegation_map_v.impl&%0.lt.? (lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) m$) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) n$)))) )) (and (=> (= new_s@ (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)))) (=> (= old_s@ (vstd!set.impl&%0.insert.? K&. K& (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) k!)) (=> (= tmp%8 (= (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) (I index@1)) k!)) (and (=> %%location_label%%6 tmp%8) (=> tmp%8 (and (=> (has_type e@ K&) (=> (vstd!set.impl&%0.contains.? K&. K& old_s@ e@) (or (and (=> (= e@ k!) %%switch_label%%0) (=> (not (= e@ k!)) (=> (= i@ (%I (as_type (%%choose%%2 INT 0 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) e@ K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) INT))) (or (and (=> (< i@ index@1) (=> (= tmp%9 (= (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) (I i@)) e@)) (and (=> %%location_label%%7 tmp%9) (=> tmp%9 %%switch_label%%1)))) (=> (not (< i@ index@1)) (=> (= tmp%10 (= (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) (I (Add i@ 1))) e@)) (and (=> %%location_label%%8 tmp%10) (=> tmp%10 %%switch_label%%1))))) (and (not %%switch_label%%1) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%9 (vstd!set.impl&%0.contains.? K&. K& new_s@ e@)))))) (=> (forall ((e$ Poly)) (! (=> (has_type e$ K&) (=> (vstd!set.impl&%0.contains.? K&. K& old_s@ e$) (vstd!set.impl&%0.contains.? K&. K& new_s@ e$))) :pattern ((vstd!set.impl&%0.contains.? K&. K& old_s@ e$)) :pattern ((vstd!set.impl&%0.contains.? K&. K& new_s@ e$)) )) (=> (= s1@ new_s@) (=> (= s2@ old_s@) (and (and (=> (has_type elem@ K&) (=> %%location_label%%10 (and (=> (vstd!set.impl&%0.contains.? K&. K& s1@ elem@) (vstd!set.impl&%0.contains.? K&. K& s2@ elem@)) (=> (vstd!set.impl&%0.contains.? K&. K& s2@ elem@) (vstd!set.impl&%0.contains.? K&. K& s1@ elem@))))) (=> (forall ((elem$ Poly)) (! (=> (has_type elem$ K&) (and (=> (vstd!set.impl&%0.contains.? K&. K& s1@ elem$) (vstd!set.impl&%0.contains.? K&. K& s2@ elem$)) (=> (vstd!set.impl&%0.contains.? K&. K& s2@ elem$) (vstd!set.impl&%0.contains.? K&. K& s1@ elem$)))) :pattern ((vstd!set.impl&%0.contains.? K&. K& s1@ elem$)) :pattern ((vstd!set.impl&%0.contains.? K&. K& s2@ elem$)) )) (=> (= tmp%11 (ext_eq false (TYPE%vstd!set.Set. K&. K&) s1@ s2@)) (and (=> %%location_label%%11 tmp%11) (=> tmp%11 (=> %%location_label%%12 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> %%location_label%%13 (= (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))) (vstd!set.impl&%0.insert.? K&. K& (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) k!)))))))))))))) (=> (= (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))) (vstd!set.impl&%0.insert.? K&. K& (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) k!)) (=> (= i! index@1) (and (=> %%location_label%%14 (lib!delegation_map_v.impl&%1.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))) (and (=> %%location_label%%15 (= (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))) (nClip (Add (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) 1)))) (and (=> %%location_label%%16 (and (<= 0 i!) (< i! (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)))))) (and (=> %%location_label%%17 (= (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) (vstd!seq_lib.impl&%0.insert.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) (I i!) k!))) (=> %%location_label%%18 (= (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))) (vstd!set.impl&%0.insert.? K&. K& (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) k!))))))))))))))))))))))))))))
(check-sat)
(exit)
