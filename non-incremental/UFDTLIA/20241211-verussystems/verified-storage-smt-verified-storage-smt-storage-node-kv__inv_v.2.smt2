...
(declare-const durable_store! lib!kv.durable.durablespec_t.DurableKvStoreView.)
(declare-const volatile_index! lib!kv.volatile.volatilespec_t.VolatileKvIndexView.)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Bool)
(declare-const tmp%3 Poly)
(assert fuel_defaults)
(assert (has_type (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!) (TYPE%lib!kv.durable.durablespec_t.DurableKvStoreView. K&. K& I&. I& L&. L& E&. E&)))
(assert (has_type (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. volatile_index!) (TYPE%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. K&. K&)))
...
(assert (lib!kv.durable.durablespec_t.impl&%2.empty.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!)))
(assert (lib!kv.durable.durablespec_t.impl&%2.valid.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!)))
(assert (vstd!set.impl&%0.finite.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!kv.durable.durablespec_t.DurableKvStoreViewEntry. K&. K& I&. I& L&. L&) (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/contents (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!))))))
(assert (lib!kv.volatile.volatilespec_t.impl&%1.empty.? K&. K& (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. volatile_index!)))
...
(assert (not (=> (= tmp%1 (vstd!set_lib.impl&%0.is_empty.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!kv.durable.durablespec_t.DurableKvStoreViewEntry. K&. K& I&. I& L&. L&) (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/contents (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!)))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (vstd!set_lib.impl&%0.is_empty.? $ INT (vstd!map.impl&%0.dom.? $ INT $ (TYPE%lib!kv.durable.durablespec_t.DurableKvStoreViewEntry. K&. K& I&. I& L&. L&) (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/contents (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!)))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (lib!kv.durable.durablespec_t.DurableKvStoreView./DurableKvStoreView/contents (%Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!)))) (and (=> %%location_label%%2 (req%lib!kv.inv_v.lemma_empty_map_contains_no_keys. $ INT $ (TYPE%lib!kv.durable.durablespec_t.DurableKvStoreViewEntry. K&. K& I&. I& L&. L&) tmp%3)) (=> (ens%lib!kv.inv_v.lemma_empty_map_contains_no_keys. $ INT $ (TYPE%lib!kv.durable.durablespec_t.DurableKvStoreViewEntry. K&. K& I&. I& L&. L&) tmp%3) (=> %%location_label%%3 (lib!kv.durable.durablespec_t.impl&%2.matches_volatile_index.? K&. K& I&. I& L&. L& E&. E& (Poly%lib!kv.durable.durablespec_t.DurableKvStoreView. durable_store!) (Poly%lib!kv.volatile.volatilespec_t.VolatileKvIndexView. volatile_index!))))))))))))))
(check-sat)
(exit)
