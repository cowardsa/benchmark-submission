...
(declare-const region1! Poly)
(declare-const region2! Poly)
(assert fuel_defaults)
(assert (has_type region1! TYPE%lib!definitions_t.MemRegion.))
(assert (has_type region2! TYPE%lib!definitions_t.MemRegion.))
(assert (not true))
(check-sat)
(exit)
