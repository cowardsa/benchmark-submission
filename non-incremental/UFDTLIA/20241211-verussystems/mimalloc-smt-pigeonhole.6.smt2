...
(set-info :comment ";; MODULE 'module pigeonhole'")
...
(set-info :comment ";; Function-Decl lib::pigeonhole::set_nat_range")
...
(set-info :comment ";; Function-Axioms lib::pigeonhole::set_nat_range")
...
(set-info :comment ";; Function-Specs lib::pigeonhole::singleton_set_unique_elt")
...
(set-info :comment ";; Function-Def lib::pigeonhole::singleton_set_unique_elt")
(set-info :comment ";; pigeonhole.rs:10:7: 10:58 (#0)")
(set-info :comment ";; Function-Specs lib::pigeonhole::set_mismatch")
...
(set-info :comment ";; Function-Def lib::pigeonhole::set_mismatch")
(set-info :comment ";; pigeonhole.rs:26:7: 26:61 (#0)")
(set-info :comment ";; Function-Specs lib::pigeonhole::lemma_nat_range")
...
(set-info :comment ";; Function-Def lib::pigeonhole::lemma_nat_range")
(set-info :comment ";; pigeonhole.rs:64:1: 64:47 (#0)")
(set-info :comment ";; Function-Specs lib::pigeonhole::nat_set_size")
(declare-fun req%lib!pigeonhole.nat_set_size. (vstd!set.Set<nat.>. Int) Bool)
(declare-const %%global_location_label%%13 Bool)
(assert (forall ((s! vstd!set.Set<nat.>.) (bound! Int)) (! (= (req%lib!pigeonhole.nat_set_size. s! bound!) (=> %%global_location_label%%13 (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (= (and (<= 0 (%I i$)) (< (%I i$) bound!)) (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s!) i$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s!) i$)) )))) :pattern ((req%lib!pigeonhole.nat_set_size. s! bound!)) )))
(declare-fun ens%lib!pigeonhole.nat_set_size. (vstd!set.Set<nat.>. Int) Bool)
(assert (forall ((s! vstd!set.Set<nat.>.) (bound! Int)) (! (= (ens%lib!pigeonhole.nat_set_size. s! bound!) (and (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. s!)) (= (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. s!)) bound!))) :pattern ((ens%lib!pigeonhole.nat_set_size. s! bound!)) )))
(set-info :comment ";; Function-Def lib::pigeonhole::nat_set_size")
(set-info :comment ";; pigeonhole.rs:82:7: 82:45 (#0)")
(set-info :comment ";; Function-Specs lib::pigeonhole::pigeonhole_missing_idx_implies_double_helper")
(declare-fun req%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. (vstd!map.Map<nat./nat.>. Int Int vstd!set.Set<nat.>. Int) Bool)
...
(assert (forall ((m! vstd!map.Map<nat./nat.>.) (missing! Int) (len! Int) (prev_vals! vstd!set.Set<nat.>.) (k! Int)) (! (= (req%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. m! missing! len! prev_vals! k!) (and (=> %%global_location_label%%14 (>= len! 2)) (=> %%global_location_label%%15 (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (= (and (<= 0 (%I i$)) (< (%I i$) len!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$)) ))) (=> %%global_location_label%%16 (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$) (and (let ((tmp%%$ (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) i$)))) (and (<= 0 tmp%%$) (< tmp%%$ len!))) (not (= (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) i$)) missing!))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$)) ))) (=> %%global_location_label%%17 (and (<= 0 missing!) (< missing! len!))) (=> %%global_location_label%%18 (and (<= 0 k!) (< k! len!))) (=> %%global_location_label%%19 (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!))) (=> %%global_location_label%%20 (= (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!)) k!)) (=> %%global_location_label%%21 (forall ((elt$ Poly)) (! (=> (has_type elt$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) elt$) (exists ((j$ Poly)) (! (and (has_type j$ NAT) (and (and (<= 0 (%I j$)) (< (%I j$) k!)) (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) j$) elt$))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) j$)) )))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) elt$)) ))))) :pattern ((req%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. m! missing! len! prev_vals! k!)) )))
(declare-fun ens%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. (vstd!map.Map<nat./nat.>. Int Int vstd!set.Set<nat.>. Int Int) Bool)
(assert (forall ((m! vstd!map.Map<nat./nat.>.) (missing! Int) (len! Int) (prev_vals! vstd!set.Set<nat.>.) (k! Int) (dup2! Int)) (! (= (ens%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. m! missing! len! prev_vals! k! dup2!) (and (<= 0 dup2!) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I dup2!)) (exists ((dup1$ Poly)) (! (and (has_type dup1$ NAT) (and (and (and (not (= (%I dup1$) dup2!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) dup1$)) (and (<= 0 (%I dup1$)) (< (%I dup1$) len!))) (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) dup1$) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I dup2!))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) dup1$)) )))) :pattern ((ens%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. m! missing! len! prev_vals! k! dup2!)) )))
(set-info :comment ";; Function-Def lib::pigeonhole::pigeonhole_missing_idx_implies_double_helper")
(set-info :comment ";; pigeonhole.rs:96:1: 102:16 (#0)")
...
(assert (forall ((m! vstd!map.Map<nat./nat.>.) (missing! Int) (len! Int)) (! (= (req%lib!pigeonhole.pigeonhole_missing_idx_implies_double. m! missing! len!) (and (=> %%global_location_label%%22 (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (= (and (<= 0 (%I i$)) (< (%I i$) len!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$)) ))) (=> %%global_location_label%%23 (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$) (and (let ((tmp%%$ (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) i$)))) (and (<= 0 tmp%%$) (< tmp%%$ len!))) (not (= (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) i$)) missing!))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$)) ))) (=> %%global_location_label%%24 (and (<= 0 missing!) (< missing! len!))))) :pattern ((req%lib!pigeonhole.pigeonhole_missing_idx_implies_double. m! missing! len!)) )))
...
(set-info :comment ";; Function-Def lib::pigeonhole::pigeonhole_missing_idx_implies_double")
(set-info :comment ";; pigeonhole.rs:146:1: 150:20 (#0)")
(declare-const r! tuple%2.)
(declare-const m! vstd!map.Map<nat./nat.>.)
(declare-const missing! Int)
(declare-const len! Int)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Bool)
(declare-const tmp%3 Bool)
(declare-const tmp%4 vstd!set.Set<nat.>.)
(declare-const dup2@ Int)
(declare-const dup1@ Int)
(assert fuel_defaults)
(assert (<= 0 missing!))
(assert (<= 0 len!))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (= (and (<= 0 (%I i$)) (< (%I i$) len!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$)) )))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$) (and (let ((tmp%%$ (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) i$)))) (and (<= 0 tmp%%$) (< tmp%%$ len!))) (not (= (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) i$)) missing!))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$)) )))
(assert (and (<= 0 missing!) (< missing! len!)))
(declare-fun %%choose%%2 (Type Int Dcr Type Poly Int Int Dcr Type Dcr Type Poly Poly Dcr Type Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Poly) (%%hole%%5 Int) (%%hole%%6 Int) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Dcr) (%%hole%%10 Type) (%%hole%%11 Poly) (%%hole%%12 Poly) (%%hole%%13 Dcr) (%%hole%%14 Type) (%%hole%%15 Dcr) (%%hole%%16 Type) (%%hole%%17 Poly)) (! (=> (exists ((dup1$1 Poly)) (! (and (has_type dup1$1 %%hole%%0) (and (and (and (not (= (%I dup1$1) %%hole%%1)) (vstd!set.impl&%0.contains.? %%hole%%2 %%hole%%3 %%hole%%4 dup1$1)) (and (<= %%hole%%5 (%I dup1$1)) (< (%I dup1$1) %%hole%%6))) (= (vstd!map.impl&%0.index.? %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 dup1$1) %%hole%%12))) :pattern ((vstd!map.impl&%0.index.? %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 dup1$1)) )) (exists ((dup1$1 Poly)) (! (and (and (has_type dup1$1 %%hole%%0) (and (and (and (not (= (%I dup1$1) %%hole%%1)) (vstd!set.impl&%0.contains.? %%hole%%2 %%hole%%3 %%hole%%4 dup1$1)) (and (<= %%hole%%5 (%I dup1$1)) (< (%I dup1$1) %%hole%%6))) (= (vstd!map.impl&%0.index.? %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 dup1$1) %%hole%%12))) (= (%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17) dup1$1)) :pattern ((vstd!map.impl&%0.index.? %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 dup1$1))))) :pattern ((%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17)))))
...
(assert (not (and (=> (= tmp%1 (>= len! 1)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (or (and (=> (= len! 1) (=> (= tmp%2 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I 0))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (not (= (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I 0))) missing!))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%0))))))) (=> (not (= len! 1)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%3 (>= len! 2))))))) (=> (>= len! 2) (=> (= tmp%4 (%Poly%vstd!set.Set<nat.>. (vstd!set.impl&%0.empty.? $ NAT))) (and (=> %%location_label%%4 (req%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. m! missing! len! tmp%4 0)) (=> (ens%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. m! missing! len! tmp%4 0 dup2@) (=> (= dup1@ (%I (as_type (%%choose%%2 NAT dup2@ $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) 0 len! $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I dup2@)) $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) NAT))) (=> (= r! (tuple%2./tuple%2 (I dup1@) (I dup2@))) (=> %%location_label%%5 (let ((i$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r!)))))) (let ((j$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r!)))))) (and (and (and (not (= i$ j$)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I i$))) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I j$))) (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I i$)) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I j$))))))))))))))))
(check-sat)
(exit)
