...
(declare-const cloned_ep! lib!io_t.EndPoint.)
...
(assert (not (=> (= tmp%2 (lib!io_t.EndPoint./EndPoint/id (%Poly%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. ep!)))) (=> (ens%lib!args_t.clone_vec_u8. tmp%2 tmp%1) (=> (= cloned_ep! (lib!io_t.EndPoint./EndPoint (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%1)))) (=> %%location_label%%0 (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. cloned_ep!)) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. ep!)))))))))
(check-sat)
(exit)
