...
(assert (has_type self! TYPE%lib!hashmap_t.CKeyHashMap.))
(assert (has_type other! TYPE%lib!hashmap_t.CKeyHashMap.))
(assert (not (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!hashmap_t.CKeyHashMap. self! other!))))
(assert (<= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyHashMap. self!)) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyHashMap. other!))))
(declare-fun %%choose%%1 (Type Int Int Dcr Type Poly Dcr Type Poly Dcr Type Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly) (%%hole%%9 Dcr) (%%hole%%10 Type) (%%hole%%11 Poly) (%%hole%%12 Dcr) (%%hole%%13 Type) (%%hole%%14 Poly)) (! (=> (exists ((i$1 Poly)) (! (and (has_type i$1 %%hole%%0) (and (and (<= %%hole%%1 (%I i$1)) (< (%I i$1) %%hole%%2)) (not (= (lib!hashmap_t.impl&%1.view.? (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$1)) (lib!hashmap_t.impl&%1.view.? (vstd!seq.Seq.index.? %%hole%%6 %%hole%%7 %%hole%%8 i$1)))))) :pattern ((vstd!seq.Seq.index.? %%hole%%9 %%hole%%10 %%hole%%11 i$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%12 %%hole%%13 %%hole%%14 i$1)) )) (exists ((i$1 Poly)) (! (and (and (has_type i$1 %%hole%%0) (and (and (<= %%hole%%1 (%I i$1)) (< (%I i$1) %%hole%%2)) (not (= (lib!hashmap_t.impl&%1.view.? (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$1)) (lib!hashmap_t.impl&%1.view.? (vstd!seq.Seq.index.? %%hole%%6 %%hole%%7 %%hole%%8 i$1)))))) (= (%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14) i$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%9 %%hole%%10 %%hole%%11 i$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%12 %%hole%%13 %%hole%%14 i$1))))) :pattern ((%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14)))))
...
(assert (not (=> (ens%lib!hashmap_t.impl&%0.lemma_to_vec_view. (%Poly%lib!hashmap_t.CKeyHashMap. self!) (%Poly%lib!hashmap_t.CKeyHashMap. other!)) (=> (= tmp%1 (not (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!)))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (or (and (=> (not (= (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!))))) (=> (= tmp%2 (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) (=> (= tmp%3 (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!))) (and (=> %%location_label%%1 (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) tmp%2 tmp%3)) (=> (ens%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) tmp%2 tmp%3) %%switch_label%%0))))) (=> (not (not (= (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!)))))) (=> (= tmp%4 (exists ((i$ Poly)) (! (and (has_type i$ INT) (and (and (<= 0 (%I i$)) (< (%I i$) (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))))) (not (= (lib!hashmap_t.impl&%1.view.? (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) i$)) (lib!hashmap_t.impl&%1.view.? (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!))) i$)))))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) i$)) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!))) i$)) ))) (and (=> %%location_label%%2 tmp%4) (=> tmp%4 (=> (= i@ (%I (as_type (%%choose%%1 INT 0 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!))) $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!)))) INT))) (=> (= tmp%5 (not (= (lib!hashmap_t.impl&%1.view.? (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) (I i@))) (lib!hashmap_t.impl&%1.view.? (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!))) (I i@)))))) (and (=> %%location_label%%3 tmp%5) (=> tmp%5 (=> (= tmp%6 (not (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) (I i@)) (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!))) (I i@)))))) (and (=> %%location_label%%4 tmp%6) (=> tmp%6 (=> (= tmp%7 (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!)) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!)))))) (and (=> %%location_label%%5 tmp%7) (=> tmp%7 (=> (= tmp%8 (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? self!))) (=> (= tmp%9 (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. (lib!hashmap_t.impl&%0.spec_to_vec.? other!))) (and (=> %%location_label%%6 (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) tmp%8 tmp%9)) (=> (ens%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) tmp%8 tmp%9) %%switch_label%%0))))))))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%7 (not (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyHashMap. self!) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyHashMap. other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyHashMap. self!)))))))))))))))
(check-sat)
(exit)
