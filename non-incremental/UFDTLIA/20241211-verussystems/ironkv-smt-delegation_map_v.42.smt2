...
(declare-const s! lib!delegation_map_v.DelegationMap.)
(declare-const k_zero! Poly)
(declare-const id_zero! lib!io_t.EndPoint.)
(declare-const lows@0 lib!delegation_map_v.StrictlyOrderedMap.)
(declare-const m@ Poly)
(declare-const s@ lib!delegation_map_v.DelegationMap.)
(assert fuel_defaults)
(assert (has_type k_zero! K&))
(assert (tr_bound%lib!keys_t.KeyTrait. K&. K&))
(assert (tr_bound%lib!verus_extra.clone_v.VerusClone. K&. K&))
(assert (= k_zero! (lib!keys_t.KeyTrait.zero_spec.? K&. K&)))
(assert (lib!abstract_end_point_t.impl&%0.valid_physical_address.? (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. id_zero!)))))
(declare-const lows@1 lib!delegation_map_v.StrictlyOrderedMap.)
...
(assert (not (=> (ens%lib!delegation_map_v.impl&%3.new. K&. K& lows@0) (and (=> %%location_label%%0 (req%lib!delegation_map_v.impl&%3.set. K&. K& lows@0 k_zero! id_zero!)) (=> (has_type (Poly%lib!delegation_map_v.StrictlyOrderedMap. lows@1) (TYPE%lib!delegation_map_v.StrictlyOrderedMap. K&. K&)) (=> (ens%lib!delegation_map_v.impl&%3.set. K&. K& lows@0 lows@1 k_zero! id_zero!) (=> (= m@ (vstd!map.impl&%0.total.? K&. K& $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%fun%1. K&. K& $ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (Poly%fun%1. (mk_fun (%%lambda%%4 (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. id_zero!)))))))) (=> (= s@ (lib!delegation_map_v.DelegationMap./DelegationMap (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. lows@1)) m@)) (=> (= s! s@) (and (=> %%location_label%%1 (lib!delegation_map_v.impl&%4.valid.? K&. K& (Poly%lib!delegation_map_v.DelegationMap. s!))) (=> %%location_label%%2 (= (lib!delegation_map_v.impl&%4.view.? K&. K& (Poly%lib!delegation_map_v.DelegationMap. s!)) (vstd!map.impl&%0.total.? K&. K& $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%fun%1. K&. K& $ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (Poly%fun%1. (mk_fun (%%lambda%%4 (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. id_zero!)))))))))))))))))))
(check-sat)
(exit)
