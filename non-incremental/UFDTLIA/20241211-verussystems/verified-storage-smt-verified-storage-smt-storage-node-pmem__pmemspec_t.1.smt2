...
(set-info :comment ";; MODULE 'module pmem::pmemspec_t'")
...
(assert (forall ((T&. Dcr) (T& Type) (E&. Dcr) (E& Type) (F&. Dcr) (F& Type) (O&. Dcr) (O& Type) (result! core!result.Result.) (op! Poly) (mapped_result! core!result.Result.)) (! (= (ens%core!result.impl&%0.map_err. T&. T& E&. E& F&. F& O&. O& result! op! mapped_result!) (and (has_type (Poly%core!result.Result. mapped_result!) (TYPE%core!result.Result. T&. T& F&. F&)) (=> (is-core!result.Result./Err_ result!) (and (is-core!result.Result./Err_ mapped_result!) (closure_ens O& $ (TYPE%tuple%1. E&. E&) op! (Poly%tuple%1. (tuple%1./tuple%1 (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))) (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. mapped_result!)))))) (=> (is-core!result.Result./Ok_ result!) (= mapped_result! (core!result.Result./Ok (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))))) :pattern ((ens%core!result.impl&%0.map_err. T&. T& E&. E& F&. F& O&. O& result! op! mapped_result!)) )))
...
(set-info :comment ";; Function-Specs lib::pmem::pmemspec_t::bytes_crc")
...
(set-info :comment ";; Function-Specs lib::pmem::pmemspec_t::axiom_bytes_uncorrupted2")
...
(set-info :comment ";; Function-Specs lib::pmem::pmemspec_t::compare_crcs")
...
(set-info :comment ";; Function-Def lib::pmem::pmemspec_t::CDB_FALSE")
(set-info :comment ";; src/pmem/pmemspec_t.rs:187:5: 187:51 (#0)")
