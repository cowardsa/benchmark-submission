...
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (x$ Poly)) (! (= (%%apply%%0 (%%lambda%%9 %%hole%%0 %%hole%%1) x$) (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$)) :pattern ((%%apply%%0 (%%lambda%%9 %%hole%%0 %%hole%%1) x$)))))
...
(assert (not (=> (ens%alloc!vec.impl&%1.len. T&. T& $ ALLOCATOR_GLOBAL self! tmp%1) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT SZ) (I tmp%1))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT SZ) (I tmp%1) tmp%2) (=> (= res@0 (%I tmp%2)) (=> (= i@0 0) (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (and (=> %%location_label%%1 tmp%3) (=> tmp%3 (and (=> %%location_label%%2 (and (<= 0 i@0) (<= i@0 (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL self!)))) (and (=> %%location_label%%3 (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) ))) (and (=> %%location_label%%4 (<= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (- (uHi SZ) 1))) (and (=> %%location_label%%5 (= res@0 (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@0)) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))))) (=> (uInv SZ res@1) (=> (uInv SZ i@1) (=> (and (<= 0 i@1) (<= i@1 (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL self!))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) )) (=> (<= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (- (uHi SZ) 1)) (=> (= res@1 (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))))))) (=> (ens%alloc!vec.impl&%1.len. T&. T& $ ALLOCATOR_GLOBAL self! tmp%4) (=> (not (< i@1 tmp%4)) (=> (= f$1@ (mk_fun (%%lambda%%9 T&. T&))) (=> (= tmp%17 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) (=> (= tmp%18 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.empty.? $ (UINT 8)))) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int. T&. T& $ (UINT 8) tmp%17 (Poly%vstd!seq.Seq<u8.>. tmp%18) f$1@) (=> (= tmp%19 (mk_fun (%%lambda%%6 f$1@ $ (UINT 8)))) (=> (= tmp%20 (mk_fun (%%lambda%%1 T&. T& $ (UINT 8)))) (and (=> %%location_label%%6 (req%vstd!function.fun_ext_2. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) tmp%19 tmp%20)) (=> (ens%vstd!function.fun_ext_2. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) tmp%19 tmp%20) (=> (= tmp%21 (mk_fun (%%lambda%%3 f$1@ $ (UINT 8)))) (=> (= tmp%22 (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))) (and (=> %%location_label%%7 (req%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%21 tmp%22)) (=> (ens%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%21 tmp%22) (=> (= tmp%23 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!))) (and (=> %%location_label%%8 tmp%23) (=> tmp%23 (=> (= %return! (I res@1)) (=> %%location_label%%9 (= (%I %return!) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
