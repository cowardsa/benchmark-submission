...
(assert (not (or (and (=> (> (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!) 0) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0))) (=> (= tmp%1 (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0))) (=> (= tmp%2 (is-lib!single_message_t.SingleMessage./Message_ (%Poly%lib!single_message_t.SingleMessage. tmp%1))) %%switch_label%%1)))) (=> (not (> (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!) 0)) (=> (= tmp%2 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%2 (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0))) (=> (= tmp%3 (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0))) (=> (= tmp%4 (<= (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. tmp%3)) (%I seqno_acked!))) %%switch_label%%0)))) (=> (not tmp%2) (=> (= tmp%4 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
