...
(declare-const self!@0 lib!single_delivery_state_v.CTombstoneTable.)
(declare-const src! lib!io_t.EndPoint.)
(declare-const last_seqno! Int)
(declare-const tmp%1 Bool)
(assert fuel_defaults)
(assert (uInv 64 last_seqno!))
(assert (lib!single_delivery_state_v.impl&%1.abstractable.? (Poly%lib!single_delivery_state_v.CTombstoneTable. self!@0)))
(assert (lib!abstract_end_point_t.impl&%0.valid_physical_address.? (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src!)))))
(declare-const self!@1 lib!single_delivery_state_v.CTombstoneTable.)
...
(assert (not (=> (ens%lib!endpoint_hashmap_t.impl&%0.insert. $ (UINT 64) (Poly%lib!endpoint_hashmap_t.HashMap<u64.>. (lib!single_delivery_state_v.CTombstoneTable./CTombstoneTable/epmap (%Poly%lib!single_delivery_state_v.CTombstoneTable. (Poly%lib!single_delivery_state_v.CTombstoneTable. self!@0)))) (Poly%lib!endpoint_hashmap_t.HashMap<u64.>. (lib!single_delivery_state_v.CTombstoneTable./CTombstoneTable/epmap (%Poly%lib!single_delivery_state_v.CTombstoneTable. (Poly%lib!single_delivery_state_v.CTombstoneTable. self!@1)))) src! (I last_seqno!)) (=> (= tmp%1 (forall ((k$ Poly)) (! (=> (has_type k$ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. (lib!single_delivery_state_v.impl&%1.view.? (Poly%lib!single_delivery_state_v.CTombstoneTable. self!@1)))) k$) (or (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. (lib!single_delivery_state_v.impl&%1.view.? (Poly%lib!single_delivery_state_v.CTombstoneTable. self!@0)))) k$) (= (%Poly%lib!abstract_end_point_t.AbstractEndPoint. k$) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src!)))))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. (lib!single_delivery_state_v.impl&%1.view.? (Poly%lib!single_delivery_state_v.CTombstoneTable. self!@1)))) k$)) ))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> %%location_label%%1 (ext_eq false (TYPE%vstd!map.Map. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. (lib!single_delivery_state_v.impl&%1.view.? (Poly%lib!single_delivery_state_v.CTombstoneTable. self!@1))) (vstd!map.impl&%0.insert.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. (lib!single_delivery_state_v.impl&%1.view.? (Poly%lib!single_delivery_state_v.CTombstoneTable. self!@0))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src!))) (I last_seqno!)))) (=> %%location_label%%2 (lib!single_delivery_state_v.impl&%1.abstractable.? (Poly%lib!single_delivery_state_v.CTombstoneTable. self!@1))))))))))
(check-sat)
(exit)
