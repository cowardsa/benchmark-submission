...
(assert (has_type other! (UINT SZ)))
(assert (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT SZ) self!)))
(assert (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT SZ) other!)))
(assert (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) other!)))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_serialize_injective. $ (UINT 64) (I (uClip 64 (%I self!))) (I (uClip 64 (%I other!))))) (=> (ens%lib!marshal_v.Marshalable.lemma_serialize_injective. $ (UINT 64) (I (uClip 64 (%I self!))) (I (uClip 64 (%I other!)))) (=> %%location_label%%1 (%B (lib!marshal_v.Marshalable.view_equal.? $ (UINT SZ) self! other!)))))))
(check-sat)
(exit)
