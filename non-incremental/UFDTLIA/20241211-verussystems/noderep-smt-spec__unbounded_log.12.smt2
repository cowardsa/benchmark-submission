...
(assert (has_type a! (TYPE%vstd!map.Map. $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&))))
(assert (has_type b! (TYPE%vstd!map.Map. $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&))))
(assert (<= 0 version!))
(assert (tr_bound%lib!Dispatch. DT&. DT&))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (and (<= 0 (%I i$)) (< (%I i$) version!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) a!) i$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) a!) i$)) )))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (and (<= 0 (%I i$)) (< (%I i$) version!)) (= (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) a! i$) (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) b! i$)))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) a! i$)) :pattern ((vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) b! i$)) )))
...
(assert (not (=> (= decrease%init0 version!) (or (and (=> (> version! 0) (=> (= tmp%1 (nClip (Sub version! 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((a!$0 a!) (b!$1 b!) (version!$2 tmp%1)) version!$2) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!spec.unbounded_log.compute_nrstate_at_version_preserves. DT&. DT& a! b! tmp%1)) (=> (ens%lib!spec.unbounded_log.compute_nrstate_at_version_preserves. DT&. DT& a! b! tmp%1) %%switch_label%%0))))) (=> (not (> version! 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (= (lib!spec.unbounded_log.compute_nrstate_at_version.? DT&. DT& a! (I version!)) (lib!spec.unbounded_log.compute_nrstate_at_version.? DT&. DT& b! (I version!)))))))))
(check-sat)
(exit)
