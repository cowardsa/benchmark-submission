...
(assert (has_type other! (UINT 64)))
(assert (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT 64) self!)))
(assert (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT 64) other!)))
(assert (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT 64) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT 64) other!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> %%location_label%%0 (%B (lib!marshal_v.Marshalable.view_equal.? $ (UINT 64) self! other!))))))
(check-sat)
(exit)
