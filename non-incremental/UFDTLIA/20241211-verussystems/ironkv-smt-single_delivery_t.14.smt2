...
(assert (has_type self! (TYPE%lib!single_delivery_t.SingleDelivery. $ TYPE%lib!message_t.Message.)))
...
(assert (has_type count! NAT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!))) dst!) (=> (= tmp%2 (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) tmp%2 dst!)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!)) dst!)) (=> (<= (%I count!) (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.AckState./AckState/un_acked (%Poly%lib!single_delivery_t.AckState. (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!)) dst!))))) (=> (has_type p@ TYPE%lib!network_t.Packet.) (or (and (=> (= (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. p@)) (%Poly%lib!abstract_end_point_t.AbstractEndPoint. src!)) (=> (has_type i@ INT) (=> (= tmp%3 (exists ((i$ Poly)) (! (and (has_type i$ INT) (and (and (and (and (<= 0 (%I i$)) (< (%I i$) (%I count!))) (is-lib!single_message_t.SingleMessage./Message_ (%Poly%lib!single_message_t.SingleMessage. (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.AckState./AckState/un_acked (%Poly%lib!single_delivery_t.AckState. (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!)) dst!))) i$)))) (= (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. p@)) (%Poly%lib!single_message_t.SingleMessage. (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.AckState./AckState/un_acked (%Poly%lib!single_delivery_t.AckState. (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!)) dst!))) i$)))) (= (lib!network_t.Packet./Packet/dst (%Poly%lib!network_t.Packet. p@)) (lib!single_message_t.SingleMessage./Message/dst (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. p@)))))))) :pattern ((vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.AckState./AckState/un_acked (%Poly%lib!single_delivery_t.AckState. (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. self!)) dst!))) i$)) ))) %%switch_label%%0))) (=> (not (= (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. p@)) (%Poly%lib!abstract_end_point_t.AbstractEndPoint. src!))) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0))))))))))
(check-sat)
(exit)
