...
(assert (not (or (and (=> (is-lib!cmessage_v.CSingleMessage./Message_ (%Poly%lib!cmessage_v.CSingleMessage. self!)) (=> (= seqno@ (lib!cmessage_v.CSingleMessage./Message/seqno (%Poly%lib!cmessage_v.CSingleMessage. self!))) (=> (= dst@ (lib!cmessage_v.CSingleMessage./Message/dst (%Poly%lib!cmessage_v.CSingleMessage. self!))) (=> (= m@ (lib!cmessage_v.CSingleMessage./Message/m (%Poly%lib!cmessage_v.CSingleMessage. self!))) (or (and (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ (UINT 64) (I seqno@) tmp%1) (=> (= tmp%2 tmp%1) %%switch_label%%7)) (=> (not true) (=> (= tmp%2 (B false)) %%switch_label%%7))) (and (not %%switch_label%%7) (or (and (=> (%B tmp%2) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. dst@) tmp%3) (=> (= tmp%4 tmp%3) %%switch_label%%6))) (=> (not (%B tmp%2)) (=> (= tmp%4 (B false)) %%switch_label%%6))) (and (not %%switch_label%%6) (or (and (=> (%B tmp%4) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. m@) tmp%5) (=> (= tmp%6 tmp%5) %%switch_label%%5))) (=> (not (%B tmp%4)) (=> (= tmp%6 (B false)) %%switch_label%%5))) (and (not %%switch_label%%5) (or (and (=> (%B tmp%6) (and (=> %%location_label%%0 (uInv SZ (Sub (- (uHi SZ) 1) 0))) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1) (and (=> %%location_label%%1 (uInv SZ (Add 0 1))) (and (=> %%location_label%%2 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1))))) (and (=> %%location_label%%3 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I seqno@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I seqno@) tmp%7) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%7)) (and (=> %%location_label%%4 (uInv SZ (Add 0 1))) (and (=> %%location_label%%5 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I seqno@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I seqno@) tmp%8) (and (=> %%location_label%%6 (uInv SZ (Add (uClip SZ (Add 0 1)) (%I tmp%8)))) (and (=> %%location_label%%7 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%8)))))) (and (=> %%location_label%%8 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. dst@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. dst@) tmp%9) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%8))))) (%I tmp%9)) (and (=> %%location_label%%9 (uInv SZ (Add 0 1))) (and (=> %%location_label%%10 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I seqno@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I seqno@) tmp%10) (and (=> %%location_label%%11 (uInv SZ (Add (uClip SZ (Add 0 1)) (%I tmp%10)))) (and (=> %%location_label%%12 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. dst@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. dst@) tmp%11) (and (=> %%location_label%%13 (uInv SZ (Add (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%10))) (%I tmp%11)))) (and (=> %%location_label%%14 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%10))) (%I tmp%11)))))) (and (=> %%location_label%%15 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. m@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!cmessage_v.CMessage. (Poly%lib!cmessage_v.CMessage. m@) tmp%12) (=> (= tmp%13 (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%10))) (%I tmp%11))))) (%I tmp%12))) %%switch_label%%4)))))))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%8))))) (%I tmp%9))) (=> (= tmp%13 false) %%switch_label%%4))) (and (not %%switch_label%%4) (=> (= tmp%14 tmp%13) %%switch_label%%3))))))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%7))) (=> (= tmp%14 false) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= tmp%15 tmp%14) %%switch_label%%2)))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1)) (=> (= tmp%15 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%16 tmp%15) %%switch_label%%1))))) (=> (not (%B tmp%6)) (=> (= tmp%16 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%23 tmp%16) %%switch_label%%0))))))))))))) (=> (not (is-lib!cmessage_v.CSingleMessage./Message_ (%Poly%lib!cmessage_v.CSingleMessage. self!))) (or (and (=> (is-lib!cmessage_v.CSingleMessage./Ack_ (%Poly%lib!cmessage_v.CSingleMessage. self!)) (=> (= ack_seqno@ (lib!cmessage_v.CSingleMessage./Ack/ack_seqno (%Poly%lib!cmessage_v.CSingleMessage. self!))) (or (and (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ (UINT 64) (I ack_seqno@) tmp%17) (=> (= tmp%18 tmp%17) %%switch_label%%11)) (=> (not true) (=> (= tmp%18 (B false)) %%switch_label%%11))) (and (not %%switch_label%%11) (or (and (=> (%B tmp%18) (and (=> %%location_label%%16 (uInv SZ (Sub (- (uHi SZ) 1) 0))) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1) (and (=> %%location_label%%17 (uInv SZ (Add 0 1))) (and (=> %%location_label%%18 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1))))) (and (=> %%location_label%%19 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I ack_seqno@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) (I ack_seqno@) tmp%19) (=> (= tmp%20 (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%19))) %%switch_label%%10)))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1)) (=> (= tmp%20 false) %%switch_label%%10))) (and (not %%switch_label%%10) (=> (= tmp%21 tmp%20) %%switch_label%%9))))) (=> (not (%B tmp%18)) (=> (= tmp%21 false) %%switch_label%%9))) (and (not %%switch_label%%9) (=> (= tmp%22 tmp%21) %%switch_label%%8))))))) (=> (not (is-lib!cmessage_v.CSingleMessage./Ack_ (%Poly%lib!cmessage_v.CSingleMessage. self!))) (=> (= tmp%22 true) %%switch_label%%8))) (and (not %%switch_label%%8) (=> (= tmp%23 tmp%22) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= %return! (B tmp%23)) (=> %%location_label%%20 (= %return! (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. self!))))))))
(check-sat)
(exit)
