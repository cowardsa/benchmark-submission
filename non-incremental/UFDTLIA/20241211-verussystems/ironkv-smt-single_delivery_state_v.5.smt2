...
(declare-const cm! vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>.)
(declare-const i! Int)
(declare-const tmp%1 vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>.)
(declare-const tmp%2 Int)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (and (<= 0 i!) (<= i! (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>. cm!)))))
...
(assert (not (=> (= decrease%init0 i!) (or (and (=> (< 0 i!) (=> (= tmp%1 (%Poly%vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>. (vstd!seq.Seq.subrange.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>. cm!) (I 1) (I (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>. cm!)))))) (=> (= tmp%2 (Sub i! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((cm!$0 tmp%1) (i!$1 tmp%2)) i!$1) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!single_delivery_state_v.impl&%0.abstractify_distributes_over_skip. tmp%1 tmp%2)) (=> (ens%lib!single_delivery_state_v.impl&%0.abstractify_distributes_over_skip. tmp%1 tmp%2) %%switch_label%%0)))))) (=> (not (< 0 i!)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. (lib!cmessage_v.abstractify_cmessage_seq.? (vstd!seq.Seq.subrange.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>. cm!) (I i!) (I (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>. cm!)))))) (vstd!seq.Seq.subrange.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. (lib!cmessage_v.abstractify_cmessage_seq.? (Poly%vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>. cm!))) (I i!) (I (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. (lib!cmessage_v.abstractify_cmessage_seq.? (Poly%vstd!seq.Seq<lib!cmessage_v.CSingleMessage.>. cm!)))))))))))))
(check-sat)
(exit)
