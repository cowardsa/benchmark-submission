...
(declare-const v! alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>.)
...
(assert (not (=> (and (< 0 idx@0) (<= idx@0 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)))) (=> (forall ((i$ Poly) (j$ Poly)) (! (=> (and (has_type i$ INT) (has_type j$ INT)) (=> (and (and (<= 0 (%I i$)) (< (Add (%I i$) 1) idx@0)) (= (%I j$) (Add (%I i$) 1))) (lib!hashmap_t.ckeykvlt.? (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) i$) (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) j$)))) :pattern ((lib!hashmap_t.ckeykvlt.? (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) i$) (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) j$))) )) (=> (ens%alloc!vec.impl&%1.len. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!) tmp%2) (=> (< idx@0 tmp%2) (and (=> %%location_label%%0 (uInv SZ (Sub idx@0 1))) (=> (= tmp%4 (uClip SZ (Sub idx@0 1))) (and (=> %%location_label%%1 (req%vstd!std_specs.vec.vec_index. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!) tmp%4)) (=> (ens%vstd!std_specs.vec.vec_index. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!) tmp%4 tmp%3) (and (=> %%location_label%%2 (req%vstd!std_specs.vec.vec_index. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!) idx@0)) (=> (ens%vstd!std_specs.vec.vec_index. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!) idx@0 tmp%5) (or (and (=> (>= (lib!keys_t.SHTKey./SHTKey/ukey (%Poly%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. tmp%3))))) (lib!keys_t.SHTKey./SHTKey/ukey (%Poly%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. tmp%5)))))) (=> (= tmp%6 (not (lib!hashmap_t.ckeykvlt.? (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) (I (Sub idx@0 1))) (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) (I idx@0))))) (and (=> %%location_label%%3 tmp%6) (=> tmp%6 (=> (= res! false) (=> %%location_label%%4 (= res! (lib!hashmap_t.spec_sorted_keys.? (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!))))))))) (=> (not (>= (lib!keys_t.SHTKey./SHTKey/ukey (%Poly%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. tmp%3))))) (lib!keys_t.SHTKey./SHTKey/ukey (%Poly%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. tmp%5))))))) (and (=> %%location_label%%5 (uInv SZ (Add idx@0 1))) (=> (= idx@1 (uClip SZ (Add idx@0 1))) %%switch_label%%0)))) (and (not %%switch_label%%0) (and (=> %%location_label%%6 (and (< 0 idx@1) (<= idx@1 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!))))) (=> %%location_label%%7 (forall ((i$ Poly) (j$ Poly)) (! (=> (and (has_type i$ INT) (has_type j$ INT)) (=> (and (and (<= 0 (%I i$)) (< (Add (%I i$) 1) idx@1)) (= (%I j$) (Add (%I i$) 1))) (lib!hashmap_t.ckeykvlt.? (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) i$) (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) j$)))) :pattern ((lib!hashmap_t.ckeykvlt.? (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) i$) (vstd!seq.Seq.index.? $ TYPE%lib!hashmap_t.CKeyKV. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!hashmap_t.CKeyKV. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!hashmap_t.CKeyKV./allocator_global%.>. v!)) j$))) ))))))))))))))))))
(check-sat)
(exit)
