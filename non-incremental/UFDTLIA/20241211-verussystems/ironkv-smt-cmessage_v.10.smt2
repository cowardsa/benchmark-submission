...
(declare-const key! lib!keys_t.SHTKey.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!keys_t.SHTKey. key!) TYPE%lib!keys_t.SHTKey.))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= b! true) (=> %%location_label%%0 (= b! (lib!app_interface_t.valid_key.? (Poly%lib!keys_t.SHTKey. key!)))))))
(check-sat)
(exit)
