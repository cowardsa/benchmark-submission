...
(set-info :comment ";; Function-Specs lib::endpoint_hashmap_t::HashMap::put")
(declare-fun ens%lib!endpoint_hashmap_t.impl&%0.put. (Dcr Type Poly Poly lib!io_t.EndPoint. Poly) Bool)
(assert (forall ((V&. Dcr) (V& Type) (pre%self! Poly) (self! Poly) (key! lib!io_t.EndPoint.) (value! Poly)) (! (= (ens%lib!endpoint_hashmap_t.impl&%0.put. V&. V& pre%self! self! key! value!) (and (has_type self! (TYPE%lib!endpoint_hashmap_t.HashMap. V&. V&)) (lib!endpoint_hashmap_t.impl&%0.put_spec.? V&. V& (lib!endpoint_hashmap_t.impl&%0.view.? V&. V& pre%self!) (lib!endpoint_hashmap_t.impl&%0.view.? V&. V& self!) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. key!))) value!))) :pattern ((ens%lib!endpoint_hashmap_t.impl&%0.put. V&. V& pre%self! self! key! value!)) )))
...
(set-info :comment ";; Function-Def lib::single_delivery_state_v::CSendState::put")
(set-info :comment ";; ironsht/src/single_delivery_state_v.rs:292:5: 292:60 (#0)")
...
(set-info :comment ";; Function-Def lib::single_delivery_state_v::CTombstoneTable::lookup")
(set-info :comment ";; ironsht/src/single_delivery_state_v.rs:211:5: 211:61 (#0)")
...
(assert (forall ((pre%self! lib!single_delivery_state_v.CTombstoneTable.) (src! lib!io_t.EndPoint.) (last_seqno! Int)) (! (= (req%lib!single_delivery_state_v.impl&%1.insert. pre%self! src! last_seqno!) (and (=> %%global_location_label%%22 (lib!single_delivery_state_v.impl&%1.abstractable.? (Poly%lib!single_delivery_state_v.CTombstoneTable. pre%self!))) (=> %%global_location_label%%23 (lib!abstract_end_point_t.impl&%0.valid_physical_address.? (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src!))))))) :pattern ((req%lib!single_delivery_state_v.impl&%1.insert. pre%self! src! last_seqno!)) )))
...
(set-info :comment ";; Function-Def lib::single_delivery_state_v::CTombstoneTable::insert")
(set-info :comment ";; ironsht/src/single_delivery_state_v.rs:222:5: 222:62 (#0)")
...
(assert (forall ((self! lib!single_delivery_state_v.CAckState.) (dst! lib!abstract_end_point_t.AbstractEndPoint.) (k! Int)) (! (= (req%lib!single_delivery_state_v.impl&%0.lemma_seqno_in_un_acked_list. self! dst! k!) (and (=> %%global_location_label%%24 (lib!single_delivery_state_v.impl&%0.valid.? (Poly%lib!single_delivery_state_v.CAckState. self!) (Poly%lib!abstract_end_point_t.AbstractEndPoint. dst!))) (=> %%global_location_label%%25 (and (<= 0 k!) (< k! (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))))))))) :pattern ((req%lib!single_delivery_state_v.impl&%0.lemma_seqno_in_un_acked_list. self! dst! k!)) )))
...
(set-info :comment ";; Function-Def lib::single_delivery_state_v::CAckState::lemma_seqno_in_un_acked_list")
(set-info :comment ";; ironsht/src/single_delivery_state_v.rs:126:5: 126:84 (#0)")
...
(set-info :comment ";; Function-Def lib::single_delivery_t::SingleDelivery::lemma_un_acked_messages_for_dests_empty")
(set-info :comment ";; ironsht/src/single_delivery_state_v.rs:378:5: 378:117 (#0)")
...
(assert (forall ((self! lib!single_delivery_state_v.CSingleDelivery.) (src! lib!abstract_end_point_t.AbstractEndPoint.) (dst! lib!abstract_end_point_t.AbstractEndPoint.) (i! Int)) (! (= (req%lib!single_delivery_state_v.impl&%3.un_acked_messages_extend. self! src! dst! i!) (and (=> %%global_location_label%%27 (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. (Poly%lib!single_delivery_t.SingleDelivery. (lib!single_delivery_state_v.impl&%3.view.? (Poly%lib!single_delivery_state_v.CSingleDelivery. self!)))))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. dst!))) (=> %%global_location_label%%28 (< i! (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.AckState./AckState/un_acked (%Poly%lib!single_delivery_t.AckState. (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. (Poly%lib!single_delivery_t.SingleDelivery. (lib!single_delivery_state_v.impl&%3.view.? (Poly%lib!single_delivery_state_v.CSingleDelivery. self!))))) (Poly%lib!abstract_end_point_t.AbstractEndPoint. dst!))))))) (=> %%global_location_label%%29 (lib!single_delivery_state_v.impl&%2.valid.? (Poly%lib!single_delivery_state_v.CSendState. (lib!single_delivery_state_v.CSingleDelivery./CSingleDelivery/send_state (%Poly%lib!single_delivery_state_v.CSingleDelivery. (Poly%lib!single_delivery_state_v.CSingleDelivery. self!)))))))) :pattern ((req%lib!single_delivery_state_v.impl&%3.un_acked_messages_extend. self! src! dst! i!)) )))
...
(set-info :comment ";; Function-Def lib::single_delivery_state_v::CSingleDelivery::un_acked_messages_extend")
(set-info :comment ";; ironsht/src/single_delivery_state_v.rs:344:5: 344:103 (#0)")
(set-info :comment ";; Function-Specs lib::single_delivery_state_v::CAckState::clone_up_to_view")
(declare-fun ens%lib!single_delivery_state_v.impl&%0.clone_up_to_view. (lib!single_delivery_state_v.CAckState. lib!single_delivery_state_v.CAckState.) Bool)
(assert (forall ((self! lib!single_delivery_state_v.CAckState.) (o! lib!single_delivery_state_v.CAckState.)) (! (= (ens%lib!single_delivery_state_v.impl&%0.clone_up_to_view. self! o!) (and (has_type (Poly%lib!single_delivery_state_v.CAckState. o!) TYPE%lib!single_delivery_state_v.CAckState.) (= (lib!single_delivery_state_v.impl&%0.view.? (Poly%lib!single_delivery_state_v.CAckState. o!)) (lib!single_delivery_state_v.impl&%0.view.? (Poly%lib!single_delivery_state_v.CAckState. self!))))) :pattern ((ens%lib!single_delivery_state_v.impl&%0.clone_up_to_view. self! o!)) )))
(set-info :comment ";; Function-Def lib::single_delivery_state_v::CAckState::clone_up_to_view")
(set-info :comment ";; ironsht/src/single_delivery_state_v.rs:65:9: 73:10 (#0)")
(set-info :comment ";; Function-Def lib::single_delivery_state_v::CAckState::clone_up_to_view")
(set-info :comment ";; ironsht/src/single_delivery_state_v.rs:60:5: 60:46 (#0)")
(declare-const o! lib!single_delivery_state_v.CAckState.)
(declare-const self! lib!single_delivery_state_v.CAckState.)
...
(declare-const s1@ vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>.)
(declare-const s2@ vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>.)
(declare-const un_acked@0 alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>.)
(declare-const i@0 Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!single_delivery_state_v.CAckState. self!) TYPE%lib!single_delivery_state_v.CAckState.))
(declare-const un_acked@1 alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>.)
...
(assert (not (=> (ens%alloc!vec.impl&%0.new. $ TYPE%lib!cmessage_v.CSingleMessage. tmp%1) (=> (= un_acked@0 (%Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. tmp%1)) (=> (= i@0 0) (and (=> %%location_label%%0 (<= i@0 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))))) (and (=> %%location_label%%1 (= (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@0))) i@0)) (and (=> %%location_label%%2 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@0)) j$)) (lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))) j$))))) :pattern ((lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@0)) j$))) ))) (=> (uInv SZ i@1) (=> (<= i@1 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!)))))) (=> (= (vstd!seq.Seq.len.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@1))) i@1) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@1)) j$)) (lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))) j$))))) :pattern ((lib!cmessage_v.impl&%2.view.? (vstd!seq.Seq.index.? $ TYPE%lib!cmessage_v.CSingleMessage. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@1)) j$))) )) (=> (= tmp%3 (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!)))) (=> (ens%alloc!vec.impl&%1.len. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. tmp%3) tmp%2) (=> (not (< i@1 tmp%2)) (=> (= s1@ (lib!cmessage_v.abstractify_cmessage_seq.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@1)))) (=> (= s2@ (lib!cmessage_v.abstractify_cmessage_seq.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!cmessage_v.CSingleMessage. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (lib!single_delivery_state_v.CAckState./CAckState/un_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))))) (and (=> (= tmp%7 (= (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s1@)) (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s2@)))) (and (=> %%location_label%%3 tmp%7) (=> tmp%7 (and (=> (has_type idx@ INT) (=> (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s1@)))) (=> %%location_label%%4 (= (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s1@) idx@) (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s2@) idx@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s1@)))) (= (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s1@) idx$) (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s2@) idx$)))) :pattern ((vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s1@) idx$)) :pattern ((vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s2@) idx$)) )) (=> (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s1@) (Poly%vstd!seq.Seq<lib!single_message_t.SingleMessage<lib!message_t.Message.>.>. s2@))) (and (=> %%location_label%%5 tmp%8) (=> tmp%8 (=> %%location_label%%6 (= s1@ s2@)))))))))) (=> (= s1@ s2@) (=> (= o! (lib!single_delivery_state_v.CAckState./CAckState (%I (I (lib!single_delivery_state_v.CAckState./CAckState/num_packets_acked (%Poly%lib!single_delivery_state_v.CAckState. (Poly%lib!single_delivery_state_v.CAckState. self!))))) (%Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. (Poly%alloc!vec.Vec<lib!cmessage_v.CSingleMessage./allocator_global%.>. un_acked@1)))) (=> %%location_label%%7 (= (lib!single_delivery_state_v.impl&%0.view.? (Poly%lib!single_delivery_state_v.CAckState. o!)) (lib!single_delivery_state_v.impl&%0.view.? (Poly%lib!single_delivery_state_v.CAckState. self!))))))))))))))))))))))))
(check-sat)
(exit)
