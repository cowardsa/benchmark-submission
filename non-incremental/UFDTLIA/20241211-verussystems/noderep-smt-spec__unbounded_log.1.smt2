...
(assert (has_type node_id! NAT))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (Sub (%I end!) (%I start!))) (=> (tr_bound%lib!Dispatch. DT&. DT&) (=> (<= (%I start!) (%I end!)) (or (and (=> (< (%I start!) (%I end!)) (or (and (=> (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log!) start!) (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! start!))) (%I node_id!)))) (=> (= tmp%2 (I (nClip (Add (%I start!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((log!$0 log!) (start!$1 tmp%2) (end!$2 end!) (node_id!$3 node_id!)) (Sub (%I end!$2) (%I start!$1))) decrease%init0 false)) (=> (= tmp%1 (lib!spec.unbounded_log.LogRangeNoNodeId.? DT&. DT& log! (I (nClip (Add (%I start!) 1))) end! node_id!)) (=> (= tmp%3 tmp%1) %%switch_label%%1))))) (=> (not (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log!) start!) (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! start!))) (%I node_id!))))) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 tmp%3) %%switch_label%%0)))) (=> (not (< (%I start!) (%I end!))) (=> (= tmp%4 true) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
