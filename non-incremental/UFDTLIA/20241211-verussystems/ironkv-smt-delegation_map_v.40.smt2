...
(assert (uInv SZ start@0))
(assert (uInv SZ tmp%1))
(assert (has_type (Poly%lib!delegation_map_v.StrictlyOrderedVec. tmp%2) (TYPE%lib!delegation_map_v.StrictlyOrderedVec. K&. K&)))
(assert (uInv SZ end@0))
(assert (uInv SZ tmp%7))
(assert (has_type (Poly%lib!delegation_map_v.StrictlyOrderedVec. tmp%8) (TYPE%lib!delegation_map_v.StrictlyOrderedVec. K&. K&)))
...
(assert (not (=> (has_type (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1) (TYPE%lib!delegation_map_v.StrictlyOrderedMap. K&. K&)) (=> (lib!delegation_map_v.impl&%3.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1)) (=> (and (<= start@0 end@0) (<= end@0 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1)))))))) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= start@0 (%I j$)) (< (%I j$) end@0)) (lib!delegation_map_v.impl&%2.above_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. hi!) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))) j$)))) :pattern ((vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))) j$)) )) (=> (= tmp%8 (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1)))) (=> (ens%lib!delegation_map_v.impl&%1.len. K&. K& tmp%8 tmp%7) (or (and (=> (< end@0 tmp%7) (=> (= tmp%10 (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1)))) (and (=> %%location_label%%0 (req%lib!delegation_map_v.impl&%1.index. K&. K& tmp%10 end@0)) (=> (ens%lib!delegation_map_v.impl&%1.index. K&. K& tmp%10 end@0 tmp%9) (=> (ens%lib!delegation_map_v.impl&%2.above. K&. K& hi! tmp%9 tmp%11) (=> (= tmp%12 tmp%11) %%switch_label%%0)))))) (=> (not (< end@0 tmp%7)) (=> (= tmp%12 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> tmp%12 (and (=> %%location_label%%1 (uInv SZ (Add end@0 1))) (=> (= end@1 (uClip SZ (Add end@0 1))) (and (=> %%location_label%%2 (lib!delegation_map_v.impl&%3.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))) (and (=> %%location_label%%3 (and (<= start@0 end@1) (<= end@1 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))))))) (=> %%location_label%%4 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= start@0 (%I j$)) (< (%I j$) end@1)) (lib!delegation_map_v.impl&%2.above_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. hi!) (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))) j$)))) :pattern ((vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/keys (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!@1))))) j$)) ))))))))))))))))))
(check-sat)
(exit)
