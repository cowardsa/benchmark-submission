...
(declare-const x! lib!keys_t.KeyIterator.)
(declare-const y! lib!keys_t.KeyIterator.)
(declare-const x_inner! lib!keys_t.KeyIterator.)
(declare-const y_inner! lib!keys_t.KeyIterator.)
...
(assert (has_type (Poly%lib!keys_t.KeyIterator. x!) (TYPE%lib!keys_t.KeyIterator. K&. K&)))
(assert (has_type (Poly%lib!keys_t.KeyIterator. y!) (TYPE%lib!keys_t.KeyIterator. K&. K&)))
(assert (has_type (Poly%lib!keys_t.KeyIterator. x_inner!) (TYPE%lib!keys_t.KeyIterator. K&. K&)))
(assert (has_type (Poly%lib!keys_t.KeyIterator. y_inner!) (TYPE%lib!keys_t.KeyIterator. K&. K&)))
(assert (tr_bound%lib!keys_t.KeyTrait. K&. K&))
(assert (tr_bound%lib!verus_extra.clone_v.VerusClone. K&. K&))
(assert (lib!delegation_map_v.impl&%4.range_consistent.? K&. K& (Poly%lib!delegation_map_v.DelegationMap. self!) (Poly%lib!keys_t.KeyIterator. x!) (Poly%lib!keys_t.KeyIterator. y!) (Poly%lib!io_t.EndPoint. dst!)))
(assert (lib!keys_t.impl&%3.geq_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. x_inner!) (Poly%lib!keys_t.KeyIterator. x!)))
(assert (not (lib!keys_t.impl&%3.lt_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. y!) (Poly%lib!keys_t.KeyIterator. y_inner!))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!keys_t.KeyTrait.cmp_properties. K&. K&) (=> %%location_label%%0 (lib!delegation_map_v.impl&%4.range_consistent.? K&. K& (Poly%lib!delegation_map_v.DelegationMap. self!) (Poly%lib!keys_t.KeyIterator. x_inner!) (Poly%lib!keys_t.KeyIterator. y_inner!) (Poly%lib!io_t.EndPoint. dst!))))))
(check-sat)
(exit)
