...
(assert (not (=> (= %return! (Poly%lib!keys_t.SHTKey. (lib!keys_t.SHTKey./SHTKey (%I (I (lib!keys_t.SHTKey./SHTKey/ukey (%Poly%lib!keys_t.SHTKey. self!))))))) (=> %%location_label%%0 (= %return! self!)))))
(check-sat)
(exit)
