...
(assert (has_type self! (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.)))
(assert (has_type other! (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.)))
(assert (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self!)))
(assert (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) other!)))
(assert (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) other!)))
...
(assert (not (or (and (=> (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self! other!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self! other!)) (=> (ens%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self! other!) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self!)))) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) other!))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 %%switch_label%%0)))))) (=> (not (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self! other!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self! other!)))))))
(check-sat)
(exit)
