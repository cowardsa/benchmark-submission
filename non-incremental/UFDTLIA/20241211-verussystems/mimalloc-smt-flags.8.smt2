...
(declare-const self! lib!types.PageInner.)
(declare-const x@ Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!types.PageInner. self!) TYPE%lib!types.PageInner.))
(set-info :comment ";; requires not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= x@ (lib!types.PageInner./PageInner/flags1 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!)))) (and (=> %%location_label%%0 true) (=> (=> (= x@ 0) (and (= (uClip 8 (bitand (I x@) (I 1))) 0) (= (uClip 8 (bitand (I x@) (I 2))) 0))) (=> (= b! (= (lib!types.PageInner./PageInner/flags1 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!))) 0)) (=> %%location_label%%1 (=> b! (and (not (lib!flags.impl&%0.in_full.? (Poly%lib!types.PageInner. self!))) (not (lib!flags.impl&%0.has_aligned.? (Poly%lib!types.PageInner. self!))))))))))))
(check-sat)
(exit)
