...
(assert (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (! (= (req%vstd!seq_lib.impl&%0.add_empty_right. A&. A& a! b!) (=> %%global_location_label%%106 (= (vstd!seq.Seq.len.? A&. A& b!) 0))) :pattern ((req%vstd!seq_lib.impl&%0.add_empty_right. A&. A& a! b!)) )))
...
(assert (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (! (= (req%vstd!seq_lib.impl&%0.add_empty_left. A&. A& a! b!) (=> %%global_location_label%%107 (= (vstd!seq.Seq.len.? A&. A& a!) 0))) :pattern ((req%vstd!seq_lib.impl&%0.add_empty_left. A&. A& a! b!)) )))
...
(set-info :comment ";; Function-Specs lib::spec::unbounded_log::combiner_request_ids_proof")
(declare-fun req%lib!spec.unbounded_log.combiner_request_ids_proof. (vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>.) Bool)
(declare-const %%global_location_label%%108 Bool)
(assert (forall ((combiners! vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>.)) (! (= (req%lib!spec.unbounded_log.combiner_request_ids_proof. combiners!) (=> %%global_location_label%%108 (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))))) :pattern ((req%lib!spec.unbounded_log.combiner_request_ids_proof. combiners!)) )))
(set-info :comment ";; Function-Def lib::spec::unbounded_log::combiner_request_ids_proof")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/unbounded_log.rs:1220:1: 1220:93 (#0)")
...
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!)))) (or (and (=> (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))) 0) (=> (= tmp%2 (vstd!set.impl&%0.empty.? $ NAT)) %%switch_label%%0)) (=> (not (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))) 0)) (=> (= node_id@ (%I (vstd!set.impl&%0.choose.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!))))) (=> (= tmp%1 (%Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. (vstd!map.impl&%0.remove.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!) (I node_id@)))) (and (=> %%location_label%%0 (check_decrease_int (let ((combiners!$0 tmp%1)) (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!$0)))) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!spec.unbounded_log.combiner_request_ids_proof. tmp%1)) (=> (= tmp%2 (vstd!set.impl&%0.union.? $ NAT (Poly%vstd!set.Set<nat.>. s1@) (lib!spec.utils.seq_to_set.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec.unbounded_log.impl&%7.queued_ops.? (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!spec.unbounded_log.CombinerState. (Poly%vstd!map.Map<nat./lib!spec.unbounded_log.CombinerState.>. combiners!) (I node_id@))))))) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
