...
(assert (and (<= logIndexLower! logIndexUpper!) (<= logIndexUpper! logLen!)))
...
(assert (= (%Poly%lib!spec.unbounded_log.UpdateState. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) new_updates! (I new_rid!))) (lib!spec.unbounded_log.UpdateState./Placed (lib!spec.types.LogEntry./LogEntry/op (%Poly%lib!spec.types.LogEntry. (Poly%lib!spec.types.LogEntry. log_entry!))) (%I (I logLen!)))))
...
(assert (= new_log! (vstd!map.impl&%0.insert.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! (I logLen!) (Poly%lib!spec.types.LogEntry. log_entry!))))
...
(assert (not (=> (= decrease%init0 (Sub logIndexUpper! logIndexLower!)) (or (and (=> (not (= logIndexLower! logIndexUpper!)) (=> (= tmp%1 (= (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)) (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! (I logIndexLower!)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (or (and (=> (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!) (=> (= tmp%2 (nClip (Add queueIndex! 1))) (=> (= tmp%3 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%1 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (new_log!$2 new_log!) (queueIndex!$3 tmp%2) (logIndexLower!$4 tmp%3) (logIndexUpper!$5 logIndexUpper!) (logLen!$6 logLen!) (node_id!$7 node_id!) (updates!$8 updates!) (new_updates!$9 new_updates!) (new_rid!$10 new_rid!) (log_entry!$11 log_entry!)) (Sub logIndexUpper!$5 logIndexLower!$4)) decrease%init0 false)) (and (=> %%location_label%%2 (req%lib!spec.unbounded_log.LogRangeMatchesQueue_append_other. DT&. DT& queue! log! new_log! tmp%2 tmp%3 logIndexUpper! logLen! node_id! updates! new_updates! new_rid! log_entry!)) (=> (ens%lib!spec.unbounded_log.LogRangeMatchesQueue_append_other. DT&. DT& queue! log! new_log! tmp%2 tmp%3 logIndexUpper! logLen! node_id! updates! new_updates! new_rid! log_entry!) %%switch_label%%1)))))) (=> (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!)) (=> (= tmp%4 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%3 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (new_log!$2 new_log!) (queueIndex!$3 queueIndex!) (logIndexLower!$4 tmp%4) (logIndexUpper!$5 logIndexUpper!) (logLen!$6 logLen!) (node_id!$7 node_id!) (updates!$8 updates!) (new_updates!$9 new_updates!) (new_rid!$10 new_rid!) (log_entry!$11 log_entry!)) (Sub logIndexUpper!$5 logIndexLower!$4)) decrease%init0 false)) (and (=> %%location_label%%4 (req%lib!spec.unbounded_log.LogRangeMatchesQueue_append_other. DT&. DT& queue! log! new_log! queueIndex! tmp%4 logIndexUpper! logLen! node_id! updates! new_updates! new_rid! log_entry!)) (=> (ens%lib!spec.unbounded_log.LogRangeMatchesQueue_append_other. DT&. DT& queue! log! new_log! queueIndex! tmp%4 logIndexUpper! logLen! node_id! updates! new_updates! new_rid! log_entry!) %%switch_label%%1)))))) (and (not %%switch_label%%1) %%switch_label%%0)))))) (=> (not (not (= logIndexLower! logIndexUpper!))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%5 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (Poly%vstd!seq.Seq<nat.>. queue!) new_log! (I queueIndex!) (I logIndexLower!) (I logIndexUpper!) (I node_id!) new_updates!)))))))
(check-sat)
(exit)
