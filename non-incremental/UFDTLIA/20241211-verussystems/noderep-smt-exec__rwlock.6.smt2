...
(declare-const write_handle! lib!exec.rwlock.RwLockWriteGuard.)
(declare-const verus_tmp_cell_perms@ Poly)
(declare-const verus_tmp_handle@ Poly)
(declare-const verus_tmp_cell_perms$1@0 Poly)
...
(declare-const exc_guard@ Poly)
(declare-const verus_tmp$2@ tuple%2.)
...
(declare-const verus_tmp$5@0 tuple%0.)
(declare-const atomic@ vstd!atomic_ghost.AtomicBool.)
(declare-const credit@ vstd!invariant.OpenInvariantCredit.)
(declare-const verus_tmp@ lib!exec.rwlock.RwLockWriteGuard.)
(declare-const cell_perms@0 Poly)
(declare-const handle@0 Poly)
(declare-const verus_tmp$1@ Poly)
(declare-const cell_perms$1@0 Poly)
(declare-const res@ tuple%0.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!exec.rwlock.RwLock. self!) (TYPE%lib!exec.rwlock.RwLock. T&. T&)))
(assert (has_type val! T&))
(assert (has_type (Poly%lib!exec.rwlock.RwLockWriteGuard. write_handle!) (TYPE%lib!exec.rwlock.RwLockWriteGuard. T&. T&)))
(assert (and (and (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!)) (lib!exec.rwlock.impl&%4.inv.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!) val!)) (lib!exec.rwlock.impl&%4.wf_write_handle.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!) (Poly%lib!exec.rwlock.RwLockWriteGuard. write_handle!))))
(declare-const cell_perms@1 Poly)
(declare-const handle@1 Poly)
(declare-const cell_perms$1@1 Poly)
(declare-const cell_perms$1@2 Poly)
...
(declare-const verus_tmp$5@1 tuple%0.)
...
(assert (not (=> (= verus_tmp@ write_handle!) (=> (= verus_tmp_cell_perms@ (lib!exec.rwlock.RwLockWriteGuard./RwLockWriteGuard/cell_perms (%Poly%lib!exec.rwlock.RwLockWriteGuard. (Poly%lib!exec.rwlock.RwLockWriteGuard. verus_tmp@)))) (=> (= verus_tmp_handle@ (lib!exec.rwlock.RwLockWriteGuard./RwLockWriteGuard/handle (%Poly%lib!exec.rwlock.RwLockWriteGuard. (Poly%lib!exec.rwlock.RwLockWriteGuard. verus_tmp@)))) (=> (= cell_perms@1 verus_tmp_cell_perms@) (=> (= handle@1 verus_tmp_handle@) (=> (= verus_tmp$1@ cell_perms@1) (=> (= verus_tmp_cell_perms$1@0 verus_tmp$1@) (=> (= cell_perms$1@1 verus_tmp_cell_perms$1@0) (=> (= tmp%1 (lib!exec.rwlock.RwLock./RwLock/data (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. self!)))) (and (=> %%location_label%%0 (req%vstd!cell.impl&%3.put. T&. T& tmp%1 cell_perms$1@1 val!)) (=> (has_type cell_perms$1@2 (TYPE%vstd!cell.PointsTo. T&. T&)) (=> (ens%vstd!cell.impl&%3.put. T&. T& tmp%1 cell_perms$1@1 cell_perms$1@2 val!) (=> (= atomic@ (%Poly%vstd!atomic_ghost.AtomicBool. (lib!exec.CachePadded./CachePadded/0 (%Poly%lib!exec.CachePadded. (Poly%lib!exec.CachePadded. (lib!exec.rwlock.RwLock./RwLock/exc_locked (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. self!)))))))) (=> (= tmp%2 (vstd!atomic_ghost.AtomicBool./AtomicBool/atomic_inv (%Poly%vstd!atomic_ghost.AtomicBool. (Poly%vstd!atomic_ghost.AtomicBool. atomic@)))) (=> (has_type (Poly%tuple%2. pair@0) (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionBool. $ (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&)))) (=> (vstd!invariant.AtomicInvariant.inv.? $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionBool. $ (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&))) $ (TYPE%vstd!atomic_ghost.AtomicPredBool. $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_exc_locked.) tmp%2 (Poly%tuple%2. pair@0)) (=> (= verus_tmp$2@ pair@0) (=> (= verus_tmp_perm@0 (%Poly%vstd!atomic.PermissionBool. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. verus_tmp$2@))))) (=> (= verus_tmp_g@0 (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. verus_tmp$2@)))) (=> (= perm@1 verus_tmp_perm@0) (=> (= g@1 verus_tmp_g@0) (=> (= verus_tmp$3@1 (vstd!atomic.PermissionDataBool./PermissionDataBool/value (%Poly%vstd!atomic.PermissionDataBool. (Poly%vstd!atomic.PermissionDataBool. (vstd!atomic.impl&%0.view.? (Poly%vstd!atomic.PermissionBool. perm@1)))))) (=> (= tmp%3 (vstd!atomic_ghost.AtomicBool./AtomicBool/patomic (%Poly%vstd!atomic_ghost.AtomicBool. (Poly%vstd!atomic_ghost.AtomicBool. atomic@)))) (and (=> %%location_label%%1 (req%vstd!atomic.impl&%1.store. tmp%3 perm@1 false)) (=> (ens%vstd!atomic.impl&%1.store. tmp%3 perm@1 perm@2 false) (=> (= verus_tmp$4@1 (vstd!atomic.PermissionDataBool./PermissionDataBool/value (%Poly%vstd!atomic.PermissionDataBool. (Poly%vstd!atomic.PermissionDataBool. (vstd!atomic.impl&%0.view.? (Poly%vstd!atomic.PermissionBool. perm@2)))))) (=> (= verus_tmp$5@1 tuple%0./tuple%0) (=> (= exc_guard@ handle@1) (=> (= tmp%4 (lib!exec.rwlock.RwLock./RwLock/inst (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. self!)))) (and (=> %%location_label%%2 (req%lib!spec.rwlock.RwLockSpec.impl&%10.exc_release. $ (TYPE%vstd!cell.PointsTo. T&. T&) tmp%4 cell_perms$1@2 cell_perms$1@2 g@1 exc_guard@)) (=> (has_type g@2 (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&))) (=> (ens%lib!spec.rwlock.RwLockSpec.impl&%10.exc_release. $ (TYPE%vstd!cell.PointsTo. T&. T&) tmp%4 cell_perms$1@2 cell_perms$1@2 g@1 g@2 exc_guard@) (=> (= pair@1 (tuple%2./tuple%2 (Poly%vstd!atomic.PermissionBool. perm@2) g@2)) (and (=> %%location_label%%3 (vstd!invariant.AtomicInvariant.inv.? $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionBool. $ (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&))) $ (TYPE%vstd!atomic_ghost.AtomicPredBool. $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_exc_locked.) tmp%2 (Poly%tuple%2. pair@1))) (=> (= res@ tuple%0./tuple%0) (=> %%location_label%%4 (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
