...
(assert (has_type (Poly%core!option.Option. ov!) (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL))))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%core!option.impl&%0.as_ref. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) ov! tmp%%@) (or (and (=> (is-core!option.Option./Some_ tmp%%@) (=> (= v@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@))))) (=> (ens%lib!args_t.clone_vec_u8. v@ tmp%1) (=> (= tmp%2 (core!option.Option./Some (Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%1))) %%switch_label%%0)))) (=> (not (is-core!option.Option./Some_ tmp%%@)) (=> (= tmp%2 core!option.Option./None) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= res! tmp%2) (=> %%location_label%%0 (= (lib!cmessage_v.optional_value_view.? (Poly%core!option.Option. ov!)) (lib!cmessage_v.optional_value_view.? (Poly%core!option.Option. res!))))))))))
(check-sat)
(exit)
