...
(declare-const queue! vstd!seq.Seq<nat.>.)
(declare-const log! Poly)
(declare-const new_log! Poly)
(declare-const queueIndex! Int)
(declare-const logIndexLower! Int)
(declare-const logIndexUpper! Int)
(declare-const node_id! Int)
(declare-const updates! Poly)
(declare-const new_updates! Poly)
(declare-const new_rid! Int)
(declare-const log_entry! lib!spec.types.LogEntry.)
...
(assert (has_type new_log! (TYPE%vstd!map.Map. $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&))))
(assert (<= 0 queueIndex!))
(assert (<= 0 logIndexLower!))
(assert (<= 0 logIndexUpper!))
(assert (<= 0 node_id!))
(assert (has_type updates! (TYPE%vstd!map.Map. $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&))))
(assert (has_type new_updates! (TYPE%vstd!map.Map. $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&))))
(assert (<= 0 new_rid!))
(assert (has_type (Poly%lib!spec.types.LogEntry. log_entry!) (TYPE%lib!spec.types.LogEntry. DT&. DT&)))
(assert (tr_bound%lib!Dispatch. DT&. DT&))
(assert (and (<= 0 queueIndex!) (<= queueIndex! (vstd!seq.Seq.len.? $ NAT (Poly%vstd!seq.Seq<nat.>. queue!)))))
(assert (<= logIndexLower! logIndexUpper!))
(assert (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (Poly%lib!spec.types.LogEntry. log_entry!))) node_id!))
(assert (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) new_updates!) (I new_rid!)))
(assert (= (%Poly%lib!spec.unbounded_log.UpdateState. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) new_updates! (I new_rid!))) (lib!spec.unbounded_log.UpdateState./Placed (lib!spec.types.LogEntry./LogEntry/op (%Poly%lib!spec.types.LogEntry. (Poly%lib!spec.types.LogEntry. log_entry!))) (%I (I logIndexUpper!)))))
(assert (not (vstd!seq_lib.impl&%0.contains.? $ NAT (Poly%vstd!seq.Seq<nat.>. queue!) (I new_rid!))))
(assert (forall ((rid$ Poly)) (! (=> (has_type rid$ NAT) (=> (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates!) rid$) (not (= (%I rid$) new_rid!))) (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) new_updates!) rid$) (= (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) new_updates! rid$) (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates! rid$))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.unbounded_log.UpdateState. DT&. DT&) updates!) rid$)) )))
(assert (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (Poly%vstd!seq.Seq<nat.>. queue!) log! (I queueIndex!) (I logIndexLower!) (I logIndexUpper!) (I node_id!) updates!))
(assert (= new_log! (vstd!map.impl&%0.insert.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! (I logIndexUpper!) (Poly%lib!spec.types.LogEntry. log_entry!))))
...
(assert (not (=> (= decrease%init0 (Sub logIndexUpper! logIndexLower!)) (or (and (=> (= logIndexLower! (nClip (Add logIndexUpper! 1))) %%switch_label%%0) (=> (not (= logIndexLower! (nClip (Add logIndexUpper! 1)))) (or (and (=> (= logIndexLower! logIndexUpper!) (=> (= tmp%1 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log!) (I logIndexLower!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (or (and (=> (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!) (=> (= tmp%2 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (vstd!seq.Seq.push.? $ NAT (Poly%vstd!seq.Seq<nat.>. queue!) (I new_rid!)) new_log! (I (nClip (Add queueIndex! 1))) (I (nClip (Add logIndexLower! 1))) (I (nClip (Add logIndexUpper! 1))) (I node_id!) new_updates!)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%3)))) (=> (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!)) %%switch_label%%3)) (and (not %%switch_label%%3) (or (and (=> (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!)) (=> (= tmp%3 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (vstd!seq.Seq.push.? $ NAT (Poly%vstd!seq.Seq<nat.>. queue!) (I new_rid!)) new_log! (I queueIndex!) (I (nClip (Add logIndexLower! 1))) (I (nClip (Add logIndexUpper! 1))) (I node_id!) new_updates!)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%2)))) (=> (not (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!))) %%switch_label%%2)) (and (not %%switch_label%%2) %%switch_label%%1)))))))) (=> (not (= logIndexLower! logIndexUpper!)) (=> (= tmp%4 (= (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)) (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! (I logIndexLower!)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (or (and (=> (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!) (=> (= tmp%5 (nClip (Add queueIndex! 1))) (=> (= tmp%6 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%4 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (new_log!$2 new_log!) (queueIndex!$3 tmp%5) (logIndexLower!$4 tmp%6) (logIndexUpper!$5 logIndexUpper!) (node_id!$6 node_id!) (updates!$7 updates!) (new_updates!$8 new_updates!) (new_rid!$9 new_rid!) (log_entry!$10 log_entry!)) (Sub logIndexUpper!$5 logIndexLower!$4)) decrease%init0 false)) (and (=> %%location_label%%5 (req%lib!spec.unbounded_log.LogRangeMatchesQueue_append. DT&. DT& queue! log! new_log! tmp%5 tmp%6 logIndexUpper! node_id! updates! new_updates! new_rid! log_entry!)) (=> (ens%lib!spec.unbounded_log.LogRangeMatchesQueue_append. DT&. DT& queue! log! new_log! tmp%5 tmp%6 logIndexUpper! node_id! updates! new_updates! new_rid! log_entry!) (=> (= tmp%7 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (vstd!seq.Seq.push.? $ NAT (Poly%vstd!seq.Seq<nat.>. queue!) (I new_rid!)) new_log! (I queueIndex!) (I logIndexLower!) (I (nClip (Add logIndexUpper! 1))) (I node_id!) new_updates!)) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 %%switch_label%%4))))))))) (=> (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!)) (=> (= tmp%8 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%7 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (new_log!$2 new_log!) (queueIndex!$3 queueIndex!) (logIndexLower!$4 tmp%8) (logIndexUpper!$5 logIndexUpper!) (node_id!$6 node_id!) (updates!$7 updates!) (new_updates!$8 new_updates!) (new_rid!$9 new_rid!) (log_entry!$10 log_entry!)) (Sub logIndexUpper!$5 logIndexLower!$4)) decrease%init0 false)) (and (=> %%location_label%%8 (req%lib!spec.unbounded_log.LogRangeMatchesQueue_append. DT&. DT& queue! log! new_log! queueIndex! tmp%8 logIndexUpper! node_id! updates! new_updates! new_rid! log_entry!)) (=> (ens%lib!spec.unbounded_log.LogRangeMatchesQueue_append. DT&. DT& queue! log! new_log! queueIndex! tmp%8 logIndexUpper! node_id! updates! new_updates! new_rid! log_entry!) %%switch_label%%4)))))) (and (not %%switch_label%%4) %%switch_label%%1))))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%9 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (vstd!seq.Seq.push.? $ NAT (Poly%vstd!seq.Seq<nat.>. queue!) (I new_rid!)) new_log! (I queueIndex!) (I logIndexLower!) (I (nClip (Add logIndexUpper! 1))) (I node_id!) new_updates!)))))))
(check-sat)
(exit)
