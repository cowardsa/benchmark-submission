...
(set-info :comment ";; MODULE 'module single_delivery_t'")
...
(set-info :comment ";; Function-Recommends lib::single_delivery_t::ack_state_lookup")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:55:1: 55:113 (#0)")
...
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::send_single_message")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:165:5: 165:178 (#0)")
...
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::send_no_message")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:195:5: 195:77 (#0)")
...
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::receive_no_message")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:189:5: 189:80 (#0)")
...
(set-info :comment ";; Spec-Termination lib::single_delivery_t::truncate_un_ack_list")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:30:1: 30:118 (#0)")
(set-info :comment ";; Function-Recommends lib::single_delivery_t::truncate_un_ack_list")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:30:1: 30:118 (#0)")
...
(assert (forall ((MT&. Dcr) (MT& Type) (pre! Poly) (post! Poly) (pkt! Poly) (acks! Poly)) (! (= (req%lib!single_delivery_t.impl&%1.receive_ack. MT&. MT& pre! post! pkt! acks!) (=> %%global_location_label%%6 (is-lib!single_message_t.SingleMessage./Ack_ (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))) :pattern ((req%lib!single_delivery_t.impl&%1.receive_ack. MT&. MT& pre! post! pkt! acks!)) )))
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::receive_ack")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:83:5: 83:104 (#0)")
...
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::new_single_message")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:76:5: 76:76 (#0)")
...
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::receive_real_packet")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:103:5: 103:89 (#0)")
...
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::should_ack_single_message")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:114:5: 114:83 (#0)")
...
(assert (forall ((MT&. Dcr) (MT& Type) (self! Poly) (pkt! Poly) (ack! Poly) (acks! Poly)) (! (= (req%lib!single_delivery_t.impl&%1.send_ack. MT&. MT& self! pkt! ack! acks!) (=> %%global_location_label%%7 (lib!single_delivery_t.impl&%1.should_ack_single_message.? MT&. MT& self! pkt!))) :pattern ((req%lib!single_delivery_t.impl&%1.send_ack. MT&. MT& self! pkt! ack! acks!)) )))
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::send_ack")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:124:5: 124:97 (#0)")
...
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::maybe_ack_packet")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:136:5: 136:110 (#0)")
...
(set-info :comment ";; Function-Recommends lib::single_delivery_t::SingleDelivery::receive")
(set-info :comment ";; ironsht/src/single_delivery_t.rs:145:5: 145:113 (#0)")
...
(declare-const ack! Poly)
(declare-const acks! Poly)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Bool)
(declare-const tmp%%@ lib!single_message_t.SingleMessage.)
...
(assert (has_type ack! TYPE%lib!network_t.Packet.))
(assert (has_type acks! (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= tmp%%@ (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))) (or (and (=> (is-lib!single_message_t.SingleMessage./Ack_ tmp%%@) (and (=> %%location_label%%0 (req%lib!single_delivery_t.impl&%1.receive_ack. MT&. MT& pre! post! pkt! acks!)) (=> (= tmp%1 (lib!single_delivery_t.impl&%1.receive_ack.? MT&. MT& pre! post! pkt! acks!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (is-lib!single_message_t.SingleMessage./Ack_ tmp%%@)) (=> (= tmp%2 (ite (is-lib!single_message_t.SingleMessage./Message_ tmp%%@) (let ((seqno$ (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. tmp%%@))))) (let ((m$ (%Poly%lib!message_t.Message. (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. tmp%%@)))))) (and (lib!single_delivery_t.impl&%1.receive_real_packet.? MT&. MT& pre! post! pkt!) (lib!single_delivery_t.impl&%1.maybe_ack_packet.? MT&. MT& post! pkt! ack! acks!)))) (and (= post! pre!) (= acks! (vstd!set.impl&%0.empty.? $ TYPE%lib!network_t.Packet.))))) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
