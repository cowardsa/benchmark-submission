...
(set-info :comment ";; MODULE 'module net_sht_v, function lib::net_sht_v::sht_marshal_data_injective'")
...
(assert (forall ((A&. Dcr) (A& Type) (self! Poly)) (! (= (req%vstd!seq_lib.impl&%0.drop_last. A&. A& self!) (=> %%global_location_label%%5 (>= (vstd!seq.Seq.len.? A&. A& self!) 1))) :pattern ((req%vstd!seq_lib.impl&%0.drop_last. A&. A& self!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly)) (! (= (req%lib!marshal_v.Marshalable.ghost_serialize. Self%&. Self%& self!) (=> %%global_location_label%%7 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& self!)))) :pattern ((req%lib!marshal_v.Marshalable.ghost_serialize. Self%&. Self%& self!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (other! Poly)) (! (= (req%lib!marshal_v.Marshalable.lemma_serialize_injective. Self%&. Self%& self! other!) (and (=> %%global_location_label%%8 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& self!))) (=> %%global_location_label%%9 (%B (lib!marshal_v.Marshalable.is_marshalable.? Self%&. Self%& other!))) (=> %%global_location_label%%10 (= (lib!marshal_v.Marshalable.ghost_serialize.? Self%&. Self%& self!) (lib!marshal_v.Marshalable.ghost_serialize.? Self%&. Self%& other!))))) :pattern ((req%lib!marshal_v.Marshalable.lemma_serialize_injective. Self%&. Self%& self! other!)) )))
...
(assert (forall ((a! lib!cmessage_v.CSingleMessage.) (b! lib!cmessage_v.CSingleMessage.)) (! (= (req%lib!net_sht_v.sht_marshal_data_injective. a! b!) (and (=> %%global_location_label%%11 (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. a!)))) (=> %%global_location_label%%12 (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. b!)))) (=> %%global_location_label%%13 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. a!)) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. b!)))))) :pattern ((req%lib!net_sht_v.sht_marshal_data_injective. a! b!)) )))
...
(set-info :comment ";; Function-Def lib::net_sht_v::sht_marshal_data_injective")
(set-info :comment ";; ironsht/src/net_sht_v.rs:78:1: 78:80 (#0)")
(declare-const a! lib!cmessage_v.CSingleMessage.)
(declare-const b! lib!cmessage_v.CSingleMessage.)
(declare-const tmp%1 Bool)
(assert fuel_defaults)
(assert (has_type (Poly%lib!cmessage_v.CSingleMessage. a!) TYPE%lib!cmessage_v.CSingleMessage.))
(assert (has_type (Poly%lib!cmessage_v.CSingleMessage. b!) TYPE%lib!cmessage_v.CSingleMessage.))
(assert (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. a!))))
(assert (%B (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. b!))))
(assert (= (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. a!)) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. b!))))
...
(assert (not (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_serialize_injective. $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. a!) (Poly%lib!cmessage_v.CSingleMessage. b!))) (=> (ens%lib!marshal_v.Marshalable.lemma_serialize_injective. $ TYPE%lib!cmessage_v.CSingleMessage. (Poly%lib!cmessage_v.CSingleMessage. a!) (Poly%lib!cmessage_v.CSingleMessage. b!)) (=> (= tmp%1 (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. a!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. b!)))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (= (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. a!)) (lib!cmessage_v.impl&%2.view.? (Poly%lib!cmessage_v.CSingleMessage. b!)))))))))))
(check-sat)
(exit)
