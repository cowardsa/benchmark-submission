...
(declare-const id! Poly)
(declare-const args! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Bool)
(declare-const tmp%3 Poly)
(declare-const tmp%4 Poly)
(declare-const tmp%5 Poly)
(declare-const root_identity@ lib!abstract_end_point_t.AbstractEndPoint.)
(declare-const params@ lib!abstract_parameters_t.AbstractParameters.)
(declare-const tmp%6 Bool)
(declare-const end_points@ core!option.Option.)
(assert fuel_defaults)
(assert (has_type pre! TYPE%lib!host_protocol_t.AbstractHostState.))
(assert (has_type id! TYPE%lib!abstract_end_point_t.AbstractEndPoint.))
(assert (has_type args! (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))))
...
(assert (not (=> (= end_points@ (lib!host_protocol_t.parse_args.? args!)) (or (and (=> (is-core!option.Option./None_ end_points@) (=> (= tmp%2 true) %%switch_label%%1)) (=> (not (is-core!option.Option./None_ end_points@)) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ (TYPE%vstd!seq.Seq. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (Poly%core!option.Option. end_points@))) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. end_points@)))) (=> (= tmp%2 (= (vstd!seq.Seq.len.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. tmp%1) 0)) %%switch_label%%1))))) (and (not %%switch_label%%1) (or (and (=> tmp%2 (=> (= tmp%6 false) %%switch_label%%0)) (=> (not tmp%2) (and (=> %%location_label%%1 (req%vstd!std_specs.option.spec_unwrap. $ (TYPE%vstd!seq.Seq. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (Poly%core!option.Option. end_points@))) (=> (= tmp%3 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. end_points@)))) (and (=> %%location_label%%2 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. tmp%3 (I 0))) (=> (= tmp%4 (vstd!seq.Seq.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. tmp%3 (I 0))) (=> (= root_identity@ (%Poly%lib!abstract_end_point_t.AbstractEndPoint. tmp%4)) (=> (= params@ (lib!abstract_parameters_t.impl&%0.static_params.? (I 0))) (and (=> %%location_label%%3 (req%vstd!std_specs.option.spec_unwrap. $ (TYPE%vstd!seq.Seq. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (Poly%core!option.Option. end_points@))) (=> (= tmp%5 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. end_points@)))) (=> (= tmp%6 (= (%Poly%lib!host_protocol_t.AbstractHostState. pre!) (lib!host_protocol_t.AbstractHostState./AbstractHostState (%Poly%lib!host_protocol_t.AbstractConstants. (Poly%lib!host_protocol_t.AbstractConstants. (lib!host_protocol_t.AbstractConstants./AbstractConstants (%Poly%lib!abstract_end_point_t.AbstractEndPoint. (Poly%lib!abstract_end_point_t.AbstractEndPoint. root_identity@)) (%Poly%vstd!seq.Seq<lib!abstract_end_point_t.AbstractEndPoint.>. tmp%5) (%Poly%lib!abstract_parameters_t.AbstractParameters. (Poly%lib!abstract_parameters_t.AbstractParameters. params@)) (%Poly%lib!abstract_end_point_t.AbstractEndPoint. id!)))) (%Poly%lib!delegation_map_t.AbstractDelegationMap. (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!delegation_map_t.impl&%0.init.? (Poly%lib!abstract_end_point_t.AbstractEndPoint. root_identity@)))) (%Poly%vstd!map.Map<lib!keys_t.SHTKey./vstd!seq.Seq<u8.>.>. (vstd!map.impl&%0.empty.? $ TYPE%lib!keys_t.SHTKey. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (%Poly%lib!single_delivery_t.SingleDelivery. (Poly%lib!single_delivery_t.SingleDelivery. (lib!single_delivery_t.impl&%1.init.? $ TYPE%lib!message_t.Message.))) (%Poly%core!option.Option. (Poly%core!option.Option. core!option.Option./None)) (%I (I 1)) (%Poly%vstd!seq.Seq<lib!abstract_service_t.AppRequest.>. (vstd!seq.Seq.empty.? $ TYPE%lib!abstract_service_t.AppRequest.))))) %%switch_label%%0))))))))))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
