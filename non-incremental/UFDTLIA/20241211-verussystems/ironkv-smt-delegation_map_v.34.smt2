...
(declare-const o! core!option.Option.)
(declare-const self! lib!delegation_map_v.StrictlyOrderedMap.)
(declare-const k! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>.)
(declare-const i@ Int)
...
(assert (not (and (=> %%location_label%%0 (req%lib!delegation_map_v.impl&%3.find_key. K&. K& self! k!)) (=> (ens%lib!delegation_map_v.impl&%3.find_key. K&. K& self! k! tmp%%@) (or (and (=> (is-core!option.Option./None_ tmp%%@) (=> (= tmp%3 core!option.Option./None) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ tmp%%@)) (=> (= i@ (%I (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@))))) (=> (= tmp%2 (lib!delegation_map_v.StrictlyOrderedMap./StrictlyOrderedMap/vals (%Poly%lib!delegation_map_v.StrictlyOrderedMap. (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)))) (and (=> %%location_label%%1 (req%vstd!std_specs.vec.vec_index. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. tmp%2) i@)) (=> (ens%vstd!std_specs.vec.vec_index. $ TYPE%lib!io_t.EndPoint. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!io_t.EndPoint./allocator_global%.>. tmp%2) i@ tmp%1) (=> (= tmp%3 (core!option.Option./Some tmp%1)) %%switch_label%%0))))))) (and (not %%switch_label%%0) (=> (= o! tmp%3) (=> %%location_label%%2 (ite (is-core!option.Option./None_ o!) (not (vstd!set.impl&%0.contains.? K&. K& (vstd!map.impl&%0.dom.? K&. K& $ TYPE%lib!io_t.EndPoint. (lib!delegation_map_v.impl&%3.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!))) k!)) (let ((v$ (%Poly%lib!io_t.EndPoint. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. o!)))))) (= (%Poly%lib!io_t.EndPoint. (vstd!map.impl&%0.index.? K&. K& $ TYPE%lib!io_t.EndPoint. (lib!delegation_map_v.impl&%3.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedMap. self!)) k!)) v$)))))))))))
(check-sat)
(exit)
