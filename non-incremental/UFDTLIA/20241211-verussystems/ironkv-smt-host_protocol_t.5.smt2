...
(assert (has_type reqm! TYPE%lib!message_t.Message.))
(assert (has_type sm! (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)))
(assert (has_type replym! TYPE%lib!message_t.Message.))
...
(assert (not (=> (lib!delegation_map_t.impl&%0.is_complete.? (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (=> (is-lib!message_t.Message./SetRequest_ (%Poly%lib!message_t.Message. reqm!)) (=> (= k@ (lib!message_t.Message./SetRequest/key (%Poly%lib!message_t.Message. reqm!))) (=> (= ov@ (lib!message_t.Message./SetRequest/value (%Poly%lib!message_t.Message. reqm!))) (=> (= tmp%1 (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (=> %%location_label%%0 (req%lib!delegation_map_t.impl&%0.spec_index. tmp%1 (Poly%lib!keys_t.SHTKey. k@))))))))))
(check-sat)
(exit)
