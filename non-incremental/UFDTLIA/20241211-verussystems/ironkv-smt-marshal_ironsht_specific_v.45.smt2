...
(assert (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self! other!)))
...
(assert (not (=> (= tmp%1 (Poly%tuple%2. (lib!marshal_ironsht_specific_v.impl&%5.forward_bijection_for_view_equality_do_not_use_for_anything_else.? self!))) (=> (= tmp%2 (Poly%tuple%2. (lib!marshal_ironsht_specific_v.impl&%5.forward_bijection_for_view_equality_do_not_use_for_anything_else.? other!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (TYPE%tuple%2. $ (TYPE%core!option.Option. $ (UINT 64)) $ (TYPE%core!option.Option. $ (UINT 64))) tmp%1 tmp%2)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (TYPE%tuple%2. $ (TYPE%core!option.Option. $ (UINT 64)) $ (TYPE%core!option.Option. $ (UINT 64))) tmp%1 tmp%2) (and (=> %%location_label%%1 (= (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self!) (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) other!))) (=> %%location_label%%2 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) other!))))))))))
(check-sat)
(exit)
