...
(assert (has_type s! (TYPE%vstd!set.Set. $ TYPE%lib!tokens.SegmentId.)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? $ TYPE%lib!tokens.SegmentId. s!)) (=> (vstd!set.impl&%0.finite.? $ TYPE%lib!tokens.SegmentId. s!) (or (and (=> (= (vstd!set.impl&%0.len.? $ TYPE%lib!tokens.SegmentId. s!) 0) (=> (= tmp%3 0) %%switch_label%%0)) (=> (not (= (vstd!set.impl&%0.len.? $ TYPE%lib!tokens.SegmentId. s!) 0)) (=> (= x@ (%Poly%lib!tokens.SegmentId. (vstd!set.impl&%0.choose.? $ TYPE%lib!tokens.SegmentId. s!))) (=> (= tmp%2 (vstd!set.impl&%0.remove.? $ TYPE%lib!tokens.SegmentId. s! (Poly%lib!tokens.SegmentId. x@))) (and (=> %%location_label%%0 (check_decrease_int (let ((s!$0 (%Poly%vstd!set.Set<lib!tokens.SegmentId.>. tmp%2))) (vstd!set.impl&%0.len.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!$0))) decrease%init0 false)) (=> (= tmp%1 (lib!tokens.segment_u_max.? (vstd!set.impl&%0.remove.? $ TYPE%lib!tokens.SegmentId. s! (Poly%lib!tokens.SegmentId. x@)))) (=> (= tmp%3 (vstd!math.max.? (I tmp%1) (I (lib!tokens.SegmentId./SegmentId/uniq (%Poly%lib!tokens.SegmentId. (Poly%lib!tokens.SegmentId. x@)))))) %%switch_label%%0))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
