...
(set-info :comment ";; MODULE 'module pmem::pmemmock_t'")
...
(declare-const fuel%lib!pmem.pmemmock_t.impl&%1.inv. FuelId)
(declare-const fuel%lib!pmem.pmemmock_t.impl&%3.inv. FuelId)
...
(assert (distinct fuel%vstd!std_specs.option.is_none. fuel%vstd!std_specs.vec.impl&%0.spec_index. fuel%vstd!std_specs.vec.axiom_spec_len. fuel%vstd!std_specs.vec.axiom_vec_index_decreases. fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_subrange_decreases. fuel%vstd!seq.axiom_seq_new_len. fuel%vstd!seq.axiom_seq_new_index. fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq.axiom_seq_subrange_len. fuel%vstd!seq.axiom_seq_subrange_index. fuel%vstd!seq_lib.impl&%0.map. fuel%vstd!slice.impl&%2.spec_index. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view. fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view. fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%20.view. fuel%vstd!view.impl&%24.view. fuel%lib!pmem.pmemmock_t.impl&%1.inv. fuel%lib!pmem.pmemmock_t.impl&%3.inv. fuel%lib!pmem.pmemspec_t.maybe_corrupted. fuel%lib!pmem.pmemspec_t.impl&%5.write. fuel%lib!pmem.pmemspec_t.impl&%5.flush_byte. fuel%lib!pmem.pmemspec_t.impl&%5.flush. fuel%lib!pmem.pmemspec_t.impl&%6.len. fuel%lib!pmem.pmemspec_t.impl&%6.write. fuel%lib!pmem.pmemspec_t.impl&%6.flush. fuel%lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes_in_range. fuel%lib!pmem.pmemspec_t.impl&%6.committed. fuel%lib!pmem.pmemspec_t.impl&%7.len. fuel%lib!pmem.pmemspec_t.impl&%7.spec_index. fuel%lib!pmem.pmemspec_t.impl&%7.write. fuel%lib!pmem.pmemspec_t.impl&%7.flush. fuel%lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes_in_range. fuel%lib!pmem.pmcopy_t.impl&%0.bytes_parseable. fuel%lib!pmem.pmcopy_t.impl&%7.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%19.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%27.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%55.spec_size_of. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(declare-sort alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. 0)
...
(declare-datatypes ((core!option.Option. 0) (core!result.Result. 0) (vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. 0) (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. 0) (lib!pmem.pmemspec_t.PmemError. 0) (lib!pmem.pmemspec_t.PersistentMemoryByte. 0) (lib!pmem.pmemspec_t.PersistentMemoryRegionView. 0) (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. 0) (lib!pmem.pmemspec_t.PersistentMemoryConstants. 0) (tuple%0. 0)) (((core!option.Option./None ) (core!option.Option./Some (core!option.Option./Some/?0 Poly))) ((core!result.Result./Ok (core!result.Result./Ok/?0 Poly)) (core!result.Result./Err (core!result.Result./Err/?0 Poly))) ((vstd!raw_ptr.Metadata./Thin ) (vstd!raw_ptr.Metadata./Length (vstd!raw_ptr.Metadata./Length/?0 Int)) (vstd!raw_ptr.Metadata./Dyn (vstd!raw_ptr.Metadata./Dyn/?0 vstd!raw_ptr.DynMetadata.))) ((vstd!raw_ptr.PtrData./PtrData (vstd!raw_ptr.PtrData./PtrData/?addr Int) (vstd!raw_ptr.PtrData./PtrData/?provenance vstd!raw_ptr.Provenance.) (vstd!raw_ptr.PtrData./PtrData/?metadata vstd!raw_ptr.Metadata.))) ((lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion/?contents alloc!vec.Vec<u8./allocator_global%.>.))) ((lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions./VolatileMemoryMockingPersistentMemoryRegions (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions./VolatileMemoryMockingPersistentMemoryRegions/?regions alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>.))) ((lib!pmem.pmemspec_t.PmemError./InvalidFileName ) (lib!pmem.pmemspec_t.PmemError./CannotOpenPmFile ) (lib!pmem.pmemspec_t.PmemError./NotPm ) (lib!pmem.pmemspec_t.PmemError./PmdkError ) (lib!pmem.pmemspec_t.PmemError./AccessOutOfRange )) ((lib!pmem.pmemspec_t.PersistentMemoryByte./PersistentMemoryByte (lib!pmem.pmemspec_t.PersistentMemoryByte./PersistentMemoryByte/?state_at_last_flush Int) (lib!pmem.pmemspec_t.PersistentMemoryByte./PersistentMemoryByte/?outstanding_write core!option.Option.))) ((lib!pmem.pmemspec_t.PersistentMemoryRegionView./PersistentMemoryRegionView (lib!pmem.pmemspec_t.PersistentMemoryRegionView./PersistentMemoryRegionView/?state vstd!seq.Seq<lib!pmem.pmemspec_t.PersistentMemoryByte.>.))) ((lib!pmem.pmemspec_t.PersistentMemoryRegionsView./PersistentMemoryRegionsView (lib!pmem.pmemspec_t.PersistentMemoryRegionsView./PersistentMemoryRegionsView/?regions vstd!seq.Seq<lib!pmem.pmemspec_t.PersistentMemoryRegionView.>.))) ((lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/?impervious_to_corruption Bool))) ((tuple%0./tuple%0 ))))
...
(declare-fun lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion/contents (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.) alloc!vec.Vec<u8./allocator_global%.>.)
(declare-fun lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions./VolatileMemoryMockingPersistentMemoryRegions/regions (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.) alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>.)
...
(declare-const TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. Type)
(declare-const TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. Type)
...
(declare-fun Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. (alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>.) Poly)
(declare-fun %Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. (Poly) alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>.)
...
(declare-fun Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.) Poly)
(declare-fun %Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (Poly) lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.)
(declare-fun Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.) Poly)
(declare-fun %Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. (Poly) lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.)
...
(assert (forall ((x alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>.)) (! (= x (%Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. (Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. x))) :pattern ((Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x (TYPE%alloc!vec.Vec. $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. $ ALLOCATOR_GLOBAL)) (= x (Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. (%Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. x)))) :pattern ((has_type x (TYPE%alloc!vec.Vec. $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. $ ALLOCATOR_GLOBAL))) )))
(assert (forall ((x alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>.)) (! (has_type (Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. x) (TYPE%alloc!vec.Vec. $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. $ ALLOCATOR_GLOBAL)) :pattern ((has_type (Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. x) (TYPE%alloc!vec.Vec. $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. $ ALLOCATOR_GLOBAL))) )))
...
(assert (forall ((x lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.)) (! (= x (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. x))) :pattern ((Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.) (= x (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. x)))) :pattern ((has_type x TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.)) )))
(assert (forall ((x lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.)) (! (= (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion/contents x) (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion/?contents x)) :pattern ((lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion/contents x)) )))
(assert (forall ((x lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.)) (! (has_type (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. x) TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.) :pattern ((has_type (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. x) TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.)) )))
(assert (forall ((x lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.)) (! (= x (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. x))) :pattern ((Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.) (= x (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. x)))) :pattern ((has_type x TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.)) )))
(assert (forall ((x lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.)) (! (= (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions./VolatileMemoryMockingPersistentMemoryRegions/regions x) (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions./VolatileMemoryMockingPersistentMemoryRegions/?regions x)) :pattern ((lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions./VolatileMemoryMockingPersistentMemoryRegions/regions x)) )))
(assert (forall ((x lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.)) (! (has_type (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. x) TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.) :pattern ((has_type (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. x) TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type)) (! (=> (tr_bound%vstd!slice.SliceAdditionalSpecFns. Self%&. Self%& T&. T&) (and (tr_bound%vstd!view.View. Self%&. Self%&) (and (= $ (proj%%vstd!view.View./V Self%&. Self%&)) (= (TYPE%vstd!seq.Seq. T&. T&) (proj%vstd!view.View./V Self%&. Self%&))))) :pattern ((tr_bound%vstd!slice.SliceAdditionalSpecFns. Self%&. Self%& T&. T&)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type) (self! Poly) (i! Poly)) (! (= (req%vstd!slice.SliceAdditionalSpecFns.spec_index. Self%&. Self%& T&. T& self! i!) (=> %%global_location_label%%0 (and (<= 0 (%I i!)) (< (%I i!) (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? Self%&. Self%& self!)))))) :pattern ((req%vstd!slice.SliceAdditionalSpecFns.spec_index. Self%&. Self%& T&. T& self! i!)) )))
(set-info :comment ";; Function-Axioms vstd::slice::SliceAdditionalSpecFns::spec_index")
(assert (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type) (self! Poly) (i! Poly)) (! (=> (and (has_type self! Self%&) (has_type i! INT)) (has_type (vstd!slice.SliceAdditionalSpecFns.spec_index.? Self%&. Self%& T&. T& self! i!) T&)) :pattern ((vstd!slice.SliceAdditionalSpecFns.spec_index.? Self%&. Self%& T&. T& self! i!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.get_num_regions. Self%&. Self%& self!) (=> %%global_location_label%%2 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? Self%&. Self%& self!)))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegions.get_num_regions. Self%&. Self%& self!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (index! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.get_region_size. Self%&. Self%& self! index!) (and (=> %%global_location_label%%5 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? Self%&. Self%& self!))) (=> %%global_location_label%%6 (< (%I index!) (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& self!)))))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegions.get_region_size. Self%&. Self%& self! index!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (S&. Dcr) (S& Type) (self! Poly) (index! Poly) (addr! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.read_aligned. Self%&. Self%& S&. S& self! index! addr!) (and (=> %%global_location_label%%8 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? Self%&. Self%& self!))) (=> %%global_location_label%%9 (< (%I index!) (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& self!)))) (=> %%global_location_label%%10 (let ((tmp%%$ (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&))))) (and (and (<= 0 (%I addr!)) (< (%I addr!) tmp%%$)) (<= tmp%%$ (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& self!) index!))))))) (=> %%global_location_label%%11 (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes_in_range.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& self!) index! addr! (I (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&)))))) (=> %%global_location_label%%12 (%B (lib!pmem.pmcopy_t.PmCopyHelper.bytes_parseable.? S&. S& (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& self!) index!)))) addr! (I (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&)))))))))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegions.read_aligned. Self%&. Self%& S&. S& self! index! addr!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (index! Poly) (addr! Poly) (num_bytes! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.read_unaligned. Self%&. Self%& self! index! addr! num_bytes!) (and (=> %%global_location_label%%13 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? Self%&. Self%& self!))) (=> %%global_location_label%%14 (< (%I index!) (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& self!)))) (=> %%global_location_label%%15 (<= (Add (%I addr!) (%I num_bytes!)) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& self!) index!))))) (=> %%global_location_label%%16 (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes_in_range.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& self!) index! addr! (I (Add (%I addr!) (%I num_bytes!))))))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegions.read_unaligned. Self%&. Self%& self! index! addr! num_bytes!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (pre%self! Poly) (index! Poly) (addr! Poly) (bytes! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.write. Self%&. Self%& pre%self! index! addr! bytes!) (and (=> %%global_location_label%%17 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? Self%&. Self%& pre%self!))) (=> %%global_location_label%%18 (< (%I index!) (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& pre%self!)))) (=> %%global_location_label%%19 (<= (Add (%I addr!) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) bytes!))) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& pre%self!) index!))))) (=> %%global_location_label%%20 (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes_in_range.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& pre%self!) index! addr! (I (Add (%I addr!) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) bytes!)))))))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegions.write. Self%&. Self%& pre%self! index! addr! bytes!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (S&. Dcr) (S& Type) (pre%self! Poly) (index! Poly) (addr! Poly) (to_write! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. Self%&. Self%& S&. S& pre%self! index! addr! to_write!) (and (=> %%global_location_label%%21 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? Self%&. Self%& pre%self!))) (=> %%global_location_label%%22 (< (%I index!) (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& pre%self!)))) (=> %%global_location_label%%23 (<= (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&))) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& pre%self!) index!))))) (=> %%global_location_label%%24 (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes_in_range.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? Self%&. Self%& pre%self!) index! addr! (I (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&)))))))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. Self%&. Self%& S&. S& pre%self! index! addr! to_write!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (pre%self! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.flush. Self%&. Self%& pre%self!) (=> %%global_location_label%%25 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? Self%&. Self%& pre%self!)))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegions.flush. Self%&. Self%& pre%self!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.get_region_size. Self%&. Self%& self!) (=> %%global_location_label%%26 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? Self%&. Self%& self!)))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegion.get_region_size. Self%&. Self%& self!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (S&. Dcr) (S& Type) (self! Poly) (addr! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.read_aligned. Self%&. Self%& S&. S& self! addr!) (and (=> %%global_location_label%%27 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? Self%&. Self%& self!))) (=> %%global_location_label%%28 (let ((tmp%%$ (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&))))) (and (and (<= 0 (%I addr!)) (< (%I addr!) tmp%%$)) (<= tmp%%$ (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? Self%&. Self%& self!)))))) (=> %%global_location_label%%29 (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes_in_range.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? Self%&. Self%& self!) addr! (I (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&)))))) (=> %%global_location_label%%30 (%B (lib!pmem.pmcopy_t.PmCopyHelper.bytes_parseable.? S&. S& (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? Self%&. Self%& self!))) addr! (I (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&)))))))))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegion.read_aligned. Self%&. Self%& S&. S& self! addr!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (addr! Poly) (num_bytes! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.read_unaligned. Self%&. Self%& self! addr! num_bytes!) (and (=> %%global_location_label%%31 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? Self%&. Self%& self!))) (=> %%global_location_label%%32 (<= (Add (%I addr!) (%I num_bytes!)) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? Self%&. Self%& self!)))) (=> %%global_location_label%%33 (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes_in_range.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? Self%&. Self%& self!) addr! (I (Add (%I addr!) (%I num_bytes!))))))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegion.read_unaligned. Self%&. Self%& self! addr! num_bytes!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (pre%self! Poly) (addr! Poly) (bytes! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.write. Self%&. Self%& pre%self! addr! bytes!) (and (=> %%global_location_label%%34 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? Self%&. Self%& pre%self!))) (=> %%global_location_label%%35 (<= (Add (%I addr!) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) bytes!))) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? Self%&. Self%& pre%self!)))) (=> %%global_location_label%%36 (<= (Add (%I addr!) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) bytes!))) 18446744073709551615)) (=> %%global_location_label%%37 (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes_in_range.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? Self%&. Self%& pre%self!) addr! (I (Add (%I addr!) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) bytes!)))))))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegion.write. Self%&. Self%& pre%self! addr! bytes!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (S&. Dcr) (S& Type) (pre%self! Poly) (addr! Poly) (to_write! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.serialize_and_write. Self%&. Self%& S&. S& pre%self! addr! to_write!) (and (=> %%global_location_label%%38 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? Self%&. Self%& pre%self!))) (=> %%global_location_label%%39 (<= (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&))) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? Self%&. Self%& pre%self!)))) (=> %%global_location_label%%40 (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes_in_range.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? Self%&. Self%& pre%self!) addr! (I (Add (%I addr!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? S&. S&)))))))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegion.serialize_and_write. Self%&. Self%& S&. S& pre%self! addr! to_write!)) )))
...
(assert (forall ((Self%&. Dcr) (Self%& Type) (pre%self! Poly)) (! (= (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.flush. Self%&. Self%& pre%self!) (=> %%global_location_label%%41 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? Self%&. Self%& pre%self!)))) :pattern ((req%lib!pmem.pmemspec_t.PersistentMemoryRegion.flush. Self%&. Self%& pre%self!)) )))
...
(set-info :comment ";; Function-Axioms lib::pmem::pmemmock_t::VolatileMemoryMockingPersistentMemoryRegion::inv")
(assert (fuel_bool_default fuel%lib!pmem.pmemmock_t.impl&%1.inv.))
(assert (=> (fuel_bool fuel%lib!pmem.pmemmock_t.impl&%1.inv.) (forall ((self! Poly)) (! (= (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!) (B (and (and (<= (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion/contents (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!)))) 18446744073709551615) (= (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion/contents (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!)))) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!)))) (= (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion/contents (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!))))) (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!)))))))) :pattern ((lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!)) ))))
(set-info :comment ";; Function-Specs lib::pmem::pmemmock_t::VolatileMemoryMockingPersistentMemoryRegion::new")
(declare-fun ens%lib!pmem.pmemmock_t.impl&%0.new. (Int lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.) Bool)
(assert (forall ((region_size! Int) (result! lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.)) (! (= (ens%lib!pmem.pmemmock_t.impl&%0.new. region_size! result!) (and (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. result!))) (= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. result!))) region_size!))) :pattern ((ens%lib!pmem.pmemmock_t.impl&%0.new. region_size! result!)) )))
(set-info :comment ";; Function-Axioms lib::pmem::pmemmock_t::VolatileMemoryMockingPersistentMemoryRegions::inv")
(assert (fuel_bool_default fuel%lib!pmem.pmemmock_t.impl&%3.inv.))
(assert (=> (fuel_bool fuel%lib!pmem.pmemmock_t.impl&%3.inv.) (forall ((self! Poly)) (! (= (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. self!) (B (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!std_specs.vec.spec_vec_len.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions./VolatileMemoryMockingPersistentMemoryRegions/regions (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. self!)))))) (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (vstd!seq.Seq.index.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions./VolatileMemoryMockingPersistentMemoryRegions/regions (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. self!)))) i$))))) :pattern ((lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (vstd!seq.Seq.index.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./allocator_global%.>. (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions./VolatileMemoryMockingPersistentMemoryRegions/regions (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. self!)))) i$))) )))) :pattern ((lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. self!)) ))))
(set-info :comment ";; Function-Axioms vstd::slice::impl&%2::spec_index")
(assert (fuel_bool_default fuel%vstd!slice.impl&%2.spec_index.))
(assert (=> (fuel_bool fuel%vstd!slice.impl&%2.spec_index.) (forall ((T&. Dcr) (T& Type) (self! Poly) (i! Poly)) (! (= (vstd!slice.SliceAdditionalSpecFns.spec_index.? $ (SLICE T&. T&) T&. T& self! i!) (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (SLICE T&. T&) self!) i!)) :pattern ((vstd!slice.SliceAdditionalSpecFns.spec_index.? $ (SLICE T&. T&) T&. T& self! i!)) ))))
(set-info :comment ";; Function-Specs lib::pmem::pmemmock_t::VolatileMemoryMockingPersistentMemoryRegions::new")
(declare-fun ens%lib!pmem.pmemmock_t.impl&%2.new. (slice%<u64.>. lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.) Bool)
(assert (forall ((region_sizes! slice%<u64.>.) (result! lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions.)) (! (= (ens%lib!pmem.pmemmock_t.impl&%2.new. region_sizes! result!) (and (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. result!))) (= (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. result!))) (vstd!seq.Seq.len.? $ (UINT 64) (vstd!view.View.view.? $ (SLICE $ (UINT 64)) (Poly%slice%<u64.>. region_sizes!)))) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (UINT 64) (vstd!view.View.view.? $ (SLICE $ (UINT 64)) (Poly%slice%<u64.>. region_sizes!))))) (= (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. result!)) i$))) (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (SLICE $ (UINT 64)) (Poly%slice%<u64.>. region_sizes!)) i$))))) :pattern ((lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. (Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegions. result!)) i$)))) )))) :pattern ((ens%lib!pmem.pmemmock_t.impl&%2.new. region_sizes! result!)) )))
...
(set-info :comment ";; Function-Def lib::pmem::pmemmock_t::VolatileMemoryMockingPersistentMemoryRegion::get_region_size")
(set-info :comment ";; src/pmem/pmemmock_t.rs:62:9: 62:50 (#0)")
(declare-const %return! Poly)
(declare-const self! Poly)
(declare-const tmp%1 Int)
(declare-const tmp%2 alloc!vec.Vec<u8./allocator_global%.>.)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion.))
(assert (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= tmp%2 (lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion./VolatileMemoryMockingPersistentMemoryRegion/contents (%Poly%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!))) (=> (ens%alloc!vec.impl&%1.len. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%2) tmp%1) (=> (= %return! (I (uClip 64 tmp%1))) (=> %%location_label%%0 (= (%I %return!) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.pmemmock_t.VolatileMemoryMockingPersistentMemoryRegion. self!)))))))))
(check-sat)
(exit)
