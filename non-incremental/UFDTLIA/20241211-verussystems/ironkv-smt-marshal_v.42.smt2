...
(assert (not (%B (lib!marshal_v.Marshalable.view_equal.? $ (UINT SZ) self! other!))))
(assert (<= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) self!)) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) other!))))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (UINT 64) (I (uClip 64 (%I self!))) (I (uClip 64 (%I other!))))) (=> (ens%lib!marshal_v.Marshalable.lemma_serialization_is_not_a_prefix_of. $ (UINT 64) (I (uClip 64 (%I self!))) (I (uClip 64 (%I other!)))) (=> %%location_label%%1 (not (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) self!) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) other!) (I 0) (I (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) self!)))))))))))
(check-sat)
(exit)
