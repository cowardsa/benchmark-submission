...
(declare-const acquired@1 Bool)
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%1 Bool)
(set-info :comment ";; Cannot show invariant holds at end of block")
(declare-const %%location_label%%2 Bool)
(set-info :comment ";; invariant not satisfied at end of loop body")
(declare-const %%location_label%%3 Bool)
(set-info :comment ";; invariant not satisfied at end of loop body")
(declare-const %%location_label%%4 Bool)
(assert (not (=> (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!)) (=> (=> acquired@0 (and (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. token@0))))) (= (lib!spec.rwlock.RwLockSpec.exc_pending_token_data./exc_pending_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.exc_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%6.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. token@0))))))) (lib!exec.rwlock.RwLock./RwLock/inst (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. self!))))) (= (lib!spec.rwlock.RwLockSpec.exc_pending_token_data./exc_pending_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.exc_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%6.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. token@0))))))) 0))) (=> (not acquired@0) (=> (= atomic@ (%Poly%vstd!atomic_ghost.AtomicBool. (lib!exec.CachePadded./CachePadded/0 (%Poly%lib!exec.CachePadded. (Poly%lib!exec.CachePadded. (lib!exec.rwlock.RwLock./RwLock/exc_locked (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. self!)))))))) (=> (= operand1@ false) (=> (= operand2@ true) (=> (= tmp%1 (vstd!atomic_ghost.AtomicBool./AtomicBool/atomic_inv (%Poly%vstd!atomic_ghost.AtomicBool. (Poly%vstd!atomic_ghost.AtomicBool. atomic@)))) (=> (has_type (Poly%tuple%2. pair@0) (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionBool. $ (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&)))) (=> (vstd!invariant.AtomicInvariant.inv.? $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionBool. $ (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&))) $ (TYPE%vstd!atomic_ghost.AtomicPredBool. $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_exc_locked.) tmp%1 (Poly%tuple%2. pair@0)) (=> (= verus_tmp$1@ pair@0) (=> (= verus_tmp_perm@0 (%Poly%vstd!atomic.PermissionBool. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. verus_tmp$1@))))) (=> (= verus_tmp_g@0 (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. verus_tmp$1@)))) (=> (= perm@1 verus_tmp_perm@0) (=> (= g@1 verus_tmp_g@0) (=> (= verus_tmp$2@1 (vstd!atomic.PermissionDataBool./PermissionDataBool/value (%Poly%vstd!atomic.PermissionDataBool. (Poly%vstd!atomic.PermissionDataBool. (vstd!atomic.impl&%0.view.? (Poly%vstd!atomic.PermissionBool. perm@1)))))) (=> (= tmp%2 (vstd!atomic_ghost.AtomicBool./AtomicBool/patomic (%Poly%vstd!atomic_ghost.AtomicBool. (Poly%vstd!atomic_ghost.AtomicBool. atomic@)))) (and (=> %%location_label%%0 (req%vstd!atomic.impl&%1.compare_exchange. tmp%2 perm@1 operand1@ operand2@)) (=> (ens%vstd!atomic.impl&%1.compare_exchange. tmp%2 perm@1 perm@2 operand1@ operand2@ result$1@) (=> (= verus_tmp$3@1 result$1@) (=> (= verus_tmp_res@ verus_tmp$3@1) (=> (= res@1 verus_tmp_res@) (=> (= verus_tmp$4@1 (vstd!atomic.PermissionDataBool./PermissionDataBool/value (%Poly%vstd!atomic.PermissionDataBool. (Poly%vstd!atomic.PermissionDataBool. (vstd!atomic.impl&%0.view.? (Poly%vstd!atomic.PermissionBool. perm@2)))))) (or (and (=> (%B (B (is-core!result.Result./Ok_ (%Poly%core!result.Result. (Poly%core!result.Result. res@1))))) (=> (= tmp%4 (lib!exec.rwlock.RwLock./RwLock/inst (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. self!)))) (and (=> %%location_label%%1 (req%lib!spec.rwlock.RwLockSpec.impl&%10.exc_start. $ (TYPE%vstd!cell.PointsTo. T&. T&) tmp%4 g@1)) (=> (has_type g@2 (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&))) (=> (ens%lib!spec.rwlock.RwLockSpec.impl&%10.exc_start. $ (TYPE%vstd!cell.PointsTo. T&. T&) tmp%4 g@1 g@2 tmp%3) (=> (= token@1 (core!option.Option./Some tmp%3)) %%switch_label%%0)))))) (=> (not (%B (B (is-core!result.Result./Ok_ (%Poly%core!result.Result. (Poly%core!result.Result. res@1)))))) (=> (= g@2 g@1) (=> (= token@1 token@0) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> (= pair@1 (tuple%2./tuple%2 (Poly%vstd!atomic.PermissionBool. perm@2) g@2)) (and (=> %%location_label%%2 (vstd!invariant.AtomicInvariant.inv.? $ (TYPE%tuple%2. (TRACKED $) (TYPE%lib!spec.rwlock.RwLockSpec.Instance. $ (TYPE%vstd!cell.PointsTo. T&. T&)) $ INT) $ (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionBool. $ (TYPE%lib!spec.rwlock.RwLockSpec.exc_locked. $ (TYPE%vstd!cell.PointsTo. T&. T&))) $ (TYPE%vstd!atomic_ghost.AtomicPredBool. $ TYPE%lib!exec.rwlock.InvariantPredicate_auto_RwLock_exc_locked.) tmp%1 (Poly%tuple%2. pair@1))) (=> (= result@ result$1@) (=> (ens%core!result.impl&%0.is_ok. $ BOOL $ BOOL result@ acquired@1) (and (=> %%location_label%%3 (lib!exec.rwlock.impl&%3.wf.? T&. T& (Poly%lib!exec.rwlock.RwLock. self!))) (=> %%location_label%%4 (=> acquired@1 (and (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. token@1))))) (= (lib!spec.rwlock.RwLockSpec.exc_pending_token_data./exc_pending_token_data/instance (%Poly%lib!spec.rwlock.RwLockSpec.exc_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%6.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. token@1))))))) (lib!exec.rwlock.RwLock./RwLock/inst (%Poly%lib!exec.rwlock.RwLock. (Poly%lib!exec.rwlock.RwLock. self!))))) (= (lib!spec.rwlock.RwLockSpec.exc_pending_token_data./exc_pending_token_data/value (%Poly%lib!spec.rwlock.RwLockSpec.exc_pending_token_data. (Poly%lib!spec.rwlock.RwLockSpec.exc_pending_token_data. (lib!spec.rwlock.RwLockSpec.impl&%6.view.? $ (TYPE%vstd!cell.PointsTo. T&. T&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. token@1))))))) 0)))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
