...
(declare-const self! lib!single_delivery_state_v.CTombstoneTable.)
(declare-const src! lib!io_t.EndPoint.)
(declare-const tmp%1 lib!endpoint_hashmap_t.HashMap<u64.>.)
(declare-const tmp%%@ core!option.Option.)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= tmp%1 (lib!single_delivery_state_v.CTombstoneTable./CTombstoneTable/epmap (%Poly%lib!single_delivery_state_v.CTombstoneTable. (Poly%lib!single_delivery_state_v.CTombstoneTable. self!)))) (=> (ens%lib!endpoint_hashmap_t.impl&%0.get. $ (UINT 64) (Poly%lib!endpoint_hashmap_t.HashMap<u64.>. tmp%1) src! tmp%%@) (=> (= last_seqno! (ite (is-core!option.Option./Some_ tmp%%@) (let ((v$ (%I (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@)))))) v$) 0)) (=> %%location_label%%0 (= last_seqno! (lib!single_delivery_t.tombstone_table_lookup.? (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. src!))) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. (lib!single_delivery_state_v.impl&%1.view.? (Poly%lib!single_delivery_state_v.CTombstoneTable. self!)))))))))))
(check-sat)
(exit)
