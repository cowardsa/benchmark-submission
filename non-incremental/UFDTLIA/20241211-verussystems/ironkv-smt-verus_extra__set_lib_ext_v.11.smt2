...
(assert (not (=> (= s1@ (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.push.? A&. A& s! x!))) (=> (= s2@ (vstd!set.impl&%0.insert.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) x!)) (and (and (=> (has_type elem@ A&) (or (and (=> (= elem@ x!) (=> (= tmp%1 (= (vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.push.? A&. A& s! x!) (I (vstd!seq.Seq.len.? A&. A& s!))) x!)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (vstd!seq_lib.impl&%0.contains.? A&. A& (vstd!seq.Seq.push.? A&. A& s! x!) x!)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%0))))))) (=> (not (= elem@ x!)) (or (and (=> (vstd!set.impl&%0.contains.? A&. A& (vstd!set.impl&%0.insert.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) x!) elem@) (=> (= tmp%3 (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) elem@)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= i@ (%I (as_type (%%choose%%2 INT 0 (vstd!seq.Seq.len.? A&. A& s!) A&. A& s! elem@ A&. A& s!) INT))) (=> (= tmp%4 (= (vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.push.? A&. A& s! x!) (I i@)) elem@)) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 %%switch_label%%1)))))))) (=> (not (vstd!set.impl&%0.contains.? A&. A& (vstd!set.impl&%0.insert.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) x!) elem@)) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%4 (and (=> (vstd!set.impl&%0.contains.? A&. A& s1@ elem@) (vstd!set.impl&%0.contains.? A&. A& s2@ elem@)) (=> (vstd!set.impl&%0.contains.? A&. A& s2@ elem@) (vstd!set.impl&%0.contains.? A&. A& s1@ elem@))))))) (=> (forall ((elem$ Poly)) (! (=> (has_type elem$ A&) (and (=> (vstd!set.impl&%0.contains.? A&. A& s1@ elem$) (vstd!set.impl&%0.contains.? A&. A& s2@ elem$)) (=> (vstd!set.impl&%0.contains.? A&. A& s2@ elem$) (vstd!set.impl&%0.contains.? A&. A& s1@ elem$)))) :pattern ((vstd!set.impl&%0.contains.? A&. A& s1@ elem$)) :pattern ((vstd!set.impl&%0.contains.? A&. A& s2@ elem$)) )) (=> (= tmp%5 (ext_eq false (TYPE%vstd!set.Set. A&. A&) s1@ s2@)) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 (=> %%location_label%%6 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> %%location_label%%7 (= (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.push.? A&. A& s! x!)) (vstd!set.impl&%0.insert.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) x!)))))))))
(check-sat)
(exit)
