...
(assert (not (=> (is-lib!single_message_t.SingleMessage./Message_ (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))) (=> (lib!delegation_map_t.impl&%0.is_complete.? (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (or (and (=> (is-lib!message_t.Message./SetRequest_ (%Poly%lib!message_t.Message. (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))))) (=> (has_type sm@ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)) (=> (has_type replym@ TYPE%lib!message_t.Message.) (=> (has_type should_send@ BOOL) (=> (= tmp%2 (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. pkt!)))) (=> (= tmp%3 (I (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))))) (=> (= tmp%4 (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!)))))) (and (=> %%location_label%%0 (req%lib!host_protocol_t.next_set_request_complete. pre! post! tmp%2 tmp%3 tmp%4 sm@ replym@ out! should_send@)) (=> (= tmp%1 (lib!host_protocol_t.next_set_request_complete.? pre! post! (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. pkt!))) (I (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!)))))) (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))) sm@ replym@ out! should_send@)) (=> (= tmp%5 (exists ((sm$ Poly) (replym$ Poly) (should_send$ Poly)) (! (and (and (has_type sm$ (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)) (has_type replym$ TYPE%lib!message_t.Message.) (has_type should_send$ BOOL)) (lib!host_protocol_t.next_set_request_complete.? pre! post! (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. pkt!))) (I (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!)))))) (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))) sm$ replym$ out! should_send$)) :pattern ((lib!host_protocol_t.next_set_request_complete.? pre! post! (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!network_t.Packet./Packet/src (%Poly%lib!network_t.Packet. pkt!))) (I (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!)))))) (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))) sm$ replym$ out! should_send$)) ))) %%switch_label%%0)))))))))) (=> (not (is-lib!message_t.Message./SetRequest_ (%Poly%lib!message_t.Message. (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!)))))))) (=> (= tmp%5 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
