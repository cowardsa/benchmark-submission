...
(declare-const midsize! Int)
(declare-const endsize! Int)
(declare-const tmp%1 Bool)
(assert fuel_defaults)
(assert (has_type s! (TYPE%vstd!seq.Seq. A&. A&)))
(assert (and (<= 0 start!) (<= start! (vstd!seq.Seq.len.? A&. A& s!))))
(assert (and (and (<= 0 midsize!) (<= midsize! endsize!)) (<= endsize! (Sub (vstd!seq.Seq.len.? A&. A& s!) start!))))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq.Seq.subrange.? A&. A& (vstd!seq.Seq.subrange.? A&. A& s! (I start!) (I (Add start! endsize!))) (I 0) (I midsize!)) (vstd!seq.Seq.subrange.? A&. A& s! (I start!) (I (Add start! midsize!))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (= (vstd!seq.Seq.subrange.? A&. A& (vstd!seq.Seq.subrange.? A&. A& s! (I start!) (I (Add start! endsize!))) (I 0) (I midsize!)) (vstd!seq.Seq.subrange.? A&. A& s! (I start!) (I (Add start! midsize!))))))))))
(check-sat)
(exit)
