...
(declare-const out! lib!single_delivery_state_v.CSingleDelivery.)
...
(declare-const m1@ vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>.)
(declare-const m2@ vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>.)
(declare-const m1$1@ vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>.)
(declare-const m2$1@ vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>.)
(declare-const result@ lib!single_delivery_state_v.CSingleDelivery.)
...
(assert (not (=> (ens%lib!endpoint_hashmap_t.impl&%0.new. $ (UINT 64) tmp%1) (=> (ens%lib!endpoint_hashmap_t.impl&%0.new. $ TYPE%lib!single_delivery_state_v.CAckState. tmp%2) (=> (= result@ (lib!single_delivery_state_v.CSingleDelivery./CSingleDelivery (%Poly%lib!single_delivery_state_v.CTombstoneTable. (Poly%lib!single_delivery_state_v.CTombstoneTable. (lib!single_delivery_state_v.CTombstoneTable./CTombstoneTable (%Poly%lib!endpoint_hashmap_t.HashMap<u64.>. tmp%1)))) (%Poly%lib!single_delivery_state_v.CSendState. (Poly%lib!single_delivery_state_v.CSendState. (lib!single_delivery_state_v.CSendState./CSendState (%Poly%lib!endpoint_hashmap_t.HashMap<lib!single_delivery_state_v.CAckState.>. tmp%2)))))) (=> (= m1@ (lib!single_delivery_state_v.impl&%1.view.? (Poly%lib!single_delivery_state_v.CTombstoneTable. (lib!single_delivery_state_v.CSingleDelivery./CSingleDelivery/receive_state (%Poly%lib!single_delivery_state_v.CSingleDelivery. (Poly%lib!single_delivery_state_v.CSingleDelivery. result@)))))) (=> (= m2@ (lib!single_delivery_t.SingleDelivery./SingleDelivery/receive_state (%Poly%lib!single_delivery_t.SingleDelivery. (Poly%lib!single_delivery_t.SingleDelivery. (lib!single_delivery_t.impl&%1.init.? $ TYPE%lib!message_t.Message.))))) (and (and (=> (has_type key@ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (=> %%location_label%%0 (and (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@)) key@) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m2@)) key@)) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m2@)) key@) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@)) key@))) (=> (and (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@)) key@) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m2@)) key@)) (= (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@) key@) (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m2@) key@)))))) (=> (forall ((key$ Poly)) (! (=> (has_type key$ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (and (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@)) key$) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m2@)) key$)) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m2@)) key$) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@)) key$))) (=> (and (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@)) key$) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m2@)) key$)) (= (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@) key$) (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m2@) key$))))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@)) key$)) )) (=> (= tmp%3 (ext_eq false (TYPE%vstd!map.Map. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ NAT) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m1@) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./nat.>. m2@))) (and (=> %%location_label%%1 tmp%3) (=> tmp%3 (=> %%location_label%%2 (= m1@ m2@))))))) (=> (= m1@ m2@) (=> (= m1$1@ (lib!single_delivery_state_v.impl&%2.view.? (Poly%lib!single_delivery_state_v.CSendState. (lib!single_delivery_state_v.CSingleDelivery./CSingleDelivery/send_state (%Poly%lib!single_delivery_state_v.CSingleDelivery. (Poly%lib!single_delivery_state_v.CSingleDelivery. result@)))))) (=> (= m2$1@ (%Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. (lib!single_delivery_t.SingleDelivery./SingleDelivery/send_state (%Poly%lib!single_delivery_t.SingleDelivery. (Poly%lib!single_delivery_t.SingleDelivery. (lib!single_delivery_t.impl&%1.init.? $ TYPE%lib!message_t.Message.)))))) (and (and (=> (has_type key$1@ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (=> %%location_label%%3 (and (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@)) key$1@) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m2$1@)) key$1@)) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m2$1@)) key$1@) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@)) key$1@))) (=> (and (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@)) key$1@) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m2$1@)) key$1@)) (= (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@) key$1@) (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m2$1@) key$1@)))))) (=> (forall ((key$ Poly)) (! (=> (has_type key$ TYPE%lib!abstract_end_point_t.AbstractEndPoint.) (and (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@)) key$) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m2$1@)) key$)) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m2$1@)) key$) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@)) key$))) (=> (and (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@)) key$) (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m2$1@)) key$)) (= (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@) key$) (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m2$1@) key$))))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@)) key$)) )) (=> (= tmp%4 (ext_eq false (TYPE%vstd!map.Map. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. $ TYPE%lib!message_t.Message.)) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m1$1@) (Poly%vstd!map.Map<lib!abstract_end_point_t.AbstractEndPoint./lib!single_delivery_t.AckState<lib!message_t.Message.>.>. m2$1@))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (=> %%location_label%%5 (= m1$1@ m2$1@))))))) (=> (= m1$1@ m2$1@) (=> (= out! result@) (=> %%location_label%%6 (= (lib!single_delivery_state_v.impl&%3.view.? (Poly%lib!single_delivery_state_v.CSingleDelivery. out!)) (lib!single_delivery_t.impl&%1.init.? $ TYPE%lib!message_t.Message.)))))))))))))))))
(check-sat)
(exit)
