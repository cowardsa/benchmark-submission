...
(declare-const accl@ %%Function%%)
(declare-const s@ Poly)
(declare-const tmp%12 Poly)
(declare-const tmp%13 Poly)
(declare-const tmp%14 %%Function%%)
(declare-const tmp%15 %%Function%%)
(declare-const tmp%16 Bool)
(declare-const sl$1@ %%Function%%)
(declare-const s$1@ Poly)
(declare-const old_res@ Int)
(declare-const tmp%17 Poly)
(declare-const tmp%18 vstd!seq.Seq<u8.>.)
(declare-const tmp%19 %%Function%%)
(declare-const tmp%20 %%Function%%)
(declare-const tmp%21 %%Function%%)
(declare-const tmp%22 %%Function%%)
(declare-const tmp%23 Bool)
(declare-const f$1@ %%Function%%)
(declare-const res@0 Int)
...
(assert (uInv SZ res@0))
(assert (uInv SZ i@0))
(assert (uInv SZ tmp%4))
(declare-fun %%lambda%%7 (Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (x$ Poly)) (! (= (%%apply%%0 (%%lambda%%7 %%hole%%0 %%hole%%1) x$) (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$)) :pattern ((%%apply%%0 (%%lambda%%7 %%hole%%0 %%hole%%1) x$)))))
(declare-fun %%lambda%%8 (Dcr Type Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (x$ Poly)) (! (= (%%apply%%0 (%%lambda%%8 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) x$) (I (vstd!seq.Seq.len.? %%hole%%2 %%hole%%3 (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$)))) :pattern ((%%apply%%0 (%%lambda%%8 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) x$)))))
...
(assert (not (=> (and (<= 0 i@0) (<= i@0 (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL self!))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) )) (=> (<= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (- (uHi SZ) 1)) (=> (= res@0 (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@0)) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))))))) (=> (ens%alloc!vec.impl&%1.len. T&. T& $ ALLOCATOR_GLOBAL self! tmp%4) (=> (< i@0 tmp%4) (=> (= f@ (mk_fun (%%lambda%%7 T&. T&))) (=> (= tmp%5 (mk_fun (%%lambda%%3 f@ $ (UINT 8)))) (=> (= tmp%6 (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))) (and (=> %%location_label%%0 (req%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%5 tmp%6)) (=> (ens%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%5 tmp%6) (=> (= tmp%7 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) (=> (= tmp%8 (Add i@0 1)) (and (=> %%location_label%%1 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. T&. T& $ (UINT 8) tmp%7 tmp%8 0 f@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. T&. T& $ (UINT 8) tmp%7 tmp%8 0 f@) (=> (= sl@ (mk_fun (%%lambda%%8 T&. T& $ (UINT 8)))) (=> (= accl@ (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))) (=> (= tmp%9 (mk_fun (%%lambda%%2 sl@))) (and (=> %%location_label%%2 (req%vstd!function.fun_ext_2. $ INT T&. T& $ INT accl@ tmp%9)) (=> (ens%vstd!function.fun_ext_2. $ INT T&. T& $ INT accl@ tmp%9) (=> (= s@ (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (Add i@0 1)))) (and (=> %%location_label%%3 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& s@ 0 sl@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& s@ 0 sl@) (=> (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& s@ (I 0) (I (Sub (vstd!seq.Seq.len.? T&. T& s@) 1))) (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@0)))) (and (=> %%location_label%%4 tmp%10) (=> tmp%10 (=> (= tmp%11 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!))) (and (=> %%location_label%%5 tmp%11) (=> tmp%11 (=> (= old_res@ res@0) (and (=> %%location_label%%6 (req%vstd!std_specs.vec.vec_index. T&. T& $ ALLOCATOR_GLOBAL self! i@0)) (=> (ens%vstd!std_specs.vec.vec_index. T&. T& $ ALLOCATOR_GLOBAL self! i@0 tmp%12) (and (=> %%location_label%%7 (req%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%12)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. T&. T& tmp%12 tmp%13) (and (=> %%location_label%%8 (uInv SZ (Add res@0 (%I tmp%13)))) (=> (= res@1 (uClip SZ (Add res@0 (%I tmp%13)))) (and (=> %%location_label%%9 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (=> (= sl$1@ (mk_fun (%%lambda%%8 T&. T& $ (UINT 8)))) (=> (= tmp%14 (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))) (=> (= tmp%15 (mk_fun (%%lambda%%2 sl$1@))) (and (=> %%location_label%%10 (req%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%14 tmp%15)) (=> (ens%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%14 tmp%15) (=> (= s$1@ (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1))) (and (=> %%location_label%%11 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& s$1@ 0 sl$1@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& s$1@ 0 sl$1@) (=> (= tmp%16 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& s$1@ (I 0) (I (Sub (vstd!seq.Seq.len.? T&. T& s$1@) 1))) (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (Sub i@1 1))))) (and (=> %%location_label%%12 tmp%16) (=> tmp%16 (and (=> %%location_label%%13 (and (<= 0 i@1) (<= i@1 (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL self!)))) (and (=> %%location_label%%14 (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) ))) (and (=> %%location_label%%15 (<= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (- (uHi SZ) 1))) (=> %%location_label%%16 (= res@1 (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
