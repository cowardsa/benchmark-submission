...
(assert (not (or (and (=> (is-lib!cmessage_v.CMessage./GetRequest_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= k@ (lib!cmessage_v.CMessage./GetRequest/k (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k@) tmp%1) (=> (= tmp%2 tmp%1) %%switch_label%%3)) (=> (not true) (=> (= tmp%2 (B false)) %%switch_label%%3))) (and (not %%switch_label%%3) (or (and (=> (%B tmp%2) (and (=> %%location_label%%0 (uInv SZ (Sub (- (uHi SZ) 1) 0))) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1) (and (=> %%location_label%%1 (uInv SZ (Add 0 1))) (and (=> %%location_label%%2 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1))))) (and (=> %%location_label%%3 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k@) tmp%3) (=> (= tmp%4 (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%3))) %%switch_label%%2)))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1)) (=> (= tmp%4 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%5 tmp%4) %%switch_label%%1))))) (=> (not (%B tmp%2)) (=> (= tmp%5 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%60 tmp%5) %%switch_label%%0))))))) (=> (not (is-lib!cmessage_v.CMessage./GetRequest_ (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (is-lib!cmessage_v.CMessage./SetRequest_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= k$1@ (lib!cmessage_v.CMessage./SetRequest/k (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= v@ (lib!cmessage_v.CMessage./SetRequest/v (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$1@) tmp%6) (=> (= tmp%7 tmp%6) %%switch_label%%9)) (=> (not true) (=> (= tmp%7 (B false)) %%switch_label%%9))) (and (not %%switch_label%%9) (or (and (=> (%B tmp%7) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v@) tmp%8) (=> (= tmp%9 tmp%8) %%switch_label%%8))) (=> (not (%B tmp%7)) (=> (= tmp%9 (B false)) %%switch_label%%8))) (and (not %%switch_label%%8) (or (and (=> (%B tmp%9) (and (=> %%location_label%%4 (uInv SZ (Sub (- (uHi SZ) 1) 0))) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1) (and (=> %%location_label%%5 (uInv SZ (Add 0 1))) (and (=> %%location_label%%6 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1))))) (and (=> %%location_label%%7 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$1@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$1@) tmp%10) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%10)) (and (=> %%location_label%%8 (uInv SZ (Add 0 1))) (and (=> %%location_label%%9 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$1@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$1@) tmp%11) (and (=> %%location_label%%10 (uInv SZ (Add (uClip SZ (Add 0 1)) (%I tmp%11)))) (and (=> %%location_label%%11 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%11)))))) (and (=> %%location_label%%12 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v@) tmp%12) (=> (= tmp%13 (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%11))))) (%I tmp%12))) %%switch_label%%7))))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%10))) (=> (= tmp%13 false) %%switch_label%%7))) (and (not %%switch_label%%7) (=> (= tmp%14 tmp%13) %%switch_label%%6)))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1)) (=> (= tmp%14 false) %%switch_label%%6))) (and (not %%switch_label%%6) (=> (= tmp%15 tmp%14) %%switch_label%%5))))) (=> (not (%B tmp%9)) (=> (= tmp%15 false) %%switch_label%%5))) (and (not %%switch_label%%5) (=> (= tmp%59 tmp%15) %%switch_label%%4)))))))))) (=> (not (is-lib!cmessage_v.CMessage./SetRequest_ (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (is-lib!cmessage_v.CMessage./Reply_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= k$2@ (lib!cmessage_v.CMessage./Reply/k (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= v$1@ (lib!cmessage_v.CMessage./Reply/v (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$2@) tmp%16) (=> (= tmp%17 tmp%16) %%switch_label%%15)) (=> (not true) (=> (= tmp%17 (B false)) %%switch_label%%15))) (and (not %%switch_label%%15) (or (and (=> (%B tmp%17) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v$1@) tmp%18) (=> (= tmp%19 tmp%18) %%switch_label%%14))) (=> (not (%B tmp%17)) (=> (= tmp%19 (B false)) %%switch_label%%14))) (and (not %%switch_label%%14) (or (and (=> (%B tmp%19) (and (=> %%location_label%%13 (uInv SZ (Sub (- (uHi SZ) 1) 0))) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1) (and (=> %%location_label%%14 (uInv SZ (Add 0 1))) (and (=> %%location_label%%15 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1))))) (and (=> %%location_label%%16 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$2@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$2@) tmp%20) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%20)) (and (=> %%location_label%%17 (uInv SZ (Add 0 1))) (and (=> %%location_label%%18 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$2@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$2@) tmp%21) (and (=> %%location_label%%19 (uInv SZ (Add (uClip SZ (Add 0 1)) (%I tmp%21)))) (and (=> %%location_label%%20 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%21)))))) (and (=> %%location_label%%21 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v$1@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (Poly%core!option.Option. v$1@) tmp%22) (=> (= tmp%23 (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%21))))) (%I tmp%22))) %%switch_label%%13))))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%20))) (=> (= tmp%23 false) %%switch_label%%13))) (and (not %%switch_label%%13) (=> (= tmp%24 tmp%23) %%switch_label%%12)))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1)) (=> (= tmp%24 false) %%switch_label%%12))) (and (not %%switch_label%%12) (=> (= tmp%25 tmp%24) %%switch_label%%11))))) (=> (not (%B tmp%19)) (=> (= tmp%25 false) %%switch_label%%11))) (and (not %%switch_label%%11) (=> (= tmp%58 tmp%25) %%switch_label%%10)))))))))) (=> (not (is-lib!cmessage_v.CMessage./Reply_ (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (is-lib!cmessage_v.CMessage./Redirect_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= k$3@ (lib!cmessage_v.CMessage./Redirect/k (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= id@ (lib!cmessage_v.CMessage./Redirect/id (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$3@) tmp%26) (=> (= tmp%27 tmp%26) %%switch_label%%21)) (=> (not true) (=> (= tmp%27 (B false)) %%switch_label%%21))) (and (not %%switch_label%%21) (or (and (=> (%B tmp%27) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. id@) tmp%28) (=> (= tmp%29 tmp%28) %%switch_label%%20))) (=> (not (%B tmp%27)) (=> (= tmp%29 (B false)) %%switch_label%%20))) (and (not %%switch_label%%20) (or (and (=> (%B tmp%29) (and (=> %%location_label%%22 (uInv SZ (Sub (- (uHi SZ) 1) 0))) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1) (and (=> %%location_label%%23 (uInv SZ (Add 0 1))) (and (=> %%location_label%%24 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1))))) (and (=> %%location_label%%25 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$3@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$3@) tmp%30) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%30)) (and (=> %%location_label%%26 (uInv SZ (Add 0 1))) (and (=> %%location_label%%27 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$3@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. (Poly%lib!keys_t.SHTKey. k$3@) tmp%31) (and (=> %%location_label%%28 (uInv SZ (Add (uClip SZ (Add 0 1)) (%I tmp%31)))) (and (=> %%location_label%%29 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%31)))))) (and (=> %%location_label%%30 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. id@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. id@) tmp%32) (=> (= tmp%33 (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%31))))) (%I tmp%32))) %%switch_label%%19))))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%30))) (=> (= tmp%33 false) %%switch_label%%19))) (and (not %%switch_label%%19) (=> (= tmp%34 tmp%33) %%switch_label%%18)))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1)) (=> (= tmp%34 false) %%switch_label%%18))) (and (not %%switch_label%%18) (=> (= tmp%35 tmp%34) %%switch_label%%17))))) (=> (not (%B tmp%29)) (=> (= tmp%35 false) %%switch_label%%17))) (and (not %%switch_label%%17) (=> (= tmp%57 tmp%35) %%switch_label%%16)))))))))) (=> (not (is-lib!cmessage_v.CMessage./Redirect_ (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (is-lib!cmessage_v.CMessage./Shard_ (%Poly%lib!cmessage_v.CMessage. self!)) (=> (= kr@ (lib!cmessage_v.CMessage./Shard/kr (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= recipient@ (lib!cmessage_v.CMessage./Shard/recipient (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. kr@) tmp%36) (=> (= tmp%37 tmp%36) %%switch_label%%27)) (=> (not true) (=> (= tmp%37 (B false)) %%switch_label%%27))) (and (not %%switch_label%%27) (or (and (=> (%B tmp%37) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. recipient@) tmp%38) (=> (= tmp%39 tmp%38) %%switch_label%%26))) (=> (not (%B tmp%37)) (=> (= tmp%39 (B false)) %%switch_label%%26))) (and (not %%switch_label%%26) (or (and (=> (%B tmp%39) (and (=> %%location_label%%31 (uInv SZ (Sub (- (uHi SZ) 1) 0))) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1) (and (=> %%location_label%%32 (uInv SZ (Add 0 1))) (and (=> %%location_label%%33 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1))))) (and (=> %%location_label%%34 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. kr@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. kr@) tmp%40) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%40)) (and (=> %%location_label%%35 (uInv SZ (Add 0 1))) (and (=> %%location_label%%36 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. kr@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. kr@) tmp%41) (and (=> %%location_label%%37 (uInv SZ (Add (uClip SZ (Add 0 1)) (%I tmp%41)))) (and (=> %%location_label%%38 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%41)))))) (and (=> %%location_label%%39 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. recipient@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. recipient@) tmp%42) (=> (= tmp%43 (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%41))))) (%I tmp%42))) %%switch_label%%25))))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%40))) (=> (= tmp%43 false) %%switch_label%%25))) (and (not %%switch_label%%25) (=> (= tmp%44 tmp%43) %%switch_label%%24)))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1)) (=> (= tmp%44 false) %%switch_label%%24))) (and (not %%switch_label%%24) (=> (= tmp%45 tmp%44) %%switch_label%%23))))) (=> (not (%B tmp%39)) (=> (= tmp%45 false) %%switch_label%%23))) (and (not %%switch_label%%23) (=> (= tmp%56 tmp%45) %%switch_label%%22)))))))))) (=> (not (is-lib!cmessage_v.CMessage./Shard_ (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= range@ (lib!cmessage_v.CMessage./Delegate/range (%Poly%lib!cmessage_v.CMessage. self!))) (=> (= h@ (lib!cmessage_v.CMessage./Delegate/h (%Poly%lib!cmessage_v.CMessage. self!))) (or (and (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. range@) tmp%46) (=> (= tmp%47 tmp%46) %%switch_label%%32)) (=> (not true) (=> (= tmp%47 (B false)) %%switch_label%%32))) (and (not %%switch_label%%32) (or (and (=> (%B tmp%47) (=> (ens%lib!marshal_v.Marshalable._is_marshalable. $ TYPE%lib!hashmap_t.CKeyHashMap. (Poly%lib!hashmap_t.CKeyHashMap. h@) tmp%48) (=> (= tmp%49 tmp%48) %%switch_label%%31))) (=> (not (%B tmp%47)) (=> (= tmp%49 (B false)) %%switch_label%%31))) (and (not %%switch_label%%31) (or (and (=> (%B tmp%49) (and (=> %%location_label%%40 (uInv SZ (Sub (- (uHi SZ) 1) 0))) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1) (and (=> %%location_label%%41 (uInv SZ (Add 0 1))) (and (=> %%location_label%%42 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1))))) (and (=> %%location_label%%43 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. range@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. range@) tmp%50) (or (and (=> (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%50)) (and (=> %%location_label%%44 (uInv SZ (Add 0 1))) (and (=> %%location_label%%45 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. range@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%lib!keys_t.KeyRange. $ TYPE%lib!keys_t.SHTKey.) (Poly%lib!keys_t.KeyRange. range@) tmp%51) (and (=> %%location_label%%46 (uInv SZ (Add (uClip SZ (Add 0 1)) (%I tmp%51)))) (and (=> %%location_label%%47 (uInv SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%51)))))) (and (=> %%location_label%%48 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!hashmap_t.CKeyHashMap. (Poly%lib!hashmap_t.CKeyHashMap. h@))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!hashmap_t.CKeyHashMap. (Poly%lib!hashmap_t.CKeyHashMap. h@) tmp%52) (=> (= tmp%53 (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add (uClip SZ (Add 0 1)) (%I tmp%51))))) (%I tmp%52))) %%switch_label%%30))))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) (uClip SZ (Add 0 1)))) (%I tmp%50))) (=> (= tmp%53 false) %%switch_label%%30))) (and (not %%switch_label%%30) (=> (= tmp%54 tmp%53) %%switch_label%%29)))))))) (=> (not (>= (uClip SZ (Sub (- (uHi SZ) 1) 0)) 1)) (=> (= tmp%54 false) %%switch_label%%29))) (and (not %%switch_label%%29) (=> (= tmp%55 tmp%54) %%switch_label%%28))))) (=> (not (%B tmp%49)) (=> (= tmp%55 false) %%switch_label%%28))) (and (not %%switch_label%%28) (=> (= tmp%56 tmp%55) %%switch_label%%22))))))))))) (and (not %%switch_label%%22) (=> (= tmp%57 tmp%56) %%switch_label%%16))))) (and (not %%switch_label%%16) (=> (= tmp%58 tmp%57) %%switch_label%%10))))) (and (not %%switch_label%%10) (=> (= tmp%59 tmp%58) %%switch_label%%4))))) (and (not %%switch_label%%4) (=> (= tmp%60 tmp%59) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= %return! (B tmp%60)) (=> %%location_label%%49 (= %return! (lib!marshal_v.Marshalable.is_marshalable.? $ TYPE%lib!cmessage_v.CMessage. self!))))))))
(check-sat)
(exit)
