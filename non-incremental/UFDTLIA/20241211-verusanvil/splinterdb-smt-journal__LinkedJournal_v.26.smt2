...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%2.can_crop.? self! depth!) (=> (= tmp%1 (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!)))) (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.pointer_after_crop. tmp%1 tmp%2 depth!)))))))
(check-sat)
(exit)
