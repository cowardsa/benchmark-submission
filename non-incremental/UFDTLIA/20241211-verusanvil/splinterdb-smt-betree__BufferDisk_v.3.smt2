...
(declare-const tmp%2 lib!spec.Messages_t.Message.)
(declare-const tmp%3 Poly)
(declare-const tmp%4 lib!spec.Messages_t.Message.)
...
(assert (not (=> (lib!betree.BufferDisk_v.impl&%0.valid_buffers.? T&. T& self! buffers!) (=> (and (<= 0 (%I start!)) (<= (%I start!) (lib!betree.LinkedSeq_v.impl&%0.len.? buffers!))) (=> (<= (%I start!) (lib!betree.LinkedSeq_v.impl&%0.len.? buffers!)) (or (and (=> (= (%I start!) (lib!betree.LinkedSeq_v.impl&%0.len.? buffers!)) (=> (= tmp%4 (lib!spec.Messages_t.Message./Update (%Poly%lib!spec.Messages_t.Delta. (Poly%lib!spec.Messages_t.Delta. (lib!spec.Messages_t.nop_delta.? (I 0)))))) %%switch_label%%0)) (=> (not (= (%I start!) (lib!betree.LinkedSeq_v.impl&%0.len.? buffers!))) (and (=> %%location_label%%0 (req%lib!betree.LinkedSeq_v.impl&%0.spec_index. buffers! start!)) (=> (= tmp%1 (%Poly%lib!spec.AsyncDisk_t.Address. (vstd!seq.Seq.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<lib!spec.AsyncDisk_t.Address.>. (lib!betree.LinkedSeq_v.LinkedSeq./LinkedSeq/addrs (%Poly%lib!betree.LinkedSeq_v.LinkedSeq. buffers!))) start!))) (=> (= tmp%3 (I (Add (%I start!) 1))) (and (=> %%location_label%%1 (req%lib!betree.BufferDisk_v.impl&%1.query_from. T&. T& self! buffers! k! tmp%3)) (=> (= tmp%2 (lib!betree.BufferDisk_v.impl&%1.query_from.? T&. T& self! buffers! k! (I (Add (%I start!) 1)))) (=> (= tmp%4 (lib!spec.Messages_t.impl&%1.merge.? (Poly%lib!spec.Messages_t.Message. (lib!betree.BufferDisk_v.impl&%1.query.? T&. T& self! (Poly%lib!spec.AsyncDisk_t.Address. tmp%1) k!)) (Poly%lib!spec.Messages_t.Message. tmp%2))) %%switch_label%%0)))))))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
