...
(set-info :comment ";; MODULE 'module betree::Memtable_v'")
...
(set-info :comment ";; Function-Decl lib::betree::Memtable_v::Memtable::contains")
...
(set-info :comment ";; Function-Recommends lib::betree::Memtable_v::Memtable::query")
(set-info :comment ";; betree/Memtable_v.rs:31:5: 31:64 (#0)")
...
(set-info :comment ";; Function-Recommends lib::betree::Memtable_v::Memtable::apply_put")
(set-info :comment ";; betree/Memtable_v.rs:46:5: 46:79 (#0)")
...
(set-info :comment ";; Spec-Termination lib::betree::Memtable_v::Memtable::apply_puts")
(set-info :comment ";; betree/Memtable_v.rs:54:5: 54:80 (#0)")
(declare-const T&. Dcr)
(declare-const T& Type)
(declare-const self! Poly)
(declare-const puts! Poly)
(declare-const tmp%1 lib!betree.Memtable_v.Memtable.)
(declare-const tmp%2 Poly)
(declare-const last_lsn@ Int)
(declare-const tmp%3 Poly)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (has_type self! (TYPE%lib!betree.Memtable_v.Memtable. T&. T&)))
(assert (has_type puts! TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!))) (=> (tr_bound%lib!betree.Buffer_v.Buffer. T&. T&) (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? puts!) (or (and (=> (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? puts!) (=> (= tmp%3 self!) %%switch_label%%0)) (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? puts!)) (=> (= last_lsn@ (nClip (Sub (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!)) 1))) (=> (= tmp%2 (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? puts! (I last_lsn@)))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.Memtable_v.Memtable. self!)) (puts!$1 (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. tmp%2))) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!$1)))) decrease%init0 false)) (=> (has_type (Poly%lib!betree.Memtable_v.Memtable. tmp%1) (TYPE%lib!betree.Memtable_v.Memtable. T&. T&)) (=> (= tmp%1 (lib!betree.Memtable_v.impl&%0.apply_puts.? T&. T& self! (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? puts! (I last_lsn@))))) (=> (= tmp%3 (Poly%lib!betree.Memtable_v.Memtable. (lib!betree.Memtable_v.impl&%0.apply_put.? T&. T& (Poly%lib!betree.Memtable_v.Memtable. tmp%1) (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!))) (I last_lsn@))))) %%switch_label%%0)))))))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
