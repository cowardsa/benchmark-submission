...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBranch_v.impl&%5.get_rank.? self! ranking!)) (=> (= decrease%init1 2) (or (and (=> (not (lib!betree.LinkedBranch_v.impl&%5.has_root.? self!)) (=> (= tmp%2 (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.)) %%switch_label%%0)) (=> (not (not (lib!betree.LinkedBranch_v.impl&%5.has_root.? self!))) (or (and (=> (is-lib!betree.LinkedBranch_v.Node./Leaf_ (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (=> (= tmp%1 (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/root (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!))))) %%switch_label%%1)) (=> (not (is-lib!betree.LinkedBranch_v.Node./Leaf_ (lib!betree.LinkedBranch_v.impl&%5.root.? self!))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!)) (ranking!$1 (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!))) (lib!betree.LinkedBranch_v.impl&%5.get_rank.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!$0) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!$1))) decrease%init0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!)) (ranking!$1 (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!))) 1) decrease%init1 false))) (=> (= tmp%1 (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (lib!betree.Utils_v.union_seq_of_sets.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.>. subtree_addrs@)) (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/root (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!))))) %%switch_label%%1)))) (and (not %%switch_label%%1) (=> (= tmp%2 tmp%1) %%switch_label%%0))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
