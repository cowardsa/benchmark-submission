...
(assert (lib!journal.LinkedJournal_v.impl&%1.decodable.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. core!option.Option./None)))
...
(assert (not (=> (= tight@ (lib!journal.LinkedJournal_v.impl&%1.build_tight.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. core!option.Option./None))) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.wf.? (Poly%lib!journal.LinkedJournal_v.DiskView. tight@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (lib!journal.LinkedJournal_v.impl&%1.valid_ranking.? (Poly%lib!journal.LinkedJournal_v.DiskView. tight@) (vstd!map.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (and (=> (has_type other@ TYPE%lib!journal.LinkedJournal_v.DiskView.) (=> (and (and (and (lib!journal.LinkedJournal_v.impl&%1.decodable.? other@ (Poly%core!option.Option. core!option.Option./None)) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? other@)) (= (lib!journal.LinkedJournal_v.impl&%1.iptr.? (Poly%lib!journal.LinkedJournal_v.DiskView. tight@) (Poly%core!option.Option. core!option.Option./None)) (lib!journal.LinkedJournal_v.impl&%1.iptr.? other@ (Poly%core!option.Option. core!option.Option./None)))) (lib!journal.LinkedJournal_v.impl&%1.is_sub_disk.? other@ (Poly%lib!journal.LinkedJournal_v.DiskView. tight@))) (=> (= tmp%3 (ext_eq true (TYPE%vstd!set.Set. $ TYPE%lib!spec.AsyncDisk_t.Address.) (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. tight@))))) (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. other@)))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (ext_eq true (TYPE%vstd!map.Map. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord.) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. other@))) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. tight@)))))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> %%location_label%%4 (ext_eq false TYPE%lib!journal.LinkedJournal_v.DiskView. other@ (Poly%lib!journal.LinkedJournal_v.DiskView. tight@))))))))))) (=> (forall ((other$ Poly)) (! (=> (has_type other$ TYPE%lib!journal.LinkedJournal_v.DiskView.) (=> (and (and (and (lib!journal.LinkedJournal_v.impl&%1.decodable.? other$ (Poly%core!option.Option. core!option.Option./None)) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? other$)) (= (lib!journal.LinkedJournal_v.impl&%1.iptr.? (Poly%lib!journal.LinkedJournal_v.DiskView. tight@) (Poly%core!option.Option. core!option.Option./None)) (lib!journal.LinkedJournal_v.impl&%1.iptr.? other$ (Poly%core!option.Option. core!option.Option./None)))) (lib!journal.LinkedJournal_v.impl&%1.is_sub_disk.? other$ (Poly%lib!journal.LinkedJournal_v.DiskView. tight@))) (ext_eq false TYPE%lib!journal.LinkedJournal_v.DiskView. other$ (Poly%lib!journal.LinkedJournal_v.DiskView. tight@)))) :pattern ((lib!journal.LinkedJournal_v.impl&%1.is_sub_disk.? other$ (Poly%lib!journal.LinkedJournal_v.DiskView. tight@))) )) (=> %%location_label%%5 (lib!journal.LinkedJournal_v.impl&%1.is_tight.? (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.impl&%1.build_tight.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!) (Poly%core!option.Option. core!option.Option./None))) (Poly%core!option.Option. core!option.Option./None))))))))))))))
(check-sat)
(exit)
