...
(declare-const head@ lib!journal.LinkedJournal_v.JournalRecord.)
(declare-const next_ptr@ core!option.Option.)
...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.entries_wf.? self!) (=> (lib!journal.LinkedJournal_v.impl&%1.nondangling_pointers.? self!) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) addr!) (=> (= tmp%2 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. tmp%2 addr!)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) addr!)) (=> (= head@ (%Poly%lib!journal.LinkedJournal_v.JournalRecord. tmp%1)) (=> (= next_ptr@ (lib!journal.LinkedJournal_v.impl&%0.cropped_prior.? (Poly%lib!journal.LinkedJournal_v.JournalRecord. head@) (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))))) (or (and (=> (is-core!option.Option./Some_ next_ptr@) (and (=> %%location_label%%1 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%core!option.Option. next_ptr@))) (=> (= tmp%3 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. next_ptr@)))) (=> (= tmp%5 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (and (=> %%location_label%%2 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. tmp%5 tmp%3)) (=> (= tmp%4 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) tmp%3)) (=> (= tmp%6 (lib!abstract_system.MsgHistory_v.impl&%0.can_concat.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. tmp%4))) (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (Poly%lib!journal.LinkedJournal_v.JournalRecord. head@)))))) %%switch_label%%0))))))) (=> (not (is-core!option.Option./Some_ next_ptr@)) (=> (= tmp%6 true) %%switch_label%%0))) (not %%switch_label%%0))))))))))))
(check-sat)
(exit)
