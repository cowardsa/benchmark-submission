...
(declare-const tmp%4 lib!betree.LinkedBetree_v.LinkedBetree.)
...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%5.can_recurse_for_reachable.? T&. T& self! ranking! child_idx!) (=> (lib!betree.LinkedBetree_v.impl&%5.can_recurse_for_reachable.? T&. T& self! ranking! child_idx!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.get_rank. T&. T& self! ranking!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& self! ranking!)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%5.child_count. T&. T& self!)) (=> (= tmp%2 (lib!betree.LinkedBetree_v.impl&%5.child_count.? T&. T& self!)) (and (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%5.child_count. T&. T& self!)) (=> (= tmp%7 (lib!betree.LinkedBetree_v.impl&%5.child_count.? T&. T& self!)) (or (and (=> (< (%I child_idx!) tmp%7) (and (=> %%location_label%%3 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%8 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (=> (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%8) child_idx!) %%switch_label%%1)))) (=> (not (< (%I child_idx!) tmp%7)) %%switch_label%%1)) (and (not %%switch_label%%1) (and (=> %%location_label%%4 (req%lib!betree.LinkedBetree_v.impl&%5.child_count. T&. T& self!)) (=> (= tmp%3 (lib!betree.LinkedBetree_v.impl&%5.child_count.? T&. T& self!)) (or (and (=> (= (%I child_idx!) tmp%3) (=> (= tmp%6 (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.)) %%switch_label%%0)) (=> (not (= (%I child_idx!) tmp%3)) (and (=> %%location_label%%5 (req%lib!betree.LinkedBetree_v.impl&%5.child_at_idx. T&. T& self! child_idx!)) (=> (= tmp%4 (lib!betree.LinkedBetree_v.impl&%5.child_at_idx.? T&. T& self! child_idx!)) (and (=> %%location_label%%6 (req%lib!betree.LinkedBetree_v.impl&%5.reachable_betree_addrs_using_ranking. T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. tmp%4) ranking!)) (=> (= tmp%5 (I (nClip (Add (%I child_idx!) 1)))) (and (=> %%location_label%%7 (req%lib!betree.LinkedBetree_v.impl&%5.reachable_betree_addrs_using_ranking_recur. T&. T& self! ranking! tmp%5)) (=> (= tmp%6 (vstd!set.impl&%0.union.? $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. child_addrs@) (Poly%vstd!set.Set<lib!spec.AsyncDisk_t.Address.>. right_subtree_addrs@))) %%switch_label%%0)))))))) (not %%switch_label%%0))))))))))))))))
(check-sat)
(exit)
