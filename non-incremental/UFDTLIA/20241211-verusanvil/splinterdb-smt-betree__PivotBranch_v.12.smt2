...
(declare-const self! lib!betree.PivotBranch_v.Node.)
...
(assert (lib!betree.PivotBranch_v.impl&%3.wf.? (Poly%lib!betree.PivotBranch_v.Node. self!)))
...
(assert (not (=> (= s@ (ite (is-lib!betree.PivotBranch_v.Node./Leaf_ self!) (lib!betree.PivotBranch_v.Node./Leaf/keys (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. self!))) (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. self!))))) (and (=> %%location_label%%0 (req%lib!spec.KeyType_t.impl&%1.strictly_sorted_implies_sorted. s@)) (=> (ens%lib!spec.KeyType_t.impl&%1.strictly_sorted_implies_sorted. s@) (=> (= tmp%1 (lib!spec.KeyType_t.impl&%1.largest_lte.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s@) (Poly%lib!spec.KeyType_t.Key. key!))) (and (=> %%location_label%%1 (req%lib!spec.KeyType_t.impl&%1.largest_lte_ensures. s@ key! tmp%1)) (=> (ens%lib!spec.KeyType_t.impl&%1.largest_lte_ensures. s@ key! tmp%1) (=> %%location_label%%2 (let ((s$ (lib!betree.PivotBranch_v.impl&%3.get_keys_or_pivots.? (Poly%lib!betree.PivotBranch_v.Node. self!)))) (and (and (and (let ((tmp%%$ (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. self!) (Poly%lib!spec.KeyType_t.Key. key!)))) (and (<= (Sub 0 1) tmp%%$) (< tmp%%$ (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s$))))) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (<= (%I i$) (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. self!) (Poly%lib!spec.KeyType_t.Key. key!)))) (lib!spec.KeyType_t.impl&%1.lte.? (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s$) i$) (Poly%lib!spec.KeyType_t.Key. key!)))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s$) i$)) ))) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (< (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. self!) (Poly%lib!spec.KeyType_t.Key. key!)) (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s$)))) (lib!spec.KeyType_t.impl&%1.lt.? (Poly%lib!spec.KeyType_t.Key. key!) (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s$) i$)))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s$) i$)) ))) (=> (vstd!seq_lib.impl&%0.contains.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s$) (Poly%lib!spec.KeyType_t.Key. key!)) (and (<= 0 (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. self!) (Poly%lib!spec.KeyType_t.Key. key!))) (= (%Poly%lib!spec.KeyType_t.Key. (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. s$) (I (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. self!) (Poly%lib!spec.KeyType_t.Key. key!))))) key!))))))))))))))
(check-sat)
(exit)
