...
(set-info :comment ";; MODULE 'module allocation_layer::UnifiedCrashAwareJournal_v'")
...
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.empty. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.to_tj. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.seq_start. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.seq_end. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.valid_image. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.tight_domain. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.tight_dv. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.init_by. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.wf. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.decodable. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.to_lj. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.to_aj. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.supports_image. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%2.arrow_v. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%2.arrow_Known_v. FuelId)
(declare-const fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%3.to_jdv. FuelId)
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_empty. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!map_lib.impl&%0.contains_key. fuel%vstd!map_lib.impl&%0.contains_value. fuel%vstd!map_lib.impl&%0.values. fuel%vstd!map_lib.impl&%0.submap_of. fuel%vstd!map_lib.impl&%0.spec_le. fuel%vstd!map_lib.impl&%0.union_prefer_right. fuel%vstd!map_lib.impl&%0.restrict. fuel%vstd!math.max. fuel%vstd!set.impl&%0.subset_of. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_mk_map_domain. fuel%vstd!set.axiom_mk_map_index. fuel%vstd!set.axiom_set_empty_finite. fuel%lib!abstract_system.MsgHistory_v.impl&%0.wf. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_exactly. fuel%lib!abstract_system.MsgHistory_v.impl&%0.is_empty. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_follow. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_concat. fuel%lib!abstract_system.MsgHistory_v.impl&%0.empty_history_at. fuel%lib!allocation_layer.AllocationJournal_v.singleton_index. fuel%lib!allocation_layer.AllocationJournal_v.contiguous_lsns. fuel%lib!allocation_layer.AllocationJournal_v.aus_hold_contiguous_lsns. fuel%lib!allocation_layer.AllocationJournal_v.au_addrs_past_pointer. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.tight_domain. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.bounded_inactive_lsns. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.build_lsn_au_index_page_walk. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.build_lsn_au_index_au_walk. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.upstream. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.nonzero_pages_point_backward. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.internal_au_pages_fully_linked. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.has_unique_lsns. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.pointer_is_upstream. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.wf_addrs. fuel%lib!allocation_layer.AllocationJournal_v.impl&%1.valid_first_au. fuel%lib!allocation_layer.AllocationJournal_v.impl&%2.au_domain_valid. fuel%lib!allocation_layer.AllocationJournal_v.impl&%2.build_lsn_au_index. fuel%lib!allocation_layer.AllocationJournal_v.impl&%2.valid_structure. fuel%lib!allocation_layer.AllocationJournal_v.impl&%2.valid_subrange. fuel%lib!allocation_layer.LikesJournal_v.impl&%2.addr_supports_lsn. fuel%lib!allocation_layer.LikesJournal_v.impl&%2.tj_at. fuel%lib!allocation_layer.MiniAllocator_v.impl&%0.wf. fuel%lib!allocation_layer.MiniAllocator_v.impl&%1.empty. fuel%lib!allocation_layer.MiniAllocator_v.impl&%1.wf. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.empty. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.to_tj. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.seq_start. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.seq_end. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.valid_image. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.tight_domain. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.tight_dv. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.init_by. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.wf. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.decodable. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.to_lj. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.to_aj. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.supports_image. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%2.arrow_v. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%2.arrow_Known_v. fuel%lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%3.to_jdv. fuel%lib!disk.GenericDisk_v.impl&%0.first_page. fuel%lib!disk.GenericDisk_v.impl&%0.previous. fuel%lib!disk.GenericDisk_v.impl&%0.after_page. fuel%lib!disk.GenericDisk_v.first_page. fuel%lib!journal.LinkedJournal_v.impl&%0.wf. fuel%lib!journal.LinkedJournal_v.impl&%0.has_link. fuel%lib!journal.LinkedJournal_v.impl&%0.cropped_prior. fuel%lib!journal.LinkedJournal_v.impl&%0.contains_lsn. fuel%lib!journal.LinkedJournal_v.impl&%1.entries_wf. fuel%lib!journal.LinkedJournal_v.impl&%1.is_nondangling_pointer. fuel%lib!journal.LinkedJournal_v.impl&%1.nondangling_pointers. fuel%lib!journal.LinkedJournal_v.impl&%1.this_block_can_concat. fuel%lib!journal.LinkedJournal_v.impl&%1.blocks_can_concat. fuel%lib!journal.LinkedJournal_v.impl&%1.blocks_each_have_link. fuel%lib!journal.LinkedJournal_v.impl&%1.block_in_bounds. fuel%lib!journal.LinkedJournal_v.impl&%1.wf. fuel%lib!journal.LinkedJournal_v.impl&%1.valid_ranking. fuel%lib!journal.LinkedJournal_v.impl&%1.acyclic. fuel%lib!journal.LinkedJournal_v.impl&%1.the_ranking. fuel%lib!journal.LinkedJournal_v.impl&%1.decodable. fuel%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. fuel%lib!journal.LinkedJournal_v.impl&%1.seq_start. fuel%lib!journal.LinkedJournal_v.impl&%1.seq_end. fuel%lib!journal.LinkedJournal_v.impl&%1.is_sub_disk_with_newer_lsn. fuel%lib!journal.LinkedJournal_v.impl&%1.next. fuel%lib!journal.LinkedJournal_v.impl&%2.wf. fuel%lib!journal.LinkedJournal_v.impl&%2.seq_start. fuel%lib!journal.LinkedJournal_v.impl&%2.seq_end. fuel%lib!journal.LinkedJournal_v.impl&%2.decodable. fuel%lib!spec.AsyncDisk_t.impl&%0.wf. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(declare-datatypes ((core!option.Option. 0) (lib!journal.LinkedJournal_v.LinkedJournal.State. 0) (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. 0) (lib!abstract_system.MsgHistory_v.KeyedMessage. 0) (lib!abstract_system.MsgHistory_v.MsgHistory. 0) (lib!allocation_layer.MiniAllocator_v.PageAllocator. 0) (lib!allocation_layer.MiniAllocator_v.MiniAllocator. 0) (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. 0) (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. 0) (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. 0) (lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. 0) (lib!journal.LinkedJournal_v.JournalRecord. 0) (lib!journal.LinkedJournal_v.DiskView. 0) (lib!journal.LinkedJournal_v.TruncatedJournal. 0) (lib!spec.AsyncDisk_t.Address. 0) (lib!spec.KeyType_t.Key. 0) (lib!spec.Messages_t.Value. 0) (lib!spec.Messages_t.Delta. 0) (lib!spec.Messages_t.Message. 0) (tuple%0. 0)) (((core!option.Option./None ) (core!option.Option./Some (core!option.Option./Some/?0 Poly))) ((lib!journal.LinkedJournal_v.LinkedJournal.State./State (lib!journal.LinkedJournal_v.LinkedJournal.State./State/?truncated_journal lib!journal.LinkedJournal_v.TruncatedJournal.) (lib!journal.LinkedJournal_v.LinkedJournal.State./State/?unmarshalled_tail lib!abstract_system.MsgHistory_v.MsgHistory.))) ((lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/?journal lib!journal.LinkedJournal_v.LinkedJournal.State.) (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/?lsn_au_index vstd!map.Map<nat./nat.>.) (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/?first Int) (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/?mini_allocator lib!allocation_layer.MiniAllocator_v.MiniAllocator.))) ((lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage (lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage/?key lib!spec.KeyType_t.Key.) (lib!abstract_system.MsgHistory_v.KeyedMessage./KeyedMessage/?message lib!spec.Messages_t.Message.))) ((lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/?msgs vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>.) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/?seq_start Int) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/?seq_end Int))) ((lib!allocation_layer.MiniAllocator_v.PageAllocator./PageAllocator (lib!allocation_layer.MiniAllocator_v.PageAllocator./PageAllocator/?observed vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.) (lib!allocation_layer.MiniAllocator_v.PageAllocator./PageAllocator/?reserved vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.) (lib!allocation_layer.MiniAllocator_v.PageAllocator./PageAllocator/?au Int))) ((lib!allocation_layer.MiniAllocator_v.MiniAllocator./MiniAllocator (lib!allocation_layer.MiniAllocator_v.MiniAllocator./MiniAllocator/?allocs vstd!map.Map<nat./lib!allocation_layer.MiniAllocator_v.PageAllocator.>.) (lib!allocation_layer.MiniAllocator_v.MiniAllocator./MiniAllocator/?curr core!option.Option.))) ((lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/?freshest_rec core!option.Option.) (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/?boundary_lsn Int) (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/?first Int))) ((lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/?image lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/?unmarshalled_tail lib!abstract_system.MsgHistory_v.MsgHistory.) (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/?lsn_au_index vstd!map.Map<nat./nat.>.) (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/?mini_allocator lib!allocation_layer.MiniAllocator_v.MiniAllocator.))) ((lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Unknown ) (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known/?v lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.))) ((lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView./DiskView (lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView./DiskView/?entries vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>.))) ((lib!journal.LinkedJournal_v.JournalRecord./JournalRecord (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/?message_seq lib!abstract_system.MsgHistory_v.MsgHistory.) (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/?prior_rec core!option.Option.))) ((lib!journal.LinkedJournal_v.DiskView./DiskView (lib!journal.LinkedJournal_v.DiskView./DiskView/?boundary_lsn Int) (lib!journal.LinkedJournal_v.DiskView./DiskView/?entries vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>.))) ((lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/?freshest_rec core!option.Option.) (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/?disk_view lib!journal.LinkedJournal_v.DiskView.))) ((lib!spec.AsyncDisk_t.Address./Address (lib!spec.AsyncDisk_t.Address./Address/?au Int) (lib!spec.AsyncDisk_t.Address./Address/?page Int))) ((lib!spec.KeyType_t.Key./Key (lib!spec.KeyType_t.Key./Key/?0 Int))) ((lib!spec.Messages_t.Value./Value (lib!spec.Messages_t.Value./Value/?0 Int))) ((lib!spec.Messages_t.Delta./Delta (lib!spec.Messages_t.Delta./Delta/?0 Int))) ((lib!spec.Messages_t.Message./Define (lib!spec.Messages_t.Message./Define/?value lib!spec.Messages_t.Value.)) (lib!spec.Messages_t.Message./Update (lib!spec.Messages_t.Message./Update/?delta lib!spec.Messages_t.Delta.))) ((tuple%0./tuple%0 ))))
...
(declare-fun lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/journal (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.) lib!journal.LinkedJournal_v.LinkedJournal.State.)
(declare-fun lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/lsn_au_index (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.) vstd!map.Map<nat./nat.>.)
(declare-fun lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/first (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.) Int)
(declare-fun lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/mini_allocator (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.) lib!allocation_layer.MiniAllocator_v.MiniAllocator.)
...
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/freshest_rec (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) core!option.Option.)
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/boundary_lsn (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) Int)
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/first (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) Int)
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/image (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/unmarshalled_tail (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) lib!abstract_system.MsgHistory_v.MsgHistory.)
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/lsn_au_index (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) vstd!map.Map<nat./nat.>.)
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/mini_allocator (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) lib!allocation_layer.MiniAllocator_v.MiniAllocator.)
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known/v (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.) lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView./DiskView/entries (lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.) vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>.)
...
(declare-const TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. Type)
...
(declare-const TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. Type)
(declare-const TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. Type)
(declare-const TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. Type)
(declare-const TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. Type)
...
(declare-fun Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.) Poly)
(declare-fun %Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. (Poly) lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)
...
(declare-fun Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) Poly)
(declare-fun %Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. (Poly) lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)
(declare-fun Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) Poly)
(declare-fun %Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. (Poly) lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)
(declare-fun Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.) Poly)
(declare-fun %Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. (Poly) lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.)
(declare-fun Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. (lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.) Poly)
(declare-fun %Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. (Poly) lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.)
...
(assert (forall ((x lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) (! (= x (%Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. (Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. x))) :pattern ((Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.) (= x (Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. (%Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. x)))) :pattern ((has_type x TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) )))
(assert (forall ((_journal! lib!journal.LinkedJournal_v.LinkedJournal.State.) (_lsn_au_index! vstd!map.Map<nat./nat.>.) (_first! Int) (_mini_allocator! lib!allocation_layer.MiniAllocator_v.MiniAllocator.)) (! (=> (and (has_type (Poly%lib!journal.LinkedJournal_v.LinkedJournal.State. _journal!) TYPE%lib!journal.LinkedJournal_v.LinkedJournal.State.) (<= 0 _first!) (has_type (Poly%lib!allocation_layer.MiniAllocator_v.MiniAllocator. _mini_allocator!) TYPE%lib!allocation_layer.MiniAllocator_v.MiniAllocator.)) (has_type (Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State _journal! _lsn_au_index! _first! _mini_allocator!)) TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) :pattern ((has_type (Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State _journal! _lsn_au_index! _first! _mini_allocator!)) TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) )))
(assert (forall ((x lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) (! (= (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/journal x) (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/?journal x)) :pattern ((lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/journal x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.) (has_type (Poly%lib!journal.LinkedJournal_v.LinkedJournal.State. (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/journal (%Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. x))) TYPE%lib!journal.LinkedJournal_v.LinkedJournal.State.)) :pattern ((lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/journal (%Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. x)) (has_type x TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) )))
(assert (forall ((x lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) (! (= (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/lsn_au_index x) (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/?lsn_au_index x)) :pattern ((lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/lsn_au_index x)) )))
(assert (forall ((x lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) (! (= (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/first x) (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/?first x)) :pattern ((lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/first x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.) (<= 0 (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/first (%Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. x)))) :pattern ((lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/first (%Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. x)) (has_type x TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) )))
(assert (forall ((x lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) (! (= (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/mini_allocator x) (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/?mini_allocator x)) :pattern ((lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/mini_allocator x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.) (has_type (Poly%lib!allocation_layer.MiniAllocator_v.MiniAllocator. (lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/mini_allocator (%Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. x))) TYPE%lib!allocation_layer.MiniAllocator_v.MiniAllocator.)) :pattern ((lib!allocation_layer.AllocationJournal_v.AllocationJournal.State./State/mini_allocator (%Poly%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State. x)) (has_type x TYPE%lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)) )))
...
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) (! (= x (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. x))) :pattern ((Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) (= x (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. x)))) :pattern ((has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) )))
(assert (forall ((_freshest_rec! core!option.Option.) (_boundary_lsn! Int) (_first! Int)) (! (=> (and (has_type (Poly%core!option.Option. _freshest_rec!) (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.)) (<= 0 _boundary_lsn!) (<= 0 _first!)) (has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState _freshest_rec! _boundary_lsn! _first!)) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) :pattern ((has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState _freshest_rec! _boundary_lsn! _first!)) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) (! (= (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/freshest_rec x) (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/?freshest_rec x)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/freshest_rec x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) (has_type (Poly%core!option.Option. (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/freshest_rec (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. x))) (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.))) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/freshest_rec (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. x)) (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) (! (= (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/boundary_lsn x) (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/?boundary_lsn x)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/boundary_lsn x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) (<= 0 (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/boundary_lsn (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. x)))) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/boundary_lsn (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. x)) (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) (! (= (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/first x) (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/?first x)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/first x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) (<= 0 (lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/first (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. x)))) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState./ImageState/first (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. x)) (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) (! (= x (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. x))) :pattern ((Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) (= x (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. x)))) :pattern ((has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) )))
(assert (forall ((_image! lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) (_unmarshalled_tail! lib!abstract_system.MsgHistory_v.MsgHistory.) (_lsn_au_index! vstd!map.Map<nat./nat.>.) (_mini_allocator! lib!allocation_layer.MiniAllocator_v.MiniAllocator.)) (! (=> (and (has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. _image!) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.) (has_type (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. _unmarshalled_tail!) TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.) (has_type (Poly%lib!allocation_layer.MiniAllocator_v.MiniAllocator. _mini_allocator!) TYPE%lib!allocation_layer.MiniAllocator_v.MiniAllocator.)) (has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState _image! _unmarshalled_tail! _lsn_au_index! _mini_allocator!)) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) :pattern ((has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState _image! _unmarshalled_tail! _lsn_au_index! _mini_allocator!)) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) (! (= (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/image x) (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/?image x)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/image x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) (has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState. (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/image (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. x))) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/image (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. x)) (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) (! (= (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/unmarshalled_tail x) (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/?unmarshalled_tail x)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/unmarshalled_tail x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) (has_type (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/unmarshalled_tail (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. x))) TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/unmarshalled_tail (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. x)) (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) (! (= (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/lsn_au_index x) (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/?lsn_au_index x)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/lsn_au_index x)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) (! (= (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/mini_allocator x) (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/?mini_allocator x)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/mini_allocator x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) (has_type (Poly%lib!allocation_layer.MiniAllocator_v.MiniAllocator. (lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/mini_allocator (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. x))) TYPE%lib!allocation_layer.MiniAllocator_v.MiniAllocator.)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState./EphemeralState/mini_allocator (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. x)) (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.)) (! (= x (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. x))) :pattern ((Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.) (= x (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. x)))) :pattern ((has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.)) )))
(assert (has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Unknown) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.))
(assert (forall ((_v! lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) (! (=> (has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. _v!) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.) (has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known _v!)) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.)) :pattern ((has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known _v!)) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.)) (! (= (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known/v x) (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known/?v x)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known/v x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.) (has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState. (lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known/v (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. x))) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral./Known/v (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral. x)) (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.Ephemeral.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.)) (! (= x (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. x))) :pattern ((Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. x)) )))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.) (= x (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. (%Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. x)))) :pattern ((has_type x TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.)) (! (= (lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView./DiskView/entries x) (lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView./DiskView/?entries x)) :pattern ((lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView./DiskView/entries x)) )))
(assert (forall ((x lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.)) (! (has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. x) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.) :pattern ((has_type (Poly%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView. x) TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.)) )))
...
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::DiskView::to_jdv")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%3.to_jdv.? (Poly Poly) lib!journal.LinkedJournal_v.DiskView.)
...
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::ImageState::to_tj")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.to_tj.? (Poly Poly) lib!journal.LinkedJournal_v.TruncatedJournal.)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::ImageState::valid_image")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.valid_image.? (Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::EphemeralState::init_by")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.init_by.? (Poly Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::ImageState::tight_domain")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.tight_domain.? (Poly Poly) vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::ImageState::tight_dv")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.tight_dv.? (Poly Poly) lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.)
...
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::EphemeralState::to_lj")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.to_lj.? (Poly Poly) lib!journal.LinkedJournal_v.LinkedJournal.State.)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::EphemeralState::to_aj")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.to_aj.? (Poly Poly) lib!allocation_layer.AllocationJournal_v.AllocationJournal.State.)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::Ephemeral::arrow_v")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%2.arrow_v.? (Poly) lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::ImageState::seq_end")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.seq_end.? (Poly Poly) Int)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::ImageState::seq_start")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.seq_start.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::ImageState::empty")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%0.empty.? (Poly) lib!allocation_layer.UnifiedCrashAwareJournal_v.ImageState.)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::EphemeralState::wf")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.wf.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::EphemeralState::supports_image")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.supports_image.? (Poly Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::EphemeralState::decodable")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%1.decodable.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::allocation_layer::UnifiedCrashAwareJournal_v::Ephemeral::arrow_Known_v")
(declare-fun lib!allocation_layer.UnifiedCrashAwareJournal_v.impl&%2.arrow_Known_v.? (Poly) lib!allocation_layer.UnifiedCrashAwareJournal_v.EphemeralState.)
...
(assert (forall ((self! Poly)) (! (= (req%lib!journal.LinkedJournal_v.impl&%1.the_ranking. self!) (and (=> %%global_location_label%%14 (lib!journal.LinkedJournal_v.impl&%1.wf.? self!)) (=> %%global_location_label%%15 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)))) :pattern ((req%lib!journal.LinkedJournal_v.impl&%1.the_ranking. self!)) )))
...
(assert (forall ((self! Poly) (ptr! Poly)) (! (= (req%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. self! ptr!) (=> %%global_location_label%%16 (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! ptr!))) :pattern ((req%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. self! ptr!)) )))
...
(set-info :comment ";; Function-Recommends lib::allocation_layer::UnifiedCrashAwareJournal_v::DiskView::to_jdv")
(set-info :comment ";; allocation_layer/UnifiedCrashAwareJournal_v.rs:185:5: 185:81 (#0)")
(declare-const %return! lib!journal.LinkedJournal_v.DiskView.)
(declare-const self! Poly)
(declare-const boundary_lsn! Poly)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!allocation_layer.UnifiedCrashAwareJournal_v.DiskView.))
