...
(declare-const tail@ lib!journal.LinkedJournal_v.DiskView.)
(declare-const tmp%2 lib!journal.LinkedJournal_v.DiskView.)
...
(assert (not (=> (= decrease%init0 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? self! root!)) (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (or (and (=> (not (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (= tmp%3 (lib!journal.LinkedJournal_v.DiskView./DiskView (%I (I 0)) (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (vstd!map.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord.)))) %%switch_label%%0)) (=> (not (not (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!))) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. root!)) (=> (= tmp%2 (lib!journal.LinkedJournal_v.DiskView./DiskView (%I (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (vstd!map.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord.)))) %%switch_label%%1)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. root!))) (=> (= addr@ (%Poly%lib!spec.AsyncDisk_t.Address. (core!option.Option./Some/0 (%Poly%core!option.Option. root!)))) (=> (= tmp%1 (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)) (root!$1 (%Poly%core!option.Option. tmp%1))) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!$0) (Poly%core!option.Option. root!$1))) decrease%init0 false)) (=> (has_type (Poly%lib!journal.LinkedJournal_v.DiskView. tail@) TYPE%lib!journal.LinkedJournal_v.DiskView.) (=> (= tmp%2 (lib!journal.LinkedJournal_v.DiskView./DiskView (%I (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (vstd!map.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. (Poly%lib!journal.LinkedJournal_v.DiskView. tail@)))) (Poly%lib!spec.AsyncDisk_t.Address. addr@) (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (Poly%lib!spec.AsyncDisk_t.Address. addr@)))))) %%switch_label%%1))))))) (and (not %%switch_label%%1) (=> (= tmp%3 tmp%2) %%switch_label%%0))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
