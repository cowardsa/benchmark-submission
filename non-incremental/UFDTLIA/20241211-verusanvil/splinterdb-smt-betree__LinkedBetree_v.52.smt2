...
(declare-const tmp%8 lib!betree.LinkedBetree_v.Path.)
...
(assert (not (or (and (=> (and (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!)))) (lib!betree.LinkedBetree_v.impl&%5.acyclic.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!))))) (=> (= tmp%2 (Poly%lib!betree.LinkedBetree_v.LinkedBetree. (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!)))) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& tmp%2)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!))))) (=> (= tmp%3 (lib!betree.LinkedBetree_v.impl&%0.key_in_domain.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%1) (Poly%lib!spec.KeyType_t.Key. (lib!betree.LinkedBetree_v.Path./Path/key (%Poly%lib!betree.LinkedBetree_v.Path. self!))))) %%switch_label%%4))))) (=> (not (and (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!)))) (lib!betree.LinkedBetree_v.impl&%5.acyclic.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!)))))) (=> (= tmp%3 false) %%switch_label%%4))) (and (not %%switch_label%%4) (or (and (=> tmp%3 (or (and (=> (< 0 (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. self!))) (=> (= tmp%5 (Poly%lib!betree.LinkedBetree_v.LinkedBetree. (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!)))) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& tmp%5)) (=> (= tmp%4 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. (lib!betree.LinkedBetree_v.Path./Path/linked (%Poly%lib!betree.LinkedBetree_v.Path. self!))))) (=> (= tmp%6 (lib!betree.LinkedBetree_v.impl&%0.is_index.? (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%4))) %%switch_label%%3))))) (=> (not (< 0 (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. self!)))) (=> (= tmp%6 true) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= tmp%7 tmp%6) %%switch_label%%2)))) (=> (not tmp%3) (=> (= tmp%7 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%7 (or (and (=> (< 0 (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. self!))) (and (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%10.subpath. T&. T& self!)) (=> (= tmp%8 (lib!betree.LinkedBetree_v.impl&%10.subpath.? T&. T& self!)) (=> (= tmp%9 (lib!betree.LinkedBetree_v.impl&%10.valid.? T&. T& (Poly%lib!betree.LinkedBetree_v.Path. tmp%8))) %%switch_label%%1)))) (=> (not (< 0 (lib!betree.LinkedBetree_v.Path./Path/depth (%Poly%lib!betree.LinkedBetree_v.Path. self!)))) (=> (= tmp%9 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%10 tmp%9) %%switch_label%%0)))) (=> (not tmp%7) (=> (= tmp%10 false) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
