...
(declare-const tmp%3 lib!betree.LinkedBetree_v.BetreeNode.)
...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!) (or (and (=> (< (%I start!) (%I end!)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (=> (= tmp%2 (<= (%I end!) (lib!betree.LinkedSeq_v.impl&%0.len.? (Poly%lib!betree.LinkedSeq_v.LinkedSeq. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/buffers (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%1))))))) %%switch_label%%0)))) (=> (not (< (%I start!) (%I end!))) (=> (= tmp%2 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (and (< (%I start!) (%I end!)) (<= (%I end!) (lib!betree.LinkedSeq_v.impl&%0.len.? (Poly%lib!betree.LinkedSeq_v.LinkedSeq. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/buffers (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)))))))) (=> (has_type k@ TYPE%lib!spec.KeyType_t.Key.) (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%3 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (=> (= tmp%5 (Poly%lib!betree.BufferDisk_v.BufferDisk. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/buffer_dv (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))) (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%4.valid_compact_key_domain. T&. T& tmp%5 (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%3) start! end! k@)))))))))))))
(check-sat)
(exit)
