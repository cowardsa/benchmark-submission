...
(assert (not (=> (= decrease%init0 node!) (or (and (=> (is-lib!betree.PivotBranch_v.Node./Leaf_ node!) (=> (= keys@ (lib!betree.PivotBranch_v.Node./Leaf/keys (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. node!)))) (=> (= msgs@ (lib!betree.PivotBranch_v.Node./Leaf/msgs (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. node!)))) (and (=> %%location_label%%0 (req%lib!betree.PivotBranchRefinement_v.lemma_insert_leaf_is_correct. node! key! msg!)) (=> (ens%lib!betree.PivotBranchRefinement_v.lemma_insert_leaf_is_correct. node! key! msg!) %%switch_label%%0))))) (=> (not (is-lib!betree.PivotBranch_v.Node./Leaf_ node!)) (=> (= pivots@ (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. node!)))) (=> (= children@ (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. node!)))) (=> (= post@ (lib!betree.PivotBranch_v.impl&%3.insert.? (Poly%lib!betree.PivotBranch_v.Node. node!) (Poly%lib!spec.KeyType_t.Key. key!) (Poly%lib!spec.Messages_t.Message. msg!) (Poly%lib!betree.PivotBranch_v.Path. path!))) (=> (= r@ (lib!betree.PivotBranch_v.impl&%3.route.? (Poly%lib!betree.PivotBranch_v.Node. node!) (Poly%lib!spec.KeyType_t.Key. key!))) (=> (= tmp%1 (let ((tmp%%$ (Add r@ 1))) (and (<= 0 tmp%%$) (< tmp%%$ (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)))))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= tmp%2 (%Poly%lib!betree.PivotBranch_v.Node. (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) (I (Add r@ 1))))) (=> (= tmp%3 (lib!betree.PivotBranch_v.impl&%4.subpath.? (Poly%lib!betree.PivotBranch_v.Path. path!))) (and (=> %%location_label%%2 (check_decrease_height (Poly%lib!betree.PivotBranch_v.Node. (let ((node!$0 tmp%2) (key!$1 key!) (msg!$2 msg!) (path!$3 tmp%3)) node!$0)) (Poly%lib!betree.PivotBranch_v.Node. decrease%init0) false)) (and (=> %%location_label%%3 (req%lib!betree.PivotBranchRefinement_v.lemma_insert_inserts_to_all_keys. tmp%2 key! msg! tmp%3)) (=> (ens%lib!betree.PivotBranchRefinement_v.lemma_insert_inserts_to_all_keys. tmp%2 key! msg! tmp%3) (=> (= tmp%4 (ext_eq false (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. post@)))) (I (Add r@ 1))))) (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) (I (Add r@ 1))))) (Poly%lib!spec.KeyType_t.Key. key!)))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (=> (= tmp%5 (= (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. post@))))) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)))) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 (=> (= tmp%6 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. post@))))))) (not (= (%I i$) (Add r@ 1)))) (ext_eq true TYPE%lib!betree.PivotBranch_v.Node. (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. (Poly%lib!betree.PivotBranch_v.Node. post@)))) i$) (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) i$)))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) i$)) ))) (and (=> %%location_label%%6 tmp%6) (=> tmp%6 (=> (= tmp%7 (ext_eq true (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.impl&%3.insert.? (Poly%lib!betree.PivotBranch_v.Node. node!) (Poly%lib!spec.KeyType_t.Key. key!) (Poly%lib!spec.Messages_t.Message. msg!) (Poly%lib!betree.PivotBranch_v.Path. path!))))) (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!))) (Poly%lib!spec.KeyType_t.Key. key!)))) (and (=> %%location_label%%7 tmp%7) (=> tmp%7 %%switch_label%%0)))))))))))))))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%8 (= (lib!betree.PivotBranch_v.impl&%3.all_keys.? (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.impl&%3.insert.? (Poly%lib!betree.PivotBranch_v.Node. node!) (Poly%lib!spec.KeyType_t.Key. key!) (Poly%lib!spec.Messages_t.Message. msg!) (Poly%lib!betree.PivotBranch_v.Path. path!)))) (%Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.impl&%3.all_keys.? (Poly%lib!betree.PivotBranch_v.Node. node!))) (Poly%lib!spec.KeyType_t.Key. key!))))))))))
(check-sat)
(exit)
