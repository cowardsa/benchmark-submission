...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (=> (= tmp%2 (Poly%lib!betree.LinkedBranch_v.DiskView. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/disk_view (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!)))) (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%4.valid_ranking. tmp%2 ranking!))))))
(check-sat)
(exit)
