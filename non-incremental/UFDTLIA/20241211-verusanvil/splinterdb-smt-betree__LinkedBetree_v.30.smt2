...
(declare-const %return! lib!betree.BufferDisk_v.BufferDisk.)
(declare-const self! Poly)
(declare-const k@ Poly)
(declare-const k$1@ Poly)
(declare-const entries@ vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.Buffer_v.SimpleBuffer.>.)
