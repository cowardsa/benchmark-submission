...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBranch_v.impl&%5.get_rank.? self! ranking!)) (=> (= decrease%init1 0) (=> (and (and (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? self! ranking!)) (lib!betree.LinkedBranch_v.impl&%3.valid_child_index.? (Poly%lib!betree.LinkedBranch_v.Node. (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) i!)) (=> (= tmp%2 (Poly%lib!betree.LinkedBranch_v.LinkedBranch. (lib!betree.LinkedBranch_v.impl&%5.child_at_idx.? self! i!))) (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. tmp%2)) (ranking!$1 (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!))) (lib!betree.LinkedBranch_v.impl&%5.get_rank.? (Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!$0) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!$1))) decrease%init0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. tmp%2)) (ranking!$1 (%Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. ranking!))) 2) decrease%init1 false)))))))))
(check-sat)
(exit)
