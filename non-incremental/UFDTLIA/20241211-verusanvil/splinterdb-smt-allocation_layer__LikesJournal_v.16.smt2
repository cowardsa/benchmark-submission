...
(declare-const msgs@ lib!abstract_system.MsgHistory_v.MsgHistory.)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.))
(assert (has_type new! TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.))
(assert (has_type new_bdy! NAT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!) (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? new!) (=> (lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to.? self! new_bdy!) (or (and (=> (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) (%I new_bdy!)) (and (=> %%location_label%%0 (req%lib!abstract_system.MsgHistory_v.impl&%0.discard_old. self! new_bdy!)) (=> (= tmp%1 (lib!abstract_system.MsgHistory_v.impl&%0.discard_old.? self! new_bdy!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) (%I new_bdy!))) (=> (= tmp%2 (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
