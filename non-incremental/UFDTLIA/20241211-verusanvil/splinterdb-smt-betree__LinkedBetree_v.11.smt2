...
(assert (not (or (and (=> (lib!betree.LinkedBetree_v.impl&%1.entries_wf.? self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%1.healthy_child_ptrs. self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%1.healthy_child_ptrs.? self!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (lib!betree.LinkedBetree_v.impl&%1.entries_wf.? self!)) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
