...
(declare-const jr@ lib!journal.LinkedJournal_v.JournalRecord.)
...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! ptr!) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!) (or (and (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! ptr!) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%2 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (= tmp%3 tmp%2) %%switch_label%%1)))) (=> (not (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! ptr!)) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (and (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! ptr!) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (and (=> %%location_label%%2 (req%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. self! ptr!)) (=> (= tmp%4 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? self! ptr!)) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. ptr!)) (=> (= tmp%10 core!option.Option./None) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. ptr!))) (and (=> %%location_label%%3 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. ptr!)) (=> (= tmp%5 (core!option.Option./Some/0 (%Poly%core!option.Option. ptr!))) (=> (= tmp%7 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (and (=> %%location_label%%4 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. tmp%7 tmp%5)) (=> (= tmp%6 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) tmp%5)) (=> (= jr@ (%Poly%lib!journal.LinkedJournal_v.JournalRecord. tmp%6)) (=> (= tmp%9 (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%0.cropped_prior.? (Poly%lib!journal.LinkedJournal_v.JournalRecord. jr@) (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))))) (and (=> %%location_label%%5 (req%lib!journal.LinkedJournal_v.impl&%1.iptr. self! tmp%9)) (=> (= tmp%8 (lib!journal.LinkedJournal_v.impl&%1.iptr.? self! (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%0.cropped_prior.? (Poly%lib!journal.LinkedJournal_v.JournalRecord. jr@) (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))))))) (=> (= tmp%10 (core!option.Option./Some (Poly%lib!journal.PagedJournal_v.JournalRecord. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (Poly%lib!journal.LinkedJournal_v.JournalRecord. jr@))))) (%Poly%core!option.Option. (Poly%core!option.Option. tmp%8)))))) %%switch_label%%0)))))))))))) (not %%switch_label%%0)))))))))))))
(check-sat)
(exit)
