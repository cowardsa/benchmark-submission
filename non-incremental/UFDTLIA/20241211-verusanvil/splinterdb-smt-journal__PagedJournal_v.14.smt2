...
(assert (has_type self! TYPE%lib!journal.PagedJournal_v.JournalRecord.))
(assert (has_type boundary_lsn! NAT))
(assert (has_type depth! NAT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (%I depth!)) (=> (= decrease%init1 0) (or (and (=> (= (%I depth!) 0) (=> (= tmp%4 (core!option.Option./Some self!)) %%switch_label%%0)) (=> (not (= (%I depth!) 0)) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.cropped_prior.? self! boundary_lsn!))) (=> (= tmp%3 (I (nClip (Sub (%I depth!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((ojr!$0 (%Poly%core!option.Option. tmp%2)) (boundary_lsn!$1 (%I boundary_lsn!)) (depth!$2 (%I tmp%3))) depth!$2) decrease%init0 (check_decrease_int (let ((ojr!$0 (%Poly%core!option.Option. tmp%2)) (boundary_lsn!$1 (%I boundary_lsn!)) (depth!$2 (%I tmp%3))) 1) decrease%init1 false))) (=> (has_type (Poly%core!option.Option. tmp%1) (TYPE%core!option.Option. $ TYPE%lib!journal.PagedJournal_v.JournalRecord.)) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%0.opt_rec_crop_head_records.? (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.cropped_prior.? self! boundary_lsn!)) boundary_lsn! (I (nClip (Sub (%I depth!) 1))))) (=> (= tmp%4 tmp%1) %%switch_label%%0)))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
