...
(set-info :comment ";; MODULE 'module exec::Cache_v'")
...
(set-info :comment ";; Function-Decl lib::exec::Cache_v::Entry::arrow_Reserved_addr")
(declare-fun lib!exec.Cache_v.impl&%0.arrow_Reserved_addr.? (Poly) lib!spec.AsyncDisk_t.Address.)
(set-info :comment ";; Function-Decl lib::exec::Cache_v::Entry::arrow_Loading_addr")
(declare-fun lib!exec.Cache_v.impl&%0.arrow_Loading_addr.? (Poly) lib!spec.AsyncDisk_t.Address.)
(set-info :comment ";; Function-Decl lib::exec::Cache_v::Entry::arrow_Filled_addr")
(declare-fun lib!exec.Cache_v.impl&%0.arrow_Filled_addr.? (Poly) lib!spec.AsyncDisk_t.Address.)
(set-info :comment ";; Function-Decl lib::exec::Cache_v::Entry::arrow_Filled_data")
...
(set-info :comment ";; Function-Recommends lib::exec::Cache_v::Entry::get_addr")
(set-info :comment ";; exec/Cache_v.rs:37:5: 37:56 (#0)")
...
(set-info :comment ";; Function-Axioms lib::exec::Cache_v::Entry::arrow_Reserved_addr")
(assert (fuel_bool_default fuel%lib!exec.Cache_v.impl&%0.arrow_Reserved_addr.))
(assert (=> (fuel_bool fuel%lib!exec.Cache_v.impl&%0.arrow_Reserved_addr.) (forall ((self! Poly)) (! (= (lib!exec.Cache_v.impl&%0.arrow_Reserved_addr.? self!) (lib!exec.Cache_v.Entry./Reserved/addr (%Poly%lib!exec.Cache_v.Entry. self!))) :pattern ((lib!exec.Cache_v.impl&%0.arrow_Reserved_addr.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!exec.Cache_v.Entry.) (has_type (Poly%lib!spec.AsyncDisk_t.Address. (lib!exec.Cache_v.impl&%0.arrow_Reserved_addr.? self!)) TYPE%lib!spec.AsyncDisk_t.Address.)) :pattern ((lib!exec.Cache_v.impl&%0.arrow_Reserved_addr.? self!)) )))
(set-info :comment ";; Function-Axioms lib::exec::Cache_v::Entry::arrow_Loading_addr")
(assert (fuel_bool_default fuel%lib!exec.Cache_v.impl&%0.arrow_Loading_addr.))
(assert (=> (fuel_bool fuel%lib!exec.Cache_v.impl&%0.arrow_Loading_addr.) (forall ((self! Poly)) (! (= (lib!exec.Cache_v.impl&%0.arrow_Loading_addr.? self!) (lib!exec.Cache_v.Entry./Loading/addr (%Poly%lib!exec.Cache_v.Entry. self!))) :pattern ((lib!exec.Cache_v.impl&%0.arrow_Loading_addr.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!exec.Cache_v.Entry.) (has_type (Poly%lib!spec.AsyncDisk_t.Address. (lib!exec.Cache_v.impl&%0.arrow_Loading_addr.? self!)) TYPE%lib!spec.AsyncDisk_t.Address.)) :pattern ((lib!exec.Cache_v.impl&%0.arrow_Loading_addr.? self!)) )))
(set-info :comment ";; Function-Axioms lib::exec::Cache_v::Entry::arrow_Filled_addr")
(assert (fuel_bool_default fuel%lib!exec.Cache_v.impl&%0.arrow_Filled_addr.))
(assert (=> (fuel_bool fuel%lib!exec.Cache_v.impl&%0.arrow_Filled_addr.) (forall ((self! Poly)) (! (= (lib!exec.Cache_v.impl&%0.arrow_Filled_addr.? self!) (lib!exec.Cache_v.Entry./Filled/addr (%Poly%lib!exec.Cache_v.Entry. self!))) :pattern ((lib!exec.Cache_v.impl&%0.arrow_Filled_addr.? self!)) ))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!exec.Cache_v.Entry.) (has_type (Poly%lib!spec.AsyncDisk_t.Address. (lib!exec.Cache_v.impl&%0.arrow_Filled_addr.? self!)) TYPE%lib!spec.AsyncDisk_t.Address.)) :pattern ((lib!exec.Cache_v.impl&%0.arrow_Filled_addr.? self!)) )))
(set-info :comment ";; Function-Axioms lib::exec::Cache_v::Entry::arrow_Filled_data")
(assert (fuel_bool_default fuel%lib!exec.Cache_v.impl&%0.arrow_Filled_data.))
(assert (=> (fuel_bool fuel%lib!exec.Cache_v.impl&%0.arrow_Filled_data.) (forall ((self! Poly)) (! (= (lib!exec.Cache_v.impl&%0.arrow_Filled_data.? self!) (lib!exec.Cache_v.Entry./Filled/data (%Poly%lib!exec.Cache_v.Entry. self!))) :pattern ((lib!exec.Cache_v.impl&%0.arrow_Filled_data.? self!)) ))))
...
(set-info :comment ";; Function-Def lib::exec::Cache_v::injective_map_property")
(set-info :comment ";; exec/Cache_v.rs:328:1: 328:57 (#0)")
(declare-const K&. Dcr)
...
(assert (vstd!map_lib.impl&%0.is_injective.? K&. K& V&. V& map!))
(assert (not true))
(check-sat)
(exit)
