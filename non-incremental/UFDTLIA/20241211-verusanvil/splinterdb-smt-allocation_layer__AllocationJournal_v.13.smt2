...
(declare-const bottom@ core!option.Option.)
(declare-const last_lsn@ Int)
(declare-const first_lsn@ Int)
(declare-const update@ vstd!map.Map<nat./nat.>.)
(declare-const prior_result@ vstd!map.Map<nat./nat.>.)
(declare-const tmp%2 vstd!map.Map<nat./nat.>.)
(declare-const addr@ lib!spec.AsyncDisk_t.Address.)
(declare-const tmp%3 Poly)
(declare-const tmp%4 lib!spec.AsyncDisk_t.Address.)
(declare-const tmp%5 lib!spec.AsyncDisk_t.Address.)
(declare-const bottom$1@ core!option.Option.)
(declare-const addr$1@ lib!spec.AsyncDisk_t.Address.)
...
(assert (not (=> (= decrease%init0 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? self! root!)) (=> (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. root!)) (and (and (lib!allocation_layer.AllocationJournal_v.impl&%1.pointer_is_upstream.? self! root! first!) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (lib!allocation_layer.AllocationJournal_v.impl&%1.internal_au_pages_fully_linked.? self!))) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. root!)) %%switch_label%%2) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. root!))) (=> (= addr$1@ (%Poly%lib!spec.AsyncDisk_t.Address. (core!option.Option./Some/0 (%Poly%core!option.Option. root!)))) (or (and (=> (= (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. addr$1@))) (%I first!)) %%switch_label%%3) (=> (not (= (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. addr$1@))) (%I first!))) (=> (= bottom$1@ (lib!disk.GenericDisk_v.first_page.? root!)) (=> (ens%lib!allocation_layer.AllocationJournal_v.impl&%1.bottom_properties. (%Poly%lib!journal.LinkedJournal_v.DiskView. self!) (%Poly%core!option.Option. root!) (%I first!)) (=> (= tmp%4 (%Poly%lib!spec.AsyncDisk_t.Address. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. bottom$1@))))) (=> (= tmp%5 (%Poly%lib!spec.AsyncDisk_t.Address. (core!option.Option./Some/0 (%Poly%core!option.Option. root!)))) (=> (ens%lib!allocation_layer.AllocationJournal_v.impl&%1.transitive_ranking. (%Poly%lib!journal.LinkedJournal_v.DiskView. self!) tmp%4 tmp%5 (%I first!)) %%switch_label%%3))))))) (and (not %%switch_label%%3) %%switch_label%%2))))) (and (not %%switch_label%%2) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. root!)) (=> (= tmp%3 (vstd!map.impl&%0.empty.? $ NAT $ NAT)) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. root!))) (=> (= addr@ (%Poly%lib!spec.AsyncDisk_t.Address. (core!option.Option./Some/0 (%Poly%core!option.Option. root!)))) (or (and (=> (= (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. addr@))) (%I first!)) (=> (= tmp%2 (lib!allocation_layer.AllocationJournal_v.impl&%1.build_lsn_au_index_page_walk.? self! root!)) %%switch_label%%1)) (=> (not (= (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. (Poly%lib!spec.AsyncDisk_t.Address. addr@))) (%I first!))) (=> (= bottom@ (lib!disk.GenericDisk_v.first_page.? root!)) (=> (= last_lsn@ (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (core!option.Option./Some/0 (%Poly%core!option.Option. root!))))))))) (=> (= first_lsn@ (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. bottom@)))))))))) (=> (= update@ (lib!allocation_layer.AllocationJournal_v.singleton_index.? (I first_lsn@) (I last_lsn@) (I (lib!spec.AsyncDisk_t.Address./Address/au (%Poly%lib!spec.AsyncDisk_t.Address. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. bottom@)))))))) (=> (= tmp%1 (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? self! (Poly%core!option.Option. bottom@)))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)) (root!$1 (%Poly%core!option.Option. tmp%1)) (first!$2 (%I first!))) (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? (Poly%lib!journal.LinkedJournal_v.DiskView. self!$0) (Poly%core!option.Option. root!$1))) decrease%init0 false)) (=> (= tmp%2 (%Poly%vstd!map.Map<nat./nat.>. (vstd!map_lib.impl&%0.union_prefer_right.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. prior_result@) (Poly%vstd!map.Map<nat./nat.>. update@)))) %%switch_label%%1))))))))) (and (not %%switch_label%%1) (=> (= tmp%3 (Poly%vstd!map.Map<nat./nat.>. tmp%2)) %%switch_label%%0)))))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
