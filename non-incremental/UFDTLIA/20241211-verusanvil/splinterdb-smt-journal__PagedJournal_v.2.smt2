...
(assert (not (or (and (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))) (or (and (=> (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!journal.PagedJournal_v.JournalRecord. tmp%2)) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))))) (or (and (=> (lib!journal.PagedJournal_v.impl&%0.wf.? tmp%1) (=> (= tmp%4 (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))) (and (=> %%location_label%%1 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!journal.PagedJournal_v.JournalRecord. tmp%4)) (=> (= tmp%3 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))))) (=> (= tmp%5 (lib!abstract_system.MsgHistory_v.impl&%0.can_concat.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. tmp%3))) (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))))) %%switch_label%%2))))) (=> (not (lib!journal.PagedJournal_v.impl&%0.wf.? tmp%1)) (=> (= tmp%5 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%6 tmp%5) %%switch_label%%1))))))) (=> (not (is-core!option.Option./Some_ (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!)))) (=> (= tmp%6 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%7 tmp%6) %%switch_label%%0)))) (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.wf.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. self!))))) (=> (= tmp%7 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
