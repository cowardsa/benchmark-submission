...
(assert (has_type element! TYPE%lib!spec.KeyType_t.Element.))
...
(assert (not (or (and (=> (and (and (lib!betree.PivotTable_v.impl&%0.wf.? self!) (is-lib!spec.KeyType_t.Element./Elem_ (%Poly%lib!spec.KeyType_t.Element. element!))) (and (<= 0 (%I i!)) (<= (%I i!) (lib!betree.PivotTable_v.impl&%0.len.? self!)))) (or (and (=> (= (%I i!) 0) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Element. tmp%2 (I 0))) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!))) (I 0))) (=> (= tmp%3 (lib!spec.KeyType_t.impl&%2.lt.? element! tmp%1)) %%switch_label%%6))))) (=> (not (= (%I i!) 0)) (=> (= tmp%3 true) %%switch_label%%6))) (and (not %%switch_label%%6) (=> (= tmp%4 tmp%3) %%switch_label%%5)))) (=> (not (and (and (lib!betree.PivotTable_v.impl&%0.wf.? self!) (is-lib!spec.KeyType_t.Element./Elem_ (%Poly%lib!spec.KeyType_t.Element. element!))) (and (<= 0 (%I i!)) (<= (%I i!) (lib!betree.PivotTable_v.impl&%0.len.? self!))))) (=> (= tmp%4 false) %%switch_label%%5))) (and (not %%switch_label%%5) (or (and (=> tmp%4 (or (and (=> (= (%I i!) (lib!betree.PivotTable_v.impl&%0.len.? self!)) (=> (= tmp%6 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (and (=> %%location_label%%1 (req%vstd!seq.Seq.last. $ TYPE%lib!spec.KeyType_t.Element. tmp%6)) (=> (= tmp%5 (vstd!seq.Seq.last.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!))))) (=> (= tmp%7 (lib!spec.KeyType_t.impl&%2.lt.? tmp%5 element!)) %%switch_label%%4))))) (=> (not (= (%I i!) (lib!betree.PivotTable_v.impl&%0.len.? self!))) (=> (= tmp%7 true) %%switch_label%%4))) (and (not %%switch_label%%4) (=> (= tmp%8 tmp%7) %%switch_label%%3)))) (=> (not tmp%4) (=> (= tmp%8 false) %%switch_label%%3))) (and (not %%switch_label%%3) (or (and (=> tmp%8 (or (and (=> (and (< 0 (%I i!)) (< (%I i!) (lib!betree.PivotTable_v.impl&%0.len.? self!))) (=> (= tmp%10 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (=> (= tmp%11 (I (Sub (%I i!) 1))) (and (=> %%location_label%%2 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Element. tmp%10 tmp%11)) (=> (= tmp%9 (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!))) (I (Sub (%I i!) 1)))) (or (and (=> (lib!spec.KeyType_t.impl&%2.lt.? tmp%9 element!) (=> (= tmp%13 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (and (=> %%location_label%%3 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Element. tmp%13 i!)) (=> (= tmp%12 (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!))) i!)) (=> (= tmp%14 (lib!spec.KeyType_t.impl&%2.lt.? element! tmp%12)) %%switch_label%%2))))) (=> (not (lib!spec.KeyType_t.impl&%2.lt.? tmp%9 element!)) (=> (= tmp%14 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%15 tmp%14) %%switch_label%%1)))))))) (=> (not (and (< 0 (%I i!)) (< (%I i!) (lib!betree.PivotTable_v.impl&%0.len.? self!)))) (=> (= tmp%15 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%16 tmp%15) %%switch_label%%0)))) (=> (not tmp%8) (=> (= tmp%16 false) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
