...
(set-info :comment ";; allocation_layer/LikesJournal_v.rs:105:5: 105:88 (#0)")
(declare-const %return! vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.)
...
(declare-const tmp%9 vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>.)
...
(assert (not (=> (lib!allocation_layer.LikesJournal_v.impl&%1.buildable.? self! root!) (or (and (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (= tmp%2 tmp%1) %%switch_label%%1)))) (=> (not (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!)) (=> (= tmp%2 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (and (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.the_rank_of. self! root!)) (=> (= tmp%3 (lib!journal.LinkedJournal_v.impl&%1.the_rank_of.? self! root!)) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. root!)) (=> (= tmp%10 (vstd!map.impl&%0.empty.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address.)) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. root!))) (and (=> %%location_label%%2 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. root!)) (=> (= tmp%4 (core!option.Option./Some/0 (%Poly%core!option.Option. root!))) (=> (= tmp%6 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) (and (=> %%location_label%%3 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. tmp%6 tmp%4)) (=> (= tmp%5 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) tmp%4)) (=> (= curr_msgs@ (lib!journal.LinkedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.LinkedJournal_v.JournalRecord. tmp%5))) (=> (= start_lsn@ (nClip (vstd!math.max.? (I (lib!journal.LinkedJournal_v.DiskView./DiskView/boundary_lsn (%Poly%lib!journal.LinkedJournal_v.DiskView. self!))) (I (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. curr_msgs@))))))) (and (=> %%location_label%%4 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. root!)) (=> (= tmp%7 (core!option.Option./Some/0 (%Poly%core!option.Option. root!))) (=> (= update@ (lib!allocation_layer.LikesJournal_v.singleton_index.? (I start_lsn@) (I (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. curr_msgs@)))) tmp%7)) (and (=> %%location_label%%5 (req%lib!journal.LinkedJournal_v.impl&%1.next. self! root!)) (=> (= tmp%8 (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!)) (and (=> %%location_label%%6 (req%lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index. self! (Poly%core!option.Option. tmp%8))) (=> (= tmp%9 (lib!allocation_layer.LikesJournal_v.impl&%1.build_lsn_addr_index.? self! (Poly%core!option.Option. tmp%8))) (=> (= tmp%10 (vstd!map_lib.impl&%0.union_prefer_right.? $ NAT $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. tmp%9) (Poly%vstd!map.Map<nat./lib!spec.AsyncDisk_t.Address.>. update@))) %%switch_label%%0))))))))))))))))) (not %%switch_label%%0))))))))))
(check-sat)
(exit)
