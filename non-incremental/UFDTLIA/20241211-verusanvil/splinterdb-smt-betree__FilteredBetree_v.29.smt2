...
(assert (not (or (and (=> (and (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)) (= (vstd!seq.Seq.len.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) 1)) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. tmp%2 (I 0))) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))) (I 0))) (=> (= tmp%3 (is-lib!betree.FilteredBetree_v.BetreeNode./Nil_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. tmp%1))) %%switch_label%%1))))) (=> (not (and (is-lib!betree.FilteredBetree_v.BetreeNode./Node_ (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)) (= (vstd!seq.Seq.len.? $ TYPE%lib!betree.FilteredBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.FilteredBetree_v.BetreeNode.>. (lib!betree.FilteredBetree_v.BetreeNode./Node/children (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) 1))) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> (and tmp%3 (= (lib!betree.BufferOffsets_v.impl&%0.len.? (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.FilteredBetree_v.BetreeNode./Node/flushed (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) 1)) (=> (= tmp%5 (Poly%vstd!seq.Seq<nat.>. (lib!betree.BufferOffsets_v.BufferOffsets./BufferOffsets/offsets (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.FilteredBetree_v.BetreeNode./Node/flushed (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!))))))) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ NAT tmp%5 (I 0))) (=> (= tmp%4 (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!betree.BufferOffsets_v.BufferOffsets./BufferOffsets/offsets (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.FilteredBetree_v.BetreeNode./Node/flushed (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))))) (I 0))) (=> (= tmp%6 (= (%I tmp%4) 0)) %%switch_label%%0))))) (=> (not (and tmp%3 (= (lib!betree.BufferOffsets_v.impl&%0.len.? (Poly%lib!betree.BufferOffsets_v.BufferOffsets. (lib!betree.FilteredBetree_v.BetreeNode./Node/flushed (%Poly%lib!betree.FilteredBetree_v.BetreeNode. self!)))) 1))) (=> (= tmp%6 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
