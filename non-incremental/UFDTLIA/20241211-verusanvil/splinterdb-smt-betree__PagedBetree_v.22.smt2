...
(declare-const %return! lib!betree.PagedBetree_v.Path.)
...
(assert (not (=> (< 0 (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!))))) (=> (lib!betree.PagedBetree_v.impl&%2.wf.? (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (=> (is-lib!betree.PagedBetree_v.BetreeNode./Node_ (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!))) (=> (= tmp%2 (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (=> (= tmp%3 (Poly%lib!spec.KeyType_t.Key. (lib!betree.PagedBetree_v.Path./Path/key (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (and (=> %%location_label%%0 (req%lib!betree.PagedBetree_v.impl&%2.child. tmp%2 tmp%3)) (=> (= tmp%1 (lib!betree.PagedBetree_v.impl&%2.child.? (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.PagedBetree_v.Path./Path/key (%Poly%lib!betree.PagedBetree_v.Path. self!))))) (=> (= tmp%5 (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))) (=> (= tmp%6 (I (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))))) (=> %%location_label%%1 (req%vstd!seq.Seq.subrange. $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) tmp%5 (I 1) tmp%6)))))))))))))
(check-sat)
(exit)
