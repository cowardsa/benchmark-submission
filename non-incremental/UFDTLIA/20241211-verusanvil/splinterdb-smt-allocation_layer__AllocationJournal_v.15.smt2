...
(set-info :comment ";; Function-Axioms lib::journal::LinkedJournal_v::TruncatedJournal::build_lsn_au_index")
(assert (fuel_bool_default fuel%lib!allocation_layer.AllocationJournal_v.impl&%2.build_lsn_au_index.))
(assert (=> (fuel_bool fuel%lib!allocation_layer.AllocationJournal_v.impl&%2.build_lsn_au_index.) (forall ((self! Poly) (first! Poly)) (! (= (lib!allocation_layer.AllocationJournal_v.impl&%2.build_lsn_au_index.? self! first!) (lib!allocation_layer.AllocationJournal_v.impl&%1.build_lsn_au_index_au_walk.? (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))) (Poly%core!option.Option. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/freshest_rec (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. self!))) first!)) :pattern ((lib!allocation_layer.AllocationJournal_v.impl&%2.build_lsn_au_index.? self! first!)) ))))
(set-info :comment ";; Function-Recommends lib::allocation_layer::AllocationJournal_v::au_addrs_past_pointer")
(set-info :comment ";; allocation_layer/AllocationJournal_v.rs:126:1: 126:78 (#0)")
(declare-const %return! vstd!set.Set<lib!spec.AsyncDisk_t.Address.>.)
(declare-const ptr! Poly)
(declare-const addr@ Poly)
(declare-const tmp%1 Poly)
(assert fuel_defaults)
(assert (has_type ptr! (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.)))
(declare-fun %%lambda%%7 (Poly) %%Function%%)
(assert (forall ((%%hole%%0 Poly) (addr$ Poly)) (! (= (%%apply%%0 (%%lambda%%7 %%hole%%0) addr$) (B (lib!disk.GenericDisk_v.impl&%0.after_page.? %%hole%%0 addr$))) :pattern ((%%apply%%0 (%%lambda%%7 %%hole%%0) addr$)))))
(declare-const %%switch_label%%0 Bool)
(assert (not (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. ptr!)) (=> (= tmp%1 (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.)) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. ptr!))) (=> (has_type addr@ TYPE%lib!spec.AsyncDisk_t.Address.) (=> (= tmp%1 (vstd!set.impl&%0.new.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ (TYPE%fun%1. $ TYPE%lib!spec.AsyncDisk_t.Address. $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%7 (core!option.Option./Some/0 (%Poly%core!option.Option. ptr!))))))) %%switch_label%%0)))) (not %%switch_label%%0))))
(check-sat)
(exit)
