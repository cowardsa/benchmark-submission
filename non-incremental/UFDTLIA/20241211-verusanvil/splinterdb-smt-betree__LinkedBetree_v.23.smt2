...
(assert (not (or (and (=> (lib!betree.LinkedBetree_v.impl&%0.wf.? self!) (=> (= tmp%2 (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/pivots (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%lib!betree.PivotTable_v.impl&%0.bounded_key. tmp%2 key!)) (=> (= tmp%1 (lib!betree.PivotTable_v.impl&%0.bounded_key.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/pivots (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!))) key!)) (=> (= tmp%3 tmp%1) %%switch_label%%0))))) (=> (not (lib!betree.LinkedBetree_v.impl&%0.wf.? self!)) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
