...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%4.wf.? self!) (=> (has_type addr@ TYPE%lib!spec.AsyncDisk_t.Address.) (or (and (=> (and (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking!) addr@) (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBranch_v.Node. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBranch_v.Node.>. (lib!betree.LinkedBranch_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBranch_v.DiskView. self!)))) addr@)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%4.node_children_respects_rank. self! ranking! addr@)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%4.node_children_respects_rank.? self! ranking! addr@)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (and (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking!) addr@) (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBranch_v.Node. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBranch_v.Node.>. (lib!betree.LinkedBranch_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBranch_v.DiskView. self!)))) addr@))) (=> (= tmp%2 true) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
