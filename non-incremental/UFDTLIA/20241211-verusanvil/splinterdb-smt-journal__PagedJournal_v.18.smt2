...
(assert (not (=> (lib!journal.PagedJournal_v.impl&%1.wf.? self!) (and (=> %%location_label%%0 (req%lib!journal.PagedJournal_v.impl&%1.seq_start. self!)) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%1.seq_start.? self!)) (or (and (=> (<= tmp%1 (%I lsn!)) (and (=> %%location_label%%1 (req%lib!journal.PagedJournal_v.impl&%1.seq_end. self!)) (=> (= tmp%2 (lib!journal.PagedJournal_v.impl&%1.seq_end.? self!)) (=> (= tmp%3 (<= (%I lsn!) tmp%2)) %%switch_label%%0)))) (=> (not (<= tmp%1 (%I lsn!))) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
