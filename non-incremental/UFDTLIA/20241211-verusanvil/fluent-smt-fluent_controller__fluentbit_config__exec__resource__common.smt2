...
(set-info :comment ";; MODULE 'module fluent_controller::fluentbit_config::exec::resource::common'")
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.impl&%0.spec_add. fuel%vstd!seq_lib.impl&%0.map_values. fuel%vstd!seq_lib.impl&%0.add_empty_left. fuel%vstd!seq_lib.impl&%0.add_empty_right. fuel%vstd!seq_lib.impl&%0.push_distributes_over_add. fuel%vstd!seq_lib.impl&%0.contains. fuel%vstd!seq_lib.impl&%0.to_set. fuel%vstd!seq_lib.check_argument_is_seq. fuel%vstd!set.impl&%0.choose. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%1.view. fuel%vstd!view.impl&%2.view. fuel%vstd!view.impl&%3.view. fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%5.view. fuel%vstd!view.impl&%11.view. fuel%fluent_controller!fluent_controller.fluentbit_config.model.resource.common.make_owner_references. fuel%fluent_controller!fluent_controller.fluentbit_config.trusted.spec_types.impl&%0.well_formed. fuel%fluent_controller!fluent_controller.fluentbit_config.trusted.spec_types.impl&%0.controller_owner_ref. fuel%fluent_controller!fluent_controller.fluentbit_config.trusted.spec_types.impl&%1.kind.))
...
(set-info :comment ";; Function-Specs fluent_controller::fluent_controller::fluentbit_config::trusted::exec_types::FluentBitConfig::controller_owner_ref")
(declare-fun ens%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.impl&%3.controller_owner_ref. (fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig. fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference.) Bool)
(assert (forall ((self! fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig.) (owner_reference! fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference.)) (! (= (ens%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.impl&%3.controller_owner_ref. self! owner_reference!) (= (fluent_controller!kubernetes_api_objects.exec.owner_reference.impl&%0.view.? (Poly%fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference. owner_reference!)) (fluent_controller!fluent_controller.fluentbit_config.trusted.spec_types.impl&%0.controller_owner_ref.? (vstd!view.View.view.? $ TYPE%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig. (Poly%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig. self!))))) :pattern ((ens%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.impl&%3.controller_owner_ref. self! owner_reference!)) )))
...
(assert (forall ((or$ Poly)) (! (= (%%apply%%0 %%lambda%%2 or$) (Poly%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (fluent_controller!kubernetes_api_objects.exec.owner_reference.impl&%0.view.? or$))) :pattern ((%%apply%%0 %%lambda%%2 or$)))))
...
(set-info :comment ";; Function-Def fluent_controller::fluent_controller::fluentbit_config::exec::resource::common::make_owner_references")
(set-info :comment ";; controller_examples/fluent_controller/fluentbit_config/exec/resource/common.rs:20:1: 20:94 (#0)")
(declare-const owner_references! alloc!vec.Vec<fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference./alloc!alloc.Global.>.)
(declare-const fbc! fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig.)
(declare-const tmp%1 Poly)
(declare-const tmp%2 fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference.)
(declare-const tmp%3 Bool)
(declare-const idx@ Poly)
(declare-const tmp%4 Bool)
(declare-const s1@ vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>.)
(declare-const s2@ vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>.)
(declare-const owner_references@0 alloc!vec.Vec<fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference./alloc!alloc.Global.>.)
(assert fuel_defaults)
(assert (fluent_controller!fluent_controller.fluentbit_config.trusted.spec_types.impl&%0.well_formed.? (vstd!view.View.view.? $ TYPE%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig. (Poly%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig. fbc!))))
(declare-const owner_references@1 alloc!vec.Vec<fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference./alloc!alloc.Global.>.)
...
(assert (=> %%query%% (not (=> (ens%alloc!vec.impl&%0.new. $ TYPE%fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference. tmp%1) (=> (= owner_references@0 (%Poly%alloc!vec.Vec<fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference./alloc!alloc.Global.>. tmp%1)) (=> (ens%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.impl&%3.controller_owner_ref. fbc! tmp%2) (=> (ens%alloc!vec.impl&%1.push. $ TYPE%fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference. $ TYPE%alloc!alloc.Global. (Poly%alloc!vec.Vec<fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference./alloc!alloc.Global.>. owner_references@0) (Poly%alloc!vec.Vec<fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference./alloc!alloc.Global.>. owner_references@1) (Poly%fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference. tmp%2)) (=> (= s1@ (%Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. (vstd!seq_lib.impl&%0.map_values.? $ TYPE%fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference. $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference. $ TYPE%alloc!alloc.Global.) (Poly%alloc!vec.Vec<fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference./alloc!alloc.Global.>. owner_references@1)) (Poly%fun%1. (mk_fun %%lambda%%2))))) (=> (= s2@ (%Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. (fluent_controller!fluent_controller.fluentbit_config.model.resource.common.make_owner_references.? (vstd!view.View.view.? $ TYPE%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig. (Poly%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig. fbc!)))))) (and (=> (= tmp%3 (= (vstd!seq.Seq.len.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s1@)) (vstd!seq.Seq.len.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s2@)))) (and (=> %%location_label%%0 tmp%3) (=> tmp%3 (and (=> (has_type idx@ INT) (=> (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s1@)))) (=> %%location_label%%1 (= (vstd!seq.Seq.index.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s1@) idx@) (vstd!seq.Seq.index.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s2@) idx@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s1@)))) (= (vstd!seq.Seq.index.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s1@) idx$) (vstd!seq.Seq.index.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s2@) idx$)))) :pattern ((vstd!seq.Seq.index.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s1@) idx$)) :pattern ((vstd!seq.Seq.index.? $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s2@) idx$)) )) (=> (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.) (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s1@) (Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. s2@))) (and (=> %%location_label%%2 tmp%4) (=> tmp%4 (=> %%location_label%%3 (= s1@ s2@)))))))))) (=> (= s1@ s2@) (=> (= owner_references! owner_references@1) (=> %%location_label%%4 (= (%Poly%vstd!seq.Seq<fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView.>. (vstd!seq_lib.impl&%0.map_values.? $ TYPE%fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference. $ TYPE%fluent_controller!kubernetes_api_objects.spec.owner_reference.OwnerReferenceView. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference. $ TYPE%alloc!alloc.Global.) (Poly%alloc!vec.Vec<fluent_controller!kubernetes_api_objects.exec.owner_reference.OwnerReference./alloc!alloc.Global.>. owner_references!)) (Poly%fun%1. (mk_fun %%lambda%%2)))) (fluent_controller!fluent_controller.fluentbit_config.model.resource.common.make_owner_references.? (vstd!view.View.view.? $ TYPE%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig. (Poly%fluent_controller!fluent_controller.fluentbit_config.trusted.exec_types.FluentBitConfig. fbc!)))))))))))))))))
(assert %%query%%)
(check-sat)
(exit)
