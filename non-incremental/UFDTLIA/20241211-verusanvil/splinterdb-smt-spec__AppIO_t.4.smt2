...
(set-info :comment ";; spec/AppIO_t.rs:174:1: 174:102 (#0)")
(set-info :comment ";; Function-Axioms lib::spec::AppIO_t::to_disk_reqs")
...
(set-info :comment ";; Function-Specs lib::spec::AppIO_t::TrustedAPI::send_disk_requests")
...
(set-info :comment ";; Function-Axioms lib::spec::ImplDisk_t::IDiskResponse::view")
...
(set-info :comment ";; Spec-Termination lib::spec::AppIO_t::to_disk_resps")
(set-info :comment ";; spec/AppIO_t.rs:187:1: 187:101 (#0)")
(set-info :comment ";; Function-Recommends lib::spec::AppIO_t::to_disk_resps")
(set-info :comment ";; spec/AppIO_t.rs:187:1: 187:101 (#0)")
(declare-const %return! vstd!map.Map<u64./lib!spec.AsyncDisk_t.DiskResponse.>.)
...
(assert (not (or (and (=> (> (vstd!seq.Seq.len.? $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps!) 0) (=> (= tmp%2 (I (vstd!seq.Seq.len.? $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps!))) (and (=> %%location_label%%0 (req%vstd!seq.Seq.subrange. $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps! (I 1) tmp%2)) (=> (= tmp%1 (vstd!seq.Seq.subrange.? $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps! (I 1) (I (vstd!seq.Seq.len.? $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps!)))) (=> (= sub_id_resps@ (%Poly%vstd!seq.Seq<tuple%2<u64./lib!spec.ImplDisk_t.IDiskResponse.>.>. tmp%1)) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps! (I 0))) (=> (= tmp%3 (vstd!seq.Seq.index.? $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps! (I 0))) (and (=> %%location_label%%2 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps! (I 0))) (=> (= tmp%4 (vstd!seq.Seq.index.? $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps! (I 0))) (=> (= tmp%5 (vstd!map.impl&%0.insert.? $ (UINT 64) $ TYPE%lib!spec.AsyncDisk_t.DiskResponse. (Poly%vstd!map.Map<u64./lib!spec.AsyncDisk_t.DiskResponse.>. (lib!spec.AppIO_t.to_disk_resps.? (Poly%vstd!seq.Seq<tuple%2<u64./lib!spec.ImplDisk_t.IDiskResponse.>.>. sub_id_resps@))) (tuple%2./tuple%2/0 (%Poly%tuple%2. tmp%3)) (Poly%lib!spec.AsyncDisk_t.DiskResponse. (lib!spec.ImplDisk_t.impl&%4.view.? (tuple%2./tuple%2/1 (%Poly%tuple%2. tmp%4)))))) %%switch_label%%0)))))))))) (=> (not (> (vstd!seq.Seq.len.? $ (TYPE%tuple%2. $ (UINT 64) $ TYPE%lib!spec.ImplDisk_t.IDiskResponse.) id_resps!) 0)) (=> (= tmp%5 (vstd!map.impl&%0.empty.? $ (UINT 64) $ TYPE%lib!spec.AsyncDisk_t.DiskResponse.)) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
