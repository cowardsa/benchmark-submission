...
(set-info :comment ";; Function-Axioms lib::betree::LinkedBranch_v::Refinement_v::inv_internal")
(assert (fuel_bool_default fuel%lib!betree.LinkedBranch_v.Refinement_v.inv_internal.))
(assert (=> (fuel_bool fuel%lib!betree.LinkedBranch_v.Refinement_v.inv_internal.) (forall ((branch! Poly) (ranking! Poly)) (! (= (lib!betree.LinkedBranch_v.Refinement_v.inv_internal.? branch! ranking!) (and (and (and (lib!betree.LinkedBranch_v.impl&%5.wf.? branch!) (lib!betree.LinkedBranch_v.impl&%5.valid_ranking.? branch! ranking!)) (lib!betree.LinkedBranch_v.impl&%5.keys_strictly_sorted_internal.? branch! ranking!)) (lib!betree.LinkedBranch_v.impl&%5.all_keys_in_range_internal.? branch! ranking!))) :pattern ((lib!betree.LinkedBranch_v.Refinement_v.inv_internal.? branch! ranking!)) ))))
(set-info :comment ";; Function-Recommends lib::betree::LinkedBranch_v::Refinement_v::inv")
(set-info :comment ";; betree/LinkedBranch_v/Refinement_v.rs:107:1: 107:60 (#0)")
...
(assert (not (or (and (=> (lib!betree.LinkedBranch_v.impl&%5.acyclic.? branch!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%5.the_ranking. branch!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%5.the_ranking.? branch!)) (=> (= tmp%2 (lib!betree.LinkedBranch_v.Refinement_v.inv_internal.? branch! (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. tmp%1))) %%switch_label%%0)))) (=> (not (lib!betree.LinkedBranch_v.impl&%5.acyclic.? branch!)) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
