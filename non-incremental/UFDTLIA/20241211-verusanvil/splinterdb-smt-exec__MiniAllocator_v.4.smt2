...
(assert (has_type self! TYPE%lib!exec.MiniAllocator_v.MiniAllocator.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (or (and (=> (is-core!option.Option./Some_ (lib!exec.MiniAllocator_v.MiniAllocator./MiniAllocator/allocs (%Poly%lib!exec.MiniAllocator_v.MiniAllocator. self!))) (=> (= tmp%2 (Poly%core!option.Option. (lib!exec.MiniAllocator_v.MiniAllocator./MiniAllocator/allocs (%Poly%lib!exec.MiniAllocator_v.MiniAllocator. self!)))) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!exec.MiniAllocator_v.PageAllocator. tmp%2)) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!exec.MiniAllocator_v.MiniAllocator./MiniAllocator/allocs (%Poly%lib!exec.MiniAllocator_v.MiniAllocator. self!)))))) (=> (= tmp%3 (lib!exec.MiniAllocator_v.impl&%1.wf.? tmp%1)) %%switch_label%%0))))) (=> (not (is-core!option.Option./Some_ (lib!exec.MiniAllocator_v.MiniAllocator./MiniAllocator/allocs (%Poly%lib!exec.MiniAllocator_v.MiniAllocator. self!)))) (=> (= tmp%3 true) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
