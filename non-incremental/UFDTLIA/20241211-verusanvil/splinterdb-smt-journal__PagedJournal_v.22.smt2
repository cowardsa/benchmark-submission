...
(declare-const prior_rec@ core!option.Option.)
(declare-const rec@ lib!journal.PagedJournal_v.JournalRecord.)
(declare-const tmp%6 core!option.Option.)
(assert fuel_defaults)
(assert (has_type ojr! (TYPE%core!option.Option. $ TYPE%lib!journal.PagedJournal_v.JournalRecord.)))
...
(assert (not (or (and (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. ojr!)) (and (=> %%location_label%%0 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!journal.PagedJournal_v.JournalRecord. ojr!)) (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. ojr!))) (=> (= tmp%2 (lib!journal.PagedJournal_v.impl&%0.valid.? tmp%1 lsn!)) %%switch_label%%2)))) (=> (not (is-core!option.Option./Some_ (%Poly%core!option.Option. ojr!))) (=> (= tmp%2 true) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. ojr!)) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. ojr!)) lsn!)) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. ojr!)) (=> (= tmp%6 core!option.Option./None) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. ojr!))) (=> (= rec@ (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. ojr!)))) (or (and (=> (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@)))))) (%I lsn!)) (=> (= tmp%5 core!option.Option./None) %%switch_label%%1)) (=> (not (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@)))))) (%I lsn!))) (=> (= tmp%4 (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@))))) (and (=> %%location_label%%1 (req%lib!journal.PagedJournal_v.impl&%0.discard_old_journal_rec. tmp%4 lsn!)) (=> (= tmp%3 (lib!journal.PagedJournal_v.impl&%0.discard_old_journal_rec.? (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@)))) lsn!)) (=> (= tmp%5 tmp%3) %%switch_label%%1)))))) (and (not %%switch_label%%1) (=> (= prior_rec@ tmp%5) (=> (= tmp%6 (core!option.Option./Some (Poly%lib!journal.PagedJournal_v.JournalRecord. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@))))) (%Poly%core!option.Option. (Poly%core!option.Option. prior_rec@)))))) %%switch_label%%0))))))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
