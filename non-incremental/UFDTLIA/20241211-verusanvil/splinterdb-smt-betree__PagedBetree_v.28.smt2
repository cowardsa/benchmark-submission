...
(declare-const tmp%1 lib!betree.PagedBetree_v.ChildMap.)
...
(assert (has_type replacement! TYPE%lib!betree.PagedBetree_v.BetreeNode.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!))))) (=> (= decrease%init1 1) (or (and (=> (= (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))) 0) (=> (= tmp%2 replacement!) %%switch_label%%0)) (=> (not (= (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. self!)))) 0)) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.PagedBetree_v.Path. self!)) (replacement!$1 (%Poly%lib!betree.PagedBetree_v.BetreeNode. replacement!))) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ TYPE%lib!spec.KeyType_t.Key.) (Poly%vstd!seq.Seq<vstd!set.Set<lib!spec.KeyType_t.Key.>.>. (lib!betree.PagedBetree_v.Path./Path/routing (%Poly%lib!betree.PagedBetree_v.Path. (Poly%lib!betree.PagedBetree_v.Path. (lib!betree.PagedBetree_v.impl&%5.subpath.? (Poly%lib!betree.PagedBetree_v.Path. self!$0)))))))) decrease%init0 false)) (=> (= tmp%1 (lib!betree.PagedBetree_v.impl&%5.replaced_children.? self! replacement!)) (=> (= tmp%2 (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.BetreeNode./Node (%Poly%lib!betree.Buffer_v.SimpleBuffer. (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.PagedBetree_v.BetreeNode./Node/buffer (%Poly%lib!betree.PagedBetree_v.BetreeNode. (Poly%lib!betree.PagedBetree_v.BetreeNode. (lib!betree.PagedBetree_v.Path./Path/node (%Poly%lib!betree.PagedBetree_v.Path. self!))))))) (%Poly%lib!betree.PagedBetree_v.ChildMap. (Poly%lib!betree.PagedBetree_v.ChildMap. tmp%1))))) %%switch_label%%0))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
