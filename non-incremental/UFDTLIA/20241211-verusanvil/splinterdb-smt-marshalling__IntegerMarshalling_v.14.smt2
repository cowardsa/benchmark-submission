...
(assert (not (and (=> (has_type x@ (UINT 8)) (=> %%location_label%%0 (and (= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x@)) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 8)))) (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x@)) x@)))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ (UINT 8)) (and (= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x$)) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 8)))) (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x$)) x$))) :pattern ((lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x$)) )) (and (=> (has_type s@ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (= (vstd!seq.Seq.len.? $ (UINT 8) s@) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 8)))) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.push.? $ (UINT 8) (vstd!seq.Seq.empty.? $ (UINT 8)) (vstd!seq.Seq.index.? $ (UINT 8) s@ (I 0))) s@)) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 8) s@)) s@))))))) (=> (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (= (vstd!seq.Seq.len.? $ (UINT 8) s$) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 8)))) (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 8) s$)) s$))) :pattern ((lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 8) s$))) )) (and (=> %%location_label%%3 (forall ((x$$0 Poly)) (! (=> (has_type x$$0 (UINT 8)) (and (= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x$$0)) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 8)))) (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x$$0)) x$$0))) :pattern ((lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x$$0)) ))) (=> %%location_label%%4 (forall ((s$$0 Poly)) (! (=> (has_type s$$0 (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (= (vstd!seq.Seq.len.? $ (UINT 8) s$$0) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 8)))) (= (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 8) s$$0)) s$$0))) :pattern ((lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 8) s$$0))) ))))))))))
(check-sat)
(exit)
