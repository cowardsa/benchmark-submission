...
(declare-const decrease%init0 lib!betree.PagedBetree_v.ChildMap.)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.PagedBetree_v.ChildMap.))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (%Poly%lib!betree.PagedBetree_v.ChildMap. self!)) (or (and (=> (lib!betree.Buffer_v.total_keys.? (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!betree.PagedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!betree.PagedBetree_v.BetreeNode.>. (lib!betree.PagedBetree_v.ChildMap./ChildMap/map (%Poly%lib!betree.PagedBetree_v.ChildMap. self!))))) (=> (has_type k@ TYPE%lib!spec.KeyType_t.Key.) (=> (= tmp%2 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!betree.PagedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!betree.PagedBetree_v.BetreeNode.>. (lib!betree.PagedBetree_v.ChildMap./ChildMap/map (%Poly%lib!betree.PagedBetree_v.ChildMap. self!))) k@)) (and (=> %%location_label%%0 (check_decrease_height (Poly%lib!betree.PagedBetree_v.BetreeNode. (let ((self!$0 (%Poly%lib!betree.PagedBetree_v.BetreeNode. tmp%2))) self!$0)) (Poly%lib!betree.PagedBetree_v.ChildMap. decrease%init0) false)) (=> (= tmp%1 (lib!betree.PagedBetree_v.impl&%2.wf.? (vstd!map.impl&%0.index.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!betree.PagedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!betree.PagedBetree_v.BetreeNode.>. (lib!betree.PagedBetree_v.ChildMap./ChildMap/map (%Poly%lib!betree.PagedBetree_v.ChildMap. self!))) k@))) (=> (= tmp%3 (forall ((k$ Poly)) (! (=> (has_type k$ TYPE%lib!spec.KeyType_t.Key.) (lib!betree.PagedBetree_v.impl&%2.wf.? (vstd!map.impl&%0.index.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!betree.PagedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!betree.PagedBetree_v.BetreeNode.>. (lib!betree.PagedBetree_v.ChildMap./ChildMap/map (%Poly%lib!betree.PagedBetree_v.ChildMap. self!))) k$))) :pattern ((vstd!map.impl&%0.index.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!betree.PagedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!betree.PagedBetree_v.BetreeNode.>. (lib!betree.PagedBetree_v.ChildMap./ChildMap/map (%Poly%lib!betree.PagedBetree_v.ChildMap. self!))) k$)) ))) %%switch_label%%0)))))) (=> (not (lib!betree.Buffer_v.total_keys.? (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!betree.PagedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!betree.PagedBetree_v.BetreeNode.>. (lib!betree.PagedBetree_v.ChildMap./ChildMap/map (%Poly%lib!betree.PagedBetree_v.ChildMap. self!)))))) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
