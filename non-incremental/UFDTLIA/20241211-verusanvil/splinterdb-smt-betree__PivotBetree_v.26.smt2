...
(assert (not (or (and (=> (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)) (=> (has_type i@ NAT) (or (and (=> (lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! i@) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.PivotBetree_v.BetreeNode. tmp%2 i@)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) i@)) (=> (= tmp%3 (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. tmp%1))) %%switch_label%%1))))) (=> (not (lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! i@)) (=> (= tmp%3 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! i$) (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBetree_v.BetreeNode. (Poly%vstd!seq.Seq<lib!betree.PivotBetree_v.BetreeNode.>. (lib!betree.PivotBetree_v.BetreeNode./Node/children (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) i$))))) :pattern ((lib!betree.PivotBetree_v.impl&%1.valid_child_index.? self! i$)) ))) %%switch_label%%0))))) (=> (not (is-lib!betree.PivotBetree_v.BetreeNode./Node_ (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (=> (= tmp%4 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
