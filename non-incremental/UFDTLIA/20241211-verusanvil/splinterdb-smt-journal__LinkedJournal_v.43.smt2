...
(assert (not (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.valid_ranking.? (Poly%lib!journal.LinkedJournal_v.DiskView. (lib!journal.LinkedJournal_v.TruncatedJournal./TruncatedJournal/disk_view (%Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!journal.LinkedJournal_v.impl&%2.mkfs.? (I 0)))))) (vstd!map.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (lib!journal.LinkedJournal_v.impl&%2.decodable.? (Poly%lib!journal.LinkedJournal_v.TruncatedJournal. (lib!journal.LinkedJournal_v.impl&%2.mkfs.? (I 0))))))))))
(check-sat)
(exit)
