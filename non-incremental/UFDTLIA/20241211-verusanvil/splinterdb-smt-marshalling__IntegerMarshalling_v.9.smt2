...
(assert (not (=> (ens%lib!marshalling.StaticallySized_v.StaticallySized.exec_uniform_size. T&. T& tmp%1) (=> (= sz! tmp%1) (and (=> %%location_label%%0 (= sz! (lib!marshalling.UniformSized_v.UniformSized.uniform_size.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self!))) (=> %%location_label%%1 (= sz! (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? T&. T&))))))))
(check-sat)
(exit)
