...
(assert (forall ((%%hole%%0 Poly) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (key$ Poly)) (! (= (%%apply%%0 (%%lambda%%12 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) key$) (vstd!seq.Seq.index.? %%hole%%1 %%hole%%2 %%hole%%3 (I (lib!betree.PivotBranch_v.impl&%3.route.? %%hole%%0 key$)))) :pattern ((%%apply%%0 (%%lambda%%12 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) key$)))))
(declare-fun %%lambda%%13 (Poly Int Dcr Type Poly Dcr Type Dcr Type Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Poly) (%%hole%%1 Int) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Poly) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Dcr) (%%hole%%10 Type) (key$ Poly)) (! (= (%%apply%%0 (%%lambda%%13 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10) key$) (B (vstd!set.impl&%0.contains.? %%hole%%9 %%hole%%10 (vstd!map.impl&%0.dom.? %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!spec.Messages_t.Message.>. (lib!betree.Buffer_v.SimpleBuffer./SimpleBuffer/map (%Poly%lib!betree.Buffer_v.SimpleBuffer. (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.PivotBranchRefinement_v.impl&%0.i.? (vstd!seq.Seq.index.? %%hole%%2 %%hole%%3 %%hole%%4 (I (Add (lib!betree.PivotBranch_v.impl&%3.route.? %%hole%%0 key$) %%hole%%1))))))))) key$))) :pattern ((%%apply%%0 (%%lambda%%13 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10) key$)))))
(declare-fun %%lambda%%14 (Poly Int Dcr Type Poly Dcr Type Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Poly) (%%hole%%1 Int) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Poly) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Dcr) (%%hole%%8 Type) (key$ Poly)) (! (= (%%apply%%0 (%%lambda%%14 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) key$) (vstd!map.impl&%0.index.? %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!spec.Messages_t.Message.>. (lib!betree.Buffer_v.SimpleBuffer./SimpleBuffer/map (%Poly%lib!betree.Buffer_v.SimpleBuffer. (Poly%lib!betree.Buffer_v.SimpleBuffer. (lib!betree.PivotBranchRefinement_v.impl&%0.i.? (vstd!seq.Seq.index.? %%hole%%2 %%hole%%3 %%hole%%4 (I (Add (lib!betree.PivotBranch_v.impl&%3.route.? %%hole%%0 key$) %%hole%%1)))))))) key$)) :pattern ((%%apply%%0 (%%lambda%%14 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) key$)))))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!betree.PivotBranch_v.impl&%3.wf.? self!) (or (and (=> (is-lib!betree.PivotBranch_v.Node./Index_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (has_type key@ TYPE%lib!spec.KeyType_t.Key.) (and (=> %%location_label%%0 (req%lib!betree.PivotBranch_v.impl&%3.route. self! key@)) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%3.route.? self! key@)) (=> (= tmp%%@ (Add tmp%1 1)) (=> (= tmp%2 (forall ((key$ Poly)) (! (=> (has_type key$ TYPE%lib!spec.KeyType_t.Key.) (let ((tmp%%$ (Add (lib!betree.PivotBranch_v.impl&%3.route.? self! key$) 1))) (and (<= 0 tmp%%$) (< tmp%%$ (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!)))))))) :pattern ((lib!betree.PivotBranch_v.impl&%3.route.? self! key$)) ))) %%switch_label%%1)))))) (=> (not (is-lib!betree.PivotBranch_v.Node./Index_ (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= tmp%2 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (=> (is-lib!betree.PivotBranch_v.Node./Index_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (forall ((key$ Poly)) (! (=> (has_type key$ TYPE%lib!spec.KeyType_t.Key.) (let ((tmp%%$ (Add (lib!betree.PivotBranch_v.impl&%3.route.? self! key$) 1))) (and (<= 0 tmp%%$) (< tmp%%$ (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!)))))))) :pattern ((lib!betree.PivotBranch_v.impl&%3.route.? self! key$)) ))) (or (and (=> (is-lib!betree.PivotBranch_v.Node./Leaf_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (= keys@ (lib!betree.PivotBranch_v.Node./Leaf/keys (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= msgs@ (lib!betree.PivotBranch_v.Node./Leaf/msgs (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (has_type key$1@ TYPE%lib!spec.KeyType_t.Key.) (=> (has_type key$2@ TYPE%lib!spec.KeyType_t.Key.) (=> (= tmp%3 (lib!betree.Buffer_v.SimpleBuffer./SimpleBuffer (%Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!spec.Messages_t.Message.>. (vstd!map.impl&%0.new.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!spec.Messages_t.Message. $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ BOOL) $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!spec.Messages_t.Message.) (Poly%fun%1. (mk_fun (%%lambda%%0 $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys@)))) (Poly%fun%1. (mk_fun (%%lambda%%12 self! $ TYPE%lib!spec.Messages_t.Message. (Poly%vstd!seq.Seq<lib!spec.Messages_t.Message.>. msgs@)))))))) %%switch_label%%0)))))) (=> (not (is-lib!betree.PivotBranch_v.Node./Leaf_ (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= pivots@ (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= children@ (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (has_type key$3@ TYPE%lib!spec.KeyType_t.Key.) (=> (has_type key$4@ TYPE%lib!spec.KeyType_t.Key.) (=> (= tmp%3 (lib!betree.Buffer_v.SimpleBuffer./SimpleBuffer (%Poly%vstd!map.Map<lib!spec.KeyType_t.Key./lib!spec.Messages_t.Message.>. (vstd!map.impl&%0.new.? $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!spec.Messages_t.Message. $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ BOOL) $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!spec.Messages_t.Message.) (Poly%fun%1. (mk_fun (%%lambda%%13 self! 1 $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!spec.Messages_t.Message. $ TYPE%lib!spec.KeyType_t.Key.))) (Poly%fun%1. (mk_fun (%%lambda%%14 self! 1 $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) $ TYPE%lib!spec.KeyType_t.Key. $ TYPE%lib!spec.Messages_t.Message.))))))) %%switch_label%%0))))))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
