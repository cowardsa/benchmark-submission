...
(declare-const r1! vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>.)
(declare-const r2! vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>.)
...
(assert (lib!betree.LinkedBetree_v.impl&%5.valid_ranking.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r1!)))
(assert (lib!betree.LinkedBetree_v.impl&%5.valid_ranking.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r2!)))
...
(assert (not (=> (= decrease%init0 (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r1!))) (or (and (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 self!) (r1!$1 r1!) (r2!$2 r2!) (start!$3 0)) (lib!betree.LinkedBetree_v.impl&%5.get_rank.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!$0) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r1!$1))) decrease%init0 true)) (and (=> %%location_label%%1 (req%lib!allocation_layer.LikesBetree_v.impl&%1.children_likes_ignore_ranking. T&. T& self! r1! r2! 0)) (=> (ens%lib!allocation_layer.LikesBetree_v.impl&%1.children_likes_ignore_ranking. T&. T& self! r1! r2! 0) %%switch_label%%0)))) (=> (not (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (ext_eq false (TYPE%vstd!multiset.Multiset. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesBetree_v.impl&%1.tree_likes.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r1!))) (Poly%vstd!multiset.Multiset<lib!spec.AsyncDisk_t.Address.>. (lib!allocation_layer.LikesBetree_v.impl&%1.tree_likes.? T&. T& (Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!) (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./nat.>. r2!))))))))))
(check-sat)
(exit)
