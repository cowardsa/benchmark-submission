...
(declare-const tmp%1 lib!betree.FilteredBetree_v.Path.)
...
(assert (not (or (and (=> (and (and (lib!betree.FilteredBetree_v.impl&%1.wf.? (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!)))) (lib!betree.FilteredBetree_v.impl&%1.key_in_domain.? (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.FilteredBetree_v.Path./Path/key (%Poly%lib!betree.FilteredBetree_v.Path. self!))))) (=> (< 0 (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. self!))) (lib!betree.FilteredBetree_v.impl&%1.is_index.? (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!)))))) (or (and (=> (< 0 (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. self!))) (and (=> %%location_label%%0 (req%lib!betree.FilteredBetree_v.impl&%4.subpath. self!)) (=> (= tmp%1 (lib!betree.FilteredBetree_v.impl&%4.subpath.? self!)) (=> (= tmp%2 (lib!betree.FilteredBetree_v.impl&%4.valid.? (Poly%lib!betree.FilteredBetree_v.Path. tmp%1))) %%switch_label%%1)))) (=> (not (< 0 (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. self!)))) (=> (= tmp%2 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%3 tmp%2) %%switch_label%%0)))) (=> (not (and (and (lib!betree.FilteredBetree_v.impl&%1.wf.? (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!)))) (lib!betree.FilteredBetree_v.impl&%1.key_in_domain.? (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!))) (Poly%lib!spec.KeyType_t.Key. (lib!betree.FilteredBetree_v.Path./Path/key (%Poly%lib!betree.FilteredBetree_v.Path. self!))))) (=> (< 0 (lib!betree.FilteredBetree_v.Path./Path/depth (%Poly%lib!betree.FilteredBetree_v.Path. self!))) (lib!betree.FilteredBetree_v.impl&%1.is_index.? (Poly%lib!betree.FilteredBetree_v.BetreeNode. (lib!betree.FilteredBetree_v.Path./Path/node (%Poly%lib!betree.FilteredBetree_v.Path. self!))))))) (=> (= tmp%3 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
