...
(assert (not (=> (= decrease%init0 (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!)))) (or (and (=> (> (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!))) 0) (=> (= tmp%1 (lib!betree.PivotBranch_v.impl&%4.subpath.? (Poly%lib!betree.PivotBranch_v.Path. path!))) (and (=> %%location_label%%0 (check_decrease_int (let ((path!$0 tmp%1)) (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!$0)))) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!betree.PivotBranchRefinement_v.lemma_path_target_is_wf. tmp%1)) (=> (ens%lib!betree.PivotBranchRefinement_v.lemma_path_target_is_wf. tmp%1) %%switch_label%%0))))) (=> (not (> (lib!betree.PivotBranch_v.Path./Path/depth (%Poly%lib!betree.PivotBranch_v.Path. (Poly%lib!betree.PivotBranch_v.Path. path!))) 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (lib!betree.PivotBranch_v.impl&%3.wf.? (Poly%lib!betree.PivotBranch_v.Node. (lib!betree.PivotBranch_v.impl&%4.target.? (Poly%lib!betree.PivotBranch_v.Path. path!))))))))))
(check-sat)
(exit)
