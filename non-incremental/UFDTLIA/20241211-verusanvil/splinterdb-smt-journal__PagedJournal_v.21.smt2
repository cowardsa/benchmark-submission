...
(assert (not (=> (= decrease%init0 (%Poly%core!option.Option. ojr!)) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. ojr!)) (=> (= tmp%4 core!option.Option./None) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. ojr!))) (=> (= rec@ (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. ojr!)))) (or (and (=> (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@)))))) (%I lsn!)) (=> (= tmp%3 core!option.Option./None) %%switch_label%%1)) (=> (not (<= (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_start (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@)))))) (%I lsn!))) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@))))) (and (=> %%location_label%%0 (check_decrease_height (Poly%core!option.Option. (let ((ojr!$0 (%Poly%core!option.Option. tmp%2)) (lsn!$1 (%I lsn!))) ojr!$0)) (Poly%core!option.Option. decrease%init0) false)) (=> (has_type (Poly%core!option.Option. tmp%1) (TYPE%core!option.Option. $ TYPE%lib!journal.PagedJournal_v.JournalRecord.)) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%0.discard_old_journal_rec.? (Poly%core!option.Option. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/prior_rec (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@)))) lsn!)) (=> (= tmp%3 tmp%1) %%switch_label%%1))))))) (and (not %%switch_label%%1) (=> (= prior_rec@ tmp%3) (=> (= tmp%4 (core!option.Option./Some (Poly%lib!journal.PagedJournal_v.JournalRecord. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@))))) (%Poly%core!option.Option. (Poly%core!option.Option. prior_rec@)))))) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
