...
(set-info :comment ";; MODULE 'module abstract_system::StampedMap_v'")
...
(declare-const fuel%lib!abstract_system.StampedMap_v.impl&%0.plus_history. FuelId)
...
(assert (distinct fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_insert_domain. fuel%vstd!map.axiom_map_insert_same. fuel%vstd!map.axiom_map_insert_different. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_mk_map_domain. fuel%vstd!set.axiom_mk_map_index. fuel%vstd!set.axiom_set_insert_finite. fuel%lib!abstract_system.MsgHistory_v.impl&%0.wf. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains. fuel%lib!abstract_system.MsgHistory_v.impl&%0.contains_exactly. fuel%lib!abstract_system.MsgHistory_v.impl&%0.is_empty. fuel%lib!abstract_system.MsgHistory_v.impl&%0.len. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_follow. fuel%lib!abstract_system.MsgHistory_v.impl&%0.can_discard_to. fuel%lib!abstract_system.MsgHistory_v.impl&%0.discard_recent. fuel%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map. fuel%lib!abstract_system.StampedMap_v.empty. fuel%lib!abstract_system.StampedMap_v.impl&%0.ext_equal. fuel%lib!abstract_system.StampedMap_v.impl&%0.plus_history. fuel%lib!spec.Messages_t.default_value. fuel%lib!spec.Messages_t.nop_delta. fuel%lib!spec.Messages_t.impl&%1.combine_deltas. fuel%lib!spec.Messages_t.impl&%1.apply_delta. fuel%lib!spec.Messages_t.impl&%1.merge. fuel%lib!spec.Messages_t.impl&%1.empty. fuel%lib!spec.TotalKMMap_t.total_domain. fuel%lib!spec.TotalKMMap_t.impl&%0.empty. fuel%lib!spec.TotalKMMap_t.impl&%0.spec_index. fuel%lib!spec.TotalKMMap_t.impl&%0.insert. fuel%lib!spec.TotalKMMap_t.impl&%0.dom. fuel%lib!spec.TotalKMMap_t.impl&%0.wf. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(set-info :comment ";; Function-Decl lib::spec::TotalKMMap_t::TotalKMMap::empty")
...
(set-info :comment ";; Function-Decl lib::abstract_system::StampedMap_v::empty")
(declare-fun lib!abstract_system.StampedMap_v.empty.? (Poly) lib!abstract_system.StampedMap_v.Stamped.)
(set-info :comment ";; Function-Decl lib::abstract_system::StampedMap_v::StampedMap::ext_equal")
(declare-fun lib!abstract_system.StampedMap_v.impl&%0.ext_equal.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl lib::abstract_system::StampedMap_v::StampedMap::plus_history")
(declare-fun lib!abstract_system.StampedMap_v.impl&%0.plus_history.? (Poly Poly) lib!abstract_system.StampedMap_v.Stamped.)
...
(assert (forall ((%%hole%%0 Poly) (k$ Poly)) (! (= (%%apply%%0 (%%lambda%%0 %%hole%%0) k$) %%hole%%0) :pattern ((%%apply%%0 (%%lambda%%0 %%hole%%0) k$)))))
(assert (=> (fuel_bool fuel%lib!spec.TotalKMMap_t.total_domain.) (forall ((no%param Poly)) (! (= (lib!spec.TotalKMMap_t.total_domain.? no%param) (%Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (vstd!set.impl&%0.new.? $ TYPE%lib!spec.KeyType_t.Key. $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 (B true))))))) :pattern ((lib!spec.TotalKMMap_t.total_domain.? no%param)) ))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.len. self!) (=> %%global_location_label%%4 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.len. self!)) )))
...
(assert (forall ((self! Poly) (orig! Poly)) (! (= (req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map. self! orig!) (and (=> %%global_location_label%%5 (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? self! (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))))) (=> %%global_location_label%%6 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? self!)))) :pattern ((req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map. self! orig!)) )))
...
(set-info :comment ";; Function-Recommends lib::abstract_system::StampedMap_v::empty")
(set-info :comment ";; abstract_system/StampedMap_v.rs:26:1: 26:48 (#0)")
(set-info :comment ";; Function-Axioms lib::abstract_system::StampedMap_v::empty")
...
(set-info :comment ";; Function-Recommends lib::abstract_system::StampedMap_v::StampedMap::ext_equal")
(set-info :comment ";; abstract_system/StampedMap_v.rs:31:3: 31:71 (#0)")
(set-info :comment ";; Function-Axioms lib::abstract_system::StampedMap_v::StampedMap::ext_equal")
...
(set-info :comment ";; Function-Specs lib::abstract_system::StampedMap_v::StampedMap::plus_history")
(declare-fun req%lib!abstract_system.StampedMap_v.impl&%0.plus_history. (Poly Poly) Bool)
(declare-const %%global_location_label%%7 Bool)
(declare-const %%global_location_label%%8 Bool)
(declare-const %%global_location_label%%9 Bool)
(assert (forall ((self! Poly) (history! Poly)) (! (= (req%lib!abstract_system.StampedMap_v.impl&%0.plus_history. self! history!) (and (=> %%global_location_label%%7 (lib!spec.TotalKMMap_t.impl&%0.wf.? (lib!abstract_system.StampedMap_v.Stamped./Stamped/value (%Poly%lib!abstract_system.StampedMap_v.Stamped. self!)))) (=> %%global_location_label%%8 (lib!abstract_system.MsgHistory_v.impl&%0.wf.? history!)) (=> %%global_location_label%%9 (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? history! (I (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. self!))))))) :pattern ((req%lib!abstract_system.StampedMap_v.impl&%0.plus_history. self! history!)) )))
(set-info :comment ";; Function-Recommends lib::abstract_system::StampedMap_v::StampedMap::plus_history")
(set-info :comment ";; abstract_system/StampedMap_v.rs:38:3: 38:82 (#0)")
(set-info :comment ";; Function-Axioms lib::abstract_system::StampedMap_v::StampedMap::plus_history")
(assert (fuel_bool_default fuel%lib!abstract_system.StampedMap_v.impl&%0.plus_history.))
(assert (=> (fuel_bool fuel%lib!abstract_system.StampedMap_v.impl&%0.plus_history.) (forall ((self! Poly) (history! Poly)) (! (= (lib!abstract_system.StampedMap_v.impl&%0.plus_history.? self! history!) (lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map.? history! self!)) :pattern ((lib!abstract_system.StampedMap_v.impl&%0.plus_history.? self! history!)) ))))
(assert (forall ((self! Poly) (history! Poly)) (! (=> (and (has_type self! (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.)) (has_type history! TYPE%lib!abstract_system.MsgHistory_v.MsgHistory.)) (has_type (Poly%lib!abstract_system.StampedMap_v.Stamped. (lib!abstract_system.StampedMap_v.impl&%0.plus_history.? self! history!)) (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.))) :pattern ((lib!abstract_system.StampedMap_v.impl&%0.plus_history.? self! history!)) )))
(set-info :comment ";; Function-Specs lib::abstract_system::StampedMap_v::StampedMap::ext_equal_is_equality")
(declare-fun ens%lib!abstract_system.StampedMap_v.impl&%0.ext_equal_is_equality. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!abstract_system.StampedMap_v.impl&%0.ext_equal_is_equality. no%param) (forall ((a$ Poly) (b$ Poly)) (! (=> (and (has_type a$ (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.)) (has_type b$ (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.))) (= (lib!abstract_system.StampedMap_v.impl&%0.ext_equal.? a$ b$) (= a$ b$))) :pattern ((lib!abstract_system.StampedMap_v.impl&%0.ext_equal.? a$ b$)) ))) :pattern ((ens%lib!abstract_system.StampedMap_v.impl&%0.ext_equal_is_equality. no%param)) )))
(set-info :comment ";; Function-Def lib::abstract_system::StampedMap_v::StampedMap::ext_equal_is_equality")
(set-info :comment ";; abstract_system/StampedMap_v.rs:48:3: 48:39 (#0)")
(declare-const no%param Int)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (forall ((a$ Poly) (b$ Poly)) (! (=> (and (has_type a$ (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.)) (has_type b$ (TYPE%lib!abstract_system.StampedMap_v.Stamped. $ TYPE%lib!spec.TotalKMMap_t.TotalKMMap.))) (= (lib!abstract_system.StampedMap_v.impl&%0.ext_equal.? a$ b$) (= a$ b$))) :pattern ((lib!abstract_system.StampedMap_v.impl&%0.ext_equal.? a$ b$)) )))))
(check-sat)
(exit)
