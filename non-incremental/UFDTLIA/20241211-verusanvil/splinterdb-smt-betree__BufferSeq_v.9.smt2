...
(declare-const s@ vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>.)
...
(assert (not (=> (and (and (<= 0 (%I start!)) (< (%I start!) (%I end!))) (<= (%I end!) (lib!betree.BufferSeq_v.impl&%0.len.? self!))) (=> (= s@ (%Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (vstd!seq.Seq.push.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (vstd!seq.Seq.empty.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer.) new_buffer!))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.Seq.subrange. $ TYPE%lib!betree.Buffer_v.SimpleBuffer. tmp%2 (I 0) start!)) (=> (= tmp%1 (vstd!seq.Seq.subrange.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. self!))) (I 0) start!)) (=> (= tmp%4 (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. self!)))) (=> (= tmp%5 (I (lib!betree.BufferSeq_v.impl&%0.len.? self!))) (=> %%location_label%%1 (req%vstd!seq.Seq.subrange. $ TYPE%lib!betree.Buffer_v.SimpleBuffer. tmp%4 end! tmp%5)))))))))))
(check-sat)
(exit)
