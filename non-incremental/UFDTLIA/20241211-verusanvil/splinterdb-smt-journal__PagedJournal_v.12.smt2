...
(assert (not (=> (= decrease%init0 (%I depth!)) (=> (= decrease%init1 1) (or (and (=> (is-core!option.Option./None_ (%Poly%core!option.Option. ojr!)) (=> (= tmp%2 core!option.Option./None) %%switch_label%%0)) (=> (not (is-core!option.Option./None_ (%Poly%core!option.Option. ojr!))) (=> (= rec@ (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. ojr!)))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 rec@) (boundary_lsn!$1 (%I boundary_lsn!)) (depth!$2 (%I depth!))) depth!$2) decrease%init0 (check_decrease_int (let ((self!$0 rec@) (boundary_lsn!$1 (%I boundary_lsn!)) (depth!$2 (%I depth!))) 0) decrease%init1 false))) (=> (has_type (Poly%core!option.Option. tmp%1) (TYPE%core!option.Option. $ TYPE%lib!journal.PagedJournal_v.JournalRecord.)) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%0.crop_head_records.? (Poly%lib!journal.PagedJournal_v.JournalRecord. rec@) boundary_lsn! depth!)) (=> (= tmp%2 tmp%1) %%switch_label%%0))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
