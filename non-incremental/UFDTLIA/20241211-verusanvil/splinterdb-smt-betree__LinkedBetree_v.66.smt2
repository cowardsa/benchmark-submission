...
(assert (not (or (and (=> (and (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) (or (and (=> (< (%I start!) (%I end!)) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%5.root.? T&. T& self!)) (=> (= tmp%2 (<= (%I end!) (lib!betree.LinkedSeq_v.impl&%0.len.? (Poly%lib!betree.LinkedSeq_v.LinkedSeq. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/buffers (%Poly%lib!betree.LinkedBetree_v.BetreeNode. (Poly%lib!betree.LinkedBetree_v.BetreeNode. tmp%1))))))) %%switch_label%%3)))) (=> (not (< (%I start!) (%I end!))) (=> (= tmp%2 false) %%switch_label%%3))) (and (not %%switch_label%%3) (=> (= tmp%3 tmp%2) %%switch_label%%2)))) (=> (not (and (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!))) (=> (= tmp%3 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%3 (and (=> %%location_label%%1 (req%lib!betree.LinkedBetree_v.impl&%6.compact_buffer_valid_domain. T&. T& self! start! end! compacted_buffer!)) (=> (= tmp%4 (lib!betree.LinkedBetree_v.impl&%6.compact_buffer_valid_domain.? T&. T& self! start! end! compacted_buffer!)) (=> (= tmp%5 tmp%4) %%switch_label%%1)))) (=> (not tmp%3) (=> (= tmp%5 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%5 (and (=> %%location_label%%2 (req%lib!betree.LinkedBetree_v.impl&%6.compact_buffer_valid_range. T&. T& self! start! end! compacted_buffer!)) (=> (= tmp%6 (lib!betree.LinkedBetree_v.impl&%6.compact_buffer_valid_range.? T&. T& self! start! end! compacted_buffer!)) (=> (= tmp%7 tmp%6) %%switch_label%%0)))) (=> (not tmp%5) (=> (= tmp%7 false) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
