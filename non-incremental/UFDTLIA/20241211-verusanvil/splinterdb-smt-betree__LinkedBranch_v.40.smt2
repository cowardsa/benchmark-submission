...
(declare-const split_branch! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Poly)
(declare-const tmp%3 Bool)
(declare-const pivot$1@ lib!spec.KeyType_t.Key.)
(declare-const pivot_index@ Int)
(declare-const tmp%4 Bool)
(declare-const root@ lib!betree.LinkedBranch_v.Node.)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!betree.LinkedBranch_v.SplitArg.))
(assert (has_type split_branch! TYPE%lib!betree.LinkedBranch_v.LinkedBranch.))
