...
(set-info :comment ";; Function-Def lib::marshalling::IntegerMarshalling_v::impl&%11::max_ensures")
(set-info :comment ";; marshalling/IntegerMarshalling_v.rs:361:11: 361:34 (#0)")
(set-info :comment ";; Function-Def lib::marshalling::IntegerMarshalling_v::impl&%11::exec_max")
(set-info :comment ";; marshalling/IntegerMarshalling_v.rs:365:10: 365:36 (#0)")
(set-info :comment ";; Function-Def lib::marshalling::IntegerMarshalling_v::impl&%11::to_usize")
(set-info :comment ";; marshalling/IntegerMarshalling_v.rs:367:10: 367:43 (#0)")
(set-info :comment ";; Function-Def lib::marshalling::IntegerMarshalling_v::impl&%11::from_usize")
(set-info :comment ";; marshalling/IntegerMarshalling_v.rs:372:10: 372:45 (#0)")
(declare-const %return! Poly)
(declare-const v! Poly)
(assert fuel_defaults)
(assert (has_type v! (UINT SZ)))
(assert (<= (%I v!) (%I (lib!marshalling.IntegerMarshalling_v.IntFormattable.max.? $ (UINT 64)))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= %return! (I (uClip 64 (%I v!)))) (=> %%location_label%%0 (= (%I %return!) (%I v!))))))
(check-sat)
(exit)
