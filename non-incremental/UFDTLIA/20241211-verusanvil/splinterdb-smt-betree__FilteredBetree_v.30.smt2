...
(assert (not (or (and (=> (and (lib!betree.FilteredBetree_v.impl&%1.wf.? self!) (lib!betree.FilteredBetree_v.impl&%1.is_leaf.? self!)) (and (=> %%location_label%%0 (req%lib!betree.FilteredBetree_v.impl&%1.my_domain. self!)) (=> (= tmp%1 (lib!betree.FilteredBetree_v.impl&%1.my_domain.? self!)) (=> (= tmp%2 (lib!betree.Domain_v.impl&%1.contains.? (Poly%lib!betree.Domain_v.Domain. tmp%1) split_key!)) %%switch_label%%1)))) (=> (not (and (lib!betree.FilteredBetree_v.impl&%1.wf.? self!) (lib!betree.FilteredBetree_v.impl&%1.is_leaf.? self!))) (=> (= tmp%2 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%2 (and (=> %%location_label%%1 (req%lib!betree.FilteredBetree_v.impl&%1.my_domain. self!)) (=> (= tmp%3 (lib!betree.FilteredBetree_v.impl&%1.my_domain.? self!)) (=> (= tmp%4 (not (= (lib!betree.Domain_v.Domain./Domain/start (%Poly%lib!betree.Domain_v.Domain. (Poly%lib!betree.Domain_v.Domain. tmp%3))) (lib!spec.KeyType_t.to_element.? split_key!)))) %%switch_label%%0)))) (=> (not tmp%2) (=> (= tmp%4 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
