...
(assert (not (=> (has_type i@ NAT) (or (and (=> (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? self! i@) (=> (= tmp%2 (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) tmp%2 i@)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. self!))) i@)) (=> (= tmp%3 (is-core!option.Option./Some_ (%Poly%core!option.Option. tmp%1))) %%switch_label%%0))))) (=> (not (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? self! i@)) (=> (= tmp%3 true) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
