...
(declare-const page_allocator@ lib!exec.MiniAllocator_v.PageAllocator.)
...
(assert (is-core!option.Option./None_ (lib!exec.MiniAllocator_v.MiniAllocator./MiniAllocator/allocs (%Poly%lib!exec.MiniAllocator_v.MiniAllocator. (Poly%lib!exec.MiniAllocator_v.MiniAllocator. self!@0)))))
(assert (< au! (lib!disk.GenericDisk_v.au_count.? (I 0))))
...
(assert (not (and (=> %%location_label%%0 (req%lib!exec.MiniAllocator_v.impl&%1.new. au!)) (=> (ens%lib!exec.MiniAllocator_v.impl&%1.new. au! page_allocator@) (=> (= tmp%1 (core!option.Option./Some (Poly%lib!exec.MiniAllocator_v.PageAllocator. page_allocator@))) (=> (= (lib!exec.MiniAllocator_v.MiniAllocator./MiniAllocator/allocs (%Poly%lib!exec.MiniAllocator_v.MiniAllocator. (Poly%lib!exec.MiniAllocator_v.MiniAllocator. self!@1))) tmp%1) (=> %%location_label%%1 (lib!exec.MiniAllocator_v.impl&%3.wf.? (Poly%lib!exec.MiniAllocator_v.MiniAllocator. self!@1)))))))))
(check-sat)
(exit)
