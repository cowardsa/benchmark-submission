...
(declare-const %return! tuple%2.)
(declare-const self! Poly)
(declare-const split_arg! Poly)
(declare-const right_root_addr! Poly)
...
(assert (has_type split_arg! TYPE%lib!betree.LinkedBranch_v.SplitArg.))
(assert (has_type right_root_addr! TYPE%lib!spec.AsyncDisk_t.Address.))
...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.has_root.? self!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%1.wf. split_arg! self!)) (=> (= tmp%1 (lib!betree.LinkedBranch_v.impl&%1.wf.? split_arg! self!)) (=> (lib!betree.LinkedBranch_v.impl&%1.wf.? split_arg! self!) (=> (lib!betree.LinkedBranch_v.impl&%4.is_fresh.? (Poly%lib!betree.LinkedBranch_v.DiskView. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/disk_view (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!))) (vstd!set.impl&%0.insert.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!set.impl&%0.empty.? $ TYPE%lib!spec.AsyncDisk_t.Address.) right_root_addr!)) (and (=> %%location_label%%1 (req%lib!betree.LinkedBranch_v.impl&%5.root. self!)) (=> (= tmp%2 (lib!betree.LinkedBranch_v.impl&%5.root.? self!)) (or (and (=> (is-lib!betree.LinkedBranch_v.Node./Leaf_ tmp%2) (and (=> %%location_label%%2 (req%lib!betree.LinkedBranch_v.impl&%5.split_leaf. self! split_arg! right_root_addr!)) (=> (= tmp%3 (lib!betree.LinkedBranch_v.impl&%5.split_leaf.? self! split_arg! right_root_addr!)) (=> (= tmp%5 tmp%3) %%switch_label%%0)))) (=> (not (is-lib!betree.LinkedBranch_v.Node./Leaf_ tmp%2)) (and (=> %%location_label%%3 (req%lib!betree.LinkedBranch_v.impl&%5.split_index. self! split_arg! right_root_addr!)) (=> (= tmp%4 (lib!betree.LinkedBranch_v.impl&%5.split_index.? self! split_arg! right_root_addr!)) (=> (= tmp%5 tmp%4) %%switch_label%%0))))) (not %%switch_label%%0)))))))))))
(check-sat)
(exit)
