...
(declare-const tmp%7 lib!betree.Domain_v.Domain.)
(declare-const tmp%8 lib!betree.Domain_v.Domain.)
(declare-const tmp%9 Bool)
(declare-const child_ptr@ core!option.Option.)
...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%1.entries_wf.? self!) (=> (lib!betree.LinkedBetree_v.impl&%0.wf.? node!) (=> (lib!betree.LinkedBetree_v.impl&%0.valid_child_index.? node! idx!) (and (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%1.node_has_nondangling_child_ptrs. self! node!)) (=> (= tmp%1 (lib!betree.LinkedBetree_v.impl&%1.node_has_nondangling_child_ptrs.? self! node!)) (=> (lib!betree.LinkedBetree_v.impl&%1.node_has_nondangling_child_ptrs.? self! node!) (=> (= tmp%3 (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. node!)))) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) tmp%3 idx!)) (=> (= tmp%2 (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.) (Poly%vstd!seq.Seq<core!option.Option<lib!spec.AsyncDisk_t.Address.>.>. (lib!betree.LinkedBetree_v.BetreeNode./BetreeNode/children (%Poly%lib!betree.LinkedBetree_v.BetreeNode. node!))) idx!)) (=> (= child_ptr@ (%Poly%core!option.Option. tmp%2)) (or (and (=> (is-core!option.Option./Some_ child_ptr@) (and (=> %%location_label%%2 (req%vstd!std_specs.option.spec_unwrap. $ TYPE%lib!spec.AsyncDisk_t.Address. (Poly%core!option.Option. child_ptr@))) (=> (= tmp%4 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. child_ptr@)))) (=> (= tmp%6 (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!)))) (and (=> %%location_label%%3 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. tmp%6 tmp%4)) (=> (= tmp%5 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!betree.LinkedBetree_v.BetreeNode. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!betree.LinkedBetree_v.BetreeNode.>. (lib!betree.LinkedBetree_v.DiskView./DiskView/entries (%Poly%lib!betree.LinkedBetree_v.DiskView. self!))) tmp%4)) (and (=> %%location_label%%4 (req%lib!betree.LinkedBetree_v.impl&%0.my_domain. tmp%5)) (=> (= tmp%7 (lib!betree.LinkedBetree_v.impl&%0.my_domain.? tmp%5)) (and (=> %%location_label%%5 (req%lib!betree.LinkedBetree_v.impl&%0.child_domain. node! idx!)) (=> (= tmp%8 (lib!betree.LinkedBetree_v.impl&%0.child_domain.? node! idx!)) (=> (= tmp%9 (= tmp%7 tmp%8)) %%switch_label%%0))))))))))) (=> (not (is-core!option.Option./Some_ child_ptr@)) (=> (= tmp%9 true) %%switch_label%%0))) (not %%switch_label%%0))))))))))))))
(check-sat)
(exit)
