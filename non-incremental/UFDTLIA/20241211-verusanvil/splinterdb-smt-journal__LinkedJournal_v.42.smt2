...
(assert (not (or (and (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. self!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? self!)) (=> (= tmp%2 tmp%1) %%switch_label%%3)))) (=> (not (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!)) (=> (= tmp%2 false) %%switch_label%%3))) (and (not %%switch_label%%3) (or (and (=> tmp%2 (=> (has_type other@ TYPE%lib!journal.LinkedJournal_v.DiskView.) (or (and (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? other@ root!) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.acyclic. other@)) (=> (= tmp%3 (lib!journal.LinkedJournal_v.impl&%1.acyclic.? other@)) (=> (= tmp%4 tmp%3) %%switch_label%%2)))) (=> (not (lib!journal.LinkedJournal_v.impl&%1.decodable.? other@ root!)) (=> (= tmp%4 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%4 (and (=> %%location_label%%2 (req%lib!journal.LinkedJournal_v.impl&%1.iptr. self! root!)) (=> (= tmp%5 (lib!journal.LinkedJournal_v.impl&%1.iptr.? self! root!)) (and (=> %%location_label%%3 (req%lib!journal.LinkedJournal_v.impl&%1.iptr. other@ root!)) (=> (= tmp%6 (lib!journal.LinkedJournal_v.impl&%1.iptr.? other@ root!)) (=> (= tmp%7 (= tmp%5 tmp%6)) %%switch_label%%1)))))) (=> (not tmp%4) (=> (= tmp%7 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%8 (forall ((other$ Poly)) (! (=> (has_type other$ TYPE%lib!journal.LinkedJournal_v.DiskView.) (=> (and (and (and (lib!journal.LinkedJournal_v.impl&%1.decodable.? other$ root!) (lib!journal.LinkedJournal_v.impl&%1.acyclic.? other$)) (= (lib!journal.LinkedJournal_v.impl&%1.iptr.? self! root!) (lib!journal.LinkedJournal_v.impl&%1.iptr.? other$ root!))) (lib!journal.LinkedJournal_v.impl&%1.is_sub_disk.? other$ self!)) (= other$ self!))) :pattern ((lib!journal.LinkedJournal_v.impl&%1.is_sub_disk.? other$ self!)) ))) %%switch_label%%0))))))) (=> (not tmp%2) (=> (= tmp%8 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
