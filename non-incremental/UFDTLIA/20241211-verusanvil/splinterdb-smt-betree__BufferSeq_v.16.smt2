...
(assert (has_type offset_map! TYPE%lib!betree.OffsetMap_v.OffsetMap.))
(assert (has_type idx! INT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (Sub (lib!betree.BufferSeq_v.impl&%0.len.? self!) (%I idx!))) (=> (and (<= 0 (%I idx!)) (<= (%I idx!) (lib!betree.BufferSeq_v.impl&%0.len.? self!))) (or (and (=> (= (lib!betree.BufferSeq_v.impl&%0.len.? self!) (%I idx!)) (=> (= tmp%3 (lib!betree.Buffer_v.impl&%1.empty.? (I 0))) %%switch_label%%0)) (=> (not (= (lib!betree.BufferSeq_v.impl&%0.len.? self!) (%I idx!))) (=> (= bottom_buffer@ (lib!betree.Buffer_v.impl&%1.apply_filter.? (vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. self!))) idx!) (Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (lib!betree.OffsetMap_v.impl&%0.active_keys.? offset_map! (I (nClip (%I idx!))))))) (=> (= tmp%2 (I (Add (%I idx!) 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!betree.BufferSeq_v.BufferSeq. self!)) (offset_map!$1 (%Poly%lib!betree.OffsetMap_v.OffsetMap. offset_map!)) (idx!$2 (%I tmp%2))) (Sub (lib!betree.BufferSeq_v.impl&%0.len.? (Poly%lib!betree.BufferSeq_v.BufferSeq. self!$0)) idx!$2)) decrease%init0 false)) (=> (= tmp%1 (lib!betree.BufferSeq_v.impl&%0.i_filtered_from.? self! offset_map! (I (Add (%I idx!) 1)))) (=> (= tmp%3 (lib!betree.Buffer_v.impl&%1.merge.? (Poly%lib!betree.Buffer_v.SimpleBuffer. bottom_buffer@) (Poly%lib!betree.Buffer_v.SimpleBuffer. tmp%1))) %%switch_label%%0))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)
