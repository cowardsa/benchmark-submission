...
(set-info :comment ";; MODULE 'module spec::AppIO_t'")
...
(set-info :comment ";; Function-Decl lib::spec::ImplDisk_t::iau_count")
(declare-fun lib!spec.ImplDisk_t.iau_count.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::spec::AppIO_t::ProgramModel::init")
...
(set-info :comment ";; Function-Decl lib::spec::AppIO_t::ProgramModel::next")
...
(set-info :comment ";; Function-Decl lib::spec::AppIO_t::Token::view")
(declare-fun lib!spec.AppIO_t.impl&%0.view.? (Dcr Type Poly) Poly)
(set-info :comment ";; Function-Decl lib::spec::ImplDisk_t::IAddress::wf")
(declare-fun lib!spec.ImplDisk_t.impl&%0.wf.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::spec::ImplDisk_t::IDiskRequest::arrow_from")
(declare-fun lib!spec.ImplDisk_t.impl&%1.arrow_from.? (Poly) lib!spec.ImplDisk_t.IAddress.)
(set-info :comment ";; Function-Decl lib::spec::ImplDisk_t::IDiskRequest::arrow_to")
...
(set-info :comment ";; Function-Decl lib::spec::ImplDisk_t::IDiskRequest::view")
(declare-fun lib!spec.ImplDisk_t.impl&%3.view.? (Poly) lib!spec.AsyncDisk_t.DiskRequest.)
(set-info :comment ";; Function-Decl lib::spec::AppIO_t::to_disk_reqs")
...
(set-info :comment ";; Function-Decl lib::spec::ImplDisk_t::IDiskResponse::view")
(declare-fun lib!spec.ImplDisk_t.impl&%4.view.? (Poly) lib!spec.AsyncDisk_t.DiskResponse.)
(set-info :comment ";; Function-Decl lib::spec::AppIO_t::to_disk_resps")
...
(set-info :comment ";; Function-Decl lib::spec::AppIO_t::Program::view")
...
(set-info :comment ";; Function-Axioms lib::spec::ImplDisk_t::iau_count")
...
(set-info :comment ";; Function-Axioms lib::spec::AppIO_t::ProgramModel::init")
...
(set-info :comment ";; Function-Axioms lib::spec::AppIO_t::ProgramModel::next")
...
(set-info :comment ";; Function-Specs lib::spec::AppIO_t::ProgramModel::accept_request_always_enabled")
...
(set-info :comment ";; Function-Axioms lib::spec::AppIO_t::Token::view")
...
(set-info :comment ";; Function-Specs lib::spec::AppIO_t::TrustedAPI::receive_request")
...
(set-info :comment ";; Function-Specs lib::spec::AppIO_t::TrustedAPI::execute")
...
(set-info :comment ";; Function-Specs lib::spec::AppIO_t::TrustedAPI::send_reply")
...
(set-info :comment ";; Function-Axioms lib::spec::ImplDisk_t::IAddress::wf")
...
(set-info :comment ";; Function-Axioms lib::spec::ImplDisk_t::IDiskRequest::arrow_from")
...
(set-info :comment ";; Function-Axioms lib::spec::ImplDisk_t::IDiskRequest::arrow_to")
...
(set-info :comment ";; Function-Axioms lib::spec::ImplDisk_t::IDiskRequest::view")
...
(set-info :comment ";; Function-Specs lib::spec::AppIO_t::to_disk_reqs")
...
(set-info :comment ";; Spec-Termination lib::spec::AppIO_t::to_disk_reqs")
(set-info :comment ";; spec/AppIO_t.rs:174:1: 174:102 (#0)")
(set-info :comment ";; Function-Recommends lib::spec::AppIO_t::to_disk_reqs")
(set-info :comment ";; spec/AppIO_t.rs:174:1: 174:102 (#0)")
(declare-const %return! vstd!map.Map<u64./lib!spec.AsyncDisk_t.DiskRequest.>.)
(declare-const ids! Poly)
(declare-const reqs! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Poly)
(declare-const tmp%3 Poly)
(declare-const tmp%4 Poly)
(declare-const tmp%5 vstd!map.Map<u64./lib!spec.AsyncDisk_t.DiskRequest.>.)
(declare-const tmp%6 Poly)
(declare-const tmp%7 Poly)
(declare-const sub_ids@ vstd!seq.Seq<u64.>.)
(declare-const sub_reqs@ vstd!seq.Seq<lib!spec.ImplDisk_t.IDiskRequest.>.)
(declare-const tmp%8 Poly)
(assert fuel_defaults)
(assert (has_type ids! (TYPE%vstd!seq.Seq. $ (UINT 64))))
(assert (has_type reqs! (TYPE%vstd!seq.Seq. $ TYPE%lib!spec.ImplDisk_t.IDiskRequest.)))
...
(assert (not (=> (= (vstd!seq.Seq.len.? $ (UINT 64) ids!) (vstd!seq.Seq.len.? $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs!)) (or (and (=> (> (vstd!seq.Seq.len.? $ (UINT 64) ids!) 0) (=> (= tmp%2 (I (vstd!seq.Seq.len.? $ (UINT 64) ids!))) (and (=> %%location_label%%0 (req%vstd!seq.Seq.subrange. $ (UINT 64) ids! (I 1) tmp%2)) (=> (= tmp%1 (vstd!seq.Seq.subrange.? $ (UINT 64) ids! (I 1) (I (vstd!seq.Seq.len.? $ (UINT 64) ids!)))) (=> (= sub_ids@ (%Poly%vstd!seq.Seq<u64.>. tmp%1)) (=> (= tmp%4 (I (vstd!seq.Seq.len.? $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs!))) (and (=> %%location_label%%1 (req%vstd!seq.Seq.subrange. $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs! (I 1) tmp%4)) (=> (= tmp%3 (vstd!seq.Seq.subrange.? $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs! (I 1) (I (vstd!seq.Seq.len.? $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs!)))) (=> (= sub_reqs@ (%Poly%vstd!seq.Seq<lib!spec.ImplDisk_t.IDiskRequest.>. tmp%3)) (and (=> %%location_label%%2 (req%lib!spec.AppIO_t.to_disk_reqs. (Poly%vstd!seq.Seq<u64.>. sub_ids@) (Poly%vstd!seq.Seq<lib!spec.ImplDisk_t.IDiskRequest.>. sub_reqs@))) (=> (= tmp%5 (lib!spec.AppIO_t.to_disk_reqs.? (Poly%vstd!seq.Seq<u64.>. sub_ids@) (Poly%vstd!seq.Seq<lib!spec.ImplDisk_t.IDiskRequest.>. sub_reqs@))) (and (=> %%location_label%%3 (req%vstd!seq.impl&%0.spec_index. $ (UINT 64) ids! (I 0))) (=> (= tmp%6 (vstd!seq.Seq.index.? $ (UINT 64) ids! (I 0))) (and (=> %%location_label%%4 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs! (I 0))) (=> (= tmp%7 (vstd!seq.Seq.index.? $ TYPE%lib!spec.ImplDisk_t.IDiskRequest. reqs! (I 0))) (=> (= tmp%8 (vstd!map.impl&%0.insert.? $ (UINT 64) $ TYPE%lib!spec.AsyncDisk_t.DiskRequest. (Poly%vstd!map.Map<u64./lib!spec.AsyncDisk_t.DiskRequest.>. tmp%5) tmp%6 (Poly%lib!spec.AsyncDisk_t.DiskRequest. (lib!spec.ImplDisk_t.impl&%3.view.? tmp%7)))) %%switch_label%%0)))))))))))))))) (=> (not (> (vstd!seq.Seq.len.? $ (UINT 64) ids!) 0)) (=> (= tmp%8 (vstd!map.impl&%0.empty.? $ (UINT 64) $ TYPE%lib!spec.AsyncDisk_t.DiskRequest.)) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
