...
(assert (not (=> (lib!betree.PivotBranch_v.impl&%3.wf.? self!) (=> (is-lib!betree.PivotBranch_v.Node./Leaf_ (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (> (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. keys!) 0) (=> (= (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. keys!) (vstd!seq.Seq.len.? $ TYPE%lib!spec.Messages_t.Message. msgs!)) (=> (lib!spec.KeyType_t.impl&%1.is_strictly_sorted.? keys!) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.Node./Leaf/keys (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.Seq.last. $ TYPE%lib!spec.KeyType_t.Key. tmp%2)) (=> (= tmp%1 (vstd!seq.Seq.last.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. (lib!betree.PivotBranch_v.Node./Leaf/keys (%Poly%lib!betree.PivotBranch_v.Node. self!))))) (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Key. keys! (I 0)))))))))))))
(check-sat)
(exit)
