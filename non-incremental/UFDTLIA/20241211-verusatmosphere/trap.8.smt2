...
(set-info :comment ";; MODULE 'module trap'")
...
(set-info :comment ";; Function-Decl lib::trap::TrapFrameOption::is_None")
...
(set-info :comment ";; Function-Specs lib::trap::TrapFrameOption::set_self_fast")
...
(set-info :comment ";; Function-Specs lib::trap::TrapFrameOption::set_dst_fast")
...
(set-info :comment ";; Function-Specs lib::trap::Registers::zeroed")
...
(set-info :comment ";; Function-Specs lib::trap::Registers::random")
...
(set-info :comment ";; Function-Axioms lib::trap::TrapFrameOption::is_None")
...
(set-info :comment ";; Function-Specs lib::trap::TrapFrameOption::unwrap")
...
(set-info :comment ";; Function-Def lib::trap::TrapFrameOption::unwrap")
(set-info :comment ";; trap.rs:42:5: 42:45 (#0)")
(set-info :comment ";; Function-Specs lib::trap::TrapFrameOption::is_some")
...
(set-info :comment ";; Function-Def lib::trap::TrapFrameOption::is_some")
(set-info :comment ";; trap.rs:28:5: 28:39 (#0)")
(set-info :comment ";; Function-Specs lib::trap::TrapFrameOption::is_none")
...
(set-info :comment ";; Function-Def lib::trap::TrapFrameOption::is_none")
(set-info :comment ";; trap.rs:34:5: 34:39 (#0)")
(set-info :comment ";; Function-Specs lib::trap::TrapFrameOption::set_self")
...
(set-info :comment ";; Function-Def lib::trap::TrapFrameOption::set_self")
(set-info :comment ";; trap.rs:67:5: 67:48 (#0)")
(set-info :comment ";; Function-Specs lib::trap::TrapFrameOption::set_dst")
...
(set-info :comment ";; Function-Def lib::trap::TrapFrameOption::set_dst")
(set-info :comment ";; trap.rs:94:5: 94:47 (#0)")
(set-info :comment ";; Function-Specs lib::trap::TrapFrameOption::set_to_none")
...
(set-info :comment ";; Function-Def lib::trap::TrapFrameOption::set_to_none")
(set-info :comment ";; trap.rs:103:5: 103:34 (#0)")
(set-info :comment ";; Function-Specs lib::trap::TrapFrameOption::zeroed_none")
...
(set-info :comment ";; Function-Def lib::trap::TrapFrameOption::zeroed_none")
(set-info :comment ";; trap.rs:110:5: 110:39 (#0)")
(set-info :comment ";; Function-Specs lib::trap::Registers::new_empty")
...
(set-info :comment ";; Function-Def lib::trap::Registers::new_empty")
(set-info :comment ";; trap.rs:167:5: 167:37 (#0)")
(declare-const %return! lib!trap.Registers.)
