...
(set-info :comment ";; Function-Def lib::pagetable::entry::PageEntry::empty")
(set-info :comment ";; pagetable/entry.rs:41:5: 41:33 (#0)")
(declare-const ret! lib!pagetable.entry.PageEntry.)
(declare-const no%param Int)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= ret! (lib!pagetable.entry.PageEntry./PageEntry (%I (I 0)) (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. (lib!pagetable.entry.PageEntryPerm./PageEntryPerm (%B (B false)) (%B (B false)) (%B (B false)) (%B (B false)) (%B (B false))))))) (=> %%location_label%%0 (lib!pagetable.entry.impl&%4.is_empty.? (Poly%lib!pagetable.entry.PageEntry. ret!))))))
(check-sat)
(exit)
