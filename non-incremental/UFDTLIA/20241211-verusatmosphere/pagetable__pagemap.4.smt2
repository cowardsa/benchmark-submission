...
(set-info :comment ";; Function-Specs lib::pagetable::pagemap::PageMap::index")
...
(set-info :comment ";; Function-Def lib::pagetable::pagemap::PageMap::index")
(set-info :comment ";; pagetable/pagemap.rs:128:5: 128:55 (#0)")
(declare-const ret! lib!pagetable.entry.PageEntry.)
(declare-const self! lib!pagetable.pagemap.PageMap.)
(declare-const index! Int)
(declare-const tmp%1 Poly)
(declare-const tmp%2 lib!array.Array.)
(declare-const tmp%3 lib!pagetable.entry.PageEntry.)
...
(assert (not (=> (= tmp%2 (lib!pagetable.pagemap.PageMap./PageMap/ar (%Poly%lib!pagetable.pagemap.PageMap. (Poly%lib!pagetable.pagemap.PageMap. self!)))) (and (=> %%location_label%%0 (req%lib!array.impl&%0.get. $ (UINT SZ) $ (CONST_INT 512) tmp%2 index!)) (=> (ens%lib!array.impl&%0.get. $ (UINT SZ) $ (CONST_INT 512) tmp%2 index! tmp%1) (=> (ens%lib!pagetable.entry.usize2page_entry. (%I tmp%1) tmp%3) (=> (= ret! tmp%3) (=> %%location_label%%1 (ext_eq false TYPE%lib!pagetable.entry.PageEntry. (Poly%lib!pagetable.entry.PageEntry. ret!) (Poly%lib!pagetable.entry.PageEntry. (lib!pagetable.pagemap.impl&%0.spec_index.? (Poly%lib!pagetable.pagemap.PageMap. self!) (I index!))))))))))))
(check-sat)
(exit)
