...
(set-info :comment ";; Function-Specs lib::array::test")
(declare-fun req%lib!array.test. (Dcr Type lib!array.Array.) Bool)
(declare-const %%global_location_label%%17 Bool)
(declare-const %%global_location_label%%18 Bool)
(declare-const %%global_location_label%%19 Bool)
(assert (forall ((N&. Dcr) (N& Type) (pre%ar! lib!array.Array.)) (! (= (req%lib!array.test. N&. N& pre%ar!) (and (=> %%global_location_label%%17 (lib!array.impl&%0.wf.? $ (UINT 64) N&. N& (Poly%lib!array.Array. pre%ar!))) (=> %%global_location_label%%18 (= (%I (vstd!seq.Seq.index.? $ (UINT 64) (lib!array.Array./Array/seq (%Poly%lib!array.Array. (Poly%lib!array.Array. pre%ar!))) (I 1))) 0)) (=> %%global_location_label%%19 (= (const_int N&) 2)))) :pattern ((req%lib!array.test. N&. N& pre%ar!)) )))
(declare-fun ens%lib!array.test. (Dcr Type lib!array.Array. lib!array.Array.) Bool)
(assert (forall ((N&. Dcr) (N& Type) (pre%ar! lib!array.Array.) (ar! lib!array.Array.)) (! (= (ens%lib!array.test. N&. N& pre%ar! ar!) (has_type (Poly%lib!array.Array. ar!) (TYPE%lib!array.Array. $ (UINT 64) N&. N&))) :pattern ((ens%lib!array.test. N&. N& pre%ar! ar!)) )))
(set-info :comment ";; Function-Def lib::array::test")
(set-info :comment ";; array.rs:154:1: 154:48 (#0)")
(declare-const N&. Dcr)
(declare-const N& Type)
(declare-const ar!@0 lib!array.Array.)
...
(declare-const v_1_new@ Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!array.Array. ar!@0) (TYPE%lib!array.Array. $ (UINT 64) N&. N&)))
(assert (uInv SZ (const_int N&)))
(assert (lib!array.impl&%0.wf.? $ (UINT 64) N&. N& (Poly%lib!array.Array. ar!@0)))
(assert (= (%I (vstd!seq.Seq.index.? $ (UINT 64) (lib!array.Array./Array/seq (%Poly%lib!array.Array. (Poly%lib!array.Array. ar!@0))) (I 1))) 0))
(assert (= (const_int N&) 2))
(declare-const ar!@1 lib!array.Array.)
...
(assert (not (and (=> %%location_label%%0 (req%lib!array.impl&%0.get. $ (UINT 64) N&. N& ar!@0 1)) (=> (ens%lib!array.impl&%0.get. $ (UINT 64) N&. N& ar!@0 1 tmp%1) (=> (= v_1@ (%I tmp%1)) (=> (= tmp%2 (= v_1@ 0)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (and (=> %%location_label%%2 (req%lib!array.impl&%1.set. $ (UINT 64) N&. N& ar!@0 0 (I 1))) (=> (has_type (Poly%lib!array.Array. ar!@1) (TYPE%lib!array.Array. $ (UINT 64) N&. N&)) (=> (ens%lib!array.impl&%1.set. $ (UINT 64) N&. N& ar!@0 ar!@1 0 (I 1)) (and (=> %%location_label%%3 (req%lib!array.impl&%0.get. $ (UINT 64) N&. N& ar!@1 0)) (=> (ens%lib!array.impl&%0.get. $ (UINT 64) N&. N& ar!@1 0 tmp%3) (=> (= v_0@ (%I tmp%3)) (=> (= tmp%4 (= v_0@ 1)) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (=> %%location_label%%5 (req%lib!array.impl&%0.get. $ (UINT 64) N&. N& ar!@1 1)))))))))))))))))))
(check-sat)
(exit)
