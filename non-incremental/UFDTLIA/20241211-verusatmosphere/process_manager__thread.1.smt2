...
(assert (not (=> (= ret! (ite (is-lib!process_manager.thread.IPCPayLoad./Message_ self!) (let ((va$ (lib!process_manager.thread.IPCPayLoad./Message/va (%Poly%lib!process_manager.thread.IPCPayLoad. (Poly%lib!process_manager.thread.IPCPayLoad. self!))))) (let ((len$ (lib!process_manager.thread.IPCPayLoad./Message/len (%Poly%lib!process_manager.thread.IPCPayLoad. (Poly%lib!process_manager.thread.IPCPayLoad. self!))))) (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (I va$) (I len$)))))) core!option.Option./None)) (=> %%location_label%%0 (= ret! (lib!process_manager.thread.impl&%3.spec_get_payload_as_message.? (Poly%lib!process_manager.thread.IPCPayLoad. self!)))))))
(check-sat)
(exit)
