...
(assert (not (=> %%location_label%%0 (vstd!seq_lib.impl&%0.no_duplicates.? T&. T& (lib!slinkedlist.spec_impl_u.StaticLinkedList./StaticLinkedList/spec_seq (%Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. (Poly%lib!slinkedlist.spec_impl_u.StaticLinkedList. self!)))))))
(check-sat)
(exit)
