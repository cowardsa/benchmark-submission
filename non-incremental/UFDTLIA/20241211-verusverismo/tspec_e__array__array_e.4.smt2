...
(assert (has_type self! (TYPE%verismo!tspec_e.array.Array. T&. T& N&. N&)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (ens%verismo!tspec_e.array.array_t.impl&%4.trusted_len. T&. T& N&. N& tmp%1) (=> (= ret! tmp%1) (and (=> %%location_label%%0 (= ret! (verismo!tspec_e.array.array_t.impl&%4.spec_len.? T&. T& N&. N&))) (=> %%location_label%%1 (%B (B true))))))))
(check-sat)
(exit)
