...
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#8482)")
(set-info :comment ";; Function-Axioms verismo::arch::rmp::def_s::RMP_FAIL_INUSE")
(assert (fuel_bool_default fuel%verismo!arch.rmp.def_s.RMP_FAIL_INUSE.))
(assert (=> (fuel_bool fuel%verismo!arch.rmp.def_s.RMP_FAIL_INUSE.) (= verismo!arch.rmp.def_s.RMP_FAIL_INUSE.? 3)))
(assert (uInv 64 verismo!arch.rmp.def_s.RMP_FAIL_INUSE.?))
(set-info :comment ";; Function-Def verismo::arch::rmp::def_s::RMP_FAIL_OVERLAP")
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#8482)")
(set-info :comment ";; Function-Axioms verismo::arch::rmp::def_s::RMP_FAIL_OVERLAP")
(assert (fuel_bool_default fuel%verismo!arch.rmp.def_s.RMP_FAIL_OVERLAP.))
(assert (=> (fuel_bool fuel%verismo!arch.rmp.def_s.RMP_FAIL_OVERLAP.) (= verismo!arch.rmp.def_s.RMP_FAIL_OVERLAP.? 4)))
(assert (uInv 64 verismo!arch.rmp.def_s.RMP_FAIL_OVERLAP.?))
(set-info :comment ";; Function-Specs verismo::arch::rmp::def_s::RmpEntry::proof_eq")
...
(set-info :comment ";; Function-Def verismo::arch::rmp::def_s::RmpEntry::proof_eq")
(set-info :comment ";; verismo/src/arch/rmp/def_s.rs:28:5: 28:41 (#0)")
(declare-const self! verismo!arch.rmp.def_s.RmpEntry.)
(declare-const r! verismo!arch.rmp.def_s.RmpEntry.)
(assert fuel_defaults)
(assert (has_type (Poly%verismo!arch.rmp.def_s.RmpEntry. self!) TYPE%verismo!arch.rmp.def_s.RmpEntry.))
(assert (has_type (Poly%verismo!arch.rmp.def_s.RmpEntry. r!) TYPE%verismo!arch.rmp.def_s.RmpEntry.))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (= (verismo!arch.rmp.access_u.impl&%0.view.? (Poly%verismo!arch.rmp.def_s.RmpEntry. self!)) (verismo!arch.rmp.access_u.impl&%0.view.? (Poly%verismo!arch.rmp.def_s.RmpEntry. r!))) (= self! r!)))))
(check-sat)
(exit)
