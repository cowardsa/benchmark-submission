...
(set-info :comment ";; MODULE 'module snp::percpu::def_s'")
(set-info :comment ";; Fuel")
(declare-const fuel%verismo!snp.percpu.def_s.VMPL_COUNT. FuelId)
(declare-const fuel%verismo!snp.percpu.def_s.BSP. FuelId)
(assert (distinct fuel%verismo!snp.percpu.def_s.VMPL_COUNT. fuel%verismo!snp.percpu.def_s.BSP.))
(set-info :comment ";; Datatypes")
(set-info :comment ";; Function-Decl verismo::snp::percpu::def_s::VMPL_COUNT")
(declare-fun verismo!snp.percpu.def_s.VMPL_COUNT.? () Int)
(set-info :comment ";; Function-Decl verismo::snp::percpu::def_s::BSP")
(declare-fun verismo!snp.percpu.def_s.BSP.? () Int)
(set-info :comment ";; Function-Def verismo::snp::percpu::def_s::BSP")
(set-info :comment ";; verismo/src/snp/percpu/def_s.rs:7:1: 7:24 (#0)")
