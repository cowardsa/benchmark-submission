...
(assert (has_type input! (TYPE%vstd!seq.Seq. T&. T&)))
(assert (and (<= 0 i!) (< i! (vstd!seq.Seq.len.? T&. T& input!))))
(assert (and (<= 0 j!) (< j! (vstd!seq.Seq.len.? T&. T& input!))))
...
(assert (not (=> (= ret@ (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) (vstd!seq.Seq.index.? T&. T& input! (I j!))) (I j!) (vstd!seq.Seq.index.? T&. T& input! (I i!)))) (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. T&. T& input!) (=> (= tmp%1 (vstd!seq.Seq.index.? T&. T& input! (I j!))) (and (=> %%location_label%%0 (req%verismo!tspec_e.array.sort.lemma_seq_to_multiset_update. T&. T& input! i! tmp%1)) (=> (ens%verismo!tspec_e.array.sort.lemma_seq_to_multiset_update. T&. T& input! i! tmp%1) (=> (= tmp%2 (vstd!seq.Seq.update.? T&. T& input! (I i!) (vstd!seq.Seq.index.? T&. T& input! (I j!)))) (=> (= tmp%3 (vstd!seq.Seq.index.? T&. T& input! (I i!))) (and (=> %%location_label%%1 (req%verismo!tspec_e.array.sort.lemma_seq_to_multiset_update. T&. T& tmp%2 j! tmp%3)) (=> (ens%verismo!tspec_e.array.sort.lemma_seq_to_multiset_update. T&. T& tmp%2 j! tmp%3) (=> (= tmp%4 (vstd!seq.Seq.update.? T&. T& input! (I i!) (vstd!seq.Seq.index.? T&. T& input! (I j!)))) (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. T&. T& tmp%4) (=> (= ret! ret@) (and (=> %%location_label%%2 (= ret! (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) (vstd!seq.Seq.index.? T&. T& input! (I j!))) (I j!) (vstd!seq.Seq.index.? T&. T& input! (I i!))))) (=> %%location_label%%3 (ext_eq true (TYPE%vstd!multiset.Multiset. T&. T&) (vstd!seq_lib.impl&%0.to_multiset.? T&. T& ret!) (vstd!seq_lib.impl&%0.to_multiset.? T&. T& input!))))))))))))))))))
(check-sat)
(exit)
