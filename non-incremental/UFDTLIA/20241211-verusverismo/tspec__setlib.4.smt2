...
(declare-const v1$1@ Poly)
(declare-const v2$1@ Poly)
(declare-const tmp%7 Bool)
(declare-const tmp%8 Bool)
(declare-const v2$2@ Poly)
(declare-const r0@ Poly)
...
(assert (has_type vv1! T1&))
(assert (> (vstd!set.impl&%0.len.? T1&. T1& s1!) 0))
(assert (vstd!set.impl&%0.contains.? T1&. T1& s1! vv1!))
(assert (vstd!set.impl&%0.finite.? T1&. T1& s1!))
(assert (vstd!set.impl&%0.finite.? T2&. T2& s2!))
(declare-fun %%choose%%1 (Type Type Dcr Type Poly Dcr Type Poly %%Function%% Poly Dcr Type Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Poly) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Poly) (%%hole%%8 %%Function%%) (%%hole%%9 Poly) (%%hole%%10 Dcr) (%%hole%%11 Type) (%%hole%%12 Poly) (%%hole%%13 Dcr) (%%hole%%14 Type) (%%hole%%15 Poly)) (! (=> (exists ((v1$ Poly) (v2$ Poly)) (! (and (has_type v1$ %%hole%%0) (has_type v2$ %%hole%%1) (and (and (vstd!set.impl&%0.contains.? %%hole%%2 %%hole%%3 %%hole%%4 v1$) (vstd!set.impl&%0.contains.? %%hole%%5 %%hole%%6 %%hole%%7 v2$)) (= %%hole%%9 (%%apply%%1 %%hole%%8 v1$ v2$)))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%10 %%hole%%11 %%hole%%12 v1$) (vstd!set.impl&%0.contains.? %%hole%%13 %%hole%%14 %%hole%%15 v2$)) )) (exists ((v1$ Poly) (v2$ Poly)) (! (and (and (has_type v1$ %%hole%%0) (has_type v2$ %%hole%%1) (and (and (vstd!set.impl&%0.contains.? %%hole%%2 %%hole%%3 %%hole%%4 v1$) (vstd!set.impl&%0.contains.? %%hole%%5 %%hole%%6 %%hole%%7 v2$)) (= %%hole%%9 (%%apply%%1 %%hole%%8 v1$ v2$)))) (= (%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15) (Poly%tuple%2. (tuple%2./tuple%2 v1$ v2$)))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%10 %%hole%%11 %%hole%%12 v1$) (vstd!set.impl&%0.contains.? %%hole%%13 %%hole%%14 %%hole%%15 v2$))))) :pattern ((%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15)))))
(declare-fun %%choose%%2 (Type Dcr Type Poly %%Function%% Poly Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4 %%Function%%) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((v2$3 Poly)) (! (and (has_type v2$3 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 v2$3) (= %%hole%%6 (%%apply%%1 %%hole%%4 %%hole%%5 v2$3)))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%7 %%hole%%8 %%hole%%9 v2$3)) )) (exists ((v2$3 Poly)) (! (and (and (has_type v2$3 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 v2$3) (= %%hole%%6 (%%apply%%1 %%hole%%4 %%hole%%5 v2$3)))) (= (%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) v2$3)) :pattern ((vstd!set.impl&%0.contains.? %%hole%%7 %%hole%%8 %%hole%%9 v2$3))))) :pattern ((%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
...
(assert (not (=> (= r0@ (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (=> (= r1@ (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! T1& T2& T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (and (=> %%location_label%%0 (req%verismo!tspec.setlib.lemma_setop1. T1&. T1& T2&. T2& T3&. T3& vv1! s2! op_fn!)) (=> (ens%verismo!tspec.setlib.lemma_setop1. T1&. T1& T2&. T2& T3&. T3& vv1! s2! op_fn! r2@) (=> (= ss1@ (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!)) (and (=> (has_type val@ T3&) (or (and (=> (vstd!set.impl&%0.contains.? T3&. T3& r0@ val@) (=> (= tmp%%@ (%Poly%tuple%2. (as_type (%%choose%%1 T1& T2& T1&. T1& s1! T2&. T2& s2! op_fn! val@ T1&. T1& s1! T2&. T2& s2!) (TYPE%tuple%2. T1&. T1& T2&. T2&)))) (=> (= v1@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= v2@ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= tmp%1 (and (and (vstd!set.impl&%0.contains.? T1&. T1& s1! v1@) (vstd!set.impl&%0.contains.? T2&. T2& s2! v2@)) (= val@ (%%apply%%1 op_fn! v1@ v2@)))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (or (and (=> (vstd!set.impl&%0.contains.? T1&. T1& ss1@ v1@) (=> (= tmp%2 (vstd!set.impl&%0.contains.? T3&. T3& r1@ val@)) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 %%switch_label%%3)))) (=> (not (vstd!set.impl&%0.contains.? T1&. T1& ss1@ v1@)) (or (and (=> (not (= v1@ vv1!)) (=> (= tmp%3 (vstd!set.impl&%0.contains.? T1&. T1& ss1@ v1@)) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 %%switch_label%%4)))) (=> (not (not (= v1@ vv1!))) (=> (= tmp%4 (vstd!set.impl&%0.contains.? T3&. T3& r2@ val@)) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 %%switch_label%%4))))) (and (not %%switch_label%%4) %%switch_label%%3)))) (and (not %%switch_label%%3) %%switch_label%%2))))))))) (=> (not (vstd!set.impl&%0.contains.? T3&. T3& r0@ val@)) %%switch_label%%2)) (and (not %%switch_label%%2) (or (and (=> (vstd!set.impl&%0.contains.? T3&. T3& r1@ val@) (=> (= tmp%%$1@ (%Poly%tuple%2. (as_type (%%choose%%1 T1& T2& T1&. T1& ss1@ T2&. T2& s2! op_fn! val@ T1&. T1& ss1@ T2&. T2& s2!) (TYPE%tuple%2. T1&. T1& T2&. T2&)))) (=> (= v1$1@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@)))) (=> (= v2$1@ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@)))) (=> (= tmp%5 (and (and (vstd!set.impl&%0.contains.? T1&. T1& s1! v1$1@) (vstd!set.impl&%0.contains.? T2&. T2& s2! v2$1@)) (= val@ (%%apply%%1 op_fn! v1$1@ v2$1@)))) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 (=> (= tmp%6 (vstd!set.impl&%0.contains.? T3&. T3& r0@ val@)) (and (=> %%location_label%%6 tmp%6) (=> tmp%6 %%switch_label%%1)))))))))) (=> (not (vstd!set.impl&%0.contains.? T3&. T3& r1@ val@)) %%switch_label%%1)) (and (not %%switch_label%%1) (or (and (=> (vstd!set.impl&%0.contains.? T3&. T3& r2@ val@) (=> (= v2$2@ (as_type (%%choose%%2 T2& T2&. T2& s2! op_fn! vv1! val@ T2&. T2& s2!) T2&)) (=> (= tmp%7 (and (and (vstd!set.impl&%0.contains.? T1&. T1& s1! vv1!) (vstd!set.impl&%0.contains.? T2&. T2& s2! v2$2@)) (= val@ (%%apply%%1 op_fn! vv1! v2$2@)))) (and (=> %%location_label%%7 tmp%7) (=> tmp%7 (=> (= tmp%8 (vstd!set.impl&%0.contains.? T3&. T3& r0@ val@)) (and (=> %%location_label%%8 tmp%8) (=> tmp%8 %%switch_label%%0)))))))) (=> (not (vstd!set.impl&%0.contains.? T3&. T3& r2@ val@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%9 (= (vstd!set.impl&%0.contains.? T3&. T3& r0@ val@) (vstd!set.impl&%0.contains.? T3&. T3& (vstd!set.impl&%0.union.? T3&. T3& r1@ r2@) val@)))))))))) (=> (forall ((val$ Poly)) (! (=> (has_type val$ T3&) (= (vstd!set.impl&%0.contains.? T3&. T3& r0@ val$) (vstd!set.impl&%0.contains.? T3&. T3& (vstd!set.impl&%0.union.? T3&. T3& r1@ r2@) val$))) :pattern ((vstd!set.impl&%0.contains.? T3&. T3& r0@ val$)) )) (=> (= ret! (tuple%3./tuple%3 r0@ r1@ r2@)) (and (=> %%location_label%%10 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!)))))))) (and (=> %%location_label%%11 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! T1& T2& T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!)))))))) (and (=> %%location_label%%12 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. (Poly%fun%2. op_fn!)) vv1!)))))))))) (=> %%location_label%%13 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (vstd!set.impl&%0.union.? T3&. T3& (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. ret!)))))))))))))))))))
(check-sat)
(exit)
