...
(assert (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (pre%self! Poly) (index! Int) (elem! Poly)) (! (= (req%verismo!tspec_e.array.array_e.impl&%2.set. T&. T& N&. N& pre%self! index! elem!) (and (=> %%global_location_label%%29 (< index! (vstd!seq.Seq.len.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& pre%self!)))) (=> %%global_location_label%%30 (%B (B true))))) :pattern ((req%verismo!tspec_e.array.array_e.impl&%2.set. T&. T& N&. N& pre%self! index! elem!)) )))
...
(set-info :comment ";; Function-Specs verismo::tspec_e::array::Array::memset")
(declare-fun req%verismo!tspec_e.array.array_utils.impl&%0.memset. (Dcr Type Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%31 Bool)
(assert (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (pre%self! Poly) (elem! Poly)) (! (= (req%verismo!tspec_e.array.array_utils.impl&%0.memset. T&. T& N&. N& pre%self! elem!) (=> %%global_location_label%%31 (> (vstd!seq.Seq.len.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& pre%self!)) 0))) :pattern ((req%verismo!tspec_e.array.array_utils.impl&%0.memset. T&. T& N&. N& pre%self! elem!)) )))
(declare-fun ens%verismo!tspec_e.array.array_utils.impl&%0.memset. (Dcr Type Dcr Type Poly Poly Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (pre%self! Poly) (self! Poly) (elem! Poly)) (! (= (ens%verismo!tspec_e.array.array_utils.impl&%0.memset. T&. T& N&. N& pre%self! self! elem!) (and (has_type self! (TYPE%verismo!tspec_e.array.Array. T&. T& N&. N&)) (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) (vstd!seq.Seq.len.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!)))) (= (vstd!seq.Seq.index.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!) j$) elem!))) :pattern ((vstd!seq.Seq.index.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!) j$)) )))) :pattern ((ens%verismo!tspec_e.array.array_utils.impl&%0.memset. T&. T& N&. N& pre%self! self! elem!)) )))
(set-info :comment ";; Function-Def verismo::tspec_e::array::Array::memset")
(set-info :comment ";; verismo/src/tspec_e/array/array_utils.rs:100:9: 108:10 (#0)")
(declare-const T&. Dcr)
...
(assert (not (=> (has_type self!@1 (TYPE%verismo!tspec_e.array.Array. T&. T& N&. N&)) (=> (%B (B true)) (=> (and (<= 0 i@0) (<= i@0 (vstd!seq.Seq.len.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!@1)))) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (vstd!seq.Seq.index.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!@1) j$) elem!))) :pattern ((vstd!seq.Seq.index.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!@1) j$)) )) (=> (ens%verismo!tspec_e.array.array_e.impl&%0.len. T&. T& N&. N& self!@1 tmp%1) (=> (< i@0 tmp%1) (and (=> %%location_label%%0 (req%verismo!tspec_e.array.array_e.impl&%2.set. T&. T& N&. N& self!@1 i@0 elem!)) (=> (has_type self!@2 (TYPE%verismo!tspec_e.array.Array. T&. T& N&. N&)) (=> (ens%verismo!tspec_e.array.array_e.impl&%2.set. T&. T& N&. N& self!@1 self!@2 i@0 elem!) (and (=> %%location_label%%1 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (and (=> %%location_label%%2 (%B (B true))) (and (=> %%location_label%%3 (and (<= 0 i@1) (<= i@1 (vstd!seq.Seq.len.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!@2))))) (=> %%location_label%%4 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (vstd!seq.Seq.index.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!@2) j$) elem!))) :pattern ((vstd!seq.Seq.index.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!@2) j$)) ))))))))))))))))))
(check-sat)
(exit)
