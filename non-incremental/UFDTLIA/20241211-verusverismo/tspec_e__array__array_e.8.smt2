...
(assert (not (and (=> %%location_label%%0 (req%verismo!tspec_e.array.array_t.impl&%4.trusted_update. T&. T& N&. N& self!@0 index! elem!)) (=> (has_type self!@1 (TYPE%verismo!tspec_e.array.Array. T&. T& N&. N&)) (=> (ens%verismo!tspec_e.array.array_t.impl&%4.trusted_update. T&. T& N&. N& self!@0 self!@1 index! elem! tmp%1) (=> %%location_label%%1 (= (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!@1) (vstd!seq.Seq.update.? T&. T& (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!@0) (I index!) elem!))))))))
(check-sat)
(exit)
