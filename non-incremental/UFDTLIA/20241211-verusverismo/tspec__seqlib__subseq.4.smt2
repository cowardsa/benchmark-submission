...
(declare-const keep_idx! vstd!seq.Seq<int.>.)
(declare-const removed_idx! vstd!seq.Seq<int.>.)
(declare-const i! Int)
...
(assert (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& keep! s! (Poly%vstd!seq.Seq<int.>. keep_idx!)))
(assert (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& removed! s! (Poly%vstd!seq.Seq<int.>. removed_idx!)))
(assert (and (<= 0 i!) (< i! (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx!)))))
