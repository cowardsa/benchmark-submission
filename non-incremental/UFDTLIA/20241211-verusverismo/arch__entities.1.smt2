...
(set-info :comment ";; MODULE 'module arch::entities'")
...
(set-info :comment ";; Function-Decl verismo::arch::entities::VMPL::is_VMPL1")
(declare-fun verismo!arch.entities.impl&%9.is_VMPL1.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::entities::VMPL::is_VMPL2")
(declare-fun verismo!arch.entities.impl&%9.is_VMPL2.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::entities::VMPL::is_VMPL3")
...
(set-info :comment ";; Function-Axioms verismo::arch::entities::VMPL::is_VMPL1")
(assert (fuel_bool_default fuel%verismo!arch.entities.impl&%9.is_VMPL1.))
(assert (=> (fuel_bool fuel%verismo!arch.entities.impl&%9.is_VMPL1.) (forall ((self! Poly)) (! (= (verismo!arch.entities.impl&%9.is_VMPL1.? self!) (is-verismo!arch.entities.VMPL./VMPL1_ (%Poly%verismo!arch.entities.VMPL. self!))) :pattern ((verismo!arch.entities.impl&%9.is_VMPL1.? self!)) ))))
(set-info :comment ";; Function-Axioms verismo::arch::entities::VMPL::is_VMPL2")
(assert (fuel_bool_default fuel%verismo!arch.entities.impl&%9.is_VMPL2.))
(assert (=> (fuel_bool fuel%verismo!arch.entities.impl&%9.is_VMPL2.) (forall ((self! Poly)) (! (= (verismo!arch.entities.impl&%9.is_VMPL2.? self!) (is-verismo!arch.entities.VMPL./VMPL2_ (%Poly%verismo!arch.entities.VMPL. self!))) :pattern ((verismo!arch.entities.impl&%9.is_VMPL2.? self!)) ))))
(set-info :comment ";; Function-Axioms verismo::arch::entities::VMPL::is_VMPL3")
...
(assert (=> (fuel_bool fuel%verismo!arch.entities.impl&%9.is_VMPL3.) (forall ((self! Poly)) (! (= (verismo!arch.entities.impl&%9.is_VMPL3.? self!) (is-verismo!arch.entities.VMPL./VMPL3_ (%Poly%verismo!arch.entities.VMPL. self!))) :pattern ((verismo!arch.entities.impl&%9.is_VMPL3.? self!)) ))))
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Function-Specs verismo::arch::entities::VMPL::as_u64")
...
(set-info :comment ";; Function-Def verismo::arch::entities::VMPL::as_u64")
(set-info :comment ";; verismo/src/arch/entities/mod.rs:18:25: 18:36 (#8235)")
(declare-const ret! Int)
(declare-const self! verismo!arch.entities.VMPL.)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= ret! (let ((ret$ (ite (is-verismo!arch.entities.VMPL./VMPL0_ self!) 0 (ite (is-verismo!arch.entities.VMPL./VMPL1_ self!) 1 (ite (is-verismo!arch.entities.VMPL./VMPL2_ self!) 2 3))))) ret$)) (=> %%location_label%%0 (= ret! (%I (verismo!tspec.integer.IntValue.as_int.? $ TYPE%verismo!arch.entities.VMPL. (Poly%verismo!arch.entities.VMPL. self!))))))))
(check-sat)
(exit)
