...
(set-info :comment ";; MODULE 'module tspec::range_set'")
...
(set-info :comment ";; Function-Decl verismo::tspec::range_set::range")
(declare-fun verismo!tspec.range_set.range.? (Poly Poly) tuple%2.)
(set-info :comment ";; Function-Decl verismo::tspec::range_set::range2set")
(declare-fun verismo!tspec.range_set.range2set.? (Poly) vstd!set.Set<int.>.)
(set-info :comment ";; Function-Decl verismo::tspec::range_set::VRange::to_set")
...
(set-info :comment ";; Function-Decl verismo::tspec::range_set::VRange::end")
...
(set-info :comment ";; Function-Decl verismo::tspec::range_set::within_range")
(declare-fun verismo!tspec.range_set.within_range.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::tspec::range_set::inside_range")
(declare-fun verismo!tspec.range_set.inside_range.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::tspec::range_set::inside_ranges")
(declare-fun verismo!tspec.range_set.inside_ranges.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::tspec::range_set::after_range")
...
(set-info :comment ";; Function-Decl verismo::tspec::range_set::range_disjoint_")
(declare-fun verismo!tspec.range_set.range_disjoint_.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::tspec::range_set::ranges_disjoint")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::VRange::to_set")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::VRange::end")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::impl&%0::end")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::range_disjoint_")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::inside_range")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::ranges_disjoint")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::within_range")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::range2set")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::range")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::impl&%0::to_set")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::inside_ranges")
...
(set-info :comment ";; Function-Axioms verismo::tspec::range_set::after_range")
...
(set-info :comment ";; Function-Def verismo::tspec::range_set::lemma_to_set")
(set-info :comment ";; verismo/src/tspec/range_set.rs:62:1: 62:64 (#0)")
...
(set-info :comment ";; Function-Def verismo::tspec::range_set::lemma_range_set_disjoint")
(set-info :comment ";; verismo/src/tspec/range_set.rs:159:1: 159:88 (#0)")
...
(declare-const ret@ Bool)
(declare-const set1@ vstd!set.Set<int.>.)
(declare-const set2@ vstd!set.Set<int.>.)
...
(assert (not (=> (= ret@ (verismo!tspec.range_set.range_disjoint.? (I f1!) (I n1!) (I f2!) (I n2!))) (=> (ens%verismo!tspec.range_set.lemma_to_set. f1! n1! set1@) (=> (ens%verismo!tspec.range_set.lemma_to_set. f2! n2! set2@) (or (and (=> ret@ (and (=> (has_type a@ INT) (=> (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set1@) a@) (=> %%location_label%%0 (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set2@) a@))))) (=> (forall ((a$ Poly)) (! (=> (has_type a$ INT) (=> (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set1@) a$) (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set2@) a$)))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set1@) a$)) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set2@) a$)) )) %%switch_label%%0))) (=> (not ret@) (and (=> (= tmp%1 (<= f1! f1!)) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= tmp%2 (> n1! 0)) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (= tmp%3 (< f1! (Add f1! n1!))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> %%location_label%%4 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set1@) (I f1!)))))))))))) (=> (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set1@) (I f1!)) (=> (= tmp%4 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set2@) (I f2!))) (and (=> %%location_label%%5 tmp%4) (=> tmp%4 (or (and (=> (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set2@) (I f1!))) (=> (= tmp%5 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set1@) (I f2!))) (and (=> %%location_label%%6 tmp%5) (=> tmp%5 %%switch_label%%2)))) (=> (not (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set2@) (I f1!)))) %%switch_label%%2)) (and (not %%switch_label%%2) (or (and (=> (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set1@) (I f2!))) (=> (= tmp%6 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set2@) (I f1!))) (and (=> %%location_label%%7 tmp%6) (=> tmp%6 %%switch_label%%1)))) (=> (not (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. set1@) (I f2!)))) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (= tmp%7 (not (vstd!set.impl&%0.disjoint.? $ INT (Poly%vstd!set.Set<int.>. set1@) (Poly%vstd!set.Set<int.>. set2@)))) (and (=> %%location_label%%8 tmp%7) (=> tmp%7 %%switch_label%%0)))))))))))))) (and (not %%switch_label%%0) (=> (= ret! ret@) (and (=> %%location_label%%9 (= ret! (verismo!tspec.range_set.range_disjoint.? (I f1!) (I n1!) (I f2!) (I n2!)))) (=> %%location_label%%10 (= ret! (vstd!set.impl&%0.disjoint.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I f1!) (I n1!))) (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I f2!) (I n2!)))))))))))))))
(check-sat)
(exit)
