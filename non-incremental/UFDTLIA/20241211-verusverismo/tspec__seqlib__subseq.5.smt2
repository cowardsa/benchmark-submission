...
(set-info :comment ";; MODULE 'module tspec::seqlib::subseq'")
...
(set-info :comment ";; Function-Decl verismo::tspec::seqlib::subseq::sub_element")
(declare-fun verismo!tspec.seqlib.subseq.sub_element.? (Dcr Type Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::tspec::seqlib::subseq::is_subseq_via_index")
...
(set-info :comment ";; Function-Axioms verismo::tspec::seqlib::subseq::sub_element")
...
(set-info :comment ";; Function-Axioms verismo::tspec::seqlib::subseq::is_subseq_via_index")
...
(set-info :comment ";; Function-Specs verismo::tspec::seqlib::subseq::proof_empty_is_subs")
...
(set-info :comment ";; Function-Def verismo::tspec::seqlib::subseq::proof_empty_is_subs")
(set-info :comment ";; verismo/src/tspec/seqlib/subseq.rs:17:1: 17:47 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::seqlib::subseq::proof_subs_remove")
...
(set-info :comment ";; Function-Def verismo::tspec::seqlib::subseq::proof_subs_remove")
(set-info :comment ";; verismo/src/tspec/seqlib/subseq.rs:23:1: 23:87 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::seqlib::subseq::proof_subs_push")
...
(set-info :comment ";; Function-Def verismo::tspec::seqlib::subseq::proof_subs_push")
(set-info :comment ";; verismo/src/tspec/seqlib/subseq.rs:60:1: 60:85 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::seqlib::subseq::lemma_remove_keep")
(declare-fun req%verismo!tspec.seqlib.subseq.lemma_remove_keep. (Dcr Type Poly Poly Poly vstd!seq.Seq<int.>. vstd!seq.Seq<int.>. Int) Bool)
(declare-const %%global_location_label%%52 Bool)
(declare-const %%global_location_label%%53 Bool)
(declare-const %%global_location_label%%54 Bool)
(declare-const %%global_location_label%%55 Bool)
(assert (forall ((T&. Dcr) (T& Type) (s! Poly) (keep! Poly) (removed! Poly) (keep_idx! vstd!seq.Seq<int.>.) (removed_idx! vstd!seq.Seq<int.>.) (i! Int)) (! (= (req%verismo!tspec.seqlib.subseq.lemma_remove_keep. T&. T& s! keep! removed! keep_idx! removed_idx! i!) (and (=> %%global_location_label%%52 (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& keep! s! (Poly%vstd!seq.Seq<int.>. keep_idx!))) (=> %%global_location_label%%53 (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& removed! s! (Poly%vstd!seq.Seq<int.>. removed_idx!))) (=> %%global_location_label%%54 (and (<= 0 i!) (< i! (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx!))))) (=> %%global_location_label%%55 (= (nClip (Add (vstd!seq.Seq.len.? T&. T& keep!) (vstd!seq.Seq.len.? T&. T& removed!))) (vstd!seq.Seq.len.? T&. T& s!))))) :pattern ((req%verismo!tspec.seqlib.subseq.lemma_remove_keep. T&. T& s! keep! removed! keep_idx! removed_idx! i!)) )))
(declare-fun ens%verismo!tspec.seqlib.subseq.lemma_remove_keep. (Dcr Type Poly Poly Poly vstd!seq.Seq<int.>. vstd!seq.Seq<int.>. Int) Bool)
(assert (forall ((T&. Dcr) (T& Type) (s! Poly) (keep! Poly) (removed! Poly) (keep_idx! vstd!seq.Seq<int.>.) (removed_idx! vstd!seq.Seq<int.>.) (i! Int)) (! (= (ens%verismo!tspec.seqlib.subseq.lemma_remove_keep. T&. T& s! keep! removed! keep_idx! removed_idx! i!) (and (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& (vstd!seq_lib.impl&%0.remove.? T&. T& keep! (I i!)) s! (vstd!seq_lib.impl&%0.remove.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx!) (I i!))) (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& (vstd!seq.Seq.push.? T&. T& removed! (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx!) (I i!)))) s! (vstd!seq.Seq.push.? $ INT (Poly%vstd!seq.Seq<int.>. removed_idx!) (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx!) (I i!)))))) :pattern ((ens%verismo!tspec.seqlib.subseq.lemma_remove_keep. T&. T& s! keep! removed! keep_idx! removed_idx! i!)) )))
(set-info :comment ";; Function-Def verismo::tspec::seqlib::subseq::lemma_remove_keep")
(set-info :comment ";; verismo/src/tspec/seqlib/subseq.rs:100:1: 107:2 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::seqlib::subseq::proof_remove_keep")
(declare-fun req%verismo!tspec.seqlib.subseq.proof_remove_keep. (Dcr Type Poly Poly Poly vstd!seq.Seq<int.>. vstd!seq.Seq<int.>. Int) Bool)
...
(assert (forall ((T&. Dcr) (T& Type) (s! Poly) (keep! Poly) (removed! Poly) (pre%keep_idx! vstd!seq.Seq<int.>.) (pre%removed_idx! vstd!seq.Seq<int.>.) (i! Int)) (! (= (req%verismo!tspec.seqlib.subseq.proof_remove_keep. T&. T& s! keep! removed! pre%keep_idx! pre%removed_idx! i!) (and (=> %%global_location_label%%56 (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& keep! s! (Poly%vstd!seq.Seq<int.>. pre%keep_idx!))) (=> %%global_location_label%%57 (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& removed! s! (Poly%vstd!seq.Seq<int.>. pre%removed_idx!))) (=> %%global_location_label%%58 (and (<= 0 i!) (< i! (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. pre%keep_idx!))))) (=> %%global_location_label%%59 (= (nClip (Add (vstd!seq.Seq.len.? T&. T& keep!) (vstd!seq.Seq.len.? T&. T& removed!))) (vstd!seq.Seq.len.? T&. T& s!))))) :pattern ((req%verismo!tspec.seqlib.subseq.proof_remove_keep. T&. T& s! keep! removed! pre%keep_idx! pre%removed_idx! i!)) )))
(declare-fun ens%verismo!tspec.seqlib.subseq.proof_remove_keep. (Dcr Type Poly Poly Poly vstd!seq.Seq<int.>. vstd!seq.Seq<int.>. vstd!seq.Seq<int.>. vstd!seq.Seq<int.>. Int) Bool)
(assert (forall ((T&. Dcr) (T& Type) (s! Poly) (keep! Poly) (removed! Poly) (pre%keep_idx! vstd!seq.Seq<int.>.) (keep_idx! vstd!seq.Seq<int.>.) (pre%removed_idx! vstd!seq.Seq<int.>.) (removed_idx! vstd!seq.Seq<int.>.) (i! Int)) (! (= (ens%verismo!tspec.seqlib.subseq.proof_remove_keep. T&. T& s! keep! removed! pre%keep_idx! keep_idx! pre%removed_idx! removed_idx! i!) (and (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& (vstd!seq_lib.impl&%0.remove.? T&. T& keep! (I i!)) s! (Poly%vstd!seq.Seq<int.>. keep_idx!)) (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& (vstd!seq.Seq.push.? T&. T& removed! (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. pre%keep_idx!) (I i!)))) s! (Poly%vstd!seq.Seq<int.>. removed_idx!)) (= keep_idx! (%Poly%vstd!seq.Seq<int.>. (vstd!seq_lib.impl&%0.remove.? $ INT (Poly%vstd!seq.Seq<int.>. pre%keep_idx!) (I i!)))) (= removed_idx! (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.push.? $ INT (Poly%vstd!seq.Seq<int.>. pre%removed_idx!) (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. pre%keep_idx!) (I i!))))))) :pattern ((ens%verismo!tspec.seqlib.subseq.proof_remove_keep. T&. T& s! keep! removed! pre%keep_idx! keep_idx! pre%removed_idx! removed_idx! i!)) )))
(set-info :comment ";; Function-Def verismo::tspec::seqlib::subseq::proof_remove_keep")
(set-info :comment ";; verismo/src/tspec/seqlib/subseq.rs:136:1: 143:2 (#0)")
(declare-const T&. Dcr)
(declare-const T& Type)
(declare-const s! Poly)
(declare-const keep! Poly)
(declare-const removed! Poly)
(declare-const keep_idx!@0 vstd!seq.Seq<int.>.)
(declare-const removed_idx!@0 vstd!seq.Seq<int.>.)
(declare-const i! Int)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Bool)
(declare-const tmp%3 Int)
(declare-const tmp%%@ tuple%2.)
(declare-const keep0@ Poly)
(declare-const keep_idx0@ vstd!seq.Seq<int.>.)
(declare-const tmp%%$1@ tuple%2.)
(declare-const removed0@ Poly)
(declare-const removed_idx0@ vstd!seq.Seq<int.>.)
(declare-const removed1@ Poly)
(declare-const removed_idx1@ vstd!seq.Seq<int.>.)
(declare-const keep1@ Poly)
(declare-const keep_idx1@ vstd!seq.Seq<int.>.)
(assert fuel_defaults)
(assert (has_type s! (TYPE%vstd!seq.Seq. T&. T&)))
(assert (has_type keep! (TYPE%vstd!seq.Seq. T&. T&)))
(assert (has_type removed! (TYPE%vstd!seq.Seq. T&. T&)))
(assert (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& keep! s! (Poly%vstd!seq.Seq<int.>. keep_idx!@0)))
(assert (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& removed! s! (Poly%vstd!seq.Seq<int.>. removed_idx!@0)))
(assert (and (<= 0 i!) (< i! (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx!@0)))))
(assert (= (nClip (Add (vstd!seq.Seq.len.? T&. T& keep!) (vstd!seq.Seq.len.? T&. T& removed!))) (vstd!seq.Seq.len.? T&. T& s!)))
(declare-const keep_idx!@1 vstd!seq.Seq<int.>.)
(declare-const removed_idx!@1 vstd!seq.Seq<int.>.)
...
(assert (not (=> (= tmp%%@ (tuple%2./tuple%2 keep! (Poly%vstd!seq.Seq<int.>. keep_idx!@0))) (=> (= keep0@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= keep_idx0@ (%Poly%vstd!seq.Seq<int.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= tmp%%$1@ (tuple%2./tuple%2 removed! (Poly%vstd!seq.Seq<int.>. removed_idx!@0))) (=> (= removed0@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@)))) (=> (= removed_idx0@ (%Poly%vstd!seq.Seq<int.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@))))) (=> (= tmp%1 (and (let ((tmp%%$$0 (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx0@) (I i!))))) (and (<= 0 tmp%%$$0) (< tmp%%$$0 (vstd!seq.Seq.len.? T&. T& s!)))) (= (vstd!seq.Seq.index.? T&. T& keep0@ (I i!)) (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx0@) (I i!)))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (let ((tmp%%$2 (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx0@) (I i!))))) (and (<= 0 tmp%%$2) (< tmp%%$2 (vstd!seq.Seq.len.? T&. T& s!))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= removed1@ (vstd!seq.Seq.push.? T&. T& removed0@ (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx0@) (I i!))))) (=> (= removed_idx1@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.push.? $ INT (Poly%vstd!seq.Seq<int.>. removed_idx0@) (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx0@) (I i!))))) (=> (= keep1@ (vstd!seq_lib.impl&%0.remove.? T&. T& keep0@ (I i!))) (=> (= keep_idx1@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq_lib.impl&%0.remove.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx0@) (I i!)))) (and (=> %%location_label%%2 (req%verismo!tspec.seqlib.subseq.proof_subs_remove. T&. T& s! keep0@ keep_idx0@ i!)) (=> (ens%verismo!tspec.seqlib.subseq.proof_subs_remove. T&. T& s! keep0@ keep_idx0@ i!) (=> (= tmp%3 (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx0@) (I i!)))) (and (=> %%location_label%%3 (req%verismo!tspec.seqlib.subseq.proof_subs_push. T&. T& s! removed0@ removed_idx0@ tmp%3)) (=> (ens%verismo!tspec.seqlib.subseq.proof_subs_push. T&. T& s! removed0@ removed_idx0@ tmp%3) (=> (= keep_idx!@1 keep_idx1@) (=> (= removed_idx!@1 removed_idx1@) (and (=> %%location_label%%4 (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& (vstd!seq_lib.impl&%0.remove.? T&. T& keep! (I i!)) s! (Poly%vstd!seq.Seq<int.>. keep_idx!@1))) (and (=> %%location_label%%5 (verismo!tspec.seqlib.subseq.is_subseq_via_index.? T&. T& (vstd!seq.Seq.push.? T&. T& removed! (vstd!seq.Seq.index.? T&. T& s! (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx!@0) (I i!)))) s! (Poly%vstd!seq.Seq<int.>. removed_idx!@1))) (and (=> %%location_label%%6 (= keep_idx!@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq_lib.impl&%0.remove.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx!@0) (I i!))))) (=> %%location_label%%7 (= removed_idx!@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.push.? $ INT (Poly%vstd!seq.Seq<int.>. removed_idx!@0) (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. keep_idx!@0) (I i!))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
