...
(set-info :comment ";; MODULE 'module trusted_hacl::hash_s'")
...
(set-info :comment ";; Function-Decl verismo::trusted_hacl::hash_s::SHA512_LEN")
(declare-fun verismo!trusted_hacl.hash_s.SHA512_LEN.? () Int)
(set-info :comment ";; Function-Decl verismo::trusted_hacl::hash_s::spec_cal_sha512")
...
(set-info :comment ";; Function-Axioms verismo::trusted_hacl::hash_s::spec_cal_sha512")
...
(set-info :comment ";; Function-Def verismo::trusted_hacl::hash_s::SHA512_LEN")
(set-info :comment ";; verismo/src/trusted_hacl/hash_s.rs:9:1: 9:43 (#0)")
