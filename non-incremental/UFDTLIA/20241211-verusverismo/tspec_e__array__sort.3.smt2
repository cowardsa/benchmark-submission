...
(assert (has_type v! T&))
(assert (and (and (and (<= 0 start!) (<= start! i!)) (< i! end!)) (<= end! (vstd!seq.Seq.len.? T&. T& input!))))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 (= (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) v!) (I start!) (I end!)) (I (Sub i! start!))) v!)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (ext_eq true (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) v!) (I start!) (I end!)) (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.subrange.? T&. T& input! (I start!) (I end!)) (I (Sub i! start!)) v!))))))))
(check-sat)
(exit)
