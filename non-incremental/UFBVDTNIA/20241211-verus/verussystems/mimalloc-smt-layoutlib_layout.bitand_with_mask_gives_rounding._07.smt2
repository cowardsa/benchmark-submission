...
(set-info :comment ";; layout.rs:441:9: 441:15 (#0)")
...
(assert (not (=> %%location_label%%0 (= (bvlshr x! ((_ zero_extend 63) (_ bv1 1))) (let ((tmp$$$$bitvectmp0 (_ bv2 2))) (ite (= tmp$$$$bitvectmp0 (_ bv0 2)) tmp$$$$bitvectmp1 (bvudiv x! ((_ zero_extend 62) tmp$$$$bitvectmp0))))))))
(check-sat)
(exit)
