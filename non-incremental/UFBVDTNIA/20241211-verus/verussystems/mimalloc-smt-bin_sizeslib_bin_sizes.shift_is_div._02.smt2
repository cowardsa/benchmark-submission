...
(set-info :comment ";; bin_sizes.rs:598:9: 598:15 (#0)")
...
(assert (and (bvult ((_ zero_extend 63) (_ bv0 1)) shift!) (bvult shift! ((_ zero_extend 57) (_ bv64 7)))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvlshr x! shift!) (let ((tmp$$$$bitvectmp0 (_ bv2 2))) (ite (= tmp$$$$bitvectmp0 (_ bv0 2)) tmp$$$$bitvectmp1 (bvudiv (bvlshr x! (bvsub shift! ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 62) tmp$$$$bitvectmp0))))))))
(check-sat)
(exit)
