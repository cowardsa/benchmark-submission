...
(set-info :comment ";; commit_mask.rs:69:13: 69:19 (#0)")
...
(set-info :comment ";; commit_mask.rs:69:13: 69:19 (#0)")
(declare-const j$1@ (_ BitVec 64))
(declare-const m$1@ (_ BitVec 64))
(declare-const n@ (_ BitVec 64))
(declare-const o@ (_ BitVec 64))
(assert (bvult j$1@ ((_ zero_extend 57) (_ bv64 7))))
(assert (= m$1@ (bvshl (bvsub (bvshl ((_ zero_extend 63) (_ bv1 1)) n@) ((_ zero_extend 63) (_ bv1 1))) o@)))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (=> (and (bvule o@ j$1@) (bvult j$1@ (bvadd o@ n@))) (= (bvand m$1@ (bvshl ((_ zero_extend 63) (_ bv1 1)) j$1@)) (bvshl ((_ zero_extend 63) (_ bv1 1)) j$1@))))))
(check-sat)
(exit)
