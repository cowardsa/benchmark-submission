...
(set-info :comment ";; layout.rs:431:9: 431:15 (#0)")
...
(assert (not (= y! ((_ zero_extend 63) (_ bv0 1)))))
(assert (not (= y! ((_ zero_extend 63) (_ bv1 1)))))
(assert (= (bvand y! (bvsub y! ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 63) (_ bv0 1))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (and (= (bvand x! (bvnot (bvsub y! ((_ zero_extend 63) (_ bv1 1))))) (bvmul ((_ zero_extend 62) (_ bv2 2)) (bvand (bvlshr x! ((_ zero_extend 63) (_ bv1 1))) (bvnot (bvsub (bvlshr y! ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1))))))) (bvult (bvand (bvlshr x! ((_ zero_extend 63) (_ bv1 1))) (bvnot (bvsub (bvlshr y! ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1))))) (_ bv9223372036854775808 64))))))
(check-sat)
(exit)
