...
(set-info :comment ";; layout.rs:443:13: 443:19 (#0)")
...
(assert (not (=> %%location_label%%0 (=> (= (bvand y! (bvsub y! ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 63) (_ bv0 1))) (= (let ((tmp$$$$bitvectmp0 (_ bv2 2))) (ite (= tmp$$$$bitvectmp0 (_ bv0 2)) tmp$$$$bitvectmp1 (bvurem y! ((_ zero_extend 62) tmp$$$$bitvectmp0)))) ((_ zero_extend 63) (_ bv0 1)))))))
(check-sat)
(exit)
