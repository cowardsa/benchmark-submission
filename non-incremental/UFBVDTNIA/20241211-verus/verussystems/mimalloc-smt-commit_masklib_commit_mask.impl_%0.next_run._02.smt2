...
(set-info :comment ";; commit_mask.rs:626:21: 626:27 (#0)")
...
(assert (not (= mask@ ((_ zero_extend 63) (_ bv0 1)))))
(assert (= (bvand mask@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv0 1))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (not (= (bvlshr mask@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv0 1)))))))
(check-sat)
(exit)
