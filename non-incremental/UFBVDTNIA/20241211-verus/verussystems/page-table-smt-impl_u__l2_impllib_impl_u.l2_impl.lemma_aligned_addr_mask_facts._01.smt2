...
(set-info :comment ";; page-table/impl_u/l2_impl.rs:60:13: 60:19 (#0)")
...
(declare-const max_width@ (_ BitVec 64))
(assert (= (let ((tmp$$$$bitvectmp0 (_ bv1073741824 31))) (ite (= tmp$$$$bitvectmp0 (_ bv0 31)) tmp$$$$bitvectmp1 (bvurem addr! ((_ zero_extend 33) tmp$$$$bitvectmp0)))) ((_ zero_extend 63) (_ bv0 1))))
(assert (bvule ((_ zero_extend 58) (_ bv32 6)) max_width@))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand addr! (bvshl (bvnot (bvshl (bvnot ((_ zero_extend 63) (_ bv0 1))) (bvsub (bvadd (bvsub max_width@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 59) (_ bv30 5))))) ((_ zero_extend 59) (_ bv30 5)))) (bvand addr! (bvshl (bvnot (bvshl (bvnot ((_ zero_extend 63) (_ bv0 1))) (bvsub (bvadd (bvsub max_width@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 60) (_ bv12 4))))) ((_ zero_extend 60) (_ bv12 4))))))))
(check-sat)
(exit)
