...
(set-info :comment ";; layout.rs:427:9: 427:15 (#0)")
...
(assert (not (=> %%location_label%%0 (=> (= (bvand y! (bvsub y! ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 63) (_ bv0 1))) (= (bvand (bvlshr y! ((_ zero_extend 63) (_ bv1 1))) (bvsub (bvlshr y! ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 63) (_ bv0 1)))))))
(check-sat)
(exit)
