...
(set-info :comment ";; commit_mask.rs:682:25: 682:31 (#0)")
...
(assert (not (= (bvand mask@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1)))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand mask@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv0 1))))))
(check-sat)
(exit)
