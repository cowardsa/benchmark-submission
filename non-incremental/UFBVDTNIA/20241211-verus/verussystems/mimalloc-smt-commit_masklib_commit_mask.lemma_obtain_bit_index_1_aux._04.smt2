...
(set-info :comment ";; commit_mask.rs:152:9: 152:15 (#0)")
...
(assert (and (= (bvand (bvlshr a! ((_ zero_extend 63) (_ bv1 1))) (bvshl ((_ zero_extend 63) (_ bv1 1)) j@)) (bvshl ((_ zero_extend 63) (_ bv1 1)) j@)) (bvult j@ ((_ zero_extend 57) (_ bv64 7)))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand a! (bvshl ((_ zero_extend 63) (_ bv1 1)) (bvadd j@ ((_ zero_extend 63) (_ bv1 1))))) (bvshl ((_ zero_extend 63) (_ bv1 1)) (bvadd j@ ((_ zero_extend 63) (_ bv1 1))))))))
(check-sat)
(exit)
