...
(set-info :comment ";; commit_mask.rs:445:21: 445:27 (#0)")
...
(assert (bvult c@ ((_ zero_extend 57) (_ bv64 7))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (bvugt (bvshl ((_ zero_extend 63) (_ bv1 1)) c@) ((_ zero_extend 63) (_ bv0 1))))))
(check-sat)
(exit)
