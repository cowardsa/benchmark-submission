...
(set-info :comment ";; commit_mask.rs:149:9: 149:15 (#0)")
...
(assert (not (= (bvand a! ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1)))))
(assert (not (= a! ((_ zero_extend 63) (_ bv0 1)))))
(assert (= (bvlshr a! hi!) ((_ zero_extend 63) (_ bv0 1))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (and (not (= (bvlshr a! ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv0 1)))) (= (bvlshr (bvlshr a! ((_ zero_extend 63) (_ bv1 1))) (bvsub hi! ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 63) (_ bv0 1)))))))
(check-sat)
(exit)
