...
(set-info :comment ";; layout.rs:422:9: 422:15 (#0)")
...
(assert (not (=> %%location_label%%0 (= (bvand x! (bvnot ((_ sign_extend 62) (bvsub ((_ zero_extend 1) (_ bv1 1)) ((_ zero_extend 1) (_ bv1 1)))))) x!))))
(check-sat)
(exit)
