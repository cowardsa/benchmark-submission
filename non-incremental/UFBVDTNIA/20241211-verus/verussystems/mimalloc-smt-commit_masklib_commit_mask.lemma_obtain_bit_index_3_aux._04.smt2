...
(set-info :comment ";; commit_mask.rs:98:9: 98:15 (#0)")
...
(assert (not (= (bvand (bvlshr a! ((_ zero_extend 63) (_ bv1 1))) (bvshl ((_ zero_extend 63) (_ bv1 1)) j@)) (bvshl ((_ zero_extend 63) (_ bv1 1)) j@))))
(assert (= (bvand (bvlshr b! ((_ zero_extend 63) (_ bv1 1))) (bvshl ((_ zero_extend 63) (_ bv1 1)) j@)) (bvshl ((_ zero_extend 63) (_ bv1 1)) j@)))
(assert (bvult j@ ((_ zero_extend 57) (_ bv64 7))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (and (not (= (bvand a! (bvshl ((_ zero_extend 63) (_ bv1 1)) (bvadd j@ ((_ zero_extend 63) (_ bv1 1))))) (bvshl ((_ zero_extend 63) (_ bv1 1)) (bvadd j@ ((_ zero_extend 63) (_ bv1 1)))))) (= (bvand b! (bvshl ((_ zero_extend 63) (_ bv1 1)) (bvadd j@ ((_ zero_extend 63) (_ bv1 1))))) (bvshl ((_ zero_extend 63) (_ bv1 1)) (bvadd j@ ((_ zero_extend 63) (_ bv1 1)))))))))
(check-sat)
(exit)
