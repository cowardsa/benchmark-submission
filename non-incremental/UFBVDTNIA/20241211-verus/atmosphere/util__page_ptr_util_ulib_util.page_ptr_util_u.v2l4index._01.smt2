...
(set-info :comment ";; util/page_ptr_util_u.rs:271:5: 271:11 (#0)")
...
(assert (not (=> %%location_label%%0 (bvule (bvand (bvlshr va! ((_ zero_extend 58) (_ bv39 6))) ((_ zero_extend 55) (_ bv511 9))) ((_ zero_extend 55) (_ bv511 9))))))
(check-sat)
(exit)
