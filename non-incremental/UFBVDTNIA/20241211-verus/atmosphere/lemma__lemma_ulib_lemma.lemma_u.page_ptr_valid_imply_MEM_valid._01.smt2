...
(set-info :comment ";; MODULE 'module lemma::lemma_u'")
(set-info :comment ";; lemma/lemma_u.rs:37:5: 37:11 (#0)")
...
(set-info :comment ";; Broadcast lib::lemma::lemma_u::map_equal_implies_submap_each_other")
...
(set-info :comment ";; Function-Specs lib::lemma::lemma_u::seq_pop_unique_lemma")
...
(set-info :comment ";; Function-Specs lib::lemma::lemma_u::map_insert_lemma")
...
(set-info :comment ";; Function-Specs lib::lemma::lemma_u::seq_index_lemma")
...
(set-info :comment ";; Function-Def lib::lemma::lemma_u::page_ptr_valid_imply_MEM_valid")
(set-info :comment ";; lemma/lemma_u.rs:37:5: 37:11 (#0)")
(declare-const v! (_ BitVec 64))
(declare-const tmp$$$$bitvectmp1 (_ BitVec 64))
(declare-const tmp$$$$bitvectmp3 (_ BitVec 64))
(assert (and (= (let ((tmp$$$$bitvectmp0 (_ bv4096 13))) (ite (= tmp$$$$bitvectmp0 (_ bv0 13)) tmp$$$$bitvectmp1 (bvurem v! ((_ zero_extend 51) tmp$$$$bitvectmp0)))) ((_ zero_extend 63) (_ bv0 1))) (bvult (let ((tmp$$$$bitvectmp2 (_ bv4096 13))) (ite (= tmp$$$$bitvectmp2 (_ bv0 13)) tmp$$$$bitvectmp3 (bvudiv v! ((_ zero_extend 51) tmp$$$$bitvectmp2)))) ((_ zero_extend 40) (bvmul ((_ zero_extend 11) (bvmul ((_ zero_extend 11) (_ bv2 2)) ((_ zero_extend 2) (_ bv1024 11)))) ((_ zero_extend 13) (_ bv1024 11)))))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand v! (bvnot ((_ zero_extend 16) (_ bv281474976706560 48)))) ((_ zero_extend 63) (_ bv0 1))))))
(check-sat)
(exit)
