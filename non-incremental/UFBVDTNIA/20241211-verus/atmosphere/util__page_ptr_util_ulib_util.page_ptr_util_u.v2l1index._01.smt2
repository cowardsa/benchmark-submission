...
(set-info :comment ";; util/page_ptr_util_u.rs:241:5: 241:11 (#0)")
...
(assert (not (=> %%location_label%%0 (bvule (bvand (bvlshr va! ((_ zero_extend 60) (_ bv12 4))) ((_ zero_extend 55) (_ bv511 9))) ((_ zero_extend 55) (_ bv511 9))))))
(check-sat)
(exit)
