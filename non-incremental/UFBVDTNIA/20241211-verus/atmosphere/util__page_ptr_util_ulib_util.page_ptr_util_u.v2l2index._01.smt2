...
(set-info :comment ";; util/page_ptr_util_u.rs:251:5: 251:11 (#0)")
...
(assert (not (=> %%location_label%%0 (bvule (bvand (bvlshr va! ((_ zero_extend 59) (_ bv21 5))) ((_ zero_extend 55) (_ bv511 9))) ((_ zero_extend 55) (_ bv511 9))))))
(check-sat)
(exit)
