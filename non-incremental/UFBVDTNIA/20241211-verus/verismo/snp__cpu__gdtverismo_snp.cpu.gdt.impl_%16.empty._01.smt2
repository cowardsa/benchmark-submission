...
(set-info :comment ";; verismo/src/snp/cpu/gdt.rs:18:1: 18:39 (#18306)")
(declare-const mask@0 (_ BitVec 64))
(declare-const offset@0 (_ BitVec 64))
(declare-const val@0 (_ BitVec 64))
(assert true)
(set-info :comment ";; bitvector ensures not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (or (not (= val@0 (_ bv0 64))) (= (bvand (bvlshr val@0 offset@0) mask@0) (_ bv0 64))))))
(check-sat)
(exit)
