...
(set-info :comment ";; MODULE 'module tspec::security::sectype_test::p'")
(set-info :comment ";; verismo/src/tspec/security/sectype_test.rs:35:5: 35:11 (#0)")
...
(set-info :comment ";; Function-Def verismo::tspec::security::sectype_test::p::proof_test_bits2")
(set-info :comment ";; verismo/src/tspec/security/sectype_test.rs:35:5: 35:11 (#0)")
