...
(set-info :comment ";; page-table/impl_u/l2_impl.rs:313:17: 313:23 (#0)")
...
(assert (= (bvand address! (bvshl (bvnot (bvshl (bvnot ((_ zero_extend 63) (_ bv0 1))) (bvsub (bvadd (bvsub mw@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 59) (_ bv30 5))))) ((_ zero_extend 59) (_ bv30 5)))) address!))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand address! (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 60) (_ bv12 4)))) ((_ zero_extend 63) (_ bv0 1))))))
(check-sat)
(exit)
