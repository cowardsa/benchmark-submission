...
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:319:25: 319:31 (#0)")
...
(declare-const low_bits@ (_ BitVec 64))
...
(assert (= low_bits@ (let ((tmp$$$$bitvectmp0 (bvmul ((_ zero_extend 23) (_ bv512 10)) ((_ zero_extend 10) (bvmul ((_ zero_extend 13) (_ bv512 10)) ((_ zero_extend 10) (_ bv4096 13))))))) (ite (= tmp$$$$bitvectmp0 (_ bv0 33)) tmp$$$$bitvectmp1 (bvurem addr$1@ ((_ zero_extend 31) tmp$$$$bitvectmp0))))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvor (bvor (bvshl l0_idx_u64@ ((_ zero_extend 58) (_ bv39 6))) (bvshl l1_idx_u64@ ((_ zero_extend 59) (_ bv30 5)))) low_bits@) (bvadd (bvadd (bvmul l0_idx_u64@ ((_ zero_extend 21) (bvmul ((_ zero_extend 33) (_ bv512 10)) ((_ zero_extend 10) (bvmul ((_ zero_extend 23) (_ bv512 10)) ((_ zero_extend 10) (bvmul ((_ zero_extend 13) (_ bv512 10)) ((_ zero_extend 10) (_ bv4096 13))))))))) (bvmul l1_idx_u64@ ((_ zero_extend 31) (bvmul ((_ zero_extend 23) (_ bv512 10)) ((_ zero_extend 10) (bvmul ((_ zero_extend 13) (_ bv512 10)) ((_ zero_extend 10) (_ bv4096 13)))))))) low_bits@)))))
(check-sat)
(exit)
