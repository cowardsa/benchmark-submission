...
(set-info :comment ";; commit_mask.rs:128:5: 128:11 (#0)")
...
(assert (and (bvult b@ ((_ zero_extend 57) (_ bv64 7))) (= (bvand (bvnot a@) (bvshl ((_ zero_extend 63) (_ bv1 1)) b@)) (bvshl ((_ zero_extend 63) (_ bv1 1)) b@))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (not (= (bvand a@ (bvshl ((_ zero_extend 63) (_ bv1 1)) b@)) (bvshl ((_ zero_extend 63) (_ bv1 1)) b@))))))
(check-sat)
(exit)
