...
(set-info :comment ";; page-table/impl_u/l2_impl.rs:202:9: 202:15 (#0)")
...
(set-info :comment ";; page-table/impl_u/l2_impl.rs:202:9: 202:15 (#0)")
(declare-const address! (_ BitVec 64))
(declare-const mw@ (_ BitVec 64))
(assert (= (bvand address! (bvshl (bvnot (bvshl (bvnot ((_ zero_extend 63) (_ bv0 1))) (bvsub (bvadd (bvsub mw@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 60) (_ bv12 4))))) ((_ zero_extend 60) (_ bv12 4)))) address!))
(assert (and (bvule ((_ zero_extend 58) (_ bv32 6)) mw@) (bvule mw@ ((_ zero_extend 58) (_ bv52 6)))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand address! (bvshl (bvnot (bvshl (bvnot ((_ zero_extend 63) (_ bv0 1))) (bvsub ((_ zero_extend 57) (bvadd ((_ zero_extend 1) (_ bv51 6)) ((_ zero_extend 6) (_ bv1 1)))) mw@))) mw@)) ((_ zero_extend 63) (_ bv0 1))))))
(check-sat)
(exit)
