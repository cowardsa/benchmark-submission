...
(set-info :comment ";; commit_mask.rs:91:5: 91:11 (#0)")
...
(assert (not (=> %%location_label%%0 (= (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 63) (_ bv0 1))) ((_ zero_extend 63) (_ bv1 1))))))
(check-sat)
(exit)
