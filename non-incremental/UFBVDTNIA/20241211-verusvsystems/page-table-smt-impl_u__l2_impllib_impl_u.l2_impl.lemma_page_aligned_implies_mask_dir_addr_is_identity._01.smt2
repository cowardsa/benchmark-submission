...
(set-info :comment ";; page-table/impl_u/l2_impl.rs:39:9: 39:15 (#0)")
...
(declare-const mask_dir_addr@ (_ BitVec 64))
(assert (bvule addr@ (bvsub (bvshl ((_ zero_extend 63) (_ bv1 1)) max_width@) ((_ zero_extend 63) (_ bv1 1)))))
(assert (= (let ((tmp$$$$bitvectmp0 (_ bv4096 13))) (ite (= tmp$$$$bitvectmp0 (_ bv0 13)) tmp$$$$bitvectmp1 (bvurem addr@ ((_ zero_extend 51) tmp$$$$bitvectmp0)))) ((_ zero_extend 63) (_ bv0 1))))
(assert (= mask_dir_addr@ (bvshl (bvnot (bvshl (bvnot ((_ zero_extend 63) (_ bv0 1))) (bvsub (bvadd (bvsub max_width@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 60) (_ bv12 4))))) ((_ zero_extend 60) (_ bv12 4)))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand addr@ mask_dir_addr@) addr@))))
(check-sat)
(exit)
