...
(set-info :comment ";; page-table/impl_u/l2_impl.rs:317:17: 317:23 (#0)")
...
(assert (= (bvand address! (bvshl (bvnot (bvshl (bvnot ((_ zero_extend 63) (_ bv0 1))) (bvsub (bvadd (bvsub mw@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 59) (_ bv21 5))))) ((_ zero_extend 59) (_ bv21 5)))) address!))
