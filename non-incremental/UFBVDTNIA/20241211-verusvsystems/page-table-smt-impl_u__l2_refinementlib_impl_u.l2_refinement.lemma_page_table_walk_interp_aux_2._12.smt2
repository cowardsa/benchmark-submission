...
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:500:25: 500:31 (#0)")
...
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:500:25: 500:31 (#0)")
(declare-const low_bits$3@ (_ BitVec 64))
(declare-const addr$1@ (_ BitVec 64))
(declare-const tmp$$$$bitvectmp1 (_ BitVec 64))
(declare-const l0_idx_u64@ (_ BitVec 64))
(assert (= low_bits$3@ (let ((tmp$$$$bitvectmp0 (bvmul ((_ zero_extend 33) (_ bv512 10)) ((_ zero_extend 10) (bvmul ((_ zero_extend 23) (_ bv512 10)) ((_ zero_extend 10) (bvmul ((_ zero_extend 13) (_ bv512 10)) ((_ zero_extend 10) (_ bv4096 13))))))))) (ite (= tmp$$$$bitvectmp0 (_ bv0 43)) tmp$$$$bitvectmp1 (bvurem addr$1@ ((_ zero_extend 21) tmp$$$$bitvectmp0))))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvor (bvshl l0_idx_u64@ ((_ zero_extend 58) (_ bv39 6))) low_bits$3@) (bvadd (bvmul l0_idx_u64@ ((_ zero_extend 21) (bvmul ((_ zero_extend 33) (_ bv512 10)) ((_ zero_extend 10) (bvmul ((_ zero_extend 23) (_ bv512 10)) ((_ zero_extend 10) (bvmul ((_ zero_extend 13) (_ bv512 10)) ((_ zero_extend 10) (_ bv4096 13))))))))) low_bits$3@)))))
(check-sat)
(exit)
