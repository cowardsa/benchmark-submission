...
(set-info :comment ";; commit_mask.rs:95:9: 95:15 (#0)")
...
(assert (not (and (not (= (bvand a! ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1)))) (= (bvand b! ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1 1))))))
(assert (not (= (bvand a! b!) b!)))
(assert (= (bvlshr a! hi!) ((_ zero_extend 63) (_ bv0 1))))
(assert (= (bvlshr b! hi!) ((_ zero_extend 63) (_ bv0 1))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (and (and (not (= (bvand (bvlshr a! ((_ zero_extend 63) (_ bv1 1))) (bvlshr b! ((_ zero_extend 63) (_ bv1 1)))) (bvlshr b! ((_ zero_extend 63) (_ bv1 1))))) (= (bvlshr (bvlshr a! ((_ zero_extend 63) (_ bv1 1))) (bvsub hi! ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 63) (_ bv0 1)))) (= (bvlshr (bvlshr b! ((_ zero_extend 63) (_ bv1 1))) (bvsub hi! ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 63) (_ bv0 1)))))))
(check-sat)
(exit)
