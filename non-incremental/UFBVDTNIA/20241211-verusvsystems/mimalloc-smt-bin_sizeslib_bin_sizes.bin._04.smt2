...
(set-info :comment ";; bin_sizes.rs:1160:9: 1160:15 (#0)")
...
(set-info :comment ";; bin_sizes.rs:1160:9: 1160:15 (#0)")
(declare-const shifted@ (_ BitVec 8))
(assert true)
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (bvult (bvand shifted@ ((_ zero_extend 6) (_ bv3 2))) ((_ zero_extend 5) (_ bv4 3))))))
(check-sat)
(exit)
