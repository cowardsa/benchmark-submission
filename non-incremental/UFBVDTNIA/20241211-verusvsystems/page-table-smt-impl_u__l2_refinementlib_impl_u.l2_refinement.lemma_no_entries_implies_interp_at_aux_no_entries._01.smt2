...
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:542:13: 542:19 (#0)")
...
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:542:13: 542:19 (#0)")
(declare-const entry$1@ (_ BitVec 64))
(assert (= entry$1@ ((_ zero_extend 63) (_ bv0 1))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (not (= (bvand entry$1@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 63) (_ bv0 1)))) (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 63) (_ bv0 1))))))))
(check-sat)
(exit)
