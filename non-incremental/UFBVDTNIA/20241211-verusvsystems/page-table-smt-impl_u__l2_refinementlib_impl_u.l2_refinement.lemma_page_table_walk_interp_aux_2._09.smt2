...
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:377:33: 377:39 (#0)")
...
(declare-const low_bits$1@ (_ BitVec 64))
...
(assert (= low_bits$1@ (let ((tmp$$$$bitvectmp0 (bvmul ((_ zero_extend 13) (_ bv512 10)) ((_ zero_extend 10) (_ bv4096 13))))) (ite (= tmp$$$$bitvectmp0 (_ bv0 23)) tmp$$$$bitvectmp1 (bvurem addr$1@ ((_ zero_extend 41) tmp$$$$bitvectmp0))))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= addr$1@ (bvor (bvor (bvor (bvshl l0_idx_u64@ ((_ zero_extend 58) (_ bv39 6))) (bvshl l1_idx_u64@ ((_ zero_extend 59) (_ bv30 5)))) (bvshl l2_idx_u64@ ((_ zero_extend 59) (_ bv21 5)))) low_bits$1@)))))
(check-sat)
(exit)
