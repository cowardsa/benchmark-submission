...
(set-info :comment ";; commit_mask.rs:124:5: 124:11 (#0)")
...
(assert (not (= a! (bvnot ((_ zero_extend 63) (_ bv0 1))))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (not (= (bvnot a!) ((_ zero_extend 63) (_ bv0 1)))))))
(check-sat)
(exit)
