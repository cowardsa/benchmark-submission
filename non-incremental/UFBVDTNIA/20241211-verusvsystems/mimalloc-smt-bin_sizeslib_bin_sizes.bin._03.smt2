...
(set-info :comment ";; bin_sizes.rs:1155:9: 1155:15 (#0)")
...
(declare-const lz@ (_ BitVec 32))
(assert (and (and (bvule ((_ zero_extend 60) (_ bv8 4)) w@) (bvult w@ ((_ zero_extend 46) (_ bv131073 18)))) (and (bvule ((_ zero_extend 26) (_ bv46 6)) lz@) (bvule lz@ ((_ zero_extend 26) (_ bv60 6))))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (bvult (bvand (bvlshr w@ (bvsub ((_ sign_extend 31) (bvsub ((_ zero_extend 27) (_ bv63 6)) ((_ zero_extend 1) lz@))) ((_ zero_extend 62) (_ bv2 2)))) ((_ zero_extend 62) (_ bv3 2))) ((_ zero_extend 61) (_ bv4 3))))))
(check-sat)
(exit)
