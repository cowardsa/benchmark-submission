...
(set-info :comment ";; flags.rs:133:13: 133:19 (#0)")
...
(assert (not (=> %%location_label%%0 (=> (or (= y@ ((_ zero_extend 7) (_ bv1 1))) (= y@ ((_ zero_extend 7) (_ bv0 1)))) (= (bvand (bvor (bvand x@ (bvnot ((_ zero_extend 7) (_ bv1 1)))) y@) ((_ zero_extend 5) (_ bv4 3))) (bvand x@ ((_ zero_extend 5) (_ bv4 3))))))))
(check-sat)
(exit)
