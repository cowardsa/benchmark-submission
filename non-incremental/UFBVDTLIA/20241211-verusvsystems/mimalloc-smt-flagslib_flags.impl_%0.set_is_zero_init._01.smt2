...
(set-info :comment ";; flags.rs:167:13: 167:19 (#0)")
...
(assert (not (=> %%location_label%%0 (=> (or (= y@ ((_ zero_extend 7) (_ bv1 1))) (= y@ ((_ zero_extend 7) (_ bv0 1)))) (= (bvand (bvor (bvand x@ (bvnot ((_ zero_extend 5) (_ bv4 3)))) (bvshl y@ ((_ zero_extend 6) (_ bv2 2)))) ((_ zero_extend 7) (_ bv1 1))) (bvand x@ ((_ zero_extend 7) (_ bv1 1))))))))
(check-sat)
(exit)
