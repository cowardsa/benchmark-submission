...
(set-info :comment ";; flags.rs:115:13: 115:19 (#0)")
...
(assert (bvule u! ((_ zero_extend 1) (_ bv127 7))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvlshr (bvor (bvand x@ ((_ zero_extend 7) (_ bv1 1))) (bvshl u! ((_ zero_extend 7) (_ bv1 1)))) ((_ zero_extend 7) (_ bv1 1))) u!))))
(check-sat)
(exit)
