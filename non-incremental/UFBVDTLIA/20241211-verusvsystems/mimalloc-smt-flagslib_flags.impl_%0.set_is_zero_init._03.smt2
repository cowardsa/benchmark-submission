...
(set-info :comment ";; flags.rs:169:13: 169:19 (#0)")
...
(set-info :comment ";; Function-Specs lib::types::PageInner::set_is_committed")
...
(set-info :comment ";; Function-Specs lib::types::PageInner::set_is_zero_init")
...
(set-info :comment ";; Function-Def lib::types::PageInner::set_is_zero_init")
(set-info :comment ";; flags.rs:169:13: 169:19 (#0)")
...
(assert (not (=> %%location_label%%0 (=> (or (= y@ ((_ zero_extend 7) (_ bv1 1))) (= y@ ((_ zero_extend 7) (_ bv0 1)))) (= (= (bvand (bvor (bvand x@ (bvnot ((_ zero_extend 5) (_ bv4 3)))) (bvshl y@ ((_ zero_extend 6) (_ bv2 2)))) ((_ zero_extend 5) (_ bv4 3))) ((_ zero_extend 7) (_ bv0 1))) (= y@ ((_ zero_extend 7) (_ bv0 1))))))))
(check-sat)
(exit)
