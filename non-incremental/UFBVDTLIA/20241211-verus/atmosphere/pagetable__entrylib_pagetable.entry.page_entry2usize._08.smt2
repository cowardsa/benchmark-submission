...
(set-info :comment ";; pagetable/entry.rs:275:9: 275:15 (#0)")
...
(assert (not (=> %%location_label%%0 (= (not (= (bvand (bvor ret@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 61) (_ bv7 3)))) ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv0 1)))) ghost_present@))))
(check-sat)
(exit)
