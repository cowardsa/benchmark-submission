...
(declare-const ghost_addr@ (_ BitVec 64))
(assert (and (= ghost_ret@ ret@) (= (bvand ghost_ret@ ((_ zero_extend 16) (_ bv281474976706560 48))) ghost_addr@)))
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand (bvor ret@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 16) (_ bv281474976706560 48))) ghost_addr@))))
(check-sat)
(exit)
