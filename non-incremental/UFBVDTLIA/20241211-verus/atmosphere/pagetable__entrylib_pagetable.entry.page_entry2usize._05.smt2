...
(set-info :comment ";; pagetable/entry.rs:259:9: 259:15 (#0)")
...
(assert (= (bvand ret@ (bvnot ((_ zero_extend 16) (_ bv281474976706560 48)))) ((_ zero_extend 63) (_ bv0 1))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand ret@ ((_ zero_extend 16) (_ bv281474976706560 48))) ret@))))
(check-sat)
(exit)
