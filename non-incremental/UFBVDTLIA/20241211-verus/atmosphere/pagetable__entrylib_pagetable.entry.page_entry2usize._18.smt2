...
(set-info :comment ";; pagetable/entry.rs:340:9: 340:15 (#0)")
...
(assert (not (=> %%location_label%%0 (= (bvand ret@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 63) (_ bv0 1))))))
(check-sat)
(exit)
