...
(set-info :comment ";; pagetable/entry.rs:365:9: 365:15 (#0)")
...
(assert (and (= ghost_ret@ ret@) (= (not (= (bvand ret@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 61) (_ bv7 3)))) ((_ zero_extend 63) (_ bv0 1)))) ghost_ps@)))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (not (= (bvand (bvor ret@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 58) (_ bv63 6)))) (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 61) (_ bv7 3)))) ((_ zero_extend 63) (_ bv0 1)))) ghost_ps@))))
(check-sat)
(exit)
