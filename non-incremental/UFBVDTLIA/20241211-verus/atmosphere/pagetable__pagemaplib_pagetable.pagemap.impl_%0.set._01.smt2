...
(set-info :comment ";; pagetable/pagemap.rs:118:13: 118:19 (#0)")
...
(assert (= (not (= (bvand u@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv0 1)))) true))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (not (= u@ ((_ zero_extend 63) (_ bv0 1)))))))
(check-sat)
(exit)
