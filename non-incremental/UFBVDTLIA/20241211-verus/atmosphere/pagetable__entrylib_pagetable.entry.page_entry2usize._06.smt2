...
(assert (= (bvand ghost_addr@ (bvnot ((_ zero_extend 16) (_ bv281474976706560 48)))) ((_ zero_extend 63) (_ bv0 1))))
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand ghost_addr@ (bvnot ((_ zero_extend 16) (bvor ((_ zero_extend 47) (_ bv1 1)) (_ bv281474976706560 48))))) ((_ zero_extend 63) (_ bv0 1))))))
(check-sat)
(exit)
