...
(set-info :comment ";; flags.rs:185:13: 185:19 (#0)")
...
(set-info :comment ";; Function-Def lib::types::PageInner::set_in_full")
(set-info :comment ";; flags.rs:185:13: 185:19 (#0)")
...
(assert (not (=> %%location_label%%0 (=> (or (= y@ ((_ zero_extend 7) (_ bv1 1))) (= y@ ((_ zero_extend 7) (_ bv0 1)))) (= (bvand (bvor (bvand x@ (bvnot ((_ zero_extend 7) (_ bv1 1)))) y@) ((_ zero_extend 7) (_ bv1 1))) y@)))))
(check-sat)
(exit)
