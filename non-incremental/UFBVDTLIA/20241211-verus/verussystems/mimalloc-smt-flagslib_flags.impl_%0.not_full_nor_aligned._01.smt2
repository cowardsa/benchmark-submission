...
(set-info :comment ";; flags.rs:97:13: 97:19 (#0)")
...
(assert (not (=> %%location_label%%0 (=> (= x@ ((_ zero_extend 7) (_ bv0 1))) (and (= (bvand x@ ((_ zero_extend 7) (_ bv1 1))) ((_ zero_extend 7) (_ bv0 1))) (= (bvand x@ ((_ zero_extend 6) (_ bv2 2))) ((_ zero_extend 7) (_ bv0 1))))))))
(check-sat)
(exit)
