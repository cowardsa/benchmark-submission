...
(set-info :comment ";; pagetable/entry.rs:240:9: 240:15 (#0)")
...
(assert (and (= (bvand ghost_addr@ (bvnot ((_ zero_extend 16) (_ bv281474976706560 48)))) ((_ zero_extend 63) (_ bv0 1))) (= ghost_addr@ ret@)))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand (bvor ret@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 16) (_ bv281474976706560 48))) ghost_addr@))))
(check-sat)
(exit)
