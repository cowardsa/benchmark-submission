...
(set-info :comment ";; pagetable/entry.rs:425:9: 425:15 (#0)")
...
(assert (and (= ghost_ret@ ret@) (= (not (= (bvand ret@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 58) (_ bv63 6)))) ((_ zero_extend 63) (_ bv0 1)))) ghost_execute_disable@)))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (not (= (bvand (bvor ret@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 62) (_ bv2 2)))) (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 58) (_ bv63 6)))) ((_ zero_extend 63) (_ bv0 1)))) ghost_execute_disable@))))
(check-sat)
(exit)
