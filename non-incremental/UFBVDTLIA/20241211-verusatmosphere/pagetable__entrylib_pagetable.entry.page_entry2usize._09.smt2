...
(set-info :comment ";; pagetable/entry.rs:278:9: 278:15 (#0)")
...
(assert (not (=> %%location_label%%0 (= (bvand (bvor ret@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 61) (_ bv7 3)))) ((_ zero_extend 16) (_ bv281474976706560 48))) ghost_addr@))))
(check-sat)
(exit)
