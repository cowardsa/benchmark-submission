...
(set-info :comment ";; pagetable/entry.rs:392:9: 392:15 (#0)")
...
(assert (= (bvand ret@ (bvnot (bvor (bvor (bvor ((_ zero_extend 63) (_ bv1 1)) (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 61) (_ bv7 3)))) (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 63) (_ bv1 1)))) ((_ zero_extend 16) (_ bv281474976706560 48))))) ((_ zero_extend 63) (_ bv0 1))))
(set-info :comment ";; bitvector assertion not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (bvand ret@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 58) (_ bv63 6)))) ((_ zero_extend 63) (_ bv0 1))))))
(check-sat)
(exit)
