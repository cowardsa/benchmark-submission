...
(set-info :comment ";; pagetable/entry.rs:192:5: 192:11 (#0)")
...
(assert (not (=> %%location_label%%0 (= (bvand ((_ zero_extend 47) (_ bv0 1)) (_ bv281474976706560 48)) ((_ zero_extend 47) (_ bv0 1))))))
(check-sat)
(exit)
