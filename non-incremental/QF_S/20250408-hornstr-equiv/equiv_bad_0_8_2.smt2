...
(let ((a!2 (re.++ (re.* a!1) (re.union (str.to_re "") (re.++ a!1 (re.* a!1)))))
      ...
      (a!8 (re.union (re.union (re.union a!7 (str.to_re "b")) (str.to_re "g"))
                     (str.to_re "a"))))
(let ((a!5 (re.union (re.union (re.union a!4 (str.to_re "c")) (str.to_re "i"))
                     (str.to_re "k"))))
(let ((a!6 (re.union a!5 (re.++ a!1 (re.++ (re.* a!1) a!5)))))
(let ((a!10 (re.union (re.union (re.union a!8 (str.to_re "c")) (str.to_re "f"))
                      (re.++ (re.union a!9 (str.to_re "k"))
                             (re.++ (re.* a!1) a!6)))))
(let ((a!11 (re.++ (re.* a!10) (re.++ (re.union a!9 (str.to_re "k")) a!2))))
(let ((a!12 (re.union (re.++ (re.union a!9 (str.to_re "k")) a!2)
                      (re.++ a!10 a!11))))
(let ((a!13 (re.union a!2
                      (re.++ (re.++ (re.* a!1) a!6) (re.++ (re.* a!10) a!12)))))
