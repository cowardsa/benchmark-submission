...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "0") (str.to_re "B"))
                               (str.to_re "1"))
                     (str.to_re "E")))
      (a!5 (re.union (re.union (re.union (str.to_re "1") (str.to_re "E"))
                               (str.to_re "W"))
                     (str.to_re "O")))
      (a!9 (re.union (re.union (re.union (str.to_re "0") (str.to_re "B"))
                               (str.to_re "E"))
                     (str.to_re "W"))))
(let ((a!2 (re.++ (re.* (re.union a!1 (str.to_re "W"))) (str.to_re "O"))))
(let ((a!3 (re.union (str.to_re "O") (re.++ (re.union a!1 (str.to_re "W")) a!2))))
(let ((a!4 (re.++ (re.* (re.union a!1 (str.to_re "W"))) a!3)))
...
(let ((a!10 (re.++ (re.++ (re.union a!9 (str.to_re "O")) a!4) a!8)))
