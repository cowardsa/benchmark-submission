...
(let ((a!2 (re.++ a!1
                  (re.union (re.union (str.to_re "B") (str.to_re "D"))
                            (str.to_re "C")))))
(let ((a!3 (re.++ (re.union (re.union (str.to_re "F") (str.to_re "E"))
                            (str.to_re "A"))
                  a!2)))
(let ((a!4 (re.union (re.union (re.union (str.to_re "B") (str.to_re "D"))
                               (str.to_re "C"))
                     a!3)))
(let ((a!5 (re.++ (re.union (re.union (str.to_re "F") (str.to_re "C"))
                            (str.to_re "A"))
                  (re.++ a!1 a!4))))
