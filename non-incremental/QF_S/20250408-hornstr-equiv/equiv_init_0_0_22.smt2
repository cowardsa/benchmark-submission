...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "k") (str.to_re "0"))
                               (str.to_re "f"))
                     (str.to_re "h")))
      (a!6 (re.union (re.union (re.union (str.to_re "g") (str.to_re "e"))
                               (str.to_re "d"))
                     (str.to_re "b")))
      (a!7 (re.union (re.union (re.union (str.to_re "1") (str.to_re "k"))
                               (str.to_re "0"))
                     (str.to_re "f"))))
(let ((a!2 (re.union (re.union (re.union a!1 (str.to_re "c")) (str.to_re "i"))
                     (str.to_re "g")))
      (a!8 (re.union (re.union (re.union a!7 (str.to_re "h")) (str.to_re "c"))
                     (str.to_re "i"))))
(let ((a!3 (re.union (re.union (re.union a!2 (str.to_re "e")) (str.to_re "l"))
                     (str.to_re "j")))
      (a!9 (re.union (re.union (re.union a!8 (str.to_re "l")) (str.to_re "j"))
                     (str.to_re "a"))))
(let ((a!4 (re.union (re.union (re.union a!3 (str.to_re "a")) (str.to_re "d"))
                     (str.to_re "b"))))
(let ((a!5 (re.union (str.to_re "1")
                     (re.++ a!4 (re.++ (re.* a!4) (str.to_re "1"))))))
(let ((a!10 (re.union a!6 (re.++ a!9 (re.++ (re.* a!4) a!5)))))
(let ((a!11 (re.++ (re.* a!10)
                   (re.union (str.to_re "") (re.++ a!10 (re.* a!10))))))
  (str.in_re varout (re.++ (re.++ (re.* a!4) a!5) a!11))))))))))
(check-sat)
(exit)
