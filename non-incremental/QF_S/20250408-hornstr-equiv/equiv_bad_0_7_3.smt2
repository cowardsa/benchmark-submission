...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "d") (str.to_re "h"))
      ...
      (a!11 (re.union (re.union (re.union (str.to_re "l") (str.to_re "1"))
                                (str.to_re "j"))
                      (str.to_re "i"))))
(let ((a!2 (re.++ (re.union a!1 (str.to_re "f"))
                  (re.* (re.union a!1 (str.to_re "f")))))
      (a!5 (re.union (re.union (re.union a!4 (str.to_re "a")) (str.to_re "1"))
                     (str.to_re "j")))
      (a!10 (re.union (re.union (re.union a!9 (str.to_re "b")) (str.to_re "g"))
                      (str.to_re "a"))))
(let ((a!3 (re.++ (re.* (re.union a!1 (str.to_re "f")))
                  (re.union (str.to_re "") a!2)))
      (a!6 (re.++ (re.* (re.union a!1 (str.to_re "f")))
                  (re.union (re.union a!5 (str.to_re "i")) (str.to_re "k")))))
(let ((a!7 (re.union (re.union (re.union a!5 (str.to_re "i")) (str.to_re "k"))
                     (re.++ (re.union a!1 (str.to_re "f")) a!6))))
(let ((a!8 (re.++ (re.* (re.union a!1 (str.to_re "f"))) a!7)))
(let ((a!12 (re.union (re.union (re.union a!10 (str.to_re "c")) (str.to_re "f"))
                      (re.++ (re.union a!11 (str.to_re "k")) a!8))))
(let ((a!13 (re.++ (re.* a!12) (re.++ (re.union a!11 (str.to_re "k")) a!3))))
(let ((a!14 (re.union (re.++ (re.union a!11 (str.to_re "k")) a!3)
                      (re.++ a!12 a!13))))
