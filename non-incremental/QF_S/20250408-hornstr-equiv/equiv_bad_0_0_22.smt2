...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "k") (str.to_re "0"))
                               (str.to_re "f"))
                     (str.to_re "h")))
      (a!7 (re.union (re.union (re.union (str.to_re "g") (str.to_re "e"))
                               (str.to_re "d"))
                     (str.to_re "b")))
      (a!8 (re.union (re.union (re.union (str.to_re "1") (str.to_re "k"))
                               (str.to_re "0"))
                     (str.to_re "f"))))
(let ((a!2 (re.union (re.union (re.union a!1 (str.to_re "c")) (str.to_re "i"))
                     (str.to_re "g")))
      (a!9 (re.union (re.union (re.union a!8 (str.to_re "h")) (str.to_re "c"))
                     (str.to_re "i"))))
(let ((a!3 (re.union (re.union (re.union a!2 (str.to_re "e")) (str.to_re "l"))
                     (str.to_re "j")))
      (a!10 (re.union (re.union (re.union a!9 (str.to_re "l")) (str.to_re "j"))
                      (str.to_re "a"))))
(let ((a!4 (re.union (re.union (re.union a!3 (str.to_re "a")) (str.to_re "d"))
                     (str.to_re "b"))))
(let ((a!5 (re.++ (re.* a!4) (re.union (str.to_re "") (re.++ a!4 (re.* a!4)))))
      (a!6 (re.union (str.to_re "1")
                     (re.++ a!4 (re.++ (re.* a!4) (str.to_re "1"))))))
(let ((a!11 (re.union a!7 (re.++ a!10 (re.++ (re.* a!4) a!6)))))
(let ((a!12 (re.union (re.++ a!10 a!5)
                      (re.++ a!11 (re.++ (re.* a!11) (re.++ a!10 a!5))))))
(let ((a!13 (re.union a!5
                      (re.++ (re.++ (re.* a!4) a!6) (re.++ (re.* a!11) a!12)))))
