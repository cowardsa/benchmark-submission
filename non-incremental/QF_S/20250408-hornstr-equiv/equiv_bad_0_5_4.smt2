...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "d") (str.to_re "h"))
                               (str.to_re "0"))
                     (str.to_re "a")))
      (a!4 (re.union (re.union (re.union (str.to_re "l") (str.to_re "e"))
                               (str.to_re "b"))
                     (str.to_re "g")))
      (a!8 (re.union (re.union (re.union (str.to_re "d") (str.to_re "h"))
                               (str.to_re "0"))
                     (str.to_re "b")))
      (a!10 (re.union (re.union (re.union (str.to_re "l") (str.to_re "e"))
                                (str.to_re "1"))
                      (str.to_re "j"))))
(let ((a!2 (re.* (re.union (re.union a!1 (str.to_re "c")) (str.to_re "f"))))
      (a!5 (re.union (re.union (re.union a!4 (str.to_re "1")) (str.to_re "j"))
                     (str.to_re "i")))
      (a!9 (re.union (re.union (re.union a!8 (str.to_re "g")) (str.to_re "a"))
                     (str.to_re "c"))))
(let ((a!3 (re.++ (re.union (re.union a!1 (str.to_re "c")) (str.to_re "f")) a!2))
      (a!6 (re.++ (re.union (re.union a!1 (str.to_re "c")) (str.to_re "f"))
                  (re.++ a!2 (re.union a!5 (str.to_re "k"))))))
(let ((a!7 (re.++ a!2 (re.union (re.union a!5 (str.to_re "k")) a!6)))
      (a!13 (re.++ (re.union (re.union a!10 (str.to_re "i")) (str.to_re "k"))
                   (re.++ a!2 (re.union (str.to_re "") a!3)))))
(let ((a!11 (re.++ (re.union (re.union a!10 (str.to_re "i")) (str.to_re "k"))
                   a!7)))
(let ((a!12 (re.* (re.union (re.union a!9 (str.to_re "f")) a!11))))
(let ((a!14 (re.++ (re.union (re.union a!9 (str.to_re "f")) a!11)
                   (re.++ a!12 a!13))))
