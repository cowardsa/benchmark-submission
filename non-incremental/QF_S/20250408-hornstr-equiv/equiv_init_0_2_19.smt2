...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "0") (str.to_re "B"))
      ...
      (a!12 (re.union (re.union (re.union (str.to_re "1") (str.to_re "E"))
                                (str.to_re "W"))
                      (str.to_re "O")))
      (a!18 (re.union (re.union (re.union (str.to_re "0") (str.to_re "B"))
                                (str.to_re "E"))
                      (str.to_re "W"))))
...
(let ((a!6 (re.++ (re.++ (re.* a!1) a!2)
      ...
      (a!15 (re.++ (re.++ a!12 (re.++ (re.* a!1) a!2))
                   (re.++ a!4 (re.union (str.to_re "W") a!5))))
      (a!19 (re.++ (re.++ (re.union a!18 (str.to_re "O"))
                          (re.++ (re.* a!1) a!2))
                   (re.++ a!4 (re.union (str.to_re "W") a!5)))))
