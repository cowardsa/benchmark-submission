...
(let ((a!12 (re.union (re.union (re.union a!10 (str.to_re "k")) (str.to_re "1"))
                      (re.++ (re.union a!11 (str.to_re "h")) a!8))))
(let ((a!13 (re.++ (re.* a!12) (re.++ (re.union a!11 (str.to_re "h")) a!3))))
(let ((a!14 (re.union (re.++ (re.union a!11 (str.to_re "h")) a!3)
                      (re.++ a!12 a!13))))
(let ((a!15 (re.union a!3 (re.++ a!8 (re.++ (re.* a!12) a!14)))))
