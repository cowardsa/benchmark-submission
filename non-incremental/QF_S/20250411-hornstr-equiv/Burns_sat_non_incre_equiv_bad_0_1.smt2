...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "1") (str.to_re "7"))
      ...
      (a!8 (re.union (re.union (re.union (str.to_re "5") (str.to_re "7"))
                               (str.to_re "8"))
                     (str.to_re "3"))))
(let ((a!2 (re.union (re.union (re.union a!1 (str.to_re "c")) (str.to_re "4"))
                     (str.to_re "b")))
      (a!9 (re.union (re.union (re.union a!8 (str.to_re "9")) (str.to_re "c"))
                     (str.to_re "4"))))
(let ((a!3 (re.++ (re.* a!2) (re.union (str.to_re "") (re.++ a!2 (re.* a!2)))))
      (a!5 (re.++ a!2 (re.++ (re.* a!2) (re.union a!4 (str.to_re "2"))))))
(let ((a!6 (re.++ (re.* a!2) (re.union (re.union a!4 (str.to_re "2")) a!5))))
(let ((a!10 (re.union a!7 (re.++ (re.union a!9 (str.to_re "b")) a!6))))
(let ((a!11 (re.++ (re.* a!10) (re.++ (re.union a!9 (str.to_re "b")) a!3))))
(let ((a!12 (re.union (re.++ (re.union a!9 (str.to_re "b")) a!3)
                      (re.++ a!10 a!11))))
(let ((a!13 (re.union a!3 (re.++ a!6 (re.++ (re.* a!10) a!12)))))
