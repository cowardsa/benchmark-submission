...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "1") (str.to_re "7"))
                               (str.to_re "8"))
                     (str.to_re "3")))
      (a!2 (re.union (re.union (re.union (str.to_re "5") (str.to_re "6"))
                               (str.to_re "a"))
                     (str.to_re "9")))
      (a!7 (re.union (re.union (re.union (str.to_re "1") (str.to_re "5"))
                               (str.to_re "6"))
                     (str.to_re "3")))
      (a!9 (re.union (re.union (re.union (str.to_re "7") (str.to_re "8"))
                               (str.to_re "9"))
                     (str.to_re "b"))))
(let ((a!3 (re.union (re.union (re.union a!2 (str.to_re "2")) (str.to_re "c"))
                     (str.to_re "b")))
      (a!8 (re.union (re.union (re.union a!7 (str.to_re "a")) (str.to_re "2"))
                     (str.to_re "c"))))
(let ((a!4 (re.++ (re.* (re.union a!1 (str.to_re "4"))) a!3)))
(let ((a!5 (re.union a!3 (re.++ (re.union a!1 (str.to_re "4")) a!4))))
(let ((a!6 (re.++ (re.* (re.union a!1 (str.to_re "4"))) a!5)))
(let ((a!10 (re.* (re.union (re.union a!8 (str.to_re "4")) (re.++ a!9 a!6)))))
(let ((a!11 (re.++ (re.union (re.union a!8 (str.to_re "4")) (re.++ a!9 a!6))
                   a!10)))
(let ((a!12 (re.++ a!6 (re.++ a!10 (re.union (str.to_re "") a!11)))))
