...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "i") (str.to_re "j"))
                               (str.to_re "c"))
                     (str.to_re "0")))
      (a!2 (re.union (re.union (re.union (str.to_re "a") (str.to_re "e"))
                               (str.to_re "f"))
                     (str.to_re "b")))
      (a!7 (re.union (re.union (re.union (str.to_re "i") (str.to_re "a"))
                               (str.to_re "f"))
                     (str.to_re "c")))
      (a!8 (re.union (re.union (re.union (str.to_re "e") (str.to_re "j"))
                               (str.to_re "b"))
                     (str.to_re "g"))))
(let ((a!3 (re.union (re.union (re.union a!2 (str.to_re "g")) (str.to_re "l"))
                     (str.to_re "h")))
      (a!9 (re.union (re.union (re.union a!8 (str.to_re "l")) (str.to_re "h"))
                     (str.to_re "k"))))
(let ((a!4 (re.++ (re.* (re.union a!1 (str.to_re "1")))
                  (re.union (re.union a!3 (str.to_re "d")) (str.to_re "k")))))
(let ((a!5 (re.union (re.union (re.union a!3 (str.to_re "d")) (str.to_re "k"))
                     (re.++ (re.union a!1 (str.to_re "1")) a!4))))
(let ((a!6 (re.++ (re.* (re.union a!1 (str.to_re "1"))) a!5)))
(let ((a!10 (re.union (re.union (re.union a!7 (str.to_re "0")) (str.to_re "d"))
                      (re.++ (re.union a!9 (str.to_re "1")) a!6))))
(let ((a!11 (re.++ (re.* a!10)
