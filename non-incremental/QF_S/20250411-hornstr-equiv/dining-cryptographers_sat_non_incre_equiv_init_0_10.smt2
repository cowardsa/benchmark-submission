...
(let ((a!2 (re.* (re.union (re.union a!1 (str.to_re "h")) (str.to_re "d"))))
      (a!5 (re.union (re.union (re.union a!4 (str.to_re "0")) (str.to_re "l"))
                     (str.to_re "k")))
      (a!9 (re.union (re.union (re.union a!8 (str.to_re "0")) (str.to_re "l"))
                     (str.to_re "d"))))
...
(let ((a!7 (re.++ a!2 (re.union (re.union a!5 (str.to_re "1")) a!6)))
      (a!12 (re.++ (re.union a!10 (str.to_re "h"))
                   (re.++ a!2 (re.union (str.to_re "") a!3)))))
(let ((a!11 (re.union (re.union (re.union a!9 (str.to_re "k")) (str.to_re "1"))
                      (re.++ (re.union a!10 (str.to_re "h")) a!7))))
