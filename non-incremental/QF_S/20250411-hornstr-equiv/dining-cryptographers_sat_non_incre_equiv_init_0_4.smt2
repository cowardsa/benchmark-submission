...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "e") (str.to_re "g"))
      ...
      (a!7 (re.union (re.union (re.union (str.to_re "i") (str.to_re "a"))
                               (str.to_re "e"))
                     (str.to_re "j"))))
(let ((a!2 (re.union (re.union (re.union a!1 (str.to_re "h")) (str.to_re "d"))
                     (str.to_re "1")))
      (a!5 (re.union (re.union (re.union a!4 (str.to_re "b")) (str.to_re "l"))
                     (str.to_re "k")))
      (a!8 (re.union (re.union (re.union a!7 (str.to_re "f")) (str.to_re "b"))
                     (str.to_re "g"))))
(let ((a!3 (re.++ (re.* a!2) (re.union (str.to_re "") (re.++ a!2 (re.* a!2)))))
      ...
      (a!9 (re.union (re.union (re.union a!8 (str.to_re "c")) (str.to_re "l"))
                     (str.to_re "h"))))
(let ((a!10 (re.union (re.union (re.union (str.to_re "0") (str.to_re "k"))
                                (str.to_re "1"))
                      (re.++ (re.union a!9 (str.to_re "d"))
                             (re.++ (re.* a!2) a!6)))))
(let ((a!11 (re.++ (re.* a!10) (re.++ (re.union a!9 (str.to_re "d")) a!3))))
(let ((a!12 (re.union (re.++ (re.union a!9 (str.to_re "d")) a!3)
                      (re.++ a!10 a!11))))
