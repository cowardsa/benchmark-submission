...
(let ((a!25 (re.union a!14
                      (re.++ (re.union (re.union a!18 a!22) (re.++ a!13 a!4))
                             a!24))))
  (and (str.in_re X a!25) (not isin) (= X varout) isout))))))))))
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "e") (str.to_re "g"))
      ...
      (a!4 (re.union (re.union (re.union (str.to_re "i") (str.to_re "a"))
                               (str.to_re "j"))
                     (str.to_re "f")))
      (a!8 (re.union (re.union (re.union (str.to_re "i") (str.to_re "a"))
                               (str.to_re "j"))
                     (str.to_re "0")))
      (a!10 (re.union (re.union (re.union (str.to_re "e") (str.to_re "f"))
                                (str.to_re "b"))
                      (str.to_re "g"))))
(let ((a!2 (re.* (re.union (re.union a!1 (str.to_re "h")) (str.to_re "d"))))
      (a!5 (re.union (re.union (re.union a!4 (str.to_re "b")) (str.to_re "l"))
                     (str.to_re "k")))
      (a!9 (re.union (re.union (re.union a!8 (str.to_re "l")) (str.to_re "k"))
                     (str.to_re "1")))
      (a!11 (re.union (re.union (re.union a!10 (str.to_re "c")) (str.to_re "h"))
                      (str.to_re "d"))))
...
(let ((a!13 (re.++ (re.* (re.union a!9 (re.++ a!11 a!7))) a!12)))
(let ((a!14 (re.union a!12 (re.++ (re.union a!9 (re.++ a!11 a!7)) a!13))))
(let ((a!15 (re.++ (re.* (re.union a!9 (re.++ a!11 a!7))) a!14)))
