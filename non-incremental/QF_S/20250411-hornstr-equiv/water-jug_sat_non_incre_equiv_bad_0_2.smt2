...
(let ((a!2 (re.++ (re.++ (str.to_re "Z") (str.to_re "b"))
  ...
  (and (str.in_re X (re.union (re.++ a!2 a!4) (re.++ a!6 a!8)))
       ...
       isin
       (not isout)))))
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "e") (str.to_re "c"))
                               (str.to_re "a"))
                     (str.to_re "d")))
      (a!4 (re.union (re.union (re.union (str.to_re "Z") (str.to_re "f"))
                     ...
                     (str.to_re "a"))))
(let ((a!2 (re.++ (re.* a!1)
                  (re.union (re.union (str.to_re "Z") (str.to_re "b"))
                            (str.to_re "f")))))
(let ((a!3 (re.union (re.union (re.union (str.to_re "Z") (str.to_re "b"))
                               (str.to_re "f"))
                     (re.++ a!1 a!2))))
(let ((a!5 (re.union (re.union (str.to_re "b") (str.to_re "e"))
                     (re.++ (re.union a!4 (str.to_re "d"))
                            (re.++ (re.* a!1) a!3)))))
(let ((a!6 (re.++ (re.* a!5) (re.union (str.to_re "") (re.++ a!5 (re.* a!5))))))
  (str.in_re varin (re.++ (re.++ (re.* a!1) a!3) a!6))))))))
(check-sat)
