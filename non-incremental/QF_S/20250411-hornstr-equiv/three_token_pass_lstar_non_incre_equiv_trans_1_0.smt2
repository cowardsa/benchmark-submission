...
(assert (let ((a!1 (re.union (str.to_re "")
      ...
      (a!2 (re.++ (re.* (str.to_re "n"))
                  (re.union (re.union (str.to_re "m") (str.to_re "t"))
                            (str.to_re "b")))))
(let ((a!3 (re.union (re.union (re.union (str.to_re "m") (str.to_re "t"))
                               (str.to_re "b"))
                     (re.++ (str.to_re "n") a!2)))
      (a!5 (re.++ (re.union (re.union (str.to_re "m") (str.to_re "t"))
                            (str.to_re "b"))
                  (re.++ (re.* (str.to_re "n")) a!1))))
(let ((a!4 (re.++ (re.union (re.union (str.to_re "m") (str.to_re "t"))
                            (str.to_re "b"))
...
(assert (let ((a!1 (re.++ (re.* (str.to_re "n"))
                  (re.union (re.union (str.to_re "m") (str.to_re "t"))
                            (str.to_re "b")))))
(let ((a!2 (re.union (re.union (re.union (str.to_re "m") (str.to_re "t"))
                               (str.to_re "b"))
                     (re.++ (str.to_re "n") a!1))))
(let ((a!3 (re.++ (re.union (re.union (str.to_re "m") (str.to_re "t"))
                            (str.to_re "b"))
