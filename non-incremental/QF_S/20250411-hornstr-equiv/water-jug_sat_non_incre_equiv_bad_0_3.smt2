...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "b") (str.to_re "e"))
      ...
      (a!5 (re.union (re.union (re.union (str.to_re "Z") (str.to_re "f"))
                               (str.to_re "c"))
                     (str.to_re "a"))))
(let ((a!2 (re.++ (re.* (re.union a!1 (str.to_re "d")))
                  (re.union (str.to_re "Z") (str.to_re "f")))))
(let ((a!3 (re.union (re.union (str.to_re "Z") (str.to_re "f"))
                     (re.++ (re.union a!1 (str.to_re "d")) a!2))))
(let ((a!4 (re.++ (re.* (re.union a!1 (str.to_re "d"))) a!3)))
(let ((a!6 (re.union (re.union (str.to_re "b") (str.to_re "e"))
                     (re.++ (re.union a!5 (str.to_re "d")) a!4))))
