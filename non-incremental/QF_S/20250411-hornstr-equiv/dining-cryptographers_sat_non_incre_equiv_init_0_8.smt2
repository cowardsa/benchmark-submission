...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "e") (str.to_re "g"))
      ...
      (a!4 (re.union (re.union (re.union (str.to_re "i") (str.to_re "a"))
                               (str.to_re "j"))
                     (str.to_re "f")))
      (a!9 (re.union (re.union (re.union (str.to_re "i") (str.to_re "a"))
                               (str.to_re "j"))
                     (str.to_re "b")))
      (a!11 (re.union (re.union (re.union (str.to_re "e") (str.to_re "f"))
                                (str.to_re "g"))
                      (str.to_re "c"))))
(let ((a!2 (re.++ (re.union a!1 (str.to_re "d"))
                  (re.* (re.union a!1 (str.to_re "d")))))
      (a!5 (re.union (re.union (re.union a!4 (str.to_re "b")) (str.to_re "0"))
                     (str.to_re "l")))
      (a!10 (re.union (re.union (re.union a!9 (str.to_re "0")) (str.to_re "l"))
                      (str.to_re "k"))))
...
(let ((a!7 (re.union (re.union (re.union a!5 (str.to_re "k")) (str.to_re "1"))
      ...
      (a!14 (re.++ (re.union (re.union a!11 (str.to_re "h")) (str.to_re "d"))
                   a!3)))
(let ((a!8 (re.++ (re.* (re.union a!1 (str.to_re "d"))) a!7)))
(let ((a!12 (re.++ (re.union (re.union a!11 (str.to_re "h")) (str.to_re "d"))
                   a!8)))
(let ((a!13 (re.* (re.union (re.union a!10 (str.to_re "1")) a!12))))
(let ((a!15 (re.++ (re.union (re.union a!10 (str.to_re "1")) a!12)
                   (re.++ a!13 a!14))))
(let ((a!16 (re.union a!3 (re.++ a!8 (re.++ a!13 (re.union a!14 a!15))))))
