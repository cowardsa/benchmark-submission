...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "1") (str.to_re "7"))
      ...
      (a!4 (re.union (re.union (re.union (str.to_re "5") (str.to_re "6"))
                               (str.to_re "a"))
                     (str.to_re "9")))
      (a!8 (re.union (re.union (re.union (str.to_re "1") (str.to_re "6"))
                               (str.to_re "3"))
                     (str.to_re "a")))
      (a!9 (re.union (re.union (re.union (str.to_re "5") (str.to_re "7"))
                               (str.to_re "8"))
                     (str.to_re "9"))))
...
(let ((a!6 (re.++ (re.union (re.union a!1 (str.to_re "4")) (str.to_re "b")) a!5))
      (a!12 (re.++ (re.union (re.union a!9 (str.to_re "4")) (str.to_re "b"))
                   (re.++ a!2 (re.union (str.to_re "") a!3)))))
(let ((a!7 (re.union (re.union (re.union a!4 (str.to_re "2")) (str.to_re "c"))
                     a!6)))
(let ((a!10 (re.++ (re.union (re.union a!9 (str.to_re "4")) (str.to_re "b"))
                   (re.++ a!2 a!7))))
(let ((a!11 (re.union (re.union (re.union a!8 (str.to_re "2")) (str.to_re "c"))
                      a!10)))
