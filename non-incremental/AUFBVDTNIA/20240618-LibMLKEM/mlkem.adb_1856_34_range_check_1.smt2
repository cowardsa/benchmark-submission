...
;; oadd
(declare-fun oadd ((Array Int (Array Int t))
...
;; byteencode12
(declare-fun byteencode12 ((Array Int (Array Int t))) (Array Int byte))
                    ...
                    (=>
                      ...
                      (forall ((n1 (_ BitVec 8)) (s1 (Array Int (Array Int t))))
                        (=>
                          ...
                          (=>
                            (= n1 #x03)
                            (forall ((n2 (_ BitVec 8)) (e1 (Array Int (Array Int t))))
                              (=>
                                (exists ((i Int))
                                  (and
                                    (= i 0)
                                    (ite (= (and (ite (<= 0 i) true false) 
                                      (ite (<= i 2)
                                        true
                                        false)) true)
                                      (exists ((n3 (_ BitVec 8)) (e2 (Array Int (Array Int t))) (i1 Int))
                                        (and
                                          (= n3 (bvadd #x03 ((_ int_to_bv 8) i1)))
                                          (and
                                            (= (and (ite (and
                                                           (in_range3 i1)
                                                               ...
                                                               (=>
                                                                 (or
                                                                   ...
                                                                   (or
                                                                    (< temp___3407 0)
                                                                    (<= i1 temp___3407)))
                                                                 (= (select e2 temp___3407) (select e temp___3407))))))
                                                      true
                                                      false) (ite (and
                                                                    (<= 0 i1)
                                                                    (<= i1 2))
                                                               ...
                                                               false)) true)
                                            (and
                                              (= e1 (store e2 i1 (samplepolycbd_eta_1
                                                                   (prf_eta_1
                                                                    sigma
                                                                    n3))))
                                              (and
                                ...
                                (=>
                                  (= n2 #x06)
                                  (forall ((s_hat (Array Int (Array Int t))))
                                    (=>
                                      (= s_hat (ntt s1))
                                      (forall ((e_hat (Array Int (Array Int t))))
                                        (=>
                                          (= e_hat (ntt e1))
