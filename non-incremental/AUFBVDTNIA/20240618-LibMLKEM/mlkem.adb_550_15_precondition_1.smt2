...
;; to_rep
(declare-fun to_rep7 (byte1) (_ BitVec 8))

;; of_rep
(declare-fun of_rep7 ((_ BitVec 8)) byte1)
...
(declare-const s (Array Int byte1))
...
(declare-fun concat_singleton_right ((Array Int byte1)
  Int
  Int
  byte1) (Array Int byte1))
...
(declare-sort index_prf_eta_2_bytes 0)

(declare-const dummy18 index_prf_eta_2_bytes)
...
(assert
  (forall ((a (Array Int byte1)))
    (forall ((temp___2289 Int))
      (= (to_rep7 (select a temp___2289)) (to_rep3
...
;; Goal def'vc
;; File "mlkem.adb", line 542, characters 0-0
(assert
  (not
                ...
                (let ((temp___2303 (of_array1
                  ...
                  (=>
                    (dynamic_property
                      ...
                      (last temp___2303))
                    (=>
                      (forall ((temp___1548 us_rep1))
                        (state_of__function_guard
                          (state_of temp___1548)
                          temp___1548))
                      (= (let ((temp___1548 (us_repqtmk1 c__split_fields)))
                           (state_of temp___1548)) 0)))))))))))))
