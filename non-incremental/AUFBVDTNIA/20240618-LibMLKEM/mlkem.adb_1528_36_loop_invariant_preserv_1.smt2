...
(declare-const sb (Array Int u8_bit))
...
(declare-sort bit_sum 0)

;; in_range
(define-fun in_range2 ((x Int)) Bool
  (and (<= 0 x) (<= x 2)))

(declare-const dummy3 bit_sum)

(declare-sort t224b 0)

;; in_range
(define-fun in_range3 ((x Int)) Bool
  (and (<= 0 x) (<= x 1)))

(declare-const dummy4 t224b)
...
;; Goal def'vc
;; File "mlkem.adb", line 1520, characters 0-0
(assert
  (not
  (let ((temp___result_2950 (bytestobits b)))
    (=>
      (bytestobits__function_guard temp___result_2950 b)
      (=>
        (= temp___result_2950 sb)
        (=>
          (in_range1 i)
          (forall ((r Int))
            (=>
                  ...
                  (=>
                    ...
                    (=>
                      (= (and (ite (<= 0 j) true false) (ite (<= j 1)
                                                          true
                                                          false)) true)
                      (forall ((r1 Int) (j1 Int))
                        (=>
                          (and (<= 0 r1) (<= r1 j1))
                          (=>
                            (= (and (ite (and (in_range2 r1) (in_range3 j1))
                                      true
                                      false) (ite (and (<= 0 j1) (<= j1 1))
                                               true
                                               false)) true)
                            (forall ((o (_ BitVec 8)))
                              (=>
                                (= (to_rep1 (select sb (+ (* (* 2 i) 2) j1))) o)
                                (let ((o1 (+ r1 (ubv_to_int o))))
                                  (=>
                                    (in_range2 o1)
                                    (forall ((r2 Int))
                                      (=>
