...
(declare-const dummy3 (Array Int t))
...
(declare-const dummy5 (Array Int udu))
...
(declare-const dummy7 (Array Int t))
...
(declare-const dk_pke (Array Int byte))

(declare-const c (Array Int byte))

(declare-sort ciphertext_index 0)

(declare-const dummy8 ciphertext_index)

(declare-sort index_udv_bytes 0)

(declare-const dummy9 index_udv_bytes)

(declare-sort t284b 0)

(declare-const dummy10 t284b)

;; Goal def'vc
;; File "mlkem.adb", line 1918, characters 0-0
(assert
  (not
  (=>
    (<= 0 959)
    (and (and (<= 0 0) (<= 0 1087)) (and (<= 0 959) (<= 959 1087))))))
