...
;; Goal def'vc
;; File "mlkem.adb", line 1571, characters 0-0
(assert
  (not
          ...
          (=>
            ...
            (=>
              ...
              (=>
                ...
                (=>
                  (in_range1 r230b)
                  (let ((temp___3001 start))
                    (forall ((j Int))
                      (=>
                        (= j temp___3001)
                        (=>
                          (= (and (ite (<= temp___3001 j) true false) 
                          (ite (<= j r230b)
                            true
                            false)) true)
