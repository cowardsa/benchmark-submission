...
;; nth
(declare-fun nth2 ((_ BitVec 64)
  Int) Bool)

;; lsr
(declare-fun lsr2 ((_ BitVec 64)
  Int) (_ BitVec 64))

;; asr
(declare-fun asr2 ((_ BitVec 64)
  Int) (_ BitVec 64))

;; lsl
(declare-fun lsl2 ((_ BitVec 64)
  Int) (_ BitVec 64))
...
;; nth_bv
(declare-fun nth_bv2 ((_ BitVec 64)
  (_ BitVec 64)) Bool)

;; nth_bv_def
(assert
  (forall ((x (_ BitVec 64)) (i1 (_ BitVec 64)))
    (=
      (= (nth_bv2 x i1) true)
      (not (= (bvand (bvlshr x i1) #x0000000000000001) #x0000000000000000)))))

;; Nth_bv_is_nth
(assert
  (forall ((x (_ BitVec 64)) (i1 (_ BitVec 64)))
    (= (nth2 x (ubv_to_int i1)) (nth_bv2 x i1))))

;; Nth_bv_is_nth2
(assert
  (forall ((x (_ BitVec 64)) (i1 Int))
    (=>
      (and (<= 0 i1) (< i1 18446744073709551616))
      (= (nth_bv2 x ((_ int_to_bv 64) i1)) (nth2 x i1)))))

(declare-sort unsigned_64 0)

(declare-const attr__ATTRIBUTE_MODULUS1 (_ BitVec 64))

(declare-const dummy6 unsigned_64)

;; to_rep
(declare-fun to_rep3 (unsigned_64) (_ BitVec 64))

;; of_rep
(declare-fun of_rep3 ((_ BitVec 64)) unsigned_64)
...
(assert
  (forall ((i1 byte_absorption_number))
    (and
      (<= 0 (byte_absorption_numberqtint i1))
      (<= (byte_absorption_numberqtint i1) 199))))
...
;; to_rep
(define-fun to_rep4 ((x byte_absorption_number)) Int
...
(declare-const dummy9 byte1)

;; to_rep
(declare-fun to_rep5 (byte1) (_ BitVec 8))

;; of_rep
(declare-fun of_rep5 ((_ BitVec 8)) byte1)
...
(declare-datatypes ((map__ref1 0))
  (((map__refqtmk1 (map__content1 (Array Int byte1))))))

;; slide
(declare-fun slide ((Array Int byte1)
  Int
  Int) (Array Int byte1))

;; slide_eq
(assert
  (forall ((a (Array Int byte1)))
    (forall ((first1 Int))
...
(declare-const dummy10 (Array Int byte1))
...
(assert
  (forall ((i1 bit_absorption_number))
    (and
      (<= 0 (bit_absorption_numberqtint i1))
      (<= (bit_absorption_numberqtint i1) 1599))))
...
;; to_rep
(define-fun to_rep6 ((x bit_absorption_number)) Int
...
(assert
  (forall ((x bit_absorption_number))
    (! (in_range5 (to_rep6 x)) :pattern ((to_rep6 x)) )))
...
(assert
  (forall ((i1 rate_bytes_number))
    (and
      (<= 1 (rate_bytes_numberqtint i1))
      (<= (rate_bytes_numberqtint i1) 199))))

;; in_range
(define-fun in_range6 ((x Int)) Bool
  (and (<= 1 x) (<= x 199)))

(declare-const dummy12 rate_bytes_number)

;; to_rep
(define-fun to_rep7 ((x rate_bytes_number)) Int
  (rate_bytes_numberqtint x))

;; of_rep
(declare-fun of_rep7 (Int) rate_bytes_number)
...
(assert
  (forall ((x rate_bytes_number))
    (! (in_range6 (to_rep7 x)) :pattern ((to_rep7 x)) )))

;; coerce_axiom
(assert
  (forall ((x Int))
    (! (=> (in_range6 x) (= (to_rep7 (of_rep7 x)) x)) :pattern ((to_rep7
                                                                  (of_rep7 x))) )))
...
(declare-const dummy13 states)

;; to_rep
(declare-fun to_rep8 (states) Int)

;; of_rep
(declare-fun of_rep8 (Int) states)
...
;; range_axiom
(assert
  (forall ((x states)) (! (in_range7 (to_rep8 x)) :pattern ((to_rep8 x)) )))

;; coerce_axiom
(assert
  (forall ((x Int))
    (! (=> (in_range7 x) (= (to_rep8 (of_rep8 x)) x)) :pattern ((to_rep8
                                                                  (of_rep8 x))) )))
...
(declare-const shake__shake128__context__sponge_ctx__first__bit Int)

(declare-const shake__shake128__context__sponge_ctx__last__bit Int)

(declare-const shake__shake128__context__sponge_ctx__position Int)

;; shake__shake128__context__sponge_ctx__first__bit_axiom
(assert (<= 0 shake__shake128__context__sponge_ctx__first__bit))

;; shake__shake128__context__sponge_ctx__last__bit_axiom
(assert
  (< shake__shake128__context__sponge_ctx__first__bit shake__shake128__context__sponge_ctx__last__bit))

;; shake__shake128__context__sponge_ctx__position_axiom
(assert (<= 0 shake__shake128__context__sponge_ctx__position))

(declare-const shake__shake128__context__update_complete__first__bit Int)

(declare-const shake__shake128__context__update_complete__last__bit Int)

(declare-const shake__shake128__context__update_complete__position Int)

;; shake__shake128__context__update_complete__first__bit_axiom
(assert (<= 0 shake__shake128__context__update_complete__first__bit))

;; shake__shake128__context__update_complete__last__bit_axiom
(assert
  (< shake__shake128__context__update_complete__first__bit shake__shake128__context__update_complete__last__bit))

;; shake__shake128__context__update_complete__position_axiom
(assert (<= 0 shake__shake128__context__update_complete__position))
...
;; in_range
(define-fun in_range8 ((x (_ BitVec 16))) Bool
  (and (bvule #x0000 x) (bvule x #x0D00)))

(declare-const dummy16 t1)

;; to_rep
(declare-fun to_rep9 (t1) (_ BitVec 16))

;; of_rep
(declare-fun of_rep9 ((_ BitVec 16)) t1)

;; inversion_axiom
(assert
  (forall ((x t1)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)) )))

;; range_axiom
(assert
  (forall ((x t1)) (! (in_range8 (to_rep9 x)) :pattern ((to_rep9 x)) )))

;; coerce_axiom
(assert
  (forall ((x (_ BitVec 16)))
    (! (let ((y (bvurem x #x0D01)))
         (=> (in_range8 y) (= (to_rep9 (of_rep9 x)) y))) :pattern ((to_rep9
                                                                    (of_rep9
                                                                    x))) )))

(declare-datatypes ((map__ref2 0))
  (((map__refqtmk2 (map__content2 (Array Int t1))))))
...
(declare-const dummy17 index_number)
...
(declare-datatypes ((us_t1 0))
  (((us_tqtmk1 (elts1 (Array Int byte1))(rt1 t2)))))

;; to_array
(define-fun to_array1 ((a us_t1)) (Array Int byte1)
  (elts1 a))

;; of_array
(define-fun of_array1 ((a (Array Int byte1)) (f Int) (l Int)) us_t1
  (us_tqtmk1 a (mk1 f l)))
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_1964 us_t1) (temp___is_init_1960 Bool) (temp___skip_constant_1961 Bool) (temp___do_toplevel_1962 Bool) (temp___do_typ_inv_1963 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1961 true))
    (dynamic_property
      0
      2147483646
      (first1 temp___expr_1964)
      (last1 temp___expr_1964))))
        ...
        (! (and
             ...
             (forall ((i1 Int))
               (! (=>
                    ...
                    (= (select (concat_singleton_right a a_first a_last b) i1) (select a i1))) :pattern ((select 
               (concat_singleton_right
                 a
                 a_first
                 a_last
                 b) i1)) :pattern ((select a i1)) ))) :pattern ((concat_singleton_right
                                                                  a
                                                                  a_first
                                                                  a_last
                                                                  b)) )))))
...
(assert
  (forall ((v byte))
    (forall ((i1 Int))
      (! (= (select (singleton1 v i1) i1) v) :pattern ((select (singleton1
                                                                 v
                                                                 i1) i1)) ))))

(declare-sort index_32 0)

(declare-const dummy19 index_32)

(declare-sort u16 0)

(declare-const attr__ATTRIBUTE_MODULUS3 (_ BitVec 16))

(declare-const dummy20 u16)
...
(declare-const dummy21 index_256)

(declare-sort index_3 0)

(declare-const dummy22 index_3)
...
(assert
  (forall ((a (Array Int byte)))
    (forall ((temp___2289 Int))
      (= (to_rep2 (select a temp___2289)) (to_rep5
                                            (select (convert a) temp___2289))))))

;; convert
(declare-fun convert1 ((Array Int byte1)) (Array Int byte))

;; convert__def
(assert
  (forall ((a (Array Int byte1)))
    (forall ((temp___2290 Int))
      (= (to_rep5 (select a temp___2290)) (to_rep2
                                            (select (convert1 a) temp___2290))))))

;; mlkem__xof_then_samplentt__a__aggregate_def
(declare-fun mlkem__xof_then_samplentt__a__aggregate_def ((_ BitVec 16)) (Array Int t1))
  ...
  (forall ((param__ctx us_rep))
    (! (let ((result (state_of1 param__ctx)))
         (=>
           ...
           (in_range7 result))) :pattern ((state_of1 param__ctx)) )))

;; state_of__def_axiom
(assert
  (forall ((param__ctx us_rep))
    (! (= (state_of1 param__ctx) (to_rep8
...
(assert
  (forall ((param__ctx us_rep))
    (! (= (in_queue_bit_length param__ctx) (to_rep6
...
(declare-const dummy23 rate_bits_number)
...
(assert
  (forall ((param__ctx us_rep1))
    (! (and
         (forall ((temp___1940 us_rep))
           (in_queue_bit_length__function_guard
             (in_queue_bit_length temp___1940)
             temp___1940))
         (and
           (forall ((temp___1942 us_rep))
             (in_queue_bit_length__function_guard
               (in_queue_bit_length temp___1942)
               temp___1942))
           (and
             (forall ((temp___1944 us_rep))
               (rate_of__function_guard (rate_of temp___1944) temp___1944))
             (=
               (= (can_absorb param__ctx) true)
               (and
                 (= (mod2
                      (let ((temp___1940 (rec__shake__shake128__context__sponge_ctx
                                           (us_split_fields3 param__ctx))))
                        (in_queue_bit_length temp___1940))
                      8) 0)
                 (< (let ((temp___1942 (rec__shake__shake128__context__sponge_ctx
                                         (us_split_fields3 param__ctx))))
                      (in_queue_bit_length temp___1942)) (let ((temp___1944 
  ...
  (forall ((param__ctx us_rep1))
    (! (let ((result (state_of param__ctx)))
         (=>
           ...
           (in_range12 result))) :pattern ((state_of param__ctx)) )))

;; state_of__def_axiom
(assert
  (forall ((param__ctx us_rep1))
    (! (and
         (forall ((temp___1954 us_rep))
           (state_of__function_guard1 (state_of1 temp___1954) temp___1954))
         (= (state_of param__ctx) (ite (= (let ((temp___1954 (rec__shake__shake128__context__sponge_ctx
                                                               (us_split_fields3
                                                                 param__ctx))))
                                            (state_of1 temp___1954)) 1)
                                    2
                                    (ite (or
...
;; def_axiom
(assert
  (forall ((temp___2863 (_ BitVec 16)))
    (forall ((temp___2864 Int))
      (=>
        (in_range8 temp___2863)
        (= (to_rep9
             (select (mlkem__xof_then_samplentt__a__aggregate_def
                       temp___2863) temp___2864)) temp___2863)))))

;; Goal def'vc
;; File "mlkem.adb", line 1409, characters 0-0
(assert
  (not
  (forall ((j2 Int))
    (=>
      ...
      (=>
        ...
        (forall ((a (Array Int t1)))
          (=>
            (= a (mlkem__xof_then_samplentt__a__aggregate_def #x0000))
            (forall ((c__split_fields us_split_fields2))
              (=>
                (forall ((temp___1956 us_rep1))
                  (state_of__function_guard
                    (state_of temp___1956)
                    temp___1956))
                (=>
                  (= (let ((temp___1956 (us_repqtmk1 c__split_fields)))
                       (state_of temp___1956)) 0)
                  (forall ((temp___2870 us_t))
                    (=>
                          ...
                          (exists ((o1 byte))
                            (and
                              ...
                              (let ((temp___2869 (of_array
                                                   ...
                                                   0
                                                   o)))
                                (ite (= (length1 temp___2869) 0)
                                  (exists ((o2 byte))
                                    (and
                                      (= (to_rep2 o2) j)
                                      (= temp___2870 (of_array
                                                       (singleton1 o2 0)
                                                       0
                                                       0))))
                                  (let ((o2 (- (+ (first temp___2869) (+ 
                                    (length
                                      (first temp___2869)
                                      (last temp___2869)) 1)) 1)))
                                    (and
                                      (in_range3 o2)
                                      (exists ((o3 byte))
                                        (and
                      ...
                      (=>
                        ...
                        (forall ((c__split_fields1 us_split_fields2))
                          (=>
                            (forall ((temp___1969 us_rep1))
                              (state_of__function_guard
                                (state_of temp___1969)
                                temp___1969))
                            (=>
                              (= (let ((temp___1969 (us_repqtmk1
                                                      c__split_fields1)))
                                   (state_of temp___1969)) 0)
                              (=>
                                (< j2 256)
                                (forall ((j21 Int) (a1 (Array Int t1)) (b (Array Int byte)))
                                  (=>
                                    (= (and (ite (in_range1 j21) true false) 
                                    (ite (< j21 256)
                                      true
                                      false)) true)
                                    (=>
                                      (dynamic_property 0 2147483646 0 2)
                                      (let ((temp___compl_2874 (of_array1
                                                                 (convert b)
                                                                 0
                                                                 2)))
                                        (forall ((o integer))
                                          (=>
                                            ...
                                            (forall ((o1 integer))
                                              (=>
                                                (= (to_rep o1) (first1
                                                                 temp___compl_2874))
                                                (forall ((c__split_fields2 us_split_fields2) (param__digest (Array Int byte1)))
                                                  (=>
                                                    (forall ((temp___1978 us_rep1))
                                                      (state_of__function_guard
                                                        (state_of
                                                          temp___1978)
                                                        temp___1978))
                                                              ...
                                                              (=>
                                                                ...
                                                                (forall 
                                                                  ...
                                                                  (=>
                                                                    ...
                                                                    (select b1 0)) o3)
                                                                    (=>
                                                                    (= (bvadd ((_ zero_extend 8) o3) (bvmul #x0100 (bvurem ((_ zero_extend 8) o2) #x0010))) 
                                                                    d1)
                                                                    (forall 
                                                                    ((o4 (_ BitVec 8)))
                                                                    (=>
                                                                    ...
                                                                    (select b1 1)) o5)
                                                                    (=>
                                                                    (= (bvadd (bvudiv ((_ zero_extend 8) o5) #x0010) (bvmul #x0010 ((_ zero_extend 8) o4))) 
                                                                    d2)
                                                                    (forall 
                                                                    ((spark__branch Bool) (j22 Int) (a2 (Array Int t1)))
                                                                    (=>
                                                                    (and
                                                                    (= spark__branch 
                                                                    (ite (bvult 
