...
;; to_rep
(declare-fun to_rep1 (unsigned_64) (_ BitVec 64))

;; of_rep
(declare-fun of_rep1 ((_ BitVec 64)) unsigned_64)
...
;; to_rep
(define-fun to_rep2 ((x byte_absorption_number)) Int
...
(declare-const dummy6 bit_absorption_number)

;; to_rep
(define-fun to_rep4 ((x bit_absorption_number)) Int
...
(assert
  (forall ((x bit_absorption_number))
    (! (in_range2 (to_rep4 x)) :pattern ((to_rep4 x)) )))

;; coerce_axiom
(assert
  (forall ((x Int))
    (! (=> (in_range2 x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4
                                                                  (of_rep4 x))) )))
...
(declare-const dummy7 rate_bytes_number)

;; to_rep
(define-fun to_rep5 ((x rate_bytes_number)) Int
  (rate_bytes_numberqtint x))

;; of_rep
(declare-fun of_rep5 (Int) rate_bytes_number)
...
;; to_rep
(declare-fun to_rep6 (states) Int)

;; of_rep
(declare-fun of_rep6 (Int) states)
...
;; range_axiom
(assert
  (forall ((x states)) (! (in_range4 (to_rep6 x)) :pattern ((to_rep6 x)) )))
...
(declare-const dummy11 index_number)
...
;; to_rep
(define-fun to_rep7 ((x tinteger_32B)) Int
  (tinteger_32Bqtint x))

;; of_rep
(declare-fun of_rep7 (Int) tinteger_32B)
...
;; to_rep
(declare-fun to_rep8 (byte1) (_ BitVec 8))

;; of_rep
(declare-fun of_rep8 ((_ BitVec 8)) byte1)
...
;; to_array
(define-fun to_array ((a us_t1)) (Array Int byte1)
  (elts1 a))

;; first
(define-fun first ((a us_t1)) Int
  (to_rep7 (rec__first1 (rt1 a))))

;; last
(define-fun last ((a us_t1)) Int
  (to_rep7 (rec__last1 (rt1 a))))
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_667 us_t1) (temp___is_init_663 Bool) (temp___skip_constant_664 Bool) (temp___do_toplevel_665 Bool) (temp___do_typ_inv_666 Bool)) Bool
  (=>
...
;; convert
(declare-fun convert ((Array Int byte1)) (Array Int byte))

;; convert__def
(assert
  (forall ((a (Array Int byte1)))
    (forall ((temp___2289 Int))
      (= (to_rep8 (select a temp___2289)) (to_rep3
...
(assert
  (forall ((param__ctx us_rep))
    (! (= (in_queue_bit_length param__ctx) (to_rep4
...
(declare-const dummy19 rate_bits_number)
...
;; Goal def'vc
;; File "mlkem.adb", line 598, characters 0-0
(assert
  (not
  (=>
    ...
    (=>
      ...
      (forall ((ctx__split_fields us_split_fields2))
        (=>
          ...
          (=>
            (= (let ((temp___1537 (us_repqtmk1 ctx__split_fields)))
                 (state_of temp___1537)) 0)
            (=>
              (dynamic_property 0 2147483646 (first c) (last c))
                ...
                (=>
                  (forall ((temp___1550 us_rep1))
                    (state_of__function_guard
                      ...
                      temp___1550))
                  (=>
                    (= (let ((temp___1550 (us_repqtmk1 ctx__split_fields1)))
                         (state_of temp___1550)) 0)
                    (dynamic_property 0 2147483646 0 31))))))))))))
