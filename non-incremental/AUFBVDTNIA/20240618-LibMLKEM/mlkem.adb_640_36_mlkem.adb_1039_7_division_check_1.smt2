...
(declare-fun mlkem__bytedecodedv__bytestobits__r__aggregate_def ((_ BitVec 8)) (Array Int u8_bit))

;; def_axiom
(assert
  (forall ((temp___2774 (_ BitVec 8)))
    (forall ((temp___2775 Int))
      (=>
        (in_range temp___2774)
        (= (to_rep1
             (select (mlkem__bytedecodedv__bytestobits__r__aggregate_def
                       temp___2774) temp___2775)) temp___2774)))))

;; Goal def'vc
;; File "mlkem.adb", line 1039, characters 0-0
(assert
  (not
  (forall ((this_bit (_ BitVec 8)))
    (forall ((r (Array Int u8_bit)))
      (=>
        (= r (mlkem__bytedecodedv__bytestobits__r__aggregate_def #x00))
        (=>
          (in_range this_bit)
          (forall ((i Int))
            (=>
              ...
              (=>
                ...
                (forall ((this_bit1 (_ BitVec 8)) (i1 Int))
                  (=>
                    (= (and (ite (in_range this_bit1) true false) (ite 
                                                                    (and
                                                                    (<= 0 i1)
                                                                    (<= i1 127))
                                                                    true
                          ...
                          (=>
                            ...
                            (forall ((j Int))
                              (=>
                                (= j 0)
                                (=>
                                  (= (and (ite (<= 0 j) true false) (ite (<= j 7)
                                                                    true
                                                                    false)) true)
                                  (forall ((r1 (Array Int u8_bit)) (this_byte1 (_ BitVec 8)) (this_bit2 (_ BitVec 8)) (j1 Int))
                                    (=>
                                      (= (and (ite (in_range this_bit2)
                                                true
                                                false) (ite (and
                                                              (<= 0 j1)
                                                              (<= j1 7))
                                      ...
                                      (forall ((this_bit3 (_ BitVec 8)))
                                        (=>
                                          (= this_bit3 (bvurem this_byte1 #x02))
                                          (forall ((o1 u8_bit))
                                            (=>
                                              (= (to_rep1 o1) this_bit3)
                                              (forall ((r2 (Array Int u8_bit)))
                                                (=>
                                                  (= r2 (store r1 (+ (* 8 i1) j1) o1))
                                                  (not (= #x02 #x00))))))))))))))))))))))))))))
