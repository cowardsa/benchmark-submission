                                                              ...
                                                              (=>
                                                                ...
                                                                (forall 
                                                                  ...
                                                                  (=>
                                                                    ...
                                                                    (and
                                                                    (<= (* i2 320) temp___2485)
                                                                    (<= temp___2485 (- (* (+ i2 1) 320) 1)))
                                                                    (= (select usf1 temp___2485) (select 
                                                                    (to_array
                                                                    temp___24781) temp___2485))
                                                                    (= (select usf1 temp___2485) (select r2 temp___2485))))
                                                                    (forall 
                                                                    ((r3 (Array Int byte__init_wrapper)))
                                                                    (=>
                                                                    (= r3 usf1)
                                                                    (let ((temp___24971 (- (* (+ i2 1) 320) 1)))
                                                                    (=>
                                                                    (=>
                                                                    (<= 0 temp___24971)
                                                                    (and
