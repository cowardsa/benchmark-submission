...
(declare-datatypes ((map__ref 0))
  (((map__refqtmk (map__content (Array Int (Array Int udu)))))))
...
(declare-const dummy4 index_poly_udu_bytes)

(declare-sort index_udu_bytes 0)

(declare-const dummy5 index_udu_bytes)
...
;; Goal def'vc
;; File "mlkem.adb", line 1081, characters 0-0
(assert
  (not
  (forall ((r (Array Int (Array Int udu))))
    (forall ((i Int))
      (=>
        (= i 0)
        (=>
          (= (and (ite (<= 0 i) true false) (ite (<= i 2) true false)) true)
          (forall ((r1 (Array Int (Array Int udu))) (i1 Int))
            (=>
              (= (and (ite (forall ((temp___2828 Int))
                             (=>
                               (and (<= 0 temp___2828) (<= temp___2828 2))
                               (=>
                                 (or
                                   (< 2 temp___2828)
                                   (or (< temp___2828 0) (<= i1 temp___2828)))
                                 (= (select r1 temp___2828) (select r temp___2828)))))
                        true
                        false) (ite (and (<= 0 i1) (<= i1 2)) true false)) true)
              (let ((temp___2824 (- (* (* (+ i1 1) 32) 10) 1)))
                (let ((temp___2823 (* (* i1 32) 10)))
                  (=>
                    (=>
                      (<= temp___2823 temp___2824)
                      (and
                        (and (<= 0 temp___2823) (<= temp___2823 959))
                        (and (<= 0 temp___2824) (<= temp___2824 959))))
                    (let ((temp___2825 (of_array b temp___2823 temp___2824)))
                      (ite (<= (first temp___2825) (last temp___2825))
                        (and
                          (<= 0 319)
                          (= (- (last temp___2825) (first temp___2825)) (- 319 0)))
                        (< 319 0))))))))))))))
