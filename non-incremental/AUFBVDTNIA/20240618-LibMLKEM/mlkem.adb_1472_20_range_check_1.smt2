...
;; Goal def'vc
;; File "mlkem.adb", line 1463, characters 0-0
(assert
  (not
  (let ((temp___result_2914 (bytestobits b)))
    (=>
      (bytestobits__function_guard temp___result_2914 b)
      (=>
        (= temp___result_2914 sb)
        (=>
          (in_range1 i)
          (forall ((r Int))
            (=>
