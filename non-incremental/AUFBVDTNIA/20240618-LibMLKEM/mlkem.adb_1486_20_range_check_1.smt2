...
(declare-sort t219b 0)

;; in_range
(define-fun in_range3 ((x Int)) Bool
  (and (<= 0 x) (<= x 1)))

(declare-const dummy4 t219b)
...
;; Goal def'vc
;; File "mlkem.adb", line 1477, characters 0-0
(assert
  (not
  (let ((temp___result_2921 (bytestobits b)))
    (=>
      (bytestobits__function_guard temp___result_2921 b)
      (=>
        (= temp___result_2921 sb)
        (=>
          (in_range1 i)
          (forall ((r Int))
            (=>
                        ...
                        (=>
                          ...
                          (=>
                            ...
                            (forall ((o (_ BitVec 8)))
                              (=>
                                (= (to_rep1
                                     (select sb (+ (+ (* (* 2 i) 2) 2) j1))) o)
                                (in_range2 (+ r1 (ubv_to_int o))))))))))))))))))))
