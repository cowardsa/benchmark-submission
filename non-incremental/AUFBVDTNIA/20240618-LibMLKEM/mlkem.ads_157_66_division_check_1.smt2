...
;; Goal def'vc
;; File "mlkem.ads", line 154, characters 0-0
(assert
  (not
            ...
            (forall ((r1 Int))
              (=>
                ...
                (=>
                  ...
                  (forall ((reduce1 Int))
                    (=>
                      (= reduce1 (ite (ite (< r1 0) true false) 1 0))
                      (let ((o (* reduce1 3329)))
                        (=>
                          (in_range o)
                          (let ((o1 (+ r1 o)))
                                ...
                                (=>
                                  ...
                                  (=>
                                    ...
                                    (=>
                                      ...
                                      (=>
                                        (in_range_int r2)
                                        (forall ((mlkem__zq__Osubtract__result (_ BitVec 16)))
                                          (=>
                                            (= mlkem__zq__Osubtract__result ((_ int_to_bv 16) r2))
                                            (not (= 3329 0)))))))))))))))))))))))))
