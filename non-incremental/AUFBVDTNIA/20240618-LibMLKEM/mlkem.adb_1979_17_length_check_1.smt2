        ...
        (=>
          (= hek (h
                   (of_array
                     ...
                     0
                     1183)))
          (forall ((temp___2114 us_t))
            (=>
              (exists ((temp___2113 us_t))
                (and
                        ...
                        (let ((o (- (+ (first temp___2112) (+ (length
                          ...
                          (and
                            ...
                            (= temp___2113 (of_array
                                             ...
                                             (first temp___2112)
                                             o)))))))
                  (ite (= (length1 temp___2113) 0)
                    (= temp___2114 (of_array random_z 0 31))
                    (let ((o (- (+ (first temp___2113) (+ (length
                                                            (first
                                                              temp___2113)
                                                            (last
                                                              temp___2113)) 
                      ...
                      (and
                        (in_range1 o)
                        (= temp___2114 (of_array
                                         (concat1
                                           (to_array temp___2113)
                                           (first temp___2113)
                                           (last temp___2113)
                                           random_z
                                           0
                                         ...
                                         (first temp___2113)
                                         o)))))))
              (ite (<= (first temp___2114) (last temp___2114))
                (and
                  (<= 0 2399)
                  (= (- (last temp___2114) (first temp___2114)) (- 2399 0)))
                (< 2399 0))))))))))
