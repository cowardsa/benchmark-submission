                            ...
                            (let ((o2 (oadd o1 o)))
                              (and
                                ...
                                (exists ((o3 t))
                                  (and
                                    (= (to_rep o3) o2)
                                    (exists ((r2 (Array Int t__init_wrapper)))
                                      (and
                                        (= r2 (store r i (t__init_wrapperqtmk
                                                           o3
                                                           true)))
                                        (exists ((i1 Int))
                                          (and
                                            ...
                                            (and
                                                               ...
                                                               (=>
                                                                 ...
                                                                 (=>
                                                                   (or
                                                                    ...
                                                                    (< temp___2223 0)
                                                                    (< i1 temp___2223)))
                                                                   (= (select r1 temp___2223) (select r temp___2223))))))
                                                        true
                                                        false) (ite (and
                                                                    (<= 0 i1)
                                                                    (<= i1 255))
                                              ...
                                              (= i1 255))))))))))))))
                    (= r1 r))))
              (forall ((temp___2242 Int))
                (=>
                  (and (<= 0 temp___2242) (<= temp___2242 255))
                  (= (us_attr__init (select r1 temp___2242)) true)))))))))))
