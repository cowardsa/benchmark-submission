...
;; ek_is_valid_for_encaps
(declare-fun ek_is_valid_for_encaps ((Array Int byte)) Bool)

;; ek_is_valid_for_encaps__post_axiom
(assert true)

(declare-const ek (Array Int byte))

(declare-const random_m (Array Int byte))
...
(declare-const dummy5 mlkem_encapsulation_key_index)

(declare-sort index_64 0)

(declare-const dummy6 index_64)

(declare-sort t305b 0)

(declare-const dummy7 t305b)

;; Goal def'vc
;; File "mlkem.ads", line 103, characters 0-0
(assert
  (not
  (=>
    (= (ek_is_valid_for_encaps ek) true)
    (let ((o (- (+ 0 (+ (length 0 31) (length 0 31))) 1)))
      (=>
        (in_range1 o)
        (let ((o1 (of_array
                    (concat1 random_m 0 31 (h (of_array ek 0 1183)) 0 31)
                    0
                    o)))
          (and (= (first o1) 0) (<= (last o1) 2147483646))))))))
