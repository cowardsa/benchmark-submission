...
(declare-fun mlkem__bytedecode1__bytestobits__r__aggregate_def ((_ BitVec 8)) (Array Int u8_bit))

;; def_axiom
(assert
  (forall ((temp___2744 (_ BitVec 8)))
    (forall ((temp___2745 Int))
      (=>
        (in_range temp___2744)
        (= (to_rep1
             (select (mlkem__bytedecode1__bytestobits__r__aggregate_def
                       temp___2744) temp___2745)) temp___2744)))))

;; Goal def'vc
;; File "mlkem.adb", line 1022, characters 0-0
(assert
  (not true))
