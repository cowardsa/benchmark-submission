...
;; Goal def'vc
;; File "mlkem.ads", line 170, characters 0-0
(assert
  (not
  (forall ((r1 (_ BitVec 64)))
    (=>
      (= r1 ((_ zero_extend 48) x))
      (=>
        (bvuge (bvadd (bvmul (bvudiv r1 #x0000000000000D01) #x0000000000000D01) #x0000000000000D01) r1)
        (=>
          (bvule r1 (bvadd #x0000000000000D01 (bvmul (bvudiv r1 #x0000000000000D01) #x0000000000000D01)))
          (=>
            (bvule r1 (bvadd #x0000000000000D01 (bvmul (bvudiv (bvmul r1 #x0000002000000000) #x0001A02000000000) #x0000000000000D01)))
            (=>
              (bvule r1 (bvadd #x0000000000000D01 (bvmul (bvudiv (bvmul r1 #x000000000275F6ED) #x0000002000000000) #x0000000000000D01)))
              (forall ((r2 (_ BitVec 64)))
                (=>
                  (= r2 (bvmul r1 #x000000000275F6ED))
                  (=>
                    (bvule r1 (bvadd #x0000000000000D01 (bvmul (bvudiv r2 #x0000002000000000) #x0000000000000D01)))
                    (forall ((r3 (_ BitVec 64)))
                      (=>
                        (= r3 (bvudiv r2 #x0000002000000000))
                        (=>
                          (bvule r1 (bvadd #x0000000000000D01 (bvmul r3 #x0000000000000D01)))
                          (forall ((r4 (_ BitVec 64)))
                            (=>
                              (= r4 (bvmul r3 #x0000000000000D01))
                              (=>
                                (bvule r1 (bvadd #x0000000000000D01 r4))
                                (=>
                                  (bvule (bvsub r1 r4) #x0000000000000D01)
                                        ...
                                        (forall ((r5 (_ BitVec 64)))
                                          (=>
                                            ...
                                            (=>
                                              ...
                                              (=>
                                                (= ((_ extract 15 0) r5) (bvurem 
                                                x #x0D01))
                                                (and
                                                  (bvule ((_ zero_extend 48) #x0000) r5)
                                                  (bvule r5 ((_ zero_extend 48) #x0D00))))))))))))))))))))))))))))
