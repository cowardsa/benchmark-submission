    ...
    (forall ((r1 (Array Int byte__init_wrapper)))
      (=>
        (exists ((i Int))
          (and
            (= i 0)
            (ite (= (and (ite (<= 0 i) true false) (ite (<= i 2) true false)) true)
              (and
                (ite (<= 0 383)
                  (and
                    (<= (* i 384) (+ (* i 384) 383))
                                        ...
                                        (exists ((i1 Int))
                                          (and
                                            ...
                                            (and
                                              ...
                                              (= i1 2)))))))))))))))))
              (= r1 r))))
        (forall ((temp___2702 Int))
          (=>
            (and (<= 0 temp___2702) (<= temp___2702 1151))
