                          ...
                          (=>
                            ...
                            (=>
                              (= (and (ite (<= 0 i) true false) (ite (<= i 2)
                                                                  true
                                                                  false)) true)
                              (forall ((n1 (_ BitVec 8)) (r1 (Array Int (Array Int t))) (i1 Int))
                                (=>
                                  (= n1 ((_ int_to_bv 8) i1))
                                  (=>
                                    (= (and (ite (and
                                                       ...
                                                       (=>
                                                         (or
                                                           ...
                                                           (or
                                                             (< temp___3439 0)
                                                             (<= i1 temp___3439)))
                                                         (= (select r1 temp___3439) (select r temp___3439))))))
                                              true
                                              false) (ite (and
                                                            (<= 0 i1)
                                                            (<= i1 2))
                                                       true
                                                       false)) true)
                                    (forall ((r2 (Array Int (Array Int t))))
                                      (=>
                                        (= r2 (store r1 i1 (samplepolycbd_eta_1
                                                             (prf_eta_1
                                                               random_r
                                                               n1))))
