                                ...
                                (=>
                                  ...
                                  (=>
                                    ...
                                    (ite (<= i 2)
                                      true
                                      false)) true)
                                    (forall ((n2 (_ BitVec 8)) (e11 (Array Int (Array Int t))) (i1 Int))
                                      (=>
                                        (= n2 (bvadd #x03 ((_ int2bv 8) i1)))
                                        (=>
                                          (= (and (ite (and
                                                         (forall ((temp___3446 Int))
                                                           (=>
                                                             (and
                                                               (<= 0 temp___3446)
                                                               (<= temp___3446 2))
                                                             (=>
                                                               (or
                                                                 ...
                                                                 (or
                                                                   (< temp___3446 0)
                                                                   (<= i1 temp___3446)))
                                                               (= (select e11 temp___3446) (select e1 temp___3446)))))
                                                         (in_range4 i1))
                                                    true
                                                    false) (ite (and
                                                                  (<= 0 i1)
                                                             ...
                                                             true
                                                             false)) true)
                                          (forall ((e12 (Array Int (Array Int t))))
                                            (=>
                                              (= e12 (store e11 i1 (samplepolycbd_eta_2
                                                                    (prf_eta_2
                                                                    random_r
                                                                    n2))))
