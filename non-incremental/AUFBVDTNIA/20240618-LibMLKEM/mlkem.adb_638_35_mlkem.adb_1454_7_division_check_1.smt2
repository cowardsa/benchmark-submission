...
;; mlkem__samplepolycbd_eta_1__bytestobits__r__aggregate_def
(declare-fun mlkem__samplepolycbd_eta_1__bytestobits__r__aggregate_def ((_ BitVec 8)) (Array Int u8_bit))

;; def_axiom
(assert
  (forall ((temp___2893 (_ BitVec 8)))
    (forall ((temp___2894 Int))
      (=>
        (in_range temp___2893)
        (= (to_rep1
             (select (mlkem__samplepolycbd_eta_1__bytestobits__r__aggregate_def
                       temp___2893) temp___2894)) temp___2893)))))

;; Goal def'vc
;; File "mlkem.adb", line 1454, characters 0-0
(assert
  (not
  (forall ((this_bit (_ BitVec 8)))
    (forall ((r (Array Int u8_bit)))
      (=>
        (= r (mlkem__samplepolycbd_eta_1__bytestobits__r__aggregate_def #x00))
        (=>
          (in_range this_bit)
          (forall ((i Int))
            (=>
                              ...
                              (=>
                                ...
                                (=>
                                  (= (and (ite (<= 0 j) true false) (ite (<= j 7)
                                                                    true
                                                                    false)) true)
                                  (forall ((this_bit2 (_ BitVec 8)) (j1 Int))
                                    (=>
