...
;; temp_____aggregate_def_2398
(declare-fun temp_____aggregate_def_2398 ((_ BitVec 8)) (Array Int byte))

;; def_axiom
(assert
  (forall ((temp___2400 (_ BitVec 8)))
    (forall ((temp___2401 Int))
      (= (to_rep1
           (select (temp_____aggregate_def_2398 temp___2400) temp___2401)) temp___2400))))

;; Goal def'vc
;; File "mlkem.adb", line 866, characters 0-0
(assert
  (not
  (forall ((r (Array Int byte)))
    (=>
      (= r (temp_____aggregate_def_2398 #x00))
      (forall ((i Int))
        (=>
          (= i 0)
          (=>
