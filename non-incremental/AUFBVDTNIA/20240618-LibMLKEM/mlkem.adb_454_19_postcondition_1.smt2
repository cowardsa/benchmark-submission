...
(declare-datatypes ((map__ref1 0))
  (((map__refqtmk1 (map__content1 (Array Int t__init_wrapper))))))
...
;; convert
(declare-fun convert ((Array Int t__init_wrapper)) (Array Int t))

;; convert__def
(assert
  (forall ((a (Array Int t__init_wrapper)))
    (forall ((temp___195 Int))
      (= (to_rep (of_rep (to_rep (rec__value (select a temp___195))))) 
      (to_rep
        (select (convert a) temp___195))))))
          ...
          (=>
            ...
            (=>
              ...
              (=>
                ...
                (forall ((mlkem__Oadd__result (Array Int t)))
                  (=>
                    (= mlkem__Oadd__result (convert r1))
                    (forall ((i Int))
                      (=>
                        (and (<= 0 i) (<= i 255))
                        (=>
                          (forall ((temp___2255 (_ BitVec 16)) (temp___2254 (_ BitVec 16)))
                            (oadd__function_guard
                              (oadd temp___2254 temp___2255)
                              temp___2254
                              temp___2255))
                          (= (to_rep (select mlkem__Oadd__result i)) 
                          (let ((temp___2255 (to_rep (select right i))))
                            (let ((temp___2254 (to_rep (select left i))))
                              (oadd temp___2254 temp___2255))))))))))))))))))
