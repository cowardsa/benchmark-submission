...
(declare-const dummy udv)

;; to_rep
(declare-fun to_rep (udv) (_ BitVec 8))

;; of_rep
(declare-fun of_rep ((_ BitVec 8)) udv)

;; inversion_axiom
(assert
  (forall ((x udv)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)) )))

;; range_axiom
(assert (forall ((x udv)) (! (in_range (to_rep x)) :pattern ((to_rep x)) )))
...
;; mlkem__byteencodedv__b__aggregate_def
(declare-fun mlkem__byteencodedv__b__aggregate_def ((_ BitVec 8)) (Array Int u8_bit))

;; def_axiom
(assert
  (forall ((temp___2411 (_ BitVec 8)))
    (forall ((temp___2412 Int))
      (=>
        (in_range1 temp___2411)
        (= (to_rep2
             (select (mlkem__byteencodedv__b__aggregate_def temp___2411) temp___2412)) temp___2411)))))

;; Goal def'vc
;; File "mlkem.adb", line 872, characters 0-0
(assert
  (not
  (forall ((a (_ BitVec 8)) (this_bit (_ BitVec 8)))
    (forall ((b (Array Int u8_bit)))
      (=>
        (= b (mlkem__byteencodedv__b__aggregate_def #x00))
        (=>
          (in_range a)
          (=>
            (in_range this_bit)
              ...
              (=>
                ...
                (=>
                  (= (and (ite (<= 0 i) true false) (ite (<= i 255)
                                                      true
                                                      false)) true)
                  (forall ((a1 (_ BitVec 8)) (this_bit1 (_ BitVec 8)) (i1 Int))
                    (=>
                                ...
                                (=>
                                  ...
                                  (=>
                                    ...
                                    (ite (<= j 3)
                                      true
                                      false)) true)
                                    (forall ((a3 (_ BitVec 8)) (this_bit2 (_ BitVec 8)) (j1 Int))
                                      (=>
                                        (= (and (ite (and
                                                       (in_range a3)
                                                       (in_range this_bit2))
                                                  ...
                                                  false) (ite (and
                                                           ...
                                                           true
                                                           false)) true)
                                        (forall ((this_bit3 (_ BitVec 8)))
                                          (=>
                                            (= this_bit3 (bvurem a3 #x02))
                                            (in_range1 this_bit3))))))))))))))))))))))))
