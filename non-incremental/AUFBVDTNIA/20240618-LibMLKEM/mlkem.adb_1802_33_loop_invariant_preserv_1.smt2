                            ...
                            (forall ((r3 (Array Int (Array Int (Array Int t__init_wrapper)))))
                              (=>
                                (exists ((j1 Int))
                                  (and
                                    (= j1 0)
                                    (ite (= (and (ite (<= 0 j1) true false) 
                                      (ite (<= j1 2)
                                        true
                                        false)) true)
                                      (exists ((r4 (Array Int (Array Int (Array Int t__init_wrapper)))))
                                        (and
                                          (= r4 (store r2 i2 (store (select r2 i2) j1 
                                          (convert
                                            (xof_then_samplentt
                                              rho
                                              ((_ int2bv 8) j1)
                                                  ...
                                                  (and
                                                    ...
                                                    (and
                                                      (= (and (ite (and
                                                                    ...
                                                                    (not
                                                                    (= i2 temp___3149))
                                                                    (= (select r3 temp___3149) (select r2 temp___3149))
                                                                    (forall 
                                                                    ((temp___3150 Int))
                                                                    (=>
                                                                    (and
                                                                    ...
                                                                    (< temp___3150 0)
                                                                    (< j2 temp___3150)))
                                                                    (= (select (select r3 temp___3149) temp___3150) (select (select r2 temp___3149) temp___3150))))))))
                                                                    (in_range1
                                                                    j2))
                                                                true
                                                                false) 
                                ...
                                (=>
                                  (=>
                                    ...
                                    (and
                                      (and (<= 0 0) (<= 0 2))
                                      (and (<= 0 i2) (<= i2 2))))
                                  (let ((temp___3259 (of_array r3 0 i2)))
                                    (forall ((temp___3260 Int))
                                      (=>
                                        (and
                                          (<= (first temp___3259) temp___3260)
