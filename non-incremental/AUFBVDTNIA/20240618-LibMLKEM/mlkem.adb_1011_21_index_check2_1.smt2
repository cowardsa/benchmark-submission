...
;; byteencode12
(declare-fun byteencode12 ((Array Int t)) (Array Int byte))

;; byteencode12__post_axiom
(assert true)
...
(declare-const v (Array Int (Array Int t)))
...
(declare-const dummy4 k_range)

(declare-sort index_384 0)

(declare-const dummy5 index_384)

(declare-sort index_poly_zq_vector_bytes 0)

(declare-const dummy6 index_poly_zq_vector_bytes)
...
(declare-const dummy7 tinteger_32B)
...
(declare-datatypes ((us_t 0))
  (((us_tqtmk (elts (Array Int byte__init_wrapper))(rt t1)))))
...
;; of_array
(define-fun of_array ((a (Array Int byte__init_wrapper)) (f Int) (l Int)) us_t
  (us_tqtmk a (mk f l)))
...
;; Goal def'vc
;; File "mlkem.adb", line 1005, characters 0-0
(assert
  (not
        ...
        (=>
          ...
          (=>
            (ite (<= 0 383)
              ...
              (< (+ (* i 384) 383) (* i 384)))
            (let ((temp___2661 (of_array
                                 (convert
                                   (slide
                                     (byteencode12 (select v i))
                                     0
                                     (* i 384)))
                                 (* i 384)
                                 (+ (* i 384) 383))))
              (let ((temp___2665 (+ (* i 384) 383)))
                (let ((temp___2664 (* i 384)))
                  (=>
                    (=>
                      (<= temp___2664 temp___2665)
                      (and
                        (and (<= 0 temp___2664) (<= temp___2664 1151))
                        (and (<= 0 temp___2665) (<= temp___2665 1151))))
                    (let ((temp___2666 (of_array r temp___2664 temp___2665)))
                      (=>
                        (ite (<= (first temp___2661) (last temp___2661))
                          (and
                            (<= (first temp___2666) (last temp___2666))
                            (= (- (last temp___2661) (first temp___2661)) (- 
                            (last
                              temp___2666) (first temp___2666))))
                          (< (last temp___2666) (first temp___2666)))
                        (forall ((usf (Array Int byte__init_wrapper)))
                          (=>
                            (forall ((temp___2668 Int))
                              (ite (and
                                     (<= (* i 384) temp___2668)
                                     (<= temp___2668 (+ (* i 384) 383)))
                                (= (select usf temp___2668) (select (to_array
                                                                    temp___2661) temp___2668))
                                (= (select usf temp___2668) (select r temp___2668))))
                            (forall ((r1 (Array Int byte__init_wrapper)))
                              (=>
                                (= r1 usf)
                                (let ((temp___2680 (+ (* i 384) 383)))
                                  (=>
                                    (=>
                                      (<= 0 temp___2680)
                                      (and
                                        ...
                                        (and
                                          (<= 0 temp___2680)
                                          (<= temp___2680 1151))))
                                    (forall ((r2 (Array Int byte__init_wrapper)) (i1 Int))
                                      (=>
                                        (let ((temp___2690 (of_array
                                                             r2
                                                             0
                                                             (+ (* i1 384) 383))))
                                          (forall ((temp___2691 Int))
                                            (=>
                                              (and
                                                (<= (first temp___2690) temp___2691)
                                                (<= temp___2691 (last
                                                                  temp___2690)))
                                              (= (us_attr__init
                                                   (select (to_array
                                                ...
                                                (=>
                                                  ...
                                                  (let ((temp___26611 
                                                    (of_array
                                                      ...
                                                      (* i2 384)
                                                      (+ (* i2 384) 383))))
                                                    (let ((temp___26651 (+ (* i2 384) 383)))
                                                      (let ((temp___26641 (* i2 384)))
                                                        (=>
                                                          (=>
                                                            (<= temp___26641 temp___26651)
                                                            (and
                                                              (and
                                                                (<= 0 temp___26641)
                                                                (<= temp___26641 1151))
                                                          ...
                                                          (let ((temp___26661 
                                                            ...
                                                            (=>
                                                              (ite (<= 
                                                                ...
                                                                (first
                                                                  temp___26661)))
                                                              (let ((temp___2669 (* i2 384)))
                                                                (=>
                                                                  (<= temp___2669 (+ (* i2 384) 383))
                                                                  (and
                                                                    (<= 0 temp___2669)
                                                                    (<= temp___2669 1151))))))))))))))))))))))))))))))))))))
