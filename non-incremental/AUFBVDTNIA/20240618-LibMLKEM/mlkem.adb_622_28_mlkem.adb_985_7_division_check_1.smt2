...
;; temp_____aggregate_def_2641
(declare-fun temp_____aggregate_def_2641 ((_ BitVec 8)) (Array Int byte))

;; def_axiom
(assert
  (forall ((temp___2643 (_ BitVec 8)))
    (forall ((temp___2644 Int))
      (= (to_rep1
           (select (temp_____aggregate_def_2641 temp___2643) temp___2644)) temp___2643))))

;; Goal def'vc
;; File "mlkem.adb", line 985, characters 0-0
(assert
  (not
  (forall ((r (Array Int byte)))
    (=>
      (= r (temp_____aggregate_def_2641 #x00))
      (forall ((i Int))
        (=>
          (= i 0)
          (=>
            (= (and (ite (<= 0 i) true false) (ite (<= i 3071) true false)) true)
            (forall ((r1 (Array Int byte)) (i1 Int))
              (=>
                ...
                (forall ((o (_ BitVec 8)))
                  (=>
                    (let ((temp___2650 (mod2 i1 8)))
                      (ite (< temp___2650 256)
                        (= o (bvshl #x01 ((_ int_to_bv 8) temp___2650)))
                        (= o #x00)))
