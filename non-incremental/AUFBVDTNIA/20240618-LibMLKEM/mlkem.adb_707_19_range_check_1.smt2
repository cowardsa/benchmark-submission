...
;; Goal def'vc
;; File "mlkem.adb", line 685, characters 0-0
(assert
  (not
  (=>
    (in_range x)
    (forall ((t1 (_ BitVec 64)))
      (=>
        (= t1 (bvadd (bvmul (bvmul ((_ zero_extend 48) x) #x0000000000000002) #x0000000000000010) #x0000000000000D01))
            ...
            (forall ((t3 (_ BitVec 64)))
              (=>
                ...
                (forall ((t4 (_ BitVec 64)))
                  (=>
                    (= t4 (bvlshr t3 ((_ int_to_bv 64) 43)))
                    (forall ((t5 (_ BitVec 64)))
                      (=>
                        (= t5 (bvurem t4 #x0000000000000010))
                        (and
                          (bvule ((_ zero_extend 56) #x00) t5)
