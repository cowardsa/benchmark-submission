...
;; temp_____aggregate_def_2458
(declare-fun temp_____aggregate_def_2458 ((_ BitVec 8)) (Array Int byte))

;; def_axiom
(assert
  (forall ((temp___2460 (_ BitVec 8)))
    (forall ((temp___2461 Int))
      (= (to_rep1
           (select (temp_____aggregate_def_2458 temp___2460) temp___2461)) temp___2460))))

;; Goal def'vc
;; File "mlkem.adb", line 906, characters 0-0
(assert
  (not
  (forall ((r (Array Int byte)))
    (=>
      (= r (temp_____aggregate_def_2458 #x00))
      (forall ((i Int))
        (=>
          (= i 0)
          (=>
            (= (and (ite (<= 0 i) true false) (ite (<= i 2559) true false)) true)
            (forall ((i1 Int))
              (=>
                ...
                (forall ((o (_ BitVec 8)))
                  (=>
                    (let ((temp___2467 (mod2 i1 8)))
                      (ite (< temp___2467 256)
                        (= o (bvshl #x01 ((_ int_to_bv 8) temp___2467)))
                        (= o #x00)))
