...
;; mlkem__samplepolycbd_eta_2__bytestobits__r__aggregate_def
(declare-fun mlkem__samplepolycbd_eta_2__bytestobits__r__aggregate_def ((_ BitVec 8)) (Array Int u8_bit))

;; def_axiom
(assert
  (forall ((temp___2929 (_ BitVec 8)))
    (forall ((temp___2930 Int))
      (=>
        (in_range temp___2929)
        (= (to_rep1
             (select (mlkem__samplepolycbd_eta_2__bytestobits__r__aggregate_def
                       temp___2929) temp___2930)) temp___2929)))))

;; Goal def'vc
;; File "mlkem.adb", line 1511, characters 0-0
(assert
  (not true))
