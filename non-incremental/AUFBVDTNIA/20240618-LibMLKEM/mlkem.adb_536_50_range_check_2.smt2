  ...
  (forall ((param__ctx us_rep))
    (! (let ((result (in_queue_bit_length param__ctx)))
         (=>
           ...
           (and (< result 1600) (in_range7 result)))) :pattern ((in_queue_bit_length
                                                                  param__ctx)) )))
...
(assert
  (forall ((param__ctx us_rep1))
    (! (let ((result (state_of param__ctx)))
         (=> (state_of__function_guard result param__ctx) (in_range9 result))) :pattern (
    (state_of
      param__ctx)) )))
