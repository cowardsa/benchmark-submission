...
(declare-sort t226b 0)

;; in_range
(define-fun in_range3 ((x Int)) Bool
  (and (<= 0 x) (<= x 1)))

(declare-const dummy4 t226b)
...
;; Goal def'vc
;; File "mlkem.adb", line 1534, characters 0-0
(assert
  (not
  (let ((temp___result_2957 (bytestobits b)))
    (=>
      (bytestobits__function_guard temp___result_2957 b)
      (=>
        (= temp___result_2957 sb)
        (=>
          (in_range1 i)
          (forall ((r Int))
            (=>
