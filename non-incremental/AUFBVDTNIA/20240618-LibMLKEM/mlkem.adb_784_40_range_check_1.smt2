  ...
  (=>
    ...
    (=>
      ...
      (forall ((i Int))
        (=>
          (and (<= 0 i) (<= i 255))
          (in_range1 (to_rep (select temp___expr_1270 i))))))))

;; Goal def'vc
;; File "mlkem.adb", line 778, characters 0-0
(assert
  (not
  (forall ((r (Array Int t)))
    (=>
      ...
      (forall ((i Int))
        (=>
          ...
          (=>
            ...
            (forall ((r1 (Array Int t)) (i1 Int))
              (=>
                (= (and (ite (forall ((temp___2377 Int))
                               (=>
                                 (and
                                   (<= 0 temp___2377)
                                   (<= temp___2377 255))
                                 (=>
                                   (or
                                     ...
                                     (or
                                       (< temp___2377 0)
                                       (<= i1 temp___2377)))
                                   (= (select r1 temp___2377) (select r temp___2377)))))
                          true
                          false) (ite (and (<= 0 i1) (<= i1 255)) true false)) true)
                (forall ((o (_ BitVec 16)))
                  (=>
                    (= (to_rep (select y i1)) o)
                    (and
