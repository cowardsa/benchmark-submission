...
(assert
  ...
  (forall ((r (Array Int (Array Int (Array Int t__init_wrapper)))))
    (forall ((r1 (Array Int (Array Int (Array Int t__init_wrapper)))))
      (=>
        (exists ((i Int))
          (and
            (= i 0)
            (ite (= (and (ite (<= 0 i) true false) (ite (<= i 2) true false)) true)
              (exists ((r2 (Array Int (Array Int (Array Int t__init_wrapper)))) (j Int))
                (and
                  (exists ((j1 Int))
                    (and
                      (= j1 0)
                      (ite (= (and (ite (<= 0 j1) true false) (ite (<= j1 2)
                                                                true
                                                                false)) true)
                        (exists ((r3 (Array Int (Array Int (Array Int t__init_wrapper)))))
                          (and
                            (= r3 (store r i (store (select r i) j1 (convert
                                                                    (xof_then_samplentt
                                                                    rho
                                                                    ((_ int_to_bv 8) j1)
                                                                    ((_ int_to_bv 8) i))))))
                                      ...
                                      (= (and (ite (and
                                                     (forall ((temp___3149 Int))
                                                       (=>
                                                         ...
                                                         (ite (not
                                                                (= i temp___3149))
                                                           (= (select r2 temp___3149) (select r temp___3149))
                                                               ...
                                                               (=>
                                                                 (or
                                                                   ...
                                                                   (or
                                                                    (< temp___3150 0)
                                                                    (< j temp___3150)))
                                                                 (= (select (select r2 temp___3149) temp___3150) (select (select r temp___3149) temp___3150))))))))
                                                     (in_range1 j))
                                                true
                                                false) (ite (and
                                                              (<= 0 j)
                  ...
                  (and
                    ...
                    (exists ((i1 Int))
                      (and
                        (let ((temp___3259 (of_array r1 0 i1)))
                        ...
                        (and
                                             ...
                                             (=>
                                               (or
                                                 ...
                                                 (or
                                                   (< temp___3233 0)
                                                   (< i1 temp___3233)))
                                               (= (select r1 temp___3233) (select r temp___3233)))))
                                         (in_range1 i1))
                                    true
                          ...
                          (= i1 2)))))))
              (= r1 r))))
        (forall ((temp___3308 Int))
          (=>
            (and (<= 0 temp___3308) (<= temp___3308 2))
            (forall ((temp___3310 Int))
              (=>
                (and (<= 0 temp___3310) (<= temp___3310 2))
                (forall ((temp___3312 Int))
                  (=>
                    (and (<= 0 temp___3312) (<= temp___3312 255))
                    (= (us_attr__init
