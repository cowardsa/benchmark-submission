...
(declare-const ek (Array Int byte))
...
(declare-const dummy5 (Array Int t1))
...
(declare-datatypes ((map__ref1 0))
  (((map__refqtmk1 (map__content1 (Array Int (Array Int t1)))))))

;; byteencode12
(declare-fun byteencode12 ((Array Int (Array Int t1))) (Array Int byte))

;; byteencode12__post_axiom
(assert true)

;; bytedecode12
(declare-fun bytedecode12 ((Array Int byte)) (Array Int (Array Int t1)))

;; bytedecode12__post_axiom
(assert true)

(declare-const key_to_check (Array Int byte))
...
(declare-const dummy7 index_poly_zq_vector_bytes)

;; key_to_check__def_axiom
(assert
  (= key_to_check (let ((temp___625 (let ((temp___623 1151))
                                      (let ((temp___622 0))
                                        (let ((temp___624 ek)) temp___624)))))
                    (let ((temp___626 temp___625)) temp___626))))

;; Goal def'vc
;; File "mlkem.ads", line 93, characters 0-0
(assert
  (not
  (=>
    (=>
    ...
    (=>
      (= ek key_to_check)
      (forall ((decoded (Array Int (Array Int t1))))
        (=>
          (= decoded (bytedecode12 key_to_check))
          (forall ((reencoded (Array Int byte)))
            (=>
              (= reencoded (byteencode12 decoded))
              (let ((o (of_array reencoded 0 1151)))
                (let ((o1 (of_array key_to_check 0 1151)))
