  ...
  (forall ((b (Array Int u8_bit)))
    (=>
      ...
      (forall ((b1 (Array Int u8_bit)))
        (=>
          (forall ((temp___2583 (Array Int u8_bit)))
            (bits_12_to_u16__function_guard
              (bits_12_to_u16 temp___2583)
              temp___2583))
          (=>
            (forall ((temp___2604 (Array Int u8_bit)))
              (bits_12_to_u16__function_guard
                (bits_12_to_u16 temp___2604)
                temp___2604))
            (=>
              (forall ((temp___2617 (Array Int u8_bit)))
                (bits_12_to_u16__function_guard
                  (bits_12_to_u16 temp___2617)
                  temp___2617))
              (=>
                (forall ((temp___2617 (Array Int u8_bit)))
                  (bits_12_to_u16__function_guard
                ...
                (=>
                  (forall ((temp___2623 (Array Int u8_bit)))
                    (bits_12_to_u16__function_guard
                      (bits_12_to_u16 temp___2623)
                      temp___2623))
                  (=>
                    (exists ((i Int))
                      (and
                        (= i 0)
                        (ite (= (and (ite (<= 0 i) true false) (ite (<= i 255)
                                                                 true
                                                                 false)) true)
                    ...
                    (forall ((usf Int))
                      (=>
                        (= (and (ite (<= 0 usf) true false) (ite (<= usf 255)
                                                              true
                                                              false)) true)
                        (let ((temp___2625 (+ (* usf 12) 11)))
                          (let ((temp___2624 (* usf 12)))
                            (=>
                              (<= temp___2624 temp___2625)
                              (and
                                (and
                                  (<= 0 temp___2624)
                                  (<= temp___2624 3071))
