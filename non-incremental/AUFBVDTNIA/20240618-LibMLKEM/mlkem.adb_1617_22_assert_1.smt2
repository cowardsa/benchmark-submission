...
(declare-const dummy5 ntt_len_bit_index)
...
(declare-const dummy9 tinteger_32B)
...
;; Goal def'vc
;; File "mlkem.adb", line 1562, characters 0-0
(assert
  (not
          ...
          (forall ((f_hat (Array Int t)))
            (=>
              ...
              (forall ((k1 (_ BitVec 8)))
                (=>
                  (= k1 #x01)
                  (forall ((f_hat1 (Array Int t)) (k2 (_ BitVec 8)))
                    (=>
                      (exists ((i Int))
                        (and
                          (= i 0)
                          (ite (= (and (ite (<= 0 i) true false) (ite (<= i 6)
                                                                   true
                                                                   false)) true)
                            (let ((temp___2967 (power 2 (- 7 i))))
                              (and
                                (exists ((i1 Int))
                                  (and
                                    (and (<= 1 i1) (<= i1 7))
                                    (= temp___2967 (power 2 i1))))
                                (exists ((len1 Int))
                                  (and
                                    (= len1 temp___2967)
                                    (let ((temp___2972 (power 2 i)))
                                      (and
                                        (exists ((i1 Int))
                                          (and
                                            (and (<= 0 i1) (<= i1 6))
                                            (= temp___2972 (power 2 i1))))
                                        (exists ((count1 Int))
                                          (and
                                            (= count1 temp___2972)
                                            (exists ((r232b Int))
                                              (and
                                                ...
                                                (and
                                                  (in_range1 r232b)
                                                  (exists ((f_hat2 (Array Int t)) (k3 (_ BitVec 8)) (j Int))
                                                    (and
                                                      (exists ((j1 Int))
                                                        (and
                                                          (= j1 0)
                                                          (ite (= (and 
                                                            ...
                                                            (ite (<= j1 r232b)
                                                              true
                                                              false)) true)
                                                            (exists ((k4 (_ BitVec 8)))
                                                              (and
                                                                (and
                                                                  (= (* count1 len1) 128)
                                                                  (and
                                                                    (let ((temp___2984 (* (* j len1) 2)))
                                                                    (and
                                                                    (<= 0 temp___2984)
                                                                    (<= temp___2984 252)))
                                                                    (= (bv2nat k4) (+ 
                                                        ...
                                                        (and
                                                          ...
                                                          (and
                                                            ...
                                                            (power
                                                              2
                                                              (+ i 1)))
                                                            (exists ((len2 Int) (count2 Int) (i1 Int) (r232b1 Int))
                                                              (and
                                                                (= (bv2nat k2) 
                                                                (power
                                                                  2
