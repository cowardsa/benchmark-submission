...
(((us_split_fieldsqtmk1
  (rec__ada___names__data__char_tables__vector us_main_type1)))))
(define-fun us_split_fields_rec__ada___names__data__char_tables__vector__projection ((a us_split_fields2)) us_main_type1 
...
(define-fun dynamic_invariant1 ((temp___expr_297 us_rep1)
...
(define-fun bool_eq ((a (Array (_ BitVec 32) name_id))
  ...
  (b__last (_ BitVec 32))) Bool (ite (and
                                     ...
                                     (= (to_rep2 (select a temp___idx_173)) 
                                     (to_rep2
...
;; bool_eq_rev
  ...
  (= (to_rep2 (select a temp___idx_173)) (to_rep2
                                         (select b (bvadd (bvsub b__first a__first) temp___idx_173)))))))))))
...
;; def_axiom
  ...
  (forall ((temp___518 (_ BitVec 32)))
  (= (select (names__hash_table__aggregate_def temp___517) temp___518) 
  rliteral)))))
...
(define-fun last1 ((container us_rep3)) Int (+ (- 1) (length1 container)))

(declare-fun last__function_guard1 (Int us_rep3) Bool)

(define-fun last_index1 ((container us_rep1)) Int (last1 (model2 container)))
...
;; valid_hashes__def_axiom
  ...
  (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true)
     ...
     (<= (to_rep2 (select names__hash_table h)) (last_index
                                                (us_repqtmk
...
(define-fun element ((container us_rep)
  (index Int)) us_rep4 (get (model1 container) index))
...
(define-fun dynamic_invariant5 ((temp___expr_322 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_284 Int)
...
(define-fun capacity ((container us_rep1)) Int (ite (= (distinct 0 0) true)
                                               (to_rep1
                                               (rec__ada___names__data__char_tables__vector__capacity
...
;; model__post_axiom
  (assert
  (forall ((container us_rep1))
  (! (= (length1 (model2 container)) (length2 container)) :pattern ((model2
                                                                    container)) )))
...
(define-fun dynamic_invariant8 ((temp___expr_307 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant4 result true
...
(declare-fun user_eq15 (extended_index2 extended_index2) Bool)

(declare-const dummy15 extended_index2)

(declare-datatypes ((extended_index__ref2 0))
(((extended_index__refqtmk2 (extended_index__content2 extended_index2)))))
(define-fun extended_index__ref_extended_index__content__projection ((a extended_index__ref2)) extended_index2 
  (extended_index__content2 a))

(define-fun dynamic_invariant9 ((temp___expr_197 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length3 container)))
     (and (<= result (capacity1 container)) (dynamic_invariant10 result true
     false true true))) :pattern ((length3 container)) )))

(define-fun default_initial_assumption3 ((temp___expr_242 us_rep2)
...
(define-fun dynamic_invariant11 ((temp___expr_263 Int)
...
(declare-fun user_eq17 (extended_index3 extended_index3) Bool)

(declare-const dummy17 extended_index3)
...
(define-fun dynamic_invariant12 ((temp___expr_234 Int)
...
(assert
;; defqtvc
 ;; File "names.ads", line 27, characters 0-0
  (not
  (forall ((entry_table__split_fields us_main_type)
  (char_table__split_fields us_main_type1)
  (hash_table (Array (_ BitVec 32) name_id)))
  (=> (dynamic_invariant2 no_name true false true true)
  (=> (= hash_table (names__hash_table__aggregate_def 0))
  (=> (in_range2 1024)
  (=> (default_initial_assumption1
  (us_repqtmk1 char_table__split_discrs
  (us_split_fieldsqtmk1 char_table__split_fields)) false)
  (=> (dynamic_invariant1
  (us_repqtmk1 char_table__split_discrs
  (us_split_fieldsqtmk1 char_table__split_fields)) false false true true)
  (=> (in_range 256)
  (=> (default_initial_assumption
  (us_repqtmk entry_table__split_discrs
  (us_split_fieldsqtmk entry_table__split_fields)) false)
  (=> (dynamic_invariant
  (us_repqtmk entry_table__split_discrs
  (us_split_fieldsqtmk entry_table__split_fields)) false false true true)
  (let ((result (invariant__ hash_table
  ...
  (char_table__split_fields1 us_main_type1)) (valid_tables__function_guard
  ...
  (=>
  (forall ((entry_table__split_fields1 us_main_type)
  (char_table__split_fields1 us_main_type1))
  (valid_name_table__function_guard
  ...
  (=>
  (and (invariant____function_guard result hash_table
  (us_split_fieldsqtmk1 char_table__split_fields)
  (us_split_fieldsqtmk entry_table__split_fields))
  (= (= result true)
  (and
