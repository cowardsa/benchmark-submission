...
;; defqtvc
 ;; File "very_longs.ads", line 49, characters 0-0
  ...
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1038) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___1047)
               (<= temp___1047 (last1 result____split_fields2)))
               (=>
               (or (< temp___1038 temp___1047)
               (or (< temp___1047 1) (<= i1 temp___1047)))
               (= (select (to_array result____split_fields2) temp___1047) (select 
  ...
  (let ((temp___1039 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1039) i1) (<= i1 (last1 temp___1039)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1039) i1)) o2)
  (forall ((l_digit2 (_ BitVec 16)))
  (=> (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1040 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1040) i1) (<= i1 (last1 temp___1040)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1040) i1)) o3)
