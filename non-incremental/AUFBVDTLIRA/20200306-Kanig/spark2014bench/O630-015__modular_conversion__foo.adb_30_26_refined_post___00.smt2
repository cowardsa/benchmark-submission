...
(((map__refqtmk (map__content (Array Int unsigned_64))))))
...
;; defqtvc
 ;; File "foo.ads", line 16, characters 0-0
  (not
  (forall ((data (_ BitVec 64)) (value (Array Int unsigned_64))
  (o (_ BitVec 64)) (data1 (_ BitVec 64)))
  (=> (dynamic_invariant field true false true true)
  (=> (dynamic_invariant1 data false false true true)
