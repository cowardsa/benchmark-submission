...
(declare-fun temp_____aggregate_def_1110 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1112 (_ BitVec 8)))
  (forall ((temp___1113 Int) (temp___1114 Int))
  (let ((temp___1111 (temp_____aggregate_def_1110 temp___1112 temp___1113
                     temp___1114)))
  (=> (dynamic_invariant3 temp___1112 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1113 temp___1114)
  (and (= (first1 temp___1111) temp___1113)
  (= (last1 temp___1111) temp___1114)))
  (forall ((temp___1115 Int))
  (= (to_rep2 (select (to_array temp___1111) temp___1115)) temp___1112))))))))
...
;; defqtvc
 ;; File "very_longs.ads", line 61, characters 0-0
  ...
  (let ((temp___1116 (temp_____aggregate_def_1110 #x00 1 (+ o3 o2))))
  (=> (= (first1 temp___1116) 1)
  (=>
  (= (last1 temp___1116) (+ (to_rep
                            (rec__very_longs__very_long__length
                            (us_split_discrs1 l))) (to_rep
                                                   (rec__very_longs__very_long__length
                                                   (us_split_discrs1 r)))))
  (=>
  (ite (<= (first1 temp___1116) (last1 temp___1116))
  (and
  ...
  (= (- (last1 temp___1116) (first1 temp___1116)) (- (+ (to_rep
                                                        (rec__very_longs__very_long__length
                                                        (us_split_discrs1 l))) 
  ...
  (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1))
  (let ((temp___1118 (of_array (to_array temp___1116) (first1 temp___1116)
                     (last1 temp___1116))))
  (=>
  (ite (<= (first1 temp___1118) (last1 temp___1118))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1118) (first1 temp___1118)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1118)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1123 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r)))))
  (exists ((j Int))
  (and (= j 1)
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1123) true false)) true)
  ...
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1125) true false)) true)
  ...
  (= (and (ite (and
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1126 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1126) i1) (<= i1 (last1 temp___1126)))
  (exists ((o4 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1126) i1)) o4)
  (exists ((l_digit3 (_ BitVec 16)))
  (and (= l_digit3 ((_ zero_extend 8) o4))
  (let ((temp___1127 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1127) j1) (<= j1 (last1 temp___1127)))
  (exists ((o5 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1127) j1)) o5)
  (exists ((r_digit3 (_ BitVec 16)))
  (and (= r_digit3 ((_ zero_extend 8) o5))
  (let ((o6 (+ i1 j1)))
  (and (in_range2 o6)
  (let ((temp___1129 (- o6 1)))
  (and
  (and (<= (first1 result____split_fields5) temp___1129)
  (<= temp___1129 (last1 result____split_fields5)))
  (exists ((o7 (_ BitVec 8)))
  (and
  (= (to_rep2 (select (to_array result____split_fields5) temp___1129)) o7)
