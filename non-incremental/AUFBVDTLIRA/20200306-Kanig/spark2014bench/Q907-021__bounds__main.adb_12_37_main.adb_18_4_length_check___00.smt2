...
;; defqtvc
 ;; File "main.adb", line 4, characters 0-0
  (not
  (forall ((payload_bytes (Array Int byte)))
  (=> (= payload_bytes (main__payload_bytes__aggregate_def #x00))
  (let ((main__C8b__assume (serialize Tuple0)))
  (=>
  (and (serialize__function_guard main__C8b__assume Tuple0)
  (dynamic_invariant main__C8b__assume true false true true))
  (=> (= main__C8b__assume c8b)
  (=> (dynamic_invariant c8b true false true true)
  (=>
  (ite (<= (first1 c8b) (last1 c8b)) (<= (first1 c8b) (last1 c8b))
  (< (last1 c8b) (first1 c8b)))
  (let ((temp___244 (of_array
                    (slide (to_array c8b) (first1 c8b) (first1 c8b))
                    (first1 c8b) (last1 c8b))))
  (let ((temp___246 (last1 c8b)))
  (let ((temp___245 (first1 c8b)))
  (=>
  (=> (<= temp___245 temp___246)
  (and (and (<= 1 temp___245) (<= temp___245 100))
  (and (<= 1 temp___246) (<= temp___246 100))))
  (let ((temp___247 (of_array payload_bytes temp___245 temp___246)))
  (=> (<= (first1 temp___244) (last1 temp___244))
  (<= (first1 temp___247) (last1 temp___247)))))))))))))))))
(check-sat)
(exit)
