...
;; defqtvc
 ;; File "very_longs.ads", line 65, characters 0-0
  ...
  (=> (= j temp___1203)
  (=>
  (= (and (ite (<= 1 j) true false) (ite (<= j temp___1203) true false)) true)
  (forall ((quotient__split_fields2 us_t) (u__split_fields2 us_t)
  ...
  (= (and (ite (and
               ...
               (us_split_fieldsqtmk1 u__split_fields2)) false true true true)
               (dynamic_invariant
               (us_repqtmk quotient__split_discrs
  ...
  (=> (dynamic_invariant6 q_hat2 true true true true)
  (=> (in_range1 j1)
  (forall ((u__split_fields3 us_t) (current_borrow2 (_ BitVec 16)))
  (=>
  (and (dynamic_invariant2
  (us_repqtmk1 u__split_discrs (us_split_fieldsqtmk1 u__split_fields3)) true
