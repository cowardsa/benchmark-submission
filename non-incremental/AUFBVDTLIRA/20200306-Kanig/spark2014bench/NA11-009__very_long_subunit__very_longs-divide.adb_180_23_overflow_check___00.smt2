...
;; defqtvc
 ;; File "very_longs-divide.adb", line 145, characters 0-0
  ...
  (=> (= n r125b)
  (=> (dynamic_invariant6 r125b true false true true)
  (=>
  (let ((temp___1366 r125b))
  (exists ((divisor_index Int))
  (and (= divisor_index 1)
  (ite (= (and (ite (<= 1 divisor_index) true false) (ite (<= divisor_index temp___1366)
                                                     true false)) true)
  ...
  (= (and (ite (and
               ...
               (and
               (and
               (and (dynamic_invariant2 product2 false true true true)
  ...
  (and (in_range2 o2)
  (let ((temp___1369 (- o2 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1369)
  (<= temp___1369 (last1 u__split_fields2)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields2) temp___1369)) o3)
  (and
  ...
  (let ((o2 (+ j divisor_index1)))
  (and (in_range2 o2)
  (let ((temp___1371 (- o2 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1371)
  (<= temp___1371 (last1 u__split_fields2)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields2) temp___1371)) o3)
  (exists ((o4 octet))
  (and
  ...
  (and (in_range2 o5)
  (let ((temp___1373 (- o5 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1373)
  (<= temp___1373 (last1 u__split_fields2)))
  (and
  (= u__split_fields1 (us_tqtmk
                      (store (to_array u__split_fields2) temp___1373 o4)
                      (rt u__split_fields2)))
  (and (= current_borrow2 future_borrow1) (= divisor_index1 temp___1366))))))))))))))))))))))))))))
  (and
  (and
  (and
