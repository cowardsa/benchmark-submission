...
;; defqtvc
 ;; File "finnuc.ads", line 45, characters 0-0
  ...
  (logic_index (_ BitVec 8)) (logic_index_1 (_ BitVec 8))
  (mux_out1 (Array Int Bool)) (mux_out1_1 (Array Int Bool))
  (logic_table map1) (logic_table_1 map1) (logical_operator1_out1 Bool)
  (mux_out11 (Array Int Bool)) (mux_out12 (Array Int Bool))
  (mux_out13 (Array Int Bool)))
