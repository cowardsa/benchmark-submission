...
(declare-fun user_eq2 (endpoint_range endpoint_range) Bool)

(declare-const dummy2 endpoint_range)
...
(define-fun dynamic_invariant2 ((temp___expr_181 Int)
  ...
  (temp___do_typ_inv_180 Bool)) Bool (=>
                                     ...
                                     (<= 2 3)) (in_range2 temp___expr_181)))

;; physical__post_axiom
  (assert
  (forall ((ep Int))
  (! (=> (dynamic_invariant2 ep true true true true)
     (let ((result (physical ep)))
     (=> (physical__function_guard result ep) (dynamic_invariant1 result true
     false true true)))) :pattern ((physical ep)) )))
...
(define-fun to_int4 ((x word64)) Int (ubv_to_int (to_rep x)))
...
(define-fun to_int5 ((x word32)) Int (ubv_to_int (to_rep1 x)))
...
(define-fun to_int6 ((x ring_range)) Int (ubv_to_int (to_rep2 x)))

;; range_int_axiom
  (assert
  (forall ((x ring_range)) (! (in_range_int
...
(((map__refqtmk2 (map__content2 (Array Int us_rep1))))))
...
(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 19)))
...
(declare-fun user_eq8 (error error) Bool)

(declare-const dummy8 error)

(declare-datatypes ((error__ref 0))
(((error__refqtmk (error__content error)))))
(define-fun error__ref_error__content__projection ((a error__ref)) error 
  (error__content a))
...
(define-fun dynamic_invariant3 ((temp___expr_208 Int)
  ...
  (temp___do_typ_inv_207 Bool)) Bool (=>
                                     ...
                                     (<= 0 19)) (in_range4 temp___expr_208)))

(define-fun dynamic_invariant4 ((temp___expr_235 (_ BitVec 8))
...
(define-fun dynamic_invariant5 ((temp___expr_249 (_ BitVec 32))
  (temp___is_init_245 Bool) (temp___skip_constant_246 Bool)
  (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool true)
...
(assert
;; defqtvc
 ;; File "hw-dbc-transfer_rings.ads", line 38, characters 0-0
  (not
  (forall ((current (_ BitVec 8)))
  (=> (dynamic_invariant2 ep true false true true)
  (=> (dynamic_invariant1 pointer true false true true)
  (=> (dynamic_invariant3 status true false true true)
  (=> (dynamic_invariant remaining_length true false true true)
  (=> (dynamic_invariant4 current false false true true)
  (let ((o ep))
  (let ((o1 (physical o)))
  (=>
  (and (physical__function_guard o1 o) (dynamic_invariant1 o1 true false true
  true))
  (let ((o2 ep))
  (let ((o3 (physical o2)))
  (=>
  (and (physical__function_guard o3 o2) (dynamic_invariant1 o3 true false
  true true))
  (let ((o4 ep))
  (let ((o5 (physical o4)))
  (=>
  (and (physical__function_guard o5 o4) (dynamic_invariant1 o5 true false
  true true))
  (forall ((spark__branch Bool))
  (=>
  (= spark__branch (and (and (ite (bvule o5 pointer) true false) (ite (bvult (bvsub 
                                                                 pointer o3) #x0000000000000400)
                                                                 true false)) 
  (ite (= (bvurem (bvsub pointer o1) #x0000000000000010) #x0000000000000000)
  true false)))
  (=> (= spark__branch true)
  (let ((o6 ep))
  (let ((o7 (physical o6)))
