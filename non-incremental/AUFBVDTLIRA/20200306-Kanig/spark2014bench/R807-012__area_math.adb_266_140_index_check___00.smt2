...
;; defqtvc
 ;; File "area_math.ads", line 46, characters 0-0
  ...
  (=> (= (to_rep2 (select (to_array temp___523) temp___524)) o5)
  (=> (not (= o5 #xFFFFFFFF))
  (forall ((o6 Int))
  ...
  (let ((o7 (+ i 1)))
  (=> (in_range1 o7)
  (=> (and (<= (first1 temp___527) o7) (<= o7 (last1 temp___527)))
  (forall ((o8 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___527) o7)) o8)
  (forall ((temp___526 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) temp___526)
  (<= (first1 (rec__area_math__ensemble__to1 result____split_fields4)) temp___526)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
