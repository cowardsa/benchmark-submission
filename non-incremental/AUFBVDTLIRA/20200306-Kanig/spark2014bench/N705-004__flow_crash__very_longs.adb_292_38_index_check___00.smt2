...
;; defqtvc
 ;; File "very_longs.ads", line 59, characters 0-0
  ...
  (let ((temp___1139 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1139) i1) (<= i1 (last1 temp___1139)))
  (forall ((o5 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1139) i1)) o5)
  (forall ((l_digit3 (_ BitVec 16)))
  (=> (= l_digit3 ((_ zero_extend 8) o5))
  (let ((temp___1140 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1140) j1) (<= j1 (last1 temp___1140)))
  (forall ((o6 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1140) j1)) o6)
  (forall ((r_digit3 (_ BitVec 16)))
  (=> (= r_digit3 ((_ zero_extend 8) o6))
  (let ((o7 (+ i1 j1)))
  (=> (in_range2 o7)
  (let ((temp___1142 (- o7 1)))
  (=>
  (and (<= (first1 result____split_fields3) temp___1142)
  (<= temp___1142 (last1 result____split_fields3)))
  (forall ((o8 (_ BitVec 8)))
  (=>
  (= (to_rep2 (select (to_array result____split_fields3) temp___1142)) o8)
  (forall ((t_digit3 (_ BitVec 16)))
  (=> (= t_digit3 ((_ zero_extend 8) o8))
  ...
  (=> (= (to_rep2 o10) o9)
  (let ((o11 (+ i1 j1)))
  (=> (in_range2 o11) (<= (first1 result____split_fields3) (- o11 1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
