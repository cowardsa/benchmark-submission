...
(assert
;; defqtvc
 ;; File "x86.ads", line 40, characters 0-0
  (not
  (forall ((xsi (Array Int unsigned_8)) (o (_ BitVec 8)) (o1 (_ BitVec 8))
  (o2 (_ BitVec 8)) (o3 (_ BitVec 8)) (x86__esi__result (_ BitVec 32)))
  (=> (= (to_rep (select xsi 3)) o)
  (=> (= (to_rep (select xsi 2)) o1)
  (=> (= (to_rep (select xsi 1)) o2)
  (=> (= (to_rep (select xsi 0)) o3)
  (=>
  (= x86__esi__result (bvadd (bvadd (bvadd ((_ zero_extend 24) o3) (bvmul ((_ zero_extend 24) o2) #x00000100)) (bvmul ((_ zero_extend 24) o1) #x00010000)) (bvmul ((_ zero_extend 24) o) #x01000000)))
  (= x86__esi__result (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep
                                                               (select xsi 0))) (bvmul ((_ zero_extend 24) 
