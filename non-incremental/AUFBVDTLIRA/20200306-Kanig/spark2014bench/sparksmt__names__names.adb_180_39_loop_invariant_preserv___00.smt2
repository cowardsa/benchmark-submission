...
;; defqtvc
 ;; File "names.ads", line 51, characters 0-0
  ...
  (= (valid_hashes hash_table
     (us_split_fieldsqtmk entry_table__split_fields)) true))))
  (forall ((s2 (Array Int character)) (i1 Int))
  (=>
  (forall ((entry_table__split_fields1 us_main_type)
  (char_table__split_fields1 us_main_type2)
  (hash_table1 (Array (_ BitVec 32) name_id))) (invariant____function_guard
  ...
  (=>
  (= (to_rep6
     (rec__ada___names__data__name_entry__table_index (us_split_fields5 e))) o7)
  (let ((o8 (+ o7 (- i2 1))))
  (=> (in_range13 o8)
  (=> (in_range14 o8)
  (let ((o9 (us_repqtmk1 char_table__split_discrs
            (us_split_fieldsqtmk1 char_table__split_fields))))
  (let ((o10 (element1 o9 o8)))
  (=>
  (and (dynamic_invariant4 o10 true false true true)
  (= o10 (get1 (model2 o9) o8)))
  (forall ((o11 character))
  (=> (= (to_rep1 o11) o10)
  (let ((temp___inv_5701 (invariant__ hash_table
                         (us_split_fieldsqtmk1 char_table__split_fields)
                         (us_split_fieldsqtmk entry_table__split_fields))))
  (=>
  (forall ((entry_table__split_fields1 us_main_type)
  ...
  hash_table1 (us_split_fieldsqtmk entry_table__split_fields1)))
  (=>
  (and (invariant____function_guard temp___inv_5701 hash_table
  (us_split_fieldsqtmk1 char_table__split_fields)
  (us_split_fieldsqtmk entry_table__split_fields))
