...
(define-fun dynamic_invariant1 ((temp___expr_171 (_ BitVec 32))
  (temp___is_init_167 Bool) (temp___skip_constant_168 Bool)
  (temp___do_toplevel_169 Bool) (temp___do_typ_inv_170 Bool)) Bool true)

(declare-sort xdr_boolean 0)
...
(declare-fun user_eq5 (xdr_boolean xdr_boolean) Bool)

(declare-const dummy5 xdr_boolean)

(declare-datatypes ((xdr_boolean__ref 0))
(((xdr_boolean__refqtmk (xdr_boolean__content xdr_boolean)))))
(define-fun xdr_boolean__ref_xdr_boolean__content__projection ((a xdr_boolean__ref)) xdr_boolean 
  (xdr_boolean__content a))
...
(assert
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 86, characters 0-0
  (not
  (forall ((last2 Int) (temporary (_ BitVec 32)) (temporary1 (_ BitVec 32)))
  (=> (dynamic_invariant2 value true false true true)
  ...
  (=> (dynamic_invariant1 temporary false false true true)
  (=>
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (= value 0) true false))
