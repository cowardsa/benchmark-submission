...
;; defqtvc
 ;; File "ring_buf.ads", line 61, characters 0-0
  ...
  (= o1 (ite (< 65535 (- (+ (ubv_to_int (to_rep1
                                    (rec__ring_buf__ring_buffer__first
        ...
        (let ((temp___213 (of_array
                          ...
                          (bvsub (bvsub (bvadd #x0000 ((_ int_to_bv 16) 
                          (to_rep2
                          (rec__ring_buf__ring_buffer__length
        ...
        (first1 temp___212)
        ((_ int_to_bv 16) (- (+ (ubv_to_int (first1 temp___212)) (+ (length1
                                                             (ubv_to_int 
                                                             (first1
                                                             temp___212))
                                                             (ubv_to_int 
                                                             (last1
                                                             temp___212))) 
        (length1 (ubv_to_int (first1 temp___213)) (ubv_to_int (last1 temp___213))))) 1))))))
        (let ((temp___217 (of_array
                          ...
                          (bvsub (bvadd (to_rep1
                                        (rec__ring_buf__ring_buffer__first
                                        (us_split_fields1 o))) ((_ int_to_bv 16) 
                          (to_rep2
                          (rec__ring_buf__ring_buffer__length
