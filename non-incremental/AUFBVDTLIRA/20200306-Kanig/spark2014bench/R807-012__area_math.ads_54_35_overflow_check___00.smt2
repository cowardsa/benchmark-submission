...
;; defqtvc
 ;; File "area_math.ads", line 46, characters 0-0
  ...
  (=> (is_consistent__function_guard (is_consistent e) e)
  (=>
  (forall ((result____split_fields5 us_split_fields2))
  ...
  (exists ((i Int))
  (and (= i 0)
  (ite (= (and (ite (<= 0 i) true false) (ite (<= i temp___449) true false)) true)
  (exists ((skip Bool))
  (and (= skip (distinct 0 0))
  (exists ((spark__branch Bool) (prev1 (_ BitVec 32)) (skip1 Bool))
  (and
  ...
  (= skip1 skip)))))
  (exists ((spark__branch1 Bool) (next1 (_ BitVec 32)) (skip2 Bool))
  (and
  (exists ((o4 Int))
  ...
  (= skip2 skip1)))))))
  (exists ((spark__branch2 Bool) (result____split_fields5 us_split_fields2))
  (and
  ...
  (and
  (= result____split_fields6 (us_split_fieldsqtmk1 o6
                             (rec__area_math__ensemble__from1
                             result____split_fields3)
                             (rec__area_math__ensemble__to1
                             result____split_fields3)))
  (let ((temp___462 (rec__area_math__ensemble__from1 result____split_fields6)))
  (exists ((o7 address_type))
  (and (= (to_rep2 o7) prev1)
  (exists ((temp___463 Int))
  (and
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields6)) temp___463)
  (and
  ...
  (us_tqtmk
  (store (to_array (rec__area_math__ensemble__from1 result____split_fields6)) temp___463 o7)
  (rt (rec__area_math__ensemble__from1 result____split_fields6)))
  ...
  (= result____split_fields7 (us_split_fieldsqtmk1
                             ...
                             (store (to_array
                                    (rec__area_math__ensemble__from1
                                    result____split_fields6)) temp___463 o7)
                             (rt
                             (rec__area_math__ensemble__from1
                             result____split_fields6)))
                             (rec__area_math__ensemble__to1
                             result____split_fields6)))
  (let ((temp___467 (rec__area_math__ensemble__to1 result____split_fields7)))
  (exists ((o8 address_type))
  (and (= (to_rep2 o8) next1)
  (exists ((temp___468 Int))
  (and
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields7)) temp___468)
  (and
  ...
  (rec__area_math__ensemble__from1 result____split_fields7)
  (us_tqtmk
  (store (to_array (rec__area_math__ensemble__to1 result____split_fields7)) temp___468 o8)
  (rt (rec__area_math__ensemble__to1 result____split_fields7))))))
  (and
  (= result____split_fields5 (us_split_fieldsqtmk1
                             ...
                             (store (to_array
                                    (rec__area_math__ensemble__to1
                                    result____split_fields7)) temp___468 o8)
                             (rt
                             (rec__area_math__ensemble__to1
                             result____split_fields7)))))
  (and
  ...
  (exists ((o4 Int))
  (and
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields5)) o4)
  (exists ((prev2 (_ BitVec 32)) (next2 (_ BitVec 32)) (skip3 Bool) (i1 Int))
  (and
  (and
  (<= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) (+ i1 1))
  (and
  (=> (not (= skip3 true))
  ...
  (= (and (ite (and
               ...
               (us_repqtmk1 result____split_discrs result____split_fields4)
               false true true true))
          true false) (ite (and (<= 0 i1) (<= i1 r61b)) true false)) true)
  (= i1 temp___449)))))))))))))))
  (= result____split_fields4 result____split_fields3)))))
  (forall ((area_math__Onot__result us_rep))
  (=>
  (= area_math__Onot__result (to_base
                             (us_repqtmk1 result____split_discrs
                             result____split_fields4)))
  (forall ((o4 Bool))
  (=>
  (forall ((area_math__Onot__result1 us_rep) (b (_ BitVec 32)))
  (olt__function_guard (olt b area_math__Onot__result1) b
  area_math__Onot__result1))
  (=>
  (forall ((b (_ BitVec 32))) (olt__function_guard (olt (bvnot b) e)
  (bvnot b) e))
  (=>
  (exists ((o5 Bool))
  (and
  (let ((o6 (is_consistent area_math__Onot__result)))
  (and
  (and (is_consistent__function_guard o6 area_math__Onot__result)
  (= (= o6 true)
  (and
  (forall ((r Int))
  (=>
  ...
  (<= r (- (to_rep
           (rec__area_math__ensemble__size
           (us_split_fields1 area_math__Onot__result))) 1)))
  (and
  (bvult (to_rep2
         (select (to_array
                 (rec__area_math__ensemble__to
                 (us_split_fields1 area_math__Onot__result))) r)) (to_rep2
                                                                  (select 
                                                                  (to_array
                                                                  (rec__area_math__ensemble__from
                                                                  (us_split_fields1
                                                                  area_math__Onot__result))) (+ r 1))))
  (bvugt (bvsub (to_rep2
                (select (to_array
                        (rec__area_math__ensemble__from
                        (us_split_fields1 area_math__Onot__result))) (+ r 1))) 
  (to_rep2
  (select (to_array
          (rec__area_math__ensemble__to
          (us_split_fields1 area_math__Onot__result))) r))) #x00000001))))
  (forall ((r Int))
  (=>
  (and (<= 1 r)
  (<= r (to_rep
        (rec__area_math__ensemble__size
        (us_split_fields1 area_math__Onot__result)))))
  (bvule (to_rep2
         (select (to_array
                 (rec__area_math__ensemble__from
                 (us_split_fields1 area_math__Onot__result))) r)) (to_rep2
                                                                  ...
                                                                  (rec__area_math__ensemble__to
                                                                  (us_split_fields1
                                                                  area_math__Onot__result))) r))))))))
  (ite (= o6 true)
  (= o5 (ite (forall ((b (_ BitVec 32)))
             (=> (and (bvule #x00000000 b) (bvule b #xFFFFFFFF))
             (= (= (olt b area_math__Onot__result) true)
             (= (olt (bvnot b) e) true))))
        true false))
  (= o5 false))))
  (ite (= o5 true)
  ...
  (= (to_rep
     (rec__area_math__ensemble__size
     (us_split_fields1 area_math__Onot__result))) o8)
  (= o4 (ite (<= o8 o7) true false)))))))) (= o4 false))))
  (=> (= o4 true)
  (forall ((o5 Int))
  (=> (= (to_rep (rec__area_math__ensemble__size (us_split_fields1 e))) o5)
  (in_range1 (+ o5 1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
