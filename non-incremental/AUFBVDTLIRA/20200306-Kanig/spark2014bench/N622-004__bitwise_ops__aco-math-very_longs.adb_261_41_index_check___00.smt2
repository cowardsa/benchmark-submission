...
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 64, characters 0-0
  ...
  (=> (= (to_rep2 (select (to_array temp___1266) i1)) o2)
  ...
  (let ((temp___1267 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1267) j1) (<= j1 (last1 temp___1267)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1267) j1)) o3)
  ...
  (let ((o4 (+ i1 j1)))
  (=> (in_range2 o4)
  (let ((temp___1274 (- o4 1)))
  (forall ((spark__branch Bool))
  (=>
  (= spark__branch (and (ite (<= 1 temp___1274) true false) (ite (<= temp___1274 
                                                            r82b) true false)))
  (=> (= spark__branch true)
  (let ((o5 (+ i1 j1)))
  (=> (in_range2 o5)
  (let ((temp___1269 (- o5 1)))
  (=>
  (and (<= (first1 result____split_fields3) temp___1269)
  (<= temp___1269 (last1 result____split_fields3)))
  (forall ((o6 (_ BitVec 8)))
  (=>
  (= (to_rep2 (select (to_array result____split_fields3) temp___1269)) o6)
