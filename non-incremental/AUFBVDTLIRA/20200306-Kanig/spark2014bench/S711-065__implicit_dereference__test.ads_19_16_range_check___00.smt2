...
(define-fun dynamic_invariant ((temp___expr_168 us_t)
...
(((t41s__refqtmk (t41s__content us_t)))))
(define-fun t41s__ref_t41s__content__projection ((a t41s__ref)) us_t 
  (t41s__content a))

(declare-sort t42s 0)

(declare-fun t42sqtint (t42s) Int)

;; t42s'axiom
  (assert
  (forall ((i t42s)) (and (<= 0 (t42sqtint i)) (<= (t42sqtint i) 1))))
...
(declare-fun user_eq4 (t42s t42s) Bool)

(declare-const dummy4 t42s)

(declare-datatypes ((t42s__ref 0))
(((t42s__refqtmk (t42s__content t42s)))))
(define-fun t42s__ref_t42s__content__projection ((a t42s__ref)) t42s 
  (t42s__content a))

(declare-datatypes ((t46s__ref 0))
(((t46s__refqtmk (t46s__content us_t)))))
(define-fun t46s__ref_t46s__content__projection ((a t46s__ref)) us_t 
  (t46s__content a))
...
;; t47s'axiom
  (assert
  (forall ((i t47s)) (and (<= 0 (t47sqtint i)) (<= (t47sqtint i) 1))))
...
(declare-fun user_eq5 (t47s t47s) Bool)

(declare-const dummy5 t47s)
...
(declare-fun temp_____aggregate_def_210 ((_ BitVec 8)
  (_ BitVec 8)) (Array Int byte))

(declare-fun temp_____aggregate_def_221 ((_ BitVec 8)
  (_ BitVec 8)) (Array Int byte))
...
;; def_axiom
  (assert
  (forall ((temp___212 (_ BitVec 8)) (temp___213 (_ BitVec 8)))
  (let ((temp___211 (temp_____aggregate_def_210 temp___212 temp___213)))
  (=>
  (and (dynamic_invariant3 temp___212 true true true true)
  (dynamic_invariant3 temp___213 true true true true))
  (and (= (to_rep1 (select temp___211 0)) temp___212)
  (= (to_rep1 (select temp___211 1)) temp___213))))))

;; def_axiom
  (assert
  (forall ((temp___223 (_ BitVec 8)) (temp___224 (_ BitVec 8)))
  (let ((temp___222 (temp_____aggregate_def_221 temp___223 temp___224)))
  (=>
  (and (dynamic_invariant3 temp___223 true true true true)
  (dynamic_invariant3 temp___224 true true true true))
  (and (= (to_rep1 (select temp___222 0)) temp___223)
  (= (to_rep1 (select temp___222 1)) temp___224))))))
...
;; defqtvc
 ;; File "test.ads", line 15, characters 0-0
  ...
  (exists ((o1 Bool))
  (and
  (ite (<= (first1 buffer) 1073741823)
  (= o1 (ite (<= 14 (length buffer)) true false)) (= o1 false))
  (ite (= o1 true)
  (let ((o2 (+ (first1 buffer) 13)))
  (and (in_range o2)
  (let ((o3 (+ (first1 buffer) 12)))
  (and (in_range o3)
  (and
  (=> (<= o3 o2)
  (and (and (<= (first1 buffer) o3) (<= o3 (last1 buffer)))
  (and (<= (first1 buffer) o2) (<= o2 (last1 buffer)))))
  (let ((temp___258 (of_array (to_array buffer) o3 o2)))
  (= o (bool_eq (to_array temp___258) (first1 temp___258) (last1 temp___258)
       (temp_____aggregate_def_210 #x00 #x00) 0 1))))))))
  (= o false))))
  (=> (= o true)
  (let ((o1 (+ (first1 buffer) 13)))
  (=> (in_range o1)
  (let ((o2 (+ (first1 buffer) 12)))
  (=> (in_range o2) (=> (<= o2 o1) (<= (first1 buffer) o2))))))))))))
(check-sat)
(exit)
