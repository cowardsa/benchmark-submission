...
(define-fun to_int3 ((x mod_16)) Int (ubv_to_int (to_rep x)))
...
(declare-const a1__first mod_16)

(declare-const a1__last mod_16)
...
;; defqtvc
 ;; File "test_length.adb", line 12, characters 0-0
  (not
  (let ((test_length__p2__a1__assume (create #xFFFF)))
  (=>
  (and (create__function_guard test_length__p2__a1__assume #xFFFF)
  (and (dynamic_invariant1 test_length__p2__a1__assume true false true true)
  (and (= (first1 test_length__p2__a1__assume) #x0000)
  (= (last1 test_length__p2__a1__assume) #xFFFF))))
  (forall ((a1 (Array (_ BitVec 16) natural)))
  (=> (= a1 (to_array test_length__p2__a1__assume))
  (=> (= (to_rep a1__first) (first1 test_length__p2__a1__assume))
  (=> (= (to_rep a1__last) (last1 test_length__p2__a1__assume))
  (=> (dynamic_property #x0000 #xFFFF (to_rep a1__first) (to_rep a1__last))
  (forall ((o (_ BitVec 64)))
  (=>
  (exists ((o1 (_ BitVec 16)))
  (and (= (to_rep a1__last) o1)
  (exists ((o2 (_ BitVec 16)))
  (and (= (to_rep a1__first) o2)
  (ite (bvule ((_ zero_extend 48) o2) ((_ zero_extend 48) o1))
  (exists ((o3 (_ BitVec 16)))
  (and (= (to_rep a1__first) o3)
  (exists ((o4 (_ BitVec 16)))
  (and (= (to_rep a1__last) o4)
