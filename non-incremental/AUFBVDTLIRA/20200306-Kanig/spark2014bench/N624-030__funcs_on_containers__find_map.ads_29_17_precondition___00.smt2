...
;; defqtvc
 ;; File "find_map.ads", line 26, characters 0-0
  ...
  (forall ((o1 Int))
  (=> (= (to_rep (select (to_array a) usf)) o1)
  (let ((o2 (contains find_map__find_all__result o1)))
  (=>
  (= (= o2 true) (= (has_key (model1 find_map__find_all__result) o1) true))
  (=> (= o2 true)
  (=> (and (<= (first1 a) usf) (<= usf (last1 a)))
  (forall ((o3 Int))
  (=> (= (to_rep (select (to_array a) usf)) o3)
  (= (contains find_map__find_all__result o3) true)))))))))))))))))))))))))))))
(check-sat)
(exit)
