...
;; defqtvc
 ;; File "parse.ads", line 15, characters 0-0
  ...
  (=> (= spark__branch6 true)
  (forall ((parse__parse_header__R26b__assume Int))
  (=> (= (to_rep4 result____split_discrs) parse__parse_header__R26b__assume)
  (=> (= parse__parse_header__R26b__assume r26b)
  (=> (dynamic_invariant4 r26b true false true true)
