...
(((t59b__refqtmk (t59b__content us_t)))))
(define-fun t59b__ref_t59b__content__projection ((a t59b__ref)) us_t 
  (t59b__content a))

(declare-datatypes ((us_split_fields2 0))
(((us_split_fieldsqtmk1
  (rec__ada___ada___aco__math__very_longs__very_long__long_digits1 us_t)))))
(define-fun us_split_fields_rec__ada___ada___aco__math__very_longs__very_long__long_digits__17__projection ((a us_split_fields2)) us_t 
...
(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___201 (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
...
(define-fun of_base ((r1 us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r1)
                                          (us_split_fieldsqtmk1
                                          (let ((temp___200 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
...
(define-fun dynamic_invariant4 ((temp___expr_682 us_rep1)
  (temp___is_init_678 Bool) (temp___skip_constant_679 Bool)
  (temp___do_toplevel_680 Bool)
  (temp___do_typ_inv_681 Bool)) Bool (and
                                     (=>
                                     (not (= temp___skip_constant_679 true))
                                     (in_range3
                                     (to_rep
                                     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                     (us_split_discrs1 l)))
                                     (us_split_discrs1
                                     (to_base temp___expr_682))))
                                     (and (dynamic_property 1
                                     (to_rep
                                     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                     (us_split_discrs1 l)))
                                     (first1
                                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_682)))
                                     (last1
                                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_682))))
                                     (and
                                     (= (first1
                                        (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_682))) 1)
                                     (= (last1
                                        (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_682))) 
                                     (to_rep
...
(define-fun default_initial_assumption ((temp___expr_685 us_rep1)
  (temp___skip_top_level_686 Bool)) Bool (and
                                         (= (to_rep
                                            (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_685))) (to_rep
                                                               (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l))))
                                         (and
...
(declare-fun temp_____aggregate_def_1178 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1180 (_ BitVec 8)))
  (forall ((temp___1181 Int) (temp___1182 Int))
  (let ((temp___1179 (temp_____aggregate_def_1178 temp___1180 temp___1181
                     temp___1182)))
  (=> (dynamic_invariant3 temp___1180 true true true true)
  (and
  (=> (dynamic_property 1 2147483647 temp___1181 temp___1182)
  (and (= (first1 temp___1179) temp___1181)
  (= (last1 temp___1179) temp___1182)))
  (forall ((temp___1183 Int))
  (= (to_rep2 (select (to_array temp___1179) temp___1183)) temp___1180))))))))
...
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 52, characters 0-0
  ...
  (let ((temp___1184 (temp_____aggregate_def_1178 #x00 1 o1)))
  (=> (= (first1 temp___1184) 1)
  (=>
  (= (last1 temp___1184) (to_rep
                         (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                         (us_split_discrs1 l))))
  (=>
  (ite (<= (first1 temp___1184) (last1 temp___1184))
  (and
  (<= 1 (to_rep
        (rec__ada___ada___aco__math__very_longs__very_long__octet_length
        (us_split_discrs1 l))))
  (= (- (last1 temp___1184) (first1 temp___1184)) (- (to_rep
                                                     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                                     (us_split_discrs1 l))) 1)))
  (< (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1 l))) 1))
  (let ((temp___1186 (of_array (to_array temp___1184) (first1 temp___1184)
                     (last1 temp___1184))))
  (=>
  (ite (<= (first1 temp___1186) (last1 temp___1186))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1186) (first1 temp___1186)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1186)
  (forall ((carry1 (_ BitVec 16)))
  (=> (= carry1 #x0000)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1191 (last1
                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1191) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields3) temp___1200)
               (<= temp___1200 (last1 result____split_fields3)))
               (=>
               (or (< temp___1191 temp___1200)
               (or (< temp___1200 1) (<= i1 temp___1200)))
               (= (select (to_array result____split_fields3) temp___1200) (select 
               (to_array result____split_fields1) temp___1200))))))
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1192 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1192) i1) (<= i1 (last1 temp___1192)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1192) i1)) o2)
  (exists ((l_digit2 (_ BitVec 16)))
  (and (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1193 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1193) i1) (<= i1 (last1 temp___1193)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1193) i1)) o3)
  ...
  (= o4 (bvudiv sum2 (ite (< 8 65536) (bvshl #x0001 ((_ int_to_bv 16) 8))
                     #x0000)))))
  ...
  (forall ((ada___ada___aco__math__very_longs__modadd__result us_rep))
  (=>
  (= ada___ada___aco__math__very_longs__modadd__result (to_base
                                                       (us_repqtmk1
  ...
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1 ada___ada___aco__math__very_longs__modadd__result))) 
  (to_rep
  (rec__ada___ada___aco__math__very_longs__very_long__octet_length
  (us_split_discrs1 l)))))))))))))))))))))))))))))))))
(check-sat)
