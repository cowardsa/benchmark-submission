...
(declare-datatypes ((uint16__ref 0))
(((uint16__refqtmk (uint16__content uint16)))))
...
(define-fun to_int4 ((x uint16)) Int (ubv_to_int (to_rep1 x)))
...
(((map__refqtmk (map__content (Array (_ BitVec 16) uint8))))))
...
(declare-datatypes ((record_struct__ref 0))
...
(((us_tqtmk (elts (Array (_ BitVec 16) uint8))(rt t)))))
...
(declare-datatypes ((bytearray__ref 0))
(((bytearray__refqtmk (bytearray__content us_t)))))
...
;; defqtvc
 ;; File "bytes.ads", line 14, characters 0-0
  (not
  (forall ((length1 (_ BitVec 16)) (o (_ BitVec 8)) (o1 uint8)
  (temp___202 (_ BitVec 16)))
  (=> (dynamic_property #x0000 #xFFFF (to_rep1 output__first)
  (to_rep1 output__last))
  (=> (dynamic_invariant length1 false false true true)
  (=>
  (= (to_rep (rec__bytes__record_struct__length (us_split_fields1 a_record))) o)
  (=> (= (to_rep o1) o)
