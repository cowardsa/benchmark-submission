...
;; defqtvc
 ;; File "keccak-duplex.ads", line 155, characters 0-0
  ...
  (ctx__split_fields1 us_split_fields))
  ...
  (= block (ada___keccak__keccak_1600__duplex__duplex_mute__block__aggregate_def
           #x00))
  (=>
  (ite (<= (first1 in_data) (last1 in_data))
  (and (<= 0 (- (length in_data) 1))
  (= (- (last1 in_data) (first1 in_data)) (- (- (length in_data) 1) 0)))
  (< (- (length in_data) 1) 0))
  (let ((temp___1239 (of_array (slide1 (to_array in_data) (first1 in_data) 0)
                     0 (- (length in_data) 1))))
  (let ((o (length in_data)))
  (=> (in_range o)
  (let ((temp___1241 (- o 1)))
  (=>
  (=> (<= 0 temp___1241)
  (and (and (<= 0 0) (<= 0 199))
  (and (<= 0 temp___1241) (<= temp___1241 199))))
  (let ((temp___1242 (of_array block 0 temp___1241)))
  (=>
  (ite (<= (first1 temp___1239) (last1 temp___1239))
  (and (<= (first1 temp___1242) (last1 temp___1242))
  (= (- (last1 temp___1239) (first1 temp___1239)) (- (last1 temp___1242) 
  (first1 temp___1242)))) (< (last1 temp___1242) (first1 temp___1242)))
  (forall ((usf (Array Int byte)))
  (=>
  (forall ((temp___1244 Int))
  (ite (and (<= 0 temp___1244) (<= temp___1244 (- (length in_data) 1)))
  (= (select usf temp___1244) (select (to_array temp___1239) temp___1244))
  (= (select usf temp___1244) (select block temp___1244))))
  (forall ((block1 (Array Int byte)))
  (=> (= block1 usf)
  (let ((o1 (us_repqtmk ctx__split_fields)))
  (let ((o2 (rate_of o1)))
  (=>
  (and (rate_of__function_guard o2 o1)
  ...
  (=>
  (forall ((temp___1248 Int))
  (ite (and (<= 0 temp___1248) (<= temp___1248 r179s))
  (= (select usf1 temp___1248) (select (to_array
                                       (of_array
                                       (slide1 (to_array temp___1246)
                                       (first1 temp___1246) 0) 0 r179s)) temp___1248))
  (= (select usf1 temp___1248) (select block1 temp___1248))))
  ...
  (= (to_rep3
     (rec__ada___keccak__keccak_1600__duplex__context__rate
     ctx__split_fields)) o7)
  (=> (= (- (div1 (+ o7 7) 8) 1) r182s)
  (=> (dynamic_invariant1 r182s true false true true)
  (let ((o8 (us_repqtmk ctx__split_fields)))
  (let ((o9 (rate_of o8)))
  (=>
  (and (rate_of__function_guard o9 o8)
  ...
  (=>
  (=> (<= 0 r182s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r182s) (<= r182s 199))))
  (forall
