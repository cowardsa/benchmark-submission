...
;; defqtvc
 ;; File "random.ads", line 43, characters 0-0
  ...
  (=> (= k 1)
  (=>
  (= (and (ite (<= 1 k) true false) (ite (<= k temp___244) true false)) true)
  (let ((o (to_state1 j)))
  (=>
  ...
  (forall ((j1 Int))
  (=> (= j1 o6)
  (forall ((i2 Int) (j2 Int) (g__split_fields3 us_split_fields) (k1 Int))
  (=>
  (and (< 0 i2) (and (<= (first1 initiator) j2) (<= j2 (last1 initiator))))
  (=>
  (= (and (ite (and
               (and
               (and (dynamic_invariant j2 true true true true)
               (= (rec__random__generator__index g__split_fields3) (rec__random__generator__index
                                                                   g__split_fields)))
               (dynamic_property1 1 (max 624 (length initiator)) k1))
               (dynamic_invariant2 i2 true true true true))
  ...
  (let ((temp___2491 (- i2 1)))
  (=> (and (<= 0 temp___2491) (<= temp___2491 623))
  (forall ((o9 (_ BitVec 32)))
  (=>
  (= (to_rep1
     (select (rec__random__generator__state g__split_fields3) temp___2491)) o9)
  (let ((temp___2471 (- i2 1)))
  (=> (and (<= 0 temp___2471) (<= temp___2471 623))
  (forall ((o10 (_ BitVec 32)))
  (=>
  (= (to_rep1
     (select (rec__random__generator__state g__split_fields3) temp___2471)) o10)
  ...
  (= g__split_fields4 (us_split_fieldsqtmk
                      (store (rec__random__generator__state g__split_fields3) i2 o12)
                      (rec__random__generator__index g__split_fields3)))
  (forall ((i3 Int))
  (=>
  (exists ((spark__branch1 Bool))
  (and (= spark__branch1 (ite (= i2 623) true false))
  (ite (= spark__branch1 true)
  (exists ((o13 (_ BitVec 32)))
  (and
  (= (to_rep1 (select (rec__random__generator__state g__split_fields4) 623)) o13)
  (exists ((o14 unsigned_32)) (and (= (to_rep1 o14) o13) (= i3 1)))))
  (let ((o13 (+ i2 1))) (and (in_range4 o13) (= i3 o13))))))
  (forall ((o13 Int))
  (=>
  (ite (= j2 (last1 initiator)) (= o13 0)
  (let ((o14 (+ j2 1))) (and (= o13 o14) (in_range1 o14))))
  (forall ((j3 Int)) (=> (= j3 o13) (< 0 i3)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
