...
;; defqtvc
 ;; File "keccak-sponge.ads", line 222, characters 0-0
  ...
  (=> (= spark__branch1 (ite (<= o8 o9) true false))
  (=> (= spark__branch1 true)
  (forall
  ...
  (=> (= (- o10 1) r120s)
  (=> (dynamic_invariant2 r120s true false true true)
  (=>
  (=> (<= 0 r120s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r120s) (<= r120s 199))))
  (let ((ada___keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl 
  (of_array
  (rec__ada___keccak__keccak_1600__sponge__context__block ctx__split_fields2)
  0 r120s)))
  (forall ((o11 integer))
  (=>
  (= (to_rep o11) (last1
  ...
  (= (to_rep o12) (first1
                  ada___keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl))
  (<= (length (to_rep o12) (to_rep o11)) 200)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
