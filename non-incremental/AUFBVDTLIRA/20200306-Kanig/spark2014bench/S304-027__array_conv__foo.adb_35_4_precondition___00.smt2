...
(define-fun to_int2 ((x my_elem)) Int (ubv_to_int (to_rep3 x)))
...
(define-fun to_int3 ((x byte)) Int (ubv_to_int (to_rep4 x)))
...
;; defqtvc
 ;; File "foo.adb", line 5, characters 0-0
  (not
  (forall ((stored_items (Array Int byte))
  (structure__split_fields us_split_fields2)
  (structure__split_fields1 us_split_fields2))
  (=>
  (exists ((usf Int))
  ...
  (= structure__split_fields1 (us_split_fieldsqtmk1
                              ...
                              #x04)))
  (=> (dynamic_property 1 2147483647 1 4)
  (let ((foo__get__value__compl (of_array (convert stored_items) 1 4)))
  (forall ((o integer))
  (=> (= (to_rep1 o) (last1 foo__get__value__compl))
  (forall ((o1 integer))
  (=> (= (to_rep1 o1) (first1 foo__get__value__compl))
  (= (length1 (to_rep1 o1) (to_rep1 o)) (to_rep
                                        (rec__foo__element_structure_type__max_size
                                        (us_split_discrs1
                                        (to_base
