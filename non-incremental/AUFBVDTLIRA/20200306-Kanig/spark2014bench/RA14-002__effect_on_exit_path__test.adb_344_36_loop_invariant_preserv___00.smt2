...
;; defqtvc
 ;; File "test.ads", line 80, characters 0-0
  ...
  (=> (= iterator #x00)
  (=>
  (= (and (ite (bvule #x00 iterator) true false) (ite (bvule iterator temp___590)
                                                 true false)) true)
  (let ((o4 current))
  ...
  (=> (not (= iterator1 temp___590))
  (let ((o9 current))
  (let ((o10 (os_mbx_is_empty o9 os_task_mbx_rw)))
  (=>
  (and (os_mbx_is_empty__function_guard o10 o9 os_task_mbx_rw)
  (= (= o10 true)
  (= (to_rep1
     (rec__test__os_mbx_t__count
     (us_split_fields3 (select os_task_mbx_rw o9)))) #x00)))
  (let ((o11 (os_ghost_mbx_are_well_formed os_task_mbx_rw)))
  (=>
  (and (os_ghost_mbx_are_well_formed__function_guard o11 os_task_mbx_rw)
  (= (= o11 true)
  (forall ((task_id Int))
  (=> (and (<= 0 task_id) (<= task_id 4))
  (= (os_ghost_task_mbx_are_well_formed task_id os_task_mbx_rw) true)))))
