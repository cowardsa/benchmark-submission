...
(define-fun to_int3 ((x octet)) Int (ubv_to_int (to_rep5 x)))
...
(define-fun to_int4 ((x serial_number_type)) Int (ubv_to_int (to_rep6 x)))
...
;; defqtvc
 ;; File "timestamp_messages-server.ads", line 19, characters 0-0
  ...
  (ada___timestamp_messages__server__put_timestamp_value__message_imprint_value__assume us_t)
  (ada___timestamp_messages__server__put_timestamp_value__tst_info__assume us_t))
  (=>
  (let ((o (of_array
           (rec__timestamp_messages__timestamp__hashed_message
           (us_split_fields3 stamp)) 1 32)))
  ...
  (= ada___timestamp_messages__server__put_timestamp_value__message_imprint__assume 
  message_imprint)
  (=> (dynamic_invariant message_imprint true false true true)
  (=>
  (let ((o (length1 message_imprint)))
  (and (in_range1 o)
  (let ((temp___377 (put_length_value o)))
  (and
  (and (put_length_value__function_guard temp___377 o)
  (and (dynamic_invariant temp___377 true false true true)
  (<= (length1 temp___377) 5)))
  (let ((temp___376 (make_leading_identifier 0 1 15)))
  (and
  (and (make_leading_identifier__function_guard temp___376 0 1 15)
  (dynamic_invariant1 temp___376 true false true true))
  (let ((o1 (- (+ 0 (+ 1 (length (first1 temp___377) (last1 temp___377)))) 1)))
  (and (in_range1 o1)
  (exists ((o2 octet))
  (and (= (to_rep5 o2) temp___376)
  (let ((temp___378 (of_array
                    (concat_singleton_left o2 0 (to_array temp___377)
                    (first1 temp___377) (last1 temp___377)) 0 o1)))
  (ite (= (length1 temp___378) 0)
  (= ada___timestamp_messages__server__put_timestamp_value__message_imprint_value__assume 
  (of_array (to_array message_imprint) (first1 message_imprint)
  (last1 message_imprint)))
  (let ((o3 (- (+ (first1 temp___378) (+ (length (first1 temp___378)
                                         (last1 temp___378)) (length
                                                             (first1
                                                             message_imprint)
                                                             (last1
                                                             message_imprint)))) 1)))
  ...
  (= ada___timestamp_messages__server__put_timestamp_value__message_imprint_value__assume 
  (of_array
  (concat1 (to_array temp___378) (first1 temp___378) (last1 temp___378)
  (to_array message_imprint) (first1 message_imprint)
  (last1 message_imprint)) (first1 temp___378) o3))))))))))))))))
  (=>
  (= ada___timestamp_messages__server__put_timestamp_value__message_imprint_value__assume 
  message_imprint_value)
  (=> (dynamic_invariant message_imprint_value true false true true)
  (=>
  ...
  (let ((o1 (ubv_to_int o)))
  (and (in_range o1)
  (let ((temp___383 (put_integer_value o1)))
  (and
  (and (put_integer_value__function_guard temp___383 o1) (dynamic_invariant
  temp___383 true false true true))
  (exists ((temp___382 us_t))
  (and
  (exists ((temp___381 us_t))
  (and
  (let ((o2 (rec__timestamp_messages__timestamp__policy
            (us_split_fields3 stamp))))
  (let ((temp___380 (put_oid_value o2)))
  (and
  (and (put_oid_value__function_guard temp___380 o2) (dynamic_invariant
  temp___380 true false true true))
  (exists ((o3 Int))
  (and
  (= (to_rep4
     (rec__timestamp_messages__timestamp__version (us_split_fields3 stamp))) o3)
  (let ((temp___379 (put_integer_value o3)))
  (and
  (and (put_integer_value__function_guard temp___379 o3) (dynamic_invariant
  temp___379 true false true true))
  (ite (= (length1 temp___379) 0)
  (= temp___381 (of_array (to_array temp___380) (first1 temp___380)
                (last1 temp___380)))
  (let ((o4 (- (+ (first1 temp___379) (+ (length (first1 temp___379)
                                         (last1 temp___379)) (length
                                                             (first1
                                                             temp___380)
                                                             (last1
                                                             temp___380)))) 1)))
  (and (in_range1 o4)
  (= temp___381 (of_array
                (concat1 (to_array temp___379) (first1 temp___379)
                (last1 temp___379) (to_array temp___380) (first1 temp___380)
                (last1 temp___380)) (first1 temp___379) o4))))))))))))
  (ite (= (length1 temp___381) 0)
  (= temp___382 (of_array (to_array message_imprint_value)
                (first1 message_imprint_value) (last1 message_imprint_value)))
  (let ((o2 (- (+ (first1 temp___381) (+ (length (first1 temp___381)
                                         (last1 temp___381)) (length
                                                             (first1
                                                             message_imprint_value)
                                                             (last1
  ...
  (and (in_range1 o2)
  (= temp___382 (of_array
                (concat1 (to_array temp___381) (first1 temp___381)
                (last1 temp___381) (to_array message_imprint_value)
                (first1 message_imprint_value) (last1 message_imprint_value))
                (first1 temp___381) o2)))))))
  (ite (= (length1 temp___382) 0)
  (= ada___timestamp_messages__server__put_timestamp_value__tst_info__assume 
  (of_array (to_array temp___383) (first1 temp___383) (last1 temp___383)))
  (let ((o2 (- (+ (first1 temp___382) (+ (length (first1 temp___382)
                                         (last1 temp___382)) (length
                                                             (first1
                                                             temp___383)
                                                             (last1
                                                             temp___383)))) 1)))
  ...
  (= ada___timestamp_messages__server__put_timestamp_value__tst_info__assume 
  (of_array
  (concat1 (to_array temp___382) (first1 temp___382) (last1 temp___382)
  (to_array temp___383) (first1 temp___383) (last1 temp___383))
  (first1 temp___382) o2)))))))))))))
  (=>
  (= ada___timestamp_messages__server__put_timestamp_value__tst_info__assume 
  tst_info)
  (=> (dynamic_invariant tst_info true false true true)
  (let ((o (length1 tst_info)))
  (=> (in_range1 o)
  (let ((temp___385 (put_length_value o)))
  (=>
  (and (put_length_value__function_guard temp___385 o)
  (and (dynamic_invariant temp___385 true false true true)
  (<= (length1 temp___385) 5)))
  (let ((temp___384 (make_leading_identifier 0 1 15)))
  (=>
  (and (make_leading_identifier__function_guard temp___384 0 1 15)
  (dynamic_invariant1 temp___384 true false true true))
  (let ((o1 (- (+ 0 (+ 1 (length (first1 temp___385) (last1 temp___385)))) 1)))
  (=> (in_range1 o1)
  (forall ((o2 octet))
  (=> (= (to_rep5 o2) temp___384)
  (let ((temp___386 (of_array
                    (concat_singleton_left o2 0 (to_array temp___385)
                    (first1 temp___385) (last1 temp___385)) 0 o1)))
  (=> (not (= (length1 temp___386) 0)) (in_range1
  (- (+ (first1 temp___386) (+ (length (first1 temp___386)
