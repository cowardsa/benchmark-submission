...
;; defqtvc
 ;; File "patris.ads", line 271, characters 0-0
  ...
  (action_request_nbr Int) (spark__branch Bool)
  (cur_piece__split_fields1 us_split_fields) (success Bool)
  (spark__branch1 Bool) (cur_state1 Int))
  ...
  (=> (= spark__branch1 true)
  (=> (= cur_state1 1) (= (get_state cur_state1) 1)))))))))))))))))
(check-sat)
(exit)
