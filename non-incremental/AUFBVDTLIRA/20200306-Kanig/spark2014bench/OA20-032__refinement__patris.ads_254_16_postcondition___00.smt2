...
;; defqtvc
 ;; File "patris.ads", line 250, characters 0-0
  ...
  (to_line1 Int) (complete_lines1 (_ BitVec 32)) (spark__branch2 Bool)
  (cur_board2 (Array Int (Array Int cell))) (spark__branch3 Bool)
  (o (_ BitVec 32)) (line_counter1 (_ BitVec 32)) (cur_state1 Int))
  ...
  (exists ((del_line Int))
  (and (= del_line 1)
  (ite (= (and (ite (<= 1 del_line) true false) (ite (<= del_line 20) true
                                                false)) true)
  (exists ((spark__branch4 Bool) (cur_board3 (Array Int (Array Int cell)))
  (to_line2 Int) (complete_lines2 (_ BitVec 32)))
  (and
  (let ((o1 (select cur_board del_line)))
  (let ((o2 (is_complete_line o1)))
  (and
  (= (= o2 true)
  (forall ((x Int))
  (=> (and (<= 1 x) (<= x 10)) (not (= (to_rep (select o1 x)) 0)))))
  (and (= spark__branch4 o2)
  (ite (= spark__branch4 true)
  (and (= cur_board3 (store cur_board del_line empty_line))
  ...
  (= o3 (bvsub temp___919 #x000186A0)) (= o3 temp___919)))
  (and (= complete_lines2 o3)
  (= (to_rep (select (select cur_board3 del_line) 1)) 0))))))
  (and (and (= cur_board3 cur_board) (= to_line2 to_line))
  (= complete_lines2 complete_lines)))))))
  ...
  (= (and (ite (and
               ...
               (in_range9 del_line1))
          true false) (ite (and (<= 1 del_line1) (<= del_line1 20)) true
                      false)) true)
  (= del_line1 20))))))
  (and
  ...
  (and
  (= spark__branch4 (ite (not (= complete_lines1 #x00000000)) true false))
  (ite (= spark__branch4 true)
  (and (= (- to_line1 1) r21b)
  (and (dynamic_invariant r21b true false true true)
  (let ((temp___929 r21b))
  (exists ((from_line Int))
  (and (= from_line temp___929)
  (ite (= (and (ite (<= 1 from_line) true false) (ite (<= from_line temp___929)
                                                 true false)) true)
  (and
  (= (= (no_complete_lines cur_board1) true)
  (forall ((y Int))
  (=> (and (<= 1 y) (<= y 20))
  (not (= (is_complete_line (select cur_board1 y)) true)))))
  (exists ((cur_board3 (Array Int (Array Int cell))) (to_line2 Int)
  (from_line1 Int))
  (and (and (= (no_complete_lines cur_board3) true) (< from_line1 to_line2))
  (and
  (= (and (ite (and (dynamic_property 1 r21b from_line1) (dynamic_invariant3
               to_line2 true true true true))
          true false) (ite (and (<= 1 from_line1) (<= from_line1 r21b)) true
                      false)) true)
  (exists ((to_line3 Int))
  (and
  (let ((o1 (select cur_board3 from_line1)))
  (let ((o2 (is_empty_line o1)))
  (and
  (= (= o2 true)
  (forall ((x Int))
  (=> (and (<= 1 x) (<= x 10)) (= (to_rep (select o1 x)) 0))))
  (and (= spark__branch2 (ite (= o2 true) false true))
  (ite (= spark__branch2 true)
  (exists ((cur_board4 (Array Int (Array Int cell))))
  (and
  (= cur_board4 (store cur_board3 to_line2 (select cur_board3 from_line1)))
  (and (= cur_board2 (store cur_board4 from_line1 empty_line))
  (let ((o3 (- to_line2 1)))
  (and (in_range9 o3)
  (and (= to_line3 o3)
  (= (to_rep (select (select cur_board2 from_line1) 1)) 0)))))))
  (and (= cur_board2 cur_board3) (= to_line3 to_line2)))))))
  (= from_line1 1)))))))
  (and (= spark__branch2 spark__branch4) (= cur_board2 cur_board1))))))))
  (and (= spark__branch2 spark__branch4) (= cur_board2 cur_board1)))))
  (=>
  (exists ((spark__branch4 Bool))
  (and (= spark__branch4 (ite (= complete_lines1 #x00000001) true false))
  (ite (= spark__branch4 true)
  (and
  (exists ((o1 (_ BitVec 32)))
  (and
  (let ((temp___938 (bvadd level_nbr #x00000001)))
  (ite (bvule (bvsub #x000186A0 level_nbr) #x00000001)
  (= o1 (bvsub temp___938 #x000186A0)) (= o1 temp___938)))
  (exists ((o2 (_ BitVec 32)))
  (let ((temp___938 (bvadd level_nbr #x00000001)))
  (ite (bvule (bvsub #x000186A0 level_nbr) #x00000001)
  (= o2 (bvsub temp___938 #x000186A0)) (= o2 temp___938))))))
  (= spark__branch3 spark__branch4))
  (exists ((spark__branch5 Bool))
  (and (= spark__branch5 (ite (= complete_lines1 #x00000002) true false))
  (ite (= spark__branch5 true)
  (and
  (exists ((o1 (_ BitVec 32)))
  (and
  (let ((temp___940 (bvadd level_nbr #x00000001)))
  (ite (bvule (bvsub #x000186A0 level_nbr) #x00000001)
  (= o1 (bvsub temp___940 #x000186A0)) (= o1 temp___940)))
  (exists ((o2 (_ BitVec 32)))
  (let ((temp___940 (bvadd level_nbr #x00000001)))
  (ite (bvule (bvsub #x000186A0 level_nbr) #x00000001)
  (= o2 (bvsub temp___940 #x000186A0)) (= o2 temp___940))))))
  (= spark__branch3 spark__branch5))
  (exists ((spark__branch6 Bool))
  (and (= spark__branch6 (ite (= complete_lines1 #x00000003) true false))
  (ite (= spark__branch6 true)
  (and
  (exists ((o1 (_ BitVec 32)))
  (and
  (let ((temp___942 (bvadd level_nbr #x00000001)))
  (ite (bvule (bvsub #x000186A0 level_nbr) #x00000001)
  (= o1 (bvsub temp___942 #x000186A0)) (= o1 temp___942)))
  (exists ((o2 (_ BitVec 32)))
  (let ((temp___942 (bvadd level_nbr #x00000001)))
  (ite (bvule (bvsub #x000186A0 level_nbr) #x00000001)
  (= o2 (bvsub temp___942 #x000186A0)) (= o2 temp___942))))))
  (= spark__branch3 spark__branch6))
  (and (= spark__branch3 (ite (= complete_lines1 #x00000004) true false))
  (or (not (= spark__branch3 true))
  (exists ((o1 (_ BitVec 32)))
  (and
  (let ((temp___944 (bvadd level_nbr #x00000001)))
  (ite (bvule (bvsub #x000186A0 level_nbr) #x00000001)
  (= o1 (bvsub temp___944 #x000186A0)) (= o1 temp___944)))
  (exists ((o2 (_ BitVec 32)))
  (let ((temp___944 (bvadd level_nbr #x00000001)))
  (ite (bvule (bvsub #x000186A0 level_nbr) #x00000001)
  (= o2 (bvsub temp___944 #x000186A0)) (= o2 temp___944)))))))))))))))))
  (=>
  (let ((temp___946 (bvadd line_counter complete_lines1)))
  (ite (bvule (bvsub #x000186A0 line_counter) complete_lines1)
  (= o (bvsub temp___946 #x000186A0)) (= o temp___946)))
  (=> (= line_counter1 o)
  (=>
  (exists ((spark__branch4 Bool))
  (= spark__branch4 (ite (bvuge line_counter1 #x0000000A)
