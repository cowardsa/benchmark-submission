...
;; is_empty__def_axiom
  ...
  (! (= (= (is_empty b) true)
     (forall ((y Int))
     (=> (and (<= 1 y) (<= y 20)) (= (is_empty_line (select b y)) true)))) :pattern (
  (is_empty b)) )))
...
(declare-fun user_eq11 (x_coord x_coord) Bool)

(declare-const dummy11 x_coord)
...
(declare-fun user_eq12 (y_coord y_coord) Bool)

(declare-const dummy12 y_coord)
...
(define-fun dynamic_invariant7 ((temp___expr_593 Int)
  ...
  (temp___do_typ_inv_592 Bool)) Bool (=>
                                     ...
                                     (<= 1 20)) (in_range11 temp___expr_593)))

(define-fun dynamic_invariant8 ((temp___expr_631 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_638 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_645 Int)
...
(declare-fun is_empty1 ((Array Int (Array Int cell)) Int Int) Bool)

(declare-fun is_empty__function_guard1 (Bool (Array Int (Array Int cell)) Int
  Int) Bool)
...
;; is_empty__def_axiom
  ...
  (forall ((b (Array Int (Array Int cell))))
  (forall ((y Int) (x Int))
  (! (= (= (is_empty1 b y x) true)
     (and (and (in_range10 x) (in_range11 y))
...
;; no_overlap__def_axiom
  ...
  (! (= (= (no_overlap b p) true)
     ...
     (and
     (and
     (= (is_empty1 b (to_rep3 (rec__patris__piece__y (us_split_fields1 p)))
...
(assert
;; defqtvc
 ;; File "patris.ads", line 258, characters 0-0
  (not
  (forall ((cur_state Int) (score_nbr (_ BitVec 32))
  (level_nbr (_ BitVec 32)) (line_counter (_ BitVec 32))
  (action_request_nbr Int) (o direction) (o1 shape) (o2 direction) (o3 shape)
  (cur_state1 Int))
  (=> (dynamic_invariant2 score_nbr false false true true)
  (=> (dynamic_invariant2 level_nbr false false true true)
  (=> (dynamic_invariant2 line_counter false false true true)
  (=> (dynamic_invariant1 cur_state false false true true)
  (=> (dynamic_invariant action_request_nbr false false true true)
  (=> (= (to_rep4 o) 0)
  (=> (= (to_rep1 o1) 1)
  (=> (= (to_rep4 o2) 0)
