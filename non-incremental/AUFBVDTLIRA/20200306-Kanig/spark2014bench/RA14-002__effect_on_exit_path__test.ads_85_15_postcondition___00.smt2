...
;; defqtvc
 ;; File "test.ads", line 80, characters 0-0
  ...
  (=>
  (forall ((os_task_mbx_rw2 (Array Int us_rep1)))
  (os_mbx_is_empty__function_guard (os_mbx_is_empty current os_task_mbx_rw2)
  current os_task_mbx_rw2))
  (=>
  (forall ((os_task_mbx_rw2 (Array Int us_rep1)))
  (os_ghost_mbx_are_well_formed__function_guard
  (os_ghost_mbx_are_well_formed os_task_mbx_rw2) os_task_mbx_rw2))
  ...
  current os_task_mbx_rw2))
  (=>
  (forall ((os_task_list_rw1 (Array Int us_rep2)) (o Int))
  (os_mbx_get_waiting_mask__function_guard
  (os_mbx_get_waiting_mask o os_task_list_rw1) o os_task_list_rw1))
  (=>
  (forall ((os_task_mbx_rw2 (Array Int us_rep1)) (iterator (_ BitVec 8))
  (o Int)) (os_mbx_get_mbx_entry_sender__function_guard
  (os_mbx_get_mbx_entry_sender o iterator os_task_mbx_rw2) o iterator
  os_task_mbx_rw2))
  (=>
  (forall ((os_task_mbx_rw2 (Array Int us_rep1)) (o Int))
  (os_mbx_get_mbx_head__function_guard
  (os_mbx_get_mbx_head o os_task_mbx_rw2) o os_task_mbx_rw2))
  (=>
  (forall ((os_task_mbx_rw2 (Array Int us_rep1)) (o Int))
  (os_mbx_get_mbx_head__function_guard
  (os_mbx_get_mbx_head o os_task_mbx_rw2) o os_task_mbx_rw2))
  (=>
  (forall ((os_task_mbx_rw2 (Array Int us_rep1)) (iterator (_ BitVec 8))
  (o Int)) (oadd__function_guard
  (oadd (os_mbx_get_mbx_head o os_task_mbx_rw2) iterator)
  (os_mbx_get_mbx_head o os_task_mbx_rw2) iterator))
  (=>
  (forall ((os_task_mbx_rw2 (Array Int us_rep1)) (o Int))
  (os_mbx_get_mbx_head__function_guard
  (os_mbx_get_mbx_head o os_task_mbx_rw2) o os_task_mbx_rw2))
  ...
  (ite (= spark__branch true) (= os_task_mbx_rw1 os_task_mbx_rw)
  (exists ((status1 Int))
  (and (= status1 (- 4))
  (let ((o2 current))
  ...
  (and (= (bvsub o3 #x01) r25b)
  (and (dynamic_invariant3 r25b true false true true)
  (let ((temp___590 r25b))
  (exists ((iterator (_ BitVec 8)))
  (and (= iterator #x00)
  (ite (= (and (ite (bvule #x00 iterator) true false) (ite (bvule iterator temp___590)
                                                      true false)) true)
  (let ((o4 current))
  ...
  (let ((o10 current))
  (exists ((os_task_mbx_rw2 (Array Int us_rep1)))
  (and (= os_task_mbx_rw2 os_task_mbx_rw)
  (forall ((temp___index_496 Int))
  (=> (and (<= 0 temp___index_496) (<= temp___index_496 4))
  (= (bool_eq2 (select os_task_mbx_rw1 temp___index_496)
     (ite (= temp___index_496 o10)
     (us_repqtmk1
     (us_split_fieldsqtmk1
     (of_rep
     (let ((temp___500 (bvadd (to_rep
                              (rec__test__os_mbx_t__head
                              (us_split_fields3 (select os_task_mbx_rw2 o10)))) #x01)))
     (ite (bvule (bvsub #x03 (to_rep
                             (rec__test__os_mbx_t__head
                             (us_split_fields3 (select os_task_mbx_rw2 o10))))) #x01)
     (bvsub temp___500 #x03) temp___500)))
     (of_rep1
     (bvsub (to_rep1
            (rec__test__os_mbx_t__count
            (us_split_fields3 (select os_task_mbx_rw2 o10)))) #x01))
     ...
     (rec__test__os_mbx_t__mbx_array
     (us_split_fields3 (select os_task_mbx_rw2 o10)))
     (let ((temp___509 (bvsub (os_mbx_get_mbx_head o10 os_task_mbx_rw1) #x01)))
     (ite (bvult (os_mbx_get_mbx_head o10 os_task_mbx_rw1) #x01)
     (bvadd temp___509 #x03) temp___509))
     (us_repqtmk (us_split_fieldsqtmk rliteral rliteral1)))))
     (select os_task_mbx_rw2 temp___index_496))) true))))))))))
  (and (= iterator1 temp___590) (= os_task_mbx_rw1 os_task_mbx_rw)))))))))))))))))
