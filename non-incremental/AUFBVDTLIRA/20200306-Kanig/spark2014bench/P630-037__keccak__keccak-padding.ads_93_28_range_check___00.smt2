...
;; defqtvc
 ;; File "keccak-padding.ads", line 87, characters 0-0
  (not
  (forall ((o Int) (o1 Int))
  (=> (dynamic_property 0 2147483647 (to_rep block__first)
  (to_rep block__last))
  (=> (dynamic_invariant num_used_bits true false true true)
  (=> (dynamic_invariant max_bit_length true false true true)
  (=> (= (to_rep block__last) o)
  (=> (= (to_rep block__first) o1)
  (let ((o2 (length o1 o)))
  (=> (in_range o2)
  (=> (and (<= o2 268435455) (<= max_bit_length 2147483640))
  (=> (in_range (+ max_bit_length 7))
  (forall ((o3 Int))
  (=> (= (to_rep block__last) o3)
  (forall ((o4 Int))
  (=> (= (to_rep block__first) o4) (in_range (length o4 o3))))))))))))))))))
(check-sat)
(exit)
