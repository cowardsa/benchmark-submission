...
;; defqtvc
 ;; File "test.ads", line 11, characters 0-0
  ...
  (=>
  (forall ((s__split_fields2 us_split_fields)) (get_remaining__function_guard
  (get_remaining (us_repqtmk s__split_fields2))
  (us_repqtmk s__split_fields2)))
  (=> (< 0 (get_remaining (us_repqtmk s__split_fields)))
  (forall ((o Int))
  (=> (= (to_rep (rec__test__t__remaining s__split_fields)) o)
  (let ((o1 (- o 1)))
  (=> (in_range o1)
  (forall ((o2 length_type))
  (=> (= (to_rep o2) o1)
