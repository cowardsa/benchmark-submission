...
(define-fun in_range1 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(declare-fun user_eq (frame_length frame_length) Bool)

(declare-const dummy frame_length)
...
;; range_axiom
  (assert
  (forall ((x frame_length)) (! (in_range1
...
(declare-fun user_eq1 (rx_errors rx_errors) Bool)

(declare-const dummy1 rx_errors)
...
(declare-const dummy3 (Array Int bits_8))
...
(declare-fun user_eq3 ((Array Int bits_8) (Array Int bits_8)) Bool)
...
(declare-const dummy6 rx_frame_queue_index)
...
(define-fun dynamic_invariant ((temp___expr_310 us_rep)
...
(define-fun dynamic_invariant3 ((temp___expr_283 Int)
  ...
  (temp___do_typ_inv_282 Bool)) Bool (=>
                                     ...
                                     (<= 0 5)) (in_range2 temp___expr_283)))

(define-fun dynamic_invariant4 ((temp___expr_327 (_ BitVec 8))
...
;; range_axiom
  (assert
  (forall ((x rx_frame_queue_index)) (! (in_range4
...
(define-fun dynamic_invariant5 ((temp___expr_397 us_rep1)
...
;; def_axiom
  ...
  (=> (dynamic_invariant temp___405 true true true true)
...
;; def_axiom
  ...
  (=> (dynamic_invariant6 temp___409 true true true true)
