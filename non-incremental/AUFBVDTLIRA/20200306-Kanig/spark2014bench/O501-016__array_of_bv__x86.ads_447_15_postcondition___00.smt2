...
;; defqtvc
 ;; File "x86.ads", line 445, characters 0-0
  ...
  (=>
  (and
  (= (readmem8 o1 memory4) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 8)) #x000000FF)))
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF))
  (=> (not (= i o1))
  ...
  (=>
  (and
  (= (readmem8 o2 memory6) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 16)) #x000000FF)))
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF))
  (=> (not (= i o2))
  ...
  (=>
  (and
  (= (readmem8 o3 memory8) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 24)) #x000000FF)))
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF))
  (=> (not (= i o3))
