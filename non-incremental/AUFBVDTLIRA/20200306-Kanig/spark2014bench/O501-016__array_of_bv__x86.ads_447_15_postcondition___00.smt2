...
;; defqtvc
 ;; File "x86.ads", line 445, characters 0-0
  ...
  (=>
  (and (= (readmem8 o memory2) ((_ extract 7 0) (bvand val__ #x000000FF)))
  (forall ((i (_ BitVec 64)))
  ...
  (=>
  (and
  (= (readmem8 o1 memory4) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int_to_bv 32) 8)) #x000000FF)))
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF))
  (=> (not (= i o1))
  ...
  (=>
  (and
  (= (readmem8 o2 memory6) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int_to_bv 32) 16)) #x000000FF)))
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF))
  (=> (not (= i o2))
  ...
  (=>
  (and
  (= (readmem8 o3 memory8) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int_to_bv 32) 24)) #x000000FF)))
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF))
  (=> (not (= i o3))
  ...
  (= ((_ zero_extend 8) (to_rep
                        (select memory8 (bvadd addr #x0000000000000002)))) ((_ extract 15 0) (bvlshr (bvand 
  val__ #x00FF0000) ((_ int_to_bv 32) 16))))
  (=>
  (forall ((memory9 (Array (_ BitVec 64) unsigned8)))
  (readmem16__function_guard (readmem16 addr memory9) addr memory9))
  (=>
  (= (readmem16 addr memory8) ((_ extract 15 0) (bvand val__ #x0000FFFF)))
  (=>
  (forall ((memory9 (Array (_ BitVec 64) unsigned8)))
  (readmem16__function_guard (readmem16 addr memory9) addr memory9))
  (=>
  (forall ((memory9 (Array (_ BitVec 64) unsigned8)))
  (readmem16__function_guard
  (readmem16 (bvadd addr #x0000000000000002) memory9)
  (bvadd addr #x0000000000000002) memory9))
  (=>
  (= (bvor ((_ zero_extend 16) (readmem16 addr memory8)) (bvshl ((_ zero_extend 16) 
  (readmem16 (bvadd addr #x0000000000000002) memory8)) ((_ int_to_bv 32) 16))) 
  val__)
  (=>
  (forall ((memory9 (Array (_ BitVec 64) unsigned8)))
