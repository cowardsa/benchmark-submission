...
(((t21b__refqtmk (t21b__content us_t1)))))
...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 154, characters 0-0
  (not
  (forall ((last4 Int) (temporary_array (Array Int octet)))
  (=> (dynamic_invariant value true false true true)
  (=> (dynamic_property1 0 65535 (to_rep1 data__first) (to_rep1 data__last))
  ...
  (of_array1 temporary_array (to_rep1 temporary_array__first)
  (to_rep1 temporary_array__last)) false)
  (=>
  (and (dynamic_property1 0 (- (length1 value) 1)
  (to_rep1 temporary_array__first) (to_rep1 temporary_array__last))
  (and (= (to_rep1 temporary_array__first) 0)
  (= (to_rep1 temporary_array__last) (- (length1 value) 1))))
  (let ((temp___579 (temp_____aggregate_def_573 #x00 0 (- (length1 value) 1))))
  (=> (= (first3 temp___579) 0)
  (=> (= (last3 temp___579) (- (length1 value) 1))
  (=>
  (ite (<= (first3 temp___579) (last3 temp___579))
  (and (<= 0 (- (length1 value) 1))
  (= (- (last3 temp___579) (first3 temp___579)) (- (- (length1 value) 1) 0)))
  (< (- (length1 value) 1) 0))
  (let ((temp___581 (of_array1 (to_array1 temp___579) (first3 temp___579)
                    (last3 temp___579))))
  (=>
  (ite (<= (first3 temp___581) (last3 temp___581))
  (and (<= (to_rep1 temporary_array__first) (to_rep1 temporary_array__last))
  (= (- (last3 temp___581) (first3 temp___581)) (- (to_rep1
                                                   temporary_array__last) 
  (to_rep1 temporary_array__first))))
  (< (to_rep1 temporary_array__last) (to_rep1 temporary_array__first)))
  (forall ((temporary_array1 (Array Int octet)))
  (=> (= temporary_array1 (to_array1 temp___581))
  (forall ((temporary_array2 (Array Int octet)))
  (=>
  (let ((temp___582 (first1 value)))
  (let ((temp___583 (last1 value)))
  (exists ((i Int))
  (and (= i temp___582)
  (ite (= (and (ite (<= temp___582 i) true false) (ite (<= i temp___583) true
                                                  false)) true)
  (exists ((temporary_array3 (Array Int octet)) (i1 Int))
  (and
  (= (and (ite true true false) (ite (and (<= (first1 value) i1)
                                     (<= i1 (last1 value)))
                                true false)) true)
  (exists ((o Int))
  (and (= (to_rep (select (to_array value) i1)) o)
  (exists ((o1 octet))
  (and (= (to_rep2 o1) ((_ int_to_bv 8) o))
  (let ((o2 (- i1 (first1 value))))
  (and (in_range1 o2)
  (and
  (and (<= (to_rep1 temporary_array__first) o2)
  (<= o2 (to_rep1 temporary_array__last)))
  (and (= temporary_array2 (store temporary_array3 o2 o1)) (= i1 temp___583)))))))))))
  (= temporary_array2 temporary_array1))))))
  (forall ((o Int))
  (=> (= (to_rep1 temporary_array__last) o)
  (forall ((o1 Int))
  (=> (= (to_rep1 temporary_array__first) o1)
  (forall ((last5 Int))
  (=>
  (forall ((o2 us_t1)) (length_with_padding__function_guard
  (length_with_padding (length2 o2)) (length2 o2)))
  (=>
  (and
  (= last5 (+ position (- (length_with_padding
                          (length2 (of_array1 temporary_array2 o1 o))) 1)))
  (dynamic_invariant2 last5 true true true true))
  (=> (length_with_padding__function_guard
  (length_with_padding (length1 value)) (length1 value))
