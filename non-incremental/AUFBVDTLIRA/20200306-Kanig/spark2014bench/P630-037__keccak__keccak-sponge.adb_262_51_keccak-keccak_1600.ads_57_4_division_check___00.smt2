...
;; defqtvc
 ;; File "keccak-sponge.ads", line 175, characters 0-0
  ...
  (= (mod2 (in_queue_bit_length (us_repqtmk ctx__split_fields1)) 8) (mod2
                                                                    suffix_len
                                                                    8)))
  ...
  (and (= spark__branch1 (ite (= suffix_len 0) true false))
  ...
  (and (= spark__branch2 (ite (= (mod2 bit_length 8) 0) true false))
  ...
  (= (rate_of (us_repqtmk ctx__split_fields2)) (rate_of
                                               (us_repqtmk ctx__split_fields))))
  (= (mod2 (in_queue_bit_length (us_repqtmk ctx__split_fields2)) 8) (mod2
                                                                    bit_length
                                                                    8)))
  (< (in_queue_bit_length (us_repqtmk ctx__split_fields2)) (rate_of
                                                           ...
                                                           ctx__split_fields2))))
  (exists ((o4 byte))
  (and (= (to_rep1 o4) suffix)
  (exists ((suffix_array1 (Array Int byte)))
  (and (= suffix_array1 (store suffix_array 0 o4))
  (and
  (and
  (and (= (state_of (us_repqtmk ctx__split_fields1)) 0)
  (= (rate_of (us_repqtmk ctx__split_fields1)) (rate_of
  ...
  (and (in_range1 o5)
  (and (in_range4 o5)
  (exists ((message_last1 Int))
  (and (= message_last1 o5)
  (and
  ...
  (and (= spark__branch3 (ite (<= o6 8) true false))
  (and
  (and
  (and
  (and (= (state_of (us_repqtmk ctx__split_fields1)) 0)
  ...
  (dynamic_invariant1 initial_rate false true true true)))))))))))))))))))))))
  ...
  (let ((o10 (us_repqtmk ctx__split_fields1)))
  (let ((o11 (in_queue_bit_length o10)))
  (=>
  (and (in_queue_bit_length__function_guard o11 o10)
