...
;; defqtvc
 ;; File "very_longs.ads", line 40, characters 0-0
  ...
  (let ((temp___971 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 number))))
  (=> (and (<= (first1 temp___971) index) (<= index (last1 temp___971)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___971) index)) o2)
  (forall ((spark__branch1 Bool))
  (=> (= spark__branch1 (ite (not (= o2 #x00)) true false))
  (=> (= spark__branch1 true) (in_range4 index)))))))))))))))))))))))
(check-sat)
(exit)
