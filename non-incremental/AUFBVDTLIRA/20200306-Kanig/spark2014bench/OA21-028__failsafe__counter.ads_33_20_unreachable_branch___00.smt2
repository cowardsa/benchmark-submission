...
;; defqtvc
 ;; File "counter.ads", line 29, characters 0-0
  ...
  (exists ((inputs3 (Array (_ BitVec 8) Bool)) (i1 (_ BitVec 8)))
  (and
  (and
  (forall ((k (_ BitVec 8)))
  (=> (and (bvule #x01 k) (bvule k (bvsub i1 #x01)))
  (= (= (select inputs3 k) true)
  (= (select temp___loop_entry_214 (bvadd k #x01)) true))))
  (forall ((k (_ BitVec 8)))
  (=> (and (bvule i1 k) (bvule k #x0A))
  (= (= (select inputs3 k) true) (= (select temp___loop_entry_216 k) true)))))
  (and
  (= (and (ite (and (in_range3 i1)
               ...
               (= (select inputs3 temp___212) (select inputs temp___212))))))
          true false) (ite (and (bvule #x01 i1) (bvule i1 #x09)) true false)) true)
  (and (= inputs1 (store inputs3 i1 (select inputs3 (bvadd i1 #x01))))
  (= i1 #x09))))))))) (= inputs1 inputs))
  (=> (= inputs2 (store inputs1 #x0A input))
  (not
  (forall ((k (_ BitVec 8)))
  (=> (and (bvule #x01 k) (bvule k #x09))
  (= (= (select inputs2 k) true) (= (select inputs (bvadd k #x01)) true)))))))))))
(check-sat)
(exit)
