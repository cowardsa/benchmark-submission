...
(define-fun to_int2 ((x unsigned_8)) Int (ubv_to_int (to_rep1 x)))
...
(declare-datatypes ((buffer_type__ref 0))
(((buffer_type__refqtmk (buffer_type__content us_t)))))
...
;; defqtvc
 ;; File "p.ads", line 6, characters 0-0
  (not
  (forall ((buf (Array Int unsigned_8)) (o Int))
  (=> (dynamic_property 0 2147483647 (to_rep buf__first) (to_rep buf__last))
  (=> (dynamic_invariant i true false true true)
  (=> (< i (length (to_rep buf__first) (to_rep buf__last)))
  (=> (= (to_rep buf__first) o)
  (let ((o1 (+ o i)))
  (=> (in_range o1)
  (=> (and (<= (to_rep buf__first) o1) (<= o1 (to_rep buf__last)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep1 (select buf o1)) o2)
  (forall ((temp (_ BitVec 8)))
  (=> (= temp o2)
  (=> (dynamic_invariant1 temp true false true true)
  (forall ((o3 unsigned_8))
  (=> (= (to_rep1 o3) (bvadd temp #x01))
  (forall ((o4 Int))
  (=> (= (to_rep buf__first) o4)
  (let ((o5 (+ o4 i))) (=> (in_range o5) (<= (to_rep buf__first) o5))))))))))))))))))))))
(check-sat)
(exit)
