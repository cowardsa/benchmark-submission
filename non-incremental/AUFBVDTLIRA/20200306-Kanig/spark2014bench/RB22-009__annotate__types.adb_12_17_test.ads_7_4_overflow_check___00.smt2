...
;; defqtvc
 ;; File "test.ads", line 7, characters 0-0
  (not
  (forall ((result__ (_ BitVec 8)) (i Int))
  ...
  (=> (in_range1 o)
  (=> (< i o)
  (forall ((result__1 (_ BitVec 8)) (i1 Int))
  (=>
  (= (and (ite (and (dynamic_invariant i1 true true true true)
               (dynamic_invariant1 result__1 true true true true))
          true false) (ite (< i1 (length buffer)) true false)) true)
  (let ((o1 (+ (first1 buffer) i1)))
  (=> (in_range1 o1)
  (=> (and (<= (first1 buffer) o1) (<= o1 (last1 buffer)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep1 (select (to_array buffer) o1)) o2)
  (forall ((result__2 (_ BitVec 8)))
  (=> (= result__2 (bvadd result__1 o2)) (in_range1 (+ i1 1))))))))))))))))))))))
(check-sat)
(exit)
