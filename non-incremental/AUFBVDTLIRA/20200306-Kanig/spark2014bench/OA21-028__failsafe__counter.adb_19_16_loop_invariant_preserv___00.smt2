...
;; defqtvc
 ;; File "counter.ads", line 29, characters 0-0
  ...
  (temp___loop_entry_214 (Array (_ BitVec 8) Bool))
  (temp___loop_entry_216 (Array (_ BitVec 8) Bool))
  (inputs1 (Array (_ BitVec 8) Bool)) (i1 (_ BitVec 8))
  (inputs2 (Array (_ BitVec 8) Bool)) (i2 (_ BitVec 8)) (k (_ BitVec 8)))
  (=> (= i #x01)
  (=>
  (= (and (ite (bvule #x01 i) true false) (ite (bvule i #x09) true false)) true)
  (=> (= temp___loop_entry_214 inputs)
  (=> (= temp___loop_entry_216 inputs)
  (=>
  (forall ((k1 (_ BitVec 8)))
  (=> (and (bvule #x01 k1) (bvule k1 (bvsub i1 #x01)))
  (= (= (select inputs1 k1) true)
  (= (select temp___loop_entry_214 (bvadd k1 #x01)) true))))
  (=>
  (forall ((k1 (_ BitVec 8)))
  (=> (and (bvule i1 k1) (bvule k1 #x0A))
  (= (= (select inputs1 k1) true) (= (select temp___loop_entry_216 k1) true))))
  (=>
  (= (and (ite (and (in_range3 i1)
               ...
               (= (select inputs1 temp___212) (select inputs temp___212))))))
          true false) (ite (and (bvule #x01 i1) (bvule i1 #x09)) true false)) true)
  (=> (= inputs2 (store inputs1 i1 (select inputs1 (bvadd i1 #x01))))
  (=> (not (= i1 #x09))
  (=> (= i2 (bvadd i1 #x01))
  (=> (bvule #x01 k)
  (=> (bvule k (bvsub i2 #x01))
