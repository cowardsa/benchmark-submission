...
(declare-fun user_eq (dst_subject_type dst_subject_type) Bool)

(declare-const dummy dst_subject_type)
...
(define-fun to_rep ((x dst_subject_type)) Int (dst_subject_typeqtint x))

(declare-fun of_rep (Int) dst_subject_type)
...
;; range_axiom
  (assert
  (forall ((x dst_subject_type)) (! (in_range1
...
(define-fun in_range2 ((x Int)) Bool (and (<= 0 x) (<= x 256)))
...
(declare-fun user_eq1 (dst_vector_range dst_vector_range) Bool)

(declare-const dummy1 dst_vector_range)
...
(define-fun to_rep1 ((x dst_vector_range)) Int (dst_vector_rangeqtint x))

(declare-fun of_rep1 (Int) dst_vector_range)
...
;; range_axiom
  (assert
  (forall ((x dst_vector_range)) (! (in_range2
...
(define-fun us_split_fields_rec__ada___skp__subjects__event_entry_type__dst_subject__projection ((a us_split_fields)) dst_subject_type 
  (rec__ada___skp__subjects__event_entry_type__dst_subject a))

(define-fun us_split_fields_rec__ada___skp__subjects__event_entry_type__dst_vector__projection ((a us_split_fields)) dst_vector_range 
  (rec__ada___skp__subjects__event_entry_type__dst_vector a))

(define-fun us_split_fields_rec__ada___skp__subjects__event_entry_type__handover__projection ((a us_split_fields)) Bool 
  (rec__ada___skp__subjects__event_entry_type__handover a))

(define-fun us_split_fields_rec__ada___skp__subjects__event_entry_type__send_ipi__projection ((a us_split_fields)) Bool 
...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (= (ite (rec__ada___skp__subjects__event_entry_type__handover
                                (us_split_fields1 a)) 1 0) (ite (rec__ada___skp__subjects__event_entry_type__handover
                                                                (us_split_fields1
                                                                b)) 1 0))
                        (= (ite (rec__ada___skp__subjects__event_entry_type__send_ipi
                                (us_split_fields1 a)) 1 0) (ite (rec__ada___skp__subjects__event_entry_type__send_ipi
                                                                (us_split_fields1
                                                                b)) 1 0))))
                   true false))
...
(((event_entry_type__refqtmk (event_entry_type__content us_rep)))))
(define-fun event_entry_type__ref_event_entry_type__content__projection ((a event_entry_type__ref)) us_rep 
...
(declare-fun user_eq3 (profile_kind profile_kind) Bool)

(declare-const dummy3 profile_kind)
...
(declare-fun to_rep2 (profile_kind) Int)

(declare-fun of_rep2 (Int) profile_kind)
...
(declare-fun to_rep3 (word32) (_ BitVec 32))

(declare-fun of_rep3 ((_ BitVec 32)) word32)
...
(define-fun to_int3 ((x word32)) Int (ubv_to_int (to_rep3 x)))
...
(define-fun us_split_fields_rec__ada___skp__subjects__vmx_controls_type__exec_pin__projection ((a us_split_fields2)) word32 
  (rec__ada___skp__subjects__vmx_controls_type__exec_pin a))

(define-fun us_split_fields_rec__ada___skp__subjects__vmx_controls_type__exec_proc__projection ((a us_split_fields2)) word32 
  (rec__ada___skp__subjects__vmx_controls_type__exec_proc a))

(define-fun us_split_fields_rec__ada___skp__subjects__vmx_controls_type__exec_proc2__projection ((a us_split_fields2)) word32 
  (rec__ada___skp__subjects__vmx_controls_type__exec_proc2 a))

(define-fun us_split_fields_rec__ada___skp__subjects__vmx_controls_type__exit_ctrls__projection ((a us_split_fields2)) word32 
  (rec__ada___skp__subjects__vmx_controls_type__exit_ctrls a))

(define-fun us_split_fields_rec__ada___skp__subjects__vmx_controls_type__entry_ctrls__projection ((a us_split_fields2)) word32 
...
(((vmx_controls_type__refqtmk (vmx_controls_type__content us_rep1)))))
(define-fun vmx_controls_type__ref_vmx_controls_type__content__projection ((a vmx_controls_type__ref)) us_rep1 
...
(declare-fun user_eq6 (word64 word64) Bool)

(declare-const dummy6 word64)
...
(declare-fun to_rep4 (word64) (_ BitVec 64))

(declare-fun of_rep4 ((_ BitVec 64)) word64)
...
(define-fun to_int4 ((x word64)) Int (ubv_to_int (to_rep4 x)))
...
(define-fun us_split_fields_rec__ada___skp__subjects__trap_entry_type__dst_subject__projection ((a us_split_fields4)) dst_subject_type 
  (rec__ada___skp__subjects__trap_entry_type__dst_subject a))

(define-fun us_split_fields_rec__ada___skp__subjects__trap_entry_type__dst_vector__projection ((a us_split_fields4)) dst_vector_range 
...
(((trap_entry_type__refqtmk (trap_entry_type__content us_rep2)))))
(define-fun trap_entry_type__ref_trap_entry_type__content__projection ((a trap_entry_type__ref)) us_rep2 
...
(define-fun bool_eq4 ((a (Array Int us_rep)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq (select a temp___idx_160)
...
(define-fun us_split_fields_rec__ada___skp__subjects__subject_spec_type__vmx_controls__projection ((a us_split_fields6)) us_rep1 
  (rec__ada___skp__subjects__subject_spec_type__vmx_controls a))

(define-fun us_split_fields_rec__ada___skp__subjects__subject_spec_type__trap_table__projection ((a us_split_fields6)) (Array Int us_rep2) 
  (rec__ada___skp__subjects__subject_spec_type__trap_table a))

(define-fun us_split_fields_rec__ada___skp__subjects__subject_spec_type__event_table__projection ((a us_split_fields6)) (Array Int us_rep) 
...
(declare-sort event_range 0)

(declare-fun event_rangeqtint (event_range) Int)

;; event_range'axiom
  (assert
  (forall ((i event_range))
  (and (<= 0 (event_rangeqtint i)) (<= (event_rangeqtint i) 31))))

(define-fun in_range5 ((x Int)) Bool (and (<= 0 x) (<= x 31)))
...
(declare-fun user_eq12 (event_range event_range) Bool)

(declare-const dummy12 event_range)

(declare-datatypes ((event_range__ref 0))
(((event_range__refqtmk (event_range__content event_range)))))
(define-fun event_range__ref_event_range__content__projection ((a event_range__ref)) event_range 
  (event_range__content a))

(define-fun dynamic_invariant ((temp___expr_381 Int)
  ...
  (temp___do_typ_inv_380 Bool)) Bool (=>
                                     ...
                                     (<= 0 31)) (in_range5 temp___expr_381)))
...
(declare-fun user_eq13 (subject_id_type subject_id_type) Bool)

(declare-const dummy13 subject_id_type)
...
(define-fun dynamic_invariant1 ((temp___expr_414 Int)
  ...
  (temp___do_typ_inv_413 Bool)) Bool (=>
                                     ...
                                     (<= 0 6)) (in_range6 temp___expr_414)))

(declare-const null_trap us_rep2)

(declare-const attr__ATTRIBUTE_ADDRESS3 Int)

(declare-const null_trap_table (Array Int us_rep2))

(declare-const attr__ATTRIBUTE_ADDRESS4 Int)

(declare-fun ada___skp__subjects__null_trap_table__aggregate_def (us_rep2) (Array Int us_rep2))
...
;; def_axiom
  (assert
  (forall ((temp___158 us_rep2))
  (forall ((temp___159 Int))
  (= (select (ada___skp__subjects__null_trap_table__aggregate_def temp___158) temp___159) temp___158))))

(declare-const null_event us_rep)

(declare-const attr__ATTRIBUTE_ADDRESS5 Int)

(declare-const null_event_table (Array Int us_rep))

(declare-const attr__ATTRIBUTE_ADDRESS6 Int)

(declare-fun ada___skp__subjects__null_event_table__aggregate_def (us_rep) (Array Int us_rep))
...
(declare-fun temp_____aggregate_def_174 (us_rep us_rep
  us_rep) (Array Int us_rep))

(declare-fun temp_____aggregate_def_180 (us_rep us_rep) (Array Int us_rep))

(declare-fun temp_____aggregate_def_185 (us_rep us_rep
  us_rep) (Array Int us_rep))

(declare-fun temp_____aggregate_def_191 (us_rep us_rep
  us_rep) (Array Int us_rep))

(declare-fun temp_____aggregate_def_197 (us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2) (Array Int us_rep2))

(declare-fun temp_____aggregate_def_258 (us_rep us_rep) (Array Int us_rep))

(declare-fun temp_____aggregate_def_263 (us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
...
(declare-fun temp_____aggregate_def_324 (us_rep us_rep) (Array Int us_rep))
...
;; subject_specs__def_axiom
  ...
  (= subject_specs (ada___skp__subjects__subject_specs__aggregate_def
                   (us_repqtmk3
                   (us_split_fieldsqtmk3 rliteral (of_rep2 0)
                   (of_rep4 #x0000000000F4A000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000005000) (of_rep4 #x0000000000F60000)
                   (of_rep4 #x0000000000F72000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000003000) (of_rep4 #x0000000000006000)
                   (of_rep4 #x0000000080010033) (of_rep4 #x00000000E005003F)
                   (of_rep4 #x0000000000002220) (of_rep4 #x00000000001767FF)
                   (of_rep3 #x0000A09B) (of_rep3 #xFFFFFFFF)
                   (of_rep3 #x00000000)
                   (us_repqtmk1
                   (us_split_fieldsqtmk1 (of_rep3 #x00000049)
                   (of_rep3 #xB2999E00) (of_rep3 #x00000040)
                   (of_rep3 #x00408200) (of_rep3 #x00000200)))
                   null_trap_table null_event_table))
                   (us_repqtmk3
                   (us_split_fieldsqtmk3 rliteral (of_rep2 0)
                   (of_rep4 #x0000000000F56000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000006000) (of_rep4 #x0000000000F6A000)
                   (of_rep4 #x0000000000F7E000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000003000) (of_rep4 #x0000000000006000)
                   (of_rep4 #x0000000080010033) (of_rep4 #x00000000E005003F)
                   (of_rep4 #x0000000000002220) (of_rep4 #x00000000001767FF)
                   (of_rep3 #x0000A09B) (of_rep3 #xFFFFFFFF)
                   ...
                   (us_repqtmk
                   (us_split_fieldsqtmk rliteral1 rliteral2 (distinct 0 0)
                   (distinct 1 0)))
                   (us_repqtmk
                   (us_split_fieldsqtmk rliteral3 rliteral2 (distinct 0 0)
                   (distinct 1 0))) null_event)))
                   (us_repqtmk3
                   (us_split_fieldsqtmk3 rliteral4 (of_rep2 0)
                   (of_rep4 #x0000000000F4E000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000007000) (of_rep4 #x0000000000F62000)
                   (of_rep4 #x0000000000F73000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000003000) (of_rep4 #x0000000000006000)
                   (of_rep4 #x0000000080010033) (of_rep4 #x00000000E005003F)
                   (of_rep4 #x0000000000002220) (of_rep4 #x00000000001767FF)
                   (of_rep3 #x0000A09B) (of_rep3 #xFFFFFFFF)
                   ...
                   (us_repqtmk
                   (us_split_fieldsqtmk rliteral5 rliteral6 (distinct 0 0)
                   (distinct 1 0))) null_event)))
                   (us_repqtmk3
                   (us_split_fieldsqtmk3 rliteral7 (of_rep2 0)
                   (of_rep4 #x0000000000F46000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000008000) (of_rep4 #x0000000000F5E000)
                   (of_rep4 #x0000000000F71000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000003000) (of_rep4 #x0000000000006000)
                   (of_rep4 #x0000000080010033) (of_rep4 #x00000000E005003F)
                   (of_rep4 #x0000000000002220) (of_rep4 #x00000000001767FF)
                   (of_rep3 #x0000A09B) (of_rep3 #xFFFFFFFF)
                   ...
                   (us_repqtmk
                   (us_split_fieldsqtmk rliteral1 rliteral8 (distinct 1 0)
                   (distinct 0 0)))
                   (us_repqtmk
                   (us_split_fieldsqtmk rliteral5 rliteral9 (distinct 0 0)
                   (distinct 1 0))) null_event)))
                   (us_repqtmk3
                   (us_split_fieldsqtmk3 rliteral10 (of_rep2 0)
                   (of_rep4 #x0000000000F52000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000009000) (of_rep4 #x0000000000F68000)
                   (of_rep4 #x0000000000F7A000) (of_rep4 #x0000000000000000)
                   (of_rep4 #x0000000000003000) (of_rep4 #x0000000000006000)
                   (of_rep4 #x0000000080010033) (of_rep4 #x00000000E005003F)
                   (of_rep4 #x0000000000002220) (of_rep4 #x00000000001767FF)
                   (of_rep3 #x0000A09B) (of_rep3 #xFFFFFFFF)
                   ...
                   (us_repqtmk
                   (us_split_fieldsqtmk rliteral3 rliteral8 (distinct 1 0)
                   (distinct 0 0)))
                   (us_repqtmk
                   (us_split_fieldsqtmk rliteral5 rliteral11 (distinct 0 0)
                   (distinct 1 0))) null_event)))
                   (us_repqtmk3
                   (us_split_fieldsqtmk3 rliteral7 (of_rep2 1)
                   (of_rep4 #x0000000000000000) (of_rep4 #x0000000000DAF01E)
                   (of_rep4 #x000000000000A000) (of_rep4 #x0000000000F5A000)
                   (of_rep4 #x0000000000F6F000) (of_rep4 #x0000000000F70000)
                   (of_rep4 #x0000000000000000) (of_rep4 #x0000000000400000)
                   (of_rep4 #x0000000000000035) (of_rep4 #x0000000000000020)
                   (of_rep4 #x0000000000002020) (of_rep4 #x0000000000002000)
                   (of_rep3 #x0000C09B) (of_rep3 #xFFF08002)
                   (of_rep3 #x00000005)
                   (us_repqtmk1
                   (us_split_fieldsqtmk1 (of_rep3 #x00000049)
                   (of_rep3 #xB2981E00) (of_rep3 #x000000C2)
                   (of_rep3 #x00708200) (of_rep3 #x00008000)))
                   (temp_____aggregate_def_197
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral12 rliteral9))
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral12 rliteral9))
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral12 rliteral9))
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral12 rliteral9))
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral12 rliteral9))
                   ...
                   (us_repqtmk
                   (us_split_fieldsqtmk rliteral5 rliteral13 (distinct 0 0)
                   (distinct 1 0))) null_event)))
                   (us_repqtmk3
                   (us_split_fieldsqtmk3 rliteral10 (of_rep2 1)
                   (of_rep4 #x0000000000000000) (of_rep4 #x00000000009A001E)
                   (of_rep4 #x000000000000B000) (of_rep4 #x0000000000F64000)
                   (of_rep4 #x0000000000F78000) (of_rep4 #x0000000000F79000)
                   (of_rep4 #x0000000000000000) (of_rep4 #x0000000000400000)
                   (of_rep4 #x0000000000000035) (of_rep4 #x0000000000000020)
                   (of_rep4 #x0000000000002020) (of_rep4 #x0000000000002000)
                   (of_rep3 #x0000C09B) (of_rep3 #xFFF08002)
                   ...
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral14 rliteral9))
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral14 rliteral9))
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral14 rliteral9))
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral14 rliteral9))
                   (us_repqtmk2 (us_split_fieldsqtmk2 rliteral14 rliteral9))
                   ...
                   (us_repqtmk
                   (us_split_fieldsqtmk rliteral5 rliteral15 (distinct 0 0)
                   (distinct 1 0))) null_event))))))
...
;; def_axiom
  (assert
  (forall ((temp___176 us_rep) (temp___177 us_rep) (temp___178 us_rep))
...
;; def_axiom
  (assert
  (forall ((temp___182 us_rep) (temp___183 us_rep))
...
;; def_axiom
  (assert
  (forall ((temp___187 us_rep) (temp___188 us_rep) (temp___189 us_rep))
...
;; def_axiom
  (assert
  (forall ((temp___193 us_rep) (temp___194 us_rep) (temp___195 us_rep))
...
;; def_axiom
  (assert
  (forall ((temp___199 us_rep2) (temp___200 us_rep2) (temp___201 us_rep2)
  (temp___202 us_rep2) (temp___203 us_rep2) (temp___204 us_rep2)
  (temp___205 us_rep2) (temp___206 us_rep2) (temp___207 us_rep2)
  (temp___208 us_rep2) (temp___209 us_rep2) (temp___210 us_rep2)
  (temp___211 us_rep2) (temp___212 us_rep2) (temp___213 us_rep2)
  (temp___214 us_rep2) (temp___215 us_rep2) (temp___216 us_rep2)
  (temp___217 us_rep2) (temp___218 us_rep2) (temp___219 us_rep2)
  (temp___220 us_rep2) (temp___221 us_rep2) (temp___222 us_rep2)
  (temp___223 us_rep2) (temp___224 us_rep2) (temp___225 us_rep2)
  (temp___226 us_rep2) (temp___227 us_rep2) (temp___228 us_rep2)
  (temp___229 us_rep2) (temp___230 us_rep2) (temp___231 us_rep2)
  (temp___232 us_rep2) (temp___233 us_rep2) (temp___234 us_rep2)
  (temp___235 us_rep2) (temp___236 us_rep2) (temp___237 us_rep2)
  (temp___238 us_rep2) (temp___239 us_rep2) (temp___240 us_rep2)
  (temp___241 us_rep2) (temp___242 us_rep2) (temp___243 us_rep2)
  (temp___244 us_rep2) (temp___245 us_rep2) (temp___246 us_rep2)
  (temp___247 us_rep2) (temp___248 us_rep2) (temp___249 us_rep2)
  (temp___250 us_rep2) (temp___251 us_rep2) (temp___252 us_rep2)
  (temp___253 us_rep2) (temp___254 us_rep2) (temp___255 us_rep2)
  (temp___256 us_rep2))
...
;; def_axiom
  (assert
  (forall ((temp___260 us_rep) (temp___261 us_rep))
...
;; def_axiom
  (assert
  (forall ((temp___265 us_rep2) (temp___266 us_rep2) (temp___267 us_rep2)
  (temp___268 us_rep2) (temp___269 us_rep2) (temp___270 us_rep2)
  (temp___271 us_rep2) (temp___272 us_rep2) (temp___273 us_rep2)
  (temp___274 us_rep2) (temp___275 us_rep2) (temp___276 us_rep2)
  (temp___277 us_rep2) (temp___278 us_rep2) (temp___279 us_rep2)
  (temp___280 us_rep2) (temp___281 us_rep2) (temp___282 us_rep2)
  (temp___283 us_rep2) (temp___284 us_rep2) (temp___285 us_rep2)
  (temp___286 us_rep2) (temp___287 us_rep2) (temp___288 us_rep2)
  (temp___289 us_rep2) (temp___290 us_rep2) (temp___291 us_rep2)
  (temp___292 us_rep2) (temp___293 us_rep2) (temp___294 us_rep2)
  (temp___295 us_rep2) (temp___296 us_rep2) (temp___297 us_rep2)
  (temp___298 us_rep2) (temp___299 us_rep2) (temp___300 us_rep2)
  (temp___301 us_rep2) (temp___302 us_rep2) (temp___303 us_rep2)
  (temp___304 us_rep2) (temp___305 us_rep2) (temp___306 us_rep2)
  (temp___307 us_rep2) (temp___308 us_rep2) (temp___309 us_rep2)
  (temp___310 us_rep2) (temp___311 us_rep2) (temp___312 us_rep2)
  (temp___313 us_rep2) (temp___314 us_rep2) (temp___315 us_rep2)
  (temp___316 us_rep2) (temp___317 us_rep2) (temp___318 us_rep2)
  (temp___319 us_rep2) (temp___320 us_rep2) (temp___321 us_rep2)
  (temp___322 us_rep2))
...
;; def_axiom
  (assert
  (forall ((temp___326 us_rep) (temp___327 us_rep))
...
(define-fun dynamic_invariant2 ((temp___expr_333 Int)
...
;; null_trap__def_axiom
  (assert
  (= null_trap (us_repqtmk2 (us_split_fieldsqtmk2 rliteral16 rliteral8))))

;; null_event__def_axiom
  (assert
  (= null_event (us_repqtmk
                (us_split_fieldsqtmk rliteral16 rliteral8 (distinct 0 0)
                (distinct 0 0)))))
...
(define-fun dynamic_invariant4 ((temp___expr_340 Int)
  ...
  (temp___do_typ_inv_339 Bool)) Bool (=>
                                     ...
                                     (<= 0 7)) (in_range1 temp___expr_340)))

(define-fun dynamic_invariant5 ((temp___expr_347 Int)
  ...
  (temp___do_typ_inv_346 Bool)) Bool (=>
                                     ...
                                     (<= 0 256)) (in_range2 temp___expr_347)))

(define-fun dynamic_invariant6 ((temp___expr_388 (_ BitVec 32))
  (temp___is_init_384 Bool) (temp___skip_constant_385 Bool)
  (temp___do_toplevel_386 Bool) (temp___do_typ_inv_387 Bool)) Bool true)

(define-fun dynamic_invariant7 ((temp___expr_407 (_ BitVec 64))
  (temp___is_init_403 Bool) (temp___skip_constant_404 Bool)
  (temp___do_toplevel_405 Bool) (temp___do_typ_inv_406 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "skp-subjects.ads", line 51, characters 0-0
  (not
  (forall ((ada___skp__subjects__get_event__result us_split_fields))
  (=> (dynamic_invariant1 subject_id true false true true)
  (=> (dynamic_invariant event_nr true false true true)
  (=>
  (not
  (= (to_rep
     (rec__ada___skp__subjects__event_entry_type__dst_subject
     ...
     (select (rec__ada___skp__subjects__subject_spec_type__event_table
             (us_split_fields7 (select subject_specs 0))) 0)))) 0))
  (=>
  (not
  (= (to_rep
     (rec__ada___skp__subjects__event_entry_type__dst_subject
  ...
  (=>
  (= (us_repqtmk ada___skp__subjects__get_event__result) (select (rec__ada___skp__subjects__subject_spec_type__event_table
                                                                 (us_split_fields7
                                                                 (select 
                                                                 subject_specs 
                                                                 subject_id))) 
