...
;; defqtvc
 ;; File "x86.ads", line 453, characters 0-0
  ...
  (to_rep (select memory8 addr))) (bvmul ((_ zero_extend 56) (to_rep
                                                             (select memory8 (bvadd 
                                                             addr #x0000000000000001)))) #x0000000000000100)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory8 (bvadd addr #x0000000000000002)))) #x0000000000010000)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory8 (bvadd addr #x0000000000000003)))) #x0000000001000000)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory8 (bvadd addr #x0000000000000004)))) #x0000000100000000)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory8 (bvadd addr #x0000000000000005)))) #x0000010000000000)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory8 (bvadd addr #x0000000000000006)))) #x0001000000000000)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory8 (bvadd addr #x0000000000000007)))) #x0100000000000000)) 
  val__))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
