...
;; defqtvc
 ;; File "test_length.adb", line 4, characters 0-0
  (not
  (let ((test_length__p1__a__assume (create #xFFFF)))
  (=>
  (and (create__function_guard test_length__p1__a__assume #xFFFF)
  (and (dynamic_invariant2 test_length__p1__a__assume true false true true)
  (and (= (first1 test_length__p1__a__assume) #x0000)
  (= (last1 test_length__p1__a__assume) #xFFFF))))
  (forall ((a (Array (_ BitVec 16) natural)))
  (=> (= a (to_array test_length__p1__a__assume))
  (=> (= (to_rep a__first) (first1 test_length__p1__a__assume))
  (=> (= (to_rep a__last) (last1 test_length__p1__a__assume))
  (=> (dynamic_property #x0000 #xFFFF (to_rep a__first) (to_rep a__last))
  (forall ((o (_ BitVec 16)))
  (=> (= (to_rep a__last) o)
  (forall ((o1 (_ BitVec 16)))
  (=> (= (to_rep a__first) o1) (in_range1 (length (ubv_to_int o1) (ubv_to_int o))))))))))))))))
(check-sat)
(exit)
