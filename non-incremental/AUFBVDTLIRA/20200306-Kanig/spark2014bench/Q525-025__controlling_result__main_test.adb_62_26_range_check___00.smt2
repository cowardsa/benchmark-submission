...
(declare-datatypes ((object__ref1 0))
(((object__refqtmk1 (object__content1 us_rep1)))))
...
(define-fun to_int2 ((x stream_element)) Int (ubv_to_int (to_rep4 x)))
...
(declare-datatypes ((tTref_stringSP1__ref 0))
...
(declare-datatypes ((tTshort_stringSP1__ref 0))
...
;; defqtvc
 ;; File "main_test.adb", line 8, characters 0-0
  (not
  (forall ((len_n Int) (len_i Int) (len_l Int) (total_len Int))
  (let ((o (of_array (temp___String_Literal_304 Tuple0) 1 4)))
  (let ((main_test__field_10__assume (create 10 o)))
  (=>
  ...
  (=>
  (and (create__function_guard main_test__field_10__assume 10 o)
  ...
  (=> (= field_10__attr__tag us_tag)
  (let ((o1 (of_array (temp___String_Literal_305 Tuple0) 1 5)))
  (let ((main_test__field_06__assume (create 6 o1)))
  (=>
  ...
  (=>
  (and (create__function_guard main_test__field_06__assume 6 o1)
  ...
  (=> (= field_06__attr__tag us_tag)
  (let ((o2 (of_array (temp___String_Literal_306 Tuple0) 1 4)))
  (let ((main_test__stream_10__assume (create2 10 o2)))
  (=>
  ...
  (=>
  (and (create__function_guard2 main_test__stream_10__assume 10 o2)
  ...
  (=> (= stream_10__attr__tag us_tag1)
  (let ((o3 (of_array (temp___String_Literal_307 Tuple0) 1 5)))
  (let ((main_test__stream_06__assume (create2 6 o3)))
  (=>
  ...
  (=>
  (and (create__function_guard2 main_test__stream_06__assume 6 o3)
  ...
  (forall ((ref_string (Array Int character)))
  (=> (= ref_string (temp___String_Literal_308 Tuple0))
  (forall ((short_string (Array Int character)))
  (=> (= short_string (temp___String_Literal_309 Tuple0))
  ...
  (let ((temp___311 (null_string o4)))
  (and
  (and (null_string__function_guard temp___311 o4)
  (and (dynamic_invariant3 temp___311 true false true true)
  (= (length1 temp___311) (elements o4))))
  (let ((o5 (us_repqtmk field_10__split_fields field_10__attr__tag)))
  (let ((temp___310 (null_string o5)))
  (and
  (and (null_string__function_guard temp___310 o5)
  (and (dynamic_invariant3 temp___310 true false true true)
  (= (length1 temp___310) (elements o5))))
  (ite (= (length1 temp___310) 0)
  (= main_test__total_string__assume (of_array (to_array temp___311)
                                     (first1 temp___311) (last1 temp___311)))
  (let ((o6 (- (+ (first1 temp___310) (+ (length (first1 temp___310)
  ...
  (= main_test__total_string__assume (of_array
                                     ...
                                     (to_array temp___311)
                                     (first1 temp___311) (last1 temp___311))
                                     (first1 temp___310) o6)))))))))))
  (forall ((total_string (Array Int character)))
  ...
  (let ((temp___314 (null_string2 o4)))
  (and
  (and (null_string__function_guard2 temp___314 o4)
  (and (dynamic_invariant4 temp___314 true false true true)
  (= (length2 temp___314) (elements2 o4))))
  (let ((o5 (us_repqtmk1 stream_10__split_fields stream_10__attr__tag)))
  (let ((temp___313 (null_string2 o5)))
  (and
  (and (null_string__function_guard2 temp___313 o5)
  (and (dynamic_invariant4 temp___313 true false true true)
  (= (length2 temp___313) (elements2 o5))))
  (ite (= (length2 temp___313) 0)
  (= main_test__total_stream__assume (of_array1 (to_array1 temp___314)
                                     (first3 temp___314) (last3 temp___314)))
  (let ((o6 (- (+ (first3 temp___313) (+ (length (first3 temp___313)
  ...
  (= main_test__total_stream__assume (of_array1
                                     ...
                                     (first3 temp___314) (last3 temp___314))
                                     (first3 temp___313) o6)))))))))))
  (forall ((total_stream (Array Int stream_element)))
  ...
  (forall ((o4 Int))
  (=> (= (to_rep3 total_stream__last) o4)
  (forall ((o5 Int))
  (=> (= (to_rep3 total_stream__first) o5)
  (=> (in_range2 (length o5 o4))
  (forall ((o6 Int))
  (=> (= (to_rep3 total_stream__last) o6)
  (forall ((o7 Int))
  (=> (= (to_rep3 total_stream__first) o7)
  (=> (in_range (length o7 o6))
  (forall ((o8 Int))
  (=> (= (to_rep3 total_stream__last) o8)
  (forall ((o9 Int))
  (=> (= (to_rep3 total_stream__first) o9)
  (=> (in_range1 (length o9 o8))
  (forall ((o10 Int))
  (=> (= (to_rep1 total_string__last) o10)
  (forall ((o11 Int))
  (=> (= (to_rep1 total_string__first) o11)
  (=> (in_range2 (length o11 o10))
  (forall ((o12 Int))
  (=> (= (to_rep1 total_string__last) o12)
  (forall ((o13 Int))
  (=> (= (to_rep1 total_string__first) o13)
  (=> (in_range (length o13 o12))
  (forall ((o14 Int))
  (=> (= (to_rep1 total_string__last) o14)
  (forall ((o15 Int))
  (=> (= (to_rep1 total_string__first) o15)
  (let ((o16 (us_repqtmk field_06__split_fields field_06__attr__tag)))
  (let ((o17 (elements o16)))
  (=>
  (and (elements__function_guard o17 o16) (dynamic_invariant2 o17 true false
  true true))
  (let ((o18 (us_repqtmk field_10__split_fields field_10__attr__tag)))
  (let ((o19 (elements o18)))
  (=>
  (and (elements__function_guard o19 o18) (dynamic_invariant2 o19 true false
  true true))
  (let ((o20 (+ o19 o17)))
  (=> (in_range o20)
  (forall ((total_len1 Int))
  (=> (= total_len1 o20)
  (forall ((temp___320 us_t))
  (=> (forall ((o21 us_rep)) (elements__function_guard (elements o21) o21))
  (=> (forall ((o21 us_rep)) (elements__function_guard (elements o21) o21))
  (=>
  (let ((o21 (of_array short_string 1 3)))
  (let ((o22 (us_repqtmk field_06__split_fields field_06__attr__tag)))
  (let ((temp___319 (convert o22 o21)))
  (and
  (and (convert__function_guard temp___319 o22 o21)
  (and (dynamic_invariant3 temp___319 true false true true)
  (= (length1 temp___319) (elements o22))))
  (let ((o23 (of_array ref_string 1 12)))
  (let ((o24 (us_repqtmk field_10__split_fields field_10__attr__tag)))
  (let ((temp___318 (convert o24 o23)))
  (and
  (and (convert__function_guard temp___318 o24 o23)
  (and (dynamic_invariant3 temp___318 true false true true)
  (= (length1 temp___318) (elements o24))))
  (ite (= (length1 temp___318) 0)
  (= temp___320 (of_array (to_array temp___319) (first1 temp___319)
                (last1 temp___319)))
  (let ((o25 (- (+ (first1 temp___318) (+ (length (first1 temp___318)
  ...
  (= temp___320 (of_array
                ...
                (last1 temp___319)) (first1 temp___318) o25)))))))))))))
  (=>
  ...
  (forall ((total_string1 (Array Int character)))
  (=> (= total_string1 (to_array temp___320))
  (=>
  (= (length (to_rep1 total_string__first) (to_rep1 total_string__last)) total_len1)
  (let ((o21 (us_repqtmk1 stream_06__split_fields stream_06__attr__tag)))
  (let ((o22 (elements2 o21)))
  (=>
  (and (elements__function_guard2 o22 o21) (dynamic_invariant2 o22 true false
  true true))
  (let ((o23 (us_repqtmk1 stream_10__split_fields stream_10__attr__tag)))
  (let ((o24 (elements2 o23)))
  (=>
  (and (elements__function_guard2 o24 o23) (dynamic_invariant2 o24 true false
  true true))
  (=> (in_range (+ o24 o22))
  (forall ((temp___323 us_t1))
  (=>
  (forall ((o25 us_rep1)) (elements__function_guard2 (elements2 o25) o25))
  (=>
  (forall ((o25 us_rep1)) (elements__function_guard2 (elements2 o25) o25))
  (=>
  (let ((o25 (of_array short_string 1 3)))
  (let ((o26 (us_repqtmk1 stream_06__split_fields stream_06__attr__tag)))
  (let ((temp___322 (convert2 o26 o25)))
  (and
  (and (convert__function_guard2 temp___322 o26 o25)
  (and (dynamic_invariant4 temp___322 true false true true)
  (= (length2 temp___322) (elements2 o26))))
  (let ((o27 (of_array ref_string 1 12)))
  (let ((o28 (us_repqtmk1 stream_10__split_fields stream_10__attr__tag)))
  (let ((temp___321 (convert2 o28 o27)))
  (and
  (and (convert__function_guard2 temp___321 o28 o27)
  (and (dynamic_invariant4 temp___321 true false true true)
  (= (length2 temp___321) (elements2 o28))))
  (ite (= (length2 temp___321) 0)
  (= temp___323 (of_array1 (to_array1 temp___322) (first3 temp___322)
                (last3 temp___322)))
  (let ((o29 (- (+ (first3 temp___321) (+ (length (first3 temp___321)
  ...
  (= temp___323 (of_array1
                ...
                (last3 temp___322)) (first3 temp___321) o29)))))))))))))
  (=>
  ...
  (forall ((total_stream1 (Array Int stream_element)))
  (=> (= total_stream1 (to_array1 temp___323))
  (forall ((o25 Int))
  (=> (= (to_rep3 total_stream__last) o25)
  (forall ((o26 Int))
  (=> (= (to_rep3 total_stream__first) o26)
  (=> (in_range2 (length o26 o25))
  (forall ((o27 Int))
  (=> (= (to_rep3 total_stream__last) o27)
  (forall ((o28 Int))
  (=> (= (to_rep3 total_stream__first) o28)
  (=> (in_range (length o28 o27))
  (forall ((o29 Int))
  (=> (= (to_rep3 total_stream__last) o29)
  (forall ((o30 Int))
  (=> (= (to_rep3 total_stream__first) o30)
  (=> (in_range1 (length o30 o29))
  (forall ((o31 Int))
  (=> (= (to_rep1 total_string__last) o31)
  (forall ((o32 Int))
  (=> (= (to_rep1 total_string__first) o32)
  (=> (in_range2 (length o32 o31))
  (forall ((o33 Int))
  (=> (= (to_rep1 total_string__last) o33)
  (forall ((o34 Int))
  (=> (= (to_rep1 total_string__first) o34) (in_range (length o34 o33))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
