...
;; defqtvc
 ;; File "ethernet_dissector.ads", line 12, characters 0-0
  ...
  (=> (= spark__branch2 (ite (= o8 #x88A8) true false))
  (=> (= spark__branch2 true)
  ...
  (< 2 1))
  (forall ((ethertype_length_2 (Array Int byte)))
  (=>
  ...
  (=> (= spark__branch3 (ite (= o15 #x8100) true false))
  (=> (= spark__branch3 true) (in_range1 (+ (first1 buffer) 19)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
