...
;; defqtvc
 ;; File "len_problem.adb", line 1, characters 0-0
  ...
  (let ((temp___206 (len_problem__s__aggregate_def 32 65535 r1b)))
  (=> (= (first1 temp___206) 65535)
  (=> (= (last1 temp___206) r1b)
  (=>
  (ite (<= (first1 temp___206) (last1 temp___206))
  (and (<= 65535 r1b)
  (= (- (last1 temp___206) (first1 temp___206)) (- r1b 65535)))
  (< r1b 65535))
  (let ((len_problem__s__assume (of_array (to_array temp___206)
                                (first1 temp___206) (last1 temp___206))))
  (forall ((s (Array Int character)))
  (=> (= s (to_array len_problem__s__assume))
  (=> (= (to_rep s__first) (first1 len_problem__s__assume))
  (=> (= (to_rep s__last) (last1 len_problem__s__assume))
  (=>
