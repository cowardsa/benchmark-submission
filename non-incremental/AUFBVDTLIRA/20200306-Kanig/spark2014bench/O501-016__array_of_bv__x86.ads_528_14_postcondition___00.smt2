...
;; defqtvc
 ;; File "x86.ads", line 525, characters 0-0
  (not
  (forall ((o (_ BitVec 8)) (x86__readmem8ghost__result (_ BitVec 8)))
  (=> (dynamic_invariant addr true false true true)
  (=> (= (to_rep (select mem addr)) o)
  (=> (= x86__readmem8ghost__result o)
  (= x86__readmem8ghost__result (to_rep (select mem addr)))))))))
(check-sat)
(exit)
