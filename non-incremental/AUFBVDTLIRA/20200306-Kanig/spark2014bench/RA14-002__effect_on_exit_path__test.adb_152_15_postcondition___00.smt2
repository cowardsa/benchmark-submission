...
(assert
;; defqtvc
 ;; File "test.adb", line 148, characters 0-0
  (not
  ...
  (let ((q_ (us_split_fields3 (select os_task_mbx_rw task_id))))
  (let ((o task_id))
  (let ((o1 (os_mbx_get_mbx_count o os_task_mbx_rw)))
  (=>
  (and (os_mbx_get_mbx_count__function_guard o1 o os_task_mbx_rw)
  ...
  (let ((o2 (bvsub o1 #x01)))
  (=> (in_range1 o2)
  (forall ((o3 os_mbx_count_t))
  (=> (= (to_rep1 o3) o2)
  (forall ((os_task_mbx_rw2 (Array Int us_rep1)))
  (=>
  (= os_task_mbx_rw2 (store os_task_mbx_rw task_id (us_repqtmk1
                                                   (us_split_fieldsqtmk1
                                                   (rec__test__os_mbx_t__head
                                                   q_) o3
                                                   (rec__test__os_mbx_t__mbx_array
                                                   q_)))))
  (forall ((temp___index_626 Int))
  (=> (and (<= 0 temp___index_626) (<= temp___index_626 4))
  (= (bool_eq2 (select os_task_mbx_rw2 temp___index_626)
     (ite (= temp___index_626 task_id)
     (us_repqtmk1
     (let ((q_1 (us_split_fields3 (select os_task_mbx_rw1 task_id))))
     (us_split_fieldsqtmk1 (rec__test__os_mbx_t__head q_1)
     (of_rep1
     (bvsub (to_rep1
            (rec__test__os_mbx_t__count
