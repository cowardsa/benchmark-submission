...
;; defqtvc
 ;; File "main_test.adb", line 8, characters 0-0
  ...
  (=> (forall ((o23 us_rep)) (elements__function_guard (elements o23) o23))
  (=>
  ...
  (=> (forall ((o25 us_rep)) (elements__function_guard (elements o25) o25))
  (=>
  ...
  (=> (not (= (length1 temp___318) 0)) (in_range3
  (- (+ (first1 temp___318) (+ (length (first1 temp___318)
