...
;; defqtvc
 ;; File "very_longs.ads", line 12, characters 0-0
  ...
  (=> (dynamic_invariant2 length true false true true)
  (=> (in_range2 length)
  ...
  length)
  (let ((temp___887 (temp_____aggregate_def_881 #x00 1 length)))
  (=> (= (first1 temp___887) 1)
  ...
  (let ((temp___889 (of_array (to_array temp___887) (first1 temp___887)
                    (last1 temp___887))))
  (=>
  ...
  (=> (= result____split_fields1 temp___889)
  (forall ((temp1 Int))
  (=> (= temp1 number)
  (=> (= (last1 result____split_fields1) r27b)
  (=> (in_range3 r27b)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields3) temp___901)
               (<= temp___901 (last1 result____split_fields3)))
               (=>
               (or (< temp___894 temp___901)
               (or (< temp___901 1) (<= index1 temp___901)))
               (= (select (to_array result____split_fields3) temp___901) (select 
               (to_array result____split_fields1) temp___901))))))
          true false) (ite (and (<= 1 index1) (<= index1 r27b)) true false)) true)
  ...
  (forall ((very_longs__make_from_natural__result us_rep))
  (=>
