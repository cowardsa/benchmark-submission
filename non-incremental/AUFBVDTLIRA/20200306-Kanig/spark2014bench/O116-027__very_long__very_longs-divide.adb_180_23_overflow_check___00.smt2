...
;; defqtvc
 ;; File "very_longs-divide.adb", line 145, characters 0-0
  ...
  (carry (_ BitVec 16)) (product1 (_ BitVec 16))
  (temporary_digit (_ BitVec 16)) (future_borrow (_ BitVec 16))
  (carry1 (_ BitVec 16)) (current_borrow1 (_ BitVec 16))
  (spark__branch1 Bool) (u__split_fields1 us_t)
  (current_borrow2 (_ BitVec 16)) (carry2 (_ BitVec 16))
  (future_borrow1 (_ BitVec 16)) (future_borrow2 (_ BitVec 16)))
  ...
  (=> (= n r127b)
  (=> (dynamic_invariant6 r127b true false true true)
  (=>
  (let ((temp___1374 r127b))
  (exists ((divisor_index Int))
  (and (= divisor_index 1)
  (ite (= (and (ite (<= 1 divisor_index) true false) (ite (<= divisor_index temp___1374)
                                                     true false)) true)
  ...
  (and (in_range2 o2)
  (let ((temp___1377 (- o2 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1377)
  (<= temp___1377 (last1 u__split_fields2)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields2) temp___1377)) o3)
  (and
  ...
  (let ((o2 (+ j divisor_index1)))
  (and (in_range2 o2)
  (let ((temp___1379 (- o2 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1379)
  (<= temp___1379 (last1 u__split_fields2)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields2) temp___1379)) o3)
  (exists ((o4 octet))
  (and
  ...
  (and (in_range2 o5)
  (let ((temp___1381 (- o5 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1381)
  (<= temp___1381 (last1 u__split_fields2)))
  (and
  (= u__split_fields1 (us_tqtmk
                      (store (to_array u__split_fields2) temp___1381 o4)
                      (rt u__split_fields2)))
  (and (= current_borrow2 future_borrow1) (= divisor_index1 temp___1374))))))))))))))))))))))))))))
  (and
  (and
  (and
  ...
  (let ((o (+ j n)))
  (and (in_range2 o)
  (and (and (<= (first1 u__split_fields1) o) (<= o (last1 u__split_fields1)))
  (exists ((o1 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields1) o)) o1)
  ...
  (let ((o (+ j n)))
  (=> (in_range2 o)
  (=> (and (<= (first1 u__split_fields1) o) (<= o (last1 u__split_fields1)))
