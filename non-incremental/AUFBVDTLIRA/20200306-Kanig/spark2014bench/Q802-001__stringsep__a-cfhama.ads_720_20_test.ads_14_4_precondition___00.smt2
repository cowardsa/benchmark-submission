...
(((us_split_fieldsqtmk1 (rec__test__scales_map__map us_main_type)))))
(define-fun us_split_fields_rec__test__scales_map__map__projection ((a us_split_fields2)) us_main_type 
  ...
  (b us_rep1)) Bool (ite (and
                         ...
                         (= (to_rep1
                            ...
                            (us_split_discrs1 a))) (to_rep1
                                                   ...
                                                   (us_split_discrs1 b)))))
                         (= (us_main_eq
                            (rec__test__scales_map__map (us_split_fields3 a))
                            (rec__test__scales_map__map (us_split_fields3 b))) true))
                    true false))

(define-fun in_range2 ((rec__test__scales_map__map__capacity1 Int)
  (rec__test__scales_map__map__modulus1 (_ BitVec 32))
  (a us_split_discrs)) Bool (and
                            (= rec__test__scales_map__map__capacity1 
                            (to_rep (rec__test__scales_map__map__capacity a)))
                            (= rec__test__scales_map__map__modulus1 (to_rep1
                                                                    (rec__test__scales_map__map__modulus
                                                                    a)))))
...
;; length__post_axiom
  (assert
  (forall ((container us_rep1)) (! (in_range1
...
(define-fun dynamic_invariant1 ((temp___expr_524 Int)
...
;; get__post_axiom
  ...
  (forall ((key us_rep)) (! (in_range3
  (get container key)) :pattern ((get container key)) ))))
...
(define-fun default_initial_assumption ((temp___expr_532 us_rep2)
  (temp___skip_top_level_533 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_533 true))
                                         (and
                                         (= (is_empty temp___expr_532) true)
                                         (= (length2 temp___expr_532) 0))))
...
;; range_axiom
  (assert
  (forall ((x integer)) (! (in_range7 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(define-fun bool_eq4 ((x us_t)
  (y us_t)) Bool (bool_eq3 (elts x) (to_rep4 (first (rt x)))
...
(define-fun to_rep5 ((x natural)) Int (naturalqtint x))

(declare-fun of_rep5 (Int) natural)
...
;; range_axiom
  (assert
  (forall ((x natural)) (! (in_range4 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(define-fun in_range8 ((rec__ada___ada___ada__strings__superbounded__super_string__max_length1 Int)
...
(((super_string__refqtmk (super_string__content us_rep3)))))
(define-fun super_string__ref_super_string__content__projection ((a super_string__ref)) us_rep3 
  (super_string__content a))

(define-fun dynamic_invariant5 ((temp___expr_284 us_rep3)
...
(define-fun dynamic_invariant6 ((temp___expr_308 (_ BitVec 32))
...
(define-fun in_range9 ((x Int)) Bool (and (<= 1 x) (<= x 128)))
...
(define-fun to_base ((a us_rep4)) us_rep3 (us_repqtmk2 (us_split_discrs4 a)
                                          (us_split_fieldsqtmk2
                                          (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                          (us_split_fields7 a))
                                          (of_array
...
(define-fun of_base ((r us_rep3)) us_rep4 (us_repqtmk3 (us_split_discrs3 r)
                                          (us_split_fieldsqtmk3
                                          (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                          (us_split_fields5 r))
...
(((bounded_string__refqtmk (bounded_string__content us_rep4)))))
(define-fun bounded_string__ref_bounded_string__content__projection ((a bounded_string__ref)) us_rep4 
...
(define-fun dynamic_invariant7 ((temp___expr_291 us_rep4)
...
(define-fun default_initial_assumption1 ((temp___expr_294 us_rep4)
...
(((map__refqtmk3 (map__content3 us_rep5)))))
(define-fun map__ref_map__content__2__projection ((a map__ref3)) us_rep5 
  (map__content3 a))
...
(define-fun default_initial_assumption2 ((temp___expr_370 us_rep5)
  (temp___skip_top_level_371 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_371 true))
                                         (and
                                         (= (is_empty1 temp___expr_370) true)
                                         (= (length4 temp___expr_370) 0))))

(declare-datatypes ((key_type__ref1 0))
(((key_type__refqtmk1 (key_type__content1 us_rep4)))))
(define-fun key_type__ref_key_type__content__2__projection ((a key_type__ref1)) us_rep4 
...
(declare-fun witness1 (us_rep5 us_rep4) Int)

(declare-fun witness__function_guard1 (Int us_rep5 us_rep4) Bool)

(declare-fun w_get1 (us_rep5 Int) Int)

(declare-fun w_get__function_guard1 (Int us_rep5 Int) Bool)
...
(define-fun dynamic_invariant8 ((temp___expr_362 Int)
...
;; get__post_axiom
  ...
  (forall ((key us_rep4)) (! (in_range10
  (get1 container1 key)) :pattern ((get1 container1 key)) ))))

;; length__post_axiom
  (assert
  (forall ((container1 us_rep5)) (! (in_range1
  (length4 container1)) :pattern ((length4 container1)) )))
...
;; witness__post_axiom
  (assert
  (forall ((container1 us_rep5))
  (forall ((key us_rep4)) (! (in_range1
  (witness1 container1 key)) :pattern ((witness1 container1 key)) ))))

;; w_get__post_axiom
  (assert
  (forall ((container1 us_rep5))
  (forall ((witness2 Int)) (! (in_range10
  (w_get1 container1 witness2)) :pattern ((w_get1 container1 witness2)) ))))

;; user_eq__def_axiom
  (assert
  (forall ((a us_rep4) (b us_rep4))
  (! (= (user_eq14 a b) (oeq2 (of_base (to_base a)) (of_base (to_base b)))) :pattern (
  (user_eq14 a b)) )))

;; length__post_axiom
  (assert
  (forall ((container1 us_rep2)) (! (in_range1
  (length2 container1)) :pattern ((length2 container1)) )))
...
;; witness__post_axiom
  ...
  (forall ((key us_rep)) (! (in_range1
  (witness container1 key)) :pattern ((witness container1 key)) ))))

;; w_get__post_axiom
  (assert
  (forall ((container1 us_rep2))
  (forall ((witness2 Int)) (! (in_range3
  (w_get container1 witness2)) :pattern ((w_get container1 witness2)) ))))
...
;; defqtvc
 ;; File "a-cfhama.ads", line 714, characters 0-0
  ...
  (<= o1 (to_rep (rec__test__scales_map__map__capacity (us_split_discrs1 o)))))
  (let ((o2 container))
  (let ((o3 (positions o2)))
  (=>
  ...
  (=> (= (has_key o3 i) true)
  (and
  (let ((temp___568 (get o3 i)))
  (and (<= 1 temp___568) (<= temp___568 (length1 o2))))
  (forall ((j us_rep))
  (=> (= (has_key o3 j) true)
