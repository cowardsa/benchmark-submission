...
;; defqtvc
 ;; File "test.ads", line 37, characters 0-0
  (not
  (forall ((result__ (Array Int word32)) (temp___268 Int) (temp___269 Int)
  ...
  (=> (= (to_rep result____first) temp___268)
  (=> (= (to_rep result____last) temp___269)
  (=> (= i temp___268)
  (=>
  (= (and (ite (<= temp___268 i) true false) (ite (<= i temp___269) true
                                             false)) true)
  (=> (<= (first1 right) i)
  (=> (<= i (last1 right))
  ...
  (= (and (ite (and (dynamic_property1 (to_rep result____first)
               ...
               (or (< temp___273 temp___268) (< i1 temp___273)))
               (= (select result__2 temp___273) (select result__ temp___273))))))
