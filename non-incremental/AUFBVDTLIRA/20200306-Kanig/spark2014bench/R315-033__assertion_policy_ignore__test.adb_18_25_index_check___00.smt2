...
;; defqtvc
 ;; File "test.ads", line 7, characters 0-0
  ...
  (forall ((usf Int))
  (forall ((o4 Int))
  (=> (= (to_rep dest__last) o4)
  (forall ((o5 Int))
  (=> (= (to_rep dest__first) o5)
  (=>
  (= (and (ite (<= o5 usf) true false) (ite (<= usf o4) true false)) true)
  (=>
  (= (and (ite (<= index usf) true false) (ite (<= usf (+ index i)) true
                                          false)) true)
  (let ((temp___209 (- (+ src_first usf) index)))
  (=> (and (<= (first1 src) temp___209) (<= temp___209 (last1 src)))
  (=>
  (exists ((o6 (_ BitVec 8)))
  (= (to_rep1 (select (to_array src) temp___209)) o6))
