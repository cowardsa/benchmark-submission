...
(define-fun to_int2 ((x stream_element)) Int (ubv_to_int (to_rep3 x)))
...
;; defqtvc
 ;; File "polyorb_hi-output.ads", line 87, characters 0-0
  ...
  (= (and (ite (<= temp___346 j) true false) (ite (<= j (last3 stream)) true
                                             false)) true)
  (forall ((index1 Int) (output1 (Array Int character)) (j1 Int))
  (=>
  ...
  (forall ((temp___352 us_t))
  (=>
  (exists ((o (_ BitVec 8)))
  (and (= (to_rep3 (select (to_array1 stream) j1)) o)
  (exists ((temp___351 Int))
  (and (= (to_rep (select hex (ubv_to_int (bvurem o #x10)))) temp___351)
  (exists ((o1 (_ BitVec 8)))
  (and (= (to_rep3 (select (to_array1 stream) j1)) o1)
  (exists ((temp___349 Int))
  (and (= (to_rep (select hex (ubv_to_int (bvudiv o1 #x10)))) temp___349)
  (let ((o2 (- (+ 1 (+ 1 1)) 1)))
  (and (in_range1 o2)
  (exists ((o3 character))
  (and (= (to_rep o3) temp___349)
  (exists ((o4 character))
  (and (= (to_rep o4) 32)
  (let ((temp___350 (of_array (concat_singletons o4 1 o3) 1 o2)))
  (ite (= (length1 temp___350) 0)
  (exists ((o5 character))
  (and (= (to_rep o5) temp___351)
  (= temp___352 (of_array (singleton1 o5 1) 1 1))))
  (let ((o5 (- (+ (first1 temp___350) (+ (length (first1 temp___350)
                                         (last1 temp___350)) 1)) 1)))
  (and (in_range1 o5)
  (exists ((o6 character))
  (and (= (to_rep o6) temp___351)
  (= temp___352 (of_array
                (concat_singleton_right (to_array temp___350)
                (first1 temp___350) (last1 temp___350) o6)
                (first1 temp___350) o5))))))))))))))))))))))
  (=>
  (ite (<= (first1 temp___352) (last1 temp___352))
  (and (<= r19b r20b)
  (= (- (last1 temp___352) (first1 temp___352)) (- r20b r19b)))
  (< r20b r19b))
  (let ((temp___353 (of_array
                    (slide (to_array temp___352) (first1 temp___352) r19b)
                    r19b r20b)))
  (=>
  (=> (<= r19b r20b)
  (and (and (<= 1 r19b) (<= r19b 48)) (and (<= 1 r20b) (<= r20b 48))))
  (let ((temp___354 (of_array output1 r19b r20b)))
  (=>
  (ite (<= (first1 temp___353) (last1 temp___353))
  (and (<= (first1 temp___354) (last1 temp___354))
  (= (- (last1 temp___353) (first1 temp___353)) (- (last1 temp___354) 
  (first1 temp___354)))) (< (last1 temp___354) (first1 temp___354)))
  (forall ((usf (Array Int character)))
  (=>
  (forall ((temp___356 Int))
  (ite (and (<= r19b temp___356) (<= temp___356 r20b))
  (= (select usf temp___356) (select (to_array temp___353) temp___356))
  (= (select usf temp___356) (select output1 temp___356))))
