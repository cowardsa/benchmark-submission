...
;; defqtvc
 ;; File "decadriver.ads", line 80, characters 0-0
  ...
  (o2 (_ BitVec 8)) (o3 Int) (error1 Int) (spark__branch Bool) (o4 Int)
  (o5 Int))
  ...
  (let ((temp___986 (of_array
                    (slide (to_array temp___985) (first1 temp___985) o11) o10
                    r6b)))
  ...
  (=> (<= (first1 temp___986) (last1 temp___986))
  (<= (first1 temp___988) (last1 temp___988)))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
