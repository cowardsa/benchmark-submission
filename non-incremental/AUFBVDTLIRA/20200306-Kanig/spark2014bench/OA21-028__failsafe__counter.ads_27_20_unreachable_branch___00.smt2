...
;; defqtvc
 ;; File "counter.ads", line 19, characters 0-0
  (not
  (forall ((inputs (Array (_ BitVec 8) Bool)) (res (_ BitVec 8))
  (res1 (_ BitVec 8))
  (counter__model__current_chain_length__result (_ BitVec 8)))
  (=> (= res #x00)
  ...
  (= res1 res))))
  (=> (= counter__model__current_chain_length__result res1)
  (=> (= (select inputs #x0A) true)
  (=>
  (forall ((i (_ BitVec 8)))
  (=>
  (and
