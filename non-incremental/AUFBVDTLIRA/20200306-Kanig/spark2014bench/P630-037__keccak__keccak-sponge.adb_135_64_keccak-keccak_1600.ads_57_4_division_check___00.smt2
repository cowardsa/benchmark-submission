...
;; defqtvc
 ;; File "keccak-sponge.ads", line 146, characters 0-0
  ...
  (=> (= spark__branch (ite (< 0 initial_data_len) true false))
  (=> (= spark__branch true)
  (let ((o4 (+ (first1 data) (- initial_data_len 1))))
  (=> (in_range1 o4)
  (=> (in_range4 o4)
  (forall ((data_last1 Int))
  (=> (= data_last1 o4)
  (forall ((o5 Int))
  (=>
  (= (to_rep5
  ...
  (and
  (and (and (= ctx__split_fields1 ctx__split_fields) (= offset1 offset))
  (= remaining_bits1 remaining_bits)) (= remaining_bytes1 remaining_bytes))))
  (forall ((o9 Int))
  (=>
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields1)) o9)
  (=> (= (- o9 1) r71s)
  (=> (dynamic_invariant2 r71s true false true true)
  (=>
  (=> (<= 0 r71s)
  ...
  (forall ((ctx__split_fields4 us_split_fields) (offset2 Int)
  (remaining_bits2 Int) (remaining_bytes2 Int))
  (=>
  (forall ((ctx__split_fields5 us_split_fields)) (state_of__function_guard
  (state_of (us_repqtmk ctx__split_fields5))
  (us_repqtmk ctx__split_fields5)))
  (=>
  (forall ((ctx__split_fields5 us_split_fields)) (rate_of__function_guard
  (rate_of (us_repqtmk ctx__split_fields5)) (us_repqtmk ctx__split_fields5)))
  (=>
  (forall ((ctx__split_fields5 us_split_fields)) (state_of__function_guard
  (state_of (us_repqtmk ctx__split_fields5))
  (us_repqtmk ctx__split_fields5)))
  ...
  (let ((o10 (us_repqtmk ctx__split_fields3)))
  (let ((o11 (rate_of o10)))
  (and
  ...
  (< o11 1600))))
  (let ((o12 (us_repqtmk ctx__split_fields3)))
  ...
  (exists ((ctx__split_fields5 us_split_fields) (offset3 Int)
  ...
  (= (state_of (us_repqtmk ctx__split_fields5)) 0))
  (= (rate_of (us_repqtmk ctx__split_fields5)) initial_bit_rate))
  (and
  (= (and (ite (and
               (and
  ...
  (and
  (and (and (= ctx__split_fields4 ctx__split_fields3) (= offset2 offset1))
  ...
  (= (select usf temp___909) (select (rec__ada___keccak__keccak_1600__sponge__context__block
                                     ctx__split_fields4) temp___909))))
  (= ctx__split_fields5 (us_split_fieldsqtmk
                        (rec__ada___keccak__keccak_1600__sponge__context__state
                        ctx__split_fields4) usf
                        (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
                        ctx__split_fields4)
                        (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
                        ctx__split_fields4)
  ...
  (let ((o10 (us_repqtmk ctx__split_fields5)))
  (let ((o11 (rate_of o10)))
  (=>
  (and (rate_of__function_guard o11 o10)
  (and (dynamic_invariant1 o11 true false true true)
  ...
  (= o11 (* (to_rep6
            (rec__ada___keccak__keccak_1600__sponge__context__rate
            ctx__split_fields5)) 8))
  (< o11 1600))))
  (let ((o12 (us_repqtmk ctx__split_fields5)))
  (let ((o13 (rate_of o12)))
  (=>
  (and (rate_of__function_guard o13 o12)
  ...
  (= o13 (* (to_rep6
            ...
            ctx__split_fields5)) 8))
  (< o13 1600))))
  (let ((o14 (us_repqtmk ctx__split_fields5)))
  (let ((o15 (state_of o14)))
  (=>
  (and (state_of__function_guard o15 o14)
  (and (dynamic_invariant3 o15 true false true true)
  (= o15 (to_rep3
         (rec__ada___keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields5)))))
  (not (= 8 0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
