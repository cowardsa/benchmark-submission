...
;; defqtvc
 ;; File "very_longs.ads", line 55, characters 0-0
  ...
  (let ((temp___1075 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1075) i1) (<= i1 (last1 temp___1075)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1075) i1)) o2)
  (forall ((l_digit3 (_ BitVec 16)))
  (=> (= l_digit3 ((_ zero_extend 8) o2))
  (let ((temp___1076 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1076) j1) (<= j1 (last1 temp___1076)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1076) j1)) o3)
  (forall ((r_digit3 (_ BitVec 16)))
  (=> (= r_digit3 ((_ zero_extend 8) o3))
  (=> (= (last1 result____split_fields3) r92b)
  (=> (in_range2 r92b)
  (let ((o4 (+ i1 j1)))
  (=> (in_range2 o4)
