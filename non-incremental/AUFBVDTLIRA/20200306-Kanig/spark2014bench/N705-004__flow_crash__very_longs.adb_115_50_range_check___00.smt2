...
(define-fun dynamic_invariant1 ((temp___expr_445 us_rep1)
  (temp___is_init_441 Bool) (temp___skip_constant_442 Bool)
  (temp___do_toplevel_443 Bool)
  (temp___do_typ_inv_444 Bool)) Bool (and
                                     (=>
                                     ...
                                     (first1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_445)))
                                     (last1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_445))))
                                     (and
                                     (= (first1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_445))) 1)
                                     (= (last1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_445))) 
                                     octet_length)))))

(define-fun default_initial_assumption ((temp___expr_448 us_rep1)
  (temp___skip_top_level_449 Bool)) Bool (and
                                         (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_448))) octet_length)
                                         (and
                                         (= (first1
                                            (rec__very_longs__very_long__long_digits1
                                            (us_split_fields3
...
(declare-fun temp_____aggregate_def_910 ((_ BitVec 8) Int Int) us_t)
...
;; def_axiom
  (assert
  (forall ((temp___912 (_ BitVec 8)))
  (forall ((temp___913 Int) (temp___914 Int))
  (let ((temp___911 (temp_____aggregate_def_910 temp___912 temp___913
                    temp___914)))
  (=> (dynamic_invariant3 temp___912 true true true true)
  (and
  (=> (dynamic_property 1 2147483647 temp___913 temp___914)
  (and (= (first1 temp___911) temp___913) (= (last1 temp___911) temp___914)))
  (forall ((temp___915 Int))
  (= (to_rep2 (select (to_array temp___911) temp___915)) temp___912))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_259 us_rep)
...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 11, characters 0-0
  (not
  ...
  (let ((temp___916 (temp_____aggregate_def_910 #x00 1 octet_length)))
  (=> (= (first1 temp___916) 1)
  (=> (= (last1 temp___916) octet_length)
  (=>
  (ite (<= (first1 temp___916) (last1 temp___916))
  (and (<= 1 octet_length)
  (= (- (last1 temp___916) (first1 temp___916)) (- octet_length 1)))
  (< octet_length 1))
  (let ((temp___918 (of_array (to_array temp___916) (first1 temp___916)
                    (last1 temp___916))))
  (=>
  (ite (<= (first1 temp___918) (last1 temp___918))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___918) (first1 temp___918)) (- (last1
  ...
  (=> (= result____split_fields1 temp___918)
  (forall ((temp1 Int))
  (=> (= temp1 number)
  (=> (= (last1 result____split_fields1) r28b)
  (=> (in_range3 r28b)
  (let ((temp___923 r28b))
  (forall ((index Int))
  (=> (= index 1)
  (=>
  (= (and (ite (<= 1 index) true false) (ite (<= index temp___923) true
                                        false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___929)
               (<= temp___929 (last1 result____split_fields2)))
               (=>
               (or (< temp___923 temp___929)
               (or (< temp___929 1) (<= index1 temp___929)))
               (= (select (to_array result____split_fields2) temp___929) (select 
               (to_array result____split_fields1) temp___929))))))
               (dynamic_invariant temp2 false true true true))
          true false) (ite (and (<= 1 index1) (<= index1 r28b)) true false)) true)
