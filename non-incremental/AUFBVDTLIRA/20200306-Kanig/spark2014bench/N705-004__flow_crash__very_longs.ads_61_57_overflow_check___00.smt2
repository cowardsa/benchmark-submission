...
(((t90b__refqtmk (t90b__content us_t)))))
...
(define-fun us_split_fields_rec__very_longs__very_long__long_digits__26__projection ((a us_split_fields2)) us_t 
...
(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___218 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
...
(define-fun of_base ((r1 us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r1)
                                          ...
                                          (let ((temp___217 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array (to_array temp___217)
                                          (first1 temp___217)
                                          (last1 temp___217))))))
...
(define-fun dynamic_invariant4 ((temp___expr_725 us_rep1)
  (temp___is_init_721 Bool) (temp___skip_constant_722 Bool)
  (temp___do_toplevel_723 Bool)
  (temp___do_typ_inv_724 Bool)) Bool (and
                                     ...
                                     (first1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_725)))
                                     (last1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_725))))
                                     (and
                                     (= (first1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_725))) 1)
                                     (= (last1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_725))) (+ 
                                     (to_rep
...
(define-fun default_initial_assumption ((temp___expr_728 us_rep1)
  (temp___skip_top_level_729 Bool)) Bool (and
                                         (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_728))) (+ (to_rep
                                                                  (rec__very_longs__very_long__octet_length
                                                                  (us_split_discrs1
                                                                  l))) 
                                         (to_rep
...
(((t92b__refqtmk (t92b__content us_t)))))
...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 59, characters 0-0
  (not
  ...
  (=>
  (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))) o)
  (=>
  ...
  (forall ((o3 Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))) o3)
  (forall ((o4 Int))
  (=>
  ...
  (=>
  (let ((temp___1136 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r)))))
  (exists ((j Int))
  (and (= j 1)
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1136) true false)) true)
  ...
  (and
  (let ((temp___1138 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1138) true false)) true)
  ...
  (= (and (ite (and
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1139 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1139) i1) (<= i1 (last1 temp___1139)))
  (exists ((o5 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1139) i1)) o5)
  (exists ((l_digit3 (_ BitVec 16)))
  (and (= l_digit3 ((_ zero_extend 8) o5))
  (let ((temp___1140 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1140) j1) (<= j1 (last1 temp___1140)))
  (exists ((o6 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1140) j1)) o6)
  (exists ((r_digit3 (_ BitVec 16)))
  (and (= r_digit3 ((_ zero_extend 8) o6))
  (let ((o7 (+ i1 j1)))
  (and (in_range2 o7)
  (let ((temp___1142 (- o7 1)))
  (and
  (and (<= (first1 result____split_fields5) temp___1142)
  (<= temp___1142 (last1 result____split_fields5)))
  (exists ((o8 (_ BitVec 8)))
  (and
  (= (to_rep2 (select (to_array result____split_fields5) temp___1142)) o8)
  ...
  (let ((o11 (+ i1 j1)))
  (and (in_range2 o11)
  (let ((temp___1144 (- o11 1)))
  (and
  (and (<= (first1 result____split_fields5) temp___1144)
  (<= temp___1144 (last1 result____split_fields5)))
  (and
  (= result____split_fields4 (us_tqtmk
                             (store (to_array result____split_fields5) temp___1144 o10)
  ...
  (= o12 (bvudiv temp3 (ite (< 8 65536) (bvshl #x0001 ((_ int_to_bv 16) 8))
                       #x0000)))))
  (and (= carry3 o12) (= i1 temp___1138)))))))))))))))))))))))))))))))))))))
  ...
  (exists ((o7 Int))
  (and
  (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) o7)
  (let ((o8 (+ o7 j1)))
  (and (in_range2 o8)
  (and
  ...
  (forall ((o5 Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))) o5)
  (forall ((o6 Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) o6)
  (in_range2 (+ o6 o5)))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
