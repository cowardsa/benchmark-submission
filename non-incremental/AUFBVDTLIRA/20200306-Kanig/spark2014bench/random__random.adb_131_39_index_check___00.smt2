...
(declare-datatypes ((tmatD1__ref 0))
(((tmatD1__refqtmk (tmatD1__content tmatD1)))))
...
;; defqtvc
 ;; File "random.ads", line 47, characters 0-0
  (not
  (forall ((g__split_fields us_split_fields) (value (_ BitVec 32)) (o Int))
  (=> (dynamic_invariant1 value false false true true)
  (=> (= (random__random__mat__aggregate_def #x00000000 #x9908B0DF) mat)
  (=> (dynamic_invariant1 upper_mask true false true true)
  (=> (dynamic_invariant1 lower_mask true false true true)
  (=> (= (to_rep (rec__random__generator__index g__split_fields)) o)
  (let ((o1 (next o)))
  (=>
  (and (next__function_guard o1 o)
  (and (dynamic_invariant o1 true false true true)
  (= o1 (ite (= o 623) 0 (+ o 1)))))
  (forall ((o2 (_ BitVec 32)))
  (=>
  (= (to_rep1 (select (rec__random__generator__state g__split_fields) o1)) o2)
  (forall ((o3 Int))
  (=> (= (to_rep (rec__random__generator__index g__split_fields)) o3)
  (forall ((o4 (_ BitVec 32)))
  (=>
  (= (to_rep1 (select (rec__random__generator__state g__split_fields) o3)) o4)
  (forall ((value1 (_ BitVec 32)))
  (=> (= value1 (bvor (bvand o4 #x80000000) (bvand o2 #x7FFFFFFF)))
  (forall ((o5 Int))
  (=>
  (exists ((o6 Int))
  (and (= (to_rep (rec__random__generator__index g__split_fields)) o6)
  (exists ((o7 Int))
  (and (= (to_rep (rec__random__generator__index g__split_fields)) o7)
  (ite (= (and (ite (<= 0 o7) true false) (ite (<= o6 226) true false)) true)
  (exists ((o8 Int))
  (and (= (to_rep (rec__random__generator__index g__split_fields)) o8)
  (let ((o9 (+ o8 397))) (and (= o5 o9) (in_range1 o9)))))
  (exists ((o8 Int))
  (and (= (to_rep (rec__random__generator__index g__split_fields)) o8)
  (exists ((o9 Int))
  ...
  (let ((o11 (+ o10 (- 227)))) (and (= o5 o11) (in_range1 o11)))))
  (= o5 396)))))))))))
  (forall ((o6 (_ BitVec 32)))
  (=>
  (= (to_rep1 (select (rec__random__generator__state g__split_fields) o5)) o6)
  (forall ((o7 unsigned_32))
  (=> (= (to_rep1 o7) o6)
  (forall ((o8 Int))
  (=> (= (to_rep (rec__random__generator__index g__split_fields)) o8)
  (forall ((g__split_fields1 us_split_fields))
  (=>
  (= g__split_fields1 (us_split_fieldsqtmk
                      (store (rec__random__generator__state g__split_fields) o8 o7)
