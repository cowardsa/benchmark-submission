...
;; defqtvc
 ;; File "counter.ads", line 29, characters 0-0
  ...
  (temp___loop_entry_214 (Array (_ BitVec 8) Bool)) (usf (_ BitVec 8)))
  (=> (= i #x01)
  (=>
  ...
  (=>
  (forall ((k (_ BitVec 8)))
  (=> (and (bvule #x01 k) (bvule k (bvsub i #x01)))
  (= (= (select inputs k) true)
  (= (select temp___loop_entry_214 (bvadd k #x01)) true))))
  (=>
  (= (and (ite (bvule i usf) true false) (ite (bvule usf #x0A) true false)) true)
  (=> (bvule #x01 usf) (=> (bvule usf #x0A) (bvule #x01 usf)))))))))))
(check-sat)
(exit)
