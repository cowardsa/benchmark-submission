...
(define-fun uxx__ref_uxx__content__2__projection ((a uxx__ref)) uxx (uxx__content
                                                                    a))

(define-fun dynamic_invariant1 ((temp___expr_216 (_ BitVec 32))
...
(assert
;; defqtvc
 ;; File "ethernet_dissector.adb", line 6, characters 0-0
  (not
  (forall ((value (_ BitVec 32)) (i Int))
  ...
  (=> (= i 0)
  (let ((o (power 256 i)))
  (=> (in_range2 o) (=> (uint_in_range1 o) (in_range1 (- (last1 buffer) i)))))))))))))
(check-sat)
(exit)
