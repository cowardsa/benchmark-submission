...
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 22, characters 0-0
  ...
  (=> (= index 1)
  (=>
  (= (and (ite (<= 1 index) true false) (ite (<= index temp___1101) true
                                        false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___1108)
               (<= temp___1108 (last1 result____split_fields2)))
               (=>
               (or (< temp___1101 temp___1108)
               (or (< temp___1108 1) (<= index1 temp___1108)))
               (= (select (to_array result____split_fields2) temp___1108) (select 
               (to_array result____split_fields1) temp___1108))))))
          true false) (ite (and (<= 1 index1) (<= index1 r26b)) true false)) true)
  (uint_in_range (mod1 temp2 256)))))))))))))))))))))))))))))
(check-sat)
(exit)
