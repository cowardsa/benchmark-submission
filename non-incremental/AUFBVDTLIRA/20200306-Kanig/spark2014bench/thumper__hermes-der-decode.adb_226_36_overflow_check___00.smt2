...
;; defqtvc
 ;; File "hermes-der-decode.adb", line 210, characters 0-0
  ...
  (=> (= spark__branch (ite (= o1 #xFF) true false))
  (=> (not (= spark__branch true)) (in_range1 (+ length_stop 1)))))))))))))))))))))))
(check-sat)
(exit)
