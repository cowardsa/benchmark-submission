...
(define-fun dynamic_invariant3 ((temp___expr_785 us_rep1)
...
(define-fun dynamic_invariant4 ((temp___expr_798 us_rep2)
...
(define-fun dynamic_invariant6 ((temp___expr_764 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_246 (_ BitVec 8))
  (temp___is_init_242 Bool) (temp___skip_constant_243 Bool)
  (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "very_longs.adb", line 447, characters 0-0
  (not
  (forall ((spark__branch Bool) (n Int) (u__split_fields us_t)
  (v__split_fields us_t) (j Int) (q_hat (_ BitVec 16))
  (current_borrow (_ BitVec 16)) (carry (_ BitVec 16))
  (product1 (_ BitVec 16)) (temporary_digit (_ BitVec 16))
  (future_borrow (_ BitVec 16)) (carry1 (_ BitVec 16))
  (current_borrow1 (_ BitVec 16)) (spark__branch1 Bool)
  (u__split_fields1 us_t) (current_borrow2 (_ BitVec 16))
  (carry2 (_ BitVec 16)) (future_borrow1 (_ BitVec 16))
  (future_borrow2 (_ BitVec 16)))
  (=> (dynamic_invariant divisor true false true true)
  (=> (dynamic_invariant divisor true false true true)
  (=> (dynamic_invariant6 n true false true true)
  (=> (dynamic_invariant3
  ...
  (=> (dynamic_invariant2 current_borrow false false true true)
  (=> (dynamic_invariant2 carry false false true true)
  (=> (dynamic_invariant2 product1 false false true true)
  (=> (dynamic_invariant2 temporary_digit false false true true)
  (=> (dynamic_invariant2 future_borrow false false true true)
  (=> (= carry1 #x0000)
  (=> (= current_borrow1 #x0000)
  (=> (= n r132b)
  (=> (dynamic_invariant6 r132b true false true true)
  (=>
  (let ((temp___1414 r132b))
  (exists ((divisor_index Int))
  (and (= divisor_index 1)
  (ite (= (and (ite (<= 1 divisor_index) true false) (ite (<= divisor_index temp___1414)
                                                     true false)) true)
  (exists ((u__split_fields2 us_t) (current_borrow3 (_ BitVec 16))
  (carry3 (_ BitVec 16)) (product2 (_ BitVec 16))
  (temporary_digit1 (_ BitVec 16)) (future_borrow3 (_ BitVec 16))
  (divisor_index1 Int))
  (and
  (= (and (ite (and
               (and
               (and
               (and
               (and (dynamic_invariant2 future_borrow3 false true true true)
               (dynamic_invariant2 current_borrow3 false true true true))
               (dynamic_invariant3
  ...
  (exists ((o (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array v__split_fields) divisor_index1)) o)
  (exists ((product3 (_ BitVec 16)))
  (and (= product3 (bvadd (bvmul q_hat ((_ zero_extend 8) o)) carry3))
  (let ((o1 (shift_right product3 8)))
  (and
  (and (shift_right__function_guard o1 product3 8)
  (and (dynamic_invariant2 o1 true false true true)
  (= o1 (bvudiv product3 (ite (< 8 65536) (bvshl #x0001 ((_ int_to_bv 16) 8))
                         #x0000)))))
  (and (= carry2 o1)
  (exists ((temporary_digit2 (_ BitVec 16)))
  (and (= temporary_digit2 (bvand product3 #x00FF))
  (and
  (let ((o2 (+ j divisor_index1)))
  (and (in_range2 o2)
  (let ((temp___1417 (- o2 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1417)
  (<= temp___1417 (last1 u__split_fields2)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields2) temp___1417)) o3)
  (and
  (= spark__branch1 (ite (bvuge ((_ zero_extend 8) o3) (bvadd temporary_digit2 current_borrow3))
                    true false))
  (ite (= spark__branch1 true) (= future_borrow1 #x0000)
  (= future_borrow1 #x0001)))))))))
  (let ((o2 (+ j divisor_index1)))
  (and (in_range2 o2)
  (let ((temp___1419 (- o2 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1419)
  (<= temp___1419 (last1 u__split_fields2)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields2) temp___1419)) o3)
  (exists ((o4 octet))
  (and
  (= (to_rep2 o4) ((_ extract 7 0) (bvand (bvsub (bvsub ((_ zero_extend 8) o3) temporary_digit2) current_borrow3) #x00FF)))
  (let ((o5 (+ j divisor_index1)))
  (and (in_range2 o5)
  (let ((temp___1421 (- o5 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1421)
  (<= temp___1421 (last1 u__split_fields2)))
  (and
  (= u__split_fields1 (us_tqtmk
                      (store (to_array u__split_fields2) temp___1421 o4)
                      (rt u__split_fields2)))
  (and (= current_borrow2 future_borrow1) (= divisor_index1 temp___1414))))))))))))))))))))))))))))
  (and
  (and
  (and
  (and (= spark__branch1 spark__branch) (= u__split_fields1 u__split_fields))
  (= current_borrow2 current_borrow1)) (= carry2 carry1))
  (= future_borrow1 future_borrow))))))
  (=>
  (let ((o (+ j n)))
  (and (in_range2 o)
  (let ((temp___1433 (- o 1)))
  (and
  (and (<= (first1 u__split_fields1) temp___1433)
  (<= temp___1433 (last1 u__split_fields1)))
  (exists ((o1 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields1) temp___1433)) o1)
  (exists ((spark__branch2 Bool))
  (and
  (= spark__branch2 (ite (bvuge ((_ zero_extend 8) o1) (bvadd carry2 current_borrow2))
                    true false))
  (ite (= spark__branch2 true) (= future_borrow2 #x0000)
  (= future_borrow2 #x0001))))))))))
  (let ((o (+ j n)))
  (=> (in_range2 o)
  (let ((temp___1435 (- o 1)))
  (=>
  (and (<= (first1 u__split_fields1) temp___1435)
  (<= temp___1435 (last1 u__split_fields1)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields1) temp___1435)) o1)
  (forall ((o2 octet))
  (=>
  (= (to_rep2 o2) ((_ extract 7 0) (bvand (bvsub (bvsub ((_ zero_extend 8) o1) carry2) current_borrow2) #x00FF)))
  (let ((o3 (+ j n)))
  (=> (in_range2 o3) (<= (first1 u__split_fields1) (- o3 1)))))))))))))))))))))))))))))))))
(check-sat)
(exit)
