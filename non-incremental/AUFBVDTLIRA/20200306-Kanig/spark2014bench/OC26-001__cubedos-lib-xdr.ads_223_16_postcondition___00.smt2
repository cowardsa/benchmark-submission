...
(assert
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 210, characters 0-0
  (not
  (forall ((value Int) (last2 Int) (temporary (_ BitVec 32)))
  ...
  (forall ((last3 Int) (temporary1 (_ BitVec 32)))
  (=>
  (and (= last3 (+ position 3))
