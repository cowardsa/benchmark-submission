...
;; defqtvc
 ;; File "linted-update.ads", line 41, characters 0-0
  ...
  (let ((o14 (bv2nat x3))) (and (in_range o14) (= y3 o14)))
  (let ((o14 (bv2nat (bvnot x3))))
  (and (in_range o14)
  ...
  (let ((o14 (bv2nat x4))) (and (in_range o14) (= y4 o14)))
  (let ((o14 (bv2nat (bvnot x4))))
  (and (in_range o14)
  ...
  (=> (not (= spark__branch2 true)) (in_range (bv2nat (bvnot x5)))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
