...
;; defqtvc
 ;; File "linted-update.ads", line 41, characters 0-0
  ...
  (o13 (_ BitVec 8)) (x5 (_ BitVec 32)) (spark__branch2 Bool))
  ...
  (let ((o14 (ubv_to_int x3))) (and (in_range o14) (= y3 o14)))
  (let ((o14 (ubv_to_int (bvnot x3))))
  (and (in_range o14)
  (let ((o15 (- (- o14) 1))) (and (in_range1 o15) (= y3 o15))))))
  (=> (= (to_rep o4) y3)
  ...
  (let ((o14 (ubv_to_int x4))) (and (in_range o14) (= y4 o14)))
  (let ((o14 (ubv_to_int (bvnot x4))))
  (and (in_range o14)
  (let ((o15 (- (- o14) 1))) (and (in_range1 o15) (= y4 o15))))))
  (=> (= (to_rep o9) y4)
  (=>
  ...
  (=> (not (= spark__branch2 true)) (in_range (ubv_to_int (bvnot x5)))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
