...
(declare-fun user_eq5 (word64 word64) Bool)

(declare-const dummy5 word64)

(declare-datatypes ((word64__ref 0))
(((word64__refqtmk (word64__content word64)))))
(define-fun word64__ref_word64__content__projection ((a1 word64__ref)) word64 
  (word64__content a1))

(define-fun dynamic_invariant1 ((temp___expr_167 (_ BitVec 64))
...
(define-fun dynamic_invariant4 ((temp___expr_160 (_ BitVec 32))
...
;; defqtvc
 ;; File "foo.ads", line 10, characters 0-0
  ...
  (= o #x00000000)))) (in_range1 (ubv_to_int (bvudiv i #x0000000000000020))))))))))
(check-sat)
(exit)
