...
;; defqtvc
 ;; File "x86.ads", line 47, characters 0-0
  ...
  (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 2))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi4 3))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000)))
  (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select xsi4 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi4 3))) #x01000000)) val__))
  (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select xsi4 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi4 3))) #x01000000)) val__)))))))))))))))))))))))))
