...
(define-fun to_int2 ((x os_mbx_index_t)) Int (ubv_to_int (to_rep x)))
...
(define-fun to_int3 ((x os_mbx_count_t)) Int (ubv_to_int (to_rep1 x)))
...
;; os_mbx_get_mbx_head__post_axiom
  ...
  (forall ((test__os_task_mbx_rw (Array Int us_rep1)))
  (! (=> (dynamic_invariant task_id1 true true true true)
     (let ((result (os_mbx_get_mbx_head task_id1 test__os_task_mbx_rw)))
     (=> (os_mbx_get_mbx_head__function_guard result task_id1
     test__os_task_mbx_rw) (dynamic_invariant2 result true false true true)))) :pattern (
  (os_mbx_get_mbx_head task_id1 test__os_task_mbx_rw)) ))))
...
;; os_mbx_get_mbx_head__def_axiom
  ...
  (forall ((test__os_task_mbx_rw (Array Int us_rep1)))
  (! (=> (dynamic_invariant task_id1 true true true true)
     (= (os_mbx_get_mbx_head task_id1 test__os_task_mbx_rw) (to_rep
...
;; os_mbx_is_empty__def_axiom
  ...
  (forall ((task_id1 Int))
  (forall ((test__os_task_mbx_rw (Array Int us_rep1)))
  (! (= (= (os_mbx_is_empty task_id1 test__os_task_mbx_rw) true)
     (= (to_rep1
        (rec__test__os_mbx_t__count
        (us_split_fields3 (select test__os_task_mbx_rw task_id1)))) #x00)) :pattern (
  (os_mbx_is_empty task_id1 test__os_task_mbx_rw)) ))))
...
;; os_mbx_get_mbx_tail__post_axiom
  (assert
  (forall ((task_id1 Int))
  (forall ((test__os_task_mbx_rw (Array Int us_rep1)))
  (! (and
     (forall ((task_id2 Int) (test__os_task_mbx_rw1 (Array Int us_rep1)))
     (os_mbx_is_empty__function_guard
     (os_mbx_is_empty task_id2 test__os_task_mbx_rw1) task_id2
     test__os_task_mbx_rw1))
     (=>
     (and (dynamic_invariant task_id1 true true true true)
     (not (= (os_mbx_is_empty task_id1 test__os_task_mbx_rw) true)))
     (let ((result (os_mbx_get_mbx_tail task_id1 test__os_task_mbx_rw)))
     (=> (os_mbx_get_mbx_tail__function_guard result task_id1
     test__os_task_mbx_rw) (dynamic_invariant2 result true false true true))))) :pattern (
  (os_mbx_get_mbx_tail task_id1 test__os_task_mbx_rw)) ))))

;; os_mbx_get_mbx_tail__def_axiom
  (assert
  (forall ((task_id1 Int))
  (forall ((test__os_task_mbx_rw (Array Int us_rep1)))
  (! (=> (dynamic_invariant task_id1 true true true true)
     ...
     (os_mbx_get_mbx_head task_id2 test__os_task_mbx_rw1) task_id2
     test__os_task_mbx_rw1))
     (and
     (forall ((task_id2 Int) (test__os_task_mbx_rw1 (Array Int us_rep1)))
     (os_mbx_get_mbx_count__function_guard
     (os_mbx_get_mbx_count task_id2 test__os_task_mbx_rw1) task_id2
     test__os_task_mbx_rw1))
     (and
     (forall ((task_id2 Int) (test__os_task_mbx_rw1 (Array Int us_rep1)))
     (os_mbx_get_mbx_head__function_guard
     ...
     (oadd (os_mbx_get_mbx_head task_id2 test__os_task_mbx_rw1)
     (bvsub (os_mbx_get_mbx_count task_id2 test__os_task_mbx_rw1) #x01))
     (os_mbx_get_mbx_head task_id2 test__os_task_mbx_rw1)
     (bvsub (os_mbx_get_mbx_count task_id2 test__os_task_mbx_rw1) #x01)))
     (= (os_mbx_get_mbx_tail task_id1 test__os_task_mbx_rw) (oadd
                                                            (os_mbx_get_mbx_head
                                                            task_id1
                                                            test__os_task_mbx_rw)
                                                            (bvsub (os_mbx_get_mbx_count
                                                                   task_id1
                                                                   test__os_task_mbx_rw) #x01))))))))) :pattern (
  (os_mbx_get_mbx_tail task_id1 test__os_task_mbx_rw)) ))))
...
(assert
;; defqtvc
 ;; File "test.adb", line 250, characters 0-0
  (not
  (forall ((os_task_mbx_rw (Array Int us_rep1)) (usf (_ BitVec 8)))
  (=> (dynamic_invariant task_id true false true true)
  (=>
  (= (and (ite (bvule #x00 usf) true false) (ite (bvule usf #x02) true false)) true)
  (let ((o task_id))
  ...
  (=> (not (= o1 true))
  (let ((o2 task_id))
  (let ((o3 (os_mbx_get_mbx_tail o2 os_task_mbx_rw)))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o4 Int))
  (os_mbx_get_mbx_head__function_guard
  (os_mbx_get_mbx_head o4 os_task_mbx_rw1) o4 os_task_mbx_rw1))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o4 Int))
  (os_mbx_get_mbx_count__function_guard
  (os_mbx_get_mbx_count o4 os_task_mbx_rw1) o4 os_task_mbx_rw1))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o4 Int))
  (os_mbx_get_mbx_head__function_guard
  (os_mbx_get_mbx_head o4 os_task_mbx_rw1) o4 os_task_mbx_rw1))
  ...
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o4 Int))
  (oadd__function_guard
  (oadd (os_mbx_get_mbx_head o4 os_task_mbx_rw1)
  (bvsub (os_mbx_get_mbx_count o4 os_task_mbx_rw1) #x01))
  (os_mbx_get_mbx_head o4 os_task_mbx_rw1)
  (bvsub (os_mbx_get_mbx_count o4 os_task_mbx_rw1) #x01)))
  (=>
  (and (os_mbx_get_mbx_tail__function_guard o3 o2 os_task_mbx_rw)
  (and (dynamic_invariant2 o3 true false true true)
  (= o3 (oadd (os_mbx_get_mbx_head o2 os_task_mbx_rw)
        (bvsub (os_mbx_get_mbx_count o2 os_task_mbx_rw) #x01)))))
  (let ((o4 task_id))
  (let ((o5 (os_mbx_get_mbx_head o4 os_task_mbx_rw)))
  (=>
  (and (os_mbx_get_mbx_head__function_guard o5 o4 os_task_mbx_rw)
  (and (dynamic_invariant2 o5 true false true true)
  (= o5 (to_rep
        (rec__test__os_mbx_t__head
        (us_split_fields3 (select os_task_mbx_rw o4)))))))
  (let ((o6 task_id))
  (let ((o7 (os_mbx_get_mbx_head o6 os_task_mbx_rw)))
  (=>
  (and (os_mbx_get_mbx_head__function_guard o7 o6 os_task_mbx_rw)
  (and (dynamic_invariant2 o7 true false true true)
  (= o7 (to_rep
        (rec__test__os_mbx_t__head
        (us_split_fields3 (select os_task_mbx_rw o6)))))))
  (let ((o8 task_id))
  (let ((o9 (os_mbx_get_mbx_tail o8 os_task_mbx_rw)))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o10 Int))
  (os_mbx_get_mbx_head__function_guard
  (os_mbx_get_mbx_head o10 os_task_mbx_rw1) o10 os_task_mbx_rw1))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o10 Int))
  (os_mbx_get_mbx_count__function_guard
  (os_mbx_get_mbx_count o10 os_task_mbx_rw1) o10 os_task_mbx_rw1))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o10 Int))
  (os_mbx_get_mbx_head__function_guard
  (os_mbx_get_mbx_head o10 os_task_mbx_rw1) o10 os_task_mbx_rw1))
  ...
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o10 Int))
  (oadd__function_guard
  (oadd (os_mbx_get_mbx_head o10 os_task_mbx_rw1)
  (bvsub (os_mbx_get_mbx_count o10 os_task_mbx_rw1) #x01))
  (os_mbx_get_mbx_head o10 os_task_mbx_rw1)
  (bvsub (os_mbx_get_mbx_count o10 os_task_mbx_rw1) #x01)))
  (=>
  (and (os_mbx_get_mbx_tail__function_guard o9 o8 os_task_mbx_rw)
  (and (dynamic_invariant2 o9 true false true true)
  (= o9 (oadd (os_mbx_get_mbx_head o8 os_task_mbx_rw)
        (bvsub (os_mbx_get_mbx_count o8 os_task_mbx_rw) #x01)))))
  (=>
  (not
  (= (and (ite (bvult o9 o7) true false) (or (ite (bvuge usf o5) true false) 
  (ite (bvule usf o3) true false))) true))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o10 Int))
  (os_mbx_is_empty__function_guard (os_mbx_is_empty o10 os_task_mbx_rw1) o10
  os_task_mbx_rw1)) (not (= (os_mbx_is_empty task_id os_task_mbx_rw) true)))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
