...
(((us_split_fieldsqtmk (rec__p__my_hash__map us_main_type)))))
(define-fun us_split_fields_rec__p__my_hash__map__projection ((a us_split_fields)) us_main_type 
  ...
  (b us_rep)) Bool (ite (and
                        ...
                        (= (to_rep1
                           ...
                           (us_split_discrs1 a))) (to_rep1
                                                  ...
                                                  (us_split_discrs1 b)))))
                        (= (us_main_eq
                           (rec__p__my_hash__map (us_split_fields1 a))
                           (rec__p__my_hash__map (us_split_fields1 b))) true))
                   true false))

(define-fun in_range1 ((rec__p__my_hash__map__capacity1 Int)
...
(define-fun default_initial_assumption ((temp___expr_336 us_rep1)
...
(((us_split_fieldsqtmk1 (rec__p__my_hash__cursor__node count_type)))))
(define-fun us_split_fields_rec__p__my_hash__cursor__node__projection ((a us_split_fields2)) count_type 
...
(declare-fun has_key (us_rep1 (Array Int character)) Bool)

(declare-fun has_key__function_guard (Bool us_rep1
...
(declare-fun get (us_rep3 Int) (Array Int character))

(declare-fun get__function_guard ((Array Int character) us_rep3 Int) Bool)
...
(declare-fun find (us_rep3 (Array Int character)) Int)

(declare-fun find__function_guard (Int us_rep3 (Array Int character)) Bool)
...
(define-fun default_initial_assumption1 ((temp___expr_477 us_rep3)
  (temp___skip_top_level_478 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_478 true))
                                         (= (length2 temp___expr_477) 0)))
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     ...
     (and
     (and
     (and (= (length2 result) (length1 container))
     (forall ((temp___667 Int))
     (=>
     (and (in_range5 temp___667)
     (= (iter_has_element result temp___667) true))
     (= (has_key (model1 container) (get result temp___667)) true))))
     (forall ((key (Array Int character)))
     (=> (= (has_key (model1 container) key) true)
     (and (< 0 (find result key))
     (= (let ((temp___671 (get result (find result key))))
        (bool_eq5 temp___671 1 5 key 1 5)) true)))))
     (forall ((i Int))
     ...
     (=>
     (= (let ((temp___675 (get result j)))
        (let ((temp___674 (get result i)))
        (bool_eq5 temp___674 1 5 temp___675 1 5))) true)
     (= i j)))))))) :pattern ((keys container)) )))
...
(define-fun default_initial_assumption2 ((temp___expr_608 us_rep4)
  (temp___skip_top_level_609 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_609 true))
                                         (and
                                         (= (is_empty1 temp___expr_608) true)
                                         (= (length4 temp___expr_608) 0))))
...
(define-fun key ((container us_rep)
  (position us_rep2)) (Array Int character) (get (keys container)
                                            (get1 (positions container)
                                            position)))

(declare-fun key__function_guard ((Array Int character) us_rep us_rep2) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_309 (_ BitVec 32))
...
;; find__post_axiom
  ...
  (forall ((key1 (Array Int character)))
  (! (let ((result (find container key1)))
     (and
     (=> (< 0 result)
     (and (<= result (length2 container))
     (= (let ((temp___579 (get container result)))
        (bool_eq5 key1 1 5 temp___579 1 5)) true)))
...
;; has_key__post_axiom
  ...
  (! (=> (= (distinct 1 0) true)
     ...
     (and (= (has_key container k) true) (= (bool_eq5 k 1 5 key1 1 5) true)))
     (= (has_key container key1) true))) :pattern ((has_key container key1)) ))))

(declare-fun witness (us_rep1 (Array Int character)) Int)

(declare-fun witness__function_guard (Int us_rep1
  (Array Int character)) Bool)
...
(declare-fun get2 (us_rep1 (Array Int character)) Int)

(declare-fun get__function_guard2 (Int us_rep1 (Array Int character)) Bool)
...
;; element_type'axiom
  ...
  (and (<= 1 (element_typeqtint i)) (<= (element_typeqtint i) 1000))))
...
(define-fun dynamic_invariant3 ((temp___expr_381 Int)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep1)) (! (dynamic_invariant (length container) true
...
;; is_empty__post_axiom
  ...
  (! (= (= (is_empty container) true)
     (forall ((key1 (Array Int character)))
     (not (= (has_key container key1) true)))) :pattern ((is_empty container)) )))
...
(define-fun dynamic_invariant4 ((temp___expr_469 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_600 Int)
