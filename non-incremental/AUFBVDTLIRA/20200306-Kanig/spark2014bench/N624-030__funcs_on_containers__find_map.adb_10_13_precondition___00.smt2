...
;; defqtvc
 ;; File "find_map.ads", line 26, characters 0-0
  ...
  (= (and (ite (<= temp___855 k) true false) (ite (<= k (last1 a)) true
                                             false)) true)
  (forall ((o1 Int))
  (=> (= (to_rep (select (to_array a) k)) o1)
  (let ((o2 (us_repqtmk result____split_discrs
            (us_split_fieldsqtmk result____split_fields1))))
  (let ((o3 (contains o2 o1)))
  (=> (= (= o3 true) (= (has_key (model1 o2) o1) true))
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (= o3 true) false true))
  (=> (= spark__branch true)
  (=> (in_range4 k)
  (forall ((o4 Int))
  (=> (= (to_rep (select (to_array a) k)) o4)
  (let ((o5 result____split_discrs))
  (< (length (us_repqtmk o5 (us_split_fieldsqtmk result____split_fields1))) 
  (to_rep2 (rec__find_map__index_maps__map__capacity o5))))))))))))))))))))))))))))))
(check-sat)
(exit)
