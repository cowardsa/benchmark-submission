...
;; defqtvc
 ;; File "very_longs-divide.adb", line 185, characters 0-0
  ...
  (o2 octet) (divisor_index Int) (u__split_fields1 us_t)
  (carry1 (_ BitVec 16)) (sum1 (_ BitVec 16)) (divisor_index1 Int)
  (o3 (_ BitVec 8)))
  ...
  (=> (= (to_rep2 (select (to_array v__split_fields) divisor_index1)) o3)
  (let ((o4 (+ j divisor_index1)))
  (=> (in_range2 o4)
  (let ((temp___1416 (- o4 1)))
  (=>
  (and (<= (first1 u__split_fields1) temp___1416)
  (<= temp___1416 (last1 u__split_fields1)))
  (forall ((o5 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields1) temp___1416)) o5)
  (forall ((sum2 (_ BitVec 16)))
  (=>
  (= sum2 (bvadd (bvadd ((_ zero_extend 8) o5) ((_ zero_extend 8) o3)) carry1))
