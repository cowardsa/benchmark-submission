...
;; defqtvc
 ;; File "linted-update.ads", line 41, characters 0-0
  ...
  (x3 (_ BitVec 32)) (spark__branch1 Bool))
  ...
  (let ((o9 (ubv_to_int x2))) (and (in_range o9) (= y2 o9)))
  (let ((o9 (ubv_to_int (bvnot x2))))
  (and (in_range o9)
  (let ((o10 (- (- o9) 1))) (and (in_range1 o10) (= y2 o10))))))
  (=> (= (to_rep o4) y2)
  ...
  (=> (= spark__branch1 true) (in_range (ubv_to_int x3))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
