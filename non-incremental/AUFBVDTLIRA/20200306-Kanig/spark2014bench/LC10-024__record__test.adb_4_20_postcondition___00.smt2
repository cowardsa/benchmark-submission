...
(define-fun to_int2 ((x entry_id)) Int (ubv_to_int (to_rep2 x)))
...
;; defqtvc
 ;; File "test.adb", line 3, characters 0-0
  ...
  (forall ((o Int))
  (=> (= (to_rep (select (rec__test__t__cards s__split_fields) i1)) o)
  (forall ((tmp Int))
  (=> (= tmp o)
  (=> (dynamic_invariant tmp true false true true)
  (forall ((o1 Int))
  (=> (= (to_rep (select (rec__test__t__cards s__split_fields) i2)) o1)
  (forall ((o2 integer))
  (=> (= (to_rep o2) o1)
  ...
  (= s__split_fields2 (us_split_fieldsqtmk
                      ...
                      (store (rec__test__t__cards s__split_fields) i1 o2)))
  (forall ((o3 integer))
  (=> (= (to_rep o3) tmp)
  ...
  (= s__split_fields3 (us_split_fieldsqtmk
                      ...
                      (store (rec__test__t__cards s__split_fields2) i2 o3)))
  (=>
