...
;; defqtvc
 ;; File "parse.ads", line 15, characters 0-0
  ...
  (=> (= spark__branch1 (ite (= opcode1 #x00) true false))
  (=> (not (= spark__branch1 true))
  (forall ((spark__branch2 Bool))
  (=> (= spark__branch2 (ite (= opcode1 #x01) true false))
  (=> (not (= spark__branch2 true))
  (forall ((parse__parse_header__R6b__assume Int))
  (=> (= (to_rep4 result____split_discrs) parse__parse_header__R6b__assume)
  (=> (= parse__parse_header__R6b__assume r6b)
  (=> (dynamic_invariant4 r6b true false true true)
  (forall ((o7 return_code_t))
  (=> (= (to_rep4 o7) 1)
  (=> (= result____attr__constrained true) (= o7 result____split_discrs)))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
