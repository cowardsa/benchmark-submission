...
;; defqtvc
 ;; File "repro.adb", line 22, characters 0-0
  ...
  (=> (= result_pos1 o6)
  (let ((temp___278 (rec__repro__ensemble__areas (us_split_fields3 e))))
  (let ((o7 (+ e_pos 1)))
  (=> (in_range1 o7)
  (=> (and (<= (first1 temp___278) o7) (<= o7 (last1 temp___278)))
  (forall ((o8 (_ BitVec 32)))
  (=>
  (= (to_rep1
     (rec__repro__area__from
     (us_split_fields1 (select (to_array temp___278) o7)))) o8)
  (forall ((o9 address_type))
  (=> (= (to_rep1 o9) (bvsub o8 #x00000001))
  (let ((temp___277 (rec__repro__ensemble__areas (us_split_fields3 e))))
  (=> (and (<= (first1 temp___277) e_pos) (<= e_pos (last1 temp___277)))
  (forall ((o10 (_ BitVec 32)))
  (=>
  (= (to_rep1
     (rec__repro__area__to
     (us_split_fields1 (select (to_array temp___277) e_pos)))) o10)
  (forall ((o11 address_type))
  (=> (= (to_rep1 o11) (bvadd o10 #x00000001))
  (=>
  (and (<= (to_rep result_arr__first) result_pos1)
  (<= result_pos1 (to_rep result_arr__last)))
  (forall ((result_arr1 (Array Int us_rep)))
  (=>
  (= result_arr1 (store result_arr result_pos1 (us_repqtmk
                                               (us_split_fieldsqtmk o11 o9))))
  (=> (in_range1 (+ e_pos 1))
  (let ((temp___288 (rec__repro__ensemble__areas (us_split_fields3 e))))
  (let ((o12 (+ e_pos 1)))
  (=> (in_range1 o12)
  (=> (and (<= (first1 temp___288) o12) (<= o12 (last1 temp___288)))
  (forall ((o13 (_ BitVec 32)))
  (=>
  (= (to_rep1
     (rec__repro__area__from
