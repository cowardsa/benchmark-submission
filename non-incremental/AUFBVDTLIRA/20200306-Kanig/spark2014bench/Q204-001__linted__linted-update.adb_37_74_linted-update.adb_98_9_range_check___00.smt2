...
;; defqtvc
 ;; File "linted-update.ads", line 40, characters 0-0
  ...
  (y4 (_ BitVec 32)) (ada___linted__update__to_storage__C206b__assume Int)
  (spark__branch Bool) (y5 (_ BitVec 32)) (c207b1 (_ BitVec 32)))
  (=>
  (= (to_rep
  ...
  (let ((o c206b)) (and (uint_in_range1 o) (= y5 ((_ int_to_bv 32) o)))))
  (=> (= c207b1 y5)
  (=> (= c207b1 c210b)
  ...
  (forall ((spark__branch1 Bool) (y6 (_ BitVec 32)))
  (=>
  ...
  (let ((o c216b)) (and (uint_in_range1 o) (= y6 ((_ int_to_bv 32) o))))))
  ...
  (forall ((spark__branch2 Bool) (y7 (_ BitVec 32)))
  (=>
  ...
  (let ((o c226b)) (and (uint_in_range1 o) (= y7 ((_ int_to_bv 32) o))))))
  ...
  (forall ((spark__branch3 Bool) (y8 (_ BitVec 32)))
  (=>
  ...
  (let ((o c236b)) (and (uint_in_range1 o) (= y8 ((_ int_to_bv 32) o))))))
  ...
  (forall ((spark__branch4 Bool) (y9 (_ BitVec 32)))
  (=>
  ...
  (let ((o c246b)) (and (uint_in_range1 o) (= y9 ((_ int_to_bv 32) o))))))
  (forall ((c247b1 (_ BitVec 32)))
  (=> (= c247b1 y9)
  (=> (= c247b1 c250b)
  (=> (dynamic_invariant1 c250b true false true true)
  (bvule ((_ zero_extend 24) #x00) (bvand (bvlshr c250b ((_ int_to_bv 32) 16)) #x000000FF)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
