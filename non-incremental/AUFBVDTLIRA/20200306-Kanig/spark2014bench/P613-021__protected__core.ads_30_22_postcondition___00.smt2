...
(((mailboxT__refqtmk (mailboxT__content us_rep1)))))
...
(define-fun to_int2 ((x message_index)) Int (ubv_to_int (to_rep2 x)))
...
;; defqtvc
 ;; File "core.ads", line 29, characters 0-0
  (not
  (forall ((self__ us_split_fields2) (self__1 us_split_fields2))
  (=> (dynamic_invariant n true false true true)
  (=>
  (exists ((o Int))
  (and (= (to_rep3 (rec__core__mailboxT__count self__)) o)
  ...
  (exists ((self__2 us_split_fields2))
  (and
  ...
  (exists ((self__3 us_split_fields2))
  (and
  ...
  (exists ((o7 message_index))
  (and (= (to_rep2 o7) (bvurem (bvadd o6 #x01) #x10))
  (exists ((self__4 us_split_fields2))
  (and
  (= self__4 (us_split_fieldsqtmk1 (rec__core__mailboxT__messages self__3) o7
             (rec__core__mailboxT__next_out self__3)
             (rec__core__mailboxT__count self__3)))
  (exists ((o8 Int))
  (and (= (to_rep3 (rec__core__mailboxT__count self__4)) o8)
  (let ((o9 (+ o8 1)))
  (and (in_range3 o9)
  (exists ((o10 message_count))
  (and (= (to_rep3 o10) o9)
  (= self__1 (us_split_fieldsqtmk1 (rec__core__mailboxT__messages self__4)
             (rec__core__mailboxT__next_in self__4)
             (rec__core__mailboxT__next_out self__4) o10))))))))))))))))))))))))))))
  (= self__1 self__))))))
  (=>
  (forall ((self__2 us_split_fields2)) (item_count__function_guard
  (item_count (us_repqtmk1 self__2)) (us_repqtmk1 self__2)))
  (< 0 (item_count (us_repqtmk1 self__1)))))))))
(check-sat)
(exit)
