...
;; shift_right__post_axiom
  ...
  (! (=>
     ...
     (= result (bvudiv value (ite (< count 65536)
                             (bvshl #x0001 ((_ int_to_bv 16) count)) #x0000)))
...
(define-fun us_split_fields_rec__very_longs__very_long__long_digits__24__projection ((a us_split_fields2)) us_t 
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((us_split_fields__refqtmk1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___split_fields__content__24__projection ((a us_split_fields__ref1)) us_split_fields2 
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((us_repqtmk1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep___split_discrs__24__projection ((a us_rep1)) us_split_discrs 
  (us_split_discrs2 a))

(define-fun us_rep___split_fields__24__projection ((a us_rep1)) us_split_fields2 
  (us_split_fields3 a))

(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___214 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array temp___214)
                                         (first1 temp___214)
                                         (last1 temp___214))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r1)
                                          (us_split_fieldsqtmk1
                                          (let ((temp___213 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
...
(define-fun dynamic_invariant4 ((temp___expr_689 us_rep1)
  (temp___is_init_685 Bool) (temp___skip_constant_686 Bool)
  (temp___do_toplevel_687 Bool)
  (temp___do_typ_inv_688 Bool)) Bool (and
                                     (=>
                                     ...
                                     (first1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_689)))
                                     (last1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_689))))
                                     (and
...
(define-fun default_initial_assumption ((temp___expr_692 us_rep1)
  (temp___skip_top_level_693 Bool)) Bool (and
                                         (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_692))) (to_rep
                                                               (rec__very_longs__very_long__length
                                                               (us_split_discrs1
                                                               l))))
                                         (and
...
(declare-datatypes ((t89b__ref 0))
(((t89b__refqtmk (t89b__content us_t)))))
(define-fun t89b__ref_t89b__content__projection ((a t89b__ref)) us_t 
  (t89b__content a))

(declare-fun temp_____aggregate_def_1059 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1061 (_ BitVec 8)))
  (forall ((temp___1062 Int) (temp___1063 Int))
  (let ((temp___1060 (temp_____aggregate_def_1059 temp___1061 temp___1062
                     temp___1063)))
  (=> (dynamic_invariant3 temp___1061 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1062 temp___1063)
  (and (= (first1 temp___1060) temp___1062)
  (= (last1 temp___1060) temp___1063)))
  (forall ((temp___1064 Int))
  (= (to_rep2 (select (to_array temp___1060) temp___1064)) temp___1061))))))))
...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 55, characters 0-0
  (not
  ...
  (=>
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) o)
  (=> (in_range1 o)
  ...
  (=>
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) o1)
  (let ((temp___1065 (temp_____aggregate_def_1059 #x00 1 o1)))
  (=> (= (first1 temp___1065) 1)
  (=>
  (= (last1 temp___1065) (to_rep
                         (rec__very_longs__very_long__length
                         (us_split_discrs1 l))))
  (=>
  (ite (<= (first1 temp___1065) (last1 temp___1065))
  (and
  (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))
  (= (- (last1 temp___1065) (first1 temp___1065)) (- (to_rep
                                                     (rec__very_longs__very_long__length
                                                     (us_split_discrs1 l))) 1)))
  (< (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1))
  (let ((temp___1067 (of_array (to_array temp___1065) (first1 temp___1065)
                     (last1 temp___1065))))
  (=>
  (ite (<= (first1 temp___1067) (last1 temp___1067))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1067) (first1 temp___1067)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1067)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1072 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r)))))
  (exists ((j Int))
  (and (= j 1)
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1072) true false)) true)
  ...
  (= (and (ite (and
               ...
               (dynamic_invariant2 carry1 false true true true))
               (dynamic_invariant4
               (us_repqtmk1 result____split_discrs
               (us_split_fieldsqtmk1 result____split_fields3)) false true
               true true)) (dynamic_invariant2 l_digit1 false true true
               true))
  ...
  (and (= carry2 #x0000)
  (and
  (let ((temp___1074 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1074) true false)) true)
  ...
  (= (and (ite (and
               ...
               (dynamic_invariant2 carry3 false true true true))
               (dynamic_invariant4
               (us_repqtmk1 result____split_discrs
               (us_split_fieldsqtmk1 result____split_fields4)) false true
               true true)) (dynamic_invariant2 l_digit2 false true true
               true))
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1075 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1075) i1) (<= i1 (last1 temp___1075)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1075) i1)) o2)
  (exists ((l_digit3 (_ BitVec 16)))
  (and (= l_digit3 ((_ zero_extend 8) o2))
  (let ((temp___1076 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1076) j1) (<= j1 (last1 temp___1076)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1076) j1)) o3)
  (exists ((r_digit3 (_ BitVec 16)))
  (and (= r_digit3 ((_ zero_extend 8) o3))
  (and (= (last1 result____split_fields4) r92b)
  (and (in_range2 r92b)
  (and
  (let ((o4 (+ i1 j1)))
  (and (in_range2 o4)
  (let ((temp___1083 (- o4 1)))
  (exists ((spark__branch Bool))
  (and
  (= spark__branch (and (ite (<= 1 temp___1083) true false) (ite (<= temp___1083 
                                                            r92b) true false)))
  (ite (= spark__branch true)
  (let ((o5 (+ i1 j1)))
  (and (in_range2 o5)
  (let ((temp___1078 (- o5 1)))
  (and
  (and (<= (first1 result____split_fields4) temp___1078)
  (<= temp___1078 (last1 result____split_fields4)))
  (exists ((o6 (_ BitVec 8)))
  (and
  (= (to_rep2 (select (to_array result____split_fields4) temp___1078)) o6)
  (exists ((t_digit3 (_ BitVec 16)))
  (and (= t_digit3 ((_ zero_extend 8) o6))
  (exists ((temp3 (_ BitVec 16)))
  (and (= temp3 (bvadd (bvadd (bvmul l_digit3 r_digit3) t_digit3) carry3))
  (let ((o7 (takelsb_from16 temp3)))
  (and
  (and (takelsb_from16__function_guard o7 temp3) (dynamic_invariant3 o7 true
  false true true))
  (exists ((o8 octet))
  (and (= (to_rep2 o8) o7)
  (let ((o9 (+ i1 j1)))
  (and (in_range2 o9)
  (let ((temp___1080 (- o9 1)))
  (and
  (and (<= (first1 result____split_fields4) temp___1080)
  (<= temp___1080 (last1 result____split_fields4)))
  (and
  (= result____split_fields2 (us_tqtmk
                             (store (to_array result____split_fields4) temp___1080 o8)
                             (rt result____split_fields4)))
  (let ((o10 (shift_right temp3 8)))
  (and (shift_right__function_guard o10 temp3 8)
  (and (dynamic_invariant2 o10 true false true true)
  (= o10 (bvudiv temp3 (ite (< 8 65536) (bvshl #x0001 ((_ int_to_bv 16) 8))
                       #x0000)))))))))))))))))))))))))
  (= result____split_fields2 result____split_fields4)))))))
  (= i1 temp___1074))))))))))))))))))
  (= result____split_fields2 result____split_fields3))))) (= j1 temp___1072))))))
  (= result____split_fields2 result____split_fields1)))))
  (forall ((very_longs__modmultiply__result us_rep))
  (=>
  (= very_longs__modmultiply__result (to_base
                                     (us_repqtmk1 result____split_discrs
                                     (us_split_fieldsqtmk1
                                     result____split_fields2))))
  (= (to_rep
     (rec__very_longs__very_long__length
     (us_split_discrs1 very_longs__modmultiply__result))) (to_rep
                                                          (rec__very_longs__very_long__length
                                                          (us_split_discrs1
                                                          l))))))))))))))))))))))))))))))))
(check-sat)
