...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 274, characters 0-0
  (not
  (forall ((last4 Int) (o Bool) (o1 Int) (o2 Int))
  ...
  (exists ((o5 Bool))
  (and
  (ite (= (mod1 position 4) 0) (= o5 (ite (< 0 (length2 data)) true false))
  (= o5 false))
  (ite (= o5 true) (= o4 (ite (= (mod1 (length2 data) 4) 0) true false))
  (= o4 false))))
  (ite (= o4 true)
  (exists ((o5 Int))
  (and (= (to_rep1 value__last) o5)
  (exists ((o6 Int))
  (and (= (to_rep1 value__first) o6)
  (let ((o7 (length o6 o5)))
  (and (in_range1 o7) (= o3 (ite (<= o7 65536) true false))))))))
  (= o3 false))))
  (ite (= o3 true)
  ...
  (= o false))))
  (=> (= o true)
  (=> (= (to_rep1 value__last) o1)
  (=> (= (to_rep1 value__first) o2)
  (let ((o3 (length o2 o1)))
  (=> (in_range4 o3)
  (let ((o4 (length_with_padding o3)))
  (=>
  (and (length_with_padding__function_guard o4 o3)
  (and (dynamic_invariant o4 true false true true)
  (= o4 (+ o3 (ite (= (mod1 o3 4) 0) 0 (- 4 (mod1 o3 4))))))) (in_range1
  (- (last3 data) (- o4 1))))))))))))))))))
(check-sat)
(exit)
