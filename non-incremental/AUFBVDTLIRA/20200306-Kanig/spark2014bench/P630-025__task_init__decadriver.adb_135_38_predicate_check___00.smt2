...
(define-fun to_int3 ((x bits_8)) Int (ubv_to_int (to_rep2 x)))
...
(define-fun to_int4 ((x rx_frame_queue_index)) Int (ubv_to_int (to_rep5 x)))
...
(define-fun to_int5 ((x bits_1)) Int (ubv_to_int (to_rep6 x)))
...
(define-fun to_int6 ((x bits_2)) Int (ubv_to_int (to_rep7 x)))
...
(define-fun to_int7 ((x bits_3)) Int (ubv_to_int (to_rep8 x)))
...
(define-fun to_int8 ((x bits_7)) Int (ubv_to_int (to_rep9 x)))
...
(((bits_12__refqtmk (bits_12__content bits_12)))))
...
(define-fun to_int9 ((x bits_12)) Int (ubv_to_int (to_rep10 x)))
...
;; defqtvc
 ;; File "decadriver.ads", line 127, characters 0-0
  (not
  (forall ((frame_length1 Int) (next_idx (_ BitVec 8))
  (self__ us_split_fields2)
  (ada___dw1000__registers__rx_finfo__read__reg__fields us_split_fields4)
  (rx_finfo_reg__split_fields us_split_fields4) (o (_ BitVec 8)))
  (=> (dynamic_invariant1 (us_repqtmk1 self__) true false true true)
  (=> (dynamic_invariant frame_length1 false false true true)
  (=> (dynamic_invariant3 next_idx false false true true)
  (=>
  (= rx_finfo_reg__split_fields ada___dw1000__registers__rx_finfo__read__reg__fields)
  (=>
  (= (to_rep8
     (rec__ada___dw1000__register_types__rx_finfo_type__rxfle
     rx_finfo_reg__split_fields)) o)
  (let ((o1 (* (ubv_to_int o) 128)))
  (=> (in_range1 o1)
  ...
  (=> (= spark__branch (ite (< 0 frame_length2) true false))
  (=> (= spark__branch true)
  (forall ((o4 Int))
  (=> (= (to_rep (rec__decadriver__receiver_type__rx_count self__)) o4)
  (forall ((spark__branch1 Bool))
  (=> (= spark__branch1 (ite (<= 2 o4) true false))
  (=> (not (= spark__branch1 true))
  (forall ((o5 Int))
  (=> (= (to_rep (rec__decadriver__receiver_type__rx_count self__)) o5)
  (=> (in_range_int o5)
  (forall ((o6 (_ BitVec 8)))
  (=> (= (to_rep5 (rec__decadriver__receiver_type__queue_head self__)) o6)
  (forall ((next_idx1 (_ BitVec 8)))
  (=> (= next_idx1 (bvurem (bvadd o6 ((_ int_to_bv 8) o5)) #x02))
  (forall ((o7 Int))
  (=> (= (to_rep (rec__decadriver__receiver_type__rx_count self__)) o7)
  (let ((o8 (+ o7 1)))
  (=> (in_range1 o8)
  (forall ((o9 natural))
  (=> (= (to_rep o9) o8)
  (forall ((self__1 us_split_fields2))
  (=>
  (= self__1 (us_split_fieldsqtmk1
             (rec__decadriver__receiver_type__frame_queue self__)
             (rec__decadriver__receiver_type__queue_head self__) o9
  ...
  (=>
  (=> (<= 1 r15b)
  (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 r15b) (<= r15b 1024))))
  (let ((ada___dw1000__register_driver__read_register__data__compl (of_array
                                                                   (rec__decadriver__rx_frame_type__frame
                                                                   (us_split_fields1
                                                                   (select 
                                                                   (rec__decadriver__receiver_type__frame_queue
  ...
  (= (to_rep1 o11) (first1
                   ada___dw1000__register_driver__read_register__data__compl))
  (forall
  ((ada___dw1000__register_driver__read_register__data (Array Int bits_8)))
  (let ((q_ (us_split_fields1
            (select (rec__decadriver__receiver_type__frame_queue self__1) next_idx1))))
  (let ((temp___1007 (of_array
                     ada___dw1000__register_driver__read_register__data
                     (first1
                     ada___dw1000__register_driver__read_register__data__compl)
                     (last1
                     ada___dw1000__register_driver__read_register__data__compl))))
  (forall ((usf (Array Int bits_8)))
  (=>
  (forall ((temp___1011 Int))
  (ite (and (<= 1 temp___1011) (<= temp___1011 r15b))
  (= (select usf temp___1011) (select (to_array
                                      (of_array
                                      (slide (to_array temp___1007)
                                      (first1 temp___1007) 1) 1 r15b)) temp___1011))
  (= (select usf temp___1011) (select (rec__decadriver__rx_frame_type__frame
                                      (us_split_fields1
                                      (select (rec__decadriver__receiver_type__frame_queue
                                              self__1) next_idx1))) temp___1011))))
  (let ((temp___1014 (us_repqtmk
                     (us_split_fieldsqtmk
                     (rec__decadriver__rx_frame_type__size q_) usf
                     (rec__decadriver__rx_frame_type__error q_)
                     (rec__decadriver__rx_frame_type__overrun q_)))))
  (=> (dynamic_predicate temp___1014)
  (forall ((self__2 us_split_fields2))
  (=>
  (= self__2 (us_split_fieldsqtmk1
             (store (rec__decadriver__receiver_type__frame_queue self__1) next_idx1 temp___1014)
             (rec__decadriver__receiver_type__queue_head self__1)
             (rec__decadriver__receiver_type__rx_count self__1)
             (rec__decadriver__receiver_type__overrun_occurred self__1)
             (rec__decadriver__receiver_type__frame_ready self__1)))
  (let ((q_1 (us_split_fields1
             (select (rec__decadriver__receiver_type__frame_queue self__2) next_idx1))))
  (=> (in_range3 frame_length2)
  (forall ((o12 frame_length))
  (=> (= (to_rep3 o12) frame_length2)
  (let ((temp___1021 (us_repqtmk
                     (us_split_fieldsqtmk o12
                     (rec__decadriver__rx_frame_type__frame q_1)
                     (rec__decadriver__rx_frame_type__error q_1)
                     (rec__decadriver__rx_frame_type__overrun q_1)))))
  (=> (dynamic_predicate temp___1021)
  (forall ((self__3 us_split_fields2))
  (=>
  (= self__3 (us_split_fieldsqtmk1
             (store (rec__decadriver__receiver_type__frame_queue self__2) next_idx1 temp___1021)
             (rec__decadriver__receiver_type__queue_head self__2)
             (rec__decadriver__receiver_type__rx_count self__2)
             (rec__decadriver__receiver_type__overrun_occurred self__2)
             (rec__decadriver__receiver_type__frame_ready self__2)))
  (let ((q_2 (us_split_fields1
             (select (rec__decadriver__receiver_type__frame_queue self__3) next_idx1))))
  (forall ((o13 rx_errors))
  (=> (= (to_rep4 o13) 0)
  (let ((temp___1025 (us_repqtmk
                     (us_split_fieldsqtmk
                     (rec__decadriver__rx_frame_type__size q_2)
                     (rec__decadriver__rx_frame_type__frame q_2) o13
                     (rec__decadriver__rx_frame_type__overrun q_2)))))
  (=> (dynamic_predicate temp___1025)
  (forall ((self__4 us_split_fields2))
  (=>
  (= self__4 (us_split_fieldsqtmk1
             (store (rec__decadriver__receiver_type__frame_queue self__3) next_idx1 temp___1025)
             (rec__decadriver__receiver_type__queue_head self__3)
             (rec__decadriver__receiver_type__rx_count self__3)
             (rec__decadriver__receiver_type__overrun_occurred self__3)
             (rec__decadriver__receiver_type__frame_ready self__3)))
  (let ((q_3 (us_split_fields1
             (select (rec__decadriver__receiver_type__frame_queue self__4) next_idx1))))
  (dynamic_predicate
  (us_repqtmk
  (us_split_fieldsqtmk (rec__decadriver__rx_frame_type__size q_3)
  (rec__decadriver__rx_frame_type__frame q_3)
