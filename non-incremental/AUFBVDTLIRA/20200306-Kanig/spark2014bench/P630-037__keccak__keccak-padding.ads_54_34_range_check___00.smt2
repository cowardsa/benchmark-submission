...
;; defqtvc
 ;; File "keccak-padding.ads", line 43, characters 0-0
  ...
  (=>
  (exists ((o1 Int))
  (and (= (to_rep first_block__last) o1)
  (exists ((o2 Int))
  (and (= (to_rep first_block__first) o2)
  (exists ((o3 Int))
  (and (= (to_rep next_block__last) o3)
  (exists ((o4 Int))
  (and (= (to_rep next_block__first) o4)
  ...
  (=> (in_range (+ max_bit_length 7))
  (forall ((o1 Int))
  (=> (= (to_rep first_block__last) o1)
  (forall ((o2 Int))
  (=> (= (to_rep first_block__first) o2) (in_range (length o2 o1)))))))))))))))))
(check-sat)
(exit)
