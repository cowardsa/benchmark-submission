...
(declare-fun xdr_unsigned_to_hyper ((_ BitVec 64)) Int)

(declare-fun xdr_unsigned_to_hyper__function_guard (Int (_ BitVec 64)) Bool)
...
(define-fun source__ref_source__content__4__projection ((a source__ref)) source 
  (source__content a))

(define-fun dynamic_invariant2 ((temp___expr_317 (_ BitVec 64))
  (temp___is_init_313 Bool) (temp___skip_constant_314 Bool)
  (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool true)
...
(define-fun target__ref_target__content__4__projection ((a target__ref)) target 
  (target__content a))
...
(define-fun dynamic_invariant3 ((temp___expr_324 Int)
  ...
  (temp___do_typ_inv_323 Bool)) Bool (=>
                                     ...
                                     (in_range3 temp___expr_324)))

;; xdr_unsigned_to_hyper__post_axiom
  (assert
  (forall ((s (_ BitVec 64)))
  (! (=> (dynamic_invariant2 s true true true true)
     (let ((result (xdr_unsigned_to_hyper s)))
     (=> (xdr_unsigned_to_hyper__function_guard result s) (dynamic_invariant3
     result true false true true)))) :pattern ((xdr_unsigned_to_hyper s)) )))
...
(declare-fun user_eq7 (xdr_hyper xdr_hyper) Bool)

(declare-const dummy7 xdr_hyper)

(declare-datatypes ((xdr_hyper__ref 0))
(((xdr_hyper__refqtmk (xdr_hyper__content xdr_hyper)))))
...
(define-fun dynamic_invariant5 ((temp___expr_227 us_t)
...
(define-fun dynamic_invariant7 ((temp___expr_199 (_ BitVec 8))
  (temp___is_init_195 Bool) (temp___skip_constant_196 Bool)
  (temp___do_toplevel_197 Bool) (temp___do_typ_inv_198 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 226, characters 0-0
  (not
  (forall ((value Int) (last2 Int) (temporary (_ BitVec 64)))
  (=> (dynamic_invariant5 data true false true true)
  (=> (dynamic_invariant1 position true false true true)
  (=> (dynamic_invariant4 value false false true true)
  ...
  (forall ((last3 Int) (temporary1 (_ BitVec 64)))
  (=>
  (and (= last3 (+ position 7))
  (and (dynamic_invariant temporary1 true true true true) (dynamic_invariant1
  last3 true true true true)))
  (let ((o (xdr_unsigned_to_hyper temporary1)))
  (=>
