...
;; defqtvc
 ;; File "ring_buf.ads", line 69, characters 0-0
  ...
  (forall ((o4 Int))
  (=> (= (to_rep2 (rec__ring_buf__ring_buffer__length r__split_fields2)) o4)
  (let ((o5 (- o4 1)))
  (=> (in_range2 o5)
  ...
  (forall ((r__split_fields4 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields4)) (us_repqtmk r__split_fields4)))
  (= (let ((temp___389 (func_pop (to_model (us_repqtmk r__split_fields1)))))
     (let ((temp___388 (to_model (us_repqtmk r__split_fields3))))
     (bool_eq (to_array temp___388) (first1 temp___388) (last1 temp___388)
     (to_array temp___389) (first1 temp___389) (last1 temp___389)))) true))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
