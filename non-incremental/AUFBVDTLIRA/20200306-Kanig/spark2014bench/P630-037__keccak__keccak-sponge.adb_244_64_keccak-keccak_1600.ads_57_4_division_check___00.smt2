...
(declare-datatypes ((tTsuffix_arraySP1__ref 0))
...
(declare-datatypes ((t93s__ref 0))
(((t93s__refqtmk (t93s__content us_t)))))
...
;; defqtvc
 ;; File "keccak-sponge.ads", line 175, characters 0-0
  (not
  (forall ((ctx__split_fields us_split_fields) (message_last Int))
  (=> (dynamic_invariant6 message true false true true)
  (=> (dynamic_invariant bit_length true false true true)
  (=> (dynamic_invariant5 suffix true false true true)
  (=> (dynamic_invariant suffix_len true false true true)
  (=>
  ...
  (< (in_queue_bit_length (us_repqtmk ctx__split_fields)) (rate_of
                                                          (us_repqtmk
                                                          ctx__split_fields)))
  (forall ((suffix_array (Array Int byte)))
  (=>
  ...
  (let ((o1 (div1 o 8)))
  (=> (in_range2 o1)
  (forall ((message_byte_length Int))
  (=> (= message_byte_length o1)
  (=> (dynamic_invariant message_byte_length true false true true)
  (=> (dynamic_invariant4 message_last false false true true)
  ...
  (=> (= spark__branch1 (ite (= suffix_len 0) true false))
  ...
  (let ((o6 (+ (mod2 bit_length 8) suffix_len)))
  (=> (in_range1 o6)
  (forall ((spark__branch3 Bool))
  (=> (= spark__branch3 (ite (<= o6 8) true false))
  ...
  (and (= spark__branch4 (ite (< 1 message_byte_length) true false))
  (ite (= spark__branch4 true)
  (and (= (- message_last1 1) r91s)
  (and (dynamic_invariant2 r91s true false true true)
  (let ((o7 (+ (- bit_length 8) (- 8 (mod2 bit_length 8)))))
  (and (in_range1 o7)
  (and (in_range2 o7)
  (let ((temp___951 (first1 message)))
  (and
  (=> (<= temp___951 r91s)
  (and (and (<= (first1 message) temp___951) (<= temp___951 (last1 message)))
  (and (<= (first1 message) r91s) (<= r91s (last1 message)))))
  (and
  (and
  (and (= (state_of (us_repqtmk ctx__split_fields1)) 0)
  (= (rate_of (us_repqtmk ctx__split_fields1)) (rate_of
                                               (us_repqtmk ctx__split_fields))))
  (= (mod2 (in_queue_bit_length (us_repqtmk ctx__split_fields1)) 8) (mod2 o7
                                                                    8)))
  (< (in_queue_bit_length (us_repqtmk ctx__split_fields1)) (rate_of
                                                           (us_repqtmk
                                                           ctx__split_fields1)))))))))))
  ...
  (=>
  (let ((temp___954 (mod2 bit_length 8)))
  (ite (< temp___954 256) (= o8 (bvshl #x01 ((_ int_to_bv 8) temp___954)))
  (= o8 #x00)))
  (let ((temp___953 (last1 message)))
  (=> (and (<= (first1 message) temp___953) (<= temp___953 (last1 message)))
  (forall ((o9 (_ BitVec 8)))
  (=> (= (to_rep1 (select (to_array message) temp___953)) o9)
  (forall ((o10 byte))
  (=> (= (to_rep1 o10) (bvor (bvand o9 (bvsub o8 #x01)) o7))
  ...
  (= (rate_of (us_repqtmk ctx__split_fields2)) (rate_of
                                               (us_repqtmk
                                               ctx__split_fields1))))
  (= (mod2 (in_queue_bit_length (us_repqtmk ctx__split_fields2)) 8) (mod2 8
                                                                    8)))
  (< (in_queue_bit_length (us_repqtmk ctx__split_fields2)) (rate_of
                                                           (us_repqtmk
                                                           ctx__split_fields2))))
  (let ((o11 (us_repqtmk ctx__split_fields2)))
  (let ((o12 (rate_of o11)))
  (=>
  (and (rate_of__function_guard o12 o11)
  ...
  (< o12 1600))))
  (let ((o13 (us_repqtmk ctx__split_fields2)))
  (let ((o14 (rate_of o13)))
  (=>
  ...
  (= o14 (* (to_rep6
            ...
            ctx__split_fields2)) 8))
  (< o14 1600))))
  (let ((o15 (us_repqtmk ctx__split_fields2)))
  (let ((o16 (in_queue_bit_length o15)))
  (=>
  (and (in_queue_bit_length__function_guard o16 o15)
  (and (dynamic_invariant o16 true false true true)
  (and
  (= o16 (to_rep5
         (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
         ctx__split_fields2)))
  (< o16 1600))))
  (let ((o17 (us_repqtmk ctx__split_fields2)))
  (let ((o18 (in_queue_bit_length o17)))
  (=>
  (and (in_queue_bit_length__function_guard o18 o17)
  (and (dynamic_invariant o18 true false true true)
  (and
  (= o18 (to_rep5
         (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
         ctx__split_fields2)))
