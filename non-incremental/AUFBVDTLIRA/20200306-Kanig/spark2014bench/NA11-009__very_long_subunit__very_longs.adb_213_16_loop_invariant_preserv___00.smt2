...
;; is_zero__def_axiom
  ...
  (! (= (= (is_zero number) true)
     ...
     (= (to_rep2
        (let ((temp___310 (rec__very_longs__very_long__long_digits
                          (us_split_fields1 number))))
        (select (to_array temp___310) j))) #x00)))) :pattern ((is_zero
                                                              number)) )))
...
(((t59b__refqtmk (t59b__content tdigit_count_typeB)))))
(define-fun t59b__ref_t59b__content__projection ((a t59b__ref)) tdigit_count_typeB 
  (t59b__content a))
...
;; defqtvc
 ;; File "very_longs.ads", line 40, characters 0-0
  (not
  (forall ((digit_count Int))
  (=> (dynamic_invariant number true false true true)
  (=> (= digit_count 0)
  (=> (dynamic_invariant1 digit_count true false true true)
  (let ((o number))
  (let ((o1 (is_zero o)))
  (=>
  (and (is_zero__function_guard o1 o)
  (= (= o1 true)
  (forall ((j Int))
  (=>
  (and (<= 1 j)
  (<= j (last1
        (rec__very_longs__very_long__long_digits (us_split_fields1 o)))))
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits (us_split_fields1 o))) j)) #x00)))))
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (= o1 true) false true))
  (=> (= spark__branch true)
  (let ((temp___968 (last1
                    (rec__very_longs__very_long__long_digits
                    (us_split_fields1 number)))))
  (forall ((i Int))
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___968) true false)) true)
  (forall ((spark__branch1 Bool) (digit_count1 Int))
  (=>
  (let ((temp___969 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 number))))
  (and (and (<= (first1 temp___969) i) (<= i (last1 temp___969)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___969) i)) o2)
  (and (= spark__branch1 (ite (not (= o2 #x00)) true false))
  (ite (= spark__branch1 true) (and (in_range4 i) (= digit_count1 i))
  (= digit_count1 digit_count)))))))
  (forall ((digit_count2 Int) (i1 Int))
  (=>
  (=> (< digit_count2 i1)
  (forall ((j Int))
  (=> (and (<= (+ digit_count2 1) j) (<= j i1))
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) j)) #x00))))
  (=>
  (= (and (ite (and (dynamic_property1 1
               (last1
               (rec__very_longs__very_long__long_digits
               (us_split_fields1 number))) i1) (dynamic_invariant1
               digit_count2 true true true true))
  ...
  (forall ((i2 Int))
  (=> (= i2 (+ i1 1))
  (forall ((digit_count3 Int))
  (=>
  (let ((temp___969 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 number))))
  (and (and (<= (first1 temp___969) i2) (<= i2 (last1 temp___969)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___969) i2)) o2)
  (exists ((spark__branch2 Bool))
  (and (= spark__branch2 (ite (not (= o2 #x00)) true false))
  (ite (= spark__branch2 true) (and (in_range4 i2) (= digit_count3 i2))
  (= digit_count3 digit_count2))))))))
  (=> (< digit_count3 i2)
  (forall ((j Int))
  (=> (and (<= (+ digit_count3 1) j) (<= j i2))
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) j)) #x00))))))))))))))))))))))))))))))
