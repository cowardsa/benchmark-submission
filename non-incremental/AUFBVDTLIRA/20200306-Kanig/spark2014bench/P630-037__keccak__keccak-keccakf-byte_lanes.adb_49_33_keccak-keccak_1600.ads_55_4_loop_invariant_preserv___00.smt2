...
;; defqtvc
 ;; File "keccak-keccakf-byte_lanes.ads", line 32, characters 0-0
  (not
  (forall ((x (_ BitVec 8)) (y (_ BitVec 8)) (remaining_bits Int)
  (offset Int))
  (=> (dynamic_invariant5 data true false true true)
  (=> (dynamic_invariant bit_len true false true true)
  (=> (<= (length data) 268435455)
  (=> (<= bit_len (* (length data) 8))
  (=> (<= bit_len 1600)
  (=> (= x #x00)
  (=> (dynamic_invariant3 x true false true true)
  (=> (= y #x00)
  (=> (dynamic_invariant4 y true false true true)
  ...
  (let ((o1 (div1 o 8)))
  (=> (in_range2 o1)
  (forall ((initial_byte_len Int))
  (=> (= initial_byte_len o1)
  (=> (dynamic_invariant initial_byte_len true false true true)
  (=> (<= 64 remaining_bits)
  (let ((o2 (+ remaining_bits 7)))
  (=> (in_range1 o2)
  (=> (in_range1 (+ offset (div1 o2 8)))
  (forall ((a map1) (x1 (_ BitVec 8)) (y1 (_ BitVec 8)) (remaining_bits1 Int)
  (offset1 Int))
  (=>
  ...
  (=> (= temp___763 remaining_bits1)
  (forall ((lane (_ BitVec 64)))
  (=> (= lane #x0000000000000000)
  ...
  (let ((o5 (+ o4 i)))
  (=> (in_range1 o5)
  (=> (and (<= (first1 data) o5) (<= o5 (last1 data)))
  (forall ((o6 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array data) o5)) o6)
  (forall ((lane1 (_ BitVec 64)))
  (=>
  ...
  (=> (in_range1 o7)
  (=> (in_range2 o7)
  (let ((o8 (+ (first1 data) offset1)))
  (=> (in_range1 o8)
  (let ((o9 (+ o8 i1)))
  (=> (in_range1 o9)
  (=> (and (<= (first1 data) o9) (<= o9 (last1 data)))
  (forall ((o10 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array data) o9)) o10)
  ...
  (=> (in_range1 o11)
  (=> (in_range2 o11)
  (let ((o12 (+ (first1 data) offset1)))
  (=> (in_range1 o12)
  (let ((o13 (+ o12 i2)))
  (=> (in_range1 o13)
  (=> (and (<= (first1 data) o13) (<= o13 (last1 data)))
  (forall ((o14 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array data) o13)) o14)
  (forall ((lane3 (_ BitVec 64)))
  (=>
  ...
  (=> (in_range1 o15)
  (=> (in_range2 o15)
  (let ((o16 (+ (first1 data) offset1)))
  (=> (in_range1 o16)
  (let ((o17 (+ o16 i3)))
  (=> (in_range1 o17)
  (=> (and (<= (first1 data) o17) (<= o17 (last1 data)))
  (forall ((o18 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array data) o17)) o18)
  (forall ((lane4 (_ BitVec 64)))
  (=>
  ...
  (=> (in_range1 o19)
  (=> (in_range2 o19)
  (let ((o20 (+ (first1 data) offset1)))
  (=> (in_range1 o20)
  (let ((o21 (+ o20 i4)))
  (=> (in_range1 o21)
  (=> (and (<= (first1 data) o21) (<= o21 (last1 data)))
  (forall ((o22 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array data) o21)) o22)
  (forall ((lane5 (_ BitVec 64)))
  (=>
  ...
  (=> (in_range1 o23)
  (=> (in_range2 o23)
  (let ((o24 (+ (first1 data) offset1)))
  (=> (in_range1 o24)
  (let ((o25 (+ o24 i5)))
  (=> (in_range1 o25)
  (=> (and (<= (first1 data) o25) (<= o25 (last1 data)))
  (forall ((o26 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array data) o25)) o26)
  (forall ((lane6 (_ BitVec 64)))
  (=>
  ...
  (=> (in_range1 o27)
  (=> (in_range2 o27)
  (let ((o28 (+ (first1 data) offset1)))
  (=> (in_range1 o28)
  (let ((o29 (+ o28 i6)))
  (=> (in_range1 o29)
  (=> (and (<= (first1 data) o29) (<= o29 (last1 data)))
  (forall ((o30 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array data) o29)) o30)
  (forall ((lane7 (_ BitVec 64)))
  (=>
  ...
  (=> (in_range1 o31)
  (=> (in_range2 o31)
  (let ((o32 (+ (first1 data) offset1)))
  (=> (in_range1 o32)
  (let ((o33 (+ o32 i7)))
  (=> (in_range1 o33)
  (=> (and (<= (first1 data) o33) (<= o33 (last1 data)))
  (forall ((o34 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array data) o33)) o34)
  (forall ((lane8 (_ BitVec 64)))
  (=>
  (= lane8 (bvor lane7 (bvshl ((_ zero_extend 56) o34) ((_ int2bv 64) o31))))
  (forall ((o35 (_ BitVec 64)))
  (=> (= (to_rep (get a x1 y1)) o35)
  (forall ((o36 lane_type))
  (=> (= (to_rep o36) (bvxor o35 lane8))
  (forall ((a1 map1))
  (=> (= a1 (set a x1 y1 o36))
  (forall ((o37 (_ BitVec 8)))
  (=>
  (let ((temp___753 (bvadd x1 #x01)))
  (ite (bvule (bvsub #x05 x1) #x01) (= o37 (bvsub temp___753 #x05))
  (= o37 temp___753)))
  (forall ((x2 (_ BitVec 8)))
  (=> (= x2 o37)
  (forall ((spark__branch Bool) (y2 (_ BitVec 8)))
  (=>
  (and (= spark__branch (ite (= x2 #x00) true false))
  (ite (= spark__branch true)
  (exists ((o38 (_ BitVec 8)))
  (and
  (let ((temp___754 (bvadd y1 #x01)))
  (ite (bvule (bvsub #x05 y1) #x01) (= o38 (bvsub temp___754 #x05))
  (= o38 temp___754))) (= y2 o38))) (= y2 y1)))
  (let ((o38 (+ offset1 8)))
  (=> (in_range1 o38)
  (forall ((offset2 Int))
  (=> (= offset2 o38)
  (let ((o39 (- remaining_bits1 64)))
  (=> (in_range2 o39)
  (forall ((remaining_bits2 Int))
  (=> (= remaining_bits2 o39)
  (=> (<= 64 remaining_bits2)
  (let ((o40 (+ remaining_bits2 7)))
  (=> (in_range1 o40)
  (=> (in_range1 (+ offset2 (div1 o40 8))) (= (mod2 offset2 8) 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
