...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 193, characters 0-0
  (not
  (forall ((value (_ BitVec 32)) (last2 Int) (temporary_2 (_ BitVec 32))
  (o (_ BitVec 8)) (temporary_1 (_ BitVec 32)) (i Int)
  (temporary_21 (_ BitVec 32)))
  ...
  (=> (= temporary_1 ((_ zero_extend 24) o))
  (=> (dynamic_invariant temporary_1 true false true true)
  (=> (dynamic_invariant temporary_2 false false true true)
  (=> (= i 1)
  (=> (= temporary_21 (bvmul temporary_1 #x00000100))
  (let ((temp___597 (+ position i)))
  (=> (and (<= (first1 data) temp___597) (<= temp___597 (last1 data)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep1 (select (to_array data) temp___597)) o1)
  (forall ((temporary_22 (_ BitVec 32)))
  (=> (= temporary_22 (bvadd temporary_21 ((_ zero_extend 24) o1)))
  ...
  (=> (= temporary_23 (bvmul temporary_11 #x00000100))
  (let ((temp___5971 (+ position i1)))
  (=> (and (<= (first1 data) temp___5971) (<= temp___5971 (last1 data)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep1 (select (to_array data) temp___5971)) o2)
  (forall ((temporary_24 (_ BitVec 32)))
  (=> (= temporary_24 (bvadd temporary_23 ((_ zero_extend 24) o2)))
  (forall ((value2 (_ BitVec 32)))
  (=> (= value2 temporary_24)
  (forall ((temporary_12 (_ BitVec 32)))
  (=> (= temporary_12 value2)
  (forall ((i2 Int))
  (=> (= i2 3)
  (forall ((temporary_25 (_ BitVec 32)))
  (=> (= temporary_25 (bvmul temporary_12 #x00000100))
  (let ((temp___5972 (+ position i2)))
  (=> (and (<= (first1 data) temp___5972) (<= temp___5972 (last1 data)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep1 (select (to_array data) temp___5972)) o3)
  (forall ((temporary_26 (_ BitVec 32)))
  (=> (= temporary_26 (bvadd temporary_25 ((_ zero_extend 24) o3)))
