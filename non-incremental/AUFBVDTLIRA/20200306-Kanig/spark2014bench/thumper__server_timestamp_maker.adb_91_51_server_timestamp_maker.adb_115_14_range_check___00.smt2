...
;; defqtvc
 ;; File "server_timestamp_maker.ads", line 18, characters 0-0
  ...
  (imprint_stop Int) (decode_status Int) (imprint_status Int) (o Int)
  (spark__branch Bool) (o1 (_ BitVec 8)) (spark__branch1 Bool))
  ...
  (=> (= (to_rep1 (rec__messages__message__size (us_split_fields1 c13b))) o)
  (=> (= spark__branch (ite (<= o 2) true false))
  (=> (not (= spark__branch true))
  (=>
  (= (to_rep
     (select (rec__messages__message__data (us_split_fields1 c13b)) 1)) o1)
  (=> (= spark__branch1 (ite (not (= o1 #x30)) true false))
  (=> (not (= spark__branch1 true))
  (forall ((ada___ada___hermes__der__decode__get_length_value__status Int)
  ...
  true)))
  (=> (in_range5 ada___ada___hermes__der__decode__get_length_value__stop)
  (forall ((length_stop1 Int))
  (=>
  ...
  (=> (= spark__branch3 (ite (= o2 512) false true))
  (=> (not (= spark__branch3 true))
  (forall ((ada___ada___hermes__der__decode__get_integer_value__status Int)
  ...
  true)))
  (=> (in_range5 ada___ada___hermes__der__decode__get_integer_value__stop)
  (forall ((version_stop1 Int))
  (=>
  (= version_stop1 ada___ada___hermes__der__decode__get_integer_value__stop)
  (forall ((version1 Int))
  (=> (= version1 ada___ada___hermes__der__decode__get_integer_value__value)
  (forall ((decode_status2 Int))
  (=>
  (= decode_status2 ada___ada___hermes__der__decode__get_integer_value__status)
  (forall ((spark__branch4 Bool))
  (=> (= spark__branch4 (ite (= decode_status2 0) false true))
  (=> (not (= spark__branch4 true))
  (forall ((spark__branch5 Bool))
  (=> (= spark__branch5 (ite (= version1 1) false true))
