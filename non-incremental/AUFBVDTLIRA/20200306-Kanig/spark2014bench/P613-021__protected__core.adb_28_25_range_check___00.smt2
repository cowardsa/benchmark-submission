...
;; defqtvc
 ;; File "core.ads", line 33, characters 0-0
  (not
  (forall ((n Int) (self__ us_split_fields2) (o (_ BitVec 8))
  (o1 (_ BitVec 8)) (o2 message_index) (self__1 us_split_fields2) (o3 Int))
  (=> (dynamic_invariant n false false true true)
  (=> (< 0 (to_rep3 (rec__core__mailboxT__count self__)))
  (=> (= (to_rep2 (rec__core__mailboxT__next_out self__)) o)
  (=>
  (exists ((o4 Int))
  (= (to_rep
     (rec__core__message_record__value
     (us_split_fields1 (select (rec__core__mailboxT__messages self__) o)))) o4))
  (=> (= (to_rep2 (rec__core__mailboxT__next_out self__)) o1)
  (=> (= (to_rep2 o2) (bvurem (bvadd o1 #x01) #x10))
  (=>
  (= self__1 (us_split_fieldsqtmk1 (rec__core__mailboxT__messages self__)
             (rec__core__mailboxT__next_in self__) o2
             (rec__core__mailboxT__count self__)))
  (=> (= (to_rep3 (rec__core__mailboxT__count self__1)) o3) (in_range2
  (- o3 1)))))))))))))
(check-sat)
(exit)
