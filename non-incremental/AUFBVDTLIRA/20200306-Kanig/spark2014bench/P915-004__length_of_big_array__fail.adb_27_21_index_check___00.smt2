...
;; temp___String_Literal_222__def_axiom
  ...
  (! (and
     (and
     (= (to_rep (select (temp___String_Literal_222 us_void_param) 1)) 63)
     (= (to_rep (select (temp___String_Literal_222 us_void_param) 2)) 63))
     (= (to_rep (select (temp___String_Literal_222 us_void_param) 3)) 63)) :pattern (
  (temp___String_Literal_222 us_void_param)) )))
...
;; defqtvc
 ;; File "fail.adb", line 24, characters 0-0
  ...
  (=> (bvule (first3 c) #x0000000000000000)
