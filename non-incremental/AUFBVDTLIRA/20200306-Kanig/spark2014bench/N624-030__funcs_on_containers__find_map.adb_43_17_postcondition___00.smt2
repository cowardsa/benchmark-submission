...
;; defqtvc
 ;; File "find_map.adb", line 36, characters 0-0
  (not
  (forall ((o Int) (find_map__find_upto__find_map_bad__result Int) (i Int))
  ...
  (=>
  (forall ((i1 Int))
  (=> (and (<= (first1 a) i1) (<= i1 (- (element m e) 1)))
  ...
  (= o (get (model1 o5) o4)))))) (= o 0))))))
  (=> (= find_map__find_upto__find_map_bad__result o)
