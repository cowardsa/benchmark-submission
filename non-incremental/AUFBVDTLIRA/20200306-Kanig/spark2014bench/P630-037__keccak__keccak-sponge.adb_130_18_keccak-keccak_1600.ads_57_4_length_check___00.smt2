...
;; defqtvc
 ;; File "keccak-sponge.ads", line 146, characters 0-0
  ...
  (=> (= spark__branch3 (ite (< 0 remaining_bits2) true false))
  (=> (= spark__branch3 true)
  (=> (= (- remaining_bytes2 1) r78s)
  (=> (dynamic_invariant2 r78s true false true true)
  (let ((o10 (+ (first1 data) offset2)))
  (=> (in_range1 o10)
  (=> (= o10 r81s)
  (=> (dynamic_invariant2 r81s true false true true)
  (let ((o11 (+ offset2 (- remaining_bytes2 1))))
  (=> (in_range1 o11)
  (let ((o12 (+ (first1 data) o11)))
  (=> (in_range1 o12)
  (=> (= o12 r82s)
  (=> (dynamic_invariant2 r82s true false true true)
  (=>
  (=> (<= r81s r82s)
  ...
  (=> (<= (first1 temp___903) (last1 temp___903))
  (<= (first1 temp___906) (last1 temp___906))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
