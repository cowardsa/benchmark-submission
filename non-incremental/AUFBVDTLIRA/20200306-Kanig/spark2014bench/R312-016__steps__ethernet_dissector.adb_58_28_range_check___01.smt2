...
;; defqtvc
 ;; File "ethernet_dissector.ads", line 12, characters 0-0
  ...
  (=> (in_range1 o18)
  (=> (= o18 r34b)
  (=> (dynamic_invariant1 r34b true false true true)
  (let ((o19 (+ (first1 buffer) 13)))
  (=> (in_range1 o19)
  (let ((o20 (+ o19 offset1)))
  (=> (in_range1 o20)
  (=> (= o20 r35b)
  (=> (dynamic_invariant1 r35b true false true true)
  (=>
  (=> (<= r34b r35b)
  ...
  (=> (in_range1 o24)
  (=> (= o24 r38b)
  (=> (dynamic_invariant1 r38b true false true true)
  (let ((temp___323 (first1 buffer)))
  (=> (<= temp___323 r38b) (<= (first1 buffer) temp___323))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
