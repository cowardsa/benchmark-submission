...
;; defqtvc
 ;; File "keccak-duplex.ads", line 115, characters 0-0
  ...
  (=> (forall ((o1 us_rep)) (rate_of__function_guard (rate_of o1) o1))
  (=>
  (let ((o1 (us_repqtmk ctx__split_fields)))
  (let ((o2 (max_input_length o1)))
  (and
  (and (max_input_length__function_guard o2 o1)
  (and (dynamic_invariant3 o2 true false true true)
  (= o2 (- (rate_of o1) 2))))
  (ite (<= in_data_bit_length o2)
  (let ((o3 (+ in_data_bit_length 7)))
  (and (in_range o3)
  (let ((o4 (length1 in_data)))
  (and (in_range o4) (= o (ite (<= (div1 o3 8) o4) true false))))))
  (= o false)))))
  (=>
  (or (not (= o true))
  (let ((o1 (us_repqtmk ctx__split_fields)))
  ...
  (=> (in_range (+ out_data_bit_length 7))
  (forall ((o1 Int))
  (=> (= (to_rep out_data__last) o1)
  (forall ((o2 Int))
  (=> (= (to_rep out_data__first) o2) (in_range (length o2 o1)))))))))))))))))))
(check-sat)
(exit)
