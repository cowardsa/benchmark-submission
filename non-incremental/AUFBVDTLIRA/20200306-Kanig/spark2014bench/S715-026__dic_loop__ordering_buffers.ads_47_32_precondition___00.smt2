...
;; defqtvc
 ;; File "ordering_buffers.ads", line 38, characters 0-0
  ...
  (has_message (us_repqtmk buffer__split_fields1) index)
  (us_repqtmk buffer__split_fields1) index))
  ...
  (us_repqtmk buffer__split_fields2)))
  (=>
  (forall ((o1 Int) (buffer__split_fields2 us_split_fields))
  (get_message__function_guard
  (get_message (us_repqtmk buffer__split_fields2) o1)
  (us_repqtmk buffer__split_fields2) o1))
  (=>
  (forall ((buffer__split_fields2 us_split_fields)) (first__function_guard
  (first (us_repqtmk buffer__split_fields2))
  (us_repqtmk buffer__split_fields2)))
  ...
  (= (get_message (us_repqtmk buffer__split_fields1) o) message))
  (forall ((i Int))
  (=>
  ...
  (=>
  (= (and (ite (<= o4 usf1) true false) (ite (<= usf1 o2) true false)) true)
  (=> (not (= usf1 index))
  (=> (in_range3 usf1)
  (let ((o5 (get_message usf usf1)))
  (=>
  (and (get_message__function_guard o5 usf usf1)
