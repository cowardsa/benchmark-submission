...
;; defqtvc
 ;; File "hermes-oid.ads", line 52, characters 0-0
  ...
  (=> (< left_index2 right_index2)
  (forall ((o18 Int))
  (=> (= (to_rep result____last) o18)
  (forall ((o19 Int))
  (=> (= (to_rep result____first) o19)
  (forall ((o20 Int))
  (=> (= (to_rep result____last) o20)
  (forall ((o21 Int))
  (=> (= (to_rep result____first) o21)
  (forall ((result__3 (Array Int octet)) (left_index3 Int) (right_index3 Int)
  (temp2 (_ BitVec 8)))
  (=>
  (and
  ...
  (and (<= (to_rep result____first) left_index3)
  (<= left_index3 (to_rep result____last)))
  (forall ((o22 (_ BitVec 8)))
  (=> (= (to_rep5 (select result__3 left_index3)) o22)
  (forall ((temp3 (_ BitVec 8)))
  (=> (= temp3 o22)
  (=>
  (and (<= (to_rep result____first) right_index3)
  (<= right_index3 (to_rep result____last)))
  (forall ((o23 (_ BitVec 8)))
  (=> (= (to_rep5 (select result__3 right_index3)) o23)
  (forall ((o24 octet))
  (=> (= (to_rep5 o24) o23)
  (=>
  (and (<= (to_rep result____first) left_index3)
  (<= left_index3 (to_rep result____last)))
  (forall ((result__4 (Array Int octet)))
  (=> (= result__4 (store result__3 left_index3 o24))
  (forall ((o25 octet))
  (=> (= (to_rep5 o25) temp3)
  (=>
  (and (<= (to_rep result____first) right_index3)
  (<= right_index3 (to_rep result____last)))
  (forall ((result__5 (Array Int octet)))
  (=> (= result__5 (store result__4 right_index3 o25))
  (let ((o26 (+ left_index3 1)))
  (=> (in_range1 o26)
  (forall ((left_index4 Int))
  (=> (= left_index4 o26)
  (let ((o27 (- right_index3 1)))
  (=> (in_range2 o27)
  (forall ((right_index4 Int))
  (=> (= right_index4 o27)
  (=> (< left_index4 right_index4)
  (forall ((o28 Int))
  (=> (= (to_rep result____last) o28)
  (forall ((o29 Int))
  (=> (= (to_rep result____first) o29)
  (forall ((o30 Int))
  (=> (= (to_rep result____last) o30)
  (forall ((o31 Int))
  (=> (= (to_rep result____first) o31)
  (<= (to_rep result____first) left_index4)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
