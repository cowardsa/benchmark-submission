...
;; defqtvc
 ;; File "random.ads", line 47, characters 0-0
  ...
  (forall ((o5 Int))
  (=> (= (to_rep (rec__random__generator__index g__split_fields)) o5)
  (forall ((o6 Int))
  (=> (= (to_rep (rec__random__generator__index g__split_fields)) o6)
  (=>
  (not
  (= (and (ite (<= 0 o6) true false) (ite (<= o5 226) true false)) true))
  (forall ((o7 Int))
  (=> (= (to_rep (rec__random__generator__index g__split_fields)) o7)
  (forall ((o8 Int))
