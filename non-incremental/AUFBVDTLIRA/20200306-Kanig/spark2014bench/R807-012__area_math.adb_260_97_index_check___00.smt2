...
;; defqtvc
 ;; File "area_math.ads", line 46, characters 0-0
  ...
  (=>
  (= result____split_fields4 (us_split_fieldsqtmk1 o6
                             (rec__area_math__ensemble__from1
                             result____split_fields3)
                             (rec__area_math__ensemble__to1
                             result____split_fields3)))
  (let ((temp___462 (rec__area_math__ensemble__from1 result____split_fields4)))
  (forall ((o7 address_type))
  (=> (= (to_rep2 o7) prev1)
  (forall ((temp___463 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) temp___463)
  (=>
  ...
  (us_repqtmk1 result____split_discrs
  (us_split_fieldsqtmk1
  (rec__area_math__ensemble__size1 result____split_fields4)
  (us_tqtmk
  (store (to_array (rec__area_math__ensemble__from1 result____split_fields4)) temp___463 o7)
  (rt (rec__area_math__ensemble__from1 result____split_fields4)))
  ...
  (= result____split_fields5 (us_split_fieldsqtmk1
                             ...
                             (store (to_array
                                    (rec__area_math__ensemble__from1
                                    result____split_fields4)) temp___463 o7)
                             (rt
                             (rec__area_math__ensemble__from1
                             result____split_fields4)))
                             (rec__area_math__ensemble__to1
                             result____split_fields4)))
  (let ((temp___467 (rec__area_math__ensemble__to1 result____split_fields5)))
  (forall ((o8 address_type))
  (=> (= (to_rep2 o8) next1)
  (forall ((temp___468 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields5)) temp___468)
  (=>
  ...
  (= result____split_fields6 (us_split_fieldsqtmk1
                             ...
                             (store (to_array
                                    (rec__area_math__ensemble__to1
                                    result____split_fields5)) temp___468 o8)
                             (rt
                             (rec__area_math__ensemble__to1
                             result____split_fields5)))))
  (=>
  ...
  (let ((temp___482 (rec__area_math__ensemble__to1 result____split_fields6)))
  (forall ((temp___483 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields6)) temp___483)
  (=>
  (and (<= (first1 temp___482) temp___483)
  (<= temp___483 (last1 temp___482)))
  (forall ((o9 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___482) temp___483)) o9)
  (=> (not (= o9 #xFFFFFFFF))
  (let ((temp___486 (rec__area_math__ensemble__from (us_split_fields1 e))))
  (let ((o10 (+ i 1)))
  (=> (in_range1 o10)
  (=> (and (<= (first1 temp___486) o10) (<= o10 (last1 temp___486)))
  (forall ((o11 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___486) o10)) o11)
  (forall ((temp___485 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields6)) temp___485)
  (<= (first1 (rec__area_math__ensemble__to1 result____split_fields6)) temp___485))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
