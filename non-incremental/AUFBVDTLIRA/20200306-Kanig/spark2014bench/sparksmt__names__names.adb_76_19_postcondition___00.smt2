...
(define-fun in_range5 ((rec__ada___names__data__entry_tables__vector__capacity1 Int)
  ...
  (to_rep3 (rec__ada___names__data__entry_tables__vector__capacity a))))
...
(define-fun last2 ((container us_rep1)) Int (+ 0 (length2 container)))
...
(define-fun in_range8 ((rec__ada___names__data__char_tables__vector__capacity1 Int)
  ...
  (to_rep4 (rec__ada___names__data__char_tables__vector__capacity a))))
...
(define-fun dynamic_invariant4 ((temp___expr_297 us_rep2)
...
(define-fun capacity1 ((container us_rep2)) Int (ite (= (distinct 0 0) true)
                                                (to_rep4
                                                (rec__ada___names__data__char_tables__vector__capacity
                                                (us_split_discrs3 container)))
                                                2147483647))

(declare-fun capacity__function_guard1 (Int us_rep2) Bool)

(define-fun dynamic_invariant5 ((temp___expr_284 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length3 container)))
     (and (<= result (capacity1 container)) (dynamic_invariant5 result true
...
(declare-fun model2 (us_rep2) us_rep3)

(declare-fun model__function_guard1 (us_rep3 us_rep2) Bool)

(declare-fun length4 (us_rep3) Int)

(declare-fun length__function_guard3 (Int us_rep3) Bool)

(define-fun last3 ((container us_rep3)) Int (+ (- 1) (length4 container)))
...
(declare-const dummy13 extended_index1)
...
(declare-fun user_eq14 (name_id name_id) Bool)

(declare-const dummy14 name_id)
...
;; range_axiom
  (assert
  (forall ((x name_id)) (! (in_range10 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
;; range_axiom
  (assert
  (forall ((x char_table_index)) (! (in_range11
...
(((name_entry__refqtmk (name_entry__content us_rep4)))))
(define-fun name_entry__ref_name_entry__content__projection ((a name_entry__ref)) us_rep4 
  (name_entry__content a))

(declare-datatypes ((element_type__ref 0))
(((element_type__refqtmk (element_type__content us_rep4)))))
...
(define-fun bool_eq5 ((a (Array (_ BitVec 32) name_id))
...
(define-fun length5 ((x Int) (y Int)) Int (ite (<= x y) (+ (- y x) 1) 0))

(define-fun olt ((left us_rep3)
  (right us_rep3)) Bool (and (< (length4 left) (length4 right)) (ite 
                                                                (forall
                                                                ((n Int))
                                                                (=>
                                                                (and (<= 0 n)
...
(declare-fun olt__function_guard (Bool us_rep3 us_rep3) Bool)
...
(declare-fun get1 (us_rep1 Int) us_rep4)

(declare-fun get__function_guard1 (us_rep4 us_rep1 Int) Bool)

(define-fun olt1 ((left us_rep1)
...
(declare-fun olt__function_guard1 (Bool us_rep1 us_rep1) Bool)
...
(declare-fun user_eq17 (tcount_typeB tcount_typeB) Bool)

(declare-const dummy17 tcount_typeB)
...
(define-fun dynamic_invariant7 ((temp___expr_249 Int)
...
(declare-fun user_eq18 (tchar_table_indexB tchar_table_indexB) Bool)

(declare-const dummy18 tchar_table_indexB)

(declare-datatypes ((tchar_table_indexB__ref 0))
...
(define-fun t13b__ref_t13b__content__projection ((a t13b__ref)) integer 
  (t13b__content a))
...
;; valid_hashes__def_axiom
  ...
  (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true)
     (forall ((h (_ BitVec 32)))
     (=> (and (bvule #x00000000 h) (bvule h #x000000FF))
     (<= (to_rep5 (select names__hash_table h)) (last_index
                                                (us_repqtmk
                                                entry_table__split_discrs
                                                names__entry_table__fields)))))) :pattern (
  (valid_hashes names__hash_table names__entry_table__fields)) ))))

(declare-fun valid_entry (us_rep4 us_split_fields2 us_split_fields) Bool)

(declare-fun valid_entry__function_guard (Bool us_rep4 us_split_fields2
  us_split_fields) Bool)
...
(define-fun element ((container us_rep)
  (index Int)) us_rep4 (get1 (model1 container) index))

(declare-fun element__function_guard (us_rep4 us_rep Int) Bool)
...
(define-fun dynamic_invariant11 ((temp___expr_204 Int)
...
(define-fun default_initial_assumption2 ((temp___expr_315 us_rep3)
  (temp___skip_top_level_316 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_316 true))
                                         (= (length4 temp___expr_315) 0)))
...
(define-fun in_range15 ((x Int)) Bool (and (<= (- 1) x) (<= x 2147483646)))
...
(declare-fun user_eq21 (extended_index2 extended_index2) Bool)

(declare-const dummy21 extended_index2)
...
(define-fun dynamic_invariant13 ((temp___expr_307 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length4 container)))
     (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant11 result true
     false true true))) :pattern ((length4 container)) )))
...
(declare-fun user_eq22 (element_type element_type) Bool)

(declare-const dummy22 element_type)

(declare-datatypes ((element_type__ref2 0))
(((element_type__refqtmk2 (element_type__content2 element_type)))))
(define-fun element_type__ref_element_type__content__4__projection ((a element_type__ref2)) element_type 
  (element_type__content2 a))

(define-fun dynamic_invariant14 ((temp___expr_478 Int)
  (temp___is_init_474 Bool) (temp___skip_constant_475 Bool)
  (temp___do_toplevel_476 Bool)
  (temp___do_typ_inv_477 Bool)) Bool (=>
...
;; get__post_axiom
  ...
  (forall ((position Int))
  (! (=>
     (and (dynamic_invariant13 position true true true true)
     (and (<= 0 position) (<= position (last3 container))))
     (dynamic_invariant14 (get container position) true false true true)) :pattern (
...
(define-fun in_range17 ((x Int)) Bool (and (<= 1 x) (<= x 2147483647)))
...
(declare-fun user_eq23 (index_type index_type) Bool)

(declare-const dummy23 index_type)
...
(define-fun dynamic_invariant15 ((temp___expr_263 Int)
...
(define-fun dynamic_invariant16 ((temp___expr_234 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length2 container)))
     (and (<= (+ 0 result) 2147483647) (dynamic_invariant11 result true false
...
(assert
;; defqtvc
 ;; File "names.adb", line 71, characters 0-0
  (not
  ...
  (< (last_index1
     (us_repqtmk1 char_table__split_discrs
     (us_split_fieldsqtmk1 char_table__split_fields))) (- 2147483646 
  (length s)))
  (=>
  (< (last_index
     (us_repqtmk entry_table__split_discrs
  ...
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i o) true false)) true)
  (let ((usf (length3
             (us_repqtmk1 char_table__split_discrs
  ...
  (let ((o2 (+ i o1)))
  (and (in_range1 o2)
  (and (and (<= (first1 s) o2) (<= o2 (last1 s)))
  (exists ((o3 Int))
  (and (= (to_rep1 (select (to_array s) o2)) o3)
  (let ((o4 char_table__split_discrs))
  (exists
  ((ada___names__data__char_tables__append__2__container__fields us_main_type2))
  (and
  (and
  (and
  (= (length3
     (us_repqtmk1 o4
     (us_split_fieldsqtmk1
     ada___names__data__char_tables__append__2__container__fields))) (+ 
  (length3 (us_repqtmk1 o4 (us_split_fieldsqtmk1 char_table__split_fields))) 1))
  (= (olt
     (model2
     ...
     (us_repqtmk1 o4
     (us_split_fieldsqtmk1
     ada___names__data__char_tables__append__2__container__fields)))) true))
  (= (get
     (model2
     (us_repqtmk1 o4
     (us_split_fieldsqtmk1
     ada___names__data__char_tables__append__2__container__fields)))
     (+ (last_index1
        (us_repqtmk1 o4 (us_split_fieldsqtmk1 char_table__split_fields))) 1)) o3))
  (exists ((char_table__split_fields2 us_main_type2))
  (and
  (= char_table__split_fields2 ada___names__data__char_tables__append__2__container__fields)
  (and (in_range12 (+ usf i))
  (let ((o5 (us_repqtmk1 char_table__split_discrs
            (us_split_fieldsqtmk1 char_table__split_fields2))))
  (let ((o6 (length3 o5)))
  (and
  (and (dynamic_invariant5 o6 true false true true) (<= o6 (capacity1 o5)))
  (let ((o7 (invariant__ hash_table
            (us_split_fieldsqtmk1 char_table__split_fields2)
            (us_split_fieldsqtmk entry_table__split_fields))))
  (and
  (and (invariant____function_guard o7 hash_table
  (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields))
  (= (= o7 true)
  (and
  ...
  (= (length3
     (us_repqtmk1 char_table__split_discrs
     (us_split_fieldsqtmk1 char_table__split_fields1))) (+ usf i1)))
  (and
  (= (and (ite (and (dynamic_property1 1 (length s) i1) (dynamic_invariant4
               (us_repqtmk1 char_table__split_discrs
               (us_split_fieldsqtmk1 char_table__split_fields1)) true true
               true true))
          true false) (ite (and (<= 1 i1) (<= i1 (length s))) true false)) true)
  (= i1 o)))))))))))))))))))))))
  ...
  (let ((o2 (length s)))
  (=> (in_range13 o2)
  (let ((o3 (us_repqtmk1 char_table__split_discrs
            (us_split_fieldsqtmk1 char_table__split_fields1))))
  (let ((o4 (last_index1 o3)))
  (=>
  (and (dynamic_invariant6 o4 true false true true)
  (= o4 (last3 (model2 o3))))
  (let ((o5 (- o4 (- o2 1))))
  (=> (in_range13 o5)
  (=> (in_range11 o5)
  (forall ((o6 char_table_index))
  (=> (= (to_rep6 o6) o5)
  (let ((o7 entry_table__split_discrs))
  (forall
  ((ada___names__data__entry_tables__append__2__container__fields us_main_type))
  (=>
  (and
  (and
  (= (length1
     (us_repqtmk o7
     (us_split_fieldsqtmk
     ada___names__data__entry_tables__append__2__container__fields))) (+ 
  (length1 (us_repqtmk o7 (us_split_fieldsqtmk entry_table__split_fields))) 1))
  (= (olt1
     (model1 (us_repqtmk o7 (us_split_fieldsqtmk entry_table__split_fields)))
     (model1
     (us_repqtmk o7
     (us_split_fieldsqtmk
     ada___names__data__entry_tables__append__2__container__fields)))) true))
  (= (bool_eq4
     (get1
     (model1
     (us_repqtmk o7
     ...
     ada___names__data__entry_tables__append__2__container__fields)))
     (+ (last_index
        (us_repqtmk o7 (us_split_fieldsqtmk entry_table__split_fields))) 1))
     (us_repqtmk2 (us_split_fieldsqtmk2 o6 o1 rliteral))) true))
  (forall ((entry_table__split_fields1 us_main_type))
  (=>
  (= entry_table__split_fields1 ada___names__data__entry_tables__append__2__container__fields)
  (let ((o8 (us_repqtmk entry_table__split_discrs
            (us_split_fieldsqtmk entry_table__split_fields1))))
