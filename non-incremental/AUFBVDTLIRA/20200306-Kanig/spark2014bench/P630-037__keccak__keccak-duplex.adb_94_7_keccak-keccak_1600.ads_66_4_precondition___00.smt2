...
(declare-const r168s Int)

(declare-const attr__ATTRIBUTE_ADDRESS4 Int)

(declare-const r171s Int)
...
(declare-fun user_eq9 (tTblockSP1 tTblockSP1) Bool)

(declare-const dummy9 tTblockSP1)

(declare-datatypes ((tTblockSP1__ref 0))
(((tTblockSP1__refqtmk (tTblockSP1__content tTblockSP1)))))
(define-fun tTblockSP1__ref_tTblockSP1__content__2__projection ((a tTblockSP1__ref)) tTblockSP1 
  (tTblockSP1__content a))

(declare-datatypes ((t170s__ref 0))
(((t170s__refqtmk (t170s__content us_t)))))
(define-fun t170s__ref_t170s__content__projection ((a t170s__ref)) us_t 
  (t170s__content a))

(declare-datatypes ((t173s__ref 0))
(((t173s__refqtmk (t173s__content us_t)))))
(define-fun t173s__ref_t173s__content__projection ((a t173s__ref)) us_t 
  (t173s__content a))

(declare-fun ada___keccak__keccak_1600__duplex__duplex_blank__block__aggregate_def ((_ BitVec 8)) (Array Int byte))
...
;; def_axiom
  (assert
  (forall ((temp___1213 (_ BitVec 8)))
  (=> (dynamic_invariant3 temp___1213 true true true true)
  (forall ((temp___1214 Int))
  (= (to_rep2
     (select (ada___keccak__keccak_1600__duplex__duplex_blank__block__aggregate_def
             temp___1213) temp___1214)) temp___1213)))))
...
;; defqtvc
 ;; File "keccak-duplex.ads", line 137, characters 0-0
  ...
  (=>
  (= block (ada___keccak__keccak_1600__duplex__duplex_blank__block__aggregate_def
           #x00))
  ...
  (= o1 (to_rep3
        ...
        ctx__split_fields)))))
  (=> (= (- (div1 (+ o1 7) 8) 1) r168s)
  (=> (dynamic_invariant1 r168s true false true true)
  (=>
  (=> (<= 0 r168s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r168s) (<= r168s 199))))
  ...
  (=>
  (forall ((temp___1218 Int))
  (ite (and (<= 0 temp___1218) (<= temp___1218 r168s))
  (= (select usf temp___1218) (select (to_array
                                      (of_array
                                      (slide1 (to_array temp___1216)
                                      (first1 temp___1216) 0) 0 r168s)) temp___1218))
  (= (select usf temp___1218) (select block temp___1218))))
  ...
  (= (to_rep3
     (rec__ada___keccak__keccak_1600__duplex__context__rate
     ctx__split_fields)) o6)
  (=> (= (- (div1 (+ o6 7) 8) 1) r171s)
  (=> (dynamic_invariant1 r171s true false true true)
  (let ((o7 (us_repqtmk ctx__split_fields)))
  (let ((o8 (rate_of o7)))
  (=>
  (and (rate_of__function_guard o8 o7)
  ...
  (=>
  (=> (<= 0 r171s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r171s) (<= r171s 199))))
  (forall
