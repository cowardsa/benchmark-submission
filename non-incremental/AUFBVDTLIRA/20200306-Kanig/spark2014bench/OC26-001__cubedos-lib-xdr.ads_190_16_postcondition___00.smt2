...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 177, characters 0-0
  ...
  (forall ((last3 Int) (temp1 (_ BitVec 32)))
  (=>
  (and (= last3 (+ position 3))
  (and (dynamic_invariant temp1 true true true true) (dynamic_invariant1
  last3 true true true true)))
  (let ((o (xdr_unsigned_to_integer temp1)))
  (=>
  (and (xdr_unsigned_to_integer__function_guard o temp1) (dynamic_invariant3
  o true false true true)) (= last3 (+ position 3)))))))))))))))))))
(check-sat)
(exit)
