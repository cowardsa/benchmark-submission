...
;; defqtvc
 ;; File "parse.ads", line 15, characters 0-0
  ...
  (=> (= spark__branch true)
  (forall ((parse__parse_header__R2b__assume Int))
  (=> (= (to_rep4 result____split_discrs) parse__parse_header__R2b__assume)
  (=> (= parse__parse_header__R2b__assume r2b)
  (=> (dynamic_invariant4 r2b true false true true)
  (forall ((o5 return_code_t))
  (=> (= (to_rep4 o5) 1)
  (=> (= result____attr__constrained true) (= o5 result____split_discrs))))))))))))))))))))))))))))
(check-sat)
(exit)
