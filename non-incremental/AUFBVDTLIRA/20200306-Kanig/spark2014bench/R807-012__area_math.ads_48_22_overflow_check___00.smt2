...
;; defqtvc
 ;; File "area_math.ads", line 46, characters 0-0
  ...
  (let ((o e))
  (let ((o1 (is_consistent o)))
  (=>
  (and (is_consistent__function_guard o1 o)
  (= (= o1 true)
  (and
  (forall ((r Int))
  (=>
  (and (<= 1 r)
  (<= r (- (to_rep (rec__area_math__ensemble__size (us_split_fields1 o))) 1)))
  (and
  (bvult (to_rep2
         (select (to_array
                 (rec__area_math__ensemble__to (us_split_fields1 o))) r)) 
  (to_rep2
  (select (to_array (rec__area_math__ensemble__from (us_split_fields1 o))) (+ r 1))))
  (bvugt (bvsub (to_rep2
                (select (to_array
                        (rec__area_math__ensemble__from (us_split_fields1 o))) (+ r 1))) 
  (to_rep2
  (select (to_array (rec__area_math__ensemble__to (us_split_fields1 o))) r))) #x00000001))))
  (forall ((r Int))
  (=>
  (and (<= 1 r)
  (<= r (to_rep (rec__area_math__ensemble__size (us_split_fields1 o)))))
  (bvule (to_rep2
         (select (to_array
                 (rec__area_math__ensemble__from (us_split_fields1 o))) r)) 
  (to_rep2
  (select (to_array (rec__area_math__ensemble__to (us_split_fields1 o))) r))))))))
  (forall ((o2 Int))
