...
;; defqtvc
 ;; File "very_longs.ads", line 43, characters 0-0
  ...
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1002) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___1012)
               (<= temp___1012 (last1 result____split_fields2)))
               (=>
               (or (< temp___1002 temp___1012)
               (or (< temp___1012 1) (<= i1 temp___1012)))
               (= (select (to_array result____split_fields2) temp___1012) (select 
