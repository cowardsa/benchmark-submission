...
;; defqtvc
 ;; File "patris.ads", line 250, characters 0-0
  ...
  (complete_lines1 (_ BitVec 32)) (cur_board2 (Array Int (Array Int cell)))
  (to_line2 Int) (complete_lines2 (_ BitVec 32)) (del_line1 Int)
  (del_line2 Int) (cur_board3 (Array Int (Array Int cell))) (y Int))
  ...
  (=>
  (forall ((y1 Int))
  (=> (and (<= 1 y1) (<= y1 del_line1))
  (not (= (is_complete_line (select cur_board2 y1)) true))))
  (=>
  (= (and (ite (and
               (and
               (and
               ...
               (= (select cur_board2 temp___923) (select cur_board temp___923)))))
               (dynamic_invariant3 to_line2 true true true true))
               (dynamic_invariant2 complete_lines2 true true true true))
               (in_range9 del_line1))
          true false) (ite (and (<= 1 del_line1) (<= del_line1 20)) true
                      false)) true)
  (=> (not (= del_line1 20))
  (=> (= del_line2 (+ del_line1 1))
  (=>
  (let ((o (select cur_board2 del_line2)))
  (let ((o1 (is_complete_line o)))
  (and
  (= (= o1 true)
  (forall ((x Int))
  ...
  (and (= cur_board3 (store cur_board2 del_line2 empty_line))
  (= (to_rep (select (select cur_board3 del_line2) 1)) 0))
  (= cur_board3 cur_board2)))))))
  (=> (<= 1 y)
  (=> (<= y del_line2)
