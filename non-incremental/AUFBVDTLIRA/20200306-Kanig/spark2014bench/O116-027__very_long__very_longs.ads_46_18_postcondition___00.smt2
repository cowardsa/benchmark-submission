...
(((t73b__refqtmk (t73b__content us_t)))))
(define-fun t73b__ref_t73b__content__projection ((a t73b__ref)) us_t 
  (t73b__content a))

(declare-fun temp_____aggregate_def_989 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___991 (_ BitVec 8)))
  (forall ((temp___992 Int) (temp___993 Int))
  (let ((temp___990 (temp_____aggregate_def_989 temp___991 temp___992
                    temp___993)))
  (=> (dynamic_invariant3 temp___991 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___992 temp___993)
  (and (= (first1 temp___990) temp___992) (= (last1 temp___990) temp___993)))
  (forall ((temp___994 Int))
  (= (to_rep2 (select (to_array temp___990) temp___994)) temp___991))))))))
...
;; defqtvc
 ;; File "very_longs.ads", line 43, characters 0-0
  ...
  (let ((temp___995 (temp_____aggregate_def_989 #x00 1 o1)))
  (=> (= (first1 temp___995) 1)
  (=>
  (= (last1 temp___995) (to_rep
                        (rec__very_longs__very_long__length
                        (us_split_discrs1 l))))
  (=>
  ...
  (= (- (last1 temp___995) (first1 temp___995)) (- (to_rep
                                                   (rec__very_longs__very_long__length
                                                   (us_split_discrs1 l))) 1)))
  (< (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1))
  (let ((temp___997 (of_array (to_array temp___995) (first1 temp___995)
                    (last1 temp___995))))
  (=>
  (ite (<= (first1 temp___997) (last1 temp___997))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___997) (first1 temp___997)) (- (last1
  ...
  (=> (= result____split_fields1 temp___997)
  (forall ((carry1 (_ BitVec 16)))
  (=> (= carry1 #x0000)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1002 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1002) true false)) true)
  ...
  (= (and (ite (and
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1003 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1003) i1) (<= i1 (last1 temp___1003)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1003) i1)) o2)
  (exists ((l_digit2 (_ BitVec 16)))
  (and (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1004 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1004) i1) (<= i1 (last1 temp___1004)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1004) i1)) o3)
  ...
  (forall ((very_longs__modadd__result us_rep))
  (=>
