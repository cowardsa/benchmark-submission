...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 73, characters 0-0
  (not
  (forall ((digit_number Int) (bit_position Int) (mask (_ BitVec 8))
  (digit (_ BitVec 8)) (result__ Int) (digit_number1 Int) (bit_position1 Int)
  (o (_ BitVec 8)))
  ...
  (=> (dynamic_invariant2 mask false false true true)
  (=> (dynamic_invariant2 digit false false true true)
  (=> (dynamic_invariant3 result__ false false true true)
  (=> (= digit_number1 (+ 1 (div1 bit_number 8)))
  (=> (= bit_position1 (mod2 bit_number 8))
  (=>
  (ite (< bit_position1 8) (= o (bvshl #x01 ((_ int_to_bv 8) bit_position1)))
  (= o #x00))
  (<= (first1
      (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_number1))))))))))))))
(check-sat)
(exit)
