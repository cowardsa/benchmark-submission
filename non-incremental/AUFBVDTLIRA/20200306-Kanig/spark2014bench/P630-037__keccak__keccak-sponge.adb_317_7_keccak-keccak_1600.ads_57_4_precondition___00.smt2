...
(declare-fun user_eq6 (states states) Bool)

(declare-const dummy6 states)
...
(declare-fun user_eq7 (byte_absorption_number byte_absorption_number) Bool)

(declare-const dummy7 byte_absorption_number)
...
;; rate_of__post_axiom
  ...
  (! (let ((result (rate_of ctx)))
     ...
     (and (< result 1600) (dynamic_invariant2 result true false true true)))) :pattern (
  (rate_of ctx)) )))
...
(declare-const r97s Int)

(declare-const attr__ATTRIBUTE_ADDRESS3 Int)

(declare-const r102s Int)
...
(declare-const r111s Int)

(declare-const attr__ATTRIBUTE_ADDRESS7 Int)

(declare-const r114s Int)

(declare-const attr__ATTRIBUTE_ADDRESS8 Int)

(declare-sort tTnext_blockSP1 0)

(declare-fun tTnext_blockSP1qtint (tTnext_blockSP1) Int)

;; tTnext_blockSP1'axiom
  (assert
  (forall ((i tTnext_blockSP1))
  (and (<= 0 (tTnext_blockSP1qtint i)) (<= (tTnext_blockSP1qtint i) 199))))
...
(declare-const dummy13 tTnext_blockSP1)

(declare-datatypes ((tTnext_blockSP1__ref 0))
(((tTnext_blockSP1__refqtmk (tTnext_blockSP1__content tTnext_blockSP1)))))
(define-fun tTnext_blockSP1__ref_tTnext_blockSP1__content__projection ((a tTnext_blockSP1__ref)) tTnext_blockSP1 
...
(declare-datatypes ((t104s__ref 0))
(((t104s__refqtmk (t104s__content us_t)))))
(define-fun t104s__ref_t104s__content__projection ((a t104s__ref)) us_t 
  (t104s__content a))
...
(declare-datatypes ((t110s__ref 0))
(((t110s__refqtmk (t110s__content us_t)))))
(define-fun t110s__ref_t110s__content__projection ((a t110s__ref)) us_t 
  (t110s__content a))
...
(((t116s__refqtmk (t116s__content us_t)))))
(define-fun t116s__ref_t116s__content__projection ((a t116s__ref)) us_t 
  (t116s__content a))

(declare-fun ada___keccak__keccak_1600__sponge__finalize__next_block__aggregate_def ((_ BitVec 8)) (Array Int byte))

(declare-fun temp_____aggregate_def_1108 ((_ BitVec 8)) (Array Int byte))

(define-fun dynamic_invariant3 ((temp___expr_273 (_ BitVec 8))
...
(define-fun dynamic_invariant6 ((temp___expr_360 Int)
  ...
  (temp___do_typ_inv_359 Bool)) Bool (=>
                                     ...
                                     (<= 1 199)) (in_range6 temp___expr_360)))

(define-fun dynamic_invariant7 ((temp___expr_336 Int)
  ...
  (temp___do_typ_inv_335 Bool)) Bool (=>
                                     ...
                                     (<= 0 199)) (in_range4 temp___expr_336)))
...
;; def_axiom
  (assert
  (forall ((temp___1099 (_ BitVec 8)))
  (=> (dynamic_invariant3 temp___1099 true true true true)
  (forall ((temp___1100 Int))
  (= (to_rep2
     (select (ada___keccak__keccak_1600__sponge__finalize__next_block__aggregate_def
             temp___1099) temp___1100)) temp___1099)))))

;; def_axiom
  (assert
  (forall ((temp___1110 (_ BitVec 8)))
  (=> (dynamic_invariant3 temp___1110 true true true true)
  (forall ((temp___1111 Int))
  (= (to_rep2 (select (temp_____aggregate_def_1108 temp___1110) temp___1111)) temp___1110)))))
...
;; defqtvc
 ;; File "keccak-sponge.adb", line 273, characters 0-0
  ...
  (forall ((next_block (Array Int byte)))
  (=>
  (= next_block (ada___keccak__keccak_1600__sponge__finalize__next_block__aggregate_def
                #x00))
  (forall ((spark__branch Bool) (ctx__split_fields1 us_split_fields))
  (=>
  (let ((o (us_repqtmk ctx__split_fields)))
  (let ((o1 (rate_of o)))
  (and
  (and (rate_of__function_guard o1 o)
  ...
  (and (= spark__branch (ite (<= o1 o2) true false))
  (ite (= spark__branch true)
  (exists ((o3 Int))
  (and
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields)) o3)
  (and (= (- o3 1) r97s)
  (and (dynamic_invariant r97s true false true true)
  ...
  (and
  (=> (<= 0 r97s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r97s) (<= r97s 199))))
  (exists
  ...
  (= ctx__split_fields4 (us_split_fieldsqtmk
                        (rec__ada___keccak__keccak_1600__sponge__context__state
                        ctx__split_fields3)
                        (temp_____aggregate_def_1108 #x00)
                        (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
                        ctx__split_fields3)
                        (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
                        ctx__split_fields3)
  ...
  (=> (= (- o 1) r102s)
  (=> (dynamic_invariant r102s true false true true)
  (forall ((o1 Int))
  (=>
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
  ...
  (=> (= (- o1 1) r105s)
  (=> (dynamic_invariant r105s true false true true)
  (=>
  (=> (<= 0 r105s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r105s) (<= r105s 199))))
  (let ((ada___keccak__padding__pad101_multi_blocks__next_block__compl 
  (of_array next_block 0 r105s)))
  (=>
  (=> (<= 0 r102s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r102s) (<= r102s 199))))
  (let ((ada___keccak__padding__pad101_multi_blocks__first_block__compl 
  (of_array
  (rec__ada___keccak__keccak_1600__sponge__context__block ctx__split_fields1)
  0 r102s)))
  (forall ((o2 integer))
  (=>
  (= (to_rep o2) (last1
                 ada___keccak__padding__pad101_multi_blocks__next_block__compl))
  (forall ((o3 integer))
  (=>
  (= (to_rep o3) (first1
                 ada___keccak__padding__pad101_multi_blocks__next_block__compl))
  ...
  (= (to_rep o8) (first1
                 ada___keccak__padding__pad101_multi_blocks__first_block__compl))
  (forall ((spilled Bool)
  (ada___keccak__padding__pad101_multi_blocks__next_block (Array Int byte))
  (ada___keccak__padding__pad101_multi_blocks__first_block (Array Int byte)))
  (=> (= (= spilled true) (< o5 (+ o6 2)))
  (let ((temp___1118 (of_array
                     ada___keccak__padding__pad101_multi_blocks__first_block
                     (first1
                     ada___keccak__padding__pad101_multi_blocks__first_block__compl)
                     (last1
                     ada___keccak__padding__pad101_multi_blocks__first_block__compl))))
  ...
  (ite (and (<= 0 temp___1121) (<= temp___1121 r102s))
  (= (select usf temp___1121) (select (to_array
                                      (of_array
                                      (slide1 (to_array temp___1118)
                                      (first1 temp___1118) 0) 0 r102s)) temp___1121))
  (= (select usf temp___1121) (select (rec__ada___keccak__keccak_1600__sponge__context__block
                                      ctx__split_fields1) temp___1121))))
  (forall ((ctx__split_fields2 us_split_fields))
  (=>
  (= ctx__split_fields2 (us_split_fieldsqtmk
                        (rec__ada___keccak__keccak_1600__sponge__context__state
                        ctx__split_fields1) usf
                        (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
                        ctx__split_fields1)
                        (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
                        ctx__split_fields1)
                        ...
                        (rec__ada___keccak__keccak_1600__sponge__context__curr_state
                        ctx__split_fields1)))
  (let ((temp___1127 (of_array
                     ada___keccak__padding__pad101_multi_blocks__next_block
                     (first1
                     ada___keccak__padding__pad101_multi_blocks__next_block__compl)
                     (last1
                     ada___keccak__padding__pad101_multi_blocks__next_block__compl))))
  (forall ((usf1 (Array Int byte)))
  (=>
  (forall ((temp___1129 Int))
  (ite (and (<= 0 temp___1129) (<= temp___1129 r105s))
  (= (select usf1 temp___1129) (select (to_array
                                       (of_array
                                       (slide1 (to_array temp___1127)
                                       (first1 temp___1127) 0) 0 r105s)) temp___1129))
  (= (select usf1 temp___1129) (select next_block temp___1129))))
  (forall ((next_block1 (Array Int byte)))
  (=> (= next_block1 usf1)
  (forall ((o9 Int))
  (=>
  (= (to_rep6
  ...
  (=> (= (- o9 1) r108s)
  (=> (dynamic_invariant r108s true false true true)
  (let ((o10 (us_repqtmk ctx__split_fields2)))
  (let ((o11 (rate_of o10)))
  (=>
  ...
  (= o11 (* (to_rep6
            (rec__ada___keccak__keccak_1600__sponge__context__rate
            ctx__split_fields2)) 8))
  (< o11 1600))))
  (=>
  (=> (<= 0 r108s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r108s) (<= r108s 199))))
  (forall
  ((ada___keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a map1))
  ...
  (and (= spark__branch1 spilled)
  (ite (= spark__branch1 true)
  (exists ((o12 Int))
  (and
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields4)) o12)
  (and (= (- o12 1) r111s)
  (and (dynamic_invariant r111s true false true true)
  (let ((o13 (us_repqtmk ctx__split_fields4)))
  (let ((o14 (rate_of o13)))
  (and
  (and (rate_of__function_guard o14 o13)
  ...
  (and
  (=> (<= 0 r111s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r111s) (<= r111s 199))))
  (exists
  ...
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields5)) o12)
  (=> (= (- o12 1) r114s)
  (=> (dynamic_invariant r114s true false true true)
  (=>
  (=> (<= 0 r114s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r114s) (<= r114s 199))))
  (let ((ada___keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl 
  (of_array
  (rec__ada___keccak__keccak_1600__sponge__context__block ctx__split_fields5)
  0 r114s)))
  (forall ((o13 integer))
  (=>
  (= (to_rep o13) (last1
