...
(define-fun length ((a us_t)) Int (ite (bvule (first1 a) (last2 a))
                                  (+ (- (ubv_to_int (last2 a)) (ubv_to_int (first1 a))) 1)
                                  0))
...
;; defqtvc
 ;; File "fail.adb", line 4, characters 0-0
  ...
  (let ((temp___216 (fail__create__r__aggregate_def (distinct 0 0)
                    #x0000000000000000 last)))
  (=> (= (first1 temp___216) #x0000000000000000)
  (=> (= (last2 temp___216) last)
  (=> (bvule (first1 temp___216) (last2 temp___216))
