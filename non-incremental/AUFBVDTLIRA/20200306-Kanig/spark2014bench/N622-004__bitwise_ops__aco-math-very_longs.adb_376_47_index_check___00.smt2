...
(define-fun dynamic_invariant4 ((temp___expr_852 Int)
...
(declare-datatypes ((s121b__ref 0))
(((s121b__refqtmk (s121b__content us_t)))))
(define-fun s121b__ref_s121b__content__projection ((a s121b__ref)) us_t 
  (s121b__content a))

(declare-datatypes ((t124b__ref 0))
(((t124b__refqtmk (t124b__content us_t)))))
(define-fun t124b__ref_t124b__content__projection ((a t124b__ref)) us_t 
  (t124b__content a))

(declare-fun temp_____aggregate_def_1534 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1536 (_ BitVec 8)))
  (forall ((temp___1537 Int) (temp___1538 Int))
  (let ((temp___1535 (temp_____aggregate_def_1534 temp___1536 temp___1537
                     temp___1538)))
  (=> (dynamic_invariant2 temp___1536 true true true true)
  (and
  (=> (dynamic_property 1 2147483647 temp___1537 temp___1538)
  (and (= (first1 temp___1535) temp___1537)
  (= (last1 temp___1535) temp___1538)))
  (forall ((temp___1539 Int))
  (= (to_rep2 (select (to_array temp___1535) temp___1539)) temp___1536))))))))
...
(define-fun dynamic_invariant6 ((temp___expr_917 us_t)
  (temp___is_init_913 Bool) (temp___skip_constant_914 Bool)
  (temp___do_toplevel_915 Bool)
  (temp___do_typ_inv_916 Bool)) Bool (=>
                                     (not (= temp___skip_constant_914 true))
                                     (and (dynamic_property 1 r122b
                                     (first1 temp___expr_917)
                                     (last1 temp___expr_917))
                                     (and (= (first1 temp___expr_917) 1)
                                     (= (last1 temp___expr_917) r122b)))))

(define-fun default_initial_assumption ((temp___expr_919 us_t)
  (temp___skip_top_level_920 Bool)) Bool (and (= (first1 temp___expr_919) 1)
                                         (= (last1 temp___expr_919) r122b)))

(assert
;; defqtvc
 ;; File "aco-math-very_longs.adb", line 359, characters 0-0
  (not
  (forall ((result____split_fields us_t) (new_overflow (_ BitVec 8))
  (overflow_mask (_ BitVec 8)) (old_overflow (_ BitVec 8))
  (ada___ada___aco__math__very_longs__divide__full_left_shift__R122b__assume Int))
  ...
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     result____split_discrs)) ada___ada___aco__math__very_longs__divide__full_left_shift__R122b__assume)
  (=>
  (= ada___ada___aco__math__very_longs__divide__full_left_shift__R122b__assume 
  r122b)
  (=> (dynamic_invariant3 r122b true false true true)
  (let ((temp___1540 (temp_____aggregate_def_1534 #x00 1 r122b)))
  (=> (= (first1 temp___1540) 1)
  (=> (= (last1 temp___1540) r122b)
  (=>
  (ite (<= (first1 temp___1540) (last1 temp___1540))
  (and (<= 1 r122b)
  (= (- (last1 temp___1540) (first1 temp___1540)) (- r122b 1))) (< r122b 1))
  (let ((temp___1542 (of_array (to_array temp___1540) (first1 temp___1540)
                     (last1 temp___1540))))
  (=>
  (ite (<= (first1 temp___1542) (last1 temp___1542))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1542) (first1 temp___1542)) (- (last1
  ...
  (=>
  (= result____split_fields1 (of_array (to_array temp___1542)
  ...
  (=>
  (let ((temp___1548 (last1
                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 number)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1548) true false)) true)
  (exists ((result____split_fields3 us_t) (old_overflow2 (_ BitVec 8))
  (new_overflow1 (_ BitVec 8)) (i1 Int))
  (and
  (= (and (ite (and
               (and
               (and (dynamic_invariant2 old_overflow2 true true true true)
               (dynamic_invariant
               (us_repqtmk result____split_discrs
               (us_split_fieldsqtmk result____split_fields3)) false true true
               true))
               (forall ((temp___1561 Int))
               (=>
               (and (<= (first1 result____split_fields3) temp___1561)
               (<= temp___1561 (last1 result____split_fields3)))
               (=>
               (or (< temp___1548 temp___1561)
               (or (< temp___1561 1) (<= i1 temp___1561)))
               (= (select (to_array result____split_fields3) temp___1561) (select 
               (to_array result____split_fields1) temp___1561))))))
          ...
          true false) (ite (and (<= 1 i1)
                      ...
                      true false)) true)
  (let ((o1 (- 8 distance)))
  (let ((temp___1549 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 number))))
  (and (and (<= (first1 temp___1549) i1) (<= i1 (last1 temp___1549)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1549) i1)) o2)
  ...
  (and
  (ite (< distance 8)
  (let ((temp___1550 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 number))))
  ...
  (exists ((result____split_fields4 us_t))
  (and
  (= result____split_fields4 (us_tqtmk
                             (store (to_array result____split_fields3) i1 o6)
                             (rt result____split_fields3)))
  (and
  (and (<= (first1 result____split_fields4) i1)
  (<= i1 (last1 result____split_fields4)))
  (exists ((o7 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array result____split_fields4) i1)) o7)
  (exists ((o8 octet))
  (and (= (to_rep2 o8) (bvor o7 old_overflow2))
  (and
  (and (<= (first1 result____split_fields4) i1)
  (<= i1 (last1 result____split_fields4)))
  (and
  (= result____split_fields2 (us_tqtmk
                             (store (to_array result____split_fields4) i1 o8)
                             (rt result____split_fields4)))
  (and (= old_overflow1 new_overflow2) (= i1 temp___1548))))))))))))))))))))))))))))
  (and (= result____split_fields2 result____split_fields1)
  (= old_overflow1 old_overflow))))))
  (forall ((o1 octet))
