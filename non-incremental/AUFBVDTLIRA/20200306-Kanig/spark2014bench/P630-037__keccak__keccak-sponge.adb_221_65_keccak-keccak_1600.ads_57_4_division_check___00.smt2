...
;; defqtvc
 ;; File "keccak-sponge.ads", line 175, characters 0-0
  ...
  (and (< (first1 message) message_last1)
  (and (= (- message_last1 1) r88s)
  (and (dynamic_invariant2 r88s true false true true)
  (let ((o7 (- bit_length (mod2 bit_length 8))))
  (and (in_range1 o7)
  (and (in_range2 o7)
  (let ((temp___938 (first1 message)))
  (and
  (=> (<= temp___938 r88s)
  (and (and (<= (first1 message) temp___938) (<= temp___938 (last1 message)))
  (and (<= (first1 message) r88s) (<= r88s (last1 message)))))
  (and
  (and
  ...
  (=> (= (to_rep1 (select (to_array message) message_last1)) o9)
  (forall ((o10 byte))
  ...
  (let ((o11 (+ (mod2 bit_length 8) suffix_len)))
  (=> (in_range1 o11)
  (forall ((ctx__split_fields2 us_split_fields))
  (=>
  ...
  (= (rate_of (us_repqtmk ctx__split_fields2)) (rate_of
                                               (us_repqtmk
                                               ctx__split_fields1))))
  (= (mod2 (in_queue_bit_length (us_repqtmk ctx__split_fields2)) 8) (mod2 o11
                                                                    8)))
  (< (in_queue_bit_length (us_repqtmk ctx__split_fields2)) (rate_of
                                                           (us_repqtmk
                                                           ctx__split_fields2))))
  (let ((o12 (us_repqtmk ctx__split_fields2)))
  (let ((o13 (rate_of o12)))
  (=>
  ...
  (< o13 1600))))
  (let ((o14 (us_repqtmk ctx__split_fields2)))
  (let ((o15 (rate_of o14)))
  (=>
  (and (rate_of__function_guard o15 o14)
  (and (dynamic_invariant1 o15 true false true true)
  (and
  (= o15 (* (to_rep6
            (rec__ada___keccak__keccak_1600__sponge__context__rate
            ctx__split_fields2)) 8))
  (< o15 1600))))
  (let ((o16 (us_repqtmk ctx__split_fields2)))
  (let ((o17 (in_queue_bit_length o16)))
  (=>
  (and (in_queue_bit_length__function_guard o17 o16)
  (and (dynamic_invariant o17 true false true true)
  (and
  (= o17 (to_rep5
         (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
         ctx__split_fields2)))
  (< o17 1600))))
  (=> (in_range1 (+ bit_length suffix_len))
  (let ((o18 (us_repqtmk ctx__split_fields2)))
  (let ((o19 (in_queue_bit_length o18)))
  (=>
  (and (in_queue_bit_length__function_guard o19 o18)
  (and (dynamic_invariant o19 true false true true)
  (and
  (= o19 (to_rep5
         (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
         ctx__split_fields2)))
