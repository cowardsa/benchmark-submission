...
;; defqtvc
 ;; File "counter.ads", line 19, characters 0-0
  (not
  (forall ((inputs (Array (_ BitVec 8) Bool)) (res (_ BitVec 8)) (o Bool)
  (res1 (_ BitVec 8)) (temp___202 (_ BitVec 8)))
  (=> (= res #x00)
  ...
  (=>
  (forall ((i (_ BitVec 8)))
  (=> (and (bvule (bvsub #x0A res1) i) (bvule i #x0A))
  (= (select inputs i) true)))
  (=>
  (= (and (ite (dynamic_invariant res1 true true true true) true false) 
  (ite (and (bvult res1 #x0A) (= (select inputs (bvsub #x0A res1)) true))
  true false)) true)
  (=> (= temp___202 res1)
  (let ((o1 (bvadd res1 #x01)))
  (=> (in_range1 o1)
  (forall ((res2 (_ BitVec 8)))
  (=> (= res2 o1)
  (forall ((o2 Bool))
  (=>
  (ite (bvult res2 #x0A)
  (let ((temp___203 (bvsub #x0A res2)))
  (and (and (bvule #x01 temp___203) (bvule temp___203 #x0A))
