...
;; defqtvc
 ;; File "foo.adb", line 127, characters 0-0
  ...
  (=> (= octet_count1 o3)
  (forall ((o4 Int))
  (=> (= (to_rep1 data__last) o4)
  (forall ((o5 Int))
  (=> (= (to_rep1 data__first) o5)
  (let ((o6 (length o5 o4)))
  (=> (in_range1 o6)
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (< o6 octet_count1) true false))
  (=> (= spark__branch true)
  (forall ((o7 Int))
  (=> (= (to_rep1 data__last) o7)
  (forall ((o8 Int))
  (=> (= (to_rep1 data__first) o8) (in_range2 (length o8 o7))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
