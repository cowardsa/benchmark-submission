...
(((us_split_fieldsqtmk
  (rec__timestamp_messages__request__placeholder integer)))))
(define-fun us_split_fields_rec__timestamp_messages__request__placeholder__projection ((a us_split_fields)) integer 
  (rec__timestamp_messages__request__placeholder a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep
                           (rec__timestamp_messages__request__placeholder
...
(declare-const timestamp_messages__request__placeholder__first__bit Int)

(declare-const timestamp_messages__request__placeholder__last__bit Int)

(declare-const timestamp_messages__request__placeholder__position Int)

;; timestamp_messages__request__placeholder__first__bit_axiom
  (assert (<= 0 timestamp_messages__request__placeholder__first__bit))

;; timestamp_messages__request__placeholder__last__bit_axiom
  (assert
  (< timestamp_messages__request__placeholder__first__bit timestamp_messages__request__placeholder__last__bit))

;; timestamp_messages__request__placeholder__position_axiom
  (assert (<= 0 timestamp_messages__request__placeholder__position))

(declare-fun user_eq4 (us_rep us_rep) Bool)

(declare-const dummy4 us_rep)

(declare-datatypes ((request__ref 0))
(((request__refqtmk (request__content us_rep)))))
(define-fun request__ref_request__content__projection ((a request__ref)) us_rep 
  (request__content a))

(declare-const req us_rep)
...
(define-fun dynamic_invariant2 ((temp___expr_161 (_ BitVec 8))
  (temp___is_init_157 Bool) (temp___skip_constant_158 Bool)
  (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool true)

(define-fun dynamic_invariant3 ((temp___expr_168 us_t)
