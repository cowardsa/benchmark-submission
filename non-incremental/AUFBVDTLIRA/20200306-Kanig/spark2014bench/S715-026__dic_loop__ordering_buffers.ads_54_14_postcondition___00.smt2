 ...
 ;; File "ordering_buffers.ads", line 49, characters 0-0
  ...
  (= o3 (to_rep1
        (select (rec__ordering_buffers__ordering_buffer_type__ring
                buffer__split_fields) ((_ int_to_bv 8) (mod2 o1 256)))))))
  (forall ((message1 Int))
  (=> (= message1 o3)
  (let ((o4 orig_first))
  (=> (in_range4 o4)
  ...
  (us_repqtmk buffer__split_fields3)))
  (=>
  (forall ((o5 Int) (buffer__split_fields3 us_split_fields))
  (get_message__function_guard
  (get_message (us_repqtmk buffer__split_fields3) o5)
  (us_repqtmk buffer__split_fields3) o5))
  (=>
  (forall ((buffer__split_fields3 us_split_fields)) (first__function_guard
  (first (us_repqtmk buffer__split_fields3))
  (us_repqtmk buffer__split_fields3)))
  ...
  (us_repqtmk buffer__split_fields3)))
  (=>
  (forall ((buffer__split_fields3 us_split_fields) (i Int))
  (get_message__function_guard
  (get_message (us_repqtmk buffer__split_fields3) i)
  (us_repqtmk buffer__split_fields3) i))
  (=>
  (forall ((buffer__split_fields3 us_split_fields) (i Int))
  (get_message__function_guard
  (get_message (us_repqtmk buffer__split_fields3) i)
  ...
  (= (first (us_repqtmk buffer__split_fields2)) (first
                                                (us_repqtmk
                                                buffer__split_fields)))
  (= (get_message (us_repqtmk buffer__split_fields2) o4) 0))
  (forall ((i Int))
  (=>
  (and (<= (first (us_repqtmk buffer__split_fields2)) i)
  (<= i (last (us_repqtmk buffer__split_fields2))))
  (=> (not (= i o4))
  (= (get_message (us_repqtmk buffer__split_fields2) i) (get_message
                                                        (us_repqtmk
                                                        buffer__split_fields)
                                                        i))))))
  (=>
  ...
  (forall ((buffer__split_fields3 us_split_fields))
  (=>
  (forall ((buffer__split_fields4 us_split_fields)) (first__function_guard
  (first (us_repqtmk buffer__split_fields4))
  (us_repqtmk buffer__split_fields4)))
  (=>
  (forall ((buffer__split_fields4 us_split_fields)) (first__function_guard
  (first (us_repqtmk buffer__split_fields4))
  (us_repqtmk buffer__split_fields4)))
  ...
  (us_repqtmk buffer__split_fields4)))
  (=>
  (forall ((buffer__split_fields4 us_split_fields)) (last__function_guard
  (last (us_repqtmk buffer__split_fields4))
  (us_repqtmk buffer__split_fields4)))
  (=>
  (forall ((buffer__split_fields4 us_split_fields) (index Int))
  (get_message__function_guard
  (get_message (us_repqtmk buffer__split_fields4) index)
  (us_repqtmk buffer__split_fields4) index))
  (=>
  (forall ((buffer__split_fields4 us_split_fields) (index Int))
  (get_message__function_guard
  (get_message (us_repqtmk buffer__split_fields4) index)
  ...
  (us_repqtmk buffer__split_fields4)))
  (=>
  (forall ((buffer__split_fields4 us_split_fields))
  (has_message__function_guard
  (has_message (us_repqtmk buffer__split_fields4)
  (last (us_repqtmk buffer__split_fields4)))
  (us_repqtmk buffer__split_fields4)
  (last (us_repqtmk buffer__split_fields4))))
  (=>
  (and
  (and
  (= (first (us_repqtmk buffer__split_fields3)) (+ (first
                                                   (us_repqtmk
                                                   buffer__split_fields2)) 1))
  (forall ((index Int))
  (=>
  (and (<= (first (us_repqtmk buffer__split_fields3)) index)
  (<= index (- (last (us_repqtmk buffer__split_fields3)) 1)))
  (= (get_message (us_repqtmk buffer__split_fields3) index) (get_message
                                                            (us_repqtmk
  ...
  (last (us_repqtmk buffer__split_fields4))
  (us_repqtmk buffer__split_fields4)))
  (=> (= (last (us_repqtmk buffer__split_fields3)) (+ orig_first 16))
  (=>
  (forall ((buffer__split_fields4 us_split_fields)) (last__function_guard
  (last (us_repqtmk buffer__split_fields4))
  (us_repqtmk buffer__split_fields4)))
  (=>
  (= ((_ int_to_bv 8) (mod2 (last (us_repqtmk buffer__split_fields3)) 256)) ((_ int_to_bv 8) 
  (mod2 (+ orig_first 16) 256)))
  (=>
  (= ((_ int_to_bv 8) (mod2 (+ orig_first 16) 256)) ((_ int_to_bv 8) (mod2
                                                               orig_first
                                                               256)))
  (=>
  (forall ((buffer__split_fields4 us_split_fields)) (last__function_guard
  ...
  (forall ((buffer__split_fields4 us_split_fields))
  (has_message__function_guard
  (has_message (us_repqtmk buffer__split_fields4) orig_first)
  (us_repqtmk buffer__split_fields4) orig_first))
  (=>
  (forall ((buffer__split_fields4 us_split_fields)) (last__function_guard
  (last (us_repqtmk buffer__split_fields4))
  (us_repqtmk buffer__split_fields4)))
  ...
  (last (us_repqtmk buffer__split_fields4))))
  (=>
  (= (= (has_message (us_repqtmk buffer__split_fields3) orig_first) true)
  (= (has_message (us_repqtmk buffer__split_fields3)
     (last (us_repqtmk buffer__split_fields3))) true))
  (=>
  (forall ((buffer__split_fields4 us_split_fields)) (first__function_guard
