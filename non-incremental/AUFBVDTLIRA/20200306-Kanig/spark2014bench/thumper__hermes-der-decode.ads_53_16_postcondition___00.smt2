...
(declare-datatypes ((length_of_length_type__ref 0))
...
;; defqtvc
 ;; File "hermes-der-decode.ads", line 44, characters 0-0
  (not
  (forall ((stop Int) (length1 Int) (status Int) (length_of_length Int)
  (stop1 Int))
  ...
  (=> (dynamic_invariant length1 false false true true)
  (=> (dynamic_invariant2 status false false true true)
  (=> (<= (first1 message) start)
  (=> (<= start (last1 message))
  (=> (dynamic_invariant1 length_of_length false false true true)
  (=> (<= (first1 message) start)
  (=> (<= start (last1 message))
  (=>
  (exists ((o (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) start)) o)
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (= o #x80) true false))
  (ite (= spark__branch true) (= stop1 start)
  (and (and (<= (first1 message) start) (<= start (last1 message)))
  (exists ((o1 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) start)) o1)
  (exists ((spark__branch1 Bool))
  (and (= spark__branch1 (ite (= (bvand o1 #x80) #x00) true false))
  (ite (= spark__branch1 true)
  (and (= stop1 start)
  (and (and (<= (first1 message) start) (<= start (last1 message)))
  (exists ((o2 (_ BitVec 8)))
  (= (to_rep1 (select (to_array message) start)) o2))))
  (and (and (<= (first1 message) start) (<= start (last1 message)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) start)) o2)
  (exists ((spark__branch2 Bool))
  (and (= spark__branch2 (ite (= o2 #xFF) true false))
  (ite (= spark__branch2 true) (= stop1 start)
  (and (bvuge (bvsub (to_rep1 (select (to_array message) start)) #x80) #x01)
  (and (not (= (to_rep1 (select (to_array message) start)) #x00))
  (and (and (<= (first1 message) start) (<= start (last1 message)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) start)) o3)
  (let ((o4 (ubv_to_int (bvand o3 #x7F))))
  (and (in_range3 o4)
  (exists ((length_of_length1 Int))
  (and (= length_of_length1 o4)
  (let ((o5 (- (last1 message) length_of_length1)))
  (and (in_range1 o5)
  (exists ((spark__branch3 Bool))
  (and (= spark__branch3 (ite (< o5 start) true false))
  (ite (= spark__branch3 true)
  (let ((o6 (last1 message))) (and (in_range2 o6) (= stop1 o6)))
  (let ((o6 (+ start 1)))
  (and (in_range1 o6)
  (and (and (<= (first1 message) o6) (<= o6 (last1 message)))
  (exists ((o7 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) o6)) o7)
  ...
  (let ((o8 (+ start length_of_length1))) (and (in_range1 o8) (= stop1 o8)))
  (let ((o8 (+ start length_of_length1)))
  (and (in_range1 o8)
  (and (= stop1 o8)
  (let ((o9 (+ start 1)))
  (and (in_range1 o9)
  (let ((o10 (convert_length o9 length_of_length1)))
  (and (convert_length__function_guard o10 o9 length_of_length1)
