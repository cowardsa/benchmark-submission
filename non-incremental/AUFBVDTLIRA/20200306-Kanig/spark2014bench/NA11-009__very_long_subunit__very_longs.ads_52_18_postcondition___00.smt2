...
(declare-fun temp_____aggregate_def_1023 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1025 (_ BitVec 8)))
  (forall ((temp___1026 Int) (temp___1027 Int))
  (let ((temp___1024 (temp_____aggregate_def_1023 temp___1025 temp___1026
                     temp___1027)))
  (=> (dynamic_invariant1 temp___1025 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1026 temp___1027)
  (and (= (first1 temp___1024) temp___1026)
  (= (last1 temp___1024) temp___1027)))
  (forall ((temp___1028 Int))
  (= (to_rep2 (select (to_array temp___1024) temp___1028)) temp___1025))))))))
...
;; defqtvc
 ;; File "very_longs.ads", line 49, characters 0-0
  ...
  (let ((temp___1029 (temp_____aggregate_def_1023 #x00 1 o1)))
  (=> (= (first1 temp___1029) 1)
  (=>
  (= (last1 temp___1029) (to_rep
                         (rec__very_longs__very_long__length
                         (us_split_discrs1 l))))
  (=>
  (ite (<= (first1 temp___1029) (last1 temp___1029))
  (and
  (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))
  (= (- (last1 temp___1029) (first1 temp___1029)) (- (to_rep
                                                     (rec__very_longs__very_long__length
                                                     (us_split_discrs1 l))) 1)))
  (< (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1))
  (let ((temp___1031 (of_array (to_array temp___1029) (first1 temp___1029)
                     (last1 temp___1029))))
  (=>
  (ite (<= (first1 temp___1031) (last1 temp___1031))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1031) (first1 temp___1031)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1031)
  (forall ((borrow1 (_ BitVec 16)))
  (=> (= borrow1 #x0000)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1036 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1036) true false)) true)
  ...
  (= (and (ite (and
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1037 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1037) i1) (<= i1 (last1 temp___1037)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1037) i1)) o2)
  (exists ((l_digit2 (_ BitVec 16)))
  (and (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1038 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1038) i1) (<= i1 (last1 temp___1038)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1038) i1)) o3)
