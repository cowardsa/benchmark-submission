...
;; defqtvc
 ;; File "hermes-der-decode.ads", line 44, characters 0-0
  ...
  (o (_ BitVec 8)) (spark__branch Bool) (o1 (_ BitVec 8))
  (spark__branch1 Bool) (o2 (_ BitVec 8)) (spark__branch2 Bool)
  (o3 (_ BitVec 8)))
  ...
  (=> (= spark__branch (ite (= o #x80) true false))
  (=> (not (= spark__branch true))
  (=> (<= (first1 message) start)
  (=> (<= start (last1 message))
  (=> (= (to_rep1 (select (to_array message) start)) o1)
  (=> (= spark__branch1 (ite (= (bvand o1 #x80) #x00) true false))
  ...
  (=> (<= (first1 message) start)
  (=> (<= start (last1 message))
  (=> (= (to_rep1 (select (to_array message) start)) o3)
  (let ((o4 (ubv_to_int (bvand o3 #x7F))))
  (=> (in_range3 o4)
  (forall ((length_of_length1 Int))
  (=> (= length_of_length1 o4)
  (let ((o5 (- (last1 message) length_of_length1)))
  (=> (in_range1 o5)
  (forall ((spark__branch3 Bool))
  (=> (= spark__branch3 (ite (< o5 start) true false))
  (=> (not (= spark__branch3 true))
  (let ((o6 (+ start 1)))
  (=> (in_range1 o6)
  (=> (and (<= (first1 message) o6) (<= o6 (last1 message)))
  (forall ((o7 (_ BitVec 8)))
  (=> (= (to_rep1 (select (to_array message) o6)) o7)
