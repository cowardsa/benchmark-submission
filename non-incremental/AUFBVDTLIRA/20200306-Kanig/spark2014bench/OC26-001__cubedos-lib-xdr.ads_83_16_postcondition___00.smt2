...
(declare-datatypes ((xdr_unsigned__ref 0))
...
(assert
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 70, characters 0-0
  (not
  (forall ((data (Array Int octet)) (last2 Int) (temporary_2 (_ BitVec 32))
  (temporary_1 (_ BitVec 32)) (i Int) (temporary_21 (_ BitVec 32)) (o octet))
  ...
  (=> (<= (+ position 3) (to_rep data__last))
  (=> (= temporary_1 value)
  (=> (dynamic_invariant temporary_1 true false true true)
  (=> (dynamic_invariant temporary_2 false false true true)
  (=> (= i 1)
  (=> (= temporary_21 (bvurem temporary_1 #x00000100))
  (=> (= (to_rep1 o) ((_ extract 7 0) temporary_21))
  (let ((temp___522 (+ position (- 4 i))))
  (=>
  (and (<= (to_rep data__first) temp___522)
  (<= temp___522 (to_rep data__last)))
  (forall ((data1 (Array Int octet)))
  (=> (= data1 (store data temp___522 o))
  (forall ((temporary_11 (_ BitVec 32)))
  (=> (= temporary_11 (bvudiv temporary_1 #x00000100))
  (forall ((i1 Int))
  (=> (= i1 2)
  (forall ((temporary_22 (_ BitVec 32)))
  (=> (= temporary_22 (bvurem temporary_11 #x00000100))
  (forall ((o1 octet))
  (=> (= (to_rep1 o1) ((_ extract 7 0) temporary_22))
  (let ((temp___5221 (+ position (- 4 i1))))
  (=>
  (and (<= (to_rep data__first) temp___5221)
  (<= temp___5221 (to_rep data__last)))
  (forall ((data2 (Array Int octet)))
  (=> (= data2 (store data1 temp___5221 o1))
  (forall ((temporary_12 (_ BitVec 32)))
  (=> (= temporary_12 (bvudiv temporary_11 #x00000100))
  (forall ((i2 Int))
  (=> (= i2 3)
  (forall ((temporary_23 (_ BitVec 32)))
  (=> (= temporary_23 (bvurem temporary_12 #x00000100))
  (forall ((o2 octet))
  (=> (= (to_rep1 o2) ((_ extract 7 0) temporary_23))
  (let ((temp___5222 (+ position (- 4 i2))))
  (=>
  (and (<= (to_rep data__first) temp___5222)
  (<= temp___5222 (to_rep data__last)))
  (forall ((data3 (Array Int octet)))
  (=> (= data3 (store data2 temp___5222 o2))
  (forall ((temporary_13 (_ BitVec 32)))
  (=> (= temporary_13 (bvudiv temporary_12 #x00000100))
  (forall ((i3 Int))
  (=> (= i3 4)
  (forall ((temporary_24 (_ BitVec 32)))
  (=> (= temporary_24 (bvurem temporary_13 #x00000100))
  (forall ((o3 octet))
  (=> (= (to_rep1 o3) ((_ extract 7 0) temporary_24))
  (let ((temp___5223 (+ position (- 4 i3))))
  (=>
  (and (<= (to_rep data__first) temp___5223)
  (<= temp___5223 (to_rep data__last)))
  (let ((o4 (+ position 3)))
  (=> (in_range2 o4)
