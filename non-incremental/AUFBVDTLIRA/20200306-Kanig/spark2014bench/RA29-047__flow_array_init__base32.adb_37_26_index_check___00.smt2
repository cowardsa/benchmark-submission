...
;; defqtvc
 ;; File "base32.ads", line 59, characters 0-0
  (not
  (forall ((decoded_string (Array Int character)))
  ...
  (of_array decoded_string (to_rep1 decoded_string__first)
  (to_rep1 decoded_string__last)) false)
  (=>
  (and (dynamic_property 1 (length (to_rep1 b__first) (to_rep1 b__last))
  (to_rep1 decoded_string__first) (to_rep1 decoded_string__last))
  (and (= (to_rep1 decoded_string__first) 1)
  (= (to_rep1 decoded_string__last) (length (to_rep1 b__first)
                                    (to_rep1 b__last)))))
  (forall ((temp___287 Int))
  (=> (= (to_rep1 decoded_string__last) temp___287)
  (forall ((i Int))
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___287) true false)) true)
  (forall ((decoded_string1 (Array Int character)) (i1 Int))
  (=>
  (= (and (ite (forall ((temp___290 Int))
               (=>
               (and (<= (to_rep1 decoded_string__first) temp___290)
               (<= temp___290 (to_rep1 decoded_string__last)))
               (=>
               (or (< temp___287 temp___290)
               (or (< temp___290 1) (<= i1 temp___290)))
               (= (select decoded_string1 temp___290) (select decoded_string temp___290)))))
          true false) (ite (and (<= 1 i1)
                           (<= i1 (to_rep1 decoded_string__last)))
                      true false)) true)
  (forall ((o1 character))
