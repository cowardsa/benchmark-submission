...
;; defqtvc
 ;; File "network-addresses.ads", line 37, characters 0-0
  ...
  (text (Array Int character)) (count1 Int) (count2 Int))
  (=>
  ...
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i 4) true false)) true)
  (and (in_range1 (* 4 (- i 1)))
  (and (in_range1 (* 2 (- i 1)))
  (exists ((text1 (Array Int character)) (index1 Int) (count3 Int)
  (skip1 Int) (value1 (_ BitVec 8)) (digit_21 Int) (digit_11 Int)
  (digit_01 Int) (i1 Int))
  (and (and (<= (* 2 (- i1 1)) count3) (<= count3 (* 4 (- i1 1))))
  (and
  (= (and (ite (and
               (and
               (and
               ...
               (dynamic_invariant count3 false true true true))
  ...
  (and (= (to_rep1 (select address i1)) o1)
  (exists ((value2 (_ BitVec 8)))
  (and (= value2 o1)
  (exists ((o2 Int))
  (and (= (to_rep2 (select digit_lookup_table (bvudiv value2 #x64))) o2)
  (exists ((digit_22 Int))
  (and (= digit_22 o2)
  (exists ((value3 (_ BitVec 8)))
  (and (= value3 (bvurem value2 #x64))
  (let ((temp___349 (bvudiv value3 #x0A)))
  (and (and (bvule #x00 temp___349) (bvule temp___349 #x09))
  (exists ((o3 Int))
  (and (= (to_rep2 (select digit_lookup_table temp___349)) o3)
  (exists ((digit_12 Int))
  (and (= digit_12 o3)
  (exists ((value4 (_ BitVec 8)))
  (and (= value4 (bvurem value3 #x0A))
  (and (and (bvule #x00 value4) (bvule value4 #x09))
  (exists ((o4 Int))
  (and (= (to_rep2 (select digit_lookup_table value4)) o4)
  (exists ((digit_02 Int))
  (and (= digit_02 o4)
  (exists ((spark__branch Bool) (text2 (Array Int character)) (skip2 Int))
  (and
  ...
  (and
  (exists ((spark__branch1 Bool))
  (and (= spark__branch1 (ite (= i1 4) false true))
  (ite (= spark__branch1 true)
  (exists ((o5 character))
  (and (= (to_rep o5) 46)
  (let ((temp___353 (+ index2 skip2)))
  (and (and (<= 1 temp___353) (<= temp___353 15))
  (let ((o6 (+ skip2 1))) (and (in_range9 o6) (= skip3 o6)))))))
  (= skip3 skip2))))
  (and (ite (< i1 4) (<= skip3 4) (<= skip3 3))
  (let ((o5 (+ count3 skip3)))
