...
;; defqtvc
 ;; File "very_longs.ads", line 41, characters 0-0
  ...
  (let ((temp___1008 (of_array (to_array temp___1006) (first1 temp___1006)
                     (last1 temp___1006))))
  (=>
  (ite (<= (first1 temp___1008) (last1 temp___1008))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1008) (first1 temp___1008)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1008)
  (forall ((carry1 (_ BitVec 16)))
  (=> (= carry1 #x0000)
  (let ((temp___1013 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (forall ((i Int))
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1013) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___1025)
               (<= temp___1025 (last1 result____split_fields2)))
               (=>
               (or (< temp___1013 temp___1025)
               (or (< temp___1025 1) (<= i1 temp___1025)))
               (= (select (to_array result____split_fields2) temp___1025) (select 
               (to_array result____split_fields1) temp___1025))))))
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  (rec__very_longs__very_long__long_digits
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1014 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1014) i1) (<= i1 (last1 temp___1014)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1014) i1)) o2)
