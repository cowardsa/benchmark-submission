...
(define-fun to_int2 ((x my_index)) Int (ubv_to_int (to_rep x)))
...
;; defqtvc
 ;; File "fail.adb", line 3, characters 0-0
  (not
  (let ((fail__c__assume (create #xFFFFFFFFFFFFFFFF)))
  (=>
  (and (create__function_guard fail__c__assume #xFFFFFFFFFFFFFFFF)
  (and (dynamic_invariant1 fail__c__assume true false true true)
  (and (= (last1 fail__c__assume) #xFFFFFFFFFFFFFFFF)
  (= (first1 fail__c__assume) #x0000000000000000))))
  (=> (= fail__c__assume c)
