...
(define-fun in_range5 ((rec__ada___names__data__entry_tables__vector__capacity1 Int)
  (a us_split_discrs)) Bool (= rec__ada___names__data__entry_tables__vector__capacity1 
  (to_rep2 (rec__ada___names__data__entry_tables__vector__capacity a))))
...
(declare-const ada___names__data__entry_tables__vector__capacity__first__bit1 Int)

(declare-const ada___names__data__entry_tables__vector__capacity__last__bit1 Int)

(declare-const ada___names__data__entry_tables__vector__capacity__position1 Int)
...
(define-fun default_initial_assumption ((temp___expr_226 us_rep)
  (temp___skip_top_level_227 Bool)) Bool (and
                                         ...
                                         (=>
                                         (not
                                         (= temp___skip_top_level_227 true))
...
(define-fun last2 ((container us_rep1)) Int (+ 0 (length1 container)))
...
(define-fun us_split_discrs_rec__ada___names__data__char_tables__vector__capacity__projection ((a us_split_discrs2)) capacity_range1 
  (rec__ada___names__data__char_tables__vector__capacity a))
...
(((us_split_fieldsqtmk1
  (rec__ada___names__data__char_tables__vector us_main_type2)))))
(define-fun us_split_fields_rec__ada___names__data__char_tables__vector__projection ((a us_split_fields2)) us_main_type2 
  (rec__ada___names__data__char_tables__vector a))
...
(declare-const ada___names__data__char_tables__vector__capacity__first__bit Int)

(declare-const ada___names__data__char_tables__vector__capacity__last__bit Int)

(declare-const ada___names__data__char_tables__vector__capacity__position Int)

;; ada___names__data__char_tables__vector__capacity__first__bit_axiom
  (assert
  (<= 0 ada___names__data__char_tables__vector__capacity__first__bit))

;; ada___names__data__char_tables__vector__capacity__last__bit_axiom
  (assert
  (< ada___names__data__char_tables__vector__capacity__first__bit ada___names__data__char_tables__vector__capacity__last__bit))

;; ada___names__data__char_tables__vector__capacity__position_axiom
  (assert (<= 0 ada___names__data__char_tables__vector__capacity__position))
...
(((tchar_tableS__refqtmk (tchar_tableS__content us_rep2)))))
(define-fun tchar_tableS__ref_tchar_tableS__content__projection ((a tchar_tableS__ref)) us_rep2 
...
(define-fun in_range8 ((rec__ada___names__data__char_tables__vector__capacity1 Int)
  (a us_split_discrs2)) Bool (= rec__ada___names__data__char_tables__vector__capacity1 
  (to_rep3 (rec__ada___names__data__char_tables__vector__capacity a))))
...
(declare-const ada___names__data__char_tables__vector__capacity__first__bit1 Int)

(declare-const ada___names__data__char_tables__vector__capacity__last__bit1 Int)

(declare-const ada___names__data__char_tables__vector__capacity__position1 Int)
...
;; ada___names__data__char_tables__vector__capacity__position_axiom
  (assert (<= 0 ada___names__data__char_tables__vector__capacity__position1))
...
(((vector__refqtmk1 (vector__content1 us_rep2)))))
(define-fun vector__ref_vector__content__2__projection ((a vector__ref1)) us_rep2 
  (vector__content1 a))
...
(define-fun dynamic_invariant3 ((temp___expr_297 us_rep2)
...
(define-fun default_initial_assumption1 ((temp___expr_299 us_rep2)
  (temp___skip_top_level_300 Bool)) Bool (and
                                         (= (to_rep3
                                            (rec__ada___names__data__char_tables__vector__capacity
                                            (us_split_discrs3
                                            temp___expr_299))) 1024)
                                         (=>
                                         (not
                                         (= temp___skip_top_level_300 true))
...
;; range_axiom
  (assert
  (forall ((x positive)) (! (in_range3 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(declare-fun user_eq12 (name_id name_id) Bool)

(declare-const dummy12 name_id)
...
;; range_axiom
  (assert
  (forall ((x name_id)) (! (in_range9 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(declare-fun user_eq13 (char_table_index char_table_index) Bool)

(declare-const dummy13 char_table_index)
...
(define-fun us_split_fields_rec__ada___names__data__name_entry__table_index__projection ((a us_split_fields4)) char_table_index 
  (rec__ada___names__data__name_entry__table_index a))

(define-fun us_split_fields_rec__ada___names__data__name_entry__length__projection ((a us_split_fields4)) positive 
  (rec__ada___names__data__name_entry__length a))

(define-fun us_split_fields_rec__ada___names__data__name_entry__next_hash__projection ((a us_split_fields4)) name_id 
...
(((name_entry__refqtmk (name_entry__content us_rep3)))))
(define-fun name_entry__ref_name_entry__content__projection ((a name_entry__ref)) us_rep3 
  (name_entry__content a))

(declare-datatypes ((element_type__ref 0))
(((element_type__refqtmk (element_type__content us_rep3)))))
(define-fun element_type__ref_element_type__content__projection ((a element_type__ref)) us_rep3 
  (element_type__content a))

(declare-fun first_index__function_guard (Int us_rep) Bool)

(declare-datatypes ((element_type__ref1 0))
(((element_type__refqtmk1 (element_type__content1 us_rep3)))))
(define-fun element_type__ref_element_type__content__2__projection ((a element_type__ref1)) us_rep3 
  (element_type__content1 a))

(declare-fun get (us_rep1 Int) us_rep3)

(declare-fun get__function_guard (us_rep3 us_rep1 Int) Bool)

(define-fun element ((container us_rep)
  (index Int)) us_rep3 (get (model1 container) index))

(declare-fun element__function_guard (us_rep3 us_rep Int) Bool)

(declare-datatypes ((map__ref1 0))
(((map__refqtmk1 (map__content1 (Array (_ BitVec 32) name_id))))))
...
(define-fun bool_eq4 ((a (Array (_ BitVec 32) name_id))
  ...
  (b__last (_ BitVec 32))) Bool (ite (and
                                     ...
                                     (forall ((temp___idx_173 (_ BitVec 32)))
                                     (=>
                                     (and (bvule a__first temp___idx_173)
                                     (bvule temp___idx_173 a__last))
                                     (= (to_rep5 (select a temp___idx_173)) 
                                     (to_rep5
                                     (select b (bvadd (bvsub b__first a__first) temp___idx_173)))))))
                                true false))
...
;; bool_eq_rev
  ...
  (bvugt b__first b__last))
  (forall ((temp___idx_173 (_ BitVec 32)))
  (=> (and (bvule a__first temp___idx_173) (bvule temp___idx_173 a__last))
  (= (to_rep5 (select a temp___idx_173)) (to_rep5
                                         (select b (bvadd (bvsub b__first a__first) temp___idx_173)))))))))))

(declare-const attr__ATTRIBUTE_ADDRESS2 Int)

(declare-fun invariant__ ((Array (_ BitVec 32) name_id) us_split_fields2
  us_split_fields) Bool)

(declare-fun invariant____function_guard (Bool (Array (_ BitVec 32) name_id)
  us_split_fields2 us_split_fields) Bool)

(declare-fun valid_tables (us_split_fields2 us_split_fields) Bool)

(declare-fun valid_tables__function_guard (Bool us_split_fields2
  us_split_fields) Bool)

(declare-fun valid_name_table (us_split_fields2 us_split_fields) Bool)

(declare-fun valid_name_table__function_guard (Bool us_split_fields2
  us_split_fields) Bool)

(declare-fun valid_hashes ((Array (_ BitVec 32) name_id)
  us_split_fields) Bool)

(declare-fun valid_hashes__function_guard (Bool (Array (_ BitVec 32) name_id)
  us_split_fields) Bool)
...
;; invariant____def_axiom
  (assert
  (forall ((names__hash_table (Array (_ BitVec 32) name_id)))
  (forall ((names__char_table__fields us_split_fields2))
  (forall ((names__entry_table__fields us_split_fields))
  (! (and
     (forall ((names__char_table__fields1 us_split_fields2)
     (names__entry_table__fields1 us_split_fields))
     (valid_tables__function_guard
     (valid_tables names__char_table__fields1 names__entry_table__fields1)
     names__char_table__fields1 names__entry_table__fields1))
     (and
     (forall ((names__char_table__fields1 us_split_fields2)
     (names__entry_table__fields1 us_split_fields))
     (valid_name_table__function_guard
     (valid_name_table names__char_table__fields1
     names__entry_table__fields1) names__char_table__fields1
     names__entry_table__fields1))
     (and
     (forall ((names__hash_table1 (Array (_ BitVec 32) name_id))
     (names__entry_table__fields1 us_split_fields))
     (valid_hashes__function_guard
     (valid_hashes names__hash_table1 names__entry_table__fields1)
     names__hash_table1 names__entry_table__fields1))
     (=
     ...
     (= (valid_name_table names__char_table__fields
        names__entry_table__fields) true))
     (= (valid_hashes names__hash_table names__entry_table__fields) true)))))) :pattern (
  (invariant__ names__hash_table names__char_table__fields
...
(declare-fun to_string (Int (Array (_ BitVec 32) name_id) us_split_fields2
  us_split_fields) us_t)

(declare-fun to_string__function_guard (us_t Int
  (Array (_ BitVec 32) name_id) us_split_fields2 us_split_fields) Bool)
...
;; to_string__post_axiom
  ...
  (! (and
     (forall ((names__hash_table1 (Array (_ BitVec 32) name_id))
     (names__char_table__fields1 us_split_fields2)
     (names__entry_table__fields1 us_split_fields))
     (invariant____function_guard
     (invariant__ names__hash_table1 names__char_table__fields1
     names__entry_table__fields1) names__hash_table1
     names__char_table__fields1 names__entry_table__fields1))
     (=>
     (and
     (and
     (and (dynamic_invariant4 n true true true true) (dynamic_invariant3
     (us_repqtmk1 char_table__split_discrs names__char_table__fields) true
     true true true)) (dynamic_invariant1
     (us_repqtmk entry_table__split_discrs names__entry_table__fields) true
     true true true))
     (= (invariant__ names__hash_table names__char_table__fields
        names__entry_table__fields) true))
     (let ((result (to_string n names__hash_table names__char_table__fields
                   names__entry_table__fields)))
     (=> (to_string__function_guard result n names__hash_table
     names__char_table__fields names__entry_table__fields) (dynamic_invariant
     result true false true true))))) :pattern ((to_string n
                                                names__hash_table
...
(declare-fun user_eq15 (hash_type hash_type) Bool)

(declare-const dummy15 hash_type)
...
(define-fun dynamic_invariant5 ((temp___expr_395 (_ BitVec 32))
  (temp___is_init_391 Bool) (temp___skip_constant_392 Bool)
  (temp___do_toplevel_393 Bool) (temp___do_typ_inv_394 Bool)) Bool true)

;; hash__post_axiom
  (assert
  (forall ((key us_t))
  (! (=> (dynamic_invariant key true true true true) (dynamic_invariant5
     (hash key) true false true true)) :pattern ((hash key)) )))
...
;; valid_name_id'axiom
  (assert
  (forall ((i valid_name_id))
  (and (<= 1 (valid_name_idqtint i)) (<= (valid_name_idqtint i) 2147483647))))
...
(declare-datatypes ((valid_name_id__ref 0))
(((valid_name_id__refqtmk (valid_name_id__content valid_name_id)))))
(define-fun valid_name_id__ref_valid_name_id__content__projection ((a valid_name_id__ref)) valid_name_id 
...
(define-fun in_range13 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x)
                                                (bvule x #x000000FF)))

(define-fun in_range_int ((x Int)) Bool (and (<= 0 x) (<= x 255)))

(declare-fun attr__ATTRIBUTE_IMAGE12 ((_ BitVec 32)) us_image)

(declare-fun attr__ATTRIBUTE_VALUE__pre_check12 (us_image) Bool)

(declare-fun attr__ATTRIBUTE_VALUE12 (us_image) (_ BitVec 32))

(declare-fun user_eq18 (hash_table_index_t hash_table_index_t) Bool)

(declare-const dummy18 hash_table_index_t)

(declare-datatypes ((hash_table_index_t__ref 0))
(((hash_table_index_t__refqtmk
  (hash_table_index_t__content hash_table_index_t)))))
(define-fun hash_table_index_t__ref_hash_table_index_t__content__projection ((a hash_table_index_t__ref)) hash_table_index_t 
  (hash_table_index_t__content a))

(define-fun dynamic_invariant6 ((temp___expr_402 (_ BitVec 32))
  (temp___is_init_398 Bool) (temp___skip_constant_399 Bool)
  (temp___do_toplevel_400 Bool)
  (temp___do_typ_inv_401 Bool)) Bool (=>
                                     (or (= temp___is_init_398 true)
                                     (bvule #x00000000 #x000000FF))
                                     (in_range13 temp___expr_402)))
...
(define-fun dynamic_invariant8 ((temp___expr_74 Int) (temp___is_init_70 Bool)
...
(declare-fun model2 (us_rep2) us_rep4)

(declare-fun model__function_guard1 (us_rep4 us_rep2) Bool)

(declare-fun length5 (us_rep4) Int)

(declare-fun length__function_guard3 (Int us_rep4) Bool)

(define-fun last3 ((container us_rep4)) Int (+ (- 1) (length5 container)))

(declare-fun last__function_guard1 (Int us_rep4) Bool)

(define-fun last_index1 ((container us_rep2)) Int (last3 (model2 container)))

(declare-fun last_index__function_guard1 (Int us_rep2) Bool)
...
;; valid_tables__def_axiom
  ...
  (! (=
     ...
     (and
     (<= (last_index
         (us_repqtmk entry_table__split_discrs names__entry_table__fields)) 2147483647)
     (<= (last_index1
         (us_repqtmk1 char_table__split_discrs names__char_table__fields)) 2147483646))) :pattern (
...
;; valid_hashes__def_axiom
  ...
  (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true)
     ...
     (<= (to_rep5 (select names__hash_table h1)) (last_index
                                                 (us_repqtmk
                                                 entry_table__split_discrs
                                                 names__entry_table__fields)))))) :pattern (
  (valid_hashes names__hash_table names__entry_table__fields)) ))))

(declare-fun valid_entry (us_rep3 us_split_fields2 us_split_fields) Bool)

(declare-fun valid_entry__function_guard (Bool us_rep3 us_split_fields2
  us_split_fields) Bool)

;; valid_entry__post_axiom
  (assert
  (forall ((names__char_table__fields us_split_fields2)
  (names__entry_table__fields us_split_fields)) (valid_tables__function_guard
  (valid_tables names__char_table__fields names__entry_table__fields)
...
;; valid_entry__def_axiom
  ...
  (! (=
     ...
     (and
     (<= (to_rep5
         (rec__ada___names__data__name_entry__next_hash (us_split_fields5 e))) 
     (last_index
     (us_repqtmk entry_table__split_discrs names__entry_table__fields)))
     (<= (- (to_rep4
            (rec__ada___names__data__name_entry__length (us_split_fields5 e))) 1) (- 
     (last_index1
     (us_repqtmk1 char_table__split_discrs names__char_table__fields)) 
     (to_rep6
     (rec__ada___names__data__name_entry__table_index (us_split_fields5 e))))))) :pattern (
...
;; valid_name_table__def_axiom
  ...
  (! (and
     (forall ((names__char_table__fields1 us_split_fields2)
     (names__entry_table__fields1 us_split_fields) (i Int))
     (valid_entry__function_guard
     (valid_entry
     (element
     (us_repqtmk entry_table__split_discrs names__entry_table__fields1) i)
     names__char_table__fields1 names__entry_table__fields1)
     (element
     (us_repqtmk entry_table__split_discrs names__entry_table__fields1) i)
     names__char_table__fields1 names__entry_table__fields1))
     ...
     (= (valid_entry
        (element
        (us_repqtmk entry_table__split_discrs names__entry_table__fields) i)
        names__char_table__fields names__entry_table__fields) true))))) :pattern (
...
(define-fun dynamic_invariant10 ((temp___expr_204 Int)
...
(define-fun dynamic_invariant11 ((temp___expr_256 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_322 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_277 Int)
...
(define-fun dynamic_invariant14 ((temp___expr_284 Int)
...
(define-fun capacity ((container us_rep2)) Int (ite (= (distinct 0 0) true)
                                               (to_rep3
                                               (rec__ada___names__data__char_tables__vector__capacity
...
;; length__post_axiom
  ...
  (! (let ((result (length3 container)))
     (and (<= result (capacity container)) (dynamic_invariant14 result true
     false true true))) :pattern ((length3 container)) )))

(define-fun default_initial_assumption2 ((temp___expr_315 us_rep4)
...
;; model__post_axiom
  (assert
  (forall ((container us_rep2))
  (! (= (length5 (model2 container)) (length3 container)) :pattern ((model2
                                                                    container)) )))
...
;; extended_index'axiom
  ...
  (<= (extended_indexqtint2 i) 2147483646))))
...
(define-fun dynamic_invariant15 ((temp___expr_307 Int)
...
(define-fun dynamic_invariant16 ((temp___expr_211 Int)
...
(define-fun capacity1 ((container us_rep)) Int (ite (= (distinct 0 0) true)
                                               (to_rep2
                                               (rec__ada___names__data__entry_tables__vector__capacity
...
;; length__post_axiom
  ...
  (! (let ((result (length2 container)))
     (and (<= result (capacity1 container)) (dynamic_invariant16 result true
     false true true))) :pattern ((length2 container)) )))

(define-fun default_initial_assumption3 ((temp___expr_242 us_rep1)
...
(define-fun dynamic_invariant17 ((temp___expr_263 Int)
...
(declare-fun user_eq23 (extended_index3 extended_index3) Bool)

(declare-const dummy23 extended_index3)

(declare-datatypes ((extended_index__ref3 0))
(((extended_index__refqtmk3 (extended_index__content3 extended_index3)))))
(define-fun extended_index__ref_extended_index__content__2__projection ((a extended_index__ref3)) extended_index3 
  (extended_index__content3 a))

(define-fun dynamic_invariant18 ((temp___expr_234 Int)
...
;; defqtvc
 ;; File "names.ads", line 44, characters 0-0
  ...
  (char_table__split_fields us_main_type2)
  (hash_table (Array (_ BitVec 32) name_id)) (n Int)
  (entry_table__split_fields1 us_main_type)
  (char_table__split_fields1 us_main_type2)
  (hash_table1 (Array (_ BitVec 32) name_id)))
  (=> (dynamic_invariant3
  (us_repqtmk1 char_table__split_discrs
  (us_split_fieldsqtmk1 char_table__split_fields)) true false true true)
  (=> (dynamic_invariant1
  (us_repqtmk entry_table__split_discrs
  (us_split_fieldsqtmk entry_table__split_fields)) true false true true)
  (=> (dynamic_invariant s true false true true)
  (=> (dynamic_invariant4 n false false true true)
  (=>
  (forall ((entry_table__split_fields2 us_main_type)
  (char_table__split_fields2 us_main_type2)
  (hash_table2 (Array (_ BitVec 32) name_id))) (invariant____function_guard
  (invariant__ hash_table2 (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields2)) hash_table2
  (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields2)))
  (=>
  (= (invariant__ hash_table (us_split_fieldsqtmk1 char_table__split_fields)
     (us_split_fieldsqtmk entry_table__split_fields)) true)
  (=>
  (forall ((entry_table__split_fields2 us_main_type)
  (char_table__split_fields2 us_main_type2)) (valid_tables__function_guard
  (valid_tables (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields2))
  (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields2)))
  (=>
  ...
  (char_table__split_fields2 us_main_type2))
  (valid_name_table__function_guard
  (valid_name_table (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields2))
  (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields2)))
  (=>
  (forall ((entry_table__split_fields2 us_main_type)
  (hash_table2 (Array (_ BitVec 32) name_id))) (valid_hashes__function_guard
  (valid_hashes hash_table2 (us_split_fieldsqtmk entry_table__split_fields2))
  hash_table2 (us_split_fieldsqtmk entry_table__split_fields2)))
  (=>
  (forall ((entry_table__split_fields2 us_main_type)
  (char_table__split_fields2 us_main_type2)
  (hash_table2 (Array (_ BitVec 32) name_id))) (invariant____function_guard
  ...
  (us_split_fieldsqtmk entry_table__split_fields2)))
  (=>
  (forall ((hash_table2 (Array (_ BitVec 32) name_id))
  (char_table__split_fields2 us_main_type2)
  (entry_table__split_fields2 us_main_type)) (invariant____function_guard
  (invariant__ hash_table2 (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields2)) hash_table2
  (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields2)))
  ...
  (exists ((ptr Int))
  (and (= ptr 0)
  (and (dynamic_invariant4 ptr true false true true)
  (let ((o (hash s)))
  (and (dynamic_invariant5 o true false true true)
  (let ((o1 (bvurem o #x00000100)))
  (and (in_range13 o1)
  (and (= o1 h)
  (and (dynamic_invariant6 h true false true true)
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (= (length s) 0) true false))
  (ite (= spark__branch true)
  (and
  (and (= entry_table__split_fields1 entry_table__split_fields)
  (= char_table__split_fields1 char_table__split_fields))
  (= hash_table1 hash_table))
  (exists ((o2 Int))
  (and (= (to_rep5 (select hash_table h)) o2)
  (exists ((n1 Int))
  (and (= n1 o2)
  (or
  (and
  ...
  (and (= spark__branch1 (ite (in_range11 n1) true false))
  (and (= spark__branch1 true)
  (exists ((ptr1 Int))
  (and (= ptr1 n1)
  (exists ((ptr2 Int))
  (let ((temp___545 (to_string ptr1 hash_table
                    (us_split_fieldsqtmk1 char_table__split_fields)
                    (us_split_fieldsqtmk entry_table__split_fields))))
  (and
  (and (to_string__function_guard temp___545 ptr1 hash_table
  (us_split_fieldsqtmk1 char_table__split_fields)
  (us_split_fieldsqtmk entry_table__split_fields)) (dynamic_invariant
  temp___545 true false true true))
  (exists ((spark__branch2 Bool))
  (and
  (= spark__branch2 (bool_eq (to_array temp___545) (first1 temp___545)
                    (last1 temp___545) (to_array s) (first1 s) (last1 s)))
  (ite (= spark__branch2 true) (= ptr2 ptr1)
  (let ((o3 (invariant__ hash_table
            (us_split_fieldsqtmk1 char_table__split_fields)
            (us_split_fieldsqtmk entry_table__split_fields))))
  (and
  (and (invariant____function_guard o3 hash_table
  (us_split_fieldsqtmk1 char_table__split_fields)
  (us_split_fieldsqtmk entry_table__split_fields))
  (= (= o3 true)
  (and
  ...
  (= (valid_tables (us_split_fieldsqtmk1 char_table__split_fields)
     (us_split_fieldsqtmk entry_table__split_fields)) true)
  (= (valid_name_table (us_split_fieldsqtmk1 char_table__split_fields)
     (us_split_fieldsqtmk entry_table__split_fields)) true))
  (= (valid_hashes hash_table
     (us_split_fieldsqtmk entry_table__split_fields)) true))))
  (let ((o4 (us_repqtmk entry_table__split_discrs
            (us_split_fieldsqtmk entry_table__split_fields))))
  ...
  (= (invariant__ hash_table (us_split_fieldsqtmk1 char_table__split_fields)
     (us_split_fieldsqtmk entry_table__split_fields)) true))
  (and
  (and (dynamic_invariant4 ptr3 true true true true) (dynamic_invariant4 n1
  false true true true))
  (and (in_range12 ptr3)
  (let ((o6 (us_repqtmk entry_table__split_discrs
            (us_split_fieldsqtmk entry_table__split_fields))))
  (let ((o7 (element o6 ptr3)))
  (and (= (bool_eq3 o7 (get (model1 o6) ptr3)) true)
  (exists ((o8 Int))
  (and
  (= (to_rep5
  ...
  (and (not (= o8 0))
  (and (in_range12 ptr3)
  (let ((o9 (us_repqtmk entry_table__split_discrs
            (us_split_fieldsqtmk entry_table__split_fields))))
  (let ((o10 (element o9 ptr3)))
  (and (= (bool_eq3 o10 (get (model1 o9) ptr3)) true)
  (exists ((o11 Int))
  (and
  (= (to_rep5
     (rec__ada___names__data__name_entry__next_hash (us_split_fields5 o10))) o11)
  (and (= ptr2 o11)
  (let ((temp___5451 (to_string ptr2 hash_table
                     (us_split_fieldsqtmk1 char_table__split_fields)
                     (us_split_fieldsqtmk entry_table__split_fields))))
  (and
  (and (to_string__function_guard temp___5451 ptr2 hash_table
  (us_split_fieldsqtmk1 char_table__split_fields)
  (us_split_fieldsqtmk entry_table__split_fields)) (dynamic_invariant
  temp___5451 true false true true))
  (exists ((spark__branch3 Bool))
  (and
  (= spark__branch3 (bool_eq (to_array temp___5451) (first1 temp___5451)
                    (last1 temp___5451) (to_array s) (first1 s) (last1 s)))
  (= spark__branch3 true))))))))))))))))))))))))))))))))))))))
  (= entry_table__split_fields1 entry_table__split_fields))
  (= char_table__split_fields1 char_table__split_fields))
  (= hash_table1 hash_table))
  (exists ((spark__branch1 Bool) (ptr1 Int))
  (and
  (exists ((spark__branch2 Bool))
  (and (= spark__branch2 (ite (in_range11 n1) true false))
  (ite (= spark__branch2 true)
  (exists ((ptr2 Int))
  (and (= ptr2 n1)
  (let ((temp___545 (to_string ptr2 hash_table
                    (us_split_fieldsqtmk1 char_table__split_fields)
                    (us_split_fieldsqtmk entry_table__split_fields))))
  (and
  (and (to_string__function_guard temp___545 ptr2 hash_table
  (us_split_fieldsqtmk1 char_table__split_fields)
  (us_split_fieldsqtmk entry_table__split_fields)) (dynamic_invariant
  temp___545 true false true true))
  (exists ((spark__branch3 Bool))
  (and
  (= spark__branch3 (bool_eq (to_array temp___545) (first1 temp___545)
                    (last1 temp___545) (to_array s) (first1 s) (last1 s)))
  ...
  (= (to_rep5
     (rec__ada___names__data__name_entry__next_hash (us_split_fields5 o7))) o8)
  (and (= o8 0) (= ptr1 ptr3)))))))))))))))))))))))
  (and (= spark__branch1 spark__branch2) (= ptr1 ptr)))))
  (exists ((entry_table__split_fields2 us_main_type) (n2 Int))
  (and
  (and
  (and
  (and
  (and
  (= (invariant__ hash_table (us_split_fieldsqtmk1 char_table__split_fields1)
     (us_split_fieldsqtmk entry_table__split_fields2)) true)
  (= (length2
     (us_repqtmk entry_table__split_discrs
     (us_split_fieldsqtmk entry_table__split_fields2))) (+ (length2
                                                           (us_repqtmk
                                                           entry_table__split_discrs
                                                           (us_split_fieldsqtmk
                                                           entry_table__split_fields))) 1)))
  (<= (length3
      (us_repqtmk1 char_table__split_discrs
      (us_split_fieldsqtmk1 char_table__split_fields))) (length3
                                                        (us_repqtmk1
                                                        char_table__split_discrs
                                                        (us_split_fieldsqtmk1
                                                        char_table__split_fields1)))))
  (= n2 (last_index
        (us_repqtmk entry_table__split_discrs
        (us_split_fieldsqtmk entry_table__split_fields2)))))
  (and
  (and (dynamic_invariant4 n2 true true true true) (dynamic_invariant3
  (us_repqtmk1 char_table__split_discrs
  (us_split_fieldsqtmk1 char_table__split_fields1)) true true true true))
  (dynamic_invariant1
  (us_repqtmk entry_table__split_discrs
  (us_split_fieldsqtmk entry_table__split_fields2)) true true true true)))
  (exists ((spark__branch2 Bool))
  (and (= spark__branch2 (ite (in_range11 ptr1) true false))
  (ite (= spark__branch2 true)
  (and
  (and (in_range12 ptr1)
  (let ((o3 (us_repqtmk entry_table__split_discrs
            (us_split_fieldsqtmk entry_table__split_fields2))))
  (let ((temp___550 (element o3 ptr1)))
  (and (= (bool_eq3 temp___550 (get (model1 o3) ptr1)) true)
  (let ((q_ (us_split_fields5 temp___550)))
  (exists ((o4 name_id))
  (and (= (to_rep5 o4) n2)
  (and (in_range12 ptr1)
  (let ((o5 entry_table__split_discrs))
  (exists
  ((ada___names__data__entry_tables__replace_element__container__fields us_main_type))
  (and
  (and
  (and
  (= (length2
     (us_repqtmk o5
     (us_split_fieldsqtmk
     ada___names__data__entry_tables__replace_element__container__fields))) 
  (length2 (us_repqtmk o5 (us_split_fieldsqtmk entry_table__split_fields2))))
  (= (bool_eq3
     (get
     (model1
     (us_repqtmk o5
     ...
     (us_repqtmk2
     (us_split_fieldsqtmk2
     (rec__ada___names__data__name_entry__table_index q_)
     (rec__ada___names__data__name_entry__length q_) o4))) true))
  (= (equal_except
     (model1
     (us_repqtmk o5 (us_split_fieldsqtmk entry_table__split_fields2)))
     (model1
     (us_repqtmk o5
     (us_split_fieldsqtmk
     ada___names__data__entry_tables__replace_element__container__fields)))
     ptr1) true))
  (= entry_table__split_fields1 ada___names__data__entry_tables__replace_element__container__fields))))))))))))
  (= hash_table1 hash_table))
  (and
  (exists ((o3 name_id))
  (and (= (to_rep5 o3) n2) (= hash_table1 (store hash_table h o3))))
  (= entry_table__split_fields1 entry_table__split_fields2))))))))))))))))))))))))))
  (=>
  (forall ((entry_table__split_fields2 us_main_type)
  (char_table__split_fields2 us_main_type2)
  (hash_table2 (Array (_ BitVec 32) name_id))) (invariant____function_guard
