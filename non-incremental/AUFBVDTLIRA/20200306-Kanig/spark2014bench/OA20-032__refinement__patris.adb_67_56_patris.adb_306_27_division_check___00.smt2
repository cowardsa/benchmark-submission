...
;; defqtvc
 ;; File "patris.ads", line 271, characters 0-0
  ...
  (action_request_nbr Int) (spark__branch Bool) (spark__branch1 Bool) (o Int)
  (spark__branch2 Bool))
  ...
  (=> (= spark__branch1 (ite (= cur_state 3) true false))
  (=> (= spark__branch1 true)
  (=> (= (to_rep1 (rec__patris__piece__s next_piece__split_fields)) o)
  (=> (= spark__branch2 (ite (= o 0) true false))
  (=> (= spark__branch2 true)
  (let ((o1 (rand Tuple0)))
  (=> (dynamic_invariant3 o1 true false true true)
  (forall ((o2 direction))
