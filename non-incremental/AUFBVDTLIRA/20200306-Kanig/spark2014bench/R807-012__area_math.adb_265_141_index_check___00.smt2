...
;; defqtvc
 ;; File "area_math.ads", line 46, characters 0-0
  ...
  (=> (= (to_rep2 (select (to_array temp___533) temp___534)) o5)
  (=> (not (= o5 #x00000000))
  (=> (not (= i 0))
  (let ((temp___537 (rec__area_math__ensemble__to (us_split_fields1 e))))
  (=> (and (<= (first1 temp___537) i) (<= i (last1 temp___537)))
  (forall ((o6 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___537) i)) o6)
  (forall ((temp___536 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) temp___536)
  (<= (first1 (rec__area_math__ensemble__from1 result____split_fields4)) temp___536))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
