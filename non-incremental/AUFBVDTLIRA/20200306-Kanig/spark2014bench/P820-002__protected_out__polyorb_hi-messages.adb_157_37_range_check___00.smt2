...
(define-fun dynamic_invariant2 ((temp___expr_186 (_ BitVec 8))
...
;; def_axiom
  ...
  (=> (dynamic_invariant2 temp___156 true true true true)
...
(assert
;; defqtvc
 ;; File "polyorb_hi-messages.ads", line 85, characters 0-0
  (not
  (forall ((stream__split_fields us_split_fields) (spark__branch Bool)
  (stream__split_fields1 us_split_fields) (o Int))
  (=> (dynamic_invariant item true false true true)
  (=>
  (forall ((stream__split_fields2 us_split_fields)) (valid__function_guard
  (valid (us_repqtmk stream__split_fields2))
  (us_repqtmk stream__split_fields2)))
  ...
  (= (to_rep1
     (rec__ada___polyorb_hi__messages__message_type__last
     stream__split_fields)) o1)
  (exists ((o2 Int))
  (and
  (= (to_rep1
     (rec__ada___polyorb_hi__messages__message_type__first
     stream__split_fields)) o2)
  (and (= spark__branch (ite (< o1 o2) true false))
  (=> (not (= spark__branch true))
  (= stream__split_fields1 stream__split_fields)))))))
  (=>
  (= (to_rep1
     (rec__ada___polyorb_hi__messages__message_type__last
     stream__split_fields1)) o)
  (let ((o1 (length item)))
  (=> (in_range2 o1)
  (forall ((spark__branch1 Bool))
  (=> (= spark__branch1 (ite (<= o1 (- 19 o)) true false))
  (=> (= spark__branch1 true)
  (forall ((o2 Int))
  (=>
  (= (to_rep1
  ...
  (= (to_rep1
     (rec__ada___polyorb_hi__messages__message_type__last
     stream__split_fields1)) o4)
  (let ((o5 (+ o4 o3)))
  (=> (in_range2 o5)
  (=> (= o5 r24b)
  (=> (in_range2 r24b)
  (=>
  (ite (<= (first1 item) (last1 item))
  (and (<= r23b r24b) (= (- (last1 item) (first1 item)) (- r24b r23b)))
  (< r24b r23b))
  (let ((temp___495 (of_array (slide (to_array item) (first1 item) r23b) 
                    r23b r24b)))
  (=>
  (=> (<= r23b r24b)
  (and (and (<= 1 r23b) (<= r23b 19)) (and (<= 1 r24b) (<= r24b 19))))
  (let ((temp___497 (of_array
                    (rec__ada___polyorb_hi__messages__message_type__content
                    stream__split_fields1) r23b r24b)))
  (=>
  (ite (<= (first1 temp___495) (last1 temp___495))
  (and (<= (first1 temp___497) (last1 temp___497))
  (= (- (last1 temp___495) (first1 temp___495)) (- (last1 temp___497) 
  (first1 temp___497)))) (< (last1 temp___497) (first1 temp___497)))
  (forall ((usf (Array Int stream_element)))
  (=>
  (forall ((temp___500 Int))
  (ite (and (<= r23b temp___500) (<= temp___500 r24b))
  (= (select usf temp___500) (select (to_array temp___495) temp___500))
  (= (select usf temp___500) (select (rec__ada___polyorb_hi__messages__message_type__content
                                     stream__split_fields1) temp___500))))
  (forall ((stream__split_fields2 us_split_fields))
  (=>
  (= stream__split_fields2 (us_split_fieldsqtmk usf
                           (rec__ada___polyorb_hi__messages__message_type__first
                           stream__split_fields1)
                           (rec__ada___polyorb_hi__messages__message_type__last
                           stream__split_fields1)))
  (let ((o6 (length item)))
  (=> (in_range2 o6)
  ...
  (let ((o8 (+ o7 o6))) (=> (in_range2 o8) (in_range o8)))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
