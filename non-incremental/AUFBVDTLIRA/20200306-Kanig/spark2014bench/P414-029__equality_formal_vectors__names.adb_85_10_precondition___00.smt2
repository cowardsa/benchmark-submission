...
;; defqtvc
 ;; File "names.ads", line 9, characters 0-0
  ...
  (=> (= c330b temp___660)
  (=>
  (= (and (ite (<= temp___660 c330b) true false) (ite (<= c330b (last1 s))
                                                 true false)) true)
  (forall ((char_table__split_fields1 us_main_type) (c330b1 Int))
  (=>
  (= (and (ite (dynamic_invariant1
          (us_repqtmk char_table__split_discrs
          (us_split_fieldsqtmk char_table__split_fields1)) true true true
          true) true false) (ite (and (<= (first1 s) c330b1)
                                 (<= c330b1 (last1 s)))
                            true false)) true)
  (forall ((o3 Int))
  (=> (= (to_rep1 (select (to_array s) c330b1)) o3)
  (let ((o4 char_table__split_discrs))
  (< (length1
     (us_repqtmk o4 (us_split_fieldsqtmk char_table__split_fields1))) 
  (capacity (us_repqtmk o4 (us_split_fieldsqtmk char_table__split_fields1)))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
