...
(define-fun to_int2 ((x message_index)) Int (ubv_to_int (to_rep1 x)))
...
;; defqtvc
 ;; File "communications.ads", line 14, characters 0-0
  (not
  (forall ((self__ us_split_fields) (self__1 us_split_fields))
  (=> (dynamic_invariant n true false true true)
  (=>
  (exists ((o Int))
  (and (= (to_rep2 (rec__communications__mailboxT__count self__)) o)
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (< o 16) true false))
  (ite (= spark__branch true)
  (exists ((o1 integer))
  (and (= (to_rep o1) n)
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep1 (rec__communications__mailboxT__next_in self__)) o2)
  (exists ((self__2 us_split_fields))
  (and
  (= self__2 (us_split_fieldsqtmk
             (store (rec__communications__mailboxT__messages self__) o2 o1)
             (rec__communications__mailboxT__next_in self__)
             (rec__communications__mailboxT__next_out self__)
             (rec__communications__mailboxT__count self__)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep1 (rec__communications__mailboxT__next_in self__2)) o3)
  (exists ((o4 message_index))
  (and (= (to_rep1 o4) (bvurem (bvadd o3 #x01) #x10))
  (exists ((self__3 us_split_fields))
  (and
  (= self__3 (us_split_fieldsqtmk
             (rec__communications__mailboxT__messages self__2) o4
             (rec__communications__mailboxT__next_out self__2)
             (rec__communications__mailboxT__count self__2)))
  (exists ((o5 Int))
  (and (= (to_rep2 (rec__communications__mailboxT__count self__3)) o5)
  (let ((o6 (+ o5 1)))
  (and (in_range2 o6)
  (exists ((o7 message_count))
  (and (= (to_rep2 o7) o6)
  (= self__1 (us_split_fieldsqtmk
             (rec__communications__mailboxT__messages self__3)
             (rec__communications__mailboxT__next_in self__3)
             (rec__communications__mailboxT__next_out self__3) o7))))))))))))))))))))
  (= self__1 self__))))))
  (=>
  (forall ((self__2 us_split_fields)) (item_count__function_guard
