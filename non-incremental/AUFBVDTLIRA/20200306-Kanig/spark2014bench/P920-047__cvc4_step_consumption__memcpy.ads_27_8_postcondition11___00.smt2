...
;; defqtvc
 ;; File "memcpy.ads", line 14, characters 0-0
  ...
  (rsi (_ BitVec 64)) (rax (_ BitVec 64)) (rdi1 (_ BitVec 64))
  (rdx1 (_ BitVec 64)) (memory1 (Array (_ BitVec 64) unsigned8))
  (rsp1 (_ BitVec 64)) (rdx_400586 (_ BitVec 64)) (rdi_400586 (_ BitVec 64)))
  (=> (= rdi1 rdi)
  (=> (= rdx1 rdx)
  (=> (= memory1 memory)
  (=> (= rsp1 rsp)
  ...
  (=>
  (forall ((rdi2 (_ BitVec 64)) (rdx2 (_ BitVec 64)) (i (_ BitVec 64)))
  (inmemoryrange__function_guard (inmemoryrange i rdi2 (bvadd rdi2 rdx2)) i
  rdi2 (bvadd rdi2 rdx2)))
  (=>
  ...
  (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF))
  (=>
  (forall ((rdi2 (_ BitVec 64)) (rdx2 (_ BitVec 64)) (i1 (_ BitVec 64)))
  (inmemoryrange__function_guard (inmemoryrange i1 rdi2 (bvadd rdi2 rdx2)) i1
  rdi2 (bvadd rdi2 rdx2)))
  (=>
  (forall ((rsp5 (_ BitVec 64)) (i1 (_ BitVec 64)))
  (insaferegion64__function_guard (insaferegion64 i1 rsp5) i1 rsp5))
  (=>
  (and (not (= (inmemoryrange i rdi1 (bvadd rdi1 rdx1)) true))
