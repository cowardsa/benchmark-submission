...
;; defqtvc
 ;; File "very_longs.ads", line 61, characters 0-0
  ...
  (=> (= carry2 #x0000)
  (forall ((result____split_fields3 us_t) (carry3 (_ BitVec 16)))
  (=>
  ...
  (and
  (and (<= (first1 result____split_fields4) temp___1131)
  (<= temp___1131 (last1 result____split_fields4)))
  (exists ((o7 (_ BitVec 8)))
  (and
  (= (to_rep2 (select (to_array result____split_fields4) temp___1131)) o7)
  ...
  (and
  (and (<= (first1 result____split_fields4) temp___1133)
  (<= temp___1133 (last1 result____split_fields4)))
  (and
  (= result____split_fields3 (us_tqtmk
                             (store (to_array result____split_fields4) temp___1133 o9)
  ...
  (and (= result____split_fields3 result____split_fields2) (= carry3 carry2))))))
  ...
  (let ((o7 (+ o6 j1)))
  (=> (in_range2 o7) (<= (first1 result____split_fields3) o7)))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
