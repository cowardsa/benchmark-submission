...
(define-fun dynamic_invariant1 ((temp___expr_788 us_rep1)
...
(define-fun dynamic_invariant2 ((temp___expr_801 us_rep2)
...
(define-fun dynamic_invariant4 ((temp___expr_356 (_ BitVec 16))
...
(define-fun dynamic_invariant5 ((temp___expr_767 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_250 (_ BitVec 8))
...
;; defqtvc
 ;; File "very_longs-divide.adb", line 109, characters 0-0
  ...
  (let ((o6 (+ j n)))
  (and (in_range2 o6)
  (let ((temp___1364 (- o6 2)))
  (and
  (and (<= (first1 u__split_fields) temp___1364)
  (<= temp___1364 (last1 u__split_fields)))
  (exists ((o7 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields) temp___1364)) o7)
  (let ((temp___1362 (- n 1)))
  (and
  (and (<= (first1 v__split_fields) temp___1362)
  (<= temp___1362 (last1 v__split_fields)))
  (exists ((o8 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array v__split_fields) temp___1362)) o8)
  (and
  ...
  (and (and (<= (first1 v__split_fields) n) (<= n (last1 v__split_fields)))
  (exists ((o9 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array v__split_fields) n)) o9)
  ...
  (=> (= spark__branch1 true)
  (let ((o6 (+ j n)))
  (=> (in_range2 o6) (<= (first1 u__split_fields) (- o6 2))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
