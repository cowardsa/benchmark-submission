...
(((result_type__refqtmk (result_type__content result_type)))))
...
;; defqtvc
 ;; File "decadriver.ads", line 114, characters 0-0
  (not
  (forall ((result__ Int) (self__ us_split_fields2) (result__1 Int))
  (=> (dynamic_invariant (us_repqtmk1 self__) true false true true)
