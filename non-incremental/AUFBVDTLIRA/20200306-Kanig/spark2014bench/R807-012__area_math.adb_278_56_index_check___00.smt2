...
;; defqtvc
 ;; File "area_math.ads", line 46, characters 0-0
  ...
  (forall ((i Int))
  (=> (= i 0)
  (=> (= (and (ite (<= 0 i) true false) (ite (<= i r61b) true false)) true)
  (forall ((skip Bool))
  (=> (= skip (distinct 0 0))
  ...
  (or (= skip2 true)
  (exists ((o5 Int))
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) o5)))
  (=>
  (or (= skip2 true)
  (let ((temp___533 (rec__area_math__ensemble__from1 result____split_fields4)))
  (exists ((temp___534 Int))
  (and
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) temp___534)
  (and
  (and (<= (first1 temp___533) temp___534)
  (<= temp___534 (last1 temp___533)))
  (exists ((o5 (_ BitVec 32)))
  (and (= (to_rep2 (select (to_array temp___533) temp___534)) o5)
  (or (= o5 #x00000000)
  (or (= i 0)
  (let ((temp___537 (rec__area_math__ensemble__to (us_split_fields1 e))))
  (and (and (<= (first1 temp___537) i) (<= i (last1 temp___537)))
  (exists ((o6 (_ BitVec 32)))
  (and (= (to_rep2 (select (to_array temp___537) i)) o6)
  (let ((temp___535 (rec__area_math__ensemble__from1 result____split_fields4)))
  (exists ((temp___536 Int))
  (and
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) temp___536)
  (and
  (and (<= (first1 temp___535) temp___536)
  (<= temp___536 (last1 temp___535)))
  (exists ((o7 (_ BitVec 32)))
  (= (to_rep2 (select (to_array temp___535) temp___536)) o7)))))))))))))))))))
  (=>
  (or (= skip2 true)
  (let ((temp___523 (rec__area_math__ensemble__to1 result____split_fields4)))
  (exists ((temp___524 Int))
  (and
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) temp___524)
  (and
  (and (<= (first1 temp___523) temp___524)
  (<= temp___524 (last1 temp___523)))
  (exists ((o5 (_ BitVec 32)))
  (and (= (to_rep2 (select (to_array temp___523) temp___524)) o5)
  (or (= o5 #xFFFFFFFF)
  (exists ((o6 Int))
  (and (= (to_rep (rec__area_math__ensemble__size (us_split_fields1 e))) o6)
  (or (not (< i o6))
  (let ((temp___527 (rec__area_math__ensemble__from (us_split_fields1 e))))
  (let ((o7 (+ i 1)))
  (and (in_range1 o7)
  (and (and (<= (first1 temp___527) o7) (<= o7 (last1 temp___527)))
  (exists ((o8 (_ BitVec 32)))
  (and (= (to_rep2 (select (to_array temp___527) o7)) o8)
  (let ((temp___525 (rec__area_math__ensemble__to1 result____split_fields4)))
  (exists ((temp___526 Int))
  (and
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) temp___526)
  (and
  (and (<= (first1 temp___525) temp___526)
  (<= temp___526 (last1 temp___525)))
  (exists ((o9 (_ BitVec 32)))
  (= (to_rep2 (select (to_array temp___525) temp___526)) o9)))))))))))))))))))))))
  (=>
  (or (not (= skip2 true))
  (and
  (exists ((o5 Bool))
  ...
  (= o5 (ite (= o7 0) false true)))) (= o5 false))))
  (or (not (= o5 true))
  (let ((temp___519 (rec__area_math__ensemble__to (us_split_fields1 e))))
  (and (and (<= (first1 temp___519) i) (<= i (last1 temp___519)))
  (exists ((o6 (_ BitVec 32)))
  (= (to_rep2 (select (to_array temp___519) i)) o6)))))))
  (exists ((o5 Bool))
  (and
  (ite (= i 0)
  (exists ((o6 Int))
  ...
  (or (not (= o5 true))
  (let ((temp___517 (rec__area_math__ensemble__from (us_split_fields1 e))))
  (let ((o6 (+ i 1)))
  (and (in_range1 o6)
  (and (and (<= (first1 temp___517) o6) (<= o6 (last1 temp___517)))
  (exists ((o7 (_ BitVec 32)))
  (= (to_rep2 (select (to_array temp___517) o6)) o7)))))))))))
  (let ((o5 e))
  (let ((temp___inv_514 (is_consistent o5)))
  (=>
  (and (is_consistent__function_guard temp___inv_514 o5)
  (= (= temp___inv_514 true)
  (and
  (forall ((r Int))
  (=>
  (and (<= 1 r)
  (<= r (- (to_rep (rec__area_math__ensemble__size (us_split_fields1 o5))) 1)))
  (and
  (bvult (to_rep2
         (select (to_array
                 (rec__area_math__ensemble__to (us_split_fields1 o5))) r)) 
  (to_rep2
  (select (to_array (rec__area_math__ensemble__from (us_split_fields1 o5))) (+ r 1))))
  (bvugt (bvsub (to_rep2
                (select (to_array
                        (rec__area_math__ensemble__from
                        (us_split_fields1 o5))) (+ r 1))) (to_rep2
                                                          (select (to_array
                                                                  (rec__area_math__ensemble__to
                                                                  (us_split_fields1
                                                                  o5))) r))) #x00000001))))
  ...
  (=>
  (and (<= 1 r)
  (<= r (to_rep (rec__area_math__ensemble__size (us_split_fields1 o5)))))
  (bvule (to_rep2
         (select (to_array
                 (rec__area_math__ensemble__from (us_split_fields1 o5))) r)) 
  (to_rep2
  (select (to_array (rec__area_math__ensemble__to (us_split_fields1 o5))) r))))))))
  (forall ((o6 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) o6)
  (=> (< 0 o6)
  (forall ((o7 Bool))
  (=>
  (exists ((o8 Int))
  (and (= (to_rep (rec__area_math__ensemble__size (us_split_fields1 e))) o8)
  (ite (< i o8)
  (exists ((o9 Int))
  (and (= (to_rep (rec__area_math__ensemble__size (us_split_fields1 e))) o9)
  (= o7 (ite (< 0 o9) true false)))) (= o7 false))))
  (=> (= o7 true)
  (let ((temp___508 (rec__area_math__ensemble__to (us_split_fields1 e))))
  (let ((o8 (+ i 1)))
  (=> (in_range1 o8)
  (=> (and (<= (first1 temp___508) o8) (<= o8 (last1 temp___508)))
  (forall ((o9 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___508) o8)) o9)
  (let ((temp___506 (rec__area_math__ensemble__to1 result____split_fields4)))
  (forall ((temp___507 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) temp___507)
  (=>
  (and (<= (first1 temp___506) temp___507)
  (<= temp___507 (last1 temp___506)))
  (forall ((o10 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___506) temp___507)) o10)
  (let ((temp___504 (rec__area_math__ensemble__from (us_split_fields1 e))))
  (let ((o11 (+ i 1)))
  (=> (in_range1 o11)
  (=> (and (<= (first1 temp___504) o11) (<= o11 (last1 temp___504)))
  (forall ((o12 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___504) o11)) o12)
  (forall ((temp___503 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) temp___503)
  (<= (first1 (rec__area_math__ensemble__to1 result____split_fields4)) temp___503)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
