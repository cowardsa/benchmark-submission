...
;; modadd__post_axiom
  ...
  (! (=>
     ...
     (=> (modadd__function_guard result l r)
     (and
     (= (to_rep
        (rec__ada___ada___aco__math__very_longs__very_long__octet_length
        (us_split_discrs1 result))) (to_rep
                                    (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                    (us_split_discrs1 l))))
     (dynamic_invariant result true false true true))))) :pattern ((modadd l
                                                                   r)) )))
...
(((t158b__refqtmk (t158b__content us_t)))))
(define-fun t158b__ref_t158b__content__projection ((a t158b__ref)) us_t 
  (t158b__content a))

(declare-datatypes ((us_split_fields2 0))
(((us_split_fieldsqtmk1
  (rec__ada___ada___aco__math__very_longs__very_long__long_digits1 us_t)))))
(define-fun us_split_fields_rec__ada___ada___aco__math__very_longs__very_long__long_digits__40__projection ((a us_split_fields2)) us_t 
  (rec__ada___ada___aco__math__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((us_split_fields__refqtmk1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___split_fields__content__40__projection ((a us_split_fields__ref1)) us_split_fields2 
...
(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___250 (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array temp___250)
                                         (first1 temp___250)
                                         (last1 temp___250))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r1)
                                          (us_split_fieldsqtmk1
                                          (let ((temp___249 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array (to_array temp___249)
                                          (first1 temp___249)
                                          (last1 temp___249))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1058 us_rep1)
  (temp___is_init_1054 Bool) (temp___skip_constant_1055 Bool)
  (temp___do_toplevel_1056 Bool)
  (temp___do_typ_inv_1057 Bool)) Bool (and
                                      (=>
                                      (not
                                      (= temp___skip_constant_1055 true))
                                      (in_range3
                                      (to_rep
                                      (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                      (us_split_discrs1 l)))
                                      ...
                                      (first1
                                      (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_1058)))
                                      (last1
                                      (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_1058))))
                                      (and
                                      (= (first1
                                         (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_1058))) 1)
                                      (= (last1
                                         (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_1058))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_1061 us_rep1)
  (temp___skip_top_level_1062 Bool)) Bool (and
                                          (= (to_rep
                                             (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                             (us_split_discrs2
                                             temp___expr_1061))) (to_rep
                                                                 (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                                                 (us_split_discrs1
                                                                 l))))
                                          (and
...
(assert
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 92, characters 0-0
  (not
  (forall ((result____split_fields us_t) (borrow (_ BitVec 16)) (o Int))
  ...
  (=> (dynamic_invariant1 borrow false false true true)
  (let ((o1 result____split_discrs))
  (forall ((borrow1 (_ BitVec 16))
  (ada___ada___aco__math__very_longs__modsubtract_and_borrow__result__fields us_t))
  (=>
  (and
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length o1)) 
  (to_rep
  (rec__ada___ada___aco__math__very_longs__very_long__octet_length
  (us_split_discrs1 l))))
  ...
  (and (= spark__branch (ite (= borrow1 #x0001) true false))
  ...
  (=>
  (= ada___ada___aco__math__very_longs__subtract_fp__result (to_base
                                                            (us_repqtmk1
  ...
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1
     ada___ada___aco__math__very_longs__subtract_fp__result))) (to_rep
                                                               (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l))))))))))))))))))))))))))))
(check-sat)
