...
(define-fun dynamic_invariant3 ((temp___expr_778 Int)
...
(assert
;; defqtvc
 ;; File "very_longs.adb", line 401, characters 0-0
  (not
  ...
  (=> (= overflow_mask1 o1)
  (=> (= (last1 number__split_fields) r130b)
  (=> (in_range2 r130b)
  (let ((temp___1376 r130b))
  (forall ((i Int))
  (=> (= i temp___1376)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1376) true false)) true)
  (forall ((number__split_fields1 us_t) (old_overflow1 (_ BitVec 8))
  (new_overflow1 (_ BitVec 8)) (i1 Int))
  (=>
  (= (and (ite (and
               (and
               (and (dynamic_invariant2 new_overflow1 false true true true)
               (dynamic_invariant
               (us_repqtmk number__split_discrs
               (us_split_fieldsqtmk number__split_fields1)) true true true
               true))
               (forall ((temp___1389 Int))
               (=>
               (and (<= (first1 number__split_fields1) temp___1389)
               (<= temp___1389 (last1 number__split_fields1)))
               (=>
               (or (< temp___1376 temp___1389)
               (or (< temp___1389 1) (<= temp___1389 i1)))
               (= (select (to_array number__split_fields1) temp___1389) (select 
               (to_array number__split_fields) temp___1389))))))
               (dynamic_invariant2 old_overflow1 true true true true))
          true false) (ite (and (<= 1 i1) (<= i1 r130b)) true false)) true)
  (=>
