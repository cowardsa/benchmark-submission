...
;; defqtvc
 ;; File "very_longs.ads", line 40, characters 0-0
  ...
  (=> (= index 1)
  (=>
  (= (and (ite (<= 1 index) true false) (ite (<= index (last1
                                                       (rec__very_longs__very_long__long_digits
                                                       (us_split_fields1
                                                       number))))
                                        true false)) true)
  ...
  (ite (= spark__branch1 true) (and (in_range4 index) (= digit_count1 index))
  (= digit_count1 digit_count)))))))
  (=> (< digit_count1 index)
  (forall ((usf Int))
  (=>
  (= (and (ite (<= (+ digit_count1 1) usf) true false) (ite (<= usf index)
                                                       true false)) true)
  (<= (first1
