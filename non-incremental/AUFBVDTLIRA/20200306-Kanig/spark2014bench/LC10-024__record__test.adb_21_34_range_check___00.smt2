...
;; defqtvc
 ;; File "test.ads", line 11, characters 0-0
  ...
  (=>
  (forall ((s__split_fields1 us_split_fields)) (get_remaining__function_guard
  (get_remaining (us_repqtmk s__split_fields1))
  (us_repqtmk s__split_fields1)))
  (=> (< 0 (get_remaining (us_repqtmk s__split_fields)))
  (forall ((o Int))
  (=> (= (to_rep (rec__test__t__remaining s__split_fields)) o) (in_range
  (- o 1)))))))))
(check-sat)
(exit)
