...
;; defqtvc
 ;; File "ethernet_dissector.ads", line 12, characters 0-0
  (not
  (forall ((ethernet_dissector__match__result Int))
  (=> (dynamic_invariant2 buffer true false true true)
  (=>
  (exists ((offset Int))
  (and (= offset 0)
  (and (dynamic_invariant offset true false true true)
  (exists ((spark__branch Bool))
  (and
  (= spark__branch (or (ite (< (length buffer) 60) true false) (ite (< 1520 
                                                               (length
                                                               buffer)) true
                                                               false)))
  (ite (= spark__branch true) (= ethernet_dissector__match__result 0)
  (and (< 5 (length buffer))
  ...
  (< 2 1))
  (exists ((ethertype_length_1 (Array Int byte)))
  (and
  ...
  (and (= spark__branch1 (ite (= o6 #x8100) true false))
  ...
  (and (= spark__branch2 (ite (= o8 #x88A8) true false))
  ...
  (and (= spark__branch3 (ite (= o15 #x8100) true false))
  (and (not (= spark__branch3 true)) (= ethernet_dissector__match__result 0)))))))))))))))))))))))))))))))))))))
  (exists ((spark__branch1 Bool) (offset1 Int))
  (and
  (let ((o5 (of_array ethertype_length_1 1 2)))
  (let ((o6 (convert_to_two_octets o5)))
  (and
  ...
  (< 2 1))
  (exists ((ethertype_length_3 (Array Int byte)))
  (and
  ...
  (and (in_range1 o14)
  (and (= o14 r25b)
  (and (dynamic_invariant1 r25b true false true true)
  (let ((o15 (+ (first1 buffer) 13)))
  (and (in_range1 o15)
  (let ((o16 (+ o15 offset1)))
  (and (in_range1 o16)
  (and (= o16 r26b)
  (and (dynamic_invariant1 r26b true false true true)
  (and
  (=> (<= r25b r26b)
  (and (and (<= (first1 buffer) r25b) (<= r25b (last1 buffer)))
  (and (<= (first1 buffer) r26b) (<= r26b (last1 buffer)))))
  (let ((temp___319 (of_array (to_array buffer) r25b r26b)))
  (and
  (ite (<= (first1 temp___319) (last1 temp___319))
  (and (<= 1 2) (= (- (last1 temp___319) (first1 temp___319)) (- 2 1)))
  (< 2 1))
  (exists ((length1 (Array Int byte)))
  (and (= length1 (slide (to_array temp___319) (first1 temp___319) 1))
  (let ((o17 (length buffer)))
  (and (in_range1 o17)
  (let ((o18 (of_array length1 1 2)))
  (let ((o19 (convert_to_two_octets o18)))
  (and
  (and (convert_to_two_octets__function_guard o19 o18) (dynamic_invariant3
  o19 true false true true))
  (let ((o20 (+ 15 offset1)))
  (and (in_range1 o20)
  (let ((o21 (+ o20 (ubv_to_int o19))))
  (and (in_range1 o21)
  (exists ((spark__branch3 Bool))
  (and (= spark__branch3 (ite (= (- o21 1) o17) false true))
  (and (= spark__branch3 true) (= ethernet_dissector__match__result 0))))))))))))))))))))))))))))))
  (let ((o13 (of_array ethertype_length_3 1 2)))
  (let ((o14 (convert_to_two_octets o13)))
  (and
  (and (convert_to_two_octets__function_guard o14 o13) (dynamic_invariant3
  o14 true false true true))
  (let ((o15 (of_array ethertype_length_3 1 2)))
  (let ((o16 (convert_to_two_octets o15)))
  (and
  (and (convert_to_two_octets__function_guard o16 o15) (dynamic_invariant3
  o16 true false true true))
  (exists ((spark__branch3 Bool))
  (and
  (= spark__branch3 (and (ite (bvule #x05DD o16) true false) (ite (bvule o14 #x05FF)
                                                             true false)))
  (and (= spark__branch3 true) (= ethernet_dissector__match__result 0)))))))))))))))))))
  (and
  (let ((o9 (of_array ethertype_length_3 1 2)))
  ...
  (let ((o22 (of_array length1 1 2)))
  (let ((o23 (convert_to_two_octets o22)))
  (and
  (and (convert_to_two_octets__function_guard o23 o22) (dynamic_invariant3
  o23 true false true true))
  (let ((o24 (+ (first1 buffer) (ubv_to_int o23))))
  (and (in_range1 o24)
  (let ((o25 (- o24 1)))
  (and (in_range1 o25)
  (and (= o25 r30b)
  (and (dynamic_invariant1 r30b true false true true)
  (let ((temp___320 (first1 buffer)))
  (=> (<= temp___320 r30b)
  (and (and (<= (first1 buffer) temp___320) (<= temp___320 (last1 buffer)))
  (and (<= (first1 buffer) r30b) (<= r30b (last1 buffer))))))))))))))))))))))))))))))))))))))))))))
  (let ((o13 (of_array ethertype_length_3 1 2)))
  (let ((o14 (convert_to_two_octets o13)))
  (and
  (and (convert_to_two_octets__function_guard o14 o13) (dynamic_invariant3
  ...
  (= spark__branch3 (and (ite (bvule #x05DD o16) true false) (ite (bvule o14 #x05FF)
                                                             true false)))
  (and (not (= spark__branch3 true))
  (let ((o17 (+ (first1 buffer) 12)))
  (and (in_range1 o17)
  (let ((o18 (+ o17 offset1)))
  (and (in_range1 o18)
  (and (= o18 r34b)
  (and (dynamic_invariant1 r34b true false true true)
  (let ((o19 (+ (first1 buffer) 13)))
  (and (in_range1 o19)
  (let ((o20 (+ o19 offset1)))
  (and (in_range1 o20)
  (and (= o20 r35b)
  (and (dynamic_invariant1 r35b true false true true)
  (and
  (=> (<= r34b r35b)
  (and (and (<= (first1 buffer) r34b) (<= r34b (last1 buffer)))
  (and (<= (first1 buffer) r35b) (<= r35b (last1 buffer)))))
  (let ((o21 (length buffer)))
  (and (in_range1 o21)
  (let ((o22 (+ (first1 buffer) o21)))
  (and (in_range1 o22)
  (let ((o23 (- o22 15)))
  (and (in_range1 o23)
  (let ((o24 (- o23 offset1)))
  (and (in_range1 o24)
  (and (= o24 r38b)
  (and (dynamic_invariant1 r38b true false true true)
  (let ((temp___323 (first1 buffer)))
  (=> (<= temp___323 r38b)
  (and (and (<= (first1 buffer) temp___323) (<= temp___323 (last1 buffer)))
  (and (<= (first1 buffer) r38b) (<= r38b (last1 buffer)))))))))))))))))))))))))))))))))))))))))))))))
  (let ((o9 (length buffer)))
