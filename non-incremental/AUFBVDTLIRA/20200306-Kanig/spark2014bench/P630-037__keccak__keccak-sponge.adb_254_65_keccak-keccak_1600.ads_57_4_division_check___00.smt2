...
;; defqtvc
 ;; File "keccak-sponge.ads", line 175, characters 0-0
  ...
  (= (mod2 (in_queue_bit_length (us_repqtmk ctx__split_fields1)) 8) 0))
  ...
  (= o7 (bvlshr suffix ((_ int_to_bv 8) (- 8 (mod2 bit_length 8)))))
  (= o7 #x00))
  (forall ((o8 byte))
  (=> (= (to_rep1 o8) o7)
  (forall ((suffix_array2 (Array Int byte)))
  (=> (= suffix_array2 (store suffix_array1 0 o8))
  (let ((o9 (+ bit_length suffix_len)))
  (=> (in_range1 o9)
  (forall ((ctx__split_fields2 us_split_fields))
  (=>
  ...
  (let ((o15 (in_queue_bit_length o14)))
  (=>
  (and (in_queue_bit_length__function_guard o15 o14)
