...
;; defqtvc
 ;; File "very_longs.ads", line 41, characters 0-0
  ...
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1013) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields3) temp___1025)
               (<= temp___1025 (last1 result____split_fields3)))
               (=>
               (or (< temp___1013 temp___1025)
               (or (< temp___1025 1) (<= i1 temp___1025)))
               (= (select (to_array result____split_fields3) temp___1025) (select 
  ...
  (let ((temp___1014 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1014) i1) (<= i1 (last1 temp___1014)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1014) i1)) o2)
  (exists ((l_digit2 (_ BitVec 16)))
  (and (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1015 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1015) i1) (<= i1 (last1 temp___1015)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1015) i1)) o3)
