...
;; defqtvc
 ;; File "linted-update.ads", line 41, characters 0-0
  ...
  (let ((o20 (ubv_to_int x5))) (and (in_range o20) (= y5 o20)))
  (let ((o20 (ubv_to_int (bvnot x5))))
  (and (in_range o20)
  (let ((o21 (- (- o20) 1))) (and (in_range1 o21) (= y5 o21))))))
  (=> (= (to_rep o4) y5)
  ...
  (let ((o20 (ubv_to_int x6))) (and (in_range o20) (= y6 o20)))
  (let ((o20 (ubv_to_int (bvnot x6))))
  (and (in_range o20)
  (let ((o21 (- (- o20) 1))) (and (in_range1 o21) (= y6 o21))))))
  (=> (= (to_rep o9) y6)
  (=>
  ...
  (let ((o20 (ubv_to_int x7))) (and (in_range o20) (= y7 o20)))
  (let ((o20 (ubv_to_int (bvnot x7))))
  (and (in_range o20)
  (let ((o21 (- (- o20) 1))) (and (in_range1 o21) (= y7 o21))))))
  (=> (= (to_rep o14) y7)
  (=>
  ...
  (let ((o20 (ubv_to_int x8))) (and (in_range o20) (= y8 o20)))
  (let ((o20 (ubv_to_int (bvnot x8))))
  (and (in_range o20)
  (let ((o21 (- (- o20) 1))) (and (in_range1 o21) (= y8 o21))))))
  (=> (= (to_rep o19) y8)
  (=>
  (=> (<= 17 20) (and (and (<= 1 17) (<= 17 32)) (and (<= 1 20) (<= 20 32))))
  (=> (= (slide s 17 1) c127b)
  (=> (dynamic_invariant1 x4 false false true true)
  (=> (dynamic_invariant y4 false false true true) (=> (<= 17 20) (<= 1 17)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
