...
(define-fun to_int3 ((x byte)) Int (ubv_to_int (to_rep1 x)))
...
(define-fun to_int4 ((x lane_type)) Int (ubv_to_int (to_rep2 x)))
...
;; defqtvc
 ;; File "keccak-keccakf-byte_lanes.ads", line 51, characters 0-0
  (not
  (forall ((spark__branch Bool) (lane (_ BitVec 64)) (x (_ BitVec 8))
  (y (_ BitVec 8)) (o Int) (o1 Int))
  ...
  (forall ((spark__branch1 Bool) (data1 (Array Int byte)) (x1 (_ BitVec 8))
  (y1 (_ BitVec 8)) (remaining_bytes1 Int) (offset1 Int)
  (lane1 (_ BitVec 64)))
  (=>
  (ite (<= 8 remaining_bytes)
  (exists ((o6 Int))
  (and (= (to_rep data__last) o6)
  (exists ((o7 Int))
  (and (= (to_rep data__first) o7)
  (and (in_range1 (length o7 o6))
  (and (in_range1 (+ offset remaining_bytes))
  (exists ((data2 (Array Int byte)) (x2 (_ BitVec 8)) (y2 (_ BitVec 8))
  (remaining_bytes2 Int) (offset2 Int) (lane2 (_ BitVec 64)))
  (and
  (and (= (mod2 offset2 8) 0)
  (= (+ offset2 remaining_bytes2) (length (to_rep data__first)
                                  (to_rep data__last))))
  (and
  (= (and (ite (and
               (and
               (and
               (and (dynamic_invariant2 x2 true true true true)
               ...
               (dynamic_invariant1 lane2 false true true true))
          true false) (ite (<= 8 remaining_bytes2) true false)) true)
  (exists ((temp___802 Int))
  (and (= temp___802 offset2)
  (exists ((temp___801 Int))
  (and (= temp___801 remaining_bytes2)
  (exists ((o8 (_ BitVec 64)))
  (and (= (to_rep2 (get a x2 y2)) o8)
  (and (= lane1 o8)
  (exists ((i Int))
  (and (= i 0)
  (let ((o9 (* i 8)))
  ...
  (exists ((o10 byte))
  (and
  (= (to_rep1 o10) ((_ extract 7 0) (bvand (bvlshr lane1 ((_ int_to_bv 64) o9)) #x00000000000000FF)))
  (exists ((o11 Int))
  (and (= (to_rep data__first) o11)
  (let ((o12 (+ o11 offset2)))
  (and (in_range1 o12)
  (let ((o13 (+ o12 i)))
  (and (in_range1 o13)
  (and (and (<= (to_rep data__first) o13) (<= o13 (to_rep data__last)))
  (exists ((data3 (Array Int byte)))
  (and (= data3 (store data2 o13 o10))
  (exists ((i1 Int))
  (and (= i1 1)
  (let ((o14 (* i1 8)))
  (and (in_range1 o14)
  ...
  (exists ((o15 byte))
  (and
  (= (to_rep1 o15) ((_ extract 7 0) (bvand (bvlshr lane1 ((_ int_to_bv 64) o14)) #x00000000000000FF)))
  (exists ((o16 Int))
  (and (= (to_rep data__first) o16)
  (let ((o17 (+ o16 offset2)))
  (and (in_range1 o17)
  (let ((o18 (+ o17 i1)))
  (and (in_range1 o18)
  (and (and (<= (to_rep data__first) o18) (<= o18 (to_rep data__last)))
  (exists ((data4 (Array Int byte)))
  (and (= data4 (store data3 o18 o15))
  (exists ((i2 Int))
  (and (= i2 2)
  (let ((o19 (* i2 8)))
  (and (in_range1 o19)
  ...
  (exists ((o20 byte))
  (and
  (= (to_rep1 o20) ((_ extract 7 0) (bvand (bvlshr lane1 ((_ int_to_bv 64) o19)) #x00000000000000FF)))
  (exists ((o21 Int))
  (and (= (to_rep data__first) o21)
  (let ((o22 (+ o21 offset2)))
  (and (in_range1 o22)
  (let ((o23 (+ o22 i2)))
  (and (in_range1 o23)
  (and (and (<= (to_rep data__first) o23) (<= o23 (to_rep data__last)))
  (exists ((data5 (Array Int byte)))
  (and (= data5 (store data4 o23 o20))
  (exists ((i3 Int))
  (and (= i3 3)
  (let ((o24 (* i3 8)))
  (and (in_range1 o24)
  ...
  (exists ((o25 byte))
  (and
  (= (to_rep1 o25) ((_ extract 7 0) (bvand (bvlshr lane1 ((_ int_to_bv 64) o24)) #x00000000000000FF)))
  (exists ((o26 Int))
  (and (= (to_rep data__first) o26)
  (let ((o27 (+ o26 offset2)))
  (and (in_range1 o27)
  (let ((o28 (+ o27 i3)))
  (and (in_range1 o28)
  (and (and (<= (to_rep data__first) o28) (<= o28 (to_rep data__last)))
  (exists ((data6 (Array Int byte)))
  (and (= data6 (store data5 o28 o25))
  (exists ((i4 Int))
  (and (= i4 4)
  (let ((o29 (* i4 8)))
  (and (in_range1 o29)
  ...
  (exists ((o30 byte))
  (and
  (= (to_rep1 o30) ((_ extract 7 0) (bvand (bvlshr lane1 ((_ int_to_bv 64) o29)) #x00000000000000FF)))
  (exists ((o31 Int))
  (and (= (to_rep data__first) o31)
  (let ((o32 (+ o31 offset2)))
  (and (in_range1 o32)
  (let ((o33 (+ o32 i4)))
  (and (in_range1 o33)
  (and (and (<= (to_rep data__first) o33) (<= o33 (to_rep data__last)))
  (exists ((data7 (Array Int byte)))
  (and (= data7 (store data6 o33 o30))
  (exists ((i5 Int))
  (and (= i5 5)
  (let ((o34 (* i5 8)))
  (and (in_range1 o34)
  ...
  (exists ((o35 byte))
  (and
  (= (to_rep1 o35) ((_ extract 7 0) (bvand (bvlshr lane1 ((_ int_to_bv 64) o34)) #x00000000000000FF)))
  (exists ((o36 Int))
  (and (= (to_rep data__first) o36)
  (let ((o37 (+ o36 offset2)))
  (and (in_range1 o37)
  (let ((o38 (+ o37 i5)))
  (and (in_range1 o38)
  (and (and (<= (to_rep data__first) o38) (<= o38 (to_rep data__last)))
  (exists ((data8 (Array Int byte)))
  (and (= data8 (store data7 o38 o35))
  (exists ((i6 Int))
  (and (= i6 6)
  (let ((o39 (* i6 8)))
  (and (in_range1 o39)
  ...
  (exists ((o40 byte))
  (and
  (= (to_rep1 o40) ((_ extract 7 0) (bvand (bvlshr lane1 ((_ int_to_bv 64) o39)) #x00000000000000FF)))
  (exists ((o41 Int))
  (and (= (to_rep data__first) o41)
  (let ((o42 (+ o41 offset2)))
  (and (in_range1 o42)
  (let ((o43 (+ o42 i6)))
  (and (in_range1 o43)
  (and (and (<= (to_rep data__first) o43) (<= o43 (to_rep data__last)))
  (exists ((data9 (Array Int byte)))
  (and (= data9 (store data8 o43 o40))
  (exists ((i7 Int))
  (and (= i7 7)
  (let ((o44 (* i7 8)))
  (and (in_range1 o44)
  ...
  (exists ((o45 byte))
  (and
  (= (to_rep1 o45) ((_ extract 7 0) (bvand (bvlshr lane1 ((_ int_to_bv 64) o44)) #x00000000000000FF)))
  (exists ((o46 Int))
  (and (= (to_rep data__first) o46)
  (let ((o47 (+ o46 offset2)))
  (and (in_range1 o47)
  (let ((o48 (+ o47 i7)))
  (and (in_range1 o48)
  (and (and (<= (to_rep data__first) o48) (<= o48 (to_rep data__last)))
  (and (= data1 (store data9 o48 o45))
  (exists ((o49 (_ BitVec 8)))
  (and
  (let ((temp___790 (bvadd x2 #x01)))
  (ite (bvule (bvsub #x05 x2) #x01) (= o49 (bvsub temp___790 #x05))
  (= o49 temp___790)))
  (and (= x1 o49)
  (and
  (and (= spark__branch1 (ite (= x1 #x00) true false))
  (ite (= spark__branch1 true)
  (exists ((o50 (_ BitVec 8)))
  (and
  (let ((temp___791 (bvadd y2 #x01)))
  (ite (bvule (bvsub #x05 y2) #x01) (= o50 (bvsub temp___791 #x05))
  (= o50 temp___791))) (= y1 o50))) (= y1 y2)))
  (let ((o50 (- remaining_bytes2 8)))
  (and (in_range2 o50)
  (and (= remaining_bytes1 o50)
  (let ((o51 (+ offset2 8)))
  (and (in_range1 o51) (and (= offset1 o51) (not (<= 8 remaining_bytes1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
  (and
  (and
  (and
  (and (and (and (= spark__branch1 spark__branch) (= data1 data)) (= x1 x))
  (= y1 y)) (= remaining_bytes1 remaining_bytes)) (= offset1 offset))
  (= lane1 lane)))
  (forall ((spark__branch2 Bool))
  (=> (= spark__branch2 (ite (< 0 remaining_bytes1) true false))
  (=> (= spark__branch2 true)
  (forall ((o6 (_ BitVec 64)))
  (=> (= (to_rep2 (get a x1 y1)) o6)
  (forall ((lane2 (_ BitVec 64)))
  (=> (= lane2 o6)
  (forall ((shift Int))
  (=> (= shift 0)
  (=> (dynamic_invariant shift true false true true)
  (forall ((initial_offset Int))
  ...
  (=> (in_range1 (* o7 8))
  (forall ((o8 Int))
  (=> (= (to_rep data__last) o8)
  (forall ((o9 Int))
  (=> (= (to_rep data__first) o9)
  (=> (in_range1 (length o9 o8))
  (=> (in_range1 (+ offset1 remaining_bytes1))
  (forall ((data2 (Array Int byte)) (remaining_bytes2 Int) (offset2 Int)
  (shift1 Int))
  (=>
  (and
  (and
  (= (+ offset2 remaining_bytes2) (length (to_rep data__first)
                                  (to_rep data__last)))
  (= (mod2 shift1 8) 0)) (= shift1 (* (- offset2 initial_offset) 8)))
  (=>
  (= (and (ite (and
               (and (dynamic_invariant shift1 true true true true)
               (dynamic_invariant remaining_bytes2 true true true true))
               (dynamic_invariant offset2 true true true true))
          true false) (ite (< 0 remaining_bytes2) true false)) true)
  (forall ((temp___813 Int))
  (=> (= temp___813 offset2)
  (forall ((temp___812 Int))
  (=> (= temp___812 shift1)
  (forall ((temp___811 Int))
  (=> (= temp___811 remaining_bytes2)
  (forall ((o10 byte))
  (=>
  (= (to_rep1 o10) ((_ extract 7 0) (bvand (bvlshr lane2 ((_ int_to_bv 64) shift1)) #x00000000000000FF)))
  (forall ((o11 Int))
  (=> (= (to_rep data__first) o11)
  (let ((o12 (+ o11 offset2)))
  (=> (in_range1 o12)
  (=> (and (<= (to_rep data__first) o12) (<= o12 (to_rep data__last)))
  (forall ((data3 (Array Int byte)))
  (=> (= data3 (store data2 o12 o10))
  (let ((o13 (+ shift1 8)))
  (=> (in_range1 o13)
  (forall ((shift2 Int))
  (=> (= shift2 o13)
  ...
  (forall ((offset3 Int))
  (=> (= offset3 o14)
  (let ((o15 (- remaining_bytes2 1)))
  (=> (in_range2 o15)
  (forall ((remaining_bytes3 Int))
  (=> (= remaining_bytes3 o15)
  (=> (< 0 remaining_bytes3)
  (let ((o16 (- offset3 initial_offset)))
  (=> (in_range1 o16)
  (=> (in_range1 (* o16 8))
  (forall ((o17 Int))
  (=> (= (to_rep data__last) o17)
  (forall ((o18 Int))
  (=> (= (to_rep data__first) o18)
  (=> (in_range1 (length o18 o17))
  (=> (in_range1 (+ offset3 remaining_bytes3))
  (= (+ offset3 remaining_bytes3) (length (to_rep data__first)
                                  (to_rep data__last)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
