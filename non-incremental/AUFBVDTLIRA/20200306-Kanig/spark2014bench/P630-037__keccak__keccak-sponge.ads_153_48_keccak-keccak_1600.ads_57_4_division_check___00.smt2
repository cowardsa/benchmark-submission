...
;; defqtvc
 ;; File "keccak-sponge.ads", line 146, characters 0-0
  (not
  (forall ((ctx__split_fields us_split_fields) (o Bool))
  ...
  (let ((o2 (state_of o1)))
  (and
  (and (state_of__function_guard o2 o1)
  (and (dynamic_invariant3 o2 true false true true)
  (= o2 (to_rep3
        (rec__ada___keccak__keccak_1600__sponge__context__curr_state
        ctx__split_fields)))))
  (ite (and (= o2 0) (<= bit_length 2147483640))
  (let ((o3 (length data)))
  (and (in_range1 o3)
  (let ((o4 (+ bit_length 7)))
  (and (in_range1 o4) (= o (ite (<= (div1 o4 8) o3) true false))))))
  (= o false)))))
  (=> (= o true)
  (let ((o1 (us_repqtmk ctx__split_fields)))
  (let ((o2 (in_queue_bit_length o1)))
  (=>
  (and (in_queue_bit_length__function_guard o2 o1)
