...
;; defqtvc
 ;; File "names.ads", line 44, characters 0-0
  ...
  (let ((o9 (us_repqtmk entry_table__split_discrs
            (us_split_fieldsqtmk entry_table__split_fields))))
  (let ((o10 (element o9 ptr2)))
  (=> (= (bool_eq3 o10 (get (model1 o9) ptr2)) true)
  (forall ((o11 Int))
  (=>
  (= (to_rep5
  ...
  (forall ((ptr3 Int))
  (=> (= ptr3 o11)
  (let ((temp___5451 (to_string ptr3 hash_table
                     (us_split_fieldsqtmk1 char_table__split_fields)
                     (us_split_fieldsqtmk entry_table__split_fields))))
  (=>
  (and (to_string__function_guard temp___5451 ptr3 hash_table
  (us_split_fieldsqtmk1 char_table__split_fields)
  (us_split_fieldsqtmk entry_table__split_fields)) (dynamic_invariant
  ...
  (let ((o12 (invariant__ hash_table
             (us_split_fieldsqtmk1 char_table__split_fields)
             (us_split_fieldsqtmk entry_table__split_fields))))
  (=>
  (forall ((entry_table__split_fields1 us_main_type)
  ...
  hash_table1 (us_split_fieldsqtmk entry_table__split_fields1)))
  (=>
  (and (invariant____function_guard o12 hash_table
  (us_split_fieldsqtmk1 char_table__split_fields)
  (us_split_fieldsqtmk entry_table__split_fields))
  (= (= o12 true)
  (and
  ...
  (= (valid_hashes hash_table
     (us_split_fieldsqtmk entry_table__split_fields)) true))))
  (let ((o13 (us_repqtmk entry_table__split_discrs
             (us_split_fieldsqtmk entry_table__split_fields))))
  (let ((o14 (last_index o13)))
  (=>
  (and (dynamic_invariant2 o14 true false true true)
  (= o14 (last2 (model1 o13)))) (in_range11 ptr3)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
