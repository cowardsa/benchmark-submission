...
;; defqtvc
 ;; File "very_longs-divide.adb", line 51, characters 0-0
  ...
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1295) true false)) true)
  ...
  (= (and (ite (and
               ...
               true))
               (forall ((temp___1308 Int))
               (=>
               (and (<= (first1 result____split_fields3) temp___1308)
               (<= temp___1308 (last1 result____split_fields3)))
               (=>
               (or (< temp___1295 temp___1308)
               (or (< temp___1308 1) (<= i1 temp___1308)))
               (= (select (to_array result____split_fields3) temp___1308) (select 
               (to_array result____split_fields1) temp___1308))))))
  ...
  (let ((temp___1296 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 number))))
  (and (and (<= (first1 temp___1296) i1) (<= i1 (last1 temp___1296)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1296) i1)) o2)
  ...
  (and
  (ite (< distance 8)
  (let ((temp___1297 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 number))))
  (and (and (<= (first1 temp___1297) i1) (<= i1 (last1 temp___1297)))
  (exists ((o6 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1297) i1)) o6)
  ...
  (and (= old_overflow1 new_overflow2) (= i1 temp___1295))))))))))))))))))))))))))))
