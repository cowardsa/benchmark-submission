...
;; defqtvc
 ;; File "random.ads", line 51, characters 0-0
  (not
  (forall ((value Int) (x (_ BitVec 32)) (x1 (_ BitVec 32)))
  ...
  (= spark__branch (and (ite (= min1 (- 2147483648)) true false) (ite (= 
                                                                 max1 2147483647)
                                                                 true false)))
  (ite (= spark__branch true) (dynamic_invariant1 x1 true true true true)
  (let ((o (+ (- max1 min1) 1)))
  (and (uint_in_range o)
  (and (= ((_ int_to_bv 32) o) n)
  (and (dynamic_invariant1 n true false true true)
  (and (= (bvadd (bvurem #xFFFFFFFF n) #x00000001) slop)
  (and (dynamic_invariant1 slop true false true true)
  (exists ((x2 (_ BitVec 32)))
  (and
  (exists ((x3 (_ BitVec 32)))
  (and (dynamic_invariant1 x3 false true true true)
  (and (dynamic_invariant1 x2 true true true true)
  (=> (not (= slop n)) (bvule x2 (bvsub #xFFFFFFFF slop))))))
  (and (= x1 (bvurem x2 n))
  (and (bvule #x00000000 x1) (bvule x1 (bvsub n #x00000001)))))))))))))))
  (let ((o (+ min1 (ubv_to_int x1))))
  (=> (in_range1 o)
