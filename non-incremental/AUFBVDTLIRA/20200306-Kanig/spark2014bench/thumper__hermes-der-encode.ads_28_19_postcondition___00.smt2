...
;; defqtvc
 ;; File "hermes-der-encode.ads", line 27, characters 0-0
  ...
  (ada___ada___hermes__der__encode__put_boolean_value__boolean_octet_array__assume us_t)
  (ada___ada___hermes__der__encode__put_boolean_value__result us_t))
  (=>
  (ite (= value true)
  ...
  (and (= (to_rep1 o1) #x01)
  (exists ((o2 octet))
  (and (= (to_rep1 o2) temp___393)
  (let ((temp___395 (of_array (concat_singletons o2 0 o1) 0 o)))
  (ite (= (length1 temp___395) 0)
  (exists ((o3 octet))
  (and (= (to_rep1 o3) boolean_value_octet)
  (= ada___ada___hermes__der__encode__put_boolean_value__boolean_octet_array__assume 
  (of_array (singleton1 o3 0) 0 0))))
  (let ((o3 (- (+ (first1 temp___395) (+ (length (first1 temp___395)
                                         (last1 temp___395)) 1)) 1)))
  (and (in_range o3)
  (exists ((o4 octet))
  (and (= (to_rep1 o4) boolean_value_octet)
  (= ada___ada___hermes__der__encode__put_boolean_value__boolean_octet_array__assume 
  (of_array
  (concat_singleton_right (to_array temp___395) (first1 temp___395)
  (last1 temp___395) o4) (first1 temp___395) o3))))))))))))))))
  (=>
  (= ada___ada___hermes__der__encode__put_boolean_value__boolean_octet_array__assume 
  boolean_octet_array)
  (=> (dynamic_invariant4 boolean_octet_array true false true true)
  (=>
