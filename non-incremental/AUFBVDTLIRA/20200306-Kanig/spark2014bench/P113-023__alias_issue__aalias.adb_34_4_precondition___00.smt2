...
(define-fun to_int3 ((x m64_type)) Int (ubv_to_int (to_rep x)))
...
(define-fun to_int4 ((x byte)) Int (ubv_to_int (to_rep1 x)))
...
;; defqtvc
 ;; File "aalias.adb", line 1, characters 0-0
  ...
  (= (length (ubv_to_int (to_rep o3)) (ubv_to_int (to_rep o2))) (length
                                                        (ubv_to_int (to_rep o1))
                                                        (ubv_to_int (to_rep o))))))))))))))
(check-sat)
(exit)
