...
(assert
;; defqtvc
 ;; File "x86.ads", line 491, characters 0-0
  (not
  (forall ((rcx (_ BitVec 64)) (rsi (_ BitVec 64)) (rdi (_ BitVec 64))
  (val1 (_ BitVec 8)) (val2 (_ BitVec 8)) (rcx1 (_ BitVec 64))
  (rsi1 (_ BitVec 64)) (rdi1 (_ BitVec 64)) (val11 (_ BitVec 8))
  (val21 (_ BitVec 8)))
  ...
  (= (and (ite (and
               (and
               (and
               (and (dynamic_invariant1 val21 false true true true)
