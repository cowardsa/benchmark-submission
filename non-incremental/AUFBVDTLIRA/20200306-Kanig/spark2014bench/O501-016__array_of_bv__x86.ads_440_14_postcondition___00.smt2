...
;; defqtvc
 ;; File "x86.ads", line 438, characters 0-0
  ...
  (= (bvor (bvshl ((_ zero_extend 24) (readmem8
                                      (bvadd addr #x0000000000000002) memory)) ((_ int2bv 32) 16)) (bvshl ((_ zero_extend 24) 
  ...
  (=>
  (= x86__readmem32__result (bvor (bvor (bvor ((_ zero_extend 24) o7) (bvshl ((_ zero_extend 24) o5) ((_ int2bv 32) 8))) (bvshl ((_ zero_extend 24) o3) ((_ int2bv 32) 16))) (bvshl ((_ zero_extend 24) o1) ((_ int2bv 32) 24))))
  (=>
  (forall ((memory1 (Array (_ BitVec 64) unsigned8)))
  (readmem16__function_guard (readmem16 addr memory1) addr memory1))
  (=>
