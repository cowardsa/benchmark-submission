...
;; readmem16__post_axiom
  ...
  (! (=> (dynamic_invariant addr true true true true)
     ...
     (bvshl ((_ zero_extend 8) (to_rep
                               (select x86__memory (bvadd addr #x0000000000000001)))) ((_ int_to_bv 16) 8))
...
;; defqtvc
 ;; File "x86.ads", line 438, characters 0-0
  ...
  (= (bvor (bvshl ((_ zero_extend 24) (readmem8
                                      (bvadd addr #x0000000000000002) memory)) ((_ int_to_bv 32) 16)) (bvshl ((_ zero_extend 24) 
  (readmem8 (bvadd addr #x0000000000000003) memory)) ((_ int_to_bv 32) 24))) (bvshl ((_ zero_extend 16) 
  (readmem16 (bvadd addr #x0000000000000002) memory)) ((_ int_to_bv 32) 16)))
  (let ((o (bvadd addr #x0000000000000003)))
  (let ((o1 (readmem8 o memory)))
  (=>
  (and (readmem8__function_guard o1 o memory)
  (and (dynamic_invariant1 o1 true false true true)
  (= o1 (to_rep (select memory o)))))
  ...
  (let ((o4 (bvadd addr #x0000000000000001)))
  (let ((o5 (readmem8 o4 memory)))
  (=>
  (and (readmem8__function_guard o5 o4 memory)
  (and (dynamic_invariant1 o5 true false true true)
  (= o5 (to_rep (select memory o4)))))
  (let ((o6 addr))
  (let ((o7 (readmem8 o6 memory)))
  (=>
  (and (readmem8__function_guard o7 o6 memory)
  (and (dynamic_invariant1 o7 true false true true)
  (= o7 (to_rep (select memory o6)))))
  (forall ((x86__readmem32__result (_ BitVec 32)))
  (=>
  (= x86__readmem32__result (bvor (bvor (bvor ((_ zero_extend 24) o7) (bvshl ((_ zero_extend 24) o5) ((_ int_to_bv 32) 8))) (bvshl ((_ zero_extend 24) o3) ((_ int_to_bv 32) 16))) (bvshl ((_ zero_extend 24) o1) ((_ int_to_bv 32) 24))))
  (=>
  (forall ((memory1 (Array (_ BitVec 64) unsigned8)))
  (readmem16__function_guard (readmem16 addr memory1) addr memory1))
  (=>
