...
;; defqtvc
 ;; File "keccak-keccakf-byte_lanes.ads", line 66, characters 0-0
  (not
  (forall ((data (Array Int byte)) (spark__branch Bool) (o (_ BitVec 8))
  (temp___818 Int) (o1 (_ BitVec 8)) (o2 byte) (temp___820 Int))
  ...
  (=>
  (= spark__branch (and (ite (< 0 bit_len) true false) (ite (= (mod2 
                                                               bit_len 8) 0)
                                                       false true)))
  (=> (= spark__branch true)
  (=>
  ...
  (=> (<= temp___818 (to_rep data__last))
  (=> (= (to_rep1 (select data temp___818)) o1)
  (=> (= (to_rep1 o2) (bvand o1 (bvsub o #x01)))
