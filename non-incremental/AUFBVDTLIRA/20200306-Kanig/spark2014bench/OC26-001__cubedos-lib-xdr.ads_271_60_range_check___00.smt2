...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 258, characters 0-0
  (not
  (forall ((last2 Int) (o Int) (o1 Int))
  (=> (dynamic_invariant3 data true false true true)
  (=> (dynamic_invariant1 position true false true true)
  (=> (dynamic_property 0 65535 (to_rep value__first) (to_rep value__last))
  (=> (dynamic_invariant2 last2 false false true true)
  (=> (= (mod1 position 4) 0)
  (=> (= (mod1 (length1 data) 4) 0)
  (=> (<= (first1 data) position)
  (=> (<= position (last1 data))
  (=> (length_with_padding__function_guard
  (length_with_padding (length (to_rep value__first) (to_rep value__last)))
  (length (to_rep value__first) (to_rep value__last)))
  (=>
  (<= (+ position (- (length_with_padding
                     (length (to_rep value__first) (to_rep value__last))) 1)) 
  (last1 data))
  (=> (= (to_rep value__last) o)
  (=> (= (to_rep value__first) o1)
  (let ((o2 (length o1 o)))
  (=> (in_range1 o2)
  (let ((temp___611 (- (+ position o2) 1)))
  (=>
  (=> (<= position temp___611)
  (and (and (<= (first1 data) position) (<= position (last1 data)))
  (and (<= (first1 data) temp___611) (<= temp___611 (last1 data)))))
  (let ((temp___612 (of_array (to_array data) position temp___611)))
  (let ((temp___613 (of_array (to_array temp___612) (first1 temp___612)
                    (last1 temp___612))))
  (=>
  (ite (<= (first1 temp___613) (last1 temp___613))
  (and (<= (to_rep value__first) (to_rep value__last))
  (= (- (last1 temp___613) (first1 temp___613)) (- (to_rep value__last) 
  (to_rep value__first)))) (< (to_rep value__last) (to_rep value__first)))
  (forall ((o3 Int))
  (=> (= (to_rep value__first) o3)
  (forall ((value (Array Int octet)))
  (=> (= value (slide (to_array temp___613) (first1 temp___613) o3))
  (forall ((o4 Int))
  (=> (= (to_rep value__last) o4)
  (forall ((o5 Int))
  (=> (= (to_rep value__first) o5)
  (let ((o6 (length o5 o4)))
  (=> (in_range2 o6)
  (let ((o7 (length_with_padding o6)))
  (=>
  (and (length_with_padding__function_guard o7 o6)
  (and (dynamic_invariant o7 true false true true)
  (= o7 (+ o6 (ite (= (mod1 o6 4) 0) 0 (- 4 (mod1 o6 4)))))))
  (let ((o8 (+ position (- o7 1))))
  (=> (in_range4 o8)
  (forall ((last3 Int))
  (=> (= last3 o8)
  (forall ((o9 Int))
  (=> (= (to_rep value__last) o9)
  (forall ((o10 Int))
  (=> (= (to_rep value__first) o10) (in_range2 (length o10 o9))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
