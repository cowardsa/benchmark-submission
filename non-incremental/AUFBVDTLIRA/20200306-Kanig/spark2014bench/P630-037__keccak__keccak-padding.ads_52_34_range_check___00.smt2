...
;; defqtvc
 ;; File "keccak-padding.ads", line 43, characters 0-0
  (not
  (forall ((o Int) (o1 Int) (o2 Int) (o3 Int) (o4 Int) (o5 Int))
  (=> (dynamic_property 0 2147483647 (to_rep first_block__first)
  (to_rep first_block__last))
  (=> (dynamic_invariant num_used_bits true false true true)
  (=> (dynamic_invariant max_bit_length true false true true)
  (=> (dynamic_property 0 2147483647 (to_rep next_block__first)
  (to_rep next_block__last))
  (=> (= (to_rep first_block__last) o)
  (=> (= (to_rep first_block__first) o1)
  (=> (= (to_rep next_block__last) o2)
  (=> (= (to_rep next_block__first) o3)
  (=> (= (length o3 o2) (length o1 o))
  (=> (= (to_rep first_block__last) o4)
  (=> (= (to_rep first_block__first) o5) (in_range (length o5 o4))))))))))))))))
(check-sat)
(exit)
