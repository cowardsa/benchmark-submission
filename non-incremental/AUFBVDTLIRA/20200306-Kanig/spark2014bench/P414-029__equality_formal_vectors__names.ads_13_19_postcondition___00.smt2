...
;; defqtvc
 ;; File "names.ads", line 9, characters 0-0
  ...
  (exists ((ptr Int))
  (and (= ptr 0)
  (and (dynamic_invariant3 ptr true false true true)
  (let ((o (hash s)))
  (and (dynamic_invariant7 o true false true true)
  (let ((o1 (bvurem o #x00000100)))
  (and (in_range13 o1)
  (and (= o1 h)
  (and (dynamic_invariant8 h true false true true)
  ...
  (and (= spark__branch1 (ite (in_range12 n1) true false))
  ...
  (exists ((char_table__split_fields1 us_main_type))
  (and
  ...
  (and (in_range14 o8)
  (and (in_range10 o8)
  (exists ((o9 char_table_index))
  (and (= (to_rep6 o9) o8)
  (let ((o10 entry_table__split_discrs))
  (exists ((names__entry_tables__append__2__container__fields us_main_type1))
  (and
  (and
  (and
  (= (length5
  ...
  (exists ((entry_table__split_fields1 us_main_type1))
  (and
  ...
  (and (= n2 o12)
  (exists ((spark__branch2 Bool))
  (and (= spark__branch2 (ite (in_range12 ptr1) true false))
  (ite (= spark__branch2 true)
  (and (in_range15 ptr1)
  (let ((o13 (us_repqtmk1 entry_table__split_discrs
             (us_split_fieldsqtmk1 entry_table__split_fields1))))
  (let ((temp___665 (element o13 ptr1)))
  (and (= (bool_eq4 temp___665 (get1 (model2 o13) ptr1)) true)
  (let ((q_ (us_split_fields5 temp___665)))
  (exists ((o14 name_id))
  (and (= (to_rep5 o14) n2)
  (and (in_range15 ptr1)
  (let ((o15 entry_table__split_discrs))
  (exists
  ((names__entry_tables__replace_element__container__fields us_main_type1))
  (and
  (and
  (= (length5
     (us_repqtmk1 o15
     (us_split_fieldsqtmk1
     names__entry_tables__replace_element__container__fields))) (length5
                                                                (us_repqtmk1
                                                                o15
                                                                (us_split_fieldsqtmk1
  ...
  (= (bool_eq4
     ...
     (us_repqtmk1 o15
     (us_split_fieldsqtmk1
     names__entry_tables__replace_element__container__fields))) ptr1)
     (us_repqtmk2
     (us_split_fieldsqtmk2 (rec__names__name_entry__table_index q_)
     (rec__names__name_entry__length q_) o14))) true))
  (= (equal_except
     (model2
     (us_repqtmk1 o15 (us_split_fieldsqtmk1 entry_table__split_fields1)))
     (model2
     (us_repqtmk1 o15
     (us_split_fieldsqtmk1
     names__entry_tables__replace_element__container__fields))) ptr1) true))))))))))))
  (exists ((o13 name_id)) (= (to_rep5 o13) n2)))))))))))))))))))))))))))))))))))))))))))))))))))))
  (=> (invariant____function_guard (invariant__ Tuple0) Tuple0)
  (= (invariant__ Tuple0) true))))))))))))
(check-sat)
(exit)
