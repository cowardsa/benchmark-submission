...
(declare-datatypes ((s7b__ref 0))
(((s7b__refqtmk (s7b__content us_t)))))
(define-fun s7b__ref_s7b__content__projection ((a s7b__ref)) us_t (s7b__content
                                                                  a))
...
(declare-fun temp_____aggregate_def_1456 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1458 (_ BitVec 8)))
  (forall ((temp___1459 Int) (temp___1460 Int))
  (let ((temp___1457 (temp_____aggregate_def_1456 temp___1458 temp___1459
                     temp___1460)))
  (=> (dynamic_invariant3 temp___1458 true true true true)
  (and
  (=> (dynamic_property 1 2147483647 temp___1459 temp___1460)
  (and (= (first1 temp___1457) temp___1459)
  (= (last1 temp___1457) temp___1460)))
  (forall ((temp___1461 Int))
  (= (to_rep2 (select (to_array temp___1457) temp___1461)) temp___1458))))))))
...
(define-fun dynamic_invariant6 ((temp___expr_473 us_t)
  (temp___is_init_469 Bool) (temp___skip_constant_470 Bool)
  (temp___do_toplevel_471 Bool)
  (temp___do_typ_inv_472 Bool)) Bool (=>
                                     (not (= temp___skip_constant_470 true))
                                     (and (dynamic_property 1 r8b
                                     (first1 temp___expr_473)
                                     (last1 temp___expr_473))
                                     (and (= (first1 temp___expr_473) 1)
                                     (= (last1 temp___expr_473) r8b)))))

(define-fun default_initial_assumption ((temp___expr_475 us_t)
  (temp___skip_top_level_476 Bool)) Bool (and (= (first1 temp___expr_475) 1)
                                         (= (last1 temp___expr_475) r8b)))
...
;; defqtvc
 ;; File "aco-math-very_longs.adb", line 39, characters 0-0
  ...
  (ada___ada___aco__math__very_longs__modadd_and_carry__R8b__assume Int))
  ...
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     result____split_discrs)) ada___ada___aco__math__very_longs__modadd_and_carry__R8b__assume)
  (=>
  (= ada___ada___aco__math__very_longs__modadd_and_carry__R8b__assume 
  r8b)
  (=> (dynamic_invariant4 r8b true false true true)
  (let ((temp___1462 (temp_____aggregate_def_1456 #x00 1 r8b)))
  (=> (= (first1 temp___1462) 1)
  (=> (= (last1 temp___1462) r8b)
  (=>
  (ite (<= (first1 temp___1462) (last1 temp___1462))
  (and (<= 1 r8b) (= (- (last1 temp___1462) (first1 temp___1462)) (- r8b 1)))
  (< r8b 1))
  (let ((temp___1464 (of_array (to_array temp___1462) (first1 temp___1462)
                     (last1 temp___1462))))
  (=>
  (ite (<= (first1 temp___1464) (last1 temp___1464))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1464) (first1 temp___1464)) (- (last1
  ...
  (=>
  (= result____split_fields1 (of_array (to_array temp___1464)
                             (first1 temp___1464) (last1 temp___1464)))
  (forall ((carry1 (_ BitVec 16)))
  (=> (= carry1 #x0000)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1470 (last1
                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1470) true false)) true)
  (exists ((result____split_fields3 us_t) (carry2 (_ BitVec 16))
  ...
  (= (and (ite (and
               ...
               (and
               (and
               (and (dynamic_invariant2 sum1 false true true true)
               (dynamic_invariant
               (us_repqtmk result____split_discrs
               (us_split_fieldsqtmk result____split_fields3)) false true true
               true))
               (forall ((temp___1479 Int))
               (=>
               (and (<= (first1 result____split_fields3) temp___1479)
               (<= temp___1479 (last1 result____split_fields3)))
               (=>
               (or (< temp___1470 temp___1479)
               (or (< temp___1479 1) (<= i1 temp___1479)))
               (= (select (to_array result____split_fields3) temp___1479) (select 
               (to_array result____split_fields1) temp___1479))))))
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1471 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1471) i1) (<= i1 (last1 temp___1471)))
  (exists ((o (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1471) i1)) o)
  (exists ((l_digit2 (_ BitVec 16)))
  (and (= l_digit2 ((_ zero_extend 8) o))
  (let ((temp___1472 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1472) i1) (<= i1 (last1 temp___1472)))
  (exists ((o1 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1472) i1)) o1)
  (exists ((r_digit2 (_ BitVec 16)))
  (and (= r_digit2 ((_ zero_extend 8) o1))
  ...
  (= o2 (bvudiv sum2 (ite (< 8 65536) (bvshl #x0001 ((_ int_to_bv 16) 8))
                     #x0000)))))
  ...
  (= result____split_fields2 (us_tqtmk
                             (store (to_array result____split_fields3) i1 o4)
