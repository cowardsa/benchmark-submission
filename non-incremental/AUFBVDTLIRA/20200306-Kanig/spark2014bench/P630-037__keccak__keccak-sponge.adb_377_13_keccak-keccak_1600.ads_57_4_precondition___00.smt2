...
;; defqtvc
 ;; File "keccak-sponge.ads", line 222, characters 0-0
  ...
  (=> (= spark__branch2 (ite (< 0 o8) true false))
  (=> (= spark__branch2 true)
  (forall ((o9 Int))
  (=>
  (= (to_rep4
  ...
  (let ((o11 (- o10 o9)))
  (=> (in_range2 o11)
  (forall ((bytes_to_squeeze Int))
  (=> (= bytes_to_squeeze o11)
  (=> (dynamic_invariant bytes_to_squeeze true false true true)
  (forall ((spark__branch3 Bool) (bytes_to_squeeze1 Int))
  (=>
  (and (= spark__branch3 (ite (< remaining bytes_to_squeeze) true false))
  (ite (= spark__branch3 true) (= bytes_to_squeeze1 remaining)
  (= bytes_to_squeeze1 bytes_to_squeeze)))
  (forall ((o12 Int))
  (=> (= (to_rep digest__first) o12)
  (let ((o13 (+ o12 offset)))
  (=> (in_range1 o13)
  (=> (= o13 r123s)
  (=> (dynamic_invariant2 r123s true false true true)
  ...
  (=> (in_range1 o16)
  (=> (= o16 r124s)
  (=> (dynamic_invariant2 r124s true false true true)
  (forall
  ...
  (=> (dynamic_invariant4 r127s true false true true)
  (forall ((o17 Int))
  (=>
  (= (to_rep4
     (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
  ...
  (=> (in_range1 o18)
  (=> (= o18 r128s)
  (=> (dynamic_invariant2 r128s true false true true)
  (=>
  (=> (<= r127s r128s)
  ...
  (=> (in_range1 o20)
  (=> (in_range6 o20)
  (forall ((o21 byte_absorption_number))
  (=> (= (to_rep4 o21) o20)
  ...
  (=> (in_range1 o23)
  (=> (in_range2 o23)
  (forall ((remaining1 Int))
  (=> (= remaining1 o23)
  (forall ((o24 Int))
  (=>
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields3)) o24)
  (forall ((o25 Int))
  (=>
  (= (to_rep4
     (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
     ctx__split_fields3)) o25)
  (forall ((spark__branch4 Bool))
  (=> (= spark__branch4 (ite (<= o24 o25) true false))
  (=> (= spark__branch4 true)
  (forall
  ((ada___keccak__keccak_1600__keccakf_1600_permutation__permute__a map1))
  ...
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields4)) o26)
  (=> (= (- o26 1) r131s)
  (=> (dynamic_invariant2 r131s true false true true)
  (=>
  (=> (<= 0 r131s)
  ...
  (= (to_rep o28) (first1
                  ada___keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl))
  (<= (length (to_rep o28) (to_rep o27)) 200)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
