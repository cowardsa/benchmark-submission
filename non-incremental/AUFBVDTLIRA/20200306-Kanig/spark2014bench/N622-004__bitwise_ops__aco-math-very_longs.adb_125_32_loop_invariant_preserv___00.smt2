...
(define-fun to_rep3 ((x tdigit_index_typeB)) Int (tdigit_index_typeBqtint x))

(declare-fun of_rep3 (Int) tdigit_index_typeB)
...
;; range_axiom
  (assert
  (forall ((x tdigit_index_typeB)) (! (in_range5
...
(define-fun to_int2 ((x octet)) Int (ubv_to_int (to_rep4 x)))
...
(((t22s__refqtmk (t22s__content us_t1)))))
(define-fun t22s__ref_t22s__content__projection ((a t22s__ref)) us_t1 
  (t22s__content a))
...
(((us_split_fieldsqtmk
  (rec__ada___ada___aco__math__very_longs__very_long__long_digits us_t1)))))
(define-fun us_split_fields_rec__ada___ada___aco__math__very_longs__very_long__long_digits__projection ((a us_split_fields)) us_t1 
...
(define-fun dynamic_invariant2 ((temp___expr_277 us_rep)
...
(declare-datatypes ((s30b__ref 0))
(((s30b__refqtmk (s30b__content us_t1)))))
(define-fun s30b__ref_s30b__content__projection ((a s30b__ref)) us_t1 
  (s30b__content a))

(declare-datatypes ((t33b__ref 0))
(((t33b__refqtmk (t33b__content us_t1)))))
(define-fun t33b__ref_t33b__content__projection ((a t33b__ref)) us_t1 
  (t33b__content a))

(declare-fun temp_____aggregate_def_1111 ((_ BitVec 8) Int Int) us_t1)
...
;; def_axiom
  (assert
  (forall ((temp___1113 (_ BitVec 8)))
  (forall ((temp___1114 Int) (temp___1115 Int))
  (let ((temp___1112 (temp_____aggregate_def_1111 temp___1113 temp___1114
                     temp___1115)))
  (=> (dynamic_invariant3 temp___1113 true true true true)
  (and
  (=> (dynamic_property1 1 2147483647 temp___1114 temp___1115)
  (and (= (first3 temp___1112) temp___1114)
  (= (last3 temp___1112) temp___1115)))
  (forall ((temp___1116 Int))
  (= (to_rep4 (select (to_array1 temp___1112) temp___1116)) temp___1113))))))))

(define-fun dynamic_invariant7 ((temp___expr_271 us_t1)
  ...
  (temp___do_typ_inv_270 Bool)) Bool (=>
                                     ...
                                     (first3 temp___expr_271)
                                     (last3 temp___expr_271))))

(define-fun dynamic_invariant8 ((temp___expr_542 us_t1)
  (temp___is_init_538 Bool) (temp___skip_constant_539 Bool)
  (temp___do_toplevel_540 Bool)
  (temp___do_typ_inv_541 Bool)) Bool (=>
                                     (not (= temp___skip_constant_539 true))
                                     (and (dynamic_property1 1 r31b
                                     (first3 temp___expr_542)
                                     (last3 temp___expr_542))
                                     (and (= (first3 temp___expr_542) 1)
                                     (= (last3 temp___expr_542) r31b)))))

(define-fun default_initial_assumption ((temp___expr_544 us_t1)
  (temp___skip_top_level_545 Bool)) Bool (and (= (first3 temp___expr_544) 1)
                                         (= (last3 temp___expr_544) r31b)))
...
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 26, characters 0-0
  ...
  (ada___ada___aco__math__very_longs__make_from_hex_string__R31b__assume Int))
  ...
  (= (to_rep2
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     result____split_discrs)) ada___ada___aco__math__very_longs__make_from_hex_string__R31b__assume)
  (=>
  (= ada___ada___aco__math__very_longs__make_from_hex_string__R31b__assume 
  r31b)
  (=> (dynamic_invariant4 r31b true false true true)
  (let ((temp___1117 (temp_____aggregate_def_1111 #x00 1 r31b)))
  (=> (= (first3 temp___1117) 1)
  (=> (= (last3 temp___1117) r31b)
  (=>
  (ite (<= (first3 temp___1117) (last3 temp___1117))
  (and (<= 1 r31b)
  (= (- (last3 temp___1117) (first3 temp___1117)) (- r31b 1))) (< r31b 1))
  (let ((temp___1119 (of_array1 (to_array1 temp___1117) (first3 temp___1117)
                     (last3 temp___1117))))
  (=>
  (ite (<= (first3 temp___1119) (last3 temp___1119))
  (and (<= (first3 result____split_fields) (last3 result____split_fields))
  (= (- (last3 temp___1119) (first3 temp___1119)) (- (last3
  ...
  (=>
  (= result____split_fields1 (of_array1 (to_array1 temp___1119)
  ...
  (=>
  (= string_index2 (+ (* 2 (- (last3 result____split_fields2) index2)) 1))
  (=>
  (and
  (and
  (and
  ...
  (=>
  (exists ((o5 Int))
  (= (to_rep (select (to_array number) string_index2)) o5))
  (forall ((h_digit2 (_ BitVec 8)) (h_okay Bool))
  (=> (dynamic_invariant3 h_digit2 true true true true)
  (let ((o5 (+ string_index2 1)))
  (=> (in_range1 o5)
  (=> (and (<= (first1 number) o5) (<= o5 (last1 number)))
  (=> (exists ((o6 Int)) (= (to_rep (select (to_array number) o5)) o6))
  ...
  (forall ((o6 octet))
  (=> (= (to_rep4 o6) (bvadd (bvmul #x10 h_digit2) l_digit2))
  (=>
  (and (<= (first3 result____split_fields2) index2)
  (<= index2 (last3 result____split_fields2)))
  (forall ((result____split_fields3 us_t1))
  (=>
  (= result____split_fields3 (us_tqtmk1
                             (store (to_array1 result____split_fields2) index2 o6)
  ...
  (forall ((index3 Int))
  (=> (= index3 o7)
  (let ((o8 (+ string_index2 2)))
  (=> (in_range1 o8)
  (forall ((string_index3 Int))
  (=> (= string_index3 o8)
  (let ((o9 (- (last3 result____split_fields3) index3)))
  (=> (in_range5 o9)
  (let ((o10 (* 2 o9)))
  (=> (in_range5 o10)
  (let ((o11 (+ o10 1)))
  (=> (in_range5 o11)
  (=> (in_range2 o11)
  (= string_index3 (+ (* 2 (- (last3 result____split_fields3) index3)) 1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
