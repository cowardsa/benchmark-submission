...
;; defqtvc
 ;; File "very_longs-divide.adb", line 74, characters 0-0
  ...
  (= (and (ite (and
               ...
               true))
               (forall ((temp___1329 Int))
               (=>
               (and (<= (first1 number__split_fields1) temp___1329)
               (<= temp___1329 (last1 number__split_fields1)))
               (=>
               (or (< temp___1315 temp___1329)
               (or (< temp___1329 1) (<= i1 temp___1329)))
               (= (select (to_array number__split_fields1) temp___1329) (select 
               (to_array number__split_fields) temp___1329))))))
