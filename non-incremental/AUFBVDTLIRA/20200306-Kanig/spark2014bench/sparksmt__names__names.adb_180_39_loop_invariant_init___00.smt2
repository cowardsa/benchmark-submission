...
(define-fun last3 ((container us_rep4)) Int (+ (- 1) (length2 container)))
...
(declare-fun first_index__function_guard1 (Int us_rep2) Bool)

(define-fun element1 ((container us_rep2)
  (index Int)) Int (get1 (model2 container) index))
...
(define-fun dynamic_invariant4 ((temp___expr_471 Int)
  (temp___is_init_467 Bool) (temp___skip_constant_468 Bool)
  (temp___do_toplevel_469 Bool)
  (temp___do_typ_inv_470 Bool)) Bool (=>
                                     (or (= temp___is_init_467 true)
                                     (<= 0 255)) (in_range11
                                     temp___expr_471)))
...
;; index_type'axiom
  ...
  (and (<= 0 (index_typeqtint1 i)) (<= (index_typeqtint1 i) 2147483646))))

(define-fun in_range14 ((x Int)) Bool (and (<= 0 x) (<= x 2147483646)))
...
(((t20b__refqtmk (t20b__content integer)))))
(define-fun t20b__ref_t20b__content__projection ((a t20b__ref)) integer 
  (t20b__content a))

(define-fun dynamic_invariant6 ((temp___expr_509 us_t)
  ...
  (temp___do_typ_inv_508 Bool)) Bool (=>
                                     ...
                                     (= (last1 temp___expr_509) l)))))

(define-fun default_initial_assumption2 ((temp___expr_511 us_t)
  (temp___skip_top_level_512 Bool)) Bool (and (= (first1 temp___expr_511) 1)
                                         (= (last1 temp___expr_511) l)))

(declare-fun temp___String_Literal_561 (tuple0) (Array Int character))

;; temp___String_Literal_561__def_axiom
  (assert true)

(define-fun dynamic_invariant7 ((temp___expr_74 Int) (temp___is_init_70 Bool)
  (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool)
  (temp___do_typ_inv_73 Bool)) Bool (=>
                                    (or (= temp___is_init_70 true)
                                    (<= 0 255)) (in_range2 temp___expr_74)))

(define-fun dynamic_invariant8 ((temp___expr_96 us_t)
...
;; valid_entry__def_axiom
  ...
  (forall ((names__entry_table__fields us_split_fields))
  (! (=
     (= (valid_entry e1 names__char_table__fields names__entry_table__fields) true)
     (and
     (<= (to_rep5
         (rec__ada___names__data__name_entry__next_hash
         (us_split_fields5 e1))) (last_index
                                 (us_repqtmk entry_table__split_discrs
                                 names__entry_table__fields)))
     (<= (- (to_rep
            (rec__ada___names__data__name_entry__length
            (us_split_fields5 e1))) 1) (- (last_index1
                                          (us_repqtmk1
                                          char_table__split_discrs
                                          names__char_table__fields)) 
     (to_rep6
     (rec__ada___names__data__name_entry__table_index (us_split_fields5 e1))))))) :pattern (
  (valid_entry e1 names__char_table__fields names__entry_table__fields)) )))))
...
;; l__def_axiom
  (assert
  (= l (to_rep
       (rec__ada___names__data__name_entry__length (us_split_fields5 e)))))
...
(define-fun dynamic_invariant11 ((temp___expr_322 Int)
...
(declare-fun user_eq22 (extended_index1 extended_index1) Bool)

(declare-const dummy22 extended_index1)
...
(define-fun dynamic_invariant12 ((temp___expr_277 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_284 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length3 container)))
     (and (<= result (capacity container)) (dynamic_invariant13 result true
     false true true))) :pattern ((length3 container)) )))

(define-fun default_initial_assumption3 ((temp___expr_315 us_rep4)
...
;; model__post_axiom
  (assert
  (forall ((container us_rep2))
  (! (= (length2 (model2 container)) (length3 container)) :pattern ((model2
                                                                    container)) )))
...
(define-fun dynamic_invariant14 ((temp___expr_329 Int)
...
(declare-const dummy24 element_type1)

(declare-datatypes ((element_type__ref3 0))
(((element_type__refqtmk3 (element_type__content3 element_type1)))))
(define-fun element_type__ref_element_type__content__4__projection ((a element_type__ref3)) element_type1 
  (element_type__content3 a))

(define-fun dynamic_invariant16 ((temp___expr_478 Int)
...
;; get__post_axiom
  ...
  (forall ((position Int))
  (! (=>
     (and (dynamic_invariant15 position true true true true)
     (and (<= 0 position) (<= position (last3 container))))
     (dynamic_invariant16 (get1 container position) true false true true)) :pattern (
  (get1 container position)) ))))

(define-fun dynamic_invariant17 ((temp___expr_211 Int)
...
(define-fun default_initial_assumption4 ((temp___expr_242 us_rep1)
...
;; model__post_axiom
  (assert
  (forall ((container us_rep))
  (! (= (length1 (model1 container)) (length4 container)) :pattern ((model1
                                                                    container)) )))
...
(define-fun dynamic_invariant18 ((temp___expr_263 Int)
...
(define-fun dynamic_invariant19 ((temp___expr_234 Int)
...
;; defqtvc
 ;; File "names.ads", line 51, characters 0-0
  ...
  (hash_table (Array (_ BitVec 32) name_id)) (s (Array Int character))
  (spark__branch Bool))
  (=> (dynamic_invariant3
  ...
  (=> (dynamic_invariant5 n true false true true)
  (=>
  ...
  (=> (= spark__branch (ite (= n 0) true false))
  (=> (not (= spark__branch true))
  (let ((o n))
  (=> (in_range12 o)
  (let ((o1 (us_repqtmk entry_table__split_discrs
            (us_split_fieldsqtmk entry_table__split_fields))))
  (let ((names__to_string__B_3__e__assume (element o1 o)))
  (=>
  (= (bool_eq3 names__to_string__B_3__e__assume (get (model1 o1) o)) true)
  (=> (= names__to_string__B_3__e__assume e)
  (forall ((names__to_string__B_3__l__assume Int))
  (=>
  (= (to_rep
     (rec__ada___names__data__name_entry__length (us_split_fields5 e))) names__to_string__B_3__l__assume)
  (=> (= names__to_string__B_3__l__assume l)
  (=> (dynamic_invariant l true false true true)
  (=> (default_initial_assumption2
  (of_array s (to_rep2 s__first) (to_rep2 s__last)) false)
  (=>
  (and (dynamic_property 1 l (to_rep2 s__first) (to_rep2 s__last))
  (and (= (to_rep2 s__first) 1) (= (to_rep2 s__last) l)))
  (forall ((i Int))
  (=> (= i 1)
  (=> (= (and (ite (<= 1 i) true false) (ite (<= i l) true false)) true)
  (forall ((o2 Int))
  (=>
  (= (to_rep6
  ...
  (=>
  (and (invariant____function_guard temp___inv_570 hash_table
  (us_split_fieldsqtmk1 char_table__split_fields)
  (us_split_fieldsqtmk entry_table__split_fields))
  (= (= temp___inv_570 true)
  (and
