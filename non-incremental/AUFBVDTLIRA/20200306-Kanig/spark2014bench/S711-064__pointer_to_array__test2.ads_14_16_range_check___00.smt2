...
(((t14s__refqtmk (t14s__content t14s)))))
...
;; defqtvc
 ;; File "test2.ads", line 11, characters 0-0
  ...
  (=> (= o true)
  (let ((o1 buffer))
  (let ((test2__check_array__R11s (zero o1)))
  (=>
  (and (zero__function_guard test2__check_array__R11s o1)
  (and (dynamic_invariant test2__check_array__R11s true false true true)
