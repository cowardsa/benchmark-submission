...
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 58, characters 0-0
  ...
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1227) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___1236)
               (<= temp___1236 (last1 result____split_fields2)))
               (=>
               (or (< temp___1227 temp___1236)
               (or (< temp___1236 1) (<= i1 temp___1236)))
               (= (select (to_array result____split_fields2) temp___1236) (select 
  ...
  (let ((temp___1228 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1228) i1) (<= i1 (last1 temp___1228)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1228) i1)) o2)
  ...
  (let ((temp___1229 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1229) i1) (<= i1 (last1 temp___1229)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1229) i1)) o3)
