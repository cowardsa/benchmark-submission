...
;; defqtvc
 ;; File "main2.adb", line 4, characters 0-0
  (not
  (forall ((foo__split_fields us_split_fields) (current_err us_private)
  ...
  (=> (< off_c1 10000)
  (=> (= off_c2 0)
  (let ((temp___204 (to_string (attr__ATTRIBUTE_IMAGE off_c1) 12)))
  (=> (in_range1
  (- (+ 1 (+ (length 1 7) (length (first1 temp___204) (last1 temp___204)))) 1))
  (forall ((current_err1 us_private) (standard_in1 us_private)
  (file_system1 us_private) (standard_out1 us_private)
  (standard_err1 us_private) (current_in1 us_private)
  (current_out1 us_private))
  (=>
  (and
  (= (line_length current_err standard_in file_system standard_out
     standard_err current_in current_out) (line_length current_err1
                                          standard_in1 file_system1
                                          standard_out1 standard_err1
                                          current_in1 current_out1))
  (= (page_length current_err standard_in file_system standard_out
     standard_err current_in current_out) (page_length current_err1
                                          standard_in1 file_system1
                                          standard_out1 standard_err1
                                          current_in1 current_out1)))
  (let ((temp___207 (to_string (attr__ATTRIBUTE_IMAGE off_c2) 12)))
  (in_range1
  (- (+ 1 (+ (length 1 7) (length (first1 temp___207) (last1 temp___207)))) 1)))))))))))))))))))
(check-sat)
(exit)
