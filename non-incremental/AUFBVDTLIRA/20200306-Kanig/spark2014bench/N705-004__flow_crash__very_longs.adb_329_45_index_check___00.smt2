...
;; defqtvc
 ;; File "very_longs.adb", line 326, characters 0-0
  (not
  (forall ((digit_index Int) (digit_index1 Int)
  (very_longs__divide__get_msd__result Int))
  ...
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1303) true false)) true)
  ...
  (let ((temp___1312 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 number))))
  (and
  (and (<= (first1 temp___1312) digit_index2)
  (<= digit_index2 (last1 temp___1312)))
  (exists ((o (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1312) digit_index2)) o)
  (exists ((i1 Int))
  (and
  (and
  (or
  ...
  (=> (< digit_index1 i1)
  (forall ((j Int))
  (=> (and (<= (+ digit_index1 1) j) (<= j i1))
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) j)) #x00)))))
  (and
  (= (and (ite (and (dynamic_invariant1 digit_index1 true true true true)
               (dynamic_property1 1
               (last1
               (rec__very_longs__very_long__long_digits
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 number)))))
                      true false)) true)
  (= i1 temp___1303))))))))))) (= digit_index1 digit_index)))))
  (=> (= very_longs__divide__get_msd__result digit_index1)
  (=> (in_range2 (+ very_longs__divide__get_msd__result 1))
  (<= (first1
      (rec__very_longs__very_long__long_digits (us_split_fields1 number))) very_longs__divide__get_msd__result))))))))))))
(check-sat)
(exit)
