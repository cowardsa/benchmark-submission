...
(define-fun to_rep4 ((x component_type)) Int (component_typeqtint x))

(declare-fun of_rep4 (Int) component_type)
...
(define-fun bool_eq2 ((a (Array Int component_type)) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep4 (select a temp___idx_161)) (to_rep4
...
(declare-const dummy7 (Array Int component_type))
...
(declare-fun user_eq7 ((Array Int component_type)
...
(declare-fun user_eq8 (other_count_type other_count_type) Bool)

(declare-const dummy8 other_count_type)
...
(define-fun to_rep5 ((x other_count_type)) Int (other_count_typeqtint x))

(declare-fun of_rep5 (Int) other_count_type)
...
(define-fun dynamic_invariant4 ((temp___expr_280 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_287 Int)
  ...
  (temp___do_typ_inv_286 Bool)) Bool (=>
                                     ...
                                     (<= 0 2)) (in_range2 temp___expr_287)))

(define-fun dynamic_invariant6 ((temp___expr_294 Int)
  ...
  (temp___do_typ_inv_293 Bool)) Bool (=>
                                     ...
                                     (<= 0 175)) (in_range3 temp___expr_294)))
...
(define-fun dynamic_invariant7 ((temp___expr_325 Int)
  ...
  (temp___do_typ_inv_324 Bool)) Bool (=>
                                     ...
                                     (<= 0 13)) (in_range5 temp___expr_325)))
