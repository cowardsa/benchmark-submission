...
(((us_split_fieldsqtmk
  (rec__timestamp_messages__response__placeholder integer)))))
(define-fun us_split_fields_rec__timestamp_messages__response__placeholder__projection ((a us_split_fields)) integer 
  (rec__timestamp_messages__response__placeholder a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep
                           (rec__timestamp_messages__response__placeholder
...
(declare-const timestamp_messages__response__placeholder__first__bit Int)

(declare-const timestamp_messages__response__placeholder__last__bit Int)

(declare-const timestamp_messages__response__placeholder__position Int)

;; timestamp_messages__response__placeholder__first__bit_axiom
  (assert (<= 0 timestamp_messages__response__placeholder__first__bit))

;; timestamp_messages__response__placeholder__last__bit_axiom
  (assert
  (< timestamp_messages__response__placeholder__first__bit timestamp_messages__response__placeholder__last__bit))

;; timestamp_messages__response__placeholder__position_axiom
  (assert (<= 0 timestamp_messages__response__placeholder__position))

(declare-fun user_eq4 (us_rep us_rep) Bool)

(declare-const dummy4 us_rep)

(declare-datatypes ((response__ref 0))
(((response__refqtmk (response__content us_rep)))))
(define-fun response__ref_response__content__projection ((a response__ref)) us_rep 
  (response__content a))
