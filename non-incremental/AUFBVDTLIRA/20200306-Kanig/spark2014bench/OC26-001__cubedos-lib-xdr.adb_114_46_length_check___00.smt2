...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 137, characters 0-0
  ...
  (=> (= spark__branch (ite (= (mod1 (length1 value) 4) 0) false true))
  (=> (= spark__branch true)
  ...
  (=> (in_range3 o4)
  (forall ((padding_stop1 Int))
  (=> (= padding_stop1 o4)
  (=> (= padding_start1 r12b)
  (=> (dynamic_invariant1 r12b true false true true)
  (=> (= padding_stop1 r13b)
  (=> (dynamic_invariant1 r13b true false true true)
  (let ((temp___559 (temp_____aggregate_def_553 #x00 r12b r13b)))
  (=> (= (first1 temp___559) r12b)
  (=> (= (last1 temp___559) r13b)
  (=>
  ...
  (=> (<= (first1 temp___561) (last1 temp___561))
  (<= (first1 temp___562) (last1 temp___562)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
