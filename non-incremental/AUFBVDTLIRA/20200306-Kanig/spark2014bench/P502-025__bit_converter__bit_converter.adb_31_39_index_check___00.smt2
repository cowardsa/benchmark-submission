...
(declare-datatypes ((zero_or_one__ref 0))
(((zero_or_one__refqtmk (zero_or_one__content zero_or_one)))))
(define-fun zero_or_one__ref_zero_or_one__content__projection ((a zero_or_one__ref)) zero_or_one 
  (zero_or_one__content a))

(define-fun dynamic_invariant ((temp___expr_168 (_ BitVec 8))
...
;; to_number__post_axiom
  ...
  (! (let ((result (to_number bool__)))
     (=> (to_number__function_guard result bool__) (dynamic_invariant result
     true false true true))) :pattern ((to_number bool__)) )))
...
;; index_type'axiom
  (assert
  (forall ((i index_type))
  (and (<= 1 (index_typeqtint i)) (<= (index_typeqtint i) 8))))
...
(declare-datatypes ((bit_array__ref 0))
(((bit_array__refqtmk (bit_array__content us_t)))))
(define-fun bit_array__ref_bit_array__content__projection ((a bit_array__ref)) us_t 
  (bit_array__content a))
...
(declare-fun user_eq4 (modular_type modular_type) Bool)

(declare-const dummy4 modular_type)

(declare-datatypes ((modular_type__ref 0))
(((modular_type__refqtmk (modular_type__content modular_type)))))
(define-fun modular_type__ref_modular_type__content__projection ((a modular_type__ref)) modular_type 
  (modular_type__content a))

(define-fun dynamic_invariant1 ((temp___expr_161 (_ BitVec 8))
...
;; defqtvc
 ;; File "bit_converter.ads", line 15, characters 0-0
  (not
  (forall ((bit (_ BitVec 8)))
  (=> (dynamic_invariant3 array_of_bits true false true true)
  (=> (< 0 object__size)
  (let ((o (first1 array_of_bits)))
  (=> (in_range3 o)
  (=> (= o first_index)
  (=> (dynamic_invariant2 first_index true false true true)
  (let ((o1 (last1 array_of_bits)))
  (=> (in_range3 o1)
  (=> (= o1 last_index)
  (=> (dynamic_invariant2 last_index true false true true)
  (forall ((bits (_ BitVec 8)))
  (=> (= bits #x00)
  (=> (dynamic_invariant1 bits true false true true)
  (=> (dynamic_invariant bit false false true true)
  (=>
  (and (<= (first1 array_of_bits) first_index)
  (<= first_index (last1 array_of_bits)))
  (let ((o2 (select (to_array array_of_bits) first_index)))
  (let ((o3 (to_number o2)))
  (=>
  (and (to_number__function_guard o3 o2) (dynamic_invariant o3 true false
  true true))
  (forall ((bit1 (_ BitVec 8)))
  (=> (= bit1 o3)
  (forall ((bits1 (_ BitVec 8)))
  (=> (= bits1 (bvor bits bit1))
  (let ((temp___196 (+ first_index 1)))
  (forall ((i Int))
  (=> (= i temp___196)
  (=>
  (= (and (ite (<= temp___196 i) true false) (ite (<= i last_index) true
                                             false)) true)
  (forall ((bits2 (_ BitVec 8)) (bit2 (_ BitVec 8)) (i1 Int))
  (=>
  (= (and (ite (and (dynamic_invariant1 bits2 true true true true)
               (dynamic_invariant bit2 false true true true))
          true false) (ite (and (<= (+ first_index 1) i1) (<= i1 last_index))
                      true false)) true)
