...
;; defqtvc
 ;; File "harness.adb", line 3, characters 0-0
  ...
  (=> (= h1 x)
  (=>
  (forall ((r__split_fields4 us_split_fields)) (is_full__function_guard
  (is_full (us_repqtmk r__split_fields4)) (us_repqtmk r__split_fields4)))
  (not (= (is_full (us_repqtmk r__split_fields3)) true))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
