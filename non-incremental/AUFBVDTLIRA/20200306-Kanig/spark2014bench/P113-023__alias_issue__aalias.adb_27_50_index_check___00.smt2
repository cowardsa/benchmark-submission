...
(define-fun to_int4 ((x m64_type)) Int (ubv_to_int (to_rep1 x)))
...
;; defqtvc
 ;; File "aalias.adb", line 21, characters 0-0
  ...
  (b11 (Array (_ BitVec 64) byte)) (i1 (_ BitVec 64)) (o (_ BitVec 64))
  (o1 (_ BitVec 64)))
  ...
  (=>
  (= (length (ubv_to_int (to_rep1 b1__first)) (ubv_to_int (to_rep1 b1__last))) 
  (length (ubv_to_int (to_rep1 b2__first)) (ubv_to_int (to_rep1 b2__last))))
