...
;; defqtvc
 ;; File "counter.ads", line 29, characters 0-0
  (not
  (forall ((inputs (Array (_ BitVec 8) Bool))
  (inputs1 (Array (_ BitVec 8) Bool)) (i (_ BitVec 8))
  (inputs2 (Array (_ BitVec 8) Bool)) (inputs3 (Array (_ BitVec 8) Bool))
  (k (_ BitVec 8)))
  (=> (= inputs1 inputs)
  (=> (= i #x01)
  (=>
  ...
  (= (and (ite (and (in_range3 i1)
               ...
               (= (select inputs4 temp___212) (select inputs temp___212))))))
          true false) (ite (and (bvule #x01 i1) (bvule i1 #x09)) true false)) true)
  (and (= inputs2 (store inputs4 i1 (select inputs4 (bvadd i1 #x01))))
  (= i1 #x09))))))))) (= inputs2 inputs))
  (=> (= inputs3 (store inputs2 #x0A input))
  (=> (bvule #x01 k)
  (=> (bvule k #x09)
