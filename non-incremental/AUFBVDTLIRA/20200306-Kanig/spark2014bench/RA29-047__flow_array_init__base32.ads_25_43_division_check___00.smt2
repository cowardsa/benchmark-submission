...
(((byte_array_type__refqtmk (byte_array_type__content us_t)))))
(define-fun byte_array_type__ref_byte_array_type__content__projection ((a byte_array_type__ref)) us_t 
...
(declare-const i6s us_t)

(declare-const attr__ATTRIBUTE_ADDRESS Int)

(define-fun dynamic_invariant ((temp___expr_200 us_t)
  ...
  (temp___do_typ_inv_199 Bool)) Bool (and
                                     ...
                                     (last1 temp___expr_200)))
                                     (=> (= temp___do_toplevel_198 true)
                                     (=> (= temp___is_init_196 true)
                                     (= (mod2 (length temp___expr_200) 5) 0)))))

(define-fun dynamic_predicate ((temp___203 us_t)) Bool (= (mod2
                                                          (length temp___203)
                                                          5) 0))
...
(assert
;; defqtvc
 ;; File "base32.ads", line 23, characters 0-0
  (not (=> (dynamic_invariant i6s true false false true) (not (= 5 0)))))
(check-sat)
(exit)
