...
(declare-const structure us_rep)
...
(define-fun dynamic_invariant ((temp___expr_215 us_rep)
...
(define-fun dynamic_invariant4 ((temp___expr_202 (_ BitVec 8))
  (temp___is_init_198 Bool) (temp___skip_constant_199 Bool)
  (temp___do_toplevel_200 Bool) (temp___do_typ_inv_201 Bool)) Bool true)

(define-fun dynamic_invariant5 ((temp___expr_209 us_t)
...
(assert
;; defqtvc
 ;; File "foo.adb", line 20, characters 0-0
  (not
  (forall ((o Int) (o1 Int))
  (=> (dynamic_invariant structure true false true true)
