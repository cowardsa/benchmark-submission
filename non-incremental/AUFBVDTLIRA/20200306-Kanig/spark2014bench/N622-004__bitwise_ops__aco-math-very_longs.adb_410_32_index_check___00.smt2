...
(define-fun dynamic_invariant3 ((temp___expr_852 Int)
...
(assert
;; defqtvc
 ;; File "aco-math-very_longs.adb", line 398, characters 0-0
  (not
  (forall ((number__split_fields us_t) (new_overflow (_ BitVec 8))
  ...
  (=> (dynamic_invariant3 distance true false true true)
  (=> (= old_overflow #x00)
  ...
  (let ((o (- 8 distance)))
  (let ((o1 (shift_right #xFF o)))
  (=>
  (and (shift_right__function_guard o1 #xFF o)
  (and (dynamic_invariant2 o1 true false true true)
  (= o1 (bvudiv #xFF (ite (< o 256) (bvshl #x01 ((_ int_to_bv 8) o)) #x00)))))
  (forall ((overflow_mask1 (_ BitVec 8)))
  (=> (= overflow_mask1 o1)
  (=> (= (last1 number__split_fields) r128b)
  (=> (in_range2 r128b)
  (let ((temp___1584 r128b))
  (forall ((i Int))
  (=> (= i temp___1584)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1584) true false)) true)
  ...
  (= (and (ite (and
               ...
               true))
               (forall ((temp___1598 Int))
               (=>
               (and (<= (first1 number__split_fields1) temp___1598)
               (<= temp___1598 (last1 number__split_fields1)))
               (=>
               (or (< temp___1584 temp___1598)
               (or (< temp___1598 1) (<= temp___1598 i1)))
               (= (select (to_array number__split_fields1) temp___1598) (select 
               (to_array number__split_fields) temp___1598))))))
          true false) (ite (and (<= 1 i1) (<= i1 r128b)) true false)) true)
  (=>
  (and (<= (first1 number__split_fields1) i1)
  (<= i1 (last1 number__split_fields1)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array number__split_fields1) i1)) o2)
  ...
  (=> (= (to_rep2 (select (to_array number__split_fields1) i1)) o4)
  (let ((o5 (shift_right o4 o3)))
  (=>
  (and (shift_right__function_guard o5 o4 o3)
  (and (dynamic_invariant2 o5 true false true true)
  (= o5 (bvudiv o4 (ite (< o3 256) (bvshl #x01 ((_ int_to_bv 8) o3)) #x00)))))
  (forall ((o6 octet))
  (=> (= (to_rep2 o6) o5)
  (=>
  (and (<= (first1 number__split_fields1) i1)
  (<= i1 (last1 number__split_fields1)))
  (forall ((number__split_fields2 us_t))
  (=>
  (= number__split_fields2 (us_tqtmk
                           (store (to_array number__split_fields1) i1 o6)
                           (rt number__split_fields1)))
  (forall ((o7 (_ BitVec 8)))
  (=>
  (ite (< (- 8 distance) 8)
  (= o7 (bvshl old_overflow1 ((_ int_to_bv 8) (- 8 distance)))) (= o7 #x00))
  (=>
  (and (<= (first1 number__split_fields2) i1)
  (<= i1 (last1 number__split_fields2)))
  (forall ((o8 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array number__split_fields2) i1)) o8)
  (forall ((o9 octet))
  (=> (= (to_rep2 o9) (bvor o8 o7)) (<= (first1 number__split_fields2) i1))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
