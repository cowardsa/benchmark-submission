...
;; defqtvc
 ;; File "ethernet_dissector.ads", line 12, characters 0-0
  ...
  (=> (in_range1 o14)
  (=> (= o14 r25b)
  (=> (dynamic_invariant1 r25b true false true true)
  (let ((o15 (+ (first1 buffer) 13)))
  (=> (in_range1 o15)
  (let ((o16 (+ o15 offset1)))
  (=> (in_range1 o16)
  (=> (= o16 r26b)
  (=> (dynamic_invariant1 r26b true false true true)
  (=>
  (=> (<= r25b r26b)
  ...
  (=> (= spark__branch3 (ite (= (- o21 1) o17) false true))
  ...
  (=> (in_range1 o25)
  (=> (= o25 r30b)
  (=> (dynamic_invariant1 r30b true false true true)
  (let ((temp___320 (first1 buffer)))
  (=> (<= temp___320 r30b) (<= (first1 buffer) temp___320))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
