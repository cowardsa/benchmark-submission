...
;; defqtvc
 ;; File "very_longs.ads", line 61, characters 0-0
  ...
  (let ((temp___1126 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1126) i1) (<= i1 (last1 temp___1126)))
  (forall ((o4 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1126) i1)) o4)
  (forall ((l_digit3 (_ BitVec 16)))
  (=> (= l_digit3 ((_ zero_extend 8) o4))
  (let ((temp___1127 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1127) j1) (<= j1 (last1 temp___1127)))
  (forall ((o5 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1127) j1)) o5)
  ...
  (=>
  (and (<= (first1 result____split_fields3) temp___1129)
  (<= temp___1129 (last1 result____split_fields3)))
  (forall ((o7 (_ BitVec 8)))
  (=>
  (= (to_rep2 (select (to_array result____split_fields3) temp___1129)) o7)
