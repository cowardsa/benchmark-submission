...
(define-fun dynamic_invariant1 ((temp___expr_230 us_t)
...
(assert
;; defqtvc
 ;; File "hermes-der-decode.adb", line 121, characters 0-0
  (not
  (forall ((result__ Int))
  (=> (dynamic_invariant1 message true false true true)
  (=> (dynamic_invariant starting true false true true)
  (=> (dynamic_invariant2 octet_count true false true true)
  (=> (dynamic_invariant1 message true false true true)
  (=> (< (first1 message) starting)
  (=> (<= (+ starting (- octet_count 1)) (last1 message))
  (=> (<= octet_count 4)
  (=>
  (=> (= octet_count 4)
  ...
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i octet_count) true false)) true)
  (=> (or (not (< octet_count 4)) (in_range1 (power 256 (- i 1))))
  (forall ((result__1 Int) (i1 Int))
  (=>
  (and (=> (< octet_count 4) (< result__1 (power 256 (- i1 1))))
  (=> (= octet_count 4)
  (and (=> (= i1 1) (< result__1 1))
  (=> (< 1 i1) (< result__1 (* 128 (power 256 (- i1 2))))))))
  (=>
  (= (and (ite (and (dynamic_invariant result__1 true true true true)
               (dynamic_property1 1 octet_count i1))
          true false) (ite (and (<= 1 i1) (<= i1 octet_count)) true false)) true)
  (let ((o (+ starting (- i1 1))))
  (=> (in_range1 o)
  ...
  (=> (in_range1 o2)
  (let ((o3 (+ o2 (ubv_to_int o1)))) (=> (in_range1 o3) (in_range2 o3))))))))))))))))))))))))))))))
(check-sat)
(exit)
