...
(define-fun in_range4 ((rec__ada___names__data__char_tables__vector__capacity1 Int)
...
;; range_axiom
  (assert
  (forall ((x name_id)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(define-fun bool_eq3 ((a (Array (_ BitVec 32) name_id))
  ...
  (b__last (_ BitVec 32))) Bool (ite (and
                                     ...
                                     (= (to_rep3 (select a temp___idx_173)) 
                                     (to_rep3
...
;; bool_eq_rev
  ...
  (= (to_rep3 (select a temp___idx_173)) (to_rep3
                                         (select b (bvadd (bvsub b__first a__first) temp___idx_173)))))))))))
...
;; valid_hashes__def_axiom
  ...
  (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true)
     ...
     (<= (to_rep3 (select names__hash_table h)) (last_index
                                                (us_repqtmk
...
(assert
;; defqtvc
 ;; File "names.ads", line 39, characters 0-0
  (not
  ...
  (let ((o (valid_hashes hash_table
           (us_split_fieldsqtmk entry_table__split_fields))))
  (=>
  (and (valid_hashes__function_guard o hash_table
  (us_split_fieldsqtmk entry_table__split_fields))
  (= (= o true)
  (forall ((h (_ BitVec 32)))
  (=> (and (bvule #x00000000 h) (bvule h #x000000FF))
  (<= (to_rep3 (select hash_table h)) (last_index
                                      (us_repqtmk entry_table__split_discrs
                                      (us_split_fieldsqtmk
                                      entry_table__split_fields))))))))
  (let ((o1 (valid_tables (us_split_fieldsqtmk1 char_table__split_fields)
            (us_split_fieldsqtmk entry_table__split_fields))))
  (=>
  (and (valid_tables__function_guard o1
