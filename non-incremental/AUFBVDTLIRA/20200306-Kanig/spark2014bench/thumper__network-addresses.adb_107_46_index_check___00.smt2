...
;; defqtvc
 ;; File "network-addresses.ads", line 37, characters 0-0
  ...
  (=> (in_range1 (* 4 (- i 1)))
  (=> (in_range1 (* 2 (- i 1)))
  (forall ((index1 Int) (count1 Int) (skip1 Int) (value1 (_ BitVec 8))
  (digit_21 Int) (digit_11 Int) (digit_01 Int) (i1 Int))
  ...
  (=> (= value3 (bvurem value2 #x64)) (bvule #x00 (bvudiv value3 #x0A)))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
