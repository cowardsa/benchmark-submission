...
(define-fun to_int2 ((x address_type)) Int (ubv_to_int (to_rep1 x)))
...
(declare-const empty_array (Array Int address_type))
...
(declare-const empty__split_discrs us_split_discrs)
...
(declare-fun area_math__empty_array__aggregate_def ((_ BitVec 32)) (Array Int address_type))

(declare-const dummy5 (Array Int address_type))
...
(declare-fun user_eq5 ((Array Int address_type)
...
(define-fun us_split_fields_rec__area_math__ensemble__size__2__projection ((a us_split_fields2)) natural 
  (rec__area_math__ensemble__size1 a))

(define-fun us_split_fields_rec__area_math__ensemble__from__2__projection ((a us_split_fields2)) (Array Int address_type) 
  (rec__area_math__ensemble__from1 a))

(define-fun us_split_fields_rec__area_math__ensemble__to__2__projection ((a us_split_fields2)) (Array Int address_type) 
...
(define-fun of_base ((r us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r)
                                         ...
                                         (rec__area_math__ensemble__size
                                         (us_split_fields1 r))
                                         (let ((temp___160 (rec__area_math__ensemble__from
                                                           (us_split_fields1
                                                           r))))
                                         (to_array temp___160))
                                         (let ((temp___161 (rec__area_math__ensemble__to
                                                           (us_split_fields1
                                                           r))))
                                         (to_array temp___161)))))
...
(((t15s__refqtmk (t15s__content us_rep1)))))
(define-fun t15s__ref_t15s__content__projection ((a t15s__ref)) us_rep1 
  (t15s__content a))

(define-fun dynamic_predicate1 ((temp___237 us_rep1)) Bool (and
                                                           (<= (to_rep
                                                               (rec__area_math__ensemble__size
                                                               (us_split_fields1
                                                               (to_base
...
;; empty_array__def_axiom
  (assert (= empty_array (area_math__empty_array__aggregate_def #x00000000)))

;; def_axiom
  (assert
  (forall ((temp___156 (_ BitVec 32)))
  (=> (dynamic_invariant3 temp___156 true true true true)
  (forall ((temp___157 Int))
  (= (to_rep1
     (select (area_math__empty_array__aggregate_def temp___156) temp___157)) temp___156)))))
...
;; line_length__post_axiom
  ...
  (ada___ada__text_io__current_in us_private)) (! (dynamic_invariant4
  (line_length ada___ada__text_io__current_out
  ada___ada__text_io__current_err ada___ada__text_io__standard_in
  ada___ada__text_io__file_system ada___ada__text_io__standard_out
  ada___ada__text_io__standard_err ada___ada__text_io__current_in) true false
  true
  true) :pattern ((line_length ada___ada__text_io__current_out
...
;; page_length__post_axiom
  ...
  (ada___ada__text_io__standard_err us_private)
  (ada___ada__text_io__current_in us_private)) (! (dynamic_invariant4
  (page_length ada___ada__text_io__current_out
  ada___ada__text_io__current_err ada___ada__text_io__standard_in
  ada___ada__text_io__file_system ada___ada__text_io__standard_out
  ada___ada__text_io__standard_err ada___ada__text_io__current_in) true false
  true
  true) :pattern ((page_length ada___ada__text_io__current_out
                  ada___ada__text_io__current_err
                  ada___ada__text_io__standard_in
                  ada___ada__text_io__file_system
                  ada___ada__text_io__standard_out
...
(assert
;; defqtvc
 ;; File "area_math.ads", line 1, characters 0-0
  (not
  (=> (= (area_math__empty_array__aggregate_def #x00000000) empty_array)
  (=>
  (exists ((usf Int))
