...
;; defqtvc
 ;; File "very_longs.ads", line 12, characters 0-0
  ...
  (exists ((index Int))
  (and (= index 1)
  (ite (= (and (ite (<= 1 index) true false) (ite (<= index temp___237) true
                                             false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields3) temp___243)
               (<= temp___243 (last1 result____split_fields3)))
               (=>
               (or (< temp___237 temp___243)
               (or (< temp___243 1) (<= index1 temp___243)))
               (= (select (to_array result____split_fields3) temp___243) (select 
