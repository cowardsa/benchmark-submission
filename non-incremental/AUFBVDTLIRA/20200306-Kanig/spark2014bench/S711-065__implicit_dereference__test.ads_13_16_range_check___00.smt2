...
;; defqtvc
 ;; File "test.ads", line 9, characters 0-0
  ...
  (= o1 (ite (<= 14 (length (rec__test__bytes_ptr__pointer_value buffer)))
        true false))
  (= o1 false))
  (ite (= o1 true)
  (let ((o2 (+ (first1 (rec__test__bytes_ptr__pointer_value buffer)) 13)))
  (and (in_range o2)
  (let ((o3 (+ (first1 (rec__test__bytes_ptr__pointer_value buffer)) 12)))
  (and (in_range o3)
  (let ((temp___244 (rec__test__bytes_ptr__pointer_value buffer)))
  (and
  (=> (<= o3 o2)
  (and (and (<= (first1 temp___244) o3) (<= o3 (last1 temp___244)))
  (and (<= (first1 temp___244) o2) (<= o2 (last1 temp___244)))))
  (let ((temp___247 (of_array (to_array temp___244) o3 o2)))
  (= o (bool_eq (to_array temp___247) (first1 temp___247) (last1 temp___247)
       (temp_____aggregate_def_179 #x00 #x00) 0 1)))))))))
  (= o false))))
  (=> (= o true)
  (let ((o1 (+ (first1 (rec__test__bytes_ptr__pointer_value buffer)) 13)))
  (=> (in_range o1)
  (let ((o2 (+ (first1 (rec__test__bytes_ptr__pointer_value buffer)) 12)))
  (=> (in_range o2)
  (=> (<= o2 o1)
