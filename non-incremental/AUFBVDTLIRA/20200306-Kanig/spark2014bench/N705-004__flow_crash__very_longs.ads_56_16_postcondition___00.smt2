...
(define-fun us_split_fields_rec__very_longs__very_long__long_digits__23__projection ((a us_split_fields2)) us_t 
...
(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___212 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
...
(define-fun of_base ((r1 us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r1)
                                          ...
                                          (let ((temp___211 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array (to_array temp___211)
                                          (first1 temp___211)
                                          (last1 temp___211))))))
...
(define-fun dynamic_invariant4 ((temp___expr_686 us_rep1)
  ...
  (temp___do_typ_inv_685 Bool)) Bool (and
                                     ...
                                     (first1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_686)))
                                     (last1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_686))))
                                     (and
                                     (= (first1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_686))) 1)
                                     (= (last1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_686))) 
                                     (to_rep
...
(define-fun default_initial_assumption ((temp___expr_689 us_rep1)
...
(((t81b__refqtmk (t81b__content us_t)))))
(define-fun t81b__ref_t81b__content__projection ((a t81b__ref)) us_t 
  (t81b__content a))

(declare-fun temp_____aggregate_def_1072 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1074 (_ BitVec 8)))
  (forall ((temp___1075 Int) (temp___1076 Int))
  (let ((temp___1073 (temp_____aggregate_def_1072 temp___1074 temp___1075
                     temp___1076)))
  (=> (dynamic_invariant3 temp___1074 true true true true)
  (and
  (=> (dynamic_property 1 2147483647 temp___1075 temp___1076)
  (and (= (first1 temp___1073) temp___1075)
  (= (last1 temp___1073) temp___1076)))
  (forall ((temp___1077 Int))
  (= (to_rep2 (select (to_array temp___1073) temp___1077)) temp___1074))))))))
...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 53, characters 0-0
  (not
  ...
  (let ((temp___1078 (temp_____aggregate_def_1072 #x00 1 o1)))
  (=> (= (first1 temp___1078) 1)
  (=>
  (= (last1 temp___1078) (to_rep
                         (rec__very_longs__very_long__octet_length
                         (us_split_discrs1 l))))
  (=>
  (ite (<= (first1 temp___1078) (last1 temp___1078))
  (and
  (<= 1 (to_rep
        (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))
  (= (- (last1 temp___1078) (first1 temp___1078)) (- (to_rep
                                                     (rec__very_longs__very_long__octet_length
                                                     (us_split_discrs1 l))) 1)))
  (< (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1))
  (let ((temp___1080 (of_array (to_array temp___1078) (first1 temp___1078)
                     (last1 temp___1078))))
  (=>
  (ite (<= (first1 temp___1080) (last1 temp___1080))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1080) (first1 temp___1080)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1080)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1085 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r)))))
  (exists ((j Int))
  (and (= j 1)
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1085) true false)) true)
  ...
  (and (= carry2 #x0000)
  (and
  (let ((temp___1087 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1087) true false)) true)
  ...
  (= (and (ite (and
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1088 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1088) i1) (<= i1 (last1 temp___1088)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1088) i1)) o2)
  (exists ((l_digit3 (_ BitVec 16)))
  (and (= l_digit3 ((_ zero_extend 8) o2))
  (let ((temp___1089 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1089) j1) (<= j1 (last1 temp___1089)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1089) j1)) o3)
  (exists ((r_digit3 (_ BitVec 16)))
  (and (= r_digit3 ((_ zero_extend 8) o3))
  (and (= (last1 result____split_fields4) r84b)
  (and (in_range2 r84b)
  (and
  (let ((o4 (+ i1 j1)))
  (and (in_range2 o4)
  ...
  (let ((o5 (+ i1 j1)))
  (and (in_range2 o5)
  (let ((temp___1091 (- o5 1)))
  (and
  (and (<= (first1 result____split_fields4) temp___1091)
  (<= temp___1091 (last1 result____split_fields4)))
  (exists ((o6 (_ BitVec 8)))
  (and
  (= (to_rep2 (select (to_array result____split_fields4) temp___1091)) o6)
  ...
  (let ((o9 (+ i1 j1)))
  (and (in_range2 o9)
  (let ((temp___1093 (- o9 1)))
  (and
  (and (<= (first1 result____split_fields4) temp___1093)
  (<= temp___1093 (last1 result____split_fields4)))
  (and
  (= result____split_fields2 (us_tqtmk
                             (store (to_array result____split_fields4) temp___1093 o8)
  ...
  (= i1 temp___1087))))))))))))))))))
  (= result____split_fields2 result____split_fields3))))) (= j1 temp___1085))))))
