...
;; defqtvc
 ;; File "hermes-der-encode.ads", line 34, characters 0-0
  ...
  (dynamic_invariant temp___398 true false true true))
  (let ((o1 (- (+ 0 (+ 1 (length (first1 temp___399) (last1 temp___399)))) 1)))
  (=> (in_range o1)
  (forall ((o2 octet))
  (=> (= (to_rep1 o2) temp___398)
  (let ((temp___400 (of_array
                    (concat_singleton_left o2 0 (to_array temp___399)
                    (first1 temp___399) (last1 temp___399)) 0 o1)))
  (=> (not (= (length1 temp___400) 0)) (in_range
  (- (+ (first1 temp___400) (+ (length (first1 temp___400)
