...
;; defqtvc
 ;; File "keccak-sponge.ads", line 146, characters 0-0
  ...
  (=> (= block_offset1 r57s)
  (=> (dynamic_invariant r57s true false true true)
  (let ((o10 (+ block_offset1 remaining_bytes)))
  (=> (in_range1 o10)
  (=> (= (- o10 1) r58s)
  (=> (dynamic_invariant2 r58s true false true true)
  (=> (= data_last1 r61s)
  (=> (dynamic_invariant4 r61s true false true true)
  ...
  (let ((o12 (+ o11 bit_length))) (=> (in_range1 o12) (in_range7 o12))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
