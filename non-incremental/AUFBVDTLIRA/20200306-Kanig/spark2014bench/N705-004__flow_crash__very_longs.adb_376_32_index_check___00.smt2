...
(define-fun dynamic_invariant4 ((temp___expr_778 Int)
...
(define-fun s123b__ref_s123b__content__projection ((a s123b__ref)) us_t 
  (s123b__content a))

(declare-datatypes ((t126b__ref 0))
(((t126b__refqtmk (t126b__content us_t)))))
...
(define-fun dynamic_invariant6 ((temp___expr_843 us_t)
  (temp___is_init_839 Bool) (temp___skip_constant_840 Bool)
  (temp___do_toplevel_841 Bool)
  (temp___do_typ_inv_842 Bool)) Bool (=>
                                     (not (= temp___skip_constant_840 true))
                                     (and (dynamic_property 1 r124b
                                     (first1 temp___expr_843)
                                     (last1 temp___expr_843))
                                     (and (= (first1 temp___expr_843) 1)
                                     (= (last1 temp___expr_843) r124b)))))

(define-fun default_initial_assumption ((temp___expr_845 us_t)
  (temp___skip_top_level_846 Bool)) Bool (and (= (first1 temp___expr_845) 1)
                                         (= (last1 temp___expr_845) r124b)))

(assert
;; defqtvc
 ;; File "very_longs.adb", line 362, characters 0-0
  (not
  (forall ((result____split_fields us_t) (new_overflow (_ BitVec 8))
  (overflow_mask (_ BitVec 8)) (old_overflow (_ BitVec 8))
  (very_longs__divide__full_left_shift__R124b__assume Int))
  ...
  (let ((temp___1334 (of_array (to_array temp___1332) (first1 temp___1332)
                     (last1 temp___1332))))
  (=>
  (ite (<= (first1 temp___1334) (last1 temp___1334))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1334) (first1 temp___1334)) (- (last1
  ...
  (=>
  (= result____split_fields1 (of_array (to_array temp___1334)
  ...
  (=> (= overflow_mask1 o)
  (let ((temp___1340 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 number)))))
  (forall ((i Int))
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1340) true false)) true)
  ...
  (= (and (ite (and
               ...
               true))
               (forall ((temp___1353 Int))
               (=>
               (and (<= (first1 result____split_fields2) temp___1353)
               (<= temp___1353 (last1 result____split_fields2)))
               (=>
               (or (< temp___1340 temp___1353)
               (or (< temp___1353 1) (<= i1 temp___1353)))
               (= (select (to_array result____split_fields2) temp___1353) (select 
               (to_array result____split_fields1) temp___1353))))))
          ...
          true false) (ite (and (<= 1 i1)
                      ...
                      true false)) true)
  (let ((o1 (- 8 distance)))
  (let ((temp___1341 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 number))))
  (=> (and (<= (first1 temp___1341) i1) (<= i1 (last1 temp___1341)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1341) i1)) o2)
  ...
  (=>
  (ite (< distance 8)
  (let ((temp___1342 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 number))))
  (and (and (<= (first1 temp___1342) i1) (<= i1 (last1 temp___1342)))
  (exists ((o6 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1342) i1)) o6)
