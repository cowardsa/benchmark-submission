...
(define-fun to_int4 ((x unsigned_16)) Int (ubv_to_int (to_rep1 x)))
...
;; defqtvc
 ;; File "parse.ads", line 15, characters 0-0
  ...
  (let ((o16 query))
  (let ((o17 (extract_unsigned_16 o16 8)))
  (=>
  (and (extract_unsigned_16__function_guard o17 o16 8) (dynamic_invariant o17
  true false true true))
  (forall ((count2 (_ BitVec 16)))
  (=> (= count2 o17)
  (forall ((spark__branch5 Bool))
  (=> (= spark__branch5 (ite (not (= count2 #x0000)) true false))
  (=> (not (= spark__branch5 true))
  (let ((o18 query))
  (let ((o19 (extract_unsigned_16 o18 10)))
  (=>
  (and (extract_unsigned_16__function_guard o19 o18 10) (dynamic_invariant
  o19 true false true true))
  (forall ((count3 (_ BitVec 16)))
  (=> (= count3 o19)
  (forall ((spark__branch6 Bool))
  (=> (= spark__branch6 (ite (not (= count3 #x0000)) true false))
  (=> (not (= spark__branch6 true))
  (forall ((parse__parse_header__R30b__assume Int))
  (=> (= (to_rep4 result____split_discrs) parse__parse_header__R30b__assume)
  (=> (= parse__parse_header__R30b__assume r30b)
  (=> (dynamic_invariant4 r30b true false true true)
  (forall ((o20 return_code_t))
  (=> (= (to_rep4 o20) 0)
  (=> (= result____attr__constrained true) (= o20 result____split_discrs)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
