...
(define-fun in_range2 ((rec__very_longs__very_long__octet_length1 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_266 Int)
...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 74, characters 0-0
  (not
  (forall ((number__split_fields us_t) (digit_number Int) (bit_position Int)
  (digit (_ BitVec 8)) (digit_number1 Int) (bit_position1 Int)
  (o (_ BitVec 8)) (digit1 (_ BitVec 8)) (digit2 (_ BitVec 8)) (o1 octet))
  (=> (dynamic_invariant
  (us_repqtmk number__split_discrs
  (us_split_fieldsqtmk number__split_fields)) true false true true)
  (=> (dynamic_invariant4 bit_number true false true true)
  (=> (dynamic_invariant3 bit_value true false true true)
  (=> (dynamic_invariant1 digit_number false false true true)
  ...
  (=> (= bit_position1 (mod2 bit_number 8))
  (=> (<= (first1 number__split_fields) digit_number1)
  (=> (<= digit_number1 (last1 number__split_fields))
  (=> (= (to_rep2 (select (to_array number__split_fields) digit_number1)) o)
  (=> (= digit1 o)
  (=>
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (= bit_value 1) true false))
