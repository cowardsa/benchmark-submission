...
(assert
;; defqtvc
 ;; File "hermes-der-decode.adb", line 238, characters 0-0
  (not
  (forall ((stop Int) (status Int) (length_stop Int) (length1 Int)
  (length_status Int))
  (=> (dynamic_invariant2 message true false true true)
  (=> (dynamic_invariant identifier_stop true false true true)
  (=> (dynamic_invariant2 message true false true true)
  ...
  (=> (dynamic_invariant length_stop false false true true)
  (=> (dynamic_invariant length1 false false true true)
  (=> (dynamic_invariant1 length_status false false true true)
  ...
  (and
  (and (dynamic_invariant length_stop1 true true true true)
  (dynamic_invariant length2 true true true true)) (dynamic_invariant1
  ...
  (=> (= spark__branch2 (ite (= length2 1) false true))
  (=> (= spark__branch2 true) (in_range1 (+ length_stop1 length2))))))))))))))))))))))))))))))
(check-sat)
(exit)
