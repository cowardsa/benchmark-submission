...
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 75, characters 0-0
  ...
  (forall ((j1 Int))
  (=> (= j1 m1)
  (forall ((quotient__split_fields2 us_t) (u__split_fields2 us_t) (j2 Int)
  ...
  (dynamic_invariant1
  (us_repqtmk1 u__split_discrs (us_split_fieldsqtmk1 u__split_fields2)) false
  true true true))
  ...
  true true true))
  (forall ((quotient__split_fields3 us_t) (u__split_fields4 us_t))
  (=>
  ...
  true true true)) (=> (not (= j2 1)) (in_range1 (- j2 1))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
