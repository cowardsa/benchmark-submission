...
;; defqtvc
 ;; File "ordering_buffers.ads", line 38, characters 0-0
  ...
  (has_message (us_repqtmk buffer__split_fields2) index)
  (us_repqtmk buffer__split_fields2) index))
  (=> (not (= (has_message (us_repqtmk buffer__split_fields) index) true))
  (let ((o index))
  (forall ((buffer__split_fields2 us_split_fields))
  (=>
  ...
  (us_repqtmk buffer__split_fields3)))
  (=>
  (forall ((o1 Int) (buffer__split_fields3 us_split_fields))
  (get_message__function_guard
  (get_message (us_repqtmk buffer__split_fields3) o1)
  (us_repqtmk buffer__split_fields3) o1))
  (=>
  (forall ((buffer__split_fields3 us_split_fields)) (first__function_guard
  (first (us_repqtmk buffer__split_fields3))
  (us_repqtmk buffer__split_fields3)))
  ...
  (= (get_message (us_repqtmk buffer__split_fields2) o) message))
  (forall ((i Int))
  (=>
