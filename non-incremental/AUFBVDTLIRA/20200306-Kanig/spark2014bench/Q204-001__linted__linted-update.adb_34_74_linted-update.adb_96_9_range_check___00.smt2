...
;; defqtvc
 ;; File "linted-update.ads", line 40, characters 0-0
  ...
  (y3 (_ BitVec 32)) (c207b1 (_ BitVec 32)))
  (=>
  (= (to_rep
  ...
  (forall ((spark__branch1 Bool) (y4 (_ BitVec 32)))
  (=>
  ...
  (forall ((spark__branch2 Bool) (y5 (_ BitVec 32)))
  (=>
  ...
  (bvule ((_ zero_extend 24) #x00) (bvand (bvlshr c230b ((_ int_to_bv 32) 24)) #x000000FF)))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
