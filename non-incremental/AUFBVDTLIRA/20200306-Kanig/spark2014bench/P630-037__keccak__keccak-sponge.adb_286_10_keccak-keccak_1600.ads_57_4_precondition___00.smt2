...
;; defqtvc
 ;; File "keccak-sponge.adb", line 273, characters 0-0
  ...
  (=> (= (- o3 1) r97s)
  (=> (dynamic_invariant r97s true false true true)
  ...
  (let ((temp___1103 (of_array
                     (rec__ada___keccak__keccak_1600__sponge__context__block
                     ctx__split_fields) 0 r97s)))
  (<= (length
      (of_array (to_array temp___1103) (first1 temp___1103)
      (last1 temp___1103))) 268435455)))))))))))))))))))))))
(check-sat)
(exit)
