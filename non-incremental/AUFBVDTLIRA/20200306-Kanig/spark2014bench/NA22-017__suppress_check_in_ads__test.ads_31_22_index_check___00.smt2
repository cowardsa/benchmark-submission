...
;; defqtvc
 ;; File "test.ads", line 17, characters 0-0
  ...
  (usf Int) (o (_ BitVec 32)) (o1 (_ BitVec 32)))
  ...
  (and (= (to_rep result____first) temp___253)
  (exists ((temp___254 Int))
  (and (= (to_rep result____last) temp___254)
  (exists ((i Int))
  (and (= i temp___253)
  (ite (= (and (ite (<= temp___253 i) true false) (ite (<= i temp___254) true
                                                  false)) true)
  (and (and (<= (first1 right) i) (<= i (last1 right)))
  (exists ((o2 (_ BitVec 32)))
  (and (= (to_rep1 (select (to_array right) i)) o2)
  (and (and (<= (first1 left) i) (<= i (last1 left)))
  (exists ((o3 (_ BitVec 32)))
  (and (= (to_rep1 (select (to_array left) i)) o3)
  (let ((o4 (xor2 o3 o2)))
  (and
  (and (xor2__function_guard o4 o3 o2)
  (and (dynamic_invariant o4 true false true true) (= o4 (bvxor o3 o2))))
  (exists ((o5 word32))
  (and (= (to_rep1 o5) o4)
  (exists ((result__2 (Array Int word32)))
  (and (= result__2 (store result__ i o5))
  (and (exists ((o6 Int)) (= (to_rep result____first) o6))
  (exists ((i1 Int))
  (and
  (forall ((pos Int))
  ...
  (= (and (ite (and
               ...
               (= (select result__1 temp___257) (select result__ temp___257)))))
  ...
  (=>
  (= (and (ite (<= (first1 left) usf) true false) (ite (<= usf (last1 left))
                                                  true false)) true)
  (=> (<= (first1 right) usf)
  (=> (<= usf (last1 right))
  (=> (= (to_rep1 (select (to_array right) usf)) o)
  (=> (<= (first1 left) usf)
  (=> (<= usf (last1 left))
  (=> (= (to_rep1 (select (to_array left) usf)) o1)
  (let ((o2 (xor2 o1 o)))
  (=>
