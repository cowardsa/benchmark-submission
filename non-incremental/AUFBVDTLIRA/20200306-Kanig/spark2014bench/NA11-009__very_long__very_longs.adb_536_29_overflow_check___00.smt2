...
(assert
;; defqtvc
 ;; File "very_longs.adb", line 515, characters 0-0
  (not
  ...
  (=> (= carry1 #x0000)
  (=> (= n r127b)
  (=> (dynamic_invariant7 r127b true false true true)
  (=>
  (let ((temp___1406 r127b))
  (exists ((divisor_index Int))
  (and (= divisor_index 1)
  (ite (= (and (ite (<= 1 divisor_index) true false) (ite (<= divisor_index temp___1406)
                                                     true false)) true)
  ...
  (and (in_range2 o4)
  (let ((temp___1408 (- o4 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1408)
  (<= temp___1408 (last1 u__split_fields2)))
  (exists ((o5 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields2) temp___1408)) o5)
  ...
  (and (in_range2 o8)
  (let ((temp___1411 (- o8 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1411)
  (<= temp___1411 (last1 u__split_fields2)))
  (and
  (= u__split_fields1 (us_tqtmk
                      (store (to_array u__split_fields2) temp___1411 o7)
                      (rt u__split_fields2)))
  ...
  (= o9 (bvudiv sum2 (ite (< 8 65536) (bvshl #x0001 ((_ int_to_bv 16) 8))
                     #x0000)))))
  (and (= carry2 o9) (= divisor_index1 temp___1406))))))))))))))))))))))))))
