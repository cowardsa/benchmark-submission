...
;; defqtvc
 ;; File "very_longs.ads", line 43, characters 0-0
  ...
  (let ((temp___993 (temp_____aggregate_def_987 #x00 1 o1)))
  (=> (= (first1 temp___993) 1)
  (=>
  ...
  (let ((temp___995 (of_array (to_array temp___993) (first1 temp___993)
                    (last1 temp___993))))
  (=>
  ...
  (=> (= result____split_fields1 temp___995)
  ...
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1000) true false)) true)
  ...
  (let ((temp___1001 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1001) i1) (<= i1 (last1 temp___1001)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1001) i1)) o2)
  (forall ((l_digit2 (_ BitVec 16)))
  (=> (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1002 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1002) i1) (<= i1 (last1 temp___1002)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1002) i1)) o3)
