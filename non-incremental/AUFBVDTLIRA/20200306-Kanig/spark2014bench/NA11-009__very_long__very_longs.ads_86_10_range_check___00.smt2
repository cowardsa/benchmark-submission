...
(define-fun in_range2 ((rec__very_longs__very_long__length1 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_263 us_rep)
...
;; defqtvc
 ;; File "very_longs.ads", line 3, characters 0-0
  ...
  (=>
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 usf1))) usf)
  (=> (<= 1 usf) (<= 1 1)))))))
(check-sat)
(exit)
