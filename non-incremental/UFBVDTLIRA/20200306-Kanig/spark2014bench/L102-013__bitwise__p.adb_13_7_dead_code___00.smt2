...
;; defqtvc
 ;; File "p.adb", line 1, characters 0-0
  (not
  (=> (dynamic_invariant havok_x true false true true)
  (=> (dynamic_invariant havok_y true false true true)
  ...
  (=> (= spark__branch1 (ite (bvult (bvor x y) x) true false))
  (forall ((spark__branch2 Bool))
  (=> (= spark__branch2 (ite (bvult (bvxor x y) x) true false))
