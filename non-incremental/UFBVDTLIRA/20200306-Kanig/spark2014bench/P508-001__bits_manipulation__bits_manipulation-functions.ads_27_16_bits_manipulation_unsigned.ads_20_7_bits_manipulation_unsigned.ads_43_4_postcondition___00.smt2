...
(define-fun dynamic_invariant2 ((temp___expr_421 Int)
  ...
  (temp___do_typ_inv_420 Bool)) Bool (=>
                                     ...
                                     (<= 0 15)) (in_range1 temp___expr_421)))

;; msb_index_fast_inline_always__post_axiom
  (assert
  (forall ((value1 (_ BitVec 16))) (! (in_range1
  (msb_index_fast_inline_always value1)) :pattern ((msb_index_fast_inline_always
                                                   value1)) )))

(declare-fun msb_index_fast_inline ((_ BitVec 16)) Int)

(declare-fun msb_index_fast_inline__function_guard (Int (_ BitVec 16)) Bool)
...
(declare-fun msb_index_fast_not_inline ((_ BitVec 16)) Int)
...
(declare-fun msb_index_slow_inline_always ((_ BitVec 16)) Int)
...
;; msb_index_slow_inline_always__post_axiom
  ...
  (! (=>
     ...
     (and (= (shift_right value1 result) #x0001) (dynamic_invariant2 result
     true false true true)))) :pattern ((msb_index_slow_inline_always value1)) )))

(declare-fun msb_index_slow_inline ((_ BitVec 16)) Int)

(declare-fun msb_index_slow_inline__function_guard (Int (_ BitVec 16)) Bool)
...
(declare-fun msb_index_slow_not_inline ((_ BitVec 16)) Int)
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 23, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_16__functions__msb_index__result Int))
  ...
  (= (shift_right o o1) #x0001)) (= result__1 o1))))
  ...
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (and (= o1 (msb_index_slow_inline_always o)) (= (shift_right o o1) #x0001)))
  (= result__1 o1))))
  (let ((o value))
  ...
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (and (= o1 (msb_index_fast_inline_always o)) (= (shift_right o o1) #x0001)))
  (= result__1 o1))))
  (let ((o value))
  ...
  (= result__1 o1)))))))))))))
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__msb_index__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_16__functions__msb_index__result) #x0001)))))))))
(check-sat)
(exit)
