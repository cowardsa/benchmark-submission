...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 198, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result (_ BitVec 16))
  (i Int))
  ...
  (=> (= (axiom__ Tuple0) true)
  (=>
  (let ((temp___574 amount))
  (exists ((i1 Int))
  (and (= i1 1)
  (ite (= (and (ite (<= 1 i1) true false) (ite (<= i1 temp___574) true false)) true)
  ...
  (= i2 temp___574)))))))))))) (= result__1 result__)))))
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result result__1)
  (=> (<= 1 i)
  (=> (<= i amount)
