...
(assert
;; defqtvc
 ;; File "x86.ads", line 74, characters 0-0
  (not
  ...
  (=>
  (= rax2 (bvor (bvand rax #xFFFFFFFF00000000) ((_ zero_extend 32) val__)))
  (= rax2 (bvor (bvand rax1 #xFFFFFFFF00000000) ((_ zero_extend 32) val__))))))))))
(check-sat)
(exit)
