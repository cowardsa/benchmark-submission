...
(define-fun dynamic_invariant ((temp___expr_164 (_ BitVec 64))
  (temp___is_init_160 Bool) (temp___skip_constant_161 Bool)
  (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "alpha_launch_examples.adb", line 36, characters 0-0
  (not
  (forall ((alpha_launch_examples__example_3__result (_ BitVec 64)))
