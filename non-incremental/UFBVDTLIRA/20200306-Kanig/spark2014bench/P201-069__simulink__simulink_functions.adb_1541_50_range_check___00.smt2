...
(define-fun source__ref_source__content__8__projection ((a source__ref)) source 
  (source__content a))

(define-fun dynamic_invariant ((temp___expr_475 (_ BitVec 32))
  (temp___is_init_471 Bool) (temp___skip_constant_472 Bool)
  (temp___do_toplevel_473 Bool) (temp___do_typ_inv_474 Bool)) Bool true)
...
(define-fun target__ref_target__content__8__projection ((a target__ref)) target 
  (target__content a))

(define-fun dynamic_invariant1 ((temp___expr_482 (_ BitVec 8))
  (temp___is_init_478 Bool) (temp___skip_constant_479 Bool)
  (temp___do_toplevel_480 Bool) (temp___do_typ_inv_481 Bool)) Bool true)
...
;; u32tou8__post_axiom
  ...
  (! (=> (dynamic_invariant s true true true true)
     ...
     (=> (u32tou8__function_guard result s) (dynamic_invariant1 result true
     false true true)))) :pattern ((u32tou8 s)) )))
...
(assert
;; defqtvc
 ;; File "simulink_functions.ads", line 213, characters 0-0
  (not
