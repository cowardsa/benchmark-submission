...
(declare-const arg2 (_ BitVec 32))
...
(define-fun dynamic_invariant1 ((temp___expr_172 (_ BitVec 32))
  (temp___is_init_168 Bool) (temp___skip_constant_169 Bool)
  (temp___do_toplevel_170 Bool)
  (temp___do_typ_inv_171 Bool)) Bool (=>
                                     (or (= temp___is_init_168 true)
                                     (bvule #x00000001 #xFFFFFFFF)) (in_range
                                     temp___expr_172)))

(assert
;; defqtvc
 ;; File "spark-mod_arithmetic_lemmas.ads", line 63, characters 0-0
  (not
  (=> (dynamic_invariant arg1 true false true true)
  (=> (dynamic_invariant1 arg2 true false true true)
  (=> (dynamic_invariant res true false true true) (not (= arg2 #x00000000)))))))
(check-sat)
(exit)
