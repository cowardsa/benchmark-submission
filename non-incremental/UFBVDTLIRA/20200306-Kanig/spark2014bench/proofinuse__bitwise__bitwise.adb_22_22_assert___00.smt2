...
(assert
;; defqtvc
 ;; File "bitwise.ads", line 13, characters 0-0
  (not
  (forall ((res (_ BitVec 32)) (res1 (_ BitVec 32)) (res2 (_ BitVec 32)))
  (=> (dynamic_invariant x true false true true)
  (=> (dynamic_invariant res false false true true)
  (=> (= res1 (bvlshr x ((_ int_to_bv 32) 1)))
  (=> (= res1 (bvudiv x #x00000002))
  (=> (= res2 (bvlshr res1 ((_ int_to_bv 32) 2)))
  (= res2 (bvudiv x #x00000008))))))))))
(check-sat)
(exit)
