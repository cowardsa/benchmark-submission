...
(assert
;; defqtvc
 ;; File "x86.ads", line 474, characters 0-0
  (not
  (forall ((x86__signedlt_32__result Bool))
  (=> (dynamic_invariant val1 true false true true)
  (=> (dynamic_invariant val2 true false true true)
  (=>
  (= x86__signedlt_32__result (ite (bvugt (bvadd ((_ zero_extend 32) 
                              val1) ((_ zero_extend 32) val2)) ((_ zero_extend 32) (bvadd 
                              val1 val2))) true false))
  (=> (= x86__signedlt_32__result true)
