...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 42, characters 0-0
  ...
  (= o8 (ite (and (<= 1 8) (<= 8 8))
        (ite (< o6 8) (bvlshr o7 ((_ int2bv 8) o6)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< o6 16)
                         (bvlshr ((_ zero_extend 8) o7) ((_ int2bv 16) o6))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o7) ((_ int2bv 32) o6)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o7) ((_ int2bv 64) o6))))))))
  (=>
  (or
  (not
