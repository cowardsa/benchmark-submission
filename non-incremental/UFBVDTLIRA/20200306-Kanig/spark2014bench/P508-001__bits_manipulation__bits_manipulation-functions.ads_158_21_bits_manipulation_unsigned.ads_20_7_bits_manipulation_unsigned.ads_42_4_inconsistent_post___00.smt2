...
;; lemma3__def_axiom
  ...
  (! (= (= (lemma3 us_void_param) true)
     ...
     (forall ((j Int))
     (=> (and (<= n j) (<= j 7)) (bvule (shift_right val__ j) #x01))))
     (= (shift_right val__ n) #x01)))))))) :pattern ((lemma3 us_void_param)) )))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 156, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_right__lemma3__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_right__lemma3__result true)
  (= (lemma3 Tuple0) true))))))
(check-sat)
(exit)
