...
;; defqtvc
 ;; File "p.ads", line 13, characters 0-0
  ...
  (=> (and (bvule #x0000000000000001 i1) (bvule i1 #x0000000000000010))
  (=>
  (= m1 (let ((temp___214 (ubv_to_int (bvsub #x0000000000000020 (bvmul #x0000000000000002 i1)))))
        (ite (< temp___214 18446744073709551616)
        (bvshl #x0000000000000001 ((_ int_to_bv 64) temp___214))
        #x0000000000000000)))
  (=> (= (bvurem y3 m1) #x0000000000000000)
  (=>
  (bvult left_y (let ((temp___210 (ubv_to_int i1)))
                (ite (< temp___210 18446744073709551616)
                (bvshl #x0000000000000001 ((_ int_to_bv 64) temp___210))
                #x0000000000000000)))
  (=> (= (bvurem ux2 m1) (bvurem ((_ int_to_bv 64) x) m1))
