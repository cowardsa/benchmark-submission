...
;; defqtvc
 ;; File "x86.ads", line 19, characters 0-0
  ...
  (=>
  (= (and (ite (bvule #x0000000000000000 n1) true false) (ite (bvule n1 
                                                         var1_range_size)
                                                         true false)) true)
  ...
  (forall ((n21 (_ BitVec 64)) (n3 (_ BitVec 64)))
  (=>
  (forall ((j (_ BitVec 64)))
  ...
  (= (and (ite (and (dynamic_property2 #x0000000000000000 var2_range_size
          ...
          true false) (ite (and (bvule #x0000000000000000 n21)
                      ...
                      true false)) true)
  (=> (not (= n21 temp___179))
  (forall ((n22 (_ BitVec 64)))
  (=> (= n22 (bvadd n21 #x0000000000000001))
  (forall ((n4 (_ BitVec 64)))
  (=> (= n4 (bvadd n22 (bvsub var1_range_size n11)))
  (=> (dynamic_invariant n4 true false true true)
  (=>
  (and (bvule #x0000000000000000 n4)
  (bvule n4 (bvadd var1_range_size var2_range_size)))
  (=> (not (= var1 (bvadd (bvsub var2 var1_range_size) n4)))
  (=> (not (= (bvadd var1 n11) (bvadd var2 n22)))
  (forall ((j (_ BitVec 64)))
