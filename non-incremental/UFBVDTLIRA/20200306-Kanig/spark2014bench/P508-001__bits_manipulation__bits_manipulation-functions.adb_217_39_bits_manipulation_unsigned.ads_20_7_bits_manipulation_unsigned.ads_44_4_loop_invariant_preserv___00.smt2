...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 302, characters 0-0
  ...
  (= (make_mask i) (bvsub (ite (< i 4294967296)
                          (bvshl #x00000001 ((_ int_to_bv 32) i)) #x00000000) #x00000001))
  (=>
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 (- i1 1)))
  (= (make_mask j1) (bvsub (ite (< j1 4294967296)
                           (bvshl #x00000001 ((_ int_to_bv 32) j1)) #x00000000) #x00000001))))
  (=>
  ...
  (= (make_mask i2) (bvsub (ite (< i2 4294967296)
                           (bvshl #x00000001 ((_ int_to_bv 32) i2)) #x00000000) #x00000001))
  (=> (<= 1 j)
  (=> (<= j (- i2 1))
  (= (make_mask j) (bvsub (ite (< j 4294967296)
                          (bvshl #x00000001 ((_ int_to_bv 32) j)) #x00000000) #x00000001)))))))))))))))))
(check-sat)
(exit)
