...
(declare-fun cl ((_ BitVec 64)) (_ BitVec 8))

(declare-fun cl__function_guard ((_ BitVec 8) (_ BitVec 64)) Bool)
...
;; cl__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rcx true true true true)
     ...
     (and (= result ((_ extract 7 0) (bvand x86__rcx #x00000000000000FF)))
     (dynamic_invariant1 result true false true true))))) :pattern ((cl
                                                                    x86__rcx)) )))

(assert
;; defqtvc
 ;; File "x86.ads", line 507, characters 0-0
  (not
  (forall ((zeroflag Bool) (carryflag Bool) (rcx (_ BitVec 64))
  (rcx1 (_ BitVec 64)))
  (=> (dynamic_invariant rcx true false true true)
  (=>
  (exists ((spark__branch Bool))
  (and
  (= spark__branch (and (ite (= carryflag true) false true) (ite (= zeroflag true)
                                                            false true)))
  (ite (= spark__branch true)
  (exists ((rcx2 (_ BitVec 64)))
  (and (= rcx2 rcx)
  (and
  (= rcx1 (bvor (bvand rcx2 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) #x01)))
  (dynamic_invariant rcx1 true true true true))))
  (exists ((rcx2 (_ BitVec 64)))
  (and (= rcx2 rcx)
  (and
  (= rcx1 (bvor (bvand rcx2 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) #x00)))
  (dynamic_invariant rcx1 true true true true)))))))
  (=> (not (= carryflag true))
  (=> (not (= zeroflag true))
