  ...
  (! (=>
     ...
     (= (shift_left v amount) (ite (and (<= 1 64) (<= 64 8))
                              ...
                              ((_ zero_extend 48) (ite (< amount 16)
                                                  ...
                                                  #x0000))
                              (ite (and (<= 17 64) (<= 64 32))
                              ((_ zero_extend 32) (bvshl ((_ extract 31 0) v) ((_ int_to_bv 32) amount)))
                              (bvshl v ((_ int_to_bv 64) amount))))))) :pattern (
  (shift_left v amount)) ))))
...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 23, characters 0-0
  ...
  (let ((o1 len))
  (=> (in_range1 o1)
  (let ((bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume 
  (make_mask o1)))
  (=>
  ...
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume 
  (shift_right #xFFFFFFFFFFFFFFFF (- 64 o1))))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume 
  mask)
  ...
  (= o4 (ite (and (<= 1 64) (<= 64 8))
        ...
        ((_ zero_extend 48) (ite (< o2 16)
                            ...
                            #x0000))
        (ite (and (<= 17 64) (<= 64 32))
        ((_ zero_extend 32) (bvlshr ((_ extract 31 0) o3) ((_ int_to_bv 32) o2)))
        (bvlshr o3 ((_ int_to_bv 64) o2)))))))
  (forall ((result__1 (_ BitVec 64)))
  (=> (= result__1 (bvand o4 mask))
  (=> (bvule result__1 mask)
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result (_ BitVec 64)))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result result__1)
  (let ((o5 (+ (- to__ from) 1)))
  (=> (in_range1 o5)
  (let ((o6 (make_mask o5)))
  (=>
  (and (dynamic_invariant1 o6 true false true true)
  (= o6 (shift_right #xFFFFFFFFFFFFFFFF (- 64 o5))))
  (let ((o7 from))
  (let ((o8 value))
  (let ((o9 (shift_right o8 o7)))
  (=>
  (and (dynamic_invariant1 o9 true false true true)
  (= o9 (ite (and (<= 1 64) (<= 64 8))
        ((_ zero_extend 56) (ite (< o7 8)
                            (bvlshr ((_ extract 7 0) o8) ((_ int_to_bv 8) o7))
                            #x00))
        (ite (and (<= 9 64) (<= 64 16))
        ((_ zero_extend 48) (ite (< o7 16)
                            (bvlshr ((_ extract 15 0) o8) ((_ int_to_bv 16) o7))
                            #x0000))
        (ite (and (<= 17 64) (<= 64 32))
        ((_ zero_extend 32) (bvlshr ((_ extract 31 0) o8) ((_ int_to_bv 32) o7)))
        (bvlshr o8 ((_ int_to_bv 64) o7)))))))
  (=>
  (or
  (not
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result (bvand o9 o6)))
  (let ((o10 (+ (- to__ from) 1)))
  (and (in_range1 o10)
  (let ((o11 (make_mask o10)))
  (and (dynamic_invariant1 o11 true false true true)
  (= o11 (shift_right #xFFFFFFFFFFFFFFFF (- 64 o10))))))))
  (=>
  (and
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result (bvand o9 o6))
  (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result 
