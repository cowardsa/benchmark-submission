...
;; defqtvc
 ;; File "x86.ads", line 19, characters 0-0
  ...
  (forall ((n1 (_ BitVec 64)))
  (=> (= n1 #x0000000000000000)
  (=>
  (= (and (ite (bvule #x0000000000000000 n1) true false) (ite (bvule n1 temp___177)
                                                         true false)) true)
  (forall ((n11 (_ BitVec 64)))
  (=>
  (=> (not (= n11 #x0000000000000000))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule #x0000000000000000 i) (bvule i (bvsub n11 #x0000000000000001)))
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 j) (bvule j var2_range_size))
  (not (= (bvadd var1 i) (bvadd var2 j))))))))
  (=>
  (= (and (ite (dynamic_property1 #x0000000000000000 var1_range_size n11)
          true false) (ite (and (bvule #x0000000000000000 n11)
                           (bvule n11 var1_range_size))
                      true false)) true)
  (=>
  (let ((temp___179 var2_range_size))
  (exists ((n2 (_ BitVec 64)))
  (and (= n2 #x0000000000000000)
  (or
  (not
  (= (and (ite (bvule #x0000000000000000 n2) true false) (ite (bvule n2 temp___179)
                                                         true false)) true))
  (exists ((n (_ BitVec 64)))
  (and (= n (bvadd n2 (bvsub var1_range_size n11)))
  ...
  (and (not (= (bvadd var1 n11) (bvadd var2 n2)))
  (exists ((n21 (_ BitVec 64)) (n3 (_ BitVec 64)))
  (and
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 j) (bvule j n21))
  (not (= (bvadd var1 n11) (bvadd var2 j)))))
  (and
  (= (and (ite (and (dynamic_property2 #x0000000000000000 var2_range_size
               n21) (dynamic_invariant n3 true true true true))
          true false) (ite (and (bvule #x0000000000000000 n21)
                           (bvule n21 var2_range_size))
                      true false)) true)
  (= n21 temp___179))))))))))))))
  (=>
  (forall ((j (_ BitVec 64)))
  ...
  (=> (not (= n11 #x0000000000000000))
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 i) (bvule i n11))
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 j) (bvule j var2_range_size))
  (not (= (bvadd var1 i) (bvadd var2 j))))))))
  (=>
  ...
  (not (= (bvadd var1 i) (bvadd var2 j)))))))
  (=> (not (= n11 temp___177))
  (forall ((n12 (_ BitVec 64)))
  (=> (= n12 (bvadd n11 #x0000000000000001))
