...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant4 item true true true true)
     (and
     (forall ((item1 Int) (e1 Int)) (my_eq__function_guard (my_eq e1 item1)
     e1 item1))
     (=> (= (distinct 1 0) true)
     (=>
     (exists ((e1 Int))
...
(assert
;; defqtvc
 ;; File "p.ads", line 20, characters 0-0
  (not
  ...
  (forall ((l__split_fields1 us_main_type) (cu__split_fields count_type)
  (i Bool))
  (=>
  (forall ((o2 Int) (o3 us_split_discrs) (l__split_fields2 us_main_type)
  (cu__split_fields1 count_type)) (my_eq__function_guard
  (my_eq
  (element (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields2))
  (us_repqtmk (us_split_fieldsqtmk cu__split_fields1))) o2)
  (element (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields2))
  (us_repqtmk (us_split_fieldsqtmk cu__split_fields1))) o2))
  (=>
  (and
  (and
  (and
  (= (contains1 (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1)) o) true)
  (= (has_element (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields))) true))
  (= (my_eq
     (element (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields))) o) true))
  (ite (= (contains1 (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields))
          o) true)
  (and
  (and
  (and (not (= i true))
  (= (oeq1 (model1 (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1)))
     (model1 (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields)))) true))
  (= (oeq2
     (elements (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1)))
     (elements (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields)))) true))
  (= (oeq3
     (positions (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1)))
     (positions (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields)))) true))
  (and
  (and
  (and
  (and
  (and
  (and (= i true)
  (= (length (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1))) (+ 
  (length (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields))) 1)))
  (= (element (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields))) o))
  (= (ole (model1 (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields)))
     (model1 (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1)))) true))
  (= (included_except
     (model1 (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1)))
     (model1 (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields))) o) true))
  (= (mapping_preserved
     (elements (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields)))
     (elements (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1)))
     (positions (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields)))
     (positions (us_repqtmk1 o1 (us_split_fieldsqtmk1 l__split_fields1)))) true))
  ...
  (forall ((l__split_fields2 us_main_type) (cu__split_fields1 count_type))
  (=>
  (and
  (and
  (and
  ...
  (= (bool_eq (us_repqtmk (us_split_fieldsqtmk cu__split_fields1))
     no_element) true)
  (= (length (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields2))) (- 
  (length (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields1))) 1)))
  (not
  (= (contains1 (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields2))
     (element (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields1))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields)))) true)))
  (not
  (= (has_key
     (positions (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields2)))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields))) true)))
  (= (ole (model1 (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields2)))
     (model1 (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields1)))) true))
  (= (included_except
     (model1 (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields1)))
     (model1 (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields2)))
     (element (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields1))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields)))) true))
  (= (mapping_preserved
     (elements (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields2)))
     (elements (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields1)))
     (positions (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields2)))
     (positions (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields1)))) true))
  (= (keys_included_except
     (positions (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields1)))
     (positions (us_repqtmk1 o2 (us_split_fieldsqtmk1 l__split_fields2)))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields))) true))
  (let ((temp___970 (us_repqtmk1 l__split_discrs
                    (us_split_fieldsqtmk1 l__split_fields2))))
  (forall ((usf count_type))
  (let ((usf1 (us_repqtmk (us_split_fieldsqtmk usf))))
  (let ((o3 (has_element temp___970 usf1)))
  (=> (= (= o3 true) (= (has_key (positions temp___970) usf1) true))
  (=> (= (and (ite true true false) o3) true)
  (= (has_element
     (us_repqtmk1 l__split_discrs (us_split_fieldsqtmk1 l__split_fields))
     usf1) true))))))))))))))))))))))
(check-sat)
