...
;; msb_index_slow_inline_always__post_axiom
  ...
  (! (=>
     ...
     (and (= (shift_right value result) #x01) (dynamic_invariant2 result true
     false true true)))) :pattern ((msb_index_slow_inline_always value)) )))
...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 137, characters 0-0
  ...
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_not_inline__result Int))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_not_inline__result o1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_not_inline__result) #x01))))))))))
(check-sat)
(exit)
