...
;; defqtvc
 ;; File "p.ads", line 13, characters 0-0
  ...
  (=>
  (let ((o4 (ubv_to_int (bvsub #x0000000000000020 (bvmul #x0000000000000002 i1)))))
  (and (in_range1 o4)
  (ite (< o4 18446744073709551616)
  (= o3 (bvshl #x0000000000000001 ((_ int_to_bv 64) o4)))
  (= o3 #x0000000000000000))))
  (forall ((o4 (_ BitVec 64)))
  (=>
  (let ((o5 (ubv_to_int i1)))
  (and (in_range1 o5)
  (ite (< o5 18446744073709551616)
  (= o4 (bvshl #x0000000000000001 ((_ int_to_bv 64) o5)))
  (= o4 #x0000000000000000)))) (not (= m1 #x0000000000000000))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
