...
(declare-fun bh ((_ BitVec 64)) (_ BitVec 8))

(declare-fun bh__function_guard ((_ BitVec 8) (_ BitVec 64)) Bool)
...
;; bh__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rbx true true true true)
     (let ((result (bh x86__rbx)))
     (=> (bh__function_guard result x86__rbx)
     (and
     (= result ((_ extract 7 0) (bvurem (bvudiv (bvand x86__rbx #x000000000000FF00) #x0000000000000100) ((_ int_to_bv 64) 256))))
     (dynamic_invariant1 result true false true true))))) :pattern ((bh
                                                                    x86__rbx)) )))
...
(assert
;; defqtvc
 ;; File "x86.ads", line 174, characters 0-0
  (not
  (forall ((rbx (_ BitVec 64)) (rbx1 (_ BitVec 64)))
  (=> (dynamic_invariant rbx true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rbx1 (bvor (bvand rbx #xFFFFFFFFFFFF00FF) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) 
  val__) #x0100))))
