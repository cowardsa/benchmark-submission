...
;; defqtvc
 ;; File "a-cfhase.ads", line 1066, characters 0-0
  ...
  (forall ((o5 Int))
  (=> (= (to_rep1 (rec__p__my_sets__set__capacity target__split_discrs)) o5)
  (let ((o6 (- o5 o4)))
  (=> (in_range5 o6)
  (=> (in_range5 (+ o6 o3))
  (let ((o7 source))
  ...
  (<= o10 (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 o9)))))
  (let ((o11 source))
  (let ((o12 (length o11)))
  (=>
  (and (dynamic_invariant o12 true false true true)
  (<= o12 (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 o11)))))
  (in_range5 (- o12 o10)))))))))))))))))))))))))))
(check-sat)
(exit)
