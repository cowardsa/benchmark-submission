...
(assert
;; defqtvc
 ;; File "x86.ads", line 210, characters 0-0
  (not
  (forall ((rsp (_ BitVec 64)))
  (=> (dynamic_invariant rsp true false true true)
  (forall ((x86__esp__result (_ BitVec 32)))
  (=> (= x86__esp__result ((_ extract 31 0) (bvand rsp #x00000000FFFFFFFF)))
  (bvule ((_ zero_extend 32) #x00000000) (bvand rsp #x00000000FFFFFFFF))))))))
(check-sat)
(exit)
