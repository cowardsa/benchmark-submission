...
(declare-fun lemma7 (tuple0) Bool)

(declare-fun lemma7__function_guard (Bool tuple0) Bool)
...
;; lemma7__def_axiom
  ...
  (! (= (= (lemma7 us_void_param) true)
     (forall ((value (_ BitVec 32)))
     (=> (and (bvule #x00000000 value) (bvule value #xFFFFFFFF))
     (forall ((n Int))
     (=> (and (<= 0 n) (<= n 31))
     (= (shift_left (shift_right value n) n) (bvand value (shift_left
                                                          (make_mask
                                                          (+ (- 31 n) 1)) n)))))))) :pattern (
  (lemma7 us_void_param)) )))

(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 216, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_32__functions__lemmas__shift_right__lemma7__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__lemmas__shift_right__lemma7__result true)
  (= (lemma7 Tuple0) true))))))
(check-sat)
(exit)
