...
(declare-datatypes ((unsigned_4__ref 0))
(((unsigned_4__refqtmk (unsigned_4__content unsigned_4)))))
(define-fun unsigned_4__ref_unsigned_4__content__projection ((a unsigned_4__ref)) unsigned_4 
...
;; shift_left_4__post_axiom
  ...
  (! (=>
     ...
     amount true true true true)) (<= amount 4))
     (let ((result (shift_left_4 value amount)))
     (=> (shift_left_4__function_guard result value amount)
     (dynamic_invariant1 result true false true true)))) :pattern ((shift_left_4
                                                                   value
                                                                   amount)) ))))
...
;; shift_right_4__post_axiom
  ...
  (! (=>
     ...
     (and (dynamic_invariant1 value true true true true) (dynamic_invariant
     amount true true true true)) (<= amount 4))
     (let ((result (shift_right_4 value amount)))
     (=> (shift_right_4__function_guard result value amount)
     (dynamic_invariant1 result true false true true)))) :pattern ((shift_right_4
                                                                   value
                                                                   amount)) ))))
