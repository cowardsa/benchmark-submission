...
;; defqtvc
 ;; File "x86.ads", line 19, characters 0-0
  ...
  (forall ((n3 (_ BitVec 64)) (n12 (_ BitVec 64)) (n22 (_ BitVec 64)))
  (=>
  (or
  ...
  (=> (= n4 (bvadd n3 #x0000000000000001))
  (=>
  (exists ((spark__branch2 Bool))
  (and
  (= spark__branch2 (ite (= var1 (bvadd (bvsub var2 var1_range_size) n4))
                    true false))
  (or (not (= spark__branch2 true))
  (and (dynamic_invariant n12 false false true true)
  (and (dynamic_invariant n22 false false true true)
  (exists ((n13 (_ BitVec 64)) (n23 (_ BitVec 64)))
  (and
  (exists ((spark__branch3 Bool))
  (and (= spark__branch3 (ite (bvugt n4 var1_range_size) true false))
  (ite (= spark__branch3 true)
  (and (= n13 #x0000000000000000)
  (and (= n23 (bvsub n4 var1_range_size)) (bvule n23 var2_range_size)))
  (exists ((spark__branch4 Bool))
  (and (= spark__branch4 (ite (bvult n4 var2_range_size) true false))
  (ite (= spark__branch4 true) (and (= n13 var1_range_size) (= n23 n4))
  (and (= n13 (bvsub var1_range_size n4)) (= n23 #x0000000000000000))))))))
  (and
  (and
  (and (and (bvule #x0000000000000000 n13) (bvule n13 var1_range_size))
  (and (bvule #x0000000000000000 n23) (bvule n23 var2_range_size)))
  (= (bvadd var1 n13) (bvadd var2 n23)))
  (exists ((i (_ BitVec 64)))
  (and (and (bvule #x0000000000000000 i) (bvule i var1_range_size))
  (exists ((j (_ BitVec 64)))
  (and (and (bvule #x0000000000000000 j) (bvule j var2_range_size))
  ...
  (or
  (forall ((m (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 m) (bvule m n4))
  (not (= var1 (bvadd (bvsub var2 var1_range_size) m)))))
  (exists ((i (_ BitVec 64)))
  (and (and (bvule #x0000000000000000 i) (bvule i var1_range_size))
  (exists ((j (_ BitVec 64)))
