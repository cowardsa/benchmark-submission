...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 103, characters 0-0
  ...
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result Int))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result o1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline__result) #x01))))))))))
(check-sat)
(exit)
