...
(declare-sort nvu17 0)

(define-fun in_range1 ((x1 (_ BitVec 8))) Bool (and (bvule #x00 x1)
                                               (bvule x1 #x10)))

(define-fun in_range_int ((x1 Int)) Bool (and (<= 0 x1) (<= x1 16)))
...
(declare-fun user_eq (nvu17 nvu17) Bool)

(declare-const dummy nvu17)

(declare-datatypes ((nvu17__ref 0))
(((nvu17__refqtmk (nvu17__content nvu17)))))
(define-fun nvu17__ref_nvu17__content__projection ((a nvu17__ref)) nvu17 
  (nvu17__content a))

(define-fun dynamic_invariant ((temp___expr_186 (_ BitVec 8))
  (temp___is_init_182 Bool) (temp___skip_constant_183 Bool)
  (temp___do_toplevel_184 Bool)
  (temp___do_typ_inv_185 Bool)) Bool (=>
                                     (or (= temp___is_init_182 true)
                                     (bvule #x00 #x10)) (in_range1
                                     temp___expr_186)))

(assert
;; defqtvc
 ;; File "nwa.ads", line 35, characters 0-0
  (not
  (forall ((z (_ BitVec 8)) (spark__branch Bool))
