...
;; defqtvc
 ;; File "p.ads", line 10, characters 0-0
  (not
  (forall ((y (_ BitVec 8)) (p__g__result Int))
  (=> (dynamic_invariant x true false true true)
  (=> (= x #x0F)
  (=> (= y (bvurem (bvadd x #x02) #x10))
  (=> (dynamic_invariant y true false true true)
  (=> (= p__g__result (ubv_to_int y)) (= p__g__result 1)))))))))
(check-sat)
(exit)
