...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 198, characters 0-0
  ...
  (=>
  (let ((temp___544 (- i2 1)))
  (ite (< temp___544 256) (= o3 (bvshl #x01 ((_ int_to_bv 8) temp___544)))
  (= o3 #x00)))
  ...
  (=>
  (let ((temp___549 (- i2 1)))
  (ite (< temp___549 256) (= o4 (bvshl #x01 ((_ int_to_bv 8) temp___549)))
  (= o4 #x00)))
  (forall ((o5 (_ BitVec 8)))
  (=>
  (let ((temp___548 (- i2 1)))
  (ite (< temp___548 256) (= o5 (bvshl #x01 ((_ int_to_bv 8) temp___548)))
  (= o5 #x00)))
