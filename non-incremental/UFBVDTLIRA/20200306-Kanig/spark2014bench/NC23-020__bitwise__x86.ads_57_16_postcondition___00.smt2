...
;; al__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rax true true true true)
     ...
     (=> (al__function_guard result x86__rax)
     (and (= result ((_ extract 7 0) (bvand x86__rax #x00000000000000FF)))
     (dynamic_invariant1 result true false true true))))) :pattern ((al
                                                                    x86__rax)) )))

(assert
;; defqtvc
 ;; File "x86.ads", line 55, characters 0-0
  (not
  (forall ((rax (_ BitVec 64)) (rax1 (_ BitVec 64)) (rax2 (_ BitVec 64)))
  (=> (dynamic_invariant rax true false true true)
  (=> (= rax1 rax)
  (=>
  (= rax2 (bvor (bvand rax1 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) #x01)))
