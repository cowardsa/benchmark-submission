...
;; ebp__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rbp true true true true)
     (let ((result (ebp x86__rbp)))
     (=> (ebp__function_guard result x86__rbp)
     (and (= result ((_ extract 31 0) (bvand x86__rbp #x00000000FFFFFFFF)))
     (dynamic_invariant1 result true false true true))))) :pattern ((ebp
                                                                    x86__rbp)) )))
...
;; defqtvc
 ;; File "x86.ads", line 237, characters 0-0
  (not
  (forall ((rbp (_ BitVec 64)) (rbp1 (_ BitVec 64)))
  (=> (dynamic_invariant rbp true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rbp1 (bvor (bvand rbp #xFFFFFFFF00000000) ((_ zero_extend 32) val__)))
  (=> (forall ((rbp2 (_ BitVec 64))) (ebp__function_guard (ebp rbp2) rbp2))
  (= (ebp rbp1) val__))))))))
(check-sat)
(exit)
