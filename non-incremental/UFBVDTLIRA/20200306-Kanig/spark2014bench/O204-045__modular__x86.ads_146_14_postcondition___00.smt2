...
(assert
;; defqtvc
 ;; File "x86.ads", line 144, characters 0-0
  (not
  ...
  (=>
  (= rdx2 (bvor (bvand rdx #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__)))
  (= rdx2 (bvor (bvand rdx1 #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__))))))))))
(check-sat)
(exit)
