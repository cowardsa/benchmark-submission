...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 4, characters 0-0
  ...
  (=>
  (not (= (and (ite (<= 1 16) true false) (ite (<= 16 8) true false)) true))
  (=>
  (not (= (and (ite (<= 9 16) true false) (ite (<= 16 16) true false)) true))
  (=>
  (not
  (= (and (ite (<= 17 16) true false) (ite (<= 16 32) true false)) true))
  (bvule ((_ zero_extend 48) #x0000) (bvlshr ((_ zero_extend 48) v) ((_ int_to_bv 64) 
  amount))))))))))
(check-sat)
(exit)
