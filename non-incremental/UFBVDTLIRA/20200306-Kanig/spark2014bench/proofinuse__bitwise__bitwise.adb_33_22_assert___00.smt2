...
(declare-const xx (_ BitVec 32))

(declare-const attr__ATTRIBUTE_ADDRESS2 Int)

(declare-const yy (_ BitVec 32))
...
(assert
;; defqtvc
 ;; File "bitwise.ads", line 16, characters 0-0
  (not
  (forall ((x (_ BitVec 32)) (y (_ BitVec 32)) (x1 (_ BitVec 32))
  (y1 (_ BitVec 32)) (x2 (_ BitVec 32)))
  (=> (dynamic_invariant x true false true true)
  (=> (dynamic_invariant y true false true true)
  (=> (= x xx)
  (=> (dynamic_invariant xx true false true true)
  (=> (= y yy)
  (=> (dynamic_invariant yy true false true true)
  (=> (= x1 (bvxor x y))
  (=> (= y1 (bvxor x1 y)) (=> (= x2 (bvxor x1 y1)) (=> (= x2 yy) (= y1 xx))))))))))))))
(check-sat)
(exit)
