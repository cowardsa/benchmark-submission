...
(define-fun dynamic_invariant ((temp___expr_180 (_ BitVec 8))
  ...
  (temp___do_typ_inv_179 Bool)) Bool (=> (= temp___do_toplevel_178 true)
                                     ...
                                     (or
                                     (and (bvule #x01 temp___expr_180)
                                     (bvule temp___expr_180 #x03))
                                     (and (bvule #x05 temp___expr_180)
                                     (bvule temp___expr_180 #xFF))))))

(define-fun dynamic_predicate ((temp___184 (_ BitVec 8))) Bool (or
                                                               (and
                                                               (bvule #x01 temp___184)
                                                               (bvule temp___184 #x03))
                                                               (and
                                                               (bvule #x05 temp___184)
                                                               (bvule temp___184 #xFF))))
