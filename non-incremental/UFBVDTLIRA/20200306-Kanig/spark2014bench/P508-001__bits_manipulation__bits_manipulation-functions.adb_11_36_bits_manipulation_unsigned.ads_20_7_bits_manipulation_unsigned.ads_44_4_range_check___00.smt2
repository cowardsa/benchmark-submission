...
(declare-fun user_eq3 (modular modular) Bool)

(declare-const dummy3 modular)
...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 4, characters 0-0
  (not
  (=> (dynamic_invariant1 v true false true true)
  (=> (dynamic_invariant amount true false true true)
  (=>
  (not (= (and (ite (<= 1 32) true false) (ite (<= 32 8) true false)) true))
  (=>
  (not (= (and (ite (<= 9 32) true false) (ite (<= 32 16) true false)) true))
  (=>
  (not
  (= (and (ite (<= 17 32) true false) (ite (<= 32 32) true false)) true))
  (bvule ((_ zero_extend 32) #x00000000) (bvlshr ((_ zero_extend 32) 
  v) ((_ int_to_bv 64) amount))))))))))
(check-sat)
(exit)
