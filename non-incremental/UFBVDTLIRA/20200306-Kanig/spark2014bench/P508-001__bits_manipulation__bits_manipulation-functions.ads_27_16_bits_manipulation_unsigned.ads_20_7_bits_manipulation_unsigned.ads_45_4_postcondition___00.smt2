...
(declare-fun msb_index_fast_inline_always ((_ BitVec 64)) Int)
...
;; msb_index_fast_inline_always__post_axiom
  (assert
  (forall ((value1 (_ BitVec 64))) (! (in_range1
  (msb_index_fast_inline_always value1)) :pattern ((msb_index_fast_inline_always
                                                   value1)) )))

(declare-fun msb_index_fast_inline ((_ BitVec 64)) Int)

(declare-fun msb_index_fast_inline__function_guard (Int (_ BitVec 64)) Bool)
...
(declare-fun msb_index_fast_not_inline ((_ BitVec 64)) Int)
...
(declare-fun msb_index_slow_inline_always ((_ BitVec 64)) Int)
...
;; msb_index_slow_inline_always__post_axiom
  ...
  (! (=>
     ...
     (not (= value1 #x0000000000000000)))
     (let ((result (msb_index_slow_inline_always value1)))
     (and (= (shift_right value1 result) #x0000000000000001)
     (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline_always
                                                                   value1)) )))

(declare-fun msb_index_slow_inline ((_ BitVec 64)) Int)

(declare-fun msb_index_slow_inline__function_guard (Int (_ BitVec 64)) Bool)
...
;; msb_index_slow_inline__post_axiom
  ...
  (! (=>
     ...
     (and (= (shift_right value1 result) #x0000000000000001)
     (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline
                                                                   value1)) )))
...
(declare-fun msb_index_slow_not_inline ((_ BitVec 64)) Int)
...
;; msb_index_slow_not_inline__post_axiom
  ...
  (! (=>
     ...
     (and (= (shift_right value1 result) #x0000000000000001)
     (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_not_inline
                                                                   value1)) )))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 23, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_64__functions__msb_index__result Int))
  ...
  (and (= spark__branch1 (ite true true false))
  (ite (= spark__branch1 true)
  (let ((o value))
  (let ((o1 (msb_index_slow_inline_always o)))
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (= (shift_right o o1) #x0000000000000001)) (= result__1 o1))))
  (exists ((spark__branch2 Bool))
  (and (= spark__branch2 (ite (= 2 1) true false))
  (ite (= spark__branch2 true)
  (let ((o value))
  (let ((o1 (msb_index_slow_inline o)))
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (and (= o1 (msb_index_slow_inline_always o))
  (= (shift_right o o1) #x0000000000000001))) (= result__1 o1))))
  (let ((o value))
  (let ((o1 (msb_index_slow_not_inline o)))
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (and (= o1 (msb_index_slow_inline_always o))
  (= (shift_right o o1) #x0000000000000001))) (= result__1 o1))))))))))
  ...
  (ite (= spark__branch1 true)
  (let ((o value))
  (let ((o1 (msb_index_fast_inline_always o)))
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (= (shift_right o o1) #x0000000000000001)) (= result__1 o1))))
  (exists ((spark__branch2 Bool))
  ...
  (ite (= spark__branch2 true)
  (let ((o value))
  (let ((o1 (msb_index_fast_inline o)))
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (and (= o1 (msb_index_fast_inline_always o))
  (= (shift_right o o1) #x0000000000000001))) (= result__1 o1))))
  (let ((o value))
  (let ((o1 (msb_index_fast_not_inline o)))
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (and (= o1 (msb_index_fast_inline_always o))
  (= (shift_right o o1) #x0000000000000001))) (= result__1 o1)))))))))))))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index__result result__1)
  (= (shift_right value
