...
(define-fun longword_t__ref_longword_t__content__projection ((a longword_t__ref)) longword_t 
...
;; r__post_axiom
  ...
  (! (=>
     ...
     (let ((result (r a b)))
     (=> (r__function_guard result a b)
     (and (not (= result #x0000000000000000)) (dynamic_invariant result true
     false true true))))) :pattern ((r a b)) )))
