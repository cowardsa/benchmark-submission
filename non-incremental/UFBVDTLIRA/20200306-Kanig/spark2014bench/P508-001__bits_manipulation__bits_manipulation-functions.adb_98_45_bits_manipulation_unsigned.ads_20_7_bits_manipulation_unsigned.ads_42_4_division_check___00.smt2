...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 79, characters 0-0
  ...
  (v (_ BitVec 8)) (shift_amount1 Int) (result__1 Int) (v1 (_ BitVec 8))
  (new_v1 (_ BitVec 8)))
  ...
  (=>
  (= (and (ite (= shift_amount 0) false true) (ite (not (= v #x00)) true
                                              false)) true)
  (=>
  (= (and (ite (and
               (and
  ...
  (= o (ite (and (<= 1 8) (<= 8 8))
       (ite (< shift_amount1 8) (bvlshr v1 ((_ int_to_bv 8) shift_amount1))
       #x00)
       (ite (and (<= 9 8) (<= 8 16))
       ((_ extract 7 0) (ite (< shift_amount1 16)
                        (bvlshr ((_ zero_extend 8) v1) ((_ int_to_bv 16) shift_amount1))
                        #x0000))
       (ite (and (<= 17 8) (<= 8 32))
       ((_ extract 7 0) (bvlshr ((_ zero_extend 24) v1) ((_ int_to_bv 32) shift_amount1)))
       ((_ extract 7 0) (bvlshr ((_ zero_extend 56) v1) ((_ int_to_bv 64) shift_amount1))))))))
  (forall ((new_v2 (_ BitVec 8)))
  (=> (= new_v2 o)
  (forall ((result__2 Int) (v2 (_ BitVec 8)))
  (=>
