 ...
 ;; File "bits_manipulation-functions.ads", line 93, characters 0-0
  ...
  (= o1 (ite (and (<= 1 32) (<= 32 8))
        ((_ zero_extend 24) (ite (< usf1 8)
                            (bvlshr ((_ extract 7 0) usf) ((_ int2bv 8) usf1))
                            #x00))
        (ite (and (<= 9 32) (<= 32 16))
        ((_ zero_extend 16) (ite (< usf1 16)
                            (bvlshr ((_ extract 15 0) usf) ((_ int2bv 16) usf1))
                            #x0000))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr usf ((_ int2bv 32) usf1))
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) usf) ((_ int2bv 64) usf1))))))))
  (ite (= o1 #x00000001)
  (= o (ite (forall ((j Int))
            (=> (and (<= 0 j) (<= j usf1))
