  ...
  (! (=>
     ...
     (= (shift_left v amount) (ite (and (<= 1 32) (<= 32 8))
                              ...
                              ((_ zero_extend 16) (ite (< amount 16)
                                                  ...
                                                  #x0000))
                              (ite (and (<= 17 32) (<= 32 32))
                              (bvshl v ((_ int2bv 32) amount))
                              ((_ extract 31 0) (bvurem (bvshl ((_ zero_extend 32) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 4294967296)))))))) :pattern (
  (shift_left v amount)) ))))
 ...
 ;; File "bits_manipulation-functions.adb", line 42, characters 0-0
  ...
  (= o8 (ite (and (<= 1 32) (<= 32 8))
        ...
        ((_ zero_extend 16) (ite (< o6 16)
                            (bvlshr ((_ extract 15 0) o7) ((_ int2bv 16) o6))
                            #x0000))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr o7 ((_ int2bv 32) o6))
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) o7) ((_ int2bv 64) o6))))))))
  (=>
  (or
  (not
