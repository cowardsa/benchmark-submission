...
(assert
;; defqtvc
 ;; File "x86.ads", line 384, characters 0-0
  (not
  (forall ((r14 (_ BitVec 64)))
  (=> (dynamic_invariant r14 true false true true)
  (forall ((x86__r14l__result (_ BitVec 8)))
  (=> (= x86__r14l__result ((_ extract 7 0) (bvand r14 #x00000000000000FF)))
  (bvule ((_ zero_extend 56) #x00) (bvand r14 #x00000000000000FF))))))))
(check-sat)
(exit)
