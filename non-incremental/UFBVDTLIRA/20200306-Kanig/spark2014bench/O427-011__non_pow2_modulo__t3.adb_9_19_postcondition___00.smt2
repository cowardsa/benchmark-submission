...
(assert
;; defqtvc
 ;; File "t3.adb", line 8, characters 0-0
  (not
  (forall ((t3__mmin__result (_ BitVec 64)))
  (=> (dynamic_invariant x true false true true)
  (=>
  (= t3__mmin__result (bvurem (bvsub #x00000000000000E6 x) #x00000000000000E6))
  (= t3__mmin__result (let ((temp___200 (bvadd (let ((temp___199 (bvsub #x00000000000000E5 
                                               x)))
                                               (ite (bvult #x00000000000000E5 
                                               x)
                                               (bvadd temp___199 #x00000000000000E6)
                                               temp___199)) #x0000000000000001)))
                      (ite (bvule (bvsub #x00000000000000E6 (let ((temp___199 (bvsub #x00000000000000E5 
                                                            x)))
                                                            (ite (bvult #x00000000000000E5 
                                                            x)
                                                            (bvadd temp___199 #x00000000000000E6)
