...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 23, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_8__functions__msb_index__result Int))
  ...
  (= (shift_right o o1) #x01)) (= result__1 o1))))
  ...
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (and (= o1 (msb_index_slow_inline_always o)) (= (shift_right o o1) #x01)))
  (= result__1 o1))))
  (let ((o value))
  ...
  (and
  (and (dynamic_invariant2 o1 true false true true)
  (and (= o1 (msb_index_fast_inline_always o)) (= (shift_right o o1) #x01)))
  (= result__1 o1))))
  (let ((o value))
  ...
  (= result__1 o1)))))))))))))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__msb_index__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_8__functions__msb_index__result) #x01)))))))))
(check-sat)
(exit)
