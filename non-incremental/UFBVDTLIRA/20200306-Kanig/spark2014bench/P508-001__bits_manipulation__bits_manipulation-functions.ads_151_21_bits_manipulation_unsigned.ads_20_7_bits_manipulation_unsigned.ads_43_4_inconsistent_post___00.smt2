...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     ...
     (and
     (not
     (= (ite (< n 65536) (bvshl #x0001 ((_ int_to_bv 16) n)) #x0000) #x0000))
     (= (shift_right val__ n) (bvudiv val__ (ite (< n 65536)
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 149, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_16__functions__lemmas__shift_right__lemma2__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__lemmas__shift_right__lemma2__result true)
  (= (lemma1 Tuple0) true))))))
(check-sat)
(exit)
