...
(define-fun default_initial_assumption2 ((temp___expr_389 us_rep3)
  (temp___skip_top_level_390 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_390 true))
                                         (and
                                         (= (is_empty1 temp___expr_389) true)
                                         (= (length4 temp___expr_389) 0))))
...
(define-fun element ((container us_rep)
  (position us_rep4)) Int (get (elements container)
                          (get1 (positions container) position)))

(declare-fun element__function_guard (Int us_rep us_rep4) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_260 Int)
  ...
  (temp___do_typ_inv_259 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range6 temp___expr_260)))
...
(define-fun dynamic_invariant6 ((temp___expr_349 Int)
  ...
  (temp___do_typ_inv_348 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range7 temp___expr_349)))
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant6 (get container position1) true false true true)) :pattern (
...
(define-fun dynamic_invariant7 ((temp___expr_381 Int)
...
(assert
;; defqtvc
 ;; File "a-cfhase.ads", line 474, characters 0-0
  (not true))
(check-sat)
(exit)
