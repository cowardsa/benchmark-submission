...
(((us_split_fieldsqtmk (rec__find_map__index_maps__cursor__node count_type)))))
(define-fun us_split_fields_rec__find_map__index_maps__cursor__node__projection ((a us_split_fields)) count_type 
...
(((us_split_fieldsqtmk1 (rec__find_map__index_maps__map us_main_type)))))
(define-fun us_split_fields_rec__find_map__index_maps__map__projection ((a us_split_fields2)) us_main_type 
...
(define-fun in_range2 ((rec__find_map__index_maps__map__capacity1 Int)
...
(define-fun dynamic_invariant ((temp___expr_287 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_404 Int)
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (and
     (let ((temp___475 (get result i)))
     (and (<= 1 temp___475) (<= temp___475 (length1 container))))
     (forall ((j us_rep))
...
(define-fun dynamic_invariant3 ((temp___expr_266 (_ BitVec 32))
...
(define-fun dynamic_invariant5 ((temp___expr_327 Int)
  ...
  (temp___do_typ_inv_326 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range6 temp___expr_327)))
...
;; defqtvc
 ;; File "a-cfhama.ads", line 729, characters 0-0
  ...
  (<= o1 (to_rep
         (rec__find_map__index_maps__map__capacity (us_split_discrs1 o)))))
  (let ((o2 container))
  (let ((o3 (positions o2)))
  (=>
  ...
  (=> (= (has_key o3 i) true)
  (and
  (let ((temp___470 (get o3 i)))
  (and (<= 1 temp___470) (<= temp___470 (length1 o2))))
  (forall ((j us_rep))
  (=> (= (has_key o3 j) true)
