...
(assert
;; defqtvc
 ;; File "t2.adb", line 8, characters 0-0
  (not
  (forall ((t2__mmin__result (_ BitVec 8)))
  (=> (dynamic_invariant x true false true true)
  (=> (= t2__mmin__result (bvurem (bvsub #xE6 x) #xE6))
  (= t2__mmin__result (let ((temp___200 (bvadd (let ((temp___199 (bvsub #xE5 
                                               x)))
                                               (ite (bvult #xE5 x)
                                               (bvadd temp___199 #xE6)
                                               temp___199)) #x01)))
                      (ite (bvule (bvsub #xE6 (let ((temp___199 (bvsub #xE5 
                                              x)))
                                              (ite (bvult #xE5 x)
                                              (bvadd temp___199 #xE6)
                                              temp___199))) #x01)
