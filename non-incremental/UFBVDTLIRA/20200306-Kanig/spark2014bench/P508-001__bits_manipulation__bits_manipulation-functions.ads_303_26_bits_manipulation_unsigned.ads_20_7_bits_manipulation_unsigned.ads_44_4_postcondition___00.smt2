...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 302, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result Bool))
  (=> (= (lemma8 Tuple0) true)
  ...
  (= (make_mask size) (bvsub (ite (< size 4294967296)
                             ...
                             #x00000000) #x00000001))))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result 
  (lemma2_goal Tuple0))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result true)
  (= (lemma2 Tuple0) true))))))))))
(check-sat)
(exit)
