...
(assert
;; defqtvc
 ;; File "x86.ads", line 113, characters 0-0
  (not
  (forall ((rcx (_ BitVec 64)) (rcx1 (_ BitVec 64)) (rcx2 (_ BitVec 64)))
  (=> (= rcx1 rcx)
  (=> (dynamic_invariant rcx true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rcx2 (bvor (bvand rcx #xFFFFFFFF00000000) ((_ zero_extend 32) val__)))
  (= rcx2 (bvor (bvand rcx1 #xFFFFFFFF00000000) ((_ zero_extend 32) val__))))))))))
(check-sat)
(exit)
