...
(declare-fun user_eq (nvu16b nvu16b) Bool)

(declare-const dummy nvu16b)

(declare-datatypes ((nvu16b__ref 0))
(((nvu16b__refqtmk (nvu16b__content nvu16b)))))
(define-fun nvu16b__ref_nvu16b__content__projection ((a nvu16b__ref)) nvu16b 
  (nvu16b__content a))
