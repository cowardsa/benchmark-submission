...
(declare-fun user_eq (nvu16 nvu16) Bool)

(declare-const dummy nvu16)

(declare-datatypes ((nvu16__ref 0))
(((nvu16__refqtmk (nvu16__content nvu16)))))
(define-fun nvu16__ref_nvu16__content__projection ((a nvu16__ref)) nvu16 
  (nvu16__content a))
...
(assert
;; defqtvc
 ;; File "nwa.ads", line 20, characters 0-0
  (not
  (forall ((z (_ BitVec 16)))
  ...
  (= spark__branch (ite (= x #x0000) true false)))
  (bvult (bvsub ((_ zero_extend 16) x) ((_ zero_extend 16) y)) #x00010000))))))))))))
(check-sat)
(exit)
