...
(assert
;; defqtvc
 ;; File "x86.ads", line 328, characters 0-0
  (not
  (forall ((r10 (_ BitVec 64)) (r101 (_ BitVec 64)) (r102 (_ BitVec 64)))
  (=> (= r101 r10)
  (=> (dynamic_invariant r10 true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= r102 (bvor (bvand r10 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__)))
  (= r102 (bvor (bvand r101 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__))))))))))
(check-sat)
(exit)
