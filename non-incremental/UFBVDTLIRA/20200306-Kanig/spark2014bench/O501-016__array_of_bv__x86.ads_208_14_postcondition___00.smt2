...
(assert
;; defqtvc
 ;; File "x86.ads", line 206, characters 0-0
  (not
  (forall ((rsp (_ BitVec 64)) (rsp1 (_ BitVec 64)) (rsp2 (_ BitVec 64)))
  (=> (= rsp1 rsp)
  (=> (dynamic_invariant rsp true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rsp2 (bvor (bvand rsp #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__)))
  (= rsp2 (bvor (bvand rsp1 #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__))))))))))
(check-sat)
(exit)
