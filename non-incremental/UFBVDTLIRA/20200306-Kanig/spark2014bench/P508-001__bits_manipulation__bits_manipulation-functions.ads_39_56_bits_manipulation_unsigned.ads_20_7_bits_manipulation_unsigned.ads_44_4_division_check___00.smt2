...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 35, characters 0-0
  (not
  (forall ((usf (_ BitVec 32)) (usf1 Int) (o (_ BitVec 32))
  (o1 (_ BitVec 32)))
  (=>
  ...
  (=>
  (ite (< usf1 4294967296) (= o (bvshl #x00000001 ((_ int_to_bv 32) usf1)))
  (= o #x00000000))
  (=> (not (= o #x00000000))
  (=>
  (ite (< usf1 4294967296) (= o1 (bvshl #x00000001 ((_ int_to_bv 32) usf1)))
  (= o1 #x00000000)) (not (= o1 #x00000000))))))))))
(check-sat)
(exit)
