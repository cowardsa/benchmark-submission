...
(declare-fun u32toint8 ((_ BitVec 32)) Int)

(declare-fun u32toint8__function_guard (Int (_ BitVec 32)) Bool)
...
(define-fun source__ref_source__content__10__projection ((a source__ref)) source 
  (source__content a))

(define-fun dynamic_invariant ((temp___expr_503 (_ BitVec 32))
  (temp___is_init_499 Bool) (temp___skip_constant_500 Bool)
  (temp___do_toplevel_501 Bool) (temp___do_typ_inv_502 Bool)) Bool true)
...
;; target'axiom
  (assert
  (forall ((i target))
  (and (<= (- 128) (targetqtint i)) (<= (targetqtint i) 127))))
...
(define-fun target__ref_target__content__10__projection ((a target__ref)) target 
  (target__content a))

(define-fun dynamic_invariant1 ((temp___expr_510 Int)
...
;; u32toint8__post_axiom
  (assert
  (forall ((s (_ BitVec 32)))
  (! (=> (dynamic_invariant s true true true true)
     (let ((result (u32toint8 s)))
     (=> (u32toint8__function_guard result s) (dynamic_invariant1 result true
     false true true)))) :pattern ((u32toint8 s)) )))
...
(define-fun dynamic_invariant2 ((temp___expr_370 (_ BitVec 32))
...
(assert
;; defqtvc
 ;; File "simulink_functions.ads", line 216, characters 0-0
  (not
