...
(assert
;; defqtvc
 ;; File "x86.ads", line 84, characters 0-0
  (not
  (forall ((rcx (_ BitVec 64)))
  (=> (dynamic_invariant rcx true false true true)
  (forall ((x86__cl__result (_ BitVec 8)))
  (=> (= x86__cl__result ((_ extract 7 0) (bvand rcx #x00000000000000FF)))
  (bvule ((_ zero_extend 56) #x00) (bvand rcx #x00000000000000FF))))))))
(check-sat)
(exit)
