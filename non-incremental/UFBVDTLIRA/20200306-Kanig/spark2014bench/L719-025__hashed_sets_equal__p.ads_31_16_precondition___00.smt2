...
(define-fun to_int2 ((x hash_type)) Int (ubv_to_int (to_rep1 x)))
...
(define-fun dynamic_invariant ((temp___expr_267 Int)
  ...
  (temp___do_typ_inv_266 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range3 temp___expr_267)))
...
(declare-fun keys_included_except (us_rep3 us_rep3 us_rep) Bool)
...
(define-fun contains1 ((container us_rep1)
  (item Int)) Bool (contains (model1 container) item))
...
;; length__post_axiom
  ...
  (! (let ((result (length container)))
     ...
     (dynamic_invariant3 result true false true true))) :pattern ((length
                                                                  container)) )))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant item true true true true)
     ...
     (= (my_eq item (get container result)) true)))) (dynamic_invariant3
...
(define-fun default_initial_assumption1 ((temp___expr_382 us_rep3)
  (temp___skip_top_level_383 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_383 true))
                                         (and
                                         (= (is_empty temp___expr_382) true)
                                         (= (length3 temp___expr_382) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_315 us_rep4)
  (temp___skip_top_level_316 Bool)) Bool (=>
                                         ...
                                         (= (is_empty1 temp___expr_315) true)))

;; model__post_axiom
  (assert
  (forall ((container us_rep1))
  (! (= (length4 (model1 container)) (length container)) :pattern ((model1
                                                                   container)) )))
...
(define-fun dynamic_invariant4 ((temp___expr_307 Int)
  ...
  (temp___do_typ_inv_306 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range5 temp___expr_307)))
...
;; length__post_axiom
  (assert
  (forall ((container us_rep4)) (! (dynamic_invariant3 (length4 container)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep3)) (! (dynamic_invariant3 (length3 container)
...
;; keys_included_except__post_axiom
  ...
  (! (= (= (keys_included_except left right new_key) true)
     (forall ((key us_rep))
     (=> (= (has_key left key) true)
     (=> (not (= (bool_eq key new_key) true)) (= (has_key right key) true))))) :pattern (
...
;; defqtvc
 ;; File "p.ads", line 26, characters 0-0
  (not
  (forall ((l__split_fields us_main_type) (cu__split_fields count_type))
  (=>
  (= (has_element
     (us_repqtmk1 l__split_discrs (us_split_fieldsqtmk1 l__split_fields))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields))) true)
  (let ((usf (us_repqtmk1 l__split_discrs
             (us_split_fieldsqtmk1 l__split_fields))))
  (let ((o (us_repqtmk (us_split_fieldsqtmk cu__split_fields))))
  (let ((o1 (us_repqtmk1 l__split_discrs
            (us_split_fieldsqtmk1 l__split_fields))))
  (let ((o2 (element o1 o)))
  (=>
  (and (dynamic_invariant o2 true false true true)
  (= o2 (get (elements o1) (get1 (positions o1) o))))
  (forall ((e Int))
  (=> (= e o2)
  (=> (dynamic_invariant1 e true false true true)
  (let ((o3 l__split_discrs))
  (forall ((l__split_fields1 us_main_type) (cu__split_fields1 count_type))
  (=>
  (and
  (and
  (and
  ...
  (and
  (and
  (= (bool_eq (us_repqtmk (us_split_fieldsqtmk cu__split_fields1))
     no_element) true)
  (= (length (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields1))) (- 
  (length (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields))) 1)))
  (not
  (= (contains1 (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields1))
     (element (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields)))) true)))
  (not
  (= (has_key
     (positions (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields1)))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields))) true)))
  (= (ole (model1 (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields1)))
     (model1 (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields)))) true))
  (= (included_except
     (model1 (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields)))
     (model1 (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields1)))
     (element (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields)))) true))
  (= (mapping_preserved
     (elements (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields1)))
     (elements (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields)))
     (positions (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields1)))
     (positions (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields)))) true))
  (= (keys_included_except
     (positions (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields)))
     (positions (us_repqtmk1 o3 (us_split_fieldsqtmk1 l__split_fields1)))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields))) true))
  (let ((o4 l__split_discrs))
  (forall ((l__split_fields2 us_main_type) (cu__split_fields2 count_type)
  (i Bool))
  (=>
  (forall ((e1 Int) (o5 us_split_discrs) (l__split_fields3 us_main_type)
  (cu__split_fields3 count_type)) (my_eq__function_guard
  (my_eq
  (element (us_repqtmk1 o5 (us_split_fieldsqtmk1 l__split_fields3))
  (us_repqtmk (us_split_fieldsqtmk cu__split_fields3))) e1)
  (element (us_repqtmk1 o5 (us_split_fieldsqtmk1 l__split_fields3))
  (us_repqtmk (us_split_fieldsqtmk cu__split_fields3))) e1))
  (=>
  (and
  (and
  (and
  (= (contains1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2)) e) true)
  (= (has_element (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields2))) true))
  (= (my_eq
     (element (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields2))) e) true))
  (ite (= (contains1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1))
          e) true)
  (and
  (and
  (and (not (= i true))
  (= (oeq1 (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2)))
     (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))) true))
  (= (oeq2
     (elements (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2)))
     (elements (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))) true))
  (= (oeq3
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2)))
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))) true))
  (and
  (and
  (and
  (and
  (and
  (and (= i true)
  (= (length (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2))) (+ 
  (length (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1))) 1)))
  (= (element (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields2))) e))
  (= (ole (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2)))) true))
  (= (included_except
     (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2)))
     (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1))) e) true))
  (= (mapping_preserved
     (elements (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (elements (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2)))
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2)))) true))
  (= (keys_included_except
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields2)))
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields2))) true))))
  ...
  (= (bool_eq (us_repqtmk (us_split_fieldsqtmk cu__split_fields2))
     (us_repqtmk (us_split_fieldsqtmk cu__split_fields))) true)
  (let ((temp___980 (us_repqtmk1 l__split_discrs
                    (us_split_fieldsqtmk1 l__split_fields2))))
  (forall ((usf1 count_type))
  (let ((usf2 (us_repqtmk (us_split_fieldsqtmk usf1))))
  (let ((o5 (has_element temp___980 usf2)))
  (=> (= (= o5 true) (= (has_key (positions temp___980) usf2) true))
  (=> (= (and (ite true true false) o5) true)
  (let ((o6 (element usf usf2)))
  (=>
  (and (dynamic_invariant o6 true false true true)
  (= o6 (get (elements usf) (get1 (positions usf) usf2))))
  (= (has_element
