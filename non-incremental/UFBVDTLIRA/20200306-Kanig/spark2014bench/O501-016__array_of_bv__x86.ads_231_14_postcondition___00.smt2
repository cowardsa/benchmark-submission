...
(assert
;; defqtvc
 ;; File "x86.ads", line 229, characters 0-0
  (not
  (forall ((rbp (_ BitVec 64)) (rbp1 (_ BitVec 64)) (rbp2 (_ BitVec 64)))
  (=> (= rbp1 rbp)
  (=> (dynamic_invariant rbp true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rbp2 (bvor (bvand rbp #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__)))
  (= rbp2 (bvor (bvand rbp1 #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__))))))))))
(check-sat)
(exit)
