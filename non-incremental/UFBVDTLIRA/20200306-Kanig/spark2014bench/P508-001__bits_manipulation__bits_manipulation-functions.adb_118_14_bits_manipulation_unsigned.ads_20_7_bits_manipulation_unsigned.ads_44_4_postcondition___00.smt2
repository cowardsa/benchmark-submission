...
;; lemma6__def_axiom
  ...
  (! (= (= (lemma61 us_void_param) true)
     ...
     (and (and (<= 0 n) (<= n 31))
     (and
     (and (= (shift_right val__ n) #x00000001)
     (forall ((j Int))
     (=> (and (<= 0 j) (<= j n)) (bvuge (shift_right val__ j) #x00000001))))
     (forall ((j Int))
     (=> (and (<= n j) (<= j 31)) (bvule (shift_right val__ j) #x00000001))))))))))) :pattern (
...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 115, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result Int))
  ...
  (exists ((i Int))
  (and (= i 0)
  (ite (= (and (ite (<= 0 i) true false) (ite (<= i 31) true false)) true)
  (exists ((result__2 Int))
  (and (= result__2 i)
  (let ((o value))
  (let ((o1 (shift_right o i)))
  (and
  (and (dynamic_invariant1 o1 true false true true)
  (= o1 (ite (and (<= 1 32) (<= 32 8))
        ((_ zero_extend 24) (ite (< i 8)
                            (bvlshr ((_ extract 7 0) o) ((_ int_to_bv 8) i))
                            #x00))
        (ite (and (<= 9 32) (<= 32 16))
        ((_ zero_extend 16) (ite (< i 16)
                            (bvlshr ((_ extract 15 0) o) ((_ int_to_bv 16) i))
                            #x0000))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr o ((_ int_to_bv 32) i))
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) o) ((_ int_to_bv 64) i))))))))
  (ite (= o1 #x00000001) (= result__1 result__2)
  (exists ((result__3 Int) (i1 Int))
  (and
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j i1)) (bvugt (shift_right value j) #x00000001)))
  (and
  (= (and (ite (and (dynamic_invariant2 result__3 false true true true)
               (in_range2 i1))
          true false) (ite (and (<= 0 i1) (<= i1 31)) true false)) true)
  (ite (= i1 31) (= result__1 result__3)
  (exists ((i2 Int))
  (and (= i2 (+ i1 1))
  (and (= result__1 i2)
  (let ((o2 value))
  (let ((o3 (shift_right o2 i2)))
  (and
  (and (dynamic_invariant1 o3 true false true true)
  (= o3 (ite (and (<= 1 32) (<= 32 8))
        ((_ zero_extend 24) (ite (< i2 8)
                            (bvlshr ((_ extract 7 0) o2) ((_ int_to_bv 8) i2))
                            #x00))
        (ite (and (<= 9 32) (<= 32 16))
        ((_ zero_extend 16) (ite (< i2 16)
                            (bvlshr ((_ extract 15 0) o2) ((_ int_to_bv 16) i2))
                            #x0000))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr o2 ((_ int_to_bv 32) i2))
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) o2) ((_ int_to_bv 64) i2))))))))
  (= o3 #x00000001))))))))))))))))) (= result__1 result__))))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result) #x00000001))))))))))
(check-sat)
(exit)
