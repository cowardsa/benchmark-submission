...
;; defqtvc
 ;; File "aalias.adb", line 10, characters 0-0
  (not
  (forall ((e1 (_ BitVec 8)) (e2 (_ BitVec 8)) (b (_ BitVec 8))
  (e21 (_ BitVec 8)) (e11 (_ BitVec 8)))
  (=> (= e21 e2)
  (=> (dynamic_invariant e1 true false true true)
  (=> (dynamic_invariant e2 true false true true)
  (=> (= e11 e2)
  (=> (dynamic_invariant b false false true true) (= e11 e21)))))))))
(check-sat)
(exit)
