...
(define-fun my_mod__ref_my_mod__content__projection ((a my_mod__ref)) my_mod 
  (my_mod__content a))
...
;; defqtvc
 ;; File "my_shift.ads", line 10, characters 0-0
  (not
  (forall ((z (_ BitVec 32)) (z1 (_ BitVec 32)) (z2 (_ BitVec 32)))
  (=> (dynamic_invariant z true false true true)
  (=> (= z z_old)
  (=> (dynamic_invariant z_old true false true true)
  (=> (= z1 (bvlshr z ((_ int_to_bv 32) 1)))
  (=> (= z1 (bvudiv z_old #x00000002))
  (=> (= z2 (bvlshr z1 ((_ int_to_bv 32) 2))) (= z2 (bvudiv z_old #x00000008)))))))))))
(check-sat)
(exit)
