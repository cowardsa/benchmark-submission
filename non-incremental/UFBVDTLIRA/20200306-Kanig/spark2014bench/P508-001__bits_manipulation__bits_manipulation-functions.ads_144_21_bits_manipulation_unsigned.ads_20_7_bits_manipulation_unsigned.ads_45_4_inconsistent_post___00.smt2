...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     ...
     (= (ite (< n 18446744073709551616)
        (bvshl #x0000000000000001 ((_ int_to_bv 64) n)) #x0000000000000000) #x0000000000000000))
     (= (shift_right val__ n) (bvudiv val__ (ite (< n 18446744073709551616)
...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 142, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__lemmas__shift_right__lemma1__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__lemmas__shift_right__lemma1__result true)
  (= (lemma1 Tuple0) true))))))
(check-sat)
(exit)
