...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 23, characters 0-0
  ...
  (= o4 (ite (and (<= 1 8) (<= 8 8))
        (ite (< o2 8) (bvlshr o3 ((_ int2bv 8) o2)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< o2 16)
                         (bvlshr ((_ zero_extend 8) o3) ((_ int2bv 16) o2))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o3) ((_ int2bv 32) o2)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o3) ((_ int2bv 64) o2))))))))
  ...
  (= o9 (ite (and (<= 1 8) (<= 8 8))
        (ite (< o7 8) (bvlshr o8 ((_ int2bv 8) o7)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< o7 16)
                         (bvlshr ((_ zero_extend 8) o8) ((_ int2bv 16) o7))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o8) ((_ int2bv 32) o7)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o8) ((_ int2bv 64) o7))))))))
  (=>
  (or
  (not
