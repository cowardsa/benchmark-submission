...
;; lemma6__def_axiom
  ...
  (! (= (= (lemma61 us_void_param) true)
     ...
     (=> (and (bvule #x0000 val__) (bvule val__ #xFFFF))
     (=> (not (= val__ #x0000))
     (and (= (shift_right val__ 0) val__)
     (exists ((n Int))
     (and (and (<= 0 n) (<= n 15))
     (and
     (and (= (shift_right val__ n) #x0001)
     (forall ((j Int))
     (=> (and (<= 0 j) (<= j n)) (bvuge (shift_right val__ j) #x0001))))
     (forall ((j Int))
     (=> (and (<= n j) (<= j 15)) (bvule (shift_right val__ j) #x0001))))))))))) :pattern (
...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 115, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result Int))
  ...
  (exists ((i Int))
  (and (= i 0)
  (ite (= (and (ite (<= 0 i) true false) (ite (<= i 15) true false)) true)
  ...
  (ite (= o1 #x0001) (= result__1 result__2)
  (exists ((result__3 Int) (i1 Int))
  (and
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j i1)) (bvugt (shift_right value j) #x0001)))
  (and
  (= (and (ite (and (dynamic_invariant2 result__3 false true true true)
               (in_range2 i1))
          true false) (ite (and (<= 0 i1) (<= i1 15)) true false)) true)
  (ite (= i1 15) (= result__1 result__3)
  (exists ((i2 Int))
  (and (= i2 (+ i1 1))
  (and (= result__1 i2)
  (let ((o2 value))
  ...
  (= o3 #x0001))))))))))))))))) (= result__1 result__))))
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result) #x0001))))))))))
(check-sat)
(exit)
