...
;; bit_test__post_axiom
  ...
  (! (=>
     ...
     (= (= result true)
     (not
     (= (bvand value (let ((temp___172 (bv2nat pos)))
...
;; defqtvc
 ;; File "bitset.ads", line 18, characters 0-0
  (not
  (forall ((res (_ BitVec 64)) (o (_ BitVec 64)) (res1 (_ BitVec 64))
  (bitset__bit_set__result (_ BitVec 64)))
  ...
  (=>
  (forall ((bitset__bit_set__result1 (_ BitVec 64)))
  (bit_test__function_guard (bit_test bitset__bit_set__result1 pos)
  bitset__bit_set__result1 pos))
