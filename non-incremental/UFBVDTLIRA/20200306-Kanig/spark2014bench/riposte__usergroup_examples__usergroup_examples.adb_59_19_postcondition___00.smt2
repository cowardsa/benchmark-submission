...
(define-fun u64__ref_u64__content__projection ((a1 u64__ref)) u64 (u64__content
                                                                  a1))
...
;; defqtvc
 ;; File "usergroup_examples.adb", line 55, characters 0-0
  (not
  (forall ((usergroup_examples__example_5__result (_ BitVec 64)))
  (=> (dynamic_invariant a true false true true)
  (=> (dynamic_invariant b true false true true)
  (=> (bvugt a #x0000000000000011)
  (=> (bvugt b #x0000000000000013)
  (=>
  (= usergroup_examples__example_5__result (bvxor #x0000000000000049 (bvmul 
  a b))) (bvugt usergroup_examples__example_5__result #x0000000000000000)))))))))
(check-sat)
(exit)
