...
(define-fun dynamic_invariant ((temp___expr_179 (_ BitVec 8))
...
(declare-datatypes ((tt7__ref 0))
(((tt7__refqtmk (tt7__content tt7)))))
(define-fun tt7__ref_tt7__content__projection ((a tt7__ref)) tt7 (tt7__content
                                                                 a))
...
;; defqtvc
 ;; File "u.adb", line 3, characters 0-0
  ...
  (= (ite (< 256 8) (bvshl #x0A ((_ int_to_bv 8) 256)) #x00) #x00)))))
(check-sat)
(exit)
