...
(assert
;; defqtvc
 ;; File "x86.ads", line 140, characters 0-0
  (not
  (forall ((rdx (_ BitVec 64)))
  (=> (dynamic_invariant rdx true false true true)
  (forall ((x86__dx__result (_ BitVec 16)))
  (=> (= x86__dx__result ((_ extract 15 0) (bvand rdx #x000000000000FFFF)))
  (bvule ((_ zero_extend 48) #x0000) (bvand rdx #x000000000000FFFF))))))))
(check-sat)
(exit)
