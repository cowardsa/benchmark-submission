...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     ...
     (forall ((n Int))
     (=> (and (<= 0 n) (<= n 7))
     (= (shift_left v n) (bvmul v (ite (< n 256)
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 254, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_left__lemma1__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_left__lemma1__result true)
  (= (lemma1 Tuple0) true))))))
(check-sat)
(exit)
