...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 109, characters 0-0
  ...
  (forall
  ((bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_not_inline__result Int))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_not_inline__result o1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_not_inline__result) #x00000001))))))))))
(check-sat)
(exit)
