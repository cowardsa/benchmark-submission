...
;; defqtvc
 ;; File "x86.ads", line 174, characters 0-0
  (not
  (forall ((rbx (_ BitVec 64)) (rbx1 (_ BitVec 64)) (rbx2 (_ BitVec 64)))
  (=> (= rbx1 rbx)
  (=> (dynamic_invariant rbx true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rbx2 (bvor (bvand rbx #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) 
  val__) #x0100))))
  (= rbx2 (bvor (bvand rbx1 #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) 
  val__) #x0100)))))))))))
(check-sat)
(exit)
