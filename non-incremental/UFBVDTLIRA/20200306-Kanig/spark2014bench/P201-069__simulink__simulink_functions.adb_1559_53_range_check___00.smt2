...
(declare-fun u32toint16 ((_ BitVec 32)) Int)

(declare-fun u32toint16__function_guard (Int (_ BitVec 32)) Bool)
...
(define-fun source__ref_source__content__9__projection ((a source__ref)) source 
  (source__content a))

(define-fun dynamic_invariant ((temp___expr_489 (_ BitVec 32))
  (temp___is_init_485 Bool) (temp___skip_constant_486 Bool)
  (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool true)
...
;; target'axiom
  (assert
  (forall ((i target))
  (and (<= (- 32768) (targetqtint i)) (<= (targetqtint i) 32767))))
...
(define-fun target__ref_target__content__9__projection ((a target__ref)) target 
  (target__content a))
...
;; u32toint16__post_axiom
  (assert
  (forall ((s (_ BitVec 32)))
  (! (=> (dynamic_invariant s true true true true)
     (let ((result (u32toint16 s)))
     (=> (u32toint16__function_guard result s) (dynamic_invariant1 result
     true false true true)))) :pattern ((u32toint16 s)) )))
...
(assert
;; defqtvc
 ;; File "simulink_functions.ads", line 215, characters 0-0
  (not
