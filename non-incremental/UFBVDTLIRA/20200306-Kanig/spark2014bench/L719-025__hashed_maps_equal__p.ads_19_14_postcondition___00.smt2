...
(define-fun key_type__ref_key_type__content__4__projection ((a key_type__ref)) us_rep2 
  (key_type__content a))
...
(define-fun dynamic_invariant5 ((temp___expr_269 Int)
...
(define-fun default_initial_assumption ((temp___expr_383 us_rep3)
...
(define-fun default_initial_assumption1 ((temp___expr_408 us_rep4)
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq3 a b) (oeq3 a b)) :pattern ((user_eq3 a b)) )))

(define-fun default_initial_assumption2 ((temp___expr_331 us_rep1)
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     ...
     (= (has_key (model1 container) (get1 result temp___460)) true))))
     (forall ((key1 Int))
     (=> (and (in_range7 key1) (= (has_key (model1 container) key1) true))
     (and (< 0 (find1 result key1))
     (and
     (forall ((result1 us_rep3) (key2 Int)) (my_eq__function_guard
...
;; has_key__post_axiom
  ...
  (! (=> (dynamic_invariant6 key1 true true true true)
     ...
     (= (my_eq k1 key1) true))) (= (has_key container key1) true))))) :pattern (
...
;; length__post_axiom
  (assert
  (forall ((container us_rep1)) (! (dynamic_invariant (length4 container)
...
;; ole__post_axiom
  ...
  (! (= (= (ole left right) true)
     (forall ((key1 Int))
     (=> (and (in_range7 key1) (= (has_key left key1) true))
...
;; oeq__post_axiom
  ...
  (! (= (= (oeq3 left right) true)
     ...
     (forall ((key1 Int))
     (=> (and (in_range7 key1) (= (has_key right key1) true))
...
;; is_empty__post_axiom
  ...
  (! (= (= (is_empty1 container) true)
     (forall ((key1 Int))
     (not (and (in_range7 key1) (= (has_key container key1) true))))) :pattern (
  (is_empty1 container)) )))
...
;; keys_included_except__post_axiom
  ...
  (! (=> (dynamic_invariant6 new_key true true true true)
     ...
     (forall ((key1 Int))
     (=> (and (in_range7 key1) (= (has_key left key1) true))
     (=> (not (= (my_eq key1 new_key) true)) (= (has_key right key1) true))))))) :pattern (
...
;; elements_equal_except__post_axiom
  ...
  (! (=> (dynamic_invariant6 new_key true true true true)
     ...
     (forall ((key1 Int))
     (=> (and (in_range7 key1) (= (has_key left key1) true))
     (=> (not (= (my_eq key1 new_key) true))
     (and (= (has_key right key1) true) (= (get left key1) (get right key1))))))))) :pattern (
...
;; has_key__post_axiom
  ...
  (! (=> (= (distinct 0 0) true)
     (=>
     (exists ((k1 us_rep2))
     (and (= (has_key1 container k1) true) (= (bool_eq2 k1 key1) true)))
...
;; defqtvc
 ;; File "p.ads", line 17, characters 0-0
  ...
  (let ((o2 (contains o1 o)))
  (and (= (= o2 true) (= (has_key (model1 o1) o) true))
  ...
  (= (get1 (keys (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))
     (get2 (positions (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))
     (find (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)) o3))) o3))
  (= (equal_except
     (keys (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields)))
     (keys (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))
     (get2 (positions (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))
     (find (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)) o3))) true))
  (= (get (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1))) o3) 
  e))
  (= (same_keys
  ...
  (= (elements_equal_except
     (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))
     (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields))) o3) true))))
  (let ((o3 k))
  (let ((o4 l__split_discrs))
  (and
  (and
  ...
  (= (key (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1))
     (find (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)) o3)) o3))
  (= (get (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1))) o3) 
  e))
  (= (ole (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields)))
     (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))) true))
  ...
  (= (mapping_preserved
     ...
     (positions (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))) true))
