...
(define-fun dynamic_invariant1 ((temp___expr_374 Int)
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (and
     (let ((temp___449 (get result i)))
     (and (<= 1 temp___449) (<= temp___449 (length1 container))))
     (forall ((j us_rep))
...
(define-fun dynamic_invariant4 ((temp___expr_267 Int)
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (= (contains (model1 container1) (get1 result temp___438)) true))))
     (forall ((item Int))
...
(define-fun dynamic_invariant7 ((temp___expr_342 Int)
...
;; defqtvc
 ;; File "a-cfhase.ads", line 1196, characters 0-0
  ...
  (=> (= (has_key o3 i) true)
  (and
  (let ((temp___444 (get o3 i)))
  (and (<= 1 temp___444) (<= temp___444 (length1 o2))))
  (forall ((j us_rep))
  (=> (= (has_key o3 j) true)
