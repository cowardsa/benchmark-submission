...
(define-fun to_int2 ((x unsigned_16)) Int (ubv_to_int (to_rep x)))
...
;; defqtvc
 ;; File "saturation.adb", line 10, characters 0-0
  ...
  (forall ((val____split_fields1 us_split_fields))
  (=>
  (= val____split_fields1 (us_split_fieldsqtmk o2
                          (rec__saturation__saturable_value__upper_bound
                          val____split_fields)))
  (=>
  (=>
  (= (bvule (to_rep
            (rec__saturation__saturable_value__value val____split_fields)) 
  (to_rep
  ...
  (to_rep
  (rec__saturation__saturable_value__upper_bound val____split_fields))) true)
  (= (bool_eq (us_repqtmk val____split_fields1)
     (us_repqtmk
     (us_split_fieldsqtmk
