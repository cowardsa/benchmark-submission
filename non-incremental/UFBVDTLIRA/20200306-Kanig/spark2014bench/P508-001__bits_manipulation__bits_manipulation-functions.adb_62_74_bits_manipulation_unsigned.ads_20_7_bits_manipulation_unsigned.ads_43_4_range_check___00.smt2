...
(declare-fun shift_left__function_guard ((_ BitVec 16) (_ BitVec 16)
  Int) Bool)
...
;; shift_left__def_axiom
  ...
  (! (=>
     ...
     (= (shift_left v amount) (ite (and (<= 1 16) (<= 16 8))
                              ...
                              (ite (and (<= 9 16) (<= 16 16))
                              (ite (< amount 16)
                              (bvshl v ((_ int_to_bv 16) amount)) #x0000)
                              (ite (and (<= 17 16) (<= 16 32))
                              ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 16) v) ((_ int_to_bv 32) amount)) ((_ int_to_bv 32) 65536)))
                              ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 48) v) ((_ int_to_bv 64) amount)) ((_ int_to_bv 64) 65536)))))))) :pattern (
  (shift_left v amount)) ))))
...
(declare-fun extract_bits_inline_always ((_ BitVec 16) Int
  Int) (_ BitVec 16))

(declare-fun extract_bits_inline_always__function_guard ((_ BitVec 16)
  (_ BitVec 16) Int Int) Bool)
...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 53, characters 0-0
  (not
  ...
  (forall
  ((bits_manipulation_unsigned__unsigned_16__functions__extract_bits_not_inline__result (_ BitVec 16)))
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_not_inline__result o3)
  (let ((o4 (+ (- to__ from) 1)))
  (=> (in_range1 o4)
  (let ((o5 (make_mask o4)))
  (=>
  (and (dynamic_invariant1 o5 true false true true)
  (= o5 (shift_right #xFFFF (- 16 o4))))
  (let ((o6 from))
  (let ((o7 value))
  (let ((o8 (shift_right o7 o6)))
  (=>
  (and (dynamic_invariant1 o8 true false true true)
  (= o8 (ite (and (<= 1 16) (<= 16 8))
        ((_ zero_extend 8) (ite (< o6 8)
                           (bvlshr ((_ extract 7 0) o7) ((_ int_to_bv 8) o6))
                           #x00))
        (ite (and (<= 9 16) (<= 16 16))
        (ite (< o6 16) (bvlshr o7 ((_ int_to_bv 16) o6)) #x0000)
        (ite (and (<= 17 16) (<= 16 32))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 16) o7) ((_ int_to_bv 32) o6)))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 48) o7) ((_ int_to_bv 64) o6))))))))
  (=>
  (or
  (not
  (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_not_inline__result (bvand o8 o5)))
  (let ((o9 (+ (- to__ from) 1)))
  (and (in_range1 o9)
  (let ((o10 (make_mask o9)))
  (and (dynamic_invariant1 o10 true false true true)
  (= o10 (shift_right #xFFFF (- 16 o9))))))))
  (=>
  (and
  (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_not_inline__result (bvand o8 o5))
  (bvule bits_manipulation_unsigned__unsigned_16__functions__extract_bits_not_inline__result 
