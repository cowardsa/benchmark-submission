...
;; shift_left__def_axiom
  ...
  (! (=>
     ...
     (= (shift_left v amount) (ite (and (<= 1 16) (<= 16 8))
                              ...
                              (ite (and (<= 9 16) (<= 16 16))
                              (ite (< amount 16)
                              (bvshl v ((_ int2bv 16) amount)) #x0000)
                              (ite (and (<= 17 16) (<= 16 32))
                              ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 16) v) ((_ int2bv 32) amount)) ((_ int2bv 32) 65536)))
                              ((_ extract 15 0) (bvurem (bvshl ((_ zero_extend 48) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 65536)))))))) :pattern (
  (shift_left v amount)) ))))
 ...
 ;; File "bits_manipulation-functions.adb", line 53, characters 0-0
  ...
  (= o8 (ite (and (<= 1 16) (<= 16 8))
        ((_ zero_extend 8) (ite (< o6 8)
                           (bvlshr ((_ extract 7 0) o7) ((_ int2bv 8) o6))
                           #x00))
        (ite (and (<= 9 16) (<= 16 16))
        (ite (< o6 16) (bvlshr o7 ((_ int2bv 16) o6)) #x0000)
        (ite (and (<= 17 16) (<= 16 32))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 16) o7) ((_ int2bv 32) o6)))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 48) o7) ((_ int2bv 64) o6))))))))
  (=>
  (or
  (not
