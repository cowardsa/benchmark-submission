...
;; defqtvc
 ;; File "achiever.ads", line 34, characters 0-0
  (not
  (forall ((my_internal_state Int)
  (state_item__split_fields us_split_fields))
  ...
  (us_split_fieldsqtmk1 (us_repqtmk state_item__split_fields1)))))
  (=>
  (forall ((my_internal_state1 Int)) (get_internal_state__function_guard
  (get_internal_state my_internal_state1) my_internal_state1))
  (=>
  (forall ((state_item__split_fields1 us_split_fields))
  (get_state_item__function_guard
  (get_state_item
  ...
  (get_internal_state my_internal_state1) my_internal_state1))
  (=>
  (forall ((my_internal_state1 Int) (usf Int))
  (prf_do_something__function_guard
  (prf_do_something st 0 usf (get_internal_state my_internal_state1)) 
  st 0 usf (get_internal_state my_internal_state1)))
