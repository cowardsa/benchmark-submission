...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 137, characters 0-0
  ...
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_not_inline__result Int))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_not_inline__result o1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_not_inline__result) #x0000000000000001))))))))))
(check-sat)
(exit)
