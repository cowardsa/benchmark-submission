...
(declare-fun user_eq2 (score_t score_t) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_558 (_ BitVec 32))
...
(assert
;; defqtvc
 ;; File "patris.ads", line 304, characters 0-0
  (not
  (forall ((level_nbr (_ BitVec 32)) (speed_up Bool))
  (=> (dynamic_invariant1 level_nbr true false true true)
  (let ((o (* (- 11 (mod2 (ubv_to_int level_nbr) 11)) 50)))
  (=> (in_range o)
  (=> (in_range1 o)
  (forall ((interval Int))
  (=> (= interval o)
