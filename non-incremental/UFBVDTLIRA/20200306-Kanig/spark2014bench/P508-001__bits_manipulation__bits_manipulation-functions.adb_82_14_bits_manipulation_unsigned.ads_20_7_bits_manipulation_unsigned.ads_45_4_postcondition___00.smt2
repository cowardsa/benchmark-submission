 ...
 ;; File "bits_manipulation-functions.adb", line 79, characters 0-0
  ...
  (= o (ite (and (<= 1 64) (<= 64 8))
       ((_ zero_extend 56) (ite (< shift_amount1 8)
                           (bvlshr ((_ extract 7 0) v1) ((_ int2bv 8) shift_amount1))
                           #x00))
       (ite (and (<= 9 64) (<= 64 16))
       ((_ zero_extend 48) (ite (< shift_amount1 16)
                           (bvlshr ((_ extract 15 0) v1) ((_ int2bv 16) shift_amount1))
                           #x0000))
       (ite (and (<= 17 64) (<= 64 32))
       ((_ zero_extend 32) (bvlshr ((_ extract 31 0) v1) ((_ int2bv 32) shift_amount1)))
       (bvlshr v1 ((_ int2bv 64) shift_amount1)))))))
