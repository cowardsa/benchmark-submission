...
;; lemma6__def_axiom
  ...
  (! (= (= (lemma61 us_void_param) true)
     ...
     (=>
     (and (bvule #x0000000000000000 val__) (bvule val__ #xFFFFFFFFFFFFFFFF))
     (=> (not (= val__ #x0000000000000000))
     (and (= (shift_right val__ 0) val__)
     (exists ((n Int))
     (and (and (<= 0 n) (<= n 63))
     (and
     (and (= (shift_right val__ n) #x0000000000000001)
     (forall ((j Int))
     (=> (and (<= 0 j) (<= j n))
     (bvuge (shift_right val__ j) #x0000000000000001))))
     (forall ((j Int))
     (=> (and (<= n j) (<= j 63))
     (bvule (shift_right val__ j) #x0000000000000001))))))))))) :pattern (
...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 115, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result Int))
  ...
  (exists ((i Int))
  (and (= i 0)
  (ite (= (and (ite (<= 0 i) true false) (ite (<= i 63) true false)) true)
  ...
  (= o1 (ite (and (<= 1 64) (<= 64 8))
        ((_ zero_extend 56) (ite (< i 8)
                            (bvlshr ((_ extract 7 0) o) ((_ int_to_bv 8) i))
                            #x00))
        (ite (and (<= 9 64) (<= 64 16))
        ((_ zero_extend 48) (ite (< i 16)
                            (bvlshr ((_ extract 15 0) o) ((_ int_to_bv 16) i))
                            #x0000))
        (ite (and (<= 17 64) (<= 64 32))
        ((_ zero_extend 32) (bvlshr ((_ extract 31 0) o) ((_ int_to_bv 32) i)))
        (bvlshr o ((_ int_to_bv 64) i)))))))
  (ite (= o1 #x0000000000000001) (= result__1 result__2)
  ...
  (= (and (ite (and (dynamic_invariant2 result__3 false true true true)
               (in_range2 i1))
          true false) (ite (and (<= 0 i1) (<= i1 63)) true false)) true)
  (ite (= i1 63) (= result__1 result__3)
  (exists ((i2 Int))
  (and (= i2 (+ i1 1))
  (and (= result__1 i2)
  (let ((o2 value))
  ...
  (= o3 (ite (and (<= 1 64) (<= 64 8))
        ((_ zero_extend 56) (ite (< i2 8)
                            (bvlshr ((_ extract 7 0) o2) ((_ int_to_bv 8) i2))
                            #x00))
        (ite (and (<= 9 64) (<= 64 16))
        ((_ zero_extend 48) (ite (< i2 16)
                            (bvlshr ((_ extract 15 0) o2) ((_ int_to_bv 16) i2))
                            #x0000))
        (ite (and (<= 17 64) (<= 64 32))
        ((_ zero_extend 32) (bvlshr ((_ extract 31 0) o2) ((_ int_to_bv 32) i2)))
        (bvlshr o2 ((_ int_to_bv 64) i2)))))))
  (= o3 #x0000000000000001))))))))))))))))) (= result__1 result__))))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result) #x0000000000000001))))))))))
(check-sat)
(exit)
