 ...
 ;; File "bits_manipulation-functions.adb", line 115, characters 0-0
  ...
  (= o1 (ite (and (<= 1 64) (<= 64 8))
        ...
        ((_ zero_extend 48) (ite (< i 16)
                            (bvlshr ((_ extract 15 0) o) ((_ int2bv 16) i))
                            #x0000))
        (ite (and (<= 17 64) (<= 64 32))
        ((_ zero_extend 32) (bvlshr ((_ extract 31 0) o) ((_ int2bv 32) i)))
        (bvlshr o ((_ int2bv 64) i)))))))
  ...
  (= o3 (ite (and (<= 1 64) (<= 64 8))
        ...
        ((_ zero_extend 48) (ite (< i2 16)
                            (bvlshr ((_ extract 15 0) o2) ((_ int2bv 16) i2))
                            #x0000))
        (ite (and (<= 17 64) (<= 64 32))
        ((_ zero_extend 32) (bvlshr ((_ extract 31 0) o2) ((_ int2bv 32) i2)))
        (bvlshr o2 ((_ int2bv 64) i2)))))))
