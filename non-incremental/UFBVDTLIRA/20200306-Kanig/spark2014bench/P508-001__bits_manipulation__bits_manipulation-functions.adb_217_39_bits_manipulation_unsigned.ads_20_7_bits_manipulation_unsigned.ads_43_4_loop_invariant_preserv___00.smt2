...
(declare-sort t619s 0)

(declare-fun t619sqtint (t619s) Int)

;; t619s'axiom
  (assert
  (forall ((i t619s)) (and (<= 2 (t619sqtint i)) (<= (t619sqtint i) 15))))

(define-fun in_range2 ((x Int)) Bool (and (<= 2 x) (<= x 15)))
...
(declare-fun user_eq2 (t619s t619s) Bool)

(declare-const dummy2 t619s)

(declare-datatypes ((t619s__ref 0))
(((t619s__refqtmk (t619s__content t619s)))))
(define-fun t619s__ref_t619s__content__projection ((a t619s__ref)) t619s 
  (t619s__content a))
...
;; lemma8__def_axiom
  ...
  (! (= (= (lemma81 us_void_param) true)
     ...
     (forall ((n Int))
     (=> (and (<= 1 n) (<= n 15))
     (bvult (shift_right val__ (- 16 n)) (ite (< n 65536)
                                         (bvshl #x0001 ((_ int_to_bv 16) n))
                                         #x0000))))))) :pattern ((lemma81
                                                                 us_void_param)) )))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 302, characters 0-0
  ...
  (=> (= (make_mask 1) #x0001)
  (=> (= i 2)
  (=> (= (and (ite (<= 2 i) true false) (ite (<= i 15) true false)) true)
  (=>
  (= (make_mask i) (bvsub (ite (< i 65536) (bvshl #x0001 ((_ int_to_bv 16) i))
                          #x0000) #x0001))
  (=>
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 (- i1 1)))
  (= (make_mask j1) (bvsub (ite (< j1 65536)
                           (bvshl #x0001 ((_ int_to_bv 16) j1)) #x0000) #x0001))))
  (=>
  (= (and (ite (in_range2 i1) true false) (ite (and (<= 2 i1) (<= i1 15))
                                          true false)) true)
  (=> (not (= i1 15))
  (=> (= i2 (+ i1 1))
  (=>
  (= (make_mask i2) (bvsub (ite (< i2 65536)
                           (bvshl #x0001 ((_ int_to_bv 16) i2)) #x0000) #x0001))
  (=> (<= 1 j)
  (=> (<= j (- i2 1))
  (= (make_mask j) (bvsub (ite (< j 65536) (bvshl #x0001 ((_ int_to_bv 16) j))
                          #x0000) #x0001)))))))))))))))))
(check-sat)
(exit)
