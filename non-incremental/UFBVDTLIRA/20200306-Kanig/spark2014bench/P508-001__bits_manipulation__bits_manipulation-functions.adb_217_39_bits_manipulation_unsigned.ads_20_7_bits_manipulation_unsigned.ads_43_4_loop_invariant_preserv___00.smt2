...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 302, characters 0-0
  ...
  (= (make_mask j1) (bvsub (ite (< j1 65536)
                           (bvshl #x0001 ((_ int2bv 16) j1)) #x0000) #x0001))))
  (=>
  ...
  (= (make_mask i2) (bvsub (ite (< i2 65536)
                           (bvshl #x0001 ((_ int2bv 16) i2)) #x0000) #x0001))
  (=> (<= 1 j)
  (=> (<= j (- i2 1))
  (= (make_mask j) (bvsub (ite (< j 65536) (bvshl #x0001 ((_ int2bv 16) j))
                          #x0000) #x0001)))))))))))))))))
(check-sat)
(exit)
