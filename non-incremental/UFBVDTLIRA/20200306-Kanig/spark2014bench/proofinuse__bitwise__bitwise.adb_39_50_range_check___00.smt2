...
(define-fun dynamic_invariant ((temp___expr_165 (_ BitVec 8))
...
(define-fun dynamic_invariant1 ((temp___expr_172 (_ BitVec 16))
  (temp___is_init_168 Bool) (temp___skip_constant_169 Bool)
  (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "bitwise.ads", line 19, characters 0-0
  (not
  (forall ((fsthalf (_ BitVec 8)) (sndhalf (_ BitVec 8)))
  (=> (dynamic_invariant1 val__ true false true true)
  (=> (dynamic_invariant fsthalf false false true true)
  ...
  (bvule ((_ zero_extend 8) #x00) (bvand o #x00FF))))))))))))
(check-sat)
(exit)
