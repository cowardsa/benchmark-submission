...
(declare-fun temp_____aggregate_def_231 (map1 Int (_ BitVec 8) Int Int
  (_ BitVec 8) Int) map1)
...
;; def_axiom
  (assert
  (forall ((temp___233 map1))
  (forall ((temp___234 Int) (temp___236 Int) (temp___237 Int)
  (temp___239 Int))
  (forall ((temp___235 (_ BitVec 8)) (temp___238 (_ BitVec 8)))
  (let ((temp___232 (temp_____aggregate_def_231 temp___233 temp___234
                    temp___235 temp___236 temp___237 temp___238 temp___239)))
  (=>
  (and (dynamic_invariant1 temp___234 true true true true)
  (and
  (and
  (and (dynamic_invariant2 temp___235 true true true true) (dynamic_invariant
  temp___236 true true true true)) (dynamic_invariant1 temp___237 true true
  true true))
  (and (dynamic_invariant2 temp___238 true true true true) (dynamic_invariant
  temp___239 true true true true))))
  (forall ((temp___240 Int))
  (forall ((temp___241 (_ BitVec 8)))
  (ite (and (= temp___240 temp___237) (= temp___241 temp___238))
  (= (to_rep (get temp___232 temp___240 temp___241)) temp___239)
  (ite (and (= temp___240 temp___234) (= temp___241 temp___235))
  (= (to_rep (get temp___232 temp___240 temp___241)) temp___236)
  (= (get temp___232 temp___240 temp___241) (get temp___233 temp___240
                                            temp___241))))))))))))

(assert
;; defqtvc
 ;; File "update_logic_fn.ads", line 33, characters 0-0
  (not
  ...
  (= (bool_eq a2 1 10 #x00 #x07
     (temp_____aggregate_def_231 a_2d_arr 5 #x07 v1 x y v2) 1 10 #x00 #x07) true))))))))))))))
(check-sat)
(exit)
