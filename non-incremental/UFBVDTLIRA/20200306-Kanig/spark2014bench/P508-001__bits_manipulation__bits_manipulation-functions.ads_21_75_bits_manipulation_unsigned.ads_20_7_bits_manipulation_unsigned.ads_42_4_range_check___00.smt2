...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 13, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result (_ BitVec 8)))
  ...
  (= result__1 o3))))))))))))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result result__1)
  (let ((o (+ (- to__ from) 1)))
  (=> (in_range1 o)
  (let ((o1 (make_mask o)))
  (=>
  (and (dynamic_invariant1 o1 true false true true)
  (= o1 (shift_right #xFF (- 8 o))))
  (let ((o2 from))
  (let ((o3 value))
  ...
  (or
  (not
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result (bvand o4 o1)))
  (let ((o5 (+ (- to__ from) 1)))
  (and (in_range1 o5)
  (let ((o6 (make_mask o5)))
  ...
  (and
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result (bvand o4 o1))
  (bvule bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result 
