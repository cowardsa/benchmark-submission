...
;; defqtvc
 ;; File "dynamicsaturateassert.ads", line 19, characters 0-0
  (not
  (forall ((saturated_value (_ BitVec 32))
  (saturation_dynamic_out1 (_ BitVec 32))
  (saturation_dynamic_out11 (_ BitVec 32)))
  (=> (dynamic_invariant1 value true false true true)
  (=> (dynamic_invariant1 max1 true false true true)
  (=> (dynamic_invariant1 min1 true false true true)
  (=> (dynamic_invariant saturated_value false false true true)
  (=> (bvuge max1 min1)
  (=> (dynamic_invariant saturation_dynamic_out1 false false true true)
  (=>
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (bvult value min1) true false))
  ...
  (=> (bvuge saturation_dynamic_out11 min1) (bvuge max1 min1)))))))))))))
(check-sat)
(exit)
