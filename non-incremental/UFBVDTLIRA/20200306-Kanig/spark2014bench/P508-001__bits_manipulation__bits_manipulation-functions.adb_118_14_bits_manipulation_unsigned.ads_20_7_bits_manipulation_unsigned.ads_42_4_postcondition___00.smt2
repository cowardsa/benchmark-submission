...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 115, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result Int))
  ...
  (exists ((i Int))
  (and (= i 0)
  (ite (= (and (ite (<= 0 i) true false) (ite (<= i 7) true false)) true)
  ...
  (ite (= o1 #x01) (= result__1 result__2)
  ...
  (= o3 #x01))))))))))))))))) (= result__1 result__))))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result) #x01))))))))))
(check-sat)
(exit)
