...
;; defqtvc
 ;; File "inrange3.ads", line 15, characters 0-0
  (not
  (forall ((inrange3__inrange64__result Bool)
  (inrange3__inrange64__result1 Bool))
  ...
  (and (= i #x0000000000000000)
  (and (dynamic_invariant i true false true true)
  (or
  (and (bvult i range_size)
  (exists ((o Bool))
  (and
  (ite (= i #x0000000000000000) (= o true)
  (= o (ite (forall ((n (_ BitVec 64)))
            (=>
            (and (bvule #x0000000000000000 n)
            (bvule n (bvsub i #x0000000000000001)))
            (not (= var (bvadd bottom n)))))
       true false)))
  (exists ((i1 (_ BitVec 64)))
  (and
  (and
  (and (bvule #x0000000000000000 i1)
  (bvule i1 (bvsub range_size #x0000000000000001)))
  (or (= i1 #x0000000000000000)
  ...
  (ite (bvult i1 range_size) true false)) true)
  (exists ((temp___171 (_ BitVec 64)))
  (and (= temp___171 i1)
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (= var (bvadd bottom i1)) true false))
  (and (= spark__branch true)
  (= inrange3__inrange64__result1 (distinct 1 0)))))))))))))
  (exists ((inrange3__inrange64__result2 Bool))
  (and
  (ite (bvult i range_size)
  (exists ((o Bool))
  (and
  (ite (= i #x0000000000000000) (= o true)
  (= o (ite (forall ((n (_ BitVec 64)))
  ...
  (and (= i2 (bvadd i1 #x0000000000000001)) (not (bvult i2 range_size))))))))))))))
  (= inrange3__inrange64__result2 inrange3__inrange64__result))
  (= inrange3__inrange64__result1 (distinct 0 0))))))))
