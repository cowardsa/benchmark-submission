...
(assert
;; defqtvc
 ;; File "x86.ads", line 105, characters 0-0
  (not
  ...
  (=>
  (= rcx2 (bvor (bvand rcx #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__)))
  (= rcx2 (bvor (bvand rcx1 #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__))))))))))
(check-sat)
(exit)
