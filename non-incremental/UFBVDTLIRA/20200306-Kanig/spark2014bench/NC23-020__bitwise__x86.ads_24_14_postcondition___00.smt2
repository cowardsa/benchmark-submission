...
(assert
;; defqtvc
 ;; File "x86.ads", line 22, characters 0-0
  (not
  ...
  (=>
  (= rax2 (bvor (bvand rax #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__)))
  (= rax2 (bvor (bvand rax1 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__))))))))))
(check-sat)
(exit)
