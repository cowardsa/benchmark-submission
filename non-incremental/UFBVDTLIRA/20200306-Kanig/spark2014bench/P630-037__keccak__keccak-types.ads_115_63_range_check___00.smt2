...
(declare-fun user_eq1 (unsigned_1 unsigned_1) Bool)

(declare-const dummy1 unsigned_1)

(declare-datatypes ((unsigned_1__ref 0))
(((unsigned_1__refqtmk (unsigned_1__content unsigned_1)))))
(define-fun unsigned_1__ref_unsigned_1__content__projection ((a unsigned_1__ref)) unsigned_1 
  (unsigned_1__content a))

(define-fun dynamic_invariant1 ((temp___expr_168 (_ BitVec 8))
...
(assert
;; defqtvc
 ;; File "keccak-types.ads", line 65, characters 0-0
  (not
  (forall ((o (_ BitVec 8)))
  ...
  (=> (<= amount 1)
  (=>
  (ite (< amount 8) (= o (bvlshr value ((_ int_to_bv 8) amount))) (= o #x00))
