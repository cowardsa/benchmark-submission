 ...
 ;; File "bits_manipulation-functions.adb", line 79, characters 0-0
  ...
  (= o (ite (and (<= 1 16) (<= 16 8))
       ((_ zero_extend 8) (ite (< shift_amount1 8)
                          ...
                          #x00))
       (ite (and (<= 9 16) (<= 16 16))
       (ite (< shift_amount1 16) (bvlshr v1 ((_ int2bv 16) shift_amount1))
       #x0000)
       (ite (and (<= 17 16) (<= 16 32))
       ((_ extract 15 0) (bvlshr ((_ zero_extend 16) v1) ((_ int2bv 32) shift_amount1)))
       ((_ extract 15 0) (bvlshr ((_ zero_extend 48) v1) ((_ int2bv 64) shift_amount1))))))))
