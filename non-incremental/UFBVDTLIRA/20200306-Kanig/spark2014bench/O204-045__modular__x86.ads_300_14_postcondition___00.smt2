...
(assert
;; defqtvc
 ;; File "x86.ads", line 298, characters 0-0
  (not
  (forall ((r8 (_ BitVec 64)) (r81 (_ BitVec 64)) (r82 (_ BitVec 64)))
  (=> (= r81 r8)
  (=> (dynamic_invariant r8 true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=> (= r82 (bvor (bvand r8 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) 
  val__)))
  (= r82 (bvor (bvand r81 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__))))))))))
(check-sat)
(exit)
