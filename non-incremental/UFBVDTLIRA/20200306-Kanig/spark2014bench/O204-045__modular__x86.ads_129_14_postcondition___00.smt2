...
(assert
;; defqtvc
 ;; File "x86.ads", line 127, characters 0-0
  (not
  ...
  (=>
  (= rdx2 (bvor (bvand rdx #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__)))
  (= rdx2 (bvor (bvand rdx1 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__))))))))))
(check-sat)
(exit)
