...
;; defqtvc
 ;; File "p.ads", line 12, characters 0-0
  ...
  (let ((o (shift_right a 17)))
  (=>
  (and (shift_right__function_guard o a 17)
  (and (dynamic_invariant1 o true false true true)
  (= o (bvudiv a (ite (< 17 4294967296) (bvshl #x00000001 ((_ int_to_bv 32) 17))
                 #x00000000)))))
  (forall ((a1 (_ BitVec 32))) (=> (= a1 o) (not (= #x00020000 #x00000000))))))))))
(check-sat)
(exit)
