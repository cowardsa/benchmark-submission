...
;; lemma5__def_axiom
  ...
  (! (= (= (lemma5 us_void_param) true)
     ...
     (=> (and (<= 1 n) (<= n 7))
     (=>
     (or (bvugt (shift_right val__ (- n 1)) #x00)
     (bvugt (shift_right val__ n) #x00))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 190, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_right__lemma5__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_right__lemma5__result true)
  (= (lemma5 Tuple0) true))))))
(check-sat)
(exit)
