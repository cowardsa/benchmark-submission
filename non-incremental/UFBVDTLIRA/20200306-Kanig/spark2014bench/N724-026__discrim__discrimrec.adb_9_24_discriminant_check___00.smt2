...
(define-fun to_int5 ((x unsigned_64)) Int (ubv_to_int (to_rep x)))
...
(define-fun to_int6 ((x unsigned_32)) Int (ubv_to_int (to_rep1 x)))
...
(define-fun to_int7 ((x unsigned_16)) Int (ubv_to_int (to_rep2 x)))
...
(define-fun to_int8 ((x unsigned_8)) Int (ubv_to_int (to_rep3 x)))
...
(define-fun dynamic_invariant1 ((temp___expr_252 us_rep)
...
(define-fun dynamic_invariant2 ((temp___expr_159 (_ BitVec 64))
  (temp___is_init_155 Bool) (temp___skip_constant_156 Bool)
  (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool true)

(define-fun dynamic_invariant3 ((temp___expr_166 (_ BitVec 32))
  (temp___is_init_162 Bool) (temp___skip_constant_163 Bool)
  (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool true)

(define-fun dynamic_invariant4 ((temp___expr_173 (_ BitVec 16))
  (temp___is_init_169 Bool) (temp___skip_constant_170 Bool)
  (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool true)

(define-fun dynamic_invariant5 ((temp___expr_180 (_ BitVec 8))
...
;; defqtvc
 ;; File "discrimrec.adb", line 8, characters 0-0
  ...
  (forall ((o1 unsigned_32))
  (=> (= (to_rep1 o1) ((_ extract 31 0) (bvurem o #x0000000100000000)))
