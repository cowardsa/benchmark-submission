...
(assert
;; defqtvc
 ;; File "x86.ads", line 88, characters 0-0
  (not
  ...
  (=>
  (= rcx2 (bvor (bvand rcx #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__)))
  (= rcx2 (bvor (bvand rcx1 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__))))))))))
(check-sat)
(exit)
