...
(assert
;; defqtvc
 ;; File "t.adb", line 34, characters 0-0
  (not
  (forall ((t__mmul__result (_ BitVec 8)))
  (=> (dynamic_invariant x true false true true)
  (=> (dynamic_invariant y true false true true)
  (=>
  (= t__mmul__result ((_ extract 7 0) (bvurem (bvmul ((_ zero_extend 8) 
  x) ((_ zero_extend 8) y)) #x00E6)))
  (= ((_ zero_extend 8) t__mmul__result) (bvurem (bvmul ((_ zero_extend 8) 
  x) ((_ zero_extend 8) y)) #x00E6))))))))
(check-sat)
(exit)
