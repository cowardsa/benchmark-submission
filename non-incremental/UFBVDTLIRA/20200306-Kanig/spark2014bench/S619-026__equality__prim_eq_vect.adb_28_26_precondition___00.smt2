...
(define-fun us_split_discrs_rec__prim_eq_vect__int_vect__vector__capacity__projection ((a us_split_discrs)) capacity_range 
...
(((us_split_fieldsqtmk (rec__prim_eq_vect__int_vect__vector us_main_type)))))
(define-fun us_split_fields_rec__prim_eq_vect__int_vect__vector__projection ((a us_split_fields)) us_main_type 
...
(define-fun to_int2 ((x hash_type)) Int (ubv_to_int (to_rep2 x)))
...
(define-fun us_split_discrs_rec__prim_eq_vect__int_vect_map__map__capacity__projection ((a us_split_discrs2)) count_type 
  (rec__prim_eq_vect__int_vect_map__map__capacity a))

(define-fun us_split_discrs_rec__prim_eq_vect__int_vect_map__map__modulus__projection ((a us_split_discrs2)) hash_type 
...
(((us_split_fieldsqtmk1 (rec__prim_eq_vect__int_vect_map__map us_main_type2)))))
(define-fun us_split_fields_rec__prim_eq_vect__int_vect_map__map__projection ((a us_split_fields2)) us_main_type2 
...
(define-fun map__ref_map__content__2__projection ((a map__ref1)) us_rep3 
  (map__content1 a))
...
(((my_vect__refqtmk (my_vect__content us_rep)))))
(define-fun my_vect__ref_my_vect__content__projection ((a my_vect__ref)) us_rep 
  (my_vect__content a))

(declare-datatypes ((us_split_fields4 0))
(((us_split_fieldsqtmk2
  (rec__prim_eq_vect__two_vects__f us_rep)(rec__prim_eq_vect__two_vects__g us_rep)))))
(define-fun us_split_fields_rec__prim_eq_vect__two_vects__f__projection ((a us_split_fields4)) us_rep 
  (rec__prim_eq_vect__two_vects__f a))

(define-fun us_split_fields_rec__prim_eq_vect__two_vects__g__projection ((a us_split_fields4)) us_rep 
...
(define-fun us_rep___split_fields__2__projection ((a us_rep4)) us_split_fields4 
  (us_split_fields5 a))
...
(((two_vects__refqtmk (two_vects__content us_rep4)))))
...
(define-fun element_type__ref_element_type__content__3__projection ((a element_type__ref)) us_rep4 
...
(define-fun contains ((container us_rep2)
  (key Int)) Bool (has_key (model2 container) key))

(declare-fun contains__function_guard (Bool us_rep2 Int) Bool)

(declare-datatypes ((element_type__ref1 0))
(((element_type__refqtmk1 (element_type__content1 us_rep4)))))
(define-fun element_type__ref_element_type__content__4__projection ((a element_type__ref1)) us_rep4 
...
(define-fun element ((container us_rep2)
  (key Int)) us_rep4 (get1 (model2 container) key))

(declare-fun element__function_guard (us_rep4 us_rep2 Int) Bool)
...
(define-fun default_initial_assumption3 ((temp___expr_377 us_rep1)
  (temp___skip_top_level_378 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_378 true))
                                         (= (length1 temp___expr_377) 0)))
...
(define-fun dynamic_invariant7 ((temp___expr_369 Int)
...
;; has_key__post_axiom
  ...
  (forall ((key Int))
  (! (=> (dynamic_invariant9 key true true true true)
     (=> (= (distinct 1 0) true)
     (=>
     (exists ((k Int))
...
(declare-fun w_get (us_rep3 Int) us_rep4)
...
;; get__post_axiom
  ...
  (forall ((key Int))
  (! (=>
     (and (dynamic_invariant9 key true true true true)
