...
(define-fun to_int2 ((x (_ BitVec 128))) Int (ite (bvsge x (_ bv0 128))
                                             (ubv_to_int x)
                                             (- (- 340282366920938463463374607431768211456 (ubv_to_int x)))))
...
(declare-fun user_eq (nvu64b nvu64b) Bool)

(declare-const dummy nvu64b)

(declare-datatypes ((nvu64b__ref 0))
(((nvu64b__refqtmk (nvu64b__content nvu64b)))))
(define-fun nvu64b__ref_nvu64b__content__projection ((a nvu64b__ref)) nvu64b 
  (nvu64b__content a))

(define-fun dynamic_invariant ((temp___expr_221 (_ BitVec 64))
  (temp___is_init_217 Bool) (temp___skip_constant_218 Bool)
  (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "nwa.ads", line 56, characters 0-0
  (not
  ...
  (=> (bvule y #x0000000100000000)
  (=> (dynamic_invariant z false false true true)
  (=>
  (exists ((spark__branch Bool))
  (= spark__branch (ite (= x #x0000000000000000) true false)))
