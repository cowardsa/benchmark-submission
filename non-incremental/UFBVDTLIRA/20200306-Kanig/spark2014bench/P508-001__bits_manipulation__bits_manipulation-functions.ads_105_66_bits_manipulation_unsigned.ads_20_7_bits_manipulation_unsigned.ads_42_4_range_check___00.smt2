...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 93, characters 0-0
  ...
  (= o1 (ite (and (<= 1 8) (<= 8 8))
        (ite (< usf1 8) (bvlshr usf ((_ int2bv 8) usf1)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< usf1 16)
                         (bvlshr ((_ zero_extend 8) usf) ((_ int2bv 16) usf1))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) usf) ((_ int2bv 32) usf1)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) usf) ((_ int2bv 64) usf1))))))))
  (ite (= o1 #x01)
  (= o (ite (forall ((j Int))
