...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 115, characters 0-0
  ...
  (= o1 (ite (and (<= 1 8) (<= 8 8))
        (ite (< i 8) (bvlshr o ((_ int2bv 8) i)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< i 16)
                         (bvlshr ((_ zero_extend 8) o) ((_ int2bv 16) i))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o) ((_ int2bv 32) i)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o) ((_ int2bv 64) i))))))))
  (=> (not (= o1 #x01))
  ...
  (= o3 (ite (and (<= 1 8) (<= 8 8))
        (ite (< i2 8) (bvlshr o2 ((_ int2bv 8) i2)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< i2 16)
                         (bvlshr ((_ zero_extend 8) o2) ((_ int2bv 16) i2))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o2) ((_ int2bv 32) i2)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o2) ((_ int2bv 64) i2))))))))
  (=> (not (= o3 #x01))
  (forall ((j Int))
