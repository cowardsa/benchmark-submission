...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 299, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result Bool))
  (=> (= (lemma8 Tuple0) true)
  (=>
  (forall ((size Int))
  (=> (and (<= 1 size) (<= size 15))
  ...
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result 
  (lemma1_goal Tuple0))
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result true)
  (= (lemma1 Tuple0) true))))))))
(check-sat)
(exit)
