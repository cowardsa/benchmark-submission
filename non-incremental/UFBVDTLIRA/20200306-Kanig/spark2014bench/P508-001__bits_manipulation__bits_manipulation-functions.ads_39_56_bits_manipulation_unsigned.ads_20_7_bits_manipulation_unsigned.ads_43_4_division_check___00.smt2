...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 35, characters 0-0
  (not
  (forall ((usf (_ BitVec 16)) (usf1 Int) (o (_ BitVec 16))
  (o1 (_ BitVec 16)))
  (=>
  ...
  (=>
  (ite (< usf1 65536) (= o (bvshl #x0001 ((_ int_to_bv 16) usf1))) (= o #x0000))
  (=> (not (= o #x0000))
  (=>
  (ite (< usf1 65536) (= o1 (bvshl #x0001 ((_ int_to_bv 16) usf1)))
  (= o1 #x0000)) (not (= o1 #x0000))))))))))
(check-sat)
(exit)
