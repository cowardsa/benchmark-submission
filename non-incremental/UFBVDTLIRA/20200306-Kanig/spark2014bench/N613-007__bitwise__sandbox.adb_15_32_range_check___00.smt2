...
(declare-const whole (_ BitVec 64))
...
(declare-fun user_eq (size64_type size64_type) Bool)

(declare-const dummy size64_type)

(declare-datatypes ((size64_type__ref 0))
(((size64_type__refqtmk (size64_type__content size64_type)))))
(define-fun size64_type__ref_size64_type__content__projection ((a size64_type__ref)) size64_type 
  (size64_type__content a))

(define-fun dynamic_invariant ((temp___expr_158 (_ BitVec 64))
  (temp___is_init_154 Bool) (temp___skip_constant_155 Bool)
  (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool true)

(declare-sort size32_type 0)
...
(declare-fun user_eq1 (size32_type size32_type) Bool)

(declare-const dummy1 size32_type)

(declare-datatypes ((size32_type__ref 0))
(((size32_type__refqtmk (size32_type__content size32_type)))))
(define-fun size32_type__ref_size32_type__content__projection ((a size32_type__ref)) size32_type 
  (size32_type__content a))
...
;; defqtvc
 ;; File "sandbox.ads", line 9, characters 0-0
  (not
  (forall ((msw (_ BitVec 32)) (lsw (_ BitVec 32)))
  ...
  (bvule ((_ zero_extend 32) #x00000000) (bvand whole #x00000000FFFFFFFF))))))))
(check-sat)
(exit)
