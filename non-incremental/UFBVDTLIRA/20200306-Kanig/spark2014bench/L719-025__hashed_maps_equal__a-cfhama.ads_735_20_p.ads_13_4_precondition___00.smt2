...
(((us_split_fieldsqtmk (rec__p__my_maps__cursor__node count_type)))))
(define-fun us_split_fields_rec__p__my_maps__cursor__node__projection ((a us_split_fields)) count_type 
...
(((us_split_fieldsqtmk1 (rec__p__my_maps__map us_main_type)))))
(define-fun us_split_fields_rec__p__my_maps__map__projection ((a us_split_fields2)) us_main_type 
  ...
  (b us_rep1)) Bool (ite (and
                         ...
                         (= (to_rep1
                            ...
                            (us_split_discrs1 a))) (to_rep1
                                                   ...
                                                   (us_split_discrs1 b)))))
                         (= (us_main_eq
                            (rec__p__my_maps__map (us_split_fields3 a))
                            (rec__p__my_maps__map (us_split_fields3 b))) true))
                    true false))
...
(define-fun in_range2 ((rec__p__my_maps__map__capacity1 Int)
  ...
  (a us_split_discrs)) Bool (and
                            (= rec__p__my_maps__map__capacity1 (to_rep
                                                               (rec__p__my_maps__map__capacity
                                                               a)))
                            (= rec__p__my_maps__map__modulus1 (to_rep1
                                                              (rec__p__my_maps__map__modulus
                                                              a)))))
...
(define-fun key_type__ref_key_type__content__4__projection ((a key_type__ref)) us_rep 
  (key_type__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_400 Int)
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (and
     (let ((temp___471 (get result i)))
     (and (<= 1 temp___471) (<= temp___471 (length1 container))))
     (forall ((j us_rep))
...
(define-fun key_type__ref_key_type__content__3__projection ((a key_type__ref2)) key_type1 
...
(define-fun dynamic_invariant4 ((temp___expr_316 Int)
  ...
  (temp___do_typ_inv_315 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range5 temp___expr_316)))
...
;; has_key__post_axiom
  ...
  (! (=> (dynamic_invariant4 key true true true true)
     (and
     (forall ((key1 Int) (k Int)) (my_eq__function_guard (my_eq k key1) k
     key1))
     (=> (= (distinct 1 0) true)
     (=>
     (exists ((k Int))
     (and (and (in_range5 k) (= (has_key1 container1 k) true))
     (= (my_eq k key) true))) (= (has_key1 container1 key) true))))) :pattern (
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (forall ((k Int))
     (=> (and (in_range5 k) (= (has_key1 container1 k) true))
     (= (= (my_eq k key) true)
...
;; oeq__post_axiom
  ...
  (! (= (= (oeq2 left right) true)
     (and
     (forall ((key Int))
     (=> (and (in_range5 key) (= (has_key1 left key) true))
     (and (= (has_key1 right key) true) (= (get1 right key) (get1 left key)))))
     (forall ((key Int))
     (=> (and (in_range5 key) (= (has_key1 right key) true))
...
;; is_empty__post_axiom
  ...
  (! (= (= (is_empty1 container1) true)
     (forall ((key Int))
     (not (and (in_range5 key) (= (has_key1 container1 key) true))))) :pattern (
...
;; defqtvc
 ;; File "a-cfhama.ads", line 729, characters 0-0
  ...
  (<= o1 (to_rep (rec__p__my_maps__map__capacity (us_split_discrs1 o)))))
  (let ((o2 container))
  (let ((o3 (positions o2)))
  (=>
  ...
  (=> (= (has_key o3 i) true)
  (and
  (let ((temp___466 (get o3 i)))
  (and (<= 1 temp___466) (<= temp___466 (length1 o2))))
  (forall ((j us_rep))
  (=> (= (has_key o3 j) true)
