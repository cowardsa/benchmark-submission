...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 288, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__lemmas__make_mask__lemma2__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__lemmas__make_mask__lemma2__result true)
  (= (lemma2 Tuple0) true))))))
(check-sat)
(exit)
