...
(declare-fun signedlt_32 ((_ BitVec 32) (_ BitVec 32)) Bool)

(declare-fun signedlt_32__function_guard (Bool (_ BitVec 32)
  (_ BitVec 32)) Bool)
...
(define-fun dynamic_invariant ((temp___expr_218 (_ BitVec 32))
  (temp___is_init_214 Bool) (temp___skip_constant_215 Bool)
  (temp___do_toplevel_216 Bool) (temp___do_typ_inv_217 Bool)) Bool true)

;; signedlt_32__post_axiom
  (assert
  (forall ((val1 (_ BitVec 32)) (val2 (_ BitVec 32)))
  (! (=>
     (and (dynamic_invariant val1 true true true true) (dynamic_invariant
     val2 true true true true))
     (let ((result (signedlt_32 val1 val2)))
     (=> (signedlt_32__function_guard result val1 val2)
     (= (= result true)
     (bvugt (bvadd ((_ zero_extend 32) val1) ((_ zero_extend 32) val2)) ((_ zero_extend 32) (bvadd val1 val2))))))) :pattern (
  (signedlt_32 val1 val2)) )))

(declare-const val1 (_ BitVec 32))

(declare-const attr__ATTRIBUTE_ADDRESS Int)

(declare-const val2 (_ BitVec 32))

(declare-const attr__ATTRIBUTE_ADDRESS1 Int)

(assert
;; defqtvc
 ;; File "x86.ads", line 478, characters 0-0
  (not
  (=> (dynamic_invariant val1 true false true true)
  (=> (dynamic_invariant val2 true false true true)
  (let ((o val2))
  (let ((o1 val1))
  (let ((o2 (signedlt_32 o1 o)))
  (=>
  (and (signedlt_32__function_guard o2 o1 o)
  (= (= o2 true)
  (bvugt (bvadd ((_ zero_extend 32) o1) ((_ zero_extend 32) o)) ((_ zero_extend 32) (bvadd o1 o)))))
  (forall ((x86__signedlte_32__result Bool))
  (=> (= x86__signedlte_32__result (or (ite (= val1 val2) true false) o2))
  (=> (= x86__signedlte_32__result true)
  (or (= val1 val2)
