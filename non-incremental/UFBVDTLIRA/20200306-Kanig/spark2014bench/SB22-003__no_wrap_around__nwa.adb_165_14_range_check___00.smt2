...
(define-fun in_range_int ((x1 Int)) Bool (and (<= 0 x1) (<= x1 1000)))
...
(declare-fun user_eq (nvu32b nvu32b) Bool)

(declare-const dummy nvu32b)

(declare-datatypes ((nvu32b__ref 0))
(((nvu32b__refqtmk (nvu32b__content nvu32b)))))
(define-fun nvu32b__ref_nvu32b__content__projection ((a nvu32b__ref)) nvu32b 
  (nvu32b__content a))

(define-fun dynamic_invariant ((temp___expr_200 (_ BitVec 32))
  (temp___is_init_196 Bool) (temp___skip_constant_197 Bool)
  (temp___do_toplevel_198 Bool)
  (temp___do_typ_inv_199 Bool)) Bool (=>
                                     (or (= temp___is_init_196 true)
                                     (bvule #x00000000 #x000003E8))
...
;; defqtvc
 ;; File "nwa.ads", line 47, characters 0-0
  ...
  (and (= spark__branch (ite (= x #x00000000) true false))
  (or (not (= spark__branch true)) (in_range1 (bvneg x))))) (in_range1
  (bvadd x y)))))))))))))
(check-sat)
(exit)
