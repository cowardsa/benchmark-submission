...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     (forall ((size Int))
     (=> (and (<= 1 size) (<= size 15))
     (bvult (make_mask size) (ite (< size 65536)
                             (bvshl #x0001 ((_ int_to_bv 16) size)) #x0000))))) :pattern (
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 284, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_16__functions__lemmas__make_mask__lemma1__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__lemmas__make_mask__lemma1__result true)
  (= (lemma1 Tuple0) true))))))
(check-sat)
(exit)
