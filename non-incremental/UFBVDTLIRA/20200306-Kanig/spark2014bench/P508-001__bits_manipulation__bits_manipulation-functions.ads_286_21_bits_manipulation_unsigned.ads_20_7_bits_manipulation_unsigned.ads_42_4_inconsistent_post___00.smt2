...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     (forall ((size Int))
     (=> (and (<= 1 size) (<= size 7))
     (bvult (make_mask size) (ite (< size 256)
                             (bvshl #x01 ((_ int_to_bv 8) size)) #x00))))) :pattern (
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 284, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__lemmas__make_mask__lemma1__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__lemmas__make_mask__lemma1__result true)
  (= (lemma1 Tuple0) true))))))
(check-sat)
(exit)
