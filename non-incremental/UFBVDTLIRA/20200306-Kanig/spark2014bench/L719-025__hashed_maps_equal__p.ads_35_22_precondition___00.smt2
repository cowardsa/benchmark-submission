...
;; defqtvc
 ;; File "p.ads", line 28, characters 0-0
  ...
  (let ((usf1 (us_repqtmk l__split_discrs
              (us_split_fieldsqtmk l__split_fields))))
  (let ((o k))
  ...
  (= (key (us_repqtmk o6 (us_split_fieldsqtmk l__split_fields2))
     (find (us_repqtmk o6 (us_split_fieldsqtmk l__split_fields2)) o5)) o5))
  (= (get (model1 (us_repqtmk o6 (us_split_fieldsqtmk l__split_fields2))) o5) e))
  ...
  (= (keys_included_except
     ...
     (model1 (us_repqtmk o6 (us_split_fieldsqtmk l__split_fields1))) o5) true))
  (= (mapping_preserved
  ...
  (let ((o8 (find usf o7)))
  (=>
  (forall ((usf2 us_rep) (o9 Int) (o10 us_rep1)) (my_eq__function_guard
  (my_eq (key usf2 o10) o9) (key usf2 o10) o9))
  (=>
  (ite (= (not (has_key1 (model1 usf) o7)) true)
  (= (bool_eq1 o8 no_element) true)
  (and
  (and (= (has_key (positions usf) o8) true)
  (= (get2 (positions usf) o8) (find1 (keys usf) o7)))
  (= (my_eq (key usf o8) o7) true)))
  (let ((o9 k))
  ...
  (=> (= (bool_eq1 o11 o8) true)
  (let ((temp___838 (us_repqtmk l__split_discrs
                    (us_split_fieldsqtmk l__split_fields2))))
  (forall ((usf2 count_type))
  (let ((usf3 (us_repqtmk1 (us_split_fieldsqtmk1 usf2))))
  (let ((o12 (has_element temp___838 usf3)))
  (=> (= (= o12 true) (= (has_key (positions temp___838) usf3) true))
  (=> (= (and (ite true true false) o12) true)
  (let ((o13 (element usf1 usf3)))
  (=>
  (and (dynamic_invariant o13 true false true true)
  (= o13 (get (model1 usf1) (key usf1 usf3))))
  (= (has_element
