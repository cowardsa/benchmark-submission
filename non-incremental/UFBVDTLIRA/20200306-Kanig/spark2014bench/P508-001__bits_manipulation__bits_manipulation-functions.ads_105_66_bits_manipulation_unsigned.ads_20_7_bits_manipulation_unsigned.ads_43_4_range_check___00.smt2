 ...
 ;; File "bits_manipulation-functions.ads", line 93, characters 0-0
  ...
  (= o1 (ite (and (<= 1 16) (<= 16 8))
        ((_ zero_extend 8) (ite (< usf1 8)
                           ...
                           #x00))
        (ite (and (<= 9 16) (<= 16 16))
        (ite (< usf1 16) (bvlshr usf ((_ int2bv 16) usf1)) #x0000)
        (ite (and (<= 17 16) (<= 16 32))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 16) usf) ((_ int2bv 32) usf1)))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 48) usf) ((_ int2bv 64) usf1))))))))
  (ite (= o1 #x0001)
  (= o (ite (forall ((j Int))
            (=> (and (<= 0 j) (<= j usf1))
