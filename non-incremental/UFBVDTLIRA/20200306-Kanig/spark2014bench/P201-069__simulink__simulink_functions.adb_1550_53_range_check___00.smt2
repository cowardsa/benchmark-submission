...
(declare-fun u32toint32 ((_ BitVec 32)) Int)

(declare-fun u32toint32__function_guard (Int (_ BitVec 32)) Bool)
...
(define-fun source__ref_source__content__6__projection ((a source__ref)) source 
  (source__content a))

(define-fun dynamic_invariant ((temp___expr_447 (_ BitVec 32))
  (temp___is_init_443 Bool) (temp___skip_constant_444 Bool)
  (temp___do_toplevel_445 Bool) (temp___do_typ_inv_446 Bool)) Bool true)
...
(define-fun target__ref_target__content__6__projection ((a target__ref)) target 
  (target__content a))

(define-fun dynamic_invariant1 ((temp___expr_454 Int)
  ...
  (temp___do_typ_inv_453 Bool)) Bool (=>
                                     ...
                                     (in_range1 temp___expr_454)))

;; u32toint32__post_axiom
  (assert
  (forall ((s (_ BitVec 32)))
  (! (=> (dynamic_invariant s true true true true)
     (let ((result (u32toint32 s)))
     (=> (u32toint32__function_guard result s) (dynamic_invariant1 result
     true false true true)))) :pattern ((u32toint32 s)) )))
...
(assert
;; defqtvc
 ;; File "simulink_functions.ads", line 214, characters 0-0
  (not
