...
;; defqtvc
 ;; File "t.adb", line 22, characters 0-0
  ...
  (forall ((t__msub__result (_ BitVec 8)))
  (=> (= t__msub__result o)
  (=> (=> (= (and (= x #x00) (= y #x00)) true) (= t__msub__result #x00))
  (=> (=> (= (and (not (= x #x00)) (= y #x00)) true) (= t__msub__result x))
  (=>
  (=> (= (and (= x #x00) (not (= y #x00))) true)
  (= t__msub__result (bvurem (bvsub #xE6 y) #xE6)))
  (=> (=> (= (and (= x #x02) (= y #x04)) true) (= t__msub__result #xE4))
  (=> (= (and (= x #x04) (= y #x02)) true) (= t__msub__result #x02))))))))))))))
(check-sat)
(exit)
