...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 190, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__axiom__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__axiom__result true)
