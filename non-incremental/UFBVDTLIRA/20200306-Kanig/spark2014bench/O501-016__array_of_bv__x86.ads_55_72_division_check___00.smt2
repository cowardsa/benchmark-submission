...
(assert
;; defqtvc
 ;; File "x86.ads", line 53, characters 0-0
  (not
  (forall ((rax (_ BitVec 64)))
  (=> (dynamic_invariant rax true false true true)
  (forall ((x86__ah__result (_ BitVec 8)))
  (=>
  (= x86__ah__result ((_ extract 7 0) (bvudiv (bvand rax #x000000000000FF00) #x0000000000000100)))
