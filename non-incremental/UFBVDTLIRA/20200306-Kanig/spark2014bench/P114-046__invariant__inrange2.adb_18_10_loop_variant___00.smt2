...
;; defqtvc
 ;; File "inrange2.ads", line 15, characters 0-0
  (not
  (forall ((matched Bool) (i (_ BitVec 64)) (spark__branch Bool)
  (i1 (_ BitVec 64)) (temp___174 (_ BitVec 64)) (spark__branch1 Bool)
  (i2 (_ BitVec 64)))
  ...
  (=>
  (= (and (ite (bvult i range_size) true false) (ite (= matched true) false
                                                true)) true)
  (=> (= spark__branch (ite (= var (bvadd bottom i)) true false))
  ...
  (=> (= temp___174 i1)
  (=>
  (= (and (ite (bvult i1 range_size) true false) (ite (= matched true) false
                                                 true)) true)
  (=> (= spark__branch1 (ite (= var (bvadd bottom i1)) true false))
