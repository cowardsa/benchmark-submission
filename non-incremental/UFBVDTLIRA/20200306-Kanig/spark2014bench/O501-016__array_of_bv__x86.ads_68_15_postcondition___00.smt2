...
;; ax__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rax true true true true)
     ...
     (and (= result ((_ extract 15 0) (bvand x86__rax #x000000000000FFFF)))
     (dynamic_invariant1 result true false true true))))) :pattern ((ax
                                                                    x86__rax)) )))
...
(assert
;; defqtvc
 ;; File "x86.ads", line 66, characters 0-0
  (not
  ...
  (=>
  (= rax1 (bvor (bvand rax #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__)))
  (=> (forall ((rax2 (_ BitVec 64))) (ax__function_guard (ax rax2) rax2))
  (= (ax rax1) val__))))))))
(check-sat)
(exit)
