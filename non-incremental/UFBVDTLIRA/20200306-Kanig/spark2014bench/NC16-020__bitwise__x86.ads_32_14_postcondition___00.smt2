...
(define-fun dynamic_invariant1 ((temp___expr_211 (_ BitVec 8))
  (temp___is_init_207 Bool) (temp___skip_constant_208 Bool)
  (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "x86.ads", line 30, characters 0-0
  (not
  (forall ((rax (_ BitVec 64)) (rax1 (_ BitVec 64)) (rax2 (_ BitVec 64)))
  (=> (= rax1 rax)
  (=> (dynamic_invariant rax true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rax2 (bvor (bvand rax #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) 
  val__) #x0100))))
