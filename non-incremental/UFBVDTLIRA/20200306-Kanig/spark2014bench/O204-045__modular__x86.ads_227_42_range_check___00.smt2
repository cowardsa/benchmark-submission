...
(assert
;; defqtvc
 ;; File "x86.ads", line 225, characters 0-0
  (not
  (forall ((rbp (_ BitVec 64)))
  (=> (dynamic_invariant rbp true false true true)
  (forall ((x86__bp__result (_ BitVec 16)))
  (=> (= x86__bp__result ((_ extract 15 0) (bvand rbp #x000000000000FFFF)))
  (bvule ((_ zero_extend 48) #x0000) (bvand rbp #x000000000000FFFF))))))))
(check-sat)
(exit)
