...
;; ch__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rcx true true true true)
     ...
     (and
     (= result ((_ extract 7 0) (bvurem (bvudiv (bvand x86__rcx #x000000000000FF00) #x0000000000000100) ((_ int_to_bv 64) 256))))
...
;; defqtvc
 ;; File "x86.ads", line 96, characters 0-0
  ...
  (=>
  (= rcx1 (bvor (bvand rcx #xFFFFFFFFFFFF00FF) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) 
  val__) #x0100))))
  (=> (forall ((rcx2 (_ BitVec 64))) (ch__function_guard (ch rcx2) rcx2))
  (= (ch rcx1) val__))))))))
(check-sat)
(exit)
