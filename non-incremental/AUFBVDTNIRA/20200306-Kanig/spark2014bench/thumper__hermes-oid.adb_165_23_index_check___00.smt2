...
(define-fun to_int2 ((x octet)) Int (ubv_to_int (to_rep5 x)))
...
(declare-datatypes ((tcomponent_typeB__ref 0))
...
;; defqtvc
 ;; File "hermes-oid.ads", line 52, characters 0-0
  (not
  (forall ((octet_count Int) (result_index Int) (start_index Int)
  (left_index Int) (right_index Int) (current_component Int)
  (temp (_ BitVec 8)) (o Int) (o1 Int))
  (=> (dynamic_property 0 2147483647 (to_rep result____first)
  ...
  (=> (= (to_rep result____last) o)
  (=> (= (to_rep result____first) o1)
  (let ((temp___362 (temp_____aggregate_def_356 #x00 o1 o)))
  (=> (= (first1 temp___362) (to_rep result____first))
  (=> (= (last1 temp___362) (to_rep result____last))
  (let ((temp___364 (of_array (to_array temp___362) (first1 temp___362)
                    (last1 temp___362))))
  (=>
  ...
  (forall ((o2 Int))
  (=> (= (to_rep result____first) o2)
  (forall ((result__ (Array Int octet)))
  (=> (= result__ (slide1 (to_array temp___364) (first1 temp___364) o2))
  (forall ((octet_count1 Int))
  (=> (= octet_count1 0)
  (forall ((o3 Int))
  (=> (= (to_rep result____last) o3)
  (forall ((o4 Int))
  (=> (= (to_rep result____first) o4)
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (< 0 (length o4 o3)) true false))
  (=> (= spark__branch true)
  (forall ((o5 Int))
  (=> (= (to_rep result____first) o5)
  (=> (in_range2 o5)
  (forall ((result_index1 Int))
  (=> (= result_index1 o5)
  (forall ((octet_count2 Int))
  (=> (= octet_count2 1)
  (forall ((o6 Int))
  (=>
  (= (to_rep2
  ...
  (=> (uint_in_range o9)
  (forall ((o10 octet))
  (=> (= (to_rep5 o10) ((_ int_to_bv 8) o9))
  (=>
  (and (<= (to_rep result____first) result_index1)
  (<= result_index1 (to_rep result____last)))
  (forall ((result__1 (Array Int octet)))
  (=> (= result__1 (store result__ result_index1 o10))
  (forall ((temp___367 Int))
  (=>
  (= (to_rep4
     (rec__ada___hermes__oid__object_identifier__other_component_count
     (us_split_fields1 identifier))) temp___367)
  (forall ((other_index Int))
  (=> (= other_index 1)
  (=>
  (= (and (ite (<= 1 other_index) true false) (ite (<= other_index temp___367)
                                              true false)) true)
  (forall ((o11 Int))
  (=> (= (to_rep result____last) o11)
  (forall ((o12 Int))
  (=> (= (to_rep result____first) o12)
  (forall ((octet_count3 Int) (result_index2 Int) (start_index1 Int)
  (left_index1 Int) (right_index1 Int) (current_component1 Int)
  (temp1 (_ BitVec 8)) (other_index1 Int))
  (=>
  ...
  (forall ((current_component2 Int))
  (=> (= current_component2 o13)
  (forall ((start_index2 Int))
  (=> (= start_index2 result_index2)
  (forall ((out_of_space Bool))
  (=> (= out_of_space (distinct 0 0))
  (forall ((spark__branch1 Bool) (result__2 (Array Int octet))
  (result_index3 Int) (out_of_space1 Bool))
  (=>
  (exists ((o14 Int))
  (and (= (to_rep result____last) o14)
  (exists ((o15 Int))
  (and (= (to_rep result____first) o15)
  (exists ((result__3 (Array Int octet)) (result_index4 Int)
  ...
  (and (= spark__branch1 (ite (= result_index4 o16) true false))
  (ite (= spark__branch1 true)
  (and (and (= out_of_space1 (distinct 1 0)) (= result__2 result__3))
  ...
  (exists ((o19 octet))
  (and (= (to_rep5 o19) ((_ int_to_bv 8) o18))
  (and
  (and (<= (to_rep result____first) result_index3)
  (<= result_index3 (to_rep result____last)))
  (and (= result__2 (store result__3 result_index3 o19))
  ...
  (=> (= spark__branch2 (ite (= out_of_space1 true) false true))
  (=> (= spark__branch2 true)
  ...
  (=> (in_range2 o15)
  (forall ((o16 Int))
  (=> (= (to_rep result____first) o16)
  (let ((o17 (+ o16 1)))
  (=> (in_range1 o17)
  (=> (in_range2 o17)
  (forall ((left_index2 Int))
  (=> (= left_index2 o17)
  (forall ((right_index2 Int))
  (=> (= right_index2 result_index3)
  (forall ((result__3 (Array Int octet)))
  (=>
  (ite (< left_index2 right_index2)
  (exists ((o18 Int))
  (and (= (to_rep result____last) o18)
  (exists ((o19 Int))
  (and (= (to_rep result____first) o19)
  (exists ((o20 Int))
  (and (= (to_rep result____last) o20)
  (exists ((o21 Int))
  (and (= (to_rep result____first) o21)
  (exists ((result__4 (Array Int octet)) (left_index3 Int) (right_index3 Int)
  (temp2 (_ BitVec 8)))
  (and
  (and
  (and (<= (to_rep result____first) left_index3)
  (<= left_index3 (to_rep result____last)))
  (and (<= (to_rep result____first) right_index3)
  (<= right_index3 (to_rep result____last))))
  (and
  (= (and (ite (and
               (and (dynamic_invariant right_index3 false true true true)
               (dynamic_invariant3 temp2 false true true true))
               (dynamic_invariant left_index3 false true true true))
          true false) (ite (< left_index3 right_index3) true false)) true)
  (and
  (and (<= (to_rep result____first) left_index3)
  (<= left_index3 (to_rep result____last)))
  (exists ((o22 (_ BitVec 8)))
  (and (= (to_rep5 (select result__4 left_index3)) o22)
  (exists ((temp3 (_ BitVec 8)))
  (and (= temp3 o22)
  (and
  (and (<= (to_rep result____first) right_index3)
  (<= right_index3 (to_rep result____last)))
  (exists ((o23 (_ BitVec 8)))
  (and (= (to_rep5 (select result__4 right_index3)) o23)
  (exists ((o24 octet))
  (and (= (to_rep5 o24) o23)
  (and
  (and (<= (to_rep result____first) left_index3)
  (<= left_index3 (to_rep result____last)))
  (exists ((result__5 (Array Int octet)))
  (and (= result__5 (store result__4 left_index3 o24))
  (exists ((o25 octet))
  (and (= (to_rep5 o25) temp3)
  (and
  (and (<= (to_rep result____first) right_index3)
  (<= right_index3 (to_rep result____last)))
  (and (= result__3 (store result__5 right_index3 o25))
  (let ((o26 (+ left_index3 1)))
  (and (in_range1 o26)
  (exists ((left_index4 Int))
  (and (= left_index4 o26)
  (let ((o27 (- right_index3 1)))
  (and (in_range2 o27)
  (exists ((right_index4 Int))
  (and (= right_index4 o27) (not (< left_index4 right_index4))))))))))))))))))))))))))))))))))))))
  (= result__3 result__2))
  (=> (= start_index2 r16b)
  (=> (dynamic_invariant r16b true false true true)
  (=> (= (- result_index3 1) r17b)
  ...
  (=> (= index temp___385)
  (=>
  (= (and (ite (<= temp___385 index) true false) (ite (<= index temp___386)
                                                 true false)) true)
  (forall ((result__4 (Array Int octet)) (index1 Int))
  (=>
  (= (and (ite (forall ((temp___389 Int))
               (=>
               (and (<= (to_rep result____first) temp___389)
               (<= temp___389 (to_rep result____last)))
               (=>
               (or (< temp___386 temp___389)
               (or (< temp___389 temp___385) (<= index1 temp___389)))
               (= (select result__4 temp___389) (select result__3 temp___389)))))
          true false) (ite (and (<= r16b index1) (<= index1 r17b)) true
                      false)) true)
  (=>
  (and (<= (to_rep result____first) index1)
  (<= index1 (to_rep result____last)))
  (forall ((o18 (_ BitVec 8)))
  (=> (= (to_rep5 (select result__4 index1)) o18)
  (forall ((o19 octet))
  (=> (= (to_rep5 o19) (bvadd o18 #x80))
  (<= (to_rep result____first) index1))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
