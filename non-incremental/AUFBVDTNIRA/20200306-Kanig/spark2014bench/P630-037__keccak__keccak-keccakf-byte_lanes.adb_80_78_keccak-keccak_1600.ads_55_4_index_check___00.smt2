...
;; defqtvc
 ;; File "keccak-keccakf-byte_lanes.ads", line 32, characters 0-0
  (not
  (forall ((spark__branch Bool) (a map1) (x (_ BitVec 8)) (y (_ BitVec 8))
  (remaining_bits Int) (offset Int))
  ...
  (forall ((spark__branch1 Bool) (a1 map1) (x1 (_ BitVec 8))
  (y1 (_ BitVec 8)) (remaining_bits1 Int) (offset1 Int))
  (=>
  ...
  (=> (= spark__branch2 (ite (< 0 remaining_bits1) true false))
  (=> (= spark__branch2 true)
  (forall ((word (_ BitVec 64)))
  (=> (= word #x0000000000000000)
  ...
  (=> (= (- remaining_bytes 1) r47s)
  (=> (dynamic_invariant1 r47s true false true true)
  (forall ((i Int))
  (=> (= i 0)
  (=> (= (and (ite (<= 0 i) true false) (ite (<= i r47s) true false)) true)
  (forall ((word1 (_ BitVec 64)) (i1 Int))
  (=>
  (= (and (ite (dynamic_invariant2 word1 true true true true) true false) 
  (ite (and (<= 0 i1) (<= i1 r47s)) true false)) true)
  (let ((o4 (* i1 8)))
  (=> (in_range1 o4)
  (=> (in_range2 o4)
  (let ((o5 (+ (first1 data) offset1)))
  (=> (in_range1 o5)
  (let ((o6 (+ o5 i1))) (=> (in_range1 o6) (<= (first1 data) o6)))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
