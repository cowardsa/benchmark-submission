...
;; defqtvc
 ;; File "very_longs-divide.adb", line 92, characters 0-0
  ...
  (=> (= overflow_mask1 o1)
  (=> (= (last1 number__split_fields) r124b)
  (=> (in_range2 r124b)
  (let ((temp___1339 r124b))
  (forall ((i Int))
  (=> (= i temp___1339)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1339) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 number__split_fields1) temp___1353)
               (<= temp___1353 (last1 number__split_fields1)))
               (=>
               (or (< temp___1339 temp___1353)
               (or (< temp___1353 1) (<= temp___1353 i1)))
               (= (select (to_array number__split_fields1) temp___1353) (select 
               (to_array number__split_fields) temp___1353))))))
