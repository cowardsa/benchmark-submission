...
(define-fun dynamic_invariant1 ((temp___expr_859 us_rep1)
...
(declare-datatypes ((t99b__ref 0))
(((t99b__refqtmk (t99b__content us_t)))))
...
(define-fun dynamic_invariant2 ((temp___expr_872 us_rep2)
...
;; get_msd__post_axiom
  ...
  (! (and
     ...
     (not
     (= (to_rep2
        (let ((temp___885 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                          (us_split_fields1 number))))
        (select (to_array temp___885) result))) #x00))
     (forall ((i Int))
     (=>
     (and (<= (+ result 1) i)
     (<= i (last1
           ...
           (us_split_fields1 number)))))
     (= (to_rep2
        (let ((temp___886 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                          (us_split_fields1 number))))
        (select (to_array temp___886) i))) #x00))))
...
(define-fun dynamic_invariant4 ((temp___expr_264 (_ BitVec 8))
...
(define-fun dynamic_invariant5 ((temp___expr_852 Int)
  (temp___is_init_848 Bool) (temp___skip_constant_849 Bool)
...
(define-fun dynamic_invariant6 ((temp___expr_440 (_ BitVec 16))
...
(define-fun dynamic_invariant8 ((temp___expr_845 Int)
  (temp___is_init_841 Bool) (temp___skip_constant_842 Bool)
  (temp___do_toplevel_843 Bool)
  (temp___do_typ_inv_844 Bool)) Bool (=>
                                     (or (= temp___is_init_841 true)
                                     (<= first2 last3)) (dynamic_property2
                                     first2 last3 temp___expr_845)))
...
(declare-datatypes ((s134b__ref 0))
(((s134b__refqtmk (s134b__content us_t)))))
(define-fun s134b__ref_s134b__content__projection ((a s134b__ref)) us_t 
  (s134b__content a))

(declare-datatypes ((t137b__ref 0))
(((t137b__refqtmk (t137b__content us_t)))))
(define-fun t137b__ref_t137b__content__projection ((a t137b__ref)) us_t 
  (t137b__content a))

(declare-datatypes ((s138b__ref 0))
(((s138b__refqtmk (s138b__content us_t)))))
(define-fun s138b__ref_s138b__content__projection ((a s138b__ref)) us_t 
  (s138b__content a))

(declare-datatypes ((t141b__ref 0))
(((t141b__refqtmk (t141b__content us_t)))))
...
(define-fun dynamic_invariant10 ((temp___expr_947 us_t)
  (temp___is_init_943 Bool) (temp___skip_constant_944 Bool)
  (temp___do_toplevel_945 Bool)
  (temp___do_typ_inv_946 Bool)) Bool (=>
                                     (not (= temp___skip_constant_944 true))
                                     (and (dynamic_property 1 r135b
                                     (first1 temp___expr_947)
                                     (last1 temp___expr_947))
                                     (and (= (first1 temp___expr_947) 1)
                                     (= (last1 temp___expr_947) r135b)))))

(define-fun default_initial_assumption2 ((temp___expr_949 us_t)
  (temp___skip_top_level_950 Bool)) Bool (and (= (first1 temp___expr_949) 1)
                                         (= (last1 temp___expr_949) r135b)))

(define-fun dynamic_invariant11 ((temp___expr_957 us_t)
  (temp___is_init_953 Bool) (temp___skip_constant_954 Bool)
  (temp___do_toplevel_955 Bool)
  (temp___do_typ_inv_956 Bool)) Bool (=>
                                     (not (= temp___skip_constant_954 true))
                                     (and (dynamic_property 1 r139b
                                     (first1 temp___expr_957)
                                     (last1 temp___expr_957))
                                     (and (= (first1 temp___expr_957) 1)
                                     (= (last1 temp___expr_957) r139b)))))

(define-fun default_initial_assumption3 ((temp___expr_959 us_t)
  (temp___skip_top_level_960 Bool)) Bool (and (= (first1 temp___expr_959) 1)
                                         (= (last1 temp___expr_959) r139b)))
...
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 75, characters 0-0
  ...
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1 divisor))) (to_rep
                                  (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                  remainder__split_discrs)))
  (=>
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1 dividend))) (to_rep
                                   (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                   quotient__split_discrs)))
  (=>
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1 dividend))) (* 2 (to_rep
                                        (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                        (us_split_discrs1 divisor)))))
  ...
  (forall ((ada___ada___aco__math__very_longs__divide__R135b__assume Int))
  (=>
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
  ...
  (= (to_rep2
     (select (to_array
             (rec__ada___ada___aco__math__very_longs__very_long__long_digits
             (us_split_fields1 o4))) i)) #x00))))))
  (let ((o6 (+ o5 1)))
  (=> (in_range2 o6)
  (=> (dynamic_property1 1 last2 o6)
  (forall ((n1 Int))
  (=> (= n1 o6)
  (let ((temp___1386 (- 48 n1)))
  (=> (dynamic_property2 first2 last3 temp___1386)
  (forall ((m1 Int))
  (=> (= m1 temp___1386)
  (let ((temp___1387 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 divisor))))
  (let ((temp___1388 (- n1 1)))
  (=>
  (and (<= (first1 temp___1387) temp___1388)
  (<= temp___1388 (last1 temp___1387)))
  (forall ((o7 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1387) temp___1388)) o7)
  ...
  (=> (= shift_distance1 o8)
  (forall
  ((ada___ada___aco__math__very_longs__divide__full_left_shift__result__fields us_t))
  (=> (dynamic_invariant
  (us_repqtmk u__split_discrs
  (us_split_fieldsqtmk
  ada___ada___aco__math__very_longs__divide__full_left_shift__result__fields))
  true true true true)
  (let ((temp___1389 (of_base
                     (us_repqtmk u__split_discrs
                     (us_split_fieldsqtmk
                     ada___ada___aco__math__very_longs__divide__full_left_shift__result__fields)))))
  (forall ((u__split_fields1 us_t))
  (=>
  (= (us_split_fieldsqtmk1 u__split_fields1) (us_split_fields3 temp___1389))
  (=> (= u__split_discrs (us_split_discrs2 temp___1389))
  (forall ((o9 Int))
  (=>
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1 divisor))) o9)
  (let ((temp___1390 (of_base1 divisor)))
  (forall ((v__split_fields1 us_t))
  (=>
  (= (us_split_fieldsqtmk2 v__split_fields1) (us_split_fields5 temp___1390))
  (=> (= v__split_discrs (us_split_discrs3 temp___1390))
  (forall
  ((ada___ada___aco__math__very_longs__divide__left_shift__number__fields us_t))
  (=> (dynamic_invariant
  (us_repqtmk v__split_discrs
  (us_split_fieldsqtmk
  ada___ada___aco__math__very_longs__divide__left_shift__number__fields))
  true true true true)
  (=>
  ...
  (and
  (and
  (and (dynamic_invariant3 j2 false true true true) (dynamic_invariant6
  q_hat1 false true true true)) (dynamic_invariant
  (us_repqtmk quotient__split_discrs
  ...
  true true true)) (= j2 1)))))))))
  (=> (= n1 r142b)
  (=> (dynamic_invariant7 r142b true false true true)
  (let ((temp___1398 r142b))
  (forall ((divisor_index Int))
  (=> (= divisor_index 1)
  (=>
  (= (and (ite (<= 1 divisor_index) true false) (ite (<= divisor_index temp___1398)
                                                true false)) true)
  ...
  (= (and (ite (and (dynamic_invariant
               ...
               true true)
               (forall ((temp___1405 Int))
               (=>
               (and (<= (first1 remainder__split_fields2) temp___1405)
               (<= temp___1405 (last1 remainder__split_fields2)))
               (=>
               (or (< temp___1398 temp___1405)
               (or (< temp___1405 1) (<= divisor_index1 temp___1405)))
               (= (select (to_array remainder__split_fields2) temp___1405) (select 
               (to_array remainder__split_fields1) temp___1405))))))
          true false) (ite (and (<= 1 divisor_index1)
                           (<= divisor_index1 r142b))
                      true false)) true)
  (=>
  (and (<= (first1 u__split_fields2) divisor_index1)
  (<= divisor_index1 (last1 u__split_fields2)))
  (forall ((o10 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields2) divisor_index1)) o10)
  (forall ((o11 octet))
  (=> (= (to_rep2 o11) o10)
