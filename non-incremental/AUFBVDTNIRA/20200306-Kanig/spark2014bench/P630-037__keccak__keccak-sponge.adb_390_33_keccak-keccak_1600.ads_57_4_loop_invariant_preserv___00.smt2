...
;; defqtvc
 ;; File "keccak-sponge.ads", line 222, characters 0-0
  ...
  (= o12 (to_rep3
         ...
         ctx__split_fields3)))))
  (forall ((o13 Int))
  (=> (= (to_rep digest__last) o13)
  (forall ((o14 Int))
  (=> (= (to_rep digest__first) o14)
  (=> (in_range1 (length o14 o13))
  (=> (in_range1 (+ offset1 remaining1))
  ...
  (and
  (and
  (= (+ offset2 remaining2) (length (to_rep digest__first)
                            (to_rep digest__last)))
  (= (state_of (us_repqtmk ctx__split_fields4)) 1))
  (= (rate_of (us_repqtmk ctx__split_fields4)) initial_rate))
  (=>
  (= (and (ite (and
               (and (dynamic_invariant remaining2 true true true true)
               (and
               (and
               (and
               (and
               ...
               (= (select (rec__ada___keccak__keccak_1600__sponge__context__block
                          ctx__split_fields4) temp___1067) (select (rec__ada___keccak__keccak_1600__sponge__context__block
          ...
          true false) (ite (<= (to_rep6
                               (rec__ada___keccak__keccak_1600__sponge__context__rate
                               ctx__split_fields4)) remaining2)
                      true false)) true)
  (forall ((temp___1076 Int))
  (=> (= temp___1076 offset2)
  (forall ((temp___1075 Int))
  (=> (= temp___1075 remaining2)
  (forall ((o15 Int))
  (=> (= (to_rep digest__first) o15)
  (let ((o16 (+ o15 offset2)))
  (=> (in_range1 o16)
  (=> (= o16 r134s)
  (=> (dynamic_invariant2 r134s true false true true)
  (forall ((o17 Int))
  (=>
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
  ...
  (=> (in_range1 o18)
  (forall ((o19 Int))
  (=> (= (to_rep digest__first) o19)
  (let ((o20 (+ o19 (- o18 1))))
  (=> (in_range1 o20)
  (=> (= o20 r135s)
  (=> (dynamic_invariant2 r135s true false true true)
  (forall ((o21 Int))
  (=>
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields4)) o21)
  (=> (= (- o21 1) r138s)
  (=> (dynamic_invariant2 r138s true false true true)
  (=>
  (=> (<= 0 r138s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r138s) (<= r138s 199))))
  (let ((temp___1048 (of_array
                     (rec__ada___keccak__keccak_1600__sponge__context__block
                     ctx__split_fields4) 0 r138s)))
  (=>
  ...
  (let ((temp___1050 (of_array digest2 r134s r135s)))
  (=>
  ...
  (= (select usf temp___1052) (select digest2 temp___1052))))
  (forall ((digest3 (Array Int byte)))
  (=> (= digest3 usf)
  (forall
  ((ada___keccak__keccak_1600__keccakf_1600_permutation__permute__a map1))
  ...
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields5)) o22)
  (=> (= (- o22 1) r141s)
  (=> (dynamic_invariant2 r141s true false true true)
  (=>
  (=> (<= 0 r141s)
  ...
  (= (select usf1 temp___1060) (select (rec__ada___keccak__keccak_1600__sponge__context__block
                                       ctx__split_fields5) temp___1060))))
  ...
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields6)) o27)
  (let ((o28 (- remaining2 o27)))
  (=> (in_range2 o28)
  (forall ((remaining3 Int))
  (=> (= remaining3 o28)
  (forall ((o29 Int))
  (=>
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields6)) o29)
  (=> (<= o29 remaining3)
  (let ((o30 (us_repqtmk ctx__split_fields6)))
  (let ((o31 (rate_of o30)))
  (=>
  (and (rate_of__function_guard o31 o30)
  ...
  (< o31 1600))))
  (let ((o32 (us_repqtmk ctx__split_fields6)))
  (let ((o33 (state_of o32)))
  (=>
  (and (state_of__function_guard o33 o32)
  (and (dynamic_invariant3 o33 true false true true)
  (= o33 (to_rep3
         (rec__ada___keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields6)))))
  (forall ((o34 Int))
  (=> (= (to_rep digest__last) o34)
  (forall ((o35 Int))
  (=> (= (to_rep digest__first) o35)
  (=> (in_range1 (length o35 o34))
  (=> (in_range1 (+ offset3 remaining3))
