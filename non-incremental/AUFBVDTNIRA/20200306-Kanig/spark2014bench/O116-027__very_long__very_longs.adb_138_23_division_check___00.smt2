...
;; defqtvc
 ;; File "very_longs.ads", line 12, characters 0-0
  ...
  (=> (= index 1)
  (=>
  (= (and (ite (<= 1 index) true false) (ite (<= index temp___894) true
                                        false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___901)
               (<= temp___901 (last1 result____split_fields2)))
               (=>
               (or (< temp___894 temp___901)
               (or (< temp___901 1) (<= index1 temp___901)))
               (= (select (to_array result____split_fields2) temp___901) (select 
