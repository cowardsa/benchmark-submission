...
;; defqtvc
 ;; File "ring_buf.ads", line 38, characters 0-0
  (not
  (forall ((o Int) (o1 (_ BitVec 16)) (o2 Int) (o3 (_ BitVec 16)))
  (=>
  ...
  (=> (not (< 65535 (- (+ (ubv_to_int o1) o) 1)))
  (=>
  (= (to_rep1 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))) o2)
  (=> (uint_in_range o2)
  (=>
  (= (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) o3)
  (forall ((temp___304 (_ BitVec 16)))
  (=>
  (= (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) temp___304)
  (=> (bvule temp___304 (bvsub (bvadd o3 ((_ int_to_bv 16) o2)) #x0001))
