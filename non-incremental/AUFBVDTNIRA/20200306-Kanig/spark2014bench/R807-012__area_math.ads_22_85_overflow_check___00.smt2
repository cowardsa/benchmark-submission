...
;; defqtvc
 ;; File "area_math.ads", line 20, characters 0-0
  ...
  (=>
  (exists ((o1 Int))
  (= (to_rep (rec__area_math__ensemble__size (us_split_fields1 e))) o1))
  (=> (= (to_rep (rec__area_math__ensemble__size (us_split_fields1 e))) o)
  (=>
  (= (and (ite (<= 1 usf) true false) (ite (<= usf (- o 1)) true false)) true)
  (let ((temp___362 (rec__area_math__ensemble__from (us_split_fields1 e))))
  (let ((o1 (+ usf 1)))
  (=> (in_range1 o1)
  (=> (and (<= (first1 temp___362) o1) (<= o1 (last1 temp___362)))
  (forall ((o2 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___362) o1)) o2)
  (let ((temp___361 (rec__area_math__ensemble__to (us_split_fields1 e))))
  (=> (and (<= (first1 temp___361) usf) (<= usf (last1 temp___361)))
  (forall ((o3 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___361) usf)) o3)
  (=> (bvult o3 o2)
  (let ((temp___366 (rec__area_math__ensemble__to (us_split_fields1 e))))
  (=> (and (<= (first1 temp___366) usf) (<= usf (last1 temp___366)))
  (forall ((o4 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___366) usf)) o4) (in_range1
  (+ usf 1))))))))))))))))))))))))))
(check-sat)
(exit)
