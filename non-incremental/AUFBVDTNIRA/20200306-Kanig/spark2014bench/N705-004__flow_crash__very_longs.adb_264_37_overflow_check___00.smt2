...
;; defqtvc
 ;; File "very_longs.ads", line 53, characters 0-0
  ...
  (let ((temp___1088 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1088) i1) (<= i1 (last1 temp___1088)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1088) i1)) o2)
  (forall ((l_digit3 (_ BitVec 16)))
  (=> (= l_digit3 ((_ zero_extend 8) o2))
  (let ((temp___1089 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1089) j1) (<= j1 (last1 temp___1089)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1089) j1)) o3)
  (forall ((r_digit3 (_ BitVec 16)))
  (=> (= r_digit3 ((_ zero_extend 8) o3))
  (=> (= (last1 result____split_fields3) r84b)
  (=> (in_range2 r84b)
  (let ((o4 (+ i1 j1)))
  (=> (in_range2 o4)
  ...
  (=>
  (and (<= (first1 result____split_fields3) temp___1091)
  (<= temp___1091 (last1 result____split_fields3)))
  (forall ((o6 (_ BitVec 8)))
  (=>
  (= (to_rep2 (select (to_array result____split_fields3) temp___1091)) o6)
