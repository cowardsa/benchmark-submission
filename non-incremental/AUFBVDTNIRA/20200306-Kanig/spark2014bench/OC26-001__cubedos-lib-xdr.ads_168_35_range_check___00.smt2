...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 154, characters 0-0
  (not
  (forall ((last4 Int) (o Bool) (o1 Int))
  ...
  (exists ((o4 Bool))
  (and
  (ite (= (mod1 position 4) 0)
  (exists ((o5 Int))
  (and (= (to_rep1 data__last) o5)
  (exists ((o6 Int))
  (and (= (to_rep1 data__first) o6)
  (= o4 (ite (< 0 (length o6 o5)) true false)))))) (= o4 false))
  (ite (= o4 true)
  (exists ((o5 Int))
  (and (= (to_rep1 data__last) o5)
  (exists ((o6 Int))
  (and (= (to_rep1 data__first) o6)
  (= o3 (ite (= (mod1 (length o6 o5) 4) 0) true false)))))) (= o3 false))))
  (ite (= o3 true)
  (let ((o4 (length1 value)))
  (and (in_range1 o4) (= o2 (ite (<= o4 65536) true false)))) (= o2 false))))
  (ite (= o2 true)
  (exists ((o3 Int))
  (and (= (to_rep1 data__last) o3)
  (exists ((o4 Int))
  (and (= (to_rep1 data__first) o4)
  (= o (and (ite (<= o4 position) true false) (ite (<= position o3) true
                                              false)))))))
  (= o false))))
  (=> (= o true)
  (=> (= (to_rep1 data__last) o1)
  (let ((o2 (- o1 position)))
  (=> (in_range1 o2) (=> (in_range1 (+ o2 1)) (in_range4 (length1 value)))))))))))))))
(check-sat)
(exit)
