...
;; to_model__post_axiom
  ...
  (! (let ((result (to_model r)))
     (=> (to_model__function_guard result r) (dynamic_invariant result true
...
(declare-fun temp_____aggregate_def_254 (Int) (Array (_ BitVec 16) integer))

(declare-fun temp_____aggregate_def_325 (Int) (Array (_ BitVec 16) integer))
...
;; def_axiom
  ...
  (=> (dynamic_invariant1 temp___327 true true true true)
  (forall ((temp___328 (_ BitVec 16)))
...
(assert
;; defqtvc
 ;; File "ring_buf.ads", line 58, characters 0-0
  (not
  (forall ((r__split_fields us_split_fields)
  (r__split_fields1 us_split_fields) (o ar_index)
  (r__split_fields2 us_split_fields) (r__split_fields3 us_split_fields))
  (=>
  ...
  (= r__split_fields2 (us_split_fieldsqtmk
                      (rec__ring_buf__ring_buffer__data r__split_fields1) o
                      (rec__ring_buf__ring_buffer__length r__split_fields1)))
  (=>
  (= r__split_fields3 (us_split_fieldsqtmk (temp_____aggregate_def_325 0)
  ...
  (= (let ((temp___339 (to_model (us_repqtmk r__split_fields3))))
     (bool_eq (to_array temp___339) (first1 temp___339) (last1 temp___339)
     (temp_____aggregate_def_254 0) #x0001 #x0000)) true)))))))))
(check-sat)
(exit)
