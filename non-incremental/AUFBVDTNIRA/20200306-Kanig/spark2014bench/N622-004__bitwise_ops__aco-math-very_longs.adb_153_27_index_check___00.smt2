 ...
 ;; File "aco-math-very_longs.ads", line 32, characters 0-0
  ...
  (= (and (ite true true false) (ite (and (<= 1 i1)
                                     (<= i1 (last1
                                            ...
                                            (us_split_fields1 l)))))
                                true false)) true)
  (let ((temp___1147 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1147) i1) (<= i1 (last1 temp___1147)))
  (forall ((o (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1147) i1)) o)
  (let ((temp___1146 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1146) i1) (<= i1 (last1 temp___1146)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1146) i1)) o1)
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (bvult o1 o) true false))
  (=> (not (= spark__branch true))
  (let ((temp___1150 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1150) i1) (<= i1 (last1 temp___1150)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1150) i1)) o2)
  (<= (first1
      (rec__ada___ada___aco__math__very_longs__very_long__long_digits
