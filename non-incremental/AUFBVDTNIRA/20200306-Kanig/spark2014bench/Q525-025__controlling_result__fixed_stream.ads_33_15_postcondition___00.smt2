...
;; defqtvc
 ;; File "fixed_stream.ads", line 30, characters 0-0
  ...
  (= (last1 temp___292) (to_rep
                        ...
                        (us_split_fields1 this))))
  (=>
  (ite (<= (first1 temp___292) (last1 temp___292))
  (and
  (<= 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))))
  (= (- (last1 temp___292) (first1 temp___292)) (- (to_rep
                                                   (rec__fixed_stream__object__width
                                                   (us_split_fields1 this))) 1)))
  (< (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))) 1))
  (let ((fixed_stream__null_string__value__assume (of_array
                                                  (to_array temp___292)
                                                  (first1 temp___292)
                                                  (last1 temp___292))))
  (forall ((value (Array Int stream_element)))
  (=> (= value (to_array fixed_stream__null_string__value__assume))
  (=>
  (= (to_rep2 value__first) (first1 fixed_stream__null_string__value__assume))
  (=>
  (= (to_rep2 value__last) (last1 fixed_stream__null_string__value__assume))
  (=>
  (and (dynamic_property 1
  ...
  (forall ((fixed_stream__null_string__result us_t))
  (=> (= fixed_stream__null_string__result (of_array value o2 o1))
  (=> (elements__function_guard (elements this) this)
  (= (length fixed_stream__null_string__result) (elements this)))))))))))))))))))))))
(check-sat)
(exit)
