...
;; defqtvc
 ;; File "communications.ads", line 14, characters 0-0
  (not
  (forall ((self__ us_split_fields) (o Int) (spark__branch Bool) (o1 integer)
  (o2 (_ BitVec 8)) (self__1 us_split_fields) (o3 (_ BitVec 8))
  (o4 message_index) (self__2 us_split_fields) (o5 Int))
  (=> (dynamic_invariant n true false true true)
  (=> (= (to_rep2 (rec__communications__mailboxT__count self__)) o)
  (=> (= spark__branch (ite (< o 16) true false))
  (=> (= spark__branch true)
  (=> (= (to_rep o1) n)
  (=> (= (to_rep1 (rec__communications__mailboxT__next_in self__)) o2)
  (=>
  ...
  (=> (= (to_rep1 (rec__communications__mailboxT__next_in self__1)) o3)
  (=> (= (to_rep1 o4) (bvurem (bvadd o3 #x01) #x10))
  (=>
  (= self__2 (us_split_fieldsqtmk
             (rec__communications__mailboxT__messages self__1) o4
             (rec__communications__mailboxT__next_out self__1)
             (rec__communications__mailboxT__count self__1)))
