...
(define-fun to_int3 ((x byte)) Int (ubv_to_int (to_rep x)))
...
(define-fun to_int4 ((x address)) Int (ubv_to_int (to_rep1 x)))
...
;; defqtvc
 ;; File "memassign2.adb", line 11, characters 0-0
  (not
  (forall ((mem (Array (_ BitVec 64) byte)))
  (=> (dynamic_invariant dest true false true true)
  (=> (dynamic_invariant src true false true true)
  (=> (bvugt (bvsub #xFFFFFFFFFFFFFFFF dest) #x0000000000000000)
  ...
  (let ((temp___202 (bvadd src #x0000000000000001)))
  (=>
  ...
  (let ((temp___203 (of_array mem src temp___202)))
  (=>
  (ite (bvule (first1 temp___203) (last1 temp___203))
  (and (bvule dest (bvadd dest #x0000000000000001))
  (= (bvsub (last1 temp___203) (first1 temp___203)) (bvsub (bvadd dest #x0000000000000001) 
  dest))) (bvult (bvadd dest #x0000000000000001) dest))
  (let ((temp___204 (of_array
                    (slide (to_array temp___203) (first1 temp___203) dest)
                    dest (bvadd dest #x0000000000000001))))
  (let ((temp___205 (bvadd dest #x0000000000000001)))
  (=>
  (=> (bvule dest temp___205)
  (and (and (bvule #x0000000000000000 dest) (bvule dest #xFFFFFFFFFFFFFFFF))
  (and (bvule #x0000000000000000 temp___205)
  (bvule temp___205 #xFFFFFFFFFFFFFFFF))))
  (let ((temp___206 (of_array mem dest temp___205)))
  (=> (bvule (first1 temp___204) (last1 temp___204))
  (bvule (first1 temp___206) (last1 temp___206))))))))))))))))))))
(check-sat)
(exit)
