...
(define-fun to_int2 ((x byte)) Int (ubv_to_int (to_rep x)))
...
;; defqtvc
 ;; File "untangle.adb", line 38, characters 0-0
  (not
  (forall ((x__split_fields us_split_fields2) (x__split_discrs Bool))
  (=> (dynamic_invariant n true false true true)
  (untangle__optional_thing__t__pred
  (us_repqtmk2 (us_split_discrsqtmk x__split_discrs)
  (us_split_fieldsqtmk2 (us_repqtmk1 x__split_fields))))))))
(check-sat)
(exit)
