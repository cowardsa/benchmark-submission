...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 21, characters 0-0
  (not
  ...
  (let ((temp___966 (last1
                    (rec__very_longs__very_long__long_digits
                    (us_split_fields1 l)))))
  (forall ((i Int))
  (=> (= i temp___966)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___966) true false)) true)
  (forall ((i1 Int))
  (=>
  ...
  (let ((temp___969 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 r))))
  (=> (and (<= (first1 temp___969) i1) (<= i1 (last1 temp___969)))
  (forall ((o (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___969) i1)) o)
  (let ((temp___968 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 l))))
  (=> (and (<= (first1 temp___968) i1) (<= i1 (last1 temp___968)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___968) i1)) o1)
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (bvult o1 o) true false))
  (=> (not (= spark__branch true))
  (let ((temp___972 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 r))))
  (=> (and (<= (first1 temp___972) i1) (<= i1 (last1 temp___972)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___972) i1)) o2)
