...
;; defqtvc
 ;; File "very_longs.adb", line 362, characters 0-0
  ...
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1340) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields3) temp___1353)
               (<= temp___1353 (last1 result____split_fields3)))
               (=>
               (or (< temp___1340 temp___1353)
               (or (< temp___1353 1) (<= i1 temp___1353)))
               (= (select (to_array result____split_fields3) temp___1353) (select 
  ...
  (and (= (to_rep2 (select (to_array temp___1341) i1)) o2)
  ...
  (and (= old_overflow1 new_overflow2) (= i1 temp___1340))))))))))))))))))))))))))))
