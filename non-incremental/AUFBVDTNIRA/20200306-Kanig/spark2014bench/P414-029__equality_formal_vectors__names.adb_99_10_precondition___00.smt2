...
(declare-fun user_eq6 (capacity_range1 capacity_range1) Bool)

(declare-const dummy6 capacity_range1)
...
(declare-fun to_string (Int us_split_fields2 us_split_fields) us_t)

(declare-fun to_string__function_guard (us_t Int us_split_fields2
...
(define-fun in_range6 ((rec__names__char_tables__vector__capacity1 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_415 us_rep)
...
;; range_axiom
  (assert
  (forall ((x capacity_range1)) (! (in_range5
...
(define-fun in_range7 ((rec__names__entry_tables__vector__capacity1 Int)
  (a us_split_discrs2)) Bool (= rec__names__entry_tables__vector__capacity1 
  (to_rep4 (rec__names__entry_tables__vector__capacity a))))
...
(define-fun dynamic_invariant2 ((temp___expr_613 us_rep1)
...
;; to_string__post_axiom
  ...
  (! (and (invariant____function_guard (invariant__ Tuple0) Tuple0)
     (=>
     (and
     (and
     (and (dynamic_invariant3 n true true true true) (dynamic_invariant2
     (us_repqtmk1 entry_table__split_discrs names__entry_table__fields) true
     true true true)) (dynamic_invariant1
     (us_repqtmk char_table__split_discrs names__char_table__fields) true
     true true true)) (= (invariant__ Tuple0) true))
     (let ((result (to_string n names__entry_table__fields
                   names__char_table__fields)))
     (=> (to_string__function_guard result n names__entry_table__fields
     names__char_table__fields) (dynamic_invariant result true false true
     true))))) :pattern ((to_string n names__entry_table__fields
                         names__char_table__fields)) )))))
...
(define-fun bool_eq2 ((a (Array (_ BitVec 32) name_id))
  ...
  (b__last (_ BitVec 32))) Bool (ite (and
                                     ...
                                     (= (to_rep5 (select a temp___idx_156)) 
                                     (to_rep5
...
(define-fun element_type__ref_element_type__content__3__projection ((a element_type__ref)) us_rep3 
...
(define-fun last3 ((container us_rep4)) Int (+ 0 (length4 container)))
...
(define-fun last_index1 ((container us_rep1)) Int (last3 (model2 container)))
...
(define-fun dynamic_invariant6 ((temp___expr_452 Int)
...
(define-fun element_type__ref_element_type__content__4__projection ((a element_type__ref1)) us_rep3 
...
(define-fun element ((container us_rep1)
  (index Int)) us_rep3 (get1 (model2 container) index))
...
(declare-fun user_eq17 (hash_type hash_type) Bool)

(declare-const dummy17 hash_type)
...
(define-fun dynamic_invariant7 ((temp___expr_313 (_ BitVec 32))
  (temp___is_init_309 Bool) (temp___skip_constant_310 Bool)
  (temp___do_toplevel_311 Bool) (temp___do_typ_inv_312 Bool)) Bool true)

;; hash__post_axiom
  (assert
  (forall ((key us_t))
  (! (=> (dynamic_invariant key true true true true) (dynamic_invariant7
...
(declare-fun user_eq18 (valid_name_id valid_name_id) Bool)

(declare-const dummy18 valid_name_id)
...
(declare-fun user_eq19 (hash_table_index_t hash_table_index_t) Bool)

(declare-const dummy19 hash_table_index_t)
...
(define-fun dynamic_invariant8 ((temp___expr_320 (_ BitVec 32))
...
(define-fun in_range14 ((x Int)) Bool (and (<= (- 2147483648) x)
                                      (<= x 2147483647)))
...
(declare-fun user_eq20 (tchar_table_indexB tchar_table_indexB) Bool)

(declare-const dummy20 tchar_table_indexB)
...
(define-fun dynamic_invariant9 ((temp___expr_46 Int) (temp___is_init_42 Bool)
...
(define-fun dynamic_invariant10 ((temp___expr_74 Int)
  (temp___is_init_70 Bool) (temp___skip_constant_71 Bool)
  (temp___do_toplevel_72 Bool)
  (temp___do_typ_inv_73 Bool)) Bool (=>
                                    (or (= temp___is_init_70 true)
                                    (<= 0 255)) (in_range2 temp___expr_74)))

(define-fun dynamic_invariant11 ((temp___expr_18 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_306 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_337 Int)
...
(define-fun dynamic_invariant14 ((temp___expr_365 Int)
...
(define-fun default_initial_assumption2 ((temp___expr_407 us_rep2)
  (temp___skip_top_level_408 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_408 true))
                                         (= (length2 temp___expr_407) 0)))
...
(define-fun dynamic_invariant15 ((temp___expr_399 Int)
...
(define-fun element_type__ref_element_type__content__2__projection ((a element_type__ref2)) element_type 
  (element_type__content2 a))

(define-fun dynamic_invariant16 ((temp___expr_392 Int)
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant16 (get container position) true false true true)) :pattern (
...
;; model__post_axiom
  (assert
  (forall ((container us_rep1))
  (! (= (length4 (model2 container)) (length5 container)) :pattern ((model2
                                                                    container)) )))
...
;; defqtvc
 ;; File "names.ads", line 9, characters 0-0
  (not
  (forall ((n Int) (char_table__split_fields us_main_type)
  (entry_table__split_fields us_main_type1)
  (hash_table (Array (_ BitVec 32) name_id)) (ptr Int))
  (=> (dynamic_invariant1
  (us_repqtmk char_table__split_discrs
  (us_split_fieldsqtmk char_table__split_fields)) true false true true)
  (=> (dynamic_invariant2
  (us_repqtmk1 entry_table__split_discrs
  (us_split_fieldsqtmk1 entry_table__split_fields)) true false true true)
  (=> (dynamic_invariant s true false true true)
  (=> (dynamic_invariant3 n false false true true)
  (=> (invariant____function_guard (invariant__ Tuple0) Tuple0)
  (=> (= (invariant__ Tuple0) true)
  (=> (= ptr 0)
  (=> (dynamic_invariant3 ptr true false true true)
  (let ((o (hash s)))
  (=> (dynamic_invariant7 o true false true true)
  (let ((o1 (bvurem o #x00000100)))
  (=> (in_range13 o1)
  (=> (= o1 h)
  (=> (dynamic_invariant8 h true false true true)
  ...
  (and (= spark__branch2 (ite (in_range12 n1) true false))
  (ite (= spark__branch2 true)
  (exists ((ptr2 Int))
  (and (= ptr2 n1)
  (exists ((ptr3 Int))
  (and
  (and (dynamic_invariant3 ptr3 true true true true) (dynamic_invariant3 n1
  false true true true))
  (let ((temp___657 (to_string ptr3
                    (us_split_fieldsqtmk1 entry_table__split_fields)
                    (us_split_fieldsqtmk char_table__split_fields))))
  (and
  (and (to_string__function_guard temp___657 ptr3
  (us_split_fieldsqtmk1 entry_table__split_fields)
  (us_split_fieldsqtmk char_table__split_fields)) (dynamic_invariant
  temp___657 true false true true))
  (and
  (= spark__branch1 (bool_eq (to_array temp___657) (first1 temp___657)
                    (last1 temp___657) (to_array s) (first1 s) (last1 s)))
  (and (not (= spark__branch1 true))
  (and (in_range15 ptr3)
  (let ((o3 (us_repqtmk1 entry_table__split_discrs
            (us_split_fieldsqtmk1 entry_table__split_fields))))
  (let ((o4 (element o3 ptr3)))
  (and (= (bool_eq4 o4 (get1 (model2 o3) ptr3)) true)
  (exists ((o5 Int))
  (and
  (= (to_rep5 (rec__names__name_entry__next_hash (us_split_fields5 o4))) o5)
  (and (= o5 0) (= ptr1 ptr3))))))))))))))))
  (and (= spark__branch1 spark__branch2) (= ptr1 ptr)))))
  (forall ((char_table__split_fields1 us_main_type))
  (=>
  (let ((temp___660 (first1 s)))
  (let ((temp___661 (last1 s)))
  (exists ((c330b Int))
  (and (= c330b temp___660)
  (ite (= (and (ite (<= temp___660 c330b) true false) (ite (<= c330b temp___661)
                                                      true false)) true)
  (exists ((char_table__split_fields2 us_main_type) (c330b1 Int))
  (and
  (= (and (ite (dynamic_invariant1
          (us_repqtmk char_table__split_discrs
          (us_split_fieldsqtmk char_table__split_fields2)) true true true
          true) true false) (ite (and (<= (first1 s) c330b1)
                                 (<= c330b1 (last1 s)))
                            true false)) true)
  (exists ((o3 Int))
  (and (= (to_rep1 (select (to_array s) c330b1)) o3)
  (let ((o4 char_table__split_discrs))
  (exists ((names__char_tables__append__2__container__fields us_main_type))
  (and
  (and
  (and
  (= (length1
     (us_repqtmk o4
     (us_split_fieldsqtmk names__char_tables__append__2__container__fields))) (+ 
  (length1 (us_repqtmk o4 (us_split_fieldsqtmk char_table__split_fields2))) 1))
  (= (olt
     (model1 (us_repqtmk o4 (us_split_fieldsqtmk char_table__split_fields2)))
     (model1
     (us_repqtmk o4
     (us_split_fieldsqtmk names__char_tables__append__2__container__fields)))) true))
  (= (get
     (model1
     (us_repqtmk o4
     (us_split_fieldsqtmk names__char_tables__append__2__container__fields)))
     (+ (last_index
        (us_repqtmk o4 (us_split_fieldsqtmk char_table__split_fields2))) 1)) o3))
  (and
  (= char_table__split_fields1 names__char_tables__append__2__container__fields)
  (= c330b1 temp___661)))))))))
  (= char_table__split_fields1 char_table__split_fields))))))
  (=>
  (= (last_index
     (us_repqtmk char_table__split_discrs
     (us_split_fieldsqtmk char_table__split_fields1))) (- (length1
                                                          (us_repqtmk
  ...
  (<= (last_index
      (us_repqtmk char_table__split_discrs
      (us_split_fieldsqtmk char_table__split_fields1))) 2147483646)
  (let ((o3 (length s)))
  (=> (in_range1 o3)
  (forall ((o4 positive))
  (=> (= (to_rep o4) o3)
  (let ((o5 (length s)))
  (=> (in_range14 o5)
  (let ((o6 (us_repqtmk char_table__split_discrs
            (us_split_fieldsqtmk char_table__split_fields1))))
  (let ((o7 (last_index o6)))
  (=>
  (and (dynamic_invariant5 o7 true false true true)
  (= o7 (last2 (model1 o6))))
  (let ((o8 (- o7 (- o5 1))))
  (=> (in_range14 o8)
  (=> (in_range10 o8)
  (forall ((o9 char_table_index))
  (=> (= (to_rep6 o9) o8)
  (let ((o10 entry_table__split_discrs))
  (forall ((names__entry_tables__append__2__container__fields us_main_type1))
  (=>
  (and
  (and
  (= (length5
     (us_repqtmk1 o10
     (us_split_fieldsqtmk1 names__entry_tables__append__2__container__fields))) (+ 
  (length5
  (us_repqtmk1 o10 (us_split_fieldsqtmk1 entry_table__split_fields))) 1))
  (= (olt1
     (model2
     (us_repqtmk1 o10 (us_split_fieldsqtmk1 entry_table__split_fields)))
     (model2
     (us_repqtmk1 o10
     (us_split_fieldsqtmk1 names__entry_tables__append__2__container__fields)))) true))
  (= (bool_eq4
     (get1
     (model2
     (us_repqtmk1 o10
     ...
     (+ (last_index1
        (us_repqtmk1 o10 (us_split_fieldsqtmk1 entry_table__split_fields))) 1))
     (us_repqtmk2 (us_split_fieldsqtmk2 o9 o4 rliteral))) true))
  (forall ((entry_table__split_fields1 us_main_type1))
  (=>
  (= entry_table__split_fields1 names__entry_tables__append__2__container__fields)
  (let ((o11 (us_repqtmk1 entry_table__split_discrs
             (us_split_fieldsqtmk1 entry_table__split_fields1))))
  (let ((o12 (last_index1 o11)))
  (=>
  (and (dynamic_invariant6 o12 true false true true)
  (= o12 (last3 (model2 o11))))
  (forall ((n2 Int))
  (=> (= n2 o12)
  (forall ((spark__branch2 Bool))
  (=> (= spark__branch2 (ite (in_range12 ptr1) true false))
  (=> (= spark__branch2 true)
  (=> (in_range15 ptr1)
  (let ((o13 (us_repqtmk1 entry_table__split_discrs
             (us_split_fieldsqtmk1 entry_table__split_fields1))))
  (=> (= (bool_eq4 (element o13 ptr1) (get1 (model2 o13) ptr1)) true)
  (forall ((o14 name_id))
  (=> (= (to_rep5 o14) n2) (=> (in_range15 ptr1) (<= 1 ptr1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
