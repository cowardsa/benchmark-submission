...
;; defqtvc
 ;; File "find_map.ads", line 26, characters 0-0
  ...
  (=> (= k temp___855)
  (=>
  (= (and (ite (<= temp___855 k) true false) (ite (<= k (last1 a)) true
                                             false)) true)
  ...
  (let ((o2 (us_repqtmk result____split_discrs
            (us_split_fieldsqtmk result____split_fields2))))
  (let ((o3 (contains o2 usf)))
  (=> (= (= o3 true) (= (has_key (model1 o2) usf) true))
  (=> (= o3 true)
  (let ((o4 (us_repqtmk result____split_discrs
            (us_split_fieldsqtmk result____split_fields2))))
  (let ((temp___861 (element o4 usf)))
  (=>
  (and (dynamic_invariant2 temp___861 true false true true)
  (= temp___861 (get (model1 o4) usf)))
  (=>
  (= (and (ite (<= (first1 a) temp___861) true false) (ite (<= temp___861 k)
                                                      true false)) true)
  (let ((o5 (us_repqtmk result____split_discrs
            (us_split_fieldsqtmk result____split_fields2))))
  (let ((temp___862 (element o5 usf)))
  (=>
  (and (dynamic_invariant2 temp___862 true false true true)
  (= temp___862 (get (model1 o5) usf))) (<= (first1 a) temp___862))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
