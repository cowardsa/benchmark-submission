...
(define-fun to_int3 ((x storage_element)) Int (ubv_to_int (to_rep x)))
...
;; defqtvc
 ;; File "linted-controls.ads", line 37, characters 0-0
  ...
  (let ((o9 (ubv_to_int x2))) (and (in_range1 o9) (= y2 o9)))
  (let ((o9 (ubv_to_int (bvnot x2))))
  (and (in_range1 o9)
  (let ((o10 (- (- o9) 1))) (and (in_range2 o10) (= y2 o10))))))
  (=> (= (to_rep1 o4) y2)
  ...
  (=> (=> (<= 5 8) (and (and (<= 1 5) (<= 5 9)) (and (<= 1 8) (<= 8 9))))
  (=> (= (to_rep (select (slide s 5 1) 1)) o5)
  (=> (=> (<= 5 8) (and (and (<= 1 5) (<= 5 9)) (and (<= 1 8) (<= 8 9))))
  (=> (= (to_rep (select (slide s 5 1) 2)) o6)
  (=> (=> (<= 5 8) (and (and (<= 1 5) (<= 5 9)) (and (<= 1 8) (<= 8 9))))
  (=> (= (to_rep (select (slide s 5 1) 3)) o7)
  (=> (=> (<= 5 8) (and (and (<= 1 5) (<= 5 9)) (and (<= 1 8) (<= 8 9))))
  ...
  (=> (= spark__branch1 true) (in_range1 (ubv_to_int x3))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
