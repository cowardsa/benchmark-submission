...
(define-fun to_int2 ((x word32)) Int (ubv_to_int (to_rep1 x)))
...
(((t5b__refqtmk (t5b__content tindexB)))))
...
;; defqtvc
 ;; File "test.ads", line 17, characters 0-0
  (not
  (forall ((result__ (Array Int word32)) (temp___253 Int) (temp___254 Int)
  (i Int) (o (_ BitVec 32)) (o1 (_ BitVec 32)))
  ...
  (=> (= (to_rep result____first) temp___253)
  (=> (= (to_rep result____last) temp___254)
  (=> (= i temp___253)
  (=>
  ...
  (=> (<= (first1 right) i)
  (=> (<= i (last1 right))
  (=> (= (to_rep1 (select (to_array right) i)) o)
  (=> (<= (first1 left) i)
  (=> (<= i (last1 left))
  (=> (= (to_rep1 (select (to_array left) i)) o1)
  (let ((o2 (xor2 o1 o)))
  (=>
  ...
  (forall ((o3 word32))
  (=> (= (to_rep1 o3) o2)
  (forall ((result__1 (Array Int word32)))
  (=> (= result__1 (store result__ i o3))
  (=> (exists ((o4 Int)) (= (to_rep result____first) o4))
  (forall ((result__2 (Array Int word32)) (i1 Int))
  (=>
  ...
  (=>
  (forall ((pos Int))
  (=> (and (<= (to_rep result____first) pos) (<= pos i1))
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (to_rep result____first) temp___257)
               (<= temp___257 (to_rep result____last)))
               (=>
               (or (< temp___254 temp___257)
               (or (< temp___257 temp___253) (< i1 temp___257)))
               (= (select result__2 temp___257) (select result__ temp___257)))))
               (dynamic_property1 (to_rep result____first)
               (to_rep result____last) i1))
          true false) (ite (and (<= (to_rep result____first) i1)
                           (<= i1 (to_rep result____last)))
                      true false)) true)
  (=> (not (= i1 temp___254))
  (forall ((i2 Int))
  (=> (= i2 (+ i1 1))
  (=> (and (<= (first1 right) i2) (<= i2 (last1 right)))
  (forall ((o4 (_ BitVec 32)))
  (=> (= (to_rep1 (select (to_array right) i2)) o4)
  (=> (and (<= (first1 left) i2) (<= i2 (last1 left)))
  (forall ((o5 (_ BitVec 32)))
  (=> (= (to_rep1 (select (to_array left) i2)) o5)
  (let ((o6 (xor2 o5 o4)))
  (=>
  (and (xor2__function_guard o6 o5 o4)
  (and (dynamic_invariant o6 true false true true) (= o6 (bvxor o5 o4))))
  (forall ((o7 word32))
  (=> (= (to_rep1 o7) o6)
  (forall ((result__3 (Array Int word32)))
  (=> (= result__3 (store result__2 i2 o7))
  (=> (exists ((o8 Int)) (= (to_rep result____first) o8))
  (forall ((pos Int))
  (=> (and (<= (to_rep result____first) pos) (<= pos i2))
  (=>
  (forall ((pos1 Int)) (xor2__function_guard
  (xor2 (to_rep1 (select (to_array left) pos1))
  (to_rep1 (select (to_array right) pos1)))
  (to_rep1 (select (to_array left) pos1))
  (to_rep1 (select (to_array right) pos1))))
