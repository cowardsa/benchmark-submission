...
(define-fun to_int2 ((x byte)) Int (ubv_to_int (to_rep2 x)))
...
(declare-fun encode (us_t1) us_t)

(declare-fun encode__function_guard (us_t us_t1) Bool)
...
(((tbS__refqtmk (tbS__content us_t1)))))
(define-fun tbS__ref_tbS__content__projection ((a tbS__ref)) us_t1 (tbS__content
                                                                   a))

(define-fun dynamic_invariant2 ((temp___expr_200 us_t1)
...
(define-fun dynamic_predicate1 ((temp___203 us_t1)) Bool (= (mod2
                                                            (length2
                                                            temp___203) 5) 0))

(define-fun dynamic_invariant3 ((temp___expr_271 us_t1)
  (temp___is_init_267 Bool) (temp___skip_constant_268 Bool)
  (temp___do_toplevel_269 Bool)
  (temp___do_typ_inv_270 Bool)) Bool (and
                                     (=>
                                     (not (= temp___skip_constant_268 true))
                                     (and (dynamic_property1 1 (length1 s)
                                     (first3 temp___expr_271)
                                     (last3 temp___expr_271))
                                     (and (= (first3 temp___expr_271) 1)
                                     (= (last3 temp___expr_271) (length1 s)))))
                                     (=> (= temp___do_toplevel_269 true)
                                     (=> (= temp___is_init_267 true)
                                     (= (mod2 (length2 temp___expr_271) 5) 0)))))

(define-fun default_initial_assumption ((temp___expr_274 us_t1)
  (temp___skip_top_level_275 Bool)) Bool (and (= (first3 temp___expr_274) 1)
                                         (= (last3 temp___expr_274) (length1
                                                                    s))))

(define-fun dynamic_predicate2 ((temp___278 us_t1)) Bool (= (mod2
                                                            (length2
                                                            temp___278) 5) 0))
...
(define-fun dynamic_invariant7 ((temp___expr_173 (_ BitVec 8))
...
(assert
;; defqtvc
 ;; File "base32.ads", line 68, characters 0-0
  (not
  (forall ((b (Array Int byte)) (b1 (Array Int byte)) (o Int) (o1 Int))
  (=> (dynamic_invariant s true false true true)
  (=> (= (mod2 (length1 s) 5) 0)
  (=> (< (length1 s) 268435455)
  (=> (default_initial_assumption
  (of_array1 b (to_rep1 b__first) (to_rep1 b__last)) false)
  (=>
  (and (dynamic_property1 1 (length1 s) (to_rep1 b__first) (to_rep1 b__last))
  (and (= (to_rep1 b__first) 1) (= (to_rep1 b__last) (length1 s))))
  (=>
  (exists ((temp___297 Int))
  (and (= (to_rep1 b__last) temp___297)
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___297) true false)) true)
  (exists ((b2 (Array Int byte)) (i1 Int))
  (and
  (= (and (ite (forall ((temp___304 Int))
               (=>
               (and (<= (to_rep1 b__first) temp___304)
               (<= temp___304 (to_rep1 b__last)))
               (=>
               (or (< temp___297 temp___304)
               (or (< temp___304 1) (<= i1 temp___304)))
               (= (select b2 temp___304) (select b temp___304)))))
          true false) (ite (and (<= 1 i1) (<= i1 (to_rep1 b__last))) true
                      false)) true)
  (let ((o2 (+ (first1 s) (- i1 1))))
  (and (in_range1 o2)
  (and (and (<= (first1 s) o2) (<= o2 (last1 s)))
  (exists ((o3 Int))
  (and (= (to_rep (select (to_array s) o2)) o3)
  (exists ((o4 byte))
  (and (= (to_rep2 o4) ((_ int_to_bv 8) o3))
  (and (and (<= (to_rep1 b__first) i1) (<= i1 (to_rep1 b__last)))
  (and (= (mod2 (length (to_rep1 b__first) (to_rep1 b__last)) 5) 0)
  (and (= b1 (store b2 i1 o4)) (= i1 temp___297))))))))))))) (= b1 b))))))
