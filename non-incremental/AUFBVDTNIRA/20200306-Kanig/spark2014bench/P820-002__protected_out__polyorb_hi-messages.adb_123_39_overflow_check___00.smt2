...
;; defqtvc
 ;; File "polyorb_hi-messages.ads", line 75, characters 0-0
  (not
  (forall ((stream__split_fields us_split_fields) (last2 Int))
  (=> (dynamic_property (- 9223372036854775808) 9223372036854775807
  ...
  (let ((o (us_repqtmk stream__split_fields)))
  (let ((o1 (length1 o)))
  (=>
  ...
  (=> (in_range4 o5)
  (=> (= o5 read_elts)
  (=> (dynamic_invariant2 read_elts true false true true)
  (forall ((o6 Int))
  (=> (= (to_rep2 item__last) o6)
  (forall ((o7 Int))
  (=> (= (to_rep2 item__first) o7)
  (let ((temp___475 (temp_____aggregate_def_469 #x00 o7 o6)))
  (=> (= (first1 temp___475) (to_rep2 item__first))
  (=> (= (last1 temp___475) (to_rep2 item__last))
  (let ((temp___477 (of_array (to_array temp___475) (first1 temp___475)
                    (last1 temp___475))))
  (=>
  ...
  (forall ((o8 Int))
  (=> (= (to_rep2 item__first) o8)
  (forall ((item (Array Int stream_element)))
  (=> (= item (slide (to_array temp___477) (first1 temp___477) o8))
  (forall ((spark__branch Bool) (last3 Int))
  (=>
  (exists ((spark__branch1 Bool))
  (and (= spark__branch1 (ite (< read_elts 1) true false))
  (and (not (= spark__branch1 true))
  (exists ((o9 Int))
  (and (= (to_rep2 item__last) o9)
  (exists ((o10 Int))
  (and (= (to_rep2 item__first) o10)
  (let ((o11 (length o10 o9)))
  (and (in_range2 o11)
  (and (= spark__branch (ite (= read_elts o11) true false))
  (ite (= spark__branch true)
  (exists ((o12 Int)) (and (= (to_rep2 item__last) o12) (= last3 o12)))
  (exists ((o12 Int))
  (and (= (to_rep2 item__first) o12)
  (let ((o13 (+ o12 read_elts)))
  (and (in_range2 o13)
  (let ((o14 (- o13 1))) (and (in_range2 o14) (= last3 o14))))))))))))))))))
  (=> (= last3 r15b)
  (=> (dynamic_invariant1 r15b true false true true)
  (forall ((ada___polyorb_hi__messages__read__R18b__assume Int))
  (=>
  (= (to_rep1
     (rec__ada___polyorb_hi__messages__message_type__first
     stream__split_fields)) ada___polyorb_hi__messages__read__R18b__assume)
  (=> (= ada___polyorb_hi__messages__read__R18b__assume r18b)
  ...
  (forall ((o11 Int))
  (=> (= (to_rep2 item__first) o11)
  (forall ((o12 Int))
  (=> (= (to_rep2 item__first) o12)
  (let ((temp___481 (of_array
                    (slide (to_array temp___480) (first1 temp___480) o12) o11
                    r15b)))
  ...
  (let ((temp___483 (of_array item temp___482 r15b)))
  (=>
  ...
  (let ((o14 (+ o13 read_elts)))
  (=> (in_range2 o14)
  (forall ((spark__branch1 Bool))
  (=> (= spark__branch1 (ite (< o14 19) true false))
  (=> (= spark__branch1 true)
  (forall ((o15 Int))
  (=>
  (= (to_rep1
