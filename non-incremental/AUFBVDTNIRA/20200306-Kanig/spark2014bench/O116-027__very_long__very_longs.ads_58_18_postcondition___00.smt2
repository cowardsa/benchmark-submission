...
;; defqtvc
 ;; File "very_longs.ads", line 55, characters 0-0
  ...
  (exists ((j Int))
  (and (= j 1)
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1074) true false)) true)
  ...
  (and (= carry2 #x0000)
  (and
  (let ((temp___1076 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1076) true false)) true)
  ...
  (let ((temp___1077 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1077) i1) (<= i1 (last1 temp___1077)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1077) i1)) o2)
  (exists ((l_digit3 (_ BitVec 16)))
  (and (= l_digit3 ((_ zero_extend 8) o2))
  (let ((temp___1078 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1078) j1) (<= j1 (last1 temp___1078)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1078) j1)) o3)
  (exists ((r_digit3 (_ BitVec 16)))
  (and (= r_digit3 ((_ zero_extend 8) o3))
  (and (= (last1 result____split_fields4) r94b)
  (and (in_range2 r94b)
  (and
  (let ((o4 (+ i1 j1)))
  (and (in_range2 o4)
  ...
  (and
  (= (to_rep2 (select (to_array result____split_fields4) temp___1080)) o6)
  ...
  (let ((o9 (+ i1 j1)))
  (and (in_range2 o9)
  (let ((temp___1082 (- o9 1)))
  (and
  (and (<= (first1 result____split_fields4) temp___1082)
  (<= temp___1082 (last1 result____split_fields4)))
  (and
  (= result____split_fields2 (us_tqtmk
                             (store (to_array result____split_fields4) temp___1082 o8)
  ...
  (= i1 temp___1076))))))))))))))))))
  (= result____split_fields2 result____split_fields3))))) (= j1 temp___1074))))))
