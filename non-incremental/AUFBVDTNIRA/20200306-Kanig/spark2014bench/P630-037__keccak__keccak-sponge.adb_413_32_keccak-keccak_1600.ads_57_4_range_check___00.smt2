...
;; defqtvc
 ;; File "keccak-sponge.ads", line 222, characters 0-0
  ...
  (=> (= spark__branch3 (ite (< 0 remaining2) true false))
  (=> (= spark__branch3 true)
  (forall ((o8 Int))
  (=> (= (to_rep digest__first) o8)
  (let ((o9 (+ o8 offset2)))
  (=> (in_range1 o9)
  (=> (= o9 r144s)
  (=> (dynamic_invariant2 r144s true false true true)
  (let ((o10 (+ offset2 remaining2)))
  (=> (in_range1 o10)
  (forall ((o11 Int))
  (=> (= (to_rep digest__first) o11)
  (let ((o12 (+ o11 (- o10 1))))
  (=> (in_range1 o12)
  (=> (= o12 r145s)
  (=> (dynamic_invariant2 r145s true false true true)
  (=> (= (- remaining2 1) r148s)
  (=> (dynamic_invariant2 r148s true false true true)
  (=>
  (=> (<= 0 r148s)
