...
(define-fun to_int3 ((x os_mbx_index_t)) Int (ubv_to_int (to_rep x)))
...
(define-fun to_int4 ((x os_mbx_count_t)) Int (ubv_to_int (to_rep1 x)))
...
(define-fun dynamic_invariant2 ((temp___expr_198 (_ BitVec 32))
...
;; os_mbx_get_waiting_mask__post_axiom
  ...
  (! (=> (dynamic_invariant task_id true true true true)
     ...
     test__os_task_list_rw) (dynamic_invariant2 result true false true true)))) :pattern (
...
;; os_mbx_get_mbx_entry_sender__post_axiom
  ...
  (! (and
     ...
     index true true true true)) (in_range4
     (to_rep2
     (rec__test__os_mbx_entry_t__sender_id
     (us_split_fields1
...
;; oadd__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant3 left true true true true) (dynamic_invariant1
     right true true true true))
     (let ((result (oadd left right)))
     (=> (oadd__function_guard result left right) (dynamic_invariant3 result
...
;; os_mbx_get_mbx_head__post_axiom
  ...
  (! (=> (dynamic_invariant task_id1 true true true true)
     ...
     test__os_task_mbx_rw) (dynamic_invariant3 result true false true true)))) :pattern (
...
(assert
;; defqtvc
 ;; File "test.adb", line 216, characters 0-0
  (not
  ...
  (let ((o2 (ite (not (= o1 true))
            (os_ghost_mbx_are_well_formed os_task_mbx_rw) false)))
  (=>
  (or (= o1 true)
  (and (os_ghost_mbx_are_well_formed__function_guard o2 os_task_mbx_rw)
  (= (= o2 true)
  (forall ((task_id1 Int))
  (=> (and (<= 0 task_id1) (<= task_id1 4))
  (= (os_ghost_task_mbx_are_well_formed task_id1 os_task_mbx_rw) true))))))
  (=>
  (or (not (= o2 true))
  (let ((o3 task_id))
  (let ((o4 (os_mbx_get_mbx_count o3 os_task_mbx_rw)))
  (and (os_mbx_get_mbx_count__function_guard o4 o3 os_task_mbx_rw)
  (and (dynamic_invariant1 o4 true false true true)
  (= o4 (to_rep1
        (rec__test__os_mbx_t__count
        (us_split_fields3 (select os_task_mbx_rw o3))))))))))
  (=>
  (and (= o2 true)
  (bvult index (os_mbx_get_mbx_count task_id os_task_mbx_rw)))
  (let ((o3 task_id))
  (=>
  ...
  (os_mbx_get_mbx_head o4 os_task_mbx_rw1) o4 os_task_mbx_rw1))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o4 (_ BitVec 8)) (o5 Int))
  (oadd__function_guard (oadd (os_mbx_get_mbx_head o5 os_task_mbx_rw1) o4)
  (os_mbx_get_mbx_head o5 os_task_mbx_rw1) o4)) (in_range4
  (to_rep2
  (rec__test__os_mbx_entry_t__sender_id
  (us_split_fields1
  (select (rec__test__os_mbx_t__mbx_array
          (us_split_fields3 (select os_task_mbx_rw o3))) (oadd
                                                         (os_mbx_get_mbx_head
                                                         o3 os_task_mbx_rw)
                                                         index))))))))))))))))))))))
(check-sat)
