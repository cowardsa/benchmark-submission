...
;; defqtvc
 ;; File "ordering_buffers.ads", line 60, characters 0-0
  ...
  (let ((o4 (last o3)))
  (=> (forall ((o5 us_rep)) (first__function_guard (first o5) o5))
  (=>
  (and (last__function_guard o4 o3)
  (and (dynamic_invariant1 o4 true false true true)
  (= o4 (- (+ (first o3) 16) 1))))
  (let ((o5 (us_repqtmk buffer__split_fields1)))
  (let ((o6 (has_message o5 o4)))
  (=>
  (forall ((o7 Int) (o8 us_rep)) (get_message__function_guard
  (get_message o8 o7) o8 o7))
  (=>
  (forall ((o7 Int) (o8 us_rep)) (get_message__function_guard
  (get_message o8 o7) o8 o7))
  (=>
  (forall ((o7 Int) (o8 us_rep)) (is_null__function_guard
  (is_null (get_message o8 o7)) (get_message o8 o7)))
  (=>
  (and (has_message__function_guard o6 o5 o4)
  (= (= o6 true) (not (= (is_null (get_message o5 o4)) true))))
  (forall ((usf1 Int))
  (let ((o7 (us_repqtmk buffer__split_fields1)))
  (let ((o8 (last o7)))
  (=> (forall ((o9 us_rep)) (first__function_guard (first o9) o9))
  (=>
  (and (last__function_guard o8 o7)
  (and (dynamic_invariant1 o8 true false true true)
  (= o8 (- (+ (first o7) 16) 1))))
  (let ((o9 (us_repqtmk buffer__split_fields1)))
  (let ((o10 (first o9)))
  (=>
  (and (first__function_guard o10 o9)
  (and (dynamic_invariant o10 true false true true)
  (= o10 (to_rep
         (rec__ordering_buffers__ordering_buffer_type__first
         buffer__split_fields1)))))
  (=>
  (= (and (ite (<= o10 usf1) true false) (ite (<= usf1 (- o8 1)) true false)) true)
  (=> (in_range3 usf1)
  (let ((o11 (get_message usf usf1)))
  (=>
  (and (get_message__function_guard o11 usf usf1)
  ...
  (=> (in_range3 usf1)
  (=> (forall ((o12 us_rep)) (first__function_guard (first o12) o12))
