...
(declare-datatypes ((boolean_array_8_2_range_1__ref 0))
...
;; defqtvc
 ;; File "finnuc.ads", line 45, characters 0-0
  (not
  (forall ((unit_delay_memory Bool) (memory_memory Bool)
  (memory_memory_1 Bool) (logic_index (_ BitVec 8))
  (logic_index_1 (_ BitVec 8)) (mux_out1 (Array Int Bool))
  (mux_out1_1 (Array Int Bool)) (logic_table map1) (logic_table_1 map1)
  (logical_operator1_out1 Bool) (mux_out11 (Array Int Bool))
  (mux_out12 (Array Int Bool)) (mux_out13 (Array Int Bool)))
  ...
  (=> (dynamic_invariant logic_index false false true true)
  (=>
  (= logic_table_1 (finnuc__comp__logic_table_1__aggregate_def (distinct 0 0)
                   ...
                   (distinct 0 0) (distinct 0 0) (distinct 0 0)))
  (=> (dynamic_invariant logic_index_1 false false true true)
  (=>
  (= logical_operator1_out1 (ite (= (ite (= unit_delay_memory true) c false) true)
                            true setb))
  (=> (= mux_out11 (store mux_out1 1 seta))
  (=> (= mux_out12 (store mux_out11 2 logical_operator1_out1))
  (=> (= mux_out13 (store mux_out12 3 memory_memory))
  (let ((o (select mux_out13 3)))
  (let ((o1 (boolean_to_unsigned_8 o)))
  (=>
  (and (boolean_to_unsigned_8__function_guard o1 o)
  (and (dynamic_invariant o1 true false true true)
  (= o1 (ite (= o true) #x01 #x00))))
  (let ((o2 (select mux_out13 2)))
  (let ((o3 (boolean_to_unsigned_8 o2)))
  (=>
  (and (boolean_to_unsigned_8__function_guard o3 o2)
  (and (dynamic_invariant o3 true false true true)
  (= o3 (ite (= o2 true) #x01 #x00))))
  (let ((o4 (select mux_out13 1)))
  (let ((o5 (boolean_to_unsigned_8 o4)))
  (=>
  (and (boolean_to_unsigned_8__function_guard o5 o4)
  (and (dynamic_invariant o5 true false true true)
  (= o5 (ite (= o4 true) #x01 #x00))))
  (forall ((logic_index1 (_ BitVec 8)))
  (=>
  (= logic_index1 (bvadd (bvadd (bvmul o5 #x04) (bvmul o3 #x02)) (bvmul o1 #x01)))
  (let ((temp___267 (+ (ubv_to_int logic_index1) 1)))
  (=> (and (<= 1 temp___267) (<= temp___267 8))
  (forall ((demux_out1 Bool))
  (=> (= demux_out1 (get logic_table temp___267 1))
  (let ((temp___268 (+ (ubv_to_int logic_index1) 1)))
  (=> (and (<= 1 temp___268) (<= temp___268 8))
  (forall ((a Bool))
  (=> (= a demux_out1)
  (forall ((mux_out1_11 (Array Int Bool)))
  (=> (= mux_out1_11 (store mux_out1_1 1 logical_operator1_out1))
  (forall ((o6 Bool))
  (=> (ite (= seta true) (= o6 (ite (= c true) false true)) (= o6 false))
  (forall ((mux_out1_12 (Array Int Bool)))
  (=> (= mux_out1_12 (store mux_out1_11 2 o6))
  (forall ((mux_out1_13 (Array Int Bool)))
  (=> (= mux_out1_13 (store mux_out1_12 3 memory_memory_1))
  (let ((o7 (select mux_out1_13 3)))
  (let ((o8 (boolean_to_unsigned_8 o7)))
  (=>
  (and (boolean_to_unsigned_8__function_guard o8 o7)
  (and (dynamic_invariant o8 true false true true)
  (= o8 (ite (= o7 true) #x01 #x00))))
  (let ((o9 (select mux_out1_13 2)))
  (let ((o10 (boolean_to_unsigned_8 o9)))
  (=>
  (and (boolean_to_unsigned_8__function_guard o10 o9)
  (and (dynamic_invariant o10 true false true true)
  (= o10 (ite (= o9 true) #x01 #x00))))
  (let ((o11 (select mux_out1_13 1)))
  (let ((o12 (boolean_to_unsigned_8 o11)))
  (=>
  (and (boolean_to_unsigned_8__function_guard o12 o11)
  (and (dynamic_invariant o12 true false true true)
  (= o12 (ite (= o11 true) #x01 #x00))))
  (forall ((logic_index_11 (_ BitVec 8)))
  (=>
  (= logic_index_11 (bvadd (bvadd (bvmul o12 #x04) (bvmul o10 #x02)) (bvmul o8 #x01)))
  (let ((temp___269 (+ (ubv_to_int logic_index_11) 1)))
  (=> (and (<= 1 temp___269) (<= temp___269 8))
  (forall ((demux_out1_1 Bool))
  (=> (= demux_out1_1 (get logic_table_1 temp___269 1))
  (<= 1 (+ (ubv_to_int logic_index_11) 1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
