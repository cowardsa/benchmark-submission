...
;; defqtvc
 ;; File "very_longs.ads", line 61, characters 0-0
  ...
  (let ((temp___1128 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1128) i1) (<= i1 (last1 temp___1128)))
  (forall ((o4 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1128) i1)) o4)
  (forall ((l_digit3 (_ BitVec 16)))
  (=> (= l_digit3 ((_ zero_extend 8) o4))
  (let ((temp___1129 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1129) j1) (<= j1 (last1 temp___1129)))
  (forall ((o5 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1129) j1)) o5)
  (forall ((r_digit3 (_ BitVec 16)))
  (=> (= r_digit3 ((_ zero_extend 8) o5))
  (let ((o6 (+ i1 j1)))
  (=> (in_range2 o6)
  (let ((temp___1131 (- o6 1)))
  (=>
  (and (<= (first1 result____split_fields3) temp___1131)
  (<= temp___1131 (last1 result____split_fields3)))
  (forall ((o7 (_ BitVec 8)))
  (=>
  (= (to_rep2 (select (to_array result____split_fields3) temp___1131)) o7)
  (forall ((t_digit3 (_ BitVec 16)))
  (=> (= t_digit3 ((_ zero_extend 8) o7))
  ...
  false true true))
  (forall ((o9 octet)) (=> (= (to_rep2 o9) o8) (in_range2 (+ i1 j1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
