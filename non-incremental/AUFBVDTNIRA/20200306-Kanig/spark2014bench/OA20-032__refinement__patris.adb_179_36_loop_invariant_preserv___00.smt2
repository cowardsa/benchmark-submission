...
;; defqtvc
 ;; File "patris.ads", line 250, characters 0-0
  ...
  (ite (= (and (ite (<= 1 del_line) true false) (ite (<= del_line 20) true
                                                false)) true)
  (exists ((spark__branch3 Bool) (cur_board2 (Array Int (Array Int cell)))
  ...
  (and (= cur_board2 (store cur_board del_line empty_line))
  ...
  (=>
  (= spark__branch2 (ite (not (= complete_lines1 #x00000000)) true false))
  (=> (= spark__branch2 true)
  (=> (= (- to_line1 1) r21b)
  (=> (dynamic_invariant r21b true false true true)
  (let ((temp___929 r21b))
  (forall ((from_line Int))
  (=> (= from_line temp___929)
  (=>
  (= (and (ite (<= 1 from_line) true false) (ite (<= from_line temp___929)
                                            true false)) true)
  (=>
  (= (= (no_complete_lines cur_board1) true)
  (forall ((y Int))
  (=> (and (<= 1 y) (<= y 20))
  (not (= (is_complete_line (select cur_board1 y)) true)))))
  (forall ((cur_board2 (Array Int (Array Int cell))) (to_line2 Int)
  (from_line1 Int))
  (=> (and (= (no_complete_lines cur_board2) true) (< from_line1 to_line2))
  (=>
  (= (and (ite (and (dynamic_property 1 r21b from_line1) (dynamic_invariant3
          ...
          true false) (ite (and (<= 1 from_line1) (<= from_line1 r21b)) true
                      false)) true)
  (forall ((spark__branch3 Bool) (cur_board3 (Array Int (Array Int cell)))
  (to_line3 Int))
  (=>
  ...
  (and
  (= cur_board4 (store cur_board2 to_line2 (select cur_board2 from_line1)))
  (and (= cur_board3 (store cur_board4 from_line1 empty_line))
  (let ((o2 (- to_line2 1)))
  (and (in_range9 o2)
  (and (= to_line3 o2)
  (= (to_rep (select (select cur_board3 from_line1) 1)) 0)))))))
  (and (= cur_board3 cur_board2) (= to_line3 to_line2)))))))
  (=> (not (= from_line1 1))
  (forall ((from_line2 Int))
  (=> (= from_line2 (- from_line1 1))
  (=>
  (= (= (no_complete_lines cur_board3) true)
  (forall ((y Int))
  (=> (and (<= 1 y) (<= y 20))
  (not (= (is_complete_line (select cur_board3 y)) true)))))
  (=> (= (no_complete_lines cur_board3) true) (< from_line2 to_line3))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
