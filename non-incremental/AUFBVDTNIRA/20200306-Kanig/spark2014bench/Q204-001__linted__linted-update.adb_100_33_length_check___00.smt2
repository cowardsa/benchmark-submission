...
(define-fun to_int3 ((x nat)) Int (ubv_to_int (to_rep1 x)))
...
(define-fun to_int4 ((x storage_element)) Int (ubv_to_int (to_rep2 x)))
...
;; defqtvc
 ;; File "linted-update.ads", line 40, characters 0-0
  ...
  (y1 (_ BitVec 32)) (c227b (_ BitVec 32)) (y2 (_ BitVec 32))
  (c237b (_ BitVec 32)) (y3 (_ BitVec 32)) (c247b (_ BitVec 32))
  (y4 (_ BitVec 32)) (c257b (_ BitVec 32)) (y5 (_ BitVec 32))
  (ada___linted__update__to_storage__C206b__assume Int) (spark__branch Bool)
  (y6 (_ BitVec 32)) (c207b1 (_ BitVec 32)))
  (=>
  (= (to_rep
  ...
  (and (in_range1 o)
  (and (uint_in_range1 o) (= y6 (bvsub ((_ int_to_bv 32) o) #x80000000)))))
  (let ((o c206b)) (and (uint_in_range1 o) (= y6 ((_ int_to_bv 32) o)))))
  (=> (= c207b1 y6)
  (=> (= c207b1 c210b)
  ...
  (forall ((spark__branch1 Bool) (y7 (_ BitVec 32)))
  (=>
  (and (= spark__branch1 (ite (< c216b 0) true false))
  (ite (= spark__branch1 true)
  (let ((o (- c216b (- 2147483648))))
  (and (in_range1 o)
  (and (uint_in_range1 o) (= y7 (bvsub ((_ int_to_bv 32) o) #x80000000)))))
  (let ((o c216b)) (and (uint_in_range1 o) (= y7 ((_ int_to_bv 32) o))))))
  ...
  (=>
  (= (to_rep
     (rec__ada___linted__update__packet__z_position (us_split_fields1 u))) ada___linted__update__to_storage__C226b__assume)
  (=> (= ada___linted__update__to_storage__C226b__assume c226b)
  (=> (dynamic_invariant c226b true false true true)
  (=> (dynamic_invariant1 c227b false false true true)
  (=> (dynamic_invariant1 y2 false false true true)
  (forall ((spark__branch2 Bool) (y8 (_ BitVec 32)))
  (=>
  (and (= spark__branch2 (ite (< c226b 0) true false))
  (ite (= spark__branch2 true)
  (let ((o (- c226b (- 2147483648))))
  (and (in_range1 o)
  (and (uint_in_range1 o) (= y8 (bvsub ((_ int_to_bv 32) o) #x80000000)))))
  (let ((o c226b)) (and (uint_in_range1 o) (= y8 ((_ int_to_bv 32) o))))))
  (forall ((c227b1 (_ BitVec 32)))
  (=> (= c227b1 y8)
  (=> (= c227b1 c230b)
  (=> (dynamic_invariant1 c230b true false true true)
  (forall ((c231b (Array Int storage_element)))
  (=>
  (= c231b (temp_____aggregate_def_263
           ((_ extract 7 0) (bvand (bvlshr c230b ((_ int_to_bv 32) 24)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c230b ((_ int_to_bv 32) 16)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c230b ((_ int_to_bv 32) 8)) #x000000FF))
           ((_ extract 7 0) (bvand c230b #x000000FF))))
  (forall ((ada___linted__update__to_storage__C236b__assume Int))
  (=>
  (= (to_rep
     (rec__ada___linted__update__packet__mx_position (us_split_fields1 u))) ada___linted__update__to_storage__C236b__assume)
  (=> (= ada___linted__update__to_storage__C236b__assume c236b)
  (=> (dynamic_invariant c236b true false true true)
  (=> (dynamic_invariant1 c237b false false true true)
  (=> (dynamic_invariant1 y3 false false true true)
  (forall ((spark__branch3 Bool) (y9 (_ BitVec 32)))
  (=>
  (and (= spark__branch3 (ite (< c236b 0) true false))
  (ite (= spark__branch3 true)
  (let ((o (- c236b (- 2147483648))))
  (and (in_range1 o)
  (and (uint_in_range1 o) (= y9 (bvsub ((_ int_to_bv 32) o) #x80000000)))))
  (let ((o c236b)) (and (uint_in_range1 o) (= y9 ((_ int_to_bv 32) o))))))
  (forall ((c237b1 (_ BitVec 32)))
  (=> (= c237b1 y9)
  (=> (= c237b1 c240b)
  (=> (dynamic_invariant1 c240b true false true true)
  (forall ((c241b (Array Int storage_element)))
  (=>
  (= c241b (temp_____aggregate_def_270
           ((_ extract 7 0) (bvand (bvlshr c240b ((_ int_to_bv 32) 24)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c240b ((_ int_to_bv 32) 16)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c240b ((_ int_to_bv 32) 8)) #x000000FF))
           ((_ extract 7 0) (bvand c240b #x000000FF))))
  (forall ((ada___linted__update__to_storage__C246b__assume Int))
  (=>
  (= (to_rep
     (rec__ada___linted__update__packet__my_position (us_split_fields1 u))) ada___linted__update__to_storage__C246b__assume)
  (=> (= ada___linted__update__to_storage__C246b__assume c246b)
  (=> (dynamic_invariant c246b true false true true)
  (=> (dynamic_invariant1 c247b false false true true)
  (=> (dynamic_invariant1 y4 false false true true)
  (forall ((spark__branch4 Bool) (y10 (_ BitVec 32)))
  (=>
  (and (= spark__branch4 (ite (< c246b 0) true false))
  (ite (= spark__branch4 true)
  (let ((o (- c246b (- 2147483648))))
  (and (in_range1 o)
  (and (uint_in_range1 o) (= y10 (bvsub ((_ int_to_bv 32) o) #x80000000)))))
  (let ((o c246b)) (and (uint_in_range1 o) (= y10 ((_ int_to_bv 32) o))))))
  (forall ((c247b1 (_ BitVec 32)))
  (=> (= c247b1 y10)
  (=> (= c247b1 c250b)
  (=> (dynamic_invariant1 c250b true false true true)
  (forall ((c251b (Array Int storage_element)))
  (=>
  (= c251b (temp_____aggregate_def_277
           ((_ extract 7 0) (bvand (bvlshr c250b ((_ int_to_bv 32) 24)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c250b ((_ int_to_bv 32) 16)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c250b ((_ int_to_bv 32) 8)) #x000000FF))
           ((_ extract 7 0) (bvand c250b #x000000FF))))
  (forall ((ada___linted__update__to_storage__C256b__assume Int))
  (=>
  (= (to_rep
     (rec__ada___linted__update__packet__mz_position (us_split_fields1 u))) ada___linted__update__to_storage__C256b__assume)
  (=> (= ada___linted__update__to_storage__C256b__assume c256b)
  (=> (dynamic_invariant c256b true false true true)
  (=> (dynamic_invariant1 c257b false false true true)
  (=> (dynamic_invariant1 y5 false false true true)
  (forall ((y11 (_ BitVec 32)))
  (=>
  (exists ((spark__branch5 Bool))
  (and (= spark__branch5 (ite (< c256b 0) true false))
  (ite (= spark__branch5 true)
  (let ((o (- c256b (- 2147483648))))
  (and (in_range1 o)
  (and (uint_in_range1 o) (= y11 (bvsub ((_ int_to_bv 32) o) #x80000000)))))
  (let ((o c256b)) (and (uint_in_range1 o) (= y11 ((_ int_to_bv 32) o)))))))
  (forall ((c257b1 (_ BitVec 32)))
  (=> (= c257b1 y11)
  (=> (= c257b1 c260b)
  (=> (dynamic_invariant1 c260b true false true true)
  (forall ((c261b (Array Int storage_element)))
  (=>
  (= c261b (temp_____aggregate_def_284
           ((_ extract 7 0) (bvand (bvlshr c260b ((_ int_to_bv 32) 24)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c260b ((_ int_to_bv 32) 16)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c260b ((_ int_to_bv 32) 8)) #x000000FF))
           ((_ extract 7 0) (bvand c260b #x000000FF))))
  (forall ((ada___linted__update__to_storage__C266b__assume (_ BitVec 32)))
  (=>
  (= (to_rep1
     (rec__ada___linted__update__packet__z_rotation (us_split_fields1 u))) ada___linted__update__to_storage__C266b__assume)
  (=> (= ada___linted__update__to_storage__C266b__assume c266b)
  (=> (dynamic_invariant1 c266b true false true true)
  (forall ((c267b (Array Int storage_element)))
  (=>
  (= c267b (temp_____aggregate_def_291
           ((_ extract 7 0) (bvand (bvlshr c266b ((_ int_to_bv 32) 24)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c266b ((_ int_to_bv 32) 16)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c266b ((_ int_to_bv 32) 8)) #x000000FF))
           ((_ extract 7 0) (bvand c266b #x000000FF))))
  (forall ((ada___linted__update__to_storage__C272b__assume (_ BitVec 32)))
  (=>
  (= (to_rep1
     (rec__ada___linted__update__packet__x_rotation (us_split_fields1 u))) ada___linted__update__to_storage__C272b__assume)
  (=> (= ada___linted__update__to_storage__C272b__assume c272b)
  (=> (dynamic_invariant1 c272b true false true true)
  (forall ((c273b (Array Int storage_element)))
  (=>
  (= c273b (temp_____aggregate_def_298
           ((_ extract 7 0) (bvand (bvlshr c272b ((_ int_to_bv 32) 24)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c272b ((_ int_to_bv 32) 16)) #x000000FF))
           ((_ extract 7 0) (bvand (bvlshr c272b ((_ int_to_bv 32) 8)) #x000000FF))
           ((_ extract 7 0) (bvand c272b #x000000FF))))
  (forall ((temp___311 us_t))
  (=>
  (exists ((temp___310 us_t))
  (and
  (exists ((temp___309 us_t))
  (and
  (exists ((temp___308 us_t))
  (and
  (exists ((temp___307 us_t))
  (and
  (exists ((temp___306 us_t))
  (and
  (let ((o (- (+ 1 (+ (length 1 4) (length 1 4))) 1)))
  (and (in_range2 o)
  (let ((temp___305 (of_array (concat1 c211b 1 4 c221b 1 4) 1 o)))
  (ite (= (length1 temp___305) 0) (= temp___306 (of_array c231b 1 4))
  (let ((o1 (- (+ (first1 temp___305) (+ (length (first1 temp___305)
                                         (last1 temp___305)) (length 1 4))) 1)))
  (and (in_range2 o1)
  (= temp___306 (of_array
                (concat1 (to_array temp___305) (first1 temp___305)
                (last1 temp___305) c231b 1 4) (first1 temp___305) o1))))))))
  (ite (= (length1 temp___306) 0) (= temp___307 (of_array c241b 1 4))
  (let ((o (- (+ (first1 temp___306) (+ (length (first1 temp___306)
                                        (last1 temp___306)) (length 1 4))) 1)))
  (and (in_range2 o)
  (= temp___307 (of_array
                (concat1 (to_array temp___306) (first1 temp___306)
                (last1 temp___306) c241b 1 4) (first1 temp___306) o)))))))
  (ite (= (length1 temp___307) 0) (= temp___308 (of_array c251b 1 4))
  (let ((o (- (+ (first1 temp___307) (+ (length (first1 temp___307)
                                        (last1 temp___307)) (length 1 4))) 1)))
  (and (in_range2 o)
  (= temp___308 (of_array
                (concat1 (to_array temp___307) (first1 temp___307)
                (last1 temp___307) c251b 1 4) (first1 temp___307) o)))))))
  (ite (= (length1 temp___308) 0) (= temp___309 (of_array c261b 1 4))
  (let ((o (- (+ (first1 temp___308) (+ (length (first1 temp___308)
                                        (last1 temp___308)) (length 1 4))) 1)))
  (and (in_range2 o)
  (= temp___309 (of_array
                (concat1 (to_array temp___308) (first1 temp___308)
                (last1 temp___308) c261b 1 4) (first1 temp___308) o)))))))
  (ite (= (length1 temp___309) 0) (= temp___310 (of_array c267b 1 4))
  (let ((o (- (+ (first1 temp___309) (+ (length (first1 temp___309)
                                        (last1 temp___309)) (length 1 4))) 1)))
  (and (in_range2 o)
  (= temp___310 (of_array
                (concat1 (to_array temp___309) (first1 temp___309)
                (last1 temp___309) c267b 1 4) (first1 temp___309) o)))))))
  (ite (= (length1 temp___310) 0) (= temp___311 (of_array c273b 1 4))
  (let ((o (- (+ (first1 temp___310) (+ (length (first1 temp___310)
                                        (last1 temp___310)) (length 1 4))) 1)))
  (and (in_range2 o)
  (= temp___311 (of_array
                (concat1 (to_array temp___310) (first1 temp___310)
                (last1 temp___310) c273b 1 4) (first1 temp___310) o)))))))
  (=> (<= (first1 temp___311) (last1 temp___311)) (<= 1 32)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
