...
(declare-fun temp_____aggregate_def_1224 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1226 (_ BitVec 8)))
  (forall ((temp___1227 Int) (temp___1228 Int))
  (let ((temp___1225 (temp_____aggregate_def_1224 temp___1226 temp___1227
                     temp___1228)))
  (=> (dynamic_invariant3 temp___1226 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1227 temp___1228)
  (and (= (first1 temp___1225) temp___1227)
  (= (last1 temp___1225) temp___1228)))
  (forall ((temp___1229 Int))
  (= (to_rep2 (select (to_array temp___1225) temp___1229)) temp___1226))))))))
...
;; defqtvc
 ;; File "very_longs.adb", line 49, characters 0-0
  ...
  (let ((temp___1230 (temp_____aggregate_def_1224 #x00 1 r9b)))
  (=> (= (first1 temp___1230) 1)
  (=> (= (last1 temp___1230) r9b)
  (=>
  (ite (<= (first1 temp___1230) (last1 temp___1230))
  (and (<= 1 r9b) (= (- (last1 temp___1230) (first1 temp___1230)) (- r9b 1)))
  (< r9b 1))
  (let ((temp___1232 (of_array (to_array temp___1230) (first1 temp___1230)
                     (last1 temp___1230))))
  (=>
  (ite (<= (first1 temp___1232) (last1 temp___1232))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1232) (first1 temp___1232)) (- (last1
  ...
  (=>
  (= result____split_fields1 (of_array (to_array temp___1232)
                             (first1 temp___1232) (last1 temp___1232)))
  (forall ((carry1 (_ BitVec 16)))
  (=> (= carry1 #x0000)
  (let ((temp___1238 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (forall ((i Int))
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1238) true false)) true)
  ...
  (= (and (ite (and
               ...
               true))
               (forall ((temp___1249 Int))
               (=>
               (and (<= (first1 result____split_fields2) temp___1249)
               (<= temp___1249 (last1 result____split_fields2)))
               (=>
               (or (< temp___1238 temp___1249)
               (or (< temp___1249 1) (<= i1 temp___1249)))
               (= (select (to_array result____split_fields2) temp___1249) (select 
               (to_array result____split_fields1) temp___1249))))))
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1239 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1239) i1) (<= i1 (last1 temp___1239)))
  (forall ((o (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1239) i1)) o)
  (forall ((l_digit2 (_ BitVec 16)))
  (=> (= l_digit2 ((_ zero_extend 8) o))
  (let ((temp___1240 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1240) i1) (<= i1 (last1 temp___1240)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1240) i1)) o1)
