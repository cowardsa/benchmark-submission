...
(define-fun in_range4 ((x (_ BitVec 64))) Bool (and
                                               ...
                                               (bvule x #x0000FFFFFFFFFFFF)))

(define-fun in_range_int ((x Int)) Bool (and (<= 0 x) (<= x 281474976710655)))
...
(define-fun uxx__ref_uxx__content__3__projection ((a uxx__ref)) uxx (uxx__content
                                                                    a))

(define-fun dynamic_invariant1 ((temp___expr_233 (_ BitVec 64))
  ...
  (temp___do_typ_inv_232 Bool)) Bool (=>
                                     ...
                                     (bvule #x0000000000000000 #x0000FFFFFFFFFFFF))
                                     (in_range4 temp___expr_233)))
...
(define-fun dynamic_invariant4 ((temp___expr_151 Int)
...
(assert
;; defqtvc
 ;; File "ethernet_dissector.adb", line 7, characters 0-0
  (not
  (forall ((value (_ BitVec 64)) (i Int))
  (=> (dynamic_invariant buffer true false true true)
  (=> (= (length buffer) 6)
  (=> (= value #x0000000000000000)
  (=> (dynamic_invariant1 value true false true true)
  (=> (= i 0) (let ((o (power 256 i))) (=> (in_range2 o) (in_range_int o)))))))))))
(check-sat)
(exit)
