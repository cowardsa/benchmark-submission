...
;; defqtvc
 ;; File "ordering_buffers.ads", line 49, characters 0-0
  ...
  (=>
  (= (and (ite (<= o7 usf2) true false) (ite (<= usf2 o5) true false)) true)
  (=> (in_range3 usf2)
  (let ((o8 (get_message usf1 usf2)))
  (=>
  (and (get_message__function_guard o8 usf1 usf2)
  (and (dynamic_invariant o8 true false true true)
  (= o8 (to_rep1
        (select (rec__ordering_buffers__ordering_buffer_type__ring
                buffer__split_fields) ((_ int_to_bv 8) (mod2 usf2 256)))))))
  (=> (in_range3 usf2)
  (=> (forall ((o9 us_rep)) (first__function_guard (first o9) o9))
  (<= (first (us_repqtmk buffer__split_fields2)) usf2)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
