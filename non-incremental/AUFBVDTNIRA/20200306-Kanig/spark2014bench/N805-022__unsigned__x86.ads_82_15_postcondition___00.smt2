...
;; readmem8__post_axiom
  ...
  (! (=> (dynamic_invariant addr true true true true)
     ...
     (dynamic_invariant1 result true false true true))))) :pattern ((readmem8
                                                                    addr
                                                                    x86__memory)) ))))
...
;; defqtvc
 ;; File "x86.ads", line 80, characters 0-0
  ...
  (forall ((x86__readmem16__result (_ BitVec 16)))
  (=>
  (= x86__readmem16__result (bvadd ((_ zero_extend 8) o3) (bvmul ((_ zero_extend 8) o1) #x0100)))
  (= x86__readmem16__result (bvadd ((_ zero_extend 8) (to_rep
                                                      (select memory 
