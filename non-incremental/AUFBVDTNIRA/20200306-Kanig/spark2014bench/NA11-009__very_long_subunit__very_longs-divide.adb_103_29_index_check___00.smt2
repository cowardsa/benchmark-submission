...
(define-fun dynamic_invariant3 ((temp___expr_781 Int)
...
;; defqtvc
 ;; File "very_longs-divide.adb", line 92, characters 0-0
  ...
  (=> (= overflow_mask1 o1)
  (=> (= (last1 number__split_fields) r122b)
  (=> (in_range2 r122b)
  (let ((temp___1331 r122b))
  (forall ((i Int))
  (=> (= i temp___1331)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1331) true false)) true)
  ...
  (= (and (ite (and
               ...
               true))
               (forall ((temp___1344 Int))
               (=>
               (and (<= (first1 number__split_fields1) temp___1344)
               (<= temp___1344 (last1 number__split_fields1)))
               (=>
               (or (< temp___1331 temp___1344)
               (or (< temp___1344 1) (<= temp___1344 i1)))
               (= (select (to_array number__split_fields1) temp___1344) (select 
               (to_array number__split_fields) temp___1344))))))
               (dynamic_invariant2 old_overflow1 true true true true))
          true false) (ite (and (<= 1 i1) (<= i1 r122b)) true false)) true)
  (=>
