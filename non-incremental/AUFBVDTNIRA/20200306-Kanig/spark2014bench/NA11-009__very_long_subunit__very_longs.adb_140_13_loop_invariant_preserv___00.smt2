...
;; range_axiom
  (assert
  (forall ((x tdigit_count_typeB)) (! (in_range6
...
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int)
  (high Int)) Bool (and (in_range6 low)
                   (and (in_range6 high)
...
(define-fun in_range7 ((rec__very_longs__very_long__length1 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_257 us_t1)
...
(define-fun dynamic_invariant9 ((temp___expr_458 us_t1)
...
;; defqtvc
 ;; File "very_longs.ads", line 16, characters 0-0
  ...
  (very_longs__make_from_hex_string__R31b__assume Int))
  ...
  (=>
  (= (to_rep2 (rec__very_longs__very_long__length result____split_discrs)) very_longs__make_from_hex_string__R31b__assume)
  (=> (= very_longs__make_from_hex_string__R31b__assume r31b)
  (=> (dynamic_invariant4 r31b true false true true)
  (let ((temp___910 (temp_____aggregate_def_904 #x00 1 r31b)))
  (=> (= (first3 temp___910) 1)
  (=> (= (last3 temp___910) r31b)
  (=>
  (ite (<= (first3 temp___910) (last3 temp___910))
  (and (<= 1 r31b) (= (- (last3 temp___910) (first3 temp___910)) (- r31b 1)))
  (< r31b 1))
  ...
  (dynamic_invariant3 h_digit1 false true true true)) (dynamic_invariant2
  (us_repqtmk result____split_discrs
  (us_split_fieldsqtmk result____split_fields2)) false true true true))
  (dynamic_invariant3 l_digit1 false true true true)) (dynamic_invariant4
  index2 false true true true))
  (=>
  (and (<= (first1 number) string_index2) (<= string_index2 (last1 number)))
  (=>
  (exists ((o4 Int))
  (= (to_rep (select (to_array number) string_index2)) o4))
  (forall ((h_digit2 (_ BitVec 8)) (h_okay Bool))
  (=> (dynamic_invariant3 h_digit2 true true true true)
  (let ((o4 (+ string_index2 1)))
  (=> (in_range1 o4)
  (=> (and (<= (first1 number) o4) (<= o4 (last1 number)))
  (=> (exists ((o5 Int)) (= (to_rep (select (to_array number) o4)) o5))
  ...
  (forall ((o5 octet))
  (=> (= (to_rep4 o5) (bvadd (bvmul #x10 h_digit2) l_digit2))
  (=>
  ...
  (= result____split_fields3 (us_tqtmk1
                             (store (to_array1 result____split_fields2) index2 o5)
  ...
  (forall ((index3 Int))
  (=> (= index3 o6)
  (let ((o7 (+ string_index2 2)))
  (=> (in_range1 o7)
  (forall ((string_index3 Int))
  (=> (= string_index3 o7)
  (let ((o8 (- (last3 result____split_fields3) index3)))
  (=> (in_range6 o8)
  (let ((o9 (* 2 o8)))
  (=> (in_range6 o9)
  (=> (in_range2 o9)
  (=> (in_range1 (+ o9 (first1 number)))
  (= string_index3 (+ (* 2 (- (last3 result____split_fields3) index3)) 
  (first1 number))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
