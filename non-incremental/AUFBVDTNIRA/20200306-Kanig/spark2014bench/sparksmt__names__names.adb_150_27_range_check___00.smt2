...
;; defqtvc
 ;; File "names.ads", line 44, characters 0-0
  ...
  (hash_table (Array (_ BitVec 32) name_id)) (n Int) (ptr Int))
  (=> (dynamic_invariant3
  ...
  (hash_table1 (Array (_ BitVec 32) name_id))) (invariant____function_guard
  (invariant__ hash_table1 (us_split_fieldsqtmk1 char_table__split_fields1)
  (us_split_fieldsqtmk entry_table__split_fields1)) hash_table1
  (us_split_fieldsqtmk1 char_table__split_fields1)
  (us_split_fieldsqtmk entry_table__split_fields1)))
  (=>
  (= (invariant__ hash_table (us_split_fieldsqtmk1 char_table__split_fields)
     (us_split_fieldsqtmk entry_table__split_fields)) true)
  (=> (= ptr 0)
  (=> (dynamic_invariant4 ptr true false true true)
  (let ((o (hash s)))
  (=> (dynamic_invariant5 o true false true true)
  (let ((o1 (bvurem o #x00000100)))
  (=> (in_range13 o1)
  (=> (= o1 h)
  (=> (dynamic_invariant6 h true false true true)
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (= (length s) 0) true false))
  (=> (not (= spark__branch true))
  (forall ((o2 Int))
  (=> (= (to_rep5 (select hash_table h)) o2)
  (forall ((n1 Int))
  (=> (= n1 o2)
  (forall ((spark__branch1 Bool) (ptr1 Int))
  (=>
  (forall ((entry_table__split_fields1 us_main_type)
  (char_table__split_fields1 us_main_type2)) (valid_tables__function_guard
  (valid_tables (us_split_fieldsqtmk1 char_table__split_fields1)
  (us_split_fieldsqtmk entry_table__split_fields1))
  (us_split_fieldsqtmk1 char_table__split_fields1)
  (us_split_fieldsqtmk entry_table__split_fields1)))
  (=>
  ...
  (char_table__split_fields1 us_main_type2))
  (valid_name_table__function_guard
  (valid_name_table (us_split_fieldsqtmk1 char_table__split_fields1)
  (us_split_fieldsqtmk entry_table__split_fields1))
  (us_split_fieldsqtmk1 char_table__split_fields1)
  (us_split_fieldsqtmk entry_table__split_fields1)))
  (=>
  (forall ((entry_table__split_fields1 us_main_type)
  (hash_table1 (Array (_ BitVec 32) name_id))) (valid_hashes__function_guard
  (valid_hashes hash_table1 (us_split_fieldsqtmk entry_table__split_fields1))
  hash_table1 (us_split_fieldsqtmk entry_table__split_fields1)))
  (=>
  (forall ((entry_table__split_fields1 us_main_type)
  (char_table__split_fields1 us_main_type2)
  (hash_table1 (Array (_ BitVec 32) name_id))) (invariant____function_guard
  ...
  (forall ((entry_table__split_fields1 us_main_type)
  (char_table__split_fields1 us_main_type2) (n2 Int))
  (=>
  (forall ((hash_table1 (Array (_ BitVec 32) name_id))
  (entry_table__split_fields2 us_main_type)
  (char_table__split_fields2 us_main_type2)) (invariant____function_guard
  (invariant__ hash_table1 (us_split_fieldsqtmk1 char_table__split_fields2)
  (us_split_fieldsqtmk entry_table__split_fields2)) hash_table1
  ...
  (= (length2
     (us_repqtmk entry_table__split_discrs
     (us_split_fieldsqtmk entry_table__split_fields1))) (+ (length2
                                                           (us_repqtmk
                                                           entry_table__split_discrs
                                                           (us_split_fieldsqtmk
  ...
  (dynamic_invariant1
  (us_repqtmk entry_table__split_discrs
  (us_split_fieldsqtmk entry_table__split_fields1)) true true true true)))
  (forall ((spark__branch2 Bool))
  (=> (= spark__branch2 (ite (in_range11 ptr1) true false))
  (=> (= spark__branch2 true)
  (=> (in_range12 ptr1)
  (let ((o3 (us_repqtmk entry_table__split_discrs
            (us_split_fieldsqtmk entry_table__split_fields1))))
  (=> (= (bool_eq3 (element o3 ptr1) (get (model1 o3) ptr1)) true)
  (forall ((o4 name_id)) (=> (= (to_rep5 o4) n2) (in_range12 ptr1))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
