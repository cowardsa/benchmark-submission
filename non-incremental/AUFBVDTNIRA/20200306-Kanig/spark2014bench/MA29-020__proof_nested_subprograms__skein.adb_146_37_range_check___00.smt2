...
(define-fun to_int5 ((x u16)) Int (ubv_to_int (to_rep x)))
...
(define-fun to_int6 ((x u32)) Int (ubv_to_int (to_rep1 x)))
...
(define-fun to_int7 ((x u64)) Int (ubv_to_int (to_rep2 x)))
...
(define-fun to_int8 ((x u7)) Int (ubv_to_int (to_rep3 x)))
...
(define-fun to_int9 ((x u6)) Int (ubv_to_int (to_rep4 x)))
...
(define-fun to_int10 ((x hash_bit_length)) Int (ubv_to_int (to_rep5 x)))
...
(define-fun to_int11 ((x byte)) Int (ubv_to_int (to_rep6 x)))
...
(define-fun to_int12 ((x unsigned_64)) Int (ubv_to_int (to_rep7 x)))
...
;; defqtvc
 ;; File "skein.ads", line 131, characters 0-0
  ...
  (and (= spark__branch2 (ite (bvuge c29b #x0000000000000001) true false))
  (or (not (= spark__branch2 true))
  (let ((temp___755 (bvsub c29b #x0000000000000001)))
  (exists ((n4 (_ BitVec 64)))
  (and (= n4 #x0000000000000000)
  (or
  (not
  (= (and (ite (bvule #x0000000000000000 n4) true false) (ite (bvule n4 temp___755)
                                                         true false)) true))
  (exists ((n5 (_ BitVec 64)))
  (and
  (= (and (ite true true false) (ite (and (bvule #x0000000000000000 n5)
                                     (bvule n5 (bvsub c29b #x0000000000000001)))
                                true false)) true)
  (let ((o19 (ubv_to_int (bvmul #x0000000000000008 (bvand n5 #x0000000000000007)))))
  (and (in_range1 o19)
  (let ((temp___757 (bvudiv n5 #x0000000000000008)))
  (and
  (and (bvule #x0000000000000000 temp___757)
  (bvule temp___757 #x0000000000000007))
  (exists ((o20 (_ BitVec 64)))
  (and
  (= (to_rep2
     (select (rec__skein__skein_512_context__x local_ctx__split_fields14) temp___757)) o20)
  (exists ((o21 byte))
  (and
  (= (to_rep6 o21) ((_ extract 7 0) (bvand (bvlshr o20 ((_ int_to_bv 64) o19)) #x00000000000000FF)))
  (let ((temp___758 (bvadd c26b n5)))
  (and
  (and (bvule (to_rep7 hash__first) temp___758)
  (bvule temp___758 (to_rep7 hash__last))) (= n5 temp___755))))))))))))))))))))
  (in_range8 (bvadd blocks_done2 #x0000000000000001)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
