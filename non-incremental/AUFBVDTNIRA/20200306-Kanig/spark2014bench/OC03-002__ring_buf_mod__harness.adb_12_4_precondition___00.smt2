...
;; defqtvc
 ;; File "harness.adb", line 3, characters 0-0
  ...
  (= (let ((temp___255 (func_push (to_model (us_repqtmk r__split_fields1)) y)))
     ...
     (to_array temp___255) (first1 temp___255) (last1 temp___255)))) true)
  (=>
  (forall ((r__split_fields3 us_split_fields)) (is_empty__function_guard
  (is_empty (us_repqtmk r__split_fields3)) (us_repqtmk r__split_fields3)))
  (not (= (is_empty (us_repqtmk r__split_fields2)) true))))))))))))))))))))))))
(check-sat)
(exit)
