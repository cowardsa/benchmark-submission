...
;; defqtvc
 ;; File "keccak-sponge.ads", line 222, characters 0-0
  ...
  (forall ((spark__branch1 Bool) (ctx__split_fields2 us_split_fields))
  (=>
  (exists ((o8 Int))
  (and
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields1)) o8)
  (exists ((o9 Int))
  (and
  (= (to_rep4
     (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
     ctx__split_fields1)) o9)
  (and (= spark__branch1 (ite (<= o8 o9) true false))
  ...
  (of_array
  (rec__ada___keccak__keccak_1600__sponge__context__block ctx__split_fields3)
  0 r120s)))
  (exists ((o11 integer))
  (and
  (= (to_rep o11) (last1
  ...
  (= (to_rep o12) (first1
                  ada___keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl))
  (exists
  ((ada___keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data (Array Int byte)))
  ...
  (= (select usf temp___1016) (select (to_array
                                      (of_array
                                      (slide1 (to_array temp___1013)
                                      (first1 temp___1013) 0) 0 r120s)) temp___1016))
  (= (select usf temp___1016) (select (rec__ada___keccak__keccak_1600__sponge__context__block
                                      ctx__split_fields3) temp___1016))))
  (exists ((ctx__split_fields4 us_split_fields))
  (and
  (= ctx__split_fields4 (us_split_fieldsqtmk
                        (rec__ada___keccak__keccak_1600__sponge__context__state
                        ctx__split_fields3) usf
                        (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
                        ctx__split_fields3)
                        (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
                        ctx__split_fields3)
  ...
  (= (+ offset remaining) (length (to_rep digest__first)
                          (to_rep digest__last)))
  (forall ((spark__branch2 Bool) (ctx__split_fields3 us_split_fields)
  (digest1 (Array Int byte)) (remaining1 Int) (offset1 Int))
  (=>
  (exists ((o8 Int))
  (and
  (= (to_rep4
  ...
  (and (= spark__branch3 (ite (< 0 o8) true false))
  ...
  (and (= bytes_to_squeeze o11)
  (and (dynamic_invariant bytes_to_squeeze true false true true)
  (exists ((spark__branch4 Bool) (bytes_to_squeeze1 Int))
  (and
  ...
  (exists ((o12 Int))
  (and (= (to_rep digest__first) o12)
  (let ((o13 (+ o12 offset)))
  (and (in_range1 o13)
  (and (= o13 r123s)
  (and (dynamic_invariant2 r123s true false true true)
  (let ((o14 (+ offset bytes_to_squeeze1)))
  (and (in_range1 o14)
  (exists ((o15 Int))
  (and (= (to_rep digest__first) o15)
  (let ((o16 (+ o15 (- o14 1))))
  (and (in_range1 o16)
  (and (= o16 r124s)
  (and (dynamic_invariant2 r124s true false true true)
  (exists
  ((ada___keccak__keccak_1600__sponge__squeeze__B_2__R127s__assume Int))
  (and
  (= (to_rep4
     (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
     ctx__split_fields2)) ada___keccak__keccak_1600__sponge__squeeze__B_2__R127s__assume)
  (and
  ...
  (let ((o18 (+ o17 (- bytes_to_squeeze1 1))))
  (and (in_range1 o18)
  (and (= o18 r128s)
  ...
  (let ((temp___1024 (of_array
                     (rec__ada___keccak__keccak_1600__sponge__context__block
                     ctx__split_fields2) r127s r128s)))
  (and
  ...
  (= (select usf temp___1028) (select (to_array temp___1025) temp___1028))
  (= (select usf temp___1028) (select digest temp___1028))))
  (and (= digest1 usf)
  (exists ((o19 Int))
  (and
  (= (to_rep4
     (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
     ctx__split_fields2)) o19)
  ...
  (= ctx__split_fields4 (us_split_fieldsqtmk
                        ...
                        ctx__split_fields2)
                        (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
                        ctx__split_fields2) o21
                        (rec__ada___keccak__keccak_1600__sponge__context__rate
                        ctx__split_fields2)
                        (rec__ada___keccak__keccak_1600__sponge__context__curr_state
                        ctx__split_fields2)))
  (let ((o22 (+ offset bytes_to_squeeze1)))
  (and (in_range1 o22)
  (and (= offset1 o22)
  (let ((o23 (- remaining bytes_to_squeeze1)))
  (and (in_range1 o23)
  (and (in_range2 o23)
  (and (= remaining1 o23)
  (exists ((o24 Int))
  ...
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields4)) o24)
  (exists ((o25 Int))
  (and
  (= (to_rep4
     (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
     ctx__split_fields4)) o25)
  (and (= spark__branch2 (ite (<= o24 o25) true false))
  ...
  (= ctx__split_fields3 ctx__split_fields2)) (= digest1 digest))
  ...
  (forall ((ctx__split_fields4 us_split_fields) (digest2 (Array Int byte))
  (remaining2 Int) (offset2 Int))
  (=>
  ...
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields3)) o8)
  (ite (<= o8 remaining1)
  (let ((o9 (us_repqtmk ctx__split_fields3)))
  (let ((o10 (rate_of o9)))
  (and
  (and (rate_of__function_guard o10 o9)
  ...
  (< o10 1600))))
  (let ((o11 (us_repqtmk ctx__split_fields3)))
  (let ((o12 (state_of o11)))
  (and
  (and (state_of__function_guard o12 o11)
  (and (dynamic_invariant3 o12 true false true true)
  (= o12 (to_rep3
         (rec__ada___keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields3)))))
  (exists ((o13 Int))
  (and (= (to_rep digest__last) o13)
  (exists ((o14 Int))
  (and (= (to_rep digest__first) o14)
  (and (in_range1 (length o14 o13))
  (and (in_range1 (+ offset1 remaining1))
  (exists ((ctx__split_fields5 us_split_fields) (digest3 (Array Int byte))
  ...
  (= (+ offset3 remaining3) (length (to_rep digest__first)
                            (to_rep digest__last)))
  (= (state_of (us_repqtmk ctx__split_fields5)) 1))
  (= (rate_of (us_repqtmk ctx__split_fields5)) initial_rate))
  (and
  (= (and (ite (and
               ...
               (= (select (rec__ada___keccak__keccak_1600__sponge__context__block
                          ctx__split_fields5) temp___1067) (select (rec__ada___keccak__keccak_1600__sponge__context__block
                                                                   ctx__split_fields3) temp___1067)))))
               (= (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
  ...
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields5)) o17)
  (let ((o18 (+ offset3 o17)))
  (and (in_range1 o18)
  (exists ((o19 Int))
  (and (= (to_rep digest__first) o19)
  (let ((o20 (+ o19 (- o18 1))))
  (and (in_range1 o20)
  (and (= o20 r135s)
  ...
  (= (select usf temp___1052) (select (to_array temp___1049) temp___1052))
  (= (select usf temp___1052) (select digest3 temp___1052))))
  (and (= digest2 usf)
  (exists
  ((ada___keccak__keccak_1600__keccakf_1600_permutation__permute__a map1))
  (exists ((ctx__split_fields6 us_split_fields))
  ...
  (let ((ada___keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl 
  (of_array
  (rec__ada___keccak__keccak_1600__sponge__context__block ctx__split_fields6)
  0 r141s)))
  (exists ((o23 integer))
  (and
  (= (to_rep o23) (last1
  ...
  (= (select usf1 temp___1060) (select (to_array
                                       (of_array
                                       (slide1 (to_array temp___1057)
                                       (first1 temp___1057) 0) 0 r141s)) temp___1060))
  (= (select usf1 temp___1060) (select (rec__ada___keccak__keccak_1600__sponge__context__block
                                       ctx__split_fields6) temp___1060))))
  (and
  (= ctx__split_fields4 (us_split_fieldsqtmk
                        (rec__ada___keccak__keccak_1600__sponge__context__state
                        ctx__split_fields6) usf1
                        (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
                        ctx__split_fields6)
                        (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
                        ctx__split_fields6)
  ...
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields4)) o27)
  (let ((o28 (- remaining3 o27)))
  (and (in_range2 o28)
  (and (= remaining2 o28)
  (exists ((o29 Int))
  (and
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields4)) o29)
  (not (<= o29 remaining2)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
  (and
  (and (and (= ctx__split_fields4 ctx__split_fields3) (= digest2 digest1))
  ...
  (=>
  (exists ((spark__branch3 Bool))
  (and (= spark__branch3 (ite (< 0 remaining2) true false))
  (ite (= spark__branch3 true)
  (exists ((o8 Int))
  (and (= (to_rep digest__first) o8)
  (let ((o9 (+ o8 offset2)))
  (and (in_range1 o9)
  (and (= o9 r144s)
  (and (dynamic_invariant2 r144s true false true true)
  (let ((o10 (+ offset2 remaining2)))
  (and (in_range1 o10)
  (exists ((o11 Int))
  (and (= (to_rep digest__first) o11)
  (let ((o12 (+ o11 (- o10 1))))
  (and (in_range1 o12)
  (and (= o12 r145s)
  (and (dynamic_invariant2 r145s true false true true)
  (and (= (- remaining2 1) r148s)
  (and (dynamic_invariant2 r148s true false true true)
  (and
  (=> (<= 0 r148s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r148s) (<= r148s 199))))
  (let ((temp___1079 (of_array
                     (rec__ada___keccak__keccak_1600__sponge__context__block
                     ctx__split_fields4) 0 r148s)))
  (and
  (ite (<= (first1 temp___1079) (last1 temp___1079))
  (and (<= r144s r145s)
  (= (- (last1 temp___1079) (first1 temp___1079)) (- r145s r144s)))
  (< r145s r144s))
  (let ((temp___1080 (of_array
                     (slide1 (to_array temp___1079) (first1 temp___1079)
                     r144s) r144s r145s)))
  (and
  (=> (<= r144s r145s)
  (and
  ...
  (let ((temp___1081 (of_array digest2 r144s r145s)))
  (and
  (ite (<= (first1 temp___1080) (last1 temp___1080))
  (and (<= (first1 temp___1081) (last1 temp___1081))
  (= (- (last1 temp___1080) (first1 temp___1080)) (- (last1 temp___1081) 
  (first1 temp___1081)))) (< (last1 temp___1081) (first1 temp___1081)))
  (exists ((usf (Array Int byte)))
  (and
  (forall ((temp___1083 Int))
  (ite (and (<= r144s temp___1083) (<= temp___1083 r145s))
  (= (select usf temp___1083) (select (to_array temp___1080) temp___1083))
  (= (select usf temp___1083) (select digest2 temp___1083))))
  (and (in_range6 remaining2)
  (exists ((o13 byte_absorption_number))
  (and (= (to_rep4 o13) remaining2)
  (= ctx__split_fields5 (us_split_fieldsqtmk
                        (rec__ada___keccak__keccak_1600__sponge__context__state
                        ctx__split_fields4)
                        (rec__ada___keccak__keccak_1600__sponge__context__block
  ...
  (=>
  (forall ((ctx__split_fields6 us_split_fields)) (state_of__function_guard
  (state_of (us_repqtmk ctx__split_fields6))
  (us_repqtmk ctx__split_fields6)))
  (= (state_of (us_repqtmk ctx__split_fields5)) 1))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
