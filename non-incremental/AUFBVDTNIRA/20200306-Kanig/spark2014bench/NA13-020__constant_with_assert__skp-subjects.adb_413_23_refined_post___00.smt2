...
(define-fun to_int3 ((x word32)) Int (ubv_to_int (to_rep1 x)))
...
(define-fun to_int4 ((x word64)) Int (ubv_to_int (to_rep2 x)))
...
;; defqtvc
 ;; File "skp-subjects.ads", line 44, characters 0-0
  ...
  (ada___skp__subjects__get_pml4_address__result (_ BitVec 64)))
  (=> (dynamic_invariant subject_id true false true true)
  (=>
  (forall ((subject Int))
  (=> (and (<= 0 subject) (<= subject 0))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject Int))
  (=> (and (<= 1 subject) (<= subject 1))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject Int))
  (=> (and (<= 2 subject) (<= subject 2))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject Int))
  (=> (and (<= 3 subject) (<= subject 3))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject Int))
  (=> (and (<= 4 subject) (<= subject 4))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject Int))
  (=> (and (<= 5 subject) (<= subject 5))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject Int))
  (=> (and (<= 6 subject) (<= subject 6))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (= (to_rep2
     (rec__ada___skp__subjects__subject_spec_type__pml4_address
     (us_split_fields7 (select subject_specs subject_id)))) o)
