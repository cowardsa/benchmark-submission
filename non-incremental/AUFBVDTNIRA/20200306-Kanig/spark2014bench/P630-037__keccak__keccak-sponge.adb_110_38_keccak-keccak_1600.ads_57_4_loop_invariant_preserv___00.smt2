...
;; defqtvc
 ;; File "keccak-sponge.ads", line 146, characters 0-0
  ...
  (=> (<= initial_bit_rate remaining_bits1)
  ...
  (= o13 (to_rep3
         (rec__ada___keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields3)))))
  (=> (in_range1 (+ remaining_bits1 7))
  (=> (in_range1 (+ offset1 remaining_bytes1))
  ...
  (and
  (and
  (and (= (+ offset2 remaining_bytes2) initial_data_len)
  (= remaining_bytes2 (div1 (+ remaining_bits2 7) 8)))
  (= (mod2 bit_length 8) (mod2 remaining_bits2 8)))
  (= (state_of (us_repqtmk ctx__split_fields4)) 0))
  (= (rate_of (us_repqtmk ctx__split_fields4)) initial_bit_rate))
  (=>
  (= (and (ite (and
               (and
               (and (dynamic_invariant offset2 true true true true)
               ...
               (and
               (= (rec__ada___keccak__keccak_1600__sponge__context__block
                  ctx__split_fields4) (rec__ada___keccak__keccak_1600__sponge__context__block
                                      ctx__split_fields3))
               (= (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
               ...
               (= (rec__ada___keccak__keccak_1600__sponge__context__curr_state
                  ctx__split_fields4) (rec__ada___keccak__keccak_1600__sponge__context__curr_state
                                      ctx__split_fields3))))
               (dynamic_invariant remaining_bytes2 true true true true))
          true false) (ite (<= initial_bit_rate remaining_bits2) true false)) true)
  (forall ((temp___901 Int))
  (=> (= temp___901 remaining_bytes2)
  (forall ((temp___900 Int))
  (=> (= temp___900 remaining_bits2)
  (forall ((temp___899 Int))
  (=> (= temp___899 offset2)
  (let ((o14 (+ (first1 data) offset2)))
  (=> (in_range1 o14)
  (=> (= o14 r74s)
  (=> (dynamic_invariant2 r74s true false true true)
  (forall ((o15 Int))
  (=>
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields4)) o15)
  (let ((o16 (+ offset2 (- o15 1))))
  (=> (in_range1 o16)
  (let ((o17 (+ (first1 data) o16)))
  (=> (in_range1 o17)
  (=> (= o17 r75s)
  (=> (dynamic_invariant2 r75s true false true true)
  (=>
  (=> (<= r74s r75s)
  ...
  (= (to_rep6
     (rec__ada___keccak__keccak_1600__sponge__context__rate
     ctx__split_fields6)) o20)
  (let ((o21 (- remaining_bytes2 o20)))
  (=> (in_range2 o21)
  (forall ((remaining_bytes3 Int))
  (=> (= remaining_bytes3 o21)
  (let ((o22 (- remaining_bits2 initial_bit_rate)))
  (=> (in_range2 o22)
  (forall ((remaining_bits3 Int))
  (=> (= remaining_bits3 o22)
  (=> (<= initial_bit_rate remaining_bits3)
  (let ((o23 (us_repqtmk ctx__split_fields6)))
  (let ((o24 (rate_of o23)))
  (=>
  (and (rate_of__function_guard o24 o23)
  ...
  (< o24 1600))))
  (let ((o25 (us_repqtmk ctx__split_fields6)))
  (let ((o26 (state_of o25)))
  (=>
  (and (state_of__function_guard o26 o25)
  (and (dynamic_invariant3 o26 true false true true)
  (= o26 (to_rep3
         (rec__ada___keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields6)))))
  (=> (in_range1 (+ remaining_bits3 7))
  (=> (in_range1 (+ offset3 remaining_bytes3))
  (= (+ offset3 remaining_bytes3) initial_data_len)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
