...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 274, characters 0-0
  ...
  (=> (= i temp___630)
  (=>
  (= (and (ite (<= temp___630 i) true false) (ite (<= i (- o6 1)) true false)) true)
  (forall ((i1 Int))
  (=>
  (= (and (ite true true false) (ite (and (<= position i1)
                                     (<= i1 (- (+ position (length
                                                           ...
                                                           value__last))) 1)))
                                true false)) true)
  (=> (and (<= (first3 data) i1) (<= i1 (last3 data)))
  (forall ((o7 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array1 data) i1)) o7)
  (forall ((o8 character))
  (=> (= (to_rep o8) (ubv_to_int o7))
  (let ((o9 (- i1 position)))
  (=> (in_range1 o9)
  (forall ((o10 Int))
  (=> (= (to_rep1 value__first) o10) (in_range1 (+ o10 o9)))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
