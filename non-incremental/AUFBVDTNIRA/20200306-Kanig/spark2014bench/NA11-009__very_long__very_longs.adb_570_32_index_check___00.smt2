...
(((t108b__refqtmk (t108b__content us_t)))))
...
(((t109b__refqtmk (t109b__content us_t)))))
...
(declare-datatypes ((s129b__ref 0))
(((s129b__refqtmk (s129b__content us_t)))))
...
(declare-datatypes ((s133b__ref 0))
(((s133b__refqtmk (s133b__content us_t)))))
...
;; defqtvc
 ;; File "very_longs.ads", line 65, characters 0-0
  ...
  (forall ((very_longs__divide__R130b__assume Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__length quotient__split_discrs)) very_longs__divide__R130b__assume)
  (=> (= very_longs__divide__R130b__assume r130b)
  (=> (dynamic_invariant7 r130b true false true true)
  (let ((temp___1174 (temp_____aggregate_def_1168 #x00 1 r130b)))
  (=> (= (first1 temp___1174) 1)
  (=> (= (last1 temp___1174) r130b)
  (=>
  (ite (<= (first1 temp___1174) (last1 temp___1174))
  (and (<= 1 r130b)
  (= (- (last1 temp___1174) (first1 temp___1174)) (- r130b 1))) (< r130b 1))
  (let ((temp___1176 (of_array (to_array temp___1174) (first1 temp___1174)
                     (last1 temp___1174))))
  (=>
  ...
  (forall ((very_longs__divide__R134b__assume Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__length remainder__split_discrs)) very_longs__divide__R134b__assume)
  (=> (= very_longs__divide__R134b__assume r134b)
  (=> (dynamic_invariant7 r134b true false true true)
  (let ((temp___1187 (temp_____aggregate_def_1181 #x00 1 r134b)))
  (=> (= (first1 temp___1187) 1)
  (=> (= (last1 temp___1187) r134b)
  (=>
  (ite (<= (first1 temp___1187) (last1 temp___1187))
  (and (<= 1 r134b)
  (= (- (last1 temp___1187) (first1 temp___1187)) (- r134b 1))) (< r134b 1))
  ...
  (=>
  (= remainder__split_fields1 (of_array (to_array temp___1189)
                              (first1 temp___1189) (last1 temp___1189)))
  (let ((o2 divisor))
  (let ((temp___1194 (number_of_digits1 o2)))
  (=>
  (and (number_of_digits__function_guard1 temp___1194 o2)
  (and (dynamic_invariant1 temp___1194 true false true true)
  (and
  (=> (< 0 temp___1194)
  (not
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits (us_split_fields1 o2))) temp___1194)) #x00)))
  (forall ((i Int))
  (=>
  (and (<= (+ temp___1194 1) i)
  (<= i (last1
  ...
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits (us_split_fields1 o2))) i)) #x00))))))
  (=> (dynamic_property1 1 last2 temp___1194)
  (forall ((n1 Int))
  (=> (= n1 temp___1194)
  (forall ((o3 Int))
  (=>
  ...
  (let ((temp___1195 (- o3 n1)))
  (=> (dynamic_property2 first2 last3 temp___1195)
  (forall ((m1 Int))
  (=> (= m1 temp___1195)
  (let ((temp___1196 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 divisor))))
  (=> (and (<= (first1 temp___1196) n1) (<= n1 (last1 temp___1196)))
  (forall ((o4 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1196) n1)) o4)
  ...
  true true true true)
  (let ((temp___1197 (of_base
                     (us_repqtmk u__split_discrs
                     (us_split_fieldsqtmk
                     very_longs__divide__full_left_shift__result__fields)))))
  (forall ((u__split_fields1 us_t))
  (=>
  (= (us_split_fieldsqtmk1 u__split_fields1) (us_split_fields3 temp___1197))
  (=> (= u__split_discrs (us_split_discrs2 temp___1197))
  (forall ((o6 Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))) o6)
  (let ((temp___1198 (of_base1 divisor)))
  (forall ((v__split_fields1 us_t))
  (=>
  (= (us_split_fieldsqtmk2 v__split_fields1) (us_split_fields5 temp___1198))
  (=> (= v__split_discrs (us_split_discrs3 temp___1198))
  ...
  (=>
  (let ((temp___1201 r137b))
  (exists ((j Int))
  (and (= j temp___1201)
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1201) true false)) true)
  (exists ((quotient__split_fields2 us_t) (u__split_fields3 us_t)
  (q_hat1 (_ BitVec 16)) (current_borrow1 (_ BitVec 16)) (j1 Int))
  (and
  (= (and (ite (and
               (and
               (and (dynamic_invariant6 current_borrow1 false true true true)
               (dynamic_invariant2
               (us_repqtmk1 u__split_discrs
               (us_split_fieldsqtmk1 u__split_fields3)) false true true
          ...
          true false) (ite (and (<= 1 j1) (<= j1 r137b)) true false)) true)
  (and (in_range1 j1)
  ...
  (=> (= n1 r139b)
  (=> (dynamic_invariant8 r139b true false true true)
  (let ((temp___1207 r139b))
  (forall ((divisor_index Int))
  (=> (= divisor_index 1)
  (=>
  (= (and (ite (<= 1 divisor_index) true false) (ite (<= divisor_index temp___1207)
                                                true false)) true)
  ...
  (= (and (ite (and (dynamic_invariant
               ...
               true true)
               (forall ((temp___1214 Int))
               (=>
               (and (<= (first1 remainder__split_fields2) temp___1214)
               (<= temp___1214 (last1 remainder__split_fields2)))
               (=>
               (or (< temp___1207 temp___1214)
               (or (< temp___1214 1) (<= divisor_index1 temp___1214)))
               (= (select (to_array remainder__split_fields2) temp___1214) (select 
               (to_array remainder__split_fields1) temp___1214))))))
          true false) (ite (and (<= 1 divisor_index1)
                           (<= divisor_index1 r139b))
                      true false)) true)
  (=>
