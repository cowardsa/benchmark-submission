...
;; defqtvc
 ;; File "core.ads", line 29, characters 0-0
  (not
  (forall ((self__ us_split_fields2) (o Int) (spark__branch Bool)
  (o1 (_ BitVec 8)) (o2 integer) (o3 (_ BitVec 8)) (self__1 us_split_fields2)
  (o4 (_ BitVec 8)) (o5 (_ BitVec 8)) (self__2 us_split_fields2)
  (o6 (_ BitVec 8)) (o7 message_index) (self__3 us_split_fields2) (o8 Int))
  (=> (dynamic_invariant n true false true true)
  (=> (= (to_rep3 (rec__core__mailboxT__count self__)) o)
  (=> (= spark__branch (ite (< o 16) true false))
  (=> (= spark__branch true)
  (=> (= (to_rep2 (rec__core__mailboxT__next_in self__)) o1)
  (=> (= (to_rep o2) n)
  (=> (= (to_rep2 (rec__core__mailboxT__next_in self__)) o3)
  (=>
  ...
  (=> (= (to_rep2 (rec__core__mailboxT__next_in self__1)) o4)
  (=> (= (to_rep2 (rec__core__mailboxT__next_in self__1)) o5)
  (=>
  (= self__2 (us_split_fieldsqtmk1
             (store (rec__core__mailboxT__messages self__1) o5 (us_repqtmk
                                                               (us_split_fieldsqtmk
                                                               (rec__core__message_record__value
                                                               (us_split_fields1
                                                               (select 
                                                               ...
                                                               self__1) o4)))
                                                               rliteral1)))
             (rec__core__mailboxT__next_in self__1)
             (rec__core__mailboxT__next_out self__1)
             (rec__core__mailboxT__count self__1)))
  (=> (= (to_rep2 (rec__core__mailboxT__next_in self__2)) o6)
  (=> (= (to_rep2 o7) (bvurem (bvadd o6 #x01) #x10))
  (=>
  (= self__3 (us_split_fieldsqtmk1 (rec__core__mailboxT__messages self__2) o7
