...
;; defqtvc
 ;; File "hermes-der-decode.adb", line 310, characters 0-0
  (not
  (forall ((stop Int) (value Int) (status Int) (result__ Int))
  (=> (dynamic_invariant3 message true false true true)
  (=> (dynamic_invariant1 length1 true false true true)
  (=> (dynamic_invariant1 length_stop true false true true)
  (=> (dynamic_invariant3 message true false true true)
  ...
  (let ((o (+ length_stop 1)))
  (=> (in_range1 o)
  (=> (and (<= (first1 message) o) (<= o (last1 message)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep1 (select (to_array message) o)) o1)
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (= (bvand o1 #x80) #x00) true false))
  (=> (not (= spark__branch true))
  (forall ((result__1 Int))
  (=>
  (let ((temp___308 length1))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___308) true false)) true)
  (exists ((result__2 Int) (i1 Int))
  (and
  (= (and (ite (dynamic_invariant result__2 true true true true) true false) 
  (ite (and (<= 1 i1) (<= i1 length1)) true false)) true)
  (let ((o2 (+ length_stop i1)))
  (and (in_range1 o2)
  (and (and (<= (first1 message) o2) (<= o2 (last1 message)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) o2)) o3)
  (let ((o4 (* 256 result__2)))
  (and (in_range1 o4)
  (let ((o5 (+ o4 (ubv_to_int (bvxor o3 #xFF)))))
  (and (in_range1 o5) (and (= result__1 o5) (= i1 temp___308)))))))))))))
  (= result__1 result__)))))
  (forall ((spark__branch1 Bool))
  (=> (= spark__branch1 (ite (= result__1 2147483647) true false))
  (=> (not (= spark__branch1 true)) (in_range1 (+ result__1 1)))))))))))))))))))))))))))))))
(check-sat)
(exit)
