...
;; defqtvc
 ;; File "aco-math-very_longs.adb", line 39, characters 0-0
  ...
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1470) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___1479)
               (<= temp___1479 (last1 result____split_fields2)))
               (=>
               (or (< temp___1470 temp___1479)
               (or (< temp___1479 1) (<= i1 temp___1479)))
               (= (select (to_array result____split_fields2) temp___1479) (select 
  ...
  (let ((temp___1471 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1471) i1) (<= i1 (last1 temp___1471)))
  (forall ((o (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1471) i1)) o)
  ...
  (let ((temp___1472 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1472) i1) (<= i1 (last1 temp___1472)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1472) i1)) o1)
  ...
  false true true))
  (forall ((o4 octet))
  (=> (= (to_rep2 o4) o3) (<= (first1 result____split_fields2) i1)))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
