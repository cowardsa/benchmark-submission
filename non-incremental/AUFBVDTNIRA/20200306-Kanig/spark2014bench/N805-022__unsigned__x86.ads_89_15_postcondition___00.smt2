...
;; Nth_bv_is_nth2
  ...
  (=> (and (<= 0 i) (< i 256)) (= (nth_bv3 x ((_ int_to_bv 8) i)) (nth3 x i)))))
...
(((t__refqtmk3 (t__content3 (_ BitVec 8))))))
...
(declare-fun readmem16 ((_ BitVec 64)
  (Array (_ BitVec 64) unsigned_8)) (_ BitVec 16))
...
(define-fun dynamic_invariant1 ((temp___expr_180 (_ BitVec 16))
...
;; readmem16__post_axiom
  ...
  (! (=> (dynamic_invariant addr true true true true)
     ...
     (bvuge result #x0000)) (dynamic_invariant1 result true false true true))))) :pattern (
...
(assert
;; defqtvc
 ;; File "x86.ads", line 87, characters 0-0
  (not
  (forall ((memory (Array (_ BitVec 64) unsigned_8)))
  (=> (dynamic_invariant addr true false true true)
  (let ((o (bvadd addr #x0000000000000002)))
  (let ((o1 (readmem16 o memory)))
  (=>
  (and (readmem16__function_guard o1 o memory)
  (and (dynamic_invariant1 o1 true false true true)
  (and
  (= o1 (bvadd ((_ zero_extend 8) (to_rep (select memory o))) (bvmul ((_ zero_extend 8) 
  (to_rep (select memory (bvadd o #x0000000000000001)))) #x0100)))
  (bvuge o1 #x0000))))
  (let ((o2 addr))
  (let ((o3 (readmem16 o2 memory)))
  (=>
  (and (readmem16__function_guard o3 o2 memory)
  (and (dynamic_invariant1 o3 true false true true)
  (and
  (= o3 (bvadd ((_ zero_extend 8) (to_rep (select memory o2))) (bvmul ((_ zero_extend 8) 
  (to_rep (select memory (bvadd o2 #x0000000000000001)))) #x0100)))
  (bvuge o3 #x0000))))
  (forall ((x86__readmem32__result (_ BitVec 32)))
  (=>
  (= x86__readmem32__result (bvadd ((_ zero_extend 16) o3) (bvmul ((_ zero_extend 16) o1) #x00010000)))
  (=>
  ...
  (= x86__readmem32__result (bvadd ((_ zero_extend 16) (readmem16 addr
