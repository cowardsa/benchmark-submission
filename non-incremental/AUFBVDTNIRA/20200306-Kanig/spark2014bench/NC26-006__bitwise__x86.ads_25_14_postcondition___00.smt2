...
(assert
;; defqtvc
 ;; File "x86.ads", line 23, characters 0-0
  (not
  (forall ((memory (Array (_ BitVec 64) unsigned8)) (o (_ BitVec 16)))
  ...
  (= o2 (to_rep (select memory o1)))))
  (= o (bvshl ((_ zero_extend 8) o2) ((_ int_to_bv 16) 8)))))) (= o #x0000))
  (let ((o1 addr))
  (let ((o2 (readmem8 o1 memory)))
  (=>
  (and (readmem8__function_guard o2 o1 memory)
  ...
  (=> (= x86__readmem16__result (bvor ((_ zero_extend 8) o2) o))
  (= x86__readmem16__result (bvor ((_ zero_extend 8) (to_rep
                                                     (select memory addr))) 
  (ite (< 8 16)
  (bvshl ((_ zero_extend 8) (to_rep
                            (select memory (bvadd addr #x0000000000000001)))) ((_ int_to_bv 16) 8))
  #x0000)))))))))))))
(check-sat)
(exit)
