...
;; defqtvc
 ;; File "polyorb_hi-output.ads", line 87, characters 0-0
  ...
  (=> (= (to_rep (select hex (ubv_to_int (bvurem o #x10)))) temp___351)
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep3 (select (to_array1 stream) j1)) o1)
  (forall ((temp___349 Int))
  (=> (= (to_rep (select hex (ubv_to_int (bvudiv o1 #x10)))) temp___349)
  (let ((o2 (- (+ 1 (+ 1 1)) 1)))
  (=> (in_range1 o2)
  (forall ((o3 character))
  (=> (= (to_rep o3) temp___349)
  (forall ((o4 character))
  (=> (= (to_rep o4) 32)
  (let ((temp___350 (of_array (concat_singletons o4 1 o3) 1 o2)))
  (=> (not (= (length1 temp___350) 0)) (in_range1
  (- (+ (first1 temp___350) (+ (length (first1 temp___350)
