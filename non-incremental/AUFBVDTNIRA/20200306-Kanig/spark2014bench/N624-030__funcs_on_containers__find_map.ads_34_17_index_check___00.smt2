...
;; defqtvc
 ;; File "find_map.ads", line 26, characters 0-0
  ...
  (let ((temp___879 (element find_map__find_all__result usf)))
  (=>
  (and (dynamic_invariant2 temp___879 true false true true)
  (= temp___879 (get (model1 find_map__find_all__result) usf)))
  (<= (first1 a) temp___879))))))))))))))))))))))))))))
(check-sat)
(exit)
