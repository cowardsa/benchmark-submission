...
;; defqtvc
 ;; File "test.ads", line 13, characters 0-0
  ...
  (=>
  (let ((o5 (ubv_to_int (bvurem i #x0000000000000020))))
  (and (in_range2 o5)
  (ite (< o5 4294967296) (= o4 (bvshl #x00000001 ((_ int_to_bv 32) o5)))
  (= o4 #x00000000))))
  (let ((o5 (ubv_to_int (bvudiv i #x0000000000000020))))
  (=> (in_range2 o5)
  (let ((o6 (+ a_first o5))) (=> (in_range1 o6) (<= (first1 a) o6))))))))))))))))))))))))))
(check-sat)
(exit)
