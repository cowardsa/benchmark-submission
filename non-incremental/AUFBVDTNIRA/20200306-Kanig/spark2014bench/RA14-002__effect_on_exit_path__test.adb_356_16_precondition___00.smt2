...
(define-fun to_int5 ((x os_mbx_mask_t)) Int (ubv_to_int (to_rep4 x)))
...
(define-fun bool_eq5 ((a (Array Int us_rep2)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq4 (select a temp___idx_171)
...
;; os_mbx_get_mbx_entry__def_axiom
  ...
  (! (=>
     ...
     (= (os_mbx_get_mbx_entry task_id index test__os_task_mbx_rw) (let ((temp___462 
                                                                  (rec__test__os_mbx_t__mbx_array
                                                                  (us_split_fields3
                                                                  (select test__os_task_mbx_rw task_id)))))
                                                                  (select temp___462 
...
;; os_mbx_is_waiting_mbx_entry__def_axiom
  ...
  (! (and
     ...
     (not
     (= (bvand (os_mbx_get_waiting_mask task_id test__os_task_list_rw) (bvshl #x00000001 ((_ int_to_bv 32) 
...
(define-fun dynamic_invariant3 ((temp___expr_284 (_ BitVec 8))
  (temp___is_init_280 Bool) (temp___skip_constant_281 Bool)
  (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool true)
...
(define-fun to_int6 ((x unsigned_char)) Int (ubv_to_int (to_rep5 x)))
...
(define-fun dynamic_invariant5 ((temp___expr_198 (_ BitVec 32))
  (temp___is_init_194 Bool) (temp___skip_constant_195 Bool)
  (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool true)
...
;; os_mbx_get_mbx_entry_sender__post_axiom
  ...
  (! (and
     ...
     (rec__test__os_mbx_entry_t__sender_id
     (us_split_fields1
     (let ((temp___442 (rec__test__os_mbx_t__mbx_array
                       (us_split_fields3
                       (select test__os_task_mbx_rw task_id)))))
     (select temp___442 (oadd
                        (os_mbx_get_mbx_head task_id test__os_task_mbx_rw)
                        index))))))))
...
;; os_mbx_get_mbx_entry_sender__def_axiom
  ...
  (! (=>
     ...
     (rec__test__os_mbx_entry_t__sender_id
     (us_split_fields1
     (let ((temp___450 (rec__test__os_mbx_t__mbx_array
                       (us_split_fields3
                       (select test__os_task_mbx_rw task_id)))))
     (select temp___450 (oadd
                        (os_mbx_get_mbx_head task_id test__os_task_mbx_rw)
...
;; def_axiom
  ...
  (let ((temp___502 (temp_____aggregate_def_501 temp___503 temp___504
                    temp___505)))
  (=> (dynamic_invariant4 temp___504 true true true true)
...
;; defqtvc
 ;; File "test.ads", line 80, characters 0-0
  ...
  (mbx_entry__split_fields us_split_fields)
  (os_task_list_rw (Array Int us_rep2)) (os_task_current Int))
  ...
  (=>
  (and (= (os_ghost_mbx_are_well_formed os_task_mbx_rw) true)
  (not (= (os_mbx_is_empty current os_task_mbx_rw) true)))
  (=>
  (= (and (ite (and (dynamic_property #x00 r25b iterator1)
               (dynamic_invariant2 status1 false true true true))
          true false) (ite (and (bvule #x00 iterator1)
                           (bvule iterator1 r25b))
                      true false)) true)
  (=> (in_range2 iterator1)
  (let ((o7 current))
  (let ((o8 (os_mbx_is_waiting_mbx_entry o7 iterator1 os_task_mbx_rw
            os_task_list_rw)))
  (=>
  (forall ((os_task_list_rw1 (Array Int us_rep2)) (o9 Int))
  (os_mbx_get_waiting_mask__function_guard
  (os_mbx_get_waiting_mask o9 os_task_list_rw1) o9 os_task_list_rw1))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (iterator2 (_ BitVec 8))
  (o9 Int)) (os_mbx_get_mbx_entry_sender__function_guard
  (os_mbx_get_mbx_entry_sender o9 iterator2 os_task_mbx_rw1) o9 iterator2
  os_task_mbx_rw1))
  (=>
  (and (os_mbx_is_waiting_mbx_entry__function_guard o8 o7 iterator1
  os_task_mbx_rw os_task_list_rw)
  (= (= o8 true)
  (not
  (= (bvand (os_mbx_get_waiting_mask o7 os_task_list_rw) (bvshl #x00000001 ((_ int_to_bv 32) 
  (os_mbx_get_mbx_entry_sender o7 iterator1 os_task_mbx_rw)))) #x00000000))))
  (forall ((spark__branch1 Bool))
  (=> (= spark__branch1 o8)
  (=> (= spark__branch1 true)
  (=> (in_range2 iterator1)
  (let ((o9 current))
  (let ((temp___591 (os_mbx_get_mbx_entry o9 iterator1 os_task_mbx_rw)))
  (=>
  ...
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (iterator2 (_ BitVec 8))
  (o10 Int)) (oadd__function_guard
  (oadd (os_mbx_get_mbx_head o10 os_task_mbx_rw1) iterator2)
  (os_mbx_get_mbx_head o10 os_task_mbx_rw1) iterator2))
  (=>
  (and (os_mbx_get_mbx_entry__function_guard temp___591 o9 iterator1
  os_task_mbx_rw)
  (= temp___591 (select (rec__test__os_mbx_t__mbx_array
                        (us_split_fields3 (select os_task_mbx_rw o9))) 
  (oadd (os_mbx_get_mbx_head o9 os_task_mbx_rw) iterator1))))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o10 Int))
  (os_mbx_is_empty__function_guard (os_mbx_is_empty o10 os_task_mbx_rw1) o10
  os_task_mbx_rw1)) (not (= (os_mbx_is_empty current os_task_mbx_rw) true))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
