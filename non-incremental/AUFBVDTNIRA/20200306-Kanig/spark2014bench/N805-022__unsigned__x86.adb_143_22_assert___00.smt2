...
(define-fun to_int4 ((x unsigned_8)) Int (ubv_to_int (to_rep x)))
...
(define-fun dynamic_invariant1 ((temp___expr_173 (_ BitVec 32))
...
(assert
;; defqtvc
 ;; File "x86.ads", line 95, characters 0-0
  (not
  (forall ((memory (Array (_ BitVec 64) unsigned_8)))
  (=> (dynamic_invariant addr true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (forall ((o unsigned_8))
  (=> (= (to_rep o) ((_ extract 7 0) (bvurem val__ #x00000100)))
  (forall ((memory1 (Array (_ BitVec 64) unsigned_8)))
  (=> (= memory1 (store memory addr o))
  (forall ((o1 unsigned_8))
  (=>
  (= (to_rep o1) ((_ extract 7 0) (bvurem (bvudiv val__ #x00000100) #x00000100)))
  (forall ((memory2 (Array (_ BitVec 64) unsigned_8)))
  (=> (= memory2 (store memory1 (bvadd addr #x0000000000000001) o1))
  (forall ((o2 unsigned_8))
  (=>
  (= (to_rep o2) ((_ extract 7 0) (bvurem (bvudiv val__ #x00010000) #x00000100)))
  (forall ((memory3 (Array (_ BitVec 64) unsigned_8)))
  (=> (= memory3 (store memory2 (bvadd addr #x0000000000000002) o2))
  (forall ((o3 unsigned_8))
  (=>
  (= (to_rep o3) ((_ extract 7 0) (bvurem (bvudiv val__ #x01000000) #x00000100)))
  (forall ((memory4 (Array (_ BitVec 64) unsigned_8)))
  (=> (= memory4 (store memory3 (bvadd addr #x0000000000000003) o3))
  (=>
  (= (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) 
  (to_rep (select memory4 (bvadd addr #x0000000000000001)))) #x00000100)) (bvurem 
  val__ #x00010000))
  (=>
  (= (bvadd ((_ zero_extend 24) (to_rep
                                (select memory4 (bvadd addr #x0000000000000002)))) (bvmul ((_ zero_extend 24) 
  (to_rep (select memory4 (bvadd addr #x0000000000000003)))) #x00000100)) (bvurem (bvudiv 
  val__ #x00010000) #x00010000))
  (=>
  ...
  (to_rep (select memory4 (bvadd addr #x0000000000000003)))) #x00000100)) (bvurem (bvudiv 
  val__ #x00010000) #x00010000)))
  (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) 
  (to_rep (select memory4 (bvadd addr #x0000000000000001)))) #x00000100)) (bvmul ((_ zero_extend 24) 
  (to_rep (select memory4 (bvadd addr #x0000000000000002)))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select memory4 (bvadd addr #x0000000000000003)))) #x01000000)) 
  val__))
  (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) 
  (to_rep (select memory4 (bvadd addr #x0000000000000001)))) #x00000100)) (bvmul ((_ zero_extend 24) 
  (to_rep (select memory4 (bvadd addr #x0000000000000002)))) #x00010000)) (bvmul ((_ zero_extend 24) 
