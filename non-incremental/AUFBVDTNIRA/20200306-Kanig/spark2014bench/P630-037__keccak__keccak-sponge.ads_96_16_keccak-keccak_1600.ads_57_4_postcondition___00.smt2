...
(define-fun to_int4 ((x byte)) Int (ubv_to_int (to_rep3 x)))
...
;; in_queue_bit_length__def_axiom
  (assert
  (forall ((ctx us_rep))
  (! (= (in_queue_bit_length ctx) (to_rep4
                                  (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
                                  (us_split_fields1 ctx)))) :pattern (
  (in_queue_bit_length ctx)) )))

(declare-fun temp_____aggregate_def_838 ((_ BitVec 8)) (Array Int byte))
...
;; def_axiom
  (assert
  (forall ((temp___840 (_ BitVec 8)))
  (=> (dynamic_invariant3 temp___840 true true true true)
  (forall ((temp___841 Int))
  (= (to_rep3 (select (temp_____aggregate_def_838 temp___840) temp___841)) temp___840)))))
...
;; defqtvc
 ;; File "keccak-sponge.ads", line 92, characters 0-0
  ...
  (ada___keccak__keccak_1600__keccakf_1600__init__a map1)
  (ctx__split_fields1 us_split_fields) (ctx__split_fields2 us_split_fields)
  (ctx__split_fields3 us_split_fields) (ctx__split_fields4 us_split_fields))
  ...
  (= ctx__split_fields2 (us_split_fieldsqtmk
                        (rec__ada___keccak__keccak_1600__sponge__context__state
                        ctx__split_fields1) (temp_____aggregate_def_838 #x00)
                        (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
                        ctx__split_fields1)
                        (rec__ada___keccak__keccak_1600__sponge__context__bytes_squeezed
                        ctx__split_fields1)
  ...
  (= ctx__split_fields4 (us_split_fieldsqtmk
                        ...
                        ctx__split_fields3)
                        (rec__ada___keccak__keccak_1600__sponge__context__bits_absorbed
                        ctx__split_fields3) rliteral1
                        (rec__ada___keccak__keccak_1600__sponge__context__rate
                        ctx__split_fields3)
                        (rec__ada___keccak__keccak_1600__sponge__context__curr_state
                        ctx__split_fields3)))
  (let ((o (div1 (- 1600 capacity) 8)))
  (=> (in_range5 o)
  (forall ((o1 rate_number))
  (=> (= (to_rep5 o1) o)
  ...
  (= ctx__split_fields6 (us_split_fieldsqtmk
                        ...
                        ctx__split_fields5)
                        (rec__ada___keccak__keccak_1600__sponge__context__rate
                        ctx__split_fields5) o2))
  (=>
  (forall ((ctx__split_fields7 us_split_fields)) (state_of__function_guard
  (state_of (us_repqtmk ctx__split_fields7))
  (us_repqtmk ctx__split_fields7)))
