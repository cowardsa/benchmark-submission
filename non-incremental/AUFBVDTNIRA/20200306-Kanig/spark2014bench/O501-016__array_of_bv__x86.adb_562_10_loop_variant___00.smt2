...
(assert
;; defqtvc
 ;; File "x86.ads", line 492, characters 0-0
  (not
  (forall ((rcx (_ BitVec 64)) (rsi (_ BitVec 64)) (rdi (_ BitVec 64))
  (memory (Array (_ BitVec 64) unsigned8)) (val1 (_ BitVec 8))
  (val2 (_ BitVec 8)) (rcx1 (_ BitVec 64)) (rsi1 (_ BitVec 64))
  (rdi1 (_ BitVec 64)) (val11 (_ BitVec 8)) (val21 (_ BitVec 8))
  (temp___440 (_ BitVec 64)))
  ...
  (=> (dynamic_invariant1 val1 false false true true)
  (=> (dynamic_invariant1 val2 false false true true)
  (=> (bvugt rcx #x0000000000000000)
  (=>
  (= (and (ite (and
               (and
               (and
               ...
               (dynamic_invariant1 val11 false true true true))
               (dynamic_invariant1 val21 false true true true))
          true false) (ite (bvugt rcx1 #x0000000000000000) true false)) true)
  (=> (= temp___440 rcx1)
  (let ((o (readmem8 rsi1 memory)))
  (=>
  (and (readmem8__function_guard o rsi1 memory)
  (and (dynamic_invariant1 o true false true true)
  (= o (to_rep (select memory rsi1)))))
  (forall ((val12 (_ BitVec 8)))
  (=> (= val12 o)
  (let ((o1 (readmem8 rdi1 memory)))
  (=>
  (and (readmem8__function_guard o1 rdi1 memory)
  (and (dynamic_invariant1 o1 true false true true)
  (= o1 (to_rep (select memory rdi1)))))
  (forall ((val22 (_ BitVec 8)))
  (=> (= val22 o1)
  (forall ((zeroflag Bool))
  (=> (= zeroflag (ite (= (bvsub val12 val22) #x00) true false))
  (forall ((rcx2 (_ BitVec 64)))
  (=> (= rcx2 (bvsub rcx1 #x0000000000000001))
  (=>
  (not
  (= (or (ite (= rcx2 #x0000000000000000) true false) (ite (= zeroflag true)
                                                      false true)) true))
