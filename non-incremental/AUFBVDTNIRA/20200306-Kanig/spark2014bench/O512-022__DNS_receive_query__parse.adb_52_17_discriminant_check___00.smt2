...
;; defqtvc
 ;; File "parse.ads", line 15, characters 0-0
  ...
  (forall ((parse__parse_header__R14b__assume Int))
  (=> (= (to_rep4 result____split_discrs) parse__parse_header__R14b__assume)
  (=> (= parse__parse_header__R14b__assume r14b)
  (=> (dynamic_invariant4 r14b true false true true)
  (forall ((o12 return_code_t))
  (=> (= (to_rep4 o12) 1)
