...
(define-fun dynamic_invariant4 ((temp___expr_223 Int)
...
(assert
;; defqtvc
 ;; File "hermes-der-decode.ads", line 68, characters 0-0
  (not
  (forall ((stop Int) (status Int) (tag_class Int) (structured_flag Int)
  (tag Int) (identifier_status Int) (tag_class1 Int) (structured_flag1 Int)
  (tag1 Int) (identifier_status1 Int) (stop1 Int))
  (=> (dynamic_invariant5 message true false true true)
  (=> (dynamic_invariant start true false true true)
  (=> (dynamic_invariant stop false false true true)
  (=> (dynamic_invariant4 status false false true true)
  (=> (<= (first1 message) start)
  (=> (<= start (last1 message))
  (=> (dynamic_invariant1 tag_class false false true true)
  (=> (dynamic_invariant2 structured_flag false false true true)
  (=> (dynamic_invariant3 tag false false true true)
  (=> (dynamic_invariant4 identifier_status false false true true)
  (=> (<= (first1 message) start)
  (=> (<= start (last1 message))
  (=>
  (exists ((o (_ BitVec 8)))
  (= (to_rep1 (select (to_array message) start)) o))
  (=> (dynamic_invariant1 tag_class1 true true true true)
  (=> (dynamic_invariant2 structured_flag1 true true true true)
  (=> (dynamic_invariant3 tag1 true true true true)
  (=> (dynamic_invariant4 identifier_status1 true true true true)
  (=>
  ...
  (exists ((status1 Int))
  (and (dynamic_invariant4 status1 true true true true) (dynamic_invariant
  stop1 true true true true))))))))))) (<= start stop1))))))))))))))))))))))
(check-sat)
(exit)
