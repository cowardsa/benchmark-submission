...
(define-fun dynamic_invariant4 ((temp___expr_788 us_rep1)
...
(define-fun dynamic_invariant5 ((temp___expr_801 us_rep2)
...
(define-fun dynamic_invariant7 ((temp___expr_767 Int)
...
;; defqtvc
 ;; File "very_longs-divide.adb", line 185, characters 0-0
  ...
  (carry (_ BitVec 16)) (sum (_ BitVec 16)) (o octet)
  (quotient__split_fields1 us_t) (spark__branch Bool) (o1 (_ BitVec 8))
  (o2 octet) (carry1 (_ BitVec 16)) (u__split_fields1 us_t)
  (carry2 (_ BitVec 16)))
  ...
  (=> (= (to_rep2 (select (to_array quotient__split_fields1) j)) o1)
  ...
  (and (in_range2 o4)
  (let ((temp___1416 (- o4 1)))
  (and
  (and (<= (first1 u__split_fields2) temp___1416)
  (<= temp___1416 (last1 u__split_fields2)))
  (exists ((o5 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields2) temp___1416)) o5)
  ...
  (=> (in_range2 o4)
  (=>
  (and (<= (first1 u__split_fields1) o4) (<= o4 (last1 u__split_fields1)))
  (forall ((o5 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields1) o4)) o5)
  (forall ((o6 octet))
  (=> (= (to_rep2 o6) (bvadd o5 o3)) (in_range2 (+ j n)))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
