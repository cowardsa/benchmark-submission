...
;; defqtvc
 ;; File "very_longs.ads", line 40, characters 0-0
  (not
  (forall ((digit_count Int) (digit_count1 Int)
  (very_longs__number_of_digits__result Int))
  ...
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___968) true false)) true)
  (exists ((spark__branch1 Bool) (digit_count2 Int))
  (and
  ...
  (ite (= spark__branch1 true) (and (in_range4 i) (= digit_count2 i))
  (= digit_count2 digit_count)))))))
  (exists ((i1 Int))
  (and
  (=> (< digit_count1 i1)
  (forall ((j Int))
  (=> (and (<= (+ digit_count1 1) j) (<= j i1))
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits
  ...
  (= (and (ite (and (dynamic_property1 1
               ...
               digit_count1 true true true true))
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  (rec__very_longs__very_long__long_digits
                                  (us_split_fields1 number)))))
                      true false)) true)
  (= i1 temp___968)))))) (= digit_count1 digit_count)))))
  (= digit_count1 digit_count)))))))
  (=> (= very_longs__number_of_digits__result digit_count1)
  (=> (< 0 very_longs__number_of_digits__result)
  (not
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) very_longs__number_of_digits__result)) #x00)))))))))))
(check-sat)
(exit)
