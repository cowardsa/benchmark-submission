...
;; defqtvc
 ;; File "aco-math-very_longs.adb", line 444, characters 0-0
  ...
  (q_hat (_ BitVec 16)) (current_borrow (_ BitVec 16)) (carry (_ BitVec 16))
  (product1 (_ BitVec 16)) (temporary_digit (_ BitVec 16))
  (future_borrow (_ BitVec 16)) (divisor_index Int) (u__split_fields1 us_t)
  (current_borrow1 (_ BitVec 16)) (carry1 (_ BitVec 16))
  (product2 (_ BitVec 16)) (temporary_digit1 (_ BitVec 16))
  (future_borrow1 (_ BitVec 16)) (divisor_index1 Int) (o (_ BitVec 8))
  (product3 (_ BitVec 16)))
  ...
  (= (and (ite (<= 1 divisor_index) true false) (ite (<= divisor_index 
                                                r130b) true false)) true)
  (=>
  (= (and (ite (and
               (and
               (and
               (and
               (and (dynamic_invariant2 carry1 false true true true)
               (dynamic_invariant2 product2 false true true true))
               (dynamic_invariant2 temporary_digit1 false true true true))
               (dynamic_invariant2 current_borrow1 false true true true))
               (dynamic_invariant3
  ...
  (=> (= (to_rep2 (select (to_array v__split_fields) divisor_index1)) o)
  (=> (= product3 (bvadd (bvmul q_hat ((_ zero_extend 8) o)) carry1))
  ...
  (=> (= carry2 o1)
  (forall ((temporary_digit2 (_ BitVec 16)))
  (=> (= temporary_digit2 (bvand product3 #x00FF))
  (forall ((spark__branch Bool) (future_borrow2 (_ BitVec 16)))
  (=>
  (let ((o2 (+ j divisor_index1)))
  (and (in_range2 o2)
  (let ((temp___1625 (- o2 1)))
  (and
  (and (<= (first1 u__split_fields1) temp___1625)
  (<= temp___1625 (last1 u__split_fields1)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields1) temp___1625)) o3)
  (and
  (= spark__branch (ite (bvuge ((_ zero_extend 8) o3) (bvadd temporary_digit2 current_borrow1))
                   true false))
  ...
  (=>
  (and (<= (first1 u__split_fields1) temp___1627)
  (<= temp___1627 (last1 u__split_fields1)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields1) temp___1627)) o3)
  (forall ((o4 octet))
  (=>
  (= (to_rep2 o4) ((_ extract 7 0) (bvand (bvsub (bvsub ((_ zero_extend 8) o3) temporary_digit2) current_borrow1) #x00FF)))
  (in_range2 (+ j divisor_index1))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
