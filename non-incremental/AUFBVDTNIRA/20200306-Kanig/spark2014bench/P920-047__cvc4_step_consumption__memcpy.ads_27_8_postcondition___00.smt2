...
;; defqtvc
 ;; File "memcpy.ads", line 14, characters 0-0
  ...
  (rsi (_ BitVec 64)) (rax (_ BitVec 64)) (rsp1 (_ BitVec 64))
  ...
  (not
  (= (bvand (readmem64 (bvsub rbp1 #x0000000000000040) memory8) #x0000000000000007) #x0000000000000000)))
  ...
  (let ((o9 (readmem64 rsp2 memory9)))
  (=>
  (and (readmem64__function_guard o9 rsp2 memory9)
  ...
  (= (bvand o9 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep
                                                              (select memory9 (bvadd rsp2 #x0000000000000001)))) #x0000000000000100)))
  (= (bvand o9 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep
                                                              (select memory9 (bvadd rsp2 #x0000000000000002)))) #x0000000000010000)))
  (= (bvand o9 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep
                                                              (select memory9 (bvadd rsp2 #x0000000000000003)))) #x0000000001000000)))
  (= (bvand o9 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep
                                                              (select memory9 (bvadd rsp2 #x0000000000000004)))) #x0000000100000000)))
  (= (bvand o9 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep
                                                              (select memory9 (bvadd rsp2 #x0000000000000005)))) #x0000010000000000)))
  (= (bvand o9 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep
                                                              (select memory9 (bvadd rsp2 #x0000000000000006)))) #x0001000000000000)))
  (= (bvand o9 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep
                                                              (select memory9 (bvadd rsp2 #x0000000000000007)))) #x0100000000000000)))))
  ...
  (= rsp4 (bvadd rsp1 #x0000000000000008)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
