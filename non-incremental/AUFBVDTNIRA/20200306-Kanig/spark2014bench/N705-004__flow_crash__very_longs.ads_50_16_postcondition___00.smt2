...
(define-fun us_split_fields_rec__very_longs__very_long__long_digits__20__projection ((a us_split_fields2)) us_t 
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((us_split_fields__refqtmk1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___split_fields__content__20__projection ((a us_split_fields__ref1)) us_split_fields2 
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((us_repqtmk1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep___split_discrs__20__projection ((a us_rep1)) us_split_discrs 
  (us_split_discrs2 a))

(define-fun us_rep___split_fields__20__projection ((a us_rep1)) us_split_fields2 
  (us_split_fields3 a))

(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___206 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array temp___206)
                                         (first1 temp___206)
                                         (last1 temp___206))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r1)
                                          (us_split_fieldsqtmk1
                                          (let ((temp___205 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array (to_array temp___205)
                                          (first1 temp___205)
                                          (last1 temp___205))))))
...
(define-fun tresultS__ref_tresultS__content__3__projection ((a tresultS__ref)) us_rep1 
  (tresultS__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_647 us_rep1)
  (temp___is_init_643 Bool) (temp___skip_constant_644 Bool)
  (temp___do_toplevel_645 Bool)
  (temp___do_typ_inv_646 Bool)) Bool (and
                                     (=>
                                     (not (= temp___skip_constant_644 true))
                                     (in_range3
                                     (to_rep
                                     (rec__very_longs__very_long__octet_length
                                     (us_split_discrs1 l)))
                                     (us_split_discrs1
                                     (to_base temp___expr_647))))
                                     (and (dynamic_property 1
                                     (to_rep
                                     (rec__very_longs__very_long__octet_length
                                     (us_split_discrs1 l)))
                                     (first1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_647)))
                                     (last1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_647))))
                                     (and
                                     (= (first1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_647))) 1)
                                     (= (last1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_647))) 
                                     (to_rep
...
(define-fun default_initial_assumption ((temp___expr_650 us_rep1)
  (temp___skip_top_level_651 Bool)) Bool (and
                                         (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_650))) (to_rep
                                                               (rec__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l))))
                                         (and
...
(define-fun dynamic_invariant3 ((temp___expr_366 (_ BitVec 16))
...
(declare-fun temp_____aggregate_def_1036 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1038 (_ BitVec 8)))
  (forall ((temp___1039 Int) (temp___1040 Int))
  (let ((temp___1037 (temp_____aggregate_def_1036 temp___1038 temp___1039
                     temp___1040)))
  (=> (dynamic_invariant1 temp___1038 true true true true)
  (and
  (=> (dynamic_property 1 2147483647 temp___1039 temp___1040)
  (and (= (first1 temp___1037) temp___1039)
  (= (last1 temp___1037) temp___1040)))
  (forall ((temp___1041 Int))
  (= (to_rep2 (select (to_array temp___1037) temp___1041)) temp___1038))))))))
...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 47, characters 0-0
  (not
  (forall ((result____split_fields us_t) (l_digit (_ BitVec 16))
  (r_digit (_ BitVec 16)) (difference1 (_ BitVec 16)) (borrow (_ BitVec 16))
  (o Int) (o1 Int))
  ...
  (=> (dynamic_invariant3 r_digit false false true true)
  (=> (dynamic_invariant3 difference1 false false true true)
  (=> (dynamic_invariant3 borrow false false true true)
  (=>
  (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) o1)
  (let ((temp___1042 (temp_____aggregate_def_1036 #x00 1 o1)))
  (=> (= (first1 temp___1042) 1)
  (=>
  (= (last1 temp___1042) (to_rep
                         (rec__very_longs__very_long__octet_length
                         (us_split_discrs1 l))))
  (=>
  (ite (<= (first1 temp___1042) (last1 temp___1042))
  (and
  (<= 1 (to_rep
        (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))
  (= (- (last1 temp___1042) (first1 temp___1042)) (- (to_rep
                                                     (rec__very_longs__very_long__octet_length
                                                     (us_split_discrs1 l))) 1)))
  (< (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1))
  (let ((temp___1044 (of_array (to_array temp___1042) (first1 temp___1042)
                     (last1 temp___1042))))
  (=>
  (ite (<= (first1 temp___1044) (last1 temp___1044))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1044) (first1 temp___1044)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1044)
  (forall ((borrow1 (_ BitVec 16)))
  (=> (= borrow1 #x0000)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1049 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1049) true false)) true)
  (exists ((result____split_fields3 us_t) (l_digit1 (_ BitVec 16))
  (r_digit1 (_ BitVec 16)) (difference2 (_ BitVec 16))
  (borrow2 (_ BitVec 16)) (i1 Int))
  (and
  (= (and (ite (and
               (and
               (and
               (and
               (and (dynamic_invariant3 r_digit1 false true true true)
               (dynamic_invariant3 difference2 false true true true))
               (dynamic_invariant3 borrow2 false true true true))
               (dynamic_invariant2
               (us_repqtmk1 result____split_discrs
               ...
               (=>
               (and (<= (first1 result____split_fields3) temp___1060)
               (<= temp___1060 (last1 result____split_fields3)))
               (=>
               (or (< temp___1049 temp___1060)
               (or (< temp___1060 1) (<= i1 temp___1060)))
               (= (select (to_array result____split_fields3) temp___1060) (select 
               (to_array result____split_fields1) temp___1060))))))
               (dynamic_invariant3 l_digit1 false true true true))
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  (rec__very_longs__very_long__long_digits
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1050 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1050) i1) (<= i1 (last1 temp___1050)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1050) i1)) o2)
  (exists ((l_digit2 (_ BitVec 16)))
  (and (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1051 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1051) i1) (<= i1 (last1 temp___1051)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1051) i1)) o3)
  (exists ((r_digit2 (_ BitVec 16)))
  (and (= r_digit2 ((_ zero_extend 8) o3))
  (exists ((difference3 (_ BitVec 16)))
  (and (= difference3 (bvsub (bvsub l_digit2 r_digit2) borrow2))
  (and
  (exists ((spark__branch Bool))
  (= spark__branch (ite (not (= (bvand difference3 #xFF00) #x0000)) true
                   false)))
  (let ((o4 (takelsb_from16 difference3)))
  (and
  (and (takelsb_from16__function_guard o4 difference3) (dynamic_invariant1 o4
  ...
  (= result____split_fields2 (us_tqtmk
                             (store (to_array result____split_fields3) i1 o5)
                             (rt result____split_fields3)))
  (= i1 temp___1049))))))))))))))))))))))))
  (= result____split_fields2 result____split_fields1)))))
  (forall ((very_longs__modsubtract__result us_rep))
  (=>
  (= very_longs__modsubtract__result (to_base
                                     (us_repqtmk1 result____split_discrs
                                     (us_split_fieldsqtmk1
                                     result____split_fields2))))
  (= (to_rep
     (rec__very_longs__very_long__octet_length
     (us_split_discrs1 very_longs__modsubtract__result))) (to_rep
                                                          (rec__very_longs__very_long__octet_length
                                                          (us_split_discrs1
                                                          l)))))))))))))))))))))))))))))))))
(check-sat)
