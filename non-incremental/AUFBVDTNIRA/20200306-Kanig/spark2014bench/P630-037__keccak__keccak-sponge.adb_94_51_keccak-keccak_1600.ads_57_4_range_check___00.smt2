...
;; defqtvc
 ;; File "keccak-sponge.ads", line 146, characters 0-0
  ...
  (=> (= spark__branch2 (ite (< 0 free_bits_in_block1) true false))
  (=> (= spark__branch2 true)
  (forall ((o9 Int))
  (=>
  (= (to_rep5
  ...
  (forall ((block_offset1 Int))
  (=> (= block_offset1 (div1 o9 8))
  (=> (= block_offset1 r64s)
  (=> (dynamic_invariant r64s true false true true)
  (let ((o10 (+ block_offset1 (- free_bytes_in_block1 1))))
  (=> (in_range1 o10)
  (=> (= o10 r65s)
  (=> (dynamic_invariant2 r65s true false true true)
  (let ((o11 (+ (first1 data) (- free_bytes_in_block1 1))))
  (=> (in_range1 o11)
  (=> (= o11 r68s)
  (=> (dynamic_invariant2 r68s true false true true)
  ...
  (=> (in_range1 o13)
  (=> (in_range2 o13)
  (forall ((remaining_bytes1 Int))
  (=> (= remaining_bytes1 o13)
  (let ((o14 (- remaining_bits free_bits_in_block1)))
  (=> (in_range1 o14) (in_range2 o14))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
