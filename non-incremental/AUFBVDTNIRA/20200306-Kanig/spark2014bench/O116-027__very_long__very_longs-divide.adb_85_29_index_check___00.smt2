...
;; defqtvc
 ;; File "very_longs-divide.adb", line 74, characters 0-0
  ...
  (=> (in_range2 r122b)
  (let ((temp___1323 r122b))
  (forall ((i Int))
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1323) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 number__split_fields1) temp___1335)
               (<= temp___1335 (last1 number__split_fields1)))
               (=>
               (or (< temp___1323 temp___1335)
               (or (< temp___1335 1) (<= i1 temp___1335)))
               (= (select (to_array number__split_fields1) temp___1335) (select 
               (to_array number__split_fields) temp___1335))))))
