...
;; defqtvc
 ;; File "random.ads", line 43, characters 0-0
  ...
  (= g__split_fields3 g__split_fields2))))
  (forall ((i3 Int) (g__split_fields4 us_split_fields) (k1 Int))
  (=> (< 0 i3)
  (=>
  (= (and (ite (and
               (and
               (= (rec__random__generator__index g__split_fields4) (rec__random__generator__index
                                                                   g__split_fields1))
               (in_range5 k1)) (dynamic_invariant2 i3 true true true true))
          true false) (ite (and (<= 1 k1) (<= k1 623)) true false)) true)
  (=> (not (= k1 623))
  (let ((o5 (to_state i3)))
  (=>
  (and (to_state__function_guard o5 i3)
  (and (dynamic_invariant1 o5 true false true true)
  (= o5 ((_ int_to_bv 32) i3))))
  (let ((temp___2691 (- i3 1)))
  (=> (and (<= 0 temp___2691) (<= temp___2691 623))
  (forall ((o6 (_ BitVec 32)))
  (=>
  (= (to_rep1
     (select (rec__random__generator__state g__split_fields4) temp___2691)) o6)
  (let ((temp___2671 (- i3 1)))
  (=> (and (<= 0 temp___2671) (<= temp___2671 623))
  (forall ((o7 (_ BitVec 32)))
  (=>
  (= (to_rep1
     (select (rec__random__generator__state g__split_fields4) temp___2671)) o7)
  (forall ((o8 (_ BitVec 32)))
  (=>
  (= (to_rep1 (select (rec__random__generator__state g__split_fields4) i3)) o8)
  (forall ((o9 unsigned_32))
  (=>
  (= (to_rep1 o9) (bvsub (bvxor o8 (bvmul (bvxor o7 (bvlshr o6 ((_ int_to_bv 32) 30))) #x5D588B65)) o5))
  (forall ((g__split_fields5 us_split_fields))
  (=>
  (= g__split_fields5 (us_split_fieldsqtmk
                      (store (rec__random__generator__state g__split_fields4) i3 o9)
                      (rec__random__generator__index g__split_fields4)))
  (forall ((i4 Int))
  (=>
  (exists ((spark__branch3 Bool))
  (and (= spark__branch3 (ite (= i3 623) true false))
  (ite (= spark__branch3 true)
  (exists ((o10 (_ BitVec 32)))
  (and
  (= (to_rep1 (select (rec__random__generator__state g__split_fields5) 623)) o10)
