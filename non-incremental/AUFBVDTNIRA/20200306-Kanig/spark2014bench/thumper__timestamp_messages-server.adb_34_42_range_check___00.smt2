...
;; defqtvc
 ;; File "timestamp_messages-server.ads", line 19, characters 0-0
  ...
  (let ((o1 (of_array
            (rec__timestamp_messages__timestamp__hashed_message
            (us_split_fields3 stamp)) 1 32)))
  (let ((temp___375 (put_octet_string_value o1)))
  (and
  (and (put_octet_string_value__function_guard temp___375 o1)
  (dynamic_invariant temp___375 true false true true))
  (let ((o2 (rec__timestamp_messages__timestamp__hash_algorithm
            (us_split_fields3 stamp))))
  (let ((temp___374 (put_oid_value o2)))
  (and
  (and (put_oid_value__function_guard temp___374 o2) (dynamic_invariant
  ...
  (let ((o3 (- (+ (first1 temp___374) (+ (length (first1 temp___374)
  ...
  (first1 temp___374) o3)))))))))))
  (=>
  (= ada___timestamp_messages__server__put_timestamp_value__message_imprint__assume 
  message_imprint)
  (=> (dynamic_invariant message_imprint true false true true)
  (=>
  (let ((o1 (length1 message_imprint)))
  (and (in_range1 o1)
  (let ((temp___377 (put_length_value o1)))
  (and
  (and (put_length_value__function_guard temp___377 o1)
  ...
  (let ((o2 (- (+ 0 (+ 1 (length (first1 temp___377) (last1 temp___377)))) 1)))
  (and (in_range1 o2)
  (exists ((o3 octet))
  (and (= (to_rep5 o3) temp___376)
  (let ((temp___378 (of_array
                    (concat_singleton_left o3 0 (to_array temp___377)
                    (first1 temp___377) (last1 temp___377)) 0 o2)))
  ...
  (let ((o4 (- (+ (first1 temp___378) (+ (length (first1 temp___378)
  ...
  (last1 message_imprint)) (first1 temp___378) o4))))))))))))))))
  (=>
  (= ada___timestamp_messages__server__put_timestamp_value__message_imprint_value__assume 
  ...
  (=> (not (= (length1 temp___382) 0)) (in_range1
  (- (+ (first1 temp___382) (+ (length (first1 temp___382)
