...
(declare-fun user_eq5 (my_index my_index) Bool)

(declare-const dummy5 my_index)
...
(define-fun to_int2 ((x my_index)) Int (ubv_to_int (to_rep2 x)))
...
(((map__refqtmk1 (map__content1 (Array (_ BitVec 64) Bool))))))
...
(((us_tqtmk1 (elts1 (Array (_ BitVec 64) Bool))(rt1 t1)))))
...
;; temp___String_Literal_226__def_axiom
  ...
  (! (and
     (and
     (= (to_rep (select (temp___String_Literal_226 us_void_param) 1)) 109)
     (= (to_rep (select (temp___String_Literal_226 us_void_param) 2)) 97))
     (= (to_rep (select (temp___String_Literal_226 us_void_param) 3)) 120)) :pattern (
...
;; temp___String_Literal_227__def_axiom
  ...
  (! (and
     (and
     (= (to_rep (select (temp___String_Literal_227 us_void_param) 1)) 122)
     (= (to_rep (select (temp___String_Literal_227 us_void_param) 2)) 101))
     (and
     (= (to_rep (select (temp___String_Literal_227 us_void_param) 3)) 114)
     (= (to_rep (select (temp___String_Literal_227 us_void_param) 4)) 111))) :pattern (
...
(define-fun dynamic_invariant5 ((temp___expr_32 Int) (temp___is_init_28 Bool)
...
(define-fun dynamic_invariant6 ((temp___expr_191 (_ BitVec 64))
...
;; create__post_axiom
  ...
  (! (=> (dynamic_invariant6 last4 true true true true)
...
;; defqtvc
 ;; File "fail.adb", line 32, characters 0-0
  ...
  (=> (= (create #xFFFFFFFFFFFFFFFF) c)
  (=> (= (first3 c) #x0000000000000000)
  (=> (= (last3 c) #xFFFFFFFFFFFFFFFF)
  (let ((o (length1 c)))
  (=> (in_range1 o)
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (< 9223372036854775807 o) true false))
  (=> (not (= spark__branch true)) (in_range1 (length1 c)))))))))))))
(check-sat)
(exit)
