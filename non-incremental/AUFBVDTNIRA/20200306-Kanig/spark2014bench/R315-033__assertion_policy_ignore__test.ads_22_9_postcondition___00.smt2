...
;; defqtvc
 ;; File "test.ads", line 7, characters 0-0
  (not
  (forall ((dest (Array Int byte)) (dest1 (Array Int byte)) (i Int))
  ...
  (exists ((i1 Int))
  (and (= i1 0)
  (ite (= (and (ite (<= 0 i1) true false) (ite (<= i1 temp___201) true false)) true)
  (exists ((temp___loop_entry_210 (Array Int byte)))
  (and (= temp___loop_entry_210 dest)
  (let ((o (+ src_first i1)))
  (and (in_range1 o)
  (and (and (<= (first1 src) o) (<= o (last1 src)))
  (exists ((o1 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array src) o)) o1)
  (exists ((o2 byte))
  (and (= (to_rep1 o2) o1)
  (let ((o3 (+ index i1)))
  (and (in_range1 o3)
  (and (and (<= (to_rep dest__first) o3) (<= o3 (to_rep dest__last)))
  (exists ((dest2 (Array Int byte)))
  (and (= dest2 (store dest o3 o2))
  (and
  (exists ((o4 Int))
  (and (= (to_rep dest__last) o4)
  (exists ((o5 Int)) (= (to_rep dest__first) o5))))
  (exists ((i2 Int))
  (and
  (forall ((j Int))
  (=> (and (<= (to_rep dest__first) j) (<= j (to_rep dest__last)))
  (ite (and (<= index j) (<= j (+ index i2)))
  ...
  (and
  (= (and (ite (dynamic_property1 0 (- src_length 1) i2) true false) 
  (ite (and (<= 0 i2) (<= i2 (- src_length 1))) true false)) true)
  (= i2 temp___201))))))))))))))))))) (= dest1 dest)))))
  (=> (<= (to_rep dest__first) i)
  (=> (<= i (to_rep dest__last))
  (=> (<= index i)
  (=> (<= i (- (+ index src_length) 1))
  (= (to_rep1 (select dest1 i)) (to_rep1
