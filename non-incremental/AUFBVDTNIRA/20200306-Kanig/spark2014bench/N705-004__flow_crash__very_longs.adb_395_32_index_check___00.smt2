...
(assert
;; defqtvc
 ;; File "very_longs.adb", line 383, characters 0-0
  (not
  (forall ((number__split_fields us_t) (new_overflow (_ BitVec 8))
  (overflow_mask (_ BitVec 8)) (old_overflow (_ BitVec 8)) (o (_ BitVec 8))
  (overflow_mask1 (_ BitVec 8)))
  (=> (dynamic_invariant
  ...
  (=> (in_range2 r128b)
  (let ((temp___1360 r128b))
  (forall ((i Int))
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1360) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 number__split_fields1) temp___1374)
               (<= temp___1374 (last1 number__split_fields1)))
               (=>
               (or (< temp___1360 temp___1374)
               (or (< temp___1374 1) (<= i1 temp___1374)))
               (= (select (to_array number__split_fields1) temp___1374) (select 
               (to_array number__split_fields) temp___1374))))))
  ...
  (=> (= (to_rep2 (select (to_array number__split_fields2) i1)) o7)
  (forall ((o8 octet))
