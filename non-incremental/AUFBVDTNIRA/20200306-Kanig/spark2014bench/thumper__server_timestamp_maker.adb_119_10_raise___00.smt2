...
(define-fun to_int2 ((x octet)) Int (ubv_to_int (to_rep x)))
...
(declare-datatypes ((imprint__ref 0))
(((imprint__refqtmk (imprint__content us_rep1)))))
...
(declare-datatypes ((status_type__ref1 0))
...
;; defqtvc
 ;; File "server_timestamp_maker.ads", line 18, characters 0-0
  (not
  (forall ((length_stop Int) (length1 Int) (version_stop Int) (version Int)
  (imprint_stop Int) (decode_status Int) (imprint_status Int)
  (spark__branch Bool) (result__ Bool) (c14b Bool) (spark__branch1 Bool))
  (=> (= request_message c13b)
  (=> (dynamic_invariant3 length_stop false false true true)
  (=> (dynamic_invariant1 length1 false false true true)
  (=> (dynamic_invariant3 version_stop false false true true)
  (=> (dynamic_invariant version false false true true)
  (=> (dynamic_invariant3 imprint_stop false false true true)
  (=> (dynamic_invariant2 decode_status false false true true)
  (=> (dynamic_invariant4 imprint_status false false true true)
  (=>
  (exists ((o Int))
  (and (= (to_rep1 (rec__messages__message__size (us_split_fields1 c13b))) o)
  (exists ((spark__branch2 Bool))
  (and (= spark__branch2 (ite (<= o 2) true false))
  (ite (= spark__branch2 true)
  (and (= result__ (distinct 0 0)) (= spark__branch spark__branch2))
  (exists ((o1 (_ BitVec 8)))
  (and
  (= (to_rep
     (select (rec__messages__message__data (us_split_fields1 c13b)) 1)) o1)
  (exists ((spark__branch3 Bool))
  (and (= spark__branch3 (ite (not (= o1 #x30)) true false))
  (ite (= spark__branch3 true)
  (and (= result__ (distinct 0 0)) (= spark__branch spark__branch3))
  (exists ((ada___ada___hermes__der__decode__get_length_value__status Int)
  (ada___ada___hermes__der__decode__get_length_value__length Int)
  (ada___ada___hermes__der__decode__get_length_value__stop Int))
  (and
  (and
  (and (<= 2 ada___ada___hermes__der__decode__get_length_value__stop)
  (<= ada___ada___hermes__der__decode__get_length_value__stop (last1
                                                              (of_array
                                                              (rec__messages__message__data
                                                              (us_split_fields1
                                                              c13b)) 1 512))))
  ...
  true) (dynamic_invariant1
  ada___ada___hermes__der__decode__get_length_value__length true true true
  true)) (dynamic_invariant2
  ada___ada___hermes__der__decode__get_length_value__status true true true
  true)))
  (and (in_range5 ada___ada___hermes__der__decode__get_length_value__stop)
  (exists ((length_stop1 Int))
  (and
  (= length_stop1 ada___ada___hermes__der__decode__get_length_value__stop)
  (exists ((length2 Int))
  (and (= length2 ada___ada___hermes__der__decode__get_length_value__length)
  (exists ((decode_status1 Int))
  (and
  (= decode_status1 ada___ada___hermes__der__decode__get_length_value__status)
  (exists ((spark__branch4 Bool))
  (and (= spark__branch4 (ite (= decode_status1 0) false true))
  (ite (= spark__branch4 true)
  (and (= result__ (distinct 0 0)) (= spark__branch spark__branch4))
  (let ((o2 (+ length_stop1 length2)))
  (and (in_range1 o2)
  (exists ((spark__branch5 Bool))
  (and (= spark__branch5 (ite (= o2 512) false true))
  (ite (= spark__branch5 true)
  (and (= result__ (distinct 0 0)) (= spark__branch spark__branch5))
  (exists ((ada___ada___hermes__der__decode__get_integer_value__status Int)
  (ada___ada___hermes__der__decode__get_integer_value__value Int)
  (ada___ada___hermes__der__decode__get_integer_value__stop Int))
  (and
  (and
  (and
  (<= (+ length_stop1 1) ada___ada___hermes__der__decode__get_integer_value__stop)
  (<= ada___ada___hermes__der__decode__get_integer_value__stop (last1
                                                               (of_array
                                                               (rec__messages__message__data
                                                               (us_split_fields1
                                                               c13b)) 1 512))))
  (and
  (and (dynamic_invariant1
  ada___ada___hermes__der__decode__get_integer_value__stop true true true
  true) (dynamic_invariant
  ada___ada___hermes__der__decode__get_integer_value__value true true true
  true)) (dynamic_invariant2
  ada___ada___hermes__der__decode__get_integer_value__status true true true
  true)))
  (and (in_range5 ada___ada___hermes__der__decode__get_integer_value__stop)
  (exists ((version_stop1 Int))
  (and
  (= version_stop1 ada___ada___hermes__der__decode__get_integer_value__stop)
  (exists ((version1 Int))
  (and (= version1 ada___ada___hermes__der__decode__get_integer_value__value)
  (exists ((decode_status2 Int))
  (and
  (= decode_status2 ada___ada___hermes__der__decode__get_integer_value__status)
  (exists ((spark__branch6 Bool))
  (and (= spark__branch6 (ite (= decode_status2 0) false true))
  (ite (= spark__branch6 true)
  (and (= result__ (distinct 0 0)) (= spark__branch spark__branch6))
  (exists ((spark__branch7 Bool))
  (and (= spark__branch7 (ite (= version1 1) false true))
  (ite (= spark__branch7 true)
  (and (= result__ (distinct 0 0)) (= spark__branch spark__branch7))
  (and (= c13b c17b)
  (let ((o3 (+ version_stop1 1)))
  (and (in_range5 o3)
  (and (= o3 c18b)
  (and (dynamic_invariant3 c18b true false true true)
  (and (= spark__branch (ite (= imprint_status 0) false true))
  (and (= spark__branch true) (= result__ (distinct 0 0)))))))))))))))))))))))))))))))))))))))))))))))))))
  (=> (= c14b result__)
  (=> (= spark__branch1 (ite (= c14b true) false true))
  (= spark__branch1 true)))))))))))))))
(check-sat)
(exit)
