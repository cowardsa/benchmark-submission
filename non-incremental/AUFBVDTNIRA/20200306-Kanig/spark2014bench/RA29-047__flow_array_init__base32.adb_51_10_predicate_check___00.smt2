...
;; defqtvc
 ;; File "base32.ads", line 68, characters 0-0
  (not
  (forall ((b (Array Int byte)) (temp___297 Int) (i Int)
  (b1 (Array Int byte)) (i1 Int))
  ...
  (=> (= (to_rep1 b__last) temp___297)
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___297) true false)) true)
  (=>
  (= (and (ite (forall ((temp___304 Int))
               ...
               (= (select b1 temp___304) (select b temp___304)))))
          true false) (ite (and (<= 1 i1) (<= i1 (to_rep1 b__last))) true
                      false)) true)
  (let ((o (+ (first1 s) (- i1 1))))
  (=> (in_range1 o)
  (=> (and (<= (first1 s) o) (<= o (last1 s)))
  (forall ((o1 Int))
  (=> (= (to_rep (select (to_array s) o)) o1)
  (forall ((o2 byte))
  (=> (= (to_rep2 o2) ((_ int_to_bv 8) o1))
  (=> (and (<= (to_rep1 b__first) i1) (<= i1 (to_rep1 b__last)))
