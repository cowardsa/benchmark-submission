...
;; defqtvc
 ;; File "hermes-der-decode.adb", line 350, characters 0-0
  ...
  (=>
  (ite (<= 2 length2)
  (let ((o3 (+ length_stop1 2)))
  (and (in_range1 o3)
  (and (and (<= (first1 message) o3) (<= o3 (last1 message)))
  (exists ((o4 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) o3)) o4)
  (let ((o5 (+ length_stop1 1)))
  (and (in_range1 o5)
  (and (and (<= (first1 message) o5) (<= o5 (last1 message)))
  (exists ((o6 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) o5)) o6)
  (= o2 (and (ite (= o6 #x00) true false) (ite (= (bvand o4 #x80) #x00) true
                                          false)))))))))))))
  (= o2 false))
  ...
  (=>
  (ite (<= 2 length2)
  (let ((o4 (+ length_stop1 2)))
  (and (in_range1 o4)
  (and (and (<= (first1 message) o4) (<= o4 (last1 message)))
  (exists ((o5 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) o4)) o5)
  (let ((o6 (+ length_stop1 1)))
  (and (in_range1 o6)
  (and (and (<= (first1 message) o6) (<= o6 (last1 message)))
  (exists ((o7 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array message) o6)) o7)
  (= o3 (and (ite (= o7 #xFF) true false) (ite (= (bvor o5 #x7F) #xFF) true
                                          false)))))))))))))
  (= o3 false))
  (forall ((spark__branch4 Bool))
  (=> (= spark__branch4 o3)
  (=> (= spark__branch4 true) (in_range1 (+ length_stop1 length2)))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
