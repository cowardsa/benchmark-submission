...
(declare-datatypes ((s117b__ref 0))
(((s117b__refqtmk (s117b__content us_t)))))
(define-fun s117b__ref_s117b__content__projection ((a s117b__ref)) us_t 
  (s117b__content a))

(declare-datatypes ((t120b__ref 0))
(((t120b__refqtmk (t120b__content us_t)))))
(define-fun t120b__ref_t120b__content__projection ((a t120b__ref)) us_t 
  (t120b__content a))

(declare-fun temp_____aggregate_def_1289 ((_ BitVec 8) Int Int) us_t)
...
;; def_axiom
  (assert
  (forall ((temp___1291 (_ BitVec 8)))
  (forall ((temp___1292 Int) (temp___1293 Int))
  (let ((temp___1290 (temp_____aggregate_def_1289 temp___1291 temp___1292
                     temp___1293)))
  (=> (dynamic_invariant2 temp___1291 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1292 temp___1293)
  (and (= (first1 temp___1290) temp___1292)
  (= (last1 temp___1290) temp___1293)))
  (forall ((temp___1294 Int))
  (= (to_rep2 (select (to_array temp___1290) temp___1294)) temp___1291))))))))
...
;; defqtvc
 ;; File "very_longs-divide.adb", line 51, characters 0-0
  ...
  (very_longs__divide__full_left_shift__R118b__assume Int))
  ...
  (=>
  (= (to_rep (rec__very_longs__very_long__length result____split_discrs)) very_longs__divide__full_left_shift__R118b__assume)
  (=> (= very_longs__divide__full_left_shift__R118b__assume r118b)
  (=> (dynamic_invariant3 r118b true false true true)
  (let ((temp___1295 (temp_____aggregate_def_1289 #x00 1 r118b)))
  (=> (= (first1 temp___1295) 1)
  (=> (= (last1 temp___1295) r118b)
  (=>
  (ite (<= (first1 temp___1295) (last1 temp___1295))
  (and (<= 1 r118b)
  (= (- (last1 temp___1295) (first1 temp___1295)) (- r118b 1))) (< r118b 1))
  (let ((temp___1297 (of_array (to_array temp___1295) (first1 temp___1295)
                     (last1 temp___1295))))
  (=>
  (ite (<= (first1 temp___1297) (last1 temp___1297))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1297) (first1 temp___1297)) (- (last1
  ...
  (=>
  (= result____split_fields1 (of_array (to_array temp___1297)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___1316)
               (<= temp___1316 (last1 result____split_fields2)))
               (=>
               (or (< temp___1303 temp___1316)
               (or (< temp___1316 1) (<= i1 temp___1316)))
               (= (select (to_array result____split_fields2) temp___1316) (select 
               (to_array result____split_fields1) temp___1316))))))
  ...
  (let ((temp___1304 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 number))))
  (=> (and (<= (first1 temp___1304) i1) (<= i1 (last1 temp___1304)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1304) i1)) o2)
  ...
  (=>
  (ite (< distance 8)
  (let ((temp___1305 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 number))))
  (and (and (<= (first1 temp___1305) i1) (<= i1 (last1 temp___1305)))
  (exists ((o6 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1305) i1)) o6)
