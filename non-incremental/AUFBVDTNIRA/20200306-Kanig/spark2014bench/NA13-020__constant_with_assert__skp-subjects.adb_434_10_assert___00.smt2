...
;; defqtvc
 ;; File "skp-subjects.ads", line 44, characters 0-0
  ...
  (=>
  (forall ((subject1 Int))
  (=> (and (<= 0 subject1) (<= subject1 0))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject1)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject1 Int))
  (=> (and (<= 1 subject1) (<= subject1 1))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject1)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject1 Int))
  (=> (and (<= 2 subject1) (<= subject1 2))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject1)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject1 Int))
  (=> (and (<= 3 subject1) (<= subject1 3))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject1)))) #x0000000000001000) #x0000000000000000)))
  (=>
  (forall ((subject1 Int))
  (=> (and (<= 4 subject1) (<= subject1 4))
  (= (bvurem (to_rep2
             (rec__ada___skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject1)))) #x0000000000001000) #x0000000000000000)))
  (=> (<= 5 subject)
