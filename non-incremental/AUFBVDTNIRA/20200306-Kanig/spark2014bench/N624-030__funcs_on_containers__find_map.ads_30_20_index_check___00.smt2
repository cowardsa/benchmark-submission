...
;; defqtvc
 ;; File "find_map.ads", line 26, characters 0-0
  ...
  (forall ((o1 Bool))
  (=>
  (and (and (<= (first1 a) usf) (<= usf (last1 a)))
  (exists ((o2 Int))
  (and (= (to_rep (select (to_array a) usf)) o2)
  (let ((o3 (contains find_map__find_all__result o2)))
  (and
  (= (= o3 true) (= (has_key (model1 find_map__find_all__result) o2) true))
  (ite (= o3 true)
  (and (and (<= (first1 a) usf) (<= usf (last1 a)))
  (exists ((o4 Int))
  (and (= (to_rep (select (to_array a) usf)) o4)
  (let ((temp___875 (element find_map__find_all__result o4)))
  (and
  (and (dynamic_invariant2 temp___875 true false true true)
  (= temp___875 (get (model1 find_map__find_all__result) o4)))
  (= o1 (and (ite (<= (first1 a) temp___875) true false) (ite (<= temp___875 usf)
                                                         true false))))))))
  (= o1 false)))))))
  (=> (= o1 true)
  (=> (and (<= (first1 a) usf) (<= usf (last1 a)))
  (=> (exists ((o2 Int)) (= (to_rep (select (to_array a) usf)) o2))
  (=> (and (<= (first1 a) usf) (<= usf (last1 a)))
  (forall ((o2 Int))
  (=> (= (to_rep (select (to_array a) usf)) o2)
  (let ((temp___876 (element find_map__find_all__result o2)))
  (=>
  (and (dynamic_invariant2 temp___876 true false true true)
