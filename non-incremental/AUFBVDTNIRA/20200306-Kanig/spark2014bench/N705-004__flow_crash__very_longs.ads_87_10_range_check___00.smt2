...
(define-fun dynamic_invariant ((temp___expr_239 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_259 us_rep)
...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 3, characters 0-0
  (not
  (forall ((usf Int) (usf1 us_rep))
  (=> (dynamic_invariant usf true true true true)
  (=>
  (= (to_rep
     (rec__very_longs__very_long__octet_length (us_split_discrs1 usf1))) usf)
  (=> (<= 1 usf) (<= 1 1)))))))
(check-sat)
(exit)
