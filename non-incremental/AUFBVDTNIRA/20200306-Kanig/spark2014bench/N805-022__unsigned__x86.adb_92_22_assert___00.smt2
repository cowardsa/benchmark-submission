...
;; defqtvc
 ;; File "x86.ads", line 65, characters 0-0
  (not
  (forall ((xdi (Array Int unsigned_8)))
  (=> (dynamic_invariant val__ true false true true)
  (forall ((o unsigned_8))
  (=> (= (to_rep o) ((_ extract 7 0) (bvurem val__ #x00000100)))
  (forall ((xdi1 (Array Int unsigned_8)))
  (=> (= xdi1 (store xdi 0 o))
  (forall ((o1 unsigned_8))
  (=>
  (= (to_rep o1) ((_ extract 7 0) (bvurem (bvudiv val__ #x00000100) #x00000100)))
  (forall ((xdi2 (Array Int unsigned_8)))
  (=> (= xdi2 (store xdi1 1 o1))
  (forall ((o2 unsigned_8))
  (=>
  (= (to_rep o2) ((_ extract 7 0) (bvurem (bvudiv val__ #x00010000) #x00000100)))
  (forall ((xdi3 (Array Int unsigned_8)))
  (=> (= xdi3 (store xdi2 2 o2))
  (forall ((o3 unsigned_8))
  (=>
  (= (to_rep o3) ((_ extract 7 0) (bvurem (bvudiv val__ #x01000000) #x00000100)))
  (forall ((xdi4 (Array Int unsigned_8)))
  (=> (= xdi4 (store xdi3 3 o3))
  (=>
  (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi4 1))) #x00000100)) (bvurem val__ #x00010000))
  (=>
  (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 2))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi4 3))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000))
  (=>
  ...
  (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 2))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi4 3))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000)))
  (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select xdi4 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi4 3))) #x01000000)) val__))
  (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select xdi4 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi4 3))) #x01000000)) val__)))))))))))))))))))))))))
