...
;; defqtvc
 ;; File "messages.ads", line 39, characters 0-0
  (not
  (forall ((high_level__split_fields us_split_fields2)
  (messages__from_network__L_1__R3b__assume Int)
  (high_level__split_fields1 us_split_fields2)
  (messages__from_network__result us_split_fields2))
  (=>
  ...
  (=>
  (= (to_rep
     (rec__messages__network_message__size (us_split_fields1 low_level))) messages__from_network__L_1__R3b__assume)
  (=> (= messages__from_network__L_1__R3b__assume r3b)
  (=> (dynamic_invariant r3b true false true true)
  (=>
  (let ((temp___249 r3b))
  (exists ((i Int))
  (and (= i 1)
  ...
  (=> (= messages__from_network__result high_level__split_fields1)
