...
(declare-datatypes ((entry_id__ref 0))
(((entry_id__refqtmk (entry_id__content entry_id)))))
...
(define-fun to_int2 ((x entry_id)) Int (ubv_to_int (to_rep1 x)))
...
(define-fun dynamic_invariant1 ((temp___expr_160 Int)
  ...
  (temp___do_typ_inv_159 Bool)) Bool (=>
                                     ...
                                     (<= 0 5)) (in_range temp___expr_160)))

(define-fun dynamic_invariant2 ((temp___expr_167 (_ BitVec 8))
...
;; defqtvc
 ;; File "test.ads", line 8, characters 0-0
  ...
  (and (= (to_rep1 (rec__test__t__index s__split_fields)) o1)
  (let ((temp___209 (bvadd o1 #x01)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep1 (rec__test__t__index s__split_fields)) o2)
  (ite (bvule (bvsub #x05 o2) #x01) (= o (bvsub temp___209 #x05))
  (= o temp___209)))))))
  (forall ((o1 entry_id))
  (=> (= (to_rep1 o1) o)
  ...
  (= s__split_fields2 (us_split_fieldsqtmk
                      (rec__test__t__remaining s__split_fields) o1
                      (rec__test__t__cards s__split_fields)))
  (=>
  (exists ((o2 Int))
  (and (= (to_rep (rec__test__t__remaining s__split_fields2)) o2)
  (and (in_range_int (mod1 o2 5))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep1 (rec__test__t__index s__split_fields2)) o3)
  (exists ((o4 Int))
  (and (= (to_rep (rec__test__t__remaining s__split_fields2)) o4)
  (and (in_range_int (mod1 o4 5))
  (exists ((o5 (_ BitVec 8)))
  (= (to_rep1 (rec__test__t__index s__split_fields2)) o5))))))))))
  (=>
  (exists ((o2 (_ BitVec 8)))
  (= (to_rep1 (rec__test__t__index s__split_fields2)) o2))
