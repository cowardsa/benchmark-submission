...
(define-fun us_split_fields_rec__ada___ada___aco__math__very_longs__very_long__long_digits__20__projection ((a us_split_fields2)) us_t 
...
(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___207 (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array temp___207)
                                         (first1 temp___207)
                                         (last1 temp___207))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r1)
                                          (us_split_fieldsqtmk1
                                          (let ((temp___206 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
...
(define-fun dynamic_invariant3 ((temp___expr_721 us_rep1)
  (temp___is_init_717 Bool) (temp___skip_constant_718 Bool)
  (temp___do_toplevel_719 Bool)
  (temp___do_typ_inv_720 Bool)) Bool (and
                                     (=>
                                     ...
                                     (first1
                                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_721)))
                                     (last1
                                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_721))))
                                     (and
                                     (= (first1
                                        (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_721))) 1)
                                     (= (last1
                                        (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_721))) 
                                     (to_rep
...
(define-fun default_initial_assumption ((temp___expr_724 us_rep1)
  (temp___skip_top_level_725 Bool)) Bool (and
                                         (= (to_rep
                                            (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
...
(declare-fun temp_____aggregate_def_1214 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1216 (_ BitVec 8)))
  (forall ((temp___1217 Int) (temp___1218 Int))
  (let ((temp___1215 (temp_____aggregate_def_1214 temp___1216 temp___1217
                     temp___1218)))
  (=> (dynamic_invariant1 temp___1216 true true true true)
  (and
  (=> (dynamic_property 1 2147483647 temp___1217 temp___1218)
  (and (= (first1 temp___1215) temp___1217)
  (= (last1 temp___1215) temp___1218)))
  (forall ((temp___1219 Int))
  (= (to_rep2 (select (to_array temp___1215) temp___1219)) temp___1216))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_271 us_t)
...
(assert
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 58, characters 0-0
  (not
  ...
  (=> (dynamic_invariant2 difference1 false false true true)
  (=> (dynamic_invariant2 borrow false false true true)
  (=>
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1 l))) o1)
  (let ((temp___1220 (temp_____aggregate_def_1214 #x00 1 o1)))
  (=> (= (first1 temp___1220) 1)
  (=>
  (= (last1 temp___1220) (to_rep
                         (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                         (us_split_discrs1 l))))
  (=>
  (ite (<= (first1 temp___1220) (last1 temp___1220))
  (and
  (<= 1 (to_rep
        (rec__ada___ada___aco__math__very_longs__very_long__octet_length
        (us_split_discrs1 l))))
  (= (- (last1 temp___1220) (first1 temp___1220)) (- (to_rep
                                                     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                                     (us_split_discrs1 l))) 1)))
  (< (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1 l))) 1))
  (let ((temp___1222 (of_array (to_array temp___1220) (first1 temp___1220)
                     (last1 temp___1220))))
  (=>
  (ite (<= (first1 temp___1222) (last1 temp___1222))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1222) (first1 temp___1222)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1222)
  (forall ((borrow1 (_ BitVec 16)))
  (=> (= borrow1 #x0000)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1227 (last1
                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1227) true false)) true)
  ...
  (= (and (ite (and
               ...
               (and
               (and
               (and (dynamic_invariant2 borrow2 false true true true)
               (dynamic_invariant3
               (us_repqtmk1 result____split_discrs
               (us_split_fieldsqtmk1 result____split_fields3)) false true
               true true))
               (forall ((temp___1236 Int))
               (=>
               (and (<= (first1 result____split_fields3) temp___1236)
               (<= temp___1236 (last1 result____split_fields3)))
               (=>
               (or (< temp___1227 temp___1236)
               (or (< temp___1236 1) (<= i1 temp___1236)))
               (= (select (to_array result____split_fields3) temp___1236) (select 
               (to_array result____split_fields1) temp___1236))))))
               (dynamic_invariant2 l_digit1 false true true true))
               (dynamic_invariant2 r_digit1 false true true true))
               (dynamic_invariant2 difference2 false true true true))
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1228 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1228) i1) (<= i1 (last1 temp___1228)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1228) i1)) o2)
  (exists ((l_digit2 (_ BitVec 16)))
  (and (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1229 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1229) i1) (<= i1 (last1 temp___1229)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1229) i1)) o3)
  ...
  (forall ((ada___ada___aco__math__very_longs__modsubtract__result us_rep))
  (=>
  (= ada___ada___aco__math__very_longs__modsubtract__result (to_base
                                                            (us_repqtmk1
  ...
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1
     ada___ada___aco__math__very_longs__modsubtract__result))) (to_rep
                                                               (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))))))))))))))))))))))))))))))
(check-sat)
