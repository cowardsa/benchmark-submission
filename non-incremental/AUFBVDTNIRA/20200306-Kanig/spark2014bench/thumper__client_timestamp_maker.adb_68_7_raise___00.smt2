...
(declare-const hash us_t)

(declare-const attr__ATTRIBUTE_ADDRESS Int)

(declare-const timestamp us_t)

(declare-const attr__ATTRIBUTE_ADDRESS1 Int)

(define-fun dynamic_invariant ((temp___expr_171 us_t)
...
(define-fun dynamic_invariant3 ((temp___expr_164 (_ BitVec 8))
  (temp___is_init_160 Bool) (temp___skip_constant_161 Bool)
  (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "client_timestamp_maker.ads", line 23, characters 0-0
  (not
