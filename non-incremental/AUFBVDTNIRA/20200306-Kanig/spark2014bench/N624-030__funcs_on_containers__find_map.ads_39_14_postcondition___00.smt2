...
;; defqtvc
 ;; File "find_map.ads", line 36, characters 0-0
  (not
  (forall ((find_map__find_upto__result Int) (i Int))
  ...
  (and
  (and (find_all__function_guard find_map__find_upto__m__assume o)
  (and (dynamic_invariant1 find_map__find_upto__m__assume true false true
  true)
  (and
  (forall ((i1 Int))
  ...
  (= (contains find_map__find_upto__m__assume
     (to_rep (select (to_array o) i1))) true)
  (let ((temp___640 (element find_map__find_upto__m__assume
                    (to_rep (select (to_array o) i1)))))
  (and (<= (first1 o) temp___640) (<= temp___640 i1))))
  (= (to_rep
     (select (to_array o) (element find_map__find_upto__m__assume
                          (to_rep (select (to_array o) i1))))) (to_rep
                                                               (select 
                                                               (to_array o) i1))))))
  (forall ((e1 Int))
  ...
  (and (dynamic_invariant1 m true false true true)
  (let ((o1 e))
  (let ((o2 m))
  ...
  (let ((o4 m))
  (let ((o5 (find_map_bad o4)))
  (and
  (and (find_map_bad__function_guard o5 o4)
  (and (dynamic_invariant o5 true false true true)
  (and (= o5 (ite (<= (element o4 e) last2) (element o4 e) 0))
  (=> (= o5 0)
  (forall ((i1 Int))
  (=> (and (<= (first1 a) i1) (<= i1 last2))
  (not (= (to_rep (select (to_array a) i1)) e))))))))
  (= find_map__find_upto__result o5)))) (= find_map__find_upto__result 0)))))))))))))
  (=> (= find_map__find_upto__result 0)
  (=> (<= (first1 a) i)
