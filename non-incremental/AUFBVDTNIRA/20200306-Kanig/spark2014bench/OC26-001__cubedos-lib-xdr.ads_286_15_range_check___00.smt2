...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 274, characters 0-0
  ...
  (exists ((o3 Bool))
  (and
  (ite (= (mod1 position 4) 0) (= o3 (ite (< 0 (length2 data)) true false))
  (= o3 false))
  (ite (= o3 true) (= o (ite (= (mod1 (length2 data) 4) 0) true false))
  (= o false))))
  (=> (= o true)
  (=> (= (to_rep1 value__last) o1)
  (=> (= (to_rep1 value__first) o2) (in_range1 (length o2 o1)))))))))))))
(check-sat)
(exit)
