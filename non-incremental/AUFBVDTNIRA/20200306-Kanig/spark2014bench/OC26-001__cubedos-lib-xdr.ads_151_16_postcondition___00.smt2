...
(define-fun to_int2 ((x octet)) Int (ubv_to_int (to_rep1 x)))
...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 137, characters 0-0
  ...
  (=>
  (ite (<= (first1 temp___548) (last1 temp___548))
  (and (<= (first1 temp___550) (last1 temp___550))
  (= (- (last1 temp___548) (first1 temp___548)) (- (last1 temp___550) 
  (first1 temp___550)))) (< (last1 temp___550) (first1 temp___550)))
  (forall ((usf (Array Int octet)))
  (=>
  (forall ((temp___552 Int))
  (ite (and (<= position temp___552)
       (<= temp___552 (- (+ position (length1 value)) 1)))
  (= (select usf temp___552) (select (to_array temp___548) temp___552))
  (= (select usf temp___552) (select data temp___552))))
  (forall ((data1 (Array Int octet)))
  (=> (= data1 usf)
  (=>
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (= (mod1 (length1 value) 4) 0) false true))
  (or (not (= spark__branch true))
  (let ((o1 (length1 value)))
  (and (in_range1 o1)
  (let ((o2 (+ position o1)))
  (and (in_range3 o2)
  (exists ((padding_start1 Int))
  (and (= padding_start1 o2)
  (let ((o3 (length1 value)))
  (and (in_range1 o3)
  (let ((o4 (+ padding_start1 (- 3 (mod1 o3 4)))))
  (and (in_range3 o4)
  (exists ((padding_stop1 Int))
  (and (= padding_stop1 o4)
  (and (= padding_start1 r12b)
  (and (dynamic_invariant1 r12b true false true true)
  (and (= padding_stop1 r13b)
  (and (dynamic_invariant1 r13b true false true true)
  (let ((temp___559 (temp_____aggregate_def_553 #x00 r12b r13b)))
  (and (= (first1 temp___559) r12b)
  (and (= (last1 temp___559) r13b)
  (and
  (ite (<= (first1 temp___559) (last1 temp___559))
  (and (<= r12b r13b)
  (= (- (last1 temp___559) (first1 temp___559)) (- r13b r12b)))
  (< r13b r12b))
  (let ((temp___561 (of_array
                    (slide (to_array temp___559) (first1 temp___559) r12b)
                    r12b r13b)))
  (and
  (=> (<= r12b r13b)
  (and (and (<= (to_rep data__first) r12b) (<= r12b (to_rep data__last)))
  (and (<= (to_rep data__first) r13b) (<= r13b (to_rep data__last)))))
  (let ((temp___562 (of_array data1 r12b r13b)))
  (and
  (ite (<= (first1 temp___561) (last1 temp___561))
  (and (<= (first1 temp___562) (last1 temp___562))
  (= (- (last1 temp___561) (first1 temp___561)) (- (last1 temp___562) 
  (first1 temp___562)))) (< (last1 temp___562) (first1 temp___562)))
  (exists ((usf1 (Array Int octet)))
  (forall ((temp___564 Int))
  (ite (and (<= r12b temp___564) (<= temp___564 r13b))
  (= (select usf1 temp___564) (select (to_array temp___561) temp___564))
  (= (select usf1 temp___564) (select data1 temp___564))))))))))))))))))))))))))))))))
  (let ((o1 (length1 value)))
  (=> (in_range2 o1)
  (let ((o2 (length_with_padding o1)))
  (=>
  (and (length_with_padding__function_guard o2 o1)
  (and (dynamic_invariant o2 true false true true)
  (= o2 (+ o1 (ite (= (mod1 o1 4) 0) 0 (- 4 (mod1 o1 4)))))))
  (let ((o3 (+ position (- o2 1))))
  (=> (in_range4 o3)
  (forall ((last3 Int))
  (=> (= last3 o3)
  (=> (length_with_padding__function_guard
  (length_with_padding (length1 value)) (length1 value))
  (= last3 (+ position (- (length_with_padding (length1 value)) 1)))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
