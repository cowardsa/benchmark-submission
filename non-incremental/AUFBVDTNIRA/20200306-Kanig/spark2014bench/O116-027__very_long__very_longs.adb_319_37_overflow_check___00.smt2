...
(((t91b__refqtmk (t91b__content us_t)))))
(define-fun t91b__ref_t91b__content__projection ((a t91b__ref)) us_t 
  (t91b__content a))

(declare-fun temp_____aggregate_def_1061 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1063 (_ BitVec 8)))
  (forall ((temp___1064 Int) (temp___1065 Int))
  (let ((temp___1062 (temp_____aggregate_def_1061 temp___1063 temp___1064
                     temp___1065)))
  (=> (dynamic_invariant3 temp___1063 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1064 temp___1065)
  (and (= (first1 temp___1062) temp___1064)
  (= (last1 temp___1062) temp___1065)))
  (forall ((temp___1066 Int))
  (= (to_rep2 (select (to_array temp___1062) temp___1066)) temp___1063))))))))
...
;; defqtvc
 ;; File "very_longs.ads", line 55, characters 0-0
  ...
  (let ((temp___1067 (temp_____aggregate_def_1061 #x00 1 o1)))
  (=> (= (first1 temp___1067) 1)
  (=>
  (= (last1 temp___1067) (to_rep
                         (rec__very_longs__very_long__length
                         (us_split_discrs1 l))))
  (=>
  ...
  (= (- (last1 temp___1067) (first1 temp___1067)) (- (to_rep
                                                     (rec__very_longs__very_long__length
                                                     (us_split_discrs1 l))) 1)))
  (< (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1))
  (let ((temp___1069 (of_array (to_array temp___1067) (first1 temp___1067)
                     (last1 temp___1067))))
  (=>
  (ite (<= (first1 temp___1069) (last1 temp___1069))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1069) (first1 temp___1069)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1069)
  (forall ((j Int))
  (=> (= j 1)
  (=>
  (= (and (ite (<= 1 j) true false) (ite (<= j (last1
                                               (rec__very_longs__very_long__long_digits
                                               (us_split_fields1 r))))
                                    true false)) true)
  (forall ((result____split_fields2 us_t) (l_digit1 (_ BitVec 16))
  ...
  (= (and (ite (and
               ...
               true)) (dynamic_invariant2 r_digit1 false true true true))
  ...
  (= (and (ite (<= 1 i) true false) (ite (<= i (last1
                                               ...
                                               (us_split_fields1 l))))
                                    true false)) true)
  (forall ((result____split_fields3 us_t) (l_digit2 (_ BitVec 16))
  ...
  (= (and (ite (and
               ...
               true)) (dynamic_invariant2 r_digit2 false true true true))
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1077 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1077) i1) (<= i1 (last1 temp___1077)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1077) i1)) o2)
  (forall ((l_digit3 (_ BitVec 16)))
  (=> (= l_digit3 ((_ zero_extend 8) o2))
  (let ((temp___1078 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1078) j1) (<= j1 (last1 temp___1078)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1078) j1)) o3)
  (forall ((r_digit3 (_ BitVec 16)))
  (=> (= r_digit3 ((_ zero_extend 8) o3))
  (=> (= (last1 result____split_fields3) r94b)
  (=> (in_range2 r94b)
  (let ((o4 (+ i1 j1)))
  (=> (in_range2 o4)
  (let ((temp___1085 (- o4 1)))
  (forall ((spark__branch Bool))
  (=>
  (= spark__branch (and (ite (<= 1 temp___1085) true false) (ite (<= temp___1085 
                                                            r94b) true false)))
  (=> (= spark__branch true)
  (let ((o5 (+ i1 j1)))
  (=> (in_range2 o5)
  (let ((temp___1080 (- o5 1)))
  (=>
  (and (<= (first1 result____split_fields3) temp___1080)
  (<= temp___1080 (last1 result____split_fields3)))
  (forall ((o6 (_ BitVec 8)))
  (=>
  (= (to_rep2 (select (to_array result____split_fields3) temp___1080)) o6)
  (forall ((t_digit3 (_ BitVec 16)))
  (=> (= t_digit3 ((_ zero_extend 8) o6))
  (forall ((temp3 (_ BitVec 16)))
  (=> (= temp3 (bvadd (bvadd (bvmul l_digit3 r_digit3) t_digit3) carry3))
