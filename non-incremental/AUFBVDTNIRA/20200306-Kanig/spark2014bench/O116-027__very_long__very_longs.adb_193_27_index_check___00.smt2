...
;; defqtvc
 ;; File "very_longs.ads", line 24, characters 0-0
  ...
  (let ((temp___939 (last1
                    (rec__very_longs__very_long__long_digits
                    (us_split_fields1 l)))))
  (forall ((i Int))
  (=> (= i temp___939)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___939) true false)) true)
  (forall ((i1 Int))
  (=>
  (= (and (ite true true false) (ite (and (<= 1 i1)
                                     (<= i1 (last1
                                            ...
                                            (us_split_fields1 l)))))
                                true false)) true)
  (let ((temp___942 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 r))))
  (=> (and (<= (first1 temp___942) i1) (<= i1 (last1 temp___942)))
  (forall ((o (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___942) i1)) o)
  (let ((temp___941 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 l))))
  (=> (and (<= (first1 temp___941) i1) (<= i1 (last1 temp___941)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___941) i1)) o1)
  (forall ((spark__branch Bool))
  (=> (= spark__branch (ite (bvult o1 o) true false))
  (=> (not (= spark__branch true))
  (let ((temp___945 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 r))))
  (=> (and (<= (first1 temp___945) i1) (<= i1 (last1 temp___945)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___945) i1)) o2)
