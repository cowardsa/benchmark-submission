...
;; defqtvc
 ;; File "area_math.ads", line 46, characters 0-0
  ...
  (=>
  (<= (to_rep (rec__area_math__ensemble__size1 result____split_fields4)) (+ i 1))
  (=>
  (=> (not (= skip2 true))
  ...
  (= (to_rep2
     (select (to_array
             (rec__area_math__ensemble__to1 result____split_fields4)) 
     (to_rep (rec__area_math__ensemble__size1 result____split_fields4)))) #xFFFFFFFF)
  (and (< i (to_rep (rec__area_math__ensemble__size (us_split_fields1 e))))
  (= (to_rep2
     (select (to_array
             (rec__area_math__ensemble__to1 result____split_fields4)) 
     (to_rep (rec__area_math__ensemble__size1 result____split_fields4)))) (bvsub 
  ...
  (= (to_rep2
     (select (to_array (rec__area_math__ensemble__from (us_split_fields1 e))) (+ i 1))) #x00000000))
  (and
  (and (= i (to_rep (rec__area_math__ensemble__size (us_split_fields1 e))))
  (not (= (to_rep (rec__area_math__ensemble__size (us_split_fields1 e))) 0)))
  (= (to_rep2
     (select (to_array (rec__area_math__ensemble__to (us_split_fields1 e))) i)) #xFFFFFFFF))))
  (=> (is_consistent__function_guard (is_consistent e) e)
  (=> (= (is_consistent e) true)
  (=>
  (< 0 (to_rep (rec__area_math__ensemble__size1 result____split_fields4)))
