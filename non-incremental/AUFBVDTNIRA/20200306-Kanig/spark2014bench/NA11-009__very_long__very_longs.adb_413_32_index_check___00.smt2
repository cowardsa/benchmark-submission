...
(assert
;; defqtvc
 ;; File "very_longs.adb", line 402, characters 0-0
  (not
  ...
  (=> (in_range2 r120b)
  (let ((temp___1315 r120b))
  (forall ((i Int))
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1315) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 number__split_fields1) temp___1328)
               (<= temp___1328 (last1 number__split_fields1)))
               (=>
               (or (< temp___1315 temp___1328)
               (or (< temp___1328 1) (<= i1 temp___1328)))
               (= (select (to_array number__split_fields1) temp___1328) (select 
               (to_array number__split_fields) temp___1328))))))
               (dynamic_invariant2 old_overflow1 true true true true))
          true false) (ite (and (<= 1 i1) (<= i1 r120b)) true false)) true)
  (let ((o1 (- 8 distance)))
  (=>
