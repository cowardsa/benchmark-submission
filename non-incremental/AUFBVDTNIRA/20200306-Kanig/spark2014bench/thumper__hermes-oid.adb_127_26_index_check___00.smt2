...
;; defqtvc
 ;; File "hermes-oid.ads", line 52, characters 0-0
  ...
  (forall ((o14 Int))
  (=> (= (to_rep result____last) o14)
  (forall ((o15 Int))
  (=> (= (to_rep result____first) o15)
  (forall ((result_index3 Int) (current_component3 Int))
  (=>
  ...
  (dynamic_invariant result_index3 false true true true))
  (forall ((o16 Int))
  (=> (= (to_rep result____last) o16)
  (forall ((spark__branch1 Bool))
  (=> (= spark__branch1 (ite (= result_index3 o16) true false))
  (=> (not (= spark__branch1 true))
  (let ((o17 (+ result_index3 1)))
  (=> (in_range1 o17)
  ...
  (=> (uint_in_range o18)
  (forall ((o19 octet))
  (=> (= (to_rep5 o19) ((_ int_to_bv 8) o18))
  (<= (to_rep result____first) result_index4)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
