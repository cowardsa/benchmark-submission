...
;; defqtvc
 ;; File "test.ads", line 37, characters 0-0
  ...
  (=> (and (<= (first1 right) usf) (<= usf (last1 right)))
  (forall ((o5 (_ BitVec 32)))
  (=> (= (to_rep1 (select (to_array right) usf)) o5)
  (=> (and (<= (first1 left) usf) (<= usf (last1 left)))
  (forall ((o6 (_ BitVec 32)))
  (=> (= (to_rep1 (select (to_array left) usf)) o6)
  (let ((o7 (xor2 o6 o5)))
  (=>
  (and (xor2__function_guard o7 o6 o5)
  (and (dynamic_invariant o7 true false true true) (= o7 (bvxor o6 o5))))
