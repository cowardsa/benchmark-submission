...
;; defqtvc
 ;; File "skein.ads", line 131, characters 0-0
  ...
  (=> (= spark__branch (ite (bvult o3 #x0000000000000040) true false))
  (=> (= spark__branch true)
  (forall ((skein__skein_512_final__B13b__L_3__R14b__assume (_ BitVec 64)))
  (=>
  (= (to_rep2
     (rec__skein__context_header__byte_count
     (us_split_fields3
     (rec__skein__skein_512_context__h local_ctx__split_fields1)))) skein__skein_512_final__B13b__L_3__R14b__assume)
  (=> (= skein__skein_512_final__B13b__L_3__R14b__assume r14b)
  (=> (dynamic_invariant r14b true false true true)
  (=> (bvule r14b #x000000000000003F) (bvuge r14b #x0000000000000000)))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
