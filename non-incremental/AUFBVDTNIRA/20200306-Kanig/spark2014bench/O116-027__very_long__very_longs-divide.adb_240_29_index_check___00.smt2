...
(define-fun to_int3 ((x octet)) Int (ubv_to_int (to_rep2 x)))
...
(declare-datatypes ((digit_count_type__ref 0))
  ...
  (! (=> (dynamic_invariant number true true true true)
     ...
     (= (to_rep2
        (let ((temp___316 (rec__very_longs__very_long__long_digits
                          (us_split_fields1 number))))
        (select (to_array temp___316) j))) #x00))))
...
(((t110b__refqtmk (t110b__content us_t)))))
(define-fun t110b__ref_t110b__content__projection ((a t110b__ref)) us_t 
  (t110b__content a))
...
(((t111b__refqtmk (t111b__content us_t)))))
(define-fun t111b__ref_t111b__content__projection ((a t111b__ref)) us_t 
  (t111b__content a))
...
(declare-datatypes ((s131b__ref 0))
(((s131b__refqtmk (s131b__content us_t)))))
(define-fun s131b__ref_s131b__content__projection ((a s131b__ref)) us_t 
  (s131b__content a))

(declare-datatypes ((t134b__ref 0))
(((t134b__refqtmk (t134b__content us_t)))))
(define-fun t134b__ref_t134b__content__projection ((a t134b__ref)) us_t 
  (t134b__content a))

(declare-datatypes ((s135b__ref 0))
(((s135b__refqtmk (s135b__content us_t)))))
(define-fun s135b__ref_s135b__content__projection ((a s135b__ref)) us_t 
  (s135b__content a))

(declare-datatypes ((t138b__ref 0))
(((t138b__refqtmk (t138b__content us_t)))))
(define-fun t138b__ref_t138b__content__projection ((a t138b__ref)) us_t 
  (t138b__content a))

(declare-fun temp_____aggregate_def_1170 ((_ BitVec 8) Int Int) us_t)

(declare-fun temp_____aggregate_def_1183 ((_ BitVec 8) Int Int) us_t)
...
;; def_axiom
  (assert
  (forall ((temp___1172 (_ BitVec 8)))
  (forall ((temp___1173 Int) (temp___1174 Int))
  (let ((temp___1171 (temp_____aggregate_def_1170 temp___1172 temp___1173
                     temp___1174)))
  (=> (dynamic_invariant4 temp___1172 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1173 temp___1174)
  (and (= (first1 temp___1171) temp___1173)
  (= (last1 temp___1171) temp___1174)))
  (forall ((temp___1175 Int))
  (= (to_rep2 (select (to_array temp___1171) temp___1175)) temp___1172))))))))

;; def_axiom
  (assert
  (forall ((temp___1185 (_ BitVec 8)))
  (forall ((temp___1186 Int) (temp___1187 Int))
  (let ((temp___1184 (temp_____aggregate_def_1183 temp___1185 temp___1186
                     temp___1187)))
  (=> (dynamic_invariant4 temp___1185 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1186 temp___1187)
  (and (= (first1 temp___1184) temp___1186)
  (= (last1 temp___1184) temp___1187)))
  (forall ((temp___1188 Int))
  (= (to_rep2 (select (to_array temp___1184) temp___1188)) temp___1185))))))))
...
;; defqtvc
 ;; File "very_longs.ads", line 65, characters 0-0
  ...
  (v__split_fields us_t) (q_hat (_ BitVec 16)) (current_borrow (_ BitVec 16))
  (o Int))
  ...
  (=> (number_of_digits__function_guard1 (number_of_digits1 divisor) 
  divisor)
  (=> (< 1 (number_of_digits1 divisor))
  (=>
  ...
  (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))))
  (=> (dynamic_invariant8 n false false true true)
  (=> (dynamic_invariant9 m false false true true)
  ...
  (forall ((o1 Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))) o1)
  (=> (in_range1 o1)
  ...
  (forall ((very_longs__divide__R132b__assume Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__length quotient__split_discrs)) very_longs__divide__R132b__assume)
  (=> (= very_longs__divide__R132b__assume r132b)
  (=> (dynamic_invariant7 r132b true false true true)
  (let ((temp___1176 (temp_____aggregate_def_1170 #x00 1 r132b)))
  (=> (= (first1 temp___1176) 1)
  (=> (= (last1 temp___1176) r132b)
  (=>
  (ite (<= (first1 temp___1176) (last1 temp___1176))
  (and (<= 1 r132b)
  (= (- (last1 temp___1176) (first1 temp___1176)) (- r132b 1))) (< r132b 1))
  (let ((temp___1178 (of_array (to_array temp___1176) (first1 temp___1176)
                     (last1 temp___1176))))
  (=>
  (ite (<= (first1 temp___1178) (last1 temp___1178))
  (and (<= (first1 quotient__split_fields) (last1 quotient__split_fields))
  (= (- (last1 temp___1178) (first1 temp___1178)) (- (last1
  ...
  (=>
  (= quotient__split_fields1 (of_array (to_array temp___1178)
                             (first1 temp___1178) (last1 temp___1178)))
  (forall ((very_longs__divide__R136b__assume Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__length remainder__split_discrs)) very_longs__divide__R136b__assume)
  (=> (= very_longs__divide__R136b__assume r136b)
  (=> (dynamic_invariant7 r136b true false true true)
  (let ((temp___1189 (temp_____aggregate_def_1183 #x00 1 r136b)))
  (=> (= (first1 temp___1189) 1)
  (=> (= (last1 temp___1189) r136b)
  (=>
  (ite (<= (first1 temp___1189) (last1 temp___1189))
  (and (<= 1 r136b)
  (= (- (last1 temp___1189) (first1 temp___1189)) (- r136b 1))) (< r136b 1))
  (let ((temp___1191 (of_array (to_array temp___1189) (first1 temp___1189)
                     (last1 temp___1189))))
  (=>
  (ite (<= (first1 temp___1191) (last1 temp___1191))
  (and (<= (first1 remainder__split_fields) (last1 remainder__split_fields))
  (= (- (last1 temp___1191) (first1 temp___1191)) (- (last1
  ...
  (=>
  (= remainder__split_fields1 (of_array (to_array temp___1191)
                              (first1 temp___1191) (last1 temp___1191)))
  (let ((o2 divisor))
  (let ((temp___1196 (number_of_digits1 o2)))
  (=>
  (and (number_of_digits__function_guard1 temp___1196 o2)
  (and (dynamic_invariant1 temp___1196 true false true true)
  (and
  (=> (< 0 temp___1196)
  (not
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits (us_split_fields1 o2))) temp___1196)) #x00)))
  (forall ((j Int))
  (=>
  (and (<= (+ temp___1196 1) j)
  (<= j (last1
        (rec__very_longs__very_long__long_digits (us_split_fields1 o2)))))
  (= (to_rep2
     (select (to_array
  ...
  (let ((temp___1197 (- o3 n1)))
  (=> (dynamic_property2 first2 last3 temp___1197)
  (forall ((m1 Int))
  (=> (= m1 temp___1197)
  (let ((temp___1198 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 divisor))))
  (=> (and (<= (first1 temp___1198) n1) (<= n1 (last1 temp___1198)))
  (forall ((o4 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1198) n1)) o4)
  (let ((o5 (get_shift_distance o4)))
  (=>
  (and (get_shift_distance__function_guard o5 o4) (dynamic_invariant5 o5 true
  false true true))
  ...
  true true true true)
  (let ((temp___1199 (of_base
                     (us_repqtmk u__split_discrs
                     (us_split_fieldsqtmk
                     very_longs__divide__full_left_shift__result__fields)))))
  (forall ((u__split_fields1 us_t))
  (=>
  (= (us_split_fieldsqtmk1 u__split_fields1) (us_split_fields3 temp___1199))
  (=> (= u__split_discrs (us_split_discrs2 temp___1199))
  (forall ((o6 Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))) o6)
  (let ((temp___1200 (of_base1 divisor)))
  (forall ((v__split_fields1 us_t))
  (=>
  (= (us_split_fieldsqtmk2 v__split_fields1) (us_split_fields5 temp___1200))
  (=> (= v__split_discrs (us_split_discrs3 temp___1200))
  ...
  (=>
  (let ((temp___1203 r139b))
  (exists ((j Int))
  (and (= j temp___1203)
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1203) true false)) true)
  (exists ((quotient__split_fields2 us_t) (u__split_fields3 us_t)
  (q_hat1 (_ BitVec 16)) (current_borrow1 (_ BitVec 16)) (j1 Int))
  (and
  (= (and (ite (and
               (and
               (and (dynamic_invariant2
               (us_repqtmk1 u__split_discrs
               (us_split_fieldsqtmk1 u__split_fields3)) false true true true)
               (dynamic_invariant
               (us_repqtmk quotient__split_discrs
               (us_split_fieldsqtmk quotient__split_fields2)) false true true
               true)) (dynamic_invariant6 q_hat1 false true true true))
               (dynamic_invariant6 current_borrow1 false true true true))
  ...
  (= j1 1)))))))))))) (= u__split_fields2 u__split_fields1)))))
  (=> (= n1 r141b)
  (=> (dynamic_invariant8 r141b true false true true)
  (let ((temp___1209 r141b))
  (forall ((divisor_index Int))
  (=> (= divisor_index 1)
  (=>
  (= (and (ite (<= 1 divisor_index) true false) (ite (<= divisor_index temp___1209)
                                                true false)) true)
  ...
  (= (and (ite (and (dynamic_invariant
               ...
               true true)
               (forall ((temp___1216 Int))
               (=>
               (and (<= (first1 remainder__split_fields2) temp___1216)
               (<= temp___1216 (last1 remainder__split_fields2)))
               (=>
               (or (< temp___1209 temp___1216)
               (or (< temp___1216 1) (<= divisor_index1 temp___1216)))
               (= (select (to_array remainder__split_fields2) temp___1216) (select 
               (to_array remainder__split_fields1) temp___1216))))))
          true false) (ite (and (<= 1 divisor_index1)
                           (<= divisor_index1 r141b))
                      true false)) true)
  (=>
  (and (<= (first1 u__split_fields2) divisor_index1)
  (<= divisor_index1 (last1 u__split_fields2)))
  (forall ((o8 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields2) divisor_index1)) o8)
  (forall ((o9 octet))
  (=> (= (to_rep2 o9) o8)
