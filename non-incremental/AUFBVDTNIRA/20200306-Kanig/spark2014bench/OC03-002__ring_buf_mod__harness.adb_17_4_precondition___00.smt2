...
;; lsr_bv_is_lsr
  ...
  (= (bvlshr x1 n) (lsr x1 (ubv_to_int n)))))

;; asr_bv_is_asr
  (assert
  (forall ((x1 (_ BitVec 16)) (n (_ BitVec 16)))
  (= (bvashr x1 n) (asr x1 (ubv_to_int n)))))

;; lsl_bv_is_lsl
  (assert
  (forall ((x1 (_ BitVec 16)) (n (_ BitVec 16)))
  (= (bvshl x1 n) (lsl x1 (ubv_to_int n)))))
...
;; Nth_bv_is_nth
  (assert
  (forall ((x1 (_ BitVec 16)) (i (_ BitVec 16)))
  (= (nth x1 (ubv_to_int i)) (nth_bv x1 i))))
...
(define-fun to_int2 ((x1 ar_index)) Int (ubv_to_int (to_rep x1)))
...
;; to_model__def_axiom
  (assert
  (forall ((r us_rep))
  (! (= (to_model r) (ite (< 65535 (- (+ (ubv_to_int (to_rep
                                                 (rec__ring_buf__ring_buffer__first
                                                 (us_split_fields1 r)))) 
                     (to_rep2
                     (rec__ring_buf__ring_buffer__length
...
;; defqtvc
 ;; File "harness.adb", line 3, characters 0-0
  ...
  (=>
  (forall ((r__split_fields3 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields3)) (us_repqtmk r__split_fields3)))
  (=>
  (forall ((r__split_fields3 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields3)) (us_repqtmk r__split_fields3)))
  (=>
  (forall ((r__split_fields3 us_split_fields) (o Int))
  (func_push__function_guard
  (func_push (to_model (us_repqtmk r__split_fields3)) o)
  (to_model (us_repqtmk r__split_fields3)) o))
  (=>
  (forall ((r__split_fields3 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields3)) (us_repqtmk r__split_fields3)))
  (=>
  (= (let ((temp___255 (func_push (to_model (us_repqtmk r__split_fields1)) y)))
     (let ((temp___254 (to_model (us_repqtmk r__split_fields2))))
     (bool_eq (to_array temp___254) (first1 temp___254) (last1 temp___254)
     (to_array temp___255) (first1 temp___255) (last1 temp___255)))) true)
  (forall ((r__split_fields3 us_split_fields) (h1 Int))
  (=>
  (forall ((r__split_fields4 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields4)) (us_repqtmk r__split_fields4)))
  (=>
  (forall ((r__split_fields4 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields4)) (us_repqtmk r__split_fields4)))
  (=>
  (forall ((r__split_fields4 us_split_fields)) (func_pop__function_guard
  (func_pop (to_model (us_repqtmk r__split_fields4)))
  (to_model (us_repqtmk r__split_fields4))))
  (=>
  (forall ((r__split_fields4 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields4)) (us_repqtmk r__split_fields4)))
  (=>
  ...
  (to_model (us_repqtmk r__split_fields4)) (us_repqtmk r__split_fields4)))
  (=>
  (forall ((r__split_fields4 us_split_fields)) (func_head__function_guard
  (func_head (to_model (us_repqtmk r__split_fields4)))
  (to_model (us_repqtmk r__split_fields4))))
  (=>
  (and
  (and
  (= (let ((temp___279 (func_pop (to_model (us_repqtmk r__split_fields2)))))
     (let ((temp___278 (to_model (us_repqtmk r__split_fields3))))
     (bool_eq (to_array temp___278) (first1 temp___278) (last1 temp___278)
     (to_array temp___279) (first1 temp___279) (last1 temp___279)))) true)
  ...
  (=>
  (forall ((r__split_fields5 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields5)) (us_repqtmk r__split_fields5)))
  (=>
  (forall ((r__split_fields5 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields5)) (us_repqtmk r__split_fields5)))
  (=>
  (forall ((r__split_fields5 us_split_fields) (o Int))
  (func_push__function_guard
  (func_push (to_model (us_repqtmk r__split_fields5)) o)
  (to_model (us_repqtmk r__split_fields5)) o))
  (=>
  (forall ((r__split_fields5 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields5)) (us_repqtmk r__split_fields5)))
  (=>
  (= (let ((temp___255 (func_push (to_model (us_repqtmk r__split_fields3)) z)))
     (let ((temp___254 (to_model (us_repqtmk r__split_fields4))))
     (bool_eq (to_array temp___254) (first1 temp___254) (last1 temp___254)
     (to_array temp___255) (first1 temp___255) (last1 temp___255)))) true)
  (forall ((r__split_fields5 us_split_fields) (h2 Int))
  (=>
  (forall ((r__split_fields6 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields6)) (us_repqtmk r__split_fields6)))
  (=>
  (forall ((r__split_fields6 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields6)) (us_repqtmk r__split_fields6)))
  (=>
  (forall ((r__split_fields6 us_split_fields)) (func_pop__function_guard
  (func_pop (to_model (us_repqtmk r__split_fields6)))
  (to_model (us_repqtmk r__split_fields6))))
  (=>
  (forall ((r__split_fields6 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields6)) (us_repqtmk r__split_fields6)))
  (=>
  ...
  (to_model (us_repqtmk r__split_fields6)) (us_repqtmk r__split_fields6)))
  (=>
  (forall ((r__split_fields6 us_split_fields)) (func_head__function_guard
  (func_head (to_model (us_repqtmk r__split_fields6)))
  (to_model (us_repqtmk r__split_fields6))))
  (=>
  (and
  (and
  (= (let ((temp___279 (func_pop (to_model (us_repqtmk r__split_fields4)))))
     (let ((temp___278 (to_model (us_repqtmk r__split_fields5))))
     (bool_eq (to_array temp___278) (first1 temp___278) (last1 temp___278)
     (to_array temp___279) (first1 temp___279) (last1 temp___279)))) true)
  (= h2 (func_head (to_model (us_repqtmk r__split_fields4)))))
  (dynamic_invariant h2 true true true true))
  (=> (= h2 y)
  (=>
  (forall ((r__split_fields6 us_split_fields)) (is_empty__function_guard
  (is_empty (us_repqtmk r__split_fields6)) (us_repqtmk r__split_fields6)))
  (not (= (is_empty (us_repqtmk r__split_fields5)) true))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
