...
(define-fun dynamic_invariant ((temp___expr_209 us_t)
...
(define-fun dynamic_invariant4 ((temp___expr_200 us_t1)
  ...
  (temp___do_typ_inv_199 Bool)) Bool (and
                                     ...
                                     (= (mod2 (length1 temp___expr_200) 5) 0)))))
...
(assert
;; defqtvc
 ;; File "base32.ads", line 38, characters 0-0
  (not
  (=> (dynamic_invariant i8s true false true true)
  (=> (dynamic_invariant i8s true false true true)
  (=> (dynamic_invariant s true false true true) (in_range1 (length s)))))))
(check-sat)
(exit)
