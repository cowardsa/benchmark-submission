...
(declare-fun xdr_integer_to_unsigned (Int) (_ BitVec 32))

(declare-fun xdr_integer_to_unsigned__function_guard ((_ BitVec 32)
  Int) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_282 (_ BitVec 32))
  (temp___is_init_278 Bool) (temp___skip_constant_279 Bool)
  (temp___do_toplevel_280 Bool) (temp___do_typ_inv_281 Bool)) Bool true)

;; xdr_integer_to_unsigned__post_axiom
  (assert
  (forall ((s Int))
  (! (=> (dynamic_invariant1 s true true true true)
     (let ((result (xdr_integer_to_unsigned s)))
     (=> (xdr_integer_to_unsigned__function_guard result s)
     (dynamic_invariant2 result true false true true)))) :pattern ((xdr_integer_to_unsigned
                                                                   s)) )))
...
(declare-fun user_eq6 (xdr_integer xdr_integer) Bool)

(declare-const dummy6 xdr_integer)
...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 54, characters 0-0
  ...
  (let ((o value))
  (let ((o1 (xdr_integer_to_unsigned o)))
  (=>
  (and (xdr_integer_to_unsigned__function_guard o1 o) (dynamic_invariant2 o1
  true false true true))
  (forall ((last3 Int))
  (=>
  (and (= last3 (+ position 3)) (dynamic_invariant last3 true true true
  true)) (= last3 (+ position 3)))))))))))))))))))
(check-sat)
(exit)
