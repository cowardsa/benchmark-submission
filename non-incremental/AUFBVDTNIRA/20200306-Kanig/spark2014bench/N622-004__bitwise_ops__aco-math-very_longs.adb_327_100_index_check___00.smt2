...
;; defqtvc
 ;; File "aco-math-very_longs.adb", line 323, characters 0-0
  ...
  (ada___ada___aco__math__very_longs__divide__get_msd__result Int) (usf Int))
  ...
  (let ((o (+ ada___ada___aco__math__very_longs__divide__get_msd__result 1)))
  (=> (in_range2 o)
  (=>
