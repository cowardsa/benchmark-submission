...
;; defqtvc
 ;; File "test.ads", line 7, characters 0-0
  (not
  (forall ((dest (Array Int byte)) (dest1 (Array Int byte)) (usf Int) (o Int)
  (o1 Int))
  ...
  (=>
  (let ((temp___201 (- src_length 1)))
  (exists ((i Int))
  (and (= i 0)
  (ite (= (and (ite (<= 0 i) true false) (ite (<= i temp___201) true false)) true)
  (exists ((temp___loop_entry_210 (Array Int byte)))
  (and (= temp___loop_entry_210 dest)
  (let ((o2 (+ src_first i)))
  (and (in_range1 o2)
  (and (and (<= (first1 src) o2) (<= o2 (last1 src)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep1 (select (to_array src) o2)) o3)
  (exists ((o4 byte))
  (and (= (to_rep1 o4) o3)
  (let ((o5 (+ index i)))
  (and (in_range1 o5)
  (and (and (<= (to_rep dest__first) o5) (<= o5 (to_rep dest__last)))
  (exists ((dest2 (Array Int byte)))
  (and (= dest2 (store dest o5 o4))
  (and
  (exists ((o6 Int))
  (and (= (to_rep dest__last) o6)
  (exists ((o7 Int)) (= (to_rep dest__first) o7))))
  (exists ((i1 Int))
  (and
  (forall ((j Int))
  (=> (and (<= (to_rep dest__first) j) (<= j (to_rep dest__last)))
  (ite (and (<= index j) (<= j (+ index i1)))
  (= (to_rep1 (select dest1 j)) (to_rep1
                                (select (to_array src) (- (+ src_first j) 
                                index))))
  (= (to_rep1 (select dest1 j)) (to_rep1 (select temp___loop_entry_210 j))))))
  (and
  (= (and (ite (dynamic_property1 0 (- src_length 1) i1) true false) 
  (ite (and (<= 0 i1) (<= i1 (- src_length 1))) true false)) true)
  (= i1 temp___201))))))))))))))))))) (= dest1 dest)))))
  (=> (= (to_rep dest__last) o)
  (=> (= (to_rep dest__first) o1)
  (=> (= (and (ite (<= o1 usf) true false) (ite (<= usf o) true false)) true)
  (=>
  (= (and (ite (<= index usf) true false) (ite (<= usf (- (+ index src_length) 1))
                                          true false)) true)
  (let ((temp___212 (- (+ src_first usf) index)))
  (=> (and (<= (first1 src) temp___212) (<= temp___212 (last1 src)))
  (=>
  (exists ((o2 (_ BitVec 8)))
  (= (to_rep1 (select (to_array src) temp___212)) o2))
