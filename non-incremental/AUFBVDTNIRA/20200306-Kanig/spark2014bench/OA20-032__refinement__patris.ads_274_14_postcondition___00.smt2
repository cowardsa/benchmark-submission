...
(declare-fun user_eq11 (score_t score_t) Bool)

(declare-const dummy11 score_t)
...
(declare-fun rand (tuple0) Int)

(declare-fun rand__function_guard (Int tuple0) Bool)
...
(declare-fun user_eq12 (int__ int__) Bool)

(declare-const dummy12 int__)
...
;; rand__post_axiom
  ...
  (rand us_void_param) true false true
  true) :pattern ((rand us_void_param)) )))
...
(declare-fun user_eq14 (x_coord x_coord) Bool)

(declare-const dummy14 x_coord)
...
(define-fun dynamic_invariant7 ((temp___expr_586 Int)
  ...
  (temp___do_typ_inv_585 Bool)) Bool (=>
                                     ...
                                     (<= 1 10)) (in_range11 temp___expr_586)))
...
(define-fun in_range12 ((x Int)) Bool (and (<= 1 x) (<= x 20)))
...
(declare-fun user_eq15 (y_coord y_coord) Bool)

(declare-const dummy15 y_coord)
...
(define-fun dynamic_invariant8 ((temp___expr_593 Int)
  ...
  (temp___do_typ_inv_592 Bool)) Bool (=>
                                     ...
                                     (<= 1 20)) (in_range12 temp___expr_593)))
...
(define-fun dynamic_invariant9 ((temp___expr_631 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_638 Int)
...
(define-fun dynamic_invariant11 ((temp___expr_645 Int)
...
;; is_empty__def_axiom
  ...
  (forall ((y Int) (x Int))
  (! (= (= (is_empty b y x) true)
     (and (and (in_range11 x) (in_range12 y))
...
(declare-const rliteral px_coord)

;; rliteral_axiom
  (assert (= (px_coordqtint rliteral) 5))

(declare-const rliteral1 py_coord)

;; rliteral_axiom
  (assert (= (py_coordqtint rliteral1) 1))

(assert
;; defqtvc
 ;; File "patris.ads", line 271, characters 0-0
  (not
  (forall ((cur_board (Array Int (Array Int cell)))
  (cur_piece__split_fields us_split_fields)
  (next_piece__split_fields us_split_fields) (cur_state Int)
  (score_nbr (_ BitVec 32)) (level_nbr (_ BitVec 32))
  (line_counter (_ BitVec 32)) (best_score_nbr (_ BitVec 32))
  (action_request_nbr Int) (cur_board1 (Array Int (Array Int cell)))
  (cur_piece__split_fields1 us_split_fields) (cur_state1 Int))
  ...
  (=> (dynamic_invariant2 best_score_nbr true false true true)
  (=> (dynamic_invariant1 cur_state true false true true)
  (=> (dynamic_invariant action_request_nbr true false true true)
  (=>
  (= (valid_configuration cur_board cur_piece__split_fields cur_state) true)
  (=>
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (= cur_state 0) true false))
  ...
  (exists ((cur_state2 Int))
  (and (= cur_state2 1)
  (exists ((cur_board2 (Array Int (Array Int cell))) (cur_state3 Int))
  (and
  (and
  (and (= (get_state cur_state3) 2)
  (= (valid_configuration cur_board2 cur_piece__split_fields1 cur_state3) true))
  (dynamic_invariant1 cur_state3 true true true true))
  (exists ((score_nbr1 (_ BitVec 32)) (level_nbr1 (_ BitVec 32))
  (line_counter1 (_ BitVec 32)))
  (and
  (and (= (get_state cur_state1) 3)
  (= (valid_configuration cur_board1 cur_piece__split_fields1 cur_state1) true))
  (and
  (and
  (and (dynamic_invariant2 score_nbr1 true true true true)
  (dynamic_invariant2 level_nbr1 true true true true)) (dynamic_invariant2
  line_counter1 true true true true)) (dynamic_invariant1 cur_state1 true
  true true true))))))))
  (and (= cur_board1 cur_board) (= cur_state1 cur_state)))))))
  (and
  (exists ((spark__branch1 Bool))
  (and (= spark__branch1 (ite (= cur_state 3) true false))
  (ite (= spark__branch1 true)
  (exists ((spark__branch2 Bool) (next_piece__split_fields1 us_split_fields))
  (and
  (exists ((o Int))
  (and (= (to_rep1 (rec__patris__piece__s next_piece__split_fields)) o)
  (and (= spark__branch2 (ite (= o 0) true false))
  (ite (= spark__branch2 true)
  (let ((o1 (rand Tuple0)))
  (and (dynamic_invariant3 o1 true false true true)
  (exists ((o2 direction))
  (and (= (to_rep4 o2) (mod2 o1 4))
  (let ((o3 (rand Tuple0)))
  (and (dynamic_invariant3 o3 true false true true)
  (exists ((o4 shape))
  (and (= (to_rep1 o4) (+ 1 (mod2 o3 7)))
  (= next_piece__split_fields1 (us_split_fieldsqtmk o4 o2 rliteral rliteral1))))))))))
  (= next_piece__split_fields1 next_piece__split_fields)))))
  (let ((o (no_overlap cur_board (us_repqtmk next_piece__split_fields1))))
  (and
  (= (= o true)
  (ite (= (to_rep1 (rec__patris__piece__s next_piece__split_fields1)) 2)
  (and
  (and
  (and
  (= (is_empty cur_board
     (to_rep3 (rec__patris__piece__y next_piece__split_fields1))
     (to_rep2 (rec__patris__piece__x next_piece__split_fields1))) true)
  (= (is_empty cur_board
     (to_rep3 (rec__patris__piece__y next_piece__split_fields1))
     (+ (to_rep2 (rec__patris__piece__x next_piece__split_fields1)) 1)) true))
  (= (is_empty cur_board
     (+ (to_rep3 (rec__patris__piece__y next_piece__split_fields1)) 1)
     (to_rep2 (rec__patris__piece__x next_piece__split_fields1))) true))
  (= (is_empty cur_board
     (+ (to_rep3 (rec__patris__piece__y next_piece__split_fields1)) 1)
     (+ (to_rep2 (rec__patris__piece__x next_piece__split_fields1)) 1)) true))
  (ite (= (to_rep1 (rec__patris__piece__s next_piece__split_fields1)) 1)
  (forall ((y Int))
  (=> (and (<= 0 y) (<= y 3))
  (forall ((x Int))
  (=> (and (<= 0 x) (<= x 3))
  (=>
  (= (get
     (select possible_i_shapes (to_rep4
                               (rec__patris__piece__d
                               next_piece__split_fields1)))
     y x) true)
  (= (is_empty cur_board
     (+ (to_rep3 (rec__patris__piece__y next_piece__split_fields1)) y)
     (+ (to_rep2 (rec__patris__piece__x next_piece__split_fields1)) x)) true))))))
  (forall ((y Int))
  (=> (and (<= 0 y) (<= y 2))
  (forall ((x Int))
  (=> (and (<= 0 x) (<= x 2))
  (=>
  (= (get
     (get1 possible_three_shapes
     (to_rep1 (rec__patris__piece__s next_piece__split_fields1))
     (to_rep4 (rec__patris__piece__d next_piece__split_fields1))) y x) true)
  (= (is_empty cur_board
     (+ (to_rep3 (rec__patris__piece__y next_piece__split_fields1)) y)
     (+ (to_rep2 (rec__patris__piece__x next_piece__split_fields1)) x)) true)))))))))
  ...
  (= spark__branch4 (ite (bvugt score_nbr best_score_nbr) true false))))
  (= cur_piece__split_fields1 cur_piece__split_fields))
  (and (= cur_piece__split_fields1 next_piece__split_fields1)
  (let ((o1 (rand Tuple0)))
  (and (dynamic_invariant3 o1 true false true true)
  (exists ((o2 direction))
  (and (= (to_rep4 o2) (mod2 o1 4))
  ...
  (and (dynamic_invariant3 o3 true false true true)
  (exists ((o4 shape))
  (and (= (to_rep1 o4) (+ 1 (mod2 o3 7))) (= cur_state1 0)))))))))))))))))
  (and (= cur_piece__split_fields1 cur_piece__split_fields)
