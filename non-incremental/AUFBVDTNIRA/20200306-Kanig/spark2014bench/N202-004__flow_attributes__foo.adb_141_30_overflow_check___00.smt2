...
(((t52b__refqtmk (t52b__content us_t1)))))
(define-fun t52b__ref_t52b__content__projection ((a t52b__ref)) us_t1 
  (t52b__content a))

(declare-fun temp_____aggregate_def_338 ((_ BitVec 8) Int Int) us_t1)
...
(define-fun dynamic_invariant5 ((temp___expr_251 (_ BitVec 8))
  (temp___is_init_247 Bool) (temp___skip_constant_248 Bool)
  (temp___do_toplevel_249 Bool) (temp___do_typ_inv_250 Bool)) Bool true)

(define-fun dynamic_invariant6 ((temp___expr_258 us_t1)
...
;; def_axiom
  (assert
  (forall ((temp___340 (_ BitVec 8)))
  (forall ((temp___341 Int) (temp___342 Int))
  (let ((temp___339 (temp_____aggregate_def_338 temp___340 temp___341
                    temp___342)))
  (=> (dynamic_invariant5 temp___340 true true true true)
  (and
  (=> (dynamic_property1 0 2147483647 temp___341 temp___342)
  (and (= (first3 temp___339) temp___341) (= (last3 temp___339) temp___342)))
  (forall ((temp___343 Int))
  (= (to_rep2 (select (to_array1 temp___339) temp___343)) temp___340))))))))

(assert
;; defqtvc
 ;; File "foo.adb", line 127, characters 0-0
  (not
  (forall ((octet_count Int) (o Int) (o1 Int))
  (=> (dynamic_invariant1 text true false true true)
  (=> (dynamic_property1 0 2147483647 (to_rep1 data__first)
  (to_rep1 data__last))
  (=> (dynamic_invariant octet_count false false true true)
  (=> (= (to_rep1 data__last) o)
  (=> (= (to_rep1 data__first) o1)
  (let ((temp___344 (temp_____aggregate_def_338 #x00 o1 o)))
  (=> (= (first3 temp___344) (to_rep1 data__first))
  (=> (= (last3 temp___344) (to_rep1 data__last))
  (let ((temp___346 (of_array1 (to_array1 temp___344) (first3 temp___344)
                    (last3 temp___344))))
  (=>
  (ite (<= (first3 temp___346) (last3 temp___346))
  (and (<= (to_rep1 data__first) (to_rep1 data__last))
  (= (- (last3 temp___346) (first3 temp___346)) (- (to_rep1 data__last) 
  (to_rep1 data__first)))) (< (to_rep1 data__last) (to_rep1 data__first)))
  (forall ((o2 Int))
  (=> (= (to_rep1 data__first) o2)
  (forall ((data (Array Int octet)))
  ...
  (=>
  (exists ((o4 Int))
  (and (= (to_rep1 data__last) o4)
  (exists ((o5 Int))
  (and (= (to_rep1 data__first) o5)
  (let ((o6 (length o5 o4)))
  (and (in_range1 o6)
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (< o6 octet_count1) true false))
  (ite (= spark__branch true)
  (exists ((o7 Int))
  (and (= (to_rep1 data__last) o7)
  (exists ((o8 Int))
  (and (= (to_rep1 data__first) o8)
  (let ((o9 (length o8 o7))) (and (in_range2 o9) (= octet_count2 o9)))))))
  (= octet_count2 octet_count1))))))))))
  (=> (= octet_count2 r53b)
  (=> (dynamic_invariant r53b true false true true)
  (forall ((i Int))
  (=> (= i 1)
  (=> (= (and (ite (<= 1 i) true false) (ite (<= i r53b) true false)) true)
  (forall ((i1 Int))
  (=>
  (= (and (ite true true false) (ite (and (<= 1 i1) (<= i1 r53b)) true false)) true)
  (let ((o4 (+ (first1 text) i1)))
  (=> (in_range1 o4)
  (let ((o5 (- o4 1)))
  (=> (in_range1 o5)
  (=> (and (<= (first1 text) o5) (<= o5 (last1 text)))
  (forall ((o6 Int))
  (=> (= (to_rep (select (to_array text) o5)) o6)
  (forall ((o7 octet))
  (=> (= (to_rep2 o7) ((_ int_to_bv 8) o6))
  (forall ((o8 Int))
