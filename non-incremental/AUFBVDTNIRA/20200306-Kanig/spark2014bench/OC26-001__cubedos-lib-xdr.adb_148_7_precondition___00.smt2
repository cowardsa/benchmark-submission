...
(declare-fun xdr_unsigned_to_integer ((_ BitVec 32)) Int)

(declare-fun xdr_unsigned_to_integer__function_guard (Int
  (_ BitVec 32)) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_289 (_ BitVec 32))
  (temp___is_init_285 Bool) (temp___skip_constant_286 Bool)
  (temp___do_toplevel_287 Bool) (temp___do_typ_inv_288 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_296 Int)
  ...
  (temp___do_typ_inv_295 Bool)) Bool (=>
                                     ...
                                     (in_range3 temp___expr_296)))

;; xdr_unsigned_to_integer__post_axiom
  (assert
  (forall ((s (_ BitVec 32)))
  (! (=> (dynamic_invariant2 s true true true true)
     (let ((result (xdr_unsigned_to_integer s)))
     (=> (xdr_unsigned_to_integer__function_guard result s)
     (dynamic_invariant3 result true false true true)))) :pattern ((xdr_unsigned_to_integer
                                                                   s)) )))

(declare-const attr__ATTRIBUTE_ADDRESS4 Int)

(declare-sort xdr_integer 0)

(declare-fun xdr_integerqtint (xdr_integer) Int)

;; xdr_integer'axiom
  (assert
  (forall ((i xdr_integer))
  (and (<= (- 2147483648) (xdr_integerqtint i))
  (<= (xdr_integerqtint i) 2147483647))))
...
(declare-fun user_eq7 (xdr_integer xdr_integer) Bool)

(declare-const dummy7 xdr_integer)

(declare-datatypes ((xdr_integer__ref 0))
(((xdr_integer__refqtmk (xdr_integer__content xdr_integer)))))
(define-fun xdr_integer__ref_xdr_integer__content__projection ((a xdr_integer__ref)) xdr_integer 
  (xdr_integer__content a))
...
(assert
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 177, characters 0-0
  (not
  (forall ((value Int) (last2 Int) (temp (_ BitVec 32)))
