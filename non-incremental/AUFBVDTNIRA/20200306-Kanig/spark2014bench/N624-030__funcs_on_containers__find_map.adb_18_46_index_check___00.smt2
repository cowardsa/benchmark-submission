...
;; defqtvc
 ;; File "find_map.ads", line 26, characters 0-0
  ...
  (exists ((o3 Int))
  (and (= (to_rep (select (to_array a) usf)) o3)
  (let ((o4 (us_repqtmk result____split_discrs
            (us_split_fieldsqtmk result____split_fields2))))
  (let ((o5 (contains o4 o3)))
  (and (= (= o5 true) (= (has_key (model1 o4) o3) true))
  (ite (= o5 true)
  (and (and (<= (first1 a) usf) (<= usf (last1 a)))
  (exists ((o6 Int))
  (and (= (to_rep (select (to_array a) usf)) o6)
  (let ((o7 (us_repqtmk result____split_discrs
            (us_split_fieldsqtmk result____split_fields2))))
  (let ((temp___868 (element o7 o6)))
  (and
  (and (dynamic_invariant2 temp___868 true false true true)
  (= temp___868 (get (model1 o7) o6)))
  (= o2 (and (ite (<= (first1 a) temp___868) true false) (ite (<= temp___868 usf)
                                                         true false)))))))))
