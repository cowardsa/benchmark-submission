...
(((s18b__refqtmk (s18b__content us_t)))))
...
(((t22b__refqtmk (t22b__content tdigit_count_typeB)))))
(define-fun t22b__ref_t22b__content__projection ((a t22b__ref)) tdigit_count_typeB 
  (t22b__content a))

(declare-fun temp_____aggregate_def_1256 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1258 (_ BitVec 8)))
  (forall ((temp___1259 Int) (temp___1260 Int))
  (let ((temp___1257 (temp_____aggregate_def_1256 temp___1258 temp___1259
                     temp___1260)))
  (=> (dynamic_invariant1 temp___1258 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1259 temp___1260)
  (and (= (first1 temp___1257) temp___1259)
  (= (last1 temp___1257) temp___1260)))
  (forall ((temp___1261 Int))
  (= (to_rep2 (select (to_array temp___1257) temp___1261)) temp___1258))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_425 us_t)
  (temp___is_init_421 Bool) (temp___skip_constant_422 Bool)
  (temp___do_toplevel_423 Bool)
  (temp___do_typ_inv_424 Bool)) Bool (=>
                                     (not (= temp___skip_constant_422 true))
                                     (and (dynamic_property 1 r19b
                                     (first1 temp___expr_425)
                                     (last1 temp___expr_425))
                                     (and (= (first1 temp___expr_425) 1)
                                     (= (last1 temp___expr_425) r19b)))))

(define-fun default_initial_assumption ((temp___expr_427 us_t)
  (temp___skip_top_level_428 Bool)) Bool (and (= (first1 temp___expr_427) 1)
                                         (= (last1 temp___expr_427) r19b)))

(assert
;; defqtvc
 ;; File "very_longs.adb", line 82, characters 0-0
  (not
  (forall ((result____split_fields us_t) (borrow (_ BitVec 16))
  (l_digit (_ BitVec 16)) (r_digit (_ BitVec 16)) (difference1 (_ BitVec 16))
  (very_longs__modsubtract_and_borrow__R19b__assume Int))
  ...
  (=>
  (= (to_rep (rec__very_longs__very_long__length result____split_discrs)) very_longs__modsubtract_and_borrow__R19b__assume)
  (=> (= very_longs__modsubtract_and_borrow__R19b__assume r19b)
  (=> (dynamic_invariant2 r19b true false true true)
  (let ((temp___1262 (temp_____aggregate_def_1256 #x00 1 r19b)))
  (=> (= (first1 temp___1262) 1)
  (=> (= (last1 temp___1262) r19b)
  (=>
  (ite (<= (first1 temp___1262) (last1 temp___1262))
  (and (<= 1 r19b)
  (= (- (last1 temp___1262) (first1 temp___1262)) (- r19b 1))) (< r19b 1))
  (let ((temp___1264 (of_array (to_array temp___1262) (first1 temp___1262)
                     (last1 temp___1262))))
  (=>
  (ite (<= (first1 temp___1264) (last1 temp___1264))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1264) (first1 temp___1264)) (- (last1
  ...
  (=>
  (= result____split_fields1 (of_array (to_array temp___1264)
                             (first1 temp___1264) (last1 temp___1264)))
  (forall ((borrow1 (_ BitVec 16)))
  (=> (= borrow1 #x0000)
  (let ((temp___1270 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (forall ((i Int))
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1270) true false)) true)
  ...
  (= (and (ite (and
               ...
               true)
               (forall ((temp___1278 Int))
               (=>
               (and (<= (first1 result____split_fields2) temp___1278)
               (<= temp___1278 (last1 result____split_fields2)))
               (=>
               (or (< temp___1270 temp___1278)
               (or (< temp___1278 1) (<= i1 temp___1278)))
               (= (select (to_array result____split_fields2) temp___1278) (select 
               (to_array result____split_fields1) temp___1278))))))
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1271 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1271) i1) (<= i1 (last1 temp___1271)))
  (forall ((o (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1271) i1)) o)
  (forall ((l_digit2 (_ BitVec 16)))
  (=> (= l_digit2 ((_ zero_extend 8) o))
  (let ((temp___1272 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1272) i1) (<= i1 (last1 temp___1272)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1272) i1)) o1)
  ...
  (= spark__branch (ite (not (= (bvand difference3 #xFF00) #x0000)) true
                   false)))
  (=> (= (last1 result____split_fields2) r23b)
  (=> (in_range2 r23b)
  (=> (and (<= 1 i1) (<= i1 r23b))
  (let ((o2 (takelsb_from16 difference3)))
  (=>
  (and (takelsb_from16__function_guard o2 difference3) (dynamic_invariant1 o2
  ...
  (= result____split_fields3 (us_tqtmk
                             (store (to_array result____split_fields2) i1 o3)
