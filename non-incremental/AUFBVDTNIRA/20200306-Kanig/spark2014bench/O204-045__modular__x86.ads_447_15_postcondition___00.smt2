...
;; Nth_bv_is_nth2
  ...
  (=> (and (<= 0 i) (< i 256)) (= (nth_bv2 x ((_ int_to_bv 8) i)) (nth2 x i)))))
...
(define-fun dynamic_invariant2 ((temp___expr_232 (_ BitVec 16))
...
;; readmem16__post_axiom
  ...
  (! (=> (dynamic_invariant addr1 true true true true)
     ...
     (and
     (and
     (= result (bvadd ((_ zero_extend 8) (to_rep (select x86__memory addr1))) (bvmul ((_ zero_extend 8) 
     (to_rep (select x86__memory (bvadd addr1 #x0000000000000001)))) #x0100)))
     (bvuge result #x0000)) (dynamic_invariant2 result true false true true))))) :pattern (
...
;; defqtvc
 ;; File "x86.ads", line 445, characters 0-0
  ...
  (let ((o (bvadd addr #x0000000000000004)))
  (let ((o1 (readmem32 o memory)))
  (=>
  (forall ((memory1 (Array (_ BitVec 64) unsigned8)) (o2 (_ BitVec 64)))
  (readmem16__function_guard (readmem16 o2 memory1) o2 memory1))
  (=>
  (forall ((memory1 (Array (_ BitVec 64) unsigned8)) (o2 (_ BitVec 64)))
  (readmem16__function_guard
  (readmem16 (bvadd o2 #x0000000000000002) memory1)
  (bvadd o2 #x0000000000000002) memory1))
  (=>
  (and (readmem32__function_guard o1 o memory)
  (and (dynamic_invariant1 o1 true false true true)
  (and
  (= o1 (bvadd ((_ zero_extend 16) (readmem16 o memory)) (bvmul ((_ zero_extend 16) 
  (readmem16 (bvadd o #x0000000000000002) memory)) #x00010000)))
  (bvuge o1 #x00000000))))
  (let ((o2 addr))
  (let ((o3 (readmem32 o2 memory)))
  (=>
  (forall ((memory1 (Array (_ BitVec 64) unsigned8)) (o4 (_ BitVec 64)))
  (readmem16__function_guard (readmem16 o4 memory1) o4 memory1))
  (=>
  (forall ((memory1 (Array (_ BitVec 64) unsigned8)) (o4 (_ BitVec 64)))
  (readmem16__function_guard
  (readmem16 (bvadd o4 #x0000000000000002) memory1)
  (bvadd o4 #x0000000000000002) memory1))
  (=>
  (and (readmem32__function_guard o3 o2 memory)
  (and (dynamic_invariant1 o3 true false true true)
  (and
  (= o3 (bvadd ((_ zero_extend 16) (readmem16 o2 memory)) (bvmul ((_ zero_extend 16) 
  (readmem16 (bvadd o2 #x0000000000000002) memory)) #x00010000)))
  (bvuge o3 #x00000000))))
  (forall ((x86__readmem64__result (_ BitVec 64)))
  (=>
  (= x86__readmem64__result (bvadd ((_ zero_extend 32) o3) (bvmul ((_ zero_extend 32) o1) #x0000000100000000)))
  (=>
  ...
  (= x86__readmem64__result (bvadd ((_ zero_extend 32) (readmem32 addr
                                                       memory)) (bvmul ((_ zero_extend 32) 
  (readmem32 (bvadd addr #x0000000000000004) memory)) #x0000000100000000)))))))))))))))))))))
(check-sat)
(exit)
