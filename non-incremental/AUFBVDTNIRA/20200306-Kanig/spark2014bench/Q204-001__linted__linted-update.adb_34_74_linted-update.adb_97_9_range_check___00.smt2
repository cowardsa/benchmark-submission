...
;; defqtvc
 ;; File "linted-update.ads", line 40, characters 0-0
  ...
  (let ((o c206b)) (and (uint_in_range1 o) (= y4 ((_ int_to_bv 32) o)))))
  (=> (= c207b1 y4)
  (=> (= c207b1 c210b)
  ...
  (forall ((spark__branch1 Bool) (y5 (_ BitVec 32)))
  (=>
  ...
  (let ((o c216b)) (and (uint_in_range1 o) (= y5 ((_ int_to_bv 32) o))))))
  ...
  (forall ((spark__branch2 Bool) (y6 (_ BitVec 32)))
  (=>
  ...
  (let ((o c226b)) (and (uint_in_range1 o) (= y6 ((_ int_to_bv 32) o))))))
  ...
  (forall ((spark__branch3 Bool) (y7 (_ BitVec 32)))
  (=>
  ...
  (let ((o c236b)) (and (uint_in_range1 o) (= y7 ((_ int_to_bv 32) o))))))
  (forall ((c237b1 (_ BitVec 32)))
  (=> (= c237b1 y7)
  (=> (= c237b1 c240b)
  (=> (dynamic_invariant1 c240b true false true true)
  (bvule ((_ zero_extend 24) #x00) (bvand (bvlshr c240b ((_ int_to_bv 32) 24)) #x000000FF)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
