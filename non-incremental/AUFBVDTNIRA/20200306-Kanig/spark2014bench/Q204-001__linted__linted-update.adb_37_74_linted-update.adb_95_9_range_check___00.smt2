...
;; defqtvc
 ;; File "linted-update.ads", line 40, characters 0-0
  ...
  (and (in_range1 o)
  (and (uint_in_range1 o) (= y2 (bvsub ((_ int_to_bv 32) o) #x80000000)))))
  (let ((o c206b)) (and (uint_in_range1 o) (= y2 ((_ int_to_bv 32) o)))))
  (=> (= c207b1 y2)
  (=> (= c207b1 c210b)
  ...
  (let ((o c216b)) (and (uint_in_range1 o) (= y3 ((_ int_to_bv 32) o))))))
  (forall ((c217b1 (_ BitVec 32)))
  (=> (= c217b1 y3)
  (=> (= c217b1 c220b)
  (=> (dynamic_invariant1 c220b true false true true)
  (bvule ((_ zero_extend 24) #x00) (bvand (bvlshr c220b ((_ int_to_bv 32) 16)) #x000000FF)))))))))))))))))))))))))))))
(check-sat)
(exit)
