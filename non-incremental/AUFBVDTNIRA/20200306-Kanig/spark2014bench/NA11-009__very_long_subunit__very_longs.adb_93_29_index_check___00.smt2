...
(declare-fun temp_____aggregate_def_1251 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1253 (_ BitVec 8)))
  (forall ((temp___1254 Int) (temp___1255 Int))
  (let ((temp___1252 (temp_____aggregate_def_1251 temp___1253 temp___1254
                     temp___1255)))
  (=> (dynamic_invariant1 temp___1253 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1254 temp___1255)
  (and (= (first1 temp___1252) temp___1254)
  (= (last1 temp___1252) temp___1255)))
  (forall ((temp___1256 Int))
  (= (to_rep2 (select (to_array temp___1252) temp___1256)) temp___1253))))))))
...
(assert
;; defqtvc
 ;; File "very_longs.adb", line 72, characters 0-0
  (not
  ...
  (let ((temp___1257 (temp_____aggregate_def_1251 #x00 1 r19b)))
  (=> (= (first1 temp___1257) 1)
  (=> (= (last1 temp___1257) r19b)
  (=>
  (ite (<= (first1 temp___1257) (last1 temp___1257))
  (and (<= 1 r19b)
  (= (- (last1 temp___1257) (first1 temp___1257)) (- r19b 1))) (< r19b 1))
  (let ((temp___1259 (of_array (to_array temp___1257) (first1 temp___1257)
                     (last1 temp___1257))))
  (=>
  (ite (<= (first1 temp___1259) (last1 temp___1259))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1259) (first1 temp___1259)) (- (last1
  ...
  (=>
  (= result____split_fields1 (of_array (to_array temp___1259)
                             (first1 temp___1259) (last1 temp___1259)))
  ...
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1265) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___1273)
               (<= temp___1273 (last1 result____split_fields2)))
               (=>
               (or (< temp___1265 temp___1273)
               (or (< temp___1273 1) (<= i1 temp___1273)))
               (= (select (to_array result____split_fields2) temp___1273) (select 
               (to_array result____split_fields1) temp___1273))))))
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1266 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1266) i1) (<= i1 (last1 temp___1266)))
  (forall ((o (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1266) i1)) o)
  (forall ((l_digit2 (_ BitVec 16)))
  (=> (= l_digit2 ((_ zero_extend 8) o))
  (let ((temp___1267 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1267) i1) (<= i1 (last1 temp___1267)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1267) i1)) o1)
