...
;; defqtvc
 ;; File "very_longs-divide.adb", line 109, characters 0-0
  ...
  (let ((temp___1349 (- o 1)))
  (=>
  (and (<= (first1 u__split_fields) temp___1349)
  (<= temp___1349 (last1 u__split_fields)))
  (forall ((o1 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields) temp___1349)) o1)
  (let ((o2 (+ j n)))
  (=> (in_range2 o2)
  ...
  (let ((o6 (+ j n)))
  (and (in_range2 o6)
  (let ((temp___1356 (- o6 2)))
  (and
  (and (<= (first1 u__split_fields) temp___1356)
  (<= temp___1356 (last1 u__split_fields)))
  (exists ((o7 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields) temp___1356)) o7)
  (let ((temp___1354 (- n 1)))
  (and
  (and (<= (first1 v__split_fields) temp___1354)
  (<= temp___1354 (last1 v__split_fields)))
  (exists ((o8 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array v__split_fields) temp___1354)) o8)
  (and
  ...
  (let ((o6 (+ j n)))
  (=> (in_range2 o6)
  (let ((temp___1360 (- o6 2)))
  (=>
  (and (<= (first1 u__split_fields) temp___1360)
  (<= temp___1360 (last1 u__split_fields)))
  (forall ((o7 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields) temp___1360)) o7)
