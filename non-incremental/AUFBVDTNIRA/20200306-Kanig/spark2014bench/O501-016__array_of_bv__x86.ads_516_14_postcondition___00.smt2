...
(assert
;; defqtvc
 ;; File "x86.ads", line 513, characters 0-0
  (not
  (forall ((o (_ BitVec 8)) (o1 (_ BitVec 8)) (o2 (_ BitVec 8))
  (o3 (_ BitVec 8)) (o4 (_ BitVec 8)) (o5 (_ BitVec 8)) (o6 (_ BitVec 8))
  (o7 (_ BitVec 8)) (x86__readmem64ghost__result (_ BitVec 64)))
  (=> (dynamic_invariant addr true false true true)
  (=> (= (to_rep (select mem (bvadd addr #x0000000000000007))) o)
  (=> (= (to_rep (select mem (bvadd addr #x0000000000000006))) o1)
  (=> (= (to_rep (select mem (bvadd addr #x0000000000000005))) o2)
  (=> (= (to_rep (select mem (bvadd addr #x0000000000000004))) o3)
  (=> (= (to_rep (select mem (bvadd addr #x0000000000000003))) o4)
  (=> (= (to_rep (select mem (bvadd addr #x0000000000000002))) o5)
