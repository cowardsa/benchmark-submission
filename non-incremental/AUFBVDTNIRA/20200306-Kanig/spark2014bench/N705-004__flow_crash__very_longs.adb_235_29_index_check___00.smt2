...
;; defqtvc
 ;; File "very_longs.ads", line 47, characters 0-0
  ...
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___1049) true false)) true)
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 result____split_fields2) temp___1060)
               (<= temp___1060 (last1 result____split_fields2)))
               (=>
               (or (< temp___1049 temp___1060)
               (or (< temp___1060 1) (<= i1 temp___1060)))
               (= (select (to_array result____split_fields2) temp___1060) (select 
  ...
  (let ((temp___1050 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (=> (and (<= (first1 temp___1050) i1) (<= i1 (last1 temp___1050)))
  (forall ((o2 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1050) i1)) o2)
  (forall ((l_digit2 (_ BitVec 16)))
  (=> (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1051 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (=> (and (<= (first1 temp___1051) i1) (<= i1 (last1 temp___1051)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array temp___1051) i1)) o3)
  (forall ((r_digit2 (_ BitVec 16)))
  (=> (= r_digit2 ((_ zero_extend 8) o3))
  (forall ((difference3 (_ BitVec 16)))
  (=> (= difference3 (bvsub (bvsub l_digit2 r_digit2) borrow2))
  (=>
  ...
  (forall ((o5 octet))
  (=> (= (to_rep2 o5) o4) (<= (first1 result____split_fields2) i1)))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
