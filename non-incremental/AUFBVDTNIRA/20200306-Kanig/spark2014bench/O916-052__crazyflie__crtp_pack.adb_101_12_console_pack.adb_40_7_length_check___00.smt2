...
(define-fun to_int2 ((x t_uint8)) Int (ubv_to_int (to_rep2 x)))
...
(define-fun to_int3 ((x crtp_channel)) Int (ubv_to_int (to_rep3 x)))
...
(define-fun to_int4 ((x crtp_reserved)) Int (ubv_to_int (to_rep4 x)))
...
;; defqtvc
 ;; File "console_pack.adb", line 40, characters 0-0
  ...
  (=> (= spark__branch (ite (<= (- o1 1) 30) true false))
  (=> (= spark__branch true)
  (forall
  ((console_pack__console_put_line__crtp_append_character_data__R6b__assume Int))
  (=>
  (= (to_rep
     (rec__crtp_pack__crtp_packet_handler__index handler__split_fields)) console_pack__console_put_line__crtp_append_character_data__R6b__assume)
  (=>
  (= console_pack__console_put_line__crtp_append_character_data__R6b__assume 
  r6b)
  (=> (dynamic_invariant1 r6b true false true true)
  (forall ((o2 Int))
  (=>
  (= (to_rep
     (rec__crtp_pack__crtp_packet_handler__index handler__split_fields)) o2)
  (let ((o3 (+ o2 1)))
  (=> (in_range1 o3)
  (=> (= (- o3 1) r7b)
