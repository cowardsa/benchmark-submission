...
;; defqtvc
 ;; File "aco-math-very_longs.adb", line 481, characters 0-0
  ...
  (let ((o4 (+ j n)))
  (=> (in_range2 o4)
  (let ((temp___1676 (- o4 1)))
  (=>
  (and (<= (first1 u__split_fields1) temp___1676)
  (<= temp___1676 (last1 u__split_fields1)))
  (forall ((o5 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields1) temp___1676)) o5)
  (forall ((o6 octet))
  (=> (= (to_rep2 o6) (bvadd o5 o3))
  (let ((o7 (+ j n)))
  (=> (in_range2 o7) (<= (first1 u__split_fields1) (- o7 1))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
