...
;; lsr_bv_is_lsr
  ...
  (= (bvlshr x n) (lsr3 x (ubv_to_int n)))))

;; asr_bv_is_asr
  (assert
  (forall ((x (_ BitVec 64)) (n (_ BitVec 64)))
  (= (bvashr x n) (asr3 x (ubv_to_int n)))))

;; lsl_bv_is_lsl
  (assert
  (forall ((x (_ BitVec 64)) (n (_ BitVec 64)))
  (= (bvshl x n) (lsl3 x (ubv_to_int n)))))

;; rotate_left_bv_is_rotate_left
  (assert
  (forall ((v (_ BitVec 64)) (n (_ BitVec 64)))
  (= (bvor (bvshl v (bvurem n (_ bv64 64))) (bvlshr v (bvsub (_ bv64 64) (bvurem n (_ bv64 64))))) 
  (rotate_left4 v (ubv_to_int n)))))

;; rotate_right_bv_is_rotate_right
  (assert
  (forall ((v (_ BitVec 64)) (n (_ BitVec 64)))
  (= (bvor (bvlshr v (bvurem n (_ bv64 64))) (bvshl v (bvsub (_ bv64 64) (bvurem n (_ bv64 64))))) 
  (rotate_right4 v (ubv_to_int n)))))
...
;; Nth_bv_is_nth
  (assert
  (forall ((x (_ BitVec 64)) (i (_ BitVec 64)))
  (= (nth3 x (ubv_to_int i)) (nth_bv3 x i))))
...
;; eq_sub_equiv
  ...
  (forall ((a (_ BitVec 64)) (b (_ BitVec 64)) (i (_ BitVec 64))
  (n (_ BitVec 64)))
  (= (eq_sub3 a b (ubv_to_int i) (ubv_to_int n)) (eq_sub_bv3 a b i n))))
...
(define-fun to_int5 ((x unsigned_8)) Int (ubv_to_int (to_rep x)))
...
(((map__refqtmk (map__content (Array (_ BitVec 64) unsigned_8))))))
...
(((map__refqtmk1 (map__content1 (Array Int unsigned_8))))))
...
;; defqtvc
 ;; File "x86.ads", line 107, characters 0-0
  (not
  (forall ((zeroflag Bool) (memory (Array (_ BitVec 64) unsigned_8))
  (xcx (Array Int unsigned_8)) (val1 (_ BitVec 8)) (val2 (_ BitVec 8))
  (zeroflag1 Bool) (xcx1 (Array Int unsigned_8)))
  ...
  (to_rep (select xcx 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                   (select xcx 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xcx 3))) #x01000000)))))
  (ite (not (= o #x00000000))
  (exists ((xcx2 (Array Int unsigned_8)) (xsi (Array Int unsigned_8))
  (xdi (Array Int unsigned_8)) (val11 (_ BitVec 8)) (val21 (_ BitVec 8)))
  (and
  ...
  (let ((o1 (esi xsi)))
  (and
  (and (esi__function_guard o1 xsi)
  (and (dynamic_invariant o1 true false true true)
  (= o1 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                   (select xsi 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi 3))) #x01000000)))))
  ...
  (and (= o3 (to_rep (select memory o2))) (bvuge o3 #x00))))
  (exists ((val12 (_ BitVec 8)))
  (and (= val12 o3)
  (let ((o4 (edi xdi)))
  (and
  (and (edi__function_guard o4 xdi)
  (and (dynamic_invariant o4 true false true true)
  (= o4 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                   (select xdi 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi 3))) #x01000000)))))
  ...
  (and (= o6 (to_rep (select memory o5))) (bvuge o6 #x00))))
  (exists ((val22 (_ BitVec 8)))
  (and (= val22 o6)
  (and (= zeroflag1 (ite (= (bvsub val12 val22) #x00) true false))
  (let ((o7 (ecx xcx2)))
  (and
  (and (ecx__function_guard o7 xcx2)
  (and (dynamic_invariant o7 true false true true)
  (= o7 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx2 0))) (bvmul ((_ zero_extend 24) 
  ...
  (to_rep (select xcx1 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select xcx1 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xcx1 3))) #x01000000)) (bvsub o7 #x00000001))
  (forall ((i Int))
  (=> (and (<= 4 i) (<= i 7))
  (= (to_rep (select xcx1 i)) (to_rep (select xcx3 i))))))
  (let ((o8 (ecx xcx1)))
  (and
  (and (ecx__function_guard o8 xcx1)
  (and (dynamic_invariant o8 true false true true)
  (= o8 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx1 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xcx1 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select xcx1 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xcx1 3))) #x01000000)))))
  (or
  (= (or (ite (= o8 #x00000000) true false) (ite (= zeroflag1 true) false
                                            true)) true)
  (let ((o9 (esi xsi)))
  (and
  (and (esi__function_guard o9 xsi)
  (and (dynamic_invariant o9 true false true true)
  (= o9 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                   (select xsi 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi 3))) #x01000000)))))
  (exists ((xsi1 (Array Int unsigned_8)))
  (and (= xsi1 xsi)
  (exists ((xsi2 (Array Int unsigned_8)))
  (and
  (and
  (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi2 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi2 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select xsi2 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xsi2 3))) #x01000000)) (bvadd o9 #x00000001))
  (forall ((i Int))
  (=> (and (<= 4 i) (<= i 7))
  (= (to_rep (select xsi2 i)) (to_rep (select xsi1 i))))))
  (let ((o10 (edi xdi)))
  (and
  (and (edi__function_guard o10 xdi)
  (and (dynamic_invariant o10 true false true true)
  (= o10 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                   (select xdi 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi 3))) #x01000000)))))
  (exists ((xdi1 (Array Int unsigned_8)))
  (and (= xdi1 xdi)
  (exists ((xdi2 (Array Int unsigned_8)))
  (and
  (and
  (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi2 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi2 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select xdi2 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xdi2 3))) #x01000000)) (bvadd o10 #x00000001))
  (forall ((i Int))
  (=> (and (<= 4 i) (<= i 7))
  (= (to_rep (select xdi2 i)) (to_rep (select xdi1 i))))))
  (let ((o11 (ecx xcx1)))
  (and
  (and (ecx__function_guard o11 xcx1)
  (and (dynamic_invariant o11 true false true true)
  (= o11 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx1 0))) (bvmul ((_ zero_extend 24) 
  (to_rep (select xcx1 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select xcx1 2))) #x00010000)) (bvmul ((_ zero_extend 24) 
  (to_rep (select xcx1 3))) #x01000000))))) (= o11 #x00000000)))))))))))))))))))))))))))))))))))))))))
  (and (= zeroflag1 zeroflag) (= xcx1 xcx)))))
  (=>
  (forall ((xcx2 (Array Int unsigned_8))) (ecx__function_guard (ecx xcx2)
  xcx2))
  (=> (or (= (ecx xcx1) #x00000000) (not (= zeroflag1 true)))
  (or
  (=>
  (forall ((xcx2 (Array Int unsigned_8))) (ecx__function_guard (ecx xcx2)
