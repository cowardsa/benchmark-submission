...
;; defqtvc
 ;; File "very_longs-divide.adb", line 145, characters 0-0
  (not
  (forall ((n Int) (u__split_fields us_t) (v__split_fields us_t)
  ...
  (and
  (and (<= (first1 u__split_fields1) temp___1377)
  (<= temp___1377 (last1 u__split_fields1)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array u__split_fields1) temp___1377)) o3)
  (and
  ...
  (=>
  (and (<= (first1 u__split_fields1) temp___1379)
  (<= temp___1379 (last1 u__split_fields1)))
  (forall ((o3 (_ BitVec 8)))
  (=> (= (to_rep2 (select (to_array u__split_fields1) temp___1379)) o3)
  (forall ((o4 octet))
  (=>
