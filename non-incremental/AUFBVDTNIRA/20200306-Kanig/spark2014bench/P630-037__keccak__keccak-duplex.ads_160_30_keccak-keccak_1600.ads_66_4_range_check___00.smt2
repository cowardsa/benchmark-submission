...
;; defqtvc
 ;; File "keccak-duplex.ads", line 155, characters 0-0
  ...
  (let ((o1 (max_input_length o)))
  (=> (forall ((o2 us_rep)) (rate_of__function_guard (rate_of o2) o2))
  (=>
  (and (max_input_length__function_guard o1 o)
  (and (dynamic_invariant3 o1 true false true true) (= o1 (- (rate_of o) 2))))
  (=> (<= in_data_bit_length o1)
  (=> (in_range (+ in_data_bit_length 7)) (in_range (length in_data)))))))))))))
(check-sat)
(exit)
