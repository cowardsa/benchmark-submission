...
(define-fun us_split_fields_rec__very_longs__very_long__long_digits__27__projection ((a us_split_fields2)) us_t 
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((us_split_fields__refqtmk1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___split_fields__content__27__projection ((a us_split_fields__ref1)) us_split_fields2 
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((us_repqtmk1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep___split_discrs__27__projection ((a us_rep1)) us_split_discrs 
  (us_split_discrs2 a))

(define-fun us_rep___split_fields__27__projection ((a us_rep1)) us_split_fields2 
  (us_split_fields3 a))

(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___220 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array temp___220)
                                         (first1 temp___220)
                                         (last1 temp___220))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r1)
                                          (us_split_fieldsqtmk1
                                          (let ((temp___219 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
...
(define-fun dynamic_invariant4 ((temp___expr_728 us_rep1)
  (temp___is_init_724 Bool) (temp___skip_constant_725 Bool)
  (temp___do_toplevel_726 Bool)
  (temp___do_typ_inv_727 Bool)) Bool (and
                                     (=>
                                     ...
                                     (first1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_728)))
                                     (last1
                                     (rec__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_728))))
                                     (and
                                     (= (first1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_728))) 1)
                                     (= (last1
                                        (rec__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_728))) (+ 
                                     (to_rep
...
(((t102b__refqtmk (t102b__content us_t)))))
(define-fun t102b__ref_t102b__content__projection ((a t102b__ref)) us_t 
  (t102b__content a))

(declare-fun temp_____aggregate_def_1112 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1114 (_ BitVec 8)))
  (forall ((temp___1115 Int) (temp___1116 Int))
  (let ((temp___1113 (temp_____aggregate_def_1112 temp___1114 temp___1115
                     temp___1116)))
  (=> (dynamic_invariant3 temp___1114 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1115 temp___1116)
  (and (= (first1 temp___1113) temp___1115)
  (= (last1 temp___1113) temp___1116)))
  (forall ((temp___1117 Int))
  (= (to_rep2 (select (to_array temp___1113) temp___1117)) temp___1114))))))))
...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 61, characters 0-0
  (not
  ...
  (=>
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))) o)
  (=>
  ...
  (forall ((o2 Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))) o2)
  (forall ((o3 Int))
  (=>
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) o3)
  (let ((temp___1118 (temp_____aggregate_def_1112 #x00 1 (+ o3 o2))))
  (=> (= (first1 temp___1118) 1)
  (=>
  (= (last1 temp___1118) (+ (to_rep
                            (rec__very_longs__very_long__length
                            (us_split_discrs1 l))) (to_rep
                                                   (rec__very_longs__very_long__length
                                                   (us_split_discrs1 r)))))
  (=>
  (ite (<= (first1 temp___1118) (last1 temp___1118))
  (and
  ...
  (= (- (last1 temp___1118) (first1 temp___1118)) (- (+ (to_rep
                                                        (rec__very_longs__very_long__length
                                                        (us_split_discrs1 l))) 
  (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1)))
  (< (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 
  (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1))
  (let ((temp___1120 (of_array (to_array temp___1118) (first1 temp___1118)
                     (last1 temp___1118))))
  (=>
  (ite (<= (first1 temp___1120) (last1 temp___1120))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1120) (first1 temp___1120)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1120)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1125 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r)))))
  (exists ((j Int))
  (and (= j 1)
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1125) true false)) true)
  ...
  (= (and (ite (and
               ...
               (and
               (and
               (and (dynamic_invariant2 temp1 false true true true)
               (dynamic_invariant4
               (us_repqtmk1 result____split_discrs
  ...
  (and
  (let ((temp___1127 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1127) true false)) true)
  ...
  (= (and (ite (and
               ...
               (and
               (and
               (and (dynamic_invariant2 temp2 false true true true)
               (dynamic_invariant4
               (us_repqtmk1 result____split_discrs
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1128 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1128) i1) (<= i1 (last1 temp___1128)))
  (exists ((o4 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1128) i1)) o4)
  (exists ((l_digit3 (_ BitVec 16)))
  (and (= l_digit3 ((_ zero_extend 8) o4))
  (let ((temp___1129 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1129) j1) (<= j1 (last1 temp___1129)))
  (exists ((o5 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1129) j1)) o5)
  (exists ((r_digit3 (_ BitVec 16)))
  (and (= r_digit3 ((_ zero_extend 8) o5))
  (let ((o6 (+ i1 j1)))
  (and (in_range2 o6)
  (let ((temp___1131 (- o6 1)))
  (and
  (and (<= (first1 result____split_fields5) temp___1131)
  (<= temp___1131 (last1 result____split_fields5)))
  (exists ((o7 (_ BitVec 8)))
  (and
  (= (to_rep2 (select (to_array result____split_fields5) temp___1131)) o7)
  ...
  (let ((o10 (+ i1 j1)))
  (and (in_range2 o10)
  (let ((temp___1133 (- o10 1)))
  (and
  (and (<= (first1 result____split_fields5) temp___1133)
  (<= temp___1133 (last1 result____split_fields5)))
  (and
  (= result____split_fields4 (us_tqtmk
                             (store (to_array result____split_fields5) temp___1133 o9)
  ...
  (= o11 (bvudiv temp3 (ite (< 8 65536) (bvshl #x0001 ((_ int_to_bv 16) 8))
                       #x0000)))))
  (and (= carry3 o11) (= i1 temp___1127)))))))))))))))))))))))))))))))))))))
  (and (= result____split_fields4 result____split_fields3) (= carry3 carry2))))))
  (let ((o4 (takelsb_from16 carry3)))
  (and
  (and (takelsb_from16__function_guard o4 carry3) (dynamic_invariant3 o4 true
  false true true))
  (exists ((o5 octet))
  (and (= (to_rep2 o5) o4)
  (exists ((o6 Int))
  (and
  (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) o6)
  (let ((o7 (+ o6 j1)))
  (and (in_range2 o7)
  (and
  (and (<= (first1 result____split_fields4) o7)
  (<= o7 (last1 result____split_fields4)))
  (and
  (= result____split_fields2 (us_tqtmk
                             (store (to_array result____split_fields4) o7 o5)
                             (rt result____split_fields4)))
  (= j1 temp___1125)))))))))))))))))
  (= result____split_fields2 result____split_fields1)))))
  (forall ((very_longs__Omultiply__result us_rep))
  (=>
  (= very_longs__Omultiply__result (to_base
                                   (us_repqtmk1 result____split_discrs
                                   (us_split_fieldsqtmk1
                                   result____split_fields2))))
  (= (to_rep
     (rec__very_longs__very_long__length
     (us_split_discrs1 very_longs__Omultiply__result))) (+ (to_rep
                                                           (rec__very_longs__very_long__length
                                                           (us_split_discrs1
                                                           l))) (to_rep
                                                                (rec__very_longs__very_long__length
