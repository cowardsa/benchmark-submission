...
;; defqtvc
 ;; File "hermes-der-encode.ads", line 23, characters 0-0
  ...
  (=> (= result__2 (store result__1 5 o2))
  (forall ((value2 Int))
  (=> (= value2 (div1 value1 256))
  (let ((o3 (mod1 value2 256)))
  (=> (uint_in_range o3)
  (forall ((o4 octet))
  (=> (= (to_rep1 o4) ((_ int_to_bv 8) o3))
  (forall ((result__3 (Array Int octet)))
  (=> (= result__3 (store result__2 4 o4))
  (forall ((value3 Int))
  (=> (= value3 (div1 value2 256))
  (let ((o5 (mod1 value3 256)))
  (=> (uint_in_range o5)
  (forall ((o6 octet))
  (=> (= (to_rep1 o6) ((_ int_to_bv 8) o5))
  (forall ((result__4 (Array Int octet)))
  (=> (= result__4 (store result__3 3 o6))
  (forall ((value4 Int))
  (=> (= value4 (div1 value3 256))
  (=> (uint_in_range value4)
  (forall ((o7 octet))
  (=> (= (to_rep1 o7) ((_ int_to_bv 8) value4))
  (forall ((result__5 (Array Int octet)))
  (=> (= result__5 (store result__4 2 o7)) (=> (<= 1 5) (<= 1 1))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
