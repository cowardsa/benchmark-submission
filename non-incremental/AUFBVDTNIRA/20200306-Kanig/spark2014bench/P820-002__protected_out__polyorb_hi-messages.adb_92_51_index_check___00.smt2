...
(declare-fun user_eq (tstream_element_offsetB tstream_element_offsetB) Bool)

(declare-const dummy tstream_element_offsetB)
...
(define-fun to_rep ((x tstream_element_offsetB)) Int (tstream_element_offsetBqtint
                                                     x))

(declare-fun of_rep (Int) tstream_element_offsetB)
...
;; range_axiom
  (assert
  (forall ((x tstream_element_offsetB)) (! (in_range
...
(declare-fun user_eq1 (stream_element_offset stream_element_offset) Bool)

(declare-const dummy1 stream_element_offset)
...
(declare-fun user_eq2 (stream_element stream_element) Bool)

(declare-const dummy2 stream_element)
...
(declare-fun to_rep1 (stream_element) (_ BitVec 8))

(declare-fun of_rep1 ((_ BitVec 8)) stream_element)
...
(define-fun to_int2 ((x stream_element)) Int (ubv_to_int (to_rep1 x)))
...
(declare-fun corresponding_entity ((_ BitVec 8)) Int)

(declare-fun corresponding_entity__function_guard (Int (_ BitVec 8)) Bool)
...
(declare-fun user_eq4 (target target) Bool)

(declare-const dummy4 target)
...
(define-fun dynamic_invariant ((temp___expr_416 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_423 (_ BitVec 8))
  (temp___is_init_419 Bool) (temp___skip_constant_420 Bool)
  (temp___do_toplevel_421 Bool) (temp___do_typ_inv_422 Bool)) Bool true)

;; corresponding_entity__post_axiom
  (assert
  (forall ((s (_ BitVec 8)))
  (! (=> (dynamic_invariant1 s true true true true)
     (let ((result (corresponding_entity s)))
     (=> (corresponding_entity__function_guard result s) (dynamic_invariant
     result true false true true)))) :pattern ((corresponding_entity s)) )))
