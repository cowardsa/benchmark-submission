...
(define-fun to_int2 ((x bits_8)) Int (ubv_to_int (to_rep1 x)))
...
(assert
;; defqtvc
 ;; File "decadriver.ads", line 178, characters 0-0
  (not
  (=> (dynamic_invariant1 data true false true true)
  (=> (dynamic_invariant offset true false true true)
  (=>
  (let ((temp___1045 (length data)))
  (and (<= 1 temp___1045) (<= temp___1045 1024)))
  (=> (< offset 1024)
