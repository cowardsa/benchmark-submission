...
;; defqtvc
 ;; File "keccak-sponge.adb", line 273, characters 0-0
  ...
  (=> (= (- o12 1) r111s)
  (=> (dynamic_invariant r111s true false true true)
  ...
  (let ((temp___1139 (of_array next_block1 0 r111s)))
  (<= (length
      (of_array (to_array temp___1139) (first1 temp___1139)
      (last1 temp___1139))) 268435455)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
