...
;; defqtvc
 ;; File "cubedos-lib-xdr.ads", line 137, characters 0-0
  (not
  (forall ((last2 Int) (o Bool) (o1 Int))
  ...
  (exists ((o4 Int))
  (and (= (to_rep data__last) o4)
  (exists ((o5 Int))
  (and (= (to_rep data__first) o5)
  (= o3 (ite (< 0 (length o5 o4)) true false)))))) (= o3 false))
  (ite (= o3 true)
  (exists ((o4 Int))
  (and (= (to_rep data__last) o4)
  (exists ((o5 Int))
  (and (= (to_rep data__first) o5)
  (= o2 (ite (= (mod1 (length o5 o4) 4) 0) true false)))))) (= o2 false))))
  (ite (= o2 true)
  (exists ((o3 Int))
  (and (= (to_rep data__last) o3)
  (exists ((o4 Int))
  (and (= (to_rep data__first) o4)
  (= o (and (ite (<= o4 position) true false) (ite (<= position o3) true
                                              false)))))))
  (= o false))))
  (=> (= o true)
  (=> (= (to_rep data__last) o1)
  (let ((o2 (- o1 position)))
  (=> (in_range1 o2) (=> (in_range1 (+ o2 1)) (in_range2 (length1 value)))))))))))))))
(check-sat)
(exit)
