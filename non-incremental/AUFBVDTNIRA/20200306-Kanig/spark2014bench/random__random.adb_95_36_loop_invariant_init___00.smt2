...
(define-fun to_int2 ((x unsigned_32)) Int (ubv_to_int (to_rep1 x)))
...
;; defqtvc
 ;; File "random.ads", line 43, characters 0-0
  (not
  (forall ((spark__branch Bool) (i Int) (j Int))
  ...
  (forall ((spark__branch1 Bool) (i1 Int) (g__split_fields1 us_split_fields))
  (=>
  (let ((temp___244 (max 624 (length initiator))))
  (exists ((k Int))
  (and (= k 1)
  (ite (= (and (ite (<= 1 k) true false) (ite (<= k temp___244) true false)) true)
  (let ((o (to_state1 j)))
  (and
  ...
  (exists ((spark__branch2 Bool) (i2 Int) (g__split_fields3 us_split_fields))
  (and
  (and (= spark__branch2 (ite (= i 623) true false))
  (ite (= spark__branch2 true)
  (exists ((o6 (_ BitVec 32)))
  (and
  (= (to_rep1 (select (rec__random__generator__state g__split_fields2) 623)) o6)
  (exists ((o7 unsigned_32))
  (and (= (to_rep1 o7) o6)
  (and
  (= g__split_fields3 (us_split_fieldsqtmk
                      (store (rec__random__generator__state g__split_fields2) 0 o7)
                      (rec__random__generator__index g__split_fields2)))
  (= i2 1))))))
  (and (let ((o6 (+ i 1))) (and (in_range4 o6) (= i2 o6)))
  (= g__split_fields3 g__split_fields2))))
  (exists ((o6 Int))
  (and
  (ite (= j (last1 initiator)) (= o6 0)
  (let ((o7 (+ j 1))) (and (= o6 o7) (in_range1 o7))))
  (exists ((j1 Int))
  (and (= j1 o6)
  (exists ((j2 Int) (k1 Int))
  (and
  (and (< 0 i1) (and (<= (first1 initiator) j2) (<= j2 (last1 initiator))))
  (and
  (= (and (ite (and
               (and
               (and (dynamic_invariant j2 true true true true)
               (= (rec__random__generator__index g__split_fields1) (rec__random__generator__index
                                                                   g__split_fields)))
               (dynamic_property1 1 (max 624 (length initiator)) k1))
               (dynamic_invariant2 i1 true true true true))
          true false) (ite (and (<= 1 k1)
                           (<= k1 (max 624 (length initiator))))
                      true false)) true)
  (= k1 temp___244)))))))))))))))))))))))))))))
  (and (and (= spark__branch1 spark__branch) (= i1 i))
  (= g__split_fields1 g__split_fields))))))
  (forall ((k Int))
  (=> (= k 1)
  (=> (= (and (ite (<= 1 k) true false) (ite (<= k 623) true false)) true)
  (let ((o (to_state i1)))
  (=>
  ...
  (let ((temp___267 (- i1 1)))
  (=> (and (<= 0 temp___267) (<= temp___267 623))
  (forall ((o2 (_ BitVec 32)))
  (=>
  (= (to_rep1
     (select (rec__random__generator__state g__split_fields1) temp___267)) o2)
  (forall ((o3 (_ BitVec 32)))
  (=>
  (= (to_rep1 (select (rec__random__generator__state g__split_fields1) i1)) o3)
  (forall ((o4 unsigned_32))
  (=>
  (= (to_rep1 o4) (bvsub (bvxor o3 (bvmul (bvxor o2 (bvlshr o1 ((_ int_to_bv 32) 30))) #x5D588B65)) o))
  (forall ((g__split_fields2 us_split_fields))
  (=>
  (= g__split_fields2 (us_split_fieldsqtmk
                      (store (rec__random__generator__state g__split_fields1) i1 o4)
                      (rec__random__generator__index g__split_fields1)))
  (forall ((spark__branch2 Bool) (i2 Int) (g__split_fields3 us_split_fields))
  (=>
  (and (= spark__branch2 (ite (= i1 623) true false))
  (ite (= spark__branch2 true)
  (exists ((o5 (_ BitVec 32)))
  (and
  (= (to_rep1 (select (rec__random__generator__state g__split_fields2) 623)) o5)
  (exists ((o6 unsigned_32))
  (and (= (to_rep1 o6) o5)
  (and
  (= g__split_fields3 (us_split_fieldsqtmk
                      (store (rec__random__generator__state g__split_fields2) 0 o6)
                      (rec__random__generator__index g__split_fields2)))
  (= i2 1))))))
