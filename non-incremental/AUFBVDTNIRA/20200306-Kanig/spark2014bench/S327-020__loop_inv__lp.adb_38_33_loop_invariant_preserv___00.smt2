...
;; defqtvc
 ;; File "lp.ads", line 9, characters 0-0
  ...
  (let ((temp___287 (let ((temp___286 (to_rep
                    ...
                    (bvshl #x0000000000000001 ((_ int_to_bv 64) temp___286))
                    #x0000000000000000))))
  ...
  (= (and (ite (and (dynamic_invariant previous1 true true true true)
          ...
          true false) (ite (and (<= (first1 powers) c13b1)
                           (<= c13b1 (last1 powers)))
                      true false)) true)
  (=> (and (<= (first1 powers) c13b1) (<= c13b1 (last1 powers)))
  (forall ((temp___280 Int))
  (=> (= (to_rep (select (to_array powers) c13b1)) temp___280)
  (let ((o (power 2 temp___280)))
  (=> (in_range2 o)
  (=> (uint_in_range o)
  (=> (not (bvugt ((_ int_to_bv 64) i) ((_ int_to_bv 64) o)))
  (=> (and (<= (first1 powers) c13b1) (<= c13b1 (last1 powers)))
  (forall ((o1 Int))
  (=> (= (to_rep (select (to_array powers) c13b1)) o1)
  (forall ((previous2 Int))
  (=> (= previous2 o1)
  (=> (not (= c13b1 temp___278))
  (forall ((c13b2 Int))
  (=> (= c13b2 (+ c13b1 1))
  (=>
  (forall ((temp___293 Int))
