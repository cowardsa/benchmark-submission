...
(((t61b__refqtmk (t61b__content tdigit_count_typeB)))))
(define-fun t61b__ref_t61b__content__projection ((a t61b__ref)) tdigit_count_typeB 
  (t61b__content a))
...
;; defqtvc
 ;; File "very_longs.ads", line 40, characters 0-0
  ...
  (very_longs__number_of_digits__result Int) (usf Int))
  ...
  (let ((temp___970 (last1
                    (rec__very_longs__very_long__long_digits
                    (us_split_fields1 number)))))
  (exists ((index Int))
  (and (= index 1)
  (ite (= (and (ite (<= 1 index) true false) (ite (<= index temp___970) true
                                             false)) true)
  (exists ((spark__branch1 Bool) (digit_count2 Int))
  (and
  (let ((temp___971 (rec__very_longs__very_long__long_digits
                    (us_split_fields1 number))))
  (and (and (<= (first1 temp___971) index) (<= index (last1 temp___971)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___971) index)) o2)
  (and (= spark__branch1 (ite (not (= o2 #x00)) true false))
  (ite (= spark__branch1 true) (and (in_range4 index) (= digit_count2 index))
  (= digit_count2 digit_count)))))))
  (exists ((index1 Int))
  (and
  (=> (< digit_count1 index1)
  (forall ((j Int))
  (=> (and (<= (+ digit_count1 1) j) (<= j index1))
  (= (to_rep2
     (select (to_array
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) j)) #x00))))
  (and
  (= (and (ite (and (dynamic_invariant1 digit_count1 true true true true)
               (dynamic_property1 1
               (last1
               (rec__very_longs__very_long__long_digits
               (us_split_fields1 number))) index1))
          true false) (ite (and (<= 1 index1)
                           (<= index1 (last1
                                      (rec__very_longs__very_long__long_digits
                                      (us_split_fields1 number)))))
                      true false)) true)
  (= index1 temp___970)))))) (= digit_count1 digit_count)))))
  (= digit_count1 digit_count)))))))
  (=> (= very_longs__number_of_digits__result digit_count1)
  (=>
  (= (and (ite (<= (+ very_longs__number_of_digits__result 1) usf) true
          false) (ite (<= usf (last1
                              (rec__very_longs__very_long__long_digits
                              (us_split_fields1 number))))
                 true false)) true)
