...
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 86, characters 0-0
  ...
  (ada___ada___aco__math__very_longs__modadd_and_carry__result__fields us_t))
  (=>
  (and
  (= (to_rep
  ...
  (let ((o2 (ite (= carry1 #x0001) true
            ...
            (to_base
            (us_repqtmk1 result____split_discrs
            (us_split_fieldsqtmk1 result____split_fields1))) p))))
  (and
  (or (= carry1 #x0001) (oge__function_guard o2
  (to_base
  (us_repqtmk1 result____split_discrs
  (us_split_fieldsqtmk1 result____split_fields1))) p))
  ...
  (let ((temp___1421 (of_base temp___1420)))
  (and
  (= (us_split_fieldsqtmk1 result____split_fields2) (us_split_fields3
                                                    temp___1421))
  (= result____split_discrs (us_split_discrs2 temp___1421))))))))))
  (= result____split_fields2 result____split_fields1))))))
  (forall ((ada___ada___aco__math__very_longs__add_fp__result us_rep))
  (=>
  (= ada___ada___aco__math__very_longs__add_fp__result (to_base
                                                       (us_repqtmk1
  ...
  (= (to_rep
     (rec__ada___ada___aco__math__very_longs__very_long__octet_length
     (us_split_discrs1 ada___ada___aco__math__very_longs__add_fp__result))) 
  (to_rep
  (rec__ada___ada___aco__math__very_longs__very_long__octet_length
  (us_split_discrs1 l))))))))))))))))))))))))))))
(check-sat)
