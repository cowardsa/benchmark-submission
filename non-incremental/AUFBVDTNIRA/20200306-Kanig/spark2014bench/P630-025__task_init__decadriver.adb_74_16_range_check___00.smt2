...
(define-fun to_int3 ((x rx_frame_queue_index)) Int (ubv_to_int (to_rep5 x)))
...
;; defqtvc
 ;; File "decadriver.ads", line 80, characters 0-0
  (not
  (forall ((size Int) (error Int) (self__ us_split_fields2) (o (_ BitVec 8))
  (o1 Int) (size1 Int) (o2 (_ BitVec 8)) (o3 Int) (error1 Int)
  (spark__branch Bool) (o4 Int) (o5 Int))
  ...
  (=> (= error1 o3)
  (=> (= spark__branch (ite (= error1 0) true false))
  (=> (= spark__branch true)
  (=> (= (to_rep1 frame__last) o4)
  (=> (= (to_rep1 frame__first) o5)
  (let ((o6 (length o5 o4)))
  (=> (in_range1 o6)
  (forall ((spark__branch1 Bool))
  (=> (= spark__branch1 (ite (<= size1 o6) true false))
  (=> (= spark__branch1 true)
  (forall ((o7 Int))
  (=> (= (to_rep1 frame__first) o7)
  (let ((o8 (+ o7 (- size1 1))))
  (=> (in_range1 o8)
  (=> (= o8 r6b)
  (=> (dynamic_invariant r6b true false true true)
  (=> (= size1 r9b)
  (=> (dynamic_invariant2 r9b true false true true)
  ...
  (forall ((o10 Int))
  (=> (= (to_rep1 frame__first) o10)
  (forall ((o11 Int))
  (=> (= (to_rep1 frame__first) o11)
  (forall ((temp___987 Int))
  (=> (= (to_rep1 frame__first) temp___987)
  (=> (<= temp___987 r6b) (<= (to_rep1 frame__first) temp___987)))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
