...
(declare-const octet_length Int)
...
(define-fun us_split_fields_rec__ada___ada___aco__math__very_longs__very_long__long_digits__6__projection ((a us_split_fields2)) us_t 
...
(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___179 (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
...
(define-fun of_base ((r us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r)
                                         (us_split_fieldsqtmk1
                                         (let ((temp___178 (rec__ada___ada___aco__math__very_longs__very_long__long_digits
                                                           (us_split_fields1
                                                           r))))
...
(define-fun dynamic_invariant1 ((temp___expr_519 us_rep1)
  (temp___is_init_515 Bool) (temp___skip_constant_516 Bool)
  (temp___do_toplevel_517 Bool)
  (temp___do_typ_inv_518 Bool)) Bool (and
                                     (=>
                                     (not (= temp___skip_constant_516 true))
                                     (in_range4 octet_length
                                     (us_split_discrs1
                                     (to_base temp___expr_519))))
                                     (and (dynamic_property 1 octet_length
                                     (first1
                                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_519)))
                                     (last1
                                     (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                     (us_split_fields3 temp___expr_519))))
                                     (and
                                     (= (first1
                                        (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_519))) 1)
                                     (= (last1
                                        (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                        (us_split_fields3 temp___expr_519))) 
                                     octet_length)))))

(define-fun default_initial_assumption ((temp___expr_522 us_rep1)
  (temp___skip_top_level_523 Bool)) Bool (and
                                         (= (to_rep
                                            (rec__ada___ada___aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_522))) octet_length)
                                         (and
                                         (= (first1
                                            (rec__ada___ada___aco__math__very_longs__very_long__long_digits1
                                            (us_split_fields3
...
(declare-fun temp_____aggregate_def_1088 ((_ BitVec 8) Int Int) us_t)
...
;; def_axiom
  (assert
  (forall ((temp___1090 (_ BitVec 8)))
  (forall ((temp___1091 Int) (temp___1092 Int))
  (let ((temp___1089 (temp_____aggregate_def_1088 temp___1090 temp___1091
                     temp___1092)))
  (=> (dynamic_invariant3 temp___1090 true true true true)
  (and
  (=> (dynamic_property 1 2147483647 temp___1091 temp___1092)
  (and (= (first1 temp___1089) temp___1091)
  (= (last1 temp___1089) temp___1092)))
  (forall ((temp___1093 Int))
  (= (to_rep2 (select (to_array temp___1089) temp___1093)) temp___1090))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_277 us_rep)
...
;; defqtvc
 ;; File "aco-math-very_longs.ads", line 22, characters 0-0
  ...
  (=> (dynamic_invariant2 octet_length true false true true)
  (=> (in_range2 octet_length)
  ...
  (let ((temp___1094 (temp_____aggregate_def_1088 #x00 1 octet_length)))
  (=> (= (first1 temp___1094) 1)
  (=> (= (last1 temp___1094) octet_length)
  (=>
  (ite (<= (first1 temp___1094) (last1 temp___1094))
  (and (<= 1 octet_length)
  (= (- (last1 temp___1094) (first1 temp___1094)) (- octet_length 1)))
  (< octet_length 1))
  (let ((temp___1096 (of_array (to_array temp___1094) (first1 temp___1094)
                     (last1 temp___1094))))
  (=>
  (ite (<= (first1 temp___1096) (last1 temp___1096))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1096) (first1 temp___1096)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1096)
  (forall ((temp1 Int))
  (=> (= temp1 number)
  (=> (= (last1 result____split_fields1) r26b)
  (=> (in_range3 r26b)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1101 r26b))
  (exists ((index Int))
  (and (= index 1)
  (ite (= (and (ite (<= 1 index) true false) (ite (<= index temp___1101) true
                                             false)) true)
  ...
  (= (and (ite (and
               ...
               true true))
               (forall ((temp___1108 Int))
               (=>
               (and (<= (first1 result____split_fields3) temp___1108)
               (<= temp___1108 (last1 result____split_fields3)))
               (=>
               (or (< temp___1101 temp___1108)
               (or (< temp___1108 1) (<= index1 temp___1108)))
               (= (select (to_array result____split_fields3) temp___1108) (select 
               (to_array result____split_fields1) temp___1108))))))
          true false) (ite (and (<= 1 index1) (<= index1 r26b)) true false)) true)
  (let ((o (mod1 temp2 256)))
  (and (uint_in_range o)
  (exists ((o1 octet))
  (and (= (to_rep2 o1) ((_ int_to_bv 8) o))
  (and
  (and (<= (first1 result____split_fields3) index1)
  (<= index1 (last1 result____split_fields3)))
  (and
  (= result____split_fields2 (us_tqtmk
                             (store (to_array result____split_fields3) index1 o1)
                             (rt result____split_fields3)))
  (= index1 temp___1101)))))))))
  (= result____split_fields2 result____split_fields1)))))
  (forall
  ((ada___ada___aco__math__very_longs__make_from_natural__result us_rep))
  (=>
  (= ada___ada___aco__math__very_longs__make_from_natural__result (to_base
                                                                  (us_repqtmk1
