...
;; defqtvc
 ;; File "area_math.ads", line 46, characters 0-0
  ...
  (let ((temp___474 (rec__area_math__ensemble__from1 result____split_fields6)))
  (forall ((temp___475 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields6)) temp___475)
  (=>
  (and (<= (first1 temp___474) temp___475)
  (<= temp___475 (last1 temp___474)))
  (forall ((o9 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___474) temp___475)) o9)
  (=> (not (= o9 #x00000000))
  (=> (not (= i 0))
  (let ((temp___478 (rec__area_math__ensemble__to (us_split_fields1 e))))
  (=> (and (<= (first1 temp___478) i) (<= i (last1 temp___478)))
  (forall ((o10 (_ BitVec 32)))
  (=> (= (to_rep2 (select (to_array temp___478) i)) o10)
  (forall ((temp___477 Int))
  (=>
  (= (to_rep (rec__area_math__ensemble__size1 result____split_fields6)) temp___477)
  (<= (first1 (rec__area_math__ensemble__from1 result____split_fields6)) temp___477))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
