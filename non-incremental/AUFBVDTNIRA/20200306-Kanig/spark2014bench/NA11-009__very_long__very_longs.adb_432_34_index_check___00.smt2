...
;; defqtvc
 ;; File "very_longs.adb", line 420, characters 0-0
  ...
  (= (and (ite (and
               ...
               (=>
               (and (<= (first1 number__split_fields1) temp___1345)
               (<= temp___1345 (last1 number__split_fields1)))
               (=>
               (or (< temp___1331 temp___1345)
               (or (< temp___1345 1) (<= temp___1345 i1)))
               (= (select (to_array number__split_fields1) temp___1345) (select 
               (to_array number__split_fields) temp___1345))))))
