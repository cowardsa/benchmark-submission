...
;; defqtvc
 ;; File "polyorb_hi-messages.ads", line 97, characters 0-0
  (not
  (forall ((o us_t) (ada___polyorb_hi__messages__payload__result us_t))
  (=>
  (= (ada___polyorb_hi__messages__empty_pdu__aggregate_def #x00) empty_pdu)
  (=> (valid__function_guard (valid m) m)
  (=> (= (valid m) true)
  (=> (is_empty__function_guard (is_empty m) m)
  (=> (not (= (is_empty m) true))
  (=>
  (ite (= (bool_eq
          (rec__ada___polyorb_hi__messages__message_type__content
          (us_split_fields1 m)) 1 19 empty_pdu 1 19) true)
  (= o (of_array empty_pdu 1 19))
  (exists ((temp___524 Int))
  (and
  (= (to_rep1
     (rec__ada___polyorb_hi__messages__message_type__last
     (us_split_fields1 m))) temp___524)
  (exists ((temp___523 Int))
  (and
  (= (to_rep1
     (rec__ada___polyorb_hi__messages__message_type__first
     (us_split_fields1 m))) temp___523)
  (and
  (=> (<= temp___523 temp___524)
  (and (and (<= 1 temp___523) (<= temp___523 19))
  (and (<= 1 temp___524) (<= temp___524 19))))
  (let ((temp___526 (of_array
                    (rec__ada___polyorb_hi__messages__message_type__content
                    (us_split_fields1 m)) temp___523 temp___524)))
  (= o (of_array (to_array temp___526) (first1 temp___526)
       (last1 temp___526))))))))))
  (=> (= ada___polyorb_hi__messages__payload__result o)
  (let ((o1 m))
  (let ((o2 (length o1)))
  (=>
  ...
  (= o2 (ite (= (bool_eq
                (rec__ada___polyorb_hi__messages__message_type__content
                (us_split_fields1 o1)) 1 19 empty_pdu 1 19) true)
        0
        (+ (- (to_rep1
              (rec__ada___polyorb_hi__messages__message_type__last
              (us_split_fields1 o1))) (to_rep1
                                      (rec__ada___polyorb_hi__messages__message_type__first
