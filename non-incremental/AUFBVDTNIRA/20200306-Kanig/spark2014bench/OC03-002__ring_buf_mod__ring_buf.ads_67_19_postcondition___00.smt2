...
;; func_push__post_axiom
  ...
  (forall ((x Int))
  (! (=>
     (and (dynamic_invariant1 m true true true true) (dynamic_invariant x
     true true true true))
     (let ((result (func_push m x)))
     (=> (func_push__function_guard result m x) (dynamic_invariant1 result
     true false true true)))) :pattern ((func_push m x)) ))))
...
;; func_push__def_axiom
  ...
  (! (=>
     (and (dynamic_invariant1 m true true true true) (dynamic_invariant x
     true true true true))
     (= (func_push m x) (ite (= (length m) 0)
                        (of_array (singleton1 (of_rep x) #x0000) #x0000
                        #x0000)
                        (of_array
                        (concat_singleton_right (to_array m) (first1 m)
                        (last1 m) (of_rep x)) (first1 m)
                        ((_ int_to_bv 16) (- (+ (ubv_to_int (first1 m)) (+ (length1
                                                                    (ubv_to_int 
                                                                    (first1
                                                                    m))
                                                                    (ubv_to_int 
...
(assert
;; defqtvc
 ;; File "ring_buf.ads", line 65, characters 0-0
  (not
  ...
  (= r__split_fields2 (us_split_fieldsqtmk
                      (store (rec__ring_buf__ring_buffer__data
                             r__split_fields) (bvadd o2 ((_ int_to_bv 16) o1)) o)
                      (rec__ring_buf__ring_buffer__first r__split_fields)
                      (rec__ring_buf__ring_buffer__length r__split_fields)))
  (forall ((o3 Int))
  (=> (= (to_rep2 (rec__ring_buf__ring_buffer__length r__split_fields2)) o3)
  (let ((o4 (+ o3 1)))
  (=> (in_range1 o4)
  (forall ((o5 length_type))
  (=> (= (to_rep2 o5) o4)
  (forall ((r__split_fields3 us_split_fields))
  (=>
  (= r__split_fields3 (us_split_fieldsqtmk
                      (rec__ring_buf__ring_buffer__data r__split_fields2)
  ...
  (to_model (us_repqtmk r__split_fields4)) (us_repqtmk r__split_fields4)))
  (=>
  (forall ((r__split_fields4 us_split_fields)) (func_push__function_guard
  (func_push (to_model (us_repqtmk r__split_fields4)) x)
  (to_model (us_repqtmk r__split_fields4)) x))
  (=>
  (forall ((r__split_fields4 us_split_fields)) (to_model__function_guard
  (to_model (us_repqtmk r__split_fields4)) (us_repqtmk r__split_fields4)))
  (= (let ((temp___366 (func_push (to_model (us_repqtmk r__split_fields1)) x)))
     (let ((temp___365 (to_model (us_repqtmk r__split_fields3))))
     (bool_eq (to_array temp___365) (first1 temp___365) (last1 temp___365)
     (to_array temp___366) (first1 temp___366) (last1 temp___366)))) true))))))))))))))))))))))))))))))
(check-sat)
(exit)
