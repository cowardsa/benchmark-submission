...
;; defqtvc
 ;; File "test.adb", line 216, characters 0-0
  ...
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)))
  (os_mbx_get_mbx_count__function_guard
  (os_mbx_get_mbx_count task_id os_task_mbx_rw1) task_id os_task_mbx_rw1))
  (=> (bvult index (os_mbx_get_mbx_count task_id os_task_mbx_rw))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)))
  (os_mbx_get_mbx_entry_sender__function_guard
  (os_mbx_get_mbx_entry_sender task_id index os_task_mbx_rw1) task_id 
  index os_task_mbx_rw1))
  (=> (in_range4 (os_mbx_get_mbx_entry_sender task_id index os_task_mbx_rw))
  (let ((o task_id))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o1 Int))
  (os_mbx_get_mbx_head__function_guard
  (os_mbx_get_mbx_head o1 os_task_mbx_rw1) o1 os_task_mbx_rw1))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o1 Int))
  (os_mbx_get_mbx_head__function_guard
  (os_mbx_get_mbx_head o1 os_task_mbx_rw1) o1 os_task_mbx_rw1))
  (=>
  (forall ((os_task_mbx_rw1 (Array Int us_rep1)) (o1 (_ BitVec 8)) (o2 Int))
  (oadd__function_guard (oadd (os_mbx_get_mbx_head o2 os_task_mbx_rw1) o1)
  (os_mbx_get_mbx_head o2 os_task_mbx_rw1) o1)) (in_range4
  (to_rep2
  (rec__test__os_mbx_entry_t__sender_id
  (us_split_fields1
  (select (rec__test__os_mbx_t__mbx_array
          (us_split_fields3 (select os_task_mbx_rw o))) (oadd
                                                        (os_mbx_get_mbx_head
                                                        o os_task_mbx_rw)
                                                        index)))))))))))))))))))))))
(check-sat)
