...
(define-fun in_range6 ((rec__very_longs__very_long__octet_length1 Int)
  (a us_split_discrs)) Bool (= rec__very_longs__very_long__octet_length1 
  (to_rep2 (rec__very_longs__very_long__octet_length a))))
...
(declare-datatypes ((s32b__ref 0))
(((s32b__refqtmk (s32b__content us_t1)))))
(define-fun s32b__ref_s32b__content__projection ((a s32b__ref)) us_t1 
  (s32b__content a))
...
(declare-fun temp_____aggregate_def_933 ((_ BitVec 8) Int Int) us_t1)
...
;; def_axiom
  (assert
  (forall ((temp___935 (_ BitVec 8)))
  (forall ((temp___936 Int) (temp___937 Int))
  (let ((temp___934 (temp_____aggregate_def_933 temp___935 temp___936
                    temp___937)))
  (=> (dynamic_invariant3 temp___935 true true true true)
  (and
  (=> (dynamic_property1 1 2147483647 temp___936 temp___937)
  (and (= (first3 temp___934) temp___936) (= (last3 temp___934) temp___937)))
  (forall ((temp___938 Int))
  (= (to_rep4 (select (to_array1 temp___934) temp___938)) temp___935))))))))

(define-fun dynamic_invariant7 ((temp___expr_253 us_t1)
  ...
  (temp___do_typ_inv_252 Bool)) Bool (=>
                                     ...
                                     (last3 temp___expr_253))))

(define-fun dynamic_invariant8 ((temp___expr_468 us_t1)
  (temp___is_init_464 Bool) (temp___skip_constant_465 Bool)
  (temp___do_toplevel_466 Bool)
  (temp___do_typ_inv_467 Bool)) Bool (=>
                                     (not (= temp___skip_constant_465 true))
                                     (and (dynamic_property1 1 r33b
                                     (first3 temp___expr_468)
                                     (last3 temp___expr_468))
                                     (and (= (first3 temp___expr_468) 1)
                                     (= (last3 temp___expr_468) r33b)))))

(define-fun default_initial_assumption ((temp___expr_470 us_t1)
  (temp___skip_top_level_471 Bool)) Bool (and (= (first3 temp___expr_470) 1)
                                         (= (last3 temp___expr_470) r33b)))

(assert
;; defqtvc
 ;; File "very_longs.ads", line 15, characters 0-0
  (not
  (forall ((result____split_fields us_t1) (index Int) (string_index Int)
  (h_digit (_ BitVec 8)) (l_digit (_ BitVec 8))
  (very_longs__make_from_hex_string__R33b__assume Int))
  ...
  (=>
  (= (to_rep2
     (rec__very_longs__very_long__octet_length result____split_discrs)) very_longs__make_from_hex_string__R33b__assume)
  (=> (= very_longs__make_from_hex_string__R33b__assume r33b)
  (=> (dynamic_invariant4 r33b true false true true)
  (let ((temp___939 (temp_____aggregate_def_933 #x00 1 r33b)))
  (=> (= (first3 temp___939) 1)
  (=> (= (last3 temp___939) r33b)
  (=>
  (ite (<= (first3 temp___939) (last3 temp___939))
  (and (<= 1 r33b) (= (- (last3 temp___939) (first3 temp___939)) (- r33b 1)))
  (< r33b 1))
  (let ((temp___941 (of_array1 (to_array1 temp___939) (first3 temp___939)
                    (last3 temp___939))))
  (=>
  (ite (<= (first3 temp___941) (last3 temp___941))
  (and (<= (first3 result____split_fields) (last3 result____split_fields))
  (= (- (last3 temp___941) (first3 temp___941)) (- (last3
  ...
  (=>
  (= result____split_fields1 (of_array1 (to_array1 temp___941)
                             (first3 temp___941) (last3 temp___941)))
  (forall ((valid Bool))
  (=> (= valid (distinct 1 0))
  ...
  (and
  (and
  (and (dynamic_invariant3 h_digit1 false true true true) (dynamic_invariant3
  l_digit1 false true true true)) (dynamic_invariant2
  (us_repqtmk result____split_discrs
  (us_split_fieldsqtmk result____split_fields2)) false true true true))
  (dynamic_invariant4 index2 false true true true)) (dynamic_invariant
  string_index2 false true true true))
  (=>
