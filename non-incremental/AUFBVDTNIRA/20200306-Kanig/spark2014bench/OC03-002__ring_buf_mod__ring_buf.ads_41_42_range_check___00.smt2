...
(define-fun to_int2 ((x ar_index)) Int (ubv_to_int (to_rep x)))
...
(define-fun bool_eq ((a (Array (_ BitVec 16) integer))
  ...
  (b__last (_ BitVec 16))) Bool (ite (and
                                     ...
                                     (= (to_rep2 (select a temp___idx_154)) 
                                     (to_rep2
...
(assert
;; defqtvc
 ;; File "ring_buf.ads", line 38, characters 0-0
  (not
  (forall ((o Int) (o1 (_ BitVec 16)) (o2 (_ BitVec 16)) (o3 Int))
  (=>
  (= (to_rep1 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))) o)
  (=>
  (= (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) o1)
  (=> (< 65535 (- (+ (ubv_to_int o1) o) 1))
  (=>
  (= (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) o2)
  (=>
  (= (to_rep1 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))) o3)
  (=> (uint_in_range o3)
  (let ((temp___300 (bvsub (bvsub (bvadd #x0000 ((_ int_to_bv 16) o3)) (bvsub #xFFFF o2)) #x0001)))
  (=>
  (=> (bvule #x0000 temp___300)
  (and (and (bvule #x0000 #x0000) (bvule #x0000 #xFFFF))
  (and (bvule #x0000 temp___300) (bvule temp___300 #xFFFF))))
  (let ((temp___303 (of_array
                    (rec__ring_buf__ring_buffer__data (us_split_fields1 r))
                    #x0000 temp___300)))
  (forall ((temp___296 (_ BitVec 16)))
  (=>
  (= (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) temp___296)
  (=>
  (=> (bvule temp___296 #xFFFF)
  (and (and (bvule #x0000 temp___296) (bvule temp___296 #xFFFF))
  (and (bvule #x0000 #xFFFF) (bvule #xFFFF #xFFFF))))
  (let ((temp___302 (of_array
                    (rec__ring_buf__ring_buffer__data (us_split_fields1 r))
                    temp___296 #xFFFF)))
  (=> (not (= (length1 temp___302) 0)) (uint_in_range
  (- (+ (ubv_to_int (first1 temp___302)) (+ (length (ubv_to_int (first1 temp___302))
                                        (ubv_to_int (last1 temp___302))) 
  (length (ubv_to_int (first1 temp___303)) (ubv_to_int (last1 temp___303))))) 1)))))))))))))))))))
(check-sat)
(exit)
