...
(define-fun to_int3 ((x octet1)) Int (ubv_to_int (to_rep2 x)))
...
;; defqtvc
 ;; File "messages.ads", line 46, characters 0-0
  ...
  (=> (= i 1)
  (=>
  (= (and (ite (<= 1 i) true false) (ite (<= i temp___284) true false)) true)
  (let ((usf (to_rep
             (rec__messages__network_message__size low_level__split_fields))))
  (forall ((o (_ BitVec 8)))
  (=>
  (= (to_rep2
  ...
  (forall ((o1 octet))
  (=> (= (to_rep1 o1) o)
  (forall ((low_level__split_fields1 us_split_fields))
  (=>
  (= low_level__split_fields1 (us_split_fieldsqtmk
  ...
  (forall ((o2 Int))
  (=>
  (= (to_rep (rec__messages__network_message__size low_level__split_fields1)) o2)
  (forall ((low_level__split_fields2 us_split_fields) (i1 Int))
  (=>
  (and
  (= (to_rep (rec__messages__network_message__size low_level__split_fields2)) usf)
  (forall ((item Int))
  (=> (and (<= 1 item) (<= item 512))
  (ite (and (<= 1 item) (<= item i1))
  (= (to_rep1
     (select (rec__messages__network_message__data low_level__split_fields2) item)) 
  (to_rep2
  (select (rec__messages__message__data (us_split_fields3 high_level)) item)))
  (= (to_rep1
     (select (rec__messages__network_message__data low_level__split_fields2) item)) #x00)))))
  (=>
  (= (and (ite (and (dynamic_property 1 r10b i1)
               ...
               (= (select (rec__messages__network_message__data
                          low_level__split_fields2) temp___291) (select 
               (rec__messages__network_message__data low_level__split_fields) temp___291)))))
               (= (rec__messages__network_message__size
                  low_level__split_fields2) (rec__messages__network_message__size
                                            low_level__split_fields))))
  ...
  (=>
  (= (to_rep2
     (select (rec__messages__message__data (us_split_fields3 high_level)) i2)) o3)
  (forall ((o4 octet))
  (=> (= (to_rep1 o4) o3)
  (forall ((low_level__split_fields3 us_split_fields))
  (=>
  (= low_level__split_fields3 (us_split_fieldsqtmk
                              (store (rec__messages__network_message__data
                                     low_level__split_fields2) i2 o4)
                              (rec__messages__network_message__size
                              low_level__split_fields2)))
  (forall ((o5 Int))
  (=>
  (= (to_rep (rec__messages__network_message__size low_level__split_fields3)) o5)
  (= (to_rep (rec__messages__network_message__size low_level__split_fields3)) usf)))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
