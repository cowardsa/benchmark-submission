...
(define-fun us_split_fields_rec__very_longs__very_long__long_digits__21__projection ((a us_split_fields2)) us_t 
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((us_split_fields__refqtmk1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___split_fields__content__21__projection ((a us_split_fields__ref1)) us_split_fields2 
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((us_repqtmk1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep___split_discrs__21__projection ((a us_rep1)) us_split_discrs 
  (us_split_discrs2 a))

(define-fun us_rep___split_fields__21__projection ((a us_rep1)) us_split_fields2 
  (us_split_fields3 a))

(define-fun to_base ((a us_rep1)) us_rep (us_repqtmk (us_split_discrs2 a)
                                         (us_split_fieldsqtmk
                                         (let ((temp___208 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array temp___208)
                                         (first1 temp___208)
                                         (last1 temp___208))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (us_repqtmk1 (us_split_discrs1 r1)
                                          (us_split_fieldsqtmk1
                                          (let ((temp___207 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
...
(define-fun dynamic_invariant2 ((temp___expr_650 us_rep1)
  (temp___is_init_646 Bool) (temp___skip_constant_647 Bool)
  (temp___do_toplevel_648 Bool)
  (temp___do_typ_inv_649 Bool)) Bool (and
                                     (=>
...
(define-fun default_initial_assumption ((temp___expr_653 us_rep1)
  (temp___skip_top_level_654 Bool)) Bool (and
                                         (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
...
(define-fun dynamic_invariant3 ((temp___expr_356 (_ BitVec 16))
...
(declare-fun temp_____aggregate_def_1025 ((_ BitVec 8) Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___1027 (_ BitVec 8)))
  (forall ((temp___1028 Int) (temp___1029 Int))
  (let ((temp___1026 (temp_____aggregate_def_1025 temp___1027 temp___1028
                     temp___1029)))
  (=> (dynamic_invariant1 temp___1027 true true true true)
  (and
  (=> (dynamic_property 1 65536 temp___1028 temp___1029)
  (and (= (first1 temp___1026) temp___1028)
  (= (last1 temp___1026) temp___1029)))
  (forall ((temp___1030 Int))
  (= (to_rep2 (select (to_array temp___1026) temp___1030)) temp___1027))))))))
...
(assert
;; defqtvc
 ;; File "very_longs.ads", line 49, characters 0-0
  (not
  ...
  (let ((temp___1031 (temp_____aggregate_def_1025 #x00 1 o1)))
  (=> (= (first1 temp___1031) 1)
  (=>
  (= (last1 temp___1031) (to_rep
                         (rec__very_longs__very_long__length
                         (us_split_discrs1 l))))
  (=>
  (ite (<= (first1 temp___1031) (last1 temp___1031))
  (and
  (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))
  (= (- (last1 temp___1031) (first1 temp___1031)) (- (to_rep
                                                     (rec__very_longs__very_long__length
                                                     (us_split_discrs1 l))) 1)))
  (< (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1))
  (let ((temp___1033 (of_array (to_array temp___1031) (first1 temp___1031)
                     (last1 temp___1031))))
  (=>
  (ite (<= (first1 temp___1033) (last1 temp___1033))
  (and (<= (first1 result____split_fields) (last1 result____split_fields))
  (= (- (last1 temp___1033) (first1 temp___1033)) (- (last1
  ...
  (=> (= result____split_fields1 temp___1033)
  (forall ((borrow1 (_ BitVec 16)))
  (=> (= borrow1 #x0000)
  (forall ((result____split_fields2 us_t))
  (=>
  (let ((temp___1038 (last1
                     (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l)))))
  (exists ((i Int))
  (and (= i 1)
  (ite (= (and (ite (<= 1 i) true false) (ite (<= i temp___1038) true false)) true)
  ...
  (= (and (ite (and
               ...
               (and
               (and
               (and (dynamic_invariant3 borrow2 false true true true)
               (dynamic_invariant2
               (us_repqtmk1 result____split_discrs
               (us_split_fieldsqtmk1 result____split_fields3)) false true
               true true))
               (forall ((temp___1047 Int))
               (=>
               (and (<= (first1 result____split_fields3) temp___1047)
               (<= temp___1047 (last1 result____split_fields3)))
               (=>
               (or (< temp___1038 temp___1047)
               (or (< temp___1047 1) (<= i1 temp___1047)))
               (= (select (to_array result____split_fields3) temp___1047) (select 
               (to_array result____split_fields1) temp___1047))))))
               (dynamic_invariant3 l_digit1 false true true true))
               (dynamic_invariant3 r_digit1 false true true true))
          ...
          true false) (ite (and (<= 1 i1)
                           (<= i1 (last1
                                  ...
                                  (us_split_fields1 l)))))
                      true false)) true)
  (let ((temp___1039 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 l))))
  (and (and (<= (first1 temp___1039) i1) (<= i1 (last1 temp___1039)))
  (exists ((o2 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1039) i1)) o2)
  (exists ((l_digit2 (_ BitVec 16)))
  (and (= l_digit2 ((_ zero_extend 8) o2))
  (let ((temp___1040 (rec__very_longs__very_long__long_digits
                     (us_split_fields1 r))))
  (and (and (<= (first1 temp___1040) i1) (<= i1 (last1 temp___1040)))
  (exists ((o3 (_ BitVec 8)))
  (and (= (to_rep2 (select (to_array temp___1040) i1)) o3)
