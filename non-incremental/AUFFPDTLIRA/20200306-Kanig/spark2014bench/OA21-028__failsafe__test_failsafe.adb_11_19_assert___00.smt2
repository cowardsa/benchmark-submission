...
;; defqtvc
 ;; File "test_failsafe.adb", line 3, characters 0-0
  ...
  (exists ((j1 Int) (current_time4 (_ BitVec 8)))
  (and
  (= (and (ite (dynamic_invariant current_time4 true true true true) true
          false) (ite (and (<= 1 j1) (<= j1 49)) true false)) true)
  (exists ((current_time5 (_ BitVec 8)))
  (and (= current_time5 current_time4)
  (and
  (and
  (and
  (and (= (is_valid battery_level_at1 current_time1 counter1) true)
  (= current_time1 (let ((temp___209 (bvadd current_time5 #x01)))
                   (ite (bvule (bvsub #x32 current_time5) #x01)
