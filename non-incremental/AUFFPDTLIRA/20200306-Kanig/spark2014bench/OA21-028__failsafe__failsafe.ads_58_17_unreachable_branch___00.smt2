...
;; defqtvc
 ;; File "failsafe.ads", line 54, characters 0-0
  ...
  (let ((o3 (bvadd counter #x01)))
  (let ((o4 (ite (bvule o3 #x32) o3 #x32)))
  (and (in_range3 o4)
  (and (= counter1 o4)
  (and
  (=>
  ...
  current_time2))
  (=>
  (let ((o3 (is_valid counter1 battery_level_at1 current_time1)))
  (and
  (and (is_valid__function_guard o3 counter1 battery_level_at1 current_time1)
  (= (= o3 true)
  (= counter1 (time_below_threshold battery_level_at1 current_time1))))
  (ite (= o3 true)
  (exists ((o4 (_ BitVec 8)))
  (and
  (let ((temp___276 (bvadd current_time #x01)))
  (ite (bvule (bvsub #x32 current_time) #x01) (= o4 (bvsub temp___276 #x32))
