...
(assert
;; defqtvc
 ;; File "failsafe.ads", line 60, characters 0-0
  (not
  (forall ((battery_level_at (Array (_ BitVec 8) battery_level_type))
  (current_time (_ BitVec 8)) (counter (_ BitVec 8)))
  ...
  (current_time1 (_ BitVec 8)) (counter1 (_ BitVec 8)))
  (is_valid__function_guard
  (is_valid counter1 battery_level_at1 current_time1) counter1
  battery_level_at1 current_time1))
  (=> (= (is_valid counter battery_level_at current_time) true)
  (let ((o (is_valid counter battery_level_at current_time)))
  (=>
  (forall ((battery_level_at1 (Array (_ BitVec 8) battery_level_type))
  (current_time1 (_ BitVec 8))) (time_below_threshold__function_guard
  (time_below_threshold battery_level_at1 current_time1) battery_level_at1
  current_time1))
  (=>
  (and (is_valid__function_guard o counter battery_level_at current_time)
  (= (= o true)
