...
;; defqtvc
 ;; File "test_failsafe.adb", line 3, characters 0-0
  ...
  (=> (= j 1)
  (=>
  (forall ((current_time6 (_ BitVec 8))
  (battery_level_at4 (Array (_ BitVec 8) battery_level_type))
  (counter4 us_private)) (is_valid__function_guard
  (is_valid battery_level_at4 current_time6 counter4) battery_level_at4
  current_time6 counter4))
  (=>
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j 49) true false)) true)
  (exists ((j1 Int) (current_time6 (_ BitVec 8)))
  (and
  (= (and (ite (dynamic_invariant current_time6 true true true true) true
          false) (ite (and (<= 1 j1) (<= j1 49)) true false)) true)
  (exists ((current_time7 (_ BitVec 8)))
  (and (= current_time7 current_time6)
  (and
  (and
  (and
  (and (= (is_valid battery_level_at1 current_time1 counter1) true)
  (= current_time1 (let ((temp___209 (bvadd current_time7 #x01)))
                   (ite (bvule (bvsub #x32 current_time7) #x01)
  ...
  (forall ((current_time6 (_ BitVec 8))
  (battery_level_at4 (Array (_ BitVec 8) battery_level_type))
  (counter4 us_private)) (is_raised__function_guard
  (is_raised battery_level_at4 current_time6 counter4) battery_level_at4
  current_time6 counter4))
