...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (fp.eq (to_rep1 (rec__p2__r__b (us_split_fields1 a))) 
...
(define-fun dynamic_invariant2 ((temp___expr_178 (_ BitVec 8))
  (temp___is_init_174 Bool) (temp___skip_constant_175 Bool)
  (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "p2.ads", line 30, characters 0-0
  (not
  (forall ((full_s__split_fields us_split_fields) (o Int))
  (=> (dynamic_invariant x true false true true)
  (=> (dynamic_invariant1 y true false true true)
  (=> (= (to_rep (rec__p2__r__a full_s__split_fields)) o)
  (let ((o1 (+ o x)))
  (=> (in_range o1)
  (forall ((o2 integer))
  (=> (= (to_rep o2) o1)
  (forall ((full_s__split_fields1 us_split_fields))
  (=>
  (= full_s__split_fields1 (us_split_fieldsqtmk o2
                           (rec__p2__r__b full_s__split_fields)))
  (forall ((o3 Float32))
  (=> (= (to_rep1 (rec__p2__r__b full_s__split_fields1)) o3)
