...
;; defqtvc
 ;; File "logger.ads", line 47, characters 0-0
  ...
  (result__ (Array (_ BitVec 16) us_rep)) (logger__log_content__result us_t))
  (=>
  ...
  (let ((o (distinct 0 0)))
  (let ((o1 (make_entry #x0000 #x0000 #x0000
            (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)
            o)))
  (and
  (and (make_entry__function_guard o1 #x0000 #x0000 #x0000
  (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)
  o)
  (= o1 (us_repqtmk
        (us_split_fieldsqtmk (of_rep2 #x0000) (of_rep2 #x0000)
        (of_rep2 #x0000)
        (of_rep1
        (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))
        o))))
  (= logger__log_content__result (of_array (temp_____aggregate_def_246 o1)
                                 #x0001 #x0000)))))
  ...
  (let ((o1 (- o 1)))
  (and (in_range_int o1)
  (and (= ((_ int_to_bv 16) o1) tmp)
  (and (dynamic_invariant3 tmp true false true true)
  ...
  (exists ((result__1 (Array (_ BitVec 16) us_rep)))
  (and
  ...
  (and (= spark__branch1 (ite (bvule o3 o2) true false))
  (ite (= spark__branch1 true)
  (exists ((logger__log_content__B_1__R4b__assume (_ BitVec 16)))
  (and
  (= (to_rep (rec__logger__log_database__first event_log__split_fields)) logger__log_content__B_1__R4b__assume)
  (and (= logger__log_content__B_1__R4b__assume r4b)
  (and (dynamic_invariant3 r4b true false true true)
  (exists ((logger__log_content__B_1__R5b__assume (_ BitVec 16)))
  (and
  (= (to_rep (rec__logger__log_database__last event_log__split_fields)) logger__log_content__B_1__R5b__assume)
  (and (= logger__log_content__B_1__R5b__assume r5b)
  (and (dynamic_invariant3 r5b true false true true)
  (and
  (=> (bvule r4b r5b)
  ...
  (let ((temp___252 (of_array
                    ...
                    #x0000 tmp)))
  (and
  (ite (bvule (first1 temp___252) (last1 temp___252))
  (and (bvule (to_rep result____first) (to_rep result____last))
  (= (bvsub (last1 temp___252) (first1 temp___252)) (bvsub (to_rep
                                                           result____last) 
  (to_rep result____first))))
  (bvult (to_rep result____last) (to_rep result____first)))
  (= result__1 (to_array temp___252)))))))))))))))
  (exists ((logger__log_content__B_1__R8b__assume (_ BitVec 16)))
  (and
  (= (to_rep (rec__logger__log_database__first event_log__split_fields)) logger__log_content__B_1__R8b__assume)
  (and (= logger__log_content__B_1__R8b__assume r8b)
  (and (dynamic_invariant3 r8b true false true true)
  (exists ((logger__log_content__B_1__R11b__assume (_ BitVec 16)))
  (and
  (= (to_rep (rec__logger__log_database__last event_log__split_fields)) logger__log_content__B_1__R11b__assume)
  (and (= logger__log_content__B_1__R11b__assume r11b)
  (and (dynamic_invariant3 r11b true false true true)
  (exists ((temp___259 us_t))
  (and
  (and
  (=> (bvule #x0000 r11b)
  (and (and (bvule #x0000 #x0000) (bvule #x0000 #x0257))
  (and (bvule #x0000 r11b) (bvule r11b #x0257))))
  (let ((temp___258 (of_array
                    (rec__logger__log_database__data event_log__split_fields)
                    #x0000 r11b)))
  (and
  (=> (bvule r8b #x0257)
  ...
  (and (bvule #x0000 tmp)
  (= (bvsub (last1 temp___259) (first1 temp___259)) (bvsub tmp #x0000)))
  (bvult tmp #x0000))
  (let ((temp___260 (of_array
                    (slide (to_array temp___259) (first1 temp___259) #x0000)
                    #x0000 tmp)))
  (and
  (ite (bvule (first1 temp___260) (last1 temp___260))
  (and (bvule (to_rep result____first) (to_rep result____last))
  (= (bvsub (last1 temp___260) (first1 temp___260)) (bvsub (to_rep
                                                           result____last) 
  (to_rep result____first))))
  (bvult (to_rep result____last) (to_rep result____first)))
  (= result__1 (to_array temp___260))))))))))))))))))))))
  (exists ((o2 (_ BitVec 16)))
  (and (= (to_rep result____last) o2)
  (exists ((o3 (_ BitVec 16)))
  (and (= (to_rep result____first) o3)
  (= logger__log_content__result (of_array result__1 o3 o2)))))))))))))))))))
  (let ((o (log_size event_log__split_fields)))
  (=>
  (and (log_size__function_guard o event_log__split_fields)
  (and (dynamic_invariant o true false true true)
