...
(declare-datatypes ((tfloat32B__ref 0))
(((tfloat32B__refqtmk (tfloat32B__content tfloat32B)))))
(define-fun tfloat32B__ref_tfloat32B__content__projection ((a tfloat32B__ref)) tfloat32B 
...
(declare-datatypes ((float32__ref 0))
(((float32__refqtmk (float32__content float32)))))
(define-fun float32__ref_float32__content__projection ((a float32__ref)) float32 
  (float32__content a))
...
(define-fun in_range1 ((x1 (_ BitVec 32))) Bool (and (bvule #x00000000 x1)
                                                (bvule x1 #x000F4240)))

(define-fun in_range_int ((x1 Int)) Bool (and (<= 0 x1) (<= x1 1000000)))
...
(((t__refqtmk2 (t__content2 t)))))
(define-fun t__ref_t__content__projection ((a t__ref2)) t (t__content2 a))
...
;; defqtvc
 ;; File "wibble.adb", line 31, characters 0-0
  ...
  (=> (= state1 o)
  (fp.leq state1 (fp.mul RNE ((_ to_fp_unsigned 8 24) RNE (bvadd x #x00000001)) (fp #b0 #b10000010 #b01000000000000000000000))))))))))))))
(check-sat)
(exit)
