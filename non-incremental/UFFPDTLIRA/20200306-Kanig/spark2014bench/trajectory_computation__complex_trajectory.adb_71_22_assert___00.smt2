...
;; defqtvc
 ;; File "complex_trajectory.ads", line 39, characters 0-0
  ...
  n 1))) ((_ to_fp 11 53) RNE (to_real (+ n 2)))) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)) distance1)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
