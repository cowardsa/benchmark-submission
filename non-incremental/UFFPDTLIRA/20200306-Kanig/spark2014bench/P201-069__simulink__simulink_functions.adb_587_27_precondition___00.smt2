...
(define-fun dynamic_invariant1 ((temp___expr_363 (_ BitVec 16))
  (temp___is_init_359 Bool) (temp___skip_constant_360 Bool)
  (temp___do_toplevel_361 Bool) (temp___do_typ_inv_362 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "simulink_functions.ads", line 99, characters 0-0
  (not
  (=> (dynamic_invariant1 i true false true true)
  (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) ((_ to_fp_unsigned 8 24) RNE 
  i)))))
(check-sat)
(exit)
