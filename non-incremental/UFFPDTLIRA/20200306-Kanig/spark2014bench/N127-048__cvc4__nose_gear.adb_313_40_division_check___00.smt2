...
;; defqtvc
 ;; File "nose_gear.ads", line 21, characters 0-0
  ...
  (ngrotations_out11 (_ BitVec 16)) (wheel_circunference_out11 Float64)
  (ms_in_hour_out11 Float64) (ms_in_our1_out11 Float64)
  (update_period_os_interrupt_out11 (_ BitVec 16))
  (validity_period_out11 (_ BitVec 16)) (to_int32_left_out11 Int)
  ...
  (data_type_conversion_out11 Int) (sum1_2_out11 (_ BitVec 16)))
  ...
  (=> (= update_period_os_interrupt_out11 #x01F4)
  (=> (= validity_period_out11 #x0BB8)
  (=> (= to_int32_left_out11 (ubv_to_int ngrotations_out11))
  (=> (= to_int32_left_1_out11 (ubv_to_int ngclicktime_out11))
  (=> (= to_int32_left_2_out11 (ubv_to_int millisecs_out11))
  (=> (= to_int32_right_out11 (ubv_to_int old_ngrotations_out11))
  (=> (= to_int32_right_1_out11 (ubv_to_int old_ngclicktime_out11))
  (=> (= to_int32_right_2_out11 (ubv_to_int old_ngclicktime_out11))
  (=> (= data_type_conversion1_out11 (ubv_to_int millisecs_out11))
  (=> (= data_type_conversion_out11 (ubv_to_int old_ngclicktime_out11))
  (=>
  (= sum1_2_out11 (bvsub validity_period_out11 update_period_os_interrupt_out11))
  ...
  (=> (= to_uint16_result_out11 ((_ int_to_bv 16) left_out11))
  (=> (<= left_1_out11 65535)
  (=> (uint_in_range left_1_out11)
  (forall ((to_uint16_result_1_out11 (_ BitVec 16)))
  (=> (= to_uint16_result_1_out11 ((_ int_to_bv 16) left_1_out11))
  (=> (uint_in_range left_2_out11)
  (forall ((to_uint16_result_2_out11 (_ BitVec 16)))
  (=> (= to_uint16_result_2_out11 ((_ int_to_bv 16) left_2_out11))
  (let ((o10 (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE to_uint16_result_out11) wheel_circunference_out11)))
  (=> (fp.isFinite64 o10)
  (forall ((distance_km_out11 Float64))
  (=> (= distance_km_out11 o10)
  (let ((o11 (fp.div RNE ((_ to_fp_unsigned 11 53) RNE to_uint16_result_1_out11) ms_in_hour_out11)))
  (=> (fp.isFinite64 o11)
  (forall ((elapsed_time_h_out11 Float64))
  (=> (= elapsed_time_h_out11 o11)
  (forall ((relational_operator_out1 Bool))
  (=>
  (= relational_operator_out1 (ite (bvule to_uint16_result_2_out11 sum1_2_out11)
                              true false))
  (forall ((spark__branch3 Bool) (avoid_div_by_zero_out11 Float64))
  (=>
  (and
  (= spark__branch3 (ite (bvugt to_uint16_result_1_out11 #x0000) true false))
  (ite (= spark__branch3 true)
  (= avoid_div_by_zero_out11 elapsed_time_h_out11)
  (= avoid_div_by_zero_out11 ms_in_our1_out11)))
  (not (fp.isZero avoid_div_by_zero_out11))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
