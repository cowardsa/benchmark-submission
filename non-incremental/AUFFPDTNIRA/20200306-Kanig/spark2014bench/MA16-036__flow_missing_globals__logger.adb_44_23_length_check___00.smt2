...
;; defqtvc
 ;; File "logger.ads", line 47, characters 0-0
  ...
  (forall ((logger__log_content__B_1__R8b__assume (_ BitVec 16)))
  (=>
  (= (to_rep (rec__logger__log_database__first event_log__split_fields)) logger__log_content__B_1__R8b__assume)
  (=> (= logger__log_content__B_1__R8b__assume r8b)
  (=> (dynamic_invariant3 r8b true false true true)
  (forall ((logger__log_content__B_1__R11b__assume (_ BitVec 16)))
  (=>
  (= (to_rep (rec__logger__log_database__last event_log__split_fields)) logger__log_content__B_1__R11b__assume)
  (=> (= logger__log_content__B_1__R11b__assume r11b)
  (=> (dynamic_invariant3 r11b true false true true)
