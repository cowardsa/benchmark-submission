...
;; defqtvc
 ;; File "failsafe.ads", line 54, characters 0-0
  ...
  (=>
  (let ((o9 (bvsub counter1 #x01)))
  (and (in_range1 o9)
  (let ((temp___268 (bvsub current_time1 o9)))
  (let ((o10 (bvsub counter1 #x01)))
  (and (in_range1 o10)
  (ite (bvult current_time1 o10) (= o8 (bvadd temp___268 #x32))
  (= o8 temp___268)))))))
  (not
  (= (and (ite (bvule o8 usf) true false) (ite (bvule usf #x31) true false)) true))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
