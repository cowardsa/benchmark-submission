...
;; defqtvc
 ;; File "failsafe.ads", line 22, characters 0-0
  ...
  (let ((usf (fp.geq (to_rep (select battery_level_at current_time)) 
  battery_threshold)))
  ...
  (= res1 res))
  (forall ((failsafe__model__time_below_threshold__result (_ BitVec 8)))
  (=> (= failsafe__model__time_below_threshold__result res1)
  (=>
  ...
  (=>
  (not
  (= (or usf (ite (forall ((s1 (_ BitVec 8)))
                  (=> (and (bvule #x00 s1) (bvule s1 #x31))
                  (fp.lt (to_rep (select battery_level_at s1)) battery_threshold)))
             true false)) true))
  (forall ((o Bool))
  (=>
  (ite (bvult failsafe__model__time_below_threshold__result #x32)
  (exists ((o1 (_ BitVec 8)))
  (and
  (and (in_range1 failsafe__model__time_below_threshold__result)
  (let ((temp___249 (bvsub current_time failsafe__model__time_below_threshold__result)))
  (and (in_range1 failsafe__model__time_below_threshold__result)
  (ite (bvult current_time failsafe__model__time_below_threshold__result)
  (= o1 (bvadd temp___249 #x32)) (= o1 temp___249)))))
  (exists ((o2 Float32))
  (and (= (to_rep (select battery_level_at o1)) o2)
  (= o (ite (fp.leq battery_threshold o2) true false)))))) (= o false))
  (=> (= o true)
  (let ((o1 (bvsub failsafe__model__time_below_threshold__result #x01)))
  (=> (in_range1 o1)
  (=> (bvuge current_time o1)
  (forall ((usf1 (_ BitVec 8)))
  (forall ((o2 (_ BitVec 8)))
  (=>
  (let ((o3 (bvsub failsafe__model__time_below_threshold__result #x01)))
  (and (in_range1 o3)
  (let ((temp___250 (bvsub current_time o3)))
  (let ((o4 (bvsub failsafe__model__time_below_threshold__result #x01)))
  (and (in_range1 o4)
  (ite (bvult current_time o4) (= o2 (bvadd temp___250 #x32))
  (= o2 temp___250)))))))
  (not
  (= (and (ite (bvule o2 usf1) true false) (ite (bvule usf1 current_time)
                                           true false)) true))))))))))))))))))))))))))))))
(check-sat)
(exit)
