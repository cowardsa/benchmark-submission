...
;; defqtvc
 ;; File "test_failsafe.adb", line 3, characters 0-0
  ...
  (battery_level_at (Array (_ BitVec 8) battery_level_type))
  (counter us_private) (j Int) (current_time1 (_ BitVec 8))
  (battery_level_at1 (Array (_ BitVec 8) battery_level_type))
  (counter1 us_private) (current_time2 (_ BitVec 8))
  (current_time3 (_ BitVec 8))
  (battery_level_at2 (Array (_ BitVec 8) battery_level_type))
  (counter2 us_private) (current_time4 (_ BitVec 8))
  (current_time5 (_ BitVec 8))
  (battery_level_at3 (Array (_ BitVec 8) battery_level_type))
  (counter3 us_private) (current_time6 (_ BitVec 8))
  (current_time7 (_ BitVec 8))
  (battery_level_at4 (Array (_ BitVec 8) battery_level_type))
  (counter4 us_private))
  (=> (dynamic_invariant current_time true false true true)
  (=> (= j 1)
  (=>
  (forall ((current_time8 (_ BitVec 8))
  (battery_level_at5 (Array (_ BitVec 8) battery_level_type))
  (counter5 us_private)) (is_valid__function_guard
  (is_valid battery_level_at5 current_time8 counter5) battery_level_at5
  current_time8 counter5))
  (=>
  (ite (= (and (ite (<= 1 j) true false) (ite (<= j 49) true false)) true)
  (exists ((j1 Int) (current_time8 (_ BitVec 8)))
  (and
  (= (and (ite (dynamic_invariant current_time8 true true true true) true
          false) (ite (and (<= 1 j1) (<= j1 49)) true false)) true)
  (exists ((current_time9 (_ BitVec 8)))
  (and (= current_time9 current_time8)
  (and
  (and
  (and
  (and (= (is_valid battery_level_at1 current_time1 counter1) true)
  (= current_time1 (let ((temp___209 (bvadd current_time9 #x01)))
                   (ite (bvule (bvsub #x32 current_time9) #x01)
  ...
  (forall ((current_time8 (_ BitVec 8))
  (battery_level_at5 (Array (_ BitVec 8) battery_level_type))
  (counter5 us_private)) (is_raised__function_guard
  (is_raised battery_level_at5 current_time8 counter5) battery_level_at5
  current_time8 counter5))
  ...
  (is_valid battery_level_at5 current_time8 counter5) battery_level_at5
  current_time8 counter5))
  (=> (= (is_valid battery_level_at2 current_time3 counter2) true)
  (=>
  ...
  (=> (dynamic_invariant current_time3 true true true true)
  (=>
  (forall ((current_time8 (_ BitVec 8))
  (battery_level_at5 (Array (_ BitVec 8) battery_level_type))
  (counter5 us_private)) (is_raised__function_guard
  (is_raised battery_level_at5 current_time8 counter5) battery_level_at5
  current_time8 counter5))
  (=> (= (is_raised battery_level_at2 current_time3 counter2) true)
  (=> (= current_time4 current_time3)
  (=>
  (forall ((current_time8 (_ BitVec 8))
  (battery_level_at5 (Array (_ BitVec 8) battery_level_type))
  (counter5 us_private)) (is_valid__function_guard
  ...
  (=>
  (= current_time5 (let ((temp___209 (bvadd current_time4 #x01)))
                   (ite (bvule (bvsub #x32 current_time4) #x01)
                   (bvsub temp___209 #x32) temp___209)))
  (=>
  (fp.eq (to_rep (select battery_level_at3 current_time5)) (fp #b0 #b01111011 #b10011001100110011001101))
  (=> (dynamic_invariant current_time5 true true true true)
  (=>
  (forall ((current_time8 (_ BitVec 8))
  (battery_level_at5 (Array (_ BitVec 8) battery_level_type))
  (counter5 us_private)) (is_raised__function_guard
  (is_raised battery_level_at5 current_time8 counter5) battery_level_at5
  current_time8 counter5))
  (=> (= (is_raised battery_level_at3 current_time5 counter3) true)
  (=> (= current_time6 current_time5)
  (=>
  (forall ((current_time8 (_ BitVec 8))
  (battery_level_at5 (Array (_ BitVec 8) battery_level_type))
  (counter5 us_private)) (is_valid__function_guard
  (is_valid battery_level_at5 current_time8 counter5) battery_level_at5
  current_time8 counter5))
  (=> (= (is_valid battery_level_at4 current_time7 counter4) true)
  (=>
  (= current_time7 (let ((temp___209 (bvadd current_time6 #x01)))
                   (ite (bvule (bvsub #x32 current_time6) #x01)
                   (bvsub temp___209 #x32) temp___209)))
  (=>
  (fp.eq (to_rep (select battery_level_at4 current_time7)) (fp #b0 #b01111111 #b00000000000000000000000))
  (=> (dynamic_invariant current_time7 true true true true)
  (=>
  (forall ((current_time8 (_ BitVec 8))
  (battery_level_at5 (Array (_ BitVec 8) battery_level_type))
  (counter5 us_private)) (is_valid__function_guard
