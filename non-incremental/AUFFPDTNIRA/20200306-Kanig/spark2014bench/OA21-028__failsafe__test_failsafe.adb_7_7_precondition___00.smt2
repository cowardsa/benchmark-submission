...
;; defqtvc
 ;; File "test_failsafe.adb", line 3, characters 0-0
  (not
  (forall ((current_time (_ BitVec 8)) (j Int) (j1 Int)
  (current_time1 (_ BitVec 8))
  (battery_level_at (Array (_ BitVec 8) battery_level_type))
  (counter us_private))
  (=> (dynamic_invariant current_time true false true true)
  (=> (= j 1)
  (=> (= (and (ite (<= 1 j) true false) (ite (<= j 49) true false)) true)
  (=>
  (= (and (ite (dynamic_invariant current_time1 true true true true) true
  ...
  (counter1 us_private)) (is_valid__function_guard
  (is_valid battery_level_at1 current_time2 counter1) battery_level_at1
  current_time2 counter1))
  (= (is_valid battery_level_at current_time1 counter) true)))))))))
(check-sat)
(exit)
