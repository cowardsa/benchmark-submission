...
(declare-const s Int)
(declare-const t Int)
(define-fun lemma_UREM_REF7 ((x Int) (s Int) (t Int)) Bool (= x (intand k x (intor k s (intor k t (intneg k s))))))
(assert (= t (intmodtotal k x s)))
(assert (not (lemma_UREM_REF7 x s t)))
; bounds
