...
;; defqtvc
 ;; File "errorexample.ads", line 19, characters 0-0
  (not
  (forall ((relative_error (_ BitVec 32)) (abs_out1 (_ BitVec 32)))
  (=> (dynamic_invariant requested_force true false true true)
  (=> (dynamic_invariant1 calculated_force true false true true)
  (=> (dynamic_invariant relative_error false false true true)
  (=> (not (= requested_force #x00000000))
  (=> (dynamic_invariant abs_out1 false false true true)
  (=> (not (= requested_force #x00000000))
  (forall ((abs_out11 (_ BitVec 32)))
  (=>
