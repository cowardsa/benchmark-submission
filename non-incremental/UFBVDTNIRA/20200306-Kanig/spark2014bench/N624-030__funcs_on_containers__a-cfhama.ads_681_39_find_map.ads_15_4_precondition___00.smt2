...
(define-fun in_range1 ((rec__find_map__index_maps__map__capacity1 Int)
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     ...
     (=>
     (and (in_range4 temp___464)
     (= (iter_has_element result temp___464) true))
     (= (has_key (model1 container) (get result temp___464)) true))))
     (forall ((key Int))
     (=> (and (in_range3 key) (= (has_key (model1 container) key) true))
     (and (< 0 (find result key))
     (and
     (forall ((result1 us_rep3) (key1 Int)) (equivalent_keys__function_guard
     (equivalent_keys (get result1 (find result1 key1)) key1)
     ...
     (equivalent_keys (get result1 i1) (get result1 j1)) (get result1 i1)
     (get result1 j1)))
     (=> (= (equivalent_keys (get result i) (get result j)) true) (= i j))))))))) :pattern (
  (keys container)) )))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant1 key1 true true true true)
     ...
     (equivalent_keys__function_guard
     (equivalent_keys key2 (get container1 result1)) key2
...
(define-fun dynamic_invariant5 ((temp___expr_327 Int)
  ...
  (temp___do_typ_inv_326 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range7 temp___expr_327)))
...
(define-fun dynamic_invariant8 ((temp___expr_404 Int)
