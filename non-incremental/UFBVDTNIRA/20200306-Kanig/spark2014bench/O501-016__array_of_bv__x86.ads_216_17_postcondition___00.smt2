...
;; esp__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rsp true true true true)
     (let ((result (esp x86__rsp)))
     (=> (esp__function_guard result x86__rsp)
     (and (= result ((_ extract 31 0) (bvand x86__rsp #x00000000FFFFFFFF)))
     (dynamic_invariant1 result true false true true))))) :pattern ((esp
                                                                    x86__rsp)) )))
...
(assert
;; defqtvc
 ;; File "x86.ads", line 214, characters 0-0
  (not
  (forall ((rsp (_ BitVec 64)) (rsp1 (_ BitVec 64)))
  (=> (dynamic_invariant rsp true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rsp1 (bvor (bvand rsp #xFFFFFFFF00000000) ((_ zero_extend 32) val__)))
