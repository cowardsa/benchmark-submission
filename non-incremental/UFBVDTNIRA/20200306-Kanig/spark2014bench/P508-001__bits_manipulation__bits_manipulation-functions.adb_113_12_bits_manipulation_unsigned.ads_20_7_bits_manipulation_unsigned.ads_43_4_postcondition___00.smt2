...
;; msb_index_fast_inline_always__post_axiom
  (assert
  (forall ((value (_ BitVec 16))) (! (in_range1
  (msb_index_fast_inline_always value)) :pattern ((msb_index_fast_inline_always
                                                  value)) )))
...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 109, characters 0-0
  (not
  ...
  (= (shift_right o o1) #x0001))
  (forall
  ((bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result Int))
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result o1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_not_inline__result) #x0001))))))))))
(check-sat)
(exit)
