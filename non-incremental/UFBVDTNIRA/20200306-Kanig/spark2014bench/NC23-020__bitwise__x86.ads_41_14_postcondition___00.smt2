...
;; defqtvc
 ;; File "x86.ads", line 39, characters 0-0
  ...
  (=>
  (= rax2 (bvor (bvand rax #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__)))
  (= rax2 (bvor (bvand rax1 #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__))))))))))
(check-sat)
(exit)
