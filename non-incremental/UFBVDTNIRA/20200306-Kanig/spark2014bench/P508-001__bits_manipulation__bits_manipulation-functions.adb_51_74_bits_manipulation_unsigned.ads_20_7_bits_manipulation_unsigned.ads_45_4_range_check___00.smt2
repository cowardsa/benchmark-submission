...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 42, characters 0-0
  ...
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result (_ BitVec 64)))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result o3)
  (let ((o4 (+ (- to__ from) 1)))
  (=> (in_range1 o4)
  (let ((o5 (make_mask o4)))
  (=>
  ...
  (or
  (not
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result (bvand o8 o5)))
  (let ((o9 (+ (- to__ from) 1)))
  (and (in_range1 o9)
  ...
  (and
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result (bvand o8 o5))
  (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result 
