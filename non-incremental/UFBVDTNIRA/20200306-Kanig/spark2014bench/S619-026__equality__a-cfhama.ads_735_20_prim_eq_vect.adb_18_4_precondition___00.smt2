...
(((my_vect__refqtmk (my_vect__content us_rep3)))))
...
(((sequence__refqtmk (sequence__content us_rep5)))))
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant7 (get1 container1 position) true false true true)) :pattern (
