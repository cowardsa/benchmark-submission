...
;; defqtvc
 ;; File "discrimrec.ads", line 33, characters 0-0
  ...
  (eax__split_fields us_split_fields) (o unsigned_64) (o1 register_option))
  ...
  (=> (dynamic_invariant3 (us_repqtmk eax__split_discrs eax__split_fields)
  false false true true)
  (=> (= (to_rep o) #x0000000000000010)
  (=> (= (to_rep4 o1) 0) (in_range1 0
  (us_split_discrs1
  (us_repqtmk (us_split_discrsqtmk o1)
  (us_split_fieldsqtmk o dummy1 dummy1 dummy1 dummy2 dummy2 dummy1 dummy2
  dummy3 dummy3)))))))))))))))
(check-sat)
(exit)
