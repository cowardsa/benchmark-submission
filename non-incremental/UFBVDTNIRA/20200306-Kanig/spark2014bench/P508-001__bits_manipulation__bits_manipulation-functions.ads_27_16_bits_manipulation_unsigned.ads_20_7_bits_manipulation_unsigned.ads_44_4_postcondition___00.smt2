...
(declare-fun msb_index_fast_inline_always ((_ BitVec 32)) Int)
...
;; msb_index_fast_inline_always__post_axiom
  (assert
  (forall ((value1 (_ BitVec 32))) (! (in_range1
  (msb_index_fast_inline_always value1)) :pattern ((msb_index_fast_inline_always
                                                   value1)) )))

(declare-fun msb_index_fast_inline ((_ BitVec 32)) Int)

(declare-fun msb_index_fast_inline__function_guard (Int (_ BitVec 32)) Bool)
...
;; msb_index_slow_inline__post_axiom
  ...
  (! (=>
     ...
     (and (= (shift_right value1 result) #x00000001) (dynamic_invariant2
     result true false true true)))) :pattern ((msb_index_slow_inline value1)) )))
...
;; msb_index_slow_not_inline__post_axiom
  ...
  (! (=>
     ...
     (and (= (shift_right value1 result) #x00000001) (dynamic_invariant2
     result true false true true)))) :pattern ((msb_index_slow_not_inline
                                               value1)) )))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 23, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_32__functions__msb_index__result Int))
  ...
  (= (shift_right o o1) #x00000001)) (= result__1 o1))))
  ...
  (= (shift_right o o1) #x00000001))) (= result__1 o1)))))))))))))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_32__functions__msb_index__result) #x00000001)))))))))
(check-sat)
(exit)
