...
(assert
;; defqtvc
 ;; File "x86.ads", line 183, characters 0-0
  (not
  ...
  (=>
  (= rbx2 (bvor (bvand rbx #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__)))
  (= rbx2 (bvor (bvand rbx1 #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__))))))))))
(check-sat)
(exit)
