...
(define-fun in_range ((x1 Int)) Bool (and (<= 0 x1) (<= x1 2)))
...
(define-fun dynamic_invariant1 ((temp___expr_186 (_ BitVec 32))
...
;; defqtvc
 ;; File "division_by_zero.adb", line 18, characters 0-0
  (not
  (forall ((u (_ BitVec 32)) (spark__branch Bool) (spark__branch1 Bool))
  (=> (dynamic_invariant op true false true true)
  ...
  (=> (not (= spark__branch1 true)) (not (= y #x00000000)))))))))))))
(check-sat)
(exit)
