...
;; defqtvc
 ;; File "discrimrec.ads", line 33, characters 0-0
  ...
  (=> (= spark__branch (ite (= o3 #x00000010) true false))
  (=> (= spark__branch true)
  (forall ((o4 unsigned_64))
  (=> (= (to_rep o4) #x0000000000000020)
  (forall ((o5 register_option))
  (=> (= (to_rep4 o5) 0) (in_range1 0
  (us_split_discrs1
  (us_repqtmk (us_split_discrsqtmk o5)
  (us_split_fieldsqtmk o4 dummy1 dummy1 dummy1 dummy2 dummy2 dummy1 dummy2
  dummy3 dummy3))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
