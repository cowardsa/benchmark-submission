...
(define-fun to_int2 ((x unsigned_64)) Int (ubv_to_int (to_rep x)))
...
;; defqtvc
 ;; File "x86.ads", line 19, characters 0-0
  ...
  (and (= x86__rangesintersect__B100b__res__assume res)
  (exists ((spark__branch Bool))
  (and (= spark__branch res)
  (ite (= spark__branch true)
  (and
  (let ((temp___173 (bvadd var1_range_size var2_range_size)))
  (exists ((n (_ BitVec 64)))
  (and (= n #x0000000000000000)
  (or
  (not
  (= (and (ite (bvule #x0000000000000000 n) true false) (ite (bvule n temp___173)
                                                        true false)) true))
  (exists ((spark__branch1 Bool) (n11 (_ BitVec 64)) (n21 (_ BitVec 64)))
  (and
  ...
  (exists ((n3 (_ BitVec 64)))
  (and
  (or
  (forall ((m (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 m) (bvule m n3))
  ...
  (= (and (ite (dynamic_property #x0000000000000000
          (bvadd var1_range_size var2_range_size) n3) true false) (ite 
                                                                  (and
                                                                  (bvule #x0000000000000000 n3)
                                                                  (bvule n3 (bvadd 
                                                                  var1_range_size 
                                                                  var2_range_size)))
                                                                  true false)) true)
  ...
  (= (bvadd var1 i) (bvadd var2 j)))))))
  (and
  (let ((temp___177 var1_range_size))
  (exists ((n11 (_ BitVec 64)))
  (and (= n11 #x0000000000000000)
  (or
  (not
  (= (and (ite (bvule #x0000000000000000 n11) true false) (ite (bvule n11 temp___177)
                                                          true false)) true))
  (exists ((n12 (_ BitVec 64)))
  (and
  (=> (not (= n12 #x0000000000000000))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule #x0000000000000000 i) (bvule i (bvsub n12 #x0000000000000001)))
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 j) (bvule j var2_range_size))
  (not (= (bvadd var1 i) (bvadd var2 j))))))))
  (and
  (= (and (ite (dynamic_property1 #x0000000000000000 var1_range_size n12)
          true false) (ite (and (bvule #x0000000000000000 n12)
                           (bvule n12 var1_range_size))
                      true false)) true)
  (and
  (let ((temp___179 var2_range_size))
  (exists ((n21 (_ BitVec 64)))
  (and (= n21 #x0000000000000000)
  (or
  (not
  (= (and (ite (bvule #x0000000000000000 n21) true false) (ite (bvule n21 temp___179)
                                                          true false)) true))
  (exists ((n (_ BitVec 64)))
  (and (= n (bvadd n21 (bvsub var1_range_size n12)))
  (and (dynamic_invariant n true false true true)
  (and
  (and (bvule #x0000000000000000 n)
  (bvule n (bvadd var1_range_size var2_range_size)))
  (and (not (= var1 (bvadd (bvsub var2 var1_range_size) n)))
  (and (not (= (bvadd var1 n12) (bvadd var2 n21)))
  (exists ((n22 (_ BitVec 64)) (n3 (_ BitVec 64)))
  (and
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 j) (bvule j n22))
  (not (= (bvadd var1 n12) (bvadd var2 j)))))
  (and
  (= (and (ite (and (dynamic_property2 #x0000000000000000 var2_range_size
               n22) (dynamic_invariant n3 true true true true))
          true false) (ite (and (bvule #x0000000000000000 n22)
                           (bvule n22 var2_range_size))
                      true false)) true)
  (= n22 temp___179))))))))))))))
  (and
  (forall ((j (_ BitVec 64)))
  ...
  (=> (not (= n12 #x0000000000000000))
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 i) (bvule i n12))
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 j) (bvule j var2_range_size))
  (not (= (bvadd var1 i) (bvadd var2 j))))))))
  (and
  ...
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 j) (bvule j var2_range_size))
  (not (= (bvadd var1 i) (bvadd var2 j))))))) (= n12 temp___177))))))))))))
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 i) (bvule i var1_range_size))
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule #x0000000000000000 j) (bvule j var2_range_size))
  (not (= (bvadd var1 i) (bvadd var2 j)))))))))))))))))
  (let ((o (bvadd var1_range_size var2_range_size)))
  (let ((o1 (bvsub var2 var1_range_size)))
  (let ((o2 var1))
  (let ((o3 (inrange64 o2 o1 o)))
  (=>
  (and (inrange64__function_guard o3 o2 o1 o)
  (= (= o3 true)
  (exists ((n (_ BitVec 64)))
  (and (and (bvule #x0000000000000000 n) (bvule n o)) (= o2 (bvadd o1 n))))))
  (forall ((x86__rangesintersect__result Bool))
  (=> (= x86__rangesintersect__result o3)
  (=> (= x86__rangesintersect__result true)
  (exists ((i (_ BitVec 64)))
  (and (and (bvule #x0000000000000000 i) (bvule i var1_range_size))
  (exists ((j (_ BitVec 64)))
  (and (and (bvule #x0000000000000000 j) (bvule j var2_range_size))
