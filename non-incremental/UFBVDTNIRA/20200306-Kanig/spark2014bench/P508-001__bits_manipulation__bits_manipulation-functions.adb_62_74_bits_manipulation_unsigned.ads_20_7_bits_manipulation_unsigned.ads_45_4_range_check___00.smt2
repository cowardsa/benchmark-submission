...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 53, characters 0-0
  ...
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result (_ BitVec 64)))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result o3)
  (let ((o4 (+ (- to__ from) 1)))
  (=> (in_range1 o4)
  (let ((o5 (make_mask o4)))
  (=>
  (and (dynamic_invariant1 o5 true false true true)
  (= o5 (shift_right #xFFFFFFFFFFFFFFFF (- 64 o4))))
  (let ((o6 from))
  (let ((o7 value))
  (let ((o8 (shift_right o7 o6)))
  (=>
  (and (dynamic_invariant1 o8 true false true true)
  (= o8 (ite (and (<= 1 64) (<= 64 8))
        ((_ zero_extend 56) (ite (< o6 8)
                            (bvlshr ((_ extract 7 0) o7) ((_ int_to_bv 8) o6))
                            #x00))
        (ite (and (<= 9 64) (<= 64 16))
        ((_ zero_extend 48) (ite (< o6 16)
                            (bvlshr ((_ extract 15 0) o7) ((_ int_to_bv 16) o6))
                            #x0000))
        (ite (and (<= 17 64) (<= 64 32))
        ((_ zero_extend 32) (bvlshr ((_ extract 31 0) o7) ((_ int_to_bv 32) o6)))
        (bvlshr o7 ((_ int_to_bv 64) o6)))))))
  (=>
  (or
  (not
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result (bvand o8 o5)))
  (let ((o9 (+ (- to__ from) 1)))
  (and (in_range1 o9)
  (let ((o10 (make_mask o9)))
  (and (dynamic_invariant1 o10 true false true true)
  (= o10 (shift_right #xFFFFFFFFFFFFFFFF (- 64 o9))))))))
  (=>
  (and
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result (bvand o8 o5))
  (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result 
