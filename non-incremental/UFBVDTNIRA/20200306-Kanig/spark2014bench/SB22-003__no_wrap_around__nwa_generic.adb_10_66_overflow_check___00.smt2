...
(declare-sort nv_cpuproc_uproc_instrc_offs_field 0)

(define-fun in_range1 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x)
                                               (bvule x #x00FFFFFF)))

(define-fun in_range_int ((x Int)) Bool (and (<= 0 x) (<= x 16777215)))
...
(declare-fun user_eq (nv_cpuproc_uproc_instrc_offs_field
  nv_cpuproc_uproc_instrc_offs_field) Bool)

(declare-const dummy nv_cpuproc_uproc_instrc_offs_field)

(declare-datatypes ((nv_cpuproc_uproc_instrc_offs_field__ref 0))
(((nv_cpuproc_uproc_instrc_offs_field__refqtmk
  (nv_cpuproc_uproc_instrc_offs_field__content nv_cpuproc_uproc_instrc_offs_field)))))
(define-fun nv_cpuproc_uproc_instrc_offs_field__ref_nv_cpuproc_uproc_instrc_offs_field__content__projection ((a nv_cpuproc_uproc_instrc_offs_field__ref)) nv_cpuproc_uproc_instrc_offs_field 
  (nv_cpuproc_uproc_instrc_offs_field__content a))

(define-fun dynamic_invariant ((temp___expr_186 (_ BitVec 32))
  (temp___is_init_182 Bool) (temp___skip_constant_183 Bool)
  (temp___do_toplevel_184 Bool)
  (temp___do_typ_inv_185 Bool)) Bool (=>
                                     (or (= temp___is_init_182 true)
                                     (bvule #x00000000 #x00FFFFFF))
                                     (in_range1 temp___expr_186)))

(assert
;; defqtvc
 ;; File "nwa_generic.adb", line 3, characters 0-0
  (not
  (forall ((ucode_instr_offset_in_uproc (_ BitVec 32))
  (ucode_instr_offset_in_uproc1 (_ BitVec 32)))
  (=> (= ucode_instr_offset_in_uproc #x00000000)
  (=> (dynamic_invariant ucode_instr_offset_in_uproc true false true true)
  (=> (bvult ucode_instr_offset_in_uproc #x00FFFFFF)
  (=>
  (= (and (ite (dynamic_invariant ucode_instr_offset_in_uproc1 true true true
          true) true false) (ite (bvult ucode_instr_offset_in_uproc1 #x00FFFFFF)
                            true false)) true)
