...
(declare-datatypes ((word64_pos__ref 0))
(((word64_pos__refqtmk (word64_pos__content word64_pos)))))
(define-fun word64_pos__ref_word64_pos__content__projection ((a word64_pos__ref)) word64_pos 
...
;; bit_test__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant value true true true true) (dynamic_invariant1
...
;; defqtvc
 ;; File "bitset.ads", line 26, characters 0-0
  (not
  (forall ((mask (_ BitVec 64)) (o (_ BitVec 64)) (mask1 (_ BitVec 64))
  (bitset__bit_clear__result (_ BitVec 64)))
  (=> (dynamic_invariant value true false true true)
  (=> (dynamic_invariant1 pos true false true true)
  (=> (dynamic_invariant mask false false true true)
  (=>
  (let ((temp___182 (ubv_to_int pos)))
  (ite (< temp___182 18446744073709551616)
  (= o (bvshl #x0000000000000001 ((_ int_to_bv 64) temp___182)))
  (= o #x0000000000000000)))
  (=> (= mask1 (bvnot o))
  (=> (= bitset__bit_clear__result (bvand value mask1))
  (=>
  (forall ((bitset__bit_clear__result1 (_ BitVec 64)))
  (bit_test__function_guard (bit_test bitset__bit_clear__result1 pos)
