...
;; lemma7__def_axiom
  ...
  (! (= (= (lemma7 us_void_param) true)
     ...
     (=>
     (and (bvule #x0000000000000000 value) (bvule value #xFFFFFFFFFFFFFFFF))
     (forall ((n Int))
     (=> (and (<= 0 n) (<= n 63))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 216, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__lemmas__shift_right__lemma7__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__lemmas__shift_right__lemma7__result true)
  (= (lemma7 Tuple0) true))))))
(check-sat)
(exit)
