...
(define-fun m__ref_m__content__projection ((a1 m__ref)) m (m__content a1))
...
;; n'axiom
  (assert (forall ((i n)) (and (<= 0 (nqtint i)) (<= (nqtint i) 32))))
...
(define-fun n__ref_n__content__projection ((a1 n__ref)) n (n__content a1))
...
(define-fun dynamic_invariant2 ((temp___expr_165 Int)
  ...
  (temp___do_typ_inv_164 Bool)) Bool (=>
                                     ...
                                     (<= 0 32)) (in_range2 temp___expr_165)))

(declare-sort s 0)

(define-fun in_range3 ((x1 (_ BitVec 8))) Bool (and (bvule #x00 x1)
                                               (bvule x1 #x0F)))
...
(define-fun s__ref_s__content__projection ((a1 s__ref)) s (s__content a1))
...
(define-fun dynamic_invariant3 ((temp___expr_172 (_ BitVec 8))
  ...
  (temp___do_typ_inv_171 Bool)) Bool (=>
                                     ...
                                     (bvule #x00 #x0F)) (in_range3
                                     temp___expr_172)))

;; u__def_axiom
  (assert (= u ((_ int_to_bv 8) x)))

;; v__def_axiom
  (assert (= v ((_ int_to_bv 8) y)))

;; w__def_axiom
  (assert (= w (ubv_to_int (bvurem (bvsub u v) #x10))))

;; xs__def_axiom
  (assert (= xs (bvurem (bvsub u v) #x10)))
...
;; zs__def_axiom
  (assert (= zs (ubv_to_int (bvurem (bvsub a b) #x10))))
...
;; defqtvc
 ;; File "p.adb", line 1, characters 0-0
  ...
  (=> (= (ubv_to_int (bvurem (bvsub u v) #x10)) w)
  (=> (dynamic_invariant2 w true false true true)
  (let ((o2 (bvurem (bvsub u v) #x10)))
  (=> (in_range3 o2)
  (=> (= o2 xs)
  (=> (dynamic_invariant3 xs true false true true)
  (let ((o3 u))
  (=> (in_range3 o3)
  (=> (= o3 a)
  (=> (dynamic_invariant3 a true false true true) (in_range3 v)))))))))))))))))))))))
(check-sat)
(exit)
