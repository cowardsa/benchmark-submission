...
(((key_type__refqtmk (key_type__content us_rep1)))))
...
(define-fun dynamic_invariant1 ((temp___expr_276 Int)
...
(define-fun dynamic_invariant2 ((temp___expr_255 Int)
  ...
  (temp___do_typ_inv_254 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range4 temp___expr_255)))
...
(define-fun dynamic_invariant4 ((temp___expr_269 Int)
  ...
  (temp___do_typ_inv_268 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range5 temp___expr_269)))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant4 key1 true true true true)
     ...
     (= (my_eq key1 (get1 container result)) true)))) (dynamic_invariant
...
(define-fun dynamic_invariant5 ((temp___expr_316 Int)
  ...
  (temp___do_typ_inv_315 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range6 temp___expr_316)))
...
(define-fun dynamic_invariant6 ((temp___expr_323 Int)
  ...
  (temp___do_typ_inv_322 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range8 temp___expr_323)))
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant6 result true false true true)))) :pattern ((get
                                                                   container
                                                                   key1)) ))))
...
(define-fun dynamic_invariant7 ((temp___expr_375 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_368 Int)
  ...
  (temp___do_typ_inv_367 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range9 temp___expr_368)))
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant8 (get1 container position) true false true true)) :pattern (
...
(define-fun dynamic_invariant9 ((temp___expr_400 Int)
...
;; defqtvc
 ;; File "p.ads", line 21, characters 0-0
  ...
  (=> (dynamic_invariant2 k true false true true)
  (=>
  (< (length
     (us_repqtmk l__split_discrs (us_split_fieldsqtmk l__split_fields))) 
  (to_rep1 (rec__p__my_maps__map__capacity l__split_discrs)))
  (=>
  (not
  (= (contains
     (us_repqtmk l__split_discrs (us_split_fieldsqtmk l__split_fields)) 
  ...
  (= (key (us_repqtmk o1 (us_split_fieldsqtmk l__split_fields1))
     (find (us_repqtmk o1 (us_split_fieldsqtmk l__split_fields1)) o)) o))
  ...
  (= (mapping_preserved
     ...
     (positions (us_repqtmk o1 (us_split_fieldsqtmk l__split_fields1)))) true))
  (= (keys_included_except1
     (positions (us_repqtmk o1 (us_split_fieldsqtmk l__split_fields1)))
     (positions (us_repqtmk o1 (us_split_fieldsqtmk l__split_fields)))
     (find (us_repqtmk o1 (us_split_fieldsqtmk l__split_fields1)) o)) true))
  (let ((o2 k))
  ...
  (and
  (and
  (= (length (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields2))) (- 
  (length (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields1))) 1))
  (not
  (= (contains (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields2)) o2) true)))
  (= (ole (model1 (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields2)))
     (model1 (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields1)))) true))
  (= (keys_included_except
     (model1 (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields1)))
     (model1 (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields2))) o2) true))
  (= (mapping_preserved
     (keys (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields2)))
     (keys (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields1)))
     (positions (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields2)))
     (positions (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields1)))) true))
  (= (keys_included_except1
     (positions (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields1)))
     (positions (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields2)))
     (find (us_repqtmk o3 (us_split_fieldsqtmk l__split_fields1)) o2)) true))
  (let ((temp___826 (us_repqtmk l__split_discrs
                    (us_split_fieldsqtmk l__split_fields2))))
  (forall ((usf1 count_type))
  (let ((usf2 (us_repqtmk1 (us_split_fieldsqtmk1 usf1))))
  (let ((o4 (has_element temp___826 usf2)))
  (=> (= (= o4 true) (= (has_key (positions temp___826) usf2) true))
  (=> (= (and (ite true true false) o4) true)
  (let ((o5 (element usf usf2)))
  (=>
  (and (dynamic_invariant1 o5 true false true true)
  (= o5 (get (model1 usf) (key usf usf2))))
  (= (has_element
