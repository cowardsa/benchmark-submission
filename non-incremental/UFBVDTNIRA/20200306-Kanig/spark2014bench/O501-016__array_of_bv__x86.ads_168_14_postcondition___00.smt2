...
(assert
;; defqtvc
 ;; File "x86.ads", line 166, characters 0-0
  (not
  ...
  (=>
  (= rbx2 (bvor (bvand rbx #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__)))
  (= rbx2 (bvor (bvand rbx1 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__))))))))))
(check-sat)
(exit)
