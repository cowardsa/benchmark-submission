...
(declare-const scale_num (_ BitVec 32))

(declare-const attr__ATTRIBUTE_ADDRESS1 Int)

(declare-const scale_denom (_ BitVec 32))
...
;; defqtvc
 ;; File "spark-mod_arithmetic_lemmas.ads", line 102, characters 0-0
  ...
  (= o (ite (= scale_num #x00000000) true
       (ite (bvule val__ (bvudiv #xFFFFFFFF scale_num)) true false)))
  (= o false)) (=> (= o true) (not (= scale_denom #x00000000)))))))))))
(check-sat)
(exit)
