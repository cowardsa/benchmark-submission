...
(assert
;; defqtvc
 ;; File "x86.ads", line 162, characters 0-0
  (not
  (forall ((rbx (_ BitVec 64)))
  (=> (dynamic_invariant rbx true false true true)
  (forall ((x86__bl__result (_ BitVec 8)))
  (=> (= x86__bl__result ((_ extract 7 0) (bvand rbx #x00000000000000FF)))
  (bvule ((_ zero_extend 56) #x00) (bvand rbx #x00000000000000FF))))))))
(check-sat)
(exit)
