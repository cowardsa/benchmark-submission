...
;; msb_index_fast_inline_always__post_axiom
  (assert
  (forall ((value (_ BitVec 64))) (! (in_range1
...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 109, characters 0-0
  ...
  (= (shift_right o o1) #x0000000000000001))
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result Int))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result o1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_not_inline__result) #x0000000000000001))))))))))
(check-sat)
(exit)
