...
(assert
;; defqtvc
 ;; File "x86.ads", line 339, characters 0-0
  (not
  (forall ((r11 (_ BitVec 64)))
  (=> (dynamic_invariant r11 true false true true)
  (forall ((x86__r11l__result (_ BitVec 8)))
  (=> (= x86__r11l__result ((_ extract 7 0) (bvand r11 #x00000000000000FF)))
  (bvule ((_ zero_extend 56) #x00) (bvand r11 #x00000000000000FF))))))))
(check-sat)
(exit)
