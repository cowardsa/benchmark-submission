...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 93, characters 0-0
  (not
  (forall ((usf (_ BitVec 64)) (usf1 Int) (o Bool) (usf2 Int))
  (=>
  (= (and (ite (bvule #x0000000000000000 usf) true false) (ite (bvule usf #xFFFFFFFFFFFFFFFF)
                                                          true false)) true)
  (=> (not (= usf #x0000000000000000))
  (=>
  (= (and (ite (<= 0 usf1) true false) (ite (<= usf1 63) true false)) true)
  (=>
  (let ((o1 (shift_right usf usf1)))
  (and
  (and (dynamic_invariant1 o1 true false true true)
  (= o1 (ite (and (<= 1 64) (<= 64 8))
        ((_ zero_extend 56) (ite (< usf1 8)
                            (bvlshr ((_ extract 7 0) usf) ((_ int_to_bv 8) usf1))
                            #x00))
        (ite (and (<= 9 64) (<= 64 16))
        ((_ zero_extend 48) (ite (< usf1 16)
                            (bvlshr ((_ extract 15 0) usf) ((_ int_to_bv 16) usf1))
                            #x0000))
        (ite (and (<= 17 64) (<= 64 32))
        ((_ zero_extend 32) (bvlshr ((_ extract 31 0) usf) ((_ int_to_bv 32) usf1)))
        (bvlshr usf ((_ int_to_bv 64) usf1)))))))
  (ite (= o1 #x0000000000000001)
  (= o (ite (forall ((j Int))
            (=> (and (<= 0 j) (<= j usf1))
            (bvuge (shift_right usf j) #x0000000000000001)))
       true false))
  (= o false))))
  (=> (= o true)
  (=>
