...
;; bit_position'axiom
  ...
  (and (<= 0 (bit_positionqtint i)) (<= (bit_positionqtint i) 15))))
...
(define-fun dynamic_invariant2 ((temp___expr_421 Int)
...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 79, characters 0-0
  (not
  (forall ((new_v (_ BitVec 16)) (shift_amount Int) (result__ Int)
  (v (_ BitVec 16)) (result__1 Int)
  (bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_inline_always__result Int))
  ...
  (=>
  (ite (= (and (ite (= shift_amount 0) false true) (ite (not (= v #x0000))
                                                   true false)) true)
  (exists ((shift_amount1 Int) (result__2 Int) (v1 (_ BitVec 16))
  (new_v1 (_ BitVec 16)))
  (and
  (= (and (ite (and
               (and
               (and (dynamic_invariant1 v1 true true true true)
               (dynamic_invariant1 new_v1 false true true true))
               (dynamic_invariant2 shift_amount1 true true true true))
  ...
  (= o (ite (and (<= 1 16) (<= 16 8))
       ((_ zero_extend 8) (ite (< shift_amount1 8)
                          (bvlshr ((_ extract 7 0) v1) ((_ int_to_bv 8) shift_amount1))
                          #x00))
       (ite (and (<= 9 16) (<= 16 16))
       (ite (< shift_amount1 16) (bvlshr v1 ((_ int_to_bv 16) shift_amount1))
       #x0000)
       (ite (and (<= 17 16) (<= 16 32))
       ((_ extract 15 0) (bvlshr ((_ zero_extend 16) v1) ((_ int_to_bv 32) shift_amount1)))
       ((_ extract 15 0) (bvlshr ((_ zero_extend 48) v1) ((_ int_to_bv 64) shift_amount1))))))))
  (exists ((new_v2 (_ BitVec 16)))
  (and (= new_v2 o)
  (exists ((v2 (_ BitVec 16)))
  (and
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (not (= new_v2 #x0000)) true false))
  ...
  (not
  (= (and (ite (= shift_amount2 0) false true) (ite (not (= v2 #x0000)) true
                                               false)) true))))))))))))))
  (= result__1 result__))
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_inline_always__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_inline_always__result) #x0001)))))))))))))))
(check-sat)
(exit)
