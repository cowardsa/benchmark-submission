  ...
  (! (=>
     ...
     (= (shift_right v amount) (ite (and (<= 1 32) (<= 32 8))
                               ...
                               ((_ zero_extend 16) (ite (< amount 16)
                                                   ...
                                                   #x0000))
                               (ite (and (<= 17 32) (<= 32 32))
                               (bvlshr v ((_ int_to_bv 32) amount))
                               ((_ extract 31 0) (bvlshr ((_ zero_extend 32) v) ((_ int_to_bv 64) amount)))))))) :pattern (
  (shift_right v amount)) ))))

(declare-fun shift_left ((_ BitVec 32) Int) (_ BitVec 32))

(declare-fun shift_left__function_guard ((_ BitVec 32) (_ BitVec 32)
  Int) Bool)
...
;; shift_left__def_axiom
  ...
  (! (=>
     (and (dynamic_invariant1 v true true true true) (dynamic_invariant
     amount true true true true))
     (= (shift_left v amount) (ite (and (<= 1 32) (<= 32 8))
                              ((_ zero_extend 24) (ite (< amount 8)
                                                  (bvshl ((_ extract 7 0) v) ((_ int_to_bv 8) amount))
                                                  #x00))
                              (ite (and (<= 9 32) (<= 32 16))
                              ((_ zero_extend 16) (ite (< amount 16)
                                                  (bvshl ((_ extract 15 0) v) ((_ int_to_bv 16) amount))
                                                  #x0000))
                              (ite (and (<= 17 32) (<= 32 32))
                              (bvshl v ((_ int_to_bv 32) amount))
                              ((_ extract 31 0) (bvurem (bvshl ((_ zero_extend 32) v) ((_ int_to_bv 64) amount)) ((_ int_to_bv 64) 4294967296)))))))) :pattern (
  (shift_left v amount)) ))))
...
(define-fun dynamic_invariant3 ((temp___expr_460 Int)
  ...
  (temp___do_typ_inv_459 Bool)) Bool (=>
                                     ...
                                     (<= 0 31)) (in_range2 temp___expr_460)))
...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 23, characters 0-0
  (not
  (forall ((result__ (_ BitVec 32)))
  ...
  (let ((o1 len))
  (=> (in_range1 o1)
  (let ((bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume 
  (make_mask o1)))
  (=>
  (and (dynamic_invariant1
  bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume
  true false true true)
  (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume 
  (shift_right #xFFFFFFFF (- 32 o1))))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume 
  mask)
  (=> (dynamic_invariant1 mask true false true true)
  ...
  (= o4 (ite (and (<= 1 32) (<= 32 8))
        ((_ zero_extend 24) (ite (< o2 8)
                            (bvlshr ((_ extract 7 0) o3) ((_ int_to_bv 8) o2))
                            #x00))
        (ite (and (<= 9 32) (<= 32 16))
        ((_ zero_extend 16) (ite (< o2 16)
                            (bvlshr ((_ extract 15 0) o3) ((_ int_to_bv 16) o2))
                            #x0000))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr o3 ((_ int_to_bv 32) o2))
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) o3) ((_ int_to_bv 64) o2))))))))
  (forall ((result__1 (_ BitVec 32)))
  (=> (= result__1 (bvand o4 mask))
  (=> (bvule result__1 mask)
  (forall
  ((bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result (_ BitVec 32)))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result result__1)
  (let ((o5 (+ (- to__ from) 1)))
  (=> (in_range1 o5)
  (let ((o6 (make_mask o5)))
  (=>
  (and (dynamic_invariant1 o6 true false true true)
  (= o6 (shift_right #xFFFFFFFF (- 32 o5))))
  (let ((o7 from))
  (let ((o8 value))
  (let ((o9 (shift_right o8 o7)))
  (=>
  (and (dynamic_invariant1 o9 true false true true)
  (= o9 (ite (and (<= 1 32) (<= 32 8))
        ((_ zero_extend 24) (ite (< o7 8)
                            (bvlshr ((_ extract 7 0) o8) ((_ int_to_bv 8) o7))
                            #x00))
        (ite (and (<= 9 32) (<= 32 16))
        ((_ zero_extend 16) (ite (< o7 16)
                            (bvlshr ((_ extract 15 0) o8) ((_ int_to_bv 16) o7))
                            #x0000))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr o8 ((_ int_to_bv 32) o7))
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) o8) ((_ int_to_bv 64) o7))))))))
  (=>
  (or
  (not
  ...
  (let ((o10 (+ (- to__ from) 1)))
  (and (in_range1 o10)
  (let ((o11 (make_mask o10)))
  (and (dynamic_invariant1 o11 true false true true)
  (= o11 (shift_right #xFFFFFFFF (- 32 o10))))))))
  (=>
  (and
  (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result (bvand o9 o6))
  (bvule bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result 
