...
(assert
;; defqtvc
 ;; File "x86.ads", line 279, characters 0-0
  (not
  (forall ((rdi (_ BitVec 64)))
  (=> (dynamic_invariant rdi true false true true)
  (forall ((x86__edi__result (_ BitVec 32)))
  (=> (= x86__edi__result ((_ extract 31 0) (bvand rdi #x00000000FFFFFFFF)))
  (bvule ((_ zero_extend 32) #x00000000) (bvand rdi #x00000000FFFFFFFF))))))))
(check-sat)
(exit)
