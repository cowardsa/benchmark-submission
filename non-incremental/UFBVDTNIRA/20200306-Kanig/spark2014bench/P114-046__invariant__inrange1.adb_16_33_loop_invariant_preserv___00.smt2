...
;; defqtvc
 ;; File "inrange1.ads", line 15, characters 0-0
  (not
  (forall ((matched Bool) (i (_ BitVec 64)) (o Bool) (i1 (_ BitVec 64))
  (spark__branch Bool) (i2 (_ BitVec 64)) (o1 Bool))
  ...
  (= (and (ite (bvult i2 range_size) true false) (ite (= matched true) false
                                                 true)) true)
  (=>
  (ite (bvugt i2 #x0000000000000000)
  (= o1 (ite (exists ((n (_ BitVec 64)))
             (and
             (and (bvule #x0000000000000000 n)
  ...
  (=>
  (= (= matched true)
  (and (bvugt i2 #x0000000000000000)
  (exists ((n (_ BitVec 64)))
  (and
