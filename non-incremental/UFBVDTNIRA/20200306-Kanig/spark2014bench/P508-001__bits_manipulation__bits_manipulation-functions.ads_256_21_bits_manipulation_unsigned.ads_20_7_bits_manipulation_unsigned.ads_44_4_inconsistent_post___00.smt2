...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     ...
     (forall ((n Int))
     (=> (and (<= 0 n) (<= n 31))
     (= (shift_left v n) (bvmul v (ite (< n 4294967296)
                                  (bvshl #x00000001 ((_ int_to_bv 32) n))
                                  #x00000000)))))))) :pattern ((lemma1
                                                               us_void_param)) )))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 254, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_32__functions__lemmas__shift_left__lemma1__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__lemmas__shift_left__lemma1__result true)
  (= (lemma1 Tuple0) true))))))
(check-sat)
(exit)
