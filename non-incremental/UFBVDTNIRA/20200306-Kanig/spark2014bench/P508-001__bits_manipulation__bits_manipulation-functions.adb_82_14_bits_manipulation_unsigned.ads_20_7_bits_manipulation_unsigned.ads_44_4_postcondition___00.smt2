...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 79, characters 0-0
  (not
  (forall ((new_v (_ BitVec 32)) (shift_amount Int) (result__ Int)
  (v (_ BitVec 32)) (result__1 Int)
  (bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline_always__result Int))
  (=> (dynamic_invariant1 value true false true true)
  (=> (not (= value #x00000000))
  (=> (= shift_amount 15)
  (=> (dynamic_invariant2 shift_amount true false true true)
  (=> (= result__ 0)
  (=> (dynamic_invariant2 result__ true false true true)
  (=> (= v value)
  (=> (dynamic_invariant1 v true false true true)
  (=> (dynamic_invariant1 new_v false false true true)
  (=>
  (ite (= (and (ite (= shift_amount 0) false true) (ite (not
                                                        (= v #x00000000))
                                                   true false)) true)
  (exists ((shift_amount1 Int) (result__2 Int) (v1 (_ BitVec 32))
  (new_v1 (_ BitVec 32)))
  (and
  (= (and (ite (and
               (and
               (and (dynamic_invariant2 shift_amount1 true true true true)
               (dynamic_invariant2 result__2 true true true true))
               (dynamic_invariant1 v1 true true true true))
               (dynamic_invariant1 new_v1 false true true true))
          true false) (ite (and (not (= shift_amount1 0))
                           (not (= v1 #x00000000)))
                      true false)) true)
  (let ((o (shift_right v1 shift_amount1)))
  (and
  (and (dynamic_invariant1 o true false true true)
  (= o (ite (and (<= 1 32) (<= 32 8))
       ((_ zero_extend 24) (ite (< shift_amount1 8)
                           (bvlshr ((_ extract 7 0) v1) ((_ int_to_bv 8) shift_amount1))
                           #x00))
       (ite (and (<= 9 32) (<= 32 16))
       ((_ zero_extend 16) (ite (< shift_amount1 16)
                           (bvlshr ((_ extract 15 0) v1) ((_ int_to_bv 16) shift_amount1))
                           #x0000))
       (ite (and (<= 17 32) (<= 32 32))
       (bvlshr v1 ((_ int_to_bv 32) shift_amount1))
       ((_ extract 31 0) (bvlshr ((_ zero_extend 32) v1) ((_ int_to_bv 64) shift_amount1))))))))
  (exists ((new_v2 (_ BitVec 32)))
  (and (= new_v2 o)
  (exists ((v2 (_ BitVec 32)))
  (and
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (not (= new_v2 #x00000000)) true false))
  (ite (= spark__branch true)
  (and (in_range2 (+ result__2 shift_amount1))
  (let ((o1 (+ result__2 shift_amount1)))
  (and (in_range2 o1) (and (= result__1 o1) (= v2 new_v2)))))
  (and (= result__1 result__2) (= v2 v1)))))
  (exists ((o1 Int))
  (and (ite (= shift_amount1 1) (= o1 1) (= o1 (div1 shift_amount1 2)))
  (exists ((shift_amount2 Int))
  (and (= shift_amount2 o1)
  (not
  (= (and (ite (= shift_amount2 0) false true) (ite (not (= v2 #x00000000))
                                               true false)) true))))))))))))))
  (= result__1 result__))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline_always__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_32__functions__msb_index_fast_inline_always__result) #x00000001)))))))))))))))
(check-sat)
(exit)
