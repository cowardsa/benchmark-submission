...
(declare-fun find (us_rep1 Int) us_rep)

(declare-fun find__function_guard (us_rep us_rep1 Int) Bool)
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant1 item true true true true)
     ...
     (and
     (forall ((container1 us_rep1) (item1 Int) (result1 us_rep))
     (my_eq__function_guard (my_eq (element container1 result1) item1)
     (element container1 result1) item1))
     (ite (not (= (contains (model1 container) item) true))
     (= (bool_eq result no_element) true)
     (and
     (and (= (has_key (positions container) result) true)
     (= (get1 (positions container) result) (find1 (elements container) item)))
     (= (my_eq (element container result) item) true)))))) :pattern (
  (find container item)) ))))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant1 item true true true true)
     ...
     result true false true true)))) :pattern ((find1 container item)) ))))

(define-fun e_elements_included ((left us_rep2)
  (right us_rep2)) Bool (ite (forall ((i Int))
                             (=> (and (<= 1 i) (<= i (length2 left)))
                             (and (< 0 (find1 right (get left i)))
                             (= (get right (find1 right (get left i))) 
                             (get left i)))))
                        true false))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (my_eq (get result1 (find1 result1 item1)) item1)
     (get result1 (find1 result1 item1)) item1))
     (= (my_eq (get result (find1 result item)) item) true))))))
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i (length container)))
     (= (find1 result (get result i)) i))))
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i (length container)))
     (forall ((j Int))
...
;; defqtvc
 ;; File "p.ads", line 16, characters 0-0
  (not
  (forall ((l__split_fields us_main_type) (l__split_fields1 us_main_type))
  ...
  (let ((o2 (contains1 o1 o)))
  (and (= (= o2 true) (= (contains (model1 o1) o) true))
  (exists ((spark__branch Bool))
  (and (= spark__branch o2)
  ...
  (and
  (and
  (= (oeq1 (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields)))) true)
  (= (contains1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)) o3) true))
  (= (oeq2
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields)))) true))
  (= (element (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1))
     (find (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)) o3)) o3))
  (= (equal_except
     (elements (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields)))
     (elements (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (get1
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (find (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)) o3))) true))))
  (let ((o3 e))
  (let ((o4 l__split_discrs))
  (and
  (and
  ...
  (and
  (and
  (= (length (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1))) (+ 
  (length (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields))) 1))
  (= (contains1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)) o3) true))
  (= (element (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1))
     (find (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)) o3)) o3))
  (= (ole (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields)))
     (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))) true))
  (= (included_except
     (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (model1 (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields))) o3) true))
  (= (mapping_preserved
     (elements (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields)))
     (elements (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields1)))
     (positions (us_repqtmk1 o4 (us_split_fieldsqtmk1 l__split_fields)))
  ...
  (let ((o2 (find o1 o)))
  (=>
  (forall ((o3 Int) (o4 us_rep1) (o5 us_rep)) (my_eq__function_guard
  (my_eq (element o4 o5) o3) (element o4 o5) o3))
  (=>
  (ite (= (not (contains (model1 o1) o)) true)
  (= (bool_eq o2 no_element) true)
  (and
  (and (= (has_key (positions o1) o2) true)
  (= (get1 (positions o1) o2) (find1 (elements o1) o)))
  (= (my_eq (element o1 o2) o) true)))
  (= (has_element
