...
(assert
;; defqtvc
 ;; File "x86.ads", line 373, characters 0-0
  (not
  (forall ((r13 (_ BitVec 64)) (r131 (_ BitVec 64)) (r132 (_ BitVec 64)))
  (=> (= r131 r13)
  (=> (dynamic_invariant r13 true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= r132 (bvor (bvand r13 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__)))
  (= r132 (bvor (bvand r131 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__))))))))))
(check-sat)
(exit)
