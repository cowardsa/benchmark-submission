...
(assert
;; defqtvc
 ;; File "x86.ads", line 358, characters 0-0
  (not
  (forall ((r12 (_ BitVec 64)) (r121 (_ BitVec 64)) (r122 (_ BitVec 64)))
  (=> (= r121 r12)
  (=> (dynamic_invariant r12 true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= r122 (bvor (bvand r12 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__)))
  (= r122 (bvor (bvand r121 #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__))))))))))
(check-sat)
(exit)
