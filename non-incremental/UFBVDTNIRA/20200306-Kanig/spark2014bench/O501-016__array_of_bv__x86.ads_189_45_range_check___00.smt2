...
(assert
;; defqtvc
 ;; File "x86.ads", line 187, characters 0-0
  (not
  (forall ((rbx (_ BitVec 64)))
  (=> (dynamic_invariant rbx true false true true)
  (forall ((x86__ebx__result (_ BitVec 32)))
  (=> (= x86__ebx__result ((_ extract 31 0) (bvand rbx #x00000000FFFFFFFF)))
  (bvule ((_ zero_extend 32) #x00000000) (bvand rbx #x00000000FFFFFFFF))))))))
(check-sat)
(exit)
