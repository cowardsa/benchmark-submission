...
(declare-fun ah ((_ BitVec 64)) (_ BitVec 8))

(declare-fun ah__function_guard ((_ BitVec 8) (_ BitVec 64)) Bool)
...
;; ah__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rax true true true true)
     (let ((result (ah x86__rax)))
     (=> (ah__function_guard result x86__rax)
     (and
     (= result ((_ extract 7 0) (bvurem (bvudiv (bvand x86__rax #x000000000000FF00) #x0000000000000100) ((_ int_to_bv 64) 256))))
     (dynamic_invariant1 result true false true true))))) :pattern ((ah
                                                                    x86__rax)) )))
...
(assert
;; defqtvc
 ;; File "x86.ads", line 57, characters 0-0
  (not
  (forall ((rax (_ BitVec 64)) (rax1 (_ BitVec 64)))
  (=> (dynamic_invariant rax true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rax1 (bvor (bvand rax #xFFFFFFFFFFFF00FF) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) 
  val__) #x0100))))
  (=> (forall ((rax2 (_ BitVec 64))) (ah__function_guard (ah rax2) rax2))
  (= (ah rax1) val__))))))))
(check-sat)
(exit)
