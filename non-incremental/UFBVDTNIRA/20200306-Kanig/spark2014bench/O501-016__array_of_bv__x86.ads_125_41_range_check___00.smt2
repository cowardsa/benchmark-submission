...
(assert
;; defqtvc
 ;; File "x86.ads", line 123, characters 0-0
  (not
  (forall ((rdx (_ BitVec 64)))
  (=> (dynamic_invariant rdx true false true true)
  (forall ((x86__dl__result (_ BitVec 8)))
  (=> (= x86__dl__result ((_ extract 7 0) (bvand rdx #x00000000000000FF)))
  (bvule ((_ zero_extend 56) #x00) (bvand rdx #x00000000000000FF))))))))
(check-sat)
(exit)
