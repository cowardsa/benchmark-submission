...
;; defqtvc
 ;; File "inrange4.ads", line 15, characters 0-0
  (not
  (forall ((matched Bool) (i (_ BitVec 64)) (matched1 Bool)
  (inrange4__inrange64__result Bool))
  ...
  (and (= i1 #x0000000000000000)
  (ite (= (and (ite (bvule #x0000000000000000 i1) true false) (ite (bvule i1 temp___170)
                                                              true false)) true)
  (or
  (and
  ...
  (= matched1 matched)))))
  (=> (= inrange4__inrange64__result matched1)
  (=> (= inrange4__inrange64__result true)
