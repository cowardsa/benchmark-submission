...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 23, characters 0-0
  ...
  (let ((o1 len))
  (=> (in_range1 o1)
  (let ((bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__mask__assume 
  (make_mask o1)))
  (=>
  ...
  (= o4 (ite (and (<= 1 16) (<= 16 8))
        ((_ zero_extend 8) (ite (< o2 8)
                           (bvlshr ((_ extract 7 0) o3) ((_ int_to_bv 8) o2))
                           #x00))
        (ite (and (<= 9 16) (<= 16 16))
        (ite (< o2 16) (bvlshr o3 ((_ int_to_bv 16) o2)) #x0000)
        (ite (and (<= 17 16) (<= 16 32))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 16) o3) ((_ int_to_bv 32) o2)))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 48) o3) ((_ int_to_bv 64) o2))))))))
  (forall ((result__1 (_ BitVec 16)))
  (=> (= result__1 (bvand o4 mask))
  (=> (bvule result__1 mask)
  (forall
  ((bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result (_ BitVec 16)))
  (=>
  ...
  (= o6 (shift_right #xFFFF (- 16 o5))))
  (let ((o7 from))
  (let ((o8 value))
  (let ((o9 (shift_right o8 o7)))
  (=>
  (and (dynamic_invariant1 o9 true false true true)
  (= o9 (ite (and (<= 1 16) (<= 16 8))
        ((_ zero_extend 8) (ite (< o7 8)
                           (bvlshr ((_ extract 7 0) o8) ((_ int_to_bv 8) o7))
                           #x00))
        (ite (and (<= 9 16) (<= 16 16))
        (ite (< o7 16) (bvlshr o8 ((_ int_to_bv 16) o7)) #x0000)
        (ite (and (<= 17 16) (<= 16 32))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 16) o8) ((_ int_to_bv 32) o7)))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 48) o8) ((_ int_to_bv 64) o7))))))))
  (=>
  (or
  (not
  (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result (bvand o9 o6)))
  (let ((o10 (+ (- to__ from) 1)))
  (and (in_range1 o10)
  (let ((o11 (make_mask o10)))
  (and (dynamic_invariant1 o11 true false true true)
  (= o11 (shift_right #xFFFF (- 16 o10))))))))
  (=>
  (and
  (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result (bvand o9 o6))
  (bvule bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline_always__result 
