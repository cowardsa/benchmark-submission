...
(declare-fun al ((_ BitVec 8)) (_ BitVec 8))

(declare-fun al__function_guard ((_ BitVec 8) (_ BitVec 8)) Bool)
...
(define-fun dynamic_invariant ((temp___expr_166 (_ BitVec 8))
...
;; al__post_axiom
  ...
  (! (=> (dynamic_invariant x86__al_test true true true true)
     (let ((result (al x86__al_test)))
     (=> (al__function_guard result x86__al_test)
     (and (= result (bvand x86__al_test #xFF)) (dynamic_invariant result true
     false true true))))) :pattern ((al x86__al_test)) )))
...
;; defqtvc
 ;; File "x86.ads", line 19, characters 0-0
  (not
  (forall ((al_test (_ BitVec 8)) (al_test1 (_ BitVec 8)))
  ...
  (=> (= al_test1 (bvor (bvand al_test #x00) val__))
  (=>
