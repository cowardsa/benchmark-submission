...
;; defqtvc
 ;; File "a-cfdlli.ads", line 1403, characters 0-0
  ...
  (forall ((o2 Int))
  (=>
  (ite (= (bool_eq position no_element) true) (= o2 1)
  (let ((o3 position))
  (let ((o4 container))
  (let ((o5 (positions o4)))
  (and
  ...
  (=> (= (has_key o5 i) true)
  (and
  (let ((temp___360 (get1 o5 i)))
  (and (<= 1 temp___360) (<= temp___360 (length o4))))
  (forall ((j us_rep))
  (=> (= (has_key o5 j) true)
  ...
  (=> (= (distinct 0 0) true)
  (and (= o2 (w_get o5 (witness o5 o3)))
  (forall ((k us_rep))
  (=> (= (has_key o5 k) true)
  (= (= (bool_eq k o3) true) (= (witness o5 o3) (witness o5 k))))))))))))))
  (let ((o3 container))
  (let ((o4 (model1 o3)))
