...
(declare-fun temp_____aggregate_def_329 (map1 Int (_ BitVec 8) Int
  (_ BitVec 8) Int) map1)
...
;; def_axiom
  (assert
  (forall ((temp___331 map1))
  (forall ((temp___332 Int) (temp___334 Int) (temp___336 Int))
  (forall ((temp___333 (_ BitVec 8)) (temp___335 (_ BitVec 8)))
  (let ((temp___330 (temp_____aggregate_def_329 temp___331 temp___332
                    temp___333 temp___334 temp___335 temp___336)))
  (=>
  (and (dynamic_invariant1 temp___332 true true true true)
  (and
  (and (dynamic_invariant2 temp___333 true true true true)
  (dynamic_invariant1 temp___334 true true true true))
  (and (dynamic_invariant2 temp___335 true true true true) (dynamic_invariant
  temp___336 true true true true))))
  (forall ((temp___337 Int))
  (forall ((temp___338 (_ BitVec 8)))
  (ite (or (and (= temp___337 temp___332) (= temp___338 temp___333))
       (and (= temp___337 temp___334) (= temp___338 temp___335)))
  (= (to_rep (get temp___330 temp___337 temp___338)) temp___336)
  (= (get temp___330 temp___337 temp___338) (get temp___331 temp___337
                                            temp___338)))))))))))

(assert
;; defqtvc
 ;; File "update_logic_fn.ads", line 111, characters 0-0
  (not
  ...
  (= (bool_eq a2 1 10 #x00 #x07
     (temp_____aggregate_def_329 a_2d_arr 5 #x07 x y v1) 1 10 #x00 #x07) true)))))))))))))
(check-sat)
(exit)
