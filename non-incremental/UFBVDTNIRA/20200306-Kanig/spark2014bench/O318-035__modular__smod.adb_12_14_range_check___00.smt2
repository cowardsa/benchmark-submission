...
(define-fun to_int2 ((x1 m)) Int (ubv_to_int (to_rep x1)))
...
;; first__def_axiom
  (assert (= first ((_ int_to_bv 8) x)))

;; last__def_axiom
  (assert (= last ((_ int_to_bv 8) y)))
...
;; defqtvc
 ;; File "smod.adb", line 4, characters 0-0
  ...
  (=> (dynamic_invariant1 w false false true true) (dynamic_property_int
  (ubv_to_int first) (ubv_to_int last) v)))))))))))
(check-sat)
(exit)
