...
(define-fun dynamic_invariant ((temp___expr_492 (_ BitVec 64))
...
(define-fun dynamic_invariant1 ((temp___expr_506 Int)
...
(declare-sort t733s 0)

(declare-fun t733sqtint (t733s) Int)

;; t733s'axiom
  (assert
  (forall ((i t733s)) (and (<= 2 (t733sqtint i)) (<= (t733sqtint i) 63))))
...
(declare-fun user_eq2 (t733s t733s) Bool)

(declare-const dummy2 t733s)

(declare-datatypes ((t733s__ref 0))
(((t733s__refqtmk (t733s__content t733s)))))
(define-fun t733s__ref_t733s__content__projection ((a t733s__ref)) t733s 
  (t733s__content a))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 302, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result Bool))
  (=> (= (lemma8 Tuple0) true)
  (=> (= (make_mask 1) #x0000000000000001)
  (=>
  (exists ((i Int))
  (and (= i 2)
  (or
  (not (= (and (ite (<= 2 i) true false) (ite (<= i 63) true false)) true))
  (and
  ...
  (= (make_mask j) (bvsub (ite (< j 18446744073709551616)
                          (bvshl #x0000000000000001 ((_ int_to_bv 64) j))
                          #x0000000000000000) #x0000000000000001))))
  (and
  (= (and (ite (in_range2 i1) true false) (ite (and (<= 2 i1) (<= i1 63))
                                          true false)) true)
  (= i1 63))))))))
  (=>
  (forall ((size Int))
  ...
  (= (make_mask size) (bvsub (ite (< size 18446744073709551616)
                             ...
                             #x0000000000000000) #x0000000000000001))))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result 
  (lemma2_goal Tuple0))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma2__result true)
  (= (lemma2 Tuple0) true))))))))))
(check-sat)
(exit)
