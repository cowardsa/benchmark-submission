...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 179, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_right__lemma4__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_right__lemma4__result true)
  (= (lemma4 Tuple0) true))))))
(check-sat)
(exit)
