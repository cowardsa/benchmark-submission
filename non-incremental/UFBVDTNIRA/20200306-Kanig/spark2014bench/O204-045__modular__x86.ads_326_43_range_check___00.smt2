...
(assert
;; defqtvc
 ;; File "x86.ads", line 324, characters 0-0
  (not
  (forall ((r10 (_ BitVec 64)))
  (=> (dynamic_invariant r10 true false true true)
  (forall ((x86__r10l__result (_ BitVec 8)))
  (=> (= x86__r10l__result ((_ extract 7 0) (bvand r10 #x00000000000000FF)))
  (bvule ((_ zero_extend 56) #x00) (bvand r10 #x00000000000000FF))))))))
(check-sat)
(exit)
