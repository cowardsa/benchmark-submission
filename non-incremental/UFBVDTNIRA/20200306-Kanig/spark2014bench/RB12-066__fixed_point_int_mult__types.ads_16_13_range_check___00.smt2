...
(define-fun in_range_int ((x1 Int)) Bool (and (<= 0 x1) (<= x1 100)))
...
(declare-fun user_eq2 (m2 m2) Bool)

(declare-const dummy2 m2)

(declare-datatypes ((m2__ref 0))
(((m2__refqtmk (m2__content m2)))))
(define-fun m2__ref_m2__content__projection ((a m2__ref)) m2 (m2__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_170 (_ BitVec 8))
...
;; defqtvc
 ;; File "types.ads", line 15, characters 0-0
  ...
  (=> (<= y 3200)
  (let ((o (fxp_mult x y)))
  (=> (in_range_int o) (in_range2 ((_ int_to_bv 8) o))))))))))
(check-sat)
(exit)
