...
;; shift_right__post_axiom
  ...
  (! (=>
     ...
     (= result (bvudiv value (ite (< amount 4294967296)
                             (bvshl #x00000001 ((_ int_to_bv 32) amount))
                             #x00000000)))
...
;; defqtvc
 ;; File "p.ads", line 9, characters 0-0
  (not
  (forall ((a (_ BitVec 32)) (a1 (_ BitVec 32)))
  (=> (= a1 a)
  (=> (dynamic_invariant1 a true false true true)
  (let ((o (shift_right a 2)))
  (=>
  (and (shift_right__function_guard o a 2)
  (and (dynamic_invariant1 o true false true true)
  (= o (bvudiv a (ite (< 2 4294967296) (bvshl #x00000001 ((_ int_to_bv 32) 2))
                 #x00000000)))))
  (forall ((a2 (_ BitVec 32))) (=> (= a2 o) (= a2 (bvudiv a1 #x00000004)))))))))))
(check-sat)
(exit)
