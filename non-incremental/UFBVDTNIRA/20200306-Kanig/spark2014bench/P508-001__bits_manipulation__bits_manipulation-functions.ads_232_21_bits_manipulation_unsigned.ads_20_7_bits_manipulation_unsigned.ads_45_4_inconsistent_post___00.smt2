...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 230, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__lemmas__shift_right__lemma8__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__lemmas__shift_right__lemma8__result true)
  (= (lemma8 Tuple0) true))))))
(check-sat)
(exit)
