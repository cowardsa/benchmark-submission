...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     (forall ((size Int))
     (=> (and (<= 1 size) (<= size 63))
     (bvult (make_mask size) (ite (< size 18446744073709551616)
                             (bvshl #x0000000000000001 ((_ int_to_bv 64) size))
                             #x0000000000000000))))) :pattern ((lemma1
                                                               us_void_param)) )))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 299, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma1__result Bool))
  (=> (= (lemma8 Tuple0) true)
  (=>
  (forall ((size Int))
  (=> (and (<= 1 size) (<= size 63))
  (bvult (make_mask size) (ite (< size 18446744073709551616)
                          ...
                          #x0000000000000000))))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma1__result 
  (lemma1_goal Tuple0))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__proofs__make_mask__lemma1__result true)
  (= (lemma1 Tuple0) true))))))))
(check-sat)
(exit)
