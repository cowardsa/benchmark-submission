...
(assert
;; defqtvc
 ;; File "x86.ads", line 271, characters 0-0
  (not
  (forall ((rdi (_ BitVec 64)))
  (=> (dynamic_invariant rdi true false true true)
  (forall ((x86__di__result (_ BitVec 16)))
  (=> (= x86__di__result ((_ extract 15 0) (bvand rdi #x000000000000FFFF)))
  (bvule ((_ zero_extend 48) #x0000) (bvand rdi #x000000000000FFFF))))))))
(check-sat)
(exit)
