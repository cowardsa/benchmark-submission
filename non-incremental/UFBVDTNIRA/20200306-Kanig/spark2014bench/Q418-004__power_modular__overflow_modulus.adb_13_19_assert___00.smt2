...
;; defqtvc
 ;; File "overflow_modulus.adb", line 1, characters 0-0
  (not
  (forall ((x (_ BitVec 8)) (y (_ BitVec 8)) (o (_ BitVec 8))
  (x1 (_ BitVec 8)))
  ...
  (and
  (and (id__function_guard temp___190 257)
  (and (dynamic_invariant temp___190 true false true true)
  (= temp___190 257)))
  (ite (< temp___190 256) (= o (bvshl #x01 ((_ int_to_bv 8) temp___190)))
  (= o #x00))))
  (=> (= x1 o)
  (=> (= x1 #x00)
  (let ((temp___191 (id 3)))
  (=>
  (and (id__function_guard temp___191 3)
  (and (dynamic_invariant temp___191 true false true true) (= temp___191 3)))
  (forall ((o1 (_ BitVec 8)))
  (=>
  (ite (< temp___191 256) (= o1 (bvshl #x01 ((_ int_to_bv 8) temp___191)))
  (= o1 #x00))
  (forall ((y1 (_ BitVec 8))) (=> (= y1 (bvurem o1 #x08)) (= y1 #x00)))))))))))))))
(check-sat)
(exit)
