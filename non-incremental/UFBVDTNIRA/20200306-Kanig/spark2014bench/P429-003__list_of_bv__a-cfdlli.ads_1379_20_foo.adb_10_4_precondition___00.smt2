...
(define-fun dynamic_invariant ((temp___expr_306 Int)
...
(((us_split_fieldsqtmk1 (rec__foo__lists__list us_main_type1)))))
(define-fun us_split_fields_rec__foo__lists__list__projection ((a us_split_fields2)) us_main_type1 
...
(define-fun in_range3 ((rec__foo__lists__list__capacity1 Int)
...
(define-fun default_initial_assumption2 ((temp___expr_257 us_rep)
...
(declare-fun get1 (us_rep3 Int) (_ BitVec 8))

(declare-fun get__function_guard1 ((_ BitVec 8) us_rep3 Int) Bool)
...
(define-fun default_initial_assumption3 ((temp___expr_292 us_rep3)
  (temp___skip_top_level_293 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_293 true))
                                         (= (length3 temp___expr_292) 0)))
...
;; defqtvc
 ;; File "a-cfdlli.ads", line 1373, characters 0-0
  ...
  (=> (= (has_key o1 i) true)
  (and
  (let ((temp___360 (get o1 i)))
  (and (<= 1 temp___360) (<= temp___360 (length2 o))))
  (forall ((j us_rep))
  (=> (= (has_key o1 j) true)
