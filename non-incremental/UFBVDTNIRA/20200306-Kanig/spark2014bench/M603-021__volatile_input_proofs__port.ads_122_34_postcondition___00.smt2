...
;; defqtvc
 ;; File "port.ads", line 119, characters 0-0
  (not
  (forall ((veraw (_ BitVec 8)) (x Int) (t Int) (tmp (_ BitVec 8))
  (veraw1 (_ BitVec 8)) (tmp1 (_ BitVec 8)))
  (=> (dynamic_invariant3 veraw true false true true)
  (=> (dynamic_invariant2 x false false true true)
  (=> (dynamic_invariant2 t false false true true)
  (=> (dynamic_invariant3 tmp false false true true)
  (=> (dynamic_invariant3 veraw1 true true true true)
  (=> (= tmp1 veraw1)
  (let ((o (c3 tmp1)))
  (=>
