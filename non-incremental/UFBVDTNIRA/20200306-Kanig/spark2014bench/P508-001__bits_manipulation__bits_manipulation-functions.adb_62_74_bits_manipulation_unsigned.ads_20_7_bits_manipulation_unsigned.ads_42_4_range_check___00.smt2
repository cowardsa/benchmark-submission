...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 53, characters 0-0
  ...
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result (_ BitVec 8)))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result o3)
  (let ((o4 (+ (- to__ from) 1)))
  (=> (in_range1 o4)
  (let ((o5 (make_mask o4)))
  (=>
  (and (dynamic_invariant1 o5 true false true true)
  (= o5 (shift_right #xFF (- 8 o4))))
  (let ((o6 from))
  (let ((o7 value))
  ...
  (= o8 (ite (and (<= 1 8) (<= 8 8))
        (ite (< o6 8) (bvlshr o7 ((_ int_to_bv 8) o6)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< o6 16)
                         (bvlshr ((_ zero_extend 8) o7) ((_ int_to_bv 16) o6))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o7) ((_ int_to_bv 32) o6)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o7) ((_ int_to_bv 64) o6))))))))
  (=>
  (or
  (not
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result (bvand o8 o5)))
  (let ((o9 (+ (- to__ from) 1)))
  (and (in_range1 o9)
  (let ((o10 (make_mask o9)))
  (and (dynamic_invariant1 o10 true false true true)
  (= o10 (shift_right #xFF (- 8 o9))))))))
  (=>
  (and
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result (bvand o8 o5))
  (bvule bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result 
