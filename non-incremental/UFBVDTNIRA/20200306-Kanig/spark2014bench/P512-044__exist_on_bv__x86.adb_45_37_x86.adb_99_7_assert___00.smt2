...
;; defqtvc
 ;; File "x86.ads", line 19, characters 0-0
  ...
  (=>
  (= spark__branch1 (ite (= var1 (bvadd (bvsub var2 var1_range_size) n)) true
                    false))
  (=> (= spark__branch1 true)
  (=> (dynamic_invariant n1 false false true true)
  (=> (dynamic_invariant n2 false false true true)
  (forall ((spark__branch2 Bool) (n11 (_ BitVec 64)) (n21 (_ BitVec 64)))
  (=>
  ...
  (and (= spark__branch2 (ite (bvult n var2_range_size) true false))
  (ite (= spark__branch2 true) (and (= n11 var1_range_size) (= n21 n))
