...
(assert
;; defqtvc
 ;; File "x86.ads", line 283, characters 0-0
  (not
  ...
  (=>
  (= rdi2 (bvor (bvand rdi #xFFFFFFFF00000000) ((_ zero_extend 32) val__)))
  (= rdi2 (bvor (bvand rdi1 #xFFFFFFFF00000000) ((_ zero_extend 32) val__))))))))))
(check-sat)
(exit)
