...
(assert
;; defqtvc
 ;; File "x86.ads", line 49, characters 0-0
  (not
  ...
  (=>
  (= rax1 (bvor (bvand rax #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) val__)))
  (=> (forall ((rax2 (_ BitVec 64))) (al__function_guard (al rax2) rax2))
  (= (al rax1) val__))))))))
(check-sat)
(exit)
