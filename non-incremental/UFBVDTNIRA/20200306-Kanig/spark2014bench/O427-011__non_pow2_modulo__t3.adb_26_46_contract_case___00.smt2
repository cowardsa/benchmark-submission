...
(define-fun in_range1 ((x1 (_ BitVec 64))) Bool (and
...
(define-fun dynamic_invariant ((temp___expr_190 (_ BitVec 64))
  ...
  (temp___do_typ_inv_189 Bool)) Bool (=>
                                     ...
                                     (in_range1 temp___expr_190)))

(assert
;; defqtvc
 ;; File "t3.adb", line 22, characters 0-0
  (not
  ...
  (ite (bvult x y) (= o (bvadd temp___208 #x00000000000000E6))
  (= o temp___208)))
  (forall ((t3__msub__result (_ BitVec 64)))
  (=> (= t3__msub__result o)
  (=>
  (=> (= (and (= x #x0000000000000000) (= y #x0000000000000000)) true)
  (= t3__msub__result #x0000000000000000))
  (=>
  ...
  (=> (= (and (= x #x0000000000000002) (= y #x0000000000000004)) true)
  (= t3__msub__result #x00000000000000E4)))))))))))))
(check-sat)
(exit)
