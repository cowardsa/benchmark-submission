...
(define-fun in_range_int ((x1 Int)) Bool (and (<= 0 x1) (<= x1 99)))
...
(declare-fun user_eq1 (m3 m3) Bool)

(declare-const dummy1 m3)

(declare-datatypes ((m3__ref 0))
(((m3__refqtmk (m3__content m3)))))
(define-fun m3__ref_m3__content__projection ((a m3__ref)) m3 (m3__content a))
