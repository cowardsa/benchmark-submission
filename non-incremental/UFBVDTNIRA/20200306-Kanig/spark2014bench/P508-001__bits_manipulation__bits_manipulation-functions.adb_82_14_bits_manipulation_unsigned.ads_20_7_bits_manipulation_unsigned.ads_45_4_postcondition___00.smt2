...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 79, characters 0-0
  (not
  (forall ((new_v (_ BitVec 64)) (shift_amount Int) (result__ Int)
  (v (_ BitVec 64)) (result__1 Int)
  (bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline_always__result Int))
  (=> (dynamic_invariant1 value true false true true)
  (=> (not (= value #x0000000000000000))
  (=> (= shift_amount 31)
  ...
  (ite (= (and (ite (= shift_amount 0) false true) (ite (not
                                                        (= v #x0000000000000000))
                                                   true false)) true)
  (exists ((shift_amount1 Int) (result__2 Int) (v1 (_ BitVec 64))
  (new_v1 (_ BitVec 64)))
  (and
  (= (and (ite (and
               (and
          ...
          true false) (ite (and (not (= shift_amount1 0))
                           (not (= v1 #x0000000000000000)))
                      true false)) true)
  (let ((o (shift_right v1 shift_amount1)))
  (and
  (and (dynamic_invariant1 o true false true true)
  (= o (ite (and (<= 1 64) (<= 64 8))
       ((_ zero_extend 56) (ite (< shift_amount1 8)
                           (bvlshr ((_ extract 7 0) v1) ((_ int_to_bv 8) shift_amount1))
                           #x00))
       (ite (and (<= 9 64) (<= 64 16))
       ((_ zero_extend 48) (ite (< shift_amount1 16)
                           (bvlshr ((_ extract 15 0) v1) ((_ int_to_bv 16) shift_amount1))
                           #x0000))
       (ite (and (<= 17 64) (<= 64 32))
       ((_ zero_extend 32) (bvlshr ((_ extract 31 0) v1) ((_ int_to_bv 32) shift_amount1)))
       (bvlshr v1 ((_ int_to_bv 64) shift_amount1)))))))
  (exists ((new_v2 (_ BitVec 64)))
  (and (= new_v2 o)
  (exists ((v2 (_ BitVec 64)))
  (and
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (not (= new_v2 #x0000000000000000)) true false))
  ...
  (not
  (= (and (ite (= shift_amount2 0) false true) (ite (not
                                                    (= v2 #x0000000000000000))
                                               true false)) true))))))))))))))
  (= result__1 result__))
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline_always__result result__1)
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline_always__result) #x0000000000000001)))))))))))))))
(check-sat)
(exit)
