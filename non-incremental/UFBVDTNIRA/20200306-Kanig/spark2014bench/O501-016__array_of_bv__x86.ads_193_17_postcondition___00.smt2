...
;; ebx__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rbx true true true true)
     ...
     (and (= result ((_ extract 31 0) (bvand x86__rbx #x00000000FFFFFFFF)))
     (dynamic_invariant1 result true false true true))))) :pattern ((ebx
                                                                    x86__rbx)) )))
...
(assert
;; defqtvc
 ;; File "x86.ads", line 191, characters 0-0
  (not
  ...
  (=>
  (= rbx1 (bvor (bvand rbx #xFFFFFFFF00000000) ((_ zero_extend 32) val__)))
  (=> (forall ((rbx2 (_ BitVec 64))) (ebx__function_guard (ebx rbx2) rbx2))
  (= (ebx rbx1) val__))))))))
(check-sat)
(exit)
