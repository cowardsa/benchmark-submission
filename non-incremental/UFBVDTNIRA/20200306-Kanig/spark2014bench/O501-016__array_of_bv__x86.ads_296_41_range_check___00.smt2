...
;; defqtvc
 ;; File "x86.ads", line 294, characters 0-0
  (not
  (forall ((r8 (_ BitVec 64)))
  (=> (dynamic_invariant r8 true false true true)
  (forall ((x86__r8l__result (_ BitVec 8)))
  (=> (= x86__r8l__result ((_ extract 7 0) (bvand r8 #x00000000000000FF)))
  (bvule ((_ zero_extend 56) #x00) (bvand r8 #x00000000000000FF))))))))
(check-sat)
(exit)
