...
(assert
;; defqtvc
 ;; File "x86.ads", line 179, characters 0-0
  (not
  (forall ((rbx (_ BitVec 64)))
  (=> (dynamic_invariant rbx true false true true)
  (forall ((x86__bx__result (_ BitVec 16)))
  (=> (= x86__bx__result ((_ extract 15 0) (bvand rbx #x000000000000FFFF)))
  (bvule ((_ zero_extend 48) #x0000) (bvand rbx #x000000000000FFFF))))))))
(check-sat)
(exit)
