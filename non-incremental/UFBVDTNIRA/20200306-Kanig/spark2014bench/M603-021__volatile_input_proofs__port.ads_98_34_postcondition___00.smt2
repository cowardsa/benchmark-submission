...
(declare-fun c2 ((_ BitVec 8)) Bool)

(declare-fun c2__function_guard (Bool (_ BitVec 8)) Bool)
...
;; defqtvc
 ;; File "port.ads", line 95, characters 0-0
  (not
  (forall ((vbraw (_ BitVec 8)) (tmp (_ BitVec 8)) (vbraw1 (_ BitVec 8))
  (tmp1 (_ BitVec 8)))
  (=> (dynamic_invariant1 vbraw true false true true)
  (=> (dynamic_invariant1 tmp false false true true)
  (=> (dynamic_invariant1 vbraw1 true true true true)
  (=> (= tmp1 vbraw1)
  (let ((o (c2 tmp1)))
