...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 149, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_64__functions__lemmas__shift_right__lemma2__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_64__functions__lemmas__shift_right__lemma2__result true)
  (= (lemma1 Tuple0) true))))))
(check-sat)
(exit)
