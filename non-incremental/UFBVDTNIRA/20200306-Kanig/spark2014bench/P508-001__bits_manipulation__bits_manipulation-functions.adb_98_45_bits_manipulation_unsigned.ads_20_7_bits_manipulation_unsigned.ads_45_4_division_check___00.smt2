...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 79, characters 0-0
  ...
  (v (_ BitVec 64)) (shift_amount1 Int) (result__1 Int) (v1 (_ BitVec 64))
  (new_v1 (_ BitVec 64)))
  ...
  (=>
  (= (and (ite (= shift_amount 0) false true) (ite (not
                                                   (= v #x0000000000000000))
                                              true false)) true)
  (=>
  (= (and (ite (and
  ...
  (forall ((new_v2 (_ BitVec 64)))
  (=> (= new_v2 o)
  (forall ((result__2 Int) (v2 (_ BitVec 64)))
  (=>
