...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 202, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_32__functions__lemmas__shift_right__lemma6__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__lemmas__shift_right__lemma6__result true)
  (= (lemma6 Tuple0) true))))))
(check-sat)
(exit)
