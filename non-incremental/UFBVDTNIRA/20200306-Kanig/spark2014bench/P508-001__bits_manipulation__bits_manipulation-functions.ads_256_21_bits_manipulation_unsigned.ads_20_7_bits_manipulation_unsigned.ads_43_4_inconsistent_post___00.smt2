...
(declare-fun lemma1__function_guard (Bool tuple0) Bool)
...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     ...
     (forall ((n Int))
     (=> (and (<= 0 n) (<= n 15))
     (= (shift_left v n) (bvmul v (ite (< n 65536)
                                  (bvshl #x0001 ((_ int_to_bv 16) n)) #x0000)))))))) :pattern (
  (lemma1 us_void_param)) )))

(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 254, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_16__functions__lemmas__shift_left__lemma1__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__lemmas__shift_left__lemma1__result true)
  (= (lemma1 Tuple0) true))))))
(check-sat)
(exit)
