...
;; defqtvc
 ;; File "abs_controller_supplier_with_property.ads", line 19, characters 0-0
  ...
  (at_rest_switch_out1 Int) (sum_1_out1_sat Int) (at_rest_switch_out11 Int))
  ...
  (and (= spark__branch (ite (bvugt vehicle_speed #x00000000) true false))
  (ite (= spark__branch true)
  (let ((o (ubv_to_int (bvmul #x00000008 vehicle_speed))))
  (and (in_range2 o)
  (let ((o1 (ubv_to_int (bvmul #x0000000A wheel_speed))))
  (and (in_range2 o1)
  (let ((o2 (- o1 o)))
  (and (in_range1 o2)
  (exists ((sum_out11 Int))
  (and (= sum_out11 o2)
  (let ((o3 (ite (< sum_out11 0) true false)))
  (let ((o4 (boolean_to_integer_8 o3)))
  (and
  (and (boolean_to_integer_8__function_guard o4 o3) (dynamic_invariant o4
  true false true true))
  (let ((o5 (ite (< 0 sum_out11) true false)))
  (let ((o6 (boolean_to_integer_8 o5)))
  (and
  (and (boolean_to_integer_8__function_guard o6 o5) (dynamic_invariant o6
  true false true true))
  (let ((o7 (- o6 o4)))
  (and (in_range3 o7)
  (exists ((sum_1_out1_sat1 Int))
  (and (= sum_1_out1_sat1 o7)
  (exists ((sum_1_out11 Int))
  (and
  (exists ((spark__branch1 Bool))
  (and (= spark__branch1 (ite (< 127 sum_1_out1_sat1) true false))
  (ite (= spark__branch1 true) (= sum_1_out11 127)
  (exists ((spark__branch2 Bool))
  (and (= spark__branch2 (ite (< sum_1_out1_sat1 (- 128)) true false))
  (ite (= spark__branch2 true) (= sum_1_out11 (- 128))
  (and (in_range sum_1_out1_sat1) (= sum_1_out11 sum_1_out1_sat1))))))))
  (= at_rest_switch_out11 sum_1_out11)))))))))))))))))))))
