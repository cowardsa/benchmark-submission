...
(declare-datatypes ((unsigned_2__ref 0))
(((unsigned_2__refqtmk (unsigned_2__content unsigned_2)))))
...
(assert
;; defqtvc
 ;; File "keccak-types.ads", line 70, characters 0-0
  (not
  (forall ((o (_ BitVec 8)))
