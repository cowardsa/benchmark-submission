...
;; foo__lists__list__capacity__last__bit_axiom
  (assert
  (< foo__lists__list__capacity__first__bit1 foo__lists__list__capacity__last__bit1))
...
(declare-datatypes ((tlS__ref 0))
(((tlS__refqtmk (tlS__content us_rep)))))
(define-fun tlS__ref_tlS__content__projection ((a tlS__ref)) us_rep (tlS__content
                                                                    a))
...
(define-fun dynamic_invariant ((temp___expr_494 us_rep)
  (temp___is_init_490 Bool) (temp___skip_constant_491 Bool)
  (temp___do_toplevel_492 Bool)
  (temp___do_typ_inv_493 Bool)) Bool (=>
                                     (not (= temp___skip_constant_491 true))
                                     (in_range1 5
                                     (us_split_discrs1 temp___expr_494))))

(define-fun default_initial_assumption ((temp___expr_496 us_rep)
...
(define-fun dynamic_invariant1 ((temp___expr_229 (_ BitVec 8))
  ...
  (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool true)
...
(define-fun default_initial_assumption1 ((temp___expr_257 us_rep1)
...
(define-fun default_initial_assumption3 ((temp___expr_314 us_rep3)
  (temp___skip_top_level_315 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_315 true))
                                         (and
                                         (= (is_empty1 temp___expr_314) true)
                                         (= (length3 temp___expr_314) 0))))

(define-fun default_initial_assumption4 ((temp___expr_300 us_rep1)
...
(define-fun dynamic_invariant5 ((temp___expr_306 Int)
...
;; defqtvc
 ;; File "foo.adb", line 15, characters 0-0
  (not
  (forall ((x (_ BitVec 8)) (l__split_fields us_main_type))
  ...
  (< (length (us_repqtmk o (us_split_fieldsqtmk l__split_fields))) (to_rep
                                                                   (rec__foo__lists__list__capacity
                                                                   o)))))))))))
(check-sat)
(exit)
