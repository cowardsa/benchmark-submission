...
;; defqtvc
 ;; File "p.ads", line 13, characters 0-0
  ...
  (let ((o (ubv_to_int y2)))
  (=> (in_range3 o)
  (forall ((p__sqrt_von_neumann__result Int))
  (=> (= p__sqrt_von_neumann__result o)
  (<= (* p__sqrt_von_neumann__result p__sqrt_von_neumann__result) x))))))))))))))))))))
(check-sat)
(exit)
