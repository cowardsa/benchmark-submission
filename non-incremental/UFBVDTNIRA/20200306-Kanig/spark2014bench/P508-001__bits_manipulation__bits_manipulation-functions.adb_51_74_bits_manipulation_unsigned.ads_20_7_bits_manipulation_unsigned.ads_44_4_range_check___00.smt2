...
(declare-fun extract_bits_inline_always ((_ BitVec 32) Int
  Int) (_ BitVec 32))

(declare-fun extract_bits_inline_always__function_guard ((_ BitVec 32)
  (_ BitVec 32) Int Int) Bool)
...
;; extract_bits_inline_always__post_axiom
  ...
  (! (=>
     (and
     (and
     (and (dynamic_invariant1 value true true true true) (dynamic_invariant3
     from true true true true)) (dynamic_invariant3 to__ true true true
     true)) (<= from to__))
     (let ((result (extract_bits_inline_always value from to__)))
     (and
     (and
     (and
     (= result (bvand (shift_right value from) (make_mask
                                               (+ (- to__ from) 1))))
     (bvule result (make_mask (+ (- to__ from) 1))))
     (= (shift_left result from) (bvand value (shift_left
...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 42, characters 0-0
  (not
  ...
  (forall
  ((bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result (_ BitVec 32)))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result o3)
  (let ((o4 (+ (- to__ from) 1)))
  (=> (in_range1 o4)
  (let ((o5 (make_mask o4)))
  (=>
  (and (dynamic_invariant1 o5 true false true true)
  (= o5 (shift_right #xFFFFFFFF (- 32 o4))))
  (let ((o6 from))
  (let ((o7 value))
  (let ((o8 (shift_right o7 o6)))
  (=>
  (and (dynamic_invariant1 o8 true false true true)
  (= o8 (ite (and (<= 1 32) (<= 32 8))
        ((_ zero_extend 24) (ite (< o6 8)
                            (bvlshr ((_ extract 7 0) o7) ((_ int_to_bv 8) o6))
                            #x00))
        (ite (and (<= 9 32) (<= 32 16))
        ((_ zero_extend 16) (ite (< o6 16)
                            (bvlshr ((_ extract 15 0) o7) ((_ int_to_bv 16) o6))
                            #x0000))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr o7 ((_ int_to_bv 32) o6))
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) o7) ((_ int_to_bv 64) o6))))))))
  (=>
  (or
  (not
  (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result (bvand o8 o5)))
  (let ((o9 (+ (- to__ from) 1)))
  (and (in_range1 o9)
  (let ((o10 (make_mask o9)))
  (and (dynamic_invariant1 o10 true false true true)
  (= o10 (shift_right #xFFFFFFFF (- 32 o9))))))))
  (=>
  (and
  (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result (bvand o8 o5))
  (bvule bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline__result 
