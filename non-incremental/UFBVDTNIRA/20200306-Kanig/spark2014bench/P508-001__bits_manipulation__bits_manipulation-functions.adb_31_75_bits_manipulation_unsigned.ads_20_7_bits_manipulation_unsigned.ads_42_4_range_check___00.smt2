...
;; shift_left__def_axiom
  ...
  (! (=>
     ...
     (= (shift_left v amount) (ite (and (<= 1 8) (<= 8 8))
                              (ite (< amount 8)
                              (bvshl v ((_ int_to_bv 8) amount)) #x00)
                              (ite (and (<= 9 8) (<= 8 16))
                              ((_ extract 7 0) (bvurem (ite (< amount 16)
                                                       (bvshl ((_ zero_extend 8) v) ((_ int_to_bv 16) amount))
                                                       #x0000) ((_ int_to_bv 16) 256)))
                              (ite (and (<= 17 8) (<= 8 32))
                              ((_ extract 7 0) (bvurem (bvshl ((_ zero_extend 24) v) ((_ int_to_bv 32) amount)) ((_ int_to_bv 32) 256)))
                              ((_ extract 7 0) (bvurem (bvshl ((_ zero_extend 56) v) ((_ int_to_bv 64) amount)) ((_ int_to_bv 64) 256)))))))) :pattern (
  (shift_left v amount)) ))))
...
;; make_mask__def_axiom
  ...
  (forall ((num_bits Int))
  (! (=> (dynamic_invariant2 num_bits true true true true)
     (= (make_mask num_bits) (shift_right #xFF (- 8 num_bits)))) :pattern (
  (make_mask num_bits)) )))
...
(define-fun dynamic_invariant3 ((temp___expr_361 Int)
...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 23, characters 0-0
  ...
  (let ((o1 len))
  (=> (in_range1 o1)
  (let ((bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume 
  (make_mask o1)))
  (=>
  (and (dynamic_invariant1
  bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume
  true false true true)
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume 
  (shift_right #xFF (- 8 o1))))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume 
  mask)
  ...
  (= o4 (ite (and (<= 1 8) (<= 8 8))
        (ite (< o2 8) (bvlshr o3 ((_ int_to_bv 8) o2)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< o2 16)
                         (bvlshr ((_ zero_extend 8) o3) ((_ int_to_bv 16) o2))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o3) ((_ int_to_bv 32) o2)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o3) ((_ int_to_bv 64) o2))))))))
  (forall ((result__1 (_ BitVec 8)))
  (=> (= result__1 (bvand o4 mask))
  (=> (bvule result__1 mask)
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result (_ BitVec 8)))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result result__1)
  (let ((o5 (+ (- to__ from) 1)))
  (=> (in_range1 o5)
  (let ((o6 (make_mask o5)))
  (=>
  (and (dynamic_invariant1 o6 true false true true)
  (= o6 (shift_right #xFF (- 8 o5))))
  (let ((o7 from))
  (let ((o8 value))
  ...
  (= o9 (ite (and (<= 1 8) (<= 8 8))
        (ite (< o7 8) (bvlshr o8 ((_ int_to_bv 8) o7)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< o7 16)
                         (bvlshr ((_ zero_extend 8) o8) ((_ int_to_bv 16) o7))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o8) ((_ int_to_bv 32) o7)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o8) ((_ int_to_bv 64) o7))))))))
  (=>
  (or
  (not
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result (bvand o9 o6)))
  (let ((o10 (+ (- to__ from) 1)))
  (and (in_range1 o10)
  (let ((o11 (make_mask o10)))
  (and (dynamic_invariant1 o11 true false true true)
  (= o11 (shift_right #xFF (- 8 o10))))))))
  (=>
  (and
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result (bvand o9 o6))
  (bvule bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result 
