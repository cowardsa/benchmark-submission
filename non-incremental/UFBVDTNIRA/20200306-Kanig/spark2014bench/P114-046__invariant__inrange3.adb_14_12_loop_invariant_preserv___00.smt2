...
;; defqtvc
 ;; File "inrange3.ads", line 15, characters 0-0
  (not
  (forall ((i (_ BitVec 64)) (o Bool) (i1 (_ BitVec 64)) (spark__branch Bool)
  (i2 (_ BitVec 64)) (o1 Bool))
  ...
  (=> (bvult i2 range_size)
  (=>
  (ite (= i2 #x0000000000000000) (= o1 true)
  (= o1 (ite (forall ((n (_ BitVec 64)))
             (=>
             (and (bvule #x0000000000000000 n)
             (bvule n (bvsub i2 #x0000000000000001)))
             (not (= var (bvadd bottom n)))))
        true false)))
