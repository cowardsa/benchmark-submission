...
;; defqtvc
 ;; File "modular.adb", line 5, characters 0-0
  ...
  (let ((o (mod2 (+ (mod2 a 256) (mod2 b 256)) 256)))
  (=> (uint_in_range o)
  (forall ((modular__add_byte_c__result (_ BitVec 8)))
  (=> (= modular__add_byte_c__result ((_ int_to_bv 8) o))
  (= modular__add_byte_c__result ((_ int_to_bv 8) (mod2 (+ a b) 256)))))))))))
(check-sat)
(exit)
