...
;; defqtvc
 ;; File "x86.ads", line 92, characters 0-0
  ...
  (forall ((x86__ch__result (_ BitVec 8)))
  (=>
  (= x86__ch__result ((_ extract 7 0) (bvudiv (bvand rcx #x000000000000FF00) #x0000000000000100)))
  (= x86__ch__result ((_ extract 7 0) (bvurem (bvudiv (bvand rcx #x000000000000FF00) #x0000000000000100) ((_ int_to_bv 64) 256))))))))))
(check-sat)
(exit)
