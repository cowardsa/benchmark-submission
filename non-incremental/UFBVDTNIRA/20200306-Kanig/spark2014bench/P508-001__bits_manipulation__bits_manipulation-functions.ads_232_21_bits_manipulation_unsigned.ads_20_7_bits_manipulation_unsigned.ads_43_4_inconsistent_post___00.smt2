...
;; lemma8__def_axiom
  ...
  (! (= (= (lemma8 us_void_param) true)
     ...
     (bvult (shift_right val__ (- 16 n)) (ite (< n 65536)
                                         ...
                                         #x0000))))))) :pattern ((lemma8
                                                                 us_void_param)) )))

(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 230, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_16__functions__lemmas__shift_right__lemma8__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_16__functions__lemmas__shift_right__lemma8__result true)
  (= (lemma8 Tuple0) true))))))
(check-sat)
(exit)
