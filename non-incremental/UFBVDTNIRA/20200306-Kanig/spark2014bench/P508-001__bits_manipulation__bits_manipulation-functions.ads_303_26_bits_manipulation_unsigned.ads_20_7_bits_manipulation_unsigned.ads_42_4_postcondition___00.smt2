...
(declare-sort t562s 0)

(declare-fun t562sqtint (t562s) Int)

;; t562s'axiom
  (assert
  (forall ((i t562s)) (and (<= 2 (t562sqtint i)) (<= (t562sqtint i) 7))))

(define-fun in_range2 ((x Int)) Bool (and (<= 2 x) (<= x 7)))
...
(declare-fun user_eq2 (t562s t562s) Bool)

(declare-const dummy2 t562s)

(declare-datatypes ((t562s__ref 0))
(((t562s__refqtmk (t562s__content t562s)))))
(define-fun t562s__ref_t562s__content__projection ((a t562s__ref)) t562s 
  (t562s__content a))
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 302, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result Bool))
  (=> (= (lemma8 Tuple0) true)
  (=> (= (make_mask 1) #x01)
  (=>
  (exists ((i Int))
  (and (= i 2)
  (or
  (not (= (and (ite (<= 2 i) true false) (ite (<= i 7) true false)) true))
  (and
  ...
  (=> (and (<= 1 size) (<= size 7))
  (= (make_mask size) (bvsub (ite (< size 256)
                             (bvshl #x01 ((_ int_to_bv 8) size)) #x00) #x01))))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result 
  (lemma2_goal Tuple0))
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result true)
  (= (lemma2 Tuple0) true))))))))))
(check-sat)
(exit)
