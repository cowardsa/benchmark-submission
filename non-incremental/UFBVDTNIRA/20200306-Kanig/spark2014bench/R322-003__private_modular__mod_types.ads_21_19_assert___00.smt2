...
(declare-datatypes ((my_mod__ref 0))
(((my_mod__refqtmk (my_mod__content my_mod)))))
...
;; defqtvc
 ;; File "mod_types.ads", line 1, characters 0-0
  (not
  (let ((mod_types__a__assume (id #x02)))
  (=>
  (and (id__function_guard mod_types__a__assume #x02)
  (and (dynamic_invariant mod_types__a__assume true false true true)
  (= mod_types__a__assume #x02)))
  (=> (= mod_types__a__assume a)
  (=> (dynamic_invariant a true false true true)
  (let ((mod_types__b__assume (id #xFE)))
  (=>
  (and (id__function_guard mod_types__b__assume #xFE)
  (and (dynamic_invariant mod_types__b__assume true false true true)
  (= mod_types__b__assume #xFE)))
  (=> (= mod_types__b__assume b)
  (=> (dynamic_invariant b true false true true)
  (let ((mod_types__c__assume (id #x00)))
  (=>
  (and (id__function_guard mod_types__c__assume #x00)
  (and (dynamic_invariant mod_types__c__assume true false true true)
  (= mod_types__c__assume #x00)))
  (=> (= mod_types__c__assume c)
