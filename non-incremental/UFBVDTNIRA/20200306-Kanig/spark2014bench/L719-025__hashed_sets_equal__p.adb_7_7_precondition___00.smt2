...
;; defqtvc
 ;; File "p.ads", line 20, characters 0-0
  ...
  (or
  (< (length (us_repqtmk1 o (us_split_fieldsqtmk1 l__split_fields))) 
  (to_rep (rec__p__my_sets__set__capacity o)))
  (= (contains1 (us_repqtmk1 o (us_split_fieldsqtmk1 l__split_fields)) e) true)))))))))
(check-sat)
(exit)
