...
(declare-fun extract_bits_inline__function_guard ((_ BitVec 32) (_ BitVec 32)
  Int Int) Bool)
...
(declare-fun extract_bits_not_inline__function_guard ((_ BitVec 32)
  (_ BitVec 32) Int Int) Bool)
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 13, characters 0-0
  ...
  (bits_manipulation_unsigned__unsigned_32__functions__extract_bits__result (_ BitVec 32)))
  ...
  (= result__1 o3))))))))))))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits__result result__1)
  (let ((o (+ (- to__ from) 1)))
  (=> (in_range1 o)
  (let ((o1 (make_mask o)))
  (=>
  (and (dynamic_invariant1 o1 true false true true)
  (= o1 (shift_right #xFFFFFFFF (- 32 o))))
  (let ((o2 from))
  (let ((o3 value))
