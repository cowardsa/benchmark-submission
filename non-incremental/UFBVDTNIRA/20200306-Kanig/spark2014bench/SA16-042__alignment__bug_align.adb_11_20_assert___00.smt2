...
(declare-fun alignment_of_var ((_ BitVec 8)) (_ BitVec 64))

(declare-fun alignment_of_var__function_guard ((_ BitVec 64)
  (_ BitVec 8)) Bool)
...
(declare-fun user_eq (u8 u8) Bool)

(declare-const dummy u8)

(declare-datatypes ((u8__ref 0))
(((u8__refqtmk (u8__content u8)))))
...
(define-fun dynamic_invariant1 ((temp___expr_187 (_ BitVec 64))
  (temp___is_init_183 Bool) (temp___skip_constant_184 Bool)
  (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool true)

;; alignment_of_var__post_axiom
  (assert
  (forall ((bug_align__var (_ BitVec 8)))
  (! (=> (dynamic_invariant bug_align__var true true true true)
     (let ((result (alignment_of_var bug_align__var)))
     (=> (alignment_of_var__function_guard result bug_align__var)
     (dynamic_invariant1 result true false true true)))) :pattern ((alignment_of_var
                                                                   bug_align__var)) )))

;; alignment_of_var__def_axiom
  (assert
  (forall ((bug_align__var (_ BitVec 8)))
  (! (=> (dynamic_invariant bug_align__var true true true true)
     (= (alignment_of_var bug_align__var) ((_ int_to_bv 64) 16))) :pattern (
  (alignment_of_var bug_align__var)) )))
...
;; defqtvc
 ;; File "bug_align.adb", line 1, characters 0-0
  ...
  (=>
  (forall ((var1 (_ BitVec 8))) (alignment_of_var__function_guard
