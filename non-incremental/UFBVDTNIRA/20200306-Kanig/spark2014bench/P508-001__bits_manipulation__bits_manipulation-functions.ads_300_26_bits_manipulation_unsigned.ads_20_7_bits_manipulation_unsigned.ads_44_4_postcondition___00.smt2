...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     ...
     (bvult (make_mask size) (ite (< size 4294967296)
                             (bvshl #x00000001 ((_ int_to_bv 32) size))
                             #x00000000))))) :pattern ((lemma1 us_void_param)) )))
...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 299, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result Bool))
  (=> (= (lemma8 Tuple0) true)
  (=>
  (forall ((size Int))
  (=> (and (<= 1 size) (<= size 31))
  (bvult (make_mask size) (ite (< size 4294967296)
                          (bvshl #x00000001 ((_ int_to_bv 32) size)) #x00000000))))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result 
  (lemma1_goal Tuple0))
  (=>
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma1__result true)
  (= (lemma1 Tuple0) true))))))))
(check-sat)
(exit)
