...
(declare-fun to_signed ((_ BitVec 64)) Int)

(declare-fun to_signed__function_guard (Int (_ BitVec 64)) Bool)
...
(define-fun dynamic_invariant ((temp___expr_189 (_ BitVec 64))
...
;; target'axiom
  (assert
  (forall ((i target))
  (and (<= (- 9223372036854775808) (targetqtint i))
  (<= (targetqtint i) 9223372036854775807))))
...
(define-fun dynamic_invariant1 ((temp___expr_203 Int)
  ...
  (temp___do_typ_inv_202 Bool)) Bool (=>
                                     ...
                                     (in_range temp___expr_203)))

;; to_signed__post_axiom
  (assert
  (forall ((s (_ BitVec 64)))
  (! (=> (dynamic_invariant s true true true true)
     (let ((result (to_signed s)))
     (=> (to_signed__function_guard result s) (dynamic_invariant1 result true
     false true true)))) :pattern ((to_signed s)) )))

(declare-fun to_unsigned (Int) (_ BitVec 64))

(declare-fun to_unsigned__function_guard ((_ BitVec 64) Int) Bool)

(declare-sort source1 0)

(declare-fun sourceqtint (source1) Int)
...
(declare-fun user_eq2 (source1 source1) Bool)

(declare-const dummy2 source1)

(declare-datatypes ((source__ref1 0))
(((source__refqtmk1 (source__content1 source1)))))
(define-fun source__ref_source__content__2__projection ((a source__ref1)) source1 
  (source__content1 a))

(define-fun dynamic_invariant2 ((temp___expr_210 Int)
  (temp___is_init_206 Bool) (temp___skip_constant_207 Bool)
  (temp___do_toplevel_208 Bool)
  (temp___do_typ_inv_209 Bool)) Bool (=>
                                     (or (= temp___is_init_206 true)
                                     (<= (- 9223372036854775808) 9223372036854775807))
                                     (in_range1 temp___expr_210)))
...
(declare-fun user_eq3 (target1 target1) Bool)

(declare-const dummy3 target1)

(declare-datatypes ((target__ref1 0))
(((target__refqtmk1 (target__content1 target1)))))
(define-fun target__ref_target__content__2__projection ((a target__ref1)) target1 
  (target__content1 a))

(define-fun dynamic_invariant3 ((temp___expr_217 (_ BitVec 64))
  (temp___is_init_213 Bool) (temp___skip_constant_214 Bool)
  (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool true)

;; to_unsigned__post_axiom
  (assert
  (forall ((s Int))
  (! (=> (dynamic_invariant2 s true true true true)
     (let ((result (to_unsigned s)))
     (=> (to_unsigned__function_guard result s) (dynamic_invariant3 result
     true false true true)))) :pattern ((to_unsigned s)) )))
...
(define-fun dynamic_invariant4 ((temp___expr_182 (_ BitVec 64))
  (temp___is_init_178 Bool) (temp___skip_constant_179 Bool)
  (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool true)

(declare-sort integer_64 0)

(declare-fun integer_64qtint (integer_64) Int)

;; integer_64'axiom
  (assert
  (forall ((i integer_64))
  (and (<= (- 9223372036854775808) (integer_64qtint i))
  (<= (integer_64qtint i) 9223372036854775807))))

(define-fun in_range2 ((x1 Int)) Bool (and (<= (- 9223372036854775808) x1)
...
(declare-fun user_eq5 (integer_64 integer_64) Bool)

(declare-const dummy5 integer_64)

(declare-datatypes ((integer_64__ref 0))
(((integer_64__refqtmk (integer_64__content integer_64)))))
(define-fun integer_64__ref_integer_64__content__2__projection ((a integer_64__ref)) integer_64 
...
;; y__def_axiom
  (assert
  (and (to_signed__function_guard (to_signed #x0000000000000000)
  #x0000000000000000) (= y (to_signed #x0000000000000000))))
...
;; defqtvc
 ;; File "unchecked_conv.adb", line 3, characters 0-0
  ...
  (let ((unchecked_conv__y__assume (to_signed #x0000000000000000)))
  (=>
  (and (to_signed__function_guard unchecked_conv__y__assume
  #x0000000000000000) (dynamic_invariant1 unchecked_conv__y__assume true
  false true true))
  (=> (= unchecked_conv__y__assume y)
  (=> (dynamic_invariant5 y true false true true)
