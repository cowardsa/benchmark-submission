...
(define-fun default_initial_assumption2 ((temp___expr_382 us_rep3)
...
(declare-fun user_eq9 (tcount_typeB tcount_typeB) Bool)
...
;; defqtvc
 ;; File "a-cfhase.ads", line 840, characters 0-0
  ...
  (<= o (to_rep1 (rec__p__my_sets__set__capacity target__split_discrs))))
  (forall ((o1 Int))
  (=> (= (to_rep1 (rec__p__my_sets__set__capacity target__split_discrs)) o1)
  (=> (in_range5 (- o1 o))
  (let ((o2 source))
  (let ((o3 (us_repqtmk target__split_discrs
            (us_split_fieldsqtmk target__split_fields))))
  (let ((o4 (intersection1 o3 o2)))
  (=>
  (and
  (and
  (and
  (and
  (and (= (length o4) (num_overlaps (model1 o3) (model1 o2)))
  (= (ole (model1 o4) (model1 o3)) true))
  (= (ole (model1 o4) (model1 o2)) true))
  (= (includes_intersection (model1 o4) (model1 o3) (model1 o2)) true))
  (= (e_elements_included (elements o4) (elements o3)) true))
  (= (e_elements_included1 (elements o3) (model1 o2) (elements o4)) true))
  (let ((o5 (length o4)))
  (=>
  (and (dynamic_invariant o5 true false true true)
  (<= o5 (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 o4)))))
  (let ((o6 source))
  (let ((o7 (length o6)))
  (=>
  (and (dynamic_invariant o7 true false true true)
  (<= o7 (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 o6)))))
  (in_range5 (- o7 o5)))))))))))))))))))
(check-sat)
(exit)
