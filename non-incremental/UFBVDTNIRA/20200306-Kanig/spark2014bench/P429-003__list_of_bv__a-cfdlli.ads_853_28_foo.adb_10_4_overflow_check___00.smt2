...
(declare-fun get1 (us_rep2 Int) (_ BitVec 8))

(declare-fun get__function_guard1 ((_ BitVec 8) us_rep2 Int) Bool)
...
;; defqtvc
 ;; File "a-cfdlli.ads", line 826, characters 0-0
  ...
  (=> (= (has_key o2 i) true)
  (and
  (let ((temp___360 (get o2 i)))
  (and (<= 1 temp___360) (<= temp___360 (length1 o1))))
  (forall ((j us_rep))
  (=> (= (has_key o2 j) true)
  ...
  (<= o4 (to_rep (rec__foo__lists__list__capacity container__split_discrs))))
  (in_range4 (- o4 count)))))))))))))))
(check-sat)
(exit)
