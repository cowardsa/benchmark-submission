...
(define-fun default_initial_assumption ((temp___expr_292 us_rep2)
...
(define-fun default_initial_assumption1 ((temp___expr_314 us_rep3)
...
(define-fun default_initial_assumption2 ((temp___expr_300 us_rep)
...
;; defqtvc
 ;; File "a-cfdlli.ads", line 1021, characters 0-0
  ...
  (<= o (to_rep (rec__foo__lists__list__capacity target__split_discrs))))
  (forall ((o1 Int))
  (=> (= (to_rep (rec__foo__lists__list__capacity target__split_discrs)) o1)
  (in_range3 (- o1 o))))))))))
(check-sat)
(exit)
