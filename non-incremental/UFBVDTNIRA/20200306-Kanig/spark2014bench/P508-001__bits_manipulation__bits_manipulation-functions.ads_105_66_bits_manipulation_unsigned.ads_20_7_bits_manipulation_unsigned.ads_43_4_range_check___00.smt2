...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 93, characters 0-0
  (not
  (forall ((usf (_ BitVec 16)) (usf1 Int) (o Bool) (usf2 Int))
  (=>
  (= (and (ite (bvule #x0000 usf) true false) (ite (bvule usf #xFFFF) true
                                              false)) true)
  (=> (not (= usf #x0000))
  (=>
  (= (and (ite (<= 0 usf1) true false) (ite (<= usf1 15) true false)) true)
  (=>
  (let ((o1 (shift_right usf usf1)))
  (and
  (and (dynamic_invariant1 o1 true false true true)
  (= o1 (ite (and (<= 1 16) (<= 16 8))
        ((_ zero_extend 8) (ite (< usf1 8)
                           (bvlshr ((_ extract 7 0) usf) ((_ int_to_bv 8) usf1))
                           #x00))
        (ite (and (<= 9 16) (<= 16 16))
        (ite (< usf1 16) (bvlshr usf ((_ int_to_bv 16) usf1)) #x0000)
        (ite (and (<= 17 16) (<= 16 32))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 16) usf) ((_ int_to_bv 32) usf1)))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 48) usf) ((_ int_to_bv 64) usf1))))))))
  (ite (= o1 #x0001)
  (= o (ite (forall ((j Int))
            (=> (and (<= 0 j) (<= j usf1))
            (bvuge (shift_right usf j) #x0001)))
       true false))
  (= o false))))
  (=> (= o true)
  (=>
  (= (and (ite (<= usf1 usf2) true false) (ite (<= usf2 15) true false)) true)
  (in_range1 usf2))))))))))
(check-sat)
(exit)
