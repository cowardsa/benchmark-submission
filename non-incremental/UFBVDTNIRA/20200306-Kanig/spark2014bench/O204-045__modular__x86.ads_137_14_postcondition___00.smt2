...
;; defqtvc
 ;; File "x86.ads", line 135, characters 0-0
  (not
  (forall ((rdx (_ BitVec 64)) (rdx1 (_ BitVec 64)) (rdx2 (_ BitVec 64)))
  (=> (= rdx1 rdx)
  (=> (dynamic_invariant rdx true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rdx2 (bvor (bvand rdx #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) 
  val__) #x0100))))
  (= rdx2 (bvor (bvand rdx1 #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) 
  val__) #x0100)))))))))))
(check-sat)
(exit)
