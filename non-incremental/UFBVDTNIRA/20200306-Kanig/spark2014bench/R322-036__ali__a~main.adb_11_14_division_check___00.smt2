...
;; get__def_axiom
  (assert
  (forall ((b__state Bool))
  (! (= (= (get b__state) true) (= b__state true)) :pattern ((get b__state)) )))
...
;; defqtvc
 ;; File "a~main.ads", line 5, characters 0-0
  (not
  (forall ((y (_ BitVec 64)) (state Bool) (x (_ BitVec 64))
  (x1 (_ BitVec 64)))
  (=> (dynamic_invariant y false false true true)
  (=> (forall ((state1 Bool)) (get__function_guard (get state1) state1))
  (=> (= (get state) true)
