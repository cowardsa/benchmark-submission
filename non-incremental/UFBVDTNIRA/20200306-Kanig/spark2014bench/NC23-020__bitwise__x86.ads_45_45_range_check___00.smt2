...
(define-fun dynamic_invariant1 ((temp___expr_184 (_ BitVec 32))
  (temp___is_init_180 Bool) (temp___skip_constant_181 Bool)
  (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "x86.ads", line 43, characters 0-0
  (not
  (forall ((rax (_ BitVec 64)))
  (=> (dynamic_invariant rax true false true true)
  (forall ((x86__eax__result (_ BitVec 32)))
  (=> (= x86__eax__result ((_ extract 31 0) (bvand rax #x00000000FFFFFFFF)))
