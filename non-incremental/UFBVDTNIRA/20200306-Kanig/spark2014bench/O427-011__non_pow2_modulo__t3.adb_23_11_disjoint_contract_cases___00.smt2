...
;; defqtvc
 ;; File "t3.adb", line 22, characters 0-0
  ...
  (<= (+ (+ (+ (+ (+ 0 (ite (= (and (= x #x0000000000000000) (= y #x0000000000000000)) true)
                       1 0)) (ite (= (and (not (= x #x0000000000000000)) (= 
                             y #x0000000000000000)) true) 1 0)) (ite (= (and (= 
                                                                x #x0000000000000000) (not (= 
                                                                y #x0000000000000000))) true)
                                                                1 0)) 
  (ite (= (and (= x #x0000000000000002) (= y #x0000000000000004)) true) 1 0)) 
  (ite (= (and (= x #x0000000000000004) (= y #x0000000000000002)) true) 1 0)) 1)))))
(check-sat)
(exit)
