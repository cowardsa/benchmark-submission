...
(assert
;; defqtvc
 ;; File "x86.ads", line 275, characters 0-0
  (not
  (forall ((rdi (_ BitVec 64)) (rdi1 (_ BitVec 64)) (rdi2 (_ BitVec 64)))
  (=> (= rdi1 rdi)
  (=> (dynamic_invariant rdi true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rdi2 (bvor (bvand rdi #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__)))
  (= rdi2 (bvor (bvand rdi1 #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__))))))))))
(check-sat)
(exit)
