...
(declare-fun subst ((_ BitVec 8) (_ BitVec 8)) (_ BitVec 8))

(declare-fun subst__function_guard ((_ BitVec 8) (_ BitVec 8)
  (_ BitVec 8)) Bool)
...
;; subst__post_axiom
  ...
  (! (=>
     ...
     false true true)))) :pattern ((subst a b)) )))
...
;; subst__def_axiom
  ...
  (! (=>
     (and (dynamic_invariant a true true true true) (dynamic_invariant b true
     true true true)) (= (subst a b) (bvsub a b))) :pattern ((subst a b)) )))
...
(assert
;; defqtvc
 ;; File "pack.ads", line 21, characters 0-0
  (not
  ...
  (let ((o2 (subst o1 o)))
  (=>
  (and (subst__function_guard o2 o1 o)
  (and (dynamic_invariant o2 true false true true) (= o2 (bvsub o1 o))))
  (not (= o2 #x00)))))))))))
(check-sat)
(exit)
