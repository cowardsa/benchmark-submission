...
;; lemma1__def_axiom
  ...
  (! (= (= (lemma1 us_void_param) true)
     ...
     (forall ((n Int))
     (=> (and (<= 0 n) (<= n 7))
     (and (not (= (ite (< n 256) (bvshl #x01 ((_ int_to_bv 8) n)) #x00) #x00))
     (= (shift_right val__ n) (bvudiv val__ (ite (< n 256)
...
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 149, characters 0-0
  (not
  (forall
  ((bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_right__lemma2__result Bool))
  (not
  (=>
  (= bits_manipulation_unsigned__unsigned_8__functions__lemmas__shift_right__lemma2__result true)
  (= (lemma1 Tuple0) true))))))
(check-sat)
(exit)
