...
(define-fun dynamic_invariant2 ((temp___expr_361 Int)
...
;; lemma6__def_axiom
  ...
  (! (= (= (lemma61 us_void_param) true)
     ...
     (=> (and (bvule #x00 val__) (bvule val__ #xFF))
     (=> (not (= val__ #x00))
     (and (= (shift_right val__ 0) val__)
     (exists ((n Int))
     (and (and (<= 0 n) (<= n 7))
     (and
     (and (= (shift_right val__ n) #x01)
     (forall ((j Int))
     (=> (and (<= 0 j) (<= j n)) (bvuge (shift_right val__ j) #x01))))
     (forall ((j Int))
     (=> (and (<= n j) (<= j 7)) (bvule (shift_right val__ j) #x01))))))))))) :pattern (
...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 115, characters 0-0
  ...
  (= o1 (ite (and (<= 1 8) (<= 8 8))
        (ite (< i 8) (bvlshr o ((_ int_to_bv 8) i)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< i 16)
                         (bvlshr ((_ zero_extend 8) o) ((_ int_to_bv 16) i))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o) ((_ int_to_bv 32) i)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o) ((_ int_to_bv 64) i))))))))
  (=> (not (= o1 #x01))
  (forall ((result__1 Int) (i1 Int))
  (=>
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j i1)) (bvugt (shift_right value j) #x01)))
  (=>
  (= (and (ite (and (dynamic_invariant2 result__1 false true true true)
               (in_range2 i1))
          true false) (ite (and (<= 0 i1) (<= i1 7)) true false)) true)
  (=> (not (= i1 7))
  (forall ((i2 Int))
  (=> (= i2 (+ i1 1))
  ...
  (= o3 (ite (and (<= 1 8) (<= 8 8))
        (ite (< i2 8) (bvlshr o2 ((_ int_to_bv 8) i2)) #x00)
        (ite (and (<= 9 8) (<= 8 16))
        ((_ extract 7 0) (ite (< i2 16)
                         (bvlshr ((_ zero_extend 8) o2) ((_ int_to_bv 16) i2))
                         #x0000))
        (ite (and (<= 17 8) (<= 8 32))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 24) o2) ((_ int_to_bv 32) i2)))
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) o2) ((_ int_to_bv 64) i2))))))))
  (=> (not (= o3 #x01))
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j i2)) (bvugt (shift_right value j) #x01))))))))))))))))))))))))))))
(check-sat)
(exit)
