...
(define-fun to_int2 ((x hash_type)) Int (ubv_to_int (to_rep x)))
...
(define-fun dynamic_invariant ((temp___expr_712 Int)
  ...
  (temp___do_toplevel_710 Bool)
  (temp___do_typ_inv_711 Bool)) Bool (=>
                                     (or (= temp___is_init_708 true)
                                     (<= 1 100)) (in_range3 temp___expr_712)))
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant key1 true true true true)
     ...
     (and (forall ((e Int)) (key__function_guard (key e) e))
     (and
     (forall ((key2 Int) (e Int)) (my_eq__function_guard (my_eq key2 (key e))
     key2 (key e)))
     (= (= (contains container key1) true)
     (exists ((e Int))
     (and (and (in_range2 e) (= (contains1 (model1 container) e) true))
     (= (my_eq key1 (key e)) true)))))))) :pattern ((contains container key1)) ))))
...
(define-fun element ((container us_rep)
  (position us_rep3)) Int (get (elements container)
...
(declare-fun mapping_preserved_except (us_rep1 us_rep1 us_rep4 us_rep4
  us_rep3) Bool)

(declare-fun mapping_preserved_except__function_guard (Bool us_rep1 us_rep1
  us_rep4 us_rep4 us_rep3) Bool)

(declare-fun m_included_except (us_rep2 us_rep2 Int) Bool)

(declare-fun m_included_except__function_guard (Bool us_rep2 us_rep2
  Int) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_260 Int)
  ...
  (temp___do_typ_inv_259 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range5 temp___expr_260)))
...
(define-fun dynamic_invariant3 ((temp___expr_705 Int)
  (temp___is_init_701 Bool) (temp___skip_constant_702 Bool)
  (temp___do_toplevel_703 Bool)
  (temp___do_typ_inv_704 Bool)) Bool (=>
                                     (or (= temp___is_init_701 true)
                                     (<= 1 100)) (in_range6 temp___expr_705)))
...
(define-fun dynamic_invariant4 ((temp___expr_267 (_ BitVec 32))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant1 item true true true true)
     ...
     (= (my_eq item (get container result)) true)))) (dynamic_invariant5
...
(define-fun default_initial_assumption2 ((temp___expr_322 us_rep2)
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (=>
     (and (in_range8 temp___445)
     (= (iter_has_element result temp___445) true))
     (= (contains1 (model1 container) (get result temp___445)) true))))
     (forall ((item Int))
     (=> (and (in_range2 item) (= (contains1 (model1 container) item) true))
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (and
     (let ((temp___456 (get1 result i)))
     (and (<= 1 temp___456) (<= temp___456 (length container))))
     (forall ((j us_rep3))
...
(define-fun dynamic_invariant6 ((temp___expr_314 Int)
  ...
  (temp___do_typ_inv_313 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range2 temp___expr_314)))

;; contains__post_axiom
  (assert
  (forall ((container us_rep2))
  (forall ((item Int))
  (! (=> (dynamic_invariant6 item true true true true)
     (and
     ...
     (=>
     (exists ((e Int))
     (and (and (in_range2 e) (= (contains1 container e) true))
     (= (my_eq e item) true))) (= (contains1 container item) true))))) :pattern (
...
;; ole__post_axiom
  ...
  (! (= (= (ole left right) true)
     (forall ((item Int))
     (=> (and (in_range2 item) (= (contains1 left item) true))
...
;; is_empty__post_axiom
  ...
  (! (let ((result (is_empty1 container)))
     ...
     (= (= result true)
     (forall ((item Int))
     (not (and (in_range2 item) (= (contains1 container item) true)))))
...
;; included_except__post_axiom
  ...
  (! (=> (dynamic_invariant6 item true true true true)
     ...
     (forall ((e Int))
     (=> (and (in_range2 e) (= (contains1 left e) true))
     (or (= (contains1 right e) true) (= (my_eq e item) true))))))) :pattern (
  (included_except left right item)) ))))

(define-fun dynamic_invariant7 ((temp___expr_356 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_349 Int)
  ...
  (temp___do_typ_inv_348 Bool)) Bool (=>
                                     ...
                                     (<= 1 100)) (in_range9 temp___expr_349)))
...
;; has_key__post_axiom
  ...
  (! (=> (= (distinct 0 0) true)
     (=>
     (exists ((k1 us_rep3))
     (and (= (has_key container k1) true) (= (bool_eq3 k1 key1) true)))
...
(declare-fun user_eq14 (element_type4 element_type4) Bool)

(declare-const dummy14 element_type4)
...
(define-fun dynamic_invariant9 ((temp___expr_381 Int)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep4)) (! (dynamic_invariant5 (length3 container)
...
;; is_empty__post_axiom
  ...
  (! (= (= (is_empty container) true)
     (forall ((key1 us_rep3)) (not (= (has_key container key1) true)))) :pattern (
  (is_empty container)) )))
...
;; m_included_except__post_axiom
  ...
  (! (=> (dynamic_invariant key1 true true true true)
     ...
     (and (forall ((e Int)) (key__function_guard (key e) e))
     (and
     (forall ((key2 Int) (e Int)) (my_eq__function_guard (my_eq (key e) key2)
     (key e) key2))
     (= (= (m_included_except left right key1) true)
     (forall ((e Int))
     (=> (and (in_range2 e) (= (contains1 left e) true))
     (or (= (contains1 right e) true) (= (my_eq (key e) key1) true))))))))) :pattern (
  (m_included_except left right key1)) ))))

;; temp___result_252'def
  (assert
  (forall ((container us_rep) (position us_rep3)) (key__function_guard
  (key (element container position)) (element container position))))

(define-fun key1 ((container us_rep)
  (position us_rep3)) Int (key (element container position)))

(declare-fun key__function_guard1 (Int us_rep us_rep3) Bool)

;; find__post_axiom
  (assert
  (forall ((container us_rep))
  (forall ((key2 Int))
  (! (=> (dynamic_invariant key2 true true true true)
     (let ((result (find1 container key2)))
     (and (forall ((e Int)) (key__function_guard (key e) e))
     (and (forall ((e Int)) (key__function_guard (key e) e))
     (and
     (forall ((key3 Int) (e Int)) (my_eq__function_guard (my_eq key3 (key e))
     key3 (key e)))
     (and
     (forall ((container1 us_rep) (key3 Int) (result1 us_rep3))
     (my_eq__function_guard (my_eq (key1 container1 result1) key3)
     (key1 container1 result1) key3))
     (ite (forall ((e Int))
          (=> (and (in_range2 e) (= (contains1 (model1 container) e) true))
          (not (= (my_eq key2 (key e)) true))))
     (= (bool_eq3 result no_element) true)
     (and (= (has_key (positions container) result) true)
     (= (my_eq (key1 container result) key2) true))))))))) :pattern (
...
;; defqtvc
 ;; File "p.ads", line 24, characters 0-0
  ...
  (length (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields))))
  (= (element1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)) o3) e))
  (= (contains1
     (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1))) e) true))
  (= (m_included_except
     (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields)))
     (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1))) o3) true))
  (= (included_except
     (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))
     (model1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields))) e) true))
  (= (mapping_preserved_except
     (elements (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields)))
     (elements (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))
     (positions (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields)))
     (positions (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))
     (find1 (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)) o3)) true))
  (= (oeq1 (positions (us_repqtmk o4 (us_split_fieldsqtmk l__split_fields1)))
