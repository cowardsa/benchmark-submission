...
(declare-fun dh ((_ BitVec 64)) (_ BitVec 8))

(declare-fun dh__function_guard ((_ BitVec 8) (_ BitVec 64)) Bool)
...
(assert
;; defqtvc
 ;; File "x86.ads", line 135, characters 0-0
  (not
  (forall ((rdx (_ BitVec 64)) (rdx1 (_ BitVec 64)))
  (=> (dynamic_invariant rdx true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rdx1 (bvor (bvand rdx #xFFFFFFFFFFFF00FF) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) 
  val__) #x0100))))
  (=> (forall ((rdx2 (_ BitVec 64))) (dh__function_guard (dh rdx2) rdx2))
  (= (dh rdx1) val__))))))))
(check-sat)
(exit)
