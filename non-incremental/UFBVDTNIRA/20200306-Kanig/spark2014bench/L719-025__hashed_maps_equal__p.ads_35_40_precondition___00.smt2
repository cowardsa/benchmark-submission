...
;; defqtvc
 ;; File "p.ads", line 28, characters 0-0
  ...
  (let ((o8 (find usf o7)))
  (=>
  (forall ((usf1 us_rep) (o9 Int) (o10 us_rep1)) (my_eq__function_guard
  (my_eq (key usf1 o10) o9) (key usf1 o10) o9))
  (=>
  ...
  (let ((o12 (has_element temp___838 usf2)))
  (=> (= (= o12 true) (= (has_key (positions temp___838) usf2) true))
