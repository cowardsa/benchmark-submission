...
;; defqtvc
 ;; File "x86.ads", line 14, characters 0-0
  (not
  (forall ((x86__inrange64__result Bool))
  ...
  (=>
  (= x86__inrange64__result (ite (bvule bottom (bvsub #xFFFFFFFFFFFFFFFF 
                            range_size))
                            (and (ite (bvule bottom var) true false) 
                            (ite (bvule var (bvadd bottom range_size)) true
                            false))
                            (or (and (ite (bvule bottom var) true false) (distinct 1 0)) 
                            (ite (bvule var (bvsub (bvsub range_size (bvsub #xFFFFFFFFFFFFFFFF 
                            bottom)) #x0000000000000001)) true false))))
  (=> (= x86__inrange64__result true)
