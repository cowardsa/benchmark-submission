...
(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 93, characters 0-0
  (not
  (forall ((usf (_ BitVec 32)) (usf1 Int) (o Bool) (usf2 Int))
  (=>
  (= (and (ite (bvule #x00000000 usf) true false) (ite (bvule usf #xFFFFFFFF)
                                                  true false)) true)
  (=> (not (= usf #x00000000))
  (=>
  (= (and (ite (<= 0 usf1) true false) (ite (<= usf1 31) true false)) true)
  (=>
  (let ((o1 (shift_right usf usf1)))
  (and
  (and (dynamic_invariant1 o1 true false true true)
  (= o1 (ite (and (<= 1 32) (<= 32 8))
        ((_ zero_extend 24) (ite (< usf1 8)
                            (bvlshr ((_ extract 7 0) usf) ((_ int_to_bv 8) usf1))
                            #x00))
        (ite (and (<= 9 32) (<= 32 16))
        ((_ zero_extend 16) (ite (< usf1 16)
                            (bvlshr ((_ extract 15 0) usf) ((_ int_to_bv 16) usf1))
                            #x0000))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr usf ((_ int_to_bv 32) usf1))
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) usf) ((_ int_to_bv 64) usf1))))))))
  (ite (= o1 #x00000001)
  (= o (ite (forall ((j Int))
            (=> (and (<= 0 j) (<= j usf1))
            (bvuge (shift_right usf j) #x00000001)))
       true false))
  (= o false))))
  (=> (= o true)
  (=>
  (= (and (ite (<= usf1 usf2) true false) (ite (<= usf2 31) true false)) true)
  (in_range1 usf2))))))))))
(check-sat)
(exit)
