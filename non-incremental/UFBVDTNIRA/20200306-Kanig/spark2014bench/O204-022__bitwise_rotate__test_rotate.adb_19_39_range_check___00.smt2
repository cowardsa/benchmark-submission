...
(declare-datatypes ((longword_t__ref 0))
(((longword_t__refqtmk (longword_t__content longword_t)))))
...
;; defqtvc
 ;; File "test_rotate.adb", line 8, characters 0-0
  ...
  (=> (bvule a #xFFFFFFFFFFFFFFFF)
  (=> (not (= a #x0000000000000000))
  (=> (bvule b #x000000007FFFFFFF) (in_range (ubv_to_int b)))))))))
(check-sat)
(exit)
