...
(declare-fun user_eq4 (modular modular) Bool)

(declare-const dummy4 modular)
...
(define-fun dynamic_invariant4 ((temp___expr_382 (_ BitVec 32))
  (temp___is_init_378 Bool) (temp___skip_constant_379 Bool)
  (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool true)

(assert
;; defqtvc
 ;; File "bits_manipulation-functions.ads", line 7, characters 0-0
  (not
  (=> (dynamic_invariant1 v true false true true)
  (=> (dynamic_invariant amount true false true true)
  (=>
  (not (= (and (ite (<= 1 64) true false) (ite (<= 64 8) true false)) true))
  (=> (= (and (ite (<= 9 64) true false) (ite (<= 64 16) true false)) true)
  (=> (< amount 16) (bvule ((_ zero_extend 48) #x0000) v))))))))
(check-sat)
(exit)
