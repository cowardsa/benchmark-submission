...
;; defqtvc
 ;; File "inrange2.ads", line 15, characters 0-0
  ...
  (inrange2__inrange64__result Bool))
  ...
  (and (= spark__branch (ite (= var (bvadd bottom i)) true false))
  ...
  (and (dynamic_invariant i2 true true true true)
  ...
  (and (= spark__branch1 (ite (= var (bvadd bottom i2)) true false))
  (= spark__branch1 true)))))))))))))) (= matched1 (distinct 1 0))))
  (= matched1 matched))
  (=> (= inrange2__inrange64__result matched1)
  (=> (= inrange2__inrange64__result true)
  (exists ((n (_ BitVec 64)))
  (and
