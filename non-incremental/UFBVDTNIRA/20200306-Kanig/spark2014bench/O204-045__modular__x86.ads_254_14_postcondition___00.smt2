...
(assert
;; defqtvc
 ;; File "x86.ads", line 252, characters 0-0
  (not
  (forall ((rsi (_ BitVec 64)) (rsi1 (_ BitVec 64)) (rsi2 (_ BitVec 64)))
  (=> (= rsi1 rsi)
  (=> (dynamic_invariant rsi true false true true)
  (=> (dynamic_invariant1 val__ true false true true)
  (=>
  (= rsi2 (bvor (bvand rsi #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__)))
  (= rsi2 (bvor (bvand rsi1 #xFFFFFFFFFFFF0000) ((_ zero_extend 48) val__))))))))))
(check-sat)
(exit)
