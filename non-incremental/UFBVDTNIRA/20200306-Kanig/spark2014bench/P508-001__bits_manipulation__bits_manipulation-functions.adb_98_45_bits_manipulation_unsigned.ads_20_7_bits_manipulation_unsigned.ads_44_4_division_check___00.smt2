...
;; defqtvc
 ;; File "bits_manipulation-functions.adb", line 79, characters 0-0
  ...
  (v (_ BitVec 32)) (shift_amount1 Int) (result__1 Int) (v1 (_ BitVec 32))
  (new_v1 (_ BitVec 32)))
  ...
  (=>
  (= (and (ite (= shift_amount 0) false true) (ite (not (= v #x00000000))
                                              true false)) true)
  (=>
  (= (and (ite (and
               (and
               (and (dynamic_invariant2 shift_amount1 true true true true)
               (dynamic_invariant2 result__1 true true true true))
  ...
  (forall ((new_v2 (_ BitVec 32)))
  (=> (= new_v2 o)
  (forall ((result__2 Int) (v2 (_ BitVec 32)))
  (=>
  (exists ((spark__branch Bool))
  (and (= spark__branch (ite (not (= new_v2 #x00000000)) true false))
  (ite (= spark__branch true)
  (and (in_range2 (+ result__1 shift_amount1))
  (let ((o1 (+ result__1 shift_amount1)))
  (and (in_range2 o1) (and (= result__2 o1) (= v2 new_v2)))))
