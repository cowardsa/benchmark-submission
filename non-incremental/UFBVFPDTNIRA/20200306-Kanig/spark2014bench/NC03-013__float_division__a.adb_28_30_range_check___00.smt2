...
;; defqtvc
 ;; File "a.ads", line 8, characters 0-0
  (not
  (forall ((y Float32) (h Float32) (spark__branch Bool))
  (=> (dynamic_invariant1 x true false true true)
  (=> (dynamic_invariant2 y false false true true)
  (=> (dynamic_invariant h false false true true)
  (=> (= spark__branch (ite (not (= x #x0000)) true false))
  (=> (= spark__branch true)
  (=>
  (fp.leq (fp #b0 #b01111110 #b11001100110011001100110) ((_ to_fp_unsigned 8 24) RNE 
  x))
  (let ((o (fp.div RNE (fp #b0 #b10010101 #b11000000110001000110000) ((_ to_fp_unsigned 8 24) RNE 
  x))))
  (=> (fp.isFinite32 o)
  (forall ((h1 Float32))
  (=> (= h1 o)
  ...
  (=>
  (= spark__branch1 (ite (fp.leq (fp #b0 #b10001100 #b10101101101100000000000) h1)
                    true false))
