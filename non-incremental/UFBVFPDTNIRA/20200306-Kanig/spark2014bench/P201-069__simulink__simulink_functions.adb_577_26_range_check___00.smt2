...
(define-fun dynamic_invariant1 ((temp___expr_356 (_ BitVec 8))
...
;; defqtvc
 ;; File "simulink_functions.ads", line 98, characters 0-0
  ...
  (let ((o ((_ to_fp_unsigned 8 24) RNE i)))
  (let ((o1 (sqrt2 o)))
  (=>
  ...
  (fp.leq ((_ to_fp_unsigned 8 24) RTP #x00) (fp.roundToIntegral RNA o1))))))))
(check-sat)
(exit)
