...
(assert (= (=> (and (= (x451 (_ bv608 256)) x877) (= (not (bvugt x306 (_ bv128 256))) x619)) (and x619 (=> (= x380 (_ bv128 256)) x595))) x289))
...
(assert (= x240 (=> (and (or (and (= (bvadd x133 (_ bv644 256)) x454) x445) (not x445)) (= (bvult x133 x52) x445)) x128)))
...
(assert (= x697 (=> (and (= x906 (bvugt x197 x318)) (or (not x906) (and x906 (= x724 (bvadd x318 (_ bv644 256)))))) x849)))
...
(assert (= x249 (=> (and (= (x1050 (_ bv608 256)) x1018) (= x363 (not (bvugt x133 (_ bv128 256))))) (and x363 (=> (= (_ bv128 256) x52) x240)))))
(assert (not x187))
(assert (= (=> (and (= x1035 (bvugt x978 x371)) (or (and x1035 (= x726 (bvadd x371 (_ bv644 256)))) (not x1035))) x109) x730))
