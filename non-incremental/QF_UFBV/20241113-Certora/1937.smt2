...
(define-fun x403 ((x260 (_ BitVec 256))) (_ BitVec 256) (ite x428 (x578 x260) (ite x1077 (x164 x260) (ite x929 (x393 x260) (ite x1073 (x893 x260) (x445 x260))))))
...
(assert (= (or x428 x1077 x929 x774 x1073) x579))
...
(assert (not x441))
(assert (bvult (_ bv10000 256) (x911 (_ bv64 256) x823 (_ bv62 256))))
...
(assert (not (x382 (x911 (_ bv64 256) x823 (_ bv62 256)))))
...
(assert (= (x379 (x911 (_ bv64 256) x823 (_ bv62 256))) x823))
...
(assert (= (x94 (x911 (_ bv64 256) x823 (_ bv62 256))) (_ bv62 256)))
...
(assert (= (_ bv0 256) (x909 (_ bv2380562969 256))))
...
(assert (= (x909 (x911 (_ bv64 256) x823 (_ bv62 256))) (x911 (_ bv64 256) x823 (_ bv62 256))))
...
(assert (x382 (_ bv2380562969 256)))
