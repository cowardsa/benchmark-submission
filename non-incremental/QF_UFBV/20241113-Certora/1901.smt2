...
(define-fun x868 ((x283 (_ BitVec 256))) (_ BitVec 256) (ite x122 (x890 x283) (ite x375 (x995 x283) (ite x648 (x83 x283) (ite x92 (x1056 x283) (x34 x283))))))
...
(assert (= (_ bv0 256) (x249 (_ bv4093489498 256))))
...
(assert (x725 (_ bv4093489498 256)))
...
(assert (= (and (not x1011) x935) x648))
...
(assert (= x122 (and x386 (not x1033))))
...
(assert (= x46 (or x122 x648 x92 x375 x201)))
