...
(define-fun x799 ((x121 (_ BitVec 256))) (_ BitVec 256) (ite x429 (x910 x121) (ite x815 (x147 x121) (ite x810 (x641 x121) (ite x469 (x80 x121) (x668 x121))))))
...
(assert (x52 (_ bv1950513463 256)))
(assert (= x492 (=> (and (= (x451 (_ bv608 256)) x932) (= x836 (not (bvugt x357 (_ bv128 256))))) (and x836 (=> (= (_ bv128 256) x741) x98)))))
(assert (not (x52 (x1064 (_ bv64 256) x544 (_ bv53 256)))))
(assert (= (and x711 x68) x804))
...
(assert (= (and (not x511) x238) x742))
(assert (= (x812 (bvadd (_ bv1 256) x693)) (x812 x693)))
(assert (= x10 (and x885 x182)))
(assert (= (and x924 (not x867)) x1004))
(assert (= (x154 (x1064 (_ bv64 256) x644 (_ bv54 256))) (_ bv64 256)))
(assert (= x122 (and (not x400) x776)))
(assert (= (or x10 x988) x754))
(assert (=> (bvuge (_ bv10000 256) x437) (= (_ bv0 256) (x812 x437))))
(assert (= (and x578 (not x666)) x989))
(assert (= (and (not x972) x291) x795))
(assert (= x64 (=> (and (= x905 (bvugt x640 x318)) (or (and x905 (= (bvadd (_ bv644 256) x318) x1053)) (not x905))) x184)))
(assert (= x98 (=> (and (= x157 (bvugt x741 x357)) (or (and (= (bvadd (_ bv644 256) x357) x967) x157) (not x157))) x791)))
...
(assert (= x950 (and x432 x757)))
(assert (= (and x549 x161) x963))
...
(assert (= (=> (and (= x148 (not (bvult (_ bv128 256) x220))) (= (x669 (_ bv608 256)) x203)) (and (=> (= (_ bv128 256) x958) x1059) x148)) x914))
(assert (= x922 (and x519 x963)))
...
(assert (= (x812 (_ bv1950513463 256)) (_ bv0 256)))
(assert (= x110 true))
...
(assert (= (and x106 (not x723)) x663))
(assert (= (x218 (x1064 (_ bv64 256) x284 (_ bv54 256))) x284))
(assert (= x497 (and (not x161) x549)))
(assert (= x578 (and x255 x321)))
(assert (= x798 (and x110 x245)))
(assert (= x876 (=> (and (= (x622 (_ bv608 256)) x446) (= (not (bvult (_ bv128 256) x318)) x833)) (and x833 (=> (= (_ bv128 256) x640) x64)))))
...
(assert (not x1014))
(assert (= (and x723 x106) x238))
(assert (= x711 (and x666 x578)))
...
(assert (= x72 (and x804 x144)))
(assert (= x123 (and (not x478) x447)))
(assert (= (and x157 x498) x631))
(assert (= (and x498 (not x157)) x322))
...
(assert (= x106 (and x291 x972)))
(assert (= x619 (or x469 x815 x429 x227 x810)))
...
(assert (= (=> (and (or (not x182) (and x182 (= (bvadd (_ bv644 256) x875) x530))) (= (bvugt x516 x875) x182)) x903) x364))
...
(assert (= x454 (=> (and (= (x269 (_ bv608 256)) x717) (= (not (bvugt x875 (_ bv128 256))) x1048)) (and (=> (= (_ bv128 256) x516) x364) x1048))))
