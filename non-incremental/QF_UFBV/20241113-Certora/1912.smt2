...
(define-fun x997 ((x38 (_ BitVec 256))) (_ BitVec 256) (ite (= (_ bv128 256) x38) (_ bv101303053088694494606861925597757802635279773212751656293157087116103218364416 256) (x26 x38)))
...
(define-fun x452 ((x38 (_ BitVec 256))) (_ BitVec 256) (ite x613 (x565 x38) (ite x1069 (x533 x38) (ite x690 (x818 x38) (ite x567 (x648 x38) (x572 x38))))))
...
(define-fun x845 ((x38 (_ BitVec 256))) (_ BitVec 256) (ite x875 (x596 x38) (x997 x38)))
...
(assert (= x364 (or x567 x690 x945 x1069 x613)))
...
(assert (= (and (not x1014) x902) x613))
(assert (= x875 (and x106 x20)))
(assert (= (x24 (bvadd (_ bv1 256) x1093)) (x24 x1093)))
(assert (= (_ bv0 256) (x24 (_ bv101303053088694494606861925597757802635279773212751656293157087116103218364416 256))))
...
(assert (= x1002 (and x181 (not x288))))
...
(assert (= (and x879 (not x766)) x690))
(assert (x679 (_ bv4071861181 256)))
...
(assert (= (_ bv0 256) (x24 (_ bv4071861181 256))))
...
(assert (= (and x161 x1019) x902))
(assert (= (and x768 x579) x507))
(assert (= x181 (and x846 x456)))
...
(assert (x679 (_ bv101303053088694494606861925597757802635279773212751656293157087116103218364416 256)))
...
(assert (= (and x879 x766) x1019))
(assert (= x1069 (and x1019 (not x161))))
