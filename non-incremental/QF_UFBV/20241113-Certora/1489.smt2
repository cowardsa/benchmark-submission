...
(assert (x47 (_ bv55872812666826790873254719658177832298163604279880832133641197521357099761664 256)))
...
(assert (= (x732 x192) (x732 (bvadd x192 (_ bv1 256)))))
...
(assert (= (x732 (_ bv2072437804 256)) (_ bv0 256)))
