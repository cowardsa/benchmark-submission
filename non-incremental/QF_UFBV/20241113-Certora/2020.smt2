...
(define-fun x464 ((x52 (_ BitVec 256))) (_ BitVec 256) (ite (= x52 (_ bv63 256)) x779 (x32 x52)))
...
(assert (= (x649 (_ bv1629339761 256)) (_ bv0 256)))
...
(assert (= (_ bv0 256) (x649 (_ bv43926913059227969994039843436467959244092213894144739379164533339694747877376 256))))
...
(assert (= (=> (and (and (= x287 (_ bv36 256)) (= (_ bv1629339761 256) x228) (= (bvand x554 (_ bv1461501637330902918203684832716283019655932542975 256)) x254) (= (_ bv96 256) x988) (= x622 x425) (= (_ bv36 256) x142) (= (x32 (_ bv63 256)) x12) (= x1119 x711) (= x848 (_ bv36 256)) (= (bvand (_ bv1461501637330902918203684832716283019655932542975 256) x199) x711) (= (_ bv96 256) x202) (= x1033 (_ bv1 256)) (= (bvadd x636 x999) x779) (= x848 (bvadd (bvneg (_ bv292 256)) x569)) (= x1014 x904) (= (bvudiv x22 (_ bv256 256)) x199) (= (bvadd x980 (_ bv292 256)) x569) (= x1080 (_ bv43926913059227969994039843436467959244092213894144739379164533339694747877376 256)) (= x1022 (_ bv96 256)) (= x30 x1014) (= x312 (_ bv292 256)) (= (x32 (_ bv0 256)) x22) (not (= x636 x254)) (= (x263 x688) x34) (bvule (_ bv1 256) x34) (= (x32 (_ bv63 256)) x554) (= (_ bv96 256) x331) (= x999 (bvand (_ bv115792089237316195423570985007226406215939081747436879206741300988257197096960 256) x12))) (and (= x125 x820) (= x275 (_ bv1143531618 256)) (bvuge (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639935 256) x59) (= x1100 x246) (= (not (= (_ bv0 256) x553)) x125) (= x231 (= x553 x59)) (bvule (_ bv0 256) x59) (= x164 (_ bv52 256)) (= (_ bv52 256) x171) x231 (= x59 (x134 x1100)) (= x1100 x622) (= (x210 (_ bv64 256) x1100 (_ bv53 256)) x705) (= x553 (x464 x705)) (= (not (= (ite x125 (_ bv1 256) (_ bv0 256)) (_ bv0 256))) x85) (bvule (_ bv1 256) x491) (= (x263 x688) x491))) (and (=> x85 x881) (=> (and (not x85) (and (= x120 x93) (= x328 x987) (= x93 false))) x1087))) x612))
...
(assert (x883 (_ bv43926913059227969994039843436467959244092213894144739379164533339694747877376 256)))
