...
(define-fun x149 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= (_ bv608 256) x640) (ite x78 (_ bv1 256) (_ bv0 256)) (x681 x640)))
(define-fun x232 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= (_ bv640 256) x640) (ite x751 (_ bv1 256) (_ bv0 256)) (x550 x640)))
(define-fun x411 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= x640 (_ bv672 256)) (ite x394 (_ bv1 256) (_ bv0 256)) (x402 x640)))
(define-fun x664 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= x640 (_ bv736 256)) (ite x456 (_ bv1 256) (_ bv0 256)) (x12 x640)))
...
(define-fun x808 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= (_ bv608 256) x640) (ite x246 (_ bv1 256) (_ bv0 256)) (x20 x640)))
(define-fun x93 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= (_ bv640 256) x640) (ite x895 (_ bv1 256) (_ bv0 256)) (x372 x640)))
(define-fun x587 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= x640 (_ bv672 256)) (ite x106 (_ bv1 256) (_ bv0 256)) (x770 x640)))
(define-fun x649 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= x640 (_ bv736 256)) (ite x497 (_ bv1 256) (_ bv0 256)) (x180 x640)))
...
(assert (= x545 (=> (and (and (and (= x637 x817) (= (x761 x297) x642) (= (x216 x81) x636) (= x177 x285) (= (x631 x81) x817) (= x601 x297) (bvule (_ bv1 256) x636) (= (_ bv671964649 256) x782) (= x642 x736) (= x270 (_ bv36 256))) (and (= x839 x177) (= true x742) (bvule (_ bv1 256) x655) (= x156 (_ bv128 256)) (= x676 (bvand (_ bv1461501637330902918203684832716283019655932542975 256) x908)) (= (bvult (_ bv0 256) x867) x360) (bvule (_ bv1 256) x412) (= x129 x839) (= (x216 x676) x655) (= (x765 (_ bv128 256)) x867) (= x187 (_ bv0 256)) (= x595 (bvadd (_ bv12557716990566177289638658165944178960098460730014837968835517675898432126976 256) x665)) (= (_ bv196 256) x132) (= x908 (x153 (_ bv61 256))) (= x850 (_ bv2644517106 256)) (= (bvand (_ bv26959946667150639794667015087019630673637144422540572481103610249215 256) x67) x665) (= x412 (x216 x300)) (= x67 (x315 (_ bv160 256))))) (and (bvule x56 (_ bv57896044618658097711785492504343953926634992332820282019728792003956564819967 256)) (= (_ bv0 256) x767) (= x747 (ite x43 x840 x311)) x747 (bvuge x56 (_ bv4 256)))) (and (=> (and (not x360) (= x775 (_ bv0 256))) x307) (=> (and x360 (and (= x510 (bvugt x867 (_ bv32 256))) (= x314 (x597 (_ bv160 256))))) (and (=> (and (not x510) (= (_ bv32 256) x775)) x307) (=> (and (and (= x618 (bvult (_ bv64 256) x867)) (= x733 (x597 (_ bv192 256)))) x510) (and (=> (and (and (= x863 (bvugt x867 (_ bv96 256))) (= (x597 (_ bv224 256)) x479)) x618) (and (=> (and (= (_ bv96 256) x775) (not x863)) x307) (=> x863 x2))) (=> (and (= (_ bv64 256) x775) (not x618)) x307)))))))))
