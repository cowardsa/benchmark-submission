...
(assert (= x1010 (=> (and (or (and (and (x347 x170 x438) (= x496 (bvmul x170 x438)) (= x1172 x496)) (not x406)) (and x406 (= x1172 (_ bv0 256)))) (and (= (_ bv576 256) x1103) (= (bvadd x1043 x438) x60) (= x945 (_ bv1000000000000000000 256)) (= x406 (= x170 (_ bv0 256))) (not (bvugt x438 (bvadd x438 x1043))) (= (bvudiv x336 (_ bv1000000000000000000 256)) x438))) x631)))
...
(assert (= (_ bv0 256) (x827 (_ bv1351606815 256))))
...
(assert (= x631 (=> (and (and (not (bvult (bvadd x1032 x784) x784)) (= (_ bv640 256) x1051) (= (bvudiv x1172 (_ bv1000000000000000000 256)) x784) (= (_ bv1000000000000000000 256) x351) (= x1019 (bvadd x784 x1032)) (= (= (_ bv0 256) x447) x244)) (or (and x244 (= (_ bv0 256) x346)) (and (not x244) (and (x347 x447 x1027) (= x346 x943) (= (bvmul x1027 x447) x943))))) x159)))
...
(assert (x253 (_ bv1351606815 256)))
...
(assert (= x159 (=> (and (= (_ bv704 256) x1137) (= x570 x1149) (= (bvudiv x346 (_ bv1000000000000000000 256)) x110) (= (bvadd x110 x1027) x175) (not (bvugt x110 (bvadd x1027 x110)))) x152)))
