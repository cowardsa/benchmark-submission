...
(define-fun x485 ((x767 (_ BitVec 256))) (_ BitVec 256) (ite (= x767 (_ bv60 256)) x271 (x274 x767)))
...
(assert (x815 (_ bv1545948433 256)))
...
(assert (= (_ bv0 256) (x894 (_ bv1545948433 256))))
