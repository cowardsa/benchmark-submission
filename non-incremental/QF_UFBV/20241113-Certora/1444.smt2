...
(define-fun x42 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite x428 (x154 x640) (ite x458 (x893 x640) (ite x568 (x440 x640) (ite x386 (x172 x640) (x858 x640))))))
(define-fun x520 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= x79 x640) (_ bv0 256) (x42 x640)))
(define-fun x450 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite x578 (x888 x640) (ite x885 (x891 x640) (ite x58 (x335 x640) (ite x902 (x781 x640) (x556 x640))))))
...
(assert (= x439 (or x428 x458 x65 x386 x568)))
...
(assert (x516 (_ bv4112390170 256)))
...
(assert (= (_ bv0 256) (x88 (_ bv4112390170 256))))
