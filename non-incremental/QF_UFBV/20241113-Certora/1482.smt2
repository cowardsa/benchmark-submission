...
(assert (x47 (_ bv20375094138672698079285525013494130279933481487013111337324235730670499921920 256)))
...
(assert (= (x732 x192) (x732 (bvadd x192 (_ bv3 256)))))
...
(assert (= (x732 (_ bv755754245 256)) (_ bv0 256)))
