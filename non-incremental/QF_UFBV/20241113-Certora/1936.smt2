...
(define-fun x799 ((x121 (_ BitVec 256))) (_ BitVec 256) (ite x281 (x910 x121) (ite x429 (x147 x121) (ite x815 (x641 x121) (ite x469 (x983 x121) (x668 x121))))))
...
(assert (= (x812 (_ bv135776137 256)) (_ bv0 256)))
(assert (= x110 true))
