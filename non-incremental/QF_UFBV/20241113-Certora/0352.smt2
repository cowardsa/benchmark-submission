...
(define-fun x641 ((x43 (_ BitVec 256))) (_ BitVec 256) (ite (= x768 x43) x469 (x178 x43)))
...
(define-fun x188 ((x43 (_ BitVec 256))) (_ BitVec 256) (ite (= x43 x768) x420 (x240 x43)))
...
(define-fun x108 ((x43 (_ BitVec 256))) (_ BitVec 256) (ite (= x43 x895) x768 (x252 x43)))
...
(define-fun x373 ((x43 (_ BitVec 256))) (_ BitVec 256) (ite (= x768 x43) x703 (x853 x43)))
...
(define-fun x697 ((x43 (_ BitVec 256))) (_ BitVec 256) (ite (= x768 x43) x321 (x434 x43)))
(define-fun x377 ((x43 (_ BitVec 256))) (_ BitVec 256) (ite x218 (x853 x43) (ite x805 (x349 x43) (x697 x43))))
(define-fun x866 ((x43 (_ BitVec 256))) (_ BitVec 256) (ite (= x43 x768) x460 (x377 x43)))
...
(assert (= (x588 (x20 (_ bv64 256) x768 (_ bv0 256))) x768))
...
(assert (= (_ bv64 256) (x297 (x20 (_ bv64 256) x768 (_ bv0 256)))))
...
(assert (bvugt (x20 (_ bv64 256) x768 (_ bv0 256)) (_ bv10000 256)))
...
(assert (= (x432 (x20 (_ bv64 256) x768 (_ bv0 256))) (x20 (_ bv64 256) x768 (_ bv0 256))))
...
(assert (= (and x220 x158) x468))
(assert (= x239 (or x826 x226 x468 x22)))
