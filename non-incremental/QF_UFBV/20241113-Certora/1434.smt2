...
(define-fun x471 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= x640 (_ bv128 256)) (ite x589 (_ bv1 256) (_ bv0 256)) (x745 x640)))
...
(define-fun x698 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= (_ bv128 256) x640) (ite x898 (_ bv1 256) (_ bv0 256)) (x871 x640)))
...
(define-fun x666 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite x644 (x845 x640) (ite x816 (x222 x640) (ite x762 (x821 x640) (ite x793 (x591 x640) (x526 x640))))))
(define-fun x723 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= x686 x640) (_ bv0 256) (x666 x640)))
(define-fun x707 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite x482 (x22 x640) (ite x675 (x258 x640) (ite x225 (x27 x640) (ite x262 (x433 x640) (x292 x640))))))
(define-fun x404 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= x640 x72) (_ bv0 256) (x707 x640)))
(define-fun x42 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite x458 (x154 x640) (ite x568 (x893 x640) (ite x725 (x440 x640) (ite x386 (x172 x640) (x858 x640))))))
(define-fun x520 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite (= x79 x640) (_ bv0 256) (x42 x640)))
(define-fun x450 ((x640 (_ BitVec 256))) (_ BitVec 256) (ite x885 (x888 x640) (ite x58 (x891 x640) (ite x283 (x335 x640) (ite x902 (x781 x640) (x556 x640))))))
...
(assert (= x578 (and x276 x76)))
(assert (= (and (not x557) x513) x458))
...
(assert (= x439 (or x458 x568 x65 x386 x725)))
...
(assert (x516 (_ bv2423977664 256)))
...
(assert (= (and x557 x513) x65))
(assert (= (and x740 x378) x428))
...
(assert (= (_ bv0 256) (x88 (_ bv2423977664 256))))
