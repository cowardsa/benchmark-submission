...
(define-fun x797 ((x582 (_ BitVec 256))) (_ BitVec 256) (ite x200 (x688 x582) (ite x633 (x770 x582) (ite x551 (x606 x582) (ite x883 (x29 x582) (x686 x582))))))
...
(assert (= (or x551 x636 x200 x633 x883) x535))
...
(assert (= x386 (and x276 x557)))
(assert (= (_ bv32 256) (x204 (x131 (_ bv32 256) x479))))
(assert (= x633 (and (not x676) x16)))
