...
(define-fun x467 ((x236 (_ BitVec 256))) (_ BitVec 256) (ite (= (_ bv59 256) x236) x602 (x117 x236)))
...
(assert (= (x286 (_ bv1599795626 256)) (_ bv0 256)))
