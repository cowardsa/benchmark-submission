...
(define-fun x477 ((x52 (_ BitVec 256))) (_ BitVec 256) (ite x607 (x968 x52) (ite x762 (ite x169 (x820 x52) (x527 x52)) (x724 x52))))
...
(assert (= x321 (and x42 x735)))
(assert (= x698 (and (not x254) x531)))
...
(assert (= (=> (and (= (= x731 x1016) x881) x881 (= x839 (= x480 x919)) (= (= x617 x920) x269) x269 (= x339 x920) (= x617 x822) (= x441 x480) (= x754 x458) (= (not (= (_ bv0 256) (ite x458 (_ bv1 256) (_ bv0 256)))) x731)) (and (=> x839 x871) (=> (and (not x839) (and (= (_ bv0 256) x44) (= x395 x670) (= x729 x44))) x981))) x824))
(assert (= x786 (or x838 x960)))
...
(assert (= x322 (=> (and (= x536 (x646 (_ bv128 256))) (= x369 (_ bv32 256)) (= x139 (_ bv128 256)) (= (bvugt x536 (_ bv0 256)) x658)) (and (=> (not x658) x448) (=> (and (= x456 (bvugt x536 (_ bv32 256))) x658) (and (=> (not x456) x448) (=> (and x456 (= (bvult (_ bv64 256) x536) x926)) (and (=> (and x926 (= (bvult (_ bv96 256) x536) x91)) (and (=> (not x91) x448) (=> x91 x685))) (=> (not x926) x448)))))))))
(assert (=> (bvule x358 (_ bv10000 256)) (= (x835 x358) (_ bv0 256))))
(assert (= (and (not x839) x715) x62))
(assert (bvugt (x681 (_ bv64 256) x518 (_ bv71 256)) (_ bv10000 256)))
(assert (= x246 (or x131 x435)))
...
(assert (= x526 (and (not x397) x149)))
(assert (x426 (_ bv117300739 256)))
...
(assert (= (=> (and (= (ite x839 x395 x729) x793) (= x947 (and x707 x935)) (= x935 (= x939 x677)) (= x441 x677)) (and (=> x947 x18) (=> (and (and (= x641 (_ bv0 256)) (= x569 x966) (= x487 x641)) (not x947)) x285))) x981))
(assert (= x704 (and x839 x715)))
...
(assert (bvugt (x387 (_ bv32 256) (_ bv3 256)) (_ bv10000 256)))
...
(assert (= x999 (and x918 x866)))
(assert (= x930 x322))
(assert (= (x835 (_ bv117300739 256)) (_ bv0 256)))
...
(assert (= (and (not x735) x42) x902))
(assert (x426 (_ bv20282409603651670423947251286015 256)))
(assert (= x896 (or x690 x846)))
(assert (= x883 (or x834 x145)))
...
(assert (= (and x311 x340) x112))
(assert (= x98 (and (not x467) x82)))
...
(assert (= (=> (and (= false x540) (and (and (= (bvadd (bvneg x538) x410) x603) (= x603 x395) (= x538 (bvmul (bvudiv x370 (_ bv10000000000 256)) (_ bv10000000000 256))) (= x729 x325)) (and (= x410 (bvmul (bvudiv x804 (_ bv10000000000 256)) (_ bv10000000000 256))) (= false x434)))) x981) x871))
...
(assert (= x169 (and (not x802) x999)))
(assert (= (=> (and (= x125 (not (bvugt x60 (_ bv224 256)))) (= x858 (x830 x424))) (and x125 x930)) x816))
(assert (= x674 (and x743 (not x663))))
(assert (=> (bvuge (_ bv10000 256) x701) (= (_ bv0 256) (x835 x701))))
(assert (bvult (_ bv10000 256) (x681 (_ bv64 256) x502 (_ bv0 256))))
(assert (= x123 (and (not x1006) x80)))
...
(assert (not (x426 (x387 (_ bv32 256) (_ bv3 256)))))
...
(assert (= x743 (or (and x799 (not x456)) (and x882 (not x658)) x257 (and (not x91) x717) (and x991 (not x926)))))
(check-sat)
(exit)
