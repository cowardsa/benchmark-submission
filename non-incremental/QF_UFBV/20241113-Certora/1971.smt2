...
(define-fun x483 ((x121 (_ BitVec 256))) (_ BitVec 256) (ite (= (_ bv644 256) x121) x343 (x299 x121)))
...
(assert (= x206 (=> (and (or (and x157 (= (bvadd (_ bv644 256) x220) x1061)) (not x157)) (= x157 (bvugt x213 x220))) x824)))
(assert (= (and x148 x429) x281))
(assert (= (x812 (bvadd x657 (_ bv1 256))) (x812 x657)))
(assert (= (and x456 (not x432)) x619))
(assert (=> (bvuge (_ bv10000 256) x41) (= (x812 x41) (_ bv0 256))))
(assert (=> (bvuge (_ bv10000 256) x962) (= (x812 x962) (_ bv0 256))))
(assert (= (=> (and (and (= x572 (bvand x130 (_ bv26959946667150639794667015087019630673637144422540572481103610249215 256))) (= (bvugt x357 (_ bv0 256)) x326) (= (x769 (_ bv480 256)) x357) (= x542 x644) (= (x725 x1053) x944) (= (_ bv548 256) x152) (= (bvand (_ bv1461501637330902918203684832716283019655932542975 256) x1031) x677) (= x1031 (x921 (_ bv61 256))) (= x644 x765) (bvule (_ bv1 256) x528) (= true x478) (= (_ bv0 256) x814) (= x827 (bvadd (_ bv8201566632893150923963993786005714124394006047134357091761987320195290497024 256) x572)) (= x964 (_ bv304213014 256)) (= x528 (x725 x677)) (= (_ bv480 256) x509) (= x130 (x66 (_ bv512 256))) (bvuge x944 (_ bv1 256))) (and (= x17 x559) (= (_ bv36 256) x208) (= x17 x740) (= x740 x765))) (and (=> (and (not x326) (= (_ bv0 256) x92)) x171) (=> (and (and (= (x451 (_ bv512 256)) x741) (= x1048 (bvugt x357 (_ bv32 256)))) x326) (and (=> (and (= x92 (_ bv32 256)) (not x1048)) x171) (=> (and x1048 (and (= x5 (x451 (_ bv544 256))) (= (bvult (_ bv64 256) x357) x972))) (and (=> (and (and (= (x451 (_ bv576 256)) x932) (= (bvult (_ bv96 256) x357) x723)) x972) (and (=> x723 x493) (=> (and (= x92 (_ bv96 256)) (not x723)) x171))) (=> (and (not x972) (= (_ bv64 256) x92)) x171))))))) x567))
...
(assert (= x389 (=> (and (= x432 (bvugt x640 x318)) (or (and x432 (= (bvadd (_ bv644 256) x318) x516)) (not x432))) x184)))
(assert (= x171 (=> (and (= x182 (bvugt x92 x357)) (or (and (= (bvadd (_ bv644 256) x357) x857) x182) (not x182))) x791)))
...
(assert (= (and (not x1035) x988) x885))
...
(assert (= (x812 (_ bv2423977664 256)) (_ bv0 256)))
(assert (= x110 true))
...
(assert (= (=> (and (or (not x1035) (and x1035 (= (bvadd (_ bv644 256) x875) x201))) (= (bvugt x116 x875) x1035)) x903) x491))
