...
(assert (= x1059 (=> (and (or (and x182 (= (bvadd (_ bv644 256) x220) x857)) (not x182)) (= x182 (bvugt x213 x220))) x824)))
...
(assert (= x492 (=> (and (= (x451 (_ bv608 256)) x993) (= x511 (not (bvugt x357 (_ bv128 256))))) (and x511 (=> (= (_ bv128 256) x92) x98)))))
...
(assert (= x64 (=> (and (= x157 (bvugt x640 x318)) (or (and x157 (= (bvadd (_ bv644 256) x318) x606)) (not x157))) x184)))
(assert (= x98 (=> (and (= x1035 (bvugt x92 x357)) (or (and (= (bvadd (_ bv644 256) x357) x201) x1035) (not x1035))) x791)))
...
(assert (= (=> (and (or (not x724) (and x724 (= (bvadd (_ bv644 256) x875) x1053))) (= (bvugt x186 x875) x724)) x903) x364))
...
(assert (= x454 (=> (and (= (x269 (_ bv608 256)) x889) (= (not (bvugt x875 (_ bv128 256))) x519)) (and (=> (= (_ bv128 256) x186) x364) x519))))
