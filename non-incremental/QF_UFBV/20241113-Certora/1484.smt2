...
(define-fun x875 ((x272 (_ BitVec 256))) (_ BitVec 256) (ite (= (_ bv64 256) x272) x569 (x145 x272)))
...
(assert (= (x641 (_ bv1235694526 256)) (_ bv0 256)))
...
(assert (x253 (_ bv33314258517849989611667794535789571277955111873204816427805969623793706991616 256)))
(assert x26)
...
(assert (= (x641 (_ bv33314258517849989611667794535789571277955111873204816427805969623793706991616 256)) (_ bv0 256)))
...
(assert (x253 (_ bv1235694526 256)))
