...
(declare-const sslice@ lib!marshalling.Slice_v.Slice.)
(declare-const parsed_len@ Poly)
...
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.Slice_v.impl&%1.len. (%Poly%lib!marshalling.Slice_v.Slice. dslice!))) (=> (ens%lib!marshalling.Slice_v.impl&%1.len. (%Poly%lib!marshalling.Slice_v.Slice. dslice!) tmp%1) (or (and (=> (< (uClip SZ tmp%1) (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/total_size (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!))) (=> (= %return! (Poly%core!option.Option. core!option.Option./None)) (and (=> %%location_label%%1 (= (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (%B (lib!marshalling.SeqMarshalling_v.SeqMarshal.lengthable.? $ (TYPE%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. EltFormat&. EltFormat& LenType&. LenType&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))) (=> %%location_label%%2 (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (= (core!option.Option./Some/0 (%Poly%core!option.Option. %return!)) (lib!marshalling.SeqMarshalling_v.SeqMarshal.length.? $ (TYPE%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. EltFormat&. EltFormat& LenType&. LenType&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))))))) (=> (not (< (uClip SZ tmp%1) (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/total_size (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= tmp%3 (Poly%lib!marshalling.IntegerMarshalling_v.IntFormat. (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/lenf (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!)))) (=> (ens%lib!marshalling.IntegerMarshalling_v.impl&%14.exec_uniform_size. LenType&. LenType& tmp%3 tmp%2) (and (=> %%location_label%%3 (req%lib!marshalling.Slice_v.impl&%1.subslice. (%Poly%lib!marshalling.Slice_v.Slice. dslice!) 0 (%I tmp%2))) (=> (ens%lib!marshalling.Slice_v.impl&%1.subslice. (%Poly%lib!marshalling.Slice_v.Slice. dslice!) 0 (%I tmp%2) sslice@) (=> (= tmp%4 (Poly%lib!marshalling.IntegerMarshalling_v.IntFormat. (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/lenf (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!)))) (and (=> %%location_label%%4 (req%lib!marshalling.Marshalling_v.Marshal.exec_parse. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. LenType&. LenType&) tmp%4 (Poly%lib!marshalling.Slice_v.Slice. sslice@) data!)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.exec_parse. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. LenType&. LenType&) tmp%4 (Poly%lib!marshalling.Slice_v.Slice. sslice@) data! parsed_len@) (=> (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.Slice_v.impl&%0.subslice.? (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (I 0) (lib!marshalling.UniformSized_v.UniformSized.uniform_size.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. LenType&. LenType&) (Poly%lib!marshalling.IntegerMarshalling_v.IntFormat. (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/lenf (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!)))))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)) (vstd!seq.Seq.subrange.? $ (UINT 8) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)) (I 0) (I (lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.size_of_length_field.? EltFormat&. EltFormat& LenType&. LenType& self!))))) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.deepv_is_as_int. LenType&. LenType& parsed_len@) (=> (= tmp%6 (%Poly%vstd!seq.Seq<u8.>. (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))) (=> (ens%lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.length_ensures. EltFormat&. EltFormat& LenType&. LenType& (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!) tmp%6) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.to_usize. LenType&. LenType& parsed_len@ tmp%7) (=> (= %return! (Poly%core!option.Option. (core!option.Option./Some tmp%7))) (and (=> %%location_label%%6 (= (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (%B (lib!marshalling.SeqMarshalling_v.SeqMarshal.lengthable.? $ (TYPE%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. EltFormat&. EltFormat& LenType&. LenType&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))) (=> %%location_label%%7 (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (= (core!option.Option./Some/0 (%Poly%core!option.Option. %return!)) (lib!marshalling.SeqMarshalling_v.SeqMarshal.length.? $ (TYPE%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. EltFormat&. EltFormat& LenType&. LenType&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))))))))))))))))))))))))))
(check-sat)
(exit)
