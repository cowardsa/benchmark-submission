...
(assert (> (lib!bin_sizes.size_of_bin.? (I bin_idx!)) lib!config.SMALL_SIZE_MAX.?))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!bin_sizes.lemma_bin_sizes_constants. 0) (=> %%location_label%%0 (>= (lib!bin_sizes.pfd_lower.? (I bin_idx!)) lib!config.PAGES_DIRECT.?)))))
(check-sat)
(exit)
