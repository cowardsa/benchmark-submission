...
(assert (has_type (Poly%lib!types.PagePtr. page_ptr!) TYPE%lib!types.PagePtr.))
...
(assert (not (and (=> %%location_label%%0 (req%lib!layout.impl&%0.ptr_segment. page_ptr!)) (=> (ens%lib!layout.impl&%0.ptr_segment. page_ptr! segment_ptr@) (and (=> %%location_label%%1 (req%lib!layout.segment_page_start_from_slice. segment_ptr@ page_ptr! block_size!)) (=> (ens%lib!layout.segment_page_start_from_slice. segment_ptr@ page_ptr! block_size! tmp%1) (=> (= addr! tmp%1) (=> %%location_label%%2 (= addr! (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!)))) (I block_size!) (I 0)))))))))))
(check-sat)
(exit)
