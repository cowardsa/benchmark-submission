...
(assert (not (=> (ens%lib!definitions_t.axiom_max_phyaddr_width_facts. 0) (and (=> %%location_label%%0 true) (=> (= (uClip 64 (bitshl (I 1) (I 32))) 4294967296) (and (=> %%location_label%%1 true) (=> (forall ((m$ Poly) (n$ Poly)) (! (=> (and (has_type m$ (UINT 64)) (has_type n$ (UINT 64))) (=> (and (< (%I n$) (%I m$)) (< (%I m$) 64)) (< (uClip 64 (bitshl (I 1) (I (%I n$)))) (uClip 64 (bitshl (I 1) (I (%I m$))))))) :pattern ((uClip 64 (bitshl (I 1) (I (%I n$)))) (uClip 64 (bitshl (I 1) (I (%I m$))))))) (and (=> %%location_label%%2 (and (<= 0 lib!definitions_t.MAX_PHYADDR_WIDTH.?) (< lib!definitions_t.MAX_PHYADDR_WIDTH.? 64))) (and (=> %%location_label%%3 (uInv 64 (Sub (uClip 64 (bitshl (I 1) (I lib!definitions_t.MAX_PHYADDR_WIDTH.?))) 1))) (=> (= %return! (uClip 64 (Sub (uClip 64 (bitshl (I 1) (I lib!definitions_t.MAX_PHYADDR_WIDTH.?))) 1))) (=> %%location_label%%4 (= %return! lib!definitions_t.MAX_PHYADDR_SPEC.?))))))))))))
(check-sat)
(exit)
