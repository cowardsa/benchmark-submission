...
(assert (not (=> (ens%lib!config.const_facts. 0) (or (and (=> (or (<= try_alignment! 1) (> try_alignment! (uClip SZ lib!config.SEGMENT_SIZE.?))) (=> (= hint! 0) (and (=> %%location_label%%0 (=> (not (= try_alignment! 0)) (= (uClip SZ (EucMod hint! try_alignment!)) 0))) (=> %%location_label%%1 (=> (<= try_alignment! 1) (= hint! 0)))))) (=> (not (or (<= try_alignment! 1) (> try_alignment! (uClip SZ lib!config.SEGMENT_SIZE.?)))) %%switch_label%%3)) (and (not %%switch_label%%3) (=> (= tmp%1 (uClip SZ lib!config.SEGMENT_SIZE.?)) (and (=> %%location_label%%2 (req%lib!layout.align_up. size! tmp%1)) (=> (ens%lib!layout.align_up. size! tmp%1 size@) (and (=> %%location_label%%3 (uInv SZ (Mul 1024 1024))) (and (=> %%location_label%%4 (uInv SZ (Mul (uClip SZ (Mul 1024 1024)) 1024))) (or (and (=> (> size@ (uClip SZ (Mul (uClip SZ (Mul 1024 1024)) 1024))) (=> (= hint! 0) (and (=> %%location_label%%5 (=> (not (= try_alignment! 0)) (= (uClip SZ (EucMod hint! try_alignment!)) 0))) (=> %%location_label%%6 (=> (<= try_alignment! 1) (= hint! 0)))))) (=> (not (> size@ (uClip SZ (Mul (uClip SZ (Mul 1024 1024)) 1024)))) %%switch_label%%2)) (and (not %%switch_label%%2) (=> (ens%lib!os_alloc.aligned_base_add. size@ hint@0) (or (and (=> (or (= hint@0 0) (> hint@0 lib!os_alloc.HINT_MAX.?)) (=> (= iinit@ lib!os_alloc.HINT_BASE.?) (=> (ens%core!num.impl&%11.wrapping_add. hint@0 size@ expected@) (=> (ens%lib!os_alloc.aligned_base_add. size@ hint@1) %%switch_label%%1)))) (=> (not (or (= hint@0 0) (> hint@0 lib!os_alloc.HINT_MAX.?))) (=> (= hint@1 hint@0) %%switch_label%%1))) (and (not %%switch_label%%1) (and (=> %%location_label%%7 (not (= try_alignment! 0))) (or (and (=> (not (= (uClip SZ (EucMod hint@1 try_alignment!)) 0)) (=> (= hint! 0) (and (=> %%location_label%%8 (=> (not (= try_alignment! 0)) (= (uClip SZ (EucMod hint! try_alignment!)) 0))) (=> %%location_label%%9 (=> (<= try_alignment! 1) (= hint! 0)))))) (=> (not (not (= (uClip SZ (EucMod hint@1 try_alignment!)) 0))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= hint! hint@1) (and (=> %%location_label%%10 (=> (not (= try_alignment! 0)) (= (uClip SZ (EucMod hint! try_alignment!)) 0))) (=> %%location_label%%11 (=> (<= try_alignment! 1) (= hint! 0)))))))))))))))))))))))
(check-sat)
(exit)
