...
(assert (has_type (Poly%main!logimpl_v.PersistentHeader. header!) TYPE%main!logimpl_v.PersistentHeader.))
(assert (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?))
(assert (or (= header_pos! main!logimpl_v.header1_pos.?) (= header_pos! main!logimpl_v.header2_pos.?)))
(assert (= (main!logimpl_v.spec_bytes_to_header.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (I (Add header_pos! main!logimpl_v.header_size.?)))) header!))
...
(assert (not (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (I (Add header_pos! main!logimpl_v.header_size.?))) (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! main!logimpl_v.header_crc_offset.?)) (I (Add (Add header_pos! main!logimpl_v.header_crc_offset.?) 8))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! main!logimpl_v.header_head_offset.?)) (I (Add header_pos! main!logimpl_v.header_size.?)))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! main!logimpl_v.header_crc_offset.?)) (I (Add (Add header_pos! main!logimpl_v.header_crc_offset.?) 8))))) (=> (= tmp%3 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! main!logimpl_v.header_head_offset.?)) (I (Add header_pos! main!logimpl_v.header_size.?))))) (and (=> %%location_label%%1 (req%main!logimpl_v.lemma_bytes_combine_into_header. tmp%2 tmp%3 header!)) (=> (ens%main!logimpl_v.lemma_bytes_combine_into_header. tmp%2 tmp%3 header!) (=> %%location_label%%2 (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (and (=> (= header_pos! main!logimpl_v.header1_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. headers$))) header!)) (=> (= header_pos! main!logimpl_v.header2_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. headers$))) header!)))))))))))))))
(check-sat)
(exit)
