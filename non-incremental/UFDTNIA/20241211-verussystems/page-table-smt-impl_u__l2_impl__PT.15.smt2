...
(declare-const pt1! lib!impl_u.l2_impl.PTDir.)
(declare-const mem2! lib!spec_t.mem.PageTableMemory.)
(declare-const pt2! lib!impl_u.l2_impl.PTDir.)
...
(declare-const tmp%6 vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>.)
(declare-const i@ Poly)
(declare-const tmp%7 Int)
(declare-const tmp%8 Bool)
(declare-const e_base@ Int)
...
(assert (has_type (Poly%lib!impl_u.l2_impl.PTDir. pt1!) TYPE%lib!impl_u.l2_impl.PTDir.))
(assert (has_type (Poly%lib!impl_u.l2_impl.PTDir. pt2!) TYPE%lib!impl_u.l2_impl.PTDir.))
(assert (<= 0 layer!))
(assert (uInv SZ ptr!))
(assert (<= 0 base!))
(assert (<= 0 idx!))
(assert (< idx! lib!definitions_t.X86_NUM_ENTRIES.?))
(assert (= (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt2!))) (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt1!)))))
(assert (= (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt2!)))) (I idx!)) (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt1!)))) (I idx!))))
(assert (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt1!) (I layer!) (I ptr!)))
(assert (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt2!) (I layer!) (I ptr!)))
(assert (= (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt1!) (I layer!) (I ptr!) (I idx!)) (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt2!) (I layer!) (I ptr!) (I idx!))))
...
(assert (not (=> (= decrease%init0 (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!)) (=> (= tmp%%@ (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt1!) (I layer!) (I ptr!) (I idx!))) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%@) (=> (= dir_addr@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@)))) (=> (= e_base@ (lib!definitions_t.entry_base_from_index.? (I base!) (I idx!) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I layer!))))) (=> (= dir_pt@ (%Poly%lib!impl_u.l2_impl.PTDir. (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt1!)))) (I idx!)))))) (=> (= tmp%1 (lib!impl_u.l2_impl.PT.directories_obey_invariant_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt1!) (I layer!) (I ptr!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (lib!impl_u.l2_impl.PT.directories_obey_invariant_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt2!) (I layer!) (I ptr!))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (nClip (Add layer! 1))) (=> (= tmp%4 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (vstd!seq.Seq.empty.? $ TYPE%lib!impl_u.l1.NodeEntry.))) (and (=> %%location_label%%2 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_aux_facts. mem1! dir_pt@ tmp%3 dir_addr@ e_base@ tmp%4)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_aux_facts. mem1! dir_pt@ tmp%3 dir_addr@ e_base@ tmp%4) (=> (= tmp%5 (nClip (Add layer! 1))) (=> (= tmp%6 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (vstd!seq.Seq.empty.? $ TYPE%lib!impl_u.l1.NodeEntry.))) (and (=> %%location_label%%3 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_aux_facts. mem2! dir_pt@ tmp%5 dir_addr@ e_base@ tmp%6)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_aux_facts. mem2! dir_pt@ tmp%5 dir_addr@ e_base@ tmp%6) (and (=> (has_type i@ NAT) (=> (< (%I i@) lib!definitions_t.X86_NUM_ENTRIES.?) (=> (= tmp%7 (nClip (Add layer! 1))) (and (=> %%location_label%%4 (check_decrease_int (let ((mem1!$0 mem1!) (pt1!$1 dir_pt@) (mem2!$2 mem2!) (pt2!$3 dir_pt@) (layer!$4 tmp%7) (ptr!$5 dir_addr@) (base!$6 e_base@) (idx!$7 (%I i@))) (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!$4)) decrease%init0 false)) (and (=> %%location_label%%5 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_entry_different_memory. mem1! dir_pt@ mem2! dir_pt@ tmp%7 dir_addr@ e_base@ (%I i@))) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_entry_different_memory. mem1! dir_pt@ mem2! dir_pt@ tmp%7 dir_addr@ e_base@ (%I i@)) (=> %%location_label%%6 (and (= (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@) i@) (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@) i@)) (= (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@)))))) i@) (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@)))))) i@)))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) lib!definitions_t.X86_NUM_ENTRIES.?) (and (= (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@) i$) (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@) i$)) (= (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@)))))) i$) (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@)))))) i$))))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@)))))) i$)))) (=> (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ TYPE%lib!impl_u.l1.NodeEntry.) (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@)))))) (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. dir_pt@) (I (nClip (Add layer! 1))) (I dir_addr@) (I e_base@)))))))) (and (=> %%location_label%%7 tmp%8) (=> tmp%8 %%switch_label%%0))))))))))))))))))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%8 (= (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt1!) (I layer!) (I ptr!) (I base!) (I idx!)) (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt2!) (I layer!) (I ptr!) (I base!) (I idx!))))))))))
(check-sat)
(exit)
