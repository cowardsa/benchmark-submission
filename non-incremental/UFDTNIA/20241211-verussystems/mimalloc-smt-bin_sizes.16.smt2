...
(assert (not (=> (= decrease%init0 (Sub bin_idx_end! bin_idx_start!)) (or (and (=> (>= bin_idx_start! bin_idx_end!) %%switch_label%%0) (=> (not (>= bin_idx_start! bin_idx_end!)) (=> (= tmp%1 (Add bin_idx_start! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((bin_idx_start!$0 tmp%1) (bin_idx_end!$1 bin_idx_end!)) (Sub bin_idx_end!$1 bin_idx_start!$0)) decrease%init0 false)) (=> (ens%lib!bin_sizes.result_smallest_bin_fitting_size_size_of_bin. tmp%1 bin_idx_end!) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%1 (=> (lib!bin_sizes.check_smallest_bin_fitting_size_size_of_bin.? (I bin_idx_start!) (I bin_idx_end!)) (forall ((bin_idx$ Poly)) (! (=> (has_type bin_idx$ INT) (=> (and (<= bin_idx_start! (%I bin_idx$)) (< (%I bin_idx$) bin_idx_end!)) (lib!bin_sizes.property_smallest_bin_fitting_size_size_of_bin.? bin_idx$))) :pattern ((lib!bin_sizes.property_smallest_bin_fitting_size_size_of_bin.? bin_idx$)))))))))))
(check-sat)
(exit)
