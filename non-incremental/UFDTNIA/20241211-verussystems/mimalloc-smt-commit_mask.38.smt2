...
(set-info :comment ";; Function-Def lib::commit_mask::CommitMask::next_run")
(set-info :comment ";; commit_mask.rs:648:13: 700:14 (#0)")
(set-info :comment ";; Function-Def lib::commit_mask::CommitMask::next_run")
(set-info :comment ";; commit_mask.rs:588:5: 588:63 (#0)")
(set-info :comment ";; Function-Specs lib::commit_mask::CommitMask::is_empty")
(declare-fun ens%lib!commit_mask.impl&%0.is_empty. (lib!commit_mask.CommitMask. Bool) Bool)
(assert (forall ((self! lib!commit_mask.CommitMask.) (b! Bool)) (! (= (ens%lib!commit_mask.impl&%0.is_empty. self! b!) (= b! (= (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!)) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.empty.? $ INT))))) :pattern ((ens%lib!commit_mask.impl&%0.is_empty. self! b!)))))
(set-info :comment ";; Function-Def lib::commit_mask::CommitMask::is_empty")
(set-info :comment ";; commit_mask.rs:715:9: 728:10 (#0)")
(set-info :comment ";; Function-Def lib::commit_mask::CommitMask::is_empty")
(set-info :comment ";; commit_mask.rs:711:5: 711:39 (#0)")
(set-info :comment ";; Function-Specs lib::commit_mask::CommitMask::is_full")
(declare-fun ens%lib!commit_mask.impl&%0.is_full. (lib!commit_mask.CommitMask. Bool) Bool)
(assert (forall ((self! lib!commit_mask.CommitMask.) (b! Bool)) (! (= (ens%lib!commit_mask.impl&%0.is_full. self! b!) (= b! (= (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!)) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1. $ INT $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%1 0 lib!config.COMMIT_MASK_BITS.?)))))))) :pattern ((ens%lib!commit_mask.impl&%0.is_full. self! b!)))))
(set-info :comment ";; Function-Def lib::commit_mask::CommitMask::is_full")
(set-info :comment ";; commit_mask.rs:741:9: 756:10 (#0)")
...
(assert (not (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) (uClip SZ (bitnot (I 0)))))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)))) (=> (< i@0 8) (=> (= tmp%2 (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!)))) (and (=> %%location_label%%0 (req%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%2 i@0)) (=> (ens%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%2 i@0 tmp%1) (or (and (=> (not (= (%I tmp%1) (uClip SZ (bitnot (I 0))))) (=> (ens%lib!config.const_facts. 0) (=> (ens%lib!commit_mask.lemma_is_bit_set. 0) (=> (ens%lib!commit_mask.impl&%0.lemma_view. self!) (=> (= tmp%3 (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@0)))) (and (=> %%location_label%%1 (req%lib!commit_mask.lemma_obtain_bit_index_2. tmp%3)) (=> (ens%lib!commit_mask.lemma_obtain_bit_index_2. tmp%3 j@) (=> (= tmp%4 (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (I (Add (Mul i@0 64) j@))))) (and (=> %%location_label%%2 tmp%4) (=> tmp%4 (and (=> %%location_label%%3 (and (< i@0 8) (< j@ 64))) (=> (< (Add (Mul i@0 64) j@) 512) (=> (= b! false) (=> %%location_label%%4 (= b! (= (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!)) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1. $ INT $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%1 0 lib!config.COMMIT_MASK_BITS.?))))))))))))))))))))) (=> (not (not (= (%I tmp%1) (uClip SZ (bitnot (I 0)))))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%5 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (=> %%location_label%%6 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) (uClip SZ (bitnot (I 0)))))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$))))))))))))))))
(check-sat)
(exit)
