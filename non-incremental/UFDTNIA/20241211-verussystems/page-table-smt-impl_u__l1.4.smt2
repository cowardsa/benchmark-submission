...
(assert (not (=> (lib!impl_u.l1.impl&%1.well_formed.? self!) (=> (has_type i@ NAT) (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.num_entries. self!)) (=> (= tmp%1 (lib!impl_u.l1.impl&%1.num_entries.? self!)) (or (and (=> (< (%I i@) tmp%1) (=> (= tmp%3 (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))) (and (=> %%location_label%%1 (req%vstd!seq.Seq.index. $ TYPE%lib!impl_u.l1.NodeEntry. tmp%3 i@)) (=> (= tmp%2 (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) i@)) (=> (= tmp%4 (is-lib!impl_u.l1.NodeEntry./Empty_ (%Poly%lib!impl_u.l1.NodeEntry. tmp%2))) %%switch_label%%0))))) (=> (not (< (%I i@) tmp%1)) (=> (= tmp%4 true) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
