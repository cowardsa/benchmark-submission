...
(set-info :comment ";; src/math.rs:216:5: 216:71 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_inequality_converse")
(set-info :comment ";; src/math.rs:216:5: 216:71 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (not (=> (= decrease%init0 z!) (or (and (=> (> z! 1) (or (and (=> (<= (Mul x! (Sub z! 1)) (Mul y! (Sub z! 1))) (=> (= tmp%1 (Sub z! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((x!$0 x!) (y!$1 y!) (z!$2 tmp%1)) z!$2) decrease%init0 false)) (and (=> %%location_label%%1 (req%main!math.lemma_mul_inequality_converse. x! y! tmp%1)) (=> (ens%main!math.lemma_mul_inequality_converse. x! y! tmp%1) %%switch_label%%1))))) (=> (not (<= (Mul x! (Sub z! 1)) (Mul y! (Sub z! 1)))) (=> (= tmp%2 (Sub z! 1)) (and (=> %%location_label%%2 (check_decrease_int (let ((x!$0 y!) (y!$1 x!) (z!$2 tmp%2)) z!$2) decrease%init0 false)) (and (=> %%location_label%%3 (req%main!math.lemma_mul_inequality_converse. y! x! tmp%2)) (=> (ens%main!math.lemma_mul_inequality_converse. y! x! tmp%2) (=> %%location_label%%4 false))))))) (and (not %%switch_label%%1) %%switch_label%%0))) (=> (not (> z! 1)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%5 (<= x! y!)))))))
(check-sat)
(exit)
