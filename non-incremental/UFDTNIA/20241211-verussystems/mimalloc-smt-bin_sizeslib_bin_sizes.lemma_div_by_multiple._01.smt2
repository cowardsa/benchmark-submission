...
(set-info :comment ";; bin_sizes.rs:492:1: 492:51 (#0)")
...
(set-info :comment ";; Function-Def lib::bin_sizes::lemma_div_by_multiple")
(set-info :comment ";; bin_sizes.rs:492:1: 492:51 (#0)")
(declare-const b! Int)
(declare-const d! Int)
...
(assert (not (=> %%location_label%%0 (= (EucDiv (Mul b! d!) d!) b!))))
(check-sat)
(exit)
