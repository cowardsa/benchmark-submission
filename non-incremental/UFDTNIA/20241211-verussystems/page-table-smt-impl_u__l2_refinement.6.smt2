...
(set-info :comment ";; Function-Def lib::impl_u::l2_refinement::lemma_no_entries_implies_interp_at_aux_no_entries")
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:519:7: 519:164 (#0)")
(set-info :comment ";; Function-Def lib::spec_t::impl_spec::PageTableImpl::ispec_init_implies_inv")
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:554:11: 554:71 (#0)")
...
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:48:1: 48:86 (#0)")
(set-info :comment ";; Function-Specs lib::impl_u::l2_refinement::lemma_page_table_walk_interp_aux_2")
(declare-fun req%lib!impl_u.l2_refinement.lemma_page_table_walk_interp_aux_2. (lib!spec_t.mem.PageTableMemory. lib!impl_u.l2_impl.PTDir.) Bool)
(declare-const %%global_location_label%%78 Bool)
(assert (forall ((mem! lib!spec_t.mem.PageTableMemory.) (pt! lib!impl_u.l2_impl.PTDir.)) (! (= (req%lib!impl_u.l2_refinement.lemma_page_table_walk_interp_aux_2. mem! pt!) (=> %%global_location_label%%78 (and (lib!impl_u.l2_impl.PT.inv.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))))) :pattern ((req%lib!impl_u.l2_refinement.lemma_page_table_walk_interp_aux_2. mem! pt!)))))
(declare-fun ens%lib!impl_u.l2_refinement.lemma_page_table_walk_interp_aux_2. (lib!spec_t.mem.PageTableMemory. lib!impl_u.l2_impl.PTDir.) Bool)
(assert (forall ((mem! lib!spec_t.mem.PageTableMemory.) (pt! lib!impl_u.l2_impl.PTDir.)) (! (= (ens%lib!impl_u.l2_refinement.lemma_page_table_walk_interp_aux_2. mem! pt!) (forall ((k$ Poly)) (! (=> (has_type k$ NAT) (=> (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hardware.interp_pt_mem.? (Poly%lib!spec_t.mem.PageTableMemory. mem!)))) k$)) (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))))))) k$)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))))))) k$))))) :pattern ((ens%lib!impl_u.l2_refinement.lemma_page_table_walk_interp_aux_2. mem! pt!)))))
(set-info :comment ";; Function-Def lib::impl_u::l2_refinement::lemma_page_table_walk_interp_aux_2")
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:254:1: 254:86 (#0)")
(set-info :comment ";; Function-Specs lib::impl_u::l2_refinement::lemma_page_table_walk_interp")
(declare-fun ens%lib!impl_u.l2_refinement.lemma_page_table_walk_interp. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!impl_u.l2_refinement.lemma_page_table_walk_interp. no%param) (forall ((mem$ Poly) (pt$ Poly)) (! (=> (and (has_type mem$ TYPE%lib!spec_t.mem.PageTableMemory.) (has_type pt$ TYPE%lib!impl_u.l2_impl.PTDir.)) (=> (and (lib!impl_u.l2_impl.PT.inv.? mem$ pt$) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem$ pt$)))) (= (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem$ pt$)))))) (lib!spec_t.hardware.interp_pt_mem.? mem$)))) :pattern ((lib!impl_u.l2_impl.PT.inv.? mem$ pt$))))) :pattern ((ens%lib!impl_u.l2_refinement.lemma_page_table_walk_interp. no%param)))))
(set-info :comment ";; Function-Def lib::impl_u::l2_refinement::lemma_page_table_walk_interp")
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:22:1: 22:44 (#0)")
(set-info :comment ";; Function-Specs lib::impl_u::l2_impl::PT::map_frame")
(declare-fun req%lib!impl_u.l2_impl.PT.map_frame. (lib!spec_t.mem.PageTableMemory. lib!impl_u.l2_impl.PTDir. Int lib!definitions_t.PageTableEntryExec.) Bool)
...
(assert (forall ((pre%mem! lib!spec_t.mem.PageTableMemory.) (pre%pt! lib!impl_u.l2_impl.PTDir.) (vaddr! Int) (pte! lib!definitions_t.PageTableEntryExec.)) (! (= (req%lib!impl_u.l2_impl.PT.map_frame. pre%mem! pre%pt! vaddr! pte!) (and (=> %%global_location_label%%79 (lib!impl_u.l2_impl.PT.inv.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))) (=> %%global_location_label%%80 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))))) (=> %%global_location_label%%81 (lib!spec_t.mem.impl&%1.inv.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!))) (=> %%global_location_label%%82 (>= (lib!spec_t.mem.impl&%1.alloc_available_pages.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!)) 3)) (=> %%global_location_label%%83 (lib!impl_u.l2_impl.PT.accepted_mapping.? (I vaddr!) (Poly%lib!definitions_t.PageTableEntry. (lib!definitions_t.impl&%7.view.? (Poly%lib!definitions_t.PageTableEntryExec. pte!))))) (=> %%global_location_label%%84 (lib!impl_u.l1.impl&%1.accepted_mapping.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))) (I vaddr!) (Poly%lib!definitions_t.PageTableEntry. (lib!definitions_t.impl&%7.view.? (Poly%lib!definitions_t.PageTableEntryExec. pte!))))) (=> %%global_location_label%%85 (< vaddr! lib!definitions_t.MAX_BASE.?)))) :pattern ((req%lib!impl_u.l2_impl.PT.map_frame. pre%mem! pre%pt! vaddr! pte!)))))
(declare-fun ens%lib!impl_u.l2_impl.PT.map_frame. (lib!spec_t.mem.PageTableMemory. lib!spec_t.mem.PageTableMemory. lib!impl_u.l2_impl.PTDir. lib!impl_u.l2_impl.PTDir. Int lib!definitions_t.PageTableEntryExec. core!result.Result.) Bool)
(assert (forall ((pre%mem! lib!spec_t.mem.PageTableMemory.) (mem! lib!spec_t.mem.PageTableMemory.) (pre%pt! lib!impl_u.l2_impl.PTDir.) (pt! lib!impl_u.l2_impl.PTDir.) (vaddr! Int) (pte! lib!definitions_t.PageTableEntryExec.) (res! core!result.Result.)) (! (= (ens%lib!impl_u.l2_impl.PT.map_frame. pre%mem! mem! pre%pt! pt! vaddr! pte! res!) (and (has_type (Poly%core!result.Result. res!) (TYPE%core!result.Result. $ TYPE%tuple%0. $ TYPE%tuple%0.)) (has_type (Poly%lib!impl_u.l2_impl.PTDir. pt!) TYPE%lib!impl_u.l2_impl.PTDir.) (lib!impl_u.l2_impl.PT.inv.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) (ite (is-core!result.Result./Ok_ res!) (= (core!result.Result./Ok (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)))))) (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))))) (I vaddr!) (Poly%lib!definitions_t.PageTableEntry. (lib!definitions_t.impl&%7.view.? (Poly%lib!definitions_t.PageTableEntryExec. pte!))))) (= (core!result.Result./Err (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)))))) (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))))) (I vaddr!) (Poly%lib!definitions_t.PageTableEntry. (lib!definitions_t.impl&%7.view.? (Poly%lib!definitions_t.PageTableEntryExec. pte!)))))))) :pattern ((ens%lib!impl_u.l2_impl.PT.map_frame. pre%mem! mem! pre%pt! pt! vaddr! pte! res!)))))
(set-info :comment ";; Function-Def lib::spec_t::impl_spec::PageTableImpl::ispec_map_frame")
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:577:5: 577:124 (#0)")
(declare-const %return! Poly)
(declare-const self! Poly)
(declare-const mem!@0 Poly)
(declare-const vaddr! Poly)
(declare-const pte! Poly)
(declare-const tmp%1 Int)
(declare-const tmp%2 lib!impl_u.l1.Directory.)
(declare-const tmp%3 core!result.Result.)
(declare-const pt@0 lib!impl_u.l2_impl.PTDir.)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!spec_t.impl_spec.PageTableImpl.))
(assert (has_type mem!@0 TYPE%lib!spec_t.mem.PageTableMemory.))
(assert (has_type vaddr! (UINT SZ)))
(assert (has_type pte! TYPE%lib!definitions_t.PageTableEntryExec.))
(assert (lib!impl_u.spec_pt.step_Map_enabled.? (Poly%lib!impl_u.spec_pt.PageTableVariables. (lib!spec_t.impl_spec.pt_vars.? mem!@0)) vaddr! (Poly%lib!definitions_t.PageTableEntry. (lib!definitions_t.impl&%7.view.? pte!))))
(assert (%B (lib!spec_t.impl_spec.InterfaceSpec.ispec_inv.? $ TYPE%lib!spec_t.impl_spec.PageTableImpl. self! mem!@0)))
(declare-fun %%choose%%2 (Type Poly Poly Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Poly)) (! (=> (exists ((pt$1 Poly)) (! (and (has_type pt$1 %%hole%%0) (and (lib!impl_u.l2_impl.PT.inv.? %%hole%%1 pt$1) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? %%hole%%2 pt$1))))) :pattern ((lib!impl_u.l2_impl.PT.inv.? %%hole%%3 pt$1)))) (exists ((pt$1 Poly)) (! (and (and (has_type pt$1 %%hole%%0) (and (lib!impl_u.l2_impl.PT.inv.? %%hole%%1 pt$1) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? %%hole%%2 pt$1))))) (= (%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) pt$1)) :pattern ((lib!impl_u.l2_impl.PT.inv.? %%hole%%3 pt$1))))) :pattern ((%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3)))))
(declare-const mem!@1 Poly)
(declare-const pt@1 lib!impl_u.l2_impl.PTDir.)
...
(assert (not (=> (= pt@0 (%Poly%lib!impl_u.l2_impl.PTDir. (as_type (%%choose%%2 TYPE%lib!impl_u.l2_impl.PTDir. mem!@0 mem!@0 mem!@0) TYPE%lib!impl_u.l2_impl.PTDir.))) (=> (= tmp%1 (lib!definitions_t.MemRegionExec./MemRegionExec/base (%Poly%lib!definitions_t.MemRegionExec. (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? mem!@0))))) (and (=> %%location_label%%0 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. (%Poly%lib!spec_t.mem.PageTableMemory. mem!@0) pt@0 0 tmp%1 0)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. (%Poly%lib!spec_t.mem.PageTableMemory. mem!@0) pt@0 0 tmp%1 0) (=> (= tmp%2 (lib!impl_u.l2_impl.PT.interp.? mem!@0 (Poly%lib!impl_u.l2_impl.PTDir. pt@0))) (and (=> %%location_label%%1 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%2)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%2) (=> (= (lib!definitions_t.impl&%8.upper_vaddr.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I 0) (I 0)) lib!definitions_t.PT_BOUND_HIGH.?) (=> (ens%lib!impl_u.l2_refinement.lemma_page_table_walk_interp. 0) (and (=> %%location_label%%2 (req%lib!impl_u.l2_impl.PT.map_frame. (%Poly%lib!spec_t.mem.PageTableMemory. mem!@0) pt@0 (%I vaddr!) (%Poly%lib!definitions_t.PageTableEntryExec. pte!))) (=> (has_type mem!@1 TYPE%lib!spec_t.mem.PageTableMemory.) (=> (has_type (Poly%lib!impl_u.l2_impl.PTDir. pt@1) TYPE%lib!impl_u.l2_impl.PTDir.) (=> (ens%lib!impl_u.l2_impl.PT.map_frame. (%Poly%lib!spec_t.mem.PageTableMemory. mem!@0) (%Poly%lib!spec_t.mem.PageTableMemory. mem!@1) pt@0 pt@1 (%I vaddr!) (%Poly%lib!definitions_t.PageTableEntryExec. pte!) tmp%3) (=> (= %return! (Poly%core!result.Result. tmp%3)) (and (=> %%location_label%%3 (%B (lib!spec_t.impl_spec.InterfaceSpec.ispec_inv.? $ TYPE%lib!spec_t.impl_spec.PageTableImpl. self! mem!@1))) (=> %%location_label%%4 (lib!impl_u.spec_pt.step_Map.? (Poly%lib!impl_u.spec_pt.PageTableVariables. (lib!spec_t.impl_spec.pt_vars.? mem!@0)) (Poly%lib!impl_u.spec_pt.PageTableVariables. (lib!spec_t.impl_spec.pt_vars.? mem!@1)) vaddr! (Poly%lib!definitions_t.PageTableEntry. (lib!definitions_t.impl&%7.view.? pte!)) %return!)))))))))))))))))))
(check-sat)
(exit)
