...
(set-info :comment ";; Function-Specs lib::multilog::inv_v::lemma_flushing_metadata_maintains_invariants")
(declare-fun req%lib!multilog.inv_v.lemma_flushing_metadata_maintains_invariants. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Int Int Bool vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. lib!multilog.multilogspec_t.AbstractMultiLogState.) Bool)
...
(assert (forall ((pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (multilog_id! Int) (num_logs! Int) (cdb! Bool) (infos! vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>.) (state! lib!multilog.multilogspec_t.AbstractMultiLogState.)) (! (= (req%lib!multilog.inv_v.lemma_flushing_metadata_maintains_invariants. pm_regions_view! multilog_id! num_logs! cdb! infos! state!) (and (=> %%global_location_label%%64 (lib!multilog.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) (B cdb!))) (=> %%global_location_label%%65 (lib!multilog.inv_v.each_metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) (I multilog_id!) (I num_logs!) (B cdb!) (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!))) (=> %%global_location_label%%66 (lib!multilog.inv_v.each_info_consistent_with_log_area.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) (I num_logs!) (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!) (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!))))) :pattern ((req%lib!multilog.inv_v.lemma_flushing_metadata_maintains_invariants. pm_regions_view! multilog_id! num_logs! cdb! infos! state!)))))
(declare-fun ens%lib!multilog.inv_v.lemma_flushing_metadata_maintains_invariants. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Int Int Bool vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. lib!multilog.multilogspec_t.AbstractMultiLogState.) Bool)
(assert (forall ((pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (multilog_id! Int) (num_logs! Int) (cdb! Bool) (infos! vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>.) (state! lib!multilog.multilogspec_t.AbstractMultiLogState.)) (! (= (ens%lib!multilog.inv_v.lemma_flushing_metadata_maintains_invariants. pm_regions_view! multilog_id! num_logs! cdb! infos! state!) (let ((pm_regions_view2$ (lib!pmem.pmemspec_t.impl&%7.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!)))) (and (and (lib!multilog.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2$) (B cdb!)) (lib!multilog.inv_v.each_metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2$) (I multilog_id!) (I num_logs!) (B cdb!) (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!))) (lib!multilog.inv_v.each_info_consistent_with_log_area.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2$) (I num_logs!) (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!) (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!))))) :pattern ((ens%lib!multilog.inv_v.lemma_flushing_metadata_maintains_invariants. pm_regions_view! multilog_id! num_logs! cdb! infos! state!)))))
(set-info :comment ";; Function-Def lib::multilog::inv_v::lemma_flushing_metadata_maintains_invariants")
(set-info :comment ";; src/multilog/inv_v.rs:865:5: 872:6 (#0)")
(set-info :comment ";; Function-Specs lib::multilog::inv_v::lemma_metadata_types_set_after_cdb_update")
(declare-fun req%lib!multilog.inv_v.lemma_metadata_types_set_after_cdb_update. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Int vstd!seq.Seq<u8.>. Bool) Bool)
...
(assert (forall ((old_pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (new_pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (log_id! Int) (new_cdb_bytes! vstd!seq.Seq<u8.>.) (old_cdb! Bool)) (! (= (req%lib!multilog.inv_v.lemma_metadata_types_set_after_cdb_update. old_pm_regions_view! new_pm_regions_view! log_id! new_cdb_bytes! old_cdb!) (and (=> %%global_location_label%%67 (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))) (=> %%global_location_label%%68 (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!))) (=> %%global_location_label%%69 (= (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!)) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!)))) (=> %%global_location_label%%70 (or (= new_cdb_bytes! (%Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I lib!pmem.pmemspec_t.CDB_FALSE.?)))) (= new_cdb_bytes! (%Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I lib!pmem.pmemspec_t.CDB_TRUE.?)))))) (=> %%global_location_label%%71 (> (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!)) 0)) (=> %%global_location_label%%72 (is-core!option.Option./Some_ (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))) (I 0))))) (=> %%global_location_label%%73 (= (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))) (I 0))))))) old_cdb!)) (=> %%global_location_label%%74 (=> old_cdb! (= new_cdb_bytes! (%Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I lib!pmem.pmemspec_t.CDB_FALSE.?)))))) (=> %%global_location_label%%75 (=> (not old_cdb!) (= new_cdb_bytes! (%Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I lib!pmem.pmemspec_t.CDB_TRUE.?)))))) (=> %%global_location_label%%76 (= new_pm_regions_view! (lib!pmem.pmemspec_t.impl&%7.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. (lib!pmem.pmemspec_t.impl&%7.write.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!) (I 0) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (Poly%vstd!seq.Seq<u8.>. new_cdb_bytes!)))))) (=> %%global_location_label%%77 (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))))) (=> %%global_location_label%%78 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))))) (= (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!) i$))) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!) i$)))))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$))))) (=> %%global_location_label%%79 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))))) (< lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!) i$)))))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$))))) (=> %%global_location_label%%80 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))))) (lib!multilog.inv_v.inactive_metadata_types_set_in_region.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))) i$) (B old_cdb!)))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$))))))) :pattern ((req%lib!multilog.inv_v.lemma_metadata_types_set_after_cdb_update. old_pm_regions_view! new_pm_regions_view! log_id! new_cdb_bytes! old_cdb!)))))
(declare-fun ens%lib!multilog.inv_v.lemma_metadata_types_set_after_cdb_update. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Int vstd!seq.Seq<u8.>. Bool) Bool)
(assert (forall ((old_pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (new_pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (log_id! Int) (new_cdb_bytes! vstd!seq.Seq<u8.>.) (old_cdb! Bool)) (! (= (ens%lib!multilog.inv_v.lemma_metadata_types_set_after_cdb_update. old_pm_regions_view! new_pm_regions_view! log_id! new_cdb_bytes! old_cdb!) (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!))))) :pattern ((ens%lib!multilog.inv_v.lemma_metadata_types_set_after_cdb_update. old_pm_regions_view! new_pm_regions_view! log_id! new_cdb_bytes! old_cdb!)))))
(set-info :comment ";; Function-Def lib::multilog::inv_v::lemma_metadata_types_set_after_cdb_update")
(set-info :comment ";; src/multilog/inv_v.rs:957:5: 963:6 (#0)")
(set-info :comment ";; Function-Specs lib::multilog::inv_v::lemma_no_outstanding_writes_to_active_metadata_implies_metadata_types_set_after_flush")
(declare-fun req%lib!multilog.inv_v.lemma_no_outstanding_writes_to_active_metadata_implies_metadata_types_set_after_flush. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Bool) Bool)
...
(assert (forall ((pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (cdb! Bool)) (! (= (req%lib!multilog.inv_v.lemma_no_outstanding_writes_to_active_metadata_implies_metadata_types_set_after_flush. pm_regions_view! cdb!) (and (=> %%global_location_label%%81 (is-core!option.Option./Some_ (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))) (I 0))))) (=> %%global_location_label%%82 (= cdb! (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))) (I 0))))))))) (=> %%global_location_label%%83 (lib!multilog.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) (B cdb!))) (=> %%global_location_label%%84 (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))))) (=> %%global_location_label%%85 (> (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!)) 0)) (=> %%global_location_label%%86 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))))) (> (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) i$))) lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$))))))) :pattern ((req%lib!multilog.inv_v.lemma_no_outstanding_writes_to_active_metadata_implies_metadata_types_set_after_flush. pm_regions_view! cdb!)))))
(declare-fun ens%lib!multilog.inv_v.lemma_no_outstanding_writes_to_active_metadata_implies_metadata_types_set_after_flush. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Bool) Bool)
(assert (forall ((pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (cdb! Bool)) (! (= (ens%lib!multilog.inv_v.lemma_no_outstanding_writes_to_active_metadata_implies_metadata_types_set_after_flush. pm_regions_view! cdb!) (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. (lib!pmem.pmemspec_t.impl&%7.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))))))) :pattern ((ens%lib!multilog.inv_v.lemma_no_outstanding_writes_to_active_metadata_implies_metadata_types_set_after_flush. pm_regions_view! cdb!)))))
(set-info :comment ";; Function-Def lib::multilog::inv_v::lemma_no_outstanding_writes_to_active_metadata_implies_metadata_types_set_after_flush")
(set-info :comment ";; src/multilog/inv_v.rs:1009:5: 1012:6 (#0)")
(set-info :comment ";; Function-Specs lib::multilog::inv_v::lemma_write_to_inactive_metadata_implies_active_metadata_stays_equal")
(declare-fun req%lib!multilog.inv_v.lemma_write_to_inactive_metadata_implies_active_metadata_stays_equal. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Int Int vstd!seq.Seq<u8.>. Bool) Bool)
...
(assert (forall ((wrpm_regions_old! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (wrpm_regions_new! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (which_log! Int) (addr! Int) (bytes_to_write! vstd!seq.Seq<u8.>.) (cdb! Bool)) (! (= (req%lib!multilog.inv_v.lemma_write_to_inactive_metadata_implies_active_metadata_stays_equal. wrpm_regions_old! wrpm_regions_new! which_log! addr! bytes_to_write! cdb!) (and (=> %%global_location_label%%87 (= wrpm_regions_new! (lib!pmem.pmemspec_t.impl&%7.write.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (I which_log!) (I addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)))) (=> %%global_location_label%%88 (and (<= 0 which_log!) (< which_log! (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!))))) (=> %%global_location_label%%89 (lib!multilog.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (B cdb!))) (=> %%global_location_label%%90 (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!))))) (=> %%global_location_label%%91 (let ((unused_metadata_pos$ (lib!multilog.layout_v.get_log_metadata_pos.? (B (not cdb!))))) (let ((tmp%%$ (Add addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!))))) (and (and (<= unused_metadata_pos$ addr!) (< addr! tmp%%$)) (<= tmp%%$ (Add (Add unused_metadata_pos$ (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.LogMetadata.))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64))))))))) (=> %%global_location_label%%92 (lib!multilog.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (B cdb!))) (=> %%global_location_label%%93 (lib!multilog.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) (B cdb!))) (=> %%global_location_label%%94 (= (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!)) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!)))) (=> %%global_location_label%%95 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!))))) (and (and (= (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) i$))) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) i$)))) (> (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) i$))) lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (> (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) i$))) lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$))))) (=> %%global_location_label%%96 (= (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (I 0)))))) (core!option.Option./Some (B cdb!)))))) :pattern ((req%lib!multilog.inv_v.lemma_write_to_inactive_metadata_implies_active_metadata_stays_equal. wrpm_regions_old! wrpm_regions_new! which_log! addr! bytes_to_write! cdb!)))))
(declare-fun ens%lib!multilog.inv_v.lemma_write_to_inactive_metadata_implies_active_metadata_stays_equal. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Int Int vstd!seq.Seq<u8.>. Bool) Bool)
(assert (forall ((wrpm_regions_old! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (wrpm_regions_new! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (which_log! Int) (addr! Int) (bytes_to_write! vstd!seq.Seq<u8.>.) (cdb! Bool)) (! (= (ens%lib!multilog.inv_v.lemma_write_to_inactive_metadata_implies_active_metadata_stays_equal. wrpm_regions_old! wrpm_regions_new! which_log! addr! bytes_to_write! cdb!) (and (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!)))) (lib!multilog.inv_v.active_metadata_is_equal.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!)))) :pattern ((ens%lib!multilog.inv_v.lemma_write_to_inactive_metadata_implies_active_metadata_stays_equal. wrpm_regions_old! wrpm_regions_new! which_log! addr! bytes_to_write! cdb!)))))
(set-info :comment ";; Function-Def lib::multilog::inv_v::lemma_write_to_inactive_metadata_implies_active_metadata_stays_equal")
(set-info :comment ";; src/multilog/inv_v.rs:1054:5: 1061:6 (#0)")
(declare-const wrpm_regions_old! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)
(declare-const wrpm_regions_new! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)
...
(declare-const cur_old@ vstd!seq.Seq<u8.>.)
(declare-const cur_new@ vstd!seq.Seq<u8.>.)
(declare-const old_cdb@ core!option.Option.)
(declare-const log_metadata_pos@ Int)
(assert fuel_defaults)
(assert (= wrpm_regions_new! (lib!pmem.pmemspec_t.impl&%7.write.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (I which_log!) (I addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!))))
(assert (and (<= 0 which_log!) (< which_log! (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!)))))
(assert (lib!multilog.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (B cdb!)))
(assert (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!)))))
(assert (let ((unused_metadata_pos$ (lib!multilog.layout_v.get_log_metadata_pos.? (B (not cdb!))))) (let ((tmp%%$ (Add addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!))))) (and (and (<= unused_metadata_pos$ addr!) (< addr! tmp%%$)) (<= tmp%%$ (Add (Add unused_metadata_pos$ (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.LogMetadata.))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))))
(assert (lib!multilog.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (B cdb!)))
(assert (lib!multilog.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) (B cdb!)))
(assert (= (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!)) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!))))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!))))) (and (and (= (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) i$))) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) i$)))) (> (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) i$))) lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (> (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) i$))) lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$)))))
(assert (= (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (I 0)))))) (core!option.Option./Some (B cdb!))))
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (= tmp%1 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!))))) (not (= (%I i$) which_log!))) (ext_eq false TYPE%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) i$)) (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) i$))))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!))))) (not (= (%I i$) which_log!))) (lib!multilog.inv_v.active_metadata_is_equal_in_region.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) i$)) (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) i$)) (B cdb!)))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= cur_old@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (I which_log!))))) (=> (= cur_new@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) (I which_log!))))) (=> (= tmp%3 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. cur_old@)) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (I which_log!)))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. cur_new@)) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) (I which_log!)))))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (ens%lib!log.inv_v.lemma_auto_smaller_range_of_seq_is_subrange. cur_old@) (=> (ens%lib!log.inv_v.lemma_auto_smaller_range_of_seq_is_subrange. cur_new@) (=> (= tmp%5 (lib!multilog.inv_v.log_index_trigger.? (I which_log!))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. cur_old@) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. cur_new@) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> (= old_cdb@ (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (I 0))))))) (=> (= log_metadata_pos@ (lib!multilog.layout_v.get_log_metadata_pos.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. old_cdb@))))) (=> (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. cur_old@) (I log_metadata_pos@) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. cur_new@) (I log_metadata_pos@) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> (= tmp%8 (lib!multilog.inv_v.active_metadata_is_equal_in_region.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!) (I which_log!))) (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) (I which_log!))) (B cdb!))) (and (=> %%location_label%%7 tmp%8) (=> tmp%8 (and (=> %%location_label%%8 (req%lib!multilog.inv_v.lemma_regions_metadata_matches_implies_metadata_types_set. wrpm_regions_old! wrpm_regions_new! cdb!)) (=> (ens%lib!multilog.inv_v.lemma_regions_metadata_matches_implies_metadata_types_set. wrpm_regions_old! wrpm_regions_new! cdb!) (=> (= tmp%9 (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!))))) (and (=> %%location_label%%9 tmp%9) (=> tmp%9 (and (=> %%location_label%%10 (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!))))) (=> %%location_label%%11 (lib!multilog.inv_v.active_metadata_is_equal.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_new!) (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. wrpm_regions_old!))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
