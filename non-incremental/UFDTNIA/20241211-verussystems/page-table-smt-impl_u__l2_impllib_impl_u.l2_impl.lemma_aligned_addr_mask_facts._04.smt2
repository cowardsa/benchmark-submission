...
(set-info :comment ";; page-table/impl_u/l2_impl.rs:84:13: 84:19 (#0)")
...
(assert (not (=> %%location_label%%0 (lib!definitions_t.aligned.? (I lib!definitions_t.L2_ENTRY_SIZE.?) (I lib!definitions_t.PAGE_SIZE.?)))))
(check-sat)
(exit)
