...
(set-info :comment ";; Function-Def lib::spec::cyclicbuffer::log_entry_idx_wrap_around")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/cyclicbuffer.rs:784:1: 784:79 (#0)")
...
(assert (and (<= start! idx!) (< idx! (nClip (Add start! buffer_size!)))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (and (<= start! (%I i$)) (< (%I i$) (nClip (Add start! buffer_size!)))) (not (= (%I i$) idx!))) (not (= (lib!spec.cyclicbuffer.log_entry_idx.? i$ (I buffer_size!)) (lib!spec.cyclicbuffer.log_entry_idx.? (I idx!) (I buffer_size!)))))) :pattern ((lib!spec.cyclicbuffer.log_entry_idx.? i$ (I buffer_size!))))))))
(check-sat)
(exit)
