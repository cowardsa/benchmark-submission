...
(assert (not (=> (= decrease%init0 i!) (or (and (=> (= i! 0) %%switch_label%%0) (=> (not (= i! 0)) (=> (= tmp%1 (nClip (Sub i! 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((i!$0 tmp%1) (e!$1 e!)) i!$0) decrease%init0 false)) (=> (ens%lib!definitions_u.lemma_new_seq. T&. T& tmp%1 e!) %%switch_label%%0))))) (and (not %%switch_label%%0) (and (=> %%location_label%%1 (= (vstd!seq.Seq.len.? T&. T& (lib!definitions_t.new_seq.? T&. T& (I i!) e!)) i!)) (=> %%location_label%%2 (forall ((j$ Poly)) (! (=> (has_type j$ NAT) (=> (< (%I j$) i!) (= (vstd!seq.Seq.index.? T&. T& (lib!definitions_t.new_seq.? T&. T& (I i!) e!) j$) e!))) :pattern ((vstd!seq.Seq.index.? T&. T& (lib!definitions_t.new_seq.? T&. T& (I i!) e!) j$)))))))))))
(check-sat)
(exit)
