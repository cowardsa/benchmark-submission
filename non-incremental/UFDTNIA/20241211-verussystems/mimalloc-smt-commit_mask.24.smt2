...
(declare-const seq_set@ vstd!set.Set<int.>.)
(declare-const bit_set@ vstd!set.Set<int.>.)
...
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Int) (t$ Poly)) (! (= (%%apply%%0 (%%lambda%%10 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) t$) (B (and (let ((tmp%%$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. t$))))) (and (<= %%hole%%0 tmp%%$) (< tmp%%$ %%hole%%1))) (let ((tmp%%$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. t$))))) (and (<= %%hole%%2 tmp%%$) (< tmp%%$ %%hole%%3)))))) :pattern ((%%apply%%0 (%%lambda%%10 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) t$)))))
...
(assert (not (=> (= i@0 0) (and (=> %%location_label%%0 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@0))))) j$)) (uClip SZ (bitnot (I 0)))))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@0))))) j$))))) (=> (has_type (Poly%lib!commit_mask.CommitMask. self!@1) TYPE%lib!commit_mask.CommitMask.) (=> (uInv SZ i@1) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@1))))) j$)) (uClip SZ (bitnot (I 0)))))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@1))))) j$)))) (=> (not (< i@1 8)) (=> (ens%lib!config.const_facts. 0) (=> (ens%lib!commit_mask.lemma_is_bit_set. 0) (=> (ens%lib!commit_mask.impl&%0.lemma_view. self!@1) (=> (= seq_set@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1. $ INT $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%1 0 lib!config.COMMIT_MASK_BITS.?)))))) (=> (= bit_set@ (%Poly%vstd!set.Set<int.>. (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ INT) $ INT (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ INT) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ INT) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%10 0 8 0 64)))) (Poly%fun%1. (mk_fun (%%lambda%%4 64)))))) (and (=> (has_type i$2@ INT) (=> (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. seq_set@) i$2@) (=> (= tmp%2 (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ INT) (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ INT) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ INT) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%10 0 8 0 64)))) (Poly%tuple%2. (tuple%2./tuple%2 (I (EucDiv (%I i$2@) 64)) (I (EucMod (%I i$2@) 64)))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> %%location_label%%2 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. bit_set@) i$2@))))))) (=> (forall ((i$3 Poly)) (! (=> (has_type i$3 INT) (=> (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. seq_set@) i$3) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. bit_set@) i$3))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. seq_set@) i$3)) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. bit_set@) i$3)))) (=> (= tmp%3 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. seq_set@) (Poly%vstd!set.Set<int.>. bit_set@))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> (= tmp%4 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!@1))) (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1. $ INT $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%1 0 lib!config.COMMIT_MASK_BITS.?)))))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (=> %%location_label%%5 (= (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!@1)) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1. $ INT $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%1 0 lib!config.COMMIT_MASK_BITS.?))))))))))))))))))))))))))))
(check-sat)
(exit)
