...
(assert (not (and (=> %%location_label%%0 (req%main!math.lemma_fundamental_div_mod. x! d!)) (=> (ens%main!math.lemma_fundamental_div_mod. x! d!) (and (=> %%location_label%%1 (req%main!math.lemma_fundamental_div_mod. y! d!)) (=> (ens%main!math.lemma_fundamental_div_mod. y! d!) (and (=> %%location_label%%2 (req%main!math.lemma_mod_range. x! d!)) (=> (ens%main!math.lemma_mod_range. x! d!) (and (=> %%location_label%%3 (req%main!math.lemma_mod_range. y! d!)) (=> (ens%main!math.lemma_mod_range. y! d!) (=> (= tmp%1 (EucDiv y! d!)) (=> (ens%main!math.lemma_mul_is_commutative. tmp%1 d!) (=> (= tmp%2 (EucDiv x! d!)) (=> (ens%main!math.lemma_mul_is_commutative. tmp%2 d!) (or (and (=> (> (EucDiv y! d!) (Add (EucDiv x! d!) 1)) (=> (= tmp%3 (Sub (EucDiv y! d!) (EucDiv x! d!))) (and (=> %%location_label%%4 (req%main!math.lemma_mul_inequality. 2 tmp%3 d!)) (=> (ens%main!math.lemma_mul_inequality. 2 tmp%3 d!) (=> (= tmp%4 (EucDiv y! d!)) (=> (= tmp%5 (EucDiv x! d!)) (=> (ens%main!math.lemma_mul_is_distributive_sub_other_way. d! tmp%4 tmp%5) (=> (= tmp%6 (>= (Mul (Sub (EucDiv y! d!) (EucDiv x! d!)) d!) (Mul 2 d!))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> %%location_label%%6 false))))))))))) (=> (not (> (EucDiv y! d!) (Add (EucDiv x! d!) 1))) %%switch_label%%1)) (and (not %%switch_label%%1) (or (and (=> (<= (EucDiv y! d!) (EucDiv x! d!)) (=> (= tmp%7 (Sub (EucDiv x! d!) (EucDiv y! d!))) (and (=> %%location_label%%7 (req%main!math.lemma_mul_inequality. 0 tmp%7 d!)) (=> (ens%main!math.lemma_mul_inequality. 0 tmp%7 d!) (=> (= tmp%8 (<= (Mul 0 d!) (Mul (Sub (EucDiv x! d!) (EucDiv y! d!)) d!))) (and (=> %%location_label%%8 tmp%8) (=> tmp%8 (=> (= tmp%9 (Sub (EucDiv x! d!) (EucDiv y! d!))) (=> (ens%main!math.lemma_mul_is_commutative. tmp%9 d!) (=> (= tmp%10 (EucDiv x! d!)) (=> (= tmp%11 (EucDiv y! d!)) (=> (ens%main!math.lemma_mul_is_distributive_sub. d! tmp%10 tmp%11) (=> (= tmp%12 (= (Mul d! (Sub (EucDiv x! d!) (EucDiv y! d!))) (Sub (Mul d! (EucDiv x! d!)) (Mul d! (EucDiv y! d!))))) (and (=> %%location_label%%9 tmp%12) (=> tmp%12 (=> (= tmp%13 (<= (Mul 0 d!) (Add (Sub (Sub x! y!) (EucMod x! d!)) (EucMod y! d!)))) (and (=> %%location_label%%10 tmp%13) (=> tmp%13 (=> %%location_label%%11 false))))))))))))))))))) (=> (not (<= (EucDiv y! d!) (EucDiv x! d!))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%12 (= (EucDiv y! d!) (Add (EucDiv x! d!) 1)))))))))))))))))))))
(check-sat)
(exit)
