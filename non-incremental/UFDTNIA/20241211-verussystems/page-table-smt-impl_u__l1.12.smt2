...
(assert (not (=> (lib!impl_u.l1.impl&%1.well_formed.? self!) (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.directories_are_in_next_layer. self!)) (=> (= tmp%1 (lib!impl_u.l1.impl&%1.directories_are_in_next_layer.? self!)) (=> (lib!impl_u.l1.impl&%1.directories_are_in_next_layer.? self!) (=> (lib!impl_u.l1.impl&%1.directories_match_arch.? self!) (or (and (=> (lib!impl_u.l1.impl&%1.well_formed.? self!) (and (=> %%location_label%%1 (req%lib!impl_u.l1.impl&%1.directories_are_in_next_layer. self!)) (=> (= tmp%2 (lib!impl_u.l1.impl&%1.directories_are_in_next_layer.? self!)) (=> (= tmp%3 tmp%2) %%switch_label%%3)))) (=> (not (lib!impl_u.l1.impl&%1.well_formed.? self!)) (=> (= tmp%3 false) %%switch_label%%3))) (and (not %%switch_label%%3) (or (and (=> (and tmp%3 (lib!impl_u.l1.impl&%1.directories_match_arch.? self!)) (=> (has_type i@ NAT) (or (and (=> (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))))) (=> (= tmp%5 (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))) (and (=> %%location_label%%2 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!impl_u.l1.NodeEntry. tmp%5 i@)) (=> (= tmp%4 (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) i@)) (=> (= tmp%6 (is-lib!impl_u.l1.NodeEntry./Directory_ (%Poly%lib!impl_u.l1.NodeEntry. tmp%4))) %%switch_label%%2))))) (=> (not (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))))) (=> (= tmp%6 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%6 (=> (= tmp%8 (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))) (and (=> %%location_label%%3 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!impl_u.l1.NodeEntry. tmp%8 i@)) (=> (= tmp%7 (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) i@)) (=> (= tmp%9 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. tmp%7))))) %%switch_label%%1))))) (=> (not tmp%6) (=> (= tmp%9 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%10 (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (and (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))))) (is-lib!impl_u.l1.NodeEntry./Directory_ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) i$)))) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) i$))))))) :pattern ((is-lib!impl_u.l1.NodeEntry./Directory_ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) i$))))))) %%switch_label%%0))))))) (=> (not (and tmp%3 (lib!impl_u.l1.impl&%1.directories_match_arch.? self!))) (=> (= tmp%10 (%B (vstd!pervasive.arbitrary.? $ BOOL))) %%switch_label%%0))) (not %%switch_label%%0)))))))))))
(check-sat)
(exit)
