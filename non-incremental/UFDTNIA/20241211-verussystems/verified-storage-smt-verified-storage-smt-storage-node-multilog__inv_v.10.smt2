...
(assert (not (=> (= tmp%1 (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> (has_type s@ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s@) (and (=> (has_type s$1@ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) (I 0))) s$1@) (=> (= tmp%2 (lib!multilog.inv_v.log_index_trigger.? (I 0))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (and (=> %%location_label%%2 (req%lib!multilog.inv_v.lemma_metadata_set_after_crash_in_first_region. pm_regions_view! cdb!)) (=> (ens%lib!multilog.inv_v.lemma_metadata_set_after_crash_in_first_region. pm_regions_view! cdb!) (=> %%location_label%%3 (and (= (lib!multilog.layout_v.deserialize_and_check_log_cdb.? s$1@) (core!option.Option./Some (B cdb!))) (lib!multilog.inv_v.metadata_types_set_in_first_region.? s$1@)))))))))) (=> (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) (I 0))) s$) (and (= (lib!multilog.layout_v.deserialize_and_check_log_cdb.? s$) (core!option.Option./Some (B cdb!))) (lib!multilog.inv_v.metadata_types_set_in_first_region.? s$)))) :pattern ((lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) (I 0))) s$)))) (and (=> (has_type i@ INT) (=> (has_type s$2@ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (and (and (lib!multilog.inv_v.log_index_trigger.? i@) (and (<= 0 (%I i@)) (< (%I i@) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))))) (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) i@)) s$2@)) (=> (= tmp%3 (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) i@)) (and (=> %%location_label%%4 (req%lib!multilog.inv_v.lemma_metadata_set_after_crash_in_region. tmp%3 cdb!)) (=> (ens%lib!multilog.inv_v.lemma_metadata_set_after_crash_in_region. tmp%3 cdb!) (=> %%location_label%%5 (lib!multilog.inv_v.metadata_types_set_in_region.? s$2@ (B cdb!))))))))) (=> (forall ((i$ Poly) (s$ Poly)) (! (=> (and (has_type i$ INT) (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (and (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))))) (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) i$)) s$)) (lib!multilog.inv_v.metadata_types_set_in_region.? s$ (B cdb!)))) :pattern ((lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) i$)) s$)))) (=> %%location_label%%6 (lib!multilog.inv_v.metadata_types_set.? s@)))))))) (=> (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$) (lib!multilog.inv_v.metadata_types_set.? s$))) :pattern ((lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$)))) (=> %%location_label%%7 (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$) (lib!multilog.inv_v.metadata_types_set.? s$))) :pattern ((lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$))))))))))))
(check-sat)
(exit)
