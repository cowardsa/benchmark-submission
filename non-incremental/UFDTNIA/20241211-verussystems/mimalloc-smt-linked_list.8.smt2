...
(declare-const perm! vstd!raw_ptr.PointsToRaw.)
...
(declare-const tmp%4 lib!linked_list.Node.)
...
(declare-const verus_tmp$1@ vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const points_to_node@0 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(assert fuel_defaults)
(assert (vstd!raw_ptr.impl&%11.contains_range.? (Poly%vstd!raw_ptr.PointsToRaw. perm!) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!))) (I (vstd!layout.size_of.? $ TYPE%lib!linked_list.Node.))))
(assert (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. perm!)) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!))))))
(assert (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!)) (vstd!layout.align_of.? $ TYPE%lib!linked_list.Node.)) 0))
...
(declare-const points_to@1 vstd!raw_ptr.PointsToRaw.)
(declare-const rest@1 vstd!raw_ptr.PointsToRaw.)
...
(assert (not (=> (= tmp%1 (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!)) (vstd!layout.size_of.? $ TYPE%lib!linked_list.Node.))))) (and (=> %%location_label%%0 (req%vstd!raw_ptr.impl&%11.split. perm! tmp%1)) (=> (ens%vstd!raw_ptr.impl&%11.split. perm! tmp%1 verus_tmp@) (=> (= verus_tmp_points_to@ (%Poly%vstd!raw_ptr.PointsToRaw. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. verus_tmp@))))) (=> (= verus_tmp_rest@ (%Poly%vstd!raw_ptr.PointsToRaw. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. verus_tmp@))))) (=> (= points_to@1 verus_tmp_points_to@) (=> (= rest@1 verus_tmp_rest@) (=> (ens%vstd!layout.layout_for_type_is_valid. $ TYPE%lib!linked_list.Node.) (=> (= tmp%3 (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!))))) (and (=> %%location_label%%1 (req%vstd!raw_ptr.impl&%11.into_typed. $ TYPE%lib!linked_list.Node. points_to@1 tmp%3)) (=> (ens%vstd!raw_ptr.impl&%11.into_typed. $ TYPE%lib!linked_list.Node. points_to@1 tmp%3 tmp%2) (=> (= verus_tmp$1@ (%Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. tmp%2)) (=> (= verus_tmp_points_to_node@0 verus_tmp$1@) (=> (= points_to_node@1 verus_tmp_points_to_node@0) (=> (= tmp%4 (lib!linked_list.Node./Node (%Poly%ptr_mut%<lib!linked_list.Node.>. (Poly%ptr_mut%<lib!linked_list.Node.>. next!)))) (and (=> %%location_label%%2 (req%vstd!raw_ptr.ptr_mut_write. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to_node@1) (Poly%lib!linked_list.Node. tmp%4))) (=> (ens%vstd!raw_ptr.ptr_mut_write. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to_node@1) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to_node@2) (Poly%lib!linked_list.Node. tmp%4)) (=> (= res! (tuple%2./tuple%2 (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to_node@2) (Poly%vstd!raw_ptr.PointsToRaw. rest@1))) (=> %%location_label%%3 (let ((points_to$ (%Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((points_to_raw$ (%Poly%vstd!raw_ptr.PointsToRaw. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (and (and (and (= (%Poly%ptr_mut%<lib!linked_list.Node.>. (vstd!raw_ptr.PointsToData./PointsToData/ptr (%Poly%vstd!raw_ptr.PointsToData. (vstd!view.View.view.? $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to$))))) ptr!) (= (vstd!raw_ptr.PointsToData./PointsToData/opt_value (%Poly%vstd!raw_ptr.PointsToData. (vstd!view.View.view.? $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to$)))) (vstd!raw_ptr.MemContents./Init (Poly%lib!linked_list.Node. (lib!linked_list.Node./Node (%Poly%ptr_mut%<lib!linked_list.Node.>. (Poly%ptr_mut%<lib!linked_list.Node.>. next!))))))) (= (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw$)) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.difference.? $ INT (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. perm!))) (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!)) (vstd!layout.size_of.? $ TYPE%lib!linked_list.Node.))))))))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw$)) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. ptr!)))))))))))))))))))))))))))))
(check-sat)
(exit)
