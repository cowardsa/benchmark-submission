...
(declare-const id! lib!tokens.SegmentId.)
(declare-const p! ptr_mut%<lib!types.SegmentHeader.>.)
(assert fuel_defaults)
(assert (>= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!)) 0))
(assert (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!)) lib!config.SEGMENT_SIZE.?) 0))
(assert (< (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!)) lib!config.SEGMENT_SIZE.?) (- (uHi SZ) 1)))
(assert (= (vstd!raw_ptr.PtrData./PtrData/metadata (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!types.SegmentHeader.) (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!)))) vstd!raw_ptr.Metadata./Thin))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!config.const_facts. 0) (=> (= id! (lib!tokens.SegmentId./SegmentId (%I (I (nClip (EucDiv (nClip (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!))) lib!config.SEGMENT_SIZE.?)))) (%Poly%vstd!raw_ptr.Provenance. (Poly%vstd!raw_ptr.Provenance. (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!types.SegmentHeader.) (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!)))))) (%I (I 0)))) (=> %%location_label%%0 (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!) (Poly%lib!tokens.SegmentId. id!)))))))
(check-sat)
(exit)
