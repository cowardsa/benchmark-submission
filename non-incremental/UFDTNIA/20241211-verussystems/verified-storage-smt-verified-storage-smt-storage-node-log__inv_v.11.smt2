...
(declare-const pm1! lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
(declare-const pm2! lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
(declare-const cdb! Bool)
(declare-const tmp%1 vstd!seq.Seq<u8.>.)
(declare-const tmp%2 vstd!seq.Seq<u8.>.)
(assert fuel_defaults)
(assert (lib!log.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm1!) (B cdb!)))
(assert (lib!log.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm2!) (B cdb!)))
(assert (lib!log.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm1!)))))
(assert (lib!log.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm1!) (B cdb!)))
(assert (let ((tmp%%$ lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (< 0 tmp%%$) (< tmp%%$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm1!))))))))
(assert (let ((tmp%%$ lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (< 0 tmp%%$) (< tmp%%$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm2!))))))))
(assert (lib!log.inv_v.active_metadata_is_equal.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm1!) (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm2!)))
(assert (= (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm1!)) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm2!))))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm1!))) (=> (= tmp%2 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm2!))) (and (=> %%location_label%%0 (req%lib!log.inv_v.lemma_active_metadata_bytes_equal_implies_metadata_types_set. tmp%1 tmp%2 cdb!)) (=> (ens%lib!log.inv_v.lemma_active_metadata_bytes_equal_implies_metadata_types_set. tmp%1 tmp%2 cdb!) (=> %%location_label%%1 (lib!log.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm2!)))))))))))
(check-sat)
(exit)
