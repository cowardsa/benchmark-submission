...
(declare-const bin_idx_start! Poly)
(declare-const bin_idx_end! Poly)
(declare-const wsize_start! Poly)
(declare-const wsize_end! Poly)
...
(assert (has_type bin_idx_start! INT))
(assert (has_type bin_idx_end! INT))
(assert (has_type wsize_start! INT))
(assert (has_type wsize_end! INT))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (Sub (%I bin_idx_end!) (%I bin_idx_start!))) (or (and (=> (>= (%I bin_idx_start!) (%I bin_idx_end!)) (=> (= tmp%4 true) %%switch_label%%0)) (=> (not (>= (%I bin_idx_start!) (%I bin_idx_end!))) (or (and (=> (lib!bin_sizes.check_idx_in_range_has_bin_size.? bin_idx_start! wsize_start! wsize_end!) (=> (= tmp%2 (I (Add (%I bin_idx_start!) 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((bin_idx_start!$0 (%I tmp%2)) (bin_idx_end!$1 (%I bin_idx_end!)) (wsize_start!$2 (%I wsize_start!)) (wsize_end!$3 (%I wsize_end!))) (Sub bin_idx_end!$1 bin_idx_start!$0)) decrease%init0 false)) (=> (= tmp%1 (lib!bin_sizes.check2_idx_in_range_has_bin_size.? (I (Add (%I bin_idx_start!) 1)) bin_idx_end! wsize_start! wsize_end!)) (=> (= tmp%3 tmp%1) %%switch_label%%1))))) (=> (not (lib!bin_sizes.check_idx_in_range_has_bin_size.? bin_idx_start! wsize_start! wsize_end!)) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 tmp%3) %%switch_label%%0))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
