...
(declare-const combined_header@ main!logimpl_v.PersistentHeader.)
...
(assert (= (main!logimpl_v.spec_bytes_to_header.? (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))) header!))
...
(assert (not (=> (= crc_val@ (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. crc_bytes!))) (=> (= metadata@ (main!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))) (=> (ens%main!logimpl_v.lemma_seq_addition. crc_bytes! metadata_bytes!) (=> (= combined_header@ (main!logimpl_v.spec_bytes_to_header.? (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)))) (=> (= tmp%1 (= (main!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. combined_header@))) crc_val@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false TYPE%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. metadata@) (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.spec_bytes_to_metadata.? (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (ext_eq false TYPE%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. combined_header@)))) (Poly%main!logimpl_v.PersistentHeaderMetadata. metadata@))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> %%location_label%%3 (let ((combined_header$ (main!logimpl_v.PersistentHeader./PersistentHeader (%I (I (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. crc_bytes!)))) (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))))))) (= header! combined_header$))))))))))))))))))
(check-sat)
(exit)
