...
(set-info :comment ";; MODULE 'module spec_t::impl_spec'")
...
(declare-const fuel%lib!spec_t.impl_spec.implements_interface_spec. FuelId)
...
(set-info :comment ";; Function-Decl lib::spec_t::impl_spec::implements_interface_spec")
(declare-fun lib!spec_t.impl_spec.implements_interface_spec.? (Dcr Type) Bool)
...
(set-info :comment ";; Function-Axioms lib::spec_t::impl_spec::implements_interface_spec")
(assert (fuel_bool_default fuel%lib!spec_t.impl_spec.implements_interface_spec.))
(assert (=> (fuel_bool fuel%lib!spec_t.impl_spec.implements_interface_spec.) (forall ((T&. Dcr) (T& Type)) (! (= (lib!spec_t.impl_spec.implements_interface_spec.? T&. T&) true) :pattern ((lib!spec_t.impl_spec.implements_interface_spec.? T&. T&))))))
...
(set-info :comment ";; Trait-Impl-Axiom")
(assert (tr_bound%lib!spec_t.impl_spec.InterfaceSpec. $ TYPE%lib!spec_t.impl_spec.PageTableImpl.))
(set-info :comment ";; Function-Specs lib::spec_t::impl_spec::theorem")
(declare-fun ens%lib!spec_t.impl_spec.theorem. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!spec_t.impl_spec.theorem. no%param) (lib!spec_t.impl_spec.implements_interface_spec.? $ TYPE%lib!spec_t.impl_spec.PageTableImpl.)) :pattern ((ens%lib!spec_t.impl_spec.theorem. no%param)))))
(set-info :comment ";; Function-Def lib::spec_t::impl_spec::theorem")
(set-info :comment ";; page-table/spec_t/impl_spec.rs:61:1: 61:23 (#0)")
(declare-const no%param Int)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (lib!spec_t.impl_spec.implements_interface_spec.? $ TYPE%lib!spec_t.impl_spec.PageTableImpl.))))
(check-sat)
(exit)
