...
(assert (not (and (=> (has_type base@ NAT) (=> (has_type pte@ TYPE%lib!definitions_t.PageTableEntry.) (=> (and (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!)) (lib!impl_u.l1.impl&%1.accepted_mapping.? (Poly%lib!impl_u.l1.Directory. self!) base@ pte@)) (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.lemma_accepted_mapping_implies_interp_accepted_mapping_manual. self! (%I base@) (%Poly%lib!definitions_t.PageTableEntry. pte@))) (=> (ens%lib!impl_u.l1.impl&%1.lemma_accepted_mapping_implies_interp_accepted_mapping_manual. self! (%I base@) (%Poly%lib!definitions_t.PageTableEntry. pte@)) (=> %%location_label%%1 (lib!impl_u.l0.impl&%0.accepted_mapping.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) base@ pte@))))))) (=> (forall ((base$ Poly) (pte$ Poly)) (! (=> (and (has_type base$ NAT) (has_type pte$ TYPE%lib!definitions_t.PageTableEntry.)) (=> (and (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!)) (lib!impl_u.l1.impl&%1.accepted_mapping.? (Poly%lib!impl_u.l1.Directory. self!) base$ pte$)) (lib!impl_u.l0.impl&%0.accepted_mapping.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) base$ pte$))) :pattern ((lib!impl_u.l1.impl&%1.accepted_mapping.? (Poly%lib!impl_u.l1.Directory. self!) base$ pte$)))) (=> %%location_label%%2 (forall ((base$ Poly) (pte$ Poly)) (! (=> (and (has_type base$ NAT) (has_type pte$ TYPE%lib!definitions_t.PageTableEntry.)) (=> (and (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!)) (lib!impl_u.l1.impl&%1.accepted_mapping.? (Poly%lib!impl_u.l1.Directory. self!) base$ pte$)) (lib!impl_u.l0.impl&%0.accepted_mapping.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) base$ pte$))) :pattern ((lib!impl_u.l1.impl&%1.accepted_mapping.? (Poly%lib!impl_u.l1.Directory. self!) base$ pte$)))))))))
(check-sat)
(exit)
