...
(set-info :comment ";; Function-Specs lib::io_t::EndPoint::view_equal_spec")
(declare-fun ens%lib!marshal_ironsht_specific_v.impl&%1.view_equal_spec. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!marshal_ironsht_specific_v.impl&%1.view_equal_spec. no%param) (forall ((x$ Poly) (y$ Poly)) (! (=> (and (has_type x$ TYPE%lib!io_t.EndPoint.) (has_type y$ TYPE%lib!io_t.EndPoint.)) (= (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!io_t.EndPoint. x$ y$)) (= (lib!io_t.impl&%4.view.? x$) (lib!io_t.impl&%4.view.? y$)))) :pattern ((lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!io_t.EndPoint. x$ y$))))) :pattern ((ens%lib!marshal_ironsht_specific_v.impl&%1.view_equal_spec. no%param)))))
(set-info :comment ";; Function-Def lib::io_t::EndPoint::view_equal_spec")
(set-info :comment ";; ironsht/src/marshal_ironsht_specific_v.rs:57:9: 57:39 (#0)")
(declare-const no%param Int)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (forall ((x$ Poly) (y$ Poly)) (! (=> (and (has_type x$ TYPE%lib!io_t.EndPoint.) (has_type y$ TYPE%lib!io_t.EndPoint.)) (= (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!io_t.EndPoint. x$ y$)) (= (lib!io_t.impl&%4.view.? x$) (lib!io_t.impl&%4.view.? y$)))) :pattern ((lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!io_t.EndPoint. x$ y$)))))))
(check-sat)
(exit)
