...
(declare-const mem! lib!spec_t.mem.PageTableMemory.)
(declare-const pt! lib!impl_u.l2_impl.PTDir.)
(declare-const layer! Int)
(declare-const ptr! Int)
(declare-const base_vaddr! Int)
(declare-const init! vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>.)
(declare-const tmp%1 Bool)
(declare-const tmp%2 vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>.)
(declare-const entry@ lib!impl_u.l1.NodeEntry.)
...
(assert (uInv SZ ptr!))
(assert (<= 0 base_vaddr!))
(assert (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!)))
...
(assert (not (=> (= decrease%init0 (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!)) (=> (= decrease%init1 (Sub lib!definitions_t.X86_NUM_ENTRIES.? (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)))) (=> (= decrease%init2 0) (or (and (=> (>= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)) lib!definitions_t.X86_NUM_ENTRIES.?) %%switch_label%%0) (=> (not (>= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)) lib!definitions_t.X86_NUM_ENTRIES.?)) (=> (= tmp%1 (lib!impl_u.l2_impl.PT.directories_obey_invariant_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= entry@ (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) (I (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!))))) (=> (= tmp%2 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (vstd!seq.Seq.push.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!) (Poly%lib!impl_u.l1.NodeEntry. entry@)))) (and (=> %%location_label%%1 (check_decrease_int (let ((mem!$0 mem!) (pt!$1 pt!) (layer!$2 layer!) (ptr!$3 ptr!) (base_vaddr!$4 base_vaddr!) (init!$5 tmp%2)) (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!$2)) decrease%init0 (check_decrease_int (let ((mem!$0 mem!) (pt!$1 pt!) (layer!$2 layer!) (ptr!$3 ptr!) (base_vaddr!$4 base_vaddr!) (init!$5 tmp%2)) (Sub lib!definitions_t.X86_NUM_ENTRIES.? (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!$5)))) decrease%init1 (check_decrease_int (let ((mem!$0 mem!) (pt!$1 pt!) (layer!$2 layer!) (ptr!$3 ptr!) (base_vaddr!$4 base_vaddr!) (init!$5 tmp%2)) 0) decrease%init2 false)))) (and (=> %%location_label%%2 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_aux_facts. mem! pt! layer! ptr! base_vaddr! tmp%2)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_aux_facts. mem! pt! layer! ptr! base_vaddr! tmp%2) %%switch_label%%0)))))))))) (and (not %%switch_label%%0) (and (=> %%location_label%%3 (= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l2_impl.PT.interp_at_aux.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)))) (ite (> (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)) lib!definitions_t.X86_NUM_ENTRIES.?) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)) lib!definitions_t.X86_NUM_ENTRIES.?))) (and (=> %%location_label%%4 (forall ((j$ Poly)) (! (=> (has_type j$ NAT) (=> (< (%I j$) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!))) (= (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l2_impl.PT.interp_at_aux.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!))) j$) (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!) j$)))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l2_impl.PT.interp_at_aux.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!))) j$))))) (=> %%location_label%%5 (let ((res$ (lib!impl_u.l2_impl.PT.interp_at_aux.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)))) (and (forall ((j$ Poly)) (! (=> (has_type j$ NAT) (=> (and (<= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)) (%I j$)) (< (%I j$) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$)))) (let ((tmp%%$ (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) j$))) (ite (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%$) (let ((dir_addr$ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$))))) (and (is-lib!impl_u.l1.NodeEntry./Directory_ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$) j$))) (= (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$) j$))) (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) j$))) (I (nClip (Add layer! 1))) (I dir_addr$) (I (lib!definitions_t.entry_base_from_index.? (I base_vaddr!) j$ (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I layer!))))))))) (ite (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%$) (let ((addr$ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$))))) (and (is-lib!impl_u.l1.NodeEntry./Page_ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$) j$))) (= (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$) j$))))))))) addr$))) (is-lib!impl_u.l1.NodeEntry./Empty_ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$) j$)))))))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$) j$)))) (forall ((j$ Poly)) (! (=> (has_type j$ NAT) (=> (and (<= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)) (%I j$)) (< (%I j$) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$)))) (= (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$) j$)) (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) j$)))) :pattern ((lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) j$))))))))))))))))
(check-sat)
(exit)
