...
(assert (not (=> (= pt@0 (%Poly%lib!impl_u.l2_impl.PTDir. (as_type (%%choose%%3 TYPE%lib!impl_u.l2_impl.PTDir. mem!@0 mem!@0 mem!@0) TYPE%lib!impl_u.l2_impl.PTDir.))) (=> (= tmp%1 (lib!definitions_t.MemRegionExec./MemRegionExec/base (%Poly%lib!definitions_t.MemRegionExec. (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? mem!@0))))) (and (=> %%location_label%%0 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. (%Poly%lib!spec_t.mem.PageTableMemory. mem!@0) pt@0 0 tmp%1 0)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. (%Poly%lib!spec_t.mem.PageTableMemory. mem!@0) pt@0 0 tmp%1 0) (=> (= tmp%2 (lib!impl_u.l2_impl.PT.interp.? mem!@0 (Poly%lib!impl_u.l2_impl.PTDir. pt@0))) (and (=> %%location_label%%1 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%2)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%2) (=> (= (lib!definitions_t.impl&%8.upper_vaddr.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I 0) (I 0)) lib!definitions_t.PT_BOUND_HIGH.?) (=> (ens%lib!impl_u.l2_refinement.lemma_page_table_walk_interp. 0) (and (=> %%location_label%%2 (req%lib!impl_u.l2_impl.PT.unmap. (%Poly%lib!spec_t.mem.PageTableMemory. mem!@0) pt@0 (%I vaddr!))) (=> (has_type mem!@1 TYPE%lib!spec_t.mem.PageTableMemory.) (=> (has_type (Poly%lib!impl_u.l2_impl.PTDir. pt@1) TYPE%lib!impl_u.l2_impl.PTDir.) (=> (ens%lib!impl_u.l2_impl.PT.unmap. (%Poly%lib!spec_t.mem.PageTableMemory. mem!@0) (%Poly%lib!spec_t.mem.PageTableMemory. mem!@1) pt@0 pt@1 (%I vaddr!) tmp%3) (=> (= %return! (Poly%core!result.Result. tmp%3)) (and (=> %%location_label%%3 (%B (lib!spec_t.impl_spec.InterfaceSpec.ispec_inv.? $ TYPE%lib!spec_t.impl_spec.PageTableImpl. self! mem!@1))) (=> %%location_label%%4 (lib!impl_u.spec_pt.step_Unmap.? (Poly%lib!impl_u.spec_pt.PageTableVariables. (lib!spec_t.impl_spec.pt_vars.? mem!@0)) (Poly%lib!impl_u.spec_pt.PageTableVariables. (lib!spec_t.impl_spec.pt_vars.? mem!@1)) vaddr! %return!)))))))))))))))))))
(check-sat)
(exit)
