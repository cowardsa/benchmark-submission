...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_flushing_metadata_maintains_invariants")
(set-info :comment ";; src/log/inv_v.rs:718:5: 724:6 (#0)")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_if_view_differs_only_in_log_area_parts_not_accessed_by_recovery_then_recover_state_matches")
(set-info :comment ";; src/log/inv_v.rs:817:5: 826:6 (#0)")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_header_bytes_equal_implies_active_metadata_bytes_equal")
(set-info :comment ";; src/log/inv_v.rs:1003:5: 1003:108 (#0)")
...
(assert (<= lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!))))
(assert (<= lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem2!))))
(assert (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem2!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?))))
(assert (is-core!option.Option./Some_ (lib!log.layout_v.deserialize_and_check_log_cdb.? (Poly%vstd!seq.Seq<u8.>. mem1!))))
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. mem1! mem2!) (=> (ens%lib!log.inv_v.lemma_auto_smaller_range_of_seq_is_subrange. mem1!) (=> (= cdb@ (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!log.layout_v.deserialize_and_check_log_cdb.? (Poly%vstd!seq.Seq<u8.>. mem1!))))))) (=> (= log_metadata_pos@ (lib!log.layout_v.get_log_metadata_pos.? (B cdb@))) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem2!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I log_metadata_pos@) (I (Add (Add log_metadata_pos@ (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem2!) (I log_metadata_pos@) (I (Add (Add log_metadata_pos@ (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> %%location_label%%2 (lib!log.inv_v.active_metadata_bytes_are_equal.? (Poly%vstd!seq.Seq<u8.>. mem1!) (Poly%vstd!seq.Seq<u8.>. mem2!))))))))))))))))
(check-sat)
(exit)
