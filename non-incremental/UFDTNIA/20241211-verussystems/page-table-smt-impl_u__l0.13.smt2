...
(assert (not (or (and (=> (lib!definitions_t.between.? base! (I (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. self!))) (I (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. self!)))) (=> (has_type size@ NAT) (=> (= tmp%1 (exists ((size$ Poly)) (! (and (has_type size$ NAT) (and (lib!definitions_t.impl&%8.contains_entry_size.? (Poly%lib!definitions_t.Arch. (lib!impl_u.l0.PageTableContents./PageTableContents/arch (%Poly%lib!impl_u.l0.PageTableContents. self!))) size$) (lib!definitions_t.aligned.? base! size$))) :pattern ((lib!definitions_t.impl&%8.contains_entry_size.? (Poly%lib!definitions_t.Arch. (lib!impl_u.l0.PageTableContents./PageTableContents/arch (%Poly%lib!impl_u.l0.PageTableContents. self!))) size$)) :pattern ((lib!definitions_t.aligned.? base! size$))))) %%switch_label%%0))) (=> (not (lib!definitions_t.between.? base! (I (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. self!))) (I (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. self!))))) (=> (= tmp%1 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
