...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (and (=> %%location_label%%0 (< (Add (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.? (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.GlobalMetadata.))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (=> %%location_label%%1 (< (Add (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_REGION_METADATA.? (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.RegionMetadata.))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (=> %%location_label%%2 (< (Add (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.? (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.LogMetadata.))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (=> %%location_label%%3 (< (Add (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_TRUE.? (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.LogMetadata.))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?))))))))
(check-sat)
(exit)
