...
(assert (has_type tmp%1 (UINT SZ)))
(assert (has_type (Poly%array%. tmp%2) (ARRAY $ (UINT SZ) $ (CONST_INT 8))))
...
(assert (not (=> (< i@0 8) (=> (< ofs@0 64) (=> (= mask@0 (uClip SZ (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@0)))) (I ofs@0)))) (=> (not (= mask@0 0)) (=> (= (uClip SZ (bitand (I mask@0) (I 1))) 0) (and (=> %%location_label%%0 (not (= mask@0 0))) (and (=> %%location_label%%1 (= (uClip SZ (bitand (I mask@0) (I 1))) 0)) (=> (not (= (uClip SZ (bitshr (I mask@0) (I 1))) 0)) (and (=> %%location_label%%2 true) (=> (forall ((m$ Poly) (n$ Int)) (! (=> (and (has_type m$ (UINT 64)) (uInv 64 n$)) (=> (< n$ 64) (= (uClip 64 (bitshr (I (uClip 64 (bitshr (I (%I m$)) (I n$)))) (I 1))) (uClip 64 (bitshr (I (%I m$)) (I (uClip 64 (Add n$ 1)))))))) :pattern ((uClip 64 (bitshr (I (%I m$)) (I (uClip 64 (Add n$ 1)))))))) (and (=> %%location_label%%3 true) (=> (forall ((m$ Poly)) (! (=> (has_type m$ (UINT 64)) (= (uClip 64 (bitshr (I (uClip 64 (bitshr (I (%I m$)) (I 63)))) (I 1))) 0)) :pattern ((uClip 64 (bitshr (I (%I m$)) (I 63)))))) (and (=> %%location_label%%4 (and (<= 0 1) (< 1 64))) (=> (= mask@1 (uClip SZ (bitshr (I mask@0) (I 1)))) (and (=> %%location_label%%5 (uInv SZ (Add ofs@0 1))) (=> (= ofs@1 (uClip SZ (Add ofs@0 1))) (and (=> %%location_label%%6 (< i@0 8)) (and (=> %%location_label%%7 (< ofs@1 64)) (and (=> %%location_label%%8 (= mask@1 (uClip SZ (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@0)))) (I ofs@1))))) (=> %%location_label%%9 (not (= mask@1 0))))))))))))))))))))))))
(check-sat)
(exit)
