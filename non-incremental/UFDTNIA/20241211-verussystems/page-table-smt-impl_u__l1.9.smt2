...
(assert (not (=> (= decrease%init0 (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)))) (or (and (=> (and (and (and (lib!impl_u.l1.impl&%1.well_formed.? self!) (lib!impl_u.l1.impl&%1.pages_match_entry_size.? self!)) (lib!impl_u.l1.impl&%1.directories_are_in_next_layer.? self!)) (lib!impl_u.l1.impl&%1.directories_match_arch.? self!)) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!impl_u.l1.Directory. self!))) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 true)) (=> (= tmp%1 (lib!impl_u.l1.impl&%1.directories_obey_invariant.? self!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (and (and (and (lib!impl_u.l1.impl&%1.well_formed.? self!) (lib!impl_u.l1.impl&%1.pages_match_entry_size.? self!)) (lib!impl_u.l1.impl&%1.directories_are_in_next_layer.? self!)) (lib!impl_u.l1.impl&%1.directories_match_arch.? self!))) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
