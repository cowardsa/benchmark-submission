...
(assert (uInv 64 i!))
(assert (<= 0 exp!))
(assert (= i! (lib!bin_sizes.pow2.? (I exp!))))
(assert (< exp! 64))
...
(assert (not (=> (= decrease%init0 i!) (=> (= tmp%1 (= (lib!bin_sizes.pow2.? (I 0)) 1)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (fuel_bool fuel%vstd!std_specs.bits.u64_leading_zeros.) (or (and (=> (= exp! 0) (=> (= (vstd!std_specs.bits.u64_leading_zeros.? (I 1)) 63) %%switch_label%%0)) (=> (not (= exp! 0)) (and (=> (ens%lib!bin_sizes.pow2_properties. 0) (=> %%location_label%%1 (> (lib!bin_sizes.pow2.? (I exp!)) (lib!bin_sizes.pow2.? (I 0))))) (=> (> (lib!bin_sizes.pow2.? (I exp!)) (lib!bin_sizes.pow2.? (I 0))) (and (=> (ens%lib!bin_sizes.pow2_properties. 0) (=> %%location_label%%2 (let ((tmp%%$ (nClip (EucDiv (lib!bin_sizes.pow2.? (I exp!)) 2)))) (and (= (uClip 64 (EucDiv i! 2)) tmp%%$) (= tmp%%$ (lib!bin_sizes.pow2.? (I (Sub exp! 1)))))))) (=> (let ((tmp%%$ (nClip (EucDiv (lib!bin_sizes.pow2.? (I exp!)) 2)))) (and (= (uClip 64 (EucDiv i! 2)) tmp%%$) (= tmp%%$ (lib!bin_sizes.pow2.? (I (Sub exp! 1)))))) (and (=> (ens%lib!bin_sizes.pow2_properties. 0) (=> %%location_label%%3 (< (lib!bin_sizes.pow2.? (I (Sub exp! 1))) (lib!bin_sizes.pow2.? (I exp!))))) (=> (< (lib!bin_sizes.pow2.? (I (Sub exp! 1))) (lib!bin_sizes.pow2.? (I exp!))) (=> (= tmp%2 (uClip 64 (EucDiv i! 2))) (=> (= tmp%3 (nClip (Sub exp! 1))) (and (=> %%location_label%%4 (check_decrease_int (let ((i!$0 tmp%2) (exp!$1 tmp%3)) i!$0) decrease%init0 false)) (and (=> %%location_label%%5 (req%lib!bin_sizes.leading_zeros_powers_of_2. tmp%2 tmp%3)) (=> (ens%lib!bin_sizes.leading_zeros_powers_of_2. tmp%2 tmp%3) (=> (= tmp%4 (= (vstd!std_specs.bits.u64_leading_zeros.? (I (uClip 64 (EucDiv i! 2)))) (Sub (Sub 64 (Sub exp! 1)) 1))) (and (=> %%location_label%%6 tmp%4) (=> tmp%4 (=> (= tmp%5 (let ((tmp%%$ (uClip 32 (Sub (vstd!std_specs.bits.u64_leading_zeros.? (I (uClip 64 (EucDiv i! 2)))) 1)))) (let ((tmp%%$3 (uClip 32 (Sub (Sub (Sub 64 (Sub exp! 1)) 1) 1)))) (and (and (= (vstd!std_specs.bits.u64_leading_zeros.? (I i!)) tmp%%$) (= tmp%%$ tmp%%$3)) (= tmp%%$3 (uClip 32 (Sub (Sub 64 exp!) 1))))))) (and (=> %%location_label%%7 tmp%5) (=> tmp%5 %%switch_label%%0))))))))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%8 (= (vstd!std_specs.bits.u64_leading_zeros.? (I i!)) (Sub (Sub 64 exp!) 1))))))))))))
(check-sat)
(exit)
