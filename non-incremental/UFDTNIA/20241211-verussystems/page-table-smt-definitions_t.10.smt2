...
(assert (not (=> (< (%I i!) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!))))) (or (and (=> (< (nClip (Add (%I i!) 1)) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!))))) (and (=> %%location_label%%0 (req%lib!definitions_t.impl&%8.entry_size. self! i!)) (=> (= tmp%1 (lib!definitions_t.impl&%8.entry_size.? self! i!)) (=> (= tmp%3 (I (nClip (Add (%I i!) 1)))) (and (=> %%location_label%%1 (req%lib!definitions_t.impl&%8.entry_size. self! tmp%3)) (=> (= tmp%2 (lib!definitions_t.impl&%8.entry_size.? self! (I (nClip (Add (%I i!) 1))))) (=> (= tmp%5 (I (nClip (Add (%I i!) 1)))) (and (=> %%location_label%%2 (req%lib!definitions_t.impl&%8.num_entries. self! tmp%5)) (=> (= tmp%4 (lib!definitions_t.impl&%8.num_entries.? self! (I (nClip (Add (%I i!) 1))))) (=> (= tmp%6 (= tmp%1 (nClip (Mul tmp%2 tmp%4)))) %%switch_label%%0)))))))))) (=> (not (< (nClip (Add (%I i!) 1)) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!)))))) (=> (= tmp%6 true) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
