...
(assert (and (and (lib!impl_u.l2_impl.impl&%0.hp_pat_is_zero.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)) (lib!spec_t.hardware.impl&%3.all_mb0_bits_are_zero.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))) (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))))
...
(assert (not (=> (= e@ (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/entry (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (=> (= mw@ lib!definitions_t.MAX_PHYADDR_WIDTH.?) (=> (ens%lib!definitions_t.axiom_max_phyaddr_width_facts. 0) (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%3.all_mb0_bits_are_zero.) (or (and (=> (= (lib!spec_t.hardware.impl&%3.layer.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)) 1) (and (=> %%location_label%%0 (= (uClip 64 (bitand (I e@) (I (uClip 64 (bitshl (I 1) (I 12)))))) 0)) (and (=> %%location_label%%1 (= (uClip 64 (bitand (I e@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 29 1)) 13))))))))) (I 13)))))) 0)) (and (=> %%location_label%%2 (and (<= 32 mw@) (<= mw@ 52))) (=> (= (uClip 64 (bitand (I e@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add (uClip 64 (Sub mw@ 1)) 1)) 12))))))))) (I 12)))))) (uClip 64 (bitand (I e@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add (uClip 64 (Sub mw@ 1)) 1)) 30))))))))) (I 30))))))) %%switch_label%%0))))) (=> (not (= (lib!spec_t.hardware.impl&%3.layer.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)) 1)) (or (and (=> (= (lib!spec_t.hardware.impl&%3.layer.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)) 2) (and (=> %%location_label%%3 (= (uClip 64 (bitand (I e@) (I (uClip 64 (bitshl (I 1) (I 12)))))) 0)) (and (=> %%location_label%%4 (= (uClip 64 (bitand (I e@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 20 1)) 13))))))))) (I 13)))))) 0)) (and (=> %%location_label%%5 (and (<= 32 mw@) (<= mw@ 52))) (=> (= (uClip 64 (bitand (I e@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add (uClip 64 (Sub mw@ 1)) 1)) 12))))))))) (I 12)))))) (uClip 64 (bitand (I e@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add (uClip 64 (Sub mw@ 1)) 1)) 21))))))))) (I 21))))))) %%switch_label%%1))))) (=> (not (= (lib!spec_t.hardware.impl&%3.layer.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)) 2)) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (and (=> %%location_label%%6 (=> (= (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/layer (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))) 1) (= (uClip 64 (bitand (I (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/entry (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (I lib!spec_t.hardware.MASK_L1_PG_ADDR_SPEC.?))) (uClip 64 (bitand (I (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/entry (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (I lib!spec_t.hardware.MASK_ADDR_SPEC.?)))))) (=> %%location_label%%7 (=> (= (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/layer (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))) 2) (= (uClip 64 (bitand (I (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/entry (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (I lib!spec_t.hardware.MASK_L2_PG_ADDR_SPEC.?))) (uClip 64 (bitand (I (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/entry (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (I lib!spec_t.hardware.MASK_ADDR_SPEC.?)))))))))))))))
(check-sat)
(exit)
