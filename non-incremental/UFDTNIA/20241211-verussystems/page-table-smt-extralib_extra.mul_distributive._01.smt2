...
(set-info :comment ";; page-table/extra.rs:94:1: 94:46 (#0)")
...
(set-info :comment ";; Function-Def lib::extra::mul_distributive")
(set-info :comment ";; page-table/extra.rs:94:1: 94:46 (#0)")
(declare-const a! Int)
(declare-const b! Int)
...
(assert (not (=> %%location_label%%0 (= (nClip (Mul (nClip (Add a! 1)) b!)) (nClip (Add (nClip (Mul a! b!)) b!))))))
(check-sat)
(exit)
