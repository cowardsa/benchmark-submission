...
(assert (not (=> (= decrease%init0 (Sub lib!definitions_t.X86_NUM_LAYERS.? (%I layer!))) (=> (= decrease%init1 lib!definitions_t.X86_NUM_ENTRIES.?) (=> (= decrease%init2 2) (=> (lib!impl_u.l2_impl.PT.inv_at.? mem! pt! layer! ptr!) (=> (= tmp%2 (vstd!seq.Seq.empty.? $ TYPE%lib!impl_u.l1.NodeEntry.)) (=> %%location_label%%0 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!)) (base_vaddr!$4 (%I base_vaddr!)) (init!$5 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. tmp%2))) (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!$2)) decrease%init0 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!)) (base_vaddr!$4 (%I base_vaddr!)) (init!$5 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. tmp%2))) (Sub lib!definitions_t.X86_NUM_ENTRIES.? (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!$5)))) decrease%init1 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!)) (base_vaddr!$4 (%I base_vaddr!)) (init!$5 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. tmp%2))) 1) decrease%init2 false)))))))))))
(check-sat)
(exit)
