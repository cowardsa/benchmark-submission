...
(set-info :comment ";; page-table/impl_u/l2_impl.rs:91:13: 91:19 (#0)")
...
(assert (not (=> %%location_label%%0 (lib!definitions_t.aligned.? (I lib!definitions_t.L3_ENTRY_SIZE.?) (I lib!definitions_t.PAGE_SIZE.?)))))
(check-sat)
(exit)
