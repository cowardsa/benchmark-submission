...
(set-info :comment ";; page-table/spec_t/mem.rs:215:9: 215:15 (#0)")
...
(assert (iInv SZ word_offset@))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (< word_offset@ 562949953421823) (=> %%location_label%%0 (< (Mul word_offset@ lib!definitions_t.WORD_SIZE.?) 4503599627374584)))))
(check-sat)
(exit)
