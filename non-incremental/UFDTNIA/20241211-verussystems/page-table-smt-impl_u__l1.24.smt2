...
(assert (not (=> (lib!impl_u.l1.impl&%1.inv.? self!) (or (and (=> (<= (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. self!)) (%I base!)) (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.upper_vaddr. self!)) (=> (= tmp%1 (lib!impl_u.l1.impl&%1.upper_vaddr.? self!)) (=> (= tmp%2 (<= (nClip (Add (%I base!) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte!))))))) tmp%1)) %%switch_label%%0)))) (=> (not (<= (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. self!)) (%I base!))) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
