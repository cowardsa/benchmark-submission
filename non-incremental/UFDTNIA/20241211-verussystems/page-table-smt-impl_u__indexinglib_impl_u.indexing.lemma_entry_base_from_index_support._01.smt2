...
(set-info :comment ";; page-table/impl_u/indexing.rs:37:5: 37:11 (#0)")
...
(assert (not (=> %%location_label%%0 (forall ((a$ Int) (b$ Int)) (! (=> (and (<= 0 a$) (<= 0 b$)) (= (lib!impl_u.indexing.nat_mul.? (I a$) (I b$)) (nClip (Mul a$ b$)))) :pattern ((nClip (Mul a$ b$))))))))
(check-sat)
(exit)
