...
(declare-const tmp%4 lib!impl_u.l1.NodeEntry.)
...
(assert (has_type pt! TYPE%lib!impl_u.l2_impl.PTDir.))
(assert (has_type layer! NAT))
(assert (has_type ptr! (UINT SZ)))
(assert (has_type base_vaddr! NAT))
(assert (has_type idx! NAT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (Sub lib!definitions_t.X86_NUM_LAYERS.? (%I layer!))) (=> (= decrease%init1 (Sub lib!definitions_t.X86_NUM_ENTRIES.? (%I idx!))) (=> (= decrease%init2 0) (=> (lib!impl_u.l2_impl.PT.inv_at.? mem! pt! layer! ptr!) (=> (= tmp%%@ (lib!impl_u.l2_impl.PT.view_at.? mem! pt! layer! ptr! idx!)) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%@) (=> (= dir_addr@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@)))) (=> (= entry_base@ (lib!definitions_t.entry_base_from_index.? base_vaddr! idx! (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) layer!)))) (=> (= tmp%2 (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. pt!))) idx!)))) (=> (= tmp%3 (I (nClip (Add (%I layer!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. tmp%2)) (layer!$2 (%I tmp%3)) (ptr!$3 dir_addr@) (base_vaddr!$4 entry_base@)) (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!$2)) decrease%init0 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. tmp%2)) (layer!$2 (%I tmp%3)) (ptr!$3 dir_addr@) (base_vaddr!$4 entry_base@)) lib!definitions_t.X86_NUM_ENTRIES.?) decrease%init1 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. tmp%2)) (layer!$2 (%I tmp%3)) (ptr!$3 dir_addr@) (base_vaddr!$4 entry_base@)) 2) decrease%init2 false)))) (=> (has_type (Poly%lib!impl_u.l1.Directory. tmp%1) TYPE%lib!impl_u.l1.Directory.) (=> (= tmp%1 (lib!impl_u.l2_impl.PT.interp_at.? mem! (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. pt!))) idx!))) (I (nClip (Add (%I layer!) 1))) (I dir_addr@) (I entry_base@))) (=> (= tmp%4 (lib!impl_u.l1.NodeEntry./Directory (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. tmp%1)))) %%switch_label%%0))))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%@)) (=> (= tmp%4 (ite (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%@) (let ((addr$ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@))))) (let ((flag_RW$ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@))))) (let ((flag_US$ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@))))) (let ((flag_XD$ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@))))) (lib!impl_u.l1.NodeEntry./Page (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. (lib!definitions_t.PageTableEntry./PageTableEntry (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I addr$)) (%I (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) layer!)))))) (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.Flags./Flags (%B (B flag_RW$)) (%B (B (not flag_US$))) (%B (B flag_XD$))))))))))))) lib!impl_u.l1.NodeEntry./Empty)) %%switch_label%%0))) (not %%switch_label%%0)))))))))
(check-sat)
(exit)
