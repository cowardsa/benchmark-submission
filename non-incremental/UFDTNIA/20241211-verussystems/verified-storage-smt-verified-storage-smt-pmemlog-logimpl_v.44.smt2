...
(declare-const tmp%12 vstd!seq.Seq<u8.>.)
(declare-const tmp%13 Bool)
(declare-const tmp%14 vstd!seq.Seq<u8.>.)
(declare-const tmp%15 Int)
(declare-const tmp%16 Bool)
(declare-const tmp%17 Bool)
(declare-const tmp%18 Bool)
(declare-const log_state$1@ main!infinitelog_t.AbstractInfiniteLogState.)
(declare-const log_state@ core!option.Option.)
(declare-const log_size@ Int)
(declare-const log_header_metadata@ main!logimpl_v.PersistentHeaderMetadata.)
(declare-const metadata_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const crc_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const log_header@ main!logimpl_v.PersistentHeader.)
(declare-const header_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const initial_ib_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
...
(assert (not (or (and (=> (<= device_size! main!logimpl_v.contents_offset.?) (and (=> %%location_label%%0 (uInv 64 (Add main!logimpl_v.contents_offset.? 1))) (=> (= result! (core!result.Result./Err (Poly%main!main_t.InfiniteLogErr. (main!main_t.InfiniteLogErr./InsufficientSpaceForSetup (%I (I (uClip 64 (Add main!logimpl_v.contents_offset.? 1)))))))) (and (=> %%location_label%%1 (%B (main!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!@0))) (and (=> %%location_label%%2 (= (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!@0) (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!@0))) (and (=> %%location_label%%3 (= (vstd!seq.Seq.len.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@0)) device_size!)) (=> %%location_label%%4 (ite (is-core!result.Result./Ok_ result!) (let ((capacity$ (%I (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= (main!logimpl_v.impl&%0.recover.? (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@0)) (core!option.Option./Some (Poly%main!infinitelog_t.AbstractInfiniteLogState. (main!infinitelog_t.impl&%0.initialize.? (I capacity$)))))) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./InsufficientSpaceForSetup_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((required_space$ (main!main_t.InfiniteLogErr./InsufficientSpaceForSetup/required_space (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (< device_size! required_space$))))))))))) (=> (not (<= device_size! main!logimpl_v.contents_offset.?)) %%switch_label%%1)) (and (not %%switch_label%%1) (and (=> %%location_label%%5 (uInv 64 (Sub device_size! main!logimpl_v.contents_offset.?))) (=> (= log_size@ (uClip 64 (Sub device_size! main!logimpl_v.contents_offset.?))) (=> (= log_header_metadata@ (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata (%I (I 0)) (%I (I 0)) (%I (I log_size@)))) (=> (ens%main!logimpl_v.metadata_to_bytes. log_header_metadata@ metadata_bytes@) (=> (ens%main!pmemspec_t.bytes_crc. metadata_bytes@ crc_bytes@) (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@) tmp%1) (and (=> %%location_label%%6 (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%1))) (=> (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%1) tmp%2) (=> (= log_header@ (main!logimpl_v.PersistentHeader./PersistentHeader (%I (I tmp%2)) (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. log_header_metadata@)))) (=> (ens%main!logimpl_v.header_to_bytes. log_header@ header_bytes@) (=> (= tmp%3 main!pmemspec_t.cdb0_val.?) (=> (ens%vstd!bytes.u64_to_le_bytes. tmp%3 initial_ib_bytes@) (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. header_bytes@) tmp%4) (=> (= tmp%5 (I main!logimpl_v.header1_pos.?)) (and (=> %%location_label%%7 (req%main!pmemspec_t.PersistentMemory.write. PM&. PM& pm!@0 tmp%5 tmp%4)) (=> (has_type pm!@1 PM&) (=> (ens%main!pmemspec_t.PersistentMemory.write. PM&. PM& pm!@0 pm!@1 tmp%5 tmp%4) (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. initial_ib_bytes@) tmp%6) (=> (= tmp%7 (I main!logimpl_v.incorruptible_bool_pos.?)) (and (=> %%location_label%%8 (req%main!pmemspec_t.PersistentMemory.write. PM&. PM& pm!@1 tmp%7 tmp%6)) (=> (has_type pm!@2 PM&) (=> (ens%main!pmemspec_t.PersistentMemory.write. PM&. PM& pm!@1 pm!@2 tmp%7 tmp%6) (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2) (I main!logimpl_v.header1_pos.?) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. header_bytes@)))) (and (=> %%location_label%%9 tmp%8) (=> tmp%8 (=> (= tmp%9 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2) (I main!logimpl_v.incorruptible_bool_pos.?) (I (Add main!logimpl_v.incorruptible_bool_pos.? 8))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. initial_ib_bytes@)))) (and (=> %%location_label%%10 tmp%9) (=> tmp%9 (=> (= tmp%10 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@)))) (=> (= tmp%11 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. metadata_bytes@)))) (=> (= tmp%12 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. header_bytes@)))) (and (=> %%location_label%%11 (req%main!logimpl_v.lemma_header_split_into_bytes. tmp%10 tmp%11 tmp%12)) (=> (ens%main!logimpl_v.lemma_header_split_into_bytes. tmp%10 tmp%11 tmp%12) (=> (= tmp%13 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_head_offset.?)) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. metadata_bytes@)))) (and (=> %%location_label%%12 tmp%13) (=> tmp%13 (=> (= tmp%14 (%Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2))) (=> (= tmp%15 main!logimpl_v.header1_pos.?) (and (=> %%location_label%%13 (req%main!logimpl_v.lemma_header_match. tmp%14 tmp%15 log_header@)) (=> (ens%main!logimpl_v.lemma_header_match. tmp%14 tmp%15 log_header@) (=> (= log_state@ (main!logimpl_v.impl&%0.recover.? (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2))) (or (and (=> (is-core!option.Option./Some_ log_state@) (=> (= log_state$1@ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. log_state@))))) (=> (= tmp%16 (= (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. log_state$1@))) 0)) (and (=> %%location_label%%14 tmp%16) (=> tmp%16 (=> (= tmp%17 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. log_state$1@)))) (vstd!seq.Seq.empty.? $ (UINT 8)))) (and (=> %%location_label%%15 tmp%17) (=> tmp%17 (=> (= tmp%18 (= (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/capacity (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. log_state$1@))) (Sub log_size@ 1))) (and (=> %%location_label%%16 tmp%18) (=> tmp%18 %%switch_label%%0))))))))))) (=> (not (is-core!option.Option./Some_ log_state@)) (=> %%location_label%%17 false))) (and (not %%switch_label%%0) (and (=> %%location_label%%18 (uInv 64 (Sub log_size@ 1))) (=> (= result! (core!result.Result./Ok (I (uClip 64 (Sub log_size@ 1))))) (and (=> %%location_label%%19 (%B (main!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!@2))) (and (=> %%location_label%%20 (= (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!@2) (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!@0))) (and (=> %%location_label%%21 (= (vstd!seq.Seq.len.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2)) device_size!)) (=> %%location_label%%22 (ite (is-core!result.Result./Ok_ result!) (let ((capacity$ (%I (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= (main!logimpl_v.impl&%0.recover.? (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2)) (core!option.Option./Some (Poly%main!infinitelog_t.AbstractInfiniteLogState. (main!infinitelog_t.impl&%0.initialize.? (I capacity$)))))) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./InsufficientSpaceForSetup_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((required_space$ (main!main_t.InfiniteLogErr./InsufficientSpaceForSetup/required_space (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (< device_size! required_space$))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
