...
(assert (= num_regions! (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>. region_sizes!))))
