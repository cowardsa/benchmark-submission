...
(assert (uInv SZ size!))
(assert (= (uClip SZ (EucMod size! 8)) 0))
(assert (<= size! 131072))
(assert (lib!bin_sizes.valid_bin_idx.? (I (lib!bin_sizes.smallest_bin_fitting_size.? (I size!)))))
...
(assert (not (=> (lib!bin_sizes.check_bin.? (I 0) (I 8192)) (=> (lib!bin_sizes.check_bin.? (I 8192) (I 16384)) (=> (lib!bin_sizes.check_bin.? (I 16384) (I 24576)) (=> (lib!bin_sizes.check_bin.? (I 24576) (I 32768)) (=> (lib!bin_sizes.check_bin.? (I 32768) (I 40960)) (=> (lib!bin_sizes.check_bin.? (I 40960) (I 49152)) (=> (lib!bin_sizes.check_bin.? (I 49152) (I 57344)) (=> (lib!bin_sizes.check_bin.? (I 57344) (I 65536)) (=> (lib!bin_sizes.check_bin.? (I 65536) (I 73728)) (=> (lib!bin_sizes.check_bin.? (I 73728) (I 81920)) (=> (lib!bin_sizes.check_bin.? (I 81920) (I 90112)) (=> (lib!bin_sizes.check_bin.? (I 90112) (I 98304)) (=> (lib!bin_sizes.check_bin.? (I 98304) (I 106496)) (=> (lib!bin_sizes.check_bin.? (I 106496) (I 114688)) (=> (lib!bin_sizes.check_bin.? (I 114688) (I 122880)) (=> (lib!bin_sizes.check_bin.? (I 122880) (I 131080)) (and (=> %%location_label%%0 (req%lib!bin_sizes.result_bin. 0 8192)) (=> (ens%lib!bin_sizes.result_bin. 0 8192) (and (=> %%location_label%%1 (req%lib!bin_sizes.result_bin. 8192 16384)) (=> (ens%lib!bin_sizes.result_bin. 8192 16384) (and (=> %%location_label%%2 (req%lib!bin_sizes.result_bin. 16384 24576)) (=> (ens%lib!bin_sizes.result_bin. 16384 24576) (and (=> %%location_label%%3 (req%lib!bin_sizes.result_bin. 24576 32768)) (=> (ens%lib!bin_sizes.result_bin. 24576 32768) (and (=> %%location_label%%4 (req%lib!bin_sizes.result_bin. 32768 40960)) (=> (ens%lib!bin_sizes.result_bin. 32768 40960) (and (=> %%location_label%%5 (req%lib!bin_sizes.result_bin. 40960 49152)) (=> (ens%lib!bin_sizes.result_bin. 40960 49152) (and (=> %%location_label%%6 (req%lib!bin_sizes.result_bin. 49152 57344)) (=> (ens%lib!bin_sizes.result_bin. 49152 57344) (and (=> %%location_label%%7 (req%lib!bin_sizes.result_bin. 57344 65536)) (=> (ens%lib!bin_sizes.result_bin. 57344 65536) (and (=> %%location_label%%8 (req%lib!bin_sizes.result_bin. 65536 73728)) (=> (ens%lib!bin_sizes.result_bin. 65536 73728) (and (=> %%location_label%%9 (req%lib!bin_sizes.result_bin. 73728 81920)) (=> (ens%lib!bin_sizes.result_bin. 73728 81920) (and (=> %%location_label%%10 (req%lib!bin_sizes.result_bin. 81920 90112)) (=> (ens%lib!bin_sizes.result_bin. 81920 90112) (and (=> %%location_label%%11 (req%lib!bin_sizes.result_bin. 90112 98304)) (=> (ens%lib!bin_sizes.result_bin. 90112 98304) (and (=> %%location_label%%12 (req%lib!bin_sizes.result_bin. 98304 106496)) (=> (ens%lib!bin_sizes.result_bin. 98304 106496) (and (=> %%location_label%%13 (req%lib!bin_sizes.result_bin. 106496 114688)) (=> (ens%lib!bin_sizes.result_bin. 106496 114688) (and (=> %%location_label%%14 (req%lib!bin_sizes.result_bin. 114688 122880)) (=> (ens%lib!bin_sizes.result_bin. 114688 122880) (and (=> %%location_label%%15 (req%lib!bin_sizes.result_bin. 122880 131080)) (=> (ens%lib!bin_sizes.result_bin. 122880 131080) (=> (= tmp%1 (lib!bin_sizes.id.? (I size!))) (and (=> %%location_label%%16 tmp%1) (=> tmp%1 (=> %%location_label%%17 (let ((tmp%%$ (lib!bin_sizes.size_of_bin.? (I (lib!bin_sizes.smallest_bin_fitting_size.? (I size!)))))) (and (>= 131072 tmp%%$) (>= tmp%%$ size!)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
