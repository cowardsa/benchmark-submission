...
(declare-const verus_tmp_points_to_node@0 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const verus_tmp_points_to_raw@ vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp_block@ lib!tokens.Mim.block.)
(declare-const verus_tmp_is_exposed@ vstd!raw_ptr.IsExposed.)
(declare-const tmp%4 Int)
(declare-const tmp%5 ptr_mut%<lib!linked_list.Node.>.)
(declare-const tmp%6 Poly)
(declare-const tmp%7 Poly)
(declare-const tmp%8 ptr_mut%<lib!linked_list.Node.>.)
(declare-const tmp%9 vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp_points_to_raw$1@ vstd!raw_ptr.PointsToRaw.)
...
(declare-const verus_tmp@ tuple%4.)
(declare-const points_to_node@0 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const points_to_raw@0 vstd!raw_ptr.PointsToRaw.)
(declare-const block@0 lib!tokens.Mim.block.)
(declare-const is_exposed@0 vstd!raw_ptr.IsExposed.)
(declare-const ptr@ ptr_mut%<lib!linked_list.Node.>.)
(declare-const node@ lib!linked_list.Node.)
(declare-const verus_tmp$1@ vstd!raw_ptr.PointsToRaw.)
(declare-const points_to_raw$1@0 vstd!raw_ptr.PointsToRaw.)
(declare-const ptru@ ptr_mut%<u8.>.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!linked_list.LL. self!@0) TYPE%lib!linked_list.LL.))
(assert (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. self!@0)))
(assert (not (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!@0)) 0)))
(declare-const self!@1 lib!linked_list.LL.)
(declare-const points_to_node@1 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const points_to_raw@1 vstd!raw_ptr.PointsToRaw.)
(declare-const block@1 lib!tokens.Mim.block.)
(declare-const is_exposed@1 vstd!raw_ptr.IsExposed.)
(declare-const points_to_node@2 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const self!@2 lib!linked_list.LL.)
(declare-const points_to_raw$1@1 vstd!raw_ptr.PointsToRaw.)
...
(assert (not (=> (= i@ (nClip (Sub (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@0)))))) 1))) (=> (= tmp%1 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@0) (I i@) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@0) (I i@))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%3 (nClip (Sub (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@0)))))) 1))) (and (=> %%location_label%%1 (req%vstd!map.impl&%0.tracked_remove. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@0)))) (I tmp%3))) (=> (and (= (lib!linked_list.LL./LL/first self!@0) (lib!linked_list.LL./LL/first self!@1)) (= (lib!linked_list.LL./LL/data self!@0) (lib!linked_list.LL./LL/data self!@1))) (=> (has_type (Poly%lib!linked_list.LL. self!@1) TYPE%lib!linked_list.LL.) (=> (ens%vstd!map.impl&%0.tracked_remove. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@0)))) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@1)))) (I tmp%3) tmp%2) (=> (= verus_tmp@ (%Poly%tuple%4. tmp%2)) (=> (= verus_tmp_points_to_node@0 (%Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. verus_tmp@))))) (=> (= verus_tmp_points_to_raw@ (%Poly%vstd!raw_ptr.PointsToRaw. (tuple%4./tuple%4/1 (%Poly%tuple%4. (Poly%tuple%4. verus_tmp@))))) (=> (= verus_tmp_block@ (%Poly%lib!tokens.Mim.block. (tuple%4./tuple%4/2 (%Poly%tuple%4. (Poly%tuple%4. verus_tmp@))))) (=> (= verus_tmp_is_exposed@ (%Poly%vstd!raw_ptr.IsExposed. (tuple%4./tuple%4/3 (%Poly%tuple%4. (Poly%tuple%4. verus_tmp@))))) (=> (= points_to_node@1 verus_tmp_points_to_node@0) (=> (= points_to_raw@1 verus_tmp_points_to_raw@) (=> (= block@1 verus_tmp_block@) (=> (= is_exposed@1 verus_tmp_is_exposed@) (=> (= tmp%5 (lib!linked_list.LL./LL/first (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@1)))) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. tmp%5) tmp%4) (=> (ens%vstd!raw_ptr.with_exposed_provenance. $ TYPE%lib!linked_list.Node. tmp%4 is_exposed@1 tmp%6) (=> (= ptr@ (%Poly%ptr_mut%<lib!linked_list.Node.>. tmp%6)) (and (=> %%location_label%%2 (req%vstd!raw_ptr.ptr_mut_read. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr@) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to_node@1))) (=> (ens%vstd!raw_ptr.ptr_mut_read. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr@) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to_node@1) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to_node@2) tmp%7) (=> (= node@ (%Poly%lib!linked_list.Node. tmp%7)) (=> (= tmp%8 (lib!linked_list.Node./Node/ptr (%Poly%lib!linked_list.Node. (Poly%lib!linked_list.Node. node@)))) (=> (= (lib!linked_list.LL./LL/first (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@2))) tmp%8) (=> (and (= (lib!linked_list.LL./LL/data self!@1) (lib!linked_list.LL./LL/data self!@2)) (= (lib!linked_list.LL./LL/perms self!@1) (lib!linked_list.LL./LL/perms self!@2))) (and (=> %%location_label%%3 (req%vstd!raw_ptr.impl&%12.into_raw. $ TYPE%lib!linked_list.Node. (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to_node@2))) (=> (ens%vstd!raw_ptr.impl&%12.into_raw. $ TYPE%lib!linked_list.Node. (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. points_to_node@2) tmp%9) (and (=> %%location_label%%4 (req%vstd!raw_ptr.impl&%11.join. tmp%9 points_to_raw@1)) (=> (ens%vstd!raw_ptr.impl&%11.join. tmp%9 points_to_raw@1 verus_tmp$1@) (=> (= verus_tmp_points_to_raw$1@ verus_tmp$1@) (=> (= points_to_raw$1@1 verus_tmp_points_to_raw$1@) (=> (ens%vstd!raw_ptr.cast_ptr_to_thin_ptr. $ TYPE%lib!linked_list.Node. $ (UINT 8) (Poly%ptr_mut%<lib!linked_list.Node.>. ptr@) tmp%10) (=> (= ptru@ (%Poly%ptr_mut%<u8.>. tmp%10)) (=> (= tmp%11 (nClip (Sub (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@2)))))) 1))) (=> (= (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3)))))) tmp%11) (=> (and (= (lib!linked_list.LL./LL/first self!@2) (lib!linked_list.LL./LL/first self!@3)) (= (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LL./LL/perms self!@2) (lib!linked_list.LL./LL/perms self!@3))) (and (=> (has_type i$1@ NAT) (=> (= tmp%12 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@0) i$1@ (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@0) i$1@)))) (and (=> %%location_label%%5 tmp%12) (=> tmp%12 (or (and (=> (> (%I i$1@) 0) (=> (= j@ (nClip (Sub (%I i$1@) 1))) (=> (= tmp%13 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@0) (I j@) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@0) (I j@))))) (and (=> %%location_label%%6 tmp%13) (=> tmp%13 %%switch_label%%0))))) (=> (not (> (%I i$1@) 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%7 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@3) i$1@ (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@3) i$1@)))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@3) i$ (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@3) i$)))) :pattern ((lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@3) i$)))) (=> (= j$1@ (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3))))))) (=> (= tmp%14 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@0) (I j$1@) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@0) (I j$1@))))) (and (=> %%location_label%%8 tmp%14) (=> tmp%14 (=> (= tmp%15 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@0) (I (nClip (Sub j$1@ 1))) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@0) (I (nClip (Sub j$1@ 1))))))) (and (=> %%location_label%%9 tmp%15) (=> tmp%15 (=> (= tmp%16 (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3))))) i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3)))))))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3))))) i$))))) (and (=> %%location_label%%10 tmp%16) (=> tmp%16 (=> (= tmp%17 (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. self!@3))) (and (=> %%location_label%%11 tmp%17) (=> tmp%17 (=> (= tmp%18 (>= (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!tokens.Mim.block_token_data./block_token_data/key (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. block@1)))))))) (vstd!layout.size_of.? $ TYPE%lib!linked_list.Node.))) (and (=> %%location_label%%12 tmp%18) (=> tmp%18 (=> (= x! (tuple%3./tuple%3 (Poly%ptr_mut%<u8.>. ptru@) (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw$1@1) (Poly%lib!tokens.Mim.block. block@1))) (=> %%location_label%%13 (let ((ptr$ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. x!)))))) (let ((points_to$ (%Poly%vstd!raw_ptr.PointsToRaw. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. x!)))))) (let ((block_token$ (%Poly%lib!tokens.Mim.block. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. x!)))))) (and (and (and (and (and (and (and (and (and (and (and (and (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. self!@3)) (= (lib!linked_list.impl&%2.block_size.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.block_size.? (Poly%lib!linked_list.LL. self!@0)))) (= (nClip (Add (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!@3)) 1)) (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!@0)))) (= (lib!linked_list.impl&%2.instance.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.instance.? (Poly%lib!linked_list.LL. self!@0)))) (= (lib!linked_list.impl&%2.page_id.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.page_id.? (Poly%lib!linked_list.LL. self!@0)))) (= (lib!linked_list.impl&%2.fixed_page.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.fixed_page.? (Poly%lib!linked_list.LL. self!@0)))) (= (lib!linked_list.impl&%2.heap_id.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.heap_id.? (Poly%lib!linked_list.LL. self!@0)))) (vstd!raw_ptr.impl&%11.is_range.? (Poly%vstd!raw_ptr.PointsToRaw. points_to$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. ptr$))) (I (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!tokens.Mim.block_token_data./block_token_data/key (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. block_token$))))))))))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. points_to$)) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. ptr$)))))) (= (lib!tokens.Mim.block_token_data./block_token_data/instance (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. block_token$))))) (lib!linked_list.impl&%2.instance.? (Poly%lib!linked_list.LL. self!@0)))) (lib!layout.is_block_ptr.? (Poly%ptr_mut%<u8.>. ptr$) (Poly%lib!tokens.BlockId. (lib!tokens.Mim.block_token_data./block_token_data/key (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. block_token$)))))))) (=> (lib!linked_list.impl&%2.fixed_page.? (Poly%lib!linked_list.LL. self!@3)) (and (= (lib!tokens.BlockId./BlockId/page_id (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!tokens.Mim.block_token_data./block_token_data/key (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. block_token$)))))))) (lib!linked_list.impl&%2.page_id.? (Poly%lib!linked_list.LL. self!@3))) (= (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!tokens.Mim.block_token_data./block_token_data/key (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. block_token$)))))))) (lib!linked_list.impl&%2.block_size.? (Poly%lib!linked_list.LL. self!@3)))))) (let ((tmp%%$ (lib!linked_list.impl&%2.heap_id.? (Poly%lib!linked_list.LL. self!@3)))) (=> (is-core!option.Option./Some_ tmp%%$) (let ((heap_id$ (%Poly%lib!tokens.HeapId. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%$)))))) (= (lib!tokens.BlockState./BlockState/heap_id (%Poly%lib!tokens.BlockState. (Poly%lib!tokens.BlockState. (lib!tokens.Mim.block_token_data./block_token_data/value (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. block_token$)))))))) (core!option.Option./Some (Poly%lib!tokens.HeapId. heap_id$)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
