...
(set-info :comment ";; src/math.rs:20:5: 20:51 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_nonzero")
(set-info :comment ";; src/math.rs:20:5: 20:51 (#0)")
(declare-const x! Int)
(declare-const y! Int)
...
(assert (not (=> %%location_label%%0 (= (not (= (Mul x! y!) 0)) (and (not (= x! 0)) (not (= y! 0)))))))
(check-sat)
(exit)
