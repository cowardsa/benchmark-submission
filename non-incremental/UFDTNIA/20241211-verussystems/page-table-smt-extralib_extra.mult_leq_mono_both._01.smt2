...
(set-info :comment ";; page-table/extra.rs:131:1: 131:64 (#0)")
...
(set-info :comment ";; Function-Def lib::extra::mult_leq_mono_both")
(set-info :comment ";; page-table/extra.rs:131:1: 131:64 (#0)")
(declare-const a! Int)
(declare-const b! Int)
(declare-const c! Int)
...
(assert (not (=> %%location_label%%0 (let ((tmp%%$ (nClip (Mul a! b!)))) (and (<= 0 tmp%%$) (<= tmp%%$ (nClip (Mul c! d!))))))))
(check-sat)
(exit)
