...
(set-info :comment ";; src/math.rs:397:5: 397:59 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_fundamental_div_mod")
(set-info :comment ";; src/math.rs:397:5: 397:59 (#0)")
(declare-const x! Int)
(declare-const d! Int)
...
(assert (not (=> %%location_label%%0 (= x! (Add (Mul d! (EucDiv x! d!)) (EucMod x! d!))))))
(check-sat)
(exit)
