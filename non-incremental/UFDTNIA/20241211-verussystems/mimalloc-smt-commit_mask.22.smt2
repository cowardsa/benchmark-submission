...
(declare-const s_un@ vstd!set.Set<usize.>.)
(declare-const f_un@ %%Function%%)
(declare-const f@ %%Function%%)
(declare-const s_full@ vstd!set.Set<tuple%2<int./usize.>.>.)
(declare-const s_full_o@ vstd!set.Set<tuple%2<int./usize.>.>.)
(declare-const s1@ vstd!set.Set<tuple%2<int./usize.>.>.)
(declare-const s2@ vstd!set.Set<tuple%2<int./usize.>.>.)
(declare-const s2o@ vstd!set.Set<tuple%2<int./usize.>.>.)
(declare-const s3@ vstd!set.Set<tuple%2<int./usize.>.>.)
...
(assert (and (<= 0 i!) (< i! 8)))
(assert (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i!))) 0))
(assert (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i!)) (= (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$) (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$)) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)))))
(assert (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (< i! (%I j$)) (< (%I j$) 8)) (= (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$) (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$)) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)))))
(declare-fun %%lambda%%8 (Int Int Poly) %%Function%%)
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Int) (%%hole%%2 Poly) (t$ Poly)) (! (= (%%apply%%0 (%%lambda%%8 %%hole%%0 %%hole%%1 %%hole%%2) t$) (B (and (and (= (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. t$))) %%hole%%0) (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. t$))) %%hole%%1)) (lib!commit_mask.is_bit_set.? %%hole%%2 (tuple%2./tuple%2/1 (%Poly%tuple%2. t$)))))) :pattern ((%%apply%%0 (%%lambda%%8 %%hole%%0 %%hole%%1 %%hole%%2) t$)))))
(declare-fun %%lambda%%9 (Int Int Int Dcr Type Poly) %%Function%%)
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (t$ Poly)) (! (= (%%apply%%0 (%%lambda%%9 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) t$) (B (and (and (let ((tmp%%$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. t$))))) (and (< %%hole%%0 tmp%%$) (< tmp%%$ %%hole%%1))) (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. t$))) %%hole%%2)) (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 (tuple%2./tuple%2/0 (%Poly%tuple%2. t$))) (tuple%2./tuple%2/1 (%Poly%tuple%2. t$)))))) :pattern ((%%apply%%0 (%%lambda%%9 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) t$)))))
(declare-fun %%choose%%1 (Type Dcr Type Poly %%Function%% Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4 %%Function%%) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly)) (! (=> (exists ((y$ Poly)) (! (and (has_type y$ %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 y$) (= (%%apply%%0 %%hole%%4 y$) %%hole%%5))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 %%hole%%8 y$)))) (exists ((y$ Poly)) (! (and (and (has_type y$ %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 y$) (= (%%apply%%0 %%hole%%4 y$) %%hole%%5))) (= (%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) y$)) :pattern ((vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 %%hole%%8 y$))))) :pattern ((%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8)))))
...
(assert (not (=> (= s_un@ (%Poly%vstd!set.Set<usize.>. (vstd!set.impl&%0.new.? $ (UINT SZ) $ (TYPE%fun%1. $ (UINT SZ) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%6 64 (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) (I i!)))))))) (=> (= f_un@ (mk_fun (%%lambda%%7 (Mul 64 i!)))) (=> (= f@ (mk_fun (%%lambda%%4 64))) (=> (= s_full@ (%Poly%vstd!set.Set<tuple%2<int./usize.>.>. (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 0 8 64 $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))))))))) (=> (= s_full_o@ (%Poly%vstd!set.Set<tuple%2<int./usize.>.>. (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 0 8 64 $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))))))))) (=> (= s1@ (%Poly%vstd!set.Set<tuple%2<int./usize.>.>. (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 0 i! 64 $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))))))))) (=> (= s2@ (%Poly%vstd!set.Set<tuple%2<int./usize.>.>. (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%8 i! 64 (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i!)))))))) (=> (= s2o@ (%Poly%vstd!set.Set<tuple%2<int./usize.>.>. (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%8 i! 64 (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) (I i!)))))))) (=> (= s3@ (%Poly%vstd!set.Set<tuple%2<int./usize.>.>. (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%9 i! 8 64 $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))))))))) (=> (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. $ (TYPE%tuple%2. $ INT $ (UINT SZ))) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s_full@) (vstd!set.impl&%0.union.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) (vstd!set.impl&%0.union.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s1@) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2@)) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s3@)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> (ens%lib!commit_mask.lemma_is_bit_set. 0) (=> %%location_label%%1 (ext_eq false (TYPE%vstd!set.Set. $ (TYPE%tuple%2. $ INT $ (UINT SZ))) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2@) (vstd!set.impl&%0.empty.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)))))) (=> (ext_eq false (TYPE%vstd!set.Set. $ (TYPE%tuple%2. $ INT $ (UINT SZ))) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2@) (vstd!set.impl&%0.empty.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)))) (=> (ens%lib!commit_mask.lemma_map_distribute_auto. $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT) (=> (= tmp%2 (ext_eq false (TYPE%vstd!set.Set. $ INT) (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s_full@) (Poly%fun%1. f@)) (vstd!set.impl&%0.union.? $ INT (vstd!set.impl&%0.union.? $ INT (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s1@) (Poly%fun%1. f@)) (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2@) (Poly%fun%1. f@))) (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s3@) (Poly%fun%1. f@))))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (= tmp%3 (ext_eq false (TYPE%vstd!set.Set. $ (TYPE%tuple%2. $ INT $ (UINT SZ))) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s_full_o@) (vstd!set.impl&%0.union.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s_full@) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@)))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (and (=> (has_type x@ INT) (=> (vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (UINT SZ) $ INT (Poly%vstd!set.Set<usize.>. s_un@) (Poly%fun%1. f_un@)) x@) (=> (= tmp%4 (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@) (Poly%tuple%2. (tuple%2./tuple%2 (I i!) (as_type (%%choose%%1 (UINT SZ) $ (UINT SZ) (Poly%vstd!set.Set<usize.>. s_un@) f_un@ x@ $ (UINT SZ) (Poly%vstd!set.Set<usize.>. s_un@)) (UINT SZ)))))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (=> %%location_label%%5 (vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@) (Poly%fun%1. f@)) x@))))))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ INT) (=> (vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (UINT SZ) $ INT (Poly%vstd!set.Set<usize.>. s_un@) (Poly%fun%1. f_un@)) x$) (vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@) (Poly%fun%1. f@)) x$))) :pattern ((vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (UINT SZ) $ INT (Poly%vstd!set.Set<usize.>. s_un@) (Poly%fun%1. f_un@)) x$)) :pattern ((vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@) (Poly%fun%1. f@)) x$)))) (and (=> (has_type x$1@ INT) (=> (vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@) (Poly%fun%1. f@)) x$1@) (=> (= y@ (%Poly%tuple%2. (as_type (%%choose%%1 (TYPE%tuple%2. $ INT $ (UINT SZ)) $ (TYPE%tuple%2. $ INT $ (UINT SZ)) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@) f@ x$1@ $ (TYPE%tuple%2. $ INT $ (UINT SZ)) (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@)) (TYPE%tuple%2. $ INT $ (UINT SZ))))) (=> (= tmp%5 (vstd!set.impl&%0.contains.? $ (UINT SZ) (vstd!set.impl&%0.new.? $ (UINT SZ) $ (TYPE%fun%1. $ (UINT SZ) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%6 64 (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) (I i!)))))) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. y@))))) (and (=> %%location_label%%6 tmp%5) (=> tmp%5 (=> %%location_label%%7 (vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (UINT SZ) $ INT (Poly%vstd!set.Set<usize.>. s_un@) (Poly%fun%1. f_un@)) x$1@)))))))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ INT) (=> (vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@) (Poly%fun%1. f@)) x$) (vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (UINT SZ) $ INT (Poly%vstd!set.Set<usize.>. s_un@) (Poly%fun%1. f_un@)) x$))) :pattern ((vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@) (Poly%fun%1. f@)) x$)) :pattern ((vstd!set.impl&%0.contains.? $ INT (vstd!set_lib.impl&%0.map.? $ (UINT SZ) $ INT (Poly%vstd!set.Set<usize.>. s_un@) (Poly%fun%1. f_un@)) x$)))) (=> (= tmp%6 (ext_eq false (TYPE%vstd!set.Set. $ INT) (vstd!set_lib.impl&%0.map.? $ (UINT SZ) $ INT (Poly%vstd!set.Set<usize.>. s_un@) (Poly%fun%1. f_un@)) (vstd!set_lib.impl&%0.map.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ INT (Poly%vstd!set.Set<tuple%2<int./usize.>.>. s2o@) (Poly%fun%1. f@)))) (and (=> %%location_label%%8 tmp%6) (=> tmp%6 (=> %%location_label%%9 (= (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. other!)) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.union.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (vstd!set_lib.impl&%0.map.? $ (UINT SZ) $ INT (vstd!set.impl&%0.new.? $ (UINT SZ) $ (TYPE%fun%1. $ (UINT SZ) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%6 64 (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) (I i!)))))) (Poly%fun%1. (mk_fun (%%lambda%%7 (Mul 64 i!)))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
