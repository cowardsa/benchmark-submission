...
(declare-const verus_tmp_original_pm_region@ lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Bool)
(declare-const tmp%3 lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
(declare-const tmp%4 lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
...
(declare-const original_pm_region@0 lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
...
(declare-const original_pm_region@1 lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
...
(assert (not (=> (= verus_tmp@1 (%Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@0))) (=> (= verus_tmp_original_pm_region@ verus_tmp@1) (=> (= original_pm_region@1 verus_tmp_original_pm_region@) (and (=> %%location_label%%0 (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.flush. PMRegion&. PMRegion& pm_region!@0)) (=> (has_type pm_region!@1 PMRegion&) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegion.flush. PMRegion&. PMRegion& pm_region!@0 pm_region!@1) (and (=> %%location_label%%1 (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.get_region_size. PMRegion&. PMRegion& pm_region!@1)) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegion.get_region_size. PMRegion&. PMRegion& pm_region!@1 tmp%1) (=> (= region_size@ (%I tmp%1)) (and (=> %%location_label%%2 (uInv 64 (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!log.layout_v.MIN_LOG_AREA_SIZE.?))) (or (and (=> (< region_size@ (uClip 64 (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!log.layout_v.MIN_LOG_AREA_SIZE.?))) (and (=> %%location_label%%3 (uInv 64 (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!log.layout_v.MIN_LOG_AREA_SIZE.?))) (=> (= result! (core!result.Result./Err (Poly%lib!log.logimpl_t.LogErr. (lib!log.logimpl_t.LogErr./InsufficientSpaceForSetup (%I (I (uClip 64 (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!log.layout_v.MIN_LOG_AREA_SIZE.?)))))))) (and (=> %%location_label%%4 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? PMRegion&. PMRegion& pm_region!@1))) (and (=> %%location_label%%5 (= (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? PMRegion&. PMRegion& pm_region!@1) (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? PMRegion&. PMRegion& pm_region!@0))) (and (=> %%location_label%%6 (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1))) (=> %%location_label%%7 (ite (is-core!result.Result./Ok_ result!) (let ((log_capacity$ (%I (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((state$ (lib!log.logspec_t.impl&%0.initialize.? (I log_capacity$)))) (and (and (and (and (and (<= log_capacity$ (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1))) (= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1)) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@0)))) (lib!log.logimpl_t.can_only_crash_as_state.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1) (I log_id!) (Poly%lib!log.logspec_t.AbstractLogState. state$))) (= (lib!log.logimpl_v.impl&%1.recover.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1))) (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. state$)))) (= (lib!log.logimpl_v.impl&%1.recover.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1))))) (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. state$)))) (= state$ (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state$)))))) (and (and (is-core!result.Result./Err_ result!) (is-lib!log.logimpl_t.LogErr./InsufficientSpaceForSetup_ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((required_space$ (lib!log.logimpl_t.LogErr./InsufficientSpaceForSetup/required_space (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (and (= (%Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1)) (lib!pmem.pmemspec_t.impl&%6.flush.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@0))) (< (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1)) required_space$)))))))))))) (=> (not (< region_size@ (uClip 64 (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!log.layout_v.MIN_LOG_AREA_SIZE.?)))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%8 (uInv 64 (Sub region_size@ lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?))) (=> (= log_capacity@ (uClip 64 (Sub region_size@ lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?))) (and (=> %%location_label%%9 (req%lib!log.setup_v.write_setup_metadata. PMRegion&. PMRegion& pm_region!@1 region_size@ log_capacity@ log_id!)) (=> (has_type pm_region!@2 PMRegion&) (=> (ens%lib!log.setup_v.write_setup_metadata. PMRegion&. PMRegion& pm_region!@1 pm_region!@2 region_size@ log_capacity@ log_id!) (=> (= state@ (lib!log.logspec_t.impl&%0.initialize.? (I log_capacity@))) (=> (= tmp%2 (ext_eq false TYPE%lib!log.logspec_t.AbstractLogState. (Poly%lib!log.logspec_t.AbstractLogState. state@) (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state@))))) (and (=> %%location_label%%10 tmp%2) (=> tmp%2 (=> (= tmp%3 (%Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2))) (and (=> %%location_label%%11 (req%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_to_region_then_flush_is_idempotent. tmp%3)) (=> (ens%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_to_region_then_flush_is_idempotent. tmp%3) (=> (= tmp%4 (%Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2))) (and (=> %%location_label%%12 (req%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_view_can_only_crash_as_committed. tmp%4)) (=> (ens%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_view_can_only_crash_as_committed. tmp%4) (=> (= result! (core!result.Result./Ok (I log_capacity@))) (and (=> %%location_label%%13 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? PMRegion&. PMRegion& pm_region!@2))) (and (=> %%location_label%%14 (= (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? PMRegion&. PMRegion& pm_region!@2) (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? PMRegion&. PMRegion& pm_region!@0))) (and (=> %%location_label%%15 (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2))) (=> %%location_label%%16 (ite (is-core!result.Result./Ok_ result!) (let ((log_capacity$ (%I (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((state$ (lib!log.logspec_t.impl&%0.initialize.? (I log_capacity$)))) (and (and (and (and (and (<= log_capacity$ (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2))) (= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2)) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@0)))) (lib!log.logimpl_t.can_only_crash_as_state.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2) (I log_id!) (Poly%lib!log.logspec_t.AbstractLogState. state$))) (= (lib!log.logimpl_v.impl&%1.recover.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2))) (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. state$)))) (= (lib!log.logimpl_v.impl&%1.recover.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2))))) (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. state$)))) (= state$ (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state$)))))) (and (and (is-core!result.Result./Err_ result!) (is-lib!log.logimpl_t.LogErr./InsufficientSpaceForSetup_ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((required_space$ (lib!log.logimpl_t.LogErr./InsufficientSpaceForSetup/required_space (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (and (= (%Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2)) (lib!pmem.pmemspec_t.impl&%6.flush.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@0))) (< (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2)) required_space$)))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
