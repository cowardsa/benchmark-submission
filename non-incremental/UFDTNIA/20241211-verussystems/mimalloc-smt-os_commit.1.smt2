...
(declare-const diff@ Int)
(assert fuel_defaults)
(assert (uInv SZ addr!))
(assert (uInv SZ size!))
(assert (= (EucMod addr! (lib!os_mem.page_size.? (I 0))) 0))
(assert (= (EucMod size! (lib!os_mem.page_size.? (I 0))) 0))
(assert (not (= addr! 0)))
(assert (<= (Add addr! size!) (- (uHi SZ) 1)))
...
(assert (not (or (and (=> (or (= size! 0) (= addr! 0)) (=> (= res! (tuple%2./tuple%2 (I 0) (I 0))) (=> %%location_label%%0 (let ((start$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((csize$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (and (and (and (and (= (EucMod start$ (lib!os_mem.page_size.? (I 0))) 0) (= (EucMod csize$ (lib!os_mem.page_size.? (I 0))) 0)) (=> (not (= size! 0)) (= start$ addr!))) (=> (not (= size! 0)) (= csize$ size!))) (=> (= size! 0) (and (= start$ 0) (= csize$ 0))))))))) (=> (not (or (= size! 0) (= addr! 0))) %%switch_label%%3)) (and (not %%switch_label%%3) (or (and (=> conservative! (=> (ens%lib!os_mem.get_page_size. 0 tmp%1) (and (=> %%location_label%%1 (req%lib!layout.align_up. addr! tmp%1)) (=> (ens%lib!layout.align_up. addr! tmp%1 tmp%2) (=> (= tmp%5 tmp%2) %%switch_label%%2))))) (=> (not conservative!) (=> (ens%lib!os_mem.get_page_size. 0 tmp%3) (and (=> %%location_label%%2 (req%lib!layout.align_down. addr! tmp%3)) (=> (ens%lib!layout.align_down. addr! tmp%3 tmp%4) (=> (= tmp%5 tmp%4) %%switch_label%%2)))))) (and (not %%switch_label%%2) (=> (= start@ tmp%5) (or (and (=> conservative! (and (=> %%location_label%%3 (uInv SZ (Add addr! size!))) (=> (ens%lib!os_mem.get_page_size. 0 tmp%6) (=> (= tmp%8 (uClip SZ (Add addr! size!))) (and (=> %%location_label%%4 (req%lib!layout.align_down. tmp%8 tmp%6)) (=> (ens%lib!layout.align_down. tmp%8 tmp%6 tmp%7) (=> (= tmp%12 tmp%7) %%switch_label%%1))))))) (=> (not conservative!) (and (=> %%location_label%%5 (uInv SZ (Add addr! size!))) (=> (ens%lib!os_mem.get_page_size. 0 tmp%9) (=> (= tmp%11 (uClip SZ (Add addr! size!))) (and (=> %%location_label%%6 (req%lib!layout.align_up. tmp%11 tmp%9)) (=> (ens%lib!layout.align_up. tmp%11 tmp%9 tmp%10) (=> (= tmp%12 tmp%10) %%switch_label%%1)))))))) (and (not %%switch_label%%1) (=> (= end@ tmp%12) (and (=> %%location_label%%7 (uInv SZ (Sub end@ start@))) (=> (= diff@ (uClip SZ (Sub end@ start@))) (or (and (=> (<= diff@ 0) (=> (= res! (tuple%2./tuple%2 (I 0) (I 0))) (=> %%location_label%%8 (let ((start$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((csize$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (and (and (and (and (= (EucMod start$ (lib!os_mem.page_size.? (I 0))) 0) (= (EucMod csize$ (lib!os_mem.page_size.? (I 0))) 0)) (=> (not (= size! 0)) (= start$ addr!))) (=> (not (= size! 0)) (= csize$ size!))) (=> (= size! 0) (and (= start$ 0) (= csize$ 0))))))))) (=> (not (<= diff@ 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= res! (tuple%2./tuple%2 (I start@) (I diff@))) (=> %%location_label%%9 (let ((start$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((csize$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (and (and (and (and (= (EucMod start$ (lib!os_mem.page_size.? (I 0))) 0) (= (EucMod csize$ (lib!os_mem.page_size.? (I 0))) 0)) (=> (not (= size! 0)) (= start$ addr!))) (=> (not (= size! 0)) (= csize$ size!))) (=> (= size! 0) (and (= start$ 0) (= csize$ 0))))))))))))))))))))))
(check-sat)
(exit)
