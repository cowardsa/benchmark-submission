...
(declare-const tmp%4 lib!impl_u.l1.Directory.)
...
(declare-const page_addr@ Int)
(declare-const l1_RW@ Bool)
(declare-const l1_US@ Bool)
(declare-const l1_XD@ Bool)
...
(declare-const page_addr$1@ Int)
(declare-const l2_RW@ Bool)
(declare-const l2_US@ Bool)
(declare-const l2_XD@ Bool)
...
(declare-const page_addr$2@ Int)
(declare-const l3_RW@ Bool)
(declare-const l3_US@ Bool)
(declare-const l3_XD@ Bool)
...
(declare-const tmp%%$3@ lib!spec_t.hardware.GhostPageDirectoryEntry.)
(declare-const l3_base_vaddr@ Int)
(declare-const l2_dir_ghost_pt@ lib!impl_u.l2_impl.PTDir.)
(declare-const interp_l3_dir@ lib!impl_u.l1.Directory.)
(declare-const interp_l3_entry@ lib!impl_u.l1.NodeEntry.)
(declare-const low_bits$2@ Int)
(declare-const l2_dir_addr@ Int)
(declare-const l2_RW$1@ Bool)
(declare-const l2_US$1@ Bool)
(declare-const l2_XD$1@ Bool)
...
(declare-const tmp%%$2@ lib!spec_t.hardware.GhostPageDirectoryEntry.)
(declare-const l2_base_vaddr@ Int)
(declare-const l1_dir_ghost_pt@ lib!impl_u.l2_impl.PTDir.)
(declare-const interp_l2_dir@ lib!impl_u.l1.Directory.)
(declare-const interp_l2_entry@ lib!impl_u.l1.NodeEntry.)
(declare-const low_bits$1@ Int)
(declare-const l1_dir_addr@ Int)
(declare-const l1_RW$1@ Bool)
(declare-const l1_US$1@ Bool)
(declare-const l1_XD$1@ Bool)
(declare-const tmp%56 Bool)
(declare-const tmp%57 Bool)
(declare-const tmp%58 Bool)
(declare-const tmp%59 Bool)
(declare-const tmp%%$1@ lib!spec_t.hardware.GhostPageDirectoryEntry.)
(declare-const l1_base_vaddr@ Int)
(declare-const l0_dir_ghost_pt@ lib!impl_u.l2_impl.PTDir.)
(declare-const interp_l1_dir@ lib!impl_u.l1.Directory.)
(declare-const interp_l1_entry@ lib!impl_u.l1.NodeEntry.)
(declare-const low_bits@ Int)
(declare-const l0_dir_addr@ Int)
(declare-const l0_RW@ Bool)
(declare-const l0_US@ Bool)
(declare-const l0_XD@ Bool)
(declare-const tmp%60 Bool)
(declare-const tmp%61 Bool)
(declare-const low_bits$3@ Int)
(declare-const tmp%%@ lib!spec_t.hardware.GhostPageDirectoryEntry.)
(declare-const addr$1@ Int)
(declare-const l0_idx_u64@ Int)
(declare-const l0_idx@ Int)
(declare-const l1_idx_u64@ Int)
(declare-const l1_idx@ Int)
(declare-const l2_idx_u64@ Int)
(declare-const l2_idx@ Int)
(declare-const l3_idx_u64@ Int)
(declare-const l3_idx@ Int)
(declare-const interp_l0_dir@ lib!impl_u.l1.Directory.)
(declare-const interp_l0_entry@ lib!impl_u.l1.NodeEntry.)
...
(assert (and (lib!impl_u.l2_impl.PT.inv.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))))
...
(assert (not (=> (= m1@ (lib!spec_t.hardware.interp_pt_mem.? (Poly%lib!spec_t.mem.PageTableMemory. mem!))) (=> (= m2@ (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)))))))) (=> (= tmp%1 (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))) (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%1)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%1) (=> (= tmp%2 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (and (=> (has_type addr@ NAT) (=> (= tmp%3 (lib!definitions_t.MemRegionExec./MemRegionExec/base (%Poly%lib!definitions_t.MemRegionExec. (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem!)))))) (and (=> %%location_label%%2 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. mem! pt! 0 tmp%3 0)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. mem! pt! 0 tmp%3 0) (=> (= tmp%4 (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))) (and (=> %%location_label%%3 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%4)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%4) (or (and (=> (and (< (%I addr@) lib!definitions_t.MAX_BASE.?) (exists ((pte$ Poly)) (! (and (has_type pte$ TYPE%lib!definitions_t.PageTableEntry.) (lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (lib!spec_t.hardware.nat_to_u64.? addr@)) pte$)) :pattern ((lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (lib!spec_t.hardware.nat_to_u64.? addr@)) pte$))))) %%switch_label%%0) (=> (not (and (< (%I addr@) lib!definitions_t.MAX_BASE.?) (exists ((pte$ Poly)) (! (and (has_type pte$ TYPE%lib!definitions_t.PageTableEntry.) (lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (lib!spec_t.hardware.nat_to_u64.? addr@)) pte$)) :pattern ((lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (lib!spec_t.hardware.nat_to_u64.? addr@)) pte$)))))) (or (and (=> (>= (%I addr@) lib!definitions_t.MAX_BASE.?) %%switch_label%%1) (=> (not (>= (%I addr@) lib!definitions_t.MAX_BASE.?)) (=> (= tmp%5 (< (%I addr@) lib!definitions_t.MAX_BASE.?)) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= tmp%6 (= (%I addr@) (uClip 64 (%I addr@)))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> (= tmp%7 (= (lib!spec_t.hardware.nat_to_u64.? addr@) (%I addr@))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> (= tmp%8 (not (exists ((pte$ Poly)) (! (and (has_type pte$ TYPE%lib!definitions_t.PageTableEntry.) (lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (lib!spec_t.hardware.nat_to_u64.? addr@)) pte$)) :pattern ((lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (lib!spec_t.hardware.nat_to_u64.? addr@)) pte$)))))) (and (=> %%location_label%%7 tmp%8) (=> tmp%8 (=> (= addr$1@ (uClip 64 (%I addr@))) (=> (= tmp%9 (not (exists ((pte$ Poly)) (! (and (has_type pte$ TYPE%lib!definitions_t.PageTableEntry.) (lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I addr$1@) pte$)) :pattern ((lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I addr$1@) pte$)))))) (and (=> %%location_label%%8 tmp%9) (=> tmp%9 (=> (= l0_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 47 1)) 39))))))))) (I 39))))))) (I 39)))) (=> (= l0_idx@ l0_idx_u64@) (=> (= l1_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 38 1)) 30))))))))) (I 30))))))) (I 30)))) (=> (= l1_idx@ l1_idx_u64@) (=> (= l2_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 29 1)) 21))))))))) (I 21))))))) (I 21)))) (=> (= l2_idx@ l2_idx_u64@) (=> (= l3_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 20 1)) 12))))))))) (I 12))))))) (I 12)))) (=> (= l3_idx@ l3_idx_u64@) (and (=> %%location_label%%9 true) (=> (forall ((a$ Poly)) (! (=> (has_type a$ (UINT 64)) (=> (= (uClip 64 (bitand (I (%I a$)) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 8 1)) 0))))))))) (I 0)))))) (%I a$)) (< (%I a$) 512))) :pattern ((uClip 64 (bitand (I (%I a$)) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 8 1)) 0))))))))) (I 0))))))))) (and (and (=> %%location_label%%10 true) (=> (= (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 20 1)) 12))))))))) (I 12))))))) (I 12)))) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 8 1)) 0))))))))) (I 0)))))) (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 20 1)) 12))))))))) (I 12))))))) (I 12)))) (and (=> %%location_label%%11 true) (=> (= (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 29 1)) 21))))))))) (I 21))))))) (I 21)))) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 8 1)) 0))))))))) (I 0)))))) (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 29 1)) 21))))))))) (I 21))))))) (I 21)))) (and (=> %%location_label%%12 true) (=> (= (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 38 1)) 30))))))))) (I 30))))))) (I 30)))) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 8 1)) 0))))))))) (I 0)))))) (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 38 1)) 30))))))))) (I 30))))))) (I 30)))) (and (=> %%location_label%%13 true) (=> (= (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 47 1)) 39))))))))) (I 39))))))) (I 39)))) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 8 1)) 0))))))))) (I 0)))))) (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 47 1)) 39))))))))) (I 39))))))) (I 39)))) (=> %%location_label%%14 (and (and (and (< l0_idx@ 512) (< l1_idx@ 512)) (< l2_idx@ 512)) (< l3_idx@ 512))))))))))) (=> (and (and (and (< l0_idx@ 512) (< l1_idx@ 512)) (< l2_idx@ 512)) (< l3_idx@ 512)) (and (=> %%location_label%%15 true) (=> (= (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 47 1)) 39))))))))) (I 39))) 280925220896768) (and (=> %%location_label%%16 true) (=> (= (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 38 1)) 30))))))))) (I 30))) 548682072064) (and (=> %%location_label%%17 true) (=> (= (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 29 1)) 21))))))))) (I 21))) 1071644672) (and (=> %%location_label%%18 true) (=> (= (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add 20 1)) 12))))))))) (I 12))) 2093056) (=> (= interp_l0_dir@ (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))) (=> (= interp_l0_entry@ (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I 0) (I (lib!definitions_t.MemRegionExec./MemRegionExec/base (%Poly%lib!definitions_t.MemRegionExec. (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem!)))))) (I 0) (I l0_idx@))) (and (=> %%location_label%%19 (req%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. interp_l0_dir@ l0_idx@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. interp_l0_dir@ l0_idx@) (=> (= tmp%%@ (lib!spec_t.hardware.read_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.impl&%4.view.? (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem!)))))))) (I 0) (I l0_idx@))) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%@) (=> (= l0_dir_addr@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@)))) (=> (= l0_RW@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@)))) (=> (= l0_US@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@)))) (=> (= l0_XD@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@)))) (=> (= tmp%10 (is-lib!impl_u.l1.NodeEntry./Directory_ interp_l0_entry@)) (and (=> %%location_label%%20 tmp%10) (=> tmp%10 (=> (= l1_base_vaddr@ (lib!definitions_t.entry_base_from_index.? (I 0) (I l0_idx@) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I 0))))) (=> (= l0_dir_ghost_pt@ (%Poly%lib!impl_u.l2_impl.PTDir. (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) (I l0_idx@)))))) (=> (= tmp%11 (lib!impl_u.l2_impl.PT.directories_obey_invariant_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I 0) (I (lib!definitions_t.MemRegionExec./MemRegionExec/base (%Poly%lib!definitions_t.MemRegionExec. (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem!)))))))) (and (=> %%location_label%%21 tmp%11) (=> tmp%11 (=> (= tmp%12 (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l0_dir_ghost_pt@) (I 1) (I l0_dir_addr@))) (and (=> %%location_label%%22 tmp%12) (=> tmp%12 (=> (= tmp%13 (lib!impl_u.l1.impl&%1.directories_obey_invariant.? (Poly%lib!impl_u.l1.Directory. interp_l0_dir@))) (and (=> %%location_label%%23 tmp%13) (=> tmp%13 (=> (= tmp%14 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. interp_l0_dir@)))) (I l0_idx@))))))) (and (=> %%location_label%%24 tmp%14) (=> tmp%14 (and (=> %%location_label%%25 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. mem! l0_dir_ghost_pt@ 1 l0_dir_addr@ l1_base_vaddr@)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. mem! l0_dir_ghost_pt@ 1 l0_dir_addr@ l1_base_vaddr@) (=> (= interp_l1_dir@ (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l0_dir_ghost_pt@) (I 1) (I l0_dir_addr@) (I l1_base_vaddr@))) (=> (= interp_l1_entry@ (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l0_dir_ghost_pt@) (I 1) (I l0_dir_addr@) (I l1_base_vaddr@) (I l1_idx@))) (and (=> %%location_label%%26 (req%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. interp_l1_dir@ l1_idx@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. interp_l1_dir@ l1_idx@) (=> (= low_bits@ (uClip 64 (EucMod addr$1@ (uClip 64 lib!definitions_t.L1_ENTRY_SIZE.?)))) (and (=> %%location_label%%27 (= l1_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 548682072064)))) (I 30))))) (and (=> %%location_label%%28 (= low_bits@ (uClip 64 (EucMod addr$1@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))) (=> (= (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitshl (I l0_idx_u64@) (I 39)))) (I (uClip 64 (bitshl (I l1_idx_u64@) (I 30))))))) (I low_bits@))) (uClip 64 (Add (uClip 64 (Add (uClip 64 (Mul l0_idx_u64@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))) (uClip 64 (Mul l1_idx_u64@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))) low_bits@))) (and (=> %%location_label%%29 (= l0_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 280925220896768)))) (I 39))))) (and (=> %%location_label%%30 (= l1_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 548682072064)))) (I 30))))) (and (=> %%location_label%%31 (< addr$1@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))))) (and (=> %%location_label%%32 (= low_bits@ (uClip 64 (EucMod addr$1@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))) (=> (= addr$1@ (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitshl (I l0_idx_u64@) (I 39)))) (I (uClip 64 (bitshl (I l1_idx_u64@) (I 30))))))) (I low_bits@)))) (=> (= tmp%%$1@ (lib!spec_t.hardware.read_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I l0_dir_addr@) (I 1) (I l1_idx@))) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%$1@) (=> (= page_addr@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$1@)))) (=> (= l1_RW@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$1@)))) (=> (= l1_US@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$1@)))) (=> (= l1_XD@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$1@)))) (and (or (and (=> (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L1_ENTRY_SIZE.?)) (=> (= pte@ (lib!definitions_t.PageTableEntry./PageTableEntry (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I page_addr@)) (%I (I lib!definitions_t.L1_ENTRY_SIZE.?))))) (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.Flags./Flags (%B (B (and l0_RW@ l1_RW@))) (%B (B (or (not l0_US@) (not l1_US@)))) (%B (B (or l0_XD@ l1_XD@)))))))) (=> (= tmp%15 (lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (uClip 64 addr$1@)) (Poly%lib!definitions_t.PageTableEntry. pte@))) (and (=> %%location_label%%33 tmp%15) (=> tmp%15 (=> %%location_label%%34 false)))))) (=> (not (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L1_ENTRY_SIZE.?))) %%switch_label%%4)) (and (not %%switch_label%%4) (=> %%location_label%%35 (not (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L1_ENTRY_SIZE.?)))))) (=> (not (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L1_ENTRY_SIZE.?))) (=> (= tmp%16 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@) (I l1_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%36 tmp%16) (=> tmp%16 (=> (= tmp%17 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%37 tmp%17) (=> tmp%17 (=> (= tmp%18 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l0_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%38 tmp%18) (=> tmp%18 (=> (= tmp%19 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) (I addr$1@)))) (and (=> %%location_label%%39 tmp%19) (=> tmp%19 %%switch_label%%3))))))))))))))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%$1@)) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%$1@) (=> (= l1_dir_addr@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$1@)))) (=> (= l1_RW$1@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$1@)))) (=> (= l1_US$1@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$1@)))) (=> (= l1_XD$1@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$1@)))) (=> (= tmp%20 (is-lib!impl_u.l1.NodeEntry./Directory_ interp_l1_entry@)) (and (=> %%location_label%%40 tmp%20) (=> tmp%20 (=> (= l2_base_vaddr@ (lib!definitions_t.entry_base_from_index.? (I l1_base_vaddr@) (I l1_idx@) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I 1))))) (=> (= l1_dir_ghost_pt@ (%Poly%lib!impl_u.l2_impl.PTDir. (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. l0_dir_ghost_pt@)))) (I l1_idx@)))))) (=> (= tmp%21 (lib!impl_u.l2_impl.PT.directories_obey_invariant_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l0_dir_ghost_pt@) (I 1) (I l0_dir_addr@))) (and (=> %%location_label%%41 tmp%21) (=> tmp%21 (=> (= tmp%22 (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l1_dir_ghost_pt@) (I 2) (I l1_dir_addr@))) (and (=> %%location_label%%42 tmp%22) (=> tmp%22 (and (=> %%location_label%%43 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. mem! l1_dir_ghost_pt@ 2 l1_dir_addr@ l2_base_vaddr@)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. mem! l1_dir_ghost_pt@ 2 l1_dir_addr@ l2_base_vaddr@) (=> (= interp_l2_dir@ (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l1_dir_ghost_pt@) (I 2) (I l1_dir_addr@) (I l2_base_vaddr@))) (=> (= interp_l2_entry@ (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l1_dir_ghost_pt@) (I 2) (I l1_dir_addr@) (I l2_base_vaddr@) (I l2_idx@))) (and (=> %%location_label%%44 (req%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. interp_l2_dir@ l2_idx@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. interp_l2_dir@ l2_idx@) (=> (= low_bits$1@ (uClip 64 (EucMod addr$1@ (uClip 64 lib!definitions_t.L2_ENTRY_SIZE.?)))) (and (=> %%location_label%%45 (= l1_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 548682072064)))) (I 30))))) (and (=> %%location_label%%46 (= l2_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 1071644672)))) (I 21))))) (and (=> %%location_label%%47 (= low_bits$1@ (uClip 64 (EucMod addr$1@ (uClip 64 (Mul 512 4096)))))) (=> (= (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitshl (I l0_idx_u64@) (I 39)))) (I (uClip 64 (bitshl (I l1_idx_u64@) (I 30))))))) (I (uClip 64 (bitshl (I l2_idx_u64@) (I 21))))))) (I low_bits$1@))) (uClip 64 (Add (uClip 64 (Add (uClip 64 (Add (uClip 64 (Mul l0_idx_u64@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))) (uClip 64 (Mul l1_idx_u64@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))) (uClip 64 (Mul l2_idx_u64@ (uClip 64 (Mul 512 4096)))))) low_bits$1@))) (and (=> %%location_label%%48 (= l0_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 280925220896768)))) (I 39))))) (and (=> %%location_label%%49 (= l1_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 548682072064)))) (I 30))))) (and (=> %%location_label%%50 (= l2_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 1071644672)))) (I 21))))) (and (=> %%location_label%%51 (< addr$1@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))))) (and (=> %%location_label%%52 (= low_bits$1@ (uClip 64 (EucMod addr$1@ (uClip 64 (Mul 512 4096)))))) (=> (= addr$1@ (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitshl (I l0_idx_u64@) (I 39)))) (I (uClip 64 (bitshl (I l1_idx_u64@) (I 30))))))) (I (uClip 64 (bitshl (I l2_idx_u64@) (I 21))))))) (I low_bits$1@)))) (=> (= tmp%%$2@ (lib!spec_t.hardware.read_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I l1_dir_addr@) (I 2) (I l2_idx@))) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%$2@) (=> (= page_addr$1@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$2@)))) (=> (= l2_RW@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$2@)))) (=> (= l2_US@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$2@)))) (=> (= l2_XD@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$2@)))) (and (or (and (=> (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L2_ENTRY_SIZE.?)) (=> (= pte$1@ (lib!definitions_t.PageTableEntry./PageTableEntry (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I page_addr$1@)) (%I (I lib!definitions_t.L2_ENTRY_SIZE.?))))) (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.Flags./Flags (%B (B (and (and l0_RW@ l1_RW$1@) l2_RW@))) (%B (B (or (or (not l0_US@) (not l1_US$1@)) (not l2_US@)))) (%B (B (or (or l0_XD@ l1_XD$1@) l2_XD@)))))))) (=> (= tmp%23 (lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (uClip 64 addr$1@)) (Poly%lib!definitions_t.PageTableEntry. pte$1@))) (and (=> %%location_label%%53 tmp%23) (=> tmp%23 (=> %%location_label%%54 false)))))) (=> (not (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L2_ENTRY_SIZE.?))) %%switch_label%%7)) (and (not %%switch_label%%7) (=> %%location_label%%55 (not (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L2_ENTRY_SIZE.?)))))) (=> (not (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L2_ENTRY_SIZE.?))) (=> (= tmp%24 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l2_dir@) (I l2_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%56 tmp%24) (=> tmp%24 (=> (= tmp%25 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l2_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%57 tmp%25) (=> tmp%25 (=> (= tmp%26 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@) (I l1_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%58 tmp%26) (=> tmp%26 (=> (= tmp%27 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%59 tmp%27) (=> tmp%27 (=> (= tmp%28 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l0_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%60 tmp%28) (=> tmp%28 (=> (= tmp%29 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) (I addr$1@)))) (and (=> %%location_label%%61 tmp%29) (=> tmp%29 %%switch_label%%6))))))))))))))))))))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%$2@)) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%$2@) (=> (= l2_dir_addr@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$2@)))) (=> (= l2_RW$1@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$2@)))) (=> (= l2_US$1@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$2@)))) (=> (= l2_XD$1@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$2@)))) (=> (= tmp%30 (is-lib!impl_u.l1.NodeEntry./Directory_ interp_l2_entry@)) (and (=> %%location_label%%62 tmp%30) (=> tmp%30 (=> (= l3_base_vaddr@ (lib!definitions_t.entry_base_from_index.? (I l2_base_vaddr@) (I l2_idx@) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I 2))))) (=> (= l2_dir_ghost_pt@ (%Poly%lib!impl_u.l2_impl.PTDir. (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. l1_dir_ghost_pt@)))) (I l2_idx@)))))) (=> (= tmp%31 (lib!impl_u.l2_impl.PT.directories_obey_invariant_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l1_dir_ghost_pt@) (I 2) (I l1_dir_addr@))) (and (=> %%location_label%%63 tmp%31) (=> tmp%31 (=> (= tmp%32 (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l2_dir_ghost_pt@) (I 3) (I l2_dir_addr@))) (and (=> %%location_label%%64 tmp%32) (=> tmp%32 (and (=> %%location_label%%65 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. mem! l2_dir_ghost_pt@ 3 l2_dir_addr@ l3_base_vaddr@)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. mem! l2_dir_ghost_pt@ 3 l2_dir_addr@ l3_base_vaddr@) (=> (= interp_l3_dir@ (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l2_dir_ghost_pt@) (I 3) (I l2_dir_addr@) (I l3_base_vaddr@))) (=> (= interp_l3_entry@ (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. l2_dir_ghost_pt@) (I 3) (I l2_dir_addr@) (I l3_base_vaddr@) (I l3_idx@))) (and (=> %%location_label%%66 (req%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. interp_l3_dir@ l3_idx@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. interp_l3_dir@ l3_idx@) (=> (= low_bits$2@ (uClip 64 (EucMod addr$1@ (uClip 64 lib!definitions_t.L3_ENTRY_SIZE.?)))) (and (=> %%location_label%%67 (= l1_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 548682072064)))) (I 30))))) (and (=> %%location_label%%68 (= l2_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 1071644672)))) (I 21))))) (and (=> %%location_label%%69 (= l3_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 2093056)))) (I 12))))) (and (=> %%location_label%%70 (= low_bits$2@ (uClip 64 (EucMod addr$1@ 4096)))) (=> (= (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitshl (I l0_idx_u64@) (I 39)))) (I (uClip 64 (bitshl (I l1_idx_u64@) (I 30))))))) (I (uClip 64 (bitshl (I l2_idx_u64@) (I 21))))))) (I (uClip 64 (bitshl (I l3_idx_u64@) (I 12))))))) (I low_bits$2@))) (uClip 64 (Add (uClip 64 (Add (uClip 64 (Add (uClip 64 (Add (uClip 64 (Mul l0_idx_u64@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))) (uClip 64 (Mul l1_idx_u64@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))) (uClip 64 (Mul l2_idx_u64@ (uClip 64 (Mul 512 4096)))))) (uClip 64 (Mul l3_idx_u64@ 4096)))) low_bits$2@))) (and (=> %%location_label%%71 (= l0_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 280925220896768)))) (I 39))))) (and (=> %%location_label%%72 (= l1_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 548682072064)))) (I 30))))) (and (=> %%location_label%%73 (= l2_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 1071644672)))) (I 21))))) (and (=> %%location_label%%74 (= l3_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 2093056)))) (I 12))))) (and (=> %%location_label%%75 (< addr$1@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))))) (and (=> %%location_label%%76 (= low_bits$2@ (uClip 64 (EucMod addr$1@ 4096)))) (=> (= addr$1@ (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitshl (I l0_idx_u64@) (I 39)))) (I (uClip 64 (bitshl (I l1_idx_u64@) (I 30))))))) (I (uClip 64 (bitshl (I l2_idx_u64@) (I 21))))))) (I (uClip 64 (bitshl (I l3_idx_u64@) (I 12))))))) (I low_bits$2@)))) (=> (= tmp%%$3@ (lib!spec_t.hardware.read_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I l2_dir_addr@) (I 3) (I l3_idx@))) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%$3@) (=> (= page_addr$2@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$3@)))) (=> (= l3_RW@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$3@)))) (=> (= l3_US@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$3@)))) (=> (= l3_XD@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$3@)))) (and (or (and (=> (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L3_ENTRY_SIZE.?)) (=> (= pte$2@ (lib!definitions_t.PageTableEntry./PageTableEntry (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I page_addr$2@)) (%I (I lib!definitions_t.L3_ENTRY_SIZE.?))))) (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.Flags./Flags (%B (B (and (and (and l0_RW@ l1_RW$1@) l2_RW$1@) l3_RW@))) (%B (B (or (or (or (not l0_US@) (not l1_US$1@)) (not l2_US$1@)) (not l3_US@)))) (%B (B (or (or (or l0_XD@ l1_XD$1@) l2_XD$1@) l3_XD@)))))))) (=> (= tmp%33 (lib!spec_t.hardware.valid_pt_walk.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (I (uClip 64 addr$1@)) (Poly%lib!definitions_t.PageTableEntry. pte$2@))) (and (=> %%location_label%%77 tmp%33) (=> tmp%33 (=> %%location_label%%78 false)))))) (=> (not (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L3_ENTRY_SIZE.?))) %%switch_label%%10)) (and (not %%switch_label%%10) (=> %%location_label%%79 (not (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L3_ENTRY_SIZE.?)))))) (=> (not (lib!definitions_t.aligned.? (I addr$1@) (I lib!definitions_t.L3_ENTRY_SIZE.?))) (=> (= tmp%34 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l3_dir@) (I l3_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%80 tmp%34) (=> tmp%34 (=> (= tmp%35 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l3_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%81 tmp%35) (=> tmp%35 (=> (= tmp%36 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l2_dir@) (I l2_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%82 tmp%36) (=> tmp%36 (=> (= tmp%37 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l2_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%83 tmp%37) (=> tmp%37 (=> (= tmp%38 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@) (I l1_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%84 tmp%38) (=> tmp%38 (=> (= tmp%39 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%85 tmp%39) (=> tmp%39 (=> (= tmp%40 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l0_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%86 tmp%40) (=> tmp%40 (=> (= tmp%41 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) (I addr$1@)))) (and (=> %%location_label%%87 tmp%41) (=> tmp%41 %%switch_label%%9))))))))))))))))))))))))))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%$3@)) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%$3@) (=> %%location_label%%88 false)) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%$3@)) (=> (= tmp%42 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l3_dir@) (I l3_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%89 tmp%42) (=> tmp%42 (=> (= tmp%43 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l3_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%90 tmp%43) (=> tmp%43 (=> (= tmp%44 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l2_dir@) (I l2_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%91 tmp%44) (=> tmp%44 (=> (= tmp%45 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l2_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%92 tmp%45) (=> tmp%45 (=> (= tmp%46 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@) (I l1_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%93 tmp%46) (=> tmp%46 (=> (= tmp%47 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%94 tmp%47) (=> tmp%47 (=> (= tmp%48 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l0_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%95 tmp%48) (=> tmp%48 (=> (= tmp%49 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) (I addr$1@)))) (and (=> %%location_label%%96 tmp%49) (=> tmp%49 %%switch_label%%11)))))))))))))))))))))))))) (and (not %%switch_label%%11) %%switch_label%%9)))) (and (not %%switch_label%%9) %%switch_label%%8)))))))))))))))))))))))))))))))))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%$2@)) (=> (= tmp%50 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l2_dir@) (I l2_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%97 tmp%50) (=> tmp%50 (=> (= tmp%51 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l2_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%98 tmp%51) (=> tmp%51 (=> (= tmp%52 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@) (I l1_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%99 tmp%52) (=> tmp%52 (=> (= tmp%53 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%100 tmp%53) (=> tmp%53 (=> (= tmp%54 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l0_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%101 tmp%54) (=> tmp%54 (=> (= tmp%55 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) (I addr$1@)))) (and (=> %%location_label%%102 tmp%55) (=> tmp%55 %%switch_label%%8)))))))))))))))))))) (and (not %%switch_label%%8) %%switch_label%%6)))) (and (not %%switch_label%%6) %%switch_label%%5)))))))))))))))))))))))))))))))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%$1@)) (=> (= tmp%56 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@) (I l1_idx@))))))) (I addr$1@)))) (and (=> %%location_label%%103 tmp%56) (=> tmp%56 (=> (= tmp%57 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l1_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%104 tmp%57) (=> tmp%57 (=> (= tmp%58 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l0_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%105 tmp%58) (=> tmp%58 (=> (= tmp%59 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) (I addr$1@)))) (and (=> %%location_label%%106 tmp%59) (=> tmp%59 %%switch_label%%5)))))))))))))) (and (not %%switch_label%%5) %%switch_label%%3)))) (and (not %%switch_label%%3) %%switch_label%%2)))))))))))))))))))))))))))))))))))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%@)) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%@) (=> %%location_label%%107 false)) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%@)) (=> (= low_bits$3@ (uClip 64 (EucMod addr$1@ (uClip 64 lib!definitions_t.L0_ENTRY_SIZE.?)))) (and (=> %%location_label%%108 (= low_bits$3@ (uClip 64 (EucMod addr$1@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))))) (=> (= (uClip 64 (bitor (I (uClip 64 (bitshl (I l0_idx_u64@) (I 39)))) (I low_bits$3@))) (uClip 64 (Add (uClip 64 (Mul l0_idx_u64@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))) low_bits$3@))) (and (=> %%location_label%%109 (= l0_idx_u64@ (uClip 64 (bitshr (I (uClip 64 (bitand (I addr$1@) (I 280925220896768)))) (I 39))))) (and (=> %%location_label%%110 (< addr$1@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))))) (and (=> %%location_label%%111 (= low_bits$3@ (uClip 64 (EucMod addr$1@ (uClip 64 (Mul 512 (uClip 64 (Mul 512 (uClip 64 (Mul 512 4096)))))))))) (=> (= addr$1@ (uClip 64 (bitor (I (uClip 64 (bitshl (I l0_idx_u64@) (I 39)))) (I low_bits$3@)))) (=> (= tmp%60 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. interp_l0_dir@))))))) (I addr$1@)))) (and (=> %%location_label%%112 tmp%60) (=> tmp%60 (=> (= tmp%61 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) (I addr$1@)))) (and (=> %%location_label%%113 tmp%61) (=> tmp%61 %%switch_label%%12))))))))))))))) (and (not %%switch_label%%12) %%switch_label%%2)))) (and (not %%switch_label%%2) %%switch_label%%1))))))))))))))))))))))))))))))))))))))))))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%114 (=> (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m1@)) addr@)) (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) addr@))))))))))))) (=> (forall ((addr$ Poly)) (! (=> (has_type addr$ NAT) (=> (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m1@)) addr$)) (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) addr$)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m1@)) addr$)) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. m2@)) addr$)))) (=> %%location_label%%115 (forall ((k$ Poly)) (! (=> (has_type k$ NAT) (=> (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hardware.interp_pt_mem.? (Poly%lib!spec_t.mem.PageTableMemory. mem!)))) k$)) (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))))))) k$)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))))))) k$)))))))))))))))))
(check-sat)
(exit)
