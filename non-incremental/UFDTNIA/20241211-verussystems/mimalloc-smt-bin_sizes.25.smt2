...
(declare-const e1@ Poly)
(declare-const e2@ Poly)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Int)
(declare-const tmp%3 Int)
(declare-const tmp%4 Int)
(declare-const diff@ Int)
(declare-const e1$1@ Int)
(declare-const e2$1@ Int)
(declare-const e1$2@ Int)
(declare-const e2$2@ Int)
...
(assert (not (and (=> (has_type e@ INT) (=> (ens%lib!bin_sizes.pow2_positive. (%I e@)) (=> %%location_label%%0 (> (lib!bin_sizes.pow2.? e@) 0)))) (=> (forall ((e$ Poly)) (! (=> (has_type e$ INT) (> (lib!bin_sizes.pow2.? e$) 0)) :pattern ((lib!bin_sizes.pow2.? e$)))) (and (=> (has_type e$1@ INT) (=> (> (%I e$1@) 0) (=> (= (lib!bin_sizes.pow2.? (I 1)) 2) (and (=> %%location_label%%1 (req%lib!bin_sizes.pow2_subtracts. 1 (nClip (%I e$1@)))) (=> (ens%lib!bin_sizes.pow2_subtracts. 1 (nClip (%I e$1@))) (=> %%location_label%%2 (= (nClip (EucDiv (lib!bin_sizes.pow2.? e$1@) 2)) (lib!bin_sizes.pow2.? (I (Sub (%I e$1@) 1)))))))))) (=> (forall ((e$ Poly)) (! (=> (has_type e$ INT) (=> (> (%I e$) 0) (= (nClip (EucDiv (lib!bin_sizes.pow2.? e$) 2)) (lib!bin_sizes.pow2.? (I (Sub (%I e$) 1)))))) :pattern ((lib!bin_sizes.pow2.? e$)))) (and (=> (has_type e1@ INT) (=> (has_type e2@ INT) (=> (and (<= 0 (%I e1@)) (< (%I e1@) (%I e2@))) (=> (= diff@ (Sub (%I e2@) (%I e1@))) (=> (= tmp%1 (> (lib!bin_sizes.pow2.? (I diff@)) 1)) (and (=> %%location_label%%3 tmp%1) (=> tmp%1 (=> (ens%lib!bin_sizes.pow2_positive. diff@) (=> (ens%lib!bin_sizes.pow2_positive. (%I e1@)) (=> (ens%lib!bin_sizes.pow2_positive. (%I e2@)) (and (=> (ens%lib!bin_sizes.pow2_adds. (nClip (%I e1@)) (nClip diff@)) (=> %%location_label%%4 (= (nClip (Mul (lib!bin_sizes.pow2.? e1@) (lib!bin_sizes.pow2.? (I diff@)))) (lib!bin_sizes.pow2.? e2@)))) (=> (= (nClip (Mul (lib!bin_sizes.pow2.? e1@) (lib!bin_sizes.pow2.? (I diff@)))) (lib!bin_sizes.pow2.? e2@)) (=> (= tmp%2 (lib!bin_sizes.pow2.? e1@)) (=> (= tmp%3 (lib!bin_sizes.pow2.? (I diff@))) (=> (= tmp%4 (lib!bin_sizes.pow2.? e2@)) (and (=> %%location_label%%5 (req%lib!bin_sizes.mul_ordering. tmp%2 tmp%3 tmp%4)) (=> (ens%lib!bin_sizes.mul_ordering. tmp%2 tmp%3 tmp%4) (=> %%location_label%%6 (< (lib!bin_sizes.pow2.? e1@) (lib!bin_sizes.pow2.? e2@)))))))))))))))))))) (=> (forall ((e1$ Poly) (e2$ Poly)) (! (=> (and (has_type e1$ INT) (has_type e2$ INT)) (=> (and (<= 0 (%I e1$)) (< (%I e1$) (%I e2$))) (< (lib!bin_sizes.pow2.? e1$) (lib!bin_sizes.pow2.? e2$)))) :pattern ((lib!bin_sizes.pow2.? e1$) (lib!bin_sizes.pow2.? e2$)))) (and (=> (and (<= 0 e1$1@) (<= 0 e2$1@)) (=> (ens%lib!bin_sizes.pow2_adds. (nClip e1$1@) (nClip e2$1@)) (=> %%location_label%%7 (= (nClip (Mul (lib!bin_sizes.pow2.? (I e1$1@)) (lib!bin_sizes.pow2.? (I e2$1@)))) (lib!bin_sizes.pow2.? (I (Add e1$1@ e2$1@))))))) (=> (forall ((e1$ Int) (e2$ Int)) (! (=> (and (<= 0 e1$) (<= 0 e2$)) (= (nClip (Mul (lib!bin_sizes.pow2.? (I e1$)) (lib!bin_sizes.pow2.? (I e2$)))) (lib!bin_sizes.pow2.? (I (Add e1$ e2$))))) :pattern ((lib!bin_sizes.pow2.? (I (Add e1$ e2$)))))) (and (=> (and (<= 0 e1$2@) (<= e1$2@ e2$2@)) (and (=> %%location_label%%8 (req%lib!bin_sizes.pow2_subtracts. (nClip e1$2@) (nClip e2$2@))) (=> (ens%lib!bin_sizes.pow2_subtracts. (nClip e1$2@) (nClip e2$2@)) (=> %%location_label%%9 (= (nClip (EucDiv (lib!bin_sizes.pow2.? (I e2$2@)) (lib!bin_sizes.pow2.? (I e1$2@)))) (lib!bin_sizes.pow2.? (I (Sub e2$2@ e1$2@)))))))) (=> (forall ((e1$ Int) (e2$ Int)) (! (=> (and (<= 0 e1$) (<= e1$ e2$)) (= (nClip (EucDiv (lib!bin_sizes.pow2.? (I e2$)) (lib!bin_sizes.pow2.? (I e1$)))) (lib!bin_sizes.pow2.? (I (Sub e2$ e1$))))) :pattern ((lib!bin_sizes.pow2.? (I (Sub e2$ e1$)))))) (and (=> %%location_label%%10 (forall ((e$ Poly)) (! (=> (has_type e$ INT) (> (lib!bin_sizes.pow2.? e$) 0)) :pattern ((lib!bin_sizes.pow2.? e$))))) (and (=> %%location_label%%11 (forall ((e$ Poly)) (! (=> (has_type e$ INT) (=> (> (%I e$) 0) (= (nClip (EucDiv (lib!bin_sizes.pow2.? e$) 2)) (lib!bin_sizes.pow2.? (I (Sub (%I e$) 1)))))) :pattern ((lib!bin_sizes.pow2.? e$))))) (and (=> %%location_label%%12 (forall ((e1$ Poly) (e2$ Poly)) (! (=> (and (has_type e1$ INT) (has_type e2$ INT)) (=> (and (<= 0 (%I e1$)) (< (%I e1$) (%I e2$))) (< (lib!bin_sizes.pow2.? e1$) (lib!bin_sizes.pow2.? e2$)))) :pattern ((lib!bin_sizes.pow2.? e1$) (lib!bin_sizes.pow2.? e2$))))) (and (=> %%location_label%%13 (forall ((e1$ Int) (e2$ Int)) (! (=> (and (<= 0 e1$) (<= 0 e2$)) (= (nClip (Mul (lib!bin_sizes.pow2.? (I e1$)) (lib!bin_sizes.pow2.? (I e2$)))) (lib!bin_sizes.pow2.? (I (Add e1$ e2$))))) :pattern ((lib!bin_sizes.pow2.? (I (Add e1$ e2$))))))) (=> %%location_label%%14 (forall ((e1$ Int) (e2$ Int)) (! (=> (and (<= 0 e1$) (<= e1$ e2$)) (= (nClip (EucDiv (lib!bin_sizes.pow2.? (I e2$)) (lib!bin_sizes.pow2.? (I e1$)))) (lib!bin_sizes.pow2.? (I (Sub e2$ e1$))))) :pattern ((lib!bin_sizes.pow2.? (I (Sub e2$ e1$)))))))))))))))))))))))
(check-sat)
(exit)
