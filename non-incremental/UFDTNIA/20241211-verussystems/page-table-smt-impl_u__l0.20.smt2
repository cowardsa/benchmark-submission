...
(assert (has_type s! (TYPE%vstd!set.Set. T&. T&)))
(assert (has_type a! T&))
(assert (vstd!set.impl&%0.finite.? T&. T& s!))
(assert (vstd!set.impl&%0.contains.? T&. T& s! a!))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (or (and (=> (= (vstd!set.impl&%0.len.? T&. T& s!) 0) (=> (= tmp%1 (= (nClip (Add (vstd!set.impl&%0.len.? T&. T& (vstd!set.impl&%0.remove.? T&. T& s! a!)) 1)) 0)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (= (vstd!set.impl&%0.len.? T&. T& s!) 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%1 (> (vstd!set.impl&%0.len.? T&. T& s!) 0))))))
(check-sat)
(exit)
