...
(declare-const other! lib!impl_u.l0.PageTableContents.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!impl_u.l0.PageTableContents. self!) TYPE%lib!impl_u.l0.PageTableContents.))
(assert (has_type (Poly%lib!impl_u.l0.PageTableContents. other!) TYPE%lib!impl_u.l0.PageTableContents.))
(assert (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. self!)))
(assert (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. other!)))
(assert (lib!impl_u.l0.impl&%0.ranges_disjoint.? (Poly%lib!impl_u.l0.PageTableContents. self!) (Poly%lib!impl_u.l0.PageTableContents. other!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (lib!impl_u.l0.impl&%0.mappings_disjoint.? (Poly%lib!impl_u.l0.PageTableContents. self!) (Poly%lib!impl_u.l0.PageTableContents. other!)))))
(check-sat)
(exit)
