...
(declare-const tmp%1 main!logimpl_v.PersistentHeaderMetadata.)
(declare-const tmp%2 Int)
(declare-const verus_tmp_old_metadata_bytes@ vstd!seq.Seq<u8.>.)
(declare-const verus_tmp_old_crc_bytes@ vstd!seq.Seq<u8.>.)
(declare-const tmp%3 Bool)
(declare-const tmp%4 Bool)
(declare-const metadata_bytes@0 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const crc_bytes@0 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const verus_tmp@0 vstd!seq.Seq<u8.>.)
(declare-const old_metadata_bytes@0 vstd!seq.Seq<u8.>.)
(declare-const verus_tmp$1@0 vstd!seq.Seq<u8.>.)
(declare-const old_crc_bytes@0 vstd!seq.Seq<u8.>.)
...
(declare-const old_metadata_bytes@1 vstd!seq.Seq<u8.>.)
(declare-const verus_tmp$1@1 vstd!seq.Seq<u8.>.)
(declare-const old_crc_bytes@1 vstd!seq.Seq<u8.>.)
(declare-const crc_bytes@1 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const metadata_bytes@1 alloc!vec.Vec<u8./allocator_global%.>.)
...
(assert (not (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> (= tmp%1 (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header!)))) (=> (ens%main!logimpl_v.metadata_to_bytes. tmp%1 metadata_bytes@0) (=> (= tmp%2 (main!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header!)))) (=> (ens%vstd!bytes.u64_to_le_bytes. tmp%2 crc_bytes@0) (=> (= verus_tmp@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. metadata_bytes@0)))) (=> (= verus_tmp_old_metadata_bytes@ verus_tmp@1) (=> (= old_metadata_bytes@1 verus_tmp_old_metadata_bytes@) (=> (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@0)))) (=> (= verus_tmp_old_crc_bytes@ verus_tmp$1@1) (=> (= old_crc_bytes@1 verus_tmp_old_crc_bytes@) (=> (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@0) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@1) (Poly%alloc!vec.Vec<u8./allocator_global%.>. metadata_bytes@0) (Poly%alloc!vec.Vec<u8./allocator_global%.>. metadata_bytes@1)) (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_crc_bytes@1) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@1)) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8))))) (and (=> %%location_label%%0 tmp%3) (=> tmp%3 (=> (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_metadata_bytes@1) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@1)) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)))) (and (=> %%location_label%%1 tmp%4) (=> tmp%4 (=> (= out! crc_bytes@1) (and (=> %%location_label%%2 (= header! (main!logimpl_v.spec_bytes_to_header.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!))))) (and (=> %%location_label%%3 (= (vstd!bytes.spec_u64_from_le_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!)) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8)))) (main!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header!))))) (and (=> %%location_label%%4 (= (main!logimpl_v.spec_bytes_to_metadata.? (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!)) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?))) (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header!))))) (=> %%location_label%%5 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!))) main!logimpl_v.header_size.?)))))))))))))))))))))))))))
(check-sat)
(exit)
