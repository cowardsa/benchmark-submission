...
(assert (not (and (=> %%location_label%%0 (uInv SZ (Mul 512 512))) (and (=> %%location_label%%1 (uInv SZ (Mul (uClip SZ (Mul 512 512)) 1024))) (and (=> %%location_label%%2 (uInv SZ (Mul (uClip SZ (Mul (uClip SZ (Mul 512 512)) 1024)) 1024))) (=> %%location_label%%3 (uInv SZ (Mul (uClip SZ (Mul (uClip SZ (Mul (uClip SZ (Mul 512 512)) 1024)) 1024)) 1024))))))))
(check-sat)
(exit)
