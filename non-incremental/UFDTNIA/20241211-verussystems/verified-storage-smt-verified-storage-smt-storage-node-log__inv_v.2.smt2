...
(assert (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. old_pm_region_view!) (I log_id!) (B new_cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!)))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (and (=> (= old_mem@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. old_pm_region_view!))) (=> (= new_mem@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. new_pm_region_view!))) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. old_mem@ new_mem@) (=> %%location_label%%0 (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. new_pm_region_view!) (I log_id!) (B new_cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!)))))) (=> (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. new_pm_region_view!) (I log_id!) (B new_cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!)) (=> %%location_label%%1 (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. new_pm_region_view!) (I log_id!) (B new_cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!))))))))
(check-sat)
(exit)
