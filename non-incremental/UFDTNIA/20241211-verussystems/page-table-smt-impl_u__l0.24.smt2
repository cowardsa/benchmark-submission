...
(set-info :comment ";; Function-Specs lib::impl_u::l0::PageTableContents::lemma_mappings_have_positive_entry_size")
(declare-fun req%lib!impl_u.l0.impl&%0.lemma_mappings_have_positive_entry_size. (lib!impl_u.l0.PageTableContents.) Bool)
(declare-const %%global_location_label%%19 Bool)
(assert (forall ((self! lib!impl_u.l0.PageTableContents.)) (! (= (req%lib!impl_u.l0.impl&%0.lemma_mappings_have_positive_entry_size. self!) (=> %%global_location_label%%19 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. self!)))) :pattern ((req%lib!impl_u.l0.impl&%0.lemma_mappings_have_positive_entry_size. self!)))))
(declare-fun ens%lib!impl_u.l0.impl&%0.lemma_mappings_have_positive_entry_size. (lib!impl_u.l0.PageTableContents.) Bool)
(assert (forall ((self! lib!impl_u.l0.PageTableContents.)) (! (= (ens%lib!impl_u.l0.impl&%0.lemma_mappings_have_positive_entry_size. self!) (forall ((va$ Poly)) (! (=> (has_type va$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!))))) va$) (> (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!)))) va$)))))) 0))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!))))) va$))))) :pattern ((ens%lib!impl_u.l0.impl&%0.lemma_mappings_have_positive_entry_size. self!)))))
(set-info :comment ";; Function-Def lib::impl_u::l0::PageTableContents::lemma_mappings_have_positive_entry_size")
(set-info :comment ";; page-table/impl_u/l0.rs:240:11: 240:59 (#0)")
...
(assert (not (=> %%location_label%%0 (forall ((va$ Poly)) (! (=> (has_type va$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!))))) va$) (> (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!)))) va$)))))) 0))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!))))) va$)))))))
(check-sat)
(exit)
