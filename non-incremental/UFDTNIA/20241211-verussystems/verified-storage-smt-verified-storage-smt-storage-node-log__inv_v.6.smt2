...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (and (=> (ens%lib!pmem.pmemutil_v.lemma_wherever_no_outstanding_writes_persistent_memory_view_can_only_crash_as_committed. pm_region_view!) (=> (= tmp%1 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. mem! tmp%1) (=> %%location_label%%0 (= (lib!log.layout_v.recover_cdb.? (Poly%vstd!seq.Seq<u8.>. mem!)) (core!option.Option./Some (B cdb!))))))) (=> (= (lib!log.layout_v.recover_cdb.? (Poly%vstd!seq.Seq<u8.>. mem!)) (core!option.Option./Some (B cdb!))) (and (and (=> %%location_label%%1 (req%lib!log.inv_v.lemma_invariants_imply_crash_recover_for_one_log. pm_region_view! mem! log_id! cdb! info! state!)) (=> (ens%lib!log.inv_v.lemma_invariants_imply_crash_recover_for_one_log. pm_region_view! mem! log_id! cdb! info! state!) (=> %%location_label%%2 (= (lib!log.layout_v.recover_given_cdb.? (Poly%vstd!seq.Seq<u8.>. mem!) (I log_id!) (B cdb!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!)))))))) (=> (= (lib!log.layout_v.recover_given_cdb.? (Poly%vstd!seq.Seq<u8.>. mem!) (I log_id!) (B cdb!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!))))) (=> (= tmp%2 (ext_eq false (TYPE%core!option.Option. $ TYPE%lib!log.logspec_t.AbstractLogState.) (Poly%core!option.Option. (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. mem!) (I log_id!))) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!))))))) (and (=> %%location_label%%3 tmp%2) (=> tmp%2 (and (=> %%location_label%%4 (req%lib!log.inv_v.lemma_metadata_set_after_crash. pm_region_view! cdb!)) (=> (ens%lib!log.inv_v.lemma_metadata_set_after_crash. pm_region_view! cdb!) (and (=> %%location_label%%5 (= (lib!log.layout_v.recover_cdb.? (Poly%vstd!seq.Seq<u8.>. mem!)) (core!option.Option./Some (B cdb!)))) (and (=> %%location_label%%6 (= (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. mem!) (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!)))))) (=> %%location_label%%7 (lib!log.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<u8.>. mem!)))))))))))))))))
(check-sat)
(exit)
