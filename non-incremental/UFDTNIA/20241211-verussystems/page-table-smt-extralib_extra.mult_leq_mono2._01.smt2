...
(set-info :comment ";; page-table/extra.rs:125:1: 125:52 (#0)")
...
(set-info :comment ";; Function-Def lib::extra::mult_leq_mono2")
(set-info :comment ";; page-table/extra.rs:125:1: 125:52 (#0)")
(declare-const a! Int)
(declare-const b! Int)
(declare-const c! Int)
...
(assert (not (=> %%location_label%%0 (<= (nClip (Mul c! a!)) (nClip (Mul c! a!))))))
(check-sat)
(exit)
