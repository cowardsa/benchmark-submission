...
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)) main!pmemspec_t.persistence_chunk_size.?))
(assert (= (EucMod write_addr! main!pmemspec_t.persistence_chunk_size.?) 0))
(assert (and (<= 0 write_addr!) (< write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)))))
(assert (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!))) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (forall ((chunks_flushed$ Poly)) (! (=> (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT)) (let ((new_crash_contents$ (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!) chunks_flushed$))) (let ((new_contents$ (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)))) (or (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. new_crash_contents$) (Poly%vstd!seq.Seq<u8.>. pm!)) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. new_crash_contents$) (Poly%vstd!seq.Seq<u8.>. new_contents$)))))) :pattern ((main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!) chunks_flushed$)))))))
(check-sat)
(exit)
