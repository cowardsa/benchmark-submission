...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_FLAG_US")
(set-info :comment ";; page-table/spec_t/hardware.rs:101:1: 101:44 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_FLAG_PWT")
(set-info :comment ";; page-table/spec_t/hardware.rs:102:1: 102:44 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_FLAG_PCD")
(set-info :comment ";; page-table/spec_t/hardware.rs:103:1: 103:44 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_FLAG_A")
(set-info :comment ";; page-table/spec_t/hardware.rs:104:1: 104:44 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_FLAG_XD")
(set-info :comment ";; page-table/spec_t/hardware.rs:105:1: 105:45 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_PG_FLAG_D")
(set-info :comment ";; page-table/spec_t/hardware.rs:109:1: 109:47 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_PG_FLAG_G")
(set-info :comment ";; page-table/spec_t/hardware.rs:110:1: 110:47 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_L1_PG_FLAG_PS")
(set-info :comment ";; page-table/spec_t/hardware.rs:113:1: 113:50 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_L2_PG_FLAG_PS")
(set-info :comment ";; page-table/spec_t/hardware.rs:114:1: 114:50 (#0)")
...
(assert (forall ((self! Poly)) (! (= (req%lib!spec_t.hardware.impl&%3.all_mb0_bits_are_zero. self!) (=> %%global_location_label%%5 (<= (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/layer (%Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)) 3))) :pattern ((req%lib!spec_t.hardware.impl&%3.all_mb0_bits_are_zero. self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::PageDirectoryEntry::all_mb0_bits_are_zero")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_ADDR_SPEC")
(set-info :comment ";; page-table/spec_t/hardware.rs:127:1: 127:81 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_L1_PG_ADDR_SPEC")
(set-info :comment ";; page-table/spec_t/hardware.rs:136:1: 136:87 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_PG_FLAG_PAT")
(set-info :comment ";; page-table/spec_t/hardware.rs:111:1: 111:48 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_L2_PG_ADDR_SPEC")
(set-info :comment ";; page-table/spec_t/hardware.rs:145:1: 145:87 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_L3_PG_ADDR_SPEC")
(set-info :comment ";; page-table/spec_t/hardware.rs:154:1: 154:87 (#0)")
...
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_L3_PG_FLAG_PAT")
(set-info :comment ";; page-table/spec_t/hardware.rs:116:1: 116:50 (#0)")
...
(assert (forall ((n! Poly)) (! (= (req%lib!spec_t.hardware.nat_to_u64. n!) (=> %%global_location_label%%6 (<= (%I n!) 18446744073709551615))) :pattern ((req%lib!spec_t.hardware.nat_to_u64. n!)))))
...
(declare-fun %%lambda%%0 (Int Poly Type Poly) %%Function%%)
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Poly) (%%hole%%2 Type) (%%hole%%3 Poly) (addr$ Poly)) (! (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) addr$) (B (and (< (%I addr$) %%hole%%0) (exists ((pte$ Poly)) (! (and (has_type pte$ %%hole%%2) (lib!spec_t.hardware.valid_pt_walk.? %%hole%%3 (I (lib!spec_t.hardware.nat_to_u64.? addr$)) pte$)) :pattern ((lib!spec_t.hardware.valid_pt_walk.? %%hole%%1 (I (lib!spec_t.hardware.nat_to_u64.? addr$)) pte$))))))) :pattern ((%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) addr$)))))
...
(declare-fun %%lambda%%1 (Type Poly Poly Type) %%Function%%)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Type) (addr$ Poly)) (! (= (%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) addr$) (as_type (%%choose%%0 %%hole%%0 %%hole%%1 (I (lib!spec_t.hardware.nat_to_u64.? addr$)) %%hole%%2 (I (lib!spec_t.hardware.nat_to_u64.? addr$))) %%hole%%3)) :pattern ((%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) addr$)))))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.interp_pt_mem.) (forall ((pt_mem! Poly)) (! (= (lib!spec_t.hardware.interp_pt_mem.? pt_mem!) (%Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (vstd!map.impl&%0.new.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. $ (TYPE%fun%1. $ NAT $ BOOL) $ (TYPE%fun%1. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (Poly%fun%1. (mk_fun (%%lambda%%0 lib!definitions_t.MAX_BASE.? pt_mem! TYPE%lib!definitions_t.PageTableEntry. pt_mem!))) (Poly%fun%1. (mk_fun (%%lambda%%1 TYPE%lib!definitions_t.PageTableEntry. pt_mem! pt_mem! TYPE%lib!definitions_t.PageTableEntry.)))))) :pattern ((lib!spec_t.hardware.interp_pt_mem.? pt_mem!))))))
...
(assert (forall ((addr! Poly)) (! (= (req%lib!spec_t.mem.word_index_spec. addr!) (=> %%global_location_label%%7 (lib!definitions_t.aligned.? addr! (I 8)))) :pattern ((req%lib!spec_t.mem.word_index_spec. addr!)))))
...
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::HWStep::arrow_paddr")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%0.arrow_paddr.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%0.arrow_paddr.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%0.arrow_paddr.? self!) (lib!spec_t.hardware.HWStep./ReadWrite/paddr (%Poly%lib!spec_t.hardware.HWStep. self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_paddr.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.HWStep.) (<= 0 (lib!spec_t.hardware.impl&%0.arrow_paddr.? self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_paddr.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::HWStep::arrow_op")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%0.arrow_op.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%0.arrow_op.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%0.arrow_op.? self!) (lib!spec_t.hardware.HWStep./ReadWrite/op (%Poly%lib!spec_t.hardware.HWStep. self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_op.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.HWStep.) (has_type (Poly%lib!definitions_t.RWOp. (lib!spec_t.hardware.impl&%0.arrow_op.? self!)) TYPE%lib!definitions_t.RWOp.)) :pattern ((lib!spec_t.hardware.impl&%0.arrow_op.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::HWStep::arrow_ReadWrite_vaddr")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%0.arrow_ReadWrite_vaddr.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%0.arrow_ReadWrite_vaddr.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%0.arrow_ReadWrite_vaddr.? self!) (lib!spec_t.hardware.HWStep./ReadWrite/vaddr (%Poly%lib!spec_t.hardware.HWStep. self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_ReadWrite_vaddr.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.HWStep.) (<= 0 (lib!spec_t.hardware.impl&%0.arrow_ReadWrite_vaddr.? self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_ReadWrite_vaddr.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::HWStep::arrow_ReadWrite_paddr")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%0.arrow_ReadWrite_paddr.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%0.arrow_ReadWrite_paddr.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%0.arrow_ReadWrite_paddr.? self!) (lib!spec_t.hardware.HWStep./ReadWrite/paddr (%Poly%lib!spec_t.hardware.HWStep. self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_ReadWrite_paddr.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.HWStep.) (<= 0 (lib!spec_t.hardware.impl&%0.arrow_ReadWrite_paddr.? self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_ReadWrite_paddr.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::HWStep::arrow_ReadWrite_op")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%0.arrow_ReadWrite_op.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%0.arrow_ReadWrite_op.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%0.arrow_ReadWrite_op.? self!) (lib!spec_t.hardware.HWStep./ReadWrite/op (%Poly%lib!spec_t.hardware.HWStep. self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_ReadWrite_op.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.HWStep.) (has_type (Poly%lib!definitions_t.RWOp. (lib!spec_t.hardware.impl&%0.arrow_ReadWrite_op.? self!)) TYPE%lib!definitions_t.RWOp.)) :pattern ((lib!spec_t.hardware.impl&%0.arrow_ReadWrite_op.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::HWStep::arrow_ReadWrite_pte")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%0.arrow_ReadWrite_pte.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%0.arrow_ReadWrite_pte.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%0.arrow_ReadWrite_pte.? self!) (lib!spec_t.hardware.HWStep./ReadWrite/pte (%Poly%lib!spec_t.hardware.HWStep. self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_ReadWrite_pte.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.HWStep.) (has_type (Poly%core!option.Option. (lib!spec_t.hardware.impl&%0.arrow_ReadWrite_pte.? self!)) (TYPE%core!option.Option. $ (TYPE%tuple%2. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.)))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_ReadWrite_pte.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::HWStep::arrow_TLBFill_vaddr")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%0.arrow_TLBFill_vaddr.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%0.arrow_TLBFill_vaddr.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%0.arrow_TLBFill_vaddr.? self!) (lib!spec_t.hardware.HWStep./TLBFill/vaddr (%Poly%lib!spec_t.hardware.HWStep. self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_TLBFill_vaddr.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.HWStep.) (<= 0 (lib!spec_t.hardware.impl&%0.arrow_TLBFill_vaddr.? self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_TLBFill_vaddr.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::HWStep::arrow_TLBFill_pte")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%0.arrow_TLBFill_pte.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%0.arrow_TLBFill_pte.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%0.arrow_TLBFill_pte.? self!) (lib!spec_t.hardware.HWStep./TLBFill/pte (%Poly%lib!spec_t.hardware.HWStep. self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_TLBFill_pte.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.HWStep.) (has_type (Poly%lib!definitions_t.PageTableEntry. (lib!spec_t.hardware.impl&%0.arrow_TLBFill_pte.? self!)) TYPE%lib!definitions_t.PageTableEntry.)) :pattern ((lib!spec_t.hardware.impl&%0.arrow_TLBFill_pte.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::HWStep::arrow_TLBEvict_vaddr")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%0.arrow_TLBEvict_vaddr.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%0.arrow_TLBEvict_vaddr.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%0.arrow_TLBEvict_vaddr.? self!) (lib!spec_t.hardware.HWStep./TLBEvict/vaddr (%Poly%lib!spec_t.hardware.HWStep. self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_TLBEvict_vaddr.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.HWStep.) (<= 0 (lib!spec_t.hardware.impl&%0.arrow_TLBEvict_vaddr.? self!))) :pattern ((lib!spec_t.hardware.impl&%0.arrow_TLBEvict_vaddr.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::is_Directory")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.is_Directory.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.is_Directory.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.is_Directory.? self!) (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.is_Directory.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Directory_flag_P")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Directory_flag_P.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Directory_flag_P.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Directory_flag_P.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_P (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Directory_flag_P.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Directory_flag_PWT")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Directory_flag_PWT.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Directory_flag_PWT.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Directory_flag_PWT.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_PWT (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Directory_flag_PWT.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Directory_flag_PCD")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Directory_flag_PCD.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Directory_flag_PCD.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Directory_flag_PCD.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_PCD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Directory_flag_PCD.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Directory_flag_A")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Directory_flag_A.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Directory_flag_A.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Directory_flag_A.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_A (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Directory_flag_A.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::is_Page")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.is_Page.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.is_Page.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.is_Page.? self!) (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.is_Page.? self!))))))
...
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Page_flag_P")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_P.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_P.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Page_flag_P.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_P (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Page_flag_P.? self!))))))
...
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Page_flag_PWT")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_PWT.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_PWT.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Page_flag_PWT.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_PWT (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Page_flag_PWT.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Page_flag_PCD")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_PCD.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_PCD.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Page_flag_PCD.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_PCD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Page_flag_PCD.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Page_flag_A")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_A.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_A.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Page_flag_A.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_A (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Page_flag_A.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Page_flag_D")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_D.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_D.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Page_flag_D.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_D (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Page_flag_D.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Page_flag_G")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_G.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_G.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Page_flag_G.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_G (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Page_flag_G.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::get_Page_flag_PAT")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_PAT.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.get_Page_flag_PAT.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.get_Page_flag_PAT.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_PAT (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.get_Page_flag_PAT.? self!))))))
...
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::is_Empty")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%1.is_Empty.))
...
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%1.is_Empty.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%1.is_Empty.? self!) (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Empty_ (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%1.is_Empty.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_flag_G")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_flag_G.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_flag_G.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_flag_G.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_G (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_flag_G.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_flag_PAT")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_flag_PAT.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_flag_PAT.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_flag_PAT.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_PAT (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_flag_PAT.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_flag_D")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_flag_D.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_flag_D.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_flag_D.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_D (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_flag_D.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Directory_addr")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_addr.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_addr.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Directory_addr.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Directory_addr.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.GhostPageDirectoryEntry.) (uInv SZ (lib!spec_t.hardware.impl&%2.arrow_Directory_addr.? self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Directory_addr.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Directory_flag_P")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_P.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_P.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Directory_flag_P.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_P (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Directory_flag_P.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Directory_flag_RW")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_RW.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_RW.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Directory_flag_RW.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Directory_flag_RW.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Directory_flag_US")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_US.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_US.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Directory_flag_US.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Directory_flag_US.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Directory_flag_PWT")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_PWT.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_PWT.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Directory_flag_PWT.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_PWT (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Directory_flag_PWT.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Directory_flag_PCD")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_PCD.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_PCD.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Directory_flag_PCD.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_PCD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Directory_flag_PCD.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Directory_flag_A")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_A.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_A.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Directory_flag_A.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_A (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Directory_flag_A.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Directory_flag_XD")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_XD.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Directory_flag_XD.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Directory_flag_XD.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Directory_flag_XD.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_addr")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_addr.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_addr.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_addr.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_addr.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!spec_t.hardware.GhostPageDirectoryEntry.) (uInv SZ (lib!spec_t.hardware.impl&%2.arrow_Page_addr.? self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_addr.? self!)))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_P")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_P.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_P.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_P.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_P (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_P.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_RW")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_RW.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_RW.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_RW.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_RW.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_US")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_US.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_US.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_US.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_US.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_PWT")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_PWT.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_PWT.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_PWT.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_PWT (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_PWT.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_PCD")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_PCD.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_PCD.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_PCD.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_PCD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_PCD.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_A")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_A.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_A.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_A.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_A (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_A.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_D")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_D.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_D.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_D.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_D (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_D.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_G")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_G.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_G.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_G.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_G (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_G.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_PAT")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_PAT.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_PAT.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_PAT.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_PAT (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_PAT.? self!))))))
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::GhostPageDirectoryEntry::arrow_Page_flag_XD")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_XD.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%2.arrow_Page_flag_XD.) (forall ((self! Poly)) (! (= (lib!spec_t.hardware.impl&%2.arrow_Page_flag_XD.? self!) (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. self!))) :pattern ((lib!spec_t.hardware.impl&%2.arrow_Page_flag_XD.? self!))))))
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_DIR_ADDR_SPEC")
(set-info :comment ";; page-table/spec_t/hardware.rs:163:1: 163:52 (#0)")
...
(set-info :comment ";; Function-Axioms lib::spec_t::hardware::next")
(assert (fuel_bool_default fuel%lib!spec_t.hardware.next.))
(assert (=> (fuel_bool fuel%lib!spec_t.hardware.next.) (forall ((s1! Poly) (s2! Poly)) (! (= (lib!spec_t.hardware.next.? s1! s2!) (exists ((step$ Poly)) (! (and (has_type step$ TYPE%lib!spec_t.hardware.HWStep.) (lib!spec_t.hardware.next_step.? s1! s2! step$)) :pattern ((lib!spec_t.hardware.next_step.? s1! s2! step$))))) :pattern ((lib!spec_t.hardware.next.? s1! s2!))))))
(set-info :comment ";; Function-Specs lib::spec_t::hardware::MASK_ADDR")
(declare-fun ens%lib!spec_t.hardware.MASK_ADDR. (Int) Bool)
(assert (forall ((%return! Int)) (! (= (ens%lib!spec_t.hardware.MASK_ADDR. %return!) (and (uInv 64 %return!) (= %return! lib!spec_t.hardware.MASK_ADDR_SPEC.?))) :pattern ((ens%lib!spec_t.hardware.MASK_ADDR. %return!)))))
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_ADDR")
(set-info :comment ";; page-table/spec_t/hardware.rs:129:1: 129:15 (#0)")
(set-info :comment ";; Function-Specs lib::spec_t::hardware::MASK_L1_PG_ADDR")
(declare-fun ens%lib!spec_t.hardware.MASK_L1_PG_ADDR. (Int) Bool)
(assert (forall ((%return! Int)) (! (= (ens%lib!spec_t.hardware.MASK_L1_PG_ADDR. %return!) (and (uInv 64 %return!) (= %return! lib!spec_t.hardware.MASK_L1_PG_ADDR_SPEC.?))) :pattern ((ens%lib!spec_t.hardware.MASK_L1_PG_ADDR. %return!)))))
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_L1_PG_ADDR")
(set-info :comment ";; page-table/spec_t/hardware.rs:138:1: 138:15 (#0)")
(set-info :comment ";; Function-Specs lib::spec_t::hardware::MASK_L2_PG_ADDR")
(declare-fun ens%lib!spec_t.hardware.MASK_L2_PG_ADDR. (Int) Bool)
(assert (forall ((%return! Int)) (! (= (ens%lib!spec_t.hardware.MASK_L2_PG_ADDR. %return!) (and (uInv 64 %return!) (= %return! lib!spec_t.hardware.MASK_L2_PG_ADDR_SPEC.?))) :pattern ((ens%lib!spec_t.hardware.MASK_L2_PG_ADDR. %return!)))))
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_L2_PG_ADDR")
(set-info :comment ";; page-table/spec_t/hardware.rs:147:1: 147:15 (#0)")
(set-info :comment ";; Function-Specs lib::spec_t::hardware::MASK_L3_PG_ADDR")
(declare-fun ens%lib!spec_t.hardware.MASK_L3_PG_ADDR. (Int) Bool)
(assert (forall ((%return! Int)) (! (= (ens%lib!spec_t.hardware.MASK_L3_PG_ADDR. %return!) (and (uInv 64 %return!) (= %return! lib!spec_t.hardware.MASK_L3_PG_ADDR_SPEC.?))) :pattern ((ens%lib!spec_t.hardware.MASK_L3_PG_ADDR. %return!)))))
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_L3_PG_ADDR")
(set-info :comment ";; page-table/spec_t/hardware.rs:156:1: 156:15 (#0)")
(set-info :comment ";; Function-Specs lib::spec_t::hardware::MASK_DIR_ADDR")
(declare-fun ens%lib!spec_t.hardware.MASK_DIR_ADDR. (Int) Bool)
(assert (forall ((%return! Int)) (! (= (ens%lib!spec_t.hardware.MASK_DIR_ADDR. %return!) (and (uInv 64 %return!) (= %return! lib!spec_t.hardware.MASK_DIR_ADDR_SPEC.?))) :pattern ((ens%lib!spec_t.hardware.MASK_DIR_ADDR. %return!)))))
(set-info :comment ";; Function-Def lib::spec_t::hardware::MASK_DIR_ADDR")
(set-info :comment ";; page-table/spec_t/hardware.rs:165:1: 165:15 (#0)")
(declare-const %return! Int)
(declare-const tmp%1 Int)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!spec_t.hardware.MASK_ADDR. tmp%1) (=> (= %return! tmp%1) (=> %%location_label%%0 (= %return! lib!spec_t.hardware.MASK_DIR_ADDR_SPEC.?))))))
(check-sat)
(exit)
