...
(set-info :comment ";; Function-Def lib::spec::cyclicbuffer::log_entry_alive_wrap_around")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/cyclicbuffer.rs:820:7: 825:2 (#0)")
...
(set-info :comment ";; Function-Def lib::spec::cyclicbuffer::log_entry_alive_wrap_around_helper")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/cyclicbuffer.rs:841:7: 846:2 (#0)")
(declare-const alive_bits! vstd!map.Map<nat./bool.>.)
...
(assert (<= 0 low!))
(assert (<= 0 high!))
(assert (= buffer_size! lib!constants.LOG_SIZE.?))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (= (< (%I i$) buffer_size!) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ BOOL (Poly%vstd!map.Map<nat./bool.>. alive_bits!)) i$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ BOOL (Poly%vstd!map.Map<nat./bool.>. alive_bits!)) i$)))))
(assert (and (<= low! high!) (<= high! (nClip (Add low! buffer_size!)))))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= low! (%I i$)) (< (%I i$) high!)) (not (lib!spec.cyclicbuffer.log_entry_is_alive.? (Poly%vstd!map.Map<nat./bool.>. alive_bits!) (I (lib!spec.cyclicbuffer.add_buffersize.? i$ (I buffer_size!))) (I buffer_size!))))) :pattern ((lib!spec.cyclicbuffer.log_entry_is_alive.? (Poly%vstd!map.Map<nat./bool.>. alive_bits!) (I (lib!spec.cyclicbuffer.add_buffersize.? i$ (I buffer_size!))) (I buffer_size!))))))
...
(assert (not (and (=> (has_type i@ INT) (=> (and (<= (nClip (Add low! buffer_size!)) (%I i@)) (< (%I i@) (nClip (Add high! buffer_size!)))) (=> (= j@ (Sub (%I i@) buffer_size!)) (=> (= tmp%1 (and (<= low! j@) (< j@ high!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (not (lib!spec.cyclicbuffer.log_entry_is_alive.? (Poly%vstd!map.Map<nat./bool.>. alive_bits!) (I (lib!spec.cyclicbuffer.add_buffersize.? (I j@) (I buffer_size!))) (I buffer_size!)))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> %%location_label%%2 (not (lib!spec.cyclicbuffer.log_entry_is_alive.? (Poly%vstd!map.Map<nat./bool.>. alive_bits!) i@ (I buffer_size!))))))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= (nClip (Add low! buffer_size!)) (%I i$)) (< (%I i$) (nClip (Add high! buffer_size!)))) (not (lib!spec.cyclicbuffer.log_entry_is_alive.? (Poly%vstd!map.Map<nat./bool.>. alive_bits!) i$ (I buffer_size!))))) :pattern ((lib!spec.cyclicbuffer.log_entry_is_alive.? (Poly%vstd!map.Map<nat./bool.>. alive_bits!) i$ (I buffer_size!))))) (=> %%location_label%%3 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= (nClip (Add low! buffer_size!)) (%I i$)) (< (%I i$) (nClip (Add high! buffer_size!)))) (not (lib!spec.cyclicbuffer.log_entry_is_alive.? (Poly%vstd!map.Map<nat./bool.>. alive_bits!) i$ (I buffer_size!))))) :pattern ((lib!spec.cyclicbuffer.log_entry_is_alive.? (Poly%vstd!map.Map<nat./bool.>. alive_bits!) i$ (I buffer_size!))))))))))
(check-sat)
(exit)
