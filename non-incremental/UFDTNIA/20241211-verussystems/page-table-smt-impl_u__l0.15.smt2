...
(declare-const union_dom@ Poly)
(declare-const dom_union@ Poly)
...
(assert (not (and (=> (has_type s1@ (TYPE%vstd!map.Map. S&. S& T&. T&)) (=> (has_type s2@ (TYPE%vstd!map.Map. S&. S& T&. T&)) (=> (and (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s1@)) (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s2@))) (=> (= tmp%1 (vstd!set.impl&%0.finite.? S&. S& (vstd!set.impl&%0.union.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s1@) (vstd!map.impl&%0.dom.? S&. S& T&. T& s2@)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= union_dom@ (vstd!map.impl&%0.dom.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& s1@ s2@))) (=> (= dom_union@ (vstd!set.impl&%0.union.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s1@) (vstd!map.impl&%0.dom.? S&. S& T&. T& s2@))) (=> (= tmp%2 (forall ((s$ Poly)) (! (=> (has_type s$ S&) (=> (vstd!set.impl&%0.contains.? S&. S& union_dom@ s$) (vstd!set.impl&%0.contains.? S&. S& dom_union@ s$))) :pattern ((vstd!set.impl&%0.contains.? S&. S& union_dom@ s$)) :pattern ((vstd!set.impl&%0.contains.? S&. S& dom_union@ s$))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (forall ((s$ Poly)) (! (=> (has_type s$ S&) (=> (vstd!set.impl&%0.contains.? S&. S& dom_union@ s$) (vstd!set.impl&%0.contains.? S&. S& union_dom@ s$))) :pattern ((vstd!set.impl&%0.contains.? S&. S& dom_union@ s$)) :pattern ((vstd!set.impl&%0.contains.? S&. S& union_dom@ s$))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (ext_eq false (TYPE%vstd!set.Set. S&. S&) union_dom@ dom_union@)) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> %%location_label%%4 (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& s1@ s2@))))))))))))))))))))) (=> (forall ((s1$ Poly) (s2$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type s2$ (TYPE%vstd!map.Map. S&. S& T&. T&))) (=> (and (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s1$)) (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s2$))) (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& s1$ s2$))))) :pattern ((vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& s1$ s2$)))) (=> %%location_label%%5 (forall ((s1$ Poly) (s2$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type s2$ (TYPE%vstd!map.Map. S&. S& T&. T&))) (=> (and (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s1$)) (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s2$))) (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& s1$ s2$))))) :pattern ((vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& s1$ s2$)))))))))))
(check-sat)
(exit)
