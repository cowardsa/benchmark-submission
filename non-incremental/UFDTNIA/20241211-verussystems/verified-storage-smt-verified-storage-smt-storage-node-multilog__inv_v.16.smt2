...
(declare-const old_pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)
(declare-const new_pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)
...
(assert (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!)))
(assert (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!)))
(assert (= (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!)) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!))))
...
(assert (> (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!)) 0))
(assert (is-core!option.Option./Some_ (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))) (I 0)))))
(assert (= (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))) (I 0))))))) old_cdb!))
...
(assert (= new_pm_regions_view! (lib!pmem.pmemspec_t.impl&%7.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. (lib!pmem.pmemspec_t.impl&%7.write.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!) (I 0) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (Poly%vstd!seq.Seq<u8.>. new_cdb_bytes!))))))
(assert (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!)))))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))))) (= (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!) i$))) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!) i$)))))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$)))))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))))) (< lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!) i$)))))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$)))))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))))) (lib!multilog.inv_v.inactive_metadata_types_set_in_region.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))) i$) (B old_cdb!)))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$)))))
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (= tmp%1 (lib!multilog.inv_v.log_index_trigger.? (I 0))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))) (I 0)))) (=> (= tmp%3 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!))) (I 0)))) (=> (ens%lib!multilog.layout_v.lemma_establish_subrange_equivalence. tmp%2 tmp%3) (=> (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!))) (I 0)) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (Poly%vstd!seq.Seq<u8.>. new_cdb_bytes!))) (and (=> %%location_label%%1 tmp%4) (=> tmp%4 (=> (= new_cdb@ (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!multilog.layout_v.deserialize_and_check_log_cdb.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!))) (I 0)))))))) (=> (= log_metadata_pos@ (lib!multilog.layout_v.get_log_metadata_pos.? (B new_cdb@))) (and (=> (has_type i@ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i@) (and (<= 0 (%I i@)) (< (%I i@) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))))) (=> (= tmp%5 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))) i@))) (=> (= tmp%6 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!))) i@))) (=> (ens%lib!multilog.layout_v.lemma_establish_subrange_equivalence. tmp%5 tmp%6) (=> %%location_label%%2 (lib!multilog.inv_v.metadata_types_set_in_region.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!))) i@) (B new_cdb@)))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_regions_view!))))) (lib!multilog.inv_v.metadata_types_set_in_region.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!))) i$) (B new_cdb@)))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$)))) (=> %%location_label%%3 (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_regions_view!)))))))))))))))))))))
(check-sat)
(exit)
