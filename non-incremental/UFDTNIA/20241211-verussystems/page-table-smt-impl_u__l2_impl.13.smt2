...
(set-info :comment ";; Function-Def lib::spec_t::hardware::PageDirectoryEntry::new_dir_entry")
(set-info :comment ";; page-table/impl_u/l2_impl.rs:349:5: 349:65 (#0)")
...
(assert (< layer! 3))
(assert (= (uClip 64 (bitand (I address!) (I lib!spec_t.hardware.MASK_DIR_ADDR_SPEC.?))) address!))
...
(assert (not (and (=> %%location_label%%0 (req%lib!impl_u.l2_impl.impl&%0.new_entry. layer! address! false true false false false false)) (=> (ens%lib!impl_u.l2_impl.impl&%0.new_entry. layer! address! false true false false false false tmp%1) (=> (= r! tmp%1) (and (=> %%location_label%%1 (lib!spec_t.hardware.impl&%3.all_mb0_bits_are_zero.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. r!))) (and (=> %%location_label%%2 (lib!impl_u.l2_impl.impl&%0.hp_pat_is_zero.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. r!))) (and (=> %%location_label%%3 (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. r!)))) (and (=> %%location_label%%4 (= (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/layer (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. r!))) layer!)) (and (=> %%location_label%%5 (= (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. r!))))) address!)) (and (=> %%location_label%%6 (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_RW (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. r!)))))) (and (=> %%location_label%%7 (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_US (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. r!)))))) (=> %%location_label%%8 (not (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/flag_XD (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. r!)))))))))))))))))))
(check-sat)
(exit)
