...
(set-info :comment ";; MODULE 'module constants'")
(set-info :comment ";; Fuel")
(declare-const fuel%lib!constants.MAX_REPLICAS_PER_LOG. FuelId)
(declare-const fuel%lib!constants.MAX_REPLICAS. FuelId)
(declare-const fuel%lib!constants.DEFAULT_LOG_BYTES. FuelId)
...
(declare-const fuel%lib!constants.RESPONSE_CHECK_INTERVAL. FuelId)
...
(assert (distinct fuel%lib!constants.MAX_REPLICAS_PER_LOG. fuel%lib!constants.MAX_REPLICAS. fuel%lib!constants.DEFAULT_LOG_BYTES. fuel%lib!constants.LOG_SIZE. fuel%lib!constants.MAX_THREADS_PER_REPLICA. fuel%lib!constants.MAX_PENDING_OPS. fuel%lib!constants.MAX_REQUESTS. fuel%lib!constants.RESPONSE_CHECK_INTERVAL. fuel%lib!constants.GC_FROM_HEAD. fuel%lib!constants.WARN_THRESHOLD. fuel%lib!constants.MAX_IDX.))
(set-info :comment ";; Datatypes")
(set-info :comment ";; Function-Decl lib::constants::MAX_REPLICAS_PER_LOG")
(declare-fun lib!constants.MAX_REPLICAS_PER_LOG.? () Int)
(set-info :comment ";; Function-Decl lib::constants::MAX_REPLICAS")
(declare-fun lib!constants.MAX_REPLICAS.? () Int)
(set-info :comment ";; Function-Decl lib::constants::DEFAULT_LOG_BYTES")
(declare-fun lib!constants.DEFAULT_LOG_BYTES.? () Int)
...
(set-info :comment ";; Function-Decl lib::constants::RESPONSE_CHECK_INTERVAL")
(declare-fun lib!constants.RESPONSE_CHECK_INTERVAL.? () Int)
...
(set-info :comment ";; Function-Def lib::constants::MAX_REPLICAS")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:17:1: 17:41 (#0)")
...
(set-info :comment ";; Function-Def lib::constants::LOG_SIZE")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:23:1: 23:45 (#0)")
...
(set-info :comment ";; Function-Def lib::constants::MAX_THREADS_PER_REPLICA")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:27:1: 27:53 (#0)")
...
(set-info :comment ";; Function-Def lib::constants::MAX_IDX")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:54:1: 54:53 (#0)")
...
(set-info :comment ";; Function-Def lib::constants::MAX_PENDING_OPS")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:29:1: 29:43 (#0)")
...
(set-info :comment ";; Function-Def lib::constants::MAX_REQUESTS")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:32:1: 32:80 (#0)")
...
(set-info :comment ";; Function-Def lib::constants::MAX_REPLICAS_PER_LOG")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:14:1: 14:49 (#0)")
(set-info :comment ";; Function-Axioms lib::constants::MAX_REPLICAS_PER_LOG")
(assert (fuel_bool_default fuel%lib!constants.MAX_REPLICAS_PER_LOG.))
(assert (=> (fuel_bool fuel%lib!constants.MAX_REPLICAS_PER_LOG.) (= lib!constants.MAX_REPLICAS_PER_LOG.? 16)))
(assert (uInv SZ lib!constants.MAX_REPLICAS_PER_LOG.?))
(set-info :comment ";; Function-Def lib::constants::DEFAULT_LOG_BYTES")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:20:1: 20:59 (#0)")
...
(assert (not (and (=> %%location_label%%0 (uInv SZ (Mul 2 1024))) (=> %%location_label%%1 (uInv SZ (Mul (uClip SZ (Mul 2 1024)) 1024))))))
(check-sat)
(exit)
