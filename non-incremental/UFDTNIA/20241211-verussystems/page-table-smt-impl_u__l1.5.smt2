...
(assert (not (=> (lib!impl_u.l1.impl&%1.well_formed.? self!) (=> (has_type i@ NAT) (or (and (=> (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!impl_u.l1.NodeEntry. tmp%2 i@)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) i@)) (=> (= tmp%3 (is-lib!impl_u.l1.NodeEntry./Page_ (%Poly%lib!impl_u.l1.NodeEntry. tmp%1))) %%switch_label%%1))))) (=> (not (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))))) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%3 (=> (= tmp%5 (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))) (and (=> %%location_label%%1 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!impl_u.l1.NodeEntry. tmp%5 i@)) (=> (= tmp%4 (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) i@)) (and (=> %%location_label%%2 (req%lib!impl_u.l1.impl&%1.entry_size. self!)) (=> (= tmp%6 (lib!impl_u.l1.impl&%1.entry_size.? self!)) (=> (= tmp%7 (= (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. tmp%4)))))))) tmp%6)) %%switch_label%%0))))))) (=> (not tmp%3) (=> (= tmp%7 true) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
