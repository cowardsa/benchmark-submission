...
(assert (not (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (uClip SZ (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$))) (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$))))) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$)))) (=> (< i@0 8) (=> (= tmp%2 (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!)))) (and (=> %%location_label%%0 (req%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%2 i@0)) (=> (ens%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%2 i@0 tmp%1) (=> (= tmp%4 (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!)))) (and (=> %%location_label%%1 (req%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%4 i@0)) (=> (ens%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%4 i@0 tmp%3) (or (and (=> (not (= (uClip SZ (bitand (I (%I tmp%1)) (I (%I tmp%3)))) 0)) (=> (ens%lib!commit_mask.impl&%0.lemma_view. self!) (=> (ens%lib!commit_mask.impl&%0.lemma_view. other!) (=> (ens%lib!commit_mask.lemma_is_bit_set. 0) (=> (= tmp%5 (uClip SZ (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@0)))) (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) (I i@0))))))) (and (=> %%location_label%%2 (req%lib!commit_mask.lemma_obtain_bit_index_1. tmp%5)) (=> (ens%lib!commit_mask.lemma_obtain_bit_index_1. tmp%5 j@) (=> (= tmp%6 (and (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (I (Add (Mul i@0 64) j@))) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. other!))) (I (Add (Mul i@0 64) j@))))) (and (=> %%location_label%%3 tmp%6) (=> tmp%6 (=> (= res! true) (=> %%location_label%%4 (= res! (not (vstd!set.impl&%0.disjoint.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. other!)))))))))))))))))) (=> (not (not (= (uClip SZ (bitand (I (%I tmp%1)) (I (%I tmp%3)))) 0))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%5 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (=> %%location_label%%6 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (uClip SZ (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$))) (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$))))) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$)))))))))))))))))))
(check-sat)
(exit)
