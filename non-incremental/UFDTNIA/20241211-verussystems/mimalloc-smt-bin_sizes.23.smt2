...
(assert (not (=> (= decrease%init0 e1!) (or (and (=> (= e1! 0) %%switch_label%%0) (=> (not (= e1! 0)) (and (and (=> %%location_label%%0 (= (nClip (Mul (lib!bin_sizes.pow2.? (I e1!)) (lib!bin_sizes.pow2.? (I e2!)))) (nClip (Mul (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e1! 1))) 2)) (lib!bin_sizes.pow2.? (I e2!)))))) (=> (= (nClip (Mul (lib!bin_sizes.pow2.? (I e1!)) (lib!bin_sizes.pow2.? (I e2!)))) (nClip (Mul (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e1! 1))) 2)) (lib!bin_sizes.pow2.? (I e2!))))) (and (=> (= tmp%1 (lib!bin_sizes.pow2.? (I (Sub e1! 1)))) (=> (= tmp%2 (lib!bin_sizes.pow2.? (I e2!))) (=> (ens%lib!bin_sizes.mul_assoc. tmp%1 2 tmp%2) (=> %%location_label%%1 (= (nClip (Mul (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e1! 1))) 2)) (lib!bin_sizes.pow2.? (I e2!)))) (nClip (Mul 2 (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e1! 1))) (lib!bin_sizes.pow2.? (I e2!))))))))))) (=> (= (nClip (Mul (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e1! 1))) 2)) (lib!bin_sizes.pow2.? (I e2!)))) (nClip (Mul 2 (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e1! 1))) (lib!bin_sizes.pow2.? (I e2!))))))) (and (=> (= tmp%3 (nClip (Sub e1! 1))) (and (=> %%location_label%%2 (check_decrease_int (let ((e1!$0 tmp%3) (e2!$1 e2!)) e1!$0) decrease%init0 false)) (=> (ens%lib!bin_sizes.pow2_adds. tmp%3 e2!) (=> %%location_label%%3 (= (nClip (Mul 2 (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e1! 1))) (lib!bin_sizes.pow2.? (I e2!)))))) (nClip (Mul 2 (lib!bin_sizes.pow2.? (I (Add (Sub e1! 1) e2!)))))))))) (=> (= (nClip (Mul 2 (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e1! 1))) (lib!bin_sizes.pow2.? (I e2!)))))) (nClip (Mul 2 (lib!bin_sizes.pow2.? (I (Add (Sub e1! 1) e2!)))))) (and (=> %%location_label%%4 (= (nClip (Mul 2 (lib!bin_sizes.pow2.? (I (Add (Sub e1! 1) e2!))))) (lib!bin_sizes.pow2.? (I (nClip (Add e1! e2!)))))) (=> (= (nClip (Mul 2 (lib!bin_sizes.pow2.? (I (Add (Sub e1! 1) e2!))))) (lib!bin_sizes.pow2.? (I (nClip (Add e1! e2!))))) (=> %%location_label%%5 (= (nClip (Mul (lib!bin_sizes.pow2.? (I e1!)) (lib!bin_sizes.pow2.? (I e2!)))) (lib!bin_sizes.pow2.? (I (nClip (Add e1! e2!)))))))))))))) (=> (= (nClip (Mul (lib!bin_sizes.pow2.? (I e1!)) (lib!bin_sizes.pow2.? (I e2!)))) (lib!bin_sizes.pow2.? (I (nClip (Add e1! e2!))))) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%6 (= (nClip (Mul (lib!bin_sizes.pow2.? (I e1!)) (lib!bin_sizes.pow2.? (I e2!)))) (lib!bin_sizes.pow2.? (I (nClip (Add e1! e2!)))))))))))
(check-sat)
(exit)
