...
(set-info :comment ";; Function-Specs lib::verus_extra::seq_lib_v::lemma_filter_skip_rejected")
...
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_filter_skip_rejected")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:195:1: 195:88 (#0)")
(declare-const A&. Dcr)
