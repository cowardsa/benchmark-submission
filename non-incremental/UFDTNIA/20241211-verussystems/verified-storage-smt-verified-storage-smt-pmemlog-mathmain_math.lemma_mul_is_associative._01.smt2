...
(set-info :comment ";; src/math.rs:27:5: 27:66 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_is_associative")
(set-info :comment ";; src/math.rs:27:5: 27:66 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (not (=> %%location_label%%0 (= (Mul x! (Mul y! z!)) (Mul (Mul x! y!) z!)))))
(check-sat)
(exit)
