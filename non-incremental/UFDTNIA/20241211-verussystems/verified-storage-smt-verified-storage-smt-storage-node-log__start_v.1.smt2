...
(set-info :comment ";; MODULE 'module log::start_v'")
...
(set-info :comment ";; Function-Decl lib::pmem::subregion_v::PersistentMemorySubregion::start")
(declare-fun lib!pmem.subregion_v.impl&%1.start.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::pmem::subregion_v::PersistentMemorySubregion::len")
(declare-fun lib!pmem.subregion_v.impl&%1.len.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::pmem::subregion_v::PersistentMemorySubregion::view")
...
(set-info :comment ";; Function-Axioms lib::pmem::subregion_v::PersistentMemorySubregion::start")
...
(set-info :comment ";; Function-Axioms lib::pmem::subregion_v::PersistentMemorySubregion::len")
...
(set-info :comment ";; Function-Def lib::log::start_v::read_cdb")
(set-info :comment ";; src/log/start_v.rs:39:5: 39:109 (#0)")
...
(declare-const verus_tmp_log_cdb_addrs@ vstd!seq.Seq<int.>.)
(declare-const verus_tmp_true_cdb_bytes@ vstd!seq.Seq<u8.>.)
...
(declare-const verus_tmp$1@0 vstd!seq.Seq<int.>.)
(declare-const log_cdb_addrs@0 vstd!seq.Seq<int.>.)
(declare-const verus_tmp$2@0 vstd!seq.Seq<u8.>.)
(declare-const true_cdb_bytes@0 vstd!seq.Seq<u8.>.)
(declare-const log_cdb@ lib!pmem.pmcopy_t.MaybeCorruptedBytes<u64.>.)
(declare-const result@ core!option.Option.)
...
(assert (is-core!option.Option./Some_ (lib!log.layout_v.recover_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!))))))
...
(assert (forall ((%%hole%%0 Int) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%6 %%hole%%0) i$) (I (Add %%hole%%0 (%I i$)))) :pattern ((%%apply%%0 (%%lambda%%6 %%hole%%0) i$)))))
(declare-const verus_tmp@1 vstd!seq.Seq<u8.>.)
(declare-const mem@1 vstd!seq.Seq<u8.>.)
(declare-const verus_tmp$1@1 vstd!seq.Seq<int.>.)
(declare-const log_cdb_addrs@1 vstd!seq.Seq<int.>.)
(declare-const verus_tmp$2@1 vstd!seq.Seq<u8.>.)
(declare-const true_cdb_bytes@1 vstd!seq.Seq<u8.>.)
...
(assert (not (=> (= verus_tmp@1 (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!))) (=> (= verus_tmp_mem@ verus_tmp@1) (=> (= mem@1 verus_tmp_mem@) (=> (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)) (Poly%fun%1. (mk_fun (%%lambda%%6 lib!log.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?)))))) (=> (= verus_tmp_log_cdb_addrs@ verus_tmp$1@1) (=> (= log_cdb_addrs@1 verus_tmp_log_cdb_addrs@) (=> (= verus_tmp$2@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem@1) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (I (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_CDB.? (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))) (=> (= verus_tmp_true_cdb_bytes@ verus_tmp$2@1) (=> (= true_cdb_bytes@1 verus_tmp_true_cdb_bytes@) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. true_cdb_bytes@1) (vstd!seq.Seq.new.? $ (UINT 8) $ (TYPE%fun%1. $ INT $ (UINT 8)) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)) (Poly%fun%1. (mk_fun (%%lambda%%5 $ INT (Poly%vstd!seq.Seq<int.>. log_cdb_addrs@1) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem@1))))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%3 (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?)) (and (=> %%location_label%%1 (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.read_aligned. PMRegion&. PMRegion& $ (UINT 64) pm_region! tmp%3)) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegion.read_aligned. PMRegion&. PMRegion& $ (UINT 64) pm_region! tmp%3 tmp%2) (=> (= tmp%%@ (%Poly%core!result.Result. tmp%2)) (or (and (=> (is-core!result.Result./Ok_ tmp%%@) %%switch_label%%0) (=> (not (is-core!result.Result./Ok_ tmp%%@)) (=> (= e@ (%Poly%lib!pmem.pmemspec_t.PmemError. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@))))) (=> (= result! (core!result.Result./Err (Poly%lib!log.logimpl_t.LogErr. (lib!log.logimpl_t.LogErr./PmemErr (%Poly%lib!pmem.pmemspec_t.PmemError. (Poly%lib!pmem.pmemspec_t.PmemError. e@)))))) (=> %%location_label%%2 (ite (is-core!result.Result./Ok_ result!) (let ((b$ (%B (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= (core!option.Option./Some (B b$)) (lib!log.layout_v.recover_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!)))))) (ite (and (is-core!result.Result./Err_ result!) (is-lib!log.logimpl_t.LogErr./CRCMismatch_ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? PMRegion&. PMRegion& pm_region!)))) (let ((e$ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= e$ (lib!log.logimpl_t.LogErr./PmemErr (%Poly%lib!pmem.pmemspec_t.PmemError. (Poly%lib!pmem.pmemspec_t.PmemError. lib!pmem.pmemspec_t.PmemError./AccessOutOfRange)))))))))))) (and (not %%switch_label%%0) (=> (= log_cdb@ (let ((log_cdb$1 (%Poly%lib!pmem.pmcopy_t.MaybeCorruptedBytes<u64.>. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@)))))) log_cdb$1)) (=> (= tmp%4 (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? PMRegion&. PMRegion& pm_region!)))) (and (=> %%location_label%%3 (req%lib!pmem.pmemutil_v.check_cdb. log_cdb@ mem@1 tmp%4 log_cdb_addrs@1)) (=> (ens%lib!pmem.pmemutil_v.check_cdb. log_cdb@ mem@1 tmp%4 log_cdb_addrs@1 result@) (=> (= result! (ite (is-core!option.Option./Some_ result@) (let ((b$ (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. result@)))))) (core!result.Result./Ok (B b$))) (core!result.Result./Err (Poly%lib!log.logimpl_t.LogErr. lib!log.logimpl_t.LogErr./CRCMismatch)))) (=> %%location_label%%4 (ite (is-core!result.Result./Ok_ result!) (let ((b$ (%B (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= (core!option.Option./Some (B b$)) (lib!log.layout_v.recover_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!)))))) (ite (and (is-core!result.Result./Err_ result!) (is-lib!log.logimpl_t.LogErr./CRCMismatch_ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? PMRegion&. PMRegion& pm_region!)))) (let ((e$ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= e$ (lib!log.logimpl_t.LogErr./PmemErr (%Poly%lib!pmem.pmemspec_t.PmemError. (Poly%lib!pmem.pmemspec_t.PmemError. lib!pmem.pmemspec_t.PmemError./AccessOutOfRange)))))))))))))))))))))))))))))))))
(check-sat)
(exit)
