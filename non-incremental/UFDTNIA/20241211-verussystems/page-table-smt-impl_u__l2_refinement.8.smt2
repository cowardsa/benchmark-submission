...
(set-info :comment ";; Function-Specs lib::impl_u::l2_impl::PT::unmap")
(declare-fun req%lib!impl_u.l2_impl.PT.unmap. (lib!spec_t.mem.PageTableMemory. lib!impl_u.l2_impl.PTDir. Int) Bool)
...
(assert (forall ((pre%mem! lib!spec_t.mem.PageTableMemory.) (pre%pt! lib!impl_u.l2_impl.PTDir.) (vaddr! Int)) (! (= (req%lib!impl_u.l2_impl.PT.unmap. pre%mem! pre%pt! vaddr!) (and (=> %%global_location_label%%86 (lib!impl_u.l2_impl.PT.inv.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))) (=> %%global_location_label%%87 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))))) (=> %%global_location_label%%88 (lib!spec_t.mem.impl&%1.inv.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!))) (=> %%global_location_label%%89 (lib!impl_u.l1.impl&%1.accepted_unmap.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))) (I vaddr!))) (=> %%global_location_label%%90 (< vaddr! lib!definitions_t.MAX_BASE.?)))) :pattern ((req%lib!impl_u.l2_impl.PT.unmap. pre%mem! pre%pt! vaddr!)))))
(declare-fun ens%lib!impl_u.l2_impl.PT.unmap. (lib!spec_t.mem.PageTableMemory. lib!spec_t.mem.PageTableMemory. lib!impl_u.l2_impl.PTDir. lib!impl_u.l2_impl.PTDir. Int core!result.Result.) Bool)
(assert (forall ((pre%mem! lib!spec_t.mem.PageTableMemory.) (mem! lib!spec_t.mem.PageTableMemory.) (pre%pt! lib!impl_u.l2_impl.PTDir.) (pt! lib!impl_u.l2_impl.PTDir.) (vaddr! Int) (res! core!result.Result.)) (! (= (ens%lib!impl_u.l2_impl.PT.unmap. pre%mem! mem! pre%pt! pt! vaddr! res!) (and (has_type (Poly%core!result.Result. res!) (TYPE%core!result.Result. $ TYPE%tuple%0. $ TYPE%tuple%0.)) (has_type (Poly%lib!impl_u.l2_impl.PTDir. pt!) TYPE%lib!impl_u.l2_impl.PTDir.) (lib!impl_u.l2_impl.PT.inv.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) (ite (is-core!result.Result./Ok_ res!) (= (core!result.Result./Ok (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)))))) (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))))) (I vaddr!))) (= (core!result.Result./Err (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!)))))) (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. pre%mem!) (Poly%lib!impl_u.l2_impl.PTDir. pre%pt!))))) (I vaddr!)))))) :pattern ((ens%lib!impl_u.l2_impl.PT.unmap. pre%mem! mem! pre%pt! pt! vaddr! res!)))))
(set-info :comment ";; Function-Def lib::spec_t::impl_spec::PageTableImpl::ispec_unmap")
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:588:5: 588:95 (#0)")
(set-info :comment ";; Function-Specs lib::impl_u::l2_impl::PT::resolve")
(declare-fun req%lib!impl_u.l2_impl.PT.resolve. (lib!spec_t.mem.PageTableMemory. lib!impl_u.l2_impl.PTDir. Int) Bool)
...
(assert (forall ((mem! lib!spec_t.mem.PageTableMemory.) (pt! lib!impl_u.l2_impl.PTDir.) (vaddr! Int)) (! (= (req%lib!impl_u.l2_impl.PT.resolve. mem! pt! vaddr!) (and (=> %%global_location_label%%91 (lib!impl_u.l2_impl.PT.inv.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))) (=> %%global_location_label%%92 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))) (=> %%global_location_label%%93 (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))) (I vaddr!))) (=> %%global_location_label%%94 (< vaddr! lib!definitions_t.MAX_BASE.?)))) :pattern ((req%lib!impl_u.l2_impl.PT.resolve. mem! pt! vaddr!)))))
(declare-fun ens%lib!impl_u.l2_impl.PT.resolve. (lib!spec_t.mem.PageTableMemory. lib!impl_u.l2_impl.PTDir. Int core!result.Result.) Bool)
(assert (forall ((mem! lib!spec_t.mem.PageTableMemory.) (pt! lib!impl_u.l2_impl.PTDir.) (vaddr! Int) (res! core!result.Result.)) (! (= (ens%lib!impl_u.l2_impl.PT.resolve. mem! pt! vaddr! res!) (and (has_type (Poly%core!result.Result. res!) (TYPE%core!result.Result. $ (TYPE%tuple%2. $ (UINT SZ) $ TYPE%lib!definitions_t.PageTableEntryExec.) $ TYPE%tuple%0.)) (= (lib!extra.result_map_ok.? $ (TYPE%tuple%2. $ (UINT SZ) $ TYPE%lib!definitions_t.PageTableEntryExec.) $ TYPE%tuple%0. $ (TYPE%tuple%2. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (Poly%core!result.Result. res!) (Poly%fun%1. (mk_fun %%lambda%%3))) (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))) (I vaddr!))) (= (lib!extra.result_map_ok.? $ (TYPE%tuple%2. $ (UINT SZ) $ TYPE%lib!definitions_t.PageTableEntryExec.) $ TYPE%tuple%0. $ (TYPE%tuple%2. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (Poly%core!result.Result. res!) (Poly%fun%1. (mk_fun %%lambda%%3))) (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!))))) (I vaddr!))))) :pattern ((ens%lib!impl_u.l2_impl.PT.resolve. mem! pt! vaddr! res!)))))
(set-info :comment ";; Function-Def lib::spec_t::impl_spec::PageTableImpl::ispec_resolve")
(set-info :comment ";; page-table/impl_u/l2_refinement.rs:599:5: 599:118 (#0)")
...
(assert (lib!impl_u.spec_pt.step_Resolve_enabled.? vaddr!))
(assert (%B (lib!spec_t.impl_spec.InterfaceSpec.ispec_inv.? $ TYPE%lib!spec_t.impl_spec.PageTableImpl. self! mem!)))
(declare-fun %%choose%%4 (Type Poly Poly Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Poly)) (! (=> (exists ((pt$1 Poly)) (! (and (has_type pt$1 %%hole%%0) (and (lib!impl_u.l2_impl.PT.inv.? %%hole%%1 pt$1) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? %%hole%%2 pt$1))))) :pattern ((lib!impl_u.l2_impl.PT.inv.? %%hole%%3 pt$1)))) (exists ((pt$1 Poly)) (! (and (and (has_type pt$1 %%hole%%0) (and (lib!impl_u.l2_impl.PT.inv.? %%hole%%1 pt$1) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? %%hole%%2 pt$1))))) (= (%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) pt$1)) :pattern ((lib!impl_u.l2_impl.PT.inv.? %%hole%%3 pt$1))))) :pattern ((%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3)))))
...
(assert (not (=> (= pt@ (%Poly%lib!impl_u.l2_impl.PTDir. (as_type (%%choose%%4 TYPE%lib!impl_u.l2_impl.PTDir. mem! mem! mem!) TYPE%lib!impl_u.l2_impl.PTDir.))) (=> (= tmp%1 (lib!definitions_t.MemRegionExec./MemRegionExec/base (%Poly%lib!definitions_t.MemRegionExec. (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? mem!))))) (and (=> %%location_label%%0 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. (%Poly%lib!spec_t.mem.PageTableMemory. mem!) pt@ 0 tmp%1 0)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_facts. (%Poly%lib!spec_t.mem.PageTableMemory. mem!) pt@ 0 tmp%1 0) (=> (= tmp%2 (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@))) (and (=> %%location_label%%1 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%2)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. tmp%2) (=> (= (lib!definitions_t.impl&%8.upper_vaddr.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I 0) (I 0)) lib!definitions_t.PT_BOUND_HIGH.?) (=> (ens%lib!impl_u.l2_refinement.lemma_page_table_walk_interp. 0) (and (=> %%location_label%%2 (req%lib!impl_u.l2_impl.PT.resolve. (%Poly%lib!spec_t.mem.PageTableMemory. mem!) pt@ (%I vaddr!))) (=> (ens%lib!impl_u.l2_impl.PT.resolve. (%Poly%lib!spec_t.mem.PageTableMemory. mem!) pt@ (%I vaddr!) tmp%%@) (=> (= %return! (Poly%core!result.Result. (ite (and (is-core!result.Result./Ok_ tmp%%@) (is-tuple%2./tuple%2_ (%Poly%tuple%2. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@)))))) (let ((v$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@)))))))) (let ((pte$ (%Poly%lib!definitions_t.PageTableEntryExec. (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@)))))))) (core!result.Result./Ok (Poly%tuple%2. (tuple%2./tuple%2 (I v$) (Poly%lib!definitions_t.PageTableEntryExec. pte$)))))) (let ((e$ (%Poly%tuple%0. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@)))))) (core!result.Result./Err (Poly%tuple%0. e$)))))) (=> %%location_label%%3 (lib!impl_u.spec_pt.step_Resolve.? (Poly%lib!impl_u.spec_pt.PageTableVariables. (lib!spec_t.impl_spec.pt_vars.? mem!)) (Poly%lib!impl_u.spec_pt.PageTableVariables. (lib!spec_t.impl_spec.pt_vars.? mem!)) vaddr! (Poly%core!result.Result. (lib!extra.result_map_ok.? $ (TYPE%tuple%2. $ (UINT SZ) $ TYPE%lib!definitions_t.PageTableEntryExec.) $ TYPE%tuple%0. $ (TYPE%tuple%2. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) %return! (Poly%fun%1. (mk_fun %%lambda%%3))))))))))))))))))))
(check-sat)
(exit)
