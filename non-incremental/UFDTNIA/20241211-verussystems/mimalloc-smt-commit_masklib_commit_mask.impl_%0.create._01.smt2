...
(set-info :comment ";; commit_mask.rs:436:17: 436:23 (#0)")
...
(assert (not (=> (< (Add idx! (Sub count! bitcount@0)) 512) (=> (= i$1@0 (EucDiv (Add idx! (Sub count! bitcount@0)) 64)) (=> %%location_label%%0 (< i$1@0 8))))))
(check-sat)
(exit)
