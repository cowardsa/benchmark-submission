...
(assert (not (and (=> %%location_label%%0 (req%main!math.lemma_mod_range. x! n!)) (=> (ens%main!math.lemma_mod_range. x! n!) (and (=> %%location_label%%1 (req%main!math.lemma_fundamental_div_mod. x! n!)) (=> (ens%main!math.lemma_fundamental_div_mod. x! n!) (=> (= tmp%1 (Add x! n!)) (and (=> %%location_label%%2 (req%main!math.lemma_fundamental_div_mod. tmp%1 n!)) (=> (ens%main!math.lemma_fundamental_div_mod. tmp%1 n!) (=> (= tmp%2 (Sub x! n!)) (and (=> %%location_label%%3 (req%main!math.lemma_fundamental_div_mod. tmp%2 n!)) (=> (ens%main!math.lemma_fundamental_div_mod. tmp%2 n!) (and (=> %%location_label%%4 (req%main!math.lemma_mod_range. x! n!)) (=> (ens%main!math.lemma_mod_range. x! n!) (=> (= tmp%3 (Add x! n!)) (and (=> %%location_label%%5 (req%main!math.lemma_mod_range. tmp%3 n!)) (=> (ens%main!math.lemma_mod_range. tmp%3 n!) (=> (= tmp%4 (Sub x! n!)) (and (=> %%location_label%%6 (req%main!math.lemma_mod_range. tmp%4 n!)) (=> (ens%main!math.lemma_mod_range. tmp%4 n!) (=> (= zp@ (Sub (Sub (EucDiv (Add x! n!) n!) (EucDiv x! n!)) 1)) (=> (= zm@ (Add (Sub (EucDiv (Sub x! n!) n!) (EucDiv x! n!)) 1)) (=> (= tmp%5 (EucDiv (Add x! n!) n!)) (=> (= tmp%6 (Add (EucDiv x! n!) 1)) (=> (ens%main!math.lemma_mul_is_distributive_sub. n! tmp%5 tmp%6) (=> (= tmp%7 (EucDiv x! n!)) (=> (ens%main!math.lemma_mul_is_distributive_add. n! tmp%7 1) (=> (= tmp%8 (= (Mul n! zp@) (Sub (Sub (Mul n! (EucDiv (Add x! n!) n!)) (Mul n! (EucDiv x! n!))) (Mul n! 1)))) (and (=> %%location_label%%7 tmp%8) (=> tmp%8 (=> (= tmp%9 (= 0 (Sub (Add (Mul n! zp@) (EucMod (Add x! n!) n!)) (EucMod x! n!)))) (and (=> %%location_label%%8 tmp%9) (=> tmp%9 (=> (= tmp%10 (EucDiv (Sub x! n!) n!)) (=> (= tmp%11 (Sub (EucDiv x! n!) 1)) (=> (ens%main!math.lemma_mul_is_distributive_sub. n! tmp%10 tmp%11) (=> (= tmp%12 (EucDiv x! n!)) (=> (ens%main!math.lemma_mul_is_distributive_sub. n! tmp%12 1) (=> (= tmp%13 (= (Mul n! zm@) (Add (Sub (Mul n! (EucDiv (Sub x! n!) n!)) (Mul n! (EucDiv x! n!))) (Mul n! 1)))) (and (=> %%location_label%%9 tmp%13) (=> tmp%13 (=> (= tmp%14 (= 0 (Sub (Add (Mul n! zm@) (EucMod (Sub x! n!) n!)) (EucMod x! n!)))) (and (=> %%location_label%%10 tmp%14) (=> tmp%14 (or (and (=> (> zp@ 0) (and (=> %%location_label%%11 (req%main!math.lemma_mul_inequality. 1 zp@ n!)) (=> (ens%main!math.lemma_mul_inequality. 1 zp@ n!) %%switch_label%%5))) (=> (not (> zp@ 0)) %%switch_label%%5)) (and (not %%switch_label%%5) (or (and (=> (< zp@ 0) (=> (= tmp%15 (Sub 0 1)) (and (=> %%location_label%%12 (req%main!math.lemma_mul_inequality. zp@ tmp%15 n!)) (=> (ens%main!math.lemma_mul_inequality. zp@ tmp%15 n!) %%switch_label%%4)))) (=> (not (< zp@ 0)) %%switch_label%%4)) (and (not %%switch_label%%4) (or (and (=> (= zp@ 0) (=> (ens%main!math.lemma_mul_by_zero_is_zero. n!) %%switch_label%%3)) (=> (not (= zp@ 0)) %%switch_label%%3)) (and (not %%switch_label%%3) (or (and (=> (> zm@ 0) (and (=> %%location_label%%13 (req%main!math.lemma_mul_inequality. 1 zm@ n!)) (=> (ens%main!math.lemma_mul_inequality. 1 zm@ n!) %%switch_label%%2))) (=> (not (> zm@ 0)) %%switch_label%%2)) (and (not %%switch_label%%2) (or (and (=> (< zm@ 0) (=> (= tmp%16 (Sub 0 1)) (and (=> %%location_label%%14 (req%main!math.lemma_mul_inequality. zm@ tmp%16 n!)) (=> (ens%main!math.lemma_mul_inequality. zm@ tmp%16 n!) %%switch_label%%1)))) (=> (not (< zm@ 0)) %%switch_label%%1)) (and (not %%switch_label%%1) (or (and (=> (and (<= 0 x!) (< x! n!)) (and (=> %%location_label%%15 (req%main!math.lemma_small_div. x! n!)) (=> (ens%main!math.lemma_small_div. x! n!) %%switch_label%%0))) (=> (not (and (<= 0 x!) (< x! n!))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%16 (= (EucMod (Add x! n!) n!) (EucMod x! n!))) (and (=> %%location_label%%17 (= (EucMod (Sub x! n!) n!) (EucMod x! n!))) (and (=> %%location_label%%18 (= (EucDiv (Add x! n!) n!) (Add (EucDiv x! n!) 1))) (and (=> %%location_label%%19 (= (EucDiv (Sub x! n!) n!) (Sub (EucDiv x! n!) 1))) (=> %%location_label%%20 (= (and (<= 0 x!) (< x! n!)) (= (EucMod x! n!) x!)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
