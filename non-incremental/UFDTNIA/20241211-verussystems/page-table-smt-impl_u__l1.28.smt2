...
(declare-const new_dir@ lib!impl_u.l1.Directory.)
...
(assert (not (=> (= decrease%init0 (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)))) (=> (ens%lib!impl_u.l0.ambient_lemmas1. 0) (=> (ens%lib!impl_u.l1.ambient_lemmas2. 0) (=> (ens%lib!impl_u.l1.impl&%1.lemma_accepted_mapping_implies_interp_accepted_mapping_auto. (%Poly%lib!impl_u.l1.Directory. self!)) (or (and (=> (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l1.impl&%1.accepted_mapping.? self! base! pte!)) (=> (= tmp%7 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. self!))) (=> (= tmp%8 (lib!impl_u.l1.impl&%1.entry_size.? self!)) (=> (= tmp%9 (lib!impl_u.l1.impl&%1.num_entries.? self!)) (=> (ens%lib!impl_u.indexing.lemma_index_from_base_and_addr. tmp%7 (%I base!) tmp%8 tmp%9) %%switch_label%%5))))) (=> (not (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l1.impl&%1.accepted_mapping.? self! base! pte!))) %%switch_label%%5)) (and (not %%switch_label%%5) (or (and (=> (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l1.impl&%1.accepted_mapping.? self! base! pte!)) (=> (= entry@ (lib!impl_u.l1.impl&%1.index_for_vaddr.? self! base!)) (=> (= tmp%%@ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) (I entry@)))) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@) (=> (= tmp%5 (let ((p$ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@))))) (core!result.Result./Err self!))) %%switch_label%%1)) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@)) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@) (=> (= d@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@)))) (or (and (=> (= (lib!impl_u.l1.impl&%1.entry_size.? self!) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte!)))))) (=> (= tmp%1 (core!result.Result./Err self!)) %%switch_label%%3)) (=> (not (= (lib!impl_u.l1.impl&%1.entry_size.? self!) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte!))))))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 d@) (base!$1 (%I base!)) (pte!$2 (%Poly%lib!definitions_t.PageTableEntry. pte!))) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 false)) (=> (has_type (Poly%core!result.Result. tmp%%$1@) (TYPE%core!result.Result. $ TYPE%lib!impl_u.l1.Directory. $ TYPE%lib!impl_u.l1.Directory.)) (=> (= tmp%1 (ite (is-core!result.Result./Ok_ tmp%%$1@) (let ((d$1 (%Poly%lib!impl_u.l1.Directory. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%$1@)))))) (core!result.Result./Ok (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.impl&%1.update.? self! (I entry@) (Poly%lib!impl_u.l1.NodeEntry. (lib!impl_u.l1.NodeEntry./Directory (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. d$1)))))))) (let ((d$2 (%Poly%lib!impl_u.l1.Directory. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%$1@)))))) (core!result.Result./Err (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.impl&%1.update.? self! (I entry@) (Poly%lib!impl_u.l1.NodeEntry. (lib!impl_u.l1.NodeEntry./Directory (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. d$2)))))))))) %%switch_label%%3))))) (and (not %%switch_label%%3) (=> (= tmp%4 tmp%1) %%switch_label%%2))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@)) (or (and (=> (= (lib!impl_u.l1.impl&%1.entry_size.? self!) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte!)))))) (=> (= tmp%3 (core!result.Result./Ok (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.impl&%1.update.? self! (I entry@) (Poly%lib!impl_u.l1.NodeEntry. (lib!impl_u.l1.NodeEntry./Page (%Poly%lib!definitions_t.PageTableEntry. pte!))))))) %%switch_label%%4)) (=> (not (= (lib!impl_u.l1.impl&%1.entry_size.? self!) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte!))))))) (=> (= new_dir@ (lib!impl_u.l1.impl&%1.new_empty_dir.? self! (I entry@))) (and (=> %%location_label%%1 (check_decrease_int (let ((self!$0 new_dir@) (base!$1 (%I base!)) (pte!$2 (%Poly%lib!definitions_t.PageTableEntry. pte!))) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 false)) (=> (has_type (Poly%core!result.Result. tmp%2) (TYPE%core!result.Result. $ TYPE%lib!impl_u.l1.Directory. $ TYPE%lib!impl_u.l1.Directory.)) (=> (= tmp%2 (lib!impl_u.l1.impl&%1.map_frame.? (Poly%lib!impl_u.l1.Directory. new_dir@) base! pte!)) (=> (= tmp%3 (core!result.Result./Ok (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.impl&%1.update.? self! (I entry@) (Poly%lib!impl_u.l1.NodeEntry. (lib!impl_u.l1.NodeEntry./Directory (%Poly%lib!impl_u.l1.Directory. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%2)))))))))) %%switch_label%%4))))))) (and (not %%switch_label%%4) (=> (= tmp%4 tmp%3) %%switch_label%%2))))) (and (not %%switch_label%%2) (=> (= tmp%5 tmp%4) %%switch_label%%1))))) (and (not %%switch_label%%1) (=> (= tmp%6 tmp%5) %%switch_label%%0)))))) (=> (not (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l1.impl&%1.accepted_mapping.? self! base! pte!))) (=> (= tmp%6 (%Poly%core!result.Result. (vstd!pervasive.arbitrary.? $ (TYPE%core!result.Result. $ TYPE%lib!impl_u.l1.Directory. $ TYPE%lib!impl_u.l1.Directory.)))) %%switch_label%%0))) (not %%switch_label%%0))))))))))
(check-sat)
(exit)
