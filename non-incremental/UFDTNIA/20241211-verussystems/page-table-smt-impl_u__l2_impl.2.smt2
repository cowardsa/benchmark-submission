...
(assert (not (=> (= r! (= (uClip 64 (bitand (I (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/entry (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (I lib!spec_t.hardware.MASK_FLAG_P.?))) lib!spec_t.hardware.MASK_FLAG_P.?)) (=> %%location_label%%0 (= r! (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Empty_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))))))))
(check-sat)
(exit)
