...
(assert (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)))))
(assert (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))))
...
(assert (not (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8))) (Poly%vstd!seq.Seq<u8.>. crc_bytes!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (and (=> %%location_label%%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8))) (Poly%vstd!seq.Seq<u8.>. crc_bytes!))) (and (=> %%location_label%%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))) (=> %%location_label%%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8))) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?))))))))))))))))
(check-sat)
(exit)
