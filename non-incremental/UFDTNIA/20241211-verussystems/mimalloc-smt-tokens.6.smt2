...
(assert (forall ((s! vstd!set.Set<lib!tokens.SegmentId.>.)) (! (= (req%lib!tokens.lemma_segment_get_unused_uniq_field. s!) (=> %%global_location_label%%11 (vstd!set.impl&%0.finite.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)))) :pattern ((req%lib!tokens.lemma_segment_get_unused_uniq_field. s!)))))
...
(set-info :comment ";; Function-Def lib::tokens::lemma_segment_get_unused_uniq_field")
(set-info :comment ";; tokens.rs:238:1: 238:68 (#0)")
...
(assert (not (and (=> %%location_label%%0 (req%lib!tokens.segment_u_max_not_in. s!)) (=> (ens%lib!tokens.segment_u_max_not_in. s!) (=> %%location_label%%1 (forall ((id$ Poly)) (! (=> (has_type id$ TYPE%lib!tokens.SegmentId.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!) id$) (not (= (lib!tokens.SegmentId./SegmentId/uniq (%Poly%lib!tokens.SegmentId. id$)) (lib!tokens.segment_get_unused_uniq_field.? (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)))))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!) id$)))))))))
(check-sat)
(exit)
