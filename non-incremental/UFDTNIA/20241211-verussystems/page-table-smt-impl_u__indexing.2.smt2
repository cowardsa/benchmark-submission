...
(set-info :comment ";; Function-Def lib::impl_u::indexing::lemma_entry_base_from_index")
(set-info :comment ";; page-table/impl_u/indexing.rs:48:1: 48:79 (#0)")
...
(set-info :comment ";; Function-Def lib::impl_u::indexing::lemma_entry_base_from_index_support")
(set-info :comment ";; page-table/impl_u/indexing.rs:24:1: 24:87 (#0)")
...
(assert (not (and (=> %%location_label%%0 true) (=> (forall ((a$ Int) (b$ Int)) (! (=> (and (<= 0 a$) (<= 0 b$)) (= (lib!impl_u.indexing.nat_mul.? (I a$) (I b$)) (nClip (Mul a$ b$)))) :pattern ((nClip (Mul a$ b$))))) (and (=> %%location_label%%1 true) (=> (forall ((a$ Poly) (b$ Poly)) (! (=> (and (has_type a$ NAT) (has_type b$ NAT)) (= (lib!impl_u.indexing.nat_mul.? a$ b$) (lib!impl_u.indexing.nat_mul.? b$ a$))) :pattern ((lib!impl_u.indexing.nat_mul.? a$ b$)) :pattern ((lib!impl_u.indexing.nat_mul.? b$ a$)))) (and (=> (has_type a@ NAT) (=> (and (lib!definitions_t.aligned.? (I base!) (I (lib!impl_u.indexing.nat_mul.? (I entry_size!) a@))) (> (%I a@) 0)) (and (=> %%location_label%%2 (req%lib!extra.mod_mult_zero_implies_mod_zero. base! entry_size! (%I a@))) (=> (ens%lib!extra.mod_mult_zero_implies_mod_zero. base! entry_size! (%I a@)) (=> %%location_label%%3 (lib!definitions_t.aligned.? (I base!) (I entry_size!))))))) (=> (forall ((a$ Poly)) (! (=> (has_type a$ NAT) (=> (and (lib!definitions_t.aligned.? (I base!) (I (lib!impl_u.indexing.nat_mul.? (I entry_size!) a$))) (> (%I a$) 0)) (lib!definitions_t.aligned.? (I base!) (I entry_size!)))) :pattern ((lib!definitions_t.aligned.? (I base!) (I (lib!impl_u.indexing.nat_mul.? (I entry_size!) a$)))))) (and (=> %%location_label%%4 (forall ((a$ Int) (b$ Int)) (! (=> (and (<= 0 a$) (<= 0 b$)) (= (lib!impl_u.indexing.nat_mul.? (I a$) (I b$)) (nClip (Mul a$ b$)))) :pattern ((nClip (Mul a$ b$)))))) (and (=> %%location_label%%5 (forall ((a$ Poly) (b$ Poly)) (! (=> (and (has_type a$ NAT) (has_type b$ NAT)) (= (lib!impl_u.indexing.nat_mul.? a$ b$) (lib!impl_u.indexing.nat_mul.? b$ a$))) :pattern ((lib!impl_u.indexing.nat_mul.? a$ b$)) :pattern ((lib!impl_u.indexing.nat_mul.? b$ a$))))) (=> %%location_label%%6 (forall ((a$ Poly)) (! (=> (has_type a$ NAT) (=> (and (lib!definitions_t.aligned.? (I base!) (I (lib!impl_u.indexing.nat_mul.? (I entry_size!) a$))) (> (%I a$) 0)) (lib!definitions_t.aligned.? (I base!) (I entry_size!)))) :pattern ((lib!definitions_t.aligned.? (I base!) (I (lib!impl_u.indexing.nat_mul.? (I entry_size!) a$)))))))))))))))))
(check-sat)
(exit)
