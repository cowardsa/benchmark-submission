...
(assert (= (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/entry (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))) 0))
(assert (<= (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/layer (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))) 3))
...
(assert (not (and (=> %%location_label%%0 true) (=> (forall ((a$ Poly)) (! (=> (has_type a$ (UINT 64)) (= (uClip 64 (bitand (I 0) (I (%I a$)))) 0)) :pattern ((uClip 64 (bitand (I 0) (I (%I a$))))))) (=> (fuel_bool fuel%lib!spec_t.hardware.impl&%3.all_mb0_bits_are_zero.) (and (=> %%location_label%%1 true) (=> (= (uClip 64 (bitshl (I 1) (I 0))) 1) (and (=> %%location_label%%2 true) (=> (= (uClip 64 (bitand (I 0) (I 1))) 0) (and (=> %%location_label%%3 (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Empty_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (=> %%location_label%%4 (lib!spec_t.hardware.impl&%3.all_mb0_bits_are_zero.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))))))))))))
(check-sat)
(exit)
