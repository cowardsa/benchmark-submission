...
(assert (uInv 64 x!))
(assert (uInv 64 shift!))
(assert (and (<= 0 shift!) (< shift! 64)))
...
(assert (not (=> (= decrease%init0 shift!) (or (and (=> (= shift! 0) (and (=> %%location_label%%0 true) (=> (= (uClip 64 (bitshr (I x!) (I 0))) x!) (=> (= (lib!bin_sizes.pow2.? (I 0)) 1) %%switch_label%%0)))) (=> (not (= shift! 0)) (and (=> %%location_label%%1 (and (< 0 shift!) (< shift! 64))) (=> (= (uClip 64 (bitshr (I x!) (I shift!))) (uClip 64 (EucDiv (uClip 64 (bitshr (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) 2))) (and (=> (= tmp%1 (nClip (Sub shift! 1))) (=> (ens%lib!bin_sizes.pow2_adds. tmp%1 1) (=> %%location_label%%2 (= (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I shift!)))) (nClip (EucDiv x! (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub shift! 1))) (lib!bin_sizes.pow2.? (I 1)))))))))) (=> (= (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I shift!)))) (nClip (EucDiv x! (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub shift! 1))) (lib!bin_sizes.pow2.? (I 1))))))) (and (=> (= tmp%2 (Sub shift! 1)) (=> (ens%lib!bin_sizes.pow2_positive. tmp%2) (=> (= tmp%3 (lib!bin_sizes.pow2.? (I (Sub shift! 1)))) (and (=> %%location_label%%3 (req%lib!bin_sizes.div2. x! tmp%3)) (=> (ens%lib!bin_sizes.div2. x! tmp%3) (=> %%location_label%%4 (= (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I shift!)))) (nClip (EucDiv (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I (Sub shift! 1))))) 2))))))))) (=> (= (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I shift!)))) (nClip (EucDiv (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I (Sub shift! 1))))) 2))) (and (and (=> %%location_label%%5 (= (uClip 64 (bitshr (I x!) (I shift!))) (uClip 64 (EucDiv (uClip 64 (bitshr (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) 2)))) (=> (= (uClip 64 (bitshr (I x!) (I shift!))) (uClip 64 (EucDiv (uClip 64 (bitshr (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) 2))) (and (=> (= tmp%4 (uClip 64 (Sub shift! 1))) (and (=> %%location_label%%6 (check_decrease_int (let ((x!$0 x!) (shift!$1 tmp%4)) shift!$1) decrease%init0 false)) (and (=> %%location_label%%7 (req%lib!bin_sizes.shift_is_div. x! tmp%4)) (=> (ens%lib!bin_sizes.shift_is_div. x! tmp%4) (=> %%location_label%%8 (= (uClip 64 (EucDiv (uClip 64 (bitshr (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) 2)) (nClip (EucDiv (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I (Sub shift! 1))))) 2)))))))) (=> (= (uClip 64 (EucDiv (uClip 64 (bitshr (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) 2)) (nClip (EucDiv (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I (Sub shift! 1))))) 2))) (and (=> %%location_label%%9 (= (nClip (EucDiv (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I (Sub shift! 1))))) 2)) (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I shift!)))))) (=> (= (nClip (EucDiv (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I (Sub shift! 1))))) 2)) (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I shift!))))) (=> %%location_label%%10 (= (uClip 64 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I shift!)))))))))))) (=> (= (uClip 64 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I shift!))))) %%switch_label%%0)))))))))) (and (not %%switch_label%%0) (=> %%location_label%%11 (= (uClip 64 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (lib!bin_sizes.pow2.? (I shift!)))))))))))
(check-sat)
(exit)
