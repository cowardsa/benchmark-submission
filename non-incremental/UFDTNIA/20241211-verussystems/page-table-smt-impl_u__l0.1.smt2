...
(assert (not (=> (has_type va@ NAT) (or (and (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. self!)))) va@) (=> (= tmp%2 (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. self!)))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.index. $ NAT $ TYPE%lib!definitions_t.PageTableEntry. tmp%2 va@)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. self!))) va@)) (=> (= tmp%3 (lib!definitions_t.impl&%8.contains_entry_size.? (Poly%lib!definitions_t.Arch. (lib!impl_u.l0.PageTableContents./PageTableContents/arch (%Poly%lib!impl_u.l0.PageTableContents. self!))) (I (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. tmp%1)))))))) %%switch_label%%0))))) (=> (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. self!)))) va@)) (=> (= tmp%3 true) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
