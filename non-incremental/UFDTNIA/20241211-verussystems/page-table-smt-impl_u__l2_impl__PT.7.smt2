...
(assert (has_type init! (TYPE%vstd!seq.Seq. $ TYPE%lib!impl_u.l1.NodeEntry.)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= decrease%init0 (Sub lib!definitions_t.X86_NUM_LAYERS.? (%I layer!))) (=> (= decrease%init1 (Sub lib!definitions_t.X86_NUM_ENTRIES.? (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. init!))) (=> (= decrease%init2 1) (=> (lib!impl_u.l2_impl.PT.inv_at.? mem! pt! layer! ptr!) (or (and (=> (>= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. init!) lib!definitions_t.X86_NUM_ENTRIES.?) (=> (= tmp%4 init!) %%switch_label%%0)) (=> (not (>= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. init!) lib!definitions_t.X86_NUM_ENTRIES.?)) (=> (= tmp%1 (I (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. init!))) (and (=> %%location_label%%0 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!)) (base_vaddr!$4 (%I base_vaddr!)) (idx!$5 (%I tmp%1))) (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!$2)) decrease%init0 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!)) (base_vaddr!$4 (%I base_vaddr!)) (idx!$5 (%I tmp%1))) (Sub lib!definitions_t.X86_NUM_ENTRIES.? idx!$5)) decrease%init1 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!)) (base_vaddr!$4 (%I base_vaddr!)) (idx!$5 (%I tmp%1))) 0) decrease%init2 false)))) (=> (has_type (Poly%lib!impl_u.l1.NodeEntry. entry@) TYPE%lib!impl_u.l1.NodeEntry.) (=> (= tmp%3 (vstd!seq.Seq.push.? $ TYPE%lib!impl_u.l1.NodeEntry. init! (Poly%lib!impl_u.l1.NodeEntry. entry@))) (and (=> %%location_label%%1 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!)) (base_vaddr!$4 (%I base_vaddr!)) (init!$5 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. tmp%3))) (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!$2)) decrease%init0 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!)) (base_vaddr!$4 (%I base_vaddr!)) (init!$5 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. tmp%3))) (Sub lib!definitions_t.X86_NUM_ENTRIES.? (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!$5)))) decrease%init1 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!)) (base_vaddr!$4 (%I base_vaddr!)) (init!$5 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. tmp%3))) 1) decrease%init2 false)))) (=> (= tmp%2 (lib!impl_u.l2_impl.PT.interp_at_aux.? mem! pt! layer! ptr! base_vaddr! (vstd!seq.Seq.push.? $ TYPE%lib!impl_u.l1.NodeEntry. init! (Poly%lib!impl_u.l1.NodeEntry. entry@)))) (=> (= tmp%4 (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. tmp%2)) %%switch_label%%0))))))))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
