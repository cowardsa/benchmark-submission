...
(set-info :comment ";; layout.rs:285:9: 285:15 (#0)")
...
(set-info :comment ";; layout.rs:285:9: 285:15 (#0)")
(declare-const page_ptr! ptr_mut%<lib!types.Page.>.)
(declare-const block_ptr! ptr_mut%<u8.>.)
(declare-const segment_ptr! ptr_mut%<lib!types.SegmentHeader.>.)
...
(assert (not (=> (= lib!config.SLICES_PER_SEGMENT.? (EucDiv lib!config.SEGMENT_SIZE.? lib!config.SLICE_SIZE.?)) (=> (<= (Sub b@ s@) lib!config.SEGMENT_SIZE.?) (=> (> lib!config.SLICE_SIZE.? 0) (=> %%location_label%%0 (<= (EucDiv (Sub b@ s@) lib!config.SLICE_SIZE.?) lib!config.SLICES_PER_SEGMENT.?)))))))
(check-sat)
(exit)
