...
(declare-const self!@0 main!main_t.InfiniteLogImpl.)
(declare-const new_head! Int)
(declare-const tmp%1 vstd!seq.Seq<u8.>.)
(declare-const tmp%2 %%Function%%)
(declare-const verus_tmp_perm@ main!main_t.TrustedPermission.)
(declare-const tmp%3 core!result.Result.)
(declare-const verus_tmp@ main!main_t.TrustedPermission.)
(declare-const perm@0 main!main_t.TrustedPermission.)
(assert fuel_defaults)
(assert (has_type (Poly%main!main_t.InfiniteLogImpl. self!@0) (TYPE%main!main_t.InfiniteLogImpl. PM&. PM&)))
(assert (uInv 64 new_head!))
(assert (tr_bound%main!pmemspec_t.PersistentMemory. PM&. PM&))
(assert (main!main_t.impl&%4.valid.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@0)))
(declare-fun %%lambda%%4 (Poly) %%Function%%)
(assert (forall ((%%hole%%0 Poly) (s1$ Poly) (s2$ Poly)) (! (= (%%apply%%1 (%%lambda%%4 %%hole%%0) s1$ s2$) (B (= (%Poly%main!infinitelog_t.AbstractInfiniteLogState. s2$) (main!infinitelog_t.impl&%0.advance_head.? s1$ %%hole%%0)))) :pattern ((%%apply%%1 (%%lambda%%4 %%hole%%0) s1$ s2$)))))
(declare-const perm@1 main!main_t.TrustedPermission.)
(declare-const self!@1 main!main_t.InfiniteLogImpl.)
...
(assert (not (=> (= tmp%1 (main!pmemspec_t.impl&%0.view.? $ TYPE%main!main_t.TrustedPermission. PM&. PM& (main!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))))) (=> (= tmp%2 (mk_fun (%%lambda%%4 (I new_head!)))) (=> (ens%main!main_t.impl&%1.new. tmp%1 tmp%2 verus_tmp@) (=> (= verus_tmp_perm@ verus_tmp@) (=> (= perm@1 verus_tmp_perm@) (and (=> %%location_label%%0 (req%main!logimpl_v.impl&%0.untrusted_advance_head. $ TYPE%main!main_t.TrustedPermission. PM&. PM& (main!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))) (main!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))) new_head! (Poly%main!main_t.TrustedPermission. perm@1))) (=> (has_type (Poly%main!main_t.InfiniteLogImpl. self!@1) (TYPE%main!main_t.InfiniteLogImpl. PM&. PM&)) (=> (ens%main!logimpl_v.impl&%0.untrusted_advance_head. $ TYPE%main!main_t.TrustedPermission. PM&. PM& (main!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))) (main!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@1))) (main!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))) (main!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@1))) new_head! (Poly%main!main_t.TrustedPermission. perm@1) tmp%3) (=> (= result! tmp%3) (and (=> %%location_label%%1 (main!main_t.impl&%4.valid.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1))) (and (=> %%location_label%%2 (= (main!main_t.impl&%4.constants.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1)) (main!main_t.impl&%4.constants.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@0)))) (=> %%location_label%%3 (ite (is-core!result.Result./Ok_ result!) (let ((offset$ (%Poly%tuple%0. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((tmp%%$ (tuple%2./tuple%2 (Poly%core!option.Option. (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@0))) (Poly%core!option.Option. (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1)))))) (and (and (and (is-tuple%2./tuple%2_ tmp%%$) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))) (let ((old_log$ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))))) (let ((new_log$ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))))) (and (and (<= (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. old_log$))) new_head!) (<= new_head! (Add (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. old_log$))) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. old_log$)))))))) (= new_log$ (main!infinitelog_t.impl&%0.advance_head.? (Poly%main!infinitelog_t.AbstractInfiniteLogState. old_log$) (I new_head!))))))))) (ite (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeforeHead_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((head$ (main!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeforeHead/head (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (and (and (= (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1)) (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@0))) (= head$ (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1))))))))) (< new_head! head$))) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeyondTail_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((tail$ (main!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeyondTail/tail (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (and (and (= (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1)) (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@0))) (= tail$ (Add (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1))))))) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1)))))))))))) (> new_head! tail$))))))))))))))))))))
(check-sat)
(exit)
