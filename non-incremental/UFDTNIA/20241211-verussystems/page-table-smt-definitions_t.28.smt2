...
(declare-const %return! lib!definitions_t.ArchExec.)
(declare-const tmp%1 Bool)
(declare-const layers@ %%Function%%)
(assert fuel_defaults)
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= layers@ (%Poly%array%. (array_new $ TYPE%lib!definitions_t.ArchLayerExec. 4 (%%array%%0 (Poly%lib!definitions_t.ArchLayerExec. (lib!definitions_t.ArchLayerExec./ArchLayerExec (%I (I lib!definitions_t.L0_ENTRY_SIZE.?)) (%I (I 512)))) (Poly%lib!definitions_t.ArchLayerExec. (lib!definitions_t.ArchLayerExec./ArchLayerExec (%I (I lib!definitions_t.L1_ENTRY_SIZE.?)) (%I (I 512)))) (Poly%lib!definitions_t.ArchLayerExec. (lib!definitions_t.ArchLayerExec./ArchLayerExec (%I (I lib!definitions_t.L2_ENTRY_SIZE.?)) (%I (I 512)))) (Poly%lib!definitions_t.ArchLayerExec. (lib!definitions_t.ArchLayerExec./ArchLayerExec (%I (I lib!definitions_t.L3_ENTRY_SIZE.?)) (%I (I 512)))))))) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ TYPE%lib!definitions_t.ArchLayer.) (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?)))) (vstd!seq_lib.impl&%0.map.? $ TYPE%lib!definitions_t.ArchLayerExec. $ TYPE%lib!definitions_t.ArchLayer. (vstd!view.View.view.? $ (ARRAY $ TYPE%lib!definitions_t.ArchLayerExec. $ (CONST_INT 4)) (Poly%array%. layers@)) (Poly%fun%2. (mk_fun %%lambda%%2))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= %return! (lib!definitions_t.ArchExec./ArchExec (%Poly%array%. (Poly%array%. layers@)))) (=> %%location_label%%1 (= (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. %return!)) lib!definitions_t.x86_arch_spec.?)))))))))
(check-sat)
(exit)
