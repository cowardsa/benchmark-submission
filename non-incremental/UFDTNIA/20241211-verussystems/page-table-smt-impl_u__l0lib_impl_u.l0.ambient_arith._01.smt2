...
(set-info :comment ";; page-table/impl_u/l0.rs:12:1: 12:29 (#0)")
...
(set-info :comment ";; Function-Def lib::impl_u::l0::ambient_arith")
(set-info :comment ";; page-table/impl_u/l0.rs:12:1: 12:29 (#0)")
...
(assert (not (=> (ens%lib!extra.aligned_zero. 0) (and (=> %%location_label%%0 (forall ((a$ Int) (b$ Int)) (! (=> (and (<= 0 a$) (<= 0 b$)) (=> (= a$ 0) (= (nClip (Mul a$ b$)) 0))) :pattern ((nClip (Mul a$ b$)))))) (and (=> %%location_label%%1 (forall ((a$ Int) (b$ Int)) (! (=> (and (<= 0 a$) (<= 0 b$)) (=> (= b$ 0) (= (nClip (Mul a$ b$)) 0))) :pattern ((nClip (Mul a$ b$)))))) (and (=> %%location_label%%2 (forall ((a$ Int) (b$ Int)) (! (=> (and (<= 0 a$) (<= 0 b$)) (=> (and (> a$ 0) (> b$ 0)) (> (nClip (Mul a$ b$)) 0))) :pattern ((nClip (Mul a$ b$)))))) (and (=> %%location_label%%3 (forall ((a$ Int) (b$ Int)) (! (= (Mul a$ b$) (Mul b$ a$)) :pattern ((Mul a$ b$))))) (=> %%location_label%%4 (forall ((a$ Poly)) (! (=> (has_type a$ NAT) (=> (not (= (%I a$) 0)) (lib!definitions_t.aligned.? (I 0) a$))) :pattern ((lib!definitions_t.aligned.? (I 0) a$))))))))))))
(check-sat)
(exit)
