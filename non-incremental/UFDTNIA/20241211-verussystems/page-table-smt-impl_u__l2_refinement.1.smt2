...
(declare-const res@ vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>.)
...
(assert (uInv SZ ptr!))
(assert (<= 0 base_vaddr!))
(assert (= (lib!spec_t.mem.impl&%1.regions.? (Poly%lib!spec_t.mem.PageTableMemory. mem!)) (%Poly%vstd!set.Set<lib!definitions_t.MemRegion.>. (vstd!set.impl&%0.insert.? $ TYPE%lib!definitions_t.MemRegion. (vstd!set.impl&%0.empty.? $ TYPE%lib!definitions_t.MemRegion.) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.impl&%4.view.? (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem!)))))))))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) 512) (= (%I (vstd!seq.Seq.index.? $ (UINT 64) (Poly%vstd!seq.Seq<u64.>. (lib!spec_t.mem.impl&%1.region_view.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.impl&%4.view.? (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem!))))))) i$)) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT 64) (Poly%vstd!seq.Seq<u64.>. (lib!spec_t.mem.impl&%1.region_view.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.impl&%4.view.? (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem!))))))) i$)))))
(assert (= layer! 0))
...
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!))) (= (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!) i$)) lib!impl_u.l1.NodeEntry./Empty))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!) i$)))))
(assert (<= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)) 512))
...
(assert (not (=> (= decrease%init0 (Sub 512 (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)))) (=> (= tmp%1 core!option.Option./None) (=> (ens%lib!definitions_u.lemma_new_seq. $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) 512 (Poly%core!option.Option. tmp%1)) (=> (= res@ (lib!impl_u.l2_impl.PT.interp_at_aux.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!))) (or (and (=> (>= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)) 512) %%switch_label%%0) (=> (not (>= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)) 512)) (=> (= entry@ (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) (I (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!))))) (=> (= tmp%2 (lib!impl_u.l2_impl.PT.ghost_pt_matches_structure.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!))) (and (=> %%location_label%%0 tmp%2) (=> tmp%2 (and (=> (has_type i@ NAT) (=> (< (%I i@) 512) (=> (= entry$1@ (lib!spec_t.mem.impl&%1.spec_read.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) i@ (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!)))))) (and (=> %%location_label%%1 (= entry$1@ 0)) (=> (not (= (uClip 64 (bitand (I entry$1@) (I (uClip 64 (bitshl (I 1) (I 0)))))) (uClip 64 (bitshl (I 1) (I 0))))) (=> %%location_label%%2 (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Empty_ (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i@)))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) 512) (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Empty_ (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$)))) :pattern ((lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$)))) (=> (= tmp%3 (= entry@ lib!impl_u.l1.NodeEntry./Empty)) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> (= tmp%4 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (vstd!seq.Seq.push.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!) (Poly%lib!impl_u.l1.NodeEntry. entry@)))) (and (=> %%location_label%%4 (check_decrease_int (let ((mem!$0 mem!) (pt!$1 pt!) (layer!$2 layer!) (ptr!$3 ptr!) (base_vaddr!$4 base_vaddr!) (init!$5 tmp%4)) (Sub 512 (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!$5)))) decrease%init0 false)) (and (=> %%location_label%%5 (req%lib!impl_u.l2_refinement.lemma_no_entries_implies_interp_at_aux_no_entries. mem! pt! layer! ptr! base_vaddr! tmp%4)) (=> (ens%lib!impl_u.l2_refinement.lemma_no_entries_implies_interp_at_aux_no_entries. mem! pt! layer! ptr! base_vaddr! tmp%4) %%switch_label%%0))))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%6 (let ((res$ (lib!impl_u.l2_impl.PT.interp_at_aux.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. init!)))) (and (= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$)) 512) (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$))) (= (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$) i$)) lib!impl_u.l1.NodeEntry./Empty))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. res$) i$)))))))))))))))
(check-sat)
(exit)
