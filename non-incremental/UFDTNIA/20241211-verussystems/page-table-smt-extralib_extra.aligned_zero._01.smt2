...
(set-info :comment ";; page-table/extra.rs:88:1: 88:28 (#0)")
...
(set-info :comment ";; Function-Def lib::extra::aligned_zero")
(set-info :comment ";; page-table/extra.rs:88:1: 88:28 (#0)")
(declare-const no%param Int)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (forall ((a$ Poly)) (! (=> (has_type a$ NAT) (=> (not (= (%I a$) 0)) (lib!definitions_t.aligned.? (I 0) a$))) :pattern ((lib!definitions_t.aligned.? (I 0) a$)))))))
(check-sat)
(exit)
