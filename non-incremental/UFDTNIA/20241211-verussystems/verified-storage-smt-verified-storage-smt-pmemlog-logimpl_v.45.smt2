...
(set-info :comment ";; Function-Specs main::logimpl_v::UntrustedLogImpl::read_incorruptible_boolean")
(declare-fun req%main!logimpl_v.impl&%0.read_incorruptible_boolean. (Dcr Type Poly) Bool)
...
(assert (forall ((PM&. Dcr) (PM& Type) (pm! Poly)) (! (= (req%main!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm!) (and (=> %%global_location_label%%135 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!)))) (=> %%global_location_label%%136 (%B (main!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!))) (=> %%global_location_label%%137 (> (vstd!seq.Seq.len.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!)) main!logimpl_v.contents_offset.?)))) :pattern ((req%main!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm!)))))
(declare-fun ens%main!logimpl_v.impl&%0.read_incorruptible_boolean. (Dcr Type Poly core!result.Result.) Bool)
...
(assert (forall ((PM&. Dcr) (PM& Type) (pm! Poly) (result! core!result.Result.)) (! (= (ens%main!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm! result!) (and (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ (UINT 64) $ TYPE%main!main_t.InfiniteLogErr.)) (ite (is-core!result.Result./Ok_ result!) (let ((ib$ (%I (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!)))) (let ((spec_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (= ib$ spec_ib$)))) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./CRCMismatch_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (main!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!)))))))) :pattern ((ens%main!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm! result!)))))
(set-info :comment ";; Function-Def main::logimpl_v::UntrustedLogImpl::read_incorruptible_boolean")
(set-info :comment ";; src/logimpl_v.rs:1202:9: 1202:118 (#0)")
(set-info :comment ";; Function-Specs main::pmemspec_t::WriteRestrictedPersistentMemory::write")
(declare-fun req%main!pmemspec_t.impl&%0.write. (Dcr Type Dcr Type Poly Int slice%<u8.>. Poly) Bool)
...
(assert (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! Poly) (addr! Int) (bytes! slice%<u8.>.) (perm! Poly)) (! (= (req%main!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! addr! bytes! perm!) (and (=> %%global_location_label%%138 (main!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& pre%self!)) (=> %%global_location_label%%139 (<= (Add addr! (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!)))) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%self!))))) (=> %%global_location_label%%140 (<= (Add addr! (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!)))) 18446744073709551615)) (=> %%global_location_label%%141 (forall ((chunks_flushed$ Poly)) (! (=> (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT)) (%B (let ((new_contents$ (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%self!)) (I addr!) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!)) chunks_flushed$))) (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. new_contents$))))) :pattern ((main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%self!)) (I addr!) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!)) chunks_flushed$))))))) :pattern ((req%main!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! addr! bytes! perm!)))))
(declare-fun ens%main!pmemspec_t.impl&%0.write. (Dcr Type Dcr Type Poly Poly Int slice%<u8.>. Poly) Bool)
(assert (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! Poly) (self! Poly) (addr! Int) (bytes! slice%<u8.>.) (perm! Poly)) (! (= (ens%main!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! self! addr! bytes! perm!) (and (has_type self! (TYPE%main!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm& PM&. PM&)) (main!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& self!) (= (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& self!) (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& pre%self!)) (= (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& self!) (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%self!)) (I addr!) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!)))))) :pattern ((ens%main!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! self! addr! bytes! perm!)))))
(set-info :comment ";; Function-Specs main::logimpl_v::UntrustedLogImpl::update_header")
(declare-fun req%main!logimpl_v.impl&%0.update_header. (Dcr Type Dcr Type main!logimpl_v.UntrustedLogImpl. Poly Poly alloc!vec.Vec<u8./allocator_global%.>.) Bool)
...
(assert (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! main!logimpl_v.UntrustedLogImpl.) (pre%wrpm! Poly) (perm! Poly) (new_header_bytes! alloc!vec.Vec<u8./allocator_global%.>.)) (! (= (req%main!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& pre%self! pre%wrpm! perm! new_header_bytes!) (and (=> %%global_location_label%%142 (main!logimpl_v.permissions_depend_only_on_recovery_view.? Perm&. Perm& perm!)) (=> %%global_location_label%%143 (< main!logimpl_v.contents_offset.? (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!))))) (=> %%global_location_label%%144 (main!logimpl_v.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%main!logimpl_v.UntrustedLogImpl. pre%self!) pre%wrpm!)) (=> %%global_location_label%%145 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!))))) (=> %%global_location_label%%146 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8))) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)))))) (=> %%global_location_label%%147 (= (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)) main!logimpl_v.header_size.?)) (=> %%global_location_label%%148 (let ((tmp%%$ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!))))) (and (is-core!option.Option./Some_ tmp%%$) (%B (let ((log_state$ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%$)))))) (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!)))))))))) :pattern ((req%main!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& pre%self! pre%wrpm! perm! new_header_bytes!)))))
(declare-fun ens%main!logimpl_v.impl&%0.update_header. (Dcr Type Dcr Type main!logimpl_v.UntrustedLogImpl. main!logimpl_v.UntrustedLogImpl. Poly Poly Poly alloc!vec.Vec<u8./allocator_global%.>.) Bool)
(assert (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! main!logimpl_v.UntrustedLogImpl.) (self! main!logimpl_v.UntrustedLogImpl.) (pre%wrpm! Poly) (wrpm! Poly) (perm! Poly) (new_header_bytes! alloc!vec.Vec<u8./allocator_global%.>.)) (! (= (ens%main!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& pre%self! self! pre%wrpm! wrpm! perm! new_header_bytes!) (and (has_type (Poly%main!logimpl_v.UntrustedLogImpl. self!) TYPE%main!logimpl_v.UntrustedLogImpl.) (has_type wrpm! (TYPE%main!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm& PM&. PM&)) (main!logimpl_v.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%main!logimpl_v.UntrustedLogImpl. self!) wrpm!) (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)))) (= (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!) (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& pre%wrpm!)) (let ((tmp%%$ (tuple%2./tuple%2 (Poly%core!option.Option. (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!)))) (Poly%core!option.Option. (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!))))))) (and (and (and (is-tuple%2./tuple%2_ tmp%%$) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))) (let ((old_log_state$ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))))) (let ((new_log_state$ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))))) (ext_eq false TYPE%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. old_log_state$) (Poly%main!infinitelog_t.AbstractInfiniteLogState. new_log_state$)))))) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!))))) (let ((old_pm_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_metadata$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!))))) (let ((new_pm_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_metadata$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_header$ (main!logimpl_v.spec_bytes_to_header.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!))))) (and (and (and (= old_pm_ib$ new_pm_ib$) (=> (= old_pm_ib$ main!pmemspec_t.cdb0_val.?) (and (and (and (= (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_metadata$))) (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_metadata$)))) (= (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_metadata$))) new_header$)) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_crc_offset.?)) (I (Add (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_crc_offset.?) 8))) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_head_offset.?)) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_size.?))))))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)) (I main!logimpl_v.header2_pos.?) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_size.?))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)))))) (=> (= old_pm_ib$ main!pmemspec_t.cdb1_val.?) (and (and (and (= (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_metadata$))) new_header$) (= (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_metadata$))) (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_metadata$))))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_crc_offset.?)) (I (Add (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_crc_offset.?) 8))) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_head_offset.?)) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?))))))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)) (I main!logimpl_v.header1_pos.?) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?))) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)))))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_data$) (Poly%vstd!seq.Seq<u8.>. new_data$)))))))))))))) :pattern ((ens%main!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& pre%self! self! pre%wrpm! wrpm! perm! new_header_bytes!)))))
(set-info :comment ";; Function-Def main::logimpl_v::UntrustedLogImpl::update_header")
(set-info :comment ";; src/logimpl_v.rs:1234:14: 1243:37 (#0)")
...
(assert (forall ((PM&. Dcr) (PM& Type) (pre%pm! Poly) (device_size! Int)) (! (= (req%main!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pre%pm! device_size!) (and (=> %%global_location_label%%149 (%B (main!pmemspec_t.PersistentMemory.inv.? PM&. PM& pre%pm!))) (=> %%global_location_label%%150 (= (vstd!seq.Seq.len.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pre%pm!)) device_size!)))) :pattern ((req%main!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pre%pm! device_size!)))))
...
(set-info :comment ";; Function-Def main::logimpl_v::UntrustedLogImpl::untrusted_setup")
(set-info :comment ";; src/logimpl_v.rs:1350:9: 1352:37 (#0)")
(set-info :comment ";; Function-Specs main::pmemspec_t::WriteRestrictedPersistentMemory::get_pm_ref")
(declare-fun req%main!pmemspec_t.impl&%0.get_pm_ref. (Dcr Type Dcr Type Poly) Bool)
(declare-const %%global_location_label%%151 Bool)
(assert (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly)) (! (= (req%main!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& self!) (=> %%global_location_label%%151 (main!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& self!))) :pattern ((req%main!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& self!)))))
(declare-fun ens%main!pmemspec_t.impl&%0.get_pm_ref. (Dcr Type Dcr Type Poly Poly) Bool)
(assert (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly) (pm! Poly)) (! (= (ens%main!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& self! pm!) (and (has_type pm! PM&) (%B (main!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!)) (= (%Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!)) (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& self!)) (= (%Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!)) (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& self!)))) :pattern ((ens%main!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& self! pm!)))))
...
(set-info :comment ";; Function-Def main::logimpl_v::UntrustedLogImpl::untrusted_start")
(set-info :comment ";; src/logimpl_v.rs:1411:9: 1417:37 (#0)")
...
(declare-const e@ main!main_t.InfiniteLogErr.)
...
(declare-const verus_tmp_header_addrs@ vstd!seq.Seq<int.>.)
(declare-const tmp%9 alloc!vec.Vec<u8./allocator_global%.>.)
...
(declare-const tmp%16 vstd!seq.Seq<u8.>.)
(declare-const tmp%17 vstd!seq.Seq<u8.>.)
(declare-const tmp%18 vstd!seq.Seq<u8.>.)
(declare-const tmp%19 vstd!seq.Seq<u8.>.)
(declare-const tmp%20 Poly)
(declare-const tmp%21 Poly)
(declare-const tmp%22 main!logimpl_v.PersistentHeader.)
...
(declare-const tmp%28 vstd!seq.Seq<u8.>.)
(declare-const pm@ Poly)
(declare-const ib@ Int)
(declare-const header_pos@ Int)
(declare-const crc_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const verus_tmp@0 vstd!seq.Seq<int.>.)
(declare-const crc_addrs@0 vstd!seq.Seq<int.>.)
(declare-const header_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const verus_tmp$1@0 vstd!seq.Seq<int.>.)
(declare-const header_addrs@0 vstd!seq.Seq<int.>.)
...
(declare-const untrusted_log@ main!logimpl_v.UntrustedLogImpl.)
(assert fuel_defaults)
(assert (has_type wrpm!@0 (TYPE%main!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm& PM&. PM&)))
...
(assert (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0)))))
(assert (main!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& wrpm!@0))
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))) device_size!))
(assert (let ((tmp%%$ (Add main!logimpl_v.header_crc_offset.? main!pmemspec_t.crc_size.?))) (let ((tmp%%$1 main!logimpl_v.header_head_offset.?)) (let ((tmp%%$2 main!logimpl_v.header_tail_offset.?)) (and (and (and (< main!logimpl_v.header_crc_offset.? tmp%%$) (<= tmp%%$ tmp%%$1)) (< tmp%%$1 tmp%%$2)) (< tmp%%$2 main!logimpl_v.header_log_size_offset.?))))))
(assert (forall ((pm_state$ Poly)) (! (=> (has_type pm_state$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (= (%B (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! pm_state$)) (= (main!logimpl_v.impl&%0.recover.? pm_state$) (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0)))))) :pattern ((main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! pm_state$)))))
(declare-fun %%lambda%%4 (Int Int) %%Function%%)
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Int) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%4 %%hole%%0 %%hole%%1) i$) (I (Add (Add (%I i$) %%hole%%0) %%hole%%1))) :pattern ((%%apply%%0 (%%lambda%%4 %%hole%%0 %%hole%%1) i$)))))
...
(declare-const header_addrs@1 vstd!seq.Seq<int.>.)
...
(assert (not (and (=> %%location_label%%0 (req%main!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& wrpm!@0)) (=> (ens%main!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& wrpm!@0 pm@) (=> (= tmp%1 (> device_size! main!logimpl_v.contents_offset.?)) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (and (=> %%location_label%%2 (req%main!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm@)) (=> (ens%main!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm@ tmp%%@) (or (and (=> (is-core!result.Result./Ok_ tmp%%@) %%switch_label%%3) (=> (not (is-core!result.Result./Ok_ tmp%%@)) (=> (= e@ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@))))) (=> (= result! (core!result.Result./Err (Poly%main!main_t.InfiniteLogErr. e@))) (and (=> %%location_label%%3 (= (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))) (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))))) (and (=> %%location_label%%4 (= (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0) (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0))) (=> %%location_label%%5 (ite (is-core!result.Result./Ok_ result!) (let ((log_impl$ (%Poly%main!logimpl_v.UntrustedLogImpl. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (main!logimpl_v.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%main!logimpl_v.UntrustedLogImpl. log_impl$) wrpm!@0)) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./CRCMismatch_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (main!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%main!pmemspec_t.PersistentMemoryConstants. (Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0)))))))))))))) (and (not %%switch_label%%3) (=> (= ib@ (let ((ib$1 (%I (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@)))))) ib$1)) (or (and (=> (= ib@ main!pmemspec_t.cdb0_val.?) (=> (= tmp%3 main!logimpl_v.header1_pos.?) %%switch_label%%2)) (=> (not (= ib@ main!pmemspec_t.cdb0_val.?)) (=> (= tmp%2 (= ib@ main!pmemspec_t.cdb1_val.?)) (and (=> %%location_label%%6 tmp%2) (=> tmp%2 (=> (= tmp%3 main!logimpl_v.header2_pos.?) %%switch_label%%2)))))) (and (not %%switch_label%%2) (=> (= header_pos@ tmp%3) (and (=> %%location_label%%7 (uInv 64 (Add header_pos@ main!logimpl_v.header_crc_offset.?))) (=> (= tmp%5 (I (uClip 64 (Add header_pos@ main!logimpl_v.header_crc_offset.?)))) (and (=> %%location_label%%8 (req%main!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ tmp%5 (I 8))) (=> (ens%main!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ tmp%5 (I 8) tmp%4) (=> (= crc_bytes@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%4)) (=> (= verus_tmp@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT) (I 8) (Poly%fun%1. (mk_fun (%%lambda%%4 header_pos@ main!logimpl_v.header_crc_offset.?)))))) (=> (= verus_tmp_crc_addrs@ verus_tmp@1) (=> (= crc_addrs@1 verus_tmp_crc_addrs@) (and (=> %%location_label%%9 (uInv 64 (Add header_pos@ main!logimpl_v.header_head_offset.?))) (and (=> %%location_label%%10 (uInv 64 (Sub main!logimpl_v.header_size.? main!logimpl_v.header_head_offset.?))) (=> (= tmp%7 (I (uClip 64 (Add header_pos@ main!logimpl_v.header_head_offset.?)))) (=> (= tmp%8 (I (uClip 64 (Sub main!logimpl_v.header_size.? main!logimpl_v.header_head_offset.?)))) (and (=> %%location_label%%11 (req%main!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ tmp%7 tmp%8)) (=> (ens%main!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ tmp%7 tmp%8 tmp%6) (=> (= header_bytes@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%6)) (=> (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT) (I (nClip (Sub main!logimpl_v.header_size.? main!logimpl_v.header_head_offset.?))) (Poly%fun%1. (mk_fun (%%lambda%%4 header_pos@ main!logimpl_v.header_head_offset.?)))))) (=> (= verus_tmp_header_addrs@ verus_tmp$1@1) (=> (= header_addrs@1 verus_tmp_header_addrs@) (=> (ens%main!pmemspec_t.bytes_crc. header_bytes@ tmp%9) (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%9) tmp%10) (and (=> %%location_label%%12 (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%10))) (=> (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%10) tmp%11) (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@) tmp%12) (and (=> %%location_label%%13 (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%12))) (=> (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%12) tmp%13) (or (and (=> (= tmp%11 tmp%13) (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> (= tmp%14 (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. header_bytes@)))))) (=> (= tmp%15 (vstd!bytes.spec_u64_from_le_bytes.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@)))) (and (=> %%location_label%%14 (req%main!logimpl_v.lemma_u64_bytes_eq. tmp%14 tmp%15)) (=> (ens%main!logimpl_v.lemma_u64_bytes_eq. tmp%14 tmp%15) (or (and (=> (not (main!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%main!pmemspec_t.PersistentMemoryConstants. (Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0))))) (=> (= tmp%16 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. header_bytes@)))) (=> (= tmp%17 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm@) (I (Add header_pos@ main!logimpl_v.header_head_offset.?)) (I (Add header_pos@ main!logimpl_v.header_size.?))))) (=> (= tmp%18 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@)))) (=> (= tmp%19 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm@) (I (Add header_pos@ main!logimpl_v.header_crc_offset.?)) (I (Add (Add header_pos@ main!logimpl_v.header_crc_offset.?) 8))))) (and (=> %%location_label%%15 (req%main!pmemspec_t.axiom_bytes_uncorrupted. tmp%16 tmp%17 header_addrs@1 tmp%18 tmp%19 crc_addrs@1)) (=> (ens%main!pmemspec_t.axiom_bytes_uncorrupted. tmp%16 tmp%17 header_addrs@1 tmp%18 tmp%19 crc_addrs@1) %%switch_label%%1))))))) (=> (not (not (main!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%main!pmemspec_t.PersistentMemoryConstants. (Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0)))))) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@) tmp%20) (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. header_bytes@) tmp%21) (and (=> %%location_label%%16 (req%main!logimpl_v.crc_and_metadata_bytes_to_header. (%Poly%slice%<u8.>. tmp%20) (%Poly%slice%<u8.>. tmp%21))) (=> (ens%main!logimpl_v.crc_and_metadata_bytes_to_header. (%Poly%slice%<u8.>. tmp%20) (%Poly%slice%<u8.>. tmp%21) tmp%22) %%switch_label%%0)))))))))))) (=> (not (= tmp%11 tmp%13)) (=> (= result! (core!result.Result./Err (Poly%main!main_t.InfiniteLogErr. main!main_t.InfiniteLogErr./CRCMismatch))) (and (=> %%location_label%%17 (= (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))) (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))))) (and (=> %%location_label%%18 (= (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0) (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0))) (=> %%location_label%%19 (ite (is-core!result.Result./Ok_ result!) (let ((log_impl$ (%Poly%main!logimpl_v.UntrustedLogImpl. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (main!logimpl_v.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%main!logimpl_v.UntrustedLogImpl. log_impl$) wrpm!@0)) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./CRCMismatch_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (main!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%main!pmemspec_t.PersistentMemoryConstants. (Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0))))))))))))) (and (not %%switch_label%%0) (=> (= header@ tmp%22) (=> (= head@ (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (=> (= tail@ (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (=> (= log_size@ (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (=> (= tmp%23 (= device_size! (Add log_size@ main!logimpl_v.contents_offset.?))) (and (=> %%location_label%%20 tmp%23) (=> tmp%23 (=> (= tmp%24 (<= head@ tail@)) (and (=> %%location_label%%21 tmp%24) (=> tmp%24 (=> (= tmp%25 (< (Sub tail@ head@) log_size@)) (and (=> %%location_label%%22 tmp%25) (=> tmp%25 (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@) tmp%26) (and (=> %%location_label%%23 (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%26))) (=> (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%26) tmp%27) (=> (= untrusted_log@ (main!logimpl_v.UntrustedLogImpl./UntrustedLogImpl (%I (I ib@)) (%I (I tmp%27)) (%I (I head@)) (%I (I tail@)) (%I (I log_size@)))) (=> (= tmp%28 (%Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm@))) (and (=> %%location_label%%24 (req%main!logimpl_v.lemma_pm_state_header. tmp%28)) (=> (ens%main!logimpl_v.lemma_pm_state_header. tmp%28) (=> (= result! (core!result.Result./Ok (Poly%main!logimpl_v.UntrustedLogImpl. untrusted_log@))) (and (=> %%location_label%%25 (= (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))) (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))))) (and (=> %%location_label%%26 (= (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0) (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0))) (=> %%location_label%%27 (ite (is-core!result.Result./Ok_ result!) (let ((log_impl$ (%Poly%main!logimpl_v.UntrustedLogImpl. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (main!logimpl_v.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%main!logimpl_v.UntrustedLogImpl. log_impl$) wrpm!@0)) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./CRCMismatch_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (main!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%main!pmemspec_t.PersistentMemoryConstants. (Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
