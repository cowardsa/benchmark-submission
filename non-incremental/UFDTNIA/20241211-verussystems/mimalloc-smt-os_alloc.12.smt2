...
(assert (not (=> (= is_large@ true) (or (and (=> large_only! (=> (= tmp%2 true) %%switch_label%%4)) (=> (not large_only!) (=> (= tmp%2 tmp%1) %%switch_label%%4))) (and (not %%switch_label%%4) (or (and (=> (and tmp%2 allow_large!) (=> (ens%lib!types.todo. 0) %%switch_label%%3)) (=> (not (and tmp%2 allow_large!)) %%switch_label%%3)) (and (not %%switch_label%%3) (=> (= is_large$1@ false) (and (=> %%location_label%%0 (req%lib!os_alloc.unix_mmapx. addr! size! try_alignment! prot_rw!)) (=> (ens%lib!os_alloc.unix_mmapx. addr! size! try_alignment! prot_rw! tmp%%@) (=> (= p@ (%Poly%ptr_mut%<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= verus_tmp_mem@ (%Poly%lib!os_mem.MemChunk. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= mem@1 verus_tmp_mem@) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. p@) tmp%3) (or (=> (not (= tmp%3 0)) (or (and (=> allow_large! (=> (= tmp%5 tmp%4) %%switch_label%%2)) (=> (not allow_large!) (=> (= tmp%5 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%5 (=> (ens%lib!types.todo. 0) %%switch_label%%1)) (=> (not tmp%5) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (= res! (tuple%3./tuple%3 (Poly%ptr_mut%<u8.>. p@) (B is_large$1@) (Poly%lib!os_mem.MemChunk. mem@1))) (=> %%location_label%%1 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((is_large$ (%B (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (lib!os_mem.impl&%0.os_exact_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (=> prot_rw! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> prot_rw! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not prot_rw!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))))))))))))))) (not %%switch_label%%0))))))))))))))))
(check-sat)
(exit)
