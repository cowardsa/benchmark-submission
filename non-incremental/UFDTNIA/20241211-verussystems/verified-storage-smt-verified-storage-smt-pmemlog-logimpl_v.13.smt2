...
(assert (not (=> (= tmp%1 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!)))) (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) (Poly%vstd!seq.Seq<u8.>. bytes2!)) i$) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) i$)))) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) i$))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!)))) (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) (Poly%vstd!seq.Seq<u8.>. bytes2!)) (I (Add (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!)) (%I i$)))) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!) i$)))) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!) i$))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> %%location_label%%2 (let ((i$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!)))) (let ((j$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!)))) (and (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) (Poly%vstd!seq.Seq<u8.>. bytes2!)) (I 0) (I i$)) (Poly%vstd!seq.Seq<u8.>. bytes1!)) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) (Poly%vstd!seq.Seq<u8.>. bytes2!)) (I i$) (I (Add i$ j$))) (Poly%vstd!seq.Seq<u8.>. bytes2!))))))))))))))
(check-sat)
(exit)
