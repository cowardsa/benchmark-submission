...
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_seq_add_subrange")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:20:1: 20:74 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_seq_fold_left_merge_right_assoc")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:27:1: 27:120 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_seq_fold_left_sum_right")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:72:1: 72:89 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_seq_fold_left_sum_len_int_positive")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:116:1: 116:106 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_seq_fold_left_append_len_int_le")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:128:1: 128:111 (#0)")
...
(declare-fun %%lambda%%5 (%%Function%% Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 %%Function%%) (%%hole%%1 Dcr) (%%hole%%2 Type) (sb$ Poly) (a$ Poly)) (! (= (%%apply%%1 (%%lambda%%5 %%hole%%0 %%hole%%1 %%hole%%2) sb$ a$) (vstd!seq.Seq.add.? %%hole%%1 %%hole%%2 sb$ (%%apply%%0 %%hole%%0 a$))) :pattern ((%%apply%%1 (%%lambda%%5 %%hole%%0 %%hole%%1 %%hole%%2) sb$ a$)))))
(assert (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (s! Poly) (prefix! Poly) (f! %%Function%%)) (! (= (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int. A&. A& B&. B& s! prefix! f!) (= (vstd!seq.Seq.len.? B&. B& (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s! prefix! (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&))))) (%I (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ INT s! (I (vstd!seq.Seq.len.? B&. B& prefix!)) (Poly%fun%2. (mk_fun (%%lambda%%3 f! B&. B&))))))) :pattern ((ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int. A&. A& B&. B& s! prefix! f!)))))
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_seq_fold_left_append_len_int")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:100:1: 100:106 (#0)")
...
(assert (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (s! Poly) (prefix! Poly) (f! %%Function%%)) (! (= (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_right. A&. A& B&. B& s! prefix! f!) (= (vstd!seq.Seq.add.? B&. B& (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) (vstd!seq.Seq.subrange.? A&. A& s! (I 0) (I (Sub (vstd!seq.Seq.len.? A&. A& s!) 1))) prefix! (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&)))) (%%apply%%0 f! (vstd!seq.Seq.index.? A&. A& s! (I (Sub (vstd!seq.Seq.len.? A&. A& s!) 1))))) (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s! prefix! (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&)))))) :pattern ((ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_right. A&. A& B&. B& s! prefix! f!)))))
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_seq_fold_left_append_right")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:85:1: 85:104 (#0)")
...
(assert (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (s1! Poly) (s2! Poly) (f! %%Function%%)) (! (= (ens%lib!verus_extra.seq_lib_v.lemma_fold_left_append_merge. A&. A& B&. B& s1! s2! f!) (= (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) (vstd!seq.Seq.add.? A&. A& s1! s2!) (vstd!seq.Seq.empty.? B&. B&) (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&)))) (vstd!seq.Seq.add.? B&. B& (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s1! (vstd!seq.Seq.empty.? B&. B&) (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&)))) (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s2! (vstd!seq.Seq.empty.? B&. B&) (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&))))))) :pattern ((ens%lib!verus_extra.seq_lib_v.lemma_fold_left_append_merge. A&. A& B&. B& s1! s2! f!)))))
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_fold_left_append_merge")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:233:1: 233:97 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_fold_left_on_equiv_seqs")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:218:1: 218:132 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::some_differing_index_for_unequal_seqs")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:256:1: 256:89 (#0)")
...
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_subrange_subrange")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:9:1: 9:91 (#0)")
...
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:156:1: 156:98 (#0)")
(set-info :comment ";; Function-Specs lib::verus_extra::seq_lib_v::lemma_if_everything_in_seq_satisfies_filter_then_filter_is_identity")
(declare-fun req%lib!verus_extra.seq_lib_v.lemma_if_everything_in_seq_satisfies_filter_then_filter_is_identity. (Dcr Type Poly %%Function%%) Bool)
(declare-const %%global_location_label%%21 Bool)
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (pred! %%Function%%)) (! (= (req%lib!verus_extra.seq_lib_v.lemma_if_everything_in_seq_satisfies_filter_then_filter_is_identity. A&. A& s! pred!) (=> %%global_location_label%%21 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? A&. A& s!))) (%B (%%apply%%0 pred! (vstd!seq.Seq.index.? A&. A& s! i$))))) :pattern ((vstd!seq.Seq.index.? A&. A& s! i$)))))) :pattern ((req%lib!verus_extra.seq_lib_v.lemma_if_everything_in_seq_satisfies_filter_then_filter_is_identity. A&. A& s! pred!)))))
(declare-fun ens%lib!verus_extra.seq_lib_v.lemma_if_everything_in_seq_satisfies_filter_then_filter_is_identity. (Dcr Type Poly %%Function%%) Bool)
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (pred! %%Function%%)) (! (= (ens%lib!verus_extra.seq_lib_v.lemma_if_everything_in_seq_satisfies_filter_then_filter_is_identity. A&. A& s! pred!) (= (vstd!seq_lib.impl&%0.filter.? A&. A& s! (Poly%fun%1. pred!)) s!)) :pattern ((ens%lib!verus_extra.seq_lib_v.lemma_if_everything_in_seq_satisfies_filter_then_filter_is_identity. A&. A& s! pred!)))))
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_if_everything_in_seq_satisfies_filter_then_filter_is_identity")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:169:1: 169:121 (#0)")
(set-info :comment ";; Function-Specs lib::verus_extra::seq_lib_v::lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty")
(declare-fun req%lib!verus_extra.seq_lib_v.lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty. (Dcr Type Poly %%Function%%) Bool)
(declare-const %%global_location_label%%22 Bool)
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (pred! %%Function%%)) (! (= (req%lib!verus_extra.seq_lib_v.lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty. A&. A& s! pred!) (=> %%global_location_label%%22 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? A&. A& s!))) (not (%B (%%apply%%0 pred! (vstd!seq.Seq.index.? A&. A& s! i$)))))) :pattern ((vstd!seq.Seq.index.? A&. A& s! i$)))))) :pattern ((req%lib!verus_extra.seq_lib_v.lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty. A&. A& s! pred!)))))
(declare-fun ens%lib!verus_extra.seq_lib_v.lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty. (Dcr Type Poly %%Function%%) Bool)
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (pred! %%Function%%)) (! (= (ens%lib!verus_extra.seq_lib_v.lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty. A&. A& s! pred!) (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq_lib.impl&%0.filter.? A&. A& s! (Poly%fun%1. pred!)) (vstd!seq.Seq.empty.? A&. A&))) :pattern ((ens%lib!verus_extra.seq_lib_v.lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty. A&. A& s! pred!)))))
(set-info :comment ";; Function-Def lib::verus_extra::seq_lib_v::lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty")
(set-info :comment ";; ironsht/src/verus_extra/seq_lib_v.rs:182:1: 182:122 (#0)")
(declare-const A&. Dcr)
...
(assert (has_type (Poly%fun%1. pred!) (TYPE%fun%1. A&. A& $ BOOL)))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? A&. A& s!))) (not (%B (%%apply%%0 pred! (vstd!seq.Seq.index.? A&. A& s! i$)))))) :pattern ((vstd!seq.Seq.index.? A&. A& s! i$)))))
...
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? A&. A& s!)) (=> (fuel_bool fuel%vstd!seq_lib.impl&%0.filter.) (or (and (=> (not (= (vstd!seq.Seq.len.? A&. A& s!) 0)) (=> (= subseq@ (vstd!seq_lib.impl&%0.drop_last.? A&. A& s!)) (and (=> %%location_label%%0 (check_decrease_int (let ((s!$0 subseq@) (pred!$1 pred!)) (vstd!seq.Seq.len.? A&. A& s!$0)) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!verus_extra.seq_lib_v.lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty. A&. A& subseq@ pred!)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_if_nothing_in_seq_satisfies_filter_then_filter_result_is_empty. A&. A& subseq@ pred!) (=> (= s1@ s!) (=> (= s2@ (vstd!seq.Seq.push.? A&. A& subseq@ (vstd!seq.Seq.last.? A&. A& s!))) (and (=> (= tmp%1 (= (vstd!seq.Seq.len.? A&. A& s1@) (vstd!seq.Seq.len.? A&. A& s2@))) (and (=> %%location_label%%2 tmp%1) (=> tmp%1 (and (=> (has_type idx@ INT) (=> (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? A&. A& s1@))) (=> %%location_label%%3 (= (vstd!seq.Seq.index.? A&. A& s1@ idx@) (vstd!seq.Seq.index.? A&. A& s2@ idx@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? A&. A& s1@))) (= (vstd!seq.Seq.index.? A&. A& s1@ idx$) (vstd!seq.Seq.index.? A&. A& s2@ idx$)))) :pattern ((vstd!seq.Seq.index.? A&. A& s1@ idx$)) :pattern ((vstd!seq.Seq.index.? A&. A& s2@ idx$)))) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1@ s2@)) (and (=> %%location_label%%4 tmp%2) (=> tmp%2 (=> %%location_label%%5 (= s1@ s2@)))))))))) (=> (= s1@ s2@) %%switch_label%%0))))))))) (=> (not (not (= (vstd!seq.Seq.len.? A&. A& s!) 0))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%6 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq_lib.impl&%0.filter.? A&. A& s! (Poly%fun%1. pred!)) (vstd!seq.Seq.empty.? A&. A&)))))))))
(check-sat)
(exit)
