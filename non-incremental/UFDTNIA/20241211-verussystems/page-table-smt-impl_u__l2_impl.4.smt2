...
(assert (= layer! (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/layer (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))))
(assert (<= layer! 3))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!impl_u.l2_impl.impl&%0.is_page. self! layer!)) (=> (ens%lib!impl_u.l2_impl.impl&%0.is_page. self! layer! tmp%1) (=> (= r! (not tmp%1)) (=> %%location_label%%1 (ite r! (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))) (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))))))))))
(check-sat)
(exit)
