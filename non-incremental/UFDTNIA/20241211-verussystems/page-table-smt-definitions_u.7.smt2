...
(assert (not (=> (= decrease%init0 (Sub j! i!)) (and (=> %%location_label%%0 (< (nClip (Add i! 1)) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. self!))))))) (and (=> %%location_label%%1 (lib!definitions_t.impl&%8.entry_size_is_next_layer_size.? (Poly%lib!definitions_t.Arch. self!) (I i!))) (and (=> %%location_label%%2 (> (lib!definitions_t.impl&%8.num_entries.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1)))) 0)) (=> (>= (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1))))) (or (and (=> (= j! (nClip (Add i! 1))) %%switch_label%%0) (=> (not (= j! (nClip (Add i! 1)))) (=> (= tmp%1 (nClip (Add i! 1))) (and (=> %%location_label%%3 (check_decrease_int (let ((self!$0 self!) (i!$1 tmp%1) (j!$2 j!)) (Sub j!$2 i!$1)) decrease%init0 false)) (and (=> %%location_label%%4 (req%lib!definitions_u.impl&%3.lemma_entry_sizes_increase. self! tmp%1 j!)) (=> (ens%lib!definitions_u.impl&%3.lemma_entry_sizes_increase. self! tmp%1 j!) %%switch_label%%0)))))) (and (not %%switch_label%%0) (=> %%location_label%%5 (>= (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I j!)))))))))))))
(check-sat)
(exit)
