...
(declare-const %return! lib!impl_u.l1.Directory.)
...
(assert (has_type n! NAT))
(assert (has_type e! TYPE%lib!impl_u.l1.NodeEntry.))
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (< (%I n!) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))) (=> %%location_label%%0 (req%vstd!seq.Seq.update. $ TYPE%lib!impl_u.l1.NodeEntry. tmp%2 n! e!))))))
(check-sat)
(exit)
