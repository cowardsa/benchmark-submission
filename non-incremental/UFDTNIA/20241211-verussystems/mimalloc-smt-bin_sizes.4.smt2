...
(assert (not (=> (= decrease%init0 (Sub (%I wsize_end!) (%I wsize_start!))) (or (and (=> (>= (%I wsize_start!) (%I wsize_end!)) (=> (= tmp%4 true) %%switch_label%%0)) (=> (not (>= (%I wsize_start!) (%I wsize_end!))) (or (and (=> (lib!bin_sizes.property_idx_in_range_has_bin_size.? bin_idx! wsize_start!) (=> (= tmp%2 (I (Add (%I wsize_start!) 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((bin_idx!$0 (%I bin_idx!)) (wsize_start!$1 (%I tmp%2)) (wsize_end!$2 (%I wsize_end!))) (Sub wsize_end!$2 wsize_start!$1)) decrease%init0 false)) (=> (= tmp%1 (lib!bin_sizes.check_idx_in_range_has_bin_size.? bin_idx! (I (Add (%I wsize_start!) 1)) wsize_end!)) (=> (= tmp%3 tmp%1) %%switch_label%%1))))) (=> (not (lib!bin_sizes.property_idx_in_range_has_bin_size.? bin_idx! wsize_start!)) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 tmp%3) %%switch_label%%0))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
