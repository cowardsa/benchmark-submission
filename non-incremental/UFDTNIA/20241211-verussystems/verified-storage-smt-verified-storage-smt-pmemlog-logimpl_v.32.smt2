...
(assert (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (and (=> (= old_ib$ main!pmemspec_t.cdb0_val.?) (= header_pos! main!logimpl_v.header2_pos.?)) (=> (= old_ib$ main!pmemspec_t.cdb1_val.?) (= header_pos! main!logimpl_v.header1_pos.?))))))))
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)) main!logimpl_v.header_size.?))
...
(assert (not (=> (= new_pm@ (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!))) (=> (= tmp%%@ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm@))) (=> (= new_ib@ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%@))))) (=> (= new_headers@ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%@))))) (=> (= new_data@ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%@))))) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I main!logimpl_v.incorruptible_bool_pos.?) (I (Add main!logimpl_v.incorruptible_bool_pos.? 8))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I main!logimpl_v.incorruptible_bool_pos.?) (I (Add main!logimpl_v.incorruptible_bool_pos.? 8))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (or (and (=> (= header_pos! main!logimpl_v.header1_pos.?) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_crc_offset.?)) (I (Add (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_crc_offset.?) 8))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_crc_offset.?)) (I (Add (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_crc_offset.?) 8))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_head_offset.?)) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_size.?))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_head_offset.?)) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_size.?))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%0))))))) (=> (not (= header_pos! main!logimpl_v.header1_pos.?)) (=> (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_crc_offset.?)) (I (Add (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_crc_offset.?) 8))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_crc_offset.?)) (I (Add (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_crc_offset.?) 8))))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_head_offset.?)) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_head_offset.?)) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?))))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 %%switch_label%%0)))))))) (and (not %%switch_label%%0) (=> %%location_label%%5 (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)))) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm$)))) (let ((new_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (and (and (and (and (= old_ib$ new_ib$) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_data$) (Poly%vstd!seq.Seq<u8.>. old_data$))) (=> (= header_pos! main!logimpl_v.header1_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_headers$))) (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_headers$)))))) (=> (= header_pos! main!logimpl_v.header2_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_headers$))) (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_headers$)))))) (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm$))))))))))))))))))))))))))
(check-sat)
(exit)
