...
(set-info :comment ";; commit_mask.rs:220:13: 220:19 (#0)")
...
(assert (has_type a@ INT))
(assert (has_type b@ (UINT SZ)))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (and (and (and (<= 0 (%I a@)) (< (%I a@) 8)) (< (%I b@) 64)) (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) a@) b@)) (=> %%location_label%%0 (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 0 8 64 $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))))))) (Poly%tuple%2. (tuple%2./tuple%2 a@ b@)))))))
(check-sat)
(exit)
