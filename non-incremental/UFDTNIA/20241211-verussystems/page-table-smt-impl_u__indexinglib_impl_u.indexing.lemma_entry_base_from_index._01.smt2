...
(set-info :comment ";; page-table/impl_u/indexing.rs:89:13: 89:19 (#0)")
...
(assert (<= 0 idx!))
(assert (<= 0 entry_size!))
(assert (has_type idx2@ NAT))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (< 0 entry_size!) (=> (< idx! (%I idx2@)) (and (=> %%location_label%%0 (req%lib!extra.mult_less_mono_both1. idx! entry_size! (%I idx2@) entry_size!)) (=> (ens%lib!extra.mult_less_mono_both1. idx! entry_size! (%I idx2@) entry_size!) (=> %%location_label%%1 (< (lib!definitions_t.entry_base_from_index.? (I base!) (I idx!) (I entry_size!)) (lib!definitions_t.entry_base_from_index.? (I base!) idx2@ (I entry_size!))))))))))
(check-sat)
(exit)
