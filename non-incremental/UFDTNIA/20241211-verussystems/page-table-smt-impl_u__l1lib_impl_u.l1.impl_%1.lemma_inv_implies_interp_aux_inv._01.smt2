...
(set-info :comment ";; page-table/impl_u/l1.rs:365:21: 373:23 (#0)")
...
(assert (<= 0 i!))
(assert (has_type (Poly%lib!definitions_t.PageTableEntry. pte$1@) TYPE%lib!definitions_t.PageTableEntry.))
(assert (has_type (Poly%lib!impl_u.l0.PageTableContents. entry_i@) TYPE%lib!impl_u.l0.PageTableContents.))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!)) (=> (= entry_i@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (=> (= (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!)) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))) (=> (< i! (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))))) (=> %%location_label%%0 (lib!impl_u.l0.impl&%0.candidate_mapping_in_bounds.? (Poly%lib!impl_u.l0.PageTableContents. entry_i@) (I (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))))))
(check-sat)
(exit)
