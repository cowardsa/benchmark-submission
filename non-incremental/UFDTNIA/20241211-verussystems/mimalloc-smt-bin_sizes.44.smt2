...
(assert (not (=> (= decrease%init0 (Sub 8 (EucMod (Add size! 7) 8))) (or (and (=> (= (uClip SZ (EucMod size! 8)) 0) (and (=> %%location_label%%0 (req%lib!bin_sizes.bin_size_result_mul8. size!)) (=> (ens%lib!bin_sizes.bin_size_result_mul8. size!) %%switch_label%%0))) (=> (not (= (uClip SZ (EucMod size! 8)) 0)) (=> (= tmp%1 (uClip SZ (Add size! 1))) (and (=> %%location_label%%1 (check_decrease_int (let ((size!$0 tmp%1)) (Sub 8 (EucMod (Add size!$0 7) 8))) decrease%init0 false)) (and (=> %%location_label%%2 (req%lib!bin_sizes.bin_size_result. tmp%1)) (=> (ens%lib!bin_sizes.bin_size_result. tmp%1) %%switch_label%%0)))))) (and (not %%switch_label%%0) (=> %%location_label%%3 (let ((tmp%%$ (lib!bin_sizes.size_of_bin.? (I (lib!bin_sizes.smallest_bin_fitting_size.? (I size!)))))) (and (>= 131072 tmp%%$) (>= tmp%%$ size!)))))))))
(check-sat)
(exit)
