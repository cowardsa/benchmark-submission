...
(assert (not (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. self!)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. self!) (=> %%location_label%%1 (lib!impl_u.l0.impl&%0.accepted_mapping.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!)))))))
(check-sat)
(exit)
