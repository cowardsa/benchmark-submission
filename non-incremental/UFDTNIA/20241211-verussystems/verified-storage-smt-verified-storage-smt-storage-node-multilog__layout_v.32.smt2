...
(set-info :comment ";; MODULE 'module multilog::layout_v'")
...
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER. FuelId)
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA. FuelId)
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID. FuelId)
(declare-const fuel%lib!multilog.layout_v.LENGTH_OF_GLOBAL_METADATA. FuelId)
...
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_NUM_LOGS. FuelId)
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_WHICH_LOG. FuelId)
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_PADDING. FuelId)
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_REGION_SIZE. FuelId)
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA. FuelId)
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_MULTILOG_ID. FuelId)
(declare-const fuel%lib!multilog.layout_v.LENGTH_OF_REGION_METADATA. FuelId)
...
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_LOG_LENGTH. FuelId)
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_PADDING. FuelId)
(declare-const fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_HEAD. FuelId)
(declare-const fuel%lib!multilog.layout_v.LENGTH_OF_LOG_METADATA. FuelId)
...
(declare-const fuel%lib!multilog.layout_v.get_log_crc_end. FuelId)
...
(declare-const fuel%lib!multilog.layout_v.parse_u32. FuelId)
(declare-const fuel%lib!multilog.layout_v.parse_u64. FuelId)
(declare-const fuel%lib!multilog.layout_v.parse_u128. FuelId)
(declare-const fuel%lib!multilog.layout_v.parse_global_metadata. FuelId)
(declare-const fuel%lib!multilog.layout_v.parse_region_metadata. FuelId)
(declare-const fuel%lib!multilog.layout_v.parse_log_metadata. FuelId)
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.is_none. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index. fuel%vstd!array.lemma_array_index. fuel%vstd!array.array_len_matches_n. fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_subrange_decreases. fuel%vstd!seq.axiom_seq_empty. fuel%vstd!seq.axiom_seq_new_len. fuel%vstd!seq.axiom_seq_new_index. fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq.axiom_seq_subrange_len. fuel%vstd!seq.axiom_seq_subrange_index. fuel%vstd!seq_lib.impl&%0.map. fuel%vstd!seq_lib.impl&%0.drop_first. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view. fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view. fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%18.view. fuel%vstd!view.impl&%20.view. fuel%vstd!view.impl&%22.view. fuel%vstd!view.impl&%24.view. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID. fuel%lib!multilog.layout_v.LENGTH_OF_GLOBAL_METADATA. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_CRC. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_REGION_METADATA. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_NUM_LOGS. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_WHICH_LOG. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_PADDING. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_REGION_SIZE. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_MULTILOG_ID. fuel%lib!multilog.layout_v.LENGTH_OF_REGION_METADATA. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_REGION_CRC. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_TRUE. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_LOG_LENGTH. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_PADDING. fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_HEAD. fuel%lib!multilog.layout_v.LENGTH_OF_LOG_METADATA. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CRC_FOR_CDB_FALSE. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CRC_FOR_CDB_TRUE. fuel%lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA. fuel%lib!multilog.layout_v.MIN_LOG_AREA_SIZE. fuel%lib!multilog.layout_v.MULTILOG_PROGRAM_GUID. fuel%lib!multilog.layout_v.MULTILOG_PROGRAM_VERSION_NUMBER. fuel%lib!multilog.layout_v.impl&%3.spec_size_of. fuel%lib!multilog.layout_v.impl&%3.spec_align_of. fuel%lib!multilog.layout_v.impl&%12.spec_size_of. fuel%lib!multilog.layout_v.impl&%12.spec_align_of. fuel%lib!multilog.layout_v.impl&%21.spec_size_of. fuel%lib!multilog.layout_v.impl&%21.spec_align_of. fuel%lib!multilog.layout_v.extract_global_metadata. fuel%lib!multilog.layout_v.deserialize_global_metadata. fuel%lib!multilog.layout_v.extract_global_crc. fuel%lib!multilog.layout_v.deserialize_global_crc. fuel%lib!multilog.layout_v.extract_region_metadata. fuel%lib!multilog.layout_v.deserialize_region_metadata. fuel%lib!multilog.layout_v.extract_region_crc. fuel%lib!multilog.layout_v.deserialize_region_crc. fuel%lib!multilog.layout_v.extract_log_cdb. fuel%lib!multilog.layout_v.extract_and_parse_log_cdb. fuel%lib!multilog.layout_v.deserialize_log_cdb. fuel%lib!multilog.layout_v.deserialize_and_check_log_cdb. fuel%lib!multilog.layout_v.get_log_metadata_pos. fuel%lib!multilog.layout_v.get_log_crc_end. fuel%lib!multilog.layout_v.extract_log_metadata. fuel%lib!multilog.layout_v.deserialize_log_metadata. fuel%lib!multilog.layout_v.extract_log_crc. fuel%lib!multilog.layout_v.deserialize_log_crc. fuel%lib!multilog.layout_v.parse_u32. fuel%lib!multilog.layout_v.parse_u64. fuel%lib!multilog.layout_v.parse_u128. fuel%lib!multilog.layout_v.parse_global_metadata. fuel%lib!multilog.layout_v.parse_region_metadata. fuel%lib!multilog.layout_v.parse_log_metadata. fuel%lib!multilog.layout_v.relative_log_pos_to_log_area_offset. fuel%lib!multilog.layout_v.extract_log. fuel%lib!multilog.layout_v.recover_abstract_log_from_region_given_metadata. fuel%lib!multilog.layout_v.recover_abstract_log_from_region_given_cdb. fuel%lib!multilog.layout_v.recover_given_cdb. fuel%lib!multilog.layout_v.recover_cdb. fuel%lib!multilog.layout_v.recover_all. fuel%lib!multilog.multilogspec_t.impl&%0.drop_pending_appends. fuel%lib!multilog.multilogspec_t.impl&%1.num_logs. fuel%lib!multilog.multilogspec_t.impl&%1.spec_index. fuel%lib!multilog.multilogspec_t.impl&%1.drop_pending_appends. fuel%lib!pmem.pmemspec_t.CDB_FALSE. fuel%lib!pmem.pmemspec_t.CDB_TRUE. fuel%lib!pmem.pmemspec_t.const_persistence_chunk_size. fuel%lib!pmem.pmemspec_t.impl&%5.flush_byte. fuel%lib!pmem.pmemspec_t.impl&%6.len. fuel%lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes_in_range. fuel%lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes. fuel%lib!pmem.pmemspec_t.impl&%6.committed. fuel%lib!pmem.pmemspec_t.impl&%6.chunk_corresponds_ignoring_outstanding_writes. fuel%lib!pmem.pmemspec_t.impl&%6.chunk_corresponds_after_flush. fuel%lib!pmem.pmemspec_t.impl&%6.can_crash_as. fuel%lib!pmem.pmemspec_t.impl&%7.len. fuel%lib!pmem.pmemspec_t.impl&%7.spec_index. fuel%lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes. fuel%lib!pmem.pmemspec_t.impl&%7.committed. fuel%lib!pmem.pmemspec_t.impl&%7.can_crash_as. fuel%lib!pmem.pmemspec_t.extract_bytes. fuel%lib!pmem.pmcopy_t.impl&%0.spec_crc. fuel%lib!pmem.pmcopy_t.impl&%7.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%7.spec_align_of. fuel%lib!pmem.pmcopy_t.impl&%15.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%15.spec_align_of. fuel%lib!pmem.pmcopy_t.impl&%19.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%19.spec_align_of. fuel%lib!pmem.pmcopy_t.impl&%23.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%23.spec_align_of. fuel%lib!pmem.pmcopy_t.impl&%27.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%27.spec_align_of. fuel%lib!pmem.pmcopy_t.impl&%55.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%55.spec_align_of. fuel%lib!pmem.pmcopy_t.impl&%60.spec_size_of. fuel%lib!pmem.pmcopy_t.impl&%60.spec_align_of. fuel%lib!util_v.nat_seq_max. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::LENGTH_OF_GLOBAL_METADATA")
(declare-fun lib!multilog.layout_v.LENGTH_OF_GLOBAL_METADATA.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_REGION_NUM_LOGS")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_REGION_NUM_LOGS.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_REGION_WHICH_LOG")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_REGION_WHICH_LOG.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_REGION_PADDING")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_REGION_PADDING.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_REGION_REGION_SIZE")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_REGION_REGION_SIZE.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_REGION_MULTILOG_ID")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_REGION_MULTILOG_ID.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::LENGTH_OF_REGION_METADATA")
(declare-fun lib!multilog.layout_v.LENGTH_OF_REGION_METADATA.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_LOG_LOG_LENGTH")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_LOG_LOG_LENGTH.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_LOG_PADDING")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_LOG_PADDING.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::RELATIVE_POS_OF_LOG_HEAD")
(declare-fun lib!multilog.layout_v.RELATIVE_POS_OF_LOG_HEAD.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::LENGTH_OF_LOG_METADATA")
(declare-fun lib!multilog.layout_v.LENGTH_OF_LOG_METADATA.? () Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::get_log_crc_end")
(declare-fun lib!multilog.layout_v.get_log_crc_end.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::parse_u32")
(declare-fun lib!multilog.layout_v.parse_u32.? (Poly Poly) Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::parse_u64")
(declare-fun lib!multilog.layout_v.parse_u64.? (Poly Poly) Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::parse_u128")
(declare-fun lib!multilog.layout_v.parse_u128.? (Poly Poly) Int)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::parse_global_metadata")
(declare-fun lib!multilog.layout_v.parse_global_metadata.? (Poly) lib!multilog.layout_v.GlobalMetadata.)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::parse_region_metadata")
(declare-fun lib!multilog.layout_v.parse_region_metadata.? (Poly) lib!multilog.layout_v.RegionMetadata.)
(set-info :comment ";; Function-Decl lib::multilog::layout_v::parse_log_metadata")
(declare-fun lib!multilog.layout_v.parse_log_metadata.? (Poly) lib!multilog.layout_v.LogMetadata.)
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_GLOBAL_METADATA")
(set-info :comment ";; src/multilog/layout_v.rs:79:5: 79:56 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_LOG_AREA")
(set-info :comment ";; src/multilog/layout_v.rs:105:5: 105:51 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_LOG_CDB")
(set-info :comment ";; src/multilog/layout_v.rs:96:5: 96:49 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE")
(set-info :comment ";; src/multilog/layout_v.rs:97:5: 97:69 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_TRUE")
(set-info :comment ";; src/multilog/layout_v.rs:98:5: 98:68 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_GLOBAL_CRC")
(set-info :comment ";; src/multilog/layout_v.rs:84:5: 84:52 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_REGION_METADATA")
(set-info :comment ";; src/multilog/layout_v.rs:86:5: 86:57 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_REGION_CRC")
(set-info :comment ";; src/multilog/layout_v.rs:94:5: 94:52 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_LOG_CRC_FOR_CDB_TRUE")
(set-info :comment ";; src/multilog/layout_v.rs:104:5: 104:63 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::ABSOLUTE_POS_OF_LOG_CRC_FOR_CDB_FALSE")
(set-info :comment ";; src/multilog/layout_v.rs:103:5: 103:64 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::MULTILOG_PROGRAM_GUID")
(set-info :comment ";; src/multilog/layout_v.rs:111:5: 111:84 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::MULTILOG_PROGRAM_VERSION_NUMBER")
(set-info :comment ";; src/multilog/layout_v.rs:116:5: 116:56 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::MIN_LOG_AREA_SIZE")
(set-info :comment ";; src/multilog/layout_v.rs:106:5: 106:42 (#0)")
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER")
(set-info :comment ";; src/multilog/layout_v.rs:80:5: 80:62 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER.) (= lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER.? 0)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA")
(set-info :comment ";; src/multilog/layout_v.rs:81:5: 81:73 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA.) (= lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA.? 8)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID")
(set-info :comment ";; src/multilog/layout_v.rs:82:5: 82:61 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID.) (= lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID.? 16)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::LENGTH_OF_GLOBAL_METADATA")
(set-info :comment ";; src/multilog/layout_v.rs:83:5: 83:51 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::LENGTH_OF_GLOBAL_METADATA")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.LENGTH_OF_GLOBAL_METADATA.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.LENGTH_OF_GLOBAL_METADATA.) (= lib!multilog.layout_v.LENGTH_OF_GLOBAL_METADATA.? 32)))
(assert (uInv 64 lib!multilog.layout_v.LENGTH_OF_GLOBAL_METADATA.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_REGION_NUM_LOGS")
(set-info :comment ";; src/multilog/layout_v.rs:87:5: 87:56 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_REGION_NUM_LOGS")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_NUM_LOGS.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_NUM_LOGS.) (= lib!multilog.layout_v.RELATIVE_POS_OF_REGION_NUM_LOGS.? 0)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_REGION_NUM_LOGS.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_REGION_WHICH_LOG")
(set-info :comment ";; src/multilog/layout_v.rs:88:5: 88:57 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_REGION_WHICH_LOG")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_WHICH_LOG.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_WHICH_LOG.) (= lib!multilog.layout_v.RELATIVE_POS_OF_REGION_WHICH_LOG.? 4)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_REGION_WHICH_LOG.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_REGION_PADDING")
(set-info :comment ";; src/multilog/layout_v.rs:89:5: 89:55 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_REGION_PADDING")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_PADDING.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_PADDING.) (= lib!multilog.layout_v.RELATIVE_POS_OF_REGION_PADDING.? 8)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_REGION_PADDING.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_REGION_REGION_SIZE")
(set-info :comment ";; src/multilog/layout_v.rs:90:5: 90:60 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_REGION_REGION_SIZE")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_REGION_SIZE.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_REGION_SIZE.) (= lib!multilog.layout_v.RELATIVE_POS_OF_REGION_REGION_SIZE.? 16)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_REGION_REGION_SIZE.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA")
(set-info :comment ";; src/multilog/layout_v.rs:91:5: 91:67 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA.) (= lib!multilog.layout_v.RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA.? 24)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_REGION_MULTILOG_ID")
(set-info :comment ";; src/multilog/layout_v.rs:92:5: 92:60 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_REGION_MULTILOG_ID")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_MULTILOG_ID.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_REGION_MULTILOG_ID.) (= lib!multilog.layout_v.RELATIVE_POS_OF_REGION_MULTILOG_ID.? 32)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_REGION_MULTILOG_ID.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::LENGTH_OF_REGION_METADATA")
(set-info :comment ";; src/multilog/layout_v.rs:93:5: 93:51 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::LENGTH_OF_REGION_METADATA")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.LENGTH_OF_REGION_METADATA.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.LENGTH_OF_REGION_METADATA.) (= lib!multilog.layout_v.LENGTH_OF_REGION_METADATA.? 48)))
(assert (uInv 64 lib!multilog.layout_v.LENGTH_OF_REGION_METADATA.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_LOG_LOG_LENGTH")
(set-info :comment ";; src/multilog/layout_v.rs:99:5: 99:55 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_LOG_LOG_LENGTH")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_LOG_LENGTH.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_LOG_LENGTH.) (= lib!multilog.layout_v.RELATIVE_POS_OF_LOG_LOG_LENGTH.? 0)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_LOG_LOG_LENGTH.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_LOG_PADDING")
(set-info :comment ";; src/multilog/layout_v.rs:100:5: 100:52 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_LOG_PADDING")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_PADDING.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_PADDING.) (= lib!multilog.layout_v.RELATIVE_POS_OF_LOG_PADDING.? 8)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_LOG_PADDING.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::RELATIVE_POS_OF_LOG_HEAD")
(set-info :comment ";; src/multilog/layout_v.rs:101:5: 101:50 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::RELATIVE_POS_OF_LOG_HEAD")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_HEAD.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.RELATIVE_POS_OF_LOG_HEAD.) (= lib!multilog.layout_v.RELATIVE_POS_OF_LOG_HEAD.? 16)))
(assert (uInv 64 lib!multilog.layout_v.RELATIVE_POS_OF_LOG_HEAD.?))
(set-info :comment ";; Function-Def lib::multilog::layout_v::LENGTH_OF_LOG_METADATA")
(set-info :comment ";; src/multilog/layout_v.rs:102:5: 102:48 (#0)")
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::LENGTH_OF_LOG_METADATA")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.LENGTH_OF_LOG_METADATA.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.LENGTH_OF_LOG_METADATA.) (= lib!multilog.layout_v.LENGTH_OF_LOG_METADATA.? 32)))
(assert (uInv 64 lib!multilog.layout_v.LENGTH_OF_LOG_METADATA.?))
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::get_log_crc_end")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.get_log_crc_end.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.get_log_crc_end.) (forall ((cdb! Poly)) (! (= (lib!multilog.layout_v.get_log_crc_end.? cdb!) (uClip 64 (Add (Add (lib!multilog.layout_v.get_log_metadata_pos.? cdb!) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.LogMetadata.))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))) :pattern ((lib!multilog.layout_v.get_log_crc_end.? cdb!))))))
(assert (forall ((cdb! Poly)) (! (=> (has_type cdb! BOOL) (uInv 64 (lib!multilog.layout_v.get_log_crc_end.? cdb!))) :pattern ((lib!multilog.layout_v.get_log_crc_end.? cdb!)))))
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::parse_u32")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.parse_u32.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.parse_u32.) (forall ((bytes! Poly) (pos! Poly)) (! (= (lib!multilog.layout_v.parse_u32.? bytes! pos!) (vstd!bytes.spec_u32_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? bytes! (I (nClip (%I pos!))) (I 4))))) :pattern ((lib!multilog.layout_v.parse_u32.? bytes! pos!))))))
(assert (forall ((bytes! Poly) (pos! Poly)) (! (=> (and (has_type bytes! (TYPE%vstd!seq.Seq. $ (UINT 8))) (has_type pos! INT)) (uInv 32 (lib!multilog.layout_v.parse_u32.? bytes! pos!))) :pattern ((lib!multilog.layout_v.parse_u32.? bytes! pos!)))))
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::parse_u64")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.parse_u64.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.parse_u64.) (forall ((bytes! Poly) (pos! Poly)) (! (= (lib!multilog.layout_v.parse_u64.? bytes! pos!) (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? bytes! (I (nClip (%I pos!))) (I 8))))) :pattern ((lib!multilog.layout_v.parse_u64.? bytes! pos!))))))
(assert (forall ((bytes! Poly) (pos! Poly)) (! (=> (and (has_type bytes! (TYPE%vstd!seq.Seq. $ (UINT 8))) (has_type pos! INT)) (uInv 64 (lib!multilog.layout_v.parse_u64.? bytes! pos!))) :pattern ((lib!multilog.layout_v.parse_u64.? bytes! pos!)))))
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::parse_u128")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.parse_u128.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.parse_u128.) (forall ((bytes! Poly) (pos! Poly)) (! (= (lib!multilog.layout_v.parse_u128.? bytes! pos!) (vstd!bytes.spec_u128_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? bytes! (I (nClip (%I pos!))) (I 16))))) :pattern ((lib!multilog.layout_v.parse_u128.? bytes! pos!))))))
(assert (forall ((bytes! Poly) (pos! Poly)) (! (=> (and (has_type bytes! (TYPE%vstd!seq.Seq. $ (UINT 8))) (has_type pos! INT)) (uInv 128 (lib!multilog.layout_v.parse_u128.? bytes! pos!))) :pattern ((lib!multilog.layout_v.parse_u128.? bytes! pos!)))))
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::parse_global_metadata")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.parse_global_metadata.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.parse_global_metadata.) (forall ((bytes! Poly)) (! (= (lib!multilog.layout_v.parse_global_metadata.? bytes!) (let ((program_guid$ (lib!multilog.layout_v.parse_u128.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_PROGRAM_GUID.?)))) (let ((version_number$ (lib!multilog.layout_v.parse_u64.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_VERSION_NUMBER.?)))) (let ((length_of_region_metadata$ (lib!multilog.layout_v.parse_u64.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_GLOBAL_LENGTH_OF_REGION_METADATA.?)))) (lib!multilog.layout_v.GlobalMetadata./GlobalMetadata (%I (I version_number$)) (%I (I length_of_region_metadata$)) (%I (I program_guid$))))))) :pattern ((lib!multilog.layout_v.parse_global_metadata.? bytes!))))))
(assert (forall ((bytes! Poly)) (! (=> (has_type bytes! (TYPE%vstd!seq.Seq. $ (UINT 8))) (has_type (Poly%lib!multilog.layout_v.GlobalMetadata. (lib!multilog.layout_v.parse_global_metadata.? bytes!)) TYPE%lib!multilog.layout_v.GlobalMetadata.)) :pattern ((lib!multilog.layout_v.parse_global_metadata.? bytes!)))))
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::parse_region_metadata")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.parse_region_metadata.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.parse_region_metadata.) (forall ((bytes! Poly)) (! (= (lib!multilog.layout_v.parse_region_metadata.? bytes!) (let ((region_size$ (lib!multilog.layout_v.parse_u64.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_REGION_REGION_SIZE.?)))) (let ((multilog_id$ (lib!multilog.layout_v.parse_u128.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_REGION_MULTILOG_ID.?)))) (let ((num_logs$ (lib!multilog.layout_v.parse_u32.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_REGION_NUM_LOGS.?)))) (let ((which_log$ (lib!multilog.layout_v.parse_u32.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_REGION_WHICH_LOG.?)))) (let ((log_area_len$ (lib!multilog.layout_v.parse_u64.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_REGION_LENGTH_OF_LOG_AREA.?)))) (lib!multilog.layout_v.RegionMetadata./RegionMetadata (%I (I num_logs$)) (%I (I which_log$)) (%I (I 0)) (%I (I region_size$)) (%I (I log_area_len$)) (%I (I multilog_id$))))))))) :pattern ((lib!multilog.layout_v.parse_region_metadata.? bytes!))))))
(assert (forall ((bytes! Poly)) (! (=> (has_type bytes! (TYPE%vstd!seq.Seq. $ (UINT 8))) (has_type (Poly%lib!multilog.layout_v.RegionMetadata. (lib!multilog.layout_v.parse_region_metadata.? bytes!)) TYPE%lib!multilog.layout_v.RegionMetadata.)) :pattern ((lib!multilog.layout_v.parse_region_metadata.? bytes!)))))
(set-info :comment ";; Function-Axioms lib::multilog::layout_v::parse_log_metadata")
(assert (fuel_bool_default fuel%lib!multilog.layout_v.parse_log_metadata.))
(assert (=> (fuel_bool fuel%lib!multilog.layout_v.parse_log_metadata.) (forall ((bytes! Poly)) (! (= (lib!multilog.layout_v.parse_log_metadata.? bytes!) (let ((head$ (lib!multilog.layout_v.parse_u128.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_LOG_HEAD.?)))) (let ((log_length$ (lib!multilog.layout_v.parse_u64.? bytes! (I lib!multilog.layout_v.RELATIVE_POS_OF_LOG_LOG_LENGTH.?)))) (lib!multilog.layout_v.LogMetadata./LogMetadata (%I (I log_length$)) (%I (I 0)) (%I (I head$)))))) :pattern ((lib!multilog.layout_v.parse_log_metadata.? bytes!))))))
(assert (forall ((bytes! Poly)) (! (=> (has_type bytes! (TYPE%vstd!seq.Seq. $ (UINT 8))) (has_type (Poly%lib!multilog.layout_v.LogMetadata. (lib!multilog.layout_v.parse_log_metadata.? bytes!)) TYPE%lib!multilog.layout_v.LogMetadata.)) :pattern ((lib!multilog.layout_v.parse_log_metadata.? bytes!)))))
...
(declare-fun %%lambda%%3 (Poly Poly Int Dcr Type Poly) %%Function%%)
(assert (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (pos_relative_to_head$ Poly)) (! (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) pos_relative_to_head$) (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 (I (Add %%hole%%2 (lib!multilog.layout_v.relative_log_pos_to_log_area_offset.? pos_relative_to_head$ %%hole%%0 %%hole%%1))))) :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) pos_relative_to_head$)))))
...
(assert (forall ((_idx$ Poly) (s$ Poly)) (! (= (%%apply%%1 %%lambda%%6 _idx$ s$) (Poly%lib!multilog.multilogspec_t.AbstractLogState. (lib!multilog.multilogspec_t.impl&%0.drop_pending_appends.? s$))) :pattern ((%%apply%%1 %%lambda%%6 _idx$ s$)))))
(assert (=> (fuel_bool fuel%lib!multilog.multilogspec_t.impl&%1.drop_pending_appends.) (forall ((self! Poly)) (! (= (lib!multilog.multilogspec_t.impl&%1.drop_pending_appends.? self!) (lib!multilog.multilogspec_t.AbstractMultiLogState./AbstractMultiLogState (%Poly%vstd!seq.Seq<lib!multilog.multilogspec_t.AbstractLogState.>. (vstd!seq_lib.impl&%0.map.? $ TYPE%lib!multilog.multilogspec_t.AbstractLogState. $ TYPE%lib!multilog.multilogspec_t.AbstractLogState. (Poly%vstd!seq.Seq<lib!multilog.multilogspec_t.AbstractLogState.>. (lib!multilog.multilogspec_t.AbstractMultiLogState./AbstractMultiLogState/states (%Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. self!))) (Poly%fun%2. (mk_fun %%lambda%%6)))))) :pattern ((lib!multilog.multilogspec_t.impl&%1.drop_pending_appends.? self!))))))
...
(assert (forall ((%%hole%%0 Poly) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%7 %%hole%%0) i$) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? %%hole%%0 i$))))) :pattern ((%%apply%%0 (%%lambda%%7 %%hole%%0) i$)))))
(assert (=> (fuel_bool fuel%lib!pmem.pmemspec_t.impl&%7.committed.) (forall ((self! Poly)) (! (= (lib!pmem.pmemspec_t.impl&%7.committed.? self!) (%Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (vstd!seq.Seq.new.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) $ (TYPE%fun%1. $ INT $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (I (lib!pmem.pmemspec_t.impl&%7.len.? self!)) (Poly%fun%1. (mk_fun (%%lambda%%7 self!)))))) :pattern ((lib!pmem.pmemspec_t.impl&%7.committed.? self!))))))
...
(set-info :comment ";; Function-Def lib::multilog::layout_v::lemma_establish_subrange_equivalence")
(set-info :comment ";; src/multilog/layout_v.rs:783:5: 786:6 (#0)")
(set-info :comment ";; Function-Specs lib::pmem::pmemutil_v::lemma_if_no_outstanding_writes_then_persistent_memory_regions_view_can_only_crash_as_committed")
(declare-fun req%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_regions_view_can_only_crash_as_committed. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) Bool)
(declare-const %%global_location_label%%10 Bool)
(assert (forall ((pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)) (! (= (req%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_regions_view_can_only_crash_as_committed. pm_regions_view!) (=> %%global_location_label%%10 (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!)))) :pattern ((req%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_regions_view_can_only_crash_as_committed. pm_regions_view!)))))
(declare-fun ens%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_regions_view_can_only_crash_as_committed. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) Bool)
(assert (forall ((pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)) (! (= (ens%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_regions_view_can_only_crash_as_committed. pm_regions_view!) (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$) (= (%Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. s$) (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))))) :pattern ((lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$))))) :pattern ((ens%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_regions_view_can_only_crash_as_committed. pm_regions_view!)))))
(set-info :comment ";; Function-Specs lib::multilog::layout_v::lemma_if_no_outstanding_writes_then_can_only_crash_as_state")
(declare-fun req%lib!multilog.layout_v.lemma_if_no_outstanding_writes_then_can_only_crash_as_state. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Int lib!multilog.multilogspec_t.AbstractMultiLogState.) Bool)
(declare-const %%global_location_label%%11 Bool)
(declare-const %%global_location_label%%12 Bool)
(assert (forall ((pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (multilog_id! Int) (state! lib!multilog.multilogspec_t.AbstractMultiLogState.)) (! (= (req%lib!multilog.layout_v.lemma_if_no_outstanding_writes_then_can_only_crash_as_state. pm_regions_view! multilog_id! state!) (and (=> %%global_location_label%%11 (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))) (=> %%global_location_label%%12 (= (lib!multilog.layout_v.recover_all.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))) (I multilog_id!)) (core!option.Option./Some (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!)))))) :pattern ((req%lib!multilog.layout_v.lemma_if_no_outstanding_writes_then_can_only_crash_as_state. pm_regions_view! multilog_id! state!)))))
(declare-fun ens%lib!multilog.layout_v.lemma_if_no_outstanding_writes_then_can_only_crash_as_state. (lib!pmem.pmemspec_t.PersistentMemoryRegionsView. Int lib!multilog.multilogspec_t.AbstractMultiLogState.) Bool)
(assert (forall ((pm_regions_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.) (multilog_id! Int) (state! lib!multilog.multilogspec_t.AbstractMultiLogState.)) (! (= (ens%lib!multilog.layout_v.lemma_if_no_outstanding_writes_then_can_only_crash_as_state. pm_regions_view! multilog_id! state!) (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$) (= (lib!multilog.layout_v.recover_all.? s$ (I multilog_id!)) (core!option.Option./Some (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!))))) :pattern ((lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$))))) :pattern ((ens%lib!multilog.layout_v.lemma_if_no_outstanding_writes_then_can_only_crash_as_state. pm_regions_view! multilog_id! state!)))))
(set-info :comment ";; Function-Def lib::multilog::layout_v::lemma_if_no_outstanding_writes_then_can_only_crash_as_state")
(set-info :comment ";; src/multilog/layout_v.rs:720:5: 724:6 (#0)")
(set-info :comment ";; Function-Specs lib::multilog::layout_v::lemma_recover_all_successful_implies_region_sizes_sufficient")
(declare-fun req%lib!multilog.layout_v.lemma_recover_all_successful_implies_region_sizes_sufficient. (vstd!seq.Seq<vstd!seq.Seq<u8.>.>. Int) Bool)
(declare-const %%global_location_label%%13 Bool)
(assert (forall ((mems! vstd!seq.Seq<vstd!seq.Seq<u8.>.>.) (multilog_id! Int)) (! (= (req%lib!multilog.layout_v.lemma_recover_all_successful_implies_region_sizes_sufficient. mems! multilog_id!) (=> %%global_location_label%%13 (is-core!option.Option./Some_ (lib!multilog.layout_v.recover_all.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) (I multilog_id!))))) :pattern ((req%lib!multilog.layout_v.lemma_recover_all_successful_implies_region_sizes_sufficient. mems! multilog_id!)))))
(declare-fun ens%lib!multilog.layout_v.lemma_recover_all_successful_implies_region_sizes_sufficient. (vstd!seq.Seq<vstd!seq.Seq<u8.>.>. Int) Bool)
(assert (forall ((mems! vstd!seq.Seq<vstd!seq.Seq<u8.>.>.) (multilog_id! Int)) (! (= (ens%lib!multilog.layout_v.lemma_recover_all_successful_implies_region_sizes_sufficient. mems! multilog_id!) (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!)))) (>= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) i$)) (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!multilog.layout_v.MIN_LOG_AREA_SIZE.?)))) :pattern ((vstd!seq.Seq.len.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) i$)))))) :pattern ((ens%lib!multilog.layout_v.lemma_recover_all_successful_implies_region_sizes_sufficient. mems! multilog_id!)))))
(set-info :comment ";; Function-Def lib::multilog::layout_v::lemma_recover_all_successful_implies_region_sizes_sufficient")
(set-info :comment ";; src/multilog/layout_v.rs:742:5: 742:117 (#0)")
(set-info :comment ";; Function-Specs lib::multilog::layout_v::lemma_recovered_state_is_crash_idempotent")
(declare-fun req%lib!multilog.layout_v.lemma_recovered_state_is_crash_idempotent. (vstd!seq.Seq<vstd!seq.Seq<u8.>.>. Int) Bool)
(declare-const %%global_location_label%%14 Bool)
(assert (forall ((mems! vstd!seq.Seq<vstd!seq.Seq<u8.>.>.) (multilog_id! Int)) (! (= (req%lib!multilog.layout_v.lemma_recovered_state_is_crash_idempotent. mems! multilog_id!) (=> %%global_location_label%%14 (is-core!option.Option./Some_ (lib!multilog.layout_v.recover_all.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) (I multilog_id!))))) :pattern ((req%lib!multilog.layout_v.lemma_recovered_state_is_crash_idempotent. mems! multilog_id!)))))
(declare-fun ens%lib!multilog.layout_v.lemma_recovered_state_is_crash_idempotent. (vstd!seq.Seq<vstd!seq.Seq<u8.>.>. Int) Bool)
(assert (forall ((mems! vstd!seq.Seq<vstd!seq.Seq<u8.>.>.) (multilog_id! Int)) (! (= (ens%lib!multilog.layout_v.lemma_recovered_state_is_crash_idempotent. mems! multilog_id!) (let ((state$ (%Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!multilog.layout_v.recover_all.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) (I multilog_id!)))))))) (= state$ (lib!multilog.multilogspec_t.impl&%1.drop_pending_appends.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state$))))) :pattern ((ens%lib!multilog.layout_v.lemma_recovered_state_is_crash_idempotent. mems! multilog_id!)))))
(set-info :comment ";; Function-Def lib::multilog::layout_v::lemma_recovered_state_is_crash_idempotent")
(set-info :comment ";; src/multilog/layout_v.rs:797:5: 797:98 (#0)")
(declare-const mems! vstd!seq.Seq<vstd!seq.Seq<u8.>.>.)
(declare-const multilog_id! Int)
(declare-const which_log@ Poly)
(declare-const tmp%1 Bool)
(declare-const state@ lib!multilog.multilogspec_t.AbstractMultiLogState.)
(assert fuel_defaults)
(assert (uInv 128 multilog_id!))
(assert (is-core!option.Option./Some_ (lib!multilog.layout_v.recover_all.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) (I multilog_id!))))
...
(assert (not (=> (= state@ (%Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!multilog.layout_v.recover_all.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) (I multilog_id!))))))) (and (=> (has_type which_log@ INT) (=> (and (<= 0 (%I which_log@)) (< (%I which_log@) (lib!multilog.multilogspec_t.impl&%1.num_logs.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state@)))) (=> %%location_label%%0 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!multilog.multilogspec_t.AbstractLogState./AbstractLogState/pending (%Poly%lib!multilog.multilogspec_t.AbstractLogState. (Poly%lib!multilog.multilogspec_t.AbstractLogState. (lib!multilog.multilogspec_t.impl&%1.spec_index.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state@) which_log@)))))) 0)))) (=> (forall ((which_log$ Poly)) (! (=> (has_type which_log$ INT) (=> (and (<= 0 (%I which_log$)) (< (%I which_log$) (lib!multilog.multilogspec_t.impl&%1.num_logs.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state@)))) (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!multilog.multilogspec_t.AbstractLogState./AbstractLogState/pending (%Poly%lib!multilog.multilogspec_t.AbstractLogState. (Poly%lib!multilog.multilogspec_t.AbstractLogState. (lib!multilog.multilogspec_t.impl&%1.spec_index.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state@) which_log$)))))) 0))) :pattern ((lib!multilog.multilogspec_t.impl&%1.spec_index.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state@) which_log$)))) (=> (= tmp%1 (ext_eq false TYPE%lib!multilog.multilogspec_t.AbstractMultiLogState. (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state@) (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. (lib!multilog.multilogspec_t.impl&%1.drop_pending_appends.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state@))))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (let ((state$ (%Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!multilog.layout_v.recover_all.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) (I multilog_id!)))))))) (= state$ (lib!multilog.multilogspec_t.impl&%1.drop_pending_appends.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state$)))))))))))))
(check-sat)
(exit)
