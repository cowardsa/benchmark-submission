...
(set-info :comment ";; bin_sizes.rs:480:7: 480:29 (#0)")
...
(set-info :comment ";; Function-Def lib::bin_sizes::div2")
(set-info :comment ";; bin_sizes.rs:480:7: 480:29 (#0)")
(declare-const x! Int)
(declare-const y! Int)
...
(assert (not (=> %%location_label%%0 (= (EucDiv x! (Mul y! 2)) (EucDiv (EucDiv x! y!) 2)))))
(check-sat)
(exit)
