...
(set-info :comment ";; src/math.rs:183:5: 183:90 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_strict_upper_bound")
(set-info :comment ";; src/math.rs:183:5: 183:90 (#0)")
(declare-const x! Int)
...
(assert (not (=> (= tmp%1 (Sub x_bound! 1)) (=> (= tmp%2 (Sub y_bound! 1)) (and (=> %%location_label%%0 (req%main!math.lemma_mul_upper_bound. x! tmp%1 y! tmp%2)) (=> (ens%main!math.lemma_mul_upper_bound. x! tmp%1 y! tmp%2) (=> (= tmp%3 (= (Mul (Sub x_bound! 1) (Sub y_bound! 1)) (Add (Sub (Sub (Mul x_bound! y_bound!) y_bound!) x_bound!) 1))) (and (=> %%location_label%%1 tmp%3) (=> tmp%3 (=> %%location_label%%2 (< (Mul x! y!) (Mul x_bound! y_bound!))))))))))))
(check-sat)
(exit)
