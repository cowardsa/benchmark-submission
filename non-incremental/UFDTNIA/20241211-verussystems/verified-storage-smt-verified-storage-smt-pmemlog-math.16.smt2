...
(assert (not (and (=> %%location_label%%0 (req%main!math.lemma_fundamental_div_mod_converse_helper_1. q! d! r!)) (=> (ens%main!math.lemma_fundamental_div_mod_converse_helper_1. q! d! r!) (=> (= tmp%1 (= q! (EucDiv (Add (Mul q! d!) r!) d!))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (and (=> %%location_label%%2 (req%main!math.lemma_fundamental_div_mod_converse_helper_2. q! d! r!)) (=> (ens%main!math.lemma_fundamental_div_mod_converse_helper_2. q! d! r!) (and (=> %%location_label%%3 (= q! (EucDiv x! d!))) (=> %%location_label%%4 (= r! (EucMod x! d!)))))))))))))
(check-sat)
(exit)
