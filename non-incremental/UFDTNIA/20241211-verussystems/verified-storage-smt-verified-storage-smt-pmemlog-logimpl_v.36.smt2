...
(declare-const pm_state$1@ main!infinitelog_t.AbstractInfiniteLogState.)
(declare-const pm_state@ core!option.Option.)
(declare-const header@ main!logimpl_v.PersistentHeader.)
(declare-const head@ Int)
(declare-const tail@ Int)
(declare-const log_size@ Int)
(declare-const physical_head@ Int)
(declare-const physical_tail@ Int)
(assert fuel_defaults)
(assert (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!))))
(assert (let ((header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (< (Sub (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$)))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$))))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$)))))))))
...
(assert (not (=> (= pm_state@ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!))) (=> (= header@ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!))) (=> (= tmp%1 (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (=> (= tmp%2 (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (and (=> %%location_label%%0 (req%main!math.lemma_mod_range. tmp%1 tmp%2)) (=> (ens%main!math.lemma_mod_range. tmp%1 tmp%2) (=> (= tmp%3 (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (=> (= tmp%4 (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (and (=> %%location_label%%1 (req%main!math.lemma_mod_range. tmp%3 tmp%4)) (=> (ens%main!math.lemma_mod_range. tmp%3 tmp%4) (=> (= head@ (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (=> (= tail@ (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (=> (= log_size@ (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))))))) (=> (= physical_head@ (main!logimpl_v.spec_addr_logical_to_physical.? (I head@) (I log_size@))) (=> (= physical_tail@ (main!logimpl_v.spec_addr_logical_to_physical.? (I tail@) (I log_size@))) (or (and (=> (is-core!option.Option./Some_ pm_state@) (=> (= pm_state$1@ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. pm_state@))))) (or (and (=> (< physical_head@ physical_tail@) (and (=> %%location_label%%2 (req%main!math.lemma_mod_difference_equal. head@ tail@ log_size@)) (=> (ens%main!math.lemma_mod_difference_equal. head@ tail@ log_size@) %%switch_label%%1))) (=> (not (< physical_head@ physical_tail@)) (or (and (=> (< physical_tail@ physical_head@) (and (=> %%location_label%%3 (req%main!math.lemma_mod_wrapped_len. head@ tail@ log_size@)) (=> (ens%main!math.lemma_mod_wrapped_len. head@ tail@ log_size@) %%switch_label%%2))) (=> (not (< physical_tail@ physical_head@)) (and (=> %%location_label%%4 (req%main!math.lemma_mod_equal. head@ tail@ log_size@)) (=> (ens%main!math.lemma_mod_equal. head@ tail@ log_size@) %%switch_label%%2)))) (and (not %%switch_label%%2) %%switch_label%%1)))) (and (not %%switch_label%%1) %%switch_label%%0)))) (=> (not (is-core!option.Option./Some_ pm_state@)) (=> %%location_label%%5 false))) (and (not %%switch_label%%0) (=> %%location_label%%6 (let ((pm_state$ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (and (is-core!option.Option./Some_ pm_state$) (let ((pm_state$1 (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. pm_state$)))))) (and (= (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$)))))) (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. pm_state$1)))) (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. pm_state$1))))) (Sub (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$)))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$)))))))))))))))))))))))))))))))))
(check-sat)
(exit)
