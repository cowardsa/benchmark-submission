...
(declare-const %return! main!logimpl_v.PersistentHeaderMetadata.)
(declare-const header_seq! Poly)
...
(assert (has_type header_seq! (TYPE%vstd!seq.Seq. $ (UINT 8))))
...
(assert (not (=> (= (vstd!seq.Seq.len.? $ (UINT 8) header_seq!) (nClip (Mul 3 8))) (=> (= tmp%2 (I (Sub main!logimpl_v.header_head_offset.? 8))) (=> (= tmp%3 (I (Add (Sub main!logimpl_v.header_head_offset.? 8) 8))) (and (=> %%location_label%%0 (req%vstd!seq.Seq.subrange. $ (UINT 8) header_seq! tmp%2 tmp%3)) (=> (= tmp%1 (vstd!seq.Seq.subrange.? $ (UINT 8) header_seq! (I (Sub main!logimpl_v.header_head_offset.? 8)) (I (Add (Sub main!logimpl_v.header_head_offset.? 8) 8)))) (and (=> %%location_label%%1 (req%vstd!bytes.spec_u64_from_le_bytes. tmp%1)) (=> (= tmp%5 (I (Sub main!logimpl_v.header_tail_offset.? 8))) (=> (= tmp%6 (I (Add (Sub main!logimpl_v.header_tail_offset.? 8) 8))) (and (=> %%location_label%%2 (req%vstd!seq.Seq.subrange. $ (UINT 8) header_seq! tmp%5 tmp%6)) (=> (= tmp%4 (vstd!seq.Seq.subrange.? $ (UINT 8) header_seq! (I (Sub main!logimpl_v.header_tail_offset.? 8)) (I (Add (Sub main!logimpl_v.header_tail_offset.? 8) 8)))) (and (=> %%location_label%%3 (req%vstd!bytes.spec_u64_from_le_bytes. tmp%4)) (=> (= tmp%8 (I (Sub main!logimpl_v.header_log_size_offset.? 8))) (=> (= tmp%9 (I (Add (Sub main!logimpl_v.header_log_size_offset.? 8) 8))) (and (=> %%location_label%%4 (req%vstd!seq.Seq.subrange. $ (UINT 8) header_seq! tmp%8 tmp%9)) (=> (= tmp%7 (vstd!seq.Seq.subrange.? $ (UINT 8) header_seq! (I (Sub main!logimpl_v.header_log_size_offset.? 8)) (I (Add (Sub main!logimpl_v.header_log_size_offset.? 8) 8)))) (=> %%location_label%%5 (req%vstd!bytes.spec_u64_from_le_bytes. tmp%7)))))))))))))))))))
(check-sat)
(exit)
