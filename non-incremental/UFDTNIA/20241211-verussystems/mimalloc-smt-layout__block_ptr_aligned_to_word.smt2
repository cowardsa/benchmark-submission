...
(set-info :comment ";; MODULE 'module layout, function lib::layout::block_ptr_aligned_to_word'")
...
(assert (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index. fuel%vstd!array.lemma_array_index. fuel%vstd!array.array_len_matches_n. fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!raw_ptr.spec_cast_ptr_to_usize. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_new_len. fuel%vstd!seq.axiom_seq_new_index. fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view. fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view. fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%16.view. fuel%vstd!view.impl&%18.view. fuel%vstd!view.impl&%20.view. fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%32.view. fuel%vstd!view.impl&%42.view. fuel%vstd!view.impl&%46.view. fuel%lib!layout.segment_start. fuel%lib!layout.page_start. fuel%lib!layout.start_offset. fuel%lib!layout.block_start_at. fuel%lib!layout.block_start. fuel%lib!layout.is_block_ptr. fuel%lib!layout.is_block_ptr1. fuel%lib!config.INTPTR_SHIFT. fuel%lib!config.INTPTR_SIZE. fuel%lib!config.SLICE_SHIFT. fuel%lib!config.SLICE_SIZE. fuel%lib!config.SEGMENT_SHIFT. fuel%lib!config.SEGMENT_SIZE. fuel%lib!config.SLICES_PER_SEGMENT. fuel%lib!config.SMALL_PAGE_SHIFT. fuel%lib!config.MEDIUM_PAGE_SHIFT. fuel%lib!config.SMALL_PAGE_SIZE. fuel%lib!config.MEDIUM_PAGE_SIZE. fuel%lib!config.SMALL_OBJ_SIZE_MAX. fuel%lib!config.MEDIUM_OBJ_SIZE_MAX. fuel%lib!config.MEDIUM_OBJ_WSIZE_MAX. fuel%lib!config.LARGE_OBJ_SIZE_MAX. fuel%lib!config.SMALL_WSIZE_MAX. fuel%lib!config.SMALL_SIZE_MAX. fuel%lib!config.MAX_ALIGN_SIZE. fuel%lib!config.MAX_ALIGN_GUARANTEE. fuel%lib!config.SIZEOF_SEGMENT_HEADER. fuel%lib!config.SIZEOF_PAGE_HEADER. fuel%lib!config.SIZEOF_HEAP. fuel%lib!config.SIZEOF_TLD. fuel%lib!config.COMMIT_MASK_BITS. fuel%lib!config.COMMIT_MASK_FIELD_COUNT. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (req%lib!layout.mod_mul. a! b! c!) (=> %%global_location_label%%3 (= (EucMod b! c!) 0))) :pattern ((req%lib!layout.mod_mul. a! b! c!)))))
...
(set-info :comment ";; Function-Def lib::layout::block_ptr_aligned_to_word")
(set-info :comment ";; layout.rs:122:1: 122:41 (#0)")
(declare-const no%param Int)
(declare-const p@ Poly)
(declare-const block_id@ Poly)
...
(assert (not (and (=> (has_type p@ (PTR $ (UINT 8))) (=> (has_type block_id@ TYPE%lib!tokens.BlockId.) (=> (lib!layout.is_block_ptr.? p@ block_id@) (=> (ens%lib!config.const_facts. 0) (=> (fuel_bool fuel%lib!layout.is_block_ptr1.) (=> (ens%lib!linked_list.size_of_node. 0) (=> (= page_id@ (lib!tokens.BlockId./BlockId/page_id (%Poly%lib!tokens.BlockId. block_id@))) (=> (= tmp%1 (= (EucMod (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. page_id@))))) 8) 0)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (= (uClip 64 (EucMod lib!config.SLICE_SIZE.? 8)) 0)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (= (EucMod (lib!layout.page_start.? (Poly%lib!tokens.PageId. page_id@)) 8) 0)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= block_size@ (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. block_id@))) (=> (= tmp%4 (= (EucMod (lib!layout.start_offset.? (I block_size@)) 8) 0)) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (= (nClip (EucMod block_size@ 8)) 0)) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= block_idx@ (lib!tokens.BlockId./BlockId/idx (%Poly%lib!tokens.BlockId. block_id@))) (and (=> %%location_label%%5 (req%lib!layout.mod_mul. block_idx@ block_size@ 8)) (=> (ens%lib!layout.mod_mul. block_idx@ block_size@ 8) (=> (= tmp%6 (= (EucMod (Mul block_idx@ block_size@) 8) 0)) (and (=> %%location_label%%6 tmp%6) (=> tmp%6 (=> (= tmp%7 (= (EucMod (lib!layout.block_start.? block_id@) 8) 0)) (and (=> %%location_label%%7 tmp%7) (=> tmp%7 (=> (= tmp%8 (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) p@) 8) 0)) (and (=> %%location_label%%8 tmp%8) (=> tmp%8 (=> %%location_label%%9 (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) p@) (vstd!layout.align_of.? $ TYPE%lib!linked_list.Node.)) 0))))))))))))))))))))))))))))))))))))) (=> (forall ((p$ Poly) (block_id$ Poly)) (! (=> (and (has_type p$ (PTR $ (UINT 8))) (has_type block_id$ TYPE%lib!tokens.BlockId.)) (=> (lib!layout.is_block_ptr.? p$ block_id$) (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) p$) (vstd!layout.align_of.? $ TYPE%lib!linked_list.Node.)) 0))) :pattern ((lib!layout.is_block_ptr.? p$ block_id$)))) (=> %%location_label%%10 (forall ((p$ Poly) (block_id$ Poly)) (! (=> (and (has_type p$ (PTR $ (UINT 8))) (has_type block_id$ TYPE%lib!tokens.BlockId.)) (=> (lib!layout.is_block_ptr.? p$ block_id$) (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) p$) (vstd!layout.align_of.? $ TYPE%lib!linked_list.Node.)) 0))) :pattern ((lib!layout.is_block_ptr.? p$ block_id$)))))))))
(check-sat)
(exit)
