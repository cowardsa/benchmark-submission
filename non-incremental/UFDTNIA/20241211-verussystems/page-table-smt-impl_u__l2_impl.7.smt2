...
(declare-const mask_dir_addr@ Int)
...
(assert (not (and (=> (has_type addr@ (UINT 64)) (=> (and (<= (%I addr@) lib!definitions_t.MAX_PHYADDR_SPEC.?) (lib!definitions_t.aligned.? addr@ (I lib!definitions_t.PAGE_SIZE.?))) (=> (= max_width@ lib!definitions_t.MAX_PHYADDR_WIDTH.?) (=> (= mask_dir_addr@ lib!spec_t.hardware.MASK_DIR_ADDR_SPEC.?) (and (=> %%location_label%%0 (<= (%I addr@) (uClip 64 (Sub (uClip 64 (bitshl (I 1) (I max_width@))) 1)))) (and (=> %%location_label%%1 (= (uClip 64 (EucMod (%I addr@) 4096)) 0)) (and (=> %%location_label%%2 (= mask_dir_addr@ (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add (uClip 64 (Sub max_width@ 1)) 1)) 12))))))))) (I 12))))) (=> (= (uClip 64 (bitand (I (%I addr@)) (I mask_dir_addr@))) (%I addr@)) (=> %%location_label%%3 (= (uClip 64 (bitand (I (%I addr@)) (I lib!spec_t.hardware.MASK_DIR_ADDR_SPEC.?))) (%I addr@))))))))))) (=> (forall ((addr$ Poly)) (! (=> (has_type addr$ (UINT 64)) (=> (and (<= (%I addr$) lib!definitions_t.MAX_PHYADDR_SPEC.?) (lib!definitions_t.aligned.? addr$ (I lib!definitions_t.PAGE_SIZE.?))) (= (uClip 64 (bitand (I (%I addr$)) (I lib!spec_t.hardware.MASK_DIR_ADDR_SPEC.?))) (%I addr$)))) :pattern ((lib!definitions_t.aligned.? addr$ (I lib!definitions_t.PAGE_SIZE.?))))) (=> %%location_label%%4 (forall ((addr$ Poly)) (! (=> (has_type addr$ (UINT 64)) (=> (<= (%I addr$) lib!definitions_t.MAX_PHYADDR_SPEC.?) (=> (lib!definitions_t.aligned.? addr$ (I lib!definitions_t.PAGE_SIZE.?)) (= (uClip 64 (bitand (I (%I addr$)) (I lib!spec_t.hardware.MASK_DIR_ADDR_SPEC.?))) (%I addr$))))) :pattern ((lib!definitions_t.aligned.? addr$ (I lib!definitions_t.PAGE_SIZE.?))))))))))
(check-sat)
(exit)
