...
(set-info :comment ";; src/math.rs:269:5: 269:67 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_is_distributive")
(set-info :comment ";; src/math.rs:269:5: 269:67 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (not (and (=> %%location_label%%0 (= (Mul x! (Add y! z!)) (Add (Mul x! y!) (Mul x! z!)))) (and (=> %%location_label%%1 (= (Mul x! (Sub y! z!)) (Sub (Mul x! y!) (Mul x! z!)))) (and (=> %%location_label%%2 (= (Mul (Add y! z!) x!) (Add (Mul y! x!) (Mul z! x!)))) (and (=> %%location_label%%3 (= (Mul (Sub y! z!) x!) (Sub (Mul y! x!) (Mul z! x!)))) (and (=> %%location_label%%4 (= (Mul x! (Add y! z!)) (Mul (Add y! z!) x!))) (and (=> %%location_label%%5 (= (Mul x! (Sub y! z!)) (Mul (Sub y! z!) x!))) (and (=> %%location_label%%6 (= (Mul x! y!) (Mul y! x!))) (=> %%location_label%%7 (= (Mul x! z!) (Mul z! x!))))))))))))
(check-sat)
(exit)
