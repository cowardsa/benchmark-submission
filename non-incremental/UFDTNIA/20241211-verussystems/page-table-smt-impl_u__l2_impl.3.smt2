...
(assert (not (=> (= r! (=> (not (= layer! 3)) (and (not (= layer! 0)) (= (uClip 64 (bitand (I (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/entry (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (I lib!spec_t.hardware.MASK_L1_PG_FLAG_PS.?))) lib!spec_t.hardware.MASK_L1_PG_FLAG_PS.?)))) (=> %%location_label%%0 (ite r! (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))) (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))))))))
(check-sat)
(exit)
