...
(assert (<= 0 block_size!))
(assert (has_type (Poly%core!option.Option. heap_id!) (TYPE%core!option.Option. $ TYPE%lib!tokens.HeapId.)))
(assert (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. self!@0)))
(assert (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!@0)) 0))
...
(declare-const self!@5 lib!linked_list.LL.)
...
(assert (not (=> (= (lib!linked_list.LLData./LLData/fixed_page (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@1)))))) fixed_page!) (=> (and (= (lib!linked_list.LL./LL/first self!@0) (lib!linked_list.LL./LL/first self!@1)) (= (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@0)) (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@1))) (= (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@0)) (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@1))) (= (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@0)) (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@1))) (= (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@0)) (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@1))) (= (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@0)) (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@1))) (= (lib!linked_list.LL./LL/perms self!@0) (lib!linked_list.LL./LL/perms self!@1))) (=> (= (lib!linked_list.LLData./LLData/block_size (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@2)))))) block_size!) (=> (and (= (lib!linked_list.LL./LL/first self!@1) (lib!linked_list.LL./LL/first self!@2)) (= (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@1)) (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@2))) (= (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@1)) (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@2))) (= (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@1)) (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@2))) (= (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@1)) (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@2))) (= (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@1)) (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@2))) (= (lib!linked_list.LL./LL/perms self!@1) (lib!linked_list.LL./LL/perms self!@2))) (=> (= (lib!linked_list.LLData./LLData/page_id (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3)))))) page_id!) (=> (and (= (lib!linked_list.LL./LL/first self!@2) (lib!linked_list.LL./LL/first self!@3)) (= (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LL./LL/perms self!@2) (lib!linked_list.LL./LL/perms self!@3))) (=> (= (lib!linked_list.LLData./LLData/instance (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@4)))))) instance!) (=> (and (= (lib!linked_list.LL./LL/first self!@3) (lib!linked_list.LL./LL/first self!@4)) (= (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@3)) (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@4))) (= (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@3)) (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@4))) (= (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@3)) (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@4))) (= (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@3)) (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@4))) (= (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@3)) (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@4))) (= (lib!linked_list.LL./LL/perms self!@3) (lib!linked_list.LL./LL/perms self!@4))) (=> (= (lib!linked_list.LLData./LLData/heap_id (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@5)))))) heap_id!) (=> (and (= (lib!linked_list.LL./LL/first self!@4) (lib!linked_list.LL./LL/first self!@5)) (= (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@4)) (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@5))) (= (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@4)) (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@5))) (= (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@4)) (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@5))) (= (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@4)) (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@5))) (= (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@4)) (lib!linked_list.LLData./LLData/len (lib!linked_list.LL./LL/data self!@5))) (= (lib!linked_list.LL./LL/perms self!@4) (lib!linked_list.LL./LL/perms self!@5))) (and (=> %%location_label%%0 (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. self!@5))) (and (=> %%location_label%%1 (= (lib!linked_list.impl&%2.page_id.? (Poly%lib!linked_list.LL. self!@5)) page_id!)) (and (=> %%location_label%%2 (= (lib!linked_list.impl&%2.fixed_page.? (Poly%lib!linked_list.LL. self!@5)) fixed_page!)) (and (=> %%location_label%%3 (= (lib!linked_list.impl&%2.instance.? (Poly%lib!linked_list.LL. self!@5)) instance!)) (and (=> %%location_label%%4 (= (lib!linked_list.impl&%2.block_size.? (Poly%lib!linked_list.LL. self!@5)) block_size!)) (and (=> %%location_label%%5 (= (lib!linked_list.impl&%2.heap_id.? (Poly%lib!linked_list.LL. self!@5)) heap_id!)) (=> %%location_label%%6 (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!@5)) 0))))))))))))))))))))
(check-sat)
(exit)
