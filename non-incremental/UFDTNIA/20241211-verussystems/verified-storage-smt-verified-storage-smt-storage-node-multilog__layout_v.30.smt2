...
(assert (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!)))
(assert (= (lib!multilog.layout_v.recover_all.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))) (I multilog_id!)) (core!option.Option./Some (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!))))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_regions_view_can_only_crash_as_committed. pm_regions_view!)) (=> (ens%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_regions_view_can_only_crash_as_committed. pm_regions_view!) (=> %%location_label%%1 (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$) (= (lib!multilog.layout_v.recover_all.? s$ (I multilog_id!)) (core!option.Option./Some (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!))))) :pattern ((lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) s$)))))))))
(check-sat)
(exit)
