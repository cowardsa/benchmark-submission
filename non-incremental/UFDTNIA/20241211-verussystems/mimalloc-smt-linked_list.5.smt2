...
(declare-const self! lib!linked_list.LL.)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Poly)
(declare-const tmp%3 vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>.)
(declare-const tmp%4 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const n@ Int)
(declare-const tmp%5 Bool)
(assert fuel_defaults)
(assert (has_type (Poly%lib!linked_list.LL. self!) TYPE%lib!linked_list.LL.))
(assert (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. self!)))
...
(assert (not (or (and (=> (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.LL./LL/first (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!))))))) 0) (or (and (=> (not (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!)) 0)) (=> (= n@ (nClip (Sub (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!)) 1))) (=> (= tmp%1 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!) (I n@) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!) (I n@))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%3 (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!)))) (and (=> %%location_label%%1 (req%vstd!map.impl&%0.tracked_borrow. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. tmp%3) (I n@))) (=> (ens%vstd!map.impl&%0.tracked_borrow. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. tmp%3) (I n@) tmp%2) (=> (= tmp%4 (%Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. (tuple%4./tuple%4/0 (%Poly%tuple%4. tmp%2)))) (and (=> %%location_label%%2 (req%vstd!raw_ptr.impl&%6.is_nonnull. $ TYPE%lib!linked_list.Node. (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. tmp%4))) (=> (ens%vstd!raw_ptr.impl&%6.is_nonnull. $ TYPE%lib!linked_list.Node. (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. tmp%4)) (=> %%location_label%%3 false)))))))))))) (=> (not (not (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!)) 0))) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0))) (=> (not (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.LL./LL/first (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!))))))) 0)) (=> (= tmp%5 (not (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!)) 0))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%5 (= (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!)) 0) (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.LL./LL/first (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!))))))) 0)))))))
(check-sat)
(exit)
