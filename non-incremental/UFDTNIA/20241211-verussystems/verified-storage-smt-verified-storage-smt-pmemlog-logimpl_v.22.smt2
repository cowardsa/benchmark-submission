...
(declare-const out! main!logimpl_v.PersistentHeader.)
(declare-const crc_bytes! slice%<u8.>.)
(declare-const header_bytes! slice%<u8.>.)
...
(declare-const head_bytes@ slice%<u8.>.)
(declare-const tail_bytes@ slice%<u8.>.)
(declare-const log_size_bytes@ slice%<u8.>.)
(assert fuel_defaults)
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. crc_bytes!))) 8))
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. header_bytes!))) (Sub main!logimpl_v.header_size.? 8)))
...
(assert (not (and (=> %%location_label%%0 (uInv 64 (Sub main!logimpl_v.header_head_offset.? 8))) (and (=> %%location_label%%1 (uInv 64 (Add main!logimpl_v.header_head_offset.? 8))) (and (=> %%location_label%%2 (uInv 64 (Sub (uClip 64 (Add main!logimpl_v.header_head_offset.? 8)) 8))) (=> (= tmp%2 (uClip SZ (uClip 64 (Sub main!logimpl_v.header_head_offset.? 8)))) (=> (= tmp%3 (uClip SZ (uClip 64 (Sub (uClip 64 (Add main!logimpl_v.header_head_offset.? 8)) 8)))) (and (=> %%location_label%%3 (req%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. header_bytes!) tmp%2 tmp%3)) (=> (ens%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. header_bytes!) tmp%2 tmp%3 tmp%1) (=> (= head_bytes@ (%Poly%slice%<u8.>. tmp%1)) (and (=> %%location_label%%4 (uInv 64 (Sub main!logimpl_v.header_tail_offset.? 8))) (and (=> %%location_label%%5 (uInv 64 (Add main!logimpl_v.header_tail_offset.? 8))) (and (=> %%location_label%%6 (uInv 64 (Sub (uClip 64 (Add main!logimpl_v.header_tail_offset.? 8)) 8))) (=> (= tmp%5 (uClip SZ (uClip 64 (Sub main!logimpl_v.header_tail_offset.? 8)))) (=> (= tmp%6 (uClip SZ (uClip 64 (Sub (uClip 64 (Add main!logimpl_v.header_tail_offset.? 8)) 8)))) (and (=> %%location_label%%7 (req%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. header_bytes!) tmp%5 tmp%6)) (=> (ens%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. header_bytes!) tmp%5 tmp%6 tmp%4) (=> (= tail_bytes@ (%Poly%slice%<u8.>. tmp%4)) (and (=> %%location_label%%8 (uInv 64 (Sub main!logimpl_v.header_log_size_offset.? 8))) (and (=> %%location_label%%9 (uInv 64 (Add main!logimpl_v.header_log_size_offset.? 8))) (and (=> %%location_label%%10 (uInv 64 (Sub (uClip 64 (Add main!logimpl_v.header_log_size_offset.? 8)) 8))) (=> (= tmp%8 (uClip SZ (uClip 64 (Sub main!logimpl_v.header_log_size_offset.? 8)))) (=> (= tmp%9 (uClip SZ (uClip 64 (Sub (uClip 64 (Add main!logimpl_v.header_log_size_offset.? 8)) 8)))) (and (=> %%location_label%%11 (req%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. header_bytes!) tmp%8 tmp%9)) (=> (ens%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. header_bytes!) tmp%8 tmp%9 tmp%7) (=> (= log_size_bytes@ (%Poly%slice%<u8.>. tmp%7)) (and (=> %%location_label%%12 (req%vstd!bytes.u64_from_le_bytes. crc_bytes!)) (=> (ens%vstd!bytes.u64_from_le_bytes. crc_bytes! tmp%10) (and (=> %%location_label%%13 (req%vstd!bytes.u64_from_le_bytes. head_bytes@)) (=> (ens%vstd!bytes.u64_from_le_bytes. head_bytes@ tmp%11) (and (=> %%location_label%%14 (req%vstd!bytes.u64_from_le_bytes. tail_bytes@)) (=> (ens%vstd!bytes.u64_from_le_bytes. tail_bytes@ tmp%12) (and (=> %%location_label%%15 (req%vstd!bytes.u64_from_le_bytes. log_size_bytes@)) (=> (ens%vstd!bytes.u64_from_le_bytes. log_size_bytes@ tmp%13) (=> (= out! (main!logimpl_v.PersistentHeader./PersistentHeader (%I (I tmp%10)) (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata (%I (I tmp%11)) (%I (I tmp%12)) (%I (I tmp%13))))))) (and (=> %%location_label%%16 (= (main!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. out!))) (vstd!bytes.spec_u64_from_le_bytes.? (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. crc_bytes!))))) (=> %%location_label%%17 (= (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. out!))) (main!logimpl_v.spec_bytes_to_metadata.? (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. header_bytes!)))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
