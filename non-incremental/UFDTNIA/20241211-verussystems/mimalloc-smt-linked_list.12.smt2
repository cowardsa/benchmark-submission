...
(declare-const p@2 ptr_mut%<lib!linked_list.Node.>.)
...
(assert (not (=> (has_type (Poly%lib!linked_list.LL. self!@1) TYPE%lib!linked_list.LL.) (=> (has_type (Poly%lib!linked_list.LL. other!@1) TYPE%lib!linked_list.LL.) (=> (and (<= 1 count@0) (<= count@0 (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)))) (=> (< (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)) 4294967295) (=> (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. other!@1)) (=> (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. p@0)))) (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (vstd!raw_ptr.PointsToData./PointsToData/ptr (%Poly%vstd!raw_ptr.PointsToData. (vstd!view.View.view.? $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) (tuple%4./tuple%4/0 (%Poly%tuple%4. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. other!@1)))) (I (nClip (Sub (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)) count@0))))))))))))) (=> (= (vstd!raw_ptr.PtrData./PtrData/metadata (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. p@0)))) vstd!raw_ptr.Metadata./Thin) (=> (= i@ (nClip (Sub (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)) count@0))) (=> (= j@ (nClip (Sub i@ 1))) (=> (= tmp%3 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. other!@1) (I i@) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. other!@1) (I i@))))) (and (=> %%location_label%%0 tmp%3) (=> tmp%3 (=> (= tmp%4 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. other!@1) (I j@) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. other!@1) (I j@))))) (and (=> %%location_label%%1 tmp%4) (=> tmp%4 (or (and (=> (not (= i@ 0)) (=> (= tmp%6 (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. other!@1)))) (and (=> %%location_label%%2 (req%vstd!map.impl&%0.tracked_borrow. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. tmp%6) (I j@))) (=> (ens%vstd!map.impl&%0.tracked_borrow. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. tmp%6) (I j@) tmp%5) (=> (= tmp%7 (%Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. (tuple%4./tuple%4/0 (%Poly%tuple%4. tmp%5)))) (and (=> %%location_label%%3 (req%vstd!raw_ptr.impl&%6.is_nonnull. $ TYPE%lib!linked_list.Node. (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. tmp%7))) (=> (ens%vstd!raw_ptr.impl&%6.is_nonnull. $ TYPE%lib!linked_list.Node. (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. tmp%7)) %%switch_label%%1))))))) (=> (not (not (= i@ 0))) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. p@0) tmp%8) (=> (= tmp%10 (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. other!@1)))) (=> (= tmp%11 (nClip (Sub (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)) count@0))) (and (=> %%location_label%%4 (req%vstd!map.impl&%0.tracked_borrow. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. tmp%10) (I tmp%11))) (=> (ens%vstd!map.impl&%0.tracked_borrow. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. tmp%10) (I tmp%11) tmp%9) (=> (= tmp%13 (%Poly%vstd!raw_ptr.IsExposed. (tuple%4./tuple%4/3 (%Poly%tuple%4. tmp%9)))) (=> (ens%vstd!raw_ptr.with_exposed_provenance. $ TYPE%lib!linked_list.Node. tmp%8 tmp%13 tmp%12) (=> (= p@1 (%Poly%ptr_mut%<lib!linked_list.Node.>. tmp%12)) (=> (= tmp%15 (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. other!@1)))) (=> (= tmp%16 (nClip (Sub (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)) count@0))) (and (=> %%location_label%%5 (req%vstd!map.impl&%0.tracked_borrow. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. tmp%15) (I tmp%16))) (=> (ens%vstd!map.impl&%0.tracked_borrow. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. tmp%15) (I tmp%16) tmp%14) (=> (= tmp%18 (%Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. (tuple%4./tuple%4/0 (%Poly%tuple%4. tmp%14)))) (and (=> %%location_label%%6 (req%vstd!raw_ptr.ptr_ref. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. p@1) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. tmp%18))) (=> (ens%vstd!raw_ptr.ptr_ref. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. p@1) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. tmp%18) tmp%17) (=> (= next@ (%Poly%lib!linked_list.Node. tmp%17)) (=> (= tmp%20 (lib!linked_list.Node./Node/ptr (%Poly%lib!linked_list.Node. (Poly%lib!linked_list.Node. next@)))) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. tmp%20) tmp%19) (or (and (=> (not (= tmp%19 0)) (and (=> %%location_label%%7 (uInv 32 (Add count@0 1))) (=> (= count@1 (uClip 32 (Add count@0 1))) (=> (= p@2 (lib!linked_list.Node./Node/ptr (%Poly%lib!linked_list.Node. (Poly%lib!linked_list.Node. next@)))) %%switch_label%%0)))) (=> (not (not (= tmp%19 0))) (and (=> %%location_label%%8 (and (<= 1 count@0) (<= count@0 (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1))))) (and (=> %%location_label%%9 (< (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)) 4294967295)) (and (=> %%location_label%%10 (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. other!@1))) (and (=> %%location_label%%11 (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. p@1)))) (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (vstd!raw_ptr.PointsToData./PointsToData/ptr (%Poly%vstd!raw_ptr.PointsToData. (vstd!view.View.view.? $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) (tuple%4./tuple%4/0 (%Poly%tuple%4. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. other!@1)))) (I (nClip (Sub (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)) count@0)))))))))))))) (and (=> %%location_label%%12 (= (vstd!raw_ptr.PtrData./PtrData/metadata (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. p@1)))) vstd!raw_ptr.Metadata./Thin)) (and (=> %%location_label%%13 (= count@0 (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)))) (=> %%location_label%%14 (= p@1 (%Poly%ptr_mut%<lib!linked_list.Node.>. (vstd!raw_ptr.PointsToData./PointsToData/ptr (%Poly%vstd!raw_ptr.PointsToData. (vstd!view.View.view.? $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) (tuple%4./tuple%4/0 (%Poly%tuple%4. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. other!@1)))) (I 0)))))))))))))))))) (and (not %%switch_label%%0) (and (=> %%location_label%%15 (and (<= 1 count@1) (<= count@1 (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1))))) (and (=> %%location_label%%16 (< (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)) 4294967295)) (and (=> %%location_label%%17 (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. other!@1))) (and (=> %%location_label%%18 (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. p@2)))) (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (vstd!raw_ptr.PointsToData./PointsToData/ptr (%Poly%vstd!raw_ptr.PointsToData. (vstd!view.View.view.? $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) (tuple%4./tuple%4/0 (%Poly%tuple%4. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. other!@1)))) (I (nClip (Sub (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. other!@1)) count@1)))))))))))))) (=> %%location_label%%19 (= (vstd!raw_ptr.PtrData./PtrData/metadata (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!linked_list.Node.) (Poly%ptr_mut%<lib!linked_list.Node.>. p@2)))) vstd!raw_ptr.Metadata./Thin)))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
