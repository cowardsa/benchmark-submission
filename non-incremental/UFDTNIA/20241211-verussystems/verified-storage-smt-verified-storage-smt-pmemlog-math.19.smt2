...
(assert (not (or (and (=> (= (Sub y! x!) d!) (and (=> %%location_label%%0 (req%main!math.lemma_mod_auto_basics. d! x!)) (=> (ens%main!math.lemma_mod_auto_basics. d! x!) (=> (= tmp%1 (= (EucMod y! d!) (EucMod x! d!))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 false))))))) (=> (not (= (Sub y! x!) d!)) (and (=> %%location_label%%3 (req%main!math.lemma_fundamental_div_mod. x! d!)) (=> (ens%main!math.lemma_fundamental_div_mod. x! d!) (and (=> %%location_label%%4 (req%main!math.lemma_fundamental_div_mod. y! d!)) (=> (ens%main!math.lemma_fundamental_div_mod. y! d!) (and (=> %%location_label%%5 (req%main!math.lemma_fundamental_div_mod. z! d!)) (=> (ens%main!math.lemma_fundamental_div_mod. z! d!) (and (=> %%location_label%%6 (req%main!math.lemma_mod_range. x! d!)) (=> (ens%main!math.lemma_mod_range. x! d!) (and (=> %%location_label%%7 (req%main!math.lemma_mod_range. y! d!)) (=> (ens%main!math.lemma_mod_range. y! d!) (and (=> %%location_label%%8 (req%main!math.lemma_mod_range. z! d!)) (=> (ens%main!math.lemma_mod_range. z! d!) (=> (= tmp%2 (>= (Sub (Add (Sub (Mul d! (EucDiv y! d!)) (Mul d! (EucDiv x! d!))) (EucMod y! d!)) (EucMod x! d!)) 0)) (and (=> %%location_label%%9 tmp%2) (=> tmp%2 (=> (= tmp%3 (>= (Sub (Mul d! (EucDiv y! d!)) (Mul d! (EucDiv x! d!))) 0)) (and (=> %%location_label%%10 tmp%3) (=> tmp%3 (=> (= tmp%4 (EucDiv y! d!)) (=> (= tmp%5 (EucDiv x! d!)) (=> (ens%main!math.lemma_mul_is_distributive_sub. d! tmp%4 tmp%5) (=> (= tmp%6 (>= (Mul d! (Sub (EucDiv y! d!) (EucDiv x! d!))) 0)) (and (=> %%location_label%%11 tmp%6) (=> tmp%6 (and (=> %%location_label%%12 (req%main!math.lemma_div_relation_when_mods_have_different_order. d! x! y!)) (=> (ens%main!math.lemma_div_relation_when_mods_have_different_order. d! x! y!) (or (and (=> (let ((tmp%%$ (EucMod z! d!))) (and (< (EucMod y! d!) tmp%%$) (< tmp%%$ (EucMod x! d!)))) (and (=> %%location_label%%13 (req%main!math.lemma_div_relation_when_mods_have_different_order. d! z! y!)) (=> (ens%main!math.lemma_div_relation_when_mods_have_different_order. d! z! y!) (and (=> %%location_label%%14 (req%main!math.lemma_div_relation_when_mods_have_same_order. d! z! x!)) (=> (ens%main!math.lemma_div_relation_when_mods_have_same_order. d! z! x!) (=> %%location_label%%15 false)))))) (=> (not (let ((tmp%%$ (EucMod z! d!))) (and (< (EucMod y! d!) tmp%%$) (< tmp%%$ (EucMod x! d!))))) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))))))))))))))))))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%16 (or (<= (EucMod z! d!) (EucMod y! d!)) (>= (EucMod z! d!) (EucMod x! d!))))))))
(check-sat)
(exit)
