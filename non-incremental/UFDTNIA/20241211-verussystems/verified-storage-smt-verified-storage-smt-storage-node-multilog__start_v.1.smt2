...
(assert (> (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!)) 0))
(assert (is-core!option.Option./Some_ (lib!multilog.layout_v.recover_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!) (I 0))))))))
...
(declare-fun %%lambda%%10 (Int) %%Function%%)
(assert (forall ((%%hole%%0 Int) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%10 %%hole%%0) i$) (I (Add %%hole%%0 (%I i$)))) :pattern ((%%apply%%0 (%%lambda%%10 %%hole%%0) i$)))))
...
(assert (not (=> (= verus_tmp@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!))) (I 0)))) (=> (= verus_tmp_mem@ verus_tmp@1) (=> (= mem@1 verus_tmp_mem@) (=> (= tmp%1 (lib!multilog.inv_v.metadata_types_set_in_first_region.? (Poly%vstd!seq.Seq<u8.>. mem@1))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)) (Poly%fun%1. (mk_fun (%%lambda%%10 lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?)))))) (=> (= verus_tmp_log_cdb_addrs@ verus_tmp$1@1) (=> (= log_cdb_addrs@1 verus_tmp_log_cdb_addrs@) (=> (= verus_tmp$2@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem@1) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (I (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.? (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))) (=> (= verus_tmp_true_cdb_bytes@ verus_tmp$2@1) (=> (= true_cdb_bytes@1 verus_tmp_true_cdb_bytes@) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. true_cdb_bytes@1) (vstd!seq.Seq.new.? $ (UINT 8) $ (TYPE%fun%1. $ INT $ (UINT 8)) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)) (Poly%fun%1. (mk_fun (%%lambda%%9 $ INT (Poly%vstd!seq.Seq<int.>. log_cdb_addrs@1) $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem@1))))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%4 (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?)) (and (=> %%location_label%%2 (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.read_aligned. PMRegions&. PMRegions& $ (UINT 64) pm_regions! (I 0) tmp%4)) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegions.read_aligned. PMRegions&. PMRegions& $ (UINT 64) pm_regions! (I 0) tmp%4 tmp%3) (=> (= tmp%%@ (%Poly%core!result.Result. tmp%3)) (or (and (=> (is-core!result.Result./Ok_ tmp%%@) %%switch_label%%0) (=> (not (is-core!result.Result./Ok_ tmp%%@)) (=> (= e@ (%Poly%lib!pmem.pmemspec_t.PmemError. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@))))) (=> %%location_label%%3 false)))) (and (not %%switch_label%%0) (=> (= log_cdb@ (let ((log_cdb$1 (%Poly%lib!pmem.pmcopy_t.MaybeCorruptedBytes<u64.>. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@)))))) log_cdb$1)) (=> (= tmp%5 (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegions.constants.? PMRegions&. PMRegions& pm_regions!)))) (and (=> %%location_label%%4 (req%lib!pmem.pmemutil_v.check_cdb. log_cdb@ mem@1 tmp%5 log_cdb_addrs@1)) (=> (ens%lib!pmem.pmemutil_v.check_cdb. log_cdb@ mem@1 tmp%5 log_cdb_addrs@1 result@) (=> (= result! (ite (is-core!option.Option./Some_ result@) (let ((b$ (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. result@)))))) (core!result.Result./Ok (B b$))) (core!result.Result./Err (Poly%lib!multilog.multilogimpl_t.MultiLogErr. lib!multilog.multilogimpl_t.MultiLogErr./CRCMismatch)))) (=> %%location_label%%5 (ite (is-core!result.Result./Ok_ result!) (let ((b$ (%B (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= (core!option.Option./Some (B b$)) (lib!multilog.layout_v.recover_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!) (I 0)))))))) (and (and (is-core!result.Result./Err_ result!) (is-lib!multilog.multilogimpl_t.MultiLogErr./CRCMismatch_ (%Poly%lib!multilog.multilogimpl_t.MultiLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegions.constants.? PMRegions&. PMRegions& pm_regions!)))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
