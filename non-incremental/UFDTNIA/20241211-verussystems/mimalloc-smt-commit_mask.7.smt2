...
(assert (not (=> (fuel_bool fuel%lib!commit_mask.is_bit_set.) (and (=> %%location_label%%0 true) (=> (= (uClip 64 (bitshr (I (uClip 64 a!)) (I 64))) 0) (and (=> %%location_label%%1 (req%lib!commit_mask.lemma_obtain_bit_index_1_aux. (uClip 64 a!) 64)) (=> (ens%lib!commit_mask.lemma_obtain_bit_index_1_aux. (uClip 64 a!) 64 tmp%1) (=> (= b! (uClip SZ tmp%1)) (and (=> %%location_label%%2 (< b! 64)) (=> %%location_label%%3 (lib!commit_mask.is_bit_set.? (I a!) (I b!))))))))))))
(check-sat)
(exit)
