...
(set-info :comment ";; page-table/impl_u/indexing.rs:190:5: 190:11 (#0)")
...
(assert (not (=> (>= addr! base!) (=> (> entry_size! 0) (=> (= idx@ (lib!definitions_t.index_from_offset.? (I (nClip (Sub addr! base!))) (I entry_size!))) (or (and (=> (and (lib!definitions_t.aligned.? (I base!) (I entry_size!)) (lib!definitions_t.aligned.? (I addr!) (I entry_size!))) (and (=> %%location_label%%0 (req%lib!extra.subtract_mod_eq_zero. base! addr! entry_size!)) (=> (ens%lib!extra.subtract_mod_eq_zero. base! addr! entry_size!) (=> (= tmp%1 (nClip (Sub addr! base!))) (and (=> %%location_label%%1 (req%lib!extra.div_mul_cancel. tmp%1 entry_size!)) (=> (ens%lib!extra.div_mul_cancel. tmp%1 entry_size!) %%switch_label%%0)))))) (=> (not (and (lib!definitions_t.aligned.? (I base!) (I entry_size!)) (lib!definitions_t.aligned.? (I addr!) (I entry_size!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (=> (and (lib!definitions_t.aligned.? (I base!) (I entry_size!)) (lib!definitions_t.aligned.? (I addr!) (I entry_size!))) (= addr! (lib!definitions_t.entry_base_from_index.? (I base!) (I idx@) (I entry_size!))))))))))))
(check-sat)
(exit)
