...
(assert (not (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)))) (=> (< i@0 8) (=> (= tmp%2 (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!)))) (and (=> %%location_label%%0 (req%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%2 i@0)) (=> (ens%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%2 i@0 tmp%1) (or (and (=> (not (= (%I tmp%1) 0)) (=> (ens%lib!commit_mask.lemma_is_bit_set. 0) (=> (ens%lib!commit_mask.impl&%0.lemma_view. self!) (=> (= tmp%3 (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@0)))) (and (=> %%location_label%%1 (req%lib!commit_mask.lemma_obtain_bit_index_1. tmp%3)) (=> (ens%lib!commit_mask.lemma_obtain_bit_index_1. tmp%3 j@) (=> (= tmp%4 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (I (Add (Mul i@0 64) j@)))) (and (=> %%location_label%%2 tmp%4) (=> tmp%4 (=> (= b! false) (=> %%location_label%%3 (= b! (= (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!)) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.empty.? $ INT))))))))))))))) (=> (not (not (= (%I tmp%1) 0))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%4 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (=> %%location_label%%5 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$))))))))))))))))
(check-sat)
(exit)
