...
(declare-const tmp%1 lib!linked_list.LL.)
(declare-const tmp%2 lib!tokens.PageId.)
...
(assert (not (=> (= tmp%2 (%Poly%lib!tokens.PageId. (vstd!pervasive.arbitrary.? $ TYPE%lib!tokens.PageId.))) (=> (= tmp%3 (%B (vstd!pervasive.arbitrary.? $ BOOL))) (=> (= tmp%4 (%Poly%lib!tokens.Mim.Instance. (vstd!pervasive.arbitrary.? $ TYPE%lib!tokens.Mim.Instance.))) (=> (= tmp%5 (%I (vstd!pervasive.arbitrary.? $ NAT))) (=> (= tmp%6 (%Poly%core!option.Option. (vstd!pervasive.arbitrary.? $ (TYPE%core!option.Option. $ TYPE%lib!tokens.HeapId.)))) (=> (ens%lib!linked_list.impl&%2.new. tmp%2 tmp%3 tmp%4 tmp%5 tmp%6 tmp%1) (=> (= ll! tmp%1) (and (=> %%location_label%%0 (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. ll!))) (=> %%location_label%%1 (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. ll!)) 0))))))))))))
(check-sat)
(exit)
