...
(assert (not (=> (= i@0 0) (and (=> %%location_label%%0 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (uClip SZ (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$))) (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$))))) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$))))) (=> (uInv SZ i@1) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (uClip SZ (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$))) (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$))))) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. other!))))) j$)))) (=> (not (< i@1 8)) (=> (ens%lib!commit_mask.lemma_is_bit_set. 0) (=> (ens%lib!commit_mask.impl&%0.lemma_view. self!) (=> (ens%lib!commit_mask.impl&%0.lemma_view. other!) (=> (= tmp%7 (vstd!set.impl&%0.disjoint.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. other!))))) (and (=> %%location_label%%1 tmp%7) (=> tmp%7 (=> (= res! false) (=> %%location_label%%2 (= res! (not (vstd!set.impl&%0.disjoint.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. other!)))))))))))))))))))))
(check-sat)
(exit)
