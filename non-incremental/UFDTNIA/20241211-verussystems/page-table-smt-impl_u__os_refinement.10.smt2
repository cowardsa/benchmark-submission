...
(set-info :comment ";; Function-Specs lib::impl_u::os_refinement::init_refines_hl_init")
(declare-fun req%lib!impl_u.os_refinement.init_refines_hl_init. (lib!spec_t.os.OSVariables.) Bool)
(declare-const %%global_location_label%%48 Bool)
(assert (forall ((s! lib!spec_t.os.OSVariables.)) (! (= (req%lib!impl_u.os_refinement.init_refines_hl_init. s!) (=> %%global_location_label%%48 (lib!spec_t.os.init.? (Poly%lib!spec_t.os.OSVariables. s!)))) :pattern ((req%lib!impl_u.os_refinement.init_refines_hl_init. s!)))))
(declare-fun ens%lib!impl_u.os_refinement.init_refines_hl_init. (lib!spec_t.os.OSVariables.) Bool)
(assert (forall ((s! lib!spec_t.os.OSVariables.)) (! (= (ens%lib!impl_u.os_refinement.init_refines_hl_init. s!) (lib!spec_t.hlspec.init.? (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s!))))) :pattern ((ens%lib!impl_u.os_refinement.init_refines_hl_init. s!)))))
(set-info :comment ";; Function-Def lib::impl_u::os_refinement::init_refines_hl_init")
(set-info :comment ";; page-table/impl_u/os_refinement.rs:448:7: 448:46 (#0)")
(set-info :comment ";; Function-Specs lib::impl_u::os_refinement::next_step_refines_hl_next_step")
(declare-fun req%lib!impl_u.os_refinement.next_step_refines_hl_next_step. (lib!spec_t.os.OSVariables. lib!spec_t.os.OSVariables. lib!spec_t.os.OSStep.) Bool)
(declare-const %%global_location_label%%49 Bool)
(declare-const %%global_location_label%%50 Bool)
(assert (forall ((s1! lib!spec_t.os.OSVariables.) (s2! lib!spec_t.os.OSVariables.) (step! lib!spec_t.os.OSStep.)) (! (= (req%lib!impl_u.os_refinement.next_step_refines_hl_next_step. s1! s2! step!) (and (=> %%global_location_label%%49 (lib!spec_t.os.impl&%0.inv.? (Poly%lib!spec_t.os.OSVariables. s1!))) (=> %%global_location_label%%50 (lib!spec_t.os.next_step.? (Poly%lib!spec_t.os.OSVariables. s1!) (Poly%lib!spec_t.os.OSVariables. s2!) (Poly%lib!spec_t.os.OSStep. step!))))) :pattern ((req%lib!impl_u.os_refinement.next_step_refines_hl_next_step. s1! s2! step!)))))
(declare-fun ens%lib!impl_u.os_refinement.next_step_refines_hl_next_step. (lib!spec_t.os.OSVariables. lib!spec_t.os.OSVariables. lib!spec_t.os.OSStep.) Bool)
(assert (forall ((s1! lib!spec_t.os.OSVariables.) (s2! lib!spec_t.os.OSVariables.) (step! lib!spec_t.os.OSStep.)) (! (= (ens%lib!impl_u.os_refinement.next_step_refines_hl_next_step. s1! s2! step!) (lib!spec_t.hlspec.next_step.? (Poly%lib!spec_t.hlspec.AbstractConstants. (lib!spec_t.os.impl&%0.interp_constants.? (Poly%lib!spec_t.os.OSVariables. s1!))) (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s1!))) (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s2!))) (Poly%lib!spec_t.hlspec.AbstractStep. (lib!spec_t.os.impl&%2.interp.? (Poly%lib!spec_t.os.OSStep. step!))))) :pattern ((ens%lib!impl_u.os_refinement.next_step_refines_hl_next_step. s1! s2! step!)))))
(set-info :comment ";; Function-Def lib::impl_u::os_refinement::next_step_refines_hl_next_step")
(set-info :comment ";; page-table/impl_u/os_refinement.rs:458:7: 458:88 (#0)")
...
(declare-const new_value@ Int)
(declare-const result@ lib!definitions_t.StoreResult.)
...
(declare-const is_exec@ Bool)
(declare-const result$1@ lib!definitions_t.LoadResult.)
(declare-const base@ Int)
(declare-const pte$1@ lib!definitions_t.PageTableEntry.)
(declare-const tmp%58 Bool)
(declare-const tmp%59 Bool)
(declare-const tmp%60 Bool)
(declare-const pmem_idx@ Int)
(declare-const vmem_idx@ Int)
(declare-const vaddr@ Int)
(declare-const paddr@ Int)
(declare-const op@ lib!definitions_t.RWOp.)
(declare-const pte@ core!option.Option.)
(declare-const tmp%61 Bool)
(declare-const vaddr$1@ Int)
(declare-const pte$2@ lib!definitions_t.PageTableEntry.)
...
(declare-const vaddr$3@ Int)
(declare-const pte$3@ lib!definitions_t.PageTableEntry.)
...
(declare-const vaddr$4@ Int)
(declare-const result$3@ core!result.Result.)
(declare-const tmp%97 Bool)
(declare-const tmp%98 Bool)
(declare-const tmp%99 Bool)
(declare-const tmp%100 Bool)
(declare-const base$1@ Int)
(declare-const pte$6@ lib!definitions_t.PageTableEntry.)
(declare-const tmp%101 Bool)
(declare-const tmp%102 Bool)
(declare-const tmp%103 Bool)
(declare-const tmp%%$1@ tuple%2.)
(declare-const base$2@ Int)
(declare-const pte$7@ lib!definitions_t.PageTableEntry.)
(declare-const tmp%104 Bool)
(declare-const vmem_idx$1@ Int)
(declare-const tmp%105 Bool)
(declare-const tmp%106 Bool)
(declare-const pt_s1$2@ lib!impl_u.spec_pt.PageTableVariables.)
(declare-const pt_s2$2@ lib!impl_u.spec_pt.PageTableVariables.)
(declare-const vaddr$5@ Int)
(declare-const result$4@ core!result.Result.)
(declare-const abs_s1@ lib!spec_t.hlspec.AbstractVariables.)
(declare-const abs_s2@ lib!spec_t.hlspec.AbstractVariables.)
(declare-const abs_c@ lib!spec_t.hlspec.AbstractConstants.)
(declare-const sys_s1@ lib!spec_t.hardware.HWVariables.)
(declare-const sys_s2@ lib!spec_t.hardware.HWVariables.)
(declare-const pt1@ vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>.)
(declare-const pt2@ vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>.)
(declare-const abs_step@ lib!spec_t.hlspec.AbstractStep.)
...
(declare-fun %%choose%%2 (Type Type Int Dcr Type Dcr Type Poly Poly Int Dcr Type Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Type) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Poly) (%%hole%%8 Poly) (%%hole%%9 Int) (%%hole%%10 Dcr) (%%hole%%11 Type) (%%hole%%12 Dcr) (%%hole%%13 Type) (%%hole%%14 Poly)) (! (=> (exists ((base2$ Poly) (pte2$ Poly)) (! (and (has_type base2$ %%hole%%0) (has_type pte2$ %%hole%%1) (let ((paddr2$ (nClip (Add (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte2$))))) (Sub %%hole%%2 (%I base2$)))))) (let ((pmem_idx2$ (lib!spec_t.mem.word_index_spec.? (I paddr2$)))) (and (and (vstd!map_lib.impl&%0.contains_pair.? %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 base2$ pte2$) (lib!definitions_t.between.? %%hole%%8 base2$ (I (nClip (Add (%I base2$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte2$)))))))))) (< pmem_idx2$ %%hole%%9))))) :pattern ((vstd!map_lib.impl&%0.contains_pair.? %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 base2$ pte2$)))) (exists ((base2$ Poly) (pte2$ Poly)) (! (and (and (has_type base2$ %%hole%%0) (has_type pte2$ %%hole%%1) (let ((paddr2$ (nClip (Add (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte2$))))) (Sub %%hole%%2 (%I base2$)))))) (let ((pmem_idx2$ (lib!spec_t.mem.word_index_spec.? (I paddr2$)))) (and (and (vstd!map_lib.impl&%0.contains_pair.? %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 base2$ pte2$) (lib!definitions_t.between.? %%hole%%8 base2$ (I (nClip (Add (%I base2$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte2$)))))))))) (< pmem_idx2$ %%hole%%9))))) (= (%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14) (Poly%tuple%2. (tuple%2./tuple%2 base2$ pte2$)))) :pattern ((vstd!map_lib.impl&%0.contains_pair.? %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 base2$ pte2$))))) :pattern ((%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14)))))
...
(assert (not (and (=> %%location_label%%0 (req%lib!impl_u.os_refinement.next_step_preserves_inv. s1! s2! step!)) (=> (ens%lib!impl_u.os_refinement.next_step_preserves_inv. s1! s2! step!) (and (=> %%location_label%%1 (req%lib!impl_u.os_refinement.lemma_effective_mappings_equal_interp_pt_mem. s1!)) (=> (ens%lib!impl_u.os_refinement.lemma_effective_mappings_equal_interp_pt_mem. s1!) (and (=> %%location_label%%2 (req%lib!impl_u.os_refinement.lemma_effective_mappings_equal_interp_pt_mem. s2!)) (=> (ens%lib!impl_u.os_refinement.lemma_effective_mappings_equal_interp_pt_mem. s2!) (=> (= abs_s1@ (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s1!))) (=> (= abs_s2@ (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s2!))) (=> (= abs_c@ (lib!spec_t.os.impl&%0.interp_constants.? (Poly%lib!spec_t.os.OSVariables. s1!))) (=> (= sys_s1@ (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s1!)))) (=> (= sys_s2@ (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s2!)))) (=> (= pt1@ (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s1!))) (=> (= pt2@ (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s2!))) (=> (= abs_step@ (lib!spec_t.os.impl&%2.interp.? (Poly%lib!spec_t.os.OSStep. step!))) (or (and (=> (is-lib!spec_t.os.OSStep./HW_ step!) (=> (= system_step@ (lib!spec_t.os.OSStep./HW/step (%Poly%lib!spec_t.os.OSStep. (Poly%lib!spec_t.os.OSStep. step!)))) (and (=> %%location_label%%3 (req%lib!impl_u.os_refinement.lemma_effective_mappings_other. s1! s2!)) (=> (ens%lib!impl_u.os_refinement.lemma_effective_mappings_other. s1! s2!) (or (and (=> (is-lib!spec_t.hardware.HWStep./ReadWrite_ system_step@) (=> (= vaddr@ (lib!spec_t.hardware.HWStep./ReadWrite/vaddr (%Poly%lib!spec_t.hardware.HWStep. (Poly%lib!spec_t.hardware.HWStep. system_step@)))) (=> (= paddr@ (lib!spec_t.hardware.HWStep./ReadWrite/paddr (%Poly%lib!spec_t.hardware.HWStep. (Poly%lib!spec_t.hardware.HWStep. system_step@)))) (=> (= op@ (lib!spec_t.hardware.HWStep./ReadWrite/op (%Poly%lib!spec_t.hardware.HWStep. (Poly%lib!spec_t.hardware.HWStep. system_step@)))) (=> (= pte@ (lib!spec_t.hardware.HWStep./ReadWrite/pte (%Poly%lib!spec_t.hardware.HWStep. (Poly%lib!spec_t.hardware.HWStep. system_step@)))) (=> (= pmem_idx@ (lib!spec_t.mem.word_index_spec.? (I paddr@))) (=> (= vmem_idx@ (lib!spec_t.mem.word_index_spec.? (I vaddr@))) (=> (= tmp%1 (= (lib!spec_t.hardware.HWVariables./HWVariables/pt_mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s2@))) (lib!spec_t.hardware.HWVariables./HWVariables/pt_mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@))))) (and (=> %%location_label%%4 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!map.Map. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hardware.HWVariables./HWVariables/tlb (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s2@)))) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hardware.HWVariables./HWVariables/tlb (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))))) (and (=> %%location_label%%5 tmp%2) (=> tmp%2 (or (and (=> (and (is-core!option.Option./Some_ pte@) (is-tuple%2./tuple%2_ (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. pte@)))))) (=> (= base@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. pte@))))))) (=> (= pte$1@ (%Poly%lib!definitions_t.PageTableEntry. (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. pte@))))))) (and (=> %%location_label%%6 (req%lib!impl_u.os_refinement.lemma_interp. s1!)) (=> (ens%lib!impl_u.os_refinement.lemma_interp. s1!) (and (=> %%location_label%%7 (req%lib!impl_u.os_refinement.lemma_interp. s2!)) (=> (ens%lib!impl_u.os_refinement.lemma_interp. s2!) (=> (= tmp%3 (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hardware.HWVariables./HWVariables/tlb (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))) (I base@) (Poly%lib!definitions_t.PageTableEntry. pte$1@))) (and (=> %%location_label%%8 tmp%3) (=> tmp%3 (=> (= tmp%4 (lib!definitions_t.between.? (I vaddr@) (I base@) (I (nClip (Add base@ (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))))))) (and (=> %%location_label%%9 tmp%4) (=> tmp%4 (=> (= tmp%5 (= paddr@ (nClip (Add (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))) (Sub vaddr@ base@))))) (and (=> %%location_label%%10 tmp%5) (=> tmp%5 (=> (= tmp%6 (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I base@) (Poly%lib!definitions_t.PageTableEntry. pte$1@))) (and (=> %%location_label%%11 tmp%6) (=> tmp%6 (or (and (=> (is-lib!definitions_t.RWOp./Store_ op@) (=> (= new_value@ (lib!definitions_t.RWOp./Store/new_value (%Poly%lib!definitions_t.RWOp. (Poly%lib!definitions_t.RWOp. op@)))) (=> (= result@ (lib!definitions_t.RWOp./Store/result (%Poly%lib!definitions_t.RWOp. (Poly%lib!definitions_t.RWOp. op@)))) (or (and (=> (and (and (< pmem_idx@ (vstd!seq.Seq.len.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))))) (not (lib!definitions_t.Flags./Flags/is_supervisor (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.PageTableEntry./PageTableEntry/flags (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))))) (lib!definitions_t.Flags./Flags/is_writable (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.PageTableEntry./PageTableEntry/flags (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))) (=> (= tmp%7 (is-lib!definitions_t.StoreResult./Ok_ result@)) (and (=> %%location_label%%12 tmp%7) (=> tmp%7 (=> (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ NAT) (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s2@)))) (vstd!seq.Seq.update.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))) (I pmem_idx@) (I new_value@)))) (and (=> %%location_label%%13 tmp%8) (=> tmp%8 (=> (= tmp%9 (lib!spec_t.hlspec.mem_domain_from_mappings_contains.? (I (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@)))) (I vmem_idx@) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s1!))))) (and (=> %%location_label%%14 tmp%9) (=> tmp%9 (=> (= tmp%10 (ext_eq false (TYPE%vstd!set.Set. $ NAT) (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))))) (and (=> %%location_label%%15 tmp%10) (=> tmp%10 (=> (= tmp%11 (= (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))) (I pmem_idx@)) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vmem_idx@)))) (and (=> %%location_label%%16 tmp%11) (=> tmp%11 (=> (= tmp%12 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) (I vmem_idx@))) (and (=> %%location_label%%17 tmp%12) (=> tmp%12 (=> (= tmp%13 (ext_eq false (TYPE%vstd!set.Set. $ NAT) (vstd!map.impl&%0.dom.? $ NAT $ NAT (vstd!map.impl&%0.insert.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vmem_idx@) (I new_value@))) (vstd!set.impl&%0.insert.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) (I vmem_idx@)))) (and (=> %%location_label%%18 tmp%13) (=> tmp%13 (=> (= tmp%14 (ext_eq false (TYPE%vstd!set.Set. $ NAT) (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) (vstd!set.impl&%0.insert.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) (I vmem_idx@)))) (and (=> %%location_label%%19 tmp%14) (=> tmp%14 (=> (= tmp%15 (ext_eq false (TYPE%vstd!set.Set. $ NAT) (vstd!map.impl&%0.dom.? $ NAT $ NAT (vstd!map.impl&%0.insert.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vmem_idx@) (I new_value@))) (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))))) (and (=> %%location_label%%20 tmp%15) (=> tmp%15 (and (=> (has_type vmem_idx2@ NAT) (=> (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))) vmem_idx2@) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (vstd!map.impl&%0.insert.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vmem_idx@) (I new_value@))) vmem_idx2@)) (or (and (=> (= (%I vmem_idx2@) vmem_idx@) (=> (= tmp%16 (= (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) vmem_idx2@)) new_value@)) (and (=> %%location_label%%21 tmp%16) (=> tmp%16 %%switch_label%%5)))) (=> (not (= (%I vmem_idx2@) vmem_idx@)) (=> (= tmp%17 (lib!spec_t.hlspec.mem_domain_from_mappings_contains.? (I (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@)))) vmem_idx2@ (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. pt1@))) (and (=> %%location_label%%22 tmp%17) (=> tmp%17 (=> (= vaddr2@ (nClip (Mul (%I vmem_idx2@) lib!definitions_t.WORD_SIZE.?))) (=> (= tmp%%@ (%Poly%tuple%2. (as_type (%%choose%%2 NAT TYPE%lib!definitions_t.PageTableEntry. vaddr2@ $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. pt1@) (I vaddr2@) (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@))) $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. pt1@)) (TYPE%tuple%2. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.)))) (=> (= base2@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= pte2@ (%Poly%lib!definitions_t.PageTableEntry. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= paddr2$1@ (nClip (Add (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte2@)))))) (Sub vaddr2@ base2@)))) (=> (= pmem_idx2$1@ (lib!spec_t.mem.word_index_spec.? (I paddr2$1@))) (=> (= tmp%18 (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. pt1@) (I base2@) (Poly%lib!definitions_t.PageTableEntry. pte2@))) (and (=> %%location_label%%23 tmp%18) (=> tmp%18 (=> (= tmp%19 (lib!definitions_t.between.? (I vaddr2@) (I base2@) (I (nClip (Add base2@ (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte2@))))))))))) (and (=> %%location_label%%24 tmp%19) (=> tmp%19 (=> (= tmp%20 (< pmem_idx2$1@ (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@))))) (and (=> %%location_label%%25 tmp%20) (=> tmp%20 (=> (= tmp%21 (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) vmem_idx2@) (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s1!))))))) (I pmem_idx2$1@)))) (and (=> %%location_label%%26 tmp%21) (=> tmp%21 (=> (= tmp%22 (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) vmem_idx2@) (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s2!))))))) (I pmem_idx2$1@)))) (and (=> %%location_label%%27 tmp%22) (=> tmp%22 (=> (= tmp%23 (ext_eq false (TYPE%vstd!seq.Seq. $ NAT) (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s2!))))))) (vstd!seq.Seq.update.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s1!))))))) (I pmem_idx@) (I new_value@)))) (and (=> %%location_label%%28 tmp%23) (=> tmp%23 (=> (= tmp%24 (< pmem_idx@ (vstd!seq.Seq.len.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s1!)))))))))) (and (=> %%location_label%%29 tmp%24) (=> tmp%24 (=> (= tmp%25 (< pmem_idx2$1@ (vstd!seq.Seq.len.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s1!)))))))))) (and (=> %%location_label%%30 tmp%25) (=> tmp%25 (=> (= tmp%26 lib!definitions_t.WORD_SIZE.?) (and (=> %%location_label%%31 (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. (%I vmem_idx2@) tmp%26)) (=> (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. (%I vmem_idx2@) tmp%26) (and (=> (fuel_bool fuel%lib!spec_t.os.impl&%0.pt_entries_aligned.) (=> (= tmp%27 (lib!definitions_t.aligned.? (I (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))) (I 8))) (and (=> %%location_label%%32 tmp%27) (=> tmp%27 (=> (= tmp%28 (lib!definitions_t.aligned.? (I base@) (I 8))) (and (=> %%location_label%%33 tmp%28) (=> tmp%28 (=> (= tmp%29 (lib!definitions_t.aligned.? (I vaddr@) (I 8))) (and (=> %%location_label%%34 tmp%29) (=> tmp%29 (and (=> %%location_label%%35 (req%lib!extra.subtract_mod_eq_zero. base@ vaddr@ 8)) (=> (ens%lib!extra.subtract_mod_eq_zero. base@ vaddr@ 8) (=> (= tmp%30 (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))) (=> (= tmp%31 (nClip (Sub vaddr@ base@))) (and (=> %%location_label%%36 (req%lib!extra.mod_add_zero. tmp%30 tmp%31 8)) (=> (ens%lib!extra.mod_add_zero. tmp%30 tmp%31 8) (=> %%location_label%%37 (lib!definitions_t.aligned.? (I paddr@) (I 8))))))))))))))))))) (=> (lib!definitions_t.aligned.? (I paddr@) (I 8)) (and (=> (fuel_bool fuel%lib!spec_t.os.impl&%0.pt_entries_aligned.) (=> (= tmp%32 (lib!definitions_t.aligned.? (I (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte2@))))))) (I 8))) (and (=> %%location_label%%38 tmp%32) (=> tmp%32 (=> (= tmp%33 (lib!definitions_t.aligned.? (I base2@) (I 8))) (and (=> %%location_label%%39 tmp%33) (=> tmp%33 (=> (= tmp%34 (lib!definitions_t.aligned.? (I vaddr2@) (I 8))) (and (=> %%location_label%%40 tmp%34) (=> tmp%34 (and (=> %%location_label%%41 (req%lib!extra.subtract_mod_eq_zero. base2@ vaddr2@ 8)) (=> (ens%lib!extra.subtract_mod_eq_zero. base2@ vaddr2@ 8) (=> (= tmp%35 (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte2@))))))) (=> (= tmp%36 (nClip (Sub vaddr2@ base2@))) (and (=> %%location_label%%42 (req%lib!extra.mod_add_zero. tmp%35 tmp%36 8)) (=> (ens%lib!extra.mod_add_zero. tmp%35 tmp%36 8) (=> %%location_label%%43 (lib!definitions_t.aligned.? (I paddr2$1@) (I 8))))))))))))))))))) (=> (lib!definitions_t.aligned.? (I paddr2$1@) (I 8)) (or (and (=> (= pmem_idx@ pmem_idx2$1@) (=> (= tmp%37 (not (= vaddr@ vaddr2@))) (and (=> %%location_label%%44 tmp%37) (=> tmp%37 (=> (= tmp%38 (= pte$1@ pte2@)) (and (=> %%location_label%%45 tmp%38) (=> tmp%38 (=> (= tmp%39 (not (= (Sub vaddr@ base@) (Sub vaddr2@ base@)))) (and (=> %%location_label%%46 tmp%39) (=> tmp%39 (=> (= tmp%40 (not (= paddr@ paddr2$1@))) (and (=> %%location_label%%47 tmp%40) (=> tmp%40 (=> (= tmp%41 (= paddr@ (nClip (Add (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))) (Sub vaddr@ base@))))) (and (=> %%location_label%%48 tmp%41) (=> tmp%41 (=> (= tmp%42 (= paddr2$1@ (nClip (Add (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte2@)))))) (Sub vaddr2@ base2@))))) (and (=> %%location_label%%49 tmp%42) (=> tmp%42 (=> %%location_label%%50 false)))))))))))))))))))) (=> (not (= pmem_idx@ pmem_idx2$1@)) %%switch_label%%6)) (and (not %%switch_label%%6) (=> (= tmp%43 (= (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s1!))))))) (I pmem_idx2$1@)) (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. (lib!spec_t.os.OSVariables./OSVariables/hw (%Poly%lib!spec_t.os.OSVariables. (Poly%lib!spec_t.os.OSVariables. s2!))))))) (I pmem_idx2$1@)))) (and (=> %%location_label%%51 tmp%43) (=> tmp%43 (=> (= tmp%44 (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) vmem_idx2@) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) vmem_idx2@))) (and (=> %%location_label%%52 tmp%44) (=> tmp%44 %%switch_label%%5)))))))))))))))))))))))))))))))))))))))))))))))))) (and (not %%switch_label%%5) (=> %%location_label%%53 (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) vmem_idx2@) (vstd!map.impl&%0.index.? $ NAT $ NAT (vstd!map.impl&%0.insert.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vmem_idx@) (I new_value@)) vmem_idx2@))))))) (=> (forall ((vmem_idx2$ Poly)) (! (=> (has_type vmem_idx2$ NAT) (=> (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))) vmem_idx2$) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (vstd!map.impl&%0.insert.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vmem_idx@) (I new_value@))) vmem_idx2$)) (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) vmem_idx2$) (vstd!map.impl&%0.index.? $ NAT $ NAT (vstd!map.impl&%0.insert.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vmem_idx@) (I new_value@)) vmem_idx2$)))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) vmem_idx2$)))) (=> (= tmp%45 (ext_eq false (TYPE%vstd!map.Map. $ NAT $ NAT) (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) (vstd!map.impl&%0.insert.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vmem_idx@) (I new_value@)))) (and (=> %%location_label%%54 tmp%45) (=> tmp%45 (=> (= tmp%46 (lib!spec_t.hlspec.step_ReadWrite.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr@) (Poly%lib!definitions_t.RWOp. op@) (Poly%core!option.Option. (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (I base@) (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))) (and (=> %%location_label%%55 tmp%46) (=> tmp%46 %%switch_label%%4)))))))))))))))))))))))))))))))))))) (=> (not (and (and (< pmem_idx@ (vstd!seq.Seq.len.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))))) (not (lib!definitions_t.Flags./Flags/is_supervisor (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.PageTableEntry./PageTableEntry/flags (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))))) (lib!definitions_t.Flags./Flags/is_writable (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.PageTableEntry./PageTableEntry/flags (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))))) (=> (= tmp%47 (is-lib!definitions_t.StoreResult./Pagefault_ result@)) (and (=> %%location_label%%56 tmp%47) (=> tmp%47 (=> (= tmp%48 (ext_eq false (TYPE%vstd!seq.Seq. $ NAT) (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s2@)))) (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))))) (and (=> %%location_label%%57 tmp%48) (=> tmp%48 (=> (= tmp%49 (lib!spec_t.hlspec.step_ReadWrite.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr@) (Poly%lib!definitions_t.RWOp. op@) (Poly%core!option.Option. (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (I base@) (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))) (and (=> %%location_label%%58 tmp%49) (=> tmp%49 %%switch_label%%4))))))))))) (and (not %%switch_label%%4) %%switch_label%%3))))) (=> (not (is-lib!definitions_t.RWOp./Store_ op@)) (=> (= is_exec@ (lib!definitions_t.RWOp./Load/is_exec (%Poly%lib!definitions_t.RWOp. (Poly%lib!definitions_t.RWOp. op@)))) (=> (= result$1@ (lib!definitions_t.RWOp./Load/result (%Poly%lib!definitions_t.RWOp. (Poly%lib!definitions_t.RWOp. op@)))) (=> (= tmp%50 (ext_eq false (TYPE%vstd!seq.Seq. $ NAT) (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s2@)))) (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))))) (and (=> %%location_label%%59 tmp%50) (=> tmp%50 (or (and (=> (and (and (< pmem_idx@ (vstd!seq.Seq.len.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))))) (not (lib!definitions_t.Flags./Flags/is_supervisor (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.PageTableEntry./PageTableEntry/flags (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))))) (=> is_exec@ (not (lib!definitions_t.Flags./Flags/disable_execute (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.PageTableEntry./PageTableEntry/flags (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))))) (=> (= tmp%51 (is-lib!definitions_t.LoadResult./Value_ result$1@)) (and (=> %%location_label%%60 tmp%51) (=> tmp%51 (=> (= tmp%52 (= (lib!definitions_t.LoadResult./Value/0 (%Poly%lib!definitions_t.LoadResult. (Poly%lib!definitions_t.LoadResult. result$1@))) (%I (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))) (I pmem_idx@))))) (and (=> %%location_label%%61 tmp%52) (=> tmp%52 (=> (= tmp%53 (lib!spec_t.hlspec.mem_domain_from_mappings_contains.? (I (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@)))) (I vmem_idx@) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s1!))))) (and (=> %%location_label%%62 tmp%53) (=> tmp%53 (=> (= tmp%54 (= (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))) (I pmem_idx@)) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vmem_idx@)))) (and (=> %%location_label%%63 tmp%54) (=> tmp%54 (=> (= tmp%55 (lib!spec_t.hlspec.step_ReadWrite.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr@) (Poly%lib!definitions_t.RWOp. op@) (Poly%core!option.Option. (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (I base@) (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))) (and (=> %%location_label%%64 tmp%55) (=> tmp%55 %%switch_label%%7)))))))))))))))) (=> (not (and (and (< pmem_idx@ (vstd!seq.Seq.len.? $ NAT (Poly%vstd!seq.Seq<nat.>. (lib!spec_t.hardware.HWVariables./HWVariables/mem (%Poly%lib!spec_t.hardware.HWVariables. (Poly%lib!spec_t.hardware.HWVariables. sys_s1@)))))) (not (lib!definitions_t.Flags./Flags/is_supervisor (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.PageTableEntry./PageTableEntry/flags (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))))) (=> is_exec@ (not (lib!definitions_t.Flags./Flags/disable_execute (%Poly%lib!definitions_t.Flags. (Poly%lib!definitions_t.Flags. (lib!definitions_t.PageTableEntry./PageTableEntry/flags (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))))))) (=> (= tmp%56 (is-lib!definitions_t.LoadResult./Pagefault_ result$1@)) (and (=> %%location_label%%65 tmp%56) (=> tmp%56 (=> (= tmp%57 (lib!spec_t.hlspec.step_ReadWrite.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr@) (Poly%lib!definitions_t.RWOp. op@) (Poly%core!option.Option. (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (I base@) (Poly%lib!definitions_t.PageTableEntry. pte$1@))))))) (and (=> %%location_label%%66 tmp%57) (=> tmp%57 %%switch_label%%7)))))))) (and (not %%switch_label%%7) %%switch_label%%3))))))))) (and (not %%switch_label%%3) %%switch_label%%2))))))))))))))))))))) (=> (not (and (is-core!option.Option./Some_ pte@) (is-tuple%2./tuple%2_ (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. pte@))))))) (=> (= tmp%58 (lib!spec_t.hlspec.step_ReadWrite.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr@) (Poly%lib!definitions_t.RWOp. op@) (Poly%core!option.Option. pte@))) (and (=> %%location_label%%67 tmp%58) (=> tmp%58 %%switch_label%%2))))) (and (not %%switch_label%%2) (=> (= tmp%59 (lib!spec_t.hlspec.step_ReadWrite.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr@) (Poly%lib!definitions_t.RWOp. op@) (Poly%core!option.Option. pte@))) (and (=> %%location_label%%68 tmp%59) (=> tmp%59 (=> (= tmp%60 (lib!spec_t.hlspec.next_step.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (Poly%lib!spec_t.hlspec.AbstractStep. abs_step@))) (and (=> %%location_label%%69 tmp%60) (=> tmp%60 %%switch_label%%1))))))))))))))))))))) (=> (not (is-lib!spec_t.hardware.HWStep./ReadWrite_ system_step@)) (or (and (=> (is-lib!spec_t.hardware.HWStep./PTMemOp_ system_step@) (=> %%location_label%%70 false)) (=> (not (is-lib!spec_t.hardware.HWStep./PTMemOp_ system_step@)) (or (and (=> (is-lib!spec_t.hardware.HWStep./TLBFill_ system_step@) (=> (= vaddr$1@ (lib!spec_t.hardware.HWStep./TLBFill/vaddr (%Poly%lib!spec_t.hardware.HWStep. (Poly%lib!spec_t.hardware.HWStep. system_step@)))) (=> (= pte$2@ (lib!spec_t.hardware.HWStep./TLBFill/pte (%Poly%lib!spec_t.hardware.HWStep. (Poly%lib!spec_t.hardware.HWStep. system_step@)))) (=> (= tmp%61 (= abs_s2@ abs_s1@)) (and (=> %%location_label%%71 tmp%61) (=> tmp%61 %%switch_label%%9)))))) (=> (not (is-lib!spec_t.hardware.HWStep./TLBFill_ system_step@)) (=> (= vaddr$2@ (lib!spec_t.hardware.HWStep./TLBEvict/vaddr (%Poly%lib!spec_t.hardware.HWStep. (Poly%lib!spec_t.hardware.HWStep. system_step@)))) (=> (= tmp%62 (= abs_s2@ abs_s1@)) (and (=> %%location_label%%72 tmp%62) (=> tmp%62 %%switch_label%%9)))))) (and (not %%switch_label%%9) %%switch_label%%8)))) (and (not %%switch_label%%8) %%switch_label%%1)))) (and (not %%switch_label%%1) %%switch_label%%0)))))) (=> (not (is-lib!spec_t.os.OSStep./HW_ step!)) (or (and (=> (is-lib!spec_t.os.OSStep./Map_ step!) (=> (= vaddr$3@ (lib!spec_t.os.OSStep./Map/vaddr (%Poly%lib!spec_t.os.OSStep. (Poly%lib!spec_t.os.OSStep. step!)))) (=> (= pte$3@ (lib!spec_t.os.OSStep./Map/pte (%Poly%lib!spec_t.os.OSStep. (Poly%lib!spec_t.os.OSStep. step!)))) (=> (= result$2@ (lib!spec_t.os.OSStep./Map/result (%Poly%lib!spec_t.os.OSStep. (Poly%lib!spec_t.os.OSStep. step!)))) (=> (= pt_s1@ (lib!spec_t.os.impl&%0.pt_variables.? (Poly%lib!spec_t.os.OSVariables. s1!))) (=> (= pt_s2@ (lib!spec_t.os.impl&%0.pt_variables.? (Poly%lib!spec_t.os.OSVariables. s2!))) (=> (= tmp%63 (= abs_step@ (lib!spec_t.hlspec.AbstractStep./Map (%I (I vaddr$3@)) (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$3@)) (%Poly%core!result.Result. (Poly%core!result.Result. result$2@))))) (and (=> %%location_label%%73 tmp%63) (=> tmp%63 (=> (= tmp%64 (lib!spec_t.os.step_Map.? (Poly%lib!spec_t.os.OSVariables. s1!) (Poly%lib!spec_t.os.OSVariables. s2!) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@) (Poly%core!result.Result. result$2@))) (and (=> %%location_label%%74 tmp%64) (=> tmp%64 (=> (= tmp%65 (lib!impl_u.spec_pt.step_Map.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s1@) (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s2@) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@) (Poly%core!result.Result. result$2@))) (and (=> %%location_label%%75 tmp%65) (=> tmp%65 (=> (= tmp%66 (lib!spec_t.hlspec.step_Map_enabled.? (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@))) (and (=> %%location_label%%76 tmp%66) (=> tmp%66 (or (and (=> (lib!definitions_t.candidate_mapping_overlaps_existing_vmem.? (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.spec_pt.impl&%0.interp.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s1@))) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@)) (=> (= tmp%67 (lib!definitions_t.candidate_mapping_overlaps_existing_vmem.? (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@))) (and (=> %%location_label%%77 tmp%67) (=> tmp%67 (=> (= tmp%68 (lib!spec_t.hlspec.step_Map.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@) (Poly%core!result.Result. result$2@))) (and (=> %%location_label%%78 tmp%68) (=> tmp%68 %%switch_label%%11))))))) (=> (not (lib!definitions_t.candidate_mapping_overlaps_existing_vmem.? (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.spec_pt.impl&%0.interp.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s1@))) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@))) (=> (= tmp%69 (not (lib!definitions_t.candidate_mapping_overlaps_existing_vmem.? (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@)))) (and (=> %%location_label%%79 tmp%69) (=> tmp%69 (=> (= tmp%70 (forall ((base$ Poly) (pte$4 Poly)) (! (=> (and (has_type base$ NAT) (has_type pte$4 TYPE%lib!definitions_t.PageTableEntry.)) (=> (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s1!))) base$ pte$4) (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s2!))) base$ pte$4))) :pattern ((vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s1!))) base$ pte$4)) :pattern ((vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s2!))) base$ pte$4))))) (and (=> %%location_label%%80 tmp%70) (=> tmp%70 (=> (= tmp%71 (forall ((base$ Poly) (pte$5 Poly)) (! (=> (and (has_type base$ NAT) (has_type pte$5 TYPE%lib!definitions_t.PageTableEntry.)) (=> (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s1!)))))) base$ pte$5) (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s2!)))))) base$ pte$5))) :pattern ((vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s1!)))))) base$ pte$5)) :pattern ((vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s2!)))))) base$ pte$5))))) (and (=> %%location_label%%81 tmp%71) (=> tmp%71 (=> (= tmp%72 (ext_eq false (TYPE%vstd!map.Map. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s1!)))))) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s1!))))) (and (=> %%location_label%%82 tmp%72) (=> tmp%72 (=> (= tmp%73 (ext_eq false (TYPE%vstd!map.Map. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s2!)))))) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.os.impl&%0.interp_pt_mem.? (Poly%lib!spec_t.os.OSVariables. s2!))))) (and (=> %%location_label%%83 tmp%73) (=> tmp%73 (and (=> %%location_label%%84 (req%lib!impl_u.os_refinement.lemma_interp_other. s1! s2!)) (=> (ens%lib!impl_u.os_refinement.lemma_interp_other. s1! s2!) (=> (= tmp%74 (is-core!result.Result./Ok_ result$2@)) (and (=> %%location_label%%85 tmp%74) (=> tmp%74 (=> (= tmp%75 (ext_eq false (TYPE%vstd!map.Map. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) (vstd!map.impl&%0.insert.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@)))) (and (=> %%location_label%%86 tmp%75) (=> tmp%75 (and (=> (has_type word_idx@ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) word_idx@) (=> (= tmp%76 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))) word_idx@)) (and (=> %%location_label%%87 tmp%76) (=> tmp%76 (=> (= tmp%77 (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) word_idx@) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) word_idx@))) (and (=> %%location_label%%88 tmp%77) (=> tmp%77 (=> %%location_label%%89 (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) word_idx@) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) word_idx@))))))))))) (=> (forall ((word_idx$ Poly)) (! (=> (has_type word_idx$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) word_idx$) (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) word_idx$) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) word_idx$)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) word_idx$)))) (=> (= tmp%78 (ext_eq false (TYPE%vstd!set.Set. $ NAT) (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))) (Poly%vstd!set.Set<nat.>. (lib!spec_t.hlspec.mem_domain_from_mappings.? (I (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@)))) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))))))) (and (=> %%location_label%%90 tmp%78) (=> tmp%78 (=> (= tmp%79 (lib!spec_t.hlspec.step_Map.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@) (Poly%core!result.Result. result$2@))) (and (=> %%location_label%%91 tmp%79) (=> tmp%79 %%switch_label%%11))))))))))))))))))))))))))))))))) (and (not %%switch_label%%11) (=> (= tmp%80 (lib!spec_t.hlspec.step_Map.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr$3@) (Poly%lib!definitions_t.PageTableEntry. pte$3@) (Poly%core!result.Result. result$2@))) (and (=> %%location_label%%92 tmp%80) (=> tmp%80 (=> (= tmp%81 (lib!spec_t.hlspec.next_step.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (Poly%lib!spec_t.hlspec.AbstractStep. abs_step@))) (and (=> %%location_label%%93 tmp%81) (=> tmp%81 %%switch_label%%10)))))))))))))))))))))))))) (=> (not (is-lib!spec_t.os.OSStep./Map_ step!)) (or (and (=> (is-lib!spec_t.os.OSStep./Unmap_ step!) (=> (= vaddr$4@ (lib!spec_t.os.OSStep./Unmap/vaddr (%Poly%lib!spec_t.os.OSStep. (Poly%lib!spec_t.os.OSStep. step!)))) (=> (= result$3@ (lib!spec_t.os.OSStep./Unmap/result (%Poly%lib!spec_t.os.OSStep. (Poly%lib!spec_t.os.OSStep. step!)))) (=> (= pt_s1$1@ (lib!spec_t.os.impl&%0.pt_variables.? (Poly%lib!spec_t.os.OSVariables. s1!))) (=> (= pt_s2$1@ (lib!spec_t.os.impl&%0.pt_variables.? (Poly%lib!spec_t.os.OSVariables. s2!))) (=> (= tmp%82 (= abs_step@ (lib!spec_t.hlspec.AbstractStep./Unmap (%I (I vaddr$4@)) (%Poly%core!result.Result. (Poly%core!result.Result. result$3@))))) (and (=> %%location_label%%94 tmp%82) (=> tmp%82 (=> (= tmp%83 (lib!spec_t.os.step_Unmap.? (Poly%lib!spec_t.os.OSVariables. s1!) (Poly%lib!spec_t.os.OSVariables. s2!) (I vaddr$4@) (Poly%core!result.Result. result$3@))) (and (=> %%location_label%%95 tmp%83) (=> tmp%83 (=> (= tmp%84 (lib!impl_u.spec_pt.step_Unmap.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s1$1@) (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s2$1@) (I vaddr$4@) (Poly%core!result.Result. result$3@))) (and (=> %%location_label%%96 tmp%84) (=> tmp%84 (=> (= tmp%85 (lib!spec_t.hlspec.step_Unmap_enabled.? (I vaddr$4@))) (and (=> %%location_label%%97 tmp%85) (=> tmp%85 (or (and (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.spec_pt.impl&%0.interp.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s1$1@)))) (I vaddr$4@)) (=> (= tmp%86 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) (I vaddr$4@))) (and (=> %%location_label%%98 tmp%86) (=> tmp%86 (=> (= tmp%87 (is-core!result.Result./Ok_ result$3@)) (and (=> %%location_label%%99 tmp%87) (=> tmp%87 (=> (= tmp%88 (ext_eq false (TYPE%vstd!map.Map. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.spec_pt.impl&%0.interp.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s2$1@))) (vstd!map.impl&%0.remove.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.spec_pt.impl&%0.interp.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s1$1@))) (I vaddr$4@)))) (and (=> %%location_label%%100 tmp%88) (=> tmp%88 (=> (= tmp%89 (ext_eq false (TYPE%vstd!map.Map. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) (vstd!map.impl&%0.remove.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vaddr$4@)))) (and (=> %%location_label%%101 tmp%89) (=> tmp%89 (=> (= tmp%90 (ext_eq false (TYPE%vstd!set.Set. $ NAT) (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))) (Poly%vstd!set.Set<nat.>. (lib!spec_t.hlspec.mem_domain_from_mappings.? (I (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@)))) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))))))) (and (=> %%location_label%%102 tmp%90) (=> tmp%90 (and (=> %%location_label%%103 (req%lib!impl_u.os_refinement.lemma_interp_other. s2! s1!)) (=> (ens%lib!impl_u.os_refinement.lemma_interp_other. s2! s1!) (and (=> (has_type word_idx$1@ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))) word_idx$1@) (=> (= tmp%91 (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) word_idx$1@) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) word_idx$1@))) (and (=> %%location_label%%104 tmp%91) (=> tmp%91 (=> %%location_label%%105 (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) word_idx$1@) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) word_idx$1@)))))))) (=> (forall ((word_idx$ Poly)) (! (=> (has_type word_idx$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))) word_idx$) (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) word_idx$) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@)))) word_idx$)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@))))) word_idx$)))) (=> (= tmp%92 (lib!spec_t.hlspec.step_Unmap.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr$4@) (Poly%core!result.Result. result$3@))) (and (=> %%location_label%%106 tmp%92) (=> tmp%92 %%switch_label%%13))))))))))))))))))))))) (=> (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.spec_pt.impl&%0.interp.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s1$1@)))) (I vaddr$4@))) (=> (= tmp%93 (not (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) (I vaddr$4@)))) (and (=> %%location_label%%107 tmp%93) (=> tmp%93 (=> (= tmp%94 (lib!spec_t.hlspec.step_Unmap.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr$4@) (Poly%core!result.Result. result$3@))) (and (=> %%location_label%%108 tmp%94) (=> tmp%94 %%switch_label%%13)))))))) (and (not %%switch_label%%13) (=> (= tmp%95 (lib!spec_t.hlspec.step_Unmap.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr$4@) (Poly%core!result.Result. result$3@))) (and (=> %%location_label%%109 tmp%95) (=> tmp%95 (=> (= tmp%96 (lib!spec_t.hlspec.next_step.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (Poly%lib!spec_t.hlspec.AbstractStep. abs_step@))) (and (=> %%location_label%%110 tmp%96) (=> tmp%96 %%switch_label%%12))))))))))))))))))))))))) (=> (not (is-lib!spec_t.os.OSStep./Unmap_ step!)) (=> (= vaddr$5@ (lib!spec_t.os.OSStep./Resolve/vaddr (%Poly%lib!spec_t.os.OSStep. (Poly%lib!spec_t.os.OSStep. step!)))) (=> (= result$4@ (lib!spec_t.os.OSStep./Resolve/result (%Poly%lib!spec_t.os.OSStep. (Poly%lib!spec_t.os.OSStep. step!)))) (=> (= pt_s1$2@ (lib!spec_t.os.impl&%0.pt_variables.? (Poly%lib!spec_t.os.OSVariables. s1!))) (=> (= pt_s2$2@ (lib!spec_t.os.impl&%0.pt_variables.? (Poly%lib!spec_t.os.OSVariables. s2!))) (=> (= tmp%97 (= abs_step@ (lib!spec_t.hlspec.AbstractStep./Resolve (%I (I vaddr$5@)) (%Poly%core!result.Result. (Poly%core!result.Result. result$4@))))) (and (=> %%location_label%%111 tmp%97) (=> tmp%97 (=> (= tmp%98 (lib!spec_t.os.step_Resolve.? (Poly%lib!spec_t.os.OSVariables. s1!) (Poly%lib!spec_t.os.OSVariables. s2!) (I vaddr$5@) (Poly%core!result.Result. result$4@))) (and (=> %%location_label%%112 tmp%98) (=> tmp%98 (=> (= tmp%99 (lib!impl_u.spec_pt.step_Resolve.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s1$2@) (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s2$2@) (I vaddr$5@) (Poly%core!result.Result. result$4@))) (and (=> %%location_label%%113 tmp%99) (=> tmp%99 (or (and (=> (and (is-core!result.Result./Ok_ result$4@) (is-tuple%2./tuple%2_ (%Poly%tuple%2. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result$4@)))))) (=> (= base$1@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result$4@))))))) (=> (= pte$6@ (%Poly%lib!definitions_t.PageTableEntry. (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result$4@))))))) (=> (= tmp%100 (lib!spec_t.hlspec.step_Resolve.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr$5@) (Poly%core!result.Result. (core!result.Result./Ok (Poly%tuple%2. (tuple%2./tuple%2 (I base$1@) (Poly%lib!definitions_t.PageTableEntry. pte$6@))))))) (and (=> %%location_label%%114 tmp%100) (=> tmp%100 %%switch_label%%14)))))) (=> (not (and (is-core!result.Result./Ok_ result$4@) (is-tuple%2./tuple%2_ (%Poly%tuple%2. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result$4@))))))) (=> (= vmem_idx$1@ (lib!spec_t.mem.word_index_spec.? (I vaddr$5@))) (=> (= tmp%101 (= (Mul vmem_idx$1@ lib!definitions_t.WORD_SIZE.?) vaddr$5@)) (and (=> %%location_label%%115 tmp%101) (=> tmp%101 (or (and (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. (lib!spec_t.hlspec.mem_domain_from_mappings.? (I (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@)))) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))))) (I vmem_idx$1@)) (=> (= tmp%102 (lib!spec_t.hlspec.mem_domain_from_mappings_contains.? (I (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@)))) (I vmem_idx$1@) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))))) (and (=> %%location_label%%116 tmp%102) (=> tmp%102 (=> (= tmp%%$1@ (%Poly%tuple%2. (as_type (%%choose%%2 NAT TYPE%lib!definitions_t.PageTableEntry. vaddr$5@ $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))) (I vaddr$5@) (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@))) $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@))))) (TYPE%tuple%2. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.)))) (=> (= base$2@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@))))) (=> (= pte$7@ (%Poly%lib!definitions_t.PageTableEntry. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@))))) (=> (= tmp%103 (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.spec_pt.impl&%0.interp.? (Poly%lib!impl_u.spec_pt.PageTableVariables. pt_s1$2@))) (I base$2@) (Poly%lib!definitions_t.PageTableEntry. pte$7@))) (and (=> %%location_label%%117 tmp%103) (=> tmp%103 (=> %%location_label%%118 false))))))))))) (=> (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. (lib!spec_t.hlspec.mem_domain_from_mappings.? (I (lib!spec_t.hlspec.AbstractConstants./AbstractConstants/phys_mem_size (%Poly%lib!spec_t.hlspec.AbstractConstants. (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@)))) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mappings (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@)))))) (I vmem_idx$1@))) %%switch_label%%15)) (and (not %%switch_label%%15) (=> (= tmp%104 (lib!spec_t.hlspec.step_Resolve.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr$5@) (Poly%core!result.Result. result$4@))) (and (=> %%location_label%%119 tmp%104) (=> tmp%104 %%switch_label%%14))))))))))) (and (not %%switch_label%%14) (=> (= tmp%105 (lib!spec_t.hlspec.step_Resolve.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (I vaddr$5@) (Poly%core!result.Result. result$4@))) (and (=> %%location_label%%120 tmp%105) (=> tmp%105 (=> (= tmp%106 (lib!spec_t.hlspec.next_step.? (Poly%lib!spec_t.hlspec.AbstractConstants. abs_c@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s1@) (Poly%lib!spec_t.hlspec.AbstractVariables. abs_s2@) (Poly%lib!spec_t.hlspec.AbstractStep. abs_step@))) (and (=> %%location_label%%121 tmp%106) (=> tmp%106 %%switch_label%%12))))))))))))))))))))))) (and (not %%switch_label%%12) %%switch_label%%10)))) (and (not %%switch_label%%10) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%122 (lib!spec_t.hlspec.next_step.? (Poly%lib!spec_t.hlspec.AbstractConstants. (lib!spec_t.os.impl&%0.interp_constants.? (Poly%lib!spec_t.os.OSVariables. s1!))) (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s1!))) (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s2!))) (Poly%lib!spec_t.hlspec.AbstractStep. (lib!spec_t.os.impl&%2.interp.? (Poly%lib!spec_t.os.OSStep. step!)))))))))))))))))))))))
(check-sat)
(exit)
