...
(set-info :comment ";; src/math.rs:248:5: 248:81 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_is_distributive_add_other_way")
(set-info :comment ";; src/math.rs:248:5: 248:81 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (not (=> %%location_label%%0 (= (Mul (Add y! z!) x!) (Add (Mul y! x!) (Mul z! x!))))))
(check-sat)
(exit)
