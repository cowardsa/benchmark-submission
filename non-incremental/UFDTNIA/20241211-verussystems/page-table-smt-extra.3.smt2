...
(assert (not (and (=> %%location_label%%0 (req%lib!extra.lemma_aligned_iff_eq_mul_div. a! b!)) (=> (ens%lib!extra.lemma_aligned_iff_eq_mul_div. a! b!) (and (=> %%location_label%%1 (req%lib!extra.lemma_aligned_iff_eq_mul_div. b! c!)) (=> (ens%lib!extra.lemma_aligned_iff_eq_mul_div. b! c!) (and (=> %%location_label%%2 (req%lib!extra.lemma_aligned_iff_eq_mul_div. a! c!)) (=> (ens%lib!extra.lemma_aligned_iff_eq_mul_div. a! c!) (=> (= i@ (nClip (EucDiv a! b!))) (=> (= j@ (nClip (EucDiv b! c!))) (and (=> %%location_label%%3 true) (=> (= (nClip (Mul (nClip (Mul c! j@)) i@)) (nClip (Mul c! (nClip (Mul j@ i@))))) (and (=> %%location_label%%4 (< 0 c!)) (and (=> %%location_label%%5 (= a! (nClip (Mul c! (nClip (Mul j@ i@)))))) (=> (= (nClip (EucDiv a! c!)) (nClip (Mul j@ i@))) (=> %%location_label%%6 (lib!definitions_t.aligned.? (I a!) (I c!))))))))))))))))))
(check-sat)
(exit)
