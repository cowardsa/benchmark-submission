...
(assert (not (and (=> (has_type k@ INT) (=> (and (<= i! (%I k@)) (< (%I k@) j!)) (=> (= tmp%1 (= (vstd!seq.Seq.index.? T&. T& s1! k@) (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& s1! (I i!) (I j!)) (I (Sub (%I k@) i!))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (= (vstd!seq.Seq.index.? T&. T& s2! k@) (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& s2! (I i!) (I j!)) (I (Sub (%I k@) i!))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> %%location_label%%2 (= (vstd!seq.Seq.index.? T&. T& s1! k@) (vstd!seq.Seq.index.? T&. T& s2! k@))))))))))) (=> (forall ((k$ Poly)) (! (=> (has_type k$ INT) (=> (and (<= i! (%I k$)) (< (%I k$) j!)) (= (vstd!seq.Seq.index.? T&. T& s1! k$) (vstd!seq.Seq.index.? T&. T& s2! k$)))) :pattern ((vstd!seq.Seq.index.? T&. T& s1! k$)) :pattern ((vstd!seq.Seq.index.? T&. T& s2! k$)))) (=> %%location_label%%3 (forall ((k$ Poly)) (! (=> (has_type k$ INT) (=> (and (<= i! (%I k$)) (< (%I k$) j!)) (= (vstd!seq.Seq.index.? T&. T& s1! k$) (vstd!seq.Seq.index.? T&. T& s2! k$)))) :pattern ((vstd!seq.Seq.index.? T&. T& s1! k$)) :pattern ((vstd!seq.Seq.index.? T&. T& s2! k$)))))))))
(check-sat)
(exit)
