...
(set-info :comment ";; MODULE 'module os_commit'")
...
(set-info :comment ";; Function-Decl lib::os_mem::MemChunk::has_new_pointsto")
...
(set-info :comment ";; Function-Specs lib::os_mem::mprotect_prot_none")
...
(set-info :comment ";; Function-Axioms lib::os_mem::MemChunk::has_new_pointsto")
...
(set-info :comment ";; Function-Specs lib::os_mem::mprotect_prot_read_write")
...
(set-info :comment ";; Function-Specs lib::os_mem::MemChunk::split")
...
(set-info :comment ";; Function-Specs lib::os_mem::MemChunk::join")
...
(set-info :comment ";; Function-Specs lib::os_mem::MemChunk::take_points_to_set")
...
(set-info :comment ";; Function-Specs lib::os_mem::MemChunk::give_points_to_range")
...
(set-info :comment ";; Function-Specs lib::os_commit::os_page_align_areax")
...
(set-info :comment ";; Function-Def lib::os_commit::os_page_align_areax")
(set-info :comment ";; os_commit.rs:107:1: 108:28 (#0)")
(set-info :comment ";; Function-Specs lib::os_commit::os_commitx")
...
(set-info :comment ";; Function-Def lib::os_commit::os_commitx")
(set-info :comment ";; os_commit.rs:145:1: 148:24 (#0)")
(set-info :comment ";; Function-Specs lib::os_commit::os_commit")
(declare-fun req%lib!os_commit.os_commit. (ptr_mut%<u8.>. Int lib!os_mem.MemChunk.) Bool)
...
(assert (forall ((addr! ptr_mut%<u8.>.) (size! Int) (pre%mem! lib!os_mem.MemChunk.)) (! (= (req%lib!os_commit.os_commit. addr! size! pre%mem!) (and (=> %%global_location_label%%34 (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. pre%mem!))) (=> %%global_location_label%%35 (lib!os_mem.impl&%0.os_has_range.? (Poly%lib!os_mem.MemChunk. pre%mem!) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr!))) (I size!))) (=> %%global_location_label%%36 (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr!)) (lib!os_mem.page_size.? (I 0))) 0)) (=> %%global_location_label%%37 (= (EucMod size! (lib!os_mem.page_size.? (I 0))) 0)) (=> %%global_location_label%%38 (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr!)) 0))) (=> %%global_location_label%%39 (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr!)) size!) (- (uHi SZ) 1))) (=> %%global_location_label%%40 (= (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr!)))) (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. pre%mem!))))))))) :pattern ((req%lib!os_commit.os_commit. addr! size! pre%mem!)))))
(declare-fun ens%lib!os_commit.os_commit. (ptr_mut%<u8.>. Int lib!os_mem.MemChunk. lib!os_mem.MemChunk. tuple%2.) Bool)
(assert (forall ((addr! ptr_mut%<u8.>.) (size! Int) (pre%mem! lib!os_mem.MemChunk.) (mem! lib!os_mem.MemChunk.) (res! tuple%2.)) (! (= (ens%lib!os_commit.os_commit. addr! size! pre%mem! mem! res!) (and (has_type (Poly%tuple%2. res!) (TYPE%tuple%2. $ BOOL $ BOOL)) (let ((success$ (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((is_zero$ (%B (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem!)) (lib!os_mem.impl&%0.has_new_pointsto.? (Poly%lib!os_mem.MemChunk. mem!) (Poly%lib!os_mem.MemChunk. pre%mem!))) (= (vstd!map.impl&%0.dom.? $ INT $ TYPE%lib!os_mem.OsMem. (Poly%vstd!map.Map<int./lib!os_mem.OsMem.>. (lib!os_mem.MemChunk./MemChunk/os (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem!))))) (vstd!map.impl&%0.dom.? $ INT $ TYPE%lib!os_mem.OsMem. (Poly%vstd!map.Map<int./lib!os_mem.OsMem.>. (lib!os_mem.MemChunk./MemChunk/os (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. pre%mem!))))))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem!))))) (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. pre%mem!))))))) (=> success$ (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem!) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr!))) (I size!)))))))) :pattern ((ens%lib!os_commit.os_commit. addr! size! pre%mem! mem! res!)))))
(set-info :comment ";; Function-Def lib::os_commit::os_commit")
(set-info :comment ";; os_commit.rs:14:1: 15:26 (#0)")
...
(assert (not (and (=> %%location_label%%0 (req%lib!os_commit.os_commitx. addr! size! true false mem!@0)) (=> (ens%lib!os_commit.os_commitx. addr! size! true false mem!@0 mem!@1 tmp%1) (=> (= res! tmp%1) (=> %%location_label%%1 (let ((success$ (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((is_zero$ (%B (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem!@1)) (lib!os_mem.impl&%0.has_new_pointsto.? (Poly%lib!os_mem.MemChunk. mem!@1) (Poly%lib!os_mem.MemChunk. mem!@0))) (= (vstd!map.impl&%0.dom.? $ INT $ TYPE%lib!os_mem.OsMem. (Poly%vstd!map.Map<int./lib!os_mem.OsMem.>. (lib!os_mem.MemChunk./MemChunk/os (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem!@1))))) (vstd!map.impl&%0.dom.? $ INT $ TYPE%lib!os_mem.OsMem. (Poly%vstd!map.Map<int./lib!os_mem.OsMem.>. (lib!os_mem.MemChunk./MemChunk/os (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem!@0))))))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem!@1))))) (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem!@0))))))) (=> success$ (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem!@1) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr!))) (I size!))))))))))))
(check-sat)
(exit)
