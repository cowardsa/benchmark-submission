...
(set-info :comment ";; src/math.rs:52:5: 52:69 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_strict_inequality")
(set-info :comment ";; src/math.rs:52:5: 52:69 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (not (=> %%location_label%%0 (< (Mul x! z!) (Mul y! z!)))))
(check-sat)
(exit)
