...
(assert (not (=> (= decrease%init0 (Sub lib!definitions_t.X86_NUM_LAYERS.? (%I layer!))) (or (and (=> (and (and (and (and (and (and (and (= (uClip SZ (EucMod (%I ptr!) lib!definitions_t.PAGE_SIZE.?)) 0) (lib!spec_t.mem.impl&%1.inv.? mem!)) (vstd!set.impl&%0.contains.? $ TYPE%lib!definitions_t.MemRegion. (Poly%vstd!set.Set<lib!definitions_t.MemRegion.>. (lib!spec_t.mem.impl&%1.regions.? mem!)) (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. pt!))))) (= (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. pt!))))) (%I ptr!))) (= (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. pt!))))) lib!definitions_t.PAGE_SIZE.?)) (= (vstd!seq.Seq.len.? $ (UINT 64) (Poly%vstd!seq.Seq<u64.>. (lib!spec_t.mem.impl&%1.region_view.? mem! (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. pt!)))))) (vstd!seq.Seq.len.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. pt!)))))) (lib!impl_u.l2_impl.PT.layer_in_range.? layer!)) (= (vstd!seq.Seq.len.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. pt!)))) lib!definitions_t.X86_NUM_ENTRIES.?)) (and (=> %%location_label%%0 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. pt!)) (layer!$2 (%I layer!)) (ptr!$3 (%I ptr!))) (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!$2)) decrease%init0 true)) (=> (= tmp%1 (lib!impl_u.l2_impl.PT.directories_obey_invariant_at.? mem! pt! layer! ptr!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (and (and (and (and (and (and (and (= (uClip SZ (EucMod (%I ptr!) lib!definitions_t.PAGE_SIZE.?)) 0) (lib!spec_t.mem.impl&%1.inv.? mem!)) (vstd!set.impl&%0.contains.? $ TYPE%lib!definitions_t.MemRegion. (Poly%vstd!set.Set<lib!definitions_t.MemRegion.>. (lib!spec_t.mem.impl&%1.regions.? mem!)) (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. pt!))))) (= (lib!definitions_t.MemRegion./MemRegion/base (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. pt!))))) (%I ptr!))) (= (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. pt!))))) lib!definitions_t.PAGE_SIZE.?)) (= (vstd!seq.Seq.len.? $ (UINT 64) (Poly%vstd!seq.Seq<u64.>. (lib!spec_t.mem.impl&%1.region_view.? mem! (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. pt!)))))) (vstd!seq.Seq.len.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. pt!)))))) (lib!impl_u.l2_impl.PT.layer_in_range.? layer!)) (= (vstd!seq.Seq.len.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. pt!)))) lib!definitions_t.X86_NUM_ENTRIES.?))) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
