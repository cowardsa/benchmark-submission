...
(declare-const global_metadata@ lib!multilog.layout_v.GlobalMetadata.)
(declare-const global_crc@ Int)
(declare-const region_metadata@ lib!multilog.layout_v.RegionMetadata.)
(declare-const region_crc@ Int)
(declare-const cdb@ Int)
(declare-const log_metadata@ lib!multilog.layout_v.LogMetadata.)
(declare-const log_crc@ Int)
...
(assert (= num_logs! (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@0))))
(assert (< which_log! num_logs!))
(assert (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@0) (I which_log!)))))
(assert (= (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@0) (I which_log!)))) region_size!))
(assert (>= region_size! (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!multilog.layout_v.MIN_LOG_AREA_SIZE.?)))
(assert (not (= which_log! 0)))
(declare-const pm_regions!@1 Poly)
(declare-const pm_regions!@2 Poly)
(declare-const pm_regions!@3 Poly)
(declare-const pm_regions!@4 Poly)
(declare-const pm_regions!@5 Poly)
(declare-const pm_regions!@6 Poly)
(declare-const pm_regions!@7 Poly)
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.pmcopy_axioms.) (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (ens%lib!pmem.traits_t.size_of. $ TYPE%lib!multilog.layout_v.RegionMetadata. tmp%1) (=> (= global_metadata@ (lib!multilog.layout_v.GlobalMetadata./GlobalMetadata (%I (I lib!multilog.layout_v.MULTILOG_PROGRAM_VERSION_NUMBER.?)) (%I (I (uClip 64 tmp%1))) (%I (I lib!multilog.layout_v.MULTILOG_PROGRAM_GUID.?)))) (and (=> %%location_label%%0 (req%lib!pmem.pmemutil_v.calculate_crc. $ TYPE%lib!multilog.layout_v.GlobalMetadata. (Poly%lib!multilog.layout_v.GlobalMetadata. global_metadata@))) (=> (ens%lib!pmem.pmemutil_v.calculate_crc. $ TYPE%lib!multilog.layout_v.GlobalMetadata. (Poly%lib!multilog.layout_v.GlobalMetadata. global_metadata@) global_crc@) (and (=> %%location_label%%1 (uInv 64 (Sub region_size! lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?))) (=> (= region_metadata@ (lib!multilog.layout_v.RegionMetadata./RegionMetadata (%I (I num_logs!)) (%I (I which_log!)) (%I (I 0)) (%I (I region_size!)) (%I (I (uClip 64 (Sub region_size! lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)))) (%I (I multilog_id!)))) (and (=> %%location_label%%2 (req%lib!pmem.pmemutil_v.calculate_crc. $ TYPE%lib!multilog.layout_v.RegionMetadata. (Poly%lib!multilog.layout_v.RegionMetadata. region_metadata@))) (=> (ens%lib!pmem.pmemutil_v.calculate_crc. $ TYPE%lib!multilog.layout_v.RegionMetadata. (Poly%lib!multilog.layout_v.RegionMetadata. region_metadata@) region_crc@) (=> (= cdb@ lib!pmem.pmemspec_t.CDB_FALSE.?) (=> (= log_metadata@ (lib!multilog.layout_v.LogMetadata./LogMetadata (%I (I 0)) (%I (I 0)) (%I (I 0)))) (and (=> %%location_label%%3 (req%lib!pmem.pmemutil_v.calculate_crc. $ TYPE%lib!multilog.layout_v.LogMetadata. (Poly%lib!multilog.layout_v.LogMetadata. log_metadata@))) (=> (ens%lib!pmem.pmemutil_v.calculate_crc. $ TYPE%lib!multilog.layout_v.LogMetadata. (Poly%lib!multilog.layout_v.LogMetadata. log_metadata@) log_crc@) (=> (= tmp%2 (I lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?)) (and (=> %%location_label%%4 (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ TYPE%lib!multilog.layout_v.GlobalMetadata. pm_regions!@0 (I (uClip SZ which_log!)) tmp%2 (Poly%lib!multilog.layout_v.GlobalMetadata. global_metadata@))) (=> (has_type pm_regions!@1 PMRegions&) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ TYPE%lib!multilog.layout_v.GlobalMetadata. pm_regions!@0 pm_regions!@1 (I (uClip SZ which_log!)) tmp%2 (Poly%lib!multilog.layout_v.GlobalMetadata. global_metadata@)) (=> (= tmp%3 (I lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_CRC.?)) (and (=> %%location_label%%5 (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ (UINT 64) pm_regions!@1 (I (uClip SZ which_log!)) tmp%3 (I global_crc@))) (=> (has_type pm_regions!@2 PMRegions&) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ (UINT 64) pm_regions!@1 pm_regions!@2 (I (uClip SZ which_log!)) tmp%3 (I global_crc@)) (=> (= tmp%4 (I lib!multilog.layout_v.ABSOLUTE_POS_OF_REGION_METADATA.?)) (and (=> %%location_label%%6 (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ TYPE%lib!multilog.layout_v.RegionMetadata. pm_regions!@2 (I (uClip SZ which_log!)) tmp%4 (Poly%lib!multilog.layout_v.RegionMetadata. region_metadata@))) (=> (has_type pm_regions!@3 PMRegions&) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ TYPE%lib!multilog.layout_v.RegionMetadata. pm_regions!@2 pm_regions!@3 (I (uClip SZ which_log!)) tmp%4 (Poly%lib!multilog.layout_v.RegionMetadata. region_metadata@)) (=> (= tmp%5 (I lib!multilog.layout_v.ABSOLUTE_POS_OF_REGION_CRC.?)) (and (=> %%location_label%%7 (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ (UINT 64) pm_regions!@3 (I (uClip SZ which_log!)) tmp%5 (I region_crc@))) (=> (has_type pm_regions!@4 PMRegions&) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ (UINT 64) pm_regions!@3 pm_regions!@4 (I (uClip SZ which_log!)) tmp%5 (I region_crc@)) (=> (= tmp%6 (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?)) (and (=> %%location_label%%8 (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ (UINT 64) pm_regions!@4 (I (uClip SZ which_log!)) tmp%6 (I cdb@))) (=> (has_type pm_regions!@5 PMRegions&) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ (UINT 64) pm_regions!@4 pm_regions!@5 (I (uClip SZ which_log!)) tmp%6 (I cdb@)) (=> (= tmp%7 (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)) (and (=> %%location_label%%9 (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ TYPE%lib!multilog.layout_v.LogMetadata. pm_regions!@5 (I (uClip SZ which_log!)) tmp%7 (Poly%lib!multilog.layout_v.LogMetadata. log_metadata@))) (=> (has_type pm_regions!@6 PMRegions&) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ TYPE%lib!multilog.layout_v.LogMetadata. pm_regions!@5 pm_regions!@6 (I (uClip SZ which_log!)) tmp%7 (Poly%lib!multilog.layout_v.LogMetadata. log_metadata@)) (=> (= tmp%8 (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CRC_FOR_CDB_FALSE.?)) (and (=> %%location_label%%10 (req%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ (UINT 64) pm_regions!@6 (I (uClip SZ which_log!)) tmp%8 (I log_crc@))) (=> (has_type pm_regions!@7 PMRegions&) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegions.serialize_and_write. PMRegions&. PMRegions& $ (UINT 64) pm_regions!@6 pm_regions!@7 (I (uClip SZ which_log!)) tmp%8 (I log_crc@)) (=> (= mem@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@7) (I which_log!))))))) (=> (= tmp%9 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.GlobalMetadata.))) (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ TYPE%lib!multilog.layout_v.GlobalMetadata. (Poly%lib!multilog.layout_v.GlobalMetadata. global_metadata@)))) (and (=> %%location_label%%11 tmp%9) (=> tmp%9 (=> (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_CRC.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I global_crc@)))) (and (=> %%location_label%%12 tmp%10) (=> tmp%10 (=> (= tmp%11 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_REGION_METADATA.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.RegionMetadata.))) (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ TYPE%lib!multilog.layout_v.RegionMetadata. (Poly%lib!multilog.layout_v.RegionMetadata. region_metadata@)))) (and (=> %%location_label%%13 tmp%11) (=> tmp%11 (=> (= tmp%12 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_REGION_CRC.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I region_crc@)))) (and (=> %%location_label%%14 tmp%12) (=> tmp%12 (=> (= tmp%13 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I lib!pmem.pmemspec_t.CDB_FALSE.?)))) (and (=> %%location_label%%15 tmp%13) (=> tmp%13 (=> (= tmp%14 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!multilog.layout_v.LogMetadata.))) (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ TYPE%lib!multilog.layout_v.LogMetadata. (Poly%lib!multilog.layout_v.LogMetadata. log_metadata@)))) (and (=> %%location_label%%16 tmp%14) (=> tmp%14 (=> (= tmp%15 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CRC_FOR_CDB_FALSE.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I log_crc@)))) (and (=> %%location_label%%17 tmp%15) (=> tmp%15 (and (=> %%location_label%%18 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegions.inv.? PMRegions&. PMRegions& pm_regions!@7))) (and (=> %%location_label%%19 (= (lib!pmem.pmemspec_t.PersistentMemoryRegions.constants.? PMRegions&. PMRegions& pm_regions!@7) (lib!pmem.pmemspec_t.PersistentMemoryRegions.constants.? PMRegions&. PMRegions& pm_regions!@0))) (and (=> %%location_label%%20 (= (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@7)) (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@0)))) (and (=> %%location_label%%21 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@7)))) (not (= (%I i$) which_log!))) (ext_eq false TYPE%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@7) i$)) (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@0) i$))))) :pattern ((lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@7) i$)) :pattern ((lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@0) i$))))) (and (=> %%location_label%%22 (lib!multilog.setup_v.memory_correctly_set_up_on_single_region.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@7) (I which_log!))))))) (I region_size!) (I multilog_id!) (I num_logs!) (I which_log!))) (=> %%location_label%%23 (lib!multilog.inv_v.metadata_types_set_in_region.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PMRegions&. PMRegions& pm_regions!@7) (I which_log!))))))) (B false))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
