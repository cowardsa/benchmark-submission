...
(declare-const bin_idx1! Int)
(declare-const bin_idx2! Int)
(assert fuel_defaults)
(assert (lib!bin_sizes.valid_bin_idx.? (I bin_idx1!)))
(assert (lib!bin_sizes.valid_bin_idx.? (I bin_idx2!)))
(assert (not (= bin_idx1! bin_idx2!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!bin_sizes.lemma_bin_sizes_constants. 0) (=> %%location_label%%0 (not (= (lib!bin_sizes.size_of_bin.? (I bin_idx1!)) (lib!bin_sizes.size_of_bin.? (I bin_idx2!))))))))
(check-sat)
(exit)
