...
(declare-const old_pm_region_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)
(declare-const new_pm_region_view! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)
...
(declare-const tmp%6 vstd!seq.Seq<u8.>.)
(assert fuel_defaults)
(assert (uInv 128 multilog_id!))
(assert (uInv 32 num_logs!))
(assert (=> (= new_cdb! false) (= new_cdb_bytes! (%Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I lib!pmem.pmemspec_t.CDB_FALSE.?))))))
(assert (=> (= new_cdb! true) (= new_cdb_bytes! (%Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmcopy_t.PmCopyHelper.spec_to_bytes.? $ (UINT 64) (I lib!pmem.pmemspec_t.CDB_TRUE.?))))))
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_cdb_bytes!)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))
(assert (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_region_view!)))
(assert (lib!pmem.pmemspec_t.impl&%7.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_region_view!)))
(assert (> num_logs! 0))
(assert (= new_pm_region_view! (lib!pmem.pmemspec_t.impl&%7.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. (lib!pmem.pmemspec_t.impl&%7.write.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_region_view!) (I 0) (I lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (Poly%vstd!seq.Seq<u8.>. new_cdb_bytes!))))))
(assert (lib!multilog.inv_v.each_metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_region_view!) (I multilog_id!) (I num_logs!) (B new_cdb!) (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!)))
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (= tmp%1 (forall ((w$ Poly)) (! (=> (has_type w$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? w$) (and (<= 1 (%I w$)) (< (%I w$) num_logs!))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_region_view!) w$)))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_region_view!) w$))))))) :pattern ((lib!multilog.inv_v.log_index_trigger.? w$))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (forall ((w$ Poly)) (! (=> (has_type w$ (UINT 32)) (=> (and (lib!multilog.inv_v.log_index_trigger.? w$) (and (<= 1 (%I w$)) (< (%I w$) num_logs!))) (lib!multilog.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_region_view!) w$)) (I multilog_id!) (I num_logs!) w$ (B new_cdb!) (vstd!seq.Seq.index.? $ TYPE%lib!multilog.multilogimpl_v.LogInfo. (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!) w$)))) :pattern ((lib!multilog.inv_v.log_index_trigger.? w$))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (lib!multilog.inv_v.log_index_trigger.? (I 0))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (lib!multilog.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_region_view!) (I 0))) (I multilog_id!) (I num_logs!) (I 0) (B new_cdb!) (vstd!seq.Seq.index.? $ TYPE%lib!multilog.multilogimpl_v.LogInfo. (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!) (I 0)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (and (=> (= tmp%5 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. old_pm_region_view!) (I 0))))) (=> (= tmp%6 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_region_view!) (I 0))))) (=> (ens%lib!multilog.layout_v.lemma_establish_subrange_equivalence. tmp%5 tmp%6) (=> %%location_label%%4 (lib!multilog.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_region_view!) (I 0))) (I multilog_id!) (I num_logs!) (I 0) (B new_cdb!) (vstd!seq.Seq.index.? $ TYPE%lib!multilog.multilogimpl_v.LogInfo. (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!) (I 0))))))) (=> (lib!multilog.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_region_view!) (I 0))) (I multilog_id!) (I num_logs!) (I 0) (B new_cdb!) (vstd!seq.Seq.index.? $ TYPE%lib!multilog.multilogimpl_v.LogInfo. (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!) (I 0))) (=> %%location_label%%5 (lib!multilog.inv_v.each_metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. new_pm_region_view!) (I multilog_id!) (I num_logs!) (B new_cdb!) (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!))))))))))))))))))))
(check-sat)
(exit)
