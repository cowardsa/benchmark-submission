...
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_seq_addition")
(declare-fun ens%main!logimpl_v.lemma_seq_addition. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((bytes1! vstd!seq.Seq<u8.>.) (bytes2! vstd!seq.Seq<u8.>.)) (! (= (ens%main!logimpl_v.lemma_seq_addition. bytes1! bytes2!) (let ((i$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!)))) (let ((j$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!)))) (and (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) (Poly%vstd!seq.Seq<u8.>. bytes2!)) (I 0) (I i$)) (Poly%vstd!seq.Seq<u8.>. bytes1!)) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) (Poly%vstd!seq.Seq<u8.>. bytes2!)) (I i$) (I (Add i$ j$))) (Poly%vstd!seq.Seq<u8.>. bytes2!)))))) :pattern ((ens%main!logimpl_v.lemma_seq_addition. bytes1! bytes2!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_seq_addition")
(set-info :comment ";; src/logimpl_v.rs:173:5: 173:70 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_bytes_combine_into_header")
(declare-fun req%main!logimpl_v.lemma_bytes_combine_into_header. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. main!logimpl_v.PersistentHeader.) Bool)
(declare-const %%global_location_label%%31 Bool)
(declare-const %%global_location_label%%32 Bool)
(declare-const %%global_location_label%%33 Bool)
(assert (forall ((crc_bytes! vstd!seq.Seq<u8.>.) (metadata_bytes! vstd!seq.Seq<u8.>.) (header! main!logimpl_v.PersistentHeader.)) (! (= (req%main!logimpl_v.lemma_bytes_combine_into_header. crc_bytes! metadata_bytes! header!) (and (=> %%global_location_label%%31 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!)) 8)) (=> %%global_location_label%%32 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)) (Sub main!logimpl_v.header_size.? 8))) (=> %%global_location_label%%33 (= (main!logimpl_v.spec_bytes_to_header.? (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))) header!)))) :pattern ((req%main!logimpl_v.lemma_bytes_combine_into_header. crc_bytes! metadata_bytes! header!)))))
(declare-fun ens%main!logimpl_v.lemma_bytes_combine_into_header. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. main!logimpl_v.PersistentHeader.) Bool)
(assert (forall ((crc_bytes! vstd!seq.Seq<u8.>.) (metadata_bytes! vstd!seq.Seq<u8.>.) (header! main!logimpl_v.PersistentHeader.)) (! (= (ens%main!logimpl_v.lemma_bytes_combine_into_header. crc_bytes! metadata_bytes! header!) (let ((combined_header$ (main!logimpl_v.PersistentHeader./PersistentHeader (%I (I (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. crc_bytes!)))) (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))))))) (= header! combined_header$))) :pattern ((ens%main!logimpl_v.lemma_bytes_combine_into_header. crc_bytes! metadata_bytes! header!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_bytes_combine_into_header")
(set-info :comment ";; src/logimpl_v.rs:125:5: 125:120 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_header_match")
(declare-fun req%main!logimpl_v.lemma_header_match. (vstd!seq.Seq<u8.>. Int main!logimpl_v.PersistentHeader.) Bool)
(declare-const %%global_location_label%%34 Bool)
(declare-const %%global_location_label%%35 Bool)
(declare-const %%global_location_label%%36 Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (header_pos! Int) (header! main!logimpl_v.PersistentHeader.)) (! (= (req%main!logimpl_v.lemma_header_match. pm! header_pos! header!) (and (=> %%global_location_label%%34 (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?)) (=> %%global_location_label%%35 (or (= header_pos! main!logimpl_v.header1_pos.?) (= header_pos! main!logimpl_v.header2_pos.?))) (=> %%global_location_label%%36 (= (main!logimpl_v.spec_bytes_to_header.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (I (Add header_pos! main!logimpl_v.header_size.?)))) header!)))) :pattern ((req%main!logimpl_v.lemma_header_match. pm! header_pos! header!)))))
(declare-fun ens%main!logimpl_v.lemma_header_match. (vstd!seq.Seq<u8.>. Int main!logimpl_v.PersistentHeader.) Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (header_pos! Int) (header! main!logimpl_v.PersistentHeader.)) (! (= (ens%main!logimpl_v.lemma_header_match. pm! header_pos! header!) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (and (=> (= header_pos! main!logimpl_v.header1_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. headers$))) header!)) (=> (= header_pos! main!logimpl_v.header2_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. headers$))) header!)))))) :pattern ((ens%main!logimpl_v.lemma_header_match. pm! header_pos! header!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_header_match")
(set-info :comment ";; src/logimpl_v.rs:98:5: 98:92 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_metadata_bytes_eq")
(declare-fun req%main!logimpl_v.lemma_metadata_bytes_eq. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. main!logimpl_v.PersistentHeaderMetadata.) Bool)
(declare-const %%global_location_label%%37 Bool)
(declare-const %%global_location_label%%38 Bool)
(declare-const %%global_location_label%%39 Bool)
(declare-const %%global_location_label%%40 Bool)
(assert (forall ((bytes1! vstd!seq.Seq<u8.>.) (bytes2! vstd!seq.Seq<u8.>.) (metadata! main!logimpl_v.PersistentHeaderMetadata.)) (! (= (req%main!logimpl_v.lemma_metadata_bytes_eq. bytes1! bytes2! metadata!) (and (=> %%global_location_label%%37 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!)) (Sub main!logimpl_v.header_size.? 8))) (=> %%global_location_label%%38 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!)) (Sub main!logimpl_v.header_size.? 8))) (=> %%global_location_label%%39 (= metadata! (main!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. bytes1!)))) (=> %%global_location_label%%40 (= metadata! (main!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. bytes2!)))))) :pattern ((req%main!logimpl_v.lemma_metadata_bytes_eq. bytes1! bytes2! metadata!)))))
(declare-fun ens%main!logimpl_v.lemma_metadata_bytes_eq. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. main!logimpl_v.PersistentHeaderMetadata.) Bool)
(assert (forall ((bytes1! vstd!seq.Seq<u8.>.) (bytes2! vstd!seq.Seq<u8.>.) (metadata! main!logimpl_v.PersistentHeaderMetadata.)) (! (= (ens%main!logimpl_v.lemma_metadata_bytes_eq. bytes1! bytes2! metadata!) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. bytes1!) (Poly%vstd!seq.Seq<u8.>. bytes2!))) :pattern ((ens%main!logimpl_v.lemma_metadata_bytes_eq. bytes1! bytes2! metadata!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_metadata_bytes_eq")
(set-info :comment ";; src/logimpl_v.rs:330:5: 330:111 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_header_split_into_bytes")
(declare-fun req%main!logimpl_v.lemma_header_split_into_bytes. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
(declare-const %%global_location_label%%41 Bool)
(declare-const %%global_location_label%%42 Bool)
(declare-const %%global_location_label%%43 Bool)
(declare-const %%global_location_label%%44 Bool)
(assert (forall ((crc_bytes! vstd!seq.Seq<u8.>.) (metadata_bytes! vstd!seq.Seq<u8.>.) (header_bytes! vstd!seq.Seq<u8.>.)) (! (= (req%main!logimpl_v.lemma_header_split_into_bytes. crc_bytes! metadata_bytes! header_bytes!) (and (=> %%global_location_label%%41 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!)) 8)) (=> %%global_location_label%%42 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)) (Sub main!logimpl_v.header_size.? 8))) (=> %%global_location_label%%43 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!)) main!logimpl_v.header_size.?)) (=> %%global_location_label%%44 (let ((header$ (main!logimpl_v.PersistentHeader./PersistentHeader (%I (I (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. crc_bytes!)))) (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))))))) (= (main!logimpl_v.spec_bytes_to_header.? (Poly%vstd!seq.Seq<u8.>. header_bytes!)) header$))))) :pattern ((req%main!logimpl_v.lemma_header_split_into_bytes. crc_bytes! metadata_bytes! header_bytes!)))))
(declare-fun ens%main!logimpl_v.lemma_header_split_into_bytes. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((crc_bytes! vstd!seq.Seq<u8.>.) (metadata_bytes! vstd!seq.Seq<u8.>.) (header_bytes! vstd!seq.Seq<u8.>.)) (! (= (ens%main!logimpl_v.lemma_header_split_into_bytes. crc_bytes! metadata_bytes! header_bytes!) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)) (Poly%vstd!seq.Seq<u8.>. header_bytes!))) :pattern ((ens%main!logimpl_v.lemma_header_split_into_bytes. crc_bytes! metadata_bytes! header_bytes!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_header_split_into_bytes")
(set-info :comment ";; src/logimpl_v.rs:148:5: 148:115 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::bytes_to_metadata")
(declare-fun req%main!logimpl_v.bytes_to_metadata. (slice%<u8.>.) Bool)
(declare-const %%global_location_label%%45 Bool)
(assert (forall ((bytes! slice%<u8.>.)) (! (= (req%main!logimpl_v.bytes_to_metadata. bytes!) (=> %%global_location_label%%45 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!))) (Sub main!logimpl_v.header_size.? 8)))) :pattern ((req%main!logimpl_v.bytes_to_metadata. bytes!)))))
(declare-fun ens%main!logimpl_v.bytes_to_metadata. (slice%<u8.>. main!logimpl_v.PersistentHeaderMetadata.) Bool)
(assert (forall ((bytes! slice%<u8.>.) (out! main!logimpl_v.PersistentHeaderMetadata.)) (! (= (ens%main!logimpl_v.bytes_to_metadata. bytes! out!) (and (has_type (Poly%main!logimpl_v.PersistentHeaderMetadata. out!) TYPE%main!logimpl_v.PersistentHeaderMetadata.) (= out! (main!logimpl_v.spec_bytes_to_metadata.? (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!)))))) :pattern ((ens%main!logimpl_v.bytes_to_metadata. bytes! out!)))))
(set-info :comment ";; Function-Def main::logimpl_v::bytes_to_metadata")
(set-info :comment ";; src/logimpl_v.rs:246:10: 246:78 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::bytes_to_header")
(declare-fun req%main!logimpl_v.bytes_to_header. (slice%<u8.>.) Bool)
(declare-const %%global_location_label%%46 Bool)
(assert (forall ((bytes! slice%<u8.>.)) (! (= (req%main!logimpl_v.bytes_to_header. bytes!) (=> %%global_location_label%%46 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!))) main!logimpl_v.header_size.?))) :pattern ((req%main!logimpl_v.bytes_to_header. bytes!)))))
(declare-fun ens%main!logimpl_v.bytes_to_header. (slice%<u8.>. main!logimpl_v.PersistentHeader.) Bool)
(assert (forall ((bytes! slice%<u8.>.) (out! main!logimpl_v.PersistentHeader.)) (! (= (ens%main!logimpl_v.bytes_to_header. bytes! out!) (and (has_type (Poly%main!logimpl_v.PersistentHeader. out!) TYPE%main!logimpl_v.PersistentHeader.) (= out! (main!logimpl_v.spec_bytes_to_header.? (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!)))))) :pattern ((ens%main!logimpl_v.bytes_to_header. bytes! out!)))))
(set-info :comment ";; Function-Def main::logimpl_v::bytes_to_header")
(set-info :comment ";; src/logimpl_v.rs:209:10: 209:68 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::metadata_to_bytes")
(declare-fun ens%main!logimpl_v.metadata_to_bytes. (main!logimpl_v.PersistentHeaderMetadata. alloc!vec.Vec<u8./allocator_global%.>.) Bool)
(assert (forall ((metadata! main!logimpl_v.PersistentHeaderMetadata.) (out! alloc!vec.Vec<u8./allocator_global%.>.)) (! (= (ens%main!logimpl_v.metadata_to_bytes. metadata! out!) (and (= metadata! (main!logimpl_v.spec_bytes_to_metadata.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!)))) (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!))) (Sub main!logimpl_v.header_size.? 8)))) :pattern ((ens%main!logimpl_v.metadata_to_bytes. metadata! out!)))))
(set-info :comment ";; Function-Def main::logimpl_v::metadata_to_bytes")
(set-info :comment ";; src/logimpl_v.rs:263:10: 263:84 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::header_to_bytes")
(declare-fun ens%main!logimpl_v.header_to_bytes. (main!logimpl_v.PersistentHeader. alloc!vec.Vec<u8./allocator_global%.>.) Bool)
(assert (forall ((header! main!logimpl_v.PersistentHeader.) (out! alloc!vec.Vec<u8./allocator_global%.>.)) (! (= (ens%main!logimpl_v.header_to_bytes. header! out!) (and (= header! (main!logimpl_v.spec_bytes_to_header.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!)))) (= (vstd!bytes.spec_u64_from_le_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!)) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8)))) (main!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header!)))) (= (main!logimpl_v.spec_bytes_to_metadata.? (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!)) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?))) (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header!)))) (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!))) main!logimpl_v.header_size.?))) :pattern ((ens%main!logimpl_v.header_to_bytes. header! out!)))))
(set-info :comment ";; Function-Def main::logimpl_v::header_to_bytes")
(set-info :comment ";; src/logimpl_v.rs:224:10: 224:72 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::crc_and_metadata_bytes_to_header")
(declare-fun req%main!logimpl_v.crc_and_metadata_bytes_to_header. (slice%<u8.>. slice%<u8.>.) Bool)
(declare-const %%global_location_label%%47 Bool)
(declare-const %%global_location_label%%48 Bool)
(assert (forall ((crc_bytes! slice%<u8.>.) (header_bytes! slice%<u8.>.)) (! (= (req%main!logimpl_v.crc_and_metadata_bytes_to_header. crc_bytes! header_bytes!) (and (=> %%global_location_label%%47 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. crc_bytes!))) 8)) (=> %%global_location_label%%48 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. header_bytes!))) (Sub main!logimpl_v.header_size.? 8))))) :pattern ((req%main!logimpl_v.crc_and_metadata_bytes_to_header. crc_bytes! header_bytes!)))))
(declare-fun ens%main!logimpl_v.crc_and_metadata_bytes_to_header. (slice%<u8.>. slice%<u8.>. main!logimpl_v.PersistentHeader.) Bool)
(assert (forall ((crc_bytes! slice%<u8.>.) (header_bytes! slice%<u8.>.) (out! main!logimpl_v.PersistentHeader.)) (! (= (ens%main!logimpl_v.crc_and_metadata_bytes_to_header. crc_bytes! header_bytes! out!) (and (has_type (Poly%main!logimpl_v.PersistentHeader. out!) TYPE%main!logimpl_v.PersistentHeader.) (= (main!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. out!))) (vstd!bytes.spec_u64_from_le_bytes.? (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. crc_bytes!)))) (= (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. out!))) (main!logimpl_v.spec_bytes_to_metadata.? (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. header_bytes!)))))) :pattern ((ens%main!logimpl_v.crc_and_metadata_bytes_to_header. crc_bytes! header_bytes! out!)))))
(set-info :comment ";; Function-Def main::logimpl_v::crc_and_metadata_bytes_to_header")
(set-info :comment ";; src/logimpl_v.rs:292:10: 292:110 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_subrange_equality_implies_index_equality")
(declare-fun req%main!logimpl_v.lemma_subrange_equality_implies_index_equality. (Dcr Type Poly Poly Int Int) Bool)
(declare-const %%global_location_label%%49 Bool)
(declare-const %%global_location_label%%50 Bool)
(declare-const %%global_location_label%%51 Bool)
(assert (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly) (i! Int) (j! Int)) (! (= (req%main!logimpl_v.lemma_subrange_equality_implies_index_equality. T&. T& s1! s2! i! j!) (and (=> %%global_location_label%%49 (and (and (<= 0 i!) (<= i! j!)) (<= j! (vstd!seq.Seq.len.? T&. T& s1!)))) (=> %%global_location_label%%50 (<= j! (vstd!seq.Seq.len.? T&. T& s2!))) (=> %%global_location_label%%51 (= (vstd!seq.Seq.subrange.? T&. T& s1! (I i!) (I j!)) (vstd!seq.Seq.subrange.? T&. T& s2! (I i!) (I j!)))))) :pattern ((req%main!logimpl_v.lemma_subrange_equality_implies_index_equality. T&. T& s1! s2! i! j!)))))
(declare-fun ens%main!logimpl_v.lemma_subrange_equality_implies_index_equality. (Dcr Type Poly Poly Int Int) Bool)
(assert (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly) (i! Int) (j! Int)) (! (= (ens%main!logimpl_v.lemma_subrange_equality_implies_index_equality. T&. T& s1! s2! i! j!) (forall ((k$ Poly)) (! (=> (has_type k$ INT) (=> (and (<= i! (%I k$)) (< (%I k$) j!)) (= (vstd!seq.Seq.index.? T&. T& s1! k$) (vstd!seq.Seq.index.? T&. T& s2! k$)))) :pattern ((vstd!seq.Seq.index.? T&. T& s1! k$)) :pattern ((vstd!seq.Seq.index.? T&. T& s2! k$))))) :pattern ((ens%main!logimpl_v.lemma_subrange_equality_implies_index_equality. T&. T& s1! s2! i! j!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_subrange_equality_implies_index_equality")
(set-info :comment ";; src/logimpl_v.rs:872:5: 872:107 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_subrange_equality_implies_subsubrange_equality")
(declare-fun req%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. (Dcr Type Poly Poly Int Int) Bool)
(declare-const %%global_location_label%%52 Bool)
(declare-const %%global_location_label%%53 Bool)
(declare-const %%global_location_label%%54 Bool)
(assert (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly) (i! Int) (j! Int)) (! (= (req%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. T&. T& s1! s2! i! j!) (and (=> %%global_location_label%%52 (and (and (<= 0 i!) (<= i! j!)) (<= j! (vstd!seq.Seq.len.? T&. T& s1!)))) (=> %%global_location_label%%53 (<= j! (vstd!seq.Seq.len.? T&. T& s2!))) (=> %%global_location_label%%54 (= (vstd!seq.Seq.subrange.? T&. T& s1! (I i!) (I j!)) (vstd!seq.Seq.subrange.? T&. T& s2! (I i!) (I j!)))))) :pattern ((req%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. T&. T& s1! s2! i! j!)))))
(declare-fun ens%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. (Dcr Type Poly Poly Int Int) Bool)
(assert (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly) (i! Int) (j! Int)) (! (= (ens%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. T&. T& s1! s2! i! j!) (forall ((k$ Poly) (m$ Poly)) (! (=> (and (has_type k$ INT) (has_type m$ INT)) (=> (and (and (<= i! (%I k$)) (<= (%I k$) (%I m$))) (<= (%I m$) j!)) (= (vstd!seq.Seq.subrange.? T&. T& s1! k$ m$) (vstd!seq.Seq.subrange.? T&. T& s2! k$ m$)))) :pattern ((vstd!seq.Seq.subrange.? T&. T& s1! k$ m$)) :pattern ((vstd!seq.Seq.subrange.? T&. T& s2! k$ m$))))) :pattern ((ens%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. T&. T& s1! s2! i! j!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_subrange_equality_implies_subsubrange_equality")
(set-info :comment ";; src/logimpl_v.rs:887:5: 887:113 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_subrange_equality_implies_subsubrange_equality_forall")
(declare-fun ens%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality_forall. (Dcr Type) Bool)
(assert (forall ((T&. Dcr) (T& Type)) (! (= (ens%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality_forall. T&. T&) (forall ((s1$ Poly) (s2$ Poly) (i$ Poly) (j$ Poly) (k$ Poly) (m$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!seq.Seq. T&. T&)) (has_type s2$ (TYPE%vstd!seq.Seq. T&. T&)) (has_type i$ INT) (has_type j$ INT) (has_type k$ INT) (has_type m$ INT)) (=> (and (and (and (and (and (<= 0 (%I i$)) (<= (%I i$) (%I j$))) (<= (%I j$) (vstd!seq.Seq.len.? T&. T& s1$))) (<= (%I j$) (vstd!seq.Seq.len.? T&. T& s2$))) (= (vstd!seq.Seq.subrange.? T&. T& s1$ i$ j$) (vstd!seq.Seq.subrange.? T&. T& s2$ i$ j$))) (and (and (<= (%I i$) (%I k$)) (<= (%I k$) (%I m$))) (<= (%I m$) (%I j$)))) (= (vstd!seq.Seq.subrange.? T&. T& s1$ k$ m$) (vstd!seq.Seq.subrange.? T&. T& s2$ k$ m$)))) :pattern ((vstd!seq.Seq.subrange.? T&. T& s1$ i$ j$) (vstd!seq.Seq.subrange.? T&. T& s2$ k$ m$)) :pattern ((vstd!seq.Seq.subrange.? T&. T& s2$ i$ j$) (vstd!seq.Seq.subrange.? T&. T& s1$ k$ m$))))) :pattern ((ens%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality_forall. T&. T&)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_subrange_equality_implies_subsubrange_equality_forall")
(set-info :comment ";; src/logimpl_v.rs:901:5: 901:82 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_headers_unchanged")
(declare-fun req%main!logimpl_v.lemma_headers_unchanged. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
(declare-const %%global_location_label%%55 Bool)
(declare-const %%global_location_label%%56 Bool)
(declare-const %%global_location_label%%57 Bool)
(declare-const %%global_location_label%%58 Bool)
(assert (forall ((old_pm! vstd!seq.Seq<u8.>.) (new_pm! vstd!seq.Seq<u8.>.)) (! (= (req%main!logimpl_v.lemma_headers_unchanged. old_pm! new_pm!) (and (=> %%global_location_label%%55 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!)) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm!)))) (=> %%global_location_label%%56 (>= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!)) main!logimpl_v.contents_offset.?)) (=> %%global_location_label%%57 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!) (I main!logimpl_v.header1_pos.?) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm!) (I main!logimpl_v.header1_pos.?) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?))))) (=> %%global_location_label%%58 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!) (I main!logimpl_v.header2_pos.?) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_size.?))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm!) (I main!logimpl_v.header2_pos.?) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_size.?))))))) :pattern ((req%main!logimpl_v.lemma_headers_unchanged. old_pm! new_pm!)))))
(declare-fun ens%main!logimpl_v.lemma_headers_unchanged. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((old_pm! vstd!seq.Seq<u8.>.) (new_pm! vstd!seq.Seq<u8.>.)) (! (= (ens%main!logimpl_v.lemma_headers_unchanged. old_pm! new_pm!) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. old_pm!)))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm!)))) (let ((new_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (= old_headers$ new_headers$)))))) :pattern ((ens%main!logimpl_v.lemma_headers_unchanged. old_pm! new_pm!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_headers_unchanged")
(set-info :comment ";; src/logimpl_v.rs:924:5: 924:75 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_incorruptible_bool_unchanged")
(declare-fun req%main!logimpl_v.lemma_incorruptible_bool_unchanged. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
...
(assert (forall ((old_pm! vstd!seq.Seq<u8.>.) (new_pm! vstd!seq.Seq<u8.>.)) (! (= (req%main!logimpl_v.lemma_incorruptible_bool_unchanged. old_pm! new_pm!) (and (=> %%global_location_label%%59 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!)) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm!)))) (=> %%global_location_label%%60 (>= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!)) main!logimpl_v.contents_offset.?)) (=> %%global_location_label%%61 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!) (I main!logimpl_v.incorruptible_bool_pos.?) (I (Add main!logimpl_v.incorruptible_bool_pos.? 8))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm!) (I main!logimpl_v.incorruptible_bool_pos.?) (I (Add main!logimpl_v.incorruptible_bool_pos.? 8))))))) :pattern ((req%main!logimpl_v.lemma_incorruptible_bool_unchanged. old_pm! new_pm!)))))
(declare-fun ens%main!logimpl_v.lemma_incorruptible_bool_unchanged. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((old_pm! vstd!seq.Seq<u8.>.) (new_pm! vstd!seq.Seq<u8.>.)) (! (= (ens%main!logimpl_v.lemma_incorruptible_bool_unchanged. old_pm! new_pm!) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. old_pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm!)))) (let ((new_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (= old_ib$ new_ib$)))))) :pattern ((ens%main!logimpl_v.lemma_incorruptible_bool_unchanged. old_pm! new_pm!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_incorruptible_bool_unchanged")
(set-info :comment ";; src/logimpl_v.rs:940:5: 940:86 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_append_data_update_view")
(declare-fun req%main!logimpl_v.lemma_append_data_update_view. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int) Bool)
...
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (new_bytes! vstd!seq.Seq<u8.>.) (write_addr! Int)) (! (= (req%main!logimpl_v.lemma_append_data_update_view. pm! new_bytes! write_addr!) (and (=> %%global_location_label%%62 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (=> %%global_location_label%%63 (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?)) (=> %%global_location_label%%64 (and (<= main!logimpl_v.contents_offset.? write_addr!) (< write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!))))) (=> %%global_location_label%%65 (let ((live_header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((physical_head$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (let ((physical_tail$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (and (=> (<= physical_head$ physical_tail$) (and (and (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_bytes!))) (Add (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))) main!logimpl_v.contents_offset.?)) (=> (< write_addr! physical_head$) (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_bytes!))) physical_head$))) (or (<= physical_tail$ write_addr!) (< write_addr! physical_head$)))) (=> (< physical_tail$ physical_head$) (let ((tmp%%$ (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_bytes!))))) (and (and (<= physical_tail$ write_addr!) (<= write_addr! tmp%%$)) (< tmp%%$ physical_head$))))))))))) :pattern ((req%main!logimpl_v.lemma_append_data_update_view. pm! new_bytes! write_addr!)))))
(declare-fun ens%main!logimpl_v.lemma_append_data_update_view. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int) Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (new_bytes! vstd!seq.Seq<u8.>.) (write_addr! Int)) (! (= (ens%main!logimpl_v.lemma_append_data_update_view. pm! new_bytes! write_addr!) (and (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!))) (main!logimpl_v.update_data_view_postcond.? (Poly%vstd!seq.Seq<u8.>. pm!) (Poly%vstd!seq.Seq<u8.>. new_bytes!) (I write_addr!)))) :pattern ((ens%main!logimpl_v.lemma_append_data_update_view. pm! new_bytes! write_addr!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_append_data_update_view")
(set-info :comment ";; src/logimpl_v.rs:456:5: 456:97 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_same_log_state")
(declare-fun req%main!logimpl_v.lemma_same_log_state. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
...
(assert (forall ((old_pm! vstd!seq.Seq<u8.>.) (new_pm! vstd!seq.Seq<u8.>.)) (! (= (req%main!logimpl_v.lemma_same_log_state. old_pm! new_pm!) (and (=> %%global_location_label%%66 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. old_pm!)))) (=> %%global_location_label%%67 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm!)))) (=> %%global_location_label%%68 (main!logimpl_v.live_data_view_eq.? (Poly%vstd!seq.Seq<u8.>. old_pm!) (Poly%vstd!seq.Seq<u8.>. new_pm!))) (=> %%global_location_label%%69 (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. old_pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm!)))) (let ((new_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (and (and (and (or (= old_ib$ main!pmemspec_t.cdb0_val.?) (= old_ib$ main!pmemspec_t.cdb1_val.?)) (= old_ib$ new_ib$)) (=> (= old_ib$ main!pmemspec_t.cdb0_val.?) (= (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_headers$))) (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_headers$)))))) (=> (= old_ib$ main!pmemspec_t.cdb1_val.?) (= (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_headers$))) (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_headers$))))))))))))))))) :pattern ((req%main!logimpl_v.lemma_same_log_state. old_pm! new_pm!)))))
(declare-fun ens%main!logimpl_v.lemma_same_log_state. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((old_pm! vstd!seq.Seq<u8.>.) (new_pm! vstd!seq.Seq<u8.>.)) (! (= (ens%main!logimpl_v.lemma_same_log_state. old_pm! new_pm!) (ext_eq false (TYPE%core!option.Option. $ TYPE%main!infinitelog_t.AbstractInfiniteLogState.) (Poly%core!option.Option. (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. old_pm!))) (Poly%core!option.Option. (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm!))))) :pattern ((ens%main!logimpl_v.lemma_same_log_state. old_pm! new_pm!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_same_log_state")
(set-info :comment ";; src/logimpl_v.rs:811:5: 811:72 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_append_data_update_view_crash")
(declare-fun req%main!logimpl_v.lemma_append_data_update_view_crash. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int vstd!set.Set<int.>.) Bool)
...
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (new_bytes! vstd!seq.Seq<u8.>.) (write_addr! Int) (chunks_flushed! vstd!set.Set<int.>.)) (! (= (req%main!logimpl_v.lemma_append_data_update_view_crash. pm! new_bytes! write_addr! chunks_flushed!) (and (=> %%global_location_label%%70 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (=> %%global_location_label%%71 (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?)) (=> %%global_location_label%%72 (and (<= main!logimpl_v.contents_offset.? write_addr!) (< write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!))))) (=> %%global_location_label%%73 (let ((live_header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((physical_head$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (let ((physical_tail$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (and (=> (<= physical_head$ physical_tail$) (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_bytes!))) (Add (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))) main!logimpl_v.contents_offset.?))) (=> (< physical_tail$ physical_head$) (< (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_bytes!))) physical_head$))))))))) :pattern ((req%main!logimpl_v.lemma_append_data_update_view_crash. pm! new_bytes! write_addr! chunks_flushed!)))))
(declare-fun ens%main!logimpl_v.lemma_append_data_update_view_crash. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int vstd!set.Set<int.>.) Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (new_bytes! vstd!seq.Seq<u8.>.) (write_addr! Int) (chunks_flushed! vstd!set.Set<int.>.)) (! (= (ens%main!logimpl_v.lemma_append_data_update_view_crash. pm! new_bytes! write_addr! chunks_flushed!) (and (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!))) (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. new_bytes!) (Poly%vstd!set.Set<int.>. chunks_flushed!)))) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm$)))) (let ((new_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (and (and (and (and (and (= old_ib$ new_ib$) (= old_headers$ new_headers$)) (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data$)) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_data$)))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data$) (I 0) (I (Sub write_addr! main!logimpl_v.contents_offset.?))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_data$) (I 0) (I (Sub write_addr! main!logimpl_v.contents_offset.?))))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data$) (I (Add (Sub write_addr! main!logimpl_v.contents_offset.?) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_bytes!)))) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data$)))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_data$) (I (Add (Sub write_addr! main!logimpl_v.contents_offset.?) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_bytes!)))) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_data$)))))) (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm$))))))))))))))) :pattern ((ens%main!logimpl_v.lemma_append_data_update_view_crash. pm! new_bytes! write_addr! chunks_flushed!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_append_data_update_view_crash")
(set-info :comment ";; src/logimpl_v.rs:496:5: 496:129 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_data_write_is_safe")
(declare-fun req%main!logimpl_v.lemma_data_write_is_safe. (Dcr Type vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int Poly) Bool)
...
(assert (forall ((Perm&. Dcr) (Perm& Type) (pm! vstd!seq.Seq<u8.>.) (bytes! vstd!seq.Seq<u8.>.) (write_addr! Int) (perm! Poly)) (! (= (req%main!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& pm! bytes! write_addr! perm!) (and (=> %%global_location_label%%74 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (=> %%global_location_label%%75 (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?)) (=> %%global_location_label%%76 (and (<= main!logimpl_v.contents_offset.? write_addr!) (< write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!))))) (=> %%global_location_label%%77 (%B (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. pm!)))) (=> %%global_location_label%%78 (main!logimpl_v.permissions_depend_only_on_recovery_view.? Perm&. Perm& perm!)) (=> %%global_location_label%%79 (let ((live_header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((physical_head$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (let ((physical_tail$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (and (=> (<= physical_head$ physical_tail$) (and (and (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!))) (Add (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))) main!logimpl_v.contents_offset.?)) (=> (< write_addr! physical_head$) (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!))) physical_head$))) (or (<= physical_tail$ write_addr!) (< write_addr! physical_head$)))) (=> (< physical_tail$ physical_head$) (let ((tmp%%$ (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!))))) (and (and (<= physical_tail$ write_addr!) (<= write_addr! tmp%%$)) (< tmp%%$ physical_head$))))))))))) :pattern ((req%main!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& pm! bytes! write_addr! perm!)))))
(declare-fun ens%main!logimpl_v.lemma_data_write_is_safe. (Dcr Type vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int Poly) Bool)
(assert (forall ((Perm&. Dcr) (Perm& Type) (pm! vstd!seq.Seq<u8.>.) (bytes! vstd!seq.Seq<u8.>.) (write_addr! Int) (perm! Poly)) (! (= (ens%main!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& pm! bytes! write_addr! perm!) (and (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!))) (forall ((chunks_flushed$ Poly)) (! (=> (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT)) (%B (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!) chunks_flushed$))) (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$))))) :pattern ((main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!) chunks_flushed$)))) (%B (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!)))) (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$)))) (main!logimpl_v.update_data_view_postcond.? (Poly%vstd!seq.Seq<u8.>. pm!) (Poly%vstd!seq.Seq<u8.>. bytes!) (I write_addr!)))) :pattern ((ens%main!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& pm! bytes! write_addr! perm!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_data_write_is_safe")
(set-info :comment ";; src/logimpl_v.rs:377:5: 379:44 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_inactive_header_update_view")
(declare-fun req%main!logimpl_v.lemma_inactive_header_update_view. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int) Bool)
...
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (new_header_bytes! vstd!seq.Seq<u8.>.) (header_pos! Int)) (! (= (req%main!logimpl_v.lemma_inactive_header_update_view. pm! new_header_bytes! header_pos!) (and (=> %%global_location_label%%80 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (=> %%global_location_label%%81 (or (= header_pos! main!logimpl_v.header1_pos.?) (= header_pos! main!logimpl_v.header2_pos.?))) (=> %%global_location_label%%82 (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (and (=> (= old_ib$ main!pmemspec_t.cdb0_val.?) (= header_pos! main!logimpl_v.header2_pos.?)) (=> (= old_ib$ main!pmemspec_t.cdb1_val.?) (= header_pos! main!logimpl_v.header1_pos.?)))))))) (=> %%global_location_label%%83 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)) main!logimpl_v.header_size.?)) (=> %%global_location_label%%84 (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?)))) :pattern ((req%main!logimpl_v.lemma_inactive_header_update_view. pm! new_header_bytes! header_pos!)))))
(declare-fun ens%main!logimpl_v.lemma_inactive_header_update_view. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int) Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (new_header_bytes! vstd!seq.Seq<u8.>.) (header_pos! Int)) (! (= (ens%main!logimpl_v.lemma_inactive_header_update_view. pm! new_header_bytes! header_pos!) (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)))) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm$)))) (let ((new_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (and (and (and (and (= old_ib$ new_ib$) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_data$) (Poly%vstd!seq.Seq<u8.>. old_data$))) (=> (= header_pos! main!logimpl_v.header1_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_headers$))) (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_headers$)))))) (=> (= header_pos! main!logimpl_v.header2_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_headers$))) (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_headers$)))))) (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm$)))))))))))))) :pattern ((ens%main!logimpl_v.lemma_inactive_header_update_view. pm! new_header_bytes! header_pos!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_inactive_header_update_view")
(set-info :comment ";; src/logimpl_v.rs:535:5: 535:108 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_inactive_header_update_view_crash")
(declare-fun req%main!logimpl_v.lemma_inactive_header_update_view_crash. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int vstd!set.Set<int.>.) Bool)
...
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (new_header_bytes! vstd!seq.Seq<u8.>.) (header_pos! Int) (chunks_flushed! vstd!set.Set<int.>.)) (! (= (req%main!logimpl_v.lemma_inactive_header_update_view_crash. pm! new_header_bytes! header_pos! chunks_flushed!) (and (=> %%global_location_label%%85 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (=> %%global_location_label%%86 (or (= header_pos! main!logimpl_v.header1_pos.?) (= header_pos! main!logimpl_v.header2_pos.?))) (=> %%global_location_label%%87 (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (and (=> (= old_ib$ main!pmemspec_t.cdb0_val.?) (= header_pos! main!logimpl_v.header2_pos.?)) (=> (= old_ib$ main!pmemspec_t.cdb1_val.?) (= header_pos! main!logimpl_v.header1_pos.?)))))))) (=> %%global_location_label%%88 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)) main!logimpl_v.header_size.?)) (=> %%global_location_label%%89 (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?)))) :pattern ((req%main!logimpl_v.lemma_inactive_header_update_view_crash. pm! new_header_bytes! header_pos! chunks_flushed!)))))
(declare-fun ens%main!logimpl_v.lemma_inactive_header_update_view_crash. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int vstd!set.Set<int.>.) Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (new_header_bytes! vstd!seq.Seq<u8.>.) (header_pos! Int) (chunks_flushed! vstd!set.Set<int.>.)) (! (= (ens%main!logimpl_v.lemma_inactive_header_update_view_crash. pm! new_header_bytes! header_pos! chunks_flushed!) (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!) (Poly%vstd!set.Set<int.>. chunks_flushed!)))) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm$)))) (let ((new_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (let ((new_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (and (and (and (and (= old_ib$ new_ib$) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_data$) (Poly%vstd!seq.Seq<u8.>. old_data$))) (=> (= header_pos! main!logimpl_v.header1_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_headers$))) (main!logimpl_v.HeaderView./HeaderView/header2 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_headers$)))))) (=> (= header_pos! main!logimpl_v.header2_pos.?) (= (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. old_headers$))) (main!logimpl_v.HeaderView./HeaderView/header1 (%Poly%main!logimpl_v.HeaderView. (Poly%main!logimpl_v.HeaderView. new_headers$)))))) (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm$)))))))))))))) :pattern ((ens%main!logimpl_v.lemma_inactive_header_update_view_crash. pm! new_header_bytes! header_pos! chunks_flushed!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_inactive_header_update_view_crash")
(set-info :comment ";; src/logimpl_v.rs:582:5: 582:140 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_single_write_crash")
(declare-fun req%main!logimpl_v.lemma_single_write_crash. (vstd!seq.Seq<u8.>. Int vstd!seq.Seq<u8.>.) Bool)
...
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (write_addr! Int) (bytes_to_write! vstd!seq.Seq<u8.>.)) (! (= (req%main!logimpl_v.lemma_single_write_crash. pm! write_addr! bytes_to_write!) (and (=> %%global_location_label%%90 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)) main!pmemspec_t.persistence_chunk_size.?)) (=> %%global_location_label%%91 (= (EucMod write_addr! main!pmemspec_t.persistence_chunk_size.?) 0)) (=> %%global_location_label%%92 (and (<= 0 write_addr!) (< write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!))))) (=> %%global_location_label%%93 (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!))) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)))))) :pattern ((req%main!logimpl_v.lemma_single_write_crash. pm! write_addr! bytes_to_write!)))))
(declare-fun ens%main!logimpl_v.lemma_single_write_crash. (vstd!seq.Seq<u8.>. Int vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (write_addr! Int) (bytes_to_write! vstd!seq.Seq<u8.>.)) (! (= (ens%main!logimpl_v.lemma_single_write_crash. pm! write_addr! bytes_to_write!) (forall ((chunks_flushed$ Poly)) (! (=> (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT)) (let ((new_crash_contents$ (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!) chunks_flushed$))) (let ((new_contents$ (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)))) (or (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. new_crash_contents$) (Poly%vstd!seq.Seq<u8.>. pm!)) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. new_crash_contents$) (Poly%vstd!seq.Seq<u8.>. new_contents$)))))) :pattern ((main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!) chunks_flushed$))))) :pattern ((ens%main!logimpl_v.lemma_single_write_crash. pm! write_addr! bytes_to_write!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_single_write_crash")
(set-info :comment ";; src/logimpl_v.rs:1008:5: 1008:97 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_header_correct")
(declare-fun req%main!logimpl_v.lemma_header_correct. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int) Bool)
...
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (header_bytes! vstd!seq.Seq<u8.>.) (header_pos! Int)) (! (= (req%main!logimpl_v.lemma_header_correct. pm! header_bytes! header_pos!) (and (=> %%global_location_label%%94 (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?)) (=> %%global_location_label%%95 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!)) main!logimpl_v.header_size.?)) (=> %%global_location_label%%96 (or (= header_pos! main!logimpl_v.header1_pos.?) (= header_pos! main!logimpl_v.header2_pos.?))) (=> %%global_location_label%%97 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8))) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)))))) (=> %%global_location_label%%98 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (I (Add header_pos! main!logimpl_v.header_size.?))) (Poly%vstd!seq.Seq<u8.>. header_bytes!))))) :pattern ((req%main!logimpl_v.lemma_header_correct. pm! header_bytes! header_pos!)))))
(declare-fun ens%main!logimpl_v.lemma_header_correct. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Int) Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.) (header_bytes! vstd!seq.Seq<u8.>.) (header_pos! Int)) (! (= (ens%main!logimpl_v.lemma_header_correct. pm! header_bytes! header_pos!) (and (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! main!logimpl_v.header_crc_offset.?)) (I (Add (Add header_pos! main!logimpl_v.header_crc_offset.?) 8))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8)))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! main!logimpl_v.header_head_offset.?)) (I (Add header_pos! main!logimpl_v.header_size.?))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! main!logimpl_v.header_crc_offset.?)) (I (Add (Add header_pos! main!logimpl_v.header_crc_offset.?) 8))) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! main!logimpl_v.header_head_offset.?)) (I (Add header_pos! main!logimpl_v.header_size.?)))))))) :pattern ((ens%main!logimpl_v.lemma_header_correct. pm! header_bytes! header_pos!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_header_correct")
(set-info :comment ";; src/logimpl_v.rs:970:5: 970:91 (#0)")
...
(assert (forall ((x! Int) (m! Int)) (! (= (req%main!math.lemma_mod_range. x! m!) (=> %%global_location_label%%99 (> m! 0))) :pattern ((req%main!math.lemma_mod_range. x! m!)))))
...
(assert (forall ((x! Int) (y! Int) (d! Int)) (! (= (req%main!math.lemma_mod_difference_equal. x! y! d!) (and (=> %%global_location_label%%100 (> d! 0)) (=> %%global_location_label%%101 (<= x! y!)) (=> %%global_location_label%%102 (<= (EucMod x! d!) (EucMod y! d!))) (=> %%global_location_label%%103 (< (Sub y! x!) d!)))) :pattern ((req%main!math.lemma_mod_difference_equal. x! y! d!)))))
...
(assert (forall ((x! Int) (y! Int) (d! Int)) (! (= (req%main!math.lemma_mod_wrapped_len. x! y! d!) (and (=> %%global_location_label%%104 (> d! 0)) (=> %%global_location_label%%105 (<= x! y!)) (=> %%global_location_label%%106 (> (EucMod x! d!) (EucMod y! d!))) (=> %%global_location_label%%107 (< (Sub y! x!) d!)))) :pattern ((req%main!math.lemma_mod_wrapped_len. x! y! d!)))))
...
(assert (forall ((x! Int) (y! Int) (d! Int)) (! (= (req%main!math.lemma_mod_equal. x! y! d!) (and (=> %%global_location_label%%108 (> d! 0)) (=> %%global_location_label%%109 (<= x! y!)) (=> %%global_location_label%%110 (= (EucMod x! d!) (EucMod y! d!))) (=> %%global_location_label%%111 (< (Sub y! x!) d!)))) :pattern ((req%main!math.lemma_mod_equal. x! y! d!)))))
...
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_pm_state_header")
(declare-fun req%main!logimpl_v.lemma_pm_state_header. (vstd!seq.Seq<u8.>.) Bool)
(declare-const %%global_location_label%%112 Bool)
(declare-const %%global_location_label%%113 Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.)) (! (= (req%main!logimpl_v.lemma_pm_state_header. pm!) (and (=> %%global_location_label%%112 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (=> %%global_location_label%%113 (let ((header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (< (Sub (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$)))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$))))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$))))))))))) :pattern ((req%main!logimpl_v.lemma_pm_state_header. pm!)))))
(declare-fun ens%main!logimpl_v.lemma_pm_state_header. (vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((pm! vstd!seq.Seq<u8.>.)) (! (= (ens%main!logimpl_v.lemma_pm_state_header. pm!) (let ((pm_state$ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (and (is-core!option.Option./Some_ pm_state$) (let ((pm_state$1 (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. pm_state$)))))) (and (= (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$)))))) (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. pm_state$1)))) (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. pm_state$1))))) (Sub (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$)))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header$)))))))))))))) :pattern ((ens%main!logimpl_v.lemma_pm_state_header. pm!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_pm_state_header")
(set-info :comment ";; src/logimpl_v.rs:1025:5: 1025:52 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_append_ib_update")
(declare-fun req%main!logimpl_v.lemma_append_ib_update. (Dcr Type vstd!seq.Seq<u8.>. Int vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Poly) Bool)
...
(assert (forall ((Perm&. Dcr) (Perm& Type) (pm! vstd!seq.Seq<u8.>.) (new_ib! Int) (bytes_to_append! vstd!seq.Seq<u8.>.) (new_header_bytes! vstd!seq.Seq<u8.>.) (perm! Poly)) (! (= (req%main!logimpl_v.lemma_append_ib_update. Perm&. Perm& pm! new_ib! bytes_to_append! new_header_bytes! perm!) (and (=> %%global_location_label%%114 (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?)) (=> %%global_location_label%%115 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (=> %%global_location_label%%116 (or (= new_ib! main!pmemspec_t.cdb0_val.?) (= new_ib! main!pmemspec_t.cdb1_val.?))) (=> %%global_location_label%%117 (=> (= new_ib! main!pmemspec_t.cdb0_val.?) (= (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I main!logimpl_v.header1_pos.?) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?)))) new_header_bytes!))) (=> %%global_location_label%%118 (=> (= new_ib! main!pmemspec_t.cdb1_val.?) (= (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I main!logimpl_v.header2_pos.?) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_size.?)))) new_header_bytes!))) (=> %%global_location_label%%119 (= (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8)))) (main!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?))))) (=> %%global_location_label%%120 (let ((new_header$ (main!logimpl_v.spec_bytes_to_header.? (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)))) (let ((live_header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (and (and (and (= (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. new_header$)))))) (Add (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)))) (= (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. new_header$)))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))) (= (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. new_header$)))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))) (< (Sub (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. new_header$)))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. new_header$))))))) (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. new_header$))))))))))) (=> %%global_location_label%%121 (%B (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. pm!)))) (=> %%global_location_label%%122 (main!logimpl_v.permissions_depend_only_on_recovery_view.? Perm&. Perm& perm!)) (=> %%global_location_label%%123 (let ((live_header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((physical_head$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (let ((physical_tail$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (let ((contents_end$ (Add (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))) main!logimpl_v.contents_offset.?))) (let ((append_size$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)))) (let ((len1$ (Sub contents_end$ physical_tail$))) (let ((len2$ (Sub (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)) len1$))) (and (and (=> (>= (Add physical_tail$ append_size$) contents_end$) (and (and (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I physical_tail$) (I contents_end$)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!) (I 0) (I len1$))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I main!logimpl_v.contents_offset.?) (I (Add main!logimpl_v.contents_offset.? len2$))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!) (I len1$) (I append_size$)))) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!) (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I physical_tail$) (I contents_end$)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I main!logimpl_v.contents_offset.?) (I (Add main!logimpl_v.contents_offset.? len2$))))))) (=> (and (<= physical_head$ physical_tail$) (< (Add physical_tail$ append_size$) contents_end$)) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I physical_tail$) (I (Add physical_tail$ append_size$))) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)))) (=> (< physical_tail$ physical_head$) (and (< (Add physical_tail$ append_size$) physical_head$) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I physical_tail$) (I (Add physical_tail$ append_size$))) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!))))))))))))) (=> %%global_location_label%%124 (let ((old_log_state$ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (forall ((pm_state$ Poly)) (! (=> (has_type pm_state$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (= (%B (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! pm_state$)) (let ((log_state$ (main!logimpl_v.impl&%0.recover.? pm_state$))) (or (= log_state$ old_log_state$) (= log_state$ (core!option.Option./Some (Poly%main!infinitelog_t.AbstractInfiniteLogState. (main!infinitelog_t.impl&%0.append.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. old_log_state$))) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!))))))))) :pattern ((main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! pm_state$)))))))) :pattern ((req%main!logimpl_v.lemma_append_ib_update. Perm&. Perm& pm! new_ib! bytes_to_append! new_header_bytes! perm!)))))
(declare-fun ens%main!logimpl_v.lemma_append_ib_update. (Dcr Type vstd!seq.Seq<u8.>. Int vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Poly) Bool)
(assert (forall ((Perm&. Dcr) (Perm& Type) (pm! vstd!seq.Seq<u8.>.) (new_ib! Int) (bytes_to_append! vstd!seq.Seq<u8.>.) (new_header_bytes! vstd!seq.Seq<u8.>.) (perm! Poly)) (! (= (ens%main!logimpl_v.lemma_append_ib_update. Perm&. Perm& pm! new_ib! bytes_to_append! new_header_bytes! perm!) (and (let ((ib_bytes$ (vstd!bytes.spec_u64_to_le_bytes.? (I new_ib!)))) (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I main!logimpl_v.incorruptible_bool_pos.?) (Poly%vstd!seq.Seq<u8.>. ib_bytes$)))) (let ((old_log_state$ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((new_log_state$ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm$)))) (let ((new_live_header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. new_pm$)))) (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm$)))) (let ((new_pm_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (and (and (let ((tmp%%$1 (tuple%2./tuple%2 (Poly%core!option.Option. old_log_state$) (Poly%core!option.Option. new_log_state$)))) (and (and (and (is-tuple%2./tuple%2_ tmp%%$1) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1)))))) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1)))))) (let ((old_log_state$1 (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1)))))))) (let ((new_log_state$1 (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1)))))))) (and (ext_eq false TYPE%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. new_log_state$1) (Poly%main!infinitelog_t.AbstractInfiniteLogState. (main!infinitelog_t.impl&%0.append.? (Poly%main!infinitelog_t.AbstractInfiniteLogState. old_log_state$1) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)))) (%B (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$)))))))) (= new_live_header$ (main!logimpl_v.spec_bytes_to_header.? (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)))) (= new_ib! new_pm_ib$))))))))) (forall ((chunks_flushed$ Poly)) (! (=> (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT)) (%B (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I main!logimpl_v.incorruptible_bool_pos.?) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I new_ib!))) chunks_flushed$))) (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$))))) :pattern ((main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I main!logimpl_v.incorruptible_bool_pos.?) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I new_ib!))) chunks_flushed$)))))) :pattern ((ens%main!logimpl_v.lemma_append_ib_update. Perm&. Perm& pm! new_ib! bytes_to_append! new_header_bytes! perm!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_append_ib_update")
(set-info :comment ";; src/logimpl_v.rs:632:5: 638:6 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_header_crc_correct")
(declare-fun req%main!logimpl_v.lemma_header_crc_correct. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
...
(assert (forall ((header_bytes! vstd!seq.Seq<u8.>.) (crc_bytes! vstd!seq.Seq<u8.>.) (metadata_bytes! vstd!seq.Seq<u8.>.)) (! (= (req%main!logimpl_v.lemma_header_crc_correct. header_bytes! crc_bytes! metadata_bytes!) (and (=> %%global_location_label%%125 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!)) main!logimpl_v.header_size.?)) (=> %%global_location_label%%126 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!)) 8)) (=> %%global_location_label%%127 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)) (Sub main!logimpl_v.header_size.? 8))) (=> %%global_location_label%%128 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))))) (=> %%global_location_label%%129 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)))))) :pattern ((req%main!logimpl_v.lemma_header_crc_correct. header_bytes! crc_bytes! metadata_bytes!)))))
(declare-fun ens%main!logimpl_v.lemma_header_crc_correct. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((header_bytes! vstd!seq.Seq<u8.>.) (crc_bytes! vstd!seq.Seq<u8.>.) (metadata_bytes! vstd!seq.Seq<u8.>.)) (! (= (ens%main!logimpl_v.lemma_header_crc_correct. header_bytes! crc_bytes! metadata_bytes!) (and (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8))) (Poly%vstd!seq.Seq<u8.>. crc_bytes!)) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8))) (Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?))))))) :pattern ((ens%main!logimpl_v.lemma_header_crc_correct. header_bytes! crc_bytes! metadata_bytes!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_header_crc_correct")
(set-info :comment ";; src/logimpl_v.rs:953:5: 953:110 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_u64_bytes_eq")
(declare-fun req%main!logimpl_v.lemma_u64_bytes_eq. (Int Int) Bool)
(declare-const %%global_location_label%%130 Bool)
(assert (forall ((val1! Int) (val2! Int)) (! (= (req%main!logimpl_v.lemma_u64_bytes_eq. val1! val2!) (=> %%global_location_label%%130 (= val1! val2!))) :pattern ((req%main!logimpl_v.lemma_u64_bytes_eq. val1! val2!)))))
(declare-fun ens%main!logimpl_v.lemma_u64_bytes_eq. (Int Int) Bool)
(assert (forall ((val1! Int) (val2! Int)) (! (= (ens%main!logimpl_v.lemma_u64_bytes_eq. val1! val2!) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I val1!))) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I val2!))))) :pattern ((ens%main!logimpl_v.lemma_u64_bytes_eq. val1! val2!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_u64_bytes_eq")
(set-info :comment ";; src/logimpl_v.rs:992:5: 992:58 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::lemma_subrange_eq")
(declare-fun req%main!logimpl_v.lemma_subrange_eq. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%131 Bool)
(assert (forall ((T&. Dcr) (T& Type) (bytes1! Poly) (bytes2! Poly)) (! (= (req%main!logimpl_v.lemma_subrange_eq. T&. T& bytes1! bytes2!) (=> %%global_location_label%%131 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) bytes1! bytes2!))) :pattern ((req%main!logimpl_v.lemma_subrange_eq. T&. T& bytes1! bytes2!)))))
(declare-fun ens%main!logimpl_v.lemma_subrange_eq. (Dcr Type Poly Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (bytes1! Poly) (bytes2! Poly)) (! (= (ens%main!logimpl_v.lemma_subrange_eq. T&. T& bytes1! bytes2!) (forall ((i$ Poly) (j$ Poly)) (! (=> (and (has_type i$ INT) (has_type j$ INT)) (=> (and (and (<= 0 (%I i$)) (< (%I i$) (%I j$))) (< (%I j$) (vstd!seq.Seq.len.? T&. T& bytes1!))) (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& bytes1! i$ j$) (vstd!seq.Seq.subrange.? T&. T& bytes2! i$ j$)))) :pattern ((vstd!seq.Seq.subrange.? T&. T& bytes1! i$ j$)) :pattern ((vstd!seq.Seq.subrange.? T&. T& bytes2! i$ j$))))) :pattern ((ens%main!logimpl_v.lemma_subrange_eq. T&. T& bytes1! bytes2!)))))
(set-info :comment ";; Function-Def main::logimpl_v::lemma_subrange_eq")
(set-info :comment ";; src/logimpl_v.rs:999:5: 999:70 (#0)")
(set-info :comment ";; Function-Specs main::logimpl_v::UntrustedLogImpl::addr_logical_to_physical")
(declare-fun req%main!logimpl_v.impl&%0.addr_logical_to_physical. (Int Int) Bool)
...
(assert (forall ((addr! Int) (log_size! Int)) (! (= (req%main!logimpl_v.impl&%0.addr_logical_to_physical. addr! log_size!) (and (=> %%global_location_label%%132 (<= addr! 18446744073709551615)) (=> %%global_location_label%%133 (> log_size! 0)) (=> %%global_location_label%%134 (<= (Add log_size! main!logimpl_v.contents_offset.?) 18446744073709551615)))) :pattern ((req%main!logimpl_v.impl&%0.addr_logical_to_physical. addr! log_size!)))))
(declare-fun ens%main!logimpl_v.impl&%0.addr_logical_to_physical. (Int Int Int) Bool)
(assert (forall ((addr! Int) (log_size! Int) (out! Int)) (! (= (ens%main!logimpl_v.impl&%0.addr_logical_to_physical. addr! log_size! out!) (and (uInv 64 out!) (= out! (main!logimpl_v.spec_addr_logical_to_physical.? (I addr!) (I log_size!))))) :pattern ((ens%main!logimpl_v.impl&%0.addr_logical_to_physical. addr! log_size! out!)))))
(set-info :comment ";; Function-Def main::logimpl_v::UntrustedLogImpl::addr_logical_to_physical")
(set-info :comment ";; src/logimpl_v.rs:1090:9: 1090:84 (#0)")
(declare-const out! Int)
(declare-const addr! Int)
(declare-const log_size! Int)
(assert fuel_defaults)
(assert (uInv 64 addr!))
(assert (uInv 64 log_size!))
(assert (<= addr! 18446744073709551615))
(assert (> log_size! 0))
(assert (<= (Add log_size! main!logimpl_v.contents_offset.?) 18446744073709551615))
...
(assert (not (and (=> %%location_label%%0 (not (= log_size! 0))) (and (=> %%location_label%%1 (uInv 64 (Add (uClip 64 (EucMod addr! log_size!)) main!logimpl_v.contents_offset.?))) (=> (= out! (uClip 64 (Add (uClip 64 (EucMod addr! log_size!)) main!logimpl_v.contents_offset.?))) (=> %%location_label%%2 (= out! (main!logimpl_v.spec_addr_logical_to_physical.? (I addr!) (I log_size!)))))))))
(check-sat)
(exit)
