...
(assert (not (=> (ens%lib!bin_sizes.lemma_bin_sizes_constants. 0) (=> (= tmp%1 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 1 (%I j$)) (<= (%I j$) 8)) (= (EucDiv (Sub (nClip (Add (lib!bin_sizes.size_of_bin.? j$) 8)) 1) 8) (%I j$)))) :pattern ((lib!bin_sizes.size_of_bin.? j$))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (or (and (=> (and (<= 1 bin_idx!) (<= bin_idx! 8)) %%switch_label%%0) (=> (not (and (<= 1 bin_idx!) (<= bin_idx! 8))) (or (and (=> (and (< 8 bin_idx!) (< bin_idx! 73)) (=> (lib!bin_sizes.check_smallest_bin_fitting_size_size_of_bin.? (I 9) (I 73)) (=> (ens%lib!bin_sizes.result_smallest_bin_fitting_size_size_of_bin. 9 73) (=> (= tmp%2 (lib!bin_sizes.property_smallest_bin_fitting_size_size_of_bin.? (I bin_idx!))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%1)))))) (=> (not (and (< 8 bin_idx!) (< bin_idx! 73))) (or (and (=> (= bin_idx! 73) (=> (= tmp%3 (> (EucDiv (Sub (nClip (Add (lib!bin_sizes.size_of_bin.? (I lib!config.BIN_HUGE.?)) 8)) 1) 8) 524288)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%2)))) (=> (not (= bin_idx! 73)) %%switch_label%%2)) (and (not %%switch_label%%2) %%switch_label%%1)))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%3 (= (lib!bin_sizes.smallest_bin_fitting_size.? (I (lib!bin_sizes.size_of_bin.? (I bin_idx!)))) bin_idx!))))))))))
(check-sat)
(exit)
