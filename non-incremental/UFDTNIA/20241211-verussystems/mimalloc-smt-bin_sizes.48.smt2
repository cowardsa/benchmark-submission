...
(set-info :comment ";; Function-Specs lib::bin_sizes::slice_bin")
(declare-fun req%lib!bin_sizes.slice_bin. (Int) Bool)
(declare-const %%global_location_label%%50 Bool)
(assert (forall ((slice_count! Int)) (! (= (req%lib!bin_sizes.slice_bin. slice_count!) (=> %%global_location_label%%50 (<= slice_count! lib!config.SLICES_PER_SEGMENT.?))) :pattern ((req%lib!bin_sizes.slice_bin. slice_count!)))))
(declare-fun ens%lib!bin_sizes.slice_bin. (Int Int) Bool)
(assert (forall ((slice_count! Int) (sbin_idx! Int)) (! (= (ens%lib!bin_sizes.slice_bin. slice_count! sbin_idx!) (and (uInv SZ sbin_idx!) (lib!bin_sizes.valid_sbin_idx.? (I sbin_idx!)) (>= (lib!bin_sizes.size_of_sbin.? (I sbin_idx!)) slice_count!) (= sbin_idx! (lib!bin_sizes.smallest_sbin_fitting_size.? (I slice_count!))))) :pattern ((ens%lib!bin_sizes.slice_bin. slice_count! sbin_idx!)))))
(set-info :comment ";; Function-Def lib::bin_sizes::slice_bin")
(set-info :comment ";; bin_sizes.rs:1315:1: 1315:57 (#0)")
(declare-const sbin_idx! Int)
(declare-const slice_count! Int)
...
(assert (uInv SZ slice_count!))
(assert (<= slice_count! lib!config.SLICES_PER_SEGMENT.?))
...
(assert (not (or (and (=> (<= slice_count! 8) (=> (= tmp%6 slice_count!) %%switch_label%%0)) (=> (not (<= slice_count! 8)) (and (=> %%location_label%%0 (uInv SZ (Sub slice_count! 1))) (=> (= w@ (uClip 64 (uClip SZ (Sub slice_count! 1)))) (=> (= lib!config.SLICES_PER_SEGMENT.? 512) (=> (= tmp%1 (and (<= 9 slice_count!) (<= slice_count! 512))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= tmp%2 (and (<= 8 w@) (<= w@ 511))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (ens%core!num.impl&%9.leading_zeros. w@ lz@) (=> (lib!bin_sizes.check_sbin_bounds.? (I 8) (I 512)) (=> (ens%lib!bin_sizes.result_sbin_bounds. 8 512) (=> (= tmp%3 (lib!bin_sizes.property_sbin_bounds.? (I w@))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (and (=> %%location_label%%4 (uInv 32 (Sub SZ 1))) (and (=> %%location_label%%5 (uInv 32 (Sub (uClip 32 (Sub SZ 1)) lz@))) (=> (= b@ (uClip 8 (uClip 32 (Sub (uClip 32 (Sub SZ 1)) lz@)))) (and (=> %%location_label%%6 (and (<= 0 2) (< 2 8))) (and (=> %%location_label%%7 (uInv 64 (Sub (uClip 64 b@) 2))) (and (=> %%location_label%%8 (and (<= 0 (uClip 64 (Sub (uClip 64 b@) 2))) (< (uClip 64 (Sub (uClip 64 b@) 2)) 64))) (and (=> %%location_label%%9 (uInv 64 (Sub (uClip 64 (bitor (I (uClip 64 (uClip 8 (bitshl (I b@) (I 2))))) (I (uClip 64 (bitand (I (uClip 64 (bitshr (I w@) (I (uClip 64 (Sub (uClip 64 b@) 2)))))) (I 3)))))) 4))) (=> (= sbin_idx@ (uClip 64 (Sub (uClip 64 (bitor (I (uClip 64 (uClip 8 (bitshl (I b@) (I 2))))) (I (uClip 64 (bitand (I (uClip 64 (bitshr (I w@) (I (uClip 64 (Sub (uClip 64 b@) 2)))))) (I 3)))))) 4))) (=> (= tmp%4 (= sbin_idx@ (lib!bin_sizes.smallest_sbin_fitting_size.? (I slice_count!)))) (and (=> %%location_label%%10 tmp%4) (=> tmp%4 (=> (lib!bin_sizes.check_sbin.? (I 9) (I 513)) (=> (ens%lib!bin_sizes.result_sbin. 9 513) (=> (= tmp%5 (lib!bin_sizes.property_sbin.? (I slice_count!))) (and (=> %%location_label%%11 tmp%5) (=> tmp%5 (=> (= tmp%6 (uClip SZ sbin_idx@)) %%switch_label%%0)))))))))))))))))))))))))))))))))) (and (not %%switch_label%%0) (=> (= sbin_idx! tmp%6) (and (=> %%location_label%%12 (lib!bin_sizes.valid_sbin_idx.? (I sbin_idx!))) (and (=> %%location_label%%13 (>= (lib!bin_sizes.size_of_sbin.? (I sbin_idx!)) slice_count!)) (=> %%location_label%%14 (= sbin_idx! (lib!bin_sizes.smallest_sbin_fitting_size.? (I slice_count!)))))))))))
(check-sat)
(exit)
