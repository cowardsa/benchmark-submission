...
(declare-const wrpm@0 Poly)
(declare-const verus_tmp@ main!main_t.TrustedPermission.)
(declare-const perm@0 main!main_t.TrustedPermission.)
(assert fuel_defaults)
(assert (has_type pm! PM&))
(assert (uInv 64 device_size!))
(assert (tr_bound%main!pmemspec_t.PersistentMemory. PM&. PM&))
(assert (%B (main!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!)))
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!)) device_size!))
(assert (is-core!option.Option./Some_ (%Poly%core!option.Option. (%%apply%%0 (main!main_t.recovery_view.? (I 0)) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!)))))
(declare-fun %%lambda%%2 (Poly) %%Function%%)
(assert (forall ((%%hole%%0 Poly) (s1$ Poly) (s2$ Poly)) (! (= (%%apply%%1 (%%lambda%%2 %%hole%%0) s1$ s2$) %%hole%%0) :pattern ((%%apply%%1 (%%lambda%%2 %%hole%%0) s1$ s2$)))))
(declare-const perm@1 main!main_t.TrustedPermission.)
(declare-const wrpm@1 Poly)
...
(assert (not (and (=> %%location_label%%0 (req%main!pmemspec_t.impl&%0.new. $ TYPE%main!main_t.TrustedPermission. PM&. PM& pm!)) (=> (ens%main!pmemspec_t.impl&%0.new. $ TYPE%main!main_t.TrustedPermission. PM&. PM& pm! wrpm@0) (=> (= tmp%1 (%Poly%vstd!seq.Seq<u8.>. (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!))) (=> (= tmp%2 (mk_fun (%%lambda%%2 (B false)))) (=> (ens%main!main_t.impl&%1.new. tmp%1 tmp%2 verus_tmp@) (=> (= verus_tmp_perm@ verus_tmp@) (=> (= perm@1 verus_tmp_perm@) (and (=> %%location_label%%1 (req%main!logimpl_v.impl&%0.untrusted_start. $ TYPE%main!main_t.TrustedPermission. PM&. PM& wrpm@0 device_size! (Poly%main!main_t.TrustedPermission. perm@1))) (=> (has_type wrpm@1 (TYPE%main!pmemspec_t.WriteRestrictedPersistentMemory. $ TYPE%main!main_t.TrustedPermission. PM&. PM&)) (=> (ens%main!logimpl_v.impl&%0.untrusted_start. $ TYPE%main!main_t.TrustedPermission. PM&. PM& wrpm@0 wrpm@1 device_size! (Poly%main!main_t.TrustedPermission. perm@1) tmp%%@) (=> (= result! (ite (is-core!result.Result./Ok_ tmp%%@) (let ((untrusted_log_impl$ (%Poly%main!logimpl_v.UntrustedLogImpl. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@)))))) (core!result.Result./Ok (Poly%main!main_t.InfiniteLogImpl. (main!main_t.InfiniteLogImpl./InfiniteLogImpl (%Poly%main!logimpl_v.UntrustedLogImpl. (Poly%main!logimpl_v.UntrustedLogImpl. untrusted_log_impl$)) wrpm@1)))) (let ((e$ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%@)))))) (core!result.Result./Err (Poly%main!main_t.InfiniteLogErr. e$))))) (=> %%location_label%%2 (ite (is-core!result.Result./Ok_ result!) (let ((trusted_log_impl$ (%Poly%main!main_t.InfiniteLogImpl. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (and (and (main!main_t.impl&%4.valid.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. trusted_log_impl$)) (= (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. trusted_log_impl$)) (%Poly%core!option.Option. (%%apply%%0 (main!main_t.recovery_view.? (I 0)) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!))))) (= (main!main_t.impl&%4.constants.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. trusted_log_impl$)) (%Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!))))) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./CRCMismatch_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (main!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%main!pmemspec_t.PersistentMemoryConstants. (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!))))))))))))))))))))
(check-sat)
(exit)
