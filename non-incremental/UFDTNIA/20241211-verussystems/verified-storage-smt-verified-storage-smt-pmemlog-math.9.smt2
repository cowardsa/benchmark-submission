...
(assert (not (and (=> %%location_label%%0 (req%main!math.lemma_fundamental_div_mod. x! d!)) (=> (ens%main!math.lemma_fundamental_div_mod. x! d!) (and (=> %%location_label%%1 (req%main!math.lemma_fundamental_div_mod. y! d!)) (=> (ens%main!math.lemma_fundamental_div_mod. y! d!) (and (=> %%location_label%%2 (req%main!math.lemma_mod_range. x! d!)) (=> (ens%main!math.lemma_mod_range. x! d!) (and (=> %%location_label%%3 (req%main!math.lemma_mod_range. y! d!)) (=> (ens%main!math.lemma_mod_range. y! d!) (=> (= tmp%1 (= (Sub (Add (Sub (Mul d! (EucDiv y! d!)) (Mul d! (EucDiv x! d!))) (EucMod y! d!)) (EucMod x! d!)) (Sub y! x!))) (and (=> %%location_label%%4 tmp%1) (=> tmp%1 (=> (= tmp%2 (EucDiv y! d!)) (=> (= tmp%3 (EucDiv x! d!)) (=> (ens%main!math.lemma_mul_is_distributive_sub. d! tmp%2 tmp%3) (=> (= tmp%4 (= (Sub (Add (Mul d! (Sub (EucDiv y! d!) (EucDiv x! d!))) (EucMod y! d!)) (EucMod x! d!)) (Sub y! x!))) (and (=> %%location_label%%5 tmp%4) (=> tmp%4 (=> (= tmp%5 (let ((tmp%%$ (Sub (Add (Mul d! (Sub (EucDiv y! d!) (EucDiv x! d!))) (EucMod y! d!)) (EucMod x! d!)))) (and (<= 0 tmp%%$) (< tmp%%$ d!)))) (and (=> %%location_label%%6 tmp%5) (=> tmp%5 (and (=> %%location_label%%7 (req%main!math.lemma_div_relation_when_mods_have_different_order_alt. d! x! y!)) (=> (ens%main!math.lemma_div_relation_when_mods_have_different_order_alt. d! x! y!) (=> (= tmp%6 (= (EucDiv y! d!) (Add (EucDiv x! d!) 1))) (and (=> %%location_label%%8 tmp%6) (=> tmp%6 (and (=> %%location_label%%9 true) (=> (=> (= (Sub (EucDiv y! d!) (EucDiv x! d!)) 1) (= (Mul d! (Sub (EucDiv y! d!) (EucDiv x! d!))) d!)) (=> %%location_label%%10 (= (Add (Sub d! (EucMod x! d!)) (EucMod y! d!)) (Sub y! x!))))))))))))))))))))))))))))))))
(check-sat)
(exit)
