...
(assert (not (=> (= decrease%init0 i!) (or (and (=> (= i! 1) (=> (= tmp%3 0) %%switch_label%%0)) (=> (not (= i! 1)) (=> (= tmp%2 (uClip 64 (EucDiv i! 2))) (and (=> %%location_label%%0 (check_decrease_int (let ((i!$0 tmp%2)) i!$0) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!bin_sizes.log2. tmp%2)) (=> (ens%lib!bin_sizes.log2. tmp%2 tmp%1) (=> (= tmp%3 (nClip (Add tmp%1 1))) %%switch_label%%0))))))) (and (not %%switch_label%%0) (=> (= e! tmp%3) (=> %%location_label%%2 (and (<= (lib!bin_sizes.pow2.? (I e!)) i!) (< i! (lib!bin_sizes.pow2.? (I (nClip (Add e! 1)))))))))))))
(check-sat)
(exit)
