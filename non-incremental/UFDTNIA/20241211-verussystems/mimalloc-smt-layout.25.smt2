...
(set-info :comment ";; Function-Specs lib::types::SegmentPtr::ptr_segment")
(declare-fun req%lib!layout.impl&%0.ptr_segment. (lib!types.PagePtr.) Bool)
(declare-const %%global_location_label%%4 Bool)
(assert (forall ((page_ptr! lib!types.PagePtr.)) (! (= (req%lib!layout.impl&%0.ptr_segment. page_ptr!) (=> %%global_location_label%%4 (and (lib!layout.is_page_ptr.? (Poly%ptr_mut%<lib!types.Page.>. (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!)))) (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!))))) (not (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!types.Page.) (Poly%ptr_mut%<lib!types.Page.>. (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!))))))) 0))))) :pattern ((req%lib!layout.impl&%0.ptr_segment. page_ptr!)))))
(declare-fun ens%lib!layout.impl&%0.ptr_segment. (lib!types.PagePtr. lib!types.SegmentPtr.) Bool)
(assert (forall ((page_ptr! lib!types.PagePtr.) (segment_ptr! lib!types.SegmentPtr.)) (! (= (ens%lib!layout.impl&%0.ptr_segment. page_ptr! segment_ptr!) (and (has_type (Poly%lib!types.SegmentPtr. segment_ptr!) TYPE%lib!types.SegmentPtr.) (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!)))) (Poly%lib!tokens.SegmentId. (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!))))) (= (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!))) (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!))))))))) :pattern ((ens%lib!layout.impl&%0.ptr_segment. page_ptr! segment_ptr!)))))
(set-info :comment ";; Function-Def lib::types::SegmentPtr::ptr_segment")
(set-info :comment ";; layout.rs:590:5: 590:70 (#0)")
...
(set-info :comment ";; Function-Def lib::layout::block_size_ge_word")
(set-info :comment ";; layout.rs:114:1: 114:34 (#0)")
...
(set-info :comment ";; Function-Specs lib::layout::mod_mul")
(declare-fun req%lib!layout.mod_mul. (Int Int Int) Bool)
(declare-const %%global_location_label%%5 Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (req%lib!layout.mod_mul. a! b! c!) (=> %%global_location_label%%5 (= (EucMod b! c!) 0))) :pattern ((req%lib!layout.mod_mul. a! b! c!)))))
(declare-fun ens%lib!layout.mod_mul. (Int Int Int) Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (ens%lib!layout.mod_mul. a! b! c!) (= (EucMod (Mul a! b!) c!) 0)) :pattern ((ens%lib!layout.mod_mul. a! b! c!)))))
(set-info :comment ";; Function-Def lib::layout::mod_mul")
(set-info :comment ";; layout.rs:573:1: 573:45 (#0)")
...
(set-info :comment ";; Function-Def lib::layout::block_start_at_diff")
(set-info :comment ";; layout.rs:147:1: 148:36 (#0)")
(set-info :comment ";; Function-Specs lib::layout::calculate_segment_ptr_from_block")
(declare-fun req%lib!layout.calculate_segment_ptr_from_block. (ptr_mut%<u8.>. lib!tokens.BlockId.) Bool)
(declare-const %%global_location_label%%6 Bool)
(assert (forall ((ptr! ptr_mut%<u8.>.) (block_id! lib!tokens.BlockId.)) (! (= (req%lib!layout.calculate_segment_ptr_from_block. ptr! block_id!) (=> %%global_location_label%%6 (lib!layout.is_block_ptr.? (Poly%ptr_mut%<u8.>. ptr!) (Poly%lib!tokens.BlockId. block_id!)))) :pattern ((req%lib!layout.calculate_segment_ptr_from_block. ptr! block_id!)))))
(declare-fun ens%lib!layout.calculate_segment_ptr_from_block. (ptr_mut%<u8.>. lib!tokens.BlockId. ptr_mut%<lib!types.SegmentHeader.>.) Bool)
(assert (forall ((ptr! ptr_mut%<u8.>.) (block_id! lib!tokens.BlockId.) (res! ptr_mut%<lib!types.SegmentHeader.>.)) (! (= (ens%lib!layout.calculate_segment_ptr_from_block. ptr! block_id! res!) (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. res!) (Poly%lib!tokens.SegmentId. (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!tokens.BlockId./BlockId/page_id (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. block_id!))))))))) :pattern ((ens%lib!layout.calculate_segment_ptr_from_block. ptr! block_id! res!)))))
(set-info :comment ";; Function-Def lib::layout::calculate_segment_ptr_from_block")
(set-info :comment ";; layout.rs:206:1: 206:115 (#0)")
(set-info :comment ";; Function-Specs lib::layout::calculate_slice_page_ptr_from_block")
(declare-fun req%lib!layout.calculate_slice_page_ptr_from_block. (ptr_mut%<u8.>. ptr_mut%<lib!types.SegmentHeader.>. lib!tokens.BlockId.) Bool)
(declare-const %%global_location_label%%7 Bool)
(declare-const %%global_location_label%%8 Bool)
(assert (forall ((block_ptr! ptr_mut%<u8.>.) (segment_ptr! ptr_mut%<lib!types.SegmentHeader.>.) (block_id! lib!tokens.BlockId.)) (! (= (req%lib!layout.calculate_slice_page_ptr_from_block. block_ptr! segment_ptr! block_id!) (and (=> %%global_location_label%%7 (lib!layout.is_block_ptr.? (Poly%ptr_mut%<u8.>. block_ptr!) (Poly%lib!tokens.BlockId. block_id!))) (=> %%global_location_label%%8 (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. segment_ptr!) (Poly%lib!tokens.SegmentId. (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!tokens.BlockId./BlockId/page_id (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. block_id!))))))))))) :pattern ((req%lib!layout.calculate_slice_page_ptr_from_block. block_ptr! segment_ptr! block_id!)))))
(declare-fun ens%lib!layout.calculate_slice_page_ptr_from_block. (ptr_mut%<u8.>. ptr_mut%<lib!types.SegmentHeader.>. lib!tokens.BlockId. ptr_mut%<lib!types.Page.>.) Bool)
(assert (forall ((block_ptr! ptr_mut%<u8.>.) (segment_ptr! ptr_mut%<lib!types.SegmentHeader.>.) (block_id! lib!tokens.BlockId.) (page_ptr! ptr_mut%<lib!types.Page.>.)) (! (= (ens%lib!layout.calculate_slice_page_ptr_from_block. block_ptr! segment_ptr! block_id! page_ptr!) (lib!layout.is_page_ptr.? (Poly%ptr_mut%<lib!types.Page.>. page_ptr!) (Poly%lib!tokens.PageId. (lib!tokens.impl&%1.page_id_for_slice.? (Poly%lib!tokens.BlockId. block_id!))))) :pattern ((ens%lib!layout.calculate_slice_page_ptr_from_block. block_ptr! segment_ptr! block_id! page_ptr!)))))
(set-info :comment ";; Function-Def lib::layout::calculate_slice_page_ptr_from_block")
(set-info :comment ";; layout.rs:270:1: 270:153 (#0)")
(set-info :comment ";; Function-Specs lib::layout::calculate_page_ptr_subtract_offset")
(declare-fun req%lib!layout.calculate_page_ptr_subtract_offset. (ptr_mut%<lib!types.Page.>. Int lib!tokens.PageId. lib!tokens.PageId.) Bool)
(declare-const %%global_location_label%%9 Bool)
(declare-const %%global_location_label%%10 Bool)
(declare-const %%global_location_label%%11 Bool)
(assert (forall ((page_ptr! ptr_mut%<lib!types.Page.>.) (offset! Int) (page_id! lib!tokens.PageId.) (target_page_id! lib!tokens.PageId.)) (! (= (req%lib!layout.calculate_page_ptr_subtract_offset. page_ptr! offset! page_id! target_page_id!) (and (=> %%global_location_label%%9 (lib!layout.is_page_ptr.? (Poly%ptr_mut%<lib!types.Page.>. page_ptr!) (Poly%lib!tokens.PageId. page_id!))) (=> %%global_location_label%%10 (= (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. page_id!))) (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. target_page_id!))))) (=> %%global_location_label%%11 (= offset! (Mul (Sub (lib!tokens.PageId./PageId/idx (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. page_id!))) (lib!tokens.PageId./PageId/idx (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. target_page_id!)))) lib!config.SIZEOF_PAGE_HEADER.?))))) :pattern ((req%lib!layout.calculate_page_ptr_subtract_offset. page_ptr! offset! page_id! target_page_id!)))))
(declare-fun ens%lib!layout.calculate_page_ptr_subtract_offset. (ptr_mut%<lib!types.Page.>. Int lib!tokens.PageId. lib!tokens.PageId. ptr_mut%<lib!types.Page.>.) Bool)
(assert (forall ((page_ptr! ptr_mut%<lib!types.Page.>.) (offset! Int) (page_id! lib!tokens.PageId.) (target_page_id! lib!tokens.PageId.) (result! ptr_mut%<lib!types.Page.>.)) (! (= (ens%lib!layout.calculate_page_ptr_subtract_offset. page_ptr! offset! page_id! target_page_id! result!) (lib!layout.is_page_ptr.? (Poly%ptr_mut%<lib!types.Page.>. result!) (Poly%lib!tokens.PageId. target_page_id!))) :pattern ((ens%lib!layout.calculate_page_ptr_subtract_offset. page_ptr! offset! page_id! target_page_id! result!)))))
(set-info :comment ";; Function-Def lib::layout::calculate_page_ptr_subtract_offset")
(set-info :comment ";; layout.rs:295:1: 296:129 (#0)")
(set-info :comment ";; Function-Specs lib::layout::segment_page_start_from_slice")
(declare-fun req%lib!layout.segment_page_start_from_slice. (lib!types.SegmentPtr. lib!types.PagePtr. Int) Bool)
(declare-const %%global_location_label%%12 Bool)
(declare-const %%global_location_label%%13 Bool)
(declare-const %%global_location_label%%14 Bool)
(assert (forall ((segment_ptr! lib!types.SegmentPtr.) (slice! lib!types.PagePtr.) (xblock_size! Int)) (! (= (req%lib!layout.segment_page_start_from_slice. segment_ptr! slice! xblock_size!) (and (=> %%global_location_label%%12 (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!)))) (Poly%lib!tokens.SegmentId. (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!)))))) (=> %%global_location_label%%13 (and (lib!layout.is_page_ptr.? (Poly%ptr_mut%<lib!types.Page.>. (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!)))) (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!))))) (not (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!types.Page.) (Poly%ptr_mut%<lib!types.Page.>. (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!))))))) 0)))) (=> %%global_location_label%%14 (= (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!)))))) (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!))))))) :pattern ((req%lib!layout.segment_page_start_from_slice. segment_ptr! slice! xblock_size!)))))
(declare-fun ens%lib!layout.segment_page_start_from_slice. (lib!types.SegmentPtr. lib!types.PagePtr. Int Int) Bool)
(assert (forall ((segment_ptr! lib!types.SegmentPtr.) (slice! lib!types.PagePtr.) (xblock_size! Int) (res! Int)) (! (= (ens%lib!layout.segment_page_start_from_slice. segment_ptr! slice! xblock_size! res!) (and (uInv SZ res!) (let ((start_offset$ res!)) (and (=> (= xblock_size! 0) (= start_offset$ (Add (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!))))) (Mul (lib!tokens.PageId./PageId/idx (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!)))))) lib!config.SLICE_SIZE.?)))) (=> (> xblock_size! 0) (= start_offset$ (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!)))) (I xblock_size!) (I 0)))))))) :pattern ((ens%lib!layout.segment_page_start_from_slice. segment_ptr! slice! xblock_size! res!)))))
(set-info :comment ";; Function-Def lib::layout::segment_page_start_from_slice")
(set-info :comment ";; layout.rs:387:1: 391:17 (#0)")
(set-info :comment ";; Function-Specs lib::layout::calculate_page_start")
(declare-fun req%lib!layout.calculate_page_start. (lib!types.PagePtr. Int) Bool)
(declare-const %%global_location_label%%15 Bool)
(declare-const %%global_location_label%%16 Bool)
(assert (forall ((page_ptr! lib!types.PagePtr.) (block_size! Int)) (! (= (req%lib!layout.calculate_page_start. page_ptr! block_size!) (and (=> %%global_location_label%%15 (> block_size! 0)) (=> %%global_location_label%%16 (and (lib!layout.is_page_ptr.? (Poly%ptr_mut%<lib!types.Page.>. (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!)))) (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!))))) (not (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!types.Page.) (Poly%ptr_mut%<lib!types.Page.>. (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!))))))) 0)))))) :pattern ((req%lib!layout.calculate_page_start. page_ptr! block_size!)))))
(declare-fun ens%lib!layout.calculate_page_start. (lib!types.PagePtr. Int Int) Bool)
(assert (forall ((page_ptr! lib!types.PagePtr.) (block_size! Int) (addr! Int)) (! (= (ens%lib!layout.calculate_page_start. page_ptr! block_size! addr!) (and (uInv SZ addr!) (= addr! (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!)))) (I block_size!) (I 0))))) :pattern ((ens%lib!layout.calculate_page_start. page_ptr! block_size! addr!)))))
(set-info :comment ";; Function-Def lib::layout::calculate_page_start")
(set-info :comment ";; layout.rs:337:1: 337:82 (#0)")
(set-info :comment ";; Function-Specs lib::layout::calculate_page_block_at")
(declare-fun req%lib!layout.calculate_page_block_at. (Int Int Int lib!tokens.PageId.) Bool)
(declare-const %%global_location_label%%17 Bool)
(declare-const %%global_location_label%%18 Bool)
(declare-const %%global_location_label%%19 Bool)
(assert (forall ((page_start! Int) (block_size! Int) (idx! Int) (page_id! lib!tokens.PageId.)) (! (= (req%lib!layout.calculate_page_block_at. page_start! block_size! idx! page_id!) (and (=> %%global_location_label%%17 (= page_start! (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. page_id!) (I block_size!) (I 0)))) (=> %%global_location_label%%18 (<= (Add (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. page_id!) (I block_size!) (I 0)) (Mul idx! block_size!)) (Add (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. page_id!))))) lib!config.SEGMENT_SIZE.?))) (=> %%global_location_label%%19 (< (Add (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. page_id!))))) lib!config.SEGMENT_SIZE.?) (- (uHi SZ) 1))))) :pattern ((req%lib!layout.calculate_page_block_at. page_start! block_size! idx! page_id!)))))
(declare-fun ens%lib!layout.calculate_page_block_at. (Int Int Int lib!tokens.PageId. Int) Bool)
(assert (forall ((page_start! Int) (block_size! Int) (idx! Int) (page_id! lib!tokens.PageId.) (p! Int)) (! (= (ens%lib!layout.calculate_page_block_at. page_start! block_size! idx! page_id! p!) (and (uInv SZ p!) (= p! (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. page_id!) (I block_size!) (I idx!))) (= p! (Add page_start! (Mul idx! block_size!))))) :pattern ((ens%lib!layout.calculate_page_block_at. page_start! block_size! idx! page_id! p!)))))
(set-info :comment ";; Function-Def lib::layout::calculate_page_block_at")
(set-info :comment ";; layout.rs:345:1: 350:15 (#0)")
(set-info :comment ";; Function-Specs lib::layout::mk_segment_id")
(declare-fun req%lib!layout.mk_segment_id. (ptr_mut%<lib!types.SegmentHeader.>.) Bool)
(declare-const %%global_location_label%%20 Bool)
(declare-const %%global_location_label%%21 Bool)
(declare-const %%global_location_label%%22 Bool)
(declare-const %%global_location_label%%23 Bool)
(assert (forall ((p! ptr_mut%<lib!types.SegmentHeader.>.)) (! (= (req%lib!layout.mk_segment_id. p!) (and (=> %%global_location_label%%20 (>= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!)) 0)) (=> %%global_location_label%%21 (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!)) lib!config.SEGMENT_SIZE.?) 0)) (=> %%global_location_label%%22 (< (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!)) lib!config.SEGMENT_SIZE.?) (- (uHi SZ) 1))) (=> %%global_location_label%%23 (= (vstd!raw_ptr.PtrData./PtrData/metadata (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!types.SegmentHeader.) (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!)))) vstd!raw_ptr.Metadata./Thin)))) :pattern ((req%lib!layout.mk_segment_id. p!)))))
(declare-fun ens%lib!layout.mk_segment_id. (ptr_mut%<lib!types.SegmentHeader.>. lib!tokens.SegmentId.) Bool)
(assert (forall ((p! ptr_mut%<lib!types.SegmentHeader.>.) (id! lib!tokens.SegmentId.)) (! (= (ens%lib!layout.mk_segment_id. p! id!) (and (has_type (Poly%lib!tokens.SegmentId. id!) TYPE%lib!tokens.SegmentId.) (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. p!) (Poly%lib!tokens.SegmentId. id!)))) :pattern ((ens%lib!layout.mk_segment_id. p! id!)))))
(set-info :comment ";; Function-Def lib::layout::mk_segment_id")
(set-info :comment ";; layout.rs:369:1: 369:68 (#0)")
(set-info :comment ";; Function-Specs lib::layout::segment_id_divis")
(declare-fun req%lib!layout.segment_id_divis. (lib!types.SegmentPtr.) Bool)
(declare-const %%global_location_label%%24 Bool)
(assert (forall ((sp! lib!types.SegmentPtr.)) (! (= (req%lib!layout.segment_id_divis. sp!) (=> %%global_location_label%%24 (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. sp!)))) (Poly%lib!tokens.SegmentId. (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. sp!))))))) :pattern ((req%lib!layout.segment_id_divis. sp!)))))
(declare-fun ens%lib!layout.segment_id_divis. (lib!types.SegmentPtr.) Bool)
(assert (forall ((sp! lib!types.SegmentPtr.)) (! (= (ens%lib!layout.segment_id_divis. sp!) (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. sp!))))) lib!config.SEGMENT_SIZE.?) 0)) :pattern ((ens%lib!layout.segment_id_divis. sp!)))))
(set-info :comment ";; Function-Def lib::layout::segment_id_divis")
(set-info :comment ";; layout.rs:380:1: 380:46 (#0)")
(set-info :comment ";; Function-Specs lib::layout::two_mul_with_bit0")
(declare-fun req%lib!layout.two_mul_with_bit0. (Int Int) Bool)
(declare-const %%global_location_label%%25 Bool)
(assert (forall ((x1! Int) (y1! Int)) (! (= (req%lib!layout.two_mul_with_bit0. x1! y1!) (=> %%global_location_label%%25 (not (= y1! 0)))) :pattern ((req%lib!layout.two_mul_with_bit0. x1! y1!)))))
(declare-fun ens%lib!layout.two_mul_with_bit0. (Int Int) Bool)
(assert (forall ((x1! Int) (y1! Int)) (! (= (ens%lib!layout.two_mul_with_bit0. x1! y1!) (= (EucDiv (Mul 2 x1!) (Mul 2 y1!)) (EucDiv x1! y1!))) :pattern ((ens%lib!layout.two_mul_with_bit0. x1! y1!)))))
(set-info :comment ";; Function-Specs lib::layout::two_mul_with_bit1")
(declare-fun req%lib!layout.two_mul_with_bit1. (Int Int) Bool)
(declare-const %%global_location_label%%26 Bool)
(assert (forall ((x1! Int) (y1! Int)) (! (= (req%lib!layout.two_mul_with_bit1. x1! y1!) (=> %%global_location_label%%26 (not (= y1! 0)))) :pattern ((req%lib!layout.two_mul_with_bit1. x1! y1!)))))
(declare-fun ens%lib!layout.two_mul_with_bit1. (Int Int) Bool)
(assert (forall ((x1! Int) (y1! Int)) (! (= (ens%lib!layout.two_mul_with_bit1. x1! y1!) (= (EucDiv (Add (Mul 2 x1!) 1) (Mul 2 y1!)) (EucDiv x1! y1!))) :pattern ((ens%lib!layout.two_mul_with_bit1. x1! y1!)))))
(set-info :comment ";; Function-Specs lib::layout::bitand_with_mask_gives_rounding")
(declare-fun req%lib!layout.bitand_with_mask_gives_rounding. (Int Int) Bool)
(declare-const %%global_location_label%%27 Bool)
(declare-const %%global_location_label%%28 Bool)
(assert (forall ((x! Int) (y! Int)) (! (= (req%lib!layout.bitand_with_mask_gives_rounding. x! y!) (and (=> %%global_location_label%%27 (not (= y! 0))) (=> %%global_location_label%%28 (= (uClip SZ (bitand (I y!) (I (uClip SZ (Sub y! 1))))) 0)))) :pattern ((req%lib!layout.bitand_with_mask_gives_rounding. x! y!)))))
(declare-fun ens%lib!layout.bitand_with_mask_gives_rounding. (Int Int) Bool)
(assert (forall ((x! Int) (y! Int)) (! (= (ens%lib!layout.bitand_with_mask_gives_rounding. x! y!) (= (uClip SZ (bitand (I x!) (I (uClip SZ (bitnot (I (uClip SZ (Sub y! 1)))))))) (Mul (uClip SZ (EucDiv x! y!)) y!))) :pattern ((ens%lib!layout.bitand_with_mask_gives_rounding. x! y!)))))
(set-info :comment ";; Function-Def lib::layout::bitand_with_mask_gives_rounding")
(set-info :comment ";; layout.rs:416:7: 416:61 (#0)")
(set-info :comment ";; Function-Specs lib::layout::mul_mod_right")
(declare-fun ens%lib!layout.mul_mod_right. (Int Int) Bool)
(assert (forall ((a! Int) (b! Int)) (! (= (ens%lib!layout.mul_mod_right. a! b!) (= (EucMod (Mul a! b!) b!) 0)) :pattern ((ens%lib!layout.mul_mod_right. a! b!)))))
(set-info :comment ";; Function-Def lib::layout::mul_mod_right")
(set-info :comment ";; layout.rs:581:1: 581:43 (#0)")
(set-info :comment ";; Function-Specs lib::layout::align_down")
(declare-fun req%lib!layout.align_down. (Int Int) Bool)
(declare-const %%global_location_label%%29 Bool)
(assert (forall ((x! Int) (y! Int)) (! (= (req%lib!layout.align_down. x! y!) (=> %%global_location_label%%29 (not (= y! 0)))) :pattern ((req%lib!layout.align_down. x! y!)))))
...
(assert (forall ((x! Int) (y! Int)) (! (= (req%lib!layout.align_up. x! y!) (and (=> %%global_location_label%%30 (not (= y! 0))) (=> %%global_location_label%%31 (<= (Sub (Add x! y!) 1) (- (uHi SZ) 1))))) :pattern ((req%lib!layout.align_up. x! y!)))))
...
(set-info :comment ";; Function-Def lib::layout::align_up")
(set-info :comment ";; layout.rs:532:1: 532:51 (#0)")
...
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (req%lib!layout.mod_trans. a! b! c!) (and (=> %%global_location_label%%32 (= (EucMod a! b!) 0)) (=> %%global_location_label%%33 (= (EucMod b! c!) 0)))) :pattern ((req%lib!layout.mod_trans. a! b! c!)))))
(declare-fun ens%lib!layout.mod_trans. (Int Int Int) Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (ens%lib!layout.mod_trans. a! b! c!) (= (EucMod a! c!) 0)) :pattern ((ens%lib!layout.mod_trans. a! b! c!)))))
(set-info :comment ";; Function-Def lib::layout::mod_trans")
(set-info :comment ";; layout.rs:565:1: 565:47 (#0)")
(set-info :comment ";; Function-Specs lib::layout::is_block_ptr_mult4")
(declare-fun req%lib!layout.is_block_ptr_mult4. (ptr_mut%<u8.>. lib!tokens.BlockId.) Bool)
(declare-const %%global_location_label%%34 Bool)
(assert (forall ((ptr! ptr_mut%<u8.>.) (block_id! lib!tokens.BlockId.)) (! (= (req%lib!layout.is_block_ptr_mult4. ptr! block_id!) (=> %%global_location_label%%34 (lib!layout.is_block_ptr.? (Poly%ptr_mut%<u8.>. ptr!) (Poly%lib!tokens.BlockId. block_id!)))) :pattern ((req%lib!layout.is_block_ptr_mult4. ptr! block_id!)))))
(declare-fun ens%lib!layout.is_block_ptr_mult4. (ptr_mut%<u8.>. lib!tokens.BlockId.) Bool)
(assert (forall ((ptr! ptr_mut%<u8.>.) (block_id! lib!tokens.BlockId.)) (! (= (ens%lib!layout.is_block_ptr_mult4. ptr! block_id!) (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. ptr!)) 4) 0)) :pattern ((ens%lib!layout.is_block_ptr_mult4. ptr! block_id!)))))
(set-info :comment ";; Function-Def lib::layout::is_block_ptr_mult4")
(set-info :comment ";; layout.rs:618:1: 618:65 (#0)")
(set-info :comment ";; Function-Specs lib::layout::segment_start_mult_commit_size")
(declare-fun ens%lib!layout.segment_start_mult_commit_size. (lib!tokens.SegmentId.) Bool)
(assert (forall ((segment_id! lib!tokens.SegmentId.)) (! (= (ens%lib!layout.segment_start_mult_commit_size. segment_id!) (= (EucMod (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. segment_id!)) lib!config.COMMIT_SIZE.?) 0)) :pattern ((ens%lib!layout.segment_start_mult_commit_size. segment_id!)))))
(set-info :comment ";; Function-Def lib::layout::segment_start_mult_commit_size")
(set-info :comment ";; layout.rs:627:1: 627:67 (#0)")
(set-info :comment ";; Function-Specs lib::layout::segment_start_mult8")
(declare-fun ens%lib!layout.segment_start_mult8. (lib!tokens.SegmentId.) Bool)
(assert (forall ((segment_id! lib!tokens.SegmentId.)) (! (= (ens%lib!layout.segment_start_mult8. segment_id!) (= (EucMod (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. segment_id!)) 8) 0)) :pattern ((ens%lib!layout.segment_start_mult8. segment_id!)))))
(set-info :comment ";; Function-Def lib::layout::segment_start_mult8")
(set-info :comment ";; layout.rs:634:1: 634:56 (#0)")
(set-info :comment ";; Function-Specs lib::layout::calculate_start_offset")
(declare-fun ens%lib!layout.calculate_start_offset. (Int Int) Bool)
(assert (forall ((block_size! Int) (res! Int)) (! (= (ens%lib!layout.calculate_start_offset. block_size! res!) (and (uInv 32 res!) (= res! (lib!layout.start_offset.? (I block_size!))))) :pattern ((ens%lib!layout.calculate_start_offset. block_size! res!)))))
(set-info :comment ";; Function-Def lib::layout::calculate_start_offset")
(set-info :comment ";; layout.rs:646:1: 646:62 (#0)")
(set-info :comment ";; Function-Specs lib::layout::start_offset_le_slice_size")
(declare-fun ens%lib!layout.start_offset_le_slice_size. (Int) Bool)
(assert (forall ((block_size! Int)) (! (= (ens%lib!layout.start_offset_le_slice_size. block_size!) (and (let ((tmp%%$ (lib!layout.start_offset.? (I block_size!)))) (and (<= 0 tmp%%$) (<= tmp%%$ lib!config.SLICE_SIZE.?))) (or (= (lib!layout.start_offset.? (I block_size!)) 0) (= (lib!layout.start_offset.? (I block_size!)) (Mul 3 lib!config.MAX_ALIGN_GUARANTEE.?))))) :pattern ((ens%lib!layout.start_offset_le_slice_size. block_size!)))))
(set-info :comment ";; Function-Def lib::layout::start_offset_le_slice_size")
(set-info :comment ";; layout.rs:656:1: 656:57 (#0)")
(set-info :comment ";; Function-Specs lib::layout::segment_start_eq")
(declare-fun req%lib!layout.segment_start_eq. (lib!tokens.SegmentId. lib!tokens.SegmentId.) Bool)
(declare-const %%global_location_label%%35 Bool)
(assert (forall ((sid! lib!tokens.SegmentId.) (sid2! lib!tokens.SegmentId.)) (! (= (req%lib!layout.segment_start_eq. sid! sid2!) (=> %%global_location_label%%35 (= (lib!tokens.SegmentId./SegmentId/id (%Poly%lib!tokens.SegmentId. (Poly%lib!tokens.SegmentId. sid!))) (lib!tokens.SegmentId./SegmentId/id (%Poly%lib!tokens.SegmentId. (Poly%lib!tokens.SegmentId. sid2!)))))) :pattern ((req%lib!layout.segment_start_eq. sid! sid2!)))))
(declare-fun ens%lib!layout.segment_start_eq. (lib!tokens.SegmentId. lib!tokens.SegmentId.) Bool)
(assert (forall ((sid! lib!tokens.SegmentId.) (sid2! lib!tokens.SegmentId.)) (! (= (ens%lib!layout.segment_start_eq. sid! sid2!) (= (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. sid!)) (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. sid2!)))) :pattern ((ens%lib!layout.segment_start_eq. sid! sid2!)))))
(set-info :comment ";; Function-Def lib::layout::segment_start_eq")
(set-info :comment ";; layout.rs:662:1: 662:63 (#0)")
...
(assert (forall ((ptr! ptr_mut%<u8.>.) (block_id! lib!tokens.BlockId.)) (! (= (req%lib!layout.get_block_start_from_is_block_ptr. ptr! block_id!) (=> %%global_location_label%%36 (lib!layout.is_block_ptr.? (Poly%ptr_mut%<u8.>. ptr!) (Poly%lib!tokens.BlockId. block_id!)))) :pattern ((req%lib!layout.get_block_start_from_is_block_ptr. ptr! block_id!)))))
...
(set-info :comment ";; Function-Def lib::layout::get_block_start_from_is_block_ptr")
(set-info :comment ";; layout.rs:668:1: 668:80 (#0)")
(declare-const ptr! ptr_mut%<u8.>.)
(declare-const block_id! lib!tokens.BlockId.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!tokens.BlockId. block_id!) TYPE%lib!tokens.BlockId.))
(assert (lib!layout.is_block_ptr.? (Poly%ptr_mut%<u8.>. ptr!) (Poly%lib!tokens.BlockId. block_id!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (fuel_bool fuel%lib!layout.is_block_ptr1.) (=> %%location_label%%0 (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. ptr!)) (lib!layout.block_start.? (Poly%lib!tokens.BlockId. block_id!)))))))
(check-sat)
(exit)
