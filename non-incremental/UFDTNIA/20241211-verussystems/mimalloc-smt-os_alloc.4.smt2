...
(assert (not (=> (= kib@ 1024) (and (=> %%location_label%%0 (uInv SZ (Mul 1024 1024))) (=> (= mib@ (uClip SZ (Mul 1024 1024))) (and (=> %%location_label%%1 (uInv SZ (Mul 512 kib@))) (or (and (=> (< size! (uClip SZ (Mul 512 kib@))) (=> (ens%lib!os_mem.get_page_size. 0 tmp%1) (=> (= tmp%5 tmp%1) %%switch_label%%2))) (=> (not (< size! (uClip SZ (Mul 512 kib@)))) (and (=> %%location_label%%2 (uInv SZ (Mul 2 mib@))) (or (and (=> (< size! (uClip SZ (Mul 2 mib@))) (and (=> %%location_label%%3 (uInv SZ (Mul 64 kib@))) (=> (= tmp%4 (uClip SZ (Mul 64 kib@))) %%switch_label%%3))) (=> (not (< size! (uClip SZ (Mul 2 mib@)))) (and (=> %%location_label%%4 (uInv SZ (Mul 8 mib@))) (or (and (=> (< size! (uClip SZ (Mul 8 mib@))) (and (=> %%location_label%%5 (uInv SZ (Mul 256 kib@))) (=> (= tmp%3 (uClip SZ (Mul 256 kib@))) %%switch_label%%4))) (=> (not (< size! (uClip SZ (Mul 8 mib@)))) (and (=> %%location_label%%6 (uInv SZ (Mul 32 mib@))) (or (and (=> (< size! (uClip SZ (Mul 32 mib@))) (=> (= tmp%2 mib@) %%switch_label%%5)) (=> (not (< size! (uClip SZ (Mul 32 mib@)))) (and (=> %%location_label%%7 (uInv SZ (Mul 4 mib@))) (=> (= tmp%2 (uClip SZ (Mul 4 mib@))) %%switch_label%%5)))) (and (not %%switch_label%%5) (=> (= tmp%3 tmp%2) %%switch_label%%4)))))) (and (not %%switch_label%%4) (=> (= tmp%4 tmp%3) %%switch_label%%3)))))) (and (not %%switch_label%%3) (=> (= tmp%5 tmp%4) %%switch_label%%2)))))) (and (not %%switch_label%%2) (=> (= align_size@ tmp%5) (and (=> %%location_label%%8 (uInv SZ (Sub (- (uHi SZ) 1) align_size@))) (=> (= tmp%7 (>= size! (uClip SZ (Sub (- (uHi SZ) 1) align_size@)))) (=> (ens%core!intrinsics.unlikely. tmp%7 tmp%6) (or (and (=> tmp%6 %%switch_label%%0) (=> (not tmp%6) (and (=> %%location_label%%9 (req%lib!layout.align_up. size! align_size@)) (=> (ens%lib!layout.align_up. size! align_size@ x@) (=> (ens%lib!config.const_facts. 0) (=> (= tmp%8 (lib!os_mem.page_size.? (I 0))) (and (=> %%location_label%%10 (req%lib!layout.mod_trans. x@ align_size@ tmp%8)) (=> (ens%lib!layout.mod_trans. x@ align_size@ tmp%8) (or (and (=> (<= size! lib!config.SEGMENT_SIZE.?) (=> (= tmp%9 (<= (EucDiv (Sub (Add size! (lib!os_mem.page_size.? (I 0))) 1) (lib!os_mem.page_size.? (I 0))) 8192)) (and (=> %%location_label%%11 tmp%9) (=> tmp%9 (=> (= tmp%10 (<= (Mul (EucDiv (Sub (Add size! (lib!os_mem.page_size.? (I 0))) 1) (lib!os_mem.page_size.? (I 0))) (lib!os_mem.page_size.? (I 0))) lib!config.SEGMENT_SIZE.?)) (and (=> %%location_label%%12 tmp%10) (=> tmp%10 (and (=> %%location_label%%13 true) (=> (= (EucDiv (Sub (Add lib!config.SEGMENT_SIZE.? 4194304) 1) 4194304) 8) %%switch_label%%1))))))))) (=> (not (<= size! lib!config.SEGMENT_SIZE.?)) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (= res! x@) (and (=> %%location_label%%14 (= (EucMod res! (lib!os_mem.page_size.? (I 0))) 0)) (and (=> %%location_label%%15 (>= res! size!)) (=> %%location_label%%16 (=> (= size! lib!config.SEGMENT_SIZE.?) (= res! lib!config.SEGMENT_SIZE.?)))))))))))))))) (and (not %%switch_label%%0) (=> (= res! size!) (and (=> %%location_label%%17 (= (EucMod res! (lib!os_mem.page_size.? (I 0))) 0)) (and (=> %%location_label%%18 (>= res! size!)) (=> %%location_label%%19 (=> (= size! lib!config.SEGMENT_SIZE.?) (= res! lib!config.SEGMENT_SIZE.?))))))))))))))))))))
(check-sat)
(exit)
