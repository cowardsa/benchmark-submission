...
(assert (not (and (=> %%location_label%%0 (req%lib!impl_u.os_refinement.lemma_effective_mappings_equal_interp_pt_mem. s!)) (=> (ens%lib!impl_u.os_refinement.lemma_effective_mappings_equal_interp_pt_mem. s!) (=> (= tmp%1 (ext_eq false (TYPE%vstd!map.Map. $ NAT $ NAT) (Poly%vstd!map.Map<nat./nat.>. (lib!spec_t.hlspec.AbstractVariables./AbstractVariables/mem (%Poly%lib!spec_t.hlspec.AbstractVariables. (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s!)))))) (vstd!map.impl&%0.empty.? $ NAT $ NAT))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (lib!spec_t.hlspec.init.? (Poly%lib!spec_t.hlspec.AbstractVariables. (lib!spec_t.os.impl&%0.interp.? (Poly%lib!spec_t.os.OSVariables. s!))))))))))))
(check-sat)
(exit)
