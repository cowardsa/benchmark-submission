...
(assert (not (or (and (=> (and (lib!definitions_t.impl&%8.inv.? (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!)))) (< (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!))))))))) (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.entry_size. self!)) (=> (= tmp%1 (lib!impl_u.l1.impl&%1.entry_size.? self!)) (and (=> %%location_label%%1 (req%lib!impl_u.l1.impl&%1.num_entries. self!)) (=> (= tmp%2 (lib!impl_u.l1.impl&%1.num_entries.? self!)) (=> (= tmp%3 (lib!definitions_t.aligned.? (I (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. self!))) (I (nClip (Mul tmp%1 tmp%2))))) %%switch_label%%1)))))) (=> (not (and (lib!definitions_t.impl&%8.inv.? (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!)))) (< (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!)))))))))) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%3 (and (=> %%location_label%%2 (req%lib!impl_u.l1.impl&%1.num_entries. self!)) (=> (= tmp%4 (lib!impl_u.l1.impl&%1.num_entries.? self!)) (=> (= tmp%5 (= (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))) tmp%4)) %%switch_label%%0)))) (=> (not tmp%3) (=> (= tmp%5 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)
