...
(assert (not (and (=> %%location_label%%0 (req%main!math.lemma_mul_inequality_converse. x! y! z!)) (=> (ens%main!math.lemma_mul_inequality_converse. x! y! z!) (and (=> %%location_label%%1 (req%main!math.lemma_mul_inequality_converse. y! x! z!)) (=> (ens%main!math.lemma_mul_inequality_converse. y! x! z!) (=> %%location_label%%2 (= x! y!))))))))
(check-sat)
(exit)
