...
(assert (not (and (=> %%location_label%%0 (uInv 64 (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_log_size_offset.?))) (=> %%location_label%%1 (uInv 64 (Add (uClip 64 (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_log_size_offset.?)) 8))))))
(check-sat)
(exit)
