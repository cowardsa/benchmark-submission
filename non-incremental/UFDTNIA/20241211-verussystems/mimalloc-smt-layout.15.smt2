...
(assert (uInv SZ y!))
(assert (not (= y! 0)))
(assert (= (uClip SZ (bitand (I y!) (I (uClip SZ (Sub y! 1))))) 0))
...
(assert (not (=> (= decrease%init0 y!) (or (and (=> (= y! 1) (and (=> %%location_label%%0 true) (=> (= (uClip SZ (bitand (I x!) (I (uClip SZ (bitnot (I (uClip SZ (Sub 1 1)))))))) x!) (=> (= tmp%1 (= (uClip SZ (bitand (I x!) (I (uClip SZ (bitnot (I (uClip SZ (Sub y! 1)))))))) (Mul (uClip SZ (EucDiv x! y!)) y!))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 %%switch_label%%0)))))) (=> (not (= y! 1)) (and (=> %%location_label%%2 (not (= y! 0))) (=> (< (uClip SZ (bitshr (I y!) (I 1))) y!) (and (=> %%location_label%%3 (not (= y! 0))) (and (=> %%location_label%%4 (not (= y! 1))) (=> (not (= (uClip SZ (bitshr (I y!) (I 1))) 0)) (and (=> %%location_label%%5 (not (= y! 0))) (and (=> %%location_label%%6 (not (= y! 1))) (=> (=> (= (uClip SZ (bitand (I y!) (I (uClip SZ (Sub y! 1))))) 0) (= (uClip SZ (bitand (I (uClip SZ (bitshr (I y!) (I 1)))) (I (uClip SZ (Sub (uClip SZ (bitshr (I y!) (I 1))) 1))))) 0)) (=> (= tmp%2 (uClip SZ (bitshr (I x!) (I 1)))) (=> (= tmp%3 (uClip SZ (bitshr (I y!) (I 1)))) (and (=> %%location_label%%7 (check_decrease_int (let ((x!$0 tmp%2) (y!$1 tmp%3)) y!$1) decrease%init0 false)) (and (=> %%location_label%%8 (req%lib!layout.bitand_with_mask_gives_rounding. tmp%2 tmp%3)) (=> (ens%lib!layout.bitand_with_mask_gives_rounding. tmp%2 tmp%3) (and (=> %%location_label%%9 (not (= y! 0))) (and (=> %%location_label%%10 (not (= y! 1))) (and (=> %%location_label%%11 (= (uClip SZ (bitand (I y!) (I (uClip SZ (Sub y! 1))))) 0)) (=> (and (= (uClip SZ (bitand (I x!) (I (uClip SZ (bitnot (I (uClip SZ (Sub y! 1)))))))) (uClip SZ (Mul 2 (uClip SZ (bitand (I (uClip SZ (bitshr (I x!) (I 1)))) (I (uClip SZ (bitnot (I (uClip SZ (Sub (uClip SZ (bitshr (I y!) (I 1))) 1))))))))))) (< (uClip SZ (bitand (I (uClip SZ (bitshr (I x!) (I 1)))) (I (uClip SZ (bitnot (I (uClip SZ (Sub (uClip SZ (bitshr (I y!) (I 1))) 1)))))))) 9223372036854775808)) (=> (= y1@ (uClip SZ (bitshr (I y!) (I 1)))) (=> (= x1@ (uClip SZ (bitshr (I x!) (I 1)))) (=> (= b@ (uClip SZ (EucMod x! 2))) (and (=> %%location_label%%12 true) (=> (= (uClip SZ (bitshr (I y!) (I 1))) (uClip SZ (EucDiv y! 2))) (and (=> %%location_label%%13 true) (=> (= (uClip SZ (bitshr (I x!) (I 1))) (uClip SZ (EucDiv x! 2))) (and (and (=> %%location_label%%14 (not (= y! 0))) (and (=> %%location_label%%15 (not (= y! 1))) (=> (=> (= (uClip SZ (bitand (I y!) (I (uClip SZ (Sub y! 1))))) 0) (= (uClip SZ (EucMod y! 2)) 0)) (=> %%location_label%%16 (= y! (Mul 2 y1@)))))) (=> (= y! (Mul 2 y1@)) (=> (= tmp%4 (= x! (Add (Mul 2 x1@) b@))) (and (=> %%location_label%%17 tmp%4) (=> tmp%4 (and (=> (= t@ (EucDiv (Add (Mul 2 x1@) b@) (Mul 2 y1@))) (and (=> %%location_label%%18 true) (=> (= (Mul t@ (Mul 2 y1@)) (Mul 2 (Mul t@ y1@))) (and (=> %%location_label%%19 (req%lib!layout.two_mul_with_bit0. x1@ y1@)) (=> (ens%lib!layout.two_mul_with_bit0. x1@ y1@) (and (=> %%location_label%%20 (req%lib!layout.two_mul_with_bit1. x1@ y1@)) (=> (ens%lib!layout.two_mul_with_bit1. x1@ y1@) (=> (= tmp%5 (= (EucDiv (Add (Mul 2 x1@) b@) (Mul 2 y1@)) (uClip SZ (EucDiv x1@ y1@)))) (and (=> %%location_label%%21 tmp%5) (=> tmp%5 (=> %%location_label%%22 (= (Mul (EucDiv (Add (Mul 2 x1@) b@) (Mul 2 y1@)) (Mul 2 y1@)) (Mul 2 (Mul (uClip SZ (EucDiv x1@ y1@)) y1@)))))))))))))) (=> (= (Mul (EucDiv (Add (Mul 2 x1@) b@) (Mul 2 y1@)) (Mul 2 y1@)) (Mul 2 (Mul (uClip SZ (EucDiv x1@ y1@)) y1@))) (=> (= tmp%6 (= (Mul (uClip SZ (EucDiv x! y!)) y!) (Mul 2 (Mul (uClip SZ (EucDiv (uClip SZ (bitshr (I x!) (I 1))) (uClip SZ (bitshr (I y!) (I 1))))) (uClip SZ (bitshr (I y!) (I 1))))))) (and (=> %%location_label%%23 tmp%6) (=> tmp%6 %%switch_label%%0)))))))))))))))))))))))))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%24 (= (uClip SZ (bitand (I x!) (I (uClip SZ (bitnot (I (uClip SZ (Sub y! 1)))))))) (Mul (uClip SZ (EucDiv x! y!)) y!))))))))
(check-sat)
(exit)
