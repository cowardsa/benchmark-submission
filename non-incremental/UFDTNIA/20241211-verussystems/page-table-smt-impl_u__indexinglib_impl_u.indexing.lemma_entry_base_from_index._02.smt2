...
(set-info :comment ";; page-table/impl_u/indexing.rs:102:13: 102:19 (#0)")
...
(assert (<= 0 idx!))
(assert (<= 0 entry_size!))
(assert (has_type idx2$1@ NAT))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (< idx! (%I idx2$1@)) (=> %%location_label%%0 (<= (lib!definitions_t.next_entry_base_from_index.? (I base!) (I idx!) (I entry_size!)) (lib!definitions_t.entry_base_from_index.? (I base!) idx2$1@ (I entry_size!)))))))
(check-sat)
(exit)
