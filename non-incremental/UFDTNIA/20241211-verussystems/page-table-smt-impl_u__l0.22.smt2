...
(declare-const nself@ lib!impl_u.l0.PageTableContents.)
...
(assert (lib!impl_u.l0.impl&%0.accepted_mapping.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!)))
...
(assert (not (or (and (=> (is-core!result.Result./Ok_ (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!))) (=> (= nself@ (%Poly%lib!impl_u.l0.PageTableContents. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!))))))) (=> (= tmp%1 (lib!impl_u.l0.impl&%0.mappings_in_bounds.? (Poly%lib!impl_u.l0.PageTableContents. nself@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0))))) (=> (not (is-core!result.Result./Ok_ (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%1 (=> (is-core!result.Result./Ok_ (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!))) (lib!impl_u.l0.impl&%0.inv.? (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!)))))))) (=> %%location_label%%2 (=> (is-core!result.Result./Err_ (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!))) (= (%Poly%lib!impl_u.l0.PageTableContents. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!)))))) self!))))))))
(check-sat)
(exit)
