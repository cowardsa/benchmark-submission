...
(declare-const res! lib!spec_t.hardware.PageDirectoryEntry.)
...
(declare-const tmp%%@ lib!spec_t.hardware.PageDirectoryEntry.)
(declare-const tmp%3 Int)
(declare-const tmp%4 lib!definitions_t.MemRegion.)
...
(assert (not (and (=> (= tmp%1 (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (= (uClip SZ (EucMod ptr! lib!definitions_t.PAGE_SIZE.?)) 0)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> %%location_label%%2 (lib!definitions_t.aligned.? (I (nClip (Add ptr! (Mul i! lib!definitions_t.WORD_SIZE.?)))) (I 8))))))))) (=> (lib!definitions_t.aligned.? (I (nClip (Add ptr! (Mul i! lib!definitions_t.WORD_SIZE.?)))) (I 8)) (=> (= tmp%%@ (lib!impl_u.l2_impl.PT.entry_at_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I i!))) (=> (= tmp%4 (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) (and (=> %%location_label%%3 (req%lib!spec_t.mem.impl&%1.read. mem! ptr! i! tmp%4)) (=> (ens%lib!spec_t.mem.impl&%1.read. mem! ptr! i! tmp%4 tmp%3) (=> (= res! (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry (%I (I tmp%3)) (%I (I layer!)))) (and (=> %%location_label%%4 (= (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/layer (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. res!))) layer!)) (and (=> %%location_label%%5 (= (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. res!)) (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I i!)))) (and (=> %%location_label%%6 (= res! (lib!impl_u.l2_impl.PT.entry_at_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I i!)))) (and (=> %%location_label%%7 (lib!impl_u.l2_impl.impl&%0.hp_pat_is_zero.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. res!))) (=> %%location_label%%8 (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. res!))) (< 0 (lib!spec_t.hardware.impl&%3.layer.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. res!))))))))))))))))))
(check-sat)
(exit)
