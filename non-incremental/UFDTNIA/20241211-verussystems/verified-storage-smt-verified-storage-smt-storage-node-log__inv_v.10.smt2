...
(declare-const mem1_without_log_metadata@ vstd!seq.Seq<u8.>.)
(declare-const mem2_without_log_metadata@ vstd!seq.Seq<u8.>.)
...
(assert (lib!log.inv_v.active_metadata_bytes_are_equal.? (Poly%vstd!seq.Seq<u8.>. mem1!) (Poly%vstd!seq.Seq<u8.>. mem2!)))
(assert (let ((cdb1$ (lib!log.layout_v.deserialize_and_check_log_cdb.? (Poly%vstd!seq.Seq<u8.>. mem1!)))) (let ((cdb2$ (lib!log.layout_v.deserialize_and_check_log_cdb.? (Poly%vstd!seq.Seq<u8.>. mem2!)))) (let ((log_metadata_pos$ (lib!log.layout_v.get_log_metadata_pos.? (B cdb!)))) (and (and (and (is-core!option.Option./Some_ cdb1$) (is-core!option.Option./Some_ cdb2$)) (=> cdb! (and (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. cdb1$)))) (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. cdb2$))))))) (=> (not cdb!) (and (not (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. cdb1$))))) (not (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. cdb2$))))))))))))
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. mem1! mem2!) (=> (ens%lib!log.inv_v.lemma_auto_smaller_range_of_seq_is_subrange. mem1!) (=> (= mem1_without_log_metadata@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)))) (=> (= mem2_without_log_metadata@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem2!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)))) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem1!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.GlobalMetadata.))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.GlobalMetadata.))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem1!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_CRC.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2!) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_CRC.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem1!) (I lib!log.layout_v.ABSOLUTE_POS_OF_REGION_METADATA.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.RegionMetadata.))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2!) (I lib!log.layout_v.ABSOLUTE_POS_OF_REGION_METADATA.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.RegionMetadata.))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem1!) (I lib!log.layout_v.ABSOLUTE_POS_OF_REGION_CRC.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2!) (I lib!log.layout_v.ABSOLUTE_POS_OF_REGION_CRC.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem1!) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2!) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= log_metadata_pos@ (lib!log.layout_v.get_log_metadata_pos.? (B cdb!))) (=> (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem1!) (I log_metadata_pos@) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2!) (I log_metadata_pos@) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.))))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem1!) (I (nClip (Add log_metadata_pos@ (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.))))) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2!) (I (nClip (Add log_metadata_pos@ (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.))))) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> %%location_label%%7 (lib!log.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<u8.>. mem2!))))))))))))))))))))))))))))))))
(check-sat)
(exit)
