...
(set-info :comment ";; bin_sizes.rs:500:7: 500:43 (#0)")
...
(set-info :comment ";; Function-Def lib::bin_sizes::mul_assoc")
(set-info :comment ";; bin_sizes.rs:500:7: 500:43 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (not (=> %%location_label%%0 (= (nClip (Mul (nClip (Mul x! y!)) z!)) (nClip (Mul y! (nClip (Mul x! z!))))))))
(check-sat)
(exit)
