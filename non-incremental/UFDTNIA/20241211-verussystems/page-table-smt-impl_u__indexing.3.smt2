...
(set-info :comment ";; page-table/impl_u/indexing.rs:162:1: 162:101 (#0)")
...
(assert (>= addr! base!))
(assert (< addr! (lib!definitions_t.entry_base_from_index.? (I base!) (I num_entries!) (I entry_size!))))
(assert (> entry_size! 0))
...
(assert (not (=> (= idx@ (lib!definitions_t.index_from_base_and_addr.? (I base!) (I addr!) (I entry_size!))) (and (=> %%location_label%%0 (>= addr! base!)) (and (=> %%location_label%%1 (< addr! (lib!definitions_t.entry_base_from_index.? (I base!) (I num_entries!) (I entry_size!)))) (and (=> %%location_label%%2 (> entry_size! 0)) (and (=> %%location_label%%3 (= idx@ (lib!definitions_t.index_from_offset.? (I (nClip (Sub addr! base!))) (I entry_size!)))) (=> (< idx@ num_entries!) (and (=> %%location_label%%4 (>= addr! base!)) (and (=> %%location_label%%5 (< addr! (lib!definitions_t.entry_base_from_index.? (I base!) (I num_entries!) (I entry_size!)))) (and (=> %%location_label%%6 (> entry_size! 0)) (and (=> %%location_label%%7 (= idx@ (lib!definitions_t.index_from_offset.? (I (nClip (Sub addr! base!))) (I entry_size!)))) (=> (lib!definitions_t.between.? (I addr!) (I (lib!definitions_t.entry_base_from_index.? (I base!) (I idx@) (I entry_size!))) (I (lib!definitions_t.next_entry_base_from_index.? (I base!) (I idx@) (I entry_size!)))) (and (=> %%location_label%%8 (>= addr! base!)) (and (=> %%location_label%%9 (> entry_size! 0)) (and (=> %%location_label%%10 (= idx@ (lib!definitions_t.index_from_offset.? (I (nClip (Sub addr! base!))) (I entry_size!)))) (=> (=> (and (lib!definitions_t.aligned.? (I base!) (I entry_size!)) (lib!definitions_t.aligned.? (I addr!) (I entry_size!))) (= addr! (lib!definitions_t.entry_base_from_index.? (I base!) (I idx@) (I entry_size!)))) (=> %%location_label%%11 (let ((idx$ (lib!definitions_t.index_from_base_and_addr.? (I base!) (I addr!) (I entry_size!)))) (and (and (< idx$ num_entries!) (lib!definitions_t.between.? (I addr!) (I (lib!definitions_t.entry_base_from_index.? (I base!) (I idx$) (I entry_size!))) (I (lib!definitions_t.next_entry_base_from_index.? (I base!) (I idx$) (I entry_size!))))) (=> (and (lib!definitions_t.aligned.? (I base!) (I entry_size!)) (lib!definitions_t.aligned.? (I addr!) (I entry_size!))) (= addr! (lib!definitions_t.entry_base_from_index.? (I base!) (I idx$) (I entry_size!))))))))))))))))))))))))
(check-sat)
(exit)
