...
(assert (not (or (and (=> (= size! 0) (=> (ens%core!ptr.null_mut. $ (UINT 8) tmp%1) (=> (= res! (tuple%3./tuple%3 tmp%1 (B allow_large!) (Poly%lib!os_mem.MemChunk. tmp%2))) (=> %%location_label%%0 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((is_large$ (%B (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (lib!os_mem.impl&%0.os_has_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (=> request_commit! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> request_commit! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not request_commit!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> (not (= alignment! 0)) (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) alignment!) 0))))))))))) (=> (not (= size! 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%1 (req%lib!os_alloc.os_good_alloc_size. size!)) (=> (ens%lib!os_alloc.os_good_alloc_size. size! size1@) (=> (ens%lib!os_mem.get_page_size. 0 tmp%3) (and (=> %%location_label%%2 (req%lib!layout.align_up. alignment! tmp%3)) (=> (ens%lib!layout.align_up. alignment! tmp%3 alignment1@) (=> (= tmp%4 (= alignment1@ alignment!)) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (>= size1@ size!)) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (ens%lib!config.const_facts. 0) (and (=> %%location_label%%5 (req%lib!os_alloc.os_mem_alloc_aligned. size1@ alignment1@ request_commit! allow_large!)) (=> (ens%lib!os_alloc.os_mem_alloc_aligned. size1@ alignment1@ request_commit! allow_large! tmp%6) (=> (= res! tmp%6) (=> %%location_label%%6 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((is_large$ (%B (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (lib!os_mem.impl&%0.os_has_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (=> request_commit! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> request_commit! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not request_commit!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> (not (= alignment! 0)) (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) alignment!) 0)))))))))))))))))))))))))))
(check-sat)
(exit)
