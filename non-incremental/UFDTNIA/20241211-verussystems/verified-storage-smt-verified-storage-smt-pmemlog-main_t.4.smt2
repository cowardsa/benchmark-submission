...
(declare-const bytes_to_append! alloc!vec.Vec<u8./allocator_global%.>.)
...
(assert (forall ((%%hole%%0 Poly) (s1$ Poly) (s2$ Poly)) (! (= (%%apply%%1 (%%lambda%%3 %%hole%%0) s1$ s2$) (B (= (%Poly%main!infinitelog_t.AbstractInfiniteLogState. s2$) (main!infinitelog_t.impl&%0.append.? s1$ %%hole%%0)))) :pattern ((%%apply%%1 (%%lambda%%3 %%hole%%0) s1$ s2$)))))
...
(assert (not (=> (= tmp%1 (main!pmemspec_t.impl&%0.view.? $ TYPE%main!main_t.TrustedPermission. PM&. PM& (main!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))))) (=> (= tmp%2 (mk_fun (%%lambda%%3 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!))))) (=> (ens%main!main_t.impl&%1.new. tmp%1 tmp%2 verus_tmp@) (=> (= verus_tmp_perm@ verus_tmp@) (=> (= perm@1 verus_tmp_perm@) (and (=> %%location_label%%0 (req%main!logimpl_v.impl&%0.untrusted_append. $ TYPE%main!main_t.TrustedPermission. PM&. PM& (main!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))) (main!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))) bytes_to_append! (Poly%main!main_t.TrustedPermission. perm@1))) (=> (has_type (Poly%main!main_t.InfiniteLogImpl. self!@1) (TYPE%main!main_t.InfiniteLogImpl. PM&. PM&)) (=> (ens%main!logimpl_v.impl&%0.untrusted_append. $ TYPE%main!main_t.TrustedPermission. PM&. PM& (main!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))) (main!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@1))) (main!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@0))) (main!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!@1))) bytes_to_append! (Poly%main!main_t.TrustedPermission. perm@1) tmp%3) (=> (= result! tmp%3) (and (=> %%location_label%%1 (main!main_t.impl&%4.valid.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1))) (and (=> %%location_label%%2 (= (main!main_t.impl&%4.constants.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1)) (main!main_t.impl&%4.constants.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@0)))) (=> %%location_label%%3 (ite (is-core!result.Result./Ok_ result!) (let ((offset$ (%I (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((tmp%%$ (tuple%2./tuple%2 (Poly%core!option.Option. (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@0))) (Poly%core!option.Option. (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1)))))) (and (and (and (is-tuple%2./tuple%2_ tmp%%$) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))) (is-core!option.Option./Some_ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))) (let ((old_log$ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))))) (let ((new_log$ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))))))) (and (= offset$ (Add (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. old_log$))))) (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. old_log$))))) (= new_log$ (main!infinitelog_t.impl&%0.append.? (Poly%main!infinitelog_t.AbstractInfiniteLogState. old_log$) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)))))))))) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./InsufficientSpaceForAppend_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((available_space$ (main!main_t.InfiniteLogErr./InsufficientSpaceForAppend/available_space (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (and (and (= (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@1)) (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@0))) (< available_space$ (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)))) (let ((log$ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!@0)))))))) (or (= available_space$ (Sub (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/capacity (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. log$))) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. log$))))))) (= available_space$ (Sub (Sub 18446744073709551615 (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. log$)))) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. log$)))))))))))))))))))))))))))
(check-sat)
(exit)
