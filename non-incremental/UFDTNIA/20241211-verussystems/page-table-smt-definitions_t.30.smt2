...
(set-info :comment ";; Function-Axioms lib::definitions_t::LoadResult::arrow_Value_0")
(assert (fuel_bool_default fuel%lib!definitions_t.impl&%0.arrow_Value_0.))
(assert (=> (fuel_bool fuel%lib!definitions_t.impl&%0.arrow_Value_0.) (forall ((self! Poly)) (! (= (lib!definitions_t.impl&%0.arrow_Value_0.? self!) (lib!definitions_t.LoadResult./Value/0 (%Poly%lib!definitions_t.LoadResult. self!))) :pattern ((lib!definitions_t.impl&%0.arrow_Value_0.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!definitions_t.LoadResult.) (<= 0 (lib!definitions_t.impl&%0.arrow_Value_0.? self!))) :pattern ((lib!definitions_t.impl&%0.arrow_Value_0.? self!)))))
(set-info :comment ";; Function-Axioms lib::definitions_t::RWOp::arrow_new_value")
(assert (fuel_bool_default fuel%lib!definitions_t.impl&%1.arrow_new_value.))
(assert (=> (fuel_bool fuel%lib!definitions_t.impl&%1.arrow_new_value.) (forall ((self! Poly)) (! (= (lib!definitions_t.impl&%1.arrow_new_value.? self!) (lib!definitions_t.RWOp./Store/new_value (%Poly%lib!definitions_t.RWOp. self!))) :pattern ((lib!definitions_t.impl&%1.arrow_new_value.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!definitions_t.RWOp.) (<= 0 (lib!definitions_t.impl&%1.arrow_new_value.? self!))) :pattern ((lib!definitions_t.impl&%1.arrow_new_value.? self!)))))
(set-info :comment ";; Function-Axioms lib::definitions_t::RWOp::arrow_is_exec")
(assert (fuel_bool_default fuel%lib!definitions_t.impl&%1.arrow_is_exec.))
(assert (=> (fuel_bool fuel%lib!definitions_t.impl&%1.arrow_is_exec.) (forall ((self! Poly)) (! (= (lib!definitions_t.impl&%1.arrow_is_exec.? self!) (lib!definitions_t.RWOp./Load/is_exec (%Poly%lib!definitions_t.RWOp. self!))) :pattern ((lib!definitions_t.impl&%1.arrow_is_exec.? self!))))))
(set-info :comment ";; Function-Axioms lib::definitions_t::RWOp::arrow_Store_new_value")
(assert (fuel_bool_default fuel%lib!definitions_t.impl&%1.arrow_Store_new_value.))
(assert (=> (fuel_bool fuel%lib!definitions_t.impl&%1.arrow_Store_new_value.) (forall ((self! Poly)) (! (= (lib!definitions_t.impl&%1.arrow_Store_new_value.? self!) (lib!definitions_t.RWOp./Store/new_value (%Poly%lib!definitions_t.RWOp. self!))) :pattern ((lib!definitions_t.impl&%1.arrow_Store_new_value.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!definitions_t.RWOp.) (<= 0 (lib!definitions_t.impl&%1.arrow_Store_new_value.? self!))) :pattern ((lib!definitions_t.impl&%1.arrow_Store_new_value.? self!)))))
(set-info :comment ";; Function-Axioms lib::definitions_t::RWOp::arrow_Store_result")
(assert (fuel_bool_default fuel%lib!definitions_t.impl&%1.arrow_Store_result.))
(assert (=> (fuel_bool fuel%lib!definitions_t.impl&%1.arrow_Store_result.) (forall ((self! Poly)) (! (= (lib!definitions_t.impl&%1.arrow_Store_result.? self!) (lib!definitions_t.RWOp./Store/result (%Poly%lib!definitions_t.RWOp. self!))) :pattern ((lib!definitions_t.impl&%1.arrow_Store_result.? self!))))))
(set-info :comment ";; Function-Axioms lib::definitions_t::RWOp::arrow_Load_is_exec")
(assert (fuel_bool_default fuel%lib!definitions_t.impl&%1.arrow_Load_is_exec.))
(assert (=> (fuel_bool fuel%lib!definitions_t.impl&%1.arrow_Load_is_exec.) (forall ((self! Poly)) (! (= (lib!definitions_t.impl&%1.arrow_Load_is_exec.? self!) (lib!definitions_t.RWOp./Load/is_exec (%Poly%lib!definitions_t.RWOp. self!))) :pattern ((lib!definitions_t.impl&%1.arrow_Load_is_exec.? self!))))))
(set-info :comment ";; Function-Axioms lib::definitions_t::RWOp::arrow_Load_result")
(assert (fuel_bool_default fuel%lib!definitions_t.impl&%1.arrow_Load_result.))
(assert (=> (fuel_bool fuel%lib!definitions_t.impl&%1.arrow_Load_result.) (forall ((self! Poly)) (! (= (lib!definitions_t.impl&%1.arrow_Load_result.? self!) (lib!definitions_t.RWOp./Load/result (%Poly%lib!definitions_t.RWOp. self!))) :pattern ((lib!definitions_t.impl&%1.arrow_Load_result.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!definitions_t.RWOp.) (has_type (Poly%lib!definitions_t.LoadResult. (lib!definitions_t.impl&%1.arrow_Load_result.? self!)) TYPE%lib!definitions_t.LoadResult.)) :pattern ((lib!definitions_t.impl&%1.arrow_Load_result.? self!)))))
...
(set-info :comment ";; Function-Def lib::definitions_t::x86_arch_exec")
(set-info :comment ";; page-table/definitions_t.rs:330:1: 330:15 (#0)")
(set-info :comment ";; Function-Specs lib::definitions_t::MAX_PHYADDR")
(declare-fun ens%lib!definitions_t.MAX_PHYADDR. (Int) Bool)
(assert (forall ((%return! Int)) (! (= (ens%lib!definitions_t.MAX_PHYADDR. %return!) (and (uInv 64 %return!) (= %return! lib!definitions_t.MAX_PHYADDR_SPEC.?))) :pattern ((ens%lib!definitions_t.MAX_PHYADDR. %return!)))))
(set-info :comment ";; Function-Def lib::definitions_t::MAX_PHYADDR")
(set-info :comment ";; page-table/definitions_t.rs:40:1: 40:15 (#0)")
(set-info :comment ";; Function-Def lib::definitions_t::overlap_sanity_check")
(set-info :comment ";; page-table/definitions_t.rs:162:7: 162:32 (#0)")
...
(assert (not (=> (= tmp%1 (lib!definitions_t.overlap.? (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 0)) (%I (I 4096)))) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 0)) (%I (I 4096)))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (lib!definitions_t.overlap.? (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 0)) (%I (I 8192)))) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 0)) (%I (I 4096)))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (lib!definitions_t.overlap.? (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 0)) (%I (I 4096)))) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 0)) (%I (I 8192)))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (lib!definitions_t.overlap.? (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 0)) (%I (I 8192)))) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 4096)) (%I (I 4096)))))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (not (lib!definitions_t.overlap.? (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 4096)) (%I (I 8192)))) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 0)) (%I (I 4096))))))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= tmp%6 (not (lib!definitions_t.overlap.? (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 0)) (%I (I 4096)))) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.MemRegion./MemRegion (%I (I 8192)) (%I (I 16384))))))) (=> %%location_label%%5 tmp%6)))))))))))))))))))
(check-sat)
(exit)
