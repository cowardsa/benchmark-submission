...
(assert (not (=> (= i@0 0) (and (=> %%location_label%%0 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) (uClip SZ (bitnot (I 0)))))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$))))) (=> (uInv SZ i@1) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)) (uClip SZ (bitnot (I 0)))))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) j$)))) (=> (not (< i@1 8)) (=> (ens%lib!commit_mask.lemma_is_bit_set. 0) (=> (ens%lib!config.const_facts. 0) (=> (ens%lib!commit_mask.impl&%0.lemma_view. self!) (and (=> (has_type k@ INT) (=> (and (<= 0 (%I k@)) (< (%I k@) lib!config.COMMIT_MASK_BITS.?)) (=> (= t@ (EucDiv (%I k@) 64)) (=> (= u@ (uClip SZ (EucMod (%I k@) 64))) (=> (= tmp%5 (= (Add (Mul t@ 64) u@) (%I k@))) (and (=> %%location_label%%1 tmp%5) (=> tmp%5 (=> (= tmp%6 (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I t@)) (I u@))) (and (=> %%location_label%%2 tmp%6) (=> tmp%6 (=> (= tmp%7 (and (<= 0 t@) (< t@ 8))) (and (=> %%location_label%%3 tmp%7) (=> tmp%7 (=> (= tmp%8 (and (<= 0 u@) (< u@ 64))) (and (=> %%location_label%%4 tmp%8) (=> tmp%8 (=> (= tmp%9 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (I (Add (Mul t@ 64) u@)))) (and (=> %%location_label%%5 tmp%9) (=> tmp%9 (=> %%location_label%%6 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) k@))))))))))))))))))))) (=> (forall ((k$ Poly)) (! (=> (has_type k$ INT) (=> (and (<= 0 (%I k$)) (< (%I k$) lib!config.COMMIT_MASK_BITS.?)) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) k$))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) k$)))) (=> (= tmp%10 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1. $ INT $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%1 0 lib!config.COMMIT_MASK_BITS.?)))))) (and (=> %%location_label%%7 tmp%10) (=> tmp%10 (=> (= b! true) (=> %%location_label%%8 (= b! (= (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!)) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1. $ INT $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%1 0 lib!config.COMMIT_MASK_BITS.?))))))))))))))))))))))))
(check-sat)
(exit)
