...
(assert (not (or (and (=> (= (uClip SZ (bitand (I va!) (I (uClip SZ (uClip 64 (bitnot (I lib!define.MEM_4k_MASK.?))))))) 0) (and (=> %%location_label%%0 (and (<= 0 39) (< 39 64))) (=> (= tmp%1 (>= (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 va!)) (I 39)))) (I 511))) (uClip 64 lib!define.KERNEL_MEM_END_L4INDEX.?))) %%switch_label%%0))) (=> (not (= (uClip SZ (bitand (I va!) (I (uClip SZ (uClip 64 (bitnot (I lib!define.MEM_4k_MASK.?))))))) 0)) (=> (= tmp%1 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= ret! tmp%1) (=> %%location_label%%1 (= ret! (lib!util.page_ptr_util_u.spec_va_4k_valid.? (I va!)))))))))
(check-sat)
(exit)
