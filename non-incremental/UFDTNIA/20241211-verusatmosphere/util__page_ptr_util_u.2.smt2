...
(assert (not (and (=> %%location_label%%0 true) (=> (<= (uClip SZ (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 va!)) (I 39)))) (I 511)))) 511) (and (=> %%location_label%%1 (and (<= 0 39) (< 39 64))) (=> (= ret! (uClip SZ (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 va!)) (I 39)))) (I 511))))) (and (=> %%location_label%%2 (= ret! (lib!util.page_ptr_util_u.spec_v2l4index.? (I va!)))) (=> %%location_label%%3 (and (<= lib!define.KERNEL_MEM_END_L4INDEX.? ret!) (<= ret! 511))))))))))
(check-sat)
(exit)
