...
(declare-const self! lib!define.EndpointState.)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(define-fun is-lib!define.EndpointState./RECEIVE_ ((c lib!define.EndpointState.)) Bool ((_ is lib!define.EndpointState./RECEIVE) c))
(assert (not (=> (= ret! (is-lib!define.EndpointState./RECEIVE_ self!)) (=> %%location_label%%0 (= ret! (= self! lib!define.EndpointState./RECEIVE))))))
(check-sat)
(exit)
