...
(define-fun is-lib!define.EndpointState./SEND_ ((c lib!define.EndpointState.)) Bool ((_ is lib!define.EndpointState./SEND) c))
(assert (not (=> (= ret! (is-lib!define.EndpointState./SEND_ self!)) (=> %%location_label%%0 (= ret! (= self! lib!define.EndpointState./SEND))))))
(check-sat)
(exit)
