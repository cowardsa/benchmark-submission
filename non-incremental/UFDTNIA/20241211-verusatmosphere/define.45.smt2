...
(set-info :comment ";; Function-Def lib::define::PAGE_ENTRY_EXECUTE_SHIFT")
(set-info :comment ";; define.rs:172:1: 172:45 (#0)")
...
(set-info :comment ";; Function-Def lib::define::PAGE_ENTRY_EXECUTE_MASK")
(set-info :comment ";; define.rs:177:1: 177:74 (#0)")
...
(set-info :comment ";; Function-Def lib::define::PAGE_ENTRY_USER_SHIFT")
(set-info :comment ";; define.rs:170:1: 170:41 (#0)")
...
(set-info :comment ";; Function-Def lib::define::PAGE_ENTRY_USER_MASK")
(set-info :comment ";; define.rs:175:1: 175:68 (#0)")
...
(set-info :comment ";; Function-Def lib::define::NUM_CPUS")
(set-info :comment ";; define.rs:167:1: 167:31 (#0)")
...
(set-info :comment ";; Function-Def lib::define::NUM_PAGES")
(set-info :comment ";; define.rs:147:1: 147:38 (#0)")
...
(set-info :comment ";; Function-Def lib::define::MAX_NUM_ENDPOINT_DESCRIPTORS")
(set-info :comment ";; define.rs:138:1: 138:52 (#0)")
...
(set-info :comment ";; Function-Def lib::define::MAX_NUM_THREADS_PER_PROC")
(set-info :comment ";; define.rs:139:1: 139:48 (#0)")
...
(set-info :comment ";; Function-Def lib::define::MAX_CONTAINER_SCHEDULER_LEN")
(set-info :comment ";; define.rs:182:1: 182:50 (#0)")
...
(set-info :comment ";; Function-Def lib::define::CONTAINER_PROC_LIST_LEN")
(set-info :comment ";; define.rs:179:1: 179:46 (#0)")
...
(set-info :comment ";; Function-Def lib::define::CONTAINER_CHILD_LIST_LEN")
(set-info :comment ";; define.rs:180:1: 180:47 (#0)")
...
(set-info :comment ";; Function-Def lib::define::CONTAINER_ENDPOINT_LIST_LEN")
(set-info :comment ";; define.rs:181:1: 181:50 (#0)")
...
(set-info :comment ";; Function-Def lib::define::MAX_NUM_THREADS_PER_ENDPOINT")
(set-info :comment ";; define.rs:140:1: 140:52 (#0)")
...
(set-info :comment ";; Function-Def lib::define::IOID_MAX")
(set-info :comment ";; define.rs:154:1: 154:33 (#0)")
...
(set-info :comment ";; Function-Def lib::define::MEM_4k_MASK")
(set-info :comment ";; define.rs:157:1: 157:51 (#0)")
...
(set-info :comment ";; Function-Def lib::define::KERNEL_MEM_END_L4INDEX")
(set-info :comment ";; define.rs:146:1: 146:44 (#0)")
...
(set-info :comment ";; Function-Def lib::define::MEM_2m_MASK")
(set-info :comment ";; define.rs:158:1: 158:51 (#0)")
...
(set-info :comment ";; Function-Def lib::define::PCID_MAX")
(set-info :comment ";; define.rs:153:1: 153:33 (#0)")
...
(set-info :comment ";; Function-Def lib::define::MEM_1g_MASK")
(set-info :comment ";; define.rs:159:1: 159:51 (#0)")
...
(set-info :comment ";; Function-Axioms lib::define::SyscallReturnStruct::get_return_vaule_usize")
(assert (fuel_bool_default fuel%lib!define.impl&%31.get_return_vaule_usize.))
(define-fun is-lib!define.RetValueType./SuccessUsize_ ((c lib!define.RetValueType.)) Bool ((_ is lib!define.RetValueType./SuccessUsize) c))
(assert (=> (fuel_bool fuel%lib!define.impl&%31.get_return_vaule_usize.) (forall ((self! Poly)) (! (= (lib!define.impl&%31.get_return_vaule_usize.? self!) (let ((tmp%%$ (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. self!)))) (ite (is-lib!define.RetValueType./SuccessUsize_ tmp%%$) (let ((value$ (lib!define.RetValueType./SuccessUsize/value (%Poly%lib!define.RetValueType. (Poly%lib!define.RetValueType. tmp%%$))))) (core!option.Option./Some (I value$))) core!option.Option./None))) :pattern ((lib!define.impl&%31.get_return_vaule_usize.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.SyscallReturnStruct.) (has_type (Poly%core!option.Option. (lib!define.impl&%31.get_return_vaule_usize.? self!)) (TYPE%core!option.Option. $ (UINT SZ)))) :pattern ((lib!define.impl&%31.get_return_vaule_usize.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::SyscallReturnStruct::get_return_vaule_seq_usize")
(assert (fuel_bool_default fuel%lib!define.impl&%31.get_return_vaule_seq_usize.))
(define-fun is-lib!define.RetValueType./SuccessSeqUsize_ ((c lib!define.RetValueType.)) Bool ((_ is lib!define.RetValueType./SuccessSeqUsize) c))
(assert (=> (fuel_bool fuel%lib!define.impl&%31.get_return_vaule_seq_usize.) (forall ((self! Poly)) (! (= (lib!define.impl&%31.get_return_vaule_seq_usize.? self!) (let ((tmp%%$ (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. self!)))) (ite (is-lib!define.RetValueType./SuccessSeqUsize_ tmp%%$) (let ((value$ (lib!define.RetValueType./SuccessSeqUsize/value (%Poly%lib!define.RetValueType. (Poly%lib!define.RetValueType. tmp%%$))))) (core!option.Option./Some (Poly%vstd!seq.Seq<usize.>. value$))) core!option.Option./None))) :pattern ((lib!define.impl&%31.get_return_vaule_seq_usize.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.SyscallReturnStruct.) (has_type (Poly%core!option.Option. (lib!define.impl&%31.get_return_vaule_seq_usize.? self!)) (TYPE%core!option.Option. $ (TYPE%vstd!seq.Seq. $ (UINT SZ))))) :pattern ((lib!define.impl&%31.get_return_vaule_seq_usize.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::SyscallReturnStruct::get_return_vaule_pair_usize")
(assert (fuel_bool_default fuel%lib!define.impl&%31.get_return_vaule_pair_usize.))
(define-fun is-lib!define.RetValueType./SuccessPairUsize_ ((c lib!define.RetValueType.)) Bool ((_ is lib!define.RetValueType./SuccessPairUsize) c))
(assert (=> (fuel_bool fuel%lib!define.impl&%31.get_return_vaule_pair_usize.) (forall ((self! Poly)) (! (= (lib!define.impl&%31.get_return_vaule_pair_usize.? self!) (let ((tmp%%$ (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. self!)))) (ite (is-lib!define.RetValueType./SuccessPairUsize_ tmp%%$) (let ((value1$ (lib!define.RetValueType./SuccessPairUsize/value1 (%Poly%lib!define.RetValueType. (Poly%lib!define.RetValueType. tmp%%$))))) (let ((value2$ (lib!define.RetValueType./SuccessPairUsize/value2 (%Poly%lib!define.RetValueType. (Poly%lib!define.RetValueType. tmp%%$))))) (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (I value1$) (I value2$)))))) core!option.Option./None))) :pattern ((lib!define.impl&%31.get_return_vaule_pair_usize.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.SyscallReturnStruct.) (has_type (Poly%core!option.Option. (lib!define.impl&%31.get_return_vaule_pair_usize.? self!)) (TYPE%core!option.Option. $ (TYPE%tuple%2. $ (UINT SZ) $ (UINT SZ))))) :pattern ((lib!define.impl&%31.get_return_vaule_pair_usize.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::SyscallReturnStruct::get_return_vaule_three_usize")
(assert (fuel_bool_default fuel%lib!define.impl&%31.get_return_vaule_three_usize.))
(define-fun is-lib!define.RetValueType./SuccessThreeUsize_ ((c lib!define.RetValueType.)) Bool ((_ is lib!define.RetValueType./SuccessThreeUsize) c))
(assert (=> (fuel_bool fuel%lib!define.impl&%31.get_return_vaule_three_usize.) (forall ((self! Poly)) (! (= (lib!define.impl&%31.get_return_vaule_three_usize.? self!) (let ((tmp%%$ (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. self!)))) (ite (is-lib!define.RetValueType./SuccessThreeUsize_ tmp%%$) (let ((value1$ (lib!define.RetValueType./SuccessThreeUsize/value1 (%Poly%lib!define.RetValueType. (Poly%lib!define.RetValueType. tmp%%$))))) (let ((value2$ (lib!define.RetValueType./SuccessThreeUsize/value2 (%Poly%lib!define.RetValueType. (Poly%lib!define.RetValueType. tmp%%$))))) (let ((value3$ (lib!define.RetValueType./SuccessThreeUsize/value3 (%Poly%lib!define.RetValueType. (Poly%lib!define.RetValueType. tmp%%$))))) (core!option.Option./Some (Poly%tuple%3. (tuple%3./tuple%3 (I value1$) (I value2$) (I value3$))))))) core!option.Option./None))) :pattern ((lib!define.impl&%31.get_return_vaule_three_usize.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.SyscallReturnStruct.) (has_type (Poly%core!option.Option. (lib!define.impl&%31.get_return_vaule_three_usize.? self!)) (TYPE%core!option.Option. $ (TYPE%tuple%3. $ (UINT SZ) $ (UINT SZ) $ (UINT SZ))))) :pattern ((lib!define.impl&%31.get_return_vaule_three_usize.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::SyscallReturnStruct::spec_is_error")
(assert (fuel_bool_default fuel%lib!define.impl&%31.spec_is_error.))
(define-fun is-lib!define.RetValueType./Error_ ((c lib!define.RetValueType.)) Bool ((_ is lib!define.RetValueType./Error) c))
(assert (=> (fuel_bool fuel%lib!define.impl&%31.spec_is_error.) (forall ((self! Poly)) (! (= (lib!define.impl&%31.spec_is_error.? self!) (let ((tmp%%$ (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. self!)))) (is-lib!define.RetValueType./Error_ tmp%%$))) :pattern ((lib!define.impl&%31.spec_is_error.? self!))))))
(set-info :comment ";; Function-Axioms lib::define::RetValueType::arrow_value3")
(assert (fuel_bool_default fuel%lib!define.impl&%25.arrow_value3.))
(assert (=> (fuel_bool fuel%lib!define.impl&%25.arrow_value3.) (forall ((self! Poly)) (! (= (lib!define.impl&%25.arrow_value3.? self!) (lib!define.RetValueType./SuccessThreeUsize/value3 (%Poly%lib!define.RetValueType. self!))) :pattern ((lib!define.impl&%25.arrow_value3.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.RetValueType.) (uInv SZ (lib!define.impl&%25.arrow_value3.? self!))) :pattern ((lib!define.impl&%25.arrow_value3.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::RetValueType::arrow_SuccessUsize_value")
(assert (fuel_bool_default fuel%lib!define.impl&%25.arrow_SuccessUsize_value.))
(assert (=> (fuel_bool fuel%lib!define.impl&%25.arrow_SuccessUsize_value.) (forall ((self! Poly)) (! (= (lib!define.impl&%25.arrow_SuccessUsize_value.? self!) (lib!define.RetValueType./SuccessUsize/value (%Poly%lib!define.RetValueType. self!))) :pattern ((lib!define.impl&%25.arrow_SuccessUsize_value.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.RetValueType.) (uInv SZ (lib!define.impl&%25.arrow_SuccessUsize_value.? self!))) :pattern ((lib!define.impl&%25.arrow_SuccessUsize_value.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::RetValueType::arrow_SuccessSeqUsize_value")
(assert (fuel_bool_default fuel%lib!define.impl&%25.arrow_SuccessSeqUsize_value.))
(assert (=> (fuel_bool fuel%lib!define.impl&%25.arrow_SuccessSeqUsize_value.) (forall ((self! Poly)) (! (= (lib!define.impl&%25.arrow_SuccessSeqUsize_value.? self!) (lib!define.RetValueType./SuccessSeqUsize/value (%Poly%lib!define.RetValueType. self!))) :pattern ((lib!define.impl&%25.arrow_SuccessSeqUsize_value.? self!))))))
(set-info :comment ";; Function-Axioms lib::define::RetValueType::arrow_SuccessPairUsize_value1")
(assert (fuel_bool_default fuel%lib!define.impl&%25.arrow_SuccessPairUsize_value1.))
(assert (=> (fuel_bool fuel%lib!define.impl&%25.arrow_SuccessPairUsize_value1.) (forall ((self! Poly)) (! (= (lib!define.impl&%25.arrow_SuccessPairUsize_value1.? self!) (lib!define.RetValueType./SuccessPairUsize/value1 (%Poly%lib!define.RetValueType. self!))) :pattern ((lib!define.impl&%25.arrow_SuccessPairUsize_value1.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.RetValueType.) (uInv SZ (lib!define.impl&%25.arrow_SuccessPairUsize_value1.? self!))) :pattern ((lib!define.impl&%25.arrow_SuccessPairUsize_value1.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::RetValueType::arrow_SuccessPairUsize_value2")
(assert (fuel_bool_default fuel%lib!define.impl&%25.arrow_SuccessPairUsize_value2.))
(assert (=> (fuel_bool fuel%lib!define.impl&%25.arrow_SuccessPairUsize_value2.) (forall ((self! Poly)) (! (= (lib!define.impl&%25.arrow_SuccessPairUsize_value2.? self!) (lib!define.RetValueType./SuccessPairUsize/value2 (%Poly%lib!define.RetValueType. self!))) :pattern ((lib!define.impl&%25.arrow_SuccessPairUsize_value2.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.RetValueType.) (uInv SZ (lib!define.impl&%25.arrow_SuccessPairUsize_value2.? self!))) :pattern ((lib!define.impl&%25.arrow_SuccessPairUsize_value2.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::RetValueType::arrow_SuccessThreeUsize_value1")
(assert (fuel_bool_default fuel%lib!define.impl&%25.arrow_SuccessThreeUsize_value1.))
(assert (=> (fuel_bool fuel%lib!define.impl&%25.arrow_SuccessThreeUsize_value1.) (forall ((self! Poly)) (! (= (lib!define.impl&%25.arrow_SuccessThreeUsize_value1.? self!) (lib!define.RetValueType./SuccessThreeUsize/value1 (%Poly%lib!define.RetValueType. self!))) :pattern ((lib!define.impl&%25.arrow_SuccessThreeUsize_value1.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.RetValueType.) (uInv SZ (lib!define.impl&%25.arrow_SuccessThreeUsize_value1.? self!))) :pattern ((lib!define.impl&%25.arrow_SuccessThreeUsize_value1.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::RetValueType::arrow_SuccessThreeUsize_value2")
(assert (fuel_bool_default fuel%lib!define.impl&%25.arrow_SuccessThreeUsize_value2.))
(assert (=> (fuel_bool fuel%lib!define.impl&%25.arrow_SuccessThreeUsize_value2.) (forall ((self! Poly)) (! (= (lib!define.impl&%25.arrow_SuccessThreeUsize_value2.? self!) (lib!define.RetValueType./SuccessThreeUsize/value2 (%Poly%lib!define.RetValueType. self!))) :pattern ((lib!define.impl&%25.arrow_SuccessThreeUsize_value2.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.RetValueType.) (uInv SZ (lib!define.impl&%25.arrow_SuccessThreeUsize_value2.? self!))) :pattern ((lib!define.impl&%25.arrow_SuccessThreeUsize_value2.? self!)))))
(set-info :comment ";; Function-Axioms lib::define::RetValueType::arrow_SuccessThreeUsize_value3")
(assert (fuel_bool_default fuel%lib!define.impl&%25.arrow_SuccessThreeUsize_value3.))
(assert (=> (fuel_bool fuel%lib!define.impl&%25.arrow_SuccessThreeUsize_value3.) (forall ((self! Poly)) (! (= (lib!define.impl&%25.arrow_SuccessThreeUsize_value3.? self!) (lib!define.RetValueType./SuccessThreeUsize/value3 (%Poly%lib!define.RetValueType. self!))) :pattern ((lib!define.impl&%25.arrow_SuccessThreeUsize_value3.? self!))))))
(assert (forall ((self! Poly)) (! (=> (has_type self! TYPE%lib!define.RetValueType.) (uInv SZ (lib!define.impl&%25.arrow_SuccessThreeUsize_value3.? self!))) :pattern ((lib!define.impl&%25.arrow_SuccessThreeUsize_value3.? self!)))))
(set-info :comment ";; Function-Def lib::define::MAX_NUM_PROCS")
(set-info :comment ";; define.rs:141:1: 141:42 (#0)")
(set-info :comment ";; Function-Axioms lib::define::MAX_NUM_PROCS")
(assert (fuel_bool_default fuel%lib!define.MAX_NUM_PROCS.))
(assert (=> (fuel_bool fuel%lib!define.MAX_NUM_PROCS.) (= lib!define.MAX_NUM_PROCS.? lib!define.PCID_MAX.?)))
(assert (uInv SZ lib!define.MAX_NUM_PROCS.?))
(set-info :comment ";; Function-Def lib::define::MAX_NUM_THREADS")
(set-info :comment ";; define.rs:142:1: 142:46 (#0)")
(set-info :comment ";; Function-Axioms lib::define::MAX_NUM_THREADS")
(assert (fuel_bool_default fuel%lib!define.MAX_NUM_THREADS.))
(assert (=> (fuel_bool fuel%lib!define.MAX_NUM_THREADS.) (= lib!define.MAX_NUM_THREADS.? (uClip SZ (Mul 500 4096)))))
(assert (uInv SZ lib!define.MAX_NUM_THREADS.?))
(set-info :comment ";; Function-Def lib::define::IPC_MESSAGE_LEN")
(set-info :comment ";; define.rs:143:1: 143:40 (#0)")
(set-info :comment ";; Function-Axioms lib::define::IPC_MESSAGE_LEN")
(assert (fuel_bool_default fuel%lib!define.IPC_MESSAGE_LEN.))
(assert (=> (fuel_bool fuel%lib!define.IPC_MESSAGE_LEN.) (= lib!define.IPC_MESSAGE_LEN.? 1024)))
(assert (uInv SZ lib!define.IPC_MESSAGE_LEN.?))
(set-info :comment ";; Function-Def lib::define::IPC_PAGEPAYLOAD_LEN")
(set-info :comment ";; define.rs:144:1: 144:43 (#0)")
(set-info :comment ";; Function-Axioms lib::define::IPC_PAGEPAYLOAD_LEN")
(assert (fuel_bool_default fuel%lib!define.IPC_PAGEPAYLOAD_LEN.))
(assert (=> (fuel_bool fuel%lib!define.IPC_PAGEPAYLOAD_LEN.) (= lib!define.IPC_PAGEPAYLOAD_LEN.? 128)))
(assert (uInv SZ lib!define.IPC_PAGEPAYLOAD_LEN.?))
(set-info :comment ";; Function-Def lib::define::PAGE_SZ_4k")
(set-info :comment ";; define.rs:148:1: 148:43 (#0)")
(set-info :comment ";; Function-Axioms lib::define::PAGE_SZ_4k")
(assert (fuel_bool_default fuel%lib!define.PAGE_SZ_4k.))
(assert (=> (fuel_bool fuel%lib!define.PAGE_SZ_4k.) (= lib!define.PAGE_SZ_4k.? (uClip SZ (bitshl (I 1) (I 12))))))
(assert (uInv SZ lib!define.PAGE_SZ_4k.?))
(set-info :comment ";; Function-Def lib::define::PAGE_SZ_2m")
(set-info :comment ";; define.rs:149:1: 149:43 (#0)")
(set-info :comment ";; Function-Axioms lib::define::PAGE_SZ_2m")
(assert (fuel_bool_default fuel%lib!define.PAGE_SZ_2m.))
(assert (=> (fuel_bool fuel%lib!define.PAGE_SZ_2m.) (= lib!define.PAGE_SZ_2m.? (uClip SZ (bitshl (I 1) (I 21))))))
(assert (uInv SZ lib!define.PAGE_SZ_2m.?))
(set-info :comment ";; Function-Def lib::define::PAGE_SZ_1g")
(set-info :comment ";; define.rs:150:1: 150:43 (#0)")
(set-info :comment ";; Function-Axioms lib::define::PAGE_SZ_1g")
(assert (fuel_bool_default fuel%lib!define.PAGE_SZ_1g.))
(assert (=> (fuel_bool fuel%lib!define.PAGE_SZ_1g.) (= lib!define.PAGE_SZ_1g.? (uClip SZ (bitshl (I 1) (I 30))))))
(assert (uInv SZ lib!define.PAGE_SZ_1g.?))
(set-info :comment ";; Function-Def lib::define::MAX_USIZE")
(set-info :comment ";; define.rs:151:1: 151:45 (#0)")
...
(set-info :comment ";; Function-Def lib::define::VA_PERM_MASK")
(set-info :comment ";; define.rs:160:1: 160:52 (#0)")
(set-info :comment ";; Function-Axioms lib::define::VA_PERM_MASK")
(assert (fuel_bool_default fuel%lib!define.VA_PERM_MASK.))
(assert (=> (fuel_bool fuel%lib!define.VA_PERM_MASK.) (= lib!define.VA_PERM_MASK.? 9223372036854775810)))
(assert (uInv 64 lib!define.VA_PERM_MASK.?))
(set-info :comment ";; Function-Def lib::define::READ")
(set-info :comment ";; define.rs:161:1: 161:58 (#0)")
(set-info :comment ";; Function-Axioms lib::define::READ")
(assert (fuel_bool_default fuel%lib!define.READ.))
(assert (=> (fuel_bool fuel%lib!define.READ.) (= lib!define.READ.? (uClip SZ 9223372036854775808))))
(assert (uInv SZ lib!define.READ.?))
(set-info :comment ";; Function-Def lib::define::READ_WRITE")
(set-info :comment ";; define.rs:162:1: 162:64 (#0)")
(set-info :comment ";; Function-Axioms lib::define::READ_WRITE")
(assert (fuel_bool_default fuel%lib!define.READ_WRITE.))
(assert (=> (fuel_bool fuel%lib!define.READ_WRITE.) (= lib!define.READ_WRITE.? (uClip SZ 9223372036854775810))))
(assert (uInv SZ lib!define.READ_WRITE.?))
(set-info :comment ";; Function-Def lib::define::READ_EXECUTE")
(set-info :comment ";; define.rs:163:1: 163:66 (#0)")
(set-info :comment ";; Function-Axioms lib::define::READ_EXECUTE")
(assert (fuel_bool_default fuel%lib!define.READ_EXECUTE.))
(assert (=> (fuel_bool fuel%lib!define.READ_EXECUTE.) (= lib!define.READ_EXECUTE.? (uClip SZ 0))))
(assert (uInv SZ lib!define.READ_EXECUTE.?))
(set-info :comment ";; Function-Def lib::define::READ_WRITE_EXECUTE")
(set-info :comment ";; define.rs:164:1: 164:72 (#0)")
(set-info :comment ";; Function-Axioms lib::define::READ_WRITE_EXECUTE")
(assert (fuel_bool_default fuel%lib!define.READ_WRITE_EXECUTE.))
(assert (=> (fuel_bool fuel%lib!define.READ_WRITE_EXECUTE.) (= lib!define.READ_WRITE_EXECUTE.? (uClip SZ 2))))
(assert (uInv SZ lib!define.READ_WRITE_EXECUTE.?))
(set-info :comment ";; Function-Def lib::define::PCID_ENABLE_MASK")
(set-info :comment ";; define.rs:165:1: 165:70 (#0)")
(set-info :comment ";; Function-Axioms lib::define::PCID_ENABLE_MASK")
(assert (fuel_bool_default fuel%lib!define.PCID_ENABLE_MASK.))
(assert (=> (fuel_bool fuel%lib!define.PCID_ENABLE_MASK.) (= lib!define.PCID_ENABLE_MASK.? (uClip SZ 9223372036854775808))))
(assert (uInv SZ lib!define.PCID_ENABLE_MASK.?))
(set-info :comment ";; Function-Def lib::define::PAGE_ENTRY_PRESENT_SHIFT")
(set-info :comment ";; define.rs:168:1: 168:44 (#0)")
(set-info :comment ";; Function-Axioms lib::define::PAGE_ENTRY_PRESENT_SHIFT")
(assert (fuel_bool_default fuel%lib!define.PAGE_ENTRY_PRESENT_SHIFT.))
(assert (=> (fuel_bool fuel%lib!define.PAGE_ENTRY_PRESENT_SHIFT.) (= lib!define.PAGE_ENTRY_PRESENT_SHIFT.? 0)))
(assert (uInv 64 lib!define.PAGE_ENTRY_PRESENT_SHIFT.?))
...
(set-info :comment ";; Function-Specs lib::define::SyscallReturnStruct::NoSwitchNew")
(declare-fun ens%lib!define.impl&%31.NoSwitchNew. (lib!define.RetValueType. lib!define.SyscallReturnStruct.) Bool)
(assert (forall ((error_code! lib!define.RetValueType.) (ret! lib!define.SyscallReturnStruct.)) (! (= (ens%lib!define.impl&%31.NoSwitchNew. error_code! ret!) (and (has_type (Poly%lib!define.SyscallReturnStruct. ret!) TYPE%lib!define.SyscallReturnStruct.) (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) error_code!) (is-core!option.Option./None_ (lib!define.SyscallReturnStruct./SyscallReturnStruct/pcid (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!)))) (is-core!option.Option./None_ (lib!define.SyscallReturnStruct./SyscallReturnStruct/cr3 (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!)))) (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/switch_decision (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) lib!define.SwitchDecision./NoSwitch))) :pattern ((ens%lib!define.impl&%31.NoSwitchNew. error_code! ret!)))))
(set-info :comment ";; Function-Def lib::define::SyscallReturnStruct::NoSwitchNew")
(set-info :comment ";; define.rs:251:5: 251:60 (#0)")
(set-info :comment ";; Function-Specs lib::define::EndpointState::is_send")
(declare-fun ens%lib!define.impl&%8.is_send. (lib!define.EndpointState. Bool) Bool)
(assert (forall ((self! lib!define.EndpointState.) (ret! Bool)) (! (= (ens%lib!define.impl&%8.is_send. self! ret!) (= ret! (= self! lib!define.EndpointState./SEND))) :pattern ((ens%lib!define.impl&%8.is_send. self! ret!)))))
(set-info :comment ";; Function-Def lib::define::EndpointState::is_send")
(set-info :comment ";; define.rs:51:5: 51:39 (#0)")
(set-info :comment ";; Function-Specs lib::define::EndpointState::is_receive")
(declare-fun ens%lib!define.impl&%8.is_receive. (lib!define.EndpointState. Bool) Bool)
(assert (forall ((self! lib!define.EndpointState.) (ret! Bool)) (! (= (ens%lib!define.impl&%8.is_receive. self! ret!) (= ret! (= self! lib!define.EndpointState./RECEIVE))) :pattern ((ens%lib!define.impl&%8.is_receive. self! ret!)))))
(set-info :comment ";; Function-Def lib::define::EndpointState::is_receive")
(set-info :comment ";; define.rs:61:5: 61:42 (#0)")
(set-info :comment ";; Function-Specs lib::define::SyscallReturnStruct::NoNextThreadNew")
(declare-fun ens%lib!define.impl&%31.NoNextThreadNew. (lib!define.RetValueType. lib!define.SyscallReturnStruct.) Bool)
(assert (forall ((error_code! lib!define.RetValueType.) (ret! lib!define.SyscallReturnStruct.)) (! (= (ens%lib!define.impl&%31.NoNextThreadNew. error_code! ret!) (and (has_type (Poly%lib!define.SyscallReturnStruct. ret!) TYPE%lib!define.SyscallReturnStruct.) (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) error_code!) (is-core!option.Option./None_ (lib!define.SyscallReturnStruct./SyscallReturnStruct/pcid (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!)))) (is-core!option.Option./None_ (lib!define.SyscallReturnStruct./SyscallReturnStruct/cr3 (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!)))) (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/switch_decision (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) lib!define.SwitchDecision./NoThread))) :pattern ((ens%lib!define.impl&%31.NoNextThreadNew. error_code! ret!)))))
(set-info :comment ";; Function-Def lib::define::SyscallReturnStruct::NoNextThreadNew")
(set-info :comment ";; define.rs:266:5: 266:64 (#0)")
(set-info :comment ";; Function-Specs lib::define::SyscallReturnStruct::SwitchNew")
(declare-fun ens%lib!define.impl&%31.SwitchNew. (lib!define.RetValueType. Int Int lib!define.SyscallReturnStruct.) Bool)
(assert (forall ((error_code! lib!define.RetValueType.) (cr3! Int) (pcid! Int) (ret! lib!define.SyscallReturnStruct.)) (! (= (ens%lib!define.impl&%31.SwitchNew. error_code! cr3! pcid! ret!) (and (has_type (Poly%lib!define.SyscallReturnStruct. ret!) TYPE%lib!define.SyscallReturnStruct.) (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) error_code!) (ext_eq false (TYPE%core!option.Option. $ (UINT SZ)) (Poly%core!option.Option. (lib!define.SyscallReturnStruct./SyscallReturnStruct/pcid (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!)))) (Poly%core!option.Option. (core!option.Option./Some (I pcid!)))) (ext_eq false (TYPE%core!option.Option. $ (UINT SZ)) (Poly%core!option.Option. (lib!define.SyscallReturnStruct./SyscallReturnStruct/cr3 (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!)))) (Poly%core!option.Option. (core!option.Option./Some (I cr3!)))) (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/switch_decision (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) lib!define.SwitchDecision./Switch))) :pattern ((ens%lib!define.impl&%31.SwitchNew. error_code! cr3! pcid! ret!)))))
(set-info :comment ";; Function-Def lib::define::SyscallReturnStruct::SwitchNew")
(set-info :comment ";; define.rs:282:5: 282:79 (#0)")
(declare-const ret! lib!define.SyscallReturnStruct.)
(declare-const error_code! lib!define.RetValueType.)
(declare-const cr3! Int)
(declare-const pcid! Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!define.RetValueType. error_code!) TYPE%lib!define.RetValueType.))
(assert (uInv SZ cr3!))
(assert (uInv SZ pcid!))
...
(assert (not (=> (= ret! (lib!define.SyscallReturnStruct./SyscallReturnStruct (%Poly%lib!define.RetValueType. (Poly%lib!define.RetValueType. error_code!)) (%Poly%core!option.Option. (Poly%core!option.Option. (core!option.Option./Some (I pcid!)))) (%Poly%core!option.Option. (Poly%core!option.Option. (core!option.Option./Some (I cr3!)))) (%Poly%lib!define.SwitchDecision. (Poly%lib!define.SwitchDecision. lib!define.SwitchDecision./Switch)))) (and (=> %%location_label%%0 (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) error_code!)) (and (=> %%location_label%%1 (ext_eq false (TYPE%core!option.Option. $ (UINT SZ)) (Poly%core!option.Option. (lib!define.SyscallReturnStruct./SyscallReturnStruct/pcid (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!)))) (Poly%core!option.Option. (core!option.Option./Some (I pcid!))))) (and (=> %%location_label%%2 (ext_eq false (TYPE%core!option.Option. $ (UINT SZ)) (Poly%core!option.Option. (lib!define.SyscallReturnStruct./SyscallReturnStruct/cr3 (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!)))) (Poly%core!option.Option. (core!option.Option./Some (I cr3!))))) (=> %%location_label%%3 (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/switch_decision (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) lib!define.SwitchDecision./Switch))))))))
(check-sat)
(exit)
