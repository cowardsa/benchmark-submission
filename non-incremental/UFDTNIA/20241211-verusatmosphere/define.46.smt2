...
(set-info :comment ";; Function-Specs lib::define::SyscallReturnStruct::is_error")
(declare-fun ens%lib!define.impl&%31.is_error. (lib!define.SyscallReturnStruct. Bool) Bool)
(assert (forall ((self! lib!define.SyscallReturnStruct.) (ret! Bool)) (! (= (ens%lib!define.impl&%31.is_error. self! ret!) (= ret! (lib!define.impl&%31.spec_is_error.? (Poly%lib!define.SyscallReturnStruct. self!)))) :pattern ((ens%lib!define.impl&%31.is_error. self! ret!)))))
(set-info :comment ";; Function-Def lib::define::SyscallReturnStruct::is_error")
(set-info :comment ";; define.rs:241:5: 241:41 (#0)")
(declare-const ret! Bool)
(declare-const self! lib!define.SyscallReturnStruct.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!define.SyscallReturnStruct. self!) TYPE%lib!define.SyscallReturnStruct.))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= ret! (let ((tmp%%$ (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. self!))))) (is-lib!define.RetValueType./Error_ tmp%%$))) (=> %%location_label%%0 (= ret! (lib!define.impl&%31.spec_is_error.? (Poly%lib!define.SyscallReturnStruct. self!)))))))
(check-sat)
(exit)
