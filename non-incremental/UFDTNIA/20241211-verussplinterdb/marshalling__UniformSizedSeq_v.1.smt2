...
(assert (not (=> (= tmp%1 (lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat./UniformSizedElementSeqFormat/eltf (%Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. self!))) (=> (ens%lib!marshalling.UniformSized_v.UniformSized.uniform_size_ensures. EltFormat&. EltFormat& tmp%1) (and (=> %%location_label%%0 (req%lib!marshalling.Slice_v.impl&%1.len. (%Poly%lib!marshalling.Slice_v.Slice. dslice!))) (=> (ens%lib!marshalling.Slice_v.impl&%1.len. (%Poly%lib!marshalling.Slice_v.Slice. dslice!) tmp%2) (=> (= tmp%4 (lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat./UniformSizedElementSeqFormat/eltf (%Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. self!))) (=> (ens%lib!marshalling.UniformSized_v.UniformSized.exec_uniform_size. EltFormat&. EltFormat& tmp%4 tmp%3) (and (=> %%location_label%%1 (not (= (%I tmp%3) 0))) (=> (= %return! (Poly%core!option.Option. (core!option.Option./Some (I (uClip SZ (EucDiv tmp%2 (%I tmp%3))))))) (and (=> %%location_label%%2 (= (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (%B (lib!marshalling.SeqMarshalling_v.SeqMarshal.lengthable.? $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. EltFormat&. EltFormat&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))) (=> %%location_label%%3 (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (= (core!option.Option./Some/0 (%Poly%core!option.Option. %return!)) (lib!marshalling.SeqMarshalling_v.SeqMarshal.length.? $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. EltFormat&. EltFormat&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))))))))))))))
(check-sat)
(exit)
