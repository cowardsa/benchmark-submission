...
(assert (not (=> (= tmp%2 (Poly%lib!marshalling.IntegerMarshalling_v.IntFormat. (lib!marshalling.KVPairFormat_v.KVPairFormat./KVPairFormat/keylen_fmt (%Poly%lib!marshalling.KVPairFormat_v.KVPairFormat. self!)))) (=> (ens%lib!marshalling.IntegerMarshalling_v.impl&%14.exec_uniform_size. LenType&. LenType& tmp%2 tmp%1) (=> (= tmp%4 (Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. (lib!marshalling.KVPairFormat_v.KVPairFormat./KVPairFormat/data_fmt (%Poly%lib!marshalling.KVPairFormat_v.KVPairFormat. self!)))) (=> (= tmp%5 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!marshalling.KVPairFormat_v.KVPair./KVPair/key (%Poly%lib!marshalling.KVPairFormat_v.KVPair. kvpair!)))) (and (=> %%location_label%%0 (req%lib!marshalling.Marshalling_v.Marshal.exec_size. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%4 tmp%5)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.exec_size. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%4 tmp%5 tmp%3) (and (=> %%location_label%%1 (uInv SZ (Add (%I tmp%1) (%I tmp%3)))) (=> (= tmp%7 (Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. (lib!marshalling.KVPairFormat_v.KVPairFormat./KVPairFormat/data_fmt (%Poly%lib!marshalling.KVPairFormat_v.KVPairFormat. self!)))) (=> (= tmp%8 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!marshalling.KVPairFormat_v.KVPair./KVPair/value (%Poly%lib!marshalling.KVPairFormat_v.KVPair. kvpair!)))) (and (=> %%location_label%%2 (req%lib!marshalling.Marshalling_v.Marshal.exec_size. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%7 tmp%8)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.exec_size. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%7 tmp%8 tmp%6) (and (=> %%location_label%%3 (uInv SZ (Add (uClip SZ (Add (%I tmp%1) (%I tmp%3))) (%I tmp%6)))) (=> (= %return! (I (uClip SZ (Add (uClip SZ (Add (%I tmp%1) (%I tmp%3))) (%I tmp%6))))) (=> %%location_label%%4 (= %return! (lib!marshalling.Marshalling_v.Marshal.spec_size.? $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) kvpair!)))))))))))))))))))
(check-sat)
(exit)
