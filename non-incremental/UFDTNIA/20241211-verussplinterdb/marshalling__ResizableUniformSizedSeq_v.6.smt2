...
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.index_bounds_facts. EltFormat&. EltFormat& LenType&. LenType& (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!) (%I idx!))) (=> (ens%lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.index_bounds_facts. EltFormat&. EltFormat& LenType&. LenType& (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!) (%I idx!)) (=> (ens%lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.exec_size_of_length_field. EltFormat&. EltFormat& LenType&. LenType& (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!) tmp%1) (=> (= tmp%3 (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/eltf (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!))) (=> (ens%lib!marshalling.UniformSized_v.UniformSized.exec_uniform_size. EltFormat&. EltFormat& tmp%3 tmp%2) (and (=> %%location_label%%1 (uInv SZ (Mul (uClip SZ (%I idx!)) (%I tmp%2)))) (and (=> %%location_label%%2 (uInv SZ (Add tmp%1 (uClip SZ (Mul (uClip SZ (%I idx!)) (%I tmp%2)))))) (=> (ens%lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.exec_size_of_length_field. EltFormat&. EltFormat& LenType&. LenType& (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!) tmp%4) (=> (= tmp%6 (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/eltf (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!))) (=> (ens%lib!marshalling.UniformSized_v.UniformSized.exec_uniform_size. EltFormat&. EltFormat& tmp%6 tmp%5) (and (=> %%location_label%%3 (uInv SZ (Mul (uClip SZ (%I idx!)) (%I tmp%5)))) (and (=> %%location_label%%4 (uInv SZ (Add tmp%4 (uClip SZ (Mul (uClip SZ (%I idx!)) (%I tmp%5)))))) (=> (= tmp%8 (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/eltf (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!))) (=> (ens%lib!marshalling.UniformSized_v.UniformSized.exec_uniform_size. EltFormat&. EltFormat& tmp%8 tmp%7) (and (=> %%location_label%%5 (uInv SZ (Add (uClip SZ (Add tmp%4 (uClip SZ (Mul (uClip SZ (%I idx!)) (%I tmp%5))))) (%I tmp%7)))) (=> (= tmp%9 (uClip SZ (Add tmp%1 (uClip SZ (Mul (uClip SZ (%I idx!)) (%I tmp%2)))))) (=> (= tmp%10 (uClip SZ (Add (uClip SZ (Add tmp%4 (uClip SZ (Mul (uClip SZ (%I idx!)) (%I tmp%5))))) (%I tmp%7)))) (and (=> %%location_label%%6 (req%lib!marshalling.Slice_v.impl&%1.subslice. (%Poly%lib!marshalling.Slice_v.Slice. dslice!) tmp%9 tmp%10)) (=> (ens%lib!marshalling.Slice_v.impl&%1.subslice. (%Poly%lib!marshalling.Slice_v.Slice. dslice!) tmp%9 tmp%10 eslice@) (=> (= %return! (Poly%lib!marshalling.Slice_v.Slice. eslice@)) (and (=> %%location_label%%7 (lib!marshalling.Slice_v.impl&%0.wf.? (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. %return!))) (=> %%location_label%%8 (= (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. %return!) (lib!marshalling.SeqMarshalling_v.SeqMarshal.get.? $ (TYPE%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. EltFormat&. EltFormat& LenType&. LenType&) self! (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) idx!))))))))))))))))))))))))))
(check-sat)
(exit)
