...
(declare-const tmp%9 lib!marshalling.Slice_v.Slice.)
...
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.SeqMarshalling_v.SeqMarshal.exec_length. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. EltFormat&. EltFormat&) self! dslice! data!)) (=> (ens%lib!marshalling.SeqMarshalling_v.SeqMarshal.exec_length. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. EltFormat&. EltFormat&) self! dslice! data! tmp%1) (=> (= len@ (%I tmp%1)) (or (and (=> (< (%I idx!) len@) (=> (= tmp%2 (%Poly%lib!marshalling.Slice_v.SpecSlice. (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!))) (and (=> %%location_label%%1 (req%lib!marshalling.UniformSizedSeq_v.impl&%0.index_bounds_facts. EltFormat&. EltFormat& (%Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. self!) tmp%2 (%I idx!))) (=> (ens%lib!marshalling.UniformSizedSeq_v.impl&%0.index_bounds_facts. EltFormat&. EltFormat& (%Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. self!) tmp%2 (%I idx!)) (=> (= tmp%4 (lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat./UniformSizedElementSeqFormat/eltf (%Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. self!))) (=> (ens%lib!marshalling.UniformSized_v.UniformSized.exec_uniform_size. EltFormat&. EltFormat& tmp%4 tmp%3) (and (=> %%location_label%%2 (uInv SZ (Mul (uClip SZ (%I idx!)) (%I tmp%3)))) (=> (= tmp%6 (lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat./UniformSizedElementSeqFormat/eltf (%Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. self!))) (=> (ens%lib!marshalling.UniformSized_v.UniformSized.exec_uniform_size. EltFormat&. EltFormat& tmp%6 tmp%5) (and (=> %%location_label%%3 (uInv SZ (Mul (uClip SZ (%I idx!)) (%I tmp%5)))) (=> (= tmp%8 (lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat./UniformSizedElementSeqFormat/eltf (%Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. self!))) (=> (ens%lib!marshalling.UniformSized_v.UniformSized.exec_uniform_size. EltFormat&. EltFormat& tmp%8 tmp%7) (and (=> %%location_label%%4 (uInv SZ (Add (uClip SZ (Mul (uClip SZ (%I idx!)) (%I tmp%5))) (%I tmp%7)))) (=> (= tmp%10 (uClip SZ (Mul (uClip SZ (%I idx!)) (%I tmp%3)))) (=> (= tmp%11 (uClip SZ (Add (uClip SZ (Mul (uClip SZ (%I idx!)) (%I tmp%5))) (%I tmp%7)))) (and (=> %%location_label%%5 (req%lib!marshalling.Slice_v.impl&%1.subslice. (%Poly%lib!marshalling.Slice_v.Slice. dslice!) tmp%10 tmp%11)) (=> (ens%lib!marshalling.Slice_v.impl&%1.subslice. (%Poly%lib!marshalling.Slice_v.Slice. dslice!) tmp%10 tmp%11 tmp%9) (=> (= tmp%12 (core!option.Option./Some (Poly%lib!marshalling.Slice_v.Slice. tmp%9))) %%switch_label%%0)))))))))))))))))) (=> (not (< (%I idx!) len@)) (=> (= tmp%12 core!option.Option./None) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= %return! (Poly%core!option.Option. tmp%12)) (and (=> %%location_label%%6 (= (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (%B (lib!marshalling.SeqMarshalling_v.SeqMarshal.gettable.? $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. EltFormat&. EltFormat&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)) idx!)))) (=> %%location_label%%7 (=> (is-core!option.Option./Some_ (%Poly%core!option.Option. %return!)) (= (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))) (lib!marshalling.SeqMarshalling_v.SeqMarshal.get.? $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. EltFormat&. EltFormat&) self! (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. dslice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) idx!)))))))))))))
(check-sat)
(exit)
