...
(declare-const kvpair! Poly)
(declare-const data!@0 Poly)
...
(declare-const verus_tmp_data_after_keylen@ vstd!seq.Seq<u8.>.)
(declare-const tmp%6 Bool)
(declare-const tmp%7 Poly)
(declare-const tmp%8 Poly)
(declare-const tmp%9 Poly)
(declare-const verus_tmp_data_after_key@ vstd!seq.Seq<u8.>.)
...
(declare-const data_after_value@ vstd!seq.Seq<u8.>.)
(declare-const keylen$1@ Int)
(declare-const key_slice@ lib!marshalling.Slice_v.SpecSlice.)
(declare-const keylen@ Poly)
(declare-const keylen_end@ Int)
(declare-const verus_tmp@0 vstd!seq.Seq<u8.>.)
(declare-const data_after_keylen@0 vstd!seq.Seq<u8.>.)
(declare-const key_end@ Int)
(declare-const verus_tmp$1@0 vstd!seq.Seq<u8.>.)
(declare-const data_after_key@0 vstd!seq.Seq<u8.>.)
(declare-const end@ Int)
(assert fuel_defaults)
(assert (has_type self! (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)))
(assert (has_type kvpair! TYPE%lib!marshalling.KVPairFormat_v.KVPair.))
(assert (has_type data!@0 (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)))
(assert (has_type start! (UINT SZ)))
(assert (tr_bound%lib!marshalling.IntegerMarshalling_v.IntFormattable. LenType&. LenType&))
(assert (%B (lib!marshalling.Marshalling_v.Marshal.valid.? $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self!)))
(assert (%B (lib!marshalling.Marshalling_v.Marshal.marshallable.? $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) kvpair!))))
(assert (<= (Add (%I start!) (%I (lib!marshalling.Marshalling_v.Marshal.spec_size.? $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) kvpair!)))) (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!@0)))
(declare-const data!@1 Poly)
(declare-const verus_tmp@1 vstd!seq.Seq<u8.>.)
(declare-const data_after_keylen@1 vstd!seq.Seq<u8.>.)
(declare-const data!@2 Poly)
(declare-const verus_tmp$1@1 vstd!seq.Seq<u8.>.)
(declare-const data_after_key@1 vstd!seq.Seq<u8.>.)
(declare-const data!@3 Poly)
...
(assert (not (=> (= tmp%2 (Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. (lib!marshalling.KVPairFormat_v.KVPairFormat./KVPairFormat/data_fmt (%Poly%lib!marshalling.KVPairFormat_v.KVPairFormat. self!)))) (=> (= tmp%3 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!marshalling.KVPairFormat_v.KVPair./KVPair/key (%Poly%lib!marshalling.KVPairFormat_v.KVPair. kvpair!)))) (and (=> %%location_label%%0 (req%lib!marshalling.Marshalling_v.Marshal.exec_size. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%2 tmp%3)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.exec_size. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%2 tmp%3 tmp%1) (and (=> %%location_label%%1 (req%lib!marshalling.IntegerMarshalling_v.IntFormattable.from_usize. LenType&. LenType& tmp%1)) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.from_usize. LenType&. LenType& tmp%1 keylen@) (=> (= tmp%5 (Poly%lib!marshalling.IntegerMarshalling_v.IntFormat. (lib!marshalling.KVPairFormat_v.KVPairFormat./KVPairFormat/keylen_fmt (%Poly%lib!marshalling.KVPairFormat_v.KVPairFormat. self!)))) (and (=> %%location_label%%2 (req%lib!marshalling.Marshalling_v.Marshal.exec_marshall. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. LenType&. LenType&) tmp%5 keylen@ data!@0 start!)) (=> (has_type data!@1 (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.exec_marshall. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. LenType&. LenType&) tmp%5 keylen@ data!@0 data!@1 start! tmp%4) (=> (= keylen_end@ (%I tmp%4)) (=> (= verus_tmp@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@1) start! (I keylen_end@)))) (=> (= verus_tmp_data_after_keylen@ verus_tmp@1) (=> (= data_after_keylen@1 verus_tmp_data_after_keylen@) (=> (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.KVPairFormat_v.impl&%1.get_keylen_slice.? LenType&. LenType& self!)) (Poly%vstd!seq.Seq<u8.>. data_after_keylen@1)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@1) start! (I keylen_end@)))) (and (=> %%location_label%%3 tmp%6) (=> tmp%6 (=> (= tmp%8 (Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. (lib!marshalling.KVPairFormat_v.KVPairFormat./KVPairFormat/data_fmt (%Poly%lib!marshalling.KVPairFormat_v.KVPairFormat. self!)))) (=> (= tmp%9 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!marshalling.KVPairFormat_v.KVPair./KVPair/key (%Poly%lib!marshalling.KVPairFormat_v.KVPair. kvpair!)))) (and (=> %%location_label%%4 (req%lib!marshalling.Marshalling_v.Marshal.exec_marshall. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%8 tmp%9 data!@1 (I keylen_end@))) (=> (has_type data!@2 (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.exec_marshall. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%8 tmp%9 data!@1 data!@2 (I keylen_end@) tmp%7) (=> (= key_end@ (%I tmp%7)) (=> (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@2) start! (I key_end@)))) (=> (= verus_tmp_data_after_key@ verus_tmp$1@1) (=> (= data_after_key@1 verus_tmp_data_after_key@) (=> (ens%lib!marshalling.IntegerMarshalling_v.IntFormattable.deepv_is_as_int. LenType&. LenType& keylen@) (=> (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.KVPairFormat_v.impl&%1.get_keylen_slice.? LenType&. LenType& self!)) (Poly%vstd!seq.Seq<u8.>. data_after_key@1)) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.KVPairFormat_v.impl&%1.get_keylen_slice.? LenType&. LenType& self!)) (Poly%vstd!seq.Seq<u8.>. data_after_keylen@1)))) (and (=> %%location_label%%5 tmp%10) (=> tmp%10 (=> (= tmp%11 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@2) (I keylen_end@) (I key_end@)) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.KVPairFormat_v.impl&%1.get_key_slice.? LenType&. LenType& self! (I (lib!marshalling.KVPairFormat_v.impl&%1.get_keylen_elt.? LenType&. LenType& self! (Poly%vstd!seq.Seq<u8.>. data_after_key@1))))) (Poly%vstd!seq.Seq<u8.>. data_after_key@1)))) (and (=> %%location_label%%6 tmp%11) (=> tmp%11 (=> (= tmp%13 (Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. (lib!marshalling.KVPairFormat_v.KVPairFormat./KVPairFormat/data_fmt (%Poly%lib!marshalling.KVPairFormat_v.KVPairFormat. self!)))) (=> (= tmp%14 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!marshalling.KVPairFormat_v.KVPair./KVPair/value (%Poly%lib!marshalling.KVPairFormat_v.KVPair. kvpair!)))) (and (=> %%location_label%%7 (req%lib!marshalling.Marshalling_v.Marshal.exec_marshall. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%13 tmp%14 data!@2 (I key_end@))) (=> (has_type data!@3 (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.exec_marshall. $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. $ (UINT 8))) tmp%13 tmp%14 data!@2 data!@3 (I key_end@) tmp%12) (=> (= end@ (%I tmp%12)) (=> (= data_after_value@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@3) start! (I end@)))) (=> (= keylen$1@ (lib!marshalling.KVPairFormat_v.impl&%1.get_keylen_elt.? LenType&. LenType& self! (Poly%vstd!seq.Seq<u8.>. data_after_value@))) (=> (= key_slice@ (lib!marshalling.KVPairFormat_v.impl&%1.get_key_slice.? LenType&. LenType& self! (I keylen$1@))) (=> (= tmp%15 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.KVPairFormat_v.impl&%1.get_keylen_slice.? LenType&. LenType& self!)) (Poly%vstd!seq.Seq<u8.>. data_after_value@)) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.KVPairFormat_v.impl&%1.get_keylen_slice.? LenType&. LenType& self!)) (Poly%vstd!seq.Seq<u8.>. data_after_keylen@1)))) (and (=> %%location_label%%8 tmp%15) (=> tmp%15 (=> (= tmp%16 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. key_slice@) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@3) start! (I end@))) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. key_slice@) (Poly%vstd!seq.Seq<u8.>. data_after_key@1)))) (and (=> %%location_label%%9 tmp%16) (=> tmp%16 (=> (= tmp%17 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@3) (I key_end@) (I end@)) (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.KVPairFormat_v.impl&%1.get_value_subslice.? LenType&. LenType& self! (Poly%lib!marshalling.Slice_v.SpecSlice. (lib!marshalling.Slice_v.impl&%0.all.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. data_after_value@))) (I keylen$1@))) (Poly%vstd!seq.Seq<u8.>. data_after_value@)))) (and (=> %%location_label%%10 tmp%17) (=> tmp%17 (=> (= %return! (I end@)) (and (=> %%location_label%%11 (= (%I %return!) (Add (%I start!) (%I (lib!marshalling.Marshalling_v.Marshal.spec_size.? $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) kvpair!)))))) (and (=> %%location_label%%12 (= (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!@3) (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!@0))) (and (=> %%location_label%%13 (forall ((i$$0 Poly)) (! (=> (has_type i$$0 INT) (=> (and (<= 0 (%I i$$0)) (< (%I i$$0) (%I start!))) (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@3) i$$0) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@0) i$$0)))) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@3) i$$0)) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@0) i$$0))))) (and (=> %%location_label%%14 (forall ((i$$0 Poly)) (! (=> (has_type i$$0 INT) (=> (and (<= (%I %return!) (%I i$$0)) (< (%I i$$0) (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!@3))) (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@3) i$$0) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@0) i$$0)))) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@3) i$$0)) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@0) i$$0))))) (and (=> %%location_label%%15 (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@3) start! %return!)))) (=> %%location_label%%16 (= (lib!marshalling.Marshalling_v.Marshal.parse.? $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!@3) start! %return!)) (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) kvpair!))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
