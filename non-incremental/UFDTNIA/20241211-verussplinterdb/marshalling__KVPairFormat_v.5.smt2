...
(assert (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))
...
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.Marshalling_v.Marshal.try_parse. $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! slice! data!)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.try_parse. $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! slice! data! tmp%1) (and (=> %%location_label%%1 (req%core!option.impl&%0.unwrap. $ TYPE%lib!marshalling.KVPairFormat_v.KVPair. (%Poly%core!option.Option. tmp%1))) (=> (ens%core!option.impl&%0.unwrap. $ TYPE%lib!marshalling.KVPairFormat_v.KVPair. (%Poly%core!option.Option. tmp%1) tmp%2) (=> (= %return! tmp%2) (=> %%location_label%%2 (= (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./U $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) (proj%lib!marshalling.Marshalling_v.Marshal./DV $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&)) %return!) (lib!marshalling.Marshalling_v.Marshal.parse.? $ (TYPE%lib!marshalling.KVPairFormat_v.KVPairFormat. LenType&. LenType&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))))))))))
(check-sat)
(exit)
