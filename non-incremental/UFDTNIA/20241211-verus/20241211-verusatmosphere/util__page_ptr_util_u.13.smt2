...
(declare-const i! tuple%4.)
(assert fuel_defaults)
(assert (has_type (Poly%tuple%4. i!) (TYPE%tuple%4. $ (UINT SZ) $ (UINT SZ) $ (UINT SZ) $ (UINT SZ))))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(declare-const %%location_label%%3 Bool)
(assert (not (and (=> %%location_label%%0 (and (<= 0 39) (< 39 64))) (and (=> %%location_label%%1 (and (<= 0 30) (< 30 64))) (and (=> %%location_label%%2 (and (<= 0 21) (< 21 64))) (=> %%location_label%%3 (and (<= 0 12) (< 12 64))))))))
(check-sat)
(exit)
