...
(declare-const self! lib!va_range.VaRange4K.)
(declare-const i! Int)
(declare-const tmp%1 Int)
(declare-const tmp%2 Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!va_range.VaRange4K. self!) TYPE%lib!va_range.VaRange4K.))
(assert (uInv SZ i!))
(assert (lib!va_range.impl&%2.wf.? (Poly%lib!va_range.VaRange4K. self!)))
(assert (and (<= 0 i!) (< i! (lib!va_range.VaRange4K./VaRange4K/len (%Poly%lib!va_range.VaRange4K. (Poly%lib!va_range.VaRange4K. self!))))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= tmp%2 (lib!va_range.VaRange4K./VaRange4K/start (%Poly%lib!va_range.VaRange4K. (Poly%lib!va_range.VaRange4K. self!)))) (=> (ens%lib!util.page_ptr_util_u.va_add_range. tmp%2 i! tmp%1) (=> (= ret! tmp%1) (=> %%location_label%%0 (= ret! (%I (vstd!seq.Seq.index.? $ (UINT SZ) (Poly%vstd!seq.Seq<usize.>. (lib!va_range.impl&%2.view.? (Poly%lib!va_range.VaRange4K. self!))) (I i!))))))))))
(check-sat)
(exit)
