...
(assert (uInv SZ ptr!))
(assert (= (uClip SZ (EucMod ptr! 4096)) 0))
(set-info :comment ";; possible division by zero")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (not (= 4096 0))) (=> (= ret! (uClip SZ (EucDiv ptr! 4096))) (=> %%location_label%%1 (= ret! (lib!util.page_ptr_util_u.spec_page_ptr2page_index.? (I ptr!))))))))
(check-sat)
(exit)
