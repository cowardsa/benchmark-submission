...
(set-info :comment ";; lemma/lemma_u.rs:31:1: 31:53 (#0)")
(declare-const v! Int)
(assert fuel_defaults)
(assert (uInv SZ v!))
(assert (lib!util.page_ptr_util_u.page_ptr_valid.? (I v!)))
(set-info :comment ";; requires not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (and (= (uClip SZ (EucMod v! 4096)) 0) (< (uClip SZ (EucDiv v! 4096)) (nClip (Mul (nClip (Mul 2 1024)) 1024))))) (=> (= (uClip SZ (bitand (I v!) (I (uClip SZ (uClip 64 (bitnot (I 281474976706560))))))) 0) (=> %%location_label%%1 (lib!util.page_ptr_util_u.MEM_valid.? (I v!)))))))
(check-sat)
(exit)
