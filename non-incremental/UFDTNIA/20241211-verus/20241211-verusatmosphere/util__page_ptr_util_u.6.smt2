...
(assert (not (and (=> %%location_label%%0 (req%lib!util.page_ptr_util_u.v2l4index. va!)) (=> (ens%lib!util.page_ptr_util_u.v2l4index. va! tmp%1) (and (=> %%location_label%%1 (req%lib!util.page_ptr_util_u.v2l3index. va!)) (=> (ens%lib!util.page_ptr_util_u.v2l3index. va! tmp%2) (and (=> %%location_label%%2 (req%lib!util.page_ptr_util_u.v2l2index. va!)) (=> (ens%lib!util.page_ptr_util_u.v2l2index. va! tmp%3) (and (=> %%location_label%%3 (req%lib!util.page_ptr_util_u.v2l1index. va!)) (=> (ens%lib!util.page_ptr_util_u.v2l1index. va! tmp%4) (=> (= ret! (tuple%4./tuple%4 (I tmp%1) (I tmp%2) (I tmp%3) (I tmp%4))) (and (=> %%location_label%%4 (and (= (%I (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. ret!)))) (lib!util.page_ptr_util_u.spec_v2l4index.? (I va!))) (let ((tmp%%$ (%I (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. ret!)))))) (and (<= lib!define.KERNEL_MEM_END_L4INDEX.? tmp%%$) (<= tmp%%$ 511))))) (and (=> %%location_label%%5 (and (= (%I (tuple%4./tuple%4/1 (%Poly%tuple%4. (Poly%tuple%4. ret!)))) (lib!util.page_ptr_util_u.spec_v2l3index.? (I va!))) (<= (%I (tuple%4./tuple%4/1 (%Poly%tuple%4. (Poly%tuple%4. ret!)))) 511))) (and (=> %%location_label%%6 (and (= (%I (tuple%4./tuple%4/2 (%Poly%tuple%4. (Poly%tuple%4. ret!)))) (lib!util.page_ptr_util_u.spec_v2l2index.? (I va!))) (<= (%I (tuple%4./tuple%4/2 (%Poly%tuple%4. (Poly%tuple%4. ret!)))) 511))) (and (=> %%location_label%%7 (and (= (%I (tuple%4./tuple%4/3 (%Poly%tuple%4. (Poly%tuple%4. ret!)))) (lib!util.page_ptr_util_u.spec_v2l1index.? (I va!))) (<= (%I (tuple%4./tuple%4/3 (%Poly%tuple%4. (Poly%tuple%4. ret!)))) 511))) (=> %%location_label%%8 (= ret! (lib!util.page_ptr_util_u.spec_va2index.? (I va!)))))))))))))))))))
(check-sat)
(exit)
