...
(assert (not (=> (= ret! (lib!define.SyscallReturnStruct./SyscallReturnStruct (%Poly%lib!define.RetValueType. (Poly%lib!define.RetValueType. error_code!)) (%Poly%core!option.Option. (Poly%core!option.Option. core!option.Option./None)) (%Poly%core!option.Option. (Poly%core!option.Option. core!option.Option./None)) (%Poly%lib!define.SwitchDecision. (Poly%lib!define.SwitchDecision. lib!define.SwitchDecision./NoThread)))) (and (=> %%location_label%%0 (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/error_code (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) error_code!)) (and (=> %%location_label%%1 (is-core!option.Option./None_ (lib!define.SyscallReturnStruct./SyscallReturnStruct/pcid (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))))) (and (=> %%location_label%%2 (is-core!option.Option./None_ (lib!define.SyscallReturnStruct./SyscallReturnStruct/cr3 (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))))) (=> %%location_label%%3 (= (lib!define.SyscallReturnStruct./SyscallReturnStruct/switch_decision (%Poly%lib!define.SyscallReturnStruct. (Poly%lib!define.SyscallReturnStruct. ret!))) lib!define.SwitchDecision./NoThread))))))))
(check-sat)
(exit)
