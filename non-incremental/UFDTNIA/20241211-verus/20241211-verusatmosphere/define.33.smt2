...
(assert (not (and (=> %%location_label%%0 (uInv 64 (Mul 31 1024))) (and (=> %%location_label%%1 (uInv 64 (Mul (uClip 64 (Mul 31 1024)) 1024))) (=> %%location_label%%2 (uInv 64 (Mul (uClip 64 (Mul (uClip 64 (Mul 31 1024)) 1024)) 1024)))))))
(check-sat)
(exit)
