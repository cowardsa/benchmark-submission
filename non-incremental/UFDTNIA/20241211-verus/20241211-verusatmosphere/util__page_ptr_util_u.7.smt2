...
(assert (uInv SZ i!))
(assert (and (<= 0 i!) (< i! lib!define.NUM_PAGES.?)))
(set-info :comment ";; possible arithmetic underflow/overflow")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 lib!define.MAX_USIZE.?) (=> (ens%lib!lemma.lemma_t.lemma_usize_u64. tmp%1) (and (=> %%location_label%%0 (uInv SZ (Mul i! 4096))) (=> (= ret! (uClip SZ (Mul i! 4096))) (=> %%location_label%%1 (= ret! (lib!util.page_ptr_util_u.spec_page_index2page_ptr.? (I i!))))))))))
(check-sat)
(exit)
