...
(assert (has_type dslice! TYPE%lib!marshalling.Slice_v.SpecSlice.))
(assert (has_type data! (TYPE%vstd!seq.Seq. $ (UINT 8))))
...
(assert (lib!marshalling.Slice_v.impl&%0.valid.? $ (UINT 8) dslice! data!))
(assert (%B (lib!marshalling.SeqMarshalling_v.SeqMarshal.gettable.? $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. EltFormat&. EltFormat&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) dslice! data!) idx!)))
...
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.UniformSizedSeq_v.impl&%0.index_bounds_facts. EltFormat&. EltFormat& (%Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. self!) (%Poly%lib!marshalling.Slice_v.SpecSlice. dslice!) (%I idx!))) (=> (ens%lib!marshalling.UniformSizedSeq_v.impl&%0.index_bounds_facts. EltFormat&. EltFormat& (%Poly%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. self!) (%Poly%lib!marshalling.Slice_v.SpecSlice. dslice!) (%I idx!)) (=> (= tmp%1 (lib!marshalling.Slice_v.impl&%0.valid.? $ (UINT 8) (lib!marshalling.SeqMarshalling_v.SeqMarshal.get.? $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. EltFormat&. EltFormat&) self! dslice! data! idx!) data!)) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (lib!marshalling.Slice_v.impl&%0.valid.? $ (UINT 8) (lib!marshalling.SeqMarshalling_v.SeqMarshal.get.? $ (TYPE%lib!marshalling.UniformSizedSeq_v.UniformSizedElementSeqFormat. EltFormat&. EltFormat&) self! dslice! data! idx!) data!)))))))))
(check-sat)
(exit)
