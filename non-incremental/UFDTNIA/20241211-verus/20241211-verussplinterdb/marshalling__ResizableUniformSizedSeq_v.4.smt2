...
(assert (%B (lib!marshalling.SeqMarshalling_v.SeqMarshal.gettable.? $ (TYPE%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. EltFormat&. EltFormat& LenType&. LenType&) self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) dslice! data!) idx!)))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.index_bounds_facts. EltFormat&. EltFormat& LenType&. LenType& (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!) (%I idx!))) (=> (ens%lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.index_bounds_facts. EltFormat&. EltFormat& LenType&. LenType& (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!) (%I idx!)) (=> %%location_label%%1 (lib!marshalling.Slice_v.impl&%0.valid.? $ (UINT 8) (lib!marshalling.SeqMarshalling_v.SeqMarshal.get.? $ (TYPE%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. EltFormat&. EltFormat& LenType&. LenType&) self! dslice! data! idx!) data!))))))
(check-sat)
(exit)
