...
(assert (not (=> (= tmp%2 (Poly%lib!marshalling.IntegerMarshalling_v.IntFormat. (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/lenf (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. (Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!))))) (=> (ens%lib!marshalling.IntegerMarshalling_v.impl&%14.exec_uniform_size. LenType&. LenType& tmp%2 tmp%1) (=> (= out! (%I tmp%1)) (=> %%location_label%%0 (= out! (lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.size_of_length_field.? EltFormat&. EltFormat& LenType&. LenType& (Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!)))))))))
(check-sat)
(exit)
