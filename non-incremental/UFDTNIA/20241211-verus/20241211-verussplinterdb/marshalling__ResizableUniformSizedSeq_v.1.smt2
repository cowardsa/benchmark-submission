...
(declare-const self! lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat.)
(declare-const data! vstd!seq.Seq<u8.>.)
(declare-const tmp%1 lib!marshalling.IntegerMarshalling_v.IntFormat.)
(declare-const tmp%2 vstd!seq.Seq<u8.>.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!) (TYPE%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. EltFormat&. EltFormat& LenType&. LenType&)))
...
(assert (not (=> (= tmp%1 (lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat./ResizableUniformSizedElementSeqFormat/lenf (%Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. (Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!)))) (=> (= tmp%2 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. data!) (I 0) (I (lib!marshalling.ResizableUniformSizedSeq_v.impl&%0.size_of_length_field.? EltFormat&. EltFormat& LenType&. LenType& (Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!)))))) (=> (ens%lib!marshalling.IntegerMarshalling_v.impl&%12.parse_nat. LenType&. LenType& tmp%1 tmp%2) (=> %%location_label%%0 (let ((tmp%%$ (%I (lib!marshalling.SeqMarshalling_v.SeqMarshal.length.? $ (TYPE%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. EltFormat&. EltFormat& LenType&. LenType&) (Poly%lib!marshalling.ResizableUniformSizedSeq_v.ResizableUniformSizedElementSeqFormat. self!) (Poly%vstd!seq.Seq<u8.>. data!))))) (and (<= 0 tmp%%$) (<= tmp%%$ (%I (lib!marshalling.IntegerMarshalling_v.IntFormattable.max.? LenType&. LenType&)))))))))))
(check-sat)
(exit)
