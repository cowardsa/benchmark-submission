...
(assert (not (=> (= decrease%init0 hi!) (and (=> %%location_label%%0 (not (= a! 0))) (and (=> %%location_label%%1 (<= hi! 64)) (and (=> %%location_label%%2 (= (uClip 64 (bitshr (I a!) (I hi!))) 0)) (=> (not (= hi! 0)) (and (=> %%location_label%%3 true) (=> (= (uClip 64 (bitshl (I 1) (I 0))) 1) (or (and (=> (= (uClip 64 (bitand (I a!) (I 1))) 1) (=> (= i! 0) (and (=> %%location_label%%4 (< i! hi!)) (=> %%location_label%%5 (= (uClip 64 (bitand (I a!) (I (uClip 64 (bitshl (I 1) (I i!)))))) (uClip 64 (bitshl (I 1) (I i!)))))))) (=> (not (= (uClip 64 (bitand (I a!) (I 1))) 1)) (and (=> %%location_label%%6 (not (= (uClip 64 (bitand (I a!) (I 1))) 1))) (and (=> %%location_label%%7 (not (= a! 0))) (and (=> %%location_label%%8 (= (uClip 64 (bitshr (I a!) (I hi!))) 0)) (=> (and (not (= (uClip 64 (bitshr (I a!) (I 1))) 0)) (= (uClip 64 (bitshr (I (uClip 64 (bitshr (I a!) (I 1)))) (I (uClip 64 (Sub hi! 1))))) 0)) (=> (= tmp%1 (uClip 64 (bitshr (I a!) (I 1)))) (=> (= tmp%2 (uClip 64 (Sub hi! 1))) (and (=> %%location_label%%9 (check_decrease_int (let ((a!$0 tmp%1) (hi!$1 tmp%2)) hi!$1) decrease%init0 false)) (and (=> %%location_label%%10 (req%lib!commit_mask.lemma_obtain_bit_index_1_aux. tmp%1 tmp%2)) (=> (ens%lib!commit_mask.lemma_obtain_bit_index_1_aux. tmp%1 tmp%2 j@) (and (=> %%location_label%%11 (and (= (uClip 64 (bitand (I (uClip 64 (bitshr (I a!) (I 1)))) (I (uClip 64 (bitshl (I 1) (I j@)))))) (uClip 64 (bitshl (I 1) (I j@)))) (< j@ 64))) (=> (= (uClip 64 (bitand (I a!) (I (uClip 64 (bitshl (I 1) (I (uClip 64 (Add j@ 1)))))))) (uClip 64 (bitshl (I 1) (I (uClip 64 (Add j@ 1)))))) %%switch_label%%0))))))))))))) (and (not %%switch_label%%0) (=> (= i! (uClip 64 (Add j@ 1))) (and (=> %%location_label%%12 (< i! hi!)) (=> %%location_label%%13 (= (uClip 64 (bitand (I a!) (I (uClip 64 (bitshl (I 1) (I i!)))))) (uClip 64 (bitshl (I 1) (I i!))))))))))))))))))
(check-sat)
(exit)
