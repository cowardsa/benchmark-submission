...
(assert (not (=> %%location_label%%0 (= (lib!layout.block_start.? (Poly%lib!tokens.BlockId. block_id!)) (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. (lib!tokens.BlockId./BlockId/page_id (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. block_id!)))) (I (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. block_id!)))) (I (lib!tokens.BlockId./BlockId/idx (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. block_id!)))))))))
(check-sat)
(exit)
