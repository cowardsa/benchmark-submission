...
(assert (not (and (=> %%location_label%%0 true) (=> (= (Add (Mul block_idx1! block_size!) (Mul (Sub block_idx2! block_idx1!) block_size!)) (Mul block_idx2! block_size!)) (=> %%location_label%%1 (= (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. page_id!) (I block_size!) (I block_idx2!)) (Add (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. page_id!) (I block_size!) (I block_idx1!)) (Mul (Sub block_idx2! block_idx1!) block_size!))))))))
(check-sat)
(exit)
