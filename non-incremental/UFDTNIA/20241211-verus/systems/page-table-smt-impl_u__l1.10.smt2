...
(assert (not (or (and (=> (lib!impl_u.l1.impl&%1.well_formed.? self!) (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.pages_match_entry_size. self!)) (=> (= tmp%1 (lib!impl_u.l1.impl&%1.pages_match_entry_size.? self!)) (=> (= tmp%2 tmp%1) %%switch_label%%4)))) (=> (not (lib!impl_u.l1.impl&%1.well_formed.? self!)) (=> (= tmp%2 false) %%switch_label%%4))) (and (not %%switch_label%%4) (or (and (=> tmp%2 (and (=> %%location_label%%1 (req%lib!impl_u.l1.impl&%1.directories_are_in_next_layer. self!)) (=> (= tmp%3 (lib!impl_u.l1.impl&%1.directories_are_in_next_layer.? self!)) (=> (= tmp%4 tmp%3) %%switch_label%%3)))) (=> (not tmp%2) (=> (= tmp%4 false) %%switch_label%%3))) (and (not %%switch_label%%3) (or (and (=> (and tmp%4 (lib!impl_u.l1.impl&%1.directories_match_arch.? self!)) (and (=> %%location_label%%2 (req%lib!impl_u.l1.impl&%1.directories_obey_invariant. self!)) (=> (= tmp%5 (lib!impl_u.l1.impl&%1.directories_obey_invariant.? self!)) (=> (= tmp%6 tmp%5) %%switch_label%%2)))) (=> (not (and tmp%4 (lib!impl_u.l1.impl&%1.directories_match_arch.? self!))) (=> (= tmp%6 false) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> tmp%6 (and (=> %%location_label%%3 (req%lib!impl_u.l1.impl&%1.directories_are_nonempty. self!)) (=> (= tmp%7 (lib!impl_u.l1.impl&%1.directories_are_nonempty.? self!)) (=> (= tmp%8 tmp%7) %%switch_label%%1)))) (=> (not tmp%6) (=> (= tmp%8 false) %%switch_label%%1))) (and (not %%switch_label%%1) (or (and (=> tmp%8 (and (=> %%location_label%%4 (req%lib!impl_u.l1.impl&%1.frames_aligned. self!)) (=> (= tmp%9 (lib!impl_u.l1.impl&%1.frames_aligned.? self!)) (=> (= tmp%10 tmp%9) %%switch_label%%0)))) (=> (not tmp%8) (=> (= tmp%10 false) %%switch_label%%0))) (not %%switch_label%%0))))))))))))
(check-sat)
(exit)
