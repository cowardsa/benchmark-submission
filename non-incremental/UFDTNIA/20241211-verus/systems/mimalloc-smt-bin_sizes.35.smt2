...
(assert (lib!bin_sizes.valid_bin_idx.? (I b!)))
(assert (not (= b! lib!config.BIN_HUGE.?)))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!bin_sizes.lemma_bin_sizes_constants. 0) (=> %%location_label%%0 (let ((tmp%%$ (lib!bin_sizes.size_of_bin.? (I b!)))) (and (<= 8 tmp%%$) (<= tmp%%$ 4194304)))))))
(check-sat)
(exit)
