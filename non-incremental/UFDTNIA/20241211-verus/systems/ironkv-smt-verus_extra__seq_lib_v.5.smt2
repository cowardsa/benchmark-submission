...
(assert (<= 0 low!))
(declare-fun %%lambda%%4 (%%Function%% Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 %%Function%%) (%%hole%%1 Dcr) (%%hole%%2 Type) (x$ Poly)) (! (= (%%apply%%0 (%%lambda%%4 %%hole%%0 %%hole%%1 %%hole%%2) x$) (I (vstd!seq.Seq.len.? %%hole%%1 %%hole%%2 (%%apply%%0 %%hole%%0 x$)))) :pattern ((%%apply%%0 (%%lambda%%4 %%hole%%0 %%hole%%1 %%hole%%2) x$)))))
...
(assert (not (=> (= decrease%init0 (Sub (nClip (Mul 2 (vstd!seq.Seq.len.? A&. A& s!))) i!)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_len_int_positive. A&. A& B&. B& s! (nClip low!) f!) (=> (= accfl@ (mk_fun (%%lambda%%3 f! B&. B&))) (or (and (=> (= (vstd!seq.Seq.len.? A&. A& s!) 0) %%switch_label%%0) (=> (not (= (vstd!seq.Seq.len.? A&. A& s!) 0)) (or (and (=> (= i! (vstd!seq.Seq.len.? A&. A& s!)) (=> (= s1@ (vstd!seq.Seq.subrange.? A&. A& s! (I 0) (I i!))) (=> (= s2@ s!) (and (=> (= tmp%1 (= (vstd!seq.Seq.len.? A&. A& s1@) (vstd!seq.Seq.len.? A&. A& s2@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> (has_type idx@ INT) (=> (and (<= 0 (%I idx@)) (< (%I idx@) (vstd!seq.Seq.len.? A&. A& s1@))) (=> %%location_label%%1 (= (vstd!seq.Seq.index.? A&. A& s1@ idx@) (vstd!seq.Seq.index.? A&. A& s2@ idx@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? A&. A& s1@))) (= (vstd!seq.Seq.index.? A&. A& s1@ idx$) (vstd!seq.Seq.index.? A&. A& s2@ idx$)))) :pattern ((vstd!seq.Seq.index.? A&. A& s1@ idx$)) :pattern ((vstd!seq.Seq.index.? A&. A& s2@ idx$)))) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1@ s2@)) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> %%location_label%%3 (= s1@ s2@)))))))))) (=> (= s1@ s2@) (=> (= tmp%3 (vstd!seq.Seq.subrange.? A&. A& s! (I 1) (I (vstd!seq.Seq.len.? A&. A& s!)))) (=> (= tmp%4 (Sub i! 1)) (=> (= tmp%5 (Add low! (vstd!seq.Seq.len.? B&. B& (%%apply%%0 f! (vstd!seq.Seq.index.? A&. A& s! (I 0)))))) (and (=> %%location_label%%4 (check_decrease_int (let ((s!$0 tmp%3) (i!$1 tmp%4) (low!$2 tmp%5) (f!$3 f!)) (Sub (nClip (Mul 2 (vstd!seq.Seq.len.? A&. A& s!$0))) i!$1)) decrease%init0 false)) (and (=> %%location_label%%5 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. A&. A& B&. B& tmp%3 tmp%4 tmp%5 f!)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. A&. A& B&. B& tmp%3 tmp%4 tmp%5 f!) %%switch_label%%1))))))))))) (=> (not (= i! (vstd!seq.Seq.len.? A&. A& s!))) (or (and (=> (= i! (Sub (vstd!seq.Seq.len.? A&. A& s!) 1)) (=> (= fl@ (mk_fun (%%lambda%%4 f! B&. B&))) (=> (= tmp%6 (mk_fun (%%lambda%%1 fl@))) (and (=> %%location_label%%6 (req%vstd!function.fun_ext_2. $ INT A&. A& $ INT accfl@ tmp%6)) (=> (ens%vstd!function.fun_ext_2. $ INT A&. A& $ INT accfl@ tmp%6) (and (=> %%location_label%%7 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. A&. A& s! low! fl@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. A&. A& s! low! fl@) %%switch_label%%2))))))) (=> (not (= i! (Sub (vstd!seq.Seq.len.? A&. A& s!) 1))) (=> (= tmp%7 (vstd!seq.Seq.subrange.? A&. A& s! (I 0) (I (Sub (vstd!seq.Seq.len.? A&. A& s!) 1)))) (and (=> %%location_label%%8 (check_decrease_int (let ((s!$0 tmp%7) (i!$1 i!) (low!$2 low!) (f!$3 f!)) (Sub (nClip (Mul 2 (vstd!seq.Seq.len.? A&. A& s!$0))) i!$1)) decrease%init0 false)) (and (=> %%location_label%%9 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. A&. A& B&. B& tmp%7 i! low! f!)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. A&. A& B&. B& tmp%7 i! low! f!) (=> (= tmp%8 (Sub (vstd!seq.Seq.len.? A&. A& s!) 1)) (and (=> %%location_label%%10 (check_decrease_int (let ((s!$0 s!) (i!$1 tmp%8) (low!$2 low!) (f!$3 f!)) (Sub (nClip (Mul 2 (vstd!seq.Seq.len.? A&. A& s!$0))) i!$1)) decrease%init0 false)) (and (=> %%location_label%%11 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. A&. A& B&. B& s! tmp%8 low! f!)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int_le. A&. A& B&. B& s! tmp%8 low! f!) (=> (= s1$1@ (vstd!seq.Seq.subrange.? A&. A& (vstd!seq.Seq.subrange.? A&. A& s! (I 0) (I (Sub (vstd!seq.Seq.len.? A&. A& s!) 1))) (I 0) (I i!))) (=> (= s2$1@ (vstd!seq.Seq.subrange.? A&. A& s! (I 0) (I i!))) (and (=> (= tmp%9 (= (vstd!seq.Seq.len.? A&. A& s1$1@) (vstd!seq.Seq.len.? A&. A& s2$1@))) (and (=> %%location_label%%12 tmp%9) (=> tmp%9 (and (=> (has_type idx$1@ INT) (=> (and (<= 0 (%I idx$1@)) (< (%I idx$1@) (vstd!seq.Seq.len.? A&. A& s1$1@))) (=> %%location_label%%13 (= (vstd!seq.Seq.index.? A&. A& s1$1@ idx$1@) (vstd!seq.Seq.index.? A&. A& s2$1@ idx$1@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? A&. A& s1$1@))) (= (vstd!seq.Seq.index.? A&. A& s1$1@ idx$) (vstd!seq.Seq.index.? A&. A& s2$1@ idx$)))) :pattern ((vstd!seq.Seq.index.? A&. A& s1$1@ idx$)) :pattern ((vstd!seq.Seq.index.? A&. A& s2$1@ idx$)))) (=> (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1$1@ s2$1@)) (and (=> %%location_label%%14 tmp%10) (=> tmp%10 (=> %%location_label%%15 (= s1$1@ s2$1@)))))))))) (=> (= s1$1@ s2$1@) %%switch_label%%2)))))))))))))) (and (not %%switch_label%%2) %%switch_label%%1)))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (and (=> %%location_label%%16 (>= (%I (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ INT s! (I low!) (Poly%fun%2. (mk_fun (%%lambda%%3 f! B&. B&))))) 0)) (=> %%location_label%%17 (<= (%I (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ INT (vstd!seq.Seq.subrange.? A&. A& s! (I 0) (I i!)) (I low!) (Poly%fun%2. (mk_fun (%%lambda%%3 f! B&. B&))))) (%I (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ INT s! (I low!) (Poly%fun%2. (mk_fun (%%lambda%%3 f! B&. B&)))))))))))))))
(check-sat)
(exit)
