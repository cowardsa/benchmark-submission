...
(assert (not (and (=> %%location_label%%0 (req%lib!definitions_u.impl&%2.entry_size. self! layer!)) (=> (ens%lib!definitions_u.impl&%2.entry_size. self! layer! es@) (and (=> %%location_label%%1 (uInv SZ (Sub vaddr! base!))) (=> (= offset@ (uClip SZ (Sub vaddr! base!))) (and (=> %%location_label%%2 (not (= es@ 0))) (=> (= res@ (uClip SZ (EucDiv offset@ es@))) (and (=> %%location_label%%3 (= res@ (uClip SZ (EucDiv offset@ es@)))) (and (=> %%location_label%%4 (< 0 es@)) (=> (= res@ (nClip (EucDiv offset@ es@))) (=> (= res! res@) (and (=> %%location_label%%5 (= res! (lib!definitions_t.index_from_base_and_addr.? (I base!) (I vaddr!) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. self!))) (I layer!)))))) (=> %%location_label%%6 (= res! (lib!definitions_t.index_from_base_and_addr.? (I base!) (I vaddr!) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. self!))) (I layer!)))))))))))))))))))
(check-sat)
(exit)
