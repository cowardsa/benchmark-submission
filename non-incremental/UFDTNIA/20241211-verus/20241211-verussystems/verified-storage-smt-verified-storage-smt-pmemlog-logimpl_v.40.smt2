...
(declare-const bytes1! Poly)
(declare-const bytes2! Poly)
(assert fuel_defaults)
(assert (has_type bytes1! (TYPE%vstd!seq.Seq. T&. T&)))
(assert (has_type bytes2! (TYPE%vstd!seq.Seq. T&. T&)))
(assert (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) bytes1! bytes2!))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (forall ((i$ Poly) (j$ Poly)) (! (=> (and (has_type i$ INT) (has_type j$ INT)) (=> (and (and (<= 0 (%I i$)) (< (%I i$) (%I j$))) (< (%I j$) (vstd!seq.Seq.len.? T&. T& bytes1!))) (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& bytes1! i$ j$) (vstd!seq.Seq.subrange.? T&. T& bytes2! i$ j$)))) :pattern ((vstd!seq.Seq.subrange.? T&. T& bytes1! i$ j$)) :pattern ((vstd!seq.Seq.subrange.? T&. T& bytes2! i$ j$)))))))
(check-sat)
(exit)
