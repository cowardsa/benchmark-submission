...
(assert (has_type s1! (TYPE%vstd!set.Set. S&. S&)))
(assert (has_type s2! (TYPE%vstd!set.Set. S&. S&)))
(assert (has_type (Poly%fun%1. f!) (TYPE%fun%1. S&. S& T&. T&)))
(declare-fun %%choose%%0 (Type Dcr Type Poly %%Function%% Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4 %%Function%%) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly)) (! (=> (exists ((y$ Poly)) (! (and (has_type y$ %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 y$) (= (%%apply%%0 %%hole%%4 y$) %%hole%%5))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 %%hole%%8 y$)))) (exists ((y$ Poly)) (! (and (and (has_type y$ %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 y$) (= (%%apply%%0 %%hole%%4 y$) %%hole%%5))) (= (%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) y$)) :pattern ((vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 %%hole%%8 y$))))) :pattern ((%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8)))))
...
(assert (not (and (=> (has_type x@ T&) (=> (vstd!set.impl&%0.contains.? T&. T& (vstd!set.impl&%0.union.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1! (Poly%fun%1. f!)) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s2! (Poly%fun%1. f!))) x@) (or (and (=> (vstd!set.impl&%0.contains.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1! (Poly%fun%1. f!)) x@) (=> (= tmp%1 (vstd!set.impl&%0.contains.? S&. S& (vstd!set.impl&%0.union.? S&. S& s1! s2!) (as_type (%%choose%%0 S& S&. S& s1! f! x@ S&. S& s1!) S&))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (vstd!set.impl&%0.contains.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1! (Poly%fun%1. f!)) x@)) (=> (= tmp%2 (vstd!set.impl&%0.contains.? S&. S& (vstd!set.impl&%0.union.? S&. S& s1! s2!) (as_type (%%choose%%0 S& S&. S& s2! f! x@ S&. S& s2!) S&))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%2 (vstd!set.impl&%0.contains.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& (vstd!set.impl&%0.union.? S&. S& s1! s2!) (Poly%fun%1. f!)) x@)))))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!set.impl&%0.contains.? T&. T& (vstd!set.impl&%0.union.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1! (Poly%fun%1. f!)) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s2! (Poly%fun%1. f!))) x$) (vstd!set.impl&%0.contains.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& (vstd!set.impl&%0.union.? S&. S& s1! s2!) (Poly%fun%1. f!)) x$))) :pattern ((vstd!set.impl&%0.contains.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& (vstd!set.impl&%0.union.? S&. S& s1! s2!) (Poly%fun%1. f!)) x$)))) (=> (= tmp%3 (ext_eq false (TYPE%vstd!set.Set. T&. T&) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& (vstd!set.impl&%0.union.? S&. S& s1! s2!) (Poly%fun%1. f!)) (vstd!set.impl&%0.union.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1! (Poly%fun%1. f!)) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s2! (Poly%fun%1. f!))))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> %%location_label%%4 (= (vstd!set_lib.impl&%0.map.? S&. S& T&. T& (vstd!set.impl&%0.union.? S&. S& s1! s2!) (Poly%fun%1. f!)) (vstd!set.impl&%0.union.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1! (Poly%fun%1. f!)) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s2! (Poly%fun%1. f!))))))))))))
(check-sat)
(exit)
