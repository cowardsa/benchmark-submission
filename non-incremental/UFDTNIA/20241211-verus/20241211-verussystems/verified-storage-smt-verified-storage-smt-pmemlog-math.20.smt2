...
(assert (not (=> (= decrease%init0 x!) (=> (fuel_bool fuel%main!math.mul_pos.) (or (and (=> (> x! 0) (=> (= tmp%1 (Sub x! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((x!$0 tmp%1) (y!$1 y!)) x!$0) decrease%init0 false)) (and (=> %%location_label%%1 (req%main!math.lemma_mul_is_mul_pos. tmp%1 y!)) (=> (ens%main!math.lemma_mul_is_mul_pos. tmp%1 y!) (=> (= tmp%2 (Sub x! 1)) (=> (ens%main!math.lemma_mul_is_distributive_add_other_way. y! tmp%2 1) (=> (= tmp%3 (= (Mul x! y!) (Add (Mul (Sub x! 1) y!) y!))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%0)))))))))) (=> (not (> x! 0)) (=> (= tmp%4 (= x! 0)) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (= (Mul x! y!) 0)) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 %%switch_label%%0)))))))) (and (not %%switch_label%%0) (=> %%location_label%%5 (= (Mul x! y!) (main!math.mul_pos.? (I x!) (I y!))))))))))
(check-sat)
(exit)
