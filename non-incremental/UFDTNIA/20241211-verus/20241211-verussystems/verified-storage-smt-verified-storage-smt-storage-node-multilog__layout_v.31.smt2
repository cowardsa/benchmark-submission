...
(declare-const recovered_mems@ vstd!seq.Seq<core!option.Option<lib!multilog.multilogspec_t.AbstractLogState.>.>.)
...
(assert (not (and (=> (has_type i@ INT) (=> (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!)))) (=> (= cdb@ (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!multilog.layout_v.recover_cdb.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) (I 0)))))))) (=> (= recovered_mems@ (%Poly%vstd!seq.Seq<core!option.Option<lib!multilog.multilogspec_t.AbstractLogState.>.>. (vstd!seq_lib.impl&%0.map.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) $ (TYPE%core!option.Option. $ TYPE%lib!multilog.multilogspec_t.AbstractLogState.) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) (Poly%fun%2. (mk_fun (%%lambda%%4 (I multilog_id!) (I (vstd!seq.Seq.len.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!))) (B cdb@))))))) (=> (= tmp%1 (is-core!option.Option./Some_ (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!multilog.multilogspec_t.AbstractLogState.) (Poly%vstd!seq.Seq<core!option.Option<lib!multilog.multilogspec_t.AbstractLogState.>.>. recovered_mems@) i@)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (>= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) i@)) (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!multilog.layout_v.MIN_LOG_AREA_SIZE.?)))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!)))) (>= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) i$)) (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!multilog.layout_v.MIN_LOG_AREA_SIZE.?)))) :pattern ((vstd!seq.Seq.len.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) i$))))) (=> %%location_label%%2 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!)))) (>= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) i$)) (Add lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!multilog.layout_v.MIN_LOG_AREA_SIZE.?)))) :pattern ((vstd!seq.Seq.len.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mems!) i$))))))))))
(check-sat)
(exit)
