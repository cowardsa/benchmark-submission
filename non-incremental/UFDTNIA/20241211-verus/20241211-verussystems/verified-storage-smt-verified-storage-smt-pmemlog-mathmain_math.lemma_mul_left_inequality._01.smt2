...
(set-info :comment ";; src/math.rs:199:5: 199:67 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_left_inequality")
(set-info :comment ";; src/math.rs:199:5: 199:67 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (not (=> (= decrease%init0 x!) (or (and (=> (> x! 1) (=> (= tmp%1 (Sub x! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((x!$0 tmp%1) (y!$1 y!) (z!$2 z!)) x!$0) decrease%init0 false)) (and (=> %%location_label%%1 (req%main!math.lemma_mul_left_inequality. tmp%1 y! z!)) (=> (ens%main!math.lemma_mul_left_inequality. tmp%1 y! z!) (=> (= tmp%2 (= (Mul x! y!) (Add (Mul (Sub x! 1) y!) y!))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (= tmp%3 (= (Mul x! z!) (Add (Mul (Sub x! 1) z!) z!))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 %%switch_label%%0))))))))))) (=> (not (> x! 1)) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%4 (=> (<= y! z!) (<= (Mul x! y!) (Mul x! z!)))) (=> %%location_label%%5 (=> (< y! z!) (< (Mul x! y!) (Mul x! z!))))))))))
(check-sat)
(exit)
