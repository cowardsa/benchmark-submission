...
(assert (not (and (=> %%location_label%%0 (req%main!math.lemma_mul_inequality. x! x_bound! y!)) (=> (ens%main!math.lemma_mul_inequality. x! x_bound! y!) (and (=> %%location_label%%1 (req%main!math.lemma_mul_inequality. y! y_bound! x_bound!)) (=> (ens%main!math.lemma_mul_inequality. y! y_bound! x_bound!) (=> %%location_label%%2 (<= (Mul x! y!) (Mul x_bound! y_bound!)))))))))
(check-sat)
(exit)
