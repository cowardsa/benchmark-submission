...
(set-info :comment ";; src/math.rs:13:5: 13:61 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_strictly_positive")
(set-info :comment ";; src/math.rs:13:5: 13:61 (#0)")
(declare-const x! Int)
(declare-const y! Int)
...
(assert (not (=> %%location_label%%0 (=> (and (< 0 x!) (< 0 y!)) (< 0 (Mul x! y!))))))
(check-sat)
(exit)
