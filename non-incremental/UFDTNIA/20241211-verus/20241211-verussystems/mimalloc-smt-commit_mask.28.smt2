...
(assert (not (=> (= i@0 0) (and (=> %%location_label%%0 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@0))))) j$)) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@0))))) j$))))) (=> (has_type (Poly%lib!commit_mask.CommitMask. self!@1) TYPE%lib!commit_mask.CommitMask.) (=> (uInv SZ i@1) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@1))))) j$)) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@1))))) j$)))) (=> (not (< i@1 8)) (=> (ens%lib!commit_mask.lemma_is_bit_set. 0) (=> (ens%lib!commit_mask.impl&%0.lemma_view. self!@1) (=> (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!@1))) (vstd!set.impl&%0.empty.? $ INT))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (= (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!@1)) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.empty.? $ INT)))))))))))))))))
(check-sat)
(exit)
