...
(assert (uInv SZ block_size!))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; possible arithmetic underflow/overflow")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (or (and (=> (and (>= block_size! 8) (<= block_size! 1024)) (and (=> %%location_label%%0 (uInv 32 (Mul 3 (uClip 32 lib!config.MAX_ALIGN_GUARANTEE.?)))) (=> (= tmp%1 (uClip 32 (Mul 3 (uClip 32 lib!config.MAX_ALIGN_GUARANTEE.?)))) %%switch_label%%0))) (=> (not (and (>= block_size! 8) (<= block_size! 1024))) (=> (= tmp%1 0) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= res! tmp%1) (=> %%location_label%%1 (= res! (lib!layout.start_offset.? (I block_size!)))))))))
(check-sat)
(exit)
