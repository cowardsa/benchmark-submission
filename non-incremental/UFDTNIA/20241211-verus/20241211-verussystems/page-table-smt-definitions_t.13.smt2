...
(assert (not (=> (lib!definitions_t.impl&%8.inv.? self!) (=> (< (%I layer!) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!))))) (and (=> %%location_label%%0 (req%lib!definitions_t.impl&%8.num_entries. self! layer!)) (=> (= tmp%1 (lib!definitions_t.impl&%8.num_entries.? self! layer!)) (=> %%location_label%%1 (req%lib!definitions_t.impl&%8.entry_base. self! layer! base! (I tmp%1)))))))))
(check-sat)
(exit)
