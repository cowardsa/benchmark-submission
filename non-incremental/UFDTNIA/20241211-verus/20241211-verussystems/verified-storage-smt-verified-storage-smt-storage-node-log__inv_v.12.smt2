...
(set-info :comment ";; MODULE 'module log::inv_v'")
...
(set-info :comment ";; Function-Decl lib::log::inv_v::memory_matches_cdb")
...
(set-info :comment ";; Function-Axioms lib::log::inv_v::memory_matches_cdb")
...
(set-info :comment ";; Function-Specs lib::log::inv_v::lemma_addresses_in_log_area_subregion_correspond_to_relative_log_positions")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_addresses_in_log_area_subregion_correspond_to_relative_log_positions")
(set-info :comment ";; src/log/inv_v.rs:318:5: 321:6 (#0)")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_metadata_consistent_with_info_after_cdb_update")
(set-info :comment ";; src/log/inv_v.rs:177:5: 184:6 (#0)")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_addresses_in_log_area_correspond_to_relative_log_positions")
(set-info :comment ";; src/log/inv_v.rs:353:5: 356:6 (#0)")
...
(set-info :comment ";; Function-Specs lib::log::inv_v::lemma_invariants_imply_crash_recover_for_one_log")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_invariants_imply_crash_recover_for_one_log")
(set-info :comment ";; src/log/inv_v.rs:392:11: 399:6 (#0)")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_metadata_set_after_crash")
(set-info :comment ";; src/log/inv_v.rs:855:5: 858:6 (#0)")
(set-info :comment ";; Function-Specs lib::log::inv_v::lemma_invariants_imply_crash_recover")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_invariants_imply_crash_recover")
(set-info :comment ";; src/log/inv_v.rs:448:11: 455:6 (#0)")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_invariants_imply_crash_recover_forall")
(set-info :comment ";; src/log/inv_v.rs:519:5: 525:6 (#0)")
(set-info :comment ";; Function-Specs lib::log::inv_v::lemma_smaller_range_of_seq_is_subrange")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_smaller_range_of_seq_is_subrange")
(set-info :comment ";; src/log/inv_v.rs:993:5: 993:103 (#0)")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_auto_smaller_range_of_seq_is_subrange")
(set-info :comment ";; src/log/inv_v.rs:984:5: 984:76 (#0)")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_active_metadata_bytes_equal_implies_metadata_types_set")
(set-info :comment ";; src/log/inv_v.rs:931:5: 935:6 (#0)")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_metadata_matches_implies_metadata_types_set")
(set-info :comment ";; src/log/inv_v.rs:909:5: 913:6 (#0)")
(set-info :comment ";; Function-Specs lib::log::inv_v::lemma_updating_inactive_metadata_maintains_invariants")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_updating_inactive_metadata_maintains_invariants")
(set-info :comment ";; src/log/inv_v.rs:560:5: 567:6 (#0)")
...
(declare-const info! lib!log.logimpl_v.LogInfo.)
...
(declare-const pm_region_view2@ lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
(declare-const mem@ vstd!seq.Seq<u8.>.)
(declare-const global_metadata@ lib!log.layout_v.GlobalMetadata.)
(declare-const global_crc@ Int)
(declare-const region_metadata@ lib!log.layout_v.RegionMetadata.)
(declare-const region_crc@ Int)
(declare-const log_metadata@ lib!log.layout_v.LogMetadata.)
(declare-const log_crc@ Int)
(declare-const mem2@ vstd!seq.Seq<u8.>.)
(declare-const global_metadata2@ lib!log.layout_v.GlobalMetadata.)
(declare-const global_crc2@ Int)
(declare-const region_metadata2@ lib!log.layout_v.RegionMetadata.)
(declare-const region_crc2@ Int)
(declare-const log_metadata2@ lib!log.layout_v.LogMetadata.)
(declare-const log_crc2@ Int)
(declare-const global_metadata_bytes1@ vstd!seq.Seq<u8.>.)
(declare-const global_metadata_bytes2@ vstd!seq.Seq<u8.>.)
(assert fuel_defaults)
(assert (uInv 128 log_id!))
(assert (has_type (Poly%lib!log.logimpl_v.LogInfo. info!) TYPE%lib!log.logimpl_v.LogInfo.))
(assert (lib!log.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (B cdb!)))
(assert (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (I log_id!) (B cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!)))
(assert (lib!log.inv_v.info_consistent_with_log_area_in_region.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (Poly%lib!log.logimpl_v.LogInfo. info!) (Poly%lib!log.logspec_t.AbstractLogState. state!)))
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.))))
(assert (lib!log.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!)))))
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (= pm_region_view2@ (lib!pmem.pmemspec_t.impl&%6.write.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (I (lib!log.layout_v.get_log_metadata_pos.? (B (not cdb!)))) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!))) (and (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!log.layout_v.extract_log_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@))))) (Poly%vstd!seq.Seq<u8.>. (lib!log.layout_v.extract_log_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (lib!log.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@) (B cdb!)))))) (=> (lib!log.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@) (B cdb!)) (=> (= tmp%2 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (= tmp%3 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@))) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. tmp%2 tmp%3) (=> (= mem@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (= global_metadata@ (lib!log.layout_v.deserialize_global_metadata.? (Poly%vstd!seq.Seq<u8.>. mem@))) (=> (= global_crc@ (lib!log.layout_v.deserialize_global_crc.? (Poly%vstd!seq.Seq<u8.>. mem@))) (=> (= region_metadata@ (lib!log.layout_v.deserialize_region_metadata.? (Poly%vstd!seq.Seq<u8.>. mem@))) (=> (= region_crc@ (lib!log.layout_v.deserialize_region_crc.? (Poly%vstd!seq.Seq<u8.>. mem@))) (=> (= log_metadata@ (lib!log.layout_v.deserialize_log_metadata.? (Poly%vstd!seq.Seq<u8.>. mem@) (B cdb!))) (=> (= log_crc@ (lib!log.layout_v.deserialize_log_crc.? (Poly%vstd!seq.Seq<u8.>. mem@) (B cdb!))) (=> (= mem2@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@))) (=> (= global_metadata2@ (lib!log.layout_v.deserialize_global_metadata.? (Poly%vstd!seq.Seq<u8.>. mem2@))) (=> (= global_crc2@ (lib!log.layout_v.deserialize_global_crc.? (Poly%vstd!seq.Seq<u8.>. mem2@))) (=> (= region_metadata2@ (lib!log.layout_v.deserialize_region_metadata.? (Poly%vstd!seq.Seq<u8.>. mem2@))) (=> (= region_crc2@ (lib!log.layout_v.deserialize_region_crc.? (Poly%vstd!seq.Seq<u8.>. mem2@))) (=> (= log_metadata2@ (lib!log.layout_v.deserialize_log_metadata.? (Poly%vstd!seq.Seq<u8.>. mem2@) (B cdb!))) (=> (= log_crc2@ (lib!log.layout_v.deserialize_log_crc.? (Poly%vstd!seq.Seq<u8.>. mem2@) (B cdb!))) (=> (= global_metadata_bytes1@ (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.GlobalMetadata.))) (=> (= global_metadata_bytes2@ (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2@) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.GlobalMetadata.))) (and (=> (= tmp%4 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (= tmp%5 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@))) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. tmp%4 tmp%5) (=> %%location_label%%2 (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@) (I log_id!) (B cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!)))))) (=> (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@) (I log_id!) (B cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!)) (=> (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem2@) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)))) (and (=> %%location_label%%3 tmp%6) (=> tmp%6 (or (and (=> cdb! (=> (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_TRUE.?) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_TRUE.?) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))))) (and (=> %%location_label%%4 tmp%7) (=> tmp%7 %%switch_label%%0)))) (=> (not cdb!) (=> (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))))) (and (=> %%location_label%%5 tmp%8) (=> tmp%8 %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= tmp%9 (lib!log.inv_v.active_metadata_bytes_are_equal.? (Poly%vstd!seq.Seq<u8.>. mem@) (Poly%vstd!seq.Seq<u8.>. mem2@))) (and (=> %%location_label%%6 tmp%9) (=> tmp%9 (and (=> %%location_label%%7 (req%lib!log.inv_v.lemma_metadata_matches_implies_metadata_types_set. pm_region_view! pm_region_view2@ cdb!)) (=> (ens%lib!log.inv_v.lemma_metadata_matches_implies_metadata_types_set. pm_region_view! pm_region_view2@ cdb!) (=> %%location_label%%8 (let ((pm_region_view2$ (lib!pmem.pmemspec_t.impl&%6.write.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (I (lib!log.layout_v.get_log_metadata_pos.? (B (not cdb!)))) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)))) (and (and (and (lib!log.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2$) (B cdb!)) (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2$) (I log_id!) (B cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!))) (lib!log.inv_v.info_consistent_with_log_area_in_region.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2$) (Poly%lib!log.logimpl_v.LogInfo. info!) (Poly%lib!log.logspec_t.AbstractLogState. state!))) (lib!log.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2$))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
