...
(declare-const residual$1@ core!result.Result.)
(declare-const tmp%%$1@ core!ops.control_flow.ControlFlow.)
(declare-const tmp%5 lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
...
(assert (= (lib!log.logimpl_v.impl&%1.recover.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.wrpm_t.impl&%1.view.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@0)))))) (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. state!))))
(assert (lib!pmem.wrpm_t.impl&%1.inv.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@0))
(assert (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (= (%B (lib!pmem.wrpm_t.CheckPermission.check_permission.? $ TYPE%lib!log.logimpl_t.TrustedPermission. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%lib!log.logimpl_t.TrustedPermission. perm!) s$)) (= (lib!log.logimpl_v.impl&%1.recover.? s$ (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. state!))))) :pattern ((lib!pmem.wrpm_t.CheckPermission.check_permission.? $ TYPE%lib!log.logimpl_t.TrustedPermission. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%lib!log.logimpl_t.TrustedPermission. perm!) s$)))))
...
(assert (not (and (=> %%location_label%%0 (req%lib!pmem.wrpm_t.impl&%1.flush. $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@0)) (=> (has_type wrpm_region!@1 (TYPE%lib!pmem.wrpm_t.WriteRestrictedPersistentMemoryRegion. $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion&)) (=> (ens%lib!pmem.wrpm_t.impl&%1.flush. $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@0 wrpm_region!@1) (and (=> %%location_label%%1 (req%lib!pmem.wrpm_t.impl&%1.get_pm_region_ref. $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1)) (=> (ens%lib!pmem.wrpm_t.impl&%1.get_pm_region_ref. $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1 pm_region@) (and (=> %%location_label%%2 (req%lib!log.start_v.read_cdb. PMRegion&. PMRegion& pm_region@)) (=> (ens%lib!log.start_v.read_cdb. PMRegion&. PMRegion& pm_region@ tmp%1) (=> (ens%core!result.impl&%26.branch. $ BOOL $ TYPE%lib!log.logimpl_t.LogErr. tmp%1 tmp%%@) (or (and (=> (is-core!ops.control_flow.ControlFlow./Break_ tmp%%@) (=> (= residual@ (%Poly%core!result.Result. (core!ops.control_flow.ControlFlow./Break/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@))))) (=> (ens%core!result.impl&%27.from_residual. $ TYPE%lib!log.logimpl_v.UntrustedLogImpl. $ TYPE%lib!log.logimpl_t.LogErr. $ TYPE%lib!log.logimpl_t.LogErr. residual@ tmp%2) (=> (= result! tmp%2) (and (=> %%location_label%%3 (lib!pmem.wrpm_t.impl&%1.inv.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1)) (and (=> %%location_label%%4 (= (lib!pmem.wrpm_t.impl&%1.constants.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1) (lib!pmem.wrpm_t.impl&%1.constants.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@0))) (=> %%location_label%%5 (ite (is-core!result.Result./Ok_ result!) (let ((log_impl$ (%Poly%lib!log.logimpl_v.UntrustedLogImpl. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (and (and (lib!log.logimpl_v.impl&%1.inv.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& (Poly%lib!log.logimpl_v.UntrustedLogImpl. log_impl$) wrpm_region!@1 (I log_id!)) (= (lib!log.logimpl_v.impl&%1.view.? (Poly%lib!log.logimpl_v.UntrustedLogImpl. log_impl$)) state!)) (lib!log.logimpl_t.can_only_crash_as_state.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.wrpm_t.impl&%1.view.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1)) (I log_id!) (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!)))))) (ite (and (is-core!result.Result./Err_ result!) (is-lib!log.logimpl_t.LogErr./CRCMismatch_ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.wrpm_t.impl&%1.constants.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1))))) (let ((e$ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= e$ (lib!log.logimpl_t.LogErr./PmemErr (%Poly%lib!pmem.pmemspec_t.PmemError. (Poly%lib!pmem.pmemspec_t.PmemError. lib!pmem.pmemspec_t.PmemError./AccessOutOfRange)))))))))))))) (=> (not (is-core!ops.control_flow.ControlFlow./Break_ tmp%%@)) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (= cdb@ (let ((val$ (%B (core!ops.control_flow.ControlFlow./Continue/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@)))))) val$)) (and (=> %%location_label%%6 (req%lib!log.start_v.read_log_variables. PMRegion&. PMRegion& pm_region@ log_id! cdb@)) (=> (ens%lib!log.start_v.read_log_variables. PMRegion&. PMRegion& pm_region@ log_id! cdb@ tmp%3) (=> (ens%core!result.impl&%26.branch. $ TYPE%lib!log.logimpl_v.LogInfo. $ TYPE%lib!log.logimpl_t.LogErr. tmp%3 tmp%%$1@) (or (and (=> (is-core!ops.control_flow.ControlFlow./Break_ tmp%%$1@) (=> (= residual$1@ (%Poly%core!result.Result. (core!ops.control_flow.ControlFlow./Break/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%$1@))))) (=> (ens%core!result.impl&%27.from_residual. $ TYPE%lib!log.logimpl_v.UntrustedLogImpl. $ TYPE%lib!log.logimpl_t.LogErr. $ TYPE%lib!log.logimpl_t.LogErr. residual$1@ tmp%4) (=> (= result! tmp%4) (and (=> %%location_label%%7 (lib!pmem.wrpm_t.impl&%1.inv.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1)) (and (=> %%location_label%%8 (= (lib!pmem.wrpm_t.impl&%1.constants.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1) (lib!pmem.wrpm_t.impl&%1.constants.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@0))) (=> %%location_label%%9 (ite (is-core!result.Result./Ok_ result!) (let ((log_impl$ (%Poly%lib!log.logimpl_v.UntrustedLogImpl. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (and (and (lib!log.logimpl_v.impl&%1.inv.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& (Poly%lib!log.logimpl_v.UntrustedLogImpl. log_impl$) wrpm_region!@1 (I log_id!)) (= (lib!log.logimpl_v.impl&%1.view.? (Poly%lib!log.logimpl_v.UntrustedLogImpl. log_impl$)) state!)) (lib!log.logimpl_t.can_only_crash_as_state.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.wrpm_t.impl&%1.view.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1)) (I log_id!) (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!)))))) (ite (and (is-core!result.Result./Err_ result!) (is-lib!log.logimpl_t.LogErr./CRCMismatch_ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.wrpm_t.impl&%1.constants.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1))))) (let ((e$ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= e$ (lib!log.logimpl_t.LogErr./PmemErr (%Poly%lib!pmem.pmemspec_t.PmemError. (Poly%lib!pmem.pmemspec_t.PmemError. lib!pmem.pmemspec_t.PmemError./AccessOutOfRange)))))))))))))) (=> (not (is-core!ops.control_flow.ControlFlow./Break_ tmp%%$1@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= info@ (let ((val$ (%Poly%lib!log.logimpl_v.LogInfo. (core!ops.control_flow.ControlFlow./Continue/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%$1@)))))) val$)) (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (= tmp%5 (%Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region@))) (and (=> %%location_label%%10 (req%lib!log.inv_v.lemma_invariants_imply_crash_recover_forall. tmp%5 log_id! cdb@ info@ state!)) (=> (ens%lib!log.inv_v.lemma_invariants_imply_crash_recover_forall. tmp%5 log_id! cdb@ info@ state!) (=> (= tmp%6 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.wrpm_t.impl&%1.view.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1)))) (and (=> %%location_label%%11 (req%lib!log.layout_v.lemma_recovered_state_is_crash_idempotent. tmp%6 log_id!)) (=> (ens%lib!log.layout_v.lemma_recovered_state_is_crash_idempotent. tmp%6 log_id!) (=> (= tmp%7 (lib!log.inv_v.no_outstanding_writes_to_metadata.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region@))) (and (=> %%location_label%%12 tmp%7) (=> tmp%7 (=> (= tmp%8 (%Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region@))) (and (=> %%location_label%%13 (req%lib!log.inv_v.lemma_metadata_set_after_crash. tmp%8 cdb@)) (=> (ens%lib!log.inv_v.lemma_metadata_set_after_crash. tmp%8 cdb@) (=> (= result! (core!result.Result./Ok (Poly%lib!log.logimpl_v.UntrustedLogImpl. (lib!log.logimpl_v.UntrustedLogImpl./UntrustedLogImpl (%B (B cdb@)) (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info@)) (%Poly%lib!log.logspec_t.AbstractLogState. (Poly%lib!log.logspec_t.AbstractLogState. state!)))))) (and (=> %%location_label%%14 (lib!pmem.wrpm_t.impl&%1.inv.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1)) (and (=> %%location_label%%15 (= (lib!pmem.wrpm_t.impl&%1.constants.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1) (lib!pmem.wrpm_t.impl&%1.constants.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@0))) (=> %%location_label%%16 (ite (is-core!result.Result./Ok_ result!) (let ((log_impl$ (%Poly%lib!log.logimpl_v.UntrustedLogImpl. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (and (and (lib!log.logimpl_v.impl&%1.inv.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& (Poly%lib!log.logimpl_v.UntrustedLogImpl. log_impl$) wrpm_region!@1 (I log_id!)) (= (lib!log.logimpl_v.impl&%1.view.? (Poly%lib!log.logimpl_v.UntrustedLogImpl. log_impl$)) state!)) (lib!log.logimpl_t.can_only_crash_as_state.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.wrpm_t.impl&%1.view.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1)) (I log_id!) (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!)))))) (ite (and (is-core!result.Result./Err_ result!) (is-lib!log.logimpl_t.LogErr./CRCMismatch_ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (not (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.wrpm_t.impl&%1.constants.? $ TYPE%lib!log.logimpl_t.TrustedPermission. PMRegion&. PMRegion& wrpm_region!@1))))) (let ((e$ (%Poly%lib!log.logimpl_t.LogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= e$ (lib!log.logimpl_t.LogErr./PmemErr (%Poly%lib!pmem.pmemspec_t.PmemError. (Poly%lib!pmem.pmemspec_t.PmemError. lib!pmem.pmemspec_t.PmemError./AccessOutOfRange)))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
