...
(set-info :comment ";; Function-Specs lib::bin_sizes::result_sbin_bounds")
(declare-fun ens%lib!bin_sizes.result_sbin_bounds. (Int Int) Bool)
(assert (forall ((size_start! Int) (size_end! Int)) (! (= (ens%lib!bin_sizes.result_sbin_bounds. size_start! size_end!) (=> (lib!bin_sizes.check_sbin_bounds.? (I size_start!) (I size_end!)) (forall ((size$ Poly)) (! (=> (has_type size$ INT) (=> (and (<= size_start! (%I size$)) (< (%I size$) size_end!)) (lib!bin_sizes.property_sbin_bounds.? size$))) :pattern ((lib!bin_sizes.property_sbin_bounds.? size$)))))) :pattern ((ens%lib!bin_sizes.result_sbin_bounds. size_start! size_end!)))))
(set-info :comment ";; Function-Def lib::bin_sizes::result_sbin_bounds")
(set-info :comment ";; bin_sizes.rs:1270:7: 1270:58 (#0)")
(set-info :comment ";; Function-Specs lib::bin_sizes::result_sbin")
(declare-fun ens%lib!bin_sizes.result_sbin. (Int Int) Bool)
(assert (forall ((size_start! Int) (size_end! Int)) (! (= (ens%lib!bin_sizes.result_sbin. size_start! size_end!) (=> (lib!bin_sizes.check_sbin.? (I size_start!) (I size_end!)) (forall ((size$ Poly)) (! (=> (has_type size$ INT) (=> (and (<= size_start! (%I size$)) (< (%I size$) size_end!)) (lib!bin_sizes.property_sbin.? size$))) :pattern ((lib!bin_sizes.property_sbin.? size$)))))) :pattern ((ens%lib!bin_sizes.result_sbin. size_start! size_end!)))))
(set-info :comment ";; Function-Def lib::bin_sizes::result_sbin")
(set-info :comment ";; bin_sizes.rs:1302:7: 1302:51 (#0)")
...
(assert (not (=> (= decrease%init0 (Sub size_end! size_start!)) (or (and (=> (>= size_start! size_end!) %%switch_label%%0) (=> (not (>= size_start! size_end!)) (=> (= tmp%1 (Add size_start! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((size_start!$0 tmp%1) (size_end!$1 size_end!)) (Sub size_end!$1 size_start!$0)) decrease%init0 false)) (=> (ens%lib!bin_sizes.result_sbin. tmp%1 size_end!) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%1 (=> (lib!bin_sizes.check_sbin.? (I size_start!) (I size_end!)) (forall ((size$ Poly)) (! (=> (has_type size$ INT) (=> (and (<= size_start! (%I size$)) (< (%I size$) size_end!)) (lib!bin_sizes.property_sbin.? size$))) :pattern ((lib!bin_sizes.property_sbin.? size$)))))))))))
(check-sat)
(exit)
