...
(assert (not (=> (fuel_bool fuel%lib!bin_sizes.size_of_bin.) (or (and (=> (and (<= 1 bin_idx!) (<= bin_idx! 8)) (=> (= tmp%1 (= (lib!bin_sizes.size_of_bin.? (I bin_idx!)) (nClip (Mul (uClip 32 (EucDiv SZ 8)) (nClip bin_idx!))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (= (lib!bin_sizes.size_of_bin.? (I bin_idx!)) (nClip (Mul 8 (nClip bin_idx!))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (= (lib!bin_sizes.size_of_bin.? (I bin_idx!)) (Mul 8 bin_idx!))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (and (=> %%location_label%%3 true) (=> (= (EucMod (Mul 8 bin_idx!) 8) 0) %%switch_label%%0)))))))))))) (=> (not (and (<= 1 bin_idx!) (<= bin_idx! 8))) (or (and (=> (= bin_idx! lib!config.BIN_HUGE.?) %%switch_label%%1) (=> (not (= bin_idx! lib!config.BIN_HUGE.?)) (=> (= group@ (EucDiv (Sub bin_idx! 9) 4)) (=> (= inner@ (EucMod (Sub bin_idx! 9) 4)) (=> (= tmp%4 (= (lib!bin_sizes.size_of_bin.? (I bin_idx!)) (nClip (Mul (Mul (uClip 32 (EucDiv SZ 8)) (Add inner@ 5)) (lib!bin_sizes.pow2.? (I (Add group@ 1))))))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (=> (= tmp%5 (= (lib!bin_sizes.size_of_bin.? (I bin_idx!)) (nClip (Mul (Mul 8 (Add inner@ 5)) (lib!bin_sizes.pow2.? (I (Add group@ 1))))))) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 (=> (= tmp%6 (= (lib!bin_sizes.size_of_bin.? (I bin_idx!)) (Mul (Mul 8 (Add inner@ 5)) (lib!bin_sizes.pow2.? (I (Add group@ 1)))))) (and (=> %%location_label%%6 tmp%6) (=> tmp%6 (=> (= sum@ (Add inner@ 5)) (=> (= product@ (Mul sum@ (lib!bin_sizes.pow2.? (I (Add group@ 1))))) (and (=> %%location_label%%7 true) (=> (let ((s$ (Add inner@ 5))) (let ((p$ (Mul s$ (lib!bin_sizes.pow2.? (I (Add group@ 1)))))) (= (Mul (Mul 8 (Add inner@ 5)) (lib!bin_sizes.pow2.? (I (Add group@ 1)))) (Mul 8 p$)))) (=> (= tmp%7 (= (lib!bin_sizes.size_of_bin.? (I bin_idx!)) (Mul 8 product@))) (and (=> %%location_label%%8 tmp%7) (=> tmp%7 (=> (= tmp%8 (Mul 8 product@)) (and (=> %%location_label%%9 (req%lib!bin_sizes.mod8. tmp%8 product@)) (=> (ens%lib!bin_sizes.mod8. tmp%8 product@) %%switch_label%%1))))))))))))))))))))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%10 (= (nClip (EucMod (lib!bin_sizes.size_of_bin.? (I bin_idx!)) 8)) 0)))))))
(check-sat)
(exit)
