...
(declare-const v1! lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
(declare-const v2! lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
(declare-const crash_state! vstd!seq.Seq<u8.>.)
...
(declare-const is_writable_absolute_addr! %%Function%%)
...
(assert (has_type (Poly%fun%1. is_writable_absolute_addr!) (TYPE%fun%1. $ INT $ BOOL)))
(assert (lib!log.inv_v.no_outstanding_writes_to_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!)))
(assert (lib!log.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!) (B cdb!)))
(assert (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!) (I log_id!) (B cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!)))
(assert (lib!log.inv_v.info_consistent_with_log_area_in_region.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!) (Poly%lib!log.logimpl_v.LogInfo. info!) (Poly%lib!log.logspec_t.AbstractLogState. state!)))
(assert (<= (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? (lib!log.logimpl_v.LogInfo./LogInfo/log_area_len (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!))))
(assert (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v2!) (Poly%vstd!seq.Seq<u8.>. crash_state!)))
(assert (= (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!)) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v2!))))
(assert (forall ((addr$ Poly)) (! (=> (has_type addr$ INT) (= (%B (%%apply%%0 is_writable_absolute_addr! addr$)) (lib!log.inv_v.log_area_offset_unreachable_during_recovery.? (I (lib!log.logimpl_v.LogInfo./LogInfo/head_log_area_offset (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))) (I (lib!log.logimpl_v.LogInfo./LogInfo/log_area_len (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))) (I (lib!log.logimpl_v.LogInfo./LogInfo/log_length (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))) (I (Sub (%I addr$) lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?))))) :pattern ((%%apply%%0 is_writable_absolute_addr! addr$)))))
(assert (lib!pmem.subregion_v.views_differ_only_where_subregion_allows.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!) (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v2!) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?) (I (lib!log.logimpl_v.LogInfo./LogInfo/log_area_len (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))) (Poly%fun%1. is_writable_absolute_addr!)))
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (ens%lib!pmem.pmemutil_v.lemma_wherever_no_outstanding_writes_persistent_memory_view_can_only_crash_as_committed. v2!) (=> (= tmp%1 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!))) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. crash_state! tmp%1) (=> (= tmp%2 (ext_eq false (TYPE%core!option.Option. $ TYPE%lib!log.logspec_t.AbstractLogState.) (Poly%core!option.Option. (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. crash_state!) (I log_id!))) (Poly%core!option.Option. (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!))) (I log_id!))))) (and (=> %%location_label%%0 tmp%2) (=> tmp%2 (and (=> %%location_label%%1 (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!))))) (=> %%location_label%%2 (= (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. crash_state!) (I log_id!)) (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. v1!))) (I log_id!))))))))))))))
(check-sat)
(exit)
