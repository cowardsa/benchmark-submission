...
(assert (and (<= (lib!bin_sizes.pfd_lower.? (I bin_idx!)) wsize!) (<= wsize! (lib!bin_sizes.pfd_upper.? (I bin_idx!)))))
(assert (<= wsize! 128))
...
(assert (not (=> (ens%lib!bin_sizes.lemma_bin_sizes_constants. 0) (=> (= tmp%1 (= lib!config.INTPTR_SIZE.? 8)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> %%location_label%%1 true) (=> (= (uClip 32 (EucDiv SZ 8)) 8) (and (=> %%location_label%%2 true) (=> (= (EucDiv (Sub (Add (Mul wsize! 8) 8) 1) 8) wsize!) (or (and (=> (<= wsize! 1) %%switch_label%%0) (=> (not (<= wsize! 1)) (or (and (=> (<= wsize! 8) %%switch_label%%1) (=> (not (<= wsize! 8)) (or (and (=> (> wsize! 524288) %%switch_label%%2) (=> (not (> wsize! 524288)) (=> (= tmp%2 (and (< 8 wsize!) (<= wsize! 128))) (and (=> %%location_label%%3 tmp%2) (=> tmp%2 (=> (lib!bin_sizes.check2_idx_in_range_has_bin_size.? (I 1) (I 74) (I 9) (I 129)) (=> (ens%lib!bin_sizes.result2_idx_in_range_has_bin_size. 1 74 9 129) (=> (= tmp%3 (lib!bin_sizes.property_idx_in_range_has_bin_size.? (I bin_idx!) (I wsize!))) (and (=> %%location_label%%4 tmp%3) (=> tmp%3 %%switch_label%%2)))))))))) (and (not %%switch_label%%2) %%switch_label%%1)))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%5 (= (lib!bin_sizes.smallest_bin_fitting_size.? (I (Mul wsize! lib!config.INTPTR_SIZE.?))) bin_idx!))))))))))))))
(check-sat)
(exit)
