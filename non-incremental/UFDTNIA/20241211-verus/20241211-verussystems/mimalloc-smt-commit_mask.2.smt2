...
(assert (not (and (=> (has_type s1@ (TYPE%vstd!set.Set. S&. S&)) (=> (has_type s2@ (TYPE%vstd!set.Set. S&. S&)) (=> (has_type f@ (TYPE%fun%1. S&. S& T&. T&)) (=> (ens%lib!commit_mask.lemma_map_distribute. S&. S& T&. T& s1@ s2@ (%Poly%fun%1. f@)) (=> %%location_label%%0 (= (vstd!set_lib.impl&%0.map.? S&. S& T&. T& (vstd!set.impl&%0.union.? S&. S& s1@ s2@) f@) (vstd!set.impl&%0.union.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1@ f@) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s2@ f@)))))))) (=> (forall ((s1$ Poly) (s2$ Poly) (f$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!set.Set. S&. S&)) (has_type s2$ (TYPE%vstd!set.Set. S&. S&)) (has_type f$ (TYPE%fun%1. S&. S& T&. T&))) (= (vstd!set_lib.impl&%0.map.? S&. S& T&. T& (vstd!set.impl&%0.union.? S&. S& s1$ s2$) f$) (vstd!set.impl&%0.union.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1$ f$) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s2$ f$)))) :pattern ((vstd!set.impl&%0.union.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1$ f$) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s2$ f$))))) (=> %%location_label%%1 (forall ((s1$ Poly) (s2$ Poly) (f$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!set.Set. S&. S&)) (has_type s2$ (TYPE%vstd!set.Set. S&. S&)) (has_type f$ (TYPE%fun%1. S&. S& T&. T&))) (= (vstd!set_lib.impl&%0.map.? S&. S& T&. T& (vstd!set.impl&%0.union.? S&. S& s1$ s2$) f$) (vstd!set.impl&%0.union.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1$ f$) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s2$ f$)))) :pattern ((vstd!set.impl&%0.union.? T&. T& (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s1$ f$) (vstd!set_lib.impl&%0.map.? S&. S& T&. T& s2$ f$))))))))))
(check-sat)
(exit)
