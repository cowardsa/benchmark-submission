...
(set-info :comment ";; Function-Specs main::pmemmock_t::VolatileMemoryMockingPersistentMemory::new")
...
(set-info :comment ";; Function-Def main::main")
(set-info :comment ";; src/main.rs:21:5: 21:14 (#0)")
