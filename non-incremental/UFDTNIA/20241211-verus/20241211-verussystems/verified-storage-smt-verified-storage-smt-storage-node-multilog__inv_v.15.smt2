...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (= pm_regions_view2@ (lib!pmem.pmemspec_t.impl&%7.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!))) (and (=> (= tmp%1 (lib!multilog.inv_v.log_index_trigger.? (I 0))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!multilog.layout_v.extract_log_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2@) (I 0))))))) (Poly%vstd!seq.Seq<u8.>. (lib!multilog.layout_v.extract_log_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) (I 0))))))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> %%location_label%%2 (lib!multilog.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2@) (B cdb!))))))))) (=> (lib!multilog.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2@) (B cdb!)) (and (=> (has_type which_log@ (UINT 32)) (=> (and (lib!multilog.inv_v.log_index_trigger.? which_log@) (< (%I which_log@) num_logs!)) (=> (= tmp%3 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) which_log@)))) (=> (= tmp%4 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2@) which_log@)))) (=> (ens%lib!multilog.layout_v.lemma_establish_subrange_equivalence. tmp%3 tmp%4) (=> %%location_label%%3 (lib!multilog.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2@) which_log@)) (I multilog_id!) (I num_logs!) which_log@ (B cdb!) (vstd!seq.Seq.index.? $ TYPE%lib!multilog.multilogimpl_v.LogInfo. (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!) which_log@)))))))) (=> (forall ((which_log$ Poly)) (! (=> (has_type which_log$ (UINT 32)) (=> (and (lib!multilog.inv_v.log_index_trigger.? which_log$) (< (%I which_log$) num_logs!)) (lib!multilog.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2@) which_log$)) (I multilog_id!) (I num_logs!) which_log$ (B cdb!) (vstd!seq.Seq.index.? $ TYPE%lib!multilog.multilogimpl_v.LogInfo. (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!) which_log$)))) :pattern ((lib!multilog.inv_v.log_index_trigger.? which_log$)))) (=> %%location_label%%4 (let ((pm_regions_view2$ (lib!pmem.pmemspec_t.impl&%7.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!)))) (and (and (lib!multilog.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2$) (B cdb!)) (lib!multilog.inv_v.each_metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2$) (I multilog_id!) (I num_logs!) (B cdb!) (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!))) (lib!multilog.inv_v.each_info_consistent_with_log_area.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view2$) (I num_logs!) (Poly%vstd!seq.Seq<lib!multilog.multilogimpl_v.LogInfo.>. infos!) (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!)))))))))))))
(check-sat)
(exit)
