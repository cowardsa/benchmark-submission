...
(assert (lib!bin_sizes.valid_bin_idx.? (I bin_idx!)))
(assert (> (nClip (EucDiv (lib!bin_sizes.size_of_bin.? (I bin_idx!)) 8)) 1))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!bin_sizes.lemma_bin_sizes_constants. 0) (=> %%location_label%%0 (> bin_idx! 1)))))
(check-sat)
(exit)
