...
(assert (not (and (=> (has_type mem@ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) mem@) (and (=> %%location_label%%0 (req%lib!multilog.inv_v.lemma_invariants_imply_crash_recover. pm_regions_view! (%Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mem@) multilog_id! num_logs! cdb! infos! state!)) (=> (ens%lib!multilog.inv_v.lemma_invariants_imply_crash_recover. pm_regions_view! (%Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. mem@) multilog_id! num_logs! cdb! infos! state!) (=> %%location_label%%1 (= (lib!multilog.layout_v.recover_all.? mem@ (I multilog_id!)) (core!option.Option./Some (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. (lib!multilog.multilogspec_t.impl&%1.drop_pending_appends.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!)))))))))) (=> (forall ((mem$ Poly)) (! (=> (has_type mem$ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) mem$) (= (lib!multilog.layout_v.recover_all.? mem$ (I multilog_id!)) (core!option.Option./Some (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. (lib!multilog.multilogspec_t.impl&%1.drop_pending_appends.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!))))))) :pattern ((lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) mem$)) :pattern ((lib!multilog.layout_v.recover_all.? mem$ (I multilog_id!))))) (=> %%location_label%%2 (forall ((mem$ Poly)) (! (=> (has_type mem$ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (=> (lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) mem$) (= (lib!multilog.layout_v.recover_all.? mem$ (I multilog_id!)) (core!option.Option./Some (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. (lib!multilog.multilogspec_t.impl&%1.drop_pending_appends.? (Poly%lib!multilog.multilogspec_t.AbstractMultiLogState. state!))))))) :pattern ((lib!pmem.pmemspec_t.impl&%7.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm_regions_view!) mem$)) :pattern ((lib!multilog.layout_v.recover_all.? mem$ (I multilog_id!))))))))))
(check-sat)
(exit)
