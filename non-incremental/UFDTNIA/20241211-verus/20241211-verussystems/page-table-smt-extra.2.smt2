...
(assert (not (and (=> %%location_label%%0 (> b! 0)) (=> (=> (= (nClip (EucMod a! b!)) 0) (= a! (nClip (Mul b! (nClip (EucDiv a! b!)))))) (and (=> %%location_label%%1 (> b! 0)) (=> (=> (= a! (nClip (Mul b! (nClip (EucDiv a! b!))))) (= (nClip (EucMod a! b!)) 0)) (=> %%location_label%%2 (= (lib!definitions_t.aligned.? (I a!) (I b!)) (= a! (nClip (Mul b! (nClip (EucDiv a! b!)))))))))))))
(check-sat)
(exit)
