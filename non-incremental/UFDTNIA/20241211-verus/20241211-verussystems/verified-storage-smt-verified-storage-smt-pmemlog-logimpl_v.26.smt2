...
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!)) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm!))))
(assert (>= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!)) main!logimpl_v.contents_offset.?))
(assert (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!) (I main!logimpl_v.header1_pos.?) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm!) (I main!logimpl_v.header1_pos.?) (I (Add main!logimpl_v.header1_pos.? main!logimpl_v.header_size.?)))))
(assert (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!) (I main!logimpl_v.header2_pos.?) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_size.?))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm!) (I main!logimpl_v.header2_pos.?) (I (Add main!logimpl_v.header2_pos.? main!logimpl_v.header_size.?)))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality_forall. $ (UINT 8)) (=> %%location_label%%0 (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. old_pm!)))) (let ((old_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm!)))) (let ((new_headers$ (%Poly%main!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (= old_headers$ new_headers$)))))))))
(check-sat)
(exit)
