...
(assert (not (and (=> %%location_label%%0 (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! b! c!)) (=> (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! b! c!) (=> (= tmp%1 (= (nClip (EucMod 0 c!)) (nClip (EucMod (nClip (Add a! b!)) c!)))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (lib!definitions_t.aligned.? (I (nClip (Add a! b!))) (I c!))))))))))
(check-sat)
(exit)
