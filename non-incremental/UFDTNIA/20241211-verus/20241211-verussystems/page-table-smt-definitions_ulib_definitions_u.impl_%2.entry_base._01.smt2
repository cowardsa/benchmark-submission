...
(assert (not (=> (= tmp%1 (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. self!))) (I layer!))) (=> (= tmp%2 lib!definitions_t.X86_NUM_ENTRIES.?) (=> (= tmp%3 (nClip (Mul (nClip (Mul (nClip (Mul 512 1024)) 1024)) 1024))) (and (=> %%location_label%%0 (req%lib!extra.mult_leq_mono_both. idx! tmp%1 tmp%2 tmp%3)) (=> (ens%lib!extra.mult_leq_mono_both. idx! tmp%1 tmp%2 tmp%3) (and (=> %%location_label%%1 (req%lib!definitions_u.impl&%2.entry_size. self! layer!)) (=> (ens%lib!definitions_u.impl&%2.entry_size. self! layer! tmp%4) (and (=> %%location_label%%2 (uInv SZ (Mul idx! tmp%4))) (and (=> %%location_label%%3 (uInv SZ (Add base! (uClip SZ (Mul idx! tmp%4))))) (=> (= res! (uClip SZ (Add base! (uClip SZ (Mul idx! tmp%4))))) (=> %%location_label%%4 (= res! (lib!definitions_t.entry_base_from_index.? (I base!) (I idx!) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. self!))) (I layer!))))))))))))))))))
(check-sat)
(exit)
