...
(declare-fun req%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. (Dcr Type Poly %%Function%% Int) Bool)
(declare-const %%global_location_label%%23 Bool)
(declare-const %%global_location_label%%24 Bool)
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (pred! %%Function%%) (i! Int)) (! (= (req%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. A&. A& s! pred! i!) (and (=> %%global_location_label%%23 (and (<= 0 i!) (<= i! (vstd!seq.Seq.len.? A&. A& s!)))) (=> %%global_location_label%%24 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i!)) (not (%B (%%apply%%0 pred! (vstd!seq.Seq.index.? A&. A& s! j$)))))) :pattern ((vstd!seq.Seq.index.? A&. A& s! j$))))))) :pattern ((req%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. A&. A& s! pred! i!)))))
(declare-fun ens%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. (Dcr Type Poly %%Function%% Int) Bool)
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (pred! %%Function%%) (i! Int)) (! (= (ens%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. A&. A& s! pred! i!) (= (vstd!seq_lib.impl&%0.filter.? A&. A& s! (Poly%fun%1. pred!)) (vstd!seq_lib.impl&%0.filter.? A&. A& (vstd!seq.Seq.subrange.? A&. A& s! (I i!) (I (vstd!seq.Seq.len.? A&. A& s!))) (Poly%fun%1. pred!)))) :pattern ((ens%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. A&. A& s! pred! i!)))))
(declare-const A&. Dcr)
...
(assert (and (<= 0 i!) (<= i! (vstd!seq.Seq.len.? A&. A& s!))))
(assert (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i!)) (not (%B (%%apply%%0 pred! (vstd!seq.Seq.index.? A&. A& s! j$)))))) :pattern ((vstd!seq.Seq.index.? A&. A& s! j$)))))
...
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? A&. A& s!)) (=> (fuel_bool fuel%vstd!seq_lib.impl&%0.filter.) (or (and (=> (= (vstd!seq.Seq.len.? A&. A& s!) 0) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq.Seq.subrange.? A&. A& s! (I i!) (I (vstd!seq.Seq.len.? A&. A& s!))) s!)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (= (vstd!seq.Seq.len.? A&. A& s!) 0)) (or (and (=> (< i! (vstd!seq.Seq.len.? A&. A& s!)) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq_lib.impl&%0.drop_last.? A&. A& (vstd!seq.Seq.subrange.? A&. A& s! (I i!) (I (vstd!seq.Seq.len.? A&. A& s!)))) (vstd!seq.Seq.subrange.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? A&. A& s!) (I i!) (I (vstd!seq.Seq.len.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? A&. A& s!)))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (vstd!seq_lib.impl&%0.drop_last.? A&. A& s!)) (and (=> %%location_label%%2 (check_decrease_int (let ((s!$0 tmp%3) (pred!$1 pred!) (i!$2 i!)) (vstd!seq.Seq.len.? A&. A& s!$0)) decrease%init0 false)) (and (=> %%location_label%%3 (req%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. A&. A& tmp%3 pred! i!)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. A&. A& tmp%3 pred! i!) %%switch_label%%1)))))))) (=> (not (< i! (vstd!seq.Seq.len.? A&. A& s!))) (=> (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq.Seq.subrange.? A&. A& s! (I i!) (I (vstd!seq.Seq.len.? A&. A& s!))) (vstd!seq.Seq.subrange.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? A&. A& s!) (I (Sub i! 1)) (I (vstd!seq.Seq.len.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? A&. A& s!)))))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (=> (= tmp%5 (vstd!seq_lib.impl&%0.drop_last.? A&. A& s!)) (=> (= tmp%6 (Sub i! 1)) (and (=> %%location_label%%5 (check_decrease_int (let ((s!$0 tmp%5) (pred!$1 pred!) (i!$2 tmp%6)) (vstd!seq.Seq.len.? A&. A& s!$0)) decrease%init0 false)) (and (=> %%location_label%%6 (req%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. A&. A& tmp%5 pred! tmp%6)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_filter_skip_rejected. A&. A& tmp%5 pred! tmp%6) %%switch_label%%1)))))))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%7 (= (vstd!seq_lib.impl&%0.filter.? A&. A& s! (Poly%fun%1. pred!)) (vstd!seq_lib.impl&%0.filter.? A&. A& (vstd!seq.Seq.subrange.? A&. A& s! (I i!) (I (vstd!seq.Seq.len.? A&. A& s!))) (Poly%fun%1. pred!))))))))))
(check-sat)
(exit)
