...
(assert (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_pm!) (I main!logimpl_v.incorruptible_bool_pos.?) (I (Add main!logimpl_v.incorruptible_bool_pos.? 8))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm!) (I main!logimpl_v.incorruptible_bool_pos.?) (I (Add main!logimpl_v.incorruptible_bool_pos.? 8)))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (let ((tmp%%$ (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. old_pm!)))) (let ((old_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))))) (let ((tmp%%$1 (main!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm!)))) (let ((new_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1)))))) (= old_ib$ new_ib$))))))))
(check-sat)
(exit)
