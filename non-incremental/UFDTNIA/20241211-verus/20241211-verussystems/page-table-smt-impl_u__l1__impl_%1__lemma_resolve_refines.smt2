...
(set-info :comment ";; MODULE 'module impl_u::l1, function lib::impl_u::l1::Directory::lemma_resolve_refines'")
...
(assert (forall ((self! Poly) (vaddr! Poly)) (! (= (req%lib!impl_u.l0.impl&%0.resolve. self! vaddr!) (=> %%global_location_label%%11 (lib!impl_u.l0.impl&%0.accepted_resolve.? self! vaddr!))) :pattern ((req%lib!impl_u.l0.impl&%0.resolve. self! vaddr!)))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.entry_size. self!) (=> %%global_location_label%%12 (< (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!)))))))))) :pattern ((req%lib!impl_u.l1.impl&%1.entry_size. self!)))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.num_entries. self!) (=> %%global_location_label%%13 (< (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!)))))))))) :pattern ((req%lib!impl_u.l1.impl&%1.num_entries. self!)))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.empty. self!) (=> %%global_location_label%%14 (lib!impl_u.l1.impl&%1.well_formed.? self!))) :pattern ((req%lib!impl_u.l1.impl&%1.empty. self!)))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.pages_match_entry_size. self!) (=> %%global_location_label%%15 (lib!impl_u.l1.impl&%1.well_formed.? self!))) :pattern ((req%lib!impl_u.l1.impl&%1.pages_match_entry_size. self!)))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.directories_are_in_next_layer. self!) (=> %%global_location_label%%16 (lib!impl_u.l1.impl&%1.well_formed.? self!))) :pattern ((req%lib!impl_u.l1.impl&%1.directories_are_in_next_layer. self!)))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.directories_are_nonempty. self!) (and (=> %%global_location_label%%17 (lib!impl_u.l1.impl&%1.well_formed.? self!)) (=> %%global_location_label%%18 (lib!impl_u.l1.impl&%1.directories_are_in_next_layer.? self!)) (=> %%global_location_label%%19 (lib!impl_u.l1.impl&%1.directories_match_arch.? self!)))) :pattern ((req%lib!impl_u.l1.impl&%1.directories_are_nonempty. self!)))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.frames_aligned. self!) (=> %%global_location_label%%20 (lib!impl_u.l1.impl&%1.well_formed.? self!))) :pattern ((req%lib!impl_u.l1.impl&%1.frames_aligned. self!)))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.directories_obey_invariant. self!) (and (=> %%global_location_label%%21 (lib!impl_u.l1.impl&%1.well_formed.? self!)) (=> %%global_location_label%%22 (lib!impl_u.l1.impl&%1.directories_are_in_next_layer.? self!)) (=> %%global_location_label%%23 (lib!impl_u.l1.impl&%1.directories_match_arch.? self!)))) :pattern ((req%lib!impl_u.l1.impl&%1.directories_obey_invariant. self!)))))
...
(assert (forall ((self! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.upper_vaddr. self!) (=> %%global_location_label%%24 (lib!impl_u.l1.impl&%1.well_formed.? self!))) :pattern ((req%lib!impl_u.l1.impl&%1.upper_vaddr. self!)))))
...
(assert (forall ((self! Poly) (idx! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.entry_base. self! idx!) (=> %%global_location_label%%25 (lib!impl_u.l1.impl&%1.inv.? self!))) :pattern ((req%lib!impl_u.l1.impl&%1.entry_base. self! idx!)))))
...
(assert (forall ((offset! Poly) (entry_size! Poly)) (! (= (req%lib!definitions_t.index_from_offset. offset! entry_size!) (=> %%global_location_label%%26 (> (%I entry_size!) 0))) :pattern ((req%lib!definitions_t.index_from_offset. offset! entry_size!)))))
...
(assert (forall ((base! Poly) (addr! Poly) (entry_size! Poly)) (! (= (req%lib!definitions_t.index_from_base_and_addr. base! addr! entry_size!) (and (=> %%global_location_label%%27 (>= (%I addr!) (%I base!))) (=> %%global_location_label%%28 (> (%I entry_size!) 0)))) :pattern ((req%lib!definitions_t.index_from_base_and_addr. base! addr! entry_size!)))))
...
(assert (forall ((self! Poly) (layer! Poly) (base! Poly) (vaddr! Poly)) (! (= (req%lib!definitions_t.impl&%8.index_for_vaddr. self! layer! base! vaddr!) (and (=> %%global_location_label%%29 (lib!definitions_t.impl&%8.inv.? self!)) (=> %%global_location_label%%30 (< (%I layer!) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!)))))) (=> %%global_location_label%%31 (<= (%I base!) (%I vaddr!))))) :pattern ((req%lib!definitions_t.impl&%8.index_for_vaddr. self! layer! base! vaddr!)))))
...
(assert (forall ((base! Int) (idx! Int) (entry_size! Int)) (! (= (req%lib!impl_u.indexing.lemma_entry_base_from_index. base! idx! entry_size!) (=> %%global_location_label%%32 (< 0 entry_size!))) :pattern ((req%lib!impl_u.indexing.lemma_entry_base_from_index. base! idx! entry_size!)))))
...
(assert (forall ((self! lib!impl_u.l1.Directory.)) (! (= (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. self!) (=> %%global_location_label%%33 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!)))) :pattern ((req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. self!)))))
...
(assert (forall ((self! Poly) (vaddr! Poly)) (! (= (req%lib!impl_u.l1.impl&%1.resolve. self! vaddr!) (and (=> %%global_location_label%%37 (lib!impl_u.l1.impl&%1.inv.? self!)) (=> %%global_location_label%%38 (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? self!)) vaddr!)) (=> %%global_location_label%%39 (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? self!)) vaddr!))))) :pattern ((req%lib!impl_u.l1.impl&%1.resolve. self! vaddr!)))))
...
(assert (forall ((self! lib!impl_u.l1.Directory.) (j! Int)) (! (= (req%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. self! j!) (and (=> %%global_location_label%%40 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!))) (=> %%global_location_label%%41 (< j! (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!))))))))) :pattern ((req%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. self! j!)))))
...
(set-info :comment ";; Function-Specs lib::impl_u::l1::Directory::lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp")
(declare-fun req%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. (lib!impl_u.l1.Directory. Int Int) Bool)
(declare-const %%global_location_label%%42 Bool)
(declare-const %%global_location_label%%43 Bool)
(declare-const %%global_location_label%%44 Bool)
(declare-const %%global_location_label%%45 Bool)
(assert (forall ((self! lib!impl_u.l1.Directory.) (vaddr! Int) (i! Int)) (! (= (req%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. self! vaddr! i!) (and (=> %%global_location_label%%42 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!))) (=> %%global_location_label%%43 (< i! (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!)))) (=> %%global_location_label%%44 (lib!definitions_t.between.? (I vaddr!) (I (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))))) (I (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))))))) (=> %%global_location_label%%45 (not (exists ((base$ Poly)) (! (and (has_type base$ NAT) (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))))) base$) (lib!definitions_t.between.? (I vaddr!) base$ (I (nClip (Add (%I base$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))))) base$)))))))))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))))) base$)))))))) :pattern ((req%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. self! vaddr! i!)))))
(declare-fun ens%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. (lib!impl_u.l1.Directory. Int Int) Bool)
(assert (forall ((self! lib!impl_u.l1.Directory.) (vaddr! Int) (i! Int)) (! (= (ens%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. self! vaddr! i!) (not (exists ((base$ Poly)) (! (and (has_type base$ NAT) (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))))))) base$) (lib!definitions_t.between.? (I vaddr!) base$ (I (nClip (Add (%I base$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!)))))) base$)))))))))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!)))))) base$)))))) :pattern ((ens%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. self! vaddr! i!)))))
(set-info :comment ";; Function-Specs lib::impl_u::l1::Directory::lemma_resolve_refines")
(declare-fun req%lib!impl_u.l1.impl&%1.lemma_resolve_refines. (lib!impl_u.l1.Directory. Int) Bool)
(declare-const %%global_location_label%%46 Bool)
(declare-const %%global_location_label%%47 Bool)
(assert (forall ((self! lib!impl_u.l1.Directory.) (vaddr! Int)) (! (= (req%lib!impl_u.l1.impl&%1.lemma_resolve_refines. self! vaddr!) (and (=> %%global_location_label%%46 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!))) (=> %%global_location_label%%47 (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) (I vaddr!))))) :pattern ((req%lib!impl_u.l1.impl&%1.lemma_resolve_refines. self! vaddr!)))))
(declare-fun ens%lib!impl_u.l1.impl&%1.lemma_resolve_refines. (lib!impl_u.l1.Directory. Int) Bool)
(assert (forall ((self! lib!impl_u.l1.Directory.) (vaddr! Int)) (! (= (ens%lib!impl_u.l1.impl&%1.lemma_resolve_refines. self! vaddr!) (= (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) (I vaddr!)) (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. self!) (I vaddr!)))) :pattern ((ens%lib!impl_u.l1.impl&%1.lemma_resolve_refines. self! vaddr!)))))
(set-info :comment ";; Function-Def lib::impl_u::l1::Directory::lemma_resolve_refines")
(set-info :comment ";; page-table/impl_u/l1.rs:719:5: 719:57 (#0)")
...
(declare-fun %%choose%%1 (Type Dcr Type Poly Dcr Type Dcr Type Poly Poly Dcr Type Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4 Dcr) (%%hole%%5 Type) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly) (%%hole%%9 Poly) (%%hole%%10 Dcr) (%%hole%%11 Type) (%%hole%%12 Dcr) (%%hole%%13 Type) (%%hole%%14 Poly)) (! (=> (exists ((base$1 Poly)) (! (and (has_type base$1 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 base$1) (lib!definitions_t.between.? %%hole%%9 base$1 (I (nClip (Add (%I base$1) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 base$1)))))))))))) :pattern ((vstd!map.impl&%0.index.? %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 base$1)))) (exists ((base$1 Poly)) (! (and (and (has_type base$1 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 base$1) (lib!definitions_t.between.? %%hole%%9 base$1 (I (nClip (Add (%I base$1) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 base$1)))))))))))) (= (%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14) base$1)) :pattern ((vstd!map.impl&%0.index.? %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 base$1))))) :pattern ((%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14)))))
...
(assert (not (=> (= decrease%init0 (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!))))) (=> (ens%lib!impl_u.l0.ambient_lemmas1. 0) (=> (ens%lib!impl_u.l1.ambient_lemmas2. 0) (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. self!)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. self!) (=> (= entry@ (lib!impl_u.l1.impl&%1.index_for_vaddr.? (Poly%lib!impl_u.l1.Directory. self!) (I vaddr!))) (=> (= tmp%1 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%2 (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%1 (req%lib!impl_u.indexing.lemma_entry_base_from_index. tmp%1 entry@ tmp%2)) (=> (ens%lib!impl_u.indexing.lemma_entry_base_from_index. tmp%1 entry@ tmp%2) (=> (= tmp%3 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%4 (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!))) (=> (= tmp%5 (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%2 (req%lib!impl_u.indexing.lemma_index_from_base_and_addr. tmp%3 vaddr! tmp%4 tmp%5)) (=> (ens%lib!impl_u.indexing.lemma_index_from_base_and_addr. tmp%3 vaddr! tmp%4 tmp%5) (and (=> %%location_label%%3 (req%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. self! entry@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_interp_of_entry_contains_mapping_implies_interp_contains_mapping. self! entry@) (=> (= tmp%%@ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (I entry@)))) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@) (=> (= p@ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@)))) (=> (= tmp%6 (is-core!result.Result./Ok_ (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. self!) (I vaddr!)))) (and (=> %%location_label%%4 tmp%6) (=> tmp%6 (=> (= p_vaddr@ (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I entry@))) (=> (= tmp%7 (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!)))))) (I p_vaddr@) (Poly%lib!definitions_t.PageTableEntry. p@))) (and (=> %%location_label%%5 tmp%7) (=> tmp%7 (=> (= tmp%8 (< vaddr! (nClip (Add p_vaddr@ (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!)))))) (I p_vaddr@))))))))))) (and (=> %%location_label%%6 tmp%8) (=> tmp%8 %%switch_label%%0)))))))))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@)) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@) (=> (= d@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@)))) (and (=> %%location_label%%7 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. d@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. d@) (=> (= tmp%9 (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))) (I vaddr!))) (and (=> %%location_label%%8 tmp%9) (=> tmp%9 (and (=> %%location_label%%9 (check_decrease_int (let ((self!$0 d@) (vaddr!$1 vaddr!)) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 false)) (and (=> %%location_label%%10 (req%lib!impl_u.l1.impl&%1.lemma_resolve_refines. d@ vaddr!)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_resolve_refines. d@ vaddr!) (=> (= tmp%10 (= (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I entry@)) (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))) (and (=> %%location_label%%11 tmp%10) (=> tmp%10 (=> (= tmp%11 (= (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))) (I vaddr!)) (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. d@) (I vaddr!)))) (and (=> %%location_label%%12 tmp%11) (=> tmp%11 (or (and (=> (is-core!result.Result./Ok_ (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. d@) (I vaddr!))) (=> (= tmp%12 (is-core!result.Result./Ok_ (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. self!) (I vaddr!)))) (and (=> %%location_label%%13 tmp%12) (=> tmp%12 (=> (= tmp%13 (exists ((base$ Poly)) (! (and (has_type base$ NAT) (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))))))) base$) (lib!definitions_t.between.? (I vaddr!) base$ (I (nClip (Add (%I base$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$)))))))))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$))))) (and (=> %%location_label%%14 tmp%13) (=> tmp%13 (=> (= base@ (%I (as_type (%%choose%%1 NAT $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))))))) $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) (I vaddr!) $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))))))) NAT))) (=> (= tmp%14 (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!)))))) (I base@) (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I entry@)))))) (I base@)))) (and (=> %%location_label%%15 tmp%14) (=> tmp%14 (=> (= tmp%15 (is-core!result.Result./Ok_ (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. d@) (I vaddr!)))) (and (=> %%location_label%%16 tmp%15) (=> tmp%15 (=> (= tmp%16 (is-core!result.Result./Ok_ (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))) (I vaddr!)))) (and (=> %%location_label%%17 tmp%16) (=> tmp%16 (=> (= tmp%17 (= (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))) (I vaddr!)) (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) (I vaddr!)))) (and (=> %%location_label%%18 tmp%17) (=> tmp%17 %%switch_label%%2)))))))))))))))))))) (=> (not (is-core!result.Result./Ok_ (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. d@) (I vaddr!)))) (=> (= tmp%18 (is-core!result.Result./Err_ (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. d@) (I vaddr!)))) (and (=> %%location_label%%19 tmp%18) (=> tmp%18 (=> (= tmp%19 (is-core!result.Result./Err_ (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. self!) (I vaddr!)))) (and (=> %%location_label%%20 tmp%19) (=> tmp%19 (=> (= tmp%20 (is-core!result.Result./Err_ (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))) (I vaddr!)))) (and (=> %%location_label%%21 tmp%20) (=> tmp%20 (and (=> (= tmp%21 (not (exists ((base$ Poly) (pte$ Poly)) (! (and (and (has_type base$ NAT) (has_type pte$ TYPE%lib!definitions_t.PageTableEntry.)) (and (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$ pte$) (lib!definitions_t.between.? (I vaddr!) base$ (I (nClip (Add (%I base$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. pte$))))))))))) :pattern ((vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$ pte$)))))) (and (=> %%location_label%%22 tmp%21) (=> tmp%21 (or (and (=> (exists ((base$ Poly)) (! (and (has_type base$ NAT) (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))))))) base$) (lib!definitions_t.between.? (I vaddr!) base$ (I (nClip (Add (%I base$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$)))))))))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$)))) (=> (= base$2@ (%I (as_type (%%choose%%1 NAT $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))))))) $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) (I vaddr!) $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))))))) NAT))) (=> (= pte@ (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) (I base$2@)))) (=> (= tmp%22 (vstd!map_lib.impl&%0.contains_pair.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) (I base$2@) (Poly%lib!definitions_t.PageTableEntry. pte@))) (and (=> %%location_label%%23 tmp%22) (=> tmp%22 %%switch_label%%3)))))) (=> (not (exists ((base$ Poly)) (! (and (has_type base$ NAT) (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))))))) base$) (lib!definitions_t.between.? (I vaddr!) base$ (I (nClip (Add (%I base$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$)))))))))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$))))) %%switch_label%%3)) (and (not %%switch_label%%3) (=> %%location_label%%24 (not (exists ((base$ Poly)) (! (and (has_type base$ NAT) (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))))))) base$) (lib!definitions_t.between.? (I vaddr!) base$ (I (nClip (Add (%I base$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$)))))))))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$))))))))))) (=> (not (exists ((base$ Poly)) (! (and (has_type base$ NAT) (and (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))))))) base$) (lib!definitions_t.between.? (I vaddr!) base$ (I (nClip (Add (%I base$) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$)))))))))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@)))))) base$))))) (and (=> %%location_label%%25 (req%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. self! vaddr! entry@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. self! vaddr! entry@) %%switch_label%%2))))))))))))))) (and (not %%switch_label%%2) (=> (= tmp%23 (= (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))) (I vaddr!)) (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) (I vaddr!)))) (and (=> %%location_label%%26 tmp%23) (=> tmp%23 %%switch_label%%1))))))))))))))))))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@)) (=> (= tmp%24 (is-core!result.Result./Err_ (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. self!) (I vaddr!)))) (and (=> %%location_label%%27 tmp%24) (=> tmp%24 (and (=> %%location_label%%28 (req%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. self! vaddr! entry@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_no_mapping_in_interp_of_entry_implies_no_mapping_in_interp. self! vaddr! entry@) (=> (= tmp%25 (is-core!result.Result./Err_ (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) (I vaddr!)))) (and (=> %%location_label%%29 tmp%25) (=> tmp%25 %%switch_label%%1)))))))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%30 (= (lib!impl_u.l0.impl&%0.resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) (I vaddr!)) (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. self!) (I vaddr!))))))))))))))))))))))))))
(check-sat)
(exit)
