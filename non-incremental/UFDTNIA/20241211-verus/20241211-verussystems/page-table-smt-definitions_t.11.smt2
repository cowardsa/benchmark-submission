...
(assert (not (or (and (=> (<= (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!)))) lib!definitions_t.X86_NUM_LAYERS.?) (=> (has_type i@ NAT) (or (and (=> (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!))))) (and (=> %%location_label%%0 (req%lib!definitions_t.impl&%8.entry_size. self! i@)) (or (and (=> (and (< 0 tmp%%@) (<= tmp%%@ lib!definitions_t.X86_MAX_ENTRY_SIZE.?)) (and (=> %%location_label%%1 (req%lib!definitions_t.impl&%8.num_entries. self! i@)) (=> (= tmp%1 (and (< 0 tmp%%$1@) (<= tmp%%$1@ lib!definitions_t.X86_NUM_ENTRIES.?))) %%switch_label%%3))) (=> (not (and (< 0 tmp%%@) (<= tmp%%@ lib!definitions_t.X86_MAX_ENTRY_SIZE.?))) (=> (= tmp%1 false) %%switch_label%%3))) (and (not %%switch_label%%3) (or (and (=> tmp%1 (and (=> %%location_label%%2 (req%lib!definitions_t.impl&%8.entry_size_is_next_layer_size. self! i@)) (=> (= tmp%2 (lib!definitions_t.impl&%8.entry_size_is_next_layer_size.? self! i@)) (=> (= tmp%3 tmp%2) %%switch_label%%2)))) (=> (not tmp%1) (=> (= tmp%3 false) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%4 tmp%3) %%switch_label%%1))))))) (=> (not (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!)))))) (=> (= tmp%4 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%5 (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!))))) (and (and (let ((tmp%%$ (lib!definitions_t.impl&%8.entry_size.? self! i$))) (and (< 0 tmp%%$) (<= tmp%%$ lib!definitions_t.X86_MAX_ENTRY_SIZE.?))) (let ((tmp%%$ (lib!definitions_t.impl&%8.num_entries.? self! i$))) (and (< 0 tmp%%$) (<= tmp%%$ lib!definitions_t.X86_NUM_ENTRIES.?)))) (lib!definitions_t.impl&%8.entry_size_is_next_layer_size.? self! i$)))) :pattern ((lib!definitions_t.impl&%8.entry_size.? self! i$)) :pattern ((lib!definitions_t.impl&%8.num_entries.? self! i$))))) %%switch_label%%0))))) (=> (not (<= (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!)))) lib!definitions_t.X86_NUM_LAYERS.?)) (=> (= tmp%5 false) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)
