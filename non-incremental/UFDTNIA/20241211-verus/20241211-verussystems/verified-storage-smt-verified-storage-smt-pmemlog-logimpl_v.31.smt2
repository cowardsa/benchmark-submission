...
(declare-const bytes! vstd!seq.Seq<u8.>.)
(declare-const write_addr! Int)
(declare-const perm! Poly)
(declare-const chunks_flushed@ Poly)
(declare-const new_pm$1@ vstd!seq.Seq<u8.>.)
...
(assert (> (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)) main!logimpl_v.contents_offset.?))
(assert (and (<= main!logimpl_v.contents_offset.? write_addr!) (< write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)))))
(assert (%B (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. pm!))))
(assert (main!logimpl_v.permissions_depend_only_on_recovery_view.? Perm&. Perm& perm!))
(assert (let ((live_header$ (main!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (let ((physical_head$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (let ((physical_tail$ (main!logimpl_v.spec_addr_logical_to_physical.? (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$))))))) (I (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))))))) (and (=> (<= physical_head$ physical_tail$) (and (and (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!))) (Add (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. live_header$)))))) main!logimpl_v.contents_offset.?)) (=> (< write_addr! physical_head$) (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!))) physical_head$))) (or (<= physical_tail$ write_addr!) (< write_addr! physical_head$)))) (=> (< physical_tail$ physical_head$) (let ((tmp%%$ (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!))))) (and (and (<= physical_tail$ write_addr!) (<= write_addr! tmp%%$)) (< tmp%%$ physical_head$)))))))))
...
(assert (not (=> (= new_pm@ (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!))) (and (=> %%location_label%%0 (req%main!logimpl_v.lemma_append_data_update_view. pm! bytes! write_addr!)) (=> (ens%main!logimpl_v.lemma_append_data_update_view. pm! bytes! write_addr!) (and (=> %%location_label%%1 (req%main!logimpl_v.lemma_same_log_state. pm! new_pm@)) (=> (ens%main!logimpl_v.lemma_same_log_state. pm! new_pm@) (and (=> (has_type chunks_flushed@ (TYPE%vstd!set.Set. $ INT)) (=> (= new_pm$1@ (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!) chunks_flushed@)) (and (=> %%location_label%%2 (req%main!logimpl_v.lemma_append_data_update_view_crash. pm! bytes! write_addr! (%Poly%vstd!set.Set<int.>. chunks_flushed@))) (=> (ens%main!logimpl_v.lemma_append_data_update_view_crash. pm! bytes! write_addr! (%Poly%vstd!set.Set<int.>. chunks_flushed@)) (and (=> %%location_label%%3 (req%main!logimpl_v.lemma_same_log_state. pm! new_pm$1@)) (=> (ens%main!logimpl_v.lemma_same_log_state. pm! new_pm$1@) (and (=> %%location_label%%4 (req%main!logimpl_v.lemma_same_permissions. Perm&. Perm& pm! new_pm$1@ perm!)) (=> (ens%main!logimpl_v.lemma_same_permissions. Perm&. Perm& pm! new_pm$1@ perm!) (=> %%location_label%%5 (%B (let ((new_pm$2 (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!) chunks_flushed@))) (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$2))))))))))))) (=> (forall ((chunks_flushed$ Poly)) (! (=> (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT)) (%B (let ((new_pm$3 (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!) chunks_flushed$))) (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$3))))) :pattern ((main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!) chunks_flushed$)))) (and (=> %%location_label%%6 (is-core!option.Option./Some_ (main!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))) (and (=> %%location_label%%7 (forall ((chunks_flushed$ Poly)) (! (=> (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT)) (%B (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!) chunks_flushed$))) (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$))))) :pattern ((main!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!) chunks_flushed$))))) (and (=> %%location_label%%8 (%B (let ((new_pm$ (main!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes!)))) (main!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$))))) (=> %%location_label%%9 (main!logimpl_v.update_data_view_postcond.? (Poly%vstd!seq.Seq<u8.>. pm!) (Poly%vstd!seq.Seq<u8.>. bytes!) (I write_addr!)))))))))))))))
(check-sat)
(exit)
