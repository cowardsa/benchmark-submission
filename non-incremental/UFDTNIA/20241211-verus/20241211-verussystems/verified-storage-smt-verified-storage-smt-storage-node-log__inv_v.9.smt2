...
(assert (not (and (=> (has_type i@ INT) (=> (has_type j@ INT) (=> (has_type k@ INT) (=> (has_type l@ INT) (=> (and (and (and (and (<= 0 (%I i@)) (<= (%I i@) (%I k@))) (<= (%I k@) (%I l@))) (<= (%I l@) (%I j@))) (<= (%I j@) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!)))) (and (=> %%location_label%%0 (req%lib!log.inv_v.lemma_smaller_range_of_seq_is_subrange. mem1! (%I i@) (%I j@) (%I k@) (%I l@))) (=> (ens%lib!log.inv_v.lemma_smaller_range_of_seq_is_subrange. mem1! (%I i@) (%I j@) (%I k@) (%I l@)) (=> %%location_label%%1 (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) i@ j@) (I (Sub (%I k@) (%I i@))) (I (Sub (%I l@) (%I i@)))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) k@ l@)))))))))) (=> (forall ((i$ Poly) (j$ Poly) (k$ Poly) (l$ Poly)) (! (=> (and (has_type i$ INT) (has_type j$ INT) (has_type k$ INT) (has_type l$ INT)) (=> (and (and (and (and (<= 0 (%I i$)) (<= (%I i$) (%I k$))) (<= (%I k$) (%I l$))) (<= (%I l$) (%I j$))) (<= (%I j$) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) i$ j$) (I (Sub (%I k$) (%I i$))) (I (Sub (%I l$) (%I i$)))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) k$ l$)))) :pattern ((vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) i$ j$) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) k$ l$)))) (=> %%location_label%%2 (forall ((i$ Poly) (j$ Poly) (k$ Poly) (l$ Poly)) (! (=> (and (has_type i$ INT) (has_type j$ INT) (has_type k$ INT) (has_type l$ INT)) (=> (and (and (and (and (<= 0 (%I i$)) (<= (%I i$) (%I k$))) (<= (%I k$) (%I l$))) (<= (%I l$) (%I j$))) (<= (%I j$) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) i$ j$) (I (Sub (%I k$) (%I i$))) (I (Sub (%I l$) (%I i$)))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) k$ l$)))) :pattern ((vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) i$ j$) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) k$ l$)))))))))
(check-sat)
(exit)
