...
(assert (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!)))
(assert (= (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. state!))))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_view_can_only_crash_as_committed. pm_region_view!)) (=> (ens%lib!pmem.pmemutil_v.lemma_if_no_outstanding_writes_then_persistent_memory_view_can_only_crash_as_committed. pm_region_view!) (=> %%location_label%%1 (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$) (= (lib!log.layout_v.recover_state.? s$ (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. state!))))) :pattern ((lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$)))))))))
(check-sat)
(exit)
