...
(assert (not (and (=> %%location_label%%0 (uInv SZ (Sub y! 1))) (=> (= mask@ (uClip SZ (Sub y! 1))) (or (and (=> (= (uClip SZ (bitand (I y!) (I mask@))) 0) (=> (= tmp%1 (uClip SZ (Sub (Add x! y!) 1))) (and (=> %%location_label%%1 (req%lib!layout.bitand_with_mask_gives_rounding. tmp%1 y!)) (=> (ens%lib!layout.bitand_with_mask_gives_rounding. tmp%1 y!) (=> (= tmp%2 (= (uClip SZ (bitand (I (uClip SZ (Add x! mask@))) (I (uClip SZ (bitnot (I mask@)))))) (Mul (EucDiv (Sub (Add x! y!) 1) y!) y!))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 %%switch_label%%1))))))) (=> (not (= (uClip SZ (bitand (I y!) (I mask@))) 0)) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (= z@ (Add x! mask@)) (and (=> %%location_label%%3 (not (= y! 0))) (=> (= (Add (Mul (EucDiv z@ y!) y!) (EucMod z@ y!)) z@) (=> (= t@ (EucDiv (Sub (Add x! y!) 1) y!)) (=> (ens%lib!layout.mul_mod_right. t@ y!) (and (=> %%location_label%%4 true) (=> (=> (not (= y! 0)) (= (Mul (EucDiv (Mul t@ y!) y!) y!) (Mul t@ y!))) (or (and (=> (= (uClip SZ (bitand (I y!) (I mask@))) 0) (and (=> %%location_label%%5 (uInv SZ (Add x! mask@))) (=> (= tmp%3 (uClip SZ (bitand (I (uClip SZ (Add x! mask@))) (I (uClip SZ (bitnot (I mask@))))))) %%switch_label%%0))) (=> (not (= (uClip SZ (bitand (I y!) (I mask@))) 0)) (and (=> %%location_label%%6 (uInv SZ (Add x! mask@))) (and (=> %%location_label%%7 (not (= y! 0))) (and (=> %%location_label%%8 (uInv SZ (Mul (uClip SZ (EucDiv (uClip SZ (Add x! mask@)) y!)) y!))) (=> (= tmp%3 (uClip SZ (Mul (uClip SZ (EucDiv (uClip SZ (Add x! mask@)) y!)) y!))) %%switch_label%%0)))))) (and (not %%switch_label%%0) (=> (= res! tmp%3) (and (=> %%location_label%%9 (= res! (Mul (EucDiv (Sub (Add x! y!) 1) y!) y!))) (and (=> %%location_label%%10 (and (<= x! res!) (<= res! (Sub (Add x! y!) 1)))) (and (=> %%location_label%%11 (= (uClip SZ (EucMod res! y!)) 0)) (=> %%location_label%%12 (= (Mul (uClip SZ (EucDiv res! y!)) y!) res!)))))))))))))))))))))
(check-sat)
(exit)
