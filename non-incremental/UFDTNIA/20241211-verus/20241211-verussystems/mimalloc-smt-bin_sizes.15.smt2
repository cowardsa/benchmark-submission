...
(assert (and (<= 0 i!) (<= i! lib!config.SLICES_PER_SEGMENT.?)))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= lib!config.SLICES_PER_SEGMENT.? 512) (=> (lib!bin_sizes.check_sbin_idx_smallest_sbin_fitting_size.? (I 0) (I 513)) (=> (ens%lib!bin_sizes.result_sbin_idx_smallest_sbin_fitting_size. 0 513) (=> (= tmp%1 (lib!bin_sizes.property_sbin_idx_smallest_sbin_fitting_size.? (I i!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (lib!bin_sizes.valid_sbin_idx.? (I (lib!bin_sizes.smallest_sbin_fitting_size.? (I i!)))))))))))))
(check-sat)
(exit)
