...
(set-info :comment ";; linked_list.rs:807:17: 807:23 (#0)")
...
(declare-const start! ptr_mut%<u8.>.)
(declare-const last! ptr_mut%<u8.>.)
(declare-const bsize! Int)
(declare-const cap! Int)
(declare-const extend! Int)
(declare-const points_to_raw_r!@0 vstd!raw_ptr.PointsToRaw.)
(declare-const tokens!@0 vstd!map.Map<int./lib!tokens.Mim.block.>.)
(declare-const tmp%1 vstd!raw_ptr.Provenance.)
(declare-const verus_tmp_points_to_raw@0 vstd!raw_ptr.PointsToRaw.)
(declare-const tmp%2 Poly)
(declare-const verus_tmp_new_map@0 vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>.)
(declare-const verus_tmp_i@0 Int)
(declare-const verus_tmp_tokens_snap@ vstd!map.Map<int./lib!tokens.Mim.block.>.)
...
(declare-const tmp%10 vstd!set.Set<int.>.)
(declare-const verus_tmp_points_to@ vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp_rest@ vstd!raw_ptr.PointsToRaw.)
(declare-const tmp%11 vstd!set.Set<int.>.)
(declare-const verus_tmp_points_to1@ vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp_points_to2@ vstd!raw_ptr.PointsToRaw.)
...
(declare-const tmp%14 lib!linked_list.Node.)
(declare-const tmp%15 Poly)
(declare-const tmp%16 Int)
(declare-const tmp%17 Int)
(declare-const tmp%18 tuple%4.)
(declare-const old_tokens@ vstd!map.Map<int./lib!tokens.Mim.block.>.)
(declare-const block$1@ lib!tokens.Mim.block.)
(declare-const the_key@ Int)
(declare-const next@ ptr_mut%<lib!linked_list.Node.>.)
(declare-const verus_tmp$4@ tuple%2.)
(declare-const points_to@0 vstd!raw_ptr.PointsToRaw.)
(declare-const rest@0 vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp$5@ tuple%2.)
(declare-const points_to1@0 vstd!raw_ptr.PointsToRaw.)
(declare-const points_to2@0 vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp$6@ vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const points_to_node@0 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const block_ptr@ ptr_mut%<lib!linked_list.Node.>.)
(declare-const tmp%19 Bool)
(declare-const tmp%20 vstd!set.Set<int.>.)
(declare-const verus_tmp_points_to$1@ vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp_rest$1@ vstd!raw_ptr.PointsToRaw.)
(declare-const tmp%21 vstd!set.Set<int.>.)
(declare-const verus_tmp_points_to1$1@ vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp_points_to2$1@ vstd!raw_ptr.PointsToRaw.)
(declare-const tmp%22 Poly)
(declare-const verus_tmp_points_to_node$1@0 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const tmp%23 Poly)
(declare-const tmp%24 Poly)
(declare-const tmp%25 lib!linked_list.Node.)
...
(declare-const tmp%42 lib!tokens.PageId.)
...
(declare-const perm$1@ vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const padding$1@ vstd!raw_ptr.PointsToRaw.)
(declare-const block_token$1@ lib!tokens.Mim.block.)
(declare-const exposed$2@ vstd!raw_ptr.IsExposed.)
(declare-const next_ptr@ ptr_mut%<lib!linked_list.Node.>.)
(declare-const tmp%%@ tuple%4.)
(declare-const perm@ vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const padding@ vstd!raw_ptr.PointsToRaw.)
(declare-const block_token@ lib!tokens.Mim.block.)
(declare-const exposed$1@ vstd!raw_ptr.IsExposed.)
(declare-const tmp%50 Bool)
(declare-const block$2@ lib!tokens.Mim.block.)
(declare-const the_key$1@ Int)
(declare-const old_len@ Int)
(declare-const m1@ vstd!map.Map<int./lib!tokens.Mim.block.>.)
(declare-const m2@ vstd!map.Map<int./lib!tokens.Mim.block.>.)
(declare-const verus_tmp@ vstd!raw_ptr.PointsToRaw.)
(declare-const points_to_raw@0 vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp$1@ vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>.)
(declare-const new_map@0 vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>.)
(declare-const block@0 Int)
...
(declare-const verus_tmp$3@0 vstd!map.Map<int./lib!tokens.Mim.block.>.)
(declare-const tokens_snap@0 vstd!map.Map<int./lib!tokens.Mim.block.>.)
(declare-const verus_tmp$7@ tuple%2.)
(declare-const points_to$1@0 vstd!raw_ptr.PointsToRaw.)
(declare-const rest$1@0 vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp$8@ tuple%2.)
(declare-const points_to1$1@0 vstd!raw_ptr.PointsToRaw.)
(declare-const points_to2$1@0 vstd!raw_ptr.PointsToRaw.)
(declare-const verus_tmp$9@ vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const points_to_node$1@0 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const block_ptr$1@ ptr_mut%<lib!linked_list.Node.>.)
(assert fuel_defaults)
(assert (uInv SZ bsize!))
(assert (<= 0 extend!))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (Mul (Sub extend! i@0) bsize!) (Add (Mul (Sub extend! (Add i@0 1)) bsize!) bsize!)))))
(check-sat)
(exit)
