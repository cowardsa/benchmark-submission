...
(set-info :comment ";; config.rs:7:1: 7:33 (#0)")
...
(set-info :comment ";; config.rs:12:1: 12:48 (#0)")
...
(set-info :comment ";; config.rs:18:1: 18:48 (#0)")
...
(set-info :comment ";; config.rs:21:1: 21:52 (#0)")
...
(set-info :comment ";; config.rs:15:1: 15:35 (#0)")
...
(set-info :comment ";; config.rs:27:1: 27:65 (#0)")
...
(set-info :comment ";; config.rs:8:1: 8:32 (#0)")
...
(set-info :comment ";; config.rs:54:1: 54:38 (#0)")
...
(set-info :comment ";; config.rs:55:1: 55:59 (#0)")
...
(set-info :comment ";; config.rs:57:1: 57:39 (#0)")
...
(set-info :comment ";; config.rs:29:1: 29:30 (#0)")
...
(set-info :comment ";; config.rs:33:1: 33:40 (#0)")
...
(set-info :comment ";; config.rs:35:1: 35:47 (#0)")
...
(set-info :comment ";; config.rs:36:1: 36:57 (#0)")
...
(set-info :comment ";; config.rs:39:1: 39:61 (#0)")
...
(set-info :comment ";; config.rs:42:1: 42:59 (#0)")
...
(set-info :comment ";; config.rs:61:1: 61:46 (#0)")
...
(set-info :comment ";; config.rs:62:1: 62:42 (#0)")
...
(set-info :comment ";; config.rs:50:1: 50:40 (#0)")
...
(set-info :comment ";; config.rs:51:1: 51:53 (#0)")
...
(set-info :comment ";; config.rs:75:1: 75:41 (#0)")
...
(set-info :comment ";; config.rs:24:1: 24:45 (#0)")
...
(set-info :comment ";; config.rs:38:1: 38:59 (#0)")
...
(set-info :comment ";; config.rs:41:1: 41:59 (#0)")
...
(set-info :comment ";; config.rs:43:1: 43:86 (#0)")
...
(set-info :comment ";; config.rs:44:1: 44:56 (#0)")
...
(set-info :comment ";; config.rs:48:1: 48:55 (#0)")
...
(set-info :comment ";; config.rs:52:1: 52:74 (#0)")
...
(set-info :comment ";; config.rs:59:1: 59:51 (#0)")
...
(set-info :comment ";; config.rs:63:1: 63:37 (#0)")
...
(set-info :comment ";; config.rs:64:1: 64:35 (#0)")
...
(set-info :comment ";; config.rs:76:1: 76:54 (#0)")
...
(set-info :comment ";; config.rs:77:1: 77:82 (#0)")
...
(set-info :comment ";; config.rs:81:1: 81:45 (#0)")
...
(set-info :comment ";; config.rs:85:1: 85:27 (#0)")
(set-info :comment ";; Function-Specs lib::config::option_eager_commit_delay")
(declare-fun ens%lib!config.option_eager_commit_delay. (Int Int) Bool)
(assert (forall ((no%param Int) (%return! Int)) (! (= (ens%lib!config.option_eager_commit_delay. no%param %return!) (iInv 64 %return!)) :pattern ((ens%lib!config.option_eager_commit_delay. no%param %return!)))))
(set-info :comment ";; Function-Def lib::config::option_eager_commit_delay")
(set-info :comment ";; config.rs:118:1: 118:42 (#0)")
(set-info :comment ";; Function-Def lib::config::option_eager_commit")
(set-info :comment ";; config.rs:119:1: 119:37 (#0)")
(set-info :comment ";; Function-Def lib::config::option_allow_decommit")
(set-info :comment ";; config.rs:120:1: 120:39 (#0)")
(set-info :comment ";; Function-Def lib::config::option_page_reset")
(set-info :comment ";; config.rs:121:1: 121:35 (#0)")
(set-info :comment ";; Function-Specs lib::config::option_decommit_delay")
(declare-fun ens%lib!config.option_decommit_delay. (Int Int) Bool)
(assert (forall ((no%param Int) (%return! Int)) (! (= (ens%lib!config.option_decommit_delay. no%param %return!) (iInv 64 %return!)) :pattern ((ens%lib!config.option_decommit_delay. no%param %return!)))))
(set-info :comment ";; Function-Def lib::config::option_decommit_delay")
(set-info :comment ";; config.rs:126:1: 126:38 (#0)")
