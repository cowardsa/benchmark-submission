...
(assert (not (and (=> (has_type s1@ (TYPE%vstd!seq.Seq. T&. T&)) (=> (has_type s2@ (TYPE%vstd!seq.Seq. T&. T&)) (=> (has_type i@ INT) (=> (has_type j@ INT) (=> (has_type k@ INT) (=> (has_type m@ INT) (=> (and (and (and (and (and (<= 0 (%I i@)) (<= (%I i@) (%I j@))) (<= (%I j@) (vstd!seq.Seq.len.? T&. T& s1@))) (<= (%I j@) (vstd!seq.Seq.len.? T&. T& s2@))) (= (vstd!seq.Seq.subrange.? T&. T& s1@ i@ j@) (vstd!seq.Seq.subrange.? T&. T& s2@ i@ j@))) (and (and (<= (%I i@) (%I k@)) (<= (%I k@) (%I m@))) (<= (%I m@) (%I j@)))) (and (=> %%location_label%%0 (req%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. T&. T& s1@ s2@ (%I i@) (%I j@))) (=> (ens%main!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. T&. T& s1@ s2@ (%I i@) (%I j@)) (=> %%location_label%%1 (= (vstd!seq.Seq.subrange.? T&. T& s1@ k@ m@) (vstd!seq.Seq.subrange.? T&. T& s2@ k@ m@)))))))))))) (=> (forall ((s1$ Poly) (s2$ Poly) (i$ Poly) (j$ Poly) (k$ Poly) (m$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!seq.Seq. T&. T&)) (has_type s2$ (TYPE%vstd!seq.Seq. T&. T&)) (has_type i$ INT) (has_type j$ INT) (has_type k$ INT) (has_type m$ INT)) (=> (and (and (and (and (and (<= 0 (%I i$)) (<= (%I i$) (%I j$))) (<= (%I j$) (vstd!seq.Seq.len.? T&. T& s1$))) (<= (%I j$) (vstd!seq.Seq.len.? T&. T& s2$))) (= (vstd!seq.Seq.subrange.? T&. T& s1$ i$ j$) (vstd!seq.Seq.subrange.? T&. T& s2$ i$ j$))) (and (and (<= (%I i$) (%I k$)) (<= (%I k$) (%I m$))) (<= (%I m$) (%I j$)))) (= (vstd!seq.Seq.subrange.? T&. T& s1$ k$ m$) (vstd!seq.Seq.subrange.? T&. T& s2$ k$ m$)))) :pattern ((vstd!seq.Seq.subrange.? T&. T& s1$ i$ j$) (vstd!seq.Seq.subrange.? T&. T& s2$ k$ m$)) :pattern ((vstd!seq.Seq.subrange.? T&. T& s2$ i$ j$) (vstd!seq.Seq.subrange.? T&. T& s1$ k$ m$)))) (=> %%location_label%%2 (forall ((s1$ Poly) (s2$ Poly) (i$ Poly) (j$ Poly) (k$ Poly) (m$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!seq.Seq. T&. T&)) (has_type s2$ (TYPE%vstd!seq.Seq. T&. T&)) (has_type i$ INT) (has_type j$ INT) (has_type k$ INT) (has_type m$ INT)) (=> (and (and (and (and (and (<= 0 (%I i$)) (<= (%I i$) (%I j$))) (<= (%I j$) (vstd!seq.Seq.len.? T&. T& s1$))) (<= (%I j$) (vstd!seq.Seq.len.? T&. T& s2$))) (= (vstd!seq.Seq.subrange.? T&. T& s1$ i$ j$) (vstd!seq.Seq.subrange.? T&. T& s2$ i$ j$))) (and (and (<= (%I i$) (%I k$)) (<= (%I k$) (%I m$))) (<= (%I m$) (%I j$)))) (= (vstd!seq.Seq.subrange.? T&. T& s1$ k$ m$) (vstd!seq.Seq.subrange.? T&. T& s2$ k$ m$)))) :pattern ((vstd!seq.Seq.subrange.? T&. T& s1$ i$ j$) (vstd!seq.Seq.subrange.? T&. T& s2$ k$ m$)) :pattern ((vstd!seq.Seq.subrange.? T&. T& s2$ i$ j$) (vstd!seq.Seq.subrange.? T&. T& s1$ k$ m$)))))))))
(check-sat)
(exit)
