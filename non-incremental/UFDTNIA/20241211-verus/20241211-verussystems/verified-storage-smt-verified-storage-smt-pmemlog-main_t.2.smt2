...
(declare-const pm!@0 Poly)
(declare-const device_size! Int)
(declare-const tmp%1 core!result.Result.)
(assert fuel_defaults)
(assert (has_type pm!@0 PM&))
(assert (uInv 64 device_size!))
(assert (tr_bound%main!pmemspec_t.PersistentMemory. PM&. PM&))
(assert (%B (main!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!@0)))
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@0)) device_size!))
(declare-const pm!@1 Poly)
...
(assert (not (and (=> %%location_label%%0 (req%main!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pm!@0 device_size!)) (=> (has_type pm!@1 PM&) (=> (ens%main!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pm!@0 pm!@1 device_size! tmp%1) (=> (= result! tmp%1) (and (=> %%location_label%%1 (%B (main!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!@1))) (and (=> %%location_label%%2 (= (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!@1) (main!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!@0))) (and (=> %%location_label%%3 (= (vstd!seq.Seq.len.? $ (UINT 8) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@1)) device_size!)) (=> %%location_label%%4 (ite (is-core!result.Result./Ok_ result!) (let ((log_capacity$ (%I (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (= (%Poly%core!option.Option. (%%apply%%0 (main!main_t.recovery_view.? (I 0)) (main!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@1))) (core!option.Option./Some (Poly%main!infinitelog_t.AbstractInfiniteLogState. (main!infinitelog_t.impl&%0.initialize.? (I log_capacity$)))))) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./InsufficientSpaceForSetup_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((required_space$ (main!main_t.InfiniteLogErr./InsufficientSpaceForSetup/required_space (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (< device_size! required_space$))))))))))))))
(check-sat)
(exit)
