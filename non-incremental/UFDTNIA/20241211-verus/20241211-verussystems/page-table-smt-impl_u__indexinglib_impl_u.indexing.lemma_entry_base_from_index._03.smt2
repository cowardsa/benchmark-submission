...
(set-info :comment ";; page-table/impl_u/indexing.rs:110:9: 110:15 (#0)")
...
(assert (not (=> %%location_label%%0 (= (lib!definitions_t.next_entry_base_from_index.? (I base!) (I idx!) (I entry_size!)) (nClip (Add (lib!definitions_t.entry_base_from_index.? (I base!) (I idx!) (I entry_size!)) entry_size!))))))
(check-sat)
(exit)
