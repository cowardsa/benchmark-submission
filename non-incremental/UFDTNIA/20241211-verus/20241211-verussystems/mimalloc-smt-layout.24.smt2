...
(declare-const sid2! lib!tokens.SegmentId.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!tokens.SegmentId. sid!) TYPE%lib!tokens.SegmentId.))
(assert (has_type (Poly%lib!tokens.SegmentId. sid2!) TYPE%lib!tokens.SegmentId.))
(assert (= (lib!tokens.SegmentId./SegmentId/id (%Poly%lib!tokens.SegmentId. (Poly%lib!tokens.SegmentId. sid!))) (lib!tokens.SegmentId./SegmentId/id (%Poly%lib!tokens.SegmentId. (Poly%lib!tokens.SegmentId. sid2!)))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. sid!)) (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. sid2!))))))
(check-sat)
(exit)
