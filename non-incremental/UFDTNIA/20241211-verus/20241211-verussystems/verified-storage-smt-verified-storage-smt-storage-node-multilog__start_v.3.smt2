...
(assert (has_type tmp%1 (TYPE%alloc!vec.Vec. $ TYPE%lib!multilog.multilogimpl_v.LogInfo. $ ALLOCATOR_GLOBAL)))
(assert (has_type tmp%2 (TYPE%core!ops.range.Range. $ (UINT 32))))
(assert (has_type (Poly%core!ops.range.Range. tmp%3) (TYPE%core!ops.range.Range. $ (UINT 32))))
