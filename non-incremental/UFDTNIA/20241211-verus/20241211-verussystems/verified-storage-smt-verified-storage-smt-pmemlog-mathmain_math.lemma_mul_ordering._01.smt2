...
(set-info :comment ";; src/math.rs:41:5: 41:52 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_ordering")
(set-info :comment ";; src/math.rs:41:5: 41:52 (#0)")
(declare-const x! Int)
(declare-const y! Int)
...
(assert (not (=> %%location_label%%0 (and (<= x! (Mul x! y!)) (<= y! (Mul x! y!))))))
(check-sat)
(exit)
