...
(declare-const res! ptr_mut%<lib!types.SegmentHeader.>.)
...
(declare-const block_p@ Int)
(declare-const segment_p@ Int)
...
(assert (not (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. ptr!) block_p@) (=> (fuel_bool fuel%lib!layout.is_block_ptr1.) (=> (ens%lib!config.const_facts. 0) (=> (= tmp%1 (> block_p@ 0)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= id@ (uClip SZ (lib!tokens.SegmentId./SegmentId/id (%Poly%lib!tokens.SegmentId. (Poly%lib!tokens.SegmentId. (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!tokens.BlockId./BlockId/page_id (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. block_id!))))))))))) (=> (= tmp%2 (= id@ (lib!tokens.SegmentId./SegmentId/id (%Poly%lib!tokens.SegmentId. (Poly%lib!tokens.SegmentId. (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!tokens.BlockId./BlockId/page_id (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. block_id!))))))))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (< id@ 549755813887)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (and (=> %%location_label%%3 (and (< (uClip SZ (Mul id@ 33554432)) block_p@) (<= block_p@ (uClip SZ (Add (uClip SZ (Mul id@ 33554432)) 33554432))))) (and (=> %%location_label%%4 (< id@ 549755813887)) (=> (= (uClip SZ (bitand (I (uClip SZ (Sub block_p@ 1))) (I (uClip SZ (bitnot (I 33554431)))))) (uClip SZ (Mul id@ 33554432))) (=> (= tmp%4 (= (uClip SZ (Mul id@ 33554432)) (Mul id@ 33554432))) (and (=> %%location_label%%5 tmp%4) (=> tmp%4 (=> (= tmp%5 (= (uClip SZ (Add (uClip SZ (Mul id@ 33554432)) 33554432)) (Add (Mul id@ 33554432) 33554432))) (and (=> %%location_label%%6 tmp%5) (=> tmp%5 (and (=> %%location_label%%7 (uInv SZ (Sub block_p@ 1))) (and (=> %%location_label%%8 (uInv 64 (Sub lib!config.SEGMENT_SIZE.? 1))) (=> (= segment_p@ (uClip SZ (bitand (I (uClip SZ (Sub block_p@ 1))) (I (uClip SZ (bitnot (I (uClip SZ (uClip 64 (Sub lib!config.SEGMENT_SIZE.? 1)))))))))) (=> (ens%core!ptr.mut_ptr.impl&%0.with_addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. ptr!) segment_p@ tmp%6) (=> (ens%vstd!raw_ptr.cast_ptr_to_thin_ptr. $ (UINT 8) $ TYPE%lib!types.SegmentHeader. tmp%6 tmp%7) (=> (= res! (%Poly%ptr_mut%<lib!types.SegmentHeader.>. tmp%7)) (=> %%location_label%%9 (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. res!) (Poly%lib!tokens.SegmentId. (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!tokens.BlockId./BlockId/page_id (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. block_id!)))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
