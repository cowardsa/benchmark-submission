...
(assert (forall ((s! vstd!set.Set<lib!tokens.HeapId.>.)) (! (= (req%lib!tokens.lemma_heap_get_unused_uniq_field. s!) (=> %%global_location_label%%9 (vstd!set.impl&%0.finite.? $ TYPE%lib!tokens.HeapId. (Poly%vstd!set.Set<lib!tokens.HeapId.>. s!)))) :pattern ((req%lib!tokens.lemma_heap_get_unused_uniq_field. s!)))))
...
(set-info :comment ";; Function-Def lib::tokens::lemma_heap_get_unused_uniq_field")
(set-info :comment ";; tokens.rs:275:1: 275:62 (#0)")
(set-info :comment ";; Function-Specs lib::tokens::segment_u_max_not_in")
(declare-fun req%lib!tokens.segment_u_max_not_in. (vstd!set.Set<lib!tokens.SegmentId.>.) Bool)
(declare-const %%global_location_label%%10 Bool)
(assert (forall ((s! vstd!set.Set<lib!tokens.SegmentId.>.)) (! (= (req%lib!tokens.segment_u_max_not_in. s!) (=> %%global_location_label%%10 (vstd!set.impl&%0.finite.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)))) :pattern ((req%lib!tokens.segment_u_max_not_in. s!)))))
(declare-fun ens%lib!tokens.segment_u_max_not_in. (vstd!set.Set<lib!tokens.SegmentId.>.) Bool)
(assert (forall ((s! vstd!set.Set<lib!tokens.SegmentId.>.)) (! (= (ens%lib!tokens.segment_u_max_not_in. s!) (forall ((id$ Poly)) (! (=> (has_type id$ TYPE%lib!tokens.SegmentId.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!) id$) (< (lib!tokens.SegmentId./SegmentId/uniq (%Poly%lib!tokens.SegmentId. id$)) (Add (lib!tokens.segment_u_max.? (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)) 1)))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!) id$))))) :pattern ((ens%lib!tokens.segment_u_max_not_in. s!)))))
(set-info :comment ";; Function-Def lib::tokens::segment_u_max_not_in")
(set-info :comment ";; tokens.rs:219:7: 219:49 (#0)")
(declare-const s! vstd!set.Set<lib!tokens.SegmentId.>.)
(declare-const tmp%1 Bool)
(declare-const x@ lib!tokens.SegmentId.)
(declare-const t@ vstd!set.Set<lib!tokens.SegmentId.>.)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (vstd!set.impl&%0.finite.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)))
...
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!))) (and (=> %%location_label%%0 (req%vstd!set_lib.lemma_set_empty_equivalency_len. $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!))) (=> (ens%vstd!set_lib.lemma_set_empty_equivalency_len. $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)) (or (and (=> (= (vstd!set.impl&%0.len.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)) 0) (=> (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. $ TYPE%lib!tokens.SegmentId.) (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!) (vstd!set.impl&%0.empty.? $ TYPE%lib!tokens.SegmentId.))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (= (vstd!set.impl&%0.len.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)) 0)) (=> (= x@ (%Poly%lib!tokens.SegmentId. (vstd!set.impl&%0.choose.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)))) (=> (= t@ (%Poly%vstd!set.Set<lib!tokens.SegmentId.>. (vstd!set.impl&%0.remove.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!) (Poly%lib!tokens.SegmentId. x@)))) (and (=> %%location_label%%2 (check_decrease_int (let ((s!$0 t@)) (vstd!set.impl&%0.len.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!$0))) decrease%init0 false)) (and (=> %%location_label%%3 (req%lib!tokens.segment_u_max_not_in. t@)) (=> (ens%lib!tokens.segment_u_max_not_in. t@) %%switch_label%%0))))))) (and (not %%switch_label%%0) (=> %%location_label%%4 (forall ((id$ Poly)) (! (=> (has_type id$ TYPE%lib!tokens.SegmentId.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!) id$) (< (lib!tokens.SegmentId./SegmentId/uniq (%Poly%lib!tokens.SegmentId. id$)) (Add (lib!tokens.segment_u_max.? (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!)) 1)))) :pattern ((vstd!set.impl&%0.contains.? $ TYPE%lib!tokens.SegmentId. (Poly%vstd!set.Set<lib!tokens.SegmentId.>. s!) id$))))))))))))
(check-sat)
(exit)
