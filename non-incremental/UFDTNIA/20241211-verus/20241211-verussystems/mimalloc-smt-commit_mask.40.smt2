...
(set-info :comment ";; Function-Def lib::commit_mask::CommitMask::is_full")
(set-info :comment ";; commit_mask.rs:737:5: 737:38 (#0)")
(set-info :comment ";; Function-Specs lib::commit_mask::set_int_range_commit_size")
(declare-fun req%lib!commit_mask.set_int_range_commit_size. (lib!tokens.SegmentId. lib!commit_mask.CommitMask.) Bool)
(declare-const %%global_location_label%%25 Bool)
(assert (forall ((sid! lib!tokens.SegmentId.) (mask! lib!commit_mask.CommitMask.)) (! (= (req%lib!commit_mask.set_int_range_commit_size. sid! mask!) (=> %%global_location_label%%25 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. mask!))) (I 0)))) :pattern ((req%lib!commit_mask.set_int_range_commit_size. sid! mask!)))))
(declare-fun ens%lib!commit_mask.set_int_range_commit_size. (lib!tokens.SegmentId. lib!commit_mask.CommitMask.) Bool)
(assert (forall ((sid! lib!tokens.SegmentId.) (mask! lib!commit_mask.CommitMask.)) (! (= (ens%lib!commit_mask.set_int_range_commit_size. sid! mask!) (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. sid!))) (I (Add (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. sid!)) lib!config.COMMIT_SIZE.?)))) (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.bytes.? (Poly%lib!commit_mask.CommitMask. mask!) (Poly%lib!tokens.SegmentId. sid!))))) :pattern ((ens%lib!commit_mask.set_int_range_commit_size. sid! mask!)))))
(set-info :comment ";; Function-Def lib::commit_mask::set_int_range_commit_size")
(set-info :comment ";; commit_mask.rs:778:1: 778:73 (#0)")
(declare-const sid! lib!tokens.SegmentId.)
(declare-const mask! lib!commit_mask.CommitMask.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!tokens.SegmentId. sid!) TYPE%lib!tokens.SegmentId.))
(assert (has_type (Poly%lib!commit_mask.CommitMask. mask!) TYPE%lib!commit_mask.CommitMask.))
(assert (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. mask!))) (I 0)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (fuel_bool fuel%lib!commit_mask.impl&%0.bytes.) (=> %%location_label%%0 (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. sid!))) (I (Add (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. sid!)) lib!config.COMMIT_SIZE.?)))) (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.bytes.? (Poly%lib!commit_mask.CommitMask. mask!) (Poly%lib!tokens.SegmentId. sid!))))))))
(check-sat)
(exit)
