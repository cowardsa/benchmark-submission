...
(set-info :comment ";; page-table/extra.rs:99:1: 99:41 (#0)")
...
(set-info :comment ";; Function-Def lib::extra::mul_commute")
(set-info :comment ";; page-table/extra.rs:99:1: 99:41 (#0)")
(declare-const a! Int)
(declare-const b! Int)
...
(assert (not (=> %%location_label%%0 (= (nClip (Mul a! b!)) (nClip (Mul b! a!))))))
(check-sat)
(exit)
