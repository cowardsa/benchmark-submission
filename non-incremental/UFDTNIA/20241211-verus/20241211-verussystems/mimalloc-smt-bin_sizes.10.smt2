...
(declare-const size_start! Poly)
(declare-const size_end! Poly)
...
(assert (has_type size_start! INT))
(assert (has_type size_end! INT))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (Sub (%I size_end!) (%I size_start!))) (or (and (=> (>= (%I size_start!) (%I size_end!)) (=> (= tmp%4 true) %%switch_label%%0)) (=> (not (>= (%I size_start!) (%I size_end!))) (or (and (=> (lib!bin_sizes.property_sbin_bounds.? size_start!) (=> (= tmp%2 (I (Add (%I size_start!) 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((size_start!$0 (%I tmp%2)) (size_end!$1 (%I size_end!))) (Sub size_end!$1 size_start!$0)) decrease%init0 false)) (=> (= tmp%1 (lib!bin_sizes.check_sbin_bounds.? (I (Add (%I size_start!) 1)) size_end!)) (=> (= tmp%3 tmp%1) %%switch_label%%1))))) (=> (not (lib!bin_sizes.property_sbin_bounds.? size_start!)) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 tmp%3) %%switch_label%%0))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
