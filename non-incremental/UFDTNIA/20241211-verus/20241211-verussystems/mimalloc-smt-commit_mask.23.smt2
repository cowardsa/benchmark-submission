...
(assert (not (=> (has_type (Poly%lib!commit_mask.CommitMask. self!@1) TYPE%lib!commit_mask.CommitMask.) (=> (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@0)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@1))))) j$)) (uClip SZ (bitnot (I 0)))))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@1))))) j$)))) (=> (< i@0 8) (=> (= tmp%1 (uClip SZ (bitnot (I 0)))) (and (=> %%location_label%%0 (req%vstd!array.impl&%3.set. $ (UINT SZ) $ (CONST_INT 8) (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@1))) i@0 (I tmp%1))) (=> (has_type (Poly%lib!commit_mask.CommitMask. self!@2) TYPE%lib!commit_mask.CommitMask.) (=> (ens%vstd!array.impl&%3.set. $ (UINT SZ) $ (CONST_INT 8) (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@1))) (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@2))) i@0 (I tmp%1)) (and (=> %%location_label%%1 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (=> %%location_label%%2 (forall ((j$ Poly)) (! (=> (has_type j$ INT) (=> (and (<= 0 (%I j$)) (< (%I j$) i@1)) (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@2))))) j$)) (uClip SZ (bitnot (I 0)))))) :pattern ((vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!@2))))) j$))))))))))))))))
(check-sat)
(exit)
