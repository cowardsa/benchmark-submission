...
(set-info :comment ";; src/math.rs:34:5: 34:71 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_is_distributive_add")
(set-info :comment ";; src/math.rs:34:5: 34:71 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (not (=> %%location_label%%0 (= (Mul x! (Add y! z!)) (Add (Mul x! y!) (Mul x! z!))))))
(check-sat)
(exit)
