...
(declare-const ll! lib!linked_list.LL.)
...
(assert (not (=> (ens%core!ptr.null_mut. $ TYPE%lib!linked_list.Node. tmp%1) (=> (ens%vstd!map.impl&%0.tracked_empty. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) tmp%2) (=> (= ll! (lib!linked_list.LL./LL (%Poly%ptr_mut%<lib!linked_list.Node.>. tmp%1) (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LLData./LLData (%B (B fixed_page!)) (%I (I block_size!)) (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. page_id!)) (%Poly%core!option.Option. (Poly%core!option.Option. heap_id!)) (%Poly%lib!tokens.Mim.Instance. (Poly%lib!tokens.Mim.Instance. instance!)) (%I (I 0))))) (%Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. tmp%2))) (and (=> %%location_label%%0 (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. ll!))) (and (=> %%location_label%%1 (= (lib!linked_list.impl&%2.page_id.? (Poly%lib!linked_list.LL. ll!)) page_id!)) (and (=> %%location_label%%2 (= (lib!linked_list.impl&%2.fixed_page.? (Poly%lib!linked_list.LL. ll!)) fixed_page!)) (and (=> %%location_label%%3 (= (lib!linked_list.impl&%2.instance.? (Poly%lib!linked_list.LL. ll!)) instance!)) (and (=> %%location_label%%4 (= (lib!linked_list.impl&%2.block_size.? (Poly%lib!linked_list.LL. ll!)) block_size!)) (and (=> %%location_label%%5 (= (lib!linked_list.impl&%2.heap_id.? (Poly%lib!linked_list.LL. ll!)) heap_id!)) (=> %%location_label%%6 (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. ll!)) 0)))))))))))))
(check-sat)
(exit)
