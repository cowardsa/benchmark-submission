...
(declare-const %return! main!logimpl_v.PersistentHeader.)
...
(assert (not (=> (= (vstd!seq.Seq.len.? $ (UINT 8) header_seq!) main!logimpl_v.header_size.?) (=> (= tmp%2 (I main!logimpl_v.header_crc_offset.?)) (=> (= tmp%3 (I (Add main!logimpl_v.header_crc_offset.? 8))) (and (=> %%location_label%%0 (req%vstd!seq.Seq.subrange. $ (UINT 8) header_seq! tmp%2 tmp%3)) (=> (= tmp%1 (vstd!seq.Seq.subrange.? $ (UINT 8) header_seq! (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8)))) (and (=> %%location_label%%1 (req%vstd!bytes.spec_u64_from_le_bytes. tmp%1)) (=> (= tmp%5 (I main!logimpl_v.header_head_offset.?)) (=> (= tmp%6 (I main!logimpl_v.header_size.?)) (and (=> %%location_label%%2 (req%vstd!seq.Seq.subrange. $ (UINT 8) header_seq! tmp%5 tmp%6)) (=> (= tmp%4 (vstd!seq.Seq.subrange.? $ (UINT 8) header_seq! (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?))) (=> %%location_label%%3 (req%main!logimpl_v.spec_bytes_to_metadata. tmp%4))))))))))))))
(check-sat)
(exit)
