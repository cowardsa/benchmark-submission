...
(set-info :comment ";; Function-Recommends lib::extra::result_map")
(set-info :comment ";; page-table/extra.rs:196:1: 196:95 (#0)")
...
(set-info :comment ";; Function-Def lib::extra::aligned_transitive_auto")
(set-info :comment ";; page-table/extra.rs:46:1: 46:39 (#0)")
...
(assert (not (and (=> (has_type a@ NAT) (=> (has_type b@ NAT) (=> (has_type c@ NAT) (=> (and (and (and (< 0 (%I b@)) (< 0 (%I c@))) (lib!definitions_t.aligned.? a@ b@)) (lib!definitions_t.aligned.? b@ c@)) (and (=> %%location_label%%0 (req%lib!extra.aligned_transitive. (%I a@) (%I b@) (%I c@))) (=> (ens%lib!extra.aligned_transitive. (%I a@) (%I b@) (%I c@)) (=> %%location_label%%1 (lib!definitions_t.aligned.? a@ c@)))))))) (=> (forall ((a$ Poly) (b$ Poly) (c$ Poly)) (! (=> (and (has_type a$ NAT) (has_type b$ NAT) (has_type c$ NAT)) (=> (and (and (and (< 0 (%I b$)) (< 0 (%I c$))) (lib!definitions_t.aligned.? a$ b$)) (lib!definitions_t.aligned.? b$ c$)) (lib!definitions_t.aligned.? a$ c$))) :pattern ((lib!definitions_t.aligned.? a$ b$) (lib!definitions_t.aligned.? b$ c$)) :pattern ((lib!definitions_t.aligned.? a$ b$) (lib!definitions_t.aligned.? a$ c$)) :pattern ((lib!definitions_t.aligned.? b$ c$) (lib!definitions_t.aligned.? a$ c$)) :pattern ((lib!definitions_t.aligned.? b$ c$) (lib!definitions_t.aligned.? a$ c$)))) (=> %%location_label%%2 (forall ((a$ Poly) (b$ Poly) (c$ Poly)) (! (=> (and (has_type a$ NAT) (has_type b$ NAT) (has_type c$ NAT)) (=> (and (and (and (< 0 (%I b$)) (< 0 (%I c$))) (lib!definitions_t.aligned.? a$ b$)) (lib!definitions_t.aligned.? b$ c$)) (lib!definitions_t.aligned.? a$ c$))) :pattern ((lib!definitions_t.aligned.? a$ b$) (lib!definitions_t.aligned.? b$ c$)) :pattern ((lib!definitions_t.aligned.? a$ b$) (lib!definitions_t.aligned.? a$ c$)) :pattern ((lib!definitions_t.aligned.? b$ c$) (lib!definitions_t.aligned.? a$ c$)) :pattern ((lib!definitions_t.aligned.? b$ c$) (lib!definitions_t.aligned.? a$ c$)))))))))
(check-sat)
(exit)
