...
(declare-const tmp%2 lib!impl_u.l0.PageTableContents.)
(declare-const tmp%3 lib!impl_u.l0.PageTableContents.)
...
(assert (not (=> (= decrease%init0 (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)))) (=> (= decrease%init1 (Sub (lib!impl_u.l1.impl&%1.num_entries.? self!) (%I i!))) (=> (= decrease%init2 1) (or (and (=> (lib!impl_u.l1.impl&%1.inv.? self!) (or (and (=> (>= (%I i!) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))))) (=> (= tmp%2 (lib!impl_u.l0.PageTableContents./PageTableContents (%Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (vstd!map.impl&%0.empty.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry.)) (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!)))) (%I (I (lib!impl_u.l1.impl&%1.upper_vaddr.? self!))) (%I (I (lib!impl_u.l1.impl&%1.upper_vaddr.? self!))))) %%switch_label%%1)) (=> (not (>= (%I i!) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))))) (=> (= tmp%1 (I (nClip (Add (%I i!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!impl_u.l1.Directory. self!)) (i!$1 (%I tmp%1))) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 (check_decrease_int (let ((self!$0 (%Poly%lib!impl_u.l1.Directory. self!)) (i!$1 (%I tmp%1))) (Sub (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!$0)) i!$1)) decrease%init1 (check_decrease_int (let ((self!$0 (%Poly%lib!impl_u.l1.Directory. self!)) (i!$1 (%I tmp%1))) 1) decrease%init2 false)))) (=> (has_type (Poly%lib!impl_u.l0.PageTableContents. rem@) TYPE%lib!impl_u.l0.PageTableContents.) (and (=> %%location_label%%1 (check_decrease_int (let ((self!$0 (%Poly%lib!impl_u.l1.Directory. self!)) (entry!$1 (%I i!))) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 (check_decrease_int (let ((self!$0 (%Poly%lib!impl_u.l1.Directory. self!)) (entry!$1 (%I i!))) (Sub (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!$0)) entry!$1)) decrease%init1 (check_decrease_int (let ((self!$0 (%Poly%lib!impl_u.l1.Directory. self!)) (entry!$1 (%I i!))) 0) decrease%init2 false)))) (=> (has_type (Poly%lib!impl_u.l0.PageTableContents. entry_i@) TYPE%lib!impl_u.l0.PageTableContents.) (=> (= tmp%2 (lib!impl_u.l0.PageTableContents./PageTableContents (%Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (vstd!map_lib.impl&%0.union_prefer_right.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. rem@)))) (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@)))))) (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!)))) (%I (I (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@))))) (%I (I (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. rem@))))))) %%switch_label%%1)))))))) (and (not %%switch_label%%1) (=> (= tmp%3 tmp%2) %%switch_label%%0)))) (=> (not (lib!impl_u.l1.impl&%1.inv.? self!)) (=> (= tmp%3 (%Poly%lib!impl_u.l0.PageTableContents. (vstd!pervasive.arbitrary.? $ TYPE%lib!impl_u.l0.PageTableContents.))) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
