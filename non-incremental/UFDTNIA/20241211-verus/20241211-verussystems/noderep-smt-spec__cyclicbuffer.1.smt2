...
(assert (has_type m! (TYPE%vstd!map.Map. $ NAT $ NAT)))
(assert (has_type idx! NAT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (%I idx!)) (or (and (=> (= (%I idx!) 0) (=> (= tmp%3 (%I (vstd!map.impl&%0.index.? $ NAT $ NAT m! (I 0)))) %%switch_label%%0)) (=> (not (= (%I idx!) 0)) (=> (= tmp%2 (I (nClip (Sub (%I idx!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((m!$0 m!) (idx!$1 tmp%2)) (%I idx!$1)) decrease%init0 false)) (=> (<= 0 tmp%1) (=> (= tmp%1 (lib!spec.cyclicbuffer.map_min_value.? m! (I (nClip (Sub (%I idx!) 1))))) (=> (= tmp%3 (lib!spec.cyclicbuffer.min.? (I tmp%1) (vstd!map.impl&%0.index.? $ NAT $ NAT m! idx!))) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
