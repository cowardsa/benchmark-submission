...
(set-info :comment ";; Function-Specs lib::log::inv_v::lemma_updating_inactive_crc_maintains_invariants")
...
(set-info :comment ";; Function-Def lib::log::inv_v::lemma_updating_inactive_crc_maintains_invariants")
(set-info :comment ";; src/log/inv_v.rs:646:5: 653:6 (#0)")
...
(declare-const tmp%8 lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (= pm_region_view2@ (lib!pmem.pmemspec_t.impl&%6.write.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (I (Add (lib!log.layout_v.get_log_metadata_pos.? (B (not cdb!))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)))) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!))) (and (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!log.layout_v.extract_log_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@))))) (Poly%vstd!seq.Seq<u8.>. (lib!log.layout_v.extract_log_cdb.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (lib!log.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@) (B cdb!)))))) (=> (lib!log.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@) (B cdb!)) (=> (= mem@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (= mem2@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@))))) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_CDB.?) (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem2@) (I lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?)))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (or (and (=> cdb! (=> (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_TRUE.?) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_TRUE.?) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 %%switch_label%%0)))) (=> (not cdb!) (=> (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.extract_bytes.? (Poly%vstd!seq.Seq<u8.>. mem2@) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_METADATA_FOR_CDB_FALSE.?) (I (nClip (Add (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ (UINT 64)))))))))) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 %%switch_label%%0))))) (and (not %%switch_label%%0) (and (=> (= tmp%6 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (= tmp%7 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@))) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. tmp%6 tmp%7) (=> %%location_label%%6 (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@) (I log_id!) (B cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!)))))) (=> (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@) (I log_id!) (B cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!)) (=> (= tmp%8 (lib!pmem.pmemspec_t.impl&%6.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2@))) (and (=> %%location_label%%7 (req%lib!log.inv_v.lemma_metadata_matches_implies_metadata_types_set. pm_region_view! tmp%8 cdb!)) (=> (ens%lib!log.inv_v.lemma_metadata_matches_implies_metadata_types_set. pm_region_view! tmp%8 cdb!) (=> %%location_label%%8 (let ((pm_region_view2$ (lib!pmem.pmemspec_t.impl&%6.write.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (I (Add (lib!log.layout_v.get_log_metadata_pos.? (B (not cdb!))) (%I (lib!pmem.pmcopy_t.SpecPmSized.spec_size_of.? $ TYPE%lib!log.layout_v.LogMetadata.)))) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)))) (and (and (and (lib!log.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2$) (B cdb!)) (lib!log.inv_v.metadata_consistent_with_info.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2$) (I log_id!) (B cdb!) (Poly%lib!log.logimpl_v.LogInfo. info!))) (lib!log.inv_v.info_consistent_with_log_area_in_region.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2$) (Poly%lib!log.logimpl_v.LogInfo. info!) (Poly%lib!log.logspec_t.AbstractLogState. state!))) (lib!log.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view2$))))))))))))))))))))))))))))))
(check-sat)
(exit)
