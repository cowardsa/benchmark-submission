...
(set-info :comment ";; src/math.rs:255:5: 255:71 (#0)")
...
(set-info :comment ";; Function-Def main::math::lemma_mul_is_distributive_sub")
(set-info :comment ";; src/math.rs:255:5: 255:71 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (not (=> %%location_label%%0 (= (Mul x! (Sub y! z!)) (Sub (Mul x! y!) (Mul x! z!))))))
(check-sat)
(exit)
