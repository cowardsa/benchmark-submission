...
(set-info :comment ";; page-table/impl_u/indexing.rs:38:5: 38:11 (#0)")
...
(assert (not (=> %%location_label%%0 (forall ((a$ Poly) (b$ Poly)) (! (=> (and (has_type a$ NAT) (has_type b$ NAT)) (= (lib!impl_u.indexing.nat_mul.? a$ b$) (lib!impl_u.indexing.nat_mul.? b$ a$))) :pattern ((lib!impl_u.indexing.nat_mul.? a$ b$)) :pattern ((lib!impl_u.indexing.nat_mul.? b$ a$)))))))
(check-sat)
(exit)
