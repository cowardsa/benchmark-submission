...
(declare-const bin_idx_start! Int)
(declare-const bin_idx_end! Int)
(declare-const wsize_start! Int)
(declare-const wsize_end! Int)
(declare-const tmp%1 Int)
(declare-const bin_idx@ Poly)
...
(assert (not (=> (= decrease%init0 (Sub bin_idx_end! bin_idx_start!)) (or (and (=> (>= bin_idx_start! bin_idx_end!) %%switch_label%%0) (=> (not (>= bin_idx_start! bin_idx_end!)) (=> (= tmp%1 (Add bin_idx_start! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((bin_idx_start!$0 tmp%1) (bin_idx_end!$1 bin_idx_end!) (wsize_start!$2 wsize_start!) (wsize_end!$3 wsize_end!)) (Sub bin_idx_end!$1 bin_idx_start!$0)) decrease%init0 false)) (=> (ens%lib!bin_sizes.result2_idx_in_range_has_bin_size. tmp%1 bin_idx_end! wsize_start! wsize_end!) (or (and (=> (lib!bin_sizes.check2_idx_in_range_has_bin_size.? (I bin_idx_start!) (I bin_idx_end!) (I wsize_start!) (I wsize_end!)) (and (=> (has_type bin_idx@ INT) (=> (has_type wsize@ INT) (=> (and (and (<= bin_idx_start! (%I bin_idx@)) (< (%I bin_idx@) bin_idx_end!)) (and (<= wsize_start! (%I wsize@)) (< (%I wsize@) wsize_end!))) (=> (ens%lib!bin_sizes.result_idx_in_range_has_bin_size. (%I bin_idx@) wsize_start! wsize_end!) (=> %%location_label%%1 (lib!bin_sizes.property_idx_in_range_has_bin_size.? bin_idx@ wsize@)))))) (=> (forall ((bin_idx$ Poly) (wsize$ Poly)) (! (=> (and (has_type bin_idx$ INT) (has_type wsize$ INT)) (=> (and (and (<= bin_idx_start! (%I bin_idx$)) (< (%I bin_idx$) bin_idx_end!)) (and (<= wsize_start! (%I wsize$)) (< (%I wsize$) wsize_end!))) (lib!bin_sizes.property_idx_in_range_has_bin_size.? bin_idx$ wsize$))) :pattern ((lib!bin_sizes.property_idx_in_range_has_bin_size.? bin_idx$ wsize$)))) %%switch_label%%1))) (=> (not (lib!bin_sizes.check2_idx_in_range_has_bin_size.? (I bin_idx_start!) (I bin_idx_end!) (I wsize_start!) (I wsize_end!))) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0))))))) (and (not %%switch_label%%0) (=> %%location_label%%2 (=> (lib!bin_sizes.check2_idx_in_range_has_bin_size.? (I bin_idx_start!) (I bin_idx_end!) (I wsize_start!) (I wsize_end!)) (forall ((bin_idx$ Poly) (wsize$ Poly)) (! (=> (and (has_type bin_idx$ INT) (has_type wsize$ INT)) (=> (and (and (<= bin_idx_start! (%I bin_idx$)) (< (%I bin_idx$) bin_idx_end!)) (and (<= wsize_start! (%I wsize$)) (< (%I wsize$) wsize_end!))) (lib!bin_sizes.property_idx_in_range_has_bin_size.? bin_idx$ wsize$))) :pattern ((lib!bin_sizes.property_idx_in_range_has_bin_size.? bin_idx$ wsize$)))))))))))
(check-sat)
(exit)
