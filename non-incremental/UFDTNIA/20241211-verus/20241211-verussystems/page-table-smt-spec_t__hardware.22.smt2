...
(assert (not (=> (ens%lib!definitions_t.axiom_max_phyaddr_width_facts. 0) (and (=> %%location_label%%0 (uInv 64 (Sub lib!definitions_t.MAX_PHYADDR_WIDTH.? 1))) (and (=> %%location_label%%1 (uInv 64 (Add (uClip 64 (Sub lib!definitions_t.MAX_PHYADDR_WIDTH.? 1)) 1))) (and (=> %%location_label%%2 (uInv 64 (Sub (uClip 64 (Add (uClip 64 (Sub lib!definitions_t.MAX_PHYADDR_WIDTH.? 1)) 1)) 12))) (and (=> %%location_label%%3 (and (<= 0 (uClip 64 (Sub (uClip 64 (Add (uClip 64 (Sub lib!definitions_t.MAX_PHYADDR_WIDTH.? 1)) 1)) 12))) (< (uClip 64 (Sub (uClip 64 (Add (uClip 64 (Sub lib!definitions_t.MAX_PHYADDR_WIDTH.? 1)) 1)) 12)) 64))) (and (=> %%location_label%%4 (and (<= 0 12) (< 12 64))) (=> (= %return! (uClip 64 (bitshl (I (uClip 64 (bitnot (I (uClip 64 (bitshl (I (uClip 64 (bitnot (I 0)))) (I (uClip 64 (Sub (uClip 64 (Add (uClip 64 (Sub lib!definitions_t.MAX_PHYADDR_WIDTH.? 1)) 1)) 12))))))))) (I 12)))) (=> %%location_label%%5 (= %return! lib!spec_t.hardware.MASK_L3_PG_ADDR_SPEC.?)))))))))))
(check-sat)
(exit)
