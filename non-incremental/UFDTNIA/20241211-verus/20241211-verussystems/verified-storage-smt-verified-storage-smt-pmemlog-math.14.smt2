...
(assert (not (=> (= decrease%init0 (ite (>= u! 0) u! (Sub 0 u!))) (or (and (=> (< u! 0) (=> (= tmp%1 (Add u! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((u!$0 tmp%1) (d!$1 d!) (r!$2 r!)) (ite (>= u!$0 0) u!$0 (Sub 0 u!$0))) decrease%init0 false)) (and (=> %%location_label%%1 (req%main!math.lemma_fundamental_div_mod_converse_helper_1. tmp%1 d! r!)) (=> (ens%main!math.lemma_fundamental_div_mod_converse_helper_1. tmp%1 d! r!) (=> (= tmp%2 (Add (Mul u! d!) r!)) (and (=> %%location_label%%2 (req%main!math.lemma_mod_auto_basics. d! tmp%2)) (=> (ens%main!math.lemma_mod_auto_basics. d! tmp%2) (=> (= tmp%3 (Add u! 1)) (=> (= tmp%4 (Sub 0 1)) (=> (ens%main!math.lemma_mul_is_distributive_add_other_way. d! tmp%3 tmp%4) (=> (= tmp%5 (= (Add (Mul u! d!) r!) (Sub (Add (Mul (Add u! 1) d!) r!) d!))) (and (=> %%location_label%%3 tmp%5) (=> tmp%5 (=> (= tmp%6 (= u! (EucDiv (Add (Mul u! d!) r!) d!))) (and (=> %%location_label%%4 tmp%6) (=> tmp%6 %%switch_label%%0))))))))))))))))) (=> (not (< u! 0)) (or (and (=> (= u! 0) (and (=> %%location_label%%5 (req%main!math.lemma_small_div. r! d!)) (=> (ens%main!math.lemma_small_div. r! d!) (and (=> %%location_label%%6 true) (=> (=> (= u! 0) (= (Mul u! d!) 0)) (=> (= tmp%7 (= u! (EucDiv (Add (Mul u! d!) r!) d!))) (and (=> %%location_label%%7 tmp%7) (=> tmp%7 %%switch_label%%1)))))))) (=> (not (= u! 0)) (=> (= tmp%8 (Sub u! 1)) (and (=> %%location_label%%8 (check_decrease_int (let ((u!$0 tmp%8) (d!$1 d!) (r!$2 r!)) (ite (>= u!$0 0) u!$0 (Sub 0 u!$0))) decrease%init0 false)) (and (=> %%location_label%%9 (req%main!math.lemma_fundamental_div_mod_converse_helper_1. tmp%8 d! r!)) (=> (ens%main!math.lemma_fundamental_div_mod_converse_helper_1. tmp%8 d! r!) (=> (= tmp%9 (Add (Mul (Sub u! 1) d!) r!)) (and (=> %%location_label%%10 (req%main!math.lemma_mod_auto_basics. d! tmp%9)) (=> (ens%main!math.lemma_mod_auto_basics. d! tmp%9) (=> (= tmp%10 (Sub u! 1)) (=> (ens%main!math.lemma_mul_is_distributive_add_other_way. d! tmp%10 1) (=> (= tmp%11 (= (Add (Mul u! d!) r!) (Add (Add (Mul (Sub u! 1) d!) r!) d!))) (and (=> %%location_label%%11 tmp%11) (=> tmp%11 (=> (= tmp%12 (= u! (EucDiv (Add (Mul u! d!) r!) d!))) (and (=> %%location_label%%12 tmp%12) (=> tmp%12 %%switch_label%%1))))))))))))))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%13 (= u! (EucDiv (Add (Mul u! d!) r!) d!))))))))
(check-sat)
(exit)
