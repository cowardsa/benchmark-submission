...
(declare-const tmp%2 vstd!set.Set<nat.>.)
...
(assert (is-core!result.Result./Ok_ (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!))))
...
(assert (not (=> (= tmp%1 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!))))) (I base!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (%Poly%vstd!set.Set<nat.>. (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!))))))) (and (=> %%location_label%%1 (req%lib!impl_u.l0.lemma_set_contains_IMP_len_greater_zero. $ NAT (Poly%vstd!set.Set<nat.>. tmp%2) (I base!))) (=> (ens%lib!impl_u.l0.lemma_set_contains_IMP_len_greater_zero. $ NAT (Poly%vstd!set.Set<nat.>. tmp%2) (I base!)) (and (=> %%location_label%%2 (> (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!)))))) 0)) (and (=> %%location_label%%3 (= (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!))))))))) (vstd!set.impl&%0.remove.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!))))) (I base!)))) (=> %%location_label%%4 (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!)))))))))) (Sub (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!)))))) 1)))))))))))))
(check-sat)
(exit)
