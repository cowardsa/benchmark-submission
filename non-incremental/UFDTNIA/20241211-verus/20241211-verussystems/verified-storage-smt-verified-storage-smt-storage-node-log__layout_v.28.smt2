...
(declare-const recovered_mem@ core!option.Option.)
...
(assert (not (=> (= cdb@ (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!log.layout_v.recover_cdb.? (Poly%vstd!seq.Seq<u8.>. mem!))))))) (=> (= recovered_mem@ (lib!log.layout_v.recover_given_cdb.? (Poly%vstd!seq.Seq<u8.>. mem!) (I log_id!) (B cdb@))) (=> (= tmp%1 (is-core!option.Option./Some_ recovered_mem@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (>= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem!)) (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!log.layout_v.MIN_LOG_AREA_SIZE.?))))))))))
(check-sat)
(exit)
