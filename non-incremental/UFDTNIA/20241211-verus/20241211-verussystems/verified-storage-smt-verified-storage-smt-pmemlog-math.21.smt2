...
(assert (not (or (and (=> (>= x! 0) (and (=> %%location_label%%0 (req%main!math.lemma_mul_is_mul_pos. x! y!)) (=> (ens%main!math.lemma_mul_is_mul_pos. x! y!) %%switch_label%%0))) (=> (not (>= x! 0)) (or (and (=> (<= x! 0) (=> (= tmp%1 (Sub 0 x!)) (and (=> %%location_label%%1 (req%main!math.lemma_mul_is_mul_pos. tmp%1 y!)) (=> (ens%main!math.lemma_mul_is_mul_pos. tmp%1 y!) (=> (= tmp%2 (Sub 0 1)) (=> (= tmp%3 (Sub 0 x!)) (=> (ens%main!math.lemma_mul_is_associative. tmp%2 tmp%3 y!) %%switch_label%%1))))))) (=> (not (<= x! 0)) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%2 (= (Mul x! y!) (main!math.mul_recursive.? (I x!) (I y!))))))))
(check-sat)
(exit)
