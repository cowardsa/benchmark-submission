...
(declare-const entry! Poly)
(declare-const tmp%1 lib!impl_u.l0.PageTableContents.)
(declare-const d@ lib!impl_u.l1.Directory.)
(declare-const tmp%2 vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>.)
...
(declare-const tmp%4 lib!impl_u.l0.PageTableContents.)
...
(assert (has_type entry! NAT))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(declare-const %%switch_label%%2 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)))) (=> (= decrease%init1 (Sub (lib!impl_u.l1.impl&%1.num_entries.? self!) (%I entry!))) (=> (= decrease%init2 0) (or (and (=> (and (lib!impl_u.l1.impl&%1.inv.? self!) (< (%I entry!) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!)))))) (=> (= tmp%%@ (lib!impl_u.l1.impl&%1.entry_bounds.? self! entry!)) (=> (= lower@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= upper@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= tmp%%$1@ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) entry!))) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%$1@) (=> (= tmp%3 (let ((p$ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%$1@))))) (vstd!map.impl&%0.insert.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (vstd!map.impl&%0.empty.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) (I (lib!impl_u.l1.impl&%1.entry_base.? self! entry!)) (Poly%lib!definitions_t.PageTableEntry. p$)))) %%switch_label%%1)) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%$1@)) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%$1@) (=> (= d@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%$1@)))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 d@) (i!$1 0)) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 (check_decrease_int (let ((self!$0 d@) (i!$1 0)) (Sub (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!$0)) i!$1)) decrease%init1 (check_decrease_int (let ((self!$0 d@) (i!$1 0)) 1) decrease%init2 false)))) (=> (has_type (Poly%lib!impl_u.l0.PageTableContents. tmp%1) TYPE%lib!impl_u.l0.PageTableContents.) (=> (= tmp%1 (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d@) (I 0))) (=> (= tmp%2 (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. tmp%1)))) %%switch_label%%2)))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%$1@)) (=> (= tmp%2 (%Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (vstd!map.impl&%0.empty.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry.))) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%3 (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. tmp%2)) %%switch_label%%1))))) (and (not %%switch_label%%1) (=> (= tmp%4 (lib!impl_u.l0.PageTableContents./PageTableContents (%Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. tmp%3) (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!)))) (%I (I lower@)) (%I (I upper@)))) %%switch_label%%0)))))))) (=> (not (and (lib!impl_u.l1.impl&%1.inv.? self!) (< (%I entry!) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))))))) (=> (= tmp%4 (%Poly%lib!impl_u.l0.PageTableContents. (vstd!pervasive.arbitrary.? $ TYPE%lib!impl_u.l0.PageTableContents.))) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
