...
(set-info :comment ";; layout.rs:684:5: 684:11 (#0)")
...
(set-info :comment ";; Function-Specs lib::layout::sub_distribute")
(declare-fun ens%lib!layout.sub_distribute. (Int Int Int) Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (ens%lib!layout.sub_distribute. a! b! c!) (= (Sub (Mul a! c!) (Mul b! c!)) (Mul (Sub a! b!) c!))) :pattern ((ens%lib!layout.sub_distribute. a! b! c!)))))
(set-info :comment ";; Function-Def lib::layout::sub_distribute")
(set-info :comment ";; layout.rs:684:5: 684:11 (#0)")
(declare-const a! Int)
(declare-const b! Int)
(declare-const c! Int)
...
(assert (not (=> %%location_label%%0 (= (Sub (Mul a! c!) (Mul b! c!)) (Mul (Sub a! b!) c!)))))
(check-sat)
(exit)
