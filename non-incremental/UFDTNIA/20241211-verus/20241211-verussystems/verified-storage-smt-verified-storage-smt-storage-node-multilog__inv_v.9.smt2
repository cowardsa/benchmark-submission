...
(assert (lib!multilog.inv_v.no_outstanding_writes_to_active_metadata_in_region.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (B cdb!)))
(assert (lib!multilog.inv_v.metadata_types_set_in_region.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (B cdb!)))
(assert (let ((tmp%%$ lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (< lib!multilog.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.? tmp%%$) (< tmp%%$ (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))))))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (ens%lib!pmem.pmemutil_v.lemma_wherever_no_outstanding_writes_persistent_memory_view_can_only_crash_as_committed. pm_region_view!) (and (=> (has_type s@ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s@) (=> (= tmp%1 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (ens%lib!multilog.layout_v.lemma_establish_subrange_equivalence. (%Poly%vstd!seq.Seq<u8.>. s@) tmp%1) (=> %%location_label%%0 (lib!multilog.inv_v.metadata_types_set_in_region.? s@ (B cdb!))))))) (=> (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$) (lib!multilog.inv_v.metadata_types_set_in_region.? s$ (B cdb!)))) :pattern ((lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$)) :pattern ((lib!multilog.inv_v.metadata_types_set_in_region.? s$ (B cdb!))))) (=> %%location_label%%1 (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$) (lib!multilog.inv_v.metadata_types_set_in_region.? s$ (B cdb!)))) :pattern ((lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$)) :pattern ((lib!multilog.inv_v.metadata_types_set_in_region.? s$ (B cdb!))))))))))))
(check-sat)
(exit)
