...
(declare-const sp! lib!types.SegmentPtr.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!types.SegmentPtr. sp!) TYPE%lib!types.SegmentPtr.))
(assert (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. sp!)))) (Poly%lib!tokens.SegmentId. (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. sp!))))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!config.const_facts. 0) (=> %%location_label%%0 (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. sp!))))) lib!config.SEGMENT_SIZE.?) 0)))))
(check-sat)
(exit)
