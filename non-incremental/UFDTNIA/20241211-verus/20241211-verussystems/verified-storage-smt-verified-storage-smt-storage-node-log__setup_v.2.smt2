...
(assert (forall ((PMRegion&. Dcr) (PMRegion& Type) (pre%pm_region! Poly) (region_size! Int) (log_capacity! Int) (log_id! Int)) (! (= (req%lib!log.setup_v.write_setup_metadata. PMRegion&. PMRegion& pre%pm_region! region_size! log_capacity! log_id!) (and (=> %%global_location_label%%15 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? PMRegion&. PMRegion& pre%pm_region!))) (=> %%global_location_label%%16 (= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pre%pm_region!)) region_size!)) (=> %%global_location_label%%17 (>= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pre%pm_region!)) (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!log.layout_v.MIN_LOG_AREA_SIZE.?))) (=> %%global_location_label%%18 (= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pre%pm_region!)) (Add log_capacity! lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?))) (=> %%global_location_label%%19 (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pre%pm_region!))))) :pattern ((req%lib!log.setup_v.write_setup_metadata. PMRegion&. PMRegion& pre%pm_region! region_size! log_capacity! log_id!)))))
...
(set-info :comment ";; Function-Def lib::log::setup_v::write_setup_metadata")
(set-info :comment ";; src/log/setup_v.rs:199:5: 204:6 (#0)")
(declare-const PMRegion&. Dcr)
(declare-const PMRegion& Type)
(declare-const pm_region!@0 Poly)
(declare-const region_size! Int)
(declare-const log_capacity! Int)
...
(declare-const pm_region_committed@ vstd!seq.Seq<u8.>.)
(assert fuel_defaults)
(assert (has_type pm_region!@0 PMRegion&))
(assert (uInv 64 region_size!))
(assert (uInv 64 log_capacity!))
...
(assert (>= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@0)) (Add lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? lib!log.layout_v.MIN_LOG_AREA_SIZE.?)))
(assert (= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@0)) (Add log_capacity! lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)))
...
(assert (not (and (=> %%location_label%%0 (req%lib!log.setup_v.write_setup_metadata_to_region. PMRegion&. PMRegion& pm_region!@0 region_size! log_id!)) (=> (has_type pm_region!@1 PMRegion&) (=> (ens%lib!log.setup_v.write_setup_metadata_to_region. PMRegion&. PMRegion& pm_region!@0 pm_region!@1 region_size! log_id!) (=> (= flushed_region@ (lib!pmem.pmemspec_t.impl&%6.flush.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1))) (=> (= pm_region_committed@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. flushed_region@))) (and (=> (= tmp%1 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm_region_committed@)) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1)))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. pm_region_committed@) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%6.flush.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1))))))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (= tmp%3 (ext_eq false (TYPE%core!option.Option. $ TYPE%lib!log.logspec_t.AbstractLogState.) (Poly%core!option.Option. (lib!log.layout_v.recover_log.? (Poly%vstd!seq.Seq<u8.>. pm_region_committed@) (I log_capacity!) (I 0) (I 0))) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.initialize.? (I log_capacity!))))))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> %%location_label%%4 (ext_eq false (TYPE%core!option.Option. $ TYPE%lib!log.logspec_t.AbstractLogState.) (Poly%core!option.Option. (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. pm_region_committed@) (I log_id!))) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.initialize.? (I log_capacity!)))))))))))))))) (=> (ext_eq false (TYPE%core!option.Option. $ TYPE%lib!log.logspec_t.AbstractLogState.) (Poly%core!option.Option. (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. pm_region_committed@) (I log_id!))) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.initialize.? (I log_capacity!)))))) (=> (= tmp%4 (= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@1)) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. flushed_region@)))) (and (=> %%location_label%%5 tmp%4) (=> tmp%4 (and (=> %%location_label%%6 (req%lib!pmem.pmemspec_t.PersistentMemoryRegion.flush. PMRegion&. PMRegion& pm_region!@1)) (=> (has_type pm_region!@2 PMRegion&) (=> (ens%lib!pmem.pmemspec_t.PersistentMemoryRegion.flush. PMRegion&. PMRegion& pm_region!@1 pm_region!@2) (and (=> %%location_label%%7 (%B (lib!pmem.pmemspec_t.PersistentMemoryRegion.inv.? PMRegion&. PMRegion& pm_region!@2))) (and (=> %%location_label%%8 (= (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? PMRegion&. PMRegion& pm_region!@2) (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? PMRegion&. PMRegion& pm_region!@0))) (and (=> %%location_label%%9 (= (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2)) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@0)))) (and (=> %%location_label%%10 (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2))) (and (=> %%location_label%%11 (= (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2))) (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.initialize.? (I log_capacity!)))))) (=> %%location_label%%12 (lib!log.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? PMRegion&. PMRegion& pm_region!@2)))))))))))))))))))))))))
(check-sat)
(exit)
