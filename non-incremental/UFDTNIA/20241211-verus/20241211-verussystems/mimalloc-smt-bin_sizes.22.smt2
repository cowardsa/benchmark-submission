...
(assert (not (=> (= decrease%init0 e!) (or (and (=> (<= e! 0) %%switch_label%%0) (=> (not (<= e! 0)) (=> (= tmp%1 (Sub e! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((e!$0 tmp%1)) e!$0) decrease%init0 false)) (=> (ens%lib!bin_sizes.pow2_positive. tmp%1) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%1 (> (lib!bin_sizes.pow2.? (I e!)) 0)))))))
(check-sat)
(exit)
