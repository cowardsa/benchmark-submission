...
(assert (<= (Add pos! len!) 18446744073709551615))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%2 (main!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!)))) (=> (= tmp%3 (main!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%main!main_t.InfiniteLogImpl. (Poly%main!main_t.InfiniteLogImpl. self!)))) (and (=> %%location_label%%0 (req%main!logimpl_v.impl&%0.untrusted_read. $ TYPE%main!main_t.TrustedPermission. PM&. PM& tmp%2 tmp%3 pos! len!)) (=> (ens%main!logimpl_v.impl&%0.untrusted_read. $ TYPE%main!main_t.TrustedPermission. PM&. PM& tmp%2 tmp%3 pos! len! tmp%1) (=> (= result! tmp%1) (=> %%location_label%%1 (let ((state$ (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (main!main_t.impl&%4.view.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!)))))))) (let ((head$ (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. state$))))) (let ((log$ (main!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%main!infinitelog_t.AbstractInfiniteLogState. (Poly%main!infinitelog_t.AbstractInfiniteLogState. state$))))) (ite (is-core!result.Result./Ok_ result!) (let ((bytes$ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((true_bytes$ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. log$) (I (Sub pos! head$)) (I (Sub (Add pos! len!) head$)))))) (and (and (>= pos! head$) (<= (Add pos! len!) (Add head$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. log$))))) (main!main_t.read_correct_modulo_corruption.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes$)) (Poly%vstd!seq.Seq<u8.>. true_bytes$) (B (main!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%main!pmemspec_t.PersistentMemoryConstants. (Poly%main!pmemspec_t.PersistentMemoryConstants. (main!main_t.impl&%4.constants.? PM&. PM& (Poly%main!main_t.InfiniteLogImpl. self!)))))))))) (ite (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./CantReadBeforeHead_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((head_pos$ (main!main_t.InfiniteLogErr./CantReadBeforeHead/head (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (and (< pos! head$) (= head_pos$ head$))) (and (and (is-core!result.Result./Err_ result!) (is-main!main_t.InfiniteLogErr./CantReadPastTail_ (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((tail$ (main!main_t.InfiniteLogErr./CantReadPastTail/tail (%Poly%main!main_t.InfiniteLogErr. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!))))))) (and (> (Add pos! len!) (Add head$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. log$)))) (= tail$ (Add head$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. log$))))))))))))))))))))
(check-sat)
(exit)
