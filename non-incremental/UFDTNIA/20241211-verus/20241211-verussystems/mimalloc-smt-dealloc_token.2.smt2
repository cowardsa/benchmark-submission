...
(set-info :comment ";; Function-Specs lib::dealloc_token::MimDealloc::into_internal")
(declare-fun req%lib!dealloc_token.impl&%1.into_internal. (lib!dealloc_token.MimDealloc. vstd!raw_ptr.PointsToRaw.) Bool)
(declare-const %%global_location_label%%10 Bool)
(declare-const %%global_location_label%%11 Bool)
(assert (forall ((self! lib!dealloc_token.MimDealloc.) (points_to_raw! vstd!raw_ptr.PointsToRaw.)) (! (= (req%lib!dealloc_token.impl&%1.into_internal. self! points_to_raw!) (and (=> %%global_location_label%%10 (vstd!raw_ptr.impl&%11.is_range.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw!) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. (lib!dealloc_token.impl&%1.ptr.? (Poly%lib!dealloc_token.MimDealloc. self!))))) (I (lib!dealloc_token.impl&%1.size.? (Poly%lib!dealloc_token.MimDealloc. self!))))) (=> %%global_location_label%%11 (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw!)) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. (lib!dealloc_token.impl&%1.ptr.? (Poly%lib!dealloc_token.MimDealloc. self!)))))))))) :pattern ((req%lib!dealloc_token.impl&%1.into_internal. self! points_to_raw!)))))
(declare-fun ens%lib!dealloc_token.impl&%1.into_internal. (lib!dealloc_token.MimDealloc. vstd!raw_ptr.PointsToRaw. tuple%2.) Bool)
(assert (forall ((self! lib!dealloc_token.MimDealloc.) (points_to_raw! vstd!raw_ptr.PointsToRaw.) (res! tuple%2.)) (! (= (ens%lib!dealloc_token.impl&%1.into_internal. self! points_to_raw! res!) (and (has_type (Poly%tuple%2. res!) (TYPE%tuple%2. $ TYPE%lib!dealloc_token.MimDeallocInner. $ TYPE%vstd!raw_ptr.PointsToRaw.)) (let ((md$ (%Poly%lib!dealloc_token.MimDeallocInner. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((points_to_raw_full$ (%Poly%vstd!raw_ptr.PointsToRaw. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (and (and (and (and (and (lib!dealloc_token.impl&%0.wf.? (Poly%lib!dealloc_token.MimDeallocInner. md$)) (vstd!raw_ptr.impl&%11.is_range.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw_full$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. (lib!dealloc_token.impl&%1.ptr.? (Poly%lib!dealloc_token.MimDealloc. self!))))) (I (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!dealloc_token.impl&%1.block_id.? (Poly%lib!dealloc_token.MimDealloc. self!)))))))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw_full$)) (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw!)))) (= (lib!dealloc_token.impl&%1.ptr.? (Poly%lib!dealloc_token.MimDealloc. self!)) (lib!dealloc_token.MimDeallocInner./MimDeallocInner/ptr (%Poly%lib!dealloc_token.MimDeallocInner. (Poly%lib!dealloc_token.MimDeallocInner. md$))))) (= (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!dealloc_token.impl&%1.block_id.? (Poly%lib!dealloc_token.MimDealloc. self!))))) (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!tokens.Mim.block_token_data./block_token_data/key (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. (lib!dealloc_token.MimDeallocInner./MimDeallocInner/mim_block (%Poly%lib!dealloc_token.MimDeallocInner. (Poly%lib!dealloc_token.MimDeallocInner. md$))))))))))))) (= (lib!dealloc_token.MimDeallocInner./MimDeallocInner/mim_instance (%Poly%lib!dealloc_token.MimDeallocInner. (Poly%lib!dealloc_token.MimDeallocInner. md$))) (lib!dealloc_token.impl&%1.inst.? (Poly%lib!dealloc_token.MimDealloc. self!)))))))) :pattern ((ens%lib!dealloc_token.impl&%1.into_internal. self! points_to_raw! res!)))))
(set-info :comment ";; Function-Def lib::dealloc_token::MimDealloc::into_internal")
(set-info :comment ";; dealloc_token.rs:123:5: 124:56 (#0)")
(declare-const res! tuple%2.)
(declare-const self! lib!dealloc_token.MimDealloc.)
(declare-const points_to_raw! vstd!raw_ptr.PointsToRaw.)
(declare-const tmp%1 lib!dealloc_token.MimDealloc.)
(declare-const tmp%2 Bool)
(declare-const padding@ vstd!raw_ptr.PointsToRaw.)
(declare-const _size@ Int)
(declare-const inner@ lib!dealloc_token.MimDeallocInner.)
(declare-const p@ vstd!raw_ptr.PointsToRaw.)
(assert fuel_defaults)
(assert (vstd!raw_ptr.impl&%11.is_range.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw!) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. (lib!dealloc_token.impl&%1.ptr.? (Poly%lib!dealloc_token.MimDealloc. self!))))) (I (lib!dealloc_token.impl&%1.size.? (Poly%lib!dealloc_token.MimDealloc. self!)))))
(assert (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw!)) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. (lib!dealloc_token.impl&%1.ptr.? (Poly%lib!dealloc_token.MimDealloc. self!))))))))
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 self!) (=> (= tmp%2 (lib!dealloc_token.impl&%1.wf.? (Poly%lib!dealloc_token.MimDealloc. tmp%1))) (=> tmp%2 (=> (= padding@ (lib!dealloc_token.MimDealloc./MimDealloc/padding (%Poly%lib!dealloc_token.MimDealloc. (Poly%lib!dealloc_token.MimDealloc. self!)))) (=> (= _size@ (lib!dealloc_token.MimDealloc./MimDealloc/_size (%Poly%lib!dealloc_token.MimDealloc. (Poly%lib!dealloc_token.MimDealloc. self!)))) (=> (= inner@ (lib!dealloc_token.MimDealloc./MimDealloc/inner (%Poly%lib!dealloc_token.MimDealloc. (Poly%lib!dealloc_token.MimDealloc. self!)))) (and (=> %%location_label%%0 (req%vstd!raw_ptr.impl&%11.join. points_to_raw! padding@)) (=> (ens%vstd!raw_ptr.impl&%11.join. points_to_raw! padding@ p@) (=> (= res! (tuple%2./tuple%2 (Poly%lib!dealloc_token.MimDeallocInner. inner@) (Poly%vstd!raw_ptr.PointsToRaw. p@))) (=> %%location_label%%1 (let ((md$ (%Poly%lib!dealloc_token.MimDeallocInner. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((points_to_raw_full$ (%Poly%vstd!raw_ptr.PointsToRaw. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (and (and (and (and (and (lib!dealloc_token.impl&%0.wf.? (Poly%lib!dealloc_token.MimDeallocInner. md$)) (vstd!raw_ptr.impl&%11.is_range.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw_full$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. (lib!dealloc_token.impl&%1.ptr.? (Poly%lib!dealloc_token.MimDealloc. self!))))) (I (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!dealloc_token.impl&%1.block_id.? (Poly%lib!dealloc_token.MimDealloc. self!)))))))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw_full$)) (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw!)))) (= (lib!dealloc_token.impl&%1.ptr.? (Poly%lib!dealloc_token.MimDealloc. self!)) (lib!dealloc_token.MimDeallocInner./MimDeallocInner/ptr (%Poly%lib!dealloc_token.MimDeallocInner. (Poly%lib!dealloc_token.MimDeallocInner. md$))))) (= (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!dealloc_token.impl&%1.block_id.? (Poly%lib!dealloc_token.MimDealloc. self!))))) (lib!tokens.BlockId./BlockId/block_size (%Poly%lib!tokens.BlockId. (Poly%lib!tokens.BlockId. (lib!tokens.Mim.block_token_data./block_token_data/key (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. (lib!dealloc_token.MimDeallocInner./MimDeallocInner/mim_block (%Poly%lib!dealloc_token.MimDeallocInner. (Poly%lib!dealloc_token.MimDeallocInner. md$))))))))))))) (= (lib!dealloc_token.MimDeallocInner./MimDeallocInner/mim_instance (%Poly%lib!dealloc_token.MimDeallocInner. (Poly%lib!dealloc_token.MimDeallocInner. md$))) (lib!dealloc_token.impl&%1.inst.? (Poly%lib!dealloc_token.MimDealloc. self!))))))))))))))))))
(check-sat)
(exit)
