...
(assert (not (and (=> (has_type a@ INT) (=> (has_type b@ (UINT SZ)) (=> (and (and (and (<= 0 (%I a@)) (< (%I a@) 8)) (< (%I b@) 64)) (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) a@) b@)) (and (=> %%location_label%%0 (and (and (and (<= 0 (%I a@)) (< (%I a@) 8)) (< (%I b@) 64)) (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) a@) b@))) (=> (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) (vstd!set.impl&%0.new.? $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ (TYPE%fun%1. $ (TYPE%tuple%2. $ INT $ (UINT SZ)) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 0 8 64 $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))))))) (Poly%tuple%2. (tuple%2./tuple%2 a@ b@))) (=> %%location_label%%1 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (I (Add (Mul (%I a@) 64) (%I b@)))))))))) (=> (forall ((a$ Poly) (b$ Poly)) (! (=> (and (has_type a$ INT) (has_type b$ (UINT SZ))) (=> (and (and (and (<= 0 (%I a$)) (< (%I a$) 8)) (< (%I b$) 64)) (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) a$) b$)) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (I (Add (Mul (%I a$) 64) (%I b$)))))) :pattern ((lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) a$) b$)))) (and (=> %%location_label%%2 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) i$) (let ((a$ (EucDiv (%I i$) SZ))) (let ((b$ (uClip SZ (EucMod (%I i$) SZ)))) (and (= (Add (Mul a$ 64) b$) (%I i$)) (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I a$)) (I b$))))))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) i$))))) (=> %%location_label%%3 (forall ((a$ Int) (b$ Int)) (! (=> (uInv SZ b$) (=> (and (and (and (<= 0 a$) (< a$ 8)) (< b$ 64)) (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I a$)) (I b$))) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (I (Add (Mul a$ 64) b$))))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (I (Add (Mul a$ 64) b$))))))))))))
(check-sat)
(exit)
