...
(assert (not (=> (lib!impl_u.l1.impl&%1.inv.? self!) (=> (= tmp%2 (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%3 (I (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%4 (I (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. self!)))) (=> %%location_label%%0 (req%lib!definitions_t.impl&%8.next_entry_base. tmp%2 tmp%3 tmp%4 idx!))))))))
(check-sat)
(exit)
