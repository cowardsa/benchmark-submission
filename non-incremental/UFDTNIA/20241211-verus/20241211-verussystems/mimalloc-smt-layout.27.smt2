...
(set-info :comment ";; Function-Def lib::layout::get_block_start_defn")
(set-info :comment ";; layout.rs:675:1: 675:53 (#0)")
...
(set-info :comment ";; layout.rs:681:1: 681:52 (#0)")
(declare-const a! Int)
(declare-const b! Int)
(declare-const c! Int)
...
(assert (not (and (=> %%location_label%%0 true) (=> (= (Sub (Mul a! c!) (Mul b! c!)) (Mul (Sub a! b!) c!)) (=> %%location_label%%1 (= (Sub (Mul a! c!) (Mul b! c!)) (Mul (Sub a! b!) c!)))))))
(check-sat)
(exit)
