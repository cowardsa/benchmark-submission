...
(declare-const pm1! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)
(declare-const pm2! lib!pmem.pmemspec_t.PersistentMemoryRegionsView.)
...
(assert (lib!multilog.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!) (B cdb!)))
(assert (lib!multilog.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!) (B cdb!)))
(assert (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!)))))
(assert (lib!multilog.inv_v.memory_matches_deserialized_cdb.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!) (B cdb!)))
(assert (lib!multilog.inv_v.active_metadata_is_equal.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!) (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!)))
(assert (= (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!)) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!))))
(assert (> (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!)) 0))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!))))) (= (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!) i$))) (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!) i$)))))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$)))))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!))))) (< lib!multilog.layout_v.ABSOLUTE_POS_OF_LOG_AREA.? (lib!pmem.pmemspec_t.impl&%6.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!) i$)))))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$)))))
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (= log_metadata_pos@ (lib!multilog.layout_v.get_log_metadata_pos.? (B cdb!))) (and (=> (= tmp%1 (lib!multilog.inv_v.log_index_trigger.? (I 0))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!) (I 0))))) (=> (ens%lib!log.inv_v.lemma_auto_smaller_range_of_seq_is_subrange. tmp%2) (=> (= tmp%3 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. (lib!pmem.pmemspec_t.impl&%7.spec_index.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!) (I 0))))) (=> (ens%lib!log.inv_v.lemma_auto_smaller_range_of_seq_is_subrange. tmp%3) (=> %%location_label%%1 (lib!multilog.inv_v.metadata_types_set_in_first_region.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!))) (I 0))))))))))) (=> (lib!multilog.inv_v.metadata_types_set_in_first_region.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!))) (I 0))) (and (=> (has_type i@ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i@) (and (<= 0 (%I i@)) (< (%I i@) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!))))) (=> (= tmp%4 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!))) i@))) (=> (= tmp%5 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!))) i@))) (=> (ens%lib!multilog.layout_v.lemma_establish_subrange_equivalence. tmp%4 tmp%5) (=> (= tmp%6 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!))) i@))) (=> (ens%lib!log.inv_v.lemma_auto_smaller_range_of_seq_is_subrange. tmp%6) (=> %%location_label%%2 (lib!multilog.inv_v.metadata_types_set_in_region.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!))) i@) (B cdb!)))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (lib!multilog.inv_v.log_index_trigger.? i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!pmem.pmemspec_t.impl&%7.len.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm1!))))) (lib!multilog.inv_v.metadata_types_set_in_region.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!))) i$) (B cdb!)))) :pattern ((lib!multilog.inv_v.log_index_trigger.? i$)))) (=> %%location_label%%3 (lib!multilog.inv_v.metadata_types_set.? (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionsView. pm2!)))))))))))))
(check-sat)
(exit)
