...
(set-info :comment ";; MODULE 'module impl_u::l1, function lib::impl_u::l1::Directory::lemma_resolve_structure_assertions'")
...
(assert (forall ((offset! Poly) (entry_size! Poly)) (! (= (req%lib!definitions_t.index_from_offset. offset! entry_size!) (=> %%global_location_label%%25 (> (%I entry_size!) 0))) :pattern ((req%lib!definitions_t.index_from_offset. offset! entry_size!)))))
...
(assert (forall ((base! Poly) (addr! Poly) (entry_size! Poly)) (! (= (req%lib!definitions_t.index_from_base_and_addr. base! addr! entry_size!) (and (=> %%global_location_label%%26 (>= (%I addr!) (%I base!))) (=> %%global_location_label%%27 (> (%I entry_size!) 0)))) :pattern ((req%lib!definitions_t.index_from_base_and_addr. base! addr! entry_size!)))))
...
(assert (forall ((self! Poly) (layer! Poly) (base! Poly) (vaddr! Poly)) (! (= (req%lib!definitions_t.impl&%8.index_for_vaddr. self! layer! base! vaddr!) (and (=> %%global_location_label%%28 (lib!definitions_t.impl&%8.inv.? self!)) (=> %%global_location_label%%29 (< (%I layer!) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!)))))) (=> %%global_location_label%%30 (<= (%I base!) (%I vaddr!))))) :pattern ((req%lib!definitions_t.impl&%8.index_for_vaddr. self! layer! base! vaddr!)))))
...
(assert (forall ((base! Int) (idx! Int) (entry_size! Int)) (! (= (req%lib!impl_u.indexing.lemma_entry_base_from_index. base! idx! entry_size!) (=> %%global_location_label%%31 (< 0 entry_size!))) :pattern ((req%lib!impl_u.indexing.lemma_entry_base_from_index. base! idx! entry_size!)))))
...
(assert (forall ((self! lib!impl_u.l1.Directory.)) (! (= (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. self!) (=> %%global_location_label%%32 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!)))) :pattern ((req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. self!)))))
...
(set-info :comment ";; Function-Specs lib::impl_u::l1::Directory::lemma_resolve_structure_assertions")
(declare-fun req%lib!impl_u.l1.impl&%1.lemma_resolve_structure_assertions. (lib!impl_u.l1.Directory. Int Int) Bool)
(declare-const %%global_location_label%%36 Bool)
(declare-const %%global_location_label%%37 Bool)
(declare-const %%global_location_label%%38 Bool)
(assert (forall ((self! lib!impl_u.l1.Directory.) (vaddr! Int) (idx! Int)) (! (= (req%lib!impl_u.l1.impl&%1.lemma_resolve_structure_assertions. self! vaddr! idx!) (and (=> %%global_location_label%%36 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!))) (=> %%global_location_label%%37 (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) (I vaddr!))) (=> %%global_location_label%%38 (= idx! (lib!impl_u.l1.impl&%1.index_for_vaddr.? (Poly%lib!impl_u.l1.Directory. self!) (I vaddr!)))))) :pattern ((req%lib!impl_u.l1.impl&%1.lemma_resolve_structure_assertions. self! vaddr! idx!)))))
(declare-fun ens%lib!impl_u.l1.impl&%1.lemma_resolve_structure_assertions. (lib!impl_u.l1.Directory. Int Int) Bool)
(assert (forall ((self! lib!impl_u.l1.Directory.) (vaddr! Int) (idx! Int)) (! (= (ens%lib!impl_u.l1.impl&%1.lemma_resolve_structure_assertions. self! vaddr! idx!) (=> (is-lib!impl_u.l1.NodeEntry./Directory_ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (I idx!)))) (let ((d$ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (I idx!)))))) (and (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d$))) (I vaddr!)) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. d$)))))) :pattern ((ens%lib!impl_u.l1.impl&%1.lemma_resolve_structure_assertions. self! vaddr! idx!)))))
(set-info :comment ";; Function-Def lib::impl_u::l1::Directory::lemma_resolve_structure_assertions")
(set-info :comment ";; page-table/impl_u/l1.rs:689:5: 689:80 (#0)")
...
(declare-const p@ lib!definitions_t.PageTableEntry.)
...
(assert (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. self!))) (I vaddr!)))
(assert (= idx! (lib!impl_u.l1.impl&%1.index_for_vaddr.? (Poly%lib!impl_u.l1.Directory. self!) (I vaddr!))))
...
(assert (not (=> (ens%lib!impl_u.l0.ambient_lemmas1. 0) (=> (ens%lib!impl_u.l1.ambient_lemmas2. 0) (=> (= tmp%1 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%2 (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%0 (req%lib!impl_u.indexing.lemma_entry_base_from_index. tmp%1 idx! tmp%2)) (=> (ens%lib!impl_u.indexing.lemma_entry_base_from_index. tmp%1 idx! tmp%2) (=> (= tmp%3 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%4 (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!))) (=> (= tmp%5 (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%1 (req%lib!impl_u.indexing.lemma_index_from_base_and_addr. tmp%3 vaddr! tmp%4 tmp%5)) (=> (ens%lib!impl_u.indexing.lemma_index_from_base_and_addr. tmp%3 vaddr! tmp%4 tmp%5) (=> (= tmp%%@ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (I idx!)))) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@) (=> (= p@ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@)))) %%switch_label%%0)) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@)) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@) (=> (= d@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@)))) (and (=> %%location_label%%2 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. d@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. d@) (=> (= tmp%6 (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d@))) (I vaddr!))) (and (=> %%location_label%%3 tmp%6) (=> tmp%6 %%switch_label%%1))))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@)) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%4 (=> (is-lib!impl_u.l1.NodeEntry./Directory_ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (I idx!)))) (let ((d$ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (I idx!)))))) (and (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. d$))) (I vaddr!)) (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. d$))))))))))))))))))))))
(check-sat)
(exit)
