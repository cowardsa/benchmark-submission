...
(set-info :comment ";; page-table/definitions_u.rs:196:13: 196:19 (#0)")
...
(assert (not (=> (= i! j!) (=> (> (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) 0) (=> %%location_label%%0 (lib!definitions_t.aligned.? (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!))) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I j!)))))))))
(check-sat)
(exit)
