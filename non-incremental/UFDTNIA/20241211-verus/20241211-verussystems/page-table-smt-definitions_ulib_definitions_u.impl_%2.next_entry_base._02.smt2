...
(set-info :comment ";; page-table/definitions_u.rs:175:13: 175:19 (#0)")
...
(assert (not (=> (and (<= 0 offset@) (<= offset@ (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1)))) (=> (and (<= 0 base!) (<= base! lib!definitions_t.MAX_BASE.?)) (=> %%location_label%%0 (<= (Add base! offset@) (Add lib!definitions_t.MAX_BASE.? (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1)))))))))
(check-sat)
(exit)
