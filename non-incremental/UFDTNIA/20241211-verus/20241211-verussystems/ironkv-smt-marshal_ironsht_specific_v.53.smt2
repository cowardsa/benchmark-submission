...
(set-info :comment ";; Function-Specs lib::keys_t::SHTKey::view_equal_spec")
(declare-fun ens%lib!marshal_ironsht_specific_v.impl&%0.view_equal_spec. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!marshal_ironsht_specific_v.impl&%0.view_equal_spec. no%param) (forall ((x$ Poly) (y$ Poly)) (! (=> (and (has_type x$ TYPE%lib!keys_t.SHTKey.) (has_type y$ TYPE%lib!keys_t.SHTKey.)) (= (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!keys_t.SHTKey. x$ y$)) (= x$ y$))) :pattern ((lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!keys_t.SHTKey. x$ y$))))) :pattern ((ens%lib!marshal_ironsht_specific_v.impl&%0.view_equal_spec. no%param)))))
(set-info :comment ";; Function-Def lib::keys_t::SHTKey::view_equal_spec")
(set-info :comment ";; ironsht/src/marshal_ironsht_specific_v.rs:43:9: 43:39 (#0)")
(declare-const no%param Int)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (forall ((x$ Poly) (y$ Poly)) (! (=> (and (has_type x$ TYPE%lib!keys_t.SHTKey.) (has_type y$ TYPE%lib!keys_t.SHTKey.)) (= (%B (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!keys_t.SHTKey. x$ y$)) (= x$ y$))) :pattern ((lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!keys_t.SHTKey. x$ y$)))))))
(check-sat)
(exit)
