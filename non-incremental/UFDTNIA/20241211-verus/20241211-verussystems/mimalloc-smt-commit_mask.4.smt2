...
(assert (uInv 64 b!))
(assert (uInv 64 hi!))
(assert (not (= (uClip 64 (bitand (I a!) (I b!))) b!)))
(assert (<= hi! 64))
(assert (= (uClip 64 (bitshr (I a!) (I hi!))) 0))
(assert (= (uClip 64 (bitshr (I b!) (I hi!))) 0))
...
(assert (not (=> (= decrease%init0 hi!) (and (=> %%location_label%%0 (not (= (uClip 64 (bitand (I a!) (I b!))) b!))) (and (=> %%location_label%%1 (<= hi! 64)) (and (=> %%location_label%%2 (= (uClip 64 (bitshr (I a!) (I hi!))) 0)) (and (=> %%location_label%%3 (= (uClip 64 (bitshr (I b!) (I hi!))) 0)) (=> (not (= hi! 0)) (and (=> %%location_label%%4 true) (=> (= (uClip 64 (bitshl (I 1) (I 0))) 1) (or (and (=> (and (not (= (uClip 64 (bitand (I a!) (I 1))) 1)) (= (uClip 64 (bitand (I b!) (I 1))) 1)) (=> (= i! 0) (and (=> %%location_label%%5 (< i! hi!)) (and (=> %%location_label%%6 (not (= (uClip 64 (bitand (I a!) (I (uClip 64 (bitshl (I 1) (I i!)))))) (uClip 64 (bitshl (I 1) (I i!)))))) (=> %%location_label%%7 (= (uClip 64 (bitand (I b!) (I (uClip 64 (bitshl (I 1) (I i!)))))) (uClip 64 (bitshl (I 1) (I i!))))))))) (=> (not (and (not (= (uClip 64 (bitand (I a!) (I 1))) 1)) (= (uClip 64 (bitand (I b!) (I 1))) 1))) (and (=> %%location_label%%8 (not (and (not (= (uClip 64 (bitand (I a!) (I 1))) 1)) (= (uClip 64 (bitand (I b!) (I 1))) 1)))) (and (=> %%location_label%%9 (not (= (uClip 64 (bitand (I a!) (I b!))) b!))) (and (=> %%location_label%%10 (= (uClip 64 (bitshr (I a!) (I hi!))) 0)) (and (=> %%location_label%%11 (= (uClip 64 (bitshr (I b!) (I hi!))) 0)) (=> (and (and (not (= (uClip 64 (bitand (I (uClip 64 (bitshr (I a!) (I 1)))) (I (uClip 64 (bitshr (I b!) (I 1)))))) (uClip 64 (bitshr (I b!) (I 1))))) (= (uClip 64 (bitshr (I (uClip 64 (bitshr (I a!) (I 1)))) (I (uClip 64 (Sub hi! 1))))) 0)) (= (uClip 64 (bitshr (I (uClip 64 (bitshr (I b!) (I 1)))) (I (uClip 64 (Sub hi! 1))))) 0)) (=> (= tmp%1 (uClip 64 (bitshr (I a!) (I 1)))) (=> (= tmp%2 (uClip 64 (bitshr (I b!) (I 1)))) (=> (= tmp%3 (uClip 64 (Sub hi! 1))) (and (=> %%location_label%%12 (check_decrease_int (let ((a!$0 tmp%1) (b!$1 tmp%2) (hi!$2 tmp%3)) hi!$2) decrease%init0 false)) (and (=> %%location_label%%13 (req%lib!commit_mask.lemma_obtain_bit_index_3_aux. tmp%1 tmp%2 tmp%3)) (=> (ens%lib!commit_mask.lemma_obtain_bit_index_3_aux. tmp%1 tmp%2 tmp%3 j@) (and (=> %%location_label%%14 (not (= (uClip 64 (bitand (I (uClip 64 (bitshr (I a!) (I 1)))) (I (uClip 64 (bitshl (I 1) (I j@)))))) (uClip 64 (bitshl (I 1) (I j@)))))) (and (=> %%location_label%%15 (= (uClip 64 (bitand (I (uClip 64 (bitshr (I b!) (I 1)))) (I (uClip 64 (bitshl (I 1) (I j@)))))) (uClip 64 (bitshl (I 1) (I j@))))) (and (=> %%location_label%%16 (< j@ 64)) (=> (and (not (= (uClip 64 (bitand (I a!) (I (uClip 64 (bitshl (I 1) (I (uClip 64 (Add j@ 1)))))))) (uClip 64 (bitshl (I 1) (I (uClip 64 (Add j@ 1))))))) (= (uClip 64 (bitand (I b!) (I (uClip 64 (bitshl (I 1) (I (uClip 64 (Add j@ 1)))))))) (uClip 64 (bitshl (I 1) (I (uClip 64 (Add j@ 1))))))) %%switch_label%%0))))))))))))))))) (and (not %%switch_label%%0) (=> (= i! (uClip 64 (Add j@ 1))) (and (=> %%location_label%%17 (< i! hi!)) (and (=> %%location_label%%18 (not (= (uClip 64 (bitand (I a!) (I (uClip 64 (bitshl (I 1) (I i!)))))) (uClip 64 (bitshl (I 1) (I i!)))))) (=> %%location_label%%19 (= (uClip 64 (bitand (I b!) (I (uClip 64 (bitshl (I 1) (I i!)))))) (uClip 64 (bitshl (I 1) (I i!))))))))))))))))))))
(check-sat)
(exit)
