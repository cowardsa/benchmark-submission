...
(assert (and (<= 0 size!) (<= size! (nClip (Mul 128 8)))))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(assert (not (=> (lib!bin_sizes.check_bounds_for_smallest_bitting_size.? (I 0) (I (Add (nClip (Mul 128 8)) 1))) (=> (= tmp%1 (nClip (Add (nClip (Mul 128 8)) 1))) (=> (ens%lib!bin_sizes.result_bounds_for_smallest_bitting_size. 0 tmp%1) (=> (= tmp%2 (lib!bin_sizes.property_bounds_for_smallest_bitting_size.? (I size!))) (and (=> %%location_label%%0 tmp%2) (=> tmp%2 (and (=> %%location_label%%1 (lib!bin_sizes.valid_bin_idx.? (I (lib!bin_sizes.smallest_bin_fitting_size.? (I size!))))) (=> %%location_label%%2 (>= (lib!bin_sizes.size_of_bin.? (I (lib!bin_sizes.smallest_bin_fitting_size.? (I size!)))) size!)))))))))))
(check-sat)
(exit)
