...
(set-info :comment ";; Function-Def lib::definitions_u::permissive_flags")
(set-info :comment ";; page-table/definitions_u.rs:41:1: 45:3 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_u::lemma_new_seq")
(set-info :comment ";; page-table/definitions_u.rs:19:1: 19:44 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::Arch::lemma_entry_sizes_aligned")
(set-info :comment ";; page-table/definitions_u.rs:186:5: 186:65 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::Arch::lemma_entry_sizes_aligned_auto")
(set-info :comment ";; page-table/definitions_u.rs:220:5: 220:54 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::ArchExec::entry_size")
(set-info :comment ";; page-table/definitions_u.rs:105:5: 105:58 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::ArchExec::index_for_vaddr")
(set-info :comment ";; page-table/definitions_u.rs:119:5: 119:90 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::Arch::lemma_entry_sizes_increase")
(set-info :comment ";; page-table/definitions_u.rs:233:5: 233:66 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::ArchExec::num_entries")
(set-info :comment ";; page-table/definitions_u.rs:112:5: 112:59 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_u::aligned_exec")
(set-info :comment ";; page-table/definitions_u.rs:31:1: 31:65 (#0)")
(set-info :comment ";; Function-Def lib::definitions_t::ArchLayerExec::clone")
(set-info :comment ";; page-table/definitions_u.rs:81:5: 81:28 (#0)")
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Function-Def lib::definitions_u::lemma_maxphyaddr_facts")
(set-info :comment ";; page-table/definitions_u.rs:10:1: 10:38 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_u::overflow_bounds")
(set-info :comment ";; page-table/definitions_u.rs:48:1: 48:31 (#0)")
...
(set-info :comment ";; page-table/definitions_u.rs:157:5: 157:88 (#0)")
...
(assert (has_type (Poly%lib!definitions_t.ArchExec. self!) TYPE%lib!definitions_t.ArchExec.))
(assert (uInv SZ layer!))
(assert (uInv SZ base!))
(assert (uInv SZ idx!))
(assert (lib!definitions_t.impl&%8.inv.? (Poly%lib!definitions_t.Arch. (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. self!)))))
(assert (< layer! (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. self!)))))))))
(assert (<= base! lib!definitions_t.MAX_BASE.?))
(assert (<= idx! lib!definitions_t.X86_NUM_ENTRIES.?))
...
(assert (not (=> (ens%lib!definitions_u.overflow_bounds. 0) (=> (= es@ (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. self!))) (I layer!))) (and (=> %%location_label%%0 (<= es@ lib!definitions_t.X86_MAX_ENTRY_SIZE.?)) (and (=> %%location_label%%1 (<= idx! lib!definitions_t.X86_NUM_ENTRIES.?)) (=> (let ((tmp%%$ (Mul (Add idx! 1) es@))) (and (<= 0 tmp%%$) (<= tmp%%$ (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1))))) (and (=> %%location_label%%2 (uInv SZ (Add idx! 1))) (and (=> %%location_label%%3 (req%lib!definitions_u.impl&%2.entry_size. self! layer!)) (=> (ens%lib!definitions_u.impl&%2.entry_size. self! layer! tmp%1) (and (=> %%location_label%%4 (uInv SZ (Mul (uClip SZ (Add idx! 1)) tmp%1))) (=> (= offset@ (uClip SZ (Mul (uClip SZ (Add idx! 1)) tmp%1))) (and (=> %%location_label%%5 (and (<= 0 offset@) (<= offset@ (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1))))) (and (=> %%location_label%%6 (and (<= 0 base!) (<= base! lib!definitions_t.MAX_BASE.?))) (=> (<= (Add base! offset@) (Add lib!definitions_t.MAX_BASE.? (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1)))) (and (=> %%location_label%%7 (uInv SZ (Add base! offset@))) (=> (= res! (uClip SZ (Add base! offset@))) (=> %%location_label%%8 (= res! (lib!definitions_t.next_entry_base_from_index.? (I base!) (I idx!) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. self!))) (I layer!)))))))))))))))))))))))
(check-sat)
(exit)
