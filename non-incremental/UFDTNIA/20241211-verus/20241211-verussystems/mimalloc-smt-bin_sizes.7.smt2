...
(assert (not (=> (= decrease%init0 (Sub (%I bin_idx_end!) (%I bin_idx_start!))) (or (and (=> (>= (%I bin_idx_start!) (%I bin_idx_end!)) (=> (= tmp%4 true) %%switch_label%%0)) (=> (not (>= (%I bin_idx_start!) (%I bin_idx_end!))) (or (and (=> (lib!bin_sizes.property_smallest_bin_fitting_size_size_of_bin.? bin_idx_start!) (=> (= tmp%2 (I (Add (%I bin_idx_start!) 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((bin_idx_start!$0 (%I tmp%2)) (bin_idx_end!$1 (%I bin_idx_end!))) (Sub bin_idx_end!$1 bin_idx_start!$0)) decrease%init0 false)) (=> (= tmp%1 (lib!bin_sizes.check_smallest_bin_fitting_size_size_of_bin.? (I (Add (%I bin_idx_start!) 1)) bin_idx_end!)) (=> (= tmp%3 tmp%1) %%switch_label%%1))))) (=> (not (lib!bin_sizes.property_smallest_bin_fitting_size_size_of_bin.? bin_idx_start!)) (=> (= tmp%3 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%4 tmp%3) %%switch_label%%0))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
