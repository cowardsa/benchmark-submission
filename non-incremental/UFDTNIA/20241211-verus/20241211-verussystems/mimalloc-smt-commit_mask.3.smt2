...
(assert (not (=> (= m@ (uClip SZ (uClip SZ (bitshl (I (uClip SZ (Sub (uClip SZ (bitshl (I 1) (I n!))) 1))) (I o!))))) (and (=> (has_type j@ (UINT SZ)) (=> (= j$1@ (uClip 64 (%I j@))) (=> (= m$1@ (uClip 64 m@)) (=> (= o@ (uClip 64 o!)) (=> (= n@ (uClip 64 n!)) (=> (fuel_bool fuel%lib!commit_mask.is_bit_set.) (or (and (=> (< j$1@ 64) (and (=> %%location_label%%0 (< j$1@ 64)) (and (=> %%location_label%%1 (= m$1@ (uClip 64 (uClip 64 (bitshl (I (uClip 64 (Sub (uClip 64 (bitshl (I 1) (I n@))) 1))) (I o@)))))) (=> (=> (< j$1@ o@) (not (= (uClip 64 (bitand (I m$1@) (I (uClip 64 (bitshl (I 1) (I j$1@)))))) (uClip 64 (bitshl (I 1) (I j$1@)))))) (and (=> %%location_label%%2 (< j$1@ 64)) (and (=> %%location_label%%3 (= m$1@ (uClip 64 (uClip 64 (bitshl (I (uClip 64 (Sub (uClip 64 (bitshl (I 1) (I n@))) 1))) (I o@)))))) (=> (=> (and (<= o@ j$1@) (< j$1@ (uClip 64 (Add o@ n@)))) (= (uClip 64 (bitand (I m$1@) (I (uClip 64 (bitshl (I 1) (I j$1@)))))) (uClip 64 (bitshl (I 1) (I j$1@))))) (and (=> %%location_label%%4 (< n@ 64)) (and (=> %%location_label%%5 (< j$1@ 64)) (and (=> %%location_label%%6 (= m$1@ (uClip 64 (uClip 64 (bitshl (I (uClip 64 (Sub (uClip 64 (bitshl (I 1) (I n@))) 1))) (I o@)))))) (=> (=> (and (<= (uClip 64 (Add o@ n@)) j$1@) (< j$1@ 64)) (not (= (uClip 64 (bitand (I m$1@) (I (uClip 64 (bitshl (I 1) (I j$1@)))))) (uClip 64 (bitshl (I 1) (I j$1@)))))) %%switch_label%%0))))))))))) (=> (not (< j$1@ 64)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%7 (and (and (=> (< (%I j@) o!) (not (lib!commit_mask.is_bit_set.? (I m@) j@))) (=> (and (<= o! (%I j@)) (< (%I j@) (Add o! n!))) (lib!commit_mask.is_bit_set.? (I m@) j@))) (=> (and (<= (Add o! n!) (%I j@)) (< (%I j@) 64)) (not (lib!commit_mask.is_bit_set.? (I m@) j@))))))))))))) (=> (forall ((j$ Poly)) (! (=> (has_type j$ (UINT SZ)) (and (and (=> (< (%I j$) o!) (not (lib!commit_mask.is_bit_set.? (I m@) j$))) (=> (and (<= o! (%I j$)) (< (%I j$) (Add o! n!))) (lib!commit_mask.is_bit_set.? (I m@) j$))) (=> (and (<= (Add o! n!) (%I j$)) (< (%I j$) 64)) (not (lib!commit_mask.is_bit_set.? (I m@) j$))))) :pattern ((lib!commit_mask.is_bit_set.? (I m@) j$)))) (=> %%location_label%%8 (let ((m$ (uClip SZ (bitshl (I (uClip SZ (Sub (uClip SZ (bitshl (I 1) (I n!))) 1))) (I o!))))) (and (and (forall ((j$ Poly)) (! (=> (has_type j$ (UINT SZ)) (=> (< (%I j$) o!) (not (lib!commit_mask.is_bit_set.? (I m$) j$)))) :pattern ((lib!commit_mask.is_bit_set.? (I m$) j$)))) (forall ((j$ Poly)) (! (=> (has_type j$ (UINT SZ)) (=> (and (<= o! (%I j$)) (< (%I j$) (Add o! n!))) (lib!commit_mask.is_bit_set.? (I m$) j$))) :pattern ((lib!commit_mask.is_bit_set.? (I m$) j$))))) (forall ((j$ Poly)) (! (=> (has_type j$ (UINT SZ)) (=> (and (<= (Add o! n!) (%I j$)) (< (%I j$) 64)) (not (lib!commit_mask.is_bit_set.? (I m$) j$)))) :pattern ((lib!commit_mask.is_bit_set.? (I m$) j$))))))))))))
(check-sat)
(exit)
