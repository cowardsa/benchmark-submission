...
(set-info :comment ";; page-table/extra.rs:104:1: 104:44 (#0)")
...
(set-info :comment ";; Function-Def lib::extra::div_mul_cancel")
(set-info :comment ";; page-table/extra.rs:104:1: 104:44 (#0)")
(declare-const a! Int)
(declare-const b! Int)
...
(assert (not (=> %%location_label%%0 (= (nClip (Mul (nClip (EucDiv a! b!)) b!)) a!))))
(check-sat)
(exit)
