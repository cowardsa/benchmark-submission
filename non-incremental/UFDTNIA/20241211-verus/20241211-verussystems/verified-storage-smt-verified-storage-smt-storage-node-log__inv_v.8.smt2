...
(assert (and (and (and (and (<= 0 i!) (<= i! k!)) (<= k! l!)) (<= l! j!)) (<= j! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!)))))
...
(assert (not (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I k!) (I l!)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I (Sub (Add i! k!) i!)) (I (Sub (Add i! l!) i!))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I i!) (I j!)) (I (Sub k! i!)) (I (Sub l! i!))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I (Sub (Add i! k!) i!)) (I (Sub (Add i! l!) i!))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> %%location_label%%2 (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I i!) (I j!)) (I (Sub k! i!)) (I (Sub l! i!))) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. mem1!) (I k!) (I l!))))))))))))
(check-sat)
(exit)
