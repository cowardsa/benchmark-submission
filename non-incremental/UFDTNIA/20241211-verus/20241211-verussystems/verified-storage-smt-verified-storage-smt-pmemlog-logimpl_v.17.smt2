...
(declare-const crc_bytes! vstd!seq.Seq<u8.>.)
(declare-const metadata_bytes! vstd!seq.Seq<u8.>.)
(declare-const header_bytes! vstd!seq.Seq<u8.>.)
...
(declare-const tmp%7 main!logimpl_v.PersistentHeaderMetadata.)
(declare-const tmp%8 Bool)
(declare-const header@ main!logimpl_v.PersistentHeader.)
(assert fuel_defaults)
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!)) 8))
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)) (Sub main!logimpl_v.header_size.? 8)))
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!)) main!logimpl_v.header_size.?))
(assert (let ((header$ (main!logimpl_v.PersistentHeader./PersistentHeader (%I (I (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. crc_bytes!)))) (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))))))) (= (main!logimpl_v.spec_bytes_to_header.? (Poly%vstd!seq.Seq<u8.>. header_bytes!)) header$)))
...
(assert (not (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> (= header@ (main!logimpl_v.PersistentHeader./PersistentHeader (%I (I (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. crc_bytes!)))) (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)))))) (=> (= tmp%1 (= (main!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@))) (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. crc_bytes!)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_crc_offset.?) (I (Add main!logimpl_v.header_crc_offset.? 8))) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I (main!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@)))))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I (main!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@)))))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (ext_eq false TYPE%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@)))) (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (ext_eq false TYPE%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@)))) (Poly%main!logimpl_v.PersistentHeaderMetadata. (main!logimpl_v.spec_bytes_to_metadata.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)))))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= tmp%6 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)))) (=> (= tmp%7 (main!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%main!logimpl_v.PersistentHeader. (Poly%main!logimpl_v.PersistentHeader. header@)))) (and (=> %%location_label%%5 (req%main!logimpl_v.lemma_metadata_bytes_eq. metadata_bytes! tmp%6 tmp%7)) (=> (ens%main!logimpl_v.lemma_metadata_bytes_eq. metadata_bytes! tmp%6 tmp%7) (=> (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I main!logimpl_v.header_head_offset.?) (I main!logimpl_v.header_size.?)) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!))) (and (=> %%location_label%%6 tmp%8) (=> tmp%8 (=> %%location_label%%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)) (Poly%vstd!seq.Seq<u8.>. header_bytes!)))))))))))))))))))))))))))))
(check-sat)
(exit)
