...
(declare-const segment_ptr! lib!types.SegmentPtr.)
(declare-const slice! lib!types.PagePtr.)
(declare-const xblock_size! Int)
(declare-const tmp%1 Int)
(declare-const tmp%2 ptr_mut%<lib!types.Page.>.)
(declare-const tmp%3 Int)
(declare-const tmp%4 ptr_mut%<lib!types.SegmentHeader.>.)
(declare-const tmp%5 Int)
(declare-const tmp%6 Int)
(declare-const tmp%7 ptr_mut%<lib!types.SegmentHeader.>.)
(declare-const idxx@ Int)
(declare-const idx@ Int)
(declare-const start_offset@ Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!types.SegmentPtr. segment_ptr!) TYPE%lib!types.SegmentPtr.))
(assert (has_type (Poly%lib!types.PagePtr. slice!) TYPE%lib!types.PagePtr.))
(assert (uInv SZ xblock_size!))
(assert (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!)))) (Poly%lib!tokens.SegmentId. (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!))))))
(assert (and (lib!layout.is_page_ptr.? (Poly%ptr_mut%<lib!types.Page.>. (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!)))) (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!))))) (not (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ TYPE%lib!types.Page.) (Poly%ptr_mut%<lib!types.Page.>. (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!))))))) 0))))
(assert (= (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!)))))) (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!)))))
...
(assert (not (=> (ens%lib!config.const_facts. 0) (=> (= tmp%2 (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!)))) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ TYPE%lib!types.Page. (Poly%ptr_mut%<lib!types.Page.>. tmp%2) tmp%1) (=> (= tmp%4 (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!)))) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. tmp%4) tmp%3) (and (=> %%location_label%%0 (uInv SZ (Add tmp%3 lib!config.SIZEOF_SEGMENT_HEADER.?))) (and (=> %%location_label%%1 (uInv SZ (Sub tmp%1 (uClip SZ (Add tmp%3 lib!config.SIZEOF_SEGMENT_HEADER.?))))) (=> (= idxx@ (uClip SZ (Sub tmp%1 (uClip SZ (Add tmp%3 lib!config.SIZEOF_SEGMENT_HEADER.?))))) (and (=> %%location_label%%2 (not (= lib!config.SIZEOF_PAGE_HEADER.? 0))) (=> (= idx@ (uClip SZ (EucDiv idxx@ lib!config.SIZEOF_PAGE_HEADER.?))) (or (and (=> (and (>= xblock_size! (uClip SZ lib!config.INTPTR_SIZE.?)) (<= xblock_size! 1024)) (and (=> %%location_label%%3 (uInv SZ (Mul 3 lib!config.MAX_ALIGN_GUARANTEE.?))) (=> (= tmp%5 (uClip SZ (Mul 3 lib!config.MAX_ALIGN_GUARANTEE.?))) %%switch_label%%0))) (=> (not (and (>= xblock_size! (uClip SZ lib!config.INTPTR_SIZE.?)) (<= xblock_size! 1024))) (=> (= tmp%5 0) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= start_offset@ tmp%5) (=> (= tmp%7 (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!)))) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ TYPE%lib!types.SegmentHeader. (Poly%ptr_mut%<lib!types.SegmentHeader.>. tmp%7) tmp%6) (and (=> %%location_label%%4 (uInv SZ (Mul idx@ (uClip SZ lib!config.SLICE_SIZE.?)))) (and (=> %%location_label%%5 (uInv SZ (Add tmp%6 (uClip SZ (Mul idx@ (uClip SZ lib!config.SLICE_SIZE.?)))))) (and (=> %%location_label%%6 (uInv SZ (Add (uClip SZ (Add tmp%6 (uClip SZ (Mul idx@ (uClip SZ lib!config.SLICE_SIZE.?))))) start_offset@))) (=> (= res! (uClip SZ (Add (uClip SZ (Add tmp%6 (uClip SZ (Mul idx@ (uClip SZ lib!config.SLICE_SIZE.?))))) start_offset@))) (=> %%location_label%%7 (let ((start_offset$ res!)) (and (=> (= xblock_size! 0) (= start_offset$ (Add (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!))))) (Mul (lib!tokens.PageId./PageId/idx (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!)))))) lib!config.SLICE_SIZE.?)))) (=> (> xblock_size! 0) (= start_offset$ (lib!layout.block_start_at.? (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. slice!)))) (I xblock_size!) (I 0))))))))))))))))))))))))))))
(check-sat)
(exit)
