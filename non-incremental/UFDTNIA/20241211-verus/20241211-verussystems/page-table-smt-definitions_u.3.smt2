...
(assert (<= 0 i!))
(assert (<= 0 j!))
(assert (lib!definitions_t.impl&%8.inv.? (Poly%lib!definitions_t.Arch. self!)))
(assert (<= i! j!))
(assert (< j! (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. self!)))))))
...
(assert (not (=> (= decrease%init0 (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. self!))))) i!)) (or (and (=> (= i! j!) (and (=> %%location_label%%0 (= i! j!)) (and (=> %%location_label%%1 (> (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) 0)) (=> (lib!definitions_t.aligned.? (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!))) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I j!)))) %%switch_label%%0)))) (=> (not (= i! j!)) (=> (= tmp%1 (forall ((a$ Int) (b$ Int)) (! (= (Mul a$ b$) (Mul b$ a$)) :pattern ((Mul a$ b$))))) (and (=> %%location_label%%2 tmp%1) (=> tmp%1 (=> (= tmp%2 (nClip (Add i! 1))) (and (=> %%location_label%%3 (check_decrease_int (let ((self!$0 self!) (i!$1 tmp%2) (j!$2 j!)) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. self!$0))))) i!$1)) decrease%init0 false)) (and (=> %%location_label%%4 (req%lib!definitions_u.impl&%3.lemma_entry_sizes_aligned. self! tmp%2 j!)) (=> (ens%lib!definitions_u.impl&%3.lemma_entry_sizes_aligned. self! tmp%2 j!) (=> (= tmp%3 (lib!definitions_t.aligned.? (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1))))) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I j!))))) (and (=> %%location_label%%5 tmp%3) (=> tmp%3 (and (and (=> %%location_label%%6 (not (= i! j!))) (and (=> %%location_label%%7 (> (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) 0)) (and (=> %%location_label%%8 (> (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1)))) 0)) (and (=> %%location_label%%9 (= (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) (nClip (Mul (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1)))) (lib!definitions_t.impl&%8.num_entries.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1)))))))) (=> (= (nClip (EucMod (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1)))))) 0) (=> %%location_label%%10 (= (nClip (EucMod (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1)))))) 0))))))) (=> (= (nClip (EucMod (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1)))))) 0) (=> (= tmp%4 (lib!definitions_t.aligned.? (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!))) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1))))))) (and (=> %%location_label%%11 tmp%4) (=> tmp%4 (=> (= tmp%5 (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!))) (=> (= tmp%6 (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1))))) (=> (= tmp%7 (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I j!))) (and (=> %%location_label%%12 (req%lib!extra.aligned_transitive. tmp%5 tmp%6 tmp%7)) (=> (ens%lib!extra.aligned_transitive. tmp%5 tmp%6 tmp%7) (=> (= tmp%8 (lib!definitions_t.aligned.? (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!))) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I j!))))) (and (=> %%location_label%%13 tmp%8) (=> tmp%8 %%switch_label%%0))))))))))))))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%14 (lib!definitions_t.aligned.? (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!))) (I (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I j!))))))))))
(check-sat)
(exit)
