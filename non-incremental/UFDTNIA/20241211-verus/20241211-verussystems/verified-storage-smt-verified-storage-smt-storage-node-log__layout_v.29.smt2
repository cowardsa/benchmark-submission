...
(declare-const state@ lib!log.logspec_t.AbstractLogState.)
(assert fuel_defaults)
(assert (uInv 128 log_id!))
(assert (is-core!option.Option./Some_ (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. mem!) (I log_id!))))
...
(assert (not (=> (= state@ (%Poly%lib!log.logspec_t.AbstractLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. mem!) (I log_id!))))))) (=> (= tmp%1 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!log.logspec_t.AbstractLogState./AbstractLogState/pending (%Poly%lib!log.logspec_t.AbstractLogState. (Poly%lib!log.logspec_t.AbstractLogState. state@))))) 0)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false TYPE%lib!log.logspec_t.AbstractLogState. (Poly%lib!log.logspec_t.AbstractLogState. state@) (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state@))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> %%location_label%%2 (let ((state$ (%Poly%lib!log.logspec_t.AbstractLogState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!log.layout_v.recover_state.? (Poly%vstd!seq.Seq<u8.>. mem!) (I log_id!)))))))) (= state$ (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state$))))))))))))))
(check-sat)
(exit)
