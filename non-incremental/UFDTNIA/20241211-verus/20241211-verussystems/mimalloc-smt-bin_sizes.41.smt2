...
(assert (not (=> (= decrease%init0 w!) (or (and (=> (= w! 0) %%switch_label%%0) (=> (not (= w! 0)) (=> (fuel_bool fuel%vstd!std_specs.bits.u64_leading_zeros.) (and (=> (has_type x@ (UINT 64)) (=> (< (%I x@) w!) (=> (= tmp%1 (uClip 64 (EucDiv w! 2))) (and (=> %%location_label%%0 (check_decrease_int (let ((w!$0 tmp%1)) w!$0) decrease%init0 false)) (=> (ens%lib!bin_sizes.leading_zeros_monotonic. tmp%1) (or (and (=> (< (%I x@) (uClip 64 (EucDiv w! 2))) %%switch_label%%1) (=> (not (< (%I x@) (uClip 64 (EucDiv w! 2)))) (=> (= tmp%2 (<= (uClip 64 (EucDiv (%I x@) 2)) (uClip 64 (EucDiv w! 2)))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (or (and (=> (< (uClip 64 (EucDiv (%I x@) 2)) (uClip 64 (EucDiv w! 2))) (=> (= tmp%3 (<= (vstd!std_specs.bits.u64_leading_zeros.? (I (uClip 64 (EucDiv w! 2)))) (vstd!std_specs.bits.u64_leading_zeros.? (I (uClip 64 (EucDiv (%I x@) 2)))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%2)))) (=> (not (< (uClip 64 (EucDiv (%I x@) 2)) (uClip 64 (EucDiv w! 2)))) %%switch_label%%2)) (and (not %%switch_label%%2) %%switch_label%%1))))))) (and (not %%switch_label%%1) (=> %%location_label%%3 (<= (vstd!std_specs.bits.u64_leading_zeros.? (I w!)) (vstd!std_specs.bits.u64_leading_zeros.? x@)))))))))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ (UINT 64)) (=> (< (%I x$) w!) (<= (vstd!std_specs.bits.u64_leading_zeros.? (I w!)) (vstd!std_specs.bits.u64_leading_zeros.? x$)))) :pattern ((vstd!std_specs.bits.u64_leading_zeros.? x$)))) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%4 (forall ((x$ Poly)) (! (=> (has_type x$ (UINT 64)) (=> (< (%I x$) w!) (<= (vstd!std_specs.bits.u64_leading_zeros.? (I w!)) (vstd!std_specs.bits.u64_leading_zeros.? x$)))) :pattern ((vstd!std_specs.bits.u64_leading_zeros.? x$))))))))))
(check-sat)
(exit)
