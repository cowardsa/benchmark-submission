...
(assert (not (=> (= decrease%init0 z!) (or (and (=> (> z! 0) (=> (= tmp%1 (Sub z! 1)) (and (=> %%location_label%%0 (check_decrease_int (let ((x!$0 x!) (y!$1 y!) (z!$2 tmp%1)) z!$2) decrease%init0 false)) (and (=> %%location_label%%1 (req%main!math.lemma_mul_inequality. x! y! tmp%1)) (=> (ens%main!math.lemma_mul_inequality. x! y! tmp%1) (=> (= tmp%2 (Sub z! 1)) (=> (ens%main!math.lemma_mul_is_distributive_add. x! tmp%2 1) (=> (ens%main!math.lemma_mul_basics. x!) (=> (= tmp%3 (= (Mul x! z!) (Add (Mul x! (Sub z! 1)) x!))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (Sub z! 1)) (=> (ens%main!math.lemma_mul_is_distributive_add. y! tmp%4 1) (=> (ens%main!math.lemma_mul_basics. y!) (=> (= tmp%5 (= (Mul y! z!) (Add (Mul y! (Sub z! 1)) y!))) (and (=> %%location_label%%3 tmp%5) (=> tmp%5 %%switch_label%%0))))))))))))))))) (=> (not (> z! 0)) (=> (= tmp%6 (= z! 0)) (and (=> %%location_label%%4 tmp%6) (=> tmp%6 %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%5 (<= (Mul x! z!) (Mul y! z!))))))))
(check-sat)
(exit)
