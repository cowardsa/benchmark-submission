...
(assert (not (=> (= decrease%init0 (Sub lib!definitions_t.X86_NUM_LAYERS.? (%I layer!))) (=> (= decrease%init1 0) (=> (lib!impl_u.l2_impl.PT.layer_in_range.? layer!) (=> (has_type i@ NAT) (or (and (=> (< (%I i@) lib!definitions_t.X86_NUM_ENTRIES.?) (=> (= entry@ (lib!impl_u.l2_impl.PT.view_at.? mem! pt! layer! ptr! i@)) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ entry@) (=> (= tmp%2 (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. pt!))) i@)))) (=> (= tmp%3 (I (nClip (Add (%I layer!) 1)))) (=> (= tmp%4 (I (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. entry@))))) (and (=> %%location_label%%0 (check_decrease_int (let ((mem!$0 (%Poly%lib!spec_t.mem.PageTableMemory. mem!)) (pt!$1 (%Poly%lib!impl_u.l2_impl.PTDir. tmp%2)) (layer!$2 (%I tmp%3)) (ptr!$3 (%I tmp%4))) (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!$2)) decrease%init0 false)) (=> (= tmp%1 (lib!impl_u.l2_impl.PT.inv_at.? mem! (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. pt!))) i@))) (I (nClip (Add (%I layer!) 1))) (I (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. entry@)))))) (=> (= tmp%5 tmp%1) %%switch_label%%1))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ entry@)) (=> (= tmp%5 true) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%6 tmp%5) %%switch_label%%0))))) (=> (not (< (%I i@) lib!definitions_t.X86_NUM_ENTRIES.?)) (=> (= tmp%6 true) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)
