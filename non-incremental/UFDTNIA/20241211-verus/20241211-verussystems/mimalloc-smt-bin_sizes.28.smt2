...
(assert (uInv 64 i!))
(assert (<= 0 exp!))
(assert (and (<= (lib!bin_sizes.pow2.? (I exp!)) i!) (< i! (lib!bin_sizes.pow2.? (I (nClip (Add exp! 1)))))))
(assert (and (<= 1 exp!) (< exp! 64)))
...
(assert (not (=> (= decrease%init0 exp!) (=> (fuel_bool fuel%vstd!std_specs.bits.u64_leading_zeros.) (or (and (=> (= exp! 1) (=> (and (= (lib!bin_sizes.pow2.? (I 1)) 2) (= (lib!bin_sizes.pow2.? (I 2)) 4)) (=> (= tmp%1 (and (<= 2 i!) (< i! 4))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= (vstd!std_specs.bits.u64_leading_zeros.? (I 2)) (Sub (Sub 64 1) 1)) (=> (= (vstd!std_specs.bits.u64_leading_zeros.? (I 3)) (Sub (Sub 64 1) 1)) %%switch_label%%0))))))) (=> (not (= exp! 1)) (=> (= tmp%2 (< (uClip 64 (EucDiv i! 2)) (lib!bin_sizes.pow2.? (I exp!)))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (<= (lib!bin_sizes.pow2.? (I (Sub exp! 1))) (uClip 64 (EucDiv i! 2)))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (uClip 64 (EucDiv i! 2))) (=> (= tmp%5 (nClip (Sub exp! 1))) (and (=> %%location_label%%3 (check_decrease_int (let ((i!$0 tmp%4) (exp!$1 tmp%5)) exp!$1) decrease%init0 false)) (and (=> %%location_label%%4 (req%lib!bin_sizes.leading_zeros_between_powers_of_2. tmp%4 tmp%5)) (=> (ens%lib!bin_sizes.leading_zeros_between_powers_of_2. tmp%4 tmp%5) %%switch_label%%0))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%5 (= (vstd!std_specs.bits.u64_leading_zeros.? (I i!)) (Sub (Sub 64 exp!) 1)))))))))
(check-sat)
(exit)
