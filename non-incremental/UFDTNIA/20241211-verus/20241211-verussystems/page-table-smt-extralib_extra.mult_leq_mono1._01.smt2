...
(set-info :comment ";; page-table/extra.rs:119:1: 119:52 (#0)")
...
(set-info :comment ";; Function-Def lib::extra::mult_leq_mono1")
(set-info :comment ";; page-table/extra.rs:119:1: 119:52 (#0)")
(declare-const a! Int)
(declare-const b! Int)
(declare-const c! Int)
...
(assert (not (=> %%location_label%%0 (<= (nClip (Mul a! c!)) (nClip (Mul b! c!))))))
(check-sat)
(exit)
