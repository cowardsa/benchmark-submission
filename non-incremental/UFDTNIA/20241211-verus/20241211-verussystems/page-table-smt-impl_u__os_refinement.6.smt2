...
(declare-const s! lib!spec_t.os.OSVariables.)
(assert fuel_defaults)
(assert (lib!spec_t.os.init.? (Poly%lib!spec_t.os.OSVariables. s!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (lib!impl_u.spec_pt.init.? (Poly%lib!impl_u.spec_pt.PageTableVariables. (lib!spec_t.os.impl&%0.pt_variables.? (Poly%lib!spec_t.os.OSVariables. s!)))))))
(check-sat)
(exit)
