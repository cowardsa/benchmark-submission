...
(set-info :comment ";; page-table/definitions_u.rs:242:9: 242:15 (#0)")
...
(set-info :comment ";; page-table/definitions_u.rs:242:9: 242:15 (#0)")
(declare-const self! lib!definitions_t.Arch.)
(declare-const i! Int)
(declare-const j! Int)
...
(assert (not (=> (< (nClip (Add i! 1)) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. self!)))))) (=> (lib!definitions_t.impl&%8.entry_size_is_next_layer_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) (=> (> (lib!definitions_t.impl&%8.num_entries.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1)))) 0) (=> %%location_label%%0 (>= (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I i!)) (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. self!) (I (nClip (Add i! 1)))))))))))
(check-sat)
(exit)
