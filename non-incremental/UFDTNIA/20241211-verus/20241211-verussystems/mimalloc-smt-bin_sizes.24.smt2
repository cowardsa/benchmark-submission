...
(assert (not (and (and (=> (= tmp%1 (nClip (Sub e2! e1!))) (=> (ens%lib!bin_sizes.pow2_adds. tmp%1 e1!) (=> %%location_label%%0 (= (nClip (EucDiv (lib!bin_sizes.pow2.? (I e2!)) (lib!bin_sizes.pow2.? (I e1!)))) (nClip (EucDiv (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e2! e1!))) (lib!bin_sizes.pow2.? (I e1!)))) (lib!bin_sizes.pow2.? (I e1!)))))))) (=> (= (nClip (EucDiv (lib!bin_sizes.pow2.? (I e2!)) (lib!bin_sizes.pow2.? (I e1!)))) (nClip (EucDiv (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e2! e1!))) (lib!bin_sizes.pow2.? (I e1!)))) (lib!bin_sizes.pow2.? (I e1!))))) (and (=> (ens%lib!bin_sizes.pow2_positive. e1!) (=> (= tmp%2 (lib!bin_sizes.pow2.? (I (Sub e2! e1!)))) (=> (= tmp%3 (lib!bin_sizes.pow2.? (I e1!))) (and (=> %%location_label%%1 (req%lib!bin_sizes.lemma_div_by_multiple. tmp%2 tmp%3)) (=> (ens%lib!bin_sizes.lemma_div_by_multiple. tmp%2 tmp%3) (=> %%location_label%%2 (= (nClip (EucDiv (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e2! e1!))) (lib!bin_sizes.pow2.? (I e1!)))) (lib!bin_sizes.pow2.? (I e1!)))) (lib!bin_sizes.pow2.? (I (Sub e2! e1!)))))))))) (=> (= (nClip (EucDiv (nClip (Mul (lib!bin_sizes.pow2.? (I (Sub e2! e1!))) (lib!bin_sizes.pow2.? (I e1!)))) (lib!bin_sizes.pow2.? (I e1!)))) (lib!bin_sizes.pow2.? (I (Sub e2! e1!)))) (=> %%location_label%%3 (= (nClip (EucDiv (lib!bin_sizes.pow2.? (I e2!)) (lib!bin_sizes.pow2.? (I e1!)))) (lib!bin_sizes.pow2.? (I (Sub e2! e1!))))))))) (=> (= (nClip (EucDiv (lib!bin_sizes.pow2.? (I e2!)) (lib!bin_sizes.pow2.? (I e1!)))) (lib!bin_sizes.pow2.? (I (Sub e2! e1!)))) (=> %%location_label%%4 (= (nClip (EucDiv (lib!bin_sizes.pow2.? (I e2!)) (lib!bin_sizes.pow2.? (I e1!)))) (lib!bin_sizes.pow2.? (I (Sub e2! e1!)))))))))
(check-sat)
(exit)
