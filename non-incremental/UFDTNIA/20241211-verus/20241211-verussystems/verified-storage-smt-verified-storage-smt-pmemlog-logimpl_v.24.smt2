...
(assert (has_type s1! (TYPE%vstd!seq.Seq. T&. T&)))
(assert (has_type s2! (TYPE%vstd!seq.Seq. T&. T&)))
(assert (and (and (<= 0 i!) (<= i! j!)) (<= j! (vstd!seq.Seq.len.? T&. T& s1!))))
(assert (<= j! (vstd!seq.Seq.len.? T&. T& s2!)))
(assert (= (vstd!seq.Seq.subrange.? T&. T& s1! (I i!) (I j!)) (vstd!seq.Seq.subrange.? T&. T& s2! (I i!) (I j!))))
...
(assert (not (and (=> %%location_label%%0 (req%main!logimpl_v.lemma_subrange_equality_implies_index_equality. T&. T& s1! s2! i! j!)) (=> (ens%main!logimpl_v.lemma_subrange_equality_implies_index_equality. T&. T& s1! s2! i! j!) (and (=> (has_type k@ INT) (=> (has_type m@ INT) (=> (and (and (<= i! (%I k@)) (<= (%I k@) (%I m@))) (<= (%I m@) j!)) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& s1! k@ m@) (vstd!seq.Seq.subrange.? T&. T& s2! k@ m@))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> %%location_label%%2 (= (vstd!seq.Seq.subrange.? T&. T& s1! k@ m@) (vstd!seq.Seq.subrange.? T&. T& s2! k@ m@))))))))) (=> (forall ((k$ Poly) (m$ Poly)) (! (=> (and (has_type k$ INT) (has_type m$ INT)) (=> (and (and (<= i! (%I k$)) (<= (%I k$) (%I m$))) (<= (%I m$) j!)) (= (vstd!seq.Seq.subrange.? T&. T& s1! k$ m$) (vstd!seq.Seq.subrange.? T&. T& s2! k$ m$)))) :pattern ((vstd!seq.Seq.subrange.? T&. T& s1! k$ m$)) :pattern ((vstd!seq.Seq.subrange.? T&. T& s2! k$ m$)))) (=> %%location_label%%3 (forall ((k$ Poly) (m$ Poly)) (! (=> (and (has_type k$ INT) (has_type m$ INT)) (=> (and (and (<= i! (%I k$)) (<= (%I k$) (%I m$))) (<= (%I m$) j!)) (= (vstd!seq.Seq.subrange.? T&. T& s1! k$ m$) (vstd!seq.Seq.subrange.? T&. T& s2! k$ m$)))) :pattern ((vstd!seq.Seq.subrange.? T&. T& s1! k$ m$)) :pattern ((vstd!seq.Seq.subrange.? T&. T& s2! k$ m$)))))))))))
(check-sat)
(exit)
