...
(declare-const m1@ vstd!raw_ptr.PointsToRaw.)
(declare-const m2@ vstd!raw_ptr.PointsToRaw.)
(declare-const tmp%4 Poly)
(declare-const tmp%5 lib!linked_list.Node.)
...
(declare-const mem1@0 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const mem2@0 vstd!raw_ptr.PointsToRaw.)
...
(assert (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. points_to_raw!)) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. ptr!))))))
...
(assert (lib!layout.is_block_ptr.? (Poly%ptr_mut%<u8.>. ptr!) (Poly%lib!tokens.BlockId. (lib!tokens.Mim.block_token_data./block_token_data/key (%Poly%lib!tokens.Mim.block_token_data. (Poly%lib!tokens.Mim.block_token_data. (lib!tokens.Mim.impl&%10.view.? (Poly%lib!tokens.Mim.block. block_token!))))))))
...
(declare-const mem1@1 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
(declare-const mem2@1 vstd!raw_ptr.PointsToRaw.)
(declare-const mem1@2 vstd!raw_ptr.PointsTo<lib!linked_list.Node.>.)
...
(assert (not (=> (ens%vstd!layout.layout_for_type_is_valid. $ TYPE%lib!linked_list.Node.) (=> (ens%lib!layout.block_size_ge_word. 0) (=> (ens%lib!layout.block_ptr_aligned_to_word. 0) (=> (= tmp%1 (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. ptr!))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. ptr!)) (vstd!layout.size_of.? $ TYPE%lib!linked_list.Node.))))) (and (=> %%location_label%%0 (req%vstd!raw_ptr.impl&%11.split. points_to_raw! tmp%1)) (=> (ens%vstd!raw_ptr.impl&%11.split. points_to_raw! tmp%1 tmp%%@) (=> (= m1@ (%Poly%vstd!raw_ptr.PointsToRaw. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= m2@ (%Poly%vstd!raw_ptr.PointsToRaw. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= tmp%3 (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. ptr!))))) (and (=> %%location_label%%1 (req%vstd!raw_ptr.impl&%11.into_typed. $ TYPE%lib!linked_list.Node. m1@ tmp%3)) (=> (ens%vstd!raw_ptr.impl&%11.into_typed. $ TYPE%lib!linked_list.Node. m1@ tmp%3 tmp%2) (=> (= mem1@1 (%Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. tmp%2)) (=> (= mem2@1 m2@) (=> (ens%vstd!raw_ptr.cast_ptr_to_thin_ptr. $ (UINT 8) $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<u8.>. ptr!) tmp%4) (=> (= ptr@ (%Poly%ptr_mut%<lib!linked_list.Node.>. tmp%4)) (=> (= tmp%5 (lib!linked_list.Node./Node (%Poly%ptr_mut%<lib!linked_list.Node.>. (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.LL./LL/first (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@0))))))) (and (=> %%location_label%%2 (req%vstd!raw_ptr.ptr_mut_write. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr@) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. mem1@1) (Poly%lib!linked_list.Node. tmp%5))) (=> (ens%vstd!raw_ptr.ptr_mut_write. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr@) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. mem1@1) (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. mem1@2) (Poly%lib!linked_list.Node. tmp%5)) (=> (= (lib!linked_list.LL./LL/first (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@1))) ptr@) (=> (and (= (lib!linked_list.LL./LL/data self!@0) (lib!linked_list.LL./LL/data self!@1)) (= (lib!linked_list.LL./LL/perms self!@0) (lib!linked_list.LL./LL/perms self!@1))) (=> (ens%vstd!raw_ptr.expose_provenance. $ TYPE%lib!linked_list.Node. (Poly%ptr_mut%<lib!linked_list.Node.>. ptr@) verus_tmp_is_exposed@) (=> (= is_exposed@1 verus_tmp_is_exposed@) (=> (= tuple@ (tuple%4./tuple%4 (Poly%vstd!raw_ptr.PointsTo<lib!linked_list.Node.>. mem1@2) (Poly%vstd!raw_ptr.PointsToRaw. mem2@1) (Poly%lib!tokens.Mim.block. block_token!) (Poly%vstd!raw_ptr.IsExposed. is_exposed@1))) (=> (= tmp%6 (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@1))))))) (=> (and (= (lib!linked_list.LL./LL/first self!@1) (lib!linked_list.LL./LL/first self!@2)) (= (lib!linked_list.LL./LL/data self!@1) (lib!linked_list.LL./LL/data self!@2))) (=> (has_type (Poly%lib!linked_list.LL. self!@2) TYPE%lib!linked_list.LL.) (=> (ens%vstd!map.impl&%0.tracked_insert. $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@1)))) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@2)))) (I tmp%6) (Poly%tuple%4. tuple@)) (=> (= tmp%7 (nClip (Add (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@2)))))) 1))) (=> (= (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3)))))) tmp%7) (=> (and (= (lib!linked_list.LL./LL/first self!@2) (lib!linked_list.LL./LL/first self!@3)) (= (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/fixed_page (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/block_size (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/page_id (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/heap_id (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@2)) (lib!linked_list.LLData./LLData/instance (lib!linked_list.LL./LL/data self!@3))) (= (lib!linked_list.LL./LL/perms self!@2) (lib!linked_list.LL./LL/perms self!@3))) (=> (= len@ (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3))))))) (and (=> (has_type i@ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3))))) i@) (or (and (=> (< (nClip (Add (%I i@) 1)) len@) (=> (= tmp%8 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@0))))) i@)) (and (=> %%location_label%%3 tmp%8) (=> tmp%8 %%switch_label%%1)))) (=> (not (< (nClip (Add (%I i@) 1)) len@)) %%switch_label%%1)) (and (not %%switch_label%%1) (=> %%location_label%%4 (and (<= 0 (%I i@)) (< (%I i@) (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3))))))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3))))) i$) (and (<= 0 (%I i$)) (< (%I i$) (lib!linked_list.LLData./LLData/len (%Poly%lib!linked_list.LLData. (Poly%lib!linked_list.LLData. (lib!linked_list.LL./LL/data (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3)))))))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%tuple%4. $ (TYPE%vstd!raw_ptr.PointsTo. $ TYPE%lib!linked_list.Node.) $ TYPE%vstd!raw_ptr.PointsToRaw. $ TYPE%lib!tokens.Mim.block. $ TYPE%vstd!raw_ptr.IsExposed.) (Poly%vstd!map.Map<nat./tuple%4<vstd!raw_ptr.PointsTo<lib!linked_list.Node.>./vstd!raw_ptr.PointsToRaw./lib!tokens.Mim.block./vstd!raw_ptr.IsExposed.>.>. (lib!linked_list.LL./LL/perms (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. self!@3))))) i$)))) (and (=> (has_type i$1@ NAT) (=> (= tmp%9 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@0) i$1@ (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@0) i$1@)))) (and (=> %%location_label%%5 tmp%9) (=> tmp%9 (or (and (=> (> (%I i$1@) 0) (=> (= j@ (nClip (Sub (%I i$1@) 1))) (=> (= tmp%10 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@0) (I j@) (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@0) (I j@))))) (and (=> %%location_label%%6 tmp%10) (=> tmp%10 %%switch_label%%0))))) (=> (not (> (%I i$1@) 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%7 (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@3) i$1@ (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@3) i$1@)))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@3) i$ (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@3) i$)))) :pattern ((lib!linked_list.impl&%2.valid_node.? (Poly%lib!linked_list.LL. self!@3) i$ (Poly%ptr_mut%<lib!linked_list.Node.>. (lib!linked_list.impl&%2.next_ptr.? (Poly%lib!linked_list.LL. self!@3) i$)))))) (and (=> %%location_label%%8 (lib!linked_list.impl&%2.wf.? (Poly%lib!linked_list.LL. self!@3))) (and (=> %%location_label%%9 (= (lib!linked_list.impl&%2.block_size.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.block_size.? (Poly%lib!linked_list.LL. self!@0)))) (and (=> %%location_label%%10 (= (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!@3)) (nClip (Add (lib!linked_list.impl&%2.len.? (Poly%lib!linked_list.LL. self!@0)) 1)))) (and (=> %%location_label%%11 (= (lib!linked_list.impl&%2.instance.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.instance.? (Poly%lib!linked_list.LL. self!@0)))) (and (=> %%location_label%%12 (= (lib!linked_list.impl&%2.page_id.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.page_id.? (Poly%lib!linked_list.LL. self!@0)))) (and (=> %%location_label%%13 (= (lib!linked_list.impl&%2.fixed_page.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.fixed_page.? (Poly%lib!linked_list.LL. self!@0)))) (=> %%location_label%%14 (= (lib!linked_list.impl&%2.heap_id.? (Poly%lib!linked_list.LL. self!@3)) (lib!linked_list.impl&%2.heap_id.? (Poly%lib!linked_list.LL. self!@0)))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
