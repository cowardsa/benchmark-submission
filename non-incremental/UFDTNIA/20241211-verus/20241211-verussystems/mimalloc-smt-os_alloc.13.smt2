...
(declare-const try_alignment! Int)
...
(declare-const allow_large@0 Bool)
(declare-const try_alignment@0 Int)
(assert fuel_defaults)
(assert (uInv SZ size!))
(assert (uInv SZ try_alignment!))
(assert (= (EucMod size! (lib!os_mem.page_size.? (I 0))) 0))
(assert (<= size! lib!config.SEGMENT_SIZE.?))
(assert (or (= try_alignment! 1) (= (EucMod try_alignment! (lib!os_mem.page_size.? (I 0))) 0)))
(declare-const allow_large@1 Bool)
(declare-const try_alignment@1 Int)
...
(assert (not (or (and (=> (= size! 0) (=> (ens%core!ptr.null_mut. $ (UINT 8) tmp%1) (=> (= res! (tuple%3./tuple%3 tmp%1 (B allow_large!) (Poly%lib!os_mem.MemChunk. tmp%2))) (=> %%location_label%%0 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((is_large$ (%B (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (lib!os_mem.impl&%0.os_exact_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (=> request_commit! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> request_commit! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not request_commit!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))))))))))) (=> (not (= size! 0)) %%switch_label%%2)) (and (not %%switch_label%%2) (=> (= allow_large@0 allow_large!) (or (and (=> (not request_commit!) (=> (= allow_large@1 false) %%switch_label%%1)) (=> (not (not request_commit!)) (=> (= allow_large@1 allow_large@0) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= try_alignment@0 try_alignment!) (or (and (=> (= try_alignment@0 0) (=> (= try_alignment@1 1) %%switch_label%%0)) (=> (not (= try_alignment@0 0)) (=> (= try_alignment@1 try_alignment@0) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (ens%core!ptr.null_mut. $ (UINT 8) tmp%3) (and (=> %%location_label%%1 (req%lib!os_alloc.unix_mmap. (%Poly%ptr_mut%<u8.>. tmp%3) size! try_alignment@1 request_commit! false allow_large@1)) (=> (ens%lib!os_alloc.unix_mmap. (%Poly%ptr_mut%<u8.>. tmp%3) size! try_alignment@1 request_commit! false allow_large@1 tmp%4) (=> (= res! tmp%4) (=> %%location_label%%2 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((is_large$ (%B (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (lib!os_mem.impl&%0.os_exact_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (=> request_commit! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> request_commit! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not request_commit!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))))))))))))))))))))))
(check-sat)
(exit)
