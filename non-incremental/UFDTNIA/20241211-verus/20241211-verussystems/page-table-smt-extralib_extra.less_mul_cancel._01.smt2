...
(set-info :comment ";; page-table/extra.rs:113:1: 113:53 (#0)")
...
(set-info :comment ";; Function-Def lib::extra::less_mul_cancel")
(set-info :comment ";; page-table/extra.rs:113:1: 113:53 (#0)")
(declare-const a! Int)
(declare-const b! Int)
(declare-const c! Int)
...
(assert (<= 0 b!))
(assert (<= 0 c!))
(assert (< (nClip (Mul a! c!)) (nClip (Mul b! c!))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (< a! b!))))
(check-sat)
(exit)
