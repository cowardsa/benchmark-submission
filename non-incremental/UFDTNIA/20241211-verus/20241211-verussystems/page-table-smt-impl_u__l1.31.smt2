...
(assert (< i! (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!))))
...
(assert (not (=> (= tmp%1 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%2 (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%0 (req%lib!impl_u.indexing.lemma_entry_base_from_index. tmp%1 i! tmp%2)) (=> (ens%lib!impl_u.indexing.lemma_entry_base_from_index. tmp%1 i! tmp%2) (=> (= tmp%3 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%4 (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%1 (req%lib!impl_u.indexing.lemma_entry_base_from_index_support. tmp%3 i! tmp%4)) (=> (ens%lib!impl_u.indexing.lemma_entry_base_from_index_support. tmp%3 i! tmp%4) (=> (= tmp%%@ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (I i!)))) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@) (=> (= d@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@)))) (and (=> %%location_label%%2 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. d@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. d@) %%switch_label%%0)))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@)) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%3 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))) (and (=> %%location_label%%4 (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))) (=> %%location_label%%5 (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1)))))))))))))))))))))
(check-sat)
(exit)
