...
(assert (not (=> (< ofs@0 64) (or (and (=> (not (< i@0 8)) (and (=> %%location_label%%0 (< ofs@0 64)) (and (=> %%location_label%%1 (=> (< i@0 8) (= mask@0 (uClip SZ (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@0)))) (I ofs@0)))))) (and (=> %%location_label%%2 (=> (< i@0 8) (< ofs@0 64))) (=> %%location_label%%3 (=> (< i@0 8) (= (uClip SZ (bitand (I mask@0) (I 1))) 1))))))) (=> (not (not (< i@0 8))) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (= tmp%2 (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!)))) (and (=> %%location_label%%4 (req%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%2 i@0)) (=> (ens%vstd!array.array_index_get. $ (UINT SZ) $ (CONST_INT 8) tmp%2 i@0 tmp%1) (and (=> %%location_label%%5 (and (<= 0 ofs@0) (< ofs@0 64))) (=> (= mask@1 (uClip SZ (bitshr (I (%I tmp%1)) (I ofs@0)))) (or (and (=> (not (= mask@1 0)) (and (=> %%location_label%%6 (< i@0 8)) (and (=> %%location_label%%7 (< ofs@0 64)) (and (=> %%location_label%%8 (= mask@1 (uClip SZ (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@0)))) (I ofs@0))))) (and (=> %%location_label%%9 (not (= mask@1 0))) (=> (uInv SZ ofs@1) (=> (uInv SZ mask@2) (=> (< i@0 8) (=> (< ofs@1 64) (=> (= mask@2 (uClip SZ (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@0)))) (I ofs@1)))) (=> (not (= mask@2 0)) (=> (not (= (uClip SZ (bitand (I mask@2) (I 1))) 0)) (and (=> %%location_label%%10 (not (= (uClip SZ (bitand (I mask@2) (I 1))) 0))) (=> (= (uClip SZ (bitand (I mask@2) (I 1))) 1) (and (=> %%location_label%%11 (< ofs@1 64)) (and (=> %%location_label%%12 (=> (< i@0 8) (= mask@2 (uClip SZ (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@0)))) (I ofs@1)))))) (and (=> %%location_label%%13 (=> (< i@0 8) (< ofs@1 64))) (=> %%location_label%%14 (=> (< i@0 8) (= (uClip SZ (bitand (I mask@2) (I 1))) 1)))))))))))))))))))) (=> (not (not (= mask@1 0))) (=> (= ofs@1 ofs@0) (=> (= mask@2 mask@1) %%switch_label%%0)))) (and (not %%switch_label%%0) (and (=> %%location_label%%15 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (=> (= ofs@2 0) (=> %%location_label%%16 (< ofs@2 64)))))))))))))))))
(check-sat)
(exit)
