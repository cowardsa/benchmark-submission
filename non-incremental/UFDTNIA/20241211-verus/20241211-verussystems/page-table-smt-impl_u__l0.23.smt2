...
(set-info :comment ";; MODULE 'module impl_u::l0'")
...
(assert (distinct fuel%vstd!std_specs.result.impl&%0.is_Ok. fuel%vstd!std_specs.result.impl&%0.get_Ok_0. fuel%vstd!std_specs.result.impl&%0.is_Err. fuel%vstd!std_specs.result.impl&%0.get_Err_0. fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_insert_domain. fuel%vstd!map.axiom_map_insert_same. fuel%vstd!map.axiom_map_insert_different. fuel%vstd!map.axiom_map_remove_domain. fuel%vstd!map.axiom_map_remove_different. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!map.check_argument_is_map. fuel%vstd!map_lib.impl&%0.contains_pair. fuel%vstd!map_lib.impl&%0.union_prefer_right. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_remove_same. fuel%vstd!set.axiom_set_remove_insert. fuel%vstd!set.axiom_set_remove_different. fuel%vstd!set.axiom_set_union. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_mk_map_domain. fuel%vstd!set.axiom_mk_map_index. fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_remove_finite. fuel%vstd!set.axiom_set_union_finite. fuel%vstd!set.axiom_set_insert_len. fuel%vstd!set.axiom_set_remove_len. fuel%vstd!set.axiom_set_contains_len. fuel%lib!impl_u.l0.impl&%0.inv. fuel%lib!impl_u.l0.impl&%0.mappings_are_of_valid_size. fuel%lib!impl_u.l0.impl&%0.mappings_are_aligned. fuel%lib!impl_u.l0.impl&%0.mappings_dont_overlap. fuel%lib!impl_u.l0.impl&%0.candidate_mapping_in_bounds. fuel%lib!impl_u.l0.impl&%0.mappings_in_bounds. fuel%lib!impl_u.l0.impl&%0.accepted_mapping. fuel%lib!impl_u.l0.impl&%0.valid_mapping. fuel%lib!impl_u.l0.impl&%0.map_frame. fuel%lib!impl_u.l0.impl&%0.accepted_resolve. fuel%lib!impl_u.l0.impl&%0.resolve. fuel%lib!impl_u.l0.impl&%0.remove. fuel%lib!impl_u.l0.impl&%0.accepted_unmap. fuel%lib!impl_u.l0.impl&%0.unmap. fuel%lib!impl_u.l0.impl&%0.ranges_disjoint. fuel%lib!impl_u.l0.impl&%0.mappings_disjoint. fuel%lib!definitions_t.X86_NUM_LAYERS. fuel%lib!definitions_t.X86_NUM_ENTRIES. fuel%lib!definitions_t.X86_MAX_ENTRY_SIZE. fuel%lib!definitions_t.aligned. fuel%lib!definitions_t.between. fuel%lib!definitions_t.overlap. fuel%lib!definitions_t.impl&%8.entry_size. fuel%lib!definitions_t.impl&%8.num_entries. fuel%lib!definitions_t.impl&%8.inv. fuel%lib!definitions_t.impl&%8.entry_size_is_next_layer_size. fuel%lib!definitions_t.impl&%8.contains_entry_size_at_index_atleast. fuel%lib!definitions_t.impl&%8.contains_entry_size. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::mappings_are_of_valid_size")
(set-info :comment ";; page-table/impl_u/l0.rs:72:5: 72:71 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::mappings_are_aligned")
(set-info :comment ";; page-table/impl_u/l0.rs:78:5: 78:65 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::mappings_dont_overlap")
(set-info :comment ";; page-table/impl_u/l0.rs:85:5: 85:66 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::candidate_mapping_in_bounds")
(set-info :comment ";; page-table/impl_u/l0.rs:95:5: 95:104 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::mappings_in_bounds")
(set-info :comment ";; page-table/impl_u/l0.rs:99:5: 99:63 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::inv")
(set-info :comment ";; page-table/impl_u/l0.rs:63:5: 63:49 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::accepted_mapping")
(set-info :comment ";; page-table/impl_u/l0.rs:106:5: 106:93 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::valid_mapping")
(set-info :comment ";; page-table/impl_u/l0.rs:113:5: 113:90 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::map_frame")
(set-info :comment ";; page-table/impl_u/l0.rs:121:5: 121:125 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::accepted_resolve")
(set-info :comment ";; page-table/impl_u/l0.rs:151:5: 151:73 (#0)")
...
(assert (forall ((self! Poly) (vaddr! Poly)) (! (= (req%lib!impl_u.l0.impl&%0.resolve. self! vaddr!) (=> %%global_location_label%%7 (lib!impl_u.l0.impl&%0.accepted_resolve.? self! vaddr!))) :pattern ((req%lib!impl_u.l0.impl&%0.resolve. self! vaddr!)))))
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::resolve")
(set-info :comment ";; page-table/impl_u/l0.rs:157:5: 157:92 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::remove")
(set-info :comment ";; page-table/impl_u/l0.rs:172:5: 172:72 (#0)")
...
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::accepted_unmap")
(set-info :comment ";; page-table/impl_u/l0.rs:179:5: 179:70 (#0)")
...
(assert (forall ((self! Poly) (base! Poly)) (! (= (req%lib!impl_u.l0.impl&%0.unmap. self! base!) (=> %%global_location_label%%8 (lib!impl_u.l0.impl&%0.accepted_unmap.? self! base!))) :pattern ((req%lib!impl_u.l0.impl&%0.unmap. self! base!)))))
(set-info :comment ";; Function-Recommends lib::impl_u::l0::PageTableContents::unmap")
(set-info :comment ";; page-table/impl_u/l0.rs:188:5: 188:100 (#0)")
...
(set-info :comment ";; Function-Specs lib::impl_u::l0::lemma_finite_map_union")
(declare-fun ens%lib!impl_u.l0.lemma_finite_map_union. (Dcr Type Dcr Type) Bool)
(assert (forall ((S&. Dcr) (S& Type) (T&. Dcr) (T& Type)) (! (= (ens%lib!impl_u.l0.lemma_finite_map_union. S&. S& T&. T&) (forall ((s1$ Poly) (s2$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type s2$ (TYPE%vstd!map.Map. S&. S& T&. T&))) (=> (and (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s1$)) (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& s2$))) (vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& s1$ s2$))))) :pattern ((vstd!set.impl&%0.finite.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& s1$ s2$))))))) :pattern ((ens%lib!impl_u.l0.lemma_finite_map_union. S&. S& T&. T&)))))
(set-info :comment ";; Function-Def lib::impl_u::l0::lemma_finite_map_union")
(set-info :comment ";; page-table/impl_u/l0.rs:320:1: 320:43 (#0)")
(set-info :comment ";; Function-Specs lib::impl_u::l0::lemma_map_union_prefer_right_remove_commute")
(declare-fun ens%lib!impl_u.l0.lemma_map_union_prefer_right_remove_commute. (Dcr Type Dcr Type) Bool)
(assert (forall ((S&. Dcr) (S& Type) (T&. Dcr) (T& Type)) (! (= (ens%lib!impl_u.l0.lemma_map_union_prefer_right_remove_commute. S&. S& T&. T&) (and (forall ((m1$ Poly) (m2$ Poly) (n$ Poly)) (! (=> (and (has_type m1$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type m2$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type n$ S&)) (=> (and (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m1$) n$) (not (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m2$) n$))) (= (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& (vstd!map.impl&%0.remove.? S&. S& T&. T& m1$ n$) m2$) (vstd!map.impl&%0.remove.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ m2$) n$)))) :pattern ((vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& (vstd!map.impl&%0.remove.? S&. S& T&. T& m1$ n$) m2$)) :pattern ((vstd!map.impl&%0.remove.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ m2$) n$)))) (forall ((m1$ Poly) (m2$ Poly) (n$ Poly)) (! (=> (and (has_type m1$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type m2$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type n$ S&)) (=> (and (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m2$) n$) (not (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m1$) n$))) (= (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ (vstd!map.impl&%0.remove.? S&. S& T&. T& m2$ n$)) (vstd!map.impl&%0.remove.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ m2$) n$)))) :pattern ((vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ (vstd!map.impl&%0.remove.? S&. S& T&. T& m2$ n$))) :pattern ((vstd!map.impl&%0.remove.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ m2$) n$)))))) :pattern ((ens%lib!impl_u.l0.lemma_map_union_prefer_right_remove_commute. S&. S& T&. T&)))))
(set-info :comment ";; Function-Def lib::impl_u::l0::lemma_map_union_prefer_right_remove_commute")
(set-info :comment ";; page-table/impl_u/l0.rs:288:1: 288:64 (#0)")
(set-info :comment ";; Function-Specs lib::impl_u::l0::lemma_map_union_prefer_right_insert_commute")
(declare-fun ens%lib!impl_u.l0.lemma_map_union_prefer_right_insert_commute. (Dcr Type Dcr Type) Bool)
(assert (forall ((S&. Dcr) (S& Type) (T&. Dcr) (T& Type)) (! (= (ens%lib!impl_u.l0.lemma_map_union_prefer_right_insert_commute. S&. S& T&. T&) (and (forall ((m1$ Poly) (m2$ Poly) (n$ Poly) (v$ Poly)) (! (=> (and (has_type m1$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type m2$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type n$ S&) (has_type v$ T&)) (=> (and (not (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m1$) n$)) (not (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m2$) n$))) (= (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& (vstd!map.impl&%0.insert.? S&. S& T&. T& m1$ n$ v$) m2$) (vstd!map.impl&%0.insert.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ m2$) n$ v$)))) :pattern ((vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& (vstd!map.impl&%0.insert.? S&. S& T&. T& m1$ n$ v$) m2$)) :pattern ((vstd!map.impl&%0.insert.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ m2$) n$ v$)))) (forall ((m1$ Poly) (m2$ Poly) (n$ Poly) (v$ Poly)) (! (=> (and (has_type m1$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type m2$ (TYPE%vstd!map.Map. S&. S& T&. T&)) (has_type n$ S&) (has_type v$ T&)) (=> (and (not (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m1$) n$)) (not (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m2$) n$))) (= (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ (vstd!map.impl&%0.insert.? S&. S& T&. T& m2$ n$ v$)) (vstd!map.impl&%0.insert.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ m2$) n$ v$)))) :pattern ((vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ (vstd!map.impl&%0.insert.? S&. S& T&. T& m2$ n$ v$))) :pattern ((vstd!map.impl&%0.insert.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1$ m2$) n$ v$)))))) :pattern ((ens%lib!impl_u.l0.lemma_map_union_prefer_right_insert_commute. S&. S& T&. T&)))))
(set-info :comment ";; Function-Def lib::impl_u::l0::lemma_map_union_prefer_right_insert_commute")
(set-info :comment ";; page-table/impl_u/l0.rs:261:1: 261:64 (#0)")
...
(set-info :comment ";; Function-Def lib::impl_u::l0::ambient_lemmas1")
(set-info :comment ";; page-table/impl_u/l0.rs:23:1: 23:31 (#0)")
...
(assert (forall ((self! lib!impl_u.l0.PageTableContents.) (other! lib!impl_u.l0.PageTableContents.)) (! (= (req%lib!impl_u.l0.impl&%0.lemma_ranges_disjoint_implies_mappings_disjoint. self! other!) (and (=> %%global_location_label%%9 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. self!))) (=> %%global_location_label%%10 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. other!))) (=> %%global_location_label%%11 (lib!impl_u.l0.impl&%0.ranges_disjoint.? (Poly%lib!impl_u.l0.PageTableContents. self!) (Poly%lib!impl_u.l0.PageTableContents. other!))))) :pattern ((req%lib!impl_u.l0.impl&%0.lemma_ranges_disjoint_implies_mappings_disjoint. self! other!)))))
...
(set-info :comment ";; Function-Def lib::impl_u::l0::PageTableContents::lemma_ranges_disjoint_implies_mappings_disjoint")
(set-info :comment ";; page-table/impl_u/l0.rs:232:5: 232:84 (#0)")
...
(set-info :comment ";; Function-Specs lib::impl_u::l0::lemma_set_contains_IMP_len_greater_zero")
(declare-fun req%lib!impl_u.l0.lemma_set_contains_IMP_len_greater_zero. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%12 Bool)
(declare-const %%global_location_label%%13 Bool)
(assert (forall ((T&. Dcr) (T& Type) (s! Poly) (a! Poly)) (! (= (req%lib!impl_u.l0.lemma_set_contains_IMP_len_greater_zero. T&. T& s! a!) (and (=> %%global_location_label%%12 (vstd!set.impl&%0.finite.? T&. T& s!)) (=> %%global_location_label%%13 (vstd!set.impl&%0.contains.? T&. T& s! a!)))) :pattern ((req%lib!impl_u.l0.lemma_set_contains_IMP_len_greater_zero. T&. T& s! a!)))))
(declare-fun ens%lib!impl_u.l0.lemma_set_contains_IMP_len_greater_zero. (Dcr Type Poly Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (s! Poly) (a! Poly)) (! (= (ens%lib!impl_u.l0.lemma_set_contains_IMP_len_greater_zero. T&. T& s! a!) (> (vstd!set.impl&%0.len.? T&. T& s!) 0)) :pattern ((ens%lib!impl_u.l0.lemma_set_contains_IMP_len_greater_zero. T&. T& s! a!)))))
(set-info :comment ";; Function-Def lib::impl_u::l0::lemma_set_contains_IMP_len_greater_zero")
(set-info :comment ";; page-table/impl_u/l0.rs:248:1: 248:73 (#0)")
(set-info :comment ";; Function-Specs lib::impl_u::l0::PageTableContents::lemma_unmap_decrements_len")
(declare-fun req%lib!impl_u.l0.impl&%0.lemma_unmap_decrements_len. (lib!impl_u.l0.PageTableContents. Int) Bool)
(declare-const %%global_location_label%%14 Bool)
(declare-const %%global_location_label%%15 Bool)
(assert (forall ((self! lib!impl_u.l0.PageTableContents.) (base! Int)) (! (= (req%lib!impl_u.l0.impl&%0.lemma_unmap_decrements_len. self! base!) (and (=> %%global_location_label%%14 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. self!))) (=> %%global_location_label%%15 (is-core!result.Result./Ok_ (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!)))))) :pattern ((req%lib!impl_u.l0.impl&%0.lemma_unmap_decrements_len. self! base!)))))
(declare-fun ens%lib!impl_u.l0.impl&%0.lemma_unmap_decrements_len. (lib!impl_u.l0.PageTableContents. Int) Bool)
(assert (forall ((self! lib!impl_u.l0.PageTableContents.) (base! Int)) (! (= (ens%lib!impl_u.l0.impl&%0.lemma_unmap_decrements_len. self! base!) (and (> (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!)))))) 0) (= (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!))))))))) (vstd!set.impl&%0.remove.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!))))) (I base!))) (= (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!)))))))))) (Sub (vstd!set.impl&%0.len.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. self!)))))) 1)))) :pattern ((ens%lib!impl_u.l0.impl&%0.lemma_unmap_decrements_len. self! base!)))))
(set-info :comment ";; Function-Def lib::impl_u::l0::PageTableContents::lemma_unmap_decrements_len")
(set-info :comment ";; page-table/impl_u/l0.rs:205:5: 205:61 (#0)")
(set-info :comment ";; Function-Specs lib::extra::aligned_zero")
(declare-fun ens%lib!extra.aligned_zero. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!extra.aligned_zero. no%param) (forall ((a$ Poly)) (! (=> (has_type a$ NAT) (=> (not (= (%I a$) 0)) (lib!definitions_t.aligned.? (I 0) a$))) :pattern ((lib!definitions_t.aligned.? (I 0) a$))))) :pattern ((ens%lib!extra.aligned_zero. no%param)))))
(set-info :comment ";; Function-Specs lib::impl_u::l0::ambient_arith")
(declare-fun ens%lib!impl_u.l0.ambient_arith. (Int) Bool)
(assert (forall ((no%param Int)) (! (= (ens%lib!impl_u.l0.ambient_arith. no%param) (and (forall ((a$ Int) (b$ Int)) (! (=> (and (<= 0 a$) (<= 0 b$)) (=> (= a$ 0) (= (nClip (Mul a$ b$)) 0))) :pattern ((nClip (Mul a$ b$))))) (forall ((a$ Int) (b$ Int)) (! (=> (and (<= 0 a$) (<= 0 b$)) (=> (= b$ 0) (= (nClip (Mul a$ b$)) 0))) :pattern ((nClip (Mul a$ b$))))) (forall ((a$ Int) (b$ Int)) (! (=> (and (<= 0 a$) (<= 0 b$)) (=> (and (> a$ 0) (> b$ 0)) (> (nClip (Mul a$ b$)) 0))) :pattern ((nClip (Mul a$ b$))))) (forall ((a$ Int) (b$ Int)) (! (= (Mul a$ b$) (Mul b$ a$)) :pattern ((Mul a$ b$)))) (forall ((a$ Poly)) (! (=> (has_type a$ NAT) (=> (not (= (%I a$) 0)) (lib!definitions_t.aligned.? (I 0) a$))) :pattern ((lib!definitions_t.aligned.? (I 0) a$)))))) :pattern ((ens%lib!impl_u.l0.ambient_arith. no%param)))))
(set-info :comment ";; Function-Specs lib::impl_u::l0::PageTableContents::map_frame_preserves_inv")
(declare-fun req%lib!impl_u.l0.impl&%0.map_frame_preserves_inv. (lib!impl_u.l0.PageTableContents. Int lib!definitions_t.PageTableEntry.) Bool)
(declare-const %%global_location_label%%16 Bool)
(declare-const %%global_location_label%%17 Bool)
(assert (forall ((self! lib!impl_u.l0.PageTableContents.) (base! Int) (pte! lib!definitions_t.PageTableEntry.)) (! (= (req%lib!impl_u.l0.impl&%0.map_frame_preserves_inv. self! base! pte!) (and (=> %%global_location_label%%16 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. self!))) (=> %%global_location_label%%17 (lib!impl_u.l0.impl&%0.accepted_mapping.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!))))) :pattern ((req%lib!impl_u.l0.impl&%0.map_frame_preserves_inv. self! base! pte!)))))
(declare-fun ens%lib!impl_u.l0.impl&%0.map_frame_preserves_inv. (lib!impl_u.l0.PageTableContents. Int lib!definitions_t.PageTableEntry.) Bool)
(assert (forall ((self! lib!impl_u.l0.PageTableContents.) (base! Int) (pte! lib!definitions_t.PageTableEntry.)) (! (= (ens%lib!impl_u.l0.impl&%0.map_frame_preserves_inv. self! base! pte!) (and (=> (is-core!result.Result./Ok_ (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!))) (lib!impl_u.l0.impl&%0.inv.? (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!))))))) (=> (is-core!result.Result./Err_ (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!))) (= (%Poly%lib!impl_u.l0.PageTableContents. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.map_frame.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!) (Poly%lib!definitions_t.PageTableEntry. pte!)))))) self!)))) :pattern ((ens%lib!impl_u.l0.impl&%0.map_frame_preserves_inv. self! base! pte!)))))
(set-info :comment ";; Function-Def lib::impl_u::l0::PageTableContents::map_frame_preserves_inv")
(set-info :comment ";; page-table/impl_u/l0.rs:136:11: 136:75 (#0)")
(set-info :comment ";; Function-Specs lib::impl_u::l0::PageTableContents::lemma_unmap_preserves_inv")
(declare-fun req%lib!impl_u.l0.impl&%0.lemma_unmap_preserves_inv. (lib!impl_u.l0.PageTableContents. Int) Bool)
(declare-const %%global_location_label%%18 Bool)
(assert (forall ((self! lib!impl_u.l0.PageTableContents.) (base! Int)) (! (= (req%lib!impl_u.l0.impl&%0.lemma_unmap_preserves_inv. self! base!) (=> %%global_location_label%%18 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. self!)))) :pattern ((req%lib!impl_u.l0.impl&%0.lemma_unmap_preserves_inv. self! base!)))))
(declare-fun ens%lib!impl_u.l0.impl&%0.lemma_unmap_preserves_inv. (lib!impl_u.l0.PageTableContents. Int) Bool)
(assert (forall ((self! lib!impl_u.l0.PageTableContents.) (base! Int)) (! (= (ens%lib!impl_u.l0.impl&%0.lemma_unmap_preserves_inv. self! base!) (and (=> (is-core!result.Result./Ok_ (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!))) (lib!impl_u.l0.impl&%0.inv.? (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!))))))) (=> (is-core!result.Result./Err_ (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!))) (= (%Poly%lib!impl_u.l0.PageTableContents. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!)))))) self!)))) :pattern ((ens%lib!impl_u.l0.impl&%0.lemma_unmap_preserves_inv. self! base!)))))
(set-info :comment ";; Function-Def lib::impl_u::l0::PageTableContents::lemma_unmap_preserves_inv")
(set-info :comment ";; page-table/impl_u/l0.rs:198:11: 198:56 (#0)")
(declare-const self! lib!impl_u.l0.PageTableContents.)
(declare-const base! Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!impl_u.l0.PageTableContents. self!) TYPE%lib!impl_u.l0.PageTableContents.))
(assert (<= 0 base!))
(assert (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. self!)))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (=> (is-core!result.Result./Ok_ (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!))) (lib!impl_u.l0.impl&%0.inv.? (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!)))))))) (=> %%location_label%%1 (=> (is-core!result.Result./Err_ (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!))) (= (%Poly%lib!impl_u.l0.PageTableContents. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. (lib!impl_u.l0.impl&%0.unmap.? (Poly%lib!impl_u.l0.PageTableContents. self!) (I base!)))))) self!))))))
(check-sat)
(exit)
