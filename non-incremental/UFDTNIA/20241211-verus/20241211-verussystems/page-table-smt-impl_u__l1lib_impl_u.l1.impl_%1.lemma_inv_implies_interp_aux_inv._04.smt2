...
(set-info :comment ";; page-table/impl_u/l1.rs:416:13: 431:15 (#0)")
...
(assert (<= 0 i!))
(assert (has_type (Poly%lib!impl_u.l0.PageTableContents. entry_i@) TYPE%lib!impl_u.l0.PageTableContents.))
(assert (has_type (Poly%lib!impl_u.l0.PageTableContents. rem@) TYPE%lib!impl_u.l0.PageTableContents.))
...
(assert (not (=> (= interp@ (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (=> (= entry_i@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (=> (= rem@ (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))) (=> (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))) (=> (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))) (=> (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l1.impl&%1.upper_vaddr.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%0 (<= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@))))) (and (=> %%location_label%%1 (>= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@))))) (and (=> %%location_label%%2 (<= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))))))) (=> %%location_label%%3 (>= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))))))))))))))))))
(check-sat)
(exit)
