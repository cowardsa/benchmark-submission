...
(set-info :comment ";; page-table/impl_u/indexing.rs:139:13: 139:19 (#0)")
...
(declare-const idx2@ Poly)
(declare-const idx2$1@ Poly)
...
(assert (not (=> (< 0 (%I n$1@)) (=> (< 0 entry_size!) (=> (lib!definitions_t.aligned.? (I base!) n$1@) (=> (lib!definitions_t.aligned.? (I entry_size!) n$1@) (and (=> (= tmp%5 (Add idx! 1)) (and (=> %%location_label%%0 (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%5 entry_size!)) (=> (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%5 entry_size!) (=> %%location_label%%1 (lib!definitions_t.aligned.? (I (nClip (Mul (nClip (Add idx! 1)) entry_size!))) (I entry_size!)))))) (=> (lib!definitions_t.aligned.? (I (nClip (Mul (nClip (Add idx! 1)) entry_size!))) (I entry_size!)) (and (=> (= tmp%6 (nClip (Mul (nClip (Add idx! 1)) entry_size!))) (and (=> %%location_label%%2 (req%lib!extra.aligned_transitive. tmp%6 entry_size! (%I n$1@))) (=> (ens%lib!extra.aligned_transitive. tmp%6 entry_size! (%I n$1@)) (=> %%location_label%%3 (lib!definitions_t.aligned.? (I (nClip (Mul (nClip (Add idx! 1)) entry_size!))) n$1@))))) (=> (lib!definitions_t.aligned.? (I (nClip (Mul (nClip (Add idx! 1)) entry_size!))) n$1@) (and (=> (= tmp%7 (nClip (Mul (nClip (Add idx! 1)) entry_size!))) (and (=> %%location_label%%4 (req%lib!extra.mod_add_zero. base! tmp%7 (%I n$1@))) (=> (ens%lib!extra.mod_add_zero. base! tmp%7 (%I n$1@)) (=> %%location_label%%5 (lib!definitions_t.aligned.? (I (nClip (Add base! (nClip (Mul (nClip (Add idx! 1)) entry_size!))))) n$1@))))) (=> (lib!definitions_t.aligned.? (I (nClip (Add base! (nClip (Mul (nClip (Add idx! 1)) entry_size!))))) n$1@) (=> %%location_label%%6 (lib!definitions_t.aligned.? (I (lib!definitions_t.next_entry_base_from_index.? (I base!) (I idx!) (I entry_size!))) n$1@))))))))))))))
(check-sat)
(exit)
