...
(declare-const d$1@ lib!impl_u.l1.Directory.)
(declare-const tmp%%$1@ lib!impl_u.l1.NodeEntry.)
(declare-const entry$1@ Int)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (has_type self! TYPE%lib!impl_u.l1.Directory.))
(assert (has_type vaddr! NAT))
...
(assert (not (=> (= decrease%init0 (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)))) (=> (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? self!)) vaddr!)) (=> (= tmp%4 (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l0.impl&%0.accepted_resolve.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? self!)) vaddr!))) (and (=> %%location_label%%0 tmp%4) (=> tmp%4 (=> (ens%lib!impl_u.l0.ambient_lemmas1. 0) (=> (ens%lib!impl_u.l1.ambient_lemmas2. 0) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. (%Poly%lib!impl_u.l1.Directory. self!)) (=> (= tmp%5 (lib!definitions_t.between.? vaddr! (I (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. self!))) (I (lib!impl_u.l1.impl&%1.upper_vaddr.? self!)))) (and (=> %%location_label%%1 tmp%5) (=> tmp%5 (=> (= entry$1@ (lib!impl_u.l1.impl&%1.index_for_vaddr.? self! vaddr!)) (=> (= tmp%6 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. self!))) (=> (= tmp%7 (lib!impl_u.l1.impl&%1.entry_size.? self!)) (=> (= tmp%8 (lib!impl_u.l1.impl&%1.num_entries.? self!)) (=> (ens%lib!impl_u.indexing.lemma_index_from_base_and_addr. tmp%6 (%I vaddr!) tmp%7 tmp%8) (=> (= tmp%9 (and (<= 0 entry$1@) (< entry$1@ (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))))))) (and (=> %%location_label%%2 tmp%9) (=> tmp%9 (=> (= tmp%%$1@ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) (I entry$1@)))) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%$1@) (=> (= p@ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%$1@)))) %%switch_label%%2)) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%$1@)) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%$1@) (=> (= d$1@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%$1@)))) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. d$1@) (=> (= tmp%10 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. d$1@))) (and (=> %%location_label%%3 tmp%10) (=> tmp%10 %%switch_label%%3)))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%$1@)) %%switch_label%%3)) (and (not %%switch_label%%3) %%switch_label%%2)))) (and (not %%switch_label%%2) (=> (= entry@ (lib!impl_u.l1.impl&%1.index_for_vaddr.? self! vaddr!)) (=> (= tmp%%@ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) (I entry@)))) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@) (=> (= tmp%3 (let ((pte$ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@))))) (let ((offset$ (Sub (%I vaddr!) (lib!impl_u.l1.impl&%1.entry_base.? self! (I entry@))))) (core!result.Result./Ok (Poly%tuple%2. (tuple%2./tuple%2 (I (lib!impl_u.l1.impl&%1.entry_base.? self! (I entry@))) (Poly%lib!definitions_t.PageTableEntry. pte$))))))) %%switch_label%%0)) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@)) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@) (=> (= d@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@)))) (and (=> %%location_label%%4 (check_decrease_int (let ((self!$0 d@) (vaddr!$1 (%I vaddr!))) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 false)) (=> (has_type (Poly%core!result.Result. tmp%1) (TYPE%core!result.Result. $ (TYPE%tuple%2. $ NAT $ TYPE%lib!definitions_t.PageTableEntry.) $ TYPE%tuple%0.)) (=> (= tmp%1 (lib!impl_u.l1.impl&%1.resolve.? (Poly%lib!impl_u.l1.Directory. d@) vaddr!)) (=> (= tmp%2 tmp%1) %%switch_label%%1)))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@)) (=> (= tmp%2 (core!result.Result./Err (Poly%tuple%0. tuple%0./tuple%0))) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%3 tmp%2) %%switch_label%%0))))) (not %%switch_label%%0))))))))))))))))))))))))))))
(check-sat)
(exit)
