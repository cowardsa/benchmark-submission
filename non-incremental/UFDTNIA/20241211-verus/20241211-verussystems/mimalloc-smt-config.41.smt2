...
(set-info :comment ";; Function-Specs lib::config::option_decommit_extend_delay")
(declare-fun ens%lib!config.option_decommit_extend_delay. (Int Int) Bool)
(assert (forall ((no%param Int) (%return! Int)) (! (= (ens%lib!config.option_decommit_extend_delay. no%param %return!) (iInv 64 %return!)) :pattern ((ens%lib!config.option_decommit_extend_delay. no%param %return!)))))
(set-info :comment ";; Function-Def lib::config::option_decommit_extend_delay")
(set-info :comment ";; config.rs:127:1: 127:45 (#0)")
