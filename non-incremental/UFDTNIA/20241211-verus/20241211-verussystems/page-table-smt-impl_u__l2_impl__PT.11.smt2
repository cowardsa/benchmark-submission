...
(declare-const tmp%1 vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>.)
...
(declare-const res@ lib!impl_u.l1.Directory.)
...
(assert (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!)))))
...
(assert (not (=> (= tmp%1 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (vstd!seq.Seq.empty.? $ TYPE%lib!impl_u.l1.NodeEntry.))) (and (=> %%location_label%%0 (req%lib!impl_u.l2_impl.PT.lemma_interp_at_aux_facts. mem! pt! layer! ptr! base_vaddr! tmp%1)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_interp_at_aux_facts. mem! pt! layer! ptr! base_vaddr! tmp%1) (=> (= res@ (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!))) (=> (= tmp%2 (lib!impl_u.l1.impl&%1.pages_match_entry_size.? (Poly%lib!impl_u.l1.Directory. res@))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (lib!impl_u.l1.impl&%1.directories_are_in_next_layer.? (Poly%lib!impl_u.l1.Directory. res@))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (lib!impl_u.l1.impl&%1.directories_match_arch.? (Poly%lib!impl_u.l1.Directory. res@))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (lib!impl_u.l1.impl&%1.directories_obey_invariant.? (Poly%lib!impl_u.l1.Directory. res@))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= tmp%6 (lib!impl_u.l1.impl&%1.directories_are_nonempty.? (Poly%lib!impl_u.l1.Directory. res@))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> (= tmp%7 (lib!impl_u.l1.impl&%1.frames_aligned.? (Poly%lib!impl_u.l1.Directory. res@))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (and (=> %%location_label%%7 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. res@)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_inv. res@) (and (=> %%location_label%%8 (= (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!))))) base_vaddr!)) (and (=> %%location_label%%9 (= (lib!impl_u.l1.impl&%1.upper_vaddr.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!)))) (lib!definitions_t.impl&%8.upper_vaddr.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I layer!) (I base_vaddr!)))) (and (=> %%location_label%%10 (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!))))))) base_vaddr!)) (and (=> %%location_label%%11 (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!))))))) (lib!definitions_t.impl&%8.upper_vaddr.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I layer!) (I base_vaddr!)))) (=> %%location_label%%12 (let ((res$ (lib!impl_u.l2_impl.PT.interp_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!)))) (forall ((j$ Poly)) (! (=> (has_type j$ NAT) (=> (< (%I j$) (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. res$)))))) (= (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. res$)))) j$)) (lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) j$)))) :pattern ((lib!impl_u.l2_impl.PT.interp_at_entry.? (Poly%lib!spec_t.mem.PageTableMemory. mem!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) (I base_vaddr!) j$))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
