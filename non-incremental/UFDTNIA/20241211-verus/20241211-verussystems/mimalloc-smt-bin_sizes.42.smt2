...
(assert (uInv 64 mid!))
(assert (uInv 64 hi!))
(assert (and (<= lo! mid!) (< mid! hi!)))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!bin_sizes.leading_zeros_monotonic. hi!) (=> (ens%lib!bin_sizes.leading_zeros_monotonic. mid!) (=> %%location_label%%0 (let ((tmp%%$ (vstd!std_specs.bits.u64_leading_zeros.? (I mid!)))) (and (>= (vstd!std_specs.bits.u64_leading_zeros.? (I lo!)) tmp%%$) (>= tmp%%$ (vstd!std_specs.bits.u64_leading_zeros.? (I hi!))))))))))
(check-sat)
(exit)
