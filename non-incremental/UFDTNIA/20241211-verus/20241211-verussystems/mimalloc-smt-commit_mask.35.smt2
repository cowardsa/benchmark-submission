...
(assert (uInv SZ idx!))
(assert (and (<= 0 idx!) (< idx! lib!config.COMMIT_MASK_BITS.?)))
...
(assert (not (=> (ens%lib!config.const_facts. 0) (and (=> %%location_label%%0 (not (= (uClip SZ SZ) 0))) (=> (= i@0 (uClip SZ (EucDiv idx! (uClip SZ SZ)))) (and (=> %%location_label%%1 (not (= (uClip SZ SZ) 0))) (=> (= ofs@0 (uClip SZ (EucMod idx! (uClip SZ SZ)))) (=> (= mask@0 0) (and (=> %%location_label%%2 (= ofs@0 (uClip SZ (EucMod idx! (uClip SZ SZ))))) (=> (< ofs@0 64) (and (=> %%location_label%%3 (< ofs@0 64)) (=> (uInv SZ i@1) (=> (uInv SZ ofs@1) (=> (uInv SZ mask@1) (=> (< ofs@1 64) (=> (=> (< i@1 8) (= mask@1 (uClip SZ (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@1)))) (I ofs@1))))) (=> (=> (< i@1 8) (< ofs@1 64)) (=> (=> (< i@1 8) (= (uClip SZ (bitand (I mask@1) (I 1))) 1)) (or (and (=> (>= i@1 (uClip SZ lib!config.COMMIT_MASK_FIELD_COUNT.?)) (=> (= tmp%6 (tuple%2./tuple%2 (I (uClip SZ lib!config.COMMIT_MASK_BITS.?)) (I 0))) (=> (= count@1 count@0) (=> (= i@2 i@1) (=> (= ofs@2 ofs@1) (=> (= mask@2 mask@1) %%switch_label%%0)))))) (=> (not (>= i@1 (uClip SZ lib!config.COMMIT_MASK_FIELD_COUNT.?))) (=> (= count@0 0) (and (=> %%location_label%%4 (uInv SZ (Mul i@1 (uClip SZ SZ)))) (and (=> %%location_label%%5 (uInv SZ (Add (uClip SZ (Mul i@1 (uClip SZ SZ))) ofs@1))) (=> (= next_idx@ (uClip SZ (Add (uClip SZ (Mul i@1 (uClip SZ SZ))) ofs@1))) (and (=> %%location_label%%6 (< ofs@1 64)) (=> (= (EucMod (Add (Mul i@1 64) ofs@1) 64) ofs@1) (and (=> %%location_label%%7 (= (uClip SZ (bitand (I mask@1) (I 1))) 1)) (and (=> %%location_label%%8 (< i@1 8)) (and (=> %%location_label%%9 (= mask@1 (uClip SZ (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I i@1)))) (I (lib!commit_mask.mod64.? (I (uClip SZ (Add next_idx@ count@0))))))))) (and (=> %%location_label%%10 (= (EucDiv (Add next_idx@ count@0) 64) i@1)) (and (=> %%location_label%%11 (forall ((j$ Poly)) (! (=> (has_type j$ (UINT SZ)) (=> (and (<= next_idx@ (%I j$)) (< (%I j$) (Add next_idx@ count@0))) (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I (lib!commit_mask.div64.? j$))) (I (lib!commit_mask.mod64.? j$))))) :pattern ((lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I (lib!commit_mask.div64.? j$))) (I (lib!commit_mask.mod64.? j$))))))) (=> (uInv SZ i@2) (=> (uInv SZ ofs@2) (=> (uInv SZ mask@2) (=> (uInv SZ count@1) (=> (forall ((j$ Poly)) (! (=> (has_type j$ (UINT SZ)) (=> (and (<= next_idx@ (%I j$)) (< (%I j$) (Add next_idx@ count@1))) (lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I (lib!commit_mask.div64.? j$))) (I (lib!commit_mask.mod64.? j$))))) :pattern ((lib!commit_mask.is_bit_set.? (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT SZ) $ (CONST_INT 8)) (Poly%array%. (lib!commit_mask.CommitMask./CommitMask/mask (%Poly%lib!commit_mask.CommitMask. (Poly%lib!commit_mask.CommitMask. self!))))) (I (lib!commit_mask.div64.? j$))) (I (lib!commit_mask.mod64.? j$)))))) (=> (<= (Add next_idx@ count@1) 512) (and (=> (has_type j@ (UINT SZ)) (=> (and (<= next_idx@ (%I j@)) (< (%I j@) (Add next_idx@ count@1))) (=> (ens%lib!commit_mask.impl&%0.lemma_view. self!) (=> (= tmp%5 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) (I (Add (Mul (lib!commit_mask.div64.? j@) 64) (lib!commit_mask.mod64.? j@))))) (and (=> %%location_label%%12 tmp%5) (=> tmp%5 (=> %%location_label%%13 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) j@)))))))) (=> (forall ((j$ Poly)) (! (=> (has_type j$ (UINT SZ)) (=> (and (<= next_idx@ (%I j$)) (< (%I j$) (Add next_idx@ count@1))) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) j$))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) j$)))) (=> (= tmp%6 (tuple%2./tuple%2 (I next_idx@) (I count@1))) %%switch_label%%0)))))))))))))))))))))) (and (not %%switch_label%%0) (=> (= res! tmp%6) (=> %%location_label%%14 (let ((next_idx$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((count$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (and (<= (Add next_idx$ count$) lib!config.COMMIT_MASK_BITS.?) (forall ((t$ Poly)) (! (=> (has_type t$ INT) (=> (and (<= next_idx$ (%I t$)) (< (%I t$) (Add next_idx$ count$))) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) t$))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (lib!commit_mask.impl&%0.view.? (Poly%lib!commit_mask.CommitMask. self!))) t$)))))))))))))))))))))))))))))
(check-sat)
(exit)
