...
(declare-const result! ptr_mut%<lib!types.Page.>.)
(declare-const page_ptr! ptr_mut%<lib!types.Page.>.)
(declare-const offset! Int)
(declare-const page_id! lib!tokens.PageId.)
(declare-const target_page_id! lib!tokens.PageId.)
(declare-const tmp%1 lib!tokens.SegmentId.)
(declare-const tmp%2 Poly)
(declare-const p@ Int)
(declare-const q@ Int)
(assert fuel_defaults)
(assert (uInv 32 offset!))
(assert (has_type (Poly%lib!tokens.PageId. page_id!) TYPE%lib!tokens.PageId.))
(assert (has_type (Poly%lib!tokens.PageId. target_page_id!) TYPE%lib!tokens.PageId.))
(assert (lib!layout.is_page_ptr.? (Poly%ptr_mut%<lib!types.Page.>. page_ptr!) (Poly%lib!tokens.PageId. page_id!)))
(assert (= (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. page_id!))) (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. target_page_id!)))))
(assert (= offset! (Mul (Sub (lib!tokens.PageId./PageId/idx (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. page_id!))) (lib!tokens.PageId./PageId/idx (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. target_page_id!)))) lib!config.SIZEOF_PAGE_HEADER.?)))
(set-info :comment ";; possible arithmetic underflow/overflow")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. page_id!)))) (=> (ens%lib!layout.segment_start_ge0. tmp%1) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ TYPE%lib!types.Page. (Poly%ptr_mut%<lib!types.Page.>. page_ptr!) p@) (and (=> %%location_label%%0 (uInv SZ (Sub p@ (uClip SZ offset!)))) (=> (= q@ (uClip SZ (Sub p@ (uClip SZ offset!)))) (=> (ens%core!ptr.mut_ptr.impl&%0.with_addr. $ TYPE%lib!types.Page. (Poly%ptr_mut%<lib!types.Page.>. page_ptr!) q@ tmp%2) (=> (= result! (%Poly%ptr_mut%<lib!types.Page.>. tmp%2)) (=> %%location_label%%1 (lib!layout.is_page_ptr.? (Poly%ptr_mut%<lib!types.Page.>. result!) (Poly%lib!tokens.PageId. target_page_id!))))))))))))
(check-sat)
(exit)
