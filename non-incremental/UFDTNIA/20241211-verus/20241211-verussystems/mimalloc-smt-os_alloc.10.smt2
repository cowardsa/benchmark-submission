...
(declare-const hint! ptr_mut%<u8.>.)
(declare-const size! Int)
(declare-const try_alignment! Int)
(declare-const prot_rw! Bool)
...
(declare-const verus_tmp_mem@ lib!os_mem.MemChunk.)
(declare-const mem@0 lib!os_mem.MemChunk.)
(declare-const hinti@ Int)
(declare-const hint@ ptr_mut%<u8.>.)
(declare-const tmp%10 tuple%2.)
(declare-const tmp%11 tuple%2.)
(declare-const tmp%12 tuple%2.)
(declare-const tmp%13 Int)
(declare-const tmp%14 Poly)
(declare-const tmp%%$1@ tuple%2.)
(declare-const p$1@ ptr_mut%<u8.>.)
(declare-const verus_tmp_mem$1@ lib!os_mem.MemChunk.)
(declare-const mem$1@0 lib!os_mem.MemChunk.)
(assert fuel_defaults)
(assert (uInv SZ size!))
(assert (uInv SZ try_alignment!))
(assert (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. hint!)) (lib!os_mem.page_size.? (I 0))) 0))
(assert (= (EucMod size! (lib!os_mem.page_size.? (I 0))) 0))
(assert (<= size! lib!config.SEGMENT_SIZE.?))
(assert (=> (> try_alignment! 1) (= (EucMod try_alignment! (lib!os_mem.page_size.? (I 0))) 0)))
(declare-const mem@1 lib!os_mem.MemChunk.)
(declare-const mem$1@1 lib!os_mem.MemChunk.)
...
(assert (not (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. hint!) tmp%1) (or (and (=> (and (= tmp%1 0) (>= lib!config.INTPTR_SIZE.? 8)) (and (=> %%location_label%%0 (req%lib!os_alloc.os_get_aligned_hint. try_alignment! size!)) (=> (ens%lib!os_alloc.os_get_aligned_hint. try_alignment! size! hinti@) (=> (ens%core!ptr.mut_ptr.impl&%0.with_addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. hint!) hinti@ tmp%2) (=> (= hint@ (%Poly%ptr_mut%<u8.>. tmp%2)) (=> (ens%lib!config.const_facts. 0) (or (and (=> (> try_alignment! 1) (=> (= tmp%3 (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. hint@))) (=> (= tmp%4 (lib!os_mem.page_size.? (I 0))) (and (=> %%location_label%%1 (req%lib!layout.mod_trans. tmp%3 try_alignment! tmp%4)) (=> (ens%lib!layout.mod_trans. tmp%3 try_alignment! tmp%4) %%switch_label%%6))))) (=> (not (> try_alignment! 1)) %%switch_label%%6)) (and (not %%switch_label%%6) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. hint@) tmp%5) (or (and (=> (not (= tmp%5 0)) (or (and (=> prot_rw! (and (=> %%location_label%%2 (req%lib!os_mem.mmap_prot_read_write. hint@ size!)) (=> (ens%lib!os_mem.mmap_prot_read_write. hint@ size! tmp%6) (=> (= tmp%8 tmp%6) %%switch_label%%5)))) (=> (not prot_rw!) (and (=> %%location_label%%3 (req%lib!os_mem.mmap_prot_none. hint@ size!)) (=> (ens%lib!os_mem.mmap_prot_none. hint@ size! tmp%7) (=> (= tmp%8 tmp%7) %%switch_label%%5))))) (and (not %%switch_label%%5) (=> (= tmp%%@ tmp%8) (=> (= p@ (%Poly%ptr_mut%<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= verus_tmp_mem@ (%Poly%lib!os_mem.MemChunk. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= mem@1 verus_tmp_mem@) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. p@) tmp%9) (or (and (=> (not (= tmp%9 lib!os_mem.MAP_FAILED.?)) (=> (= res! (tuple%2./tuple%2 (Poly%ptr_mut%<u8.>. p@) (Poly%lib!os_mem.MemChunk. mem@1))) (=> %%location_label%%4 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (lib!os_mem.impl&%0.os_exact_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (=> prot_rw! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> prot_rw! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not prot_rw!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))))))))) (=> (not (not (= tmp%9 lib!os_mem.MAP_FAILED.?))) %%switch_label%%4)) (and (not %%switch_label%%4) %%switch_label%%3)))))))))) (=> (not (not (= tmp%5 0))) (=> (= mem@1 mem@0) %%switch_label%%3))) (and (not %%switch_label%%3) %%switch_label%%2))))))))))) (=> (not (and (= tmp%1 0) (>= lib!config.INTPTR_SIZE.? 8))) (=> (= mem@1 mem@0) %%switch_label%%2))) (and (not %%switch_label%%2) (or (and (=> prot_rw! (and (=> %%location_label%%5 (req%lib!os_mem.mmap_prot_read_write. hint! size!)) (=> (ens%lib!os_mem.mmap_prot_read_write. hint! size! tmp%10) (=> (= tmp%12 tmp%10) %%switch_label%%1)))) (=> (not prot_rw!) (and (=> %%location_label%%6 (req%lib!os_mem.mmap_prot_none. hint! size!)) (=> (ens%lib!os_mem.mmap_prot_none. hint! size! tmp%11) (=> (= tmp%12 tmp%11) %%switch_label%%1))))) (and (not %%switch_label%%1) (=> (= tmp%%$1@ tmp%12) (=> (= p$1@ (%Poly%ptr_mut%<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@))))) (=> (= verus_tmp_mem$1@ (%Poly%lib!os_mem.MemChunk. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@))))) (=> (= mem$1@1 verus_tmp_mem$1@) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. p$1@) tmp%13) (or (and (=> (not (= tmp%13 lib!os_mem.MAP_FAILED.?)) (=> (= res! (tuple%2./tuple%2 (Poly%ptr_mut%<u8.>. p$1@) (Poly%lib!os_mem.MemChunk. mem$1@1))) (=> %%location_label%%7 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (lib!os_mem.impl&%0.os_exact_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (=> prot_rw! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> prot_rw! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not prot_rw!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))))))))) (=> (not (not (= tmp%13 lib!os_mem.MAP_FAILED.?))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (ens%core!ptr.null_mut. $ (UINT 8) tmp%14) (=> (= res! (tuple%2./tuple%2 tmp%14 (Poly%lib!os_mem.MemChunk. mem$1@1))) (=> %%location_label%%8 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (lib!os_mem.impl&%0.os_exact_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (=> prot_rw! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> prot_rw! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not prot_rw!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))))))))))))))))))))))))
(check-sat)
(exit)
