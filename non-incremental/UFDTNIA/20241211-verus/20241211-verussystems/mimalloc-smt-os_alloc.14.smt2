...
(declare-const tmp%4 lib!os_mem.MemChunk.)
...
(assert (not (=> (= allow_large@0 allow_large!) (or (and (=> (not request_commit!) (=> (= allow_large@1 false) %%switch_label%%4)) (=> (not (not request_commit!)) (=> (= allow_large@1 allow_large@0) %%switch_label%%4))) (and (not %%switch_label%%4) (=> (ens%lib!os_mem.get_page_size. 0 tmp%1) (or (and (=> (>= alignment! tmp%1) (and (=> %%location_label%%0 (uInv SZ (Sub alignment! 1))) (=> (= tmp%2 (= (uClip SZ (bitand (I alignment!) (I (uClip SZ (Sub alignment! 1))))) 0)) %%switch_label%%3))) (=> (not (>= alignment! tmp%1)) (=> (= tmp%2 false) %%switch_label%%3))) (and (not %%switch_label%%3) (or (and (=> (not tmp%2) (=> (ens%core!ptr.null_mut. $ (UINT 8) tmp%3) (=> (= res! (tuple%3./tuple%3 tmp%3 (B allow_large@1) (Poly%lib!os_mem.MemChunk. tmp%4))) (=> %%location_label%%1 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((is_large$ (%B (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (lib!os_mem.impl&%0.os_exact_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (=> request_commit! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> request_commit! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not request_commit!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> (not (= alignment! 0)) (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) alignment!) 0))))))))))) (=> (not (not tmp%2)) %%switch_label%%2)) (and (not %%switch_label%%2) (and (=> %%location_label%%2 (req%lib!os_alloc.os_mem_alloc. size! alignment! request_commit! allow_large@1)) (=> (ens%lib!os_alloc.os_mem_alloc. size! alignment! request_commit! allow_large@1 tmp%%@) (=> (= p@ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%@))))) (=> (= is_large@ (%B (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%@))))) (=> (= verus_tmp_mem@ (%Poly%lib!os_mem.MemChunk. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%@))))) (=> (= mem@1 verus_tmp_mem@) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. p@) tmp%5) (or (and (=> (= tmp%5 0) (=> (= res! (tuple%3./tuple%3 (Poly%ptr_mut%<u8.>. p@) (B is_large@) (Poly%lib!os_mem.MemChunk. mem@1))) (=> %%location_label%%3 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((is_large$ (%B (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (lib!os_mem.impl&%0.os_exact_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (=> request_commit! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> request_commit! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not request_commit!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> (not (= alignment! 0)) (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) alignment!) 0)))))))))) (=> (not (= tmp%5 0)) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ (UINT 8) (Poly%ptr_mut%<u8.>. p@) tmp%6) (and (=> %%location_label%%4 (not (= alignment! 0))) (or (and (=> (not (= (uClip SZ (EucMod tmp%6 alignment!)) 0)) (=> (ens%lib!types.todo. 0) %%switch_label%%0)) (=> (not (not (= (uClip SZ (EucMod tmp%6 alignment!)) 0))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= res! (tuple%3./tuple%3 (Poly%ptr_mut%<u8.>. p@) (B is_large@) (Poly%lib!os_mem.MemChunk. mem@1))) (=> %%location_label%%5 (let ((addr$ (%Poly%ptr_mut%<u8.>. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((is_large$ (%B (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (let ((mem$ (%Poly%lib!os_mem.MemChunk. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. res!)))))) (=> (not (= (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) 0)) (and (and (and (and (and (and (and (lib!os_mem.impl&%0.wf.? (Poly%lib!os_mem.MemChunk. mem$)) (lib!os_mem.impl&%0.os_exact_range.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!))) (= (vstd!raw_ptr.impl&%11.provenance.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))) (vstd!raw_ptr.PtrData./PtrData/provenance (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.? $ (PTR $ (UINT 8)) (Poly%ptr_mut%<u8.>. addr$)))))) (<= (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!) (- (uHi SZ) 1))) (=> request_commit! (lib!os_mem.impl&%0.os_has_range_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> request_commit! (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I (Add (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) size!)))) (Poly%vstd!set.Set<int.>. (vstd!raw_ptr.impl&%11.dom.? (Poly%vstd!raw_ptr.PointsToRaw. (lib!os_mem.MemChunk./MemChunk/points_to (%Poly%lib!os_mem.MemChunk. (Poly%lib!os_mem.MemChunk. mem$))))))))) (=> (not request_commit!) (lib!os_mem.impl&%0.os_has_range_no_read_write.? (Poly%lib!os_mem.MemChunk. mem$) (I (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$))) (I size!)))) (=> (not (= alignment! 0)) (= (EucMod (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ (UINT 8) (Poly%ptr_mut%<u8.>. addr$)) alignment!) 0))))))))))))))))))))))))))))))))
(check-sat)
(exit)
