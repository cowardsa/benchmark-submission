...
(set-info :comment ";; page-table/definitions_u.rs:258:1: 258:28 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_u::x86_arch_inv")
(set-info :comment ";; page-table/definitions_u.rs:258:1: 258:28 (#0)")
...
(assert (not (=> (= tmp%1 (= (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I 3)) 4096)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (lib!definitions_t.impl&%8.contains_entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) (I 4096))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (<= (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?))))) lib!definitions_t.X86_NUM_LAYERS.?)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (and (=> (has_type i@ NAT) (=> (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?)))))) (=> (= tmp%4 (let ((tmp%%$ (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i@))) (and (< 0 tmp%%$) (<= tmp%%$ lib!definitions_t.X86_MAX_ENTRY_SIZE.?)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (let ((tmp%%$ (lib!definitions_t.impl&%8.num_entries.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i@))) (and (< 0 tmp%%$) (<= tmp%%$ lib!definitions_t.X86_NUM_ENTRIES.?)))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= tmp%6 (lib!definitions_t.impl&%8.entry_size_is_next_layer_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i@)) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> %%location_label%%6 (and (and (let ((tmp%%$ (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i@))) (and (< 0 tmp%%$) (<= tmp%%$ lib!definitions_t.X86_MAX_ENTRY_SIZE.?))) (let ((tmp%%$ (lib!definitions_t.impl&%8.num_entries.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i@))) (and (< 0 tmp%%$) (<= tmp%%$ lib!definitions_t.X86_NUM_ENTRIES.?)))) (lib!definitions_t.impl&%8.entry_size_is_next_layer_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i@)))))))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?)))))) (and (and (let ((tmp%%$ (lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i$))) (and (< 0 tmp%%$) (<= tmp%%$ lib!definitions_t.X86_MAX_ENTRY_SIZE.?))) (let ((tmp%%$ (lib!definitions_t.impl&%8.num_entries.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i$))) (and (< 0 tmp%%$) (<= tmp%%$ lib!definitions_t.X86_NUM_ENTRIES.?)))) (lib!definitions_t.impl&%8.entry_size_is_next_layer_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i$)))) :pattern ((lib!definitions_t.impl&%8.entry_size.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i$) (lib!definitions_t.impl&%8.num_entries.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?) i$)))) (=> (= tmp%7 (lib!definitions_t.impl&%8.inv.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?))) (and (=> %%location_label%%7 tmp%7) (=> tmp%7 (=> %%location_label%%8 (lib!definitions_t.impl&%8.inv.? (Poly%lib!definitions_t.Arch. lib!definitions_t.x86_arch_spec.?)))))))))))))))))))
(check-sat)
(exit)
