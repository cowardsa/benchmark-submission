...
(set-info :comment ";; Spec-Termination lib::spec::cyclicbuffer::map_min_value")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/cyclicbuffer.rs:747:1: 747:69 (#0)")
...
(set-info :comment ";; Function-Def lib::spec::cyclicbuffer::map_min_value_smallest")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/spec/cyclicbuffer.rs:757:7: 757:63 (#0)")
...
(assert (<= 0 idx!))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (and (<= 0 (%I i$)) (<= (%I i$) idx!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$)))))
...
(assert (not (=> (= decrease%init0 idx!) (or (and (=> (= idx! 0) (=> (= tmp%1 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I 0))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (= idx! 0)) (=> (= tmp%2 (nClip (Sub idx! 1))) (and (=> %%location_label%%1 (check_decrease_int (let ((m!$0 m!) (idx!$1 tmp%2)) idx!$1) decrease%init0 false)) (and (=> %%location_label%%2 (req%lib!spec.cyclicbuffer.map_min_value_smallest. m! tmp%2)) (=> (ens%lib!spec.cyclicbuffer.map_min_value_smallest. m! tmp%2) (or (and (=> (< (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I idx!))) (lib!spec.cyclicbuffer.map_min_value.? (Poly%vstd!map.Map<nat./nat.>. m!) (I (nClip (Sub idx! 1))))) (=> (= tmp%3 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I idx!))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 %%switch_label%%1)))) (=> (not (< (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I idx!))) (lib!spec.cyclicbuffer.map_min_value.? (Poly%vstd!map.Map<nat./nat.>. m!) (I (nClip (Sub idx! 1)))))) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))))))) (and (not %%switch_label%%0) (and (=> %%location_label%%4 (forall ((n$ Poly)) (! (=> (has_type n$ NAT) (=> (and (<= 0 (%I n$)) (<= (%I n$) idx!)) (<= (lib!spec.cyclicbuffer.map_min_value.? (Poly%vstd!map.Map<nat./nat.>. m!) (I idx!)) (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) n$))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) n$))))) (=> %%location_label%%5 (lib!spec.utils.map_contains_value.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I (lib!spec.cyclicbuffer.map_min_value.? (Poly%vstd!map.Map<nat./nat.>. m!) (I idx!)))))))))))
(check-sat)
(exit)
