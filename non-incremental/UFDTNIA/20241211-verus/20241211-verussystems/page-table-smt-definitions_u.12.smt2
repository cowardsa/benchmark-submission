...
(assert (not (and (=> %%location_label%%0 true) (=> (< (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1)) 18446744073709551616) (and (=> %%location_label%%1 true) (=> (< (Add lib!definitions_t.MAX_BASE.? (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1))) 18446744073709551616) (and (=> %%location_label%%2 (< (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1)) 18446744073709551616)) (=> %%location_label%%3 (< (Add lib!definitions_t.MAX_BASE.? (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1))) 18446744073709551616)))))))))
(check-sat)
(exit)
