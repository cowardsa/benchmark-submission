...
(assert (not (=> (= decrease%init0 (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!))))) (=> (= decrease%init1 (Sub (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!)) i!)) (=> (ens%lib!impl_u.l0.ambient_lemmas1. 0) (=> (= interp@ (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (or (and (=> (>= i! (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))))) %%switch_label%%0) (=> (not (>= i! (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!))))))) (=> (= tmp%1 (< i! (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!))))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (nClip (Add i! 1))) (and (=> %%location_label%%1 (check_decrease_int (let ((self!$0 self!) (i!$1 tmp%2)) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 (check_decrease_int (let ((self!$0 self!) (i!$1 tmp%2)) (Sub (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!$0)) i!$1)) decrease%init1 false))) (and (=> %%location_label%%2 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_aux_inv. self! tmp%2)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_aux_inv. self! tmp%2) (=> (= tmp%3 (lib!impl_u.l1.impl&%1.directories_obey_invariant.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> (= entry@ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (I i!)))) (=> (= entry_i@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (=> (= rem@ (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ entry@) (=> (= p@ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. entry@)))) %%switch_label%%5)) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ entry@)) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ entry@) (=> (= d@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. entry@)))) (and (=> %%location_label%%4 (check_decrease_int (let ((self!$0 d@) (i!$1 0)) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 (check_decrease_int (let ((self!$0 d@) (i!$1 0)) (Sub (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!$0)) i!$1)) decrease%init1 false))) (and (=> %%location_label%%5 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_aux_inv. d@ 0)) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_aux_inv. d@ 0) %%switch_label%%6))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ entry@)) %%switch_label%%6)) (and (not %%switch_label%%6) %%switch_label%%5)))) (and (not %%switch_label%%5) (=> (= tmp%4 (lib!impl_u.l0.impl&%0.mappings_are_of_valid_size.? (Poly%lib!impl_u.l0.PageTableContents. interp@))) (and (=> %%location_label%%6 tmp%4) (=> tmp%4 (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ entry@) (=> (= pte@ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. entry@)))) (=> (= tmp%5 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%6 (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%7 (req%lib!impl_u.indexing.lemma_entry_base_from_index. tmp%5 i! tmp%6)) (=> (ens%lib!impl_u.indexing.lemma_entry_base_from_index. tmp%5 i! tmp%6) (=> (= tmp%7 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) (=> (= tmp%8 (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%8 (req%lib!impl_u.indexing.lemma_entry_base_from_index_support. tmp%7 i! tmp%8)) (=> (ens%lib!impl_u.indexing.lemma_entry_base_from_index_support. tmp%7 i! tmp%8) %%switch_label%%4)))))))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ entry@)) %%switch_label%%4)) (and (not %%switch_label%%4) (=> (= tmp%9 (lib!impl_u.l0.impl&%0.mappings_are_aligned.? (Poly%lib!impl_u.l0.PageTableContents. interp@))) (and (=> %%location_label%%9 tmp%9) (=> tmp%9 (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ entry@) (=> (= pte$1@ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. entry@)))) (and (=> %%location_label%%10 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%11 (= entry_i@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))) (and (=> %%location_label%%12 (= (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!)) (lib!definitions_t.MemRegion./MemRegion/size (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.PageTableEntry./PageTableEntry/frame (%Poly%lib!definitions_t.PageTableEntry. (Poly%lib!definitions_t.PageTableEntry. pte$1@)))))))) (and (=> %%location_label%%13 (< i! (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!))))))) (=> (lib!impl_u.l0.impl&%0.candidate_mapping_in_bounds.? (Poly%lib!impl_u.l0.PageTableContents. entry_i@) (I (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (Poly%lib!definitions_t.PageTableEntry. pte$1@)) %%switch_label%%2))))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ entry@)) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ entry@) (=> (= d$1@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. entry@)))) (and (=> %%location_label%%14 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%15 (= entry_i@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))) (and (=> %%location_label%%16 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0))))) (and (=> %%location_label%%17 (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0))))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))) (and (=> %%location_label%%18 (= (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. d$1@))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))) (and (=> %%location_label%%19 (= (nClip (Mul (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. d$1@)) (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. d$1@)))) (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!)))) (and (=> %%location_label%%20 (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0))))) (lib!impl_u.l1.impl&%1.upper_vaddr.? (Poly%lib!impl_u.l1.Directory. d$1@)))) (and (=> %%location_label%%21 (= (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))) (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0))))))) (and (=> %%location_label%%22 (< i! (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!))))))) (=> (lib!impl_u.l0.impl&%0.mappings_in_bounds.? (Poly%lib!impl_u.l0.PageTableContents. entry_i@)) %%switch_label%%3)))))))))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ entry@)) %%switch_label%%3)) (and (not %%switch_label%%3) %%switch_label%%2)))) (and (not %%switch_label%%2) (=> (= tmp%13 (lib!impl_u.l0.impl&%0.mappings_in_bounds.? (Poly%lib!impl_u.l0.PageTableContents. entry_i@))) (and (=> %%location_label%%23 tmp%13) (=> tmp%13 (=> (= tmp%14 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. entry_i@))) (and (=> %%location_label%%24 tmp%14) (=> tmp%14 (=> (= tmp%15 (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1)))))) (and (=> %%location_label%%25 tmp%15) (=> tmp%15 (and (=> %%location_label%%26 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%27 (= rem@ (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1)))))) (and (=> %%location_label%%28 (= entry_i@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))) (and (=> %%location_label%%29 (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1)))))) (=> (lib!impl_u.l0.impl&%0.ranges_disjoint.? (Poly%lib!impl_u.l0.PageTableContents. rem@) (Poly%lib!impl_u.l0.PageTableContents. entry_i@)) (and (=> %%location_label%%30 (req%lib!impl_u.l0.impl&%0.lemma_ranges_disjoint_implies_mappings_disjoint. rem@ entry_i@)) (=> (ens%lib!impl_u.l0.impl&%0.lemma_ranges_disjoint_implies_mappings_disjoint. rem@ entry_i@) (=> (= tmp%16 (lib!impl_u.l0.impl&%0.mappings_dont_overlap.? (Poly%lib!impl_u.l0.PageTableContents. interp@))) (and (=> %%location_label%%31 tmp%16) (=> tmp%16 (and (=> %%location_label%%32 (= interp@ (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))) (and (=> %%location_label%%33 (= entry_i@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))) (and (=> %%location_label%%34 (= rem@ (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1)))))) (and (=> %%location_label%%35 (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1))))))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1)))))) (and (=> %%location_label%%36 (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1)))))) (and (=> %%location_label%%37 (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l1.impl&%1.upper_vaddr.? (Poly%lib!impl_u.l1.Directory. self!)))) (=> (<= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@)))) (=> (>= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@)))) (=> (<= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1)))))))) (=> (>= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add i! 1)))))))) (=> (= tmp%17 (lib!impl_u.l0.impl&%0.mappings_in_bounds.? (Poly%lib!impl_u.l0.PageTableContents. interp@))) (and (=> %%location_label%%38 tmp%17) (=> tmp%17 (=> (= tmp%18 (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ TYPE%lib!definitions_t.PageTableEntry. (Poly%vstd!map.Map<nat./lib!definitions_t.PageTableEntry.>. (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))))))) (and (=> %%location_label%%39 tmp%18) (=> tmp%18 (or (and (=> (= i! 0) (and (=> %%location_label%%40 (= entry_i@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!)))) (and (=> %%location_label%%41 (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@))) (nClip (Add (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!))) (nClip (Mul i! (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!)))))))) (and (=> %%location_label%%42 (= i! 0)) (=> (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I 0))))) (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))) %%switch_label%%1))))) (=> (not (= i! 0)) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (and (not %%switch_label%%0) (and (=> %%location_label%%43 (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))) (and (=> %%location_label%%44 (=> (<= i! (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))))) (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))) (and (=> %%location_label%%45 (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))) (lib!impl_u.l1.impl&%1.upper_vaddr.? (Poly%lib!impl_u.l1.Directory. self!)))) (=> %%location_label%%46 (=> (= i! 0) (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) (I 0))))) (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))))))))))))))))
(check-sat)
(exit)
