...
(assert (uInv SZ a!))
(assert (uInv SZ b!))
(assert (not (= (uClip SZ (bitand (I a!) (I b!))) b!)))
...
(assert (not (=> (fuel_bool fuel%lib!commit_mask.is_bit_set.) (and (=> %%location_label%%0 true) (=> (= (uClip 64 (bitshr (I (uClip 64 a!)) (I 64))) 0) (and (=> %%location_label%%1 true) (=> (= (uClip 64 (bitshr (I (uClip 64 b!)) (I 64))) 0) (and (=> %%location_label%%2 (req%lib!commit_mask.lemma_obtain_bit_index_3_aux. (uClip 64 a!) (uClip 64 b!) 64)) (=> (ens%lib!commit_mask.lemma_obtain_bit_index_3_aux. (uClip 64 a!) (uClip 64 b!) 64 tmp%1) (=> (= i! (uClip SZ tmp%1)) (and (=> %%location_label%%3 (< i! 64)) (and (=> %%location_label%%4 (not (lib!commit_mask.is_bit_set.? (I a!) (I i!)))) (=> %%location_label%%5 (lib!commit_mask.is_bit_set.? (I b!) (I i!)))))))))))))))
(check-sat)
(exit)
