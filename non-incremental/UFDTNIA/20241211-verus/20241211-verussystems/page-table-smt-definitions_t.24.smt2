...
(assert (has_type min_idx! NAT))
(declare-const %%switch_label%%0 Bool)
(declare-const %%location_label%%0 Bool)
(assert (not (=> (has_type i@ NAT) (or (and (=> (and (<= (%I min_idx!) (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!)))))) (and (=> %%location_label%%0 (req%lib!definitions_t.impl&%8.entry_size. self! i@)) (=> (= tmp%1 (lib!definitions_t.impl&%8.entry_size.? self! i@)) (=> (= tmp%2 (= tmp%1 (%I entry_size!))) %%switch_label%%0)))) (=> (not (and (<= (%I min_idx!) (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!))))))) (=> (= tmp%2 false) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
