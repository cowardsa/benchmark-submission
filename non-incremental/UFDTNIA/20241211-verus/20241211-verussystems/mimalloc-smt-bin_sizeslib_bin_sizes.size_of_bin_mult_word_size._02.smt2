...
(set-info :comment ";; bin_sizes.rs:178:9: 178:15 (#0)")
...
(assert (not (=> %%location_label%%0 (let ((s$ (Add inner@ 5))) (let ((p$ (Mul s$ (lib!bin_sizes.pow2.? (I (Add group@ 1)))))) (= (Mul (Mul 8 (Add inner@ 5)) (lib!bin_sizes.pow2.? (I (Add group@ 1)))) (Mul 8 p$)))))))
(check-sat)
(exit)
