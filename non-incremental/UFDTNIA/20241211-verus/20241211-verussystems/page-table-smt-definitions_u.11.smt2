...
(assert (not (=> (ens%lib!definitions_t.axiom_max_phyaddr_width_facts. 0) (and (=> %%location_label%%0 true) (=> (= (uClip 64 (bitshl (I 1) (I 32))) 4294967296) (and (=> %%location_label%%1 true) (=> (= (uClip 64 (bitshl (I 1) (I 52))) 4503599627370496) (and (=> %%location_label%%2 true) (=> (forall ((m$ Poly) (n$ Poly)) (! (=> (and (has_type m$ (UINT 64)) (has_type n$ (UINT 64))) (=> (and (< (%I n$) (%I m$)) (< (%I m$) 64)) (< (uClip 64 (bitshl (I 1) (I (%I n$)))) (uClip 64 (bitshl (I 1) (I (%I m$))))))) :pattern ((uClip 64 (bitshl (I 1) (I (%I n$)))) (uClip 64 (bitshl (I 1) (I (%I m$))))))) (=> %%location_label%%3 (let ((tmp%%$ lib!definitions_t.MAX_PHYADDR_SPEC.?)) (and (<= 4294967295 tmp%%$) (<= tmp%%$ 4503599627370495)))))))))))))
(check-sat)
(exit)
