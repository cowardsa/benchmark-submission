...
(assert (lib!log.inv_v.no_outstanding_writes_to_active_metadata.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (B cdb!)))
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (= pm_bytes@ (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (= tmp%1 (= cdb! (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!log.layout_v.deserialize_and_check_log_cdb.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@)))))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (ens%lib!pmem.pmemutil_v.lemma_wherever_no_outstanding_writes_persistent_memory_view_can_only_crash_as_committed. pm_region_view!) (and (=> (has_type s@ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (and (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s@) (let ((tmp%%$ lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?)) (let ((tmp%%$1 lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (and (<= 0 tmp%%$) (< tmp%%$ tmp%%$1)) (< tmp%%$1 (vstd!seq.Seq.len.? $ (UINT 8) s@)))))) (=> (= tmp%2 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. (%Poly%vstd!seq.Seq<u8.>. s@) tmp%2) (=> %%location_label%%1 (let ((s_cdb$ (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!log.layout_v.deserialize_and_check_log_cdb.? s@))))))) (and (and (and (and (and (= (lib!log.layout_v.deserialize_global_metadata.? s@) (lib!log.layout_v.deserialize_global_metadata.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@))) (= (lib!log.layout_v.deserialize_global_crc.? s@) (lib!log.layout_v.deserialize_global_crc.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@)))) (= (lib!log.layout_v.deserialize_region_metadata.? s@) (lib!log.layout_v.deserialize_region_metadata.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@)))) (= (lib!log.layout_v.deserialize_region_crc.? s@) (lib!log.layout_v.deserialize_region_crc.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@)))) (= s_cdb$ cdb!)) (ite s_cdb$ (and (= (lib!log.layout_v.deserialize_log_metadata.? s@ (B true)) (lib!log.layout_v.deserialize_log_metadata.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@) (B true))) (= (lib!log.layout_v.deserialize_log_crc.? s@ (B true)) (lib!log.layout_v.deserialize_log_crc.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@) (B true)))) (and (= (lib!log.layout_v.deserialize_log_metadata.? s@ (B false)) (lib!log.layout_v.deserialize_log_metadata.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@) (B false))) (= (lib!log.layout_v.deserialize_log_crc.? s@ (B false)) (lib!log.layout_v.deserialize_log_crc.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@) (B false)))))))))))) (=> (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (and (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$) (let ((tmp%%$ lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?)) (let ((tmp%%$3 lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (and (<= 0 tmp%%$) (< tmp%%$ tmp%%$3)) (< tmp%%$3 (vstd!seq.Seq.len.? $ (UINT 8) s$)))))) (let ((s_cdb$ (%B (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!log.layout_v.deserialize_and_check_log_cdb.? s$))))))) (and (and (and (and (and (= (lib!log.layout_v.deserialize_global_metadata.? s$) (lib!log.layout_v.deserialize_global_metadata.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@))) (= (lib!log.layout_v.deserialize_global_crc.? s$) (lib!log.layout_v.deserialize_global_crc.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@)))) (= (lib!log.layout_v.deserialize_region_metadata.? s$) (lib!log.layout_v.deserialize_region_metadata.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@)))) (= (lib!log.layout_v.deserialize_region_crc.? s$) (lib!log.layout_v.deserialize_region_crc.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@)))) (= s_cdb$ cdb!)) (ite s_cdb$ (and (= (lib!log.layout_v.deserialize_log_metadata.? s$ (B true)) (lib!log.layout_v.deserialize_log_metadata.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@) (B true))) (= (lib!log.layout_v.deserialize_log_crc.? s$ (B true)) (lib!log.layout_v.deserialize_log_crc.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@) (B true)))) (and (= (lib!log.layout_v.deserialize_log_metadata.? s$ (B false)) (lib!log.layout_v.deserialize_log_metadata.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@) (B false))) (= (lib!log.layout_v.deserialize_log_crc.? s$ (B false)) (lib!log.layout_v.deserialize_log_crc.? (Poly%vstd!seq.Seq<u8.>. pm_bytes@) (B false))))))))) :pattern ((lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$)))) (and (=> (has_type s$1@ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (and (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$1@) (let ((tmp%%$ lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?)) (let ((tmp%%$5 lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (and (<= 0 tmp%%$) (< tmp%%$ tmp%%$5)) (< tmp%%$5 (vstd!seq.Seq.len.? $ (UINT 8) s$1@)))))) (=> (= tmp%3 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. (%Poly%vstd!seq.Seq<u8.>. s$1@) tmp%3) (=> %%location_label%%2 (lib!log.inv_v.metadata_types_set.? s$1@)))))) (=> (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (and (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$) (let ((tmp%%$ lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?)) (let ((tmp%%$7 lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (and (<= 0 tmp%%$) (< tmp%%$ tmp%%$7)) (< tmp%%$7 (vstd!seq.Seq.len.? $ (UINT 8) s$)))))) (lib!log.inv_v.metadata_types_set.? s$))) :pattern ((lib!log.inv_v.metadata_types_set.? s$)))) (=> %%location_label%%3 (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (and (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) s$) (let ((tmp%%$ lib!log.layout_v.ABSOLUTE_POS_OF_GLOBAL_METADATA.?)) (let ((tmp%%$1 lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?)) (and (and (<= 0 tmp%%$) (< tmp%%$ tmp%%$1)) (< tmp%%$1 (vstd!seq.Seq.len.? $ (UINT 8) s$)))))) (lib!log.inv_v.metadata_types_set.? s$))) :pattern ((lib!log.inv_v.metadata_types_set.? s$)))))))))))))))))
(check-sat)
(exit)
