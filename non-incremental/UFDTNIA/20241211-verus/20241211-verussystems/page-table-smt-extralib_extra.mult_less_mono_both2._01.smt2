...
(set-info :comment ";; page-table/extra.rs:151:1: 151:66 (#0)")
...
(assert (forall ((a! Int) (b! Int)) (! (= (req%lib!extra.div_mul_cancel. a! b!) (and (=> %%global_location_label%%28 (lib!definitions_t.aligned.? (I a!) (I b!))) (=> %%global_location_label%%29 (not (= b! 0))))) :pattern ((req%lib!extra.div_mul_cancel. a! b!)))))
...
(assert (forall ((no%param Int)) (! (= (ens%lib!extra.aligned_transitive_auto. no%param) (forall ((a$ Poly) (b$ Poly) (c$ Poly)) (! (=> (and (has_type a$ NAT) (has_type b$ NAT) (has_type c$ NAT)) (=> (and (and (and (< 0 (%I b$)) (< 0 (%I c$))) (lib!definitions_t.aligned.? a$ b$)) (lib!definitions_t.aligned.? b$ c$)) (lib!definitions_t.aligned.? a$ c$))) :pattern ((lib!definitions_t.aligned.? a$ b$) (lib!definitions_t.aligned.? b$ c$)) :pattern ((lib!definitions_t.aligned.? a$ b$) (lib!definitions_t.aligned.? b$ c$)) :pattern ((lib!definitions_t.aligned.? a$ b$) (lib!definitions_t.aligned.? a$ c$)) :pattern ((lib!definitions_t.aligned.? b$ c$) (lib!definitions_t.aligned.? a$ c$))))) :pattern ((ens%lib!extra.aligned_transitive_auto. no%param)))))
...
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (req%lib!extra.leq_add_aligned_less. a! b! c!) (and (=> %%global_location_label%%30 (< 0 b!)) (=> %%global_location_label%%31 (< a! c!)) (=> %%global_location_label%%32 (lib!definitions_t.aligned.? (I a!) (I b!))) (=> %%global_location_label%%33 (lib!definitions_t.aligned.? (I c!) (I b!))))) :pattern ((req%lib!extra.leq_add_aligned_less. a! b! c!)))))
...
(assert (forall ((a! Int) (b! Int) (c! Int) (d! Int)) (! (= (req%lib!extra.mult_leq_mono_both. a! b! c! d!) (and (=> %%global_location_label%%34 (<= a! c!)) (=> %%global_location_label%%35 (<= b! d!)))) :pattern ((req%lib!extra.mult_leq_mono_both. a! b! c! d!)))))
...
(set-info :comment ";; Function-Specs lib::extra::mod_less_eq")
(declare-fun req%lib!extra.mod_less_eq. (Int Int) Bool)
(declare-const %%global_location_label%%38 Bool)
(assert (forall ((a! Int) (b! Int)) (! (= (req%lib!extra.mod_less_eq. a! b!) (=> %%global_location_label%%38 (not (= b! 0)))) :pattern ((req%lib!extra.mod_less_eq. a! b!)))))
(declare-fun ens%lib!extra.mod_less_eq. (Int Int) Bool)
(assert (forall ((a! Int) (b! Int)) (! (= (ens%lib!extra.mod_less_eq. a! b!) (<= (nClip (EucMod a! b!)) a!)) :pattern ((ens%lib!extra.mod_less_eq. a! b!)))))
(set-info :comment ";; Function-Specs lib::extra::mul_distributive")
(declare-fun ens%lib!extra.mul_distributive. (Int Int) Bool)
(assert (forall ((a! Int) (b! Int)) (! (= (ens%lib!extra.mul_distributive. a! b!) (= (nClip (Mul (nClip (Add a! 1)) b!)) (nClip (Add (nClip (Mul a! b!)) b!)))) :pattern ((ens%lib!extra.mul_distributive. a! b!)))))
(set-info :comment ";; Function-Specs lib::extra::mul_commute")
(declare-fun ens%lib!extra.mul_commute. (Int Int) Bool)
(assert (forall ((a! Int) (b! Int)) (! (= (ens%lib!extra.mul_commute. a! b!) (= (nClip (Mul a! b!)) (nClip (Mul b! a!)))) :pattern ((ens%lib!extra.mul_commute. a! b!)))))
(set-info :comment ";; Function-Specs lib::extra::less_mul_cancel")
(declare-fun req%lib!extra.less_mul_cancel. (Int Int Int) Bool)
(declare-const %%global_location_label%%39 Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (req%lib!extra.less_mul_cancel. a! b! c!) (=> %%global_location_label%%39 (< (nClip (Mul a! c!)) (nClip (Mul b! c!))))) :pattern ((req%lib!extra.less_mul_cancel. a! b! c!)))))
(declare-fun ens%lib!extra.less_mul_cancel. (Int Int Int) Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (ens%lib!extra.less_mul_cancel. a! b! c!) (< a! b!)) :pattern ((ens%lib!extra.less_mul_cancel. a! b! c!)))))
(set-info :comment ";; Function-Specs lib::extra::mult_leq_mono1")
(declare-fun req%lib!extra.mult_leq_mono1. (Int Int Int) Bool)
(declare-const %%global_location_label%%40 Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (req%lib!extra.mult_leq_mono1. a! b! c!) (=> %%global_location_label%%40 (<= a! b!))) :pattern ((req%lib!extra.mult_leq_mono1. a! b! c!)))))
(declare-fun ens%lib!extra.mult_leq_mono1. (Int Int Int) Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (ens%lib!extra.mult_leq_mono1. a! b! c!) (<= (nClip (Mul a! c!)) (nClip (Mul b! c!)))) :pattern ((ens%lib!extra.mult_leq_mono1. a! b! c!)))))
(set-info :comment ";; Function-Specs lib::extra::mult_leq_mono2")
(declare-fun req%lib!extra.mult_leq_mono2. (Int Int Int) Bool)
(declare-const %%global_location_label%%41 Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (req%lib!extra.mult_leq_mono2. a! b! c!) (=> %%global_location_label%%41 (<= a! b!))) :pattern ((req%lib!extra.mult_leq_mono2. a! b! c!)))))
(declare-fun ens%lib!extra.mult_leq_mono2. (Int Int Int) Bool)
(assert (forall ((a! Int) (b! Int) (c! Int)) (! (= (ens%lib!extra.mult_leq_mono2. a! b! c!) (<= (nClip (Mul c! a!)) (nClip (Mul c! a!)))) :pattern ((ens%lib!extra.mult_leq_mono2. a! b! c!)))))
(set-info :comment ";; Function-Specs lib::extra::mult_less_mono_both2")
(declare-fun req%lib!extra.mult_less_mono_both2. (Int Int Int Int) Bool)
(declare-const %%global_location_label%%42 Bool)
(declare-const %%global_location_label%%43 Bool)
(declare-const %%global_location_label%%44 Bool)
(declare-const %%global_location_label%%45 Bool)
(assert (forall ((a! Int) (b! Int) (c! Int) (d! Int)) (! (= (req%lib!extra.mult_less_mono_both2. a! b! c! d!) (and (=> %%global_location_label%%42 (<= a! c!)) (=> %%global_location_label%%43 (< b! d!)) (=> %%global_location_label%%44 (< 0 c!)) (=> %%global_location_label%%45 (< 0 d!)))) :pattern ((req%lib!extra.mult_less_mono_both2. a! b! c! d!)))))
(declare-fun ens%lib!extra.mult_less_mono_both2. (Int Int Int Int) Bool)
(assert (forall ((a! Int) (b! Int) (c! Int) (d! Int)) (! (= (ens%lib!extra.mult_less_mono_both2. a! b! c! d!) (< (nClip (Mul a! b!)) (nClip (Mul c! d!)))) :pattern ((ens%lib!extra.mult_less_mono_both2. a! b! c! d!)))))
(set-info :comment ";; Function-Def lib::extra::mult_less_mono_both2")
(set-info :comment ";; page-table/extra.rs:151:1: 151:66 (#0)")
(declare-const a! Int)
(declare-const b! Int)
(declare-const c! Int)
...
(assert (not (=> %%location_label%%0 (< (nClip (Mul a! b!)) (nClip (Mul c! d!))))))
(check-sat)
(exit)
