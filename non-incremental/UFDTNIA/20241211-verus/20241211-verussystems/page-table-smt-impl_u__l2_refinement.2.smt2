...
(declare-const tmp%4 vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>.)
...
(assert (has_type mem! TYPE%lib!spec_t.mem.PageTableMemory.))
(assert (lib!impl_u.spec_pt.init.? (Poly%lib!impl_u.spec_pt.PageTableVariables. (lib!spec_t.impl_spec.pt_vars.? mem!))))
...
(assert (not (=> (= pt@ (lib!impl_u.l2_impl.PTDir./PTDir (%Poly%lib!definitions_t.MemRegion. (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.impl&%4.view.? (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? mem!))))) (%Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!definitions_t.new_seq.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (I 512) (Poly%core!option.Option. core!option.Option./None))) (%Poly%vstd!set.Set<lib!definitions_t.MemRegion.>. (vstd!set.impl&%0.insert.? $ TYPE%lib!definitions_t.MemRegion. (vstd!set.impl&%0.empty.? $ TYPE%lib!definitions_t.MemRegion.) (Poly%lib!definitions_t.MemRegion. (lib!definitions_t.impl&%4.view.? (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? mem!)))))))) (=> (= tmp%1 core!option.Option./None) (=> (ens%lib!definitions_u.lemma_new_seq. $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) 512 (Poly%core!option.Option. tmp%1)) (and (=> (ens%lib!definitions_u.x86_arch_inv. 0) (=> (= tmp%2 (lib!definitions_t.MemRegionExec./MemRegionExec/base (%Poly%lib!definitions_t.MemRegionExec. (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? mem!))))) (and (=> %%location_label%%0 (req%lib!impl_u.l2_impl.PT.lemma_zeroed_page_implies_empty_at. (%Poly%lib!spec_t.mem.PageTableMemory. mem!) pt@ 0 tmp%2)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_zeroed_page_implies_empty_at. (%Poly%lib!spec_t.mem.PageTableMemory. mem!) pt@ 0 tmp%2) (=> %%location_label%%1 (lib!impl_u.l2_impl.PT.inv.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@))))))) (=> (lib!impl_u.l2_impl.PT.inv.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)) (=> (= tmp%3 (lib!definitions_t.MemRegionExec./MemRegionExec/base (%Poly%lib!definitions_t.MemRegionExec. (Poly%lib!definitions_t.MemRegionExec. (lib!spec_t.mem.impl&%1.cr3_spec.? mem!))))) (=> (= tmp%4 (%Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (vstd!seq.Seq.empty.? $ TYPE%lib!impl_u.l1.NodeEntry.))) (and (=> %%location_label%%2 (req%lib!impl_u.l2_refinement.lemma_no_entries_implies_interp_at_aux_no_entries. (%Poly%lib!spec_t.mem.PageTableMemory. mem!) pt@ 0 tmp%3 0 tmp%4)) (=> (ens%lib!impl_u.l2_refinement.lemma_no_entries_implies_interp_at_aux_no_entries. (%Poly%lib!spec_t.mem.PageTableMemory. mem!) pt@ 0 tmp%3 0 tmp%4) (and (=> (= tmp%5 (= (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@))))) 0)) (and (=> %%location_label%%3 tmp%5) (=> tmp%5 (=> (= tmp%6 (forall ((x$ Poly)) (! (=> (has_type x$ NAT) (=> (not (= (%I x$) 0)) (lib!definitions_t.aligned.? (I 0) x$))) :pattern ((lib!definitions_t.aligned.? (I 0) x$))))) (and (=> %%location_label%%4 tmp%6) (=> tmp%6 (=> (= tmp%7 (forall ((x$ Poly)) (! (=> (has_type x$ NAT) (=> (not (= (%I x$) 0)) (lib!definitions_t.aligned.? (I (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)))))) x$))) :pattern ((lib!definitions_t.aligned.? (I (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)))))) x$))))) (and (=> %%location_label%%5 tmp%7) (=> tmp%7 (=> (= x@ (nClip (Mul (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)))) (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@))))))) (=> (= tmp%8 (not (= x@ 0))) (and (=> %%location_label%%6 tmp%8) (=> tmp%8 (=> (= tmp%9 (lib!definitions_t.aligned.? (I (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)))))) (I x@))) (and (=> %%location_label%%7 tmp%9) (=> tmp%9 (=> %%location_label%%8 (lib!definitions_t.aligned.? (I (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)))))) (I (nClip (Mul (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)))) (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@))))))))))))))))))))))))) (=> (lib!definitions_t.aligned.? (I (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)))))) (I (nClip (Mul (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)))) (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@)))))))) (=> (= tmp%10 (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l2_impl.PT.interp.? mem! (Poly%lib!impl_u.l2_impl.PTDir. pt@))))) (and (=> %%location_label%%9 tmp%10) (=> tmp%10 (=> %%location_label%%10 (%B (lib!spec_t.impl_spec.InterfaceSpec.ispec_inv.? $ TYPE%lib!spec_t.impl_spec.PageTableImpl. self! mem!)))))))))))))))))))
(check-sat)
(exit)
