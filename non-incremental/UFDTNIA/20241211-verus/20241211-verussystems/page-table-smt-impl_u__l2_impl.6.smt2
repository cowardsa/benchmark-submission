...
(declare-const addr$1@ Int)
(declare-const tmp%%@ lib!spec_t.hardware.GhostPageDirectoryEntry.)
...
(assert (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))) (< 0 (lib!spec_t.hardware.impl&%3.layer.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))))
(assert (lib!impl_u.l2_impl.impl&%0.hp_pat_is_zero.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))
(assert (lib!spec_t.hardware.impl&%3.all_mb0_bits_are_zero.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))
(assert (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Empty_ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))))
...
(assert (not (=> (= tmp%%@ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!))) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%@) (=> (= addr@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@)))) (and (=> %%location_label%%0 (req%lib!impl_u.l2_impl.impl&%0.lemma_addr_mask_when_hp_pat_is_zero. self!)) (=> (ens%lib!impl_u.l2_impl.impl&%0.lemma_addr_mask_when_hp_pat_is_zero. self!) %%switch_label%%0)))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%@)) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%@) (=> (= addr$1@ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%@)))) %%switch_label%%1)) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%@)) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> (ens%lib!spec_t.hardware.MASK_ADDR. tmp%1) (=> (= res! (uClip 64 (bitand (I (lib!spec_t.hardware.PageDirectoryEntry./PageDirectoryEntry/entry (%Poly%lib!spec_t.hardware.PageDirectoryEntry. (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (I tmp%1)))) (=> %%location_label%%1 (= (uClip SZ res!) (let ((tmp%%$ (lib!spec_t.hardware.impl&%3.view.? (Poly%lib!spec_t.hardware.PageDirectoryEntry. self!)))) (ite (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Page_ tmp%%$) (let ((addr$ (lib!spec_t.hardware.GhostPageDirectoryEntry./Page/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$))))) addr$) (ite (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ tmp%%$) (let ((addr$ (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. tmp%%$))))) addr$) (%I (vstd!pervasive.arbitrary.? $ (UINT SZ)))))))))))))))
(check-sat)
(exit)
