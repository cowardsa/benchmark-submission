...
(assert (not (and (=> (has_type i@ NAT) (=> (has_type j@ NAT) (=> (and (< (%I j@) (%I i@)) (< (%I i@) (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!)))) (=> (= interp@ (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) i@)) (=> (= entry_j@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) j@)) (and (=> %%location_label%%0 (req%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_aux_inv. self! (%I i@))) (=> (ens%lib!impl_u.l1.impl&%1.lemma_inv_implies_interp_aux_inv. self! (%I i@)) (and (=> %%location_label%%1 (and (and (and (and (> (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!)) 0) (< (%I j@) (%I i@))) (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) i@))) (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_j@))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) j@))) (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_j@))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I (nClip (Add (%I j@) 1))))))) (=> (and (<= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_j@))) (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@)))) (> (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. interp@))) (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_j@))))) (=> %%location_label%%2 (lib!impl_u.l0.impl&%0.ranges_disjoint.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) i@)) (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) j@))))))))))))) (=> (forall ((i$ Poly) (j$ Poly)) (! (=> (and (has_type i$ NAT) (has_type j$ NAT)) (=> (and (< (%I j$) (%I i$)) (< (%I i$) (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!)))) (lib!impl_u.l0.impl&%0.ranges_disjoint.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) i$)) (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) j$))))) :pattern ((lib!impl_u.l0.impl&%0.ranges_disjoint.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) i$)) (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) j$)))))) (=> %%location_label%%3 (forall ((i$ Poly) (j$ Poly)) (! (=> (and (has_type i$ NAT) (has_type j$ NAT)) (=> (and (< (%I j$) (%I i$)) (< (%I i$) (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. self!)))) (lib!impl_u.l0.impl&%0.ranges_disjoint.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) i$)) (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) j$))))) :pattern ((lib!impl_u.l0.impl&%0.ranges_disjoint.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. self!) i$)) (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) j$)))))))))))
(check-sat)
(exit)
