...
(assert (not (and (=> (has_type mem@ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) mem@) (and (=> %%location_label%%0 (req%lib!log.inv_v.lemma_invariants_imply_crash_recover. pm_region_view! (%Poly%vstd!seq.Seq<u8.>. mem@) log_id! cdb! info! state!)) (=> (ens%lib!log.inv_v.lemma_invariants_imply_crash_recover. pm_region_view! (%Poly%vstd!seq.Seq<u8.>. mem@) log_id! cdb! info! state!) (=> %%location_label%%1 (and (and (= (lib!log.layout_v.recover_cdb.? mem@) (core!option.Option./Some (B cdb!))) (= (lib!log.layout_v.recover_state.? mem@ (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!)))))) (lib!log.inv_v.metadata_types_set.? mem@))))))) (=> (forall ((mem$ Poly)) (! (=> (has_type mem$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) mem$) (and (and (= (lib!log.layout_v.recover_cdb.? mem$) (core!option.Option./Some (B cdb!))) (= (lib!log.layout_v.recover_state.? mem$ (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!)))))) (lib!log.inv_v.metadata_types_set.? mem$)))) :pattern ((lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) mem$)))) (=> %%location_label%%2 (forall ((mem$ Poly)) (! (=> (has_type mem$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) mem$) (and (and (= (lib!log.layout_v.recover_cdb.? mem$) (core!option.Option./Some (B cdb!))) (= (lib!log.layout_v.recover_state.? mem$ (I log_id!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!)))))) (lib!log.inv_v.metadata_types_set.? mem$)))) :pattern ((lib!pmem.pmemspec_t.impl&%6.can_crash_as.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) mem$)))))))))
(check-sat)
(exit)
