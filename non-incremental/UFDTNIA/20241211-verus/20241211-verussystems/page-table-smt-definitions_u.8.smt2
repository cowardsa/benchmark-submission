...
(assert (not (=> (= tmp%2 (lib!definitions_t.ArchExec./ArchExec/layers (%Poly%lib!definitions_t.ArchExec. (Poly%lib!definitions_t.ArchExec. self!)))) (and (=> %%location_label%%0 (req%vstd!array.array_index_get. $ TYPE%lib!definitions_t.ArchLayerExec. $ (CONST_INT 4) tmp%2 layer!)) (=> (ens%vstd!array.array_index_get. $ TYPE%lib!definitions_t.ArchLayerExec. $ (CONST_INT 4) tmp%2 layer! tmp%1) (=> (= res! (lib!definitions_t.ArchLayerExec./ArchLayerExec/num_entries (%Poly%lib!definitions_t.ArchLayerExec. tmp%1))) (=> %%location_label%%1 (= res! (lib!definitions_t.impl&%8.num_entries.? (Poly%lib!definitions_t.Arch. (lib!definitions_u.impl&%2.view.? (Poly%lib!definitions_t.ArchExec. self!))) (I layer!))))))))))
(check-sat)
(exit)
