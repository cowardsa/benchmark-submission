...
(set-info :comment ";; Function-Axioms lib::constants::DEFAULT_LOG_BYTES")
(assert (fuel_bool_default fuel%lib!constants.DEFAULT_LOG_BYTES.))
(assert (=> (fuel_bool fuel%lib!constants.DEFAULT_LOG_BYTES.) (= lib!constants.DEFAULT_LOG_BYTES.? (uClip SZ (Mul (uClip SZ (Mul 2 1024)) 1024)))))
(assert (uInv SZ lib!constants.DEFAULT_LOG_BYTES.?))
(set-info :comment ";; Function-Def lib::constants::RESPONSE_CHECK_INTERVAL")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:35:1: 35:61 (#0)")
(set-info :comment ";; Function-Axioms lib::constants::RESPONSE_CHECK_INTERVAL")
(assert (fuel_bool_default fuel%lib!constants.RESPONSE_CHECK_INTERVAL.))
(assert (=> (fuel_bool fuel%lib!constants.RESPONSE_CHECK_INTERVAL.) (= lib!constants.RESPONSE_CHECK_INTERVAL.? 536870912)))
(assert (uInv SZ lib!constants.RESPONSE_CHECK_INTERVAL.?))
(set-info :comment ";; Function-Def lib::constants::GC_FROM_HEAD")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:45:1: 45:80 (#0)")
...
(set-info :comment ";; Function-Def lib::constants::WARN_THRESHOLD")
(set-info :comment ";; /home/amarshah/projects/verified-node-replication/verified-node-replication/src/constants.rs:51:1: 51:51 (#0)")
