...
(declare-const log_view@ lib!pmem.pmemspec_t.PersistentMemoryRegionView.)
...
(assert (not (=> (fuel_bool fuel%lib!pmem.pmcopy_t.spec_padding_needed.) (=> (ens%lib!pmem.pmemutil_v.lemma_wherever_no_outstanding_writes_persistent_memory_view_can_only_crash_as_committed. pm_region_view!) (=> (= tmp%1 (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!))) (=> (ens%lib!log.layout_v.lemma_establish_subrange_equivalence. mem! tmp%1) (=> (= log_view@ (lib!pmem.subregion_v.get_subregion_view.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. pm_region_view!) (I lib!log.layout_v.ABSOLUTE_POS_OF_LOG_AREA.?) (I (lib!log.logimpl_v.LogInfo./LogInfo/log_area_len (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))))) (=> (ens%lib!pmem.pmemutil_v.lemma_wherever_no_outstanding_writes_persistent_memory_view_can_only_crash_as_committed. log_view@) (=> (= tmp%2 (ext_eq false (TYPE%core!option.Option. $ TYPE%lib!log.logspec_t.AbstractLogState.) (Poly%core!option.Option. (lib!log.layout_v.recover_log_from_log_area_given_metadata.? (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (Poly%lib!pmem.pmemspec_t.PersistentMemoryRegionView. log_view@))) (I (lib!log.logimpl_v.LogInfo./LogInfo/head (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))) (I (lib!log.logimpl_v.LogInfo./LogInfo/log_length (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))))) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!))))))) (and (=> %%location_label%%0 tmp%2) (=> tmp%2 (=> (= tmp%3 (ext_eq false (TYPE%core!option.Option. $ TYPE%lib!log.logspec_t.AbstractLogState.) (Poly%core!option.Option. (lib!log.layout_v.recover_log.? (Poly%vstd!seq.Seq<u8.>. mem!) (I (lib!log.logimpl_v.LogInfo./LogInfo/log_area_len (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))) (I (lib!log.logimpl_v.LogInfo./LogInfo/head (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))) (I (lib!log.logimpl_v.LogInfo./LogInfo/log_length (%Poly%lib!log.logimpl_v.LogInfo. (Poly%lib!log.logimpl_v.LogInfo. info!)))))) (Poly%core!option.Option. (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!))))))) (and (=> %%location_label%%1 tmp%3) (=> tmp%3 (=> %%location_label%%2 (= (lib!log.layout_v.recover_given_cdb.? (Poly%vstd!seq.Seq<u8.>. mem!) (I log_id!) (B cdb!)) (core!option.Option./Some (Poly%lib!log.logspec_t.AbstractLogState. (lib!log.logspec_t.impl&%0.drop_pending_appends.? (Poly%lib!log.logspec_t.AbstractLogState. state!))))))))))))))))))))
(check-sat)
(exit)
