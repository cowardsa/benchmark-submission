...
(assert (uInv SZ a!))
(assert (not (= a! (uClip SZ (bitnot (I 0))))))
...
(assert (not (=> (fuel_bool fuel%lib!commit_mask.is_bit_set.) (and (=> %%location_label%%0 (not (= a! (uClip SZ (bitnot (I 0)))))) (=> (not (= (uClip SZ (bitnot (I a!))) 0)) (=> (= tmp%2 (uClip SZ (bitnot (I a!)))) (and (=> %%location_label%%1 (req%lib!commit_mask.lemma_obtain_bit_index_1. tmp%2)) (=> (ens%lib!commit_mask.lemma_obtain_bit_index_1. tmp%2 tmp%1) (=> (= b@ (uClip 64 tmp%1)) (=> (= a@ (uClip 64 a!)) (and (=> %%location_label%%2 (and (< b@ 64) (= (uClip 64 (bitand (I (uClip 64 (bitnot (I a@)))) (I (uClip 64 (bitshl (I 1) (I b@)))))) (uClip SZ (bitshl (I 1) (I b@)))))) (=> (not (= (uClip 64 (bitand (I a@) (I (uClip 64 (bitshl (I 1) (I b@)))))) (uClip 64 (bitshl (I 1) (I b@))))) (=> (= b! (uClip SZ b@)) (and (=> %%location_label%%3 (< b! 64)) (=> %%location_label%%4 (not (lib!commit_mask.is_bit_set.? (I a!) (I b!))))))))))))))))))
(check-sat)
(exit)
