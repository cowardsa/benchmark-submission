...
(set-info :comment ";; bin_sizes.rs:504:7: 504:46 (#0)")
...
(set-info :comment ";; Function-Def lib::bin_sizes::mul_ordering")
(set-info :comment ";; bin_sizes.rs:504:7: 504:46 (#0)")
(declare-const x! Int)
(declare-const y! Int)
(declare-const z! Int)
...
(assert (<= 0 y!))
(assert (<= 0 z!))
(assert (and (and (< 0 x!) (< 1 y!)) (< 0 z!)))
(assert (= (nClip (Mul x! y!)) z!))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (< x! z!))))
(check-sat)
(exit)
