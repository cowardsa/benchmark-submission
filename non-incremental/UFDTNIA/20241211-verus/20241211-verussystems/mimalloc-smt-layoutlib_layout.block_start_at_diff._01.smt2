...
(set-info :comment ";; layout.rs:152:5: 152:11 (#0)")
...
(declare-const block_idx1! Int)
(declare-const block_idx2! Int)
...
(assert (not (=> %%location_label%%0 (= (Add (Mul block_idx1! block_size!) (Mul (Sub block_idx2! block_idx1!) block_size!)) (Mul block_idx2! block_size!)))))
(check-sat)
(exit)
