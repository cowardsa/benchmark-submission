...
(set-info :comment ";; page-table/definitions_u.rs:53:5: 53:11 (#0)")
...
(assert (not (=> %%location_label%%0 (< (Mul lib!definitions_t.X86_MAX_ENTRY_SIZE.? (Add lib!definitions_t.X86_NUM_ENTRIES.? 1)) 18446744073709551616))))
(check-sat)
(exit)
