...
(declare-const segment_id! lib!tokens.SegmentId.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!tokens.SegmentId. segment_id!) TYPE%lib!tokens.SegmentId.))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!config.const_facts. 0) (=> %%location_label%%0 (= (EucMod (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. segment_id!)) 8) 0)))))
(check-sat)
(exit)
