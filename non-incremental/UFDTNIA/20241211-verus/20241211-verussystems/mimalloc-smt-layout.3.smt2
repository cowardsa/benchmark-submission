...
(declare-const tmp%4 ptr_mut%<lib!types.Page.>.)
...
(assert (not (=> (ens%lib!config.const_facts. 0) (=> (= p@ (vstd!raw_ptr.spec_cast_ptr_to_usize.? $ TYPE%lib!types.Page. (Poly%ptr_mut%<lib!types.Page.>. (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!)))))) (=> (= sid@ (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!))))))) (=> (= tmp%1 (= (Mul (EucDiv p@ lib!config.SEGMENT_SIZE.?) lib!config.SEGMENT_SIZE.?) (lib!layout.segment_start.? (Poly%lib!tokens.SegmentId. sid@)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!)))) (=> (ens%core!ptr.mut_ptr.impl&%0.addr. $ TYPE%lib!types.Page. (Poly%ptr_mut%<lib!types.Page.>. tmp%2) p$1@) (and (=> %%location_label%%1 (not (= (uClip SZ lib!config.SEGMENT_SIZE.?) 0))) (and (=> %%location_label%%2 (uInv SZ (Mul (uClip SZ (EucDiv p$1@ (uClip SZ lib!config.SEGMENT_SIZE.?))) (uClip SZ lib!config.SEGMENT_SIZE.?)))) (=> (= s@ (uClip SZ (Mul (uClip SZ (EucDiv p$1@ (uClip SZ lib!config.SEGMENT_SIZE.?))) (uClip SZ lib!config.SEGMENT_SIZE.?)))) (=> (= tmp%4 (lib!types.PagePtr./PagePtr/page_ptr (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!)))) (=> (ens%core!ptr.mut_ptr.impl&%0.with_addr. $ TYPE%lib!types.Page. (Poly%ptr_mut%<lib!types.Page.>. tmp%4) s@ tmp%3) (=> (ens%vstd!raw_ptr.cast_ptr_to_thin_ptr. $ TYPE%lib!types.Page. $ TYPE%lib!types.SegmentHeader. tmp%3 tmp%5) (=> (= segment_ptr! (lib!types.SegmentPtr./SegmentPtr (%Poly%ptr_mut%<lib!types.SegmentHeader.>. tmp%5) (%Poly%lib!tokens.SegmentId. (Poly%lib!tokens.SegmentId. (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!)))))))))) (and (=> %%location_label%%3 (lib!layout.is_segment_ptr.? (Poly%ptr_mut%<lib!types.SegmentHeader.>. (lib!types.SegmentPtr./SegmentPtr/segment_ptr (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!)))) (Poly%lib!tokens.SegmentId. (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!)))))) (=> %%location_label%%4 (= (lib!types.SegmentPtr./SegmentPtr/segment_id (%Poly%lib!types.SegmentPtr. (Poly%lib!types.SegmentPtr. segment_ptr!))) (lib!tokens.PageId./PageId/segment_id (%Poly%lib!tokens.PageId. (Poly%lib!tokens.PageId. (lib!types.PagePtr./PagePtr/page_id (%Poly%lib!types.PagePtr. (Poly%lib!types.PagePtr. page_ptr!))))))))))))))))))))))))))
(check-sat)
(exit)
