...
(set-info :comment ";; page-table/impl_u/l1.rs:376:21: 392:23 (#0)")
...
(assert (<= 0 i!))
(assert (has_type (Poly%lib!impl_u.l1.Directory. d$1@) TYPE%lib!impl_u.l1.Directory.))
...
(assert (not (=> (lib!impl_u.l1.impl&%1.inv.? (Poly%lib!impl_u.l1.Directory. self!)) (=> (= entry_i@ (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (=> (lib!impl_u.l0.impl&%0.inv.? (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0)))) (=> (= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0))))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (=> (= (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. d$1@))) (lib!impl_u.l1.impl&%1.entry_base.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))) (=> (= (nClip (Mul (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. d$1@)) (lib!impl_u.l1.impl&%1.num_entries.? (Poly%lib!impl_u.l1.Directory. d$1@)))) (lib!impl_u.l1.impl&%1.entry_size.? (Poly%lib!impl_u.l1.Directory. self!))) (=> (= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0))))) (lib!impl_u.l1.impl&%1.upper_vaddr.? (Poly%lib!impl_u.l1.Directory. d$1@))) (=> (= (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_of_entry.? (Poly%lib!impl_u.l1.Directory. self!) (I i!))))) (lib!impl_u.l0.PageTableContents./PageTableContents/map (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0)))))) (=> (< i! (vstd!seq.Seq.len.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!)))))) (=> (= tmp%10 (lib!impl_u.l1.impl&%1.well_formed.? (Poly%lib!impl_u.l1.Directory. self!))) (and (=> %%location_label%%0 tmp%10) (=> tmp%10 (=> (= tmp%11 (<= (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@))) (lib!impl_u.l0.PageTableContents./PageTableContents/lower (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0))))))) (and (=> %%location_label%%1 tmp%11) (=> tmp%11 (=> (= tmp%12 (>= (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. entry_i@))) (lib!impl_u.l0.PageTableContents./PageTableContents/upper (%Poly%lib!impl_u.l0.PageTableContents. (Poly%lib!impl_u.l0.PageTableContents. (lib!impl_u.l1.impl&%1.interp_aux.? (Poly%lib!impl_u.l1.Directory. d$1@) (I 0))))))) (and (=> %%location_label%%2 tmp%12) (=> tmp%12 (=> %%location_label%%3 (lib!impl_u.l0.impl&%0.mappings_in_bounds.? (Poly%lib!impl_u.l0.PageTableContents. entry_i@)))))))))))))))))))))))
(check-sat)
(exit)
