...
(assert (not (=> (= decrease%init0 (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. self!))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. self!)))) (or (and (=> (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l1.impl&%1.accepted_unmap.? self! base!)) (=> (ens%lib!impl_u.l1.ambient_lemmas2. 0) (=> (= tmp%4 (lib!impl_u.l1.Directory./Directory/base_vaddr (%Poly%lib!impl_u.l1.Directory. self!))) (=> (= tmp%5 (lib!impl_u.l1.impl&%1.entry_size.? self!)) (=> (= tmp%6 (lib!impl_u.l1.impl&%1.num_entries.? self!)) (=> (ens%lib!impl_u.indexing.lemma_index_from_base_and_addr. tmp%4 (%I base!) tmp%5 tmp%6) %%switch_label%%3)))))) (=> (not (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l1.impl&%1.accepted_unmap.? self! base!))) %%switch_label%%3)) (and (not %%switch_label%%3) (or (and (=> (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l1.impl&%1.accepted_unmap.? self! base!)) (=> (= entry@ (lib!impl_u.l1.impl&%1.index_for_vaddr.? self! base!)) (=> (= tmp%%@ (%Poly%lib!impl_u.l1.NodeEntry. (vstd!seq.Seq.index.? $ TYPE%lib!impl_u.l1.NodeEntry. (Poly%vstd!seq.Seq<lib!impl_u.l1.NodeEntry.>. (lib!impl_u.l1.Directory./Directory/entries (%Poly%lib!impl_u.l1.Directory. self!))) (I entry@)))) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@) (=> (= tmp%2 (let ((p$ (lib!impl_u.l1.NodeEntry./Page/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@))))) (ite (lib!definitions_t.aligned.? base! (I (lib!impl_u.l1.impl&%1.entry_size.? self!))) (core!result.Result./Ok (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.impl&%1.update.? self! (I entry@) (Poly%lib!impl_u.l1.NodeEntry. lib!impl_u.l1.NodeEntry./Empty)))) (core!result.Result./Err self!)))) %%switch_label%%1)) (=> (not (is-lib!impl_u.l1.NodeEntry./Page_ tmp%%@)) (or (and (=> (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@) (=> (= d@ (lib!impl_u.l1.NodeEntry./Directory/0 (%Poly%lib!impl_u.l1.NodeEntry. (Poly%lib!impl_u.l1.NodeEntry. tmp%%@)))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 d@) (base!$1 (%I base!))) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. (Poly%lib!definitions_t.Arch. (lib!impl_u.l1.Directory./Directory/arch (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0)))))))) (lib!impl_u.l1.Directory./Directory/layer (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. self!$0))))) decrease%init0 false)) (=> (has_type (Poly%core!result.Result. tmp%%$1@) (TYPE%core!result.Result. $ TYPE%lib!impl_u.l1.Directory. $ TYPE%lib!impl_u.l1.Directory.)) (=> (= tmp%1 (ite (is-core!result.Result./Ok_ tmp%%$1@) (let ((new_d$ (%Poly%lib!impl_u.l1.Directory. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%$1@)))))) (core!result.Result./Ok (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.impl&%1.update.? self! (I entry@) (Poly%lib!impl_u.l1.NodeEntry. (ite (lib!impl_u.l1.impl&%1.empty.? (Poly%lib!impl_u.l1.Directory. new_d$)) lib!impl_u.l1.NodeEntry./Empty (lib!impl_u.l1.NodeEntry./Directory (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. new_d$))))))))) (let ((new_d$ (%Poly%lib!impl_u.l1.Directory. (core!result.Result./Err/0 (%Poly%core!result.Result. (Poly%core!result.Result. tmp%%$1@)))))) (core!result.Result./Err (Poly%lib!impl_u.l1.Directory. (lib!impl_u.l1.impl&%1.update.? self! (I entry@) (Poly%lib!impl_u.l1.NodeEntry. (lib!impl_u.l1.NodeEntry./Directory (%Poly%lib!impl_u.l1.Directory. (Poly%lib!impl_u.l1.Directory. new_d$)))))))))) %%switch_label%%2))))) (=> (not (is-lib!impl_u.l1.NodeEntry./Directory_ tmp%%@)) (=> (= tmp%1 (core!result.Result./Err self!)) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%2 tmp%1) %%switch_label%%1))))) (and (not %%switch_label%%1) (=> (= tmp%3 tmp%2) %%switch_label%%0)))))) (=> (not (and (lib!impl_u.l1.impl&%1.inv.? self!) (lib!impl_u.l1.impl&%1.accepted_unmap.? self! base!))) (=> (= tmp%3 (%Poly%core!result.Result. (vstd!pervasive.arbitrary.? $ (TYPE%core!result.Result. $ TYPE%lib!impl_u.l1.Directory. $ TYPE%lib!impl_u.l1.Directory.)))) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)
