...
(declare-const metadata! main!logimpl_v.PersistentHeaderMetadata.)
(declare-const tmp%1 Poly)
(declare-const verus_tmp_old_bytes@ vstd!seq.Seq<u8.>.)
(declare-const tmp%2 Int)
(declare-const verus_tmp_old_head_bytes@ vstd!seq.Seq<u8.>.)
(declare-const tmp%3 Int)
(declare-const verus_tmp_old_tail_bytes@ vstd!seq.Seq<u8.>.)
(declare-const tmp%4 Int)
(declare-const verus_tmp_old_log_size_bytes@ vstd!seq.Seq<u8.>.)
(declare-const tmp%5 Bool)
(declare-const tmp%6 Bool)
(declare-const tmp%7 Bool)
(declare-const tmp%8 Bool)
(declare-const bytes@0 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const verus_tmp@0 vstd!seq.Seq<u8.>.)
(declare-const old_bytes@0 vstd!seq.Seq<u8.>.)
(declare-const head_bytes@0 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const verus_tmp$1@0 vstd!seq.Seq<u8.>.)
(declare-const old_head_bytes@0 vstd!seq.Seq<u8.>.)
(declare-const tail_bytes@0 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const verus_tmp$2@0 vstd!seq.Seq<u8.>.)
(declare-const old_tail_bytes@0 vstd!seq.Seq<u8.>.)
(declare-const log_size_bytes@0 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const verus_tmp$3@0 vstd!seq.Seq<u8.>.)
(declare-const old_log_size_bytes@0 vstd!seq.Seq<u8.>.)
(assert fuel_defaults)
(assert (has_type (Poly%main!logimpl_v.PersistentHeaderMetadata. metadata!) TYPE%main!logimpl_v.PersistentHeaderMetadata.))
(declare-const verus_tmp@1 vstd!seq.Seq<u8.>.)
(declare-const old_bytes@1 vstd!seq.Seq<u8.>.)
(declare-const verus_tmp$1@1 vstd!seq.Seq<u8.>.)
(declare-const old_head_bytes@1 vstd!seq.Seq<u8.>.)
(declare-const verus_tmp$2@1 vstd!seq.Seq<u8.>.)
(declare-const old_tail_bytes@1 vstd!seq.Seq<u8.>.)
(declare-const verus_tmp$3@1 vstd!seq.Seq<u8.>.)
(declare-const old_log_size_bytes@1 vstd!seq.Seq<u8.>.)
(declare-const bytes@1 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const head_bytes@1 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const bytes@2 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const tail_bytes@1 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const bytes@3 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const log_size_bytes@1 alloc!vec.Vec<u8./allocator_global%.>.)
...
(assert (not (=> (ens%alloc!vec.impl&%0.new. $ (UINT 8) tmp%1) (=> (= bytes@0 (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%1)) (=> (= verus_tmp@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@0)))) (=> (= verus_tmp_old_bytes@ verus_tmp@1) (=> (= old_bytes@1 verus_tmp_old_bytes@) (=> (= tmp%2 (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. metadata!)))) (=> (ens%vstd!bytes.u64_to_le_bytes. tmp%2 head_bytes@0) (=> (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. head_bytes@0)))) (=> (= verus_tmp_old_head_bytes@ verus_tmp$1@1) (=> (= old_head_bytes@1 verus_tmp_old_head_bytes@) (=> (= tmp%3 (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. metadata!)))) (=> (ens%vstd!bytes.u64_to_le_bytes. tmp%3 tail_bytes@0) (=> (= verus_tmp$2@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. tail_bytes@0)))) (=> (= verus_tmp_old_tail_bytes@ verus_tmp$2@1) (=> (= old_tail_bytes@1 verus_tmp_old_tail_bytes@) (=> (= tmp%4 (main!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (%Poly%main!logimpl_v.PersistentHeaderMetadata. (Poly%main!logimpl_v.PersistentHeaderMetadata. metadata!)))) (=> (ens%vstd!bytes.u64_to_le_bytes. tmp%4 log_size_bytes@0) (=> (= verus_tmp$3@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. log_size_bytes@0)))) (=> (= verus_tmp_old_log_size_bytes@ verus_tmp$3@1) (=> (= old_log_size_bytes@1 verus_tmp_old_log_size_bytes@) (=> (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@0) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@1) (Poly%alloc!vec.Vec<u8./allocator_global%.>. head_bytes@0) (Poly%alloc!vec.Vec<u8./allocator_global%.>. head_bytes@1)) (=> (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@1) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@2) (Poly%alloc!vec.Vec<u8./allocator_global%.>. tail_bytes@0) (Poly%alloc!vec.Vec<u8./allocator_global%.>. tail_bytes@1)) (=> (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@2) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@3) (Poly%alloc!vec.Vec<u8./allocator_global%.>. log_size_bytes@0) (Poly%alloc!vec.Vec<u8./allocator_global%.>. log_size_bytes@1)) (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_bytes@1) (vstd!seq.Seq.empty.? $ (UINT 8)))) (and (=> %%location_label%%0 tmp%5) (=> tmp%5 (=> (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_head_bytes@1) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@3)) (I (Sub main!logimpl_v.header_head_offset.? 8)) (I (Add (Sub main!logimpl_v.header_head_offset.? 8) 8))))) (and (=> %%location_label%%1 tmp%6) (=> tmp%6 (=> (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_tail_bytes@1) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@3)) (I (Sub main!logimpl_v.header_tail_offset.? 8)) (I (Add (Sub main!logimpl_v.header_tail_offset.? 8) 8))))) (and (=> %%location_label%%2 tmp%7) (=> tmp%7 (=> (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_log_size_bytes@1) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@3)) (I (Sub main!logimpl_v.header_log_size_offset.? 8)) (I (Add (Sub main!logimpl_v.header_log_size_offset.? 8) 8))))) (and (=> %%location_label%%3 tmp%8) (=> tmp%8 (=> (= out! bytes@3) (and (=> %%location_label%%4 (= metadata! (main!logimpl_v.spec_bytes_to_metadata.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!))))) (=> %%location_label%%5 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. out!))) (Sub main!logimpl_v.header_size.? 8)))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
