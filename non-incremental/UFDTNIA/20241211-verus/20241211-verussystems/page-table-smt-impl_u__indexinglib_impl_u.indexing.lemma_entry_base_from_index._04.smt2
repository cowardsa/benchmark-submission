...
(set-info :comment ";; page-table/impl_u/indexing.rs:116:13: 116:19 (#0)")
...
(assert (not (=> (< 0 (%I n@)) (=> (< 0 entry_size!) (=> (lib!definitions_t.aligned.? (I base!) n@) (=> (lib!definitions_t.aligned.? (I entry_size!) n@) (and (and (=> %%location_label%%0 (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. idx! entry_size!)) (=> (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. idx! entry_size!) (=> %%location_label%%1 (lib!definitions_t.aligned.? (I (nClip (Mul idx! entry_size!))) (I entry_size!))))) (=> (lib!definitions_t.aligned.? (I (nClip (Mul idx! entry_size!))) (I entry_size!)) (and (=> (= tmp%3 (nClip (Mul idx! entry_size!))) (and (=> %%location_label%%2 (req%lib!extra.aligned_transitive. tmp%3 entry_size! (%I n@))) (=> (ens%lib!extra.aligned_transitive. tmp%3 entry_size! (%I n@)) (=> %%location_label%%3 (lib!definitions_t.aligned.? (I (nClip (Mul idx! entry_size!))) n@))))) (=> (lib!definitions_t.aligned.? (I (nClip (Mul idx! entry_size!))) n@) (and (=> (= tmp%4 (nClip (Mul idx! entry_size!))) (and (=> %%location_label%%4 (req%lib!extra.mod_add_zero. base! tmp%4 (%I n@))) (=> (ens%lib!extra.mod_add_zero. base! tmp%4 (%I n@)) (=> %%location_label%%5 (lib!definitions_t.aligned.? (I (nClip (Add base! (nClip (Mul idx! entry_size!))))) n@))))) (=> (lib!definitions_t.aligned.? (I (nClip (Add base! (nClip (Mul idx! entry_size!))))) n@) (=> %%location_label%%6 (lib!definitions_t.aligned.? (I (lib!definitions_t.entry_base_from_index.? (I base!) (I idx!) (I entry_size!))) n@))))))))))))))
(check-sat)
(exit)
