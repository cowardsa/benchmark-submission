...
(set-info :comment ";; MODULE 'module definitions_t'")
...
(set-info :comment ";; Function-Decl lib::definitions_t::LoadResult::arrow_Value_0")
(declare-fun lib!definitions_t.impl&%0.arrow_Value_0.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::definitions_t::RWOp::arrow_new_value")
(declare-fun lib!definitions_t.impl&%1.arrow_new_value.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::definitions_t::RWOp::arrow_is_exec")
(declare-fun lib!definitions_t.impl&%1.arrow_is_exec.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::definitions_t::RWOp::arrow_Store_new_value")
(declare-fun lib!definitions_t.impl&%1.arrow_Store_new_value.? (Poly) Int)
(set-info :comment ";; Function-Decl lib::definitions_t::RWOp::arrow_Store_result")
(declare-fun lib!definitions_t.impl&%1.arrow_Store_result.? (Poly) lib!definitions_t.StoreResult.)
(set-info :comment ";; Function-Decl lib::definitions_t::RWOp::arrow_Load_is_exec")
(declare-fun lib!definitions_t.impl&%1.arrow_Load_is_exec.? (Poly) Bool)
(set-info :comment ";; Function-Decl lib::definitions_t::RWOp::arrow_Load_result")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::overlap")
(set-info :comment ";; page-table/definitions_t.rs:152:1: 152:82 (#0)")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::aligned")
(set-info :comment ";; page-table/definitions_t.rs:109:1: 109:64 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::PAGE_SIZE")
(set-info :comment ";; page-table/definitions_t.rs:50:1: 50:35 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::MAX_PHYADDR_SPEC")
(set-info :comment ";; page-table/definitions_t.rs:38:1: 38:84 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::X86_NUM_LAYERS")
(set-info :comment ";; page-table/definitions_t.rs:25:1: 25:38 (#0)")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::entry_size")
(set-info :comment ";; page-table/definitions_t.rs:241:5: 241:66 (#0)")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::num_entries")
(set-info :comment ";; page-table/definitions_t.rs:247:5: 247:67 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::X86_MAX_ENTRY_SIZE")
(set-info :comment ";; page-table/definitions_t.rs:52:1: 52:65 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::X86_NUM_ENTRIES")
(set-info :comment ";; page-table/definitions_t.rs:26:1: 26:40 (#0)")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::entry_size_is_next_layer_size")
(set-info :comment ";; page-table/definitions_t.rs:273:5: 273:82 (#0)")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::inv")
(set-info :comment ";; page-table/definitions_t.rs:261:5: 261:49 (#0)")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::entry_base")
(set-info :comment ";; page-table/definitions_t.rs:299:5: 299:87 (#0)")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::upper_vaddr")
(set-info :comment ";; page-table/definitions_t.rs:253:5: 253:78 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::L3_ENTRY_SIZE")
(set-info :comment ";; page-table/definitions_t.rs:59:1: 59:44 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::L2_ENTRY_SIZE")
(set-info :comment ";; page-table/definitions_t.rs:60:1: 60:54 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::L1_ENTRY_SIZE")
(set-info :comment ";; page-table/definitions_t.rs:61:1: 61:54 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::L0_ENTRY_SIZE")
(set-info :comment ";; page-table/definitions_t.rs:62:1: 62:54 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::x86_arch_spec")
(set-info :comment ";; page-table/definitions_t.rs:341:1: 348:3 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::MAX_BASE")
(set-info :comment ";; page-table/definitions_t.rs:53:1: 53:88 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::PT_BOUND_LOW")
(set-info :comment ";; page-table/definitions_t.rs:55:1: 55:39 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::PT_BOUND_HIGH")
(set-info :comment ";; page-table/definitions_t.rs:58:1: 58:65 (#0)")
...
(set-info :comment ";; Spec-Termination lib::definitions_t::new_seq")
(set-info :comment ";; page-table/definitions_t.rs:117:1: 117:52 (#0)")
...
(set-info :comment ";; Function-Def lib::definitions_t::WORD_SIZE")
(set-info :comment ";; page-table/definitions_t.rs:49:1: 49:32 (#0)")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::contains_entry_size_at_index_atleast")
(set-info :comment ";; page-table/definitions_t.rs:280:5: 280:113 (#0)")
...
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::contains_entry_size")
(set-info :comment ";; page-table/definitions_t.rs:284:5: 284:82 (#0)")
...
(assert (forall ((offset! Poly) (entry_size! Poly)) (! (= (req%lib!definitions_t.index_from_offset. offset! entry_size!) (=> %%global_location_label%%12 (> (%I entry_size!) 0))) :pattern ((req%lib!definitions_t.index_from_offset. offset! entry_size!)))))
...
(assert (forall ((base! Poly) (addr! Poly) (entry_size! Poly)) (! (= (req%lib!definitions_t.index_from_base_and_addr. base! addr! entry_size!) (and (=> %%global_location_label%%13 (>= (%I addr!) (%I base!))) (=> %%global_location_label%%14 (> (%I entry_size!) 0)))) :pattern ((req%lib!definitions_t.index_from_base_and_addr. base! addr! entry_size!)))))
...
(assert (forall ((self! Poly) (layer! Poly) (base! Poly) (vaddr! Poly)) (! (= (req%lib!definitions_t.impl&%8.index_for_vaddr. self! layer! base! vaddr!) (and (=> %%global_location_label%%15 (lib!definitions_t.impl&%8.inv.? self!)) (=> %%global_location_label%%16 (< (%I layer!) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!)))))) (=> %%global_location_label%%17 (<= (%I base!) (%I vaddr!))))) :pattern ((req%lib!definitions_t.impl&%8.index_for_vaddr. self! layer! base! vaddr!)))))
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::index_for_vaddr")
(set-info :comment ";; page-table/definitions_t.rs:289:5: 289:94 (#0)")
...
(assert (forall ((self! Poly) (layer! Poly) (base! Poly) (idx! Poly)) (! (= (req%lib!definitions_t.impl&%8.next_entry_base. self! layer! base! idx!) (and (=> %%global_location_label%%18 (lib!definitions_t.impl&%8.inv.? self!)) (=> %%global_location_label%%19 (< (%I layer!) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!)))))))) :pattern ((req%lib!definitions_t.impl&%8.next_entry_base. self! layer! base! idx!)))))
(set-info :comment ";; Function-Recommends lib::definitions_t::Arch::next_entry_base")
(set-info :comment ";; page-table/definitions_t.rs:309:5: 309:92 (#0)")
...
(assert (has_type self! TYPE%lib!definitions_t.Arch.))
(assert (has_type layer! NAT))
(assert (has_type base! NAT))
(assert (has_type idx! NAT))
(set-info :comment ";; recommendation not met")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!definitions_t.impl&%8.inv.? self!) (=> (< (%I layer!) (vstd!seq.Seq.len.? $ TYPE%lib!definitions_t.ArchLayer. (Poly%vstd!seq.Seq<lib!definitions_t.ArchLayer.>. (lib!definitions_t.Arch./Arch/layers (%Poly%lib!definitions_t.Arch. self!))))) (=> %%location_label%%0 (req%lib!definitions_t.impl&%8.entry_size. self! layer!))))))
(check-sat)
(exit)
