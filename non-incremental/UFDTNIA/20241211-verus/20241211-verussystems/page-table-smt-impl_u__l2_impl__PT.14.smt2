...
(declare-const mem1! lib!spec_t.mem.PageTableMemory.)
(declare-const mem2! lib!spec_t.mem.PageTableMemory.)
...
(declare-const tmp%2 lib!impl_u.l2_impl.PTDir.)
(declare-const tmp%3 Int)
(declare-const tmp%4 Int)
(declare-const entry@ lib!spec_t.hardware.GhostPageDirectoryEntry.)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!impl_u.l2_impl.PTDir. pt!) TYPE%lib!impl_u.l2_impl.PTDir.))
(assert (<= 0 layer!))
(assert (uInv SZ ptr!))
(assert (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!)))
(assert (forall ((r$ Poly)) (! (=> (has_type r$ TYPE%lib!definitions_t.MemRegion.) (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!definitions_t.MemRegion. (Poly%vstd!set.Set<lib!definitions_t.MemRegion.>. (lib!impl_u.l2_impl.PTDir./PTDir/used_regions (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) r$) (= (lib!spec_t.mem.impl&%1.region_view.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) r$) (lib!spec_t.mem.impl&%1.region_view.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) r$)))) :pattern ((lib!spec_t.mem.impl&%1.region_view.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) r$)))))
(assert (lib!spec_t.mem.impl&%1.inv.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!)))
(assert (vstd!set.impl&%0.contains.? $ TYPE%lib!definitions_t.MemRegion. (Poly%vstd!set.Set<lib!definitions_t.MemRegion.>. (lib!spec_t.mem.impl&%1.regions.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!))) (Poly%lib!definitions_t.MemRegion. (lib!impl_u.l2_impl.PTDir./PTDir/region (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!))))))
(assert (vstd!set.impl&%0.subset_of.? $ TYPE%lib!definitions_t.MemRegion. (Poly%vstd!set.Set<lib!definitions_t.MemRegion.>. (lib!impl_u.l2_impl.PTDir./PTDir/used_regions (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) (Poly%vstd!set.Set<lib!definitions_t.MemRegion.>. (lib!spec_t.mem.impl&%1.regions.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!)))))
...
(assert (not (=> (= decrease%init0 (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!)) (and (=> (has_type i@ NAT) (=> (< (%I i@) lib!definitions_t.X86_NUM_ENTRIES.?) (=> %%location_label%%0 (= (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i@) (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i@))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) lib!definitions_t.X86_NUM_ENTRIES.?) (= (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$) (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$)))) :pattern ((lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$)) :pattern ((lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$)))) (and (=> (has_type i$1@ NAT) (=> (< (%I i$1@) lib!definitions_t.X86_NUM_ENTRIES.?) (=> %%location_label%%1 (= (lib!impl_u.l2_impl.PT.entry_at_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$1@) (lib!impl_u.l2_impl.PT.entry_at_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$1@))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) lib!definitions_t.X86_NUM_ENTRIES.?) (= (lib!impl_u.l2_impl.PT.entry_at_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$) (lib!impl_u.l2_impl.PT.entry_at_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$)))) :pattern ((lib!impl_u.l2_impl.PT.entry_at_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$)) :pattern ((lib!impl_u.l2_impl.PT.entry_at_spec.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$)))) (and (=> (has_type i$2@ NAT) (=> (< (%I i$2@) lib!definitions_t.X86_NUM_ENTRIES.?) (=> (= entry@ (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$2@)) (or (and (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ entry@) (=> (= tmp%1 (lib!impl_u.l2_impl.PT.directories_obey_invariant_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem1!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!))) (and (=> %%location_label%%2 tmp%1) (=> tmp%1 (=> (= tmp%2 (%Poly%lib!impl_u.l2_impl.PTDir. (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) i$2@))))) (=> (= tmp%3 (nClip (Add layer! 1))) (=> (= tmp%4 (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. entry@)))) (and (=> %%location_label%%3 (check_decrease_int (let ((mem1!$0 mem1!) (mem2!$1 mem2!) (pt!$2 tmp%2) (layer!$3 tmp%3) (ptr!$4 tmp%4)) (Sub lib!definitions_t.X86_NUM_LAYERS.? layer!$3)) decrease%init0 false)) (and (=> %%location_label%%4 (req%lib!impl_u.l2_impl.PT.lemma_inv_at_different_memory. mem1! mem2! tmp%2 tmp%3 tmp%4)) (=> (ens%lib!impl_u.l2_impl.PT.lemma_inv_at_different_memory. mem1! mem2! tmp%2 tmp%3 tmp%4) %%switch_label%%0)))))))))) (=> (not (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ entry@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%5 (let ((entry$ (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$2@))) (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ entry$) (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) i$2@))) (I (nClip (Add layer! 1))) (I (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. entry$))))))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (< (%I i$) lib!definitions_t.X86_NUM_ENTRIES.?) (let ((entry$ (lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$))) (=> (is-lib!spec_t.hardware.GhostPageDirectoryEntry./Directory_ entry$) (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ TYPE%lib!impl_u.l2_impl.PTDir.) (Poly%vstd!seq.Seq<core!option.Option<lib!impl_u.l2_impl.PTDir.>.>. (lib!impl_u.l2_impl.PTDir./PTDir/entries (%Poly%lib!impl_u.l2_impl.PTDir. (Poly%lib!impl_u.l2_impl.PTDir. pt!)))) i$))) (I (nClip (Add layer! 1))) (I (lib!spec_t.hardware.GhostPageDirectoryEntry./Directory/addr (%Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. (Poly%lib!spec_t.hardware.GhostPageDirectoryEntry. entry$))))))))) :pattern ((lib!impl_u.l2_impl.PT.view_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!) i$)))) (=> %%location_label%%6 (lib!impl_u.l2_impl.PT.inv_at.? (Poly%lib!spec_t.mem.PageTableMemory. mem2!) (Poly%lib!impl_u.l2_impl.PTDir. pt!) (I layer!) (I ptr!))))))))))))
(check-sat)
(exit)
