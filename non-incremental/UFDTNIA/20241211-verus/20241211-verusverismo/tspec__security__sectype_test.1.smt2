...
(assert (%B (B (<= (%I (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ INT $ TYPE%tuple%0.) (verismo!tspec.security.sectype.impl&%9.spec_new.? $ INT $ TYPE%tuple%0. (verismo!tspec.ops.VSpecAdd.spec_add.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ INT $ TYPE%tuple%0.) (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (UINT 64) $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!)) (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (UINT 64) $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v2!)))))) (%I (I 18446744073709551615))))))
...
(assert (not (and (=> %%location_label%%0 (req%verismo!tspec.security.sectype.impl&%349.add. $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v2!))) (=> (ens%verismo!tspec.security.sectype.impl&%349.add. $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v2!) tmp%1) (=> (= ret! (%Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. tmp%1)) (and (=> %%location_label%%1 (verismo!tspec.security.sectype.impl&%20.wf.? $ (UINT 64) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!))) (=> %%location_label%%2 (=> (and (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v2!)))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!)))))))))))
(check-sat)
(exit)
