...
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:15:1: 15:52 (#0)")
...
(set-info :comment ";; Function-Def verismo::tspec::math::nonlinear::lemma_mod")
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:15:1: 15:52 (#0)")
...
(assert (not (=> (= ret! (EucDiv a! b!)) (=> %%location_label%%0 (= (Mul ret! b!) a!)))))
(check-sat)
(exit)
