...
(assert (not (=> (= ret@ (verismo!snp.cpu.gdt.DescriptorAttr0_7./DescriptorAttr0_7 (%I (I 0)))) (=> (= val@ (verismo!snp.cpu.gdt.DescriptorAttr0_7./DescriptorAttr0_7/value (%Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. ret@)))) (and (=> (has_type mask@ (UINT 64)) (=> (has_type offset@ (UINT 64)) (and (=> %%location_label%%0 true) (=> (or (not (= val@ 0)) (= (uClip 64 (uintand 64 (I (uClip 64 (uintshr 64 (I val@) (I (%I offset@))))) (I (%I mask@)))) 0)) (=> %%location_label%%1 (= (uClip 64 (uintand 64 (I (uClip 64 (uintshr 64 (I val@) (I (%I offset@))))) (I (%I mask@)))) (uClip 64 0))))))) (=> (forall ((mask$ Poly) (offset$ Poly)) (! (=> (and (has_type mask$ (UINT 64)) (has_type offset$ (UINT 64))) (= (uClip 64 (uintand 64 (I (uClip 64 (uintshr 64 (I val@) (I (%I offset$))))) (I (%I mask$)))) (uClip 64 0))) :pattern ((uClip 64 (uintand 64 (I (uClip 64 (uintshr 64 (I val@) (I (%I offset$))))) (I (%I mask$))))))) (=> (= ret! ret@) (=> %%location_label%%2 (= (verismo!snp.cpu.gdt.impl&%16.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. ret!)) (verismo!snp.cpu.gdt.impl&%3.empty.? (I 0)))))))))))
(check-sat)
(exit)
