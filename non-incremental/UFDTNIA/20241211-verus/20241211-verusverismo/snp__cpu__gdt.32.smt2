...
(assert (not (=> %%location_label%%0 (= (verismo!snp.cpu.gdt.impl&%16.spec_new.? (I (verismo!snp.cpu.gdt.DescriptorAttr0_7./DescriptorAttr0_7/value (%Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. self!))))) self!))))
(check-sat)
(exit)
