...
(assert (not (=> (= ret! (verismo!snp.cpu.gdt.DescriptorAttr8_11./DescriptorAttr8_11 (%I (I val!)))) (and (=> %%location_label%%0 (= ret! (verismo!snp.cpu.gdt.impl&%33.spec_new.? (I val!)))) (=> %%location_label%%1 (= (verismo!snp.cpu.gdt.impl&%33.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. ret!)) (verismo!snp.cpu.gdt.impl&%20.new.? (I val!))))))))
(check-sat)
(exit)
