...
(assert (has_type v! T1&))
(assert (tr_bound%verismo!tspec.cast.VTypeCast. T1&. T1& T2&. T2&))
(assert (tr_bound%verismo!tspec.isconst.IsConstant. T1&. T1&))
(assert (tr_bound%verismo!tspec.isconst.IsConstant. T2&. T2&))
...
(assert (not (and (=> %%location_label%%0 (req%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! 1)) (=> (ens%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! 1) (and (=> %%location_label%%1 (req%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! 2)) (=> (ens%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! 2) (and (=> %%location_label%%2 (req%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! 3)) (=> (ens%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! 3) (and (=> %%location_label%%3 (req%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! 4)) (=> (ens%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! 4) (and (=> %%location_label%%4 (= (verismo!tspec.isconst.IsConstant.is_constant.? T1&. T1& v!) (verismo!tspec.isconst.IsConstant.is_constant.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!)))) (and (=> %%location_label%%5 (= (verismo!tspec.isconst.IsConstant.is_constant_to.? T1&. T1& v! (I 1)) (verismo!tspec.isconst.IsConstant.is_constant_to.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!) (I 1)))) (and (=> %%location_label%%6 (= (verismo!tspec.isconst.IsConstant.is_constant_to.? T1&. T1& v! (I 2)) (verismo!tspec.isconst.IsConstant.is_constant_to.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!) (I 2)))) (and (=> %%location_label%%7 (= (verismo!tspec.isconst.IsConstant.is_constant_to.? T1&. T1& v! (I 3)) (verismo!tspec.isconst.IsConstant.is_constant_to.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!) (I 3)))) (=> %%location_label%%8 (= (verismo!tspec.isconst.IsConstant.is_constant_to.? T1&. T1& v! (I 4)) (verismo!tspec.isconst.IsConstant.is_constant_to.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!) (I 4))))))))))))))))))
(check-sat)
(exit)
