...
(assert (not (=> (= mask@ (uClip 64 128)) (=> (ens%verismo!snp.cpu.gdt.impl&%16.value. self! value@) (=> (= verus_tmp@1 value@) (=> (= verus_tmp_oldv@ verus_tmp@1) (=> (= oldv@1 verus_tmp_oldv@) (and (=> %%location_label%%0 (and (<= 0 (uClip 64 7)) (< (uClip 64 7) 64))) (=> (= value$1@ (uClip 64 (uintor 64 (I (uClip 64 (uintand 64 (I value@) (I (uClip 64 (uintnot 64 (I mask@))))))) (I (uClip 64 (uintshl 64 (I val!) (I (uClip 64 7)))))))) (=> (= ret@ (verismo!snp.cpu.gdt.DescriptorAttr0_7./DescriptorAttr0_7 (%I (I value$1@)))) (=> (= actual_ret@ (verismo!snp.cpu.gdt.impl&%16.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. ret@))) (=> (= expected_ret@ (verismo!snp.cpu.gdt.impl&%1.spec_set_present.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7Spec. (verismo!snp.cpu.gdt.impl&%16.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. self!))) (I val!))) (=> (= actual_ret@ expected_ret@) (=> (= ret! ret@) (=> %%location_label%%1 (= (verismo!snp.cpu.gdt.impl&%16.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. ret!)) (verismo!snp.cpu.gdt.impl&%1.spec_set_present.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7Spec. (verismo!snp.cpu.gdt.impl&%16.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. self!))) (I val!))))))))))))))))))
(check-sat)
(exit)
