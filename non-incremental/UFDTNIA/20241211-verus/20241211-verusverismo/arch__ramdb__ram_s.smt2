...
(set-info :comment ";; MODULE 'module arch::ramdb::ram_s'")
...
(declare-const fuel%verismo!arch.crypto.encdec.impl&%1.encrypt. FuelId)
...
(declare-const fuel%verismo!arch.ramdb.def.impl&%1.spec_set_data. FuelId)
(declare-const fuel%verismo!arch.ramdb.def.impl&%1.spec_set_write_count. FuelId)
...
(declare-const fuel%verismo!arch.ramdb.ram_s.memrange_contains_block. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.len. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.inv. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.write. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.to_write. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.write_raw. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.read_one_byte. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.read_byte_at. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.read_bytes_by_asid. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.read_by_asid. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.disjoint_write_read_requires. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.read_all_by_asid. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.hv_update. FuelId)
(declare-const fuel%verismo!arch.ramdb.ram_s.impl&%0.hv_view. FuelId)
...
(declare-datatypes ((core!option.Option. 0) (verismo!tspec.security.sectype.DataLabel. 0) (verismo!tspec.security.sectype.SpecSecType. 0) (verismo!arch.addr_s.def_s.SysPhy. 0) (verismo!arch.addr_s.def_s.SpecPage. 0) (verismo!arch.addr_s.def_s.SpecAddr. 0) (verismo!arch.addr_s.def_s.SpecMem. 0) (verismo!arch.entities.memid.MemID. 0) (verismo!arch.rmp.perm_s.Perm. 0) (verismo!arch.ramdb.def.RamDB. 0) (verismo!arch.entities.VMPL. 0) (verismo!arch.crypto.CryptoMask. 0) (verismo!arch.crypto.SymKey. 0) (verismo!arch.crypto.Encrypted. 0) (tuple%0. 0) (tuple%2. 0)) (((core!option.Option./None ) (core!option.Option./Some (core!option.Option./Some/?0 Poly))) ((verismo!tspec.security.sectype.DataLabel./Symbol ) (verismo!tspec.security.sectype.DataLabel./Unknown ) (verismo!tspec.security.sectype.DataLabel./TrustedRandom ) (verismo!tspec.security.sectype.DataLabel./Secret )) ((verismo!tspec.security.sectype.SpecSecType./SpecSecType (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?val Poly) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?_unused core!option.Option.) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?valsets Poly) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?labels vstd!map.Map<nat./verismo!tspec.security.sectype.DataLabel.>.))) ((verismo!arch.addr_s.def_s.SysPhy./SysPhy )) ((verismo!arch.addr_s.def_s.SpecPage./SpecPage (verismo!arch.addr_s.def_s.SpecPage./SpecPage/?value Int) (verismo!arch.addr_s.def_s.SpecPage./SpecPage/?dummy Poly))) ((verismo!arch.addr_s.def_s.SpecAddr./SpecAddr (verismo!arch.addr_s.def_s.SpecAddr./SpecAddr/?value Int) (verismo!arch.addr_s.def_s.SpecAddr./SpecAddr/?dummy Poly))) ((verismo!arch.addr_s.def_s.SpecMem./SpecMem (verismo!arch.addr_s.def_s.SpecMem./SpecMem/?first verismo!arch.addr_s.def_s.SpecAddr.) (verismo!arch.addr_s.def_s.SpecMem./SpecMem/?size Int))) ((verismo!arch.entities.memid.MemID./Guest (verismo!arch.entities.memid.MemID./Guest/?0 Int) (verismo!arch.entities.memid.MemID./Guest/?1 verismo!arch.entities.VMPL.)) (verismo!arch.entities.memid.MemID./Hv )) ((verismo!arch.rmp.perm_s.Perm./Read ) (verismo!arch.rmp.perm_s.Perm./Write ) (verismo!arch.rmp.perm_s.Perm./ExeU ) (verismo!arch.rmp.perm_s.Perm./ExeS ) (verismo!arch.rmp.perm_s.Perm./Shadow )) ((verismo!arch.ramdb.def.RamDB./RamDB (verismo!arch.ramdb.def.RamDB./RamDB/?data vstd!seq.Seq<verismo!arch.crypto.Encrypted<verismo!arch.crypto.SymKey<tuple%2<nat./int.>.>./u8.>.>.) (verismo!arch.ramdb.def.RamDB./RamDB/?write_count Int) (verismo!arch.ramdb.def.RamDB./RamDB/?crypto_mask vstd!seq.Seq<verismo!arch.crypto.CryptoMask.>.))) ((verismo!arch.entities.VMPL./VMPL0 ) (verismo!arch.entities.VMPL./VMPL1 ) (verismo!arch.entities.VMPL./VMPL2 ) (verismo!arch.entities.VMPL./VMPL3 )) ((verismo!arch.crypto.CryptoMask./CryptoMask (verismo!arch.crypto.CryptoMask./CryptoMask/?0 Int))) ((verismo!arch.crypto.SymKey./SymKey (verismo!arch.crypto.SymKey./SymKey/?key Poly))) ((verismo!arch.crypto.Encrypted./Encrypted (verismo!arch.crypto.Encrypted./Encrypted/?data Poly) (verismo!arch.crypto.Encrypted./Encrypted/?key Poly) (verismo!arch.crypto.Encrypted./Encrypted/?crypto_mask Poly))) ((tuple%0./tuple%0 )) ((tuple%2./tuple%2 (tuple%2./tuple%2/?0 Poly) (tuple%2./tuple%2/?1 Poly)))))
...
(set-info :comment ";; Function-Decl verismo::arch::crypto::CryptoMask::get_mask")
(declare-fun verismo!arch.crypto.encdec.impl&%0.get_mask.? (Dcr Type Poly) Poly)
(set-info :comment ";; Function-Decl verismo::arch::crypto::encdec::SpecEncrypt::encrypt")
(declare-fun verismo!arch.crypto.encdec.SpecEncrypt.encrypt.? (Dcr Type Dcr Type Poly Poly Poly) Poly)
(declare-fun verismo!arch.crypto.encdec.SpecEncrypt.encrypt%default%.? (Dcr Type Dcr Type Poly Poly Poly) Poly)
...
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::spec_set_data")
(declare-fun verismo!arch.ramdb.def.impl&%1.spec_set_data.? (Poly Poly) verismo!arch.ramdb.def.RamDB.)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::spec_set_write_count")
(declare-fun verismo!arch.ramdb.def.impl&%1.spec_set_write_count.? (Poly Poly) verismo!arch.ramdb.def.RamDB.)
...
(set-info :comment ";; Function-Decl verismo::arch::ramdb::ram_s::memrange_contains_block")
(declare-fun verismo!arch.ramdb.ram_s.memrange_contains_block.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::len")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.len.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::inv")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.inv.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::write")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.write.? (Dcr Type Poly Poly Poly Poly) verismo!arch.ramdb.def.RamDB.)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::to_write")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.to_write.? (Poly Poly Poly Poly Poly) verismo!arch.crypto.Encrypted.)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::write_raw")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.write_raw.? (Poly Poly Poly Poly) verismo!arch.ramdb.def.RamDB.)
...
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::read_byte_at")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.read_byte_at.? (Poly Poly Poly Poly) Int)
...
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::read_by_asid")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.read_by_asid.? (Dcr Type Poly Poly Poly) Poly)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::disjoint_write_read_requires")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.disjoint_write_read_requires.? (Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::read_all_by_asid")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.read_all_by_asid.? (Poly Poly) vstd!seq.Seq<u8.>.)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::hv_update")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.hv_update.? (Poly Poly Poly) verismo!arch.ramdb.def.RamDB.)
(set-info :comment ";; Function-Decl verismo::arch::ramdb::def::RamDB::hv_view")
(declare-fun verismo!arch.ramdb.ram_s.impl&%0.hv_view.? (Poly Poly) vstd!seq.Seq<u8.>.)
...
(set-info :comment ";; Function-Axioms verismo::arch::crypto::CryptoMask::get_mask")
(assert (forall ((T&. Dcr) (T& Type) (self! Poly)) (! (=> (has_type self! TYPE%verismo!arch.crypto.CryptoMask.) (has_type (verismo!arch.crypto.encdec.impl&%0.get_mask.? T&. T& self!) T&)) :pattern ((verismo!arch.crypto.encdec.impl&%0.get_mask.? T&. T& self!)))))
(set-info :comment ";; Function-Axioms verismo::arch::crypto::encdec::SpecEncrypt::encrypt")
(assert (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type) (self! Poly) (plain! Poly) (crypto_mask! Poly)) (! (=> (and (has_type self! Self%&) (has_type plain! T&) (has_type crypto_mask! T&)) (has_type (verismo!arch.crypto.encdec.SpecEncrypt.encrypt.? Self%&. Self%& T&. T& self! plain! crypto_mask!) (TYPE%verismo!arch.crypto.Encrypted. Self%&. Self%& T&. T&))) :pattern ((verismo!arch.crypto.encdec.SpecEncrypt.encrypt.? Self%&. Self%& T&. T& self! plain! crypto_mask!)))))
...
(set-info :comment ";; Function-Def verismo::arch::ramdb::ram_s::MEM_UNIT_SIZE")
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#8931)")
