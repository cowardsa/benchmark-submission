...
(set-info :comment ";; MODULE 'module ptr::raw_ptr_s'")
...
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%0.spec_set_pptr. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp_bytes. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp. FuelId)
...
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.sw_eq. FuelId)
...
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.is_assign_with. FuelId)
...
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_shared. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_default. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_secret_default. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_not_null. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_freemem. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.ptr_not_null_wf. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.snp_wf_not_null_range. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.ptr_validated_low. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.wf. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.inv_snp_value. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.bytes. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%5.spec_write_rel. FuelId)
...
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%7.wf_seq_perms. FuelId)
(declare-const fuel%verismo!ptr.raw_ptr_s.impl&%7.merge_perm_ensures. FuelId)
...
(set-info :comment ";; Function-Decl verismo::ptr::snp::snp_u::PTAttr::spec_set_encrypted")
...
(set-info :comment ";; Function-Decl verismo::ptr::snp::snp_u::SwSnpMemAttr::shared")
...
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::spec_set_pptr")
(declare-fun verismo!ptr.raw_ptr_s.impl&%0.spec_set_pptr.? (Poly Poly) verismo!ptr.raw_ptr_s.SnpPointsToBytes.)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::spec_set_snp_bytes")
(declare-fun verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp_bytes.? (Poly Poly) verismo!ptr.raw_ptr_s.SnpPointsToBytes.)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::spec_set_snp")
(declare-fun verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp.? (Poly Poly) verismo!ptr.raw_ptr_s.SnpPointsToBytes.)
...
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::sw_eq")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.sw_eq.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::only_val_updated")
...
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::is_assign_with")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.is_assign_with.? (Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::snp_wf_range")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.snp_wf_range.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_const_default")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.wf_const_default.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_shared")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.wf_shared.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_default")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.wf_default.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_secret_default")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.wf_secret_default.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_not_null")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.wf_not_null.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_freemem")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.wf_freemem.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::ptr_not_null_wf")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.ptr_not_null_wf.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::snp_wf_not_null_range")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.snp_wf_not_null_range.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::ptr_validated_low")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.ptr_validated_low.? (Poly Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::inv_snp_value")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.inv_snp_value.? (Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::spec_write_rel")
(declare-fun verismo!ptr.raw_ptr_s.impl&%5.spec_write_rel.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_s::SnpPointsToBytes::value")
...
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToRaw::wf_seq_perms")
(declare-fun verismo!ptr.raw_ptr_s.impl&%7.wf_seq_perms.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToRaw::merge_perm_ensures")
(declare-fun verismo!ptr.raw_ptr_s.impl&%7.merge_perm_ensures.? (Poly Poly Poly) Bool)
...
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (v! Poly) (vmpl! Int)) (! (= (req%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! vmpl!) (=> %%global_location_label%%47 (and (<= 1 vmpl!) (<= vmpl! 4)))) :pattern ((req%verismo!tspec.cast.proof_into_is_constant_to. T1&. T1& T2&. T2& v! vmpl!)))))
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::only_val_updated")
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_not_null")
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_const_default")
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_freemem")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_freemem.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_freemem.) (forall ((self! Poly) (range! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.wf_freemem.? self! range!) (verismo!ptr.raw_ptr_s.impl&%5.wf_const_default.? self! range!)) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.wf_freemem.? self! range!))))))
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::value")
...
(set-info :comment ";; Function-Specs verismo::ptr::raw_ptr_s::SnpPointsToBytes::axiom_map_ext_equal")
(declare-fun ens%verismo!ptr.raw_ptr_s.impl&%5.axiom_map_ext_equal. (verismo!ptr.raw_ptr_s.SnpPointsToBytes. verismo!ptr.raw_ptr_s.SnpPointsToBytes.) Bool)
(assert (forall ((self! verismo!ptr.raw_ptr_s.SnpPointsToBytes.) (other! verismo!ptr.raw_ptr_s.SnpPointsToBytes.)) (! (= (ens%verismo!ptr.raw_ptr_s.impl&%5.axiom_map_ext_equal. self! other!) (= (ext_eq false TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!) (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!)) (and (and (ext_eq true (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!))) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!)))) (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!)))) (= (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)) (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!)))))) :pattern ((ens%verismo!ptr.raw_ptr_s.impl&%5.axiom_map_ext_equal. self! other!)))))
(set-info :comment ";; Broadcast verismo::ptr::raw_ptr_s::SnpPointsToBytes::axiom_map_ext_equal")
(assert (forall ((self! Poly) (other! Poly)) (! (=> (and (has_type self! TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.) (has_type other! TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.)) (= (ext_eq false TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self! other!) (and (and (ext_eq true (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? self!)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? other!))) (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!))) (= (verismo!ptr.raw_ptr_s.impl&%5.range.? self!) (verismo!ptr.raw_ptr_s.impl&%5.range.? other!))))) :pattern ((ext_eq false TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self! other!)))))
(set-info :comment ";; Function-Specs verismo::ptr::raw_ptr_s::SnpPointsToBytes::axiom_map_ext_equal_deep")
(declare-fun ens%verismo!ptr.raw_ptr_s.impl&%5.axiom_map_ext_equal_deep. (verismo!ptr.raw_ptr_s.SnpPointsToBytes. verismo!ptr.raw_ptr_s.SnpPointsToBytes.) Bool)
(assert (forall ((self! verismo!ptr.raw_ptr_s.SnpPointsToBytes.) (other! verismo!ptr.raw_ptr_s.SnpPointsToBytes.)) (! (= (ens%verismo!ptr.raw_ptr_s.impl&%5.axiom_map_ext_equal_deep. self! other!) (= (ext_eq true TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!) (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!)) (and (and (ext_eq true (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!))) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!)))) (= (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!))) (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!))))) (= (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)) (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!)))))) :pattern ((ens%verismo!ptr.raw_ptr_s.impl&%5.axiom_map_ext_equal_deep. self! other!)))))
(set-info :comment ";; Broadcast verismo::ptr::raw_ptr_s::SnpPointsToBytes::axiom_map_ext_equal_deep")
(assert (forall ((self! Poly) (other! Poly)) (! (=> (and (has_type self! TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.) (has_type other! TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.)) (= (ext_eq true TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self! other!) (and (and (ext_eq true (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? self!)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? other!))) (= (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)) (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. other!)))) (= (verismo!ptr.raw_ptr_s.impl&%5.range.? self!) (verismo!ptr.raw_ptr_s.impl&%5.range.? other!))))) :pattern ((ext_eq true TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self! other!)))))
(set-info :comment ";; Function-Specs verismo::ptr::def_s::SnpPointsToRaw::tracked_empty")
...
(set-info :comment ";; Function-Specs verismo::ptr::def_s::SnpPointsToRaw::trusted_into")
(declare-fun req%verismo!ptr.raw_ptr_s.impl&%7.trusted_into. (Dcr Type verismo!ptr.def_s.SnpPointsToRaw.) Bool)
(declare-const %%global_location_label%%49 Bool)
(declare-const %%global_location_label%%50 Bool)
(assert (forall ((V&. Dcr) (V& Type) (self! verismo!ptr.def_s.SnpPointsToRaw.)) (! (= (req%verismo!ptr.raw_ptr_s.impl&%7.trusted_into. V&. V& self!) (and (=> %%global_location_label%%49 (verismo!ptr.raw_ptr_s.impl&%5.wf.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!))))) (=> %%global_location_label%%50 (= (verismo!tspec.size_s.spec_size.? V&. V&) (verismo!ptr.raw_ptr_s.impl&%5.size.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))))) :pattern ((req%verismo!ptr.raw_ptr_s.impl&%7.trusted_into. V&. V& self!)))))
(declare-fun ens%verismo!ptr.raw_ptr_s.impl&%7.trusted_into. (Dcr Type verismo!ptr.def_s.SnpPointsToRaw. Poly) Bool)
(assert (forall ((V&. Dcr) (V& Type) (self! verismo!ptr.def_s.SnpPointsToRaw.) (points_to! Poly)) (! (= (ens%verismo!ptr.raw_ptr_s.impl&%7.trusted_into. V&. V& self! points_to!) (and (has_type points_to! (TYPE%verismo!ptr.def_s.SnpPointsTo. V&. V&)) (= (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!) (%Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))) (= (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)) (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!))))) (%B (verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!)))))) :pattern ((ens%verismo!ptr.raw_ptr_s.impl&%7.trusted_into. V&. V& self! points_to!)))))
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::snp_wf_range")
...
(set-info :comment ";; Function-Specs verismo::ptr::def_s::SnpPointsToRaw::trusted_split")
...
(assert (forall ((self! verismo!ptr.def_s.SnpPointsToRaw.) (len1! Int)) (! (= (req%verismo!ptr.raw_ptr_s.impl&%7.trusted_split. self! len1!) (and (=> %%global_location_label%%51 (verismo!ptr.snp.snp_u.impl&%35.wf.? (Poly%verismo!ptr.snp.snp_u.SnpMemAttr. (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))))) (=> %%global_location_label%%52 (<= len1! (verismo!ptr.raw_ptr_s.impl&%5.size.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))) (=> %%global_location_label%%53 (> (verismo!ptr.raw_ptr_s.impl&%5.size.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))) 0)))) :pattern ((req%verismo!ptr.raw_ptr_s.impl&%7.trusted_split. self! len1!)))))
...
(set-info :comment ";; Function-Specs verismo::ptr::def_s::SnpPointsToRaw::trusted_join")
...
(assert (forall ((self! verismo!ptr.def_s.SnpPointsToRaw.) (other! verismo!ptr.def_s.SnpPointsToRaw.)) (! (= (req%verismo!ptr.raw_ptr_s.impl&%7.trusted_join. self! other!) (and (=> %%global_location_label%%54 (= (I (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))))))) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. other!))))))))) (=> %%global_location_label%%55 (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. other!)))))) (=> %%global_location_label%%56 (verismo!ptr.snp.snp_u.impl&%35.wf.? (Poly%verismo!ptr.snp.snp_u.SnpMemAttr. (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))))) (=> %%global_location_label%%57 (verismo!ptr.snp.snp_u.impl&%35.wf.? (Poly%verismo!ptr.snp.snp_u.SnpMemAttr. (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. other!)))))))))) :pattern ((req%verismo!ptr.raw_ptr_s.impl&%7.trusted_join. self! other!)))))
...
(set-info :comment ";; Function-Specs verismo::ptr::def_s::SnpPointsToRaw::tracked_to_pages")
...
(assert (forall ((self! verismo!ptr.def_s.SnpPointsToRaw.)) (! (= (req%verismo!ptr.raw_ptr_s.impl&%7.tracked_to_pages. self!) (and (=> %%global_location_label%%58 (= (EucMod (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))))) 4096) 0)) (=> %%global_location_label%%59 (= (EucMod (verismo!ptr.raw_ptr_s.impl&%5.size.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))) 4096) 0)) (=> %%global_location_label%%60 (verismo!ptr.raw_ptr_s.impl&%5.wf.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!))))))) :pattern ((req%verismo!ptr.raw_ptr_s.impl&%7.tracked_to_pages. self!)))))
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::is_assign_with")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.is_assign_with.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.is_assign_with.) (forall ((self! Poly) (val! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.is_assign_with.? self! val!) (=> (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)) (ext_eq true (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? self!)) val!))) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.is_assign_with.? self! val!))))))
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::spec_write_rel")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.spec_write_rel.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.spec_write_rel.) (forall ((self! Poly) (prev! Poly) (bytes! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.spec_write_rel.? self! prev! bytes!) (and (and (and (and (= (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp_bytes (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)) (%Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. bytes!)) (= (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp_bytes (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)))) (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp_bytes (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. prev!)))))) (= (verismo!ptr.raw_ptr_s.impl&%5.range.? self!) (verismo!ptr.raw_ptr_s.impl&%5.range.? prev!))) (= (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)) (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. prev!)))) (verismo!ptr.raw_ptr_s.impl&%5.wf.? self!))) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.spec_write_rel.? self! prev! bytes!))))))
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_secret_default")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_secret_default.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_secret_default.) (forall ((self! Poly) (range! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.wf_secret_default.? self! range!) (and (and (and (verismo!ptr.raw_ptr_s.impl&%5.wf_range.? self! range!) (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!) (verismo!tspec.default.SpecDefault.spec_default.? $ TYPE%verismo!ptr.snp.snp_u.SwSnpMemAttr.))) (%B (verismo!tspec.security.sectype.IsFullSecretToAll.is_fullsecret.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? self!))))) (%B (verismo!addr_e.addr_interface.SpecAddrTrait.spec_valid_addr_with.? $ INT (tuple%2./tuple%2/0 (%Poly%tuple%2. range!)) (tuple%2./tuple%2/1 (%Poly%tuple%2. range!)))))) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.wf_secret_default.? self! range!))))))
...
(set-info :comment ";; Function-Axioms verismo::ptr::snp::snp_u::PTAttr::spec_set_encrypted")
...
(set-info :comment ";; Function-Axioms verismo::ptr::snp::snp_u::SwSnpMemAttr::shared")
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::spec_set_pptr")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%0.spec_set_pptr.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%0.spec_set_pptr.) (forall ((self! Poly) (val! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%0.spec_set_pptr.? self! val!) (verismo!ptr.raw_ptr_s.impl&%1.spec_new.? val! (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%2.spec_snp_bytes.? self!)) (Poly%verismo!ptr.snp.snp_u.SnpMemAttr. (verismo!ptr.raw_ptr_s.impl&%2.spec_snp.? self!)))) :pattern ((verismo!ptr.raw_ptr_s.impl&%0.spec_set_pptr.? self! val!))))))
(assert (forall ((self! Poly) (val! Poly)) (! (=> (and (has_type self! TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.) (has_type val! INT)) (has_type (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%0.spec_set_pptr.? self! val!)) TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.)) :pattern ((verismo!ptr.raw_ptr_s.impl&%0.spec_set_pptr.? self! val!)))))
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::spec_set_snp_bytes")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp_bytes.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp_bytes.) (forall ((self! Poly) (val! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp_bytes.? self! val!) (verismo!ptr.raw_ptr_s.impl&%1.spec_new.? (I (verismo!ptr.raw_ptr_s.impl&%2.spec_pptr.? self!)) val! (Poly%verismo!ptr.snp.snp_u.SnpMemAttr. (verismo!ptr.raw_ptr_s.impl&%2.spec_snp.? self!)))) :pattern ((verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp_bytes.? self! val!))))))
(assert (forall ((self! Poly) (val! Poly)) (! (=> (and (has_type self! TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.) (has_type val! (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)))) (has_type (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp_bytes.? self! val!)) TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.)) :pattern ((verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp_bytes.? self! val!)))))
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::spec_set_snp")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp.) (forall ((self! Poly) (val! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp.? self! val!) (verismo!ptr.raw_ptr_s.impl&%1.spec_new.? (I (verismo!ptr.raw_ptr_s.impl&%2.spec_pptr.? self!)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%2.spec_snp_bytes.? self!)) val!)) :pattern ((verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp.? self! val!))))))
(assert (forall ((self! Poly) (val! Poly)) (! (=> (and (has_type self! TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.) (has_type val! TYPE%verismo!ptr.snp.snp_u.SnpMemAttr.)) (has_type (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp.? self! val!)) TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes.)) :pattern ((verismo!ptr.raw_ptr_s.impl&%0.spec_set_snp.? self! val!)))))
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::sw_eq")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.sw_eq.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.sw_eq.) (forall ((self! Poly) (rhs! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.sw_eq.? self! rhs!) (and (and (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. rhs!)) (ext_eq true (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? self!)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? rhs!)))) (= (verismo!ptr.raw_ptr_s.impl&%5.range.? self!) (verismo!ptr.raw_ptr_s.impl&%5.range.? rhs!)))) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.sw_eq.? self! rhs!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_shared")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_shared.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.wf_shared.) (forall ((self! Poly) (range! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.wf_shared.? self! range!) (and (and (verismo!ptr.raw_ptr_s.impl&%5.wf_not_null.? self! range!) (= (%Poly%verismo!ptr.snp.snp_u.SwSnpMemAttr. (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)) (verismo!ptr.snp.snp_u.impl&%31.shared.? (I 0)))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? self!)))))) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.wf_shared.? self! range!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::wf_default")
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::ptr_not_null_wf")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.ptr_not_null_wf.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.ptr_not_null_wf.) (forall ((self! Poly) (addr! Poly) (len! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.ptr_not_null_wf.? self! addr! len!) (verismo!ptr.raw_ptr_s.impl&%5.wf_not_null.? self! (Poly%tuple%2. (tuple%2./tuple%2 addr! len!)))) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.ptr_not_null_wf.? self! addr! len!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::snp_wf_not_null_range")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.snp_wf_not_null_range.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.snp_wf_not_null_range.) (forall ((self! Poly) (range! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.snp_wf_not_null_range.? self! range!) (and (and (%B (verismo!addr_e.addr_interface.SpecAddrTrait.spec_valid_addr_with.? $ INT (tuple%2./tuple%2/0 (%Poly%tuple%2. range!)) (tuple%2./tuple%2/1 (%Poly%tuple%2. range!)))) (= (verismo!ptr.raw_ptr_s.impl&%5.range.? self!) (%Poly%tuple%2. range!))) (verismo!ptr.snp.snp_u.impl&%35.wf.? (Poly%verismo!ptr.snp.snp_u.SnpMemAttr. (verismo!ptr.raw_ptr_s.SnpPointsToBytes./SnpPointsToBytes/snp (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)))))) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.snp_wf_not_null_range.? self! range!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::ptr_validated_low")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.ptr_validated_low.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.ptr_validated_low.) (forall ((self! Poly) (addr! Poly) (len! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.ptr_validated_low.? self! addr! len!) (and (verismo!ptr.raw_ptr_s.impl&%5.wf_not_null.? self! (Poly%tuple%2. (tuple%2./tuple%2 addr! len!))) (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!) (verismo!tspec.default.SpecDefault.spec_default.? $ TYPE%verismo!ptr.snp.snp_u.SwSnpMemAttr.)))) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.ptr_validated_low.? self! addr! len!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::inv_snp_value")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%5.inv_snp_value.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%5.inv_snp_value.) (forall ((self! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%5.inv_snp_value.? self!) (verismo!ptr.ptr_s.inv_snp_value.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? self!)))) :pattern ((verismo!ptr.raw_ptr_s.impl&%5.inv_snp_value.? self!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToRaw::wf_seq_perms")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%7.wf_seq_perms.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%7.wf_seq_perms.) (forall ((s! Poly) (i! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%7.wf_seq_perms.? s! i!) (and (and (verismo!ptr.raw_ptr_s.impl&%5.wf.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (vstd!map.impl&%0.index.? $ INT $ TYPE%verismo!ptr.def_s.SnpPointsToRaw. s! i!)))) (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ TYPE%verismo!ptr.def_s.SnpPointsToRaw. s!) i!)) (=> (> (%I i!) 0) (= (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (vstd!map.impl&%0.index.? $ INT $ TYPE%verismo!ptr.def_s.SnpPointsToRaw. s! i!))))))) (I (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (vstd!map.impl&%0.index.? $ INT $ TYPE%verismo!ptr.def_s.SnpPointsToRaw. s! (I (Sub (%I i!) 1)))))))))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (vstd!map.impl&%0.index.? $ INT $ TYPE%verismo!ptr.def_s.SnpPointsToRaw. s! (I (Sub (%I i!) 1)))))))))))))))) :pattern ((verismo!ptr.raw_ptr_s.impl&%7.wf_seq_perms.? s! i!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToRaw::merge_perm_ensures")
(assert (fuel_bool_default fuel%verismo!ptr.raw_ptr_s.impl&%7.merge_perm_ensures.))
(assert (=> (fuel_bool fuel%verismo!ptr.raw_ptr_s.impl&%7.merge_perm_ensures.) (forall ((s! Poly) (n! Poly) (res! Poly)) (! (= (verismo!ptr.raw_ptr_s.impl&%7.merge_perm_ensures.? s! n! res!) (and (and (and (verismo!ptr.raw_ptr_s.impl&%5.wf.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? res!))) (= (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? res!)))))) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (vstd!map.impl&%0.index.? $ INT $ TYPE%verismo!ptr.def_s.SnpPointsToRaw. s! (I 0)))))))))) (= (I (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? res!))))))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? res!))))))))) (I (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (vstd!map.impl&%0.index.? $ INT $ TYPE%verismo!ptr.def_s.SnpPointsToRaw. s! (I (Sub (%I n!) 1)))))))))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (verismo!ptr.raw_ptr_s.impl&%5.range.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (vstd!map.impl&%0.index.? $ INT $ TYPE%verismo!ptr.def_s.SnpPointsToRaw. s! (I (Sub (%I n!) 1)))))))))))))) (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? res!))) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (vstd!map.impl&%0.index.? $ INT $ TYPE%verismo!ptr.def_s.SnpPointsToRaw. s! (I 0)))))))) :pattern ((verismo!ptr.raw_ptr_s.impl&%7.merge_perm_ensures.? s! n! res!))))))
...
(set-info :comment ";; Function-Specs verismo::ptr::def_s::SnpPointsToRaw::tracked_into")
(declare-fun req%verismo!ptr.raw_ptr_s.impl&%7.tracked_into. (Dcr Type verismo!ptr.def_s.SnpPointsToRaw.) Bool)
(declare-const %%global_location_label%%61 Bool)
(declare-const %%global_location_label%%62 Bool)
(assert (forall ((V&. Dcr) (V& Type) (self! verismo!ptr.def_s.SnpPointsToRaw.)) (! (= (req%verismo!ptr.raw_ptr_s.impl&%7.tracked_into. V&. V& self!) (and (=> %%global_location_label%%61 (verismo!ptr.raw_ptr_s.impl&%5.wf.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!))))) (=> %%global_location_label%%62 (= (verismo!tspec.size_s.spec_size.? V&. V&) (verismo!ptr.raw_ptr_s.impl&%5.size.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))))) :pattern ((req%verismo!ptr.raw_ptr_s.impl&%7.tracked_into. V&. V& self!)))))
(declare-fun ens%verismo!ptr.raw_ptr_s.impl&%7.tracked_into. (Dcr Type verismo!ptr.def_s.SnpPointsToRaw. Poly) Bool)
(assert (forall ((V&. Dcr) (V& Type) (self! verismo!ptr.def_s.SnpPointsToRaw.) (points_to! Poly)) (! (= (ens%verismo!ptr.raw_ptr_s.impl&%7.tracked_into. V&. V& self! points_to!) (and (has_type points_to! (TYPE%verismo!ptr.def_s.SnpPointsTo. V&. V&)) (= (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!) (%Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))) (= (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)) (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!))))) (%B (verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!)))) (=> (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!))))))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!))))))))))) :pattern ((ens%verismo!ptr.raw_ptr_s.impl&%7.tracked_into. V&. V& self! points_to!)))))
(set-info :comment ";; Function-Def verismo::ptr::def_s::SnpPointsToRaw::tracked_into")
(set-info :comment ";; verismo/src/ptr/raw_ptr_s.rs:192:5: 194:44 (#0)")
(declare-const V&. Dcr)
(declare-const V& Type)
(declare-const points_to! Poly)
(declare-const self! verismo!ptr.def_s.SnpPointsToRaw.)
...
(assert (verismo!ptr.raw_ptr_s.impl&%5.wf.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))
(assert (= (verismo!tspec.size_s.spec_size.? V&. V&) (verismo!ptr.raw_ptr_s.impl&%5.size.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!))))))
...
(assert (not (=> (= tmp%1 (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))) (=> (ens%verismo!tspec.cast.proof_into_is_constant. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) V&. V& tmp%1) (=> (= tmp%2 (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))) (and (=> %%location_label%%0 (req%verismo!tspec.cast.proof_into_is_constant_to. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) V&. V& tmp%2 1)) (=> (ens%verismo!tspec.cast.proof_into_is_constant_to. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) V&. V& tmp%2 1) (=> (= tmp%3 (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))) (and (=> %%location_label%%1 (req%verismo!tspec.cast.proof_into_is_constant_to. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) V&. V& tmp%3 2)) (=> (ens%verismo!tspec.cast.proof_into_is_constant_to. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) V&. V& tmp%3 2) (=> (= tmp%4 (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))) (and (=> %%location_label%%2 (req%verismo!tspec.cast.proof_into_is_constant_to. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) V&. V& tmp%4 3)) (=> (ens%verismo!tspec.cast.proof_into_is_constant_to. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) V&. V& tmp%4 3) (=> (= tmp%5 (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)))))) (and (=> %%location_label%%3 (req%verismo!tspec.cast.proof_into_is_constant_to. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) V&. V& tmp%5 4)) (=> (ens%verismo!tspec.cast.proof_into_is_constant_to. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) V&. V& tmp%5 4) (and (=> %%location_label%%4 (req%verismo!ptr.raw_ptr_s.impl&%7.trusted_into. V&. V& self!)) (=> (ens%verismo!ptr.raw_ptr_s.impl&%7.trusted_into. V&. V& self! tmp%6) (=> (= points_to! tmp%6) (and (=> %%location_label%%5 (= (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!) (%Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!))))))) (and (=> %%location_label%%6 (= (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!)) (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!)))))) (and (=> %%location_label%%7 (%B (verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!))))) (=> %%location_label%%8 (=> (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. self!))))))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& points_to!))))))))))))))))))))))))))))))))
(check-sat)
(exit)
