...
(declare-const ss1@ Poly)
(declare-const r1@ Poly)
(declare-const r2@ Poly)
(declare-const uop_fn@ %%Function%%)
...
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? T1&. T1& s1!)) (=> (= ret@ (verismo!tspec.setlib.set_bop_recursive.? T1&. T1& T2&. T2& T3&. T3& s1! s2! (Poly%fun%2. op_fn!))) (or (and (=> (not (vstd!set_lib.impl&%0.is_empty.? T1&. T1& s1!)) (=> (= v1@ (vstd!set.impl&%0.choose.? T1&. T1& s1!)) (=> (= ss1@ (vstd!set.impl&%0.remove.? T1&. T1& s1! v1@)) (=> (= tmp%1 (vstd!set.impl&%0.remove.? T1&. T1& s1! v1@)) (and (=> %%location_label%%0 (check_decrease_int (let ((s1!$0 tmp%1) (s2!$1 s2!) (op_fn!$2 op_fn!)) (vstd!set.impl&%0.len.? T1&. T1& s1!$0)) decrease%init0 false)) (and (=> %%location_label%%1 (req%verismo!tspec.setlib.lemma_set_bop_len_recursive. T1&. T1& T3&. T3& T2&. T2& tmp%1 s2! op_fn!)) (=> (ens%verismo!tspec.setlib.lemma_set_bop_len_recursive. T1&. T1& T3&. T3& T2&. T2& tmp%1 s2! op_fn! r1@) (=> (= r2@ (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. (Poly%fun%2. op_fn!)) v1@))))))))) (=> (= tmp%2 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret@ (vstd!set.impl&%0.union.? T3&. T3& r1@ r2@))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (= uop_fn@ (mk_fun (%%lambda%%4 op_fn! v1@))) (=> (= tmp%3 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. (Poly%fun%2. op_fn!)) v1@)))))))) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. uop_fn@)))))))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (and (=> %%location_label%%4 (req%verismo!tspec.setlib.lemma_set_uop_len. T2&. T2& T3&. T3& s2! uop_fn@)) (=> (ens%verismo!tspec.setlib.lemma_set_uop_len. T2&. T2& T3&. T3& s2! uop_fn@ tmp%4) (and (=> %%location_label%%5 (req%vstd!set_lib.lemma_len_union. T3&. T3& r1@ r2@)) (=> (ens%vstd!set_lib.lemma_len_union. T3&. T3& r1@ r2@) (and (and (=> %%location_label%%6 (req%verismo!tspec.setlib.lemma_setop1. T1&. T1& T2&. T2& T3&. T3& v1@ s2! op_fn!)) (=> (ens%verismo!tspec.setlib.lemma_setop1. T1&. T1& T2&. T2& T3&. T3& v1@ s2! op_fn! tmp%5) (=> %%location_label%%7 (<= (vstd!set.impl&%0.len.? T3&. T3& r2@) (vstd!set.impl&%0.len.? T2&. T2& s2!))))) (=> (<= (vstd!set.impl&%0.len.? T3&. T3& r2@) (vstd!set.impl&%0.len.? T2&. T2& s2!)) (and (=> (= tmp%6 (vstd!set.impl&%0.len.? T1&. T1& ss1@)) (=> (= tmp%7 (vstd!set.impl&%0.len.? T2&. T2& s2!)) (=> (ens%verismo!tspec.math.nonlinear.proof_mul_assoc. tmp%6 1 tmp%7) (=> (= tmp%9 (vstd!set.impl&%0.len.? T2&. T2& s2!)) (=> (= tmp%10 (vstd!set.impl&%0.len.? T1&. T1& s1!)) (=> (ens%verismo!tspec.math.nonlinear.proof_mul_exchange. tmp%9 tmp%10 tmp%8) (=> (= tmp%12 (vstd!set.impl&%0.len.? T1&. T1& ss1@)) (=> (= tmp%13 (vstd!set.impl&%0.len.? T2&. T2& s2!)) (=> (ens%verismo!tspec.math.nonlinear.proof_mul_exchange. tmp%12 tmp%13 tmp%11) (=> %%location_label%%8 (= (nClip (Add (nClip (Mul (vstd!set.impl&%0.len.? T1&. T1& ss1@) (vstd!set.impl&%0.len.? T2&. T2& s2!))) (vstd!set.impl&%0.len.? T2&. T2& s2!))) (nClip (Mul (vstd!set.impl&%0.len.? T1&. T1& s1!) (vstd!set.impl&%0.len.? T2&. T2& s2!)))))))))))))) (=> (= (nClip (Add (nClip (Mul (vstd!set.impl&%0.len.? T1&. T1& ss1@) (vstd!set.impl&%0.len.? T2&. T2& s2!))) (vstd!set.impl&%0.len.? T2&. T2& s2!))) (nClip (Mul (vstd!set.impl&%0.len.? T1&. T1& s1!) (vstd!set.impl&%0.len.? T2&. T2& s2!)))) (or (and (=> (vstd!set_lib.impl&%0.is_empty.? T2&. T2& s2!) (=> (= tmp%14 (vstd!set_lib.impl&%0.is_empty.? T3&. T3& ret@)) (and (=> %%location_label%%9 tmp%14) (=> tmp%14 %%switch_label%%1)))) (=> (not (vstd!set_lib.impl&%0.is_empty.? T2&. T2& s2!)) (and (=> (= tmp%15 (vstd!set.impl&%0.contains.? T3&. T3& ret@ (%%apply%%1 op_fn! (vstd!set.impl&%0.choose.? T1&. T1& s1!) (vstd!set.impl&%0.choose.? T2&. T2& s2!)))) (and (=> %%location_label%%10 tmp%15) (=> tmp%15 (=> %%location_label%%11 (not (vstd!set_lib.impl&%0.is_empty.? T3&. T3& ret@)))))) (=> (not (vstd!set_lib.impl&%0.is_empty.? T3&. T3& ret@)) %%switch_label%%1)))) (and (not %%switch_label%%1) %%switch_label%%0))))))))))))))))))))))))) (=> (not (not (vstd!set_lib.impl&%0.is_empty.? T1&. T1& s1!))) (and (=> %%location_label%%12 (or (= (vstd!set.impl&%0.len.? T1&. T1& s1!) 0) (= (vstd!set.impl&%0.len.? T2&. T2& s2!) 0))) (=> (= (nClip (Mul (vstd!set.impl&%0.len.? T1&. T1& s1!) (vstd!set.impl&%0.len.? T2&. T2& s2!))) 0) (=> (= tmp%16 (vstd!set_lib.impl&%0.is_empty.? T3&. T3& ret@)) (and (=> %%location_label%%13 tmp%16) (=> tmp%16 %%switch_label%%0))))))) (and (not %%switch_label%%0) (=> (= ret! ret@) (and (=> %%location_label%%14 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (verismo!tspec.setlib.set_bop_recursive.? T1&. T1& T2&. T2& T3&. T3& s1! s2! (Poly%fun%2. op_fn!)))) (and (=> %%location_label%%15 (= (= (vstd!set.impl&%0.len.? T3&. T3& ret!) 0) (or (= (vstd!set.impl&%0.len.? T1&. T1& s1!) 0) (= (vstd!set.impl&%0.len.? T2&. T2& s2!) 0)))) (and (=> %%location_label%%16 (<= (vstd!set.impl&%0.len.? T3&. T3& ret!) (nClip (Mul (vstd!set.impl&%0.len.? T1&. T1& s1!) (vstd!set.impl&%0.len.? T2&. T2& s2!))))) (=> %%location_label%%17 (vstd!set.impl&%0.finite.? T3&. T3& ret!))))))))))))
(check-sat)
(exit)
