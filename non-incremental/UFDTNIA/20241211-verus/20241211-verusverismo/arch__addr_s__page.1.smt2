...
(declare-const self! verismo!arch.addr_s.def_s.SpecAddr.)
(declare-const n! Int)
(declare-const tmp%1 Int)
(declare-const tmp%2 Bool)
(declare-const ret@ vstd!set.Set<int.>.)
(assert fuel_defaults)
(assert (has_type (Poly%verismo!arch.addr_s.def_s.SpecAddr. self!) (TYPE%verismo!arch.addr_s.def_s.SpecAddr. T&. T&)))
(assert (<= 0 n!))
...
(assert (not (=> (= tmp%1 (%I (verismo!tspec.integer.IntValue.as_int.? $ (TYPE%verismo!arch.addr_s.def_s.SpecAddr. T&. T&) (Poly%verismo!arch.addr_s.def_s.SpecAddr. self!)))) (=> (ens%verismo!tspec.range_set.lemma_to_set. tmp%1 n! ret@) (=> (ens%verismo!tspec.setlib.lemma_ret_is_empty. $ INT (Poly%vstd!set.Set<int.>. ret@) tmp%2) (=> (= ret! ret@) (and (=> %%location_label%%0 (= (vstd!set.impl&%0.len.? $ INT (Poly%vstd!set.Set<int.>. ret!)) n!)) (and (=> %%location_label%%1 (vstd!set.impl&%0.finite.? $ INT (Poly%vstd!set.Set<int.>. ret!))) (and (=> %%location_label%%2 (= ret! (verismo!tspec.range_set.range_to_set.? (verismo!tspec.integer.IntValue.as_int.? $ (TYPE%verismo!arch.addr_s.def_s.SpecAddr. T&. T&) (Poly%verismo!arch.addr_s.def_s.SpecAddr. self!)) (I n!)))) (=> %%location_label%%3 (=> (= n! 0) (vstd!set_lib.impl&%0.is_empty.? $ INT (Poly%vstd!set.Set<int.>. ret!)))))))))))))
(check-sat)
(exit)
