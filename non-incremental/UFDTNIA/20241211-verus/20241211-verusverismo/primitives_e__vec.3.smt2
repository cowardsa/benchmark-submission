...
(assert (uInv SZ i!))
(assert (and (<= 0 i!) (< i! (vstd!std_specs.vec.spec_vec_len.? T&. T& $ TYPE%alloc!alloc.Global. (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@0)))))
...
(assert (not (=> (= tmp%2 (Poly%verismo!primitives_e.vec.RemoveParam. (verismo!primitives_e.vec.RemoveParam./RemoveParam (%I (I i!))))) (and (=> %%location_label%%0 (req%verismo!vbox.vbox.MutFnTrait.box_update. $ (TYPE%verismo!vbox.vbox.VBox. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.)) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T& self!@0 tmp%2)) (=> (has_type self!@1 (TYPE%verismo!vbox.vbox.VBox. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.))) (=> (ens%verismo!vbox.vbox.MutFnTrait.box_update. $ (TYPE%verismo!vbox.vbox.VBox. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.)) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T& self!@0 self!@1 tmp%2 tmp%1) (=> (= ret! tmp%1) (and (=> %%location_label%%1 (=> (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (Poly%verismo!ptr.snp.snp_u.SwSnpMemAttr. (verismo!vbox.vbox.impl&%6.snp.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@1))) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@1)) (vstd!seq_lib.impl&%0.remove.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@0)) (I i!))))) (and (=> %%location_label%%2 (verismo!vbox.vbox.impl&%6.only_val_updated.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@1 self!@0)) (=> %%location_label%%3 (= ret! (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@0)) (I i!)))))))))))))
(check-sat)
(exit)
