...
(declare-const reverse_op_fn! %%Function%%)
...
(assert (has_type (Poly%fun%1. reverse_op_fn!) (TYPE%fun%1. T3&. T3& $ (TYPE%tuple%2. T1&. T1& T2&. T2&))))
(assert (> (vstd!set.impl&%0.len.? T1&. T1& s1!) 0))
(assert (vstd!set.impl&%0.contains.? T1&. T1& s1! vv1!))
(assert (forall ((v1$ Poly) (v2$ Poly)) (! (=> (and (has_type v1$ T1&) (has_type v2$ T2&)) (= (%Poly%tuple%2. (%%apply%%0 reverse_op_fn! (%%apply%%1 op_fn! v1$ v2$))) (tuple%2./tuple%2 v1$ v2$))) :pattern ((%%apply%%1 op_fn! v1$ v2$)))))
(declare-fun %%choose%%3 (Type Type Dcr Type Poly Dcr Type Poly %%Function%% Poly Dcr Type Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Poly) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Poly) (%%hole%%8 %%Function%%) (%%hole%%9 Poly) (%%hole%%10 Dcr) (%%hole%%11 Type) (%%hole%%12 Poly) (%%hole%%13 Dcr) (%%hole%%14 Type) (%%hole%%15 Poly)) (! (=> (exists ((v1$ Poly) (v2$ Poly)) (! (and (has_type v1$ %%hole%%0) (has_type v2$ %%hole%%1) (and (and (vstd!set.impl&%0.contains.? %%hole%%2 %%hole%%3 %%hole%%4 v1$) (vstd!set.impl&%0.contains.? %%hole%%5 %%hole%%6 %%hole%%7 v2$)) (= %%hole%%9 (%%apply%%1 %%hole%%8 v1$ v2$)))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%10 %%hole%%11 %%hole%%12 v1$) (vstd!set.impl&%0.contains.? %%hole%%13 %%hole%%14 %%hole%%15 v2$)))) (exists ((v1$ Poly) (v2$ Poly)) (! (and (and (has_type v1$ %%hole%%0) (has_type v2$ %%hole%%1) (and (and (vstd!set.impl&%0.contains.? %%hole%%2 %%hole%%3 %%hole%%4 v1$) (vstd!set.impl&%0.contains.? %%hole%%5 %%hole%%6 %%hole%%7 v2$)) (= %%hole%%9 (%%apply%%1 %%hole%%8 v1$ v2$)))) (= (%%choose%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15) (Poly%tuple%2. (tuple%2./tuple%2 v1$ v2$)))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%10 %%hole%%11 %%hole%%12 v1$) (vstd!set.impl&%0.contains.? %%hole%%13 %%hole%%14 %%hole%%15 v2$))))) :pattern ((%%choose%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15)))))
(declare-fun %%choose%%4 (Type Dcr Type Poly %%Function%% Poly Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4 %%Function%%) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((v2$2 Poly)) (! (and (has_type v2$2 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 v2$2) (= %%hole%%6 (%%apply%%1 %%hole%%4 %%hole%%5 v2$2)))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%7 %%hole%%8 %%hole%%9 v2$2)))) (exists ((v2$2 Poly)) (! (and (and (has_type v2$2 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 v2$2) (= %%hole%%6 (%%apply%%1 %%hole%%4 %%hole%%5 v2$2)))) (= (%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) v2$2)) :pattern ((vstd!set.impl&%0.contains.? %%hole%%7 %%hole%%8 %%hole%%9 v2$2))))) :pattern ((%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
...
(assert (not (=> (= ss1@ (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!)) (=> (= r1@ (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& ss1@ T2&. T2& s2! T1& T2& T1&. T1& ss1@ T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (=> (= r2@ (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. (Poly%fun%2. op_fn!)) vv1!))))))))) (and (=> (has_type val@ T3&) (or (and (=> (vstd!set.impl&%0.contains.? T3&. T3& r1@ val@) (=> (= tmp%%@ (%Poly%tuple%2. (as_type (%%choose%%3 T1& T2& T1&. T1& ss1@ T2&. T2& s2! op_fn! val@ T1&. T1& ss1@ T2&. T2& s2!) (TYPE%tuple%2. T1&. T1& T2&. T2&)))) (=> (= v1@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= v2@ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= tmp%1 (vstd!set.impl&%0.contains.? T1&. T1& ss1@ v1@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (not (= vv1! v1@))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (= (%%apply%%1 op_fn! v1@ v2@) val@)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (ext_eq false (TYPE%tuple%2. T1&. T1& T2&. T2&) (Poly%tuple%2. (%Poly%tuple%2. (%%apply%%0 reverse_op_fn! val@))) (Poly%tuple%2. (tuple%2./tuple%2 v1@ v2@)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 %%switch_label%%1)))))))))))))))) (=> (not (vstd!set.impl&%0.contains.? T3&. T3& r1@ val@)) %%switch_label%%1)) (and (not %%switch_label%%1) (or (and (=> (vstd!set.impl&%0.contains.? T3&. T3& r2@ val@) (=> (= v2$1@ (as_type (%%choose%%4 T2& T2&. T2& s2! op_fn! vv1! val@ T2&. T2& s2!) T2&)) (=> (= tmp%5 (ext_eq false (TYPE%tuple%2. T1&. T1& T2&. T2&) (Poly%tuple%2. (%Poly%tuple%2. (%%apply%%0 reverse_op_fn! val@))) (Poly%tuple%2. (tuple%2./tuple%2 vv1! v2$1@)))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 %%switch_label%%0))))) (=> (not (vstd!set.impl&%0.contains.? T3&. T3& r2@ val@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%5 (and (=> (vstd!set.impl&%0.contains.? T3&. T3& r1@ val@) (not (vstd!set.impl&%0.contains.? T3&. T3& r2@ val@))) (=> (vstd!set.impl&%0.contains.? T3&. T3& r2@ val@) (not (vstd!set.impl&%0.contains.? T3&. T3& r1@ val@)))))))))) (=> (forall ((val$ Poly)) (! (=> (has_type val$ T3&) (and (=> (vstd!set.impl&%0.contains.? T3&. T3& r1@ val$) (not (vstd!set.impl&%0.contains.? T3&. T3& r2@ val$))) (=> (vstd!set.impl&%0.contains.? T3&. T3& r2@ val$) (not (vstd!set.impl&%0.contains.? T3&. T3& r1@ val$))))) :pattern ((vstd!set.impl&%0.contains.? T3&. T3& r1@ val$)) :pattern ((vstd!set.impl&%0.contains.? T3&. T3& r2@ val$)))) (=> %%location_label%%6 (vstd!set.impl&%0.disjoint.? T3&. T3& (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. (Poly%fun%2. op_fn!)) vv1!)))))))) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! T1& T2& T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!)))))))))))))))
(check-sat)
(exit)
