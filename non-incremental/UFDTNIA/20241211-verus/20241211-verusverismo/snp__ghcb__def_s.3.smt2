...
(set-info :comment ";; Function-Specs verismo::snp::ghcb::def_s::SvmStatus::from_u64")
(declare-fun ens%verismo!snp.ghcb.def_s.impl&%6.from_u64. (Int core!option.Option.) Bool)
(assert (forall ((val! Int) (ret! core!option.Option.)) (! (= (ens%verismo!snp.ghcb.def_s.impl&%6.from_u64. val! ret!) (and (has_type (Poly%core!option.Option. ret!) (TYPE%core!option.Option. $ TYPE%verismo!snp.ghcb.def_s.SvmStatus.)) (= ret! (verismo!snp.ghcb.def_s.impl&%6.spec_from_int.? (I val!))))) :pattern ((ens%verismo!snp.ghcb.def_s.impl&%6.from_u64. val! ret!)))))
(set-info :comment ";; Function-Def verismo::snp::ghcb::def_s::SvmStatus::from_u64")
(set-info :comment ";; verismo/src/snp/ghcb/def_s.rs:7:25: 7:36 (#20591)")
...
(assert (not (=> (= ret! (ite (= val! 0) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./Ok)) (ite (= val! 1) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./Unsupported)) (ite (= val! 2) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./VmmError)) (ite (= val! 3) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./DecodeFailed)) (ite (= val! 4) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./Exception)) (ite (= val! 5) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./Retry)) core!option.Option./None))))))) (=> %%location_label%%0 (= ret! (verismo!snp.ghcb.def_s.impl&%6.spec_from_int.? (I val!)))))))
(check-sat)
(exit)
