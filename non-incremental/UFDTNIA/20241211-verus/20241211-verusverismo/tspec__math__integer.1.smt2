...
(declare-const nbits! Poly)
(declare-const round! Poly)
...
(assert (has_type input! (UINT 64)))
(assert (has_type nbits! (UINT 64)))
(assert (has_type round! (UINT 64)))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (Sub 6 (%I round!))) (or (and (=> (< (%I round!) 6) (=> (= t@ (uClip 64 (uintor 64 (I (%I input!)) (I (uClip 64 (uintshr 64 (I (%I input!)) (I (%I nbits!)))))))) (=> (= tmp%2 (I (uClip 64 (uintshl 64 (I 1) (I (uClip 64 (uClip 64 (Add (%I round!) 1)))))))) (=> (= tmp%3 (I (uClip 64 (Add (%I round!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((input!$0 (I t@)) (nbits!$1 tmp%2) (round!$2 tmp%3)) (Sub 6 (%I round!$2))) decrease%init0 false)) (=> (uInv 64 tmp%1) (=> (= tmp%1 (verismo!tspec.math.integer._fill_ones.? (I t@) (I (uClip 64 (uintshl 64 (I 1) (I (uClip 64 (uClip 64 (Add (%I round!) 1))))))) (I (uClip 64 (Add (%I round!) 1))))) (=> (= tmp%4 tmp%1) %%switch_label%%0)))))))) (=> (not (< (%I round!) 6)) (=> (= tmp%4 (%I input!)) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)
