...
(set-info :comment ";; MODULE 'module tspec::size_s'")
...
(set-info :comment ";; Function-Specs verismo::tspec::size_s::proof_bytes_len")
(declare-fun req%verismo!tspec.size_s.proof_bytes_len. (Int vstd!seq.Seq<u8.>.) Bool)
(declare-const %%global_location_label%%49 Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (req%verismo!tspec.size_s.proof_bytes_len. data! s!) (=> %%global_location_label%%49 (ext_eq true (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s!) (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 64) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (I data!))))) :pattern ((req%verismo!tspec.size_s.proof_bytes_len. data! s!)))))
(declare-fun ens%verismo!tspec.size_s.proof_bytes_len. (Int vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (ens%verismo!tspec.size_s.proof_bytes_len. data! s!) (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s!)) 8)) :pattern ((ens%verismo!tspec.size_s.proof_bytes_len. data! s!)))))
(set-info :comment ";; Function-Def verismo::tspec::size_s::proof_bytes_len")
(set-info :comment ";; verismo/src/tspec/size_s.rs:148:1: 148:52 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::size_s::proof_bytes_len4")
(declare-fun req%verismo!tspec.size_s.proof_bytes_len4. (Int vstd!seq.Seq<u8.>.) Bool)
(declare-const %%global_location_label%%50 Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (req%verismo!tspec.size_s.proof_bytes_len4. data! s!) (=> %%global_location_label%%50 (ext_eq true (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s!) (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 32) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (I data!))))) :pattern ((req%verismo!tspec.size_s.proof_bytes_len4. data! s!)))))
(declare-fun ens%verismo!tspec.size_s.proof_bytes_len4. (Int vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (ens%verismo!tspec.size_s.proof_bytes_len4. data! s!) (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s!)) 4)) :pattern ((ens%verismo!tspec.size_s.proof_bytes_len4. data! s!)))))
(set-info :comment ";; Function-Def verismo::tspec::size_s::proof_bytes_len4")
(set-info :comment ";; verismo/src/tspec/size_s.rs:156:1: 156:53 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::size_s::proof_bytes_len2")
(declare-fun req%verismo!tspec.size_s.proof_bytes_len2. (Int vstd!seq.Seq<u8.>.) Bool)
(declare-const %%global_location_label%%51 Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (req%verismo!tspec.size_s.proof_bytes_len2. data! s!) (=> %%global_location_label%%51 (ext_eq true (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s!) (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 16) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (I data!))))) :pattern ((req%verismo!tspec.size_s.proof_bytes_len2. data! s!)))))
(declare-fun ens%verismo!tspec.size_s.proof_bytes_len2. (Int vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (ens%verismo!tspec.size_s.proof_bytes_len2. data! s!) (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s!)) 2)) :pattern ((ens%verismo!tspec.size_s.proof_bytes_len2. data! s!)))))
(set-info :comment ";; Function-Def verismo::tspec::size_s::proof_bytes_len2")
(set-info :comment ";; verismo/src/tspec/size_s.rs:164:1: 164:53 (#0)")
(declare-const data! Int)
(declare-const s! vstd!seq.Seq<u8.>.)
(assert fuel_defaults)
(assert (uInv 16 data!))
(assert (ext_eq true (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s!) (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 16) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (I data!))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s!)) 2))))
(check-sat)
(exit)
