...
(assert (not (=> %%location_label%%0 (= (verismo!snp.cpu.gdt.impl&%50.spec_new.? (I (verismo!snp.cpu.gdt.Descriptor./Descriptor/value (%Poly%verismo!snp.cpu.gdt.Descriptor. (Poly%verismo!snp.cpu.gdt.Descriptor. self!))))) self!))))
(check-sat)
(exit)
