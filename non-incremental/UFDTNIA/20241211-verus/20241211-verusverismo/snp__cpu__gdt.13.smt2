...
(assert (not (=> (= tmp%1 (verismo!snp.cpu.gdt.impl&%16.inv.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. self!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= ret! (verismo!snp.cpu.gdt.DescriptorAttr0_7./DescriptorAttr0_7/value (%Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. self!)))) (and (=> %%location_label%%1 (= ret! (verismo!snp.cpu.gdt.DescriptorAttr0_7./DescriptorAttr0_7/value (%Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. self!))))) (=> %%location_label%%2 (<= (verismo!snp.cpu.gdt.DescriptorAttr0_7./DescriptorAttr0_7/value (%Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. self!))) (uClip 64 127))))))))))
(check-sat)
(exit)
