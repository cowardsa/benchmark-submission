...
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:100:1: 100:60 (#0)")
...
(set-info :comment ";; Function-Def verismo::tspec::math::nonlinear::proof_mul_div_rel")
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:100:1: 100:60 (#0)")
...
(assert (not (=> (= ret! (Mul a! b!)) (and (=> %%location_label%%0 (= ret! (Mul a! b!))) (=> %%location_label%%1 (= (EucDiv ret! b!) a!))))))
(check-sat)
(exit)
