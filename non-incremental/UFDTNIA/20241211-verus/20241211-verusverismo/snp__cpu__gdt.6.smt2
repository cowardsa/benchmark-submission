...
(assert (not (=> (= tmp%1 (verismo!snp.cpu.gdt.impl&%50.inv.? (Poly%verismo!snp.cpu.gdt.Descriptor. self!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= ret! (verismo!snp.cpu.gdt.Descriptor./Descriptor/value (%Poly%verismo!snp.cpu.gdt.Descriptor. (Poly%verismo!snp.cpu.gdt.Descriptor. self!)))) (and (=> %%location_label%%1 (= ret! (verismo!snp.cpu.gdt.Descriptor./Descriptor/value (%Poly%verismo!snp.cpu.gdt.Descriptor. (Poly%verismo!snp.cpu.gdt.Descriptor. self!))))) (=> %%location_label%%2 (<= (verismo!snp.cpu.gdt.Descriptor./Descriptor/value (%Poly%verismo!snp.cpu.gdt.Descriptor. (Poly%verismo!snp.cpu.gdt.Descriptor. self!))) (uClip 64 18446744073709551615))))))))))
(check-sat)
(exit)
