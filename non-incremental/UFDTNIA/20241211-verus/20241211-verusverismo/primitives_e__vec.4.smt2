...
(set-info :comment ";; MODULE 'module primitives_e::vec'")
...
(declare-const fuel%verismo!primitives_e.vec.impl&%5.spec_update_requires. FuelId)
(declare-const fuel%verismo!primitives_e.vec.impl&%5.spec_update. FuelId)
...
(declare-fun verismo!primitives_e.vec.RemoveParam./RemoveParam/i (verismo!primitives_e.vec.RemoveParam.) Int)
...
(declare-const TYPE%verismo!primitives_e.vec.RemoveParam. Type)
...
(declare-fun Poly%verismo!primitives_e.vec.RemoveParam. (verismo!primitives_e.vec.RemoveParam.) Poly)
(declare-fun %Poly%verismo!primitives_e.vec.RemoveParam. (Poly) verismo!primitives_e.vec.RemoveParam.)
...
(assert (forall ((x verismo!primitives_e.vec.RemoveParam.)) (! (= x (%Poly%verismo!primitives_e.vec.RemoveParam. (Poly%verismo!primitives_e.vec.RemoveParam. x))) :pattern ((Poly%verismo!primitives_e.vec.RemoveParam. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%verismo!primitives_e.vec.RemoveParam.) (= x (Poly%verismo!primitives_e.vec.RemoveParam. (%Poly%verismo!primitives_e.vec.RemoveParam. x)))) :pattern ((has_type x TYPE%verismo!primitives_e.vec.RemoveParam.)))))
(assert (forall ((_i! Int)) (! (=> (uInv SZ _i!) (has_type (Poly%verismo!primitives_e.vec.RemoveParam. (verismo!primitives_e.vec.RemoveParam./RemoveParam _i!)) TYPE%verismo!primitives_e.vec.RemoveParam.)) :pattern ((has_type (Poly%verismo!primitives_e.vec.RemoveParam. (verismo!primitives_e.vec.RemoveParam./RemoveParam _i!)) TYPE%verismo!primitives_e.vec.RemoveParam.)))))
(assert (forall ((x verismo!primitives_e.vec.RemoveParam.)) (! (= (verismo!primitives_e.vec.RemoveParam./RemoveParam/i x) (verismo!primitives_e.vec.RemoveParam./RemoveParam/?i x)) :pattern ((verismo!primitives_e.vec.RemoveParam./RemoveParam/i x)))))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%verismo!primitives_e.vec.RemoveParam.) (uInv SZ (verismo!primitives_e.vec.RemoveParam./RemoveParam/i (%Poly%verismo!primitives_e.vec.RemoveParam. x)))) :pattern ((verismo!primitives_e.vec.RemoveParam./RemoveParam/i (%Poly%verismo!primitives_e.vec.RemoveParam. x)) (has_type x TYPE%verismo!primitives_e.vec.RemoveParam.)))))
...
(set-info :comment ";; Function-Decl verismo::vbox::vbox::spec_box_size")
(declare-fun verismo!vbox.vbox.spec_box_size.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::vbox::vbox::VBox::view")
(declare-fun verismo!vbox.vbox.impl&%6.view.? (Dcr Type Poly) Poly)
(set-info :comment ";; Function-Decl verismo::vbox::vbox::VBox::id")
(declare-fun verismo!vbox.vbox.impl&%6.id.? (Dcr Type Poly) Int)
(set-info :comment ";; Function-Decl verismo::vbox::vbox::VBox::snp")
(declare-fun verismo!vbox.vbox.impl&%6.snp.? (Dcr Type Poly) verismo!ptr.snp.snp_u.SwSnpMemAttr.)
(set-info :comment ";; Function-Decl verismo::vbox::vbox::VBox::only_val_updated")
(declare-fun verismo!vbox.vbox.impl&%6.only_val_updated.? (Dcr Type Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::vbox::vbox::MutFnTrait::spec_update_requires")
...
(set-info :comment ";; Function-Decl verismo::vbox::vbox::MutFnTrait::spec_update")
...
(assert (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type) (pre%vec! Poly) (i! Int)) (! (= (req%alloc!vec.impl&%1.remove. T&. T& A&. A& pre%vec! i!) (=> %%global_location_label%%5 (< i! (vstd!std_specs.vec.spec_vec_len.? T&. T& A&. A& pre%vec!)))) :pattern ((req%alloc!vec.impl&%1.remove. T&. T& A&. A& pre%vec! i!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (self! Poly)) (! (= (req%vstd!seq.Seq.last. A&. A& self!) (=> %%global_location_label%%30 (< 0 (vstd!seq.Seq.len.? A&. A& self!)))) :pattern ((req%vstd!seq.Seq.last. A&. A& self!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (! (= (req%vstd!set.axiom_set_insert_different. A&. A& s! a1! a2!) (=> %%global_location_label%%31 (not (= a1! a2!)))) :pattern ((req%vstd!set.axiom_set_insert_different. A&. A& s! a1! a2!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_remove_insert. A&. A& s! a!) (=> %%global_location_label%%32 (vstd!set.impl&%0.contains.? A&. A& s! a!))) :pattern ((req%vstd!set.axiom_set_remove_insert. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (! (= (req%vstd!set.axiom_set_remove_different. A&. A& s! a1! a2!) (=> %%global_location_label%%33 (not (= a1! a2!)))) :pattern ((req%vstd!set.axiom_set_remove_different. A&. A& s! a1! a2!)))))
...
(assert (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! %%Function%%) (key! Poly)) (! (= (req%vstd!set.axiom_mk_map_index. K&. K& V&. V& s! f! key!) (=> %%global_location_label%%34 (vstd!set.impl&%0.contains.? K&. K& s! key!))) :pattern ((req%vstd!set.axiom_mk_map_index. K&. K& V&. V& s! f! key!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_insert_finite. A&. A& s! a!) (=> %%global_location_label%%35 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%vstd!set.axiom_set_insert_finite. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_remove_finite. A&. A& s! a!) (=> %%global_location_label%%36 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%vstd!set.axiom_set_remove_finite. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (! (= (req%vstd!set.axiom_set_union_finite. A&. A& s1! s2!) (and (=> %%global_location_label%%37 (vstd!set.impl&%0.finite.? A&. A& s1!)) (=> %%global_location_label%%38 (vstd!set.impl&%0.finite.? A&. A& s2!)))) :pattern ((req%vstd!set.axiom_set_union_finite. A&. A& s1! s2!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (! (= (req%vstd!set.axiom_set_intersect_finite. A&. A& s1! s2!) (=> %%global_location_label%%39 (or (vstd!set.impl&%0.finite.? A&. A& s1!) (vstd!set.impl&%0.finite.? A&. A& s2!)))) :pattern ((req%vstd!set.axiom_set_intersect_finite. A&. A& s1! s2!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (! (= (req%vstd!set.axiom_set_difference_finite. A&. A& s1! s2!) (=> %%global_location_label%%40 (vstd!set.impl&%0.finite.? A&. A& s1!))) :pattern ((req%vstd!set.axiom_set_difference_finite. A&. A& s1! s2!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly)) (! (= (req%vstd!set.axiom_set_choose_finite. A&. A& s!) (=> %%global_location_label%%41 (not (vstd!set.impl&%0.finite.? A&. A& s!)))) :pattern ((req%vstd!set.axiom_set_choose_finite. A&. A& s!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_insert_len. A&. A& s! a!) (=> %%global_location_label%%42 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%vstd!set.axiom_set_insert_len. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_remove_len. A&. A& s! a!) (=> %%global_location_label%%43 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%vstd!set.axiom_set_remove_len. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_contains_len. A&. A& s! a!) (and (=> %%global_location_label%%44 (vstd!set.impl&%0.finite.? A&. A& s!)) (=> %%global_location_label%%45 (vstd!set.impl&%0.contains.? A&. A& s! a!)))) :pattern ((req%vstd!set.axiom_set_contains_len. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly)) (! (= (req%vstd!set.axiom_set_choose_len. A&. A& s!) (and (=> %%global_location_label%%46 (vstd!set.impl&%0.finite.? A&. A& s!)) (=> %%global_location_label%%47 (not (= (vstd!set.impl&%0.len.? A&. A& s!) 0))))) :pattern ((req%vstd!set.axiom_set_choose_len. A&. A& s!)))))
...
(assert (forall ((self! Poly) (vmpl! Poly)) (! (= (req%verismo!arch.rmp.entry_s.impl&%0.is_confidential_to. self! vmpl!) (=> %%global_location_label%%48 (and (< 0 (%I vmpl!)) (<= (%I vmpl!) 4)))) :pattern ((req%verismo!arch.rmp.entry_s.impl&%0.is_confidential_to. self! vmpl!)))))
...
(assert (forall ((self! Poly)) (! (= (req%verismo!ptr.raw_ptr_s.impl&%5.bytes. self!) (=> %%global_location_label%%49 (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)))) :pattern ((req%verismo!ptr.raw_ptr_s.impl&%5.bytes. self!)))))
...
(declare-fun %%lambda%%12 (Dcr Type Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (v$ Poly)) (! (= (%%apply%%0 (%%lambda%%12 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) v$) (verismo!tspec.cast.VTypeCast.vspec_cast_to.? %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 v$)) :pattern ((%%apply%%0 (%%lambda%%12 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) v$)))))
(assert (=> (fuel_bool fuel%verismo!tspec.cast.fn_vspec_cast_to.) (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type)) (! (= (verismo!tspec.cast.fn_vspec_cast_to.? T1&. T1& T2&. T2&) (mk_fun (%%lambda%%12 T1&. T1& T2&. T2&))) :pattern ((verismo!tspec.cast.fn_vspec_cast_to.? T1&. T1& T2&. T2&))))))
...
(assert (forall ((V&. Dcr) (V& Type) (self! Poly)) (! (= (req%verismo!ptr.ptr_u.impl&%2.value. V&. V& self!) (=> %%global_location_label%%50 (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (verismo!ptr.snp.snp_u.SnpMemAttrTrait.hw_snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!)))) :pattern ((req%verismo!ptr.ptr_u.impl&%2.value. V&. V& self!)))))
...
(declare-fun %%lambda%%13 (Dcr Type Poly Dcr Type Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Dcr) (%%hole%%6 Type) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%13 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6) i$) (Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.impl&%16.constant.? %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 (vstd!seq.Seq.index.? %%hole%%0 %%hole%%1 %%hole%%2 i$)))) :pattern ((%%apply%%0 (%%lambda%%13 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6) i$)))))
(assert (=> (fuel_bool fuel%verismo!primitives_e.seq.impl&%4.vspec_cast_to.) (forall ((self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT SZ) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!) (let ((seq$ (%Poly%vstd!seq.Seq<u8.>. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT SZ) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) self!)))) (vstd!seq.Seq.new.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) $ (TYPE%fun%1. $ INT $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$))) (Poly%fun%1. (mk_fun (%%lambda%%13 $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$) $ (UINT 8) $ TYPE%tuple%0.)))))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT SZ) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!))))))
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::spec_box_size")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::VBox::view")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::VBox::snp")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::MutFnTrait::spec_update_requires")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::MutFnTrait::spec_update")
...
(set-info :comment ";; Function-Axioms alloc::vec::Vec::is_constant")
...
(set-info :comment ";; Function-Axioms alloc::vec::Vec::is_constant_to")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::VBox::is_constant")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::VBox::is_constant_to")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::VBox::wf")
...
(assert (=> (fuel_bool fuel%verismo!primitives_e.seq.impl&%7.vspec_cast_to.) (forall ((self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 64) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!) (let ((seq$ (%Poly%vstd!seq.Seq<u8.>. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 64) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) self!)))) (vstd!seq.Seq.new.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) $ (TYPE%fun%1. $ INT $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$))) (Poly%fun%1. (mk_fun (%%lambda%%13 $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$) $ (UINT 8) $ TYPE%tuple%0.)))))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 64) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!))))))
...
(assert (=> (fuel_bool fuel%verismo!primitives_e.seq.impl&%6.vspec_cast_to.) (forall ((self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 32) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!) (let ((seq$ (%Poly%vstd!seq.Seq<u8.>. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 32) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) self!)))) (vstd!seq.Seq.new.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) $ (TYPE%fun%1. $ INT $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$))) (Poly%fun%1. (mk_fun (%%lambda%%13 $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$) $ (UINT 8) $ TYPE%tuple%0.)))))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 32) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!))))))
...
(set-info :comment ";; Function-Axioms alloc::vec::Vec::vspec_cast_to")
...
(assert (=> (fuel_bool fuel%verismo!primitives_e.seq.impl&%3.vspec_cast_to.) (forall ((self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 8) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!) (let ((seq$ (%Poly%vstd!seq.Seq<u8.>. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 8) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) self!)))) (vstd!seq.Seq.new.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) $ (TYPE%fun%1. $ INT $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$))) (Poly%fun%1. (mk_fun (%%lambda%%13 $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$) $ (UINT 8) $ TYPE%tuple%0.)))))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 8) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!))))))
...
(assert (=> (fuel_bool fuel%verismo!primitives_e.seq.impl&%5.vspec_cast_to.) (forall ((self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 16) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!) (let ((seq$ (%Poly%vstd!seq.Seq<u8.>. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 16) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) self!)))) (vstd!seq.Seq.new.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) $ (TYPE%fun%1. $ INT $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$))) (Poly%fun%1. (mk_fun (%%lambda%%13 $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$) $ (UINT 8) $ TYPE%tuple%0.)))))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 16) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!))))))
(set-info :comment ";; Function-Axioms alloc::vec::Vec::wf")
...
(set-info :comment ";; Function-Axioms alloc::vec::Vec::spec_update_requires")
...
(set-info :comment ";; Function-Axioms alloc::vec::Vec::spec_update")
...
(set-info :comment ";; Function-Axioms alloc::vec::Vec::spec_update_requires")
(assert (fuel_bool_default fuel%verismo!primitives_e.vec.impl&%5.spec_update_requires.))
(assert (=> (fuel_bool fuel%verismo!primitives_e.vec.impl&%5.spec_update_requires.) (forall ((T&. Dcr) (T& Type) (self! Poly) (params! Poly)) (! (= (verismo!vbox.vbox.MutFnTrait.spec_update_requires.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T& self! params!) (B (let ((tmp%%$ (verismo!primitives_e.vec.RemoveParam./RemoveParam/i (%Poly%verismo!primitives_e.vec.RemoveParam. params!)))) (and (<= 0 tmp%%$) (< tmp%%$ (vstd!std_specs.vec.spec_vec_len.? T&. T& $ TYPE%alloc!alloc.Global. self!)))))) :pattern ((verismo!vbox.vbox.MutFnTrait.spec_update_requires.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T& self! params!))))))
(set-info :comment ";; Function-Axioms alloc::vec::Vec::spec_update")
(assert (fuel_bool_default fuel%verismo!primitives_e.vec.impl&%5.spec_update.))
(assert (=> (fuel_bool fuel%verismo!primitives_e.vec.impl&%5.spec_update.) (forall ((T&. Dcr) (T& Type) (self! Poly) (prev! Poly) (params! Poly) (ret! Poly)) (! (= (verismo!vbox.vbox.MutFnTrait.spec_update.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T& self! prev! params! ret!) (B (let ((i$ (verismo!primitives_e.vec.RemoveParam./RemoveParam/i (%Poly%verismo!primitives_e.vec.RemoveParam. params!)))) (and (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!) (vstd!seq_lib.impl&%0.remove.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) prev!) (I i$))) (= ret! (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) prev!) (I i$))))))) :pattern ((verismo!vbox.vbox.MutFnTrait.spec_update.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T& self! prev! params! ret!))))))
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::VBox::spec_size_def")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::VBox::only_val_updated")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::VBox::spec_update_requires")
...
(set-info :comment ";; Function-Axioms verismo::vbox::vbox::VBox::spec_update")
...
(set-info :comment ";; Function-Def alloc::vec::Vec::box_update")
(set-info :comment ";; verismo/src/primitives_e/vec.rs:47:5: 47:68 (#0)")
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Function-Def alloc::vec::Vec::box_update")
(set-info :comment ";; verismo/src/primitives_e/vec.rs:68:5: 68:64 (#0)")
(set-info :comment ";; Trait-Impl-Axiom")
(assert (forall ((T&. Dcr) (T& Type)) (! (tr_bound%verismo!vbox.vbox.MutFnTrait. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T&) :pattern ((tr_bound%verismo!vbox.vbox.MutFnTrait. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T&)))))
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Trait-Impl-Axiom")
(assert (forall ((T&. Dcr) (T& Type)) (! (tr_bound%verismo!tspec.size_s.SpecSize. $ (TYPE%verismo!vbox.vbox.VBox. T&. T&)) :pattern ((tr_bound%verismo!tspec.size_s.SpecSize. $ (TYPE%verismo!vbox.vbox.VBox. T&. T&))))))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (forall ((T&. Dcr) (T& Type)) (! (tr_bound%verismo!tspec.cast.VTypeCast. $ (TYPE%verismo!vbox.vbox.VBox. T&. T&) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.))) :pattern ((tr_bound%verismo!tspec.cast.VTypeCast. $ (TYPE%verismo!vbox.vbox.VBox. T&. T&) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)))))))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (forall ((Params&. Dcr) (Params& Type) (Out&. Dcr) (Out& Type) (T&. Dcr) (T& Type)) (! (=> (tr_bound%verismo!vbox.vbox.MutFnTrait. T&. T& Params&. Params& Out&. Out&) (tr_bound%verismo!vbox.vbox.MutFnTrait. $ (TYPE%verismo!vbox.vbox.VBox. T&. T&) Params&. Params& Out&. Out&)) :pattern ((tr_bound%verismo!vbox.vbox.MutFnTrait. $ (TYPE%verismo!vbox.vbox.VBox. T&. T&) Params&. Params& Out&. Out&)))))
...
(assert (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (! (= (req%vstd!seq_lib.impl&%0.add_empty_right. A&. A& a! b!) (=> %%global_location_label%%52 (= (vstd!seq.Seq.len.? A&. A& b!) 0))) :pattern ((req%vstd!seq_lib.impl&%0.add_empty_right. A&. A& a! b!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (! (= (req%vstd!seq_lib.impl&%0.add_empty_left. A&. A& a! b!) (=> %%global_location_label%%53 (= (vstd!seq.Seq.len.? A&. A& a!) 0))) :pattern ((req%vstd!seq_lib.impl&%0.add_empty_left. A&. A& a! b!)))))
...
(set-info :comment ";; Function-Specs verismo::ptr::snp::snp_u::RmpAttr::lemma_new_eq")
(declare-fun ens%verismo!ptr.snp.snp_u.impl&%16.lemma_new_eq. (verismo!ptr.snp.snp_u.RmpAttr.) Bool)
(assert (forall ((self! verismo!ptr.snp.snp_u.RmpAttr.)) (! (= (ens%verismo!ptr.snp.snp_u.impl&%16.lemma_new_eq. self!) (= (verismo!ptr.snp.snp_u.impl&%16.spec_new.? (I (verismo!ptr.snp.snp_u.RmpAttr./RmpAttr/value (%Poly%verismo!ptr.snp.snp_u.RmpAttr. (Poly%verismo!ptr.snp.snp_u.RmpAttr. self!))))) self!)) :pattern ((ens%verismo!ptr.snp.snp_u.impl&%16.lemma_new_eq. self!)))))
(set-info :comment ";; Broadcast verismo::ptr::snp::snp_u::RmpAttr::lemma_new_eq")
(assert (=> (fuel_bool fuel%verismo!ptr.snp.snp_u.impl&%16.lemma_new_eq.) (forall ((self! Poly)) (! (=> (has_type self! TYPE%verismo!ptr.snp.snp_u.RmpAttr.) (= (verismo!ptr.snp.snp_u.impl&%16.spec_new.? (I (verismo!ptr.snp.snp_u.RmpAttr./RmpAttr/value (%Poly%verismo!ptr.snp.snp_u.RmpAttr. self!)))) (%Poly%verismo!ptr.snp.snp_u.RmpAttr. self!))) :pattern ((verismo!ptr.snp.snp_u.impl&%16.spec_new.? (I (verismo!ptr.snp.snp_u.RmpAttr./RmpAttr/value (%Poly%verismo!ptr.snp.snp_u.RmpAttr. self!)))))))))
...
(assert (forall ((T&. Dcr) (T& Type) (F&. Dcr) (F& Type) (prev_val! Poly) (val! Poly) (offset! Int) (f! Poly)) (! (= (req%verismo!tspec.cast.proof_field_set_constant. T&. T& F&. F& prev_val! val! offset! f!) (and (=> %%global_location_label%%54 (< offset! (verismo!tspec.size_s.spec_size.? T&. T&))) (=> %%global_location_label%%55 (%B (verismo!tspec.isconst.IsConstant.is_constant.? F&. F& f!))) (=> %%global_location_label%%56 (%B (verismo!tspec.isconst.IsConstant.is_constant.? T&. T& prev_val!))) (=> %%global_location_label%%57 (verismo!tspec.cast.field_set.? T&. T& F&. F& prev_val! val! (I offset!) f!)))) :pattern ((req%verismo!tspec.cast.proof_field_set_constant. T&. T& F&. F& prev_val! val! offset! f!)))))
...
(set-info :comment ";; Function-Specs verismo::vbox::vbox::VBox::remove")
(declare-fun req%verismo!primitives_e.vec.impl&%6.remove. (Dcr Type Poly Int) Bool)
(declare-const %%global_location_label%%58 Bool)
(assert (forall ((T&. Dcr) (T& Type) (pre%self! Poly) (i! Int)) (! (= (req%verismo!primitives_e.vec.impl&%6.remove. T&. T& pre%self! i!) (=> %%global_location_label%%58 (and (<= 0 i!) (< i! (vstd!std_specs.vec.spec_vec_len.? T&. T& $ TYPE%alloc!alloc.Global. (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) pre%self!)))))) :pattern ((req%verismo!primitives_e.vec.impl&%6.remove. T&. T& pre%self! i!)))))
(declare-fun ens%verismo!primitives_e.vec.impl&%6.remove. (Dcr Type Poly Poly Int Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (pre%self! Poly) (self! Poly) (i! Int) (ret! Poly)) (! (= (ens%verismo!primitives_e.vec.impl&%6.remove. T&. T& pre%self! self! i! ret!) (and (has_type ret! T&) (has_type self! (TYPE%verismo!vbox.vbox.VBox. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.))) (=> (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (Poly%verismo!ptr.snp.snp_u.SwSnpMemAttr. (verismo!vbox.vbox.impl&%6.snp.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!))) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!)) (vstd!seq_lib.impl&%0.remove.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) pre%self!)) (I i!)))) (verismo!vbox.vbox.impl&%6.only_val_updated.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self! pre%self!) (= ret! (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) pre%self!)) (I i!))))) :pattern ((ens%verismo!primitives_e.vec.impl&%6.remove. T&. T& pre%self! self! i! ret!)))))
(set-info :comment ";; Function-Def verismo::vbox::vbox::VBox::remove")
(set-info :comment ";; verismo/src/primitives_e/vec.rs:74:5: 74:50 (#0)")
(set-info :comment ";; Function-Specs verismo::vbox::vbox::VBox::push")
(declare-fun ens%verismo!primitives_e.vec.impl&%6.push. (Dcr Type Poly Poly Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (pre%self! Poly) (self! Poly) (val! Poly)) (! (= (ens%verismo!primitives_e.vec.impl&%6.push. T&. T& pre%self! self! val!) (and (has_type self! (TYPE%verismo!vbox.vbox.VBox. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.))) (=> (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (Poly%verismo!ptr.snp.snp_u.SwSnpMemAttr. (verismo!vbox.vbox.impl&%6.snp.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!))) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!)) (vstd!seq.Seq.push.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) pre%self!)) val!))) (verismo!vbox.vbox.impl&%6.only_val_updated.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self! pre%self!))) :pattern ((ens%verismo!primitives_e.vec.impl&%6.push. T&. T& pre%self! self! val!)))))
(set-info :comment ";; Function-Def verismo::vbox::vbox::VBox::push")
(set-info :comment ";; verismo/src/primitives_e/vec.rs:85:5: 85:35 (#0)")
(declare-const T&. Dcr)
...
(assert (has_type self!@0 (TYPE%verismo!vbox.vbox.VBox. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.))))
(assert (has_type val! T&))
...
(assert (not (=> (= tmp%2 (Poly%verismo!primitives_e.vec.PushParam. (verismo!primitives_e.vec.PushParam./PushParam val!))) (and (=> %%location_label%%0 (req%verismo!vbox.vbox.MutFnTrait.box_update. $ (TYPE%verismo!vbox.vbox.VBox. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.)) $ (TYPE%verismo!primitives_e.vec.PushParam. T&. T&) $ BOOL self!@0 tmp%2)) (=> (has_type self!@1 (TYPE%verismo!vbox.vbox.VBox. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.))) (=> (ens%verismo!vbox.vbox.MutFnTrait.box_update. $ (TYPE%verismo!vbox.vbox.VBox. $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.)) $ (TYPE%verismo!primitives_e.vec.PushParam. T&. T&) $ BOOL self!@0 self!@1 tmp%2 tmp%1) (and (=> %%location_label%%1 (=> (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (Poly%verismo!ptr.snp.snp_u.SwSnpMemAttr. (verismo!vbox.vbox.impl&%6.snp.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@1))) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@1)) (vstd!seq.Seq.push.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) (verismo!vbox.vbox.impl&%6.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@0)) val!)))) (=> %%location_label%%2 (verismo!vbox.vbox.impl&%6.only_val_updated.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) self!@1 self!@0)))))))))
(check-sat)
(exit)
