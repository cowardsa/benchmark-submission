...
(declare-const mask@ verismo!tspec.security.sectype.SecType<u64./tuple%0.>.)
(declare-const ret@ verismo!tspec.security.sectype.SecType<u64./tuple%0.>.)
(assert fuel_defaults)
(assert (%B (B (= (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!)) (I 10)))))
...
(assert (not (=> (ens%verismo!tspec.security.sectype.impl&%17.constant. $ (UINT 64) $ TYPE%tuple%0. (I 1) tmp%1) (and (=> %%location_label%%0 (req%verismo!tspec.security.sectype.impl&%354.sub. $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!) tmp%1)) (=> (ens%verismo!tspec.security.sectype.impl&%354.sub. $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!) tmp%1 tmp%2) (=> (= mask@ (%Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. tmp%2)) (and (=> %%location_label%%1 (req%verismo!tspec.security.sectype.VNot.not. $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. mask@))) (=> (ens%verismo!tspec.security.sectype.VNot.not. $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. mask@) tmp%3) (=> (= ret@ (%Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. tmp%3)) (=> (= ret! ret@) (and (=> %%location_label%%2 (%B (B (= (verismo!tspec.security.sectype.SpecSecType./SpecSecType/val (%Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (UINT 64) $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!)))) (I (uClip 64 (uintnot 64 (I (%I (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ INT $ (UINT 64) (I (Sub (%I (verismo!tspec.security.sectype.SpecSecType./SpecSecType/val (%Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (UINT 64) $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!))))) 1)))))))))))) (and (=> %%location_label%%3 (verismo!tspec.security.sectype.impl&%20.wf.? $ (UINT 64) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!))) (=> %%location_label%%4 (=> (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!)))))))))))))))))
(check-sat)
(exit)
