...
(assert (not (=> (ens%verismo!tspec.math.bits_p.bit64_and_auto. 0) (=> (= ret! (verismo!snp.cpu.gdt.impl&%50.spec_base0_23.? (Poly%verismo!snp.cpu.gdt.Descriptor. self!))) (and (=> %%location_label%%0 (= ret! (verismo!snp.cpu.gdt.impl&%50.spec_base0_23.? (Poly%verismo!snp.cpu.gdt.Descriptor. self!)))) (and (=> %%location_label%%1 (<= ret! (uClip 64 16777215))) (=> %%location_label%%2 (>= ret! 0))))))))
(check-sat)
(exit)
