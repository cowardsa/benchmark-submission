...
(assert (not (=> (ens%verismo!tspec.math.bits_p.bit64_and_auto. 0) (=> (= ret! (verismo!snp.cpu.gdt.impl&%33.spec_granularity.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. self!))) (and (=> %%location_label%%0 (= ret! (verismo!snp.cpu.gdt.impl&%33.spec_granularity.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. self!)))) (and (=> %%location_label%%1 (<= ret! (uClip 64 1))) (=> %%location_label%%2 (>= ret! 0))))))))
(check-sat)
(exit)
