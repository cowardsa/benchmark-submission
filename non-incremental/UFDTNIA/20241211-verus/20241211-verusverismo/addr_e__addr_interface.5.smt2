...
(assert (%B (verismo!addr_e.addr_interface.PageTrait.spec_valid_pn_with.? $ (UINT 64) $ (UINT 64) self! (I 0))))
...
(assert (not (and (=> %%location_label%%0 (uInv 64 (Mul (%I self!) 4096))) (=> (= %return! (I (uClip 64 (Mul (%I self!) 4096)))) (and (=> %%location_label%%1 (= %return! (verismo!addr_e.addr_interface.PageTrait.spec_to_addr.? $ (UINT 64) $ (UINT 64) self!))) (=> %%location_label%%2 (%B (verismo!addr_e.addr_interface.PageTrait.spec_ensures_to_addr.? $ (UINT 64) $ (UINT 64) self! %return!))))))))
(check-sat)
(exit)
