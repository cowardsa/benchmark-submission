...
(assert (not (=> (ens%verismo!snp.cpu.gdt.impl&%51.entry_ds_sys. 0 tmp%1) (=> (ens%verismo!snp.cpu.gdt.impl&%51.entry_cs_sys. 0 tmp%2) (=> (ens%verismo!snp.cpu.gdt.impl&%50.get_attr_0_7. tmp%2 tmp%3) (=> (ens%verismo!snp.cpu.gdt.impl&%16.new. tmp%3 tmp%4) (and (=> %%location_label%%0 (req%verismo!snp.cpu.gdt.impl&%16.set_dpl. tmp%4 3)) (=> (ens%verismo!snp.cpu.gdt.impl&%16.set_dpl. tmp%4 3 tmp%5) (=> (ens%verismo!snp.cpu.gdt.impl&%16.value. tmp%5 tmp%6) (=> %%location_label%%1 (req%verismo!snp.cpu.gdt.impl&%50.set_attr_0_7. tmp%1 tmp%6)))))))))))
(check-sat)
(exit)
