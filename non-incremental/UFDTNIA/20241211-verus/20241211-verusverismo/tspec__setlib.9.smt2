...
(declare-const ss2@ Poly)
(assert fuel_defaults)
(assert (has_type s1! (TYPE%vstd!set.Set. A&. A&)))
(assert (has_type s2! (TYPE%vstd!set.Set. A&. A&)))
...
(assert (not (=> (= ss1@ s1!) (=> (= ss2@ (vstd!set.impl&%0.union.? A&. A& s1! s2!)) (and (=> (has_type a@ A&) (=> (vstd!set.impl&%0.contains.? A&. A& ss1@ a@) (=> %%location_label%%0 (vstd!set.impl&%0.contains.? A&. A& ss2@ a@)))) (=> (forall ((a$ Poly)) (! (=> (has_type a$ A&) (=> (vstd!set.impl&%0.contains.? A&. A& ss1@ a$) (vstd!set.impl&%0.contains.? A&. A& ss2@ a$))) :pattern ((vstd!set.impl&%0.contains.? A&. A& ss1@ a$)) :pattern ((vstd!set.impl&%0.contains.? A&. A& ss2@ a$)))) (and (=> %%location_label%%1 (vstd!set.impl&%0.subset_of.? A&. A& s1! (vstd!set.impl&%0.union.? A&. A& s1! s2!))) (and (=> %%location_label%%2 (vstd!set.impl&%0.subset_of.? A&. A& s2! (vstd!set.impl&%0.union.? A&. A& s1! s2!))) (and (=> %%location_label%%3 (ext_eq true (TYPE%vstd!set.Set. A&. A&) (vstd!set.impl&%0.union.? A&. A& s1! s2!) (vstd!set.impl&%0.union.? A&. A& s2! s1!))) (=> %%location_label%%4 (ext_eq true (TYPE%vstd!set.Set. A&. A&) (vstd!set.impl&%0.union.? A&. A& s1! s2!) (vstd!set.impl&%0.union.? A&. A& (vstd!set.impl&%0.union.? A&. A& s1! s2!) s2!))))))))))))
(check-sat)
(exit)
