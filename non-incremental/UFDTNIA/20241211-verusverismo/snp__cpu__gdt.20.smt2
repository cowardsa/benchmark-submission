...
(assert (not (=> (= tmp%1 (verismo!snp.cpu.gdt.impl&%33.inv.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. self!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= ret! (verismo!snp.cpu.gdt.DescriptorAttr8_11./DescriptorAttr8_11/value (%Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. self!)))) (and (=> %%location_label%%1 (= ret! (verismo!snp.cpu.gdt.DescriptorAttr8_11./DescriptorAttr8_11/value (%Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. self!))))) (=> %%location_label%%2 (<= (verismo!snp.cpu.gdt.DescriptorAttr8_11./DescriptorAttr8_11/value (%Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. self!))) (uClip 64 7))))))))))
(check-sat)
(exit)
