...
(set-info :comment ";; MODULE 'module tspec::math::pow_s'")
...
(assert (distinct fuel%verismo!tspec.math.pow_s.spec_pow2_to_bits. fuel%verismo!tspec.math.pow_s.spec_int_pow2. fuel%verismo!tspec.math.pow_s.spec_nat_pow2. fuel%verismo!tspec.math.pow_s.spec_bit64_is_pow_of_2. fuel%verismo!tspec.math.pow_s.spec_bit64_is_shl_by_bits.))
...
(set-info :comment ";; Spec-Termination verismo::tspec::math::pow_s::spec_nat_pow2")
(set-info :comment ";; verismo/src/tspec/math/pow_s.rs:19:1: 19:46 (#0)")
...
(assert (has_type e! NAT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (%I e!)) (or (and (=> (= (%I e!) 0) (=> (= tmp%3 1) %%switch_label%%0)) (=> (not (= (%I e!) 0)) (=> (= tmp%2 (I (nClip (Sub (%I e!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((e!$0 tmp%2)) (%I e!$0)) decrease%init0 false)) (=> (= tmp%1 (verismo!tspec.math.pow_s.spec_nat_pow2.? (I (nClip (Sub (%I e!) 1))))) (=> (= tmp%3 (Mul 2 tmp%1)) %%switch_label%%0)))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
