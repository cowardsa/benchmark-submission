...
(assert (not (=> (ens%verismo!tspec.security.sectype.impl&%17.constant. $ (UINT 64) $ TYPE%tuple%0. (I 1) tmp%1) (and (=> %%location_label%%0 (req%verismo!tspec.security.sectype.impl&%349.add. $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!) tmp%1)) (=> (ens%verismo!tspec.security.sectype.impl&%349.add. $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!) tmp%1 tmp%2) (=> (= ret! (%Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. tmp%2)) (and (=> %%location_label%%1 (%B (B (= (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!)) (I 256))))) (and (=> %%location_label%%2 (verismo!tspec.security.sectype.impl&%20.wf.? $ (UINT 64) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!))) (=> %%location_label%%3 (=> (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!)))))))))))))
(check-sat)
(exit)
