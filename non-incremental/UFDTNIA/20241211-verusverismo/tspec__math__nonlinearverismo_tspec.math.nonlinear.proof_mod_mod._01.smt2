...
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:6:1: 6:43 (#0)")
...
(set-info :comment ";; Function-Def verismo::tspec::math::nonlinear::proof_mod_mod")
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:6:1: 6:43 (#0)")
(declare-const a! Int)
(declare-const b! Int)
...
(assert (not (=> %%location_label%%0 (= (EucMod (EucMod a! b!) b!) (EucMod a! b!)))))
(check-sat)
(exit)
