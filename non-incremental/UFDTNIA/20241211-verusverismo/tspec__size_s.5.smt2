...
(set-info :comment ";; Function-Specs verismo::tspec::size_s::proof_bytes_len1")
(declare-fun req%verismo!tspec.size_s.proof_bytes_len1. (Int vstd!seq.Seq<u8.>.) Bool)
(declare-const %%global_location_label%%52 Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (req%verismo!tspec.size_s.proof_bytes_len1. data! s!) (=> %%global_location_label%%52 (ext_eq true (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s!) (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 8) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (I data!))))) :pattern ((req%verismo!tspec.size_s.proof_bytes_len1. data! s!)))))
(declare-fun ens%verismo!tspec.size_s.proof_bytes_len1. (Int vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (ens%verismo!tspec.size_s.proof_bytes_len1. data! s!) (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s!)) 1)) :pattern ((ens%verismo!tspec.size_s.proof_bytes_len1. data! s!)))))
(set-info :comment ";; Function-Def verismo::tspec::size_s::proof_bytes_len1")
(set-info :comment ";; verismo/src/tspec/size_s.rs:172:1: 172:52 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::size_s::proof_bytes_len0")
(declare-fun req%verismo!tspec.size_s.proof_bytes_len0. (Int vstd!seq.Seq<u8.>.) Bool)
(declare-const %%global_location_label%%53 Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (req%verismo!tspec.size_s.proof_bytes_len0. data! s!) (=> %%global_location_label%%53 (ext_eq true (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s!) (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT SZ) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (I data!))))) :pattern ((req%verismo!tspec.size_s.proof_bytes_len0. data! s!)))))
(declare-fun ens%verismo!tspec.size_s.proof_bytes_len0. (Int vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((data! Int) (s! vstd!seq.Seq<u8.>.)) (! (= (ens%verismo!tspec.size_s.proof_bytes_len0. data! s!) (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s!)) 8)) :pattern ((ens%verismo!tspec.size_s.proof_bytes_len0. data! s!)))))
(set-info :comment ";; Function-Def verismo::tspec::size_s::proof_bytes_len0")
(set-info :comment ";; verismo/src/tspec/size_s.rs:180:1: 180:55 (#0)")
(declare-const data! Int)
(declare-const s! vstd!seq.Seq<u8.>.)
(assert fuel_defaults)
(assert (uInv SZ data!))
(assert (ext_eq true (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s!) (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT SZ) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (I data!))))
