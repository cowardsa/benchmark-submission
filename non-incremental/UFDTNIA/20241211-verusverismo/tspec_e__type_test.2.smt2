...
(assert (not (and (=> %%location_label%%0 (= (verismo!tspec_e.type_test.S5./S5/a (%Poly%verismo!tspec_e.type_test.S5. (verismo!tspec.default.SpecDefault.spec_default.? $ TYPE%verismo!tspec_e.type_test.S5.))) (%Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. (vstd!pervasive.arbitrary.? (GHOST $) (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.))))) (=> %%location_label%%1 (%B (B (= (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. (verismo!tspec_e.type_test.S5./S5/c (%Poly%verismo!tspec_e.type_test.S5. (verismo!tspec.default.SpecDefault.spec_default.? $ TYPE%verismo!tspec_e.type_test.S5.))))) (I 0))))))))
(check-sat)
(exit)
