...
(set-info :comment ";; MODULE 'module ptr::ptr_s'")
...
(declare-const fuel%verismo!arch.rmp.access_s.impl&%0.check_access_no_addr_check. FuelId)
...
(declare-const fuel%verismo!arch.rmp.entry_s.impl&%0.check_hypervisor_owned. FuelId)
(declare-const fuel%verismo!arch.rmp.entry_s.impl&%0.check_guest_reverse_mut_size_no_gpn. FuelId)
(declare-const fuel%verismo!arch.rmp.entry_s.impl&%0.check_validated. FuelId)
...
(declare-const fuel%verismo!ptr.snp.snp_s.impl&%1.valid_access. FuelId)
(declare-const fuel%verismo!ptr.snp.snp_s.impl&%2.valid_access. FuelId)
...
(declare-const fuel%verismo!ptr.ptr_s.impl&%2.spec_write_field_rel. FuelId)
(declare-const fuel%verismo!ptr.ptr_s.impl&%3.vspec_cast_to. FuelId)
(declare-const fuel%verismo!ptr.ptr_s.impl&%4.sw_eq. FuelId)
(declare-const fuel%verismo!ptr.ptr_s.impl&%4.only_val_updated. FuelId)
(declare-const fuel%verismo!ptr.ptr_s.impl&%4.spec_write_rel. FuelId)
(declare-const fuel%verismo!ptr.ptr_s.impl&%4.spec_read_rel. FuelId)
...
(set-info :comment ";; Function-Decl verismo::arch::rmp::def_s::RmpEntry::check_access_no_addr_check")
(declare-fun verismo!arch.rmp.access_s.impl&%0.check_access_no_addr_check.? (Poly Poly Poly Poly) verismo!tspec.ResultOrErr.)
...
(set-info :comment ";; Function-Decl verismo::arch::rmp::def_s::HiddenRmpEntryForPSP::check_hypervisor_owned")
(declare-fun verismo!arch.rmp.entry_s.impl&%0.check_hypervisor_owned.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::rmp::def_s::HiddenRmpEntryForPSP::check_guest_reverse_mut_size_no_gpn")
(declare-fun verismo!arch.rmp.entry_s.impl&%0.check_guest_reverse_mut_size_no_gpn.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::rmp::def_s::HiddenRmpEntryForPSP::check_validated")
(declare-fun verismo!arch.rmp.entry_s.impl&%0.check_validated.? (Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::ptr::snp::snp_u::HwSnpMemAttr::valid_memmap")
(declare-fun verismo!ptr.snp.snp_s.impl&%1.valid_memmap.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::snp::snp_u::HwSnpMemAttr::valid_access")
(declare-fun verismo!ptr.snp.snp_s.impl&%1.valid_access.? (Poly Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::snp::snp_u::SnpMemAttr::valid_access")
(declare-fun verismo!ptr.snp.snp_s.impl&%2.valid_access.? (Poly Poly Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsTo::view")
...
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::spec_write_field_rel")
(declare-fun verismo!ptr.ptr_s.impl&%2.spec_write_field_rel.? (Dcr Type Dcr Type Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::sw_eq")
(declare-fun verismo!ptr.ptr_s.impl&%4.sw_eq.? (Dcr Type Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::only_val_updated")
(declare-fun verismo!ptr.ptr_s.impl&%4.only_val_updated.? (Dcr Type Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::spec_write_rel")
(declare-fun verismo!ptr.ptr_s.impl&%4.spec_write_rel.? (Dcr Type Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::spec_read_rel")
(declare-fun verismo!ptr.ptr_s.impl&%4.spec_read_rel.? (Dcr Type Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::id")
...
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::get_value")
...
(assert (forall ((self! Poly)) (! (= (req%verismo!arch.entities.memid.impl&%3.to_vmpl. self!) (=> %%global_location_label%%47 (is-verismo!arch.entities.memid.MemID./Guest_ (%Poly%verismo!arch.entities.memid.MemID. self!)))) :pattern ((req%verismo!arch.entities.memid.impl&%3.to_vmpl. self!)))))
...
(set-info :comment ";; Function-Axioms verismo::ptr::snp::snp_u::HwSnpMemAttr::valid_memmap")
...
(set-info :comment ";; Function-Axioms verismo::arch::rmp::def_s::HiddenRmpEntryForPSP::check_guest_reverse_mut_size_no_gpn")
(assert (fuel_bool_default fuel%verismo!arch.rmp.entry_s.impl&%0.check_guest_reverse_mut_size_no_gpn.))
(assert (=> (fuel_bool fuel%verismo!arch.rmp.entry_s.impl&%0.check_guest_reverse_mut_size_no_gpn.) (forall ((self! Poly) (asid! Poly) (size! Poly)) (! (= (verismo!arch.rmp.entry_s.impl&%0.check_guest_reverse_mut_size_no_gpn.? self! asid! size!) (and (and (and (= (verismo!arch.rmp.def_s.impl&%0.spec_immutable.? self!) false) (= (verismo!arch.rmp.def_s.impl&%0.spec_assigned.? self!) true)) (= (verismo!arch.rmp.def_s.impl&%0.spec_asid.? self!) (%I asid!))) (= (verismo!arch.rmp.def_s.impl&%0.spec_size.? self!) (%Poly%verismo!arch.addr_s.def_s.PageSize. size!)))) :pattern ((verismo!arch.rmp.entry_s.impl&%0.check_guest_reverse_mut_size_no_gpn.? self! asid! size!))))))
(set-info :comment ";; Function-Axioms verismo::arch::rmp::def_s::HiddenRmpEntryForPSP::check_validated")
(assert (fuel_bool_default fuel%verismo!arch.rmp.entry_s.impl&%0.check_validated.))
(assert (=> (fuel_bool fuel%verismo!arch.rmp.entry_s.impl&%0.check_validated.) (forall ((self! Poly)) (! (= (verismo!arch.rmp.entry_s.impl&%0.check_validated.? self!) (verismo!arch.rmp.def_s.impl&%0.spec_validated.? self!)) :pattern ((verismo!arch.rmp.entry_s.impl&%0.check_validated.? self!))))))
...
(set-info :comment ";; Function-Axioms verismo::arch::rmp::def_s::HiddenRmpEntryForPSP::check_hypervisor_owned")
(assert (fuel_bool_default fuel%verismo!arch.rmp.entry_s.impl&%0.check_hypervisor_owned.))
(assert (=> (fuel_bool fuel%verismo!arch.rmp.entry_s.impl&%0.check_hypervisor_owned.) (forall ((self! Poly)) (! (= (verismo!arch.rmp.entry_s.impl&%0.check_hypervisor_owned.? self!) (not (verismo!arch.rmp.def_s.impl&%0.spec_assigned.? self!))) :pattern ((verismo!arch.rmp.entry_s.impl&%0.check_hypervisor_owned.? self!))))))
(set-info :comment ";; Function-Axioms verismo::arch::rmp::def_s::RmpEntry::check_access_no_addr_check")
(assert (fuel_bool_default fuel%verismo!arch.rmp.access_s.impl&%0.check_access_no_addr_check.))
(assert (=> (fuel_bool fuel%verismo!arch.rmp.access_s.impl&%0.check_access_no_addr_check.) (forall ((self! Poly) (memid! Poly) (enc! Poly) (perm! Poly)) (! (= (verismo!arch.rmp.access_s.impl&%0.check_access_no_addr_check.? self! memid! enc! perm!) (ite (%B enc!) (ite (not (verismo!arch.rmp.entry_s.impl&%0.check_guest_reverse_mut_size_no_gpn.? (Poly%verismo!arch.rmp.def_s.HiddenRmpEntryForPSP. (verismo!arch.rmp.access_u.impl&%0.view.? self!)) (I (verismo!arch.entities.memid.impl&%3.to_asid.? memid!)) (Poly%verismo!arch.addr_s.def_s.PageSize. verismo!arch.addr_s.def_s.PageSize./Size4k))) (verismo!tspec.ResultOrErr./Error (Poly%verismo!arch.errors.MemError. (verismo!arch.errors.MemError./NestedPF (Poly%tuple%0. tuple%0./tuple%0)))) (ite (not (verismo!arch.rmp.entry_s.impl&%0.check_validated.? (Poly%verismo!arch.rmp.def_s.HiddenRmpEntryForPSP. (verismo!arch.rmp.access_u.impl&%0.view.? self!)))) (verismo!tspec.ResultOrErr./Error (Poly%verismo!arch.errors.MemError. (verismo!arch.errors.MemError./NotValidated (Poly%tuple%0. tuple%0./tuple%0)))) (ite (not (vstd!set.impl&%0.contains.? $ TYPE%verismo!arch.rmp.perm_s.Perm. (Poly%vstd!set.Set<verismo!arch.rmp.perm_s.Perm.>. (%Poly%vstd!set.Set<verismo!arch.rmp.perm_s.Perm.>. (vstd!map.impl&%0.index.? $ TYPE%verismo!arch.entities.VMPL. $ (TYPE%vstd!set.Set. $ TYPE%verismo!arch.rmp.perm_s.Perm.) (Poly%vstd!map.Map<verismo!arch.entities.VMPL./vstd!set.Set<verismo!arch.rmp.perm_s.Perm.>.>. (verismo!arch.rmp.def_s.impl&%0.spec_perms.? (Poly%verismo!arch.rmp.def_s.HiddenRmpEntryForPSP. (verismo!arch.rmp.access_u.impl&%0.view.? self!)))) (Poly%verismo!arch.entities.VMPL. (verismo!arch.entities.memid.impl&%3.to_vmpl.? memid!))))) perm!)) (verismo!tspec.ResultOrErr./Error (Poly%verismo!arch.errors.MemError. (verismo!arch.errors.MemError./NestedPF (Poly%tuple%0. tuple%0./tuple%0)))) (verismo!tspec.ResultOrErr./Ok self!)))) (ite (not (verismo!arch.rmp.entry_s.impl&%0.check_hypervisor_owned.? (Poly%verismo!arch.rmp.def_s.HiddenRmpEntryForPSP. (verismo!arch.rmp.access_u.impl&%0.view.? self!)))) (verismo!tspec.ResultOrErr./Error (Poly%verismo!arch.errors.MemError. (verismo!arch.errors.MemError./NestedPF (Poly%tuple%0. tuple%0./tuple%0)))) (verismo!tspec.ResultOrErr./Ok self!)))) :pattern ((verismo!arch.rmp.access_s.impl&%0.check_access_no_addr_check.? self! memid! enc! perm!))))))
(assert (forall ((self! Poly) (memid! Poly) (enc! Poly) (perm! Poly)) (! (=> (and (has_type self! TYPE%verismo!arch.rmp.def_s.RmpEntry.) (has_type memid! TYPE%verismo!arch.entities.memid.MemID.) (has_type enc! BOOL) (has_type perm! TYPE%verismo!arch.rmp.perm_s.Perm.)) (has_type (Poly%verismo!tspec.ResultOrErr. (verismo!arch.rmp.access_s.impl&%0.check_access_no_addr_check.? self! memid! enc! perm!)) (TYPE%verismo!tspec.ResultOrErr. $ TYPE%verismo!arch.rmp.def_s.RmpEntry. $ (TYPE%verismo!arch.errors.MemError. $ TYPE%tuple%0.)))) :pattern ((verismo!arch.rmp.access_s.impl&%0.check_access_no_addr_check.? self! memid! enc! perm!)))))
...
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsTo::view")
...
(assert (forall ((V&. Dcr) (V& Type) (self! Poly)) (! (= (req%verismo!ptr.ptr_u.impl&%2.value. V&. V& self!) (=> %%global_location_label%%48 (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (verismo!ptr.snp.snp_u.SnpMemAttrTrait.hw_snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!)))) :pattern ((req%verismo!ptr.ptr_u.impl&%2.value. V&. V& self!)))))
...
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToData::get_value")
...
(set-info :comment ";; Function-Specs verismo::ptr::def_s::SnpPointsTo::trusted_into_raw")
(declare-fun req%verismo!ptr.ptr_s.impl&%6.trusted_into_raw. (Dcr Type Poly) Bool)
(declare-const %%global_location_label%%49 Bool)
(declare-const %%global_location_label%%50 Bool)
(assert (forall ((V&. Dcr) (V& Type) (self! Poly)) (! (= (req%verismo!ptr.ptr_s.impl&%6.trusted_into_raw. V&. V& self!) (and (=> %%global_location_label%%49 (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.def_s.SnpPointsToData./SnpPointsToData/value (%Poly%verismo!ptr.def_s.SnpPointsToData. (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))))))) (=> %%global_location_label%%50 (%B (verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!))))))) :pattern ((req%verismo!ptr.ptr_s.impl&%6.trusted_into_raw. V&. V& self!)))))
(declare-fun ens%verismo!ptr.ptr_s.impl&%6.trusted_into_raw. (Dcr Type Poly verismo!ptr.def_s.SnpPointsToRaw.) Bool)
(assert (forall ((V&. Dcr) (V& Type) (self! Poly) (points_to_raw! verismo!ptr.def_s.SnpPointsToRaw.)) (! (= (ens%verismo!ptr.ptr_s.impl&%6.trusted_into_raw. V&. V& self! points_to_raw!) (and (= (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!)) (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!))))) (= (verismo!ptr.def_s.impl&%24.view.? V&. V& self!) (%Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!)))))) (verismo!ptr.raw_ptr_s.impl&%5.wf.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!)))))) :pattern ((ens%verismo!ptr.ptr_s.impl&%6.trusted_into_raw. V&. V& self! points_to_raw!)))))
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToData::spec_write_rel")
(assert (fuel_bool_default fuel%verismo!ptr.ptr_s.impl&%4.spec_write_rel.))
(assert (=> (fuel_bool fuel%verismo!ptr.ptr_s.impl&%4.spec_write_rel.) (forall ((V&. Dcr) (V& Type) (self! Poly) (prev! Poly) (val! Poly)) (! (= (verismo!ptr.ptr_s.impl&%4.spec_write_rel.? V&. V& self! prev! val!) (and (and (and (ite (is-core!option.Option./Some_ (%Poly%core!option.Option. val!)) (let ((v$ (core!option.Option./Some/0 (%Poly%core!option.Option. val!)))) (and (= (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!)))) v$) (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!)))))))) (%B (B (is-core!option.Option./None_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!))))))) (= (verismo!ptr.def_s.SnpPointsToData./SnpPointsToData/ptr (%Poly%verismo!ptr.def_s.SnpPointsToData. self!)) (verismo!ptr.def_s.SnpPointsToData./SnpPointsToData/ptr (%Poly%verismo!ptr.def_s.SnpPointsToData. prev!)))) (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) prev!))) (verismo!ptr.snp.snp_u.impl&%28.hvupdate_rel.? (verismo!ptr.snp.snp_u.SnpMemAttrTrait.hw_snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.hw_snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) prev!)))) :pattern ((verismo!ptr.ptr_s.impl&%4.spec_write_rel.? V&. V& self! prev! val!))))))
(set-info :comment ";; Function-Specs verismo::ptr::snp::snp_u::HwSnpMemAttr::valid_access")
(declare-fun req%verismo!ptr.snp.snp_s.impl&%1.valid_access. (Poly Poly Poly Poly Poly) Bool)
(declare-const %%global_location_label%%51 Bool)
(assert (forall ((self! Poly) (vmid! Poly) (vaddr! Poly) (size! Poly) (perm! Poly)) (! (= (req%verismo!ptr.snp.snp_s.impl&%1.valid_access. self! vmid! vaddr! size! perm!) (=> %%global_location_label%%51 (>= (%I vmid!) 1))) :pattern ((req%verismo!ptr.snp.snp_s.impl&%1.valid_access. self! vmid! vaddr! size! perm!)))))
(set-info :comment ";; Function-Axioms verismo::ptr::snp::snp_u::HwSnpMemAttr::valid_access")
(assert (fuel_bool_default fuel%verismo!ptr.snp.snp_s.impl&%1.valid_access.))
(assert (=> (fuel_bool fuel%verismo!ptr.snp.snp_s.impl&%1.valid_access.) (forall ((self! Poly) (vmid! Poly) (vaddr! Poly) (size! Poly) (perm! Poly)) (! (= (verismo!ptr.snp.snp_s.impl&%1.valid_access.? self! vmid! vaddr! size! perm!) (let ((memid$ (verismo!arch.entities.memid.MemID./Guest (%I (I (nClip (Sub (%I vmid!) 1)))) (%Poly%verismo!arch.entities.VMPL. (Poly%verismo!arch.entities.VMPL. verismo!arch.entities.VMPL./VMPL0))))) (and (is-verismo!tspec.ResultOrErr./Ok_ (%Poly%verismo!tspec.ResultOrErr. (Poly%verismo!tspec.ResultOrErr. (verismo!arch.rmp.access_s.impl&%0.check_access_no_addr_check.? (Poly%verismo!arch.rmp.def_s.RmpEntry. (verismo!ptr.snp.snp_u.SwSnpMemAttr./SwSnpMemAttr/rmp (%Poly%verismo!ptr.snp.snp_u.SwSnpMemAttr. self!))) (Poly%verismo!arch.entities.memid.MemID. memid$) (B (verismo!ptr.snp.snp_u.impl&%27.encrypted.? self!)) perm!)))) (=> (verismo!ptr.snp.snp_u.impl&%27.encrypted.? self!) (verismo!ptr.snp.snp_s.impl&%1.valid_memmap.? self! vaddr! size!))))) :pattern ((verismo!ptr.snp.snp_s.impl&%1.valid_access.? self! vmid! vaddr! size! perm!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::snp::snp_u::SnpMemAttr::valid_access")
(assert (fuel_bool_default fuel%verismo!ptr.snp.snp_s.impl&%2.valid_access.))
(assert (=> (fuel_bool fuel%verismo!ptr.snp.snp_s.impl&%2.valid_access.) (forall ((self! Poly) (vaddr! Poly) (size! Poly) (perm! Poly)) (! (= (verismo!ptr.snp.snp_s.impl&%2.valid_access.? self! vaddr! size! perm!) (verismo!ptr.snp.snp_s.impl&%1.valid_access.? (Poly%verismo!ptr.snp.snp_u.SwSnpMemAttr. (verismo!ptr.snp.snp_u.SnpMemAttr./SnpMemAttr/hw (%Poly%verismo!ptr.snp.snp_u.SnpMemAttr. self!))) (I (verismo!arch.rmp.def_s.HiddenRmpEntryForPSP./HiddenRmpEntryForPSP/asid (%Poly%verismo!arch.rmp.def_s.HiddenRmpEntryForPSP. (Poly%verismo!arch.rmp.def_s.HiddenRmpEntryForPSP. (verismo!arch.rmp.access_u.impl&%0.view.? (Poly%verismo!arch.rmp.def_s.RmpEntry. (verismo!ptr.snp.snp_u.SwSnpMemAttr./SwSnpMemAttr/rmp (%Poly%verismo!ptr.snp.snp_u.SwSnpMemAttr. (Poly%verismo!ptr.snp.snp_u.SwSnpMemAttr. (verismo!ptr.snp.snp_u.SnpMemAttr./SnpMemAttr/sw (%Poly%verismo!ptr.snp.snp_u.SnpMemAttr. self!))))))))))) vaddr! size! perm!)) :pattern ((verismo!ptr.snp.snp_s.impl&%2.valid_access.? self! vaddr! size! perm!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToData::id")
...
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToData::spec_read_rel")
(assert (fuel_bool_default fuel%verismo!ptr.ptr_s.impl&%4.spec_read_rel.))
(assert (=> (fuel_bool fuel%verismo!ptr.ptr_s.impl&%4.spec_read_rel.) (forall ((V&. Dcr) (V& Type) (self! Poly) (val! Poly)) (! (= (verismo!ptr.ptr_s.impl&%4.spec_read_rel.? V&. V& self! val!) (and (and (=> (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!)))))) (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (verismo!ptr.snp.snp_u.SnpMemAttrTrait.hw_snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!))) (= (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!)))) val!)) (verismo!ptr.ptr_s.inv_snp_value.? V&. V& (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!) val!)) (verismo!ptr.snp.snp_s.impl&%2.valid_access.? (Poly%verismo!ptr.snp.snp_u.SnpMemAttr. (verismo!ptr.def_s.SnpPointsToData./SnpPointsToData/snp (%Poly%verismo!ptr.def_s.SnpPointsToData. self!))) (I (verismo!ptr.ptr_u.impl&%2.id.? V&. V& self!)) (I (verismo!tspec.size_s.spec_size.? V&. V&)) (Poly%verismo!arch.rmp.perm_s.Perm. verismo!arch.rmp.perm_s.Perm./Read)))) :pattern ((verismo!ptr.ptr_s.impl&%4.spec_read_rel.? V&. V& self! val!))))))
...
(assert (=> (fuel_bool fuel%verismo!primitives_e.seq.impl&%3.vspec_cast_to.) (forall ((self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 8) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!) (let ((seq$ (%Poly%vstd!seq.Seq<u8.>. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 8) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) self!)))) (vstd!seq.Seq.new.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) $ (TYPE%fun%1. $ INT $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$))) (Poly%fun%1. (mk_fun (%%lambda%%12 $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$) $ (UINT 8) $ TYPE%tuple%0.)))))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 8) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!))))))
...
(assert (=> (fuel_bool fuel%verismo!primitives_e.seq.impl&%5.vspec_cast_to.) (forall ((self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 16) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!) (let ((seq$ (%Poly%vstd!seq.Seq<u8.>. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 16) $ (TYPE%vstd!seq.Seq. $ (UINT 8)) self!)))) (vstd!seq.Seq.new.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) $ (TYPE%fun%1. $ INT $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$))) (Poly%fun%1. (mk_fun (%%lambda%%12 $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq$) $ (UINT 8) $ TYPE%tuple%0.)))))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT 16) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!))))))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (tr_bound%verismo!tspec.cast.VTypeCast. $ INT $ (UINT 64)))
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPPtr::is_constant_to")
...
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPPtr::vspec_cast_to")
...
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPPtr::spec_size_def")
...
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToData::spec_write_field_rel")
(assert (fuel_bool_default fuel%verismo!ptr.ptr_s.impl&%2.spec_write_field_rel.))
(assert (=> (fuel_bool fuel%verismo!ptr.ptr_s.impl&%2.spec_write_field_rel.) (forall ((V&. Dcr) (V& Type) (F&. Dcr) (F& Type) (self! Poly) (prev! Poly) (offset! Poly) (val! Poly)) (! (= (verismo!ptr.ptr_s.impl&%2.spec_write_field_rel.? V&. V& F&. F& self! prev! offset! val!) (and (and (and (ite (is-core!option.Option./Some_ (%Poly%core!option.Option. val!)) (let ((v$ (core!option.Option./Some/0 (%Poly%core!option.Option. val!)))) (and (verismo!tspec.cast.field_set.? V&. V& F&. F& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& prev!)))) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!)))) offset! v$) (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!)))))))) (%B (B (is-core!option.Option./None_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!))))))) (= (verismo!ptr.def_s.SnpPointsToData./SnpPointsToData/ptr (%Poly%verismo!ptr.def_s.SnpPointsToData. self!)) (verismo!ptr.def_s.SnpPointsToData./SnpPointsToData/ptr (%Poly%verismo!ptr.def_s.SnpPointsToData. prev!)))) (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) prev!))) (%B (verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!)))) :pattern ((verismo!ptr.ptr_s.impl&%2.spec_write_field_rel.? V&. V& F&. F& self! prev! offset! val!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToData::sw_eq")
(assert (fuel_bool_default fuel%verismo!ptr.ptr_s.impl&%4.sw_eq.))
(assert (=> (fuel_bool fuel%verismo!ptr.ptr_s.impl&%4.sw_eq.) (forall ((V&. Dcr) (V& Type) (self! Poly) (rhs! Poly)) (! (= (verismo!ptr.ptr_s.impl&%4.sw_eq.? V&. V& self! rhs!) (and (and (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) rhs!)) (= (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!) (verismo!ptr.ptr_u.impl&%2.value.? V&. V& rhs!))) (= (verismo!ptr.ptr_u.impl&%2.id.? V&. V& self!) (verismo!ptr.ptr_u.impl&%2.id.? V&. V& rhs!)))) :pattern ((verismo!ptr.ptr_s.impl&%4.sw_eq.? V&. V& self! rhs!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToData::only_val_updated")
(assert (fuel_bool_default fuel%verismo!ptr.ptr_s.impl&%4.only_val_updated.))
(assert (=> (fuel_bool fuel%verismo!ptr.ptr_s.impl&%4.only_val_updated.) (forall ((V&. Dcr) (V& Type) (self! Poly) (rhs! Poly)) (! (= (verismo!ptr.ptr_s.impl&%4.only_val_updated.? V&. V& self! rhs!) (and (and (and (= (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!) (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) rhs!)) (= (verismo!ptr.ptr_u.impl&%2.id.? V&. V& self!) (verismo!ptr.ptr_u.impl&%2.id.? V&. V& rhs!))) (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& self!))))))) (%B (verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) self!)))) :pattern ((verismo!ptr.ptr_s.impl&%4.only_val_updated.? V&. V& self! rhs!))))))
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToData::is_constant_to")
...
(set-info :comment ";; Function-Axioms verismo::ptr::def_s::SnpPointsToData::is_constant")
...
(set-info :comment ";; Function-Axioms verismo::ptr::raw_ptr_s::SnpPointsToBytes::hw_snp")
...
(set-info :comment ";; Function-Specs verismo::tspec::cast::proof_into_is_constant")
(declare-fun ens%verismo!tspec.cast.proof_into_is_constant. (Dcr Type Dcr Type Poly) Bool)
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (v! Poly)) (! (= (ens%verismo!tspec.cast.proof_into_is_constant. T1&. T1& T2&. T2& v!) (and (= (verismo!tspec.isconst.IsConstant.is_constant.? T1&. T1& v!) (verismo!tspec.isconst.IsConstant.is_constant.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!))) (= (verismo!tspec.isconst.IsConstant.is_constant_to.? T1&. T1& v! (I 1)) (verismo!tspec.isconst.IsConstant.is_constant_to.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!) (I 1))) (= (verismo!tspec.isconst.IsConstant.is_constant_to.? T1&. T1& v! (I 2)) (verismo!tspec.isconst.IsConstant.is_constant_to.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!) (I 2))) (= (verismo!tspec.isconst.IsConstant.is_constant_to.? T1&. T1& v! (I 3)) (verismo!tspec.isconst.IsConstant.is_constant_to.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!) (I 3))) (= (verismo!tspec.isconst.IsConstant.is_constant_to.? T1&. T1& v! (I 4)) (verismo!tspec.isconst.IsConstant.is_constant_to.? T2&. T2& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T1&. T1& T2&. T2& v!) (I 4))))) :pattern ((ens%verismo!tspec.cast.proof_into_is_constant. T1&. T1& T2&. T2& v!)))))
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Function-Specs verismo::ptr::def_s::SnpPointsTo::tracked_into_raw")
(declare-fun req%verismo!ptr.ptr_s.impl&%6.tracked_into_raw. (Dcr Type Poly) Bool)
(declare-const %%global_location_label%%52 Bool)
(declare-const %%global_location_label%%53 Bool)
(assert (forall ((V&. Dcr) (V& Type) (self! Poly)) (! (= (req%verismo!ptr.ptr_s.impl&%6.tracked_into_raw. V&. V& self!) (and (=> %%global_location_label%%52 (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.def_s.SnpPointsToData./SnpPointsToData/value (%Poly%verismo!ptr.def_s.SnpPointsToData. (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))))))) (=> %%global_location_label%%53 (%B (verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!))))))) :pattern ((req%verismo!ptr.ptr_s.impl&%6.tracked_into_raw. V&. V& self!)))))
(declare-fun ens%verismo!ptr.ptr_s.impl&%6.tracked_into_raw. (Dcr Type Poly verismo!ptr.def_s.SnpPointsToRaw.) Bool)
(assert (forall ((V&. Dcr) (V& Type) (self! Poly) (points_to_raw! verismo!ptr.def_s.SnpPointsToRaw.)) (! (= (ens%verismo!ptr.ptr_s.impl&%6.tracked_into_raw. V&. V& self! points_to_raw!) (and (= (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!)) (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!))))) (= (verismo!ptr.def_s.impl&%24.view.? V&. V& self!) (%Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!)))))) (verismo!ptr.raw_ptr_s.impl&%5.wf.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!)))) (=> (%B (verismo!tspec.isconst.IsConstant.is_constant.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!)))))))) (=> (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))) (I 1))) (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))) (I 1)))) (=> (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))) (I 1))) (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))) (I 1)))) (=> (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))) (I 1))) (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))) (I 1)))) (=> (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))) (I 1))) (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))) (I 1)))))) :pattern ((ens%verismo!ptr.ptr_s.impl&%6.tracked_into_raw. V&. V& self! points_to_raw!)))))
(set-info :comment ";; Function-Def verismo::ptr::def_s::SnpPointsTo::tracked_into_raw")
(set-info :comment ";; verismo/src/ptr/ptr_s.rs:119:5: 119:90 (#0)")
(declare-const V&. Dcr)
(declare-const V& Type)
(declare-const points_to_raw! verismo!ptr.def_s.SnpPointsToRaw.)
(declare-const self! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 verismo!ptr.def_s.SnpPointsToRaw.)
(assert fuel_defaults)
(assert (has_type self! (TYPE%verismo!ptr.def_s.SnpPointsTo. V&. V&)))
(assert (tr_bound%verismo!tspec.isconst.IsConstant. V&. V&))
(assert (tr_bound%verismo!tspec.wellformed.WellFormed. V&. V&))
(assert (tr_bound%verismo!tspec.cast.VTypeCast. V&. V& $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.))))
(assert (tr_bound%verismo!tspec.size_s.SpecSize. V&. V&))
(assert (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.def_s.SnpPointsToData./SnpPointsToData/value (%Poly%verismo!ptr.def_s.SnpPointsToData. (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!))))))))))
(assert (%B (verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))
...
(assert (not (=> (= tmp%1 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!))))))) (=> (ens%verismo!tspec.cast.proof_into_is_constant. V&. V& $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) tmp%1) (and (=> %%location_label%%0 (req%verismo!ptr.ptr_s.impl&%6.trusted_into_raw. V&. V& self!)) (=> (ens%verismo!ptr.ptr_s.impl&%6.trusted_into_raw. V&. V& self! tmp%2) (=> (= points_to_raw! tmp%2) (and (=> %%location_label%%1 (= (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!)) (%Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))) (and (=> %%location_label%%2 (= (verismo!ptr.def_s.impl&%24.view.? V&. V& self!) (%Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. $ (TYPE%verismo!ptr.def_s.SnpPointsToData. V&. V&) (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))))) (and (=> %%location_label%%3 (verismo!ptr.raw_ptr_s.impl&%5.wf.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))) (and (=> %%location_label%%4 (=> (%B (verismo!tspec.isconst.IsConstant.is_constant.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))))))) (and (=> %%location_label%%5 (=> (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))) (I 1))) (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))) (I 1))))) (and (=> %%location_label%%6 (=> (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))) (I 1))) (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))) (I 1))))) (and (=> %%location_label%%7 (=> (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))) (I 1))) (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))) (I 1))))) (=> %%location_label%%8 (=> (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? V&. V& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!ptr.ptr_u.impl&%2.value.? V&. V& (Poly%verismo!ptr.def_s.SnpPointsToData. (verismo!ptr.def_s.impl&%24.view.? V&. V& self!)))))) (I 1))) (%B (verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!ptr.raw_ptr_s.impl&%5.bytes.? (Poly%verismo!ptr.raw_ptr_s.SnpPointsToBytes. (verismo!ptr.raw_ptr_s.impl&%4.view.? (Poly%verismo!ptr.def_s.SnpPointsToRaw. points_to_raw!))))) (I 1)))))))))))))))))))
(check-sat)
(exit)
