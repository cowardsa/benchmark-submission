...
(assert (not (=> (ens%verismo!tspec.math.bits_p.bit64_and_auto. 0) (=> (= mask@ (uClip 64 255)) (=> (ens%verismo!snp.cpu.gdt.impl&%50.value. self! tmp%1) (and (=> %%location_label%%0 (and (<= 0 (uClip 64 40)) (< (uClip 64 40) 64))) (=> (= ret! (uClip 64 (uintand 64 (I (uClip 64 (uintshr 64 (I tmp%1) (I (uClip 64 40))))) (I mask@)))) (and (=> %%location_label%%1 (= ret! (verismo!snp.cpu.gdt.impl&%34.spec_attr_0_7.? (Poly%verismo!snp.cpu.gdt.DescriptorSpec. (verismo!snp.cpu.gdt.impl&%50.view.? (Poly%verismo!snp.cpu.gdt.Descriptor. self!)))))) (=> %%location_label%%2 (<= (verismo!snp.cpu.gdt.impl&%34.spec_attr_0_7.? (Poly%verismo!snp.cpu.gdt.DescriptorSpec. (verismo!snp.cpu.gdt.impl&%50.view.? (Poly%verismo!snp.cpu.gdt.Descriptor. self!)))) (uClip 64 255)))))))))))
(check-sat)
(exit)
