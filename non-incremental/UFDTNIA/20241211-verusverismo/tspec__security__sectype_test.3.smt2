...
(assert (%B (B (<= (%I (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ INT $ TYPE%tuple%0.) (verismo!tspec.security.sectype.impl&%9.spec_new.? $ INT $ TYPE%tuple%0. (verismo!tspec.ops.VSpecMul.spec_mul.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ INT $ TYPE%tuple%0.) (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (UINT 64) $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!)) (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (UINT 64) $ TYPE%tuple%0. (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v2!)))))) (%I (I 18446744073709551615))))))
...
(assert (not (=> (ens%verismo!tspec.security.sectype.impl&%17.constant. $ (UINT 64) $ TYPE%tuple%0. (I 11) tmp%1) (=> (= v@ (%Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. tmp%1)) (=> (= tmp%2 (%B (B (>= (%I (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!))) (%I (I 0)))))) (and (=> %%location_label%%0 tmp%2) (=> tmp%2 (=> (= tmp%3 (%B (B (>= (%I (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v2!))) (%I (I 0)))))) (and (=> %%location_label%%1 tmp%3) (=> tmp%3 (and (=> (= tmp%4 (%B (B (>= (%I (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!))) (%I (I 0)))))) (and (=> %%location_label%%2 tmp%4) (=> tmp%4 (=> %%location_label%%3 (%B (B (>= (%I (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!))) (%I (I 0))))))))) (=> (%B (B (>= (%I (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!))) (%I (I 0))))) (=> (= ret! v@) (and (=> %%location_label%%4 (verismo!tspec.security.sectype.impl&%20.wf.? $ (UINT 64) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!))) (=> %%location_label%%5 (=> (and (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v1!))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. v2!)))) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. ret!)))))))))))))))))))
(check-sat)
(exit)
