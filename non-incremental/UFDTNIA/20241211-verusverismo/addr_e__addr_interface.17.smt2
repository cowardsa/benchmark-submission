...
(set-info :comment ";; Function-Specs verismo::tspec::security::sectype::SecType::mul")
(declare-fun req%verismo!tspec.security.sectype.impl&%362.mul. (Dcr Type Poly Int) Bool)
...
(assert (forall ((M&. Dcr) (M& Type) (self! Poly) (other! Int)) (! (= (req%verismo!tspec.security.sectype.impl&%362.mul. M&. M& self! other!) (and (=> %%global_location_label%%65 (verismo!tspec.security.sectype.impl&%9.wf_value.? $ (UINT 64) M&. M& self!)) (=> %%global_location_label%%66 (= (uClip 64 (Mul (%I (verismo!tspec.security.sectype.SpecSecType./SpecSecType/val (%Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) M&. M&) $ (UINT 64) M&. M& self!)))) other!)) (Mul (%I (verismo!tspec.security.sectype.SpecSecType./SpecSecType/val (%Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) M&. M&) $ (UINT 64) M&. M& self!)))) other!))) (=> %%global_location_label%%67 (>= other! 0)))) :pattern ((req%verismo!tspec.security.sectype.impl&%362.mul. M&. M& self! other!)))))
(declare-fun ens%verismo!tspec.security.sectype.impl&%362.mul. (Dcr Type Poly Int Poly) Bool)
(assert (forall ((M&. Dcr) (M& Type) (self! Poly) (other! Int) (ret! Poly)) (! (= (ens%verismo!tspec.security.sectype.impl&%362.mul. M&. M& self! other! ret!) (and (has_type ret! (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) M&. M&)) (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ INT M&. M&) $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 64) M&. M&) (verismo!tspec.ops.VSpecMul.spec_mul.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 64) M&. M&) $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 64) M&. M&) $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ INT M&. M&) (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) M&. M&) $ (UINT 64) M&. M& self!) (Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.impl&%16.constant.? $ (UINT 64) M&. M& (I other!))))) (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) M&. M&) $ (UINT 64) M&. M& ret!)) (=> (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) M&. M&) self!)) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) M&. M&) ret!))) (verismo!tspec.security.sectype.impl&%9.wf_value.? $ (UINT 64) M&. M& ret!))) :pattern ((ens%verismo!tspec.security.sectype.impl&%362.mul. M&. M& self! other! ret!)))))
(set-info :comment ";; Function-Def verismo::primitives_e::sectype::u64_s::to_addr")
(set-info :comment ";; verismo/src/addr_e/addr_interface.rs:253:13: 253:15 (#9825)")
...
(assert (%B (verismo!addr_e.addr_interface.PageTrait.spec_valid_pn_with.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) self! (I 0))))
...
(assert (not (=> (= tmp%2 (uClip 64 verismo!arch.addr_s.def_s.PAGE_SIZE.?)) (and (=> %%location_label%%0 (req%verismo!tspec.security.sectype.impl&%362.mul. $ TYPE%tuple%0. self! tmp%2)) (=> (ens%verismo!tspec.security.sectype.impl&%362.mul. $ TYPE%tuple%0. self! tmp%2 tmp%1) (=> (= %return! tmp%1) (and (=> %%location_label%%1 (= %return! (verismo!addr_e.addr_interface.PageTrait.spec_to_addr.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) self!))) (=> %%location_label%%2 (%B (verismo!addr_e.addr_interface.PageTrait.spec_ensures_to_addr.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) self! %return!))))))))))
(check-sat)
(exit)
