...
(assert (not (=> %%location_label%%0 (%B (B (= (I (nClip (Add (nClip (Add (%I (verismo!tspec.size_s.SpecSize.spec_size_def.? $ (UINT 64))) (%I (verismo!tspec.size_s.SpecSize.spec_size_def.? $ (UINT SZ))))) (%I (I (nClip (Add (nClip (Add (nClip (Add (%I (verismo!tspec.size_s.SpecSize.spec_size_def.? $ (UINT 64))) (%I (verismo!tspec.size_s.SpecSize.spec_size_def.? $ (UINT 8))))) (%I (verismo!tspec.size_s.SpecSize.spec_size_def.? $ (UINT 8))))) (%I (verismo!tspec.size_s.SpecSize.spec_size_def.? $ (UINT 8)))))))))) (I 27)))))))
(check-sat)
(exit)
