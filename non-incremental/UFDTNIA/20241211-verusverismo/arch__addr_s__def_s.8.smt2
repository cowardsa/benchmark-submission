...
(set-info :comment ";; MODULE 'module arch::addr_s::def_s'")
...
(set-info :comment ";; Function-Decl verismo::arch::addr_s::def_s::PAGE_SHIFT")
...
(set-info :comment ";; Function-Decl verismo::arch::addr_s::def_s::PAGE_2M_SIZE")
...
(set-info :comment ";; Function-Decl verismo::arch::addr_s::def_s::BLOCK_SIZE")
...
(set-info :comment ";; Function-Decl verismo::arch::addr_s::def_s::PageSize::is_Size4k")
(declare-fun verismo!arch.addr_s.def_s.impl&%39.is_Size4k.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::addr_s::def_s::PageSize::is_Size2m")
(declare-fun verismo!arch.addr_s.def_s.impl&%39.is_Size2m.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::addr_s::def_s::PageSize::size")
...
(set-info :comment ";; Function-Def verismo::arch::addr_s::def_s::PAGE_SIZE")
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#7954)")
...
(set-info :comment ";; Function-Def verismo::arch::addr_s::def_s::VM_PAGE_NUM")
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#7954)")
...
(set-info :comment ";; Function-Axioms verismo::arch::addr_s::def_s::PageSize::is_Size4k")
...
(set-info :comment ";; Function-Specs verismo::arch::addr_s::def_s::VERUS_layout_of_usize")
(declare-fun ens%verismo!arch.addr_s.def_s.VERUS_layout_of_usize. () Bool)
(assert (= ens%verismo!arch.addr_s.def_s.VERUS_layout_of_usize. (= (vstd!layout.size_of.? $ (UINT SZ)) 8)))
(set-info :comment ";; Broadcast verismo::arch::addr_s::def_s::VERUS_layout_of_usize")
...
(set-info :comment ";; Function-Def verismo::arch::addr_s::def_s::VM_MEM_SIZE")
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#7954)")
...
(set-info :comment ";; Function-Def verismo::arch::addr_s::def_s::PAGE_SHIFT")
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#7954)")
(set-info :comment ";; Function-Axioms verismo::arch::addr_s::def_s::PAGE_SHIFT")
(assert (fuel_bool_default fuel%verismo!arch.addr_s.def_s.PAGE_SHIFT.))
(assert (=> (fuel_bool fuel%verismo!arch.addr_s.def_s.PAGE_SHIFT.) (= verismo!arch.addr_s.def_s.PAGE_SHIFT.? 12)))
(assert (uInv SZ verismo!arch.addr_s.def_s.PAGE_SHIFT.?))
(set-info :comment ";; Function-Def verismo::arch::addr_s::def_s::PAGE_2M_SIZE")
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#7954)")
(set-info :comment ";; Function-Axioms verismo::arch::addr_s::def_s::PAGE_2M_SIZE")
(assert (fuel_bool_default fuel%verismo!arch.addr_s.def_s.PAGE_2M_SIZE.))
(assert (=> (fuel_bool fuel%verismo!arch.addr_s.def_s.PAGE_2M_SIZE.) (= verismo!arch.addr_s.def_s.PAGE_2M_SIZE.? 2097152)))
(assert (uInv SZ verismo!arch.addr_s.def_s.PAGE_2M_SIZE.?))
(set-info :comment ";; Function-Def verismo::arch::addr_s::def_s::BLOCK_SIZE")
(set-info :comment ";; verismo/src/tspec/constant.rs:22:61: 22:62 (#7954)")
(set-info :comment ";; Function-Axioms verismo::arch::addr_s::def_s::BLOCK_SIZE")
(assert (fuel_bool_default fuel%verismo!arch.addr_s.def_s.BLOCK_SIZE.))
(assert (=> (fuel_bool fuel%verismo!arch.addr_s.def_s.BLOCK_SIZE.) (= verismo!arch.addr_s.def_s.BLOCK_SIZE.? 1)))
(assert (uInv SZ verismo!arch.addr_s.def_s.BLOCK_SIZE.?))
...
(set-info :comment ";; Function-Axioms verismo::arch::addr_s::def_s::PageSize::is_Size2m")
(assert (fuel_bool_default fuel%verismo!arch.addr_s.def_s.impl&%39.is_Size2m.))
(define-fun is-verismo!arch.addr_s.def_s.PageSize./Size2m_ ((c verismo!arch.addr_s.def_s.PageSize.)) Bool ((_ is verismo!arch.addr_s.def_s.PageSize./Size2m) c))
(assert (=> (fuel_bool fuel%verismo!arch.addr_s.def_s.impl&%39.is_Size2m.) (forall ((self! Poly)) (! (= (verismo!arch.addr_s.def_s.impl&%39.is_Size2m.? self!) (is-verismo!arch.addr_s.def_s.PageSize./Size2m_ (%Poly%verismo!arch.addr_s.def_s.PageSize. self!))) :pattern ((verismo!arch.addr_s.def_s.impl&%39.is_Size2m.? self!))))))
(set-info :comment ";; Function-Axioms verismo::arch::addr_s::def_s::PageSize::size")
(assert (fuel_bool_default fuel%verismo!arch.addr_s.def_s.impl&%40.size.))
(assert (=> (fuel_bool fuel%verismo!arch.addr_s.def_s.impl&%40.size.) (forall ((self! Poly)) (! (= (verismo!arch.addr_s.def_s.impl&%40.size.? self!) (ite (is-verismo!arch.addr_s.def_s.PageSize./Size4k_ (%Poly%verismo!arch.addr_s.def_s.PageSize. self!)) 4096 2097152)) :pattern ((verismo!arch.addr_s.def_s.impl&%40.size.? self!))))))
...
(set-info :comment ";; Function-Specs verismo::arch::addr_s::def_s::PageSize::as_u64")
(declare-fun ens%verismo!arch.addr_s.def_s.impl&%38.as_u64. (verismo!arch.addr_s.def_s.PageSize. Int) Bool)
(assert (forall ((self! verismo!arch.addr_s.def_s.PageSize.) (ret! Int)) (! (= (ens%verismo!arch.addr_s.def_s.impl&%38.as_u64. self! ret!) (and (uInv 64 ret!) (= ret! (%I (verismo!tspec.integer.IntValue.as_int.? $ TYPE%verismo!arch.addr_s.def_s.PageSize. (Poly%verismo!arch.addr_s.def_s.PageSize. self!)))))) :pattern ((ens%verismo!arch.addr_s.def_s.impl&%38.as_u64. self! ret!)))))
(set-info :comment ";; Function-Def verismo::arch::addr_s::def_s::PageSize::as_u64")
(set-info :comment ";; verismo/src/arch/addr_s/def_s.rs:93:38: 93:49 (#7993)")
(set-info :comment ";; Function-Specs verismo::arch::addr_s::def_s::PageSize::from_u64")
(declare-fun ens%verismo!arch.addr_s.def_s.impl&%38.from_u64. (Int core!option.Option.) Bool)
(assert (forall ((val! Int) (ret! core!option.Option.)) (! (= (ens%verismo!arch.addr_s.def_s.impl&%38.from_u64. val! ret!) (and (has_type (Poly%core!option.Option. ret!) (TYPE%core!option.Option. $ TYPE%verismo!arch.addr_s.def_s.PageSize.)) (= ret! (verismo!arch.addr_s.def_s.impl&%38.spec_from_int.? (I val!))))) :pattern ((ens%verismo!arch.addr_s.def_s.impl&%38.from_u64. val! ret!)))))
(set-info :comment ";; Function-Def verismo::arch::addr_s::def_s::PageSize::from_u64")
(set-info :comment ";; verismo/src/arch/addr_s/def_s.rs:93:38: 93:49 (#7993)")
...
(assert (not (=> (= ret! (ite (= val! 0) (core!option.Option./Some (Poly%verismo!arch.addr_s.def_s.PageSize. verismo!arch.addr_s.def_s.PageSize./Size4k)) (ite (= val! 1) (core!option.Option./Some (Poly%verismo!arch.addr_s.def_s.PageSize. verismo!arch.addr_s.def_s.PageSize./Size2m)) core!option.Option./None))) (=> %%location_label%%0 (= ret! (verismo!arch.addr_s.def_s.impl&%38.spec_from_int.? (I val!)))))))
(check-sat)
(exit)
