...
(declare-const self! verismo!arch.addr_s.def_s.SpecPage.)
(declare-const n! Int)
(declare-const tmp%1 Int)
(declare-const tmp%2 Bool)
(declare-const ret@ vstd!set.Set<int.>.)
(assert fuel_defaults)
(assert (has_type (Poly%verismo!arch.addr_s.def_s.SpecPage. self!) (TYPE%verismo!arch.addr_s.def_s.SpecPage. T&. T&)))
(assert (<= 0 n!))
