...
(set-info :comment ";; MODULE 'module pgtable_e::def'")
...
(declare-const fuel%verismo!pgtable_e.def.PAT_RESET_VAL. FuelId)
...
(declare-const fuel%verismo!pgtable_e.def.impl&%3.empty. FuelId)
...
(declare-const fuel%verismo!pgtable_e.pte.impl&%3.pte. FuelId)
(declare-const fuel%verismo!pgtable_e.pte.impl&%3.pde. FuelId)
(declare-const fuel%verismo!pgtable_e.pte.impl&%3.pdpe. FuelId)
(declare-const fuel%verismo!pgtable_e.pte.impl&%3.pml4e. FuelId)
...
(declare-fun tr_bound%verismo!pgtable_e.def.PtePermsTrait. (Dcr Type) Bool)
...
(set-info :comment ";; Function-Decl verismo::ptr::snp::snp_u::SnpMemAttr::sw_eq")
...
(set-info :comment ";; Function-Decl verismo::pgtable_e::def::PAT_RESET_VAL")
(declare-fun verismo!pgtable_e.def.PAT_RESET_VAL.? () Int)
(set-info :comment ";; Function-Decl verismo::pgtable_e::def::PAGE_TABLE_LEVELS")
...
(set-info :comment ";; Function-Decl verismo::pgtable_e::def::SpecPTE::empty")
(declare-fun verismo!pgtable_e.def.impl&%3.empty.? (Poly) verismo!pgtable_e.def.SpecPTE.)
...
(set-info :comment ";; Function-Decl verismo::pgtable_e::def::top_lvl_idx")
(declare-fun verismo!pgtable_e.def.top_lvl_idx.? (Poly) tuple%2.)
(set-info :comment ";; Function-Decl verismo::pgtable_e::def::PtePermsTrait::pte")
(declare-fun verismo!pgtable_e.def.PtePermsTrait.pte.? (Dcr Type Poly Poly) Poly)
(declare-fun verismo!pgtable_e.def.PtePermsTrait.pte%default%.? (Dcr Type Poly Poly) Poly)
(set-info :comment ";; Function-Decl verismo::pgtable_e::def::PtePermsTrait::pde")
(declare-fun verismo!pgtable_e.def.PtePermsTrait.pde.? (Dcr Type Poly Poly) Poly)
(declare-fun verismo!pgtable_e.def.PtePermsTrait.pde%default%.? (Dcr Type Poly Poly) Poly)
(set-info :comment ";; Function-Decl verismo::pgtable_e::def::PtePermsTrait::pdpe")
(declare-fun verismo!pgtable_e.def.PtePermsTrait.pdpe.? (Dcr Type Poly Poly) Poly)
(declare-fun verismo!pgtable_e.def.PtePermsTrait.pdpe%default%.? (Dcr Type Poly Poly) Poly)
(set-info :comment ";; Function-Decl verismo::pgtable_e::def::PtePermsTrait::pml4e")
(declare-fun verismo!pgtable_e.def.PtePermsTrait.pml4e.? (Dcr Type Poly Poly) Poly)
(declare-fun verismo!pgtable_e.def.PtePermsTrait.pml4e%default%.? (Dcr Type Poly Poly) Poly)
(set-info :comment ";; Function-Decl verismo::pgtable_e::def::PtePermsTrait::entry")
(declare-fun verismo!pgtable_e.def.PtePermsTrait.entry.? (Dcr Type Poly Poly Poly) Poly)
(declare-fun verismo!pgtable_e.def.PtePermsTrait.entry%default%.? (Dcr Type Poly Poly Poly) Poly)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::spec_index0")
(declare-fun verismo!pgtable_e.pte.impl&%4.spec_index0.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::spec_index1")
(declare-fun verismo!pgtable_e.pte.impl&%4.spec_index1.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::spec_index2")
(declare-fun verismo!pgtable_e.pte.impl&%4.spec_index2.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::spec_index3")
(declare-fun verismo!pgtable_e.pte.impl&%4.spec_index3.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::spec_set_index0")
(declare-fun verismo!pgtable_e.pte.impl&%5.spec_set_index0.? (Poly Poly) verismo!pgtable_e.pte.SpecVAddrIndex.)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::spec_set_index1")
(declare-fun verismo!pgtable_e.pte.impl&%5.spec_set_index1.? (Poly Poly) verismo!pgtable_e.pte.SpecVAddrIndex.)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::spec_set_index2")
(declare-fun verismo!pgtable_e.pte.impl&%5.spec_set_index2.? (Poly Poly) verismo!pgtable_e.pte.SpecVAddrIndex.)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::spec_set_index3")
(declare-fun verismo!pgtable_e.pte.impl&%5.spec_set_index3.? (Poly Poly) verismo!pgtable_e.pte.SpecVAddrIndex.)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::spec_new")
(declare-fun verismo!pgtable_e.pte.impl&%6.spec_new.? (Poly Poly Poly Poly) verismo!pgtable_e.pte.SpecVAddrIndex.)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::new")
(declare-fun verismo!pgtable_e.pte.impl&%7.new.? (Poly) verismo!pgtable_e.pte.SpecVAddrIndex.)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::SpecVAddrIndex::to_value")
(declare-fun verismo!pgtable_e.pte.impl&%7.to_value.? (Poly) verismo!pgtable_e.pte.VAddrIndex.)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::VAddrIndex::inv")
(declare-fun verismo!pgtable_e.pte.impl&%20.inv.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::VAddrIndex::spec_new")
(declare-fun verismo!pgtable_e.pte.impl&%20.spec_new.? (Poly) verismo!pgtable_e.pte.VAddrIndex.)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::VAddrIndex::spec_index0")
(declare-fun verismo!pgtable_e.pte.impl&%20.spec_index0.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::VAddrIndex::spec_index1")
(declare-fun verismo!pgtable_e.pte.impl&%20.spec_index1.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::VAddrIndex::spec_index2")
(declare-fun verismo!pgtable_e.pte.impl&%20.spec_index2.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::VAddrIndex::spec_index3")
(declare-fun verismo!pgtable_e.pte.impl&%20.spec_index3.? (Poly) Int)
(set-info :comment ";; Function-Decl verismo::pgtable_e::pte::VAddrIndex::view")
...
(declare-fun %%lambda%%11 (Dcr Type Dcr Type Poly) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Poly) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%11 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4) i$) (verismo!tspec_e.array.array_t.impl&%2._spec_index.? %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 i$)) :pattern ((%%apply%%0 (%%lambda%%11 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4) i$)))))
(assert (=> (fuel_bool fuel%verismo!tspec_e.array.array_t.impl&%2.view.) (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (self! Poly)) (! (= (verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!) (vstd!seq.Seq.new.? T&. T& $ (TYPE%fun%1. $ INT T&. T&) (I (verismo!tspec_e.array.array_t.impl&%4.spec_len.? T&. T& N&. N&)) (Poly%fun%1. (mk_fun (%%lambda%%11 T&. T& N&. N& self!))))) :pattern ((verismo!tspec_e.array.array_t.impl&%2.view.? T&. T& N&. N& self!))))))
...
(set-info :comment ";; Function-Specs verismo::ptr::snp::snp_u::RmpAttr::clone")
...
(set-info :comment ";; Function-Specs verismo::tspec_e::array::Array::clone")
...
(set-info :comment ";; Function-Axioms verismo::pgtable_e::def::TrackedPTEPerms::vspec_cast_to")
...
(set-info :comment ";; Function-Def verismo::pgtable_e::def::PAGE_TABLE_LEVELS")
(set-info :comment ";; verismo/src/pgtable_e/def.rs:16:1: 16:37 (#0)")
