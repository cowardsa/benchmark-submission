...
(set-info :comment ";; verismo/src/tspec/setlib.rs:282:9: 282:15 (#0)")
...
(assert (not (=> (or (= (vstd!set.impl&%0.len.? T1&. T1& s1!) 0) (= (vstd!set.impl&%0.len.? T2&. T2& s2!) 0)) (=> %%location_label%%0 (= (nClip (Mul (vstd!set.impl&%0.len.? T1&. T1& s1!) (vstd!set.impl&%0.len.? T2&. T2& s2!))) 0)))))
(check-sat)
(exit)
