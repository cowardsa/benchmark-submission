...
(set-info :comment ";; Function-Specs verismo::arch::pgtable::def::MemMap::lemma_valid_translate")
(declare-fun req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_valid_translate. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap. verismo!arch.addr_s.def_s.SpecPage.) Bool)
(declare-const %%global_location_label%%37 Bool)
(declare-const %%global_location_label%%38 Bool)
(declare-const %%global_location_label%%39 Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.) (page! verismo!arch.addr_s.def_s.SpecPage.)) (! (= (req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_valid_translate. VT&. VT& PT&. PT& self! page!) (and (=> %%global_location_label%%37 (verismo!arch.addr_s.page.impl&%3.is_valid.? VT&. VT& (Poly%verismo!arch.addr_s.def_s.SpecPage. page!))) (=> %%global_location_label%%38 (verismo!arch.pgtable.memmap_s.impl&%0.is_valid.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!))) (=> %%global_location_label%%39 (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. page!)))))))))) :pattern ((req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_valid_translate. VT&. VT& PT&. PT& self! page!)))))
(declare-fun ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_valid_translate. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap. verismo!arch.addr_s.def_s.SpecPage.) Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.) (page! verismo!arch.addr_s.def_s.SpecPage.)) (! (= (ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_valid_translate. VT&. VT& PT&. PT& self! page!) (verismo!arch.addr_s.page.impl&%3.is_valid.? PT&. PT& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. page!))))))) :pattern ((ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_valid_translate. VT&. VT& PT&. PT& self! page!)))))
(set-info :comment ";; Function-Def verismo::arch::pgtable::def::MemMap::lemma_valid_translate")
(set-info :comment ";; verismo/src/arch/pgtable/memmap_p.rs:85:5: 85:66 (#0)")
...
(declare-const page! verismo!arch.addr_s.def_s.SpecPage.)
(assert fuel_defaults)
(assert (has_type (Poly%verismo!arch.pgtable.def.MemMap. self!) (TYPE%verismo!arch.pgtable.def.MemMap. VT&. VT& PT&. PT&)))
(assert (has_type (Poly%verismo!arch.addr_s.def_s.SpecPage. page!) (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&)))
(assert (tr_bound%verismo!arch.addr_s.def_s.AddrType. VT&. VT&))
(assert (tr_bound%verismo!arch.addr_s.def_s.AddrType. PT&. PT&))
(assert (verismo!arch.addr_s.page.impl&%3.is_valid.? VT&. VT& (Poly%verismo!arch.addr_s.def_s.SpecPage. page!)))
(assert (verismo!arch.pgtable.memmap_s.impl&%0.is_valid.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!)))
(assert (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. page!))))))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> %%location_label%%0 (verismo!arch.addr_s.page.impl&%3.is_valid.? PT&. PT& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. page!)))))))))
(check-sat)
(exit)
