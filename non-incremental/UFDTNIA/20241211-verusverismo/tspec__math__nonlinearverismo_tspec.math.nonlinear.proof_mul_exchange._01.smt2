...
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:111:1: 111:61 (#0)")
...
(set-info :comment ";; Function-Def verismo::tspec::math::nonlinear::proof_mul_exchange")
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:111:1: 111:61 (#0)")
...
(assert (not (=> (= ret! (Mul a! b!)) (and (=> %%location_label%%0 (= ret! (Mul a! b!))) (=> %%location_label%%1 (= ret! (Mul b! a!)))))))
(check-sat)
(exit)
