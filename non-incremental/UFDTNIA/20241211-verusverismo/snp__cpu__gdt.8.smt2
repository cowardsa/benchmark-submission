...
(assert (not (=> (= mask@ (uClip 64 280375465082880)) (=> (ens%verismo!snp.cpu.gdt.impl&%50.value. self! value@) (=> (= verus_tmp@1 value@) (=> (= verus_tmp_oldv@ verus_tmp@1) (=> (= oldv@1 verus_tmp_oldv@) (and (=> %%location_label%%0 (and (<= 0 (uClip 64 40)) (< (uClip 64 40) 64))) (=> (= value$1@ (uClip 64 (uintor 64 (I (uClip 64 (uintand 64 (I value@) (I (uClip 64 (uintnot 64 (I mask@))))))) (I (uClip 64 (uintshl 64 (I val!) (I (uClip 64 40)))))))) (=> (= ret@ (verismo!snp.cpu.gdt.Descriptor./Descriptor (%I (I value$1@)))) (=> (= actual_ret@ (verismo!snp.cpu.gdt.impl&%50.view.? (Poly%verismo!snp.cpu.gdt.Descriptor. ret@))) (=> (= expected_ret@ (verismo!snp.cpu.gdt.impl&%35.spec_set_attr_0_7.? (Poly%verismo!snp.cpu.gdt.DescriptorSpec. (verismo!snp.cpu.gdt.impl&%50.view.? (Poly%verismo!snp.cpu.gdt.Descriptor. self!))) (I val!))) (=> (= actual_ret@ expected_ret@) (=> (= ret! ret@) (=> %%location_label%%1 (= (verismo!snp.cpu.gdt.impl&%50.view.? (Poly%verismo!snp.cpu.gdt.Descriptor. ret!)) (verismo!snp.cpu.gdt.impl&%35.spec_set_attr_0_7.? (Poly%verismo!snp.cpu.gdt.DescriptorSpec. (verismo!snp.cpu.gdt.impl&%50.view.? (Poly%verismo!snp.cpu.gdt.Descriptor. self!))) (I val!))))))))))))))))))
(check-sat)
(exit)
