...
(set-info :comment ";; MODULE 'module tspec_e::size_e'")
...
(set-info :comment ";; Function-Specs core::mem::size_of")
...
(set-info :comment ";; Function-Specs verismo::tspec_e::size_e::sizeof")
(declare-fun ens%verismo!tspec_e.size_e.sizeof. (Dcr Type verismo!tspec.security.sectype.SecType<usize./tuple%0.>.) Bool)
(assert (forall ((T&. Dcr) (T& Type) (ret! verismo!tspec.security.sectype.SecType<usize./tuple%0.>.)) (! (= (ens%verismo!tspec_e.size_e.sizeof. T&. T& ret!) (and (%B (B (= (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<usize./tuple%0.>. ret!)) (I (verismo!tspec.size_s.spec_size.? T&. T&))))) (verismo!tspec.security.sectype.impl&%20.wf.? $ (UINT SZ) (Poly%verismo!tspec.security.sectype.SecType<usize./tuple%0.>. ret!)) (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<usize./tuple%0.>. ret!))))) :pattern ((ens%verismo!tspec_e.size_e.sizeof. T&. T& ret!)))))
(set-info :comment ";; Function-Def verismo::tspec_e::size_e::sizeof")
(set-info :comment ";; verismo/src/tspec_e/size_e.rs:4:1: 4:44 (#0)")
(declare-const T&. Dcr)
...
(assert (tr_bound%verismo!tspec.size_s.SpecSize. T&. T&))
...
(assert (not (=> (ens%core!mem.size_of. T&. T& tmp%1) (=> (ens%verismo!tspec.security.sectype.impl&%17.constant. $ (UINT SZ) $ TYPE%tuple%0. (I tmp%1) tmp%2) (=> (= ret! (%Poly%verismo!tspec.security.sectype.SecType<usize./tuple%0.>. tmp%2)) (and (=> %%location_label%%0 (%B (B (= (verismo!tspec.integer.IntOrd.ord_int.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<usize./tuple%0.>. ret!)) (I (verismo!tspec.size_s.spec_size.? T&. T&)))))) (and (=> %%location_label%%1 (verismo!tspec.security.sectype.impl&%20.wf.? $ (UINT SZ) (Poly%verismo!tspec.security.sectype.SecType<usize./tuple%0.>. ret!))) (=> %%location_label%%2 (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) (Poly%verismo!tspec.security.sectype.SecType<usize./tuple%0.>. ret!)))))))))))
(check-sat)
(exit)
