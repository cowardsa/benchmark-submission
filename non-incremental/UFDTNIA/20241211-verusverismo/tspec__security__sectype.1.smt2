...
(assert (not (=> (= ret! (verismo!tspec.security.sectype.SecType./SecType (I self!) (%Poly%verismo!tspec.security.sectype.SpecSecType. (Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.impl&%16.constant.? $ (UINT SZ) M&. M& (I self!)))))) (and (=> %%location_label%%0 (= ret! (%Poly%verismo!tspec.security.sectype.SecType. (Poly%verismo!tspec.security.sectype.SecType. (verismo!tspec.security.sectype.impl&%9.spec_new.? $ (UINT SZ) M&. M& (Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.impl&%16.constant.? $ (UINT SZ) M&. M& (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (UINT SZ) $ (UINT SZ) (I self!))))))))) (and (=> %%location_label%%1 (= (%Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) M&. M&) $ (UINT SZ) M&. M& (Poly%verismo!tspec.security.sectype.SecType. ret!))) (verismo!tspec.security.sectype.impl&%16.constant.? $ (UINT SZ) M&. M& (I self!)))) (=> %%location_label%%2 (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) M&. M&) (Poly%verismo!tspec.security.sectype.SecType. ret!)))))))))
(check-sat)
(exit)
