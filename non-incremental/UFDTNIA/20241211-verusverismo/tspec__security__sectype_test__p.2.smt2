...
(set-info :comment ";; verismo/src/tspec/security/sectype_test.rs:14:1: 14:43 (#0)")
...
(set-info :comment ";; verismo/src/tspec/security/sectype_test.rs:28:1: 28:48 (#0)")
...
(assert (not (and (=> %%location_label%%0 (< v1! 10)) (and (=> %%location_label%%1 (< v2! 10)) (=> (< (uClip 64 (uintand 64 (I v1!) (I v2!))) 10) (=> %%location_label%%2 (< (uClip 64 (uintand 64 (I v1!) (I v2!))) 10)))))))
(check-sat)
(exit)
