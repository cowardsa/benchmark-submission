...
(declare-const s@ verismo!tspec.security.sectype.SecType<u64./tuple%0.>.)
(assert fuel_defaults)
(assert (has_type self! (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.)))
(assert (%B (verismo!addr_e.addr_interface.AddrTrait.spec_valid_addr_with.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) self! (I 0))))
...
(assert (not (=> (= tmp%2 verismo!arch.addr_s.def_s.PAGE_SIZE.?) (=> (ens%verismo!tspec.security.sectype.impl&%80.into. $ TYPE%tuple%0. tmp%2 tmp%1) (=> (= s@ (%Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. tmp%1)) (and (=> %%location_label%%0 (req%verismo!tspec.security.sectype.impl&%364.div. $ TYPE%tuple%0. self! (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. s@))) (=> (ens%verismo!tspec.security.sectype.impl&%364.div. $ TYPE%tuple%0. self! (Poly%verismo!tspec.security.sectype.SecType<u64./tuple%0.>. s@) tmp%3) (=> (= %return! tmp%3) (and (=> %%location_label%%1 (= %return! (verismo!addr_e.addr_interface.AddrTrait.spec_to_page.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) self!))) (=> %%location_label%%2 (%B (verismo!addr_e.addr_interface.AddrTrait.spec_ensures_to_page.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT 64) $ TYPE%tuple%0.) self! %return!))))))))))))
(check-sat)
(exit)
