...
(declare-const %return! verismo!snp.cpu.gdt.Descriptor.)
(declare-const no%param Int)
(declare-const tmp%1 verismo!snp.cpu.gdt.Descriptor.)
(declare-const tmp%2 verismo!snp.cpu.gdt.Descriptor.)
(declare-const tmp%3 Int)
(declare-const tmp%4 verismo!snp.cpu.gdt.DescriptorAttr0_7.)
(declare-const tmp%5 verismo!snp.cpu.gdt.DescriptorAttr0_7.)
(declare-const tmp%6 Int)
(declare-const tmp%7 verismo!snp.cpu.gdt.Descriptor.)
(assert fuel_defaults)
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (ens%verismo!snp.cpu.gdt.impl&%51.entry_cs_sys. 0 tmp%1) (=> (ens%verismo!snp.cpu.gdt.impl&%51.entry_cs_sys. 0 tmp%2) (=> (ens%verismo!snp.cpu.gdt.impl&%50.get_attr_0_7. tmp%2 tmp%3) (=> (ens%verismo!snp.cpu.gdt.impl&%16.new. tmp%3 tmp%4) (and (=> %%location_label%%0 (req%verismo!snp.cpu.gdt.impl&%16.set_exe. tmp%4 0)) (=> (ens%verismo!snp.cpu.gdt.impl&%16.set_exe. tmp%4 0 tmp%5) (=> (ens%verismo!snp.cpu.gdt.impl&%16.value. tmp%5 tmp%6) (=> %%location_label%%1 (req%verismo!snp.cpu.gdt.impl&%50.set_attr_0_7. tmp%1 tmp%6)))))))))))
(check-sat)
(exit)
