...
(set-info :comment ";; MODULE 'module tspec::stream'")
...
(declare-const fuel%verismo!tspec.stream.stream_from_data. FuelId)
...
(set-info :comment ";; Function-Decl verismo::tspec::stream::stream_from_data")
(declare-fun verismo!tspec.stream.stream_from_data.? (Dcr Type Poly) vstd!seq.Seq<u8.>.)
...
(declare-fun %%lambda%%10 (Int Int) %%Function%%)
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Int) (v1$ Poly) (v2$ Poly)) (! (= (%%apply%%1 (%%lambda%%10 %%hole%%0 %%hole%%1) v1$ v2$) (I (uClip %%hole%%1 (uintshr %%hole%%0 (I (%I v1$)) (I (%I v2$)))))) :pattern ((%%apply%%1 (%%lambda%%10 %%hole%%0 %%hole%%1) v1$ v2$)))))
(assert (=> (fuel_bool fuel%verismo!tspec.fnspec.fn_spec_shr_u8_u8_u8.) (forall ((no%param Poly)) (! (= (verismo!tspec.fnspec.fn_spec_shr_u8_u8_u8.? no%param) (mk_fun (%%lambda%%10 8 8))) :pattern ((verismo!tspec.fnspec.fn_spec_shr_u8_u8_u8.? no%param))))))
...
(assert (=> (fuel_bool fuel%verismo!tspec.fnspec.fn_spec_shr_u16_u16_u16.) (forall ((no%param Poly)) (! (= (verismo!tspec.fnspec.fn_spec_shr_u16_u16_u16.? no%param) (mk_fun (%%lambda%%10 16 16))) :pattern ((verismo!tspec.fnspec.fn_spec_shr_u16_u16_u16.? no%param))))))
...
(assert (=> (fuel_bool fuel%verismo!tspec.fnspec.fn_spec_shr_u32_u32_u32.) (forall ((no%param Poly)) (! (= (verismo!tspec.fnspec.fn_spec_shr_u32_u32_u32.? no%param) (mk_fun (%%lambda%%10 32 32))) :pattern ((verismo!tspec.fnspec.fn_spec_shr_u32_u32_u32.? no%param))))))
...
(assert (=> (fuel_bool fuel%verismo!tspec.fnspec.fn_spec_shr_u64_u64_u64.) (forall ((no%param Poly)) (! (= (verismo!tspec.fnspec.fn_spec_shr_u64_u64_u64.? no%param) (mk_fun (%%lambda%%10 64 64))) :pattern ((verismo!tspec.fnspec.fn_spec_shr_u64_u64_u64.? no%param))))))
...
(assert (=> (fuel_bool fuel%verismo!tspec.fnspec.fn_spec_shr_usize_usize_usize.) (forall ((no%param Poly)) (! (= (verismo!tspec.fnspec.fn_spec_shr_usize_usize_usize.? no%param) (mk_fun (%%lambda%%10 SZ SZ))) :pattern ((verismo!tspec.fnspec.fn_spec_shr_usize_usize_usize.? no%param))))))
...
(set-info :comment ";; Function-Axioms verismo::tspec::stream::stream_from_data")
(assert (=> (fuel_bool fuel%verismo!tspec.stream.stream_from_data.) (forall ((T&. Dcr) (T& Type) (data! Poly)) (! (= (verismo!tspec.stream.stream_from_data.? T&. T& data!) (%Poly%vstd!seq.Seq<u8.>. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) data!))) :pattern ((verismo!tspec.stream.stream_from_data.? T&. T& data!))))))
...
(set-info :comment ";; Function-Specs verismo::tspec::stream::lemma_from_data")
(declare-fun ens%verismo!tspec.stream.lemma_from_data. (Dcr Type Poly vstd!seq.Seq<u8.>.) Bool)
(assert (forall ((T&. Dcr) (T& Type) (data! Poly) (ret! vstd!seq.Seq<u8.>.)) (! (= (ens%verismo!tspec.stream.lemma_from_data. T&. T& data! ret!) (and (= ret! (verismo!tspec.stream.stream_from_data.? T&. T& data!)) (= (verismo!tspec.stream.stream_from_data.? T&. T& (verismo!tspec.stream.stream_to_data.? T&. T& (Poly%vstd!seq.Seq<u8.>. ret!))) ret!))) :pattern ((ens%verismo!tspec.stream.lemma_from_data. T&. T& data! ret!)))))
(set-info :comment ";; Function-Def verismo::tspec::stream::lemma_from_data")
(set-info :comment ";; verismo/src/tspec/stream/mod.rs:32:1: 32:84 (#0)")
(declare-const T&. Dcr)
(declare-const T& Type)
(declare-const ret! vstd!seq.Seq<u8.>.)
(declare-const data! Poly)
(assert fuel_defaults)
(assert (has_type data! T&))
(assert (tr_bound%verismo!tspec.cast.VTypeCast. T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (fuel_bool fuel%verismo!tspec.stream.stream_from_data.) (=> (= ret! (verismo!tspec.stream.stream_from_data.? T&. T& data!)) (and (=> %%location_label%%0 (= ret! (verismo!tspec.stream.stream_from_data.? T&. T& data!))) (=> %%location_label%%1 (= (verismo!tspec.stream.stream_from_data.? T&. T& (verismo!tspec.stream.stream_to_data.? T&. T& (Poly%vstd!seq.Seq<u8.>. ret!))) ret!)))))))
(check-sat)
(exit)
