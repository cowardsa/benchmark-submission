...
(assert (not (=> (= ret! (verismo!snp.cpu.gdt.DescriptorAttr0_7./DescriptorAttr0_7 (%I (I val!)))) (and (=> %%location_label%%0 (= ret! (verismo!snp.cpu.gdt.impl&%16.spec_new.? (I val!)))) (=> %%location_label%%1 (= (verismo!snp.cpu.gdt.impl&%16.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. ret!)) (verismo!snp.cpu.gdt.impl&%3.new.? (I val!))))))))
(check-sat)
(exit)
