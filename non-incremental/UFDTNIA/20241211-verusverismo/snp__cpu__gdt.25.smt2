...
(declare-const tmp%3 verismo!snp.cpu.gdt.Descriptor.)
(declare-const tmp%4 verismo!snp.cpu.gdt.Descriptor.)
(declare-const tmp%5 verismo!snp.cpu.gdt.Descriptor.)
(declare-const tmp%6 verismo!snp.cpu.gdt.DescriptorAttr0_7.)
(declare-const tmp%7 verismo!snp.cpu.gdt.DescriptorAttr0_7.)
(declare-const tmp%8 verismo!snp.cpu.gdt.DescriptorAttr0_7.)
(declare-const tmp%9 verismo!snp.cpu.gdt.DescriptorAttr0_7.)
(declare-const tmp%10 verismo!snp.cpu.gdt.DescriptorAttr0_7.)
(declare-const tmp%11 verismo!snp.cpu.gdt.DescriptorAttr0_7.)
(declare-const tmp%12 Int)
(declare-const tmp%13 verismo!snp.cpu.gdt.Descriptor.)
(declare-const tmp%14 verismo!snp.cpu.gdt.DescriptorAttr8_11.)
(declare-const tmp%15 verismo!snp.cpu.gdt.DescriptorAttr8_11.)
(declare-const tmp%16 verismo!snp.cpu.gdt.DescriptorAttr8_11.)
(declare-const tmp%17 verismo!snp.cpu.gdt.DescriptorAttr8_11.)
(declare-const tmp%18 Int)
(declare-const tmp%19 verismo!snp.cpu.gdt.Descriptor.)
...
(assert (not (=> (ens%verismo!snp.cpu.gdt.impl&%50.empty. 0 tmp%1) (and (=> %%location_label%%0 (req%verismo!snp.cpu.gdt.impl&%50.set_limit0_15. tmp%1 65535)) (=> (ens%verismo!snp.cpu.gdt.impl&%50.set_limit0_15. tmp%1 65535 tmp%2) (and (=> %%location_label%%1 (req%verismo!snp.cpu.gdt.impl&%50.set_limit16_19. tmp%2 15)) (=> (ens%verismo!snp.cpu.gdt.impl&%50.set_limit16_19. tmp%2 15 tmp%3) (and (=> %%location_label%%2 (req%verismo!snp.cpu.gdt.impl&%50.set_base0_23. tmp%3 0)) (=> (ens%verismo!snp.cpu.gdt.impl&%50.set_base0_23. tmp%3 0 tmp%4) (and (=> %%location_label%%3 (req%verismo!snp.cpu.gdt.impl&%50.set_base24_31. tmp%4 0)) (=> (ens%verismo!snp.cpu.gdt.impl&%50.set_base24_31. tmp%4 0 tmp%5) (=> (ens%verismo!snp.cpu.gdt.impl&%16.empty. 0 tmp%6) (and (=> %%location_label%%4 (req%verismo!snp.cpu.gdt.impl&%16.set_dpl. tmp%6 0)) (=> (ens%verismo!snp.cpu.gdt.impl&%16.set_dpl. tmp%6 0 tmp%7) (and (=> %%location_label%%5 (req%verismo!snp.cpu.gdt.impl&%16.set_sys. tmp%7 1)) (=> (ens%verismo!snp.cpu.gdt.impl&%16.set_sys. tmp%7 1 tmp%8) (and (=> %%location_label%%6 (req%verismo!snp.cpu.gdt.impl&%16.set_write. tmp%8 1)) (=> (ens%verismo!snp.cpu.gdt.impl&%16.set_write. tmp%8 1 tmp%9) (and (=> %%location_label%%7 (req%verismo!snp.cpu.gdt.impl&%16.set_exe. tmp%9 1)) (=> (ens%verismo!snp.cpu.gdt.impl&%16.set_exe. tmp%9 1 tmp%10) (and (=> %%location_label%%8 (req%verismo!snp.cpu.gdt.impl&%16.set_present. tmp%10 1)) (=> (ens%verismo!snp.cpu.gdt.impl&%16.set_present. tmp%10 1 tmp%11) (=> (ens%verismo!snp.cpu.gdt.impl&%16.value. tmp%11 tmp%12) (and (=> %%location_label%%9 (req%verismo!snp.cpu.gdt.impl&%50.set_attr_0_7. tmp%5 tmp%12)) (=> (ens%verismo!snp.cpu.gdt.impl&%50.set_attr_0_7. tmp%5 tmp%12 tmp%13) (=> (ens%verismo!snp.cpu.gdt.impl&%33.empty. 0 tmp%14) (and (=> %%location_label%%10 (req%verismo!snp.cpu.gdt.impl&%33.set_long. tmp%14 0)) (=> (ens%verismo!snp.cpu.gdt.impl&%33.set_long. tmp%14 0 tmp%15) (and (=> %%location_label%%11 (req%verismo!snp.cpu.gdt.impl&%33.set_size32_or_16. tmp%15 1)) (=> (ens%verismo!snp.cpu.gdt.impl&%33.set_size32_or_16. tmp%15 1 tmp%16) (and (=> %%location_label%%12 (req%verismo!snp.cpu.gdt.impl&%33.set_granularity. tmp%16 1)) (=> (ens%verismo!snp.cpu.gdt.impl&%33.set_granularity. tmp%16 1 tmp%17) (=> (ens%verismo!snp.cpu.gdt.impl&%33.value. tmp%17 tmp%18) (=> %%location_label%%13 (req%verismo!snp.cpu.gdt.impl&%50.set_attr_8_11. tmp%13 tmp%18)))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
