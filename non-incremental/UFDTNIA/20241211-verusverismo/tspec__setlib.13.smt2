...
(set-info :comment ";; MODULE 'module tspec::setlib'")
...
(set-info :comment ";; Function-Decl verismo::tspec::setlib::convert_set")
...
(set-info :comment ";; Function-Decl verismo::tspec::setlib::set_uop")
(declare-fun verismo!tspec.setlib.set_uop.? (Dcr Type Dcr Type Poly Poly) Poly)
(set-info :comment ";; Function-Decl verismo::tspec::setlib::set_bop_recursive")
...
(set-info :comment ";; Function-Decl verismo::tspec::setlib::set_op1")
(declare-fun verismo!tspec.setlib.set_op1.? (Dcr Type Dcr Type Dcr Type Poly Poly Poly) Poly)
(set-info :comment ";; Function-Decl verismo::tspec::setlib::exchange_spec_fn")
...
(set-info :comment ";; Function-Axioms verismo::tspec::setlib::convert_set")
...
(set-info :comment ";; Function-Axioms verismo::tspec::setlib::set_uop")
...
(set-info :comment ";; Function-Axioms verismo::tspec::setlib::set_op1")
...
(set-info :comment ";; Function-Specs verismo::tspec::setlib::set_bop_recursive")
...
(set-info :comment ";; Spec-Termination verismo::tspec::setlib::set_bop_recursive")
(set-info :comment ";; verismo/src/tspec/setlib.rs:61:6: 65:13 (#0)")
(set-info :comment ";; Function-Axioms verismo::tspec::setlib::set_bop_recursive")
...
(set-info :comment ";; Function-Axioms verismo::tspec::setlib::exchange_spec_fn")
...
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_set_uop_len")
...
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_set_uop_len")
(set-info :comment ";; verismo/src/tspec/setlib.rs:217:1: 217:95 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_setop1")
...
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_setop1")
(set-info :comment ";; verismo/src/tspec/setlib.rs:92:7: 94:2 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_setop_3_union")
(declare-fun req%verismo!tspec.setlib.lemma_setop_3_union. (Dcr Type Dcr Type Dcr Type Poly Poly %%Function%% Poly) Bool)
(declare-const %%global_location_label%%49 Bool)
(declare-const %%global_location_label%%50 Bool)
(declare-const %%global_location_label%%51 Bool)
(declare-const %%global_location_label%%52 Bool)
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (op_fn! %%Function%%) (vv1! Poly)) (! (= (req%verismo!tspec.setlib.lemma_setop_3_union. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! vv1!) (and (=> %%global_location_label%%49 (> (vstd!set.impl&%0.len.? T1&. T1& s1!) 0)) (=> %%global_location_label%%50 (vstd!set.impl&%0.contains.? T1&. T1& s1! vv1!)) (=> %%global_location_label%%51 (vstd!set.impl&%0.finite.? T1&. T1& s1!)) (=> %%global_location_label%%52 (vstd!set.impl&%0.finite.? T2&. T2& s2!)))) :pattern ((req%verismo!tspec.setlib.lemma_setop_3_union. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! vv1!)))))
(declare-fun ens%verismo!tspec.setlib.lemma_setop_3_union. (Dcr Type Dcr Type Dcr Type Poly Poly %%Function%% Poly tuple%3.) Bool)
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (op_fn! %%Function%%) (vv1! Poly) (ret! tuple%3.)) (! (= (ens%verismo!tspec.setlib.lemma_setop_3_union. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! vv1! ret!) (and (has_type (Poly%tuple%3. ret!) (TYPE%tuple%3. $ (TYPE%vstd!set.Set. T3&. T3&) $ (TYPE%vstd!set.Set. T3&. T3&) $ (TYPE%vstd!set.Set. T3&. T3&))) (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! T1& T2& T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. (Poly%fun%2. op_fn!)) vv1!))))))))) (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (vstd!set.impl&%0.union.? T3&. T3& (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. ret!))) (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. ret!))))))) :pattern ((ens%verismo!tspec.setlib.lemma_setop_3_union. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! vv1! ret!)))))
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_setop_3_union")
(set-info :comment ";; verismo/src/tspec/setlib.rs:143:7: 148:39 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_setop_eq_recursive")
(declare-fun req%verismo!tspec.setlib.lemma_setop_eq_recursive. (Dcr Type Dcr Type Dcr Type Poly Poly %%Function%%) Bool)
(declare-const %%global_location_label%%53 Bool)
(declare-const %%global_location_label%%54 Bool)
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (op_fn! %%Function%%)) (! (= (req%verismo!tspec.setlib.lemma_setop_eq_recursive. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn!) (and (=> %%global_location_label%%53 (vstd!set.impl&%0.finite.? T1&. T1& s1!)) (=> %%global_location_label%%54 (vstd!set.impl&%0.finite.? T2&. T2& s2!)))) :pattern ((req%verismo!tspec.setlib.lemma_setop_eq_recursive. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn!)))))
(declare-fun ens%verismo!tspec.setlib.lemma_setop_eq_recursive. (Dcr Type Dcr Type Dcr Type Poly Poly %%Function%% Poly) Bool)
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (op_fn! %%Function%%) (ret! Poly)) (! (= (ens%verismo!tspec.setlib.lemma_setop_eq_recursive. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! ret!) (and (has_type ret! (TYPE%vstd!set.Set. T3&. T3&)) (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (verismo!tspec.setlib.set_bop_recursive.? T1&. T1& T2&. T2& T3&. T3& s1! s2! (Poly%fun%2. op_fn!))))) :pattern ((ens%verismo!tspec.setlib.lemma_setop_eq_recursive. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! ret!)))))
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_setop_eq_recursive")
(set-info :comment ";; verismo/src/tspec/setlib.rs:291:7: 295:19 (#0)")
(set-info :comment ";; Function-Specs vstd::set_lib::lemma_len_union")
(declare-fun req%vstd!set_lib.lemma_len_union. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%55 Bool)
(declare-const %%global_location_label%%56 Bool)
(assert (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (! (= (req%vstd!set_lib.lemma_len_union. A&. A& s1! s2!) (and (=> %%global_location_label%%55 (vstd!set.impl&%0.finite.? A&. A& s1!)) (=> %%global_location_label%%56 (vstd!set.impl&%0.finite.? A&. A& s2!)))) :pattern ((req%vstd!set_lib.lemma_len_union. A&. A& s1! s2!)))))
(declare-fun ens%vstd!set_lib.lemma_len_union. (Dcr Type Poly Poly) Bool)
(assert (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (! (= (ens%vstd!set_lib.lemma_len_union. A&. A& s1! s2!) (<= (vstd!set.impl&%0.len.? A&. A& (vstd!set.impl&%0.union.? A&. A& s1! s2!)) (nClip (Add (vstd!set.impl&%0.len.? A&. A& s1!) (vstd!set.impl&%0.len.? A&. A& s2!))))) :pattern ((ens%vstd!set_lib.lemma_len_union. A&. A& s1! s2!)))))
...
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_set_bop_len_recursive")
(declare-fun req%verismo!tspec.setlib.lemma_set_bop_len_recursive. (Dcr Type Dcr Type Dcr Type Poly Poly %%Function%%) Bool)
(declare-const %%global_location_label%%57 Bool)
(declare-const %%global_location_label%%58 Bool)
(assert (forall ((T1&. Dcr) (T1& Type) (T3&. Dcr) (T3& Type) (T2&. Dcr) (T2& Type) (s1! Poly) (s2! Poly) (op_fn! %%Function%%)) (! (= (req%verismo!tspec.setlib.lemma_set_bop_len_recursive. T1&. T1& T3&. T3& T2&. T2& s1! s2! op_fn!) (and (=> %%global_location_label%%57 (vstd!set.impl&%0.finite.? T1&. T1& s1!)) (=> %%global_location_label%%58 (vstd!set.impl&%0.finite.? T2&. T2& s2!)))) :pattern ((req%verismo!tspec.setlib.lemma_set_bop_len_recursive. T1&. T1& T3&. T3& T2&. T2& s1! s2! op_fn!)))))
(declare-fun ens%verismo!tspec.setlib.lemma_set_bop_len_recursive. (Dcr Type Dcr Type Dcr Type Poly Poly %%Function%% Poly) Bool)
(assert (forall ((T1&. Dcr) (T1& Type) (T3&. Dcr) (T3& Type) (T2&. Dcr) (T2& Type) (s1! Poly) (s2! Poly) (op_fn! %%Function%%) (ret! Poly)) (! (= (ens%verismo!tspec.setlib.lemma_set_bop_len_recursive. T1&. T1& T3&. T3& T2&. T2& s1! s2! op_fn! ret!) (and (has_type ret! (TYPE%vstd!set.Set. T3&. T3&)) (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (verismo!tspec.setlib.set_bop_recursive.? T1&. T1& T2&. T2& T3&. T3& s1! s2! (Poly%fun%2. op_fn!))) (= (= (vstd!set.impl&%0.len.? T3&. T3& ret!) 0) (or (= (vstd!set.impl&%0.len.? T1&. T1& s1!) 0) (= (vstd!set.impl&%0.len.? T2&. T2& s2!) 0))) (<= (vstd!set.impl&%0.len.? T3&. T3& ret!) (nClip (Mul (vstd!set.impl&%0.len.? T1&. T1& s1!) (vstd!set.impl&%0.len.? T2&. T2& s2!)))) (vstd!set.impl&%0.finite.? T3&. T3& ret!))) :pattern ((ens%verismo!tspec.setlib.lemma_set_bop_len_recursive. T1&. T1& T3&. T3& T2&. T2& s1! s2! op_fn! ret!)))))
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_set_bop_len_recursive")
(set-info :comment ";; verismo/src/tspec/setlib.rs:242:7: 246:19 (#0)")
...
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (op_fn! %%Function%%)) (! (= (req%verismo!tspec.setlib.lemma_setop_len. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn!) (and (=> %%global_location_label%%59 (vstd!set.impl&%0.finite.? T1&. T1& s1!)) (=> %%global_location_label%%60 (vstd!set.impl&%0.finite.? T2&. T2& s2!)))) :pattern ((req%verismo!tspec.setlib.lemma_setop_len. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn!)))))
...
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_setop_len")
(set-info :comment ";; verismo/src/tspec/setlib.rs:316:1: 320:19 (#0)")
(set-info :comment ";; Function-Specs vstd::set_lib::impl&%0::lemma_len0_is_empty")
...
(assert (forall ((A&. Dcr) (A& Type) (self! Poly)) (! (= (req%vstd!set_lib.impl&%0.lemma_len0_is_empty. A&. A& self!) (and (=> %%global_location_label%%61 (vstd!set.impl&%0.finite.? A&. A& self!)) (=> %%global_location_label%%62 (= (vstd!set.impl&%0.len.? A&. A& self!) 0)))) :pattern ((req%vstd!set_lib.impl&%0.lemma_len0_is_empty. A&. A& self!)))))
(declare-fun ens%vstd!set_lib.impl&%0.lemma_len0_is_empty. (Dcr Type Poly) Bool)
(assert (forall ((A&. Dcr) (A& Type) (self! Poly)) (! (= (ens%vstd!set_lib.impl&%0.lemma_len0_is_empty. A&. A& self!) (= self! (vstd!set.impl&%0.empty.? A&. A&))) :pattern ((ens%vstd!set_lib.impl&%0.lemma_len0_is_empty. A&. A& self!)))))
...
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_ret_is_empty")
(set-info :comment ";; verismo/src/tspec/setlib.rs:8:1: 8:58 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_union")
...
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_union")
(set-info :comment ";; verismo/src/tspec/setlib.rs:25:1: 25:52 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_union_self")
(declare-fun ens%verismo!tspec.setlib.lemma_union_self. (Dcr Type Poly) Bool)
(assert (forall ((A&. Dcr) (A& Type) (s1! Poly)) (! (= (ens%verismo!tspec.setlib.lemma_union_self. A&. A& s1!) (ext_eq true (TYPE%vstd!set.Set. A&. A&) (vstd!set.impl&%0.union.? A&. A& s1! s1!) s1!)) :pattern ((ens%verismo!tspec.setlib.lemma_union_self. A&. A& s1!)))))
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_union_self")
(set-info :comment ";; verismo/src/tspec/setlib.rs:19:1: 19:45 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_setop_without_loss_disjoint")
(declare-fun req%verismo!tspec.setlib.lemma_setop_without_loss_disjoint. (Dcr Type Dcr Type Dcr Type Poly Poly Poly %%Function%% %%Function%%) Bool)
...
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (vv1! Poly) (op_fn! %%Function%%) (reverse_op_fn! %%Function%%)) (! (= (req%verismo!tspec.setlib.lemma_setop_without_loss_disjoint. T1&. T1& T2&. T2& T3&. T3& s1! s2! vv1! op_fn! reverse_op_fn!) (and (=> %%global_location_label%%63 (> (vstd!set.impl&%0.len.? T1&. T1& s1!) 0)) (=> %%global_location_label%%64 (vstd!set.impl&%0.contains.? T1&. T1& s1! vv1!)) (=> %%global_location_label%%65 (forall ((v1$ Poly) (v2$ Poly)) (! (=> (and (has_type v1$ T1&) (has_type v2$ T2&)) (= (%Poly%tuple%2. (%%apply%%0 reverse_op_fn! (%%apply%%1 op_fn! v1$ v2$))) (tuple%2./tuple%2 v1$ v2$))) :pattern ((%%apply%%1 op_fn! v1$ v2$))))))) :pattern ((req%verismo!tspec.setlib.lemma_setop_without_loss_disjoint. T1&. T1& T2&. T2& T3&. T3& s1! s2! vv1! op_fn! reverse_op_fn!)))))
(declare-fun ens%verismo!tspec.setlib.lemma_setop_without_loss_disjoint. (Dcr Type Dcr Type Dcr Type Poly Poly Poly %%Function%% %%Function%%) Bool)
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (vv1! Poly) (op_fn! %%Function%%) (reverse_op_fn! %%Function%%)) (! (= (ens%verismo!tspec.setlib.lemma_setop_without_loss_disjoint. T1&. T1& T2&. T2& T3&. T3& s1! s2! vv1! op_fn! reverse_op_fn!) (vstd!set.impl&%0.disjoint.? T3&. T3& (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. (Poly%fun%2. op_fn!)) vv1!)))))))) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! T1& T2& T1&. T1& (vstd!set.impl&%0.remove.? T1&. T1& s1! vv1!) T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!)))))))) :pattern ((ens%verismo!tspec.setlib.lemma_setop_without_loss_disjoint. T1&. T1& T2&. T2& T3&. T3& s1! s2! vv1! op_fn! reverse_op_fn!)))))
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_setop_without_loss_disjoint")
(set-info :comment ";; verismo/src/tspec/setlib.rs:109:7: 115:2 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_op_exchange")
(declare-fun req%verismo!tspec.setlib.lemma_op_exchange. (Dcr Type Dcr Type Dcr Type Poly Poly %%Function%%) Bool)
...
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (op_fn! %%Function%%)) (! (= (req%verismo!tspec.setlib.lemma_op_exchange. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn!) (and (=> %%global_location_label%%66 (> (vstd!set.impl&%0.len.? T1&. T1& s1!) 0)) (=> %%global_location_label%%67 (vstd!set.impl&%0.finite.? T1&. T1& s1!)) (=> %%global_location_label%%68 (vstd!set.impl&%0.finite.? T2&. T2& s2!)))) :pattern ((req%verismo!tspec.setlib.lemma_op_exchange. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn!)))))
(declare-fun ens%verismo!tspec.setlib.lemma_op_exchange. (Dcr Type Dcr Type Dcr Type Poly Poly %%Function%% Poly) Bool)
(assert (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (op_fn! %%Function%%) (ret! Poly)) (! (= (ens%verismo!tspec.setlib.lemma_op_exchange. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! ret!) (and (has_type ret! (TYPE%vstd!set.Set. T3&. T3&)) (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T2&. T2& s2! T1&. T1& s1! T2& T1& T2&. T2& s2! T1&. T1& s1! (%Poly%fun%2. (Poly%fun%2. (verismo!tspec.setlib.exchange_spec_fn.? T1&. T1& T2&. T2& T3&. T3& (Poly%fun%2. op_fn!))))))))))) :pattern ((ens%verismo!tspec.setlib.lemma_op_exchange. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! ret!)))))
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_op_exchange")
(set-info :comment ";; verismo/src/tspec/setlib.rs:201:1: 205:19 (#0)")
(set-info :comment ";; Function-Specs verismo::tspec::setlib::lemma_seq_add_subrange")
(declare-fun ens%verismo!tspec.setlib.lemma_seq_add_subrange. (Dcr Type Poly Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly)) (! (= (ens%verismo!tspec.setlib.lemma_seq_add_subrange. T&. T& s1! s2!) (ext_eq true (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& (vstd!seq.Seq.add.? T&. T& s1! s2!) (I (vstd!seq.Seq.len.? T&. T& s1!)) (I (vstd!seq.Seq.len.? T&. T& (vstd!seq.Seq.add.? T&. T& s1! s2!)))) s2!)) :pattern ((ens%verismo!tspec.setlib.lemma_seq_add_subrange. T&. T& s1! s2!)))))
(set-info :comment ";; Function-Def verismo::tspec::setlib::lemma_seq_add_subrange")
(set-info :comment ";; verismo/src/tspec/setlib.rs:336:1: 336:63 (#0)")
(declare-const T&. Dcr)
...
(assert (not (=> %%location_label%%0 (ext_eq true (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& (vstd!seq.Seq.add.? T&. T& s1! s2!) (I (vstd!seq.Seq.len.? T&. T& s1!)) (I (vstd!seq.Seq.len.? T&. T& (vstd!seq.Seq.add.? T&. T& s1! s2!)))) s2!))))
(check-sat)
(exit)
