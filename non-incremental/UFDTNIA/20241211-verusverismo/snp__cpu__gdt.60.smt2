...
(assert (not (=> (= ret! (verismo!snp.cpu.gdt.Descriptor./Descriptor (%I (I val!)))) (and (=> %%location_label%%0 (= ret! (verismo!snp.cpu.gdt.impl&%50.spec_new.? (I val!)))) (=> %%location_label%%1 (= (verismo!snp.cpu.gdt.impl&%50.view.? (Poly%verismo!snp.cpu.gdt.Descriptor. ret!)) (verismo!snp.cpu.gdt.impl&%37.new.? (I val!))))))))
(check-sat)
(exit)
