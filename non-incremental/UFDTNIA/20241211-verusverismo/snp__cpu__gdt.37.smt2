...
(assert (not (=> (ens%verismo!tspec.math.bits_p.bit64_and_auto. 0) (=> (= mask@ (uClip 64 1)) (=> (ens%verismo!snp.cpu.gdt.impl&%16.value. self! tmp%1) (and (=> %%location_label%%0 (and (<= 0 (uClip 64 1)) (< (uClip 64 1) 64))) (=> (= ret! (uClip 64 (uintand 64 (I (uClip 64 (uintshr 64 (I tmp%1) (I (uClip 64 1))))) (I mask@)))) (and (=> %%location_label%%1 (= ret! (verismo!snp.cpu.gdt.impl&%0.spec_write.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7Spec. (verismo!snp.cpu.gdt.impl&%16.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. self!)))))) (=> %%location_label%%2 (<= (verismo!snp.cpu.gdt.impl&%0.spec_write.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7Spec. (verismo!snp.cpu.gdt.impl&%16.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr0_7. self!)))) (uClip 64 1)))))))))))
(check-sat)
(exit)
