...
(assert (has_type params! (TYPE%verismo!primitives_e.vec.PushParam. T&. T&)))
(assert (%B (verismo!vbox.vbox.MutFnTrait.spec_update_requires.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ (TYPE%verismo!primitives_e.vec.PushParam. T&. T&) $ BOOL self!@0 params!)))
(declare-const self!@1 Poly)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= tmp%1 (verismo!primitives_e.vec.PushParam./PushParam/val (%Poly%verismo!primitives_e.vec.PushParam. params!))) (=> (has_type self!@1 (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.)) (=> (ens%alloc!vec.impl&%1.push. T&. T& $ TYPE%alloc!alloc.Global. self!@0 self!@1 tmp%1) (=> (= %return! (B true)) (=> %%location_label%%0 (%B (verismo!vbox.vbox.MutFnTrait.spec_update.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ (TYPE%verismo!primitives_e.vec.PushParam. T&. T&) $ BOOL self!@1 self!@0 params! %return!)))))))))
(check-sat)
(exit)
