...
(set-info :comment ";; MODULE 'module allocator::buddy'")
...
(declare-const fuel%verismo!allocator.buddy.MIN_ADDR_ALIGN. FuelId)
(declare-const fuel%verismo!allocator.buddy.ORDER. FuelId)
(declare-const fuel%verismo!allocator.buddy.ORDER_USIZE. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%2.vspec_cast_to. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%3.spec_size_def. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%5.wf. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%6.is_constant. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%6.is_constant_to. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%7.view. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8.valid_bucket. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8.wf_bucket. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8.wf_perm. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8.wf_before_validate_write. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8.inv. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8.spec_pop_or_push_element. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8.spec_add_one_to_bucket. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8.spec_add_one_to_bucket2. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8.spec_remove_or_insert_one. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8._spec_remove_or_insert_one. FuelId)
(declare-const fuel%verismo!allocator.buddy.impl&%8._spec_remove_or_insert_one2. FuelId)
(declare-const fuel%verismo!allocator.buddy.alloc_valid_size. FuelId)
...
(declare-const fuel%verismo!ptr.ptr_u.impl&%2.is_assigned. FuelId)
(declare-const fuel%verismo!ptr.ptr_u.impl&%2.is_valid_private. FuelId)
...
(declare-const fuel%verismo!ptr.ptr_u.impl&%2.ptr_not_null_wf. FuelId)
(declare-const fuel%verismo!ptr.ptr_u.impl&%2.ptr_not_null_private_wf. FuelId)
(declare-const fuel%verismo!ptr.ptr_u.impl&%2.ensures_read. FuelId)
...
(declare-const fuel%verismo!ptr.raw_ptr_t.spec_set_zeros. FuelId)
(declare-const fuel%verismo!allocator.alloc_valid_ptr. FuelId)
(declare-const fuel%verismo!allocator.valid_free_ptr. FuelId)
...
(declare-sort vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. 0)
(declare-sort vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. 0)
...
(declare-sort vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. 0)
(declare-sort vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. 0)
...
(declare-fun verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/perms (verismo!allocator.buddy.BuddyAllocator.) vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>.)
(declare-fun verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/free_lists (verismo!allocator.buddy.BuddyAllocator.) Poly)
(declare-fun verismo!allocator.buddy.SpecBuddyAllocator./SpecBuddyAllocator/perms (verismo!allocator.buddy.SpecBuddyAllocator.) vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>.)
(declare-fun verismo!allocator.buddy.SpecBuddyAllocator./SpecBuddyAllocator/free_lists (verismo!allocator.buddy.SpecBuddyAllocator.) vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>.)
...
(declare-const TYPE%verismo!allocator.buddy.BuddyAllocator. Type)
(declare-const TYPE%verismo!allocator.buddy.SpecBuddyAllocator. Type)
...
(declare-const TYPE%anonymous_closure%9260. Type)
(declare-fun Poly%fun%1. (%%Function%%) Poly)
(declare-fun %Poly%fun%1. (Poly) %%Function%%)
(declare-fun Poly%fun%2. (%%Function%%) Poly)
(declare-fun %Poly%fun%2. (Poly) %%Function%%)
(declare-fun Poly%anonymous_closure%9260. (anonymous_closure%9260.) Poly)
(declare-fun %Poly%anonymous_closure%9260. (Poly) anonymous_closure%9260.)
(declare-fun Poly%verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>. (verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>.) Poly)
(declare-fun %Poly%verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>. (Poly) verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>.)
...
(declare-fun Poly%vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. (vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>.) Poly)
(declare-fun %Poly%vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. (Poly) vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>.)
(declare-fun Poly%vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. (vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>.) Poly)
(declare-fun %Poly%vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. (Poly) vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>.)
...
(declare-fun Poly%vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. (vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>.) Poly)
(declare-fun %Poly%vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. (Poly) vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>.)
(declare-fun Poly%vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. (vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>.) Poly)
(declare-fun %Poly%vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. (Poly) vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>.)
...
(declare-fun Poly%vstd!set.Set<tuple%2<nat./nat.>.>. (vstd!set.Set<tuple%2<nat./nat.>.>.) Poly)
(declare-fun %Poly%vstd!set.Set<tuple%2<nat./nat.>.>. (Poly) vstd!set.Set<tuple%2<nat./nat.>.>.)
...
(declare-fun Poly%verismo!allocator.buddy.BuddyAllocator. (verismo!allocator.buddy.BuddyAllocator.) Poly)
(declare-fun %Poly%verismo!allocator.buddy.BuddyAllocator. (Poly) verismo!allocator.buddy.BuddyAllocator.)
(declare-fun Poly%verismo!allocator.buddy.SpecBuddyAllocator. (verismo!allocator.buddy.SpecBuddyAllocator.) Poly)
(declare-fun %Poly%verismo!allocator.buddy.SpecBuddyAllocator. (Poly) verismo!allocator.buddy.SpecBuddyAllocator.)
...
(assert (forall ((x anonymous_closure%9260.)) (! (= x (%Poly%anonymous_closure%9260. (Poly%anonymous_closure%9260. x))) :pattern ((Poly%anonymous_closure%9260. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%anonymous_closure%9260.) (= x (Poly%anonymous_closure%9260. (%Poly%anonymous_closure%9260. x)))) :pattern ((has_type x TYPE%anonymous_closure%9260.)))))
(assert (forall ((x anonymous_closure%9260.)) (! (has_type (Poly%anonymous_closure%9260. x) TYPE%anonymous_closure%9260.) :pattern ((has_type (Poly%anonymous_closure%9260. x) TYPE%anonymous_closure%9260.)))))
(assert (forall ((x verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>.)) (! (= x (%Poly%verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>. (Poly%verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>. x))) :pattern ((Poly%verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x (TYPE%verismo!ptr.def_s.SnpPointsTo. $ (TYPE%verismo!linkedlist.Node. $ TYPE%tuple%0.))) (= x (Poly%verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>. (%Poly%verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>. x)))) :pattern ((has_type x (TYPE%verismo!ptr.def_s.SnpPointsTo. $ (TYPE%verismo!linkedlist.Node. $ TYPE%tuple%0.)))))))
(assert (forall ((x verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>.)) (! (has_type (Poly%verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>. x) (TYPE%verismo!ptr.def_s.SnpPointsTo. $ (TYPE%verismo!linkedlist.Node. $ TYPE%tuple%0.))) :pattern ((has_type (Poly%verismo!ptr.def_s.SnpPointsTo<verismo!linkedlist.Node<tuple%0.>.>. x) (TYPE%verismo!ptr.def_s.SnpPointsTo. $ (TYPE%verismo!linkedlist.Node. $ TYPE%tuple%0.)))))))
...
(assert (forall ((x vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>.)) (! (= x (%Poly%vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. (Poly%vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. x))) :pattern ((Poly%vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x (TYPE%vstd!map.Map. $ (TYPE%tuple%2. $ NAT $ NAT) $ (TYPE%tuple%2. $ NAT $ NAT))) (= x (Poly%vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. (%Poly%vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. x)))) :pattern ((has_type x (TYPE%vstd!map.Map. $ (TYPE%tuple%2. $ NAT $ NAT) $ (TYPE%tuple%2. $ NAT $ NAT)))))))
(assert (forall ((x vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>.)) (! (has_type (Poly%vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. x) (TYPE%vstd!map.Map. $ (TYPE%tuple%2. $ NAT $ NAT) $ (TYPE%tuple%2. $ NAT $ NAT))) :pattern ((has_type (Poly%vstd!map.Map<tuple%2<nat./nat.>./tuple%2<nat./nat.>.>. x) (TYPE%vstd!map.Map. $ (TYPE%tuple%2. $ NAT $ NAT) $ (TYPE%tuple%2. $ NAT $ NAT)))))))
(assert (forall ((x vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>.)) (! (= x (%Poly%vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. (Poly%vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. x))) :pattern ((Poly%vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x (TYPE%vstd!map.Map. $ (TYPE%tuple%2. $ NAT $ NAT) $ TYPE%verismo!ptr.def_s.SnpPointsToRaw.)) (= x (Poly%vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. (%Poly%vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. x)))) :pattern ((has_type x (TYPE%vstd!map.Map. $ (TYPE%tuple%2. $ NAT $ NAT) $ TYPE%verismo!ptr.def_s.SnpPointsToRaw.))))))
(assert (forall ((x vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>.)) (! (has_type (Poly%vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. x) (TYPE%vstd!map.Map. $ (TYPE%tuple%2. $ NAT $ NAT) $ TYPE%verismo!ptr.def_s.SnpPointsToRaw.)) :pattern ((has_type (Poly%vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>. x) (TYPE%vstd!map.Map. $ (TYPE%tuple%2. $ NAT $ NAT) $ TYPE%verismo!ptr.def_s.SnpPointsToRaw.))))))
...
(assert (forall ((x vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>.)) (! (= x (%Poly%vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. (Poly%vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. x))) :pattern ((Poly%vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x (TYPE%vstd!seq.Seq. $ (TYPE%verismo!linkedlist.LinkedList. $ TYPE%tuple%0.))) (= x (Poly%vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. (%Poly%vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. x)))) :pattern ((has_type x (TYPE%vstd!seq.Seq. $ (TYPE%verismo!linkedlist.LinkedList. $ TYPE%tuple%0.)))))))
(assert (forall ((x vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>.)) (! (has_type (Poly%vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. x) (TYPE%vstd!seq.Seq. $ (TYPE%verismo!linkedlist.LinkedList. $ TYPE%tuple%0.))) :pattern ((has_type (Poly%vstd!seq.Seq<verismo!linkedlist.LinkedList<tuple%0.>.>. x) (TYPE%vstd!seq.Seq. $ (TYPE%verismo!linkedlist.LinkedList. $ TYPE%tuple%0.)))))))
(assert (forall ((x vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>.)) (! (= x (%Poly%vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. (Poly%vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. x))) :pattern ((Poly%vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x (TYPE%vstd!seq.Seq. $ (TYPE%verismo!linkedlist.SpecListItem. $ TYPE%tuple%0.))) (= x (Poly%vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. (%Poly%vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. x)))) :pattern ((has_type x (TYPE%vstd!seq.Seq. $ (TYPE%verismo!linkedlist.SpecListItem. $ TYPE%tuple%0.)))))))
(assert (forall ((x vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>.)) (! (has_type (Poly%vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. x) (TYPE%vstd!seq.Seq. $ (TYPE%verismo!linkedlist.SpecListItem. $ TYPE%tuple%0.))) :pattern ((has_type (Poly%vstd!seq.Seq<verismo!linkedlist.SpecListItem<tuple%0.>.>. x) (TYPE%vstd!seq.Seq. $ (TYPE%verismo!linkedlist.SpecListItem. $ TYPE%tuple%0.)))))))
...
(assert (forall ((x vstd!set.Set<tuple%2<nat./nat.>.>.)) (! (= x (%Poly%vstd!set.Set<tuple%2<nat./nat.>.>. (Poly%vstd!set.Set<tuple%2<nat./nat.>.>. x))) :pattern ((Poly%vstd!set.Set<tuple%2<nat./nat.>.>. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x (TYPE%vstd!set.Set. $ (TYPE%tuple%2. $ NAT $ NAT))) (= x (Poly%vstd!set.Set<tuple%2<nat./nat.>.>. (%Poly%vstd!set.Set<tuple%2<nat./nat.>.>. x)))) :pattern ((has_type x (TYPE%vstd!set.Set. $ (TYPE%tuple%2. $ NAT $ NAT)))))))
(assert (forall ((x vstd!set.Set<tuple%2<nat./nat.>.>.)) (! (has_type (Poly%vstd!set.Set<tuple%2<nat./nat.>.>. x) (TYPE%vstd!set.Set. $ (TYPE%tuple%2. $ NAT $ NAT))) :pattern ((has_type (Poly%vstd!set.Set<tuple%2<nat./nat.>.>. x) (TYPE%vstd!set.Set. $ (TYPE%tuple%2. $ NAT $ NAT)))))))
...
(assert (forall ((x verismo!allocator.buddy.BuddyAllocator.)) (! (= x (%Poly%verismo!allocator.buddy.BuddyAllocator. (Poly%verismo!allocator.buddy.BuddyAllocator. x))) :pattern ((Poly%verismo!allocator.buddy.BuddyAllocator. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%verismo!allocator.buddy.BuddyAllocator.) (= x (Poly%verismo!allocator.buddy.BuddyAllocator. (%Poly%verismo!allocator.buddy.BuddyAllocator. x)))) :pattern ((has_type x TYPE%verismo!allocator.buddy.BuddyAllocator.)))))
(assert (forall ((_perms! vstd!map.Map<tuple%2<nat./nat.>./verismo!ptr.def_s.SnpPointsToRaw.>.) (_free_lists! Poly)) (! (=> (has_type _free_lists! (TYPE%verismo!tspec_e.array.Array. $ (TYPE%verismo!linkedlist.LinkedList. $ TYPE%tuple%0.) $ (CONST_INT 32))) (has_type (Poly%verismo!allocator.buddy.BuddyAllocator. (verismo!allocator.buddy.BuddyAllocator./BuddyAllocator _perms! _free_lists!)) TYPE%verismo!allocator.buddy.BuddyAllocator.)) :pattern ((has_type (Poly%verismo!allocator.buddy.BuddyAllocator. (verismo!allocator.buddy.BuddyAllocator./BuddyAllocator _perms! _free_lists!)) TYPE%verismo!allocator.buddy.BuddyAllocator.)))))
(assert (forall ((x verismo!allocator.buddy.BuddyAllocator.)) (! (= (verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/perms x) (verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/?perms x)) :pattern ((verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/perms x)))))
(assert (forall ((x verismo!allocator.buddy.BuddyAllocator.)) (! (= (verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/free_lists x) (verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/?free_lists x)) :pattern ((verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/free_lists x)))))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%verismo!allocator.buddy.BuddyAllocator.) (has_type (verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/free_lists (%Poly%verismo!allocator.buddy.BuddyAllocator. x)) (TYPE%verismo!tspec_e.array.Array. $ (TYPE%verismo!linkedlist.LinkedList. $ TYPE%tuple%0.) $ (CONST_INT 32)))) :pattern ((verismo!allocator.buddy.BuddyAllocator./BuddyAllocator/free_lists (%Poly%verismo!allocator.buddy.BuddyAllocator. x)) (has_type x TYPE%verismo!allocator.buddy.BuddyAllocator.)))))
(assert (forall ((x verismo!allocator.buddy.SpecBuddyAllocator.)) (! (= x (%Poly%verismo!allocator.buddy.SpecBuddyAllocator. (Poly%verismo!allocator.buddy.SpecBuddyAllocator. x))) :pattern ((Poly%verismo!allocator.buddy.SpecBuddyAllocator. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%verismo!allocator.buddy.SpecBuddyAllocator.) (= x (Poly%verismo!allocator.buddy.SpecBuddyAllocator. (%Poly%verismo!allocator.buddy.SpecBuddyAllocator. x)))) :pattern ((has_type x TYPE%verismo!allocator.buddy.SpecBuddyAllocator.)))))
(assert (forall ((x verismo!allocator.buddy.SpecBuddyAllocator.)) (! (= (verismo!allocator.buddy.SpecBuddyAllocator./SpecBuddyAllocator/perms x) (verismo!allocator.buddy.SpecBuddyAllocator./SpecBuddyAllocator/?perms x)) :pattern ((verismo!allocator.buddy.SpecBuddyAllocator./SpecBuddyAllocator/perms x)))))
(assert (forall ((x verismo!allocator.buddy.SpecBuddyAllocator.)) (! (= (verismo!allocator.buddy.SpecBuddyAllocator./SpecBuddyAllocator/free_lists x) (verismo!allocator.buddy.SpecBuddyAllocator./SpecBuddyAllocator/?free_lists x)) :pattern ((verismo!allocator.buddy.SpecBuddyAllocator./SpecBuddyAllocator/free_lists x)))))
(assert (forall ((x verismo!allocator.buddy.SpecBuddyAllocator.)) (! (has_type (Poly%verismo!allocator.buddy.SpecBuddyAllocator. x) TYPE%verismo!allocator.buddy.SpecBuddyAllocator.) :pattern ((has_type (Poly%verismo!allocator.buddy.SpecBuddyAllocator. x) TYPE%verismo!allocator.buddy.SpecBuddyAllocator.)))))
...
(set-info :comment ";; Function-Decl verismo::ptr::snp::snp_u::SwSnpMemAttr::ensures_read")
...
(set-info :comment ";; Function-Decl verismo::allocator::buddy::MIN_ADDR_ALIGN")
(declare-fun verismo!allocator.buddy.MIN_ADDR_ALIGN.? () Int)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::ORDER")
(declare-fun verismo!allocator.buddy.ORDER.? () Int)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::ORDER_USIZE")
(declare-fun verismo!allocator.buddy.ORDER_USIZE.? () Int)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::BuddyAllocator::view")
(declare-fun verismo!allocator.buddy.impl&%7.view.? (Poly) verismo!allocator.buddy.SpecBuddyAllocator.)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::valid_bucket")
(declare-fun verismo!allocator.buddy.impl&%8.valid_bucket.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::wf_bucket")
(declare-fun verismo!allocator.buddy.impl&%8.wf_bucket.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::wf_perm")
(declare-fun verismo!allocator.buddy.impl&%8.wf_perm.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::wf_before_validate_write")
(declare-fun verismo!allocator.buddy.impl&%8.wf_before_validate_write.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::inv")
(declare-fun verismo!allocator.buddy.impl&%8.inv.? (Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::spec_pop_or_push_element")
(declare-fun verismo!allocator.buddy.impl&%8.spec_pop_or_push_element.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::spec_add_one_to_bucket")
(declare-fun verismo!allocator.buddy.impl&%8.spec_add_one_to_bucket.? (Poly Poly Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::spec_add_one_to_bucket2")
(declare-fun verismo!allocator.buddy.impl&%8.spec_add_one_to_bucket2.? (Poly Poly Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::spec_remove_or_insert_one")
(declare-fun verismo!allocator.buddy.impl&%8.spec_remove_or_insert_one.? (Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::_spec_remove_or_insert_one")
(declare-fun verismo!allocator.buddy.impl&%8._spec_remove_or_insert_one.? (Poly Poly Poly Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::SpecBuddyAllocator::_spec_remove_or_insert_one2")
(declare-fun verismo!allocator.buddy.impl&%8._spec_remove_or_insert_one2.? (Poly Poly Poly Poly Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::buddy::alloc_valid_size")
(declare-fun verismo!allocator.buddy.alloc_valid_size.? (Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPPtr::not_null")
(declare-fun verismo!ptr.ptr_u.impl&%1.not_null.? (Dcr Type Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::pptr")
...
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::is_assigned")
(declare-fun verismo!ptr.ptr_u.impl&%2.is_assigned.? (Dcr Type Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::is_valid_private")
(declare-fun verismo!ptr.ptr_u.impl&%2.is_valid_private.? (Dcr Type Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::wf_at")
(declare-fun verismo!ptr.ptr_u.impl&%2.wf_at.? (Dcr Type Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::wf_not_null_at")
(declare-fun verismo!ptr.ptr_u.impl&%2.wf_not_null_at.? (Dcr Type Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::ptr_not_null_wf")
(declare-fun verismo!ptr.ptr_u.impl&%2.ptr_not_null_wf.? (Dcr Type Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::ptr_not_null_private_wf")
(declare-fun verismo!ptr.ptr_u.impl&%2.ptr_not_null_private_wf.? (Dcr Type Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::ptr::def_s::SnpPointsToData::ensures_read")
(declare-fun verismo!ptr.ptr_u.impl&%2.ensures_read.? (Dcr Type Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::ptr::raw_ptr_t::spec_set_zeros")
(declare-fun verismo!ptr.raw_ptr_t.spec_set_zeros.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::alloc_valid_ptr")
(declare-fun verismo!allocator.alloc_valid_ptr.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::allocator::valid_free_ptr")
(declare-fun verismo!allocator.valid_free_ptr.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::linkedlist::LinkedList::inv")
(declare-fun verismo!linkedlist.impl&%18.inv.? (Dcr Type Poly) Bool)
(set-info :comment ";; Function-Decl verismo::linkedlist::LinkedList::inv_hidden")
(declare-fun verismo!linkedlist.impl&%18.inv_hidden.? (Dcr Type Poly) Bool)
(set-info :comment ";; Function-Decl verismo::linkedlist::LinkedList::view")
(declare-fun verismo!linkedlist.impl&%18.view.? (Dcr Type Poly) Poly)
(set-info :comment ";; Function-Decl verismo::linkedlist::LinkedList::spec_valid_item")
(declare-fun verismo!linkedlist.impl&%21.spec_valid_item.? (Dcr Type Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::linkedlist::LinkedList::spec_pop")
(declare-fun verismo!linkedlist.impl&%21.spec_pop.? (Dcr Type Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::linkedlist::LinkedList::spec_pop2")
(declare-fun verismo!linkedlist.impl&%21.spec_pop2.? (Dcr Type Poly Poly Poly) Bool)
...
(assert (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (pre%self! Poly) (key! Poly)) (! (= (req%vstd!map.impl&%0.tracked_remove. K&. K& V&. V& pre%self! key!) (=> %%global_location_label%%8 (vstd!set.impl&%0.contains.? K&. K& (vstd!map.impl&%0.dom.? K&. K& V&. V& pre%self!) key!))) :pattern ((req%vstd!map.impl&%0.tracked_remove. K&. K& V&. V& pre%self! key!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (self! Poly)) (! (= (req%vstd!seq_lib.impl&%0.drop_last. A&. A& self!) (=> %%global_location_label%%30 (>= (vstd!seq.Seq.len.? A&. A& self!) 1))) :pattern ((req%vstd!seq_lib.impl&%0.drop_last. A&. A& self!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (self! Poly)) (! (= (req%vstd!seq.Seq.last. A&. A& self!) (=> %%global_location_label%%31 (< 0 (vstd!seq.Seq.len.? A&. A& self!)))) :pattern ((req%vstd!seq.Seq.last. A&. A& self!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (! (= (req%vstd!set.axiom_set_insert_different. A&. A& s! a1! a2!) (=> %%global_location_label%%32 (not (= a1! a2!)))) :pattern ((req%vstd!set.axiom_set_insert_different. A&. A& s! a1! a2!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_remove_insert. A&. A& s! a!) (=> %%global_location_label%%33 (vstd!set.impl&%0.contains.? A&. A& s! a!))) :pattern ((req%vstd!set.axiom_set_remove_insert. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (! (= (req%vstd!set.axiom_set_remove_different. A&. A& s! a1! a2!) (=> %%global_location_label%%34 (not (= a1! a2!)))) :pattern ((req%vstd!set.axiom_set_remove_different. A&. A& s! a1! a2!)))))
...
(assert (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! %%Function%%) (key! Poly)) (! (= (req%vstd!set.axiom_mk_map_index. K&. K& V&. V& s! f! key!) (=> %%global_location_label%%35 (vstd!set.impl&%0.contains.? K&. K& s! key!))) :pattern ((req%vstd!set.axiom_mk_map_index. K&. K& V&. V& s! f! key!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_insert_finite. A&. A& s! a!) (=> %%global_location_label%%36 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%vstd!set.axiom_set_insert_finite. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_remove_finite. A&. A& s! a!) (=> %%global_location_label%%37 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%vstd!set.axiom_set_remove_finite. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (! (= (req%vstd!set.axiom_set_union_finite. A&. A& s1! s2!) (and (=> %%global_location_label%%38 (vstd!set.impl&%0.finite.? A&. A& s1!)) (=> %%global_location_label%%39 (vstd!set.impl&%0.finite.? A&. A& s2!)))) :pattern ((req%vstd!set.axiom_set_union_finite. A&. A& s1! s2!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (! (= (req%vstd!set.axiom_set_intersect_finite. A&. A& s1! s2!) (=> %%global_location_label%%40 (or (vstd!set.impl&%0.finite.? A&. A& s1!) (vstd!set.impl&%0.finite.? A&. A& s2!)))) :pattern ((req%vstd!set.axiom_set_intersect_finite. A&. A& s1! s2!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (! (= (req%vstd!set.axiom_set_difference_finite. A&. A& s1! s2!) (=> %%global_location_label%%41 (vstd!set.impl&%0.finite.? A&. A& s1!))) :pattern ((req%vstd!set.axiom_set_difference_finite. A&. A& s1! s2!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly)) (! (= (req%vstd!set.axiom_set_choose_finite. A&. A& s!) (=> %%global_location_label%%42 (not (vstd!set.impl&%0.finite.? A&. A& s!)))) :pattern ((req%vstd!set.axiom_set_choose_finite. A&. A& s!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_insert_len. A&. A& s! a!) (=> %%global_location_label%%43 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%vstd!set.axiom_set_insert_len. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_remove_len. A&. A& s! a!) (=> %%global_location_label%%44 (vstd!set.impl&%0.finite.? A&. A& s!))) :pattern ((req%vstd!set.axiom_set_remove_len. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (! (= (req%vstd!set.axiom_set_contains_len. A&. A& s! a!) (and (=> %%global_location_label%%45 (vstd!set.impl&%0.finite.? A&. A& s!)) (=> %%global_location_label%%46 (vstd!set.impl&%0.contains.? A&. A& s! a!)))) :pattern ((req%vstd!set.axiom_set_contains_len. A&. A& s! a!)))))
...
(assert (forall ((A&. Dcr) (A& Type) (s! Poly)) (! (= (req%vstd!set.axiom_set_choose_len. A&. A& s!) (and (=> %%global_location_label%%47 (vstd!set.impl&%0.finite.? A&. A& s!)) (=> %%global_location_label%%48 (not (= (vstd!set.impl&%0.len.? A&. A& s!) 0))))) :pattern ((req%vstd!set.axiom_set_choose_len. A&. A& s!)))))
...
(assert (forall ((self! Poly) (vmpl! Poly)) (! (= (req%verismo!arch.rmp.entry_s.impl&%0.is_confidential_to. self! vmpl!) (=> %%global_location_label%%49 (and (< 0 (%I vmpl!)) (<= (%I vmpl!) 4)))) :pattern ((req%verismo!arch.rmp.entry_s.impl&%0.is_confidential_to. self! vmpl!)))))
...
(assert (forall ((self! Poly)) (! (= (req%verismo!ptr.raw_ptr_s.impl&%5.bytes. self!) (=> %%global_location_label%%50 (verismo!ptr.snp.snp_u.impl&%27.is_vmpl0_private.? (verismo!ptr.snp.snp_u.SnpMemAttrTrait.snp.? $ TYPE%verismo!ptr.raw_ptr_s.SnpPointsToBytes. self!)))) :pattern ((req%verismo!ptr.raw_ptr_s.impl&%5.bytes. self!)))))
...
(assert (forall ((current_addr! Int) (current_bucket! Int) (current_size! Int)) (! (= (req%verismo!allocator.bit_p.proof_buddy. current_addr! current_bucket! current_size!) (and (=> %%global_location_label%%51 (< current_bucket! 63)) (=> %%global_location_label%%52 (= (uClip 64 (EucMod current_addr! current_size!)) 0)) (=> %%global_location_label%%53 (= current_size! (uClip 64 (uintshl 64 (I 1) (I current_bucket!))))))) :pattern ((req%verismo!allocator.bit_p.proof_buddy. current_addr! current_bucket! current_size!)))))
...
(set-info :comment ";; Function-Def verismo::allocator::buddy::ORDER_USIZE")
(set-info :comment ";; verismo/src/allocator/buddy.rs:15:1: 15:40 (#0)")
