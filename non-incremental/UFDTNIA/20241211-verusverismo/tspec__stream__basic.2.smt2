...
(assert (uInv 16 data!))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) 2)) (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (verismo!tspec.stream.basic.u8_to_stream.? (I (uClip 8 (%I (I data!)))))) (Poly%vstd!seq.Seq<u8.>. (verismo!tspec.stream.basic.u8_to_stream.? (I (uClip 8 (uClip 16 (EucDiv (%I (I data!)) 256))))))))) i$)) 0))) :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (verismo!tspec.stream.basic.u8_to_stream.? (I (uClip 8 (%I (I data!)))))) (Poly%vstd!seq.Seq<u8.>. (verismo!tspec.stream.basic.u8_to_stream.? (I (uClip 8 (uClip 16 (EucDiv (%I (I data!)) 256))))))))) i$)))))
...
(assert (not (=> (= l@ (uClip 8 data!)) (=> (= h@ (uClip 8 (uClip 16 (EucDiv data! 256)))) (=> (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (verismo!tspec.stream.basic.u8_to_stream.? (I (uClip 8 (%I (I data!)))))) (Poly%vstd!seq.Seq<u8.>. (verismo!tspec.stream.basic.u8_to_stream.? (I (uClip 8 (uClip 16 (EucDiv (%I (I data!)) 256))))))))) (I 0))) 0)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (verismo!tspec.stream.basic.u8_to_stream.? (I (uClip 8 (%I (I data!)))))) (Poly%vstd!seq.Seq<u8.>. (verismo!tspec.stream.basic.u8_to_stream.? (I (uClip 8 (uClip 16 (EucDiv (%I (I data!)) 256))))))))) (I 1))) 0)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (and (=> %%location_label%%2 (req%verismo!tspec.stream.basic.proof_u8_non_zero. l@)) (=> (ens%verismo!tspec.stream.basic.proof_u8_non_zero. l@) (and (=> %%location_label%%3 (req%verismo!tspec.stream.basic.proof_u8_non_zero. h@)) (=> (ens%verismo!tspec.stream.basic.proof_u8_non_zero. h@) (=> %%location_label%%4 (= data! 0))))))))))))))))
(check-sat)
(exit)
