...
(assert (not (or (and (=> (and (vstd!set.impl&%0.finite.? A&. A& s!) (= (vstd!set.impl&%0.len.? A&. A& s!) 0)) (and (=> %%location_label%%0 (req%vstd!set_lib.impl&%0.lemma_len0_is_empty. A&. A& s!)) (=> (ens%vstd!set_lib.impl&%0.lemma_len0_is_empty. A&. A& s!) %%switch_label%%0))) (=> (not (and (vstd!set.impl&%0.finite.? A&. A& s!) (= (vstd!set.impl&%0.len.? A&. A& s!) 0))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= b! (ext_eq false (TYPE%vstd!set.Set. A&. A&) s! (vstd!set.impl&%0.empty.? A&. A&))) (and (=> %%location_label%%1 (= b! (and (vstd!set.impl&%0.finite.? A&. A& s!) (= (vstd!set.impl&%0.len.? A&. A& s!) 0)))) (=> %%location_label%%2 (= b! (ext_eq false (TYPE%vstd!set.Set. A&. A&) s! (vstd!set.impl&%0.empty.? A&. A&))))))))))
(check-sat)
(exit)
