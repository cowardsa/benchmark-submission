...
(assert (%B (verismo!addr_e.addr_interface.PageTrait.spec_valid_pn_with.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) self! (I 0))))
...
(assert (not (=> (= tmp%2 (uClip SZ verismo!arch.addr_s.def_s.PAGE_SIZE.?)) (and (=> %%location_label%%0 (req%verismo!tspec.security.sectype.impl&%436.mul. $ TYPE%tuple%0. self! tmp%2)) (=> (ens%verismo!tspec.security.sectype.impl&%436.mul. $ TYPE%tuple%0. self! tmp%2 tmp%1) (=> (= %return! tmp%1) (and (=> %%location_label%%1 (= %return! (verismo!addr_e.addr_interface.PageTrait.spec_to_addr.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) self!))) (=> %%location_label%%2 (%B (verismo!addr_e.addr_interface.PageTrait.spec_ensures_to_addr.? $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) $ (TYPE%verismo!tspec.security.sectype.SecType. $ (UINT SZ) $ TYPE%tuple%0.) self! %return!))))))))))
(check-sat)
(exit)
