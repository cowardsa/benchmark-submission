...
(set-info :comment ";; MODULE 'module vcell::vcell'")
...
(declare-datatypes ((core!option.Option. 0) (verismo!tspec.security.sectype.DataLabel. 0) (verismo!tspec.security.sectype.SpecSecType. 0) (verismo!vcell.vcell.VCell. 0) (tuple%0. 0)) (((core!option.Option./None ) (core!option.Option./Some (core!option.Option./Some/?0 Poly))) ((verismo!tspec.security.sectype.DataLabel./Symbol ) (verismo!tspec.security.sectype.DataLabel./Unknown ) (verismo!tspec.security.sectype.DataLabel./TrustedRandom ) (verismo!tspec.security.sectype.DataLabel./Secret )) ((verismo!tspec.security.sectype.SpecSecType./SpecSecType (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?val Poly) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?_unused core!option.Option.) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?valsets Poly) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?labels vstd!map.Map<nat./verismo!tspec.security.sectype.DataLabel.>.))) ((verismo!vcell.vcell.VCell./VCell (verismo!vcell.vcell.VCell./VCell/?ucell Poly))) ((tuple%0./tuple%0 ))))
...
(declare-fun verismo!vcell.vcell.VCell./VCell/ucell (verismo!vcell.vcell.VCell.) Poly)
...
(declare-fun Poly%verismo!vcell.vcell.VCell. (verismo!vcell.vcell.VCell.) Poly)
(declare-fun %Poly%verismo!vcell.vcell.VCell. (Poly) verismo!vcell.vcell.VCell.)
...
(assert (forall ((x verismo!vcell.vcell.VCell.)) (! (= x (%Poly%verismo!vcell.vcell.VCell. (Poly%verismo!vcell.vcell.VCell. x))) :pattern ((Poly%verismo!vcell.vcell.VCell. x)))))
(assert (forall ((T&. Dcr) (T& Type) (x Poly)) (! (=> (has_type x (TYPE%verismo!vcell.vcell.VCell. T&. T&)) (= x (Poly%verismo!vcell.vcell.VCell. (%Poly%verismo!vcell.vcell.VCell. x)))) :pattern ((has_type x (TYPE%verismo!vcell.vcell.VCell. T&. T&))))))
(assert (forall ((T&. Dcr) (T& Type) (_ucell! Poly)) (! (=> (has_type _ucell! T&) (has_type (Poly%verismo!vcell.vcell.VCell. (verismo!vcell.vcell.VCell./VCell _ucell!)) (TYPE%verismo!vcell.vcell.VCell. T&. T&))) :pattern ((has_type (Poly%verismo!vcell.vcell.VCell. (verismo!vcell.vcell.VCell./VCell _ucell!)) (TYPE%verismo!vcell.vcell.VCell. T&. T&))))))
(assert (forall ((x verismo!vcell.vcell.VCell.)) (! (= (verismo!vcell.vcell.VCell./VCell/ucell x) (verismo!vcell.vcell.VCell./VCell/?ucell x)) :pattern ((verismo!vcell.vcell.VCell./VCell/ucell x)))))
(assert (forall ((T&. Dcr) (T& Type) (x Poly)) (! (=> (has_type x (TYPE%verismo!vcell.vcell.VCell. T&. T&)) (has_type (verismo!vcell.vcell.VCell./VCell/ucell (%Poly%verismo!vcell.vcell.VCell. x)) T&)) :pattern ((verismo!vcell.vcell.VCell./VCell/ucell (%Poly%verismo!vcell.vcell.VCell. x)) (has_type x (TYPE%verismo!vcell.vcell.VCell. T&. T&))))))
(define-fun is-verismo!vcell.vcell.VCell./VCell_ ((c verismo!vcell.vcell.VCell.)) Bool ((_ is verismo!vcell.vcell.VCell./VCell) c))
(assert (forall ((x verismo!vcell.vcell.VCell.)) (! (=> (is-verismo!vcell.vcell.VCell./VCell_ x) (height_lt (height (verismo!vcell.vcell.VCell./VCell/ucell x)) (height (Poly%verismo!vcell.vcell.VCell. x)))) :pattern ((height (verismo!vcell.vcell.VCell./VCell/ucell x))))))
...
(set-info :comment ";; Function-Axioms verismo::vcell::vcell::VCell::is_constant")
(assert (fuel_bool_default fuel%verismo!vcell.vcell.impl&%6.is_constant.))
(assert (=> (fuel_bool fuel%verismo!vcell.vcell.impl&%6.is_constant.) (forall ((T&. Dcr) (T& Type) (self! Poly)) (! (= (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) self!) (verismo!tspec.isconst.IsConstant.is_constant.? T&. T& (verismo!vcell.vcell.VCell./VCell/ucell (%Poly%verismo!vcell.vcell.VCell. self!)))) :pattern ((verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) self!))))))
...
(set-info :comment ";; Function-Axioms verismo::vcell::vcell::VCell::vspec_cast_to")
(assert (fuel_bool_default fuel%verismo!vcell.vcell.impl&%2.vspec_cast_to.))
(assert (=> (fuel_bool fuel%verismo!vcell.vcell.impl&%2.vspec_cast_to.) (forall ((T&. Dcr) (T& Type) (self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!) (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T&. T& $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (verismo!vcell.vcell.VCell./VCell/ucell (%Poly%verismo!vcell.vcell.VCell. self!)))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!))))))
(set-info :comment ";; Function-Axioms verismo::vcell::vcell::VCell::spec_size_def")
...
(set-info :comment ";; Function-Axioms verismo::vcell::vcell::VCell::wf")
(assert (fuel_bool_default fuel%verismo!vcell.vcell.impl&%5.wf.))
(assert (=> (fuel_bool fuel%verismo!vcell.vcell.impl&%5.wf.) (forall ((T&. Dcr) (T& Type) (self! Poly)) (! (= (verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) self!) (verismo!tspec.wellformed.WellFormed.wf.? T&. T& (verismo!vcell.vcell.VCell./VCell/ucell (%Poly%verismo!vcell.vcell.VCell. self!)))) :pattern ((verismo!tspec.wellformed.WellFormed.wf.? $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) self!))))))
(set-info :comment ";; Function-Axioms verismo::vcell::vcell::VCell::is_constant_to")
(assert (fuel_bool_default fuel%verismo!vcell.vcell.impl&%6.is_constant_to.))
(assert (=> (fuel_bool fuel%verismo!vcell.vcell.impl&%6.is_constant_to.) (forall ((T&. Dcr) (T& Type) (self! Poly) (vmpl! Poly)) (! (= (verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) self! vmpl!) (verismo!tspec.isconst.IsConstant.is_constant_to.? T&. T& (verismo!vcell.vcell.VCell./VCell/ucell (%Poly%verismo!vcell.vcell.VCell. self!)) vmpl!)) :pattern ((verismo!tspec.isconst.IsConstant.is_constant_to.? $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) self! vmpl!))))))
(set-info :comment ";; Trait-Impl-Axiom")
...
(set-info :comment ";; Trait-Impl-Axiom")
(assert (forall ((T&. Dcr) (T& Type)) (! (=> (tr_bound%verismo!tspec.cast.VTypeCast. T&. T& $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.))) (tr_bound%verismo!tspec.cast.VTypeCast. $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)))) :pattern ((tr_bound%verismo!tspec.cast.VTypeCast. $ (TYPE%verismo!vcell.vcell.VCell. T&. T&) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)))))))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (forall ((T&. Dcr) (T& Type)) (! (=> (tr_bound%verismo!tspec.size_s.SpecSize. T&. T&) (tr_bound%verismo!tspec.size_s.SpecSize. $ (TYPE%verismo!vcell.vcell.VCell. T&. T&))) :pattern ((tr_bound%verismo!tspec.size_s.SpecSize. $ (TYPE%verismo!vcell.vcell.VCell. T&. T&))))))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (forall ((T&. Dcr) (T& Type)) (! (=> (tr_bound%verismo!tspec.wellformed.WellFormed. T&. T&) (tr_bound%verismo!tspec.wellformed.WellFormed. $ (TYPE%verismo!vcell.vcell.VCell. T&. T&))) :pattern ((tr_bound%verismo!tspec.wellformed.WellFormed. $ (TYPE%verismo!vcell.vcell.VCell. T&. T&))))))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (forall ((T&. Dcr) (T& Type)) (! (=> (tr_bound%verismo!tspec.isconst.IsConstant. T&. T&) (tr_bound%verismo!tspec.isconst.IsConstant. $ (TYPE%verismo!vcell.vcell.VCell. T&. T&))) :pattern ((tr_bound%verismo!tspec.isconst.IsConstant. $ (TYPE%verismo!vcell.vcell.VCell. T&. T&))))))
...
(set-info :comment ";; Function-Specs verismo::vcell::vcell::VCell::new")
(declare-fun ens%verismo!vcell.vcell.impl&%7.new. (Dcr Type Poly verismo!vcell.vcell.VCell.) Bool)
(assert (forall ((T&. Dcr) (T& Type) (val! Poly) (%return! verismo!vcell.vcell.VCell.)) (! (= (ens%verismo!vcell.vcell.impl&%7.new. T&. T& val! %return!) (has_type (Poly%verismo!vcell.vcell.VCell. %return!) (TYPE%verismo!vcell.vcell.VCell. T&. T&))) :pattern ((ens%verismo!vcell.vcell.impl&%7.new. T&. T& val! %return!)))))
(set-info :comment ";; Function-Def verismo::vcell::vcell::VCell::new")
(set-info :comment ";; verismo/src/vcell/vcell.rs:8:5: 8:37 (#0)")
(declare-const T&. Dcr)
(declare-const T& Type)
(declare-const %return! verismo!vcell.vcell.VCell.)
