...
(assert (has_type s1! (TYPE%vstd!set.Set. T1&. T1&)))
(assert (has_type s2! (TYPE%vstd!set.Set. T2&. T2&)))
(assert (has_type (Poly%fun%2. op_fn!) (TYPE%fun%2. T1&. T1& T2&. T2& T3&. T3&)))
(assert (> (vstd!set.impl&%0.len.? T1&. T1& s1!) 0))
(assert (vstd!set.impl&%0.finite.? T1&. T1& s1!))
(assert (vstd!set.impl&%0.finite.? T2&. T2& s2!))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= ret! (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (and (=> %%location_label%%0 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!)))))))) (=> %%location_label%%1 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T2&. T2& s2! T1&. T1& s1! T2& T1& T2&. T2& s2! T1&. T1& s1! (%Poly%fun%2. (Poly%fun%2. (verismo!tspec.setlib.exchange_spec_fn.? T1&. T1& T2&. T2& T3&. T3& (Poly%fun%2. op_fn!))))))))))))))
(check-sat)
(exit)
