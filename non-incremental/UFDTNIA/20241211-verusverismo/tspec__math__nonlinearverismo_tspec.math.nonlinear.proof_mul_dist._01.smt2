...
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:91:1: 91:65 (#0)")
...
(set-info :comment ";; Function-Def verismo::tspec::math::nonlinear::proof_mul_dist")
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:91:1: 91:65 (#0)")
...
(assert (not (=> (= ret! (Mul (Mul a! b!) c!)) (and (=> %%location_label%%0 (= ret! (Mul (Mul a! b!) c!))) (=> %%location_label%%1 (= (Mul (Mul a! b!) c!) (Mul a! (Mul b! c!))))))))
(check-sat)
(exit)
