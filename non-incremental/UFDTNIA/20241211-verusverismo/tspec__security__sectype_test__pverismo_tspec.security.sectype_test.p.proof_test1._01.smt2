...
(set-info :comment ";; verismo/src/tspec/security/sectype_test.rs:21:5: 21:11 (#0)")
...
(set-info :comment ";; Function-Def verismo::tspec::security::sectype_test::p::proof_test1")
(set-info :comment ";; verismo/src/tspec/security/sectype_test.rs:21:5: 21:11 (#0)")
...
(assert (not (=> (< v1! 10) (=> (< v2! 10) (=> %%location_label%%0 (< (Mul v1! v2!) 100))))))
(check-sat)
(exit)
