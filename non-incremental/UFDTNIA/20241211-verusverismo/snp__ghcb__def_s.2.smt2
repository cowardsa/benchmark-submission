...
(set-info :comment ";; MODULE 'module snp::ghcb::def_s'")
...
(declare-const fuel%verismo!snp.ghcb.def_s.GHCB_BUFFER_SIZE. FuelId)
(declare-const fuel%verismo!snp.ghcb.def_s.impl&%4.as_int. FuelId)
(declare-const fuel%verismo!snp.ghcb.def_s.impl&%4.from_int. FuelId)
(declare-const fuel%verismo!snp.ghcb.def_s.impl&%5.ord_int. FuelId)
(declare-const fuel%verismo!snp.ghcb.def_s.impl&%6.spec_from_int. FuelId)
(declare-const fuel%verismo!snp.ghcb.def_s.impl&%9.vspec_cast_to. FuelId)
(declare-const fuel%verismo!snp.ghcb.def_s.impl&%10.spec_size_def. FuelId)
(declare-const fuel%verismo!snp.ghcb.def_s.impl&%12.wf. FuelId)
(declare-const fuel%verismo!snp.ghcb.def_s.impl&%13.is_constant. FuelId)
(declare-const fuel%verismo!snp.ghcb.def_s.impl&%13.is_constant_to. FuelId)
...
(declare-datatypes ((core!option.Option. 0) (verismo!tspec.security.sectype.DataLabel. 0) (verismo!tspec.security.sectype.SpecSecType. 0) (verismo!arch.rmp.perm_s.Perm. 0) (verismo!snp.ghcb.def_s.SvmStatus. 0) (verismo!snp.ghcb.def_s.GHCBProto. 0) (verismo!arch.entities.VMPL. 0) (tuple%0. 0)) (((core!option.Option./None ) (core!option.Option./Some (core!option.Option./Some/?0 Poly))) ((verismo!tspec.security.sectype.DataLabel./Symbol ) (verismo!tspec.security.sectype.DataLabel./Unknown ) (verismo!tspec.security.sectype.DataLabel./TrustedRandom ) (verismo!tspec.security.sectype.DataLabel./Secret )) ((verismo!tspec.security.sectype.SpecSecType./SpecSecType (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?val Poly) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?_unused core!option.Option.) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?valsets Poly) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/?labels vstd!map.Map<nat./verismo!tspec.security.sectype.DataLabel.>.))) ((verismo!arch.rmp.perm_s.Perm./Read ) (verismo!arch.rmp.perm_s.Perm./Write ) (verismo!arch.rmp.perm_s.Perm./ExeU ) (verismo!arch.rmp.perm_s.Perm./ExeS ) (verismo!arch.rmp.perm_s.Perm./Shadow )) ((verismo!snp.ghcb.def_s.SvmStatus./Ok ) (verismo!snp.ghcb.def_s.SvmStatus./Unsupported ) (verismo!snp.ghcb.def_s.SvmStatus./VmmError ) (verismo!snp.ghcb.def_s.SvmStatus./DecodeFailed ) (verismo!snp.ghcb.def_s.SvmStatus./Exception ) (verismo!snp.ghcb.def_s.SvmStatus./Retry )) ((verismo!snp.ghcb.def_s.GHCBProto./GHCBProto )) ((verismo!arch.entities.VMPL./VMPL0 ) (verismo!arch.entities.VMPL./VMPL1 ) (verismo!arch.entities.VMPL./VMPL2 ) (verismo!arch.entities.VMPL./VMPL3 )) ((tuple%0./tuple%0 ))))
...
(declare-const TYPE%verismo!snp.ghcb.def_s.SvmStatus. Type)
(declare-const TYPE%verismo!snp.ghcb.def_s.GHCBProto. Type)
...
(declare-fun Poly%verismo!snp.ghcb.def_s.SvmStatus. (verismo!snp.ghcb.def_s.SvmStatus.) Poly)
(declare-fun %Poly%verismo!snp.ghcb.def_s.SvmStatus. (Poly) verismo!snp.ghcb.def_s.SvmStatus.)
(declare-fun Poly%verismo!snp.ghcb.def_s.GHCBProto. (verismo!snp.ghcb.def_s.GHCBProto.) Poly)
(declare-fun %Poly%verismo!snp.ghcb.def_s.GHCBProto. (Poly) verismo!snp.ghcb.def_s.GHCBProto.)
...
(assert (forall ((x verismo!snp.ghcb.def_s.SvmStatus.)) (! (= x (%Poly%verismo!snp.ghcb.def_s.SvmStatus. (Poly%verismo!snp.ghcb.def_s.SvmStatus. x))) :pattern ((Poly%verismo!snp.ghcb.def_s.SvmStatus. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%verismo!snp.ghcb.def_s.SvmStatus.) (= x (Poly%verismo!snp.ghcb.def_s.SvmStatus. (%Poly%verismo!snp.ghcb.def_s.SvmStatus. x)))) :pattern ((has_type x TYPE%verismo!snp.ghcb.def_s.SvmStatus.)))))
(assert (forall ((x verismo!snp.ghcb.def_s.SvmStatus.)) (! (has_type (Poly%verismo!snp.ghcb.def_s.SvmStatus. x) TYPE%verismo!snp.ghcb.def_s.SvmStatus.) :pattern ((has_type (Poly%verismo!snp.ghcb.def_s.SvmStatus. x) TYPE%verismo!snp.ghcb.def_s.SvmStatus.)))))
(assert (forall ((x verismo!snp.ghcb.def_s.GHCBProto.)) (! (= x (%Poly%verismo!snp.ghcb.def_s.GHCBProto. (Poly%verismo!snp.ghcb.def_s.GHCBProto. x))) :pattern ((Poly%verismo!snp.ghcb.def_s.GHCBProto. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x TYPE%verismo!snp.ghcb.def_s.GHCBProto.) (= x (Poly%verismo!snp.ghcb.def_s.GHCBProto. (%Poly%verismo!snp.ghcb.def_s.GHCBProto. x)))) :pattern ((has_type x TYPE%verismo!snp.ghcb.def_s.GHCBProto.)))))
(assert (forall ((x verismo!snp.ghcb.def_s.GHCBProto.)) (! (has_type (Poly%verismo!snp.ghcb.def_s.GHCBProto. x) TYPE%verismo!snp.ghcb.def_s.GHCBProto.) :pattern ((has_type (Poly%verismo!snp.ghcb.def_s.GHCBProto. x) TYPE%verismo!snp.ghcb.def_s.GHCBProto.)))))
...
(set-info :comment ";; Function-Decl verismo::snp::ghcb::def_s::GHCB_BUFFER_SIZE")
(declare-fun verismo!snp.ghcb.def_s.GHCB_BUFFER_SIZE.? () Int)
(set-info :comment ";; Function-Decl verismo::snp::ghcb::def_s::SvmStatus::spec_from_int")
(declare-fun verismo!snp.ghcb.def_s.impl&%6.spec_from_int.? (Poly) core!option.Option.)
...
(set-info :comment ";; Function-Def verismo::snp::ghcb::def_s::GHCB_BUFFER_SIZE")
(set-info :comment ";; verismo/src/snp/ghcb/def_s.rs:5:1: 5:43 (#0)")
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::GHCB_BUFFER_SIZE")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.GHCB_BUFFER_SIZE.))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.GHCB_BUFFER_SIZE.) (= verismo!snp.ghcb.def_s.GHCB_BUFFER_SIZE.? 2032)))
(assert (uInv SZ verismo!snp.ghcb.def_s.GHCB_BUFFER_SIZE.?))
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::SvmStatus::as_int")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.impl&%4.as_int.))
(define-fun is-verismo!snp.ghcb.def_s.SvmStatus./Ok_ ((c verismo!snp.ghcb.def_s.SvmStatus.)) Bool ((_ is verismo!snp.ghcb.def_s.SvmStatus./Ok) c))
(define-fun is-verismo!snp.ghcb.def_s.SvmStatus./Unsupported_ ((c verismo!snp.ghcb.def_s.SvmStatus.)) Bool ((_ is verismo!snp.ghcb.def_s.SvmStatus./Unsupported) c))
(define-fun is-verismo!snp.ghcb.def_s.SvmStatus./VmmError_ ((c verismo!snp.ghcb.def_s.SvmStatus.)) Bool ((_ is verismo!snp.ghcb.def_s.SvmStatus./VmmError) c))
(define-fun is-verismo!snp.ghcb.def_s.SvmStatus./DecodeFailed_ ((c verismo!snp.ghcb.def_s.SvmStatus.)) Bool ((_ is verismo!snp.ghcb.def_s.SvmStatus./DecodeFailed) c))
(define-fun is-verismo!snp.ghcb.def_s.SvmStatus./Exception_ ((c verismo!snp.ghcb.def_s.SvmStatus.)) Bool ((_ is verismo!snp.ghcb.def_s.SvmStatus./Exception) c))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.impl&%4.as_int.) (forall ((self! Poly)) (! (= (verismo!tspec.integer.IntValue.as_int.? $ TYPE%verismo!snp.ghcb.def_s.SvmStatus. self!) (I (let ((val$ (ite (is-verismo!snp.ghcb.def_s.SvmStatus./Ok_ (%Poly%verismo!snp.ghcb.def_s.SvmStatus. self!)) 0 (ite (is-verismo!snp.ghcb.def_s.SvmStatus./Unsupported_ (%Poly%verismo!snp.ghcb.def_s.SvmStatus. self!)) 1 (ite (is-verismo!snp.ghcb.def_s.SvmStatus./VmmError_ (%Poly%verismo!snp.ghcb.def_s.SvmStatus. self!)) 2 (ite (is-verismo!snp.ghcb.def_s.SvmStatus./DecodeFailed_ (%Poly%verismo!snp.ghcb.def_s.SvmStatus. self!)) 3 (ite (is-verismo!snp.ghcb.def_s.SvmStatus./Exception_ (%Poly%verismo!snp.ghcb.def_s.SvmStatus. self!)) 4 5))))))) val$))) :pattern ((verismo!tspec.integer.IntValue.as_int.? $ TYPE%verismo!snp.ghcb.def_s.SvmStatus. self!))))))
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::SvmStatus::spec_from_int")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.impl&%6.spec_from_int.))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.impl&%6.spec_from_int.) (forall ((val! Poly)) (! (= (verismo!snp.ghcb.def_s.impl&%6.spec_from_int.? val!) (ite (< (%I val!) 0) core!option.Option./None (ite (= (%I val!) 0) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./Ok)) (ite (= (%I val!) 1) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./Unsupported)) (ite (= (%I val!) 2) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./VmmError)) (ite (= (%I val!) 3) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./DecodeFailed)) (ite (= (%I val!) 4) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./Exception)) (ite (= (%I val!) 5) (core!option.Option./Some (Poly%verismo!snp.ghcb.def_s.SvmStatus. verismo!snp.ghcb.def_s.SvmStatus./Retry)) core!option.Option./None)))))))) :pattern ((verismo!snp.ghcb.def_s.impl&%6.spec_from_int.? val!))))))
(assert (forall ((val! Poly)) (! (=> (has_type val! INT) (has_type (Poly%core!option.Option. (verismo!snp.ghcb.def_s.impl&%6.spec_from_int.? val!)) (TYPE%core!option.Option. $ TYPE%verismo!snp.ghcb.def_s.SvmStatus.))) :pattern ((verismo!snp.ghcb.def_s.impl&%6.spec_from_int.? val!)))))
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::SvmStatus::from_int")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.impl&%4.from_int.))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.impl&%4.from_int.) (forall ((val! Poly)) (! (= (verismo!tspec.integer.IntValue.from_int.? $ TYPE%verismo!snp.ghcb.def_s.SvmStatus. val!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!snp.ghcb.def_s.impl&%6.spec_from_int.? val!))))) :pattern ((verismo!tspec.integer.IntValue.from_int.? $ TYPE%verismo!snp.ghcb.def_s.SvmStatus. val!))))))
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::SvmStatus::ord_int")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.impl&%5.ord_int.))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.impl&%5.ord_int.) (forall ((self! Poly)) (! (= (verismo!tspec.integer.IntOrd.ord_int.? $ TYPE%verismo!snp.ghcb.def_s.SvmStatus. self!) (verismo!tspec.integer.IntValue.as_int.? $ TYPE%verismo!snp.ghcb.def_s.SvmStatus. self!)) :pattern ((verismo!tspec.integer.IntOrd.ord_int.? $ TYPE%verismo!snp.ghcb.def_s.SvmStatus. self!))))))
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::GHCBProto::vspec_cast_to")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.impl&%9.vspec_cast_to.))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.impl&%9.vspec_cast_to.) (forall ((self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ TYPE%verismo!snp.ghcb.def_s.GHCBProto. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!) (vstd!seq.Seq.empty.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ TYPE%verismo!snp.ghcb.def_s.GHCBProto. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) self!))))))
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::GHCBProto::spec_size_def")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.impl&%10.spec_size_def.))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.impl&%10.spec_size_def.) (= (verismo!tspec.size_s.SpecSize.spec_size_def.? $ TYPE%verismo!snp.ghcb.def_s.GHCBProto.) (I 0))))
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::GHCBProto::wf")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.impl&%12.wf.))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.impl&%12.wf.) (forall ((self! Poly)) (! (= (verismo!tspec.wellformed.WellFormed.wf.? $ TYPE%verismo!snp.ghcb.def_s.GHCBProto. self!) (B true)) :pattern ((verismo!tspec.wellformed.WellFormed.wf.? $ TYPE%verismo!snp.ghcb.def_s.GHCBProto. self!))))))
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::GHCBProto::is_constant")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.impl&%13.is_constant.))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.impl&%13.is_constant.) (forall ((self! Poly)) (! (= (verismo!tspec.isconst.IsConstant.is_constant.? $ TYPE%verismo!snp.ghcb.def_s.GHCBProto. self!) (B true)) :pattern ((verismo!tspec.isconst.IsConstant.is_constant.? $ TYPE%verismo!snp.ghcb.def_s.GHCBProto. self!))))))
(set-info :comment ";; Function-Axioms verismo::snp::ghcb::def_s::GHCBProto::is_constant_to")
(assert (fuel_bool_default fuel%verismo!snp.ghcb.def_s.impl&%13.is_constant_to.))
(assert (=> (fuel_bool fuel%verismo!snp.ghcb.def_s.impl&%13.is_constant_to.) (forall ((self! Poly) (vmpl! Poly)) (! (= (verismo!tspec.isconst.IsConstant.is_constant_to.? $ TYPE%verismo!snp.ghcb.def_s.GHCBProto. self! vmpl!) (B true)) :pattern ((verismo!tspec.isconst.IsConstant.is_constant_to.? $ TYPE%verismo!snp.ghcb.def_s.GHCBProto. self! vmpl!))))))
...
(set-info :comment ";; Trait-Impl-Axiom")
(assert (tr_bound%verismo!tspec.integer.IntValue. $ TYPE%verismo!snp.ghcb.def_s.SvmStatus.))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (tr_bound%verismo!tspec.integer.IntOrd. $ TYPE%verismo!snp.ghcb.def_s.SvmStatus.))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (tr_bound%verismo!tspec.cast.VTypeCast. $ TYPE%verismo!snp.ghcb.def_s.GHCBProto. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.))))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (tr_bound%verismo!tspec.size_s.SpecSize. $ TYPE%verismo!snp.ghcb.def_s.GHCBProto.))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (tr_bound%verismo!tspec.wellformed.WellFormed. $ TYPE%verismo!snp.ghcb.def_s.GHCBProto.))
(set-info :comment ";; Trait-Impl-Axiom")
(assert (tr_bound%verismo!tspec.isconst.IsConstant. $ TYPE%verismo!snp.ghcb.def_s.GHCBProto.))
(set-info :comment ";; Function-Specs verismo::snp::ghcb::def_s::SvmStatus::as_u64")
(declare-fun ens%verismo!snp.ghcb.def_s.impl&%6.as_u64. (verismo!snp.ghcb.def_s.SvmStatus. Int) Bool)
(assert (forall ((self! verismo!snp.ghcb.def_s.SvmStatus.) (ret! Int)) (! (= (ens%verismo!snp.ghcb.def_s.impl&%6.as_u64. self! ret!) (and (uInv 64 ret!) (= ret! (%I (verismo!tspec.integer.IntValue.as_int.? $ TYPE%verismo!snp.ghcb.def_s.SvmStatus. (Poly%verismo!snp.ghcb.def_s.SvmStatus. self!)))))) :pattern ((ens%verismo!snp.ghcb.def_s.impl&%6.as_u64. self! ret!)))))
(set-info :comment ";; Function-Def verismo::snp::ghcb::def_s::SvmStatus::as_u64")
(set-info :comment ";; verismo/src/snp/ghcb/def_s.rs:7:25: 7:36 (#20591)")
(declare-const ret! Int)
(declare-const self! verismo!snp.ghcb.def_s.SvmStatus.)
(assert fuel_defaults)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= ret! (let ((ret$ (ite (is-verismo!snp.ghcb.def_s.SvmStatus./Ok_ self!) 0 (ite (is-verismo!snp.ghcb.def_s.SvmStatus./Unsupported_ self!) 1 (ite (is-verismo!snp.ghcb.def_s.SvmStatus./VmmError_ self!) 2 (ite (is-verismo!snp.ghcb.def_s.SvmStatus./DecodeFailed_ self!) 3 (ite (is-verismo!snp.ghcb.def_s.SvmStatus./Exception_ self!) 4 5))))))) ret$)) (=> %%location_label%%0 (= ret! (%I (verismo!tspec.integer.IntValue.as_int.? $ TYPE%verismo!snp.ghcb.def_s.SvmStatus. (Poly%verismo!snp.ghcb.def_s.SvmStatus. self!))))))))
(check-sat)
(exit)
