...
(assert (not (=> (= ret@ (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (and (=> %%location_label%%0 (req%verismo!tspec.setlib.lemma_setop_eq_recursive. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn!)) (=> (ens%verismo!tspec.setlib.lemma_setop_eq_recursive. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! tmp%1) (and (=> %%location_label%%1 (req%verismo!tspec.setlib.lemma_set_bop_len_recursive. T1&. T1& T3&. T3& T2&. T2& s1! s2! op_fn!)) (=> (ens%verismo!tspec.setlib.lemma_set_bop_len_recursive. T1&. T1& T3&. T3& T2&. T2& s1! s2! op_fn! tmp%2) (=> (= ret! ret@) (and (=> %%location_label%%2 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!)))))))) (and (=> %%location_label%%3 (= (= (vstd!set.impl&%0.len.? T3&. T3& ret!) 0) (or (= (vstd!set.impl&%0.len.? T1&. T1& s1!) 0) (= (vstd!set.impl&%0.len.? T2&. T2& s2!) 0)))) (and (=> %%location_label%%4 (<= (vstd!set.impl&%0.len.? T3&. T3& ret!) (nClip (Mul (vstd!set.impl&%0.len.? T1&. T1& s1!) (vstd!set.impl&%0.len.? T2&. T2& s2!))))) (=> %%location_label%%5 (vstd!set.impl&%0.finite.? T3&. T3& ret!)))))))))))))
(check-sat)
(exit)
