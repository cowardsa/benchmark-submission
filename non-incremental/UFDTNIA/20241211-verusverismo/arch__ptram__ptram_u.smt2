...
(set-info :comment ";; MODULE 'module arch::ptram::ptram_u'")
...
(declare-const fuel%verismo!arch.entities.memtype.impl&%10.is_pt. FuelId)
...
(declare-const fuel%verismo!arch.rmp.db_u.rmp_model_eq. FuelId)
...
(declare-const fuel%verismo!arch.rmp.db_u.rmp_hv_update. FuelId)
...
(declare-const fuel%verismo!arch.pgtable.entry_s.impl&%0.child_lvl. FuelId)
...
(declare-const fuel%verismo!arch.vram.vram_s.impl&%0.model1_eq. FuelId)
(declare-const fuel%verismo!arch.vram.vram_s.impl&%1.model2_eq. FuelId)
...
(declare-const fuel%verismo!arch.ptram.ptram_u.impl&%0.model1_eq. FuelId)
(declare-const fuel%verismo!arch.ptram.ptram_u.impl&%1.model2_eq. FuelId)
...
(declare-const fuel%verismo!arch.ptram.ptram_u.impl&%2.inv_content_gpa_ok. FuelId)
(declare-const fuel%verismo!arch.ptram.ptram_u.impl&%2.inv_content_ok. FuelId)
(declare-const fuel%verismo!arch.ptram.ptram_u.impl&%2.inv_for_identity_map_ok. FuelId)
(declare-const fuel%verismo!arch.ptram.ptram_u.impl&%2.need_c_bit. FuelId)
(declare-const fuel%verismo!arch.ptram.ptram_u.impl&%2.inv_encrypted_priv_mem_ok. FuelId)
...
(declare-fun tr_bound%verismo!arch.attack.Model2Eq. (Dcr Type) Bool)
...
(set-info :comment ";; Function-Decl verismo::arch::entities::memtype::MemType::is_pt")
(declare-fun verismo!arch.entities.memtype.impl&%10.is_pt.? (Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::arch::rmp::db_u::rmp_model_eq")
(declare-fun verismo!arch.rmp.db_u.rmp_model_eq.? (Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::arch::rmp::db_u::rmp_hv_update")
(declare-fun verismo!arch.rmp.db_u.rmp_hv_update.? (Poly Poly Poly) vstd!map.Map<verismo!arch.addr_s.def_s.SpecPage<verismo!arch.addr_s.def_s.SysPhy.>./verismo!arch.rmp.def_s.RmpEntry.>.)
...
(set-info :comment ";; Function-Decl verismo::arch::entities::memtype::PTLevel::child_lvl")
(declare-fun verismo!arch.pgtable.entry_s.impl&%0.child_lvl.? (Poly) core!option.Option.)
...
(set-info :comment ";; Function-Decl verismo::arch::ptram::def_s::GuestPTRam::inv_content_gpa_ok")
(declare-fun verismo!arch.ptram.ptram_u.impl&%2.inv_content_gpa_ok.? (Poly Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::arch::ptram::def_s::GuestPTRam::inv_for_identity_map_ok")
(declare-fun verismo!arch.ptram.ptram_u.impl&%2.inv_for_identity_map_ok.? (Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::ptram::def_s::GuestPTRam::need_c_bit")
(declare-fun verismo!arch.ptram.ptram_u.impl&%2.need_c_bit.? (Poly Poly Poly) Bool)
(set-info :comment ";; Function-Decl verismo::arch::ptram::def_s::GuestPTRam::inv_encrypted_priv_mem_ok")
(declare-fun verismo!arch.ptram.ptram_u.impl&%2.inv_encrypted_priv_mem_ok.? (Poly Poly) Bool)
...
(set-info :comment ";; Function-Decl verismo::arch::attack::Model2Eq::model2_eq")
(declare-fun verismo!arch.attack.Model2Eq.model2_eq.? (Dcr Type Poly Poly) Poly)
(declare-fun verismo!arch.attack.Model2Eq.model2_eq%default%.? (Dcr Type Poly Poly) Poly)
...
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Int) (%%hole%%2 Int) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1 %%hole%%2) i$) (I (ite (= (%I i$) %%hole%%0) %%hole%%1 %%hole%%2))) :pattern ((%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1 %%hole%%2) i$)))))
(assert (=> (fuel_bool fuel%verismo!tspec.stream.basic.u8_to_stream.) (forall ((data! Poly)) (! (= (verismo!tspec.stream.basic.u8_to_stream.? data!) (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.new.? $ (UINT 8) $ (TYPE%fun%1. $ INT $ (UINT 8)) (I 1) (Poly%fun%1. (mk_fun (%%lambda%%2 0 (%I data!) 0)))))) :pattern ((verismo!tspec.stream.basic.u8_to_stream.? data!))))))
...
(declare-fun %%lambda%%3 (Dcr Type Poly Dcr Type Poly Type Type Dcr Type Poly Dcr Type Poly %%Function%%) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Type) (%%hole%%7 Type) (%%hole%%8 Dcr) (%%hole%%9 Type) (%%hole%%10 Poly) (%%hole%%11 Dcr) (%%hole%%12 Type) (%%hole%%13 Poly) (%%hole%%14 %%Function%%) (val$ Poly)) (! (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14) val$) (B (exists ((v1$ Poly) (v2$ Poly)) (! (and (and (has_type v1$ %%hole%%6) (has_type v2$ %%hole%%7)) (and (and (vstd!set.impl&%0.contains.? %%hole%%8 %%hole%%9 %%hole%%10 v1$) (vstd!set.impl&%0.contains.? %%hole%%11 %%hole%%12 %%hole%%13 v2$)) (= val$ (%%apply%%1 %%hole%%14 v1$ v2$)))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%0 %%hole%%1 %%hole%%2 v1$) (vstd!set.impl&%0.contains.? %%hole%%3 %%hole%%4 %%hole%%5 v2$)))))) :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14) val$)))))
(assert (=> (fuel_bool fuel%verismo!tspec.setlib.set_op.) (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (s1! Poly) (s2! Poly) (op_fn! Poly)) (! (= (verismo!tspec.setlib.set_op.? T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn!) (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. op_fn!)))))) :pattern ((verismo!tspec.setlib.set_op.? T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn!))))))
...
(assert (forall ((%%hole%%0 %%Function%%) (v1$ Poly) (v2$ Poly)) (! (= (%%apply%%1 (%%lambda%%6 %%hole%%0) v1$ v2$) (%%apply%%0 %%hole%%0 v1$)) :pattern ((%%apply%%1 (%%lambda%%6 %%hole%%0) v1$ v2$)))))
(assert (=> (fuel_bool fuel%verismo!tspec.setlib.uop_to_bop.) (forall ((T1&. Dcr) (T1& Type) (T2&. Dcr) (T2& Type) (T3&. Dcr) (T3& Type) (op! Poly)) (! (= (verismo!tspec.setlib.uop_to_bop.? T1&. T1& T2&. T2& T3&. T3& op!) (mk_fun (%%lambda%%6 (%Poly%fun%1. op!)))) :pattern ((verismo!tspec.setlib.uop_to_bop.? T1&. T1& T2&. T2& T3&. T3& op!))))))
...
(declare-fun %%lambda%%7 (Dcr Type Dcr Type Dcr Type Poly) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Dcr) (%%hole%%5 Type) (%%hole%%6 Poly) (v$ Poly)) (! (= (%%apply%%0 (%%lambda%%7 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6) v$) (vstd!seq.Seq.index.? %%hole%%4 %%hole%%5 (verismo!tspec.cast.VTypeCast.vspec_cast_to.? %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 v$) %%hole%%6)) :pattern ((%%apply%%0 (%%lambda%%7 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6) v$)))))
(assert (=> (fuel_bool fuel%verismo!tspec.security.seq.fn_spec_to_seq_index.) (forall ((T&. Dcr) (T& Type) (i! Poly)) (! (= (verismo!tspec.security.seq.fn_spec_to_seq_index.? T&. T& i!) (mk_fun (%%lambda%%7 T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) $ (UINT 8) i!))) :pattern ((verismo!tspec.security.seq.fn_spec_to_seq_index.? T&. T& i!))))))
...
(declare-fun %%lambda%%8 (Dcr Type Dcr Type Dcr Type Dcr Type Dcr Type Dcr Type Dcr Type Dcr Type Poly Poly) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Dcr) (%%hole%%5 Type) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Dcr) (%%hole%%9 Type) (%%hole%%10 Dcr) (%%hole%%11 Type) (%%hole%%12 Dcr) (%%hole%%13 Type) (%%hole%%14 Dcr) (%%hole%%15 Type) (%%hole%%16 Poly) (%%hole%%17 Poly) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%8 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17) i$) (Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.impl&%16.bop_new.? %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 (Poly%fun%2. (verismo!tspec.setlib.uop_to_bop.? %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 (Poly%fun%1. (verismo!tspec.security.seq.fn_spec_to_seq_index.? %%hole%%0 %%hole%%1 i$))))))) :pattern ((%%apply%%0 (%%lambda%%8 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17) i$)))))
(assert (=> (fuel_bool fuel%verismo!tspec.security.seq.impl&%0.vspec_cast_to.) (forall ((T&. Dcr) (T& Type) (M&. Dcr) (M& Type) (self! Poly)) (! (= (verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!tspec.security.sectype.SecType. T&. T& M&. M&) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) M&. M&)) self!) (vstd!seq.Seq.new.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) M&. M&) $ (TYPE%fun%1. $ INT $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) M&. M&)) (I (verismo!tspec.size_s.spec_size.? T&. T&)) (Poly%fun%1. (mk_fun (%%lambda%%8 T&. T& T&. T& T&. T& $ (UINT 8) T&. T& M&. M& T&. T& $ (UINT 8) (verismo!tspec.security.sectype.SecMemType.view.? $ (TYPE%verismo!tspec.security.sectype.SecType. T&. T& M&. M&) T&. T& M&. M& self!) (Poly%verismo!tspec.security.sectype.SpecSecType. (verismo!tspec.security.sectype.impl&%16.constant.? T&. T& M&. M& (vstd!pervasive.arbitrary.? T&. T&)))))))) :pattern ((verismo!tspec.cast.VTypeCast.vspec_cast_to.? $ (TYPE%verismo!tspec.security.sectype.SecType. T&. T& M&. M&) $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) M&. M&)) self!))))))
...
(declare-fun %%lambda%%10 (Dcr Type Dcr Type Dcr Type Poly Poly Poly) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Dcr) (%%hole%%5 Type) (%%hole%%6 Poly) (%%hole%%7 Poly) (%%hole%%8 Poly) (i$ Poly)) (! (= (%%apply%%0 (%%lambda%%10 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) i$) (I (verismo!arch.ramdb.ram_s.impl&%0.read_one_byte.? %%hole%%7 %%hole%%8 (Poly%verismo!arch.addr_s.def_s.SpecAddr. (%Poly%verismo!arch.addr_s.def_s.SpecAddr. (verismo!tspec.ops.VSpecAdd.spec_add.? %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 i$)))))) :pattern ((%%apply%%0 (%%lambda%%10 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) i$)))))
(assert (=> (fuel_bool fuel%verismo!arch.ramdb.ram_s.impl&%0.read_bytes_by_asid.) (forall ((self! Poly) (asid! Poly) (spmem! Poly)) (! (= (verismo!arch.ramdb.ram_s.impl&%0.read_bytes_by_asid.? self! asid! spmem!) (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.new.? $ (UINT 8) $ (TYPE%fun%1. $ INT $ (UINT 8)) (I (verismo!arch.addr_s.page.impl&%8.len.? $ TYPE%verismo!arch.addr_s.def_s.SysPhy. spmem!)) (Poly%fun%1. (mk_fun (%%lambda%%10 $ (TYPE%verismo!arch.addr_s.def_s.SpecAddr. $ TYPE%verismo!arch.addr_s.def_s.SysPhy.) $ INT $ (TYPE%verismo!arch.addr_s.def_s.SpecAddr. $ TYPE%verismo!arch.addr_s.def_s.SysPhy.) (Poly%verismo!arch.addr_s.def_s.SpecAddr. (verismo!arch.addr_s.def_s.SpecMem./SpecMem/first (%Poly%verismo!arch.addr_s.def_s.SpecMem. spmem!))) self! asid!)))))) :pattern ((verismo!arch.ramdb.ram_s.impl&%0.read_bytes_by_asid.? self! asid! spmem!))))))
...
(set-info :comment ";; Spec-Termination verismo::arch::ptram::def_s::GuestPTRam::pgtb_walk_addrs_recursive_ok")
(set-info :comment ";; verismo/src/arch/ptram/ptram_u.rs:24:5: 29:23 (#0)")
...
(declare-const vram@ verismo!arch.vram.def.VRamDB.)
(declare-const rmp@ vstd!map.Map<verismo!arch.addr_s.def_s.SpecPage<verismo!arch.addr_s.def_s.SysPhy.>./verismo!arch.rmp.def_s.RmpEntry.>.)
(declare-const sram@ verismo!arch.ramdb.def.RamDB.)
