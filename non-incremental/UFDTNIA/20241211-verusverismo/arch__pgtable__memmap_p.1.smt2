...
(declare-const vpage1! verismo!arch.addr_s.def_s.SpecPage.)
(declare-const vpage2! verismo!arch.addr_s.def_s.SpecPage.)
(assert fuel_defaults)
(assert (has_type (Poly%verismo!arch.pgtable.def.MemMap. self!) (TYPE%verismo!arch.pgtable.def.MemMap. VT&. VT& PT&. PT&)))
(assert (has_type (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage1!) (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&)))
(assert (has_type (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage2!) (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&)))
(assert (tr_bound%verismo!arch.addr_s.def_s.AddrType. VT&. VT&))
(assert (tr_bound%verismo!arch.addr_s.def_s.AddrType. PT&. PT&))
(assert (verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!)))
(assert (not (= vpage1! vpage2!)))
(assert (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage1!))))))))
(assert (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage2!))))))))
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (fuel_bool fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.) (=> %%location_label%%0 (not (= (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage1!))))) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage2!)))))))))))
(check-sat)
(exit)
