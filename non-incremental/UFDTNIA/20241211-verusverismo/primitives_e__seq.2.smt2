...
(set-info :comment ";; MODULE 'module primitives_e::seq'")
...
(declare-fun Poly%vstd!map.Map<nat./vstd!set.Set<u8.>.>. (vstd!map.Map<nat./vstd!set.Set<u8.>.>.) Poly)
(declare-fun %Poly%vstd!map.Map<nat./vstd!set.Set<u8.>.>. (Poly) vstd!map.Map<nat./vstd!set.Set<u8.>.>.)
...
(assert (forall ((x vstd!map.Map<nat./vstd!set.Set<u8.>.>.)) (! (= x (%Poly%vstd!map.Map<nat./vstd!set.Set<u8.>.>. (Poly%vstd!map.Map<nat./vstd!set.Set<u8.>.>. x))) :pattern ((Poly%vstd!map.Map<nat./vstd!set.Set<u8.>.>. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x (TYPE%vstd!map.Map. $ NAT $ (TYPE%vstd!set.Set. $ (UINT 8)))) (= x (Poly%vstd!map.Map<nat./vstd!set.Set<u8.>.>. (%Poly%vstd!map.Map<nat./vstd!set.Set<u8.>.>. x)))) :pattern ((has_type x (TYPE%vstd!map.Map. $ NAT $ (TYPE%vstd!set.Set. $ (UINT 8))))))))
(assert (forall ((x vstd!map.Map<nat./vstd!set.Set<u8.>.>.)) (! (has_type (Poly%vstd!map.Map<nat./vstd!set.Set<u8.>.>. x) (TYPE%vstd!map.Map. $ NAT $ (TYPE%vstd!set.Set. $ (UINT 8)))) :pattern ((has_type (Poly%vstd!map.Map<nat./vstd!set.Set<u8.>.>. x) (TYPE%vstd!map.Map. $ NAT $ (TYPE%vstd!set.Set. $ (UINT 8))))))))
...
(assert (forall ((x vstd!set.Set<u8.>.)) (! (= x (%Poly%vstd!set.Set<u8.>. (Poly%vstd!set.Set<u8.>. x))) :pattern ((Poly%vstd!set.Set<u8.>. x)))))
(assert (forall ((x Poly)) (! (=> (has_type x (TYPE%vstd!set.Set. $ (UINT 8))) (= x (Poly%vstd!set.Set<u8.>. (%Poly%vstd!set.Set<u8.>. x)))) :pattern ((has_type x (TYPE%vstd!set.Set. $ (UINT 8)))))))
(assert (forall ((x vstd!set.Set<u8.>.)) (! (has_type (Poly%vstd!set.Set<u8.>. x) (TYPE%vstd!set.Set. $ (UINT 8))) :pattern ((has_type (Poly%vstd!set.Set<u8.>. x) (TYPE%vstd!set.Set. $ (UINT 8)))))))
...
(declare-fun tr_bound%verismo!primitives_e.seq.ValSetSize. (Dcr Type) Bool)
...
(set-info :comment ";; Function-Decl verismo::primitives_e::seq::ValSetSize::valset_size")
(declare-fun verismo!primitives_e.seq.ValSetSize.valset_size.? (Dcr Type Poly Poly) Poly)
(declare-fun verismo!primitives_e.seq.ValSetSize.valset_size%default%.? (Dcr Type Poly Poly) Poly)
(set-info :comment ";; Function-Decl verismo::primitives_e::seq::valset_size")
(declare-fun verismo!primitives_e.seq.valset_size.? (Poly Poly) Int)
(declare-fun verismo!primitives_e.seq.rec%valset_size.? (Poly Poly Fuel) Int)
...
(set-info :comment ";; Spec-Termination verismo::primitives_e::seq::recursive_sec_bytes")
(set-info :comment ";; verismo/src/primitives_e/seq.rs:23:1: 23:75 (#0)")
...
(set-info :comment ";; Function-Specs verismo::primitives_e::seq::ValSetSize::valset_size")
(declare-fun req%verismo!primitives_e.seq.ValSetSize.valset_size. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%45 Bool)
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (vmpl! Poly)) (! (= (req%verismo!primitives_e.seq.ValSetSize.valset_size. Self%&. Self%& self! vmpl!) (=> %%global_location_label%%45 (and (<= 1 (%I vmpl!)) (<= (%I vmpl!) 4)))) :pattern ((req%verismo!primitives_e.seq.ValSetSize.valset_size. Self%&. Self%& self! vmpl!)))))
(set-info :comment ";; Function-Axioms verismo::primitives_e::seq::ValSetSize::valset_size")
(assert (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (vmpl! Poly)) (! (=> (and (has_type self! Self%&) (has_type vmpl! NAT)) (has_type (verismo!primitives_e.seq.ValSetSize.valset_size.? Self%&. Self%& self! vmpl!) NAT)) :pattern ((verismo!primitives_e.seq.ValSetSize.valset_size.? Self%&. Self%& self! vmpl!)))))
...
(set-info :comment ";; Spec-Termination verismo::primitives_e::seq::valset_size")
(set-info :comment ";; verismo/src/primitives_e/seq.rs:78:1: 78:62 (#0)")
(declare-const s! Poly)
(declare-const vmpl! Poly)
(declare-const tmp%1 Int)
(declare-const tmp%2 Poly)
(declare-const tmp%3 Int)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (has_type s! (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.))))
(assert (has_type vmpl! NAT))
(declare-const %%switch_label%%0 Bool)
(set-info :comment ";; could not prove termination")
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) s!)) (or (and (=> (= (vstd!seq.Seq.len.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) s!) 0) (=> (= tmp%3 1) %%switch_label%%0)) (=> (not (= (vstd!seq.Seq.len.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) s!) 0)) (=> (= tmp%2 (vstd!seq.Seq.subrange.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) s! (I 0) (I (Sub (vstd!seq.Seq.len.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) s!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((s!$0 tmp%2) (vmpl!$1 vmpl!)) (vstd!seq.Seq.len.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) s!$0)) decrease%init0 false)) (=> (<= 0 tmp%1) (=> (= tmp%1 (verismo!primitives_e.seq.valset_size.? (vstd!seq.Seq.subrange.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) s! (I 0) (I (Sub (vstd!seq.Seq.len.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) s!) 1))) vmpl!)) (=> (= tmp%3 (nClip (Mul tmp%1 (vstd!set.impl&%0.len.? $ (UINT 8) (vstd!map.impl&%0.index.? $ NAT $ (TYPE%vstd!set.Set. $ (UINT 8)) (verismo!tspec.security.sectype.SpecSecType./SpecSecType/valsets (%Poly%verismo!tspec.security.sectype.SpecSecType. (vstd!seq.Seq.last.? $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.) s!))) vmpl!))))) %%switch_label%%0))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)
