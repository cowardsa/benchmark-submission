...
(assert (not (=> (ens%verismo!tspec.math.bits_p.bit64_and_auto. 0) (=> (= mask@ (uClip 64 1)) (=> (ens%verismo!snp.cpu.gdt.impl&%33.value. self! tmp%1) (and (=> %%location_label%%0 (and (<= 0 (uClip 64 3)) (< (uClip 64 3) 64))) (=> (= ret! (uClip 64 (uintand 64 (I (uClip 64 (uintshr 64 (I tmp%1) (I (uClip 64 3))))) (I mask@)))) (and (=> %%location_label%%1 (= ret! (verismo!snp.cpu.gdt.impl&%17.spec_granularity.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11Spec. (verismo!snp.cpu.gdt.impl&%33.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. self!)))))) (=> %%location_label%%2 (<= (verismo!snp.cpu.gdt.impl&%17.spec_granularity.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11Spec. (verismo!snp.cpu.gdt.impl&%33.view.? (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. self!)))) (uClip 64 1)))))))))))
(check-sat)
(exit)
