...
(assert (has_type self!@0 (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.)))
(assert (has_type params! TYPE%verismo!primitives_e.vec.RemoveParam.))
(assert (%B (verismo!vbox.vbox.MutFnTrait.spec_update_requires.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T& self!@0 params!)))
(declare-const self!@1 Poly)
(set-info :comment ";; precondition not satisfied")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%2 (verismo!primitives_e.vec.RemoveParam./RemoveParam/i (%Poly%verismo!primitives_e.vec.RemoveParam. params!))) (and (=> %%location_label%%0 (req%alloc!vec.impl&%1.remove. T&. T& $ TYPE%alloc!alloc.Global. self!@0 tmp%2)) (=> (has_type self!@1 (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.)) (=> (ens%alloc!vec.impl&%1.remove. T&. T& $ TYPE%alloc!alloc.Global. self!@0 self!@1 tmp%2 tmp%1) (=> (= %return! tmp%1) (=> %%location_label%%1 (%B (verismo!vbox.vbox.MutFnTrait.spec_update.? $ (TYPE%alloc!vec.Vec. T&. T& $ TYPE%alloc!alloc.Global.) $ TYPE%verismo!primitives_e.vec.RemoveParam. T&. T& self!@1 self!@0 params! %return!))))))))))
(check-sat)
(exit)
