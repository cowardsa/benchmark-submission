...
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:59:1: 59:53 (#0)")
...
(set-info :comment ";; Function-Def verismo::tspec::math::nonlinear::proof_mul_assoc")
(set-info :comment ";; verismo/src/tspec/math/nonlinear.rs:59:1: 59:53 (#0)")
(declare-const a! Int)
(declare-const b! Int)
(declare-const c! Int)
...
(assert (not (=> %%location_label%%0 (= (nClip (Mul (nClip (Add a! b!)) c!)) (nClip (Add (nClip (Mul a! c!)) (nClip (Mul b! c!))))))))
(check-sat)
(exit)
