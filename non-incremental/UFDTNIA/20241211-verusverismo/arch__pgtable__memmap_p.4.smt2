...
(set-info :comment ";; MODULE 'module arch::pgtable::memmap_p'")
...
(declare-const fuel%verismo!arch.pgtable.memmap_s.impl&%0.reverse. FuelId)
(declare-const fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map. FuelId)
(declare-const fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_identity_map. FuelId)
...
(assert (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.impl&%0.is_None. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!set.impl&%0.choose. fuel%verismo!tspec.math.pow_s.spec_int_pow2. fuel%verismo!tspec.math.pow_s.spec_nat_pow2. fuel%verismo!arch.addr_s.def_s.PAGE_SIZE. fuel%verismo!arch.addr_s.page.impl&%2.value. fuel%verismo!arch.addr_s.page.impl&%2.to_page. fuel%verismo!arch.addr_s.page.impl&%2.to_offset. fuel%verismo!arch.addr_s.page.impl&%2.new2. fuel%verismo!arch.addr_s.page.impl&%2.new. fuel%verismo!arch.addr_s.page.impl&%2.null. fuel%verismo!arch.addr_s.page.impl&%3.value. fuel%verismo!arch.addr_s.page.impl&%3.is_valid. fuel%verismo!arch.addr_s.page.impl&%3.new. fuel%verismo!arch.addr_s.page.impl&%3.new2. fuel%verismo!arch.addr_s.page.impl&%3.to_addr. fuel%verismo!arch.addr_s.page.impl&%4.as_int. fuel%verismo!arch.addr_s.page.impl&%4.from_int. fuel%verismo!arch.addr_s.page.impl&%5.as_int. fuel%verismo!arch.addr_s.page.impl&%5.from_int. fuel%verismo!arch.addr_s.page.impl&%8.from_range. fuel%verismo!arch.addr_s.page.impl&%8.convert. fuel%verismo!arch.addr_s.page.impl&%8.disjoint. fuel%verismo!arch.addr_s.page.impl&%8.first. fuel%verismo!arch.addr_s.page.impl&%8.offset. fuel%verismo!arch.addr_s.page.impl&%8.len. fuel%verismo!arch.addr_s.page.impl&%8.to_page. fuel%verismo!arch.rmp.perm_s.impl&%1.as_int. fuel%verismo!arch.rmp.perm_s.impl&%1.from_int. fuel%verismo!arch.pgtable.def.impl&%4.as_int. fuel%verismo!arch.pgtable.def.impl&%4.from_int. fuel%verismo!arch.pgtable.def.impl&%6.spec_from_int. fuel%verismo!arch.pgtable.def.impl&%8.spec_value. fuel%verismo!arch.pgtable.entry_s.impl&%1.contains_flag. fuel%verismo!arch.pgtable.entry_s.impl&%1.spec_ppn. fuel%verismo!arch.pgtable.entry_s.impl&%1.is_present. fuel%verismo!arch.pgtable.entry_s.impl&%1.spec_translate_page. fuel%verismo!arch.pgtable.memmap_s.impl&%0.spec_index. fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_valid. fuel%verismo!arch.pgtable.memmap_s.impl&%0.translate. fuel%verismo!arch.pgtable.memmap_s.impl&%0.translate_addr_seq. fuel%verismo!arch.pgtable.memmap_s.impl&%0.reverse. fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map. fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_identity_map. fuel%verismo!tspec.range_set.range_disjoint. fuel%verismo!tspec.integer.impl&%0.spec_add. fuel%verismo!tspec.integer.impl&%1.spec_sub. fuel%verismo!tspec.integer.impl&%2.spec_sub. fuel%verismo!arch.entities.impl&%4.as_int. fuel%verismo!arch.entities.impl&%4.from_int. fuel%verismo!arch.entities.impl&%6.spec_from_int. fuel%verismo!tspec.spec_unused.))
...
(set-info :comment ";; Function-Decl verismo::arch::pgtable::def::MemMap::reverse")
(declare-fun verismo!arch.pgtable.memmap_s.impl&%0.reverse.? (Dcr Type Dcr Type Poly Poly) core!option.Option.)
(set-info :comment ";; Function-Decl verismo::arch::pgtable::def::MemMap::is_one_to_one_map")
(declare-fun verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.? (Dcr Type Dcr Type Poly) Bool)
...
(assert (forall ((offset! Poly)) (! (= (req%verismo!tspec.math.pow_s.spec_int_pow2. offset!) (=> %%global_location_label%%27 (>= (%I offset!) 0))) :pattern ((req%verismo!tspec.math.pow_s.spec_int_pow2. offset!)))))
...
(set-info :comment ";; Function-Axioms verismo::arch::pgtable::def::MemMap::is_identity_map")
(assert (=> (fuel_bool fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_identity_map.) (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! Poly)) (! (= (verismo!arch.pgtable.memmap_s.impl&%0.is_identity_map.? VT&. VT& PT&. PT& self!) (forall ((vpage$ Poly)) (! (=> (has_type vpage$ (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&)) (=> (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! vpage$)))))) (= (verismo!tspec.integer.IntValue.as_int.? $ (TYPE%verismo!arch.addr_s.def_s.SpecPage. PT&. PT&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! vpage$))))) (verismo!tspec.integer.IntValue.as_int.? $ (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&) vpage$)))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! vpage$))))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.is_identity_map.? VT&. VT& PT&. PT& self!))))))
...
(set-info :comment ";; Function-Axioms verismo::arch::pgtable::def::MemMap::reverse")
(assert (fuel_bool_default fuel%verismo!arch.pgtable.memmap_s.impl&%0.reverse.))
(declare-fun %%choose%%1 (Type Dcr Type Dcr Type Poly Dcr Type Dcr Type Poly Bool Type Poly Dcr Type Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Dcr) (%%hole%%9 Type) (%%hole%%10 Poly) (%%hole%%11 Bool) (%%hole%%12 Type) (%%hole%%13 Poly) (%%hole%%14 Dcr) (%%hole%%15 Type) (%%hole%%16 Dcr) (%%hole%%17 Type) (%%hole%%18 Poly)) (! (=> (exists ((gvn$ Poly)) (! (and (has_type gvn$ %%hole%%0) (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 gvn$)))))) (ext_eq %%hole%%11 %%hole%%12 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 gvn$)))) %%hole%%13))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.translate.? %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 %%hole%%18 gvn$)))) (exists ((gvn$ Poly)) (! (and (and (has_type gvn$ %%hole%%0) (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 gvn$)))))) (ext_eq %%hole%%11 %%hole%%12 (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 gvn$)))) %%hole%%13))) (= (%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 %%hole%%18) gvn$)) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.translate.? %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 %%hole%%18 gvn$))))) :pattern ((%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 %%hole%%14 %%hole%%15 %%hole%%16 %%hole%%17 %%hole%%18)))))
(assert (=> (fuel_bool fuel%verismo!arch.pgtable.memmap_s.impl&%0.reverse.) (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! Poly) (page! Poly)) (! (= (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! page!) (ite (exists ((gvn$ Poly)) (! (and (has_type gvn$ (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&)) (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! gvn$)))))) (ext_eq false (TYPE%verismo!arch.addr_s.def_s.SpecPage. PT&. PT&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! gvn$)))) page!))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! gvn$)))) (let ((ret$ (%Poly%verismo!arch.addr_s.def_s.SpecPage. (as_type (%%choose%%1 (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&) VT&. VT& PT&. PT& self! VT&. VT& PT&. PT& self! false (TYPE%verismo!arch.addr_s.def_s.SpecPage. PT&. PT&) page! VT&. VT& PT&. PT& self!) (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&))))) (core!option.Option./Some (Poly%verismo!arch.addr_s.def_s.SpecPage. ret$))) core!option.Option./None)) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! page!))))))
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! Poly) (page! Poly)) (! (=> (and (has_type self! (TYPE%verismo!arch.pgtable.def.MemMap. VT&. VT& PT&. PT&)) (has_type page! (TYPE%verismo!arch.addr_s.def_s.SpecPage. PT&. PT&))) (has_type (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! page!)) (TYPE%core!option.Option. $ (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&)))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! page!)))))
(set-info :comment ";; Function-Axioms verismo::arch::pgtable::def::MemMap::is_one_to_one_map")
(assert (=> (fuel_bool fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.) (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! Poly)) (! (= (verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.? VT&. VT& PT&. PT& self!) (and (forall ((vpage$ Poly)) (! (=> (has_type vpage$ (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&)) (=> (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! vpage$)))))) (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! vpage$)))))))))) (ext_eq false (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! vpage$)))))))) vpage$)))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! vpage$)))) (forall ((ppage$ Poly)) (! (=> (has_type ppage$ (TYPE%verismo!arch.addr_s.def_s.SpecPage. PT&. PT&)) (=> (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! ppage$)))))) (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! ppage$)))))))))) (ext_eq false (TYPE%verismo!arch.addr_s.def_s.SpecPage. PT&. PT&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& self! (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! ppage$)))))))) ppage$)))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& self! ppage$)))))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.? VT&. VT& PT&. PT& self!))))))
...
(set-info :comment ";; Function-Specs verismo::arch::pgtable::def::MemMap::lemma_is_one_to_one_map_two_diff_va")
(declare-fun req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_is_one_to_one_map_two_diff_va. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap. verismo!arch.addr_s.def_s.SpecPage. verismo!arch.addr_s.def_s.SpecPage.) Bool)
(declare-const %%global_location_label%%28 Bool)
(declare-const %%global_location_label%%29 Bool)
(declare-const %%global_location_label%%30 Bool)
(declare-const %%global_location_label%%31 Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.) (vpage1! verismo!arch.addr_s.def_s.SpecPage.) (vpage2! verismo!arch.addr_s.def_s.SpecPage.)) (! (= (req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_is_one_to_one_map_two_diff_va. VT&. VT& PT&. PT& self! vpage1! vpage2!) (and (=> %%global_location_label%%28 (verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!))) (=> %%global_location_label%%29 (not (= vpage1! vpage2!))) (=> %%global_location_label%%30 (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage1!)))))))) (=> %%global_location_label%%31 (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage2!)))))))))) :pattern ((req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_is_one_to_one_map_two_diff_va. VT&. VT& PT&. PT& self! vpage1! vpage2!)))))
(declare-fun ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_is_one_to_one_map_two_diff_va. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap. verismo!arch.addr_s.def_s.SpecPage. verismo!arch.addr_s.def_s.SpecPage.) Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.) (vpage1! verismo!arch.addr_s.def_s.SpecPage.) (vpage2! verismo!arch.addr_s.def_s.SpecPage.)) (! (= (ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_is_one_to_one_map_two_diff_va. VT&. VT& PT&. PT& self! vpage1! vpage2!) (not (= (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage1!))))) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. vpage2!)))))))) :pattern ((ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_is_one_to_one_map_two_diff_va. VT&. VT& PT&. PT& self! vpage1! vpage2!)))))
(set-info :comment ";; Function-Def verismo::arch::pgtable::def::MemMap::lemma_is_one_to_one_map_two_diff_va")
(set-info :comment ";; verismo/src/arch/pgtable/memmap_p.rs:8:5: 12:6 (#0)")
(set-info :comment ";; Function-Specs verismo::arch::pgtable::def::MemMap::lemma_one_to_one_map_two_disjoint_vmem")
(declare-fun req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_one_to_one_map_two_disjoint_vmem. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap. verismo!arch.addr_s.def_s.SpecMem. verismo!arch.addr_s.def_s.SpecMem.) Bool)
(declare-const %%global_location_label%%32 Bool)
(declare-const %%global_location_label%%33 Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.) (vmem1! verismo!arch.addr_s.def_s.SpecMem.) (vmem2! verismo!arch.addr_s.def_s.SpecMem.)) (! (= (req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_one_to_one_map_two_disjoint_vmem. VT&. VT& PT&. PT& self! vmem1! vmem2!) (and (=> %%global_location_label%%32 (verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!))) (=> %%global_location_label%%33 (verismo!arch.addr_s.page.impl&%8.disjoint.? VT&. VT& (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem1!) (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem2!))))) :pattern ((req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_one_to_one_map_two_disjoint_vmem. VT&. VT& PT&. PT& self! vmem1! vmem2!)))))
(declare-fun ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_one_to_one_map_two_disjoint_vmem. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap. verismo!arch.addr_s.def_s.SpecMem. verismo!arch.addr_s.def_s.SpecMem.) Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.) (vmem1! verismo!arch.addr_s.def_s.SpecMem.) (vmem2! verismo!arch.addr_s.def_s.SpecMem.)) (! (= (ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_one_to_one_map_two_disjoint_vmem. VT&. VT& PT&. PT& self! vmem1! vmem2!) (verismo!arch.addr_s.page.impl&%8.disjoint.? PT&. PT& (Poly%verismo!arch.addr_s.def_s.SpecMem. (verismo!arch.pgtable.memmap_s.impl&%0.translate_addr_seq.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem1!))) (Poly%verismo!arch.addr_s.def_s.SpecMem. (verismo!arch.pgtable.memmap_s.impl&%0.translate_addr_seq.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem2!))))) :pattern ((ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_one_to_one_map_two_disjoint_vmem. VT&. VT& PT&. PT& self! vmem1! vmem2!)))))
(set-info :comment ";; Function-Def verismo::arch::pgtable::def::MemMap::lemma_one_to_one_map_two_disjoint_vmem")
(set-info :comment ";; verismo/src/arch/pgtable/memmap_p.rs:24:5: 28:6 (#0)")
(set-info :comment ";; Function-Specs verismo::arch::pgtable::def::MemMap::lemma_two_disjoint_same_page_vmem")
(declare-fun req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_two_disjoint_same_page_vmem. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap. verismo!arch.addr_s.def_s.SpecMem. verismo!arch.addr_s.def_s.SpecMem.) Bool)
(declare-const %%global_location_label%%34 Bool)
(declare-const %%global_location_label%%35 Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.) (vmem1! verismo!arch.addr_s.def_s.SpecMem.) (vmem2! verismo!arch.addr_s.def_s.SpecMem.)) (! (= (req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_two_disjoint_same_page_vmem. VT&. VT& PT&. PT& self! vmem1! vmem2!) (and (=> %%global_location_label%%34 (verismo!arch.addr_s.page.impl&%8.disjoint.? VT&. VT& (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem1!) (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem2!))) (=> %%global_location_label%%35 (= (verismo!arch.addr_s.page.impl&%8.to_page.? VT&. VT& (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem1!)) (verismo!arch.addr_s.page.impl&%8.to_page.? VT&. VT& (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem2!)))))) :pattern ((req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_two_disjoint_same_page_vmem. VT&. VT& PT&. PT& self! vmem1! vmem2!)))))
(declare-fun ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_two_disjoint_same_page_vmem. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap. verismo!arch.addr_s.def_s.SpecMem. verismo!arch.addr_s.def_s.SpecMem.) Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.) (vmem1! verismo!arch.addr_s.def_s.SpecMem.) (vmem2! verismo!arch.addr_s.def_s.SpecMem.)) (! (= (ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_two_disjoint_same_page_vmem. VT&. VT& PT&. PT& self! vmem1! vmem2!) (verismo!arch.addr_s.page.impl&%8.disjoint.? PT&. PT& (Poly%verismo!arch.addr_s.def_s.SpecMem. (verismo!arch.pgtable.memmap_s.impl&%0.translate_addr_seq.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem1!))) (Poly%verismo!arch.addr_s.def_s.SpecMem. (verismo!arch.pgtable.memmap_s.impl&%0.translate_addr_seq.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecMem. vmem2!))))) :pattern ((ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_two_disjoint_same_page_vmem. VT&. VT& PT&. PT& self! vmem1! vmem2!)))))
(set-info :comment ";; Function-Def verismo::arch::pgtable::def::MemMap::lemma_two_disjoint_same_page_vmem")
(set-info :comment ";; verismo/src/arch/pgtable/memmap_p.rs:53:5: 53:98 (#0)")
(set-info :comment ";; Function-Specs verismo::arch::pgtable::def::MemMap::lemma_identity_map_is_one_to_one")
(declare-fun req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_identity_map_is_one_to_one. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap.) Bool)
(declare-const %%global_location_label%%36 Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.)) (! (= (req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_identity_map_is_one_to_one. VT&. VT& PT&. PT& self!) (=> %%global_location_label%%36 (verismo!arch.pgtable.memmap_s.impl&%0.is_identity_map.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!)))) :pattern ((req%verismo!arch.pgtable.memmap_p.impl&%0.lemma_identity_map_is_one_to_one. VT&. VT& PT&. PT& self!)))))
(declare-fun ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_identity_map_is_one_to_one. (Dcr Type Dcr Type verismo!arch.pgtable.def.MemMap.) Bool)
(assert (forall ((VT&. Dcr) (VT& Type) (PT&. Dcr) (PT& Type) (self! verismo!arch.pgtable.def.MemMap.)) (! (= (ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_identity_map_is_one_to_one. VT&. VT& PT&. PT& self!) (verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!))) :pattern ((ens%verismo!arch.pgtable.memmap_p.impl&%0.lemma_identity_map_is_one_to_one. VT&. VT& PT&. PT& self!)))))
(set-info :comment ";; Function-Def verismo::arch::pgtable::def::MemMap::lemma_identity_map_is_one_to_one")
(set-info :comment ";; verismo/src/arch/pgtable/memmap_p.rs:62:5: 62:57 (#0)")
(declare-const VT&. Dcr)
(declare-const VT& Type)
(declare-const PT&. Dcr)
(declare-const PT& Type)
(declare-const self! verismo!arch.pgtable.def.MemMap.)
(declare-const vpage@ Poly)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Bool)
(declare-const tmp%3 Bool)
(declare-const p@ verismo!arch.addr_s.def_s.SpecPage.)
(declare-const ppage@ Poly)
(assert fuel_defaults)
(assert (has_type (Poly%verismo!arch.pgtable.def.MemMap. self!) (TYPE%verismo!arch.pgtable.def.MemMap. VT&. VT& PT&. PT&)))
(assert (tr_bound%verismo!arch.addr_s.def_s.AddrType. VT&. VT&))
(assert (tr_bound%verismo!arch.addr_s.def_s.AddrType. PT&. PT&))
(assert (verismo!arch.pgtable.memmap_s.impl&%0.is_identity_map.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!)))
...
(assert (not (=> (fuel_bool fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_identity_map.) (=> (fuel_bool fuel%verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.) (and (=> (has_type vpage@ (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&)) (=> (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage@)))))) (=> (= tmp%1 (= (verismo!tspec.integer.IntValue.as_int.? $ (TYPE%verismo!arch.addr_s.def_s.SpecPage. PT&. PT&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage@))))) (verismo!tspec.integer.IntValue.as_int.? $ (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&) vpage@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage@))))))))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= p@ (%Poly%verismo!arch.addr_s.def_s.SpecPage. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage@)))))))))) (=> (= tmp%3 (ext_eq false INT (I (verismo!arch.addr_s.page.impl&%3.value.? PT&. PT& (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (Poly%verismo!arch.addr_s.def_s.SpecPage. p@))))))) (I (verismo!arch.addr_s.page.impl&%3.value.? VT&. VT& (Poly%verismo!arch.addr_s.def_s.SpecPage. p@))))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> %%location_label%%3 (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage@)))))))))) (ext_eq false (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage@)))))))) vpage@))))))))))))))) (=> (forall ((vpage$ Poly)) (! (=> (has_type vpage$ (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&)) (=> (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage$)))))) (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage$)))))))))) (ext_eq false (TYPE%verismo!arch.addr_s.def_s.SpecPage. VT&. VT&) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage$)))))))) vpage$)))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) vpage$)))) (and (=> (has_type ppage@ (TYPE%verismo!arch.addr_s.def_s.SpecPage. PT&. PT&)) (=> (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) ppage@)))))) (=> %%location_label%%4 (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) ppage@)))))))))) (= (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) ppage@)))))))) ppage@))))) (=> (forall ((ppage$ Poly)) (! (=> (has_type ppage$ (TYPE%verismo!arch.addr_s.def_s.SpecPage. PT&. PT&)) (=> (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) ppage$)))))) (and (%B (B (is-core!option.Option./Some_ (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) ppage$)))))))))) (= (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.translate.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) ppage$)))))))) ppage$)))) :pattern ((verismo!arch.pgtable.memmap_s.impl&%0.reverse.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!) ppage$)))) (=> %%location_label%%5 (verismo!arch.pgtable.memmap_s.impl&%0.is_one_to_one_map.? VT&. VT& PT&. PT& (Poly%verismo!arch.pgtable.def.MemMap. self!)))))))))))
(check-sat)
(exit)
