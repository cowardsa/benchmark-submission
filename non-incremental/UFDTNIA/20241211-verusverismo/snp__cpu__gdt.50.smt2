...
(assert (not (=> %%location_label%%0 (= (verismo!snp.cpu.gdt.impl&%33.spec_new.? (I (verismo!snp.cpu.gdt.DescriptorAttr8_11./DescriptorAttr8_11/value (%Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. (Poly%verismo!snp.cpu.gdt.DescriptorAttr8_11. self!))))) self!))))
(check-sat)
(exit)
