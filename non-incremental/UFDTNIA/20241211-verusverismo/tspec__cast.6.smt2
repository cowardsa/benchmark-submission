...
(assert (%B (verismo!tspec.isconst.IsConstant.is_constant.? F&. F& f!)))
(assert (%B (verismo!tspec.isconst.IsConstant.is_constant.? T&. T& prev_val!)))
(assert (verismo!tspec.cast.field_set.? T&. T& F&. F& prev_val! val! (I offset!) f!))
(set-info :comment ";; assertion failed")
(declare-const %%location_label%%0 Bool)
(set-info :comment ";; postcondition not satisfied")
(declare-const %%location_label%%1 Bool)
(assert (not (=> (fuel_bool fuel%verismo!tspec.cast.field_set.) (=> (= bytes@ (%Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. (verismo!tspec.cast.VTypeCast.vspec_cast_to.? T&. T& $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) val!))) (=> (ens%verismo!tspec.cast.proof_into_is_constant. T&. T& $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) prev_val!) (=> (ens%verismo!tspec.cast.proof_into_is_constant. F&. F& $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) f!) (=> (= tmp%1 (%B (verismo!tspec.isconst.IsConstant.is_constant.? $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. bytes@)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (ens%verismo!tspec.cast.proof_into_is_constant. $ (TYPE%vstd!seq.Seq. $ (TYPE%verismo!tspec.security.sectype.SpecSecType. $ (UINT 8) $ TYPE%tuple%0.)) T&. T& (Poly%vstd!seq.Seq<verismo!tspec.security.sectype.SpecSecType<u8./tuple%0.>.>. bytes@)) (=> %%location_label%%1 (%B (verismo!tspec.isconst.IsConstant.is_constant.? T&. T& val!)))))))))))))
(check-sat)
(exit)
