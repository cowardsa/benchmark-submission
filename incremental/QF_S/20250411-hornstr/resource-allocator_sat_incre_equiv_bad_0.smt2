...
(pop 1)
(push 1)
(assert (let ((a!1 (re.++ (re.* (re.union (str.to_re "c") (str.to_re "r")))
                  (str.to_re "i"))))
(let ((a!2 (re.union (str.to_re "i")
                     (re.++ (re.union (str.to_re "c") (str.to_re "r")) a!1))))
(let ((a!3 (re.++ (re.* (re.union (str.to_re "c") (str.to_re "r"))) a!2)))
(let ((a!4 (re.union (re.union (str.to_re "r") (str.to_re "i"))
                     (re.++ (str.to_re "c") a!3))))
...
(assert (let ((a!1 (re.++ (re.union (str.to_re "r") (str.to_re "i"))
      ...
      (a!3 (re.++ (re.* (re.union (str.to_re "r") (str.to_re "i")))
                  (str.to_re "c"))))
(let ((a!2 (re.++ (re.* (re.union (str.to_re "r") (str.to_re "i")))
                  (re.union (str.to_re "") a!1)))
      (a!4 (re.union (str.to_re "c")
                     (re.++ (re.union (str.to_re "r") (str.to_re "i")) a!3))))
(let ((a!5 (re.++ (re.* (re.union (str.to_re "r") (str.to_re "i"))) a!4)))
(let ((a!6 (re.union (re.union (str.to_re "c") (str.to_re "i"))
                     (re.++ (str.to_re "r") a!5))))
