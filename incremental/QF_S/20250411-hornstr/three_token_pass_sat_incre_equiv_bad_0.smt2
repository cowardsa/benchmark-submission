...
(assert (let ((a!1 (re.union (str.to_re "")
      ...
      (a!2 (re.++ (re.* (str.to_re "n"))
                  (re.union (re.union (str.to_re "t") (str.to_re "m"))
                            (str.to_re "b"))))
      (a!4 (re.union (re.union (re.union (str.to_re "t") (str.to_re "m"))
                               (str.to_re "b"))
                     (str.to_re "n"))))
(let ((a!3 (re.union (re.union (re.union (str.to_re "t") (str.to_re "m"))
                               (str.to_re "b"))
                     (re.++ (str.to_re "n") a!2)))
      (a!6 (re.++ a!4 (re.++ (re.* (str.to_re "n")) a!1))))
(let ((a!5 (re.++ a!4 (re.++ (re.* (str.to_re "n")) a!3))))
(let ((a!7 (re.union a!6 (re.++ a!5 (re.++ (re.* a!5) a!6)))))
(let ((a!8 (re.++ (re.++ (re.* (str.to_re "n")) a!3) (re.++ (re.* a!5) a!7))))
