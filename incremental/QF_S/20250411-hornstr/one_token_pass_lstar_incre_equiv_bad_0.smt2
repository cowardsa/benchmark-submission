...
(assert (let ((a!1 (re.++ (re.++ (re.* (str.to_re "n")) (str.to_re "t"))
                  (re.* (str.to_re "n")))))
  (and (not (str.in_re X a!1)) true (= X varin) isin (not isout))))
(push 1)
(assert (let ((a!1 (re.++ (str.to_re "n")
                  (re.++ (re.* (str.to_re "n")) (str.to_re "t")))))
(let ((a!2 (re.++ (str.to_re "t")
                  (re.++ (re.* (str.to_re "n")) (re.union (str.to_re "t") a!1)))))
(let ((a!3 (re.++ (re.union (str.to_re "n") a!2)
                  (re.* (re.union (str.to_re "n") a!2)))))
(let ((a!4 (re.++ (re.* (re.union (str.to_re "n") a!2))
                  (re.union (str.to_re "") a!3))))
(let ((a!5 (re.++ (re.++ (re.* (str.to_re "n")) (re.union (str.to_re "t") a!1))
                  a!4)))
  (str.in_re varin a!5)))))))
...
(let ((a!3 (re.++ (re.++ (re.* (str.to_re "n")) (re.union (str.to_re "t") a!1))
