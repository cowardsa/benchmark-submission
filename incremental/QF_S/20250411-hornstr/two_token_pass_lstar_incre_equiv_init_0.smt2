...
(pop 1)
(push 1)
(assert (let ((a!1 (re.++ (re.* (re.union (str.to_re "2") (str.to_re "1")))
                  (str.to_re "0"))))
(let ((a!2 (re.union (str.to_re "0")
                     (re.++ (re.union (str.to_re "2") (str.to_re "1")) a!1))))
(let ((a!3 (re.++ (re.* (re.union (str.to_re "2") (str.to_re "1"))) a!2)))
...
(let ((a!7 (re.union (str.to_re "0") (re.++ (re.++ (str.to_re "2") a!3) a!6)))
      ...
      (a!15 (re.++ (re.++ (re.union (str.to_re "2") (str.to_re "1")) a!3) a!11))
      (a!16 (re.++ (re.++ (re.union (str.to_re "2") (str.to_re "1")) a!3) a!6)))
