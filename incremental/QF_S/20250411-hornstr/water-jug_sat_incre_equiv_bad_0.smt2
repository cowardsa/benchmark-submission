...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "Z") (str.to_re "f"))
                               (str.to_re "e"))
                     (str.to_re "c")))
      (a!5 (re.union (re.union (re.union (str.to_re "Z") (str.to_re "b"))
                               (str.to_re "f"))
                     (str.to_re "e"))))
...
(let ((a!3 (re.++ (re.union (re.union a!1 (str.to_re "a")) (str.to_re "d")) a!2))
      (a!4 (re.++ (re.union (re.union a!1 (str.to_re "a")) (str.to_re "d"))
                  (re.++ a!2 (str.to_re "b")))))
(let ((a!6 (re.++ (re.union a!5 (str.to_re "a"))
                  (re.++ a!2 (re.union (str.to_re "b") a!4))))
      (a!8 (re.++ (re.union a!5 (str.to_re "a"))
                  (re.++ a!2 (re.union (str.to_re "") a!3)))))
(let ((a!7 (re.* (re.union (re.union (str.to_re "c") (str.to_re "d")) a!6))))
(let ((a!9 (re.++ (re.union (re.union (str.to_re "c") (str.to_re "d")) a!6)
                  (re.++ a!7 a!8))))
(let ((a!10 (re.++ (re.++ a!2 (re.union (str.to_re "b") a!4))
