...
(let ((a!3 (re.++ (re.* a!1)
                  (re.union (re.union (str.to_re "D") (str.to_re "A")) a!2))))
(let ((a!5 (re.union a!4 (re.++ (re.union (str.to_re "D") (str.to_re "C")) a!3))))
...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "F") (str.to_re "B"))
                               (str.to_re "A"))
                     (str.to_re "E"))))
(let ((a!2 (re.++ (re.* (re.union (str.to_re "D") (str.to_re "C"))) a!1)))
(let ((a!3 (re.union a!1 (re.++ (re.union (str.to_re "D") (str.to_re "C")) a!2))))
(let ((a!4 (re.++ (re.* (re.union (str.to_re "D") (str.to_re "C"))) a!3)))
(let ((a!5 (re.++ (re.union (re.union (str.to_re "F") (str.to_re "A"))
                            (str.to_re "E"))
                  a!4)))
(let ((a!6 (re.union (re.union (re.union (str.to_re "B") (str.to_re "D"))
                               (str.to_re "C"))
                     a!5)))
...
(assert (let ((a!1 (re.++ (re.union (str.to_re "B") (str.to_re "D"))
      ...
      (a!3 (re.union (re.union (re.union (str.to_re "F") (str.to_re "A"))
                               (str.to_re "E"))
                     (str.to_re "C"))))
(let ((a!2 (re.++ (re.* (re.union (str.to_re "B") (str.to_re "D")))
                  (re.union (str.to_re "") a!1)))
      (a!4 (re.++ (re.* (re.union (str.to_re "B") (str.to_re "D"))) a!3)))
(let ((a!5 (re.union a!3 (re.++ (re.union (str.to_re "B") (str.to_re "D")) a!4)))
      (a!9 (re.++ (re.union (re.union (str.to_re "F") (str.to_re "B"))
                            (str.to_re "E"))
                  a!2)))
(let ((a!6 (re.++ (re.* (re.union (str.to_re "B") (str.to_re "D"))) a!5)))
(let ((a!7 (re.++ (re.union (re.union (str.to_re "F") (str.to_re "B"))
                            (str.to_re "E"))
                  a!6)))
(let ((a!8 (re.union (re.union (re.union (str.to_re "D") (str.to_re "A"))
                               (str.to_re "C"))
                     a!7)))
...
(let ((a!4 (re.++ (re.* a!1)
                  (re.union (re.union (str.to_re "F") (str.to_re "C")) a!3))))
(let ((a!5 (re.* (re.union (re.union a!1 (str.to_re "C"))
                           (re.++ (str.to_re "F") a!4)))))
(let ((a!6 (re.++ (re.union (re.union a!1 (str.to_re "C"))
                            (re.++ (str.to_re "F") a!4))
                  (re.++ a!5 (re.++ (str.to_re "F") a!2)))))
(let ((a!7 (re.++ a!5 (re.union (re.++ (str.to_re "F") a!2) a!6))))
  (str.in_re varin (re.union a!2 (re.++ a!4 a!7))))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(push 1)
