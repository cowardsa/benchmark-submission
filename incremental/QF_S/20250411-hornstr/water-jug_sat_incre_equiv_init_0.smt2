...
(pop 1)
(push 1)
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "Z") (str.to_re "f"))
                               (str.to_re "e"))
                     (str.to_re "c")))
      (a!4 (re.union (re.union (re.union (str.to_re "Z") (str.to_re "b"))
                               (str.to_re "f"))
                     (str.to_re "e"))))
(let ((a!2 (re.* (re.union (re.union a!1 (str.to_re "a")) (str.to_re "d")))))
(let ((a!3 (re.++ (re.union (re.union a!1 (str.to_re "a")) (str.to_re "d"))
                  (re.++ a!2 (str.to_re "b")))))
(let ((a!5 (re.++ (re.union a!4 (str.to_re "a"))
                  (re.++ a!2 (re.union (str.to_re "b") a!3)))))
(let ((a!6 (re.* (re.union (re.union (str.to_re "c") (str.to_re "d")) a!5))))
(let ((a!7 (re.++ (re.union (re.union (str.to_re "c") (str.to_re "d")) a!5) a!6)))
(let ((a!8 (re.++ (re.++ a!2 (re.union (str.to_re "b") a!3))
...
(let ((a!2 (re.++ (re.* a!1) (re.union (str.to_re "") (re.++ a!1 (re.* a!1)))))
      (a!3 (re.++ (re.* a!1)
                  (re.union (re.union (str.to_re "Z") (str.to_re "b"))
                            (str.to_re "f")))))
(let ((a!4 (re.union (re.union (re.union (str.to_re "Z") (str.to_re "b"))
                               (str.to_re "f"))
                     (re.++ a!1 a!3))))
(let ((a!6 (re.union (re.union (str.to_re "b") (str.to_re "e"))
                     (re.++ (re.union a!5 (str.to_re "d"))
                            (re.++ (re.* a!1) a!4)))))
(let ((a!7 (re.++ (re.* a!6) (re.++ (re.union a!5 (str.to_re "d")) a!2))))
(let ((a!8 (re.union (re.++ (re.union a!5 (str.to_re "d")) a!2) (re.++ a!6 a!7))))
