...
(assert (let ((a!1 (re.* (re.union (re.union (str.to_re "i") (str.to_re "r"))
                           (str.to_re "c")))))
(let ((a!2 (re.++ (re.union (re.union (str.to_re "i") (str.to_re "r"))
                            (str.to_re "c"))
                  a!1)))
...
(assert (let ((a!1 (re.union (str.to_re "")
      ...
      (a!2 (re.++ (str.to_re "r")
                  (re.++ (re.* (str.to_re "r"))
                         (re.union (str.to_re "i") (str.to_re "c")))))
      (a!4 (re.* (re.union (re.union (str.to_re "i") (str.to_re "r"))
                           (str.to_re "c")))))
(let ((a!3 (re.++ (re.* (str.to_re "r"))
                  (re.union (re.union (str.to_re "i") (str.to_re "c")) a!2)))
      (a!5 (re.++ (re.union (re.union (str.to_re "i") (str.to_re "r"))
                            (str.to_re "c"))
                  a!4)))
