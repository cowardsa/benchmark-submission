...
(assert (let ((a!1 (re.++ (re.union (str.to_re "M") (str.to_re "U"))
      ...
      (a!8 (re.union (re.union (str.to_re "M") (str.to_re "U"))
                     (re.++ (str.to_re "I")
                            (re.union (str.to_re "M") (str.to_re "I"))))))
(let ((a!2 (re.++ a!1
                  (re.++ (re.* a!1) (re.union (str.to_re "M") (str.to_re "U")))))
      (a!6 (re.union a!5 (re.++ a!1 (re.++ (re.* a!1) a!5))))
      (a!9 (re.union (re.++ (str.to_re "I") (str.to_re "U"))
                     (re.++ a!8 (re.++ (re.* a!1) a!5))))
      (a!10 (re.++ a!8
                   (re.++ (re.* a!1) (re.union (str.to_re "M") (str.to_re "U"))))))
(let ((a!3 (re.++ (re.* a!1)
                  (re.union (re.union (str.to_re "M") (str.to_re "U")) a!2)))
      (a!7 (re.union (str.to_re "U")
                     (re.++ (re.union (str.to_re "M") (str.to_re "I"))
                            (re.++ (re.* a!1) a!6))))
      (a!11 (re.++ a!9 (re.++ (re.* a!9) (re.union (str.to_re "I") a!10)))))
(let ((a!4 (re.union (str.to_re "")
                     (re.++ (re.union (str.to_re "M") (str.to_re "I")) a!3)))
      (a!12 (re.++ (re.* a!9) (re.union (re.union (str.to_re "I") a!10) a!11))))
  (str.in_re varout (re.union a!4 (re.++ a!7 a!12))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(push 1)
