...
(assert (let ((a!1 (re.* (re.union (re.union (str.to_re "1") (str.to_re "2"))
                           (str.to_re "0")))))
(let ((a!2 (re.++ (re.union (re.union (str.to_re "1") (str.to_re "2"))
                            (str.to_re "0"))
                  a!1)))
...
(assert (let ((a!1 (re.union (str.to_re "")
      ...
      (a!2 (re.++ (str.to_re "1")
                  (re.++ (re.* (str.to_re "1"))
                         (re.union (str.to_re "2") (str.to_re "0"))))))
(let ((a!3 (re.++ (re.* (str.to_re "1"))
                  (re.union (re.union (str.to_re "2") (str.to_re "0")) a!2)))
      (a!5 (re.++ (re.union (str.to_re "1") (str.to_re "0"))
                  (re.++ (re.* (str.to_re "1")) a!1))))
(let ((a!4 (re.union (str.to_re "2")
                     (re.++ (re.union (str.to_re "1") (str.to_re "0")) a!3))))
(let ((a!6 (re.union a!5 (re.++ a!4 (re.++ (re.* a!4) a!5)))))
(let ((a!7 (re.union (re.++ (re.* (str.to_re "1")) a!1)
                     (re.++ a!3 (re.++ (re.* a!4) a!6)))))
...
(let ((a!3 (re.++ (re.* (str.to_re "1"))
                  (re.union (re.union (str.to_re "2") (str.to_re "0")) a!2)))
      (a!5 (re.++ (str.to_re "2") (re.++ (re.* (str.to_re "1")) a!1))))
...
(pop 1)
(push 1)
(assert (let ((a!1 (re.union (str.to_re "2")
                     (re.++ (re.union (str.to_re "1") (str.to_re "0"))
                            (re.union (str.to_re "2") (str.to_re "0"))))))
(let ((a!2 (re.++ (re.* a!1)
                  (re.union (str.to_re "")
