...
(assert (let ((a!1 (re.* (re.union (re.union (str.to_re "A") (str.to_re "W"))
                           (str.to_re "C")))))
(let ((a!2 (re.++ (re.union (re.union (str.to_re "A") (str.to_re "W"))
                            (str.to_re "C"))
                  a!1)))
...
(pop 1)
(push 1)
(assert (let ((a!1 (re.++ (str.to_re "W")
                  (re.++ (re.* (str.to_re "W"))
                         (re.union (str.to_re "A") (str.to_re "C"))))))
(let ((a!2 (re.++ (re.* (str.to_re "W"))
                  (re.union (re.union (str.to_re "A") (str.to_re "C")) a!1))))
(let ((a!3 (re.union (str.to_re "W")
                     (re.++ (re.union (str.to_re "A") (str.to_re "C")) a!2))))
(let ((a!4 (re.++ (re.* a!3) (re.union (str.to_re "") (re.++ a!3 (re.* a!3))))))
  (str.in_re varout (re.++ a!2 a!4)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(push 1)
