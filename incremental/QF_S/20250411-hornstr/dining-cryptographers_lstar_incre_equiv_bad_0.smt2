...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "0") (str.to_re "e"))
                               (str.to_re "i"))
                     (str.to_re "h")))
      (a!7 (re.union (re.union (re.union (str.to_re "e") (str.to_re "g"))
                               (str.to_re "d"))
                     (str.to_re "b")))
      (a!8 (re.union (re.union (re.union (str.to_re "0") (str.to_re "i"))
                               (str.to_re "h"))
                     (str.to_re "1"))))
(let ((a!2 (re.union (re.union (re.union a!1 (str.to_re "g")) (str.to_re "f"))
                     (str.to_re "c")))
      (a!9 (re.union (re.union (re.union a!8 (str.to_re "f")) (str.to_re "c"))
                     (str.to_re "l"))))
(let ((a!3 (re.union (re.union (re.union a!2 (str.to_re "l")) (str.to_re "k"))
                     (str.to_re "d")))
      (a!10 (re.union (re.union (re.union a!9 (str.to_re "k")) (str.to_re "j"))
                      (str.to_re "a"))))
