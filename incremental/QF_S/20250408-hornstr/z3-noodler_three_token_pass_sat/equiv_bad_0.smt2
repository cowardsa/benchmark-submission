...
(assert (let ((a!1 (re.++ (re.union (str.to_re "n") (str.to_re "m"))
      ...
      (a!6 (re.union (re.union (re.union (str.to_re "b") (str.to_re "n"))
                               (str.to_re "t"))
                     (str.to_re "m"))))
...
(let ((a!7 (re.++ (re.++ a!6 a!5)
                  (re.++ (re.* (re.++ a!6 a!5)) (re.++ a!6 a!2)))))
(let ((a!8 (re.++ a!5
                  (re.++ (re.* (re.++ a!6 a!5)) (re.union (re.++ a!6 a!2) a!7)))))
  (str.in_re varin (re.union a!2 a!8))))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(push 1)
