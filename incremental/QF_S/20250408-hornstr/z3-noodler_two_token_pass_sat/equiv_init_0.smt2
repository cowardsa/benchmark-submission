...
(assert (let ((a!1 (re.++ (re.union (str.to_re "1") (str.to_re "2"))
                  (re.union (re.union (str.to_re "1") (str.to_re "2"))
                            (str.to_re "0")))))
...
(let ((a!5 (re.++ (re.union (re.union (str.to_re "1") (str.to_re "2"))
                            (str.to_re "0"))
                  a!4)))
...
(pop 1)
(push 1)
(assert (let ((a!1 (re.++ (re.* (re.union (str.to_re "2") (str.to_re "0")))
                  (str.to_re "1"))))
(let ((a!2 (re.union (str.to_re "1")
                     (re.++ (re.union (str.to_re "2") (str.to_re "0")) a!1))))
(let ((a!3 (re.++ (re.* (re.union (str.to_re "2") (str.to_re "0"))) a!2)))
(let ((a!4 (re.union (re.union (str.to_re "2") (str.to_re "0"))
                     (re.++ (str.to_re "1") a!3))))
...
(let ((a!3 (re.++ (re.* (str.to_re "2"))
      ...
      (a!4 (re.++ (str.to_re "2") (re.++ (re.* (str.to_re "2")) a!1)))
      (a!13 (re.++ (str.to_re "0") (re.++ (re.* (str.to_re "2")) a!1))))
(let ((a!5 (re.++ (re.* (re.++ (str.to_re "2") a!3)) a!4))
      (a!9 (re.++ (re.* (re.++ (str.to_re "2") a!3))
                  (re.union (str.to_re "1") (str.to_re "0")))))
(let ((a!6 (re.union a!4 (re.++ (re.++ (str.to_re "2") a!3) a!5)))
      (a!10 (re.union (re.union (str.to_re "1") (str.to_re "0"))
                      (re.++ (re.++ (str.to_re "2") a!3) a!9)))
      (a!12 (re.++ (re.union (str.to_re "1") (re.++ (str.to_re "0") a!3)) a!9))
      (a!14 (re.++ (re.union (str.to_re "1") (re.++ (str.to_re "0") a!3)) a!5)))
(let ((a!7 (re.++ (re.* (re.++ (str.to_re "2") a!3)) a!6))
      (a!11 (re.++ (re.* (re.++ (str.to_re "2") a!3)) a!10))
      (a!15 (re.++ (re.* (re.union (str.to_re "2") a!12))
                   (re.union (re.union (str.to_re "") a!13) a!14))))
(let ((a!8 (re.union (re.++ (re.* (str.to_re "2")) a!1) (re.++ a!3 a!7)))
      (a!16 (re.union (re.union (re.union (str.to_re "") a!13) a!14)
                      (re.++ (re.union (str.to_re "2") a!12) a!15))))
(let ((a!17 (re.++ (re.* (re.union (str.to_re "2") a!12)) a!16)))
...
(pop 1)
(push 1)
(assert (let ((a!1 (re.union (re.union (str.to_re "2") (str.to_re "0"))
                     (re.++ (str.to_re "1") (str.to_re "0")))))
(let ((a!2 (re.++ a!1
                  (re.++ (re.* a!1) (re.union (str.to_re "") (str.to_re "1"))))))
(let ((a!3 (re.++ (re.* a!1)
                  (re.union (re.union (str.to_re "") (str.to_re "1")) a!2))))
  (str.in_re varout (re.union (str.to_re "") (re.++ (str.to_re "0") a!3)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
(push 1)
