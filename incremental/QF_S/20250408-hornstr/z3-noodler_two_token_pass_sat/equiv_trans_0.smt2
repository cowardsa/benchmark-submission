...
(assert (let ((a!1 (re.++ (re.* (re.union (str.to_re "1") (str.to_re "0")))
                  (str.to_re "2")))
      (a!4 (re.* (re.union (re.union (str.to_re "1") (str.to_re "2"))
                           (str.to_re "0")))))
(let ((a!2 (re.union (str.to_re "2")
                     (re.++ (re.union (str.to_re "1") (str.to_re "0")) a!1)))
      (a!5 (re.++ (re.union (re.union (str.to_re "1") (str.to_re "2"))
                            (str.to_re "0"))
                  a!4)))
...
(assert (let ((a!1 (re.union (str.to_re "")
      ...
      (a!2 (re.++ (str.to_re "1")
                  (re.++ (re.* (str.to_re "1")) (str.to_re "2"))))
      (a!3 (re.* (re.union (re.union (str.to_re "1") (str.to_re "2"))
                           (str.to_re "0")))))
(let ((a!4 (re.++ (re.union (re.union (str.to_re "1") (str.to_re "2"))
                            (str.to_re "0"))
                  a!3)))
...
(let ((a!3 (re.++ (re.union (re.union (str.to_re "1") (str.to_re "2"))
                            (str.to_re "0"))
                  a!2)))
(let ((a!4 (re.++ (re.++ (re.* (str.to_re "1")) (re.union (str.to_re "0") a!1))
                  (re.++ a!2 (re.union (str.to_re "") a!3)))))
...
(assert (let ((a!1 (re.++ (str.to_re "0")
      ...
      (a!3 (re.++ (re.* (re.union (str.to_re "2") (str.to_re "0")))
                  (str.to_re "1"))))
(let ((a!4 (re.union (str.to_re "1")
                     (re.++ (re.union (str.to_re "2") (str.to_re "0")) a!3)))
      (a!8 (re.++ (str.to_re "1")
                  (re.++ (re.* (str.to_re "0")) (re.union (str.to_re "2") a!1))))
      (a!9 (re.++ (str.to_re "1")
                  (re.++ (re.* (str.to_re "0")) (re.union (str.to_re "1") a!2)))))
(let ((a!5 (re.++ (re.* (re.union (str.to_re "2") (str.to_re "0"))) a!4)))
(let ((a!6 (re.++ (re.++ (re.* (str.to_re "0")) (re.union (str.to_re "1") a!2))
                  a!5))
      (a!10 (re.union (re.union (re.union (str.to_re "2") (str.to_re "0")) a!8)
                      (re.++ a!9 a!5))))
(let ((a!7 (re.union (re.++ (re.* (str.to_re "0"))
                            (re.union (str.to_re "2") a!1))
                     a!6))
      (a!11 (re.++ (re.* a!10)
                   (re.union (str.to_re "") (re.++ a!10 (re.* a!10))))))
  (str.in_re varin (re.++ a!7 a!11))))))))
(assert (let ((a!1 (re.union (str.to_re "")
                     (re.++ (str.to_re "0") (re.* (str.to_re "0")))))
      (a!2 (re.++ (str.to_re "0")
                  (re.++ (re.* (str.to_re "0")) (str.to_re "1"))))
      (a!3 (re.++ (re.union (str.to_re "2") (str.to_re "0"))
                  (re.* (re.union (str.to_re "2") (str.to_re "0")))))
      (a!7 (re.++ (str.to_re "0")
                  (re.++ (re.* (str.to_re "0")) (str.to_re "2"))))
      (a!8 (re.++ (re.* (re.union (str.to_re "2") (str.to_re "0")))
                  (str.to_re "1"))))
(let ((a!4 (re.++ (re.* (re.union (str.to_re "2") (str.to_re "0")))
                  (re.union (str.to_re "") a!3)))
      (a!9 (re.union (str.to_re "1")
                     (re.++ (re.union (str.to_re "2") (str.to_re "0")) a!8)))
      (a!13 (re.++ (str.to_re "1")
                   (re.++ (re.* (str.to_re "0")) (re.union (str.to_re "2") a!7))))
      (a!14 (re.++ (str.to_re "1")
                   (re.++ (re.* (str.to_re "0")) (re.union (str.to_re "1") a!2))))
      (a!16 (re.++ (str.to_re "1") (re.++ (re.* (str.to_re "0")) a!1))))
(let ((a!5 (re.++ (re.++ (re.* (str.to_re "0")) (re.union (str.to_re "1") a!2))
                  a!4))
      (a!10 (re.++ (re.* (re.union (str.to_re "2") (str.to_re "0"))) a!9)))
(let ((a!6 (re.union (re.++ (re.* (str.to_re "0")) a!1) a!5))
      (a!11 (re.++ (re.++ (re.* (str.to_re "0")) (re.union (str.to_re "1") a!2))
                   a!10))
      (a!15 (re.union (re.union (re.union (str.to_re "2") (str.to_re "0")) a!13)
                      (re.++ a!14 a!10))))
