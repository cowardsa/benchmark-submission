...
(assert (let ((a!1 (re.++ (re.union (str.to_re "1") (str.to_re "2"))
                  (re.union (re.union (str.to_re "1") (str.to_re "2"))
                            (str.to_re "0")))))
(let ((a!2 (re.++ (re.union (str.to_re "0") a!1)
                  (re.* (re.union (str.to_re "0") a!1)))))
(let ((a!3 (re.++ (re.* (re.union (str.to_re "0") a!1))
...
(assert (let ((a!1 (re.* (re.union (re.union (str.to_re "1") (str.to_re "2"))
                           (str.to_re "0"))))
      (a!4 (re.union (re.union (str.to_re "2") (str.to_re "0"))
                     (re.++ (str.to_re "1") (str.to_re "0")))))
(let ((a!2 (re.++ (re.union (re.union (str.to_re "1") (str.to_re "2"))
                            (str.to_re "0"))
                  a!1)))
(let ((a!3 (re.++ (re.union (str.to_re "1") (str.to_re "2"))
                  (re.++ a!1 (re.union (str.to_re "") a!2))))
      (a!5 (re.++ (re.++ (str.to_re "1")
                         (re.union (str.to_re "1") (str.to_re "2")))
                  (re.++ a!1 (re.union (str.to_re "") a!2)))))
(let ((a!6 (re.union a!5 (re.++ a!4 (re.++ (re.* a!4) a!5)))))
(let ((a!7 (re.union a!3 (re.++ (str.to_re "0") (re.++ (re.* a!4) a!6)))))
  (str.in_re varin a!7)))))))
(set-info :status unknown)
(check-sat)
(pop 1)
