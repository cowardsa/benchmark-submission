...
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "a") (str.to_re "H"))
                               (str.to_re "b"))
                     (str.to_re "d"))))
  (str.in_re X (re.union (re.union a!1 (str.to_re "E")) (str.to_re "c")))))
(set-info :status unknown)
(check-sat)
(pop 1)
(push 1)
(assert (let ((a!1 (re.union (re.union (re.union (str.to_re "a") (str.to_re "H"))
                     ...
                     (str.to_re "d"))))
(let ((a!2 (re.++ (re.union (re.union a!1 (str.to_re "E")) (str.to_re "c"))
                  (re.union (re.union a!1 (str.to_re "E")) (str.to_re "c")))))
(let ((a!3 (re.++ a!2 (re.union (re.union a!1 (str.to_re "E")) (str.to_re "c")))))
  (str.in_re X a!3)))))
(set-info :status unknown)
(check-sat)
...
(let ((a!2 (re.++ (re.union (re.union a!1 (str.to_re "E")) (str.to_re "c"))
                  (re.union (re.union a!1 (str.to_re "E")) (str.to_re "c")))))
(let ((a!3 (re.++ a!2 (re.union (re.union a!1 (str.to_re "E")) (str.to_re "c")))))
(let ((a!4 (re.++ a!3 (re.union (re.union a!1 (str.to_re "E")) (str.to_re "c")))))
  (str.in_re X a!4))))))
(set-info :status unknown)
(check-sat)
