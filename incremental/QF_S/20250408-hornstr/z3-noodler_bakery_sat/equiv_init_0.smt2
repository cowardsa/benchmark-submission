...
(push 1)
(assert (let ((a!1 (re.union (str.to_re "")
                     (re.++ (str.to_re "W") (re.* (str.to_re "W")))))
      (a!2 (re.++ (str.to_re "W")
                  (re.++ (re.* (str.to_re "W"))
                         (re.union (str.to_re "C") (str.to_re "A"))))))
(let ((a!3 (re.++ (re.* (str.to_re "W"))
                  (re.union (re.union (str.to_re "C") (str.to_re "A")) a!2)))
      (a!5 (re.++ (re.union (str.to_re "C") (str.to_re "W"))
                  (re.++ (re.* (str.to_re "W")) a!1))))
(let ((a!4 (re.union (str.to_re "A")
                     (re.++ (re.union (str.to_re "C") (str.to_re "W")) a!3))))
(let ((a!6 (re.union a!5 (re.++ a!4 (re.++ (re.* a!4) a!5)))))
(let ((a!7 (re.union (re.++ (re.* (str.to_re "W")) a!1)
