...
(assert (let ((a!1 (re.++ (str.to_re "N")
      ...
      (a!3 (re.++ (re.union (str.to_re "N") (str.to_re "T"))
                  (re.* (re.union (str.to_re "N") (str.to_re "T"))))))
(let ((a!2 (re.++ (re.union (str.to_re "N") (str.to_re "T"))
                  (re.++ (re.* (str.to_re "N")) (re.union (str.to_re "T") a!1))))
      (a!4 (re.++ (re.* (re.union (str.to_re "N") (str.to_re "T")))
...
(let ((a!2 (re.++ (re.union (str.to_re "N") (str.to_re "T"))
  ...
  (str.in_re varout (re.union (str.to_re "") a!2)))))
