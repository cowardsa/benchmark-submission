...
(assert (let ((a!1 (re.union (str.to_re "")
      ...
      (a!2 (re.++ (str.to_re "T")
                  (re.++ (re.* (str.to_re "T")) (str.to_re "N")))))
(let ((a!3 (re.++ (str.to_re "N")
                  (re.++ (re.* (str.to_re "T")) (re.union (str.to_re "N") a!2))))
      (a!4 (re.++ (str.to_re "N") (re.++ (re.* (str.to_re "T")) a!1))))
(let ((a!5 (re.++ (re.* (re.union (str.to_re "T") a!3)) a!4)))
(let ((a!6 (re.union a!4 (re.++ (re.union (str.to_re "T") a!3) a!5))))
(let ((a!7 (re.++ (re.* (re.union (str.to_re "T") a!3)) a!6)))
(let ((a!8 (re.++ (re.++ (re.* (str.to_re "T")) (re.union (str.to_re "N") a!2))
                  a!7)))
(let ((a!9 (re.union (re.++ (re.* (str.to_re "T")) a!1) a!8)))
...
(assert (let ((a!1 (re.union (str.to_re "")
                     (re.++ (str.to_re "T") (re.* (str.to_re "T"))))))
  (str.in_re varout (re.++ (re.* (str.to_re "T")) a!1))))
(set-info :status unknown)
(check-sat)
(pop 1)
(push 1)
(assert (str.in_re varout (str.to_re "")))
(set-info :status unknown)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (str.in_re varout
           (re.union (str.to_re "") (re.union (str.to_re "N") (str.to_re "T")))))
(set-info :status unknown)
(check-sat)
(pop 1)
(push 1)
(assert (let ((a!1 (re.union (str.to_re "")
      ...
      (a!2 (re.++ (str.to_re "N")
                  (re.++ (re.* (str.to_re "N")) (str.to_re "T")))))
(let ((a!3 (re.union (re.++ (re.* (str.to_re "N")) a!1)
                     (re.++ (re.* (str.to_re "N"))
                            (re.union (str.to_re "T") a!2)))))
